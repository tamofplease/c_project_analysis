...
#define FREE_ROP { R_FREE (out); R_FREE (esil_flg); R_FREE (esil_main); r_list_free (ops_list); ops_list = NULL; r_list_free (flg_read); flg_read = NULL; r_list_free (flg_write); flg_write = NULL; r_list_free (reg_read); reg_read = NULL; r_list_free (reg_write); reg_write = NULL; r_list_free (mem_read); mem_read = NULL; r_list_free (mem_write); mem_write = NULL; }
#define R_INTERVAL_H 
