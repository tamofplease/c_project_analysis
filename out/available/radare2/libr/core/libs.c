...
#define CB(x,y) static int __lib_ ## x ## _cb (RLibPlugin * pl, void *user, void *data) { struct r_ ## x ## _plugin_t *hand = (struct r_ ## x ## _plugin_t *)data; RCore *core = (RCore *) user; pl->free = NULL; r_ ## x ## _add (core->y, hand); return true; } static int __lib_ ## x ## _dt (RLibPlugin * pl, void *p, void *u) { return true; }
#define _LIMITS_H_ 
...
#define CB_COPY(x,y) static int __lib_ ## x ## _cb (RLibPlugin * pl, void *user, void *data) { struct r_ ## x ## _plugin_t *hand = (struct r_ ## x ## _plugin_t *)data; struct r_ ## x ## _plugin_t *instance; RCore *core = (RCore *) user; instance = R_NEW (struct r_ ## x ## _plugin_t); memcpy (instance, hand, sizeof (struct r_ ## x ## _plugin_t)); r_ ## x ## _add (core->y, instance); return true; } static int __lib_ ## x ## _dt (RLibPlugin * pl, void *p, void *u) { return true; }
