...
#define II(a,b,c,d,x,s,ac) { (a) += I ((b), (c), (d)) + (x) + (ut32)(ac); (a) = ROTATE_LEFT ((a), (s)); (a) += (b); }
...
#define FF(a,b,c,d,x,s,ac) { (a) += F ((b), (c), (d)) + (x) + (ut32)(ac); (a) = ROTATE_LEFT ((a), (s)); (a) += (b); }
...
#define __wchar_t__ 
#define GG(a,b,c,d,x,s,ac) { (a) += G ((b), (c), (d)) + (x) + (ut32)(ac); (a) = ROTATE_LEFT ((a), (s)); (a) += (b); }
#define SEEK_END 2
...
#define HH(a,b,c,d,x,s,ac) { (a) += H ((b), (c), (d)) + (x) + (ut32)(ac); (a) = ROTATE_LEFT ((a), (s)); (a) += (b); }
