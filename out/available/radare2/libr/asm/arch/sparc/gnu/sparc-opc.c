...
#define COMMUTEOP(opcode,op3,arch_mask) { opcode, F3(2, op3, 0), F3(~2, ~(op3), ~0)|ASI(~0), "1,2,d", 0, arch_mask }, { opcode, F3(2, op3, 1), F3(~2, ~(op3), ~1), "1,i,d", 0, arch_mask }, { opcode, F3(2, op3, 1), F3(~2, ~(op3), ~1), "i,1,d", 0, arch_mask }
#define __weak 
...
#define F_UNBR 4
#define fmrrs(opcode,mask,lose,flags) { opcode, (mask), (lose), "1,f,g", (flags) | F_FLOAT, v9 }
...
#define fmrrq(opcode,mask,lose,flags) { opcode, (mask), (lose), "1,R,J", (flags) | F_FLOAT, v9 }
...
#define fmovrd(mop,mask,flags) fmrrd(mop, F3(2, 0x35, 0)|OPF_LOW5(6)|RCOND(mask), F3(~2, ~0x35, 0)|OPF_LOW5(~6)|RCOND(~(mask)), (flags))
#define fmovrq(mop,mask,flags) fmrrq(mop, F3(2, 0x35, 0)|OPF_LOW5(7)|RCOND(mask), F3(~2, ~0x35, 0)|OPF_LOW5(~7)|RCOND(~(mask)), (flags))
#define fmovrs(mop,mask,flags) fmrrs(mop, F3(2, 0x35, 0)|OPF_LOW5(5)|RCOND(mask), F3(~2, ~0x35, 0)|OPF_LOW5(~5)|RCOND(~(mask)), (flags))
...
#define fmrrd(opcode,mask,lose,flags) { opcode, (mask), (lose), "1,B,H", (flags) | F_FLOAT, v9 }
