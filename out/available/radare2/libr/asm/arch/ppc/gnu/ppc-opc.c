...
#define XOPS(op,xop,rc) (OP (op) | ((((unsigned long)(xop)) & 0x3ff) << 1) | (((unsigned long)(rc)) & 1))
...
#define XFXM(op,xop,fxm,p4) (X ((op), (xop)) | ((((unsigned long)(fxm)) & 0xff) << 12) | ((unsigned long)(p4) << 20))
