...
#define B_KEY_VALUE_OFFSET(node) ((grub_afs_bvalue_t *) ((char *) B_KEY_INDEX_OFFSET (node) + node->key_count * 2))
...
#define B_KEY_INDEX_OFFSET(node) ((grub_uint16_t *) ((char *) (node) + ALIGN_UP (sizeof (struct grub_afs_bnode) + node->key_size, B_KEY_INDEX_ALIGN)))
