...
#define __END_DECLS 
#define GRUB_MINIX_INODE_DINDIR_ZONE(data) GRUB_MINIX_INODE_ENDIAN (data,double_indir_zone,16,32)
...
#define GRUB_MINIX_INODE_INDIR_ZONE(data) GRUB_MINIX_INODE_ENDIAN (data,indir_zone,16,32)
#define ZERO_FILL(x) memset (&x, 0, sizeof (x))
#define INT_FAST16_MIN INT16_MIN
#define _SC_V6_ILP32_OFF32 103
#define GRUB_LIST_HEADER 1
#define DT_BLK 6
#define GRUB_MINIX_ZONESZ (GRUB_MINIX_BSIZE << grub_le_to_cpu16 (sblock->log2_zone_size))
#define F_NOCACHE 48
