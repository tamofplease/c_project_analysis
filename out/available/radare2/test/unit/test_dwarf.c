...
#define _TIME_H_ 
#define check_abbrev_tag(expected_tag) mu_assert_eq (da->decls[i].tag, expected_tag, "Incorrect abbreviation tag")
...
#define check_abbrev_children(expected_children) mu_assert_eq (da->decls[i].has_children, expected_children, "Incorrect children flag")
...
#define check_abbrev_attr_name(expected_name) mu_assert_eq (da->decls[i].defs[j].attr_name, expected_name, "Incorrect children flag");
...
#define check_abbrev_code(expected_code) mu_assert_eq (da->decls[i].code, expected_code, "Wrong abbrev code");
#define SIGEMT 7
...
#define check_abbrev_count(expected_count) mu_assert_eq (da->decls[i].count, expected_count, "Incorrect abbreviation count")
...
#define check_abbrev_attr_form(expected_form) mu_assert_eq (da->decls[i].defs[j].attr_form, expected_form, "Incorrect children flag");
#define __WCTYPE_H_ 
