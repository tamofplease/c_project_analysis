...
#define assert_hint_eq(actual,expected) do { if (actual == NULL) mu_assert ("hint", expected == &empty_hint); else mu_assert ("hint", hint_equals (actual, expected)); } while (0)
