...
#define check_attr_data(attr_idx,expect_data) mu_assert_eq (cu.dies[i].attr_values[attr_idx].uconstant, expect_data, "Wrong attribute data")
...
#define check_attr_block_length(attr_idx,expect_len) mu_assert_eq (cu.dies[i].attr_values[attr_idx].block.length, expect_len, "Wrong attribute block length")
...
#define check_die_abbr_code(expect_code) mu_assert_eq (cu.dies[i].abbrev_code, expect_code, "Wrong abbrev code")
#define _UNISTD_H_ 
...
#define check_attr_flag(attr_idx,expect_flag) mu_assert_eq (cu.dies[i].attr_values[attr_idx].flag, expect_flag, "Wrong attribute flag")
...
#define check_attr_form(attr_idx,expect_form) mu_assert_eq (cu.dies[i].attr_values[attr_idx].attr_form, expect_form, "Wrong attribute name")
...
#define check_die_length(len) mu_assert_eq (cu.dies[i].count, len, "Wrong DIE length information")
...
#define check_attr_reference(attr_idx,expect_ref) mu_assert_eq (cu.dies[i].attr_values[attr_idx].reference, expect_ref, "Wrong attribute reference")
...
#define PRIXPTR "lX"
#define check_attr_name(attr_idx,expect_name) mu_assert_eq (cu.dies[i].attr_values[attr_idx].attr_name, expect_name, "Wrong attribute name")
...
#define check_attr_string(attr_idx,expect_string) mu_assert_streq (cu.dies[i].attr_values[attr_idx].string.content, expect_string, "Wrong string attribute information")
#define __FLT64_HAS_QUIET_NAN__ 1
#define check_attr_address(attr_idx,expect_addr) mu_assert_eq (cu.dies[i].attr_values[attr_idx].address, expect_addr, "Wrong attribute name")
...
#define POLL_HUP 6
#define check_die_tag(tg) mu_assert_eq (cu.dies[i].tag, tg, "Wrong DIE tag")
...
#define check_attr_block_data(attr_idx,data_idx,expect_data) mu_assert_eq (cu.dies[i].attr_values[attr_idx].block.data[data_idx], expect_data, "Wrong attribute block data")
