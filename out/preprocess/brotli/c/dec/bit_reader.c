# 0 "project/brotli/c/dec/bit_reader.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/brotli/c/dec/bit_reader.c"
# 9 "project/brotli/c/dec/bit_reader.c"
# 1 "project/brotli/c/dec/./bit_reader.h" 1
# 12 "project/brotli/c/dec/./bit_reader.h"
...
# 13 "project/brotli/c/dec/./bit_reader.h" 2
...
# 28 "project/brotli/c/dec/./../common/./platform.h"
...
# 10 "project/brotli/c/dec/bit_reader.c" 2

# 1 "project/brotli/c/dec/../common/platform.h" 1
# 12 "project/brotli/c/dec/bit_reader.c" 2
...
# 34 "project/brotli/c/dec/bit_reader.c" 3 4
int 
# 34 "project/brotli/c/dec/bit_reader.c"
           BrotliWarmupBitReader(BrotliBitReader* const br) {
  ...
  if (BrotliGetAvailableBits(br) == 0) {
    if (!BrotliPullByte(br)) {
      return 
# 44 "project/brotli/c/dec/bit_reader.c" 3 4
            0
# 44 "project/brotli/c/dec/bit_reader.c"
                        ;
    }
  }
  ...
  while ((((size_t)br->next_in) & aligned_read_mask) != 0) {
    if (!BrotliPullByte(br)) {
      ...
      return 
# 51 "project/brotli/c/dec/bit_reader.c" 3 4
            1
# 51 "project/brotli/c/dec/bit_reader.c"
                       ;
    }
  }
  return 
# 54 "project/brotli/c/dec/bit_reader.c" 3 4
        1
# 54 "project/brotli/c/dec/bit_reader.c"
                   ;
}


# 57 "project/brotli/c/dec/bit_reader.c" 3 4
int 
# 57 "project/brotli/c/dec/bit_reader.c"
           BrotliSafeReadBits32Slow(BrotliBitReader* const br,
  ...
  if (!BrotliSafeReadBits(br, 16, &low_val) ||
    ...
    return 
# 68 "project/brotli/c/dec/bit_reader.c" 3 4
          0
# 68 "project/brotli/c/dec/bit_reader.c"
                      ;
  }
  *val = low_val | (high_val << 16);
  return 
# 71 "project/brotli/c/dec/bit_reader.c" 3 4
        1
# 71 "project/brotli/c/dec/bit_reader.c"
                   ;
}
