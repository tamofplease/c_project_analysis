# 0 "project/brotli/c/enc/backward_references_hq.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/brotli/c/enc/backward_references_hq.c"
# 9 "project/brotli/c/enc/backward_references_hq.c"
...
# 10 "project/brotli/c/enc/backward_references_hq.c" 2



# 1 "project/brotli/c/enc/../common/constants.h" 1
# 14 "project/brotli/c/enc/backward_references_hq.c" 2
# 1 "project/brotli/c/enc/../common/context.h" 1
# 15 "project/brotli/c/enc/backward_references_hq.c" 2
# 1 "project/brotli/c/enc/../common/platform.h" 1
# 16 "project/brotli/c/enc/backward_references_hq.c" 2

# 1 "project/brotli/c/enc/./command.h" 1
# 18 "project/brotli/c/enc/backward_references_hq.c" 2
# 1 "project/brotli/c/enc/./fast_log.h" 1
# 19 "project/brotli/c/enc/backward_references_hq.c" 2
# 1 "project/brotli/c/enc/./find_match_length.h" 1
# 20 "project/brotli/c/enc/backward_references_hq.c" 2
# 1 "project/brotli/c/enc/./literal_cost.h" 1
# 23 "project/brotli/c/enc/./literal_cost.h"
__attribute__ ((visibility ("hidden"))) void BrotliEstimateBitCostsForLiterals(
    size_t pos, size_t len, size_t mask, const uint8_t* data, float* cost);
# 21 "project/brotli/c/enc/backward_references_hq.c" 2
# 1 "project/brotli/c/enc/./memory.h" 1
# 22 "project/brotli/c/enc/backward_references_hq.c" 2
# 1 "project/brotli/c/enc/./params.h" 1
# 23 "project/brotli/c/enc/backward_references_hq.c" 2
# 1 "project/brotli/c/enc/./prefix.h" 1
# 24 "project/brotli/c/enc/backward_references_hq.c" 2
# 1 "project/brotli/c/enc/./quality.h" 1
# 25 "project/brotli/c/enc/backward_references_hq.c" 2
# 33 "project/brotli/c/enc/backward_references_hq.c"
...
static void InitZopfliCostModel(
  ...
  self->literal_costs_ = ((num_bytes + 2) > 0 ? ((float*)BrotliAllocate((m), (num_bytes + 2) * sizeof(float))) : 
# 92 "project/brotli/c/enc/backward_references_hq.c" 3 4
                        ((void *)0)
# 92 "project/brotli/c/enc/backward_references_hq.c"
                        );
  self->cost_dist_ = ((dist->alphabet_size_limit) > 0 ? ((float*)BrotliAllocate((m), (dist->alphabet_size_limit) * sizeof(float))) : 
# 93 "project/brotli/c/enc/backward_references_hq.c" 3 4
                    ((void *)0)
# 93 "project/brotli/c/enc/backward_references_hq.c"
                    );
...
static void CleanupZopfliCostModel(MemoryManager* m, ZopfliCostModel* self) {
  { BrotliFree((m), (self->literal_costs_)); self->literal_costs_ = 
# 99 "project/brotli/c/enc/backward_references_hq.c" 3 4
 ((void *)0)
# 99 "project/brotli/c/enc/backward_references_hq.c"
 ; };
  { BrotliFree((m), (self->cost_dist_)); self->cost_dist_ = 
# 100 "project/brotli/c/enc/backward_references_hq.c" 3 4
 ((void *)0)
# 100 "project/brotli/c/enc/backward_references_hq.c"
 ; };
}

static void SetCost(const uint32_t* histogram, size_t histogram_size,
                    
# 104 "project/brotli/c/enc/backward_references_hq.c" 3 4
                   int 
# 104 "project/brotli/c/enc/backward_references_hq.c"
                               literal_histogram, float* cost) {
  size_t sum = 0;
...
# 151 "project/brotli/c/enc/backward_references_hq.c" 3 4
 __builtin___memset_chk (
# 151 "project/brotli/c/enc/backward_references_hq.c"
 histogram_literal
# 151 "project/brotli/c/enc/backward_references_hq.c" 3 4
 , 
# 151 "project/brotli/c/enc/backward_references_hq.c"
...
# 152 "project/brotli/c/enc/backward_references_hq.c" 3 4
 __builtin___memset_chk (
# 152 "project/brotli/c/enc/backward_references_hq.c"
 histogram_cmd
# 152 "project/brotli/c/enc/backward_references_hq.c" 3 4
 , 
# 152 "project/brotli/c/enc/backward_references_hq.c"
...
# 153 "project/brotli/c/enc/backward_references_hq.c" 3 4
 __builtin___memset_chk (
# 153 "project/brotli/c/enc/backward_references_hq.c"
 histogram_dist
# 153 "project/brotli/c/enc/backward_references_hq.c" 3 4
 , 
# 153 "project/brotli/c/enc/backward_references_hq.c"
...
# 153 "project/brotli/c/enc/backward_references_hq.c"
  ...
  SetCost(histogram_literal, 256, 
# 172 "project/brotli/c/enc/backward_references_hq.c" 3 4
                                                        1
# 172 "project/brotli/c/enc/backward_references_hq.c"
                                                                   ,
          cost_literal);
  SetCost(histogram_cmd, 704, 
# 174 "project/brotli/c/enc/backward_references_hq.c" 3 4
                                                    0
# 174 "project/brotli/c/enc/backward_references_hq.c"
                                                                ,
          cost_cmd);
  SetCost(histogram_dist, self->distance_histogram_size, 
# 176 "project/brotli/c/enc/backward_references_hq.c" 3 4
                                                        0
# 176 "project/brotli/c/enc/backward_references_hq.c"
                                                                    ,
          self->cost_dist_);
...
# 360 "project/brotli/c/enc/backward_references_hq.c"
...
# 511 "project/brotli/c/enc/backward_references_hq.c" 3 4
       int 
# 511 "project/brotli/c/enc/backward_references_hq.c"
                   is_dictionary_match =
            
# 512 "project/brotli/c/enc/backward_references_hq.c" 3 4
           (!!(
# 512 "project/brotli/c/enc/backward_references_hq.c"
           dist > dictionary_start + gap
# 512 "project/brotli/c/enc/backward_references_hq.c" 3 4
           ) ? 1 : 0)
# 512 "project/brotli/c/enc/backward_references_hq.c"
                                                        ;
...
static size_t ComputeShortestPathFromNodes(size_t num_bytes,
  ...
  nodes[index].u.next = 
# 560 "project/brotli/c/enc/backward_references_hq.c" 3 4
                       (~((uint32_t)0))
# 560 "project/brotli/c/enc/backward_references_hq.c"
                                        ;
  while (index != 0) {
...
void BrotliZopfliCreateCommands(const size_t num_bytes,
  ...
  size_t gap = 0;
  for (i = 0; offset != 
# 581 "project/brotli/c/enc/backward_references_hq.c" 3 4
                       (~((uint32_t)0))
# 581 "project/brotli/c/enc/backward_references_hq.c"
                                        ; i++) {
...
# 596 "project/brotli/c/enc/backward_references_hq.c" 3 4
     int 
# 596 "project/brotli/c/enc/backward_references_hq.c"
                 is_dictionary =
          
# 597 "project/brotli/c/enc/backward_references_hq.c" 3 4
         (!!(
# 597 "project/brotli/c/enc/backward_references_hq.c"
         distance > dictionary_start + gap
# 597 "project/brotli/c/enc/backward_references_hq.c" 3 4
         ) ? 1 : 0)
# 597 "project/brotli/c/enc/backward_references_hq.c"
                                                          ;
...
void BrotliCreateZopfliBackwardReferences(MemoryManager* m, size_t num_bytes,
    ...
    Hasher* hasher, int* dist_cache, size_t* last_insert_len,
    Command* commands, size_t* num_commands, size_t* num_literals) {
  ZopfliNode* nodes = ((num_bytes + 1) > 0 ? ((ZopfliNode*)BrotliAllocate((m), (num_bytes + 1) * sizeof(ZopfliNode))) : 
# 727 "project/brotli/c/enc/backward_references_hq.c" 3 4
                     ((void *)0)
# 727 "project/brotli/c/enc/backward_references_hq.c"
                     );
  if ((!!0) || (!!0)) return;
...
# 736 "project/brotli/c/enc/backward_references_hq.c" 3 4
 ((void *)0)
# 736 "project/brotli/c/enc/backward_references_hq.c"
 ; };
}
...
void BrotliCreateHqZopfliBackwardReferences(MemoryManager* m, size_t num_bytes,
  ...
  const size_t stream_offset = params->stream_offset;
  const size_t max_backward_limit = (((size_t)1 << (params->lgwin)) - 16);
  uint32_t* num_matches = ((num_bytes) > 0 ? ((uint32_t*)BrotliAllocate((m), (num_bytes) * sizeof(uint32_t))) : 
# 746 "project/brotli/c/enc/backward_references_hq.c" 3 4
                         ((void *)0)
# 746 "project/brotli/c/enc/backward_references_hq.c"
                         );
  ...
  ZopfliCostModel model;
  ZopfliNode* nodes;
  BackwardMatch* matches = ((matches_size) > 0 ? ((BackwardMatch*)BrotliAllocate((m), (matches_size) * sizeof(BackwardMatch))) : 
# 758 "project/brotli/c/enc/backward_references_hq.c" 3 4
                          ((void *)0)
# 758 "project/brotli/c/enc/backward_references_hq.c"
                          );
  size_t gap = 0;
  ...
  for (i = 0; i + HashTypeLengthH10() - 1 < num_bytes; ++i) {
    ...
    { if (matches_size < (cur_match_pos + 128 + shadow_matches)) { size_t _new_size = (matches_size == 0) ? (cur_match_pos + 128 + shadow_matches) : matches_size; BackwardMatch* new_array; while (_new_size < (cur_match_pos + 128 + shadow_matches)) _new_size *= 2; new_array = ((_new_size) > 0 ? ((BackwardMatch*)BrotliAllocate(((m)), (_new_size) * sizeof(BackwardMatch))) : 
# 776 "project/brotli/c/enc/backward_references_hq.c" 3 4
   ((void *)0)
# 776 "project/brotli/c/enc/backward_references_hq.c"
...
# 776 "project/brotli/c/enc/backward_references_hq.c" 3 4
   , 
# 776 "project/brotli/c/enc/backward_references_hq.c"
   matches, matches_size * sizeof(BackwardMatch)
# 776 "project/brotli/c/enc/backward_references_hq.c" 3 4
   , __builtin_object_size (
# 776 "project/brotli/c/enc/backward_references_hq.c"
   new_array
# 776 "project/brotli/c/enc/backward_references_hq.c" 3 4
   , 0))
# 776 "project/brotli/c/enc/backward_references_hq.c"
   ; { BrotliFree(((m)), (matches)); matches = 
# 776 "project/brotli/c/enc/backward_references_hq.c" 3 4
   ((void *)0)
# 776 "project/brotli/c/enc/backward_references_hq.c"
   ; }; matches = new_array; matches_size = _new_size; } }
                                                             ;
    if ((!!0)) return;
...
# 800 "project/brotli/c/enc/backward_references_hq.c" 3 4
       __builtin___memset_chk (
# 800 "project/brotli/c/enc/backward_references_hq.c"
       &num_matches[i + 1]
# 800 "project/brotli/c/enc/backward_references_hq.c" 3 4
       , 
# 800 "project/brotli/c/enc/backward_references_hq.c"
       0, skip * sizeof(num_matches[0])
# 800 "project/brotli/c/enc/backward_references_hq.c" 3 4
       , __builtin_object_size (
# 800 "project/brotli/c/enc/backward_references_hq.c"
       &num_matches[i + 1]
...
# 809 "project/brotli/c/enc/backward_references_hq.c" 3 4
 __builtin___memcpy_chk (
# 809 "project/brotli/c/enc/backward_references_hq.c"
 orig_dist_cache
# 809 "project/brotli/c/enc/backward_references_hq.c" 3 4
 , 
# 809 "project/brotli/c/enc/backward_references_hq.c"
...
# 809 "project/brotli/c/enc/backward_references_hq.c"
  ...
  nodes = ((num_bytes + 1) > 0 ? ((ZopfliNode*)BrotliAllocate((m), (num_bytes + 1) * sizeof(ZopfliNode))) : 
# 811 "project/brotli/c/enc/backward_references_hq.c" 3 4
         ((void *)0)
# 811 "project/brotli/c/enc/backward_references_hq.c"
         );
  if ((!!0) || (!!0)) return;
  InitZopfliCostModel(m, &model, &params->dist, num_bytes);
  if ((!!0)) return;
...
# 828 "project/brotli/c/enc/backward_references_hq.c" 3 4
   __builtin___memcpy_chk (
# 828 "project/brotli/c/enc/backward_references_hq.c"
   dist_cache
# 828 "project/brotli/c/enc/backward_references_hq.c" 3 4
   , 
# 828 "project/brotli/c/enc/backward_references_hq.c"
   orig_dist_cache, 4 * sizeof(dist_cache[0])
# 828 "project/brotli/c/enc/backward_references_hq.c" 3 4
   , __builtin_object_size (
# 828 "project/brotli/c/enc/backward_references_hq.c"
   dist_cache
...
# 828 "project/brotli/c/enc/backward_references_hq.c"
  ...
  CleanupZopfliCostModel(m, &model);
  { BrotliFree((m), (nodes)); nodes = 
# 836 "project/brotli/c/enc/backward_references_hq.c" 3 4
 ((void *)0)
# 836 "project/brotli/c/enc/backward_references_hq.c"
 ; };
  { BrotliFree((m), (matches)); matches = 
# 837 "project/brotli/c/enc/backward_references_hq.c" 3 4
 ((void *)0)
# 837 "project/brotli/c/enc/backward_references_hq.c"
 ; };
  { BrotliFree((m), (num_matches)); num_matches = 
# 838 "project/brotli/c/enc/backward_references_hq.c" 3 4
 ((void *)0)
# 838 "project/brotli/c/enc/backward_references_hq.c"
 ; };
}
