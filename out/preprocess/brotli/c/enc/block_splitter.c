# 0 "project/brotli/c/enc/block_splitter.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/brotli/c/enc/block_splitter.c"
# 9 "project/brotli/c/enc/block_splitter.c"
# 1 "project/brotli/c/enc/./block_splitter.h" 1
# 12 "project/brotli/c/enc/./block_splitter.h"
...
# 13 "project/brotli/c/enc/./block_splitter.h" 2
...
# 15 "project/brotli/c/enc/./block_splitter.h" 2
...
# 16 "project/brotli/c/enc/./block_splitter.h" 2
...
# 17 "project/brotli/c/enc/./block_splitter.h" 2
...
__attribute__ ((visibility ("hidden"))) void BrotliInitBlockSplit(BlockSplit* self);
__attribute__ ((visibility ("hidden"))) void BrotliDestroyBlockSplit(MemoryManager* m,
                                             BlockSplit* self);

__attribute__ ((visibility ("hidden"))) void BrotliSplitBlock(MemoryManager* m,
                                      const Command* cmds,
...
# 10 "project/brotli/c/enc/block_splitter.c" 2



# 1 "project/brotli/c/enc/../common/platform.h" 1
# 14 "project/brotli/c/enc/block_splitter.c" 2
# 1 "project/brotli/c/enc/./bit_cost.h" 1
# 14 "project/brotli/c/enc/./bit_cost.h"
# 1 "project/brotli/c/enc/././fast_log.h" 1
# 15 "project/brotli/c/enc/./bit_cost.h" 2
# 1 "project/brotli/c/enc/././histogram.h" 1
# 15 "project/brotli/c/enc/././histogram.h"
...
# 16 "project/brotli/c/enc/././histogram.h" 2


# 1 "project/brotli/c/enc/./././block_splitter.h" 1
# 19 "project/brotli/c/enc/././histogram.h" 2
# 1 "project/brotli/c/enc/./././command.h" 1
# 20 "project/brotli/c/enc/././histogram.h" 2
# 31 "project/brotli/c/enc/././histogram.h"
# 1 "project/brotli/c/enc/./././histogram_inc.h" 1
# 12 "project/brotli/c/enc/./././histogram_inc.h"
...
static inline __attribute__((__always_inline__)) void HistogramClearLiteral(HistogramLiteral* self) {
  
# 19 "project/brotli/c/enc/./././histogram_inc.h" 3 4
 __builtin___memset_chk (
# 19 "project/brotli/c/enc/./././histogram_inc.h"
 self->data_
# 19 "project/brotli/c/enc/./././histogram_inc.h" 3 4
 , 
# 19 "project/brotli/c/enc/./././histogram_inc.h"
...
# 19 "project/brotli/c/enc/./././histogram_inc.h"
  ...
  self->total_count_ = 0;
  self->bit_cost_ = 
# 21 "project/brotli/c/enc/./././histogram_inc.h" 3 4
                   __builtin_huge_val()
# 21 "project/brotli/c/enc/./././histogram_inc.h"
                           ;
}

static inline __attribute__((__always_inline__)) void ClearHistogramsLiteral(
    HistogramLiteral* array, size_t length) {
  size_t i;
  for (i = 0; i < length; ++i) HistogramClearLiteral(array + i);
}

static inline __attribute__((__always_inline__)) void HistogramAddLiteral(HistogramLiteral* self, size_t val) {
  ++self->data_[val];
  ++self->total_count_;
}

static inline __attribute__((__always_inline__)) void HistogramAddVectorLiteral(HistogramLiteral* self,
...
static inline __attribute__((__always_inline__)) void HistogramAddHistogramLiteral(HistogramLiteral* self,
    const HistogramLiteral* v) {
  size_t i;
...
static inline __attribute__((__always_inline__)) size_t HistogramDataSizeLiteral(void) { return 256; }
# 32 "project/brotli/c/enc/././histogram.h" 2
...
static inline __attribute__((__always_inline__)) void HistogramClearCommand(HistogramCommand* self) {
...
static inline __attribute__((__always_inline__)) void ClearHistogramsCommand(
    HistogramCommand* array, size_t length) {
  size_t i;
  for (i = 0; i < length; ++i) HistogramClearCommand(array + i);
}

static inline __attribute__((__always_inline__)) void HistogramAddCommand(HistogramCommand* self, size_t val) {
  ++self->data_[val];
  ++self->total_count_;
}

static inline __attribute__((__always_inline__)) void HistogramAddVectorCommand(HistogramCommand* self,
    const uint16_t* p, size_t n) {
  self->total_count_ += n;
  n += 1;
  while (--n) ++self->data_[*p++];
}

static inline __attribute__((__always_inline__)) void HistogramAddHistogramCommand(HistogramCommand* self,
    const HistogramCommand* v) {
  size_t i;
  self->total_count_ += v->total_count_;
  for (i = 0; i < 704; ++i) {
    self->data_[i] += v->data_[i];
...
static inline __attribute__((__always_inline__)) size_t HistogramDataSizeCommand(void) { return 704; }
# 40 "project/brotli/c/enc/././histogram.h" 2
...
static inline __attribute__((__always_inline__)) void HistogramClearDistance(HistogramDistance* self) {
...
static inline __attribute__((__always_inline__)) void ClearHistogramsDistance(
    HistogramDistance* array, size_t length) {
  size_t i;
  for (i = 0; i < length; ++i) HistogramClearDistance(array + i);
}

static inline __attribute__((__always_inline__)) void HistogramAddDistance(HistogramDistance* self, size_t val) {
  ++self->data_[val];
  ++self->total_count_;
}

static inline __attribute__((__always_inline__)) void HistogramAddVectorDistance(HistogramDistance* self,
    const uint16_t* p, size_t n) {
  self->total_count_ += n;
  n += 1;
  while (--n) ++self->data_[*p++];
...
static inline __attribute__((__always_inline__)) void HistogramAddHistogramDistance(HistogramDistance* self,
    const HistogramDistance* v) {
  size_t i;
  self->total_count_ += v->total_count_;
  for (i = 0; i < 544; ++i) {
    self->data_[i] += v->data_[i];
...
static inline __attribute__((__always_inline__)) size_t HistogramDataSizeDistance(void) { return 544; }
# 46 "project/brotli/c/enc/././histogram.h" 2




__attribute__ ((visibility ("hidden"))) void BrotliBuildHistogramsWithContext(
...
# 16 "project/brotli/c/enc/./bit_cost.h" 2





static inline __attribute__((__always_inline__)) double ShannonEntropy(
...
static inline __attribute__((__always_inline__)) double BitsEntropy(
...
__attribute__ ((visibility ("hidden"))) double BrotliPopulationCostLiteral(const HistogramLiteral*);
__attribute__ ((visibility ("hidden"))) double BrotliPopulationCostCommand(const HistogramCommand*);
__attribute__ ((visibility ("hidden"))) double BrotliPopulationCostDistance(const HistogramDistance*);
# 15 "project/brotli/c/enc/block_splitter.c" 2
# 1 "project/brotli/c/enc/./cluster.h" 1
# 21 "project/brotli/c/enc/./cluster.h"
...
# 1 "project/brotli/c/enc/././cluster_inc.h" 1
# 14 "project/brotli/c/enc/././cluster_inc.h"
__attribute__ ((visibility ("hidden"))) void BrotliCompareAndPushToQueueLiteral(
    const HistogramLiteral* out, const uint32_t* cluster_size, uint32_t idx1,
    uint32_t idx2, size_t max_num_pairs, HistogramPair* pairs,
    size_t* num_pairs) ;
# 70 "project/brotli/c/enc/././cluster_inc.h"
__attribute__ ((visibility ("hidden"))) size_t BrotliHistogramCombineLiteral(HistogramLiteral* out,
...
# 157 "project/brotli/c/enc/././cluster_inc.h"
__attribute__ ((visibility ("hidden"))) double BrotliHistogramBitCostDistanceLiteral(
    const HistogramLiteral* histogram, const HistogramLiteral* candidate) ;
# 172 "project/brotli/c/enc/././cluster_inc.h"
__attribute__ ((visibility ("hidden"))) void BrotliHistogramRemapLiteral(const HistogramLiteral* in,
    size_t in_size, const uint32_t* clusters, size_t num_clusters,
    HistogramLiteral* out, uint32_t* symbols) ;
# 211 "project/brotli/c/enc/././cluster_inc.h"
__attribute__ ((visibility ("hidden"))) size_t BrotliHistogramReindexLiteral(MemoryManager* m,
    HistogramLiteral* out, uint32_t* symbols, size_t length) ;
# 249 "project/brotli/c/enc/././cluster_inc.h"
__attribute__ ((visibility ("hidden"))) void BrotliClusterHistogramsLiteral(
    MemoryManager* m, const HistogramLiteral* in, const size_t in_size,
    size_t max_histograms, HistogramLiteral* out, size_t* out_size,
    uint32_t* histogram_symbols) ;
# 32 "project/brotli/c/enc/./cluster.h" 2



# 1 "project/brotli/c/enc/././cluster_inc.h" 1
# 14 "project/brotli/c/enc/././cluster_inc.h"
__attribute__ ((visibility ("hidden"))) void BrotliCompareAndPushToQueueCommand(
    const HistogramCommand* out, const uint32_t* cluster_size, uint32_t idx1,
    uint32_t idx2, size_t max_num_pairs, HistogramPair* pairs,
    size_t* num_pairs) ;
# 70 "project/brotli/c/enc/././cluster_inc.h"
__attribute__ ((visibility ("hidden"))) size_t BrotliHistogramCombineCommand(HistogramCommand* out,
                                                  uint32_t* cluster_size,
                                                  uint32_t* symbols,
                                                  uint32_t* clusters,
                                                  HistogramPair* pairs,
                                                  ...
                                                  size_t max_num_pairs) ;
# 157 "project/brotli/c/enc/././cluster_inc.h"
__attribute__ ((visibility ("hidden"))) double BrotliHistogramBitCostDistanceCommand(
    const HistogramCommand* histogram, const HistogramCommand* candidate) ;
# 172 "project/brotli/c/enc/././cluster_inc.h"
__attribute__ ((visibility ("hidden"))) void BrotliHistogramRemapCommand(const HistogramCommand* in,
    size_t in_size, const uint32_t* clusters, size_t num_clusters,
    HistogramCommand* out, uint32_t* symbols) ;
# 211 "project/brotli/c/enc/././cluster_inc.h"
__attribute__ ((visibility ("hidden"))) size_t BrotliHistogramReindexCommand(MemoryManager* m,
    HistogramCommand* out, uint32_t* symbols, size_t length) ;
# 249 "project/brotli/c/enc/././cluster_inc.h"
__attribute__ ((visibility ("hidden"))) void BrotliClusterHistogramsCommand(
    MemoryManager* m, const HistogramCommand* in, const size_t in_size,
    size_t max_histograms, HistogramCommand* out, size_t* out_size,
    uint32_t* histogram_symbols) ;
# 36 "project/brotli/c/enc/./cluster.h" 2



# 1 "project/brotli/c/enc/././cluster_inc.h" 1
# 14 "project/brotli/c/enc/././cluster_inc.h"
__attribute__ ((visibility ("hidden"))) void BrotliCompareAndPushToQueueDistance(
    const HistogramDistance* out, const uint32_t* cluster_size, uint32_t idx1,
    uint32_t idx2, size_t max_num_pairs, HistogramPair* pairs,
    size_t* num_pairs) ;
# 70 "project/brotli/c/enc/././cluster_inc.h"
__attribute__ ((visibility ("hidden"))) size_t BrotliHistogramCombineDistance(HistogramDistance* out,
                                                  uint32_t* cluster_size,
                                                  uint32_t* symbols,
                                                  uint32_t* clusters,
                                                  HistogramPair* pairs,
                                                  ...
                                                  size_t max_num_pairs) ;
# 157 "project/brotli/c/enc/././cluster_inc.h"
__attribute__ ((visibility ("hidden"))) double BrotliHistogramBitCostDistanceDistance(
    const HistogramDistance* histogram, const HistogramDistance* candidate) ;
# 172 "project/brotli/c/enc/././cluster_inc.h"
__attribute__ ((visibility ("hidden"))) void BrotliHistogramRemapDistance(const HistogramDistance* in,
    size_t in_size, const uint32_t* clusters, size_t num_clusters,
    HistogramDistance* out, uint32_t* symbols) ;
# 211 "project/brotli/c/enc/././cluster_inc.h"
__attribute__ ((visibility ("hidden"))) size_t BrotliHistogramReindexDistance(MemoryManager* m,
    HistogramDistance* out, uint32_t* symbols, size_t length) ;
# 249 "project/brotli/c/enc/././cluster_inc.h"
__attribute__ ((visibility ("hidden"))) void BrotliClusterHistogramsDistance(
    MemoryManager* m, const HistogramDistance* in, const size_t in_size,
    size_t max_histograms, HistogramDistance* out, size_t* out_size,
    uint32_t* histogram_symbols) ;
# 40 "project/brotli/c/enc/./cluster.h" 2
# 16 "project/brotli/c/enc/block_splitter.c" 2
# 1 "project/brotli/c/enc/./command.h" 1
# 17 "project/brotli/c/enc/block_splitter.c" 2
# 1 "project/brotli/c/enc/./fast_log.h" 1
# 18 "project/brotli/c/enc/block_splitter.c" 2
# 1 "project/brotli/c/enc/./histogram.h" 1
# 19 "project/brotli/c/enc/block_splitter.c" 2
# 1 "project/brotli/c/enc/./memory.h" 1
# 20 "project/brotli/c/enc/block_splitter.c" 2
# 1 "project/brotli/c/enc/./quality.h" 1
# 21 "project/brotli/c/enc/block_splitter.c" 2
...
# 63 "project/brotli/c/enc/block_splitter.c" 3 4
     __builtin___memcpy_chk (
# 63 "project/brotli/c/enc/block_splitter.c"
     literals + pos
# 63 "project/brotli/c/enc/block_splitter.c" 3 4
     , 
# 63 "project/brotli/c/enc/block_splitter.c"
     data + from_pos, head_size
# 63 "project/brotli/c/enc/block_splitter.c" 3 4
     , __builtin_object_size (
# 63 "project/brotli/c/enc/block_splitter.c"
     literals + pos
...
# 69 "project/brotli/c/enc/block_splitter.c" 3 4
     __builtin___memcpy_chk (
# 69 "project/brotli/c/enc/block_splitter.c"
     literals + pos
# 69 "project/brotli/c/enc/block_splitter.c" 3 4
     , 
# 69 "project/brotli/c/enc/block_splitter.c"
     data + from_pos, insert_len
# 69 "project/brotli/c/enc/block_splitter.c" 3 4
     , __builtin_object_size (
# 69 "project/brotli/c/enc/block_splitter.c"
     literals + pos
...
static inline __attribute__((__always_inline__)) uint32_t MyRand(uint32_t* seed) {

  *seed *= 16807U;
  return *seed;
}

static inline __attribute__((__always_inline__)) double BitCost(size_t count) {
...
# 1 "project/brotli/c/enc/./block_splitter_inc.h" 1
# 12 "project/brotli/c/enc/./block_splitter_inc.h"
static void InitialEntropyCodesLiteral(const uint8_t* data, size_t length,
                                    size_t stride,
...
static void RandomSampleLiteral(uint32_t* seed,
                             const uint8_t* data,
                             size_t length,
                             size_t stride,
...
static void RefineEntropyCodesLiteral(const uint8_t* data, size_t length,
                                   size_t stride,
                                   size_t num_histograms,
                                   HistogramLiteral* histograms) {
  size_t iters =
...
static size_t FindBlocksLiteral(const uint8_t* data, const size_t length,
                             const double block_switch_bitcost,
                             const size_t num_histograms,
                             const HistogramLiteral* histograms,
                             double* insert_cost,
                             double* cost,
...
# 86 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 __builtin___memset_chk (
# 86 "project/brotli/c/enc/./block_splitter_inc.h"
 insert_cost
# 86 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 , 
# 86 "project/brotli/c/enc/./block_splitter_inc.h"
 0, sizeof(insert_cost[0]) * data_size * num_histograms
# 86 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 , __builtin_object_size (
# 86 "project/brotli/c/enc/./block_splitter_inc.h"
 insert_cost
...
# 97 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 __builtin___memset_chk (
# 97 "project/brotli/c/enc/./block_splitter_inc.h"
 cost
# 97 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 , 
# 97 "project/brotli/c/enc/./block_splitter_inc.h"
 0, sizeof(cost[0]) * num_histograms
# 97 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 , __builtin_object_size (
# 97 "project/brotli/c/enc/./block_splitter_inc.h"
 cost
...
# 98 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 __builtin___memset_chk (
# 98 "project/brotli/c/enc/./block_splitter_inc.h"
 switch_signal
# 98 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 , 
# 98 "project/brotli/c/enc/./block_splitter_inc.h"
 0, sizeof(switch_signal[0]) * length * bitmaplen
# 98 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 , __builtin_object_size (
# 98 "project/brotli/c/enc/./block_splitter_inc.h"
 switch_signal
...
static size_t RemapBlockIdsLiteral(uint8_t* block_ids, const size_t length,
...
static void BuildBlockHistogramsLiteral(const uint8_t* data, const size_t length,
...
static void ClusterBlocksLiteral(MemoryManager* m,
                              const uint8_t* data, const size_t length,
                              const size_t num_blocks,
                              uint8_t* block_ids,
                              BlockSplit* split) {
  uint32_t* histogram_symbols = ((num_blocks) > 0 ? ((uint32_t*)BrotliAllocate((m), (num_blocks) * sizeof(uint32_t))) : 
# 193 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
                               ((void *)0)
# 193 "project/brotli/c/enc/./block_splitter_inc.h"
                               );
  uint32_t* block_lengths = ((num_blocks) > 0 ? ((uint32_t*)BrotliAllocate((m), (num_blocks) * sizeof(uint32_t))) : 
# 194 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
                           ((void *)0)
# 194 "project/brotli/c/enc/./block_splitter_inc.h"
                           );
  const size_t expected_num_clusters = 16 *
      (num_blocks + 64 - 1) / 64;
  size_t all_histograms_size = 0;
  size_t all_histograms_capacity = expected_num_clusters;
  HistogramLiteral* all_histograms =
      ((all_histograms_capacity) > 0 ? ((HistogramLiteral*)BrotliAllocate((m), (all_histograms_capacity) * sizeof(HistogramLiteral))) : 
# 200 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
     ((void *)0)
# 200 "project/brotli/c/enc/./block_splitter_inc.h"
     );
  size_t cluster_size_size = 0;
  size_t cluster_size_capacity = expected_num_clusters;
  uint32_t* cluster_size = ((cluster_size_capacity) > 0 ? ((uint32_t*)BrotliAllocate((m), (cluster_size_capacity) * sizeof(uint32_t))) : 
# 203 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
                          ((void *)0)
# 203 "project/brotli/c/enc/./block_splitter_inc.h"
                          );
  size_t num_clusters = 0;
  HistogramLiteral* histograms = (((brotli_min_size_t((num_blocks), (64)))) > 0 ? ((HistogramLiteral*)BrotliAllocate((m), ((brotli_min_size_t((num_blocks), (64)))) * sizeof(HistogramLiteral))) : 
# 205 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
                             ((void *)0)
# 205 "project/brotli/c/enc/./block_splitter_inc.h"
                             )
                                                           ;
  size_t max_num_pairs =
      64 * 64 / 2;
  size_t pairs_capacity = max_num_pairs + 1;
  HistogramPair* pairs = ((pairs_capacity) > 0 ? ((HistogramPair*)BrotliAllocate((m), (pairs_capacity) * sizeof(HistogramPair))) : 
# 210 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
                        ((void *)0)
# 210 "project/brotli/c/enc/./block_splitter_inc.h"
                        );
  size_t pos = 0;
  uint32_t* clusters;
  size_t num_final_clusters;
  static const uint32_t kInvalidIndex = 
# 214 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
                                       (~((uint32_t)0))
# 214 "project/brotli/c/enc/./block_splitter_inc.h"
                                                        ;
  uint32_t* new_index;
  size_t i;
  uint32_t sizes[64] = { 0 };
...
# 229 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 __builtin___memset_chk (
# 229 "project/brotli/c/enc/./block_splitter_inc.h"
 block_lengths
# 229 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 , 
# 229 "project/brotli/c/enc/./block_splitter_inc.h"
...
# 229 "project/brotli/c/enc/./block_splitter_inc.h"
  ...
  for (i = 0; i < num_blocks; i += 64) {
    const size_t num_to_combine =
        (brotli_min_size_t((num_blocks - i), (64)));
    ...
    num_new_clusters = BrotliHistogramCombineLiteral(
        ...
        num_to_combine, 64, max_num_pairs);
    { if (all_histograms_capacity < (all_histograms_size + num_new_clusters)) { size_t _new_size = (all_histograms_capacity == 0) ? (all_histograms_size + num_new_clusters) : all_histograms_capacity; HistogramLiteral* new_array; while (_new_size < (all_histograms_size + num_new_clusters)) _new_size *= 2; new_array = ((_new_size) > 0 ? ((HistogramLiteral*)BrotliAllocate(((m)), (_new_size) * sizeof(HistogramLiteral))) : 
# 262 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   ((void *)0)
# 262 "project/brotli/c/enc/./block_splitter_inc.h"
...
# 262 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   , 
# 262 "project/brotli/c/enc/./block_splitter_inc.h"
   all_histograms, all_histograms_capacity * sizeof(HistogramLiteral)
# 262 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   , __builtin_object_size (
# 262 "project/brotli/c/enc/./block_splitter_inc.h"
   new_array
# 262 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   , 0))
# 262 "project/brotli/c/enc/./block_splitter_inc.h"
   ; { BrotliFree(((m)), (all_histograms)); all_histograms = 
# 262 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   ((void *)0)
# 262 "project/brotli/c/enc/./block_splitter_inc.h"
   ; }; all_histograms = new_array; all_histograms_capacity = _new_size; } }
                                                                        ;
...
# 264 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   ((void *)0)
# 264 "project/brotli/c/enc/./block_splitter_inc.h"
...
# 264 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   , 
# 264 "project/brotli/c/enc/./block_splitter_inc.h"
   cluster_size, cluster_size_capacity * sizeof(uint32_t)
# 264 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   , __builtin_object_size (
# 264 "project/brotli/c/enc/./block_splitter_inc.h"
   new_array
# 264 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   , 0))
# 264 "project/brotli/c/enc/./block_splitter_inc.h"
   ; { BrotliFree(((m)), (cluster_size)); cluster_size = 
# 264 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   ((void *)0)
# 264 "project/brotli/c/enc/./block_splitter_inc.h"
   ; }; cluster_size = new_array; cluster_size_capacity = _new_size; } }
                                                                    ;
    if ((!!0)) return;
  ...
  { BrotliFree((m), (histograms)); histograms = 
# 279 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 ((void *)0)
# 279 "project/brotli/c/enc/./block_splitter_inc.h"
 ; };

  max_num_pairs =
      (brotli_min_size_t((64 * num_clusters), ((num_clusters / 2) * num_clusters)));
  if (pairs_capacity < max_num_pairs + 1) {
    { BrotliFree((m), (pairs)); pairs = 
# 284 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   ((void *)0)
# 284 "project/brotli/c/enc/./block_splitter_inc.h"
   ; };
    pairs = ((max_num_pairs + 1) > 0 ? ((HistogramPair*)BrotliAllocate((m), (max_num_pairs + 1) * sizeof(HistogramPair))) : 
# 285 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
           ((void *)0)
# 285 "project/brotli/c/enc/./block_splitter_inc.h"
           );
    if ((!!0) || (!!0)) return;
  }

  clusters = ((num_clusters) > 0 ? ((uint32_t*)BrotliAllocate((m), (num_clusters) * sizeof(uint32_t))) : 
# 289 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
            ((void *)0)
# 289 "project/brotli/c/enc/./block_splitter_inc.h"
            );
  if ((!!0) || (!!0)) return;
  ...
  num_final_clusters = BrotliHistogramCombineLiteral(
      ...
      num_clusters, num_blocks, 256,
      max_num_pairs);
  { BrotliFree((m), (pairs)); pairs = 
# 298 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 ((void *)0)
# 298 "project/brotli/c/enc/./block_splitter_inc.h"
 ; };
  { BrotliFree((m), (cluster_size)); cluster_size = 
# 299 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 ((void *)0)
# 299 "project/brotli/c/enc/./block_splitter_inc.h"
 ; };

  new_index = ((num_clusters) > 0 ? ((uint32_t*)BrotliAllocate((m), (num_clusters) * sizeof(uint32_t))) : 
# 301 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
             ((void *)0)
# 301 "project/brotli/c/enc/./block_splitter_inc.h"
             );
  if ((!!0) || (!!0)) return;
  ...
  pos = 0;
  {
    ...
    for (i = 0; i < num_blocks; ++i) {
      ...
      best_bits =
          BrotliHistogramBitCostDistanceLiteral(&histo, &all_histograms[best_out]);
      for (j = 0; j < num_final_clusters; ++j) {
        const double cur_bits = BrotliHistogramBitCostDistanceLiteral(
  ...
  { BrotliFree((m), (clusters)); clusters = 
# 333 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 ((void *)0)
# 333 "project/brotli/c/enc/./block_splitter_inc.h"
 ; };
  { BrotliFree((m), (all_histograms)); all_histograms = 
# 334 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 ((void *)0)
# 334 "project/brotli/c/enc/./block_splitter_inc.h"
 ; };
  { if (split->types_alloc_size < (num_blocks)) { size_t _new_size = (split->types_alloc_size == 0) ? (num_blocks) : split->types_alloc_size; uint8_t* new_array; while (_new_size < (num_blocks)) _new_size *= 2; new_array = ((_new_size) > 0 ? ((uint8_t*)BrotliAllocate(((m)), (_new_size) * sizeof(uint8_t))) : 
# 335 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 ((void *)0)
# 335 "project/brotli/c/enc/./block_splitter_inc.h"
...
# 335 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 , 
# 335 "project/brotli/c/enc/./block_splitter_inc.h"
 split->types, split->types_alloc_size * sizeof(uint8_t)
# 335 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 , __builtin_object_size (
# 335 "project/brotli/c/enc/./block_splitter_inc.h"
 new_array
# 335 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 , 0))
# 335 "project/brotli/c/enc/./block_splitter_inc.h"
 ; { BrotliFree(((m)), (split->types)); split->types = 
# 335 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 ((void *)0)
# 335 "project/brotli/c/enc/./block_splitter_inc.h"
 ; }; split->types = new_array; split->types_alloc_size = _new_size; } }
                                                                    ;
  { if (split->lengths_alloc_size < (num_blocks)) { size_t _new_size = (split->lengths_alloc_size == 0) ? (num_blocks) : split->lengths_alloc_size; uint32_t* new_array; while (_new_size < (num_blocks)) _new_size *= 2; new_array = ((_new_size) > 0 ? ((uint32_t*)BrotliAllocate(((m)), (_new_size) * sizeof(uint32_t))) : 
# 337 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 ((void *)0)
# 337 "project/brotli/c/enc/./block_splitter_inc.h"
...
# 337 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 ((void *)0)
# 337 "project/brotli/c/enc/./block_splitter_inc.h"
 ; }; split->lengths = new_array; split->lengths_alloc_size = _new_size; } }
                                                                         ;
  if ((!!0)) return;
  {
  ...
  { BrotliFree((m), (new_index)); new_index = 
# 359 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 ((void *)0)
# 359 "project/brotli/c/enc/./block_splitter_inc.h"
 ; };
  { BrotliFree((m), (block_lengths)); block_lengths = 
# 360 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 ((void *)0)
# 360 "project/brotli/c/enc/./block_splitter_inc.h"
 ; };
  { BrotliFree((m), (histogram_symbols)); histogram_symbols = 
# 361 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
 ((void *)0)
# 361 "project/brotli/c/enc/./block_splitter_inc.h"
 ; };
}

static void SplitByteVectorLiteral(MemoryManager* m,
                                const uint8_t* data, const size_t length,
  ...
  if (length == 0) {
    ...
    { if (split->types_alloc_size < (split->num_blocks + 1)) { size_t _new_size = (split->types_alloc_size == 0) ? (split->num_blocks + 1) : split->types_alloc_size; uint8_t* new_array; while (_new_size < (split->num_blocks + 1)) _new_size *= 2; new_array = ((_new_size) > 0 ? ((uint8_t*)BrotliAllocate(((m)), (_new_size) * sizeof(uint8_t))) : 
# 382 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   ((void *)0)
# 382 "project/brotli/c/enc/./block_splitter_inc.h"
   ); if (!(!!0) && !(!!0) && split->types_alloc_size != 0) 
# 382 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   __builtin___memcpy_chk (
# 382 "project/brotli/c/enc/./block_splitter_inc.h"
...
# 382 "project/brotli/c/enc/./block_splitter_inc.h"
   ; }; split->types = new_array; split->types_alloc_size = _new_size; } }
                                                                     ;
    { if (split->lengths_alloc_size < (split->num_blocks + 1)) { size_t _new_size = (split->lengths_alloc_size == 0) ? (split->num_blocks + 1) : split->lengths_alloc_size; uint32_t* new_array; while (_new_size < (split->num_blocks + 1)) _new_size *= 2; new_array = ((_new_size) > 0 ? ((uint32_t*)BrotliAllocate(((m)), (_new_size) * sizeof(uint32_t))) : 
# 384 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   ((void *)0)
# 384 "project/brotli/c/enc/./block_splitter_inc.h"
   ); if (!(!!0) && !(!!0) && split->lengths_alloc_size != 0) 
# 384 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   __builtin___memcpy_chk (
# 384 "project/brotli/c/enc/./block_splitter_inc.h"
...
# 384 "project/brotli/c/enc/./block_splitter_inc.h"
  ...
  histograms = ((num_histograms) > 0 ? ((HistogramLiteral*)BrotliAllocate((m), (num_histograms) * sizeof(HistogramLiteral))) : 
# 393 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
              ((void *)0)
# 393 "project/brotli/c/enc/./block_splitter_inc.h"
              );
  if ((!!0) || (!!0)) return;
                         ...
                         num_histograms, histograms);
  {
    ...
    uint8_t* block_ids = ((length) > 0 ? ((uint8_t*)BrotliAllocate((m), (length) * sizeof(uint8_t))) : 
# 404 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
                        ((void *)0)
# 404 "project/brotli/c/enc/./block_splitter_inc.h"
                        );
    size_t num_blocks = 0;
    const size_t bitmaplen = (num_histograms + 7) >> 3;
    double* insert_cost = ((data_size * num_histograms) > 0 ? ((double*)BrotliAllocate((m), (data_size * num_histograms) * sizeof(double))) : 
# 407 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
                         ((void *)0)
# 407 "project/brotli/c/enc/./block_splitter_inc.h"
                         );
    double* cost = ((num_histograms) > 0 ? ((double*)BrotliAllocate((m), (num_histograms) * sizeof(double))) : 
# 408 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
                  ((void *)0)
# 408 "project/brotli/c/enc/./block_splitter_inc.h"
                  );
    uint8_t* switch_signal = ((length * bitmaplen) > 0 ? ((uint8_t*)BrotliAllocate((m), (length * bitmaplen) * sizeof(uint8_t))) : 
# 409 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
                            ((void *)0)
# 409 "project/brotli/c/enc/./block_splitter_inc.h"
                            );
    uint16_t* new_id = ((num_histograms) > 0 ? ((uint16_t*)BrotliAllocate((m), (num_histograms) * sizeof(uint16_t))) : 
# 410 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
                      ((void *)0)
# 410 "project/brotli/c/enc/./block_splitter_inc.h"
                      );
    ...
    { BrotliFree((m), (insert_cost)); insert_cost = 
# 429 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   ((void *)0)
# 429 "project/brotli/c/enc/./block_splitter_inc.h"
   ; };
    { BrotliFree((m), (cost)); cost = 
# 430 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   ((void *)0)
# 430 "project/brotli/c/enc/./block_splitter_inc.h"
   ; };
    { BrotliFree((m), (switch_signal)); switch_signal = 
# 431 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   ((void *)0)
# 431 "project/brotli/c/enc/./block_splitter_inc.h"
   ; };
    { BrotliFree((m), (new_id)); new_id = 
# 432 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   ((void *)0)
# 432 "project/brotli/c/enc/./block_splitter_inc.h"
   ; };
    { BrotliFree((m), (histograms)); histograms = 
# 433 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   ((void *)0)
# 433 "project/brotli/c/enc/./block_splitter_inc.h"
   ; };
    ClusterBlocksLiteral(m, data, length, num_blocks, block_ids, split);
    if ((!!0)) return;
    { BrotliFree((m), (block_ids)); block_ids = 
# 436 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   ((void *)0)
# 436 "project/brotli/c/enc/./block_splitter_inc.h"
   ; };
  }
}
# 93 "project/brotli/c/enc/block_splitter.c" 2
...
# 1 "project/brotli/c/enc/./block_splitter_inc.h" 1
# 12 "project/brotli/c/enc/./block_splitter_inc.h"
static void InitialEntropyCodesCommand(const uint16_t* data, size_t length,
                                    size_t stride,
                                    size_t num_histograms,
...
static void RandomSampleCommand(uint32_t* seed,
                             const uint16_t* data,
                             size_t length,
                             size_t stride,
...
static void RefineEntropyCodesCommand(const uint16_t* data, size_t length,
                                   size_t stride,
                                   size_t num_histograms,
                                   HistogramCommand* histograms) {
  size_t iters =
...
static size_t FindBlocksCommand(const uint16_t* data, const size_t length,
                             const double block_switch_bitcost,
                             const size_t num_histograms,
                             const HistogramCommand* histograms,
                             double* insert_cost,
                             double* cost,
                             uint8_t* switch_signal,
                             uint8_t* block_id) {
...
static size_t RemapBlockIdsCommand(uint8_t* block_ids, const size_t length,
                                uint16_t* new_id, const size_t num_histograms) {
  static const uint16_t kInvalidId = 256;
  uint16_t next_id = 0;
  size_t i;
...
static void BuildBlockHistogramsCommand(const uint16_t* data, const size_t length,
                                     const uint8_t* block_ids,
                                     const size_t num_histograms,
                                     HistogramCommand* histograms) {
  size_t i;
...
static void ClusterBlocksCommand(MemoryManager* m,
...
# 194 "project/brotli/c/enc/./block_splitter_inc.h"
  ...
  HistogramCommand* all_histograms =
      ((all_histograms_capacity) > 0 ? ((HistogramCommand*)BrotliAllocate((m), (all_histograms_capacity) * sizeof(HistogramCommand))) : 
# 200 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
     ((void *)0)
# 200 "project/brotli/c/enc/./block_splitter_inc.h"
     );
...
# 203 "project/brotli/c/enc/./block_splitter_inc.h"
  ...
  size_t num_clusters = 0;
  HistogramCommand* histograms = (((brotli_min_size_t((num_blocks), (64)))) > 0 ? ((HistogramCommand*)BrotliAllocate((m), ((brotli_min_size_t((num_blocks), (64)))) * sizeof(HistogramCommand))) : 
# 205 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
                             ((void *)0)
# 205 "project/brotli/c/enc/./block_splitter_inc.h"
                             )
...
# 229 "project/brotli/c/enc/./block_splitter_inc.h"
  ...
  for (i = 0; i < num_blocks; i += 64) {
    ...
    num_new_clusters = BrotliHistogramCombineCommand(
        histograms, sizes, symbols, new_clusters, pairs, num_to_combine,
        num_to_combine, 64, max_num_pairs);
    { if (all_histograms_capacity < (all_histograms_size + num_new_clusters)) { size_t _new_size = (all_histograms_capacity == 0) ? (all_histograms_size + num_new_clusters) : all_histograms_capacity; HistogramCommand* new_array; while (_new_size < (all_histograms_size + num_new_clusters)) _new_size *= 2; new_array = ((_new_size) > 0 ? ((HistogramCommand*)BrotliAllocate(((m)), (_new_size) * sizeof(HistogramCommand))) : 
# 262 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   ((void *)0)
# 262 "project/brotli/c/enc/./block_splitter_inc.h"
   ); if (!(!!0) && !(!!0) && all_histograms_capacity != 0) 
...
# 262 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   , 
# 262 "project/brotli/c/enc/./block_splitter_inc.h"
   all_histograms, all_histograms_capacity * sizeof(HistogramCommand)
# 262 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   , __builtin_object_size (
# 262 "project/brotli/c/enc/./block_splitter_inc.h"
   new_array
...
# 301 "project/brotli/c/enc/./block_splitter_inc.h"
  ...
  pos = 0;
  {
    ...
    for (i = 0; i < num_blocks; ++i) {
      ...
      best_out = (i == 0) ? histogram_symbols[0] : histogram_symbols[i - 1];
      best_bits =
          BrotliHistogramBitCostDistanceCommand(&histo, &all_histograms[best_out]);
      for (j = 0; j < num_final_clusters; ++j) {
        const double cur_bits = BrotliHistogramBitCostDistanceCommand(
            &histo, &all_histograms[clusters[j]]);
        if (cur_bits < best_bits) {
          best_bits = cur_bits;
          best_out = clusters[j];
...
static void SplitByteVectorCommand(MemoryManager* m,
                                const uint16_t* data, const size_t length,
                                const size_t literals_per_histogram,
                                const size_t max_histograms,
                                const size_t sampling_stride_length,
...
# 384 "project/brotli/c/enc/./block_splitter_inc.h"
  ...
  histograms = ((num_histograms) > 0 ? ((HistogramCommand*)BrotliAllocate((m), (num_histograms) * sizeof(HistogramCommand))) : 
# 393 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
              ((void *)0)
# 393 "project/brotli/c/enc/./block_splitter_inc.h"
              );
...
# 100 "project/brotli/c/enc/block_splitter.c" 2
...
# 1 "project/brotli/c/enc/./block_splitter_inc.h" 1
# 12 "project/brotli/c/enc/./block_splitter_inc.h"
static void InitialEntropyCodesDistance(const uint16_t* data, size_t length,
                                    size_t stride,
                                    size_t num_histograms,
...
static void RandomSampleDistance(uint32_t* seed,
                             const uint16_t* data,
                             size_t length,
                             size_t stride,
...
static void RefineEntropyCodesDistance(const uint16_t* data, size_t length,
                                   size_t stride,
                                   size_t num_histograms,
                                   HistogramDistance* histograms) {
  size_t iters =
...
static size_t FindBlocksDistance(const uint16_t* data, const size_t length,
                             const double block_switch_bitcost,
                             const size_t num_histograms,
                             const HistogramDistance* histograms,
                             double* insert_cost,
                             double* cost,
                             uint8_t* switch_signal,
                             uint8_t* block_id) {
...
static size_t RemapBlockIdsDistance(uint8_t* block_ids, const size_t length,
                                uint16_t* new_id, const size_t num_histograms) {
  static const uint16_t kInvalidId = 256;
  uint16_t next_id = 0;
  size_t i;
...
static void BuildBlockHistogramsDistance(const uint16_t* data, const size_t length,
                                     const uint8_t* block_ids,
                                     const size_t num_histograms,
                                     HistogramDistance* histograms) {
  size_t i;
...
static void ClusterBlocksDistance(MemoryManager* m,
                              const uint16_t* data, const size_t length,
                              const size_t num_blocks,
                              uint8_t* block_ids,
                              BlockSplit* split) {
...
# 194 "project/brotli/c/enc/./block_splitter_inc.h"
  ...
  HistogramDistance* all_histograms =
      ((all_histograms_capacity) > 0 ? ((HistogramDistance*)BrotliAllocate((m), (all_histograms_capacity) * sizeof(HistogramDistance))) : 
# 200 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
     ((void *)0)
# 200 "project/brotli/c/enc/./block_splitter_inc.h"
     );
...
# 203 "project/brotli/c/enc/./block_splitter_inc.h"
  ...
  size_t num_clusters = 0;
  HistogramDistance* histograms = (((brotli_min_size_t((num_blocks), (64)))) > 0 ? ((HistogramDistance*)BrotliAllocate((m), ((brotli_min_size_t((num_blocks), (64)))) * sizeof(HistogramDistance))) : 
# 205 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
                             ((void *)0)
# 205 "project/brotli/c/enc/./block_splitter_inc.h"
                             )
...
# 229 "project/brotli/c/enc/./block_splitter_inc.h"
  ...
  for (i = 0; i < num_blocks; i += 64) {
    ...
    num_new_clusters = BrotliHistogramCombineDistance(
        histograms, sizes, symbols, new_clusters, pairs, num_to_combine,
        num_to_combine, 64, max_num_pairs);
    { if (all_histograms_capacity < (all_histograms_size + num_new_clusters)) { size_t _new_size = (all_histograms_capacity == 0) ? (all_histograms_size + num_new_clusters) : all_histograms_capacity; HistogramDistance* new_array; while (_new_size < (all_histograms_size + num_new_clusters)) _new_size *= 2; new_array = ((_new_size) > 0 ? ((HistogramDistance*)BrotliAllocate(((m)), (_new_size) * sizeof(HistogramDistance))) : 
# 262 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   ((void *)0)
# 262 "project/brotli/c/enc/./block_splitter_inc.h"
   ); if (!(!!0) && !(!!0) && all_histograms_capacity != 0) 
...
# 262 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   , 
# 262 "project/brotli/c/enc/./block_splitter_inc.h"
   all_histograms, all_histograms_capacity * sizeof(HistogramDistance)
# 262 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
   , __builtin_object_size (
# 262 "project/brotli/c/enc/./block_splitter_inc.h"
   new_array
...
# 301 "project/brotli/c/enc/./block_splitter_inc.h"
  ...
  pos = 0;
  {
    ...
    for (i = 0; i < num_blocks; ++i) {
      ...
      best_out = (i == 0) ? histogram_symbols[0] : histogram_symbols[i - 1];
      best_bits =
          BrotliHistogramBitCostDistanceDistance(&histo, &all_histograms[best_out]);
      for (j = 0; j < num_final_clusters; ++j) {
        const double cur_bits = BrotliHistogramBitCostDistanceDistance(
            &histo, &all_histograms[clusters[j]]);
        if (cur_bits < best_bits) {
          best_bits = cur_bits;
          best_out = clusters[j];
...
static void SplitByteVectorDistance(MemoryManager* m,
                                const uint16_t* data, const size_t length,
                                const size_t literals_per_histogram,
                                const size_t max_histograms,
                                const size_t sampling_stride_length,
...
# 384 "project/brotli/c/enc/./block_splitter_inc.h"
  ...
  histograms = ((num_histograms) > 0 ? ((HistogramDistance*)BrotliAllocate((m), (num_histograms) * sizeof(HistogramDistance))) : 
# 393 "project/brotli/c/enc/./block_splitter_inc.h" 3 4
              ((void *)0)
# 393 "project/brotli/c/enc/./block_splitter_inc.h"
              );
...
# 105 "project/brotli/c/enc/block_splitter.c" 2
...
void BrotliDestroyBlockSplit(MemoryManager* m, BlockSplit* self) {
  { BrotliFree((m), (self->types)); self->types = 
# 118 "project/brotli/c/enc/block_splitter.c" 3 4
 ((void *)0)
# 118 "project/brotli/c/enc/block_splitter.c"
 ; };
  { BrotliFree((m), (self->lengths)); self->lengths = 
# 119 "project/brotli/c/enc/block_splitter.c" 3 4
 ((void *)0)
# 119 "project/brotli/c/enc/block_splitter.c"
 ; };
}
...
void BrotliSplitBlock(MemoryManager* m,
                      ...
                      BlockSplit* dist_split) {
  {
    ...
    uint8_t* literals = ((literals_count) > 0 ? ((uint8_t*)BrotliAllocate((m), (literals_count) * sizeof(uint8_t))) : 
# 134 "project/brotli/c/enc/block_splitter.c" 3 4
                       ((void *)0)
# 134 "project/brotli/c/enc/block_splitter.c"
                       );
    if ((!!0) || (!!0)) return;
    ...
    SplitByteVectorLiteral(
        ...
        literal_split);
    if ((!!0)) return;
    { BrotliFree((m), (literals)); literals = 
# 146 "project/brotli/c/enc/block_splitter.c" 3 4
   ((void *)0)
# 146 "project/brotli/c/enc/block_splitter.c"
   ; };
  }

  {

    uint16_t* insert_and_copy_codes = ((num_commands) > 0 ? ((uint16_t*)BrotliAllocate((m), (num_commands) * sizeof(uint16_t))) : 
# 151 "project/brotli/c/enc/block_splitter.c" 3 4
                                     ((void *)0)
# 151 "project/brotli/c/enc/block_splitter.c"
                                     );
    size_t i;
    if ((!!0) || (!!0)) return;
    for (i = 0; i < num_commands; ++i) {
    ...
    { BrotliFree((m), (insert_and_copy_codes)); insert_and_copy_codes = 
# 165 "project/brotli/c/enc/block_splitter.c" 3 4
   ((void *)0)
# 165 "project/brotli/c/enc/block_splitter.c"
   ; };
  }

  {

    uint16_t* distance_prefixes = ((num_commands) > 0 ? ((uint16_t*)BrotliAllocate((m), (num_commands) * sizeof(uint16_t))) : 
# 170 "project/brotli/c/enc/block_splitter.c" 3 4
                                 ((void *)0)
# 170 "project/brotli/c/enc/block_splitter.c"
                                 );
    size_t j = 0;
    size_t i;
    if ((!!0) || (!!0)) return;
    ...
    SplitByteVectorDistance(
        ...
        dist_split);
    if ((!!0)) return;
    { BrotliFree((m), (distance_prefixes)); distance_prefixes = 
# 187 "project/brotli/c/enc/block_splitter.c" 3 4
   ((void *)0)
# 187 "project/brotli/c/enc/block_splitter.c"
   ; };
  }
}
