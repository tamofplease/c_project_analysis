...
static void FN(ClusterBlocks)(MemoryManager* m,
  ...
  FN(Histogram)* all_histograms =
      BROTLI_ALLOC(m, FN(Histogram), all_histograms_capacity);
  ...
  FN(Histogram)* histograms = BROTLI_ALLOC(m, FN(Histogram),
  ...
  for (i = 0; i < num_blocks; i += HISTOGRAMS_PER_BATCH) {
    ...
    BROTLI_ENSURE_CAPACITY(m, FN(Histogram), all_histograms,
...
static void FN(SplitByteVector)(MemoryManager* m,
  ...
  histograms = BROTLI_ALLOC(m, FN(Histogram), num_histograms);
