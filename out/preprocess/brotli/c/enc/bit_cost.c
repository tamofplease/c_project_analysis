...
# 10 "project/brotli/c/enc/bit_cost.c" 2

# 1 "project/brotli/c/enc/../common/constants.h" 1
# 12 "project/brotli/c/enc/bit_cost.c" 2
# 1 "project/brotli/c/enc/../common/platform.h" 1
# 13 "project/brotli/c/enc/bit_cost.c" 2

# 1 "project/brotli/c/enc/./fast_log.h" 1
# 15 "project/brotli/c/enc/bit_cost.c" 2
# 1 "project/brotli/c/enc/./histogram.h" 1
# 16 "project/brotli/c/enc/bit_cost.c" 2
...
# 1 "project/brotli/c/enc/./bit_cost_inc.h" 1
# 12 "project/brotli/c/enc/./bit_cost_inc.h"
double BrotliPopulationCostLiteral(const HistogramLiteral* histogram) {
  ...
  if (count == 4) {
    ...
    for (i = 0; i < 4; ++i) {
      ...
      for (j = i + 1; j < 4; ++j) {
        if (histo[j] > histo[i]) {
          { uint32_t __brotli_swap_tmp = (histo)[(j)]; (histo)[(j)] = (histo)[(i)]; (histo)[(i)] = __brotli_swap_tmp; };
        }
      }
    }
    h23 = histo[2] + histo[3];
...
# 23 "project/brotli/c/enc/bit_cost.c" 2
...
# 27 "project/brotli/c/enc/bit_cost.c" 2
...
# 31 "project/brotli/c/enc/bit_cost.c" 2
