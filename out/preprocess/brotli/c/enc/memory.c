# 0 "project/brotli/c/enc/memory.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/brotli/c/enc/memory.c"
# 10 "project/brotli/c/enc/memory.c"
# 1 "project/brotli/c/enc/./memory.h" 1
# 12 "project/brotli/c/enc/./memory.h"
...
# 13 "project/brotli/c/enc/./memory.h" 2
...
# 11 "project/brotli/c/enc/memory.c" 2
...
# 13 "project/brotli/c/enc/memory.c" 2


# 1 "project/brotli/c/enc/../common/platform.h" 1
# 16 "project/brotli/c/enc/memory.c" 2
# 30 "project/brotli/c/enc/memory.c"
...
void* BrotliAllocate(MemoryManager* m, size_t n) {
  ...
  if (!result) exit(
# 54 "project/brotli/c/enc/memory.c" 3 4
                   1
# 54 "project/brotli/c/enc/memory.c"
                               );
  return result;
}
