# 0 "project/brotli/c/enc/metablock.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/brotli/c/enc/metablock.c"
# 10 "project/brotli/c/enc/metablock.c"
# 1 "project/brotli/c/enc/./metablock.h" 1
# 13 "project/brotli/c/enc/./metablock.h"
# 1 "project/brotli/c/enc/./../common/context.h" 1
# 91 "project/brotli/c/enc/./../common/context.h"
# 1 "/usr/local/include/brotli/port.h" 1 3 4
# 92 "project/brotli/c/enc/./../common/context.h" 2
...
# 93 "project/brotli/c/enc/./../common/context.h" 2
...
# 15 "project/brotli/c/enc/./metablock.h" 2
...
# 11 "project/brotli/c/enc/metablock.c" 2

# 1 "project/brotli/c/enc/../common/constants.h" 1
# 13 "project/brotli/c/enc/metablock.c" 2
# 1 "project/brotli/c/enc/../common/context.h" 1
# 14 "project/brotli/c/enc/metablock.c" 2
# 1 "project/brotli/c/enc/../common/platform.h" 1
# 15 "project/brotli/c/enc/metablock.c" 2
...
# 17 "project/brotli/c/enc/metablock.c" 2
# 1 "project/brotli/c/enc/./block_splitter.h" 1
# 18 "project/brotli/c/enc/metablock.c" 2
...
# 19 "project/brotli/c/enc/metablock.c" 2
...
# 20 "project/brotli/c/enc/metablock.c" 2
# 1 "project/brotli/c/enc/./histogram.h" 1
# 21 "project/brotli/c/enc/metablock.c" 2
# 1 "project/brotli/c/enc/./memory.h" 1
# 22 "project/brotli/c/enc/metablock.c" 2
# 1 "project/brotli/c/enc/./quality.h" 1
# 23 "project/brotli/c/enc/metablock.c" 2
...
void BrotliInitDistanceParams(BrotliEncoderParams* params,
  ...
  max_distance = ndirect + (1U << (24U + npostfix + 2)) -
      (1U << (npostfix + 2));
...
static 
# 82 "project/brotli/c/enc/metablock.c" 3 4
      int 
# 82 "project/brotli/c/enc/metablock.c"
                  ComputeDistanceCost(const Command* cmds,
                                       size_t num_commands,
                                       const BrotliDistanceParams* orig_params,
                                       const BrotliDistanceParams* new_params,
                                       double* cost) {
...
# 88 "project/brotli/c/enc/metablock.c" 3 4
 int 
# 88 "project/brotli/c/enc/metablock.c"
             equal_params = 
# 88 "project/brotli/c/enc/metablock.c" 3 4
                            0
# 88 "project/brotli/c/enc/metablock.c"
  ...
  if (orig_params->distance_postfix_bits == new_params->distance_postfix_bits &&
      ...
      new_params->num_direct_distance_codes) {
    equal_params = 
# 98 "project/brotli/c/enc/metablock.c" 3 4
                  1
# 98 "project/brotli/c/enc/metablock.c"
                             ;
  }
    ...
    if (CommandCopyLen(cmd) && cmd->cmd_prefix_ >= 128) {
      if (equal_params) {
        ...
        if (distance > new_params->max_distance) {
          return 
# 109 "project/brotli/c/enc/metablock.c" 3 4
                0
# 109 "project/brotli/c/enc/metablock.c"
                            ;
        }
  ...
  *cost = BrotliPopulationCostDistance(&histo) + extra_bits;
  return 
# 123 "project/brotli/c/enc/metablock.c" 3 4
        1
# 123 "project/brotli/c/enc/metablock.c"
                   ;
}
...
# 141 "project/brotli/c/enc/metablock.c" 3 4
                                      ((void *)0)
# 141 "project/brotli/c/enc/metablock.c"
                                          ;
  size_t literal_histograms_size;
  size_t distance_histograms_size;
  size_t i;
...
# 148 "project/brotli/c/enc/metablock.c" 3 4
 int 
# 148 "project/brotli/c/enc/metablock.c"
             check_orig = 
# 148 "project/brotli/c/enc/metablock.c" 3 4
                          1
# 148 "project/brotli/c/enc/metablock.c"
...
# 156 "project/brotli/c/enc/metablock.c" 3 4
     int 
# 156 "project/brotli/c/enc/metablock.c"
                 skip;
      double dist_cost;
      ...
      if (npostfix == orig_params.dist.distance_postfix_bits &&
        ...
        check_orig = 
# 161 "project/brotli/c/enc/metablock.c" 3 4
                    0
# 161 "project/brotli/c/enc/metablock.c"
                                ;
      }
  ...
  if (!params->disable_literal_context_modeling) {
    ...
    literal_context_modes =
        ((mb->literal_split.num_types) > 0 ? ((ContextType*)BrotliAllocate((m), (mb->literal_split.num_types) * sizeof(ContextType))) : 
# 198 "project/brotli/c/enc/metablock.c" 3 4
       ((void *)0)
# 198 "project/brotli/c/enc/metablock.c"
       );
    if ((!!0) || (!!0)) return;
  ...
  literal_histograms =
      ((literal_histograms_size) > 0 ? ((HistogramLiteral*)BrotliAllocate((m), (literal_histograms_size) * sizeof(HistogramLiteral))) : 
# 208 "project/brotli/c/enc/metablock.c" 3 4
     ((void *)0)
# 208 "project/brotli/c/enc/metablock.c"
     );
  if ((!!0) || (!!0)) return;
  ...
  distance_histograms =
      ((distance_histograms_size) > 0 ? ((HistogramDistance*)BrotliAllocate((m), (distance_histograms_size) * sizeof(HistogramDistance))) : 
# 215 "project/brotli/c/enc/metablock.c" 3 4
     ((void *)0)
# 215 "project/brotli/c/enc/metablock.c"
     );
  if ((!!0) || (!!0)) return;
  ...
  mb->command_histograms =
      ((mb->command_histograms_size) > 0 ? ((HistogramCommand*)BrotliAllocate((m), (mb->command_histograms_size) * sizeof(HistogramCommand))) : 
# 222 "project/brotli/c/enc/metablock.c" 3 4
     ((void *)0)
# 222 "project/brotli/c/enc/metablock.c"
     );
  if ((!!0) || (!!0)) return;
  ...
  { BrotliFree((m), (literal_context_modes)); literal_context_modes = 
# 230 "project/brotli/c/enc/metablock.c" 3 4
 ((void *)0)
# 230 "project/brotli/c/enc/metablock.c"
 ; };
  ...
  mb->literal_context_map =
      ((mb->literal_context_map_size) > 0 ? ((uint32_t*)BrotliAllocate((m), (mb->literal_context_map_size) * sizeof(uint32_t))) : 
# 236 "project/brotli/c/enc/metablock.c" 3 4
     ((void *)0)
# 236 "project/brotli/c/enc/metablock.c"
     );
  if ((!!0) || (!!0)) return;
  ...
  mb->literal_histograms =
      ((mb->literal_histograms_size) > 0 ? ((HistogramLiteral*)BrotliAllocate((m), (mb->literal_histograms_size) * sizeof(HistogramLiteral))) : 
# 242 "project/brotli/c/enc/metablock.c" 3 4
     ((void *)0)
# 242 "project/brotli/c/enc/metablock.c"
     );
  if ((!!0) || (!!0)) return;
  ...
  if ((!!0)) return;
  { BrotliFree((m), (literal_histograms)); literal_histograms = 
# 249 "project/brotli/c/enc/metablock.c" 3 4
 ((void *)0)
# 249 "project/brotli/c/enc/metablock.c"
 ; };
  ...
  mb->distance_context_map =
      ((mb->distance_context_map_size) > 0 ? ((uint32_t*)BrotliAllocate((m), (mb->distance_context_map_size) * sizeof(uint32_t))) : 
# 267 "project/brotli/c/enc/metablock.c" 3 4
     ((void *)0)
# 267 "project/brotli/c/enc/metablock.c"
     );
  if ((!!0) || (!!0)) return;
  ...
  mb->distance_histograms =
      ((mb->distance_histograms_size) > 0 ? ((HistogramDistance*)BrotliAllocate((m), (mb->distance_histograms_size) * sizeof(HistogramDistance))) : 
# 273 "project/brotli/c/enc/metablock.c" 3 4
     ((void *)0)
# 273 "project/brotli/c/enc/metablock.c"
     );
  if ((!!0) || (!!0)) return;
  ...
  BrotliClusterHistogramsDistance(m, distance_histograms,
                                  ...
                                  mb->distance_context_map);
  if ((!!0)) return;
  { BrotliFree((m), (distance_histograms)); distance_histograms = 
# 283 "project/brotli/c/enc/metablock.c" 3 4
 ((void *)0)
# 283 "project/brotli/c/enc/metablock.c"
 ; };
}


# 1 "project/brotli/c/enc/./metablock_inc.h" 1
# 14 "project/brotli/c/enc/./metablock_inc.h"
...
static void InitBlockSplitterLiteral(
    MemoryManager* m, BlockSplitterLiteral* self, size_t alphabet_size,
  ...
  size_t max_num_types =
      (brotli_min_size_t((max_num_blocks), (256 + 1)));
  ...
  { if (split->types_alloc_size < (max_num_blocks)) { size_t _new_size = (split->types_alloc_size == 0) ? (max_num_blocks) : split->types_alloc_size; uint8_t* new_array; while (_new_size < (max_num_blocks)) _new_size *= 2; new_array = ((_new_size) > 0 ? ((uint8_t*)BrotliAllocate(((m)), (_new_size) * sizeof(uint8_t))) : 
# 64 "project/brotli/c/enc/./metablock_inc.h" 3 4
 ((void *)0)
# 64 "project/brotli/c/enc/./metablock_inc.h"
...
# 64 "project/brotli/c/enc/./metablock_inc.h"
 ; }; split->types = new_array; split->types_alloc_size = _new_size; } }
                                                            ;
  { if (split->lengths_alloc_size < (max_num_blocks)) { size_t _new_size = (split->lengths_alloc_size == 0) ? (max_num_blocks) : split->lengths_alloc_size; uint32_t* new_array; while (_new_size < (max_num_blocks)) _new_size *= 2; new_array = ((_new_size) > 0 ? ((uint32_t*)BrotliAllocate(((m)), (_new_size) * sizeof(uint32_t))) : 
# 66 "project/brotli/c/enc/./metablock_inc.h" 3 4
 ((void *)0)
# 66 "project/brotli/c/enc/./metablock_inc.h"
...
# 66 "project/brotli/c/enc/./metablock_inc.h"
  ...
  *histograms = ((*histograms_size) > 0 ? ((HistogramLiteral*)BrotliAllocate((m), (*histograms_size) * sizeof(HistogramLiteral))) : 
# 72 "project/brotli/c/enc/./metablock_inc.h" 3 4
               ((void *)0)
# 72 "project/brotli/c/enc/./metablock_inc.h"
               );
...
static void BlockSplitterFinishBlockLiteral(
    BlockSplitterLiteral* self, 
# 85 "project/brotli/c/enc/./metablock_inc.h" 3 4
                            int 
# 85 "project/brotli/c/enc/./metablock_inc.h"
                                        is_final) {
  BlockSplit* split = self->split_;
  double* last_entropy = self->last_entropy_;
  HistogramLiteral* histograms = self->histograms_;
  self->block_size_ =
      (brotli_max_size_t((self->block_size_), (self->min_block_size_)));
  if (self->num_blocks_ == 0) {
    ...
    if (split->num_types < 256 &&
      ...
      { size_t __brotli_swap_tmp = (self->last_histogram_ix_)[(0)]; (self->last_histogram_ix_)[(0)] = (self->last_histogram_ix_)[(1)]; (self->last_histogram_ix_)[(1)] = __brotli_swap_tmp; };
...
static void BlockSplitterAddSymbolLiteral(BlockSplitterLiteral* self, size_t symbol) {
  ...
  if (self->block_size_ == self->target_block_size_) {
    BlockSplitterFinishBlockLiteral(self, 
# 179 "project/brotli/c/enc/./metablock_inc.h" 3 4
                                                       0
# 179 "project/brotli/c/enc/./metablock_inc.h"
                                                                   );
  }
}
# 288 "project/brotli/c/enc/metablock.c" 2
...
static void InitBlockSplitterCommand(
    MemoryManager* m, BlockSplitterCommand* self, size_t alphabet_size,
    size_t min_block_size, double split_threshold, size_t num_symbols,
...
# 66 "project/brotli/c/enc/./metablock_inc.h"
 ; }; split->lengths = new_array; split->lengths_alloc_size = _new_size; } }
  ...
  ;
  *histograms_size = max_num_types;
  *histograms = ((*histograms_size) > 0 ? ((HistogramCommand*)BrotliAllocate((m), (*histograms_size) * sizeof(HistogramCommand))) : 
# 72 "project/brotli/c/enc/./metablock_inc.h" 3 4
               ((void *)0)
# 72 "project/brotli/c/enc/./metablock_inc.h"
               );
...
static void BlockSplitterFinishBlockCommand(
    BlockSplitterCommand* self, 
# 85 "project/brotli/c/enc/./metablock_inc.h" 3 4
                            int 
# 85 "project/brotli/c/enc/./metablock_inc.h"
                                        is_final) {
...
static void BlockSplitterAddSymbolCommand(BlockSplitterCommand* self, size_t symbol) {
  ...
  ++self->block_size_;
  if (self->block_size_ == self->target_block_size_) {
    BlockSplitterFinishBlockCommand(self, 
# 179 "project/brotli/c/enc/./metablock_inc.h" 3 4
                                                       0
# 179 "project/brotli/c/enc/./metablock_inc.h"
                                                                   );
...
# 292 "project/brotli/c/enc/metablock.c" 2
...
static void InitBlockSplitterDistance(
    MemoryManager* m, BlockSplitterDistance* self, size_t alphabet_size,
    size_t min_block_size, double split_threshold, size_t num_symbols,
...
# 66 "project/brotli/c/enc/./metablock_inc.h"
 ; }; split->lengths = new_array; split->lengths_alloc_size = _new_size; } }
  ...
  ;
  *histograms_size = max_num_types;
  *histograms = ((*histograms_size) > 0 ? ((HistogramDistance*)BrotliAllocate((m), (*histograms_size) * sizeof(HistogramDistance))) : 
# 72 "project/brotli/c/enc/./metablock_inc.h" 3 4
               ((void *)0)
# 72 "project/brotli/c/enc/./metablock_inc.h"
               );
...
static void BlockSplitterFinishBlockDistance(
    BlockSplitterDistance* self, 
# 85 "project/brotli/c/enc/./metablock_inc.h" 3 4
                            int 
# 85 "project/brotli/c/enc/./metablock_inc.h"
                                        is_final) {
...
static void BlockSplitterAddSymbolDistance(BlockSplitterDistance* self, size_t symbol) {
  ...
  ++self->block_size_;
  if (self->block_size_ == self->target_block_size_) {
    BlockSplitterFinishBlockDistance(self, 
# 179 "project/brotli/c/enc/./metablock_inc.h" 3 4
                                                       0
# 179 "project/brotli/c/enc/./metablock_inc.h"
                                                                   );
...
# 296 "project/brotli/c/enc/metablock.c" 2
...
static void InitContextBlockSplitter(
  ...
  max_num_types =
      (brotli_min_size_t((max_num_blocks), (self->max_block_types_ + 1)));
  { if (split->types_alloc_size < (max_num_blocks)) { size_t _new_size = (split->types_alloc_size == 0) ? (max_num_blocks) : split->types_alloc_size; uint8_t* new_array; while (_new_size < (max_num_blocks)) _new_size *= 2; new_array = ((_new_size) > 0 ? ((uint8_t*)BrotliAllocate(((m)), (_new_size) * sizeof(uint8_t))) : 
# 361 "project/brotli/c/enc/metablock.c" 3 4
 ((void *)0)
# 361 "project/brotli/c/enc/metablock.c"
 ); if (!(!!0) && !(!!0) && split->types_alloc_size != 0) 
# 361 "project/brotli/c/enc/metablock.c" 3 4
 __builtin___memcpy_chk (
# 361 "project/brotli/c/enc/metablock.c"
...
# 361 "project/brotli/c/enc/metablock.c"
 ; }; split->types = new_array; split->types_alloc_size = _new_size; } }
                                                            ;
  { if (split->lengths_alloc_size < (max_num_blocks)) { size_t _new_size = (split->lengths_alloc_size == 0) ? (max_num_blocks) : split->lengths_alloc_size; uint32_t* new_array; while (_new_size < (max_num_blocks)) _new_size *= 2; new_array = ((_new_size) > 0 ? ((uint32_t*)BrotliAllocate(((m)), (_new_size) * sizeof(uint32_t))) : 
# 363 "project/brotli/c/enc/metablock.c" 3 4
 ((void *)0)
# 363 "project/brotli/c/enc/metablock.c"
 ); if (!(!!0) && !(!!0) && split->lengths_alloc_size != 0) 
# 363 "project/brotli/c/enc/metablock.c" 3 4
 __builtin___memcpy_chk (
# 363 "project/brotli/c/enc/metablock.c"
...
# 363 "project/brotli/c/enc/metablock.c"
  ...
  *histograms = ((*histograms_size) > 0 ? ((HistogramLiteral*)BrotliAllocate((m), (*histograms_size) * sizeof(HistogramLiteral))) : 
# 370 "project/brotli/c/enc/metablock.c" 3 4
               ((void *)0)
# 370 "project/brotli/c/enc/metablock.c"
               );
  self->histograms_ = *histograms;
  if ((!!0) || (!!0)) return;
...
# 383 "project/brotli/c/enc/metablock.c" 3 4
                                                 int 
# 383 "project/brotli/c/enc/metablock.c"
                                                             is_final) {
  BlockSplit* split = self->split_;
  ...
  if (self->num_blocks_ == 0) {
    ...
    HistogramLiteral* combined_histo =
        ((2 * num_contexts) > 0 ? ((HistogramLiteral*)BrotliAllocate((m), (2 * num_contexts) * sizeof(HistogramLiteral))) : 
# 418 "project/brotli/c/enc/metablock.c" 3 4
       ((void *)0)
# 418 "project/brotli/c/enc/metablock.c"
       );
    ...
    { BrotliFree((m), (combined_histo)); combined_histo = 
# 494 "project/brotli/c/enc/metablock.c" 3 4
   ((void *)0)
# 494 "project/brotli/c/enc/metablock.c"
   ; };
  }
  if (is_final) {
...
static void ContextBlockSplitterAddSymbol(
  ...
  ++self->block_size_;
  if (self->block_size_ == self->target_block_size_) {
    ContextBlockSplitterFinishBlock(self, m, 
# 511 "project/brotli/c/enc/metablock.c" 3 4
                                                             0
# 511 "project/brotli/c/enc/metablock.c"
                                                                         );
    if ((!!0)) return;
  }
}
...
static void MapStaticContexts(MemoryManager* m,
  ...
  mb->literal_context_map =
      ((mb->literal_context_map_size) > 0 ? ((uint32_t*)BrotliAllocate((m), (mb->literal_context_map_size) * sizeof(uint32_t))) : 
# 525 "project/brotli/c/enc/metablock.c" 3 4
     ((void *)0)
# 525 "project/brotli/c/enc/metablock.c"
     );
  if ((!!0) || (!!0)) return;
...
static inline __attribute__((__always_inline__)) void BrotliBuildMetaBlockGreedyInternal(
    MemoryManager* m, const uint8_t* ringbuffer, size_t pos, size_t mask,
    uint8_t prev_byte, uint8_t prev_byte2, ContextLut literal_context_lut,
  ...
  if ((!!0)) return;
  InitBlockSplitterCommand(m, &cmd_blocks, 704, 1024,
  ...
  for (i = 0; i < n_commands; ++i) {
    ...
    for (j = cmd.insert_len_; j != 0; --j) {
      ...
      if (num_contexts == 1) {
        ...
        size_t context =
            ((literal_context_lut)[prev_byte] | ((literal_context_lut) + 256)[prev_byte2]);
  ...
  if (num_contexts == 1) {
    BlockSplitterFinishBlockLiteral(
        &lit_blocks.plain, 
# 605 "project/brotli/c/enc/metablock.c" 3 4
                                           1
# 605 "project/brotli/c/enc/metablock.c"
                                                      );
  } else {
    ContextBlockSplitterFinishBlock(
        &lit_blocks.ctx, m, 
# 608 "project/brotli/c/enc/metablock.c" 3 4
                                            1
# 608 "project/brotli/c/enc/metablock.c"
                                                       );
    if ((!!0)) return;
  }
  BlockSplitterFinishBlockCommand(&cmd_blocks, 
# 611 "project/brotli/c/enc/metablock.c" 3 4
                                                               1
# 611 "project/brotli/c/enc/metablock.c"
                                                                          );
  BlockSplitterFinishBlockDistance(&dist_blocks, 
# 612 "project/brotli/c/enc/metablock.c" 3 4
                                                                 1
# 612 "project/brotli/c/enc/metablock.c"
                                                                            );
...
void BrotliBuildMetaBlockGreedy(MemoryManager* m,
  ...
  if (num_contexts == 1) {
    BrotliBuildMetaBlockGreedyInternal(m, ringbuffer, pos, mask, prev_byte,
        prev_byte2, literal_context_lut, 1, 
# 633 "project/brotli/c/enc/metablock.c" 3 4
                                           ((void *)0)
# 633 "project/brotli/c/enc/metablock.c"
