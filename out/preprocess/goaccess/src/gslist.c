# 0 "project/goaccess/src/gslist.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 32 "project/goaccess/src/gslist.c" 2
...
# 33 "project/goaccess/src/gslist.c" 2
...
# 34 "project/goaccess/src/gslist.c" 2
...
# 35 "project/goaccess/src/gslist.c" 2
...
# 36 "project/goaccess/src/gslist.c" 2
...
# 38 "project/goaccess/src/gslist.c" 2
...
# 39 "project/goaccess/src/gslist.c" 2
...
# 40 "project/goaccess/src/gslist.c" 2
...
list_create (void *data) {
  ...
  node->data = data;
  node->next = 
# 49 "project/goaccess/src/gslist.c" 3 4
              ((void *)0)
# 49 "project/goaccess/src/gslist.c"
                  ;
...
list_find (GSLList * node, int (*func) (void *, void *), void *data) {
  ...
  return 
# 93 "project/goaccess/src/gslist.c" 3 4
        ((void *)0)
# 93 "project/goaccess/src/gslist.c"
            ;
}
...
list_copy (GSLList * node) {
  GSLList *list = 
# 98 "project/goaccess/src/gslist.c" 3 4
                 ((void *)0)
# 98 "project/goaccess/src/gslist.c"
                     ;
...
list_remove_nodes (GSLList * list) {
  GSLList *tmp;
  while (list != 
# 117 "project/goaccess/src/gslist.c" 3 4
                ((void *)0)
# 117 "project/goaccess/src/gslist.c"
                    ) {
    tmp = list->next;
    if (list->data)
      free (list->data);
...
list_remove_node (GSLList ** list, GSLList * node) {
  GSLList **current = list, *next = 
# 134 "project/goaccess/src/gslist.c" 3 4
                                   ((void *)0)
# 134 "project/goaccess/src/gslist.c"
                                       ;
