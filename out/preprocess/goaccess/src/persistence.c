# 0 "project/goaccess/src/persistence.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/goaccess/src/persistence.c"
# 31 "project/goaccess/src/persistence.c"
...
# 32 "project/goaccess/src/persistence.c" 2
...
# 66 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/select.h" 3 4
...
# 33 "project/goaccess/src/persistence.c" 2
...
# 34 "project/goaccess/src/persistence.c" 2
...
# 35 "project/goaccess/src/persistence.c" 2
...
# 36 "project/goaccess/src/persistence.c" 2
...
# 37 "project/goaccess/src/persistence.c" 2
...
# 39 "project/goaccess/src/persistence.c" 2
...
# 39 "project/goaccess/src/commons.h" 2
...
# 41 "project/goaccess/src/persistence.c" 2
...
# 128 "project/goaccess/src/khash.h"
...
# 129 "project/goaccess/src/khash.h" 2
...
# 135 "project/goaccess/src/khash.h"
...
# 42 "project/goaccess/src/persistence.c" 2
...
# 43 "project/goaccess/src/persistence.c" 2
...
# 30 "project/goaccess/src/tpl.h" 2
# 38 "project/goaccess/src/tpl.h"
...
# 39 "project/goaccess/src/tpl.h" 2
...
# 44 "project/goaccess/src/persistence.c" 2
...
# 45 "project/goaccess/src/persistence.c" 2
...
# 46 "project/goaccess/src/persistence.c" 2

static uint32_t *persisted_dates = 
# 47 "project/goaccess/src/persistence.c" 3 4
                                  ((void *)0)
# 47 "project/goaccess/src/persistence.c"
                                      ;
...
set_db_path (const char *fn) {
  struct stat info;
  char *rpath = 
# 57 "project/goaccess/src/persistence.c" 3 4
               ((void *)0)
# 57 "project/goaccess/src/persistence.c"
                   , *path = 
# 57 "project/goaccess/src/persistence.c" 3 4
                             ((void *)0)
# 57 "project/goaccess/src/persistence.c"
                                 ;
  const char *dbpath = 
# 58 "project/goaccess/src/persistence.c" 3 4
                      ((void *)0)
# 58 "project/goaccess/src/persistence.c"
                          ;
  ...
  rpath = realpath (dbpath, 
# 65 "project/goaccess/src/persistence.c" 3 4
                           ((void *)0)
# 65 "project/goaccess/src/persistence.c"
                               );
  if (rpath == 
# 66 "project/goaccess/src/persistence.c" 3 4
              ((void *)0)
# 66 "project/goaccess/src/persistence.c"
                  )
    do { (void) endwin (); fprintf (
# 67 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 67 "project/goaccess/src/persistence.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:14"); fprintf (
# 67 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 67 "project/goaccess/src/persistence.c"
...
# 67 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 67 "project/goaccess/src/persistence.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/persistence.c", __FUNCTION__, 67); fprintf (
# 67 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 67 "project/goaccess/src/persistence.c"
   , "Unable to open the specified db path/file '%s'. %s", dbpath, strerror (
# 67 "project/goaccess/src/persistence.c" 3 4
   (*__error())
# 67 "project/goaccess/src/persistence.c"
   )); fprintf (
# 67 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 67 "project/goaccess/src/persistence.c"
   , "\n\n"); do { dbg_fprintf ("Unable to open the specified db path/file '%s'. %s", dbpath, strerror (
# 67 "project/goaccess/src/persistence.c" 3 4
   (*__error())
# 67 "project/goaccess/src/persistence.c"
   )); } while (0); exit(
...
# 67 "project/goaccess/src/persistence.c"
  ...
  if (stat (rpath, &info) != 0)
    do { (void) endwin (); fprintf (
# 71 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 71 "project/goaccess/src/persistence.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:14"); fprintf (
# 71 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 71 "project/goaccess/src/persistence.c"
...
# 71 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 71 "project/goaccess/src/persistence.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/persistence.c", __FUNCTION__, 71); fprintf (
# 71 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 71 "project/goaccess/src/persistence.c"
   , "Unable to access database path: %s", strerror (
# 71 "project/goaccess/src/persistence.c" 3 4
   (*__error())
# 71 "project/goaccess/src/persistence.c"
   )); fprintf (
# 71 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 71 "project/goaccess/src/persistence.c"
   , "\n\n"); do { dbg_fprintf ("Unable to access database path: %s", strerror (
# 71 "project/goaccess/src/persistence.c" 3 4
   (*__error())
# 71 "project/goaccess/src/persistence.c"
   )); } while (0); exit(
...
# 72 "project/goaccess/src/persistence.c" 3 4
                           0040000
# 72 "project/goaccess/src/persistence.c"
                                  ))
    do { (void) endwin (); fprintf (
# 73 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 73 "project/goaccess/src/persistence.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:14"); fprintf (
# 73 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 73 "project/goaccess/src/persistence.c"
...
# 73 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 73 "project/goaccess/src/persistence.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/persistence.c", __FUNCTION__, 73); fprintf (
# 73 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 73 "project/goaccess/src/persistence.c"
   , "Database path is not a directory."); fprintf (
# 73 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 73 "project/goaccess/src/persistence.c"
   , "\n\n"); do { dbg_fprintf ("Database path is not a directory."); } while (0); exit(
# 73 "project/goaccess/src/persistence.c" 3 4
   1
# 73 "project/goaccess/src/persistence.c"
   ); } while (0);
  ...
  path = xmalloc (
# 75 "project/goaccess/src/persistence.c" 3 4
                 __builtin___snprintf_chk (((void *)0), 
# 75 "project/goaccess/src/persistence.c"
                 0
# 75 "project/goaccess/src/persistence.c" 3 4
...
# 76 "project/goaccess/src/persistence.c" 3 4
 __builtin___sprintf_chk (
# 76 "project/goaccess/src/persistence.c"
 path
# 76 "project/goaccess/src/persistence.c" 3 4
...
build_filename (const char *type, const char *modstr, const char *mtrstr) {
  char *fn = xmalloc (
# 84 "project/goaccess/src/persistence.c" 3 4
                     __builtin___snprintf_chk (((void *)0), 
# 84 "project/goaccess/src/persistence.c"
                     0
# 84 "project/goaccess/src/persistence.c" 3 4
                     , 0, __builtin_object_size (((void *)0), 2 > 1 ? 1 : 0), 
# 84 "project/goaccess/src/persistence.c"
                     "%s_%s_%s.db", type, modstr, mtrstr
# 84 "project/goaccess/src/persistence.c" 3 4
                     ) 
# 84 "project/goaccess/src/persistence.c"
                                                                             + 1);
  
# 85 "project/goaccess/src/persistence.c" 3 4
 __builtin___sprintf_chk (
# 85 "project/goaccess/src/persistence.c"
 fn
# 85 "project/goaccess/src/persistence.c" 3 4
 , 0, __builtin_object_size (
# 85 "project/goaccess/src/persistence.c"
...
get_filename (GModule module, GKHashMetric mtrc) {
  char *mtrstr = 
# 95 "project/goaccess/src/persistence.c" 3 4
                ((void *)0)
# 95 "project/goaccess/src/persistence.c"
                    , *modstr = 
# 95 "project/goaccess/src/persistence.c" 3 4
                                ((void *)0)
# 95 "project/goaccess/src/persistence.c"
...
# 95 "project/goaccess/src/persistence.c"
  ...
  if (!(mtrstr = get_mtr_str (mtrc.metric.storem)))
    do { (void) endwin (); fprintf (
# 98 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 98 "project/goaccess/src/persistence.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:14"); fprintf (
# 98 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 98 "project/goaccess/src/persistence.c"
...
# 98 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 98 "project/goaccess/src/persistence.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/persistence.c", __FUNCTION__, 98); fprintf (
# 98 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 98 "project/goaccess/src/persistence.c"
   , "Unable to allocate metric name."); fprintf (
# 98 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 98 "project/goaccess/src/persistence.c"
   , "\n\n"); do { dbg_fprintf ("Unable to allocate metric name."); } while (0); exit(
# 98 "project/goaccess/src/persistence.c" 3 4
   1
# 98 "project/goaccess/src/persistence.c"
   ); } while (0);
  if (!(modstr = get_module_str (module)))
    do { (void) endwin (); fprintf (
# 100 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 100 "project/goaccess/src/persistence.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:14"); fprintf (
# 100 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 100 "project/goaccess/src/persistence.c"
...
# 100 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 100 "project/goaccess/src/persistence.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/persistence.c", __FUNCTION__, 100); fprintf (
# 100 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 100 "project/goaccess/src/persistence.c"
   , "Unable to allocate module name."); fprintf (
# 100 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 100 "project/goaccess/src/persistence.c"
   , "\n\n"); do { dbg_fprintf ("Unable to allocate module name."); } while (0); exit(
# 100 "project/goaccess/src/persistence.c" 3 4
   1
# 100 "project/goaccess/src/persistence.c"
   ); } while (0);
  if (!(type = get_mtr_type_str (mtrc.type)))
    do { (void) endwin (); fprintf (
# 102 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 102 "project/goaccess/src/persistence.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:14"); fprintf (
# 102 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 102 "project/goaccess/src/persistence.c"
...
# 102 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 102 "project/goaccess/src/persistence.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/persistence.c", __FUNCTION__, 102); fprintf (
# 102 "project/goaccess/src/persistence.c" 3 4
   __stderrp
# 102 "project/goaccess/src/persistence.c"
   , "Unable to allocate module name."); fprintf (
...
static void
restore_global_si08 (kh_si08_t * hash, const char *fn) {
  tpl_node *tn;
  char *key = 
# 125 "project/goaccess/src/persistence.c" 3 4
             ((void *)0)
# 125 "project/goaccess/src/persistence.c"
                 ;
  char fmt[] = "A(sv)";
  uint16_t val;
...
static void
persist_global_si08 (kh_si08_t * hash, const char *fn) {
  tpl_node *tn;
  khint_t k;
  const char *key = 
# 143 "project/goaccess/src/persistence.c" 3 4
                   ((void *)0)
# 143 "project/goaccess/src/persistence.c"
                       ;
  char fmt[] = "A(sv)";
  uint16_t val;
  ...
  for (k = 0; k < ((hash)->n_buckets); ++k) {
    if (!(!(((hash)->flags[(k)>>4]>>(((k)&0xfU)<<1))&3)) || (!(key = ((hash)->keys[k]))))
      continue;
    val = ((hash)->vals[k]);
    tpl_pack (tn, 1);
  }
...
static void
restore_global_si32 (kh_si32_t * hash, const char *fn) {
  tpl_node *tn;
  char *key = 
# 167 "project/goaccess/src/persistence.c" 3 4
             ((void *)0)
# 167 "project/goaccess/src/persistence.c"
                 ;
  char fmt[] = "A(su)";
  uint32_t val;
...
static void
persist_global_si32 (kh_si32_t * hash, const char *fn) {
  tpl_node *tn;
  khint_t k;
  const char *key = 
# 185 "project/goaccess/src/persistence.c" 3 4
                   ((void *)0)
# 185 "project/goaccess/src/persistence.c"
                       ;
  char fmt[] = "A(su)";
  uint32_t val;
...
static void
restore_global_iglp (kh_iglp_t * hash, const char *fn) {
  tpl_node *tn;
  uint32_t key;
  GLastParse val = { 0 };
  char fmt[] = "A(uS(uIUvc#))";

  tn = tpl_map (fmt, &key, &val, 4096u);
  tpl_load (tn, (1 << 0), fn);
  while (tpl_unpack (tn, 1) > 0) {
...
static void
persist_global_iglp (kh_iglp_t * hash, const char *fn) {
  tpl_node *tn;
  khint_t k;
  uint32_t key;
  GLastParse val = { 0 };
...
# 253 "project/goaccess/src/persistence.c"
static int
insert_restored_date (uint32_t date) {
  ...
  len = ({ __typeof__ (persisted_dates_len) _a = (persisted_dates_len); __typeof__ (conf.keep_last) _b = (conf.keep_last); _a < _b ? _a : _b; });
  for (i = 0; i < len; ++i)
...
restore_si32 (GSMetric metric, const char *path, int module) {
  kh_si32_t * hash = 
# 272 "project/goaccess/src/persistence.c" 3 4
                         ((void *)0)
# 272 "project/goaccess/src/persistence.c"
                             ;
  tpl_node *tn;
  char fmt[] = "A(iA(su))";
  int date = 0, ret = 0;
  char *key = 
# 276 "project/goaccess/src/persistence.c" 3 4
             ((void *)0)
# 276 "project/goaccess/src/persistence.c"
                 ;
  uint32_t val = 0;
...
migrate_si32_to_ii32 (GSMetric metric, const char *path, int module) {
  kh_ii32_t * hash = 
# 303 "project/goaccess/src/persistence.c" 3 4
                         ((void *)0)
# 303 "project/goaccess/src/persistence.c"
                             ;
  tpl_node *tn;
  char fmt[] = "A(iA(su))";
  int date = 0, ret = 0;
  char *key = 
# 307 "project/goaccess/src/persistence.c" 3 4
             ((void *)0)
# 307 "project/goaccess/src/persistence.c"
                 ;
  uint32_t val = 0;
...
migrate_unique_key (char *key) {
  char *nkey = 
# 332 "project/goaccess/src/persistence.c" 3 4
              ((void *)0)
# 332 "project/goaccess/src/persistence.c"
                  , *token = 
# 332 "project/goaccess/src/persistence.c" 3 4
                             ((void *)0)
# 332 "project/goaccess/src/persistence.c"
...
# 332 "project/goaccess/src/persistence.c"
  ...
  if (!key || count_matches (key, '|') < 2)
    return 
# 337 "project/goaccess/src/persistence.c" 3 4
          ((void *)0)
# 337 "project/goaccess/src/persistence.c"
              ;
  ...
  while ((ptr = strchr (key, '|'))) {
    if (!(token = extract_by_delim (&key, "|"))) {
      free (nkey);
      return 
# 343 "project/goaccess/src/persistence.c" 3 4
            ((void *)0)
# 343 "project/goaccess/src/persistence.c"
                ;
    }
...
# 353 "project/goaccess/src/persistence.c" 3 4
   __builtin___sprintf_chk (
# 353 "project/goaccess/src/persistence.c"
   agent_hex
# 353 "project/goaccess/src/persistence.c" 3 4
   , 0, __builtin_object_size (
# 353 "project/goaccess/src/persistence.c"
...
migrate_si32_to_ii32_unique_keys (GSMetric metric, const char *path, int module) {
  kh_si32_t * hash = 
# 365 "project/goaccess/src/persistence.c" 3 4
                         ((void *)0)
# 365 "project/goaccess/src/persistence.c"
                             ;
  tpl_node *tn;
  char fmt[] = "A(iA(su))";
  int date = 0, ret = 0;
  char *key = 
# 369 "project/goaccess/src/persistence.c" 3 4
             ((void *)0)
# 369 "project/goaccess/src/persistence.c"
                 , *nkey = 
# 369 "project/goaccess/src/persistence.c" 3 4
                           ((void *)0)
# 369 "project/goaccess/src/persistence.c"
...
persist_si32 (GSMetric metric, const char *path, int module) {
  ...
  kh_si32_t * hash = 
# 400 "project/goaccess/src/persistence.c" 3 4
                         ((void *)0)
# 400 "project/goaccess/src/persistence.c"
                             ;
  tpl_node *tn = 
# 401 "project/goaccess/src/persistence.c" 3 4
                ((void *)0)
# 401 "project/goaccess/src/persistence.c"
                    ;
  int date = 0;
  char fmt[] = "A(iA(su))";
  uint32_t val = 0;
  const char *key = 
# 405 "project/goaccess/src/persistence.c" 3 4
                   ((void *)0)
# 405 "project/goaccess/src/persistence.c"
                       ;
  ...
  { khint_t __k; for (__k = (khint_t)(0); __k != ((dates)->n_buckets); ++__k) { if (!(!(((dates)->flags[(__k)>>4]>>(((__k)&0xfU)<<1))&3))) continue; (date) = ((dates)->keys[__k]); { if (!(hash = get_hash (module, date, metric))) return -1; { khint_t __i; for (__i = (khint_t)(0); __i != ((hash)->n_buckets); ++__i) { if (!(!(((hash)->flags[(__i)>>4]>>(((__i)&0xfU)<<1))&3))) continue; (key) = ((hash)->keys[__i]); (val) = ((hash)->vals[__i]); { tpl_pack (tn, 2); }; } }; tpl_pack (tn, 1); }; } }
...
migrate_is32_to_ii08 (GSMetric metric, const char *path, int module) {
  kh_ii08_t * hash = 
# 427 "project/goaccess/src/persistence.c" 3 4
                         ((void *)0)
# 427 "project/goaccess/src/persistence.c"
                             ;
  GKDB *db = get_db_instance (1);
  ...
  uint32_t key = 0;
  char *val = 
# 434 "project/goaccess/src/persistence.c" 3 4
             ((void *)0)
# 434 "project/goaccess/src/persistence.c"
                 ;
  khint_t k;
  ...
  while (tpl_unpack (tn, 1) > 0) {
    ...
    while (tpl_unpack (tn, 2) > 0) {
      k = kh_get_si08(mtpr, val);

      if (k == ((mtpr)->n_buckets)) {
        free (val);
        continue;
      }
      ins_ii08 (hash, key, ((mtpr)->vals[k]));
      free (val);
    }
  }
  tpl_free (tn);
...
restore_is32 (GSMetric metric, const char *path, int module) {
  kh_is32_t * hash = 
# 467 "project/goaccess/src/persistence.c" 3 4
                         ((void *)0)
# 467 "project/goaccess/src/persistence.c"
                             ;
  tpl_node *tn;
  char fmt[] = "A(iA(us))";
  int date = 0, ret = 0;
  uint32_t key = 0;
  char *val = 
# 472 "project/goaccess/src/persistence.c" 3 4
             ((void *)0)
# 472 "project/goaccess/src/persistence.c"
                 , *dupval = 
# 472 "project/goaccess/src/persistence.c" 3 4
                             ((void *)0)
# 472 "project/goaccess/src/persistence.c"
...
persist_is32 (GSMetric metric, const char *path, int module) {
  ...
  kh_igkh_t * dates = get_hdb (db, MTRC_DATES);
  kh_is32_t * hash = 
# 501 "project/goaccess/src/persistence.c" 3 4
                         ((void *)0)
# 501 "project/goaccess/src/persistence.c"
                             ;
  tpl_node *tn = 
# 502 "project/goaccess/src/persistence.c" 3 4
                ((void *)0)
# 502 "project/goaccess/src/persistence.c"
                    ;
  int date = 0;
  char fmt[] = "A(iA(us))";
  char *val = 
# 505 "project/goaccess/src/persistence.c" 3 4
             ((void *)0)
# 505 "project/goaccess/src/persistence.c"
                 ;
  uint32_t key = 0;
...
restore_ii08 (GSMetric metric, const char *path, int module) {
  kh_ii08_t * hash = 
# 529 "project/goaccess/src/persistence.c" 3 4
                         ((void *)0)
# 529 "project/goaccess/src/persistence.c"
                             ;
  tpl_node *tn;
  char fmt[] = "A(iA(uv))";
  int date = 0, ret = 0;
...
restore_ii32 (GSMetric metric, const char *path, int module) {
  kh_ii32_t * hash = 
# 559 "project/goaccess/src/persistence.c" 3 4
                         ((void *)0)
# 559 "project/goaccess/src/persistence.c"
                             ;
  tpl_node *tn;
  char fmt[] = "A(iA(uu))";
  int date = 0, ret = 0;
...
persist_ii32 (GSMetric metric, const char *path, int module) {
  ...
  kh_igkh_t * dates = get_hdb (db, MTRC_DATES);
  kh_ii32_t * hash = 
# 589 "project/goaccess/src/persistence.c" 3 4
                         ((void *)0)
# 589 "project/goaccess/src/persistence.c"
                             ;
  tpl_node *tn = 
# 590 "project/goaccess/src/persistence.c" 3 4
                ((void *)0)
# 590 "project/goaccess/src/persistence.c"
                    ;
  int date = 0;
  char fmt[] = "A(iA(uu))";
  uint32_t key = 0, val = 0;
...
persist_ii08 (GSMetric metric, const char *path, int module) {
  ...
  kh_igkh_t * dates = get_hdb (db, MTRC_DATES);
  kh_ii08_t * hash = 
# 616 "project/goaccess/src/persistence.c" 3 4
                         ((void *)0)
# 616 "project/goaccess/src/persistence.c"
                             ;
  tpl_node *tn = 
# 617 "project/goaccess/src/persistence.c" 3 4
                ((void *)0)
# 617 "project/goaccess/src/persistence.c"
                    ;
  int date = 0;
  char fmt[] = "A(iA(uv))";
  uint32_t key = 0;
...
restore_u648 (GSMetric metric, const char *path, int module) {
  kh_u648_t * hash = 
# 643 "project/goaccess/src/persistence.c" 3 4
                         ((void *)0)
# 643 "project/goaccess/src/persistence.c"
                             ;
  tpl_node *tn;
  char fmt[] = "A(iA(Uv))";
  int date = 0, ret = 0;
...
persist_u648 (GSMetric metric, const char *path, int module) {
  ...
  kh_igkh_t * dates = get_hdb (db, MTRC_DATES);
  kh_u648_t * hash = 
# 674 "project/goaccess/src/persistence.c" 3 4
                         ((void *)0)
# 674 "project/goaccess/src/persistence.c"
                             ;
  tpl_node *tn = 
# 675 "project/goaccess/src/persistence.c" 3 4
                ((void *)0)
# 675 "project/goaccess/src/persistence.c"
                    ;
  int date = 0;
  char fmt[] = "A(iA(Uv))";
  uint64_t key;
...
restore_iu64 (GSMetric metric, const char *path, int module) {
  kh_iu64_t * hash = 
# 701 "project/goaccess/src/persistence.c" 3 4
                         ((void *)0)
# 701 "project/goaccess/src/persistence.c"
                             ;
  tpl_node *tn;
  char fmt[] = "A(iA(uU))";
  int date = 0, ret = 0;
...
persist_iu64 (GSMetric metric, const char *path, int module) {
  ...
  kh_igkh_t * dates = get_hdb (db, MTRC_DATES);
  kh_iu64_t * hash = 
# 732 "project/goaccess/src/persistence.c" 3 4
                         ((void *)0)
# 732 "project/goaccess/src/persistence.c"
                             ;
  tpl_node *tn = 
# 733 "project/goaccess/src/persistence.c" 3 4
                ((void *)0)
# 733 "project/goaccess/src/persistence.c"
                    ;
  int date = 0;
  char fmt[] = "A(iA(uU))";
  uint32_t key;
...
restore_su64 (GSMetric metric, const char *path, int module) {
  kh_su64_t * hash = 
# 759 "project/goaccess/src/persistence.c" 3 4
                         ((void *)0)
# 759 "project/goaccess/src/persistence.c"
                             ;
  tpl_node *tn;
  char fmt[] = "A(iA(sU))";
  int date = 0, ret = 0;
  char *key = 
# 763 "project/goaccess/src/persistence.c" 3 4
             ((void *)0)
# 763 "project/goaccess/src/persistence.c"
                 ;
  uint64_t val;
...
persist_su64 (GSMetric metric, const char *path, int module) {
  ...
  kh_igkh_t * dates = get_hdb (db, MTRC_DATES);
  kh_su64_t * hash = 
# 791 "project/goaccess/src/persistence.c" 3 4
                         ((void *)0)
# 791 "project/goaccess/src/persistence.c"
                             ;
  tpl_node *tn = 
# 792 "project/goaccess/src/persistence.c" 3 4
                ((void *)0)
# 792 "project/goaccess/src/persistence.c"
                    ;
  int date = 0;
  char fmt[] = "A(iA(sU))";
  const char *key = 
# 795 "project/goaccess/src/persistence.c" 3 4
                   ((void *)0)
# 795 "project/goaccess/src/persistence.c"
                       ;
  uint64_t val;
...
restore_igsl (GSMetric metric, const char *path, int module) {
  kh_igsl_t * hash = 
# 818 "project/goaccess/src/persistence.c" 3 4
                         ((void *)0)
# 818 "project/goaccess/src/persistence.c"
                             ;
  tpl_node *tn;
  char fmt[] = "A(iA(uu))";
  int date = 0, ret = 0;
...
persist_igsl (GSMetric metric, const char *path, int module) {
  ...
  kh_igkh_t * dates = get_hdb (db, MTRC_DATES);
  kh_igsl_t * hash = 
# 848 "project/goaccess/src/persistence.c" 3 4
                         ((void *)0)
# 848 "project/goaccess/src/persistence.c"
                             ;
  GSLList *node;
  tpl_node *tn = 
# 850 "project/goaccess/src/persistence.c" 3 4
                ((void *)0)
# 850 "project/goaccess/src/persistence.c"
                    ;
  int date = 0;
  char fmt[] = "A(iA(uu))";
  uint32_t key, val;
  ...
  { khint_t __k; for (__k = (khint_t)(0); __k != ((dates)->n_buckets); ++__k) { if (!(!(((dates)->flags[(__k)>>4]>>(((__k)&0xfU)<<1))&3))) continue; (date) = ((dates)->keys[__k]); { if (!(hash = get_hash (module, date, metric))) return -1; { khint_t __i; for (__i = (khint_t)(0); __i != ((hash)->n_buckets); ++__i) { if (!(!(((hash)->flags[(__i)>>4]>>(((__i)&0xfU)<<1))&3))) continue; (key) = ((hash)->keys[__i]); (node) = ((hash)->vals[__i]); { while (node) { val = (*(uint32_t *) node->data); node = node->next; } tpl_pack (tn, 2); }; } }; tpl_pack (tn, 1); }; } }
# 870 "project/goaccess/src/persistence.c"
    ;
...
check_restore_path (const char *fn) {
  ...
  if (access (path, 
# 884 "project/goaccess/src/persistence.c" 3 4
                   0
# 884 "project/goaccess/src/persistence.c"
                       ) != -1)
    return path;

  do { dbg_fprintf ("DB file %s doesn't exist. %s\n", path, strerror (
# 887 "project/goaccess/src/persistence.c" 3 4
 (*__error())
# 887 "project/goaccess/src/persistence.c"
 )); } while (0);
  free (path);
  return 
# 889 "project/goaccess/src/persistence.c" 3 4
        ((void *)0)
# 889 "project/goaccess/src/persistence.c"
            ;
}
...
restore_by_type (GKHashMetric mtrc, const char *fn, int module) {
  char *path = 
# 895 "project/goaccess/src/persistence.c" 3 4
              ((void *)0)
# 895 "project/goaccess/src/persistence.c"
                  ;
...
restore_metric_type (GModule module, GKHashMetric mtrc) {
  char *fn = 
# 935 "project/goaccess/src/persistence.c" 3 4
            ((void *)0)
# 935 "project/goaccess/src/persistence.c"
                ;
...
migrate_metric (GModule module, GKHashMetric mtrc) {
  GKDB *db = get_db_instance (1);
  kh_si32_t * db_props = get_hdb (db, MTRC_DB_PROPS);

  int ret = 0;
  char *fn = 
# 948 "project/goaccess/src/persistence.c" 3 4
            ((void *)0)
# 948 "project/goaccess/src/persistence.c"
                , *path = 
# 948 "project/goaccess/src/persistence.c" 3 4
                          ((void *)0)
# 948 "project/goaccess/src/persistence.c"
                              ;
  char *modstr = 
# 949 "project/goaccess/src/persistence.c" 3 4
                ((void *)0)
# 949 "project/goaccess/src/persistence.c"
                    , *mtrstr = 
# 949 "project/goaccess/src/persistence.c" 3 4
                                ((void *)0)
# 949 "project/goaccess/src/persistence.c"
  ...
  k = kh_get_si32(db_props, "version");

  if (k != ((db_props)->n_buckets) && ((db_props)->vals[k]) == 2)
    return 0;
  ...
  case MTRC_KEYMAP:
    if (!(modstr = get_module_str (module)))
      do { (void) endwin (); fprintf (
# 968 "project/goaccess/src/persistence.c" 3 4
     __stderrp
# 968 "project/goaccess/src/persistence.c"
     , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:14"); fprintf (
# 968 "project/goaccess/src/persistence.c" 3 4
     __stderrp
# 968 "project/goaccess/src/persistence.c"
...
# 968 "project/goaccess/src/persistence.c" 3 4
     __stderrp
# 968 "project/goaccess/src/persistence.c"
     , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/persistence.c", __FUNCTION__, 968); fprintf (
# 968 "project/goaccess/src/persistence.c" 3 4
     __stderrp
# 968 "project/goaccess/src/persistence.c"
     , "Unable to allocate module name."); fprintf (
...
# 968 "project/goaccess/src/persistence.c"
  ...
  case MTRC_PROTOCOLS:
    if (!(mtrstr = get_mtr_str (mtrc.metric.storem)))
      do { (void) endwin (); fprintf (
# 980 "project/goaccess/src/persistence.c" 3 4
     __stderrp
# 980 "project/goaccess/src/persistence.c"
     , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:14"); fprintf (
# 980 "project/goaccess/src/persistence.c" 3 4
     __stderrp
# 980 "project/goaccess/src/persistence.c"
...
# 980 "project/goaccess/src/persistence.c" 3 4
     __stderrp
# 980 "project/goaccess/src/persistence.c"
     , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/persistence.c", __FUNCTION__, 980); fprintf (
# 980 "project/goaccess/src/persistence.c" 3 4
     __stderrp
# 980 "project/goaccess/src/persistence.c"
     , "Unable to allocate metric name."); fprintf (
...
# 980 "project/goaccess/src/persistence.c"
    ...
    if (!(modstr = get_module_str (module)))
      do { (void) endwin (); fprintf (
# 982 "project/goaccess/src/persistence.c" 3 4
     __stderrp
# 982 "project/goaccess/src/persistence.c"
     , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:14"); fprintf (
# 982 "project/goaccess/src/persistence.c" 3 4
     __stderrp
# 982 "project/goaccess/src/persistence.c"
...
# 982 "project/goaccess/src/persistence.c" 3 4
     __stderrp
# 982 "project/goaccess/src/persistence.c"
     , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/persistence.c", __FUNCTION__, 982); fprintf (
# 982 "project/goaccess/src/persistence.c" 3 4
     __stderrp
# 982 "project/goaccess/src/persistence.c"
     , "Unable to allocate module name."); fprintf (
...
persist_dates (void) {
  tpl_node *tn;
  char *path = 
# 1016 "project/goaccess/src/persistence.c" 3 4
              ((void *)0)
# 1016 "project/goaccess/src/persistence.c"
                  ;
  uint32_t *dates = 
# 1017 "project/goaccess/src/persistence.c" 3 4
                   ((void *)0)
# 1017 "project/goaccess/src/persistence.c"
                       , len = 0, i, date = 0;
  char fmt[] = "A(u)";
...
restore_dates (void) {
  tpl_node *tn;
  char *path = 
# 1041 "project/goaccess/src/persistence.c" 3 4
              ((void *)0)
# 1041 "project/goaccess/src/persistence.c"
                  ;
  uint32_t date, idx = 0;
  char fmt[] = "A(u)";
  int len;
...
restore_global (void) {
  GKDB *db = get_db_instance (1);
  kh_si32_t * overall = get_hdb (db, MTRC_CNT_OVERALL);
  kh_si32_t * seqs = get_hdb (db, MTRC_SEQS);
  kh_iglp_t * last_parse = get_hdb (db, MTRC_LAST_PARSE);
  kh_si32_t * db_props = get_hdb (db, MTRC_DB_PROPS);
  kh_si08_t * meth_proto = get_hdb (db, MTRC_METH_PROTO);

  char *path = 
# 1075 "project/goaccess/src/persistence.c" 3 4
              ((void *)0)
# 1075 "project/goaccess/src/persistence.c"
                  ;
...
persist_by_type (GKHashMetric mtrc, const char *fn, int module) {
  char *path = 
# 1131 "project/goaccess/src/persistence.c" 3 4
              ((void *)0)
# 1131 "project/goaccess/src/persistence.c"
                  ;
  path = set_db_path (fn);
...
persist_metric_type (GModule module, GKHashMetric mtrc) {
  char *fn = 
# 1167 "project/goaccess/src/persistence.c" 3 4
            ((void *)0)
# 1167 "project/goaccess/src/persistence.c"
                ;
  fn = get_filename (module, mtrc);
...
persist_global (void) {
  ...
  kh_si08_t * meth_proto = get_hdb (db, MTRC_METH_PROTO);
  char *path = 
# 1181 "project/goaccess/src/persistence.c" 3 4
              ((void *)0)
# 1181 "project/goaccess/src/persistence.c"
                  ;

  ins_si32 (db_props, "version", 2);
