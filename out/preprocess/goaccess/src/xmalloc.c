# 0 "project/goaccess/src/xmalloc.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 32 "project/goaccess/src/xmalloc.c" 2
...
# 34 "project/goaccess/src/xmalloc.c" 2
...
# 36 "project/goaccess/src/xmalloc.c" 2
...
# 37 "project/goaccess/src/xmalloc.c" 2
...
# 39 "project/goaccess/src/xmalloc.c" 2
...
# 40 "project/goaccess/src/xmalloc.c" 2
...
xmalloc (size_t size) {
  ...
  if ((ptr = malloc (size)) == 
# 46 "project/goaccess/src/xmalloc.c" 3 4
                              ((void *)0)
# 46 "project/goaccess/src/xmalloc.c"
                                  )
    do { (void) endwin (); fprintf (
# 47 "project/goaccess/src/xmalloc.c" 3 4
   __stderrp
# 47 "project/goaccess/src/xmalloc.c"
...
# 47 "project/goaccess/src/xmalloc.c" 3 4
   __stderrp
# 47 "project/goaccess/src/xmalloc.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/xmalloc.c", __FUNCTION__, 47); fprintf (
# 47 "project/goaccess/src/xmalloc.c" 3 4
   __stderrp
# 47 "project/goaccess/src/xmalloc.c"
   , "Unable to allocate memory - failed."); fprintf (
# 47 "project/goaccess/src/xmalloc.c" 3 4
   __stderrp
# 47 "project/goaccess/src/xmalloc.c"
   , "\n\n"); do { dbg_fprintf ("Unable to allocate memory - failed."); } while (0); exit(
# 47 "project/goaccess/src/xmalloc.c" 3 4
   1
# 47 "project/goaccess/src/xmalloc.c"
   ); } while (0);
...
# 60 "project/goaccess/src/xmalloc.c" 3 4
 __builtin___strncpy_chk (
# 60 "project/goaccess/src/xmalloc.c"
 ptr
# 60 "project/goaccess/src/xmalloc.c" 3 4
 , 
# 60 "project/goaccess/src/xmalloc.c"
...
# 69 "project/goaccess/src/xmalloc.c" 3 4
                                     ((void *)0)
# 69 "project/goaccess/src/xmalloc.c"
                                         )
    do { (void) endwin (); fprintf (
# 70 "project/goaccess/src/xmalloc.c" 3 4
   __stderrp
# 70 "project/goaccess/src/xmalloc.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:17"); fprintf (
# 70 "project/goaccess/src/xmalloc.c" 3 4
   __stderrp
# 70 "project/goaccess/src/xmalloc.c"
...
# 70 "project/goaccess/src/xmalloc.c" 3 4
   __stderrp
# 70 "project/goaccess/src/xmalloc.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/xmalloc.c", __FUNCTION__, 70); fprintf (
# 70 "project/goaccess/src/xmalloc.c" 3 4
   __stderrp
# 70 "project/goaccess/src/xmalloc.c"
   , "Unable to calloc memory - failed."); fprintf (
# 70 "project/goaccess/src/xmalloc.c" 3 4
   __stderrp
# 70 "project/goaccess/src/xmalloc.c"
   , "\n\n"); do { dbg_fprintf ("Unable to calloc memory - failed."); } while (0); exit(
# 70 "project/goaccess/src/xmalloc.c" 3 4
   1
# 70 "project/goaccess/src/xmalloc.c"
   ); } while (0);
...
xrealloc (void *oldptr, size_t size) {
  ...
  if ((newptr = realloc (oldptr, size)) == 
# 80 "project/goaccess/src/xmalloc.c" 3 4
                                          ((void *)0)
# 80 "project/goaccess/src/xmalloc.c"
                                              )
    do { (void) endwin (); fprintf (
# 81 "project/goaccess/src/xmalloc.c" 3 4
   __stderrp
# 81 "project/goaccess/src/xmalloc.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:17"); fprintf (
# 81 "project/goaccess/src/xmalloc.c" 3 4
   __stderrp
# 81 "project/goaccess/src/xmalloc.c"
...
# 81 "project/goaccess/src/xmalloc.c" 3 4
   __stderrp
# 81 "project/goaccess/src/xmalloc.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/xmalloc.c", __FUNCTION__, 81); fprintf (
# 81 "project/goaccess/src/xmalloc.c" 3 4
   __stderrp
# 81 "project/goaccess/src/xmalloc.c"
   , "Unable to reallocate memory - failed"); fprintf (
# 81 "project/goaccess/src/xmalloc.c" 3 4
   __stderrp
# 81 "project/goaccess/src/xmalloc.c"
   , "\n\n"); do { dbg_fprintf ("Unable to reallocate memory - failed"); } while (0); exit(
# 81 "project/goaccess/src/xmalloc.c" 3 4
   1
# 81 "project/goaccess/src/xmalloc.c"
   ); } while (0);
