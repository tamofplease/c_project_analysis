# 0 "project/goaccess/src/goaccess.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/goaccess/src/goaccess.c"
# 35 "project/goaccess/src/goaccess.c"
...
# 36 "project/goaccess/src/goaccess.c" 2
...
# 37 "project/goaccess/src/goaccess.c" 2
...
# 38 "project/goaccess/src/goaccess.c" 2
...
# 40 "project/goaccess/src/goaccess.c" 2
...
# 80 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/fcntl.h" 3 4
...
# 46 "project/goaccess/src/goaccess.c" 2
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/grp.h" 1 3 4
# 46 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/grp.h" 3 4
...
# 47 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/grp.h" 2 3 4
...
# 77 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/grp.h" 2 3 4
...
# 47 "project/goaccess/src/goaccess.c" 2
...
# 48 "project/goaccess/src/goaccess.c" 2
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/pwd.h" 1 3 4
# 49 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/pwd.h" 3 4
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/_types/_uid_t.h" 1 3 4
# 31 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/_types/_uid_t.h" 3 4
typedef __darwin_uid_t uid_t;
# 50 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/pwd.h" 2 3 4
...
# 49 "project/goaccess/src/goaccess.c" 2
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/signal.h" 1 3 4
# 63 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/signal.h" 3 4
...
# 50 "project/goaccess/src/goaccess.c" 2
...
# 51 "project/goaccess/src/goaccess.c" 2
...
# 52 "project/goaccess/src/goaccess.c" 2
...
# 53 "project/goaccess/src/goaccess.c" 2
...
# 54 "project/goaccess/src/goaccess.c" 2
...
# 55 "project/goaccess/src/goaccess.c" 2
...
# 56 "project/goaccess/src/goaccess.c" 2
...
# 57 "project/goaccess/src/goaccess.c" 2
...
# 58 "project/goaccess/src/goaccess.c" 2
...
# 60 "project/goaccess/src/goaccess.c" 2
...
# 66 "project/goaccess/src/goaccess.c" 2
# 1 "project/goaccess/src/csv.h" 1
# 39 "project/goaccess/src/csv.h"
...
# 67 "project/goaccess/src/goaccess.c" 2
...
# 68 "project/goaccess/src/goaccess.c" 2
...
# 69 "project/goaccess/src/goaccess.c" 2
...
# 70 "project/goaccess/src/goaccess.c" 2
...
# 71 "project/goaccess/src/goaccess.c" 2
...
# 72 "project/goaccess/src/goaccess.c" 2
# 1 "project/goaccess/src/gwsocket.h" 1
# 36 "project/goaccess/src/gwsocket.h"
...
# 37 "project/goaccess/src/gwsocket.h" 2
...
# 73 "project/goaccess/src/goaccess.c" 2
# 1 "project/goaccess/src/json.h" 1
# 42 "project/goaccess/src/json.h"
...
# 74 "project/goaccess/src/goaccess.c" 2
# 1 "project/goaccess/src/options.h" 1
# 37 "project/goaccess/src/options.h"
...
# 75 "project/goaccess/src/goaccess.c" 2
# 1 "project/goaccess/src/output.h" 1
# 39 "project/goaccess/src/output.h"
# 1 "project/goaccess/src/commons.h" 1
# 40 "project/goaccess/src/output.h" 2
...
# 76 "project/goaccess/src/goaccess.c" 2
...
# 77 "project/goaccess/src/goaccess.c" 2
# 1 "project/goaccess/src/websocket.h" 1
# 78 "project/goaccess/src/goaccess.c" 2
...
# 79 "project/goaccess/src/goaccess.c" 2
...
house_keeping (void) {
  ...
  if (conf.invalid_requests_log) {
    do { dbg_fprintf ("Closing invalid requests log.\n"); } while (0);
    invalid_log_close ();
  }


  if (conf.unknowns_log) {
    do { dbg_fprintf ("Closing unknowns log.\n"); } while (0);
    unknowns_log_close ();
  }
...
# 225 "project/goaccess/src/goaccess.c" 3 4
 (*__error()) 
# 225 "project/goaccess/src/goaccess.c"
       = 0;
  if ((pw = getpwnam (conf.username)) == 
# 226 "project/goaccess/src/goaccess.c" 3 4
                                        ((void *)0)
# 226 "project/goaccess/src/goaccess.c"
                                            ) {
    if (
# 227 "project/goaccess/src/goaccess.c" 3 4
       (*__error()) 
# 227 "project/goaccess/src/goaccess.c"
             == 0)
      do { (void) endwin (); fprintf (
# 228 "project/goaccess/src/goaccess.c" 3 4
     __stderrp
# 228 "project/goaccess/src/goaccess.c"
...
# 228 "project/goaccess/src/goaccess.c" 3 4
     __stderrp
# 228 "project/goaccess/src/goaccess.c"
     , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/goaccess.c", __FUNCTION__, 228); fprintf (
# 228 "project/goaccess/src/goaccess.c" 3 4
     __stderrp
# 228 "project/goaccess/src/goaccess.c"
     , "No such user %s", conf.username); fprintf (
# 228 "project/goaccess/src/goaccess.c" 3 4
     __stderrp
# 228 "project/goaccess/src/goaccess.c"
     , "\n\n"); do { dbg_fprintf ("No such user %s", conf.username); } while (0); exit(
# 228 "project/goaccess/src/goaccess.c" 3 4
     1
# 228 "project/goaccess/src/goaccess.c"
     ); } while (0);
    do { (void) endwin (); fprintf (
# 229 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 229 "project/goaccess/src/goaccess.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:17"); fprintf (
# 229 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 229 "project/goaccess/src/goaccess.c"
...
# 229 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 229 "project/goaccess/src/goaccess.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/goaccess.c", __FUNCTION__, 229); fprintf (
# 229 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 229 "project/goaccess/src/goaccess.c"
   , "Unable to retrieve user %s: %s", conf.username, strerror (
# 229 "project/goaccess/src/goaccess.c" 3 4
   (*__error())
# 229 "project/goaccess/src/goaccess.c"
   )); fprintf (
# 229 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 229 "project/goaccess/src/goaccess.c"
   , "\n\n"); do { dbg_fprintf ("Unable to retrieve user %s: %s", conf.username, strerror (
# 229 "project/goaccess/src/goaccess.c" 3 4
   (*__error())
# 229 "project/goaccess/src/goaccess.c"
   )); } while (0); exit(
...
# 229 "project/goaccess/src/goaccess.c"
  ...
  if (setgroups (1, &pw->pw_gid) == -1)
    do { (void) endwin (); fprintf (
# 233 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 233 "project/goaccess/src/goaccess.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:17"); fprintf (
# 233 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 233 "project/goaccess/src/goaccess.c"
...
# 233 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 233 "project/goaccess/src/goaccess.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/goaccess.c", __FUNCTION__, 233); fprintf (
# 233 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 233 "project/goaccess/src/goaccess.c"
   , "setgroups: %s", strerror (
# 233 "project/goaccess/src/goaccess.c" 3 4
   (*__error())
# 233 "project/goaccess/src/goaccess.c"
   )); fprintf (
# 233 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 233 "project/goaccess/src/goaccess.c"
   , "\n\n"); do { dbg_fprintf ("setgroups: %s", strerror (
# 233 "project/goaccess/src/goaccess.c" 3 4
   (*__error())
# 233 "project/goaccess/src/goaccess.c"
   )); } while (0); exit(
...
# 233 "project/goaccess/src/goaccess.c"
  ...
  if (setgid (pw->pw_gid) == -1)
    do { (void) endwin (); fprintf (
# 235 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 235 "project/goaccess/src/goaccess.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:17"); fprintf (
# 235 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 235 "project/goaccess/src/goaccess.c"
...
# 235 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 235 "project/goaccess/src/goaccess.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/goaccess.c", __FUNCTION__, 235); fprintf (
# 235 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 235 "project/goaccess/src/goaccess.c"
   , "setgid: %s", strerror (
...
# 235 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 235 "project/goaccess/src/goaccess.c"
   , "\n\n"); do { dbg_fprintf ("setgid: %s", strerror (
# 235 "project/goaccess/src/goaccess.c" 3 4
   (*__error())
# 235 "project/goaccess/src/goaccess.c"
   )); } while (0); exit(
...
# 235 "project/goaccess/src/goaccess.c"
  ...
  if (setuid (pw->pw_uid) == -1)
    do { (void) endwin (); fprintf (
# 237 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 237 "project/goaccess/src/goaccess.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:17"); fprintf (
# 237 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 237 "project/goaccess/src/goaccess.c"
...
# 237 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 237 "project/goaccess/src/goaccess.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/goaccess.c", __FUNCTION__, 237); fprintf (
# 237 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 237 "project/goaccess/src/goaccess.c"
   , "setuid: %s", strerror (
...
# 237 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 237 "project/goaccess/src/goaccess.c"
   , "\n\n"); do { dbg_fprintf ("setuid: %s", strerror (
# 237 "project/goaccess/src/goaccess.c" 3 4
   (*__error())
# 237 "project/goaccess/src/goaccess.c"
   )); } while (0); exit(
...
write_pid_file (const char *path, pid_t pid) {
  ...
  if ((pidfile = fopen (path, "w"))) {
    ...
    do { (void) endwin (); fprintf (
# 253 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 253 "project/goaccess/src/goaccess.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:17"); fprintf (
# 253 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 253 "project/goaccess/src/goaccess.c"
...
# 253 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 253 "project/goaccess/src/goaccess.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/goaccess.c", __FUNCTION__, 253); fprintf (
# 253 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 253 "project/goaccess/src/goaccess.c"
   , "Unable to open the specified pid file. %s", strerror (
# 253 "project/goaccess/src/goaccess.c" 3 4
   (*__error())
# 253 "project/goaccess/src/goaccess.c"
   )); fprintf (
# 253 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 253 "project/goaccess/src/goaccess.c"
   , "\n\n"); do { dbg_fprintf ("Unable to open the specified pid file. %s", strerror (
# 253 "project/goaccess/src/goaccess.c" 3 4
   (*__error())
# 253 "project/goaccess/src/goaccess.c"
   )); } while (0); exit(
...
daemonize (void) {
  ...
  if (pid < 0)
    exit (
# 267 "project/goaccess/src/goaccess.c" 3 4
         1
# 267 "project/goaccess/src/goaccess.c"
                     );
  if (pid > 0) {
    write_pid_file (conf.pidfile, pid);
    printf ("Daemonized GoAccess: %d\n", pid);
    exit (
# 271 "project/goaccess/src/goaccess.c" 3 4
         0
# 271 "project/goaccess/src/goaccess.c"
                     );
  }
  ...
  sid = setsid ();
  if (sid < 0) {
    do { dbg_fprintf ("Unable to setsid: %s.\n", strerror (
# 278 "project/goaccess/src/goaccess.c" 3 4
   (*__error())
# 278 "project/goaccess/src/goaccess.c"
   )); } while (0);
    exit (
# 279 "project/goaccess/src/goaccess.c" 3 4
         1
# 279 "project/goaccess/src/goaccess.c"
                     );
  }
  ...
  if (chdir ("/") < 0) {
    do { dbg_fprintf ("Unable to set chdir: %s.\n", strerror (
# 285 "project/goaccess/src/goaccess.c" 3 4
   (*__error())
# 285 "project/goaccess/src/goaccess.c"
   )); } while (0);
    exit (
# 286 "project/goaccess/src/goaccess.c" 3 4
         1
# 286 "project/goaccess/src/goaccess.c"
                     );
  }
  ...
  if ((fd = open ("/dev/null", 
# 291 "project/goaccess/src/goaccess.c" 3 4
                              0x0002
# 291 "project/goaccess/src/goaccess.c"
                                    , 0)) == -1) {
    do { dbg_fprintf ("Unable to open /dev/null: %s.\n", strerror (
# 292 "project/goaccess/src/goaccess.c" 3 4
   (*__error())
# 292 "project/goaccess/src/goaccess.c"
   )); } while (0);
    exit (
# 293 "project/goaccess/src/goaccess.c" 3 4
         1
# 293 "project/goaccess/src/goaccess.c"
                     );
  }

  dup2 (fd, 
# 296 "project/goaccess/src/goaccess.c" 3 4
           0
# 296 "project/goaccess/src/goaccess.c"
                       );
  dup2 (fd, 
# 297 "project/goaccess/src/goaccess.c" 3 4
           1
# 297 "project/goaccess/src/goaccess.c"
                        );
  dup2 (fd, 
# 298 "project/goaccess/src/goaccess.c" 3 4
           2
# 298 "project/goaccess/src/goaccess.c"
                        );
  if (fd > 
# 299 "project/goaccess/src/goaccess.c" 3 4
          2
# 299 "project/goaccess/src/goaccess.c"
                       ) {
    close (fd);
  }
}
...
allocate_holder_by_module (GModule module) {
  ...
  if (!raw_data) {
    do { dbg_fprintf ("raw data is NULL for module: %d.\n", module); } while (0);
    return;
  }
...
allocate_data_by_module (GModule module, int col_data) {
  ...
  if (gscroll.expanded && module == gscroll.current)
    dash->module[module].dash_size = 32;
  else
    dash->module[module].dash_size = 12;
...
render_screens (uint32_t offset) {
  ...
  mvaddstr (row - 1, 1, dgettext (PACKAGE , "[?] Help [Enter] Exp. Panel"));
  mvprintw (row - 1, col / 2 - 10, "%" 
# 404 "project/goaccess/src/goaccess.c" 3 4
                                      "u" 
# 404 "project/goaccess/src/goaccess.c"
                                             "/r - %s", offset, time_str_buf);
  mvaddstr (row - 1, col - 6 - strlen (dgettext (PACKAGE , "[q]uit GoAccess")), dgettext (PACKAGE , "[q]uit GoAccess"));
  mvprintw (row - 1, col - 5, "%s", "1.5.4");
...
disabled_panel_msg (GModule module) {
  ...
  getmaxyx (stdscr, row, col);
  draw_header (stdscr, lbl, dgettext (PACKAGE , "'%1$s' panel is disabled"), row - 1, 0, col, color_error);
}
...
tail_html (void) {
  char *json = 
# 697 "project/goaccess/src/goaccess.c" 3 4
              ((void *)0)
# 697 "project/goaccess/src/goaccess.c"
                  ;
  ...
  if (json == 
# 710 "project/goaccess/src/goaccess.c" 3 4
             ((void *)0)
# 710 "project/goaccess/src/goaccess.c"
                 )
    return;
...
fast_forward_client (int listener) {
  char *json = 
# 722 "project/goaccess/src/goaccess.c" 3 4
              ((void *)0)
# 722 "project/goaccess/src/goaccess.c"
                  ;
  ...
  if (json == 
# 728 "project/goaccess/src/goaccess.c" 3 4
             ((void *)0)
# 728 "project/goaccess/src/goaccess.c"
                 )
    return;
...
# 772 "project/goaccess/src/goaccess.c" 3 4
                                        ((void *)0)
# 772 "project/goaccess/src/goaccess.c"
                                            ) {
...
verify_inode (FILE * fp, GLog * glog) {
  ...
  if (stat (glog->filename, &fdstat) == -1)
    do { (void) endwin (); fprintf (
# 793 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 793 "project/goaccess/src/goaccess.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:17"); fprintf (
# 793 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 793 "project/goaccess/src/goaccess.c"
...
# 793 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 793 "project/goaccess/src/goaccess.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/goaccess.c", __FUNCTION__, 793); fprintf (
# 793 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 793 "project/goaccess/src/goaccess.c"
   , "Unable to stat the specified log file '%s'. %s", glog->filename, strerror (
# 793 "project/goaccess/src/goaccess.c" 3 4
   (*__error())
# 793 "project/goaccess/src/goaccess.c"
   )); fprintf (
# 793 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 793 "project/goaccess/src/goaccess.c"
   , "\n\n"); do { dbg_fprintf ("Unable to stat the specified log file '%s'. %s", glog->filename, strerror (
# 793 "project/goaccess/src/goaccess.c" 3 4
   (*__error())
# 793 "project/goaccess/src/goaccess.c"
   )); } while (0); exit(
...
perform_tail_follow (GLog * glog) {
  FILE *fp = 
# 813 "project/goaccess/src/goaccess.c" 3 4
            ((void *)0)
# 813 "project/goaccess/src/goaccess.c"
                ;
  char buf[4096u + 1] = { 0 };
  uint16_t len = 0;
  uint64_t length = 0;
  ...
  if (!(fp = fopen (glog->filename, "r")))
    do { (void) endwin (); fprintf (
# 837 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 837 "project/goaccess/src/goaccess.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:17"); fprintf (
# 837 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 837 "project/goaccess/src/goaccess.c"
...
# 837 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 837 "project/goaccess/src/goaccess.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/goaccess.c", __FUNCTION__, 837); fprintf (
# 837 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 837 "project/goaccess/src/goaccess.c"
   , "Unable to read the specified log file '%s'. %s", glog->filename, strerror (
# 837 "project/goaccess/src/goaccess.c" 3 4
   (*__error())
# 837 "project/goaccess/src/goaccess.c"
   )); fprintf (
# 837 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 837 "project/goaccess/src/goaccess.c"
   , "\n\n"); do { dbg_fprintf ("Unable to read the specified log file '%s'. %s", glog->filename, strerror (
# 837 "project/goaccess/src/goaccess.c" 3 4
   (*__error())
# 837 "project/goaccess/src/goaccess.c"
   )); } while (0); exit(
...
# 837 "project/goaccess/src/goaccess.c"
  ...
  len = ({ __typeof__ (glog->snippetlen) _a = (glog->snippetlen); __typeof__ (length) _b = (length); _a < _b ? _a : _b; });


  if ((fread (buf, len, 1, fp)) != 1 && ferror (fp))
    do { (void) endwin (); fprintf (
# 845 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 845 "project/goaccess/src/goaccess.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:17"); fprintf (
# 845 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 845 "project/goaccess/src/goaccess.c"
...
# 845 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 845 "project/goaccess/src/goaccess.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/goaccess.c", __FUNCTION__, 845); fprintf (
# 845 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 845 "project/goaccess/src/goaccess.c"
   , "Unable to fread the specified log file '%s'", glog->filename); fprintf (
# 845 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 845 "project/goaccess/src/goaccess.c"
   , "\n\n"); do { dbg_fprintf ("Unable to fread the specified log file '%s'", glog->filename); } while (0); exit(
# 845 "project/goaccess/src/goaccess.c" 3 4
   1
# 845 "project/goaccess/src/goaccess.c"
   ); } while (0);
  ...
  if (!fseeko (fp, glog->length, 
# 854 "project/goaccess/src/goaccess.c" 3 4
                                0
# 854 "project/goaccess/src/goaccess.c"
                                        ))
...
tail_loop_html (Logs * logs) {
  struct timespec refresh = {
    .tv_sec = conf.html_refresh ? conf.html_refresh : 1,
    .tv_nsec = 0,
  };
  int i = 0, ret = 0;
  ...
  while (1) {
    ...
    if (nanosleep (&refresh, 
# 891 "project/goaccess/src/goaccess.c" 3 4
                            ((void *)0)
# 891 "project/goaccess/src/goaccess.c"
                                ) == -1 && 
# 891 "project/goaccess/src/goaccess.c" 3 4
                                           (*__error()) 
# 891 "project/goaccess/src/goaccess.c"
...
# 891 "project/goaccess/src/goaccess.c"
      ...
      do { (void) endwin (); fprintf (
# 892 "project/goaccess/src/goaccess.c" 3 4
     __stderrp
# 892 "project/goaccess/src/goaccess.c"
     , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:17"); fprintf (
# 892 "project/goaccess/src/goaccess.c" 3 4
     __stderrp
# 892 "project/goaccess/src/goaccess.c"
...
# 892 "project/goaccess/src/goaccess.c" 3 4
     __stderrp
# 892 "project/goaccess/src/goaccess.c"
     , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/goaccess.c", __FUNCTION__, 892); fprintf (
# 892 "project/goaccess/src/goaccess.c" 3 4
     __stderrp
# 892 "project/goaccess/src/goaccess.c"
     , "nanosleep: %s", strerror (
# 892 "project/goaccess/src/goaccess.c" 3 4
     (*__error())
# 892 "project/goaccess/src/goaccess.c"
     )); fprintf (
...
next_module (void) {
  ...
  if (!conf.no_tab_scroll)
    gscroll.dash = get_module_index (gscroll.current) * 12;
...
term_tail_logs (Logs * logs) {
  ...
  if (nanosleep (&ts, 
# 996 "project/goaccess/src/goaccess.c" 3 4
                     ((void *)0)
# 996 "project/goaccess/src/goaccess.c"
                         ) == -1 && 
# 996 "project/goaccess/src/goaccess.c" 3 4
                                    (*__error()) 
# 996 "project/goaccess/src/goaccess.c"
...
# 996 "project/goaccess/src/goaccess.c"
    ...
    do { (void) endwin (); fprintf (
# 997 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 997 "project/goaccess/src/goaccess.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:17"); fprintf (
# 997 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 997 "project/goaccess/src/goaccess.c"
...
# 997 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 997 "project/goaccess/src/goaccess.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/goaccess.c", __FUNCTION__, 997); fprintf (
# 997 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 997 "project/goaccess/src/goaccess.c"
   , "nanosleep: %s", strerror (
...
standard_output (Logs * logs) {
  char *csv = 
# 1252 "project/goaccess/src/goaccess.c" 3 4
             ((void *)0)
# 1252 "project/goaccess/src/goaccess.c"
                 , *json = 
# 1252 "project/goaccess/src/goaccess.c" 3 4
                           ((void *)0)
# 1252 "project/goaccess/src/goaccess.c"
...
# 1287 "project/goaccess/src/goaccess.c" 3 4
 libintl_setlocale 
# 1287 "project/goaccess/src/goaccess.c"
           (
# 1287 "project/goaccess/src/goaccess.c" 3 4
            0
# 1287 "project/goaccess/src/goaccess.c"
  ...
  if (loc_ctype != 
# 1292 "project/goaccess/src/goaccess.c" 3 4
                  ((void *)0)
# 1292 "project/goaccess/src/goaccess.c"
                      )
    
# 1293 "project/goaccess/src/goaccess.c" 3 4
   libintl_setlocale 
# 1293 "project/goaccess/src/goaccess.c"
             (
# 1293 "project/goaccess/src/goaccess.c" 3 4
              2
# 1293 "project/goaccess/src/goaccess.c"
...
# 1295 "project/goaccess/src/goaccess.c" 3 4
   libintl_setlocale 
# 1295 "project/goaccess/src/goaccess.c"
             (
# 1295 "project/goaccess/src/goaccess.c" 3 4
              2
# 1295 "project/goaccess/src/goaccess.c"
...
# 1297 "project/goaccess/src/goaccess.c" 3 4
   libintl_setlocale 
# 1297 "project/goaccess/src/goaccess.c"
             (
# 1297 "project/goaccess/src/goaccess.c" 3 4
              2
# 1297 "project/goaccess/src/goaccess.c"
...
open_term (char **buf) {
  ...
  if (!isatty (
# 1308 "project/goaccess/src/goaccess.c" 3 4
              2
# 1308 "project/goaccess/src/goaccess.c"
                           ) || (term = ttyname (
# 1308 "project/goaccess/src/goaccess.c" 3 4
                                                 2
# 1308 "project/goaccess/src/goaccess.c"
    ...
    if (!isatty (
# 1309 "project/goaccess/src/goaccess.c" 3 4
                1
# 1309 "project/goaccess/src/goaccess.c"
                             ) || (term = ttyname (
# 1309 "project/goaccess/src/goaccess.c" 3 4
                                                   1
# 1309 "project/goaccess/src/goaccess.c"
      ...
      if (!isatty (
# 1310 "project/goaccess/src/goaccess.c" 3 4
                  0
# 1310 "project/goaccess/src/goaccess.c"
                              ) || (term = ttyname (
# 1310 "project/goaccess/src/goaccess.c" 3 4
                                                    0
# 1310 "project/goaccess/src/goaccess.c"
  ...
  *buf = xstrdup (term);
  ...
  return open (term, 
# 1317 "project/goaccess/src/goaccess.c" 3 4
                    0x0000
# 1317 "project/goaccess/src/goaccess.c"
                            );
}
...
set_pipe_stdin (void) {
  char *term = 
# 1325 "project/goaccess/src/goaccess.c" 3 4
              ((void *)0)
# 1325 "project/goaccess/src/goaccess.c"
                  ;
  FILE *pipe = 
# 1326 "project/goaccess/src/goaccess.c" 3 4
              __stdinp
# 1326 "project/goaccess/src/goaccess.c"
                   ;
  int term_fd = -1;
  int pipe_fd = -1;
# 1338 "project/goaccess/src/goaccess.c"
  ...
  if ((pipe_fd = dup (fileno (
# 1341 "project/goaccess/src/goaccess.c" 3 4
                             __stdinp
# 1341 "project/goaccess/src/goaccess.c"
                                  ))) == -1)
    do { (void) endwin (); fprintf (
# 1342 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1342 "project/goaccess/src/goaccess.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:17"); fprintf (
# 1342 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1342 "project/goaccess/src/goaccess.c"
...
# 1342 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1342 "project/goaccess/src/goaccess.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/goaccess.c", __FUNCTION__, 1342); fprintf (
# 1342 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1342 "project/goaccess/src/goaccess.c"
   , "Unable to dup stdin: %s", strerror (
# 1342 "project/goaccess/src/goaccess.c" 3 4
   (*__error())
# 1342 "project/goaccess/src/goaccess.c"
   )); fprintf (
# 1342 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1342 "project/goaccess/src/goaccess.c"
   , "\n\n"); do { dbg_fprintf ("Unable to dup stdin: %s", strerror (
# 1342 "project/goaccess/src/goaccess.c" 3 4
   (*__error())
# 1342 "project/goaccess/src/goaccess.c"
   )); } while (0); exit(
...
# 1342 "project/goaccess/src/goaccess.c"
  ...
  if (freopen (term, "r", 
# 1345 "project/goaccess/src/goaccess.c" 3 4
                         __stdinp
# 1345 "project/goaccess/src/goaccess.c"
                              ) == 0)
    do { (void) endwin (); fprintf (
# 1346 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1346 "project/goaccess/src/goaccess.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:17"); fprintf (
# 1346 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1346 "project/goaccess/src/goaccess.c"
...
# 1346 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1346 "project/goaccess/src/goaccess.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/goaccess.c", __FUNCTION__, 1346); fprintf (
# 1346 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1346 "project/goaccess/src/goaccess.c"
   , "Unable to open input from TTY"); fprintf (
# 1346 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1346 "project/goaccess/src/goaccess.c"
   , "\n\n"); do { dbg_fprintf ("Unable to open input from TTY"); } while (0); exit(
# 1346 "project/goaccess/src/goaccess.c" 3 4
   1
# 1346 "project/goaccess/src/goaccess.c"
   ); } while (0);
  if (fileno (
# 1347 "project/goaccess/src/goaccess.c" 3 4
             __stdinp
# 1347 "project/goaccess/src/goaccess.c"
                  ) != 0)
    (void) dup2 (fileno (
# 1348 "project/goaccess/src/goaccess.c" 3 4
                        __stdinp
# 1348 "project/goaccess/src/goaccess.c"
                             ), 0);
...
out1:
  ...
  if (pipe_fd == -1)
    pipe_fd = fileno (pipe);
  if (fcntl (pipe_fd, 
# 1362 "project/goaccess/src/goaccess.c" 3 4
                     4
# 1362 "project/goaccess/src/goaccess.c"
                            , fcntl (pipe_fd, 
# 1362 "project/goaccess/src/goaccess.c" 3 4
                                              3
# 1362 "project/goaccess/src/goaccess.c"
...
# 1362 "project/goaccess/src/goaccess.c"
    ...
    do { (void) endwin (); fprintf (
# 1363 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1363 "project/goaccess/src/goaccess.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:17"); fprintf (
# 1363 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1363 "project/goaccess/src/goaccess.c"
...
# 1363 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1363 "project/goaccess/src/goaccess.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/goaccess.c", __FUNCTION__, 1363); fprintf (
# 1363 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1363 "project/goaccess/src/goaccess.c"
   , "Unable to set fd as non-blocking: %s.", strerror (
# 1363 "project/goaccess/src/goaccess.c" 3 4
   (*__error())
# 1363 "project/goaccess/src/goaccess.c"
   )); fprintf (
# 1363 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1363 "project/goaccess/src/goaccess.c"
   , "\n\n"); do { dbg_fprintf ("Unable to set fd as non-blocking: %s.", strerror (
# 1363 "project/goaccess/src/goaccess.c" 3 4
   (*__error())
# 1363 "project/goaccess/src/goaccess.c"
   )); } while (0); exit(
...
set_io (FILE ** pipe) {
  ...
  if (!isatty (
# 1378 "project/goaccess/src/goaccess.c" 3 4
              1
# 1378 "project/goaccess/src/goaccess.c"
                           ) || conf.output_format_idx > 0)
    conf.output_stdout = 1;

  if (!isatty (
# 1381 "project/goaccess/src/goaccess.c" 3 4
              0
# 1381 "project/goaccess/src/goaccess.c"
                          ))
    *pipe = set_pipe_stdin ();
}
...
static void
handle_signal_action (__attribute__((unused)) int sig_number) {
  fprintf (
# 1394 "project/goaccess/src/goaccess.c" 3 4
          __stderrp
# 1394 "project/goaccess/src/goaccess.c"
                , "\nSIGINT caught!\n");
  fprintf (
# 1395 "project/goaccess/src/goaccess.c" 3 4
          __stderrp
# 1395 "project/goaccess/src/goaccess.c"
                , "Closing GoAccess...\n");
  ...
  if (!conf.output_stdout) {
    cleanup (
# 1401 "project/goaccess/src/goaccess.c" 3 4
            0
# 1401 "project/goaccess/src/goaccess.c"
                        );
    exit (
# 1402 "project/goaccess/src/goaccess.c" 3 4
         0
# 1402 "project/goaccess/src/goaccess.c"
                     );
  }
}
...
setup_thread_signals (void) {
  ...
  act.
# 1410 "project/goaccess/src/goaccess.c" 3 4
     __sigaction_u.__sa_handler 
# 1410 "project/goaccess/src/goaccess.c"
                = handle_signal_action;
  
# 1411 "project/goaccess/src/goaccess.c" 3 4
 (*(
# 1411 "project/goaccess/src/goaccess.c"
 &act.sa_mask
# 1411 "project/goaccess/src/goaccess.c" 3 4
 ) = 0, 0)
# 1411 "project/goaccess/src/goaccess.c"
  ...
  sigaction (
# 1414 "project/goaccess/src/goaccess.c" 3 4
            2
# 1414 "project/goaccess/src/goaccess.c"
                  , &act, 
# 1414 "project/goaccess/src/goaccess.c" 3 4
                          ((void *)0)
# 1414 "project/goaccess/src/goaccess.c"
  ...
  sigaction (
# 1415 "project/goaccess/src/goaccess.c" 3 4
            15
# 1415 "project/goaccess/src/goaccess.c"
                   , &act, 
# 1415 "project/goaccess/src/goaccess.c" 3 4
                           ((void *)0)
# 1415 "project/goaccess/src/goaccess.c"
  ...
  signal (
# 1416 "project/goaccess/src/goaccess.c" 3 4
         13
# 1416 "project/goaccess/src/goaccess.c"
                , 
# 1416 "project/goaccess/src/goaccess.c" 3 4
                  (void (*)(int))1
# 1416 "project/goaccess/src/goaccess.c"
  ...
  pthread_sigmask (
# 1419 "project/goaccess/src/goaccess.c" 3 4
                  3
# 1419 "project/goaccess/src/goaccess.c"
                             , &oldset, 
# 1419 "project/goaccess/src/goaccess.c" 3 4
                                        ((void *)0)
# 1419 "project/goaccess/src/goaccess.c"
...
# 1427 "project/goaccess/src/goaccess.c" 3 4
 (*(
# 1427 "project/goaccess/src/goaccess.c"
 &sigset
# 1427 "project/goaccess/src/goaccess.c" 3 4
 ) = 0, 0)
# 1427 "project/goaccess/src/goaccess.c"
...
# 1428 "project/goaccess/src/goaccess.c" 3 4
 (*(
# 1428 "project/goaccess/src/goaccess.c"
 &sigset
# 1428 "project/goaccess/src/goaccess.c" 3 4
 ) |= __sigbits(2), 0)
# 1428 "project/goaccess/src/goaccess.c"
...
# 1429 "project/goaccess/src/goaccess.c" 3 4
 (*(
# 1429 "project/goaccess/src/goaccess.c"
 &sigset
# 1429 "project/goaccess/src/goaccess.c" 3 4
 ) |= __sigbits(13), 0)
# 1429 "project/goaccess/src/goaccess.c"
...
# 1430 "project/goaccess/src/goaccess.c" 3 4
 (*(
# 1430 "project/goaccess/src/goaccess.c"
 &sigset
# 1430 "project/goaccess/src/goaccess.c" 3 4
 ) |= __sigbits(15), 0)
# 1430 "project/goaccess/src/goaccess.c"
                             ;
  pthread_sigmask (
# 1431 "project/goaccess/src/goaccess.c" 3 4
                  1
# 1431 "project/goaccess/src/goaccess.c"
                           , &sigset, &oldset);
}
...
initializer (void) {
  int i;
  FILE *pipe = 
# 1438 "project/goaccess/src/goaccess.c" 3 4
              ((void *)0)
# 1438 "project/goaccess/src/goaccess.c"
                  ;
  Logs *logs;
  ...
  if (!(logs = init_logs (conf.filenames_idx)))
    do { (void) endwin (); fprintf (
# 1460 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1460 "project/goaccess/src/goaccess.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:17"); fprintf (
# 1460 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1460 "project/goaccess/src/goaccess.c"
...
# 1460 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1460 "project/goaccess/src/goaccess.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/goaccess.c", __FUNCTION__, 1460); fprintf (
# 1460 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1460 "project/goaccess/src/goaccess.c"
   , dgettext (PACKAGE , "No input data was provided nor there's data to restore.")); fprintf (
# 1460 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1460 "project/goaccess/src/goaccess.c"
   , "\n\n"); do { dbg_fprintf (dgettext (PACKAGE , "No input data was provided nor there's data to restore.")); } while (0); exit(
# 1460 "project/goaccess/src/goaccess.c" 3 4
   1
# 1460 "project/goaccess/src/goaccess.c"
   ); } while (0);
...
# 1487 "project/goaccess/src/goaccess.c" 3 4
                                  ((void *)0)
# 1487 "project/goaccess/src/goaccess.c"
                                      )
    tmp = "/tmp";

  
# 1490 "project/goaccess/src/goaccess.c" 3 4
 __builtin___memset_chk (
# 1490 "project/goaccess/src/goaccess.c"
 fname
# 1490 "project/goaccess/src/goaccess.c" 3 4
 , 
# 1490 "project/goaccess/src/goaccess.c"
...
# 1490 "project/goaccess/src/goaccess.c"
  ...
  len = 
# 1493 "project/goaccess/src/goaccess.c" 3 4
       __builtin___snprintf_chk (((void *)0), 
# 1493 "project/goaccess/src/goaccess.c"
       0
# 1493 "project/goaccess/src/goaccess.c" 3 4
       , 0, __builtin_object_size (((void *)0), 2 > 1 ? 1 : 0), 
# 1493 "project/goaccess/src/goaccess.c"
       "%s/goaccess_fifo_%s", tmp, fname
# 1493 "project/goaccess/src/goaccess.c" 3 4
       ) 
# 1493 "project/goaccess/src/goaccess.c"
                                                             + 1;
...
# 1495 "project/goaccess/src/goaccess.c" 3 4
 __builtin___snprintf_chk (
# 1495 "project/goaccess/src/goaccess.c"
 path
# 1495 "project/goaccess/src/goaccess.c" 3 4
 , 
# 1495 "project/goaccess/src/goaccess.c"
...
spawn_ws (void) {
  ...
  if ((gwsreader->fd = open_fifoout ()) == -1) {
    do { if (0) dbg_printf ("Unable to open FIFO for read.\n"); } while (0);
    return 1;
  }
...
set_standard_output (void) {
  ...
  if (find_output_type (
# 1528 "project/goaccess/src/goaccess.c" 3 4
                       ((void *)0)
# 1528 "project/goaccess/src/goaccess.c"
                           , "html", 0) == 0 || conf.output_format_idx == 0)
    html = 1;
...
set_curses (Logs * logs, int *quit) {
  const char *err_log = 
# 1545 "project/goaccess/src/goaccess.c" 3 4
                       ((void *)0)
# 1545 "project/goaccess/src/goaccess.c"
                           ;
  ...
  if (!conf.read_stdin && (verify_formats () || conf.load_conf_dlg)) {
    ...
    *quit = render_confdlg (logs, parsing_spinner);
    ...
    do { (void) endwin (); fprintf (
# 1567 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1567 "project/goaccess/src/goaccess.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:17"); fprintf (
# 1567 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1567 "project/goaccess/src/goaccess.c"
...
# 1567 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1567 "project/goaccess/src/goaccess.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/goaccess.c", __FUNCTION__, 1567); fprintf (
# 1567 "project/goaccess/src/goaccess.c" 3 4
   __stderrp
# 1567 "project/goaccess/src/goaccess.c"
   , "%s", err_log); fprintf (
...
main (int argc, char **argv) {
  Logs *logs = 
# 1578 "project/goaccess/src/goaccess.c" 3 4
              ((void *)0)
# 1578 "project/goaccess/src/goaccess.c"
                  ;
  int quit = 0, ret = 0;
...
clean:
  ...
  return ret ? 
# 1647 "project/goaccess/src/goaccess.c" 3 4
              1 
# 1647 "project/goaccess/src/goaccess.c"
                           : 
# 1647 "project/goaccess/src/goaccess.c" 3 4
                             0
# 1647 "project/goaccess/src/goaccess.c"
