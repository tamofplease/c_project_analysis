# 0 "project/goaccess/src/bitmap.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 32 "project/goaccess/src/bitmap.c" 2
...
# 33 "project/goaccess/src/bitmap.c" 2
...
# 34 "project/goaccess/src/bitmap.c" 2
...
# 37 "project/goaccess/src/bitmap.c" 2
...
# 38 "project/goaccess/src/bitmap.c" 2

# 1 "project/goaccess/src/bitmap.h" 1
...
# 40 "project/goaccess/src/bitmap.c" 2
...
bitmap_set_bit (word_t * words, uint32_t n) {
  words[((n) / BITS_PER_WORD)] |= ((word_t) 1 << ((n) % BITS_PER_WORD));
  return 0;
}

int
bitmap_get_bit (word_t * words, uint32_t n) {
  word_t bit = words[((n) / BITS_PER_WORD)] & ((word_t) 1 << ((n) % BITS_PER_WORD));
  return bit != 0;
}
...
# 121 "project/goaccess/src/bitmap.c" 3 4
 __builtin___memset_chk (
# 121 "project/goaccess/src/bitmap.c"
 bm->bmp
# 121 "project/goaccess/src/bitmap.c" 3 4
 , 
# 121 "project/goaccess/src/bitmap.c"
...
bitmap_realloc (bitmap * bm, uint32_t bit) {
  uint32_t *tmp = 
# 129 "project/goaccess/src/bitmap.c" 3 4
                 ((void *)0)
# 129 "project/goaccess/src/bitmap.c"
                     ;
  ...
  if ((tmp == 
# 138 "project/goaccess/src/bitmap.c" 3 4
             ((void *)0) 
# 138 "project/goaccess/src/bitmap.c"
                  && newlen > 0) || bit < bm->len)
    do { (void) endwin (); fprintf (stderr, "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "14:56:14"); fprintf (stderr, "Config file: %s\n", conf.iconfigfile ?: "No config file used"); fprintf (stderr, "\nFatal error has occurred"); fprintf (stderr, "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/bitmap.c", __FUNCTION__, 139); fprintf (stderr, "Unable to realloc bitmap hash value %u %u", newlen, bm->len); fprintf (stderr, "\n\n"); do { dbg_fprintf ("Unable to realloc bitmap hash value %u %u", newlen, bm->len); } while (0); exit(
# 139 "project/goaccess/src/bitmap.c" 3 4
   1
# 139 "project/goaccess/src/bitmap.c"
   ); } while (0);

  do { dbg_fprintf ("bit: %d, bm->len: %d, oldlen: %d, newlen: %d\n", bit, bm->len, oldlen, newlen); } while (0);
  
# 142 "project/goaccess/src/bitmap.c" 3 4
 __builtin___memset_chk (
# 142 "project/goaccess/src/bitmap.c"
 tmp + bitmap_word (bm->len)
# 142 "project/goaccess/src/bitmap.c" 3 4
 , 
# 142 "project/goaccess/src/bitmap.c"
 0, (newlen - oldlen)
...
bitmap_copy (const bitmap * bm) {
  ...
  if (!bm)
    return 
# 154 "project/goaccess/src/bitmap.c" 3 4
          ((void *)0)
# 154 "project/goaccess/src/bitmap.c"
              ;
  if (!(ret = bitmap_create (bm->len)))
    return 
# 156 "project/goaccess/src/bitmap.c" 3 4
          ((void *)0)
# 156 "project/goaccess/src/bitmap.c"
              ;

  
# 158 "project/goaccess/src/bitmap.c" 3 4
 __builtin___memcpy_chk (
# 158 "project/goaccess/src/bitmap.c"
 ret->bmp
# 158 "project/goaccess/src/bitmap.c" 3 4
 , 
# 158 "project/goaccess/src/bitmap.c"
 bm->bmp, bitmap_sizeof (bm->len)
# 158 "project/goaccess/src/bitmap.c" 3 4
 , __builtin_object_size (
# 158 "project/goaccess/src/bitmap.c"
 ret->bmp
