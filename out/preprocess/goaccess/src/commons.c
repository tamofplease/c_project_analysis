# 0 "project/goaccess/src/commons.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/goaccess/src/commons.c"
# 35 "project/goaccess/src/commons.c"
...
# 36 "project/goaccess/src/commons.c" 2
...
# 37 "project/goaccess/src/commons.c" 2
...
# 38 "project/goaccess/src/commons.c" 2
...
# 39 "project/goaccess/src/commons.c" 2
...
# 40 "project/goaccess/src/commons.c" 2
...
# 42 "project/goaccess/src/commons.c" 2
...
# 44 "project/goaccess/src/commons.c" 2
...
# 45 "project/goaccess/src/commons.c" 2
...
# 47 "project/goaccess/src/commons.c" 2
...
# 48 "project/goaccess/src/commons.c" 2
...
get_max_choices (void) {
  char *csv = 
# 88 "project/goaccess/src/commons.c" 3 4
             ((void *)0)
# 88 "project/goaccess/src/commons.c"
                 , *json = 
# 88 "project/goaccess/src/commons.c" 3 4
                           ((void *)0)
# 88 "project/goaccess/src/commons.c"
...
# 88 "project/goaccess/src/commons.c"
  ...
  if (conf.max_items <= 0)
    return conf.real_time_html ? 50 : 366;


  if (!conf.output_stdout)
    return conf.max_items > 366 ? 366 : conf.max_items;



  if (conf.real_time_html)
    return conf.max_items > 50 ? 50 : conf.max_items;
...
display_storage (void) {
  fprintf (
# 135 "project/goaccess/src/commons.c" 3 4
          __stdoutp
# 135 "project/goaccess/src/commons.c"
                , "%s\n", dgettext (PACKAGE , "In-Memory with On-Disk Persistent Storage."));
}
...
display_default_config_file (void) {
  ...
  if (!path) {
    fprintf (
# 144 "project/goaccess/src/commons.c" 3 4
            __stdoutp
# 144 "project/goaccess/src/commons.c"
                  , "%s\n", dgettext (PACKAGE , "No default config file found."));
    fprintf (
# 145 "project/goaccess/src/commons.c" 3 4
            __stdoutp
# 145 "project/goaccess/src/commons.c"
                  , "%s `-p /path/goaccess.conf`\n", dgettext (PACKAGE , "You may specify one with"));
  } else {
    fprintf (
# 147 "project/goaccess/src/commons.c" 3 4
            __stdoutp
# 147 "project/goaccess/src/commons.c"
                  , "%s\n", path);
    free (path);
  }
}
...
display_version (void) {
  fprintf (
# 155 "project/goaccess/src/commons.c" 3 4
          __stdoutp
# 155 "project/goaccess/src/commons.c"
                , "GoAccess - %s.\n", "1.5.4");
  fprintf (
# 156 "project/goaccess/src/commons.c" 3 4
          __stdoutp
# 156 "project/goaccess/src/commons.c"
                , "%s: %s\n", dgettext (PACKAGE , "For more details visit"), "https://goaccess.io/");
  fprintf (
# 157 "project/goaccess/src/commons.c" 3 4
          __stdoutp
# 157 "project/goaccess/src/commons.c"
                , "Copyright (C) 2009-2020 by Gerardo Orellana\n");
  fprintf (
# 158 "project/goaccess/src/commons.c" 3 4
          __stdoutp
# 158 "project/goaccess/src/commons.c"
                , "\nBuild configure arguments:\n");
# 177 "project/goaccess/src/commons.c"
}
...
enum2str (const GEnum map[], int len, int idx) {
  ...
  return 
# 208 "project/goaccess/src/commons.c" 3 4
        ((void *)0)
# 208 "project/goaccess/src/commons.c"
            ;
}
...
get_module_enum (const char *str) {
  return str2enum (enum_modules, (sizeof(enum_modules) / sizeof(enum_modules[0])), str);
}
...
get_module_str (GModule module) {
  return enum2str (enum_modules, (sizeof(enum_modules) / sizeof(enum_modules[0])), module);
}
...
# 235 "project/goaccess/src/commons.c" 3 4
 __builtin___memset_chk (
# 235 "project/goaccess/src/commons.c"
 agents
# 235 "project/goaccess/src/commons.c" 3 4
 , 
# 235 "project/goaccess/src/commons.c"
...
free_agents_array (GAgents * agents) {
  ...
  if (agents == 
# 249 "project/goaccess/src/commons.c" 3 4
               ((void *)0)
# 249 "project/goaccess/src/commons.c"
                   )
    return;
...
# 350 "project/goaccess/src/commons.c" 3 4
   __builtin___memmove_chk (
# 350 "project/goaccess/src/commons.c"
   &module_list[idx]
# 350 "project/goaccess/src/commons.c" 3 4
   , 
# 350 "project/goaccess/src/commons.c"
   &module_list[idx + 1], ((17 - 1) - idx) * sizeof (module_list[0])
# 350 "project/goaccess/src/commons.c" 3 4
   , __builtin_object_size (
# 350 "project/goaccess/src/commons.c"
   &module_list[idx]
...
# 351 "project/goaccess/src/commons.c"
                                                                  ;
  module_list[17 - 1] = -1;
...
init_modules (void) {
  ...
  for (module = 0; module < 17; ++module)
    module_list[module] = -1;

  for (i = 0, module = 0; module < 17; ++module) {
