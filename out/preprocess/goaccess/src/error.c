# 0 "project/goaccess/src/error.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/goaccess/src/error.c"
# 35 "project/goaccess/src/error.c"
...
# 36 "project/goaccess/src/error.c" 2
...
# 37 "project/goaccess/src/error.c" 2
...
# 38 "project/goaccess/src/error.c" 2
...
# 39 "project/goaccess/src/error.c" 2
...
# 43 "project/goaccess/src/error.c" 2
...
# 44 "project/goaccess/src/error.c" 2
...
# 45 "project/goaccess/src/error.c" 2
...
# 47 "project/goaccess/src/error.c" 2
...
# 81 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/xlocale.h" 3 4
...
# 48 "project/goaccess/src/error.c" 2
...
# 55 "project/goaccess/src/parser.h"
...
# 49 "project/goaccess/src/error.c" 2
...
dbg_log_open (const char *path) {
  if (path != 
# 60 "project/goaccess/src/error.c" 3 4
             ((void *)0)
# 60 "project/goaccess/src/error.c"
                 ) {
    log_file = fopen (path, "w");
    if (log_file == 
# 62 "project/goaccess/src/error.c" 3 4
                   ((void *)0)
# 62 "project/goaccess/src/error.c"
                       )
      return;
  }
}
...
dbg_log_close (void) {
  if (log_file != 
# 70 "project/goaccess/src/error.c" 3 4
                 ((void *)0)
# 70 "project/goaccess/src/error.c"
                     )
    fclose (log_file);
}
...
invalid_log_open (const char *path) {
  if (path != 
# 78 "project/goaccess/src/error.c" 3 4
             ((void *)0)
# 78 "project/goaccess/src/error.c"
                 ) {
    log_invalid = fopen (path, "w");
    if (log_invalid == 
# 80 "project/goaccess/src/error.c" 3 4
                      ((void *)0)
# 80 "project/goaccess/src/error.c"
                          )
      return;
  }
}
...
invalid_log_close (void) {
  if (log_invalid != 
# 88 "project/goaccess/src/error.c" 3 4
                    ((void *)0)
# 88 "project/goaccess/src/error.c"
                        )
    fclose (log_invalid);
}
...
unknowns_log_open (const char *path) {
  if (path != 
# 96 "project/goaccess/src/error.c" 3 4
             ((void *)0)
# 96 "project/goaccess/src/error.c"
                 ) {
    log_unknowns = fopen (path, "w");
    if (log_unknowns == 
# 98 "project/goaccess/src/error.c" 3 4
                       ((void *)0)
# 98 "project/goaccess/src/error.c"
                           )
      return;
  }
}
...
unknowns_log_close (void) {
  if (log_unknowns != 
# 106 "project/goaccess/src/error.c" 3 4
                     ((void *)0)
# 106 "project/goaccess/src/error.c"
                         )
    fclose (log_unknowns);
}
...
access_log_open (const char *path) {
  if (path == 
# 120 "project/goaccess/src/error.c" 3 4
             ((void *)0)
# 120 "project/goaccess/src/error.c"
                 )
    return 0;
  ...
  if (access_log == 
# 125 "project/goaccess/src/error.c" 3 4
                   ((void *)0)
# 125 "project/goaccess/src/error.c"
                       )
    return 1;
...
access_log_close (void) {
  if (access_log != 
# 134 "project/goaccess/src/error.c" 3 4
                   ((void *)0)
# 134 "project/goaccess/src/error.c"
                       )
    fclose (access_log);
}
...
# 143 "project/goaccess/src/error.c" 3 4
 (*(
# 143 "project/goaccess/src/error.c"
 &act.sa_mask
# 143 "project/goaccess/src/error.c" 3 4
 ) = 0, 0)
# 143 "project/goaccess/src/error.c"
                           ;
  act.sa_flags = (int) 
# 144 "project/goaccess/src/error.c" 3 4
                      0x0004
# 144 "project/goaccess/src/error.c"
                                  ;
  act.
# 145 "project/goaccess/src/error.c" 3 4
     __sigaction_u.__sa_handler 
# 145 "project/goaccess/src/error.c"
                = sigsegv_handler;

  sigaction (
# 147 "project/goaccess/src/error.c" 3 4
            11
# 147 "project/goaccess/src/error.c"
                   , &act, &old_sigsegv_handler);
}

static void
dump_struct_data (FILE * fp, GLog * glog, int pid) {
  fprintf (fp, "==%d== FILE: %s\n", pid, glog->filename);
  fprintf (fp, "==%d== Line number: %" 
# 153 "project/goaccess/src/error.c" 3 4
                                      "ll" "u" 
# 153 "project/goaccess/src/error.c"
                                             "\n", pid, glog->processed);
  fprintf (fp, "==%d== Invalid data: %" 
# 154 "project/goaccess/src/error.c" 3 4
                                       "ll" "u" 
# 154 "project/goaccess/src/error.c"
                                              "\n", pid, glog->invalid);
...
sigsegv_handler (int sig) {
  FILE *fp = 
# 179 "project/goaccess/src/error.c" 3 4
            __stderrp
# 179 "project/goaccess/src/error.c"
                  ;
  int pid = getpid ();
  ...
  dump_struct (fp);
# 206 "project/goaccess/src/error.c"
  fprintf (fp, "==%d==\n", pid);
  fprintf (fp, "==%d== %s:\n", pid, dgettext (PACKAGE , "Please report it by opening an issue on GitHub"));
  fprintf (fp, "==%d== https://github.com/allinurl/goaccess/issues\n\n", pid);
  fflush (fp);


  sigaction (
# 212 "project/goaccess/src/error.c" 3 4
            11
# 212 "project/goaccess/src/error.c"
                   , &old_sigsegv_handler, 
# 212 "project/goaccess/src/error.c" 3 4
                                           ((void *)0)
# 212 "project/goaccess/src/error.c"
...
# 223 "project/goaccess/src/error.c" 3 4
 __builtin_va_start(
# 223 "project/goaccess/src/error.c"
 args
# 223 "project/goaccess/src/error.c" 3 4
 ,
# 223 "project/goaccess/src/error.c"
...
# 226 "project/goaccess/src/error.c" 3 4
 __builtin_va_end(
# 226 "project/goaccess/src/error.c"
 args
# 226 "project/goaccess/src/error.c" 3 4
 )
# 226 "project/goaccess/src/error.c"
...
# 237 "project/goaccess/src/error.c" 3 4
 __builtin_va_start(
# 237 "project/goaccess/src/error.c"
 args
# 237 "project/goaccess/src/error.c" 3 4
 ,
# 237 "project/goaccess/src/error.c"
...
# 240 "project/goaccess/src/error.c" 3 4
 __builtin_va_end(
# 240 "project/goaccess/src/error.c"
 args
# 240 "project/goaccess/src/error.c" 3 4
 )
# 240 "project/goaccess/src/error.c"
...
# 251 "project/goaccess/src/error.c" 3 4
 __builtin_va_start(
# 251 "project/goaccess/src/error.c"
 args
# 251 "project/goaccess/src/error.c" 3 4
 ,
# 251 "project/goaccess/src/error.c"
...
# 254 "project/goaccess/src/error.c" 3 4
 __builtin_va_end(
# 254 "project/goaccess/src/error.c"
 args
# 254 "project/goaccess/src/error.c" 3 4
 )
# 254 "project/goaccess/src/error.c"
...
# 261 "project/goaccess/src/error.c" 3 4
 __builtin_va_start(
# 261 "project/goaccess/src/error.c"
 args
# 261 "project/goaccess/src/error.c" 3 4
 ,
# 261 "project/goaccess/src/error.c"
...
# 261 "project/goaccess/src/error.c"
                     ;
  vfprintf (
# 262 "project/goaccess/src/error.c" 3 4
           __stderrp
# 262 "project/goaccess/src/error.c"
                 , fmt, args);
  
# 263 "project/goaccess/src/error.c" 3 4
 __builtin_va_end(
# 263 "project/goaccess/src/error.c"
 args
# 263 "project/goaccess/src/error.c" 3 4
 )
# 263 "project/goaccess/src/error.c"
...
# 274 "project/goaccess/src/error.c" 3 4
 __builtin_va_start(
# 274 "project/goaccess/src/error.c"
 args
# 274 "project/goaccess/src/error.c" 3 4
 ,
# 274 "project/goaccess/src/error.c"
...
# 277 "project/goaccess/src/error.c" 3 4
 __builtin_va_end(
# 277 "project/goaccess/src/error.c"
 args
# 277 "project/goaccess/src/error.c" 3 4
 )
# 277 "project/goaccess/src/error.c"
