...
# 9 "/Users/washi38/University/Labo/c_project_analysis/project/ish/util/sync.h" 2
...
# 9 "project/ish/util/timer.h" 2

static inline struct timespec timespec_now(clockid_t clockid) {
    
# 11 "project/ish/util/timer.h" 3 4
   (__builtin_expect(!(
# 11 "project/ish/util/timer.h"
   clockid == 
# 11 "project/ish/util/timer.h" 3 4
   _CLOCK_MONOTONIC 
# 11 "project/ish/util/timer.h"
   || clockid == 
# 11 "project/ish/util/timer.h" 3 4
   _CLOCK_REALTIME), 0) ? __assert_rtn(__func__, "project/ish/util/timer.h", 11, 
# 11 "project/ish/util/timer.h"
...
static inline 
# 38 "project/ish/util/timer.h" 3 4
             _Bool 
# 38 "project/ish/util/timer.h"
                  timespec_is_zero(struct timespec ts) {
    return ts.tv_sec == 0 && ts.tv_nsec == 0;
}

static inline 
# 42 "project/ish/util/timer.h" 3 4
             _Bool 
# 42 "project/ish/util/timer.h"
...
# 59 "project/ish/util/timer.h" 3 4
   _Bool 
# 59 "project/ish/util/timer.h"
        active;
    
# 60 "project/ish/util/timer.h" 3 4
   _Bool 
# 60 "project/ish/util/timer.h"
        thread_running;
    pthread_t thread;
...
# 66 "project/ish/util/timer.h" 3 4
   _Bool 
# 66 "project/ish/util/timer.h"
        dead;
};
