...
typedef struct {
    pthread_mutex_t m;
    pthread_t owner;
# 26 "project/ish/util/sync.h"
} lock_t;

static inline void lock_init(lock_t *lock) {
    pthread_mutex_init(&lock->m, 
# 29 "project/ish/util/sync.h" 3 4
                                ((void *)0)
# 29 "project/ish/util/sync.h"
                                    );
...
# 118 "project/ish/util/sync.h" 3 4
                                 ((void *)0)
# 118 "project/ish/util/sync.h"
                                     ;
    ...
    lock->file = 
# 127 "project/ish/util/sync.h" 3 4
                ((void *)0)
# 127 "project/ish/util/sync.h"
                    ;
}
...
# 136 "project/ish/util/sync.h" 3 4
   (__builtin_expect(!(
# 136 "project/ish/util/sync.h"
   lock->val >= 0
# 136 "project/ish/util/sync.h" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/util/sync.h", 136, 
# 136 "project/ish/util/sync.h"
   "lock->val >= 0"
# 136 "project/ish/util/sync.h" 3 4
   ) : (void)0)
...
# 140 "project/ish/util/sync.h" 3 4
   (__builtin_expect(!(
# 140 "project/ish/util/sync.h"
   lock->val > 0
# 140 "project/ish/util/sync.h" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/util/sync.h", 140, 
# 140 "project/ish/util/sync.h"
   "lock->val > 0"
# 140 "project/ish/util/sync.h" 3 4
   ) : (void)0)
...
# 146 "project/ish/util/sync.h" 3 4
   (__builtin_expect(!(
# 146 "project/ish/util/sync.h"
   lock->val == 0
# 146 "project/ish/util/sync.h" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/util/sync.h", 146, 
# 146 "project/ish/util/sync.h"
   "lock->val == 0"
# 146 "project/ish/util/sync.h" 3 4
   ) : (void)0)
...
# 154 "project/ish/util/sync.h" 3 4
   (__builtin_expect(!(
# 154 "project/ish/util/sync.h"
   lock->val == -1
# 154 "project/ish/util/sync.h" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/util/sync.h", 154, 
# 154 "project/ish/util/sync.h"
   "lock->val == -1"
# 154 "project/ish/util/sync.h" 3 4
   ) : (void)0)
# 154 "project/ish/util/sync.h"
    ...
    lock->val = lock->line = lock->pid = 0;
    lock->file = 
# 156 "project/ish/util/sync.h" 3 4
                ((void *)0)
# 156 "project/ish/util/sync.h"
                    ;
    if (pthread_rwlock_unlock(&lock->l) != 0) __builtin_trap();
}
...
extern __thread 
# 161 "project/ish/util/sync.h" 3 4
               _Bool 
# 161 "project/ish/util/sync.h"
                    should_unwind;
static inline int sigunwind_start() {
    if (sigsetjmp(unwind_buf, 1)) {
        should_unwind = 
# 164 "project/ish/util/sync.h" 3 4
                       0
# 164 "project/ish/util/sync.h"
                            ;
        return 1;
    } else {
        should_unwind = 
# 167 "project/ish/util/sync.h" 3 4
                       1
# 167 "project/ish/util/sync.h"
                           ;
        return 0;
    }
}
static inline void sigunwind_end() {
    should_unwind = 
# 172 "project/ish/util/sync.h" 3 4
                   0
# 172 "project/ish/util/sync.h"
                        ;
}
