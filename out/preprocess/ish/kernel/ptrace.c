# 0 "project/ish/kernel/ptrace.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/kernel/ptrace.c"
# 1 "project/ish/kernel/ptrace.h" 1
...
# 2 "project/ish/kernel/ptrace.c" 2
...
# 3 "project/ish/kernel/ptrace.c" 2


# 1 "project/ish/kernel/task.h" 1
# 6 "project/ish/kernel/ptrace.c" 2
...
# 7 "project/ish/kernel/ptrace.c" 2



# 9 "project/ish/kernel/ptrace.c"
static struct task *find_child(pid_t_ pid) {
    struct task *child = 
# 10 "project/ish/kernel/ptrace.c" 3 4
                        ((void *)0)
# 10 "project/ish/kernel/ptrace.c"
                            ;
    for (child = ((typeof(*child) *) ((char *) ((&current->children)->next) - 
# 11 "project/ish/kernel/ptrace.c" 3 4
   __builtin_offsetof (
# 11 "project/ish/kernel/ptrace.c"
   typeof(*child)
# 11 "project/ish/kernel/ptrace.c" 3 4
   , 
# 11 "project/ish/kernel/ptrace.c"
...
# 11 "project/ish/kernel/ptrace.c"
        ...
        if (child->pid == pid) {
            __lock(&child->ptrace.lock, "project/ish/kernel/ptrace.c", 13);
    ...
    child = 
# 21 "project/ish/kernel/ptrace.c" 3 4
           ((void *)0)
# 21 "project/ish/kernel/ptrace.c"
               ;
found:
    return child;
}
...
# 72 "project/ish/kernel/ptrace.c" 3 4
                                    1
# 72 "project/ish/kernel/ptrace.c"
                                        ;
            return 0;
...
# 106 "project/ish/kernel/ptrace.c" 3 4
           __builtin___memcpy_chk (
# 106 "project/ish/kernel/ptrace.c"
           &peek
# 106 "project/ish/kernel/ptrace.c" 3 4
           , 
# 106 "project/ish/kernel/ptrace.c"
           (char *)&user_ + addr, sizeof(peek)
# 106 "project/ish/kernel/ptrace.c" 3 4
...
# 106 "project/ish/kernel/ptrace.c"
        ...
        case 5: {
            ...
            char *ptr = mem_ptr(child->mem, addr, 2);
            read_wrunlock(&child->mem->lock);
            if (ptr) {
                
# 126 "project/ish/kernel/ptrace.c" 3 4
               __builtin___memcpy_chk (
# 126 "project/ish/kernel/ptrace.c"
               ptr
# 126 "project/ish/kernel/ptrace.c" 3 4
               , 
# 126 "project/ish/kernel/ptrace.c"
...
# 126 "project/ish/kernel/ptrace.c"
        ...
        case 7: {
            ...
            child->cpu.tf = 
# 141 "project/ish/kernel/ptrace.c" 3 4
                           0
# 141 "project/ish/kernel/ptrace.c"
                                ;
            child->ptrace.stopped = 
# 142 "project/ish/kernel/ptrace.c" 3 4
                                   0
# 142 "project/ish/kernel/ptrace.c"
                                        ;
        ...
        case 8: {
            ...
            child->ptrace.stopped = 
# 154 "project/ish/kernel/ptrace.c" 3 4
                                   0
# 154 "project/ish/kernel/ptrace.c"
                                        ;
        ...
        case 9: {
            ...
            child->cpu.tf = 
# 166 "project/ish/kernel/ptrace.c" 3 4
                           1
# 166 "project/ish/kernel/ptrace.c"
                               ;
            child->ptrace.stopped = 
# 167 "project/ish/kernel/ptrace.c" 3 4
                                   0
# 167 "project/ish/kernel/ptrace.c"
                                        ;
            notify(&child->ptrace.cond);
            unlock(&child->ptrace.lock);
