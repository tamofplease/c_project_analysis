# 0 "project/ish/kernel/fs.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/kernel/fs.h"
...
# 9 "project/ish/kernel/fs.h" 2



# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sqlite3.h" 1 3 4
# 13 "project/ish/kernel/fs.h" 2
...
# 64 "project/ish/kernel/fs.h" 3 4
                                                                         _Bool 
# 64 "project/ish/kernel/fs.h"
                                                                              follow_links);
int generic_setattrat(struct fd *at, const char *path, struct attr attr, 
# 65 "project/ish/kernel/fs.h" 3 4
                                                                        _Bool 
# 65 "project/ish/kernel/fs.h"
                                                                             follow_links);
int generic_utime(struct fd *at, const char *path, struct timespec atime, struct timespec mtime, 
# 66 "project/ish/kernel/fs.h" 3 4
                                                                                                _Bool 
# 66 "project/ish/kernel/fs.h"
                                                                                                     follow_links);
...
# 100 "project/ish/kernel/fs.h" 3 4
_Bool 
# 100 "project/ish/kernel/fs.h"
    mount_param_flag(const char *info, const char *flag);
# 123 "project/ish/kernel/fs.h"
struct fs_ops {
    const char *name;
    int magic;
...
# 169 "project/ish/kernel/fs.h" 3 4
_Bool 
# 169 "project/ish/kernel/fs.h"
