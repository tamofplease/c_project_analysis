# 0 "project/ish/kernel/misc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/kernel/misc.c"
...
# 18 "project/ish/kernel/misc.c" 3 4
           __builtin___strcpy_chk (
# 18 "project/ish/kernel/misc.c"
           current->comm
# 18 "project/ish/kernel/misc.c" 3 4
           , 
# 18 "project/ish/kernel/misc.c"
...
# 41 "project/ish/kernel/misc.c"
int_t sys_reboot(int_t magic, int_t magic2, int_t cmd) {
    __use(0, magic, magic2, cmd);
    if (!(current != 
# 43 "project/ish/kernel/misc.c" 3 4
        ((void *)0) 
# 43 "project/ish/kernel/misc.c"
        && current->euid == 0))
        return -1;
