...
# 5 "project/ish/kernel/exit.c" 2

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/ish/kernel/futex.h" 1



int futex_wake(addr_t uaddr, dword_t val);
# 7 "project/ish/kernel/exit.c" 2
...
# 10 "project/ish/kernel/exit.c" 2

static void halt_system(void);

static 
# 13 "project/ish/kernel/exit.c" 3 4
      _Bool 
# 13 "project/ish/kernel/exit.c"
           exit_tgroup(struct task *task) {
    struct tgroup *group = task->group;
    list_remove(&task->group_links);
    
# 16 "project/ish/kernel/exit.c" 3 4
   _Bool 
# 16 "project/ish/kernel/exit.c"
...
# 32 "project/ish/kernel/exit.c" 3 4
                                                ((void *)0)
# 32 "project/ish/kernel/exit.c"
                                                    ;
...
# 36 "project/ish/kernel/exit.c" 3 4
   __builtin_offsetof (
# 36 "project/ish/kernel/exit.c"
   typeof(*new_parent)
# 36 "project/ish/kernel/exit.c" 3 4
   , 
# 36 "project/ish/kernel/exit.c"
...
# 43 "project/ish/kernel/exit.c" 3 4
_Noreturn 
# 43 "project/ish/kernel/exit.c"
        void do_exit(int status) {
    ...
    current->mm = 
# 54 "project/ish/kernel/exit.c" 3 4
                 ((void *)0)
# 54 "project/ish/kernel/exit.c"
                     ;
    fdtable_release(current->files);
    current->files = 
# 56 "project/ish/kernel/exit.c" 3 4
                    ((void *)0)
# 56 "project/ish/kernel/exit.c"
                        ;
    fs_info_release(current->fs);
    current->fs = 
# 58 "project/ish/kernel/exit.c" 3 4
                 ((void *)0)
# 58 "project/ish/kernel/exit.c"
                     ;
    ...
    __lock(&current->group->lock, "project/ish/kernel/exit.c", 65);
    rusage_add(&current->group->rusage, &rusage);
    struct rusage_ group_rusage = current->group->rusage;
    unlock(&current->group->lock);


    __lock(&pids_lock, "project/ish/kernel/exit.c", 71);
    current->exiting = 
# 72 "project/ish/kernel/exit.c" 3 4
                      1
# 72 "project/ish/kernel/exit.c"
                          ;

    sighand_release(current->sighand);
    current->sighand = 
# 75 "project/ish/kernel/exit.c" 3 4
                      ((void *)0)
# 75 "project/ish/kernel/exit.c"
                          ;
    struct sigqueue *sigqueue, *sigqueue_tmp;
    for (sigqueue = ((typeof(*(sigqueue)) *) ((char *) ((&current->queue)->next) - 
# 77 "project/ish/kernel/exit.c" 3 4
   __builtin_offsetof (
# 77 "project/ish/kernel/exit.c"
   typeof(*(sigqueue))
# 77 "project/ish/kernel/exit.c" 3 4
   , 
# 77 "project/ish/kernel/exit.c"
...
# 86 "project/ish/kernel/exit.c" 3 4
   __builtin_offsetof (
# 86 "project/ish/kernel/exit.c"
   typeof(*(child))
# 86 "project/ish/kernel/exit.c" 3 4
   , 
# 86 "project/ish/kernel/exit.c"
...
# 86 "project/ish/kernel/exit.c"
    ...
    if (exit_tgroup(current)) {
        ...
        if (parent == 
# 95 "project/ish/kernel/exit.c" 3 4
                     ((void *)0)
# 95 "project/ish/kernel/exit.c"
                         ) {

            halt_system();
        } else {
            leader->zombie = 
# 99 "project/ish/kernel/exit.c" 3 4
                            1
# 99 "project/ish/kernel/exit.c"
                                ;
        ...
        if (exit_hook != 
# 113 "project/ish/kernel/exit.c" 3 4
                        ((void *)0)
# 113 "project/ish/kernel/exit.c"
                            )
    ...
    pthread_exit(
# 122 "project/ish/kernel/exit.c" 3 4
                ((void *)0)
# 122 "project/ish/kernel/exit.c"
                    );
}


# 125 "project/ish/kernel/exit.c" 3 4
_Noreturn 
# 125 "project/ish/kernel/exit.c"
        void do_exit_group(int status) {
    struct tgroup *group = current->group;
    __lock(&pids_lock, "project/ish/kernel/exit.c", 127);
    __lock(&group->lock, "project/ish/kernel/exit.c", 128);
    if (!group->doing_group_exit) {
        group->doing_group_exit = 
# 130 "project/ish/kernel/exit.c" 3 4
                                 1
# 130 "project/ish/kernel/exit.c"
                                     ;
...
# 138 "project/ish/kernel/exit.c" 3 4
   __builtin_offsetof (
# 138 "project/ish/kernel/exit.c"
   typeof(*task)
# 138 "project/ish/kernel/exit.c" 3 4
   , 
# 138 "project/ish/kernel/exit.c"
...
# 138 "project/ish/kernel/exit.c"
        ...
        task->group->stopped = 
# 140 "project/ish/kernel/exit.c" 3 4
                              0
# 140 "project/ish/kernel/exit.c"
                                   ;
...
static void halt_system(void) {
    ...
    for (int i = 2; i < (1 << 15); i++) {
        ...
        if (task != 
# 155 "project/ish/kernel/exit.c" 3 4
                   ((void *)0)
# 155 "project/ish/kernel/exit.c"
                       )
            pthread_kill(task->thread, 
# 156 "project/ish/kernel/exit.c" 3 4
                                      9
# 156 "project/ish/kernel/exit.c"
                                             );
    }


    __lock(&mounts_lock, "project/ish/kernel/exit.c", 160);
    struct mount *mount, *tmp;
    for (mount = ((typeof(*(mount)) *) ((char *) ((&mounts)->next) - 
# 162 "project/ish/kernel/exit.c" 3 4
   __builtin_offsetof (
# 162 "project/ish/kernel/exit.c"
   typeof(*(mount))
# 162 "project/ish/kernel/exit.c" 3 4
   , 
# 162 "project/ish/kernel/exit.c"
...
# 190 "project/ish/kernel/exit.c"
static 
# 190 "project/ish/kernel/exit.c" 3 4
      _Bool 
# 190 "project/ish/kernel/exit.c"
           reap_if_zombie(struct task *task, struct siginfo_ *info_out, struct rusage_ *rusage_out, int options) {
    if (!task->zombie)
        return 
# 192 "project/ish/kernel/exit.c" 3 4
              0
# 192 "project/ish/kernel/exit.c"
                   ;
    __lock(&task->group->lock, "project/ish/kernel/exit.c", 193);
    ...
    if (!(options & (1 << 24))) {
        __lock(&current->group->lock, "project/ish/kernel/exit.c", 202);
        rusage_add(&current->group->children_rusage, &rusage);
        unlock(&current->group->lock);
    }
    if (rusage_out != 
# 206 "project/ish/kernel/exit.c" 3 4
                     ((void *)0)
# 206 "project/ish/kernel/exit.c"
                         )
        *rusage_out = rusage;
    ...
    if (options & (1 << 24))
        return 
# 213 "project/ish/kernel/exit.c" 3 4
              1
# 213 "project/ish/kernel/exit.c"
                  ;
    ...
    task_destroy(task);
    return 
# 222 "project/ish/kernel/exit.c" 3 4
          1
# 222 "project/ish/kernel/exit.c"
              ;
}

static 
# 225 "project/ish/kernel/exit.c" 3 4
      _Bool 
# 225 "project/ish/kernel/exit.c"
           notify_if_stopped(struct task *task, struct siginfo_ *info_out) {
    __lock(&task->group->lock, "project/ish/kernel/exit.c", 226);
    
# 227 "project/ish/kernel/exit.c" 3 4
   _Bool 
# 227 "project/ish/kernel/exit.c"
        stopped = task->group->stopped;
    unlock(&task->group->lock);
    if (!stopped || task->group->group_exit_code == 0)
        return 
# 230 "project/ish/kernel/exit.c" 3 4
              0
# 230 "project/ish/kernel/exit.c"
                   ;
    dword_t exit_code = task->group->group_exit_code;
    task->group->group_exit_code = 0;
    info_out->child.status = exit_code;
    return 
# 234 "project/ish/kernel/exit.c" 3 4
          1
# 234 "project/ish/kernel/exit.c"
              ;
}

static 
# 237 "project/ish/kernel/exit.c" 3 4
      _Bool 
# 237 "project/ish/kernel/exit.c"
           reap_if_needed(struct task *task, struct siginfo_ *info_out, struct rusage_ *rusage_out, int options) {
    
# 238 "project/ish/kernel/exit.c" 3 4
   (__builtin_expect(!(
# 238 "project/ish/kernel/exit.c"
   task_is_leader(task)
# 238 "project/ish/kernel/exit.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/kernel/exit.c", 238, 
# 238 "project/ish/kernel/exit.c"
   "task_is_leader(task)"
# 238 "project/ish/kernel/exit.c" 3 4
   ) : (void)0)
# 238 "project/ish/kernel/exit.c"
    ...
    if ((options & (1 << 1) && notify_if_stopped(task, info_out)) ||
        ...
        info_out->sig = 17;
        return 
# 242 "project/ish/kernel/exit.c" 3 4
              1
# 242 "project/ish/kernel/exit.c"
                  ;
    }
    __lock(&task->ptrace.lock, "project/ish/kernel/exit.c", 244);
    if (task->ptrace.stopped && task->ptrace.signal) {
        ...
        return 
# 252 "project/ish/kernel/exit.c" 3 4
              1
# 252 "project/ish/kernel/exit.c"
                  ;
    }
    unlock(&task->ptrace.lock);
    return 
# 255 "project/ish/kernel/exit.c" 3 4
          0
# 255 "project/ish/kernel/exit.c"
               ;
}
...
int do_wait(int idtype, pid_t_ id, struct siginfo_ *info, struct rusage_ *rusage, int options) {
    ...
    __lock(&pids_lock, "project/ish/kernel/exit.c", 264);
    int err;
    
# 266 "project/ish/kernel/exit.c" 3 4
   _Bool 
# 266 "project/ish/kernel/exit.c"
        got_signal = 
# 266 "project/ish/kernel/exit.c" 3 4
                     0
# 266 "project/ish/kernel/exit.c"
...
# 271 "project/ish/kernel/exit.c" 3 4
       _Bool 
# 271 "project/ish/kernel/exit.c"
            no_children = 
# 271 "project/ish/kernel/exit.c" 3 4
                          1
# 271 "project/ish/kernel/exit.c"
...
# 273 "project/ish/kernel/exit.c" 3 4
       __builtin_offsetof (
# 273 "project/ish/kernel/exit.c"
       typeof(*parent)
# 273 "project/ish/kernel/exit.c" 3 4
       , 
# 273 "project/ish/kernel/exit.c"
...
# 275 "project/ish/kernel/exit.c" 3 4
           __builtin_offsetof (
# 275 "project/ish/kernel/exit.c"
           typeof(*task)
# 275 "project/ish/kernel/exit.c" 3 4
           , 
# 275 "project/ish/kernel/exit.c"
...
# 275 "project/ish/kernel/exit.c"
                ...
                if (idtype == 2 && task->group->pgid != id)
                    continue;
                no_children = 
# 280 "project/ish/kernel/exit.c" 3 4
                             0
# 280 "project/ish/kernel/exit.c"
                                  ;
        ...
        err = -10;
        if (task == 
# 293 "project/ish/kernel/exit.c" 3 4
                   ((void *)0) 
# 293 "project/ish/kernel/exit.c"
                        || task->parent == 
# 293 "project/ish/kernel/exit.c" 3 4
                                           ((void *)0) 
# 293 "project/ish/kernel/exit.c"
...
# 314 "project/ish/kernel/exit.c" 3 4
                                                         ((void *)0)
# 314 "project/ish/kernel/exit.c"
                                                             )) {


        got_signal = 
# 317 "project/ish/kernel/exit.c" 3 4
                    1
# 317 "project/ish/kernel/exit.c"
                        ;
        goto retry;
    }
    goto retry;
...
# 335 "project/ish/kernel/exit.c" 3 4
                                          ((void *)0)
# 335 "project/ish/kernel/exit.c"
                                              , options);
