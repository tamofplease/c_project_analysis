# 0 "project/ish/kernel/fs_info.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 2 "project/ish/kernel/fs_info.c" 2


struct fs_info *fs_info_new() {
    struct fs_info *fs = malloc(sizeof(struct fs_info));
    if (fs == 
# 6 "project/ish/kernel/fs_info.c" 3 4
             ((void *)0)
# 6 "project/ish/kernel/fs_info.c"
                 )
        return 
# 7 "project/ish/kernel/fs_info.c" 3 4
              ((void *)0)
# 7 "project/ish/kernel/fs_info.c"
                  ;
    fs->refcount = 1;
    fs->umask = 0;
    fs->pwd = fs->root = 
# 10 "project/ish/kernel/fs_info.c" 3 4
                        ((void *)0)
# 10 "project/ish/kernel/fs_info.c"
                            ;
    lock_init(&fs->lock);
    return fs;
}
