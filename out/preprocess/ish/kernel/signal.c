...
# 2 "project/ish/kernel/signal.c" 2
...
# 3 "project/ish/kernel/signal.c" 2
...
# 4 "project/ish/kernel/signal.c" 2
...
# 5 "project/ish/kernel/signal.c" 2
...
static 
# 18 "project/ish/kernel/signal.c" 3 4
      _Bool 
# 18 "project/ish/kernel/signal.c"
           is_on_altstack(dword_t sp, struct sighand *sighand);

static int signal_is_blockable(int sig) {
    return sig != 9 && sig != 19;
}
# 31 "project/ish/kernel/signal.c"
...
# 67 "project/ish/kernel/signal.c" 3 4
                                  30
# 67 "project/ish/kernel/signal.c"
                                         );
...
retry:
        __lock(&task->waiting_cond_lock, "project/ish/kernel/signal.c", 74);
        if (task->waiting_cond != 
# 75 "project/ish/kernel/signal.c" 3 4
                                 ((void *)0)
# 75 "project/ish/kernel/signal.c"
                                     ) {
            
# 76 "project/ish/kernel/signal.c" 3 4
           _Bool 
# 76 "project/ish/kernel/signal.c"
                mine = 
# 76 "project/ish/kernel/signal.c" 3 4
                       0
# 76 "project/ish/kernel/signal.c"
                            ;
            if (trylock(task->waiting_lock, "project/ish/kernel/signal.c", 77) == 
# 77 "project/ish/kernel/signal.c" 3 4
                                              16
# 77 "project/ish/kernel/signal.c"
                                                   ) {
                if (pthread_equal(task->waiting_lock->owner, pthread_self()))
                    mine = 
# 79 "project/ish/kernel/signal.c" 3 4
                          1
# 79 "project/ish/kernel/signal.c"
                              ;
                if (!mine) {
        ...
        unlock(&task->waiting_cond_lock);
        __lock(&task->sighand->lock, "project/ish/kernel/signal.c", 90);
    }
}

void deliver_signal(struct task *task, int sig, struct siginfo_ info) {
    __lock(&task->sighand->lock, "project/ish/kernel/signal.c", 95);
...
void send_signal(struct task *task, int sig, struct siginfo_ info) {
    ...
    __lock(&sighand->lock, "project/ish/kernel/signal.c", 108);
    ...
    if (sig == 18 || sig == 9) {
        __lock(&task->group->lock, "project/ish/kernel/signal.c", 115);
        task->group->stopped = 
# 116 "project/ish/kernel/signal.c" 3 4
                              0
# 116 "project/ish/kernel/signal.c"
                                   ;
...
# 122 "project/ish/kernel/signal.c" 3 4
_Bool 
# 122 "project/ish/kernel/signal.c"
    try_self_signal(int sig) {
    
# 123 "project/ish/kernel/signal.c" 3 4
   (__builtin_expect(!(
# 123 "project/ish/kernel/signal.c"
   sig == 21 || sig == 22
# 123 "project/ish/kernel/signal.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/kernel/signal.c", 123, 
# 123 "project/ish/kernel/signal.c"
...
# 123 "project/ish/kernel/signal.c"
    ...
    __lock(&sighand->lock, "project/ish/kernel/signal.c", 126);
    
# 127 "project/ish/kernel/signal.c" 3 4
   _Bool 
# 127 "project/ish/kernel/signal.c"
...
int send_group_signal(dword_t pgid, int sig, struct siginfo_ info) {
    __lock(&pids_lock, "project/ish/kernel/signal.c", 136);
    struct pid *pid = pid_get(pgid);
    if (pid == 
# 138 "project/ish/kernel/signal.c" 3 4
              ((void *)0)
# 138 "project/ish/kernel/signal.c"
                  ) {
        unlock(&pids_lock);
        return -3;
    }
...
# 143 "project/ish/kernel/signal.c" 3 4
   __builtin_offsetof (
# 143 "project/ish/kernel/signal.c"
   typeof(*tgroup)
# 143 "project/ish/kernel/signal.c" 3 4
   , 
# 143 "project/ish/kernel/signal.c"
...
# 192 "project/ish/kernel/signal.c" 3 4
   __builtin___memcpy_chk (
# 192 "project/ish/kernel/signal.c"
   frame->retcode
# 192 "project/ish/kernel/signal.c" 3 4
   , 
# 192 "project/ish/kernel/signal.c"
   &retcode, sizeof(retcode)
# 192 "project/ish/kernel/signal.c" 3 4
...
# 215 "project/ish/kernel/signal.c" 3 4
   __builtin___memcpy_chk (
# 215 "project/ish/kernel/signal.c"
   frame->retcode
# 215 "project/ish/kernel/signal.c" 3 4
   , 
# 215 "project/ish/kernel/signal.c"
   &rt_retcode, sizeof(rt_retcode)
# 215 "project/ish/kernel/signal.c" 3 4
   , __builtin_object_size (
# 215 "project/ish/kernel/signal.c"
   frame->retcode
...
static void receive_signal(struct sighand *sighand, struct siginfo_ *info) {
    ...
    switch (signal_action(sighand, sig)) {
        ...
        case 3:
            __lock(&current->group->lock, "project/ish/kernel/signal.c", 227);
            current->group->stopped = 
# 228 "project/ish/kernel/signal.c" 3 4
                                     1
# 228 "project/ish/kernel/signal.c"
                                         ;
...
# 239 "project/ish/kernel/signal.c" 3 4
   _Bool 
# 239 "project/ish/kernel/signal.c"
...
# 284 "project/ish/kernel/signal.c" 3 4
                                      __builtin_offsetof (
# 284 "project/ish/kernel/signal.c"
                                      struct rt_sigframe_
# 284 "project/ish/kernel/signal.c" 3 4
                                      , 
# 284 "project/ish/kernel/signal.c"
...
# 285 "project/ish/kernel/signal.c" 3 4
                                    __builtin_offsetof (
# 285 "project/ish/kernel/signal.c"
                                    struct rt_sigframe_
# 285 "project/ish/kernel/signal.c" 3 4
                                    , 
# 285 "project/ish/kernel/signal.c"
...
void signal_delivery_stop(int sig, struct siginfo_ *info) {
    __lock(&current->ptrace.lock, "project/ish/kernel/signal.c", 301);
    current->ptrace.stopped = 
# 302 "project/ish/kernel/signal.c" 3 4
                             1
# 302 "project/ish/kernel/signal.c"
                                 ;
    ...
    __lock(&current->ptrace.lock, "project/ish/kernel/signal.c", 311);
    while (current->ptrace.stopped) {
        wait_for_ignore_signals(&current->ptrace.cond, &current->ptrace.lock, 
# 313 "project/ish/kernel/signal.c" 3 4
                                                                             ((void *)0)
# 313 "project/ish/kernel/signal.c"
                                                                                 );
        __lock(&current->sighand->lock, "project/ish/kernel/signal.c", 314);
        
# 315 "project/ish/kernel/signal.c" 3 4
       _Bool 
# 315 "project/ish/kernel/signal.c"
    ...
    unlock(&current->ptrace.lock);
    __lock(&current->sighand->lock, "project/ish/kernel/signal.c", 324);
}

void receive_signals() {
    __lock(&current->group->lock, "project/ish/kernel/signal.c", 328);
    
# 329 "project/ish/kernel/signal.c" 3 4
   _Bool 
# 329 "project/ish/kernel/signal.c"
        was_stopped = current->group->stopped;
    unlock(&current->group->lock);

    struct sighand *sighand = current->sighand;
    __lock(&sighand->lock, "project/ish/kernel/signal.c", 333);
...
# 342 "project/ish/kernel/signal.c" 3 4
                                 0
# 342 "project/ish/kernel/signal.c"
                                      ;
...
# 347 "project/ish/kernel/signal.c" 3 4
   __builtin_offsetof (
# 347 "project/ish/kernel/signal.c"
   typeof(*(sigqueue))
# 347 "project/ish/kernel/signal.c" 3 4
   , 
# 347 "project/ish/kernel/signal.c"
...
# 347 "project/ish/kernel/signal.c"
    ...
    if (!was_stopped) {
        __lock(&current->group->lock, "project/ish/kernel/signal.c", 370);
        
# 371 "project/ish/kernel/signal.c" 3 4
       _Bool 
# 371 "project/ish/kernel/signal.c"
            now_stopped = current->group->stopped;
        unlock(&current->group->lock);
        if (now_stopped) {
            __lock(&pids_lock, "project/ish/kernel/signal.c", 374);
            notify(&current->parent->group->child_exit);
...
# 404 "project/ish/kernel/signal.c" 3 4
       __builtin_offsetof (
# 404 "project/ish/kernel/signal.c"
       struct rt_sigframe_
# 404 "project/ish/kernel/signal.c" 3 4
       , 
# 404 "project/ish/kernel/signal.c"
...
# 404 "project/ish/kernel/signal.c"
    ...
    __lock(&current->sighand->lock, "project/ish/kernel/signal.c", 410);
...
dword_t sys_sigreturn() {
    ...
    if (user_read(cpu->esp - 
# 426 "project/ish/kernel/signal.c" 3 4
       __builtin_offsetof (
# 426 "project/ish/kernel/signal.c"
       struct sigframe_
# 426 "project/ish/kernel/signal.c" 3 4
       , 
# 426 "project/ish/kernel/signal.c"
...
# 426 "project/ish/kernel/signal.c"
    ...
    __lock(&current->sighand->lock, "project/ish/kernel/signal.c", 432);
...
struct sighand *sighand_new() {
    ...
    if (sighand == 
# 441 "project/ish/kernel/signal.c" 3 4
                  ((void *)0)
# 441 "project/ish/kernel/signal.c"
                      )
        return 
# 442 "project/ish/kernel/signal.c" 3 4
              ((void *)0)
# 442 "project/ish/kernel/signal.c"
                  ;
    
# 443 "project/ish/kernel/signal.c" 3 4
   __builtin___memset_chk (
# 443 "project/ish/kernel/signal.c"
   sighand
# 443 "project/ish/kernel/signal.c" 3 4
   , 
# 443 "project/ish/kernel/signal.c"
   0, sizeof(struct sighand)
# 443 "project/ish/kernel/signal.c" 3 4
   , __builtin_object_size (
# 443 "project/ish/kernel/signal.c"
   sighand
...
struct sighand *sighand_copy(struct sighand *sighand) {
    ...
    if (new_sighand == 
# 451 "project/ish/kernel/signal.c" 3 4
                      ((void *)0)
# 451 "project/ish/kernel/signal.c"
                          )
        return 
# 452 "project/ish/kernel/signal.c" 3 4
              ((void *)0)
# 452 "project/ish/kernel/signal.c"
                  ;
    
# 453 "project/ish/kernel/signal.c" 3 4
   __builtin___memcpy_chk (
# 453 "project/ish/kernel/signal.c"
   new_sighand->action
# 453 "project/ish/kernel/signal.c" 3 4
   , 
# 453 "project/ish/kernel/signal.c"
   sighand->action, sizeof(new_sighand->action)
# 453 "project/ish/kernel/signal.c" 3 4
   , __builtin_object_size (
# 453 "project/ish/kernel/signal.c"
   new_sighand->action
...
static int do_sigaction(int sig, const struct sigaction_ *action, struct sigaction_ *oldaction) {
    ...
    struct sighand *sighand = current->sighand;
    __lock(&sighand->lock, "project/ish/kernel/signal.c", 470);
    if (oldaction)
...
dword_t sys_rt_sigaction(dword_t signum, addr_t action_addr, addr_t oldaction_addr, dword_t sigset_size) {
    ...
    int err = do_sigaction(signum,
            action_addr ? &action : 
# 491 "project/ish/kernel/signal.c" 3 4
                                   ((void *)0)
# 491 "project/ish/kernel/signal.c"
                                       ,
            oldaction_addr ? &oldaction : 
# 492 "project/ish/kernel/signal.c" 3 4
                                         ((void *)0)
# 492 "project/ish/kernel/signal.c"
                                             );
    if (err < 0)
        return err;
...
static void sigmask_set_temp_unlocked(sigset_t_ mask) {
    ...
    current->has_saved_mask = 
# 512 "project/ish/kernel/signal.c" 3 4
                             1
# 512 "project/ish/kernel/signal.c"
                                 ;
    sigmask_set(mask);
}

void sigmask_set_temp(sigset_t_ mask) {
    __lock(&current->sighand->lock, "project/ish/kernel/signal.c", 517);
...
dword_t sys_rt_sigprocmask(dword_t how, addr_t set_addr, addr_t oldset_addr, dword_t size) {
    ...
    if (set_addr != 0) {
        struct sighand *sighand = current->sighand;
        __lock(&sighand->lock, "project/ish/kernel/signal.c", 553);
...
static 
# 571 "project/ish/kernel/signal.c" 3 4
      _Bool 
# 571 "project/ish/kernel/signal.c"
           is_on_altstack(dword_t sp, struct sighand *sighand) {
...
dword_t sys_sigaltstack(addr_t ss_addr, addr_t old_ss_addr) {
    ...
    struct sighand *sighand = current->sighand;
    __lock(&sighand->lock, "project/ish/kernel/signal.c", 588);
    if (old_ss_addr != 0) {
...
int_t sys_rt_sigsuspend(addr_t mask_addr, uint_t size) {
    ...
    __lock(&current->sighand->lock, "project/ish/kernel/signal.c", 628);
    sigmask_set_temp_unlocked(mask);
    while (wait_for(&current->pause, &current->sighand->lock, 
# 630 "project/ish/kernel/signal.c" 3 4
                                                             ((void *)0)
# 630 "project/ish/kernel/signal.c"
                                                                 ) != -4)
        continue;
    unlock(&current->sighand->lock);
    __use(0, current->pid);
...
int_t sys_pause() {
    __lock(&current->sighand->lock, "project/ish/kernel/signal.c", 638);
    while (wait_for(&current->pause, &current->sighand->lock, 
# 639 "project/ish/kernel/signal.c" 3 4
                                                             ((void *)0)
# 639 "project/ish/kernel/signal.c"
                                                                 ) != -4)
        continue;
    unlock(&current->sighand->lock);
    return -4;
...
int_t sys_rt_sigtimedwait(addr_t set_addr, addr_t info_addr, addr_t timeout_addr, uint_t set_size) {
    ...
    __lock(&current->sighand->lock, "project/ish/kernel/signal.c", 661);
    
# 662 "project/ish/kernel/signal.c" 3 4
   (__builtin_expect(!(
# 662 "project/ish/kernel/signal.c"
   current->waiting == 0
# 662 "project/ish/kernel/signal.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/kernel/signal.c", 662, 
# 662 "project/ish/kernel/signal.c"
   "current->waiting == 0"
# 662 "project/ish/kernel/signal.c" 3 4
   ) : (void)0)
...
# 666 "project/ish/kernel/signal.c" 3 4
                                                                                    ((void *)0) 
# 666 "project/ish/kernel/signal.c"
                                                                                         : &timeout);
    } while (err == 0);
    current->waiting = 0;
    if (err == -110) {
...
# 676 "project/ish/kernel/signal.c" 3 4
   _Bool 
# 676 "project/ish/kernel/signal.c"
        found = 
# 676 "project/ish/kernel/signal.c" 3 4
                0
# 676 "project/ish/kernel/signal.c"
                     ;
    for (sigqueue = ((typeof(*sigqueue) *) ((char *) ((&current->queue)->next) - 
# 677 "project/ish/kernel/signal.c" 3 4
   __builtin_offsetof (
# 677 "project/ish/kernel/signal.c"
   typeof(*sigqueue)
# 677 "project/ish/kernel/signal.c" 3 4
   , 
# 677 "project/ish/kernel/signal.c"
...
# 677 "project/ish/kernel/signal.c"
        ...
        if (sigset_has(set, sigqueue->info.sig)) {
            found = 
# 679 "project/ish/kernel/signal.c" 3 4
                   1
# 679 "project/ish/kernel/signal.c"
                       ;
            list_remove(&sigqueue->queue);
            break;
        }
...
static int kill_task(struct task *task, dword_t sig) {
    if (!(current != 
# 697 "project/ish/kernel/signal.c" 3 4
        ((void *)0) 
# 697 "project/ish/kernel/signal.c"
        && current->euid == 0) &&
...
static int kill_group(pid_t_ pgid, dword_t sig) {
    struct pid *pid = pid_get(pgid);
    if (pid == 
# 714 "project/ish/kernel/signal.c" 3 4
              ((void *)0)
# 714 "project/ish/kernel/signal.c"
                  ) {
        unlock(&pids_lock);
        return -3;
    }
    ...
    int err = -1;
    for (tgroup = ((typeof(*tgroup) *) ((char *) ((&pid->pgroup)->next) - 
# 720 "project/ish/kernel/signal.c" 3 4
   __builtin_offsetof (
# 720 "project/ish/kernel/signal.c"
   typeof(*tgroup)
# 720 "project/ish/kernel/signal.c" 3 4
   , 
# 720 "project/ish/kernel/signal.c"
...
static int kill_everything(dword_t sig) {
    ...
    for (int i = 2; i < (1 << 15); i++) {
        ...
        if (task == 
# 733 "project/ish/kernel/signal.c" 3 4
                   ((void *)0) 
# 733 "project/ish/kernel/signal.c"
...
static int do_kill(pid_t_ pid, dword_t sig, pid_t_ tgid) {
    ...
    int err;
    __lock(&pids_lock, "project/ish/kernel/signal.c", 750);
    ...
    if (pid == -1) {
        ...
        if (task == 
# 758 "project/ish/kernel/signal.c" 3 4
                   ((void *)0)
# 758 "project/ish/kernel/signal.c"
                       ) {
            unlock(&pids_lock);
            return -3;
        }
