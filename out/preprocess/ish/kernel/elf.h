# 0 "project/ish/kernel/elf.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/kernel/elf.h"
...
# 5 "project/ish/kernel/elf.h" 2
# 16 "project/ish/kernel/elf.h"
struct elf_header {
    uint32_t magic;
    byte_t bitness;
    byte_t endian;
