# 0 "project/ish/xX_main_Xx.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/xX_main_Xx.h"
...
# 5 "project/ish/xX_main_Xx.h" 2
# 1 "project/ish/kernel/init.h" 1
...
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/tty.h" 2
...
# 6 "project/ish/xX_main_Xx.h" 2
# 1 "project/ish/kernel/fs.h" 1
# 7 "project/ish/xX_main_Xx.h" 2
# 1 "project/ish/fs/devices.h" 1
# 8 "project/ish/xX_main_Xx.h" 2
# 1 "project/ish/fs/real.h" 1
...
static void exit_handler(struct task *task, int code) {
    if (task->parent != 
# 18 "project/ish/xX_main_Xx.h" 3 4
                       ((void *)0)
# 18 "project/ish/xX_main_Xx.h"
                           )
        return;
    real_tty_reset_term();
    if (code & 0xff)
...
# 38 "project/ish/xX_main_Xx.h" 3 4
           0
# 38 "project/ish/xX_main_Xx.h"
                              ,
            1);
    if (iopol_err != 0 && 
# 40 "project/ish/xX_main_Xx.h" 3 4
                         (*__error()) 
# 40 "project/ish/xX_main_Xx.h"
                               != 
# 40 "project/ish/xX_main_Xx.h" 3 4
                                  1
# 40 "project/ish/xX_main_Xx.h"
    ...
    int opt;
    const char *root = 
# 48 "project/ish/xX_main_Xx.h" 3 4
                      ((void *)0)
# 48 "project/ish/xX_main_Xx.h"
                          ;
    const char *workdir = 
# 49 "project/ish/xX_main_Xx.h" 3 4
                         ((void *)0)
# 49 "project/ish/xX_main_Xx.h"
                             ;
    ...
    if (root != 
# 71 "project/ish/xX_main_Xx.h" 3 4
               ((void *)0) 
# 71 "project/ish/xX_main_Xx.h"
...
# 76 "project/ish/xX_main_Xx.h" 3 4
       __builtin___strcat_chk (
# 76 "project/ish/xX_main_Xx.h"
       root_realpath
# 76 "project/ish/xX_main_Xx.h" 3 4
       , 
# 76 "project/ish/xX_main_Xx.h"
...
# 76 "project/ish/xX_main_Xx.h"
    ...
    char cwd[4096 + 1];
    if (root == 
# 84 "project/ish/xX_main_Xx.h" 3 4
               ((void *)0) 
# 84 "project/ish/xX_main_Xx.h"
                    && workdir == 
# 84 "project/ish/xX_main_Xx.h" 3 4
                                  ((void *)0)
# 84 "project/ish/xX_main_Xx.h"
    ...
    if (workdir != 
# 88 "project/ish/xX_main_Xx.h" 3 4
                  ((void *)0)
# 88 "project/ish/xX_main_Xx.h"
                      ) {
        struct fd *pwd = generic_open(workdir, 0, 0);
        if (((uintptr_t) (pwd) > (uintptr_t) -0xfff)) {
            fprintf(
# 91 "project/ish/xX_main_Xx.h" 3 4
                   __stderrp
# 91 "project/ish/xX_main_Xx.h"
...
# 101 "project/ish/xX_main_Xx.h" 3 4
       __builtin___strcpy_chk (
# 101 "project/ish/xX_main_Xx.h"
       &argv_copy[p]
# 101 "project/ish/xX_main_Xx.h" 3 4
       , 
# 101 "project/ish/xX_main_Xx.h"
...
# 106 "project/ish/xX_main_Xx.h" 3 4
                                                                   ((void *)0) 
# 106 "project/ish/xX_main_Xx.h"
                                                                        ? "\0" : envp);
    if (err < 0)
        return err;
    tty_drivers[4] = &real_tty_driver;
    if (isatty(
# 110 "project/ish/xX_main_Xx.h" 3 4
              0
# 110 "project/ish/xX_main_Xx.h"
                          ) && isatty(
# 110 "project/ish/xX_main_Xx.h" 3 4
                                      1
# 110 "project/ish/xX_main_Xx.h"
