# 0 "project/ish/tools/vdso-transplant.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/tools/vdso-transplant.c"
...
# 3 "project/ish/tools/vdso-transplant.c" 2
...
# 4 "project/ish/tools/vdso-transplant.c" 2
...
# 5 "project/ish/tools/vdso-transplant.c" 2
...
# 6 "project/ish/tools/vdso-transplant.c" 2
...
# 7 "project/ish/tools/vdso-transplant.c" 2
...
# 8 "project/ish/tools/vdso-transplant.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/ish/tools/ptutil.h" 1
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/ish/tools/../misc.h" 1
# 2 "/Users/washi38/University/Labo/c_project_analysis/project/ish/tools/ptutil.h" 2
...
# 9 "project/ish/tools/vdso-transplant.c" 2


static addr_t aux_addr(int pid, unsigned type) {
    struct user_regs_struct regs;
    trycall(ptrace(PTRACE_GETREGS, pid, 
# 13 "project/ish/tools/vdso-transplant.c" 3 4
                                       ((void *)0)
# 13 "project/ish/tools/vdso-transplant.c"
                                           , &regs), "ptrace get sp for aux");
...
# 44 "project/ish/tools/vdso-transplant.c" 3 4
   __builtin___sprintf_chk (
# 44 "project/ish/tools/vdso-transplant.c"
   maps_file
# 44 "project/ish/tools/vdso-transplant.c" 3 4
...
# 49 "project/ish/tools/vdso-transplant.c" 3 4
                                             ((void *)0)
# 49 "project/ish/tools/vdso-transplant.c"
                                                 ) {
        char *map_type = 
# 50 "project/ish/tools/vdso-transplant.c" 3 4
                        ((void *)0)
# 50 "project/ish/tools/vdso-transplant.c"
                            ;
    ...
    aux_write(pid, 32, entry);
    aux_write(pid, 33, start);
}
