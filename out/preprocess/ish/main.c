# 0 "project/ish/main.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/main.c"
...
# 3 "project/ish/main.c" 2
# 1 "project/ish/kernel/calls.h" 1
...
# 5 "project/ish/kernel/calls.h" 2
...
int err_map(int err);
int errno_map(void);
# 6 "project/ish/kernel/calls.h" 2
...
# 13 "project/ish/kernel/calls.h" 2
...
# 16 "project/ish/kernel/calls.h" 2
...
# 37 "project/ish/kernel/calls.h" 3 4
_Noreturn 
# 37 "project/ish/kernel/calls.h"
        void do_exit(int status);

# 38 "project/ish/kernel/calls.h" 3 4
_Noreturn 
# 38 "project/ish/kernel/calls.h"
...
# 4 "project/ish/main.c" 2
# 1 "project/ish/kernel/task.h" 1
# 5 "project/ish/main.c" 2
# 1 "project/ish/xX_main_Xx.h" 1
...
# 6 "project/ish/main.c" 2

int main(int argc, char *const argv[]) {
    char envp[100] = {0};
    if (getenv("TERM"))
        
# 10 "project/ish/main.c" 3 4
       __builtin___strcpy_chk (
# 10 "project/ish/main.c"
       envp
# 10 "project/ish/main.c" 3 4
       , 
# 10 "project/ish/main.c"
       getenv("TERM") - strlen("TERM") - 1
# 10 "project/ish/main.c" 3 4
       , __builtin_object_size (
# 10 "project/ish/main.c"
       envp
...
# 10 "project/ish/main.c"
    ...
    if (err < 0) {
        fprintf(
# 13 "project/ish/main.c" 3 4
               __stderrp
# 13 "project/ish/main.c"
                     , "xX_main_Xx: %s\n", strerror(-err));
        return err;
    }
