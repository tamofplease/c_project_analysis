# 0 "project/ish/emu/cpu.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/emu/cpu.h"
...
# 26 "project/ish/emu/cpu.h" 3 4
_Static_assert
# 26 "project/ish/emu/cpu.h"
            (sizeof(union xmm_reg) == 16, "xmm_reg size");

# 27 "project/ish/emu/cpu.h" 3 4
_Static_assert
# 27 "project/ish/emu/cpu.h"
            (sizeof(union mm_reg) == 8, "mm_reg size");

struct cpu_state {
    struct mmu *mmu;
    long cycle;
# 50 "project/ish/emu/cpu.h"
    union {
        struct {
...
# 162 "project/ish/emu/cpu.h" 3 4
   _Bool 
# 162 "project/ish/emu/cpu.h"
        segfault_was_write;
...
# 169 "project/ish/emu/cpu.h" 3 4
_Static_assert
# 169 "project/ish/emu/cpu.h"
            (
# 169 "project/ish/emu/cpu.h" 3 4
             __builtin_offsetof (
# 169 "project/ish/emu/cpu.h"
...
# 170 "project/ish/emu/cpu.h" 3 4
_Static_assert
# 170 "project/ish/emu/cpu.h"
            (
# 170 "project/ish/emu/cpu.h" 3 4
             __builtin_offsetof (
# 170 "project/ish/emu/cpu.h"
...
# 171 "project/ish/emu/cpu.h" 3 4
_Static_assert
# 171 "project/ish/emu/cpu.h"
            (
# 171 "project/ish/emu/cpu.h" 3 4
             __builtin_offsetof (
# 171 "project/ish/emu/cpu.h"
...
# 172 "project/ish/emu/cpu.h" 3 4
_Static_assert
# 172 "project/ish/emu/cpu.h"
            (
# 172 "project/ish/emu/cpu.h" 3 4
             __builtin_offsetof (
# 172 "project/ish/emu/cpu.h"
...
# 173 "project/ish/emu/cpu.h" 3 4
_Static_assert
# 173 "project/ish/emu/cpu.h"
            (
# 173 "project/ish/emu/cpu.h" 3 4
             __builtin_offsetof (
# 173 "project/ish/emu/cpu.h"
...
# 174 "project/ish/emu/cpu.h" 3 4
_Static_assert
# 174 "project/ish/emu/cpu.h"
            (
# 174 "project/ish/emu/cpu.h" 3 4
             __builtin_offsetof (
# 174 "project/ish/emu/cpu.h"
...
# 175 "project/ish/emu/cpu.h" 3 4
_Static_assert
# 175 "project/ish/emu/cpu.h"
            (
# 175 "project/ish/emu/cpu.h" 3 4
             __builtin_offsetof (
# 175 "project/ish/emu/cpu.h"
...
# 176 "project/ish/emu/cpu.h" 3 4
_Static_assert
# 176 "project/ish/emu/cpu.h"
            (
# 176 "project/ish/emu/cpu.h" 3 4
             __builtin_offsetof (
# 176 "project/ish/emu/cpu.h"
...
# 177 "project/ish/emu/cpu.h" 3 4
_Static_assert
# 177 "project/ish/emu/cpu.h"
            (sizeof(struct cpu_state) < 0xffff, "cpu struct is too big for vector gadgets");
# 187 "project/ish/emu/cpu.h"
