# 0 "project/ish/emu/tlb.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/emu/tlb.c"
...
# 7 "/Users/washi38/University/Labo/c_project_analysis/project/ish/emu/tlb.h" 2
...
# 23 "project/ish/emu/tlb.c" 3 4
_Bool 
# 23 "project/ish/emu/tlb.c"
    __tlb_read_cross_page(struct tlb *tlb, addr_t addr, char *value, unsigned size) {
    char *ptr1 = __tlb_read_ptr(tlb, addr);
    if (ptr1 == 
# 25 "project/ish/emu/tlb.c" 3 4
               ((void *)0)
# 25 "project/ish/emu/tlb.c"
                   )
        return 
# 26 "project/ish/emu/tlb.c" 3 4
              0
# 26 "project/ish/emu/tlb.c"
                   ;
    char *ptr2 = __tlb_read_ptr(tlb, (((addr) >> 12) + 1) << 12);
    if (ptr2 == 
# 28 "project/ish/emu/tlb.c" 3 4
               ((void *)0)
# 28 "project/ish/emu/tlb.c"
                   )
        return 
# 29 "project/ish/emu/tlb.c" 3 4
              0
# 29 "project/ish/emu/tlb.c"
                   ;
    size_t part1 = (1 << 12) - ((addr) & ((1 << 12) - 1));
    
# 31 "project/ish/emu/tlb.c" 3 4
   (__builtin_expect(!(
# 31 "project/ish/emu/tlb.c"
   part1 < size
# 31 "project/ish/emu/tlb.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/emu/tlb.c", 31, 
# 31 "project/ish/emu/tlb.c"
   "part1 < size"
# 31 "project/ish/emu/tlb.c" 3 4
   ) : (void)0)
...
# 32 "project/ish/emu/tlb.c" 3 4
   __builtin___memcpy_chk (
# 32 "project/ish/emu/tlb.c"
   value
# 32 "project/ish/emu/tlb.c" 3 4
   , 
# 32 "project/ish/emu/tlb.c"
...
# 33 "project/ish/emu/tlb.c" 3 4
   __builtin___memcpy_chk (
# 33 "project/ish/emu/tlb.c"
   value + part1
# 33 "project/ish/emu/tlb.c" 3 4
   , 
# 33 "project/ish/emu/tlb.c"
...
# 33 "project/ish/emu/tlb.c"
                                            ;
    return 
# 34 "project/ish/emu/tlb.c" 3 4
          1
# 34 "project/ish/emu/tlb.c"
              ;
}


# 37 "project/ish/emu/tlb.c" 3 4
_Bool 
# 37 "project/ish/emu/tlb.c"
    __tlb_write_cross_page(struct tlb *tlb, addr_t addr, const char *value, unsigned size) {
    char *ptr1 = __tlb_write_ptr(tlb, addr);
    if (ptr1 == 
# 39 "project/ish/emu/tlb.c" 3 4
               ((void *)0)
# 39 "project/ish/emu/tlb.c"
                   )
        return 
# 40 "project/ish/emu/tlb.c" 3 4
              0
# 40 "project/ish/emu/tlb.c"
                   ;
    char *ptr2 = __tlb_write_ptr(tlb, (((addr) >> 12) + 1) << 12);
    if (ptr2 == 
# 42 "project/ish/emu/tlb.c" 3 4
               ((void *)0)
# 42 "project/ish/emu/tlb.c"
                   )
        return 
# 43 "project/ish/emu/tlb.c" 3 4
              0
# 43 "project/ish/emu/tlb.c"
                   ;
    size_t part1 = (1 << 12) - ((addr) & ((1 << 12) - 1));
    
# 45 "project/ish/emu/tlb.c" 3 4
   (__builtin_expect(!(
# 45 "project/ish/emu/tlb.c"
   part1 < size
# 45 "project/ish/emu/tlb.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/emu/tlb.c", 45, 
# 45 "project/ish/emu/tlb.c"
   "part1 < size"
# 45 "project/ish/emu/tlb.c" 3 4
   ) : (void)0)
...
# 46 "project/ish/emu/tlb.c" 3 4
   __builtin___memcpy_chk (
# 46 "project/ish/emu/tlb.c"
   ptr1
# 46 "project/ish/emu/tlb.c" 3 4
   , 
# 46 "project/ish/emu/tlb.c"
...
# 47 "project/ish/emu/tlb.c" 3 4
   __builtin___memcpy_chk (
# 47 "project/ish/emu/tlb.c"
   ptr2
# 47 "project/ish/emu/tlb.c" 3 4
   , 
# 47 "project/ish/emu/tlb.c"
   value + part1, size - part1
# 47 "project/ish/emu/tlb.c" 3 4
   , __builtin_object_size (
# 47 "project/ish/emu/tlb.c"
   ptr2
...
# 47 "project/ish/emu/tlb.c"
                                            ;
    return 
# 48 "project/ish/emu/tlb.c" 3 4
          1
# 48 "project/ish/emu/tlb.c"
              ;
}
...
__attribute__((no_sanitize("address", "thread", "undefined", "leak"))) void *tlb_handle_miss(struct tlb *tlb, addr_t addr, int type) {
    ...
    if (tlb->mmu->changes != tlb->mem_changes)
        tlb_flush(tlb);
    if (ptr == 
# 55 "project/ish/emu/tlb.c" 3 4
              ((void *)0)
# 55 "project/ish/emu/tlb.c"
                  ) {
        tlb->segfault_addr = addr;
        return 
# 57 "project/ish/emu/tlb.c" 3 4
              ((void *)0)
# 57 "project/ish/emu/tlb.c"
                  ;
    }
    tlb->dirty_page = (addr & 0xfffff000);
