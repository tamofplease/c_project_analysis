# 0 "project/ish/fs/proc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/fs/proc.c"
...
static int proc_lookup(const char *path, struct proc_entry *entry) {
    ...
    while (path_next_component(&path, component, &err)) {
        if (!
# 13 "project/ish/fs/proc.c" 3 4
            (((
# 13 "project/ish/fs/proc.c"
            proc_entry_mode(entry)
# 13 "project/ish/fs/proc.c" 3 4
            ) & 0170000) == 0040000)
# 13 "project/ish/fs/proc.c"
                                           )
        ...
        while (proc_dir_read(entry, &index, &next_entry)) {
            ...
            if (next_entry.meta->parent == 
# 21 "project/ish/fs/proc.c" 3 4
                                          ((void *)0)
# 21 "project/ish/fs/proc.c"
                                              )
                next_entry.meta->parent = entry->meta;
            else

                
# 25 "project/ish/fs/proc.c" 3 4
               (__builtin_expect(!(
# 25 "project/ish/fs/proc.c"
               next_entry.meta->parent == entry->meta
# 25 "project/ish/fs/proc.c" 3 4
               ), 0) ? __assert_rtn(__func__, "project/ish/fs/proc.c", 25, 
# 25 "project/ish/fs/proc.c"
               "next_entry.meta->parent == entry->meta"
# 25 "project/ish/fs/proc.c" 3 4
               ) : (void)0)
...
static struct fd *proc_open(struct mount *UNUSED_mount __attribute__((unused)), const char *path, int UNUSED_flags __attribute__((unused)), int UNUSED_mode __attribute__((unused))) {
    struct proc_entry entry;
    ...
    fd->proc.entry = entry;
    fd->proc.data.data = 
# 49 "project/ish/fs/proc.c" 3 4
                        ((void *)0)
# 49 "project/ish/fs/proc.c"
                            ;
    return fd;
}
...
# 65 "project/ish/fs/proc.c" 3 4
       __builtin___memcpy_chk (
# 65 "project/ish/fs/proc.c"
       p + 1
# 65 "project/ish/fs/proc.c" 3 4
       , 
# 65 "project/ish/fs/proc.c"
...
# 68 "project/ish/fs/proc.c" 3 4
   __builtin___memmove_chk (
# 68 "project/ish/fs/proc.c"
   buf
# 68 "project/ish/fs/proc.c" 3 4
   , 
# 68 "project/ish/fs/proc.c"
...
static int proc_stat(struct mount *UNUSED_mount __attribute__((unused)), const char *path, struct statbuf *stat) {
    struct proc_entry entry = {};
    int err = proc_lookup(path, &entry);
    if (err < 0)
        return err;
...
static int proc_refresh_data(struct fd *fd) {
    ...
    if (
# 86 "project/ish/fs/proc.c" 3 4
       (((
# 86 "project/ish/fs/proc.c"
       mode
# 86 "project/ish/fs/proc.c" 3 4
       ) & 0170000) == 0040000)
# 86 "project/ish/fs/proc.c"
...
# 88 "project/ish/fs/proc.c" 3 4
   (__builtin_expect(!((((
# 88 "project/ish/fs/proc.c"
   mode
# 88 "project/ish/fs/proc.c" 3 4
   ) & 0170000) == 0100000)), 0) ? __assert_rtn(__func__, "project/ish/fs/proc.c", 88, 
# 88 "project/ish/fs/proc.c"
   "S_ISREG(mode)"
# 88 "project/ish/fs/proc.c" 3 4
   ) : (void)0)
# 88 "project/ish/fs/proc.c"
    ...
    if (fd->proc.data.data == 
# 90 "project/ish/fs/proc.c" 3 4
                             ((void *)0)
# 90 "project/ish/fs/proc.c"
                                 ) {
...
# 120 "project/ish/fs/proc.c" 3 4
   (__builtin_expect(!(
# 120 "project/ish/fs/proc.c"
   data != 
# 120 "project/ish/fs/proc.c" 3 4
   ((void *)0)), 0) ? __assert_rtn(__func__, "project/ish/fs/proc.c", 120, 
# 120 "project/ish/fs/proc.c"
   "data != NULL"
# 120 "project/ish/fs/proc.c" 3 4
   ) : (void)0)
...
# 129 "project/ish/fs/proc.c" 3 4
   __builtin___memcpy_chk (
# 129 "project/ish/fs/proc.c"
   buf
# 129 "project/ish/fs/proc.c" 3 4
   , 
# 129 "project/ish/fs/proc.c"
...
# 135 "project/ish/fs/proc.c" 3 4
   _Bool 
# 135 "project/ish/fs/proc.c"
        any_left = proc_dir_read(&fd->proc.entry, &fd->offset, &proc_entry);
    if (!any_left)
        return 0;
...
static int proc_close(struct fd *fd) {
    if (fd->proc.data.data != 
# 144 "project/ish/fs/proc.c" 3 4
                             ((void *)0)
# 144 "project/ish/fs/proc.c"
                                 )
...
static ssize_t proc_readlink(struct mount *UNUSED_mount __attribute__((unused)), const char *path, char *buf, size_t bufsize) {
    struct proc_entry entry;
    int err = proc_lookup(path, &entry);
    if (err < 0)
        return err;
    if (!
# 161 "project/ish/fs/proc.c" 3 4
        (((
# 161 "project/ish/fs/proc.c"
        proc_entry_mode(&entry)
# 161 "project/ish/fs/proc.c" 3 4
        ) & 0170000) == 0120000)
# 161 "project/ish/fs/proc.c"
...
# 170 "project/ish/fs/proc.c" 3 4
   __builtin___memcpy_chk (
# 170 "project/ish/fs/proc.c"
   buf
# 170 "project/ish/fs/proc.c" 3 4
   , 
# 170 "project/ish/fs/proc.c"
...
void proc_buf_write(struct proc_data *buf, const void *data, size_t size) {
    if (buf->size + size > buf->capacity) {
        ...
        if (new_data == 
# 182 "project/ish/fs/proc.c" 3 4
                       ((void *)0)
# 182 "project/ish/fs/proc.c"
                           ) {
...
# 189 "project/ish/fs/proc.c" 3 4
   (__builtin_expect(!(
# 189 "project/ish/fs/proc.c"
   buf->size + size <= buf->capacity
# 189 "project/ish/fs/proc.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/fs/proc.c", 189, 
# 189 "project/ish/fs/proc.c"
   "buf->size + size <= buf->capacity"
# 189 "project/ish/fs/proc.c" 3 4
   ) : (void)0)
...
# 190 "project/ish/fs/proc.c" 3 4
   __builtin___memcpy_chk (
# 190 "project/ish/fs/proc.c"
   &buf->data[buf->size]
# 190 "project/ish/fs/proc.c" 3 4
   , 
# 190 "project/ish/fs/proc.c"
...
# 197 "project/ish/fs/proc.c" 3 4
   __builtin_va_start(
# 197 "project/ish/fs/proc.c"
   args
# 197 "project/ish/fs/proc.c" 3 4
   ,
# 197 "project/ish/fs/proc.c"
...
# 197 "project/ish/fs/proc.c"
                         ;
    size_t size = 
# 198 "project/ish/fs/proc.c" 3 4
                 __builtin___vsnprintf_chk (
# 198 "project/ish/fs/proc.c"
                 data
# 198 "project/ish/fs/proc.c" 3 4
                 , 
# 198 "project/ish/fs/proc.c"
...
# 199 "project/ish/fs/proc.c" 3 4
   __builtin_va_end(
# 199 "project/ish/fs/proc.c"
   args
# 199 "project/ish/fs/proc.c" 3 4
   )
# 199 "project/ish/fs/proc.c"
