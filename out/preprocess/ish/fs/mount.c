# 0 "project/ish/fs/mount.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/fs/mount.c"
...
# 7 "project/ish/fs/mount.c" 2


static const struct fs_ops *filesystems[10] = {
    &realfs,
    &procfs,
    &devptsfs,
    &tmpfs,
...
void fs_register(const struct fs_ops *fs) {
    for (unsigned i = 0; i < 10; i++) {
        if (filesystems[i] == 
# 18 "project/ish/fs/mount.c" 3 4
                             ((void *)0)
# 18 "project/ish/fs/mount.c"
                                 ) {
            filesystems[i] = fs;
            return;
        }
...
# 23 "project/ish/fs/mount.c" 3 4
   (__builtin_expect(!(
# 23 "project/ish/fs/mount.c"
   !"reached filesystem limit"
# 23 "project/ish/fs/mount.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/fs/mount.c", 23, 
# 23 "project/ish/fs/mount.c"
   "!\"reached filesystem limit\""
# 23 "project/ish/fs/mount.c" 3 4
   ) : (void)0)
...
# 27 "project/ish/fs/mount.c" 3 4
   (__builtin_expect(!(
# 27 "project/ish/fs/mount.c"
   path_is_normalized(path)
# 27 "project/ish/fs/mount.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/fs/mount.c", 27, 
# 27 "project/ish/fs/mount.c"
   "path_is_normalized(path)"
# 27 "project/ish/fs/mount.c" 3 4
   ) : (void)0)
# 27 "project/ish/fs/mount.c"
                                   ;
    __lock(&mounts_lock, "project/ish/fs/mount.c", 28);
    struct mount *mount = 
# 29 "project/ish/fs/mount.c" 3 4
                         ((void *)0)
# 29 "project/ish/fs/mount.c"
                             ;
    
# 30 "project/ish/fs/mount.c" 3 4
   (__builtin_expect(!(
# 30 "project/ish/fs/mount.c"
   !list_empty(&mounts)
# 30 "project/ish/fs/mount.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/fs/mount.c", 30, 
# 30 "project/ish/fs/mount.c"
   "!list_empty(&mounts)"
# 30 "project/ish/fs/mount.c" 3 4
   ) : (void)0)
...
# 31 "project/ish/fs/mount.c" 3 4
   __builtin_offsetof (
# 31 "project/ish/fs/mount.c"
   typeof(*mount)
# 31 "project/ish/fs/mount.c" 3 4
   , 
# 31 "project/ish/fs/mount.c"
...
void mount_retain(struct mount *mount) {
    __lock(&mounts_lock, "project/ish/fs/mount.c", 42);
    mount->refcount++;
    unlock(&mounts_lock);
}

void mount_release(struct mount *mount) {
    __lock(&mounts_lock, "project/ish/fs/mount.c", 48);
    mount->refcount--;
    unlock(&mounts_lock);
}
...
int do_mount(const struct fs_ops *fs, const char *source, const char *point, const char *info, int flags) {
    ...
    if (new_mount == 
# 55 "project/ish/fs/mount.c" 3 4
                    ((void *)0)
# 55 "project/ish/fs/mount.c"
                        )
        return -12;
    ...
    new_mount->fs = fs;
    new_mount->data = 
# 62 "project/ish/fs/mount.c" 3 4
                     ((void *)0)
# 62 "project/ish/fs/mount.c"
                         ;
    ...
    struct mount *mount;
    for (mount = ((typeof(*mount) *) ((char *) ((&mounts)->next) - 
# 76 "project/ish/fs/mount.c" 3 4
   __builtin_offsetof (
# 76 "project/ish/fs/mount.c"
   typeof(*mount)
# 76 "project/ish/fs/mount.c" 3 4
   , 
# 76 "project/ish/fs/mount.c"
...
# 100 "project/ish/fs/mount.c" 3 4
   _Bool 
# 100 "project/ish/fs/mount.c"
        found = 
# 100 "project/ish/fs/mount.c" 3 4
                0
# 100 "project/ish/fs/mount.c"
                     ;
    for (mount = ((typeof(*mount) *) ((char *) ((&mounts)->next) - 
# 101 "project/ish/fs/mount.c" 3 4
   __builtin_offsetof (
# 101 "project/ish/fs/mount.c"
   typeof(*mount)
# 101 "project/ish/fs/mount.c" 3 4
   , 
# 101 "project/ish/fs/mount.c"
...
# 101 "project/ish/fs/mount.c"
        ...
        if (strcmp(point, mount->point) == 0) {
            found = 
# 103 "project/ish/fs/mount.c" 3 4
                   1
# 103 "project/ish/fs/mount.c"
                       ;
            break;
        }
    }
...
# 113 "project/ish/fs/mount.c" 3 4
_Bool 
# 113 "project/ish/fs/mount.c"
    mount_param_flag(const char *info, const char *flag) {
    while (*info != '\0') {
        if (strncmp(info, flag, strlen(flag)) == 0)
            return 
# 116 "project/ish/fs/mount.c" 3 4
                  1
# 116 "project/ish/fs/mount.c"
                      ;
        info += strcspn(info, ",");
    }
    return 
# 119 "project/ish/fs/mount.c" 3 4
          0
# 119 "project/ish/fs/mount.c"
               ;
}
...
dword_t sys_mount(addr_t source_addr, addr_t point_addr, addr_t type_addr, dword_t flags, addr_t data_addr) {
    ...
    if (user_read_string(type_addr, type, sizeof(type)))
        return -14;
    __use(0, source, point_raw, type, flags, data_addr != 0 ? data : 
# 140 "project/ish/fs/mount.c" 3 4
   ((void *)0)
# 140 "project/ish/fs/mount.c"
   );

    if (flags & ~((1 << 0)|(1 << 1)|(1 << 2)|(1 << 3)|(1 << 15))) {
        ish_printk("FIXME " "missing mount flags %#x" "\n", flags & ~((1 << 0)|(1 << 1)|(1 << 2)|(1 << 3)|(1 << 15)));
        return -22;
    }

    const struct fs_ops *fs = 
# 147 "project/ish/fs/mount.c" 3 4
                             ((void *)0)
# 147 "project/ish/fs/mount.c"
                                 ;
    ...
    if (fs == 
# 154 "project/ish/fs/mount.c" 3 4
             ((void *)0)
# 154 "project/ish/fs/mount.c"
                 )
        return -22;

    struct statbuf stat;
    int err = generic_statat((struct fd *) -2, point_raw, &stat, 
# 158 "project/ish/fs/mount.c" 3 4
                                                      1
# 158 "project/ish/fs/mount.c"
                                                          );
    if (err < 0)
        return err;
    if (!
# 161 "project/ish/fs/mount.c" 3 4
        (((
# 161 "project/ish/fs/mount.c"
        stat.mode
# 161 "project/ish/fs/mount.c" 3 4
        ) & 0170000) == 0040000)
# 161 "project/ish/fs/mount.c"
    ...
    char point[4096];
    err = path_normalize((struct fd *) -2, point_raw, point, 1);
    if (err < 0)
        return err;

    __lock(&mounts_lock, "project/ish/fs/mount.c", 169);
    err = do_mount(fs, source, point, data, flags & ((1 << 0)|(1 << 1)|(1 << 2)|(1 << 3)));
    unlock(&mounts_lock);
    return err;
}
...
dword_t sys_umount2(addr_t target_addr, dword_t flags) {
    ...
    if (user_read_string(target_addr, target_raw, sizeof(target_raw)))
        return -14;
    char target[4096];
    int err = path_normalize((struct fd *) -2, target_raw, target,
            flags & 8 ? 2 : 1);
    if (err < 0)
        return err;

    __lock(&mounts_lock, "project/ish/fs/mount.c", 187);
...
lock_t mounts_lock = {
# 194 "project/ish/fs/mount.c" 3 4
                    {0x32AAABA7, {0}}
# 194 "project/ish/fs/mount.c"
                    , 0};
