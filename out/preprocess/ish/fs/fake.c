# 0 "project/ish/fs/fake.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/fs/fake.c"
...
# 6 "project/ish/fs/fake.c" 2
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/file.h" 1 3 4
# 67 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/file.h" 3 4
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/appleapiopts.h" 1 3 4
# 68 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/file.h" 2 3 4
...
# 69 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/file.h" 2 3 4
...
# 71 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/file.h" 2 3 4
...
# 16 "project/ish/fs/fake.c" 2

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/fake.h" 1
# 12 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/fake.h"
struct fd *fakefs_open_inode(struct mount *mount, ino_t inode);
# 18 "project/ish/fs/fake.c" 2
...
static struct fd *fakefs_open(struct mount *mount, const char *path, int flags, int mode) {
    ...
    if (flags & (1 << 6)) {
        ...
        ishstat.mode = mode | 
# 33 "project/ish/fs/fake.c" 3 4
                             0100000
# 33 "project/ish/fs/fake.c"
                                    ;
...
step:
    ...
    struct fd *fd = realfs.open(mount, path, (1 << 1), 0);
    if ((intptr_t) (fd) == -21)
        fd = realfs.open(mount, path, 0, 0);
    if ((intptr_t) (fd) == -2)
        goto step;
    db_reset(fs, stmt);
    db_commit(fs);
...
static int fakefs_symlink(struct mount *mount, const char *target, const char *link) {
    ...
    int fd = openat(mount->root_fd, fix_path(link), 
# 136 "project/ish/fs/fake.c" 3 4
                                                   0x0001 
# 136 "project/ish/fs/fake.c"
                                                            | 
# 136 "project/ish/fs/fake.c" 3 4
                                                              0x00000200 
# 136 "project/ish/fs/fake.c"
...
# 136 "project/ish/fs/fake.c"
    ...
    if (res < 0) {
        int saved_errno = 
# 144 "project/ish/fs/fake.c" 3 4
                         (*__error())
# 144 "project/ish/fs/fake.c"
                              ;
        unlinkat(mount->root_fd, fix_path(link), 0);
        db_rollback(fs);
        
# 147 "project/ish/fs/fake.c" 3 4
       (*__error()) 
# 147 "project/ish/fs/fake.c"
             = saved_errno;
        return errno_map();
    }
    ...
    struct ish_stat ishstat;
    ishstat.mode = 
# 153 "project/ish/fs/fake.c" 3 4
                  0120000 
# 153 "project/ish/fs/fake.c"
                          | 0777;
    ishstat.uid = current->euid;
    ishstat.gid = current->egid;
    ishstat.rdev = 0;
...
static int fakefs_mknod(struct mount *mount, const char *path, mode_t_ mode, dev_t_ dev) {
    ...
    if (
# 165 "project/ish/fs/fake.c" 3 4
       (((
# 165 "project/ish/fs/fake.c"
       mode
# 165 "project/ish/fs/fake.c" 3 4
       ) & 0170000) == 0060000) 
# 165 "project/ish/fs/fake.c"
...
# 165 "project/ish/fs/fake.c"
        ...
        real_mode |= 
# 166 "project/ish/fs/fake.c" 3 4
                    0100000
# 166 "project/ish/fs/fake.c"
                           ;
    else
        real_mode |= mode & 
# 168 "project/ish/fs/fake.c" 3 4
                           0170000
# 168 "project/ish/fs/fake.c"
                                 ;
    db_begin(fs);
    ...
    stat.rdev = 0;
    if (
# 180 "project/ish/fs/fake.c" 3 4
       (((
# 180 "project/ish/fs/fake.c"
       mode
# 180 "project/ish/fs/fake.c" 3 4
       ) & 0170000) == 0060000) 
# 180 "project/ish/fs/fake.c"
...
static void fake_stat_setattr(struct ish_stat *ishstat, struct attr attr) {
    switch (attr.type) {
        ...
        case attr_gid:
            ...
            break;
        case attr_mode:
            ishstat->mode = (ishstat->mode & 
# 234 "project/ish/fs/fake.c" 3 4
                                            0170000
# 234 "project/ish/fs/fake.c"
                                                  ) | (attr.mode & ~
# 234 "project/ish/fs/fake.c" 3 4
                                                                    0170000
# 234 "project/ish/fs/fake.c"
...
static int fakefs_mkdir(struct mount *mount, const char *path, mode_t_ mode) {
    ...
    struct ish_stat ishstat;
    ishstat.mode = mode | 
# 278 "project/ish/fs/fake.c" 3 4
                         0040000
# 278 "project/ish/fs/fake.c"
                                ;
    ishstat.uid = current->euid;
    ishstat.gid = current->egid;
    ishstat.rdev = 0;
...
# 289 "project/ish/fs/fake.c" 3 4
                                                   0x0000
# 289 "project/ish/fs/fake.c"
                                                           );
    if (fd < 0)
        return errno_map();
...
static ssize_t fakefs_readlink(struct mount *mount, const char *path, char *buf, size_t bufsize) {
    ...
    db_begin(fs);
    struct ish_stat ishstat;
    if (!path_read_stat(fs, path, &ishstat, 
# 303 "project/ish/fs/fake.c" 3 4
                                           ((void *)0)
# 303 "project/ish/fs/fake.c"
                                               )) {
        db_rollback(fs);
        return -2;
    }
    if (!
# 307 "project/ish/fs/fake.c" 3 4
        (((
# 307 "project/ish/fs/fake.c"
        ishstat.mode
# 307 "project/ish/fs/fake.c" 3 4
        ) & 0170000) == 0120000)
# 307 "project/ish/fs/fake.c"
...
# 320 "project/ish/fs/fake.c" 3 4
   (__builtin_expect(!(
# 320 "project/ish/fs/fake.c"
   fd->ops == &fakefs_fdops
# 320 "project/ish/fs/fake.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/fs/fake.c", 320, 
# 320 "project/ish/fs/fake.c"
   "fd->ops == &fakefs_fdops"
# 320 "project/ish/fs/fake.c" 3 4
   ) : (void)0)
...
# 336 "project/ish/fs/fake.c" 3 4
       __builtin___strcat_chk (
# 336 "project/ish/fs/fake.c"
       entry_path
# 336 "project/ish/fs/fake.c" 3 4
       , 
# 336 "project/ish/fs/fake.c"
...
# 337 "project/ish/fs/fake.c" 3 4
       __builtin___strcat_chk (
# 337 "project/ish/fs/fake.c"
       entry_path
# 337 "project/ish/fs/fake.c" 3 4
       , 
# 337 "project/ish/fs/fake.c"
...
static int fakefs_mount(struct mount *mount) {
    char db_path[
# 358 "project/ish/fs/fake.c" 3 4
                1024
# 358 "project/ish/fs/fake.c"
                        ];
    
# 359 "project/ish/fs/fake.c" 3 4
   __builtin___strcpy_chk (
# 359 "project/ish/fs/fake.c"
   db_path
# 359 "project/ish/fs/fake.c" 3 4
   , 
# 359 "project/ish/fs/fake.c"
...
# 361 "project/ish/fs/fake.c" 3 4
   (__builtin_expect(!(
# 361 "project/ish/fs/fake.c"
   strcmp(basename, "data") == 0
# 361 "project/ish/fs/fake.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/fs/fake.c", 361, 
# 361 "project/ish/fs/fake.c"
   "strcmp(basename, \"data\") == 0"
# 361 "project/ish/fs/fake.c" 3 4
   ) : (void)0)
...
# 362 "project/ish/fs/fake.c" 3 4
   __builtin___strcpy_chk (
# 362 "project/ish/fs/fake.c"
   basename
# 362 "project/ish/fs/fake.c" 3 4
   , 
# 362 "project/ish/fs/fake.c"
...
static int fakefs_umount(struct mount *mount) {
    ...
    if (err != 
# 378 "project/ish/fs/fake.c" 3 4
              0
# 378 "project/ish/fs/fake.c"
                       ) {
        ish_printk("sqlite failed to close: %d\n", err);
    }
