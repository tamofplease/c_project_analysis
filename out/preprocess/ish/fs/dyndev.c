...
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/dev.h" 2
...
struct dyn_dev_info {
    ...
    struct dev_ops *devs[255 +1];
};

struct dyn_dev_info dyn_info_char = {
    .devs_lock = {
# 18 "project/ish/fs/dyndev.c" 3 4
                {0x32AAABA7, {0}}
# 18 "project/ish/fs/dyndev.c"
                , 0},
    .devs = {},
};
...
int dyn_dev_register(struct dev_ops *ops, int type, int major, int minor) {
    ...
    if (ops == 
# 30 "project/ish/fs/dyndev.c" 3 4
              ((void *)0)
# 30 "project/ish/fs/dyndev.c"
                  ) {
        return -22;
    }
    if (type != 1) {
    ...
    __lock(&dyn_info_char.devs_lock, "project/ish/fs/dyndev.c", 37);


    if (dyn_info_char.devs[minor] != 
# 40 "project/ish/fs/dyndev.c" 3 4
                                    ((void *)0)
# 40 "project/ish/fs/dyndev.c"
                                        ) {
...
# 52 "project/ish/fs/dyndev.c" 3 4
   (__builtin_expect(!(
# 52 "project/ish/fs/dyndev.c"
   type == 1
# 52 "project/ish/fs/dyndev.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/fs/dyndev.c", 52, 
# 52 "project/ish/fs/dyndev.c"
   "type == DEV_CHAR"
# 52 "project/ish/fs/dyndev.c" 3 4
   ) : (void)0)
...
# 53 "project/ish/fs/dyndev.c" 3 4
   (__builtin_expect(!(
# 53 "project/ish/fs/dyndev.c"
   major == 240
# 53 "project/ish/fs/dyndev.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/fs/dyndev.c", 53, 
# 53 "project/ish/fs/dyndev.c"
   "major == DYN_DEV_MAJOR"
# 53 "project/ish/fs/dyndev.c" 3 4
   ) : (void)0)
# 53 "project/ish/fs/dyndev.c"
    ...
    if (ops == 
# 56 "project/ish/fs/dyndev.c" 3 4
              ((void *)0)
# 56 "project/ish/fs/dyndev.c"
                  ) {
        return -6;
    }
    fd->ops = &ops->fd;
...
static int dyn_open_char(int major, int minor, struct fd *fd) {
    return dyn_open(1, major, minor, fd);
}
