# 0 "project/ish/fs/dir.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/fs/dir.c"
...
size_t fill_dirent_32(void *dirent_data, ino_t inode, off_t_ offset, const char *name, int type) {
    ...
    dirent->reclen = 
# 41 "project/ish/fs/dir.c" 3 4
                    __builtin_offsetof (
# 41 "project/ish/fs/dir.c"
                    struct linux_dirent_
# 41 "project/ish/fs/dir.c" 3 4
                    , 
# 41 "project/ish/fs/dir.c"
...
# 43 "project/ish/fs/dir.c" 3 4
   __builtin___strcpy_chk (
# 43 "project/ish/fs/dir.c"
   dirent->name
# 43 "project/ish/fs/dir.c" 3 4
   , 
# 43 "project/ish/fs/dir.c"
...
size_t fill_dirent_64(void *dirent_data, ino_t inode, off_t_ offset, const char *name, int type) {
    ...
    dirent->offset = offset;
    dirent->reclen = 
# 52 "project/ish/fs/dir.c" 3 4
                    __builtin_offsetof (
# 52 "project/ish/fs/dir.c"
                    struct linux_dirent64_
# 52 "project/ish/fs/dir.c" 3 4
                    , 
# 52 "project/ish/fs/dir.c"
...
# 55 "project/ish/fs/dir.c" 3 4
   __builtin___strcpy_chk (
# 55 "project/ish/fs/dir.c"
   dirent->name
# 55 "project/ish/fs/dir.c" 3 4
   , 
# 55 "project/ish/fs/dir.c"
...
int_t sys_getdents_common(fd_t f, addr_t dirents, dword_t count,
    ...
    __use(0, f, dirents, count);
    struct fd *fd = f_get(f);
    if (fd == 
# 63 "project/ish/fs/dir.c" 3 4
             ((void *)0)
# 63 "project/ish/fs/dir.c"
                 )
        return -9;
    if (!
# 65 "project/ish/fs/dir.c" 3 4
        (((
# 65 "project/ish/fs/dir.c"
        fd->type
# 65 "project/ish/fs/dir.c" 3 4
        ) & 0170000) == 0040000) 
# 65 "project/ish/fs/dir.c"
...
# 65 "project/ish/fs/dir.c"
    ...
    int printed = 0;
    while (
# 73 "project/ish/fs/dir.c" 3 4
          1
# 73 "project/ish/fs/dir.c"
              ) {
        ptr = fd_telldir(fd);
        ...
        if (printed < 20) {
            __use(0, inode, offset, name, type, reclen)
                                                      ;
            printed++;
        }
