# 0 "project/ish/fs/generic.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/fs/generic.c"
...
# 23 "project/ish/fs/generic.c" 3 4
_Bool 
# 23 "project/ish/fs/generic.c"
    contains_mount_point(const char *path) {
    struct mount *mount;
    for (mount = ((typeof(*mount) *) ((char *) ((&mounts)->next) - 
# 25 "project/ish/fs/generic.c" 3 4
   __builtin_offsetof (
# 25 "project/ish/fs/generic.c"
   typeof(*mount)
# 25 "project/ish/fs/generic.c" 3 4
   , 
# 25 "project/ish/fs/generic.c"
...
# 25 "project/ish/fs/generic.c"
        ...
        if (strncmp(path, mount->point, n) == 0 &&
            ...
            return 
# 29 "project/ish/fs/generic.c" 3 4
                  1
# 29 "project/ish/fs/generic.c"
                      ;
    }
    return 
# 31 "project/ish/fs/generic.c" 3 4
          0
# 31 "project/ish/fs/generic.c"
               ;
}
...
struct fd *generic_openat(struct fd *at, const char *path_raw, int flags, int mode) {
    ...
    __lock(&inodes_lock, "project/ish/fs/generic.c", 45);
    ...
    unlock(&inodes_lock);
    fd->type = stat.mode & 
# 64 "project/ish/fs/generic.c" 3 4
                          0170000
# 64 "project/ish/fs/generic.c"
                                ;
    fd->flags = flags;
...
# 75 "project/ish/fs/generic.c" 3 4
   (__builtin_expect(!(
# 75 "project/ish/fs/generic.c"
   !
# 75 "project/ish/fs/generic.c" 3 4
   (((
# 75 "project/ish/fs/generic.c"
   fd->type
# 75 "project/ish/fs/generic.c" 3 4
   ) & 0170000) == 0120000)), 0) ? __assert_rtn(__func__, "project/ish/fs/generic.c", 75, 
# 75 "project/ish/fs/generic.c"
   "!S_ISLNK(fd->type)"
# 75 "project/ish/fs/generic.c" 3 4
   ) : (void)0)
# 75 "project/ish/fs/generic.c"
                             ;
    if (
# 76 "project/ish/fs/generic.c" 3 4
       (((
# 76 "project/ish/fs/generic.c"
       fd->type
# 76 "project/ish/fs/generic.c" 3 4
       ) & 0170000) == 0060000) 
# 76 "project/ish/fs/generic.c"
...
# 76 "project/ish/fs/generic.c"
        ...
        int type;
        if (
# 78 "project/ish/fs/generic.c" 3 4
           (((
# 78 "project/ish/fs/generic.c"
           fd->type
# 78 "project/ish/fs/generic.c" 3 4
           ) & 0170000) == 0060000)
# 78 "project/ish/fs/generic.c"
    ...
    err = -6;
    if (
# 87 "project/ish/fs/generic.c" 3 4
       (((
# 87 "project/ish/fs/generic.c"
       fd->type
# 87 "project/ish/fs/generic.c" 3 4
       ) & 0170000) == 0140000)
# 87 "project/ish/fs/generic.c"
    ...
    err = -21;
    if (
# 90 "project/ish/fs/generic.c" 3 4
       (((
# 90 "project/ish/fs/generic.c"
       fd->type
# 90 "project/ish/fs/generic.c" 3 4
       ) & 0170000) == 0040000) 
# 90 "project/ish/fs/generic.c"
    ...
    err = -20;
    if (!
# 93 "project/ish/fs/generic.c" 3 4
        (((
# 93 "project/ish/fs/generic.c"
        fd->type
# 93 "project/ish/fs/generic.c" 3 4
        ) & 0170000) == 0040000) 
# 93 "project/ish/fs/generic.c"
...
# 112 "project/ish/fs/generic.c" 3 4
   __builtin___memmove_chk (
# 112 "project/ish/fs/generic.c"
   buf + strlen(fd->mount->point)
# 112 "project/ish/fs/generic.c" 3 4
   , 
# 112 "project/ish/fs/generic.c"
   buf, strlen(buf) + 1
...
# 113 "project/ish/fs/generic.c" 3 4
   __builtin___memcpy_chk (
# 113 "project/ish/fs/generic.c"
   buf
# 113 "project/ish/fs/generic.c" 3 4
   , 
# 113 "project/ish/fs/generic.c"
   fd->mount->point, strlen(fd->mount->point)
# 113 "project/ish/fs/generic.c" 3 4
   , __builtin_object_size (
# 113 "project/ish/fs/generic.c"
   buf
...
# 115 "project/ish/fs/generic.c" 3 4
       __builtin___strcpy_chk (
# 115 "project/ish/fs/generic.c"
       buf
# 115 "project/ish/fs/generic.c" 3 4
       , 
# 115 "project/ish/fs/generic.c"
...
# 147 "project/ish/fs/generic.c" 3 4
                               ((void *)0)
# 147 "project/ish/fs/generic.c"
                                   )
        err = -1;
    else
...
# 184 "project/ish/fs/generic.c" 3 4
                                 ((void *)0)
# 184 "project/ish/fs/generic.c"
                                     )
        err = -1;
    else
...
int generic_mknodat(struct fd *at, const char *path_raw, mode_t_ mode, dev_t_ dev) {
    if (
# 207 "project/ish/fs/generic.c" 3 4
       (((
# 207 "project/ish/fs/generic.c"
       mode
# 207 "project/ish/fs/generic.c" 3 4
       ) & 0170000) == 0040000) 
# 207 "project/ish/fs/generic.c"
...
# 207 "project/ish/fs/generic.c"
        ...
        return -22;
    if (!(current != 
# 209 "project/ish/fs/generic.c" 3 4
        ((void *)0) 
# 209 "project/ish/fs/generic.c"
        && current->euid == 0) && (
# 209 "project/ish/fs/generic.c" 3 4
                        (((
# 209 "project/ish/fs/generic.c"
...
# 224 "project/ish/fs/generic.c" 3 4
                                                                            _Bool 
# 224 "project/ish/fs/generic.c"
                                                                                 follow_links) {
    char path[4096];
...
# 237 "project/ish/fs/generic.c" 3 4
                                                                                                    _Bool 
# 237 "project/ish/fs/generic.c"
                                                                                                         follow_links) {
    char path[4096];
    int err = path_normalize(at, path_raw, path, follow_links ? 1 : 2);
    if (err < 0)
