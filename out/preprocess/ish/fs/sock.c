# 0 "project/ish/fs/sock.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/fs/sock.c"
...
# 2 "project/ish/fs/sock.c" 2
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/netinet/tcp.h" 1 3 4
# 66 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/netinet/tcp.h" 3 4
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/appleapiopts.h" 1 3 4
# 67 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/netinet/tcp.h" 2 3 4
...
# 69 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/netinet/tcp.h" 2 3 4
...
# 72 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/netinet/tcp.h" 2 3 4
...
# 19 "project/ish/fs/sock.c" 3 4
                         {0x32AAABA7, {0}}
# 19 "project/ish/fs/sock.c"
                         , 0};

static fd_t sock_fd_create(int sock_fd, int domain, int type, int protocol) {
    struct fd *fd = adhoc_fd_create(&socket_fdops);
    if (fd == 
# 23 "project/ish/fs/sock.c" 3 4
             ((void *)0)
# 23 "project/ish/fs/sock.c"
                 )
        return -12;
    fd->stat.mode = 
# 25 "project/ish/fs/sock.c" 3 4
                   0140000 
# 25 "project/ish/fs/sock.c"
                            | 0666;
    fd->real_fd = sock_fd;
...
int_t sys_socket(dword_t domain, dword_t type, dword_t protocol) {
    ...
    if (type == 3 && protocol == 
# 47 "project/ish/fs/sock.c" 3 4
                                        255
# 47 "project/ish/fs/sock.c"
                                                   )
        protocol = 
# 48 "project/ish/fs/sock.c" 3 4
                  1
# 48 "project/ish/fs/sock.c"
                              ;
    ...
    if (domain == 2 && type == 2) {
        ...
        int one = 1;
        setsockopt(sock, 
# 59 "project/ish/fs/sock.c" 3 4
                        0
# 59 "project/ish/fs/sock.c"
                                  , 
# 59 "project/ish/fs/sock.c" 3 4
                                    23
# 59 "project/ish/fs/sock.c"
...
static void inode_release_if_exist(struct inode_data *inode) {
    if (inode != 
# 70 "project/ish/fs/sock.c" 3 4
                ((void *)0)
# 70 "project/ish/fs/sock.c"
                    )
        inode_release(inode);
}
...
static struct fd *sock_getfd(fd_t sock_fd) {
    ...
    if (sock == 
# 76 "project/ish/fs/sock.c" 3 4
               ((void *)0) 
# 76 "project/ish/fs/sock.c"
                    || sock->ops != &socket_fdops)
        return 
# 77 "project/ish/fs/sock.c" 3 4
              ((void *)0)
# 77 "project/ish/fs/sock.c"
                  ;
    return sock;
}
...
# 83 "project/ish/fs/sock.c" 3 4
                                {0x32AAABA7, {0}}
# 83 "project/ish/fs/sock.c"
                                , 0};
    __lock(&next_id_lock, "project/ish/fs/sock.c", 84);
    uint32_t id = ++next_id;
    unlock(&next_id_lock);
    return id;
}
...
static int unix_socket_get(const char *path_raw, struct fd *bind_fd, uint32_t *socket_id) {
    ...
    if (bind_fd != 
# 100 "project/ish/fs/sock.c" 3 4
                  ((void *)0)
# 100 "project/ish/fs/sock.c"
                      ) {
        ...
        if (err < 0) {
            ...
            __lock(&fs->lock, "project/ish/fs/sock.c", 110);
            mode &= ~fs->umask;
            unlock(&fs->lock);
            err = mount->fs->mknod(mount, path, 
# 113 "project/ish/fs/sock.c" 3 4
                                               0140000 
# 113 "project/ish/fs/sock.c"
                                                        | mode, 0);
            if (err < 0)
                goto out;
            err = mount->fs->stat(mount, path, &stat);
    ...
    if (bind_fd == 
# 124 "project/ish/fs/sock.c" 3 4
                  ((void *)0) 
# 124 "project/ish/fs/sock.c"
                       && err < 0)
        goto out;

    if (!
# 127 "project/ish/fs/sock.c" 3 4
        (((
# 127 "project/ish/fs/sock.c"
        stat.mode
# 127 "project/ish/fs/sock.c" 3 4
        ) & 0170000) == 0140000)
# 127 "project/ish/fs/sock.c"
    ...
    __lock(&inode->lock, "project/ish/fs/sock.c", 134);
    ...
    *socket_id = inode->socket_id;
    ...
    mount_release(mount);
    if (bind_fd != 
# 141 "project/ish/fs/sock.c" 3 4
                  ((void *)0)
# 141 "project/ish/fs/sock.c"
                      )
...
# 183 "project/ish/fs/sock.c"
    ...
    if (bind_fd != 
# 190 "project/ish/fs/sock.c" 3 4
                  ((void *)0) 
# 190 "project/ish/fs/sock.c"
                       && sock != 
# 190 "project/ish/fs/sock.c" 3 4
                                  ((void *)0)
# 190 "project/ish/fs/sock.c"
    ...
    if (bind_fd == 
# 194 "project/ish/fs/sock.c" 3 4
                  ((void *)0) 
# 194 "project/ish/fs/sock.c"
                       && sock == 
# 194 "project/ish/fs/sock.c" 3 4
                                  ((void *)0)
# 194 "project/ish/fs/sock.c"
    ...
    if (sock == 
# 199 "project/ish/fs/sock.c" 3 4
               ((void *)0)
# 199 "project/ish/fs/sock.c"
                   ) {
    ...
    *socket_id = sock->socket_id;
    if (bind_fd != 
# 210 "project/ish/fs/sock.c" 3 4
                  ((void *)0)
# 210 "project/ish/fs/sock.c"
                      )
...
static void unix_abstract_release(struct unix_abstract *name) {
    __lock(&unix_abstract_lock, "project/ish/fs/sock.c", 216);
    if (--name->refcount == 0) {
...
static int sockaddr_read_bind(addr_t sockaddr_addr, void *sockaddr, uint_t *sockaddr_len, struct fd *bind_fd) {
    ...
    switch (real_addr->sa_family) {
        case 
# 240 "project/ish/fs/sock.c" 3 4
            2
# 240 "project/ish/fs/sock.c"
                   :
            if (*sockaddr_len < sizeof(struct sockaddr_in))
                return -22;
            break;
        case 
# 244 "project/ish/fs/sock.c" 3 4
            30
# 244 "project/ish/fs/sock.c"
                    :
        ...
        case 
# 249 "project/ish/fs/sock.c" 3 4
            1
# 249 "project/ish/fs/sock.c"
                    : {

            char path[108 + 1];
            size_t path_size = *sockaddr_len - 
# 252 "project/ish/fs/sock.c" 3 4
                                              __builtin_offsetof (
# 252 "project/ish/fs/sock.c"
                                              struct sockaddr_
# 252 "project/ish/fs/sock.c" 3 4
                                              , 
# 252 "project/ish/fs/sock.c"
...
# 253 "project/ish/fs/sock.c" 3 4
           __builtin___memcpy_chk (
# 253 "project/ish/fs/sock.c"
           path
# 253 "project/ish/fs/sock.c" 3 4
           , 
# 253 "project/ish/fs/sock.c"
           fake_addr->data, path_size
# 253 "project/ish/fs/sock.c" 3 4
...
# 253 "project/ish/fs/sock.c"
            ...
            if (err < 0)
                return err;
            if (bind_fd != 
# 269 "project/ish/fs/sock.c" 3 4
                          ((void *)0)
# 269 "project/ish/fs/sock.c"
                              ) {
                bind_fd->socket.unix_name_len = path_size;
                
# 271 "project/ish/fs/sock.c" 3 4
               __builtin___memcpy_chk (
# 271 "project/ish/fs/sock.c"
               bind_fd->socket.unix_name
# 271 "project/ish/fs/sock.c" 3 4
               , 
# 271 "project/ish/fs/sock.c"
               path, path_size
...
# 271 "project/ish/fs/sock.c"
            ...
            size_t path_len = 
# 275 "project/ish/fs/sock.c" 3 4
                             __builtin___sprintf_chk (
# 275 "project/ish/fs/sock.c"
                             real_addr_un->sun_path
# 275 "project/ish/fs/sock.c" 3 4
...
# 275 "project/ish/fs/sock.c"
            ...
            if (bind_fd != 
# 280 "project/ish/fs/sock.c" 3 4
                          ((void *)0)
# 280 "project/ish/fs/sock.c"
                              )
                unlink(real_addr_un->sun_path);
            *sockaddr_len = 
# 282 "project/ish/fs/sock.c" 3 4
                           __builtin_offsetof (
# 282 "project/ish/fs/sock.c"
                           struct sockaddr_un
# 282 "project/ish/fs/sock.c" 3 4
                           , 
# 282 "project/ish/fs/sock.c"
...
static int sockaddr_read(addr_t sockaddr_addr, void *sockaddr, uint_t *sockaddr_len) {
    struct inode_data *inode = 
# 292 "project/ish/fs/sock.c" 3 4
                              ((void *)0)
# 292 "project/ish/fs/sock.c"
                                  ;
    int err = sockaddr_read_bind(sockaddr_addr, sockaddr, sockaddr_len, 
# 293 "project/ish/fs/sock.c" 3 4
                                                                       ((void *)0)
# 293 "project/ish/fs/sock.c"
                                                                           );
...
int_t sys_bind(fd_t sock_fd, addr_t sockaddr_addr, uint_t sockaddr_len) {
    ...
    if (sock == 
# 331 "project/ish/fs/sock.c" 3 4
               ((void *)0)
# 331 "project/ish/fs/sock.c"
                   )
        return -9;
    struct sockaddr_max_ sockaddr;
    struct inode_data *inode = 
# 334 "project/ish/fs/sock.c" 3 4
                              ((void *)0)
# 334 "project/ish/fs/sock.c"
                                  ;
...
# 342 "project/ish/fs/sock.c" 3 4
                                              ((void *)0)
# 342 "project/ish/fs/sock.c"
                                                  )
...
int_t sys_connect(fd_t sock_fd, addr_t sockaddr_addr, uint_t sockaddr_len) {
    ...
    struct fd *sock = sock_getfd(sock_fd);
    if (sock == 
# 359 "project/ish/fs/sock.c" 3 4
               ((void *)0)
# 359 "project/ish/fs/sock.c"
                   )
        return -9;
    struct sockaddr_max_ sockaddr;
...
# 372 "project/ish/fs/sock.c" 3 4
       (__builtin_expect(!(
# 372 "project/ish/fs/sock.c"
       sock->socket.unix_peer == 
# 372 "project/ish/fs/sock.c" 3 4
       ((void *)0)), 0) ? __assert_rtn(__func__, "project/ish/fs/sock.c", 372, 
# 372 "project/ish/fs/sock.c"
...
# 372 "project/ish/fs/sock.c"
        ...
        if (res == sizeof(struct fd *)) {
            ...
            __lock(&peer_lock, "project/ish/fs/sock.c", 377);
            while (sock->socket.unix_peer == 
# 378 "project/ish/fs/sock.c" 3 4
                                            ((void *)0)
# 378 "project/ish/fs/sock.c"
                                                )
                wait_for_ignore_signals(&sock->socket.unix_got_peer, &peer_lock, 
# 379 "project/ish/fs/sock.c" 3 4
                                                                                ((void *)0)
# 379 "project/ish/fs/sock.c"
                                                                                    );
            unlock(&peer_lock);
        }
    }
...
int_t sys_listen(fd_t sock_fd, int_t backlog) {
    ...
    struct fd *sock = sock_getfd(sock_fd);
    if (sock == 
# 390 "project/ish/fs/sock.c" 3 4
               ((void *)0)
# 390 "project/ish/fs/sock.c"
                   )
        return -9;
...
int_t sys_accept(fd_t sock_fd, addr_t sockaddr_addr, addr_t sockaddr_len_addr) {
    ...
    struct fd *sock = sock_getfd(sock_fd);
    if (sock == 
# 402 "project/ish/fs/sock.c" 3 4
               ((void *)0)
# 402 "project/ish/fs/sock.c"
                   )
        return -9;
...
# 414 "project/ish/fs/sock.c" 3 4
       (*__error()) 
# 414 "project/ish/fs/sock.c"
             = 0;
        client = accept(sock->real_fd,
                sockaddr_addr != 0 ? (void *) sockaddr : 
# 416 "project/ish/fs/sock.c" 3 4
                                                        ((void *)0)
# 416 "project/ish/fs/sock.c"
                                                            ,
                sockaddr_addr != 0 ? &sockaddr_len : 
# 417 "project/ish/fs/sock.c" 3 4
                                                    ((void *)0)
# 417 "project/ish/fs/sock.c"
                                                        );
        sockrestart_end_listen_wait(sock);
    } while (sockrestart_should_restart_listen_wait() && 
# 419 "project/ish/fs/sock.c" 3 4
                                                        (*__error()) 
# 419 "project/ish/fs/sock.c"
                                                              == 
# 419 "project/ish/fs/sock.c" 3 4
                                                                 4
# 419 "project/ish/fs/sock.c"
    ...
    if (sock->socket.domain == 1) {
        __lock(&peer_lock, "project/ish/fs/sock.c", 437);
...
# 457 "project/ish/fs/sock.c" 3 4
                                     __builtin_offsetof (
# 457 "project/ish/fs/sock.c"
                                     struct sockaddr_
# 457 "project/ish/fs/sock.c" 3 4
                                     , 
# 457 "project/ish/fs/sock.c"
...
# 461 "project/ish/fs/sock.c" 3 4
   __builtin___memset_chk (
# 461 "project/ish/fs/sock.c"
   fake_addr->data
# 461 "project/ish/fs/sock.c" 3 4
   , 
# 461 "project/ish/fs/sock.c"
...
# 462 "project/ish/fs/sock.c" 3 4
   __builtin___memcpy_chk (
# 462 "project/ish/fs/sock.c"
   fake_addr->data
# 462 "project/ish/fs/sock.c" 3 4
   , 
# 462 "project/ish/fs/sock.c"
...
# 462 "project/ish/fs/sock.c"
                                                            ;
    *sockaddr_len = 
# 463 "project/ish/fs/sock.c" 3 4
                   __builtin_offsetof (
# 463 "project/ish/fs/sock.c"
                   struct sockaddr_
# 463 "project/ish/fs/sock.c" 3 4
                   , 
# 463 "project/ish/fs/sock.c"
...
int_t sys_getsockname(fd_t sock_fd, addr_t sockaddr_addr, addr_t sockaddr_len_addr) {
    ...
    struct fd *sock = sock_getfd(sock_fd);
    if (sock == 
# 469 "project/ish/fs/sock.c" 3 4
               ((void *)0)
# 469 "project/ish/fs/sock.c"
                   )
        return -9;
...
int_t sys_getpeername(fd_t sock_fd, addr_t sockaddr_addr, addr_t sockaddr_len_addr) {
    ...
    struct fd *sock = sock_getfd(sock_fd);
    if (sock == 
# 501 "project/ish/fs/sock.c" 3 4
               ((void *)0)
# 501 "project/ish/fs/sock.c"
                   )
        return -9;
    dword_t sockaddr_len;
    if (user_read(sockaddr_len_addr, &(sockaddr_len), sizeof(sockaddr_len)))
...
int_t sys_socketpair(dword_t domain, dword_t type, dword_t protocol, addr_t sockets_addr) {
    ...
    __lock(&peer_lock, "project/ish/fs/sock.c", 537);
    int fake_sockets[2];
...
int_t sys_sendto(fd_t sock_fd, addr_t buffer_addr, dword_t len, dword_t flags, addr_t sockaddr_addr, dword_t sockaddr_len) {
    struct fd *sock = sock_getfd(sock_fd);
    if (sock == 
# 574 "project/ish/fs/sock.c" 3 4
               ((void *)0)
# 574 "project/ish/fs/sock.c"
                   )
        return -9;
...
# 593 "project/ish/fs/sock.c" 3 4
                                                ((void *)0)
# 593 "project/ish/fs/sock.c"
                                                    , sockaddr_len);
    free(buffer);
    if (res < 0)
        return errno_map();
...
int_t sys_recvfrom(fd_t sock_fd, addr_t buffer_addr, dword_t len, dword_t flags, addr_t sockaddr_addr, addr_t sockaddr_len_addr) {
    ...
    struct fd *sock = sock_getfd(sock_fd);
    if (sock == 
# 607 "project/ish/fs/sock.c" 3 4
               ((void *)0)
# 607 "project/ish/fs/sock.c"
                   )
        return -9;
    int real_flags = sock_flags_to_real(flags);
    if (real_flags < 0)
    ...
    ssize_t res = recvfrom(sock->real_fd, buffer, len, real_flags,
            sockaddr_addr != 0 ? (void *) sockaddr : 
# 620 "project/ish/fs/sock.c" 3 4
                                                    ((void *)0)
# 620 "project/ish/fs/sock.c"
                                                        ,
            sockaddr_len_addr != 0 ? &sockaddr_len : 
# 621 "project/ish/fs/sock.c" 3 4
                                                    ((void *)0)
# 621 "project/ish/fs/sock.c"
                                                        );
    if (res < 0) {
        free(buffer);
        return errno_map();
...
int_t sys_shutdown(fd_t sock_fd, dword_t how) {
    ...
    struct fd *sock = sock_getfd(sock_fd);
    if (sock == 
# 654 "project/ish/fs/sock.c" 3 4
               ((void *)0)
# 654 "project/ish/fs/sock.c"
                   )
        return -9;
...
int_t sys_setsockopt(fd_t sock_fd, dword_t level, dword_t option, addr_t value_addr, dword_t value_len) {
    ...
    struct fd *sock = sock_getfd(sock_fd);
    if (sock == 
# 667 "project/ish/fs/sock.c" 3 4
               ((void *)0)
# 667 "project/ish/fs/sock.c"
                   )
        return -9;
    ...
    if (level == 
# 674 "project/ish/fs/sock.c" 3 4
                58 
# 674 "project/ish/fs/sock.c"
                               && option == 1)
        return 0;

    if (level == 
# 677 "project/ish/fs/sock.c" 3 4
                0 
# 677 "project/ish/fs/sock.c"
                           && option == 10)
        return 0;


    if (level == 
# 681 "project/ish/fs/sock.c" 3 4
                6 
# 681 "project/ish/fs/sock.c"
                            && option == 13) {
        if (strncmp(value, "cubic", sizeof(value)) == 0)
            return 0;
        return -2;
    }
...
int_t sys_getsockopt(fd_t sock_fd, dword_t level, dword_t option, addr_t value_addr, dword_t len_addr) {
    ...
    struct fd *sock = sock_getfd(sock_fd);
    if (sock == 
# 709 "project/ish/fs/sock.c" 3 4
               ((void *)0)
# 709 "project/ish/fs/sock.c"
                   )
        return -9;
    dword_t value_len;
    ...
    if (level == 1 && (option == 39 || option == 3 || option == 38)) {
        ...
        if (value_len != sizeof(*cred))
            return -22;
        __lock(&peer_lock, "project/ish/fs/sock.c", 732);
        if (sock->socket.domain != 1 || sock->socket.unix_peer == 
# 733 "project/ish/fs/sock.c" 3 4
                                                                         ((void *)0)
# 733 "project/ish/fs/sock.c"
                                                                             ) {
            cred->pid = 0;
            cred->uid = cred->gid = -1;
        } else {
...
# 745 "project/ish/fs/sock.c" 3 4
                                           0xffff
# 745 "project/ish/fs/sock.c"
                                                     , 
# 745 "project/ish/fs/sock.c" 3 4
                                                       0x1007
# 745 "project/ish/fs/sock.c"
...
# 749 "project/ish/fs/sock.c" 3 4
                       6 
# 749 "project/ish/fs/sock.c"
                                   && option == 13) {
        value_len = strlen("cubic");
        
# 751 "project/ish/fs/sock.c" 3 4
       __builtin___memcpy_chk (
# 751 "project/ish/fs/sock.c"
       value
# 751 "project/ish/fs/sock.c" 3 4
       , 
# 751 "project/ish/fs/sock.c"
...
# 753 "project/ish/fs/sock.c" 3 4
                       6 
# 753 "project/ish/fs/sock.c"
                                   && option == 11) {
        ...
        int err = getsockopt(sock->real_fd, 
# 759 "project/ish/fs/sock.c" 3 4
                                           6
# 759 "project/ish/fs/sock.c"
                                                      , 
# 759 "project/ish/fs/sock.c" 3 4
                                                        0x106
# 759 "project/ish/fs/sock.c"
                                                                           , &conn_info, &conn_info_size);
        if (err < 0)
            return errno_map();
...
# 797 "project/ish/fs/sock.c" 3 4
       __builtin___memcpy_chk (
# 797 "project/ish/fs/sock.c"
       value
# 797 "project/ish/fs/sock.c" 3 4
       , 
# 797 "project/ish/fs/sock.c"
...
int_t sys_sendmsg(fd_t sock_fd, addr_t msghdr_addr, int_t flags) {
    ...
    struct fd *sock = sock_getfd(sock_fd);
    if (sock == 
# 829 "project/ish/fs/sock.c" 3 4
               ((void *)0)
# 829 "project/ish/fs/sock.c"
                   )
        return -9;
    ...
    if (msg_fake.msg_name != 0) {
        ...
        msg.msg_name = 
# 846 "project/ish/fs/sock.c" 3 4
                      ((void *)0)
# 846 "project/ish/fs/sock.c"
                          ;
    }
...
# 854 "project/ish/fs/sock.c" 3 4
   __builtin___memset_chk (
# 854 "project/ish/fs/sock.c"
   msg_iov
# 854 "project/ish/fs/sock.c" 3 4
   , 
# 854 "project/ish/fs/sock.c"
...
# 854 "project/ish/fs/sock.c"
    ...
    uint8_t *msg_control = 
# 867 "project/ish/fs/sock.c" 3 4
                          ((void *)0)
# 867 "project/ish/fs/sock.c"
                              ;
    ...
    msg.msg_control = 
# 878 "project/ish/fs/sock.c" 3 4
                     ((void *)0)
# 878 "project/ish/fs/sock.c"
                         ;
    msg.msg_controllen = 0;

    struct scm *scm = 
# 881 "project/ish/fs/sock.c" 3 4
                     ((void *)0)
# 881 "project/ish/fs/sock.c"
                         ;
    char real_msg_control[
# 882 "project/ish/fs/sock.c" 3 4
...
# 883 "project/ish/fs/sock.c" 3 4
                                                          ((void *)0) 
# 883 "project/ish/fs/sock.c"
...
# 888 "project/ish/fs/sock.c" 3 4
                                                 ((void *)0)
# 888 "project/ish/fs/sock.c"
...
# 888 "project/ish/fs/sock.c"
        ...
        if (num_fds > 0) {
            ...
            if (real_fd == -1) {
                real_fd = open(".", 
# 902 "project/ish/fs/sock.c" 3 4
                                   0x0000
# 902 "project/ish/fs/sock.c"
                                           );
                if (real_fd < 0)
                    { perror("no"); abort(); };
            }
...
# 908 "project/ish/fs/sock.c" 3 4
                                       ((
# 908 "project/ish/fs/sock.c"
                                       &msg
# 908 "project/ish/fs/sock.c" 3 4
...
# 909 "project/ish/fs/sock.c" 3 4
                                   0xffff
# 909 "project/ish/fs/sock.c"
                                             ;
            real_cmsg->cmsg_type = 
# 910 "project/ish/fs/sock.c" 3 4
                                  0x01
# 910 "project/ish/fs/sock.c"
                                            ;
            real_cmsg->cmsg_len = 
# 911 "project/ish/fs/sock.c" 3 4
                                 (((__darwin_size_t)((__darwin_size_t)(sizeof(struct cmsghdr)) + (sizeof(__uint32_t) - 1)) &~ (sizeof(__uint32_t) - 1)) + (
# 911 "project/ish/fs/sock.c"
                                 sizeof(real_fd)
# 911 "project/ish/fs/sock.c" 3 4
                                 ))
# 911 "project/ish/fs/sock.c"
...
# 912 "project/ish/fs/sock.c" 3 4
           __builtin___memcpy_chk (((unsigned char *)(
# 912 "project/ish/fs/sock.c"
           real_cmsg
# 912 "project/ish/fs/sock.c" 3 4
           ) + ((__darwin_size_t)((__darwin_size_t)(sizeof(struct cmsghdr)) + (sizeof(__uint32_t) - 1)) &~ (sizeof(__uint32_t) - 1))), 
# 912 "project/ish/fs/sock.c"
...
# 912 "project/ish/fs/sock.c"
            ...
            unsigned fd_i = 0;
            for (cmsg = (void *) msg_control; cmsg != 
# 918 "project/ish/fs/sock.c" 3 4
                                                     ((void *)0)
# 918 "project/ish/fs/sock.c"
                                                         ; cmsg = ((cmsg)->len < sizeof (struct cmsghdr_) || (((cmsg)->len + sizeof(dword_t) - 1) & ~(dword_t)(sizeof(dword_t) - 1)) + sizeof(struct cmsghdr_) >= (size_t) (mhdr_end - (uint8_t *)(cmsg)) ? 
# 918 "project/ish/fs/sock.c" 3 4
                                                                  ((void *)0) 
# 918 "project/ish/fs/sock.c"
            ...
            __lock(&peer_lock, "project/ish/fs/sock.c", 927);
            struct fd *peer = sock->socket.unix_peer;
            if (peer == 
# 929 "project/ish/fs/sock.c" 3 4
                       ((void *)0)
# 929 "project/ish/fs/sock.c"
                           ) {
                unlock(&peer_lock);
                err = -32;
                goto out_free_scm;
            }
            __lock(&peer->lock, "project/ish/fs/sock.c", 934);
...
out_free_scm:
    if (scm != 
# 957 "project/ish/fs/sock.c" 3 4
              ((void *)0)
# 957 "project/ish/fs/sock.c"
                  ) {
        __lock(&peer_lock, "project/ish/fs/sock.c", 958);
        struct fd *peer = sock->socket.unix_peer;
        if (peer != 
# 960 "project/ish/fs/sock.c" 3 4
                   ((void *)0)
# 960 "project/ish/fs/sock.c"
                       ) {
            __lock(&peer->lock, "project/ish/fs/sock.c", 961);
...
int_t sys_recvmsg(fd_t sock_fd, addr_t msghdr_addr, int_t flags) {
    ...
    struct fd *sock = sock_getfd(sock_fd);
    if (sock == 
# 977 "project/ish/fs/sock.c" 3 4
               ((void *)0)
# 977 "project/ish/fs/sock.c"
                   )
        return -9;
    ...
    if (msg_fake.msg_name != 0) {
        ...
        msg.msg_name = 
# 991 "project/ish/fs/sock.c" 3 4
                      ((void *)0)
# 991 "project/ish/fs/sock.c"
                          ;
        msg.msg_namelen = 0;
    }

    char real_msg_control[
# 995 "project/ish/fs/sock.c" 3 4
                         (((__darwin_size_t)((__darwin_size_t)(sizeof(struct cmsghdr)) + (sizeof(__uint32_t) - 1)) &~ (sizeof(__uint32_t) - 1)) + ((__darwin_size_t)((__darwin_size_t)(
# 995 "project/ish/fs/sock.c"
                         sizeof(int)
# 995 "project/ish/fs/sock.c" 3 4
                         ) + (sizeof(__uint32_t) - 1)) &~ (sizeof(__uint32_t) - 1)))
# 995 "project/ish/fs/sock.c"
    ...
    if (msg_fake.msg_controllen != 0) {
        ...
        msg.msg_control = 
# 1001 "project/ish/fs/sock.c" 3 4
                         ((void *)0)
# 1001 "project/ish/fs/sock.c"
                             ;
        msg.msg_controllen = 0;
    }
    ...
    struct cmsghdr *cmsg = 
# 1045 "project/ish/fs/sock.c" 3 4
                          ((
# 1045 "project/ish/fs/sock.c"
                          &msg
# 1045 "project/ish/fs/sock.c" 3 4
                          )->msg_controllen >= sizeof(struct cmsghdr) ? (struct cmsghdr *)(
# 1045 "project/ish/fs/sock.c"
...
# 1046 "project/ish/fs/sock.c" 3 4
                                                   ((void *)0) 
# 1046 "project/ish/fs/sock.c"
                                                        &&
            cmsg->cmsg_level == 
# 1047 "project/ish/fs/sock.c" 3 4
                               0xffff 
# 1047 "project/ish/fs/sock.c"
                                          && cmsg->cmsg_type == 
# 1047 "project/ish/fs/sock.c" 3 4
                                                                0x01
# 1047 "project/ish/fs/sock.c"
        ...
        int dummy_fd = ((int *) 
# 1048 "project/ish/fs/sock.c" 3 4
                               ((unsigned char *)(
# 1048 "project/ish/fs/sock.c"
                               cmsg
# 1048 "project/ish/fs/sock.c" 3 4
                               ) + ((__darwin_size_t)((__darwin_size_t)(sizeof(struct cmsghdr)) + (sizeof(__uint32_t) - 1)) &~ (sizeof(__uint32_t) - 1)))
# 1048 "project/ish/fs/sock.c"
        ...
        __lock(&sock->lock, "project/ish/fs/sock.c", 1051);
        
# 1052 "project/ish/fs/sock.c" 3 4
       (__builtin_expect(!(
# 1052 "project/ish/fs/sock.c"
       !list_empty(&sock->socket.unix_scm)
# 1052 "project/ish/fs/sock.c" 3 4
       ), 0) ? __assert_rtn(__func__, "project/ish/fs/sock.c", 1052, 
# 1052 "project/ish/fs/sock.c"
       "!list_empty(&sock->socket.unix_scm)"
# 1052 "project/ish/fs/sock.c" 3 4
       ) : (void)0)
...
# 1053 "project/ish/fs/sock.c" 3 4
                         __builtin_offsetof (
# 1053 "project/ish/fs/sock.c"
                         struct scm
# 1053 "project/ish/fs/sock.c" 3 4
                         , 
# 1053 "project/ish/fs/sock.c"
...
# 1108 "project/ish/fs/sock.c" 3 4
                                          __builtin_offsetof (
# 1108 "project/ish/fs/sock.c"
                                          struct mmsghdr_
# 1108 "project/ish/fs/sock.c" 3 4
                                          , 
# 1108 "project/ish/fs/sock.c"
...
# 1137 "project/ish/fs/sock.c" 3 4
                                                        (*__error()) 
# 1137 "project/ish/fs/sock.c"
                                                              == 
# 1137 "project/ish/fs/sock.c" 3 4
                                                                 22
# 1137 "project/ish/fs/sock.c"
...
# 1159 "project/ish/fs/sock.c" 3 4
                                        ((void *)0)
# 1159 "project/ish/fs/sock.c"
                                            )
        unix_abstract_release(fd->socket.unix_name_abstract);
    __lock(&peer_lock, "project/ish/fs/sock.c", 1161);
    struct fd *peer = fd->socket.unix_peer;
    if (peer != 
# 1163 "project/ish/fs/sock.c" 3 4
               ((void *)0)
# 1163 "project/ish/fs/sock.c"
                   )
        peer->socket.unix_peer = 
# 1164 "project/ish/fs/sock.c" 3 4
                                ((void *)0)
# 1164 "project/ish/fs/sock.c"
                                    ;
    unlock(&peer_lock);
    if (fd->socket.domain == 1) {
        __lock(&fd->lock, "project/ish/fs/sock.c", 1167);
        struct scm *scm, *tmp;
        for (scm = ((typeof(*(scm)) *) ((char *) ((&fd->socket.unix_scm)->next) - 
# 1169 "project/ish/fs/sock.c" 3 4
       __builtin_offsetof (
# 1169 "project/ish/fs/sock.c"
       typeof(*(scm))
# 1169 "project/ish/fs/sock.c" 3 4
       , 
# 1169 "project/ish/fs/sock.c"
...
static struct socket_call {
    ...
    {
# 1199 "project/ish/fs/sock.c" 3 4
    ((void *)0)
# 1199 "project/ish/fs/sock.c"
        },
    ...
    {
# 1217 "project/ish/fs/sock.c" 3 4
    ((void *)0)
# 1217 "project/ish/fs/sock.c"
        },
    {
# 1218 "project/ish/fs/sock.c" 3 4
    ((void *)0)
# 1218 "project/ish/fs/sock.c"
        },
...
int_t sys_socketcall(dword_t call_num, addr_t args_addr) {
    ...
    if (call.func == 
# 1227 "project/ish/fs/sock.c" 3 4
                    ((void *)0)
# 1227 "project/ish/fs/sock.c"
                        ) {
