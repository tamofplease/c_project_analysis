# 0 "project/ish/fs/sock.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/fs/sock.h"
...
# 5 "project/ish/fs/sock.h" 2
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/netinet/in.h" 1 3 4
# 68 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/netinet/in.h" 3 4
...
# 69 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/netinet/in.h" 2 3 4
...
static inline int sock_family_to_real(int fake) {
    switch (fake) {
        case 1: return 
# 84 "project/ish/fs/sock.h" 3 4
                              1
# 84 "project/ish/fs/sock.h"
                                      ;
        case 2: return 
# 85 "project/ish/fs/sock.h" 3 4
                             2
# 85 "project/ish/fs/sock.h"
                                    ;
        case 10: return 
# 86 "project/ish/fs/sock.h" 3 4
                              30
# 86 "project/ish/fs/sock.h"
                                      ;
    }
    return -1;
}
static inline int sock_family_from_real(int fake) {
    switch (fake) {
        case 
# 92 "project/ish/fs/sock.h" 3 4
            1
# 92 "project/ish/fs/sock.h"
                    : return 1;
        case 
# 93 "project/ish/fs/sock.h" 3 4
            2
# 93 "project/ish/fs/sock.h"
                   : return 2;
        case 
# 94 "project/ish/fs/sock.h" 3 4
            30
# 94 "project/ish/fs/sock.h"
                    : return 10;
    }
    return -1;
}
...
# 108 "project/ish/fs/sock.h" 3 4
                                            6
# 108 "project/ish/fs/sock.h"
                                                       )
                return -1;
            return 
# 110 "project/ish/fs/sock.h" 3 4
                  1
# 110 "project/ish/fs/sock.h"
                             ;
        case 2:
            switch (protocol) {
                default:
                ...
                case 0:
                case 
# 116 "project/ish/fs/sock.h" 3 4
                    17
# 116 "project/ish/fs/sock.h"
                               :
                case 
# 117 "project/ish/fs/sock.h" 3 4
                    1
# 117 "project/ish/fs/sock.h"
                                :
                case 
# 118 "project/ish/fs/sock.h" 3 4
                    58
# 118 "project/ish/fs/sock.h"
                                  :
                    break;
            }
            return 
# 121 "project/ish/fs/sock.h" 3 4
                  2
# 121 "project/ish/fs/sock.h"
                            ;
        case 3:
            switch (protocol) {
                default:
                    return -1;
                case 
# 126 "project/ish/fs/sock.h" 3 4
                    255
# 126 "project/ish/fs/sock.h"
                               :
                case 
# 127 "project/ish/fs/sock.h" 3 4
                    17
# 127 "project/ish/fs/sock.h"
                               :
                case 
# 128 "project/ish/fs/sock.h" 3 4
                    1
# 128 "project/ish/fs/sock.h"
                                :
                case 
# 129 "project/ish/fs/sock.h" 3 4
                    58
# 129 "project/ish/fs/sock.h"
                                  :
                    break;
            }
            return 
# 132 "project/ish/fs/sock.h" 3 4
                  2
# 132 "project/ish/fs/sock.h"
                            ;
    }
    return -1;
}
# 145 "project/ish/fs/sock.h"
static inline int sock_flags_to_real(int fake) {
    int real = 0;
    if (fake & 0x1) real |= 
# 147 "project/ish/fs/sock.h" 3 4
                                0x1
# 147 "project/ish/fs/sock.h"
                                       ;
    if (fake & 0x2) real |= 
# 148 "project/ish/fs/sock.h" 3 4
                                 0x2
# 148 "project/ish/fs/sock.h"
                                         ;
    if (fake & 0x8) real |= 
# 149 "project/ish/fs/sock.h" 3 4
                                   0x20
# 149 "project/ish/fs/sock.h"
                                             ;
    if (fake & 0x20) real |= 
# 150 "project/ish/fs/sock.h" 3 4
                                  0x10
# 150 "project/ish/fs/sock.h"
                                           ;
    if (fake & 0x40) real |= 
# 151 "project/ish/fs/sock.h" 3 4
                                     0x80
# 151 "project/ish/fs/sock.h"
                                                 ;
    if (fake & 0x80) real |= 
# 152 "project/ish/fs/sock.h" 3 4
                                0x8
# 152 "project/ish/fs/sock.h"
                                       ;
    if (fake & 0x100) real |= 
# 153 "project/ish/fs/sock.h" 3 4
                                    0x40
# 153 "project/ish/fs/sock.h"
                                               ;
...
static inline int sock_flags_from_real(int real) {
    int fake = 0;
    if (real & 
# 160 "project/ish/fs/sock.h" 3 4
              0x1
# 160 "project/ish/fs/sock.h"
                     ) fake |= 0x1;
    if (real & 
# 161 "project/ish/fs/sock.h" 3 4
              0x2
# 161 "project/ish/fs/sock.h"
                      ) fake |= 0x2;
    if (real & 
# 162 "project/ish/fs/sock.h" 3 4
              0x20
# 162 "project/ish/fs/sock.h"
                        ) fake |= 0x8;
    if (real & 
# 163 "project/ish/fs/sock.h" 3 4
              0x10
# 163 "project/ish/fs/sock.h"
                       ) fake |= 0x20;
    if (real & 
# 164 "project/ish/fs/sock.h" 3 4
              0x80
# 164 "project/ish/fs/sock.h"
                          ) fake |= 0x40;
    if (real & 
# 165 "project/ish/fs/sock.h" 3 4
              0x8
# 165 "project/ish/fs/sock.h"
                     ) fake |= 0x80;
    if (real & 
# 166 "project/ish/fs/sock.h" 3 4
              0x40
# 166 "project/ish/fs/sock.h"
                         ) fake |= 0x100;
    if (real & ~(
# 167 "project/ish/fs/sock.h" 3 4
                0x1
# 167 "project/ish/fs/sock.h"
                       |
# 167 "project/ish/fs/sock.h" 3 4
                        0x2
# 167 "project/ish/fs/sock.h"
...
# 202 "project/ish/fs/sock.h"
static inline int sock_opt_to_real(int fake, int level) {
    switch (level) {
        case 1: switch (fake) {
            case 2: return 
# 205 "project/ish/fs/sock.h" 3 4
                                      0x0004
# 205 "project/ish/fs/sock.h"
                                                  ;
            case 3: return 
# 206 "project/ish/fs/sock.h" 3 4
                                 0x1008
# 206 "project/ish/fs/sock.h"
                                        ;
            case 4: return 
# 207 "project/ish/fs/sock.h" 3 4
                                  0x1007
# 207 "project/ish/fs/sock.h"
                                          ;
            case 6: return 
# 208 "project/ish/fs/sock.h" 3 4
                                      0x0020
# 208 "project/ish/fs/sock.h"
                                                  ;
            case 9: return 
# 209 "project/ish/fs/sock.h" 3 4
                                      0x0008
# 209 "project/ish/fs/sock.h"
                                                  ;
            case 13: return 
# 210 "project/ish/fs/sock.h" 3 4
                                   0x0080
# 210 "project/ish/fs/sock.h"
                                            ;
            case 7: return 
# 211 "project/ish/fs/sock.h" 3 4
                                   0x1001
# 211 "project/ish/fs/sock.h"
                                            ;
            case 8: return 
# 212 "project/ish/fs/sock.h" 3 4
                                   0x1002
# 212 "project/ish/fs/sock.h"
                                            ;
            case 29: return 
# 213 "project/ish/fs/sock.h" 3 4
                                      0x0400
# 213 "project/ish/fs/sock.h"
                                                  ;
        } break;
        case 
# 215 "project/ish/fs/sock.h" 3 4
            6
# 215 "project/ish/fs/sock.h"
                       : switch (fake) {
            case 1: return 
# 216 "project/ish/fs/sock.h" 3 4
                                     0x01
# 216 "project/ish/fs/sock.h"
                                                ;
            case 9: return 0;
        ...
        case 
# 223 "project/ish/fs/sock.h" 3 4
            0
# 223 "project/ish/fs/sock.h"
                      : switch (fake) {
            case 1: return 
# 224 "project/ish/fs/sock.h" 3 4
                                3
# 224 "project/ish/fs/sock.h"
                                      ;
            case 2: return 
# 225 "project/ish/fs/sock.h" 3 4
                                4
# 225 "project/ish/fs/sock.h"
                                      ;
            case 3: return 
# 226 "project/ish/fs/sock.h" 3 4
                                    2
# 226 "project/ish/fs/sock.h"
                                              ;
            case 7: return 
# 227 "project/ish/fs/sock.h" 3 4
                                    8
# 227 "project/ish/fs/sock.h"
                                              ;
            case 12: return 
# 228 "project/ish/fs/sock.h" 3 4
                                    24
# 228 "project/ish/fs/sock.h"
                                              ;
            case 13: return 
# 229 "project/ish/fs/sock.h" 3 4
                                    27
# 229 "project/ish/fs/sock.h"
                                              ;
        } break;
        case 
# 231 "project/ish/fs/sock.h" 3 4
            41
# 231 "project/ish/fs/sock.h"
                        : switch (fake) {
            case 16: return 
# 232 "project/ish/fs/sock.h" 3 4
                                           4
# 232 "project/ish/fs/sock.h"
                                                            ;
            case 67: return 
# 233 "project/ish/fs/sock.h" 3 4
                                     36
# 233 "project/ish/fs/sock.h"
                                                ;
            case 26: return 
# 234 "project/ish/fs/sock.h" 3 4
                                     27
# 234 "project/ish/fs/sock.h"
                                                ;
        } break;
    }
    return -1;
...
static inline int sock_level_to_real(int fake) {
    if (fake == 1)
        return 
# 242 "project/ish/fs/sock.h" 3 4
              0xffff
# 242 "project/ish/fs/sock.h"
                        ;
    return fake;
}
