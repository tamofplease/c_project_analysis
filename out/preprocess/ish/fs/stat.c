# 0 "project/ish/fs/stat.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/fs/stat.c"
...
# 33 "project/ish/fs/stat.c" 3 4
                                                                             _Bool 
# 33 "project/ish/fs/stat.c"
                                                                                  follow_links) {
    char path[4096];
    int err = path_normalize(at, path_raw, path, follow_links ? 1 : 2);
    if (err < 0)
        return err;
    struct mount *mount = find_mount_and_trim_path(path);
    
# 39 "project/ish/fs/stat.c" 3 4
   __builtin___memset_chk (
# 39 "project/ish/fs/stat.c"
   stat
# 39 "project/ish/fs/stat.c" 3 4
   , 
# 39 "project/ish/fs/stat.c"
...
# 52 "project/ish/fs/stat.c" 3 4
                                                                              _Bool 
# 52 "project/ish/fs/stat.c"
                                                                                   follow_links) {
    int err;
    char path[4096];
    if (user_read_string(path_addr, path, sizeof(path)))
        return -14;
    __use(0, at_f, path, statbuf_addr, follow_links);
    struct fd *at = at_fd(at_f);
    if (at == 
# 59 "project/ish/fs/stat.c" 3 4
             ((void *)0)
# 59 "project/ish/fs/stat.c"
                 )
        return -9;
    struct statbuf stat = {};
    ...
    if (user_write(statbuf_addr, &(newstat), sizeof(newstat)))
        return -14;
    return 0;
}

dword_t sys_stat64(addr_t path_addr, addr_t statbuf_addr) {
    return sys_stat_path(-100, path_addr, statbuf_addr, 
# 71 "project/ish/fs/stat.c" 3 4
                                                            1
# 71 "project/ish/fs/stat.c"
                                                                );
}

dword_t sys_lstat64(addr_t path_addr, addr_t statbuf_addr) {
    return sys_stat_path(-100, path_addr, statbuf_addr, 
# 75 "project/ish/fs/stat.c" 3 4
                                                            0
# 75 "project/ish/fs/stat.c"
                                                                 );
}

dword_t sys_fstatat64(fd_t at, addr_t path_addr, addr_t statbuf_addr, dword_t flags) {
    return sys_stat_path(at, path_addr, statbuf_addr, !(flags & 0x100));
}

dword_t sys_fstat64(fd_t fd_no, addr_t statbuf_addr) {
    __use(0, fd_no, statbuf_addr);
    struct fd *fd = f_get(fd_no);
    if (fd == 
# 85 "project/ish/fs/stat.c" 3 4
             ((void *)0)
# 85 "project/ish/fs/stat.c"
                 )
        return -9;
    struct statbuf stat = {};
