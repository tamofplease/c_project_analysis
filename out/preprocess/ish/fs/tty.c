# 0 "project/ish/fs/tty.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/fs/tty.c"
...
# 5 "project/ish/fs/tty.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/poll.h" 1
...
struct poll {
    ...
    int notify_pipe[2];
    int waiters;
# 28 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/poll.h"
...
# 69 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/poll.h"
struct poll_event {
    struct fd *fd;
    int types;
};
...
# 74 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/poll.h" 3 4
_Bool 
# 74 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/poll.h"
    poll_has_fd(struct poll *poll, struct fd *fd);
...
# 82 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/tty.h"
struct tty_driver {
...
struct tty_driver *tty_drivers[256] = {
    [4] = 
# 13 "project/ish/fs/tty.c" 3 4
                         ((void *)0)
# 13 "project/ish/fs/tty.c"
                             ,
    [128] = &pty_master,
    [136] = &pty_slave,
};
...
lock_t ttys_lock = {
# 19 "project/ish/fs/tty.c" 3 4
                  {0x32AAABA7, {0}}
# 19 "project/ish/fs/tty.c"
                  , 0};

struct tty *tty_alloc(struct tty_driver *driver, int type, int num) {
    struct tty *tty = malloc(sizeof(struct tty));
    if (tty == 
# 23 "project/ish/fs/tty.c" 3 4
              ((void *)0)
# 23 "project/ish/fs/tty.c"
                  )
        return 
# 24 "project/ish/fs/tty.c" 3 4
              ((void *)0)
# 24 "project/ish/fs/tty.c"
                  ;
    ...
    tty->num = num;
    tty->hung_up = 
# 30 "project/ish/fs/tty.c" 3 4
                  0
# 30 "project/ish/fs/tty.c"
                       ;
    tty->ever_opened = 
# 31 "project/ish/fs/tty.c" 3 4
                      0
# 31 "project/ish/fs/tty.c"
                           ;
    tty->session = 0;
    tty->fg_group = 0;
    list_init(&tty->fds);

    tty->termios.iflags = (1 << 8) | (1 << 10);
    tty->termios.oflags = (1 << 0) | (1 << 2);
    tty->termios.cflags = 0;
    tty->termios.lflags = (1 << 0) | (1 << 1) | (1 << 3) | (1 << 4) | (1 << 5) | (1 << 9) | (1 << 6) | (1 << 15);

    
# 41 "project/ish/fs/tty.c" 3 4
   __builtin___memcpy_chk (
# 41 "project/ish/fs/tty.c"
   tty->termios.cc
# 41 "project/ish/fs/tty.c" 3 4
   , 
# 41 "project/ish/fs/tty.c"
   "\003\034\177\025\004\0\1\0\021\023\032\0\022\017\027\026\0\0\0", 19
# 41 "project/ish/fs/tty.c" 3 4
...
# 42 "project/ish/fs/tty.c" 3 4
   __builtin___memset_chk (
# 42 "project/ish/fs/tty.c"
   &tty->winsize
# 42 "project/ish/fs/tty.c" 3 4
   , 
# 42 "project/ish/fs/tty.c"
   0, sizeof(tty->winsize)
# 42 "project/ish/fs/tty.c" 3 4
   , __builtin_object_size (
# 42 "project/ish/fs/tty.c"
   &tty->winsize
...
# 48 "project/ish/fs/tty.c" 3 4
   __builtin___memset_chk (
# 48 "project/ish/fs/tty.c"
   tty->buf_flag
# 48 "project/ish/fs/tty.c" 3 4
   , 0
# 48 "project/ish/fs/tty.c"
...
struct tty *tty_get(struct tty_driver *driver, int type, int num) {
    __lock(&ttys_lock, "project/ish/fs/tty.c", 56);
    struct tty *tty = driver->ttys[num];

    if (tty == 
# 59 "project/ish/fs/tty.c" 3 4
              ((void *)0) 
# 59 "project/ish/fs/tty.c"
                   || tty == (void *) 1 ) {
        tty = tty_alloc(driver, type, num);
        if (tty == 
# 61 "project/ish/fs/tty.c" 3 4
                  ((void *)0)
# 61 "project/ish/fs/tty.c"
                      ) {
            unlock(&ttys_lock);
    ...
    __lock(&tty->lock, "project/ish/fs/tty.c", 75);
    tty->refcount++;
    tty->ever_opened = 
# 77 "project/ish/fs/tty.c" 3 4
                      1
# 77 "project/ish/fs/tty.c"
                          ;
    unlock(&tty->lock);
    unlock(&ttys_lock);
    return tty;
...
static void tty_poll_wakeup(struct tty *tty, int events) {
    unlock(&tty->lock);
    struct fd *fd;
    __lock(&tty->fds_lock, "project/ish/fs/tty.c", 86);
    for (fd = ((typeof(*fd) *) ((char *) ((&tty->fds)->next) - 
# 87 "project/ish/fs/tty.c" 3 4
   __builtin_offsetof (
# 87 "project/ish/fs/tty.c"
   typeof(*fd)
# 87 "project/ish/fs/tty.c" 3 4
   , 
# 87 "project/ish/fs/tty.c"
...
# 87 "project/ish/fs/tty.c"
   )); &fd->tty_other_fds != (&tty->fds); fd = ((typeof(*fd) *) ((char *) (fd->tty_other_fds.next) - 
# 87 "project/ish/fs/tty.c" 3 4
   __builtin_offsetof (
# 87 "project/ish/fs/tty.c"
   typeof(*fd)
...
# 87 "project/ish/fs/tty.c"
    ...
    unlock(&tty->fds_lock);
    __lock(&tty->lock, "project/ish/fs/tty.c", 91);
}

void tty_release(struct tty *tty) {
    __lock(&tty->lock, "project/ish/fs/tty.c", 95);
    if (--tty->refcount == 0) {
        struct tty_driver *driver = tty->driver;
        if (driver->ops->cleanup)
            driver->ops->cleanup(tty);
        driver->ttys[tty->num] = 
# 100 "project/ish/fs/tty.c" 3 4
                                ((void *)0)
# 100 "project/ish/fs/tty.c"
                                    ;
        unlock(&tty->lock);
        ...
        struct tty *master = 
# 106 "project/ish/fs/tty.c" 3 4
                            ((void *)0)
# 106 "project/ish/fs/tty.c"
                                ;
        if (tty->driver == &pty_slave && tty->refcount == 1)
            master = tty->pty.other;
        unlock(&tty->lock);
        if (master != 
# 110 "project/ish/fs/tty.c" 3 4
                     ((void *)0)
# 110 "project/ish/fs/tty.c"
                         ) {
            __lock(&master->lock, "project/ish/fs/tty.c", 111);
            tty_poll_wakeup(master, 1 | 16);
            unlock(&master->lock);
        }
    }
}
...
static void tty_set_controlling(struct tgroup *group, struct tty *tty) {
    __lock(&group->lock, "project/ish/fs/tty.c", 120);
    if (group->tty == 
# 121 "project/ish/fs/tty.c" 3 4
                     ((void *)0)
# 121 "project/ish/fs/tty.c"
                         ) {
        tty->refcount++;
        group->tty = tty;
...
int tty_open(struct tty *tty, struct fd *fd) {
    ...
    __lock(&tty->fds_lock, "project/ish/fs/tty.c", 137);
    ...
    if (!(fd->flags & (1 << 8))) {
        ...
        __lock(&pids_lock, "project/ish/fs/tty.c", 145);
        __lock(&tty->lock, "project/ish/fs/tty.c", 146);
...
static int tty_device_open(int major, int minor, struct fd *fd) {
    ...
    if (major == 5) {
        if (minor == 0) {
            __lock(&ttys_lock, "project/ish/fs/tty.c", 160);
            __lock(&current->group->lock, "project/ish/fs/tty.c", 161);
            tty = current->group->tty;
            unlock(&current->group->lock);
            if (tty != 
# 164 "project/ish/fs/tty.c" 3 4
                      ((void *)0)
# 164 "project/ish/fs/tty.c"
                          ) {
                __lock(&tty->lock, "project/ish/fs/tty.c", 165);
                tty->refcount++;
                unlock(&tty->lock);
            }
            unlock(&ttys_lock);
            if (tty == 
# 170 "project/ish/fs/tty.c" 3 4
                      ((void *)0)
# 170 "project/ish/fs/tty.c"
                          )
                return -6;
        } else if (minor == 1) {
...
# 181 "project/ish/fs/tty.c" 3 4
       (__builtin_expect(!(
# 181 "project/ish/fs/tty.c"
       driver != 
# 181 "project/ish/fs/tty.c" 3 4
       ((void *)0)), 0) ? __assert_rtn(__func__, "project/ish/fs/tty.c", 181, 
# 181 "project/ish/fs/tty.c"
       "driver != NULL"
# 181 "project/ish/fs/tty.c" 3 4
       ) : (void)0)
# 181 "project/ish/fs/tty.c"
        ...
        if (((uintptr_t) (tty) > (uintptr_t) -0xfff))
            return (intptr_t) (tty);
    }
    ...
    if (tty->driver->ops->open) {
        ...
        if (err < 0) {
            __lock(&ttys_lock, "project/ish/fs/tty.c", 190);
            tty_release(tty);
            unlock(&ttys_lock);
            return err;
        }
...
static int tty_close(struct fd *fd) {
    if (fd->tty != 
# 201 "project/ish/fs/tty.c" 3 4
                  ((void *)0)
# 201 "project/ish/fs/tty.c"
                      ) {
        __lock(&fd->tty->fds_lock, "project/ish/fs/tty.c", 202);
        list_remove_safe(&fd->tty_other_fds);
        unlock(&fd->tty->fds_lock);
        __lock(&ttys_lock, "project/ish/fs/tty.c", 205);
        tty_release(fd->tty);
        unlock(&ttys_lock);
    }
    return 0;
...
static void tty_input_wakeup(struct tty *tty) {
    notify(&tty->produced);
    tty_poll_wakeup(tty, 1);
}

static int tty_push_char(struct tty *tty, char ch, 
# 217 "project/ish/fs/tty.c" 3 4
                                                  _Bool 
# 217 "project/ish/fs/tty.c"
                                                       flag, int blocking) {
    while (tty->bufsize >= sizeof(tty->buf)) {
        if (!blocking)
            return -11;
        if (wait_for(&tty->consumed, &tty->lock, 
# 221 "project/ish/fs/tty.c" 3 4
                                                ((void *)0)
# 221 "project/ish/fs/tty.c"
                                                    ))
            return -4;
    }
...
static void tty_echo(struct tty *tty, const char *data, size_t size) {
    tty->driver->ops->write(tty, data, size, 
# 230 "project/ish/fs/tty.c" 3 4
                                            0
# 230 "project/ish/fs/tty.c"
                                                 );
}

static 
# 233 "project/ish/fs/tty.c" 3 4
      _Bool 
# 233 "project/ish/fs/tty.c"
           tty_send_input_signal(struct tty *tty, char ch, sigset_t_ *queue) {
    if (!(tty->termios.lflags & (1 << 0)))
        return 
# 235 "project/ish/fs/tty.c" 3 4
              0
# 235 "project/ish/fs/tty.c"
                   ;
    unsigned char *cc = tty->termios.cc;
    int sig;
    if (ch == '\0')
        return 
# 239 "project/ish/fs/tty.c" 3 4
              0
# 239 "project/ish/fs/tty.c"
                   ;
    else if (ch == cc[0])
        sig = 2;
    else if (ch == cc[1])
        ...
        return 
# 247 "project/ish/fs/tty.c" 3 4
              0
# 247 "project/ish/fs/tty.c"
                   ;

    if (tty->fg_group != 0) {
        if (!(tty->termios.lflags & (1 << 7)))
            tty->bufsize = 0;
        sigset_add(queue, sig);
    }
    return 
# 254 "project/ish/fs/tty.c" 3 4
          1
# 254 "project/ish/fs/tty.c"
              ;
}

ssize_t tty_input(struct tty *tty, const char *input, size_t size, 
# 257 "project/ish/fs/tty.c" 3 4
                                                                  _Bool 
# 257 "project/ish/fs/tty.c"
                                                                       blocking) {
    int err = 0;
    size_t done_size = 0;
    sigset_t_ queue = 0;

    __lock(&tty->lock, "project/ish/fs/tty.c", 262);
...
# 276 "project/ish/fs/tty.c" 3 4
           _Bool 
# 276 "project/ish/fs/tty.c"
                echo = lflags & (1 << 3);

            if (iflags & (1 << 6) && ch == '\n')
                ch = '\r';
            else if (iflags & (1 << 8) && ch == '\r')
                ch = '\n';
            if (iflags & (1 << 7) && ch == '\r')
                continue;
            ...
            if (ch == '\0') {
                ...
                goto no_special;
            } else if (ch == cc[2] || ch == cc[3]) {


                echo = lflags & (1 << 5);
                int count = tty->bufsize;
                if (ch == cc[2] && tty->bufsize > 0) {
                    echo = lflags & (1 << 4);
                    count = 1;
                }
                if (!(lflags & (1 << 3)))
                    echo = 
# 298 "project/ish/fs/tty.c" 3 4
                          0
# 298 "project/ish/fs/tty.c"
                               ;
                for (int i = 0; i < count; i++) {
                    ...
                    if (echo) {
                        tty_echo(tty, "\b \b", 3);
                        if ((lflags & (1 << 9) && ((0 <= tty->buf[tty->bufsize] && tty->buf[tty->bufsize] < ' ') || tty->buf[tty->bufsize] == '\x7f') && !(tty->buf[tty->bufsize] == '\t' || tty->buf[tty->bufsize] == '\n' || tty->buf[tty->bufsize] == cc[8] || tty->buf[tty->bufsize] == cc[9])))
                            tty_echo(tty, "\b \b", 3);
                    }
                }
                echo = 
# 310 "project/ish/fs/tty.c" 3 4
                      0
# 310 "project/ish/fs/tty.c"
                           ;
            } else if (ch == cc[4]) {
                ch = '\0';
                goto canon_wake;
                ...
                if (echo)
                    tty_echo(tty, "\r\n", 2);
canon_wake:
                err = tty_push_char(tty, ch, 
# 319 "project/ish/fs/tty.c" 3 4
                                                    1
# 319 "project/ish/fs/tty.c"
                                                        , blocking);
                if (err < 0) {
                    done_size--;
                    break;
                ...
                echo = 
# 324 "project/ish/fs/tty.c" 3 4
                      0
# 324 "project/ish/fs/tty.c"
                           ;
...
no_special:
                    err = tty_push_char(tty, ch, 
# 329 "project/ish/fs/tty.c" 3 4
                                                        0
# 329 "project/ish/fs/tty.c"
                                                             , blocking);
                    if (err < 0) {
                        done_size--;
                        break;
            ...
            if (echo) {
                if ((lflags & (1 << 9) && ((0 <= ch && ch < ' ') || ch == '\x7f') && !(ch == '\t' || ch == '\n' || ch == cc[8] || ch == cc[9]))) {
                    tty_echo(tty, "^", 1);
                    ch ^= '\100';
                }
                tty_echo(tty, &ch, 1);
        ...
        for (size_t i = 0; i < size; i++) {
            ...
            while (tty->bufsize >= sizeof(tty->buf)) {
                ...
                if (!blocking)
                    break;
                err = wait_for(&tty->consumed, &tty->lock, 
# 354 "project/ish/fs/tty.c" 3 4
                                                          ((void *)0)
# 354 "project/ish/fs/tty.c"
                                                              );
                if (err < 0)
                    break;
            }
...
# 362 "project/ish/fs/tty.c" 3 4
           (__builtin_expect(!(
# 362 "project/ish/fs/tty.c"
           tty->bufsize < sizeof(tty->buf)
# 362 "project/ish/fs/tty.c" 3 4
           ), 0) ? __assert_rtn(__func__, "project/ish/fs/tty.c", 362, 
# 362 "project/ish/fs/tty.c"
           "tty->bufsize < sizeof(tty->buf)"
# 362 "project/ish/fs/tty.c" 3 4
           ) : (void)0)
...
# 370 "project/ish/fs/tty.c" 3 4
   (__builtin_expect(!(
# 370 "project/ish/fs/tty.c"
   tty->bufsize <= sizeof(tty->buf)
# 370 "project/ish/fs/tty.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/fs/tty.c", 370, 
# 370 "project/ish/fs/tty.c"
   "tty->bufsize <= sizeof(tty->buf)"
# 370 "project/ish/fs/tty.c" 3 4
   ) : (void)0)
...
# 387 "project/ish/fs/tty.c" 3 4
   (__builtin_expect(!(
# 387 "project/ish/fs/tty.c"
   bufsize <= tty->bufsize
# 387 "project/ish/fs/tty.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/fs/tty.c", 387, 
# 387 "project/ish/fs/tty.c"
   "bufsize <= tty->bufsize"
# 387 "project/ish/fs/tty.c" 3 4
   ) : (void)0)
...
# 388 "project/ish/fs/tty.c" 3 4
   __builtin___memcpy_chk (
# 388 "project/ish/fs/tty.c"
   buf
# 388 "project/ish/fs/tty.c" 3 4
   , 
# 388 "project/ish/fs/tty.c"
...
# 390 "project/ish/fs/tty.c" 3 4
   __builtin___memmove_chk (
# 390 "project/ish/fs/tty.c"
   tty->buf
# 390 "project/ish/fs/tty.c" 3 4
   , 
# 390 "project/ish/fs/tty.c"
   tty->buf + bufsize, tty->bufsize
# 390 "project/ish/fs/tty.c" 3 4
   , __builtin_object_size (
# 390 "project/ish/fs/tty.c"
   tty->buf
...
# 391 "project/ish/fs/tty.c" 3 4
   __builtin___memmove_chk (
# 391 "project/ish/fs/tty.c"
   tty->buf_flag
# 391 "project/ish/fs/tty.c" 3 4
   , 
# 391 "project/ish/fs/tty.c"
   tty->buf_flag + bufsize, tty->bufsize
# 391 "project/ish/fs/tty.c" 3 4
   , __builtin_object_size (
# 391 "project/ish/fs/tty.c"
   tty->buf_flag
...
# 396 "project/ish/fs/tty.c" 3 4
   _Bool 
# 396 "project/ish/fs/tty.c"
        *flag_ptr = memchr(tty->buf_flag, 
# 396 "project/ish/fs/tty.c" 3 4
                                          1
# 396 "project/ish/fs/tty.c"
                                              , tty->bufsize);
    if (flag_ptr == 
# 397 "project/ish/fs/tty.c" 3 4
                   ((void *)0)
# 397 "project/ish/fs/tty.c"
                       )
        return -1;
...
static 
# 402 "project/ish/fs/tty.c" 3 4
      _Bool 
# 402 "project/ish/fs/tty.c"
           pty_is_half_closed_master(struct tty *tty) {
    if (tty->driver != &pty_master)
        return 
# 404 "project/ish/fs/tty.c" 3 4
              0
# 404 "project/ish/fs/tty.c"
                   ;

    struct tty *slave = tty->pty.other;

    __lock(&slave->lock, "project/ish/fs/tty.c", 408);
    
# 409 "project/ish/fs/tty.c" 3 4
   _Bool 
# 409 "project/ish/fs/tty.c"
        half_closed = slave->ever_opened && slave->refcount == 1;
    unlock(&slave->lock);
    return half_closed;
}

static 
# 414 "project/ish/fs/tty.c" 3 4
      _Bool 
# 414 "project/ish/fs/tty.c"
           tty_is_current(struct tty *tty) {
    __lock(&current->group->lock, "project/ish/fs/tty.c", 415);
    
# 416 "project/ish/fs/tty.c" 3 4
   _Bool 
# 416 "project/ish/fs/tty.c"
...
static ssize_t tty_read(struct fd *fd, void *buf, size_t bufsize) {
    ...
    __lock(&pids_lock, "project/ish/fs/tty.c", 443);
    __lock(&tty->lock, "project/ish/fs/tty.c", 444);
    if (tty->hung_up) {
        unlock(&pids_lock);
        goto error;
    }
    ...
    unlock(&pids_lock);
    err = tty_signal_if_background(tty, current_pgid, 21);
    if (err < 0)
        goto error;
...
# 483 "project/ish/fs/tty.c" 3 4
                                                      ((void *)0)
# 483 "project/ish/fs/tty.c"
                                                          );
            if (err < 0)
                goto error;
        }
        ...
        dword_t min = tty->termios.cc[6];
        dword_t time = tty->termios.cc[5];
        ...
        if (time == 0)
            timeout_ptr = 
# 503 "project/ish/fs/tty.c" 3 4
                         ((void *)0)
# 503 "project/ish/fs/tty.c"
                             ;
        ...
        while (tty->bufsize < min) {
            ...
            err = wait_for(&tty->produced, &tty->lock, tty->bufsize == 0 ? 
# 513 "project/ish/fs/tty.c" 3 4
                                                                          ((void *)0) 
# 513 "project/ish/fs/tty.c"
                                                                               : timeout_ptr);
            if (err == -110)
                break;
            if (err == -4)
...
static ssize_t tty_write(struct fd *fd, const void *buf, size_t bufsize) {
    struct tty *tty = fd->tty;
    __lock(&tty->lock, "project/ish/fs/tty.c", 540);
    if (tty->hung_up) {
        unlock(&tty->lock);
        return -5;
    }
...
# 546 "project/ish/fs/tty.c" 3 4
   _Bool 
# 546 "project/ish/fs/tty.c"
        blocking = !(fd->flags & (1 << 11));
    ...
    int err = 0;
    char *postbuf = 
# 554 "project/ish/fs/tty.c" 3 4
                   ((void *)0)
# 554 "project/ish/fs/tty.c"
                       ;
...
static int tty_poll(struct fd *fd) {
    struct tty *tty = fd->tty;
    __lock(&tty->lock, "project/ish/fs/tty.c", 582);
    int types = 0;
    types |= 4;
    if (tty->hung_up) {
        types |= 1 | 4 | 8 | 16;
        ...
        types |= 1 | 16;
    } else if (tty->termios.lflags & (1 << 1)) {
...
static ssize_t tty_ioctl_size(int cmd) {
    switch (cmd) {
        case 0x5401: case 0x5402: case 0x5404: case 0x5403:
            return sizeof(struct termios_);
        case 0x5413: case 0x5414:
            return sizeof(struct winsize_);
        case 0x540f: case 0x5410:
        case 0x40045431: case 0x80045430:
        case 0x5420: case 0x80045438:
        case 0x541b:
            return sizeof(dword_t);
        case 0x540b: case 0x540e:
            return 0;
    }
    return -1;
}
...
static int tiocsctty(struct tty *tty, int force) {
    ...
    __lock(&pids_lock, "project/ish/fs/tty.c", 624);
    __lock(&tty->lock, "project/ish/fs/tty.c", 625);

    if (current->group->sid == current->pid && current->group->sid == tty->session)
        goto out;

    if (current->group->tty != 
# 630 "project/ish/fs/tty.c" 3 4
                              ((void *)0)
# 630 "project/ish/fs/tty.c"
                                  ) {
        err = -1;
        goto out;
    }
    ...
    if (tty->session) {
        if (force == 1 && (current != 
# 636 "project/ish/fs/tty.c" 3 4
                         ((void *)0) 
# 636 "project/ish/fs/tty.c"
                         && current->euid == 0)) {

            struct pid *pid = pid_get(tty->session);
            struct tgroup *tgroup;
            for (tgroup = ((typeof(*tgroup) *) ((char *) ((&pid->session)->next) - 
# 640 "project/ish/fs/tty.c" 3 4
           __builtin_offsetof (
# 640 "project/ish/fs/tty.c"
           typeof(*tgroup)
# 640 "project/ish/fs/tty.c" 3 4
           , 
# 640 "project/ish/fs/tty.c"
...
# 640 "project/ish/fs/tty.c"
           )); &tgroup->session != (&pid->session); tgroup = ((typeof(*tgroup) *) ((char *) (tgroup->session.next) - 
# 640 "project/ish/fs/tty.c" 3 4
           __builtin_offsetof (
# 640 "project/ish/fs/tty.c"
           typeof(*tgroup)
...
# 640 "project/ish/fs/tty.c"
                ...
                __lock(&tgroup->lock, "project/ish/fs/tty.c", 641);
                if (tgroup->tty == tty) {
                    tgroup->tty = 
# 643 "project/ish/fs/tty.c" 3 4
                                 ((void *)0)
# 643 "project/ish/fs/tty.c"
                                     ;
                    tty->refcount--;
                }
                unlock(&tgroup->lock);
...
static int tty_mode_ioctl(struct tty *in_tty, int cmd, void *arg) {
    ...
    if (in_tty->driver == &pty_master) {
        ...
        __lock(&tty->lock, "project/ish/fs/tty.c", 667);
    }
...
static int tty_ioctl(struct fd *fd, int cmd, void *arg) {
    int err = 0;
    struct tty *tty = fd->tty;
    __lock(&tty->lock, "project/ish/fs/tty.c", 704);
    if (tty->hung_up) {
        unlock(&tty->lock);
        if (cmd == 0x5410)
            return -25;
    ...
    switch (cmd) {
        ...
        case 0x540f:
            ...
            __use(0, tty->fg_group);
            *(dword_t *) arg = tty->fg_group; break;
        case 0x5410:

            unlock(&tty->lock);
            __lock(&pids_lock, "project/ish/fs/tty.c", 743);
            __lock(&tty->lock, "project/ish/fs/tty.c", 744);
        ...
        default:
            ...
            if (err == -25 && tty->driver->ops->ioctl)
...
void tty_set_winsize(struct tty *tty, struct winsize_ winsize) {
    tty->winsize = winsize;
    if (tty->fg_group != 0)
        send_group_signal(tty->fg_group, 28, SIGINFO_NIL);
}

void tty_hangup(struct tty *tty) {
    tty->hung_up = 
# 777 "project/ish/fs/tty.c" 3 4
                  1
# 777 "project/ish/fs/tty.c"
                      ;
    tty_poll_wakeup(tty, 1 | 4 | 8 | 16);
}
