# 0 "project/ish/tests/manual/signal.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/tests/manual/signal.c"
...
# 2 "project/ish/tests/manual/signal.c" 2
...
# 3 "project/ish/tests/manual/signal.c" 2
...
# 4 "project/ish/tests/manual/signal.c" 2
...
# 5 "project/ish/tests/manual/signal.c" 2


# 6 "project/ish/tests/manual/signal.c"
...
int main() {
    ...
    act.
# 12 "project/ish/tests/manual/signal.c" 3 4
       __sigaction_u.__sa_sigaction 
# 12 "project/ish/tests/manual/signal.c"
                    = handler;
    act.sa_flags = 
# 13 "project/ish/tests/manual/signal.c" 3 4
                  0x0040
# 13 "project/ish/tests/manual/signal.c"
                            ;
    sigaction(
# 14 "project/ish/tests/manual/signal.c" 3 4
             4
# 14 "project/ish/tests/manual/signal.c"
                   , &act, 
# 14 "project/ish/tests/manual/signal.c" 3 4
                           ((void *)0)
# 14 "project/ish/tests/manual/signal.c"
