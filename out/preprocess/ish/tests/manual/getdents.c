# 0 "project/ish/tests/manual/getdents.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 3 "project/ish/tests/manual/getdents.c" 2
...
# 4 "project/ish/tests/manual/getdents.c" 2
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/syscall.h" 1 3 4
# 5 "project/ish/tests/manual/getdents.c" 2


# 6 "project/ish/tests/manual/getdents.c"
int main() {
    int fd = open(".", 
# 7 "project/ish/tests/manual/getdents.c" 3 4
                      0x0000 
# 7 "project/ish/tests/manual/getdents.c"
                               | 
# 7 "project/ish/tests/manual/getdents.c" 3 4
                                 0x00100000
# 7 "project/ish/tests/manual/getdents.c"
    ...
    write(
# 10 "project/ish/tests/manual/getdents.c" 3 4
         1
# 10 "project/ish/tests/manual/getdents.c"
                      , buf, count);
}
