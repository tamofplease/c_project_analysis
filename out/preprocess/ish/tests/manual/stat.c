# 0 "project/ish/tests/manual/stat.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 3 "project/ish/tests/manual/stat.c" 2
...
# 4 "project/ish/tests/manual/stat.c" 2
...
# 5 "project/ish/tests/manual/stat.c" 2


# 6 "project/ish/tests/manual/stat.c"
int main() {
    ...
    len = 
# 17 "project/ish/tests/manual/stat.c" 3 4
   __builtin___sprintf_chk (
# 17 "project/ish/tests/manual/stat.c"
   buf
# 17 "project/ish/tests/manual/stat.c" 3 4
...
# 17 "project/ish/tests/manual/stat.c"
   ; write(1, buf, len);;
    len = 
# 18 "project/ish/tests/manual/stat.c" 3 4
   __builtin___sprintf_chk (
# 18 "project/ish/tests/manual/stat.c"
   buf
# 18 "project/ish/tests/manual/stat.c" 3 4
   , 0, __builtin_object_size (
# 18 "project/ish/tests/manual/stat.c"
...
# 18 "project/ish/tests/manual/stat.c"
   ; write(1, buf, len);;
    len = 
# 19 "project/ish/tests/manual/stat.c" 3 4
   __builtin___sprintf_chk (
# 19 "project/ish/tests/manual/stat.c"
   buf
# 19 "project/ish/tests/manual/stat.c" 3 4
   , 0, __builtin_object_size (
# 19 "project/ish/tests/manual/stat.c"
