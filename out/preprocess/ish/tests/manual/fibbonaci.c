# 0 "project/ish/tests/manual/fibbonaci.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/tests/manual/fibbonaci.c"
...
# 2 "project/ish/tests/manual/fibbonaci.c" 2
...
# 3 "project/ish/tests/manual/fibbonaci.c" 2


# 4 "project/ish/tests/manual/fibbonaci.c"
...
int main(int argc, const char *argv[]) {
    ...
    unsigned long n = strtoul(argv[1], 
# 16 "project/ish/tests/manual/fibbonaci.c" 3 4
                                      ((void *)0)
# 16 "project/ish/tests/manual/fibbonaci.c"
                                          , 10);
    printf("%lu\n", fib(n));
    return 0;
}
