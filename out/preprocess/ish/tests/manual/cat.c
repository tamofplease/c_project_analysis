# 0 "project/ish/tests/manual/cat.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/tests/manual/cat.c"
...
# 2 "project/ish/tests/manual/cat.c" 2


# 3 "project/ish/tests/manual/cat.c"
int main(int argc, const char *argv[]) {
    FILE *f = 
# 4 "project/ish/tests/manual/cat.c" 3 4
             __stdinp
# 4 "project/ish/tests/manual/cat.c"
                  ;
    if (argc > 1)
        f = fopen(argv[1], "r");
    if (f == 
# 7 "project/ish/tests/manual/cat.c" 3 4
            ((void *)0)
# 7 "project/ish/tests/manual/cat.c"
                ) {
        fprintf(
# 8 "project/ish/tests/manual/cat.c" 3 4
               __stderrp
# 8 "project/ish/tests/manual/cat.c"
                     , "cat: ");
        perror(argv[1]);
        return 1;
    }
    ...
    int c;
    while ((c = fgetc(f)) != 
# 14 "project/ish/tests/manual/cat.c" 3 4
                            (-1)
# 14 "project/ish/tests/manual/cat.c"
                               )
        putchar(c);
}
