# 0 "project/ish/tests/manual/forkexec.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 2 "project/ish/tests/manual/forkexec.c" 2
...
# 3 "project/ish/tests/manual/forkexec.c" 2
...
# 4 "project/ish/tests/manual/forkexec.c" 2
...
# 5 "project/ish/tests/manual/forkexec.c" 2


# 6 "project/ish/tests/manual/forkexec.c"
int main(int argc, char *argv[]) {
    ...
    if (pid == 0) {
        ...
        if (waitpid(pid, 
# 20 "project/ish/tests/manual/forkexec.c" 3 4
                        ((void *)0)
# 20 "project/ish/tests/manual/forkexec.c"
                            , 0) != pid) {
            perror("wait");
            abort();
        }
