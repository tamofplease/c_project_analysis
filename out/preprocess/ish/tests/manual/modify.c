# 0 "project/ish/tests/manual/modify.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/ish/tests/manual/modify.c"
...
# 2 "project/ish/tests/manual/modify.c" 2
...
# 3 "project/ish/tests/manual/modify.c" 2
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/mman.h" 1 3 4
# 79 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/mman.h" 3 4
...
# 4 "project/ish/tests/manual/modify.c" 2
...
# 5 "project/ish/tests/manual/modify.c" 2
...
# 6 "project/ish/tests/manual/modify.c" 2


# 7 "project/ish/tests/manual/modify.c"
static char code[] = {
...
int main() {
    signal(
# 28 "project/ish/tests/manual/modify.c" 3 4
          11
# 28 "project/ish/tests/manual/modify.c"
                 , handle_segfault);
    void *code_copy = mmap(
# 29 "project/ish/tests/manual/modify.c" 3 4
                          ((void *)0)
# 29 "project/ish/tests/manual/modify.c"
                              , 0x1000, 
# 29 "project/ish/tests/manual/modify.c" 3 4
                                        0x01
# 29 "project/ish/tests/manual/modify.c"
...
# 30 "project/ish/tests/manual/modify.c" 3 4
   __builtin___memcpy_chk (
# 30 "project/ish/tests/manual/modify.c"
   code_copy
# 30 "project/ish/tests/manual/modify.c" 3 4
   , 
# 30 "project/ish/tests/manual/modify.c"
