# 0 "project/radare2/binr/preload/libr2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/binr/preload/libr2.c"
...
# 4 "project/radare2/binr/preload/libr2.c" 2
...
# 9 "project/radare2/binr/preload/libr2.c"
static RCore *core = 
# 9 "project/radare2/binr/preload/libr2.c" 3 4
                    ((void *)0)
# 9 "project/radare2/binr/preload/libr2.c"
                        ;
...
static RCoreFile *openself(void) {
 RCoreFile *fd = 
# 15 "project/radare2/binr/preload/libr2.c" 3 4
                ((void *)0)
# 15 "project/radare2/binr/preload/libr2.c"
                    ;
 char *out = r_core_cmd_str (core, "o");
 if (out) {
  if (!strstr (out, "self://")) {
   fd = r_core_file_open (core, "self://", 
# 19 "project/radare2/binr/preload/libr2.c" 3 4
                                          (4|2)
# 19 "project/radare2/binr/preload/libr2.c"
                                                   , 0);
  }
  free (out);
 }
...
static void _libwrap_init(void) {
 char *web;
 r_sys_signal (
# 40 "project/radare2/binr/preload/libr2.c" 3 4
              30
# 40 "project/radare2/binr/preload/libr2.c"
                     , sigusr1);
 r_sys_signal (
# 41 "project/radare2/binr/preload/libr2.c" 3 4
              31
# 41 "project/radare2/binr/preload/libr2.c"
                     , sigusr2);
 int pid = r_sys_getpid ();
 printf ("libr2 initialized. send SIGUSR1 to %d in order to reach the r2 prompt\n", pid);
 printf ("kill -USR1 %d\n", pid);
 fflush (
# 45 "project/radare2/binr/preload/libr2.c" 3 4
        __stdoutp
# 45 "project/radare2/binr/preload/libr2.c"
              );
 web = r_sys_getenv ("RARUN2_WEB");
 core = r_core_new ();
 r_core_loadlibs (core, 
# 48 "project/radare2/binr/preload/libr2.c" 3 4
                       0xFFFFFFFFU
# 48 "project/radare2/binr/preload/libr2.c"
                                          , 
# 48 "project/radare2/binr/preload/libr2.c" 3 4
                                            ((void *)0)
# 48 "project/radare2/binr/preload/libr2.c"
 ...
 if (web) {
  r_core_cmd0 (core, "=H&");
  r_sys_setenv ("RARUN2_WEB", 
# 51 "project/radare2/binr/preload/libr2.c" 3 4
                             ((void *)0)
# 51 "project/radare2/binr/preload/libr2.c"
                                 );
  free (web);
 }
