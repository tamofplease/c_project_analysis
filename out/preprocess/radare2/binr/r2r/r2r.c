# 0 "project/radare2/binr/r2r/r2r.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/binr/r2r/r2r.c"
...
# 4 "project/radare2/binr/r2r/r2r.c" 2
# 16 "project/radare2/binr/r2r/r2r.c"
typedef struct r2r_state_t {
 R2RRunConfig run_config;
 
# 18 "project/radare2/binr/r2r/r2r.c" 3 4
_Bool 
# 18 "project/radare2/binr/r2r/r2r.c"
     verbose;
 R2RTestDatabase *db;
 PJ *test_results;
...
# 26 "project/radare2/binr/r2r/r2r.c" 3 4
unsigned long long 
# 26 "project/radare2/binr/r2r/r2r.c"
     ok_count;
 
# 27 "project/radare2/binr/r2r/r2r.c" 3 4
unsigned long long 
# 27 "project/radare2/binr/r2r/r2r.c"
     xx_count;
 
# 28 "project/radare2/binr/r2r/r2r.c" 3 4
unsigned long long 
# 28 "project/radare2/binr/r2r/r2r.c"
     br_count;
 
# 29 "project/radare2/binr/r2r/r2r.c" 3 4
unsigned long long 
# 29 "project/radare2/binr/r2r/r2r.c"
     fx_count;
 RPVector queue;
 RPVector results;
} R2RState;
...
# 48 "project/radare2/binr/r2r/r2r.c" 3 4
 fprintf(__stderrp,
# 48 "project/radare2/binr/r2r/r2r.c"
...
# 53 "project/radare2/binr/r2r/r2r.c" 3 4
                                        unsigned long long 
# 53 "project/radare2/binr/r2r/r2r.c"
                                             prev_completed);
static void print_log(R2RState *state, 
# 54 "project/radare2/binr/r2r/r2r.c" 3 4
                                      unsigned long long 
# 54 "project/radare2/binr/r2r/r2r.c"
                                           prev_completed, 
# 54 "project/radare2/binr/r2r/r2r.c" 3 4
                                                           unsigned long long 
# 54 "project/radare2/binr/r2r/r2r.c"
...
static int help(
# 61 "project/radare2/binr/r2r/r2r.c" 3 4
               _Bool 
# 61 "project/radare2/binr/r2r/r2r.c"
                    verbose) {
...
static 
# 100 "project/radare2/binr/r2r/r2r.c" 3 4
      _Bool 
# 100 "project/radare2/binr/r2r/r2r.c"
           r2r_chdir(const char *argv0) {

 if (r_file_is_directory ("db")) {
  return 
# 103 "project/radare2/binr/r2r/r2r.c" 3 4
        1
# 103 "project/radare2/binr/r2r/r2r.c"
            ;
 }
 char *src_path = malloc (
# 105 "project/radare2/binr/r2r/r2r.c" 3 4
                         1024
# 105 "project/radare2/binr/r2r/r2r.c"
                                 );
 char *r2r_path = r_file_path (argv0);
 
# 107 "project/radare2/binr/r2r/r2r.c" 3 4
_Bool 
# 107 "project/radare2/binr/r2r/r2r.c"
     found = 
# 107 "project/radare2/binr/r2r/r2r.c" 3 4
             0
# 107 "project/radare2/binr/r2r/r2r.c"
...
# 108 "project/radare2/binr/r2r/r2r.c" 3 4
                                  1024
# 108 "project/radare2/binr/r2r/r2r.c"
                                          ) != -1) {
  src_path[
# 109 "project/radare2/binr/r2r/r2r.c" 3 4
          1024 
# 109 "project/radare2/binr/r2r/r2r.c"
                   - 1] = 0;
...
# 116 "project/radare2/binr/r2r/r2r.c" 3 4
    fprintf(__stderrp,
# 116 "project/radare2/binr/r2r/r2r.c"
    "Running from %s\n", src_path
# 116 "project/radare2/binr/r2r/r2r.c" 3 4
    )
# 116 "project/radare2/binr/r2r/r2r.c"
                                           ;
     found = 
# 117 "project/radare2/binr/r2r/r2r.c" 3 4
            1
# 117 "project/radare2/binr/r2r/r2r.c"
                ;
    } else {
     
# 119 "project/radare2/binr/r2r/r2r.c" 3 4
    fprintf(__stderrp,
# 119 "project/radare2/binr/r2r/r2r.c"
...
static 
# 132 "project/radare2/binr/r2r/r2r.c" 3 4
      _Bool 
# 132 "project/radare2/binr/r2r/r2r.c"
           r2r_test_run_unit(void) {
 return r_sandbox_system ("make -C unit all run", 1) == 0;
}

static 
# 136 "project/radare2/binr/r2r/r2r.c" 3 4
      _Bool 
# 136 "project/radare2/binr/r2r/r2r.c"
...
# 142 "project/radare2/binr/r2r/r2r.c" 3 4
                                                       "/"
# 142 "project/radare2/binr/r2r/r2r.c"
                                                                [0]);
  if (last_slash) {
   *last_slash = 0;
  }
 ...
 if (chdir (abs_test_path) == -1) {
  free (abs_test_path);
  return 
# 149 "project/radare2/binr/r2r/r2r.c" 3 4
        0
# 149 "project/radare2/binr/r2r/r2r.c"
             ;
 }
 free (abs_test_path);
 
# 152 "project/radare2/binr/r2r/r2r.c" 3 4
_Bool 
# 152 "project/radare2/binr/r2r/r2r.c"
     found = 
# 152 "project/radare2/binr/r2r/r2r.c" 3 4
             0
# 152 "project/radare2/binr/r2r/r2r.c"
                  ;
 char *cwd = 
# 153 "project/radare2/binr/r2r/r2r.c" 3 4
            ((void *)0)
# 153 "project/radare2/binr/r2r/r2r.c"
                ;
 char *old_cwd = 
# 154 "project/radare2/binr/r2r/r2r.c" 3 4
                ((void *)0)
# 154 "project/radare2/binr/r2r/r2r.c"
                    ;
 while (
# 155 "project/radare2/binr/r2r/r2r.c" 3 4
       1
# 155 "project/radare2/binr/r2r/r2r.c"
           ) {
  cwd = r_sys_getdir ();
  ...
  if (r_file_is_directory ("test")) {
   ...
   if (r_file_is_directory ("db")) {
    found = 
# 163 "project/radare2/binr/r2r/r2r.c" 3 4
           1
# 163 "project/radare2/binr/r2r/r2r.c"
               ;
    
# 164 "project/radare2/binr/r2r/r2r.c" 3 4
   fprintf(__stderrp,
# 164 "project/radare2/binr/r2r/r2r.c"
   "Running from %s\n", cwd
# 164 "project/radare2/binr/r2r/r2r.c" 3 4
   )
# 164 "project/radare2/binr/r2r/r2r.c"
  ...
  if (r_file_is_directory ("db")) {
   found = 
# 170 "project/radare2/binr/r2r/r2r.c" 3 4
          1
# 170 "project/radare2/binr/r2r/r2r.c"
              ;
   
# 171 "project/radare2/binr/r2r/r2r.c" 3 4
  fprintf(__stderrp,
# 171 "project/radare2/binr/r2r/r2r.c"
  "Running from %s\n", cwd
# 171 "project/radare2/binr/r2r/r2r.c" 3 4
  )
# 171 "project/radare2/binr/r2r/r2r.c"
  ...
  old_cwd = cwd;
  cwd = 
# 176 "project/radare2/binr/r2r/r2r.c" 3 4
       ((void *)0)
# 176 "project/radare2/binr/r2r/r2r.c"
           ;
  if (chdir ("..") == -1) {
   break;
  }
...
# 188 "project/radare2/binr/r2r/r2r.c" 3 4
_Bool 
# 188 "project/radare2/binr/r2r/r2r.c"
     verbose = 
# 188 "project/radare2/binr/r2r/r2r.c" 3 4
               0
# 188 "project/radare2/binr/r2r/r2r.c"
...
# 189 "project/radare2/binr/r2r/r2r.c" 3 4
_Bool 
# 189 "project/radare2/binr/r2r/r2r.c"
     nothing = 
# 189 "project/radare2/binr/r2r/r2r.c" 3 4
               0
# 189 "project/radare2/binr/r2r/r2r.c"
...
# 190 "project/radare2/binr/r2r/r2r.c" 3 4
_Bool 
# 190 "project/radare2/binr/r2r/r2r.c"
     quiet = 
# 190 "project/radare2/binr/r2r/r2r.c" 3 4
             0
# 190 "project/radare2/binr/r2r/r2r.c"
...
# 191 "project/radare2/binr/r2r/r2r.c" 3 4
_Bool 
# 191 "project/radare2/binr/r2r/r2r.c"
     log_mode = 
# 191 "project/radare2/binr/r2r/r2r.c" 3 4
                0
# 191 "project/radare2/binr/r2r/r2r.c"
...
# 192 "project/radare2/binr/r2r/r2r.c" 3 4
_Bool 
# 192 "project/radare2/binr/r2r/r2r.c"
     interactive = 
# 192 "project/radare2/binr/r2r/r2r.c" 3 4
                   0
# 192 "project/radare2/binr/r2r/r2r.c"
                        ;
 char *radare2_cmd = 
# 193 "project/radare2/binr/r2r/r2r.c" 3 4
                    ((void *)0)
# 193 "project/radare2/binr/r2r/r2r.c"
                        ;
 char *rasm2_cmd = 
# 194 "project/radare2/binr/r2r/r2r.c" 3 4
                  ((void *)0)
# 194 "project/radare2/binr/r2r/r2r.c"
                      ;
 char *json_test_file = 
# 195 "project/radare2/binr/r2r/r2r.c" 3 4
                       ((void *)0)
# 195 "project/radare2/binr/r2r/r2r.c"
                           ;
 char *output_file = 
# 196 "project/radare2/binr/r2r/r2r.c" 3 4
                    ((void *)0)
# 196 "project/radare2/binr/r2r/r2r.c"
                        ;
 char *fuzz_dir = 
# 197 "project/radare2/binr/r2r/r2r.c" 3 4
                 ((void *)0)
# 197 "project/radare2/binr/r2r/r2r.c"
                     ;
 const char *r2r_dir = 
# 198 "project/radare2/binr/r2r/r2r.c" 3 4
                      ((void *)0)
# 198 "project/radare2/binr/r2r/r2r.c"
                          ;
 
# 199 "project/radare2/binr/r2r/r2r.c" 3 4
unsigned long long 
# 199 "project/radare2/binr/r2r/r2r.c"
     timeout_sec = 960;
 
# 200 "project/radare2/binr/r2r/r2r.c" 3 4
_Bool 
# 200 "project/radare2/binr/r2r/r2r.c"
     get_bins = 
# 200 "project/radare2/binr/r2r/r2r.c" 3 4
                1
# 200 "project/radare2/binr/r2r/r2r.c"
                    ;
 int ret = 0;
# 216 "project/radare2/binr/r2r/r2r.c"
 RGetopt opt;
 ...
 while ((c = r_getopt_next (&opt)) != -1) {
  ...
  case 'h':
   ret = help (
# 223 "project/radare2/binr/r2r/r2r.c" 3 4
              1
# 223 "project/radare2/binr/r2r/r2r.c"
                  );
   goto beach;
  case 'q':
   quiet = 
# 226 "project/radare2/binr/r2r/r2r.c" 3 4
          1
# 226 "project/radare2/binr/r2r/r2r.c"
              ;
   break;
  case 'v':
   if (quiet) {
    printf (
# 230 "project/radare2/binr/r2r/r2r.c" 3 4
           "5.5.4" 
# 230 "project/radare2/binr/r2r/r2r.c"
                      "\n");
   } else {
  ...
  case 'V':
   verbose = 
# 240 "project/radare2/binr/r2r/r2r.c" 3 4
            1
# 240 "project/radare2/binr/r2r/r2r.c"
                ;
   break;
  case 'i':
   interactive = 
# 243 "project/radare2/binr/r2r/r2r.c" 3 4
                1
# 243 "project/radare2/binr/r2r/r2r.c"
                    ;
   break;
  case 'L':
   log_mode = 
# 246 "project/radare2/binr/r2r/r2r.c" 3 4
             1
# 246 "project/radare2/binr/r2r/r2r.c"
                 ;
   break;
  case 's':
   parse_skip (opt.arg);
...
# 258 "project/radare2/binr/r2r/r2r.c" 3 4
   fprintf(__stderrp,
# 258 "project/radare2/binr/r2r/r2r.c"
...
# 258 "project/radare2/binr/r2r/r2r.c"
                                     ;
    ret = help (
# 259 "project/radare2/binr/r2r/r2r.c" 3 4
               0
# 259 "project/radare2/binr/r2r/r2r.c"
                    );
    goto beach;
   }
   break;
  ...
  case 'n':
   nothing = 
# 271 "project/radare2/binr/r2r/r2r.c" 3 4
            1
# 271 "project/radare2/binr/r2r/r2r.c"
                ;
   break;
  case 'm':
   free (rasm2_cmd);
  ...
  case 'u':
   get_bins = 
# 282 "project/radare2/binr/r2r/r2r.c" 3 4
             0
# 282 "project/radare2/binr/r2r/r2r.c"
                  ;
   break;
  case 't':
   timeout_sec = strtoull (opt.arg, 
# 285 "project/radare2/binr/r2r/r2r.c" 3 4
                                   ((void *)0)
# 285 "project/radare2/binr/r2r/r2r.c"
                                       , 0);
   if (!timeout_sec) {
    timeout_sec = 
# 287 "project/radare2/binr/r2r/r2r.c" 3 4
                 0xFFFFFFFFFFFFFFFFULL
# 287 "project/radare2/binr/r2r/r2r.c"
                         ;
   }
   break;
  case 'o':
  ...
  default:
   ret = help (
# 295 "project/radare2/binr/r2r/r2r.c" 3 4
              0
# 295 "project/radare2/binr/r2r/r2r.c"
                   );
   goto beach;
  }
 }
...
# 303 "project/radare2/binr/r2r/r2r.c" 3 4
  fprintf(__stderrp,
# 303 "project/radare2/binr/r2r/r2r.c"
  "Cannot find %s directory.\n", r2r_dir
# 303 "project/radare2/binr/r2r/r2r.c" 3 4
  )
# 303 "project/radare2/binr/r2r/r2r.c"
...
# 307 "project/radare2/binr/r2r/r2r.c" 3 4
 _Bool 
# 307 "project/radare2/binr/r2r/r2r.c"
      dir_found = (opt.ind < argc && argv[opt.ind][0] != '.')
   ? r2r_chdir_fromtest (argv[opt.ind])
   : r2r_chdir (argv[0]);
  if (!dir_found) {
   
# 311 "project/radare2/binr/r2r/r2r.c" 3 4
  fprintf(__stderrp,
# 311 "project/radare2/binr/r2r/r2r.c"
...
# 331 "project/radare2/binr/r2r/r2r.c" 3 4
 fprintf(__stderrp,
# 331 "project/radare2/binr/r2r/r2r.c"
...
# 339 "project/radare2/binr/r2r/r2r.c" 3 4
unsigned long long 
# 339 "project/radare2/binr/r2r/r2r.c"
...
# 344 "project/radare2/binr/r2r/r2r.c" 3 4
                                            0xFFFFFFFFFFFFFFFFULL 
# 344 "project/radare2/binr/r2r/r2r.c"
                                                     / 1000 ? 
# 344 "project/radare2/binr/r2r/r2r.c" 3 4
                                                              0xFFFFFFFFFFFFFFFFULL 
# 344 "project/radare2/binr/r2r/r2r.c"
...
# 350 "project/radare2/binr/r2r/r2r.c" 3 4
                              ((void *)0)
# 350 "project/radare2/binr/r2r/r2r.c"
                                  );
 r_pvector_init (&state.results, (RPVectorFree)r2r_test_result_info_free);
 r_pvector_init (&state.completed_paths, 
# 352 "project/radare2/binr/r2r/r2r.c" 3 4
                                        ((void *)0)
# 352 "project/radare2/binr/r2r/r2r.c"
                                            );
 if (output_file) {
...
# 357 "project/radare2/binr/r2r/r2r.c" 3 4
                            0
# 357 "project/radare2/binr/r2r/r2r.c"
                                 );
 if (!state.lock) {
  return -1;
 }
...
# 373 "project/radare2/binr/r2r/r2r.c" 3 4
   fprintf(__stderrp,
# 373 "project/radare2/binr/r2r/r2r.c"
   "Category: %s\n", arg
# 373 "project/radare2/binr/r2r/r2r.c" 3 4
   )
# 373 "project/radare2/binr/r2r/r2r.c"
...
# 381 "project/radare2/binr/r2r/r2r.c" 3 4
     fprintf(__stderrp,
# 381 "project/radare2/binr/r2r/r2r.c"
...
# 385 "project/radare2/binr/r2r/r2r.c" 3 4
     fprintf(__stderrp,
# 385 "project/radare2/binr/r2r/r2r.c"
...
# 400 "project/radare2/binr/r2r/r2r.c" 3 4
   fprintf(__stderrp,
# 400 "project/radare2/binr/r2r/r2r.c"
...
# 410 "project/radare2/binr/r2r/r2r.c" 3 4
  fprintf(__stderrp,
# 410 "project/radare2/binr/r2r/r2r.c"
...
# 415 "project/radare2/binr/r2r/r2r.c" 3 4
  fprintf(__stderrp,
# 415 "project/radare2/binr/r2r/r2r.c"
  "Failed to load fuzz tests from \"%s\"\n", fuzz_dir
# 415 "project/radare2/binr/r2r/r2r.c" 3 4
  )
# 415 "project/radare2/binr/r2r/r2r.c"
...
# 419 "project/radare2/binr/r2r/r2r.c" 3 4
{ free((void *)
# 419 "project/radare2/binr/r2r/r2r.c"
cwd
# 419 "project/radare2/binr/r2r/r2r.c" 3 4
); 
# 419 "project/radare2/binr/r2r/r2r.c"
...
# 426 "project/radare2/binr/r2r/r2r.c" 3 4
_Bool 
# 426 "project/radare2/binr/r2r/r2r.c"
     jq_available = r2r_check_jq_available ();
 if (!jq_available) {
  
# 428 "project/radare2/binr/r2r/r2r.c" 3 4
 fprintf(__stderrp,
# 428 "project/radare2/binr/r2r/r2r.c"
...
# 446 "project/radare2/binr/r2r/r2r.c" 3 4
                              ((void *)0)
# 446 "project/radare2/binr/r2r/r2r.c"
                                  , path_left_free_kv, 
# 446 "project/radare2/binr/r2r/r2r.c" 3 4
                                                       ((void *)0)
# 446 "project/radare2/binr/r2r/r2r.c"
...
# 449 "project/radare2/binr/r2r/r2r.c" 3 4
  for (
# 449 "project/radare2/binr/r2r/r2r.c"
  it 
# 449 "project/radare2/binr/r2r/r2r.c" 3 4
  = (void **)(
# 449 "project/radare2/binr/r2r/r2r.c"
...
# 451 "project/radare2/binr/r2r/r2r.c" 3 4
   unsigned long long 
# 451 "project/radare2/binr/r2r/r2r.c"
...
# 451 "project/radare2/binr/r2r/r2r.c"
    ...
    if (!count) {
     count = malloc (sizeof (
# 453 "project/radare2/binr/r2r/r2r.c" 3 4
                            unsigned long long
# 453 "project/radare2/binr/r2r/r2r.c"
                                ));
     *count = 0;
...
# 465 "project/radare2/binr/r2r/r2r.c" 3 4
                          ((void *)0)
# 465 "project/radare2/binr/r2r/r2r.c"
                              );
 int i;
...
# 470 "project/radare2/binr/r2r/r2r.c" 3 4
  fprintf(__stderrp,
# 470 "project/radare2/binr/r2r/r2r.c"
...
# 477 "project/radare2/binr/r2r/r2r.c" 3 4
unsigned long long 
# 477 "project/radare2/binr/r2r/r2r.c"
     prev_completed = 
# 477 "project/radare2/binr/r2r/r2r.c" 3 4
                      0xFFFFFFFFFFFFFFFFULL
# 477 "project/radare2/binr/r2r/r2r.c"
...
# 478 "project/radare2/binr/r2r/r2r.c" 3 4
unsigned long long 
# 478 "project/radare2/binr/r2r/r2r.c"
     prev_paths_completed = 0;
 while (
# 479 "project/radare2/binr/r2r/r2r.c" 3 4
       1
# 479 "project/radare2/binr/r2r/r2r.c"
           ) {
  
# 480 "project/radare2/binr/r2r/r2r.c" 3 4
 unsigned long long 
# 480 "project/radare2/binr/r2r/r2r.c"
      completed = (
# 480 "project/radare2/binr/r2r/r2r.c" 3 4
                   unsigned long long
# 480 "project/radare2/binr/r2r/r2r.c"
  ...
  prev_paths_completed = (
# 487 "project/radare2/binr/r2r/r2r.c" 3 4
                         unsigned long long
# 487 "project/radare2/binr/r2r/r2r.c"
...
# 499 "project/radare2/binr/r2r/r2r.c" 3 4
for (
# 499 "project/radare2/binr/r2r/r2r.c"
it 
# 499 "project/radare2/binr/r2r/r2r.c" 3 4
= (void **)(
# 499 "project/radare2/binr/r2r/r2r.c"
...
# 506 "project/radare2/binr/r2r/r2r.c" 3 4
unsigned long long 
# 506 "project/radare2/binr/r2r/r2r.c"
     seconds = (r_time_now_mono () - time_start) / 1000000;
 printf ("Finished in");
 if (seconds > 60) {
  
# 509 "project/radare2/binr/r2r/r2r.c" 3 4
 unsigned long long 
# 509 "project/radare2/binr/r2r/r2r.c"
      minutes = seconds / 60;
  printf (" %"
# 510 "project/radare2/binr/r2r/r2r.c" 3 4
             "lld"
# 510 "project/radare2/binr/r2r/r2r.c"
                    " minutes and", seconds / 60);
  seconds -= (minutes * 60);
 }
 printf (" %"
# 513 "project/radare2/binr/r2r/r2r.c" 3 4
            "lld"
# 513 "project/radare2/binr/r2r/r2r.c"
                   " seconds.\n", seconds % 60);
...
# 518 "project/radare2/binr/r2r/r2r.c" 3 4
                            unsigned char 
# 518 "project/radare2/binr/r2r/r2r.c"
...
# 553 "project/radare2/binr/r2r/r2r.c" 3 4
do { if (!(
# 553 "project/radare2/binr/r2r/r2r.c"
pj && result
# 553 "project/radare2/binr/r2r/r2r.c" 3 4
...
static RThreadFunctionRet worker_th(RThread *th) {
 ...
 r_th_lock_enter (state->lock);
 while (
# 603 "project/radare2/binr/r2r/r2r.c" 3 4
       1
# 603 "project/radare2/binr/r2r/r2r.c"
           ) {
...
# 629 "project/radare2/binr/r2r/r2r.c" 3 4
  unsigned long long 
# 629 "project/radare2/binr/r2r/r2r.c"
       *count = ht_pp_find (state->path_left, test->path, 
# 629 "project/radare2/binr/r2r/r2r.c" 3 4
                                                          ((void *)0)
# 629 "project/radare2/binr/r2r/r2r.c"
...
# 643 "project/radare2/binr/r2r/r2r.c" 3 4
                                                                _Bool 
# 643 "project/radare2/binr/r2r/r2r.c"
...
# 657 "project/radare2/binr/r2r/r2r.c" 3 4
                                          unsigned char 
# 657 "project/radare2/binr/r2r/r2r.c"
                                              *)expected, (const 
# 657 "project/radare2/binr/r2r/r2r.c" 3 4
                                                                 unsigned char 
# 657 "project/radare2/binr/r2r/r2r.c"
...
# 665 "project/radare2/binr/r2r/r2r.c" 3 4
                                                unsigned char 
# 665 "project/radare2/binr/r2r/r2r.c"
                                                    *)expected, (int)strlen (expected),
   (const 
# 666 "project/radare2/binr/r2r/r2r.c" 3 4
         unsigned char 
# 666 "project/radare2/binr/r2r/r2r.c"
             *)output, (int)strlen (output));
 r_diff_free (d);

 RList *lines = r_str_split_duplist (uni, "\n", 
# 669 "project/radare2/binr/r2r/r2r.c" 3 4
                                               0
# 669 "project/radare2/binr/r2r/r2r.c"
                                                    );
 RListIter *it;
 char *line;
 
# 672 "project/radare2/binr/r2r/r2r.c" 3 4
_Bool 
# 672 "project/radare2/binr/r2r/r2r.c"
     header_found = 
# 672 "project/radare2/binr/r2r/r2r.c" 3 4
                    0
# 672 "project/radare2/binr/r2r/r2r.c"
...
# 673 "project/radare2/binr/r2r/r2r.c" 3 4
if (
# 673 "project/radare2/binr/r2r/r2r.c"
lines
# 673 "project/radare2/binr/r2r/r2r.c" 3 4
) for (
# 673 "project/radare2/binr/r2r/r2r.c"
...
# 673 "project/radare2/binr/r2r/r2r.c"
  ...
  if (!header_found) {
   if (r_str_startswith (line, "+++ ")) {
    header_found = 
# 676 "project/radare2/binr/r2r/r2r.c" 3 4
                  1
# 676 "project/radare2/binr/r2r/r2r.c"
                      ;
   }
   continue;
  }
  if (r_str_startswith (line, "@@ ") && r_str_endswith (line, " @@")) {
   printf ("%s%s%s\n", 
# 681 "project/radare2/binr/r2r/r2r.c" 3 4
                      "\x1b[36m"
# 681 "project/radare2/binr/r2r/r2r.c"
                                , line, 
# 681 "project/radare2/binr/r2r/r2r.c" 3 4
                                        "\x1b[0m"
# 681 "project/radare2/binr/r2r/r2r.c"
...
# 684 "project/radare2/binr/r2r/r2r.c" 3 4
 _Bool 
# 684 "project/radare2/binr/r2r/r2r.c"
      color = 
# 684 "project/radare2/binr/r2r/r2r.c" 3 4
              1
# 684 "project/radare2/binr/r2r/r2r.c"
  ...
  case '+':
   printf ("%s"
# 688 "project/radare2/binr/r2r/r2r.c" 3 4
              "\x1b[92m"
# 688 "project/radare2/binr/r2r/r2r.c"
                          , diffchar ? 
# 688 "project/radare2/binr/r2r/r2r.c" 3 4
                                       "\x1b[48;5;22m" 
# 688 "project/radare2/binr/r2r/r2r.c"
  ...
  case '-':
   printf ("%s"
# 691 "project/radare2/binr/r2r/r2r.c" 3 4
              "\x1b[91m"
# 691 "project/radare2/binr/r2r/r2r.c"
                          , diffchar ? 
# 691 "project/radare2/binr/r2r/r2r.c" 3 4
                                       "\x1b[48;5;52m" 
# 691 "project/radare2/binr/r2r/r2r.c"
  ...
  default:
   color = 
# 697 "project/radare2/binr/r2r/r2r.c" 3 4
          0
# 697 "project/radare2/binr/r2r/r2r.c"
               ;
   break;
  }
  if (diffchar) {
  ...
  if (color) {
   printf ("%s", 
# 706 "project/radare2/binr/r2r/r2r.c" 3 4
                "\x1b[0m"
# 706 "project/radare2/binr/r2r/r2r.c"
                           );
  }
 }
 r_list_free (lines);
...
static R2RProcessOutput *print_runner(const char *file, const char *args[], size_t args_size,
 const char *envvars[], const char *envvals[], size_t env_size, 
# 719 "project/radare2/binr/r2r/r2r.c" 3 4
                                                               unsigned long long 
# 719 "project/radare2/binr/r2r/r2r.c"
                                                                    timeout_ms, void *user) {
 size_t i;
 ...
 printf ("\n");
 return 
# 734 "project/radare2/binr/r2r/r2r.c" 3 4
       ((void *)0)
# 734 "project/radare2/binr/r2r/r2r.c"
           ;
}


# 737 "project/radare2/binr/r2r/r2r.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 737 "project/radare2/binr/r2r/r2r.c"
          r_test_cmp_cmd_output(const char *output, const char *expect, const char *regexp) {
 if (regexp) {
  if (!r_regex_match (regexp, "e", output)) {
   return 
# 740 "project/radare2/binr/r2r/r2r.c" 3 4
         1
# 740 "project/radare2/binr/r2r/r2r.c"
             ;
  }
  return 
# 742 "project/radare2/binr/r2r/r2r.c" 3 4
        0
# 742 "project/radare2/binr/r2r/r2r.c"
             ;
 }
...
static void print_result_diff(R2RRunConfig *config, R2RTestResultInfo *result) {
 if (result->run_failed) {
  printf (
# 749 "project/radare2/binr/r2r/r2r.c" 3 4
         "\x1b[31m" 
# 749 "project/radare2/binr/r2r/r2r.c"
...
# 754 "project/radare2/binr/r2r/r2r.c" 3 4
                                                                 ((void *)0)
# 754 "project/radare2/binr/r2r/r2r.c"
                                                                     );
...
# 760 "project/radare2/binr/r2r/r2r.c" 3 4
                           0
# 760 "project/radare2/binr/r2r/r2r.c"
                                , regexp_out);
  }
...
# 767 "project/radare2/binr/r2r/r2r.c" 3 4
                           0
# 767 "project/radare2/binr/r2r/r2r.c"
                                , regexp_err);
  } else if (*err) {
   printf ("-- stderr\n%s\n", err);
  }
  if (result->proc_out->ret != 0) {
   printf ("-- exit status: "
# 772 "project/radare2/binr/r2r/r2r.c" 3 4
                            "\x1b[31m"
# 772 "project/radare2/binr/r2r/r2r.c"
                                     "%d"
# 772 "project/radare2/binr/r2r/r2r.c" 3 4
                                         "\x1b[0m"
# 772 "project/radare2/binr/r2r/r2r.c"
...
# 782 "project/radare2/binr/r2r/r2r.c" 3 4
                                                                   ((void *)0)
# 782 "project/radare2/binr/r2r/r2r.c"
                                                                       );
  printf ("-- stdout\n%s\n", result->proc_out->out);
  printf ("-- stderr\n%s\n", result->proc_out->err);
  printf ("-- exit status: "
# 785 "project/radare2/binr/r2r/r2r.c" 3 4
                           "\x1b[31m"
# 785 "project/radare2/binr/r2r/r2r.c"
                                    "%d"
# 785 "project/radare2/binr/r2r/r2r.c" 3 4
                                        "\x1b[0m"
# 785 "project/radare2/binr/r2r/r2r.c"
...
# 790 "project/radare2/binr/r2r/r2r.c" 3 4
                                              unsigned long long 
# 790 "project/radare2/binr/r2r/r2r.c"
                                                   prev_completed) {

 
# 792 "project/radare2/binr/r2r/r2r.c" 3 4
unsigned long long 
# 792 "project/radare2/binr/r2r/r2r.c"
     completed = (
# 792 "project/radare2/binr/r2r/r2r.c" 3 4
                  unsigned long long
# 792 "project/radare2/binr/r2r/r2r.c"
...
# 793 "project/radare2/binr/r2r/r2r.c" 3 4
unsigned long long 
# 793 "project/radare2/binr/r2r/r2r.c"
     i;
 for (i = prev_completed; i < completed; i++) {
  ...
  printf ("\n"
# 806 "project/radare2/binr/r2r/r2r.c" 3 4
             "\x1b[A" "\x1b[2K\r"
# 806 "project/radare2/binr/r2r/r2r.c"
                                               );
  switch (result->result) {
  case R2R_TEST_RESULT_OK:
   printf (
# 809 "project/radare2/binr/r2r/r2r.c" 3 4
          "\x1b[32m"
# 809 "project/radare2/binr/r2r/r2r.c"
                     "[OK]"
# 809 "project/radare2/binr/r2r/r2r.c" 3 4
                           "\x1b[0m"
# 809 "project/radare2/binr/r2r/r2r.c"
  ...
  case R2R_TEST_RESULT_FAILED:
   printf (
# 812 "project/radare2/binr/r2r/r2r.c" 3 4
          "\x1b[31m"
# 812 "project/radare2/binr/r2r/r2r.c"
                   "[XX]"
# 812 "project/radare2/binr/r2r/r2r.c" 3 4
                         "\x1b[0m"
# 812 "project/radare2/binr/r2r/r2r.c"
  ...
  case R2R_TEST_RESULT_BROKEN:
   printf (
# 815 "project/radare2/binr/r2r/r2r.c" 3 4
          "\x1b[34m"
# 815 "project/radare2/binr/r2r/r2r.c"
                    "[BR]"
# 815 "project/radare2/binr/r2r/r2r.c" 3 4
                          "\x1b[0m"
# 815 "project/radare2/binr/r2r/r2r.c"
  ...
  case R2R_TEST_RESULT_FIXED:
   printf (
# 818 "project/radare2/binr/r2r/r2r.c" 3 4
          "\x1b[36m"
# 818 "project/radare2/binr/r2r/r2r.c"
                    "[FX]"
# 818 "project/radare2/binr/r2r/r2r.c" 3 4
                          "\x1b[0m"
# 818 "project/radare2/binr/r2r/r2r.c"
  ...
  if (result->timeout) {
   printf (
# 822 "project/radare2/binr/r2r/r2r.c" 3 4
          "\x1b[36m"
# 822 "project/radare2/binr/r2r/r2r.c"
                    " TIMEOUT"
# 822 "project/radare2/binr/r2r/r2r.c" 3 4
                              "\x1b[0m"
# 822 "project/radare2/binr/r2r/r2r.c"
  ...
  printf (" %s "
# 824 "project/radare2/binr/r2r/r2r.c" 3 4
               "\x1b[33m"
# 824 "project/radare2/binr/r2r/r2r.c"
                           "%s"
# 824 "project/radare2/binr/r2r/r2r.c" 3 4
                               "\x1b[0m"
# 824 "project/radare2/binr/r2r/r2r.c"
...
static void print_state_counts(R2RState *state) {
 printf ("%8"
# 833 "project/radare2/binr/r2r/r2r.c" 3 4
            "llu"
# 833 "project/radare2/binr/r2r/r2r.c"
                   " OK  %8"
# 833 "project/radare2/binr/r2r/r2r.c" 3 4
                            "llu"
# 833 "project/radare2/binr/r2r/r2r.c"
...
static void print_state(R2RState *state, 
# 837 "project/radare2/binr/r2r/r2r.c" 3 4
                                        unsigned long long 
# 837 "project/radare2/binr/r2r/r2r.c"
                                             prev_completed) {
 ...
 printf (
# 844 "project/radare2/binr/r2r/r2r.c" 3 4
        "\x1b[2K\r"
# 844 "project/radare2/binr/r2r/r2r.c"
                         );
 
# 845 "project/radare2/binr/r2r/r2r.c" 3 4
unsigned long long 
# 845 "project/radare2/binr/r2r/r2r.c"
     a = (
# 845 "project/radare2/binr/r2r/r2r.c" 3 4
          unsigned long long
# 845 "project/radare2/binr/r2r/r2r.c"
...
# 846 "project/radare2/binr/r2r/r2r.c" 3 4
unsigned long long 
# 846 "project/radare2/binr/r2r/r2r.c"
     b = (
# 846 "project/radare2/binr/r2r/r2r.c" 3 4
          unsigned long long
# 846 "project/radare2/binr/r2r/r2r.c"
 ...
 int w = printf ("[%"
# 847 "project/radare2/binr/r2r/r2r.c" 3 4
                    "llu"
# 847 "project/radare2/binr/r2r/r2r.c"
                           "/%"
# 847 "project/radare2/binr/r2r/r2r.c" 3 4
                               "llu"
# 847 "project/radare2/binr/r2r/r2r.c"
 ...
 fflush (
# 854 "project/radare2/binr/r2r/r2r.c" 3 4
        __stdoutp
# 854 "project/radare2/binr/r2r/r2r.c"
              );
...
static void print_log(R2RState *state, 
# 860 "project/radare2/binr/r2r/r2r.c" 3 4
                                      unsigned long long 
# 860 "project/radare2/binr/r2r/r2r.c"
                                           prev_completed, 
# 860 "project/radare2/binr/r2r/r2r.c" 3 4
                                                           unsigned long long 
# 860 "project/radare2/binr/r2r/r2r.c"
...
# 862 "project/radare2/binr/r2r/r2r.c" 3 4
unsigned long long 
# 862 "project/radare2/binr/r2r/r2r.c"
...
# 873 "project/radare2/binr/r2r/r2r.c" 3 4
                                 ((void *)0)
# 873 "project/radare2/binr/r2r/r2r.c"
                                     );
 
# 874 "project/radare2/binr/r2r/r2r.c" 3 4
for (
# 874 "project/radare2/binr/r2r/r2r.c"
it 
# 874 "project/radare2/binr/r2r/r2r.c" 3 4
= (void **)(
# 874 "project/radare2/binr/r2r/r2r.c"
...
# 884 "project/radare2/binr/r2r/r2r.c" 3 4
_Bool 
# 884 "project/radare2/binr/r2r/r2r.c"
 ...
 if (use_fancy_stuff) {
  printf (" %"
# 892 "project/radare2/binr/r2r/r2r.c" 3 4
             "llu"
# 892 "project/radare2/binr/r2r/r2r.c"
                    " failed test(s)"
# 892 "project/radare2/binr/r2r/r2r.c" 3 4
                                     "🚨"
# 892 "project/radare2/binr/r2r/r2r.c"
                                                                       "\n",
   (
# 893 "project/radare2/binr/r2r/r2r.c" 3 4
   unsigned long long
# 893 "project/radare2/binr/r2r/r2r.c"
       )r_pvector_len (&failed_results));
 } else {
  printf (" %"
# 895 "project/radare2/binr/r2r/r2r.c" 3 4
             "llu"
# 895 "project/radare2/binr/r2r/r2r.c"
                    " failed test(s)\n", (
# 895 "project/radare2/binr/r2r/r2r.c" 3 4
                                          unsigned long long
# 895 "project/radare2/binr/r2r/r2r.c"
...
# 898 "project/radare2/binr/r2r/r2r.c" 3 4
for (
# 898 "project/radare2/binr/r2r/r2r.c"
it 
# 898 "project/radare2/binr/r2r/r2r.c" 3 4
= (void **)(
# 898 "project/radare2/binr/r2r/r2r.c"
...
menu:
  if (use_fancy_stuff) {
   printf ("Wat do?    "
     "(f)ix "
# 910 "project/radare2/binr/r2r/r2r.c" 3 4
            "✅" "\xef\xb8\x8f" "\xef\xb8\x8f" "\xef\xb8\x8f"
# 910 "project/radare2/binr/r2r/r2r.c"
                                                                             "    "
     "(i)gnore "
# 911 "project/radare2/binr/r2r/r2r.c" 3 4
               "🙈"
# 911 "project/radare2/binr/r2r/r2r.c"
                                        "    "
     "(b)roken "
# 912 "project/radare2/binr/r2r/r2r.c" 3 4
               "☠" "\xef\xb8\x8f" "\xef\xb8\x8f" "\xef\xb8\x8f"
# 912 "project/radare2/binr/r2r/r2r.c"
                                                                              "    "
     "(c)ommands "
# 913 "project/radare2/binr/r2r/r2r.c" 3 4
                 "⌨" "\xef\xb8\x8f"
# 913 "project/radare2/binr/r2r/r2r.c"
                                            "    "
     "(d)iffchar "
# 914 "project/radare2/binr/r2r/r2r.c" 3 4
                 "🔍"
# 914 "project/radare2/binr/r2r/r2r.c"
                                                      "    "
     "(q)uit "
# 915 "project/radare2/binr/r2r/r2r.c" 3 4
             "🚪"
# 915 "project/radare2/binr/r2r/r2r.c"
                        "\n");
  } else {
...
# 921 "project/radare2/binr/r2r/r2r.c" 3 4
                                __stdinp
# 921 "project/radare2/binr/r2r/r2r.c"
                                     )) {
   break;
  }
  if (strlen (buf) != 2) {
...
static char *replace_lines(const char *src, size_t from, size_t to, const char *news) {
 ...
 if (!begin) {
  return 
# 981 "project/radare2/binr/r2r/r2r.c" 3 4
        ((void *)0)
# 981 "project/radare2/binr/r2r/r2r.c"
            ;
 }
...
# 1006 "project/radare2/binr/r2r/r2r.c" 3 4
                                                                   unsigned long long 
# 1006 "project/radare2/binr/r2r/r2r.c"
                                                                        start_line, 
# 1006 "project/radare2/binr/r2r/r2r.c" 3 4
                                                                                    long long 
# 1006 "project/radare2/binr/r2r/r2r.c"
...
# 1008 "project/radare2/binr/r2r/r2r.c" 3 4
for (
# 1008 "project/radare2/binr/r2r/r2r.c"
it 
# 1008 "project/radare2/binr/r2r/r2r.c" 3 4
= (void **)(
# 1008 "project/radare2/binr/r2r/r2r.c"
...
# 1008 "project/radare2/binr/r2r/r2r.c"
  ...
  test->run_line += delta;
# 1039 "project/radare2/binr/r2r/r2r.c"
...
static char *replace_cmd_kv(const char *path, const char *content, size_t line_begin, size_t line_end, const char *key, const char *value, RPVector *fixup_results) {
 ...
 if (!kv) {
  return 
# 1049 "project/radare2/binr/r2r/r2r.c" 3 4
        ((void *)0)
# 1049 "project/radare2/binr/r2r/r2r.c"
            ;
 }
 ...
 if (!newc) {
  return 
# 1055 "project/radare2/binr/r2r/r2r.c" 3 4
        ((void *)0)
# 1055 "project/radare2/binr/r2r/r2r.c"
            ;
 }
 size_t lines_before = line_end - line_begin;
 
# 1058 "project/radare2/binr/r2r/r2r.c" 3 4
long long 
# 1058 "project/radare2/binr/r2r/r2r.c"
     delta = (
# 1058 "project/radare2/binr/r2r/r2r.c" 3 4
              long long
# 1058 "project/radare2/binr/r2r/r2r.c"
...
# 1066 "project/radare2/binr/r2r/r2r.c" 3 4
                                                 unsigned long long 
# 1066 "project/radare2/binr/r2r/r2r.c"
                                                      line_begin, 
# 1066 "project/radare2/binr/r2r/r2r.c" 3 4
                                                                  unsigned long long 
# 1066 "project/radare2/binr/r2r/r2r.c"
...
# 1067 "project/radare2/binr/r2r/r2r.c" 3 4
                                    ((void *)0)
# 1067 "project/radare2/binr/r2r/r2r.c"
                                        );
 if (!content) {
  
# 1069 "project/radare2/binr/r2r/r2r.c" 3 4
 fprintf(__stderrp,
# 1069 "project/radare2/binr/r2r/r2r.c"
...
# 1077 "project/radare2/binr/r2r/r2r.c" 3 4
                              unsigned char 
# 1077 "project/radare2/binr/r2r/r2r.c"
                                  *)newc, -1, 
# 1077 "project/radare2/binr/r2r/r2r.c" 3 4
                                              0
# 1077 "project/radare2/binr/r2r/r2r.c"
...
# 1082 "project/radare2/binr/r2r/r2r.c" 3 4
 fprintf(__stderrp,
# 1082 "project/radare2/binr/r2r/r2r.c"
...
# 1088 "project/radare2/binr/r2r/r2r.c" 3 4
do { if (!(
# 1088 "project/radare2/binr/r2r/r2r.c"
...
# 1100 "project/radare2/binr/r2r/r2r.c" 3 4
do { if (!(
# 1100 "project/radare2/binr/r2r/r2r.c"
result->test->type == R2R_TEST_TYPE_CMD
# 1100 "project/radare2/binr/r2r/r2r.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1100 "project/radare2/binr/r2r/r2r.c"
...
# 1102 "project/radare2/binr/r2r/r2r.c" 3 4
unsigned long long 
# 1102 "project/radare2/binr/r2r/r2r.c"
     line_begin, line_end;
 if (test->broken.set) {
...
# 1113 "project/radare2/binr/r2r/r2r.c" 3 4
do { if (!(
# 1113 "project/radare2/binr/r2r/r2r.c"
result->test->type == R2R_TEST_TYPE_CMD
# 1113 "project/radare2/binr/r2r/r2r.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1113 "project/radare2/binr/r2r/r2r.c"
...
# 1113 "project/radare2/binr/r2r/r2r.c"
 ...
 char *name = 
# 1118 "project/radare2/binr/r2r/r2r.c" 3 4
             ((void *)0)
# 1118 "project/radare2/binr/r2r/r2r.c"
                 ;
 int fd = r_file_mkstemp ("r2r-cmds", &name);
 if (fd == -1) {
  free (name);
  
# 1122 "project/radare2/binr/r2r/r2r.c" 3 4
 fprintf(__stderrp,
# 1122 "project/radare2/binr/r2r/r2r.c"
...
# 1127 "project/radare2/binr/r2r/r2r.c" 3 4
 fprintf(__stderrp,
# 1127 "project/radare2/binr/r2r/r2r.c"
...
# 1146 "project/radare2/binr/r2r/r2r.c" 3 4
                                    ((void *)0)
# 1146 "project/radare2/binr/r2r/r2r.c"
                                        );
 if (!newcmds) {
  
# 1148 "project/radare2/binr/r2r/r2r.c" 3 4
 fprintf(__stderrp,
# 1148 "project/radare2/binr/r2r/r2r.c"
...
# 1175 "project/radare2/binr/r2r/r2r.c" 3 4
                              1
# 1175 "project/radare2/binr/r2r/r2r.c"
                                  , regexp_out);
}
