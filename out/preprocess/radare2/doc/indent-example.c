# 0 "project/radare2/doc/indent-example.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/doc/indent-example.c" 2


# 5 "project/radare2/doc/indent-example.c"
...
# 17 "project/radare2/doc/indent-example.c" 3 4
((void *)0)

# 18 "project/radare2/doc/indent-example.c"
};
...
int main(int argc, char **argv) {
 ...
 case '\0':
  ...
  r_core_seek (core, seek, 
# 32 "project/radare2/doc/indent-example.c" 3 4
                          1
# 32 "project/radare2/doc/indent-example.c"
                              );
  break;
 case '0':
  {
