# 0 "project/radare2/libr/core/vmarks.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/vmarks.c"
...
# 4 "project/radare2/libr/core/vmarks.c" 2


__attribute__((visibility("default"))) 
# 6 "project/radare2/libr/core/vmarks.c"
     void r_core_visual_mark_reset(RCore *core) {
 size_t i;
 for (i = 0; i < 
# 8 "project/radare2/libr/core/vmarks.c" 3 4
                0xFFU
# 8 "project/radare2/libr/core/vmarks.c"
                       ; i++) {
  core->marks[i] = 
# 9 "project/radare2/libr/core/vmarks.c" 3 4
                  0xFFFFFFFFFFFFFFFFULL
# 9 "project/radare2/libr/core/vmarks.c"
                          ;
 }
 core->marks_init = 
# 11 "project/radare2/libr/core/vmarks.c" 3 4
                   1
# 11 "project/radare2/libr/core/vmarks.c"
                       ;
}


# 14 "project/radare2/libr/core/vmarks.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 14 "project/radare2/libr/core/vmarks.c"
          r_core_visual_mark_dump(RCore *core) {
 size_t i;
 if (!core->marks_init) {
  return 
# 17 "project/radare2/libr/core/vmarks.c" 3 4
        0
# 17 "project/radare2/libr/core/vmarks.c"
             ;
 }
 
# 19 "project/radare2/libr/core/vmarks.c" 3 4
_Bool 
# 19 "project/radare2/libr/core/vmarks.c"
     res = 
# 19 "project/radare2/libr/core/vmarks.c" 3 4
           0
# 19 "project/radare2/libr/core/vmarks.c"
                ;
 for (i = 0; i < 
# 20 "project/radare2/libr/core/vmarks.c" 3 4
                0xFFU
# 20 "project/radare2/libr/core/vmarks.c"
                       ; i++) {
  if (core->marks[i] != 
# 21 "project/radare2/libr/core/vmarks.c" 3 4
                       0xFFFFFFFFFFFFFFFFULL
# 21 "project/radare2/libr/core/vmarks.c"
                               ) {
   if (i > 
# 22 "project/radare2/libr/core/vmarks.c" 3 4
          127
# 22 "project/radare2/libr/core/vmarks.c"
                   ) {
    r_cons_printf ("fV %zu 0x%"
# 23 "project/radare2/libr/core/vmarks.c" 3 4
                              "llx"
# 23 "project/radare2/libr/core/vmarks.c"
                                     "\n", i - 
# 23 "project/radare2/libr/core/vmarks.c" 3 4
                                               127 
# 23 "project/radare2/libr/core/vmarks.c"
    ...
    r_cons_printf ("fV %c 0x%"
# 25 "project/radare2/libr/core/vmarks.c" 3 4
                             "llx"
# 25 "project/radare2/libr/core/vmarks.c"
                                    "\n", (char)i, core->marks[i]);
   }
   res = 
# 27 "project/radare2/libr/core/vmarks.c" 3 4
        1
# 27 "project/radare2/libr/core/vmarks.c"
            ;
  }
 }
 return res;
...
# 33 "project/radare2/libr/core/vmarks.c" 3 4
__attribute__((visibility("default"))) 
# 33 "project/radare2/libr/core/vmarks.c"
     void r_core_visual_mark_set(RCore *core, 
# 33 "project/radare2/libr/core/vmarks.c" 3 4
                                              unsigned char 
# 33 "project/radare2/libr/core/vmarks.c"
                                                  ch, 
...
# 40 "project/radare2/libr/core/vmarks.c" 3 4
__attribute__((visibility("default"))) 
# 40 "project/radare2/libr/core/vmarks.c"
     void r_core_visual_mark_del(RCore *core, 
# 40 "project/radare2/libr/core/vmarks.c" 3 4
                                              unsigned char 
# 40 "project/radare2/libr/core/vmarks.c"
                                                  ch) {
 ...
 core->marks[ch] = 
# 44 "project/radare2/libr/core/vmarks.c" 3 4
                  0xFFFFFFFFFFFFFFFFULL
# 44 "project/radare2/libr/core/vmarks.c"
                          ;
}


# 47 "project/radare2/libr/core/vmarks.c" 3 4
__attribute__((visibility("default"))) 
# 47 "project/radare2/libr/core/vmarks.c"
     void r_core_visual_mark(RCore *core, 
# 47 "project/radare2/libr/core/vmarks.c" 3 4
                                          unsigned char 
# 47 "project/radare2/libr/core/vmarks.c"
                                              ch) {
 if (
# 48 "project/radare2/libr/core/vmarks.c" 3 4
    ((
# 48 "project/radare2/libr/core/vmarks.c"
    ch
# 48 "project/radare2/libr/core/vmarks.c" 3 4
    ) >= '0' && (
# 48 "project/radare2/libr/core/vmarks.c"
...
# 48 "project/radare2/libr/core/vmarks.c"
  ...
  ch += 
# 49 "project/radare2/libr/core/vmarks.c" 3 4
       127 
# 49 "project/radare2/libr/core/vmarks.c"
                 + 1;
 }
...
# 54 "project/radare2/libr/core/vmarks.c" 3 4
__attribute__((visibility("default"))) 
# 54 "project/radare2/libr/core/vmarks.c"
     void r_core_visual_mark_seek(RCore *core, 
# 54 "project/radare2/libr/core/vmarks.c" 3 4
                                               unsigned char 
# 54 "project/radare2/libr/core/vmarks.c"
                                                   ch) {
 if (core->marks_init && core->marks[ch] != 
# 55 "project/radare2/libr/core/vmarks.c" 3 4
                                           0xFFFFFFFFFFFFFFFFULL
# 55 "project/radare2/libr/core/vmarks.c"
                                                   ) {
  r_core_seek (core, core->marks[ch], 
# 56 "project/radare2/libr/core/vmarks.c" 3 4
                                     1
# 56 "project/radare2/libr/core/vmarks.c"
                                         );
 }
}
