# 0 "project/radare2/libr/core/patch.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/patch.c"
...
# 4 "project/radare2/libr/core/patch.c" 2

__attribute__((visibility("default"))) _Bool 
# 5 "project/radare2/libr/core/patch.c"
          r_core_patch_line(RCore *core, char *str) {
 char *q, *p = strchr (str + 1, ' ');
 if (!p) {
  return 
# 8 "project/radare2/libr/core/patch.c" 3 4
        0
# 8 "project/radare2/libr/core/patch.c"
             ;
 }
 *p = 0;
 for (++p; *p == ' '; p++) {
 ...
 return 
# 46 "project/radare2/libr/core/patch.c" 3 4
       1
# 46 "project/radare2/libr/core/patch.c"
           ;
}

static 
# 49 "project/radare2/libr/core/patch.c" 3 4
      _Bool 
# 49 "project/radare2/libr/core/patch.c"
           __core_patch_bracket(RCore *core, const char *str, 
# 49 "project/radare2/libr/core/patch.c" 3 4
                                                              unsigned long long 
# 49 "project/radare2/libr/core/patch.c"
                                                                   *noff) {
 ...
 if (!b) {
  return 
# 54 "project/radare2/libr/core/patch.c" 3 4
        0
# 54 "project/radare2/libr/core/patch.c"
             ;
 }
 p = off = strdup (str);
 if (!p) {
  r_buf_free (b);
  return 
# 59 "project/radare2/libr/core/patch.c" 3 4
        0
# 59 "project/radare2/libr/core/patch.c"
             ;
 }
 for (;*p;) {
  if (*p == '\n') {
  ...
  if ((q = strstr (str, "${"))) {
    ...
    *noff = r_num_math (core->num, q+2);
    r_buf_append_bytes (b, (const 
# 76 "project/radare2/libr/core/patch.c" 3 4
                                 unsigned char
# 76 "project/radare2/libr/core/patch.c"
                                    *)str, strlen (str));
    
# 77 "project/radare2/libr/core/patch.c" 3 4
   __builtin___snprintf_chk (
# 77 "project/radare2/libr/core/patch.c"
   tmp
# 77 "project/radare2/libr/core/patch.c" 3 4
   , 
# 77 "project/radare2/libr/core/patch.c"
...
# 77 "project/radare2/libr/core/patch.c"
                                                      ;
    r_buf_append_bytes (b, (const 
# 78 "project/radare2/libr/core/patch.c" 3 4
                                 unsigned char
# 78 "project/radare2/libr/core/patch.c"
                                    *)tmp, strlen (tmp));
    r_buf_append_bytes (b, (const 
# 79 "project/radare2/libr/core/patch.c" 3 4
                                 unsigned char
# 79 "project/radare2/libr/core/patch.c"
                                    *)end+1, strlen (end+1));
   }
  } else {
   r_buf_append_bytes (b, (const 
# 82 "project/radare2/libr/core/patch.c" 3 4
                                unsigned char
# 82 "project/radare2/libr/core/patch.c"
                                   *)str, strlen (str));
  }
  str = p;
 }
...
# 100 "project/radare2/libr/core/patch.c" 3 4
unsigned long long 
# 100 "project/radare2/libr/core/patch.c"
     tmpsz;
 const 
# 101 "project/radare2/libr/core/patch.c" 3 4
      unsigned char 
# 101 "project/radare2/libr/core/patch.c"
          *tmpbuf = r_buf_data (b, &tmpsz);
 r_core_write_at (core, *noff, tmpbuf, tmpsz);
 *noff += r_buf_size (b);
 free (off);
 return 
# 105 "project/radare2/libr/core/patch.c" 3 4
       1
# 105 "project/radare2/libr/core/patch.c"
           ;
}


# 108 "project/radare2/libr/core/patch.c" 3 4
__attribute__((visibility("default"))) 
# 108 "project/radare2/libr/core/patch.c"
     int r_core_patch(RCore *core, const char *patch) {
 char *p, *p0, *str;
 
# 110 "project/radare2/libr/core/patch.c" 3 4
unsigned long long 
# 110 "project/radare2/libr/core/patch.c"
     noff = 0LL;
