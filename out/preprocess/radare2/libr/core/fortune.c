# 0 "project/radare2/libr/core/fortune.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/fortune.c"
...
# 4 "project/radare2/libr/core/fortune.c" 2


# 5 "project/radare2/libr/core/fortune.c"
...
static char *getFortuneFile(RCore *core, const char *type) {
 return r_str_newf ("%s" 
# 10 "project/radare2/libr/core/fortune.c" 3 4
                   "/" "share" "/" "doc" "/" "radare2" "/" 
# 10 "project/radare2/libr/core/fortune.c"
                   "fortunes.%s",
  r_sys_prefix (
# 11 "project/radare2/libr/core/fortune.c" 3 4
               ((void *)0)
# 11 "project/radare2/libr/core/fortune.c"
                   ), type);
}


# 14 "project/radare2/libr/core/fortune.c" 3 4
__attribute__((visibility("default"))) 
# 14 "project/radare2/libr/core/fortune.c"
     void r_core_fortune_list_types(void) {
 size_t i;
 for (i = 0; i < 
# 16 "project/radare2/libr/core/fortune.c" 3 4
                (sizeof (
# 16 "project/radare2/libr/core/fortune.c"
                fortunes
# 16 "project/radare2/libr/core/fortune.c" 3 4
                ) / sizeof ((
# 16 "project/radare2/libr/core/fortune.c"
...
# 21 "project/radare2/libr/core/fortune.c" 3 4
__attribute__((visibility("default"))) 
# 21 "project/radare2/libr/core/fortune.c"
     void r_core_fortune_list(RCore *core) {

 const char *types = (char *)r_config_get (core->config, "cfg.fortunes.type");
 size_t i, j;
 for (i = 0; i < 
# 25 "project/radare2/libr/core/fortune.c" 3 4
                (sizeof (
# 25 "project/radare2/libr/core/fortune.c"
                fortunes
# 25 "project/radare2/libr/core/fortune.c" 3 4
                ) / sizeof ((
# 25 "project/radare2/libr/core/fortune.c"
...
# 25 "project/radare2/libr/core/fortune.c"
  ...
  if (strstr (types, fortunes[i])) {
   ...
   char *str = r_file_slurp (file, 
# 28 "project/radare2/libr/core/fortune.c" 3 4
                                  ((void *)0)
# 28 "project/radare2/libr/core/fortune.c"
                                      );
   if (!str) {
    free (file);
    continue;
...
static char *getrandomline(RCore *core) {
 ...
 const char *types = (char *)r_config_get (core->config, "cfg.fortunes.type");
 char *line = 
# 51 "project/radare2/libr/core/fortune.c" 3 4
             ((void *)0)
# 51 "project/radare2/libr/core/fortune.c"
                 , *templine;
 for (i = 0; i < 
# 52 "project/radare2/libr/core/fortune.c" 3 4
                (sizeof (
# 52 "project/radare2/libr/core/fortune.c"
                fortunes
# 52 "project/radare2/libr/core/fortune.c" 3 4
                ) / sizeof ((
# 52 "project/radare2/libr/core/fortune.c"
...
# 67 "project/radare2/libr/core/fortune.c" 3 4
__attribute__((visibility("default"))) 
# 67 "project/radare2/libr/core/fortune.c"
     void r_core_fortune_print_random(RCore *core) {
 ...
 if (
# 73 "project/radare2/libr/core/fortune.c" 3 4
    ((
# 73 "project/radare2/libr/core/fortune.c"
    line
# 73 "project/radare2/libr/core/fortune.c" 3 4
    ) && *(
# 73 "project/radare2/libr/core/fortune.c"
...
# 73 "project/radare2/libr/core/fortune.c"
  ...
  if (r_config_get_b (core->config, "cfg.fortunes.tts")) {
   r_sys_tts (line, 
# 80 "project/radare2/libr/core/fortune.c" 3 4
                   1
# 80 "project/radare2/libr/core/fortune.c"
                       );
  }
  free (line);
 }
