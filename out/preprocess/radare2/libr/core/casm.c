# 0 "project/radare2/libr/core/casm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/casm.c"
...
typedef int RRef;
# 4 "project/radare2/libr/core/casm.c" 2
...
# 5 "project/radare2/libr/core/casm.c" 2





# 9 "project/radare2/libr/core/casm.c"
static RCoreAsmHit * find_addr(RList *hits, 
# 9 "project/radare2/libr/core/casm.c" 3 4
                                           unsigned long long 
# 9 "project/radare2/libr/core/casm.c"
                                                addr);
static int prune_hits_in_hit_range(RList *hits, RCoreAsmHit *hit);
static int is_hit_inrange(RCoreAsmHit *hit, 
# 11 "project/radare2/libr/core/casm.c" 3 4
                                           unsigned long long 
# 11 "project/radare2/libr/core/casm.c"
                                                start_range, 
# 11 "project/radare2/libr/core/casm.c" 3 4
                                                             unsigned long long 
# 11 "project/radare2/libr/core/casm.c"
                                                                  end_range);
static int is_addr_in_range(
# 12 "project/radare2/libr/core/casm.c" 3 4
                           unsigned long long 
# 12 "project/radare2/libr/core/casm.c"
                                start, 
# 12 "project/radare2/libr/core/casm.c" 3 4
                                       unsigned long long 
# 12 "project/radare2/libr/core/casm.c"
...
# 12 "project/radare2/libr/core/casm.c"
                                                                        end_range);
static void add_hit_to_sorted_hits(RList* hits, 
# 13 "project/radare2/libr/core/casm.c" 3 4
                                               unsigned long long 
# 13 "project/radare2/libr/core/casm.c"
                                                    addr, int len, 
# 13 "project/radare2/libr/core/casm.c" 3 4
                                                                   unsigned char 
# 13 "project/radare2/libr/core/casm.c"
                                                                       is_valid);
static int prune_hits_in_addr_range(RList *hits, 
# 14 "project/radare2/libr/core/casm.c" 3 4
                                                unsigned long long 
# 14 "project/radare2/libr/core/casm.c"
                                                     addr, 
# 14 "project/radare2/libr/core/casm.c" 3 4
                                                           unsigned long long 
# 14 "project/radare2/libr/core/casm.c"
...
# 26 "project/radare2/libr/core/casm.c" 3 4
__attribute__((visibility("default"))) 
# 26 "project/radare2/libr/core/casm.c"
     RCoreAsmHit *r_core_asm_hit_new(void) {
 RCoreAsmHit *hit = 
# 27 "project/radare2/libr/core/casm.c" 3 4
                   (
# 27 "project/radare2/libr/core/casm.c"
                   RCoreAsmHit
# 27 "project/radare2/libr/core/casm.c" 3 4
                   *)calloc(1,sizeof(
# 27 "project/radare2/libr/core/casm.c"
...
# 27 "project/radare2/libr/core/casm.c"
 ...
 if (!hit) {
  return 
# 29 "project/radare2/libr/core/casm.c" 3 4
        ((void *)0)
# 29 "project/radare2/libr/core/casm.c"
            ;
 }
 hit->addr = -1;
 hit->valid = 
# 32 "project/radare2/libr/core/casm.c" 3 4
             0
# 32 "project/radare2/libr/core/casm.c"
                  ;
 return hit;
}


# 36 "project/radare2/libr/core/casm.c" 3 4
__attribute__((visibility("default"))) 
# 36 "project/radare2/libr/core/casm.c"
     RList *r_core_asm_hit_list_new(void) {
...
# 44 "project/radare2/libr/core/casm.c" 3 4
__attribute__((visibility("default"))) 
# 44 "project/radare2/libr/core/casm.c"
     void r_core_asm_hit_free(void *_hit) {
...
# 54 "project/radare2/libr/core/casm.c" 3 4
__attribute__((visibility("default"))) 
# 54 "project/radare2/libr/core/casm.c"
     char* r_core_asm_search(RCore *core, const char *input) {
 RAsmCode *acode;
 char *ret;
 if (!(acode = r_asm_massemble (core->rasm, input))) {
  return 
# 58 "project/radare2/libr/core/casm.c" 3 4
        ((void *)0)
# 58 "project/radare2/libr/core/casm.c"
            ;
 }
...
# 66 "project/radare2/libr/core/casm.c" 3 4
__attribute__((visibility("default"))) 
# 66 "project/radare2/libr/core/casm.c"
     RList *r_core_asm_strsearch(RCore *core, const char *input, 
# 66 "project/radare2/libr/core/casm.c" 3 4
                                                                 unsigned long long 
# 66 "project/radare2/libr/core/casm.c"
                                                                      from, 
# 66 "project/radare2/libr/core/casm.c" 3 4
                                                                            unsigned long long 
# 66 "project/radare2/libr/core/casm.c"
                                                                                 to, int maxhits, int regexp, int everyByte, int mode) {
 RCoreAsmHit *hit;
 RAsmOp op;
 RList *hits;
 
# 70 "project/radare2/libr/core/casm.c" 3 4
unsigned long long 
# 70 "project/radare2/libr/core/casm.c"
     at, toff = core->offset;
 
# 71 "project/radare2/libr/core/casm.c" 3 4
unsigned char 
# 71 "project/radare2/libr/core/casm.c"
    *buf;
 int align = core->search->align;
 RRegex* rx = 
# 73 "project/radare2/libr/core/casm.c" 3 4
             ((void *)0)
# 73 "project/radare2/libr/core/casm.c"
                 ;
 char *tok, *tokens[1024], *code = 
# 74 "project/radare2/libr/core/casm.c" 3 4
                                  ((void *)0)
# 74 "project/radare2/libr/core/casm.c"
                                      , *ptr;
...
# 79 "project/radare2/libr/core/casm.c" 3 4
 unsigned long long 
# 79 "project/radare2/libr/core/casm.c"
      first_match_addr = 0;

 if (!input || !*input) {
  return 
# 82 "project/radare2/libr/core/casm.c" 3 4
        ((void *)0)
# 82 "project/radare2/libr/core/casm.c"
            ;
 }
...
# 90 "project/radare2/libr/core/casm.c" 3 4
unsigned long long 
# 90 "project/radare2/libr/core/casm.c"
     usrimm = r_num_math (core->num, inp);
 
# 91 "project/radare2/libr/core/casm.c" 3 4
unsigned long long 
# 91 "project/radare2/libr/core/casm.c"
     usrimm2 = inp_arg? r_num_math (core->num, inp_arg): usrimm;
 if (usrimm > usrimm2) {
  
# 93 "project/radare2/libr/core/casm.c" 3 4
 fprintf(__stderrp,
# 93 "project/radare2/libr/core/casm.c"
...
# 93 "project/radare2/libr/core/casm.c"
                                         ;
  return 
# 94 "project/radare2/libr/core/casm.c" 3 4
        ((void *)0)
# 94 "project/radare2/libr/core/casm.c"
            ;
 }

 if (core->blocksize < 8) {
  
# 98 "project/radare2/libr/core/casm.c" 3 4
 fprintf(__stderrp,
# 98 "project/radare2/libr/core/casm.c"
...
# 98 "project/radare2/libr/core/casm.c"
                                          ;
  return 
# 99 "project/radare2/libr/core/casm.c" 3 4
        ((void *)0)
# 99 "project/radare2/libr/core/casm.c"
            ;
 }
 if (!(buf = (
# 101 "project/radare2/libr/core/casm.c" 3 4
             unsigned char 
# 101 "project/radare2/libr/core/casm.c"
                 *)calloc (core->blocksize, 1))) {
  return 
# 102 "project/radare2/libr/core/casm.c" 3 4
        ((void *)0)
# 102 "project/radare2/libr/core/casm.c"
            ;
 }
 if (!(ptr = strdup (input))) {
  free (buf);
  return 
# 106 "project/radare2/libr/core/casm.c" 3 4
        ((void *)0)
# 106 "project/radare2/libr/core/casm.c"
            ;
 }
 if (!(hits = r_core_asm_hit_list_new ())) {
  ...
  free (ptr);
  return 
# 111 "project/radare2/libr/core/casm.c" 3 4
        ((void *)0)
# 111 "project/radare2/libr/core/casm.c"
            ;
 }
 tokens[0] = 
# 113 "project/radare2/libr/core/casm.c" 3 4
            ((void *)0)
# 113 "project/radare2/libr/core/casm.c"
                ;
 for (tokcount = 0; tokcount < 
# 114 "project/radare2/libr/core/casm.c" 3 4
                              (sizeof (
# 114 "project/radare2/libr/core/casm.c"
                              tokens
# 114 "project/radare2/libr/core/casm.c" 3 4
                              ) / sizeof ((
# 114 "project/radare2/libr/core/casm.c"
...
# 114 "project/radare2/libr/core/casm.c"
                                                    - 1; tokcount++) {
  tok = strtok (tokcount? 
# 115 "project/radare2/libr/core/casm.c" 3 4
                         ((void *)0)
# 115 "project/radare2/libr/core/casm.c"
                             : ptr, ";");
  if (!tok) {
   break;
  }
 ...
 tokens[tokcount] = 
# 122 "project/radare2/libr/core/casm.c" 3 4
                   ((void *)0)
# 122 "project/radare2/libr/core/casm.c"
                       ;
 r_cons_break_push (
# 123 "project/radare2/libr/core/casm.c" 3 4
                   ((void *)0)
# 123 "project/radare2/libr/core/casm.c"
                       , 
# 123 "project/radare2/libr/core/casm.c" 3 4
                         ((void *)0)
# 123 "project/radare2/libr/core/casm.c"
 ...
 char *opst = 
# 124 "project/radare2/libr/core/casm.c" 3 4
             ((void *)0)
# 124 "project/radare2/libr/core/casm.c"
                 ;
...
# 135 "project/radare2/libr/core/casm.c" 3 4
  unsigned long long 
# 135 "project/radare2/libr/core/casm.c"
       addr = at + idx;
   if (addr >= to) {
    break;
   }
...
# 142 "project/radare2/libr/core/casm.c" 3 4
   unsigned long long 
# 142 "project/radare2/libr/core/casm.c"
        len = 
# 142 "project/radare2/libr/core/casm.c" 3 4
              (((
# 142 "project/radare2/libr/core/casm.c"
...
# 147 "project/radare2/libr/core/casm.c" 3 4
   unsigned long long 
# 147 "project/radare2/libr/core/casm.c"
        val = analop.val;
    
# 148 "project/radare2/libr/core/casm.c" 3 4
   _Bool 
# 148 "project/radare2/libr/core/casm.c"
        match = (val != 
# 148 "project/radare2/libr/core/casm.c" 3 4
                        0xFFFFFFFFFFFFFFFFULL 
# 148 "project/radare2/libr/core/casm.c"
                                 && val >= usrimm && val <= usrimm2);
    if (!match) {
     
# 150 "project/radare2/libr/core/casm.c" 3 4
    unsigned long long 
# 150 "project/radare2/libr/core/casm.c"
         val = analop.disp;
     match = (val != 
# 151 "project/radare2/libr/core/casm.c" 3 4
                    0xFFFFFFFFFFFFFFFFULL 
# 151 "project/radare2/libr/core/casm.c"
                             && val >= usrimm && val <= usrimm2);
    }
    if (!match) {
     
# 154 "project/radare2/libr/core/casm.c" 3 4
    unsigned long long 
# 154 "project/radare2/libr/core/casm.c"
         val = analop.ptr;
     match = (val != 
# 155 "project/radare2/libr/core/casm.c" 3 4
                    0xFFFFFFFFFFFFFFFFULL 
# 155 "project/radare2/libr/core/casm.c"
                             && val >= usrimm && val <= usrimm2);
    }
    if (match) {
...
# 160 "project/radare2/libr/core/casm.c" 3 4
     { free((void *)
# 160 "project/radare2/libr/core/casm.c"
     hits
# 160 "project/radare2/libr/core/casm.c" 3 4
     ); 
# 160 "project/radare2/libr/core/casm.c"
...
# 211 "project/radare2/libr/core/casm.c" 3 4
                                                   ((void *)0)
# 211 "project/radare2/libr/core/casm.c"
                                                       ;
    } else {
   ...
   if (align && align > 1) {
    if (addr % align) {
     matches = 
# 220 "project/radare2/libr/core/casm.c" 3 4
              0
# 220 "project/radare2/libr/core/casm.c"
                   ;
    }
   }
   if (matches) {
...
# 234 "project/radare2/libr/core/casm.c" 3 4
     { free((void *)
# 234 "project/radare2/libr/core/casm.c"
     hits
# 234 "project/radare2/libr/core/casm.c" 3 4
     ); 
# 234 "project/radare2/libr/core/casm.c"
...
# 246 "project/radare2/libr/core/casm.c" 3 4
    { free((void *)
# 246 "project/radare2/libr/core/casm.c"
    code
# 246 "project/radare2/libr/core/casm.c" 3 4
    ); 
# 246 "project/radare2/libr/core/casm.c"
...
# 246 "project/radare2/libr/core/casm.c"
    ...
    if (everyByte) {
     ...
     idx += 
# 268 "project/radare2/libr/core/casm.c" 3 4
           (((
# 268 "project/radare2/libr/core/casm.c"
           1
# 268 "project/radare2/libr/core/casm.c" 3 4
           )>(
# 268 "project/radare2/libr/core/casm.c"
...
# 270 "project/radare2/libr/core/casm.c" 3 4
   { free((void *)
# 270 "project/radare2/libr/core/casm.c"
   code
# 270 "project/radare2/libr/core/casm.c" 3 4
   ); 
# 270 "project/radare2/libr/core/casm.c"
...
# 273 "project/radare2/libr/core/casm.c" 3 4
  { free((void *)
# 273 "project/radare2/libr/core/casm.c"
  opst
# 273 "project/radare2/libr/core/casm.c" 3 4
  ); 
# 273 "project/radare2/libr/core/casm.c"
...
# 281 "project/radare2/libr/core/casm.c" 3 4
{ free((void *)
# 281 "project/radare2/libr/core/casm.c"
opst
# 281 "project/radare2/libr/core/casm.c" 3 4
); 
# 281 "project/radare2/libr/core/casm.c"
...
static void add_hit_to_sorted_hits(RList* hits, 
# 286 "project/radare2/libr/core/casm.c" 3 4
                                               unsigned long long 
# 286 "project/radare2/libr/core/casm.c"
                                                    addr, int len, 
# 286 "project/radare2/libr/core/casm.c" 3 4
                                                                   unsigned char 
# 286 "project/radare2/libr/core/casm.c"
 ...
 if (hit) {
  if (0) 
# 289 "project/radare2/libr/core/casm.c" 3 4
       fprintf(__stderrp,
# 289 "project/radare2/libr/core/casm.c"
       "*** Inserting instruction (valid?: %d): instr_addr: 0x%"
# 289 "project/radare2/libr/core/casm.c" 3 4
       "llx"
# 289 "project/radare2/libr/core/casm.c"
       " instr_len: %d\n", is_valid, addr, len
...
# 289 "project/radare2/libr/core/casm.c"
  ...
  hit->valid = is_valid;
  hit->code = 
# 293 "project/radare2/libr/core/casm.c" 3 4
             ((void *)0)
# 293 "project/radare2/libr/core/casm.c"
                 ;
  r_list_add_sorted (hits, hit, ((RListComparator)rcoreasm_address_comparator));
 }
}

static void add_hit_to_hits(RList* hits, 
# 298 "project/radare2/libr/core/casm.c" 3 4
                                        unsigned long long 
# 298 "project/radare2/libr/core/casm.c"
                                             addr, int len, 
# 298 "project/radare2/libr/core/casm.c" 3 4
                                                            unsigned char 
# 298 "project/radare2/libr/core/casm.c"
 ...
 if (hit) {
  if (0) 
# 301 "project/radare2/libr/core/casm.c" 3 4
       fprintf(__stderrp,
# 301 "project/radare2/libr/core/casm.c"
       "*** Inserting instruction (valid?: %d): instr_addr: 0x%"
# 301 "project/radare2/libr/core/casm.c" 3 4
       "llx"
# 301 "project/radare2/libr/core/casm.c"
...
# 301 "project/radare2/libr/core/casm.c"
  ...
  hit->valid = is_valid;
  hit->code = 
# 305 "project/radare2/libr/core/casm.c" 3 4
             ((void *)0)
# 305 "project/radare2/libr/core/casm.c"
                 ;
...
static int prune_hits_in_addr_range(RList *hits, 
# 312 "project/radare2/libr/core/casm.c" 3 4
                                                unsigned long long 
# 312 "project/radare2/libr/core/casm.c"
                                                     addr, 
# 312 "project/radare2/libr/core/casm.c" 3 4
                                                           unsigned long long 
# 312 "project/radare2/libr/core/casm.c"
...
# 312 "project/radare2/libr/core/casm.c"
                                                                         is_valid) {
 RCoreAsmHit hit = 
# 313 "project/radare2/libr/core/casm.c" 3 4
                  { 0 }
# 313 "project/radare2/libr/core/casm.c"
                         ;
 hit.addr = addr;
 hit.len = len;
 hit.valid = is_valid;
...
# 324 "project/radare2/libr/core/casm.c" 3 4
unsigned long long 
# 324 "project/radare2/libr/core/casm.c"
...
# 330 "project/radare2/libr/core/casm.c" 3 4
if (
# 330 "project/radare2/libr/core/casm.c"
hits
# 330 "project/radare2/libr/core/casm.c" 3 4
) for (
# 330 "project/radare2/libr/core/casm.c"
...
# 330 "project/radare2/libr/core/casm.c"
  ...
  if (to_check_hit && is_hit_inrange(to_check_hit, start_range, end_range)) {
   if (0) 
# 332 "project/radare2/libr/core/casm.c" 3 4
        fprintf(__stderrp,
# 332 "project/radare2/libr/core/casm.c"
        "Found hit that clashed (start: 0x%"
# 332 "project/radare2/libr/core/casm.c" 3 4
        "llx" 
# 332 "project/radare2/libr/core/casm.c"
        " - end: 0x%"
...
# 332 "project/radare2/libr/core/casm.c" 3 4
        "llx"
# 332 "project/radare2/libr/core/casm.c"
        ")\n", start_range, end_range, to_check_hit->addr, to_check_hit->len, to_check_hit->valid, to_check_hit->addr, to_check_hit->addr+to_check_hit->len
# 332 "project/radare2/libr/core/casm.c" 3 4
        )
...
# 336 "project/radare2/libr/core/casm.c"
                                        ;

   r_list_delete (hits, iter);

   to_check_hit = 
# 340 "project/radare2/libr/core/casm.c" 3 4
                 ((void *)0)
# 340 "project/radare2/libr/core/casm.c"
                     ;
   result ++;
  }
 }
...
static RCoreAsmHit * find_addr(RList *hits, 
# 347 "project/radare2/libr/core/casm.c" 3 4
                                           unsigned long long 
# 347 "project/radare2/libr/core/casm.c"
                                                addr) {

 RListIter *addr_iter = 
# 349 "project/radare2/libr/core/casm.c" 3 4
                       ((void *)0)
# 349 "project/radare2/libr/core/casm.c"
                           ;
...
static int handle_forward_disassemble(RCore* core, RList *hits, 
# 356 "project/radare2/libr/core/casm.c" 3 4
                                                               unsigned char
# 356 "project/radare2/libr/core/casm.c"
                                                                  * buf, 
# 356 "project/radare2/libr/core/casm.c" 3 4
                                                                         unsigned long long 
# 356 "project/radare2/libr/core/casm.c"
...
# 356 "project/radare2/libr/core/casm.c"
                                                                                                                                       end_addr){
 RCoreAsmHit *hit = 
# 357 "project/radare2/libr/core/casm.c" 3 4
                   ((void *)0)
# 357 "project/radare2/libr/core/casm.c"
                       , *found_addr = 
# 357 "project/radare2/libr/core/casm.c" 3 4
                                       ((void *)0)
# 357 "project/radare2/libr/core/casm.c"
...
# 359 "project/radare2/libr/core/casm.c" 3 4
unsigned long long 
# 359 "project/radare2/libr/core/casm.c"
     temp_instr_addr = current_instr_addr;
 
# 360 "project/radare2/libr/core/casm.c" 3 4
unsigned long long 
# 360 "project/radare2/libr/core/casm.c"
     tmp_current_buf_pos = current_buf_pos;
 
# 361 "project/radare2/libr/core/casm.c" 3 4
unsigned long long 
# 361 "project/radare2/libr/core/casm.c"
     start_range = current_instr_addr;
 
# 362 "project/radare2/libr/core/casm.c" 3 4
unsigned long long 
# 362 "project/radare2/libr/core/casm.c"
     end_range = end_addr;
 
# 363 "project/radare2/libr/core/casm.c" 3 4
unsigned long long 
# 363 "project/radare2/libr/core/casm.c"
     temp_instr_len = 0;
 
# 364 "project/radare2/libr/core/casm.c" 3 4
unsigned long long 
# 364 "project/radare2/libr/core/casm.c"
     start = 0, end = 0;
 
# 365 "project/radare2/libr/core/casm.c" 3 4
unsigned char 
# 365 "project/radare2/libr/core/casm.c"
    is_valid = 
# 365 "project/radare2/libr/core/casm.c" 3 4
               0
# 365 "project/radare2/libr/core/casm.c"
 ...
 while (tmp_current_buf_pos < len && temp_instr_addr < end_addr) {
  ...
  if (0) 
# 375 "project/radare2/libr/core/casm.c" 3 4
       fprintf(__stderrp,
# 375 "project/radare2/libr/core/casm.c"
       "Current position: %"
# 375 "project/radare2/libr/core/casm.c" 3 4
       "lld"
# 375 "project/radare2/libr/core/casm.c"
...
# 375 "project/radare2/libr/core/casm.c"
  ...
  if (temp_instr_len == 0){
   is_valid = 
# 379 "project/radare2/libr/core/casm.c" 3 4
             0
# 379 "project/radare2/libr/core/casm.c"
                  ;
   temp_instr_len = 1;
  } else {
   is_valid = 
# 382 "project/radare2/libr/core/casm.c" 3 4
             1
# 382 "project/radare2/libr/core/casm.c"
                 ;
  }
...
# 393 "project/radare2/libr/core/casm.c" 3 4
  unsigned int 
# 393 "project/radare2/libr/core/casm.c"
       prune_results = 0;
   ...
   if (prune_results) {
    r_list_add_sorted (hits, hit, ((RListComparator)rcoreasm_address_comparator));
    if (0) 
# 398 "project/radare2/libr/core/casm.c" 3 4
         fprintf(__stderrp,
# 398 "project/radare2/libr/core/casm.c"
...
# 400 "project/radare2/libr/core/casm.c" 3 4
   { free((void *)
# 400 "project/radare2/libr/core/casm.c"
   hit
# 400 "project/radare2/libr/core/casm.c" 3 4
   ); 
# 400 "project/radare2/libr/core/casm.c"
...
# 423 "project/radare2/libr/core/casm.c"
static int is_addr_in_range(
# 423 "project/radare2/libr/core/casm.c" 3 4
                           unsigned long long 
# 423 "project/radare2/libr/core/casm.c"
                                start, 
# 423 "project/radare2/libr/core/casm.c" 3 4
...
# 423 "project/radare2/libr/core/casm.c"
                                                                        end_range){
 int result = 
# 424 "project/radare2/libr/core/casm.c" 3 4
             0
# 424 "project/radare2/libr/core/casm.c"
                  ;
 if (start == start_range) {
  return 
# 426 "project/radare2/libr/core/casm.c" 3 4
        1
# 426 "project/radare2/libr/core/casm.c"
            ;
 }
 if (start < end && start_range < end_range) {
  ...
  if (start_range <= start && start < end_range) {
   result = 
# 431 "project/radare2/libr/core/casm.c" 3 4
           1
# 431 "project/radare2/libr/core/casm.c"
               ;
  } else if (start_range < end && end < end_range) {
   result = 
# 433 "project/radare2/libr/core/casm.c" 3 4
           1
# 433 "project/radare2/libr/core/casm.c"
               ;
  } else if ( start <= start_range && end_range < end) {
   result = 
# 435 "project/radare2/libr/core/casm.c" 3 4
           1
# 435 "project/radare2/libr/core/casm.c"
               ;
  }
  ...
  if (start < end) {
   if (start < end_range) {
    result = 
# 442 "project/radare2/libr/core/casm.c" 3 4
            1
# 442 "project/radare2/libr/core/casm.c"
                ;
   } else if (end <= end_range) {
    result = 
# 444 "project/radare2/libr/core/casm.c" 3 4
            1
# 444 "project/radare2/libr/core/casm.c"
                ;
   } else if (start_range <= start) {
    result = 
# 446 "project/radare2/libr/core/casm.c" 3 4
            1
# 446 "project/radare2/libr/core/casm.c"
                ;
   } else if (start_range < end) {
    result = 
# 448 "project/radare2/libr/core/casm.c" 3 4
            1
# 448 "project/radare2/libr/core/casm.c"
                ;
   }
   ...
   if (end < end_range) {
    result = 
# 453 "project/radare2/libr/core/casm.c" 3 4
            1
# 453 "project/radare2/libr/core/casm.c"
                ;
   } else if (end <= end_range) {
    result = 
# 455 "project/radare2/libr/core/casm.c" 3 4
            1
# 455 "project/radare2/libr/core/casm.c"
                ;
   } else if (start_range <= start) {
    result = 
# 457 "project/radare2/libr/core/casm.c" 3 4
            1
# 457 "project/radare2/libr/core/casm.c"
                ;
   }
  }
  ...
  if (start < end_range) {
   result = 
# 464 "project/radare2/libr/core/casm.c" 3 4
           1
# 464 "project/radare2/libr/core/casm.c"
               ;
  } else if (start <= start_range) {
   result = 
# 466 "project/radare2/libr/core/casm.c" 3 4
           1
# 466 "project/radare2/libr/core/casm.c"
               ;
  } else if (start_range < end) {
   result = 
# 468 "project/radare2/libr/core/casm.c" 3 4
           1
# 468 "project/radare2/libr/core/casm.c"
               ;
  }
 }
 return result;
...
static int is_hit_inrange(RCoreAsmHit *hit, 
# 474 "project/radare2/libr/core/casm.c" 3 4
                                           unsigned long long 
# 474 "project/radare2/libr/core/casm.c"
                                                start_range, 
# 474 "project/radare2/libr/core/casm.c" 3 4
                                                             unsigned long long 
# 474 "project/radare2/libr/core/casm.c"
                                                                  end_range){
 int result = 
# 475 "project/radare2/libr/core/casm.c" 3 4
             0
# 475 "project/radare2/libr/core/casm.c"
                  ;
 if (hit) {
...
# 484 "project/radare2/libr/core/casm.c" 3 4
__attribute__((visibility("default"))) 
# 484 "project/radare2/libr/core/casm.c"
     RList *r_core_asm_bwdisassemble(RCore *core, 
# 484 "project/radare2/libr/core/casm.c" 3 4
                                                  unsigned long long 
# 484 "project/radare2/libr/core/casm.c"
                                                       addr, int n, int len) {
...
# 487 "project/radare2/libr/core/casm.c" 3 4
unsigned long long 
# 487 "project/radare2/libr/core/casm.c"
     at;
 
# 488 "project/radare2/libr/core/casm.c" 3 4
unsigned int 
# 488 "project/radare2/libr/core/casm.c"
     idx = 0, hit_count;
 ...
 if (!hits) {
  return 
# 494 "project/radare2/libr/core/casm.c" 3 4
        ((void *)0)
# 494 "project/radare2/libr/core/casm.c"
            ;
 }

 len = 
# 497 "project/radare2/libr/core/casm.c" 3 4
      (((
# 497 "project/radare2/libr/core/casm.c"
      len - len % addrbytes
# 497 "project/radare2/libr/core/casm.c" 3 4
      )>(
# 497 "project/radare2/libr/core/casm.c"
...
# 497 "project/radare2/libr/core/casm.c"
 ...
 if (len < 1) {
  r_list_free (hits);
  return 
# 500 "project/radare2/libr/core/casm.c" 3 4
        ((void *)0)
# 500 "project/radare2/libr/core/casm.c"
            ;
 }

 
# 503 "project/radare2/libr/core/casm.c" 3 4
unsigned char 
# 503 "project/radare2/libr/core/casm.c"
    *buf = (
# 503 "project/radare2/libr/core/casm.c" 3 4
            unsigned char 
# 503 "project/radare2/libr/core/casm.c"
 ...
 if (!buf) {
  r_list_free (hits);
  return 
# 506 "project/radare2/libr/core/casm.c" 3 4
        ((void *)0)
# 506 "project/radare2/libr/core/casm.c"
            ;
 } else if (!hits) {
  free (buf);
  return 
# 509 "project/radare2/libr/core/casm.c" 3 4
        ((void *)0)
# 509 "project/radare2/libr/core/casm.c"
            ;
 }
 if (!r_io_read_at (core->io, addr - len / addrbytes, buf, len)) {
  ...
  free (buf);
  return 
# 514 "project/radare2/libr/core/casm.c" 3 4
        ((void *)0)
# 514 "project/radare2/libr/core/casm.c"
            ;
 }
 ...
 for (hit_count = 0; hit_count < n; hit_count++) {
  ...
  add_hit_to_hits (hits, at, instrlen, 
# 543 "project/radare2/libr/core/casm.c" 3 4
                                      1
# 543 "project/radare2/libr/core/casm.c"
                                          );
  at += instrlen;
 }
 free (buf);
...
static RList * r_core_asm_back_disassemble_all(RCore *core, 
# 550 "project/radare2/libr/core/casm.c" 3 4
                                                           unsigned long long 
# 550 "project/radare2/libr/core/casm.c"
                                                                addr, 
# 550 "project/radare2/libr/core/casm.c" 3 4
                                                                      unsigned long long 
# 550 "project/radare2/libr/core/casm.c"
...
# 550 "project/radare2/libr/core/casm.c"
 ...
 RCoreAsmHit dummy_value;
 RCoreAsmHit *hit = 
# 553 "project/radare2/libr/core/casm.c" 3 4
                   ((void *)0)
# 553 "project/radare2/libr/core/casm.c"
                       ;
 RAsmOp op;
 
# 555 "project/radare2/libr/core/casm.c" 3 4
unsigned char 
# 555 "project/radare2/libr/core/casm.c"
    *buf = (
# 555 "project/radare2/libr/core/casm.c" 3 4
            unsigned char 
# 555 "project/radare2/libr/core/casm.c"
                *)malloc (len + extra_padding);
 int current_instr_len = 0;
 
# 557 "project/radare2/libr/core/casm.c" 3 4
unsigned long long 
# 557 "project/radare2/libr/core/casm.c"
     current_instr_addr = addr,
   current_buf_pos = len - 1,
   hit_count = 0;

 
# 561 "project/radare2/libr/core/casm.c" 3 4
__builtin___memset_chk (
# 561 "project/radare2/libr/core/casm.c"
&dummy_value
# 561 "project/radare2/libr/core/casm.c" 3 4
, 
# 561 "project/radare2/libr/core/casm.c"
0, sizeof (RCoreAsmHit)
# 561 "project/radare2/libr/core/casm.c" 3 4
...
# 561 "project/radare2/libr/core/casm.c"
 ...
 if (!hits || !buf ){
  ...
  free (buf);
  return 
# 569 "project/radare2/libr/core/casm.c" 3 4
        ((void *)0)
# 569 "project/radare2/libr/core/casm.c"
            ;
 }
 ...
 if (!r_io_read_at (core->io, addr-(len+extra_padding), buf, len + extra_padding)) {
  ...
  free (buf);
  return 
# 576 "project/radare2/libr/core/casm.c" 3 4
        ((void *)0)
# 576 "project/radare2/libr/core/casm.c"
            ;
 }
 ...
 do {
  ...
  if (0) 
# 590 "project/radare2/libr/core/casm.c" 3 4
       fprintf(__stderrp,
# 590 "project/radare2/libr/core/casm.c"
       "current_buf_pos: 0x%"
# 590 "project/radare2/libr/core/casm.c" 3 4
       "llx"
# 590 "project/radare2/libr/core/casm.c"
...
# 590 "project/radare2/libr/core/casm.c"
  ...
  hit->code = 
# 595 "project/radare2/libr/core/casm.c" 3 4
             ((void *)0)
# 595 "project/radare2/libr/core/casm.c"
                 ;
  r_list_add_sorted (hits, hit, ((RListComparator)rcoreasm_address_comparator));
...
static RList *r_core_asm_back_disassemble (RCore *core, 
# 607 "project/radare2/libr/core/casm.c" 3 4
                                                       unsigned long long 
# 607 "project/radare2/libr/core/casm.c"
                                                            addr, int len, 
# 607 "project/radare2/libr/core/casm.c" 3 4
                                                                           unsigned long long 
# 607 "project/radare2/libr/core/casm.c"
...
# 610 "project/radare2/libr/core/casm.c" 3 4
unsigned char 
# 610 "project/radare2/libr/core/casm.c"
    *buf = 
# 610 "project/radare2/libr/core/casm.c" 3 4
           ((void *)0)
# 610 "project/radare2/libr/core/casm.c"
...
# 611 "project/radare2/libr/core/casm.c" 3 4
unsigned char 
# 611 "project/radare2/libr/core/casm.c"
    max_invalid_b4_exit = 4,
  last_num_invalid = 0;
 int current_instr_len = 0;
 
# 614 "project/radare2/libr/core/casm.c" 3 4
unsigned long long 
# 614 "project/radare2/libr/core/casm.c"
     current_instr_addr = addr,
  current_buf_pos = 0,
  next_buf_pos = len;
...
# 619 "project/radare2/libr/core/casm.c" 3 4
unsigned int 
# 619 "project/radare2/libr/core/casm.c"
     hit_count = 0;
 ...
 if (!hits || !buf) {
  ...
  free (buf);
  return 
# 633 "project/radare2/libr/core/casm.c" 3 4
        ((void *)0)
# 633 "project/radare2/libr/core/casm.c"
            ;
 }
 ...
 if (!r_io_read_at (core->io, (addr + extra_padding) - len, buf, len + extra_padding)) {
  ...
  free (buf);
  return 
# 640 "project/radare2/libr/core/casm.c" 3 4
        ((void *)0)
# 640 "project/radare2/libr/core/casm.c"
            ;
 }
# 657 "project/radare2/libr/core/casm.c"
 
# 657 "project/radare2/libr/core/casm.c" 3 4
__builtin___memset_chk (
# 657 "project/radare2/libr/core/casm.c"
&dummy_value
# 657 "project/radare2/libr/core/casm.c" 3 4
...
# 672 "project/radare2/libr/core/casm.c" 3 4
  unsigned int 
# 672 "project/radare2/libr/core/casm.c"
       byte_cnt = current_instr_len ? current_instr_len : 1;
   
# 673 "project/radare2/libr/core/casm.c" 3 4
  fprintf(__stderrp,
# 673 "project/radare2/libr/core/casm.c"
  "current_instr_addr: 0x%"
# 673 "project/radare2/libr/core/casm.c" 3 4
  "llx"
# 673 "project/radare2/libr/core/casm.c"
  ", current_buf_pos: 0x%"
...
# 675 "project/radare2/libr/core/casm.c" 3 4
  unsigned char 
# 675 "project/radare2/libr/core/casm.c"
      *hex_str = (
# 675 "project/radare2/libr/core/casm.c" 3 4
                  unsigned char
# 675 "project/radare2/libr/core/casm.c"
                     *)r_hex_bin2strdup(buf+current_buf_pos, byte_cnt);
   
# 676 "project/radare2/libr/core/casm.c" 3 4
  fprintf(__stderrp,
# 676 "project/radare2/libr/core/casm.c"
  "==== current_instr_bytes: %s ",hex_str
# 676 "project/radare2/libr/core/casm.c" 3 4
  )
# 676 "project/radare2/libr/core/casm.c"
                                                   ;
...
# 679 "project/radare2/libr/core/casm.c" 3 4
   fprintf(__stderrp,
# 679 "project/radare2/libr/core/casm.c"
...
# 681 "project/radare2/libr/core/casm.c" 3 4
   fprintf(__stderrp,
# 681 "project/radare2/libr/core/casm.c"
   "op.buf_asm: <invalid>\n"
# 681 "project/radare2/libr/core/casm.c" 3 4
   )
# 681 "project/radare2/libr/core/casm.c"
  ...
  if (current_instr_len == 0 || strstr (r_strbuf_get (&op.buf_asm), "invalid")) {
   ...
   add_hit_to_sorted_hits(hits, current_instr_addr, current_instr_len, 
# 690 "project/radare2/libr/core/casm.c" 3 4
                                                                                     0
# 690 "project/radare2/libr/core/casm.c"
                                                                                          );
   hit_count ++;
   last_num_invalid ++;
...
# 699 "project/radare2/libr/core/casm.c" 3 4
  unsigned int 
# 699 "project/radare2/libr/core/casm.c"
       purge_results = 0;
   
# 700 "project/radare2/libr/core/casm.c" 3 4
  unsigned char 
# 700 "project/radare2/libr/core/casm.c"
      is_valid = 
# 700 "project/radare2/libr/core/casm.c" 3 4
                 1
# 700 "project/radare2/libr/core/casm.c"
                     ;
   if (0) 
# 701 "project/radare2/libr/core/casm.c" 3 4
        fprintf(__stderrp,
# 701 "project/radare2/libr/core/casm.c"
        " handling underlap case: current_instr_addr: 0x%"
# 701 "project/radare2/libr/core/casm.c" 3 4
        "llx"
# 701 "project/radare2/libr/core/casm.c"
        ".\n", current_instr_addr
...
# 701 "project/radare2/libr/core/casm.c"
                                                                                                   ;
   purge_results = prune_hits_in_addr_range(hits, current_instr_addr, current_instr_len, 
# 702 "project/radare2/libr/core/casm.c" 3 4
                                                                                                        1
# 702 "project/radare2/libr/core/casm.c"
                                                                                                            );
   if (purge_results) {
...
# 714 "project/radare2/libr/core/casm.c" 3 4
  unsigned int 
# 714 "project/radare2/libr/core/casm.c"
       purge_results = 0;
   
# 715 "project/radare2/libr/core/casm.c" 3 4
  unsigned char 
# 715 "project/radare2/libr/core/casm.c"
      is_valid = 
# 715 "project/radare2/libr/core/casm.c" 3 4
                 1
# 715 "project/radare2/libr/core/casm.c"
                     ;
   purge_results = prune_hits_in_addr_range(hits, current_instr_addr, current_instr_len, 
# 716 "project/radare2/libr/core/casm.c" 3 4
                                                                                                        1
# 716 "project/radare2/libr/core/casm.c"
                                                                                                            );
   add_hit_to_sorted_hits(hits, current_instr_addr, current_instr_len, is_valid);
  ...
  if (0) 
# 738 "project/radare2/libr/core/casm.c" 3 4
       fprintf(__stderrp,
# 738 "project/radare2/libr/core/casm.c"
       " current_instr_addr: 0x%"
# 738 "project/radare2/libr/core/casm.c" 3 4
       "llx"
# 738 "project/radare2/libr/core/casm.c"
       " current_instr_len: %d next_instr_addr: 0x%04"
# 738 "project/radare2/libr/core/casm.c" 3 4
       "llx"
# 738 "project/radare2/libr/core/casm.c"
...
# 739 "project/radare2/libr/core/casm.c"
                                                      ;
  if (0) 
# 740 "project/radare2/libr/core/casm.c" 3 4
       fprintf(__stderrp,
# 740 "project/radare2/libr/core/casm.c"
       " hit count: %d \n", hit_count
# 740 "project/radare2/libr/core/casm.c" 3 4
       )
# 740 "project/radare2/libr/core/casm.c"
...
# 755 "project/radare2/libr/core/casm.c" 3 4
__attribute__((visibility("default"))) 
# 755 "project/radare2/libr/core/casm.c"
     RList *r_core_asm_back_disassemble_instr (RCore *core, 
# 755 "project/radare2/libr/core/casm.c" 3 4
                                                            unsigned long long 
# 755 "project/radare2/libr/core/casm.c"
                                                                 addr, int len, 
...
# 757 "project/radare2/libr/core/casm.c" 3 4
unsigned char 
# 757 "project/radare2/libr/core/casm.c"
    disassmble_each_addr = 
# 757 "project/radare2/libr/core/casm.c" 3 4
                            0
# 757 "project/radare2/libr/core/casm.c"
...
# 761 "project/radare2/libr/core/casm.c" 3 4
__attribute__((visibility("default"))) 
# 761 "project/radare2/libr/core/casm.c"
     RList *r_core_asm_back_disassemble_byte (RCore *core, 
# 761 "project/radare2/libr/core/casm.c" 3 4
                                                           unsigned long long 
# 761 "project/radare2/libr/core/casm.c"
                                                                addr, int len, 
...
# 763 "project/radare2/libr/core/casm.c" 3 4
unsigned char 
# 763 "project/radare2/libr/core/casm.c"
    disassmble_each_addr = 
# 763 "project/radare2/libr/core/casm.c" 3 4
                            1
# 763 "project/radare2/libr/core/casm.c"
...
# 769 "project/radare2/libr/core/casm.c" 3 4
__attribute__((visibility("default"))) unsigned int 
# 769 "project/radare2/libr/core/casm.c"
          r_core_asm_bwdis_len(RCore* core, int* instr_len, 
# 769 "project/radare2/libr/core/casm.c" 3 4
                                                            unsigned long long
# 769 "project/radare2/libr/core/casm.c"
                                                                * start_addr, 
...
# 770 "project/radare2/libr/core/casm.c" 3 4
unsigned int 
# 770 "project/radare2/libr/core/casm.c"
     instr_run = 0;
 RCoreAsmHit *hit;
 RListIter *iter = 
# 772 "project/radare2/libr/core/casm.c" 3 4
                  ((void *)0)
# 772 "project/radare2/libr/core/casm.c"
                      ;
...
# 783 "project/radare2/libr/core/casm.c" 3 4
 if (
# 783 "project/radare2/libr/core/casm.c"
 hits
# 783 "project/radare2/libr/core/casm.c" 3 4
 ) for (
# 783 "project/radare2/libr/core/casm.c"
