# 0 "project/radare2/libr/core/vmenus_zigns.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/vmenus_zigns.c"
...
# 4 "project/radare2/libr/core/vmenus_zigns.c" 2


# 5 "project/radare2/libr/core/vmenus_zigns.c"
typedef struct {
 
# 6 "project/radare2/libr/core/vmenus_zigns.c" 3 4
unsigned long long 
# 6 "project/radare2/libr/core/vmenus_zigns.c"
     addr;
 
# 7 "project/radare2/libr/core/vmenus_zigns.c" 3 4
unsigned long long 
# 7 "project/radare2/libr/core/vmenus_zigns.c"
     faddr;
 RAnalFunction *fcn;
 int pos;
 int cur;
...
# 13 "project/radare2/libr/core/vmenus_zigns.c" 3 4
_Bool 
# 13 "project/radare2/libr/core/vmenus_zigns.c"
     canLeft;
 
# 14 "project/radare2/libr/core/vmenus_zigns.c" 3 4
_Bool 
# 14 "project/radare2/libr/core/vmenus_zigns.c"
     canRight;
} RCoreVisualViewZigns;

static const char *cur_name = 
# 17 "project/radare2/libr/core/vmenus_zigns.c" 3 4
                             ((void *)0)
# 17 "project/radare2/libr/core/vmenus_zigns.c"
                                 ;

static char *print_item (void *_core, void *_item, 
# 19 "project/radare2/libr/core/vmenus_zigns.c" 3 4
                                                  _Bool 
# 19 "project/radare2/libr/core/vmenus_zigns.c"
                                                       selected) {
...
# 35 "project/radare2/libr/core/vmenus_zigns.c" 3 4
                             "llx"
# 35 "project/radare2/libr/core/vmenus_zigns.c"
                                    " bytes=%d/%d %20s\n", selected?'>':' ',
  item->addr, bytes_mask, bytes_size, item->name);
}

static RList *__signs(RCoreVisualViewZigns *status, 
# 39 "project/radare2/libr/core/vmenus_zigns.c" 3 4
                                                   unsigned long long 
# 39 "project/radare2/libr/core/vmenus_zigns.c"
                                                        addr, 
# 39 "project/radare2/libr/core/vmenus_zigns.c" 3 4
                                                              _Bool 
# 39 "project/radare2/libr/core/vmenus_zigns.c"
...
# 44 "project/radare2/libr/core/vmenus_zigns.c" 3 4
__attribute__((visibility("default"))) 
# 44 "project/radare2/libr/core/vmenus_zigns.c"
     int __core_visual_view_zigns_update(RCore *core, RCoreVisualViewZigns *status) {
 int h, w = r_cons_get_size (&h);
 r_cons_clear00 ();
 int colh = h -2;
 int colw = w -1;
 RList *col0 = __signs (status, status->addr, 
# 49 "project/radare2/libr/core/vmenus_zigns.c" 3 4
                                             1
# 49 "project/radare2/libr/core/vmenus_zigns.c"
                                                 );
 char *col0str = r_str_widget_list (core, col0, colh, status->cur, print_item);

 char *title = r_str_newf ("[r2-visual-signatures] 0x%08"
# 52 "project/radare2/libr/core/vmenus_zigns.c" 3 4
                                                        "llx"
# 52 "project/radare2/libr/core/vmenus_zigns.c"
                                                               " 0x%08"
# 52 "project/radare2/libr/core/vmenus_zigns.c" 3 4
                                                                       "llx"
# 52 "project/radare2/libr/core/vmenus_zigns.c"
...
# 63 "project/radare2/libr/core/vmenus_zigns.c" 3 4
__attribute__((visibility("default"))) 
# 63 "project/radare2/libr/core/vmenus_zigns.c"
     int r_core_visual_view_zigns(RCore *core) {
 RCoreVisualViewZigns status = {0};
 status.core = core;
 status.addr = core->offset;
 status.fcn = 
# 67 "project/radare2/libr/core/vmenus_zigns.c" 3 4
             ((void *)0)
# 67 "project/radare2/libr/core/vmenus_zigns.c"
                 ;

 while (
# 69 "project/radare2/libr/core/vmenus_zigns.c" 3 4
       1
# 69 "project/radare2/libr/core/vmenus_zigns.c"
           ) {
  __core_visual_view_zigns_update (core, &status);
  int ch = r_cons_readchar ();
  if (ch == -1 || ch == 4) {
   return 
# 73 "project/radare2/libr/core/vmenus_zigns.c" 3 4
         1
# 73 "project/radare2/libr/core/vmenus_zigns.c"
             ;
  }
...
# 101 "project/radare2/libr/core/vmenus_zigns.c" 3 4
   { free((void *)
# 101 "project/radare2/libr/core/vmenus_zigns.c"
   cur_name
# 101 "project/radare2/libr/core/vmenus_zigns.c" 3 4
   ); 
# 101 "project/radare2/libr/core/vmenus_zigns.c"
...
# 101 "project/radare2/libr/core/vmenus_zigns.c"
  ...
  case '\n':
   if (status.pos) {
    r_core_seek (core, status.faddr, 
# 122 "project/radare2/libr/core/vmenus_zigns.c" 3 4
                                    1
# 122 "project/radare2/libr/core/vmenus_zigns.c"
                                        );
   } else {
    r_core_seek (core, status.addr, 
# 124 "project/radare2/libr/core/vmenus_zigns.c" 3 4
                                   1
# 124 "project/radare2/libr/core/vmenus_zigns.c"
                                       );
   }
   return 
# 126 "project/radare2/libr/core/vmenus_zigns.c" 3 4
         1
# 126 "project/radare2/libr/core/vmenus_zigns.c"
             ;
   break;
  case '_':
   r_core_cmd0 (core, "z*~...");
  ...
  case '?':
   ...
   r_cons_flush ();
   r_cons_any_key (
# 152 "project/radare2/libr/core/vmenus_zigns.c" 3 4
                  ((void *)0)
# 152 "project/radare2/libr/core/vmenus_zigns.c"
                      );
   break;
  case 'q':
   
# 155 "project/radare2/libr/core/vmenus_zigns.c" 3 4
  { free((void *)
# 155 "project/radare2/libr/core/vmenus_zigns.c"
  cur_name
# 155 "project/radare2/libr/core/vmenus_zigns.c" 3 4
  ); 
# 155 "project/radare2/libr/core/vmenus_zigns.c"
...
# 155 "project/radare2/libr/core/vmenus_zigns.c"
                   ;
   return 
# 156 "project/radare2/libr/core/vmenus_zigns.c" 3 4
         0
# 156 "project/radare2/libr/core/vmenus_zigns.c"
              ;
  case ':':
   {
   char cmd[1024];
   r_cons_show_cursor (
# 160 "project/radare2/libr/core/vmenus_zigns.c" 3 4
                      1
# 160 "project/radare2/libr/core/vmenus_zigns.c"
                          );
   r_cons_set_raw (0);
   cmd[0]='\0';
   r_line_set_prompt (":> ");
   if (r_cons_fgets (cmd, sizeof (cmd), 0, 
# 164 "project/radare2/libr/core/vmenus_zigns.c" 3 4
                                          ((void *)0)
# 164 "project/radare2/libr/core/vmenus_zigns.c"
                                              ) < 0) {
    cmd[0] = '\0';
   }
   ...
   r_cons_set_raw (1);
   r_cons_show_cursor (
# 169 "project/radare2/libr/core/vmenus_zigns.c" 3 4
                      0
# 169 "project/radare2/libr/core/vmenus_zigns.c"
                           );
   if (cmd[0]) {
    r_cons_any_key (
# 171 "project/radare2/libr/core/vmenus_zigns.c" 3 4
                   ((void *)0)
# 171 "project/radare2/libr/core/vmenus_zigns.c"
                       );
   }
   r_cons_clear ();
   }
 ...
 return 
# 178 "project/radare2/libr/core/vmenus_zigns.c" 3 4
       0
# 178 "project/radare2/libr/core/vmenus_zigns.c"
            ;
}
