# 0 "project/radare2/libr/core/cmd_cmp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/cmd_cmp.c"
...
# 4 "project/radare2/libr/core/cmd_cmp.c" 2


# 5 "project/radare2/libr/core/cmd_cmp.c"
...
# 10 "project/radare2/libr/core/cmd_cmp.c" 3 4
((void *)0)

# 11 "project/radare2/libr/core/cmd_cmp.c"
};
...
# 41 "project/radare2/libr/core/cmd_cmp.c" 3 4
((void *)0)

# 42 "project/radare2/libr/core/cmd_cmp.c"
};


# 44 "project/radare2/libr/core/cmd_cmp.c" 3 4
__attribute__((visibility("default"))) 
# 44 "project/radare2/libr/core/cmd_cmp.c"
     void r_core_cmpwatch_free(RCoreCmpWatcher *w) {
 free (w->ndata);
 free (w->odata);
 free (w);
}
...
# 50 "project/radare2/libr/core/cmd_cmp.c" 3 4
__attribute__((visibility("default"))) 
# 50 "project/radare2/libr/core/cmd_cmp.c"
     RCoreCmpWatcher *r_core_cmpwatch_get(RCore *core, 
# 50 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                                       unsigned long long 
# 50 "project/radare2/libr/core/cmd_cmp.c"
                                                            addr) {
...
# 53 "project/radare2/libr/core/cmd_cmp.c" 3 4
if (
# 53 "project/radare2/libr/core/cmd_cmp.c"
core->watchers
# 53 "project/radare2/libr/core/cmd_cmp.c" 3 4
) for (
# 53 "project/radare2/libr/core/cmd_cmp.c"
...
# 53 "project/radare2/libr/core/cmd_cmp.c"
 ...
 return 
# 58 "project/radare2/libr/core/cmd_cmp.c" 3 4
       ((void *)0)
# 58 "project/radare2/libr/core/cmd_cmp.c"
           ;
}


# 61 "project/radare2/libr/core/cmd_cmp.c" 3 4
__attribute__((visibility("default"))) 
# 61 "project/radare2/libr/core/cmd_cmp.c"
     int r_core_cmpwatch_add(RCore *core, 
# 61 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                          unsigned long long 
# 61 "project/radare2/libr/core/cmd_cmp.c"
                                               addr, int size, const char *cmd) {
 RCoreCmpWatcher *cmpw;
 if (size < 1) {
  return 
# 64 "project/radare2/libr/core/cmd_cmp.c" 3 4
        0
# 64 "project/radare2/libr/core/cmd_cmp.c"
             ;
 }
 cmpw = r_core_cmpwatch_get (core, addr);
 if (!cmpw) {
  cmpw = 
# 68 "project/radare2/libr/core/cmd_cmp.c" 3 4
        (
# 68 "project/radare2/libr/core/cmd_cmp.c"
        RCoreCmpWatcher
# 68 "project/radare2/libr/core/cmd_cmp.c" 3 4
        *)malloc(sizeof(
# 68 "project/radare2/libr/core/cmd_cmp.c"
...
# 68 "project/radare2/libr/core/cmd_cmp.c"
  ...
  if (!cmpw) {
   return 
# 70 "project/radare2/libr/core/cmd_cmp.c" 3 4
         0
# 70 "project/radare2/libr/core/cmd_cmp.c"
              ;
  }
  cmpw->addr = addr;
 }
...
# 75 "project/radare2/libr/core/cmd_cmp.c" 3 4
__builtin___snprintf_chk (
# 75 "project/radare2/libr/core/cmd_cmp.c"
cmpw->cmd
# 75 "project/radare2/libr/core/cmd_cmp.c" 3 4
, 
# 75 "project/radare2/libr/core/cmd_cmp.c"
...
# 75 "project/radare2/libr/core/cmd_cmp.c"
                                                   ;
 cmpw->odata = 
# 76 "project/radare2/libr/core/cmd_cmp.c" 3 4
              ((void *)0)
# 76 "project/radare2/libr/core/cmd_cmp.c"
                  ;
 cmpw->ndata = malloc (size);
 if (!cmpw->ndata) {
  free (cmpw);
  return 
# 80 "project/radare2/libr/core/cmd_cmp.c" 3 4
        0
# 80 "project/radare2/libr/core/cmd_cmp.c"
             ;
 }
 r_io_read_at (core->io, addr, cmpw->ndata, size);
 r_list_append (core->watchers, cmpw);
 return 
# 84 "project/radare2/libr/core/cmd_cmp.c" 3 4
       1
# 84 "project/radare2/libr/core/cmd_cmp.c"
           ;
}


# 87 "project/radare2/libr/core/cmd_cmp.c" 3 4
__attribute__((visibility("default"))) 
# 87 "project/radare2/libr/core/cmd_cmp.c"
     int r_core_cmpwatch_del(RCore *core, 
# 87 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                          unsigned long long 
# 87 "project/radare2/libr/core/cmd_cmp.c"
                                               addr) {
 int ret = 
# 88 "project/radare2/libr/core/cmd_cmp.c" 3 4
          0
# 88 "project/radare2/libr/core/cmd_cmp.c"
               ;
 RCoreCmpWatcher *w;
 RListIter *iter, *iter2;
 
# 91 "project/radare2/libr/core/cmd_cmp.c" 3 4
if (
# 91 "project/radare2/libr/core/cmd_cmp.c"
core->watchers
# 91 "project/radare2/libr/core/cmd_cmp.c" 3 4
) for (
# 91 "project/radare2/libr/core/cmd_cmp.c"
...
# 91 "project/radare2/libr/core/cmd_cmp.c"
                                                     {
  if (w->addr == addr || addr == 
# 92 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                0xFFFFFFFFFFFFFFFFULL
# 92 "project/radare2/libr/core/cmd_cmp.c"
                                        ) {
   r_list_delete (core->watchers, iter);
   ret = 
# 94 "project/radare2/libr/core/cmd_cmp.c" 3 4
        1
# 94 "project/radare2/libr/core/cmd_cmp.c"
            ;
  }
 }
 return ret;
...
# 100 "project/radare2/libr/core/cmd_cmp.c" 3 4
__attribute__((visibility("default"))) 
# 100 "project/radare2/libr/core/cmd_cmp.c"
     int r_core_cmpwatch_show(RCore *core, 
# 100 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                           unsigned long long 
# 100 "project/radare2/libr/core/cmd_cmp.c"
                                                addr, int mode) {
...
# 104 "project/radare2/libr/core/cmd_cmp.c" 3 4
if (
# 104 "project/radare2/libr/core/cmd_cmp.c"
core->watchers
# 104 "project/radare2/libr/core/cmd_cmp.c" 3 4
) for (
# 104 "project/radare2/libr/core/cmd_cmp.c"
...
# 104 "project/radare2/libr/core/cmd_cmp.c"
  ...
  switch (mode) {
  case '*':
   r_cons_printf ("cw 0x%08"
# 108 "project/radare2/libr/core/cmd_cmp.c" 3 4
                           "llx" 
# 108 "project/radare2/libr/core/cmd_cmp.c"
                                   " %d %s%s\n",
  ...
  case 'd':
   if (is_diff) {
    r_cons_printf ("0x%08"
# 113 "project/radare2/libr/core/cmd_cmp.c" 3 4
                         "llx" 
# 113 "project/radare2/libr/core/cmd_cmp.c"
                                 " has changed\n", w->addr);
   }
   break;
  case 'o':
  ...
  default:
   r_cons_printf ("0x%08"
# 119 "project/radare2/libr/core/cmd_cmp.c" 3 4
                        "llx" 
# 119 "project/radare2/libr/core/cmd_cmp.c"
                                "%s\n", w->addr, is_diff? " modified": "");
   
# 120 "project/radare2/libr/core/cmd_cmp.c" 3 4
  __builtin___snprintf_chk (
# 120 "project/radare2/libr/core/cmd_cmp.c"
  cmd
# 120 "project/radare2/libr/core/cmd_cmp.c" 3 4
  , 
# 120 "project/radare2/libr/core/cmd_cmp.c"
...
# 120 "project/radare2/libr/core/cmd_cmp.c" 3 4
  "lld" 
# 120 "project/radare2/libr/core/cmd_cmp.c"
  "!%d", w->cmd, w->addr, w->size
# 120 "project/radare2/libr/core/cmd_cmp.c" 3 4
  )
                             
# 121 "project/radare2/libr/core/cmd_cmp.c"
                            ;
 ...
 return 
# 126 "project/radare2/libr/core/cmd_cmp.c" 3 4
       0
# 126 "project/radare2/libr/core/cmd_cmp.c"
            ;
}


# 129 "project/radare2/libr/core/cmd_cmp.c" 3 4
__attribute__((visibility("default"))) 
# 129 "project/radare2/libr/core/cmd_cmp.c"
     int r_core_cmpwatch_update(RCore *core, 
# 129 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                             unsigned long long 
# 129 "project/radare2/libr/core/cmd_cmp.c"
                                                  addr) {
...
# 132 "project/radare2/libr/core/cmd_cmp.c" 3 4
if (
# 132 "project/radare2/libr/core/cmd_cmp.c"
core->watchers
# 132 "project/radare2/libr/core/cmd_cmp.c" 3 4
) for (
# 132 "project/radare2/libr/core/cmd_cmp.c"
...
# 132 "project/radare2/libr/core/cmd_cmp.c"
  ...
  if (!w->ndata) {
   return 
# 137 "project/radare2/libr/core/cmd_cmp.c" 3 4
         0
# 137 "project/radare2/libr/core/cmd_cmp.c"
              ;
  }
  r_io_read_at (core->io, w->addr, w->ndata, w->size);
 }
 return !
# 141 "project/radare2/libr/core/cmd_cmp.c" 3 4
        (!(
# 141 "project/radare2/libr/core/cmd_cmp.c"
        core->watchers
# 141 "project/radare2/libr/core/cmd_cmp.c" 3 4
        ) || !(
# 141 "project/radare2/libr/core/cmd_cmp.c"
...
# 144 "project/radare2/libr/core/cmd_cmp.c" 3 4
__attribute__((visibility("default"))) 
# 144 "project/radare2/libr/core/cmd_cmp.c"
     int r_core_cmpwatch_revert(RCore *core, 
# 144 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                             unsigned long long 
# 144 "project/radare2/libr/core/cmd_cmp.c"
                                                  addr) {
 RCoreCmpWatcher *w;
 int ret = 
# 146 "project/radare2/libr/core/cmd_cmp.c" 3 4
          0
# 146 "project/radare2/libr/core/cmd_cmp.c"
               ;
 RListIter *iter;
 
# 148 "project/radare2/libr/core/cmd_cmp.c" 3 4
if (
# 148 "project/radare2/libr/core/cmd_cmp.c"
core->watchers
# 148 "project/radare2/libr/core/cmd_cmp.c" 3 4
) for (
# 148 "project/radare2/libr/core/cmd_cmp.c"
...
# 148 "project/radare2/libr/core/cmd_cmp.c"
                                         {
  if (w->addr == addr || addr == 
# 149 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                0xFFFFFFFFFFFFFFFFULL
# 149 "project/radare2/libr/core/cmd_cmp.c"
                                        ) {
   if (w->odata) {
    free (w->ndata);
    w->ndata = w->odata;
    w->odata = 
# 153 "project/radare2/libr/core/cmd_cmp.c" 3 4
              ((void *)0)
# 153 "project/radare2/libr/core/cmd_cmp.c"
                  ;
    ret = 
# 154 "project/radare2/libr/core/cmd_cmp.c" 3 4
         1
# 154 "project/radare2/libr/core/cmd_cmp.c"
             ;
   }
  }
 }
...
static int radare_compare_words(RCore *core, 
# 161 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                            unsigned long long 
# 161 "project/radare2/libr/core/cmd_cmp.c"
                                                 of, 
# 161 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                                     unsigned long long 
# 161 "project/radare2/libr/core/cmd_cmp.c"
...
# 163 "project/radare2/libr/core/cmd_cmp.c" 3 4
_Bool 
# 163 "project/radare2/libr/core/cmd_cmp.c"
     useColor = r_config_get_i (core->config, "scr.color") != 0;
 utAny v0, v1;
 RConsPrintablePalette *pal = &r_cons_singleton ()->context->pal;
 for (i = 0; i < len; i+=ws) {
  
# 167 "project/radare2/libr/core/cmd_cmp.c" 3 4
 __builtin___memset_chk (
# 167 "project/radare2/libr/core/cmd_cmp.c"
 &v0
# 167 "project/radare2/libr/core/cmd_cmp.c" 3 4
 , 
# 167 "project/radare2/libr/core/cmd_cmp.c"
...
# 168 "project/radare2/libr/core/cmd_cmp.c" 3 4
 __builtin___memset_chk (
# 168 "project/radare2/libr/core/cmd_cmp.c"
 &v1
# 168 "project/radare2/libr/core/cmd_cmp.c" 3 4
 , 
# 168 "project/radare2/libr/core/cmd_cmp.c"
...
# 168 "project/radare2/libr/core/cmd_cmp.c"
                             ;
  r_io_read_at (core->io, of + i, (
# 169 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                  unsigned char
# 169 "project/radare2/libr/core/cmd_cmp.c"
                                     *)&v0, ws);
  r_io_read_at (core->io, od + i, (
# 170 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                  unsigned char
# 170 "project/radare2/libr/core/cmd_cmp.c"
                                     *)&v1, ws);
  char ch = (v0.v64 == v1.v64)? '=': '!';
  const char *color = useColor? ch == '='? "": pal->graph_false: "";
  const char *colorEnd = useColor? 
# 173 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                  "\x1b[0m"
# 173 "project/radare2/libr/core/cmd_cmp.c"
                                             : "";

  if (useColor) {
   r_cons_printf ("%s0x%08" 
# 176 "project/radare2/libr/core/cmd_cmp.c" 3 4
                           "llx"
# 176 "project/radare2/libr/core/cmd_cmp.c"
                                  "  "
# 176 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                      "\x1b[0m"
# 176 "project/radare2/libr/core/cmd_cmp.c"
   ...
   r_cons_printf ("0x%08" 
# 178 "project/radare2/libr/core/cmd_cmp.c" 3 4
                         "llx"
# 178 "project/radare2/libr/core/cmd_cmp.c"
                                "  ", of + i);
  }
  switch (ws) {
  case 1:
   r_cons_printf ("%s0x%02x %c 0x%02x%s\n", color,
    (
# 183 "project/radare2/libr/core/cmd_cmp.c" 3 4
    unsigned int
# 183 "project/radare2/libr/core/cmd_cmp.c"
        )(v0.v8 & 0xff), ch, (
# 183 "project/radare2/libr/core/cmd_cmp.c" 3 4
                              unsigned int
# 183 "project/radare2/libr/core/cmd_cmp.c"
  ...
  case 4:
   r_cons_printf ("%s0x%08"
# 190 "project/radare2/libr/core/cmd_cmp.c" 3 4
                          "x"
# 190 "project/radare2/libr/core/cmd_cmp.c"
                                 " %c 0x%08"
# 190 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                            "x"
# 190 "project/radare2/libr/core/cmd_cmp.c"
   ...
   break;
  case 8:
   r_cons_printf ("%s0x%016"
# 198 "project/radare2/libr/core/cmd_cmp.c" 3 4
                           "llx"
# 198 "project/radare2/libr/core/cmd_cmp.c"
                                  " %c 0x%016"
# 198 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                              "llx"
# 198 "project/radare2/libr/core/cmd_cmp.c"
...
static int radare_compare_unified(RCore *core, 
# 210 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                              unsigned long long 
# 210 "project/radare2/libr/core/cmd_cmp.c"
                                                   of, 
# 210 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                                       unsigned long long 
# 210 "project/radare2/libr/core/cmd_cmp.c"
...
# 212 "project/radare2/libr/core/cmd_cmp.c" 3 4
unsigned char 
# 212 "project/radare2/libr/core/cmd_cmp.c"
    *f, *d;
 if (len < 1) {
  return 
# 214 "project/radare2/libr/core/cmd_cmp.c" 3 4
        0
# 214 "project/radare2/libr/core/cmd_cmp.c"
             ;
 }
 f = malloc (len);
 if (!f) {
  return 
# 218 "project/radare2/libr/core/cmd_cmp.c" 3 4
        0
# 218 "project/radare2/libr/core/cmd_cmp.c"
             ;
 }
 d = malloc (len);
 if (!d) {
  free (f);
  return 
# 223 "project/radare2/libr/core/cmd_cmp.c" 3 4
        0
# 223 "project/radare2/libr/core/cmd_cmp.c"
             ;
 }
 r_io_read_at (core->io, of, f, len);
 r_io_read_at (core->io, od, d, len);
 int headers = 
# 227 "project/radare2/libr/core/cmd_cmp.c" 3 4
              (((
# 227 "project/radare2/libr/core/cmd_cmp.c"
              core->print->flags
# 227 "project/radare2/libr/core/cmd_cmp.c" 3 4
              ) & (1ULL << (0x00000008)))? 1: 0)
# 227 "project/radare2/libr/core/cmd_cmp.c"
...
# 229 "project/radare2/libr/core/cmd_cmp.c" 3 4
 ((
# 229 "project/radare2/libr/core/cmd_cmp.c"
 core->print->flags
# 229 "project/radare2/libr/core/cmd_cmp.c" 3 4
 ) &= ~(1ULL << (0x00000008)))
# 229 "project/radare2/libr/core/cmd_cmp.c"
 ...
 for (i = 0; i < len; i += inc) {
  min = 
# 232 "project/radare2/libr/core/cmd_cmp.c" 3 4
       (((
# 232 "project/radare2/libr/core/cmd_cmp.c"
       16
# 232 "project/radare2/libr/core/cmd_cmp.c" 3 4
       )>(
# 232 "project/radare2/libr/core/cmd_cmp.c"
...
# 244 "project/radare2/libr/core/cmd_cmp.c" 3 4
 ((
# 244 "project/radare2/libr/core/cmd_cmp.c"
 core->print->flags
# 244 "project/radare2/libr/core/cmd_cmp.c" 3 4
 ) |= (1ULL << (0x00000008)))
# 244 "project/radare2/libr/core/cmd_cmp.c"
 ...
 return 
# 246 "project/radare2/libr/core/cmd_cmp.c" 3 4
       1
# 246 "project/radare2/libr/core/cmd_cmp.c"
           ;
}

static int radare_compare(RCore *core, const 
# 249 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                            unsigned char 
# 249 "project/radare2/libr/core/cmd_cmp.c"
                                                *f, const 
# 249 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                                          unsigned char 
# 249 "project/radare2/libr/core/cmd_cmp.c"
 ...
 int i, eq = 0;
 PJ *pj = 
# 251 "project/radare2/libr/core/cmd_cmp.c" 3 4
         ((void *)0)
# 251 "project/radare2/libr/core/cmd_cmp.c"
             ;
 if (len < 1) {
  return 0;
 }
 ...
 for (i = 0; i < len; i++) {
  ...
  case 0:
   r_cons_printf ("0x%08"
# 271 "project/radare2/libr/core/cmd_cmp.c" 3 4
                        "llx" 
# 271 "project/radare2/libr/core/cmd_cmp.c"
                                " (byte=%.2d)   %02x '%c'  ->  %02x '%c'\n",
    core->offset + i, i + 1,
    f[i], (
# 273 "project/radare2/libr/core/cmd_cmp.c" 3 4
          ((
# 273 "project/radare2/libr/core/cmd_cmp.c"
          f[i]
# 273 "project/radare2/libr/core/cmd_cmp.c" 3 4
          ) >=' ' && (
# 273 "project/radare2/libr/core/cmd_cmp.c"
...
# 273 "project/radare2/libr/core/cmd_cmp.c"
    ...
    d[i], (
# 274 "project/radare2/libr/core/cmd_cmp.c" 3 4
          ((
# 274 "project/radare2/libr/core/cmd_cmp.c"
          d[i]
# 274 "project/radare2/libr/core/cmd_cmp.c" 3 4
          ) >=' ' && (
# 274 "project/radare2/libr/core/cmd_cmp.c"
...
# 274 "project/radare2/libr/core/cmd_cmp.c"
   ...
   break;
  case '*':
   r_cons_printf ("wx %02x @ 0x%08"
# 277 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                  "llx" 
# 277 "project/radare2/libr/core/cmd_cmp.c"
                                          "\n",
    d[i],
    core->offset + i);
   break;
...
# 290 "project/radare2/libr/core/cmd_cmp.c" 3 4
  fprintf(__stderrp,
# 290 "project/radare2/libr/core/cmd_cmp.c"
  "Unknown mode\n"
# 290 "project/radare2/libr/core/cmd_cmp.c" 3 4
  )
# 290 "project/radare2/libr/core/cmd_cmp.c"
...
# 295 "project/radare2/libr/core/cmd_cmp.c" 3 4
 fprintf(__stderrp,
# 295 "project/radare2/libr/core/cmd_cmp.c"
 "Compare %d/%d equal bytes (%d%%)\n", eq, len, (eq / len) * 100
# 295 "project/radare2/libr/core/cmd_cmp.c" 3 4
 )
# 295 "project/radare2/libr/core/cmd_cmp.c"
                                                                          ;
...
static void cmd_cmp_watcher(RCore *core, const char *input) {
 char *p, *q, *r = 
# 308 "project/radare2/libr/core/cmd_cmp.c" 3 4
                  ((void *)0)
# 308 "project/radare2/libr/core/cmd_cmp.c"
                      ;
 int size = 0;
 
# 310 "project/radare2/libr/core/cmd_cmp.c" 3 4
unsigned long long 
# 310 "project/radare2/libr/core/cmd_cmp.c"
     addr = 0;
 switch (*input) {
 case ' ':
  p = strdup (input + 1);
...
# 326 "project/radare2/libr/core/cmd_cmp.c" 3 4
  fprintf(__stderrp,
# 326 "project/radare2/libr/core/cmd_cmp.c"
  "Missing parameters\n"
# 326 "project/radare2/libr/core/cmd_cmp.c" 3 4
  )
# 326 "project/radare2/libr/core/cmd_cmp.c"
  ...
  break;
 case 'r':
  addr = input[1]? r_num_math (core->num, input + 1): 
# 331 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                                     0xFFFFFFFFFFFFFFFFULL
# 331 "project/radare2/libr/core/cmd_cmp.c"
                                                             ;
  r_core_cmpwatch_revert (core, addr);
  break;
 case 'u':
  addr = input[1]? r_num_math (core->num, input + 1): 
# 335 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                                     0xFFFFFFFFFFFFFFFFULL
# 335 "project/radare2/libr/core/cmd_cmp.c"
                                                             ;
  r_core_cmpwatch_update (core, addr);
  break;
 case '*':
  r_core_cmpwatch_show (core, 
# 339 "project/radare2/libr/core/cmd_cmp.c" 3 4
                             0xFFFFFFFFFFFFFFFFULL
# 339 "project/radare2/libr/core/cmd_cmp.c"
                                     , '*');
  break;
 case '\0':
  r_core_cmpwatch_show (core, 
# 342 "project/radare2/libr/core/cmd_cmp.c" 3 4
                             0xFFFFFFFFFFFFFFFFULL
# 342 "project/radare2/libr/core/cmd_cmp.c"
                                     , 0);
  break;
 case '?': {
...
# 354 "project/radare2/libr/core/cmd_cmp.c" 3 4
     ((void *)0)
     
# 355 "project/radare2/libr/core/cmd_cmp.c"
    };
...
# 368 "project/radare2/libr/core/cmd_cmp.c" 3 4
unsigned long long 
# 368 "project/radare2/libr/core/cmd_cmp.c"
     off = r_num_math (core->num, input);
 
# 369 "project/radare2/libr/core/cmd_cmp.c" 3 4
unsigned char 
# 369 "project/radare2/libr/core/cmd_cmp.c"
    *buf = calloc (core->blocksize + 32, 1);
 RConsPrintablePalette *pal = &r_cons_singleton ()->context->pal;
 if (!buf) {
  return 
# 372 "project/radare2/libr/core/cmd_cmp.c" 3 4
        0
# 372 "project/radare2/libr/core/cmd_cmp.c"
             ;
 }
 ...
 case 'd':
  {
# 389 "project/radare2/libr/core/cmd_cmp.c"
  r_core_cmdf (core, "pdc @ 0x%"
# 389 "project/radare2/libr/core/cmd_cmp.c" 3 4
                               "llx"
# 389 "project/radare2/libr/core/cmd_cmp.c"
                                      ">$a", off);
  r_core_cmdf (core, "pdc @ 0x%"
# 390 "project/radare2/libr/core/cmd_cmp.c" 3 4
                               "llx"
# 390 "project/radare2/libr/core/cmd_cmp.c"
                                      ">$b", core->offset);
...
# 408 "project/radare2/libr/core/cmd_cmp.c" 3 4
  _Bool 
# 408 "project/radare2/libr/core/cmd_cmp.c"
       iseq = r_strbuf_equals (&op.buf_asm, &op2.buf_asm);
   
# 409 "project/radare2/libr/core/cmd_cmp.c" 3 4
  __builtin___memset_chk (
# 409 "project/radare2/libr/core/cmd_cmp.c"
  colpad
# 409 "project/radare2/libr/core/cmd_cmp.c" 3 4
  , 
# 409 "project/radare2/libr/core/cmd_cmp.c"
...
# 416 "project/radare2/libr/core/cmd_cmp.c" 3 4
   r_cons_strcat (
# 416 "project/radare2/libr/core/cmd_cmp.c"
   iseq? pal->graph_true: pal->graph_false
# 416 "project/radare2/libr/core/cmd_cmp.c" 3 4
   )
# 416 "project/radare2/libr/core/cmd_cmp.c"
                                                         ;
   ...
   r_cons_printf (" 0x%08"
# 418 "project/radare2/libr/core/cmd_cmp.c" 3 4
                         "llx" 
# 418 "project/radare2/libr/core/cmd_cmp.c"
                                 "  %s %s",
    core->offset + i, r_strbuf_get (&op.buf_asm), colpad);
   r_cons_printf ("%c 0x%08"
# 420 "project/radare2/libr/core/cmd_cmp.c" 3 4
                           "llx" 
# 420 "project/radare2/libr/core/cmd_cmp.c"
                                   "  %s\n",
    iseq? '=': '!', off + j, r_strbuf_get (&op2.buf_asm));
   if (hascolor) {
    
# 423 "project/radare2/libr/core/cmd_cmp.c" 3 4
   r_cons_strcat ("\x1b[0m")
# 423 "project/radare2/libr/core/cmd_cmp.c"
                             ;
   }
   if (op.size < 1) {
    op.size = 1;
...
# 448 "project/radare2/libr/core/cmd_cmp.c" 3 4
  _Bool 
# 448 "project/radare2/libr/core/cmd_cmp.c"
       iseq = r_strbuf_equals (&op.buf_asm, &op2.buf_asm);
   if (iseq) {
    r_cons_printf (" 0x%08"
# 450 "project/radare2/libr/core/cmd_cmp.c" 3 4
                          "llx" 
# 450 "project/radare2/libr/core/cmd_cmp.c"
                                  "  %s\n",
     core->offset + i, r_strbuf_get (&op.buf_asm));
   } else {
    if (hascolor) {
     
# 454 "project/radare2/libr/core/cmd_cmp.c" 3 4
    r_cons_strcat (
# 454 "project/radare2/libr/core/cmd_cmp.c"
    pal->graph_false
# 454 "project/radare2/libr/core/cmd_cmp.c" 3 4
    )
# 454 "project/radare2/libr/core/cmd_cmp.c"
    ...
    r_cons_printf ("-0x%08"
# 456 "project/radare2/libr/core/cmd_cmp.c" 3 4
                          "llx" 
# 456 "project/radare2/libr/core/cmd_cmp.c"
                                  "  %s\n",
     core->offset + i, r_strbuf_get (&op.buf_asm));
    if (hascolor) {
     
# 459 "project/radare2/libr/core/cmd_cmp.c" 3 4
    r_cons_strcat (
# 459 "project/radare2/libr/core/cmd_cmp.c"
    pal->graph_true
# 459 "project/radare2/libr/core/cmd_cmp.c" 3 4
    )
# 459 "project/radare2/libr/core/cmd_cmp.c"
    ...
    r_cons_printf ("+0x%08"
# 461 "project/radare2/libr/core/cmd_cmp.c" 3 4
                          "llx" 
# 461 "project/radare2/libr/core/cmd_cmp.c"
                                  "  %s\n",
     off + j, r_strbuf_get (&op2.buf_asm));
    if (hascolor) {
     
# 464 "project/radare2/libr/core/cmd_cmp.c" 3 4
    r_cons_strcat ("\x1b[0m")
# 464 "project/radare2/libr/core/cmd_cmp.c"
                              ;
    }
   }
   if (op.size < 1) {
...
static int cmd_cp(void *data, const char *input) {
 ...
 if (input[1] == '.') {
  ...
  free (newfile);
  return 
# 490 "project/radare2/libr/core/cmd_cmp.c" 3 4
        1
# 490 "project/radare2/libr/core/cmd_cmp.c"
            ;
 }
 if (strlen (input) < 3) {
  
# 493 "project/radare2/libr/core/cmd_cmp.c" 3 4
 fprintf(__stderrp,
# 493 "project/radare2/libr/core/cmd_cmp.c"
 "Usage: cp src dst\n"
# 493 "project/radare2/libr/core/cmd_cmp.c" 3 4
 )
# 493 "project/radare2/libr/core/cmd_cmp.c"
...
# 494 "project/radare2/libr/core/cmd_cmp.c" 3 4
 fprintf(__stderrp,
# 494 "project/radare2/libr/core/cmd_cmp.c"
...
# 494 "project/radare2/libr/core/cmd_cmp.c"
                                                    ;
  return 
# 495 "project/radare2/libr/core/cmd_cmp.c" 3 4
        0
# 495 "project/radare2/libr/core/cmd_cmp.c"
             ;
 }
 char *cmd = strdup (input + 2);
 if (cmd) {
  char **files = r_str_argv (cmd, 
# 499 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                 ((void *)0)
# 499 "project/radare2/libr/core/cmd_cmp.c"
                                     );
  if (files[0] && files[1]) {
   
# 501 "project/radare2/libr/core/cmd_cmp.c" 3 4
  _Bool 
# 501 "project/radare2/libr/core/cmd_cmp.c"
       rc = r_file_copy (files[0], files[1]);
   free (cmd);
...
# 508 "project/radare2/libr/core/cmd_cmp.c" 3 4
fprintf(__stderrp,
# 508 "project/radare2/libr/core/cmd_cmp.c"
"Usage: cp src dst\n"
# 508 "project/radare2/libr/core/cmd_cmp.c" 3 4
)
# 508 "project/radare2/libr/core/cmd_cmp.c"
                               ;
 return 
# 509 "project/radare2/libr/core/cmd_cmp.c" 3 4
       0
# 509 "project/radare2/libr/core/cmd_cmp.c"
            ;
}

static void __core_cmp_bits (RCore *core, 
# 512 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                         unsigned long long 
# 512 "project/radare2/libr/core/cmd_cmp.c"
                                              addr) {
 const 
# 513 "project/radare2/libr/core/cmd_cmp.c" 3 4
      _Bool 
# 513 "project/radare2/libr/core/cmd_cmp.c"
           scr_color = r_config_get_i (core->config, "scr.color");
 int i;
 
# 515 "project/radare2/libr/core/cmd_cmp.c" 3 4
unsigned char 
# 515 "project/radare2/libr/core/cmd_cmp.c"
    a, b;
 r_io_read_at (core->io, core->offset, &a, 1);
 r_io_read_at (core->io, addr, &b, 1);
 RConsPrintablePalette *pal = &r_cons_singleton ()->context->pal;
 const char *color = scr_color? pal->offset: "";
 const char *color_end = scr_color? 
# 520 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                   "\x1b[0m"
# 520 "project/radare2/libr/core/cmd_cmp.c"
                                              : "";
 if (r_config_get_i (core->config, "hex.header")) {
  char *n = r_str_newf ("0x%08"
# 522 "project/radare2/libr/core/cmd_cmp.c" 3 4
                              "llx"
# 522 "project/radare2/libr/core/cmd_cmp.c"
                                     , core->offset);
 ...
 color_end = scr_color? 
# 528 "project/radare2/libr/core/cmd_cmp.c" 3 4
                       "\x1b[0m"
# 528 "project/radare2/libr/core/cmd_cmp.c"
                                  : "";

 r_cons_printf ("%s0x%08"
# 530 "project/radare2/libr/core/cmd_cmp.c" 3 4
                        "llx"
# 530 "project/radare2/libr/core/cmd_cmp.c"
                               "%s  ", color, core->offset, color_end);
 for (i = 7; i >= 0; i--) {
  
# 532 "project/radare2/libr/core/cmd_cmp.c" 3 4
 _Bool 
# 532 "project/radare2/libr/core/cmd_cmp.c"
      b0 = (a & 1<<i)? 1: 0;
  
# 533 "project/radare2/libr/core/cmd_cmp.c" 3 4
 _Bool 
# 533 "project/radare2/libr/core/cmd_cmp.c"
      b1 = (b & 1<<i)? 1: 0;
  color = scr_color? (b0 == b1)? "": b0? pal->graph_true:pal->graph_false: "";
  color_end = scr_color ? 
# 535 "project/radare2/libr/core/cmd_cmp.c" 3 4
                         "\x1b[0m"
# 535 "project/radare2/libr/core/cmd_cmp.c"
                                    : "";
  r_cons_printf ("%s%d%s ", color, b0, color_end);
 }
 color = scr_color? pal->graph_true: "";
 color_end = scr_color? 
# 539 "project/radare2/libr/core/cmd_cmp.c" 3 4
                       "\x1b[0m"
# 539 "project/radare2/libr/core/cmd_cmp.c"
                                  : "";
 r_cons_printf ("\n%s0x%08"
# 540 "project/radare2/libr/core/cmd_cmp.c" 3 4
                          "llx"
# 540 "project/radare2/libr/core/cmd_cmp.c"
                                 "%s  ", color, addr, color_end);
 for (i = 7; i >= 0; i--) {
  
# 542 "project/radare2/libr/core/cmd_cmp.c" 3 4
 _Bool 
# 542 "project/radare2/libr/core/cmd_cmp.c"
      b0 = (a & 1<<i)? 1: 0;
  
# 543 "project/radare2/libr/core/cmd_cmp.c" 3 4
 _Bool 
# 543 "project/radare2/libr/core/cmd_cmp.c"
      b1 = (b & 1<<i)? 1: 0;
  color = scr_color? (b0 == b1)? "": b1? pal->graph_true: pal->graph_false: "";
  color_end = scr_color ? 
# 545 "project/radare2/libr/core/cmd_cmp.c" 3 4
                         "\x1b[0m"
# 545 "project/radare2/libr/core/cmd_cmp.c"
                                    : "";
...
static const RList *symbols_of(RCore *core, int id0) {
 ...
 const RList *list = bf? r_bin_get_symbols (core->bin): 
# 555 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                                       ((void *)0)
# 555 "project/radare2/libr/core/cmd_cmp.c"
                                                           ;
...
static const RList *imports_of(RCore *core, int id0) {
 ...
 RBinFile *old_bf = core->bin->cur;
 r_bin_file_set_cur_binfile (core->bin, bf);
 const RList *list = bf? r_bin_get_imports (core->bin): 
# 564 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                                       ((void *)0)
# 564 "project/radare2/libr/core/cmd_cmp.c"
                                                           ;
 r_bin_file_set_cur_binfile (core->bin, old_bf);
 return list;
}
...
static const RList *libs_of(RCore *core, int id0) {
 ...
 RBinFile *old_bf = core->bin->cur;
 r_bin_file_set_cur_binfile (core->bin, bf);
 const RList *list = bf? r_bin_get_libs (core->bin): 
# 573 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                                    ((void *)0)
# 573 "project/radare2/libr/core/cmd_cmp.c"
                                                        ;
 r_bin_file_set_cur_binfile (core->bin, old_bf);
 return list;
}
...
# 582 "project/radare2/libr/core/cmd_cmp.c" 3 4
 fprintf(__stderrp,
# 582 "project/radare2/libr/core/cmd_cmp.c"
 "Missing bin object\n"
# 582 "project/radare2/libr/core/cmd_cmp.c" 3 4
 )
# 582 "project/radare2/libr/core/cmd_cmp.c"
...
# 588 "project/radare2/libr/core/cmd_cmp.c" 3 4
 fprintf(__stderrp,
# 588 "project/radare2/libr/core/cmd_cmp.c"
 "%d == %d\n", id0, id1
# 588 "project/radare2/libr/core/cmd_cmp.c" 3 4
 )
# 588 "project/radare2/libr/core/cmd_cmp.c"
...
# 591 "project/radare2/libr/core/cmd_cmp.c" 3 4
if (
# 591 "project/radare2/libr/core/cmd_cmp.c"
s0
# 591 "project/radare2/libr/core/cmd_cmp.c" 3 4
) for (
# 591 "project/radare2/libr/core/cmd_cmp.c"
...
# 592 "project/radare2/libr/core/cmd_cmp.c" 3 4
 _Bool 
# 592 "project/radare2/libr/core/cmd_cmp.c"
      found = 
# 592 "project/radare2/libr/core/cmd_cmp.c" 3 4
              0
# 592 "project/radare2/libr/core/cmd_cmp.c"
...
# 593 "project/radare2/libr/core/cmd_cmp.c" 3 4
 if (
# 593 "project/radare2/libr/core/cmd_cmp.c"
 s1
# 593 "project/radare2/libr/core/cmd_cmp.c" 3 4
 ) for (
# 593 "project/radare2/libr/core/cmd_cmp.c"
...
# 593 "project/radare2/libr/core/cmd_cmp.c"
   ...
   if (!strcmp (s, s2)) {
    found = 
# 595 "project/radare2/libr/core/cmd_cmp.c" 3 4
           1
# 595 "project/radare2/libr/core/cmd_cmp.c"
               ;
   }
  }
  r_cons_printf ("%s%s\n", found? " ": "-", s);
...
# 600 "project/radare2/libr/core/cmd_cmp.c" 3 4
if (
# 600 "project/radare2/libr/core/cmd_cmp.c"
s1
# 600 "project/radare2/libr/core/cmd_cmp.c" 3 4
) for (
# 600 "project/radare2/libr/core/cmd_cmp.c"
...
# 601 "project/radare2/libr/core/cmd_cmp.c" 3 4
 _Bool 
# 601 "project/radare2/libr/core/cmd_cmp.c"
      found = 
# 601 "project/radare2/libr/core/cmd_cmp.c" 3 4
              0
# 601 "project/radare2/libr/core/cmd_cmp.c"
...
# 602 "project/radare2/libr/core/cmd_cmp.c" 3 4
 if (
# 602 "project/radare2/libr/core/cmd_cmp.c"
 s0
# 602 "project/radare2/libr/core/cmd_cmp.c" 3 4
 ) for (
# 602 "project/radare2/libr/core/cmd_cmp.c"
...
# 602 "project/radare2/libr/core/cmd_cmp.c"
   ...
   if (!strcmp (s, s2)) {
    found = 
# 604 "project/radare2/libr/core/cmd_cmp.c" 3 4
           1
# 604 "project/radare2/libr/core/cmd_cmp.c"
               ;
   }
  }
  if (!found) {
...
# 619 "project/radare2/libr/core/cmd_cmp.c" 3 4
 fprintf(__stderrp,
# 619 "project/radare2/libr/core/cmd_cmp.c"
 "Missing bin object\n"
# 619 "project/radare2/libr/core/cmd_cmp.c" 3 4
 )
# 619 "project/radare2/libr/core/cmd_cmp.c"
...
# 625 "project/radare2/libr/core/cmd_cmp.c" 3 4
 fprintf(__stderrp,
# 625 "project/radare2/libr/core/cmd_cmp.c"
 "%d == %d\n", id0, id1
# 625 "project/radare2/libr/core/cmd_cmp.c" 3 4
 )
# 625 "project/radare2/libr/core/cmd_cmp.c"
...
# 628 "project/radare2/libr/core/cmd_cmp.c" 3 4
if (
# 628 "project/radare2/libr/core/cmd_cmp.c"
s0
# 628 "project/radare2/libr/core/cmd_cmp.c" 3 4
) for (
# 628 "project/radare2/libr/core/cmd_cmp.c"
...
# 629 "project/radare2/libr/core/cmd_cmp.c" 3 4
 _Bool 
# 629 "project/radare2/libr/core/cmd_cmp.c"
      found = 
# 629 "project/radare2/libr/core/cmd_cmp.c" 3 4
              0
# 629 "project/radare2/libr/core/cmd_cmp.c"
...
# 630 "project/radare2/libr/core/cmd_cmp.c" 3 4
 if (
# 630 "project/radare2/libr/core/cmd_cmp.c"
 s1
# 630 "project/radare2/libr/core/cmd_cmp.c" 3 4
 ) for (
# 630 "project/radare2/libr/core/cmd_cmp.c"
...
# 630 "project/radare2/libr/core/cmd_cmp.c"
   ...
   if (!strcmp (s->name, s2->name)) {
    found = 
# 632 "project/radare2/libr/core/cmd_cmp.c" 3 4
           1
# 632 "project/radare2/libr/core/cmd_cmp.c"
               ;
   }
  }
  r_cons_printf ("%s%s\n", found? " ": "-", s->name);
...
# 637 "project/radare2/libr/core/cmd_cmp.c" 3 4
if (
# 637 "project/radare2/libr/core/cmd_cmp.c"
s1
# 637 "project/radare2/libr/core/cmd_cmp.c" 3 4
) for (
# 637 "project/radare2/libr/core/cmd_cmp.c"
...
# 638 "project/radare2/libr/core/cmd_cmp.c" 3 4
 _Bool 
# 638 "project/radare2/libr/core/cmd_cmp.c"
      found = 
# 638 "project/radare2/libr/core/cmd_cmp.c" 3 4
              0
# 638 "project/radare2/libr/core/cmd_cmp.c"
...
# 639 "project/radare2/libr/core/cmd_cmp.c" 3 4
 if (
# 639 "project/radare2/libr/core/cmd_cmp.c"
 s0
# 639 "project/radare2/libr/core/cmd_cmp.c" 3 4
 ) for (
# 639 "project/radare2/libr/core/cmd_cmp.c"
...
# 639 "project/radare2/libr/core/cmd_cmp.c"
   ...
   if (!strcmp (s->name, s2->name)) {
    found = 
# 641 "project/radare2/libr/core/cmd_cmp.c" 3 4
           1
# 641 "project/radare2/libr/core/cmd_cmp.c"
               ;
   }
  }
  if (!found) {
...
# 656 "project/radare2/libr/core/cmd_cmp.c" 3 4
 fprintf(__stderrp,
# 656 "project/radare2/libr/core/cmd_cmp.c"
 "Missing bin object\n"
# 656 "project/radare2/libr/core/cmd_cmp.c" 3 4
 )
# 656 "project/radare2/libr/core/cmd_cmp.c"
...
# 662 "project/radare2/libr/core/cmd_cmp.c" 3 4
 fprintf(__stderrp,
# 662 "project/radare2/libr/core/cmd_cmp.c"
 "%d == %d\n", id0, id1
# 662 "project/radare2/libr/core/cmd_cmp.c" 3 4
 )
# 662 "project/radare2/libr/core/cmd_cmp.c"
...
# 665 "project/radare2/libr/core/cmd_cmp.c" 3 4
if (
# 665 "project/radare2/libr/core/cmd_cmp.c"
s0
# 665 "project/radare2/libr/core/cmd_cmp.c" 3 4
) for (
# 665 "project/radare2/libr/core/cmd_cmp.c"
...
# 666 "project/radare2/libr/core/cmd_cmp.c" 3 4
 _Bool 
# 666 "project/radare2/libr/core/cmd_cmp.c"
      found = 
# 666 "project/radare2/libr/core/cmd_cmp.c" 3 4
              0
# 666 "project/radare2/libr/core/cmd_cmp.c"
...
# 667 "project/radare2/libr/core/cmd_cmp.c" 3 4
 if (
# 667 "project/radare2/libr/core/cmd_cmp.c"
 s1
# 667 "project/radare2/libr/core/cmd_cmp.c" 3 4
 ) for (
# 667 "project/radare2/libr/core/cmd_cmp.c"
...
# 667 "project/radare2/libr/core/cmd_cmp.c"
   ...
   if (!strcmp (s->name, s2->name)) {
    found = 
# 669 "project/radare2/libr/core/cmd_cmp.c" 3 4
           1
# 669 "project/radare2/libr/core/cmd_cmp.c"
               ;
   }
  }
  r_cons_printf ("%s%s\n", found? " ": "-", s->name);
...
# 674 "project/radare2/libr/core/cmd_cmp.c" 3 4
if (
# 674 "project/radare2/libr/core/cmd_cmp.c"
s1
# 674 "project/radare2/libr/core/cmd_cmp.c" 3 4
) for (
# 674 "project/radare2/libr/core/cmd_cmp.c"
...
# 675 "project/radare2/libr/core/cmd_cmp.c" 3 4
 _Bool 
# 675 "project/radare2/libr/core/cmd_cmp.c"
      found = 
# 675 "project/radare2/libr/core/cmd_cmp.c" 3 4
              0
# 675 "project/radare2/libr/core/cmd_cmp.c"
...
# 676 "project/radare2/libr/core/cmd_cmp.c" 3 4
 if (
# 676 "project/radare2/libr/core/cmd_cmp.c"
 s0
# 676 "project/radare2/libr/core/cmd_cmp.c" 3 4
 ) for (
# 676 "project/radare2/libr/core/cmd_cmp.c"
...
# 676 "project/radare2/libr/core/cmd_cmp.c"
   ...
   if (!strcmp (s->name, s2->name)) {
    found = 
# 678 "project/radare2/libr/core/cmd_cmp.c" 3 4
           1
# 678 "project/radare2/libr/core/cmd_cmp.c"
               ;
   }
  }
  if (!found) {
...
static int cmd_cmp(void *data, const char *input) {
 static char *oldcwd = 
# 709 "project/radare2/libr/core/cmd_cmp.c" 3 4
                      ((void *)0)
# 709 "project/radare2/libr/core/cmd_cmp.c"
                          ;
 int ret = 0, i, mode = 0;
 RCore *core = (RCore *)data;
 
# 712 "project/radare2/libr/core/cmd_cmp.c" 3 4
unsigned long long 
# 712 "project/radare2/libr/core/cmd_cmp.c"
     val = 
# 712 "project/radare2/libr/core/cmd_cmp.c" 3 4
           0xFFFFFFFFFFFFFFFFULL
# 712 "project/radare2/libr/core/cmd_cmp.c"
...
# 714 "project/radare2/libr/core/cmd_cmp.c" 3 4
unsigned char 
# 714 "project/radare2/libr/core/cmd_cmp.c"
    *buf;
 
# 715 "project/radare2/libr/core/cmd_cmp.c" 3 4
unsigned short 
# 715 "project/radare2/libr/core/cmd_cmp.c"
     v16;
 
# 716 "project/radare2/libr/core/cmd_cmp.c" 3 4
unsigned int 
# 716 "project/radare2/libr/core/cmd_cmp.c"
     v32;
 
# 717 "project/radare2/libr/core/cmd_cmp.c" 3 4
unsigned long long 
# 717 "project/radare2/libr/core/cmd_cmp.c"
     v64;
 FILE *fd;
 const 
# 719 "project/radare2/libr/core/cmd_cmp.c" 3 4
      unsigned char
# 719 "project/radare2/libr/core/cmd_cmp.c"
         * block = core->block;
...
# 729 "project/radare2/libr/core/cmd_cmp.c" 3 4
   fprintf(__stderrp,
# 729 "project/radare2/libr/core/cmd_cmp.c"
   "No alias name given.\n"
# 729 "project/radare2/libr/core/cmd_cmp.c" 3 4
   )
# 729 "project/radare2/libr/core/cmd_cmp.c"
...
# 737 "project/radare2/libr/core/cmd_cmp.c" 3 4
    fprintf(__stderrp,
# 737 "project/radare2/libr/core/cmd_cmp.c"
    "No such alias \"$%s\"\n", path+1
# 737 "project/radare2/libr/core/cmd_cmp.c" 3 4
    )
# 737 "project/radare2/libr/core/cmd_cmp.c"
...
# 745 "project/radare2/libr/core/cmd_cmp.c" 3 4
     r_cons_strcat (
# 745 "project/radare2/libr/core/cmd_cmp.c"
     res
# 745 "project/radare2/libr/core/cmd_cmp.c" 3 4
     )
# 745 "project/radare2/libr/core/cmd_cmp.c"
...
# 757 "project/radare2/libr/core/cmd_cmp.c" 3 4
  fprintf(__stderrp,
# 757 "project/radare2/libr/core/cmd_cmp.c"
  "Usage: cx* 00..22'\n"
# 757 "project/radare2/libr/core/cmd_cmp.c" 3 4
  )
# 757 "project/radare2/libr/core/cmd_cmp.c"
  ...
  val = radare_compare (core, block, (
# 761 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                     unsigned char 
# 761 "project/radare2/libr/core/cmd_cmp.c"
                                         *) input + 2,
   strlen (input + 2) + 1, '*');
  break;
 case ' ':
 {
  ...
  val = radare_compare (core, block, (
# 768 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                     unsigned char 
# 768 "project/radare2/libr/core/cmd_cmp.c"
                                         *) str, len, 0);
  free (str);
 }
 break;
...
# 775 "project/radare2/libr/core/cmd_cmp.c" 3 4
  fprintf(__stderrp,
# 775 "project/radare2/libr/core/cmd_cmp.c"
  "Usage: cj [string]\n"
# 775 "project/radare2/libr/core/cmd_cmp.c" 3 4
  )
# 775 "project/radare2/libr/core/cmd_cmp.c"
   ...
   int len = r_str_unescape (str);
   val = radare_compare (core, block, (
# 779 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                      unsigned char 
# 779 "project/radare2/libr/core/cmd_cmp.c"
                                          *) str, len, 'j');
   free (str);
  }
 }
...
# 792 "project/radare2/libr/core/cmd_cmp.c" 3 4
   fprintf(__stderrp,
# 792 "project/radare2/libr/core/cmd_cmp.c"
   "Usage: cx* 00..22'\n"
# 792 "project/radare2/libr/core/cmd_cmp.c" 3 4
   )
# 792 "project/radare2/libr/core/cmd_cmp.c"
...
# 799 "project/radare2/libr/core/cmd_cmp.c" 3 4
  fprintf(__stderrp,
# 799 "project/radare2/libr/core/cmd_cmp.c"
  "Usage: cx 00..22'\n"
# 799 "project/radare2/libr/core/cmd_cmp.c" 3 4
  )
# 799 "project/radare2/libr/core/cmd_cmp.c"
  ...
  if (!(filled = (char *) malloc (strlen (input) + 1))) {
   return 
# 803 "project/radare2/libr/core/cmd_cmp.c" 3 4
         0
# 803 "project/radare2/libr/core/cmd_cmp.c"
              ;
  }
  
# 805 "project/radare2/libr/core/cmd_cmp.c" 3 4
 __builtin___memcpy_chk (
# 805 "project/radare2/libr/core/cmd_cmp.c"
 filled
# 805 "project/radare2/libr/core/cmd_cmp.c" 3 4
 , 
# 805 "project/radare2/libr/core/cmd_cmp.c"
...
# 805 "project/radare2/libr/core/cmd_cmp.c"
                                           ;
  if (!(buf = (
# 806 "project/radare2/libr/core/cmd_cmp.c" 3 4
              unsigned char 
# 806 "project/radare2/libr/core/cmd_cmp.c"
                  *) malloc (strlen (input) + 1))) {
   free (filled);
   return 
# 808 "project/radare2/libr/core/cmd_cmp.c" 3 4
         0
# 808 "project/radare2/libr/core/cmd_cmp.c"
              ;
  }
...
# 819 "project/radare2/libr/core/cmd_cmp.c" 3 4
  fprintf(__stderrp,
# 819 "project/radare2/libr/core/cmd_cmp.c"
  "Cannot parse hexpair\n"
# 819 "project/radare2/libr/core/cmd_cmp.c" 3 4
  )
# 819 "project/radare2/libr/core/cmd_cmp.c"
                                    ;
...
# 831 "project/radare2/libr/core/cmd_cmp.c" 3 4
   fprintf(__stderrp,
# 831 "project/radare2/libr/core/cmd_cmp.c"
   "Cannot read hexdump\n"
# 831 "project/radare2/libr/core/cmd_cmp.c" 3 4
   )
# 831 "project/radare2/libr/core/cmd_cmp.c"
...
# 840 "project/radare2/libr/core/cmd_cmp.c" 3 4
  fprintf(__stderrp,
# 840 "project/radare2/libr/core/cmd_cmp.c"
  "Please. use 'cf [file]'\n"
# 840 "project/radare2/libr/core/cmd_cmp.c" 3 4
  )
# 840 "project/radare2/libr/core/cmd_cmp.c"
                                       ;
   return 
# 841 "project/radare2/libr/core/cmd_cmp.c" 3 4
         0
# 841 "project/radare2/libr/core/cmd_cmp.c"
              ;
  }
  fd = r_sandbox_fopen (input + 2, "rb");
  if (!fd) {
   
# 845 "project/radare2/libr/core/cmd_cmp.c" 3 4
  fprintf(__stderrp,
# 845 "project/radare2/libr/core/cmd_cmp.c"
  "Cannot open file '%s'\n", input + 2
# 845 "project/radare2/libr/core/cmd_cmp.c" 3 4
  )
# 845 "project/radare2/libr/core/cmd_cmp.c"
                                                ;
   return 
# 846 "project/radare2/libr/core/cmd_cmp.c" 3 4
         0
# 846 "project/radare2/libr/core/cmd_cmp.c"
              ;
  }
  buf = (
# 848 "project/radare2/libr/core/cmd_cmp.c" 3 4
        unsigned char 
# 848 "project/radare2/libr/core/cmd_cmp.c"
            *) malloc (core->blocksize);
  if (buf) {
   if (fread (buf, 1, core->blocksize, fd) < 1) {
    
# 851 "project/radare2/libr/core/cmd_cmp.c" 3 4
   fprintf(__stderrp,
# 851 "project/radare2/libr/core/cmd_cmp.c"
   "Cannot read file %s\n", input + 2
# 851 "project/radare2/libr/core/cmd_cmp.c" 3 4
   )
# 851 "project/radare2/libr/core/cmd_cmp.c"
   ...
   fclose (fd);
   return 
# 859 "project/radare2/libr/core/cmd_cmp.c" 3 4
         0
# 859 "project/radare2/libr/core/cmd_cmp.c"
              ;
  }
  break;
 case 'd':
...
# 870 "project/radare2/libr/core/cmd_cmp.c" 3 4
     fprintf(__stderrp,
# 870 "project/radare2/libr/core/cmd_cmp.c"
     "Cannot chdir to %s\n", newdir
# 870 "project/radare2/libr/core/cmd_cmp.c" 3 4
     )
# 870 "project/radare2/libr/core/cmd_cmp.c"
...
# 886 "project/radare2/libr/core/cmd_cmp.c" 3 4
      fprintf(__stderrp,
# 886 "project/radare2/libr/core/cmd_cmp.c"
      "Cannot chdir to %s\n", homepath
# 886 "project/radare2/libr/core/cmd_cmp.c" 3 4
      )
# 886 "project/radare2/libr/core/cmd_cmp.c"
...
# 891 "project/radare2/libr/core/cmd_cmp.c" 3 4
    fprintf(__stderrp,
# 891 "project/radare2/libr/core/cmd_cmp.c"
    "Cannot find home\n"
# 891 "project/radare2/libr/core/cmd_cmp.c" 3 4
    )
# 891 "project/radare2/libr/core/cmd_cmp.c"
...
# 897 "project/radare2/libr/core/cmd_cmp.c" 3 4
    fprintf(__stderrp,
# 897 "project/radare2/libr/core/cmd_cmp.c"
    "Cannot chdir to %s\n", input + 1
# 897 "project/radare2/libr/core/cmd_cmp.c" 3 4
    )
# 897 "project/radare2/libr/core/cmd_cmp.c"
   ...
   char *home = r_sys_getenv (
# 901 "project/radare2/libr/core/cmd_cmp.c" 3 4
                             "HOME"
# 901 "project/radare2/libr/core/cmd_cmp.c"
                                       );
   if (!home || r_sandbox_chdir (home) == -1) {
    
# 903 "project/radare2/libr/core/cmd_cmp.c" 3 4
   fprintf(__stderrp,
# 903 "project/radare2/libr/core/cmd_cmp.c"
   "Cannot find home.\n"
# 903 "project/radare2/libr/core/cmd_cmp.c" 3 4
   )
# 903 "project/radare2/libr/core/cmd_cmp.c"
 ...
 case '2':
  v16 = (
# 912 "project/radare2/libr/core/cmd_cmp.c" 3 4
        unsigned short
# 912 "project/radare2/libr/core/cmd_cmp.c"
            ) r_num_math (core->num, input + 1);
  val = radare_compare (core, block, (
# 913 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                     unsigned char 
# 913 "project/radare2/libr/core/cmd_cmp.c"
                                         *) &v16, sizeof (v16), 0);
  break;
 case '4':
  v32 = (
# 916 "project/radare2/libr/core/cmd_cmp.c" 3 4
        unsigned int
# 916 "project/radare2/libr/core/cmd_cmp.c"
            ) r_num_math (core->num, input + 1);
  val = radare_compare (core, block, (
# 917 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                     unsigned char 
# 917 "project/radare2/libr/core/cmd_cmp.c"
                                         *) &v32, sizeof (v32), 0);
  break;
 case '8':
  v64 = (
# 920 "project/radare2/libr/core/cmd_cmp.c" 3 4
        unsigned long long
# 920 "project/radare2/libr/core/cmd_cmp.c"
            ) r_num_math (core->num, input + 1);
  val = radare_compare (core, block, (
# 921 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                     unsigned char 
# 921 "project/radare2/libr/core/cmd_cmp.c"
                                         *) &v64, sizeof (v64), 0);
  break;
 case 'c':
  if (input[1] == '?') {
...
# 933 "project/radare2/libr/core/cmd_cmp.c" 3 4
  unsigned int 
# 933 "project/radare2/libr/core/cmd_cmp.c"
       oflags = core->print->flags;
   
# 934 "project/radare2/libr/core/cmd_cmp.c" 3 4
  unsigned long long 
# 934 "project/radare2/libr/core/cmd_cmp.c"
       addr = 0;
   if (input[1] == 'c') {
    core->print->flags |= 
# 936 "project/radare2/libr/core/cmd_cmp.c" 3 4
                         0x00000100
# 936 "project/radare2/libr/core/cmd_cmp.c"
                                              ;
...
# 944 "project/radare2/libr/core/cmd_cmp.c" 3 4
  unsigned char 
# 944 "project/radare2/libr/core/cmd_cmp.c"
      *b = malloc (core->blocksize);
   if (b != 
# 945 "project/radare2/libr/core/cmd_cmp.c" 3 4
           ((void *)0)
# 945 "project/radare2/libr/core/cmd_cmp.c"
               ) {
    
# 946 "project/radare2/libr/core/cmd_cmp.c" 3 4
   __builtin___memset_chk (
# 946 "project/radare2/libr/core/cmd_cmp.c"
   b
# 946 "project/radare2/libr/core/cmd_cmp.c" 3 4
   , 
# 946 "project/radare2/libr/core/cmd_cmp.c"
...
# 946 "project/radare2/libr/core/cmd_cmp.c"
 ...
 case 'g':
 {
  ...
  RCore *core2;
  char *file2 = 
# 962 "project/radare2/libr/core/cmd_cmp.c" 3 4
               ((void *)0)
# 962 "project/radare2/libr/core/cmd_cmp.c"
                   ;
  switch (input[1]) {
  case 'o':
   file2 = (char *) r_str_trim_head_ro (input + 2);
   if (*file2) {
    r_anal_diff_setup (core->anal, 
# 967 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                  1
# 967 "project/radare2/libr/core/cmd_cmp.c"
                                      , -1, -1);
   } else {
    
# 969 "project/radare2/libr/core/cmd_cmp.c" 3 4
   fprintf(__stderrp,
# 969 "project/radare2/libr/core/cmd_cmp.c"
   "Usage: cgo [file]\n"
# 969 "project/radare2/libr/core/cmd_cmp.c" 3 4
   )
# 969 "project/radare2/libr/core/cmd_cmp.c"
                                  ;
    return 
# 970 "project/radare2/libr/core/cmd_cmp.c" 3 4
          0
# 970 "project/radare2/libr/core/cmd_cmp.c"
               ;
   }
   break;
  case 'f':
   
# 974 "project/radare2/libr/core/cmd_cmp.c" 3 4
  fprintf(__stderrp,
# 974 "project/radare2/libr/core/cmd_cmp.c"
  "TODO: agf is experimental\n"
# 974 "project/radare2/libr/core/cmd_cmp.c" 3 4
  )
# 974 "project/radare2/libr/core/cmd_cmp.c"
                                         ;
   r_anal_diff_setup (core->anal, 
# 975 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                 1
# 975 "project/radare2/libr/core/cmd_cmp.c"
                                     , -1, -1);
   r_core_gdiff_fcn (core, core->offset,
    r_num_math (core->num, input + 2));
   return 
# 978 "project/radare2/libr/core/cmd_cmp.c" 3 4
         0
# 978 "project/radare2/libr/core/cmd_cmp.c"
              ;
  case ' ':
   file2 = (char *) r_str_trim_head_ro (input + 2);
   r_anal_diff_setup (core->anal, 
# 981 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                 0
# 981 "project/radare2/libr/core/cmd_cmp.c"
                                      , -1, -1);
   break;
  default: {
   const char *help_message[] = {
...
# 989 "project/radare2/libr/core/cmd_cmp.c" 3 4
   ((void *)0)
   
# 990 "project/radare2/libr/core/cmd_cmp.c"
  };
   r_core_cmd_help (core, help_message);
   return 
# 992 "project/radare2/libr/core/cmd_cmp.c" 3 4
         0
# 992 "project/radare2/libr/core/cmd_cmp.c"
              ;
  }
  }
...
# 997 "project/radare2/libr/core/cmd_cmp.c" 3 4
  fprintf(__stderrp,
# 997 "project/radare2/libr/core/cmd_cmp.c"
  "Cannot compare with file %s\n", file2
# 997 "project/radare2/libr/core/cmd_cmp.c" 3 4
  )
# 997 "project/radare2/libr/core/cmd_cmp.c"
                                                  ;
   return 
# 998 "project/radare2/libr/core/cmd_cmp.c" 3 4
         0
# 998 "project/radare2/libr/core/cmd_cmp.c"
              ;
  }

  if (!(core2 = r_core_new ())) {
   
# 1002 "project/radare2/libr/core/cmd_cmp.c" 3 4
  fprintf(__stderrp,
# 1002 "project/radare2/libr/core/cmd_cmp.c"
  "Cannot init diff core\n"
# 1002 "project/radare2/libr/core/cmd_cmp.c" 3 4
  )
# 1002 "project/radare2/libr/core/cmd_cmp.c"
                                     ;
   return 
# 1003 "project/radare2/libr/core/cmd_cmp.c" 3 4
         0
# 1003 "project/radare2/libr/core/cmd_cmp.c"
              ;
  }
  r_core_loadlibs (core2, 
# 1005 "project/radare2/libr/core/cmd_cmp.c" 3 4
                         0xFFFFFFFFU
# 1005 "project/radare2/libr/core/cmd_cmp.c"
                                            , 
# 1005 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                              ((void *)0)
# 1005 "project/radare2/libr/core/cmd_cmp.c"
...
# 1008 "project/radare2/libr/core/cmd_cmp.c" 3 4
  fprintf(__stderrp,
# 1008 "project/radare2/libr/core/cmd_cmp.c"
  "Cannot open diff file '%s'\n", file2
# 1008 "project/radare2/libr/core/cmd_cmp.c" 3 4
  )
# 1008 "project/radare2/libr/core/cmd_cmp.c"
                                                 ;
   ...
   return 
# 1011 "project/radare2/libr/core/cmd_cmp.c" 3 4
         0
# 1011 "project/radare2/libr/core/cmd_cmp.c"
              ;
  }

  r_config_set_i (core2->config, "io.va", 
# 1014 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                         1
# 1014 "project/radare2/libr/core/cmd_cmp.c"
                                             );
  ...
  core2->config = 
# 1023 "project/radare2/libr/core/cmd_cmp.c" 3 4
                 ((void *)0)
# 1023 "project/radare2/libr/core/cmd_cmp.c"
                     ;
  r_core_free (core2);
  r_core_bind_cons (core);
 }
...
# 1057 "project/radare2/libr/core/cmd_cmp.c" 3 4
   ((void *)0)
   
# 1058 "project/radare2/libr/core/cmd_cmp.c"
  };
...
# 1080 "project/radare2/libr/core/cmd_cmp.c" 3 4
  unsigned char 
# 1080 "project/radare2/libr/core/cmd_cmp.c"
      n = (
# 1080 "project/radare2/libr/core/cmd_cmp.c" 3 4
           unsigned char
# 1080 "project/radare2/libr/core/cmd_cmp.c"
   ...
   if (block[0] == n) {
    r_cons_printf ("0x%08"
# 1083 "project/radare2/libr/core/cmd_cmp.c" 3 4
                         "llx" 
# 1083 "project/radare2/libr/core/cmd_cmp.c"
                                 "\n", core->offset);
    core->num->value = 0;
   }
   break;
...
# 1089 "project/radare2/libr/core/cmd_cmp.c" 3 4
  unsigned short 
# 1089 "project/radare2/libr/core/cmd_cmp.c"
       n = (
# 1089 "project/radare2/libr/core/cmd_cmp.c" 3 4
            unsigned short
# 1089 "project/radare2/libr/core/cmd_cmp.c"
   ...
   core->num->value = 1;
   if (core->blocksize >= 2 && *(
# 1091 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                unsigned short
# 1091 "project/radare2/libr/core/cmd_cmp.c"
                                    *)block == n) {
    r_cons_printf ("0x%08"
# 1092 "project/radare2/libr/core/cmd_cmp.c" 3 4
                         "llx" 
# 1092 "project/radare2/libr/core/cmd_cmp.c"
                                 "\n", core->offset);
    core->num->value = 0;
   }
   break;
...
# 1098 "project/radare2/libr/core/cmd_cmp.c" 3 4
  unsigned int 
# 1098 "project/radare2/libr/core/cmd_cmp.c"
       n = (
# 1098 "project/radare2/libr/core/cmd_cmp.c" 3 4
            unsigned int
# 1098 "project/radare2/libr/core/cmd_cmp.c"
   ...
   core->num->value = 1;
   if (core->blocksize >= 4 && *(
# 1100 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                unsigned int
# 1100 "project/radare2/libr/core/cmd_cmp.c"
                                    *)block == n) {
    r_cons_printf ("0x%08"
# 1101 "project/radare2/libr/core/cmd_cmp.c" 3 4
                         "llx" 
# 1101 "project/radare2/libr/core/cmd_cmp.c"
                                 "\n", core->offset);
    core->num->value = 0;
   }
   break;
...
# 1107 "project/radare2/libr/core/cmd_cmp.c" 3 4
  unsigned long long 
# 1107 "project/radare2/libr/core/cmd_cmp.c"
       n = (
# 1107 "project/radare2/libr/core/cmd_cmp.c" 3 4
            unsigned long long
# 1107 "project/radare2/libr/core/cmd_cmp.c"
   ...
   core->num->value = 1;
   if (core->blocksize >= 8 && *(
# 1109 "project/radare2/libr/core/cmd_cmp.c" 3 4
                                unsigned long long
# 1109 "project/radare2/libr/core/cmd_cmp.c"
                                    *)block == n) {
    r_cons_printf ("0x%08"
# 1110 "project/radare2/libr/core/cmd_cmp.c" 3 4
                         "llx" 
# 1110 "project/radare2/libr/core/cmd_cmp.c"
                                 "\n", core->offset);
    core->num->value = 0;
   }
   break;
...
# 1117 "project/radare2/libr/core/cmd_cmp.c" 3 4
  fprintf(__stderrp,
# 1117 "project/radare2/libr/core/cmd_cmp.c"
...
# 1122 "project/radare2/libr/core/cmd_cmp.c"
           ;
   break;
  }
 }
...
# 1138 "project/radare2/libr/core/cmd_cmp.c" 3 4
  fprintf(__stderrp,
# 1138 "project/radare2/libr/core/cmd_cmp.c"
  "Usage: cV[1248] [addr] @ addr2\n" "Compare n bytes from one address to current one and return in $? 0 or 1\n"
# 1138 "project/radare2/libr/core/cmd_cmp.c" 3 4
  )
                                                                                
# 1139 "project/radare2/libr/core/cmd_cmp.c"
                                                                               ;
  }
  sz -= '0';
  if (sz > 0) {
   
# 1143 "project/radare2/libr/core/cmd_cmp.c" 3 4
  unsigned long long 
# 1143 "project/radare2/libr/core/cmd_cmp.c"
       at = r_num_math (core->num, input + 2);
   
# 1144 "project/radare2/libr/core/cmd_cmp.c" 3 4
  unsigned char 
# 1144 "project/radare2/libr/core/cmd_cmp.c"
      buf[8] = {0};
 ...
 if (val != 
# 1164 "project/radare2/libr/core/cmd_cmp.c" 3 4
           0xFFFFFFFFFFFFFFFFULL
# 1164 "project/radare2/libr/core/cmd_cmp.c"
                   ) {
  core->num->value = val;
 }
 return 0;
