# 0 "project/radare2/libr/core/vslides.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/vslides.c"
...
# 4 "project/radare2/libr/core/vslides.c" 2


# 5 "project/radare2/libr/core/vslides.c"
...
static void clearkeys(void) {
 ...
 for (i = 0; i < 256; i++) {
  free (keys[i]);
  keys[i] = 
# 11 "project/radare2/libr/core/vslides.c" 3 4
           ((void *)0)
# 11 "project/radare2/libr/core/vslides.c"
               ;
 }
}
...
# 19 "project/radare2/libr/core/vslides.c" 3 4
if (
# 19 "project/radare2/libr/core/vslides.c"
list
# 19 "project/radare2/libr/core/vslides.c" 3 4
) for (
# 19 "project/radare2/libr/core/vslides.c"
...
# 49 "project/radare2/libr/core/vslides.c" 3 4
if (
# 49 "project/radare2/libr/core/vslides.c"
list
# 49 "project/radare2/libr/core/vslides.c" 3 4
) for (
# 49 "project/radare2/libr/core/vslides.c"
...
# 65 "project/radare2/libr/core/vslides.c" 3 4
    { free((void *)
# 65 "project/radare2/libr/core/vslides.c"
    keys[k]
# 65 "project/radare2/libr/core/vslides.c" 3 4
    ); 
# 65 "project/radare2/libr/core/vslides.c"
...
# 85 "project/radare2/libr/core/vslides.c" 3 4
__attribute__((visibility("default"))) 
# 85 "project/radare2/libr/core/vslides.c"
     void r_core_visual_slides(RCore *core, const char *file) {
 
# 86 "project/radare2/libr/core/vslides.c" 3 4
_Bool 
# 86 "project/radare2/libr/core/vslides.c"
     having_fun = 
# 86 "project/radare2/libr/core/vslides.c" 3 4
                  1
# 86 "project/radare2/libr/core/vslides.c"
                      ;
 char *data = r_file_slurp (file, 
# 87 "project/radare2/libr/core/vslides.c" 3 4
                                 ((void *)0)
# 87 "project/radare2/libr/core/vslides.c"
                                     );
 if (!data) {
  
# 89 "project/radare2/libr/core/vslides.c" 3 4
 fprintf(__stderrp,
# 89 "project/radare2/libr/core/vslides.c"
 "Cannot open file.\n"
# 89 "project/radare2/libr/core/vslides.c" 3 4
 )
# 89 "project/radare2/libr/core/vslides.c"
 ...
 while (having_fun) {
  ...
  r_cons_flush ();
  r_cons_enable_mouse (
# 101 "project/radare2/libr/core/vslides.c" 3 4
                      0
# 101 "project/radare2/libr/core/vslides.c"
                           );
  ch = r_cons_readchar ();
  ...
  case 'q':
   having_fun = 
# 106 "project/radare2/libr/core/vslides.c" 3 4
               0
# 106 "project/radare2/libr/core/vslides.c"
                    ;
   break;
  case ' ':
  case 'n':
  ...
  case '!':

   {
    ...
    char *ndata = r_file_slurp (file, 
# 122 "project/radare2/libr/core/vslides.c" 3 4
                                     ((void *)0)
# 122 "project/radare2/libr/core/vslides.c"
                                         );
    if (ndata) {
     r_list_free (list);
     free (data);
  ...
  case ':':
   r_cons_show_cursor (
# 132 "project/radare2/libr/core/vslides.c" 3 4
                      1
# 132 "project/radare2/libr/core/vslides.c"
                          );
   r_cons_set_raw (0);
   while (1) {
    char cmd[1024];
    *cmd = 0;
    r_line_set_prompt (":> ");
    if (r_cons_fgets (cmd, sizeof (cmd), 0, 
# 138 "project/radare2/libr/core/vslides.c" 3 4
                                           ((void *)0)
# 138 "project/radare2/libr/core/vslides.c"
                                               ) < 0) {
     cmd[0] = '\0';
    }
   ...
   r_cons_show_cursor (
# 147 "project/radare2/libr/core/vslides.c" 3 4
                      0
# 147 "project/radare2/libr/core/vslides.c"
                           );
   r_cons_set_raw (1);
   r_cons_clear ();
   break;
