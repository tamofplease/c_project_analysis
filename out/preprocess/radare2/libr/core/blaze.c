# 0 "project/radare2/libr/core/blaze.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/blaze.c"
...
# 4 "project/radare2/libr/core/blaze.c" 2


# 5 "project/radare2/libr/core/blaze.c"
...
# 15 "project/radare2/libr/core/blaze.c" 3 4
unsigned long long 
# 15 "project/radare2/libr/core/blaze.c"
     start;
 
# 16 "project/radare2/libr/core/blaze.c" 3 4
unsigned long long 
# 16 "project/radare2/libr/core/blaze.c"
     end;
 
# 17 "project/radare2/libr/core/blaze.c" 3 4
unsigned long long 
# 17 "project/radare2/libr/core/blaze.c"
     jump;
 
# 18 "project/radare2/libr/core/blaze.c" 3 4
unsigned long long 
# 18 "project/radare2/libr/core/blaze.c"
     fail;
 int score;
 int called;
 int reached;
...
# 26 "project/radare2/libr/core/blaze.c" 3 4
unsigned long long 
# 26 "project/radare2/libr/core/blaze.c"
     addr;
 
# 27 "project/radare2/libr/core/blaze.c" 3 4
unsigned long long 
# 27 "project/radare2/libr/core/blaze.c"
     size;
 RList *bbs;
 
# 29 "project/radare2/libr/core/blaze.c" 3 4
long long 
# 29 "project/radare2/libr/core/blaze.c"
     score;
 
# 30 "project/radare2/libr/core/blaze.c" 3 4
unsigned long long 
# 30 "project/radare2/libr/core/blaze.c"
     ends;
} fcn_t;

static 
# 33 "project/radare2/libr/core/blaze.c" 3 4
      _Bool 
# 33 "project/radare2/libr/core/blaze.c"
           __is_data_block_cb(RAnalBlock *block, void *user) {
 
# 34 "project/radare2/libr/core/blaze.c" 3 4
_Bool 
# 34 "project/radare2/libr/core/blaze.c"
     *block_exists = user;
 *block_exists = 
# 35 "project/radare2/libr/core/blaze.c" 3 4
                1
# 35 "project/radare2/libr/core/blaze.c"
                    ;
 return 
# 36 "project/radare2/libr/core/blaze.c" 3 4
       0
# 36 "project/radare2/libr/core/blaze.c"
            ;
}

static int __isdata(RCore *core, 
# 39 "project/radare2/libr/core/blaze.c" 3 4
                                unsigned long long 
# 39 "project/radare2/libr/core/blaze.c"
                                     addr) {
 if (!r_io_is_valid_offset (core->io, addr, 
# 40 "project/radare2/libr/core/blaze.c" 3 4
                                           0
# 40 "project/radare2/libr/core/blaze.c"
                                                )) {
...
# 45 "project/radare2/libr/core/blaze.c" 3 4
_Bool 
# 45 "project/radare2/libr/core/blaze.c"
     block_exists = 
# 45 "project/radare2/libr/core/blaze.c" 3 4
                    0
# 45 "project/radare2/libr/core/blaze.c"
...
# 55 "project/radare2/libr/core/blaze.c" 3 4
for (
# 55 "project/radare2/libr/core/blaze.c"
it 
# 55 "project/radare2/libr/core/blaze.c" 3 4
= (void **)(
# 55 "project/radare2/libr/core/blaze.c"
...
static 
# 73 "project/radare2/libr/core/blaze.c" 3 4
      _Bool 
# 73 "project/radare2/libr/core/blaze.c"
           fcnAddBB (fcn_t *fcn, bb_t* block) {
 if (!fcn) {
  
# 75 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 75 "project/radare2/libr/core/blaze.c"
 "No function given to add a basic block\n"
# 75 "project/radare2/libr/core/blaze.c" 3 4
 )
# 75 "project/radare2/libr/core/blaze.c"
                                                     ;
  return 
# 76 "project/radare2/libr/core/blaze.c" 3 4
        0
# 76 "project/radare2/libr/core/blaze.c"
             ;
 }
...
# 84 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 84 "project/radare2/libr/core/blaze.c"
 "Block list not initialized\n"
# 84 "project/radare2/libr/core/blaze.c" 3 4
 )
# 84 "project/radare2/libr/core/blaze.c"
                                         ;
  return 
# 85 "project/radare2/libr/core/blaze.c" 3 4
        0
# 85 "project/radare2/libr/core/blaze.c"
             ;
 }
 r_list_append (fcn->bbs, block);
 return 
# 88 "project/radare2/libr/core/blaze.c" 3 4
       1
# 88 "project/radare2/libr/core/blaze.c"
           ;
}

static fcn_t* fcnNew (bb_t *block) {
 fcn_t* fcn = 
# 92 "project/radare2/libr/core/blaze.c" 3 4
             (
# 92 "project/radare2/libr/core/blaze.c"
             fcn_t
# 92 "project/radare2/libr/core/blaze.c" 3 4
             *)calloc(1,sizeof(
# 92 "project/radare2/libr/core/blaze.c"
...
# 94 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 94 "project/radare2/libr/core/blaze.c"
...
# 94 "project/radare2/libr/core/blaze.c"
                                                     ;
  return 
# 95 "project/radare2/libr/core/blaze.c" 3 4
        ((void *)0)
# 95 "project/radare2/libr/core/blaze.c"
            ;
 }
...
# 100 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 100 "project/radare2/libr/core/blaze.c"
 "Failed to add block to function\n"
# 100 "project/radare2/libr/core/blaze.c" 3 4
 )
# 100 "project/radare2/libr/core/blaze.c"
                                              ;
...
static void initBB (bb_t *bb, 
# 116 "project/radare2/libr/core/blaze.c" 3 4
                             unsigned long long 
# 116 "project/radare2/libr/core/blaze.c"
                                  start, 
# 116 "project/radare2/libr/core/blaze.c" 3 4
                                         unsigned long long 
# 116 "project/radare2/libr/core/blaze.c"
...
# 116 "project/radare2/libr/core/blaze.c" 3 4
                                                              unsigned long long 
# 116 "project/radare2/libr/core/blaze.c"
                                                                   fail, bb_type_t type, int score, int reached, int called) {
 if (bb) {
  bb->start = start;
  bb->end = end;
  bb->jump = jump;
...
static 
# 129 "project/radare2/libr/core/blaze.c" 3 4
      _Bool 
# 129 "project/radare2/libr/core/blaze.c"
           addBB(RList *block_list, 
# 129 "project/radare2/libr/core/blaze.c" 3 4
                                    unsigned long long 
# 129 "project/radare2/libr/core/blaze.c"
                                         start, 
...
# 129 "project/radare2/libr/core/blaze.c" 3 4
                                                                     unsigned long long 
# 129 "project/radare2/libr/core/blaze.c"
                                                                          fail, bb_type_t type, int score) {
 bb_t *bb = (bb_t*) 
# 130 "project/radare2/libr/core/blaze.c" 3 4
                   (
# 130 "project/radare2/libr/core/blaze.c"
                   bb_t
# 130 "project/radare2/libr/core/blaze.c" 3 4
                   *)calloc(1,sizeof(
# 130 "project/radare2/libr/core/blaze.c"
...
# 132 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 132 "project/radare2/libr/core/blaze.c"
 "Failed to calloc mem for new basic block!\n"
# 132 "project/radare2/libr/core/blaze.c" 3 4
 )
# 132 "project/radare2/libr/core/blaze.c"
                                                        ;
  return 
# 133 "project/radare2/libr/core/blaze.c" 3 4
        0
# 133 "project/radare2/libr/core/blaze.c"
             ;
 }
 initBB (bb, start, end, jump, fail, type, score, 0, 0);
 if (jump < 
# 136 "project/radare2/libr/core/blaze.c" 3 4
           0xFFFFFFFFFFFFFFFFULL
# 136 "project/radare2/libr/core/blaze.c"
                   ) {
  bb_t *jump_bb = (bb_t*) 
# 137 "project/radare2/libr/core/blaze.c" 3 4
                         (
# 137 "project/radare2/libr/core/blaze.c"
                         bb_t
# 137 "project/radare2/libr/core/blaze.c" 3 4
                         *)calloc(1,sizeof(
# 137 "project/radare2/libr/core/blaze.c"
...
# 139 "project/radare2/libr/core/blaze.c" 3 4
  fprintf(__stderrp,
# 139 "project/radare2/libr/core/blaze.c"
  "Failed to allocate memory for jump block\n"
# 139 "project/radare2/libr/core/blaze.c" 3 4
  )
# 139 "project/radare2/libr/core/blaze.c"
                                                        ;
   free (bb);
   return 
# 141 "project/radare2/libr/core/blaze.c" 3 4
         0
# 141 "project/radare2/libr/core/blaze.c"
              ;
  }
  if (type == CALL) {
   initBB (jump_bb, jump, 
# 144 "project/radare2/libr/core/blaze.c" 3 4
                         0xFFFFFFFFFFFFFFFFULL
# 144 "project/radare2/libr/core/blaze.c"
                                 , 
# 144 "project/radare2/libr/core/blaze.c" 3 4
                                   0xFFFFFFFFFFFFFFFFULL
# 144 "project/radare2/libr/core/blaze.c"
...
# 144 "project/radare2/libr/core/blaze.c"
   ...
   initBB (jump_bb, jump, 
# 146 "project/radare2/libr/core/blaze.c" 3 4
                         0xFFFFFFFFFFFFFFFFULL
# 146 "project/radare2/libr/core/blaze.c"
                                 , 
# 146 "project/radare2/libr/core/blaze.c" 3 4
                                   0xFFFFFFFFFFFFFFFFULL
# 146 "project/radare2/libr/core/blaze.c"
...
# 146 "project/radare2/libr/core/blaze.c"
 ...
 if (fail < 
# 150 "project/radare2/libr/core/blaze.c" 3 4
           0xFFFFFFFFFFFFFFFFULL
# 150 "project/radare2/libr/core/blaze.c"
                   ) {
  bb_t *fail_bb = (bb_t*) 
# 151 "project/radare2/libr/core/blaze.c" 3 4
                         (
# 151 "project/radare2/libr/core/blaze.c"
                         bb_t
# 151 "project/radare2/libr/core/blaze.c" 3 4
                         *)calloc(1,sizeof(
# 151 "project/radare2/libr/core/blaze.c"
...
# 153 "project/radare2/libr/core/blaze.c" 3 4
  fprintf(__stderrp,
# 153 "project/radare2/libr/core/blaze.c"
  "Failed to allocate memory for fail block\n"
# 153 "project/radare2/libr/core/blaze.c" 3 4
  )
# 153 "project/radare2/libr/core/blaze.c"
                                                        ;
   free (bb);
   return 
# 155 "project/radare2/libr/core/blaze.c" 3 4
         0
# 155 "project/radare2/libr/core/blaze.c"
              ;
  }
  initBB (fail_bb, fail, 
# 157 "project/radare2/libr/core/blaze.c" 3 4
                        0xFFFFFFFFFFFFFFFFULL
# 157 "project/radare2/libr/core/blaze.c"
                                , 
# 157 "project/radare2/libr/core/blaze.c" 3 4
                                  0xFFFFFFFFFFFFFFFFULL
# 157 "project/radare2/libr/core/blaze.c"
...
# 157 "project/radare2/libr/core/blaze.c"
 ...
 return 
# 161 "project/radare2/libr/core/blaze.c" 3 4
       1
# 161 "project/radare2/libr/core/blaze.c"
           ;
}

void dump_block(bb_t *block) {
 
# 165 "project/radare2/libr/core/blaze.c" 3 4
fprintf(__stderrp,
# 165 "project/radare2/libr/core/blaze.c"
"s: 0x%"
# 165 "project/radare2/libr/core/blaze.c" 3 4
"llx"
# 165 "project/radare2/libr/core/blaze.c"
...
# 166 "project/radare2/libr/core/blaze.c"
                                                                    ;
}
...
void dump_blocks (RList* list) {
 RListIter *iter;
 bb_t *block = 
# 171 "project/radare2/libr/core/blaze.c" 3 4
              ((void *)0)
# 171 "project/radare2/libr/core/blaze.c"
                  ;
 
# 172 "project/radare2/libr/core/blaze.c" 3 4
if (
# 172 "project/radare2/libr/core/blaze.c"
list
# 172 "project/radare2/libr/core/blaze.c" 3 4
) for (
# 172 "project/radare2/libr/core/blaze.c"
...
static 
# 177 "project/radare2/libr/core/blaze.c" 3 4
      _Bool 
# 177 "project/radare2/libr/core/blaze.c"
           checkFunction(fcn_t *fcn) {
 if (fcn && fcn->ends > 0 && fcn->size > 0) {
  return 
# 179 "project/radare2/libr/core/blaze.c" 3 4
        1
# 179 "project/radare2/libr/core/blaze.c"
            ;
 }

 return 
# 182 "project/radare2/libr/core/blaze.c" 3 4
       0
# 182 "project/radare2/libr/core/blaze.c"
            ;
}
...
# 187 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 187 "project/radare2/libr/core/blaze.c"
 "No function given to print\n"
# 187 "project/radare2/libr/core/blaze.c" 3 4
 )
# 187 "project/radare2/libr/core/blaze.c"
                                         ;
 ...
 RListIter *fcn_iter;
 bb_t *cur = 
# 192 "project/radare2/libr/core/blaze.c" 3 4
            ((void *)0)
# 192 "project/radare2/libr/core/blaze.c"
                ;
 ...
 char *_name = name? (char *) name: r_str_newf ("%s.%" 
# 198 "project/radare2/libr/core/blaze.c" 3 4
                                                      "llx"
# 198 "project/radare2/libr/core/blaze.c"
                                                             , pfx, fcn->addr);
 r_cons_printf ("af+ 0x%08" 
# 199 "project/radare2/libr/core/blaze.c" 3 4
                           "llx" 
# 199 "project/radare2/libr/core/blaze.c"
                                   " %s\n", fcn->addr, _name);
 if (!name) {
  free (_name);
 }
...
# 204 "project/radare2/libr/core/blaze.c" 3 4
if (
# 204 "project/radare2/libr/core/blaze.c"
fcn->bbs
# 204 "project/radare2/libr/core/blaze.c" 3 4
) for (
# 204 "project/radare2/libr/core/blaze.c"
...
# 204 "project/radare2/libr/core/blaze.c"
                                         {
  r_cons_printf ("afb+ 0x%08" 
# 205 "project/radare2/libr/core/blaze.c" 3 4
                             "llx" 
# 205 "project/radare2/libr/core/blaze.c"
                                     " 0x%08" 
# 205 "project/radare2/libr/core/blaze.c" 3 4
                                              "llx" 
# 205 "project/radare2/libr/core/blaze.c"
...
# 212 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 212 "project/radare2/libr/core/blaze.c"
 "No function given to create\n"
# 212 "project/radare2/libr/core/blaze.c" 3 4
 )
# 212 "project/radare2/libr/core/blaze.c"
                                          ;
 ...
 RListIter *fcn_iter;
 bb_t *cur = 
# 217 "project/radare2/libr/core/blaze.c" 3 4
            ((void *)0)
# 217 "project/radare2/libr/core/blaze.c"
                ;
 const char *pfx = r_config_get (core->config, "anal.fcnprefix");
 if (!pfx) {
  pfx = "fcn";
...
# 225 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 225 "project/radare2/libr/core/blaze.c"
...
# 225 "project/radare2/libr/core/blaze.c"
 ...
 f->name = name? strdup (name): r_str_newf ("%s.%" 
# 229 "project/radare2/libr/core/blaze.c" 3 4
                                                  "llx"
# 229 "project/radare2/libr/core/blaze.c"
                                                         , pfx, fcn->addr);
 f->addr = fcn->addr;
...
# 235 "project/radare2/libr/core/blaze.c" 3 4
if (
# 235 "project/radare2/libr/core/blaze.c"
fcn->bbs
# 235 "project/radare2/libr/core/blaze.c" 3 4
) for (
# 235 "project/radare2/libr/core/blaze.c"
...
# 235 "project/radare2/libr/core/blaze.c"
  ...
  r_anal_function_add_bb (core->anal, f, cur->start, (cur->end - cur->start), cur->jump, cur->fail, 
# 239 "project/radare2/libr/core/blaze.c" 3 4
                                                                                                   ((void *)0)
# 239 "project/radare2/libr/core/blaze.c"
                                                                                                       );
 }
...
# 249 "project/radare2/libr/core/blaze.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 249 "project/radare2/libr/core/blaze.c"
          core_anal_bbs(RCore *core, const char* input) {
 if (!r_io_is_valid_offset (core->io, core->offset, 
# 250 "project/radare2/libr/core/blaze.c" 3 4
                                                   0
# 250 "project/radare2/libr/core/blaze.c"
                                                        )) {
  
# 251 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 251 "project/radare2/libr/core/blaze.c"
 "No valid offset given to analyze\n"
# 251 "project/radare2/libr/core/blaze.c" 3 4
 )
# 251 "project/radare2/libr/core/blaze.c"
                                               ;
  return 
# 252 "project/radare2/libr/core/blaze.c" 3 4
        0
# 252 "project/radare2/libr/core/blaze.c"
             ;
 }

 Sdb *sdb = 
# 255 "project/radare2/libr/core/blaze.c" 3 4
           ((void *)0)
# 255 "project/radare2/libr/core/blaze.c"
               ;
 const 
# 256 "project/radare2/libr/core/blaze.c" 3 4
      unsigned long long 
# 256 "project/radare2/libr/core/blaze.c"
           start = core->offset;
 
# 257 "project/radare2/libr/core/blaze.c" 3 4
unsigned long long 
# 257 "project/radare2/libr/core/blaze.c"
     size = input[0] ? r_num_math (core->num, input + 1) : core->blocksize;
 
# 258 "project/radare2/libr/core/blaze.c" 3 4
unsigned long long 
# 258 "project/radare2/libr/core/blaze.c"
     b_start = start;
 RListIter *iter;
 int block_score = 0;
 RList *block_list;
 bb_t *block = 
# 262 "project/radare2/libr/core/blaze.c" 3 4
              ((void *)0)
# 262 "project/radare2/libr/core/blaze.c"
                  ;
 int invalid_instruction_barrier = -20000;
 const 
# 264 "project/radare2/libr/core/blaze.c" 3 4
      _Bool 
# 264 "project/radare2/libr/core/blaze.c"
           debug = r_config_get_b (core->config, "cfg.debug");
 const 
# 265 "project/radare2/libr/core/blaze.c" 3 4
      _Bool 
# 265 "project/radare2/libr/core/blaze.c"
           nopskip = r_config_get_b (core->config, "anal.nopskip");

 block_list = r_list_new ();
 if (!block_list) {
  
# 269 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 269 "project/radare2/libr/core/blaze.c"
 "Failed to create block_list\n"
# 269 "project/radare2/libr/core/blaze.c" 3 4
 )
# 269 "project/radare2/libr/core/blaze.c"
                                          ;
...
# 273 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 273 "project/radare2/libr/core/blaze.c"
 "Analyzing [0x%08"
# 273 "project/radare2/libr/core/blaze.c" 3 4
 "llx"
# 273 "project/radare2/libr/core/blaze.c"
...
# 274 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 274 "project/radare2/libr/core/blaze.c"
 "Creating basic blocks\b"
# 274 "project/radare2/libr/core/blaze.c" 3 4
 )
# 274 "project/radare2/libr/core/blaze.c"
                                    ;
...
# 276 "project/radare2/libr/core/blaze.c" 3 4
unsigned long long 
# 276 "project/radare2/libr/core/blaze.c"
     cur = 0, base = 0;
 while (cur >= base && cur < size) {
  ...
  const 
# 285 "project/radare2/libr/core/blaze.c" 3 4
       unsigned long long 
# 285 "project/radare2/libr/core/blaze.c"
            dst = start + cur;
  if (dst < start) {
...
# 305 "project/radare2/libr/core/blaze.c" 3 4
  fprintf(__stderrp,
# 305 "project/radare2/libr/core/blaze.c"
  "? Bad op at: 0x%08"
# 305 "project/radare2/libr/core/blaze.c" 3 4
  "llx"
# 305 "project/radare2/libr/core/blaze.c"
...
# 306 "project/radare2/libr/core/blaze.c" 3 4
  fprintf(__stderrp,
# 306 "project/radare2/libr/core/blaze.c"
  "Cannot analyze opcode at 0x%"
# 306 "project/radare2/libr/core/blaze.c" 3 4
  "llx"
# 306 "project/radare2/libr/core/blaze.c"
  "\n", dst
...
# 306 "project/radare2/libr/core/blaze.c"
  ...
  case R_ANAL_OP_TYPE_CALL:
   if (r_anal_noreturn_at (core->anal, op->jump)) {
    addBB (block_list, b_start, dst + op->size, 
# 319 "project/radare2/libr/core/blaze.c" 3 4
                                               0xFFFFFFFFFFFFFFFFULL
# 319 "project/radare2/libr/core/blaze.c"
                                                       , 
# 319 "project/radare2/libr/core/blaze.c" 3 4
                                                         0xFFFFFFFFFFFFFFFFULL
# 319 "project/radare2/libr/core/blaze.c"
    ...
    addBB (block_list, op->jump, 
# 323 "project/radare2/libr/core/blaze.c" 3 4
                                0xFFFFFFFFFFFFFFFFULL
# 323 "project/radare2/libr/core/blaze.c"
                                        , 
# 323 "project/radare2/libr/core/blaze.c" 3 4
                                          0xFFFFFFFFFFFFFFFFULL
# 323 "project/radare2/libr/core/blaze.c"
...
# 323 "project/radare2/libr/core/blaze.c"
  ...
  case R_ANAL_OP_TYPE_JMP:
   addBB (block_list, b_start, dst + op->size, op->jump, 
# 327 "project/radare2/libr/core/blaze.c" 3 4
                                                        0xFFFFFFFFFFFFFFFFULL
# 327 "project/radare2/libr/core/blaze.c"
                                                                , END, block_score);
   b_start = dst + op->size;
   block_score = 0;
   break;
  case R_ANAL_OP_TYPE_TRAP:
   ...
   if (b_start < dst) {
    addBB (block_list, b_start, dst, 
# 334 "project/radare2/libr/core/blaze.c" 3 4
                                    0xFFFFFFFFFFFFFFFFULL
# 334 "project/radare2/libr/core/blaze.c"
                                            , 
# 334 "project/radare2/libr/core/blaze.c" 3 4
                                              0xFFFFFFFFFFFFFFFFULL
# 334 "project/radare2/libr/core/blaze.c"
  ...
  case R_ANAL_OP_TYPE_RET:
   addBB (block_list, b_start, dst + op->size, 
# 340 "project/radare2/libr/core/blaze.c" 3 4
                                              0xFFFFFFFFFFFFFFFFULL
# 340 "project/radare2/libr/core/blaze.c"
                                                      , 
# 340 "project/radare2/libr/core/blaze.c" 3 4
                                                        0xFFFFFFFFFFFFFFFFULL
# 340 "project/radare2/libr/core/blaze.c"
...
# 361 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 361 "project/radare2/libr/core/blaze.c"
 "Found %d basic blocks\n", block_list->length
# 361 "project/radare2/libr/core/blaze.c" 3 4
 )
# 361 "project/radare2/libr/core/blaze.c"
                                                        ;
...
# 367 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 367 "project/radare2/libr/core/blaze.c"
 "Failed to create resulting list\n"
# 367 "project/radare2/libr/core/blaze.c" 3 4
 )
# 367 "project/radare2/libr/core/blaze.c"
                                              ;
  return 
# 368 "project/radare2/libr/core/blaze.c" 3 4
        0
# 368 "project/radare2/libr/core/blaze.c"
             ;
 }
...
# 373 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 373 "project/radare2/libr/core/blaze.c"
 "Failed to initialize sdb db\n"
# 373 "project/radare2/libr/core/blaze.c" 3 4
 )
# 373 "project/radare2/libr/core/blaze.c"
                                          ;
  ...
  r_list_free (result);
  return 
# 376 "project/radare2/libr/core/blaze.c" 3 4
        0
# 376 "project/radare2/libr/core/blaze.c"
             ;
 }
...
# 382 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 382 "project/radare2/libr/core/blaze.c"
 "Sorting all blocks done\n"
# 382 "project/radare2/libr/core/blaze.c" 3 4
 )
# 382 "project/radare2/libr/core/blaze.c"
                                      ;
  
# 383 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 383 "project/radare2/libr/core/blaze.c"
...
# 389 "project/radare2/libr/core/blaze.c" 3 4
  fprintf(__stderrp,
# 389 "project/radare2/libr/core/blaze.c"
  "Failed to get next block from list\n"
# 389 "project/radare2/libr/core/blaze.c" 3 4
  )
# 389 "project/radare2/libr/core/blaze.c"
                                                  ;
...
# 399 "project/radare2/libr/core/blaze.c" 3 4
   fprintf(__stderrp,
# 399 "project/radare2/libr/core/blaze.c"
   "No next block to compare with!\n"
# 399 "project/radare2/libr/core/blaze.c" 3 4
   )
# 399 "project/radare2/libr/core/blaze.c"
                                               ;
   ...
   if (block->start == next_block->start && block->end == 
# 403 "project/radare2/libr/core/blaze.c" 3 4
                                                         0xFFFFFFFFFFFFFFFFULL
# 403 "project/radare2/libr/core/blaze.c"
                                                                 ) {
   ...
   if (block->start == next_block->start && next_block->end == 
# 413 "project/radare2/libr/core/blaze.c" 3 4
                                                              0xFFFFFFFFFFFFFFFFULL
# 413 "project/radare2/libr/core/blaze.c"
                                                                      ) {
   ...
   if (block->end < 
# 422 "project/radare2/libr/core/blaze.c" 3 4
                   0xFFFFFFFFFFFFFFFFULL 
# 422 "project/radare2/libr/core/blaze.c"
                            && next_block->start < block->end && next_block->start > block->start) {
    if (next_block->jump == 
# 423 "project/radare2/libr/core/blaze.c" 3 4
                           0xFFFFFFFFFFFFFFFFULL
# 423 "project/radare2/libr/core/blaze.c"
                                   ) {
     next_block->jump = block->jump;
    }

    if (next_block->fail == 
# 427 "project/radare2/libr/core/blaze.c" 3 4
                           0xFFFFFFFFFFFFFFFFULL
# 427 "project/radare2/libr/core/blaze.c"
                                   ) {
    ...
    block->fail = 
# 434 "project/radare2/libr/core/blaze.c" 3 4
                 0xFFFFFFFFFFFFFFFFULL
# 434 "project/radare2/libr/core/blaze.c"
                         ;
  ...
  sdb_ptr_set (sdb, sdb_fmt ("bb.0x%08"
# 442 "project/radare2/libr/core/blaze.c" 3 4
                                      "llx"
# 442 "project/radare2/libr/core/blaze.c"
                                             , block->start), block, 0);
...
# 450 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 450 "project/radare2/libr/core/blaze.c"
 "Trying to create functions\n"
# 450 "project/radare2/libr/core/blaze.c" 3 4
 )
# 450 "project/radare2/libr/core/blaze.c"
                                         ;
...
# 453 "project/radare2/libr/core/blaze.c" 3 4
if (
# 453 "project/radare2/libr/core/blaze.c"
result
# 453 "project/radare2/libr/core/blaze.c" 3 4
) for (
# 453 "project/radare2/libr/core/blaze.c"
...
# 453 "project/radare2/libr/core/blaze.c"
  ...
  if (block && (block->reached == 0 || block->called >= 1)) {
   ...
   bb_t *jump = 
# 460 "project/radare2/libr/core/blaze.c" 3 4
               ((void *)0)
# 460 "project/radare2/libr/core/blaze.c"
                   ;
   bb_t *fail = 
# 461 "project/radare2/libr/core/blaze.c" 3 4
               ((void *)0)
# 461 "project/radare2/libr/core/blaze.c"
                   ;
   bb_t *cur = 
# 462 "project/radare2/libr/core/blaze.c" 3 4
              ((void *)0)
# 462 "project/radare2/libr/core/blaze.c"
                  ;

   if (!r_stack_push (stack, (void*)block)) {
    
# 465 "project/radare2/libr/core/blaze.c" 3 4
   fprintf(__stderrp,
# 465 "project/radare2/libr/core/blaze.c"
   "Failed to push initial block\n"
# 465 "project/radare2/libr/core/blaze.c" 3 4
   )
# 465 "project/radare2/libr/core/blaze.c"
                                             ;
   ...
   while (!r_stack_is_empty (stack)) {
    ...
    sdb_num_set (sdb, sdb_fmt("handled.%"
# 473 "project/radare2/libr/core/blaze.c" 3 4
                     "llx"
# 473 "project/radare2/libr/core/blaze.c"
                     "", cur->start), 1, 0);
    if (cur->score < 0) {
     fcnFree (current_function);
     current_function = 
# 476 "project/radare2/libr/core/blaze.c" 3 4
                       ((void *)0)
# 476 "project/radare2/libr/core/blaze.c"
                           ;
     break;
    }

    if ((
# 480 "project/radare2/libr/core/blaze.c" 3 4
        long long
# 480 "project/radare2/libr/core/blaze.c"
            )(cur->end - cur->start) < 0) {
     break;
    }
    ...
    if (cur->jump < 
# 486 "project/radare2/libr/core/blaze.c" 3 4
                   0xFFFFFFFFFFFFFFFFULL 
# 486 "project/radare2/libr/core/blaze.c"
                            && !sdb_num_get (sdb, sdb_fmt("handled.%"
# 486 "project/radare2/libr/core/blaze.c" 3 4
                                                  "llx"
# 486 "project/radare2/libr/core/blaze.c"
                                                  "", cur->jump), 
...
# 486 "project/radare2/libr/core/blaze.c"
     ...
     jump = sdb_ptr_get (sdb, sdb_fmt ("bb.0x%08"
# 487 "project/radare2/libr/core/blaze.c" 3 4
                                                "llx"
# 487 "project/radare2/libr/core/blaze.c"
                                                       , cur->jump), 
# 487 "project/radare2/libr/core/blaze.c" 3 4
                                                                     ((void *)0)
# 487 "project/radare2/libr/core/blaze.c"
...
# 489 "project/radare2/libr/core/blaze.c" 3 4
     fprintf(__stderrp,
# 489 "project/radare2/libr/core/blaze.c"
     "Failed to get jump block at 0x%"
# 489 "project/radare2/libr/core/blaze.c" 3 4
     "llx"
# 489 "project/radare2/libr/core/blaze.c"
     "\n", cur->jump
...
# 493 "project/radare2/libr/core/blaze.c" 3 4
     fprintf(__stderrp,
# 493 "project/radare2/libr/core/blaze.c"
     "Failed to push jump block to stack\n"
# 493 "project/radare2/libr/core/blaze.c" 3 4
     )
# 493 "project/radare2/libr/core/blaze.c"
                                                     ;
    ...
    if (cur->fail < 
# 497 "project/radare2/libr/core/blaze.c" 3 4
                   0xFFFFFFFFFFFFFFFFULL 
# 497 "project/radare2/libr/core/blaze.c"
                            && !sdb_num_get (sdb, sdb_fmt("handled.%"
# 497 "project/radare2/libr/core/blaze.c" 3 4
                                                  "llx"
# 497 "project/radare2/libr/core/blaze.c"
...
# 497 "project/radare2/libr/core/blaze.c"
     ...
     fail = sdb_ptr_get (sdb, sdb_fmt ("bb.0x%08" 
# 498 "project/radare2/libr/core/blaze.c" 3 4
                                                 "llx"
# 498 "project/radare2/libr/core/blaze.c"
                                                        , cur->fail), 
# 498 "project/radare2/libr/core/blaze.c" 3 4
                                                                      ((void *)0)
# 498 "project/radare2/libr/core/blaze.c"
...
# 500 "project/radare2/libr/core/blaze.c" 3 4
     fprintf(__stderrp,
# 500 "project/radare2/libr/core/blaze.c"
     "Failed to get fail block at 0x%"
# 500 "project/radare2/libr/core/blaze.c" 3 4
     "llx"
# 500 "project/radare2/libr/core/blaze.c"
     "\n", cur->fail
...
# 504 "project/radare2/libr/core/blaze.c" 3 4
     fprintf(__stderrp,
# 504 "project/radare2/libr/core/blaze.c"
     "Failed to push jump block to stack\n"
# 504 "project/radare2/libr/core/blaze.c" 3 4
     )
# 504 "project/radare2/libr/core/blaze.c"
   ...
   if (current_function) {
    if (checkFunction (current_function)) {
     if (input[0] == '*') {
      printFunctionCommands (core, current_function, 
# 513 "project/radare2/libr/core/blaze.c" 3 4
                                                    ((void *)0)
# 513 "project/radare2/libr/core/blaze.c"
                                                        );
     } else {
      createFunction (core, current_function, 
# 515 "project/radare2/libr/core/blaze.c" 3 4
                                             ((void *)0)
# 515 "project/radare2/libr/core/blaze.c"
                                                 );
     }
    }
    fcnFree (current_function);
 ...
 r_list_free (block_list);
 return 
# 528 "project/radare2/libr/core/blaze.c" 3 4
       1
# 528 "project/radare2/libr/core/blaze.c"
           ;
}


# 531 "project/radare2/libr/core/blaze.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 531 "project/radare2/libr/core/blaze.c"
          core_anal_bbs_range (RCore *core, const char* input) {
 if (!r_io_is_valid_offset (core->io, core->offset, 
# 532 "project/radare2/libr/core/blaze.c" 3 4
                                                   0
# 532 "project/radare2/libr/core/blaze.c"
                                                        )) {
  
# 533 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 533 "project/radare2/libr/core/blaze.c"
 "No valid offset given to analyze\n"
# 533 "project/radare2/libr/core/blaze.c" 3 4
 )
# 533 "project/radare2/libr/core/blaze.c"
                                               ;
  return 
# 534 "project/radare2/libr/core/blaze.c" 3 4
        0
# 534 "project/radare2/libr/core/blaze.c"
             ;
 }

 Sdb *sdb = 
# 537 "project/radare2/libr/core/blaze.c" 3 4
           ((void *)0)
# 537 "project/radare2/libr/core/blaze.c"
               ;
 
# 538 "project/radare2/libr/core/blaze.c" 3 4
unsigned long long 
# 538 "project/radare2/libr/core/blaze.c"
     cur = 0;
 
# 539 "project/radare2/libr/core/blaze.c" 3 4
unsigned long long 
# 539 "project/radare2/libr/core/blaze.c"
     start = core->offset;
 
# 540 "project/radare2/libr/core/blaze.c" 3 4
unsigned long long 
# 540 "project/radare2/libr/core/blaze.c"
     size = input[0] ? r_num_math (core->num, input + 1) : core->blocksize;
 
# 541 "project/radare2/libr/core/blaze.c" 3 4
unsigned long long 
# 541 "project/radare2/libr/core/blaze.c"
     b_start = start;
 RAnalOp *op;
 RListIter *iter;
 int block_score = 0;
 RList *block_list;
 bb_t *block = 
# 546 "project/radare2/libr/core/blaze.c" 3 4
              ((void *)0)
# 546 "project/radare2/libr/core/blaze.c"
                  ;
 int invalid_instruction_barrier = -20000;
 const 
# 548 "project/radare2/libr/core/blaze.c" 3 4
      _Bool 
# 548 "project/radare2/libr/core/blaze.c"
           debug = r_config_get_b (core->config, "cfg.debug");
 
# 549 "project/radare2/libr/core/blaze.c" 3 4
unsigned long long 
# 549 "project/radare2/libr/core/blaze.c"
     lista[1024] = { 0 };
 int idx = 0;
 int x;
...
# 555 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 555 "project/radare2/libr/core/blaze.c"
 "Failed to create block_list\n"
# 555 "project/radare2/libr/core/blaze.c" 3 4
 )
# 555 "project/radare2/libr/core/blaze.c"
...
# 558 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 558 "project/radare2/libr/core/blaze.c"
 "Analyzing [0x%08"
# 558 "project/radare2/libr/core/blaze.c" 3 4
 "llx"
# 558 "project/radare2/libr/core/blaze.c"
...
# 559 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 559 "project/radare2/libr/core/blaze.c"
 "Creating basic blocks\b"
# 559 "project/radare2/libr/core/blaze.c" 3 4
 )
# 559 "project/radare2/libr/core/blaze.c"
...
# 576 "project/radare2/libr/core/blaze.c" 3 4
   _Bool 
# 576 "project/radare2/libr/core/blaze.c"
        bFound = 
# 576 "project/radare2/libr/core/blaze.c" 3 4
                 0
# 576 "project/radare2/libr/core/blaze.c"
...
# 578 "project/radare2/libr/core/blaze.c" 3 4
   if (
# 578 "project/radare2/libr/core/blaze.c"
   block_list
# 578 "project/radare2/libr/core/blaze.c" 3 4
   ) for (
# 578 "project/radare2/libr/core/blaze.c"
...
# 578 "project/radare2/libr/core/blaze.c"
     ...
     if ( (block->type == END || block->type == NORMAL) && b_start + cur == block->start ) {
      bFound = 
# 580 "project/radare2/libr/core/blaze.c" 3 4
              1
# 580 "project/radare2/libr/core/blaze.c"
                  ;
      break;
     }
    }
...
# 595 "project/radare2/libr/core/blaze.c" 3 4
     fprintf(__stderrp,
# 595 "project/radare2/libr/core/blaze.c"
     "? Bad op at: 0x%08"
# 595 "project/radare2/libr/core/blaze.c" 3 4
     "llx"
# 595 "project/radare2/libr/core/blaze.c"
...
# 596 "project/radare2/libr/core/blaze.c" 3 4
     fprintf(__stderrp,
# 596 "project/radare2/libr/core/blaze.c"
     "Cannot analyze opcode at %"
# 596 "project/radare2/libr/core/blaze.c" 3 4
     "llx"
# 596 "project/radare2/libr/core/blaze.c"
     "\n", b_start + cur
...
# 596 "project/radare2/libr/core/blaze.c"
     ...
     switch (op->type) {
     case R_ANAL_OP_TYPE_RET:
      addBB (block_list, b_start, b_start + cur + op->size, 
# 604 "project/radare2/libr/core/blaze.c" 3 4
                                                           0xFFFFFFFFFFFFFFFFULL
# 604 "project/radare2/libr/core/blaze.c"
                                                                   , 
# 604 "project/radare2/libr/core/blaze.c" 3 4
                                                                     0xFFFFFFFFFFFFFFFFULL
# 604 "project/radare2/libr/core/blaze.c"
     ...
     case R_ANAL_OP_TYPE_IRJMP:
      addBB (block_list, b_start, b_start + cur + op->size, op->jump, 
# 609 "project/radare2/libr/core/blaze.c" 3 4
                                                                     0xFFFFFFFFFFFFFFFFULL
# 609 "project/radare2/libr/core/blaze.c"
                                                                             , END, block_score);
      cur = size;
      break;
     case R_ANAL_OP_TYPE_JMP:
      addBB (block_list, b_start, b_start + cur + op->size, op->jump, 
# 613 "project/radare2/libr/core/blaze.c" 3 4
                                                                     0xFFFFFFFFFFFFFFFFULL
# 613 "project/radare2/libr/core/blaze.c"
                                                                             , END, block_score);
      b_start = op->jump;
      cur = 0;
      block_score = 0;
     ...
     r_anal_op_free (op);
     op = 
# 639 "project/radare2/libr/core/blaze.c" 3 4
         ((void *)0)
# 639 "project/radare2/libr/core/blaze.c"
             ;
    }
    else {
...
# 649 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 649 "project/radare2/libr/core/blaze.c"
 "Found %d basic blocks\n", block_list->length
# 649 "project/radare2/libr/core/blaze.c" 3 4
 )
# 649 "project/radare2/libr/core/blaze.c"
...
# 655 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 655 "project/radare2/libr/core/blaze.c"
 "Failed to create resulting list\n"
# 655 "project/radare2/libr/core/blaze.c" 3 4
 )
# 655 "project/radare2/libr/core/blaze.c"
                                              ;
  return 
# 656 "project/radare2/libr/core/blaze.c" 3 4
        0
# 656 "project/radare2/libr/core/blaze.c"
             ;
 }
...
# 661 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 661 "project/radare2/libr/core/blaze.c"
 "Failed to initialize sdb db\n"
# 661 "project/radare2/libr/core/blaze.c" 3 4
 )
# 661 "project/radare2/libr/core/blaze.c"
  ...
  r_list_free (result);
  return 
# 664 "project/radare2/libr/core/blaze.c" 3 4
        0
# 664 "project/radare2/libr/core/blaze.c"
             ;
 }
...
# 670 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 670 "project/radare2/libr/core/blaze.c"
 "Sorting all blocks done\n"
# 670 "project/radare2/libr/core/blaze.c" 3 4
 )
# 670 "project/radare2/libr/core/blaze.c"
...
# 671 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 671 "project/radare2/libr/core/blaze.c"
 "Creating the complete graph\n"
# 671 "project/radare2/libr/core/blaze.c" 3 4
 )
# 671 "project/radare2/libr/core/blaze.c"
...
# 677 "project/radare2/libr/core/blaze.c" 3 4
  fprintf(__stderrp,
# 677 "project/radare2/libr/core/blaze.c"
  "Failed to get next block from list\n"
# 677 "project/radare2/libr/core/blaze.c" 3 4
  )
# 677 "project/radare2/libr/core/blaze.c"
...
# 687 "project/radare2/libr/core/blaze.c" 3 4
   fprintf(__stderrp,
# 687 "project/radare2/libr/core/blaze.c"
   "No next block to compare with!\n"
# 687 "project/radare2/libr/core/blaze.c" 3 4
   )
# 687 "project/radare2/libr/core/blaze.c"
   ...
   if (block->start == next_block->start && block->end == 
# 691 "project/radare2/libr/core/blaze.c" 3 4
                                                         0xFFFFFFFFFFFFFFFFULL
# 691 "project/radare2/libr/core/blaze.c"
                                                                 ) {
    if (block->type != CALL && next_block->type != CALL) {
     next_block->reached = block->reached + 1;
    }
   ...
   if (block->start == next_block->start && next_block->end == 
# 701 "project/radare2/libr/core/blaze.c" 3 4
                                                              0xFFFFFFFFFFFFFFFFULL
# 701 "project/radare2/libr/core/blaze.c"
                                                                      ) {
    if (next_block->type != CALL) {
     block->reached += 1;
    }
   ...
   if (block->end < 
# 710 "project/radare2/libr/core/blaze.c" 3 4
                   0xFFFFFFFFFFFFFFFFULL 
# 710 "project/radare2/libr/core/blaze.c"
                            && next_block->start < block->end && next_block->start > block->start) {
    if (next_block->jump == 
# 711 "project/radare2/libr/core/blaze.c" 3 4
                           0xFFFFFFFFFFFFFFFFULL
# 711 "project/radare2/libr/core/blaze.c"
                                   ) {
     next_block->jump = block->jump;
    }

    if (next_block->fail == 
# 715 "project/radare2/libr/core/blaze.c" 3 4
                           0xFFFFFFFFFFFFFFFFULL
# 715 "project/radare2/libr/core/blaze.c"
                                   ) {
     next_block->fail = block->fail;
    }
    ...
    block->jump = next_block->start;
    block->fail = 
# 722 "project/radare2/libr/core/blaze.c" 3 4
                 0xFFFFFFFFFFFFFFFFULL
# 722 "project/radare2/libr/core/blaze.c"
                         ;
    next_block->type = block->type;
    if (next_block->type != CALL) {
     next_block->reached += 1;
  ...
  sdb_ptr_set (sdb, sdb_fmt ("bb.0x%08"
# 730 "project/radare2/libr/core/blaze.c" 3 4
                                      "llx"
# 730 "project/radare2/libr/core/blaze.c"
                                             , block->start), block, 0);
  r_list_append (result, block);
 }
...
# 738 "project/radare2/libr/core/blaze.c" 3 4
 fprintf(__stderrp,
# 738 "project/radare2/libr/core/blaze.c"
 "Trying to create functions\n"
# 738 "project/radare2/libr/core/blaze.c" 3 4
 )
# 738 "project/radare2/libr/core/blaze.c"
...
# 741 "project/radare2/libr/core/blaze.c" 3 4
if (
# 741 "project/radare2/libr/core/blaze.c"
result
# 741 "project/radare2/libr/core/blaze.c" 3 4
) for (
# 741 "project/radare2/libr/core/blaze.c"
...
# 741 "project/radare2/libr/core/blaze.c"
  ...
  if (block && (block->reached == 0)) {
   ...
   RStack *stack = r_stack_new (100);
   bb_t *jump = 
# 748 "project/radare2/libr/core/blaze.c" 3 4
               ((void *)0)
# 748 "project/radare2/libr/core/blaze.c"
                   ;
   bb_t *fail = 
# 749 "project/radare2/libr/core/blaze.c" 3 4
               ((void *)0)
# 749 "project/radare2/libr/core/blaze.c"
                   ;
   bb_t *cur = 
# 750 "project/radare2/libr/core/blaze.c" 3 4
              ((void *)0)
# 750 "project/radare2/libr/core/blaze.c"
                  ;

   if (!r_stack_push (stack, (void*)block)) {
    
# 753 "project/radare2/libr/core/blaze.c" 3 4
   fprintf(__stderrp,
# 753 "project/radare2/libr/core/blaze.c"
   "Failed to push initial block\n"
# 753 "project/radare2/libr/core/blaze.c" 3 4
   )
# 753 "project/radare2/libr/core/blaze.c"
   ...
   while (!r_stack_is_empty (stack)) {
    ...
    sdb_num_set (sdb, sdb_fmt("handled.%"
# 761 "project/radare2/libr/core/blaze.c" 3 4
                     "llx"
# 761 "project/radare2/libr/core/blaze.c"
                     "", cur->start), 1, 0);
    if (cur->score < 0) {
     fcnFree (current_function);
     current_function = 
# 764 "project/radare2/libr/core/blaze.c" 3 4
                       ((void *)0)
# 764 "project/radare2/libr/core/blaze.c"
                           ;
     break;
    }

    if ((
# 768 "project/radare2/libr/core/blaze.c" 3 4
        long long
# 768 "project/radare2/libr/core/blaze.c"
            )(cur->end - cur->start) < 0) {
     break;
    }
    ...
    if (cur->jump < 
# 774 "project/radare2/libr/core/blaze.c" 3 4
                   0xFFFFFFFFFFFFFFFFULL 
# 774 "project/radare2/libr/core/blaze.c"
                            && !sdb_num_get (sdb, sdb_fmt("handled.%"
# 774 "project/radare2/libr/core/blaze.c" 3 4
                                                  "llx"
# 774 "project/radare2/libr/core/blaze.c"
...
# 774 "project/radare2/libr/core/blaze.c"
     ...
     jump = sdb_ptr_get (sdb, sdb_fmt ("bb.0x%08"
# 775 "project/radare2/libr/core/blaze.c" 3 4
                                                "llx"
# 775 "project/radare2/libr/core/blaze.c"
                                                       , cur->jump), 
# 775 "project/radare2/libr/core/blaze.c" 3 4
                                                                     ((void *)0)
# 775 "project/radare2/libr/core/blaze.c"
...
# 777 "project/radare2/libr/core/blaze.c" 3 4
     fprintf(__stderrp,
# 777 "project/radare2/libr/core/blaze.c"
     "Failed to get jump block at 0x%"
# 777 "project/radare2/libr/core/blaze.c" 3 4
     "llx"
# 777 "project/radare2/libr/core/blaze.c"
...
# 781 "project/radare2/libr/core/blaze.c" 3 4
     fprintf(__stderrp,
# 781 "project/radare2/libr/core/blaze.c"
     "Failed to push jump block to stack\n"
# 781 "project/radare2/libr/core/blaze.c" 3 4
     )
# 781 "project/radare2/libr/core/blaze.c"
    ...
    if (cur->fail < 
# 785 "project/radare2/libr/core/blaze.c" 3 4
                   0xFFFFFFFFFFFFFFFFULL 
# 785 "project/radare2/libr/core/blaze.c"
                            && !sdb_num_get (sdb, sdb_fmt("handled.%"
# 785 "project/radare2/libr/core/blaze.c" 3 4
                                                  "llx"
# 785 "project/radare2/libr/core/blaze.c"
...
# 785 "project/radare2/libr/core/blaze.c"
     ...
     fail = sdb_ptr_get (sdb, sdb_fmt ("bb.0x%08" 
# 786 "project/radare2/libr/core/blaze.c" 3 4
                                                 "llx"
# 786 "project/radare2/libr/core/blaze.c"
                                                        , cur->fail), 
# 786 "project/radare2/libr/core/blaze.c" 3 4
                                                                      ((void *)0)
# 786 "project/radare2/libr/core/blaze.c"
...
# 788 "project/radare2/libr/core/blaze.c" 3 4
     fprintf(__stderrp,
# 788 "project/radare2/libr/core/blaze.c"
     "Failed to get fail block at 0x%"
# 788 "project/radare2/libr/core/blaze.c" 3 4
     "llx"
# 788 "project/radare2/libr/core/blaze.c"
...
# 792 "project/radare2/libr/core/blaze.c" 3 4
     fprintf(__stderrp,
# 792 "project/radare2/libr/core/blaze.c"
     "Failed to push jump block to stack\n"
# 792 "project/radare2/libr/core/blaze.c" 3 4
     )
# 792 "project/radare2/libr/core/blaze.c"
   ...
   if (current_function) {
    ...
    if (current_function->addr == start) {
     ...
     if (checkFunction (current_function)) {
      if (input[0] == '*') {
       printFunctionCommands (core, current_function, 
# 805 "project/radare2/libr/core/blaze.c" 3 4
                                                     ((void *)0)
# 805 "project/radare2/libr/core/blaze.c"
                                                         );
      }
      else {
       createFunction (core, current_function, 
# 808 "project/radare2/libr/core/blaze.c" 3 4
                                              ((void *)0)
# 808 "project/radare2/libr/core/blaze.c"
                                                  );
      }
      fcnFree (current_function);
      r_stack_free (stack);
 ...
 r_list_free (block_list);
 return 
# 824 "project/radare2/libr/core/blaze.c" 3 4
       1
# 824 "project/radare2/libr/core/blaze.c"
           ;
}
