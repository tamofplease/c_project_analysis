# 0 "project/radare2/libr/core/cio.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/core/cio.c" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/core/cio.c"
     int r_core_setup_debugger (RCore *r, const char *debugbackend, 
# 5 "project/radare2/libr/core/cio.c" 3 4
                                                                    _Bool 
# 5 "project/radare2/libr/core/cio.c"
                                                                         attach) {
 int pid, *p = 
# 6 "project/radare2/libr/core/cio.c" 3 4
              ((void *)0)
# 6 "project/radare2/libr/core/cio.c"
                  ;
 
# 7 "project/radare2/libr/core/cio.c" 3 4
_Bool 
# 7 "project/radare2/libr/core/cio.c"
     is_gdb = !strcmp (debugbackend, "gdb");
 RIODesc * fd = r->io->desc;
 const char *prompt = 
# 9 "project/radare2/libr/core/cio.c" 3 4
                     ((void *)0)
# 9 "project/radare2/libr/core/cio.c"
                         ;

 p = fd ? fd->data : 
# 11 "project/radare2/libr/core/cio.c" 3 4
                    ((void *)0)
# 11 "project/radare2/libr/core/cio.c"
                        ;
 r_config_set_b (r->config, "cfg.debug", 
# 12 "project/radare2/libr/core/cio.c" 3 4
                                        1
# 12 "project/radare2/libr/core/cio.c"
                                            );
 if (!p) {
  
# 14 "project/radare2/libr/core/cio.c" 3 4
 fprintf(__stderrp,
# 14 "project/radare2/libr/core/cio.c"
 "Invalid debug io\n"
# 14 "project/radare2/libr/core/cio.c" 3 4
 )
# 14 "project/radare2/libr/core/cio.c"
                               ;
  return 
# 15 "project/radare2/libr/core/cio.c" 3 4
        0
# 15 "project/radare2/libr/core/cio.c"
             ;
 }
...
# 28 "project/radare2/libr/core/cio.c" 3 4
  fprintf(__stderrp,
# 28 "project/radare2/libr/core/cio.c"
  "Cannot retrieve pid from io.\n"
# 28 "project/radare2/libr/core/cio.c" 3 4
  )
# 28 "project/radare2/libr/core/cio.c"
                                            ;
 ...
 return 
# 60 "project/radare2/libr/core/cio.c" 3 4
       1
# 60 "project/radare2/libr/core/cio.c"
           ;
}


# 63 "project/radare2/libr/core/cio.c" 3 4
__attribute__((visibility("default"))) 
# 63 "project/radare2/libr/core/cio.c"
     int r_core_seek_base (RCore *core, const char *hex) {
 
# 64 "project/radare2/libr/core/cio.c" 3 4
unsigned long long 
# 64 "project/radare2/libr/core/cio.c"
     addr = r_num_tail (core->num, core->offset, hex);
 return r_core_seek (core, addr, 
# 65 "project/radare2/libr/core/cio.c" 3 4
                                1
# 65 "project/radare2/libr/core/cio.c"
                                    );
}


# 68 "project/radare2/libr/core/cio.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 68 "project/radare2/libr/core/cio.c"
          r_core_dump(RCore *core, const char *file, 
# 68 "project/radare2/libr/core/cio.c" 3 4
                                                     unsigned long long 
# 68 "project/radare2/libr/core/cio.c"
                                                          addr, 
...
# 69 "project/radare2/libr/core/cio.c" 3 4
unsigned long long 
# 69 "project/radare2/libr/core/cio.c"
     i;
 
# 70 "project/radare2/libr/core/cio.c" 3 4
unsigned char 
# 70 "project/radare2/libr/core/cio.c"
    *buf;
...
# 80 "project/radare2/libr/core/cio.c" 3 4
 fprintf(__stderrp,
# 80 "project/radare2/libr/core/cio.c"
...
# 80 "project/radare2/libr/core/cio.c"
                                                 ;
  return 
# 81 "project/radare2/libr/core/cio.c" 3 4
        0
# 81 "project/radare2/libr/core/cio.c"
             ;
 }
...
# 89 "project/radare2/libr/core/cio.c" 3 4
 fprintf(__stderrp,
# 89 "project/radare2/libr/core/cio.c"
...
# 89 "project/radare2/libr/core/cio.c"
  ...
  fclose (fd);
  return 
# 91 "project/radare2/libr/core/cio.c" 3 4
        0
# 91 "project/radare2/libr/core/cio.c"
             ;
 }
 r_cons_break_push (
# 93 "project/radare2/libr/core/cio.c" 3 4
                   ((void *)0)
# 93 "project/radare2/libr/core/cio.c"
                       , 
# 93 "project/radare2/libr/core/cio.c" 3 4
                         ((void *)0)
# 93 "project/radare2/libr/core/cio.c"
...
# 103 "project/radare2/libr/core/cio.c" 3 4
  fprintf(__stderrp,
# 103 "project/radare2/libr/core/cio.c"
  "write error\n"
# 103 "project/radare2/libr/core/cio.c" 3 4
  )
# 103 "project/radare2/libr/core/cio.c"
 ...
 free (buf);
 return 
# 110 "project/radare2/libr/core/cio.c" 3 4
       1
# 110 "project/radare2/libr/core/cio.c"
           ;
}

static 
# 113 "project/radare2/libr/core/cio.c" 3 4
      _Bool 
# 113 "project/radare2/libr/core/cio.c"
           __endian_swap(
# 113 "project/radare2/libr/core/cio.c" 3 4
                         unsigned char 
# 113 "project/radare2/libr/core/cio.c"
...
# 114 "project/radare2/libr/core/cio.c" 3 4
unsigned int 
# 114 "project/radare2/libr/core/cio.c"
     i;
 
# 115 "project/radare2/libr/core/cio.c" 3 4
unsigned short 
# 115 "project/radare2/libr/core/cio.c"
     v16;
 
# 116 "project/radare2/libr/core/cio.c" 3 4
unsigned int 
# 116 "project/radare2/libr/core/cio.c"
     v32;
 
# 117 "project/radare2/libr/core/cio.c" 3 4
unsigned long long 
# 117 "project/radare2/libr/core/cio.c"
     v64;
 if (len != 8 && len != 4 && len != 2 && len != 1) {
  
# 119 "project/radare2/libr/core/cio.c" 3 4
 fprintf(__stderrp,
# 119 "project/radare2/libr/core/cio.c"
...
# 119 "project/radare2/libr/core/cio.c"
                                                  ;
  return 
# 120 "project/radare2/libr/core/cio.c" 3 4
        0
# 120 "project/radare2/libr/core/cio.c"
             ;
 }
 if (len == 1) {
  return 
# 123 "project/radare2/libr/core/cio.c" 3 4
        1
# 123 "project/radare2/libr/core/cio.c"
            ;
 }
 ...
 return 
# 141 "project/radare2/libr/core/cio.c" 3 4
       1
# 141 "project/radare2/libr/core/cio.c"
           ;
}


# 144 "project/radare2/libr/core/cio.c" 3 4
__attribute__((visibility("default"))) unsigned char
# 144 "project/radare2/libr/core/cio.c"
        * r_core_transform_op(RCore *core, const char *arg, char op) {
 int i, j;
 
# 146 "project/radare2/libr/core/cio.c" 3 4
unsigned long long 
# 146 "project/radare2/libr/core/cio.c"
     len;
 char *str = 
# 147 "project/radare2/libr/core/cio.c" 3 4
            ((void *)0)
# 147 "project/radare2/libr/core/cio.c"
                ;
 
# 148 "project/radare2/libr/core/cio.c" 3 4
unsigned char 
# 148 "project/radare2/libr/core/cio.c"
    *buf = (
# 148 "project/radare2/libr/core/cio.c" 3 4
            unsigned char 
# 148 "project/radare2/libr/core/cio.c"
 ...
 if (!buf) {
  return 
# 150 "project/radare2/libr/core/cio.c" 3 4
        ((void *)0)
# 150 "project/radare2/libr/core/cio.c"
            ;
 }
 if (op == 'i') {
...
# 161 "project/radare2/libr/core/cio.c" 3 4
__builtin___memcpy_chk (
# 161 "project/radare2/libr/core/cio.c"
buf
# 161 "project/radare2/libr/core/cio.c" 3 4
, 
# 161 "project/radare2/libr/core/cio.c"
...
# 161 "project/radare2/libr/core/cio.c"
 ...
 if (op != 'e') {
  ...
  if (arg) {
   ...
   len = r_hex_str2bin (arg, (
# 172 "project/radare2/libr/core/cio.c" 3 4
                             unsigned char 
# 172 "project/radare2/libr/core/cio.c"
                                 *)str);


   if (len <= 0) {
    
# 176 "project/radare2/libr/core/cio.c" 3 4
   fprintf(__stderrp,
# 176 "project/radare2/libr/core/cio.c"
...
# 176 "project/radare2/libr/core/cio.c"
   ...
   const 
# 180 "project/radare2/libr/core/cio.c" 3 4
        unsigned char 
# 180 "project/radare2/libr/core/cio.c"
            *tmp = r_buf_data (core->yank_buf, &len);
 ...
 if (op == 'e') {
  ...
  int n = 0, from = 0, to = 
# 194 "project/radare2/libr/core/cio.c" 3 4
                           0xFFU
# 194 "project/radare2/libr/core/cio.c"
                                  , dif = 0, step = 1;
  os = s;
  p = strchr (s, ' ');
  if (p) {
...
# 218 "project/radare2/libr/core/cio.c" 3 4
 fprintf(__stderrp,
# 218 "project/radare2/libr/core/cio.c"
 "from %d to %d step %d size %d\n", from, to, step, wordsize
# 218 "project/radare2/libr/core/cio.c" 3 4
 )
# 218 "project/radare2/libr/core/cio.c"
                                                                      ;
  dif = (to <= from)? 
# 219 "project/radare2/libr/core/cio.c" 3 4
                     0xFFU
# 219 "project/radare2/libr/core/cio.c"
                            : to - from + 1;
  if (wordsize == 1) {
   from %= (
# 221 "project/radare2/libr/core/cio.c" 3 4
           0xFFU 
# 221 "project/radare2/libr/core/cio.c"
                   + 1);
  }
  if (dif < 1) {
   dif = 
# 224 "project/radare2/libr/core/cio.c" 3 4
        0xFFU 
# 224 "project/radare2/libr/core/cio.c"
                + 1;
  }
  if (step < 1) {
   step = 1;
  ...
  if (wordsize == 1) {
   for (i = n = 0; i < core->blocksize; i++, n += step) {
    buf[i] = (
# 234 "project/radare2/libr/core/cio.c" 3 4
             unsigned char
# 234 "project/radare2/libr/core/cio.c"
                )(n % dif) + from;
   }
  } else if (wordsize == 2) {
   
# 237 "project/radare2/libr/core/cio.c" 3 4
  unsigned short 
# 237 "project/radare2/libr/core/cio.c"
       num16 = from;
...
# 242 "project/radare2/libr/core/cio.c" 3 4
  unsigned int 
# 242 "project/radare2/libr/core/cio.c"
       num32 = from;
...
# 247 "project/radare2/libr/core/cio.c" 3 4
  unsigned long long 
# 247 "project/radare2/libr/core/cio.c"
       num64 = from;
...
# 252 "project/radare2/libr/core/cio.c" 3 4
  fprintf(__stderrp,
# 252 "project/radare2/libr/core/cio.c"
  "Invalid word size. Use 1, 2, 4 or 8\n"
# 252 "project/radare2/libr/core/cio.c" 3 4
  )
# 252 "project/radare2/libr/core/cio.c"
...
# 256 "project/radare2/libr/core/cio.c" 3 4
 unsigned char 
# 256 "project/radare2/libr/core/cio.c"
     tmp;
...
# 286 "project/radare2/libr/core/cio.c" 3 4
   fprintf(__stderrp,
# 286 "project/radare2/libr/core/cio.c"
   "Invalid inc, use 2, 4 or 8.\n"
# 286 "project/radare2/libr/core/cio.c" 3 4
   )
# 286 "project/radare2/libr/core/cio.c"
                                            ;
...
# 291 "project/radare2/libr/core/cio.c" 3 4
 _Bool 
# 291 "project/radare2/libr/core/cio.c"
      be = r_config_get_i (core->config, "cfg.bigendian");
  if (!be) {
   if (!__endian_swap ((
# 293 "project/radare2/libr/core/cio.c" 3 4
                       unsigned char
# 293 "project/radare2/libr/core/cio.c"
                          *)str, len, len)) {
    goto beach;
   }
  }
...
beach:
 ...
 free (buf);
 return 
# 322 "project/radare2/libr/core/cio.c" 3 4
       ((void *)0)
# 322 "project/radare2/libr/core/cio.c"
           ;
}


# 325 "project/radare2/libr/core/cio.c" 3 4
__attribute__((visibility("default"))) 
# 325 "project/radare2/libr/core/cio.c"
     int r_core_write_op(RCore *core, const char *arg, char op) {
 
# 326 "project/radare2/libr/core/cio.c" 3 4
unsigned char 
# 326 "project/radare2/libr/core/cio.c"
    *buf = r_core_transform_op (core, arg, op);
 if (!buf) {
  return 
# 328 "project/radare2/libr/core/cio.c" 3 4
        0
# 328 "project/radare2/libr/core/cio.c"
             ;
 }
...
# 337 "project/radare2/libr/core/cio.c" 3 4
__attribute__((visibility("default"))) 
# 337 "project/radare2/libr/core/cio.c"
     void r_core_arch_bits_at(RCore *core, 
# 337 "project/radare2/libr/core/cio.c" 3 4
                                           unsigned long long 
# 337 "project/radare2/libr/core/cio.c"
                                                addr, int *bits, const char **arch) {
 int bitsval = 0;
 const char *archval = 
# 339 "project/radare2/libr/core/cio.c" 3 4
                      ((void *)0)
# 339 "project/radare2/libr/core/cio.c"
                          ;
 RBinObject *o = r_bin_cur_object (core->bin);
 RBinSection *s = o ? r_bin_get_section_at (o, addr, core->io->va) : 
# 341 "project/radare2/libr/core/cio.c" 3 4
                                                                    ((void *)0)
# 341 "project/radare2/libr/core/cio.c"
                                                                        ;
 if (s) {
  if (!core->fixedarch) {
   archval = s->arch;
  ...
  if (!core->fixedbits && s->bits) {
   ...
   switch (s->bits) {
   case 
# 349 "project/radare2/libr/core/cio.c" 3 4
       2
# 349 "project/radare2/libr/core/cio.c"
                    :
   case 
# 350 "project/radare2/libr/core/cio.c" 3 4
       4
# 350 "project/radare2/libr/core/cio.c"
                    :
   case 
# 351 "project/radare2/libr/core/cio.c" 3 4
       8
# 351 "project/radare2/libr/core/cio.c"
                    :
    bitsval = s->bits * 8;
    break;
   }
...
# 359 "project/radare2/libr/core/cio.c" 3 4
                                                  ((void *)0)
# 359 "project/radare2/libr/core/cio.c"
                                                      );
 }
 if (arch && !archval && !core->fixedarch) {
  archval = r_anal_hint_arch_at (core->anal, addr, 
# 362 "project/radare2/libr/core/cio.c" 3 4
                                                  ((void *)0)
# 362 "project/radare2/libr/core/cio.c"
                                                      );
 }
 if (bits && bitsval) {
  *bits = bitsval;
...
# 372 "project/radare2/libr/core/cio.c" 3 4
__attribute__((visibility("default"))) 
# 372 "project/radare2/libr/core/cio.c"
     void r_core_seek_arch_bits(RCore *core, 
# 372 "project/radare2/libr/core/cio.c" 3 4
                                             unsigned long long 
# 372 "project/radare2/libr/core/cio.c"
                                                  addr) {
 int bits = 0;
 const char *arch = 
# 374 "project/radare2/libr/core/cio.c" 3 4
                   ((void *)0)
# 374 "project/radare2/libr/core/cio.c"
                       ;
...
# 384 "project/radare2/libr/core/cio.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 384 "project/radare2/libr/core/cio.c"
          r_core_seek(RCore *core, 
# 384 "project/radare2/libr/core/cio.c" 3 4
                                   unsigned long long 
# 384 "project/radare2/libr/core/cio.c"
                                        addr, 
...
# 384 "project/radare2/libr/core/cio.c"
                                                   rb) {
 core->offset = r_io_seek (core->io, addr, 
# 385 "project/radare2/libr/core/cio.c" 3 4
                                          0
# 385 "project/radare2/libr/core/cio.c"
                                                       );
 if (rb) {
 ...
 if (core->binat) {
  ...
  if (bf) {
   ...
   core->bin->cur = 
# 396 "project/radare2/libr/core/cio.c" 3 4
                   ((void *)0)
# 396 "project/radare2/libr/core/cio.c"
                       ;
  }
 }
...
# 402 "project/radare2/libr/core/cio.c" 3 4
__attribute__((visibility("default"))) 
# 402 "project/radare2/libr/core/cio.c"
     int r_core_seek_delta(RCore *core, 
# 402 "project/radare2/libr/core/cio.c" 3 4
                                        long long 
# 402 "project/radare2/libr/core/cio.c"
                                             addr) {
 
# 403 "project/radare2/libr/core/cio.c" 3 4
unsigned long long 
# 403 "project/radare2/libr/core/cio.c"
     tmp = core->offset;
 if (addr == 0) {
  return 
# 405 "project/radare2/libr/core/cio.c" 3 4
        1
# 405 "project/radare2/libr/core/cio.c"
            ;
 }
 if (addr > 0LL) {
 ...
 core->offset = addr;
 return r_core_seek (core, addr, 
# 419 "project/radare2/libr/core/cio.c" 3 4
                                1
# 419 "project/radare2/libr/core/cio.c"
                                    );
}



# 423 "project/radare2/libr/core/cio.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 423 "project/radare2/libr/core/cio.c"
          r_core_write_at(RCore *core, 
# 423 "project/radare2/libr/core/cio.c" 3 4
                                       unsigned long long 
# 423 "project/radare2/libr/core/cio.c"
                                            addr, const 
...
# 424 "project/radare2/libr/core/cio.c" 3 4
do { if (!(
# 424 "project/radare2/libr/core/cio.c"
core && buf && addr != 
# 424 "project/radare2/libr/core/cio.c" 3 4
0xFFFFFFFFFFFFFFFFULL)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 424 "project/radare2/libr/core/cio.c"
"core && buf && addr != UT64_MAX"
# 424 "project/radare2/libr/core/cio.c" 3 4
, 424); return (0); } } while (0)
# 424 "project/radare2/libr/core/cio.c"
                                                             ;
 if (size < 1) {
  return 
# 426 "project/radare2/libr/core/cio.c" 3 4
        0
# 426 "project/radare2/libr/core/cio.c"
             ;
 }
 
# 428 "project/radare2/libr/core/cio.c" 3 4
_Bool 
# 428 "project/radare2/libr/core/cio.c"
...
# 435 "project/radare2/libr/core/cio.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 435 "project/radare2/libr/core/cio.c"
          r_core_extend_at(RCore *core, 
# 435 "project/radare2/libr/core/cio.c" 3 4
                                        unsigned long long 
# 435 "project/radare2/libr/core/cio.c"
                                             addr, int size) {
 if (!core->io || !core->io->desc || size < 1) {
  return 
# 437 "project/radare2/libr/core/cio.c" 3 4
        0
# 437 "project/radare2/libr/core/cio.c"
             ;
 }
 ...
 if (io_va) {
  ...
  if (map) {
   addr = addr - 
# 443 "project/radare2/libr/core/cio.c" 3 4
                r_itv_begin (
# 443 "project/radare2/libr/core/cio.c"
                map
# 443 "project/radare2/libr/core/cio.c" 3 4
                ->itv) 
# 443 "project/radare2/libr/core/cio.c"
  ...
  r_config_set_i (core->config, "io.va", 
# 445 "project/radare2/libr/core/cio.c" 3 4
                                        0
# 445 "project/radare2/libr/core/cio.c"
                                             );
 }
...
# 455 "project/radare2/libr/core/cio.c" 3 4
__attribute__((visibility("default"))) 
# 455 "project/radare2/libr/core/cio.c"
     int r_core_shift_block(RCore *core, 
# 455 "project/radare2/libr/core/cio.c" 3 4
                                         unsigned long long 
# 455 "project/radare2/libr/core/cio.c"
                                              addr, 
...
# 457 "project/radare2/libr/core/cio.c" 3 4
unsigned long long 
# 457 "project/radare2/libr/core/cio.c"
     fend = 0, fstart = 0, bstart = 0, file_sz = 0;
 
# 458 "project/radare2/libr/core/cio.c" 3 4
unsigned char 
# 458 "project/radare2/libr/core/cio.c"
    * shift_buf = 
# 458 "project/radare2/libr/core/cio.c" 3 4
                  ((void *)0)
# 458 "project/radare2/libr/core/cio.c"
                      ;
 int res = 
# 459 "project/radare2/libr/core/cio.c" 3 4
          0
# 459 "project/radare2/libr/core/cio.c"
               ;

 if (!core->io || !core->io->desc) {
  return 
# 462 "project/radare2/libr/core/cio.c" 3 4
        0
# 462 "project/radare2/libr/core/cio.c"
             ;
 }

 if (b_size == 0 || b_size == (
# 465 "project/radare2/libr/core/cio.c" 3 4
                              unsigned long long
# 465 "project/radare2/libr/core/cio.c"
                                  ) -1) {
  r_io_use_fd (core->io, core->io->desc->fd);
  file_sz = r_io_size (core->io);
  if (file_sz == 
# 468 "project/radare2/libr/core/cio.c" 3 4
                0xFFFFFFFFFFFFFFFFULL
# 468 "project/radare2/libr/core/cio.c"
                        ) {
   file_sz = 0;
  }
 ...
 if ((
# 485 "project/radare2/libr/core/cio.c" 3 4
     long long
# 485 "project/radare2/libr/core/cio.c"
         )b_size < 1) {
  return 
# 486 "project/radare2/libr/core/cio.c" 3 4
        0
# 486 "project/radare2/libr/core/cio.c"
             ;
 }
 shift_buf = calloc (b_size, 1);
 if (!shift_buf) {
  
# 490 "project/radare2/libr/core/cio.c" 3 4
 fprintf(__stderrp,
# 490 "project/radare2/libr/core/cio.c"
...
# 490 "project/radare2/libr/core/cio.c"
                                                       ;
  return 
# 491 "project/radare2/libr/core/cio.c" 3 4
        0
# 491 "project/radare2/libr/core/cio.c"
             ;
 }
# 504 "project/radare2/libr/core/cio.c"
 if (addr + dist < fstart) {
  res = 
# 505 "project/radare2/libr/core/cio.c" 3 4
       0
# 505 "project/radare2/libr/core/cio.c"
            ;

 } else if ( (addr) + dist > fend) {
  res = 
# 508 "project/radare2/libr/core/cio.c" 3 4
       0
# 508 "project/radare2/libr/core/cio.c"
            ;
 } else {
  r_io_read_at (core->io, addr, shift_buf, b_size);
  r_io_write_at (core->io, addr + dist, shift_buf, b_size);
  res = 
# 512 "project/radare2/libr/core/cio.c" 3 4
       1
# 512 "project/radare2/libr/core/cio.c"
           ;
 }
 r_core_seek (core, addr, 
# 514 "project/radare2/libr/core/cio.c" 3 4
                         1
# 514 "project/radare2/libr/core/cio.c"
                             );
 free (shift_buf);
 return res;
}
...
# 519 "project/radare2/libr/core/cio.c" 3 4
__attribute__((visibility("default"))) 
# 519 "project/radare2/libr/core/cio.c"
