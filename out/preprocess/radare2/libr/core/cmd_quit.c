# 0 "project/radare2/libr/core/cmd_quit.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/core/cmd_quit.c" 2


# 5 "project/radare2/libr/core/cmd_quit.c"
...
# 15 "project/radare2/libr/core/cmd_quit.c" 3 4
((void *)0)

# 16 "project/radare2/libr/core/cmd_quit.c"
};
...
static int cmd_Quit(void *data, const char *input) {
 ...
 if (input[0] == '!') {
  if (input[1] == '!' || !input[1]) {
   if (!r_sandbox_enable (
# 22 "project/radare2/libr/core/cmd_quit.c" 3 4
                         0
# 22 "project/radare2/libr/core/cmd_quit.c"
                              )) {
    r_cons_flush ();
    exit (0);
   }
 ...
 if (
# 30 "project/radare2/libr/core/cmd_quit.c" 3 4
    ((
# 30 "project/radare2/libr/core/cmd_quit.c"
    input[0]
# 30 "project/radare2/libr/core/cmd_quit.c" 3 4
    ) >= '0' && (
# 30 "project/radare2/libr/core/cmd_quit.c"
...
static int cmd_quit(void *data, const char *input) {
 ...
 return 
# 73 "project/radare2/libr/core/cmd_quit.c" 3 4
       0
# 73 "project/radare2/libr/core/cmd_quit.c"
            ;
}
