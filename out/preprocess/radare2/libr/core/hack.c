# 0 "project/radare2/libr/core/hack.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/hack.c"
...
# 4 "project/radare2/libr/core/hack.c" 2
...
# 10 "project/radare2/libr/core/hack.c"
...
# 24 "project/radare2/libr/core/hack.c" 3 4
 ((void *)0)
 
# 25 "project/radare2/libr/core/hack.c"
};
 r_core_cmd_help (core, help_msg);
}


# 29 "project/radare2/libr/core/hack.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 29 "project/radare2/libr/core/hack.c"
          r_core_hack_dalvik(RCore *core, const char *op, const RAnalOp *analop) {
 if (!strcmp (op, "nop")) {
...
# 41 "project/radare2/libr/core/hack.c" 3 4
 fprintf(__stderrp,
# 41 "project/radare2/libr/core/hack.c"
...
# 41 "project/radare2/libr/core/hack.c"
                                             ;
  return 
# 42 "project/radare2/libr/core/hack.c" 3 4
        0
# 42 "project/radare2/libr/core/hack.c"
             ;
 }
 return 
# 44 "project/radare2/libr/core/hack.c" 3 4
       1
# 44 "project/radare2/libr/core/hack.c"
           ;
}


# 47 "project/radare2/libr/core/hack.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 47 "project/radare2/libr/core/hack.c"
          r_core_hack_arm64(RCore *core, const char *op, const RAnalOp *analop) {
 if (!strcmp (op, "nop")) {
...
# 55 "project/radare2/libr/core/hack.c" 3 4
 fprintf(__stderrp,
# 55 "project/radare2/libr/core/hack.c"
...
# 55 "project/radare2/libr/core/hack.c"
                                        ;
  return 
# 56 "project/radare2/libr/core/hack.c" 3 4
        0
# 56 "project/radare2/libr/core/hack.c"
             ;
 } else if (!strcmp (op, "jinf")) {
  r_core_cmdf (core, "wx 00000014");
 } else if (!strcmp (op, "jnz") || !strcmp (op, "jne")) {
  
# 60 "project/radare2/libr/core/hack.c" 3 4
 fprintf(__stderrp,
# 60 "project/radare2/libr/core/hack.c"
...
# 60 "project/radare2/libr/core/hack.c"
                                         ;
  return 
# 61 "project/radare2/libr/core/hack.c" 3 4
        0
# 61 "project/radare2/libr/core/hack.c"
             ;
 } else if (!strcmp (op, "nocj")) {
  
# 63 "project/radare2/libr/core/hack.c" 3 4
 fprintf(__stderrp,
# 63 "project/radare2/libr/core/hack.c"
 "ARM jnz hack not supported\n"
# 63 "project/radare2/libr/core/hack.c" 3 4
 )
# 63 "project/radare2/libr/core/hack.c"
                                         ;
  return 
# 64 "project/radare2/libr/core/hack.c" 3 4
        0
# 64 "project/radare2/libr/core/hack.c"
             ;
 } else if (!strcmp (op, "recj")) {
  
# 66 "project/radare2/libr/core/hack.c" 3 4
 fprintf(__stderrp,
# 66 "project/radare2/libr/core/hack.c"
 "TODO: use jnz or jz\n"
# 66 "project/radare2/libr/core/hack.c" 3 4
 )
# 66 "project/radare2/libr/core/hack.c"
                                  ;
  return 
# 67 "project/radare2/libr/core/hack.c" 3 4
        0
# 67 "project/radare2/libr/core/hack.c"
             ;
 } else if (!strcmp (op, "ret1")) {
...
# 75 "project/radare2/libr/core/hack.c" 3 4
 fprintf(__stderrp,
# 75 "project/radare2/libr/core/hack.c"
 "Invalid operation '%s'\n", op
# 75 "project/radare2/libr/core/hack.c" 3 4
 )
# 75 "project/radare2/libr/core/hack.c"
                                         ;
  return 
# 76 "project/radare2/libr/core/hack.c" 3 4
        0
# 76 "project/radare2/libr/core/hack.c"
             ;
 }
 return 
# 78 "project/radare2/libr/core/hack.c" 3 4
       1
# 78 "project/radare2/libr/core/hack.c"
           ;
}

# 80 "project/radare2/libr/core/hack.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 80 "project/radare2/libr/core/hack.c"
          r_core_hack_arm(RCore *core, const char *op, const RAnalOp *analop) {
 const int bits = core->rasm->bits;
 const 
# 82 "project/radare2/libr/core/hack.c" 3 4
      unsigned char 
# 82 "project/radare2/libr/core/hack.c"
          *b = core->block;
...
# 92 "project/radare2/libr/core/hack.c" 3 4
  fprintf(__stderrp,
# 92 "project/radare2/libr/core/hack.c"
...
# 92 "project/radare2/libr/core/hack.c"
                                    ;
   return 
# 93 "project/radare2/libr/core/hack.c" 3 4
         0
# 93 "project/radare2/libr/core/hack.c"
              ;
  }
  ...
  if (!str) {
   return 
# 98 "project/radare2/libr/core/hack.c" 3 4
         0
# 98 "project/radare2/libr/core/hack.c"
              ;
  }
  for (i=0; i < len; i+=nopsize) {
   
# 101 "project/radare2/libr/core/hack.c" 3 4
  __builtin___memcpy_chk (
# 101 "project/radare2/libr/core/hack.c"
  str + i * 2
# 101 "project/radare2/libr/core/hack.c" 3 4
  , 
# 101 "project/radare2/libr/core/hack.c"
...
# 124 "project/radare2/libr/core/hack.c" 3 4
   fprintf(__stderrp,
# 124 "project/radare2/libr/core/hack.c"
...
# 124 "project/radare2/libr/core/hack.c"
                                                  ;
    return 
# 125 "project/radare2/libr/core/hack.c" 3 4
          0
# 125 "project/radare2/libr/core/hack.c"
               ;
   }
  } else {
   
# 128 "project/radare2/libr/core/hack.c" 3 4
  fprintf(__stderrp,
# 128 "project/radare2/libr/core/hack.c"
  "ARM jz hack not supported\n"
# 128 "project/radare2/libr/core/hack.c" 3 4
  )
# 128 "project/radare2/libr/core/hack.c"
                                         ;
   return 
# 129 "project/radare2/libr/core/hack.c" 3 4
         0
# 129 "project/radare2/libr/core/hack.c"
              ;
  }
 } else if (!strcmp (op, "jnz") || !strcmp (op, "jne")) {
  if (bits == 16) {
...
# 144 "project/radare2/libr/core/hack.c" 3 4
   fprintf(__stderrp,
# 144 "project/radare2/libr/core/hack.c"
   "Current opcode is not conditional\n"
# 144 "project/radare2/libr/core/hack.c" 3 4
   )
# 144 "project/radare2/libr/core/hack.c"
                                                  ;
    return 
# 145 "project/radare2/libr/core/hack.c" 3 4
          0
# 145 "project/radare2/libr/core/hack.c"
               ;
   }
  } else {
   
# 148 "project/radare2/libr/core/hack.c" 3 4
  fprintf(__stderrp,
# 148 "project/radare2/libr/core/hack.c"
  "ARM jnz hack not supported\n"
# 148 "project/radare2/libr/core/hack.c" 3 4
  )
# 148 "project/radare2/libr/core/hack.c"
                                          ;
   return 
# 149 "project/radare2/libr/core/hack.c" 3 4
         0
# 149 "project/radare2/libr/core/hack.c"
              ;
  }
 } else if (!strcmp (op, "nocj")) {
...
# 164 "project/radare2/libr/core/hack.c" 3 4
   fprintf(__stderrp,
# 164 "project/radare2/libr/core/hack.c"
   "Current opcode is not conditional\n"
# 164 "project/radare2/libr/core/hack.c" 3 4
   )
# 164 "project/radare2/libr/core/hack.c"
                                                  ;
    return 
# 165 "project/radare2/libr/core/hack.c" 3 4
          0
# 165 "project/radare2/libr/core/hack.c"
               ;
   }
  } else {
   
# 168 "project/radare2/libr/core/hack.c" 3 4
  fprintf(__stderrp,
# 168 "project/radare2/libr/core/hack.c"
...
# 168 "project/radare2/libr/core/hack.c"
                                              ;
   return 
# 169 "project/radare2/libr/core/hack.c" 3 4
         0
# 169 "project/radare2/libr/core/hack.c"
              ;
  }
 } else if (!strcmp (op, "recj")) {
  
# 172 "project/radare2/libr/core/hack.c" 3 4
 fprintf(__stderrp,
# 172 "project/radare2/libr/core/hack.c"
 "TODO: use jnz or jz\n"
# 172 "project/radare2/libr/core/hack.c" 3 4
 )
# 172 "project/radare2/libr/core/hack.c"
                                  ;
  return 
# 173 "project/radare2/libr/core/hack.c" 3 4
        0
# 173 "project/radare2/libr/core/hack.c"
             ;
 } else if (!strcmp (op, "ret1")) {
  if (bits == 16) {
...
# 193 "project/radare2/libr/core/hack.c" 3 4
 fprintf(__stderrp,
# 193 "project/radare2/libr/core/hack.c"
 "Invalid operation\n"
# 193 "project/radare2/libr/core/hack.c" 3 4
 )
# 193 "project/radare2/libr/core/hack.c"
                                ;
  return 
# 194 "project/radare2/libr/core/hack.c" 3 4
        0
# 194 "project/radare2/libr/core/hack.c"
             ;
 }
 return 
# 196 "project/radare2/libr/core/hack.c" 3 4
       1
# 196 "project/radare2/libr/core/hack.c"
           ;
}


# 199 "project/radare2/libr/core/hack.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 199 "project/radare2/libr/core/hack.c"
          r_core_hack_x86(RCore *core, const char *op, const RAnalOp *analop) {
 const 
# 200 "project/radare2/libr/core/hack.c" 3 4
      unsigned char 
# 200 "project/radare2/libr/core/hack.c"
          *b = core->block;
 int i, size = analop->size;
 if (!strcmp (op, "nop")) {
  if (size * 2 + 1 < size) {
   return 
# 204 "project/radare2/libr/core/hack.c" 3 4
         0
# 204 "project/radare2/libr/core/hack.c"
              ;
  }
  char *str = malloc (size * 2 + 1);
  if (!str) {
   return 
# 208 "project/radare2/libr/core/hack.c" 3 4
         0
# 208 "project/radare2/libr/core/hack.c"
              ;
  }
  for (i = 0; i < size; i++) {
   
# 211 "project/radare2/libr/core/hack.c" 3 4
  __builtin___memcpy_chk (
# 211 "project/radare2/libr/core/hack.c"
  str + (i * 2)
# 211 "project/radare2/libr/core/hack.c" 3 4
  , 
# 211 "project/radare2/libr/core/hack.c"
...
# 222 "project/radare2/libr/core/hack.c" 3 4
  fprintf(__stderrp,
# 222 "project/radare2/libr/core/hack.c"
  "Current opcode is not conditional\n"
# 222 "project/radare2/libr/core/hack.c" 3 4
  )
# 222 "project/radare2/libr/core/hack.c"
                                                 ;
   return 
# 223 "project/radare2/libr/core/hack.c" 3 4
         0
# 223 "project/radare2/libr/core/hack.c"
              ;
  }
 } else if (!strcmp (op, "jinf")) {
...
# 231 "project/radare2/libr/core/hack.c" 3 4
  fprintf(__stderrp,
# 231 "project/radare2/libr/core/hack.c"
  "Current opcode is not conditional\n"
# 231 "project/radare2/libr/core/hack.c" 3 4
  )
# 231 "project/radare2/libr/core/hack.c"
                                                 ;
   return 
# 232 "project/radare2/libr/core/hack.c" 3 4
         0
# 232 "project/radare2/libr/core/hack.c"
              ;
  }
 } else if (!strcmp (op, "nocj")) {
  if (*b == 0xf) {
...
# 240 "project/radare2/libr/core/hack.c" 3 4
  fprintf(__stderrp,
# 240 "project/radare2/libr/core/hack.c"
  "Current opcode is not conditional\n"
# 240 "project/radare2/libr/core/hack.c" 3 4
  )
# 240 "project/radare2/libr/core/hack.c"
                                                 ;
   return 
# 241 "project/radare2/libr/core/hack.c" 3 4
         0
# 241 "project/radare2/libr/core/hack.c"
              ;
  }
 } else if (!strcmp (op, "recj")) {
  int is_near = (*b == 0xf);
...
# 250 "project/radare2/libr/core/hack.c" 3 4
  fprintf(__stderrp,
# 250 "project/radare2/libr/core/hack.c"
...
# 250 "project/radare2/libr/core/hack.c"
                                               ;
   return 
# 251 "project/radare2/libr/core/hack.c" 3 4
         0
# 251 "project/radare2/libr/core/hack.c"
              ;
  }
 } else if (!strcmp (op, "ret1")) {
...
# 260 "project/radare2/libr/core/hack.c" 3 4
 fprintf(__stderrp,
# 260 "project/radare2/libr/core/hack.c"
 "Invalid operation '%s'\n", op
# 260 "project/radare2/libr/core/hack.c" 3 4
 )
# 260 "project/radare2/libr/core/hack.c"
                                         ;
  return 
# 261 "project/radare2/libr/core/hack.c" 3 4
        0
# 261 "project/radare2/libr/core/hack.c"
             ;
 }
 return 
# 263 "project/radare2/libr/core/hack.c" 3 4
       1
# 263 "project/radare2/libr/core/hack.c"
           ;
}


# 266 "project/radare2/libr/core/hack.c" 3 4
__attribute__((visibility("default"))) 
# 266 "project/radare2/libr/core/hack.c"
     int r_core_hack(RCore *core, const char *op) {
 
# 267 "project/radare2/libr/core/hack.c" 3 4
_Bool 
# 267 "project/radare2/libr/core/hack.c"
     (*hack)(RCore *core, const char *op, const RAnalOp *analop) = 
# 267 "project/radare2/libr/core/hack.c" 3 4
                                                                   ((void *)0)
# 267 "project/radare2/libr/core/hack.c"
                                                                       ;
 ...
 if (!asmarch) {
  return 
# 272 "project/radare2/libr/core/hack.c" 3 4
        0
# 272 "project/radare2/libr/core/hack.c"
             ;
 }
...
# 285 "project/radare2/libr/core/hack.c" 3 4
 fprintf(__stderrp,
# 285 "project/radare2/libr/core/hack.c"
...
# 290 "project/radare2/libr/core/hack.c" 3 4
  fprintf(__stderrp,
# 290 "project/radare2/libr/core/hack.c"
  "anal op fail\n"
# 290 "project/radare2/libr/core/hack.c" 3 4
  )
# 290 "project/radare2/libr/core/hack.c"
                            ;
   return 
# 291 "project/radare2/libr/core/hack.c" 3 4
         0
# 291 "project/radare2/libr/core/hack.c"
              ;
  }
  return hack (core, op, &analop);
 }
 return 
# 295 "project/radare2/libr/core/hack.c" 3 4
       0
# 295 "project/radare2/libr/core/hack.c"
            ;
}
