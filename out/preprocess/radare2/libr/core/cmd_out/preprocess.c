# 0 "project/radare2/libr/core/cmd_project.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/cmd_project.c"
...
# 4 "project/radare2/libr/core/cmd_project.c" 2
...
# 5 "project/radare2/libr/core/cmd_project.c" 2



# 7 "project/radare2/libr/core/cmd_project.c"
static const char *help_msg_P[] = {
 ...
 "NOTE:", "", "project are stored in " "~" 
# 21 "project/radare2/libr/core/cmd_project.c" 3 4
                                      "/" ".local" "/" "share" "/" "radare2" "/" "projects"
# 21 "project/radare2/libr/core/cmd_project.c"
                                                                            ,
 
# 22 "project/radare2/libr/core/cmd_project.c" 3 4
((void *)0)

# 23 "project/radare2/libr/core/cmd_project.c"
};
...
# 36 "project/radare2/libr/core/cmd_project.c" 3 4
((void *)0)

# 37 "project/radare2/libr/core/cmd_project.c"
};
...
static int cmd_project(void *data, const char *input) {
 ...
 if (!input) {
  return 
# 45 "project/radare2/libr/core/cmd_project.c" 3 4
        0
# 45 "project/radare2/libr/core/cmd_project.c"
             ;
 }
...
# 65 "project/radare2/libr/core/cmd_project.c" 3 4
  fprintf(__stderrp,
# 65 "project/radare2/libr/core/cmd_project.c"
  "Usage: Pc [prjname]\n"
# 65 "project/radare2/libr/core/cmd_project.c" 3 4
  )
# 65 "project/radare2/libr/core/cmd_project.c"
 ...
 case '-':
  if (
# 81 "project/radare2/libr/core/cmd_project.c" 3 4
     ((
# 81 "project/radare2/libr/core/cmd_project.c"
     file
# 81 "project/radare2/libr/core/cmd_project.c" 3 4
     ) && *(
# 81 "project/radare2/libr/core/cmd_project.c"
...
# 84 "project/radare2/libr/core/cmd_project.c" 3 4
  fprintf(__stderrp,
# 84 "project/radare2/libr/core/cmd_project.c"
  "Usage: Pd [prjname]   # Use P or Pl to list the available projects.\n"
# 84 "project/radare2/libr/core/cmd_project.c" 3 4
  )
# 84 "project/radare2/libr/core/cmd_project.c"
                                                                                   ;
 ...
 case 's':
  if (
# 88 "project/radare2/libr/core/cmd_project.c" 3 4
     (!(
# 88 "project/radare2/libr/core/cmd_project.c"
     file
# 88 "project/radare2/libr/core/cmd_project.c" 3 4
     ) || !*(
# 88 "project/radare2/libr/core/cmd_project.c"
...
# 88 "project/radare2/libr/core/cmd_project.c"
  ...
  if (!
# 91 "project/radare2/libr/core/cmd_project.c" 3 4
      (!(
# 91 "project/radare2/libr/core/cmd_project.c"
      file
# 91 "project/radare2/libr/core/cmd_project.c" 3 4
      ) || !*(
# 91 "project/radare2/libr/core/cmd_project.c"
...
# 91 "project/radare2/libr/core/cmd_project.c"
 ...
 case 'S':
  if (input[1] == ' ') {
   r_core_project_save_script (core, input + 2, 
# 101 "project/radare2/libr/core/cmd_project.c" 3 4
                                               0xFFFF
# 101 "project/radare2/libr/core/cmd_project.c"
                                                             );
  } else {
...
# 118 "project/radare2/libr/core/cmd_project.c" 3 4
    fprintf(__stderrp,
# 118 "project/radare2/libr/core/cmd_project.c"
    "Cannot open %s\n", str
# 118 "project/radare2/libr/core/cmd_project.c" 3 4
    )
# 118 "project/radare2/libr/core/cmd_project.c"
...
# 121 "project/radare2/libr/core/cmd_project.c" 3 4
                                    ((void *)0)
# 121 "project/radare2/libr/core/cmd_project.c"
                                        );
     int del = 0;
     if (data) {
      char *ptr, *nl;
...
# 139 "project/radare2/libr/core/cmd_project.c" 3 4
     fprintf(__stderrp,
# 139 "project/radare2/libr/core/cmd_project.c"
     "Deleted %d lines\n", del
# 139 "project/radare2/libr/core/cmd_project.c" 3 4
     )
# 139 "project/radare2/libr/core/cmd_project.c"
...
# 154 "project/radare2/libr/core/cmd_project.c" 3 4
     fprintf(__stderrp,
# 154 "project/radare2/libr/core/cmd_project.c"
...
# 154 "project/radare2/libr/core/cmd_project.c"
     ...
     char *str = r_core_project_notes_file (core, fileproject);
     char *data = r_file_slurp (str, 
# 161 "project/radare2/libr/core/cmd_project.c" 3 4
                                    ((void *)0)
# 161 "project/radare2/libr/core/cmd_project.c"
                                        );
   ...
   case '+':
    {
     char *str = r_core_project_notes_file (core, fileproject);
     char *data = r_file_slurp (str, 
# 174 "project/radare2/libr/core/cmd_project.c" 3 4
                                    ((void *)0)
# 174 "project/radare2/libr/core/cmd_project.c"
                                        );
     data = r_str_append (data, input + 2);
     data = r_str_append (data, "\n");
     r_file_dump (str, (const 
# 177 "project/radare2/libr/core/cmd_project.c" 3 4
                             unsigned char
# 177 "project/radare2/libr/core/cmd_project.c"
                                *)data, strlen (data), 
# 177 "project/radare2/libr/core/cmd_project.c" 3 4
                                                       0
# 177 "project/radare2/libr/core/cmd_project.c"
...
# 199 "project/radare2/libr/core/cmd_project.c" 3 4
    unsigned char 
# 199 "project/radare2/libr/core/cmd_project.c"
        *data = r_base64_decode_dyn (input + 3, -1);
     if (data) {
      char *str = r_core_project_notes_file (core, fileproject);
      if (str) {
...
# 209 "project/radare2/libr/core/cmd_project.c" 3 4
    fprintf(__stderrp,
# 209 "project/radare2/libr/core/cmd_project.c"
    "Usage: `Pnj` or `Pnj ...`\n"
# 209 "project/radare2/libr/core/cmd_project.c" 3 4
    )
# 209 "project/radare2/libr/core/cmd_project.c"
   ...
   case 0:
   {
    char *str = r_core_project_notes_file (core, fileproject);
    char *data = r_file_slurp (str, 
# 218 "project/radare2/libr/core/cmd_project.c" 3 4
                                   ((void *)0)
# 218 "project/radare2/libr/core/cmd_project.c"
                                       );
    if (data) {
     r_cons_println (data);
     free (data);
 ...
 case 'i':
  if (file && *file) {
   ...
   if (!
# 232 "project/radare2/libr/core/cmd_project.c" 3 4
       (!(
# 232 "project/radare2/libr/core/cmd_project.c"
       prj_name
# 232 "project/radare2/libr/core/cmd_project.c" 3 4
       ) || !*(
# 232 "project/radare2/libr/core/cmd_project.c"
...
# 232 "project/radare2/libr/core/cmd_project.c"
 ...
 free (str);
 return 
# 251 "project/radare2/libr/core/cmd_project.c" 3 4
       1
# 251 "project/radare2/libr/core/cmd_project.c"
           ;
}
