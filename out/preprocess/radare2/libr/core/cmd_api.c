# 0 "project/radare2/libr/core/cmd_api.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/core/cmd_api.c" 2
# 26 "project/radare2/libr/core/cmd_api.c"
...
# 40 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) const char *
# 40 "project/radare2/libr/core/cmd_api.c"
r_cmd_version
# 40 "project/radare2/libr/core/cmd_api.c" 3 4
(void) { return "" "5.5.4"; }
# 40 "project/radare2/libr/core/cmd_api.c"
...
static 
# 42 "project/radare2/libr/core/cmd_api.c" 3 4
      _Bool 
# 42 "project/radare2/libr/core/cmd_api.c"
           cmd_desc_set_parent(RCmdDesc *cd, RCmdDesc *parent) {
 
# 43 "project/radare2/libr/core/cmd_api.c" 3 4
do { if (!(
# 43 "project/radare2/libr/core/cmd_api.c"
cd && !cd->parent
# 43 "project/radare2/libr/core/cmd_api.c" 3 4
...
# 43 "project/radare2/libr/core/cmd_api.c"
 ...
 return 
# 49 "project/radare2/libr/core/cmd_api.c" 3 4
       1
# 49 "project/radare2/libr/core/cmd_api.c"
           ;
}

static void cmd_desc_unset_parent(RCmdDesc *cd) {
 
# 53 "project/radare2/libr/core/cmd_api.c" 3 4
do { if (!(
# 53 "project/radare2/libr/core/cmd_api.c"
cd && cd->parent
# 53 "project/radare2/libr/core/cmd_api.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 53 "project/radare2/libr/core/cmd_api.c"
...
# 53 "project/radare2/libr/core/cmd_api.c"
 ...
 parent->n_children--;
 cd->parent = 
# 57 "project/radare2/libr/core/cmd_api.c" 3 4
             ((void *)0)
# 57 "project/radare2/libr/core/cmd_api.c"
                 ;
}

static 
# 60 "project/radare2/libr/core/cmd_api.c" 3 4
      _Bool 
# 60 "project/radare2/libr/core/cmd_api.c"
           cmd_desc_remove_from_ht_cmds(RCmd *cmd, RCmdDesc *cd) {
 void **it_cd;
 
# 62 "project/radare2/libr/core/cmd_api.c" 3 4
_Bool 
# 62 "project/radare2/libr/core/cmd_api.c"
     res = ht_pp_delete (cmd->ht_cmds, cd->name);
 
# 63 "project/radare2/libr/core/cmd_api.c" 3 4
do { if (!(
# 63 "project/radare2/libr/core/cmd_api.c"
res
# 63 "project/radare2/libr/core/cmd_api.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 63 "project/radare2/libr/core/cmd_api.c"
...
# 64 "project/radare2/libr/core/cmd_api.c" 3 4
for (
# 64 "project/radare2/libr/core/cmd_api.c"
it_cd 
# 64 "project/radare2/libr/core/cmd_api.c" 3 4
= (void **)(&
# 64 "project/radare2/libr/core/cmd_api.c"
...
# 81 "project/radare2/libr/core/cmd_api.c" 3 4
                                                                                                                            _Bool 
# 81 "project/radare2/libr/core/cmd_api.c"
                                                                                                                                 ht_insert) {
 RCmdDesc *res = 
# 82 "project/radare2/libr/core/cmd_api.c" 3 4
                (
# 82 "project/radare2/libr/core/cmd_api.c"
                RCmdDesc
# 82 "project/radare2/libr/core/cmd_api.c" 3 4
                *)calloc(1,sizeof(
# 82 "project/radare2/libr/core/cmd_api.c"
...
# 82 "project/radare2/libr/core/cmd_api.c"
 ...
 if (!res) {
  return 
# 84 "project/radare2/libr/core/cmd_api.c" 3 4
        ((void *)0)
# 84 "project/radare2/libr/core/cmd_api.c"
            ;
 }
 res->type = type;
...
err:
 cmd_desc_free (res);
 return 
# 101 "project/radare2/libr/core/cmd_api.c" 3 4
       ((void *)0)
# 101 "project/radare2/libr/core/cmd_api.c"
           ;
}
...
static void *alias_dupvalue(const void *v_void) {
 ...
 RCmdAliasVal *vcopy = 
# 119 "project/radare2/libr/core/cmd_api.c" 3 4
                      (
# 119 "project/radare2/libr/core/cmd_api.c"
                      RCmdAliasVal
# 119 "project/radare2/libr/core/cmd_api.c" 3 4
                      *)malloc(sizeof(
# 119 "project/radare2/libr/core/cmd_api.c"
...
# 119 "project/radare2/libr/core/cmd_api.c"
 ...
 if (!vcopy) {
  return 
# 121 "project/radare2/libr/core/cmd_api.c" 3 4
        ((void *)0)
# 121 "project/radare2/libr/core/cmd_api.c"
            ;
 }
 
# 123 "project/radare2/libr/core/cmd_api.c" 3 4
unsigned char 
# 123 "project/radare2/libr/core/cmd_api.c"
    *data = malloc (v->sz);
 if (!data) {
  free (vcopy);
  return 
# 126 "project/radare2/libr/core/cmd_api.c" 3 4
        ((void *)0)
# 126 "project/radare2/libr/core/cmd_api.c"
            ;
 }
...
# 132 "project/radare2/libr/core/cmd_api.c" 3 4
__builtin___memcpy_chk (
# 132 "project/radare2/libr/core/cmd_api.c"
vcopy->data
# 132 "project/radare2/libr/core/cmd_api.c" 3 4
, 
# 132 "project/radare2/libr/core/cmd_api.c"
...
static 
# 137 "project/radare2/libr/core/cmd_api.c" 3 4
      unsigned int 
# 137 "project/radare2/libr/core/cmd_api.c"
           alias_calcsizeK(const void *k) {
 return strlen ((const char *)k);
}

static 
# 141 "project/radare2/libr/core/cmd_api.c" 3 4
      unsigned int 
# 141 "project/radare2/libr/core/cmd_api.c"
           alias_calcsizeV(const void *v) {
...
static 
# 149 "project/radare2/libr/core/cmd_api.c" 3 4
      unsigned int 
# 149 "project/radare2/libr/core/cmd_api.c"
           alias_hashfn(const void *k_in) {

 
# 151 "project/radare2/libr/core/cmd_api.c" 3 4
unsigned int 
# 151 "project/radare2/libr/core/cmd_api.c"
     hash = 5381;
 
# 152 "project/radare2/libr/core/cmd_api.c" 3 4
unsigned char 
# 152 "project/radare2/libr/core/cmd_api.c"
    c;
 const char *k = k_in;
...
# 164 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 164 "project/radare2/libr/core/cmd_api.c"
     void r_cmd_alias_init(RCmd *cmd) {
 HtPPOptions opt = { 0 };
 opt.cmp = alias_cmp;
...
# 177 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 177 "project/radare2/libr/core/cmd_api.c"
     RCmd *r_cmd_new(void) {
 int i;
 RCmd *cmd = 
# 179 "project/radare2/libr/core/cmd_api.c" 3 4
            (
# 179 "project/radare2/libr/core/cmd_api.c"
            RCmd
# 179 "project/radare2/libr/core/cmd_api.c" 3 4
            *)calloc(1,sizeof(
# 179 "project/radare2/libr/core/cmd_api.c"
...
# 179 "project/radare2/libr/core/cmd_api.c"
 ...
 for (i = 0; i < (sizeof (cmd->cmds)/sizeof(*cmd->cmds)); i++) {
  cmd->cmds[i] = 
# 185 "project/radare2/libr/core/cmd_api.c" 3 4
                ((void *)0)
# 185 "project/radare2/libr/core/cmd_api.c"
                    ;
 }
 cmd->nullcallback = cmd->data = 
# 187 "project/radare2/libr/core/cmd_api.c" 3 4
                                ((void *)0)
# 187 "project/radare2/libr/core/cmd_api.c"
                                    ;
 cmd->ht_cmds = ht_pp_new0 ();
 cmd->root_cmd_desc = create_cmd_desc (cmd, 
# 189 "project/radare2/libr/core/cmd_api.c" 3 4
                                           ((void *)0)
# 189 "project/radare2/libr/core/cmd_api.c"
                                               , R_CMD_DESC_TYPE_ARGV, "", &root_help, 
# 189 "project/radare2/libr/core/cmd_api.c" 3 4
                                                                                       1
# 189 "project/radare2/libr/core/cmd_api.c"
                                                                                           );
...
# 196 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 196 "project/radare2/libr/core/cmd_api.c"
     RCmd *r_cmd_free(RCmd *cmd) {
 int i;
 if (!cmd) {
  return 
# 199 "project/radare2/libr/core/cmd_api.c" 3 4
        ((void *)0)
# 199 "project/radare2/libr/core/cmd_api.c"
            ;
 }
...
# 211 "project/radare2/libr/core/cmd_api.c" 3 4
  { free((void *)
# 211 "project/radare2/libr/core/cmd_api.c"
  cmd->cmds[i]
# 211 "project/radare2/libr/core/cmd_api.c" 3 4
  ); 
# 211 "project/radare2/libr/core/cmd_api.c"
...
# 211 "project/radare2/libr/core/cmd_api.c"
 ...
 free (cmd);
 return 
# 216 "project/radare2/libr/core/cmd_api.c" 3 4
       ((void *)0)
# 216 "project/radare2/libr/core/cmd_api.c"
           ;
}


# 219 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 219 "project/radare2/libr/core/cmd_api.c"
     RCmdDesc *r_cmd_get_root(RCmd *cmd) {
 return cmd->root_cmd_desc;
}


# 223 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 223 "project/radare2/libr/core/cmd_api.c"
     RCmdDesc *r_cmd_get_desc(RCmd *cmd, const char *cmd_identifier) {
 
# 224 "project/radare2/libr/core/cmd_api.c" 3 4
do { if (!(
# 224 "project/radare2/libr/core/cmd_api.c"
cmd && cmd_identifier
# 224 "project/radare2/libr/core/cmd_api.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 224 "project/radare2/libr/core/cmd_api.c"
"cmd && cmd_identifier"
# 224 "project/radare2/libr/core/cmd_api.c" 3 4
, 224); return (((void *)0)); } } while (0)
# 224 "project/radare2/libr/core/cmd_api.c"
                                                  ;
 char *cmdid = strdup (cmd_identifier);
 char *end_cmdid = cmdid + strlen (cmdid);
 RCmdDesc *res = 
# 227 "project/radare2/libr/core/cmd_api.c" 3 4
                ((void *)0)
# 227 "project/radare2/libr/core/cmd_api.c"
                    ;
 
# 228 "project/radare2/libr/core/cmd_api.c" 3 4
_Bool 
# 228 "project/radare2/libr/core/cmd_api.c"
     is_exact_match = 
# 228 "project/radare2/libr/core/cmd_api.c" 3 4
                      1
# 228 "project/radare2/libr/core/cmd_api.c"
 ...
 while (*cmdid) {
  RCmdDesc *cd = ht_pp_find (cmd->ht_cmds, cmdid, 
# 231 "project/radare2/libr/core/cmd_api.c" 3 4
                                                 ((void *)0)
# 231 "project/radare2/libr/core/cmd_api.c"
                                                     );
  if (cd) {
   switch (cd->type) {
  ...
  is_exact_match = 
# 248 "project/radare2/libr/core/cmd_api.c" 3 4
                  0
# 248 "project/radare2/libr/core/cmd_api.c"
                       ;
  *(--end_cmdid) = '\0';
 }
out:
...
static 
# 256 "project/radare2/libr/core/cmd_api.c" 3 4
      _Bool 
# 256 "project/radare2/libr/core/cmd_api.c"
           get_keys(void *keylist_in, const void *k, const void *v) {
 RList *keylist = (RList *) keylist_in;
 return r_list_append (keylist, (char *) k);
}


# 261 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 261 "project/radare2/libr/core/cmd_api.c"
     RList *r_cmd_alias_keys(RCmd *cmd) {
 RList *keylist = r_list_new ();
 if (!keylist) {
  return 
# 264 "project/radare2/libr/core/cmd_api.c" 3 4
        ((void *)0)
# 264 "project/radare2/libr/core/cmd_api.c"
            ;
 }
...
# 272 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 272 "project/radare2/libr/core/cmd_api.c"
     void r_cmd_alias_free(RCmd *cmd) {
 ht_pp_free (cmd->aliases);
 cmd->aliases = 
# 274 "project/radare2/libr/core/cmd_api.c" 3 4
               ((void *)0)
# 274 "project/radare2/libr/core/cmd_api.c"
                   ;
}


# 277 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 277 "project/radare2/libr/core/cmd_api.c"
          r_cmd_alias_del(RCmd *cmd, const char *k) {
 return ht_pp_delete(cmd->aliases, k);
}


# 281 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 281 "project/radare2/libr/core/cmd_api.c"
     int r_cmd_alias_set_cmd(RCmd *cmd, const char *k, const char *v) {
 RCmdAliasVal val;
 val.data = (
# 283 "project/radare2/libr/core/cmd_api.c" 3 4
            unsigned char 
# 283 "project/radare2/libr/core/cmd_api.c"
                *)v;
 if (!val.data) {
  return 1;
 }
 val.sz = strlen (v) + 1;
 val.is_str = 
# 288 "project/radare2/libr/core/cmd_api.c" 3 4
             1
# 288 "project/radare2/libr/core/cmd_api.c"
                 ;
 val.is_data = 
# 289 "project/radare2/libr/core/cmd_api.c" 3 4
              0
# 289 "project/radare2/libr/core/cmd_api.c"
                   ;
...
# 294 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 294 "project/radare2/libr/core/cmd_api.c"
     int r_cmd_alias_set_str(RCmd *cmd, const char *k, const char *v) {
 RCmdAliasVal val;
 val.data = (
# 296 "project/radare2/libr/core/cmd_api.c" 3 4
            unsigned char 
# 296 "project/radare2/libr/core/cmd_api.c"
                *)strdup (v);
 if (!val.data) {
  return 1;
 }
 val.is_str = 
# 300 "project/radare2/libr/core/cmd_api.c" 3 4
             1
# 300 "project/radare2/libr/core/cmd_api.c"
                 ;
 val.is_data = 
# 301 "project/radare2/libr/core/cmd_api.c" 3 4
              1
# 301 "project/radare2/libr/core/cmd_api.c"
                  ;
...
# 320 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 320 "project/radare2/libr/core/cmd_api.c"
     int r_cmd_alias_set_raw(RCmd *cmd, const char *k, const 
# 320 "project/radare2/libr/core/cmd_api.c" 3 4
                                                             unsigned char 
# 320 "project/radare2/libr/core/cmd_api.c"
                                                                 *v, int sz) {
...
# 333 "project/radare2/libr/core/cmd_api.c" 3 4
__builtin___memcpy_chk (
# 333 "project/radare2/libr/core/cmd_api.c"
val.data
# 333 "project/radare2/libr/core/cmd_api.c" 3 4
, 
# 333 "project/radare2/libr/core/cmd_api.c"
...
# 333 "project/radare2/libr/core/cmd_api.c"
 ...
 const 
# 337 "project/radare2/libr/core/cmd_api.c" 3 4
      unsigned char 
# 337 "project/radare2/libr/core/cmd_api.c"
          *firstnull = 
# 337 "project/radare2/libr/core/cmd_api.c" 3 4
                       ((void *)0)
# 337 "project/radare2/libr/core/cmd_api.c"
...
# 338 "project/radare2/libr/core/cmd_api.c" 3 4
_Bool 
# 338 "project/radare2/libr/core/cmd_api.c"
     is_binary = 
# 338 "project/radare2/libr/core/cmd_api.c" 3 4
                 0
# 338 "project/radare2/libr/core/cmd_api.c"
 ...
 for (i = 0; i < sz; i++) {
  ...
  if (!
# 347 "project/radare2/libr/core/cmd_api.c" 3 4
      ((
# 347 "project/radare2/libr/core/cmd_api.c"
      v[i]
# 347 "project/radare2/libr/core/cmd_api.c" 3 4
      ) >=' ' && (
# 347 "project/radare2/libr/core/cmd_api.c"
...
# 347 "project/radare2/libr/core/cmd_api.c"
   ...
   is_binary = 
# 348 "project/radare2/libr/core/cmd_api.c" 3 4
              1
# 348 "project/radare2/libr/core/cmd_api.c"
                  ;
   break;
  }
 }
 ...
 if (firstnull == &v[sz-1] && !is_binary) {
  ...
  val.is_str = 
# 355 "project/radare2/libr/core/cmd_api.c" 3 4
              1
# 355 "project/radare2/libr/core/cmd_api.c"
                  ;
 } else if (!firstnull && !is_binary) {

  val.sz++;
  
# 359 "project/radare2/libr/core/cmd_api.c" 3 4
 unsigned char 
# 359 "project/radare2/libr/core/cmd_api.c"
     *data = realloc (val.data, val.sz);
  if (!data) {
   return 1;
  }
  val.data = data;
  val.data[val.sz - 1] = '\0';
  val.is_str = 
# 365 "project/radare2/libr/core/cmd_api.c" 3 4
              1
# 365 "project/radare2/libr/core/cmd_api.c"
                  ;
 } else {

  val.is_str = 
# 368 "project/radare2/libr/core/cmd_api.c" 3 4
              0
# 368 "project/radare2/libr/core/cmd_api.c"
                   ;
 }

 val.is_data = 
# 371 "project/radare2/libr/core/cmd_api.c" 3 4
              1
# 371 "project/radare2/libr/core/cmd_api.c"
                  ;
...
# 392 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 392 "project/radare2/libr/core/cmd_api.c"
     RCmdAliasVal *r_cmd_alias_get(RCmd *cmd, const char *k) {
 
# 393 "project/radare2/libr/core/cmd_api.c" 3 4
do { if (!(
# 393 "project/radare2/libr/core/cmd_api.c"
cmd && cmd->aliases && k
# 393 "project/radare2/libr/core/cmd_api.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 393 "project/radare2/libr/core/cmd_api.c"
...
# 393 "project/radare2/libr/core/cmd_api.c"
 ...
 return ht_pp_find(cmd->aliases, k, 
# 395 "project/radare2/libr/core/cmd_api.c" 3 4
                                   ((void *)0)
# 395 "project/radare2/libr/core/cmd_api.c"
                                       );
}

static 
# 398 "project/radare2/libr/core/cmd_api.c" 3 4
      unsigned char 
# 398 "project/radare2/libr/core/cmd_api.c"
          *alias_append_internal(int *out_szp, const RCmdAliasVal *first, const 
# 398 "project/radare2/libr/core/cmd_api.c" 3 4
                                                                                unsigned char 
# 398 "project/radare2/libr/core/cmd_api.c"
                                                                                    *second, int second_sz) {
 
# 399 "project/radare2/libr/core/cmd_api.c" 3 4
unsigned char
# 399 "project/radare2/libr/core/cmd_api.c"
   * out;
 int out_sz;
 ...
 if (!out) {
  return 
# 410 "project/radare2/libr/core/cmd_api.c" 3 4
        ((void *)0)
# 410 "project/radare2/libr/core/cmd_api.c"
            ;
 }


 
# 414 "project/radare2/libr/core/cmd_api.c" 3 4
__builtin___memcpy_chk (
# 414 "project/radare2/libr/core/cmd_api.c"
out
# 414 "project/radare2/libr/core/cmd_api.c" 3 4
, 
# 414 "project/radare2/libr/core/cmd_api.c"
first->data, bytes_from_first
# 414 "project/radare2/libr/core/cmd_api.c" 3 4
, __builtin_object_size (
# 414 "project/radare2/libr/core/cmd_api.c"
out
...
# 416 "project/radare2/libr/core/cmd_api.c" 3 4
__builtin___memcpy_chk (
# 416 "project/radare2/libr/core/cmd_api.c"
out+bytes_from_first
# 416 "project/radare2/libr/core/cmd_api.c" 3 4
, 
# 416 "project/radare2/libr/core/cmd_api.c"
second, second_sz
...
# 424 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 424 "project/radare2/libr/core/cmd_api.c"
     int r_cmd_alias_append_str(RCmd *cmd, const char *k, const char *a) {
...
# 432 "project/radare2/libr/core/cmd_api.c" 3 4
 unsigned char
# 432 "project/radare2/libr/core/cmd_api.c"
    * new = alias_append_internal (&new_len, v_old, (
# 432 "project/radare2/libr/core/cmd_api.c" 3 4
                                                     unsigned char 
# 432 "project/radare2/libr/core/cmd_api.c"
                                                         *)a, strlen (a) + 1);
...
# 447 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 447 "project/radare2/libr/core/cmd_api.c"
     int r_cmd_alias_append_raw(RCmd *cmd, const char *k, const 
# 447 "project/radare2/libr/core/cmd_api.c" 3 4
                                                                unsigned char 
# 447 "project/radare2/libr/core/cmd_api.c"
                                                                    *a, int sz) {
...
# 455 "project/radare2/libr/core/cmd_api.c" 3 4
 unsigned char 
# 455 "project/radare2/libr/core/cmd_api.c"
     *new = alias_append_internal (&new_len, v_old, a, sz);
...
# 467 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 467 "project/radare2/libr/core/cmd_api.c"
     char *r_cmd_alias_val_strdup(RCmdAliasVal *v) {
 if (v->is_str) {
...
# 476 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 476 "project/radare2/libr/core/cmd_api.c"
     char *r_cmd_alias_val_strdup_b64(RCmdAliasVal *v) {
 if (v->is_str) {
  return strdup ((char *)v->data);
 }
...
# 484 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 484 "project/radare2/libr/core/cmd_api.c"
     void r_cmd_set_data(RCmd *cmd, void *data) {
 cmd->data = data;
}


# 488 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 488 "project/radare2/libr/core/cmd_api.c"
          r_cmd_add(RCmd *c, const char *cmd, RCmdCb cb) {
 int idx = (
# 489 "project/radare2/libr/core/cmd_api.c" 3 4
           unsigned char
# 489 "project/radare2/libr/core/cmd_api.c"
              )cmd[0];
 RCmdItem *item = c->cmds[idx];
 if (!item) {
  item = 
# 492 "project/radare2/libr/core/cmd_api.c" 3 4
        (
# 492 "project/radare2/libr/core/cmd_api.c"
        RCmdItem
# 492 "project/radare2/libr/core/cmd_api.c" 3 4
        *)calloc(1,sizeof(
# 492 "project/radare2/libr/core/cmd_api.c"
...
# 495 "project/radare2/libr/core/cmd_api.c" 3 4
__builtin___strncpy_chk (
# 495 "project/radare2/libr/core/cmd_api.c"
item->cmd
# 495 "project/radare2/libr/core/cmd_api.c" 3 4
, 
# 495 "project/radare2/libr/core/cmd_api.c"
cmd, sizeof (item->cmd)-1
# 495 "project/radare2/libr/core/cmd_api.c" 3 4
, __builtin_object_size (
# 495 "project/radare2/libr/core/cmd_api.c"
item->cmd
...
# 495 "project/radare2/libr/core/cmd_api.c"
 ...
 item->callback = cb;
 return 
# 497 "project/radare2/libr/core/cmd_api.c" 3 4
       1
# 497 "project/radare2/libr/core/cmd_api.c"
           ;
}


# 500 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 500 "project/radare2/libr/core/cmd_api.c"
     void r_cmd_del(RCmd *cmd, const char *command) {
 int idx = (
# 501 "project/radare2/libr/core/cmd_api.c" 3 4
           unsigned char
# 501 "project/radare2/libr/core/cmd_api.c"
              )command[0];
 
# 502 "project/radare2/libr/core/cmd_api.c" 3 4
{ free((void *)
# 502 "project/radare2/libr/core/cmd_api.c"
cmd->cmds[idx]
# 502 "project/radare2/libr/core/cmd_api.c" 3 4
); 
# 502 "project/radare2/libr/core/cmd_api.c"
...
# 505 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 505 "project/radare2/libr/core/cmd_api.c"
...
# 510 "project/radare2/libr/core/cmd_api.c" 3 4
do { if (!(
# 510 "project/radare2/libr/core/cmd_api.c"
cmd && input
# 510 "project/radare2/libr/core/cmd_api.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 510 "project/radare2/libr/core/cmd_api.c"
...
# 510 "project/radare2/libr/core/cmd_api.c"
 ...
 if (!*input) {
  ...
  char *nstr = 
# 516 "project/radare2/libr/core/cmd_api.c" 3 4
              ((void *)0)
# 516 "project/radare2/libr/core/cmd_api.c"
                  ;
  ...
  if (v && v->is_data) {
   ...
   free (v_str);
   return 
# 522 "project/radare2/libr/core/cmd_api.c" 3 4
         1
# 522 "project/radare2/libr/core/cmd_api.c"
             ;
  }
  
# 524 "project/radare2/libr/core/cmd_api.c" 3 4
 if (
# 524 "project/radare2/libr/core/cmd_api.c"
 cmd->plist
# 524 "project/radare2/libr/core/cmd_api.c" 3 4
 ) for (
# 524 "project/radare2/libr/core/cmd_api.c"
...
# 524 "project/radare2/libr/core/cmd_api.c"
   ...
   if (cp->call && cp->call (cmd->data, input)) {
    free (nstr);
    return 
# 527 "project/radare2/libr/core/cmd_api.c" 3 4
          1
# 527 "project/radare2/libr/core/cmd_api.c"
              ;
   }
  }
  if (!*input) {
  ...
  c = cmd->cmds[((
# 534 "project/radare2/libr/core/cmd_api.c" 3 4
                 unsigned char
# 534 "project/radare2/libr/core/cmd_api.c"
                    )input[0]) & 0xff];
  if (c && c->callback) {
...
# 556 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 556 "project/radare2/libr/core/cmd_api.c"
     RCmdStatus r_cmd_call_parsed_args(RCmd *cmd, RCmdParsedArgs *args) {
...
# 566 "project/radare2/libr/core/cmd_api.c" 3 4
if (
# 566 "project/radare2/libr/core/cmd_api.c"
cmd->plist
# 566 "project/radare2/libr/core/cmd_api.c" 3 4
) for (
# 566 "project/radare2/libr/core/cmd_api.c"
...
# 572 "project/radare2/libr/core/cmd_api.c" 3 4
{ free((void *)
# 572 "project/radare2/libr/core/cmd_api.c"
exec_string
# 572 "project/radare2/libr/core/cmd_api.c" 3 4
); 
# 572 "project/radare2/libr/core/cmd_api.c"
...
# 598 "project/radare2/libr/core/cmd_api.c" 3 4
 { free((void *)
# 598 "project/radare2/libr/core/cmd_api.c"
 exec_string
# 598 "project/radare2/libr/core/cmd_api.c" 3 4
 ); 
# 598 "project/radare2/libr/core/cmd_api.c"
...
# 602 "project/radare2/libr/core/cmd_api.c" 3 4
 r_log (__func__, "project/radare2/libr/core/cmd_api.c", 602, R_LOGLVL_ERROR, ((void *)0), 
# 602 "project/radare2/libr/core/cmd_api.c"
 "RCmdDesc type not handled\n"
# 602 "project/radare2/libr/core/cmd_api.c" 3 4
 );
# 602 "project/radare2/libr/core/cmd_api.c"
                                            ;
...
# 618 "project/radare2/libr/core/cmd_api.c" 3 4
for (
# 618 "project/radare2/libr/core/cmd_api.c"
it 
# 618 "project/radare2/libr/core/cmd_api.c" 3 4
= (void **)(&
# 618 "project/radare2/libr/core/cmd_api.c"
...
# 618 "project/radare2/libr/core/cmd_api.c"
 ...
 if (r_strbuf_is_empty (&csb) || r_strbuf_length (&csb) >= 7) {
  r_strbuf_fini (&csb);
  r_strbuf_set (&csb, "?");
 }
...
static 
# 642 "project/radare2/libr/core/cmd_api.c" 3 4
      _Bool 
# 642 "project/radare2/libr/core/cmd_api.c"
           show_children_shortcut(RCmdDesc *cd) {
...
# 646 "project/radare2/libr/core/cmd_api.c" 3 4
                                                        _Bool 
# 646 "project/radare2/libr/core/cmd_api.c"
                                                             use_color) {
 ...
 if (cd->help->usage) {
  ...
  if (
# 663 "project/radare2/libr/core/cmd_api.c" 3 4
     ((
# 663 "project/radare2/libr/core/cmd_api.c"
     cd->help->args_str
# 663 "project/radare2/libr/core/cmd_api.c" 3 4
     ) && *(
# 663 "project/radare2/libr/core/cmd_api.c"
...
static size_t calc_padding_len(RCmdDesc *cd) {
 ...
 if (
# 684 "project/radare2/libr/core/cmd_api.c" 3 4
    ((
# 684 "project/radare2/libr/core/cmd_api.c"
    cd->help->args_str
# 684 "project/radare2/libr/core/cmd_api.c" 3 4
    ) && *(
# 684 "project/radare2/libr/core/cmd_api.c"
...
# 695 "project/radare2/libr/core/cmd_api.c" 3 4
                                                                       _Bool 
# 695 "project/radare2/libr/core/cmd_api.c"
                                                                            use_color) {
 ...
 if (
# 712 "project/radare2/libr/core/cmd_api.c" 3 4
    ((
# 712 "project/radare2/libr/core/cmd_api.c"
    cd->help->args_str
# 712 "project/radare2/libr/core/cmd_api.c" 3 4
    ) && *(
# 712 "project/radare2/libr/core/cmd_api.c"
...
static char *argv_group_get_help(RCmd *cmd, RCmdDesc *cd, 
# 718 "project/radare2/libr/core/cmd_api.c" 3 4
                                                         _Bool 
# 718 "project/radare2/libr/core/cmd_api.c"
                                                              use_color) {
 RStrBuf *sb = r_strbuf_new (
# 719 "project/radare2/libr/core/cmd_api.c" 3 4
                            ((void *)0)
# 719 "project/radare2/libr/core/cmd_api.c"
                                );
...
# 725 "project/radare2/libr/core/cmd_api.c" 3 4
for (
# 725 "project/radare2/libr/core/cmd_api.c"
it_cd 
# 725 "project/radare2/libr/core/cmd_api.c" 3 4
= (void **)(&
# 725 "project/radare2/libr/core/cmd_api.c"
...
# 730 "project/radare2/libr/core/cmd_api.c" 3 4
for (
# 730 "project/radare2/libr/core/cmd_api.c"
it_cd 
# 730 "project/radare2/libr/core/cmd_api.c" 3 4
= (void **)(&
# 730 "project/radare2/libr/core/cmd_api.c"
...
# 737 "project/radare2/libr/core/cmd_api.c" 3 4
                                                                                     _Bool 
# 737 "project/radare2/libr/core/cmd_api.c"
                                                                                          use_color) {
 RCons *cons = r_cons_singleton ();
 ...
 RStrBuf *sb = r_strbuf_new (
# 744 "project/radare2/libr/core/cmd_api.c" 3 4
                            ((void *)0)
# 744 "project/radare2/libr/core/cmd_api.c"
                                );
 ...
 default:
  r_strbuf_free (sb);
  return 
# 767 "project/radare2/libr/core/cmd_api.c" 3 4
        ((void *)0)
# 767 "project/radare2/libr/core/cmd_api.c"
            ;
 }
}
...
static char *oldinput_get_help(RCmd *cmd, RCmdDesc *cd, RCmdParsedArgs *a) {
 const char *s = 
# 772 "project/radare2/libr/core/cmd_api.c" 3 4
                ((void *)0)
# 772 "project/radare2/libr/core/cmd_api.c"
                    ;
 r_cons_push ();
...
# 784 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 784 "project/radare2/libr/core/cmd_api.c"
     char *r_cmd_get_help(RCmd *cmd, RCmdParsedArgs *args, 
# 784 "project/radare2/libr/core/cmd_api.c" 3 4
                                                           _Bool 
# 784 "project/radare2/libr/core/cmd_api.c"
                                                                use_color) {
 ...
 if (detail == 0) {
  ...
  free (cmdid);
  return 
# 797 "project/radare2/libr/core/cmd_api.c" 3 4
        ((void *)0)
# 797 "project/radare2/libr/core/cmd_api.c"
            ;
 }
 ...
 if (!cd || !cd->help) {
  return 
# 803 "project/radare2/libr/core/cmd_api.c" 3 4
        ((void *)0)
# 803 "project/radare2/libr/core/cmd_api.c"
            ;
 }
 ...
 case R_CMD_DESC_TYPE_ARGV:
  if (detail == 1 && !r_pvector_empty (&cd->children)) {
   if (args->argc > 1) {
    return 
# 815 "project/radare2/libr/core/cmd_api.c" 3 4
          ((void *)0)
# 815 "project/radare2/libr/core/cmd_api.c"
              ;
   }
...
# 823 "project/radare2/libr/core/cmd_api.c" 3 4
 do { r_assert_log (R_LOGLVL_WARN, "(%s:%d):%s%s code should not be reached\n", "project/radare2/libr/core/cmd_api.c", 823, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : ""); } while (0)
# 823 "project/radare2/libr/core/cmd_api.c"
                     ;
  return 
# 824 "project/radare2/libr/core/cmd_api.c" 3 4
        ((void *)0)
# 824 "project/radare2/libr/core/cmd_api.c"
            ;
 }
 return 
# 826 "project/radare2/libr/core/cmd_api.c" 3 4
       ((void *)0)
# 826 "project/radare2/libr/core/cmd_api.c"
           ;
}
...
# 831 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 831 "project/radare2/libr/core/cmd_api.c"
     RCmdMacroItem *r_cmd_macro_item_new(void) {
 return 
# 832 "project/radare2/libr/core/cmd_api.c" 3 4
       (
# 832 "project/radare2/libr/core/cmd_api.c"
       RCmdMacroItem
# 832 "project/radare2/libr/core/cmd_api.c" 3 4
       *)calloc(1,sizeof(
# 832 "project/radare2/libr/core/cmd_api.c"
...
# 835 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 835 "project/radare2/libr/core/cmd_api.c"
     void r_cmd_macro_item_free(RCmdMacroItem *item) {
 if (item) {
  free (item->name);
  free (item->args);
  free (item->code);
...
# 844 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 844 "project/radare2/libr/core/cmd_api.c"
 ...
 mac->num = 
# 849 "project/radare2/libr/core/cmd_api.c" 3 4
           ((void *)0)
# 849 "project/radare2/libr/core/cmd_api.c"
               ;
 mac->user = 
# 850 "project/radare2/libr/core/cmd_api.c" 3 4
            ((void *)0)
# 850 "project/radare2/libr/core/cmd_api.c"
                ;
 mac->cmd = 
# 851 "project/radare2/libr/core/cmd_api.c" 3 4
           ((void *)0)
# 851 "project/radare2/libr/core/cmd_api.c"
               ;
 mac->macros = r_list_newf ((RListFree)r_cmd_macro_item_free);
}


# 855 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 855 "project/radare2/libr/core/cmd_api.c"
     void r_cmd_macro_fini(RCmdMacro *mac) {
 r_list_free (mac->macros);
 mac->macros = 
# 857 "project/radare2/libr/core/cmd_api.c" 3 4
              ((void *)0)
# 857 "project/radare2/libr/core/cmd_api.c"
                  ;
}
...
# 862 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 862 "project/radare2/libr/core/cmd_api.c"
          r_cmd_macro_add(RCmdMacro *mac, const char *oname) {
 struct r_cmd_macro_item_t *macro;
 char *name, *args = 
# 864 "project/radare2/libr/core/cmd_api.c" 3 4
                    ((void *)0)
# 864 "project/radare2/libr/core/cmd_api.c"
                        ;

 RCmdMacroItem *m;
 
# 867 "project/radare2/libr/core/cmd_api.c" 3 4
_Bool 
# 867 "project/radare2/libr/core/cmd_api.c"
     macro_update = 
# 867 "project/radare2/libr/core/cmd_api.c" 3 4
                    0
# 867 "project/radare2/libr/core/cmd_api.c"
 ...
 if (!*oname) {
  ...
  return 
# 876 "project/radare2/libr/core/cmd_api.c" 3 4
        0
# 876 "project/radare2/libr/core/cmd_api.c"
             ;
 }
 ...
 if (!name) {
  return 
# 881 "project/radare2/libr/core/cmd_api.c" 3 4
        0
# 881 "project/radare2/libr/core/cmd_api.c"
             ;
 }
...
# 886 "project/radare2/libr/core/cmd_api.c" 3 4
 fprintf(__stderrp,
# 886 "project/radare2/libr/core/cmd_api.c"
 "Invalid macro body\n"
# 886 "project/radare2/libr/core/cmd_api.c" 3 4
 )
# 886 "project/radare2/libr/core/cmd_api.c"
  ...
  free (name);
  return 
# 888 "project/radare2/libr/core/cmd_api.c" 3 4
        0
# 888 "project/radare2/libr/core/cmd_api.c"
             ;
 }
 *pbody = '\0';
 pbody++;
...
# 894 "project/radare2/libr/core/cmd_api.c" 3 4
 fprintf(__stderrp,
# 894 "project/radare2/libr/core/cmd_api.c"
 "r_cmd_macro_add: missing macro body?\n"
# 894 "project/radare2/libr/core/cmd_api.c" 3 4
 )
# 894 "project/radare2/libr/core/cmd_api.c"
                                                   ;
  free (name);
  return 
# 896 "project/radare2/libr/core/cmd_api.c" 3 4
        0
# 896 "project/radare2/libr/core/cmd_api.c"
             ;
 }

 macro = 
# 899 "project/radare2/libr/core/cmd_api.c" 3 4
        ((void *)0)
# 899 "project/radare2/libr/core/cmd_api.c"
            ;
 ptr = strchr (name, ' ');
 if (ptr) {
  *ptr = '\0';
 ...
 macro_update = 
# 905 "project/radare2/libr/core/cmd_api.c" 3 4
               0
# 905 "project/radare2/libr/core/cmd_api.c"
                    ;
 
# 906 "project/radare2/libr/core/cmd_api.c" 3 4
if (
# 906 "project/radare2/libr/core/cmd_api.c"
mac->macros
# 906 "project/radare2/libr/core/cmd_api.c" 3 4
) for (
# 906 "project/radare2/libr/core/cmd_api.c"
...
# 906 "project/radare2/libr/core/cmd_api.c"
  ...
  if (!strcmp (name, m->name)) {
   ...
   free (macro->args);
   macro_update = 
# 912 "project/radare2/libr/core/cmd_api.c" 3 4
                 1
# 912 "project/radare2/libr/core/cmd_api.c"
                     ;
   break;
  }
 }
 ...
 if (!macro) {
  ...
  if (!macro) {
   free (name);
   return 
# 923 "project/radare2/libr/core/cmd_api.c" 3 4
         0
# 923 "project/radare2/libr/core/cmd_api.c"
              ;
  }
 ...
 *macro->code = '\0';
 ...
 if (ptr != 
# 937 "project/radare2/libr/core/cmd_api.c" 3 4
           ((void *)0)
# 937 "project/radare2/libr/core/cmd_api.c"
               ) {
  *ptr = '\0';
...
# 949 "project/radare2/libr/core/cmd_api.c" 3 4
__builtin___strncpy_chk (
# 949 "project/radare2/libr/core/cmd_api.c"
macro->code
# 949 "project/radare2/libr/core/cmd_api.c" 3 4
, 
# 949 "project/radare2/libr/core/cmd_api.c"
...
# 949 "project/radare2/libr/core/cmd_api.c"
 ...
 if (macro_update == 
# 951 "project/radare2/libr/core/cmd_api.c" 3 4
                    0
# 951 "project/radare2/libr/core/cmd_api.c"
                         ) {
  r_list_append (mac->macros, macro);
 }
 free (name);
 return 
# 955 "project/radare2/libr/core/cmd_api.c" 3 4
       1
# 955 "project/radare2/libr/core/cmd_api.c"
           ;
}


# 958 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 958 "project/radare2/libr/core/cmd_api.c"
          r_cmd_macro_rm(RCmdMacro *mac, const char *_name) {
 
# 959 "project/radare2/libr/core/cmd_api.c" 3 4
do { if (!(
# 959 "project/radare2/libr/core/cmd_api.c"
mac && _name
# 959 "project/radare2/libr/core/cmd_api.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 959 "project/radare2/libr/core/cmd_api.c"
...
# 959 "project/radare2/libr/core/cmd_api.c"
 ...
 if (!name) {
  return 
# 964 "project/radare2/libr/core/cmd_api.c" 3 4
        0
# 964 "project/radare2/libr/core/cmd_api.c"
             ;
 }
...
# 970 "project/radare2/libr/core/cmd_api.c" 3 4
_Bool 
# 970 "project/radare2/libr/core/cmd_api.c"
     ret = 
# 970 "project/radare2/libr/core/cmd_api.c" 3 4
           0
# 970 "project/radare2/libr/core/cmd_api.c"
...
# 971 "project/radare2/libr/core/cmd_api.c" 3 4
if (
# 971 "project/radare2/libr/core/cmd_api.c"
mac->macros
# 971 "project/radare2/libr/core/cmd_api.c" 3 4
) for (
# 971 "project/radare2/libr/core/cmd_api.c"
...
# 974 "project/radare2/libr/core/cmd_api.c" 3 4
  fprintf(__stderrp,
# 974 "project/radare2/libr/core/cmd_api.c"
  "Macro '%s' removed.\n", name
# 974 "project/radare2/libr/core/cmd_api.c" 3 4
  )
# 974 "project/radare2/libr/core/cmd_api.c"
                                         ;
   ret = 
# 975 "project/radare2/libr/core/cmd_api.c" 3 4
        1
# 975 "project/radare2/libr/core/cmd_api.c"
            ;
   break;
  }
 }
...
# 984 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 984 "project/radare2/libr/core/cmd_api.c"
     void r_cmd_macro_list(RCmdMacro *mac) {
 RCmdMacroItem *m;
 int j, idx = 0;
 RListIter *iter;
 
# 988 "project/radare2/libr/core/cmd_api.c" 3 4
if (
# 988 "project/radare2/libr/core/cmd_api.c"
mac->macros
# 988 "project/radare2/libr/core/cmd_api.c" 3 4
) for (
# 988 "project/radare2/libr/core/cmd_api.c"
...
# 1003 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 1003 "project/radare2/libr/core/cmd_api.c"
     void r_cmd_macro_meta(RCmdMacro *mac) {
 RCmdMacroItem *m;
 int j;
 RListIter *iter;
 
# 1007 "project/radare2/libr/core/cmd_api.c" 3 4
if (
# 1007 "project/radare2/libr/core/cmd_api.c"
mac->macros
# 1007 "project/radare2/libr/core/cmd_api.c" 3 4
) for (
# 1007 "project/radare2/libr/core/cmd_api.c"
...
# 1033 "project/radare2/libr/core/cmd_api.c"

# 1033 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 1033 "project/radare2/libr/core/cmd_api.c"
     int r_cmd_macro_cmd_args(RCmdMacro *mac, const char *ptr, const char *args, int nargs) {
 int i, j;
 char *pcmd, cmd[
# 1035 "project/radare2/libr/core/cmd_api.c" 3 4
                4096
# 1035 "project/radare2/libr/core/cmd_api.c"
                            ];
 const char *arg = args;

 for (*cmd=i=j=0; j<
# 1038 "project/radare2/libr/core/cmd_api.c" 3 4
                   4096 
# 1038 "project/radare2/libr/core/cmd_api.c"
                                && ptr[j]; i++,j++) {
  if (ptr[j]=='$') {
...
# 1049 "project/radare2/libr/core/cmd_api.c" 3 4
    __builtin___memcpy_chk (
# 1049 "project/radare2/libr/core/cmd_api.c"
    cmd+i
# 1049 "project/radare2/libr/core/cmd_api.c" 3 4
    , 
# 1049 "project/radare2/libr/core/cmd_api.c"
...
# 1053 "project/radare2/libr/core/cmd_api.c" 3 4
    fprintf(__stderrp,
# 1053 "project/radare2/libr/core/cmd_api.c"
...
# 1053 "project/radare2/libr/core/cmd_api.c"
    ...
    int offlen;
    offlen = 
# 1058 "project/radare2/libr/core/cmd_api.c" 3 4
            __builtin___snprintf_chk (
# 1058 "project/radare2/libr/core/cmd_api.c"
            off
# 1058 "project/radare2/libr/core/cmd_api.c" 3 4
            , 
# 1058 "project/radare2/libr/core/cmd_api.c"
...
# 1059 "project/radare2/libr/core/cmd_api.c"
                 ;
    if ((i + offlen + 1) >= sizeof (cmd)) {
     return -1;
    }
    
# 1063 "project/radare2/libr/core/cmd_api.c" 3 4
   __builtin___memcpy_chk (
# 1063 "project/radare2/libr/core/cmd_api.c"
   cmd+i
# 1063 "project/radare2/libr/core/cmd_api.c" 3 4
   , 
# 1063 "project/radare2/libr/core/cmd_api.c"
...
# 1084 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 1084 "project/radare2/libr/core/cmd_api.c"
 ...
 if (ptr[strlen (ptr) - 1]==':' && !strchr (ptr, ' ')) {
  ...
  if (ptr[0] == '.') {
   ...
   return 
# 1100 "project/radare2/libr/core/cmd_api.c" 3 4
         ((void *)0)
# 1100 "project/radare2/libr/core/cmd_api.c"
             ;
  } else
  ...
  if (ptr[0]=='?' && ptr[1]=='!' && ptr[2] != '?') {
   if (mac->num && mac->num->value != 0) {
    ...
    return 
# 1116 "project/radare2/libr/core/cmd_api.c" 3 4
          ((void *)0)
# 1116 "project/radare2/libr/core/cmd_api.c"
              ;
   }
  } else
  ...
  if (ptr[0] == '?' && ptr[1] == '?' && ptr[2] != '?') {
   if (mac->num->value == 0) {
    ...
    return 
# 1133 "project/radare2/libr/core/cmd_api.c" 3 4
          ((void *)0)
# 1133 "project/radare2/libr/core/cmd_api.c"
              ;
   }
  } else {
   for (i = 0; i < *labels_n; i++) {
...
# 1146 "project/radare2/libr/core/cmd_api.c" 3 4
   __builtin___strncpy_chk (
# 1146 "project/radare2/libr/core/cmd_api.c"
   labels[*labels_n].name
# 1146 "project/radare2/libr/core/cmd_api.c" 3 4
   , 
# 1146 "project/radare2/libr/core/cmd_api.c"
   ptr, 64
...
# 1157 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 1157 "project/radare2/libr/core/cmd_api.c"
 ...
 int labels_n = 0;
 struct r_cmd_macro_label_t labels[
# 1166 "project/radare2/libr/core/cmd_api.c" 3 4
                                  20
# 1166 "project/radare2/libr/core/cmd_api.c"
                                              ];
 ...
 if (!str) {
  perror ("strdup");
  return 
# 1171 "project/radare2/libr/core/cmd_api.c" 3 4
        0
# 1171 "project/radare2/libr/core/cmd_api.c"
             ;
 }
 ptr = strchr (str, ')');
 if (!ptr) {
  
# 1175 "project/radare2/libr/core/cmd_api.c" 3 4
 fprintf(__stderrp,
# 1175 "project/radare2/libr/core/cmd_api.c"
...
# 1175 "project/radare2/libr/core/cmd_api.c"
  ...
  free (str);
  return 
# 1177 "project/radare2/libr/core/cmd_api.c" 3 4
        0
# 1177 "project/radare2/libr/core/cmd_api.c"
             ;
 } else {
  *ptr = '\0';
 }
 ...
 macro_level++;
 if (macro_level > 
# 1190 "project/radare2/libr/core/cmd_api.c" 3 4
                  1024
# 1190 "project/radare2/libr/core/cmd_api.c"
                             ) {
  
# 1191 "project/radare2/libr/core/cmd_api.c" 3 4
 fprintf(__stderrp,
# 1191 "project/radare2/libr/core/cmd_api.c"
 "Maximum macro recursivity reached.\n"
# 1191 "project/radare2/libr/core/cmd_api.c" 3 4
 )
# 1191 "project/radare2/libr/core/cmd_api.c"
                                                 ;
 ...
 r_cons_break_push (
# 1201 "project/radare2/libr/core/cmd_api.c" 3 4
                   ((void *)0)
# 1201 "project/radare2/libr/core/cmd_api.c"
                       , 
# 1201 "project/radare2/libr/core/cmd_api.c" 3 4
                         ((void *)0)
# 1201 "project/radare2/libr/core/cmd_api.c"
...
# 1202 "project/radare2/libr/core/cmd_api.c" 3 4
if (
# 1202 "project/radare2/libr/core/cmd_api.c"
mac->macros
# 1202 "project/radare2/libr/core/cmd_api.c" 3 4
) for (
# 1202 "project/radare2/libr/core/cmd_api.c"
...
# 1207 "project/radare2/libr/core/cmd_api.c" 3 4
   fprintf(__stderrp,
# 1207 "project/radare2/libr/core/cmd_api.c"
   "Macro '%s' expects %d args, not %d\n", m->name, m->nargs, nargs
# 1207 "project/radare2/libr/core/cmd_api.c" 3 4
   )
# 1207 "project/radare2/libr/core/cmd_api.c"
                                                                             ;
    ...
    r_cons_break_pop ();
    return 
# 1211 "project/radare2/libr/core/cmd_api.c" 3 4
          0
# 1211 "project/radare2/libr/core/cmd_api.c"
               ;
   }
   mac->brk = 0;
   do {
...
# 1219 "project/radare2/libr/core/cmd_api.c" 3 4
    fprintf(__stderrp,
# 1219 "project/radare2/libr/core/cmd_api.c"
    "Interrupted at (%s)\n", ptr
# 1219 "project/radare2/libr/core/cmd_api.c" 3 4
    )
# 1219 "project/radare2/libr/core/cmd_api.c"
     ...
     r_cons_break_pop ();
     return 
# 1225 "project/radare2/libr/core/cmd_api.c" 3 4
           0
# 1225 "project/radare2/libr/core/cmd_api.c"
                ;
    }
    r_cons_flush ();
...
# 1231 "project/radare2/libr/core/cmd_api.c" 3 4
    fprintf(__stderrp,
# 1231 "project/radare2/libr/core/cmd_api.c"
    "Oops. invalid label name\n"
# 1231 "project/radare2/libr/core/cmd_api.c" 3 4
    )
# 1231 "project/radare2/libr/core/cmd_api.c"
                                          ;
...
# 1273 "project/radare2/libr/core/cmd_api.c" 3 4
fprintf(__stderrp,
# 1273 "project/radare2/libr/core/cmd_api.c"
"No macro named '%s'\n", str
# 1273 "project/radare2/libr/core/cmd_api.c" 3 4
)
# 1273 "project/radare2/libr/core/cmd_api.c"
...
out_clean:
 r_cons_break_pop ();
 return 
# 1278 "project/radare2/libr/core/cmd_api.c" 3 4
       1
# 1278 "project/radare2/libr/core/cmd_api.c"
           ;
}


# 1281 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 1281 "project/radare2/libr/core/cmd_api.c"
     int r_cmd_macro_break(RCmdMacro *mac, const char *value) {
 mac->brk = 1;
 mac->brk_value = 
# 1283 "project/radare2/libr/core/cmd_api.c" 3 4
                 ((void *)0)
# 1283 "project/radare2/libr/core/cmd_api.c"
                     ;
 mac->_brk_value = (
# 1284 "project/radare2/libr/core/cmd_api.c" 3 4
                   unsigned long long
# 1284 "project/radare2/libr/core/cmd_api.c"
                       )r_num_math (mac->num, value);
 if (value && *value) {
  mac->brk_value = &mac->_brk_value;
 }
 return 0;
...
# 1293 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 1293 "project/radare2/libr/core/cmd_api.c"
     RCmdParsedArgs *r_cmd_parsed_args_new(const char *cmd, int n_args, char **args) {
 
# 1294 "project/radare2/libr/core/cmd_api.c" 3 4
do { if (!(
# 1294 "project/radare2/libr/core/cmd_api.c"
cmd && n_args >= 0
# 1294 "project/radare2/libr/core/cmd_api.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1294 "project/radare2/libr/core/cmd_api.c"
"cmd && n_args >= 0"
# 1294 "project/radare2/libr/core/cmd_api.c" 3 4
, 1294); return (((void *)0)); } } while (0)
# 1294 "project/radare2/libr/core/cmd_api.c"
                                               ;
 RCmdParsedArgs *res = 
# 1295 "project/radare2/libr/core/cmd_api.c" 3 4
                      (
# 1295 "project/radare2/libr/core/cmd_api.c"
                      RCmdParsedArgs
# 1295 "project/radare2/libr/core/cmd_api.c" 3 4
                      *)calloc(1,sizeof(
# 1295 "project/radare2/libr/core/cmd_api.c"
...
# 1295 "project/radare2/libr/core/cmd_api.c"
                                             ;
 res->has_space_after_cmd = 
# 1296 "project/radare2/libr/core/cmd_api.c" 3 4
                           1
# 1296 "project/radare2/libr/core/cmd_api.c"
                               ;
 res->argc = n_args + 1;
 res->argv = 
# 1298 "project/radare2/libr/core/cmd_api.c" 3 4
            (
# 1298 "project/radare2/libr/core/cmd_api.c"
            char *
# 1298 "project/radare2/libr/core/cmd_api.c" 3 4
            *)calloc(
# 1298 "project/radare2/libr/core/cmd_api.c"
...
# 1307 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 1307 "project/radare2/libr/core/cmd_api.c"
     RCmdParsedArgs *r_cmd_parsed_args_newcmd(const char *cmd) {
 return r_cmd_parsed_args_new (cmd, 0, 
# 1308 "project/radare2/libr/core/cmd_api.c" 3 4
                                      ((void *)0)
# 1308 "project/radare2/libr/core/cmd_api.c"
                                          );
}


# 1311 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 1311 "project/radare2/libr/core/cmd_api.c"
     RCmdParsedArgs *r_cmd_parsed_args_newargs(int n_args, char **args) {
 return r_cmd_parsed_args_new ("", n_args, args);
}


# 1315 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 1315 "project/radare2/libr/core/cmd_api.c"
     void r_cmd_parsed_args_free(RCmdParsedArgs *a) {
 if (!a) {
  return;
 }
...
# 1336 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 1336 "project/radare2/libr/core/cmd_api.c"
          r_cmd_parsed_args_setargs(RCmdParsedArgs *a, int n_args, char **args) {
 
# 1337 "project/radare2/libr/core/cmd_api.c" 3 4
do { if (!(
# 1337 "project/radare2/libr/core/cmd_api.c"
a && a->argv && a->argv[0]
# 1337 "project/radare2/libr/core/cmd_api.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1337 "project/radare2/libr/core/cmd_api.c"
"a && a->argv && a->argv[0]"
# 1337 "project/radare2/libr/core/cmd_api.c" 3 4
, 1337); return (0); } } while (0)
# 1337 "project/radare2/libr/core/cmd_api.c"
                                                        ;
 char **tmp = 
# 1338 "project/radare2/libr/core/cmd_api.c" 3 4
             (
# 1338 "project/radare2/libr/core/cmd_api.c"
             char *
# 1338 "project/radare2/libr/core/cmd_api.c" 3 4
             *)calloc(
# 1338 "project/radare2/libr/core/cmd_api.c"
...
# 1338 "project/radare2/libr/core/cmd_api.c"
 ...
 if (!tmp) {
  return 
# 1340 "project/radare2/libr/core/cmd_api.c" 3 4
        0
# 1340 "project/radare2/libr/core/cmd_api.c"
             ;
 }
 ...
 a->argc = n_args + 1;
 return 
# 1353 "project/radare2/libr/core/cmd_api.c" 3 4
       1
# 1353 "project/radare2/libr/core/cmd_api.c"
           ;
err:
 free_array (tmp, n_args + 1);
 return 
# 1356 "project/radare2/libr/core/cmd_api.c" 3 4
       0
# 1356 "project/radare2/libr/core/cmd_api.c"
            ;
}


# 1359 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 1359 "project/radare2/libr/core/cmd_api.c"
          r_cmd_parsed_args_setcmd(RCmdParsedArgs *a, const char *cmd) {
 
# 1360 "project/radare2/libr/core/cmd_api.c" 3 4
do { if (!(
# 1360 "project/radare2/libr/core/cmd_api.c"
a && a->argv && a->argv[0]
# 1360 "project/radare2/libr/core/cmd_api.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1360 "project/radare2/libr/core/cmd_api.c"
"a && a->argv && a->argv[0]"
# 1360 "project/radare2/libr/core/cmd_api.c" 3 4
, 1360); return (0); } } while (0)
# 1360 "project/radare2/libr/core/cmd_api.c"
                                                        ;
 char *tmp = strdup (cmd);
 if (!tmp) {
  return 
# 1363 "project/radare2/libr/core/cmd_api.c" 3 4
        0
# 1363 "project/radare2/libr/core/cmd_api.c"
             ;
 }
 free (a->argv[0]);
 a->argv[0] = tmp;
 return 
# 1367 "project/radare2/libr/core/cmd_api.c" 3 4
       1
# 1367 "project/radare2/libr/core/cmd_api.c"
           ;
}
...
# 1380 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 1380 "project/radare2/libr/core/cmd_api.c"
     char *r_cmd_parsed_args_argstr(RCmdParsedArgs *a) {
 
# 1381 "project/radare2/libr/core/cmd_api.c" 3 4
do { if (!(
# 1381 "project/radare2/libr/core/cmd_api.c"
a && a->argv && a->argv[0]
# 1381 "project/radare2/libr/core/cmd_api.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1381 "project/radare2/libr/core/cmd_api.c"
...
# 1387 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 1387 "project/radare2/libr/core/cmd_api.c"
     char *r_cmd_parsed_args_execstr(RCmdParsedArgs *a) {
 
# 1388 "project/radare2/libr/core/cmd_api.c" 3 4
do { if (!(
# 1388 "project/radare2/libr/core/cmd_api.c"
a && a->argv && a->argv[0]
# 1388 "project/radare2/libr/core/cmd_api.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1388 "project/radare2/libr/core/cmd_api.c"
...
# 1397 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 1397 "project/radare2/libr/core/cmd_api.c"
     const char *r_cmd_parsed_args_cmd(RCmdParsedArgs *a) {
 
# 1398 "project/radare2/libr/core/cmd_api.c" 3 4
do { if (!(
# 1398 "project/radare2/libr/core/cmd_api.c"
a && a->argv && a->argv[0]
# 1398 "project/radare2/libr/core/cmd_api.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1398 "project/radare2/libr/core/cmd_api.c"
...
static RCmdDesc *argv_new(RCmd *cmd, RCmdDesc *parent, const char *name, RCmdArgvCb cb, const RCmdDescHelp *help, 
# 1404 "project/radare2/libr/core/cmd_api.c" 3 4
                                                                                                                 _Bool 
# 1404 "project/radare2/libr/core/cmd_api.c"
                                                                                                                      ht_insert) {
 RCmdDesc *res = create_cmd_desc (cmd, parent, R_CMD_DESC_TYPE_ARGV, name, help, ht_insert);
 if (!res) {
  return 
# 1407 "project/radare2/libr/core/cmd_api.c" 3 4
        ((void *)0)
# 1407 "project/radare2/libr/core/cmd_api.c"
            ;
 }
...
# 1414 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 1414 "project/radare2/libr/core/cmd_api.c"
     RCmdDesc *r_cmd_desc_argv_new(RCmd *cmd, RCmdDesc *parent, const char *name, RCmdArgvCb cb, const RCmdDescHelp *help) {
 
# 1415 "project/radare2/libr/core/cmd_api.c" 3 4
do { if (!(
# 1415 "project/radare2/libr/core/cmd_api.c"
cmd && parent && name
# 1415 "project/radare2/libr/core/cmd_api.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1415 "project/radare2/libr/core/cmd_api.c"
"cmd && parent && name"
# 1415 "project/radare2/libr/core/cmd_api.c" 3 4
, 1415); return (((void *)0)); } } while (0)
# 1415 "project/radare2/libr/core/cmd_api.c"
                                                  ;
 return argv_new (cmd, parent, name, cb, help, 
# 1416 "project/radare2/libr/core/cmd_api.c" 3 4
                                              1
# 1416 "project/radare2/libr/core/cmd_api.c"
                                                  );
}


# 1419 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 1419 "project/radare2/libr/core/cmd_api.c"
     RCmdDesc *r_cmd_desc_inner_new(RCmd *cmd, RCmdDesc *parent, const char *name, const RCmdDescHelp *help) {
 
# 1420 "project/radare2/libr/core/cmd_api.c" 3 4
do { if (!(
# 1420 "project/radare2/libr/core/cmd_api.c"
cmd && parent && name
# 1420 "project/radare2/libr/core/cmd_api.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1420 "project/radare2/libr/core/cmd_api.c"
"cmd && parent && name"
# 1420 "project/radare2/libr/core/cmd_api.c" 3 4
, 1420); return (((void *)0)); } } while (0)
# 1420 "project/radare2/libr/core/cmd_api.c"
                                                  ;
 return create_cmd_desc (cmd, parent, R_CMD_DESC_TYPE_INNER, name, help, 
# 1421 "project/radare2/libr/core/cmd_api.c" 3 4
                                                                        0
# 1421 "project/radare2/libr/core/cmd_api.c"
                                                                             );
}


# 1424 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 1424 "project/radare2/libr/core/cmd_api.c"
     RCmdDesc *r_cmd_desc_group_new(RCmd *cmd, RCmdDesc *parent, const char *name, RCmdArgvCb cb, const RCmdDescHelp *help, const RCmdDescHelp *group_help) {
 
# 1425 "project/radare2/libr/core/cmd_api.c" 3 4
do { if (!(
# 1425 "project/radare2/libr/core/cmd_api.c"
cmd && parent && name
# 1425 "project/radare2/libr/core/cmd_api.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1425 "project/radare2/libr/core/cmd_api.c"
"cmd && parent && name"
# 1425 "project/radare2/libr/core/cmd_api.c" 3 4
, 1425); return (((void *)0)); } } while (0)
# 1425 "project/radare2/libr/core/cmd_api.c"
                                                  ;
 RCmdDesc *res = create_cmd_desc (cmd, parent, R_CMD_DESC_TYPE_GROUP, name, group_help, 
# 1426 "project/radare2/libr/core/cmd_api.c" 3 4
                                                                                       1
# 1426 "project/radare2/libr/core/cmd_api.c"
                                                                                           );
 if (!res) {
  return 
# 1428 "project/radare2/libr/core/cmd_api.c" 3 4
        ((void *)0)
# 1428 "project/radare2/libr/core/cmd_api.c"
            ;
 }

 RCmdDesc *exec_cd = 
# 1431 "project/radare2/libr/core/cmd_api.c" 3 4
                    ((void *)0)
# 1431 "project/radare2/libr/core/cmd_api.c"
                        ;
 if (cb && help) {
  exec_cd = argv_new (cmd, res, name, cb, help, 
# 1433 "project/radare2/libr/core/cmd_api.c" 3 4
                                               0
# 1433 "project/radare2/libr/core/cmd_api.c"
                                                    );
  if (!exec_cd) {
   r_cmd_desc_remove (cmd, res);
   return 
# 1436 "project/radare2/libr/core/cmd_api.c" 3 4
         ((void *)0)
# 1436 "project/radare2/libr/core/cmd_api.c"
             ;
  }
 }
...
# 1444 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 1444 "project/radare2/libr/core/cmd_api.c"
     RCmdDesc *r_cmd_desc_oldinput_new(RCmd *cmd, RCmdDesc *parent, const char *name, RCmdCb cb, const RCmdDescHelp *help) {
 
# 1445 "project/radare2/libr/core/cmd_api.c" 3 4
do { if (!(
# 1445 "project/radare2/libr/core/cmd_api.c"
cmd && parent && name && cb
# 1445 "project/radare2/libr/core/cmd_api.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1445 "project/radare2/libr/core/cmd_api.c"
"cmd && parent && name && cb"
# 1445 "project/radare2/libr/core/cmd_api.c" 3 4
, 1445); return (((void *)0)); } } while (0)
# 1445 "project/radare2/libr/core/cmd_api.c"
                                                        ;
 RCmdDesc *res = create_cmd_desc (cmd, parent, R_CMD_DESC_TYPE_OLDINPUT, name, help, 
# 1446 "project/radare2/libr/core/cmd_api.c" 3 4
                                                                                    1
# 1446 "project/radare2/libr/core/cmd_api.c"
                                                                                        );
 if (!res) {
  return 
# 1448 "project/radare2/libr/core/cmd_api.c" 3 4
        ((void *)0)
# 1448 "project/radare2/libr/core/cmd_api.c"
            ;
 }
...
# 1454 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) 
# 1454 "project/radare2/libr/core/cmd_api.c"
     RCmdDesc *r_cmd_desc_parent(RCmdDesc *cd) {
 
# 1455 "project/radare2/libr/core/cmd_api.c" 3 4
do { if (!(
# 1455 "project/radare2/libr/core/cmd_api.c"
cd
# 1455 "project/radare2/libr/core/cmd_api.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1455 "project/radare2/libr/core/cmd_api.c"
...
# 1459 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 1459 "project/radare2/libr/core/cmd_api.c"
          r_cmd_desc_has_handler(RCmdDesc *cd) {
 
# 1460 "project/radare2/libr/core/cmd_api.c" 3 4
do { if (!(
# 1460 "project/radare2/libr/core/cmd_api.c"
cd
# 1460 "project/radare2/libr/core/cmd_api.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1460 "project/radare2/libr/core/cmd_api.c"
...
# 1460 "project/radare2/libr/core/cmd_api.c"
 ...
 case R_CMD_DESC_TYPE_INNER:
  return 
# 1467 "project/radare2/libr/core/cmd_api.c" 3 4
        0
# 1467 "project/radare2/libr/core/cmd_api.c"
             ;
 case R_CMD_DESC_TYPE_GROUP:
  return cd->d.group_data.exec_cd && r_cmd_desc_has_handler (cd->d.group_data.exec_cd);
 }
 return 
# 1471 "project/radare2/libr/core/cmd_api.c" 3 4
       0
# 1471 "project/radare2/libr/core/cmd_api.c"
            ;
}


# 1474 "project/radare2/libr/core/cmd_api.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 1474 "project/radare2/libr/core/cmd_api.c"
          r_cmd_desc_remove(RCmd *cmd, RCmdDesc *cd) {
 
# 1475 "project/radare2/libr/core/cmd_api.c" 3 4
do { if (!(
# 1475 "project/radare2/libr/core/cmd_api.c"
cmd && cd
# 1475 "project/radare2/libr/core/cmd_api.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1475 "project/radare2/libr/core/cmd_api.c"
...
# 1475 "project/radare2/libr/core/cmd_api.c"
 ...
 cmd_desc_free (cd);
 return 
# 1481 "project/radare2/libr/core/cmd_api.c" 3 4
       1
# 1481 "project/radare2/libr/core/cmd_api.c"
           ;
}
