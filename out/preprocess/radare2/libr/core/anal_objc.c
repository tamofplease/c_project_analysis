# 0 "project/radare2/libr/core/anal_objc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/anal_objc.c"
# 9 "project/radare2/libr/core/anal_objc.c"
...
# 10 "project/radare2/libr/core/anal_objc.c" 2



# 12 "project/radare2/libr/core/anal_objc.c"
typedef struct {
 RCore *core;
 HtUP *up;
 size_t word_size;
...
static void array_add(RCoreObjc *o, 
# 30 "project/radare2/libr/core/anal_objc.c" 3 4
                                   unsigned long long 
# 30 "project/radare2/libr/core/anal_objc.c"
                                        va, 
# 30 "project/radare2/libr/core/anal_objc.c" 3 4
                                            unsigned long long 
# 30 "project/radare2/libr/core/anal_objc.c"
...
# 31 "project/radare2/libr/core/anal_objc.c" 3 4
_Bool 
# 31 "project/radare2/libr/core/anal_objc.c"
     found = 
# 31 "project/radare2/libr/core/anal_objc.c" 3 4
             0
# 31 "project/radare2/libr/core/anal_objc.c"
 ...
 if (!found || !vec) {
  vec = r_vector_new (sizeof (
# 34 "project/radare2/libr/core/anal_objc.c" 3 4
                             unsigned long long
# 34 "project/radare2/libr/core/anal_objc.c"
                                 ), 
# 34 "project/radare2/libr/core/anal_objc.c" 3 4
                                    ((void *)0)
# 34 "project/radare2/libr/core/anal_objc.c"
...
# 37 "project/radare2/libr/core/anal_objc.c" 3 4
unsigned long long 
# 37 "project/radare2/libr/core/anal_objc.c"
     *addr;
 
# 38 "project/radare2/libr/core/anal_objc.c" 3 4
if (!r_vector_empty (
# 38 "project/radare2/libr/core/anal_objc.c"
vec
# 38 "project/radare2/libr/core/anal_objc.c" 3 4
)) for (
# 38 "project/radare2/libr/core/anal_objc.c"
...
static inline 
# 51 "project/radare2/libr/core/anal_objc.c" 3 4
             _Bool 
# 51 "project/radare2/libr/core/anal_objc.c"
                  isValid(
# 51 "project/radare2/libr/core/anal_objc.c" 3 4
                          unsigned long long 
# 51 "project/radare2/libr/core/anal_objc.c"
                               addr) {
 return (addr != 0LL && addr != 
# 52 "project/radare2/libr/core/anal_objc.c" 3 4
                               0xFFFFFFFFFFFFFFFFULL
# 52 "project/radare2/libr/core/anal_objc.c"
                                       );
}

static inline 
# 55 "project/radare2/libr/core/anal_objc.c" 3 4
             _Bool 
# 55 "project/radare2/libr/core/anal_objc.c"
                  isInvalid(
# 55 "project/radare2/libr/core/anal_objc.c" 3 4
                            unsigned long long 
# 55 "project/radare2/libr/core/anal_objc.c"
...
static inline 
# 59 "project/radare2/libr/core/anal_objc.c" 3 4
             _Bool 
# 59 "project/radare2/libr/core/anal_objc.c"
                  inBetween(RBinSection *s, 
# 59 "project/radare2/libr/core/anal_objc.c" 3 4
                                            unsigned long long 
# 59 "project/radare2/libr/core/anal_objc.c"
                                                 addr) {
 if (!s || isInvalid (addr)) {
  return 
# 61 "project/radare2/libr/core/anal_objc.c" 3 4
        0
# 61 "project/radare2/libr/core/anal_objc.c"
             ;
 }
 const 
# 63 "project/radare2/libr/core/anal_objc.c" 3 4
      unsigned long long 
# 63 "project/radare2/libr/core/anal_objc.c"
           from = s->vaddr;
 const 
# 64 "project/radare2/libr/core/anal_objc.c" 3 4
      unsigned long long 
# 64 "project/radare2/libr/core/anal_objc.c"
           to = from + s->vsize;
 return 
# 65 "project/radare2/libr/core/anal_objc.c" 3 4
       (((
# 65 "project/radare2/libr/core/anal_objc.c"
       addr
# 65 "project/radare2/libr/core/anal_objc.c" 3 4
       )>=(
# 65 "project/radare2/libr/core/anal_objc.c"
...
static inline 
# 68 "project/radare2/libr/core/anal_objc.c" 3 4
             unsigned int 
# 68 "project/radare2/libr/core/anal_objc.c"
                  readDword(RCoreObjc *objc, 
# 68 "project/radare2/libr/core/anal_objc.c" 3 4
                                             unsigned long long 
# 68 "project/radare2/libr/core/anal_objc.c"
                                                  addr, 
...
# 69 "project/radare2/libr/core/anal_objc.c" 3 4
unsigned char 
# 69 "project/radare2/libr/core/anal_objc.c"
    buf[4];
...
static inline 
# 74 "project/radare2/libr/core/anal_objc.c" 3 4
             unsigned long long 
# 74 "project/radare2/libr/core/anal_objc.c"
                  readQword(RCoreObjc *objc, 
# 74 "project/radare2/libr/core/anal_objc.c" 3 4
                                             unsigned long long 
# 74 "project/radare2/libr/core/anal_objc.c"
                                                  addr, 
...
# 75 "project/radare2/libr/core/anal_objc.c" 3 4
unsigned char 
# 75 "project/radare2/libr/core/anal_objc.c"
    buf[8] = {0};
 *success = r_io_read_at (objc->core->io, addr, buf, sizeof (buf));
...
static void objc_analyze(RCore *core) {
 ...
 if (!strcmp ("arm", r_config_get (core->config, "asm.arch"))) {
  const 
# 84 "project/radare2/libr/core/anal_objc.c" 3 4
       _Bool 
# 84 "project/radare2/libr/core/anal_objc.c"
            emu_lazy = r_config_get_i (core->config, "emu.lazy");
  r_config_set_b (core->config, "emu.lazy", 
# 85 "project/radare2/libr/core/anal_objc.c" 3 4
                                           1
# 85 "project/radare2/libr/core/anal_objc.c"
                                               );
...
static 
# 92 "project/radare2/libr/core/anal_objc.c" 3 4
      unsigned long long 
# 92 "project/radare2/libr/core/anal_objc.c"
           getRefPtr(RCoreObjc *o, 
# 92 "project/radare2/libr/core/anal_objc.c" 3 4
                                   unsigned long long 
# 92 "project/radare2/libr/core/anal_objc.c"
                                        classMethodsVA, 
...
# 92 "project/radare2/libr/core/anal_objc.c"
                                                             *rfound) {
 *rfound = 
# 93 "project/radare2/libr/core/anal_objc.c" 3 4
          0
# 93 "project/radare2/libr/core/anal_objc.c"
               ;

 
# 95 "project/radare2/libr/core/anal_objc.c" 3 4
_Bool 
# 95 "project/radare2/libr/core/anal_objc.c"
     readSuccess;
 
# 96 "project/radare2/libr/core/anal_objc.c" 3 4
unsigned long long 
# 96 "project/radare2/libr/core/anal_objc.c"
     namePtr = readQword (o, classMethodsVA, &readSuccess);
 if (!readSuccess) {
  return 
# 98 "project/radare2/libr/core/anal_objc.c" 3 4
        0xFFFFFFFFFFFFFFFFULL
# 98 "project/radare2/libr/core/anal_objc.c"
                ;
 }

 size_t cnt = 0;
 
# 102 "project/radare2/libr/core/anal_objc.c" 3 4
unsigned long long 
# 102 "project/radare2/libr/core/anal_objc.c"
     ref = 
# 102 "project/radare2/libr/core/anal_objc.c" 3 4
           0xFFFFFFFFFFFFFFFFULL
# 102 "project/radare2/libr/core/anal_objc.c"
...
# 103 "project/radare2/libr/core/anal_objc.c" 3 4
_Bool 
# 103 "project/radare2/libr/core/anal_objc.c"
     isMsgRef = 
# 103 "project/radare2/libr/core/anal_objc.c" 3 4
                0
# 103 "project/radare2/libr/core/anal_objc.c"
 ...
 if (!*rfound || !vec) {
  *rfound = 
# 107 "project/radare2/libr/core/anal_objc.c" 3 4
           0
# 107 "project/radare2/libr/core/anal_objc.c"
                ;
  return 
# 108 "project/radare2/libr/core/anal_objc.c" 3 4
        0
# 108 "project/radare2/libr/core/anal_objc.c"
             ;
 }
 
# 110 "project/radare2/libr/core/anal_objc.c" 3 4
unsigned long long 
# 110 "project/radare2/libr/core/anal_objc.c"
     *addr;
 
# 111 "project/radare2/libr/core/anal_objc.c" 3 4
if (!r_vector_empty (
# 111 "project/radare2/libr/core/anal_objc.c"
vec
# 111 "project/radare2/libr/core/anal_objc.c" 3 4
)) for (
# 111 "project/radare2/libr/core/anal_objc.c"
...
# 111 "project/radare2/libr/core/anal_objc.c"
                             {
  const 
# 112 "project/radare2/libr/core/anal_objc.c" 3 4
       unsigned long long 
# 112 "project/radare2/libr/core/anal_objc.c"
            at = *addr;
  if (inBetween (o->_selrefs, at)) {
   isMsgRef = 
# 114 "project/radare2/libr/core/anal_objc.c" 3 4
             0
# 114 "project/radare2/libr/core/anal_objc.c"
                  ;
   ref = at;
  } else if (inBetween (o->_msgrefs, at)) {
   isMsgRef = 
# 117 "project/radare2/libr/core/anal_objc.c" 3 4
             1
# 117 "project/radare2/libr/core/anal_objc.c"
                 ;
   ref = at;
 ...
 if (cnt > 1 || ref == 0 || ref == 
# 123 "project/radare2/libr/core/anal_objc.c" 3 4
                                  0xFFFFFFFFFFFFFFFFULL
# 123 "project/radare2/libr/core/anal_objc.c"
                                          ) {
  *rfound = 
# 124 "project/radare2/libr/core/anal_objc.c" 3 4
           0
# 124 "project/radare2/libr/core/anal_objc.c"
                ;
  return 
# 125 "project/radare2/libr/core/anal_objc.c" 3 4
        0xFFFFFFFFFFFFFFFFULL
# 125 "project/radare2/libr/core/anal_objc.c"
                ;
 }
...
static 
# 130 "project/radare2/libr/core/anal_objc.c" 3 4
      _Bool 
# 130 "project/radare2/libr/core/anal_objc.c"
           objc_build_refs(RCoreObjc *objc) {
 
# 131 "project/radare2/libr/core/anal_objc.c" 3 4
unsigned long long 
# 131 "project/radare2/libr/core/anal_objc.c"
     off;
 if (!objc->_const || !objc->_selrefs) {
  return 
# 133 "project/radare2/libr/core/anal_objc.c" 3 4
        0
# 133 "project/radare2/libr/core/anal_objc.c"
             ;
 }

 const 
# 136 "project/radare2/libr/core/anal_objc.c" 3 4
      unsigned long long 
# 136 "project/radare2/libr/core/anal_objc.c"
           va_const = objc->_const->vaddr;
 size_t ss_const = objc->_const->vsize;
 const 
# 138 "project/radare2/libr/core/anal_objc.c" 3 4
      unsigned long long 
# 138 "project/radare2/libr/core/anal_objc.c"
           va_selrefs = objc->_selrefs->vaddr;
 size_t ss_selrefs = objc->_selrefs->vsize;

 size_t maxsize = 
# 141 "project/radare2/libr/core/anal_objc.c" 3 4
                 (((
# 141 "project/radare2/libr/core/anal_objc.c"
                 ss_const
# 141 "project/radare2/libr/core/anal_objc.c" 3 4
                 )>(
# 141 "project/radare2/libr/core/anal_objc.c"
...
# 141 "project/radare2/libr/core/anal_objc.c"
                                             ;
 maxsize = 
# 142 "project/radare2/libr/core/anal_objc.c" 3 4
          (((
# 142 "project/radare2/libr/core/anal_objc.c"
          maxsize
# 142 "project/radare2/libr/core/anal_objc.c" 3 4
          )>(
# 142 "project/radare2/libr/core/anal_objc.c"
...
# 145 "project/radare2/libr/core/anal_objc.c" 3 4
  fprintf(__stderrp,
# 145 "project/radare2/libr/core/anal_objc.c"
  "aao: Truncating ss_const from %zu to %zu\n", ss_const, maxsize
# 145 "project/radare2/libr/core/anal_objc.c" 3 4
  )
# 145 "project/radare2/libr/core/anal_objc.c"
                                                                           ;
...
# 151 "project/radare2/libr/core/anal_objc.c" 3 4
  fprintf(__stderrp,
# 151 "project/radare2/libr/core/anal_objc.c"
  "aao: Truncating ss_selrefs from %zu to %zu\n", ss_selrefs, maxsize
# 151 "project/radare2/libr/core/anal_objc.c" 3 4
  )
# 151 "project/radare2/libr/core/anal_objc.c"
                                                                               ;
...
# 155 "project/radare2/libr/core/anal_objc.c" 3 4
unsigned char 
# 155 "project/radare2/libr/core/anal_objc.c"
    *buf = calloc (1, maxsize);
 if (!buf) {
  return 
# 157 "project/radare2/libr/core/anal_objc.c" 3 4
        0
# 157 "project/radare2/libr/core/anal_objc.c"
             ;
 }
 const size_t word_size = objc->word_size;
 if (!r_io_read_at (objc->core->io, objc->_const->vaddr, buf, ss_const)) {
  
# 161 "project/radare2/libr/core/anal_objc.c" 3 4
 fprintf(__stderrp,
# 161 "project/radare2/libr/core/anal_objc.c"
...
# 161 "project/radare2/libr/core/anal_objc.c"
                                                                     ;
  return 
# 162 "project/radare2/libr/core/anal_objc.c" 3 4
        0
# 162 "project/radare2/libr/core/anal_objc.c"
             ;
 }
 for (off = 0; off + word_size < ss_const && off + word_size < maxsize; off += word_size) {
  
# 165 "project/radare2/libr/core/anal_objc.c" 3 4
 unsigned long long 
# 165 "project/radare2/libr/core/anal_objc.c"
      va = va_const + off;
  
# 166 "project/radare2/libr/core/anal_objc.c" 3 4
 unsigned long long 
# 166 "project/radare2/libr/core/anal_objc.c"
      xrefs_to = r_read_le64 (buf + off);
  if (isValid (xrefs_to)) {
...
# 172 "project/radare2/libr/core/anal_objc.c" 3 4
 fprintf(__stderrp,
# 172 "project/radare2/libr/core/anal_objc.c"
...
# 172 "project/radare2/libr/core/anal_objc.c"
                                                         ;
  return 
# 173 "project/radare2/libr/core/anal_objc.c" 3 4
        0
# 173 "project/radare2/libr/core/anal_objc.c"
             ;
 }
 for (off = 0; off + word_size < ss_selrefs && off + word_size < maxsize; off += word_size) {
  
# 176 "project/radare2/libr/core/anal_objc.c" 3 4
 unsigned long long 
# 176 "project/radare2/libr/core/anal_objc.c"
      va = va_selrefs + off;
  
# 177 "project/radare2/libr/core/anal_objc.c" 3 4
 unsigned long long 
# 177 "project/radare2/libr/core/anal_objc.c"
      xrefs_to = r_read_le64 (buf + off);
  if (isValid (xrefs_to)) {
 ...
 free (buf);
 return 
# 183 "project/radare2/libr/core/anal_objc.c" 3 4
       1
# 183 "project/radare2/libr/core/anal_objc.c"
           ;
}
...
static RCoreObjc *core_objc_new(RCore *core) {
 ...
 if (!sections) {
  return 
# 189 "project/radare2/libr/core/anal_objc.c" 3 4
        0
# 189 "project/radare2/libr/core/anal_objc.c"
             ;
 }
 RCoreObjc *o = 
# 191 "project/radare2/libr/core/anal_objc.c" 3 4
               (
# 191 "project/radare2/libr/core/anal_objc.c"
               RCoreObjc
# 191 "project/radare2/libr/core/anal_objc.c" 3 4
               *)calloc(1,sizeof(
# 191 "project/radare2/libr/core/anal_objc.c"
...
# 199 "project/radare2/libr/core/anal_objc.c" 3 4
 fprintf(__stderrp,
# 199 "project/radare2/libr/core/anal_objc.c"
...
# 204 "project/radare2/libr/core/anal_objc.c" 3 4
if (
# 204 "project/radare2/libr/core/anal_objc.c"
sections
# 204 "project/radare2/libr/core/anal_objc.c" 3 4
) for (
# 204 "project/radare2/libr/core/anal_objc.c"
...
# 204 "project/radare2/libr/core/anal_objc.c"
 ...
 if (!o->_const || ((o->_selrefs || o->_msgrefs) && !(o->_data && o->_const))) {
  free (o);
  return 
# 218 "project/radare2/libr/core/anal_objc.c" 3 4
        ((void *)0)
# 218 "project/radare2/libr/core/anal_objc.c"
            ;
 }
 o->up = ht_up_new (
# 220 "project/radare2/libr/core/anal_objc.c" 3 4
                   ((void *)0)
# 220 "project/radare2/libr/core/anal_objc.c"
                       , kv_array_free, 
# 220 "project/radare2/libr/core/anal_objc.c" 3 4
                                        ((void *)0)
# 220 "project/radare2/libr/core/anal_objc.c"
...
static 
# 232 "project/radare2/libr/core/anal_objc.c" 3 4
      _Bool 
# 232 "project/radare2/libr/core/anal_objc.c"
           objc_find_refs(RCore *core) {
 RCoreObjc *objc = core_objc_new (core);
 if (!objc) {
  if (core->anal->verbose) {
   
# 236 "project/radare2/libr/core/anal_objc.c" 3 4
  fprintf(__stderrp,
# 236 "project/radare2/libr/core/anal_objc.c"
...
# 236 "project/radare2/libr/core/anal_objc.c"
  ...
  return 
# 238 "project/radare2/libr/core/anal_objc.c" 3 4
        0
# 238 "project/radare2/libr/core/anal_objc.c"
             ;
 }
 ...
 if (!objc_build_refs (objc)) {
  core_objc_free (objc);
  return 
# 243 "project/radare2/libr/core/anal_objc.c" 3 4
        0
# 243 "project/radare2/libr/core/anal_objc.c"
             ;
 }
...
# 248 "project/radare2/libr/core/anal_objc.c" 3 4
unsigned long long 
# 248 "project/radare2/libr/core/anal_objc.c"
     off;
 size_t total_xrefs = 0;
 
# 250 "project/radare2/libr/core/anal_objc.c" 3 4
_Bool 
# 250 "project/radare2/libr/core/anal_objc.c"
     readSuccess = 
# 250 "project/radare2/libr/core/anal_objc.c" 3 4
                   1
# 250 "project/radare2/libr/core/anal_objc.c"
...
# 256 "project/radare2/libr/core/anal_objc.c" 3 4
 unsigned long long 
# 256 "project/radare2/libr/core/anal_objc.c"
      va = objc->_data->vaddr + off;

  
# 258 "project/radare2/libr/core/anal_objc.c" 3 4
 unsigned long long 
# 258 "project/radare2/libr/core/anal_objc.c"
      classRoVA = readQword (objc, va + objc2ClassInfoOffs, &readSuccess);
  if (!readSuccess || isInvalid (classRoVA)) {
   continue;
  }
  
# 262 "project/radare2/libr/core/anal_objc.c" 3 4
 unsigned long long 
# 262 "project/radare2/libr/core/anal_objc.c"
      classMethodsVA = readQword (objc, classRoVA + objc2ClassBaseMethsOffs, &readSuccess);
  if (!readSuccess || isInvalid (classMethodsVA)) {
   continue;
  }

  
# 267 "project/radare2/libr/core/anal_objc.c" 3 4
 unsigned int 
# 267 "project/radare2/libr/core/anal_objc.c"
      count = readDword (objc, classMethodsVA + 4, &readSuccess);
  if (!readSuccess || ((
# 268 "project/radare2/libr/core/anal_objc.c" 3 4
                       unsigned int
# 268 "project/radare2/libr/core/anal_objc.c"
                           )count == 
# 268 "project/radare2/libr/core/anal_objc.c" 3 4
                                     0xFFFFFFFFU
# 268 "project/radare2/libr/core/anal_objc.c"
...
# 273 "project/radare2/libr/core/anal_objc.c" 3 4
 unsigned long long 
# 273 "project/radare2/libr/core/anal_objc.c"
      delta = (objc2ClassMethSize * count);
  
# 274 "project/radare2/libr/core/anal_objc.c" 3 4
 unsigned long long 
# 274 "project/radare2/libr/core/anal_objc.c"
      to = classMethodsVA + delta - 8;
  if (delta > objc->file_size) {
   
# 276 "project/radare2/libr/core/anal_objc.c" 3 4
  fprintf(__stderrp,
# 276 "project/radare2/libr/core/anal_objc.c"
  "Workaround: Corrupted objc data? checking next %llx !< %llx\n", classMethodsVA, to
# 276 "project/radare2/libr/core/anal_objc.c" 3 4
  )
# 276 "project/radare2/libr/core/anal_objc.c"
                                                                                               ;
...
# 283 "project/radare2/libr/core/anal_objc.c" 3 4
  fprintf(__stderrp,
# 283 "project/radare2/libr/core/anal_objc.c"
  "Warning: Fuzzed binary or bug in here, checking next %llx !< %llx\n", classMethodsVA, to
# 283 "project/radare2/libr/core/anal_objc.c" 3 4
  )
# 283 "project/radare2/libr/core/anal_objc.c"
                                                                                                     ;
...
# 290 "project/radare2/libr/core/anal_objc.c" 3 4
  _Bool 
# 290 "project/radare2/libr/core/anal_objc.c"
       found = 
# 290 "project/radare2/libr/core/anal_objc.c" 3 4
               0
# 290 "project/radare2/libr/core/anal_objc.c"
...
# 291 "project/radare2/libr/core/anal_objc.c" 3 4
  unsigned long long 
# 291 "project/radare2/libr/core/anal_objc.c"
       selRefVA = getRefPtr (objc, va, &found);
   if (!found) {
    continue;
   }
   
# 295 "project/radare2/libr/core/anal_objc.c" 3 4
  _Bool 
# 295 "project/radare2/libr/core/anal_objc.c"
       succ = 
# 295 "project/radare2/libr/core/anal_objc.c" 3 4
              0
# 295 "project/radare2/libr/core/anal_objc.c"
...
# 296 "project/radare2/libr/core/anal_objc.c" 3 4
  unsigned long long 
# 296 "project/radare2/libr/core/anal_objc.c"
       funcVA = readQword (objc, va + objc2ClassMethImpOffs, &succ);
   if (!succ) {
    break;
   }
...
# 305 "project/radare2/libr/core/anal_objc.c" 3 4
   if (
# 305 "project/radare2/libr/core/anal_objc.c"
   list
# 305 "project/radare2/libr/core/anal_objc.c" 3 4
   ) for (
# 305 "project/radare2/libr/core/anal_objc.c"
...
# 305 "project/radare2/libr/core/anal_objc.c"
 ...
 const 
# 313 "project/radare2/libr/core/anal_objc.c" 3 4
      unsigned long long 
# 313 "project/radare2/libr/core/anal_objc.c"
           pa_selrefs = objc->_selrefs->paddr;
 const 
# 314 "project/radare2/libr/core/anal_objc.c" 3 4
      unsigned long long 
# 314 "project/radare2/libr/core/anal_objc.c"
           va_selrefs = objc->_selrefs->vaddr;
 const 
# 315 "project/radare2/libr/core/anal_objc.c" 3 4
      unsigned long long 
# 315 "project/radare2/libr/core/anal_objc.c"
           ss_selrefs = va_selrefs + objc->_selrefs->vsize;

 char rs[128];
 
# 318 "project/radare2/libr/core/anal_objc.c" 3 4
__builtin___snprintf_chk (
# 318 "project/radare2/libr/core/anal_objc.c"
rs
# 318 "project/radare2/libr/core/anal_objc.c" 3 4
, 
# 318 "project/radare2/libr/core/anal_objc.c"
...
, 2 > 1 ? 1 : 0), 
# 318 "project/radare2/libr/core/anal_objc.c"
"Found %zu objc xrefs...", total_xrefs
# 318 "project/radare2/libr/core/anal_objc.c" 3 4
)
# 318 "project/radare2/libr/core/anal_objc.c"
                                                                  ;
...
# 321 "project/radare2/libr/core/anal_objc.c" 3 4
unsigned long long 
# 321 "project/radare2/libr/core/anal_objc.c"
     a;
 const size_t word_size = objc->word_size;
 const size_t maxsize = objc->file_size - pa_selrefs;
 for (a = va_selrefs; a < ss_selrefs && a < maxsize; a += word_size) {
  r_meta_set (core->anal, R_META_TYPE_DATA, a, word_size, 
# 325 "project/radare2/libr/core/anal_objc.c" 3 4
                                                         ((void *)0)
# 325 "project/radare2/libr/core/anal_objc.c"
                                                             );
  total_words++;
 }
 
# 328 "project/radare2/libr/core/anal_objc.c" 3 4
__builtin___snprintf_chk (
# 328 "project/radare2/libr/core/anal_objc.c"
rs
# 328 "project/radare2/libr/core/anal_objc.c" 3 4
, 
# 328 "project/radare2/libr/core/anal_objc.c"
...
# 328 "project/radare2/libr/core/anal_objc.c"
 ...
 core_objc_free (objc);
 return 
# 331 "project/radare2/libr/core/anal_objc.c" 3 4
       1
# 331 "project/radare2/libr/core/anal_objc.c"
           ;
}


# 334 "project/radare2/libr/core/anal_objc.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 334 "project/radare2/libr/core/anal_objc.c"
          cmd_anal_objc(RCore *core, const char *input, 
# 334 "project/radare2/libr/core/anal_objc.c" 3 4
                                                        _Bool 
# 334 "project/radare2/libr/core/anal_objc.c"
                                                             auto_anal) {
 
# 335 "project/radare2/libr/core/anal_objc.c" 3 4
do { if (!(
# 335 "project/radare2/libr/core/anal_objc.c"
core && input
# 335 "project/radare2/libr/core/anal_objc.c" 3 4
