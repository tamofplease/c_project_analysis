# 0 "project/radare2/libr/core/gdiff.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/core/gdiff.c" 2
...
# 5 "project/radare2/libr/core/gdiff.c" 2
...
# 6 "project/radare2/libr/core/gdiff.c" 2
...
# 9 "project/radare2/libr/core/gdiff.c" 2

__attribute__((visibility("default"))) 
# 10 "project/radare2/libr/core/gdiff.c"
     int r_core_gdiff_fcn(RCore *c, 
# 10 "project/radare2/libr/core/gdiff.c" 3 4
                                    unsigned long long 
# 10 "project/radare2/libr/core/gdiff.c"
                                         addr, 
# 10 "project/radare2/libr/core/gdiff.c" 3 4
...
# 10 "project/radare2/libr/core/gdiff.c"
 ...
 if (!fa || !fb) {
  return 
# 14 "project/radare2/libr/core/gdiff.c" 3 4
        0
# 14 "project/radare2/libr/core/gdiff.c"
             ;
 }
 RAnalBlock *bb;
 RListIter *iter;
 
# 18 "project/radare2/libr/core/gdiff.c" 3 4
if (
# 18 "project/radare2/libr/core/gdiff.c"
fa->bbs
# 18 "project/radare2/libr/core/gdiff.c" 3 4
) for (
# 18 "project/radare2/libr/core/gdiff.c"
...
# 21 "project/radare2/libr/core/gdiff.c" 3 4
if (
# 21 "project/radare2/libr/core/gdiff.c"
fb->bbs
# 21 "project/radare2/libr/core/gdiff.c" 3 4
) for (
# 21 "project/radare2/libr/core/gdiff.c"
...
# 21 "project/radare2/libr/core/gdiff.c"
 ...
 r_list_free (lb);
 return 
# 31 "project/radare2/libr/core/gdiff.c" 3 4
       1
# 31 "project/radare2/libr/core/gdiff.c"
           ;
}



# 35 "project/radare2/libr/core/gdiff.c" 3 4
__attribute__((visibility("default"))) 
# 35 "project/radare2/libr/core/gdiff.c"
     int r_core_gdiff(RCore *c, RCore *c2) {
 RCore *cores[2] = {c, c2};
 RAnalFunction *fcn;
 RAnalBlock *bb;
 ...
 if (!c || !c2) {
  return 
# 43 "project/radare2/libr/core/gdiff.c" 3 4
        0
# 43 "project/radare2/libr/core/gdiff.c"
             ;
 }
 for (i = 0; i < 2; i++) {

  
# 47 "project/radare2/libr/core/gdiff.c" 3 4
 if (
# 47 "project/radare2/libr/core/gdiff.c"
 cores[i]->anal->fcns
# 47 "project/radare2/libr/core/gdiff.c" 3 4
 ) for (
# 47 "project/radare2/libr/core/gdiff.c"
...
# 53 "project/radare2/libr/core/gdiff.c" 3 4
 if (
# 53 "project/radare2/libr/core/gdiff.c"
 cores[i]->anal->fcns
# 53 "project/radare2/libr/core/gdiff.c" 3 4
 ) for (
# 53 "project/radare2/libr/core/gdiff.c"
...
# 54 "project/radare2/libr/core/gdiff.c" 3 4
  if (
# 54 "project/radare2/libr/core/gdiff.c"
  fcn->bbs
# 54 "project/radare2/libr/core/gdiff.c" 3 4
  ) for (
# 54 "project/radare2/libr/core/gdiff.c"
...
# 59 "project/radare2/libr/core/gdiff.c" 3 4
 if (
# 59 "project/radare2/libr/core/gdiff.c"
 cores[i]->anal->fcns
# 59 "project/radare2/libr/core/gdiff.c" 3 4
 ) for (
# 59 "project/radare2/libr/core/gdiff.c"
...
# 59 "project/radare2/libr/core/gdiff.c"
 ...
 return 
# 66 "project/radare2/libr/core/gdiff.c" 3 4
       1
# 66 "project/radare2/libr/core/gdiff.c"
           ;
}


static void diffrow(
# 70 "project/radare2/libr/core/gdiff.c" 3 4
                   unsigned long long 
# 70 "project/radare2/libr/core/gdiff.c"
...
# 70 "project/radare2/libr/core/gdiff.c"
                                                     size, int maxnamelen,
  int digits, 
# 71 "project/radare2/libr/core/gdiff.c" 3 4
             unsigned long long 
# 71 "project/radare2/libr/core/gdiff.c"
                  addr2, const char *name2, 
# 71 "project/radare2/libr/core/gdiff.c" 3 4
                                            unsigned int 
# 71 "project/radare2/libr/core/gdiff.c"
                                                 size2,
 ...
 if (bare) {
  if (addr2 == 
# 74 "project/radare2/libr/core/gdiff.c" 3 4
              0xFFFFFFFFFFFFFFFFULL 
# 74 "project/radare2/libr/core/gdiff.c"
                       || !name2) {
   printf ("0x%016"
# 75 "project/radare2/libr/core/gdiff.c" 3 4
                  "llx"
# 75 "project/radare2/libr/core/gdiff.c"
                         " |%8s  (%f)\n", addr, match, dist);
  } else {
   printf ("0x%016"
# 77 "project/radare2/libr/core/gdiff.c" 3 4
                  "llx"
# 77 "project/radare2/libr/core/gdiff.c"
                         " |%8s  (%f) | 0x%016"
# 77 "project/radare2/libr/core/gdiff.c" 3 4
                                               "llx"
# 77 "project/radare2/libr/core/gdiff.c"
  ...
  if (addr2 == 
# 80 "project/radare2/libr/core/gdiff.c" 3 4
              0xFFFFFFFFFFFFFFFFULL 
# 80 "project/radare2/libr/core/gdiff.c"
                       || !name2) {
   printf ("%*s %*d 0x%"
# 81 "project/radare2/libr/core/gdiff.c" 3 4
                       "llx"
# 81 "project/radare2/libr/core/gdiff.c"
                              " |%8s  (%f)\n",
    maxnamelen, name, digits, size, addr, match, dist);
  } else {
   printf ("%*s %*d 0x%"
# 84 "project/radare2/libr/core/gdiff.c" 3 4
                       "llx"
# 84 "project/radare2/libr/core/gdiff.c"
                              " |%8s  (%f) | 0x%"
# 84 "project/radare2/libr/core/gdiff.c" 3 4
                                                 "llx"
# 84 "project/radare2/libr/core/gdiff.c"
...
# 91 "project/radare2/libr/core/gdiff.c" 3 4
__attribute__((visibility("default"))) 
# 91 "project/radare2/libr/core/gdiff.c"
     void r_core_diff_show(RCore *c, RCore *c2) {
 
# 92 "project/radare2/libr/core/gdiff.c" 3 4
_Bool 
# 92 "project/radare2/libr/core/gdiff.c"
     bare = r_config_get_i (c->config, "diff.bare") || r_config_get_i (c2->config, "diff.bare");
...
# 98 "project/radare2/libr/core/gdiff.c" 3 4
unsigned long long 
# 98 "project/radare2/libr/core/gdiff.c"
     maxsize = 0;
 int digits = 1;
 int len;

 
# 102 "project/radare2/libr/core/gdiff.c" 3 4
if (
# 102 "project/radare2/libr/core/gdiff.c"
fcns
# 102 "project/radare2/libr/core/gdiff.c" 3 4
) for (
# 102 "project/radare2/libr/core/gdiff.c"
...
# 111 "project/radare2/libr/core/gdiff.c" 3 4
if (
# 111 "project/radare2/libr/core/gdiff.c"
fcns
# 111 "project/radare2/libr/core/gdiff.c" 3 4
) for (
# 111 "project/radare2/libr/core/gdiff.c"
...
# 111 "project/radare2/libr/core/gdiff.c"
 ...
 if (
# 125 "project/radare2/libr/core/gdiff.c" 3 4
    (!(
# 125 "project/radare2/libr/core/gdiff.c"
    fcns
# 125 "project/radare2/libr/core/gdiff.c" 3 4
    ) || !(
# 125 "project/radare2/libr/core/gdiff.c"
...
# 126 "project/radare2/libr/core/gdiff.c" 3 4
 fprintf(__stderrp,
# 126 "project/radare2/libr/core/gdiff.c"
...
# 131 "project/radare2/libr/core/gdiff.c" 3 4
if (
# 131 "project/radare2/libr/core/gdiff.c"
fcns
# 131 "project/radare2/libr/core/gdiff.c" 3 4
) for (
# 131 "project/radare2/libr/core/gdiff.c"
...
# 154 "project/radare2/libr/core/gdiff.c" 3 4
if (
# 154 "project/radare2/libr/core/gdiff.c"
fcns
# 154 "project/radare2/libr/core/gdiff.c" 3 4
) for (
# 154 "project/radare2/libr/core/gdiff.c"
