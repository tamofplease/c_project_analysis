# 0 "project/radare2/libr/core/pseudo.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/pseudo.c"
...
# 4 "project/radare2/libr/core/pseudo.c" 2
...
# 11 "project/radare2/libr/core/pseudo.c"
...
static void find_and_change(char* in, int len) {
 ...
 for (ctx.linebegin = in; in < end; in++) {
  if (*in == '\n' || !*in) {
   if (ctx.type == 2 && ctx.linecount < 1) {
    ctx.linecount++;
    ctx.linebegin = in + 1;
    continue;
   }
   if (ctx.type != 0 && ctx.right && ctx.left && ctx.rightlen > 0 && ctx.leftlen > 0) {
    char* copy = 
# 43 "project/radare2/libr/core/pseudo.c" 3 4
                ((void *)0)
# 43 "project/radare2/libr/core/pseudo.c"
                    ;
...
# 48 "project/radare2/libr/core/pseudo.c" 3 4
     __builtin___memmove_chk (
# 48 "project/radare2/libr/core/pseudo.c"
     copy
# 48 "project/radare2/libr/core/pseudo.c" 3 4
     , 
# 48 "project/radare2/libr/core/pseudo.c"
     ctx.left, ctx.leftlen
# 48 "project/radare2/libr/core/pseudo.c" 3 4
...
# 49 "project/radare2/libr/core/pseudo.c" 3 4
     __builtin___memmove_chk (
# 49 "project/radare2/libr/core/pseudo.c"
     ctx.left
# 49 "project/radare2/libr/core/pseudo.c" 3 4
     , 
# 49 "project/radare2/libr/core/pseudo.c"
     ctx.right, ctx.rightlen
# 49 "project/radare2/libr/core/pseudo.c" 3 4
     , __builtin_object_size (
# 49 "project/radare2/libr/core/pseudo.c"
     ctx.left
...
# 50 "project/radare2/libr/core/pseudo.c" 3 4
     __builtin___memset_chk (
# 50 "project/radare2/libr/core/pseudo.c"
     ctx.left + ctx.rightlen
# 50 "project/radare2/libr/core/pseudo.c" 3 4
     , 
# 50 "project/radare2/libr/core/pseudo.c"
     ' ', ctx.leftlen - ctx.rightlen
# 50 "project/radare2/libr/core/pseudo.c" 3 4
     , __builtin_object_size (
# 50 "project/radare2/libr/core/pseudo.c"
     ctx.left + ctx.rightlen
...
# 51 "project/radare2/libr/core/pseudo.c" 3 4
     __builtin___memmove_chk (
# 51 "project/radare2/libr/core/pseudo.c"
     ctx.comment - ctx.leftlen + ctx.rightlen
# 51 "project/radare2/libr/core/pseudo.c" 3 4
     , 
# 51 "project/radare2/libr/core/pseudo.c"
     ctx.comment, ctx.right - ctx.comment
# 51 "project/radare2/libr/core/pseudo.c" 3 4
     , __builtin_object_size (
# 51 "project/radare2/libr/core/pseudo.c"
     ctx.comment - ctx.leftlen + ctx.rightlen
...
# 52 "project/radare2/libr/core/pseudo.c" 3 4
     __builtin___memmove_chk (
# 52 "project/radare2/libr/core/pseudo.c"
     ctx.right - ctx.leftlen + ctx.rightlen
# 52 "project/radare2/libr/core/pseudo.c" 3 4
     , 
# 52 "project/radare2/libr/core/pseudo.c"
     copy, ctx.leftlen
...
# 60 "project/radare2/libr/core/pseudo.c" 3 4
      __builtin___memcpy_chk (
# 60 "project/radare2/libr/core/pseudo.c"
      copy
# 60 "project/radare2/libr/core/pseudo.c" 3 4
      , 
# 60 "project/radare2/libr/core/pseudo.c"
...
# 62 "project/radare2/libr/core/pseudo.c" 3 4
      __builtin___memcpy_chk (
# 62 "project/radare2/libr/core/pseudo.c"
      ctx.right + ctx.rightlen - ctx.leftlen
# 62 "project/radare2/libr/core/pseudo.c" 3 4
      , 
# 62 "project/radare2/libr/core/pseudo.c"
      ctx.left, ctx.leftlen
...
# 63 "project/radare2/libr/core/pseudo.c" 3 4
      __builtin___memmove_chk (
# 63 "project/radare2/libr/core/pseudo.c"
      ctx.comment + ctx.rightlen - ctx.leftlen
# 63 "project/radare2/libr/core/pseudo.c" 3 4
      , 
# 63 "project/radare2/libr/core/pseudo.c"
      ctx.comment, ctx.right - ctx.comment
...
# 64 "project/radare2/libr/core/pseudo.c" 3 4
      __builtin___memmove_chk (
# 64 "project/radare2/libr/core/pseudo.c"
      ctx.left + ctx.rightlen - ctx.leftlen
# 64 "project/radare2/libr/core/pseudo.c" 3 4
      , 
# 64 "project/radare2/libr/core/pseudo.c"
      copy, ctx.rightlen
...
# 70 "project/radare2/libr/core/pseudo.c" 3 4
     __builtin___memset_chk (
# 70 "project/radare2/libr/core/pseudo.c"
     ctx.right - ctx.leftpos
# 70 "project/radare2/libr/core/pseudo.c" 3 4
     , 
# 70 "project/radare2/libr/core/pseudo.c"
     ' ', ctx.leftpos
...
# 73 "project/radare2/libr/core/pseudo.c" 3 4
     __builtin___memset_chk (
# 73 "project/radare2/libr/core/pseudo.c"
     ctx.left
# 73 "project/radare2/libr/core/pseudo.c" 3 4
     , 
# 73 "project/radare2/libr/core/pseudo.c"
...
# 74 "project/radare2/libr/core/pseudo.c" 3 4
     __builtin___memset_chk (
# 74 "project/radare2/libr/core/pseudo.c"
     ctx.linebegin - ctx.leftlen
# 74 "project/radare2/libr/core/pseudo.c" 3 4
     , 
# 74 "project/radare2/libr/core/pseudo.c"
     ' ', ctx.leftlen
...
# 80 "project/radare2/libr/core/pseudo.c" 3 4
     __builtin___memcpy_chk (
# 80 "project/radare2/libr/core/pseudo.c"
     copy
# 80 "project/radare2/libr/core/pseudo.c" 3 4
     , 
# 80 "project/radare2/libr/core/pseudo.c"
     ctx.right, ctx.leftlen
# 80 "project/radare2/libr/core/pseudo.c" 3 4
     , __builtin_object_size (
# 80 "project/radare2/libr/core/pseudo.c"
     copy
...
# 81 "project/radare2/libr/core/pseudo.c" 3 4
     __builtin___memcpy_chk (
# 81 "project/radare2/libr/core/pseudo.c"
     ctx.right
# 81 "project/radare2/libr/core/pseudo.c" 3 4
     , 
# 81 "project/radare2/libr/core/pseudo.c"
...
# 82 "project/radare2/libr/core/pseudo.c" 3 4
     __builtin___memcpy_chk (
# 82 "project/radare2/libr/core/pseudo.c"
     ctx.left
# 82 "project/radare2/libr/core/pseudo.c" 3 4
     , 
# 82 "project/radare2/libr/core/pseudo.c"
...
# 87 "project/radare2/libr/core/pseudo.c" 3 4
  __builtin___memset_chk (
# 87 "project/radare2/libr/core/pseudo.c"
  &ctx
# 87 "project/radare2/libr/core/pseudo.c" 3 4
  , 
# 87 "project/radare2/libr/core/pseudo.c"
...
# 87 "project/radare2/libr/core/pseudo.c"
   ...
   ctx.comment[1] = '/';
   ctx.comment[2] = '/';
  } else if (!ctx.comment && ctx.type == 0) {
   if (((in)+3<end && *(in) == 's' && *((in)+1) == 't' && *((in)+2) == 'r' && *((in)+3) == '.')) {
    ctx.type = 1;
    ctx.left = in;
    while (!
# 97 "project/radare2/libr/core/pseudo.c" 3 4
           ((
# 97 "project/radare2/libr/core/pseudo.c"
           *(ctx.left - ctx.leftcolor)
# 97 "project/radare2/libr/core/pseudo.c" 3 4
           ) == ' ' || (
# 97 "project/radare2/libr/core/pseudo.c"
           *(ctx.left - ctx.leftcolor)
...
# 97 "project/radare2/libr/core/pseudo.c"
   ...
   } else if (((in)+3<end && *(in) == 's' && *((in)+1) == 'y' && *((in)+2) == 'm' && *((in)+3) == '.')) {
    ctx.type = 2;
    ctx.left = in;
    while (!
# 105 "project/radare2/libr/core/pseudo.c" 3 4
           ((
# 105 "project/radare2/libr/core/pseudo.c"
           *(ctx.left - ctx.leftcolor)
# 105 "project/radare2/libr/core/pseudo.c" 3 4
           ) == ' ' || (
# 105 "project/radare2/libr/core/pseudo.c"
...
# 105 "project/radare2/libr/core/pseudo.c"
   ...
   if (!ctx.leftlen && ctx.left && 
# 112 "project/radare2/libr/core/pseudo.c" 3 4
                                  ((
# 112 "project/radare2/libr/core/pseudo.c"
                                  *in
# 112 "project/radare2/libr/core/pseudo.c" 3 4
                                  ) == ' ' || (
# 112 "project/radare2/libr/core/pseudo.c"
...
# 112 "project/radare2/libr/core/pseudo.c"
    ...
    if (!ctx.right) {
     ctx.right = in;
     while (!
# 117 "project/radare2/libr/core/pseudo.c" 3 4
            ((
# 117 "project/radare2/libr/core/pseudo.c"
            *(ctx.right - ctx.rightcolor)
# 117 "project/radare2/libr/core/pseudo.c" 3 4
            ) == ' ' || (
# 117 "project/radare2/libr/core/pseudo.c"
            *(ctx.right - ctx.rightcolor)
...
# 117 "project/radare2/libr/core/pseudo.c"
   ...
   if (!ctx.leftlen && ctx.left && 
# 126 "project/radare2/libr/core/pseudo.c" 3 4
                                  ((
# 126 "project/radare2/libr/core/pseudo.c"
                                  *in
# 126 "project/radare2/libr/core/pseudo.c" 3 4
                                  ) == ' ' || (
# 126 "project/radare2/libr/core/pseudo.c"
...
# 126 "project/radare2/libr/core/pseudo.c"
   ...
   } else if (ctx.comment && *in == '(' && (
# 128 "project/radare2/libr/core/pseudo.c" 3 4
                                          ((
# 128 "project/radare2/libr/core/pseudo.c"
                                          in[-1]
# 128 "project/radare2/libr/core/pseudo.c" 3 4
                                          ) >= 'A' && (
# 128 "project/radare2/libr/core/pseudo.c"
...
# 128 "project/radare2/libr/core/pseudo.c"
    ...
    ctx.right = in - 1;
    while ((
# 137 "project/radare2/libr/core/pseudo.c" 3 4
          ((
# 137 "project/radare2/libr/core/pseudo.c"
          *ctx.right
# 137 "project/radare2/libr/core/pseudo.c" 3 4
          ) >= 'A' && (
# 137 "project/radare2/libr/core/pseudo.c"
...
# 137 "project/radare2/libr/core/pseudo.c"
    ...
    if (*ctx.right == ' ') {
     ctx.right--;
     while ((
# 148 "project/radare2/libr/core/pseudo.c" 3 4
           ((
# 148 "project/radare2/libr/core/pseudo.c"
           *ctx.right
# 148 "project/radare2/libr/core/pseudo.c" 3 4
           ) >= 'A' && (
# 148 "project/radare2/libr/core/pseudo.c"
...
# 148 "project/radare2/libr/core/pseudo.c"
    ...
    while (!
# 154 "project/radare2/libr/core/pseudo.c" 3 4
           ((
# 154 "project/radare2/libr/core/pseudo.c"
           *(ctx.right - ctx.rightcolor)
# 154 "project/radare2/libr/core/pseudo.c" 3 4
           ) == ' ' || (
# 154 "project/radare2/libr/core/pseudo.c"
...
# 171 "project/radare2/libr/core/pseudo.c" 3 4
((void *)0)

# 172 "project/radare2/libr/core/pseudo.c"
};
...
# 179 "project/radare2/libr/core/pseudo.c" 3 4
__attribute__((visibility("default"))) 
# 179 "project/radare2/libr/core/pseudo.c"
     int r_core_pseudo_code(RCore *core, const char *input) {
 
# 180 "project/radare2/libr/core/pseudo.c" 3 4
_Bool 
# 180 "project/radare2/libr/core/pseudo.c"
     show_c_headers = *input == 'c';
 if (*input == '?') {
  r_core_cmd_help (core, help_msg_pdc);
  return 
# 183 "project/radare2/libr/core/pseudo.c" 3 4
        0
# 183 "project/radare2/libr/core/pseudo.c"
             ;
 }
# 203 "project/radare2/libr/core/pseudo.c"
 ...
 const 
# 216 "project/radare2/libr/core/pseudo.c" 3 4
      _Bool 
# 216 "project/radare2/libr/core/pseudo.c"
           show_json = (*input == 'j');
 const 
# 217 "project/radare2/libr/core/pseudo.c" 3 4
      _Bool 
# 217 "project/radare2/libr/core/pseudo.c"
           show_addr = (*input == 'o');

 Sdb *db;
 
# 220 "project/radare2/libr/core/pseudo.c" 3 4
unsigned long long 
# 220 "project/radare2/libr/core/pseudo.c"
     queuegoto = 0LL;
 ...
 if (!hc) {
  return 
# 225 "project/radare2/libr/core/pseudo.c" 3 4
        0
# 225 "project/radare2/libr/core/pseudo.c"
             ;
 }
 r_config_hold (hc, "asm.pseudo", "asm.decode", "asm.lines", "asm.bytes", "asm.stackptr", 
# 227 "project/radare2/libr/core/pseudo.c" 3 4
                                                                                         ((void *)0)
# 227 "project/radare2/libr/core/pseudo.c"
                                                                                             );
 r_config_hold (hc, "asm.offset", "asm.flags", "asm.lines.fcn", "asm.comments", 
# 228 "project/radare2/libr/core/pseudo.c" 3 4
                                                                               ((void *)0)
# 228 "project/radare2/libr/core/pseudo.c"
                                                                                   );
 r_config_hold (hc, "asm.functions", "asm.section", "asm.cmt.col", "asm.sub.names", 
# 229 "project/radare2/libr/core/pseudo.c" 3 4
                                                                                   ((void *)0)
# 229 "project/radare2/libr/core/pseudo.c"
                                                                                       );
 r_config_hold (hc, "scr.color", "emu.str", "asm.emu", "emu.write", 
# 230 "project/radare2/libr/core/pseudo.c" 3 4
                                                                   ((void *)0)
# 230 "project/radare2/libr/core/pseudo.c"
                                                                       );
 r_config_hold (hc, "io.cache", 
# 231 "project/radare2/libr/core/pseudo.c" 3 4
                               ((void *)0)
# 231 "project/radare2/libr/core/pseudo.c"
                                   );
 if (!fcn) {
  
# 233 "project/radare2/libr/core/pseudo.c" 3 4
 fprintf(__stderrp,
# 233 "project/radare2/libr/core/pseudo.c"
 "Cannot find function in 0x%08"
# 233 "project/radare2/libr/core/pseudo.c" 3 4
 "llx"
# 233 "project/radare2/libr/core/pseudo.c"
 "\n", core->offset
...
# 233 "project/radare2/libr/core/pseudo.c"
  ...
  return 
# 235 "project/radare2/libr/core/pseudo.c" 3 4
        0
# 235 "project/radare2/libr/core/pseudo.c"
             ;
 }
 r_config_set_i (core->config, "scr.color", 0);
 r_config_set_b (core->config, "asm.stackptr", 
# 238 "project/radare2/libr/core/pseudo.c" 3 4
                                              0
# 238 "project/radare2/libr/core/pseudo.c"
                                                   );
 r_config_set_b (core->config, "asm.pseudo", 
# 239 "project/radare2/libr/core/pseudo.c" 3 4
                                            1
# 239 "project/radare2/libr/core/pseudo.c"
                                                );
 r_config_set_b (core->config, "asm.decode", 
# 240 "project/radare2/libr/core/pseudo.c" 3 4
                                            0
# 240 "project/radare2/libr/core/pseudo.c"
                                                 );
 r_config_set_b (core->config, "asm.sub.names", 
# 241 "project/radare2/libr/core/pseudo.c" 3 4
                                               1
# 241 "project/radare2/libr/core/pseudo.c"
                                                   );
 r_config_set_b (core->config, "asm.lines", 
# 242 "project/radare2/libr/core/pseudo.c" 3 4
                                           0
# 242 "project/radare2/libr/core/pseudo.c"
                                                );
 r_config_set_b (core->config, "asm.bytes", 
# 243 "project/radare2/libr/core/pseudo.c" 3 4
                                           0
# 243 "project/radare2/libr/core/pseudo.c"
                                                );
 r_config_set_b (core->config, "asm.offset", 
# 244 "project/radare2/libr/core/pseudo.c" 3 4
                                            1
# 244 "project/radare2/libr/core/pseudo.c"
                                                );
 r_config_set_b (core->config, "asm.flags", 
# 245 "project/radare2/libr/core/pseudo.c" 3 4
                                           0
# 245 "project/radare2/libr/core/pseudo.c"
                                                );
 r_config_set_b (core->config, "asm.emu", 
# 246 "project/radare2/libr/core/pseudo.c" 3 4
                                         1
# 246 "project/radare2/libr/core/pseudo.c"
                                             );
 r_config_set_b (core->config, "emu.str", 
# 247 "project/radare2/libr/core/pseudo.c" 3 4
                                         1
# 247 "project/radare2/libr/core/pseudo.c"
                                             );
 r_config_set_b (core->config, "emu.write", 
# 248 "project/radare2/libr/core/pseudo.c" 3 4
                                           1
# 248 "project/radare2/libr/core/pseudo.c"
                                               );
 r_config_set_b (core->config, "asm.lines.fcn", 
# 249 "project/radare2/libr/core/pseudo.c" 3 4
                                               0
# 249 "project/radare2/libr/core/pseudo.c"
                                                    );
 r_config_set_b (core->config, "asm.comments", 
# 250 "project/radare2/libr/core/pseudo.c" 3 4
                                              1
# 250 "project/radare2/libr/core/pseudo.c"
                                                  );
 r_config_set_b (core->config, "asm.functions", 
# 251 "project/radare2/libr/core/pseudo.c" 3 4
                                               0
# 251 "project/radare2/libr/core/pseudo.c"
                                                    );
 r_config_set_i (core->config, "asm.tabs", 0);
 r_config_set_b (core->config, "asm.section", 
# 253 "project/radare2/libr/core/pseudo.c" 3 4
                                             0
# 253 "project/radare2/libr/core/pseudo.c"
                                                  );
 r_config_set_i (core->config, "asm.cmt.col", 30);
 r_config_set_b (core->config, "io.cache", 
# 255 "project/radare2/libr/core/pseudo.c" 3 4
                                          1
# 255 "project/radare2/libr/core/pseudo.c"
                                              );
 r_core_cmd0 (core, "aeim");
 PJ *pj = 
# 257 "project/radare2/libr/core/pseudo.c" 3 4
         ((void *)0)
# 257 "project/radare2/libr/core/pseudo.c"
             ;
 if (show_json) {
 ...
 if (show_c_headers) {
  ...
  { if (pj) { r_strbuf_appendf (codestr, "// global registers\n"); } else { r_cons_printf ("// global registers\n"); }};

  { if (pj) { r_strbuf_appendf (codestr, "int stack[1024];\n"); } else { r_cons_printf ("int stack[1024];\n"); }};
  { if (pj) { r_strbuf_appendf (codestr, "unsigned long long *qword = &stack;\n"); } else { r_cons_printf ("unsigned long long *qword = &stack;\n"); }};
  { if (pj) { r_strbuf_appendf (codestr, "unsigned int *dword = &stack;\n"); } else { r_cons_printf ("unsigned int *dword = &stack;\n"); }};
  { if (pj) { r_strbuf_appendf (codestr, "unsigned short *word = &stack;\n"); } else { r_cons_printf ("unsigned short *word = &stack;\n"); }};
  { if (pj) { r_strbuf_appendf (codestr, "unsigned char *byte = &stack;\n"); } else { r_cons_printf ("unsigned char *byte = &stack;\n"); }};
  { if (pj) { r_strbuf_appendf (codestr, "int eax, ebx, ecx, edx;\n"); } else { r_cons_printf ("int eax, ebx, ecx, edx;\n"); }};
  { if (pj) { r_strbuf_appendf (codestr, "// This function contains %d basic blocks and its %d long.", n_bb, (int)r_anal_function_realsize (fcn)); } else { r_cons_printf ("// This function contains %d basic blocks and its %d long.", n_bb, (int)r_anal_function_realsize (fcn)); }}
                                             ;
  { size_t eos = 
# 291 "project/radare2/libr/core/pseudo.c" 3 4
 (((
# 291 "project/radare2/libr/core/pseudo.c"
 (indent) * 2
# 291 "project/radare2/libr/core/pseudo.c" 3 4
 )>(
# 291 "project/radare2/libr/core/pseudo.c"
...
# 291 "project/radare2/libr/core/pseudo.c" 3 4
 , 0))
# 291 "project/radare2/libr/core/pseudo.c"
 ; indentstr [(eos * 2)] = 0; if (pj) { if (show_addr) r_strbuf_appendf (codestr, "\n0x%08"
# 291 "project/radare2/libr/core/pseudo.c" 3 4
 "llx"
# 291 "project/radare2/libr/core/pseudo.c"
 " | %s", fcn->addr, indentstr); else r_strbuf_appendf (codestr, "\n%s", indentstr); } else { r_cons_newline(); if (show_addr) r_cons_printf (" 0x%08"
# 291 "project/radare2/libr/core/pseudo.c" 3 4
 "llx"
# 291 "project/radare2/libr/core/pseudo.c"
 " | %s", fcn->addr, indentstr); else r_cons_printf ("%s", indentstr); } };
  const char *S0 = "esp";
  { if (pj) { r_strbuf_appendf (codestr, "static inline void push (int reg) {%s-=%d;stack[%s]=reg;}\n", S0, (int)sizeof (int), S0); } else { r_cons_printf ("static inline void push (int reg) {%s-=%d;stack[%s]=reg;}\n", S0, (int)sizeof (int), S0); }};
  { if (pj) { r_strbuf_appendf (codestr, "static inline int pop() {int r = stack[%s]; %s+=%d; return r;}\n", S0, S0, (int)sizeof (int)); } else { r_cons_printf ("static inline int pop() {int r = stack[%s]; %s+=%d; return r;}\n", S0, S0, (int)sizeof (int)); }};
  { if (pj) { r_strbuf_appendf (codestr, "\n"); } else { r_cons_printf ("\n"); }};
 }
 { if (pj) { r_strbuf_appendf (codestr, "int %s (int esi, int edx) {", fcn->name); } else { r_cons_printf ("int %s (int esi, int edx) {", fcn->name); }};
 indent++;
 RList *visited = r_list_newf (
# 299 "project/radare2/libr/core/pseudo.c" 3 4
                              ((void *)0)
# 299 "project/radare2/libr/core/pseudo.c"
                                  );
 
# 300 "project/radare2/libr/core/pseudo.c" 3 4
unsigned long long 
# 300 "project/radare2/libr/core/pseudo.c"
     addr = fcn->addr;
 do {
  if (!bb) {
   break;
...
# 307 "project/radare2/libr/core/pseudo.c" 3 4
 _Bool 
# 307 "project/radare2/libr/core/pseudo.c"
      html = r_config_get_b (core->config, "scr.html");
  r_config_set_b (core->config, "scr.html", 
# 308 "project/radare2/libr/core/pseudo.c" 3 4
                                           0
# 308 "project/radare2/libr/core/pseudo.c"
                                                );
  char *code = r_core_cmd_str (core, sdb_fmt ("pD %"
# 309 "project/radare2/libr/core/pseudo.c" 3 4
                                                   "lld"
# 309 "project/radare2/libr/core/pseudo.c"
                                                          " @ 0x%08"
# 309 "project/radare2/libr/core/pseudo.c" 3 4
                                                                    "llx"
# 309 "project/radare2/libr/core/pseudo.c"
...
# 313 "project/radare2/libr/core/pseudo.c" 3 4
 __builtin___memset_chk (
# 313 "project/radare2/libr/core/pseudo.c"
 indentstr
# 313 "project/radare2/libr/core/pseudo.c" 3 4
 , 
# 313 "project/radare2/libr/core/pseudo.c"
...
# 315 "project/radare2/libr/core/pseudo.c" 3 4
  fprintf(__stderrp,
# 315 "project/radare2/libr/core/pseudo.c"
  "No code here\n"
# 315 "project/radare2/libr/core/pseudo.c" 3 4
  )
# 315 "project/radare2/libr/core/pseudo.c"
...
# 318 "project/radare2/libr/core/pseudo.c" 3 4
                                        1
# 318 "project/radare2/libr/core/pseudo.c"
                                            );
  const char *R0 = "eax";
  size_t len = strlen (code);
  code[len - 1] = 0;
  find_and_change (code, len);
  if (!sdb_const_get (db, sdb_fmt("mark.%"
# 323 "project/radare2/libr/core/pseudo.c" 3 4
                         "llx"
# 323 "project/radare2/libr/core/pseudo.c"
                         ,bb->addr), 0)) {
   
# 324 "project/radare2/libr/core/pseudo.c" 3 4
  _Bool 
# 324 "project/radare2/libr/core/pseudo.c"
       mustprint = !queuegoto || queuegoto != bb->addr;
   if (mustprint) {
    if (queuegoto) {
     { size_t eos = 
# 327 "project/radare2/libr/core/pseudo.c" 3 4
    (((
# 327 "project/radare2/libr/core/pseudo.c"
    (indent) * 2
# 327 "project/radare2/libr/core/pseudo.c" 3 4
    )>(
# 327 "project/radare2/libr/core/pseudo.c"
...
# 327 "project/radare2/libr/core/pseudo.c" 3 4
    "llx"
# 327 "project/radare2/libr/core/pseudo.c"
    " | %s", bb->addr, indentstr); else r_strbuf_appendf (codestr, "\n%s", indentstr); } else { r_cons_newline(); if (show_addr) r_cons_printf (" 0x%08"
# 327 "project/radare2/libr/core/pseudo.c" 3 4
    "llx"
# 327 "project/radare2/libr/core/pseudo.c"
    " | %s", bb->addr, indentstr); else r_cons_printf ("%s", indentstr); } };
     { if (pj) { r_strbuf_appendf (codestr, "goto loc_0x%"
# 328 "project/radare2/libr/core/pseudo.c" 3 4
    "llx"
# 328 "project/radare2/libr/core/pseudo.c"
    , queuegoto); } else { r_cons_printf ("goto loc_0x%"
# 328 "project/radare2/libr/core/pseudo.c" 3 4
    "llx"
# 328 "project/radare2/libr/core/pseudo.c"
    , queuegoto); }};
    ...
    { size_t eos = 
# 331 "project/radare2/libr/core/pseudo.c" 3 4
   (((
# 331 "project/radare2/libr/core/pseudo.c"
   (indent - 1) * 2
# 331 "project/radare2/libr/core/pseudo.c" 3 4
   )>(
# 331 "project/radare2/libr/core/pseudo.c"
...
# 331 "project/radare2/libr/core/pseudo.c"
   " | %s", bb->addr, indentstr); else r_cons_printf ("%s", indentstr); } };
    { if (pj) { r_strbuf_appendf (codestr, "loc_0x%"
# 332 "project/radare2/libr/core/pseudo.c" 3 4
   "llx"
# 332 "project/radare2/libr/core/pseudo.c"
   ":", bb->addr); } else { r_cons_printf ("loc_0x%"
# 332 "project/radare2/libr/core/pseudo.c" 3 4
   "llx"
# 332 "project/radare2/libr/core/pseudo.c"
   ":", bb->addr); }};
...
# 338 "project/radare2/libr/core/pseudo.c" 3 4
   if (
# 338 "project/radare2/libr/core/pseudo.c"
   lines
# 338 "project/radare2/libr/core/pseudo.c" 3 4
   ) for (
# 338 "project/radare2/libr/core/pseudo.c"
...
# 340 "project/radare2/libr/core/pseudo.c" 3 4
     unsigned long long 
# 340 "project/radare2/libr/core/pseudo.c"
          at = r_num_get (
# 340 "project/radare2/libr/core/pseudo.c" 3 4
                          ((void *)0)
# 340 "project/radare2/libr/core/pseudo.c"
                              , line);
      if (at && at != 
# 341 "project/radare2/libr/core/pseudo.c" 3 4
                     0xFFFFFFFFFFFFFFFFULL
# 341 "project/radare2/libr/core/pseudo.c"
                             ) {
       addr = at;
      }
      char *s = strchr (line, ' ');
     ...
     { size_t eos = 
# 357 "project/radare2/libr/core/pseudo.c" 3 4
    (((
# 357 "project/radare2/libr/core/pseudo.c"
    (indent) * 2
# 357 "project/radare2/libr/core/pseudo.c" 3 4
    )>(
# 357 "project/radare2/libr/core/pseudo.c"
...
# 357 "project/radare2/libr/core/pseudo.c" 3 4
    "llx"
# 357 "project/radare2/libr/core/pseudo.c"
    " | %s", addr, indentstr); else r_strbuf_appendf (codestr, "\n%s", indentstr); } else { r_cons_newline(); if (show_addr) r_cons_printf (" 0x%08"
# 357 "project/radare2/libr/core/pseudo.c" 3 4
    "llx"
# 357 "project/radare2/libr/core/pseudo.c"
    " | %s", addr, indentstr); else r_cons_printf ("%s", indentstr); } };
     { if (pj) { r_strbuf_appendf (codestr, "%s", line); } else { r_cons_printf ("%s", line); }};
    }
    r_list_free (lines);
    free (code);
    sdb_num_set (db, sdb_fmt("mark.%"
# 362 "project/radare2/libr/core/pseudo.c" 3 4
                    "llx"
# 362 "project/radare2/libr/core/pseudo.c"
                    ,bb->addr), 1, 0);
   }
  }
  if (sdb_const_get (db, sdb_fmt("loc.%"
# 365 "project/radare2/libr/core/pseudo.c" 3 4
                        "llx"
# 365 "project/radare2/libr/core/pseudo.c"
                        ,bb->addr), 0)) {



   
# 369 "project/radare2/libr/core/pseudo.c" 3 4
  unsigned long long 
# 369 "project/radare2/libr/core/pseudo.c"
       addr = sdb_array_pop_num (db, "indent", 
# 369 "project/radare2/libr/core/pseudo.c" 3 4
                                               ((void *)0)
# 369 "project/radare2/libr/core/pseudo.c"
                                                   );
   if (addr == 
# 370 "project/radare2/libr/core/pseudo.c" 3 4
              0xFFFFFFFFFFFFFFFFULL
# 370 "project/radare2/libr/core/pseudo.c"
                      ) {
    int i;
    nindent = 1;
    for (i = indent; i != nindent && i > 0; i--) {
     { size_t eos = 
# 374 "project/radare2/libr/core/pseudo.c" 3 4
    (((
# 374 "project/radare2/libr/core/pseudo.c"
    (i) * 2
# 374 "project/radare2/libr/core/pseudo.c" 3 4
    )>(
# 374 "project/radare2/libr/core/pseudo.c"
...
# 374 "project/radare2/libr/core/pseudo.c"
    " | %s", bb->addr, indentstr); else r_cons_printf ("%s", indentstr); } };
     { if (pj) { r_strbuf_appendf (codestr, "}"); } else { r_cons_printf ("}"); }};
    }
    { size_t eos = 
# 377 "project/radare2/libr/core/pseudo.c" 3 4
   (((
# 377 "project/radare2/libr/core/pseudo.c"
   (indent) * 2
# 377 "project/radare2/libr/core/pseudo.c" 3 4
   )>(
# 377 "project/radare2/libr/core/pseudo.c"
...
# 377 "project/radare2/libr/core/pseudo.c"
   " | %s", bb->addr, indentstr); else r_cons_printf ("%s", indentstr); } };
    { if (pj) { r_strbuf_appendf (codestr, "return %s;", R0); } else { r_cons_printf ("return %s;", R0); }};
    ...
    if (r_list_contains (visited, nbb)) {
     ...
     if (r_list_contains (visited, nbb)) {
      nbb = 
# 383 "project/radare2/libr/core/pseudo.c" 3 4
           ((void *)0)
# 383 "project/radare2/libr/core/pseudo.c"
               ;
     }
    }
    if (!nbb) {
   ...
   if (sdb_num_get (db, sdb_fmt("else.%"
# 393 "project/radare2/libr/core/pseudo.c" 3 4
                       "llx"
# 393 "project/radare2/libr/core/pseudo.c"
                       ,bb->addr), 0)) {
    { size_t eos = 
# 394 "project/radare2/libr/core/pseudo.c" 3 4
   (((
# 394 "project/radare2/libr/core/pseudo.c"
   (indent) * 2
# 394 "project/radare2/libr/core/pseudo.c" 3 4
   )>(
# 394 "project/radare2/libr/core/pseudo.c"
...
# 394 "project/radare2/libr/core/pseudo.c"
   " | %s", addr, indentstr); else r_cons_printf ("%s", indentstr); } };
    if (!strcmp (blocktype, "else")) {
     { if (pj) { r_strbuf_appendf (codestr, " // } %s {", blocktype); } else { r_cons_printf (" // } %s {", blocktype); }};
    } else {
     { if (pj) { r_strbuf_appendf (codestr, " // } %s (?);", blocktype); } else { r_cons_printf (" // } %s (?);", blocktype); }};
    }
   } else {
    { size_t eos = 
# 401 "project/radare2/libr/core/pseudo.c" 3 4
   (((
# 401 "project/radare2/libr/core/pseudo.c"
   (indent) * 2
# 401 "project/radare2/libr/core/pseudo.c" 3 4
   )>(
# 401 "project/radare2/libr/core/pseudo.c"
...
# 410 "project/radare2/libr/core/pseudo.c" 3 4
   fprintf(__stderrp,
# 410 "project/radare2/libr/core/pseudo.c"
   "failed block\n"
# 410 "project/radare2/libr/core/pseudo.c" 3 4
   )
# 410 "project/radare2/libr/core/pseudo.c"
   ...
   nindent = sdb_num_get (db, sdb_fmt("loc.%"
# 413 "project/radare2/libr/core/pseudo.c" 3 4
                             "llx"
# 413 "project/radare2/libr/core/pseudo.c"
                             ,addr), 
# 413 "project/radare2/libr/core/pseudo.c" 3 4
                                              ((void *)0)
# 413 "project/radare2/libr/core/pseudo.c"
   ...
   if (indent > nindent && !strcmp (blocktype, "else")) {
    ...
    for (i = indent; i != nindent; i--) {
     { size_t eos = 
# 417 "project/radare2/libr/core/pseudo.c" 3 4
    (((
# 417 "project/radare2/libr/core/pseudo.c"
    (i) * 2
# 417 "project/radare2/libr/core/pseudo.c" 3 4
    )>(
# 417 "project/radare2/libr/core/pseudo.c"
...
# 417 "project/radare2/libr/core/pseudo.c"
   ...
   sdb_set (db, sdb_fmt("loc.%"
# 423 "project/radare2/libr/core/pseudo.c" 3 4
               "llx"
# 423 "project/radare2/libr/core/pseudo.c"
               ,bb->addr), "passed", 0);
   if (bb->jump != 
# 424 "project/radare2/libr/core/pseudo.c" 3 4
                  0xFFFFFFFFFFFFFFFFULL
# 424 "project/radare2/libr/core/pseudo.c"
                          ) {
    int swap = 1;

    
# 427 "project/radare2/libr/core/pseudo.c" 3 4
   unsigned long long 
# 427 "project/radare2/libr/core/pseudo.c"
        jump = swap ? bb->jump : bb->fail;
    
# 428 "project/radare2/libr/core/pseudo.c" 3 4
   unsigned long long 
# 428 "project/radare2/libr/core/pseudo.c"
        fail = swap ? bb->fail : bb->jump;

    RAnalFunction *curfcn = r_anal_get_fcn_in (core->anal, jump, R_ANAL_FCN_TYPE_NULL);
    if (curfcn != fcn) {

     { size_t eos = 
# 433 "project/radare2/libr/core/pseudo.c" 3 4
    (((
# 433 "project/radare2/libr/core/pseudo.c"
    (indent) * 2
# 433 "project/radare2/libr/core/pseudo.c" 3 4
    )>(
# 433 "project/radare2/libr/core/pseudo.c"
...
# 433 "project/radare2/libr/core/pseudo.c" 3 4
    "llx"
# 433 "project/radare2/libr/core/pseudo.c"
    " | %s", jump, indentstr); else r_strbuf_appendf (codestr, "\n%s", indentstr); } else { r_cons_newline(); if (show_addr) r_cons_printf (" 0x%08"
# 433 "project/radare2/libr/core/pseudo.c" 3 4
    "llx"
# 433 "project/radare2/libr/core/pseudo.c"
    " | %s", jump, indentstr); else r_cons_printf ("%s", indentstr); } };
     { if (pj) { r_strbuf_appendf (codestr, "// chop"); } else { r_cons_printf ("// chop"); }};

    }
    if (sdb_get (db, sdb_fmt("loc.%"
# 437 "project/radare2/libr/core/pseudo.c" 3 4
                    "llx"
# 437 "project/radare2/libr/core/pseudo.c"
                    ,jump), 0)) {

     if (!sdb_get (db, sdb_fmt("loc.%"
# 439 "project/radare2/libr/core/pseudo.c" 3 4
                      "llx"
# 439 "project/radare2/libr/core/pseudo.c"
                      ,fail), 0)) {
      bb = r_anal_bb_from_offset (core->anal, fail);
     } else {
      
# 442 "project/radare2/libr/core/pseudo.c" 3 4
     fprintf(__stderrp,
# 442 "project/radare2/libr/core/pseudo.c"
     " // FAIL%c", 10
# 442 "project/radare2/libr/core/pseudo.c" 3 4
     )
# 442 "project/radare2/libr/core/pseudo.c"
...
# 447 "project/radare2/libr/core/pseudo.c" 3 4
     fprintf(__stderrp,
# 447 "project/radare2/libr/core/pseudo.c"
     "failed to retrieve block at 0x%"
# 447 "project/radare2/libr/core/pseudo.c" 3 4
     "llx"
# 447 "project/radare2/libr/core/pseudo.c"
     "\n", jump
...
# 447 "project/radare2/libr/core/pseudo.c"
     ...
     if (fail != 
# 450 "project/radare2/libr/core/pseudo.c" 3 4
                0xFFFFFFFFFFFFFFFFULL
# 450 "project/radare2/libr/core/pseudo.c"
                        ) {

      indent++;
      if (sdb_get (db, sdb_fmt("loc.%"
# 453 "project/radare2/libr/core/pseudo.c" 3 4
                      "llx"
# 453 "project/radare2/libr/core/pseudo.c"
                      ,bb->fail), 0)) {

       
# 455 "project/radare2/libr/core/pseudo.c" 3 4
      fprintf(__stderrp,
# 455 "project/radare2/libr/core/pseudo.c"
      "BlockAlready 0x%"
# 455 "project/radare2/libr/core/pseudo.c" 3 4
      "llx"
# 455 "project/radare2/libr/core/pseudo.c"
...
# 455 "project/radare2/libr/core/pseudo.c"
       ...
       sdb_num_set (db, sdb_fmt("loc.%"
# 459 "project/radare2/libr/core/pseudo.c" 3 4
                       "llx"
# 459 "project/radare2/libr/core/pseudo.c"
                       ,fail), indent, 0);
       sdb_num_set (db, sdb_fmt("else.%"
# 460 "project/radare2/libr/core/pseudo.c" 3 4
                       "llx"
# 460 "project/radare2/libr/core/pseudo.c"
                       ,fail), 1, 0);
       { size_t eos = 
# 461 "project/radare2/libr/core/pseudo.c" 3 4
      (((
# 461 "project/radare2/libr/core/pseudo.c"
      (indent) * 2
# 461 "project/radare2/libr/core/pseudo.c" 3 4
      )>(
# 461 "project/radare2/libr/core/pseudo.c"
...
# 461 "project/radare2/libr/core/pseudo.c"
      ...
      sdb_num_set (db, sdb_fmt("loc.%"
# 465 "project/radare2/libr/core/pseudo.c" 3 4
                      "llx"
# 465 "project/radare2/libr/core/pseudo.c"
                      ,jump), indent, 0);
      sdb_num_set (db, sdb_fmt("else.%"
# 466 "project/radare2/libr/core/pseudo.c" 3 4
                      "llx"
# 466 "project/radare2/libr/core/pseudo.c"
                      ,jump), 1, 0);
      if (jump <= bb->addr) {
       blocktype = "while";
      } else {
      ...
      { size_t eos = 
# 472 "project/radare2/libr/core/pseudo.c" 3 4
     (((
# 472 "project/radare2/libr/core/pseudo.c"
     (indent) * 2
# 472 "project/radare2/libr/core/pseudo.c" 3 4
     )>(
# 472 "project/radare2/libr/core/pseudo.c"
...
# 472 "project/radare2/libr/core/pseudo.c"
     " | %s", bb->addr, indentstr); else r_cons_printf ("%s", indentstr); } };
      { if (pj) { r_strbuf_appendf (codestr, " // do {"); } else { r_cons_printf (" // do {"); }};
      indent++;
     }
    }
   } else {
    
# 478 "project/radare2/libr/core/pseudo.c" 3 4
   unsigned long long 
# 478 "project/radare2/libr/core/pseudo.c"
        addr = sdb_array_pop_num (db, "indent", 
# 478 "project/radare2/libr/core/pseudo.c" 3 4
                                                ((void *)0)
# 478 "project/radare2/libr/core/pseudo.c"
    ...
    if (addr == 
# 479 "project/radare2/libr/core/pseudo.c" 3 4
               0xFFFFFFFFFFFFFFFFULL
# 479 "project/radare2/libr/core/pseudo.c"
                       ) {
     { size_t eos = 
# 480 "project/radare2/libr/core/pseudo.c" 3 4
    (((
# 480 "project/radare2/libr/core/pseudo.c"
    (indent) * 2
# 480 "project/radare2/libr/core/pseudo.c" 3 4
    )>(
# 480 "project/radare2/libr/core/pseudo.c"
...
# 480 "project/radare2/libr/core/pseudo.c"
    " | %s", bb->addr, indentstr); else r_cons_printf ("%s", indentstr); } };
     { if (pj) { r_strbuf_appendf (codestr, " // (break)"); } else { r_cons_printf (" // (break)"); }};
     break;
    }
    bb = r_anal_bb_from_offset (core->anal, addr);
    nindent = sdb_num_get (db, sdb_fmt("loc.%"
# 485 "project/radare2/libr/core/pseudo.c" 3 4
                              "llx"
# 485 "project/radare2/libr/core/pseudo.c"
                              ,addr), 
# 485 "project/radare2/libr/core/pseudo.c" 3 4
                                               ((void *)0)
# 485 "project/radare2/libr/core/pseudo.c"
    ...
    if (indent > nindent) {
     ...
     for (i = indent; i != nindent; i--) {
      { size_t eos = 
# 489 "project/radare2/libr/core/pseudo.c" 3 4
     (((
# 489 "project/radare2/libr/core/pseudo.c"
     (i) * 2
# 489 "project/radare2/libr/core/pseudo.c" 3 4
     )>(
# 489 "project/radare2/libr/core/pseudo.c"
...
# 489 "project/radare2/libr/core/pseudo.c"
    ...
    if (nindent != indent) {
     { size_t eos = 
# 494 "project/radare2/libr/core/pseudo.c" 3 4
    (((
# 494 "project/radare2/libr/core/pseudo.c"
    (indent) * 2
# 494 "project/radare2/libr/core/pseudo.c" 3 4
    )>(
# 494 "project/radare2/libr/core/pseudo.c"
...
# 494 "project/radare2/libr/core/pseudo.c"
    " | %s", bb->addr, indentstr); else r_cons_printf ("%s", indentstr); } };
     { if (pj) { r_strbuf_appendf (codestr, " // } else {"); } else { r_cons_printf (" // } else {"); }};
    }
    indent = nindent;
   }
  }
...
# 504 "project/radare2/libr/core/pseudo.c" 3 4
if (
# 504 "project/radare2/libr/core/pseudo.c"
fcn->bbs
# 504 "project/radare2/libr/core/pseudo.c" 3 4
) for (
# 504 "project/radare2/libr/core/pseudo.c"
...
# 504 "project/radare2/libr/core/pseudo.c"
  ...
  if (!r_list_contains (visited, bb)) {
   orphan ++;
   char *s = r_core_cmd_strf (core, "pdb@0x%08"
# 507 "project/radare2/libr/core/pseudo.c" 3 4
                                              "llx"
# 507 "project/radare2/libr/core/pseudo.c"
                                                     "@e:asm.offset=0", bb->addr);
   s = r_str_replace (s, ";", "//", 
# 508 "project/radare2/libr/core/pseudo.c" 3 4
                                   1
# 508 "project/radare2/libr/core/pseudo.c"
                                       );
   ...
   { size_t eos = 
# 521 "project/radare2/libr/core/pseudo.c" 3 4
  (((
# 521 "project/radare2/libr/core/pseudo.c"
  (1) * 2
# 521 "project/radare2/libr/core/pseudo.c" 3 4
  )>(
# 521 "project/radare2/libr/core/pseudo.c"
...
# 521 "project/radare2/libr/core/pseudo.c"
  " | %s", bb->addr, indentstr); else r_cons_printf ("%s", indentstr); } };
   { if (pj) { r_strbuf_appendf (codestr, "loc_0x%08"
# 522 "project/radare2/libr/core/pseudo.c" 3 4
  "llx"
# 522 "project/radare2/libr/core/pseudo.c"
  ": // orphan\n%s", bb->addr, s); } else { r_cons_printf ("loc_0x%08"
# 522 "project/radare2/libr/core/pseudo.c" 3 4
  "llx"
# 522 "project/radare2/libr/core/pseudo.c"
  ": // orphan\n%s", bb->addr, s); }};
 ...
 indent = 0;
 { size_t eos = 
# 528 "project/radare2/libr/core/pseudo.c" 3 4
(((
# 528 "project/radare2/libr/core/pseudo.c"
(indent) * 2
# 528 "project/radare2/libr/core/pseudo.c" 3 4
)>(
# 528 "project/radare2/libr/core/pseudo.c"
...
" | %s", addr, indentstr); else r_cons_printf ("%s", indentstr); } };
 ...
 sdb_free (db);
 return 
# 543 "project/radare2/libr/core/pseudo.c" 3 4
       1
# 543 "project/radare2/libr/core/pseudo.c"
           ;
}
