# 0 "project/radare2/libr/core/anal_tp.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 5 "project/radare2/libr/core/anal_tp.c" 2
...
# 7 "project/radare2/libr/core/anal_tp.c" 2



# 9 "project/radare2/libr/core/anal_tp.c"
static 
# 9 "project/radare2/libr/core/anal_tp.c" 3 4
      _Bool 
# 9 "project/radare2/libr/core/anal_tp.c"
           anal_emul_init(RCore *core, RConfigHold *hc, RDebugTrace **dt, RAnalEsilTrace **et) {
 if (!core->anal->esil) {
  return 
# 11 "project/radare2/libr/core/anal_tp.c" 3 4
        0
# 11 "project/radare2/libr/core/anal_tp.c"
             ;
 }
 *dt = core->dbg->trace;
 *et = core->anal->esil->trace;
 ...
 r_config_hold (hc, "esil.romem", "dbg.trace", "esil.nonull", "dbg.follow", 
# 17 "project/radare2/libr/core/anal_tp.c" 3 4
                                                                           ((void *)0)
# 17 "project/radare2/libr/core/anal_tp.c"
                                                                               );
 r_config_set (core->config, "esil.romem", "true");
 r_config_set (core->config, "dbg.trace", "true");
 r_config_set (core->config, "esil.nonull", "true");
 r_config_set_i (core->config, "dbg.follow", 
# 21 "project/radare2/libr/core/anal_tp.c" 3 4
                                            0
# 21 "project/radare2/libr/core/anal_tp.c"
                                                 );
 const char *bp = r_reg_get_name (core->anal->reg, R_REG_NAME_BP);
 const char *sp = r_reg_get_name (core->anal->reg, R_REG_NAME_SP);
 if ((bp && !r_reg_getv (core->anal->reg, bp)) && (sp && !r_reg_getv (core->anal->reg, sp))) {
  
# 25 "project/radare2/libr/core/anal_tp.c" 3 4
 fprintf(__stderrp,
# 25 "project/radare2/libr/core/anal_tp.c"
...
# 26 "project/radare2/libr/core/anal_tp.c" 3 4
 fprintf(__stderrp,
# 26 "project/radare2/libr/core/anal_tp.c"
...
# 26 "project/radare2/libr/core/anal_tp.c"
                                                                                            ;
  return 
# 27 "project/radare2/libr/core/anal_tp.c" 3 4
        0
# 27 "project/radare2/libr/core/anal_tp.c"
             ;
 }
...
static 
# 43 "project/radare2/libr/core/anal_tp.c" 3 4
      _Bool 
# 43 "project/radare2/libr/core/anal_tp.c"
           type_pos_hit(RAnal *anal, Sdb *trace, 
# 43 "project/radare2/libr/core/anal_tp.c" 3 4
                                                 _Bool 
# 43 "project/radare2/libr/core/anal_tp.c"
                                                      in_stack, int idx, int size, const char *place) {
 if (in_stack) {
  const char *sp_name = r_reg_get_name (anal->reg, R_REG_NAME_SP);
  
# 46 "project/radare2/libr/core/anal_tp.c" 3 4
 unsigned long long 
# 46 "project/radare2/libr/core/anal_tp.c"
      sp = r_reg_getv (anal->reg, sp_name);
  
# 47 "project/radare2/libr/core/anal_tp.c" 3 4
 unsigned long long 
# 47 "project/radare2/libr/core/anal_tp.c"
      write_addr = sdb_num_get (trace, sdb_fmt ("%d.mem.write", idx), 0);
  return (write_addr == sp + size);
 }
 return sdb_array_contains (trace, sdb_fmt ("%d.reg.write", idx), place, 0);
}

static void __var_rename(RAnal *anal, RAnalVar *v, const char *name, 
# 53 "project/radare2/libr/core/anal_tp.c" 3 4
                                                                    unsigned long long 
# 53 "project/radare2/libr/core/anal_tp.c"
                                                                         addr) {
 if (!name || !v) {
  return;
 }
...
# 60 "project/radare2/libr/core/anal_tp.c" 3 4
_Bool 
# 60 "project/radare2/libr/core/anal_tp.c"
     is_default = (r_str_startswith (v->name, 
# 60 "project/radare2/libr/core/anal_tp.c" 3 4
                                              "var"
# 60 "project/radare2/libr/core/anal_tp.c"
                                                       )
   || r_str_startswith (v->name, 
# 61 "project/radare2/libr/core/anal_tp.c" 3 4
                                "arg"
# 61 "project/radare2/libr/core/anal_tp.c"
                                         ));
 if (*name == '*') {
  name++;
 }
 ...
 r_anal_var_rename (v, name, 
# 73 "project/radare2/libr/core/anal_tp.c" 3 4
                            0
# 73 "project/radare2/libr/core/anal_tp.c"
                                 );
}

static void __var_retype(RAnal *anal, RAnalVar *var, const char *vname, const char *type, 
# 76 "project/radare2/libr/core/anal_tp.c" 3 4
                                                                                         _Bool 
# 76 "project/radare2/libr/core/anal_tp.c"
                                                                                              ref, 
# 76 "project/radare2/libr/core/anal_tp.c" 3 4
                                                                                                   _Bool 
# 76 "project/radare2/libr/core/anal_tp.c"
...
# 77 "project/radare2/libr/core/anal_tp.c" 3 4
do { if (!(
# 77 "project/radare2/libr/core/anal_tp.c"
anal && var && type
# 77 "project/radare2/libr/core/anal_tp.c" 3 4
...
# 84 "project/radare2/libr/core/anal_tp.c" 3 4
_Bool 
# 84 "project/radare2/libr/core/anal_tp.c"
     is_ptr = (vname && *vname == '*');
...
# 99 "project/radare2/libr/core/anal_tp.c" 3 4
_Bool 
# 99 "project/radare2/libr/core/anal_tp.c"
     is_default = tmp != 
# 99 "project/radare2/libr/core/anal_tp.c" 3 4
                         ((void *)0)
# 99 "project/radare2/libr/core/anal_tp.c"
...
static void get_src_regname(RCore *core, 
# 145 "project/radare2/libr/core/anal_tp.c" 3 4
                                        unsigned long long 
# 145 "project/radare2/libr/core/anal_tp.c"
                                             addr, char *regname, int size) {
...
# 157 "project/radare2/libr/core/anal_tp.c" 3 4
__builtin___memset_chk (
# 157 "project/radare2/libr/core/anal_tp.c"
regname
# 157 "project/radare2/libr/core/anal_tp.c" 3 4
, 
# 157 "project/radare2/libr/core/anal_tp.c"
...
# 167 "project/radare2/libr/core/anal_tp.c" 3 4
 __builtin___strncpy_chk (
# 167 "project/radare2/libr/core/anal_tp.c"
 regname
# 167 "project/radare2/libr/core/anal_tp.c" 3 4
 , 
# 167 "project/radare2/libr/core/anal_tp.c"
...
static 
# 173 "project/radare2/libr/core/anal_tp.c" 3 4
      unsigned long long 
# 173 "project/radare2/libr/core/anal_tp.c"
           get_addr(Sdb *trace, const char *regname, int idx) {
 if (!regname || !*regname) {
  return 
# 175 "project/radare2/libr/core/anal_tp.c" 3 4
        0xFFFFFFFFFFFFFFFFULL
# 175 "project/radare2/libr/core/anal_tp.c"
                ;
 }
 const char *query = sdb_fmt ("%d.reg.read.%s", idx, regname);
 return r_num_math (
# 178 "project/radare2/libr/core/anal_tp.c" 3 4
                   ((void *)0)
# 178 "project/radare2/libr/core/anal_tp.c"
...
# 193 "project/radare2/libr/core/anal_tp.c" 3 4
  fprintf(__stderrp,
# 193 "project/radare2/libr/core/anal_tp.c"
  "Unhandled conditional swap\n"
# 193 "project/radare2/libr/core/anal_tp.c" 3 4
  )
# 193 "project/radare2/libr/core/anal_tp.c"
                                          ;
...
static RList *parse_format(RCore *core, char *fmt) {
 if (!fmt || !*fmt) {
  return 
# 204 "project/radare2/libr/core/anal_tp.c" 3 4
        ((void *)0)
# 204 "project/radare2/libr/core/anal_tp.c"
            ;
 }
 RList *ret = r_list_new ();
 if (!ret) {
  return 
# 208 "project/radare2/libr/core/anal_tp.c" 3 4
        ((void *)0)
# 208 "project/radare2/libr/core/anal_tp.c"
            ;
 }
 ...
 while (ptr) {
  ...
  while (
# 218 "project/radare2/libr/core/anal_tp.c" 3 4
        ((
# 218 "project/radare2/libr/core/anal_tp.c"
        *ptr
# 218 "project/radare2/libr/core/anal_tp.c" 3 4
        ) >= '0' && (
# 218 "project/radare2/libr/core/anal_tp.c"
...
# 218 "project/radare2/libr/core/anal_tp.c"
  ...
  char *tmp = arr;
  while (tmp && (
# 223 "project/radare2/libr/core/anal_tp.c" 3 4
                ((
# 223 "project/radare2/libr/core/anal_tp.c"
                *tmp
# 223 "project/radare2/libr/core/anal_tp.c" 3 4
                ) >= 'a' && (
# 223 "project/radare2/libr/core/anal_tp.c"
...
static void retype_callee_arg(RAnal *anal, const char *callee_name, 
# 237 "project/radare2/libr/core/anal_tp.c" 3 4
                                                                   _Bool 
# 237 "project/radare2/libr/core/anal_tp.c"
                                                                        in_stack, const char *place, int size, const char *type) {
 ...
 if (in_stack) {
  ...
  __var_retype (anal, var, 
# 247 "project/radare2/libr/core/anal_tp.c" 3 4
                          ((void *)0)
# 247 "project/radare2/libr/core/anal_tp.c"
                              , type, 
# 247 "project/radare2/libr/core/anal_tp.c" 3 4
                                      0
# 247 "project/radare2/libr/core/anal_tp.c"
...
# 247 "project/radare2/libr/core/anal_tp.c"
  ...
  char *t = strdup (type);
  __var_retype (anal, rvar, 
# 258 "project/radare2/libr/core/anal_tp.c" 3 4
                           ((void *)0)
# 258 "project/radare2/libr/core/anal_tp.c"
                               , type, 
# 258 "project/radare2/libr/core/anal_tp.c" 3 4
                                       0
# 258 "project/radare2/libr/core/anal_tp.c"
...
# 258 "project/radare2/libr/core/anal_tp.c"
  ...
  if (lvar) {
   __var_retype (anal, lvar, 
# 261 "project/radare2/libr/core/anal_tp.c" 3 4
                            ((void *)0)
# 261 "project/radare2/libr/core/anal_tp.c"
                                , t, 
# 261 "project/radare2/libr/core/anal_tp.c" 3 4
                                     0
# 261 "project/radare2/libr/core/anal_tp.c"
...
static void type_match(RCore *core, char *fcn_name, 
# 282 "project/radare2/libr/core/anal_tp.c" 3 4
                                                   unsigned long long 
# 282 "project/radare2/libr/core/anal_tp.c"
                                                        addr, 
# 282 "project/radare2/libr/core/anal_tp.c" 3 4
...
# 282 "project/radare2/libr/core/anal_tp.c"
                                                                   baddr, const char* cc,
  int prev_idx, 
# 283 "project/radare2/libr/core/anal_tp.c" 3 4
               _Bool 
# 283 "project/radare2/libr/core/anal_tp.c"
                    userfnc, 
# 283 "project/radare2/libr/core/anal_tp.c" 3 4
                             unsigned long long 
# 283 "project/radare2/libr/core/anal_tp.c"
 ...
 RAnal *anal = core->anal;
 RList *types = 
# 287 "project/radare2/libr/core/anal_tp.c" 3 4
               ((void *)0)
# 287 "project/radare2/libr/core/anal_tp.c"
                   ;
 int idx = sdb_num_get (trace, "idx", 0);
 
# 289 "project/radare2/libr/core/anal_tp.c" 3 4
_Bool 
# 289 "project/radare2/libr/core/anal_tp.c"
     verbose = r_config_get_b (core->config, "anal.types.verbose");
 
# 290 "project/radare2/libr/core/anal_tp.c" 3 4
_Bool 
# 290 "project/radare2/libr/core/anal_tp.c"
     stack_rev = 
# 290 "project/radare2/libr/core/anal_tp.c" 3 4
                 0
# 290 "project/radare2/libr/core/anal_tp.c"
...
# 290 "project/radare2/libr/core/anal_tp.c"
 ...
 const char *place = r_anal_cc_arg (anal, cc, 
# 296 "project/radare2/libr/core/anal_tp.c" 3 4
                                             0x7FFFFFFF
# 296 "project/radare2/libr/core/anal_tp.c"
                                                     );
 r_cons_break_push (
# 297 "project/radare2/libr/core/anal_tp.c" 3 4
                   ((void *)0)
# 297 "project/radare2/libr/core/anal_tp.c"
                       , 
# 297 "project/radare2/libr/core/anal_tp.c" 3 4
                         ((void *)0)
# 297 "project/radare2/libr/core/anal_tp.c"
 ...
 if (place && !strcmp (place, "stack_rev")) {
  stack_rev = 
# 300 "project/radare2/libr/core/anal_tp.c" 3 4
             1
# 300 "project/radare2/libr/core/anal_tp.c"
                 ;
 }
 place = r_anal_cc_arg (anal, cc, 0);
 if (place && r_str_startswith ("stack", place)) {
  in_stack = 
# 304 "project/radare2/libr/core/anal_tp.c" 3 4
            1
# 304 "project/radare2/libr/core/anal_tp.c"
                ;
 }
 if (verbose && !strncmp (fcn_name, "sym.imp.", 8)) {
  
# 307 "project/radare2/libr/core/anal_tp.c" 3 4
 fprintf(__stderrp,
# 307 "project/radare2/libr/core/anal_tp.c"
 "Warning: Missing function definition for '%s'\n", fcn_name + 8
# 307 "project/radare2/libr/core/anal_tp.c" 3 4
 )
# 307 "project/radare2/libr/core/anal_tp.c"
                                                                          ;
 ...
 for (i = 0; i < max; i++) {
  ...
  char *type = 
# 322 "project/radare2/libr/core/anal_tp.c" 3 4
              ((void *)0)
# 322 "project/radare2/libr/core/anal_tp.c"
                  ;
  const char *name = 
# 323 "project/radare2/libr/core/anal_tp.c" 3 4
                    ((void *)0)
# 323 "project/radare2/libr/core/anal_tp.c"
                        ;
  if (format) {
   if (
# 325 "project/radare2/libr/core/anal_tp.c" 3 4
      (!(
# 325 "project/radare2/libr/core/anal_tp.c"
      types
# 325 "project/radare2/libr/core/anal_tp.c" 3 4
      ) || !(
# 325 "project/radare2/libr/core/anal_tp.c"
...
# 325 "project/radare2/libr/core/anal_tp.c"
  ...
  if (!in_stack) {
   ...
   if (place && r_str_startswith ("stack", place)) {
    in_stack = 
# 340 "project/radare2/libr/core/anal_tp.c" 3 4
              1
# 340 "project/radare2/libr/core/anal_tp.c"
                  ;
   }
  }
  char regname[10] = {0};
  
# 344 "project/radare2/libr/core/anal_tp.c" 3 4
 unsigned long long 
# 344 "project/radare2/libr/core/anal_tp.c"
      xaddr = 
# 344 "project/radare2/libr/core/anal_tp.c" 3 4
              0xFFFFFFFFFFFFFFFFULL
# 344 "project/radare2/libr/core/anal_tp.c"
...
# 345 "project/radare2/libr/core/anal_tp.c" 3 4
 _Bool 
# 345 "project/radare2/libr/core/anal_tp.c"
      memref = 
# 345 "project/radare2/libr/core/anal_tp.c" 3 4
               0
# 345 "project/radare2/libr/core/anal_tp.c"
...
# 346 "project/radare2/libr/core/anal_tp.c" 3 4
 _Bool 
# 346 "project/radare2/libr/core/anal_tp.c"
      cmt_set = 
# 346 "project/radare2/libr/core/anal_tp.c" 3 4
                0
# 346 "project/radare2/libr/core/anal_tp.c"
...
# 347 "project/radare2/libr/core/anal_tp.c" 3 4
 _Bool 
# 347 "project/radare2/libr/core/anal_tp.c"
      res = 
# 347 "project/radare2/libr/core/anal_tp.c" 3 4
            0
# 347 "project/radare2/libr/core/anal_tp.c"
...
# 350 "project/radare2/libr/core/anal_tp.c" 3 4
  unsigned long long 
# 350 "project/radare2/libr/core/anal_tp.c"
       instr_addr = sdb_num_get (trace, sdb_fmt ("%d.addr", j), 0);
   if (instr_addr < baddr) {
    break;
   }
   ...
   if (type_pos_hit (anal, trace, in_stack, j, size, place)) {
    if (!cmt_set && type && name) {
     ...
     cmt_set = 
# 376 "project/radare2/libr/core/anal_tp.c" 3 4
              1
# 376 "project/radare2/libr/core/anal_tp.c"
                  ;
     if ((op->ptr && op->ptr != 
# 377 "project/radare2/libr/core/anal_tp.c" 3 4
                               0xFFFFFFFFFFFFFFFFULL
# 377 "project/radare2/libr/core/anal_tp.c"
                                       ) && !strcmp (name, "format")) {
      RFlagItem *f = r_flag_get_by_spaces (core->flags, op->ptr, 
# 378 "project/radare2/libr/core/anal_tp.c" 3 4
                                                                "strings"
# 378 "project/radare2/libr/core/anal_tp.c"
                                                                                  , 
# 378 "project/radare2/libr/core/anal_tp.c" 3 4
                                                                                    ((void *)0)
# 378 "project/radare2/libr/core/anal_tp.c"
      ...
      if (f) {
       ...
       int read = r_io_nread_at (core->io, f->offset, (
# 381 "project/radare2/libr/core/anal_tp.c" 3 4
                                                      unsigned char 
# 381 "project/radare2/libr/core/anal_tp.c"
                                                          *)formatstr, 
# 381 "project/radare2/libr/core/anal_tp.c" 3 4
                                                                       (((
# 381 "project/radare2/libr/core/anal_tp.c"
...
# 381 "project/radare2/libr/core/anal_tp.c"
       ...
       if (read > 0) {
        ...
        format = 
# 387 "project/radare2/libr/core/anal_tp.c" 3 4
                1
# 387 "project/radare2/libr/core/anal_tp.c"
                    ;
       }
      }
     }
    ...
    if (var) {
     if (!userfnc) {
      ...
      __var_retype (anal, var, name, type, memref, 
# 395 "project/radare2/libr/core/anal_tp.c" 3 4
                                                  0
# 395 "project/radare2/libr/core/anal_tp.c"
                                                       );
     ...
     res = 
# 401 "project/radare2/libr/core/anal_tp.c" 3 4
          1
# 401 "project/radare2/libr/core/anal_tp.c"
              ;
    } else {
   ...
   if (!res && *regname && sdb_array_contains (trace, sdb_fmt ("%d.reg.write", j), regname, 0)) {
    if (var) {
     if (!userfnc) {

      __var_retype (anal, var, name, type, memref, 
# 412 "project/radare2/libr/core/anal_tp.c" 3 4
                                                  0
# 412 "project/radare2/libr/core/anal_tp.c"
                                                       );
      __var_rename (anal, var, name, addr);
     } else {
     ...
     res = 
# 418 "project/radare2/libr/core/anal_tp.c" 3 4
          1
# 418 "project/radare2/libr/core/anal_tp.c"
              ;
    } else {
     switch (op->type) {
     ...
     case R_ANAL_OP_TYPE_STORE:
      res = 
# 428 "project/radare2/libr/core/anal_tp.c" 3 4
           1
# 428 "project/radare2/libr/core/anal_tp.c"
               ;
      break;
     }
    }
   } else if (var && res && xaddr && (xaddr != 
# 432 "project/radare2/libr/core/anal_tp.c" 3 4
                                              0xFFFFFFFFFFFFFFFFULL
# 432 "project/radare2/libr/core/anal_tp.c"
                                                      )) {
    char tmp[10] = {0};
    get_src_regname (core, instr_addr, tmp, sizeof (tmp));
    
# 435 "project/radare2/libr/core/anal_tp.c" 3 4
   unsigned long long 
# 435 "project/radare2/libr/core/anal_tp.c"
        ptr = get_addr (trace, tmp, j);
    if (ptr == xaddr) {
     __var_retype (anal, var, name, r_str_get_fail (type, "int"), memref, 
# 437 "project/radare2/libr/core/anal_tp.c" 3 4
                                                                         0
# 437 "project/radare2/libr/core/anal_tp.c"
                                                                              );
    }
   }
   r_anal_op_free (op);
...
static 
# 456 "project/radare2/libr/core/anal_tp.c" 3 4
      _Bool 
# 456 "project/radare2/libr/core/anal_tp.c"
           fast_step(RCore *core, RAnalOp *aop) {

 return r_core_esil_step (core, 
# 458 "project/radare2/libr/core/anal_tp.c" 3 4
                               0xFFFFFFFFFFFFFFFFULL
# 458 "project/radare2/libr/core/anal_tp.c"
                                       , 
# 458 "project/radare2/libr/core/anal_tp.c" 3 4
                                         ((void *)0)
# 458 "project/radare2/libr/core/anal_tp.c"
...
# 502 "project/radare2/libr/core/anal_tp.c"
}


# 504 "project/radare2/libr/core/anal_tp.c" 3 4
__attribute__((visibility("default"))) 
# 504 "project/radare2/libr/core/anal_tp.c"
     void r_core_anal_type_match(RCore *core, RAnalFunction *fcn) {
 RAnalBlock *bb;
 RListIter *it;
 RAnalOp aop = {0};
 
# 508 "project/radare2/libr/core/anal_tp.c" 3 4
_Bool 
# 508 "project/radare2/libr/core/anal_tp.c"
     resolved = 
# 508 "project/radare2/libr/core/anal_tp.c" 3 4
                0
# 508 "project/radare2/libr/core/anal_tp.c"
...
# 510 "project/radare2/libr/core/anal_tp.c" 3 4
do { if (!(
# 510 "project/radare2/libr/core/anal_tp.c"
core && core->anal && fcn
# 510 "project/radare2/libr/core/anal_tp.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 510 "project/radare2/libr/core/anal_tp.c"
...
# 513 "project/radare2/libr/core/anal_tp.c" 3 4
 fprintf(__stderrp,
# 513 "project/radare2/libr/core/anal_tp.c"
 "Please run aeim\n"
# 513 "project/radare2/libr/core/anal_tp.c" 3 4
 )
# 513 "project/radare2/libr/core/anal_tp.c"
...
# 519 "project/radare2/libr/core/anal_tp.c" 3 4
_Bool 
# 519 "project/radare2/libr/core/anal_tp.c"
     chk_constraint = r_config_get_b (core->config, "anal.types.constraint");
 int ret;
 const int mininstrsz = r_anal_archinfo (anal, 
# 521 "project/radare2/libr/core/anal_tp.c" 3 4
                                              0
# 521 "project/radare2/libr/core/anal_tp.c"
                                                                         );
 const int minopcode = 
# 522 "project/radare2/libr/core/anal_tp.c" 3 4
                      (((
# 522 "project/radare2/libr/core/anal_tp.c"
                      1
# 522 "project/radare2/libr/core/anal_tp.c" 3 4
                      )>(
# 522 "project/radare2/libr/core/anal_tp.c"
...
# 522 "project/radare2/libr/core/anal_tp.c"
 ...
 RDebugTrace *dt = 
# 528 "project/radare2/libr/core/anal_tp.c" 3 4
                  ((void *)0)
# 528 "project/radare2/libr/core/anal_tp.c"
                      ;
 RAnalEsilTrace *et = 
# 529 "project/radare2/libr/core/anal_tp.c" 3 4
                     ((void *)0)
# 529 "project/radare2/libr/core/anal_tp.c"
                         ;
 ...
 char *fcn_name = 
# 546 "project/radare2/libr/core/anal_tp.c" 3 4
                 ((void *)0)
# 546 "project/radare2/libr/core/anal_tp.c"
                     ;
 char *ret_type = 
# 547 "project/radare2/libr/core/anal_tp.c" 3 4
                 ((void *)0)
# 547 "project/radare2/libr/core/anal_tp.c"
                     ;
 
# 548 "project/radare2/libr/core/anal_tp.c" 3 4
_Bool 
# 548 "project/radare2/libr/core/anal_tp.c"
     str_flag = 
# 548 "project/radare2/libr/core/anal_tp.c" 3 4
                0
# 548 "project/radare2/libr/core/anal_tp.c"
...
# 549 "project/radare2/libr/core/anal_tp.c" 3 4
_Bool 
# 549 "project/radare2/libr/core/anal_tp.c"
     prop = 
# 549 "project/radare2/libr/core/anal_tp.c" 3 4
            0
# 549 "project/radare2/libr/core/anal_tp.c"
...
# 550 "project/radare2/libr/core/anal_tp.c" 3 4
_Bool 
# 550 "project/radare2/libr/core/anal_tp.c"
     prev_var = 
# 550 "project/radare2/libr/core/anal_tp.c" 3 4
                0
# 550 "project/radare2/libr/core/anal_tp.c"
...
# 552 "project/radare2/libr/core/anal_tp.c" 3 4
                        ((void *)0)
# 552 "project/radare2/libr/core/anal_tp.c"
                            ;
 char *ret_reg = 
# 553 "project/radare2/libr/core/anal_tp.c" 3 4
                ((void *)0)
# 553 "project/radare2/libr/core/anal_tp.c"
                    ;
 ...
 char *pc = strdup (_pc);
 r_cons_break_push (
# 560 "project/radare2/libr/core/anal_tp.c" 3 4
                   ((void *)0)
# 560 "project/radare2/libr/core/anal_tp.c"
                       , 
# 560 "project/radare2/libr/core/anal_tp.c" 3 4
                         ((void *)0)
# 560 "project/radare2/libr/core/anal_tp.c"
...
# 569 "project/radare2/libr/core/anal_tp.c" 3 4
unsigned long long 
# 569 "project/radare2/libr/core/anal_tp.c"
     *bblist = calloc (sizeof (
# 569 "project/radare2/libr/core/anal_tp.c" 3 4
                               unsigned long long
# 569 "project/radare2/libr/core/anal_tp.c"
                                   ), bblist_size + 1);
...
# 571 "project/radare2/libr/core/anal_tp.c" 3 4
if (
# 571 "project/radare2/libr/core/anal_tp.c"
fcn->bbs
# 571 "project/radare2/libr/core/anal_tp.c" 3 4
) for (
# 571 "project/radare2/libr/core/anal_tp.c"
...
# 577 "project/radare2/libr/core/anal_tp.c" 3 4
  fprintf(__stderrp,
# 577 "project/radare2/libr/core/anal_tp.c"
  "Warning: basic block at 0x%08"
# 577 "project/radare2/libr/core/anal_tp.c" 3 4
  "llx"
# 577 "project/radare2/libr/core/anal_tp.c"
...
# 582 "project/radare2/libr/core/anal_tp.c" 3 4
 unsigned long long 
# 582 "project/radare2/libr/core/anal_tp.c"
      bb_addr = bb->addr;
  
# 583 "project/radare2/libr/core/anal_tp.c" 3 4
 unsigned long long 
# 583 "project/radare2/libr/core/anal_tp.c"
      bb_size = bb->size;
  
# 584 "project/radare2/libr/core/anal_tp.c" 3 4
 unsigned long long 
# 584 "project/radare2/libr/core/anal_tp.c"
      addr = bb->addr;
  
# 585 "project/radare2/libr/core/anal_tp.c" 3 4
 unsigned char 
# 585 "project/radare2/libr/core/anal_tp.c"
     *buf = calloc (bb->size + 32, 1);
  if (!buf) {
   break;
  }
...
# 599 "project/radare2/libr/core/anal_tp.c" 3 4
  unsigned long long 
# 599 "project/radare2/libr/core/anal_tp.c"
       pcval = r_reg_getv (anal->reg, pc);
   ...
   int loop_count = sdb_num_get (anal->esil->trace->db, sdb_fmt ("0x%"
# 612 "project/radare2/libr/core/anal_tp.c" 3 4
                                                                     "llx"
# 612 "project/radare2/libr/core/anal_tp.c"
                                                                            ".count", addr), 0);
   if (loop_count > 10 || aop.type == R_ANAL_OP_TYPE_RET) {
    r_anal_op_fini (&aop);
    break;
   }
   sdb_num_set (anal->esil->trace->db, sdb_fmt ("0x%"
# 617 "project/radare2/libr/core/anal_tp.c" 3 4
                                                    "llx"
# 617 "project/radare2/libr/core/anal_tp.c"
                                                           ".count", addr), loop_count + 1, 0);
...
# 629 "project/radare2/libr/core/anal_tp.c" 3 4
    fprintf(__stderrp,
# 629 "project/radare2/libr/core/anal_tp.c"
    "Warning: basic block at 0x%08"
# 629 "project/radare2/libr/core/anal_tp.c" 3 4
    "llx"
# 629 "project/radare2/libr/core/anal_tp.c"
...
# 636 "project/radare2/libr/core/anal_tp.c" 3 4
  _Bool 
# 636 "project/radare2/libr/core/anal_tp.c"
       userfnc = 
# 636 "project/radare2/libr/core/anal_tp.c" 3 4
                 0
# 636 "project/radare2/libr/core/anal_tp.c"
...
# 641 "project/radare2/libr/core/anal_tp.c" 3 4
  unsigned int 
# 641 "project/radare2/libr/core/anal_tp.c"
       type = aop.type & 
# 641 "project/radare2/libr/core/anal_tp.c" 3 4
                         0x8000ffff
# 641 "project/radare2/libr/core/anal_tp.c"
   ...
   if (aop.type == R_ANAL_OP_TYPE_CALL || aop.type & R_ANAL_OP_TYPE_UCALL) {
    char *full_name = 
# 643 "project/radare2/libr/core/anal_tp.c" 3 4
                     ((void *)0)
# 643 "project/radare2/libr/core/anal_tp.c"
                         ;
    
# 644 "project/radare2/libr/core/anal_tp.c" 3 4
   unsigned long long 
# 644 "project/radare2/libr/core/anal_tp.c"
        callee_addr;
...
# 651 "project/radare2/libr/core/anal_tp.c" 3 4
                         0xFFFFFFFFFFFFFFFFULL
# 651 "project/radare2/libr/core/anal_tp.c"
                                 ) {
     RFlagItem *flag = r_flag_get_by_spaces (core->flags, aop.ptr, 
# 652 "project/radare2/libr/core/anal_tp.c" 3 4
                                                                  "imports"
# 652 "project/radare2/libr/core/anal_tp.c"
                                                                                    , 
# 652 "project/radare2/libr/core/anal_tp.c" 3 4
                                                                                      ((void *)0)
# 652 "project/radare2/libr/core/anal_tp.c"
    ...
    if (full_name) {
     ...
     if (!fcn_name) {
      fcn_name = strdup (full_name);
      userfnc = 
# 666 "project/radare2/libr/core/anal_tp.c" 3 4
               1
# 666 "project/radare2/libr/core/anal_tp.c"
                   ;
     }
...
# 673 "project/radare2/libr/core/anal_tp.c" 3 4
     { free((void *)
# 673 "project/radare2/libr/core/anal_tp.c"
     ret_type
# 673 "project/radare2/libr/core/anal_tp.c" 3 4
     ); 
# 673 "project/radare2/libr/core/anal_tp.c"
...
# 678 "project/radare2/libr/core/anal_tp.c" 3 4
     { free((void *)
# 678 "project/radare2/libr/core/anal_tp.c"
     ret_reg
# 678 "project/radare2/libr/core/anal_tp.c" 3 4
     ); 
# 678 "project/radare2/libr/core/anal_tp.c"
...
# 678 "project/radare2/libr/core/anal_tp.c"
      ...
      resolved = 
# 683 "project/radare2/libr/core/anal_tp.c" 3 4
                0
# 683 "project/radare2/libr/core/anal_tp.c"
                     ;
      free (cc);
     }
...
# 688 "project/radare2/libr/core/anal_tp.c" 3 4
     unsigned long long 
# 688 "project/radare2/libr/core/anal_tp.c"
          mov_addr = sdb_num_get (trace, query, 0);
...
# 692 "project/radare2/libr/core/anal_tp.c" 3 4
      unsigned int 
# 692 "project/radare2/libr/core/anal_tp.c"
           type = mop->type & 
# 692 "project/radare2/libr/core/anal_tp.c" 3 4
                              0x8000ffff
# 692 "project/radare2/libr/core/anal_tp.c"
    ...
    if (ret_reg && *src && strstr (ret_reg, src)) {
     if (var && aop.direction == R_ANAL_OP_DIR_WRITE) {
      __var_retype (anal, var, 
# 709 "project/radare2/libr/core/anal_tp.c" 3 4
                              ((void *)0)
# 709 "project/radare2/libr/core/anal_tp.c"
                                  , ret_type, 
# 709 "project/radare2/libr/core/anal_tp.c" 3 4
                                              0
# 709 "project/radare2/libr/core/anal_tp.c"
...
# 709 "project/radare2/libr/core/anal_tp.c"
      ...
      resolved = 
# 710 "project/radare2/libr/core/anal_tp.c" 3 4
                1
# 710 "project/radare2/libr/core/anal_tp.c"
                    ;
     } else if (type == R_ANAL_OP_TYPE_MOV) {
      
# 712 "project/radare2/libr/core/anal_tp.c" 3 4
     { free((void *)
# 712 "project/radare2/libr/core/anal_tp.c"
     ret_reg
# 712 "project/radare2/libr/core/anal_tp.c" 3 4
     ); 
# 712 "project/radare2/libr/core/anal_tp.c"
...
# 712 "project/radare2/libr/core/anal_tp.c"
     ...
     if (ret_reg && (strstr (ret_reg, foo) || (tmp && strstr (ret_reg, tmp)))) {
      resolved = 
# 724 "project/radare2/libr/core/anal_tp.c" 3 4
                1
# 724 "project/radare2/libr/core/anal_tp.c"
                    ;
     } else if (type == R_ANAL_OP_TYPE_MOV &&
      ...
      if (ret_reg && *nsrc && strstr (ret_reg, nsrc) && var &&
       ...
       __var_retype (anal, var, 
# 734 "project/radare2/libr/core/anal_tp.c" 3 4
                               ((void *)0)
# 734 "project/radare2/libr/core/anal_tp.c"
                                   , ret_type, 
# 734 "project/radare2/libr/core/anal_tp.c" 3 4
                                               1
# 734 "project/radare2/libr/core/anal_tp.c"
...
# 742 "project/radare2/libr/core/anal_tp.c" 3 4
   _Bool 
# 742 "project/radare2/libr/core/anal_tp.c"
        sign = 
# 742 "project/radare2/libr/core/anal_tp.c" 3 4
               0
# 742 "project/radare2/libr/core/anal_tp.c"
    ...
    if ((type == R_ANAL_OP_TYPE_CMP) && next_op) {
     if (next_op->sign) {
      sign = 
# 745 "project/radare2/libr/core/anal_tp.c" 3 4
            1
# 745 "project/radare2/libr/core/anal_tp.c"
                ;
     } else {

      __var_retype (anal, var, 
# 748 "project/radare2/libr/core/anal_tp.c" 3 4
                              ((void *)0)
# 748 "project/radare2/libr/core/anal_tp.c"
                                  , "unsigned", 
# 748 "project/radare2/libr/core/anal_tp.c" 3 4
                                                0
# 748 "project/radare2/libr/core/anal_tp.c"
...
# 748 "project/radare2/libr/core/anal_tp.c"
    ...
    if (sign || aop.sign) {
     __var_retype (anal, var, 
# 753 "project/radare2/libr/core/anal_tp.c" 3 4
                             ((void *)0)
# 753 "project/radare2/libr/core/anal_tp.c"
                                 , "signed", 
# 753 "project/radare2/libr/core/anal_tp.c" 3 4
                                             0
# 753 "project/radare2/libr/core/anal_tp.c"
...
# 760 "project/radare2/libr/core/anal_tp.c" 3 4
    _Bool 
# 760 "project/radare2/libr/core/anal_tp.c"
         match = strstr (prev_dest, reg) != 
# 760 "project/radare2/libr/core/anal_tp.c" 3 4
                                            ((void *)0)
# 760 "project/radare2/libr/core/anal_tp.c"
                                                ;
     if (str_flag && match) {
      __var_retype (anal, var, 
# 762 "project/radare2/libr/core/anal_tp.c" 3 4
                              ((void *)0)
# 762 "project/radare2/libr/core/anal_tp.c"
                                  , "const char *", 
# 762 "project/radare2/libr/core/anal_tp.c" 3 4
                                                    0
# 762 "project/radare2/libr/core/anal_tp.c"
...
# 762 "project/radare2/libr/core/anal_tp.c"
     ...
     if (prop && match && prev_var) {
      __var_retype (anal, var, 
# 765 "project/radare2/libr/core/anal_tp.c" 3 4
                              ((void *)0)
# 765 "project/radare2/libr/core/anal_tp.c"
                                  , prev_type, 
# 765 "project/radare2/libr/core/anal_tp.c" 3 4
                                               0
# 765 "project/radare2/libr/core/anal_tp.c"
...
# 765 "project/radare2/libr/core/anal_tp.c"
    ...
    if (chk_constraint && var && (type == R_ANAL_OP_TYPE_CMP && aop.disp != 
# 768 "project/radare2/libr/core/anal_tp.c" 3 4
                                                                           0xFFFFFFFFFFFFFFFFULL
# 768 "project/radare2/libr/core/anal_tp.c"
                                                                                   )
      && next_op && next_op->type == R_ANAL_OP_TYPE_CJMP) {
     
# 770 "project/radare2/libr/core/anal_tp.c" 3 4
    _Bool 
# 770 "project/radare2/libr/core/anal_tp.c"
         jmp = 
# 770 "project/radare2/libr/core/anal_tp.c" 3 4
               0
# 770 "project/radare2/libr/core/anal_tp.c"
...
# 772 "project/radare2/libr/core/anal_tp.c" 3 4
    unsigned long long 
# 772 "project/radare2/libr/core/anal_tp.c"
         jmp_addr = next_op->jump;
     ...
     for (i = 0; i < 5 ; i++) {
      ...
      if ((jmp_op->type == R_ANAL_OP_TYPE_RET && r_anal_block_contains (jmpbb, jmp_addr))
       ...
       jmp = 
# 783 "project/radare2/libr/core/anal_tp.c" 3 4
            1
# 783 "project/radare2/libr/core/anal_tp.c"
                ;
   ...
   str_flag = 
# 798 "project/radare2/libr/core/anal_tp.c" 3 4
             0
# 798 "project/radare2/libr/core/anal_tp.c"
                  ;
   prop = 
# 799 "project/radare2/libr/core/anal_tp.c" 3 4
         0
# 799 "project/radare2/libr/core/anal_tp.c"
              ;
   prev_dest = 
# 800 "project/radare2/libr/core/anal_tp.c" 3 4
              ((void *)0)
# 800 "project/radare2/libr/core/anal_tp.c"
                  ;
   switch (type) {
   case R_ANAL_OP_TYPE_MOV:
   case R_ANAL_OP_TYPE_LEA:
   case R_ANAL_OP_TYPE_LOAD:
    if (aop.ptr && aop.refptr && aop.ptr != 
# 805 "project/radare2/libr/core/anal_tp.c" 3 4
                                           0xFFFFFFFFFFFFFFFFULL
# 805 "project/radare2/libr/core/anal_tp.c"
                                                   ) {
     if (type == R_ANAL_OP_TYPE_LOAD) {
      
# 807 "project/radare2/libr/core/anal_tp.c" 3 4
     unsigned char 
# 807 "project/radare2/libr/core/anal_tp.c"
         buf[256] = {0};
      r_io_read_at (core->io, aop.ptr, buf, sizeof (buf) - 1);
      
# 809 "project/radare2/libr/core/anal_tp.c" 3 4
     unsigned long long 
# 809 "project/radare2/libr/core/anal_tp.c"
          ptr = r_read_ble (buf, core->print->big_endian, aop.refptr * 8);
      if (ptr && ptr != 
# 810 "project/radare2/libr/core/anal_tp.c" 3 4
                       0xFFFFFFFFFFFFFFFFULL
# 810 "project/radare2/libr/core/anal_tp.c"
                               ) {
       RFlagItem *f = r_flag_get_by_spaces (core->flags, ptr, 
# 811 "project/radare2/libr/core/anal_tp.c" 3 4
                                                             "strings"
# 811 "project/radare2/libr/core/anal_tp.c"
                                                                               , 
# 811 "project/radare2/libr/core/anal_tp.c" 3 4
                                                                                 ((void *)0)
# 811 "project/radare2/libr/core/anal_tp.c"
       ...
       if (f) {
        str_flag = 
# 813 "project/radare2/libr/core/anal_tp.c" 3 4
                  1
# 813 "project/radare2/libr/core/anal_tp.c"
                      ;
       }
      }
     } else if (r_flag_exist_at (core->flags, "str", 3, aop.ptr)) {
      str_flag = 
# 817 "project/radare2/libr/core/anal_tp.c" 3 4
                1
# 817 "project/radare2/libr/core/anal_tp.c"
                    ;
     }
    }
    ...
    if (var && str_flag) {
     __var_retype (anal, var, 
# 822 "project/radare2/libr/core/anal_tp.c" 3 4
                             ((void *)0)
# 822 "project/radare2/libr/core/anal_tp.c"
                                 , "const char *", 
# 822 "project/radare2/libr/core/anal_tp.c" 3 4
                                                   0
# 822 "project/radare2/libr/core/anal_tp.c"
...
# 827 "project/radare2/libr/core/anal_tp.c" 3 4
    __builtin___strncpy_chk (
# 827 "project/radare2/libr/core/anal_tp.c"
    prev_type
# 827 "project/radare2/libr/core/anal_tp.c" 3 4
    , 
# 827 "project/radare2/libr/core/anal_tp.c"
    var->type, sizeof (prev_type) - 1
# 827 "project/radare2/libr/core/anal_tp.c" 3 4
    , __builtin_object_size (
# 827 "project/radare2/libr/core/anal_tp.c"
    prev_type
...
# 827 "project/radare2/libr/core/anal_tp.c"
                                                          ;
     prop = 
# 828 "project/radare2/libr/core/anal_tp.c" 3 4
           1
# 828 "project/radare2/libr/core/anal_tp.c"
               ;
    }
   }
   i += ret;
...
# 838 "project/radare2/libr/core/anal_tp.c" 3 4
{ free((void *)
# 838 "project/radare2/libr/core/anal_tp.c"
bblist
# 838 "project/radare2/libr/core/anal_tp.c" 3 4
); 
# 838 "project/radare2/libr/core/anal_tp.c"
...
# 843 "project/radare2/libr/core/anal_tp.c" 3 4
if (
# 843 "project/radare2/libr/core/anal_tp.c"
list
# 843 "project/radare2/libr/core/anal_tp.c" 3 4
) for (
# 843 "project/radare2/libr/core/anal_tp.c"
...
# 843 "project/radare2/libr/core/anal_tp.c"
  ...
  if (lvar) {
   ...
   __var_retype (anal, rvar, 
# 851 "project/radare2/libr/core/anal_tp.c" 3 4
                            ((void *)0)
# 851 "project/radare2/libr/core/anal_tp.c"
                                , lvar->type, 
# 851 "project/radare2/libr/core/anal_tp.c" 3 4
                                              0
# 851 "project/radare2/libr/core/anal_tp.c"
...
# 851 "project/radare2/libr/core/anal_tp.c"
   ...
   __var_retype (anal, lvar, 
# 853 "project/radare2/libr/core/anal_tp.c" 3 4
                            ((void *)0)
# 853 "project/radare2/libr/core/anal_tp.c"
                                , rvar->type, 
# 853 "project/radare2/libr/core/anal_tp.c" 3 4
                                              0
# 853 "project/radare2/libr/core/anal_tp.c"
...
# 858 "project/radare2/libr/core/anal_tp.c" 3 4
{ free((void *)
# 858 "project/radare2/libr/core/anal_tp.c"
ret_reg
# 858 "project/radare2/libr/core/anal_tp.c" 3 4
); 
# 858 "project/radare2/libr/core/anal_tp.c"
...
# 859 "project/radare2/libr/core/anal_tp.c" 3 4
{ free((void *)
# 859 "project/radare2/libr/core/anal_tp.c"
ret_type
# 859 "project/radare2/libr/core/anal_tp.c" 3 4
); 
# 859 "project/radare2/libr/core/anal_tp.c"
