# 0 "project/radare2/libr/core/zdiff.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/zdiff.c"
...
# 4 "project/radare2/libr/core/zdiff.c" 2
...
# 5 "project/radare2/libr/core/zdiff.c" 2
...
# 6 "project/radare2/libr/core/zdiff.c" 2


# 7 "project/radare2/libr/core/zdiff.c"
static 
# 7 "project/radare2/libr/core/zdiff.c" 3 4
      _Bool 
# 7 "project/radare2/libr/core/zdiff.c"
           matchBytes(RSignItem *a, RSignItem *b) {
 if (a->bytes && b->bytes) {
 ...
 return 
# 13 "project/radare2/libr/core/zdiff.c" 3 4
       0
# 13 "project/radare2/libr/core/zdiff.c"
            ;
}

static 
# 16 "project/radare2/libr/core/zdiff.c" 3 4
      _Bool 
# 16 "project/radare2/libr/core/zdiff.c"
           matchGraph(RSignItem *a, RSignItem *b) {
 if (a->graph && b->graph) {
  if (a->graph->cc != b->graph->cc) {
   return 
# 19 "project/radare2/libr/core/zdiff.c" 3 4
         0
# 19 "project/radare2/libr/core/zdiff.c"
              ;
  }
  if (a->graph->nbbs != b->graph->nbbs) {
   return 
# 22 "project/radare2/libr/core/zdiff.c" 3 4
         0
# 22 "project/radare2/libr/core/zdiff.c"
              ;
  }
  if (a->graph->ebbs != b->graph->ebbs) {
   return 
# 25 "project/radare2/libr/core/zdiff.c" 3 4
         0
# 25 "project/radare2/libr/core/zdiff.c"
              ;
  }
  if (a->graph->edges != b->graph->edges) {
   return 
# 28 "project/radare2/libr/core/zdiff.c" 3 4
         0
# 28 "project/radare2/libr/core/zdiff.c"
              ;
  }
  if (a->graph->bbsum!= b->graph->bbsum) {
   return 
# 31 "project/radare2/libr/core/zdiff.c" 3 4
         0
# 31 "project/radare2/libr/core/zdiff.c"
              ;
  }
  return 
# 33 "project/radare2/libr/core/zdiff.c" 3 4
        1
# 33 "project/radare2/libr/core/zdiff.c"
            ;
 }
 return 
# 35 "project/radare2/libr/core/zdiff.c" 3 4
       0
# 35 "project/radare2/libr/core/zdiff.c"
            ;
}


# 38 "project/radare2/libr/core/zdiff.c" 3 4
__attribute__((visibility("default"))) 
# 38 "project/radare2/libr/core/zdiff.c"
     int r_core_zdiff(RCore *c, RCore *c2) {
 if (!c || !c2) {
  return 
# 40 "project/radare2/libr/core/zdiff.c" 3 4
        0
# 40 "project/radare2/libr/core/zdiff.c"
             ;
 }

 SdbList *a = sdb_foreach_list (c->anal->sdb_zigns, 
# 43 "project/radare2/libr/core/zdiff.c" 3 4
                                                   0
# 43 "project/radare2/libr/core/zdiff.c"
                                                        );
 SdbList *b = sdb_foreach_list (c2->anal->sdb_zigns, 
# 44 "project/radare2/libr/core/zdiff.c" 3 4
                                                    0
# 44 "project/radare2/libr/core/zdiff.c"
                                                         );

 
# 46 "project/radare2/libr/core/zdiff.c" 3 4
fprintf(__stderrp,
# 46 "project/radare2/libr/core/zdiff.c"
"Diff %d %d\n", (int)a
# 46 "project/radare2/libr/core/zdiff.c" 3 4
->length
# 46 "project/radare2/libr/core/zdiff.c"
...
# 50 "project/radare2/libr/core/zdiff.c" 3 4
if ((
# 50 "project/radare2/libr/core/zdiff.c"
a
# 50 "project/radare2/libr/core/zdiff.c" 3 4
)) for (
# 50 "project/radare2/libr/core/zdiff.c"
...
# 59 "project/radare2/libr/core/zdiff.c" 3 4
if ((
# 59 "project/radare2/libr/core/zdiff.c"
b
# 59 "project/radare2/libr/core/zdiff.c" 3 4
)) for (
# 59 "project/radare2/libr/core/zdiff.c"
...
# 74 "project/radare2/libr/core/zdiff.c" 3 4
if (
# 74 "project/radare2/libr/core/zdiff.c"
la
# 74 "project/radare2/libr/core/zdiff.c" 3 4
) for (
# 74 "project/radare2/libr/core/zdiff.c"
...
# 79 "project/radare2/libr/core/zdiff.c" 3 4
 if (
# 79 "project/radare2/libr/core/zdiff.c"
 lb
# 79 "project/radare2/libr/core/zdiff.c" 3 4
 ) for (
# 79 "project/radare2/libr/core/zdiff.c"
...
# 84 "project/radare2/libr/core/zdiff.c" 3 4
   fprintf(__stderrp,
# 84 "project/radare2/libr/core/zdiff.c"
   "0x%08"
# 84 "project/radare2/libr/core/zdiff.c" 3 4
   "llx"
# 84 "project/radare2/libr/core/zdiff.c"
...
# 87 "project/radare2/libr/core/zdiff.c" 3 4
   fprintf(__stderrp,
# 87 "project/radare2/libr/core/zdiff.c"
   "0x%08"
# 87 "project/radare2/libr/core/zdiff.c" 3 4
   "llx"
# 87 "project/radare2/libr/core/zdiff.c"
...
# 87 "project/radare2/libr/core/zdiff.c"
 ...
 return 
# 95 "project/radare2/libr/core/zdiff.c" 3 4
       1
# 95 "project/radare2/libr/core/zdiff.c"
           ;
}
