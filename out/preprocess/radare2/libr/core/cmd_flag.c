# 0 "project/radare2/libr/core/cmd_flag.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/cmd_flag.c"
...
# 4 "project/radare2/libr/core/cmd_flag.c" 2
...
# 5 "project/radare2/libr/core/cmd_flag.c" 2
...
# 6 "project/radare2/libr/core/cmd_flag.c" 2


# 7 "project/radare2/libr/core/cmd_flag.c"
...
# 10 "project/radare2/libr/core/cmd_flag.c" 3 4
((void *)0)

# 11 "project/radare2/libr/core/cmd_flag.c"
};
...
# 19 "project/radare2/libr/core/cmd_flag.c" 3 4
((void *)0)

# 20 "project/radare2/libr/core/cmd_flag.c"
};
...
# 70 "project/radare2/libr/core/cmd_flag.c" 3 4
((void *)0)

# 71 "project/radare2/libr/core/cmd_flag.c"
};
...
# 78 "project/radare2/libr/core/cmd_flag.c" 3 4
((void *)0)

# 79 "project/radare2/libr/core/cmd_flag.c"
};
...
# 84 "project/radare2/libr/core/cmd_flag.c" 3 4
((void *)0)

# 85 "project/radare2/libr/core/cmd_flag.c"
};
...
# 96 "project/radare2/libr/core/cmd_flag.c" 3 4
((void *)0)

# 97 "project/radare2/libr/core/cmd_flag.c"
};
...
# 105 "project/radare2/libr/core/cmd_flag.c" 3 4
((void *)0)

# 106 "project/radare2/libr/core/cmd_flag.c"
};
...
# 126 "project/radare2/libr/core/cmd_flag.c" 3 4
((void *)0)

# 127 "project/radare2/libr/core/cmd_flag.c"
};
...
# 137 "project/radare2/libr/core/cmd_flag.c" 3 4
((void *)0)

# 138 "project/radare2/libr/core/cmd_flag.c"
};

static 
# 140 "project/radare2/libr/core/cmd_flag.c" 3 4
      _Bool 
# 140 "project/radare2/libr/core/cmd_flag.c"
           listFlag(RFlagItem *flag, void *user) {
 r_list_append (user, flag);
 return 
# 142 "project/radare2/libr/core/cmd_flag.c" 3 4
       1
# 142 "project/radare2/libr/core/cmd_flag.c"
           ;
}
...
static const char *__isOnlySon(RCore *core, RList *flags, const char *kw) {
 ...
 size_t count = 0;
 char *fname = 
# 161 "project/radare2/libr/core/cmd_flag.c" 3 4
              ((void *)0)
# 161 "project/radare2/libr/core/cmd_flag.c"
                  ;
 
# 162 "project/radare2/libr/core/cmd_flag.c" 3 4
if (
# 162 "project/radare2/libr/core/cmd_flag.c"
flags
# 162 "project/radare2/libr/core/cmd_flag.c" 3 4
) for (
# 162 "project/radare2/libr/core/cmd_flag.c"
...
# 162 "project/radare2/libr/core/cmd_flag.c"
  ...
  if (!strncmp (f->name, kw, strlen (kw))) {
   ...
   if (count > 1) {
    return 
# 166 "project/radare2/libr/core/cmd_flag.c" 3 4
          ((void *)0)
# 166 "project/radare2/libr/core/cmd_flag.c"
              ;
   }
   fname = f->name;
  }
...
# 181 "project/radare2/libr/core/cmd_flag.c" 3 4
if (
# 181 "project/radare2/libr/core/cmd_flag.c"
flags
# 181 "project/radare2/libr/core/cmd_flag.c" 3 4
) for (
# 181 "project/radare2/libr/core/cmd_flag.c"
...
# 193 "project/radare2/libr/core/cmd_flag.c" 3 4
 if (
# 193 "project/radare2/libr/core/cmd_flag.c"
 flags
# 193 "project/radare2/libr/core/cmd_flag.c" 3 4
 ) for (
# 193 "project/radare2/libr/core/cmd_flag.c"
...
# 193 "project/radare2/libr/core/cmd_flag.c"
  ...
  if (only) {
   ...
   const char *fname = 
# 218 "project/radare2/libr/core/cmd_flag.c" 3 4
                      ((void *)0)
# 218 "project/radare2/libr/core/cmd_flag.c"
                          ;
   size_t fname_len = 0;
   
# 220 "project/radare2/libr/core/cmd_flag.c" 3 4
  if (
# 220 "project/radare2/libr/core/cmd_flag.c"
  flags
# 220 "project/radare2/libr/core/cmd_flag.c" 3 4
  ) for (
# 220 "project/radare2/libr/core/cmd_flag.c"
...
# 243 "project/radare2/libr/core/cmd_flag.c" 3 4
 _Bool 
# 243 "project/radare2/libr/core/cmd_flag.c"
      found = 
# 243 "project/radare2/libr/core/cmd_flag.c" 3 4
              0
# 243 "project/radare2/libr/core/cmd_flag.c"
...
# 244 "project/radare2/libr/core/cmd_flag.c" 3 4
 if (
# 244 "project/radare2/libr/core/cmd_flag.c"
 list
# 244 "project/radare2/libr/core/cmd_flag.c" 3 4
 ) for (
# 244 "project/radare2/libr/core/cmd_flag.c"
...
# 244 "project/radare2/libr/core/cmd_flag.c"
   ...
   if (!strcmp (fn, kw)) {
    found = 
# 246 "project/radare2/libr/core/cmd_flag.c" 3 4
           1
# 246 "project/radare2/libr/core/cmd_flag.c"
               ;
    break;
   }
  }
...
# 277 "project/radare2/libr/core/cmd_flag.c" 3 4
if (
# 277 "project/radare2/libr/core/cmd_flag.c"
children
# 277 "project/radare2/libr/core/cmd_flag.c" 3 4
) for (
# 277 "project/radare2/libr/core/cmd_flag.c"
...
static void __flag_graph (RCore *core, const char *input, int mode) {
 RList *flags = r_list_newf (
# 294 "project/radare2/libr/core/cmd_flag.c" 3 4
                            ((void *)0)
# 294 "project/radare2/libr/core/cmd_flag.c"
                                );
...
static void spaces_list(RSpaces *sp, int mode) {
 ...
 PJ *pj = 
# 304 "project/radare2/libr/core/cmd_flag.c" 3 4
         ((void *)0)
# 304 "project/radare2/libr/core/cmd_flag.c"
             ;
 if (mode == 'j') {
  pj = pj_new ();
  pj_a (pj);
...
# 309 "project/radare2/libr/core/cmd_flag.c" 3 4
for ((
# 309 "project/radare2/libr/core/cmd_flag.c"
it
# 309 "project/radare2/libr/core/cmd_flag.c" 3 4
) = (
# 309 "project/radare2/libr/core/cmd_flag.c"
...
static void cmd_fz(RCore *core, const char *input) {
 ...
 case '.':
  {
   const char *a = 
# 343 "project/radare2/libr/core/cmd_flag.c" 3 4
                  ((void *)0)
# 343 "project/radare2/libr/core/cmd_flag.c"
                      , *b = 
# 343 "project/radare2/libr/core/cmd_flag.c" 3 4
                             ((void *)0)
# 343 "project/radare2/libr/core/cmd_flag.c"
 ...
 case ':':
  {
   const char *a, *b;
   int a_len = 0;
   int w = r_cons_get_size (
# 352 "project/radare2/libr/core/cmd_flag.c" 3 4
                           ((void *)0)
# 352 "project/radare2/libr/core/cmd_flag.c"
                               );
   r_flag_zone_around (core->flags, core->offset, &a, &b);
   if (a) {
    r_cons_printf ("[<< %s]", a);
   ...
   int title_size = 12;
   if (a || b) {
    char *title = r_str_newf ("[ 0x%08"
# 361 "project/radare2/libr/core/cmd_flag.c" 3 4
                                      "llx"
# 361 "project/radare2/libr/core/cmd_flag.c"
                                             " ]", core->offset);
...
static 
# 402 "project/radare2/libr/core/cmd_flag.c" 3 4
      _Bool 
# 402 "project/radare2/libr/core/cmd_flag.c"
           flagbar_foreach(RFlagItem *fi, void *user) {
 struct flagbar_t *u = (struct flagbar_t *)user;
 
# 404 "project/radare2/libr/core/cmd_flag.c" 3 4
unsigned long long 
# 404 "project/radare2/libr/core/cmd_flag.c"
     min = 0, max = r_io_size (u->core->io);
 ...
 r_cons_printf ("0x%08"
# 410 "project/radare2/libr/core/cmd_flag.c" 3 4
                      "llx"
# 410 "project/radare2/libr/core/cmd_flag.c"
                             " ", fi->offset);
 r_print_rangebar (u->core->print, fi->offset, fi->offset + fi->size, min, max, u->cols);
 r_cons_printf ("  %s\n", fi->name);
 return 
# 413 "project/radare2/libr/core/cmd_flag.c" 3 4
       1
# 413 "project/radare2/libr/core/cmd_flag.c"
           ;
}

static void flagbars(RCore *core, const char *glob) {
 int cols = r_cons_get_size (
# 417 "project/radare2/libr/core/cmd_flag.c" 3 4
                            ((void *)0)
# 417 "project/radare2/libr/core/cmd_flag.c"
                                );
 cols -= 80;
 if (cols < 0) {
  cols += 80;
...
# 428 "project/radare2/libr/core/cmd_flag.c" 3 4
unsigned long long 
# 428 "project/radare2/libr/core/cmd_flag.c"
     next;
 
# 429 "project/radare2/libr/core/cmd_flag.c" 3 4
unsigned long long 
# 429 "project/radare2/libr/core/cmd_flag.c"
     offset;
};

static 
# 432 "project/radare2/libr/core/cmd_flag.c" 3 4
      _Bool 
# 432 "project/radare2/libr/core/cmd_flag.c"
           flag_to_flag_foreach(RFlagItem *fi, void *user) {
 struct flag_to_flag_t *u = (struct flag_to_flag_t *)user;
 if (fi->offset < u->next && fi->offset > u->offset) {
  u->next = fi->offset;
 }
 return 
# 437 "project/radare2/libr/core/cmd_flag.c" 3 4
       1
# 437 "project/radare2/libr/core/cmd_flag.c"
           ;
}

static int flag_to_flag(RCore *core, const char *glob) {
 
# 441 "project/radare2/libr/core/cmd_flag.c" 3 4
do { if (!(
# 441 "project/radare2/libr/core/cmd_flag.c"
glob
# 441 "project/radare2/libr/core/cmd_flag.c" 3 4
...
# 441 "project/radare2/libr/core/cmd_flag.c"
 ...
 struct flag_to_flag_t u = { .next = 
# 443 "project/radare2/libr/core/cmd_flag.c" 3 4
                                    0xFFFFFFFFFFFFFFFFULL
# 443 "project/radare2/libr/core/cmd_flag.c"
                                            , .offset = core->offset };
 r_flag_foreach_glob (core->flags, glob, flag_to_flag_foreach, &u);
 if (u.next != 
# 445 "project/radare2/libr/core/cmd_flag.c" 3 4
              0xFFFFFFFFFFFFFFFFULL 
# 445 "project/radare2/libr/core/cmd_flag.c"
                       && u.next > core->offset) {
...
static 
# 455 "project/radare2/libr/core/cmd_flag.c" 3 4
      _Bool 
# 455 "project/radare2/libr/core/cmd_flag.c"
           __tableItemCallback(RFlagItem *flag, void *user) {
 FlagTableData *ftd = user;
 if (!
# 457 "project/radare2/libr/core/cmd_flag.c" 3 4
     (!(
# 457 "project/radare2/libr/core/cmd_flag.c"
     flag->name
# 457 "project/radare2/libr/core/cmd_flag.c" 3 4
     ) || !*(
# 457 "project/radare2/libr/core/cmd_flag.c"
...
# 457 "project/radare2/libr/core/cmd_flag.c"
  ...
  const char *addr = sdb_fmt ("0x%08"
# 460 "project/radare2/libr/core/cmd_flag.c" 3 4
                                    "llx"
# 460 "project/radare2/libr/core/cmd_flag.c"
                                           , flag->offset);
  r_table_add_row (t, addr, sdb_fmt ("%"
# 461 "project/radare2/libr/core/cmd_flag.c" 3 4
                                       "lld"
# 461 "project/radare2/libr/core/cmd_flag.c"
                                              , flag->size), spaceName, flag->name, 
# 461 "project/radare2/libr/core/cmd_flag.c" 3 4
                                                                                    ((void *)0)
# 461 "project/radare2/libr/core/cmd_flag.c"
                                                                                        );
 ...
 return 
# 463 "project/radare2/libr/core/cmd_flag.c" 3 4
       1
# 463 "project/radare2/libr/core/cmd_flag.c"
           ;
}
...
static void cmd_flag_tags(RCore *core, const char *input) {
 char mode = input[1];
 for (; *input && !
# 493 "project/radare2/libr/core/cmd_flag.c" 3 4
                  ((
# 493 "project/radare2/libr/core/cmd_flag.c"
                  *input
# 493 "project/radare2/libr/core/cmd_flag.c" 3 4
                  ) == ' ' || (
# 493 "project/radare2/libr/core/cmd_flag.c"
...
# 500 "project/radare2/libr/core/cmd_flag.c" 3 4
                                              ((void *)0)
# 500 "project/radare2/libr/core/cmd_flag.c"
                                                  );
  
# 501 "project/radare2/libr/core/cmd_flag.c" 3 4
 if (
# 501 "project/radare2/libr/core/cmd_flag.c"
 list
# 501 "project/radare2/libr/core/cmd_flag.c" 3 4
 ) for (
# 501 "project/radare2/libr/core/cmd_flag.c"
...
# 501 "project/radare2/libr/core/cmd_flag.c"
 ...
 if (mode == 'w') {
  ...
  RListIter *iter;
  RList *list = r_flag_tags_list (core->flags, 
# 517 "project/radare2/libr/core/cmd_flag.c" 3 4
                                              ((void *)0)
# 517 "project/radare2/libr/core/cmd_flag.c"
                                                  );
  
# 518 "project/radare2/libr/core/cmd_flag.c" 3 4
 if (
# 518 "project/radare2/libr/core/cmd_flag.c"
 list
# 518 "project/radare2/libr/core/cmd_flag.c" 3 4
 ) for (
# 518 "project/radare2/libr/core/cmd_flag.c"
...
# 518 "project/radare2/libr/core/cmd_flag.c"
 ...
 if (mode == '*') {
  ...
  const char *tag;
  RList *list = r_flag_tags_list (core->flags, 
# 529 "project/radare2/libr/core/cmd_flag.c" 3 4
                                              ((void *)0)
# 529 "project/radare2/libr/core/cmd_flag.c"
                                                  );
  
# 530 "project/radare2/libr/core/cmd_flag.c" 3 4
 if (
# 530 "project/radare2/libr/core/cmd_flag.c"
 list
# 530 "project/radare2/libr/core/cmd_flag.c" 3 4
 ) for (
# 530 "project/radare2/libr/core/cmd_flag.c"
...
# 530 "project/radare2/libr/core/cmd_flag.c"
                                  {
   const char *flags = sdb_get (core->flags->tags, sdb_fmt ("tag.%s", tag), 
# 531 "project/radare2/libr/core/cmd_flag.c" 3 4
                                                                           ((void *)0)
# 531 "project/radare2/libr/core/cmd_flag.c"
                                                                               );
 ...
 if (mode == 'j') {
  ...
  pj_o (pj);
  RList *list = r_flag_tags_list (core->flags, 
# 543 "project/radare2/libr/core/cmd_flag.c" 3 4
                                              ((void *)0)
# 543 "project/radare2/libr/core/cmd_flag.c"
                                                  );
  
# 544 "project/radare2/libr/core/cmd_flag.c" 3 4
 if (
# 544 "project/radare2/libr/core/cmd_flag.c"
 list
# 544 "project/radare2/libr/core/cmd_flag.c" 3 4
 ) for (
# 544 "project/radare2/libr/core/cmd_flag.c"
...
# 548 "project/radare2/libr/core/cmd_flag.c" 3 4
  if (
# 548 "project/radare2/libr/core/cmd_flag.c"
  flags
# 548 "project/radare2/libr/core/cmd_flag.c" 3 4
  ) for (
# 548 "project/radare2/libr/core/cmd_flag.c"
...
# 572 "project/radare2/libr/core/cmd_flag.c" 3 4
  if (
# 572 "project/radare2/libr/core/cmd_flag.c"
  flags
# 572 "project/radare2/libr/core/cmd_flag.c" 3 4
  ) for (
# 572 "project/radare2/libr/core/cmd_flag.c"
...
# 572 "project/radare2/libr/core/cmd_flag.c"
    ...
    r_cons_printf ("0x%08"
# 574 "project/radare2/libr/core/cmd_flag.c" 3 4
                         "llx"
# 574 "project/radare2/libr/core/cmd_flag.c"
                                "  %s\n", flag->offset, flag->name);
   }
   break;
  default:
   
# 578 "project/radare2/libr/core/cmd_flag.c" 3 4
  if (
# 578 "project/radare2/libr/core/cmd_flag.c"
  flags
# 578 "project/radare2/libr/core/cmd_flag.c" 3 4
  ) for (
# 578 "project/radare2/libr/core/cmd_flag.c"
...
# 578 "project/radare2/libr/core/cmd_flag.c"
                                     {
    r_cons_printf ("0x%08"
# 579 "project/radare2/libr/core/cmd_flag.c" 3 4
                         "llx"
# 579 "project/radare2/libr/core/cmd_flag.c"
                                "\n", flag->offset);
   }
   break;
  }
...
static 
# 593 "project/radare2/libr/core/cmd_flag.c" 3 4
      _Bool 
# 593 "project/radare2/libr/core/cmd_flag.c"
           rename_flag_ordinal(RFlagItem *fi, void *user) {
 struct rename_flag_t *u = (struct rename_flag_t *)user;
 char *newName = r_str_newf ("%s%d", u->pfx, u->count++);
 if (!newName) {
  return 
# 597 "project/radare2/libr/core/cmd_flag.c" 3 4
        0
# 597 "project/radare2/libr/core/cmd_flag.c"
             ;
 }
 r_flag_rename (u->core->flags, fi, newName);
 free (newName);
 return 
# 601 "project/radare2/libr/core/cmd_flag.c" 3 4
       1
# 601 "project/radare2/libr/core/cmd_flag.c"
           ;
}
...
# 624 "project/radare2/libr/core/cmd_flag.c" 3 4
unsigned long long 
# 624 "project/radare2/libr/core/cmd_flag.c"
     at;
};

static 
# 627 "project/radare2/libr/core/cmd_flag.c" 3 4
      _Bool 
# 627 "project/radare2/libr/core/cmd_flag.c"
           find_flag_after(RFlagItem *flag, void *user) {
 struct find_flag_t *u = (struct find_flag_t *)user;
 if (flag->offset > u->at && (!u->win || flag->offset < u->win->offset)) {
  u->win = flag;
 }
 return 
# 632 "project/radare2/libr/core/cmd_flag.c" 3 4
       1
# 632 "project/radare2/libr/core/cmd_flag.c"
           ;
}

static 
# 635 "project/radare2/libr/core/cmd_flag.c" 3 4
      _Bool 
# 635 "project/radare2/libr/core/cmd_flag.c"
           find_flag_after_foreach(RFlagItem *flag, void *user) {
 if (flag->size != 0) {
  return 
# 637 "project/radare2/libr/core/cmd_flag.c" 3 4
        1
# 637 "project/radare2/libr/core/cmd_flag.c"
            ;
 }

 RFlag *flags = (RFlag *)user;
 struct find_flag_t u = { .win = 
# 641 "project/radare2/libr/core/cmd_flag.c" 3 4
                                ((void *)0)
# 641 "project/radare2/libr/core/cmd_flag.c"
                                    , .at = flag->offset };
 ...
 return 
# 646 "project/radare2/libr/core/cmd_flag.c" 3 4
       1
# 646 "project/radare2/libr/core/cmd_flag.c"
           ;
}

static 
# 649 "project/radare2/libr/core/cmd_flag.c" 3 4
      _Bool 
# 649 "project/radare2/libr/core/cmd_flag.c"
           adjust_offset(RFlagItem *flag, void *user) {
 
# 650 "project/radare2/libr/core/cmd_flag.c" 3 4
long long 
# 650 "project/radare2/libr/core/cmd_flag.c"
     base = *(
# 650 "project/radare2/libr/core/cmd_flag.c" 3 4
              long long 
# 650 "project/radare2/libr/core/cmd_flag.c"
 ...
 flag->offset += base;
 return 
# 652 "project/radare2/libr/core/cmd_flag.c" 3 4
       1
# 652 "project/radare2/libr/core/cmd_flag.c"
           ;
}

static void print_space_stack(RFlag *f, int ordinal, const char *name, 
# 655 "project/radare2/libr/core/cmd_flag.c" 3 4
                                                                      _Bool 
# 655 "project/radare2/libr/core/cmd_flag.c"
                                                                           selected, PJ *pj, int mode) {
 
# 656 "project/radare2/libr/core/cmd_flag.c" 3 4
_Bool 
# 656 "project/radare2/libr/core/cmd_flag.c"
     first = ordinal == 0;
 switch (mode) {
 case 'j': {
...
static int flag_space_stack_list(RFlag *f, int mode) {
 ...
 int i = 0;
 PJ *pj = 
# 687 "project/radare2/libr/core/cmd_flag.c" 3 4
         ((void *)0)
# 687 "project/radare2/libr/core/cmd_flag.c"
             ;
 if (mode == 'j') {
  pj = pj_new ();
  pj_a (pj);
...
# 692 "project/radare2/libr/core/cmd_flag.c" 3 4
if (
# 692 "project/radare2/libr/core/cmd_flag.c"
f->spaces.spacestack
# 692 "project/radare2/libr/core/cmd_flag.c" 3 4
) for (
# 692 "project/radare2/libr/core/cmd_flag.c"
...
# 692 "project/radare2/libr/core/cmd_flag.c"
                                                   {
  print_space_stack (f, i++, space, 
# 693 "project/radare2/libr/core/cmd_flag.c" 3 4
                                   0
# 693 "project/radare2/libr/core/cmd_flag.c"
                                        , pj, mode);
 }
 const char *cur_name = r_flag_space_cur_name (f);
 print_space_stack (f, i++, cur_name, 
# 696 "project/radare2/libr/core/cmd_flag.c" 3 4
                                     1
# 696 "project/radare2/libr/core/cmd_flag.c"
                                         , pj, mode);
 if (mode == 'j') {
  pj_end (pj);
  r_cons_printf ("%s\n", pj_string (pj));
...
static 
# 711 "project/radare2/libr/core/cmd_flag.c" 3 4
      _Bool 
# 711 "project/radare2/libr/core/cmd_flag.c"
           print_function_labels_cb(void *user, const 
# 711 "project/radare2/libr/core/cmd_flag.c" 3 4
                                                      unsigned long long 
# 711 "project/radare2/libr/core/cmd_flag.c"
                                                           addr, const void *v) {
 ...
 case '*':
 case 1:
  r_cons_printf ("f.%s@0x%08"
# 717 "project/radare2/libr/core/cmd_flag.c" 3 4
                            "llx"
# 717 "project/radare2/libr/core/cmd_flag.c"
                                   "\n", name, addr);
  break;
 case 'j':
 ...
 default:
  r_cons_printf ("0x%08"
# 723 "project/radare2/libr/core/cmd_flag.c" 3 4
                       "llx"
# 723 "project/radare2/libr/core/cmd_flag.c"
                              " %s   [%s + %"
# 723 "project/radare2/libr/core/cmd_flag.c" 3 4
                                             "lld"
# 723 "project/radare2/libr/core/cmd_flag.c"
 ...
 return 
# 728 "project/radare2/libr/core/cmd_flag.c" 3 4
       1
# 728 "project/radare2/libr/core/cmd_flag.c"
           ;
}
...
# 733 "project/radare2/libr/core/cmd_flag.c" 3 4
do { if (!(
# 733 "project/radare2/libr/core/cmd_flag.c"
fcn && (rad != 'j' || pj)
# 733 "project/radare2/libr/core/cmd_flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 733 "project/radare2/libr/core/cmd_flag.c"
...
# 734 "project/radare2/libr/core/cmd_flag.c" 3 4
_Bool 
# 734 "project/radare2/libr/core/cmd_flag.c"
     json = rad == 'j';
 if (json) {
  pj_o (pj);
 }
...
# 746 "project/radare2/libr/core/cmd_flag.c" 3 4
do { if (!(
# 746 "project/radare2/libr/core/cmd_flag.c"
anal || fcn
# 746 "project/radare2/libr/core/cmd_flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 746 "project/radare2/libr/core/cmd_flag.c"
...
# 746 "project/radare2/libr/core/cmd_flag.c"
                              ;
 PJ *pj = 
# 747 "project/radare2/libr/core/cmd_flag.c" 3 4
         ((void *)0)
# 747 "project/radare2/libr/core/cmd_flag.c"
             ;
 
# 748 "project/radare2/libr/core/cmd_flag.c" 3 4
_Bool 
# 748 "project/radare2/libr/core/cmd_flag.c"
     json = rad == 'j';
 if (json) {
  pj = pj_new ();
 }
...
# 760 "project/radare2/libr/core/cmd_flag.c" 3 4
 if (
# 760 "project/radare2/libr/core/cmd_flag.c"
 anal->fcns
# 760 "project/radare2/libr/core/cmd_flag.c" 3 4
 ) for (
# 760 "project/radare2/libr/core/cmd_flag.c"
...
# 782 "project/radare2/libr/core/cmd_flag.c" 3 4
unsigned long long 
# 782 "project/radare2/libr/core/cmd_flag.c"
     off = core->offset;
 char *ptr, *str = 
# 783 "project/radare2/libr/core/cmd_flag.c" 3 4
                  ((void *)0)
# 783 "project/radare2/libr/core/cmd_flag.c"
                      ;
 RFlagItem *item;
 char *name = 
# 785 "project/radare2/libr/core/cmd_flag.c" 3 4
             ((void *)0)
# 785 "project/radare2/libr/core/cmd_flag.c"
                 ;
 
# 786 "project/radare2/libr/core/cmd_flag.c" 3 4
long long 
# 786 "project/radare2/libr/core/cmd_flag.c"
     base;
...
rep:
 ...
 case 'f':
  if (input[1] == 's') {
   ...
   if (delta > 0) {
    r_cons_printf ("0x%08"
# 798 "project/radare2/libr/core/cmd_flag.c" 3 4
                         "llx"
# 798 "project/radare2/libr/core/cmd_flag.c"
                                "\n", core->offset + delta);
   }
  } else {
...
# 816 "project/radare2/libr/core/cmd_flag.c" 3 4
  fprintf(__stderrp,
# 816 "project/radare2/libr/core/cmd_flag.c"
...
# 816 "project/radare2/libr/core/cmd_flag.c"
 ...
 case '=':
  ...
  case 0:
   flagbars (core, 
# 826 "project/radare2/libr/core/cmd_flag.c" 3 4
                  ((void *)0)
# 826 "project/radare2/libr/core/cmd_flag.c"
                      );
   break;
  default:
  case '?':
...
# 837 "project/radare2/libr/core/cmd_flag.c" 3 4
  { free((void *)
# 837 "project/radare2/libr/core/cmd_flag.c"
  str
# 837 "project/radare2/libr/core/cmd_flag.c" 3 4
  ); 
# 837 "project/radare2/libr/core/cmd_flag.c"
...
# 856 "project/radare2/libr/core/cmd_flag.c" 3 4
   fprintf(__stderrp,
# 856 "project/radare2/libr/core/cmd_flag.c"
   "Cannot find flag '%s'\n", name
# 856 "project/radare2/libr/core/cmd_flag.c" 3 4
   )
# 856 "project/radare2/libr/core/cmd_flag.c"
...
# 859 "project/radare2/libr/core/cmd_flag.c" 3 4
  fprintf(__stderrp,
# 859 "project/radare2/libr/core/cmd_flag.c"
  "Usage: fa flagname flagalias\n"
# 859 "project/radare2/libr/core/cmd_flag.c" 3 4
  )
# 859 "project/radare2/libr/core/cmd_flag.c"
                                            ;
  ...
  case ' ':
   {
    int n = atoi (input + 1);
    if (n + 
# 870 "project/radare2/libr/core/cmd_flag.c" 3 4
           127 
# 870 "project/radare2/libr/core/cmd_flag.c"
                     + 1 < 
# 870 "project/radare2/libr/core/cmd_flag.c" 3 4
                           0xFFU
# 870 "project/radare2/libr/core/cmd_flag.c"
...
# 872 "project/radare2/libr/core/cmd_flag.c" 3 4
    unsigned long long 
# 872 "project/radare2/libr/core/cmd_flag.c"
         addr = arg? r_num_math (core->num, arg): core->offset;
     r_core_visual_mark_set (core, n + 
# 873 "project/radare2/libr/core/cmd_flag.c" 3 4
                                      127 
# 873 "project/radare2/libr/core/cmd_flag.c"
                                                + 1, addr);
    }
   }
   break;
...
# 891 "project/radare2/libr/core/cmd_flag.c" 3 4
  fprintf(__stderrp,
# 891 "project/radare2/libr/core/cmd_flag.c"
...
# 892 "project/radare2/libr/core/cmd_flag.c" 3 4
  fprintf(__stderrp,
# 892 "project/radare2/libr/core/cmd_flag.c"
  "Example to relocate PIE flags on debugger:\n" " > fR entry0 `dm~:1[1]`\n"
# 892 "project/radare2/libr/core/cmd_flag.c" 3 4
  )
                                
# 893 "project/radare2/libr/core/cmd_flag.c"
                               ;
   break;
  case '?':
...
# 901 "project/radare2/libr/core/cmd_flag.c" 3 4
   unsigned long long 
# 901 "project/radare2/libr/core/cmd_flag.c"
        from, to, mask = 0xffff;
    int ret;
    if (p) {
     char *q = strchr (p + 1, ' ');
...
# 913 "project/radare2/libr/core/cmd_flag.c" 3 4
    fprintf(__stderrp,
# 913 "project/radare2/libr/core/cmd_flag.c"
    "Relocated %d flags\n", ret
# 913 "project/radare2/libr/core/cmd_flag.c" 3 4
    )
# 913 "project/radare2/libr/core/cmd_flag.c"
...
# 915 "project/radare2/libr/core/cmd_flag.c" 3 4
    fprintf(__stderrp,
# 915 "project/radare2/libr/core/cmd_flag.c"
    "Usage: fR [from] [to] ([mask])\n"
# 915 "project/radare2/libr/core/cmd_flag.c" 3 4
    )
# 915 "project/radare2/libr/core/cmd_flag.c"
...
# 916 "project/radare2/libr/core/cmd_flag.c" 3 4
    fprintf(__stderrp,
# 916 "project/radare2/libr/core/cmd_flag.c"
    "Example to relocate PIE flags on debugger:\n" " > fR entry0 `dm~:1[1]`\n"
# 916 "project/radare2/libr/core/cmd_flag.c" 3 4
    )
                                  
# 917 "project/radare2/libr/core/cmd_flag.c"
                                 ;
    }
   }
  }
...
# 936 "project/radare2/libr/core/cmd_flag.c" 3 4
  { free((void *)
# 936 "project/radare2/libr/core/cmd_flag.c"
  str
# 936 "project/radare2/libr/core/cmd_flag.c" 3 4
  ); 
# 936 "project/radare2/libr/core/cmd_flag.c"
...
# 936 "project/radare2/libr/core/cmd_flag.c"
  ...
  case '\0':
   r_cons_printf ("%"
# 939 "project/radare2/libr/core/cmd_flag.c" 3 4
                    "lld"
# 939 "project/radare2/libr/core/cmd_flag.c"
                           " 0x%"
# 939 "project/radare2/libr/core/cmd_flag.c" 3 4
                                 "llx"
# 939 "project/radare2/libr/core/cmd_flag.c"
...
# 944 "project/radare2/libr/core/cmd_flag.c" 3 4
  fprintf(__stderrp,
# 944 "project/radare2/libr/core/cmd_flag.c"
  "Usage: fb [addr] [[flags*]]\n"
# 944 "project/radare2/libr/core/cmd_flag.c" 3 4
  )
# 944 "project/radare2/libr/core/cmd_flag.c"
 ...
 case ' ': {
  ...
  char* s = strchr (cstr, ' ');
  char* s2 = 
# 954 "project/radare2/libr/core/cmd_flag.c" 3 4
            ((void *)0)
# 954 "project/radare2/libr/core/cmd_flag.c"
                , *s3 = 
# 954 "project/radare2/libr/core/cmd_flag.c" 3 4
                        ((void *)0)
# 954 "project/radare2/libr/core/cmd_flag.c"
                            ;
  char* comment = 
# 955 "project/radare2/libr/core/cmd_flag.c" 3 4
                 ((void *)0)
# 955 "project/radare2/libr/core/cmd_flag.c"
                     ;
  
# 956 "project/radare2/libr/core/cmd_flag.c" 3 4
 _Bool 
# 956 "project/radare2/libr/core/cmd_flag.c"
      comment_needs_free = 
# 956 "project/radare2/libr/core/cmd_flag.c" 3 4
                           0
# 956 "project/radare2/libr/core/cmd_flag.c"
...
# 957 "project/radare2/libr/core/cmd_flag.c" 3 4
 unsigned int 
# 957 "project/radare2/libr/core/cmd_flag.c"
      bsze = 1;
  int eqdir = 0;
...
# 980 "project/radare2/libr/core/cmd_flag.c" 3 4
  unsigned long long 
# 980 "project/radare2/libr/core/cmd_flag.c"
       arg = r_num_math (core->num, eq + 1);
    ...
    *s2 = '\0';
     ...
     *s3 = '\0';
     if (!strncmp (s3 + 1, "base64:", 7)) {
      ...
      comment_needs_free = 
# 1001 "project/radare2/libr/core/cmd_flag.c" 3 4
                          1
# 1001 "project/radare2/libr/core/cmd_flag.c"
                              ;
     } else if (s3[1]) {
      comment = s3 + 1;
     }
...
# 1010 "project/radare2/libr/core/cmd_flag.c" 3 4
 _Bool 
# 1010 "project/radare2/libr/core/cmd_flag.c"
      addFlag = 
# 1010 "project/radare2/libr/core/cmd_flag.c" 3 4
                1
# 1010 "project/radare2/libr/core/cmd_flag.c"
                    ;
  if (input[0] == '+') {
   if ((item = r_flag_get_at (core->flags, off, 
# 1012 "project/radare2/libr/core/cmd_flag.c" 3 4
                                               0
# 1012 "project/radare2/libr/core/cmd_flag.c"
                                                    ))) {
    addFlag = 
# 1013 "project/radare2/libr/core/cmd_flag.c" 3 4
             0
# 1013 "project/radare2/libr/core/cmd_flag.c"
                  ;
   }
  }
  if (addFlag) {
...
# 1018 "project/radare2/libr/core/cmd_flag.c" 3 4
   fprintf(__stderrp,
# 1018 "project/radare2/libr/core/cmd_flag.c"
   "Invalid flag name '%s'.\n", cstr
# 1018 "project/radare2/libr/core/cmd_flag.c" 3 4
   )
# 1018 "project/radare2/libr/core/cmd_flag.c"
                                              ;
    return 
# 1019 "project/radare2/libr/core/cmd_flag.c" 3 4
          0
# 1019 "project/radare2/libr/core/cmd_flag.c"
               ;
   }
...
# 1044 "project/radare2/libr/core/cmd_flag.c" 3 4
    fprintf(__stderrp,
# 1044 "project/radare2/libr/core/cmd_flag.c"
    "Cannot find function at 0x%08"
# 1044 "project/radare2/libr/core/cmd_flag.c" 3 4
    "llx"
# 1044 "project/radare2/libr/core/cmd_flag.c"
    "\n", off
 ...
 case '.':
  ...
  if (input[1]) {
   if (input[1] == '*' || input[1] == 'j') {
    if (input[2] == '*') {
     print_function_labels (core->anal, 
# 1062 "project/radare2/libr/core/cmd_flag.c" 3 4
                                       ((void *)0)
# 1062 "project/radare2/libr/core/cmd_flag.c"
                                           , input[1]);
    } else {
     RAnalFunction *fcn = r_anal_get_fcn_in (core->anal, off, 0);
     if (fcn) {
...
# 1068 "project/radare2/libr/core/cmd_flag.c" 3 4
     fprintf(__stderrp,
# 1068 "project/radare2/libr/core/cmd_flag.c"
     "Cannot find function at 0x%08"
# 1068 "project/radare2/libr/core/cmd_flag.c" 3 4
     "llx"
# 1068 "project/radare2/libr/core/cmd_flag.c"
...
# 1088 "project/radare2/libr/core/cmd_flag.c" 3 4
     fprintf(__stderrp,
# 1088 "project/radare2/libr/core/cmd_flag.c"
     "Cannot find function at 0x%08"
# 1088 "project/radare2/libr/core/cmd_flag.c" 3 4
     "llx"
# 1088 "project/radare2/libr/core/cmd_flag.c"
...
# 1098 "project/radare2/libr/core/cmd_flag.c" 3 4
   fprintf(__stderrp,
# 1098 "project/radare2/libr/core/cmd_flag.c"
   "Local flags require a function to work."
# 1098 "project/radare2/libr/core/cmd_flag.c" 3 4
   )
# 1098 "project/radare2/libr/core/cmd_flag.c"
                                                      ;
...
# 1104 "project/radare2/libr/core/cmd_flag.c" 3 4
  fprintf(__stderrp,
# 1104 "project/radare2/libr/core/cmd_flag.c"
  "Usage: fl[a] [flagname] [flagsize]\n"
# 1104 "project/radare2/libr/core/cmd_flag.c" 3 4
  )
# 1104 "project/radare2/libr/core/cmd_flag.c"
                                                   ;
    ...
    *p++ = 0;
    ...
    if (*arg) {
     ...
     if (item) {
      r_cons_printf ("0x%08"
# 1131 "project/radare2/libr/core/cmd_flag.c" 3 4
                           "llx"
# 1131 "project/radare2/libr/core/cmd_flag.c"
                                  "\n", item->size);
     }
    }
   }
   ...
   if (item)
    r_cons_printf ("0x%08"
# 1139 "project/radare2/libr/core/cmd_flag.c" 3 4
                         "llx"
# 1139 "project/radare2/libr/core/cmd_flag.c"
                                "\n", item->size);
  }
  break;
# 1157 "project/radare2/libr/core/cmd_flag.c"
 case 'z':
  cmd_fz (core, input + 1);
  break;
 case 'x':
  if (input[1] == ' ') {
   ...
   if (item) {
    r_cons_printf ("0x%08"
# 1166 "project/radare2/libr/core/cmd_flag.c" 3 4
                         "llx"
# 1166 "project/radare2/libr/core/cmd_flag.c"
                                "\n", item->offset);
    
# 1167 "project/radare2/libr/core/cmd_flag.c" 3 4
   __builtin___snprintf_chk (
# 1167 "project/radare2/libr/core/cmd_flag.c"
   cmd
# 1167 "project/radare2/libr/core/cmd_flag.c" 3 4
   , 
# 1167 "project/radare2/libr/core/cmd_flag.c"
...
# 1168 "project/radare2/libr/core/cmd_flag.c"
                              ;
    r_core_cmd0 (core, cmd);
   }
  } else {
   
# 1172 "project/radare2/libr/core/cmd_flag.c" 3 4
  fprintf(__stderrp,
# 1172 "project/radare2/libr/core/cmd_flag.c"
  "Missing arguments\n"
# 1172 "project/radare2/libr/core/cmd_flag.c" 3 4
  )
# 1172 "project/radare2/libr/core/cmd_flag.c"
 ...
 case 's':
  ...
  case 'r':
   if (input[2] == ' ') {
    ...
    r_str_trim (newname);
    r_flag_space_rename (core->flags, 
# 1193 "project/radare2/libr/core/cmd_flag.c" 3 4
                                     ((void *)0)
# 1193 "project/radare2/libr/core/cmd_flag.c"
                                         , newname);
    free (newname);
   } else {
    
# 1196 "project/radare2/libr/core/cmd_flag.c" 3 4
   fprintf(__stderrp,
# 1196 "project/radare2/libr/core/cmd_flag.c"
   "Usage: fsr [newname]\n"
# 1196 "project/radare2/libr/core/cmd_flag.c" 3 4
   )
# 1196 "project/radare2/libr/core/cmd_flag.c"
  ...
  case '-':
   switch (input[2]) {
   case '*':
    r_flag_space_unset (core->flags, 
# 1205 "project/radare2/libr/core/cmd_flag.c" 3 4
                                    ((void *)0)
# 1205 "project/radare2/libr/core/cmd_flag.c"
                                        );
    break;
   case '.': {
...
# 1232 "project/radare2/libr/core/cmd_flag.c" 3 4
  unsigned long long 
# 1232 "project/radare2/libr/core/cmd_flag.c"
       off = core->offset;
   if (input[2] == ' ') {
...
# 1240 "project/radare2/libr/core/cmd_flag.c" 3 4
   fprintf(__stderrp,
# 1240 "project/radare2/libr/core/cmd_flag.c"
   "Cannot find any flag at 0x%"
# 1240 "project/radare2/libr/core/cmd_flag.c" 3 4
   "llx"
# 1240 "project/radare2/libr/core/cmd_flag.c"
   ".\n", off
...
# 1267 "project/radare2/libr/core/cmd_flag.c" 3 4
  fprintf(__stderrp,
# 1267 "project/radare2/libr/core/cmd_flag.c"
  "Usage: fg[*] ([prefix])\n"
# 1267 "project/radare2/libr/core/cmd_flag.c" 3 4
  )
# 1267 "project/radare2/libr/core/cmd_flag.c"
...
# 1277 "project/radare2/libr/core/cmd_flag.c" 3 4
  if (
# 1277 "project/radare2/libr/core/cmd_flag.c"
  list
# 1277 "project/radare2/libr/core/cmd_flag.c" 3 4
  ) for (
# 1277 "project/radare2/libr/core/cmd_flag.c"
...
# 1294 "project/radare2/libr/core/cmd_flag.c" 3 4
   fprintf(__stderrp,
# 1294 "project/radare2/libr/core/cmd_flag.c"
   "Unknown flag '%s'\n", arg
# 1294 "project/radare2/libr/core/cmd_flag.c" 3 4
   )
# 1294 "project/radare2/libr/core/cmd_flag.c"
 ...
 case 'C':
  if (input[1] == ' ') {
   RFlagItem *item;
   char *q, *p = strdup (input + 2), *dec = 
# 1304 "project/radare2/libr/core/cmd_flag.c" 3 4
                                           ((void *)0)
# 1304 "project/radare2/libr/core/cmd_flag.c"
                                               ;
   q = strchr (p, ' ');
   if (q) {
    *q = 0;
...
# 1316 "project/radare2/libr/core/cmd_flag.c" 3 4
      fprintf(__stderrp,
# 1316 "project/radare2/libr/core/cmd_flag.c"
...
# 1322 "project/radare2/libr/core/cmd_flag.c" 3 4
    fprintf(__stderrp,
# 1322 "project/radare2/libr/core/cmd_flag.c"
    "Cannot find flag with name '%s'\n", p
# 1322 "project/radare2/libr/core/cmd_flag.c" 3 4
    )
# 1322 "project/radare2/libr/core/cmd_flag.c"
                                                    ;
...
# 1329 "project/radare2/libr/core/cmd_flag.c" 3 4
    fprintf(__stderrp,
# 1329 "project/radare2/libr/core/cmd_flag.c"
    "Cannot find item\n"
# 1329 "project/radare2/libr/core/cmd_flag.c" 3 4
    )
# 1329 "project/radare2/libr/core/cmd_flag.c"
...
# 1333 "project/radare2/libr/core/cmd_flag.c" 3 4
        fprintf(__stderrp,
# 1333 "project/radare2/libr/core/cmd_flag.c"
        "Usage: fC [name] [comment]\n"
# 1333 "project/radare2/libr/core/cmd_flag.c" 3 4
        )
# 1333 "project/radare2/libr/core/cmd_flag.c"
                                                ;
...
# 1359 "project/radare2/libr/core/cmd_flag.c" 3 4
    fprintf(__stderrp,
# 1359 "project/radare2/libr/core/cmd_flag.c"
    "Invalid name\n"
# 1359 "project/radare2/libr/core/cmd_flag.c" 3 4
    )
# 1359 "project/radare2/libr/core/cmd_flag.c"
...
# 1362 "project/radare2/libr/core/cmd_flag.c" 3 4
   fprintf(__stderrp,
# 1362 "project/radare2/libr/core/cmd_flag.c"
   "Usage: fr [[old]] [new]\n"
# 1362 "project/radare2/libr/core/cmd_flag.c" 3 4
   )
# 1362 "project/radare2/libr/core/cmd_flag.c"
...
# 1393 "project/radare2/libr/core/cmd_flag.c" 3 4
 fprintf(__stderrp,
# 1393 "project/radare2/libr/core/cmd_flag.c"
 "Usage: fN [[name]] [[realname]]\n"
# 1393 "project/radare2/libr/core/cmd_flag.c" 3 4
 )
# 1393 "project/radare2/libr/core/cmd_flag.c"
                                              ;
 ...
 case 'q':
  ...
  if (input[0] && input[1] == '.') {
   ...
   const RList *list = r_flag_get_list (core->flags, core->offset);
   PJ *pj = 
# 1413 "project/radare2/libr/core/cmd_flag.c" 3 4
           ((void *)0)
# 1413 "project/radare2/libr/core/cmd_flag.c"
               ;
   if (mode == 'j') {
    pj = pj_new ();
    pj_a (pj);
...
# 1420 "project/radare2/libr/core/cmd_flag.c" 3 4
  if (
# 1420 "project/radare2/libr/core/cmd_flag.c"
  list
# 1420 "project/radare2/libr/core/cmd_flag.c" 3 4
  ) for (
# 1420 "project/radare2/libr/core/cmd_flag.c"
...
# 1420 "project/radare2/libr/core/cmd_flag.c"
    ...
    case '*':
     r_cons_printf ("f %s = 0x%08"
# 1423 "project/radare2/libr/core/cmd_flag.c" 3 4
                                 "llx"
# 1423 "project/radare2/libr/core/cmd_flag.c"
 ...
 case 'i':
  if (input[1] == ' ' || (input[1] && input[2] == ' ')) {
   ...
   if (*arg) {
    ...
    char *sp = strchr (arg, ' ');
    if (!sp) {
     char *newarg = r_str_newf ("%c0x%"
# 1457 "project/radare2/libr/core/cmd_flag.c" 3 4
                                      "llx"
# 1457 "project/radare2/libr/core/cmd_flag.c"
                                             " %s+0x%"
# 1457 "project/radare2/libr/core/cmd_flag.c" 3 4
                                                      "llx"
# 1457 "project/radare2/libr/core/cmd_flag.c"
    ...
    free (arg);
    arg = r_str_newf (" 0x%"
# 1468 "project/radare2/libr/core/cmd_flag.c" 3 4
                           "llx"
# 1468 "project/radare2/libr/core/cmd_flag.c"
                                  " 0x%"
# 1468 "project/radare2/libr/core/cmd_flag.c" 3 4
                                        "llx"
# 1468 "project/radare2/libr/core/cmd_flag.c"
   ...
   char *arg = r_str_newf (" 0x%"
# 1475 "project/radare2/libr/core/cmd_flag.c" 3 4
                                "llx"
# 1475 "project/radare2/libr/core/cmd_flag.c"
                                       " 0x%"
# 1475 "project/radare2/libr/core/cmd_flag.c" 3 4
                                             "llx"
# 1475 "project/radare2/libr/core/cmd_flag.c"
...
# 1483 "project/radare2/libr/core/cmd_flag.c" 3 4
  unsigned long long 
# 1483 "project/radare2/libr/core/cmd_flag.c"
       addr = core->offset;
   char *arg = 
# 1484 "project/radare2/libr/core/cmd_flag.c" 3 4
              ((void *)0)
# 1484 "project/radare2/libr/core/cmd_flag.c"
                  ;
   RFlagItem *f = 
# 1485 "project/radare2/libr/core/cmd_flag.c" 3 4
                 ((void *)0)
# 1485 "project/radare2/libr/core/cmd_flag.c"
                     ;
   
# 1486 "project/radare2/libr/core/cmd_flag.c" 3 4
  _Bool 
# 1486 "project/radare2/libr/core/cmd_flag.c"
       strict_offset = 
# 1486 "project/radare2/libr/core/cmd_flag.c" 3 4
                       0
# 1486 "project/radare2/libr/core/cmd_flag.c"
   ...
   case '?':
    ...
    return 
# 1493 "project/radare2/libr/core/cmd_flag.c" 3 4
          0
# 1493 "project/radare2/libr/core/cmd_flag.c"
               ;
   case '\0':
    addr = core->offset;
    break;
...
# 1507 "project/radare2/libr/core/cmd_flag.c" 3 4
   _Bool 
# 1507 "project/radare2/libr/core/cmd_flag.c"
        isJson = 
# 1507 "project/radare2/libr/core/cmd_flag.c" 3 4
                 0
# 1507 "project/radare2/libr/core/cmd_flag.c"
...
# 1521 "project/radare2/libr/core/cmd_flag.c" 3 4
   if (
# 1521 "project/radare2/libr/core/cmd_flag.c"
   flaglist
# 1521 "project/radare2/libr/core/cmd_flag.c" 3 4
   ) for (
# 1521 "project/radare2/libr/core/cmd_flag.c"
...
# 1564 "project/radare2/libr/core/cmd_flag.c" 3 4
                                     1
# 1564 "project/radare2/libr/core/cmd_flag.c"
                                         );
    
# 1565 "project/radare2/libr/core/cmd_flag.c" 3 4
   unsigned long long 
# 1565 "project/radare2/libr/core/cmd_flag.c"
        loff = 0;
    
# 1566 "project/radare2/libr/core/cmd_flag.c" 3 4
   unsigned long long 
# 1566 "project/radare2/libr/core/cmd_flag.c"
        uoff = 0;
    
# 1567 "project/radare2/libr/core/cmd_flag.c" 3 4
   unsigned long long 
# 1567 "project/radare2/libr/core/cmd_flag.c"
        curseek = core->offset;
    char *lmatch = 
# 1568 "project/radare2/libr/core/cmd_flag.c" 3 4
                  ((void *)0) 
# 1568 "project/radare2/libr/core/cmd_flag.c"
                       , *umatch = 
# 1568 "project/radare2/libr/core/cmd_flag.c" 3 4
                                   ((void *)0)
# 1568 "project/radare2/libr/core/cmd_flag.c"
...
# 1572 "project/radare2/libr/core/cmd_flag.c" 3 4
   if (
# 1572 "project/radare2/libr/core/cmd_flag.c"
   temp
# 1572 "project/radare2/libr/core/cmd_flag.c" 3 4
   ) for (
# 1572 "project/radare2/libr/core/cmd_flag.c"
...
# 1573 "project/radare2/libr/core/cmd_flag.c" 3 4
                                     ((void *)0)
# 1573 "project/radare2/libr/core/cmd_flag.c"
                                         ) {
