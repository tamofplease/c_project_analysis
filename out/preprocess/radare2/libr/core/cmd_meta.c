# 0 "project/radare2/libr/core/cmd_meta.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/cmd_meta.c"
...
# 4 "project/radare2/libr/core/cmd_meta.c" 2
...
# 7 "project/radare2/libr/core/cmd_meta.c" 2





# 11 "project/radare2/libr/core/cmd_meta.c"
...
# 40 "project/radare2/libr/core/cmd_meta.c" 3 4
((void *)0)

# 41 "project/radare2/libr/core/cmd_meta.c"
};
...
# 58 "project/radare2/libr/core/cmd_meta.c" 3 4
((void *)0)

# 59 "project/radare2/libr/core/cmd_meta.c"
};
...
# 67 "project/radare2/libr/core/cmd_meta.c" 3 4
((void *)0)

# 68 "project/radare2/libr/core/cmd_meta.c"
};
...
# 81 "project/radare2/libr/core/cmd_meta.c" 3 4
((void *)0)

# 82 "project/radare2/libr/core/cmd_meta.c"
};
...
# 99 "project/radare2/libr/core/cmd_meta.c" 3 4
((void *)0)

# 100 "project/radare2/libr/core/cmd_meta.c"
};
...
# 111 "project/radare2/libr/core/cmd_meta.c" 3 4
((void *)0)

# 112 "project/radare2/libr/core/cmd_meta.c"
};
...
# 123 "project/radare2/libr/core/cmd_meta.c" 3 4
((void *)0)

# 124 "project/radare2/libr/core/cmd_meta.c"
};
...
# 135 "project/radare2/libr/core/cmd_meta.c" 3 4
((void *)0)

# 136 "project/radare2/libr/core/cmd_meta.c"
};

static int remove_meta_offset(RCore *core, 
# 138 "project/radare2/libr/core/cmd_meta.c" 3 4
                                          unsigned long long 
# 138 "project/radare2/libr/core/cmd_meta.c"
                                               offset) {
 char aoffset[64];
 char *aoffsetptr = sdb_itoa (offset, aoffset, 16);
 if (!aoffsetptr) {
  
# 142 "project/radare2/libr/core/cmd_meta.c" 3 4
 fprintf(__stderrp,
# 142 "project/radare2/libr/core/cmd_meta.c"
 "Failed to convert %"
# 142 "project/radare2/libr/core/cmd_meta.c" 3 4
 "llx"
# 142 "project/radare2/libr/core/cmd_meta.c"
...
static 
# 148 "project/radare2/libr/core/cmd_meta.c" 3 4
      _Bool 
# 148 "project/radare2/libr/core/cmd_meta.c"
           print_meta_offset(RCore *core, 
# 148 "project/radare2/libr/core/cmd_meta.c" 3 4
                                          unsigned long long 
# 148 "project/radare2/libr/core/cmd_meta.c"
                                               addr, PJ *pj) {
...
# 169 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                 "llx"
# 169 "project/radare2/libr/core/cmd_meta.c"
                                                        "\n", file, line, addr);
  line_old = line;
  if (line >= 2) {
   line -= 2;
...
# 183 "project/radare2/libr/core/cmd_meta.c" 3 4
  fprintf(__stderrp,
# 183 "project/radare2/libr/core/cmd_meta.c"
  "Cannot open '%s'\n", file
# 183 "project/radare2/libr/core/cmd_meta.c" 3 4
  )
# 183 "project/radare2/libr/core/cmd_meta.c"
...
# 205 "project/radare2/libr/core/cmd_meta.c"
static 
# 205 "project/radare2/libr/core/cmd_meta.c" 3 4
      unsigned long long 
# 205 "project/radare2/libr/core/cmd_meta.c"
           filter_offset = 
# 205 "project/radare2/libr/core/cmd_meta.c" 3 4
...
static 
# 209 "project/radare2/libr/core/cmd_meta.c" 3 4
      _Bool 
# 209 "project/radare2/libr/core/cmd_meta.c"
           print_addrinfo_json(void *user, const char *k, const char *v) {
 
# 210 "project/radare2/libr/core/cmd_meta.c" 3 4
unsigned long long 
# 210 "project/radare2/libr/core/cmd_meta.c"
     offset = sdb_atoi (k);
 if (!offset || offset == 
# 211 "project/radare2/libr/core/cmd_meta.c" 3 4
                         0xFFFFFFFFFFFFFFFFULL
# 211 "project/radare2/libr/core/cmd_meta.c"
                                 ) {
  return 
# 212 "project/radare2/libr/core/cmd_meta.c" 3 4
        1
# 212 "project/radare2/libr/core/cmd_meta.c"
            ;
 }
 char *subst = strdup (v);
 ...
 if (colonpos && (filter_offset == 
# 222 "project/radare2/libr/core/cmd_meta.c" 3 4
                                  0xFFFFFFFFFFFFFFFFULL 
# 222 "project/radare2/libr/core/cmd_meta.c"
...
# 234 "project/radare2/libr/core/cmd_meta.c" 3 4
unsigned long long 
# 234 "project/radare2/libr/core/cmd_meta.c"
     addr = offset;
 PJ *pj = (PJ*)user;
 pj_o (pj);
 pj_ks (pj, "file", file);
 ...
 free (subst);
 return 
# 249 "project/radare2/libr/core/cmd_meta.c" 3 4
       1
# 249 "project/radare2/libr/core/cmd_meta.c"
           ;
}

static 
# 252 "project/radare2/libr/core/cmd_meta.c" 3 4
      _Bool 
# 252 "project/radare2/libr/core/cmd_meta.c"
           print_addrinfo(void *user, const char *k, const char *v) {
 
# 253 "project/radare2/libr/core/cmd_meta.c" 3 4
unsigned long long 
# 253 "project/radare2/libr/core/cmd_meta.c"
     offset = sdb_atoi (k);
 if (!offset || offset == 
# 254 "project/radare2/libr/core/cmd_meta.c" 3 4
                         0xFFFFFFFFFFFFFFFFULL
# 254 "project/radare2/libr/core/cmd_meta.c"
                                 ) {
  return 
# 255 "project/radare2/libr/core/cmd_meta.c" 3 4
        1
# 255 "project/radare2/libr/core/cmd_meta.c"
            ;
 }
 char *subst = strdup (v);
 char *colonpos = strchr (subst, '|');
 ...
 if (colonpos && (filter_offset == 
# 265 "project/radare2/libr/core/cmd_meta.c" 3 4
                                  0xFFFFFFFFFFFFFFFFULL 
# 265 "project/radare2/libr/core/cmd_meta.c"
                                           || filter_offset == offset)) {
  if (filter_format) {
   *colonpos = ':';
   ...
   *colonpos = 0;
   r_cons_printf ("file: %s\nline: %s\naddr: 0x%08"
# 271 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                  "llx"
# 271 "project/radare2/libr/core/cmd_meta.c"
 ...
 return 
# 277 "project/radare2/libr/core/cmd_meta.c" 3 4
       1
# 277 "project/radare2/libr/core/cmd_meta.c"
           ;
}

static int cmd_meta_add_fileline(Sdb *s, char *fileline, 
# 280 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                        unsigned long long 
# 280 "project/radare2/libr/core/cmd_meta.c"
                                                             offset) {
 char aoffset[64];
 char *aoffsetptr = sdb_itoa (offset, aoffset, 16);
...
# 298 "project/radare2/libr/core/cmd_meta.c" 3 4
unsigned long long 
# 298 "project/radare2/libr/core/cmd_meta.c"
     offset = 
# 298 "project/radare2/libr/core/cmd_meta.c" 3 4
              0xFFFFFFFFFFFFFFFFULL
# 298 "project/radare2/libr/core/cmd_meta.c"
...
# 299 "project/radare2/libr/core/cmd_meta.c" 3 4
_Bool 
# 299 "project/radare2/libr/core/cmd_meta.c"
     remove = 
# 299 "project/radare2/libr/core/cmd_meta.c" 3 4
              0
# 299 "project/radare2/libr/core/cmd_meta.c"
...
# 300 "project/radare2/libr/core/cmd_meta.c" 3 4
_Bool 
# 300 "project/radare2/libr/core/cmd_meta.c"
     use_json = 
# 300 "project/radare2/libr/core/cmd_meta.c" 3 4
                0
# 300 "project/radare2/libr/core/cmd_meta.c"
                     ;
 int all = 
# 301 "project/radare2/libr/core/cmd_meta.c" 3 4
          0
# 301 "project/radare2/libr/core/cmd_meta.c"
               ;
 const char *p = input;
 char *file_line = 
# 303 "project/radare2/libr/core/cmd_meta.c" 3 4
                  ((void *)0)
# 303 "project/radare2/libr/core/cmd_meta.c"
                      ;
 char *pheap = 
# 304 "project/radare2/libr/core/cmd_meta.c" 3 4
              ((void *)0)
# 304 "project/radare2/libr/core/cmd_meta.c"
                  ;

 if (*p == '?') {
  
# 307 "project/radare2/libr/core/cmd_meta.c" 3 4
 fprintf(__stderrp,
# 307 "project/radare2/libr/core/cmd_meta.c"
 "Usage: CL[.-*?] [addr] [file:line]\n"
# 307 "project/radare2/libr/core/cmd_meta.c" 3 4
 )
# 307 "project/radare2/libr/core/cmd_meta.c"
                                                 ;
  
# 308 "project/radare2/libr/core/cmd_meta.c" 3 4
 fprintf(__stderrp,
# 308 "project/radare2/libr/core/cmd_meta.c"
 "or: CL [addr] base64:[string]\n"
# 308 "project/radare2/libr/core/cmd_meta.c" 3 4
 )
# 308 "project/radare2/libr/core/cmd_meta.c"
                                            ;
 ...
 if (*p == '-') {
  p++;
  remove = 
# 314 "project/radare2/libr/core/cmd_meta.c" 3 4
          1
# 314 "project/radare2/libr/core/cmd_meta.c"
              ;
 }
 if (*p == 'j') {
  p++;
  use_json = 
# 318 "project/radare2/libr/core/cmd_meta.c" 3 4
            1
# 318 "project/radare2/libr/core/cmd_meta.c"
                ;
 }
 if (*p == '.') {
  p++;
 ...
 if (*p == ' ') {
  ...
  p++;
  all = 
# 333 "project/radare2/libr/core/cmd_meta.c" 3 4
       1
# 333 "project/radare2/libr/core/cmd_meta.c"
           ;
  filter_format = '*';
 } else {
  filter_format = 0;
 ...
 if (all) {
  if (remove) {
   ...
   sdb_foreach (core->bin->cur->sdb_addrinfo, print_addrinfo, 
# 343 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                             ((void *)0)
# 343 "project/radare2/libr/core/cmd_meta.c"
                                                                 );
  }
  free (pheap);
  return 0;
  ...
  *sp = 0;
  sp++;
  if (offset == 
# 355 "project/radare2/libr/core/cmd_meta.c" 3 4
               0xFFFFFFFFFFFFFFFFULL
# 355 "project/radare2/libr/core/cmd_meta.c"
                       ) {
...
# 361 "project/radare2/libr/core/cmd_meta.c" 3 4
  unsigned char 
# 361 "project/radare2/libr/core/cmd_meta.c"
      *o = sdb_decode (sp + 7, &len);
   if (!o) {
    
# 363 "project/radare2/libr/core/cmd_meta.c" 3 4
   fprintf(__stderrp,
# 363 "project/radare2/libr/core/cmd_meta.c"
   "Invalid base64\n"
# 363 "project/radare2/libr/core/cmd_meta.c" 3 4
   )
# 363 "project/radare2/libr/core/cmd_meta.c"
...
# 373 "project/radare2/libr/core/cmd_meta.c" 3 4
  fprintf(__stderrp,
# 373 "project/radare2/libr/core/cmd_meta.c"
  "TODO: Support global SdbAddrinfo or dummy rbinfile to handlee this case\n"
# 373 "project/radare2/libr/core/cmd_meta.c" 3 4
  )
# 373 "project/radare2/libr/core/cmd_meta.c"
                                                                                       ;
 ...
 if (remove) {
  ...
  if (use_json) {
   ...
   sdb_foreach (core->bin->cur->sdb_addrinfo, print_addrinfo, 
# 399 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                             ((void *)0)
# 399 "project/radare2/libr/core/cmd_meta.c"
                                                                 );
   if (filter_count == 0) {
    print_meta_offset (core, offset, 
# 401 "project/radare2/libr/core/cmd_meta.c" 3 4
                                    ((void *)0)
# 401 "project/radare2/libr/core/cmd_meta.c"
                                        );
   }
  }
 }
...
# 410 "project/radare2/libr/core/cmd_meta.c" 3 4
unsigned long long 
# 410 "project/radare2/libr/core/cmd_meta.c"
     addr = core->offset;
 switch (input[1]) {
 case '?':
...
# 420 "project/radare2/libr/core/cmd_meta.c" 3 4
  fprintf(__stderrp,
# 420 "project/radare2/libr/core/cmd_meta.c"
  "Usage: CCF [file]\n"
# 420 "project/radare2/libr/core/cmd_meta.c" 3 4
  )
# 420 "project/radare2/libr/core/cmd_meta.c"
   ...
   if (comment && *comment) {
    ...
    if (cmtfile && *cmtfile) {
     ...
     r_cons_printf ("%s"
# 441 "project/radare2/libr/core/cmd_meta.c" 3 4
                       "/"
# 441 "project/radare2/libr/core/cmd_meta.c"
                                "%s\n", cwd, cmtfile);
     free (cwd);
    }
    free (cmtfile);
...
# 450 "project/radare2/libr/core/cmd_meta.c" 3 4
    unsigned long long 
# 450 "project/radare2/libr/core/cmd_meta.c"
         at = input[2]? r_num_math (core->num, input + 2): addr;
...
# 458 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                            ((void *)0)
# 458 "project/radare2/libr/core/cmd_meta.c"
                                                                );
  break;
 case 'f':
  switch (input[2]) {
...
# 464 "project/radare2/libr/core/cmd_meta.c" 3 4
   unsigned long long 
# 464 "project/radare2/libr/core/cmd_meta.c"
        arg = r_num_math (core->num, input + 2);
    if (!arg) {
     arg = core->offset;
    }
...
# 472 "project/radare2/libr/core/cmd_meta.c" 3 4
    if (
# 472 "project/radare2/libr/core/cmd_meta.c"
    fcn->bbs
# 472 "project/radare2/libr/core/cmd_meta.c" 3 4
    ) for (
# 472 "project/radare2/libr/core/cmd_meta.c"
...
# 475 "project/radare2/libr/core/cmd_meta.c" 3 4
      unsigned long long 
# 475 "project/radare2/libr/core/cmd_meta.c"
           addr = bb->addr + i;
...
# 486 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                                                     ((void *)0)
# 486 "project/radare2/libr/core/cmd_meta.c"
                                                                                         );
   break;
  case '*':
   r_meta_print_list_in_function (core->anal, R_META_TYPE_COMMENT, 1, core->offset, 
# 489 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                                                   ((void *)0)
# 489 "project/radare2/libr/core/cmd_meta.c"
                                                                                       );
   break;
  default:
   r_meta_print_list_in_function (core->anal, R_META_TYPE_COMMENT, 0, core->offset, 
# 492 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                                                   ((void *)0)
# 492 "project/radare2/libr/core/cmd_meta.c"
                                                                                       );
   break;
  }
  break;
...
# 503 "project/radare2/libr/core/cmd_meta.c" 3 4
                             ((void *)0)
# 503 "project/radare2/libr/core/cmd_meta.c"
                                 , comment);
   if (out) {

    r_core_cmdf (core, "CC-@0x%08"
# 506 "project/radare2/libr/core/cmd_meta.c" 3 4
                                 "llx"
# 506 "project/radare2/libr/core/cmd_meta.c"
                                        , addr);
...
# 525 "project/radare2/libr/core/cmd_meta.c" 3 4
   __builtin___strcpy_chk (
# 525 "project/radare2/libr/core/cmd_meta.c"
   text
# 525 "project/radare2/libr/core/cmd_meta.c" 3 4
   , 
# 525 "project/radare2/libr/core/cmd_meta.c"
...
# 526 "project/radare2/libr/core/cmd_meta.c" 3 4
   __builtin___strcat_chk (
# 526 "project/radare2/libr/core/cmd_meta.c"
   text
# 526 "project/radare2/libr/core/cmd_meta.c" 3 4
   , 
# 526 "project/radare2/libr/core/cmd_meta.c"
...
# 527 "project/radare2/libr/core/cmd_meta.c" 3 4
   __builtin___strcat_chk (
# 527 "project/radare2/libr/core/cmd_meta.c"
   text
# 527 "project/radare2/libr/core/cmd_meta.c" 3 4
   , 
# 527 "project/radare2/libr/core/cmd_meta.c"
...
# 531 "project/radare2/libr/core/cmd_meta.c" 3 4
   r_sys_perror_str(
# 531 "project/radare2/libr/core/cmd_meta.c"
   "malloc"
# 531 "project/radare2/libr/core/cmd_meta.c" 3 4
   );
# 531 "project/radare2/libr/core/cmd_meta.c"
...
# 540 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                            ((void *)0)
# 540 "project/radare2/libr/core/cmd_meta.c"
                                                                );
  break;
 case '-':
  if (input[2] == '*') {
   r_meta_del (core->anal, R_META_TYPE_COMMENT, 
# 544 "project/radare2/libr/core/cmd_meta.c" 3 4
                                               0xFFFFFFFFFFFFFFFFULL
# 544 "project/radare2/libr/core/cmd_meta.c"
                                                       , 
# 544 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                         0xFFFFFFFFFFFFFFFFULL
# 544 "project/radare2/libr/core/cmd_meta.c"
...
# 546 "project/radare2/libr/core/cmd_meta.c" 3 4
  unsigned long long 
# 546 "project/radare2/libr/core/cmd_meta.c"
       arg = r_num_math (core->num, input + 2);
 ...
 case 'u':
  ...
  if (!strncmp (arg, "base64:", 7)) {
   char *s = (char *)sdb_decode (arg + 7, 
# 559 "project/radare2/libr/core/cmd_meta.c" 3 4
                                         ((void *)0)
# 559 "project/radare2/libr/core/cmd_meta.c"
                                             );
   if (s) {
    newcomment = s;
   } else {
    newcomment = 
# 563 "project/radare2/libr/core/cmd_meta.c" 3 4
                ((void *)0)
# 563 "project/radare2/libr/core/cmd_meta.c"
                    ;
   }
  } else {
...
# 584 "project/radare2/libr/core/cmd_meta.c" 3 4
  fprintf(__stderrp,
# 584 "project/radare2/libr/core/cmd_meta.c"
  "Usage\n"
# 584 "project/radare2/libr/core/cmd_meta.c" 3 4
  )
# 584 "project/radare2/libr/core/cmd_meta.c"
                     ;
   return 
# 585 "project/radare2/libr/core/cmd_meta.c" 3 4
         0
# 585 "project/radare2/libr/core/cmd_meta.c"
              ;
  }
  p = strchr (s, ' ');
  if (p) {
...
# 591 "project/radare2/libr/core/cmd_meta.c" 3 4
 unsigned long long 
# 591 "project/radare2/libr/core/cmd_meta.c"
      addr;
  if (input[2]=='-') {
   if (input[3]) {
...
# 598 "project/radare2/libr/core/cmd_meta.c" 3 4
         fprintf(__stderrp,
# 598 "project/radare2/libr/core/cmd_meta.c"
         "Usage: CCa-[address]\n"
# 598 "project/radare2/libr/core/cmd_meta.c" 3 4
         )
# 598 "project/radare2/libr/core/cmd_meta.c"
   ...
   free (s);
   return 
# 600 "project/radare2/libr/core/cmd_meta.c" 3 4
         1
# 600 "project/radare2/libr/core/cmd_meta.c"
             ;
  }
...
# 618 "project/radare2/libr/core/cmd_meta.c" 3 4
  fprintf(__stderrp,
# 618 "project/radare2/libr/core/cmd_meta.c"
  "Usage: CCa [address] [comment]\n"
# 618 "project/radare2/libr/core/cmd_meta.c" 3 4
  )
# 618 "project/radare2/libr/core/cmd_meta.c"
                                              ;
  ...
  free (s);
  return 
# 621 "project/radare2/libr/core/cmd_meta.c" 3 4
        1
# 621 "project/radare2/libr/core/cmd_meta.c"
            ;
  }
 }
 return 
# 624 "project/radare2/libr/core/cmd_meta.c" 3 4
       1
# 624 "project/radare2/libr/core/cmd_meta.c"
           ;
}

static int cmd_meta_vartype_comment(RCore *core, const char *input) {
 
# 628 "project/radare2/libr/core/cmd_meta.c" 3 4
unsigned long long 
# 628 "project/radare2/libr/core/cmd_meta.c"
     addr = core->offset;
 switch (input[1]) {
 case '?':
...
# 634 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                            ((void *)0)
# 634 "project/radare2/libr/core/cmd_meta.c"
                                                                );
  break;
 case ' ':
  {
...
# 648 "project/radare2/libr/core/cmd_meta.c" 3 4
   r_sys_perror_str(
# 648 "project/radare2/libr/core/cmd_meta.c"
   "malloc"
# 648 "project/radare2/libr/core/cmd_meta.c" 3 4
   );
# 648 "project/radare2/libr/core/cmd_meta.c"
...
# 658 "project/radare2/libr/core/cmd_meta.c" 3 4
 unsigned long long 
# 658 "project/radare2/libr/core/cmd_meta.c"
      at = input[2]? r_num_math (core->num, input + 2): addr;
 ...
 return 
# 673 "project/radare2/libr/core/cmd_meta.c" 3 4
       1
# 673 "project/radare2/libr/core/cmd_meta.c"
           ;
}
...
# 680 "project/radare2/libr/core/cmd_meta.c" 3 4
unsigned long long 
# 680 "project/radare2/libr/core/cmd_meta.c"
     addr = core->offset;
 ...
 case '-':
  switch (input[2]) {
  case '*':
   r_meta_del (core->anal, input[0], 0, 
# 710 "project/radare2/libr/core/cmd_meta.c" 3 4
                                       0xFFFFFFFFFFFFFFFFULL
# 710 "project/radare2/libr/core/cmd_meta.c"
                                               );
   break;
  case ' ':
   p2 = strchr (input + 3, ' ');
...
# 715 "project/radare2/libr/core/cmd_meta.c" 3 4
   unsigned long long 
# 715 "project/radare2/libr/core/cmd_meta.c"
        i;
    
# 716 "project/radare2/libr/core/cmd_meta.c" 3 4
   unsigned long long 
# 716 "project/radare2/libr/core/cmd_meta.c"
        size = r_num_math (core->num, input + 3);
    
# 717 "project/radare2/libr/core/cmd_meta.c" 3 4
   unsigned long long 
# 717 "project/radare2/libr/core/cmd_meta.c"
        rep = r_num_math (core->num, p2 + 1);
    
# 718 "project/radare2/libr/core/cmd_meta.c" 3 4
   unsigned long long 
# 718 "project/radare2/libr/core/cmd_meta.c"
        cur_addr = addr;
    if (!size) {
     break;
    }
    for (i = 0; i < rep && 
# 722 "project/radare2/libr/core/cmd_meta.c" 3 4
                          0xFFFFFFFFFFFFFFFFULL 
# 722 "project/radare2/libr/core/cmd_meta.c"
                                   - cur_addr > size; i++, cur_addr += size) {
...
# 736 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                 ((void *)0)
# 736 "project/radare2/libr/core/cmd_meta.c"
                                                     );
  break;
 case 'j':
  r_meta_print_list_all (core->anal, input[0], 'j', 
# 739 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                   ((void *)0)
# 739 "project/radare2/libr/core/cmd_meta.c"
                                                       );
  break;
 case '!':
  {
   ...
   const char *comment = r_meta_get_string (core->anal, R_META_TYPE_COMMENT, addr);
   out = r_core_editor (core, 
# 745 "project/radare2/libr/core/cmd_meta.c" 3 4
                             ((void *)0)
# 745 "project/radare2/libr/core/cmd_meta.c"
                                 , comment);
   if (out) {

    r_core_cmdf (core, "CC-@0x%08"
# 748 "project/radare2/libr/core/cmd_meta.c" 3 4
                                 "llx"
# 748 "project/radare2/libr/core/cmd_meta.c"
                                        , addr);
...
# 757 "project/radare2/libr/core/cmd_meta.c" 3 4
  unsigned long long 
# 757 "project/radare2/libr/core/cmd_meta.c"
       size;
   RAnalMetaItem *mi = r_meta_get_at (core->anal, addr, type, &size);
   if (mi) {
    r_meta_print (core->anal, mi, addr, size, input[3], 
# 760 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                       ((void *)0)
# 760 "project/radare2/libr/core/cmd_meta.c"
                                                           , 
# 760 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                             0
# 760 "project/radare2/libr/core/cmd_meta.c"
...
# 764 "project/radare2/libr/core/cmd_meta.c" 3 4
  unsigned long long 
# 764 "project/radare2/libr/core/cmd_meta.c"
       size;
   RAnalMetaItem *mi = r_meta_get_at (core->anal, addr, type, &size);
   if (mi) {
    r_meta_print (core->anal, mi, addr, size, input[2], 
# 767 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                       ((void *)0)
# 767 "project/radare2/libr/core/cmd_meta.c"
                                                           , 
# 767 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                             0
# 767 "project/radare2/libr/core/cmd_meta.c"
...
# 772 "project/radare2/libr/core/cmd_meta.c" 3 4
 unsigned long long 
# 772 "project/radare2/libr/core/cmd_meta.c"
      size;
  RAnalMetaItem *mi = r_meta_get_at (core->anal, addr, type, &size);
  if (!mi) {
   break;
...
# 779 "project/radare2/libr/core/cmd_meta.c" 3 4
  _Bool 
# 779 "project/radare2/libr/core/cmd_meta.c"
       esc_bslash = core->print->esc_bslash;
   switch (mi->subtype) {
   case R_STRING_ENC_UTF8:
    esc_str = r_str_escape_utf8 (mi->str, 
# 782 "project/radare2/libr/core/cmd_meta.c" 3 4
                                         0
# 782 "project/radare2/libr/core/cmd_meta.c"
                                              , esc_bslash);
    break;
   case 0:
    esc_bslash = 
# 785 "project/radare2/libr/core/cmd_meta.c" 3 4
                0
# 785 "project/radare2/libr/core/cmd_meta.c"
                     ;
   default:
    esc_str = r_str_escape_latin1 (mi->str, 
# 787 "project/radare2/libr/core/cmd_meta.c" 3 4
                                           0
# 787 "project/radare2/libr/core/cmd_meta.c"
                                                , esc_bslash, 
# 787 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                              0
# 787 "project/radare2/libr/core/cmd_meta.c"
   ...
   r_cons_printf ("%"
# 796 "project/radare2/libr/core/cmd_meta.c" 3 4
                    "llu"
# 796 "project/radare2/libr/core/cmd_meta.c"
                           "\n", size);
  } else {
...
# 823 "project/radare2/libr/core/cmd_meta.c" 3 4
                                               ((void *)0)
# 823 "project/radare2/libr/core/cmd_meta.c"
                                                   );
    break;
   }
  }
  ...
  while (repcnt < repeat) {
   ...
   p = 
# 846 "project/radare2/libr/core/cmd_meta.c" 3 4
      ((void *)0)
# 846 "project/radare2/libr/core/cmd_meta.c"
          ;
   n = 0;
   
# 848 "project/radare2/libr/core/cmd_meta.c" 3 4
  __builtin___strncpy_chk (
# 848 "project/radare2/libr/core/cmd_meta.c"
  name
# 848 "project/radare2/libr/core/cmd_meta.c" 3 4
  , 
# 848 "project/radare2/libr/core/cmd_meta.c"
...
# 860 "project/radare2/libr/core/cmd_meta.c" 3 4
       fprintf(__stderrp,
# 860 "project/radare2/libr/core/cmd_meta.c"
       "Cannot resolve format '%s'\n", p + 1
# 860 "project/radare2/libr/core/cmd_meta.c" 3 4
       )
# 860 "project/radare2/libr/core/cmd_meta.c"
                                                      ;
...
# 867 "project/radare2/libr/core/cmd_meta.c" 3 4
       fprintf(__stderrp,
# 867 "project/radare2/libr/core/cmd_meta.c"
       "Warning: Cannot resolve struct size for '%s'\n", p
# 867 "project/radare2/libr/core/cmd_meta.c" 3 4
       )
# 867 "project/radare2/libr/core/cmd_meta.c"
                                                                    ;
      ...
      int r = r_print_format (core->print, addr, core->block,
       n, p, 0, 
# 876 "project/radare2/libr/core/cmd_meta.c" 3 4
               ((void *)0)
# 876 "project/radare2/libr/core/cmd_meta.c"
                   , 
# 876 "project/radare2/libr/core/cmd_meta.c" 3 4
                     ((void *)0)
# 876 "project/radare2/libr/core/cmd_meta.c"
...
# 881 "project/radare2/libr/core/cmd_meta.c" 3 4
     fprintf(__stderrp,
# 881 "project/radare2/libr/core/cmd_meta.c"
     "Usage: Cf [size] [pf-format-string]\n"
# 881 "project/radare2/libr/core/cmd_meta.c" 3 4
     )
# 881 "project/radare2/libr/core/cmd_meta.c"
                                                      ;
     ...
     char tmp[256] = 
# 885 "project/radare2/libr/core/cmd_meta.c" 3 4
                    { 0 }
# 885 "project/radare2/libr/core/cmd_meta.c"
                           ;
     int i, j, name_len = 0;
     if (input[1] == 'a' || input[1] == '8') {
      (void)r_io_read_at (core->io, addr, (
# 888 "project/radare2/libr/core/cmd_meta.c" 3 4
                                          unsigned char
# 888 "project/radare2/libr/core/cmd_meta.c"
                                             *)name, sizeof (name) - 1);
      name[sizeof (name) - 1] = '\0';
      name_len = strlen (name);
     } else {
      (void)r_io_read_at (core->io, addr, (
# 892 "project/radare2/libr/core/cmd_meta.c" 3 4
                                          unsigned char
# 892 "project/radare2/libr/core/cmd_meta.c"
                                             *)tmp, sizeof (tmp) - 3);
    ...
    if (n < 1) {
     ...
     return 
# 921 "project/radare2/libr/core/cmd_meta.c" 3 4
           0
# 921 "project/radare2/libr/core/cmd_meta.c"
                ;
    }
    if (!*t || n > 0) {
     RFlagItem *fi;
...
# 929 "project/radare2/libr/core/cmd_meta.c" 3 4
     __builtin___strncpy_chk (
# 929 "project/radare2/libr/core/cmd_meta.c"
     name
# 929 "project/radare2/libr/core/cmd_meta.c" 3 4
     , 
# 929 "project/radare2/libr/core/cmd_meta.c"
...
# 934 "project/radare2/libr/core/cmd_meta.c" 3 4
       __builtin___strncpy_chk (
# 934 "project/radare2/libr/core/cmd_meta.c"
       name
# 934 "project/radare2/libr/core/cmd_meta.c" 3 4
       , 
# 934 "project/radare2/libr/core/cmd_meta.c"
       fi->name, sizeof (name)-1
# 934 "project/radare2/libr/core/cmd_meta.c" 3 4
       , __builtin_object_size (
# 934 "project/radare2/libr/core/cmd_meta.c"
       name
...
# 963 "project/radare2/libr/core/cmd_meta.c" 3 4
 fprintf(__stderrp,
# 963 "project/radare2/libr/core/cmd_meta.c"
 "Missing space after CC\n"
# 963 "project/radare2/libr/core/cmd_meta.c" 3 4
 )
# 963 "project/radare2/libr/core/cmd_meta.c"
                                     ;
 ...
 return 
# 967 "project/radare2/libr/core/cmd_meta.c" 3 4
       1
# 967 "project/radare2/libr/core/cmd_meta.c"
           ;
}
...
void r_comment_vars(RCore *core, const char *input) {
 ...
 char *oname = 
# 989 "project/radare2/libr/core/cmd_meta.c" 3 4
              ((void *)0)
# 989 "project/radare2/libr/core/cmd_meta.c"
                  , *name = 
# 989 "project/radare2/libr/core/cmd_meta.c" 3 4
                            ((void *)0)
# 989 "project/radare2/libr/core/cmd_meta.c"
...
# 996 "project/radare2/libr/core/cmd_meta.c" 3 4
 fprintf(__stderrp,
# 996 "project/radare2/libr/core/cmd_meta.c"
 "Can't find function here\n"
# 996 "project/radare2/libr/core/cmd_meta.c" 3 4
 )
# 996 "project/radare2/libr/core/cmd_meta.c"
                                       ;
...
# 1005 "project/radare2/libr/core/cmd_meta.c" 3 4
 for (
# 1005 "project/radare2/libr/core/cmd_meta.c"
 it 
# 1005 "project/radare2/libr/core/cmd_meta.c" 3 4
 = (void **)(
# 1005 "project/radare2/libr/core/cmd_meta.c"
...
# 1005 "project/radare2/libr/core/cmd_meta.c"
   ...
   if (!input[1]) {
    ...
    char *b64 = sdb_encode ((const 
# 1013 "project/radare2/libr/core/cmd_meta.c" 3 4
                                  unsigned char 
# 1013 "project/radare2/libr/core/cmd_meta.c"
                                      *)var->comment, strlen (var->comment));
    if (!b64) {
     continue;
    }
    r_cons_printf ("\"Cv%c %s base64:%s @ 0x%08"
# 1017 "project/radare2/libr/core/cmd_meta.c" 3 4
                                               "llx"
# 1017 "project/radare2/libr/core/cmd_meta.c"
 ...
 case ' ': {
  ...
  char *heap_comment = 
# 1024 "project/radare2/libr/core/cmd_meta.c" 3 4
                      ((void *)0)
# 1024 "project/radare2/libr/core/cmd_meta.c"
                          ;
  if (comment) {
   if (*comment) {
    *comment++ = 0;
   ...
   if (!strncmp (comment, "base64:", 7)) {
    heap_comment = (char *)sdb_decode (comment + 7, 
# 1030 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                   ((void *)0)
# 1030 "project/radare2/libr/core/cmd_meta.c"
                                                       );
  ...
  if (!var) {
   int idx = (int)strtol (name, 
# 1036 "project/radare2/libr/core/cmd_meta.c" 3 4
                               ((void *)0)
# 1036 "project/radare2/libr/core/cmd_meta.c"
                                   , 0);
   var = r_anal_function_get_var (fcn, input[0], idx);
  }
  if (!var) {
   
# 1040 "project/radare2/libr/core/cmd_meta.c" 3 4
  fprintf(__stderrp,
# 1040 "project/radare2/libr/core/cmd_meta.c"
  "can't find variable at given offset\n"
# 1040 "project/radare2/libr/core/cmd_meta.c" 3 4
  )
# 1040 "project/radare2/libr/core/cmd_meta.c"
                                                   ;
 ...
 case '-': {
  ...
  if (!var) {
   int idx = (int)strtol (name, 
# 1062 "project/radare2/libr/core/cmd_meta.c" 3 4
                               ((void *)0)
# 1062 "project/radare2/libr/core/cmd_meta.c"
                                   , 0);
   var = r_anal_function_get_var (fcn, input[0], idx);
  }
  if (!var) {
   
# 1066 "project/radare2/libr/core/cmd_meta.c" 3 4
  fprintf(__stderrp,
# 1066 "project/radare2/libr/core/cmd_meta.c"
  "can't find variable at given offset\n"
# 1066 "project/radare2/libr/core/cmd_meta.c" 3 4
  )
# 1066 "project/radare2/libr/core/cmd_meta.c"
  ...
  free (var->comment);
  var->comment = 
# 1070 "project/radare2/libr/core/cmd_meta.c" 3 4
                ((void *)0)
# 1070 "project/radare2/libr/core/cmd_meta.c"
                    ;
  break;
 }
 case '!': {
...
# 1079 "project/radare2/libr/core/cmd_meta.c" 3 4
  fprintf(__stderrp,
# 1079 "project/radare2/libr/core/cmd_meta.c"
...
# 1079 "project/radare2/libr/core/cmd_meta.c"
  ...
  comment = r_core_editor (core, 
# 1082 "project/radare2/libr/core/cmd_meta.c" 3 4
                                ((void *)0)
# 1082 "project/radare2/libr/core/cmd_meta.c"
                                    , var->comment);
  if (comment) {
   free (var->comment);
   var->comment = comment;
...
# 1104 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                        ((void *)0)
# 1104 "project/radare2/libr/core/cmd_meta.c"
                                                            );
  break;
 case ',':
 case 'j':
...
# 1117 "project/radare2/libr/core/cmd_meta.c" 3 4
                                                    ((void *)0)
# 1117 "project/radare2/libr/core/cmd_meta.c"
                                                        );
  break;
 }
 case 'L':
 ...
 case '-':
  if (input[1] != '*') {
   ...
   r_meta_del (core->anal, R_META_TYPE_ANY, 0, 
# 1143 "project/radare2/libr/core/cmd_meta.c" 3 4
                                              0xFFFFFFFFFFFFFFFFULL
# 1143 "project/radare2/libr/core/cmd_meta.c"
                                                      );
  }
  break;
 case '?':
...
# 1155 "project/radare2/libr/core/cmd_meta.c" 3 4
  fprintf(__stderrp,
# 1155 "project/radare2/libr/core/cmd_meta.c"
...
# 1155 "project/radare2/libr/core/cmd_meta.c"
 ...
 case 'S':
  ...
  case 'r':
   if (input[2] == ' ') {
    r_spaces_rename (ms, 
# 1170 "project/radare2/libr/core/cmd_meta.c" 3 4
                        ((void *)0)
# 1170 "project/radare2/libr/core/cmd_meta.c"
                            , input + 2);
   } else {
    
# 1172 "project/radare2/libr/core/cmd_meta.c" 3 4
   fprintf(__stderrp,
# 1172 "project/radare2/libr/core/cmd_meta.c"
   "Usage: CSr [newname]\n"
# 1172 "project/radare2/libr/core/cmd_meta.c" 3 4
   )
# 1172 "project/radare2/libr/core/cmd_meta.c"
  ...
  case '-':
   if (input[2]) {
    if (input[2] == '*') {
     r_spaces_unset (ms, 
# 1178 "project/radare2/libr/core/cmd_meta.c" 3 4
                        ((void *)0)
# 1178 "project/radare2/libr/core/cmd_meta.c"
                            );
    } else {
 ...
 return 
# 1200 "project/radare2/libr/core/cmd_meta.c" 3 4
       1
# 1200 "project/radare2/libr/core/cmd_meta.c"
           ;
}
