# 0 "project/radare2/libr/core/libs.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/libs.c"
...
# 4 "project/radare2/libr/core/libs.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/sdb/src/config.h" 1 3 4
# 5 "project/radare2/libr/core/libs.c" 2
# 31 "project/radare2/libr/core/libs.c"

# 31 "project/radare2/libr/core/libs.c"
static int __lib_io_cb (RLibPlugin * pl, void *user, void *data) { struct r_io_plugin_t *hand = (struct r_io_plugin_t *)data; struct r_io_plugin_t *instance; RCore *core = (RCore *) user; instance = 
# 31 "project/radare2/libr/core/libs.c" 3 4
(
# 31 "project/radare2/libr/core/libs.c"
...
, 
# 31 "project/radare2/libr/core/libs.c"
hand, sizeof (struct r_io_plugin_t)
# 31 "project/radare2/libr/core/libs.c" 3 4
...
, 0))
# 31 "project/radare2/libr/core/libs.c"
; r_io_plugin_add (core->io, instance); return 
# 31 "project/radare2/libr/core/libs.c" 3 4
1
# 31 "project/radare2/libr/core/libs.c"
; } static int __lib_io_dt (RLibPlugin * pl, void *p, void *u) { return 
# 31 "project/radare2/libr/core/libs.c" 3 4
1
# 31 "project/radare2/libr/core/libs.c"
; }

static int __lib_core_cb (RLibPlugin * pl, void *user, void *data) { struct r_core_plugin_t *hand = (struct r_core_plugin_t *)data; RCore *core = (RCore *) user; pl->free = 
# 33 "project/radare2/libr/core/libs.c" 3 4
((void *)0)
# 33 "project/radare2/libr/core/libs.c"
; r_core_plugin_add (core->rcmd, hand); return 
# 33 "project/radare2/libr/core/libs.c" 3 4
1
# 33 "project/radare2/libr/core/libs.c"
; } static int __lib_core_dt (RLibPlugin * pl, void *p, void *u) { return 
# 33 "project/radare2/libr/core/libs.c" 3 4
1
# 33 "project/radare2/libr/core/libs.c"
; }

static int __lib_debug_cb (RLibPlugin * pl, void *user, void *data) { struct r_debug_plugin_t *hand = (struct r_debug_plugin_t *)data; RCore *core = (RCore *) user; pl->free = 
# 35 "project/radare2/libr/core/libs.c" 3 4
((void *)0)
# 35 "project/radare2/libr/core/libs.c"
; r_debug_plugin_add (core->dbg, hand); return 
# 35 "project/radare2/libr/core/libs.c" 3 4
1
# 35 "project/radare2/libr/core/libs.c"
; } static int __lib_debug_dt (RLibPlugin * pl, void *p, void *u) { return 
# 35 "project/radare2/libr/core/libs.c" 3 4
1
# 35 "project/radare2/libr/core/libs.c"
; }

static int __lib_bp_cb (RLibPlugin * pl, void *user, void *data) { struct r_bp_plugin_t *hand = (struct r_bp_plugin_t *)data; RCore *core = (RCore *) user; pl->free = 
# 37 "project/radare2/libr/core/libs.c" 3 4
((void *)0)
# 37 "project/radare2/libr/core/libs.c"
; r_bp_plugin_add (core->dbg->bp, hand); return 
# 37 "project/radare2/libr/core/libs.c" 3 4
1
# 37 "project/radare2/libr/core/libs.c"
; } static int __lib_bp_dt (RLibPlugin * pl, void *p, void *u) { return 
# 37 "project/radare2/libr/core/libs.c" 3 4
1
# 37 "project/radare2/libr/core/libs.c"
; }
static int __lib_lang_cb (RLibPlugin * pl, void *user, void *data) { struct r_lang_plugin_t *hand = (struct r_lang_plugin_t *)data; RCore *core = (RCore *) user; pl->free = 
# 38 "project/radare2/libr/core/libs.c" 3 4
((void *)0)
# 38 "project/radare2/libr/core/libs.c"
; r_lang_add (core->lang, hand); return 
# 38 "project/radare2/libr/core/libs.c" 3 4
1
# 38 "project/radare2/libr/core/libs.c"
; } static int __lib_lang_dt (RLibPlugin * pl, void *p, void *u) { return 
# 38 "project/radare2/libr/core/libs.c" 3 4
1
# 38 "project/radare2/libr/core/libs.c"
; }
static int __lib_anal_cb (RLibPlugin * pl, void *user, void *data) { struct r_anal_plugin_t *hand = (struct r_anal_plugin_t *)data; RCore *core = (RCore *) user; pl->free = 
# 39 "project/radare2/libr/core/libs.c" 3 4
((void *)0)
# 39 "project/radare2/libr/core/libs.c"
; r_anal_add (core->anal, hand); return 
# 39 "project/radare2/libr/core/libs.c" 3 4
1
# 39 "project/radare2/libr/core/libs.c"
; } static int __lib_anal_dt (RLibPlugin * pl, void *p, void *u) { return 
# 39 "project/radare2/libr/core/libs.c" 3 4
1
# 39 "project/radare2/libr/core/libs.c"
; }

static int __lib_anal_esil_cb (RLibPlugin * pl, void *user, void *data) { struct r_anal_esil_plugin_t *hand = (struct r_anal_esil_plugin_t *)data; RCore *core = (RCore *) user; pl->free = 
# 41 "project/radare2/libr/core/libs.c" 3 4
((void *)0)
# 41 "project/radare2/libr/core/libs.c"
; r_anal_esil_plugin_add (core->anal->esil, hand); return 
# 41 "project/radare2/libr/core/libs.c" 3 4
1
# 41 "project/radare2/libr/core/libs.c"
; } static int __lib_anal_esil_dt (RLibPlugin * pl, void *p, void *u) { return 
# 41 "project/radare2/libr/core/libs.c" 3 4
1
# 41 "project/radare2/libr/core/libs.c"
; }
static int __lib_asm_cb (RLibPlugin * pl, void *user, void *data) { struct r_asm_plugin_t *hand = (struct r_asm_plugin_t *)data; RCore *core = (RCore *) user; pl->free = 
# 42 "project/radare2/libr/core/libs.c" 3 4
((void *)0)
# 42 "project/radare2/libr/core/libs.c"
; r_asm_add (core->rasm, hand); return 
# 42 "project/radare2/libr/core/libs.c" 3 4
1
# 42 "project/radare2/libr/core/libs.c"
; } static int __lib_asm_dt (RLibPlugin * pl, void *p, void *u) { return 
# 42 "project/radare2/libr/core/libs.c" 3 4
1
# 42 "project/radare2/libr/core/libs.c"
; }
static int __lib_parse_cb (RLibPlugin * pl, void *user, void *data) { struct r_parse_plugin_t *hand = (struct r_parse_plugin_t *)data; RCore *core = (RCore *) user; pl->free = 
# 43 "project/radare2/libr/core/libs.c" 3 4
((void *)0)
# 43 "project/radare2/libr/core/libs.c"
; r_parse_add (core->parser, hand); return 
# 43 "project/radare2/libr/core/libs.c" 3 4
1
# 43 "project/radare2/libr/core/libs.c"
; } static int __lib_parse_dt (RLibPlugin * pl, void *p, void *u) { return 
# 43 "project/radare2/libr/core/libs.c" 3 4
1
# 43 "project/radare2/libr/core/libs.c"
; }
static int __lib_bin_cb (RLibPlugin * pl, void *user, void *data) { struct r_bin_plugin_t *hand = (struct r_bin_plugin_t *)data; RCore *core = (RCore *) user; pl->free = 
# 44 "project/radare2/libr/core/libs.c" 3 4
((void *)0)
# 44 "project/radare2/libr/core/libs.c"
; r_bin_add (core->bin, hand); return 
# 44 "project/radare2/libr/core/libs.c" 3 4
1
# 44 "project/radare2/libr/core/libs.c"
; } static int __lib_bin_dt (RLibPlugin * pl, void *p, void *u) { return 
# 44 "project/radare2/libr/core/libs.c" 3 4
1
# 44 "project/radare2/libr/core/libs.c"
; }
static int __lib_egg_cb (RLibPlugin * pl, void *user, void *data) { struct r_egg_plugin_t *hand = (struct r_egg_plugin_t *)data; RCore *core = (RCore *) user; pl->free = 
# 45 "project/radare2/libr/core/libs.c" 3 4
((void *)0)
# 45 "project/radare2/libr/core/libs.c"
; r_egg_add (core->egg, hand); return 
# 45 "project/radare2/libr/core/libs.c" 3 4
1
# 45 "project/radare2/libr/core/libs.c"
; } static int __lib_egg_dt (RLibPlugin * pl, void *p, void *u) { return 
# 45 "project/radare2/libr/core/libs.c" 3 4
1
# 45 "project/radare2/libr/core/libs.c"
; }
static int __lib_fs_cb (RLibPlugin * pl, void *user, void *data) { struct r_fs_plugin_t *hand = (struct r_fs_plugin_t *)data; RCore *core = (RCore *) user; pl->free = 
# 46 "project/radare2/libr/core/libs.c" 3 4
((void *)0)
# 46 "project/radare2/libr/core/libs.c"
; r_fs_add (core->fs, hand); return 
# 46 "project/radare2/libr/core/libs.c" 3 4
1
# 46 "project/radare2/libr/core/libs.c"
; } static int __lib_fs_dt (RLibPlugin * pl, void *p, void *u) { return 
# 46 "project/radare2/libr/core/libs.c" 3 4
1
# 46 "project/radare2/libr/core/libs.c"
; }
...
# 95 "project/radare2/libr/core/libs.c"
}


# 97 "project/radare2/libr/core/libs.c" 3 4
__attribute__((visibility("default"))) 
# 97 "project/radare2/libr/core/libs.c"
     void r_core_loadlibs_init(RCore *core) {
 
# 98 "project/radare2/libr/core/libs.c" 3 4
unsigned long long 
# 98 "project/radare2/libr/core/libs.c"
     prev = r_time_now_mono ();

 core->lib = r_lib_new (
# 100 "project/radare2/libr/core/libs.c" 3 4
                       ((void *)0)
# 100 "project/radare2/libr/core/libs.c"
                           , 
# 100 "project/radare2/libr/core/libs.c" 3 4
                             ((void *)0)
# 100 "project/radare2/libr/core/libs.c"
                                 );
 r_lib_add_handler (core->lib, R_LIB_TYPE_IO, "io plugins", &__lib_io_cb, &__lib_io_dt, core);;
 r_lib_add_handler (core->lib, R_LIB_TYPE_CORE, "core plugins", &__lib_core_cb, &__lib_core_dt, core);;
 r_lib_add_handler (core->lib, R_LIB_TYPE_DBG, "debugger plugins", &__lib_debug_cb, &__lib_debug_dt, core);;
 r_lib_add_handler (core->lib, R_LIB_TYPE_BP, "debugger breakpoint plugins", &__lib_bp_cb, &__lib_bp_dt, core);;
 r_lib_add_handler (core->lib, R_LIB_TYPE_LANG, "language plugins", &__lib_lang_cb, &__lib_lang_dt, core);;
 r_lib_add_handler (core->lib, R_LIB_TYPE_ANAL, "analysis plugins", &__lib_anal_cb, &__lib_anal_dt, core);;
 r_lib_add_handler (core->lib, R_LIB_TYPE_ESIL, "esil emulation plugins", &__lib_anal_esil_cb, &__lib_anal_esil_dt, core);;
 r_lib_add_handler (core->lib, R_LIB_TYPE_ASM, "(dis)assembler plugins", &__lib_asm_cb, &__lib_asm_dt, core);;
 r_lib_add_handler (core->lib, R_LIB_TYPE_PARSE, "parsing plugins", &__lib_parse_cb, &__lib_parse_dt, core);;
 r_lib_add_handler (core->lib, R_LIB_TYPE_BIN, "bin plugins", &__lib_bin_cb, &__lib_bin_dt, core);;
 r_lib_add_handler (core->lib, R_LIB_TYPE_EGG, "egg plugins", &__lib_egg_cb, &__lib_egg_dt, core);;
 r_lib_add_handler (core->lib, R_LIB_TYPE_FS, "fs plugins", &__lib_fs_cb, &__lib_fs_dt, core);;
 core->times->loadlibs_init_time = r_time_now_mono () - prev;
}

static 
# 116 "project/radare2/libr/core/libs.c" 3 4
      _Bool 
# 116 "project/radare2/libr/core/libs.c"
           __isScriptFilename(const char *name) {
 ...
 if (ext) {
  ...
  || !strcmp (ext, "lua")) {
   return 
# 127 "project/radare2/libr/core/libs.c" 3 4
         1
# 127 "project/radare2/libr/core/libs.c"
             ;
  }
 }
 return 
# 130 "project/radare2/libr/core/libs.c" 3 4
       0
# 130 "project/radare2/libr/core/libs.c"
            ;
}


# 133 "project/radare2/libr/core/libs.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 133 "project/radare2/libr/core/libs.c"
          r_core_loadlibs(RCore *core, int where, const char *path) {
 
# 134 "project/radare2/libr/core/libs.c" 3 4
unsigned long long 
# 134 "project/radare2/libr/core/libs.c"
     prev = r_time_now_mono ();
 ...
 if (!r_config_get_i (core->config, "cfg.plugins")) {
  ...
  return 
# 139 "project/radare2/libr/core/libs.c" 3 4
        0
# 139 "project/radare2/libr/core/libs.c"
             ;
 }

 char *homeplugindir = r_str_home (
# 142 "project/radare2/libr/core/libs.c" 3 4
                                  ".local" "/" "share" "/" "radare2" "/" "plugins"
# 142 "project/radare2/libr/core/libs.c"
                                                 );
 RList *files = r_sys_dir (homeplugindir);
 RListIter *iter;
 char *file;
 
# 146 "project/radare2/libr/core/libs.c" 3 4
if (
# 146 "project/radare2/libr/core/libs.c"
files
# 146 "project/radare2/libr/core/libs.c" 3 4
) for (
# 146 "project/radare2/libr/core/libs.c"
...
# 146 "project/radare2/libr/core/libs.c"
 ...
 return 
# 154 "project/radare2/libr/core/libs.c" 3 4
       1
# 154 "project/radare2/libr/core/libs.c"
           ;
}
