# 0 "project/radare2/libr/core/vasm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/vasm.c"
...
# 4 "project/radare2/libr/core/vasm.c" 2




# 7 "project/radare2/libr/core/vasm.c"
typedef struct {
 RCore *core;
 char blockbuf[1024];
 char codebuf[1024];
...
# 12 "project/radare2/libr/core/vasm.c" 3 4
unsigned char 
# 12 "project/radare2/libr/core/vasm.c"
    buf[128];
 RAsmCode *acode;
 int blocklen;
 
# 15 "project/radare2/libr/core/vasm.c" 3 4
unsigned long long 
# 15 "project/radare2/libr/core/vasm.c"
     off;
} RCoreVisualAsm;
...
static int readline_callback(void *_a, const char *str) {
 ...
 RCore *core = a->core;
 r_cons_clear00 ();
 r_cons_printf ("Write some %s-%" 
# 22 "project/radare2/libr/core/vasm.c" 3 4
                                 "lld" 
# 22 "project/radare2/libr/core/vasm.c"
                                         " assembly...\n\n",
...
# 41 "project/radare2/libr/core/vasm.c" 3 4
   r_cons_strcat (
# 41 "project/radare2/libr/core/vasm.c"
   "\n\n"
# 41 "project/radare2/libr/core/vasm.c" 3 4
   )
# 41 "project/radare2/libr/core/vasm.c"
   ...
   int xlen = 
# 43 "project/radare2/libr/core/vasm.c" 3 4
             (((
# 43 "project/radare2/libr/core/vasm.c"
             strlen (hex)
# 43 "project/radare2/libr/core/vasm.c" 3 4
             )>(
# 43 "project/radare2/libr/core/vasm.c"
...
# 44 "project/radare2/libr/core/vasm.c" 3 4
  __builtin___strcpy_chk (
# 44 "project/radare2/libr/core/vasm.c"
  a->codebuf
# 44 "project/radare2/libr/core/vasm.c" 3 4
  , 
# 44 "project/radare2/libr/core/vasm.c"
...
# 45 "project/radare2/libr/core/vasm.c" 3 4
  __builtin___memcpy_chk (
# 45 "project/radare2/libr/core/vasm.c"
  a->codebuf
# 45 "project/radare2/libr/core/vasm.c" 3 4
  , 
# 45 "project/radare2/libr/core/vasm.c"
...
# 45 "project/radare2/libr/core/vasm.c"
  ...
  }
  {
   ...
   char *cmd = r_str_newf ("pd %d @x:%s @0x%"
# 59 "project/radare2/libr/core/vasm.c" 3 4
                                            "llx"
# 59 "project/radare2/libr/core/vasm.c"
...
# 72 "project/radare2/libr/core/vasm.c" 3 4
__attribute__((visibility("default"))) 
# 72 "project/radare2/libr/core/vasm.c"
     void r_core_visual_asm(RCore *core, 
# 72 "project/radare2/libr/core/vasm.c" 3 4
                                         unsigned long long 
# 72 "project/radare2/libr/core/vasm.c"
                                              off) {
...
# 85 "project/radare2/libr/core/vasm.c" 3 4
   fprintf(__stderrp,
# 85 "project/radare2/libr/core/vasm.c"
...
# 85 "project/radare2/libr/core/vasm.c"
                                                                                               ;
    r_cons_any_key (
# 86 "project/radare2/libr/core/vasm.c" 3 4
                   ((void *)0)
# 86 "project/radare2/libr/core/vasm.c"
                       );
   }
