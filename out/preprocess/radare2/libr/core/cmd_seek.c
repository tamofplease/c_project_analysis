# 0 "project/radare2/libr/core/cmd_seek.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/cmd_seek.c"
...
typedef int RRef;
# 4 "project/radare2/libr/core/cmd_seek.c" 2
...
# 5 "project/radare2/libr/core/cmd_seek.c" 2
...
# 7 "project/radare2/libr/core/cmd_seek.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_debug.h" 1 3 4
# 8 "project/radare2/libr/core/cmd_seek.c" 2



# 10 "project/radare2/libr/core/cmd_seek.c"
static void __core_cmd_search_backward_prelude(RCore *core, 
# 10 "project/radare2/libr/core/cmd_seek.c" 3 4
                                                           _Bool 
# 10 "project/radare2/libr/core/cmd_seek.c"
                                                                doseek, 
# 10 "project/radare2/libr/core/cmd_seek.c" 3 4
...
# 43 "project/radare2/libr/core/cmd_seek.c" 3 4
((void *)0)

# 44 "project/radare2/libr/core/cmd_seek.c"
};
...
# 50 "project/radare2/libr/core/cmd_seek.c" 3 4
((void *)0)

# 51 "project/radare2/libr/core/cmd_seek.c"
};
...
# 57 "project/radare2/libr/core/cmd_seek.c" 3 4
((void *)0)

# 58 "project/radare2/libr/core/cmd_seek.c"
};
...
# 64 "project/radare2/libr/core/cmd_seek.c" 3 4
((void *)0)

# 65 "project/radare2/libr/core/cmd_seek.c"
};
...
# 71 "project/radare2/libr/core/cmd_seek.c" 3 4
((void *)0)

# 72 "project/radare2/libr/core/cmd_seek.c"
};
...
# 81 "project/radare2/libr/core/cmd_seek.c" 3 4
((void *)0)

# 82 "project/radare2/libr/core/cmd_seek.c"
};
...
# 87 "project/radare2/libr/core/cmd_seek.c" 3 4
((void *)0)

# 88 "project/radare2/libr/core/cmd_seek.c"
};

static void __init_seek_line(RCore *core) {
 
# 91 "project/radare2/libr/core/cmd_seek.c" 3 4
unsigned long long 
# 91 "project/radare2/libr/core/cmd_seek.c"
     from, to;
...
# 98 "project/radare2/libr/core/cmd_seek.c" 3 4
 fprintf(__stderrp,
# 98 "project/radare2/libr/core/cmd_seek.c"
 "ERROR: \"lines.from\" and \"lines.to\" must be set\n"
# 98 "project/radare2/libr/core/cmd_seek.c" 3 4
 )
# 98 "project/radare2/libr/core/cmd_seek.c"
                                                                 ;
...
static void printPadded(RCore *core, int pad) {
 ...
 char *fmt = r_str_newf ("0x%%0%d" 
# 106 "project/radare2/libr/core/cmd_seek.c" 3 4
                                  "llx"
# 106 "project/radare2/libr/core/cmd_seek.c"
                                         , pad);
...
# 122 "project/radare2/libr/core/cmd_seek.c" 3 4
 fprintf(__stderrp,
# 122 "project/radare2/libr/core/cmd_seek.c"
 "ERROR: Line must be between 1 and %d\n", core->print->lines_cache_sz - 1
# 122 "project/radare2/libr/core/cmd_seek.c" 3 4
 )
# 122 "project/radare2/libr/core/cmd_seek.c"
                                                                                    ;
 } else {
  r_core_seek (core, core->print->lines_cache[numline - 1], 
# 124 "project/radare2/libr/core/cmd_seek.c" 3 4
                                                           1
# 124 "project/radare2/libr/core/cmd_seek.c"
                                                               );
 }
}
...
# 131 "project/radare2/libr/core/cmd_seek.c" 3 4
 fprintf(__stderrp,
# 131 "project/radare2/libr/core/cmd_seek.c"
 "ERROR: Line must be < %d\n", core->print->lines_cache_sz - 1
# 131 "project/radare2/libr/core/cmd_seek.c" 3 4
 )
# 131 "project/radare2/libr/core/cmd_seek.c"
                                                                        ;
...
# 133 "project/radare2/libr/core/cmd_seek.c" 3 4
 fprintf(__stderrp,
# 133 "project/radare2/libr/core/cmd_seek.c"
...
# 133 "project/radare2/libr/core/cmd_seek.c"
  ...
  r_core_seek (core, core->print->lines_cache[curr + numlines - 1], 
# 135 "project/radare2/libr/core/cmd_seek.c" 3 4
                                                                   1
# 135 "project/radare2/libr/core/cmd_seek.c"
                                                                       );
 }
}
...
# 141 "project/radare2/libr/core/cmd_seek.c" 3 4
{ free((void *)
# 141 "project/radare2/libr/core/cmd_seek.c"
core->print->lines_cache
# 141 "project/radare2/libr/core/cmd_seek.c" 3 4
); 
# 141 "project/radare2/libr/core/cmd_seek.c"
core->print->lines_cache 
...
# 144 "project/radare2/libr/core/cmd_seek.c" 3 4
__attribute__((visibility("default"))) 
# 144 "project/radare2/libr/core/cmd_seek.c"
     int r_core_lines_currline(RCore *core) {
 int imin = 0;
...
# 162 "project/radare2/libr/core/cmd_seek.c" 3 4
__attribute__((visibility("default"))) 
# 162 "project/radare2/libr/core/cmd_seek.c"
     int r_core_lines_initcache(RCore *core, 
# 162 "project/radare2/libr/core/cmd_seek.c" 3 4
                                             unsigned long long 
# 162 "project/radare2/libr/core/cmd_seek.c"
                                                  start_addr, 
...
# 164 "project/radare2/libr/core/cmd_seek.c" 3 4
unsigned long long 
# 164 "project/radare2/libr/core/cmd_seek.c"
     off = start_addr;
 
# 165 "project/radare2/libr/core/cmd_seek.c" 3 4
unsigned long long 
# 165 "project/radare2/libr/core/cmd_seek.c"
     baddr;
 if (start_addr == 
# 166 "project/radare2/libr/core/cmd_seek.c" 3 4
                  0xFFFFFFFFFFFFFFFFULL 
# 166 "project/radare2/libr/core/cmd_seek.c"
                           || end_addr == 
# 166 "project/radare2/libr/core/cmd_seek.c" 3 4
                                          0xFFFFFFFFFFFFFFFFULL
# 166 "project/radare2/libr/core/cmd_seek.c"
 ...
 core->print->lines_cache = 
# 171 "project/radare2/libr/core/cmd_seek.c" 3 4
                           (unsigned long long*)calloc(
# 171 "project/radare2/libr/core/cmd_seek.c"
                           bsz
# 171 "project/radare2/libr/core/cmd_seek.c" 3 4
...
# 171 "project/radare2/libr/core/cmd_seek.c"
 ...
 r_cons_break_push (
# 184 "project/radare2/libr/core/cmd_seek.c" 3 4
                   ((void *)0)
# 184 "project/radare2/libr/core/cmd_seek.c"
                       , 
# 184 "project/radare2/libr/core/cmd_seek.c" 3 4
                         ((void *)0)
# 184 "project/radare2/libr/core/cmd_seek.c"
 ...
 while (off < end_addr) {
  ...
  r_io_read_at (core->io, off, (
# 189 "project/radare2/libr/core/cmd_seek.c" 3 4
                               unsigned char 
# 189 "project/radare2/libr/core/cmd_seek.c"
                                   *) buf, bsz);
  for (i = 0; i < bsz; i++) {
   if (buf[i] != '\n') {
    continue;
...
# 200 "project/radare2/libr/core/cmd_seek.c" 3 4
   unsigned long long 
# 200 "project/radare2/libr/core/cmd_seek.c"
        *tmp = realloc (core->print->lines_cache,
     (line_count + bsz) * sizeof (
# 201 "project/radare2/libr/core/cmd_seek.c" 3 4
                                 unsigned long long
# 201 "project/radare2/libr/core/cmd_seek.c"
                                     ));
    if (tmp) {
     core->print->lines_cache = tmp;
    } else {
     
# 205 "project/radare2/libr/core/cmd_seek.c" 3 4
    { free((void *)
# 205 "project/radare2/libr/core/cmd_seek.c"
    core->print->lines_cache
# 205 "project/radare2/libr/core/cmd_seek.c" 3 4
    ); 
# 205 "project/radare2/libr/core/cmd_seek.c"
...
static void seek_to_register(RCore *core, const char *input, 
# 221 "project/radare2/libr/core/cmd_seek.c" 3 4
                                                            _Bool 
# 221 "project/radare2/libr/core/cmd_seek.c"
                                                                 is_silent) {
 if (r_config_get_b (core->config, "cfg.debug")) {
  
# 223 "project/radare2/libr/core/cmd_seek.c" 3 4
 unsigned long long 
# 223 "project/radare2/libr/core/cmd_seek.c"
      off = r_debug_reg_get (core->dbg, input);
  if (!is_silent) {
   r_io_sundo_push (core->io, core->offset, r_print_get_cursor (core->print));
  }
  r_core_seek (core, off, 
# 227 "project/radare2/libr/core/cmd_seek.c" 3 4
                         1
# 227 "project/radare2/libr/core/cmd_seek.c"
                             );
 } else {
  RReg *orig = core->dbg->reg;
  core->dbg->reg = core->anal->reg;
  
# 231 "project/radare2/libr/core/cmd_seek.c" 3 4
 unsigned long long 
# 231 "project/radare2/libr/core/cmd_seek.c"
      off = r_debug_reg_get (core->dbg, input);
  core->dbg->reg = orig;
  if (!is_silent) {
   r_io_sundo_push (core->io, core->offset, r_print_get_cursor (core->print));
  ...
  r_core_seek (core, off, 
# 236 "project/radare2/libr/core/cmd_seek.c" 3 4
                         1
# 236 "project/radare2/libr/core/cmd_seek.c"
                             );
 }
}
...
# 248 "project/radare2/libr/core/cmd_seek.c" 3 4
 fprintf(__stderrp,
# 248 "project/radare2/libr/core/cmd_seek.c"
 "Usage: sort # sort the contents of the file\n"
# 248 "project/radare2/libr/core/cmd_seek.c" 3 4
 )
# 248 "project/radare2/libr/core/cmd_seek.c"
                                                          ;
...
# 259 "project/radare2/libr/core/cmd_seek.c" 3 4
   r_cons_strcat (
# 259 "project/radare2/libr/core/cmd_seek.c"
   res
# 259 "project/radare2/libr/core/cmd_seek.c" 3 4
   )
# 259 "project/radare2/libr/core/cmd_seek.c"
...
# 271 "project/radare2/libr/core/cmd_seek.c" 3 4
unsigned long long 
# 271 "project/radare2/libr/core/cmd_seek.c"
     addr = core->offset;
 int ret = 0;
 if (r_core_prevop_addr (core, core->offset, numinstr, &addr)) {
  ...
  addr = core->offset;
  const int mininstrsize = r_anal_archinfo (core->anal, 
# 282 "project/radare2/libr/core/cmd_seek.c" 3 4
                                                       0
# 282 "project/radare2/libr/core/cmd_seek.c"
                                                                                  );
  for (i = 0; i < numinstr; i++) {
   
# 284 "project/radare2/libr/core/cmd_seek.c" 3 4
  unsigned long long 
# 284 "project/radare2/libr/core/cmd_seek.c"
       prev_addr = r_core_prevop_addr_force (core, addr, 1);
   if (prev_addr == 
# 285 "project/radare2/libr/core/cmd_seek.c" 3 4
                   0xFFFFFFFFFFFFFFFFULL
# 285 "project/radare2/libr/core/cmd_seek.c"
                           ) {
    prev_addr = addr - mininstrsize;
   }
   if (prev_addr == 
# 288 "project/radare2/libr/core/cmd_seek.c" 3 4
                   0xFFFFFFFFFFFFFFFFULL 
# 288 "project/radare2/libr/core/cmd_seek.c"
                            || prev_addr >= core->offset) {
    break;
   }
   RAsmOp op = {0};
   r_core_seek (core, prev_addr, 
# 292 "project/radare2/libr/core/cmd_seek.c" 3 4
                                1
# 292 "project/radare2/libr/core/cmd_seek.c"
                                    );
...
# 301 "project/radare2/libr/core/cmd_seek.c" 3 4
                         1
# 301 "project/radare2/libr/core/cmd_seek.c"
                             );
 val += ret;
 return val;
}
...
# 325 "project/radare2/libr/core/cmd_seek.c" 3 4
 fprintf(__stderrp,
# 325 "project/radare2/libr/core/cmd_seek.c"
 "Usage: so [-][n]\n"
# 325 "project/radare2/libr/core/cmd_seek.c" 3 4
 )
# 325 "project/radare2/libr/core/cmd_seek.c"
...
# 344 "project/radare2/libr/core/cmd_seek.c" 3 4
unsigned long long 
# 344 "project/radare2/libr/core/cmd_seek.c"
     off = core->offset;

 if (!*input) {
  r_cons_printf ("0x%"
# 347 "project/radare2/libr/core/cmd_seek.c" 3 4
                     "llx" 
# 347 "project/radare2/libr/core/cmd_seek.c"
                             "\n", core->offset);
  return 0;
 }
 char *ptr;
 if ((ptr = strstr (input, "+.")) != 
# 351 "project/radare2/libr/core/cmd_seek.c" 3 4
                                    ((void *)0)
# 351 "project/radare2/libr/core/cmd_seek.c"
                                        ) {
 ...
 if (r_str_cmp (input, "ort", 3)) {
  ...
  if (*u_num == '-') {
   off = -(
# 363 "project/radare2/libr/core/cmd_seek.c" 3 4
          long long
# 363 "project/radare2/libr/core/cmd_seek.c"
              )off;
  }
 }
...
# 379 "project/radare2/libr/core/cmd_seek.c" 3 4
_Bool 
# 379 "project/radare2/libr/core/cmd_seek.c"
     silent = 
# 379 "project/radare2/libr/core/cmd_seek.c" 3 4
              0
# 379 "project/radare2/libr/core/cmd_seek.c"
 ...
 if (*input == 's') {
  silent = 
# 381 "project/radare2/libr/core/cmd_seek.c" 3 4
          1
# 381 "project/radare2/libr/core/cmd_seek.c"
              ;
  input++;
  if (*input == '?') {
...
# 394 "project/radare2/libr/core/cmd_seek.c" 3 4
  fprintf(__stderrp,
# 394 "project/radare2/libr/core/cmd_seek.c"
  "|Usage| 'sr PC' seek to program counter register\n"
# 394 "project/radare2/libr/core/cmd_seek.c" 3 4
  )
# 394 "project/radare2/libr/core/cmd_seek.c"
                                                                ;
...
# 403 "project/radare2/libr/core/cmd_seek.c" 3 4
  _Bool 
# 403 "project/radare2/libr/core/cmd_seek.c"
       seeked = 
# 403 "project/radare2/libr/core/cmd_seek.c" 3 4
                0
# 403 "project/radare2/libr/core/cmd_seek.c"
...
# 404 "project/radare2/libr/core/cmd_seek.c" 3 4
  if ((
# 404 "project/radare2/libr/core/cmd_seek.c"
  &core->anal->meta
# 404 "project/radare2/libr/core/cmd_seek.c" 3 4
  )->root) for ((
# 404 "project/radare2/libr/core/cmd_seek.c"
...
# 404 "project/radare2/libr/core/cmd_seek.c"
    ...
    if (meta->type == R_META_TYPE_COMMENT && !strcmp (meta->str, input + 2)) {
     ...
     r_core_seek (core, off, 
# 409 "project/radare2/libr/core/cmd_seek.c" 3 4
                            1
# 409 "project/radare2/libr/core/cmd_seek.c"
                                );
     r_core_block_read (core);
     seeked = 
# 411 "project/radare2/libr/core/cmd_seek.c" 3 4
             1
# 411 "project/radare2/libr/core/cmd_seek.c"
                 ;
     break;
    }
   }
...
# 416 "project/radare2/libr/core/cmd_seek.c" 3 4
   fprintf(__stderrp,
# 416 "project/radare2/libr/core/cmd_seek.c"
   "No matching comment.\n"
# 416 "project/radare2/libr/core/cmd_seek.c" 3 4
   )
# 416 "project/radare2/libr/core/cmd_seek.c"
...
# 424 "project/radare2/libr/core/cmd_seek.c" 3 4
 unsigned long long 
# 424 "project/radare2/libr/core/cmd_seek.c"
      addr = r_num_math (core->num, input + 1);
  if (core->num->nc.errors) {
   if (r_cons_singleton ()->context->is_interactive) {
    
# 427 "project/radare2/libr/core/cmd_seek.c" 3 4
   fprintf(__stderrp,
# 427 "project/radare2/libr/core/cmd_seek.c"
   "Cannot seek to unknown address '%s'\n", core->num->nc.calc_buf
# 427 "project/radare2/libr/core/cmd_seek.c" 3 4
   )
# 427 "project/radare2/libr/core/cmd_seek.c"
                                                                            ;
  ...
  r_core_seek (core, addr, 
# 434 "project/radare2/libr/core/cmd_seek.c" 3 4
                          1
# 434 "project/radare2/libr/core/cmd_seek.c"
                              );
  r_core_block_read (core);
 }
 break;
 case '/':
 {
  ...
  const 
# 441 "project/radare2/libr/core/cmd_seek.c" 3 4
       unsigned long long 
# 441 "project/radare2/libr/core/cmd_seek.c"
            saved_from = r_config_get_i (core->config, "search.from");
  const 
# 442 "project/radare2/libr/core/cmd_seek.c" 3 4
       unsigned long long 
# 442 "project/radare2/libr/core/cmd_seek.c"
...
# 473 "project/radare2/libr/core/cmd_seek.c" 3 4
  fprintf(__stderrp,
# 473 "project/radare2/libr/core/cmd_seek.c"
  "Usage: s/.. arg.\n"
# 473 "project/radare2/libr/core/cmd_seek.c" 3 4
  )
# 473 "project/radare2/libr/core/cmd_seek.c"
...
# 477 "project/radare2/libr/core/cmd_seek.c" 3 4
  fprintf(__stderrp,
# 477 "project/radare2/libr/core/cmd_seek.c"
...
# 477 "project/radare2/libr/core/cmd_seek.c"
 ...
 case '.':
  if (input[1] == '?') {
   ...
   r_core_seek (core, core->offset, 
# 493 "project/radare2/libr/core/cmd_seek.c" 3 4
                                   1
# 493 "project/radare2/libr/core/cmd_seek.c"
                                       );
   r_core_block_read (core);
  }
  break;
...
# 502 "project/radare2/libr/core/cmd_seek.c" 3 4
  unsigned long long 
# 502 "project/radare2/libr/core/cmd_seek.c"
       lsz = 0;
   
# 503 "project/radare2/libr/core/cmd_seek.c" 3 4
  unsigned long long 
# 503 "project/radare2/libr/core/cmd_seek.c"
       i;
   RListIter *iter;
   RIOUndos *undo;
   if (list) {
    
# 507 "project/radare2/libr/core/cmd_seek.c" 3 4
   if (
# 507 "project/radare2/libr/core/cmd_seek.c"
   list
# 507 "project/radare2/libr/core/cmd_seek.c" 3 4
   ) for (
# 507 "project/radare2/libr/core/cmd_seek.c"
...
# 507 "project/radare2/libr/core/cmd_seek.c"
                                     {
     char *name = 
# 508 "project/radare2/libr/core/cmd_seek.c" 3 4
                 ((void *)0)
# 508 "project/radare2/libr/core/cmd_seek.c"
                     ;

     RFlagItem *f = r_flag_get_at (core->flags, undo->off, 
# 510 "project/radare2/libr/core/cmd_seek.c" 3 4
                                                          1
# 510 "project/radare2/libr/core/cmd_seek.c"
                                                              );
     if (f) {
...
# 522 "project/radare2/libr/core/cmd_seek.c" 3 4
    unsigned long long 
# 522 "project/radare2/libr/core/cmd_seek.c"
         *val = malloc (sizeof (
# 522 "project/radare2/libr/core/cmd_seek.c" 3 4
                                unsigned long long
# 522 "project/radare2/libr/core/cmd_seek.c"
...
# 538 "project/radare2/libr/core/cmd_seek.c" 3 4
   unsigned long long 
# 538 "project/radare2/libr/core/cmd_seek.c"
        *addr = r_list_get_n (addrs, i);
    ...
    if (core->io->undo.undos == i) {
     pj_kb (pj, "current", 
# 546 "project/radare2/libr/core/cmd_seek.c" 3 4
                          1
# 546 "project/radare2/libr/core/cmd_seek.c"
                              );
    }
    pj_end (pj);
   }
...
# 570 "project/radare2/libr/core/cmd_seek.c" 3 4
   if (
# 570 "project/radare2/libr/core/cmd_seek.c"
   list
# 570 "project/radare2/libr/core/cmd_seek.c" 3 4
   ) for (
# 570 "project/radare2/libr/core/cmd_seek.c"
...
# 570 "project/radare2/libr/core/cmd_seek.c"
                                     {
     char *name = 
# 571 "project/radare2/libr/core/cmd_seek.c" 3 4
                 ((void *)0)
# 571 "project/radare2/libr/core/cmd_seek.c"
                     ;

     RFlagItem *f = r_flag_get_at (core->flags, undo->off, 
# 573 "project/radare2/libr/core/cmd_seek.c" 3 4
                                                          1
# 573 "project/radare2/libr/core/cmd_seek.c"
                                                              );
     if (f) {
      if (f->offset != undo->off) {
       name = r_str_newf ("%s + %d\n", f->name,
     ...
     if (mode) {
      r_cons_printf ("0x%"
# 583 "project/radare2/libr/core/cmd_seek.c" 3 4
                         "llx"
# 583 "project/radare2/libr/core/cmd_seek.c"
                                " %s\n", undo->off, r_str_get (name));
     } else {
      if (!name) {
       name = r_str_newf ("0x%"
# 586 "project/radare2/libr/core/cmd_seek.c" 3 4
                              "llx"
# 586 "project/radare2/libr/core/cmd_seek.c"
                                     , undo->off);
      }
 ...
 case '+':
  if (input[1] != '\0') {
   ...
   if (undo) {
    r_core_seek (core, undo->off, 
# 619 "project/radare2/libr/core/cmd_seek.c" 3 4
                                 0
# 619 "project/radare2/libr/core/cmd_seek.c"
                                      );
    r_core_block_read (core);
   }
  }
  ...
  case 0:
   {
    ...
    if (undo) {
     r_core_seek (core, undo->off, 
# 633 "project/radare2/libr/core/cmd_seek.c" 3 4
                                  0
# 633 "project/radare2/libr/core/cmd_seek.c"
                                       );
     r_core_block_read (core);
    }
   }
...
# 641 "project/radare2/libr/core/cmd_seek.c" 3 4
   long long 
# 641 "project/radare2/libr/core/cmd_seek.c"
        delta = -(
# 641 "project/radare2/libr/core/cmd_seek.c" 3 4
                  long long
# 641 "project/radare2/libr/core/cmd_seek.c"
    ...
    if (input[1] == '-') {
     delta = -(
# 643 "project/radare2/libr/core/cmd_seek.c" 3 4
              long long
# 643 "project/radare2/libr/core/cmd_seek.c"
                  )core->blocksize;
     int mult = r_num_math (core->num, input + 2);
     if (mult > 0) {
      delta /= mult;
 ...
 case 'n':
  if (input[1] == '?') {
   ...
   __core_cmd_search_backward_prelude (core, 
# 663 "project/radare2/libr/core/cmd_seek.c" 3 4
                                            1
# 663 "project/radare2/libr/core/cmd_seek.c"
                                                , 
# 663 "project/radare2/libr/core/cmd_seek.c" 3 4
                                                  1
# 663 "project/radare2/libr/core/cmd_seek.c"
 ...
 case 'p':
  if (input[1] == '?') {
   ...
   __core_cmd_search_backward_prelude (core, 
# 678 "project/radare2/libr/core/cmd_seek.c" 3 4
                                            1
# 678 "project/radare2/libr/core/cmd_seek.c"
                                                , 
# 678 "project/radare2/libr/core/cmd_seek.c" 3 4
                                                  0
# 678 "project/radare2/libr/core/cmd_seek.c"
 ...
 case 'f': {
  ...
  case '\0':
   ...
   if (fcn) {
    r_core_seek (core, r_anal_function_max_addr (fcn), 
# 723 "project/radare2/libr/core/cmd_seek.c" 3 4
                                                      1
# 723 "project/radare2/libr/core/cmd_seek.c"
                                                          );
   }
   break;
  case ' ':
   ...
   if (fcn) {
    r_core_seek (core, fcn->addr, 
# 729 "project/radare2/libr/core/cmd_seek.c" 3 4
                                 1
# 729 "project/radare2/libr/core/cmd_seek.c"
                                     );
   }
   break;
  case '.':
   ...
   if (fcn) {
    r_core_seek (core, fcn->addr, 
# 735 "project/radare2/libr/core/cmd_seek.c" 3 4
                                 1
# 735 "project/radare2/libr/core/cmd_seek.c"
                                     );
   }
   break;
  }
 ...
 case 'g':
 {
  ...
  if (map) {
   r_core_seek (core, 
# 764 "project/radare2/libr/core/cmd_seek.c" 3 4
                     r_itv_begin (
# 764 "project/radare2/libr/core/cmd_seek.c"
                     map
# 764 "project/radare2/libr/core/cmd_seek.c" 3 4
                     ->itv)
# 764 "project/radare2/libr/core/cmd_seek.c"
...
# 764 "project/radare2/libr/core/cmd_seek.c"
   ...
   r_core_seek (core, 0, 
# 766 "project/radare2/libr/core/cmd_seek.c" 3 4
                        1
# 766 "project/radare2/libr/core/cmd_seek.c"
                            );
  }
 }
 break;
 case 'G':
 {
  ...
  if (map) {
   r_core_seek (core, 
# 778 "project/radare2/libr/core/cmd_seek.c" 3 4
                     r_itv_end (
# 778 "project/radare2/libr/core/cmd_seek.c"
                     map
# 778 "project/radare2/libr/core/cmd_seek.c" 3 4
                     ->itv) 
# 778 "project/radare2/libr/core/cmd_seek.c"
...
# 778 "project/radare2/libr/core/cmd_seek.c"
   ...
   r_core_seek (core, r_io_fd_size (core->io, core->io->desc->fd), 
# 780 "project/radare2/libr/core/cmd_seek.c" 3 4
                                                                  1
# 780 "project/radare2/libr/core/cmd_seek.c"
                                                                      );
  }
 }
 break;
...
# 803 "project/radare2/libr/core/cmd_seek.c" 3 4
    fprintf(__stderrp,
# 803 "project/radare2/libr/core/cmd_seek.c"
    "Usage: sleep [seconds]\n"
# 803 "project/radare2/libr/core/cmd_seek.c" 3 4
    )
# 803 "project/radare2/libr/core/cmd_seek.c"
...
# 833 "project/radare2/libr/core/cmd_seek.c" 3 4
  fprintf(__stderrp,
# 833 "project/radare2/libr/core/cmd_seek.c"
  "%d lines\n", core->print->lines_cache_sz - 1
# 833 "project/radare2/libr/core/cmd_seek.c" 3 4
  )
# 833 "project/radare2/libr/core/cmd_seek.c"
...
# 849 "project/radare2/libr/core/cmd_seek.c" 3 4
  unsigned long long 
# 849 "project/radare2/libr/core/cmd_seek.c"
   ...
   if (n) {
    ...
    r_core_seek (core, n, 
# 854 "project/radare2/libr/core/cmd_seek.c" 3 4
                         1
# 854 "project/radare2/libr/core/cmd_seek.c"
                             );
    r_core_block_read (core);
   }
  }
