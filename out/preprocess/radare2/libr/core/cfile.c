# 0 "project/radare2/libr/core/cfile.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/cfile.c"
...
# 4 "project/radare2/libr/core/cfile.c" 2
...
# 9 "project/radare2/libr/core/cfile.c"
static int r_core_file_do_load_for_debug(RCore *r, 
# 9 "project/radare2/libr/core/cfile.c" 3 4
                                                  unsigned long long 
# 9 "project/radare2/libr/core/cfile.c"
                                                       loadaddr, const char *filenameuri);
static int r_core_file_do_load_for_io_plugin(RCore *r, 
# 10 "project/radare2/libr/core/cfile.c" 3 4
                                                      unsigned long long 
# 10 "project/radare2/libr/core/cfile.c"
                                                           baseaddr, 
# 10 "project/radare2/libr/core/cfile.c" 3 4
                                                                     unsigned long long 
# 10 "project/radare2/libr/core/cfile.c"
...
static 
# 12 "project/radare2/libr/core/cfile.c" 3 4
      _Bool 
# 12 "project/radare2/libr/core/cfile.c"
           close_but_cb(void *user, void *data, 
# 12 "project/radare2/libr/core/cfile.c" 3 4
                                                unsigned int 
# 12 "project/radare2/libr/core/cfile.c"
                                                     id) {
       ...
       return 
# 21 "project/radare2/libr/core/cfile.c" 3 4
             1
# 21 "project/radare2/libr/core/cfile.c"
                 ;
}



# 25 "project/radare2/libr/core/cfile.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 25 "project/radare2/libr/core/cfile.c"
          r_core_file_close_all_but(RCore *core) {
       r_id_storage_foreach (core->io->files, close_but_cb, core);
       return 
# 27 "project/radare2/libr/core/cfile.c" 3 4
             1
# 27 "project/radare2/libr/core/cfile.c"
                 ;
}

static 
# 30 "project/radare2/libr/core/cfile.c" 3 4
      _Bool 
# 30 "project/radare2/libr/core/cfile.c"
           __isMips(RAsm *a) {
...
# 36 "project/radare2/libr/core/cfile.c" 3 4
 unsigned long long 
# 36 "project/radare2/libr/core/cfile.c"
      gp = r_num_math (core->num, "loc._gp");
  if (!gp || gp == 
# 37 "project/radare2/libr/core/cfile.c" 3 4
                  0xFFFFFFFFFFFFFFFFULL
# 37 "project/radare2/libr/core/cfile.c"
                          ) {
...
# 48 "project/radare2/libr/core/cfile.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 48 "project/radare2/libr/core/cfile.c"
          r_core_file_reopen(RCore *core, const char *args, int perm, int loadbin) {
 const 
# 49 "project/radare2/libr/core/cfile.c" 3 4
      _Bool 
# 49 "project/radare2/libr/core/cfile.c"
           isdebug = r_config_get_b (core->config, "cfg.debug");
 char *path;
 
# 51 "project/radare2/libr/core/cfile.c" 3 4
unsigned long long 
# 51 "project/radare2/libr/core/cfile.c"
     laddr = r_config_get_i (core->config, "bin.laddr");
 RIODesc *odesc = core->io ? core->io->desc : 
# 52 "project/radare2/libr/core/cfile.c" 3 4
                                             ((void *)0)
# 52 "project/radare2/libr/core/cfile.c"
                                                 ;
 RBinFile *bf = odesc ? r_bin_file_find_by_fd (core->bin, odesc->fd) : 
# 53 "project/radare2/libr/core/cfile.c" 3 4
                                                                      ((void *)0)
# 53 "project/radare2/libr/core/cfile.c"
                                                                          ;
 char *ofilepath = 
# 54 "project/radare2/libr/core/cfile.c" 3 4
                  ((void *)0)
# 54 "project/radare2/libr/core/cfile.c"
                      , *obinfilepath = (bf && bf->file)? strdup (bf->file): 
# 54 "project/radare2/libr/core/cfile.c" 3 4
                                                                             ((void *)0)
# 54 "project/radare2/libr/core/cfile.c"
                                                                                 ;
 
# 55 "project/radare2/libr/core/cfile.c" 3 4
_Bool 
# 55 "project/radare2/libr/core/cfile.c"
     ret = 
# 55 "project/radare2/libr/core/cfile.c" 3 4
           0
# 55 "project/radare2/libr/core/cfile.c"
...
# 56 "project/radare2/libr/core/cfile.c" 3 4
unsigned long long 
# 56 "project/radare2/libr/core/cfile.c"
     origoff = core->offset;
 if (odesc) {
  if (odesc->referer) {
...
# 65 "project/radare2/libr/core/cfile.c" 3 4
unsigned long long 
# 65 "project/radare2/libr/core/cfile.c"
     new_baddr = 
# 65 "project/radare2/libr/core/cfile.c" 3 4
                 0xFFFFFFFFFFFFFFFFULL
# 65 "project/radare2/libr/core/cfile.c"
 ...
 if (args) {
  ...
  if (new_baddr && new_baddr != 
# 68 "project/radare2/libr/core/cfile.c" 3 4
                               0xFFFFFFFFFFFFFFFFULL
# 68 "project/radare2/libr/core/cfile.c"
                                       ) {
   r_config_set_i (core->config, "bin.baddr", new_baddr);
  } else {
   new_baddr = 
# 71 "project/radare2/libr/core/cfile.c" 3 4
              0xFFFFFFFFFFFFFFFFULL
# 71 "project/radare2/libr/core/cfile.c"
                      ;
  }
 }
 if (new_baddr == 
# 74 "project/radare2/libr/core/cfile.c" 3 4
                 0xFFFFFFFFFFFFFFFFULL
# 74 "project/radare2/libr/core/cfile.c"
                         ) {
...
# 79 "project/radare2/libr/core/cfile.c" 3 4
 fprintf(__stderrp,
# 79 "project/radare2/libr/core/cfile.c"
 "Cannot reopen in sandbox\n"
# 79 "project/radare2/libr/core/cfile.c" 3 4
 )
# 79 "project/radare2/libr/core/cfile.c"
                                       ;
  free (obinfilepath);
  return 
# 81 "project/radare2/libr/core/cfile.c" 3 4
        0
# 81 "project/radare2/libr/core/cfile.c"
             ;
 }
 if (!odesc) {
  
# 84 "project/radare2/libr/core/cfile.c" 3 4
 fprintf(__stderrp,
# 84 "project/radare2/libr/core/cfile.c"
 "No file opened to reopen\n"
# 84 "project/radare2/libr/core/cfile.c" 3 4
 )
# 84 "project/radare2/libr/core/cfile.c"
                                       ;
  ...
  free (obinfilepath);
  return 
# 87 "project/radare2/libr/core/cfile.c" 3 4
        0
# 87 "project/radare2/libr/core/cfile.c"
             ;
 }
 int newpid = odesc->fd;
...
# 104 "project/radare2/libr/core/cfile.c" 3 4
 fprintf(__stderrp,
# 104 "project/radare2/libr/core/cfile.c"
 "Unknown file path"
# 104 "project/radare2/libr/core/cfile.c" 3 4
 )
# 104 "project/radare2/libr/core/cfile.c"
  ...
  free (obinfilepath);
  return 
# 106 "project/radare2/libr/core/cfile.c" 3 4
        0
# 106 "project/radare2/libr/core/cfile.c"
             ;
 }
...
# 132 "project/radare2/libr/core/cfile.c" 3 4
 __builtin___memset_chk (
# 132 "project/radare2/libr/core/cfile.c"
 &core->dbg->reason
# 132 "project/radare2/libr/core/cfile.c" 3 4
 , 
# 132 "project/radare2/libr/core/cfile.c"
 0, sizeof (core->dbg->reason)
# 132 "project/radare2/libr/core/cfile.c" 3 4
...
# 134 "project/radare2/libr/core/cfile.c" 3 4
                                        1
# 134 "project/radare2/libr/core/cfile.c"
                                            );
...
# 139 "project/radare2/libr/core/cfile.c" 3 4
 _Bool 
# 139 "project/radare2/libr/core/cfile.c"
      had_rbin_info = 
# 139 "project/radare2/libr/core/cfile.c" 3 4
                      0
# 139 "project/radare2/libr/core/cfile.c"
  ...
  if (odesc && bf) {
   if (r_bin_file_delete (core->bin, bf->id)) {
    had_rbin_info = 
# 143 "project/radare2/libr/core/cfile.c" 3 4
                   1
# 143 "project/radare2/libr/core/cfile.c"
                       ;
   }
  }
  r_io_fd_close (core->io, odesc->fd);
  
# 147 "project/radare2/libr/core/cfile.c" 3 4
 fprintf(__stderrp,
# 147 "project/radare2/libr/core/cfile.c"
 "File %s reopened in %s mode\n", path, (perm & 
# 147 "project/radare2/libr/core/cfile.c" 3 4
 2
# 147 "project/radare2/libr/core/cfile.c"
...
# 148 "project/radare2/libr/core/cfile.c"
                                               ;

  if (loadbin && (loadbin == 2 || had_rbin_info)) {
   
# 151 "project/radare2/libr/core/cfile.c" 3 4
  unsigned long long 
# 151 "project/radare2/libr/core/cfile.c"
       baddr;
   if (isdebug) {
    baddr = r_debug_get_baddr (core->dbg, path);
   } else if (new_baddr != 
# 154 "project/radare2/libr/core/cfile.c" 3 4
                          0xFFFFFFFFFFFFFFFFULL
# 154 "project/radare2/libr/core/cfile.c"
                                  ) {
    baddr = new_baddr;
   } else {
...
# 162 "project/radare2/libr/core/cfile.c" 3 4
   fprintf(__stderrp,
# 162 "project/radare2/libr/core/cfile.c"
   "Error: Failed to reload rbin for: %s", path
# 162 "project/radare2/libr/core/cfile.c" 3 4
   )
# 162 "project/radare2/libr/core/cfile.c"
                                                         ;
  ...
  if (core->bin->cur && core->io && r_io_desc_get (core->io, file->fd) && !loadbin) {
   ...
   core->bin->cur = 
# 169 "project/radare2/libr/core/cfile.c" 3 4
                   ((void *)0)
# 169 "project/radare2/libr/core/cfile.c"
                       ;
  }

 } else if (odesc) {
  
# 173 "project/radare2/libr/core/cfile.c" 3 4
 fprintf(__stderrp,
# 173 "project/radare2/libr/core/cfile.c"
 "r_core_file_reopen: Cannot reopen file: %s with perms 0x%x," " attempting to open read-only.\n", path, perm
# 173 "project/radare2/libr/core/cfile.c" 3 4
 )
                                                  
# 174 "project/radare2/libr/core/cfile.c"
                                                 ;


 } else {
  
# 178 "project/radare2/libr/core/cfile.c" 3 4
 fprintf(__stderrp,
# 178 "project/radare2/libr/core/cfile.c"
 "Cannot reopen\n"
# 178 "project/radare2/libr/core/cfile.c" 3 4
 )
# 178 "project/radare2/libr/core/cfile.c"
 ...
 r_core_seek (core, origoff, 
# 184 "project/radare2/libr/core/cfile.c" 3 4
                            1
# 184 "project/radare2/libr/core/cfile.c"
                                );
 if (isdebug) {
  r_core_cmd0 (core, ".dm*");
  r_core_cmd0 (core, ".dr*");
...
# 207 "project/radare2/libr/core/cfile.c" 3 4
__attribute__((visibility("default"))) 
# 207 "project/radare2/libr/core/cfile.c"
     void r_core_sysenv_end(RCore *core, const char *cmd) {
 ...
 if (strstr (cmd, "R2_BLOCK")) {
  ...
  if (f) {
   r_file_rm (f);
   r_sys_setenv ("R2_BLOCK", 
# 214 "project/radare2/libr/core/cfile.c" 3 4
                            ((void *)0)
# 214 "project/radare2/libr/core/cfile.c"
                                );
   free (f);
  }
 }
 r_sys_setenv ("R2_FILE", 
# 218 "project/radare2/libr/core/cfile.c" 3 4
                         ((void *)0)
# 218 "project/radare2/libr/core/cfile.c"
                             );
 r_sys_setenv ("R2_BYTES", 
# 219 "project/radare2/libr/core/cfile.c" 3 4
                          ((void *)0)
# 219 "project/radare2/libr/core/cfile.c"
                              );
 r_sys_setenv ("R2_OFFSET", 
# 220 "project/radare2/libr/core/cfile.c" 3 4
                           ((void *)0)
# 220 "project/radare2/libr/core/cfile.c"
                               );
 r_sys_setenv ("R2_UTF8", 
# 221 "project/radare2/libr/core/cfile.c" 3 4
                         ((void *)0)
# 221 "project/radare2/libr/core/cfile.c"
                             );
 ...
 if (r2_config) {
  r_file_rm (r2_config);
  r_sys_setenv ("R2_CONFIG", 
# 227 "project/radare2/libr/core/cfile.c" 3 4
                            ((void *)0)
# 227 "project/radare2/libr/core/cfile.c"
                                );
  free (r2_config);
 }
}
...
# 232 "project/radare2/libr/core/cfile.c" 3 4
__attribute__((visibility("default"))) 
# 232 "project/radare2/libr/core/cfile.c"
     char *r_core_sysenv_begin(RCore * core, const char *cmd) {
 char *f, *ret = cmd? strdup (cmd): 
# 233 "project/radare2/libr/core/cfile.c" 3 4
                                   ((void *)0)
# 233 "project/radare2/libr/core/cfile.c"
                                       ;
 ...
 if (desc && desc->name) {
  ...
  r_sys_setenv ("R2_SIZE", sdb_fmt ("%"
# 243 "project/radare2/libr/core/cfile.c" 3 4
                                      "lld"
# 243 "project/radare2/libr/core/cfile.c"
                                             , r_io_desc_size (desc)));
 ...
 r_sys_setenv ("R2_OFFSET", sdb_fmt ("%"
# 254 "project/radare2/libr/core/cfile.c" 3 4
                                       "lld"
# 254 "project/radare2/libr/core/cfile.c"
                                              , core->offset));
 r_sys_setenv ("R2_XOFFSET", sdb_fmt ("0x%08"
# 255 "project/radare2/libr/core/cfile.c" 3 4
                                            "llx"
# 255 "project/radare2/libr/core/cfile.c"
                                                   , core->offset));
 r_sys_setenv ("R2_ENDIAN", core->rasm->big_endian? "big": "little");
 r_sys_setenv ("R2_BSIZE", sdb_fmt ("%d", core->blocksize));
# 271 "project/radare2/libr/core/cfile.c"
 ...
 r_sys_setenv ("R2_BITS", sdb_fmt ("%"
# 274 "project/radare2/libr/core/cfile.c" 3 4
                                     "llu"
# 274 "project/radare2/libr/core/cfile.c"
                                            , r_config_get_i (core->config, "asm.bits")));
 char *s = sdb_itoa (r_config_get_i (core->config, "scr.color"), 
# 275 "project/radare2/libr/core/cfile.c" 3 4
                                                                ((void *)0)
# 275 "project/radare2/libr/core/cfile.c"
                                                                    , 10);
...
static 
# 288 "project/radare2/libr/core/cfile.c" 3 4
      unsigned long long 
# 288 "project/radare2/libr/core/cfile.c"
           get_base_from_maps(RCore *core, const char *file) {
 RDebugMap *map;
 RListIter *iter;
 
# 291 "project/radare2/libr/core/cfile.c" 3 4
unsigned long long 
# 291 "project/radare2/libr/core/cfile.c"
     b = 0LL;

 r_debug_map_sync (core->dbg);
 
# 294 "project/radare2/libr/core/cfile.c" 3 4
if (
# 294 "project/radare2/libr/core/cfile.c"
core->dbg->maps
# 294 "project/radare2/libr/core/cfile.c" 3 4
) for (
# 294 "project/radare2/libr/core/cfile.c"
...
# 312 "project/radare2/libr/core/cfile.c" 3 4
if (
# 312 "project/radare2/libr/core/cfile.c"
core->dbg->maps
# 312 "project/radare2/libr/core/cfile.c" 3 4
) for (
# 312 "project/radare2/libr/core/cfile.c"
...
static 
# 323 "project/radare2/libr/core/cfile.c" 3 4
      _Bool 
# 323 "project/radare2/libr/core/cfile.c"
           setbpint(RCore *r, const char *mode, const char *sym) {
 RBreakpointItem *bp;
 RFlagItem *fi = r_flag_get (r->flags, sym);
 if (!fi) {
  return 
# 327 "project/radare2/libr/core/cfile.c" 3 4
        0
# 327 "project/radare2/libr/core/cfile.c"
             ;
 }
 bp = r_bp_add_sw (r->dbg->bp, fi->offset, 1, R_BP_PROT_EXEC);
 if (bp) {
  bp->internal = 
# 331 "project/radare2/libr/core/cfile.c" 3 4
                1
# 331 "project/radare2/libr/core/cfile.c"
                    ;
  ...
  return 
# 337 "project/radare2/libr/core/cfile.c" 3 4
        1
# 337 "project/radare2/libr/core/cfile.c"
            ;
 }
 
# 339 "project/radare2/libr/core/cfile.c" 3 4
fprintf(__stderrp,
# 339 "project/radare2/libr/core/cfile.c"
...
# 339 "project/radare2/libr/core/cfile.c"
                                              ;
 return 
# 340 "project/radare2/libr/core/cfile.c" 3 4
       0
# 340 "project/radare2/libr/core/cfile.c"
            ;
}
...
static int r_core_file_do_load_for_debug(RCore *r, 
# 345 "project/radare2/libr/core/cfile.c" 3 4
                                                  unsigned long long 
# 345 "project/radare2/libr/core/cfile.c"
                                                       baseaddr, const char *filenameuri) {
 RIODesc *desc = r->io->desc;
 RBinFile *binfile = 
# 347 "project/radare2/libr/core/cfile.c" 3 4
                    ((void *)0)
# 347 "project/radare2/libr/core/cfile.c"
                        ;
 RBinPlugin *plugin;
 int xtr_idx = 0;
 ...
 if (!desc) {
  return 
# 356 "project/radare2/libr/core/cfile.c" 3 4
        0
# 356 "project/radare2/libr/core/cfile.c"
             ;
 }
 int fd = desc->fd;
 ...
 if (baseaddr != 
# 365 "project/radare2/libr/core/cfile.c" 3 4
                0xFFFFFFFFFFFFFFFFULL
# 365 "project/radare2/libr/core/cfile.c"
                        ) {
  r_config_set_i (r->config, "bin.baddr", baseaddr);
 }

 RBinFileOptions opt;
 r_bin_file_options_init (&opt, fd, baseaddr, 
# 370 "project/radare2/libr/core/cfile.c" 3 4
                                             0xFFFFFFFFFFFFFFFFULL
# 370 "project/radare2/libr/core/cfile.c"
                                                     , 
# 370 "project/radare2/libr/core/cfile.c" 3 4
                                                       0
# 370 "project/radare2/libr/core/cfile.c"
...
# 373 "project/radare2/libr/core/cfile.c" 3 4
 fprintf(__stderrp,
# 373 "project/radare2/libr/core/cfile.c"
 "RBinLoad: Cannot open %s\n", filenameuri
# 373 "project/radare2/libr/core/cfile.c" 3 4
 )
# 373 "project/radare2/libr/core/cfile.c"
                                                    ;
  if (r_config_get_i (r->config, "bin.rawstr")) {
   r_bin_file_options_init (&opt, fd, baseaddr, 
# 375 "project/radare2/libr/core/cfile.c" 3 4
                                               0xFFFFFFFFFFFFFFFFULL
# 375 "project/radare2/libr/core/cfile.c"
                                                       , 
# 375 "project/radare2/libr/core/cfile.c" 3 4
                                                         1
# 375 "project/radare2/libr/core/cfile.c"
   ...
   if (!r_bin_open (r->bin, filenameuri, &opt)) {
    return 
# 378 "project/radare2/libr/core/cfile.c" 3 4
          0
# 378 "project/radare2/libr/core/cfile.c"
               ;
   }
  }
 }
 ...
 if (plugin && !strcmp (plugin->name, "any")) {
  ...
  RBinInfo *info = obj? obj->info: 
# 406 "project/radare2/libr/core/cfile.c" 3 4
                                  ((void *)0)
# 406 "project/radare2/libr/core/cfile.c"
                                      ;
  if (plugin && info) {
 ...
 return 
# 416 "project/radare2/libr/core/cfile.c" 3 4
       1
# 416 "project/radare2/libr/core/cfile.c"
           ;
}

static int r_core_file_do_load_for_io_plugin(RCore *r, 
# 419 "project/radare2/libr/core/cfile.c" 3 4
                                                      unsigned long long 
# 419 "project/radare2/libr/core/cfile.c"
                                                           baseaddr, 
# 419 "project/radare2/libr/core/cfile.c" 3 4
                                                                     unsigned long long 
# 419 "project/radare2/libr/core/cfile.c"
 ...
 int fd = cd ? cd->fd : -1;
 RBinFile *binfile = 
# 422 "project/radare2/libr/core/cfile.c" 3 4
                    ((void *)0)
# 422 "project/radare2/libr/core/cfile.c"
                        ;
 int xtr_idx = 0;
 RBinPlugin *plugin;
 ...
 if (fd < 0) {
  return 
# 427 "project/radare2/libr/core/cfile.c" 3 4
        0
# 427 "project/radare2/libr/core/cfile.c"
             ;
 }
 r_io_use_fd (r->io, fd);
 RBinFileOptions opt;
 ...
 if (!r_bin_open_io (r->bin, &opt)) {
  ...
  return 
# 436 "project/radare2/libr/core/cfile.c" 3 4
        0
# 436 "project/radare2/libr/core/cfile.c"
             ;
 }
 binfile = r_bin_cur (r->bin);
...
# 441 "project/radare2/libr/core/cfile.c" 3 4
  r_log (__func__, "project/radare2/libr/core/cfile.c", 441, R_LOGLVL_WARN, ((void *)0), 
# 441 "project/radare2/libr/core/cfile.c"
...
# 441 "project/radare2/libr/core/cfile.c"
 ...
 if (plugin && !strcmp (plugin->name, "any")) {
  RBinObject *obj = r_bin_cur_object (r->bin);
  RBinInfo *info = obj? obj->info: 
# 447 "project/radare2/libr/core/cfile.c" 3 4
                                  ((void *)0)
# 447 "project/radare2/libr/core/cfile.c"
                                      ;
  if (!info) {
   return 
# 449 "project/radare2/libr/core/cfile.c" 3 4
         0
# 449 "project/radare2/libr/core/cfile.c"
              ;
  }
  ...
  RBinObject *obj = r_bin_cur_object (r->bin);
  RBinInfo *info = obj? obj->info: 
# 461 "project/radare2/libr/core/cfile.c" 3 4
                                  ((void *)0)
# 461 "project/radare2/libr/core/cfile.c"
                                      ;
  if (!info) {
   return 
# 463 "project/radare2/libr/core/cfile.c" 3 4
         0
# 463 "project/radare2/libr/core/cfile.c"
              ;
  }
  if (plugin) {
 ...
 return 
# 474 "project/radare2/libr/core/cfile.c" 3 4
       1
# 474 "project/radare2/libr/core/cfile.c"
           ;
}

static 
# 477 "project/radare2/libr/core/cfile.c" 3 4
      _Bool 
# 477 "project/radare2/libr/core/cfile.c"
           try_loadlib(RCore *core, const char *lib, 
# 477 "project/radare2/libr/core/cfile.c" 3 4
                                                     unsigned long long 
# 477 "project/radare2/libr/core/cfile.c"
                                                          addr) {
 ...
 if (p) {
  ...
  return 
# 481 "project/radare2/libr/core/cfile.c" 3 4
        1
# 481 "project/radare2/libr/core/cfile.c"
            ;
 }
 return 
# 483 "project/radare2/libr/core/cfile.c" 3 4
       0
# 483 "project/radare2/libr/core/cfile.c"
            ;
}


# 486 "project/radare2/libr/core/cfile.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 486 "project/radare2/libr/core/cfile.c"
          r_core_file_loadlib(RCore *core, const char *lib, 
# 486 "project/radare2/libr/core/cfile.c" 3 4
                                                            unsigned long long 
# 486 "project/radare2/libr/core/cfile.c"
                                                                 libaddr) {
 ...
 char *libdir = strdup (
# 494 "project/radare2/libr/core/cfile.c" 3 4
                       "/usr/local/lib"
# 494 "project/radare2/libr/core/cfile.c"
                                );

 if (!dirlibs || !*dirlibs) {
  dirlibs = "." 
# 497 "project/radare2/libr/core/cfile.c" 3 4
               "/"
# 497 "project/radare2/libr/core/cfile.c"
                        ;
 }
 const char *ldlibrarypath[] = {
  ...
  "." 
# 507 "project/radare2/libr/core/cfile.c" 3 4
     "/"
# 507 "project/radare2/libr/core/cfile.c"
              ,
  
# 508 "project/radare2/libr/core/cfile.c" 3 4
 ((void *)0)
 
# 509 "project/radare2/libr/core/cfile.c"
};
 const char * *libpath = (const char * *) &ldlibrarypath;

 
# 512 "project/radare2/libr/core/cfile.c" 3 4
_Bool 
# 512 "project/radare2/libr/core/cfile.c"
     ret = 
# 512 "project/radare2/libr/core/cfile.c" 3 4
           0
# 512 "project/radare2/libr/core/cfile.c"
 ...
 if (*lib == '/') {
  ...
  if (try_loadlib (core, lib, libaddr)) {
   ret = 
# 519 "project/radare2/libr/core/cfile.c" 3 4
        1
# 519 "project/radare2/libr/core/cfile.c"
            ;
  }
 } else {
  while (*libpath) {
   char *s = r_str_newf ("%s" 
# 523 "project/radare2/libr/core/cfile.c" 3 4
                             "/" 
# 523 "project/radare2/libr/core/cfile.c"
                                       "%s", *libpath, lib);
   if (try_loadlib (core, s, libaddr)) {
    ret = 
# 525 "project/radare2/libr/core/cfile.c" 3 4
         1
# 525 "project/radare2/libr/core/cfile.c"
             ;
   }
   free (s);
   if (ret) {
...
static void load_scripts_for(RCore *core, const char *name) {
 char *file;
 RListIter *iter;
 char *hdir = r_str_newf (
# 541 "project/radare2/libr/core/cfile.c" 3 4
                         ".local" "/" "share" "/" "radare2" "/" "rc.d" "/" 
# 541 "project/radare2/libr/core/cfile.c"
                         "bin-%s", name);
 char *path = r_str_home (hdir);
 RList *files = r_sys_dir (path);
 if (!
# 544 "project/radare2/libr/core/cfile.c" 3 4
     (!(
# 544 "project/radare2/libr/core/cfile.c"
     files
# 544 "project/radare2/libr/core/cfile.c" 3 4
     ) || !(
# 544 "project/radare2/libr/core/cfile.c"
...
# 545 "project/radare2/libr/core/cfile.c" 3 4
 fprintf(__stderrp,
# 545 "project/radare2/libr/core/cfile.c"
 "[binrc] path: %s\n", path
# 545 "project/radare2/libr/core/cfile.c" 3 4
 )
# 545 "project/radare2/libr/core/cfile.c"
...
# 547 "project/radare2/libr/core/cfile.c" 3 4
if (
# 547 "project/radare2/libr/core/cfile.c"
files
# 547 "project/radare2/libr/core/cfile.c" 3 4
) for (
# 547 "project/radare2/libr/core/cfile.c"
...
# 549 "project/radare2/libr/core/cfile.c" 3 4
  fprintf(__stderrp,
# 549 "project/radare2/libr/core/cfile.c"
  "[binrc] loading %s\n", file
# 549 "project/radare2/libr/core/cfile.c" 3 4
  )
# 549 "project/radare2/libr/core/cfile.c"
...
# 560 "project/radare2/libr/core/cfile.c" 3 4
_Bool 
# 560 "project/radare2/libr/core/cfile.c"
     found;
} MyFileData;

static 
# 563 "project/radare2/libr/core/cfile.c" 3 4
      _Bool 
# 563 "project/radare2/libr/core/cfile.c"
           filecb(void *user, void *data, 
# 563 "project/radare2/libr/core/cfile.c" 3 4
                                          unsigned int 
# 563 "project/radare2/libr/core/cfile.c"
                                               id) {
 ...
 if (!strcmp (desc->name, filedata->name)) {
  filedata->found = 
# 567 "project/radare2/libr/core/cfile.c" 3 4
                   1
# 567 "project/radare2/libr/core/cfile.c"
                       ;
 }
 return 
# 569 "project/radare2/libr/core/cfile.c" 3 4
       1
# 569 "project/radare2/libr/core/cfile.c"
           ;
}

static 
# 572 "project/radare2/libr/core/cfile.c" 3 4
      _Bool 
# 572 "project/radare2/libr/core/cfile.c"
           file_is_loaded(RCore *core, const char *lib) {
 MyFileData filedata = {lib, 
# 573 "project/radare2/libr/core/cfile.c" 3 4
                            0
# 573 "project/radare2/libr/core/cfile.c"
                                 };
...
# 580 "project/radare2/libr/core/cfile.c" 3 4
unsigned long long 
# 580 "project/radare2/libr/core/cfile.c"
     addr;
 RBin *bin;
} RCoreLinkData;

static 
# 584 "project/radare2/libr/core/cfile.c" 3 4
      _Bool 
# 584 "project/radare2/libr/core/cfile.c"
           linkcb(void *user, void *data, 
# 584 "project/radare2/libr/core/cfile.c" 3 4
                                          unsigned int 
# 584 "project/radare2/libr/core/cfile.c"
                                               id) {
...
# 593 "project/radare2/libr/core/cfile.c" 3 4
 if (
# 593 "project/radare2/libr/core/cfile.c"
 symbols
# 593 "project/radare2/libr/core/cfile.c" 3 4
 ) for (
# 593 "project/radare2/libr/core/cfile.c"
...
# 593 "project/radare2/libr/core/cfile.c"
   ...
   if (!strcmp (sym->name, ld->name)) {
    ld->addr = sym->vaddr;
    return 
# 596 "project/radare2/libr/core/cfile.c" 3 4
          0
# 596 "project/radare2/libr/core/cfile.c"
               ;
   }
  }
 }
 return 
# 600 "project/radare2/libr/core/cfile.c" 3 4
       1
# 600 "project/radare2/libr/core/cfile.c"
           ;
}


# 603 "project/radare2/libr/core/cfile.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 603 "project/radare2/libr/core/cfile.c"
          r_core_bin_load(RCore *r, const char *filenameuri, 
# 603 "project/radare2/libr/core/cfile.c" 3 4
                                                             unsigned long long 
# 603 "project/radare2/libr/core/cfile.c"
                                                                  baddr) {
 
# 604 "project/radare2/libr/core/cfile.c" 3 4
do { if (!(
# 604 "project/radare2/libr/core/cfile.c"
r && r->io
# 604 "project/radare2/libr/core/cfile.c" 3 4
...
"r && r->io"
# 604 "project/radare2/libr/core/cfile.c" 3 4
, 604); return (0); } } while (0)
# 604 "project/radare2/libr/core/cfile.c"
                                        ;
 
# 605 "project/radare2/libr/core/cfile.c" 3 4
unsigned long long 
# 605 "project/radare2/libr/core/cfile.c"
     laddr = r_config_get_i (r->config, "bin.laddr");
 RBinFile *binfile = 
# 606 "project/radare2/libr/core/cfile.c" 3 4
                    ((void *)0)
# 606 "project/radare2/libr/core/cfile.c"
                        ;
 RBinPlugin *plugin = 
# 607 "project/radare2/libr/core/cfile.c" 3 4
                     ((void *)0)
# 607 "project/radare2/libr/core/cfile.c"
                         ;
 const char *cmd_load;
 RIODesc *desc = r->io->desc;
 if (!desc && filenameuri) {
 ...
 if (!desc) {
  ...
  if (!filenameuri || *filenameuri == '-') {
   ...
   return 
# 617 "project/radare2/libr/core/cfile.c" 3 4
         0
# 617 "project/radare2/libr/core/cfile.c"
              ;
  }
...
# 622 "project/radare2/libr/core/cfile.c" 3 4
_Bool 
# 622 "project/radare2/libr/core/cfile.c"
     is_io_load = 
# 622 "project/radare2/libr/core/cfile.c" 3 4
                  0
# 622 "project/radare2/libr/core/cfile.c"
 ...
 if (desc && desc->plugin) {
  is_io_load = 
# 624 "project/radare2/libr/core/cfile.c" 3 4
              1
# 624 "project/radare2/libr/core/cfile.c"
                  ;
 ...
 r_core_bin_export_info (r, 
# 655 "project/radare2/libr/core/cfile.c" 3 4
                           0x002
# 655 "project/radare2/libr/core/cfile.c"
                                     );
...
# 663 "project/radare2/libr/core/cfile.c" 3 4
  unsigned long long 
# 663 "project/radare2/libr/core/cfile.c"
       size = (desc->name && (r_str_startswith (desc->name, "rap") && strstr (desc->name, "://")))
    ? 
# 664 "project/radare2/libr/core/cfile.c" 3 4
     0xFFFFFFFFFFFFFFFFULL 
# 664 "project/radare2/libr/core/cfile.c"
              : r_io_desc_size (desc);
...
# 675 "project/radare2/libr/core/cfile.c" 3 4
   _Bool 
# 675 "project/radare2/libr/core/cfile.c"
        va = obj->info ? obj->info->has_va : 0;
    if (!va) {
 ...
 if (desc && r_config_get_i (r->config, "io.exec")) {
  desc->perm |= 
# 704 "project/radare2/libr/core/cfile.c" 3 4
               1
# 704 "project/radare2/libr/core/cfile.c"
                       ;
 }
...
# 717 "project/radare2/libr/core/cfile.c" 3 4
 if (
# 717 "project/radare2/libr/core/cfile.c"
 libs
# 717 "project/radare2/libr/core/cfile.c" 3 4
 ) for (
# 717 "project/radare2/libr/core/cfile.c"
...
# 721 "project/radare2/libr/core/cfile.c" 3 4
  fprintf(__stderrp,
# 721 "project/radare2/libr/core/cfile.c"
  "[bin.libs] Opening %s\n", lib
# 721 "project/radare2/libr/core/cfile.c" 3 4
  )
# 721 "project/radare2/libr/core/cfile.c"
...
# 722 "project/radare2/libr/core/cfile.c" 3 4
  unsigned long long 
# 722 "project/radare2/libr/core/cfile.c"
       baddr = (r->io->bits == 64)? 0x60000000000LL: 0x60000000;
   if (r_io_map_locate (r->io, &baddr, 0x200000, 1)) {
    r_core_file_loadlib (r, lib, baddr);
   }
  }
  r_core_cmd0 (r, "obb 0;s entry0");
  r_config_set_i (r->config, "bin.at", 
# 728 "project/radare2/libr/core/cfile.c" 3 4
                                      1
# 728 "project/radare2/libr/core/cfile.c"
                                          );
  
# 729 "project/radare2/libr/core/cfile.c" 3 4
 fprintf(__stderrp,
# 729 "project/radare2/libr/core/cfile.c"
 "[bin.libs] Linking imports...\n"
# 729 "project/radare2/libr/core/cfile.c" 3 4
 )
# 729 "project/radare2/libr/core/cfile.c"
                                            ;
...
# 732 "project/radare2/libr/core/cfile.c" 3 4
 if (
# 732 "project/radare2/libr/core/cfile.c"
 imports
# 732 "project/radare2/libr/core/cfile.c" 3 4
 ) for (
# 732 "project/radare2/libr/core/cfile.c"
...
# 739 "project/radare2/libr/core/cfile.c" 3 4
  unsigned long long 
# 739 "project/radare2/libr/core/cfile.c"
       imp_addr = impsym->offset;
   
# 740 "project/radare2/libr/core/cfile.c" 3 4
  fprintf(__stderrp,
# 740 "project/radare2/libr/core/cfile.c"
  "Resolving %s... ", imp->name
# 740 "project/radare2/libr/core/cfile.c" 3 4
  )
# 740 "project/radare2/libr/core/cfile.c"
                                         ;
   RCoreLinkData linkdata = {imp->name, 
# 741 "project/radare2/libr/core/cfile.c" 3 4
                                       0xFFFFFFFFFFFFFFFFULL
# 741 "project/radare2/libr/core/cfile.c"
                                               , r->bin};
   r_id_storage_foreach (r->io->files, linkcb, &linkdata);
   if (linkdata.addr != 
# 743 "project/radare2/libr/core/cfile.c" 3 4
                       0xFFFFFFFFFFFFFFFFULL
# 743 "project/radare2/libr/core/cfile.c"
                               ) {
    
# 744 "project/radare2/libr/core/cfile.c" 3 4
   fprintf(__stderrp,
# 744 "project/radare2/libr/core/cfile.c"
   "0x%08"
# 744 "project/radare2/libr/core/cfile.c" 3 4
   "llx"
# 744 "project/radare2/libr/core/cfile.c"
...
# 745 "project/radare2/libr/core/cfile.c" 3 4
   unsigned long long 
# 745 "project/radare2/libr/core/cfile.c"
        a = linkdata.addr;
    
# 746 "project/radare2/libr/core/cfile.c" 3 4
   unsigned long long 
# 746 "project/radare2/libr/core/cfile.c"
        b = imp_addr;
    r_core_cmdf (r, "ax 0x%08"
# 747 "project/radare2/libr/core/cfile.c" 3 4
                             "llx"
# 747 "project/radare2/libr/core/cfile.c"
                                    " 0x%08"
# 747 "project/radare2/libr/core/cfile.c" 3 4
                                            "llx"
# 747 "project/radare2/libr/core/cfile.c"
...
# 755 "project/radare2/libr/core/cfile.c" 3 4
 unsigned long long 
# 755 "project/radare2/libr/core/cfile.c"
      sp_addr = (
# 755 "project/radare2/libr/core/cfile.c" 3 4
                 unsigned long long
# 755 "project/radare2/libr/core/cfile.c"
  ...
  RIOMap *stack_map = 
# 756 "project/radare2/libr/core/cfile.c" 3 4
                     ((void *)0)
# 756 "project/radare2/libr/core/cfile.c"
                         ;
...
# 761 "project/radare2/libr/core/cfile.c" 3 4
  fprintf(__stderrp,
# 761 "project/radare2/libr/core/cfile.c"
  "Setting up coredump arch-bits to: %s-%d\n", inf->arch, inf->bits
# 761 "project/radare2/libr/core/cfile.c" 3 4
  )
# 761 "project/radare2/libr/core/cfile.c"
                                                                             ;
...
# 768 "project/radare2/libr/core/cfile.c" 3 4
   fprintf(__stderrp,
# 768 "project/radare2/libr/core/cfile.c"
...
# 770 "project/radare2/libr/core/cfile.c" 3 4
   fprintf(__stderrp,
# 770 "project/radare2/libr/core/cfile.c"
...
# 783 "project/radare2/libr/core/cfile.c" 3 4
     unsigned long long 
# 783 "project/radare2/libr/core/cfile.c"
          seek = r_reg_get_value (r->anal->reg, reg);
      r_core_seek (r, seek, 
# 784 "project/radare2/libr/core/cfile.c" 3 4
                           1
# 784 "project/radare2/libr/core/cfile.c"
                               );
     }
    }
   }
...
# 797 "project/radare2/libr/core/cfile.c" 3 4
  if (
# 797 "project/radare2/libr/core/cfile.c"
  maps
# 797 "project/radare2/libr/core/cfile.c" 3 4
  ) for (
# 797 "project/radare2/libr/core/cfile.c"
...
# 797 "project/radare2/libr/core/cfile.c"
   ...
   r_list_free (maps);
   o->maps = 
# 805 "project/radare2/libr/core/cfile.c" 3 4
            ((void *)0)
# 805 "project/radare2/libr/core/cfile.c"
                ;
  }
  
# 807 "project/radare2/libr/core/cfile.c" 3 4
 fprintf(__stderrp,
# 807 "project/radare2/libr/core/cfile.c"
 "Setting up coredump: %d maps have been found and created\n", map
# 807 "project/radare2/libr/core/cfile.c" 3 4
 )
# 807 "project/radare2/libr/core/cfile.c"
                                                                            ;
...
beach:
 ...
 return 
# 812 "project/radare2/libr/core/cfile.c" 3 4
       1
# 812 "project/radare2/libr/core/cfile.c"
           ;
}


# 815 "project/radare2/libr/core/cfile.c" 3 4
__attribute__((visibility("default"))) 
# 815 "project/radare2/libr/core/cfile.c"
     RIODesc *r_core_file_open_many(RCore *r, const char *file, int perm, 
# 815 "project/radare2/libr/core/cfile.c" 3 4
                                                                          unsigned long long 
# 815 "project/radare2/libr/core/cfile.c"
                                                                               loadaddr) {
 ...
 if (!list_fds || r_list_length (list_fds) == 0) {
  ...
  return 
# 822 "project/radare2/libr/core/cfile.c" 3 4
        ((void *)0)
# 822 "project/radare2/libr/core/cfile.c"
            ;
 }
 RListIter *iter;
 RIODesc *first = 
# 825 "project/radare2/libr/core/cfile.c" 3 4
                 ((void *)0)
# 825 "project/radare2/libr/core/cfile.c"
                     ;
 
# 826 "project/radare2/libr/core/cfile.c" 3 4
_Bool 
# 826 "project/radare2/libr/core/cfile.c"
     incloadaddr = loadaddr == 0;

 
# 828 "project/radare2/libr/core/cfile.c" 3 4
if (
# 828 "project/radare2/libr/core/cfile.c"
list_fds
# 828 "project/radare2/libr/core/cfile.c" 3 4
) for (
# 828 "project/radare2/libr/core/cfile.c"
...
# 835 "project/radare2/libr/core/cfile.c" 3 4
  unsigned long long 
# 835 "project/radare2/libr/core/cfile.c"
       sz = r_io_fd_size (r->io, fd->fd);
   r_core_bin_load (r, fd->uri, loadaddr);
   if (incloadaddr && sz != 
# 837 "project/radare2/libr/core/cfile.c" 3 4
                           0xFFFFFFFFFFFFFFFFULL
# 837 "project/radare2/libr/core/cfile.c"
                                   ) {
...
# 848 "project/radare2/libr/core/cfile.c" 3 4
__attribute__((visibility("default"))) 
# 848 "project/radare2/libr/core/cfile.c"
     RIODesc *r_core_file_open(RCore *r, const char *file, int flags, 
# 848 "project/radare2/libr/core/cfile.c" 3 4
                                                                      unsigned long long 
# 848 "project/radare2/libr/core/cfile.c"
                                                                           loadaddr) {
 
# 849 "project/radare2/libr/core/cfile.c" 3 4
do { if (!(
# 849 "project/radare2/libr/core/cfile.c"
r && file
# 849 "project/radare2/libr/core/cfile.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 849 "project/radare2/libr/core/cfile.c"
"r && file"
# 849 "project/radare2/libr/core/cfile.c" 3 4
, 849); return (((void *)0)); } } while (0)
# 849 "project/radare2/libr/core/cfile.c"
                                      ;
 
# 850 "project/radare2/libr/core/cfile.c" 3 4
unsigned long long 
# 850 "project/radare2/libr/core/cfile.c"
 ...
 if (!flags) {
  flags = 
# 857 "project/radare2/libr/core/cfile.c" 3 4
         4
# 857 "project/radare2/libr/core/cfile.c"
                 ;
 }
 r->io->bits = r->rasm->bits;
 ...
 if (!fd) {
  if (flags & 
# 872 "project/radare2/libr/core/cfile.c" 3 4
             2
# 872 "project/radare2/libr/core/cfile.c"
                     ) {
 ...
 if (r_io_is_listener (r->io)) {
  ...
  r_io_desc_free (fd);
  fd = 
# 884 "project/radare2/libr/core/cfile.c" 3 4
      ((void *)0)
# 884 "project/radare2/libr/core/cfile.c"
          ;
  goto beach;
 }
...
# 898 "project/radare2/libr/core/cfile.c" 3 4
 _Bool 
# 898 "project/radare2/libr/core/cfile.c"
      swstep = 
# 898 "project/radare2/libr/core/cfile.c" 3 4
               1
# 898 "project/radare2/libr/core/cfile.c"
  ...
  if (r->dbg->h && r->dbg->h->canstep) {
   swstep = 
# 900 "project/radare2/libr/core/cfile.c" 3 4
           0
# 900 "project/radare2/libr/core/cfile.c"
                ;
  }
 ...
 if (loadaddr != 
# 914 "project/radare2/libr/core/cfile.c" 3 4
                0xFFFFFFFFFFFFFFFFULL
# 914 "project/radare2/libr/core/cfile.c"
                        ) {
