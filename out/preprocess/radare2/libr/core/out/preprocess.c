# 0 "project/radare2/libr/core/project.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/project.c"
...
typedef int RRef;
# 4 "project/radare2/libr/core/project.c" 2
...
# 5 "project/radare2/libr/core/project.c" 2
...
# 6 "project/radare2/libr/core/project.c" 2
...
# 7 "project/radare2/libr/core/project.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/rvc.h" 1 3 4
# 13 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/rvc.h" 3 4
typedef struct RvcBlob_t {
 char *fname;
 char *fhash;
} RvcBlob;

__attribute__((visibility("default"))) _Bool r_vc_git_init(const char *path);
__attribute__((visibility("default"))) _Bool r_vc_git_branch(const char *path, const char *name);
__attribute__((visibility("default"))) _Bool r_vc_git_checkout(const char *path, const char *name);
__attribute__((visibility("default"))) _Bool r_vc_git_add(const char *path, const char *fname);
__attribute__((visibility("default"))) _Bool r_vc_git_commit(const char *path, const char *message);

__attribute__((visibility("default"))) _Bool r_vc_commit(const char *rp, const char *message, const char *author, const RList *files);
__attribute__((visibility("default"))) _Bool r_vc_branch(const char *rp, const char *bname);
__attribute__((visibility("default"))) _Bool r_vc_new(const char *path);
__attribute__((visibility("default"))) _Bool r_vc_checkout(const char *rp, const char *bname);
__attribute__((visibility("default"))) RList *r_vc_get_branches(const char *rp);
__attribute__((visibility("default"))) RList *r_vc_get_uncommitted(const char *rp);
__attribute__((visibility("default"))) RList *r_vc_log(const char *rp);
__attribute__((visibility("default"))) char *r_vc_current_branch(const char *rp);
__attribute__((visibility("default"))) _Bool r_vc_reset(const char *rp);
__attribute__((visibility("default"))) _Bool r_vc_clone(const char *src, const char *dst);

__attribute__((visibility("default"))) _Bool rvc_git_init(const RCore *core, const char *rp);
__attribute__((visibility("default"))) _Bool rvc_git_commit(RCore *core, const char *rp, const char *message, const char *author, const RList *files);
__attribute__((visibility("default"))) _Bool rvc_git_branch(const RCore *core, const char *rp, const char *bname);
__attribute__((visibility("default"))) _Bool rvc_git_checkout(const RCore *core, const char *rp, const char *bname);
__attribute__((visibility("default"))) _Bool rvc_git_repo_exists(const RCore *core, const char *rp);
# 8 "project/radare2/libr/core/project.c" 2

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/spp/spp.h" 1 3 4
# 9 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/spp/spp.h" 3 4
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/errno.h" 1 3 4
# 10 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/spp/spp.h" 2 3 4
# 94 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/spp/spp.h" 3 4
typedef struct {
 RStrBuf *cout;
 FILE *fout;
 int size;
...
# 10 "project/radare2/libr/core/project.c" 2
...
# 15 "project/radare2/libr/core/project.c"
static 
# 15 "project/radare2/libr/core/project.c" 3 4
      _Bool 
# 15 "project/radare2/libr/core/project.c"
           is_valid_project_name(const char *name) {
 if (r_str_len_utf8 (name) >= 16) {
  return 
# 17 "project/radare2/libr/core/project.c" 3 4
        0
# 17 "project/radare2/libr/core/project.c"
             ;
 }
 const char *extention = r_str_endswith (name, ".zip") ? r_str_last (name, ".zip") : 
# 19 "project/radare2/libr/core/project.c" 3 4
                                                                                    ((void *)0)
# 19 "project/radare2/libr/core/project.c"
                                                                                        ;
 for (; *name && name != extention; name++) {
  if (
# 21 "project/radare2/libr/core/project.c" 3 4
     ((
# 21 "project/radare2/libr/core/project.c"
     *name
# 21 "project/radare2/libr/core/project.c" 3 4
     ) >= '0' && (
# 21 "project/radare2/libr/core/project.c"
...
# 21 "project/radare2/libr/core/project.c"
  ...
  return 
# 24 "project/radare2/libr/core/project.c" 3 4
        0
# 24 "project/radare2/libr/core/project.c"
             ;
 }
 return 
# 26 "project/radare2/libr/core/project.c" 3 4
       1
# 26 "project/radare2/libr/core/project.c"
           ;
}

static char *get_project_script_path(RCore *core, const char *file) {
 
# 30 "project/radare2/libr/core/project.c" 3 4
do { if (!(
# 30 "project/radare2/libr/core/project.c"
core && file
# 30 "project/radare2/libr/core/project.c" 3 4
...
"core && file"
# 30 "project/radare2/libr/core/project.c" 3 4
, 30); return (((void *)0)); } } while (0)
# 30 "project/radare2/libr/core/project.c"
                                         ;
 if (!*file) {
  return 
# 32 "project/radare2/libr/core/project.c" 3 4
        ((void *)0)
# 32 "project/radare2/libr/core/project.c"
            ;
 }
 ...
 if (r_file_is_abspath (file)) {
  ...
  if (!is_valid_project_name (file)) {
   return 
# 40 "project/radare2/libr/core/project.c" 3 4
         ((void *)0)
# 40 "project/radare2/libr/core/project.c"
             ;
  }
  prjfile = r_file_abspath (r_config_get (core->config, "dir.projects"));
  prjfile = r_str_append (prjfile, 
# 43 "project/radare2/libr/core/project.c" 3 4
                                  "/"
# 43 "project/radare2/libr/core/project.c"
                                           );
  prjfile = r_str_append (prjfile, file);
  if (!r_file_exists (prjfile) || r_file_is_directory (prjfile)) {
   prjfile = r_str_append (prjfile, 
# 46 "project/radare2/libr/core/project.c" 3 4
                                   "/" 
# 46 "project/radare2/libr/core/project.c"
                                             "rc.r2");
  }
 }
 data = r_file_slurp (prjfile, 
# 49 "project/radare2/libr/core/project.c" 3 4
                              ((void *)0)
# 49 "project/radare2/libr/core/project.c"
                                  );
 if (data) {
  if (strncmp (data, magic, strlen (magic))) {
   
# 52 "project/radare2/libr/core/project.c" 3 4
  { free((void *)
# 52 "project/radare2/libr/core/project.c"
  prjfile
# 52 "project/radare2/libr/core/project.c" 3 4
  ); 
# 52 "project/radare2/libr/core/project.c"
...
# 63 "project/radare2/libr/core/project.c" 3 4
 fprintf(__stderrp,
# 63 "project/radare2/libr/core/project.c"
 "Cannot mkdir dir.projects\n"
# 63 "project/radare2/libr/core/project.c" 3 4
 )
# 63 "project/radare2/libr/core/project.c"
                                        ;
...
# 69 "project/radare2/libr/core/project.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 69 "project/radare2/libr/core/project.c"
          r_core_is_project(RCore *core, const char *name) {
 
# 70 "project/radare2/libr/core/project.c" 3 4
_Bool 
# 70 "project/radare2/libr/core/project.c"
     ret = 
# 70 "project/radare2/libr/core/project.c" 3 4
           0
# 70 "project/radare2/libr/core/project.c"
 ...
 if (name && *name && *name != '.') {
  ...
  if (!path) {
   return 
# 74 "project/radare2/libr/core/project.c" 3 4
         0
# 74 "project/radare2/libr/core/project.c"
              ;
  }
  if (r_str_endswith (path, 
# 76 "project/radare2/libr/core/project.c" 3 4
                           "/" 
# 76 "project/radare2/libr/core/project.c"
                                     "rc.r2") && r_file_exists (path)) {
   ret = 
# 77 "project/radare2/libr/core/project.c" 3 4
        1
# 77 "project/radare2/libr/core/project.c"
            ;
  } else {
   path = r_str_append (path, ".d");
   if (r_file_is_directory (path)) {
    ret = 
# 81 "project/radare2/libr/core/project.c" 3 4
         1
# 81 "project/radare2/libr/core/project.c"
             ;
   }
  }
  free (path);
...
# 89 "project/radare2/libr/core/project.c" 3 4
__attribute__((visibility("default"))) 
# 89 "project/radare2/libr/core/project.c"
     int r_core_project_cat(RCore *core, const char *name) {
 char *path = get_project_script_path (core, name);
 if (path) {
  char *data = r_file_slurp (path, 
# 92 "project/radare2/libr/core/project.c" 3 4
                                  ((void *)0)
# 92 "project/radare2/libr/core/project.c"
                                      );
  if (data) {
   r_cons_println (data);
   free (data);
...
# 102 "project/radare2/libr/core/project.c" 3 4
__attribute__((visibility("default"))) 
# 102 "project/radare2/libr/core/project.c"
     int r_core_project_list(RCore *core, int mode) {
 PJ *pj = 
# 103 "project/radare2/libr/core/project.c" 3 4
         ((void *)0)
# 103 "project/radare2/libr/core/project.c"
             ;
 RListIter *iter;
 RList *list;
...
# 119 "project/radare2/libr/core/project.c" 3 4
 if (
# 119 "project/radare2/libr/core/project.c"
 list
# 119 "project/radare2/libr/core/project.c" 3 4
 ) for (
# 119 "project/radare2/libr/core/project.c"
...
# 130 "project/radare2/libr/core/project.c" 3 4
 if (
# 130 "project/radare2/libr/core/project.c"
 list
# 130 "project/radare2/libr/core/project.c" 3 4
 ) for (
# 130 "project/radare2/libr/core/project.c"
...
# 142 "project/radare2/libr/core/project.c" 3 4
__attribute__((visibility("default"))) 
# 142 "project/radare2/libr/core/project.c"
     int r_core_project_delete(RCore *core, const char *prjfile) {
 if (r_sandbox_enable (0)) {
  
# 144 "project/radare2/libr/core/project.c" 3 4
 fprintf(__stderrp,
# 144 "project/radare2/libr/core/project.c"
 "Cannot delete project in sandbox mode\n"
# 144 "project/radare2/libr/core/project.c" 3 4
 )
# 144 "project/radare2/libr/core/project.c"
                                                    ;
...
# 149 "project/radare2/libr/core/project.c" 3 4
 fprintf(__stderrp,
# 149 "project/radare2/libr/core/project.c"
...
# 149 "project/radare2/libr/core/project.c"
                                                 ;
  return 
# 150 "project/radare2/libr/core/project.c" 3 4
        0
# 150 "project/radare2/libr/core/project.c"
             ;
 }
...
# 155 "project/radare2/libr/core/project.c" 3 4
  fprintf(__stderrp,
# 155 "project/radare2/libr/core/project.c"
...
# 155 "project/radare2/libr/core/project.c"
   ...
   free (path);
   return 
# 157 "project/radare2/libr/core/project.c" 3 4
         0
# 157 "project/radare2/libr/core/project.c"
              ;
  }
...
static 
# 166 "project/radare2/libr/core/project.c" 3 4
      _Bool 
# 166 "project/radare2/libr/core/project.c"
           load_project_rop(RCore *core, const char *prjfile) {
 
# 167 "project/radare2/libr/core/project.c" 3 4
do { if (!(
# 167 "project/radare2/libr/core/project.c"
core && !
# 167 "project/radare2/libr/core/project.c" 3 4
(!(
# 167 "project/radare2/libr/core/project.c"
...
# 167 "project/radare2/libr/core/project.c"
"core && !R_STR_ISEMPTY (prjfile)"
# 167 "project/radare2/libr/core/project.c" 3 4
, 167); return (0); } } while (0)
# 167 "project/radare2/libr/core/project.c"
                                                              ;
 char *path, *db = 
# 168 "project/radare2/libr/core/project.c" 3 4
                  ((void *)0)
# 168 "project/radare2/libr/core/project.c"
                      , *path_ns;
 
# 169 "project/radare2/libr/core/project.c" 3 4
_Bool 
# 169 "project/radare2/libr/core/project.c"
     found = 0;
 SdbListIter *it;
 SdbNs *ns;

 Sdb *rop_db = sdb_ns (core->sdb, "rop", 
# 173 "project/radare2/libr/core/project.c" 3 4
                                        0
# 173 "project/radare2/libr/core/project.c"
                                             );
 Sdb *nop_db = sdb_ns (rop_db, "nop", 
# 174 "project/radare2/libr/core/project.c" 3 4
                                     0
# 174 "project/radare2/libr/core/project.c"
                                          );
 Sdb *mov_db = sdb_ns (rop_db, "mov", 
# 175 "project/radare2/libr/core/project.c" 3 4
                                     0
# 175 "project/radare2/libr/core/project.c"
                                          );
 Sdb *const_db = sdb_ns (rop_db, "const", 
# 176 "project/radare2/libr/core/project.c" 3 4
                                         0
# 176 "project/radare2/libr/core/project.c"
                                              );
 Sdb *arithm_db = sdb_ns (rop_db, "arithm", 
# 177 "project/radare2/libr/core/project.c" 3 4
                                           0
# 177 "project/radare2/libr/core/project.c"
                                                );
 Sdb *arithmct_db = sdb_ns (rop_db, "arithm_ct", 
# 178 "project/radare2/libr/core/project.c" 3 4
                                                0
# 178 "project/radare2/libr/core/project.c"
                                                     );

 char *rc_path = get_project_script_path (core, prjfile);
 char *prj_dir = r_file_dirname (rc_path);
 
# 182 "project/radare2/libr/core/project.c" 3 4
{ free((void *)
# 182 "project/radare2/libr/core/project.c"
rc_path
# 182 "project/radare2/libr/core/project.c" 3 4
); 
# 182 "project/radare2/libr/core/project.c"
...
# 182 "project/radare2/libr/core/project.c"
                ;
 if (r_str_endswith (prjfile, 
# 183 "project/radare2/libr/core/project.c" 3 4
                             "/" 
# 183 "project/radare2/libr/core/project.c"
                                       "rc.r2")) {

  
# 185 "project/radare2/libr/core/project.c" 3 4
 fprintf(__stderrp,
# 185 "project/radare2/libr/core/project.c"
 "ENDS WITH\n"
# 185 "project/radare2/libr/core/project.c" 3 4
 )
# 185 "project/radare2/libr/core/project.c"
 ...
 } else if (r_file_fexists ("%s%s%src.r2", 
# 188 "project/radare2/libr/core/project.c" 3 4
                                          "/"
# 188 "project/radare2/libr/core/project.c"
                                                   , prj_dir, prjfile)) {
  path = r_str_newf ("%s%s%s", 
# 189 "project/radare2/libr/core/project.c" 3 4
                              "/"
# 189 "project/radare2/libr/core/project.c"
                                       , prj_dir, prjfile);
 } else {
  if (*prjfile == 
# 191 "project/radare2/libr/core/project.c" 3 4
                 "/"
# 191 "project/radare2/libr/core/project.c"
                          [0]) {
   db = r_str_newf ("%s.d", prjfile);
   if (!db) {
    free (prj_dir);
    return 
# 195 "project/radare2/libr/core/project.c" 3 4
          0
# 195 "project/radare2/libr/core/project.c"
               ;
   }
   path = strdup (db);
  } else {
   db = r_str_newf ("%s" 
# 199 "project/radare2/libr/core/project.c" 3 4
                        "/" 
# 199 "project/radare2/libr/core/project.c"
                                  "%s.d", prj_dir, prjfile);
   if (!db) {
    free (prj_dir);
    return 
# 202 "project/radare2/libr/core/project.c" 3 4
          0
# 202 "project/radare2/libr/core/project.c"
               ;
   }
 ...
 if (!path) {
  ...
  free (prj_dir);
  return 
# 210 "project/radare2/libr/core/project.c" 3 4
        0
# 210 "project/radare2/libr/core/project.c"
             ;
 }
 if (rop_db) {
  
# 213 "project/radare2/libr/core/project.c" 3 4
 if ((
# 213 "project/radare2/libr/core/project.c"
 core->sdb->ns
# 213 "project/radare2/libr/core/project.c" 3 4
 )) for (
# 213 "project/radare2/libr/core/project.c"
...
# 213 "project/radare2/libr/core/project.c"
   ...
   if (ns->sdb == rop_db) {
    ...
    found = 
# 216 "project/radare2/libr/core/project.c" 3 4
           1
# 216 "project/radare2/libr/core/project.c"
               ;
    break;
   }
  }
 ...
 if (!rop_db) {
  ...
  free (prj_dir);
  return 
# 229 "project/radare2/libr/core/project.c" 3 4
        0
# 229 "project/radare2/libr/core/project.c"
             ;
 }
 sdb_ns_set (core->sdb, "rop", rop_db);

 path_ns = r_str_newf ("%s" 
# 233 "project/radare2/libr/core/project.c" 3 4
                           "/" 
# 233 "project/radare2/libr/core/project.c"
                                     "rop", prj_dir);
 ...
 free (prj_dir);
 return 
# 256 "project/radare2/libr/core/project.c" 3 4
       1
# 256 "project/radare2/libr/core/project.c"
           ;
}


# 259 "project/radare2/libr/core/project.c" 3 4
__attribute__((visibility("default"))) 
# 259 "project/radare2/libr/core/project.c"
     void r_core_project_execute_cmds(RCore *core, const char *prjfile) {
 char *str = r_core_project_notes_file (core, prjfile);
 char *data = r_file_slurp (str, 
# 261 "project/radare2/libr/core/project.c" 3 4
                                ((void *)0)
# 261 "project/radare2/libr/core/project.c"
                                    );
 free (str);
 
# 263 "project/radare2/libr/core/project.c" 3 4
do { if (!(
# 263 "project/radare2/libr/core/project.c"
data
# 263 "project/radare2/libr/core/project.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 263 "project/radare2/libr/core/project.c"
...
# 263 "project/radare2/libr/core/project.c"
 ...
 Output out;
 out.fout = 
# 265 "project/radare2/libr/core/project.c" 3 4
           ((void *)0)
# 265 "project/radare2/libr/core/project.c"
               ;
 out.cout = r_strbuf_new (
# 266 "project/radare2/libr/core/project.c" 3 4
                         ((void *)0)
# 266 "project/radare2/libr/core/project.c"
                             );
 ...
 while (bol) {
  ...
  bol = strtok (
# 278 "project/radare2/libr/core/project.c" 3 4
               ((void *)0)
# 278 "project/radare2/libr/core/project.c"
                   , "\n");
 }
 free (data);
}
...
static 
# 289 "project/radare2/libr/core/project.c" 3 4
      _Bool 
# 289 "project/radare2/libr/core/project.c"
           r_core_project_load(RCore *core, const char *prj_name, const char *rcpath) {
 if (
# 290 "project/radare2/libr/core/project.c" 3 4
    (!(
# 290 "project/radare2/libr/core/project.c"
    prj_name
# 290 "project/radare2/libr/core/project.c" 3 4
    ) || !*(
# 290 "project/radare2/libr/core/project.c"
...
# 294 "project/radare2/libr/core/project.c" 3 4
 fprintf(__stderrp,
# 294 "project/radare2/libr/core/project.c"
 "o--;e prj.name=\n"
# 294 "project/radare2/libr/core/project.c" 3 4
 )
# 294 "project/radare2/libr/core/project.c"
                              ;
  return 
# 295 "project/radare2/libr/core/project.c" 3 4
        0
# 295 "project/radare2/libr/core/project.c"
             ;
 }
 if (!r_project_open (core->prj, prj_name, rcpath)) {
  return 
# 298 "project/radare2/libr/core/project.c" 3 4
        0
# 298 "project/radare2/libr/core/project.c"
             ;
 }
 const 
# 300 "project/radare2/libr/core/project.c" 3 4
      _Bool 
# 300 "project/radare2/libr/core/project.c"
           cfg_fortunes = r_config_get_b (core->config, "cfg.fortunes");
 const 
# 301 "project/radare2/libr/core/project.c" 3 4
      _Bool 
# 301 "project/radare2/libr/core/project.c"
           scr_interactive = r_cons_is_interactive ();
 const 
# 302 "project/radare2/libr/core/project.c" 3 4
      _Bool 
# 302 "project/radare2/libr/core/project.c"
           scr_prompt = r_config_get_b (core->config, "scr.prompt");
 (void) load_project_rop (core, prj_name);
 
# 304 "project/radare2/libr/core/project.c" 3 4
_Bool 
# 304 "project/radare2/libr/core/project.c"
...
# 322 "project/radare2/libr/core/project.c" 3 4
__attribute__((visibility("default"))) 
# 322 "project/radare2/libr/core/project.c"
     RThread *r_core_project_load_bg(RCore *core, const char *prj_name, const char *rc_path) {
 projectState *ps = 
# 323 "project/radare2/libr/core/project.c" 3 4
                   (
# 323 "project/radare2/libr/core/project.c"
                   projectState
# 323 "project/radare2/libr/core/project.c" 3 4
                   *)calloc(1,sizeof(
# 323 "project/radare2/libr/core/project.c"
...
# 323 "project/radare2/libr/core/project.c"
 ...
 RThread *th = r_th_new (project_load_background, ps, 
# 327 "project/radare2/libr/core/project.c" 3 4
                                                     0
# 327 "project/radare2/libr/core/project.c"
                                                          );
 if (th) {
  r_th_start (th, 
# 329 "project/radare2/libr/core/project.c" 3 4
                 1
# 329 "project/radare2/libr/core/project.c"
                     );
  char thname[32] = { 0 };
  size_t thlen = 
# 331 "project/radare2/libr/core/project.c" 3 4
                (((
# 331 "project/radare2/libr/core/project.c"
                strlen (prj_name)
# 331 "project/radare2/libr/core/project.c" 3 4
                )>(
# 331 "project/radare2/libr/core/project.c"
...
# 338 "project/radare2/libr/core/project.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 338 "project/radare2/libr/core/project.c"
          r_core_project_open(RCore *core, const char *prj_path) {
 
# 339 "project/radare2/libr/core/project.c" 3 4
do { if (!(
# 339 "project/radare2/libr/core/project.c"
core && !
# 339 "project/radare2/libr/core/project.c" 3 4
(!(
# 339 "project/radare2/libr/core/project.c"
...
# 339 "project/radare2/libr/core/project.c"
"core && !R_STR_ISEMPTY (prj_path)"
# 339 "project/radare2/libr/core/project.c" 3 4
, 339); return (0); } } while (0)
# 339 "project/radare2/libr/core/project.c"
                                                               ;
 int ret, close_current_session = 1;
 if (r_project_is_loaded (core->prj)) {
  
# 342 "project/radare2/libr/core/project.c" 3 4
 fprintf(__stderrp,
# 342 "project/radare2/libr/core/project.c"
 "There's a project already opened\n"
# 342 "project/radare2/libr/core/project.c" 3 4
 )
# 342 "project/radare2/libr/core/project.c"
                                               ;
  
# 343 "project/radare2/libr/core/project.c" 3 4
 _Bool 
# 343 "project/radare2/libr/core/project.c"
      ccs = r_cons_yesno ('y', "Close current session? (Y/n)");
  if (ccs) {
   r_core_cmd0 (core, "o--");
  } else {
   
# 347 "project/radare2/libr/core/project.c" 3 4
  fprintf(__stderrp,
# 347 "project/radare2/libr/core/project.c"
  "Project not loaded.\n"
# 347 "project/radare2/libr/core/project.c" 3 4
  )
# 347 "project/radare2/libr/core/project.c"
                                   ;
   return 
# 348 "project/radare2/libr/core/project.c" 3 4
         0
# 348 "project/radare2/libr/core/project.c"
              ;
  }
 }
...
# 354 "project/radare2/libr/core/project.c" 3 4
 fprintf(__stderrp,
# 354 "project/radare2/libr/core/project.c"
 "Invalid project name '%s'\n", prj_path
# 354 "project/radare2/libr/core/project.c" 3 4
 )
# 354 "project/radare2/libr/core/project.c"
                                                  ;
  return 
# 355 "project/radare2/libr/core/project.c" 3 4
        0
# 355 "project/radare2/libr/core/project.c"
             ;
 }
 if (r_project_is_loaded (core->prj)) {
...
# 372 "project/radare2/libr/core/project.c" 3 4
__attribute__((visibility("default"))) 
# 372 "project/radare2/libr/core/project.c"
     char *r_core_project_name(RCore *core, const char *prjfile) {
 char buf[256], *file = 
# 373 "project/radare2/libr/core/project.c" 3 4
                       ((void *)0)
# 373 "project/radare2/libr/core/project.c"
                           ;
 if (*prjfile != '/') {
...
# 379 "project/radare2/libr/core/project.c" 3 4
 fprintf(__stderrp,
# 379 "project/radare2/libr/core/project.c"
 "Invalid project name '%s'\n", prjfile
# 379 "project/radare2/libr/core/project.c" 3 4
 )
# 379 "project/radare2/libr/core/project.c"
                                                 ;
  return 
# 380 "project/radare2/libr/core/project.c" 3 4
        ((void *)0)
# 380 "project/radare2/libr/core/project.c"
            ;
 }
...
# 399 "project/radare2/libr/core/project.c" 3 4
 fprintf(__stderrp,
# 399 "project/radare2/libr/core/project.c"
 "Cannot open project info (%s)\n", prj
# 399 "project/radare2/libr/core/project.c" 3 4
 )
# 399 "project/radare2/libr/core/project.c"
                                                 ;
 ...
 free (prj);
 if (
# 402 "project/radare2/libr/core/project.c" 3 4
    (!(
# 402 "project/radare2/libr/core/project.c"
    file
# 402 "project/radare2/libr/core/project.c" 3 4
    ) || !*(
# 402 "project/radare2/libr/core/project.c"
...
# 402 "project/radare2/libr/core/project.c"
  ...
  free (file);
  file = strdup (prjfile);
  char *slash = (char *)r_str_lchr (file, 
# 405 "project/radare2/libr/core/project.c" 3 4
                                         "/"
# 405 "project/radare2/libr/core/project.c"
                                                  [0]);
  if (slash) {
   *slash = 0;
   slash = (char *)r_str_lchr (file, 
# 408 "project/radare2/libr/core/project.c" 3 4
                                    "/"
# 408 "project/radare2/libr/core/project.c"
                                             [0]);
   if (slash) {
...
# 414 "project/radare2/libr/core/project.c" 3 4
   { free((void *)
# 414 "project/radare2/libr/core/project.c"
   file
# 414 "project/radare2/libr/core/project.c" 3 4
   ); 
# 414 "project/radare2/libr/core/project.c"
...
# 417 "project/radare2/libr/core/project.c" 3 4
  { free((void *)
# 417 "project/radare2/libr/core/project.c"
  file
# 417 "project/radare2/libr/core/project.c" 3 4
  ); 
# 417 "project/radare2/libr/core/project.c"
...
# 448 "project/radare2/libr/core/project.c"

# 448 "project/radare2/libr/core/project.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 448 "project/radare2/libr/core/project.c"
          r_core_project_save_script(RCore *core, const char *file, int opts) {
 char *filename, *hl, *ohl = 
# 449 "project/radare2/libr/core/project.c" 3 4
                            ((void *)0)
# 449 "project/radare2/libr/core/project.c"
                                ;
 int fdold;

 if (
# 452 "project/radare2/libr/core/project.c" 3 4
    (!(
# 452 "project/radare2/libr/core/project.c"
    file
# 452 "project/radare2/libr/core/project.c" 3 4
    ) || !*(
# 452 "project/radare2/libr/core/project.c"
...
# 452 "project/radare2/libr/core/project.c"
  ...
  return 
# 453 "project/radare2/libr/core/project.c" 3 4
        0
# 453 "project/radare2/libr/core/project.c"
             ;
 }

 filename = r_str_word_get_first (file);
 int fd = r_sandbox_open (file, 
# 457 "project/radare2/libr/core/project.c" 3 4
                               0 
# 457 "project/radare2/libr/core/project.c"
                                        | 
# 457 "project/radare2/libr/core/project.c" 3 4
                                          0x0002 
# 457 "project/radare2/libr/core/project.c"
...
# 457 "project/radare2/libr/core/project.c"
 ...
 if (fd == -1) {
  free (filename);
  return 
# 460 "project/radare2/libr/core/project.c" 3 4
        0
# 460 "project/radare2/libr/core/project.c"
             ;
 }
 ...
 if (hl) {
  ohl = strdup (hl);
  r_cons_highlight (
# 466 "project/radare2/libr/core/project.c" 3 4
                   ((void *)0)
# 466 "project/radare2/libr/core/project.c"
                       );
 }
 fdold = r_cons_singleton ()->fdout;
 r_cons_singleton ()->fdout = fd;
 r_cons_singleton ()->context->is_interactive = 
# 470 "project/radare2/libr/core/project.c" 3 4
                                               0
# 470 "project/radare2/libr/core/project.c"
                                                    ;
 r_str_write (fd, "# r2 rdb project file\n");

 if (opts & 
# 473 "project/radare2/libr/core/project.c" 3 4
           0x0002
# 473 "project/radare2/libr/core/project.c"
                          ) {
  r_str_write (fd, "# eval\n");
  r_config_list (core->config, 
# 475 "project/radare2/libr/core/project.c" 3 4
                              ((void *)0)
# 475 "project/radare2/libr/core/project.c"
                                  , 
# 475 "project/radare2/libr/core/project.c" 3 4
                                    1
# 475 "project/radare2/libr/core/project.c"
 ...
 if (opts & 
# 480 "project/radare2/libr/core/project.c" 3 4
           0x0040
# 480 "project/radare2/libr/core/project.c"
                          ) {
 ...
 if (opts & 
# 487 "project/radare2/libr/core/project.c" 3 4
           0x0001
# 487 "project/radare2/libr/core/project.c"
                           ) {
  r_str_write (fd, "# flags\n");
  r_flag_space_push (core->flags, 
# 489 "project/radare2/libr/core/project.c" 3 4
                                 ((void *)0)
# 489 "project/radare2/libr/core/project.c"
                                     );
  r_flag_list (core->flags, 
# 490 "project/radare2/libr/core/project.c" 3 4
                           1
# 490 "project/radare2/libr/core/project.c"
                               , 
# 490 "project/radare2/libr/core/project.c" 3 4
                                 ((void *)0)
# 490 "project/radare2/libr/core/project.c"
 ...
 if (opts & 
# 505 "project/radare2/libr/core/project.c" 3 4
           0x0010
# 505 "project/radare2/libr/core/project.c"
                          ) {
  r_str_write (fd, "# meta\n");
  r_meta_print_list_all (core->anal, R_META_TYPE_ANY, 1, 
# 507 "project/radare2/libr/core/project.c" 3 4
                                                        ((void *)0)
# 507 "project/radare2/libr/core/project.c"
                                                            );
  r_cons_flush ();
 ...
 if (opts & 
# 512 "project/radare2/libr/core/project.c" 3 4
           0x0020
# 512 "project/radare2/libr/core/project.c"
                           ) {
  r_core_cmd (core, "ax*", 0);
  r_cons_flush ();
 }
 if (opts & 
# 516 "project/radare2/libr/core/project.c" 3 4
           0x0001
# 516 "project/radare2/libr/core/project.c"
                           ) {
  r_core_cmd (core, "f.**", 0);
  r_cons_flush ();
 }
 if (opts & 
# 520 "project/radare2/libr/core/project.c" 3 4
           0x0800
# 520 "project/radare2/libr/core/project.c"
                               ) {
  r_core_cmd (core, "db*", 0);
  r_cons_flush ();
 }
 if (opts & 
# 524 "project/radare2/libr/core/project.c" 3 4
           0x0080
# 524 "project/radare2/libr/core/project.c"
                                ) {
  r_core_cmd (core, "ah*", 0);
  r_cons_flush ();
 }
 if (opts & 
# 528 "project/radare2/libr/core/project.c" 3 4
           0x0100
# 528 "project/radare2/libr/core/project.c"
                                ) {
 ...
 if (opts & 
# 533 "project/radare2/libr/core/project.c" 3 4
           0x0200
# 533 "project/radare2/libr/core/project.c"
                                 ) {
 ...
 if (opts & 
# 541 "project/radare2/libr/core/project.c" 3 4
           0x0400
# 541 "project/radare2/libr/core/project.c"
                               ) {
  r_cons_printf ("# seek\n"
          "s 0x%08" 
# 543 "project/radare2/libr/core/project.c" 3 4
                   "llx" 
# 543 "project/radare2/libr/core/project.c"
                           "\n",
   core->offset);
  r_cons_flush ();
 }
 ...
 r_cons_singleton ()->context->is_interactive = 
# 549 "project/radare2/libr/core/project.c" 3 4
                                               1
# 549 "project/radare2/libr/core/project.c"
                                                   ;
 ...
 return 
# 559 "project/radare2/libr/core/project.c" 3 4
       1
# 559 "project/radare2/libr/core/project.c"
           ;
}


# 562 "project/radare2/libr/core/project.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 562 "project/radare2/libr/core/project.c"
          r_core_project_save(RCore *core, const char *prj_name) {
 
# 563 "project/radare2/libr/core/project.c" 3 4
_Bool 
# 563 "project/radare2/libr/core/project.c"
     scr_null = 
# 563 "project/radare2/libr/core/project.c" 3 4
                0
# 563 "project/radare2/libr/core/project.c"
...
# 564 "project/radare2/libr/core/project.c" 3 4
_Bool 
# 564 "project/radare2/libr/core/project.c"
     ret = 
# 564 "project/radare2/libr/core/project.c" 3 4
           1
# 564 "project/radare2/libr/core/project.c"
...
# 567 "project/radare2/libr/core/project.c" 3 4
do { if (!(
# 567 "project/radare2/libr/core/project.c"
prj_name && *prj_name
# 567 "project/radare2/libr/core/project.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 567 "project/radare2/libr/core/project.c"
"prj_name && *prj_name"
# 567 "project/radare2/libr/core/project.c" 3 4
, 567); return (0); } } while (0)
# 567 "project/radare2/libr/core/project.c"
                                                   ;

 if (r_config_get_b (core->config, "cfg.debug")) {
  
# 570 "project/radare2/libr/core/project.c" 3 4
 fprintf(__stderrp,
# 570 "project/radare2/libr/core/project.c"
...
# 570 "project/radare2/libr/core/project.c"
                                                                  ;
  return 
# 571 "project/radare2/libr/core/project.c" 3 4
        0
# 571 "project/radare2/libr/core/project.c"
             ;
 }
 char *script_path = get_project_script_path (core, prj_name);
 if (!script_path) {
  
# 575 "project/radare2/libr/core/project.c" 3 4
 fprintf(__stderrp,
# 575 "project/radare2/libr/core/project.c"
 "Invalid project name '%s'\n", prj_name
# 575 "project/radare2/libr/core/project.c" 3 4
 )
# 575 "project/radare2/libr/core/project.c"
                                                  ;
  return 
# 576 "project/radare2/libr/core/project.c" 3 4
        0
# 576 "project/radare2/libr/core/project.c"
             ;
 }
 char *prj_dir = r_str_endswith (script_path, 
# 578 "project/radare2/libr/core/project.c" 3 4
                                             "/" 
# 578 "project/radare2/libr/core/project.c"
                                                       "rc.r2")
...
# 583 "project/radare2/libr/core/project.c" 3 4
  fprintf(__stderrp,
# 583 "project/radare2/libr/core/project.c"
  "Structural error: rc.r2 shouldnt be a directory.\n"
# 583 "project/radare2/libr/core/project.c" 3 4
  )
# 583 "project/radare2/libr/core/project.c"
                                                                ;
...
# 590 "project/radare2/libr/core/project.c" 3 4
 fprintf(__stderrp,
# 590 "project/radare2/libr/core/project.c"
...
# 590 "project/radare2/libr/core/project.c"
  ...
  free (prj_dir);
  return 
# 593 "project/radare2/libr/core/project.c" 3 4
        0
# 593 "project/radare2/libr/core/project.c"
             ;
 }
 ...
 if (r_config_get_i (core->config, "scr.null")) {
  r_config_set_i (core->config, "scr.null", 
# 599 "project/radare2/libr/core/project.c" 3 4
                                           0
# 599 "project/radare2/libr/core/project.c"
                                                );
  scr_null = 
# 600 "project/radare2/libr/core/project.c" 3 4
            1
# 600 "project/radare2/libr/core/project.c"
                ;
 }
 make_projects_directory (core);

 Sdb *rop_db = sdb_ns (core->sdb, "rop", 
# 604 "project/radare2/libr/core/project.c" 3 4
                                        0
# 604 "project/radare2/libr/core/project.c"
                                             );
 if (rop_db) {

  
# 607 "project/radare2/libr/core/project.c" 3 4
 if ((
# 607 "project/radare2/libr/core/project.c"
 rop_db->ns
# 607 "project/radare2/libr/core/project.c" 3 4
 )) for (
# 607 "project/radare2/libr/core/project.c"
...
# 607 "project/radare2/libr/core/project.c"
                                 {
   char *rop_path = r_str_newf ("%s" 
# 608 "project/radare2/libr/core/project.c" 3 4
                                    "/" 
# 608 "project/radare2/libr/core/project.c"
                                              "rop.d" 
# 608 "project/radare2/libr/core/project.c" 3 4
                                                      "/" 
# 608 "project/radare2/libr/core/project.c"
 ...
 r_config_set (core->config, "prj.name", prj_name);
 if (!r_core_project_save_script (core, script_path, 
# 616 "project/radare2/libr/core/project.c" 3 4
                                                    0xFFFF
# 616 "project/radare2/libr/core/project.c"
                                                                  )) {
  
# 617 "project/radare2/libr/core/project.c" 3 4
 fprintf(__stderrp,
# 617 "project/radare2/libr/core/project.c"
...
# 617 "project/radare2/libr/core/project.c"
                                                     ;
  ret = 
# 618 "project/radare2/libr/core/project.c" 3 4
       0
# 618 "project/radare2/libr/core/project.c"
            ;
...
# 623 "project/radare2/libr/core/project.c" 3 4
 fprintf(__stderrp,
# 623 "project/radare2/libr/core/project.c"
...
# 623 "project/radare2/libr/core/project.c"
  ...
  char *prj_bin_dir = r_str_newf ("%s" 
# 626 "project/radare2/libr/core/project.c" 3 4
                                      "/" 
# 626 "project/radare2/libr/core/project.c"
                                                "bin", prj_dir);
  char *prj_bin_file = r_str_newf ("%s" 
# 627 "project/radare2/libr/core/project.c" 3 4
                                       "/" 
# 627 "project/radare2/libr/core/project.c"
                                                 "%s", prj_bin_dir, bin_filename);
  r_sys_mkdirp (prj_bin_dir);
  if (!r_file_copy (bin_file, prj_bin_file)) {
   
# 630 "project/radare2/libr/core/project.c" 3 4
  fprintf(__stderrp,
# 630 "project/radare2/libr/core/project.c"
  "Warning: Cannot copy '%s' into '%s'\n", bin_file, prj_bin_file
# 630 "project/radare2/libr/core/project.c" 3 4
  )
# 630 "project/radare2/libr/core/project.c"
                                                                           ;
 ...
 if (r_config_get_b (core->config, "prj.vc")) {
  if (!rvc_git_repo_exists (core, prj_dir)) {
   if (!rvc_git_init (core, prj_dir)) {
    ...
    free (script_path);
    return 
# 641 "project/radare2/libr/core/project.c" 3 4
          0
# 641 "project/radare2/libr/core/project.c"
               ;
   }
  }
  ...
  if (paths) {
   if (r_list_append (paths, prj_dir)) {
    if (!rvc_git_commit (core, prj_dir, 
# 647 "project/radare2/libr/core/project.c" 3 4
                                       ((void *)0)
# 647 "project/radare2/libr/core/project.c"
                                           , 
# 647 "project/radare2/libr/core/project.c" 3 4
                                             ((void *)0)
# 647 "project/radare2/libr/core/project.c"
     ...
     free (script_path);
     return 
# 651 "project/radare2/libr/core/project.c" 3 4
           0
# 651 "project/radare2/libr/core/project.c"
                ;
    }
   } else {
    r_list_free (paths);
    ...
    free (script_path);
    return 
# 657 "project/radare2/libr/core/project.c" 3 4
          0
# 657 "project/radare2/libr/core/project.c"
               ;
   }
  } else {
   free (prj_dir);
   free (script_path);
   return 
# 662 "project/radare2/libr/core/project.c" 3 4
         0
# 662 "project/radare2/libr/core/project.c"
              ;
  }
 }
...
# 674 "project/radare2/libr/core/project.c" 3 4
   fprintf(__stderrp,
# 674 "project/radare2/libr/core/project.c"
...
# 677 "project/radare2/libr/core/project.c" 3 4
  fprintf(__stderrp,
# 677 "project/radare2/libr/core/project.c"
  "Cannot chdir %s\n", prj_dir
# 677 "project/radare2/libr/core/project.c" 3 4
  )
# 677 "project/radare2/libr/core/project.c"
 ...
 if (scr_null) {
  r_config_set_i (core->config, "scr.null", 
# 685 "project/radare2/libr/core/project.c" 3 4
                                           1
# 685 "project/radare2/libr/core/project.c"
                                               );
 }
 free (script_path);
 r_config_set (core->config, "prj.name", prj_name);
...
# 692 "project/radare2/libr/core/project.c" 3 4
__attribute__((visibility("default"))) 
# 692 "project/radare2/libr/core/project.c"
     char *r_core_project_notes_file(RCore *core, const char *prj_name) {
 const char *prjdir = r_config_get (core->config, "dir.projects");
 char *prjpath = r_file_abspath (prjdir);
 char *notes_txt = r_file_new (prjpath, prj_name, "notes.txt", 
# 695 "project/radare2/libr/core/project.c" 3 4
                                                              ((void *)0)
# 695 "project/radare2/libr/core/project.c"
                                                                  );
 free (prjpath);
 return notes_txt;
}
...
# 700 "project/radare2/libr/core/project.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 700 "project/radare2/libr/core/project.c"
          r_core_project_is_saved(RCore *core) {
 
# 701 "project/radare2/libr/core/project.c" 3 4
_Bool 
# 701 "project/radare2/libr/core/project.c"
     ret;
 char *saved_dat, *tmp_dat;
 char *pd = r_str_newf ("%s" 
# 703 "project/radare2/libr/core/project.c" 3 4
                            "/" 
# 703 "project/radare2/libr/core/project.c"
                                      "%s",
  r_config_get (core->config, "dir.projects"),
  r_config_get (core->config, "prj.name"));
 if (!pd) {
  return 
# 707 "project/radare2/libr/core/project.c" 3 4
        0
# 707 "project/radare2/libr/core/project.c"
             ;
 }
 char *sp = r_str_newf ("%s" 
# 709 "project/radare2/libr/core/project.c" 3 4
                            "/" 
# 709 "project/radare2/libr/core/project.c"
                                      "%s", pd, "rc.r2");
 if (!sp) {
  free (pd);
  return 
# 712 "project/radare2/libr/core/project.c" 3 4
        0
# 712 "project/radare2/libr/core/project.c"
             ;
 }
 char *tsp = r_str_newf ("%s" 
# 714 "project/radare2/libr/core/project.c" 3 4
                             "/" 
# 714 "project/radare2/libr/core/project.c"
                                       "tmp", pd);
 ...
 if (!tsp) {
  free (sp);
  return 
# 719 "project/radare2/libr/core/project.c" 3 4
        0
# 719 "project/radare2/libr/core/project.c"
             ;
 }
 r_core_project_save_script (core, tsp, 
# 721 "project/radare2/libr/core/project.c" 3 4
                                       0xFFFF
# 721 "project/radare2/libr/core/project.c"
                                                     );
 ...
 if (!saved_dat) {
  free (tsp);
  return 
# 726 "project/radare2/libr/core/project.c" 3 4
        0
# 726 "project/radare2/libr/core/project.c"
             ;
 }
 ...
 if (!tmp_dat) {
  return 
# 733 "project/radare2/libr/core/project.c" 3 4
        0
# 733 "project/radare2/libr/core/project.c"
             ;
 }
