# 0 "project/radare2/libr/core/cproject.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 6 "project/radare2/libr/core/cproject.c" 2

__attribute__((visibility("default"))) 
# 7 "project/radare2/libr/core/cproject.c"
     RProject *r_project_new(void) {
 RProject *p = 
# 8 "project/radare2/libr/core/cproject.c" 3 4
              (
# 8 "project/radare2/libr/core/cproject.c"
              RProject
# 8 "project/radare2/libr/core/cproject.c" 3 4
              *)calloc(1,sizeof(
# 8 "project/radare2/libr/core/cproject.c"
...
# 12 "project/radare2/libr/core/cproject.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 12 "project/radare2/libr/core/cproject.c"
          r_project_rename(RProject *p, const char *newname) {
 if (!r_project_is_loaded (p)) {
  return 
# 14 "project/radare2/libr/core/cproject.c" 3 4
        0
# 14 "project/radare2/libr/core/cproject.c"
             ;
 }
 char *newprjdir = r_file_new (p->path, "..", newname, 
# 16 "project/radare2/libr/core/cproject.c" 3 4
                                                      ((void *)0)
# 16 "project/radare2/libr/core/cproject.c"
                                                          );
 if (r_file_exists (newprjdir)) {
  
# 18 "project/radare2/libr/core/cproject.c" 3 4
 fprintf(__stderrp,
# 18 "project/radare2/libr/core/cproject.c"
 "Cannot rename.\n"
# 18 "project/radare2/libr/core/cproject.c" 3 4
 )
# 18 "project/radare2/libr/core/cproject.c"
  ...
  free (newprjdir);
  return 
# 20 "project/radare2/libr/core/cproject.c" 3 4
        0
# 20 "project/radare2/libr/core/cproject.c"
             ;
 }
 ...
 return 
# 27 "project/radare2/libr/core/cproject.c" 3 4
       0
# 27 "project/radare2/libr/core/cproject.c"
            ;
}


# 30 "project/radare2/libr/core/cproject.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 30 "project/radare2/libr/core/cproject.c"
          r_project_is_git(RProject *p) {
 char *f = r_str_newf ("%s"
# 31 "project/radare2/libr/core/cproject.c" 3 4
                          "/"
# 31 "project/radare2/libr/core/cproject.c"
                                   ".git", p->path);
 
# 32 "project/radare2/libr/core/cproject.c" 3 4
_Bool 
# 32 "project/radare2/libr/core/cproject.c"
     ig = r_file_is_directory (f);
 free (f);
 return ig;
}


# 37 "project/radare2/libr/core/cproject.c" 3 4
__attribute__((visibility("default"))) 
# 37 "project/radare2/libr/core/cproject.c"
     void r_project_close(RProject *p) {

 
# 39 "project/radare2/libr/core/cproject.c" 3 4
{ free((void *)
# 39 "project/radare2/libr/core/cproject.c"
p->name
# 39 "project/radare2/libr/core/cproject.c" 3 4
); 
# 39 "project/radare2/libr/core/cproject.c"
...
# 40 "project/radare2/libr/core/cproject.c" 3 4
{ free((void *)
# 40 "project/radare2/libr/core/cproject.c"
p->path
# 40 "project/radare2/libr/core/cproject.c" 3 4
); 
# 40 "project/radare2/libr/core/cproject.c"
...
# 43 "project/radare2/libr/core/cproject.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 43 "project/radare2/libr/core/cproject.c"
          r_project_open(RProject *p, const char *name, const char *path) {
 
# 44 "project/radare2/libr/core/cproject.c" 3 4
do { if (!(
# 44 "project/radare2/libr/core/cproject.c"
p && !
# 44 "project/radare2/libr/core/cproject.c" 3 4
(!(
# 44 "project/radare2/libr/core/cproject.c"
...
# 44 "project/radare2/libr/core/cproject.c"
 ...
 if (r_project_is_loaded (p)) {
  if (!strcmp (name, p->name)) {
   return 
# 47 "project/radare2/libr/core/cproject.c" 3 4
         1
# 47 "project/radare2/libr/core/cproject.c"
             ;
  }
  return 
# 49 "project/radare2/libr/core/cproject.c" 3 4
        0
# 49 "project/radare2/libr/core/cproject.c"
             ;
 }
 p->name = strdup (name);
 if (path) {
 ...
 return 
# 55 "project/radare2/libr/core/cproject.c" 3 4
       1
# 55 "project/radare2/libr/core/cproject.c"
           ;
}


# 58 "project/radare2/libr/core/cproject.c" 3 4
__attribute__((visibility("default"))) 
# 58 "project/radare2/libr/core/cproject.c"
     void r_project_save(RProject *p) {

}


# 62 "project/radare2/libr/core/cproject.c" 3 4
__attribute__((visibility("default"))) 
# 62 "project/radare2/libr/core/cproject.c"
     void r_project_free(RProject *p) {
 if (p) {
  free (p->name);
  free (p->path);
  free (p);
...
# 70 "project/radare2/libr/core/cproject.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 70 "project/radare2/libr/core/cproject.c"
          r_project_is_loaded(RProject *p) {
 return !
# 71 "project/radare2/libr/core/cproject.c" 3 4
        (!(
# 71 "project/radare2/libr/core/cproject.c"
        p->name
# 71 "project/radare2/libr/core/cproject.c" 3 4
        ) || !*(
# 71 "project/radare2/libr/core/cproject.c"
