# 0 "project/radare2/libr/core/cmd_magic.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/cmd_magic.c"
...
# 4 "project/radare2/libr/core/cmd_magic.c" 2



# 6 "project/radare2/libr/core/cmd_magic.c"
static int magicdepth = 99;
static RMagic *ck = 
# 7 "project/radare2/libr/core/cmd_magic.c" 3 4
                   ((void *)0)
# 7 "project/radare2/libr/core/cmd_magic.c"
                       ;
static char *ofile = 
# 8 "project/radare2/libr/core/cmd_magic.c" 3 4
                    ((void *)0)
# 8 "project/radare2/libr/core/cmd_magic.c"
                        ;
...
static int r_core_magic_at(RCore *core, const char *file, 
# 15 "project/radare2/libr/core/cmd_magic.c" 3 4
                                                         unsigned long long 
# 15 "project/radare2/libr/core/cmd_magic.c"
                                                              addr, int depth, int v, PJ *pj, int *hits) {
 const char *fmt;
 char *q, *p;
 const char *str;
 int delta = 0, adelta = 0, ret;
 
# 20 "project/radare2/libr/core/cmd_magic.c" 3 4
unsigned long long 
# 20 "project/radare2/libr/core/cmd_magic.c"
     curoffset = core->offset;
 ...
 if (addr != core->offset) {
  ...
  if (addr >= core->offset && (addr+32) < (core->offset + core->blocksize)) {
   delta = addr - core->offset;
  } else {
   r_core_seek (core, addr, 
# 36 "project/radare2/libr/core/cmd_magic.c" 3 4
                           1
# 36 "project/radare2/libr/core/cmd_magic.c"
                               );
  }
...
# 43 "project/radare2/libr/core/cmd_magic.c" 3 4
  fprintf(__stderrp,
# 43 "project/radare2/libr/core/cmd_magic.c"
  "Unaligned search at %d\n", mod
# 43 "project/radare2/libr/core/cmd_magic.c" 3 4
  )
# 43 "project/radare2/libr/core/cmd_magic.c"
                                           ;
...
# 50 "project/radare2/libr/core/cmd_magic.c" 3 4
  fprintf(__stderrp,
# 50 "project/radare2/libr/core/cmd_magic.c"
  "0x%08" 
# 50 "project/radare2/libr/core/cmd_magic.c" 3 4
  "llx" 
# 50 "project/radare2/libr/core/cmd_magic.c"
  " [%d matches found]\r", addr, *hits
# 50 "project/radare2/libr/core/cmd_magic.c" 3 4
  )
# 50 "project/radare2/libr/core/cmd_magic.c"
                                                                ;
 ...
 if (file) {
  if (*file == ' ') file++;
  if (!*file) file = 
# 54 "project/radare2/libr/core/cmd_magic.c" 3 4
                    ((void *)0)
# 54 "project/radare2/libr/core/cmd_magic.c"
                        ;
 }
 if (file && ofile && file != ofile) {
  if (strcmp (file, ofile)) {
   r_magic_free (ck);
   ck = 
# 59 "project/radare2/libr/core/cmd_magic.c" 3 4
       ((void *)0)
# 59 "project/radare2/libr/core/cmd_magic.c"
           ;
  }
 }
 if (!ck) {
...
# 71 "project/radare2/libr/core/cmd_magic.c" 3 4
   fprintf(__stderrp,
# 71 "project/radare2/libr/core/cmd_magic.c"
   "failed r_magic_load (\"%s\") %s\n", file, r_magic_error (ck)
# 71 "project/radare2/libr/core/cmd_magic.c" 3 4
   )
# 71 "project/radare2/libr/core/cmd_magic.c"
                                                                          ;
    ck = 
# 72 "project/radare2/libr/core/cmd_magic.c" 3 4
        ((void *)0)
# 72 "project/radare2/libr/core/cmd_magic.c"
            ;
    ret = -1;
    goto seek_exit;
   }
   ...
   if (!r_magic_load (ck, magicpath)) {
    ck = 
# 79 "project/radare2/libr/core/cmd_magic.c" 3 4
        ((void *)0)
# 79 "project/radare2/libr/core/cmd_magic.c"
            ;
    
# 80 "project/radare2/libr/core/cmd_magic.c" 3 4
   fprintf(__stderrp,
# 80 "project/radare2/libr/core/cmd_magic.c"
   "failed r_magic_load (dir.magic) %s\n", r_magic_error (ck)
# 80 "project/radare2/libr/core/cmd_magic.c" 3 4
   )
# 80 "project/radare2/libr/core/cmd_magic.c"
                                                                       ;
...
# 89 "project/radare2/libr/core/cmd_magic.c" 3 4
 fprintf(__stderrp,
# 89 "project/radare2/libr/core/cmd_magic.c"
 "EOB\n"
# 89 "project/radare2/libr/core/cmd_magic.c" 3 4
 )
# 89 "project/radare2/libr/core/cmd_magic.c"
...
# 117 "project/radare2/libr/core/cmd_magic.c" 3 4
   __builtin___strcpy_chk (
# 117 "project/radare2/libr/core/cmd_magic.c"
   q + 1
# 117 "project/radare2/libr/core/cmd_magic.c" 3 4
   , 
# 117 "project/radare2/libr/core/cmd_magic.c"
...
# 117 "project/radare2/libr/core/cmd_magic.c"
  ...
  if (!pj) {
   r_cons_printf ("0x%08"
# 132 "project/radare2/libr/core/cmd_magic.c" 3 4
                        "llx"
# 132 "project/radare2/libr/core/cmd_magic.c"
...
# 150 "project/radare2/libr/core/cmd_magic.c" 3 4
    unsigned long long 
# 150 "project/radare2/libr/core/cmd_magic.c"
         addr = 0LL;
     *q = 0;
     if (!strncmp (q + 1, "0x", 2)) {
      sscanf (q + 3, "%"
# 153 "project/radare2/libr/core/cmd_magic.c" 3 4
                       "llx"
# 153 "project/radare2/libr/core/cmd_magic.c"
                              , &addr);
     } else {
      sscanf (q + 1, "%"
# 155 "project/radare2/libr/core/cmd_magic.c" 3 4
                       "lld"
# 155 "project/radare2/libr/core/cmd_magic.c"
                              , &addr);
     }
     if (!fmt || !*fmt) {
      fmt = file;
  ...
  r_magic_free (ck);
  ck = 
# 168 "project/radare2/libr/core/cmd_magic.c" 3 4
      ((void *)0)
# 168 "project/radare2/libr/core/cmd_magic.c"
          ;
...
seek_exit:
 r_core_seek (core, curoffset, 
# 187 "project/radare2/libr/core/cmd_magic.c" 3 4
                              1
# 187 "project/radare2/libr/core/cmd_magic.c"
                                  );
 return ret;
}
...
# 192 "project/radare2/libr/core/cmd_magic.c" 3 4
unsigned long long 
# 192 "project/radare2/libr/core/cmd_magic.c"
     addr = core->offset;
 int hits = 0;
 ...
 if (addr != core->offset) {
  r_core_seek (core, addr, 
# 200 "project/radare2/libr/core/cmd_magic.c" 3 4
                          1
# 200 "project/radare2/libr/core/cmd_magic.c"
                              );
 }
}
