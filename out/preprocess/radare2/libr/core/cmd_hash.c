# 0 "project/radare2/libr/core/cmd_hash.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/cmd_hash.c"
...
# 4 "project/radare2/libr/core/cmd_hash.c" 2


# 5 "project/radare2/libr/core/cmd_hash.c"
typedef void (*HashHandler)(const 
# 5 "project/radare2/libr/core/cmd_hash.c" 3 4
                                 unsigned char 
# 5 "project/radare2/libr/core/cmd_hash.c"
                                     *block, int len);
...
static inline void hexprint(const 
# 12 "project/radare2/libr/core/cmd_hash.c" 3 4
                                 unsigned char 
# 12 "project/radare2/libr/core/cmd_hash.c"
                                     *data, int len) {
 int i = 0;
 for (i = 0; i < len; i++) {
...
static void handle_md4 (const 
# 20 "project/radare2/libr/core/cmd_hash.c" 3 4
                             unsigned char 
# 20 "project/radare2/libr/core/cmd_hash.c"
                                 *block, int len) {
 
# 21 "project/radare2/libr/core/cmd_hash.c" 3 4
struct r_hash_t 
# 21 "project/radare2/libr/core/cmd_hash.c"
      *ctx = r_hash_new (
# 21 "project/radare2/libr/core/cmd_hash.c" 3 4
                         1
# 21 "project/radare2/libr/core/cmd_hash.c"
...
# 21 "project/radare2/libr/core/cmd_hash.c"
 ...
 const 
# 22 "project/radare2/libr/core/cmd_hash.c" 3 4
      unsigned char 
# 22 "project/radare2/libr/core/cmd_hash.c"
          *c = r_hash_do_md4 (ctx, block, len);
 hexprint (c, 
# 23 "project/radare2/libr/core/cmd_hash.c" 3 4
             16
# 23 "project/radare2/libr/core/cmd_hash.c"
                            );
 r_hash_free (ctx);
}

static void handle_md5 (const 
# 27 "project/radare2/libr/core/cmd_hash.c" 3 4
                             unsigned char 
# 27 "project/radare2/libr/core/cmd_hash.c"
                                 *block, int len) {
 
# 28 "project/radare2/libr/core/cmd_hash.c" 3 4
struct r_hash_t 
# 28 "project/radare2/libr/core/cmd_hash.c"
      *ctx = r_hash_new (
# 28 "project/radare2/libr/core/cmd_hash.c" 3 4
                         1
# 28 "project/radare2/libr/core/cmd_hash.c"
...
# 28 "project/radare2/libr/core/cmd_hash.c"
 ...
 const 
# 29 "project/radare2/libr/core/cmd_hash.c" 3 4
      unsigned char 
# 29 "project/radare2/libr/core/cmd_hash.c"
          *c = r_hash_do_md5 (ctx, block, len);
 hexprint (c, 
# 30 "project/radare2/libr/core/cmd_hash.c" 3 4
             16
# 30 "project/radare2/libr/core/cmd_hash.c"
                            );
 r_hash_free (ctx);
}

static void handle_sha1 (const 
# 34 "project/radare2/libr/core/cmd_hash.c" 3 4
                              unsigned char 
# 34 "project/radare2/libr/core/cmd_hash.c"
                                  *block, int len) {
 
# 35 "project/radare2/libr/core/cmd_hash.c" 3 4
struct r_hash_t 
# 35 "project/radare2/libr/core/cmd_hash.c"
      *ctx = r_hash_new (
# 35 "project/radare2/libr/core/cmd_hash.c" 3 4
                         1
# 35 "project/radare2/libr/core/cmd_hash.c"
...
# 35 "project/radare2/libr/core/cmd_hash.c"
 ...
 const 
# 36 "project/radare2/libr/core/cmd_hash.c" 3 4
      unsigned char 
# 36 "project/radare2/libr/core/cmd_hash.c"
          *c = r_hash_do_sha1 (ctx, block, len);
 hexprint (c, 
# 37 "project/radare2/libr/core/cmd_hash.c" 3 4
             20
# 37 "project/radare2/libr/core/cmd_hash.c"
                             );
 r_hash_free (ctx);
}

static void handle_sha256 (const 
# 41 "project/radare2/libr/core/cmd_hash.c" 3 4
                                unsigned char 
# 41 "project/radare2/libr/core/cmd_hash.c"
                                    *block, int len) {
 
# 42 "project/radare2/libr/core/cmd_hash.c" 3 4
struct r_hash_t 
# 42 "project/radare2/libr/core/cmd_hash.c"
      *ctx = r_hash_new (
# 42 "project/radare2/libr/core/cmd_hash.c" 3 4
                         1
# 42 "project/radare2/libr/core/cmd_hash.c"
...
# 42 "project/radare2/libr/core/cmd_hash.c"
 ...
 const 
# 43 "project/radare2/libr/core/cmd_hash.c" 3 4
      unsigned char 
# 43 "project/radare2/libr/core/cmd_hash.c"
          *c = r_hash_do_sha256 (ctx, block, len);
 hexprint (c, 
# 44 "project/radare2/libr/core/cmd_hash.c" 3 4
             32
# 44 "project/radare2/libr/core/cmd_hash.c"
                               );
 r_hash_free (ctx);
}

static void handle_sha512 (const 
# 48 "project/radare2/libr/core/cmd_hash.c" 3 4
                                unsigned char 
# 48 "project/radare2/libr/core/cmd_hash.c"
                                    *block, int len) {
 
# 49 "project/radare2/libr/core/cmd_hash.c" 3 4
struct r_hash_t 
# 49 "project/radare2/libr/core/cmd_hash.c"
      *ctx = r_hash_new (
# 49 "project/radare2/libr/core/cmd_hash.c" 3 4
                         1
# 49 "project/radare2/libr/core/cmd_hash.c"
...
# 49 "project/radare2/libr/core/cmd_hash.c"
 ...
 const 
# 50 "project/radare2/libr/core/cmd_hash.c" 3 4
      unsigned char 
# 50 "project/radare2/libr/core/cmd_hash.c"
          *c = r_hash_do_sha512 (ctx, block, len);
 hexprint (c, 
# 51 "project/radare2/libr/core/cmd_hash.c" 3 4
             64
# 51 "project/radare2/libr/core/cmd_hash.c"
                               );
 r_hash_free (ctx);
}

static void handle_adler32 (const 
# 55 "project/radare2/libr/core/cmd_hash.c" 3 4
                                 unsigned char 
# 55 "project/radare2/libr/core/cmd_hash.c"
                                     *block, int len) {
 
# 56 "project/radare2/libr/core/cmd_hash.c" 3 4
unsigned int 
# 56 "project/radare2/libr/core/cmd_hash.c"
     hn = r_hash_adler32 (block, len);
 hexprint ((
# 57 "project/radare2/libr/core/cmd_hash.c" 3 4
           unsigned char 
# 57 "project/radare2/libr/core/cmd_hash.c"
               *)&hn, sizeof (
# 57 "project/radare2/libr/core/cmd_hash.c" 3 4
                              unsigned int
# 57 "project/radare2/libr/core/cmd_hash.c"
...
static void handle_xor (const 
# 60 "project/radare2/libr/core/cmd_hash.c" 3 4
                             unsigned char 
# 60 "project/radare2/libr/core/cmd_hash.c"
                                 *block, int len) {
 r_cons_printf ("%02x\n", r_hash_xor (block, len));
}

static void handle_xorpair(const 
# 64 "project/radare2/libr/core/cmd_hash.c" 3 4
                                unsigned char 
# 64 "project/radare2/libr/core/cmd_hash.c"
                                    *block, int len) {
 r_cons_printf ("%04x\n", r_hash_xorpair (block, len));
}

static void handle_entropy(const 
# 68 "project/radare2/libr/core/cmd_hash.c" 3 4
                                unsigned char 
# 68 "project/radare2/libr/core/cmd_hash.c"
                                    *block, int len) {
 r_cons_printf ("%f\n", r_hash_entropy (block, len));
}

static void handle_parity (const 
# 72 "project/radare2/libr/core/cmd_hash.c" 3 4
                                unsigned char 
# 72 "project/radare2/libr/core/cmd_hash.c"
                                    *block, int len) {
 r_cons_printf ("%d\n", r_hash_parity (block, len)?1:0);
}

static void handle_hamdist (const 
# 76 "project/radare2/libr/core/cmd_hash.c" 3 4
                                 unsigned char 
# 76 "project/radare2/libr/core/cmd_hash.c"
                                     *block, int len) {
 r_cons_printf ("%02x\n", r_hash_hamdist (block, len));
}

static void handle_pcprint (const 
# 80 "project/radare2/libr/core/cmd_hash.c" 3 4
                                 unsigned char 
# 80 "project/radare2/libr/core/cmd_hash.c"
                                     *block, int len) {
 r_cons_printf ("%d\n", r_hash_pcprint (block, len));

}

static void handle_mod255 (const 
# 85 "project/radare2/libr/core/cmd_hash.c" 3 4
                                unsigned char 
# 85 "project/radare2/libr/core/cmd_hash.c"
                                    *block, int len) {
 r_cons_printf ("%d\n", r_hash_mod255 (block, len));

}

static void handle_xxhash(const 
# 90 "project/radare2/libr/core/cmd_hash.c" 3 4
                               unsigned char 
# 90 "project/radare2/libr/core/cmd_hash.c"
                                   *block, int len) {
 r_cons_printf ("%" 
# 91 "project/radare2/libr/core/cmd_hash.c" 3 4
                   "x" 
# 91 "project/radare2/libr/core/cmd_hash.c"
                           "\n", r_hash_xxhash (block, len));
}

static void handle_luhn(const 
# 94 "project/radare2/libr/core/cmd_hash.c" 3 4
                             unsigned char 
# 94 "project/radare2/libr/core/cmd_hash.c"
                                 *block, int len) {
 r_cons_printf ("%" 
# 95 "project/radare2/libr/core/cmd_hash.c" 3 4
                   "llu" 
# 95 "project/radare2/libr/core/cmd_hash.c"
                           "\n", r_hash_luhn (block, len));
}

static void handle_ssdeep(const 
# 98 "project/radare2/libr/core/cmd_hash.c" 3 4
                               unsigned char 
# 98 "project/radare2/libr/core/cmd_hash.c"
                                   *block, int len) {
...
static void handle_crc8_smbus(const 
# 104 "project/radare2/libr/core/cmd_hash.c" 3 4
                                   unsigned char 
# 104 "project/radare2/libr/core/cmd_hash.c"
                                       *block, int len) {
 r_cons_printf ("%02" 
# 105 "project/radare2/libr/core/cmd_hash.c" 3 4
                     "llx" 
# 105 "project/radare2/libr/core/cmd_hash.c"
                              "\n", r_hash_crc_preset (block, len, CRC_PRESET_8_SMBUS));
}
# 147 "project/radare2/libr/core/cmd_hash.c"
static void handle_crc15_can (const 
# 147 "project/radare2/libr/core/cmd_hash.c" 3 4
                                   unsigned char 
# 147 "project/radare2/libr/core/cmd_hash.c"
                                       *block, int len) {
 r_cons_printf ("%04" 
# 148 "project/radare2/libr/core/cmd_hash.c" 3 4
                     "llx" 
# 148 "project/radare2/libr/core/cmd_hash.c"
                              "\n", r_hash_crc_preset (block, len, CRC_PRESET_15_CAN));
}


static void handle_crc16 (const 
# 152 "project/radare2/libr/core/cmd_hash.c" 3 4
                               unsigned char 
# 152 "project/radare2/libr/core/cmd_hash.c"
                                   *block, int len) {
 r_cons_printf ("%04" 
# 153 "project/radare2/libr/core/cmd_hash.c" 3 4
                     "llx" 
# 153 "project/radare2/libr/core/cmd_hash.c"
                              "\n", r_hash_crc_preset (block, len, CRC_PRESET_16));
}

static void handle_crc16_hdlc (const 
# 156 "project/radare2/libr/core/cmd_hash.c" 3 4
                                    unsigned char 
# 156 "project/radare2/libr/core/cmd_hash.c"
                                        *block, int len) {
 r_cons_printf ("%04" 
# 157 "project/radare2/libr/core/cmd_hash.c" 3 4
                     "llx" 
# 157 "project/radare2/libr/core/cmd_hash.c"
                              "\n", r_hash_crc_preset (block, len, CRC_PRESET_16_HDLC));
}

static void handle_crc16_usb (const 
# 160 "project/radare2/libr/core/cmd_hash.c" 3 4
                                   unsigned char 
# 160 "project/radare2/libr/core/cmd_hash.c"
                                       *block, int len) {
 r_cons_printf ("%04" 
# 161 "project/radare2/libr/core/cmd_hash.c" 3 4
                     "llx" 
# 161 "project/radare2/libr/core/cmd_hash.c"
                              "\n", r_hash_crc_preset (block, len, CRC_PRESET_16_USB));
}

static void handle_crc16_citt (const 
# 164 "project/radare2/libr/core/cmd_hash.c" 3 4
                                    unsigned char 
# 164 "project/radare2/libr/core/cmd_hash.c"
                                        *block, int len) {
 r_cons_printf ("%04" 
# 165 "project/radare2/libr/core/cmd_hash.c" 3 4
                     "llx" 
# 165 "project/radare2/libr/core/cmd_hash.c"
                              "\n", r_hash_crc_preset (block, len, CRC_PRESET_16_CITT));
}
# 251 "project/radare2/libr/core/cmd_hash.c"
static void handle_crc24 (const 
# 251 "project/radare2/libr/core/cmd_hash.c" 3 4
                               unsigned char 
# 251 "project/radare2/libr/core/cmd_hash.c"
                                   *block, int len) {
 r_cons_printf ("%06" 
# 252 "project/radare2/libr/core/cmd_hash.c" 3 4
                     "llx" 
# 252 "project/radare2/libr/core/cmd_hash.c"
                              "\n", r_hash_crc_preset (block, len, CRC_PRESET_24));
}


static void handle_crc32 (const 
# 256 "project/radare2/libr/core/cmd_hash.c" 3 4
                               unsigned char 
# 256 "project/radare2/libr/core/cmd_hash.c"
                                   *block, int len) {
 r_cons_printf ("%08" 
# 257 "project/radare2/libr/core/cmd_hash.c" 3 4
                     "llx" 
# 257 "project/radare2/libr/core/cmd_hash.c"
                              "\n", r_hash_crc_preset (block, len, CRC_PRESET_32));
}

static void handle_crc32c (const 
# 260 "project/radare2/libr/core/cmd_hash.c" 3 4
                                unsigned char 
# 260 "project/radare2/libr/core/cmd_hash.c"
                                    *block, int len) {
 r_cons_printf ("%08" 
# 261 "project/radare2/libr/core/cmd_hash.c" 3 4
                     "llx" 
# 261 "project/radare2/libr/core/cmd_hash.c"
                              "\n", r_hash_crc_preset (block, len, CRC_PRESET_32C));
}

static void handle_crc32_ecma_267 (const 
# 264 "project/radare2/libr/core/cmd_hash.c" 3 4
                                        unsigned char 
# 264 "project/radare2/libr/core/cmd_hash.c"
                                            *block, int len) {
 r_cons_printf ("%08" 
# 265 "project/radare2/libr/core/cmd_hash.c" 3 4
                     "llx" 
# 265 "project/radare2/libr/core/cmd_hash.c"
                              "\n", r_hash_crc_preset (block, len, CRC_PRESET_32_ECMA_267));
}


static void handle_crc32_bzip2 (const 
# 269 "project/radare2/libr/core/cmd_hash.c" 3 4
                                     unsigned char 
# 269 "project/radare2/libr/core/cmd_hash.c"
                                         *block, int len) {
 r_cons_printf ("%08" 
# 270 "project/radare2/libr/core/cmd_hash.c" 3 4
                     "llx" 
# 270 "project/radare2/libr/core/cmd_hash.c"
                              "\n", r_hash_crc_preset (block, len, CRC_PRESET_CRC32_BZIP2));
}

static void handle_crc32d (const 
# 273 "project/radare2/libr/core/cmd_hash.c" 3 4
                                unsigned char 
# 273 "project/radare2/libr/core/cmd_hash.c"
                                    *block, int len) {
 r_cons_printf ("%08" 
# 274 "project/radare2/libr/core/cmd_hash.c" 3 4
                     "llx" 
# 274 "project/radare2/libr/core/cmd_hash.c"
                              "\n", r_hash_crc_preset (block, len, CRC_PRESET_CRC32D));
}

static void handle_crc32_mpeg2 (const 
# 277 "project/radare2/libr/core/cmd_hash.c" 3 4
                                     unsigned char 
# 277 "project/radare2/libr/core/cmd_hash.c"
                                         *block, int len) {
 r_cons_printf ("%08" 
# 278 "project/radare2/libr/core/cmd_hash.c" 3 4
                     "llx" 
# 278 "project/radare2/libr/core/cmd_hash.c"
                              "\n", r_hash_crc_preset (block, len, CRC_PRESET_CRC32_MPEG2));
}

static void handle_crc32_posix (const 
# 281 "project/radare2/libr/core/cmd_hash.c" 3 4
                                     unsigned char 
# 281 "project/radare2/libr/core/cmd_hash.c"
                                         *block, int len) {
 r_cons_printf ("%08" 
# 282 "project/radare2/libr/core/cmd_hash.c" 3 4
                     "llx" 
# 282 "project/radare2/libr/core/cmd_hash.c"
                              "\n", r_hash_crc_preset (block, len, CRC_PRESET_CRC32_POSIX));
}

static void handle_crc32q (const 
# 285 "project/radare2/libr/core/cmd_hash.c" 3 4
                                unsigned char 
# 285 "project/radare2/libr/core/cmd_hash.c"
                                    *block, int len) {
 r_cons_printf ("%08" 
# 286 "project/radare2/libr/core/cmd_hash.c" 3 4
                     "llx" 
# 286 "project/radare2/libr/core/cmd_hash.c"
                              "\n", r_hash_crc_preset (block, len, CRC_PRESET_CRC32Q));
}

static void handle_crc32_jamcrc (const 
# 289 "project/radare2/libr/core/cmd_hash.c" 3 4
                                      unsigned char 
# 289 "project/radare2/libr/core/cmd_hash.c"
                                          *block, int len) {
 r_cons_printf ("%08" 
# 290 "project/radare2/libr/core/cmd_hash.c" 3 4
                     "llx" 
# 290 "project/radare2/libr/core/cmd_hash.c"
                              "\n", r_hash_crc_preset (block, len, CRC_PRESET_CRC32_JAMCRC));
}

static void handle_crc32_xfer (const 
# 293 "project/radare2/libr/core/cmd_hash.c" 3 4
                                    unsigned char 
# 293 "project/radare2/libr/core/cmd_hash.c"
                                        *block, int len) {
 r_cons_printf ("%08" 
# 294 "project/radare2/libr/core/cmd_hash.c" 3 4
                     "llx" 
# 294 "project/radare2/libr/core/cmd_hash.c"
                              "\n", r_hash_crc_preset (block, len, CRC_PRESET_CRC32_XFER));
}



static void handle_crc64 (const 
# 299 "project/radare2/libr/core/cmd_hash.c" 3 4
                               unsigned char 
# 299 "project/radare2/libr/core/cmd_hash.c"
                                   * block, int len) {
 r_cons_printf ("%016" 
# 300 "project/radare2/libr/core/cmd_hash.c" 3 4
                      "llx" 
# 300 "project/radare2/libr/core/cmd_hash.c"
                               "\n", r_hash_crc_preset (block, len, CRC_PRESET_CRC64));
}



static void handle_crc64_ecma182 (const 
# 305 "project/radare2/libr/core/cmd_hash.c" 3 4
                                       unsigned char 
# 305 "project/radare2/libr/core/cmd_hash.c"
                                           * block, int len) {
 r_cons_printf ("%016" 
# 306 "project/radare2/libr/core/cmd_hash.c" 3 4
                      "llx" 
# 306 "project/radare2/libr/core/cmd_hash.c"
                               "\n", r_hash_crc_preset (block, len, CRC_PRESET_CRC64_ECMA182));
}

static void handle_crc64_we (const 
# 309 "project/radare2/libr/core/cmd_hash.c" 3 4
                                  unsigned char 
# 309 "project/radare2/libr/core/cmd_hash.c"
                                      * block, int len) {
 r_cons_printf ("%016" 
# 310 "project/radare2/libr/core/cmd_hash.c" 3 4
                      "llx" 
# 310 "project/radare2/libr/core/cmd_hash.c"
                               "\n", r_hash_crc_preset (block, len, CRC_PRESET_CRC64_WE));
}

static void handle_crc64_xz (const 
# 313 "project/radare2/libr/core/cmd_hash.c" 3 4
                                  unsigned char 
# 313 "project/radare2/libr/core/cmd_hash.c"
                                      * block, int len) {
 r_cons_printf ("%016" 
# 314 "project/radare2/libr/core/cmd_hash.c" 3 4
                      "llx" 
# 314 "project/radare2/libr/core/cmd_hash.c"
                               "\n", r_hash_crc_preset (block, len, CRC_PRESET_CRC64_XZ));
}

static void handle_crc64_iso(const 
# 317 "project/radare2/libr/core/cmd_hash.c" 3 4
                                  unsigned char 
# 317 "project/radare2/libr/core/cmd_hash.c"
                                      * block, int len) {
 r_cons_printf ("%016" 
# 318 "project/radare2/libr/core/cmd_hash.c" 3 4
                      "llx" 
# 318 "project/radare2/libr/core/cmd_hash.c"
                               "\n", r_hash_crc_preset (block, len, CRC_PRESET_CRC64_ISO));
}



static void handle_fletcher8(const 
# 323 "project/radare2/libr/core/cmd_hash.c" 3 4
                                  unsigned char 
# 323 "project/radare2/libr/core/cmd_hash.c"
                                      *block, int len) {
 r_cons_printf ("%x\n", r_hash_fletcher8 (block, len));
}

static void handle_fletcher16(const 
# 327 "project/radare2/libr/core/cmd_hash.c" 3 4
                                   unsigned char 
# 327 "project/radare2/libr/core/cmd_hash.c"
                                       *block, int len) {
 r_cons_printf ("%02x\n", r_hash_fletcher16 (block, len));
}

static void handle_fletcher32(const 
# 331 "project/radare2/libr/core/cmd_hash.c" 3 4
                                   unsigned char 
# 331 "project/radare2/libr/core/cmd_hash.c"
                                       *block, int len) {
 r_cons_printf ("%" 
# 332 "project/radare2/libr/core/cmd_hash.c" 3 4
                   "x" 
# 332 "project/radare2/libr/core/cmd_hash.c"
                           "\n", r_hash_fletcher32 (block, len));
}

static void handle_fletcher64(const 
# 335 "project/radare2/libr/core/cmd_hash.c" 3 4
                                   unsigned char 
# 335 "project/radare2/libr/core/cmd_hash.c"
                                       *block, int len) {
 r_cons_printf ("%" 
# 336 "project/radare2/libr/core/cmd_hash.c" 3 4
                   "llx" 
# 336 "project/radare2/libr/core/cmd_hash.c"
...
# 341 "project/radare2/libr/core/cmd_hash.c" 3 4
 fprintf(__stderrp,
# 341 "project/radare2/libr/core/cmd_hash.c"
 "hashbang disabled in sandbox mode\n"
# 341 "project/radare2/libr/core/cmd_hash.c" 3 4
 )
# 341 "project/radare2/libr/core/cmd_hash.c"
                                                ;
  return 
# 342 "project/radare2/libr/core/cmd_hash.c" 3 4
        0
# 342 "project/radare2/libr/core/cmd_hash.c"
             ;
 }
...
# 353 "project/radare2/libr/core/cmd_hash.c" 3 4
    fprintf(__stderrp,
# 353 "project/radare2/libr/core/cmd_hash.c"
    "This language plugin doesnt provide any example.\n"
# 353 "project/radare2/libr/core/cmd_hash.c" 3 4
    )
# 353 "project/radare2/libr/core/cmd_hash.c"
                                                                  ;
...
# 356 "project/radare2/libr/core/cmd_hash.c" 3 4
   fprintf(__stderrp,
# 356 "project/radare2/libr/core/cmd_hash.c"
   "Unknown rlang plugin '%s'.\n", foo
# 356 "project/radare2/libr/core/cmd_hash.c" 3 4
   )
# 356 "project/radare2/libr/core/cmd_hash.c"
                                                ;
  ...
  return 
# 360 "project/radare2/libr/core/cmd_hash.c" 3 4
        0
# 360 "project/radare2/libr/core/cmd_hash.c"
             ;
 }
 int ac;
...
# 386 "project/radare2/libr/core/cmd_hash.c" 3 4
    fprintf(__stderrp,
# 386 "project/radare2/libr/core/cmd_hash.c"
    "Error: scr.interactive required to run the rlang prompt\n"
# 386 "project/radare2/libr/core/cmd_hash.c" 3 4
    )
# 386 "project/radare2/libr/core/cmd_hash.c"
                                                                         ;
 ...
 r_str_argv_free (av);
 return 
# 396 "project/radare2/libr/core/cmd_hash.c" 3 4
       1
# 396 "project/radare2/libr/core/cmd_hash.c"
           ;
}
...
# 416 "project/radare2/libr/core/cmd_hash.c" 3 4
 ((void *)0)
# 416 "project/radare2/libr/core/cmd_hash.c"
     };
  r_core_cmd_help (core, helpmsg3);
  return 
# 418 "project/radare2/libr/core/cmd_hash.c" 3 4
        0
# 418 "project/radare2/libr/core/cmd_hash.c"
             ;
 }
...
# 457 "project/radare2/libr/core/cmd_hash.c"
...
# 488 "project/radare2/libr/core/cmd_hash.c"
 {"crc24", handle_crc24},
 ...
 {
# 518 "project/radare2/libr/core/cmd_hash.c" 3 4
 ((void *)0)
# 518 "project/radare2/libr/core/cmd_hash.c"
     , 
# 518 "project/radare2/libr/core/cmd_hash.c" 3 4
       ((void *)0)
# 518 "project/radare2/libr/core/cmd_hash.c"
