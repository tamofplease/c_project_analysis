# 0 "project/radare2/libr/core/carg.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/carg.c"
...
# 4 "project/radare2/libr/core/carg.c" 2




# 7 "project/radare2/libr/core/carg.c"
...
# 15 "project/radare2/libr/core/carg.c" 3 4
 fprintf(__stderrp,
# 15 "project/radare2/libr/core/carg.c"
...
# 30 "project/radare2/libr/core/carg.c" 3 4
__attribute__((visibility("default"))) 
# 30 "project/radare2/libr/core/carg.c"
     char *resolve_fcn_name(RAnal *anal, const char *func_name) {
...
static 
# 46 "project/radare2/libr/core/carg.c" 3 4
      unsigned long long 
# 46 "project/radare2/libr/core/carg.c"
           get_buf_val(
# 46 "project/radare2/libr/core/carg.c" 3 4
                       unsigned char 
# 46 "project/radare2/libr/core/carg.c"
                           *buf, int endian, int width) {
 return (width == 8)? r_read_ble64 (buf, endian) : (
# 47 "project/radare2/libr/core/carg.c" 3 4
                                                   unsigned long long
# 47 "project/radare2/libr/core/carg.c"
                                                       ) r_read_ble32 (buf,endian);
}

static void print_arg_str(int argcnt, const char *name, 
# 50 "project/radare2/libr/core/carg.c" 3 4
                                                       _Bool 
# 50 "project/radare2/libr/core/carg.c"
                                                            color) {
 if (color) {
  r_cons_printf (
# 52 "project/radare2/libr/core/carg.c" 3 4
                "\x1b[93m"
# 52 "project/radare2/libr/core/carg.c"
                             " arg [%d]"
# 52 "project/radare2/libr/core/carg.c" 3 4
                                        "\x1b[0m"
# 52 "project/radare2/libr/core/carg.c"
...
static void print_format_values(RCore *core, const char *fmt, 
# 59 "project/radare2/libr/core/carg.c" 3 4
                                                             _Bool 
# 59 "project/radare2/libr/core/carg.c"
                                                                  onstack, 
# 59 "project/radare2/libr/core/carg.c" 3 4
                                                                           unsigned long long 
# 59 "project/radare2/libr/core/carg.c"
...
# 61 "project/radare2/libr/core/carg.c" 3 4
unsigned long long 
# 61 "project/radare2/libr/core/carg.c"
     bval = src;
 int i;
 int endian = core->print->big_endian;
 int width = (core->anal->bits == 64)? 8: 4;
 int bsize = 
# 65 "project/radare2/libr/core/carg.c" 3 4
            (((
# 65 "project/radare2/libr/core/carg.c"
            64
# 65 "project/radare2/libr/core/carg.c" 3 4
            )>(
# 65 "project/radare2/libr/core/carg.c"
...
# 67 "project/radare2/libr/core/carg.c" 3 4
unsigned char 
# 67 "project/radare2/libr/core/carg.c"
    *buf = malloc (bsize);
 if (!buf) {
  
# 69 "project/radare2/libr/core/carg.c" 3 4
 fprintf(__stderrp,
# 69 "project/radare2/libr/core/carg.c"
...
# 69 "project/radare2/libr/core/carg.c"
 ...
 if (onstack || ((opt != 'd' && opt != 'x') && !onstack)) {
  if (color) {
   r_cons_printf (
# 80 "project/radare2/libr/core/carg.c" 3 4
                 "\x1b[92m"
# 80 "project/radare2/libr/core/carg.c"
                             "0x%08"
# 80 "project/radare2/libr/core/carg.c" 3 4
                                    "llx" "\x1b[0m"
# 80 "project/radare2/libr/core/carg.c"
   ...
   r_cons_printf ("0x%08"
# 82 "project/radare2/libr/core/carg.c" 3 4
                        "llx"
# 82 "project/radare2/libr/core/carg.c"
                               " --> ", bval);
  }
...
# 92 "project/radare2/libr/core/carg.c" 3 4
r_cons_strcat (
# 92 "project/radare2/libr/core/carg.c"
color? 
# 92 "project/radare2/libr/core/carg.c" 3 4
"\x1b[92m"
# 92 "project/radare2/libr/core/carg.c"
...
# 95 "project/radare2/libr/core/carg.c" 3 4
 r_cons_strcat (
# 95 "project/radare2/libr/core/carg.c"
 color ?
# 95 "project/radare2/libr/core/carg.c" 3 4
 "\x1b[0m" "\x1b[97m"
# 95 "project/radare2/libr/core/carg.c"
...
# 96 "project/radare2/libr/core/carg.c" 3 4
 r_cons_strcat (
# 96 "project/radare2/libr/core/carg.c"
 "\""
# 96 "project/radare2/libr/core/carg.c" 3 4
 )
# 96 "project/radare2/libr/core/carg.c"
...
# 101 "project/radare2/libr/core/carg.c" 3 4
  unsigned char 
# 101 "project/radare2/libr/core/carg.c"
      b = buf[i];
   if (
# 102 "project/radare2/libr/core/carg.c" 3 4
      ((
# 102 "project/radare2/libr/core/carg.c"
      b
# 102 "project/radare2/libr/core/carg.c" 3 4
      ) >=' ' && (
# 102 "project/radare2/libr/core/carg.c"
...
# 108 "project/radare2/libr/core/carg.c" 3 4
    r_cons_strcat (
# 108 "project/radare2/libr/core/carg.c"
    "..."
# 108 "project/radare2/libr/core/carg.c" 3 4
    )
# 108 "project/radare2/libr/core/carg.c"
...
# 111 "project/radare2/libr/core/carg.c" 3 4
 r_cons_strcat (
# 111 "project/radare2/libr/core/carg.c"
 "\""
# 111 "project/radare2/libr/core/carg.c" 3 4
 )
# 111 "project/radare2/libr/core/carg.c"
 ...
 case 'x' :
  r_cons_printf ("0x%08" 
# 116 "project/radare2/libr/core/carg.c" 3 4
                        "llx"
# 116 "project/radare2/libr/core/carg.c"
                               , bval);
  r_cons_newline ();
  break;
 case 'c' :
  
# 120 "project/radare2/libr/core/carg.c" 3 4
 r_cons_strcat (
# 120 "project/radare2/libr/core/carg.c"
 "\'"
# 120 "project/radare2/libr/core/carg.c" 3 4
 )
# 120 "project/radare2/libr/core/carg.c"
...
# 121 "project/radare2/libr/core/carg.c" 3 4
 unsigned char 
# 121 "project/radare2/libr/core/carg.c"
     ch = buf[0];
  if (
# 122 "project/radare2/libr/core/carg.c" 3 4
     ((
# 122 "project/radare2/libr/core/carg.c"
     ch
# 122 "project/radare2/libr/core/carg.c" 3 4
     ) >=' ' && (
# 122 "project/radare2/libr/core/carg.c"
...
# 127 "project/radare2/libr/core/carg.c" 3 4
 r_cons_strcat (
# 127 "project/radare2/libr/core/carg.c"
 "\'"
# 127 "project/radare2/libr/core/carg.c" 3 4
 )
# 127 "project/radare2/libr/core/carg.c"
 ...
 case 'p' :
  ...
  r_cons_printf ("0x%08"
# 133 "project/radare2/libr/core/carg.c" 3 4
                       "llx"
# 133 "project/radare2/libr/core/carg.c"
                              , get_buf_val (buf, endian, width));
  r_cons_newline ();
  break;
  }
 default:
...
# 141 "project/radare2/libr/core/carg.c" 3 4
r_cons_strcat ("\x1b[0m")
# 141 "project/radare2/libr/core/carg.c"
                          ;
 free (buf);
}
...
# 147 "project/radare2/libr/core/carg.c" 3 4
__attribute__((visibility("default"))) 
# 147 "project/radare2/libr/core/carg.c"
     void r_core_print_func_args(RCore *core) {
 
# 148 "project/radare2/libr/core/carg.c" 3 4
do { if (!(
# 148 "project/radare2/libr/core/carg.c"
core && core->anal && core->anal->reg
# 148 "project/radare2/libr/core/carg.c" 3 4
...
# 151 "project/radare2/libr/core/carg.c" 3 4
_Bool 
# 151 "project/radare2/libr/core/carg.c"
     color = r_config_get_i (core->config, "scr.color");
 const char *pc = r_reg_get_name (core->anal->reg, R_REG_NAME_PC);
 
# 153 "project/radare2/libr/core/carg.c" 3 4
unsigned long long 
# 153 "project/radare2/libr/core/carg.c"
     cur_addr = r_reg_getv (core->anal->reg, pc);
 RListIter *iter;
...
# 162 "project/radare2/libr/core/carg.c" 3 4
 _Bool 
# 162 "project/radare2/libr/core/carg.c"
      onstack = 
# 162 "project/radare2/libr/core/carg.c" 3 4
                0
# 162 "project/radare2/libr/core/carg.c"
                     ;
  const char *fcn_name = 
# 163 "project/radare2/libr/core/carg.c" 3 4
                        ((void *)0)
# 163 "project/radare2/libr/core/carg.c"
                            ;
  
# 164 "project/radare2/libr/core/carg.c" 3 4
 unsigned long long 
# 164 "project/radare2/libr/core/carg.c"
      pcv = op->jump;
  if (pcv == 
# 165 "project/radare2/libr/core/carg.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 165 "project/radare2/libr/core/carg.c"
                    ) {
   pcv = op->ptr;
  }
  ...
  if (!
# 180 "project/radare2/libr/core/carg.c" 3 4
      (!(
# 180 "project/radare2/libr/core/carg.c"
      list
# 180 "project/radare2/libr/core/carg.c" 3 4
      ) || !(
# 180 "project/radare2/libr/core/carg.c"
...
# 182 "project/radare2/libr/core/carg.c" 3 4
  if (
# 182 "project/radare2/libr/core/carg.c"
  list
# 182 "project/radare2/libr/core/carg.c" 3 4
  ) for (
# 182 "project/radare2/libr/core/carg.c"
...
# 182 "project/radare2/libr/core/carg.c"
    ...
    if (arg->cc_source && !strncmp (arg->cc_source, "stack", 5)) {
     onstack = 
# 184 "project/radare2/libr/core/carg.c" 3 4
              1
# 184 "project/radare2/libr/core/carg.c"
                  ;
    }
...
# 196 "project/radare2/libr/core/carg.c" 3 4
    unsigned long long 
# 196 "project/radare2/libr/core/carg.c"
         v = r_debug_arg_get (core->dbg, cc, i);
     print_arg_str (i, "", color);
     r_cons_printf ("0x%08" 
# 198 "project/radare2/libr/core/carg.c" 3 4
                           "llx"
# 198 "project/radare2/libr/core/carg.c"
                                  , v);
     r_cons_newline ();
    }
...
# 218 "project/radare2/libr/core/carg.c" 3 4
__attribute__((visibility("default"))) 
# 218 "project/radare2/libr/core/carg.c"
     RList *r_core_get_func_args(RCore *core, const char *fcn_name) {
 if (!fcn_name || !core->anal) {
  return 
# 220 "project/radare2/libr/core/carg.c" 3 4
        ((void *)0)
# 220 "project/radare2/libr/core/carg.c"
            ;
 }
 ...
 if (!key) {
  return 
# 225 "project/radare2/libr/core/carg.c" 3 4
        ((void *)0)
# 225 "project/radare2/libr/core/carg.c"
            ;
 }
 ...
 if (!r_anal_cc_func (core->anal, key)){
  return 
# 230 "project/radare2/libr/core/carg.c" 3 4
        ((void *)0)
# 230 "project/radare2/libr/core/carg.c"
            ;
 }
 ...
 if (!cc) {
  ...
  free (key);
  return 
# 237 "project/radare2/libr/core/carg.c" 3 4
        ((void *)0)
# 237 "project/radare2/libr/core/carg.c"
            ;
 }
 RList *list = r_list_newf ((RListFree)r_anal_function_arg_free);
 int i;
 
# 241 "project/radare2/libr/core/carg.c" 3 4
unsigned long long 
# 241 "project/radare2/libr/core/carg.c"
     spv = r_reg_getv (core->anal->reg, sp);
 
# 242 "project/radare2/libr/core/carg.c" 3 4
unsigned long long 
# 242 "project/radare2/libr/core/carg.c"
     s_width = (core->anal->bits == 64)? 8: 4;
 if (src && !strcmp (src, "stack_rev")) {
  for (i = nargs - 1; i >= 0; i--) {
   RAnalFuncArg *arg = 
# 245 "project/radare2/libr/core/carg.c" 3 4
                      (
# 245 "project/radare2/libr/core/carg.c"
                      RAnalFuncArg
# 245 "project/radare2/libr/core/carg.c" 3 4
                      *)calloc(1,sizeof(
# 245 "project/radare2/libr/core/carg.c"
...
# 245 "project/radare2/libr/core/carg.c"
  ...
  for (i = 0; i < nargs; i++) {
   RAnalFuncArg *arg = 
# 253 "project/radare2/libr/core/carg.c" 3 4
                      (
# 253 "project/radare2/libr/core/carg.c"
                      RAnalFuncArg
# 253 "project/radare2/libr/core/carg.c" 3 4
                      *)calloc(1,sizeof(
# 253 "project/radare2/libr/core/carg.c"
...
# 253 "project/radare2/libr/core/carg.c"
   ...
   if (!arg) {
    r_list_free (list);
    return 
# 256 "project/radare2/libr/core/carg.c" 3 4
          ((void *)0)
# 256 "project/radare2/libr/core/carg.c"
              ;
   }
   set_fcn_args_info (arg, core->anal, key, cc, i);
