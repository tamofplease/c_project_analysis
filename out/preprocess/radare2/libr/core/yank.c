# 0 "project/radare2/libr/core/yank.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/core/yank.c" 2
...
# 11 "project/radare2/libr/core/yank.c"
static int perform_mapped_file_yank(RCore *core, 
# 11 "project/radare2/libr/core/yank.c" 3 4
                                                unsigned long long 
# 11 "project/radare2/libr/core/yank.c"
                                                     offset, 
# 11 "project/radare2/libr/core/yank.c" 3 4
...
static 
# 12 "project/radare2/libr/core/yank.c" 3 4
      unsigned int 
# 12 "project/radare2/libr/core/yank.c"
           find_next_char(const char *input, char b);
static 
# 13 "project/radare2/libr/core/yank.c" 3 4
      unsigned int 
# 13 "project/radare2/libr/core/yank.c"
           consume_chars(const char *input, char b);

static 
# 15 "project/radare2/libr/core/yank.c" 3 4
      unsigned int 
# 15 "project/radare2/libr/core/yank.c"
           find_next_char(const char *input, char b) {
 
# 16 "project/radare2/libr/core/yank.c" 3 4
unsigned int 
# 16 "project/radare2/libr/core/yank.c"
     i = 0;
 if (!input) {
  return i;
 }
...
static 
# 26 "project/radare2/libr/core/yank.c" 3 4
      unsigned int 
# 26 "project/radare2/libr/core/yank.c"
           consume_chars(const char *input, char b) {
 
# 27 "project/radare2/libr/core/yank.c" 3 4
unsigned int 
# 27 "project/radare2/libr/core/yank.c"
     i = 0;
 if (!input) {
  return i;
 }
...
static int perform_mapped_file_yank(RCore *core, 
# 37 "project/radare2/libr/core/yank.c" 3 4
                                                unsigned long long 
# 37 "project/radare2/libr/core/yank.c"
                                                     offset, 
# 37 "project/radare2/libr/core/yank.c" 3 4
                                                             unsigned long long 
# 37 "project/radare2/libr/core/yank.c"
 ...
 RIODesc *yankdesc = 
# 40 "project/radare2/libr/core/yank.c" 3 4
                    ((void *)0)
# 40 "project/radare2/libr/core/yank.c"
                        ;
 
# 41 "project/radare2/libr/core/yank.c" 3 4
unsigned long long 
# 41 "project/radare2/libr/core/yank.c"
     fd = core->io->desc ? core->io->desc->fd: -1, yank_file_sz = 0,
      loadaddr = 0, addr = offset;
 int res = 
# 43 "project/radare2/libr/core/yank.c" 3 4
          0
# 43 "project/radare2/libr/core/yank.c"
               ;

 if (filename && *filename) {
  
# 46 "project/radare2/libr/core/yank.c" 3 4
 unsigned long long 
# 46 "project/radare2/libr/core/yank.c"
      load_align = r_config_get_i (core->config, "file.loadalign");
  RIOMap *map = 
# 47 "project/radare2/libr/core/yank.c" 3 4
               ((void *)0)
# 47 "project/radare2/libr/core/yank.c"
                   ;
  yankdesc = r_io_open_nomap (core->io, filename, 
# 48 "project/radare2/libr/core/yank.c" 3 4
                                                 4
# 48 "project/radare2/libr/core/yank.c"
                                                         , 0644);

  if (yankdesc && load_align) {
   yank_file_sz = r_io_size (core->io);
   
# 52 "project/radare2/libr/core/yank.c" 3 4
  unsigned long long 
# 52 "project/radare2/libr/core/yank.c"
       addr = 0;
   r_io_map_locate (core->io, &addr, yank_file_sz, load_align);
   map = r_io_map_add (core->io, yankdesc->fd, 
# 54 "project/radare2/libr/core/yank.c" 3 4
                                              4
# 54 "project/radare2/libr/core/yank.c"
                                                      , 0, addr, yank_file_sz);
   loadaddr = map? 
# 55 "project/radare2/libr/core/yank.c" 3 4
                  r_itv_begin (
# 55 "project/radare2/libr/core/yank.c"
                  map
# 55 "project/radare2/libr/core/yank.c" 3 4
                  ->itv)
# 55 "project/radare2/libr/core/yank.c"
...
# 61 "project/radare2/libr/core/yank.c" 3 4
   fprintf(__stderrp,
# 61 "project/radare2/libr/core/yank.c"
   "Unable to map the opened file: %s", filename
# 61 "project/radare2/libr/core/yank.c" 3 4
   )
# 61 "project/radare2/libr/core/yank.c"
                                                          ;
    ...
    yankdesc = 
# 63 "project/radare2/libr/core/yank.c" 3 4
              ((void *)0)
# 63 "project/radare2/libr/core/yank.c"
                  ;
   } else {
    
# 65 "project/radare2/libr/core/yank.c" 3 4
   fprintf(__stderrp,
# 65 "project/radare2/libr/core/yank.c"
...
# 78 "project/radare2/libr/core/yank.c" 3 4
 unsigned long long 
# 78 "project/radare2/libr/core/yank.c"
...
# 79 "project/radare2/libr/core/yank.c" 3 4
 unsigned long long 
# 79 "project/radare2/libr/core/yank.c"
      actual_len = len <= yank_file_sz? len: 0;
  
# 80 "project/radare2/libr/core/yank.c" 3 4
 unsigned char 
# 80 "project/radare2/libr/core/yank.c"
     *buf = 
# 80 "project/radare2/libr/core/yank.c" 3 4
            ((void *)0)
# 80 "project/radare2/libr/core/yank.c"
  ...
  if (actual_len > 0 && res == addr) {
   ...
   r_core_yank_set (core, 
# 86 "project/radare2/libr/core/yank.c" 3 4
                         -1
# 86 "project/radare2/libr/core/yank.c"
                                            , buf, len);
   res = 
# 87 "project/radare2/libr/core/yank.c" 3 4
        1
# 87 "project/radare2/libr/core/yank.c"
            ;
  } else if (res != addr) {
   
# 89 "project/radare2/libr/core/yank.c" 3 4
  fprintf(__stderrp,
# 89 "project/radare2/libr/core/yank.c"
...
# 93 "project/radare2/libr/core/yank.c"
                 ;
  } else if (actual_len == 0) {
   
# 95 "project/radare2/libr/core/yank.c" 3 4
  fprintf(__stderrp,
# 95 "project/radare2/libr/core/yank.c"
...
# 98 "project/radare2/libr/core/yank.c"
                 ;
  }
  r_io_desc_close (yankdesc);
  free (buf);
...
# 111 "project/radare2/libr/core/yank.c" 3 4
__attribute__((visibility("default"))) 
# 111 "project/radare2/libr/core/yank.c"
     int r_core_yank_set(RCore *core, 
# 111 "project/radare2/libr/core/yank.c" 3 4
                                      unsigned long long 
# 111 "project/radare2/libr/core/yank.c"
                                           addr, const 
...
# 111 "project/radare2/libr/core/yank.c"
 ...
 if (buf && len) {
  ...
  core->yank_addr = addr;
  return 
# 118 "project/radare2/libr/core/yank.c" 3 4
        1
# 118 "project/radare2/libr/core/yank.c"
            ;
 }
 return 
# 120 "project/radare2/libr/core/yank.c" 3 4
       0
# 120 "project/radare2/libr/core/yank.c"
            ;
}



# 124 "project/radare2/libr/core/yank.c" 3 4
__attribute__((visibility("default"))) 
# 124 "project/radare2/libr/core/yank.c"
     int r_core_yank_set_str(RCore *core, 
# 124 "project/radare2/libr/core/yank.c" 3 4
                                          unsigned long long 
# 124 "project/radare2/libr/core/yank.c"
                                               addr, const char *str, 
...
# 124 "project/radare2/libr/core/yank.c"
 ...
 int res = r_core_yank_set (core, addr, (
# 126 "project/radare2/libr/core/yank.c" 3 4
                                        unsigned char 
# 126 "project/radare2/libr/core/yank.c"
                                            *)str, len);
 if (res == 
# 127 "project/radare2/libr/core/yank.c" 3 4
           1
# 127 "project/radare2/libr/core/yank.c"
               ) {
  
# 128 "project/radare2/libr/core/yank.c" 3 4
 unsigned char 
# 128 "project/radare2/libr/core/yank.c"
     zero = 0;
...
# 134 "project/radare2/libr/core/yank.c" 3 4
__attribute__((visibility("default"))) 
# 134 "project/radare2/libr/core/yank.c"
     int r_core_yank(struct r_core_t *core, 
# 134 "project/radare2/libr/core/yank.c" 3 4
                                            unsigned long long 
# 134 "project/radare2/libr/core/yank.c"
                                                 addr, int len) {
 
# 135 "project/radare2/libr/core/yank.c" 3 4
unsigned long long 
# 135 "project/radare2/libr/core/yank.c"
     curseek = core->offset;
 
# 136 "project/radare2/libr/core/yank.c" 3 4
unsigned char 
# 136 "project/radare2/libr/core/yank.c"
    *buf = 
# 136 "project/radare2/libr/core/yank.c" 3 4
           ((void *)0)
# 136 "project/radare2/libr/core/yank.c"
...
# 138 "project/radare2/libr/core/yank.c" 3 4
 fprintf(__stderrp,
# 138 "project/radare2/libr/core/yank.c"
 "r_core_yank: cannot yank negative bytes\n"
# 138 "project/radare2/libr/core/yank.c" 3 4
 )
# 138 "project/radare2/libr/core/yank.c"
                                                      ;
  return 
# 139 "project/radare2/libr/core/yank.c" 3 4
        0
# 139 "project/radare2/libr/core/yank.c"
             ;
 }
 if (len == 0) {
  len = core->blocksize;
 ...
 if (!buf) {
  return 
# 146 "project/radare2/libr/core/yank.c" 3 4
        0
# 146 "project/radare2/libr/core/yank.c"
             ;
 }
 if (addr != core->offset) {
  r_core_seek (core, addr, 
# 149 "project/radare2/libr/core/yank.c" 3 4
                          1
# 149 "project/radare2/libr/core/yank.c"
                              );
 }
...
# 154 "project/radare2/libr/core/yank.c" 3 4
                             1
# 154 "project/radare2/libr/core/yank.c"
                                 );
 }
 free (buf);
 return 
# 157 "project/radare2/libr/core/yank.c" 3 4
       1
# 157 "project/radare2/libr/core/yank.c"
           ;
}



# 161 "project/radare2/libr/core/yank.c" 3 4
__attribute__((visibility("default"))) 
# 161 "project/radare2/libr/core/yank.c"
     int r_core_yank_string(RCore *core, 
# 161 "project/radare2/libr/core/yank.c" 3 4
                                         unsigned long long 
# 161 "project/radare2/libr/core/yank.c"
                                              addr, int maxlen) {
 
# 162 "project/radare2/libr/core/yank.c" 3 4
unsigned long long 
# 162 "project/radare2/libr/core/yank.c"
     curseek = core->offset;
 
# 163 "project/radare2/libr/core/yank.c" 3 4
unsigned char 
# 163 "project/radare2/libr/core/yank.c"
    *buf = 
# 163 "project/radare2/libr/core/yank.c" 3 4
           ((void *)0)
# 163 "project/radare2/libr/core/yank.c"
...
# 165 "project/radare2/libr/core/yank.c" 3 4
 fprintf(__stderrp,
# 165 "project/radare2/libr/core/yank.c"
 "r_core_yank_string: cannot yank negative bytes\n"
# 165 "project/radare2/libr/core/yank.c" 3 4
 )
# 165 "project/radare2/libr/core/yank.c"
                                                             ;
  return 
# 166 "project/radare2/libr/core/yank.c" 3 4
        0
# 166 "project/radare2/libr/core/yank.c"
             ;
 }
 if (addr != core->offset) {
  r_core_seek (core, addr, 
# 169 "project/radare2/libr/core/yank.c" 3 4
                          1
# 169 "project/radare2/libr/core/yank.c"
                              );
 }
 ...
 if (!buf) {
  return 
# 174 "project/radare2/libr/core/yank.c" 3 4
        0
# 174 "project/radare2/libr/core/yank.c"
             ;
 }
 ...
 if (curseek != addr) {
  r_core_seek (core, curseek, 
# 186 "project/radare2/libr/core/yank.c" 3 4
                             1
# 186 "project/radare2/libr/core/yank.c"
                                 );
 }
 free (buf);
 return 
# 189 "project/radare2/libr/core/yank.c" 3 4
       1
# 189 "project/radare2/libr/core/yank.c"
           ;
}


# 192 "project/radare2/libr/core/yank.c" 3 4
__attribute__((visibility("default"))) 
# 192 "project/radare2/libr/core/yank.c"
     int r_core_yank_paste(RCore *core, 
# 192 "project/radare2/libr/core/yank.c" 3 4
                                        unsigned long long 
# 192 "project/radare2/libr/core/yank.c"
                                             addr, int len) {
 if (len < 0) {
  return 
# 194 "project/radare2/libr/core/yank.c" 3 4
        0
# 194 "project/radare2/libr/core/yank.c"
             ;
 }
...
# 199 "project/radare2/libr/core/yank.c" 3 4
unsigned char 
# 199 "project/radare2/libr/core/yank.c"
    *buf = 
# 199 "project/radare2/libr/core/yank.c" 3 4
...
# 199 "project/radare2/libr/core/yank.c"
 ...
 if (!buf) {
  return 
# 201 "project/radare2/libr/core/yank.c" 3 4
        0
# 201 "project/radare2/libr/core/yank.c"
             ;
 }
 r_buf_read_at (core->yank_buf, 0, buf, len);
 if (!r_core_write_at (core, addr, buf, len)) {
  return 
# 205 "project/radare2/libr/core/yank.c" 3 4
        0
# 205 "project/radare2/libr/core/yank.c"
             ;
 }
 return 
# 207 "project/radare2/libr/core/yank.c" 3 4
       1
# 207 "project/radare2/libr/core/yank.c"
           ;
}


# 210 "project/radare2/libr/core/yank.c" 3 4
__attribute__((visibility("default"))) 
# 210 "project/radare2/libr/core/yank.c"
     int r_core_yank_to(RCore *core, const char *_arg) {
 
# 211 "project/radare2/libr/core/yank.c" 3 4
unsigned long long 
# 211 "project/radare2/libr/core/yank.c"
     len = 0;
 
# 212 "project/radare2/libr/core/yank.c" 3 4
unsigned long long 
# 212 "project/radare2/libr/core/yank.c"
     pos = -1;
 char *str, *arg;
 int res = 
# 214 "project/radare2/libr/core/yank.c" 3 4
          0
# 214 "project/radare2/libr/core/yank.c"
               ;
...
# 228 "project/radare2/libr/core/yank.c" 3 4
 fprintf(__stderrp,
# 228 "project/radare2/libr/core/yank.c"
 "Usage: yt [len] [dst-addr]\n"
# 228 "project/radare2/libr/core/yank.c" 3 4
 )
# 228 "project/radare2/libr/core/yank.c"
                                         ;
 ...
 if (r_core_yank (core, core->offset, len) == 
# 232 "project/radare2/libr/core/yank.c" 3 4
                                             1
# 232 "project/radare2/libr/core/yank.c"
                                                 ) {
...
# 239 "project/radare2/libr/core/yank.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 239 "project/radare2/libr/core/yank.c"
          r_core_yank_dump(RCore *core, 
# 239 "project/radare2/libr/core/yank.c" 3 4
                                        unsigned long long 
# 239 "project/radare2/libr/core/yank.c"
                                             pos, int format) {
 
# 240 "project/radare2/libr/core/yank.c" 3 4
_Bool 
# 240 "project/radare2/libr/core/yank.c"
     res = 
# 240 "project/radare2/libr/core/yank.c" 3 4
           0
# 240 "project/radare2/libr/core/yank.c"
 ...
 if (ybl > 0) {
  if (pos < ybl) {
   ...
   default:
    r_cons_printf ("0x%08" 
# 280 "project/radare2/libr/core/yank.c" 3 4
                          "llx" 
# 280 "project/radare2/libr/core/yank.c"
                                  " %" 
# 280 "project/radare2/libr/core/yank.c" 3 4
                                       "lld" 
# 280 "project/radare2/libr/core/yank.c"
   ...
   res = 
# 288 "project/radare2/libr/core/yank.c" 3 4
        1
# 288 "project/radare2/libr/core/yank.c"
            ;
  } else {
   
# 290 "project/radare2/libr/core/yank.c" 3 4
  fprintf(__stderrp,
# 290 "project/radare2/libr/core/yank.c"
...
# 296 "project/radare2/libr/core/yank.c" 3 4
  fprintf(__stderrp,
# 296 "project/radare2/libr/core/yank.c"
...
# 302 "project/radare2/libr/core/yank.c" 3 4
__attribute__((visibility("default"))) 
# 302 "project/radare2/libr/core/yank.c"
     int r_core_yank_hexdump(RCore *core, 
# 302 "project/radare2/libr/core/yank.c" 3 4
                                          unsigned long long 
# 302 "project/radare2/libr/core/yank.c"
                                               pos) {
 int res = 
# 303 "project/radare2/libr/core/yank.c" 3 4
          0
# 303 "project/radare2/libr/core/yank.c"
               ;
 int ybl = r_buf_size (core->yank_buf);
 if (ybl > 0) {
  if (pos < ybl) {
   
# 307 "project/radare2/libr/core/yank.c" 3 4
  unsigned char 
# 307 "project/radare2/libr/core/yank.c"
      *buf = 
# 307 "project/radare2/libr/core/yank.c" 3 4
             (unsigned char*)malloc(sizeof(unsigned char)*(
# 307 "project/radare2/libr/core/yank.c"
...
# 307 "project/radare2/libr/core/yank.c"
   ...
   if (!buf) {
    return 
# 309 "project/radare2/libr/core/yank.c" 3 4
          0
# 309 "project/radare2/libr/core/yank.c"
               ;
   }
   ...
   r_print_hexdump (core->print, pos,
    buf, ybl - pos, 16, 1, 1);
   res = 
# 314 "project/radare2/libr/core/yank.c" 3 4
        1
# 314 "project/radare2/libr/core/yank.c"
            ;
  } else {
   
# 316 "project/radare2/libr/core/yank.c" 3 4
  fprintf(__stderrp,
# 316 "project/radare2/libr/core/yank.c"
  "Position exceeds buffer length.\n"
# 316 "project/radare2/libr/core/yank.c" 3 4
  )
# 316 "project/radare2/libr/core/yank.c"
...
# 319 "project/radare2/libr/core/yank.c" 3 4
 fprintf(__stderrp,
# 319 "project/radare2/libr/core/yank.c"
 "No buffer yanked already\n"
# 319 "project/radare2/libr/core/yank.c" 3 4
 )
# 319 "project/radare2/libr/core/yank.c"
...
# 324 "project/radare2/libr/core/yank.c" 3 4
__attribute__((visibility("default"))) 
# 324 "project/radare2/libr/core/yank.c"
     int r_core_yank_cat(RCore *core, 
# 324 "project/radare2/libr/core/yank.c" 3 4
                                      unsigned long long 
# 324 "project/radare2/libr/core/yank.c"
                                           pos) {
...
# 328 "project/radare2/libr/core/yank.c" 3 4
  unsigned long long 
# 328 "project/radare2/libr/core/yank.c"
       sz = ybl - pos;
   char *buf = 
# 329 "project/radare2/libr/core/yank.c" 3 4
              (
# 329 "project/radare2/libr/core/yank.c"
              char
# 329 "project/radare2/libr/core/yank.c" 3 4
              *)malloc(sizeof(
# 329 "project/radare2/libr/core/yank.c"
...
# 329 "project/radare2/libr/core/yank.c"
   ...
   if (!buf) {
    return 
# 331 "project/radare2/libr/core/yank.c" 3 4
          0
# 331 "project/radare2/libr/core/yank.c"
               ;
   }
   r_buf_read_at (core->yank_buf, pos, (
# 333 "project/radare2/libr/core/yank.c" 3 4
                                       unsigned char 
# 333 "project/radare2/libr/core/yank.c"
                                           *)buf, sz);
   r_cons_write (buf, sz);
   r_cons_newline ();
   return 
# 336 "project/radare2/libr/core/yank.c" 3 4
         1
# 336 "project/radare2/libr/core/yank.c"
             ;
  }
  
# 338 "project/radare2/libr/core/yank.c" 3 4
 fprintf(__stderrp,
# 338 "project/radare2/libr/core/yank.c"
 "Position exceeds buffer length.\n"
# 338 "project/radare2/libr/core/yank.c" 3 4
 )
# 338 "project/radare2/libr/core/yank.c"
 ...
 return 
# 342 "project/radare2/libr/core/yank.c" 3 4
       0
# 342 "project/radare2/libr/core/yank.c"
            ;
}


# 345 "project/radare2/libr/core/yank.c" 3 4
__attribute__((visibility("default"))) 
# 345 "project/radare2/libr/core/yank.c"
     int r_core_yank_cat_string(RCore *core, 
# 345 "project/radare2/libr/core/yank.c" 3 4
                                             unsigned long long 
# 345 "project/radare2/libr/core/yank.c"
                                                  pos) {
...
# 349 "project/radare2/libr/core/yank.c" 3 4
  unsigned long long 
# 349 "project/radare2/libr/core/yank.c"
       sz = ybl - pos;
   char *buf = 
# 350 "project/radare2/libr/core/yank.c" 3 4
              (
# 350 "project/radare2/libr/core/yank.c"
              char
# 350 "project/radare2/libr/core/yank.c" 3 4
              *)malloc(sizeof(
# 350 "project/radare2/libr/core/yank.c"
...
# 350 "project/radare2/libr/core/yank.c"
   ...
   if (!buf) {
    return 
# 352 "project/radare2/libr/core/yank.c" 3 4
          0
# 352 "project/radare2/libr/core/yank.c"
               ;
   }
   r_buf_read_at (core->yank_buf, pos, (
# 354 "project/radare2/libr/core/yank.c" 3 4
                                       unsigned char 
# 354 "project/radare2/libr/core/yank.c"
                                           *)buf, sz);
   int len = r_str_nlen (buf, sz);
   r_cons_write (buf, len);
   r_cons_newline ();
   return 
# 358 "project/radare2/libr/core/yank.c" 3 4
         1
# 358 "project/radare2/libr/core/yank.c"
             ;
  }
  
# 360 "project/radare2/libr/core/yank.c" 3 4
 fprintf(__stderrp,
# 360 "project/radare2/libr/core/yank.c"
 "Position exceeds buffer length.\n"
# 360 "project/radare2/libr/core/yank.c" 3 4
 )
# 360 "project/radare2/libr/core/yank.c"
 ...
 return 
# 364 "project/radare2/libr/core/yank.c" 3 4
       0
# 364 "project/radare2/libr/core/yank.c"
            ;
}


# 367 "project/radare2/libr/core/yank.c" 3 4
__attribute__((visibility("default"))) 
# 367 "project/radare2/libr/core/yank.c"
     int r_core_yank_hud_file(RCore *core, const char *input) {
 char *buf = 
# 368 "project/radare2/libr/core/yank.c" 3 4
            ((void *)0)
# 368 "project/radare2/libr/core/yank.c"
                ;
 
# 369 "project/radare2/libr/core/yank.c" 3 4
_Bool 
# 369 "project/radare2/libr/core/yank.c"
     res = 
# 369 "project/radare2/libr/core/yank.c" 3 4
           0
# 369 "project/radare2/libr/core/yank.c"
...
# 370 "project/radare2/libr/core/yank.c" 3 4
unsigned int 
# 370 "project/radare2/libr/core/yank.c"
     len = 0;
 if (!input || !*input) {
  return 
# 372 "project/radare2/libr/core/yank.c" 3 4
        0
# 372 "project/radare2/libr/core/yank.c"
             ;
 }
 ...
 res = r_core_yank_set_str (core, 
# 379 "project/radare2/libr/core/yank.c" 3 4
                                 -1
# 379 "project/radare2/libr/core/yank.c"
                                                    , buf, len);
 free (buf);
 return res;
}
...
# 384 "project/radare2/libr/core/yank.c" 3 4
__attribute__((visibility("default"))) 
# 384 "project/radare2/libr/core/yank.c"
     int r_core_yank_hud_path(RCore *core, const char *input, int dir) {
 char *buf = 
# 385 "project/radare2/libr/core/yank.c" 3 4
            ((void *)0)
# 385 "project/radare2/libr/core/yank.c"
                ;
 
# 386 "project/radare2/libr/core/yank.c" 3 4
unsigned int 
# 386 "project/radare2/libr/core/yank.c"
     len = 0;
 int res;
 for (input++; *input == ' '; input++) {
 ...
 len = buf? strlen ((const char *) buf) + 1: 0;
 res = r_core_yank_set_str (core, 
# 393 "project/radare2/libr/core/yank.c" 3 4
                                 -1
# 393 "project/radare2/libr/core/yank.c"
                                                    , buf, len);
 free (buf);
 return res;
}
...
# 398 "project/radare2/libr/core/yank.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 398 "project/radare2/libr/core/yank.c"
          r_core_yank_hexpair(RCore *core, const char *input) {
 if (!input || !*input) {
  return 
# 400 "project/radare2/libr/core/yank.c" 3 4
        0
# 400 "project/radare2/libr/core/yank.c"
             ;
 }
 char *out = strdup (input);
 int len = r_hex_str2bin (input, (
# 403 "project/radare2/libr/core/yank.c" 3 4
                                 unsigned char 
# 403 "project/radare2/libr/core/yank.c"
                                     *)out);
 if (len > 0) {
  r_core_yank_set (core, core->offset, (
# 405 "project/radare2/libr/core/yank.c" 3 4
                                       unsigned char 
# 405 "project/radare2/libr/core/yank.c"
                                           *)out, len);
 }
 free (out);
 return 
# 408 "project/radare2/libr/core/yank.c" 3 4
       1
# 408 "project/radare2/libr/core/yank.c"
           ;
}


# 411 "project/radare2/libr/core/yank.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 411 "project/radare2/libr/core/yank.c"
          r_core_yank_file_ex(RCore *core, const char *input) {
 
# 412 "project/radare2/libr/core/yank.c" 3 4
unsigned long long 
# 412 "project/radare2/libr/core/yank.c"
     len = 0, adv = 0, addr = 0;
 
# 413 "project/radare2/libr/core/yank.c" 3 4
_Bool 
# 413 "project/radare2/libr/core/yank.c"
     res = 
# 413 "project/radare2/libr/core/yank.c" 3 4
           0
# 413 "project/radare2/libr/core/yank.c"
...
# 422 "project/radare2/libr/core/yank.c" 3 4
 fprintf(__stderrp,
# 422 "project/radare2/libr/core/yank.c"
 "ERROR: Number of bytes read must be > 0\n"
# 422 "project/radare2/libr/core/yank.c" 3 4
 )
# 422 "project/radare2/libr/core/yank.c"
                                                      ;
...
# 428 "project/radare2/libr/core/yank.c" 3 4
 fprintf(__stderrp,
# 428 "project/radare2/libr/core/yank.c"
...
# 438 "project/radare2/libr/core/yank.c" 3 4
 fprintf(__stderrp,
# 438 "project/radare2/libr/core/yank.c"
...
# 448 "project/radare2/libr/core/yank.c" 3 4
__attribute__((visibility("default"))) 
# 448 "project/radare2/libr/core/yank.c"
     int r_core_yank_file_all(RCore *core, const char *input) {
 
# 449 "project/radare2/libr/core/yank.c" 3 4
unsigned long long 
# 449 "project/radare2/libr/core/yank.c"
     adv = 0;
 if (!input) {
  return 
# 451 "project/radare2/libr/core/yank.c" 3 4
        0
# 451 "project/radare2/libr/core/yank.c"
             ;
 }
 adv = consume_chars (input, ' ');
