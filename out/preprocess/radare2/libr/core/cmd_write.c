# 0 "project/radare2/libr/core/cmd_write.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/core/cmd_write.c" 2
...
# 5 "project/radare2/libr/core/cmd_write.c" 2
...
# 7 "project/radare2/libr/core/cmd_write.c" 2



# 9 "project/radare2/libr/core/cmd_write.c"
...
# 37 "project/radare2/libr/core/cmd_write.c" 3 4
((void *)0)

# 38 "project/radare2/libr/core/cmd_write.c"
};
...
# 51 "project/radare2/libr/core/cmd_write.c" 3 4
((void *)0)

# 52 "project/radare2/libr/core/cmd_write.c"
};
...
# 63 "project/radare2/libr/core/cmd_write.c" 3 4
((void *)0)

# 64 "project/radare2/libr/core/cmd_write.c"
};
...
# 79 "project/radare2/libr/core/cmd_write.c" 3 4
((void *)0)

# 80 "project/radare2/libr/core/cmd_write.c"
};
...
# 89 "project/radare2/libr/core/cmd_write.c" 3 4
((void *)0)

# 90 "project/radare2/libr/core/cmd_write.c"
};
...
# 114 "project/radare2/libr/core/cmd_write.c" 3 4
((void *)0)

# 115 "project/radare2/libr/core/cmd_write.c"
};
...
# 122 "project/radare2/libr/core/cmd_write.c" 3 4
((void *)0)

# 123 "project/radare2/libr/core/cmd_write.c"
};
...
# 136 "project/radare2/libr/core/cmd_write.c" 3 4
((void *)0)

# 137 "project/radare2/libr/core/cmd_write.c"
};
...
# 146 "project/radare2/libr/core/cmd_write.c" 3 4
((void *)0)

# 147 "project/radare2/libr/core/cmd_write.c"
};
...
# 155 "project/radare2/libr/core/cmd_write.c" 3 4
((void *)0)

# 156 "project/radare2/libr/core/cmd_write.c"
};
...
# 169 "project/radare2/libr/core/cmd_write.c" 3 4
((void *)0)

# 170 "project/radare2/libr/core/cmd_write.c"
};
...
# 177 "project/radare2/libr/core/cmd_write.c" 3 4
((void *)0)

# 178 "project/radare2/libr/core/cmd_write.c"
};

static void cmd_write_fail(RCore *core) {
 
# 181 "project/radare2/libr/core/cmd_write.c" 3 4
fprintf(__stderrp,
# 181 "project/radare2/libr/core/cmd_write.c"
...
# 185 "project/radare2/libr/core/cmd_write.c" 3 4
__attribute__((visibility("default"))) 
# 185 "project/radare2/libr/core/cmd_write.c"
     int cmd_write_hexpair(RCore* core, const char* pairs) {
 
# 186 "project/radare2/libr/core/cmd_write.c" 3 4
do { if (!(
# 186 "project/radare2/libr/core/cmd_write.c"
core && pairs
# 186 "project/radare2/libr/core/cmd_write.c" 3 4
...
# 187 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned char 
# 187 "project/radare2/libr/core/cmd_write.c"
    *buf = malloc (strlen (pairs) + 1);
 if (!buf) {
  return 0;
 }
...
# 209 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 209 "project/radare2/libr/core/cmd_write.c"
...
static 
# 216 "project/radare2/libr/core/cmd_write.c" 3 4
      _Bool 
# 216 "project/radare2/libr/core/cmd_write.c"
           encrypt_or_decrypt_block(RCore *core, const char *algo, const char *key, int direction, const char *iv) {

 int keylen = 0;
 
# 219 "project/radare2/libr/core/cmd_write.c" 3 4
_Bool 
# 219 "project/radare2/libr/core/cmd_write.c"
     no_key_mode = !strcmp ("base64", algo) || !strcmp ("base91", algo) || !strcmp ("punycode", algo);
 
# 220 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned char 
# 220 "project/radare2/libr/core/cmd_write.c"
    *binkey = 
# 220 "project/radare2/libr/core/cmd_write.c" 3 4
              ((void *)0)
# 220 "project/radare2/libr/core/cmd_write.c"
 ...
 if (!strncmp (key, "s:", 2)) {
  binkey = (
# 222 "project/radare2/libr/core/cmd_write.c" 3 4
           unsigned char
# 222 "project/radare2/libr/core/cmd_write.c"
              *)strdup (key + 2);
  keylen = strlen (key + 2);
 } else {
  binkey = (
# 225 "project/radare2/libr/core/cmd_write.c" 3 4
           unsigned char 
# 225 "project/radare2/libr/core/cmd_write.c"
               *)strdup (key);
  keylen = r_hex_str2bin (key, binkey);
 }
 if (!binkey) {
  
# 229 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 229 "project/radare2/libr/core/cmd_write.c"
...
# 229 "project/radare2/libr/core/cmd_write.c"
                                                 ;
  return 
# 230 "project/radare2/libr/core/cmd_write.c" 3 4
        0
# 230 "project/radare2/libr/core/cmd_write.c"
             ;
 }
 if (!no_key_mode && keylen < 1) {
  
# 233 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 233 "project/radare2/libr/core/cmd_write.c"
...
# 233 "project/radare2/libr/core/cmd_write.c"
  ...
  free (binkey);
  return 
# 235 "project/radare2/libr/core/cmd_write.c" 3 4
        0
# 235 "project/radare2/libr/core/cmd_write.c"
             ;
 }
...
# 241 "project/radare2/libr/core/cmd_write.c" 3 4
   unsigned char 
# 241 "project/radare2/libr/core/cmd_write.c"
       *biniv = malloc (strlen (iv) + 1);
    int ivlen = r_hex_str2bin (iv, biniv);
    if (ivlen < 1) {
     ivlen = strlen(iv);
     
# 245 "project/radare2/libr/core/cmd_write.c" 3 4
    __builtin___strcpy_chk (
# 245 "project/radare2/libr/core/cmd_write.c"
    (char *)biniv
# 245 "project/radare2/libr/core/cmd_write.c" 3 4
    , 
# 245 "project/radare2/libr/core/cmd_write.c"
...
# 248 "project/radare2/libr/core/cmd_write.c" 3 4
    fprintf(__stderrp,
# 248 "project/radare2/libr/core/cmd_write.c"
    "Invalid IV.\n"
# 248 "project/radare2/libr/core/cmd_write.c" 3 4
    )
# 248 "project/radare2/libr/core/cmd_write.c"
   ...
   r_crypto_update (cry, (const 
# 252 "project/radare2/libr/core/cmd_write.c" 3 4
                               unsigned char
# 252 "project/radare2/libr/core/cmd_write.c"
                                  *)core->block, core->blocksize);

   int result_size = 0;
   
# 255 "project/radare2/libr/core/cmd_write.c" 3 4
  unsigned char 
# 255 "project/radare2/libr/core/cmd_write.c"
      *result = r_crypto_get_output (cry, &result_size);
   if (result) {
    if (!r_core_write_at (core, core->offset, result, result_size)) {
     
# 258 "project/radare2/libr/core/cmd_write.c" 3 4
    fprintf(__stderrp,
# 258 "project/radare2/libr/core/cmd_write.c"
    "r_core_write_at failed at 0x%08"
# 258 "project/radare2/libr/core/cmd_write.c" 3 4
    "llx"
# 258 "project/radare2/libr/core/cmd_write.c"
    "\n", core->offset
...
# 260 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 260 "project/radare2/libr/core/cmd_write.c"
   "Written %d byte(s)\n", result_size
# 260 "project/radare2/libr/core/cmd_write.c" 3 4
   )
# 260 "project/radare2/libr/core/cmd_write.c"
...
# 264 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 264 "project/radare2/libr/core/cmd_write.c"
  "Invalid key\n"
# 264 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 264 "project/radare2/libr/core/cmd_write.c"
...
# 270 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 270 "project/radare2/libr/core/cmd_write.c"
...
static void cmd_write_bits(RCore *core, int set, 
# 276 "project/radare2/libr/core/cmd_write.c" 3 4
                                                unsigned long long 
# 276 "project/radare2/libr/core/cmd_write.c"
                                                     val) {
 
# 277 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned long long 
# 277 "project/radare2/libr/core/cmd_write.c"
     ret, orig;

 r_io_read_at (core->io, core->offset, (
# 279 "project/radare2/libr/core/cmd_write.c" 3 4
                                       unsigned char
# 279 "project/radare2/libr/core/cmd_write.c"
                                          *)&orig, sizeof (orig));
 if (set) {
  ret = orig | val;
 } else {
 ...
 if (!r_core_write_at (core, core->offset, (const 
# 285 "project/radare2/libr/core/cmd_write.c" 3 4
                                                 unsigned char
# 285 "project/radare2/libr/core/cmd_write.c"
                                                    *)&ret, sizeof (ret))) {
  cmd_write_fail (core);
 }
}

static void cmd_write_inc(RCore *core, int size, 
# 290 "project/radare2/libr/core/cmd_write.c" 3 4
                                                long long 
# 290 "project/radare2/libr/core/cmd_write.c"
                                                     num) {
 
# 291 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned long long 
# 291 "project/radare2/libr/core/cmd_write.c"
     *v64;
 
# 292 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned int 
# 292 "project/radare2/libr/core/cmd_write.c"
     *v32;
 
# 293 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned short 
# 293 "project/radare2/libr/core/cmd_write.c"
     *v16;
 
# 294 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned char 
# 294 "project/radare2/libr/core/cmd_write.c"
    *v8;
 switch (size) {
 case 1: v8 = (
# 296 "project/radare2/libr/core/cmd_write.c" 3 4
              unsigned char
# 296 "project/radare2/libr/core/cmd_write.c"
                 *)core->block; *v8 += num; break;
 case 2: v16 = (
# 297 "project/radare2/libr/core/cmd_write.c" 3 4
               unsigned short
# 297 "project/radare2/libr/core/cmd_write.c"
                   *)core->block; *v16 += num; break;
 case 4: v32 = (
# 298 "project/radare2/libr/core/cmd_write.c" 3 4
               unsigned int
# 298 "project/radare2/libr/core/cmd_write.c"
                   *)core->block; *v32 += num; break;
 case 8: v64 = (
# 299 "project/radare2/libr/core/cmd_write.c" 3 4
               unsigned long long
# 299 "project/radare2/libr/core/cmd_write.c"
                   *)core->block; *v64 += num; break;
 }
...
# 309 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned char 
# 309 "project/radare2/libr/core/cmd_write.c"
    *buf;
 int len;
 int value;
 switch (input[0]) {
 ...
 case '8':
  if (input[1]) {
   ...
   r_core_write_op (core, 
# 336 "project/radare2/libr/core/cmd_write.c" 3 4
                         ((void *)0)
# 336 "project/radare2/libr/core/cmd_write.c"
                             , input[0]);
  }
  r_core_block_read (core);
  break;
 ...
 case 'D':
  {
   ...
   const char *algo = 
# 351 "project/radare2/libr/core/cmd_write.c" 3 4
                     ((void *)0)
# 351 "project/radare2/libr/core/cmd_write.c"
                         ;
   const char *key = 
# 352 "project/radare2/libr/core/cmd_write.c" 3 4
                    ((void *)0)
# 352 "project/radare2/libr/core/cmd_write.c"
                        ;
   const char *iv = 
# 353 "project/radare2/libr/core/cmd_write.c" 3 4
                   ((void *)0)
# 353 "project/radare2/libr/core/cmd_write.c"
                       ;
...
# 369 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 369 "project/radare2/libr/core/cmd_write.c"
   "Usage: wo%c [algo] [key] [IV]\n", ((!direction)?'E':'D')
# 369 "project/radare2/libr/core/cmd_write.c" 3 4
   )
# 369 "project/radare2/libr/core/cmd_write.c"
                                                                      ;
    
# 370 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 370 "project/radare2/libr/core/cmd_write.c"
...
# 371 "project/radare2/libr/core/cmd_write.c" 3 4
   unsigned long long 
# 371 "project/radare2/libr/core/cmd_write.c"
        bits;
    int i;
    for (i = 0; ; i++) {
     bits = ((
# 374 "project/radare2/libr/core/cmd_write.c" 3 4
             unsigned long long
# 374 "project/radare2/libr/core/cmd_write.c"
                 )1) << i;
     const char *name = r_hash_name (bits);
     if 
# 376 "project/radare2/libr/core/cmd_write.c" 3 4
       (!(
# 376 "project/radare2/libr/core/cmd_write.c"
       name
# 376 "project/radare2/libr/core/cmd_write.c" 3 4
       ) || !*(
# 376 "project/radare2/libr/core/cmd_write.c"
...
# 381 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 381 "project/radare2/libr/core/cmd_write.c"
...
# 381 "project/radare2/libr/core/cmd_write.c"
    ...
    for (i = 0; ; i++) {
     ...
     if (
# 385 "project/radare2/libr/core/cmd_write.c" 3 4
        (!(
# 385 "project/radare2/libr/core/cmd_write.c"
        name
# 385 "project/radare2/libr/core/cmd_write.c" 3 4
        ) || !*(
# 385 "project/radare2/libr/core/cmd_write.c"
...
# 390 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 390 "project/radare2/libr/core/cmd_write.c"
...
# 390 "project/radare2/libr/core/cmd_write.c"
    ...
    for (i = 0; ; i++) {
     ...
     if 
# 394 "project/radare2/libr/core/cmd_write.c" 3 4
       (!(
# 394 "project/radare2/libr/core/cmd_write.c"
       name
# 394 "project/radare2/libr/core/cmd_write.c" 3 4
       ) || !*(
# 394 "project/radare2/libr/core/cmd_write.c"
 ...
 case 'p':
  ...
  case 'D':
   ...
   if (len > 0) {
    ...
    buf = (
# 412 "project/radare2/libr/core/cmd_write.c" 3 4
          unsigned char
# 412 "project/radare2/libr/core/cmd_write.c"
             *)r_debruijn_pattern (len, 0, 
# 412 "project/radare2/libr/core/cmd_write.c" 3 4
                                           ((void *)0)
# 412 "project/radare2/libr/core/cmd_write.c"
                                               );
    if (buf) {
     const 
# 414 "project/radare2/libr/core/cmd_write.c" 3 4
          unsigned char 
# 414 "project/radare2/libr/core/cmd_write.c"
              *ptr = buf;
     
# 415 "project/radare2/libr/core/cmd_write.c" 3 4
    unsigned long long 
# 415 "project/radare2/libr/core/cmd_write.c"
         addr = core->offset;
     if (input[2] == '*') {
      int i;
      r_cons_printf ("wx ");
...
# 430 "project/radare2/libr/core/cmd_write.c" 3 4
    fprintf(__stderrp,
# 430 "project/radare2/libr/core/cmd_write.c"
    "Couldn't generate pattern of length %d\n", len
# 430 "project/radare2/libr/core/cmd_write.c" 3 4
    )
# 430 "project/radare2/libr/core/cmd_write.c"
                                                             ;
...
# 436 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 436 "project/radare2/libr/core/cmd_write.c"
...
# 436 "project/radare2/libr/core/cmd_write.c"
    ...
    r_cons_printf ("%"
# 440 "project/radare2/libr/core/cmd_write.c" 3 4
                     "lld"
# 440 "project/radare2/libr/core/cmd_write.c"
                            "\n", core->num->value);
   }
   break;
  case '\0':
...
static void cmd_write_value_float(RCore *core, const char *input) {
 float v = 0.0;
 sscanf (input, "%f", &v);
 r_io_write_at (core->io, core->offset, (const 
# 463 "project/radare2/libr/core/cmd_write.c" 3 4
                                              unsigned char
# 463 "project/radare2/libr/core/cmd_write.c"
                                                 *)&v, sizeof (float));
}
...
static void cmd_write_value_long_double(RCore *core, const char *input) {
 ...
 sscanf (input, "%Lf", &v);
 r_io_write_at (core->io, core->offset, (const 
# 469 "project/radare2/libr/core/cmd_write.c" 3 4
                                              unsigned char
# 469 "project/radare2/libr/core/cmd_write.c"
...
static void cmd_write_value_double(RCore *core, const char *input) {
 ...
 sscanf (input, "%lf", &v);
 r_io_write_at (core->io, core->offset, (const 
# 475 "project/radare2/libr/core/cmd_write.c" 3 4
                                              unsigned char
# 475 "project/radare2/libr/core/cmd_write.c"
                                                 *)&v, sizeof (double));
}
...
# 480 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned long long 
# 480 "project/radare2/libr/core/cmd_write.c"
     off = 0LL;
 
# 481 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned char 
# 481 "project/radare2/libr/core/cmd_write.c"
    buf[sizeof(
# 481 "project/radare2/libr/core/cmd_write.c" 3 4
               unsigned long long
# 481 "project/radare2/libr/core/cmd_write.c"
...
# 483 "project/radare2/libr/core/cmd_write.c" 3 4
_Bool 
# 483 "project/radare2/libr/core/cmd_write.c"
...
# 505 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned long long 
# 505 "project/radare2/libr/core/cmd_write.c"
     addr = core->offset;
...
# 510 "project/radare2/libr/core/cmd_write.c" 3 4
if (
# 510 "project/radare2/libr/core/cmd_write.c"
list
# 510 "project/radare2/libr/core/cmd_write.c" 3 4
) for (
# 510 "project/radare2/libr/core/cmd_write.c"
...
# 517 "project/radare2/libr/core/cmd_write.c" 3 4
 unsigned long long 
# 517 "project/radare2/libr/core/cmd_write.c"
      res = r_io_seek (core->io, addr, 
# 517 "project/radare2/libr/core/cmd_write.c" 3 4
                                       0
# 517 "project/radare2/libr/core/cmd_write.c"
                                                    );
  if (res == 
# 518 "project/radare2/libr/core/cmd_write.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 518 "project/radare2/libr/core/cmd_write.c"
                    ) {
   return;
  }
  if (type == 0) {
   type = (off & 
# 522 "project/radare2/libr/core/cmd_write.c" 3 4
                0xFFFFFFFF00000000ULL
# 522 "project/radare2/libr/core/cmd_write.c"
                        )? 8: 4;
  }
  switch (type) {
  case 1:
   r_write_ble8 (buf, (
# 526 "project/radare2/libr/core/cmd_write.c" 3 4
                      unsigned char
# 526 "project/radare2/libr/core/cmd_write.c"
                         )(off & 
# 526 "project/radare2/libr/core/cmd_write.c" 3 4
                                 0xFFU
# 526 "project/radare2/libr/core/cmd_write.c"
   ...
   if (!r_io_write (core->io, buf, 1)) {
    ...
    if (wseek)r_core_seek_delta (core,1);
   }
   break;
  case 2:
   r_write_ble16 (buf, (
# 534 "project/radare2/libr/core/cmd_write.c" 3 4
                       unsigned short
# 534 "project/radare2/libr/core/cmd_write.c"
                           )(off & 
# 534 "project/radare2/libr/core/cmd_write.c" 3 4
                                   0xFFFFU
# 534 "project/radare2/libr/core/cmd_write.c"
   ...
   if (!r_io_write (core->io, buf, 2)) {
    ...
    if (wseek)r_core_seek_delta (core,2);
   }
   break;
  case 4:
   r_write_ble32 (buf, (
# 542 "project/radare2/libr/core/cmd_write.c" 3 4
                       unsigned int
# 542 "project/radare2/libr/core/cmd_write.c"
                           )(off & 
# 542 "project/radare2/libr/core/cmd_write.c" 3 4
                                   0xFFFFFFFFU
# 542 "project/radare2/libr/core/cmd_write.c"
   ...
   if (!r_io_write (core->io, buf, 4)) {
    ...
    if (wseek)r_core_seek_delta (core,4);
   }
   break;
  case 8:
   ...
   if (!r_io_write (core->io, buf, 8)) {
    ...
    if (wseek)r_core_seek_delta (core,8);
   }
   break;
  }
  addr += type;
...
static 
# 565 "project/radare2/libr/core/cmd_write.c" 3 4
      _Bool 
# 565 "project/radare2/libr/core/cmd_write.c"
           cmd_wff(RCore *core, const char *input) {
 
# 566 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned char 
# 566 "project/radare2/libr/core/cmd_write.c"
    *buf = 
# 566 "project/radare2/libr/core/cmd_write.c" 3 4
           ((void *)0)
# 566 "project/radare2/libr/core/cmd_write.c"
...
# 577 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 577 "project/radare2/libr/core/cmd_write.c"
 "Usage: wf [file] ([size] ([offset]))\n"
# 577 "project/radare2/libr/core/cmd_write.c" 3 4
 )
# 577 "project/radare2/libr/core/cmd_write.c"
                                                   ;
 } else if (!strcmp (arg, "-")) {
  char *out = r_core_editor (core, 
# 579 "project/radare2/libr/core/cmd_write.c" 3 4
                                  ((void *)0)
# 579 "project/radare2/libr/core/cmd_write.c"
                                      , 
# 579 "project/radare2/libr/core/cmd_write.c" 3 4
                                        ((void *)0)
# 579 "project/radare2/libr/core/cmd_write.c"
  ...
  if (out) {
   if (!r_io_write_at (core->io, core->offset,
    (
# 582 "project/radare2/libr/core/cmd_write.c" 3 4
    unsigned char
# 582 "project/radare2/libr/core/cmd_write.c"
       *)out, strlen (out))) {
     
# 583 "project/radare2/libr/core/cmd_write.c" 3 4
    fprintf(__stderrp,
# 583 "project/radare2/libr/core/cmd_write.c"
    "r_io_write_at failed at 0x%08"
# 583 "project/radare2/libr/core/cmd_write.c" 3 4
    "llx"
# 583 "project/radare2/libr/core/cmd_write.c"
    "\n", core->offset
...
# 591 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 591 "project/radare2/libr/core/cmd_write.c"
 "No alias name given.\n"
# 591 "project/radare2/libr/core/cmd_write.c" 3 4
 )
# 591 "project/radare2/libr/core/cmd_write.c"
...
# 598 "project/radare2/libr/core/cmd_write.c" 3 4
   __builtin___memcpy_chk (
# 598 "project/radare2/libr/core/cmd_write.c"
   buf
# 598 "project/radare2/libr/core/cmd_write.c" 3 4
   , 
# 598 "project/radare2/libr/core/cmd_write.c"
...
# 603 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 603 "project/radare2/libr/core/cmd_write.c"
  "No such alias \"$%s\"\n", a+1
# 603 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 603 "project/radare2/libr/core/cmd_write.c"
  ...
  buf = (
# 606 "project/radare2/libr/core/cmd_write.c" 3 4
        unsigned char
# 606 "project/radare2/libr/core/cmd_write.c"
           *) r_file_slurp (a, &size);
 }
 if (size < 1) {
...
# 612 "project/radare2/libr/core/cmd_write.c" 3 4
 unsigned long long 
# 612 "project/radare2/libr/core/cmd_write.c"
      u_size = r_num_math (core->num, p);
  if (u_size < 1) u_size = (
# 613 "project/radare2/libr/core/cmd_write.c" 3 4
                           unsigned long long
# 613 "project/radare2/libr/core/cmd_write.c"
                               )size;
  if (p) {
   *p++ = 0;
...
# 618 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 618 "project/radare2/libr/core/cmd_write.c"
   "Invalid offset\n"
# 618 "project/radare2/libr/core/cmd_write.c" 3 4
   )
# 618 "project/radare2/libr/core/cmd_write.c"
    ...
    free (buf);
    return 
# 621 "project/radare2/libr/core/cmd_write.c" 3 4
          0
# 621 "project/radare2/libr/core/cmd_write.c"
               ;
   }
  }
  r_io_use_fd (core->io, core->io->desc->fd);
...
# 626 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 626 "project/radare2/libr/core/cmd_write.c"
  "r_io_write_at failed at 0x%08"
# 626 "project/radare2/libr/core/cmd_write.c" 3 4
  "llx"
# 626 "project/radare2/libr/core/cmd_write.c"
...
# 626 "project/radare2/libr/core/cmd_write.c"
  ...
  if (wseek)r_core_seek_delta (core,size);
  r_core_block_read (core);
 } else {
  
# 631 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 631 "project/radare2/libr/core/cmd_write.c"
 "Cannot open file '%s'\n", arg
# 631 "project/radare2/libr/core/cmd_write.c" 3 4
 )
# 631 "project/radare2/libr/core/cmd_write.c"
 ...
 free (buf);
 return 
# 635 "project/radare2/libr/core/cmd_write.c" 3 4
       1
# 635 "project/radare2/libr/core/cmd_write.c"
           ;
}

static 
# 638 "project/radare2/libr/core/cmd_write.c" 3 4
      _Bool 
# 638 "project/radare2/libr/core/cmd_write.c"
           ioMemcpy (RCore *core, 
# 638 "project/radare2/libr/core/cmd_write.c" 3 4
                                  unsigned long long 
# 638 "project/radare2/libr/core/cmd_write.c"
...
# 639 "project/radare2/libr/core/cmd_write.c" 3 4
_Bool 
# 639 "project/radare2/libr/core/cmd_write.c"
     ret = 
# 639 "project/radare2/libr/core/cmd_write.c" 3 4
           0
# 639 "project/radare2/libr/core/cmd_write.c"
...
# 641 "project/radare2/libr/core/cmd_write.c" 3 4
 unsigned char 
# 641 "project/radare2/libr/core/cmd_write.c"
     * buf = calloc (1, len);
  if (buf) {
   if (r_io_read_at (core->io, src, buf, len)) {
    if (r_io_write_at (core->io, dst, buf, len)) {
     r_core_block_read (core);
     ret = 
# 646 "project/radare2/libr/core/cmd_write.c" 3 4
          1
# 646 "project/radare2/libr/core/cmd_write.c"
              ;
    } else {
     
# 648 "project/radare2/libr/core/cmd_write.c" 3 4
    fprintf(__stderrp,
# 648 "project/radare2/libr/core/cmd_write.c"
    "r_io_write_at failed at 0x%08"
# 648 "project/radare2/libr/core/cmd_write.c" 3 4
    "llx"
# 648 "project/radare2/libr/core/cmd_write.c"
...
# 651 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 651 "project/radare2/libr/core/cmd_write.c"
   "r_io_read_at failed at 0x%08"
# 651 "project/radare2/libr/core/cmd_write.c" 3 4
   "llx"
# 651 "project/radare2/libr/core/cmd_write.c"
   "\n", src
...
static 
# 659 "project/radare2/libr/core/cmd_write.c" 3 4
      _Bool 
# 659 "project/radare2/libr/core/cmd_write.c"
           cmd_wfx(RCore *core, const char *input) {
...
# 667 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned long long 
# 667 "project/radare2/libr/core/cmd_write.c"
     dst = core->offset;
 
# 668 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned long long 
# 668 "project/radare2/libr/core/cmd_write.c"
     src = r_num_math (core->num, args);
 if (len > 0) {

  
# 671 "project/radare2/libr/core/cmd_write.c" 3 4
 unsigned char 
# 671 "project/radare2/libr/core/cmd_write.c"
     *buf = calloc (1, len);
  if (buf) {
...
# 678 "project/radare2/libr/core/cmd_write.c" 3 4
    fprintf(__stderrp,
# 678 "project/radare2/libr/core/cmd_write.c"
    "Failed to write at 0x%08"
# 678 "project/radare2/libr/core/cmd_write.c" 3 4
    "llx"
# 678 "project/radare2/libr/core/cmd_write.c"
    "\n", src
...
# 681 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 681 "project/radare2/libr/core/cmd_write.c"
   "cmd_wfx: failed to read at 0x%08"
# 681 "project/radare2/libr/core/cmd_write.c" 3 4
   "llx"
# 681 "project/radare2/libr/core/cmd_write.c"
   "\n", dst
...
# 681 "project/radare2/libr/core/cmd_write.c"
 ...
 free (args);
 return 
# 687 "project/radare2/libr/core/cmd_write.c" 3 4
       1
# 687 "project/radare2/libr/core/cmd_write.c"
           ;
}

static 
# 690 "project/radare2/libr/core/cmd_write.c" 3 4
      _Bool 
# 690 "project/radare2/libr/core/cmd_write.c"
           cmd_wfs(RCore *core, const char *input) {
 char *str = strdup (input);
 if (str[0] != ' ') {
  
# 693 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 693 "project/radare2/libr/core/cmd_write.c"
 "Usage wfs host:port [sz]\n"
# 693 "project/radare2/libr/core/cmd_write.c" 3 4
 )
# 693 "project/radare2/libr/core/cmd_write.c"
                                       ;
  free (str);
  return 
# 695 "project/radare2/libr/core/cmd_write.c" 3 4
        0
# 695 "project/radare2/libr/core/cmd_write.c"
             ;
 }
 
# 697 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned long long 
# 697 "project/radare2/libr/core/cmd_write.c"
     addr = 0;
 char *host = str + 1;
 char *port = strchr (host, ':');
 if (!port) {
  
# 701 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 701 "project/radare2/libr/core/cmd_write.c"
 "Usage wfs host:port [sz]\n"
# 701 "project/radare2/libr/core/cmd_write.c" 3 4
 )
# 701 "project/radare2/libr/core/cmd_write.c"
  ...
  free (str);
  return 
# 703 "project/radare2/libr/core/cmd_write.c" 3 4
        0
# 703 "project/radare2/libr/core/cmd_write.c"
             ;
 }
 
# 705 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned long long 
# 705 "project/radare2/libr/core/cmd_write.c"
     sz = core->blocksize;
 *port ++= 0;
...
# 713 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned char 
# 713 "project/radare2/libr/core/cmd_write.c"
    *buf = calloc (1, sz);
 if (!buf) {
  free (str);
  return 
# 716 "project/radare2/libr/core/cmd_write.c" 3 4
        0
# 716 "project/radare2/libr/core/cmd_write.c"
             ;
 }
 r_io_read_at (core->io, addr, buf, sz);
 RSocket *s = r_socket_new (
# 719 "project/radare2/libr/core/cmd_write.c" 3 4
                           0
# 719 "project/radare2/libr/core/cmd_write.c"
                                );
 if (!r_socket_listen (s, port, 
# 720 "project/radare2/libr/core/cmd_write.c" 3 4
                               ((void *)0)
# 720 "project/radare2/libr/core/cmd_write.c"
                                   )) {
  
# 721 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 721 "project/radare2/libr/core/cmd_write.c"
...
# 721 "project/radare2/libr/core/cmd_write.c"
  ...
  free (buf);
  return 
# 725 "project/radare2/libr/core/cmd_write.c" 3 4
        0
# 725 "project/radare2/libr/core/cmd_write.c"
             ;
 }
 int done = 0;
...
# 730 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 730 "project/radare2/libr/core/cmd_write.c"
...
# 734 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 734 "project/radare2/libr/core/cmd_write.c"
   "oops\n"
# 734 "project/radare2/libr/core/cmd_write.c" 3 4
   )
# 734 "project/radare2/libr/core/cmd_write.c"
...
# 741 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 741 "project/radare2/libr/core/cmd_write.c"
  "Written %d bytes\n", done
# 741 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 741 "project/radare2/libr/core/cmd_write.c"
 ...
 free (str);
 return 
# 749 "project/radare2/libr/core/cmd_write.c" 3 4
       1
# 749 "project/radare2/libr/core/cmd_write.c"
           ;
}
...
# 758 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 758 "project/radare2/libr/core/cmd_write.c"
 "Usage: wf [file] ([size] ([offset]))\n"
# 758 "project/radare2/libr/core/cmd_write.c" 3 4
 )
# 758 "project/radare2/libr/core/cmd_write.c"
...
# 778 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned long long 
# 778 "project/radare2/libr/core/cmd_write.c"
     addr = r_num_math (core->num, args);
...
# 791 "project/radare2/libr/core/cmd_write.c" 3 4
_Bool 
# 791 "project/radare2/libr/core/cmd_write.c"
     rad = 
# 791 "project/radare2/libr/core/cmd_write.c" 3 4
           0
# 791 "project/radare2/libr/core/cmd_write.c"
 ...
 if (core && core->io && core->io->p_cache && core->print && core->print->cb_printf) {
  ...
  case '*':
   rad = 
# 804 "project/radare2/libr/core/cmd_write.c" 3 4
        1
# 804 "project/radare2/libr/core/cmd_write.c"
            ;
  case ' ':
  case '\0':
   if (input[0] && input[1]) {
...
# 816 "project/radare2/libr/core/cmd_write.c" 3 4
    if (
# 816 "project/radare2/libr/core/cmd_write.c"
    caches
# 816 "project/radare2/libr/core/cmd_write.c" 3 4
    ) for (
# 816 "project/radare2/libr/core/cmd_write.c"
...
# 816 "project/radare2/libr/core/cmd_write.c"
      ...
      core->print->cb_printf (" @ 0x%08"
# 822 "project/radare2/libr/core/cmd_write.c" 3 4
                                       "llx"
# 822 "project/radare2/libr/core/cmd_write.c"
                                              " \n", r_itv_begin (c->itv));
     }
    } else {
     
# 825 "project/radare2/libr/core/cmd_write.c" 3 4
    if (
# 825 "project/radare2/libr/core/cmd_write.c"
    caches
# 825 "project/radare2/libr/core/cmd_write.c" 3 4
    ) for (
# 825 "project/radare2/libr/core/cmd_write.c"
...
# 825 "project/radare2/libr/core/cmd_write.c"
                                     {
      core->print->cb_printf ("0x%08"
# 826 "project/radare2/libr/core/cmd_write.c" 3 4
                                    "llx"
# 826 "project/radare2/libr/core/cmd_write.c"
                                           ": %02x",
...
# 858 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 858 "project/radare2/libr/core/cmd_write.c"
 "Usage: wB 0x2000  # or wB-0x2000\n"
# 858 "project/radare2/libr/core/cmd_write.c" 3 4
 )
# 858 "project/radare2/libr/core/cmd_write.c"
                                               ;
...
static int w0_handler_common(RCore *core, 
# 864 "project/radare2/libr/core/cmd_write.c" 3 4
                                         unsigned long long 
# 864 "project/radare2/libr/core/cmd_write.c"
                                              len) {
 int res = 0;
 if (len > 0) {
  
# 867 "project/radare2/libr/core/cmd_write.c" 3 4
 unsigned char 
# 867 "project/radare2/libr/core/cmd_write.c"
     *buf = calloc (1, len);
  if (buf) {
   if (!r_io_write_at (core->io, core->offset, buf, len)) {
    
# 870 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 870 "project/radare2/libr/core/cmd_write.c"
   "r_io_write_at failed at 0x%08" 
# 870 "project/radare2/libr/core/cmd_write.c" 3 4
   "llx" 
# 870 "project/radare2/libr/core/cmd_write.c"
...
# 876 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 876 "project/radare2/libr/core/cmd_write.c"
  "Cannot allocate %d byte(s)\n", (int)len
# 876 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 876 "project/radare2/libr/core/cmd_write.c"
...
# 885 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned long long 
# 885 "project/radare2/libr/core/cmd_write.c"
...
# 891 "project/radare2/libr/core/cmd_write.c" 3 4
long long 
# 891 "project/radare2/libr/core/cmd_write.c"
     num = 1;
 if (input[0] && input[1]) {
...
# 903 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 903 "project/radare2/libr/core/cmd_write.c"
 "Usage: w[1248][+-][num]   # inc/dec byte/word/..\n"
# 903 "project/radare2/libr/core/cmd_write.c" 3 4
 )
# 903 "project/radare2/libr/core/cmd_write.c"
                                                               ;
...
# 912 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned char 
# 912 "project/radare2/libr/core/cmd_write.c"
    *buf = 
# 912 "project/radare2/libr/core/cmd_write.c" 3 4
           ((void *)0)
# 912 "project/radare2/libr/core/cmd_write.c"
...
# 929 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 929 "project/radare2/libr/core/cmd_write.c"
...
# 939 "project/radare2/libr/core/cmd_write.c" 3 4
  unsigned char 
# 939 "project/radare2/libr/core/cmd_write.c"
      *bin_buf = malloc (str_len);
   if (!bin_buf) {
    
# 941 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 941 "project/radare2/libr/core/cmd_write.c"
   "Error: failed to malloc memory"
# 941 "project/radare2/libr/core/cmd_write.c" 3 4
   )
# 941 "project/radare2/libr/core/cmd_write.c"
 ...
 if (!fail) {
  ...
  if (wseek)r_core_seek_delta (core,len);
  r_core_block_read (core);
  free (buf);
 } else {
  
# 971 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 971 "project/radare2/libr/core/cmd_write.c"
 "Usage: w6[de] base64/hex\n"
# 971 "project/radare2/libr/core/cmd_write.c" 3 4
 )
# 971 "project/radare2/libr/core/cmd_write.c"
                                       ;
...
# 992 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned long long 
# 992 "project/radare2/libr/core/cmd_write.c"
     addr = 0, len = 0, b_size = 0;
 
# 993 "project/radare2/libr/core/cmd_write.c" 3 4
long long 
# 993 "project/radare2/libr/core/cmd_write.c"
     dist = 0;
 
# 994 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned char
# 994 "project/radare2/libr/core/cmd_write.c"
   * bytes = 
# 994 "project/radare2/libr/core/cmd_write.c" 3 4
             ((void *)0)
# 994 "project/radare2/libr/core/cmd_write.c"
                 ;
 int cmd_suc = 
# 995 "project/radare2/libr/core/cmd_write.c" 3 4
              0
# 995 "project/radare2/libr/core/cmd_write.c"
                   ;
 char *input_shadow = 
# 996 "project/radare2/libr/core/cmd_write.c" 3 4
                     ((void *)0)
# 996 "project/radare2/libr/core/cmd_write.c"
                         , *p = 
# 996 "project/radare2/libr/core/cmd_write.c" 3 4
                                ((void *)0)
# 996 "project/radare2/libr/core/cmd_write.c"
 ...
 case 'n':
  if (input[1] == ' ') {
   ...
   if (len > 0) {
    const 
# 1003 "project/radare2/libr/core/cmd_write.c" 3 4
         unsigned long long 
# 1003 "project/radare2/libr/core/cmd_write.c"
              cur_off = core->offset;
...
# 1009 "project/radare2/libr/core/cmd_write.c" 3 4
    fprintf(__stderrp,
# 1009 "project/radare2/libr/core/cmd_write.c"
    "r_io_extend failed\n"
# 1009 "project/radare2/libr/core/cmd_write.c" 3 4
    )
# 1009 "project/radare2/libr/core/cmd_write.c"
                                    ;
     cmd_suc = 
# 1010 "project/radare2/libr/core/cmd_write.c" 3 4
              1
# 1010 "project/radare2/libr/core/cmd_write.c"
                  ;
    }
   }
  } else {
   
# 1014 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 1014 "project/radare2/libr/core/cmd_write.c"
  "Usage: wen [len]\n"
# 1014 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 1014 "project/radare2/libr/core/cmd_write.c"
                                ;
   cmd_suc = 
# 1015 "project/radare2/libr/core/cmd_write.c" 3 4
            1
# 1015 "project/radare2/libr/core/cmd_write.c"
                ;
  }
  break;
 case 'N':
...
# 1027 "project/radare2/libr/core/cmd_write.c" 3 4
   unsigned long long 
# 1027 "project/radare2/libr/core/cmd_write.c"
        cur_off = core->offset;
    cmd_suc = r_core_extend_at (core, addr, len);
    if (cmd_suc) {
     r_core_seek (core, cur_off, 
# 1030 "project/radare2/libr/core/cmd_write.c" 3 4
                                1
# 1030 "project/radare2/libr/core/cmd_write.c"
                                    );
     core->offset = addr;
     r_core_block_read (core);
    } else {
     
# 1034 "project/radare2/libr/core/cmd_write.c" 3 4
    fprintf(__stderrp,
# 1034 "project/radare2/libr/core/cmd_write.c"
    "r_io_extend failed\n"
# 1034 "project/radare2/libr/core/cmd_write.c" 3 4
    )
# 1034 "project/radare2/libr/core/cmd_write.c"
   ...
   cmd_suc = 
# 1037 "project/radare2/libr/core/cmd_write.c" 3 4
            1
# 1037 "project/radare2/libr/core/cmd_write.c"
                ;
  }
  break;
 case 'x':
  if (input[1] == ' ') {
   ...
   bytes = len > 1? malloc (len+1) : 
# 1044 "project/radare2/libr/core/cmd_write.c" 3 4
                                    ((void *)0)
# 1044 "project/radare2/libr/core/cmd_write.c"
                                        ;
   len = bytes ? r_hex_str2bin (input, bytes) : 0;
   if (len > 0) {
    
# 1047 "project/radare2/libr/core/cmd_write.c" 3 4
   unsigned long long 
# 1047 "project/radare2/libr/core/cmd_write.c"
        cur_off = core->offset;
 ...
 case 's':
  ...
  if (len > 0) {
   ...
   p = strtok (
# 1075 "project/radare2/libr/core/cmd_write.c" 3 4
              ((void *)0)
# 1075 "project/radare2/libr/core/cmd_write.c"
                  , " ");
   dist = p && *p ? r_num_math (core->num, p) : 0;

   p = strtok (
# 1078 "project/radare2/libr/core/cmd_write.c" 3 4
              ((void *)0)
# 1078 "project/radare2/libr/core/cmd_write.c"
                  , " ");
   b_size = p && *p ? r_num_math (core->num, p) : 0;
   if (dist != 0){
    r_core_shift_block (core, addr, b_size, dist);
    r_core_seek (core, addr, 
# 1082 "project/radare2/libr/core/cmd_write.c" 3 4
                            1
# 1082 "project/radare2/libr/core/cmd_write.c"
                                );
    cmd_suc = 
# 1083 "project/radare2/libr/core/cmd_write.c" 3 4
             1
# 1083 "project/radare2/libr/core/cmd_write.c"
                 ;
   }
  }
  free (input_shadow);
 ...
 case 'X':
  if (input[1] == ' ') {
   ...
   len = *input ? strlen (input) : 0;
   bytes = len > 1? malloc (len+1) : 
# 1095 "project/radare2/libr/core/cmd_write.c" 3 4
                                    ((void *)0)
# 1095 "project/radare2/libr/core/cmd_write.c"
                                        ;
   len = bytes ? r_hex_str2bin (input, bytes) : 0;
   if (len > 0) {
...
# 1105 "project/radare2/libr/core/cmd_write.c" 3 4
    fprintf(__stderrp,
# 1105 "project/radare2/libr/core/cmd_write.c"
    "r_io_extend failed\n"
# 1105 "project/radare2/libr/core/cmd_write.c" 3 4
    )
# 1105 "project/radare2/libr/core/cmd_write.c"
 ...
 default:
  cmd_suc = 
# 1115 "project/radare2/libr/core/cmd_write.c" 3 4
           0
# 1115 "project/radare2/libr/core/cmd_write.c"
                ;
  break;
 }
 if (cmd_suc == 
# 1118 "project/radare2/libr/core/cmd_write.c" 3 4
               0
# 1118 "project/radare2/libr/core/cmd_write.c"
                    ) {
...
static int wp_handler_old(void *data, const char *input) {
 ...
 if (input[0] == '-' || (input[0] == ' ' && input[1] == '-')) {
  char *out = r_core_editor (core, 
# 1127 "project/radare2/libr/core/cmd_write.c" 3 4
                                  ((void *)0)
# 1127 "project/radare2/libr/core/cmd_write.c"
                                      , 
# 1127 "project/radare2/libr/core/cmd_write.c" 3 4
                                        ((void *)0)
# 1127 "project/radare2/libr/core/cmd_write.c"
  ...
  if (input[0] == ' ' && input[1]) {
   char *data = r_file_slurp (input + 1, 
# 1134 "project/radare2/libr/core/cmd_write.c" 3 4
                                        ((void *)0)
# 1134 "project/radare2/libr/core/cmd_write.c"
                                            );
   if (data) {
...
static int wu_handler_old(void *data, const char *input) {
 ...
 if (input[0]==' ') {
  char *data = r_file_slurp (input+1, 
# 1149 "project/radare2/libr/core/cmd_write.c" 3 4
                                     ((void *)0)
# 1149 "project/radare2/libr/core/cmd_write.c"
                                         );
  if (data) {
   int i;
   char sign = ' ';
...
# 1186 "project/radare2/libr/core/cmd_write.c" 3 4
            fprintf(__stderrp,
# 1186 "project/radare2/libr/core/cmd_write.c"
            "food\n"
# 1186 "project/radare2/libr/core/cmd_write.c" 3 4
            )
# 1186 "project/radare2/libr/core/cmd_write.c"
...
# 1198 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 1198 "project/radare2/libr/core/cmd_write.c"
 "|Usage: wu [unified-diff-patch]    # see 'cu'\n"
# 1198 "project/radare2/libr/core/cmd_write.c" 3 4
 )
# 1198 "project/radare2/libr/core/cmd_write.c"
                                                            ;
...
# 1206 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned long long 
# 1206 "project/radare2/libr/core/cmd_write.c"
     off = r_num_math (core->num, input);
 int len = (int)off;
 if (len > 0) {
  
# 1209 "project/radare2/libr/core/cmd_write.c" 3 4
 unsigned char 
# 1209 "project/radare2/libr/core/cmd_write.c"
     *buf = malloc (len);
  if (buf != 
# 1210 "project/radare2/libr/core/cmd_write.c" 3 4
            ((void *)0)
# 1210 "project/radare2/libr/core/cmd_write.c"
                ) {
   int i;
   r_num_irand ();
   for (i = 0; i < len; i++)
...
# 1221 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 1221 "project/radare2/libr/core/cmd_write.c"
  "Cannot allocate %d byte(s)\n", len
# 1221 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 1221 "project/radare2/libr/core/cmd_write.c"
...
# 1234 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 1234 "project/radare2/libr/core/cmd_write.c"
  "modify (%c)=%s\n", input[1], input + 3
# 1234 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 1234 "project/radare2/libr/core/cmd_write.c"
...
# 1237 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 1237 "project/radare2/libr/core/cmd_write.c"
  "len=%d\n", len
# 1237 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 1237 "project/radare2/libr/core/cmd_write.c"
...
# 1244 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 1244 "project/radare2/libr/core/cmd_write.c"
   "r_asm_modify = %d\n", len
# 1244 "project/radare2/libr/core/cmd_write.c" 3 4
   )
# 1244 "project/radare2/libr/core/cmd_write.c"
...
# 1246 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 1246 "project/radare2/libr/core/cmd_write.c"
  "Usage: wA [type] [value]\n"
# 1246 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 1246 "project/radare2/libr/core/cmd_write.c"
...
static char *__current_filename(RCore *core) {
 ...
 return 
# 1264 "project/radare2/libr/core/cmd_write.c" 3 4
       ((void *)0)
# 1264 "project/radare2/libr/core/cmd_write.c"
           ;
}

static 
# 1267 "project/radare2/libr/core/cmd_write.c" 3 4
      unsigned long long 
# 1267 "project/radare2/libr/core/cmd_write.c"
           __va2pa(RCore *core, 
# 1267 "project/radare2/libr/core/cmd_write.c" 3 4
                                unsigned long long 
# 1267 "project/radare2/libr/core/cmd_write.c"
...
# 1278 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 1278 "project/radare2/libr/core/cmd_write.c"
...
# 1282 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned char 
# 1282 "project/radare2/libr/core/cmd_write.c"
    *sfb = (
# 1282 "project/radare2/libr/core/cmd_write.c" 3 4
            unsigned char
# 1282 "project/radare2/libr/core/cmd_write.c"
               *)r_file_slurp (sfn, &sfs);
 if (sfb) {
  void **iter;
  
# 1285 "project/radare2/libr/core/cmd_write.c" 3 4
 for (
# 1285 "project/radare2/libr/core/cmd_write.c"
 iter 
# 1285 "project/radare2/libr/core/cmd_write.c" 3 4
 = (void **)(
# 1285 "project/radare2/libr/core/cmd_write.c"
...
# 1285 "project/radare2/libr/core/cmd_write.c"
   ...
   RIOCache *c = *iter;
   const 
# 1287 "project/radare2/libr/core/cmd_write.c" 3 4
        unsigned long long 
# 1287 "project/radare2/libr/core/cmd_write.c"
             ps = r_itv_size (c->itv);
   const 
# 1288 "project/radare2/libr/core/cmd_write.c" 3 4
        unsigned long long 
# 1288 "project/radare2/libr/core/cmd_write.c"
             va = r_itv_begin (c->itv);
   const 
# 1289 "project/radare2/libr/core/cmd_write.c" 3 4
        unsigned long long 
# 1289 "project/radare2/libr/core/cmd_write.c"
             pa = __va2pa (core, va);
   if (pa + ps < sfs) {
    
# 1291 "project/radare2/libr/core/cmd_write.c" 3 4
   __builtin___memcpy_chk (
# 1291 "project/radare2/libr/core/cmd_write.c"
   sfb + pa
# 1291 "project/radare2/libr/core/cmd_write.c" 3 4
   , 
# 1291 "project/radare2/libr/core/cmd_write.c"
...
# 1293 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 1293 "project/radare2/libr/core/cmd_write.c"
   "Out of bounds patch at 0x%08"
# 1293 "project/radare2/libr/core/cmd_write.c" 3 4
   "llx"
# 1293 "project/radare2/libr/core/cmd_write.c"
   "\n", pa
...
# 1293 "project/radare2/libr/core/cmd_write.c"
  ...
  r_file_dump (dfn, sfb, sfs, 
# 1297 "project/radare2/libr/core/cmd_write.c" 3 4
                             0
# 1297 "project/radare2/libr/core/cmd_write.c"
                                  );
  free (sfb);
 }
 free (sfn);
...
# 1318 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 1318 "project/radare2/libr/core/cmd_write.c"
  "Usage: wcf [file]\n"
# 1318 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 1318 "project/radare2/libr/core/cmd_write.c"
...
# 1327 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 1327 "project/radare2/libr/core/cmd_write.c"
  "TODO\n"
# 1327 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 1327 "project/radare2/libr/core/cmd_write.c"
...
# 1330 "project/radare2/libr/core/cmd_write.c" 3 4
  unsigned long long 
# 1330 "project/radare2/libr/core/cmd_write.c"
       to, from;
...
# 1336 "project/radare2/libr/core/cmd_write.c" 3 4
    fprintf(__stderrp,
# 1336 "project/radare2/libr/core/cmd_write.c"
...
# 1344 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 1344 "project/radare2/libr/core/cmd_write.c"
  "Invalidate write cache at 0x%08"
# 1344 "project/radare2/libr/core/cmd_write.c" 3 4
  "llx"
# 1344 "project/radare2/libr/core/cmd_write.c"
  "\n", core->offset
...
# 1353 "project/radare2/libr/core/cmd_write.c" 3 4
 unsigned long long 
# 1353 "project/radare2/libr/core/cmd_write.c"
      from, to;
  if (input[1]==' ') {
   char *p = strchr (input+2, ' ');
   if (p) {
...
# 1361 "project/radare2/libr/core/cmd_write.c" 3 4
    fprintf(__stderrp,
# 1361 "project/radare2/libr/core/cmd_write.c"
    "Invalid range (from>to)\n"
# 1361 "project/radare2/libr/core/cmd_write.c" 3 4
    )
# 1361 "project/radare2/libr/core/cmd_write.c"
...
# 1369 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 1369 "project/radare2/libr/core/cmd_write.c"
  "Invalidate write cache at 0x%08"
# 1369 "project/radare2/libr/core/cmd_write.c" 3 4
  "llx"
# 1369 "project/radare2/libr/core/cmd_write.c"
...
# 1373 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 1373 "project/radare2/libr/core/cmd_write.c"
 "invalidated %d cache(s)\n", r_io_cache_invalidate (core->io, from, to)
# 1373 "project/radare2/libr/core/cmd_write.c" 3 4
 )
                                              
# 1374 "project/radare2/libr/core/cmd_write.c"
                                             ;
  r_core_block_read (core);
  break;
 }
 case 'i':
  r_io_cache_commit (core->io, 0, 
# 1379 "project/radare2/libr/core/cmd_write.c" 3 4
                                 0xFFFFFFFFFFFFFFFFULL
# 1379 "project/radare2/libr/core/cmd_write.c"
                                         );
  r_core_block_read (core);
  break;
 case 'j':
...
# 1393 "project/radare2/libr/core/cmd_write.c" 3 4
 __builtin___memset_chk (
# 1393 "project/radare2/libr/core/cmd_write.c"
 core->block
# 1393 "project/radare2/libr/core/cmd_write.c" 3 4
 , 
# 1393 "project/radare2/libr/core/cmd_write.c"
...
static void w_handler_common(RCore *core, const char *input) {
 ...
 if (!r_core_write_at (core, core->offset, (const 
# 1405 "project/radare2/libr/core/cmd_write.c" 3 4
                                                 unsigned char 
# 1405 "project/radare2/libr/core/cmd_write.c"
                                                     *)str, len)) {
  cmd_write_fail (core);
 }
 free (str);
...
static int wz_handler_old(void *data, const char *input) {
 ...
 int len = r_str_unescape (str);
 if (!r_core_write_at (core, core->offset, (const 
# 1425 "project/radare2/libr/core/cmd_write.c" 3 4
                                                 unsigned char 
# 1425 "project/radare2/libr/core/cmd_write.c"
                                                     *)str + 1, len)) {
  cmd_write_fail (core);
 }
 if (len > 0) {
 ...
 if (wseek)r_core_seek_delta (core,len + 1);
 r_core_block_read (core);
 return 0;
}
...
static int wt_handler_old(void *data, const char *input) {
 ...
 char *ostr = str;
 char *hfilename = 
# 1445 "project/radare2/libr/core/cmd_write.c" 3 4
                  ((void *)0)
# 1445 "project/radare2/libr/core/cmd_write.c"
                      ;
 const char *filename = "";
 char _fn[32];
 _fn[0] = 0;
...
# 1452 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 1452 "project/radare2/libr/core/cmd_write.c"
  "Write to server\n"
# 1452 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 1452 "project/radare2/libr/core/cmd_write.c"
...
# 1453 "project/radare2/libr/core/cmd_write.c" 3 4
  long long 
# 1453 "project/radare2/libr/core/cmd_write.c"
       sz = r_io_size (core->io);
   if (sz > 0) {
    
# 1455 "project/radare2/libr/core/cmd_write.c" 3 4
   unsigned long long 
# 1455 "project/radare2/libr/core/cmd_write.c"
        addr = 0;
    char *host = str + 2;
    char *port = strchr (host, ':');
    if (port) {
...
# 1466 "project/radare2/libr/core/cmd_write.c" 3 4
    unsigned char 
# 1466 "project/radare2/libr/core/cmd_write.c"
        *buf = calloc (1, sz);
     r_io_read_at (core->io, addr, buf, sz);
     RSocket *s = r_socket_new (
# 1468 "project/radare2/libr/core/cmd_write.c" 3 4
                               0
# 1468 "project/radare2/libr/core/cmd_write.c"
                                    );
     if (r_socket_connect (s, host, port, 
# 1469 "project/radare2/libr/core/cmd_write.c" 3 4
                                         6
# 1469 "project/radare2/libr/core/cmd_write.c"
                                                           , 0)) {
      int done = 0;
      
# 1471 "project/radare2/libr/core/cmd_write.c" 3 4
     fprintf(__stderrp,
# 1471 "project/radare2/libr/core/cmd_write.c"
     "Transfering file to the end-point...\n"
# 1471 "project/radare2/libr/core/cmd_write.c" 3 4
     )
# 1471 "project/radare2/libr/core/cmd_write.c"
                                                       ;
...
# 1475 "project/radare2/libr/core/cmd_write.c" 3 4
       fprintf(__stderrp,
# 1475 "project/radare2/libr/core/cmd_write.c"
       "oops\n"
# 1475 "project/radare2/libr/core/cmd_write.c" 3 4
       )
# 1475 "project/radare2/libr/core/cmd_write.c"
...
# 1481 "project/radare2/libr/core/cmd_write.c" 3 4
     fprintf(__stderrp,
# 1481 "project/radare2/libr/core/cmd_write.c"
     "Cannot connect\n"
# 1481 "project/radare2/libr/core/cmd_write.c" 3 4
     )
# 1481 "project/radare2/libr/core/cmd_write.c"
...
# 1486 "project/radare2/libr/core/cmd_write.c" 3 4
    fprintf(__stderrp,
# 1486 "project/radare2/libr/core/cmd_write.c"
    "Usage wts host:port [sz]\n"
# 1486 "project/radare2/libr/core/cmd_write.c" 3 4
    )
# 1486 "project/radare2/libr/core/cmd_write.c"
                                          ;
...
# 1489 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 1489 "project/radare2/libr/core/cmd_write.c"
   "Unknown file size\n"
# 1489 "project/radare2/libr/core/cmd_write.c" 3 4
   )
# 1489 "project/radare2/libr/core/cmd_write.c"
...
# 1492 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 1492 "project/radare2/libr/core/cmd_write.c"
  "Usage wts host:port [sz]\n"
# 1492 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 1492 "project/radare2/libr/core/cmd_write.c"
...
# 1499 "project/radare2/libr/core/cmd_write.c" 3 4
 _Bool 
# 1499 "project/radare2/libr/core/cmd_write.c"
      append = 
# 1499 "project/radare2/libr/core/cmd_write.c" 3 4
               0
# 1499 "project/radare2/libr/core/cmd_write.c"
...
# 1500 "project/radare2/libr/core/cmd_write.c" 3 4
 _Bool 
# 1500 "project/radare2/libr/core/cmd_write.c"
      toend = 
# 1500 "project/radare2/libr/core/cmd_write.c" 3 4
              0
# 1500 "project/radare2/libr/core/cmd_write.c"
...
# 1501 "project/radare2/libr/core/cmd_write.c" 3 4
 long long 
# 1501 "project/radare2/libr/core/cmd_write.c"
      sz = core->blocksize;
  
# 1502 "project/radare2/libr/core/cmd_write.c" 3 4
 unsigned long long 
# 1502 "project/radare2/libr/core/cmd_write.c"
      poff = core->offset;
  if (*str == 'f') {
   str++;
   if (*str == '?') {
   ...
   if (*str == '!') {
    ...
    toend = 
# 1515 "project/radare2/libr/core/cmd_write.c" 3 4
           1
# 1515 "project/radare2/libr/core/cmd_write.c"
               ;

    poff = map ? poff - 
# 1517 "project/radare2/libr/core/cmd_write.c" 3 4
                       r_itv_begin (
# 1517 "project/radare2/libr/core/cmd_write.c"
                       map
# 1517 "project/radare2/libr/core/cmd_write.c" 3 4
                       ->itv) 
# 1517 "project/radare2/libr/core/cmd_write.c"
   ...
   if (*str == 'f') {
    ...
    str++;
    filename = r_str_newf ("%s-0x%08"
# 1530 "project/radare2/libr/core/cmd_write.c" 3 4
                                    "llx"
# 1530 "project/radare2/libr/core/cmd_write.c"
                                           , prefix, core->offset);
   } else {
    if (*str) {
     if (str[1] == '?') {
     ...
     if (r_str_startswith (filename, "base64:")) {
      ...
      char *decoded = (char *)sdb_decode (encoded, 
# 1540 "project/radare2/libr/core/cmd_write.c" 3 4
                                                  ((void *)0)
# 1540 "project/radare2/libr/core/cmd_write.c"
                                                      );
      if (decoded) {
       hfilename = decoded;
       filename = decoded;
...
# 1557 "project/radare2/libr/core/cmd_write.c" 3 4
   __builtin___snprintf_chk (
# 1557 "project/radare2/libr/core/cmd_write.c"
   _fn
# 1557 "project/radare2/libr/core/cmd_write.c" 3 4
   , 
# 1557 "project/radare2/libr/core/cmd_write.c"
...
# 1562 "project/radare2/libr/core/cmd_write.c" 3 4
  __builtin___snprintf_chk (
# 1562 "project/radare2/libr/core/cmd_write.c"
  _fn
# 1562 "project/radare2/libr/core/cmd_write.c" 3 4
  , 
# 1562 "project/radare2/libr/core/cmd_write.c"
...
# 1562 "project/radare2/libr/core/cmd_write.c"
  ...
  size_sep = *str? strchr (str + 1, ' ') : 
# 1567 "project/radare2/libr/core/cmd_write.c" 3 4
                                          ((void *)0)
# 1567 "project/radare2/libr/core/cmd_write.c"
                                              ;
  if (!filename || !*filename) {
   const char* prefix = r_config_get (core->config, "cfg.prefixdump");
   
# 1570 "project/radare2/libr/core/cmd_write.c" 3 4
  __builtin___snprintf_chk (
# 1570 "project/radare2/libr/core/cmd_write.c"
  _fn
# 1570 "project/radare2/libr/core/cmd_write.c" 3 4
  , 
# 1570 "project/radare2/libr/core/cmd_write.c"
...
# 1579 "project/radare2/libr/core/cmd_write.c" 3 4
    fprintf(__stderrp,
# 1579 "project/radare2/libr/core/cmd_write.c"
    "Warning: File size is unknown."
# 1579 "project/radare2/libr/core/cmd_write.c" 3 4
    )
# 1579 "project/radare2/libr/core/cmd_write.c"
                                              ;
    ...
    sz = (
# 1582 "project/radare2/libr/core/cmd_write.c" 3 4
         long long
# 1582 "project/radare2/libr/core/cmd_write.c"
             ) r_num_math (core->num, size_sep + 1);

    if (sz < 1) {
     
# 1585 "project/radare2/libr/core/cmd_write.c" 3 4
    fprintf(__stderrp,
# 1585 "project/radare2/libr/core/cmd_write.c"
...
# 1596 "project/radare2/libr/core/cmd_write.c" 3 4
     fprintf(__stderrp,
# 1596 "project/radare2/libr/core/cmd_write.c"
     "Alias \"$%s\" is a command - will not attempt to append.\n", filename+1
# 1596 "project/radare2/libr/core/cmd_write.c" 3 4
     )
# 1596 "project/radare2/libr/core/cmd_write.c"
                                                                                       ;
    ...
    if (sz > 0 && !r_core_dump (core, filename, poff, (
# 1605 "project/radare2/libr/core/cmd_write.c" 3 4
                                                      unsigned long long
# 1605 "project/radare2/libr/core/cmd_write.c"
                                                          )sz, append)) {
     sz = -1;
    }
   }
...
# 1613 "project/radare2/libr/core/cmd_write.c" 3 4
    fprintf(__stderrp,
# 1613 "project/radare2/libr/core/cmd_write.c"
    "Warning: File size is unknown."
# 1613 "project/radare2/libr/core/cmd_write.c" 3 4
    )
# 1613 "project/radare2/libr/core/cmd_write.c"
    ...
    if (sz != -1 && core->offset <= sz) {
     sz -= core->offset;
     if (!r_core_dump (core, filename, core->offset, (
# 1617 "project/radare2/libr/core/cmd_write.c" 3 4
                                                     unsigned long long
# 1617 "project/radare2/libr/core/cmd_write.c"
                                                         )sz, append)) {
      sz = -1;
     }
    } else {
...
# 1627 "project/radare2/libr/core/cmd_write.c" 3 4
      fprintf(__stderrp,
# 1627 "project/radare2/libr/core/cmd_write.c"
      "Alias \"$%s\" is a command - will not attempt to append.\n", filename+1
# 1627 "project/radare2/libr/core/cmd_write.c" 3 4
      )
# 1627 "project/radare2/libr/core/cmd_write.c"
...
# 1640 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 1640 "project/radare2/libr/core/cmd_write.c"
  "Dumped %"
# 1640 "project/radare2/libr/core/cmd_write.c" 3 4
  "lld"
# 1640 "project/radare2/libr/core/cmd_write.c"
...
# 1641 "project/radare2/libr/core/cmd_write.c"
                       ;
  }
 }
 free (ostr);
...
static int ww_handler_old(void *data, const char *input) {
 ...
 str++;
 len = (len - 1) << 1;
 char *tmp = (len > 0) ? malloc (len + 1) : 
# 1660 "project/radare2/libr/core/cmd_write.c" 3 4
                                           ((void *)0)
# 1660 "project/radare2/libr/core/cmd_write.c"
                                               ;
 if (tmp) {
  int i;
  for (i = 0; i < len; i++) {
  ...
  if (!r_io_write_at (core->io, core->offset, (const 
# 1673 "project/radare2/libr/core/cmd_write.c" 3 4
                                                    unsigned char 
# 1673 "project/radare2/libr/core/cmd_write.c"
                                                        *)str, len)) {
   
# 1674 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 1674 "project/radare2/libr/core/cmd_write.c"
  "r_io_write_at failed at 0x%08" 
# 1674 "project/radare2/libr/core/cmd_write.c" 3 4
  "llx" 
# 1674 "project/radare2/libr/core/cmd_write.c"
...
# 1680 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 1680 "project/radare2/libr/core/cmd_write.c"
 "Cannot malloc %d\n", len
# 1680 "project/radare2/libr/core/cmd_write.c" 3 4
 )
# 1680 "project/radare2/libr/core/cmd_write.c"
...
# 1689 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned char 
# 1689 "project/radare2/libr/core/cmd_write.c"
    *buf;
 int size;
 switch (input[0]) {
 case ' ':
...
# 1699 "project/radare2/libr/core/cmd_write.c" 3 4
  unsigned char 
# 1699 "project/radare2/libr/core/cmd_write.c"
      *out;
   char *in = r_core_editor (core, 
# 1700 "project/radare2/libr/core/cmd_write.c" 3 4
                                  ((void *)0)
# 1700 "project/radare2/libr/core/cmd_write.c"
                                      , 
# 1700 "project/radare2/libr/core/cmd_write.c" 3 4
                                        ((void *)0)
# 1700 "project/radare2/libr/core/cmd_write.c"
   ...
   if (in) {
    out = (
# 1702 "project/radare2/libr/core/cmd_write.c" 3 4
          unsigned char 
# 1702 "project/radare2/libr/core/cmd_write.c"
              *)strdup (in);
    if (out) {
...
# 1707 "project/radare2/libr/core/cmd_write.c" 3 4
      fprintf(__stderrp,
# 1707 "project/radare2/libr/core/cmd_write.c"
      "r_io_write_at failed at 0x%08"
# 1707 "project/radare2/libr/core/cmd_write.c" 3 4
      "llx"
# 1707 "project/radare2/libr/core/cmd_write.c"
...
# 1724 "project/radare2/libr/core/cmd_write.c" 3 4
    fprintf(__stderrp,
# 1724 "project/radare2/libr/core/cmd_write.c"
    "r_io_write_at failed at 0x%08"
# 1724 "project/radare2/libr/core/cmd_write.c" 3 4
    "llx"
# 1724 "project/radare2/libr/core/cmd_write.c"
...
# 1729 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 1729 "project/radare2/libr/core/cmd_write.c"
   "This file doesnt contains hexpairs\n"
# 1729 "project/radare2/libr/core/cmd_write.c" 3 4
   )
# 1729 "project/radare2/libr/core/cmd_write.c"
                                                   ;
...
# 1732 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 1732 "project/radare2/libr/core/cmd_write.c"
  "Cannot open file '%s'\n", arg
# 1732 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 1732 "project/radare2/libr/core/cmd_write.c"
...
# 1781 "project/radare2/libr/core/cmd_write.c" 3 4
   unsigned long long 
# 1781 "project/radare2/libr/core/cmd_write.c"
        at = core->offset;
repeat:
    if (!r_anal_op (core->anal, &analop, at, core->block + delta, core->blocksize - delta, R_ANAL_OP_MASK_BASIC)) {
     
# 1784 "project/radare2/libr/core/cmd_write.c" 3 4
    fprintf(__stderrp,
# 1784 "project/radare2/libr/core/cmd_write.c"
    "Invalid instruction?\n"
# 1784 "project/radare2/libr/core/cmd_write.c" 3 4
    )
# 1784 "project/radare2/libr/core/cmd_write.c"
    ...
    if (delta < acode->len) {
     ...
     r_core_cmdf (core, "wao nop @ 0x%08"
# 1792 "project/radare2/libr/core/cmd_write.c" 3 4
                                        "llx"
# 1792 "project/radare2/libr/core/cmd_write.c"
                                               , at);
     goto repeat;
    }
    r_anal_op_fini (&analop);
...
# 1801 "project/radare2/libr/core/cmd_write.c" 3 4
    fprintf(__stderrp,
# 1801 "project/radare2/libr/core/cmd_write.c"
    "Invalid instruction?\n"
# 1801 "project/radare2/libr/core/cmd_write.c" 3 4
    )
# 1801 "project/radare2/libr/core/cmd_write.c"
...
# 1805 "project/radare2/libr/core/cmd_write.c" 3 4
    fprintf(__stderrp,
# 1805 "project/radare2/libr/core/cmd_write.c"
    "Doesnt fit\n"
# 1805 "project/radare2/libr/core/cmd_write.c" 3 4
    )
# 1805 "project/radare2/libr/core/cmd_write.c"
...
# 1822 "project/radare2/libr/core/cmd_write.c" 3 4
      fprintf(__stderrp,
# 1822 "project/radare2/libr/core/cmd_write.c"
      "Written %d byte(s) (%s) = wx %s\n", acode->len, input+1, hex
# 1822 "project/radare2/libr/core/cmd_write.c" 3 4
      )
# 1822 "project/radare2/libr/core/cmd_write.c"
                                                                             ;
      }
      if (wseek)r_core_seek_delta (core,acode->len);
     }
     r_core_block_read (core);
    }
    free (hex);
...
# 1830 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 1830 "project/radare2/libr/core/cmd_write.c"
   "Nothing to do.\n"
# 1830 "project/radare2/libr/core/cmd_write.c" 3 4
   )
# 1830 "project/radare2/libr/core/cmd_write.c"
 ...
 case 'f':
  if ((input[1] == ' ' || input[1] == '*')) {
   ...
   char *src = r_file_slurp (file, 
# 1841 "project/radare2/libr/core/cmd_write.c" 3 4
                                  ((void *)0)
# 1841 "project/radare2/libr/core/cmd_write.c"
                                      );
   if (src) {
    
# 1843 "project/radare2/libr/core/cmd_write.c" 3 4
   unsigned long long 
# 1843 "project/radare2/libr/core/cmd_write.c"
        addr = core->offset, nextaddr = addr;
    char *a, *b = src;
    do {
     a = strstr (b, ".offset ");
     if (a) {
...
# 1871 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 1871 "project/radare2/libr/core/cmd_write.c"
   "Cannot open '%s'\n", file
# 1871 "project/radare2/libr/core/cmd_write.c" 3 4
   )
# 1871 "project/radare2/libr/core/cmd_write.c"
...
# 1874 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 1874 "project/radare2/libr/core/cmd_write.c"
  "Wrong argument\n"
# 1874 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 1874 "project/radare2/libr/core/cmd_write.c"
 ...
 case 'F':
  if ((input[1] == ' ' || input[1] == '*')) {
   const char *file = input + ((input[1] == '*')? 3: 2);
   r_asm_set_pc (core->rasm, core->offset);
   char *f = r_file_slurp (file, 
# 1881 "project/radare2/libr/core/cmd_write.c" 3 4
                                ((void *)0)
# 1881 "project/radare2/libr/core/cmd_write.c"
                                    );
   if (f) {
...
# 1890 "project/radare2/libr/core/cmd_write.c" 3 4
      fprintf(__stderrp,
# 1890 "project/radare2/libr/core/cmd_write.c"
      "Written %d byte(s) (%s)=wx %s\n", acode->len, input, hex
# 1890 "project/radare2/libr/core/cmd_write.c" 3 4
      )
# 1890 "project/radare2/libr/core/cmd_write.c"
...
# 1902 "project/radare2/libr/core/cmd_write.c" 3 4
    fprintf(__stderrp,
# 1902 "project/radare2/libr/core/cmd_write.c"
    "Cannot assemble file\n"
# 1902 "project/radare2/libr/core/cmd_write.c" 3 4
    )
# 1902 "project/radare2/libr/core/cmd_write.c"
                                      ;
...
# 1905 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 1905 "project/radare2/libr/core/cmd_write.c"
   "Cannot slurp '%s'\n", file
# 1905 "project/radare2/libr/core/cmd_write.c" 3 4
   )
# 1905 "project/radare2/libr/core/cmd_write.c"
...
# 1908 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 1908 "project/radare2/libr/core/cmd_write.c"
  "Wrong argument\n"
# 1908 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 1908 "project/radare2/libr/core/cmd_write.c"
...
# 1922 "project/radare2/libr/core/cmd_write.c" 3 4
unsigned char 
# 1922 "project/radare2/libr/core/cmd_write.c"
    *buf = malloc (buf_size);
 int wseek = r_config_get_i (core->config, "cfg.wseek");
 if (buf) {
  ...
  if (len > 0) {
   ...
   if (!r_core_write_at (core, core->offset, core->block, core->blocksize)) {
    ...
    if (wseek)r_core_seek_delta (core,core->blocksize);
   }
   r_core_block_read (core);
  } else {
   
# 1935 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 1935 "project/radare2/libr/core/cmd_write.c"
  "Wrong argument\n"
# 1935 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 1935 "project/radare2/libr/core/cmd_write.c"
...
# 1939 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 1939 "project/radare2/libr/core/cmd_write.c"
 "Cannot malloc %zd\n", buf_size
# 1939 "project/radare2/libr/core/cmd_write.c" 3 4
 )
# 1939 "project/radare2/libr/core/cmd_write.c"
...
static int wm_handler_old(void *data, const char *input) {
 RCore *core = (RCore *)data;
 char *str = strdup (input);
 int size = r_hex_str2bin (input, (
# 1947 "project/radare2/libr/core/cmd_write.c" 3 4
                                  unsigned char 
# 1947 "project/radare2/libr/core/cmd_write.c"
                                      *)str);
 int wseek = r_config_get_i (core->config, "cfg.wseek");
 switch (input[0]) {
 case '\0':
  
# 1951 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 1951 "project/radare2/libr/core/cmd_write.c"
 "TODO: Display current write mask"
# 1951 "project/radare2/libr/core/cmd_write.c" 3 4
 )
# 1951 "project/radare2/libr/core/cmd_write.c"
                                             ;
...
# 1957 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 1957 "project/radare2/libr/core/cmd_write.c"
 "Write mask disabled\n"
# 1957 "project/radare2/libr/core/cmd_write.c" 3 4
 )
# 1957 "project/radare2/libr/core/cmd_write.c"
 ...
 case ' ':
  if (size > 0) {
   r_io_use_fd (core->io, core->io->desc->fd);
   r_io_set_write_mask (core->io, (const 
# 1962 "project/radare2/libr/core/cmd_write.c" 3 4
                                        unsigned char 
# 1962 "project/radare2/libr/core/cmd_write.c"
                                            *)str, size);
   if (wseek)r_core_seek_delta (core,size);
   
# 1964 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 1964 "project/radare2/libr/core/cmd_write.c"
  "Write mask set to '"
# 1964 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 1964 "project/radare2/libr/core/cmd_write.c"
...
# 1967 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 1967 "project/radare2/libr/core/cmd_write.c"
   "%02x", str[i]
# 1967 "project/radare2/libr/core/cmd_write.c" 3 4
   )
# 1967 "project/radare2/libr/core/cmd_write.c"
...
# 1969 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 1969 "project/radare2/libr/core/cmd_write.c"
  "'\n"
# 1969 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 1969 "project/radare2/libr/core/cmd_write.c"
...
# 1971 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 1971 "project/radare2/libr/core/cmd_write.c"
  "Invalid string\n"
# 1971 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 1971 "project/radare2/libr/core/cmd_write.c"
...
# 1985 "project/radare2/libr/core/cmd_write.c" 3 4
  unsigned long long 
# 1985 "project/radare2/libr/core/cmd_write.c"
       addr = r_num_math (core->num, input + 1);
   
# 1986 "project/radare2/libr/core/cmd_write.c" 3 4
  unsigned long long 
# 1986 "project/radare2/libr/core/cmd_write.c"
       len = r_num_math (core->num, arg + 1);
   
# 1987 "project/radare2/libr/core/cmd_write.c" 3 4
  unsigned char 
# 1987 "project/radare2/libr/core/cmd_write.c"
      *data = malloc (len);
   r_io_read_at (core->io, addr, data, len);
   if (!r_io_write_at (core->io, core->offset, data, len)) {
    
# 1990 "project/radare2/libr/core/cmd_write.c" 3 4
   fprintf(__stderrp,
# 1990 "project/radare2/libr/core/cmd_write.c"
   "r_io_write_at failed at 0x%08" 
# 1990 "project/radare2/libr/core/cmd_write.c" 3 4
   "llx" 
# 1990 "project/radare2/libr/core/cmd_write.c"
...
# 1994 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 1994 "project/radare2/libr/core/cmd_write.c"
  "See wd?\n"
# 1994 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 1994 "project/radare2/libr/core/cmd_write.c"
...
# 1998 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 1998 "project/radare2/libr/core/cmd_write.c"
 "Usage: wd [source-offset] [length] @ [dest-offset]\n"
# 1998 "project/radare2/libr/core/cmd_write.c" 3 4
 )
# 1998 "project/radare2/libr/core/cmd_write.c"
                                                                 ;
...
# 2009 "project/radare2/libr/core/cmd_write.c" 3 4
  fprintf(__stderrp,
# 2009 "project/radare2/libr/core/cmd_write.c"
  "Too large\n"
# 2009 "project/radare2/libr/core/cmd_write.c" 3 4
  )
# 2009 "project/radare2/libr/core/cmd_write.c"
...
# 2011 "project/radare2/libr/core/cmd_write.c" 3 4
  unsigned char 
# 2011 "project/radare2/libr/core/cmd_write.c"
      ulen = (
# 2011 "project/radare2/libr/core/cmd_write.c" 3 4
              unsigned char
# 2011 "project/radare2/libr/core/cmd_write.c"
   ...
   if (!r_core_write_at (core, core->offset, &ulen, 1) ||
    !r_core_write_at (core, core->offset + 1, (const 
# 2013 "project/radare2/libr/core/cmd_write.c" 3 4
                                                    unsigned char 
# 2013 "project/radare2/libr/core/cmd_write.c"
                                                        *)str + 1, len)) {
    cmd_write_fail (core);
   } else {
    if (wseek)r_core_seek_delta (core,len);
...
# 2021 "project/radare2/libr/core/cmd_write.c" 3 4
 fprintf(__stderrp,
# 2021 "project/radare2/libr/core/cmd_write.c"
 "Too short.\n"
# 2021 "project/radare2/libr/core/cmd_write.c" 3 4
 )
# 2021 "project/radare2/libr/core/cmd_write.c"
...
static int cmd_write(void *data, const char *input) {
 ...
 case ' ':
 {
  ...
  if (
# 2092 "project/radare2/libr/core/cmd_write.c" 3 4
     (!(
# 2092 "project/radare2/libr/core/cmd_write.c"
     curcs
# 2092 "project/radare2/libr/core/cmd_write.c" 3 4
     ) || !*(
# 2092 "project/radare2/libr/core/cmd_write.c"
...
# 2099 "project/radare2/libr/core/cmd_write.c" 3 4
   unsigned char 
# 2099 "project/radare2/libr/core/cmd_write.c"
       *out = malloc (in_len * max);
    if (out) {
     *out = 0;
     r_charset_decode_str (core->print->charset, out, out_len, (const 
# 2102 "project/radare2/libr/core/cmd_write.c" 3 4
                                                                     unsigned char
# 2102 "project/radare2/libr/core/cmd_write.c"
                                                                        *) str + 1, in_len);
