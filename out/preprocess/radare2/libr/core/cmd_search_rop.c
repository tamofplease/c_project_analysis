# 0 "project/radare2/libr/core/cmd_search_rop.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/cmd_search_rop.c"
...
# 4 "project/radare2/libr/core/cmd_search_rop.c" 2
...
# 6 "project/radare2/libr/core/cmd_search_rop.c" 2





# 10 "project/radare2/libr/core/cmd_search_rop.c"
static RList* parse_list (const char *str) {
 ...
 if (!str) {
  return 
# 15 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        ((void *)0)
# 15 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 ...
 if (!list) {
  free (str_n);
  return 
# 22 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        ((void *)0)
# 22 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 line = strtok (str_n, "\n");
 data = strchr (line, '=');
 ...
 while (p) {
  ...
  p = strtok (
# 31 "project/radare2/libr/core/cmd_search_rop.c" 3 4
             ((void *)0)
# 31 "project/radare2/libr/core/cmd_search_rop.c"
                 , ",");
 }
...
static RList* get_constants(const char *str) {
 ...
 if (!str) {
  return 
# 42 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        ((void *)0)
# 42 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 ...
 while (p) {
  if (strtol (p, 
# 49 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                ((void *)0)
# 49 "project/radare2/libr/core/cmd_search_rop.c"
                    , 0)) {
   r_list_append (list, (void*)strdup (p));
  }
  p = strtok (
# 52 "project/radare2/libr/core/cmd_search_rop.c" 3 4
             ((void *)0)
# 52 "project/radare2/libr/core/cmd_search_rop.c"
                 , ",");
 }
 free (data);
 return list;
...
static 
# 58 "project/radare2/libr/core/cmd_search_rop.c" 3 4
      _Bool 
# 58 "project/radare2/libr/core/cmd_search_rop.c"
           isFlag (RRegItem *reg) {
 const char *type = r_reg_get_type (reg->type);

 if (!strcmp (type, "flg"))
  return 
# 62 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        1
# 62 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 return 
# 63 "project/radare2/libr/core/cmd_search_rop.c" 3 4
       0
# 63 "project/radare2/libr/core/cmd_search_rop.c"
            ;
}


static 
# 67 "project/radare2/libr/core/cmd_search_rop.c" 3 4
      _Bool 
# 67 "project/radare2/libr/core/cmd_search_rop.c"
           simulate_op (const char *op, 
# 67 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                        unsigned long long 
# 67 "project/radare2/libr/core/cmd_search_rop.c"
                                             src1, 
...
# 68 "project/radare2/libr/core/cmd_search_rop.c" 3 4
unsigned long long 
# 68 "project/radare2/libr/core/cmd_search_rop.c"
     limit;
 if (size == 64) {
  limit = 
# 70 "project/radare2/libr/core/cmd_search_rop.c" 3 4
         0xFFFFFFFFFFFFFFFFULL
# 70 "project/radare2/libr/core/cmd_search_rop.c"
                 ;
 } else {
  limit = 1ULL << size;
 }
  ...
  *result = src1 ^ src2;
  return 
# 77 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        1
# 77 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 if (!strcmp (op, "+")) {
  *result = src1 + src2;
  return 
# 81 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        1
# 81 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 if (!strcmp (op, "-")) {
  if (src2 > src1) {
  ...
  return 
# 89 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        1
# 89 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 if (!strcmp (op, "*")) {
  *result = src1 * src2;
  return 
# 93 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        1
# 93 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 if (!strcmp (op, "|")) {
  *result = src1 | src2;
  return 
# 97 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        1
# 97 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 if (!strcmp (op, "/")) {
  *result = src1 / src2;
  return 
# 101 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        1
# 101 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 if (!strcmp (op, "%")) {
  *result = src1 % src2;
  return 
# 105 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        1
# 105 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 if (!strcmp (op, "<<")) {
  *result = src1 << src2;
  return 
# 109 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        1
# 109 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 if (!strcmp (op, ">>")) {
  *result = src1 >> src2;
  return 
# 113 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        1
# 113 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 if (!strcmp (op, "&")) {
  *result = src1 & src2;
  return 
# 117 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        1
# 117 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 if (!strcmp (op, "+=")) {
  *result = old_src1 + src2;
  return 
# 121 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        1
# 121 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 if (!strcmp (op, "-=")) {
  if (src2 > old_src1) {
  ...
  return 
# 129 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        1
# 129 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 if (!strcmp (op, "*=")) {
  *result = old_src1 * src2;
  return 
# 133 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        1
# 133 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 if (!strcmp (op, "/=")) {
  *result = old_src1 / src2;
  return 
# 137 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        1
# 137 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 if (!strcmp (op, "%=")) {
  *result = old_src1 % src2;
  return 
# 141 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        1
# 141 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 if (!strcmp (op, "<<")) {
  *result = src1 << src2;
  return 
# 145 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        1
# 145 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 if (!strcmp (op, ">>")) {
  *result = src1 >> src2;
  return 
# 149 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        1
# 149 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 if (!strcmp (op, "&=")) {
  *result = src1 & src2;
  return 
# 153 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        1
# 153 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 if (!strcmp (op, "^=")) {
  *result = src1 ^ src2;
  return 
# 157 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        1
# 157 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 if (!strcmp (op, "|=")) {
  *result = src1 | src2;
  return 
# 161 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        1
# 161 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }
 return 
# 163 "project/radare2/libr/core/cmd_search_rop.c" 3 4
       0
# 163 "project/radare2/libr/core/cmd_search_rop.c"
            ;
}
...
# 177 "project/radare2/libr/core/cmd_search_rop.c" 3 4
if (
# 177 "project/radare2/libr/core/cmd_search_rop.c"
regs
# 177 "project/radare2/libr/core/cmd_search_rop.c" 3 4
) for (
# 177 "project/radare2/libr/core/cmd_search_rop.c"
...
# 225 "project/radare2/libr/core/cmd_search_rop.c"
static char* rop_classify_constant(RCore *core, RList *ropList) {
 char *esil_str, *constant;
 char *ct = 
# 227 "project/radare2/libr/core/cmd_search_rop.c" 3 4
           ((void *)0)
# 227 "project/radare2/libr/core/cmd_search_rop.c"
               , *esil_main = 
# 227 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                              ((void *)0)
# 227 "project/radare2/libr/core/cmd_search_rop.c"
...
# 227 "project/radare2/libr/core/cmd_search_rop.c"
 ...
 RList *ops_list = 
# 231 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                  ((void *)0)
# 231 "project/radare2/libr/core/cmd_search_rop.c"
                      , *flg_read = 
# 231 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                    ((void *)0)
# 231 "project/radare2/libr/core/cmd_search_rop.c"
...
# 231 "project/radare2/libr/core/cmd_search_rop.c"
                                                           ,
       *reg_read = 
# 232 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                  ((void *)0)
# 232 "project/radare2/libr/core/cmd_search_rop.c"
                      , *reg_write = 
# 232 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                     ((void *)0)
# 232 "project/radare2/libr/core/cmd_search_rop.c"
...
# 232 "project/radare2/libr/core/cmd_search_rop.c"
                                                           ,
       *mem_write = 
# 233 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                   ((void *)0)
# 233 "project/radare2/libr/core/cmd_search_rop.c"
                       ;
 const 
# 234 "project/radare2/libr/core/cmd_search_rop.c" 3 4
      _Bool 
# 234 "project/radare2/libr/core/cmd_search_rop.c"
           romem = r_config_get_i (core->config, "esil.romem");
 const 
# 235 "project/radare2/libr/core/cmd_search_rop.c" 3 4
      _Bool 
# 235 "project/radare2/libr/core/cmd_search_rop.c"
           stats = r_config_get_i (core->config, "esil.stats");

 if (!romem || !stats) {

  return 
# 239 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        ((void *)0)
# 239 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }

 
# 242 "project/radare2/libr/core/cmd_search_rop.c" 3 4
if (
# 242 "project/radare2/libr/core/cmd_search_rop.c"
ropList
# 242 "project/radare2/libr/core/cmd_search_rop.c" 3 4
) for (
# 242 "project/radare2/libr/core/cmd_search_rop.c"
...
# 242 "project/radare2/libr/core/cmd_search_rop.c"
  ...
  if (
# 245 "project/radare2/libr/core/cmd_search_rop.c" 3 4
     (!(
# 245 "project/radare2/libr/core/cmd_search_rop.c"
     constants
# 245 "project/radare2/libr/core/cmd_search_rop.c" 3 4
     ) || !(
# 245 "project/radare2/libr/core/cmd_search_rop.c"
...
# 245 "project/radare2/libr/core/cmd_search_rop.c"
  ...
  if (!head) {
   ct = 
# 252 "project/radare2/libr/core/cmd_search_rop.c" 3 4
       ((void *)0)
# 252 "project/radare2/libr/core/cmd_search_rop.c"
           ;
   goto continue_error;
  }
  esil_split_flg (esil_str, &esil_main, &esil_flg);
  cmd_anal_esil (core, esil_main? esil_main: esil_str);
  out = sdb_querys (core->anal->esil->stats, 
# 257 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                            ((void *)0)
# 257 "project/radare2/libr/core/cmd_search_rop.c"
                                                , 0, "*");
  if (!out) {
   goto continue_error;
  }
...
# 275 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 if (
# 275 "project/radare2/libr/core/cmd_search_rop.c"
 head
# 275 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 ) for (
# 275 "project/radare2/libr/core/cmd_search_rop.c"
...
# 276 "project/radare2/libr/core/cmd_search_rop.c" 3 4
  unsigned long long 
# 276 "project/radare2/libr/core/cmd_search_rop.c"
       diff_dst, value_dst;
...
# 283 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                    0
# 283 "project/radare2/libr/core/cmd_search_rop.c"
                                         );
   diff_dst = r_reg_get_value (core->dbg->reg, item_dst);
   r_reg_arena_swap (core->dbg->reg, 
# 285 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                    0
# 285 "project/radare2/libr/core/cmd_search_rop.c"
                                         );
...
# 290 "project/radare2/libr/core/cmd_search_rop.c" 3 4
   if (
# 290 "project/radare2/libr/core/cmd_search_rop.c"
   constants
# 290 "project/radare2/libr/core/cmd_search_rop.c" 3 4
   ) for (
# 290 "project/radare2/libr/core/cmd_search_rop.c"
...
# 290 "project/radare2/libr/core/cmd_search_rop.c"
                                                    {
     if (value_dst == r_num_get (
# 291 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                ((void *)0)
# 291 "project/radare2/libr/core/cmd_search_rop.c"
                                    , constant)) {
      ct = r_str_appendf (ct, "%s <-- 0x%"
# 292 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                         "llx"
# 292 "project/radare2/libr/core/cmd_search_rop.c"
                                                ";", item_dst->name, value_dst);
     }
    }
   }
  }
continue_error:
  ...
  { 
# 300 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 { free((void *)
# 300 "project/radare2/libr/core/cmd_search_rop.c"
 out
# 300 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 ); 
# 300 "project/radare2/libr/core/cmd_search_rop.c"
...
# 300 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 = ((void *)0); }
# 300 "project/radare2/libr/core/cmd_search_rop.c"
 ; r_list_free (ops_list); ops_list = 
# 300 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 ((void *)0)
# 300 "project/radare2/libr/core/cmd_search_rop.c"
 ; r_list_free (flg_read); flg_read = 
# 300 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 ((void *)0)
# 300 "project/radare2/libr/core/cmd_search_rop.c"
 ; r_list_free (flg_write); flg_write = 
# 300 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 ((void *)0)
# 300 "project/radare2/libr/core/cmd_search_rop.c"
 ; r_list_free (reg_read); reg_read = 
# 300 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 ((void *)0)
# 300 "project/radare2/libr/core/cmd_search_rop.c"
 ; r_list_free (reg_write); reg_write = 
# 300 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 ((void *)0)
# 300 "project/radare2/libr/core/cmd_search_rop.c"
 ; r_list_free (mem_read); mem_read = 
# 300 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 ((void *)0)
# 300 "project/radare2/libr/core/cmd_search_rop.c"
 ; r_list_free (mem_write); mem_write = 
# 300 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 ((void *)0)
# 300 "project/radare2/libr/core/cmd_search_rop.c"
 ; };
...
out_error:
 { 
# 305 "project/radare2/libr/core/cmd_search_rop.c" 3 4
{ free((void *)
# 305 "project/radare2/libr/core/cmd_search_rop.c"
out
# 305 "project/radare2/libr/core/cmd_search_rop.c" 3 4
); 
# 305 "project/radare2/libr/core/cmd_search_rop.c"
...
; };
 r_list_free (constants);
 return 
# 307 "project/radare2/libr/core/cmd_search_rop.c" 3 4
       ((void *)0)
# 307 "project/radare2/libr/core/cmd_search_rop.c"
           ;
}
...
static char* rop_classify_mov(RCore *core, RList *ropList) {
 char *esil_str;
 char *mov = 
# 312 "project/radare2/libr/core/cmd_search_rop.c" 3 4
            ((void *)0)
# 312 "project/radare2/libr/core/cmd_search_rop.c"
                , *esil_main = 
# 312 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                               ((void *)0)
# 312 "project/radare2/libr/core/cmd_search_rop.c"
...
# 312 "project/radare2/libr/core/cmd_search_rop.c"
 ...
 RList *head;
 RList *ops_list = 
# 316 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                  ((void *)0)
# 316 "project/radare2/libr/core/cmd_search_rop.c"
                      , *flg_read = 
# 316 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                    ((void *)0)
# 316 "project/radare2/libr/core/cmd_search_rop.c"
...
# 316 "project/radare2/libr/core/cmd_search_rop.c"
                                                           ,
       *reg_read = 
# 317 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                  ((void *)0)
# 317 "project/radare2/libr/core/cmd_search_rop.c"
                      , *reg_write = 
# 317 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                     ((void *)0)
# 317 "project/radare2/libr/core/cmd_search_rop.c"
...
# 317 "project/radare2/libr/core/cmd_search_rop.c"
                                                           ,
       *mem_write = 
# 318 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                   ((void *)0)
# 318 "project/radare2/libr/core/cmd_search_rop.c"
                       ;
 const 
# 319 "project/radare2/libr/core/cmd_search_rop.c" 3 4
      _Bool 
# 319 "project/radare2/libr/core/cmd_search_rop.c"
           romem = r_config_get_i (core->config, "esil.romem");
 const 
# 320 "project/radare2/libr/core/cmd_search_rop.c" 3 4
      _Bool 
# 320 "project/radare2/libr/core/cmd_search_rop.c"
           stats = r_config_get_i (core->config, "esil.stats");

 if (!romem || !stats) {

  return 
# 324 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        ((void *)0)
# 324 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }

 
# 327 "project/radare2/libr/core/cmd_search_rop.c" 3 4
if (
# 327 "project/radare2/libr/core/cmd_search_rop.c"
ropList
# 327 "project/radare2/libr/core/cmd_search_rop.c" 3 4
) for (
# 327 "project/radare2/libr/core/cmd_search_rop.c"
...
# 327 "project/radare2/libr/core/cmd_search_rop.c"
  ...
  cmd_anal_esil (core, esil_main? esil_main: esil_str);
  out = sdb_querys (core->anal->esil->stats, 
# 336 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                            ((void *)0)
# 336 "project/radare2/libr/core/cmd_search_rop.c"
                                                , 0, "*");
  if (out) {
   ops_list = parse_list (strstr (out, "ops.list"));
   flg_read = parse_list (strstr (out, "flg.read"));
...
# 357 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 if (
# 357 "project/radare2/libr/core/cmd_search_rop.c"
 head
# 357 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 ) for (
# 357 "project/radare2/libr/core/cmd_search_rop.c"
...
# 358 "project/radare2/libr/core/cmd_search_rop.c" 3 4
  unsigned long long 
# 358 "project/radare2/libr/core/cmd_search_rop.c"
       diff_dst, value_dst;
   if (!r_list_find (reg_write, item_dst->name,
       (RListComparator)strcmp)) {
    continue;
   ...
   value_dst = r_reg_get_value (core->dbg->reg, item_dst);
   r_reg_arena_swap (core->dbg->reg, 
# 370 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                    0
# 370 "project/radare2/libr/core/cmd_search_rop.c"
                                         );
   diff_dst = r_reg_get_value (core->dbg->reg, item_dst);
   r_reg_arena_swap (core->dbg->reg, 
# 372 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                    0
# 372 "project/radare2/libr/core/cmd_search_rop.c"
                                         );
   
# 373 "project/radare2/libr/core/cmd_search_rop.c" 3 4
  if (
# 373 "project/radare2/libr/core/cmd_search_rop.c"
  head
# 373 "project/radare2/libr/core/cmd_search_rop.c" 3 4
  ) for (
# 373 "project/radare2/libr/core/cmd_search_rop.c"
...
# 374 "project/radare2/libr/core/cmd_search_rop.c" 3 4
   unsigned long long 
# 374 "project/radare2/libr/core/cmd_search_rop.c"
        diff_src, value_src;
    ...
    r_reg_arena_swap (core->dbg->reg, 
# 384 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                     0
# 384 "project/radare2/libr/core/cmd_search_rop.c"
                                          );
    diff_src = r_reg_get_value (core->dbg->reg, item_src);
    r_reg_arena_swap (core->dbg->reg, 
# 386 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                     0
# 386 "project/radare2/libr/core/cmd_search_rop.c"
                                          );
...
continue_error:
  { 
# 396 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 { free((void *)
# 396 "project/radare2/libr/core/cmd_search_rop.c"
 out
# 396 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 ); 
# 396 "project/radare2/libr/core/cmd_search_rop.c"
...
out_error:
 { 
# 400 "project/radare2/libr/core/cmd_search_rop.c" 3 4
{ free((void *)
# 400 "project/radare2/libr/core/cmd_search_rop.c"
out
# 400 "project/radare2/libr/core/cmd_search_rop.c" 3 4
); 
# 400 "project/radare2/libr/core/cmd_search_rop.c"
...
; };
 return 
# 401 "project/radare2/libr/core/cmd_search_rop.c" 3 4
       ((void *)0)
# 401 "project/radare2/libr/core/cmd_search_rop.c"
           ;
}
...
static char* rop_classify_arithmetic(RCore *core, RList *ropList) {
 char *esil_str, *op;
 char *arithmetic = 
# 406 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                   ((void *)0)
# 406 "project/radare2/libr/core/cmd_search_rop.c"
                       , *esil_flg = 
# 406 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                     ((void *)0)
# 406 "project/radare2/libr/core/cmd_search_rop.c"
...
# 406 "project/radare2/libr/core/cmd_search_rop.c"
                                                            ,
      *out = 
# 407 "project/radare2/libr/core/cmd_search_rop.c" 3 4
            ((void *)0)
# 407 "project/radare2/libr/core/cmd_search_rop.c"
                ;
 RListIter *iter_src1, *iter_src2, *iter_r, *iter_dst, *iter_ops;
 RRegItem *item_src1, *item_src2, *item_dst;
 RList *head;
 RList *ops_list = 
# 411 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                  ((void *)0)
# 411 "project/radare2/libr/core/cmd_search_rop.c"
                      , *flg_read = 
# 411 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                    ((void *)0)
# 411 "project/radare2/libr/core/cmd_search_rop.c"
...
# 411 "project/radare2/libr/core/cmd_search_rop.c"
                                                           ,
       *reg_read = 
# 412 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                  ((void *)0)
# 412 "project/radare2/libr/core/cmd_search_rop.c"
                      , *reg_write = 
# 412 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                     ((void *)0)
# 412 "project/radare2/libr/core/cmd_search_rop.c"
...
# 412 "project/radare2/libr/core/cmd_search_rop.c"
                                                           ,
       *mem_write = 
# 413 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                    ((void *)0)
# 413 "project/radare2/libr/core/cmd_search_rop.c"
                        ;
 const 
# 414 "project/radare2/libr/core/cmd_search_rop.c" 3 4
      _Bool 
# 414 "project/radare2/libr/core/cmd_search_rop.c"
           romem = r_config_get_i (core->config, "esil.romem");
 const 
# 415 "project/radare2/libr/core/cmd_search_rop.c" 3 4
      _Bool 
# 415 "project/radare2/libr/core/cmd_search_rop.c"
           stats = r_config_get_i (core->config, "esil.stats");
 
# 416 "project/radare2/libr/core/cmd_search_rop.c" 3 4
unsigned long long 
# 416 "project/radare2/libr/core/cmd_search_rop.c"
     *op_result = 
# 416 "project/radare2/libr/core/cmd_search_rop.c" 3 4
...
# 417 "project/radare2/libr/core/cmd_search_rop.c" 3 4
unsigned long long 
# 417 "project/radare2/libr/core/cmd_search_rop.c"
     *op_result_r = 
# 417 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                    (unsigned long long*)calloc(1,sizeof(unsigned long long))
# 417 "project/radare2/libr/core/cmd_search_rop.c"
 ...
 if (!romem || !stats) {
  ...
  free (op_result_r);
  return 
# 423 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        ((void *)0)
# 423 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }

 
# 426 "project/radare2/libr/core/cmd_search_rop.c" 3 4
if (
# 426 "project/radare2/libr/core/cmd_search_rop.c"
ropList
# 426 "project/radare2/libr/core/cmd_search_rop.c" 3 4
) for (
# 426 "project/radare2/libr/core/cmd_search_rop.c"
...
# 426 "project/radare2/libr/core/cmd_search_rop.c"
  ...
  out = sdb_querys (core->anal->esil->stats, 
# 439 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                            ((void *)0)
# 439 "project/radare2/libr/core/cmd_search_rop.c"
                                                , 0, "*");
...
# 452 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 if (
# 452 "project/radare2/libr/core/cmd_search_rop.c"
 ops_list
# 452 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 ) for (
# 452 "project/radare2/libr/core/cmd_search_rop.c"
...
# 453 "project/radare2/libr/core/cmd_search_rop.c" 3 4
  if (
# 453 "project/radare2/libr/core/cmd_search_rop.c"
  head
# 453 "project/radare2/libr/core/cmd_search_rop.c" 3 4
  ) for (
# 453 "project/radare2/libr/core/cmd_search_rop.c"
...
# 454 "project/radare2/libr/core/cmd_search_rop.c" 3 4
   unsigned long long 
# 454 "project/radare2/libr/core/cmd_search_rop.c"
        value_src1, diff_src1;

    value_src1 = r_reg_get_value (core->dbg->reg, item_src1);
    r_reg_arena_swap (core->dbg->reg, 
# 457 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                     0
# 457 "project/radare2/libr/core/cmd_search_rop.c"
                                          );
    diff_src1 = r_reg_get_value (core->dbg->reg, item_src1);
    r_reg_arena_swap (core->dbg->reg, 
# 459 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                     0
# 459 "project/radare2/libr/core/cmd_search_rop.c"
                                          );
...
# 465 "project/radare2/libr/core/cmd_search_rop.c" 3 4
   if (
# 465 "project/radare2/libr/core/cmd_search_rop.c"
   head
# 465 "project/radare2/libr/core/cmd_search_rop.c" 3 4
   ) for (
# 465 "project/radare2/libr/core/cmd_search_rop.c"
...
# 466 "project/radare2/libr/core/cmd_search_rop.c" 3 4
    unsigned long long 
# 466 "project/radare2/libr/core/cmd_search_rop.c"
         value_src2, diff_src2;
     value_src2 = r_reg_get_value (core->dbg->reg, item_src2);
     r_reg_arena_swap (core->dbg->reg, 
# 468 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                      0
# 468 "project/radare2/libr/core/cmd_search_rop.c"
                                           );
...
# 480 "project/radare2/libr/core/cmd_search_rop.c" 3 4
    if (
# 480 "project/radare2/libr/core/cmd_search_rop.c"
    head
# 480 "project/radare2/libr/core/cmd_search_rop.c" 3 4
    ) for (
# 480 "project/radare2/libr/core/cmd_search_rop.c"
...
# 481 "project/radare2/libr/core/cmd_search_rop.c" 3 4
     unsigned long long 
# 481 "project/radare2/libr/core/cmd_search_rop.c"
          value_dst;
      
# 482 "project/radare2/libr/core/cmd_search_rop.c" 3 4
     _Bool 
# 482 "project/radare2/libr/core/cmd_search_rop.c"
          redundant = 
# 482 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                      0
# 482 "project/radare2/libr/core/cmd_search_rop.c"
      ...
      value_dst = r_reg_get_value (core->dbg->reg, item_dst);
      r_reg_arena_swap (core->dbg->reg, 
# 485 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                       0
# 485 "project/radare2/libr/core/cmd_search_rop.c"
                                            );
      if (!r_list_find (reg_write, item_dst->name,
            (RListComparator)strcmp)) {
       continue;
      ...
      if ( simulate && value_dst == *op_result) {
       ...
       free (tmp);
       redundant = 
# 505 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                  1
# 505 "project/radare2/libr/core/cmd_search_rop.c"
                      ;
...
continue_error:
  { 
# 521 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 { free((void *)
# 521 "project/radare2/libr/core/cmd_search_rop.c"
 out
# 521 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 ); 
# 521 "project/radare2/libr/core/cmd_search_rop.c"
...
out_error:
 { 
# 527 "project/radare2/libr/core/cmd_search_rop.c" 3 4
{ free((void *)
# 527 "project/radare2/libr/core/cmd_search_rop.c"
out
# 527 "project/radare2/libr/core/cmd_search_rop.c" 3 4
); 
# 527 "project/radare2/libr/core/cmd_search_rop.c"
...
; };
 ...
 free (op_result_r);
 return 
# 530 "project/radare2/libr/core/cmd_search_rop.c" 3 4
       ((void *)0)
# 530 "project/radare2/libr/core/cmd_search_rop.c"
           ;
}
...
static char* rop_classify_arithmetic_const(RCore *core, RList *ropList) {
 ...
 char *arithmetic = 
# 535 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                   ((void *)0)
# 535 "project/radare2/libr/core/cmd_search_rop.c"
                       , *esil_flg = 
# 535 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                     ((void *)0)
# 535 "project/radare2/libr/core/cmd_search_rop.c"
...
# 535 "project/radare2/libr/core/cmd_search_rop.c"
 ...
 RList *head, *constants;
 RList *ops_list = 
# 539 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                  ((void *)0)
# 539 "project/radare2/libr/core/cmd_search_rop.c"
                      , *flg_read = 
# 539 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                    ((void *)0)
# 539 "project/radare2/libr/core/cmd_search_rop.c"
...
# 539 "project/radare2/libr/core/cmd_search_rop.c"
                                                                             ,
  *reg_write = 
# 540 "project/radare2/libr/core/cmd_search_rop.c" 3 4
              ((void *)0)
# 540 "project/radare2/libr/core/cmd_search_rop.c"
                  , *mem_read = 
# 540 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                ((void *)0)
# 540 "project/radare2/libr/core/cmd_search_rop.c"
...
# 540 "project/radare2/libr/core/cmd_search_rop.c"
                                                       ;
 const 
# 541 "project/radare2/libr/core/cmd_search_rop.c" 3 4
      _Bool 
# 541 "project/radare2/libr/core/cmd_search_rop.c"
           romem = r_config_get_i (core->config, "esil.romem");
 const 
# 542 "project/radare2/libr/core/cmd_search_rop.c" 3 4
      _Bool 
# 542 "project/radare2/libr/core/cmd_search_rop.c"
           stats = r_config_get_i (core->config, "esil.stats");
 
# 543 "project/radare2/libr/core/cmd_search_rop.c" 3 4
unsigned long long 
# 543 "project/radare2/libr/core/cmd_search_rop.c"
     *op_result = 
# 543 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                  (unsigned long long*)calloc(1,sizeof(unsigned long long))
# 543 "project/radare2/libr/core/cmd_search_rop.c"
...
# 544 "project/radare2/libr/core/cmd_search_rop.c" 3 4
unsigned long long 
# 544 "project/radare2/libr/core/cmd_search_rop.c"
     *op_result_r = 
# 544 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                    (unsigned long long*)calloc(1,sizeof(unsigned long long))
# 544 "project/radare2/libr/core/cmd_search_rop.c"
...
# 548 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 { free((void *)
# 548 "project/radare2/libr/core/cmd_search_rop.c"
 op_result
# 548 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 ); 
# 548 "project/radare2/libr/core/cmd_search_rop.c"
...
# 549 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 { free((void *)
# 549 "project/radare2/libr/core/cmd_search_rop.c"
 op_result_r
# 549 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 ); 
# 549 "project/radare2/libr/core/cmd_search_rop.c"
...
# 549 "project/radare2/libr/core/cmd_search_rop.c"
                     ;
  return 
# 550 "project/radare2/libr/core/cmd_search_rop.c" 3 4
        ((void *)0)
# 550 "project/radare2/libr/core/cmd_search_rop.c"
            ;
 }

 
# 553 "project/radare2/libr/core/cmd_search_rop.c" 3 4
if (
# 553 "project/radare2/libr/core/cmd_search_rop.c"
ropList
# 553 "project/radare2/libr/core/cmd_search_rop.c" 3 4
) for (
# 553 "project/radare2/libr/core/cmd_search_rop.c"
...
# 553 "project/radare2/libr/core/cmd_search_rop.c"
  ...
  if (
# 556 "project/radare2/libr/core/cmd_search_rop.c" 3 4
     (!(
# 556 "project/radare2/libr/core/cmd_search_rop.c"
     constants
# 556 "project/radare2/libr/core/cmd_search_rop.c" 3 4
     ) || !(
# 556 "project/radare2/libr/core/cmd_search_rop.c"
...
# 556 "project/radare2/libr/core/cmd_search_rop.c"
  ...
  if (!head) {
   arithmetic = 
# 563 "project/radare2/libr/core/cmd_search_rop.c" 3 4
               ((void *)0)
# 563 "project/radare2/libr/core/cmd_search_rop.c"
                   ;
   continue;
  }
  esil_split_flg (esil_str, &esil_main, &esil_flg);
  ...
  char *out = sdb_querys (core->anal->esil->stats, 
# 572 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                                  ((void *)0)
# 572 "project/radare2/libr/core/cmd_search_rop.c"
                                                      , 0, "*");
...
# 583 "project/radare2/libr/core/cmd_search_rop.c" 3 4
  { free((void *)
# 583 "project/radare2/libr/core/cmd_search_rop.c"
  op_result
# 583 "project/radare2/libr/core/cmd_search_rop.c" 3 4
  ); 
# 583 "project/radare2/libr/core/cmd_search_rop.c"
...
# 584 "project/radare2/libr/core/cmd_search_rop.c" 3 4
  { free((void *)
# 584 "project/radare2/libr/core/cmd_search_rop.c"
  op_result_r
# 584 "project/radare2/libr/core/cmd_search_rop.c" 3 4
  ); 
# 584 "project/radare2/libr/core/cmd_search_rop.c"
...
# 588 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 if (
# 588 "project/radare2/libr/core/cmd_search_rop.c"
 ops_list
# 588 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 ) for (
# 588 "project/radare2/libr/core/cmd_search_rop.c"
...
# 589 "project/radare2/libr/core/cmd_search_rop.c" 3 4
  if (
# 589 "project/radare2/libr/core/cmd_search_rop.c"
  head
# 589 "project/radare2/libr/core/cmd_search_rop.c" 3 4
  ) for (
# 589 "project/radare2/libr/core/cmd_search_rop.c"
...
# 590 "project/radare2/libr/core/cmd_search_rop.c" 3 4
   unsigned long long 
# 590 "project/radare2/libr/core/cmd_search_rop.c"
        value_src1, diff_src1;
    value_src1 = r_reg_get_value (core->dbg->reg, item_src1);
    r_reg_arena_swap (core->dbg->reg, 
# 592 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                     0
# 592 "project/radare2/libr/core/cmd_search_rop.c"
                                          );
    diff_src1 = r_reg_get_value (core->dbg->reg, item_src1);
    r_reg_arena_swap (core->dbg->reg, 
# 594 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                     0
# 594 "project/radare2/libr/core/cmd_search_rop.c"
                                          );
...
# 600 "project/radare2/libr/core/cmd_search_rop.c" 3 4
   if (
# 600 "project/radare2/libr/core/cmd_search_rop.c"
   head
# 600 "project/radare2/libr/core/cmd_search_rop.c" 3 4
   ) for (
# 600 "project/radare2/libr/core/cmd_search_rop.c"
...
# 601 "project/radare2/libr/core/cmd_search_rop.c" 3 4
    unsigned long long 
# 601 "project/radare2/libr/core/cmd_search_rop.c"
         value_dst, diff_dst;
     
# 602 "project/radare2/libr/core/cmd_search_rop.c" 3 4
    _Bool 
# 602 "project/radare2/libr/core/cmd_search_rop.c"
         redundant = 
# 602 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                     0
# 602 "project/radare2/libr/core/cmd_search_rop.c"
     ...
     value_dst = r_reg_get_value (core->dbg->reg, item_dst);
     r_reg_arena_swap (core->dbg->reg, 
# 604 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                      0
# 604 "project/radare2/libr/core/cmd_search_rop.c"
                                           );
     diff_dst = r_reg_get_value (core->dbg->reg, item_dst);
     r_reg_arena_swap (core->dbg->reg, 
# 606 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                      0
# 606 "project/radare2/libr/core/cmd_search_rop.c"
                                           );
     if (!r_list_find (reg_write, item_dst->name,
          (RListComparator)strcmp)) {
      continue;
...
# 616 "project/radare2/libr/core/cmd_search_rop.c" 3 4
     if (
# 616 "project/radare2/libr/core/cmd_search_rop.c"
     constants
# 616 "project/radare2/libr/core/cmd_search_rop.c" 3 4
     ) for (
# 616 "project/radare2/libr/core/cmd_search_rop.c"
...
# 617 "project/radare2/libr/core/cmd_search_rop.c" 3 4
      unsigned long long 
# 617 "project/radare2/libr/core/cmd_search_rop.c"
           value_ct = r_num_get (
# 617 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                 ((void *)0)
# 617 "project/radare2/libr/core/cmd_search_rop.c"
       ...
       if (simulate && op_result && value_dst == *op_result) {
        ...
        free (tmp);
        redundant = 
# 632 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                   1
# 632 "project/radare2/libr/core/cmd_search_rop.c"
                       ;
       } else if (!redundant && simulate_r && value_dst == *op_result_r) {
...
continue_error:
  { 
# 648 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 { free((void *)
# 648 "project/radare2/libr/core/cmd_search_rop.c"
 out
# 648 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 ); 
# 648 "project/radare2/libr/core/cmd_search_rop.c"
...
static int rop_classify_nops(RCore *core, RList *ropList) {
 ...
 RListIter *iter_r;
 const 
# 660 "project/radare2/libr/core/cmd_search_rop.c" 3 4
      _Bool 
# 660 "project/radare2/libr/core/cmd_search_rop.c"
           romem = r_config_get_i (core->config, "esil.romem");
 const 
# 661 "project/radare2/libr/core/cmd_search_rop.c" 3 4
      _Bool 
# 661 "project/radare2/libr/core/cmd_search_rop.c"
           stats = r_config_get_i (core->config, "esil.stats");
...
# 668 "project/radare2/libr/core/cmd_search_rop.c" 3 4
if (
# 668 "project/radare2/libr/core/cmd_search_rop.c"
ropList
# 668 "project/radare2/libr/core/cmd_search_rop.c" 3 4
) for (
# 668 "project/radare2/libr/core/cmd_search_rop.c"
...
# 668 "project/radare2/libr/core/cmd_search_rop.c"
  ...
  cmd_anal_esil (core, esil_str);
  char *out = sdb_querys (core->anal->esil->stats, 
# 673 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                                  ((void *)0)
# 673 "project/radare2/libr/core/cmd_search_rop.c"
                                                      , 0, "*");
...
static void rop_classify (RCore *core, Sdb *db, RList *ropList, const char *key, unsigned int size) {
 ...
 Sdb *db_nop = sdb_ns (db, "nop", 
# 689 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                 1
# 689 "project/radare2/libr/core/cmd_search_rop.c"
                                     );
 Sdb *db_mov = sdb_ns (db, "mov", 
# 690 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                 1
# 690 "project/radare2/libr/core/cmd_search_rop.c"
                                     );
 Sdb *db_ct = sdb_ns (db, "const", 
# 691 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                  1
# 691 "project/radare2/libr/core/cmd_search_rop.c"
                                      );
 Sdb *db_aritm = sdb_ns (db, "arithm", 
# 692 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                      1
# 692 "project/radare2/libr/core/cmd_search_rop.c"
                                          );
 Sdb *db_aritm_ct = sdb_ns (db, "arithm_ct", 
# 693 "project/radare2/libr/core/cmd_search_rop.c" 3 4
                                            1
# 693 "project/radare2/libr/core/cmd_search_rop.c"
                                                );

 if (!db_nop || !db_mov || !db_ct || !db_aritm || !db_aritm_ct) {
  
# 696 "project/radare2/libr/core/cmd_search_rop.c" 3 4
 fprintf(__stderrp,
# 696 "project/radare2/libr/core/cmd_search_rop.c"
