# 0 "project/radare2/libr/core/cplugin.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/cplugin.c"




# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/sdb/src/config.h" 1 3 4
# 6 "project/radare2/libr/core/cplugin.c" 2
...
# 7 "project/radare2/libr/core/cplugin.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_cmd.h" 1 3 4
# 8 "project/radare2/libr/core/cplugin.c" 2




# 11 "project/radare2/libr/core/cplugin.c"
static RCorePlugin *cmd_static_plugins[] = {
 R_CORE_STATIC_PLUGINS
};


# 15 "project/radare2/libr/core/cplugin.c" 3 4
__attribute__((visibility("default"))) 
# 15 "project/radare2/libr/core/cplugin.c"
     void r_core_plugin_fini(RCmd *cmd) {
 RListIter *iter;
 RCorePlugin *plugin;
 if (!cmd->plist) {
  return;
...
# 21 "project/radare2/libr/core/cplugin.c" 3 4
if (
# 21 "project/radare2/libr/core/cplugin.c"
cmd->plist
# 21 "project/radare2/libr/core/cplugin.c" 3 4
) for (
# 21 "project/radare2/libr/core/cplugin.c"
...
# 21 "project/radare2/libr/core/cplugin.c"
  ...
  if (plugin && plugin->fini) {
   plugin->fini (cmd, 
# 23 "project/radare2/libr/core/cplugin.c" 3 4
                     ((void *)0)
# 23 "project/radare2/libr/core/cplugin.c"
                         );
  }
 }
 ...
 cmd->plist = 
# 28 "project/radare2/libr/core/cplugin.c" 3 4
             ((void *)0)
# 28 "project/radare2/libr/core/cplugin.c"
                 ;
}


# 31 "project/radare2/libr/core/cplugin.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 31 "project/radare2/libr/core/cplugin.c"
          r_core_plugin_add(RCmd *cmd, RCorePlugin *plugin) {
 
# 32 "project/radare2/libr/core/cplugin.c" 3 4
do { if (!(
# 32 "project/radare2/libr/core/cplugin.c"
cmd && plugin
# 32 "project/radare2/libr/core/cplugin.c" 3 4
...
# 32 "project/radare2/libr/core/cplugin.c"
                                           ;
 if (plugin->init && !plugin->init (cmd, 
# 33 "project/radare2/libr/core/cplugin.c" 3 4
                                        ((void *)0)
# 33 "project/radare2/libr/core/cplugin.c"
                                            )) {
  return 
# 34 "project/radare2/libr/core/cplugin.c" 3 4
        0
# 34 "project/radare2/libr/core/cplugin.c"
             ;
 }
 r_list_append (cmd->plist, plugin);
 return 
# 37 "project/radare2/libr/core/cplugin.c" 3 4
       1
# 37 "project/radare2/libr/core/cplugin.c"
           ;
}


# 40 "project/radare2/libr/core/cplugin.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 40 "project/radare2/libr/core/cplugin.c"
          r_core_plugin_init(RCmd *cmd) {
 size_t i;
 cmd->plist = r_list_newf (
# 42 "project/radare2/libr/core/cplugin.c" 3 4
                          ((void *)0)
# 42 "project/radare2/libr/core/cplugin.c"
                              );
 for (i = 0; cmd_static_plugins[i]; i++) {
  if (!r_core_plugin_add (cmd, cmd_static_plugins[i])) {
   
# 45 "project/radare2/libr/core/cplugin.c" 3 4
  fprintf(__stderrp,
# 45 "project/radare2/libr/core/cplugin.c"
  "Error loading cmd plugin\n"
# 45 "project/radare2/libr/core/cplugin.c" 3 4
  )
# 45 "project/radare2/libr/core/cplugin.c"
                                        ;
   return 
# 46 "project/radare2/libr/core/cplugin.c" 3 4
         0
# 46 "project/radare2/libr/core/cplugin.c"
              ;
  }
 }
 return 
# 49 "project/radare2/libr/core/cplugin.c" 3 4
       1
# 49 "project/radare2/libr/core/cplugin.c"
           ;
}


# 52 "project/radare2/libr/core/cplugin.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 52 "project/radare2/libr/core/cplugin.c"
          r_core_plugin_check(RCmd *cmd, const char *a0) {
 RListIter *iter;
 RCorePlugin *cp;
 
# 55 "project/radare2/libr/core/cplugin.c" 3 4
if (
# 55 "project/radare2/libr/core/cplugin.c"
cmd->plist
# 55 "project/radare2/libr/core/cplugin.c" 3 4
) for (
# 55 "project/radare2/libr/core/cplugin.c"
...
# 55 "project/radare2/libr/core/cplugin.c"
                                      {
  return cp->call (
# 56 "project/radare2/libr/core/cplugin.c" 3 4
                  ((void *)0)
# 56 "project/radare2/libr/core/cplugin.c"
                      , a0);
 }
 return 
# 58 "project/radare2/libr/core/cplugin.c" 3 4
       0
# 58 "project/radare2/libr/core/cplugin.c"
            ;
}
