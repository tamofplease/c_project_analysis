# 0 "project/radare2/libr/core/cmd_open.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/cmd_open.c"
...
# 4 "project/radare2/libr/core/cmd_open.c" 2
...
# 8 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_debug.h" 2 3 4
...
# 5 "project/radare2/libr/core/cmd_open.c" 2


# 6 "project/radare2/libr/core/cmd_open.c"
...
# 31 "project/radare2/libr/core/cmd_open.c" 3 4
((void *)0)

# 32 "project/radare2/libr/core/cmd_open.c"
};
...
# 37 "project/radare2/libr/core/cmd_open.c" 3 4
((void *)0)

# 38 "project/radare2/libr/core/cmd_open.c"
};
...
# 45 "project/radare2/libr/core/cmd_open.c" 3 4
((void *)0)

# 46 "project/radare2/libr/core/cmd_open.c"
};
...
# 51 "project/radare2/libr/core/cmd_open.c" 3 4
((void *)0)

# 52 "project/radare2/libr/core/cmd_open.c"
};
...
# 59 "project/radare2/libr/core/cmd_open.c" 3 4
((void *)0)

# 60 "project/radare2/libr/core/cmd_open.c"
};
...
# 68 "project/radare2/libr/core/cmd_open.c" 3 4
((void *)0)

# 69 "project/radare2/libr/core/cmd_open.c"
};
...
# 76 "project/radare2/libr/core/cmd_open.c" 3 4
((void *)0)

# 77 "project/radare2/libr/core/cmd_open.c"
};
...
# 90 "project/radare2/libr/core/cmd_open.c" 3 4
((void *)0)

# 91 "project/radare2/libr/core/cmd_open.c"
};

static const char *help_msg_o_star[] = {
 "Usage:", "o* [> files.r2]", "",
 "o*", "", "list opened files in r2 commands", 
# 95 "project/radare2/libr/core/cmd_open.c" 3 4
                                              ((void *)0)

# 96 "project/radare2/libr/core/cmd_open.c"
};
...
# 103 "project/radare2/libr/core/cmd_open.c" 3 4
((void *)0)

# 104 "project/radare2/libr/core/cmd_open.c"
};
...
# 125 "project/radare2/libr/core/cmd_open.c" 3 4
((void *)0)

# 126 "project/radare2/libr/core/cmd_open.c"
};

static const char *help_msg_oj[] = {
 "Usage:", "oj [~{}]", " # Use ~{} to indent the JSON",
 "oj", "", "list opened files in JSON format", 
# 130 "project/radare2/libr/core/cmd_open.c" 3 4
                                              ((void *)0)

# 131 "project/radare2/libr/core/cmd_open.c"
};
...
# 163 "project/radare2/libr/core/cmd_open.c" 3 4
((void *)0)

# 164 "project/radare2/libr/core/cmd_open.c"
};
...
# 169 "project/radare2/libr/core/cmd_open.c" 3 4
((void *)0)

# 170 "project/radare2/libr/core/cmd_open.c"
};
...
# 184 "project/radare2/libr/core/cmd_open.c" 3 4
((void *)0)

# 185 "project/radare2/libr/core/cmd_open.c"
};

static const char *help_msg_oo_plus[] = {
 "Usage:", "oo+", " # reopen in read-write",
 
# 189 "project/radare2/libr/core/cmd_open.c" 3 4
((void *)0)

# 190 "project/radare2/libr/core/cmd_open.c"
};

static const char *help_msg_oob[] = {
 "Usage:", "oob", " # reopen loading rbin info",
 
# 194 "project/radare2/libr/core/cmd_open.c" 3 4
((void *)0)

# 195 "project/radare2/libr/core/cmd_open.c"
};
...
# 202 "project/radare2/libr/core/cmd_open.c" 3 4
((void *)0)

# 203 "project/radare2/libr/core/cmd_open.c"
};
...
# 209 "project/radare2/libr/core/cmd_open.c" 3 4
((void *)0)

# 210 "project/radare2/libr/core/cmd_open.c"
};
...
# 216 "project/radare2/libr/core/cmd_open.c" 3 4
((void *)0)

# 217 "project/radare2/libr/core/cmd_open.c"
};


static void cmd_open_bin(RCore *core, const char *input) {
 const char *value = 
# 221 "project/radare2/libr/core/cmd_open.c" 3 4
                    ((void *)0)
# 221 "project/radare2/libr/core/cmd_open.c"
                        ;
 
# 222 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned int 
# 222 "project/radare2/libr/core/cmd_open.c"
     binfile_num = -1;
...
# 240 "project/radare2/libr/core/cmd_open.c" 3 4
  unsigned long long 
# 240 "project/radare2/libr/core/cmd_open.c"
       at = core->offset;
   if (*arg) {
 ...
 case 'a':
  ...
  if (input[2] && input[3]) {
   ...
   if (filename && *filename && (filename[1] == '/' || filename[1] == '.')) {
    ...
    RIODesc *desc = r_io_open (core->io, filename + 1, 
# 263 "project/radare2/libr/core/cmd_open.c" 3 4
                                                      (4|1)
# 263 "project/radare2/libr/core/cmd_open.c"
                                                               , 0);
    if (desc) {
     *filename = 0;
     
# 266 "project/radare2/libr/core/cmd_open.c" 3 4
    unsigned long long 
# 266 "project/radare2/libr/core/cmd_open.c"
...
# 274 "project/radare2/libr/core/cmd_open.c" 3 4
    fprintf(__stderrp,
# 274 "project/radare2/libr/core/cmd_open.c"
...
# 277 "project/radare2/libr/core/cmd_open.c" 3 4
   unsigned long long 
# 277 "project/radare2/libr/core/cmd_open.c"
        baddr = r_num_math (core->num, filename);
    
# 278 "project/radare2/libr/core/cmd_open.c" 3 4
   unsigned long long 
# 278 "project/radare2/libr/core/cmd_open.c"
...
# 290 "project/radare2/libr/core/cmd_open.c" 3 4
    fprintf(__stderrp,
# 290 "project/radare2/libr/core/cmd_open.c"
...
# 293 "project/radare2/libr/core/cmd_open.c" 3 4
   unsigned long long 
# 293 "project/radare2/libr/core/cmd_open.c"
        addr = r_num_math (core->num, input + 2);
    int fd = r_io_fd_get_current (core->io);
    RIODesc *desc = r_io_desc_get (core->io, fd);
    if (desc) {
...
# 305 "project/radare2/libr/core/cmd_open.c" 3 4
    fprintf(__stderrp,
# 305 "project/radare2/libr/core/cmd_open.c"
    "No file to load bin from?\n"
# 305 "project/radare2/libr/core/cmd_open.c" 3 4
    )
# 305 "project/radare2/libr/core/cmd_open.c"
   ...
   RIODesc *desc;
   RListIter *iter;
   RList *files = r_list_newf (
# 313 "project/radare2/libr/core/cmd_open.c" 3 4
                              ((void *)0)
# 313 "project/radare2/libr/core/cmd_open.c"
                                  );
   
# 314 "project/radare2/libr/core/cmd_open.c" 3 4
  if (
# 314 "project/radare2/libr/core/cmd_open.c"
  ofiles
# 314 "project/radare2/libr/core/cmd_open.c" 3 4
  ) for (
# 314 "project/radare2/libr/core/cmd_open.c"
...
# 319 "project/radare2/libr/core/cmd_open.c" 3 4
  if (
# 319 "project/radare2/libr/core/cmd_open.c"
  files
# 319 "project/radare2/libr/core/cmd_open.c" 3 4
  ) for (
# 319 "project/radare2/libr/core/cmd_open.c"
...
# 332 "project/radare2/libr/core/cmd_open.c" 3 4
 unsigned int 
# 332 "project/radare2/libr/core/cmd_open.c"
      id;
  const char *tmp;
  if (input[2] == '-' || input[2] == '*') {
   core->allbins = 
# 335 "project/radare2/libr/core/cmd_open.c" 3 4
                  1
# 335 "project/radare2/libr/core/cmd_open.c"
                      ;
   break;
  }
  core->allbins = 
# 338 "project/radare2/libr/core/cmd_open.c" 3 4
                 0
# 338 "project/radare2/libr/core/cmd_open.c"
                      ;

  char *v = input[2] ? strdup (input + 2) : 
# 340 "project/radare2/libr/core/cmd_open.c" 3 4
                                           ((void *)0)
# 340 "project/radare2/libr/core/cmd_open.c"
                                               ;
  if (!v) {
   
# 342 "project/radare2/libr/core/cmd_open.c" 3 4
  fprintf(__stderrp,
# 342 "project/radare2/libr/core/cmd_open.c"
  "Invalid arguments"
# 342 "project/radare2/libr/core/cmd_open.c" 3 4
  )
# 342 "project/radare2/libr/core/cmd_open.c"
...
# 347 "project/radare2/libr/core/cmd_open.c" 3 4
  fprintf(__stderrp,
# 347 "project/radare2/libr/core/cmd_open.c"
  "Usage: ob [file|objid]\n"
# 347 "project/radare2/libr/core/cmd_open.c" 3 4
  )
# 347 "project/radare2/libr/core/cmd_open.c"
  ...
  id = *v && r_is_valid_input_num_value (core->num, tmp)
   ? r_get_input_num_value (core->num, tmp): 
# 353 "project/radare2/libr/core/cmd_open.c" 3 4
                                            0xFFFFFFFFU
# 353 "project/radare2/libr/core/cmd_open.c"
                                                    ;
  if (n == 2) {
 ...
 case 'f':
  if (input[2] == ' ') {
   ...
   r_core_bin_load (core, 
# 371 "project/radare2/libr/core/cmd_open.c" 3 4
                         ((void *)0)
# 371 "project/radare2/libr/core/cmd_open.c"
                             , 
# 371 "project/radare2/libr/core/cmd_open.c" 3 4
...
# 372 "project/radare2/libr/core/cmd_open.c" 3 4
                                 ((void *)0)
# 372 "project/radare2/libr/core/cmd_open.c"
                                     ;
  }
  break;
 case 'o':
...
# 377 "project/radare2/libr/core/cmd_open.c" 3 4
  unsigned int 
# 377 "project/radare2/libr/core/cmd_open.c"
       fd = r_num_math (core->num, input + 3);
   RBinFile *bf = r_bin_file_find_by_fd (core->bin, fd);
   if (!bf || !r_core_bin_raise (core, bf->id)) {
    
# 380 "project/radare2/libr/core/cmd_open.c" 3 4
   fprintf(__stderrp,
# 380 "project/radare2/libr/core/cmd_open.c"
   "Invalid RBinFile.id number.\n"
# 380 "project/radare2/libr/core/cmd_open.c" 3 4
   )
# 380 "project/radare2/libr/core/cmd_open.c"
                                            ;
...
# 383 "project/radare2/libr/core/cmd_open.c" 3 4
  fprintf(__stderrp,
# 383 "project/radare2/libr/core/cmd_open.c"
  "Usage: obb [bfid]\n"
# 383 "project/radare2/libr/core/cmd_open.c" 3 4
  )
# 383 "project/radare2/libr/core/cmd_open.c"
...
# 390 "project/radare2/libr/core/cmd_open.c" 3 4
  unsigned int 
# 390 "project/radare2/libr/core/cmd_open.c"
       id;
   value = r_str_trim_head_ro (input + 2);
   if (!value) {
    
# 393 "project/radare2/libr/core/cmd_open.c" 3 4
   fprintf(__stderrp,
# 393 "project/radare2/libr/core/cmd_open.c"
   "Invalid argument\n"
# 393 "project/radare2/libr/core/cmd_open.c" 3 4
   )
# 393 "project/radare2/libr/core/cmd_open.c"
   ...
   id = (*value && r_is_valid_input_num_value (core->num, value)) ?
     r_get_input_num_value (core->num, value) : 
# 397 "project/radare2/libr/core/cmd_open.c" 3 4
                                               0xFFFFFFFFU
# 397 "project/radare2/libr/core/cmd_open.c"
                                                       ;
   RBinFile *bf = r_bin_file_find_by_id (core->bin, id);
   if (!bf) {
    
# 400 "project/radare2/libr/core/cmd_open.c" 3 4
   fprintf(__stderrp,
# 400 "project/radare2/libr/core/cmd_open.c"
   "Invalid binid\n"
# 400 "project/radare2/libr/core/cmd_open.c" 3 4
   )
# 400 "project/radare2/libr/core/cmd_open.c"
...
# 404 "project/radare2/libr/core/cmd_open.c" 3 4
   fprintf(__stderrp,
# 404 "project/radare2/libr/core/cmd_open.c"
   "Cannot find an RBinFile associated with that id.\n"
# 404 "project/radare2/libr/core/cmd_open.c" 3 4
   )
# 404 "project/radare2/libr/core/cmd_open.c"
                                                                 ;
 ...
 case '=':
  {
   ...
   RBinFile *bf = 
# 413 "project/radare2/libr/core/cmd_open.c" 3 4
                 ((void *)0)
# 413 "project/radare2/libr/core/cmd_open.c"
                     ;
   RBin *bin = core->bin;
   if (!bin) {
    return;
...
# 418 "project/radare2/libr/core/cmd_open.c" 3 4
  if (
# 418 "project/radare2/libr/core/cmd_open.c"
  bin->binfiles
# 418 "project/radare2/libr/core/cmd_open.c" 3 4
  ) for (
# 418 "project/radare2/libr/core/cmd_open.c"
...
# 418 "project/radare2/libr/core/cmd_open.c"
   ...
   r_table_visual_list (table, list, core->offset, core->blocksize,
    r_cons_get_size (
# 428 "project/radare2/libr/core/cmd_open.c" 3 4
                    ((void *)0)
# 428 "project/radare2/libr/core/cmd_open.c"
                        ), r_config_get_i (core->config, "scr.color"));
   char *table_text = r_table_tostring (table);
   if (table_text) {
    r_cons_printf ("\n%s\n", table_text);
    
# 432 "project/radare2/libr/core/cmd_open.c" 3 4
   free((
# 432 "project/radare2/libr/core/cmd_open.c"
   table_text
# 432 "project/radare2/libr/core/cmd_open.c" 3 4
   ))
# 432 "project/radare2/libr/core/cmd_open.c"
...
static void map_list(RIO *io, 
# 444 "project/radare2/libr/core/cmd_open.c" 3 4
                             unsigned long long 
# 444 "project/radare2/libr/core/cmd_open.c"
                                  off, int mode, RPrint *print, int fd) {
 
# 445 "project/radare2/libr/core/cmd_open.c" 3 4
do { if (!(
# 445 "project/radare2/libr/core/cmd_open.c"
io && print && print->cb_printf
# 445 "project/radare2/libr/core/cmd_open.c" 3 4
...
# 445 "project/radare2/libr/core/cmd_open.c"
                                                  ;
 PJ *pj = 
# 446 "project/radare2/libr/core/cmd_open.c" 3 4
         ((void *)0)
# 446 "project/radare2/libr/core/cmd_open.c"
             ;
 if (mode == 'j') {
  pj = pj_new ();
  if (!pj) {
 ...
 char *om_cmds = 
# 454 "project/radare2/libr/core/cmd_open.c" 3 4
                ((void *)0)
# 454 "project/radare2/libr/core/cmd_open.c"
                    ;

 
# 456 "project/radare2/libr/core/cmd_open.c" 3 4
_Bool 
# 456 "project/radare2/libr/core/cmd_open.c"
     check_for_current_map = 
# 456 "project/radare2/libr/core/cmd_open.c" 3 4
                             1
# 456 "project/radare2/libr/core/cmd_open.c"
                                 ;
...
# 464 "project/radare2/libr/core/cmd_open.c" 3 4
if (
# 464 "project/radare2/libr/core/cmd_open.c"
bank->maprefs
# 464 "project/radare2/libr/core/cmd_open.c" 3 4
) for (
# 464 "project/radare2/libr/core/cmd_open.c"
...
# 464 "project/radare2/libr/core/cmd_open.c"
  ...
  case 'q':
   if (fd == -2) {
    print->cb_printf ("0x%08"
# 472 "project/radare2/libr/core/cmd_open.c" 3 4
                            "llx"
# 472 "project/radare2/libr/core/cmd_open.c"
                                   "\n", 
# 472 "project/radare2/libr/core/cmd_open.c" 3 4
                                         r_itv_begin (
# 472 "project/radare2/libr/core/cmd_open.c"
...
# 472 "project/radare2/libr/core/cmd_open.c"
  ...
  case 'j':
   ...
   pj_kn (pj, "from", 
# 482 "project/radare2/libr/core/cmd_open.c" 3 4
                     r_itv_begin (
# 482 "project/radare2/libr/core/cmd_open.c"
                     map
# 482 "project/radare2/libr/core/cmd_open.c" 3 4
                     ->itv)
# 482 "project/radare2/libr/core/cmd_open.c"
   ...
   pj_kn (pj, "to", 
# 483 "project/radare2/libr/core/cmd_open.c" 3 4
                   ( r_itv_end (
# 483 "project/radare2/libr/core/cmd_open.c"
                   map
# 483 "project/radare2/libr/core/cmd_open.c" 3 4
                   ->itv) - 1 )
# 483 "project/radare2/libr/core/cmd_open.c"
  ...
  case 'r': {
   ...
   char *om_cmd = r_str_newf ("om %d 0x%08"
# 492 "project/radare2/libr/core/cmd_open.c" 3 4
                                          "llx"
# 492 "project/radare2/libr/core/cmd_open.c"
                                                 " 0x%08"
# 492 "project/radare2/libr/core/cmd_open.c" 3 4
                                                         "llx"
     
# 493 "project/radare2/libr/core/cmd_open.c"
    " 0x%08"
# 493 "project/radare2/libr/core/cmd_open.c" 3 4
            "llx"
# 493 "project/radare2/libr/core/cmd_open.c"
                   " %s%s%s\n", map->fd, 
# 493 "project/radare2/libr/core/cmd_open.c" 3 4
...
# 494 "project/radare2/libr/core/cmd_open.c" 3 4
    r_itv_size (
# 494 "project/radare2/libr/core/cmd_open.c"
    map
# 494 "project/radare2/libr/core/cmd_open.c" 3 4
    ->itv)
# 494 "project/radare2/libr/core/cmd_open.c"
...
# 495 "project/radare2/libr/core/cmd_open.c" 3 4
    (!(
# 495 "project/radare2/libr/core/cmd_open.c"
    map->name
# 495 "project/radare2/libr/core/cmd_open.c" 3 4
    ) || !*(
# 495 "project/radare2/libr/core/cmd_open.c"
...
# 495 "project/radare2/libr/core/cmd_open.c"
  ...
  default:
   print->cb_printf ("%c%2d fd: %i +0x%08"
# 503 "project/radare2/libr/core/cmd_open.c" 3 4
                                         "llx"
# 503 "project/radare2/libr/core/cmd_open.c"
                                                " 0x%08"
# 503 "project/radare2/libr/core/cmd_open.c" 3 4
                                                        "llx"
     
# 504 "project/radare2/libr/core/cmd_open.c"
    " - 0x%08"
# 504 "project/radare2/libr/core/cmd_open.c" 3 4
              "llx"
# 504 "project/radare2/libr/core/cmd_open.c"
                     " %s %s\n",
     (check_for_current_map && 
# 505 "project/radare2/libr/core/cmd_open.c" 3 4
                              r_itv_contain (
# 505 "project/radare2/libr/core/cmd_open.c"
                              map
# 505 "project/radare2/libr/core/cmd_open.c" 3 4
                              ->itv, 
# 505 "project/radare2/libr/core/cmd_open.c"
...
# 505 "project/radare2/libr/core/cmd_open.c"
     ...
     '*' : '-', map->id, map->fd, map->delta, 
# 506 "project/radare2/libr/core/cmd_open.c" 3 4
                                             r_itv_begin (
# 506 "project/radare2/libr/core/cmd_open.c"
                                             map
# 506 "project/radare2/libr/core/cmd_open.c" 3 4
                                             ->itv)
# 506 "project/radare2/libr/core/cmd_open.c"
...
# 507 "project/radare2/libr/core/cmd_open.c" 3 4
    ( r_itv_end (
# 507 "project/radare2/libr/core/cmd_open.c"
    map
# 507 "project/radare2/libr/core/cmd_open.c" 3 4
    ->itv) - 1 )
# 507 "project/radare2/libr/core/cmd_open.c"
   ...
   check_for_current_map &= !
# 508 "project/radare2/libr/core/cmd_open.c" 3 4
                            r_itv_contain (
# 508 "project/radare2/libr/core/cmd_open.c"
                            map
# 508 "project/radare2/libr/core/cmd_open.c" 3 4
                            ->itv, 
# 508 "project/radare2/libr/core/cmd_open.c"
...
# 529 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned int 
# 529 "project/radare2/libr/core/cmd_open.c"
     mapid;
...
static void r_core_cmd_omt(RCore *core, const char *arg) {
 ...
 r_table_set_columnsf (t, "nnnnnnnss", "id", "fd", "pa", "pa_end", "size", "va", "va_end", "perm", "name", 
# 582 "project/radare2/libr/core/cmd_open.c" 3 4
                                                                                                          ((void *)0)
# 582 "project/radare2/libr/core/cmd_open.c"
                                                                                                              );

 
# 584 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned int 
# 584 "project/radare2/libr/core/cmd_open.c"
     mapid;
 r_id_storage_get_lowest (core->io->maps, &mapid);
 do {
  RIOMap *m = r_id_storage_get (core->io->maps, mapid);
  
# 588 "project/radare2/libr/core/cmd_open.c" 3 4
 unsigned long long 
# 588 "project/radare2/libr/core/cmd_open.c"
      va = r_itv_begin (m->itv);
  
# 589 "project/radare2/libr/core/cmd_open.c" 3 4
 unsigned long long 
# 589 "project/radare2/libr/core/cmd_open.c"
      va_end = r_itv_end (m->itv);
  
# 590 "project/radare2/libr/core/cmd_open.c" 3 4
 unsigned long long 
# 590 "project/radare2/libr/core/cmd_open.c"
      pa = m->delta;
  
# 591 "project/radare2/libr/core/cmd_open.c" 3 4
 unsigned long long 
# 591 "project/radare2/libr/core/cmd_open.c"
      pa_size = r_itv_size (m->itv);
  
# 592 "project/radare2/libr/core/cmd_open.c" 3 4
 unsigned long long 
# 592 "project/radare2/libr/core/cmd_open.c"
      pa_end = pa + pa_size;
...
static 
# 606 "project/radare2/libr/core/cmd_open.c" 3 4
      _Bool 
# 606 "project/radare2/libr/core/cmd_open.c"
           cmd_om(RCore *core, const char *input) {
 char *s = strdup (input + 2);
 if (!s) {
  return 
# 609 "project/radare2/libr/core/cmd_open.c" 3 4
        0
# 609 "project/radare2/libr/core/cmd_open.c"
             ;
 }
 if (strchr (s, ' ')) {
  int fd = 0, rwx = 0;
  
# 613 "project/radare2/libr/core/cmd_open.c" 3 4
 unsigned long long 
# 613 "project/radare2/libr/core/cmd_open.c"
      size = 0, vaddr = 0, paddr = 0;
  const char *name = 
# 614 "project/radare2/libr/core/cmd_open.c" 3 4
                    ((void *)0)
# 614 "project/radare2/libr/core/cmd_open.c"
                        ;
  
# 615 "project/radare2/libr/core/cmd_open.c" 3 4
 _Bool 
# 615 "project/radare2/libr/core/cmd_open.c"
      rwx_arg = 
# 615 "project/radare2/libr/core/cmd_open.c" 3 4
                0
# 615 "project/radare2/libr/core/cmd_open.c"
                     ;
  RIODesc *desc = 
# 616 "project/radare2/libr/core/cmd_open.c" 3 4
                 ((void *)0)
# 616 "project/radare2/libr/core/cmd_open.c"
                     ;
  ...
  case 5:
   ...
   rwx_arg = 
# 624 "project/radare2/libr/core/cmd_open.c" 3 4
            1
# 624 "project/radare2/libr/core/cmd_open.c"
                ;
...
# 640 "project/radare2/libr/core/cmd_open.c" 3 4
  fprintf(__stderrp,
# 640 "project/radare2/libr/core/cmd_open.c"
  "Wrong fd, it must be greater than 3.\n"
# 640 "project/radare2/libr/core/cmd_open.c" 3 4
  )
# 640 "project/radare2/libr/core/cmd_open.c"
                                                    ;
   return 
# 641 "project/radare2/libr/core/cmd_open.c" 3 4
         0
# 641 "project/radare2/libr/core/cmd_open.c"
              ;
  }
...
# 654 "project/radare2/libr/core/cmd_open.c" 3 4
   fprintf(__stderrp,
# 654 "project/radare2/libr/core/cmd_open.c"
   "Cannot add map.\n"
# 654 "project/radare2/libr/core/cmd_open.c" 3 4
   )
# 654 "project/radare2/libr/core/cmd_open.c"
...
# 662 "project/radare2/libr/core/cmd_open.c" 3 4
  fprintf(__stderrp,
# 662 "project/radare2/libr/core/cmd_open.c"
  "Invalid fd %d\n", (int)fd
# 662 "project/radare2/libr/core/cmd_open.c" 3 4
  )
# 662 "project/radare2/libr/core/cmd_open.c"
 ...
 free (s);
 return 
# 666 "project/radare2/libr/core/cmd_open.c" 3 4
       1
# 666 "project/radare2/libr/core/cmd_open.c"
           ;
}
...
# 683 "project/radare2/libr/core/cmd_open.c" 3 4
   unsigned long long 
# 683 "project/radare2/libr/core/cmd_open.c"
        pa = core->offset;
    
# 684 "project/radare2/libr/core/cmd_open.c" 3 4
   unsigned long long 
# 684 "project/radare2/libr/core/cmd_open.c"
        va = r_num_math (core->num, r_list_get_n (args, 0));
    
# 685 "project/radare2/libr/core/cmd_open.c" 3 4
   unsigned long long 
# 685 "project/radare2/libr/core/cmd_open.c"
        vb = r_num_math (core->num, r_list_get_n (args, 1));
    
# 686 "project/radare2/libr/core/cmd_open.c" 3 4
   unsigned long long 
# 686 "project/radare2/libr/core/cmd_open.c"
        sz = vb - va;
    RIOMap *map = 
# 687 "project/radare2/libr/core/cmd_open.c" 3 4
                 ((void *)0)
# 687 "project/radare2/libr/core/cmd_open.c"
                     ;
    if (va < vb) {
...
# 692 "project/radare2/libr/core/cmd_open.c" 3 4
    fprintf(__stderrp,
# 692 "project/radare2/libr/core/cmd_open.c"
    "Cannot create map\n"
# 692 "project/radare2/libr/core/cmd_open.c" 3 4
    )
# 692 "project/radare2/libr/core/cmd_open.c"
...
# 701 "project/radare2/libr/core/cmd_open.c" 3 4
 free((
# 701 "project/radare2/libr/core/cmd_open.c"
 inp
# 701 "project/radare2/libr/core/cmd_open.c" 3 4
 ))
# 701 "project/radare2/libr/core/cmd_open.c"
...
# 703 "project/radare2/libr/core/cmd_open.c" 3 4
 fprintf(__stderrp,
# 703 "project/radare2/libr/core/cmd_open.c"
 "Cannot get any fd\n"
# 703 "project/radare2/libr/core/cmd_open.c" 3 4
 )
# 703 "project/radare2/libr/core/cmd_open.c"
...
# 712 "project/radare2/libr/core/cmd_open.c" 3 4
   unsigned int 
# 712 "project/radare2/libr/core/cmd_open.c"
        mapid;
    r_id_storage_get_lowest (core->io->maps, &mapid);
    do {
...
# 725 "project/radare2/libr/core/cmd_open.c" 3 4
   unsigned int 
# 725 "project/radare2/libr/core/cmd_open.c"
        bank_id = 0;
...
# 735 "project/radare2/libr/core/cmd_open.c" 3 4
    if (
# 735 "project/radare2/libr/core/cmd_open.c"
    bank->maprefs
# 735 "project/radare2/libr/core/cmd_open.c" 3 4
    ) for (
# 735 "project/radare2/libr/core/cmd_open.c"
  ...
  case '+':
   {
    ...
    if (
# 746 "project/radare2/libr/core/cmd_open.c" 3 4
       ((
# 746 "project/radare2/libr/core/cmd_open.c"
       *name
# 746 "project/radare2/libr/core/cmd_open.c" 3 4
       ) >= '0' && (
# 746 "project/radare2/libr/core/cmd_open.c"
...
# 746 "project/radare2/libr/core/cmd_open.c"
 ...
 case 'a':
  if (
# 768 "project/radare2/libr/core/cmd_open.c" 3 4
     ((
# 768 "project/radare2/libr/core/cmd_open.c"
     argv[1][0]
# 768 "project/radare2/libr/core/cmd_open.c" 3 4
     ) >= '0' && (
# 768 "project/radare2/libr/core/cmd_open.c"
...
# 773 "project/radare2/libr/core/cmd_open.c" 3 4
   fprintf(__stderrp,
# 773 "project/radare2/libr/core/cmd_open.c"
   "Invalid map id\n"
# 773 "project/radare2/libr/core/cmd_open.c" 3 4
   )
# 773 "project/radare2/libr/core/cmd_open.c"
...
# 776 "project/radare2/libr/core/cmd_open.c" 3 4
  fprintf(__stderrp,
# 776 "project/radare2/libr/core/cmd_open.c"
  "Expect a mapid number\n"
# 776 "project/radare2/libr/core/cmd_open.c" 3 4
  )
# 776 "project/radare2/libr/core/cmd_open.c"
                                     ;
...
# 786 "project/radare2/libr/core/cmd_open.c" 3 4
   fprintf(__stderrp,
# 786 "project/radare2/libr/core/cmd_open.c"
   "Unknown bank id\n"
# 786 "project/radare2/libr/core/cmd_open.c" 3 4
   )
# 786 "project/radare2/libr/core/cmd_open.c"
 ...
 case 0:
  {
   if (!r_io_bank_use (core->io, r_num_get (
# 807 "project/radare2/libr/core/cmd_open.c" 3 4
                                           ((void *)0)
# 807 "project/radare2/libr/core/cmd_open.c"
                                               , argv[1]))) {
    
# 808 "project/radare2/libr/core/cmd_open.c" 3 4
   fprintf(__stderrp,
# 808 "project/radare2/libr/core/cmd_open.c"
   "Cannot find bank by id %s\n", argv[1]
# 808 "project/radare2/libr/core/cmd_open.c" 3 4
   )
# 808 "project/radare2/libr/core/cmd_open.c"
                                                   ;
...
# 820 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned long long 
# 820 "project/radare2/libr/core/cmd_open.c"
     fd = 0LL;
 
# 821 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned int 
# 821 "project/radare2/libr/core/cmd_open.c"
     id = 0;
 
# 822 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned long long 
# 822 "project/radare2/libr/core/cmd_open.c"
     addr = 0;
 char *s = 
# 823 "project/radare2/libr/core/cmd_open.c" 3 4
          ((void *)0)
# 823 "project/radare2/libr/core/cmd_open.c"
              , *p = 
# 823 "project/radare2/libr/core/cmd_open.c" 3 4
                     ((void *)0)
# 823 "project/radare2/libr/core/cmd_open.c"
...
# 824 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned long long 
# 824 "project/radare2/libr/core/cmd_open.c"
     newaddr;
 RIOMap *map = 
# 825 "project/radare2/libr/core/cmd_open.c" 3 4
              ((void *)0)
# 825 "project/radare2/libr/core/cmd_open.c"
                  ;
 const char *P;
 PJ *pj;
 ...
 case '.':
  ...
  if (map) {
   if (input[2] == 'j') {
    ...
    pj_kn (pj, "delta", map->delta);
    pj_kn (pj, "from", 
# 842 "project/radare2/libr/core/cmd_open.c" 3 4
                      r_itv_begin (
# 842 "project/radare2/libr/core/cmd_open.c"
                      map
# 842 "project/radare2/libr/core/cmd_open.c" 3 4
                      ->itv)
# 842 "project/radare2/libr/core/cmd_open.c"
    ...
    pj_kn (pj, "to", 
# 843 "project/radare2/libr/core/cmd_open.c" 3 4
                    ( r_itv_end (
# 843 "project/radare2/libr/core/cmd_open.c"
                    map
# 843 "project/radare2/libr/core/cmd_open.c" 3 4
                    ->itv) - 1 )
# 843 "project/radare2/libr/core/cmd_open.c"
    ...
    core->print->cb_printf ("%2d fd: %i +0x%08"
# 852 "project/radare2/libr/core/cmd_open.c" 3 4
                                              "llx"
# 852 "project/radare2/libr/core/cmd_open.c"
                                                     " 0x%08"
# 852 "project/radare2/libr/core/cmd_open.c" 3 4
                                                             "llx"
     
# 853 "project/radare2/libr/core/cmd_open.c"
    " - 0x%08"
# 853 "project/radare2/libr/core/cmd_open.c" 3 4
              "llx"
# 853 "project/radare2/libr/core/cmd_open.c"
                     " %s %s\n", map->id, map->fd,
     map->delta, 
# 854 "project/radare2/libr/core/cmd_open.c" 3 4
                r_itv_begin (
# 854 "project/radare2/libr/core/cmd_open.c"
                map
# 854 "project/radare2/libr/core/cmd_open.c" 3 4
                ->itv)
# 854 "project/radare2/libr/core/cmd_open.c"
...
# 854 "project/radare2/libr/core/cmd_open.c"
 ...
 case 'r':
  ...
  if (P) {
   id = (
# 865 "project/radare2/libr/core/cmd_open.c" 3 4
        unsigned int
# 865 "project/radare2/libr/core/cmd_open.c"
...
# 882 "project/radare2/libr/core/cmd_open.c" 3 4
   unsigned long long 
# 882 "project/radare2/libr/core/cmd_open.c"
        dst = r_num_math (core->num, input + 3);
   ...
   if (P) {
    id = (
# 891 "project/radare2/libr/core/cmd_open.c" 3 4
         unsigned int
# 891 "project/radare2/libr/core/cmd_open.c"
             )r_num_math (core->num, input + 3);
    newaddr = r_num_math (core->num, P + 1);
 ...
 case 'o':
  if (input[2] == ' ') {
   r_core_cmdf (core, "om %s 0x%08" 
# 899 "project/radare2/libr/core/cmd_open.c" 3 4
                                   "llx" 
# 899 "project/radare2/libr/core/cmd_open.c"
                                           " $s r omo", input + 2, core->offset);
  } else {
 ...
 case 'p':
  switch (input[2]) {
  case 'd':
   id = r_num_math (core->num, input + 3);
   if (r_io_map_exists_for_id (core->io, id)) {
    r_io_map_depriorize (core->io, id);
   } else {
    
# 912 "project/radare2/libr/core/cmd_open.c" 3 4
   fprintf(__stderrp,
# 912 "project/radare2/libr/core/cmd_open.c"
...
# 918 "project/radare2/libr/core/cmd_open.c" 3 4
   fprintf(__stderrp,
# 918 "project/radare2/libr/core/cmd_open.c"
   "Cannot prioritize any map for fd %d\n", (int)fd
# 918 "project/radare2/libr/core/cmd_open.c" 3 4
   )
# 918 "project/radare2/libr/core/cmd_open.c"
                                                             ;
  ...
  case 'b':
   id = (
# 922 "project/radare2/libr/core/cmd_open.c" 3 4
        unsigned int
# 922 "project/radare2/libr/core/cmd_open.c"
            )r_num_math (core->num, input + 4);
   if (!r_bin_file_set_cur_by_id (core->bin, id)) {
    
# 924 "project/radare2/libr/core/cmd_open.c" 3 4
   fprintf(__stderrp,
# 924 "project/radare2/libr/core/cmd_open.c"
   "Cannot prioritize bin with fd %d\n", id
# 924 "project/radare2/libr/core/cmd_open.c" 3 4
   )
# 924 "project/radare2/libr/core/cmd_open.c"
                                                     ;
...
# 933 "project/radare2/libr/core/cmd_open.c" 3 4
   fprintf(__stderrp,
# 933 "project/radare2/libr/core/cmd_open.c"
   "Cannot find any map with mapid %d\n", id
# 933 "project/radare2/libr/core/cmd_open.c" 3 4
   )
# 933 "project/radare2/libr/core/cmd_open.c"
...
# 963 "project/radare2/libr/core/cmd_open.c" 3 4
  _Bool 
# 963 "project/radare2/libr/core/cmd_open.c"
       use_id = (input[2] == 'i') ? 
# 963 "project/radare2/libr/core/cmd_open.c" 3 4
                                    1 
# 963 "project/radare2/libr/core/cmd_open.c"
...
# 963 "project/radare2/libr/core/cmd_open.c"
   ...
   if (!(q = strchr (s, ' '))) {
    if (use_id) {
     id = (
# 979 "project/radare2/libr/core/cmd_open.c" 3 4
          unsigned int
# 979 "project/radare2/libr/core/cmd_open.c"
              )r_num_math (core->num, s);
   ...
   *q = '\0';
   ...
   if (use_id) {
    id = (
# 992 "project/radare2/libr/core/cmd_open.c" 3 4
         unsigned int
# 992 "project/radare2/libr/core/cmd_open.c"
             )r_num_math (core->num, s);
    map = r_io_map_get (core->io, id);
   } else {
    addr = r_num_math (core->num, s);
...
# 1010 "project/radare2/libr/core/cmd_open.c" 3 4
  unsigned int 
# 1010 "project/radare2/libr/core/cmd_open.c"
       fd = input[2]? r_num_math (core->num, input + 2): r_io_fd_get_current (core->io);
   RIODesc *desc = r_io_desc_get (core->io, fd);
   if (desc) {
    map = r_io_map_add (core->io, fd, desc->perm, 0, 0, 
# 1013 "project/radare2/libr/core/cmd_open.c" 3 4
                                                       0xFFFFFFFFFFFFFFFFULL
# 1013 "project/radare2/libr/core/cmd_open.c"
                                                               );
    if (map) {
...
# 1018 "project/radare2/libr/core/cmd_open.c" 3 4
   fprintf(__stderrp,
# 1018 "project/radare2/libr/core/cmd_open.c"
   "Usage: omm [fd]\n"
# 1018 "project/radare2/libr/core/cmd_open.c" 3 4
   )
# 1018 "project/radare2/libr/core/cmd_open.c"
...
# 1024 "project/radare2/libr/core/cmd_open.c" 3 4
  unsigned int 
# 1024 "project/radare2/libr/core/cmd_open.c"
       fd = input[2]? r_num_math (core->num, input + 2): r_io_fd_get_current (core->io);
   RIODesc *desc = r_io_desc_get (core->io, fd);
   if (desc) {
    
# 1027 "project/radare2/libr/core/cmd_open.c" 3 4
   unsigned long long 
# 1027 "project/radare2/libr/core/cmd_open.c"
...
# 1033 "project/radare2/libr/core/cmd_open.c" 3 4
   fprintf(__stderrp,
# 1033 "project/radare2/libr/core/cmd_open.c"
   "Usage: omm [fd]\n"
# 1033 "project/radare2/libr/core/cmd_open.c" 3 4
   )
# 1033 "project/radare2/libr/core/cmd_open.c"
...
# 1097 "project/radare2/libr/core/cmd_open.c" 3 4
 if (
# 1097 "project/radare2/libr/core/cmd_open.c"
 bank->maprefs
# 1097 "project/radare2/libr/core/cmd_open.c" 3 4
 ) for (
# 1097 "project/radare2/libr/core/cmd_open.c"
...
# 1100 "project/radare2/libr/core/cmd_open.c" 3 4
  __builtin___snprintf_chk (
# 1100 "project/radare2/libr/core/cmd_open.c"
  temp
# 1100 "project/radare2/libr/core/cmd_open.c" 3 4
  , 
# 1100 "project/radare2/libr/core/cmd_open.c"
...
# 1100 "project/radare2/libr/core/cmd_open.c"
  ...
  r_table_visual_list (table, list, core->offset, core->blocksize,
   r_cons_get_size (
# 1109 "project/radare2/libr/core/cmd_open.c" 3 4
                   ((void *)0)
# 1109 "project/radare2/libr/core/cmd_open.c"
                       ), r_config_get_i (core->config, "scr.color"));
...
# 1121 "project/radare2/libr/core/cmd_open.c" 3 4
{ free((void *)
# 1121 "project/radare2/libr/core/cmd_open.c"
s
# 1121 "project/radare2/libr/core/cmd_open.c" 3 4
); 
# 1121 "project/radare2/libr/core/cmd_open.c"
...
static 
# 1125 "project/radare2/libr/core/cmd_open.c" 3 4
      _Bool 
# 1125 "project/radare2/libr/core/cmd_open.c"
           reopen_in_malloc_cb(void *user, void *data, 
# 1125 "project/radare2/libr/core/cmd_open.c" 3 4
                                                       unsigned int 
# 1125 "project/radare2/libr/core/cmd_open.c"
                                                            id) {
 ...
 if (r_io_desc_is_blockdevice (desc) || r_io_desc_is_dbg (desc)) {
  return 
# 1130 "project/radare2/libr/core/cmd_open.c" 3 4
        1
# 1130 "project/radare2/libr/core/cmd_open.c"
            ;
 }

 if (strstr (desc->uri, "://")) {
  return 
# 1134 "project/radare2/libr/core/cmd_open.c" 3 4
        1
# 1134 "project/radare2/libr/core/cmd_open.c"
            ;
 }

 
# 1137 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned long long 
# 1137 "project/radare2/libr/core/cmd_open.c"
     size = r_io_desc_size (desc);

 char *uri = r_str_newf ("malloc://%"
# 1139 "project/radare2/libr/core/cmd_open.c" 3 4
                                    "llu"
# 1139 "project/radare2/libr/core/cmd_open.c"
                                           , size);
 if (!uri) {
  return 
# 1141 "project/radare2/libr/core/cmd_open.c" 3 4
        0
# 1141 "project/radare2/libr/core/cmd_open.c"
             ;
 }

 
# 1144 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned char 
# 1144 "project/radare2/libr/core/cmd_open.c"
    *buf = malloc (size);

 if (!buf) {
  free (uri);
  return 
# 1148 "project/radare2/libr/core/cmd_open.c" 3 4
        0
# 1148 "project/radare2/libr/core/cmd_open.c"
             ;
 }

 RIODesc *ndesc = r_io_open_nomap (io, uri, 
# 1151 "project/radare2/libr/core/cmd_open.c" 3 4
                                           (4|2)
# 1151 "project/radare2/libr/core/cmd_open.c"
                                                    , 0);
 free (uri);
 if (!ndesc) {
  free (buf);
  return 
# 1155 "project/radare2/libr/core/cmd_open.c" 3 4
        0
# 1155 "project/radare2/libr/core/cmd_open.c"
             ;
 }

 r_io_desc_read_at (desc, 0LL, buf, (int)size);
 ...
 r_io_desc_close (desc);
 return 
# 1164 "project/radare2/libr/core/cmd_open.c" 3 4
       1
# 1164 "project/radare2/libr/core/cmd_open.c"
           ;
}


# 1167 "project/radare2/libr/core/cmd_open.c" 3 4
__attribute__((visibility("default"))) 
# 1167 "project/radare2/libr/core/cmd_open.c"
     void r_core_file_reopen_in_malloc(RCore *core) {
...
# 1181 "project/radare2/libr/core/cmd_open.c" 3 4
 fprintf(__stderrp,
# 1181 "project/radare2/libr/core/cmd_open.c"
 "Warning: No sections found, functions and flags won't be rebased"
# 1181 "project/radare2/libr/core/cmd_open.c" 3 4
 )
# 1181 "project/radare2/libr/core/cmd_open.c"
                                                                             ;
...
# 1186 "project/radare2/libr/core/cmd_open.c" 3 4
if (
# 1186 "project/radare2/libr/core/cmd_open.c"
sections
# 1186 "project/radare2/libr/core/cmd_open.c" 3 4
) for (
# 1186 "project/radare2/libr/core/cmd_open.c"
...
# 1186 "project/radare2/libr/core/cmd_open.c"
                                   {
  RBinSection *old_sec = 
# 1187 "project/radare2/libr/core/cmd_open.c" 3 4
                        (
# 1187 "project/radare2/libr/core/cmd_open.c"
                        RBinSection
# 1187 "project/radare2/libr/core/cmd_open.c" 3 4
                        *)calloc(1,sizeof(
# 1187 "project/radare2/libr/core/cmd_open.c"
...
# 1187 "project/radare2/libr/core/cmd_open.c"
  ...
  *old_sec = *sec;
  ...
  old_sec->format = 
# 1193 "project/radare2/libr/core/cmd_open.c" 3 4
                   ((void *)0)
# 1193 "project/radare2/libr/core/cmd_open.c"
                       ;
...
# 1202 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned long long 
# 1202 "project/radare2/libr/core/cmd_open.c"
     old_base;
 
# 1203 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned long long 
# 1203 "project/radare2/libr/core/cmd_open.c"
     diff;
 int type;
};
...
static 
# 1210 "project/radare2/libr/core/cmd_open.c" 3 4
      _Bool 
# 1210 "project/radare2/libr/core/cmd_open.c"
           __rebase_flags(RFlagItem *flag, void *user) {
 struct __rebase_struct *reb = user;
 
# 1212 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned long long 
# 1212 "project/radare2/libr/core/cmd_open.c"
     old_base = reb->old_base;
 RListIter *it;
 RBinSection *sec;

 
# 1216 "project/radare2/libr/core/cmd_open.c" 3 4
if (
# 1216 "project/radare2/libr/core/cmd_open.c"
reb->old_sections
# 1216 "project/radare2/libr/core/cmd_open.c" 3 4
) for (
# 1216 "project/radare2/libr/core/cmd_open.c"
...
# 1216 "project/radare2/libr/core/cmd_open.c"
                                            {
  if ((flag->offset >= old_base + sec->vaddr && flag->offset <= old_base + sec->vaddr + sec->vsize)) {
   r_flag_set (reb->core->flags, flag->name, flag->offset + reb->diff, flag->size);
   break;
  }
 }
 return 
# 1222 "project/radare2/libr/core/cmd_open.c" 3 4
       1
# 1222 "project/radare2/libr/core/cmd_open.c"
           ;
}

static 
# 1225 "project/radare2/libr/core/cmd_open.c" 3 4
      _Bool 
# 1225 "project/radare2/libr/core/cmd_open.c"
           __rebase_refs_i(void *user, const 
# 1225 "project/radare2/libr/core/cmd_open.c" 3 4
                                             unsigned long long 
# 1225 "project/radare2/libr/core/cmd_open.c"
                                                  k, const void *v) {
 ...
 return 
# 1235 "project/radare2/libr/core/cmd_open.c" 3 4
       1
# 1235 "project/radare2/libr/core/cmd_open.c"
           ;
}

static 
# 1238 "project/radare2/libr/core/cmd_open.c" 3 4
      _Bool 
# 1238 "project/radare2/libr/core/cmd_open.c"
           __rebase_refs(void *user, const 
# 1238 "project/radare2/libr/core/cmd_open.c" 3 4
                                           unsigned long long 
# 1238 "project/radare2/libr/core/cmd_open.c"
                                                k, const void *v) {
 ...
 return 
# 1241 "project/radare2/libr/core/cmd_open.c" 3 4
       1
# 1241 "project/radare2/libr/core/cmd_open.c"
           ;
}

static void __rebase_everything(RCore *core, RList *old_sections, 
# 1244 "project/radare2/libr/core/cmd_open.c" 3 4
                                                                 unsigned long long 
# 1244 "project/radare2/libr/core/cmd_open.c"
                                                                      old_base) {
 RListIter *it, *itit, *ititit;
 RAnalFunction *fcn;
 
# 1247 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned long long 
# 1247 "project/radare2/libr/core/cmd_open.c"
     new_base = core->bin->cur->o->baddr_shift;
 RBinSection *old_section;
 
# 1249 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned long long 
# 1249 "project/radare2/libr/core/cmd_open.c"
...
# 1254 "project/radare2/libr/core/cmd_open.c" 3 4
if (
# 1254 "project/radare2/libr/core/cmd_open.c"
core->anal->fcns
# 1254 "project/radare2/libr/core/cmd_open.c" 3 4
) for (
# 1254 "project/radare2/libr/core/cmd_open.c"
...
# 1255 "project/radare2/libr/core/cmd_open.c" 3 4
 if (
# 1255 "project/radare2/libr/core/cmd_open.c"
 old_sections
# 1255 "project/radare2/libr/core/cmd_open.c" 3 4
 ) for (
# 1255 "project/radare2/libr/core/cmd_open.c"
...
# 1255 "project/radare2/libr/core/cmd_open.c"
                                                  {
   if (!(fcn->addr >= old_base + old_section->vaddr && fcn->addr <= old_base + old_section->vaddr + old_section->vsize)) {
    continue;
   }
...
# 1262 "project/radare2/libr/core/cmd_open.c" 3 4
  unsigned long long 
# 1262 "project/radare2/libr/core/cmd_open.c"
       new_sec_addr = new_base + old_section->vaddr;
   
# 1263 "project/radare2/libr/core/cmd_open.c" 3 4
  if (
# 1263 "project/radare2/libr/core/cmd_open.c"
  fcn->bbs
# 1263 "project/radare2/libr/core/cmd_open.c" 3 4
  ) for (
# 1263 "project/radare2/libr/core/cmd_open.c"
...
# 1263 "project/radare2/libr/core/cmd_open.c"
    ...
    if (bb->jump != 
# 1269 "project/radare2/libr/core/cmd_open.c" 3 4
                   0xFFFFFFFFFFFFFFFFULL
# 1269 "project/radare2/libr/core/cmd_open.c"
                           ) {
     bb->jump += diff;
    }
    if (bb->fail != 
# 1272 "project/radare2/libr/core/cmd_open.c" 3 4
                   0xFFFFFFFFFFFFFFFFULL
# 1272 "project/radare2/libr/core/cmd_open.c"
                           ) {
     bb->fail += diff;
    }
   }
 ...
 core->anal->dict_refs = 
# 1295 "project/radare2/libr/core/cmd_open.c" 3 4
                        ((void *)0)
# 1295 "project/radare2/libr/core/cmd_open.c"
                            ;
 core->anal->dict_xrefs = 
# 1296 "project/radare2/libr/core/cmd_open.c" 3 4
                         ((void *)0)
# 1296 "project/radare2/libr/core/cmd_open.c"
                             ;
...
# 1309 "project/radare2/libr/core/cmd_open.c" 3 4
__attribute__((visibility("default"))) 
# 1309 "project/radare2/libr/core/cmd_open.c"
     void r_core_file_reopen_remote_debug(RCore *core, char *uri, 
# 1309 "project/radare2/libr/core/cmd_open.c" 3 4
                                                                  unsigned long long 
# 1309 "project/radare2/libr/core/cmd_open.c"
                                                                       addr) {
...
# 1315 "project/radare2/libr/core/cmd_open.c" 3 4
 fprintf(__stderrp,
# 1315 "project/radare2/libr/core/cmd_open.c"
 "No file open?\n"
# 1315 "project/radare2/libr/core/cmd_open.c" 3 4
 )
# 1315 "project/radare2/libr/core/cmd_open.c"
...
# 1320 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned long long 
# 1320 "project/radare2/libr/core/cmd_open.c"
     old_base = core->bin->cur->o->baddr_shift;
 int bits = core->rasm->bits;
 r_config_set_i (core->config, "asm.bits", bits);
 r_config_set_b (core->config, "cfg.debug", 
# 1323 "project/radare2/libr/core/cmd_open.c" 3 4
                                           1
# 1323 "project/radare2/libr/core/cmd_open.c"
                                               );

 desc->referer = desc->uri;
 desc->uri = strdup (uri);

 if ((file = r_core_file_open (core, uri, 
# 1328 "project/radare2/libr/core/cmd_open.c" 3 4
                                         (4|2)
# 1328 "project/radare2/libr/core/cmd_open.c"
                                                  , addr))) {
  fd = file->fd;
  core->num->value = fd;
...
# 1342 "project/radare2/libr/core/cmd_open.c" 3 4
 fprintf(__stderrp,
# 1342 "project/radare2/libr/core/cmd_open.c"
 "cannot open file %s\n", uri
# 1342 "project/radare2/libr/core/cmd_open.c" 3 4
 )
# 1342 "project/radare2/libr/core/cmd_open.c"
...
# 1354 "project/radare2/libr/core/cmd_open.c" 3 4
__attribute__((visibility("default"))) 
# 1354 "project/radare2/libr/core/cmd_open.c"
     void r_core_file_reopen_debug(RCore *core, const char *args) {
 RIODesc *desc = core->io->desc;

 if (!desc || !desc->uri) {
  
# 1358 "project/radare2/libr/core/cmd_open.c" 3 4
 fprintf(__stderrp,
# 1358 "project/radare2/libr/core/cmd_open.c"
 "No file open?\n"
# 1358 "project/radare2/libr/core/cmd_open.c" 3 4
 )
# 1358 "project/radare2/libr/core/cmd_open.c"
 ...
 if (!(desc->plugin && desc->plugin->isdbg) && (desc->perm & 
# 1364 "project/radare2/libr/core/cmd_open.c" 3 4
                                                            2
# 1364 "project/radare2/libr/core/cmd_open.c"
                                                                    )) {
  
# 1365 "project/radare2/libr/core/cmd_open.c" 3 4
 fprintf(__stderrp,
# 1365 "project/radare2/libr/core/cmd_open.c"
 "Cannot debug file (%s) with permissions set to 0x%x.\n" "Reopening the original file in read-only mode.\n", desc->name, desc->perm
# 1365 "project/radare2/libr/core/cmd_open.c" 3 4
 )
                                                                              
# 1366 "project/radare2/libr/core/cmd_open.c"
                                                                             ;
  int fd = desc->fd;
  if (r_io_reopen (core->io, fd, 
# 1368 "project/radare2/libr/core/cmd_open.c" 3 4
                                (4|1)
# 1368 "project/radare2/libr/core/cmd_open.c"
                                         , 755)) {
   desc = r_io_desc_get (core->io, fd);
  } else {
   
# 1371 "project/radare2/libr/core/cmd_open.c" 3 4
  fprintf(__stderrp,
# 1371 "project/radare2/libr/core/cmd_open.c"
  "Cannot reopen\n"
# 1371 "project/radare2/libr/core/cmd_open.c" 3 4
  )
# 1371 "project/radare2/libr/core/cmd_open.c"
 ...
 char *binpath = (bf && bf->file) ? strdup (bf->file) : 
# 1377 "project/radare2/libr/core/cmd_open.c" 3 4
                                                       ((void *)0)
# 1377 "project/radare2/libr/core/cmd_open.c"
                                                           ;
 if (!binpath) {
...
# 1390 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned long long 
# 1390 "project/radare2/libr/core/cmd_open.c"
     old_base = core->bin->cur->o->baddr_shift;
 int bits = core->rasm->bits;
 ...
 desc->uri = newfile;
 desc->referer = 
# 1402 "project/radare2/libr/core/cmd_open.c" 3 4
                ((void *)0)
# 1402 "project/radare2/libr/core/cmd_open.c"
                    ;
 r_config_set_i (core->config, "asm.bits", bits);
 r_config_set_b (core->config, "cfg.debug", 
# 1404 "project/radare2/libr/core/cmd_open.c" 3 4
                                           1
# 1404 "project/radare2/libr/core/cmd_open.c"
                                               );
...
static 
# 1418 "project/radare2/libr/core/cmd_open.c" 3 4
      _Bool 
# 1418 "project/radare2/libr/core/cmd_open.c"
           init_desc_list_visual_cb(void *user, void *data, 
# 1418 "project/radare2/libr/core/cmd_open.c" 3 4
                                                            unsigned int 
# 1418 "project/radare2/libr/core/cmd_open.c"
                                                                 id) {
...
# 1420 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned long long 
# 1420 "project/radare2/libr/core/cmd_open.c"
     sz = r_io_desc_size (desc);
 if (sz > fdsz) {
  fdsz = sz;
 }
 return 
# 1424 "project/radare2/libr/core/cmd_open.c" 3 4
       1
# 1424 "project/radare2/libr/core/cmd_open.c"
           ;
}

static 
# 1427 "project/radare2/libr/core/cmd_open.c" 3 4
      _Bool 
# 1427 "project/radare2/libr/core/cmd_open.c"
           desc_list_visual_cb(void *user, void *data, 
# 1427 "project/radare2/libr/core/cmd_open.c" 3 4
                                                       unsigned int 
# 1427 "project/radare2/libr/core/cmd_open.c"
                                                            id) {
...
# 1430 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned long long 
# 1430 "project/radare2/libr/core/cmd_open.c"
     sz = r_io_desc_size (desc);
 r_cons_printf ("%2d %c %s 0x%08"
# 1431 "project/radare2/libr/core/cmd_open.c" 3 4
                                "llx"
# 1431 "project/radare2/libr/core/cmd_open.c"
                                       " ", desc->fd,
   (desc->io && (desc->io->desc == desc)) ? '*' : '-', r_str_rwx_i (desc->perm), sz);
 int flags = p->flags;
 p->flags &= ~
# 1434 "project/radare2/libr/core/cmd_open.c" 3 4
             0x00000008
# 1434 "project/radare2/libr/core/cmd_open.c"
                                 ;
 r_print_progressbar (p, sz * 100 / fdsz, r_cons_get_size (
# 1435 "project/radare2/libr/core/cmd_open.c" 3 4
                                                          ((void *)0)
# 1435 "project/radare2/libr/core/cmd_open.c"
                                                              ) - 40);
 p->flags = flags;
 r_cons_printf (" %s\n", desc->uri);
# 1452 "project/radare2/libr/core/cmd_open.c"
 return 
# 1452 "project/radare2/libr/core/cmd_open.c" 3 4
       1
# 1452 "project/radare2/libr/core/cmd_open.c"
           ;
}
...
static 
# 1455 "project/radare2/libr/core/cmd_open.c" 3 4
      _Bool 
# 1455 "project/radare2/libr/core/cmd_open.c"
           desc_list_quiet2_cb(void *user, void *data, 
# 1455 "project/radare2/libr/core/cmd_open.c" 3 4
                                                       unsigned int 
# 1455 "project/radare2/libr/core/cmd_open.c"
                                                            id) {
 ...
 p->cb_printf ("%d\n", desc->fd);
 return 
# 1459 "project/radare2/libr/core/cmd_open.c" 3 4
       0
# 1459 "project/radare2/libr/core/cmd_open.c"
            ;
}

static 
# 1462 "project/radare2/libr/core/cmd_open.c" 3 4
      _Bool 
# 1462 "project/radare2/libr/core/cmd_open.c"
           desc_list_quiet_cb(void *user, void *data, 
# 1462 "project/radare2/libr/core/cmd_open.c" 3 4
                                                      unsigned int 
# 1462 "project/radare2/libr/core/cmd_open.c"
                                                           id) {
 ...
 p->cb_printf ("%d\n", desc->fd);
 return 
# 1466 "project/radare2/libr/core/cmd_open.c" 3 4
       1
# 1466 "project/radare2/libr/core/cmd_open.c"
           ;
}

static 
# 1469 "project/radare2/libr/core/cmd_open.c" 3 4
      _Bool 
# 1469 "project/radare2/libr/core/cmd_open.c"
           desc_list_cmds_cb(void *user, void *data, 
# 1469 "project/radare2/libr/core/cmd_open.c" 3 4
                                                     unsigned int 
# 1469 "project/radare2/libr/core/cmd_open.c"
                                                          id) {
 ...
 RBinFile *bf = r_bin_file_find_by_fd (core->bin, desc->fd);
 if (bf) {
  p->cb_printf ("o %s 0x%08"
# 1475 "project/radare2/libr/core/cmd_open.c" 3 4
                           "llx"
# 1475 "project/radare2/libr/core/cmd_open.c"
 ...
 if (strstr (desc->uri, "null://")) {
  ...
  return 
# 1481 "project/radare2/libr/core/cmd_open.c" 3 4
        1
# 1481 "project/radare2/libr/core/cmd_open.c"
            ;
 }
...
# 1489 "project/radare2/libr/core/cmd_open.c" 3 4
if (
# 1489 "project/radare2/libr/core/cmd_open.c"
maps
# 1489 "project/radare2/libr/core/cmd_open.c" 3 4
) for (
# 1489 "project/radare2/libr/core/cmd_open.c"
...
# 1490 "project/radare2/libr/core/cmd_open.c" 3 4
 _Bool 
# 1490 "project/radare2/libr/core/cmd_open.c"
      map_from_bin = 
# 1490 "project/radare2/libr/core/cmd_open.c" 3 4
                     0
# 1490 "project/radare2/libr/core/cmd_open.c"
...
# 1491 "project/radare2/libr/core/cmd_open.c" 3 4
 _Bool 
# 1491 "project/radare2/libr/core/cmd_open.c"
      have_segments = 
# 1491 "project/radare2/libr/core/cmd_open.c" 3 4
                      0
# 1491 "project/radare2/libr/core/cmd_open.c"
...
# 1492 "project/radare2/libr/core/cmd_open.c" 3 4
 if (
# 1492 "project/radare2/libr/core/cmd_open.c"
 list
# 1492 "project/radare2/libr/core/cmd_open.c" 3 4
 ) for (
# 1492 "project/radare2/libr/core/cmd_open.c"
...
# 1492 "project/radare2/libr/core/cmd_open.c"
   ...
   if (sec->is_segment) {
    have_segments = 
# 1494 "project/radare2/libr/core/cmd_open.c" 3 4
                   1
# 1494 "project/radare2/libr/core/cmd_open.c"
                       ;
    if (sec->vaddr == map->itv.addr && sec->vsize == map->itv.size) {
     map_from_bin = 
# 1496 "project/radare2/libr/core/cmd_open.c" 3 4
                   1
# 1496 "project/radare2/libr/core/cmd_open.c"
                       ;
     break;
    }
   }
  ...
  if (!have_segments) {
   map_from_bin = 
# 1502 "project/radare2/libr/core/cmd_open.c" 3 4
                 1
# 1502 "project/radare2/libr/core/cmd_open.c"
                     ;
  }
  if (!map_from_bin) {

   
# 1506 "project/radare2/libr/core/cmd_open.c" 3 4
  unsigned long long 
# 1506 "project/radare2/libr/core/cmd_open.c"
       paddr = map->itv.addr;
   if (paddr == map->itv.addr) {
    paddr = 0;
   }
   
# 1510 "project/radare2/libr/core/cmd_open.c" 3 4
  unsigned long long 
# 1510 "project/radare2/libr/core/cmd_open.c"
       vaddr = map->itv.addr + map->delta;
   
# 1511 "project/radare2/libr/core/cmd_open.c" 3 4
  unsigned long long 
# 1511 "project/radare2/libr/core/cmd_open.c"
       vsize = map->itv.size;
   if (vsize > 0) {
    p->cb_printf ("om $d 0x%08"
# 1513 "project/radare2/libr/core/cmd_open.c" 3 4
                              "llx"
# 1513 "project/radare2/libr/core/cmd_open.c"
                                     " 0x%08"
# 1513 "project/radare2/libr/core/cmd_open.c" 3 4
                                             "llx"
# 1513 "project/radare2/libr/core/cmd_open.c"
...
# 1513 "project/radare2/libr/core/cmd_open.c"
 ...
 return 
# 1518 "project/radare2/libr/core/cmd_open.c" 3 4
       1
# 1518 "project/radare2/libr/core/cmd_open.c"
           ;
}
static 
# 1520 "project/radare2/libr/core/cmd_open.c" 3 4
      _Bool 
# 1520 "project/radare2/libr/core/cmd_open.c"
           desc_list_cb(void *user, void *data, 
# 1520 "project/radare2/libr/core/cmd_open.c" 3 4
                                                unsigned int 
# 1520 "project/radare2/libr/core/cmd_open.c"
                                                     id) {
 RPrint *p = (RPrint *)user;
 RIODesc *desc = (RIODesc *)data;
 p->cb_printf ("%2d %c %s 0x%08"
# 1523 "project/radare2/libr/core/cmd_open.c" 3 4
                               "llx"
# 1523 "project/radare2/libr/core/cmd_open.c"
                                      " %s\n", desc->fd,
   (desc->io && (desc->io->desc == desc)) ? '*' : '-',
   r_str_rwx_i (desc->perm), r_io_desc_size (desc), desc->uri);
 return 
# 1526 "project/radare2/libr/core/cmd_open.c" 3 4
       1
# 1526 "project/radare2/libr/core/cmd_open.c"
           ;
}

static 
# 1529 "project/radare2/libr/core/cmd_open.c" 3 4
      _Bool 
# 1529 "project/radare2/libr/core/cmd_open.c"
           desc_list_json_cb(void *user, void *data, 
# 1529 "project/radare2/libr/core/cmd_open.c" 3 4
                                                     unsigned int 
# 1529 "project/radare2/libr/core/cmd_open.c"
                                                          id) {
...
# 1533 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned long long 
# 1533 "project/radare2/libr/core/cmd_open.c"
     from = 0LL;
 pj_o (pj);
 ...
 pj_kn (pj, "from", from);
 pj_kb (pj, "writable", desc->perm & 
# 1539 "project/radare2/libr/core/cmd_open.c" 3 4
                                    2
# 1539 "project/radare2/libr/core/cmd_open.c"
                                            );
 pj_kN (pj, "size", r_io_desc_size (desc));
 pj_end (pj);
 return 
# 1542 "project/radare2/libr/core/cmd_open.c" 3 4
       1
# 1542 "project/radare2/libr/core/cmd_open.c"
           ;
}

static 
# 1545 "project/radare2/libr/core/cmd_open.c" 3 4
      _Bool 
# 1545 "project/radare2/libr/core/cmd_open.c"
           cmd_op(RCore *core, char mode, int fd) {
 ...
 if (next_fd >= 0 && next_fd != cur_fd && r_io_use_fd (core->io, next_fd)) {
  ...
  if (bf && r_core_bin_raise (core, bf->id)) {
   r_core_block_read (core);
   return 
# 1569 "project/radare2/libr/core/cmd_open.c" 3 4
         1
# 1569 "project/radare2/libr/core/cmd_open.c"
             ;
  }
...
static 
# 1576 "project/radare2/libr/core/cmd_open.c" 3 4
      _Bool 
# 1576 "project/radare2/libr/core/cmd_open.c"
           cmd_onn(RCore *core, const char* input) {
 char *ptr = r_str_trim_dup (input + 2);
 int perms = 
# 1578 "project/radare2/libr/core/cmd_open.c" 3 4
            4
# 1578 "project/radare2/libr/core/cmd_open.c"
                    ;
...
# 1584 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned long long 
# 1584 "project/radare2/libr/core/cmd_open.c"
     addr = 0LL;
 RIODesc *desc = r_io_open_at (core->io, ptr, perms, 0644, addr);
 if (!desc || desc->fd == -1) {
  
# 1587 "project/radare2/libr/core/cmd_open.c" 3 4
 fprintf(__stderrp,
# 1587 "project/radare2/libr/core/cmd_open.c"
 "Cannot open file '%s'\n", ptr
# 1587 "project/radare2/libr/core/cmd_open.c" 3 4
 )
# 1587 "project/radare2/libr/core/cmd_open.c"
  ...
  free (ptr);
  return 
# 1589 "project/radare2/libr/core/cmd_open.c" 3 4
        0
# 1589 "project/radare2/libr/core/cmd_open.c"
             ;
 }
 RList *maps = r_io_map_get_by_fd (core->io, desc->fd);
 if (maps) {
...
# 1595 "project/radare2/libr/core/cmd_open.c" 3 4
 if (
# 1595 "project/radare2/libr/core/cmd_open.c"
 maps
# 1595 "project/radare2/libr/core/cmd_open.c" 3 4
 ) for (
# 1595 "project/radare2/libr/core/cmd_open.c"
...
# 1595 "project/radare2/libr/core/cmd_open.c"
 ...
 free (ptr);
 return 
# 1601 "project/radare2/libr/core/cmd_open.c" 3 4
       1
# 1601 "project/radare2/libr/core/cmd_open.c"
           ;
}
...
static int cmd_open(void *data, const char *input) {
 ...
 int perms = 
# 1606 "project/radare2/libr/core/cmd_open.c" 3 4
            4
# 1606 "project/radare2/libr/core/cmd_open.c"
                    ;
 
# 1607 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned long long 
# 1607 "project/radare2/libr/core/cmd_open.c"
     baddr = r_config_get_i (core->config, "bin.baddr");
 
# 1608 "project/radare2/libr/core/cmd_open.c" 3 4
unsigned long long 
# 1608 "project/radare2/libr/core/cmd_open.c"
     addr = 0LL;
 int argc, fd = -1;
 RIODesc *file;
 RIODesc *desc;
 
# 1612 "project/radare2/libr/core/cmd_open.c" 3 4
_Bool 
# 1612 "project/radare2/libr/core/cmd_open.c"
     write = 
# 1612 "project/radare2/libr/core/cmd_open.c" 3 4
             0
# 1612 "project/radare2/libr/core/cmd_open.c"
                  ;
 const char *ptr = 
# 1613 "project/radare2/libr/core/cmd_open.c" 3 4
                  ((void *)0)
# 1613 "project/radare2/libr/core/cmd_open.c"
                      ;
 char **argv = 
# 1614 "project/radare2/libr/core/cmd_open.c" 3 4
              ((void *)0)
# 1614 "project/radare2/libr/core/cmd_open.c"
                  ;
  ...
  case '*':
   {
    RListIter *iter;
    RBinFile *bf = 
# 1622 "project/radare2/libr/core/cmd_open.c" 3 4
                  ((void *)0)
# 1622 "project/radare2/libr/core/cmd_open.c"
                      ;
    
# 1623 "project/radare2/libr/core/cmd_open.c" 3 4
   if (
# 1623 "project/radare2/libr/core/cmd_open.c"
   core->bin->binfiles
# 1623 "project/radare2/libr/core/cmd_open.c" 3 4
   ) for (
# 1623 "project/radare2/libr/core/cmd_open.c"
...
# 1625 "project/radare2/libr/core/cmd_open.c" 3 4
     fprintf(__stderrp,
# 1625 "project/radare2/libr/core/cmd_open.c"
  ...
  case ' ':
   {
    ...
    const char *arch = 
# 1638 "project/radare2/libr/core/cmd_open.c" 3 4
                      ((void *)0)
# 1638 "project/radare2/libr/core/cmd_open.c"
                          ;
    
# 1639 "project/radare2/libr/core/cmd_open.c" 3 4
   unsigned short 
# 1639 "project/radare2/libr/core/cmd_open.c"
        bits = 0;
    const char *filename = 
# 1640 "project/radare2/libr/core/cmd_open.c" 3 4
                          ((void *)0)
# 1640 "project/radare2/libr/core/cmd_open.c"
                              ;
    i = r_str_word_set0 (ptr);
    if (i < 2) {
     
# 1643 "project/radare2/libr/core/cmd_open.c" 3 4
    fprintf(__stderrp,
# 1643 "project/radare2/libr/core/cmd_open.c"
    "Missing argument\n"
# 1643 "project/radare2/libr/core/cmd_open.c" 3 4
    )
# 1643 "project/radare2/libr/core/cmd_open.c"
    ...
    RBinFile *file = 
# 1653 "project/radare2/libr/core/cmd_open.c" 3 4
                    ((void *)0)
# 1653 "project/radare2/libr/core/cmd_open.c"
                        ;
    if (filename) {
     file = r_bin_file_find_by_name (core->bin, filename);
     if (!file) {
      
# 1657 "project/radare2/libr/core/cmd_open.c" 3 4
     fprintf(__stderrp,
# 1657 "project/radare2/libr/core/cmd_open.c"
     "Cannot find file %s\n", filename
# 1657 "project/radare2/libr/core/cmd_open.c" 3 4
     )
# 1657 "project/radare2/libr/core/cmd_open.c"
...
# 1662 "project/radare2/libr/core/cmd_open.c" 3 4
    fprintf(__stderrp,
# 1662 "project/radare2/libr/core/cmd_open.c"
...
# 1692 "project/radare2/libr/core/cmd_open.c" 3 4
  fprintf(__stderrp,
# 1692 "project/radare2/libr/core/cmd_open.c"
  "TODO%c", 10
# 1692 "project/radare2/libr/core/cmd_open.c" 3 4
  )
# 1692 "project/radare2/libr/core/cmd_open.c"
  ...
  if (input[1] == '+') {
   write = 
# 1696 "project/radare2/libr/core/cmd_open.c" 3 4
          1
# 1696 "project/radare2/libr/core/cmd_open.c"
              ;
   perms |= 
# 1697 "project/radare2/libr/core/cmd_open.c" 3 4
           2
# 1697 "project/radare2/libr/core/cmd_open.c"
                   ;
   if (input[2] != ' ') {
    
# 1699 "project/radare2/libr/core/cmd_open.c" 3 4
   fprintf(__stderrp,
# 1699 "project/radare2/libr/core/cmd_open.c"
   "Usage: on+ file [addr] [rwx]\n"
# 1699 "project/radare2/libr/core/cmd_open.c" 3 4
   )
# 1699 "project/radare2/libr/core/cmd_open.c"
                                             ;
...
# 1706 "project/radare2/libr/core/cmd_open.c" 3 4
  fprintf(__stderrp,
# 1706 "project/radare2/libr/core/cmd_open.c"
  "Usage: on file [addr] [rwx]\n"
# 1706 "project/radare2/libr/core/cmd_open.c" 3 4
  )
# 1706 "project/radare2/libr/core/cmd_open.c"
...
# 1711 "project/radare2/libr/core/cmd_open.c" 3 4
  fprintf(__stderrp,
# 1711 "project/radare2/libr/core/cmd_open.c"
  "Usage: on%s file [addr] [rwx]\n", write?"+":""
# 1711 "project/radare2/libr/core/cmd_open.c" 3 4
  )
# 1711 "project/radare2/libr/core/cmd_open.c"
                                                           ;
...
# 1734 "project/radare2/libr/core/cmd_open.c" 3 4
  fprintf(__stderrp,
# 1734 "project/radare2/libr/core/cmd_open.c"
  "Cannot open file '%s'\n", ptr
# 1734 "project/radare2/libr/core/cmd_open.c" 3 4
  )
# 1734 "project/radare2/libr/core/cmd_open.c"
...
# 1757 "project/radare2/libr/core/cmd_open.c" 3 4
  fprintf(__stderrp,
# 1757 "project/radare2/libr/core/cmd_open.c"
  "Usage: of [arg...]\n"
# 1757 "project/radare2/libr/core/cmd_open.c" 3 4
  )
# 1757 "project/radare2/libr/core/cmd_open.c"
...
# 1768 "project/radare2/libr/core/cmd_open.c" 3 4
    fprintf(__stderrp,
# 1768 "project/radare2/libr/core/cmd_open.c"
    "Cannot find file\n"
# 1768 "project/radare2/libr/core/cmd_open.c" 3 4
    )
# 1768 "project/radare2/libr/core/cmd_open.c"
...
# 1777 "project/radare2/libr/core/cmd_open.c" 3 4
     fprintf(__stderrp,
# 1777 "project/radare2/libr/core/cmd_open.c"
     "Invalid fd number\n"
# 1777 "project/radare2/libr/core/cmd_open.c" 3 4
     )
# 1777 "project/radare2/libr/core/cmd_open.c"
 ...
 case '+':
  perms |= 
# 1793 "project/radare2/libr/core/cmd_open.c" 3 4
          2
# 1793 "project/radare2/libr/core/cmd_open.c"
                  ;
...
# 1799 "project/radare2/libr/core/cmd_open.c" 3 4
  fprintf(__stderrp,
# 1799 "project/radare2/libr/core/cmd_open.c"
  "Usage: o (uri://)[/path/to/file] (addr)\n"
# 1799 "project/radare2/libr/core/cmd_open.c" 3 4
  )
# 1799 "project/radare2/libr/core/cmd_open.c"
                                                       ;
  ...
  if (argv) {
   if (r_str_startswith (argv[0], "base64:")) {
    char *decoded = (char *)sdb_decode (argv[0] + 7, 
# 1805 "project/radare2/libr/core/cmd_open.c" 3 4
                                                    ((void *)0)
# 1805 "project/radare2/libr/core/cmd_open.c"
                                                        );
    if (decoded) {
     free (argv[0]);
     argv[0] = decoded;
  ...
  }
  {
   ...
   if ((file = r_core_file_open (core, argv0, perms, addr))) {
    ...
    if (addr == 0) {
     addr = 
# 1832 "project/radare2/libr/core/cmd_open.c" 3 4
           0xFFFFFFFFFFFFFFFFULL
# 1832 "project/radare2/libr/core/cmd_open.c"
                   ;
    }
    ...
    if (*input == '+') {
     RIODesc *desc = r_io_desc_get (core->io, fd);
     if (desc && (desc->perm & 
# 1837 "project/radare2/libr/core/cmd_open.c" 3 4
                              2
# 1837 "project/radare2/libr/core/cmd_open.c"
                                      )) {
      RListIter *iter;
...
# 1844 "project/radare2/libr/core/cmd_open.c" 3 4
     if (
# 1844 "project/radare2/libr/core/cmd_open.c"
     maplist
# 1844 "project/radare2/libr/core/cmd_open.c" 3 4
     ) for (
# 1844 "project/radare2/libr/core/cmd_open.c"
...
# 1844 "project/radare2/libr/core/cmd_open.c"
                                         {
       map->perm |= 
# 1845 "project/radare2/libr/core/cmd_open.c" 3 4
                   (2|1)
# 1845 "project/radare2/libr/core/cmd_open.c"
                            ;
      }
      r_list_free (maplist);
     } else {
      
# 1849 "project/radare2/libr/core/cmd_open.c" 3 4
     fprintf(__stderrp,
# 1849 "project/radare2/libr/core/cmd_open.c"
     "Error: %s is not writable\n", argv0
# 1849 "project/radare2/libr/core/cmd_open.c" 3 4
     )
# 1849 "project/radare2/libr/core/cmd_open.c"
                                                   ;
...
# 1853 "project/radare2/libr/core/cmd_open.c" 3 4
   fprintf(__stderrp,
# 1853 "project/radare2/libr/core/cmd_open.c"
   "cannot open file %s\n", argv0
# 1853 "project/radare2/libr/core/cmd_open.c" 3 4
   )
# 1853 "project/radare2/libr/core/cmd_open.c"
...
# 1898 "project/radare2/libr/core/cmd_open.c" 3 4
  fprintf(__stderrp,
# 1898 "project/radare2/libr/core/cmd_open.c"
  "This command is disabled in sandbox mode\n"
# 1898 "project/radare2/libr/core/cmd_open.c" 3 4
  )
# 1898 "project/radare2/libr/core/cmd_open.c"
                                                        ;
...
# 1903 "project/radare2/libr/core/cmd_open.c" 3 4
   fprintf(__stderrp,
# 1903 "project/radare2/libr/core/cmd_open.c"
   "Oops\n"
# 1903 "project/radare2/libr/core/cmd_open.c" 3 4
   )
# 1903 "project/radare2/libr/core/cmd_open.c"
...
# 1947 "project/radare2/libr/core/cmd_open.c" 3 4
    fprintf(__stderrp,
# 1947 "project/radare2/libr/core/cmd_open.c"
    "Unable to find file descriptor %d\n", fd
# 1947 "project/radare2/libr/core/cmd_open.c" 3 4
    )
# 1947 "project/radare2/libr/core/cmd_open.c"
                                                       ;
...
# 1979 "project/radare2/libr/core/cmd_open.c" 3 4
  unsigned char 
# 1979 "project/radare2/libr/core/cmd_open.c"
      *data = calloc (len, 1);
   r_io_read_at (core->io, core->offset, data, len);
   if ((file = r_core_file_open (core, uri, 
# 1981 "project/radare2/libr/core/cmd_open.c" 3 4
                                           (4|2|1)
# 1981 "project/radare2/libr/core/cmd_open.c"
                                                     , 0))) {
    fd = file->fd;
    core->num->value = fd;
...
# 1991 "project/radare2/libr/core/cmd_open.c" 3 4
   fprintf(__stderrp,
# 1991 "project/radare2/libr/core/cmd_open.c"
   "Cannot %s\n", uri
# 1991 "project/radare2/libr/core/cmd_open.c" 3 4
   )
# 1991 "project/radare2/libr/core/cmd_open.c"
 ...
 case 'o':
  ...
  case 'd':
   if (input[2] == 'r') {
    ...
    char **argv = 
# 2010 "project/radare2/libr/core/cmd_open.c" 3 4
                 ((void *)0)
# 2010 "project/radare2/libr/core/cmd_open.c"
                     ;
    int addr = 0;
    argv = r_str_argv (input + 3, &argc);
    if (argc == 0) {
     
# 2014 "project/radare2/libr/core/cmd_open.c" 3 4
    fprintf(__stderrp,
# 2014 "project/radare2/libr/core/cmd_open.c"
    "Usage: oodf (uri://)[/path/to/file] (addr)\n"
# 2014 "project/radare2/libr/core/cmd_open.c" 3 4
    )
# 2014 "project/radare2/libr/core/cmd_open.c"
                                                            ;
  ...
  case 'n':
   switch (input[2]) {
   case 0:
    r_core_file_reopen (core, 
# 2044 "project/radare2/libr/core/cmd_open.c" 3 4
                             ((void *)0)
# 2044 "project/radare2/libr/core/cmd_open.c"
                                 , 0, 0);
    break;
   case '+':
    r_core_file_reopen (core, 
# 2047 "project/radare2/libr/core/cmd_open.c" 3 4
                             ((void *)0)
# 2047 "project/radare2/libr/core/cmd_open.c"
                                 , 
# 2047 "project/radare2/libr/core/cmd_open.c" 3 4
                                   (4|2)
# 2047 "project/radare2/libr/core/cmd_open.c"
   ...
   case 'n':
    ...
    if (desc) {
     ...
     if (input[3] == '+') {
      perms |= 
# 2058 "project/radare2/libr/core/cmd_open.c" 3 4
              (4|2)
# 2058 "project/radare2/libr/core/cmd_open.c"
                       ;
     }
  ...
  case '+':
   if ('?' == input[2]) {
    ...
    int fd;
    int perms = 
# 2080 "project/radare2/libr/core/cmd_open.c" 3 4
               (4|2)
# 2080 "project/radare2/libr/core/cmd_open.c"
                        ;
...
# 2094 "project/radare2/libr/core/cmd_open.c" 3 4
    if (
# 2094 "project/radare2/libr/core/cmd_open.c"
    maplist
# 2094 "project/radare2/libr/core/cmd_open.c" 3 4
    ) for (
# 2094 "project/radare2/libr/core/cmd_open.c"
...
# 2094 "project/radare2/libr/core/cmd_open.c"
                                        {
      map->perm |= 
# 2095 "project/radare2/libr/core/cmd_open.c" 3 4
                  (2|1)
# 2095 "project/radare2/libr/core/cmd_open.c"
                           ;
     }
     r_list_free (maplist);
    }
...
# 2116 "project/radare2/libr/core/cmd_open.c" 3 4
     unsigned long long 
# 2116 "project/radare2/libr/core/cmd_open.c"
          orig_baddr = core->bin->cur->o->baddr_shift;
...
# 2129 "project/radare2/libr/core/cmd_open.c" 3 4
     fprintf(__stderrp,
# 2129 "project/radare2/libr/core/cmd_open.c"
     "Nothing to do.\n"
# 2129 "project/radare2/libr/core/cmd_open.c" 3 4
     )
# 2129 "project/radare2/libr/core/cmd_open.c"
     ...
     if (!r_io_reopen (core->io, fd, 
# 2133 "project/radare2/libr/core/cmd_open.c" 3 4
                                    (4|1)
# 2133 "project/radare2/libr/core/cmd_open.c"
                                             , 755)) {
      
# 2134 "project/radare2/libr/core/cmd_open.c" 3 4
     fprintf(__stderrp,
# 2134 "project/radare2/libr/core/cmd_open.c"
     "Cannot reopen.\n"
# 2134 "project/radare2/libr/core/cmd_open.c" 3 4
     )
# 2134 "project/radare2/libr/core/cmd_open.c"
...
# 2147 "project/radare2/libr/core/cmd_open.c" 3 4
  fprintf(__stderrp,
# 2147 "project/radare2/libr/core/cmd_open.c"
  "Usage: oc [file]\n"
# 2147 "project/radare2/libr/core/cmd_open.c" 3 4
  )
# 2147 "project/radare2/libr/core/cmd_open.c"
...
# 2150 "project/radare2/libr/core/cmd_open.c" 3 4
   fprintf(__stderrp,
# 2150 "project/radare2/libr/core/cmd_open.c"
   "This command is disabled in sandbox mode\n"
# 2150 "project/radare2/libr/core/cmd_open.c" 3 4
   )
# 2150 "project/radare2/libr/core/cmd_open.c"
...
# 2154 "project/radare2/libr/core/cmd_open.c" 3 4
   fprintf(__stderrp,
# 2154 "project/radare2/libr/core/cmd_open.c"
...
# 2154 "project/radare2/libr/core/cmd_open.c"
   ...
   if (!r_core_file_open (core, input + 2, 
# 2163 "project/radare2/libr/core/cmd_open.c" 3 4
                                          (4|1)
# 2163 "project/radare2/libr/core/cmd_open.c"
                                                   , 0)) {
    
# 2164 "project/radare2/libr/core/cmd_open.c" 3 4
   fprintf(__stderrp,
# 2164 "project/radare2/libr/core/cmd_open.c"
   "Cannot open file\n"
# 2164 "project/radare2/libr/core/cmd_open.c" 3 4
   )
# 2164 "project/radare2/libr/core/cmd_open.c"
   ...
   (void)r_core_bin_load (core, 
# 2166 "project/radare2/libr/core/cmd_open.c" 3 4
                               ((void *)0)
# 2166 "project/radare2/libr/core/cmd_open.c"
                                   , baddr);
  } else {
   
# 2168 "project/radare2/libr/core/cmd_open.c" 3 4
  fprintf(__stderrp,
# 2168 "project/radare2/libr/core/cmd_open.c"
  "Missing argument\n"
# 2168 "project/radare2/libr/core/cmd_open.c" 3 4
  )
# 2168 "project/radare2/libr/core/cmd_open.c"
...
# 2192 "project/radare2/libr/core/cmd_open.c" 3 4
  fprintf(__stderrp,
# 2192 "project/radare2/libr/core/cmd_open.c"
  "Usage: ox [fd] [fdx] - exchange two file descriptors\n"
# 2192 "project/radare2/libr/core/cmd_open.c" 3 4
  )
# 2192 "project/radare2/libr/core/cmd_open.c"
                                                                    ;
