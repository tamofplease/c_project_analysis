# 0 "project/radare2/libr/core/task.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/task.c"
...
# 4 "project/radare2/libr/core/task.c" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/core/task.c"
     void r_core_task_scheduler_init(RCoreTaskScheduler *tasks, RCore *core) {
 ...
 tasks->lock = r_th_lock_new (
# 11 "project/radare2/libr/core/task.c" 3 4
                             1
# 11 "project/radare2/libr/core/task.c"
                                 );
 tasks->tasks_running = 0;
 tasks->oneshot_running = 
# 13 "project/radare2/libr/core/task.c" 3 4
                         0
# 13 "project/radare2/libr/core/task.c"
                              ;
 tasks->main_task = r_core_task_new (core, 
# 14 "project/radare2/libr/core/task.c" 3 4
                                          0
# 14 "project/radare2/libr/core/task.c"
                                               , 
# 14 "project/radare2/libr/core/task.c" 3 4
                                                 ((void *)0)
# 14 "project/radare2/libr/core/task.c"
...
# 14 "project/radare2/libr/core/task.c"
 ...
 tasks->current_task = 
# 16 "project/radare2/libr/core/task.c" 3 4
                      ((void *)0)
# 16 "project/radare2/libr/core/task.c"
                          ;
}


# 19 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 19 "project/radare2/libr/core/task.c"
     void r_core_task_scheduler_fini(RCoreTaskScheduler *tasks) {
...
# 30 "project/radare2/libr/core/task.c" 3 4
(*(
# 30 "project/radare2/libr/core/task.c"
&block_sigset
# 30 "project/radare2/libr/core/task.c" 3 4
) = 0, 0)
# 30 "project/radare2/libr/core/task.c"
...
# 31 "project/radare2/libr/core/task.c" 3 4
(*(
# 31 "project/radare2/libr/core/task.c"
&block_sigset
# 31 "project/radare2/libr/core/task.c" 3 4
) |= __sigbits(28), 0)
# 31 "project/radare2/libr/core/task.c"
                                   ;
 r_signal_sigmask (
# 32 "project/radare2/libr/core/task.c" 3 4
                  1
# 32 "project/radare2/libr/core/task.c"
                           , &block_sigset, old_sigset);
}

static void tasks_lock_block_signals_reset(sigset_t *old_sigset) {
 r_signal_sigmask (
# 36 "project/radare2/libr/core/task.c" 3 4
                  3
# 36 "project/radare2/libr/core/task.c"
                             , old_sigset, 
# 36 "project/radare2/libr/core/task.c" 3 4
                                           ((void *)0)
# 36 "project/radare2/libr/core/task.c"
...
static void tasks_lock_enter(RCoreTaskScheduler *scheduler, sigset_t *old_sigset) {
 tasks_lock_block_signals (old_sigset);
 r_th_lock_enter (scheduler->lock);
}

static void tasks_lock_leave(RCoreTaskScheduler *scheduler, sigset_t *old_sigset) {
...
# 59 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 59 "project/radare2/libr/core/task.c"
     void r_core_task_print (RCore *core, RCoreTask *task, PJ *pj, int mode) {
 switch (mode) {
 case 'j': {
  pj_o (pj);
  pj_ki (pj, "id", task->id);
...
# 99 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 99 "project/radare2/libr/core/task.c"
     void r_core_task_list(RCore *core, int mode) {
 RListIter *iter;
 RCoreTask *task;
 PJ *pj = 
# 102 "project/radare2/libr/core/task.c" 3 4
         ((void *)0)
# 102 "project/radare2/libr/core/task.c"
             ;
 if (mode == 'j') {
...
# 112 "project/radare2/libr/core/task.c" 3 4
if (
# 112 "project/radare2/libr/core/task.c"
core->tasks.tasks
# 112 "project/radare2/libr/core/task.c" 3 4
) for (
# 112 "project/radare2/libr/core/task.c"
...
# 125 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 125 "project/radare2/libr/core/task.c"
     int r_core_task_running_tasks_count(RCoreTaskScheduler *scheduler) {
 RListIter *iter;
 RCoreTask *task;
 int count = 0;
 sigset_t old_sigset;
...
# 131 "project/radare2/libr/core/task.c" 3 4
if (
# 131 "project/radare2/libr/core/task.c"
scheduler->tasks
# 131 "project/radare2/libr/core/task.c" 3 4
) for (
# 131 "project/radare2/libr/core/task.c"
...
# 150 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 150 "project/radare2/libr/core/task.c"
     void r_core_task_join(RCoreTaskScheduler *scheduler, RCoreTask *current, int id) {
...
# 173 "project/radare2/libr/core/task.c" 3 4
 if (
# 173 "project/radare2/libr/core/task.c"
 tasks
# 173 "project/radare2/libr/core/task.c" 3 4
 ) for (
# 173 "project/radare2/libr/core/task.c"
...
# 181 "project/radare2/libr/core/task.c" 3 4
 if (
# 181 "project/radare2/libr/core/task.c"
 tasks
# 181 "project/radare2/libr/core/task.c" 3 4
 ) for (
# 181 "project/radare2/libr/core/task.c"
...
# 212 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 212 "project/radare2/libr/core/task.c"
     RCoreTask *r_core_task_new(RCore *core, 
# 212 "project/radare2/libr/core/task.c" 3 4
                                             _Bool 
# 212 "project/radare2/libr/core/task.c"
                                                  create_cons, const char *cmd, RCoreTaskCallback cb, void *user) {
 RCoreTask *task = 
# 213 "project/radare2/libr/core/task.c" 3 4
                  (
# 213 "project/radare2/libr/core/task.c"
                  RCoreTask
# 213 "project/radare2/libr/core/task.c" 3 4
                  *)calloc(1,sizeof(
# 213 "project/radare2/libr/core/task.c"
...
# 213 "project/radare2/libr/core/task.c"
 ...
 task->thread = 
# 218 "project/radare2/libr/core/task.c" 3 4
               ((void *)0)
# 218 "project/radare2/libr/core/task.c"
                   ;
 task->cmd = cmd ? strdup (cmd) : 
# 219 "project/radare2/libr/core/task.c" 3 4
                                 ((void *)0)
# 219 "project/radare2/libr/core/task.c"
                                     ;
 task->cmd_log = 
# 220 "project/radare2/libr/core/task.c" 3 4
                0
# 220 "project/radare2/libr/core/task.c"
                     ;
 task->res = 
# 221 "project/radare2/libr/core/task.c" 3 4
            ((void *)0)
# 221 "project/radare2/libr/core/task.c"
                ;
 task->running_sem = 
# 222 "project/radare2/libr/core/task.c" 3 4
                    ((void *)0)
# 222 "project/radare2/libr/core/task.c"
                        ;
 task->dispatched = 
# 223 "project/radare2/libr/core/task.c" 3 4
                   0
# 223 "project/radare2/libr/core/task.c"
                        ;
 task->dispatch_cond = r_th_cond_new ();
 task->dispatch_lock = r_th_lock_new (
# 225 "project/radare2/libr/core/task.c" 3 4
                                     0
# 225 "project/radare2/libr/core/task.c"
                                          );
 ...
 task->refcount = 1;
 task->transient = 
# 241 "project/radare2/libr/core/task.c" 3 4
                  0
# 241 "project/radare2/libr/core/task.c"
                       ;
 task->core = core;
 task->user = user;
 task->cb = cb;
...
hell:
 task_free (task);
 return 
# 250 "project/radare2/libr/core/task.c" 3 4
       ((void *)0)
# 250 "project/radare2/libr/core/task.c"
           ;
}


# 253 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 253 "project/radare2/libr/core/task.c"
     void r_core_task_incref (RCoreTask *task) {
 if (!task) {
  return;
 }
 sigset_t old_sigset;
...
# 263 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 263 "project/radare2/libr/core/task.c"
     void r_core_task_decref (RCoreTask *task) {
 if (!task) {
  return;
 }
 sigset_t old_sigset;
...
# 277 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 277 "project/radare2/libr/core/task.c"
     void r_core_task_schedule(RCoreTask *current, RTaskState next_state) {
 RCore *core = current->core;
 RCoreTaskScheduler *scheduler = &core->tasks;
 
# 280 "project/radare2/libr/core/task.c" 3 4
_Bool 
# 280 "project/radare2/libr/core/task.c"
     stop = next_state != R_CORE_TASK_STATE_RUNNING;
...
# 286 "project/radare2/libr/core/task.c" 3 4
                          ((void *)0)
# 286 "project/radare2/libr/core/task.c"
                              ;
 ...
 while ((oneshot = r_list_pop_head (scheduler->oneshot_queue))) {
  ...
  scheduler->oneshot_running = 
# 302 "project/radare2/libr/core/task.c" 3 4
                              1
# 302 "project/radare2/libr/core/task.c"
                                  ;
  oneshot->func (oneshot->user);
  scheduler->oneshot_running = 
# 304 "project/radare2/libr/core/task.c" 3 4
                              0
# 304 "project/radare2/libr/core/task.c"
                                   ;
  free (oneshot);
 }
 ...
 if (next) {
  ...
  next->dispatched = 
# 320 "project/radare2/libr/core/task.c" 3 4
                    1
# 320 "project/radare2/libr/core/task.c"
                        ;
  ...
  if (!stop) {
   ...
   current->dispatched = 
# 327 "project/radare2/libr/core/task.c" 3 4
                        0
# 327 "project/radare2/libr/core/task.c"
                             ;
...
# 353 "project/radare2/libr/core/task.c" 3 4
_Bool 
# 353 "project/radare2/libr/core/task.c"
     single = scheduler->tasks_running == 1 || scheduler->tasks_running == 0;
 ...
 if (!single) {
  ...
  current->dispatched = 
# 369 "project/radare2/libr/core/task.c" 3 4
                       0
# 369 "project/radare2/libr/core/task.c"
                            ;
 }
...
# 383 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 383 "project/radare2/libr/core/task.c"
     void r_core_task_yield(RCoreTaskScheduler *scheduler) {
...
static RThreadFunctionRet task_run(RCoreTask *task) {
 ...
 if (task == scheduler->main_task) {
  ...
  res_str = 
# 409 "project/radare2/libr/core/task.c" 3 4
           ((void *)0)
# 409 "project/radare2/libr/core/task.c"
               ;
 } else {
...
# 418 "project/radare2/libr/core/task.c" 3 4
 fprintf(__stderrp,
# 418 "project/radare2/libr/core/task.c"
 "\nTask %d finished\n", task->id
# 418 "project/radare2/libr/core/task.c" 3 4
 )
# 418 "project/radare2/libr/core/task.c"
...
stillbirth:
 ...
 if (task->cons_context && task->cons_context->break_stack) {
  r_cons_context_break_pop (task->cons_context, 
# 436 "project/radare2/libr/core/task.c" 3 4
                                               0
# 436 "project/radare2/libr/core/task.c"
                                                    );
 }
...
# 443 "project/radare2/libr/core/task.c" 3 4
 if (
# 443 "project/radare2/libr/core/task.c"
 scheduler->tasks
# 443 "project/radare2/libr/core/task.c" 3 4
 ) for (
# 443 "project/radare2/libr/core/task.c"
...
# 461 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 461 "project/radare2/libr/core/task.c"
     void r_core_task_enqueue(RCoreTaskScheduler *scheduler, RCoreTask *task) {
 if (!scheduler || !task) {
  return;
 }
 sigset_t old_sigset;
 ...
 if (task->cons_context) {
  r_cons_context_break_push (task->cons_context, 
# 474 "project/radare2/libr/core/task.c" 3 4
                                                ((void *)0)
# 474 "project/radare2/libr/core/task.c"
                                                    , 
# 474 "project/radare2/libr/core/task.c" 3 4
                                                      ((void *)0)
# 474 "project/radare2/libr/core/task.c"
...
# 481 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 481 "project/radare2/libr/core/task.c"
     void r_core_task_enqueue_oneshot(RCoreTaskScheduler *scheduler, RCoreTaskOneShot func, void *user) {
 if (!scheduler || !func) {
  return;
 }
 sigset_t old_sigset;
 ...
 if (scheduler->tasks_running == 0) {
  ...
  scheduler->oneshot_running = 
# 490 "project/radare2/libr/core/task.c" 3 4
                              1
# 490 "project/radare2/libr/core/task.c"
                                  ;
  func (user);
  scheduler->oneshot_running = 
# 492 "project/radare2/libr/core/task.c" 3 4
                              0
# 492 "project/radare2/libr/core/task.c"
                                   ;
 } else {
  OneShot *oneshot = 
# 494 "project/radare2/libr/core/task.c" 3 4
                    (
# 494 "project/radare2/libr/core/task.c"
                    OneShot
# 494 "project/radare2/libr/core/task.c" 3 4
                    *)malloc(sizeof(
# 494 "project/radare2/libr/core/task.c"
...
# 505 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 505 "project/radare2/libr/core/task.c"
     int r_core_task_run_sync(RCoreTaskScheduler *scheduler, RCoreTask *task) {
 task->thread = 
# 506 "project/radare2/libr/core/task.c" 3 4
               ((void *)0)
# 506 "project/radare2/libr/core/task.c"
                   ;
 return task_run (task);
}
...
# 511 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 511 "project/radare2/libr/core/task.c"
     void r_core_task_sync_begin(RCoreTaskScheduler *scheduler) {
 RCoreTask *task = scheduler->main_task;
 sigset_t old_sigset;
 tasks_lock_enter (scheduler, &old_sigset);
 task->thread = 
# 515 "project/radare2/libr/core/task.c" 3 4
               ((void *)0)
# 515 "project/radare2/libr/core/task.c"
                   ;
 task->cmd = 
# 516 "project/radare2/libr/core/task.c" 3 4
            ((void *)0)
# 516 "project/radare2/libr/core/task.c"
                ;
 task->cmd_log = 
# 517 "project/radare2/libr/core/task.c" 3 4
                0
# 517 "project/radare2/libr/core/task.c"
                     ;
 task->state = R_CORE_TASK_STATE_BEFORE_START;
 tasks_lock_leave (scheduler, &old_sigset);
 task_wakeup (task);
...
# 524 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 524 "project/radare2/libr/core/task.c"
     void r_core_task_sync_end(RCoreTaskScheduler *scheduler) {
...
# 530 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 530 "project/radare2/libr/core/task.c"
     void r_core_task_sleep_begin(RCoreTask *task) {
 r_core_task_schedule (task, R_CORE_TASK_STATE_SLEEPING);
}


# 534 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 534 "project/radare2/libr/core/task.c"
     void r_core_task_sleep_end(RCoreTask *task) {
 task_wakeup (task);
}


# 538 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 538 "project/radare2/libr/core/task.c"
     const char *r_core_task_status (RCoreTask *task) {
 switch (task->state) {
 case R_CORE_TASK_STATE_RUNNING:
  return "running";
 case R_CORE_TASK_STATE_SLEEPING:
...
# 553 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 553 "project/radare2/libr/core/task.c"
     RCoreTask *r_core_task_self (RCoreTaskScheduler *scheduler) {
...
# 560 "project/radare2/libr/core/task.c" 3 4
if (
# 560 "project/radare2/libr/core/task.c"
scheduler->tasks
# 560 "project/radare2/libr/core/task.c" 3 4
) for (
# 560 "project/radare2/libr/core/task.c"
...
# 560 "project/radare2/libr/core/task.c"
 ...
 return 
# 565 "project/radare2/libr/core/task.c" 3 4
       ((void *)0)
# 565 "project/radare2/libr/core/task.c"
           ;
}


# 568 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 568 "project/radare2/libr/core/task.c"
     RCoreTask *r_core_task_get_incref(RCoreTaskScheduler *scheduler, int id) {
 sigset_t old_sigset;
 tasks_lock_enter (scheduler, &old_sigset);
...
# 579 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 579 "project/radare2/libr/core/task.c"
     void r_core_task_break(RCoreTaskScheduler *scheduler, int id) {
 sigset_t old_sigset;
 tasks_lock_enter (scheduler, &old_sigset);
 RCoreTask *task = task_get (scheduler, id);
...
# 593 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 593 "project/radare2/libr/core/task.c"
     void r_core_task_break_all(RCoreTaskScheduler *scheduler) {
 sigset_t old_sigset;
 tasks_lock_enter (scheduler, &old_sigset);
 RCoreTask *task;
 RListIter *iter;
 
# 598 "project/radare2/libr/core/task.c" 3 4
if (
# 598 "project/radare2/libr/core/task.c"
scheduler->tasks
# 598 "project/radare2/libr/core/task.c" 3 4
) for (
# 598 "project/radare2/libr/core/task.c"
...
# 606 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 606 "project/radare2/libr/core/task.c"
     int r_core_task_del (RCoreTaskScheduler *scheduler, int id) {
 RCoreTask *task;
 RListIter *iter;
 
# 609 "project/radare2/libr/core/task.c" 3 4
_Bool 
# 609 "project/radare2/libr/core/task.c"
     ret = 
# 609 "project/radare2/libr/core/task.c" 3 4
           0
# 609 "project/radare2/libr/core/task.c"
...
# 612 "project/radare2/libr/core/task.c" 3 4
if (
# 612 "project/radare2/libr/core/task.c"
scheduler->tasks
# 612 "project/radare2/libr/core/task.c" 3 4
) for (
# 612 "project/radare2/libr/core/task.c"
...
# 612 "project/radare2/libr/core/task.c"
  ...
  if (task->id == id) {
   ...
   if (task->state == R_CORE_TASK_STATE_DONE) {
    ...
    task->transient = 
# 620 "project/radare2/libr/core/task.c" 3 4
                     1
# 620 "project/radare2/libr/core/task.c"
                         ;
   }
   ret = 
# 622 "project/radare2/libr/core/task.c" 3 4
        1
# 622 "project/radare2/libr/core/task.c"
            ;
   break;
  }
 }
...
# 630 "project/radare2/libr/core/task.c" 3 4
__attribute__((visibility("default"))) 
# 630 "project/radare2/libr/core/task.c"
     void r_core_task_del_all_done (RCoreTaskScheduler *scheduler) {
 RCoreTask *task;
 RListIter *iter, *iter2;
 
# 633 "project/radare2/libr/core/task.c" 3 4
if (
# 633 "project/radare2/libr/core/task.c"
scheduler->tasks
# 633 "project/radare2/libr/core/task.c" 3 4
) for (
# 633 "project/radare2/libr/core/task.c"
