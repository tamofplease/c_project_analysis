# 0 "project/radare2/libr/core/vmenus_graph.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/core/vmenus_graph.c" 2




__attribute__((visibility("default"))) 
# 8 "project/radare2/libr/core/vmenus_graph.c"
     char *r_str_widget_list(void *user, RList *list, int rows, int cur, PrintItemCallback cb) {
 void *item;
...
# 17 "project/radare2/libr/core/vmenus_graph.c" 3 4
if (
# 17 "project/radare2/libr/core/vmenus_graph.c"
list
# 17 "project/radare2/libr/core/vmenus_graph.c" 3 4
) for (
# 17 "project/radare2/libr/core/vmenus_graph.c"
...
# 39 "project/radare2/libr/core/vmenus_graph.c" 3 4
unsigned long long 
# 39 "project/radare2/libr/core/vmenus_graph.c"
     addr;
 RAnalFunction *fcn;
 int cur;
 int cur_sort;
...
# 50 "project/radare2/libr/core/vmenus_graph.c" 3 4
unsigned long long 
# 50 "project/radare2/libr/core/vmenus_graph.c"
     addr;
 const char *name;
 RAnalFunction *fcn;
} RCoreVisualViewGraphItem;

static char *print_item(void *_core, void *_item, 
# 55 "project/radare2/libr/core/vmenus_graph.c" 3 4
                                                 _Bool 
# 55 "project/radare2/libr/core/vmenus_graph.c"
                                                      selected) {
 RCoreVisualViewGraphItem *item = _item;
 if (item->name && *item->name) {
  if (
# 58 "project/radare2/libr/core/vmenus_graph.c" 3 4
     0 
# 58 "project/radare2/libr/core/vmenus_graph.c"
           && item->fcn && item->addr > item->fcn->addr) {
   
# 59 "project/radare2/libr/core/vmenus_graph.c" 3 4
  long long 
# 59 "project/radare2/libr/core/vmenus_graph.c"
       delta = item->addr - item->fcn->addr;
   return r_str_newf ("%c %s+0x%"
# 60 "project/radare2/libr/core/vmenus_graph.c" 3 4
                                "llx"
# 60 "project/radare2/libr/core/vmenus_graph.c"
                                       "\n", selected?'>':' ', item->name, delta);
  } else {
   return r_str_newf ("%c %s\n", selected?'>':' ', item->name);
  }
 }
 return r_str_newf ("%c 0x%08"
# 65 "project/radare2/libr/core/vmenus_graph.c" 3 4
                             "llx"
# 65 "project/radare2/libr/core/vmenus_graph.c"
                                    "\n", selected?'>':' ', item->addr);
}

static RList *__xrefs(RCore *core, 
# 68 "project/radare2/libr/core/vmenus_graph.c" 3 4
                                  unsigned long long 
# 68 "project/radare2/libr/core/vmenus_graph.c"
                                       addr) {
...
# 73 "project/radare2/libr/core/vmenus_graph.c" 3 4
if (
# 73 "project/radare2/libr/core/vmenus_graph.c"
xrefs
# 73 "project/radare2/libr/core/vmenus_graph.c" 3 4
) for (
# 73 "project/radare2/libr/core/vmenus_graph.c"
...
# 77 "project/radare2/libr/core/vmenus_graph.c" 3 4
                                  (
# 77 "project/radare2/libr/core/vmenus_graph.c"
                                  RCoreVisualViewGraphItem
# 77 "project/radare2/libr/core/vmenus_graph.c" 3 4
                                  *)calloc(1,sizeof(
# 77 "project/radare2/libr/core/vmenus_graph.c"
...
# 77 "project/radare2/libr/core/vmenus_graph.c"
  ...
  item->addr = ref->addr;
  item->name = f? f->name: 
# 80 "project/radare2/libr/core/vmenus_graph.c" 3 4
                          ((void *)0)
# 80 "project/radare2/libr/core/vmenus_graph.c"
                              ;
...
static RList *__refs(RCore *core, 
# 91 "project/radare2/libr/core/vmenus_graph.c" 3 4
                                 unsigned long long 
# 91 "project/radare2/libr/core/vmenus_graph.c"
                                      addr) {
 RList *r = r_list_newf (free);
 RListIter *iter;
 RAnalRef *ref;
...
# 100 "project/radare2/libr/core/vmenus_graph.c" 3 4
if (
# 100 "project/radare2/libr/core/vmenus_graph.c"
refs
# 100 "project/radare2/libr/core/vmenus_graph.c" 3 4
) for (
# 100 "project/radare2/libr/core/vmenus_graph.c"
...
# 100 "project/radare2/libr/core/vmenus_graph.c"
  ...
  RCoreVisualViewGraphItem *item = 
# 104 "project/radare2/libr/core/vmenus_graph.c" 3 4
                                  (
# 104 "project/radare2/libr/core/vmenus_graph.c"
                                  RCoreVisualViewGraphItem
# 104 "project/radare2/libr/core/vmenus_graph.c" 3 4
                                  *)calloc(1,sizeof(
# 104 "project/radare2/libr/core/vmenus_graph.c"
...
# 104 "project/radare2/libr/core/vmenus_graph.c"
  ...
  item->addr = ref->addr;
  item->name = f? f->name: 
# 107 "project/radare2/libr/core/vmenus_graph.c" 3 4
                          ((void *)0)
# 107 "project/radare2/libr/core/vmenus_graph.c"
                              ;
  RAnalFunction *rf = r_anal_get_fcn_in (core->anal, ref->addr, 0);
  if (rf) {
   item->name = rf->name;
...
# 122 "project/radare2/libr/core/vmenus_graph.c" 3 4
if (
# 122 "project/radare2/libr/core/vmenus_graph.c"
core->anal->fcns
# 122 "project/radare2/libr/core/vmenus_graph.c" 3 4
) for (
# 122 "project/radare2/libr/core/vmenus_graph.c"
...
# 122 "project/radare2/libr/core/vmenus_graph.c"
                                             {
  RCoreVisualViewGraphItem *item = 
# 123 "project/radare2/libr/core/vmenus_graph.c" 3 4
                                  (
# 123 "project/radare2/libr/core/vmenus_graph.c"
                                  RCoreVisualViewGraphItem
# 123 "project/radare2/libr/core/vmenus_graph.c" 3 4
                                  *)calloc(1,sizeof(
# 123 "project/radare2/libr/core/vmenus_graph.c"
...
# 133 "project/radare2/libr/core/vmenus_graph.c" 3 4
unsigned long long 
# 133 "project/radare2/libr/core/vmenus_graph.c"
     target = 0;
 if (status->fcn) {
...
# 143 "project/radare2/libr/core/vmenus_graph.c" 3 4
if (
# 143 "project/radare2/libr/core/vmenus_graph.c"
status->mainCol
# 143 "project/radare2/libr/core/vmenus_graph.c" 3 4
) for (
# 143 "project/radare2/libr/core/vmenus_graph.c"
...
# 166 "project/radare2/libr/core/vmenus_graph.c" 3 4
do { if (!(
# 166 "project/radare2/libr/core/vmenus_graph.c"
status && list
# 166 "project/radare2/libr/core/vmenus_graph.c" 3 4
...
# 166 "project/radare2/libr/core/vmenus_graph.c"
                                 ;
 RListComparator cmp = (status->cur_sort == 0)? cmpaddr: cmpname;
 list->sorted = 
# 168 "project/radare2/libr/core/vmenus_graph.c" 3 4
               0
# 168 "project/radare2/libr/core/vmenus_graph.c"
                    ;
...
# 173 "project/radare2/libr/core/vmenus_graph.c" 3 4
do { if (!(
# 173 "project/radare2/libr/core/vmenus_graph.c"
status
# 173 "project/radare2/libr/core/vmenus_graph.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 173 "project/radare2/libr/core/vmenus_graph.c"
...
# 173 "project/radare2/libr/core/vmenus_graph.c"
                         ;
 status->cur_sort = (status->cur_sort == 0)? 1: 0;
...
# 215 "project/radare2/libr/core/vmenus_graph.c" 3 4
__attribute__((visibility("default"))) 
# 215 "project/radare2/libr/core/vmenus_graph.c"
     int __core_visual_view_graph_update(RCore *core, RCoreVisualViewGraph *status) {
 ...
 char *title = r_str_newf ("[r2-visual-browser] addr=0x%08"
# 232 "project/radare2/libr/core/vmenus_graph.c" 3 4
                                                          "llx"
# 232 "project/radare2/libr/core/vmenus_graph.c"
                                                                 " faddr=0x%08"
# 232 "project/radare2/libr/core/vmenus_graph.c" 3 4
                                                                               "llx"
# 232 "project/radare2/libr/core/vmenus_graph.c"
                                                                                      "", status->addr, status->fcn ? status->fcn->addr : 0);
 if (title) {
 ...
 char *output = r_core_cmd_strf (core, "pd %d @e:asm.flags=0@ 0x%08"
# 241 "project/radare2/libr/core/vmenus_graph.c" 3 4
                                                                   "llx"
# 241 "project/radare2/libr/core/vmenus_graph.c"
                                                                          "; pds 256 @ 0x%08"
# 241 "project/radare2/libr/core/vmenus_graph.c" 3 4
                                                                                             "llx"
# 241 "project/radare2/libr/core/vmenus_graph.c"
...
# 254 "project/radare2/libr/core/vmenus_graph.c" 3 4
__attribute__((visibility("default"))) 
# 254 "project/radare2/libr/core/vmenus_graph.c"
     int r_core_visual_view_graph(RCore *core) {
 ...
 while (
# 265 "project/radare2/libr/core/vmenus_graph.c" 3 4
       1
# 265 "project/radare2/libr/core/vmenus_graph.c"
           ) {
  __core_visual_view_graph_update (core, &status);
  int ch = r_cons_readchar ();
  if (ch == -1 || ch == 4) {
   return 
# 269 "project/radare2/libr/core/vmenus_graph.c" 3 4
         1
# 269 "project/radare2/libr/core/vmenus_graph.c"
             ;
  }
  ...
  case 'h':
   if (!
# 274 "project/radare2/libr/core/vmenus_graph.c" 3 4
       (!(
# 274 "project/radare2/libr/core/vmenus_graph.c"
       status.xrefsCol
# 274 "project/radare2/libr/core/vmenus_graph.c" 3 4
       ) || !(
# 274 "project/radare2/libr/core/vmenus_graph.c"
...
# 274 "project/radare2/libr/core/vmenus_graph.c"
  ...
  case 'l':
   if (!
# 284 "project/radare2/libr/core/vmenus_graph.c" 3 4
       (!(
# 284 "project/radare2/libr/core/vmenus_graph.c"
       status.refsCol
# 284 "project/radare2/libr/core/vmenus_graph.c" 3 4
       ) || !(
# 284 "project/radare2/libr/core/vmenus_graph.c"
...
# 284 "project/radare2/libr/core/vmenus_graph.c"
  ...
  case '\n':
   {
    RCoreVisualViewGraphItem *item = r_list_get_n (status.mainCol, status.cur);
    r_core_seek (core, item->addr, 
# 326 "project/radare2/libr/core/vmenus_graph.c" 3 4
                                  1
# 326 "project/radare2/libr/core/vmenus_graph.c"
                                      );
   }
   return 
# 328 "project/radare2/libr/core/vmenus_graph.c" 3 4
         1
# 328 "project/radare2/libr/core/vmenus_graph.c"
             ;
   break;
  case '_':
  ...
  case '?':
   ...
   r_cons_flush ();
   r_cons_any_key (
# 378 "project/radare2/libr/core/vmenus_graph.c" 3 4
                  ((void *)0)
# 378 "project/radare2/libr/core/vmenus_graph.c"
                      );
   break;
  case '/':
   {
    char cmd[1024];
    r_cons_show_cursor (
# 383 "project/radare2/libr/core/vmenus_graph.c" 3 4
                       1
# 383 "project/radare2/libr/core/vmenus_graph.c"
                           );
    r_cons_set_raw (0);
    cmd[0]='\0';
    r_line_set_prompt (":> ");
    if (r_cons_fgets (cmd, sizeof (cmd), 0, 
# 387 "project/radare2/libr/core/vmenus_graph.c" 3 4
                                           ((void *)0)
# 387 "project/radare2/libr/core/vmenus_graph.c"
                                               ) < 0) {
     cmd[0] = '\0';
    }
    ...
    r_cons_set_raw (1);
    r_cons_show_cursor (
# 393 "project/radare2/libr/core/vmenus_graph.c" 3 4
                       0
# 393 "project/radare2/libr/core/vmenus_graph.c"
                            );
    r_cons_clear ();
   }
   break;
  case 'q':
   return 
# 398 "project/radare2/libr/core/vmenus_graph.c" 3 4
         0
# 398 "project/radare2/libr/core/vmenus_graph.c"
              ;
  case ':':
   {
   char cmd[1024];
   r_cons_show_cursor (
# 402 "project/radare2/libr/core/vmenus_graph.c" 3 4
                      1
# 402 "project/radare2/libr/core/vmenus_graph.c"
                          );
   r_cons_set_raw (0);
   cmd[0]='\0';
   r_line_set_prompt (":> ");
   if (r_cons_fgets (cmd, sizeof (cmd), 0, 
# 406 "project/radare2/libr/core/vmenus_graph.c" 3 4
                                          ((void *)0)
# 406 "project/radare2/libr/core/vmenus_graph.c"
                                              ) < 0) {
    cmd[0] = '\0';
   }
   ...
   r_cons_set_raw (1);
   r_cons_show_cursor (
# 412 "project/radare2/libr/core/vmenus_graph.c" 3 4
                      0
# 412 "project/radare2/libr/core/vmenus_graph.c"
                           );
   if (cmd[0]) {
    r_cons_any_key (
# 414 "project/radare2/libr/core/vmenus_graph.c" 3 4
                   ((void *)0)
# 414 "project/radare2/libr/core/vmenus_graph.c"
                       );
   }
   r_cons_clear ();
   }
 ...
 return 
# 424 "project/radare2/libr/core/vmenus_graph.c" 3 4
       0
# 424 "project/radare2/libr/core/vmenus_graph.c"
            ;
}
