# 0 "project/radare2/libr/core/citem.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/citem.c"
...
# 4 "project/radare2/libr/core/citem.c" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/core/citem.c"
     RCoreItem *r_core_item_at (RCore *core, 
# 5 "project/radare2/libr/core/citem.c" 3 4
                                             unsigned long long 
# 5 "project/radare2/libr/core/citem.c"
                                                  addr) {
 RCoreItem *ci = 
# 6 "project/radare2/libr/core/citem.c" 3 4
                (
# 6 "project/radare2/libr/core/citem.c"
                RCoreItem
# 6 "project/radare2/libr/core/citem.c" 3 4
                *)calloc(1,sizeof(
# 6 "project/radare2/libr/core/citem.c"
...
# 6 "project/radare2/libr/core/citem.c"
 ...
 if (map) {
  ...
  if (map->perm & 
# 12 "project/radare2/libr/core/citem.c" 3 4
                 1
# 12 "project/radare2/libr/core/citem.c"
                         ) {

   
# 14 "project/radare2/libr/core/citem.c" 3 4
  unsigned long long 
# 14 "project/radare2/libr/core/citem.c"
       size;
   ...
   if (item) {
    ...
    case R_META_TYPE_DATA:
     ci->type = "data";
     ci->size = size;
     ci->data = r_core_cmd_strf (core, "pdi 1 @e:asm.flags=0@e:asm.lines=0@e:scr.color=0@0x%08"
# 21 "project/radare2/libr/core/citem.c" 3 4
                                                                                              "llx"
# 21 "project/radare2/libr/core/citem.c"
                                                                                                     , addr);
     r_str_trim (ci->data);
     break;
  ...
  if (op) {
   if (!ci->data) {
    if (op->mnemonic) {
     ...
     ci->data = r_core_cmd_strf (core, "pi 1 @e:scr.color=0@0x%08"
# 59 "project/radare2/libr/core/citem.c" 3 4
                                                                 "llx"
# 59 "project/radare2/libr/core/citem.c"
                                                                        , addr);
     r_str_trim (ci->data);
    }
   }
 ...
 char *cmt = r_core_cmd_strf (core, "CC.@0x%08"
# 67 "project/radare2/libr/core/citem.c" 3 4
                                              "llx"
# 67 "project/radare2/libr/core/citem.c"
                                                     , addr);
 if (cmt) {
  if (*cmt) {
 ...
 r_str_trim (prev);
 ci->prev = r_num_get (
# 81 "project/radare2/libr/core/citem.c" 3 4
                      ((void *)0)
# 81 "project/radare2/libr/core/citem.c"
                          , prev);
 free (prev);
 return ci;
}
...
# 86 "project/radare2/libr/core/citem.c" 3 4
__attribute__((visibility("default"))) 
# 86 "project/radare2/libr/core/citem.c"
     void r_core_item_free (RCoreItem *ci) {
 free (ci->data);
 free (ci);
}
