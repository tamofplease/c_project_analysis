# 0 "project/radare2/libr/core/cundo.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/cundo.c"
...
# 4 "project/radare2/libr/core/cundo.c" 2
# 13 "project/radare2/libr/core/cundo.c"
__attribute__((visibility("default"))) 
# 13 "project/radare2/libr/core/cundo.c"
     RCoreUndo *r_core_undo_new(
# 13 "project/radare2/libr/core/cundo.c" 3 4
                                unsigned long long 
# 13 "project/radare2/libr/core/cundo.c"
                                     offset, const char *action, const char *revert) {
 RCoreUndo *cu = 
# 14 "project/radare2/libr/core/cundo.c" 3 4
                (
# 14 "project/radare2/libr/core/cundo.c"
                RCoreUndo
# 14 "project/radare2/libr/core/cundo.c" 3 4
                *)malloc(sizeof(
# 14 "project/radare2/libr/core/cundo.c"
...
# 24 "project/radare2/libr/core/cundo.c" 3 4
__attribute__((visibility("default"))) 
# 24 "project/radare2/libr/core/cundo.c"
     void r_core_undo_free(RCoreUndo *cu) {
 if (cu) {
  free (cu->action);
  free (cu->revert);
 }
...
# 32 "project/radare2/libr/core/cundo.c" 3 4
__attribute__((visibility("default"))) 
# 32 "project/radare2/libr/core/cundo.c"
     void r_core_undo_push(RCore *core, RCoreUndo *cu) {
 r_list_append (core->undos, cu);
}


# 36 "project/radare2/libr/core/cundo.c" 3 4
__attribute__((visibility("default"))) 
# 36 "project/radare2/libr/core/cundo.c"
     void r_core_undo_pop(RCore *core) {
...
# 44 "project/radare2/libr/core/cundo.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 44 "project/radare2/libr/core/cundo.c"
          r_core_undo_condition(RCoreUndo *cu, RCoreUndoCondition *cond) {
 if (!cond) {
  return 
# 46 "project/radare2/libr/core/cundo.c" 3 4
        1
# 46 "project/radare2/libr/core/cundo.c"
            ;
 }
 
# 48 "project/radare2/libr/core/cundo.c" 3 4
_Bool 
# 48 "project/radare2/libr/core/cundo.c"
     mustPrint = 
# 48 "project/radare2/libr/core/cundo.c" 3 4
                 0
# 48 "project/radare2/libr/core/cundo.c"
                      ;
 if (cond->addr != 
# 49 "project/radare2/libr/core/cundo.c" 3 4
                  0xFFFFFFFFFFFFFFFFULL
# 49 "project/radare2/libr/core/cundo.c"
                          ) {
...
# 61 "project/radare2/libr/core/cundo.c" 3 4
__attribute__((visibility("default"))) 
# 61 "project/radare2/libr/core/cundo.c"
     void r_core_undo_print(RCore *core, int mode, RCoreUndoCondition *cond) {
 RCoreUndo *cu;
 RListIter *iter;
 if (mode) {
  
# 65 "project/radare2/libr/core/cundo.c" 3 4
 if (
# 65 "project/radare2/libr/core/cundo.c"
 core->undos
# 65 "project/radare2/libr/core/cundo.c" 3 4
 ) for (
# 65 "project/radare2/libr/core/cundo.c"
...
# 65 "project/radare2/libr/core/cundo.c"
   ...
   if (r_core_undo_condition (cu, cond)) {
    r_cons_printf ("%s @ 0x%"
# 67 "project/radare2/libr/core/cundo.c" 3 4
                            "llx"
# 67 "project/radare2/libr/core/cundo.c"
                                   "\n", cu->revert, cu->offset);
   }
  }
 } else {
  
# 71 "project/radare2/libr/core/cundo.c" 3 4
 if (
# 71 "project/radare2/libr/core/cundo.c"
 core->undos
# 71 "project/radare2/libr/core/cundo.c" 3 4
 ) for (
# 71 "project/radare2/libr/core/cundo.c"
...
# 71 "project/radare2/libr/core/cundo.c"
                                        {
   r_cons_printf ("0x%08"
# 72 "project/radare2/libr/core/cundo.c" 3 4
                        "llx"
# 72 "project/radare2/libr/core/cundo.c"
                               " %"
# 72 "project/radare2/libr/core/cundo.c" 3 4
                                   "lld"
# 72 "project/radare2/libr/core/cundo.c"
