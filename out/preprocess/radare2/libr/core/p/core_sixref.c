# 0 "project/radare2/libr/core/p/core_sixref.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/p/core_sixref.c"
...
# 6 "project/radare2/libr/core/p/core_sixref.c" 2


# 7 "project/radare2/libr/core/p/core_sixref.c"
static void siguza_xrefs_chunked(RCore *core, 
# 7 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                             unsigned long long 
# 7 "project/radare2/libr/core/p/core_sixref.c"
                                                  search, int lenbytes) {
 const 
# 8 "project/radare2/libr/core/p/core_sixref.c" 3 4
      unsigned char 
# 8 "project/radare2/libr/core/p/core_sixref.c"
          *mem = core->block;
 
# 9 "project/radare2/libr/core/p/core_sixref.c" 3 4
unsigned int 
# 9 "project/radare2/libr/core/p/core_sixref.c"
     *p = (
# 9 "project/radare2/libr/core/p/core_sixref.c" 3 4
           unsigned int
# 9 "project/radare2/libr/core/p/core_sixref.c"
...
# 10 "project/radare2/libr/core/p/core_sixref.c" 3 4
unsigned int 
# 10 "project/radare2/libr/core/p/core_sixref.c"
     *e = (
# 10 "project/radare2/libr/core/p/core_sixref.c" 3 4
           unsigned int
# 10 "project/radare2/libr/core/p/core_sixref.c"
...
# 11 "project/radare2/libr/core/p/core_sixref.c" 3 4
unsigned long long 
# 11 "project/radare2/libr/core/p/core_sixref.c"
     addr = core->offset;

 for (; p < e; p++, addr += 4) {
  
# 14 "project/radare2/libr/core/p/core_sixref.c" 3 4
 unsigned int 
# 14 "project/radare2/libr/core/p/core_sixref.c"
      v = *p;
  if((v & 0x1f000000) == 0x10000000)
  {
   
# 17 "project/radare2/libr/core/p/core_sixref.c" 3 4
  unsigned int 
# 17 "project/radare2/libr/core/p/core_sixref.c"
       reg = v & 0x1f;
   
# 18 "project/radare2/libr/core/p/core_sixref.c" 3 4
  _Bool 
# 18 "project/radare2/libr/core/p/core_sixref.c"
       is_adrp = (v & 0x80000000) != 0;
   int64_t base = is_adrp ? (addr & 0xfffffffffffff000) : addr;
   int64_t off = ((int64_t)((((v >> 5) & 0x7ffff) << 2) | ((v >> 29) & 0x3)) << 43) >> (is_adrp ? 31 : 43);
   
# 21 "project/radare2/libr/core/p/core_sixref.c" 3 4
  unsigned long long 
# 21 "project/radare2/libr/core/p/core_sixref.c"
       target = base + off;
   if (search == 0) {
    r_cons_printf ("ax 0x%"
# 23 "project/radare2/libr/core/p/core_sixref.c" 3 4
                          "llx"
# 23 "project/radare2/libr/core/p/core_sixref.c"
                                 " 0x%"
# 23 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                       "llx"
# 23 "project/radare2/libr/core/p/core_sixref.c"
    ...
    r_cons_printf ("%#"
# 25 "project/radare2/libr/core/p/core_sixref.c" 3 4
                      "llx"
# 25 "project/radare2/libr/core/p/core_sixref.c"
                             ": %s x%u, %#"
# 25 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                           "llx"
# 25 "project/radare2/libr/core/p/core_sixref.c"
...
# 30 "project/radare2/libr/core/p/core_sixref.c" 3 4
   unsigned int 
# 30 "project/radare2/libr/core/p/core_sixref.c"
        *q = p + 1;
    while(q < e && *q == 0xd503201f)
    {
     q++;
    }
    if(q < e) {
...
# 37 "project/radare2/libr/core/p/core_sixref.c" 3 4
    unsigned int 
# 37 "project/radare2/libr/core/p/core_sixref.c"
         reg2 = reg;
     
# 38 "project/radare2/libr/core/p/core_sixref.c" 3 4
    unsigned int 
# 38 "project/radare2/libr/core/p/core_sixref.c"
         aoff = 0;
     
# 39 "project/radare2/libr/core/p/core_sixref.c" 3 4
    _Bool 
# 39 "project/radare2/libr/core/p/core_sixref.c"
         found = 
# 39 "project/radare2/libr/core/p/core_sixref.c" 3 4
                 0
# 39 "project/radare2/libr/core/p/core_sixref.c"
                      ;
     if((v & 0xff8003e0) == (0x91000000 | (reg << 5)))
     {
      reg2 = v & 0x1f;
      aoff = (v >> 10) & 0xfff;
      if (v & 0x400000) {
      ...
      if(target + aoff == search) {
       r_cons_printf ("%#"
# 48 "project/radare2/libr/core/p/core_sixref.c" 3 4
                         "llx"
# 48 "project/radare2/libr/core/p/core_sixref.c"
                                ": %s x%u, %#"
# 48 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                              "llx"
# 48 "project/radare2/libr/core/p/core_sixref.c"
       ...
       found = 
# 49 "project/radare2/libr/core/p/core_sixref.c" 3 4
              1
# 49 "project/radare2/libr/core/p/core_sixref.c"
                  ;
      } else {
       do {
        q++;
     ...
     if(!found && q < e) {
      v = *q;
      if((v & 0xff8003e0) == (0x91000000 | (reg2 << 5)))
      {
       
# 60 "project/radare2/libr/core/p/core_sixref.c" 3 4
      unsigned int 
# 60 "project/radare2/libr/core/p/core_sixref.c"
           xoff = (v >> 10) & 0xfff;
       if (v & 0x400000) {
        xoff <<= 12;
       }
       if (target + aoff + xoff == search) {
        ...
        r_cons_printf("%#"
# 66 "project/radare2/libr/core/p/core_sixref.c" 3 4
                         "llx"
# 66 "project/radare2/libr/core/p/core_sixref.c"
                                ": %s x%u, %#"
# 66 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                              "llx"
# 66 "project/radare2/libr/core/p/core_sixref.c"
                                                     "; add x%u, x%u, %#x; add x%u, x%u, %#x\n", addr, is_adrp ? "adrp" : "adr", reg, target, reg2, reg, aoff, v & 0x1f, reg2, xoff);
       }
      } else if((v & 0x3e0003e0) == (0x38000000 | (reg2 << 5)))
      {
       const char *inst = 
# 70 "project/radare2/libr/core/p/core_sixref.c" 3 4
                         ((void *)0)
# 70 "project/radare2/libr/core/p/core_sixref.c"
                             ;
       uint8_t size;
       size = (v >> 30) & 0x3;
...
# 92 "project/radare2/libr/core/p/core_sixref.c" 3 4
        unsigned long long 
# 92 "project/radare2/libr/core/p/core_sixref.c"
             uoff = ((v >> 10) & 0xfff) << size;
         if (target + aoff + uoff == search) {
          if (aoff)
          {
           r_cons_printf("%#"
# 96 "project/radare2/libr/core/p/core_sixref.c" 3 4
                            "llx"
# 96 "project/radare2/libr/core/p/core_sixref.c"
                                   ": %s x%u, %#"
# 96 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                                 "llx"
# 96 "project/radare2/libr/core/p/core_sixref.c"
                                                        "; add x%u, x%u, %#x; %s %s%u, [x%u, %#"
# 96 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                                                                                "llx"
# 96 "project/radare2/libr/core/p/core_sixref.c"
          ...
          {
           r_cons_printf("%#"
# 100 "project/radare2/libr/core/p/core_sixref.c" 3 4
                            "llx"
# 100 "project/radare2/libr/core/p/core_sixref.c"
                                   ": %s x%u, %#"
# 100 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                                 "llx"
# 100 "project/radare2/libr/core/p/core_sixref.c"
...
# 100 "project/radare2/libr/core/p/core_sixref.c"
         ...
         if(target + aoff + soff == search) {
          if((v & 0x400) == 0) {
           ...
           {
            r_cons_printf("%#"
# 140 "project/radare2/libr/core/p/core_sixref.c" 3 4
                             "llx"
# 140 "project/radare2/libr/core/p/core_sixref.c"
                                    ": %s x%u, %#"
# 140 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                                  "llx"
# 140 "project/radare2/libr/core/p/core_sixref.c"
                                                         "; add x%u, x%u, %#x; %s %s%u, [x%u, %s%"
# 140 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                                                                                  "lld"
# 140 "project/radare2/libr/core/p/core_sixref.c"
                                                                                                         "]\n",
             addr, is_adrp ? "adrp" : "adr", reg, target, reg2, reg, aoff, inst, rs, v & 0x1f, reg2, sign, (
# 141 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                                                                                           long long
# 141 "project/radare2/libr/core/p/core_sixref.c"
                                                                                                               )soff);
           }
           else
           {
            r_cons_printf("%#"
# 145 "project/radare2/libr/core/p/core_sixref.c" 3 4
                             "llx"
# 145 "project/radare2/libr/core/p/core_sixref.c"
                                    ": %s x%u, %#"
# 145 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                                  "llx"
# 145 "project/radare2/libr/core/p/core_sixref.c"
...
# 145 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                                                               "lld"
# 145 "project/radare2/libr/core/p/core_sixref.c"
                                                                                      "]\n", addr, is_adrp ? "adrp" : "adr", reg, target, inst, rs, v & 0x1f, reg2, sign, (
# 145 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                                                                                                                                                           long long
# 145 "project/radare2/libr/core/p/core_sixref.c"
                                                                                                                                                                               )soff);
          ...
          else
          {
           if((v & 0x800) != 0)
           {
            ...
            {
             r_cons_printf("%#"
# 154 "project/radare2/libr/core/p/core_sixref.c" 3 4
                              "llx"
# 154 "project/radare2/libr/core/p/core_sixref.c"
                                     ": %s x%u, %#"
# 154 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                                   "llx"
# 154 "project/radare2/libr/core/p/core_sixref.c"
...
# 154 "project/radare2/libr/core/p/core_sixref.c"
            ...
            {
             r_cons_printf("%#"
# 158 "project/radare2/libr/core/p/core_sixref.c" 3 4
                              "llx"
# 158 "project/radare2/libr/core/p/core_sixref.c"
                                     ": %s x%u, %#"
# 158 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                                   "llx"
# 158 "project/radare2/libr/core/p/core_sixref.c"
...
# 158 "project/radare2/libr/core/p/core_sixref.c"
           ...
           else
           {
            ...
            {
             r_cons_printf("%#"
# 165 "project/radare2/libr/core/p/core_sixref.c" 3 4
                              "llx"
# 165 "project/radare2/libr/core/p/core_sixref.c"
                                     ": %s x%u, %#"
# 165 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                                   "llx"
# 165 "project/radare2/libr/core/p/core_sixref.c"
...
# 165 "project/radare2/libr/core/p/core_sixref.c"
            ...
            {
             r_cons_printf("%#"
# 169 "project/radare2/libr/core/p/core_sixref.c" 3 4
                              "llx"
# 169 "project/radare2/libr/core/p/core_sixref.c"
                                     ": %s x%u, %#"
# 169 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                                   "llx"
# 169 "project/radare2/libr/core/p/core_sixref.c"
...
# 169 "project/radare2/libr/core/p/core_sixref.c"
  ...
  else if((v & 0xbf000000) == 0x18000000 || (v & 0xff000000) == 0x98000000)
  {
   int64_t off = ((int64_t)((v >> 5) & 0x7ffff) << 45) >> 43;
   if (!search) {
    r_cons_printf ("ax 0x%"
# 186 "project/radare2/libr/core/p/core_sixref.c" 3 4
                          "llx"
# 186 "project/radare2/libr/core/p/core_sixref.c"
                                 " 0x%"
# 186 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                       "llx"
# 186 "project/radare2/libr/core/p/core_sixref.c"
...
# 188 "project/radare2/libr/core/p/core_sixref.c" 3 4
   unsigned int 
# 188 "project/radare2/libr/core/p/core_sixref.c"
        reg = v & 0x1f;
    
# 189 "project/radare2/libr/core/p/core_sixref.c" 3 4
   _Bool 
# 189 "project/radare2/libr/core/p/core_sixref.c"
        is_ldrsw = (v & 0xff000000) == 0x98000000;
    
# 190 "project/radare2/libr/core/p/core_sixref.c" 3 4
   _Bool 
# 190 "project/radare2/libr/core/p/core_sixref.c"
        is_64bit = (v & 0x40000000) != 0 && !is_ldrsw;
    r_cons_printf("%#"
# 191 "project/radare2/libr/core/p/core_sixref.c" 3 4
                     "llx"
# 191 "project/radare2/libr/core/p/core_sixref.c"
                            ": %s %s%u, %#"
# 191 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                           "llx"
# 191 "project/radare2/libr/core/p/core_sixref.c"
  ...
  else if((v & 0x7c000000) == 0x14000000)
  {
   int64_t off = ((int64_t)(v & 0x3ffffff) << 38) >> 36;
   
# 197 "project/radare2/libr/core/p/core_sixref.c" 3 4
  _Bool 
# 197 "project/radare2/libr/core/p/core_sixref.c"
       is_bl = (v & 0x80000000) != 0;
   if (!search) {
    r_cons_printf("ax 0x%"
# 199 "project/radare2/libr/core/p/core_sixref.c" 3 4
                         "llx"
# 199 "project/radare2/libr/core/p/core_sixref.c"
                                " 0x%"
# 199 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                      "llx"
# 199 "project/radare2/libr/core/p/core_sixref.c"
...
# 199 "project/radare2/libr/core/p/core_sixref.c"
    ...
    r_cons_printf("%#"
# 201 "project/radare2/libr/core/p/core_sixref.c" 3 4
                     "llx"
# 201 "project/radare2/libr/core/p/core_sixref.c"
                            ": %s %#"
# 201 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                     "llx"
# 201 "project/radare2/libr/core/p/core_sixref.c"
  ...
  else if((v & 0xff000010) == 0x54000000)
  {
   int64_t off = ((int64_t)((v >> 5) & 0x7ffff) << 45) >> 43;
   if (!search) {
    r_cons_printf ("ax 0x%"
# 208 "project/radare2/libr/core/p/core_sixref.c" 3 4
                          "llx"
# 208 "project/radare2/libr/core/p/core_sixref.c"
                                 " 0x%"
# 208 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                       "llx"
# 208 "project/radare2/libr/core/p/core_sixref.c"
    ...
    r_cons_printf("%#"
# 230 "project/radare2/libr/core/p/core_sixref.c" 3 4
                     "llx"
# 230 "project/radare2/libr/core/p/core_sixref.c"
                            ": b.%s %#"
# 230 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                       "llx"
# 230 "project/radare2/libr/core/p/core_sixref.c"
  ...
  else if((v & 0x7e000000) == 0x34000000)
  {
   int64_t off = ((int64_t)((v >> 5) & 0x7ffff) << 45) >> 43;
   if (!search) {
    r_cons_printf ("ax 0x%"
# 237 "project/radare2/libr/core/p/core_sixref.c" 3 4
                          "llx"
# 237 "project/radare2/libr/core/p/core_sixref.c"
                                 " 0x%"
# 237 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                       "llx"
# 237 "project/radare2/libr/core/p/core_sixref.c"
...
# 239 "project/radare2/libr/core/p/core_sixref.c" 3 4
   unsigned int 
# 239 "project/radare2/libr/core/p/core_sixref.c"
        reg = v & 0x1f;
    
# 240 "project/radare2/libr/core/p/core_sixref.c" 3 4
   _Bool 
# 240 "project/radare2/libr/core/p/core_sixref.c"
        is_64bit = (v & 0x80000000) != 0;
    
# 241 "project/radare2/libr/core/p/core_sixref.c" 3 4
   _Bool 
# 241 "project/radare2/libr/core/p/core_sixref.c"
        is_nz = (v & 0x01000000) != 0;
    r_cons_printf ("%#"
# 242 "project/radare2/libr/core/p/core_sixref.c" 3 4
                      "llx"
# 242 "project/radare2/libr/core/p/core_sixref.c"
                             ": %s %s%u, %#"
# 242 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                            "llx"
# 242 "project/radare2/libr/core/p/core_sixref.c"
  ...
  else if((v & 0x7e000000) == 0x36000000)
  {
   int64_t off = ((int64_t)((v >> 5) & 0x3fff) << 50) >> 48;
   if (!search) {
    r_cons_printf ("ax 0x%"
# 249 "project/radare2/libr/core/p/core_sixref.c" 3 4
                          "llx"
# 249 "project/radare2/libr/core/p/core_sixref.c"
                                 " 0x%"
# 249 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                       "llx"
# 249 "project/radare2/libr/core/p/core_sixref.c"
...
# 251 "project/radare2/libr/core/p/core_sixref.c" 3 4
   unsigned int 
# 251 "project/radare2/libr/core/p/core_sixref.c"
        reg = v & 0x1f;
    
# 252 "project/radare2/libr/core/p/core_sixref.c" 3 4
   unsigned int 
# 252 "project/radare2/libr/core/p/core_sixref.c"
        bit = ((v >> 19) & 0x1f) | ((v >> 26) & 0x20);
    
# 253 "project/radare2/libr/core/p/core_sixref.c" 3 4
   _Bool 
# 253 "project/radare2/libr/core/p/core_sixref.c"
        is_64bit = bit > 31;
    
# 254 "project/radare2/libr/core/p/core_sixref.c" 3 4
   _Bool 
# 254 "project/radare2/libr/core/p/core_sixref.c"
        is_nz = (v & 0x01000000) != 0;
    r_cons_printf ("%#"
# 255 "project/radare2/libr/core/p/core_sixref.c" 3 4
                      "llx"
# 255 "project/radare2/libr/core/p/core_sixref.c"
                             ": %s %s%u, %u, %#"
# 255 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                                "llx"
# 255 "project/radare2/libr/core/p/core_sixref.c"
...
static void siguza_xrefs(RCore *core, 
# 266 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                     unsigned long long 
# 266 "project/radare2/libr/core/p/core_sixref.c"
                                          search, 
# 266 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                                  unsigned long long 
# 266 "project/radare2/libr/core/p/core_sixref.c"
...
# 267 "project/radare2/libr/core/p/core_sixref.c" 3 4
unsigned long long 
# 267 "project/radare2/libr/core/p/core_sixref.c"
     end = start + lenbytes;
 
# 268 "project/radare2/libr/core/p/core_sixref.c" 3 4
unsigned long long 
# 268 "project/radare2/libr/core/p/core_sixref.c"
     cursor = start;
...
# 273 "project/radare2/libr/core/p/core_sixref.c" 3 4
 __builtin___snprintf_chk (
# 273 "project/radare2/libr/core/p/core_sixref.c"
 target_ref
# 273 "project/radare2/libr/core/p/core_sixref.c" 3 4
 , 
# 273 "project/radare2/libr/core/p/core_sixref.c"
...
# 275 "project/radare2/libr/core/p/core_sixref.c" 3 4
 __builtin___snprintf_chk (
# 275 "project/radare2/libr/core/p/core_sixref.c"
 target_ref
# 275 "project/radare2/libr/core/p/core_sixref.c" 3 4
 , 
# 275 "project/radare2/libr/core/p/core_sixref.c"
...
# 277 "project/radare2/libr/core/p/core_sixref.c" 3 4
fprintf(__stderrp,
# 277 "project/radare2/libr/core/p/core_sixref.c"
"Finding %s in 0x%08"
# 277 "project/radare2/libr/core/p/core_sixref.c" 3 4
"llx"
# 277 "project/radare2/libr/core/p/core_sixref.c"
...
static int r_cmdsixref_call(void *user, const char *input) {
 if (!r_str_startswith (input, "sixref")) {
  return 
# 292 "project/radare2/libr/core/p/core_sixref.c" 3 4
        0
# 292 "project/radare2/libr/core/p/core_sixref.c"
             ;
 }
...
# 301 "project/radare2/libr/core/p/core_sixref.c" 3 4
 fprintf(__stderrp,
# 301 "project/radare2/libr/core/p/core_sixref.c"
 "This command only works on arm64. Please check your asm.{arch,bits}\n"
# 301 "project/radare2/libr/core/p/core_sixref.c" 3 4
 )
# 301 "project/radare2/libr/core/p/core_sixref.c"
                                                                                  ;
  return 
# 302 "project/radare2/libr/core/p/core_sixref.c" 3 4
        1
# 302 "project/radare2/libr/core/p/core_sixref.c"
            ;
 }

 if (*input == '?') {
  
# 306 "project/radare2/libr/core/p/core_sixref.c" 3 4
 fprintf(__stderrp,
# 306 "project/radare2/libr/core/p/core_sixref.c"
 "Usage: sixref [address] [len]   Find x-refs in executable sections (arm64 only. fast!)\n"
# 306 "project/radare2/libr/core/p/core_sixref.c" 3 4
 )
# 306 "project/radare2/libr/core/p/core_sixref.c"
                                                                                                     ;
...
# 310 "project/radare2/libr/core/p/core_sixref.c" 3 4
unsigned long long 
# 310 "project/radare2/libr/core/p/core_sixref.c"
     search = 0;
 int len = 0;
...
# 325 "project/radare2/libr/core/p/core_sixref.c" 3 4
  fprintf(__stderrp,
# 325 "project/radare2/libr/core/p/core_sixref.c"
...
# 332 "project/radare2/libr/core/p/core_sixref.c" 3 4
 if (
# 332 "project/radare2/libr/core/p/core_sixref.c"
 sections
# 332 "project/radare2/libr/core/p/core_sixref.c" 3 4
 ) for (
# 332 "project/radare2/libr/core/p/core_sixref.c"
...
# 332 "project/radare2/libr/core/p/core_sixref.c"
                                    {
   if (s->is_segment || !(s->perm & 
# 333 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                   1
# 333 "project/radare2/libr/core/p/core_sixref.c"
                                           )) {
    continue;
   }
...
# 339 "project/radare2/libr/core/p/core_sixref.c" 3 4
 unsigned long long 
# 339 "project/radare2/libr/core/p/core_sixref.c"
      offset = core->offset;
  if (offset & 3) {
   offset -= offset % 4;
   
# 342 "project/radare2/libr/core/p/core_sixref.c" 3 4
  fprintf(__stderrp,
# 342 "project/radare2/libr/core/p/core_sixref.c"
  "Current offset is not 4-byte aligned, using 0x%"
# 342 "project/radare2/libr/core/p/core_sixref.c" 3 4
  "llx"
# 342 "project/radare2/libr/core/p/core_sixref.c"
  " instaed\n", offset
...
# 342 "project/radare2/libr/core/p/core_sixref.c"
  ...
  RBinSection *s = r_bin_get_section_at (core->bin->cur->o, offset, 
# 345 "project/radare2/libr/core/p/core_sixref.c" 3 4
                                                                   1
# 345 "project/radare2/libr/core/p/core_sixref.c"
                                                                       );
  if (!s || !(s->perm & 
# 346 "project/radare2/libr/core/p/core_sixref.c" 3 4
                       1
# 346 "project/radare2/libr/core/p/core_sixref.c"
                               )) {
   
# 347 "project/radare2/libr/core/p/core_sixref.c" 3 4
  fprintf(__stderrp,
# 347 "project/radare2/libr/core/p/core_sixref.c"
  "Current section is not executable\n"
# 347 "project/radare2/libr/core/p/core_sixref.c" 3 4
  )
# 347 "project/radare2/libr/core/p/core_sixref.c"
                                                 ;
...
# 351 "project/radare2/libr/core/p/core_sixref.c" 3 4
 unsigned long long 
# 351 "project/radare2/libr/core/p/core_sixref.c"
      sect_end = s->vaddr + s->vsize;
  if (offset + len > sect_end || offset + len < s->vaddr) {
   len = sect_end - offset;
   
# 354 "project/radare2/libr/core/p/core_sixref.c" 3 4
  fprintf(__stderrp,
# 354 "project/radare2/libr/core/p/core_sixref.c"
  "Length is not within range for this section, using %u instead\n", len
# 354 "project/radare2/libr/core/p/core_sixref.c" 3 4
  )
# 354 "project/radare2/libr/core/p/core_sixref.c"
                                                                                  ;
 ...
 return 
# 361 "project/radare2/libr/core/p/core_sixref.c" 3 4
       1
# 361 "project/radare2/libr/core/p/core_sixref.c"
           ;
}
...
# 372 "project/radare2/libr/core/p/core_sixref.c" 3 4
__attribute__((visibility("default"))) 
# 372 "project/radare2/libr/core/p/core_sixref.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_CORE,
 .data = &r_core_plugin_sixref,
 .version = 
# 375 "project/radare2/libr/core/p/core_sixref.c" 3 4
           "5.5.4"

# 376 "project/radare2/libr/core/p/core_sixref.c"
};
