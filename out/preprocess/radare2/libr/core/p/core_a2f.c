# 0 "project/radare2/libr/core/p/core_a2f.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
typedef int RRef;
# 4 "project/radare2/libr/core/p/core_a2f.c" 2
...
# 5 "project/radare2/libr/core/p/core_a2f.c" 2
# 13 "project/radare2/libr/core/p/core_a2f.c"

# 13 "project/radare2/libr/core/p/core_a2f.c"
static 
# 13 "project/radare2/libr/core/p/core_a2f.c" 3 4
      unsigned long long 
# 13 "project/radare2/libr/core/p/core_a2f.c"
           getCrossingBlock(Sdb *db, const char *key, 
# 13 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                                      unsigned long long 
# 13 "project/radare2/libr/core/p/core_a2f.c"
                                                           start, 
...
# 14 "project/radare2/libr/core/p/core_a2f.c" 3 4
unsigned long long 
# 14 "project/radare2/libr/core/p/core_a2f.c"
     block_start, block_end;
 
# 15 "project/radare2/libr/core/p/core_a2f.c" 3 4
unsigned long long 
# 15 "project/radare2/libr/core/p/core_a2f.c"
     nearest_start = 
# 15 "project/radare2/libr/core/p/core_a2f.c" 3 4
                     0xFFFFFFFFFFFFFFFFULL
# 15 "project/radare2/libr/core/p/core_a2f.c"
                             ;
 const char *s = sdb_const_get (db, key, 
# 16 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                        ((void *)0)
# 16 "project/radare2/libr/core/p/core_a2f.c"
                                            );
 const char *next = 
# 17 "project/radare2/libr/core/p/core_a2f.c" 3 4
                   ((void *)0)
# 17 "project/radare2/libr/core/p/core_a2f.c"
                       ;
 const char *ptr = 
# 18 "project/radare2/libr/core/p/core_a2f.c" 3 4
                  ((void *)0)
# 18 "project/radare2/libr/core/p/core_a2f.c"
                      ;
 if (!s) {
  return 
# 20 "project/radare2/libr/core/p/core_a2f.c" 3 4
        0xFFFFFFFFFFFFFFFFULL
# 20 "project/radare2/libr/core/p/core_a2f.c"
                ;
 }
 ptr = s;
 do {
  ...
  block_end = sdb_num_get (db, sdb_fmt("bb.%"
# 31 "project/radare2/libr/core/p/core_a2f.c" 3 4
                              "llx"
# 31 "project/radare2/libr/core/p/core_a2f.c"
                              ,block_start), 
# 31 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                                 ((void *)0)
# 31 "project/radare2/libr/core/p/core_a2f.c"
...
static int bbAdd(Sdb *db, 
# 55 "project/radare2/libr/core/p/core_a2f.c" 3 4
                         unsigned long long 
# 55 "project/radare2/libr/core/p/core_a2f.c"
                              from, 
# 55 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                    unsigned long long 
# 55 "project/radare2/libr/core/p/core_a2f.c"
...
# 56 "project/radare2/libr/core/p/core_a2f.c" 3 4
unsigned long long 
# 56 "project/radare2/libr/core/p/core_a2f.c"
     block_start = getCrossingBlock (db, "bbs", from, to);
 
# 57 "project/radare2/libr/core/p/core_a2f.c" 3 4
_Bool 
# 57 "project/radare2/libr/core/p/core_a2f.c"
     add = 
# 57 "project/radare2/libr/core/p/core_a2f.c" 3 4
           1
# 57 "project/radare2/libr/core/p/core_a2f.c"
               ;
 if (block_start == 
# 58 "project/radare2/libr/core/p/core_a2f.c" 3 4
                   0xFFFFFFFFFFFFFFFFULL
# 58 "project/radare2/libr/core/p/core_a2f.c"
                           ) {

 } else if (block_start == from) {

  add = 
# 62 "project/radare2/libr/core/p/core_a2f.c" 3 4
       0
# 62 "project/radare2/libr/core/p/core_a2f.c"
            ;
 } else {
# 73 "project/radare2/libr/core/p/core_a2f.c"
  if (from > block_start) {
   ...
   sdb_num_set (db, sdb_fmt("bb.%"
# 76 "project/radare2/libr/core/p/core_a2f.c" 3 4
                   "llx"
# 76 "project/radare2/libr/core/p/core_a2f.c"
                   ,block_start), from, 0);
   sdb_num_set (db, sdb_fmt("bb.%"
# 77 "project/radare2/libr/core/p/core_a2f.c" 3 4
                   "llx"
# 77 "project/radare2/libr/core/p/core_a2f.c"
                   ".to",block_start), from, 0);
   sdb_array_set_num (db, sdb_fmt("bb.%"
# 78 "project/radare2/libr/core/p/core_a2f.c" 3 4
                         "llx"
# 78 "project/radare2/libr/core/p/core_a2f.c"
                         ".to",block_start), 0, from, 0);
   sdb_array_set_num (db, sdb_fmt("bb.%"
# 79 "project/radare2/libr/core/p/core_a2f.c" 3 4
                         "llx"
# 79 "project/radare2/libr/core/p/core_a2f.c"
                         ".to",block_start), 1, 
# 79 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                                 0xFFFFFFFFFFFFFFFFULL
# 79 "project/radare2/libr/core/p/core_a2f.c"
   ...
   jump = block_start;
   fail = 
# 84 "project/radare2/libr/core/p/core_a2f.c" 3 4
         0xFFFFFFFFFFFFFFFFULL
# 84 "project/radare2/libr/core/p/core_a2f.c"
                 ;
  }
 }
 if (add) {
  ...
  sdb_num_set (db, sdb_fmt("bb.%"
# 89 "project/radare2/libr/core/p/core_a2f.c" 3 4
                  "llx"
# 89 "project/radare2/libr/core/p/core_a2f.c"
                  ,from), to, 0);
  sdb_array_set_num (db, sdb_fmt("bb.%"
# 90 "project/radare2/libr/core/p/core_a2f.c" 3 4
                        "llx"
# 90 "project/radare2/libr/core/p/core_a2f.c"
                        ".to",from), 0, jump, 0);
  sdb_array_set_num (db, sdb_fmt("bb.%"
# 91 "project/radare2/libr/core/p/core_a2f.c" 3 4
                        "llx"
# 91 "project/radare2/libr/core/p/core_a2f.c"
                        ".to",from), 1, fail, 0);
...
void addTarget(RCore *core, RStack *stack, Sdb *db, 
# 98 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                                   unsigned long long 
# 98 "project/radare2/libr/core/p/core_a2f.c"
                                                        addr) {
 if (sdb_num_get (db, sdb_fmt("handled.%"
# 99 "project/radare2/libr/core/p/core_a2f.c" 3 4
                     "llx"
# 99 "project/radare2/libr/core/p/core_a2f.c"
                     ,addr), 
# 99 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                      ((void *)0)
# 99 "project/radare2/libr/core/p/core_a2f.c"
...
# 103 "project/radare2/libr/core/p/core_a2f.c" 3 4
unsigned long long
# 103 "project/radare2/libr/core/p/core_a2f.c"
    * value = (
# 103 "project/radare2/libr/core/p/core_a2f.c" 3 4
               unsigned long long
# 103 "project/radare2/libr/core/p/core_a2f.c"
...
# 105 "project/radare2/libr/core/p/core_a2f.c" 3 4
 fprintf(__stderrp,
# 105 "project/radare2/libr/core/p/core_a2f.c"
 "Failed to allocate memory for address stack\n"
# 105 "project/radare2/libr/core/p/core_a2f.c" 3 4
 )
# 105 "project/radare2/libr/core/p/core_a2f.c"
                                                          ;
...
# 110 "project/radare2/libr/core/p/core_a2f.c" 3 4
 fprintf(__stderrp,
# 110 "project/radare2/libr/core/p/core_a2f.c"
 "Failed to push address on stack\n"
# 110 "project/radare2/libr/core/p/core_a2f.c" 3 4
 )
# 110 "project/radare2/libr/core/p/core_a2f.c"
                                              ;
 ...
 sdb_num_set (db, sdb_fmt("handled.%"
# 114 "project/radare2/libr/core/p/core_a2f.c" 3 4
                 "llx"
# 114 "project/radare2/libr/core/p/core_a2f.c"
                 ,addr), 1, 0);
}

static 
# 117 "project/radare2/libr/core/p/core_a2f.c" 3 4
      unsigned long long 
# 117 "project/radare2/libr/core/p/core_a2f.c"
           analyzeStackBased(RCore *core, Sdb *db, 
# 117 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                                   unsigned long long 
# 117 "project/radare2/libr/core/p/core_a2f.c"
                                                        addr, RList *delayed_commands) {
...
# 124 "project/radare2/libr/core/p/core_a2f.c" 3 4
unsigned long long 
# 124 "project/radare2/libr/core/p/core_a2f.c"
     oaddr = addr;
 
# 125 "project/radare2/libr/core/p/core_a2f.c" 3 4
unsigned long long 
# 125 "project/radare2/libr/core/p/core_a2f.c"
     *value = 
# 125 "project/radare2/libr/core/p/core_a2f.c" 3 4
              ((void *)0)
# 125 "project/radare2/libr/core/p/core_a2f.c"
...
# 128 "project/radare2/libr/core/p/core_a2f.c" 3 4
_Bool 
# 128 "project/radare2/libr/core/p/core_a2f.c"
     block_end = 
# 128 "project/radare2/libr/core/p/core_a2f.c" 3 4
                 0
# 128 "project/radare2/libr/core/p/core_a2f.c"
 ...
 const 
# 131 "project/radare2/libr/core/p/core_a2f.c" 3 4
      unsigned long long 
# 131 "project/radare2/libr/core/p/core_a2f.c"
           maxfcnsize = 1024 * 32;

 while (!r_stack_is_empty (stack)) {
  block_end = 
# 134 "project/radare2/libr/core/p/core_a2f.c" 3 4
             0
# 134 "project/radare2/libr/core/p/core_a2f.c"
                  ;
  value = (
# 135 "project/radare2/libr/core/p/core_a2f.c" 3 4
          unsigned long long
# 135 "project/radare2/libr/core/p/core_a2f.c"
              *) r_stack_pop (stack);
  if (!value) {
   
# 137 "project/radare2/libr/core/p/core_a2f.c" 3 4
  fprintf(__stderrp,
# 137 "project/radare2/libr/core/p/core_a2f.c"
  "Failed to pop next address from stack\n"
# 137 "project/radare2/libr/core/p/core_a2f.c" 3 4
  )
# 137 "project/radare2/libr/core/p/core_a2f.c"
                                                     ;
...
# 147 "project/radare2/libr/core/p/core_a2f.c" 3 4
   fprintf(__stderrp,
# 147 "project/radare2/libr/core/p/core_a2f.c"
   "a2f: Cannot analyze opcode at 0x%"
# 147 "project/radare2/libr/core/p/core_a2f.c" 3 4
   "llx"
# 147 "project/radare2/libr/core/p/core_a2f.c"
   "\n", addr+cur
...
# 147 "project/radare2/libr/core/p/core_a2f.c"
                                                                     ;
    oaddr = 
# 148 "project/radare2/libr/core/p/core_a2f.c" 3 4
           0xFFFFFFFFFFFFFFFFULL
# 148 "project/radare2/libr/core/p/core_a2f.c"
                   ;
    break;
   }
   if (op->mnemonic[0] == '?') {
    
# 152 "project/radare2/libr/core/p/core_a2f.c" 3 4
   fprintf(__stderrp,
# 152 "project/radare2/libr/core/p/core_a2f.c"
   "a2f: Cannot analyze opcode at 0x%"
# 152 "project/radare2/libr/core/p/core_a2f.c" 3 4
   "llx"
# 152 "project/radare2/libr/core/p/core_a2f.c"
...
# 152 "project/radare2/libr/core/p/core_a2f.c"
                                                                     ;
    oaddr = 
# 153 "project/radare2/libr/core/p/core_a2f.c" 3 4
           0xFFFFFFFFFFFFFFFFULL
# 153 "project/radare2/libr/core/p/core_a2f.c"
                   ;
    break;
   }

   sdb_array_insert_num (db, sdb_fmt ("bb.%"
# 157 "project/radare2/libr/core/p/core_a2f.c" 3 4
  "llx"
# 157 "project/radare2/libr/core/p/core_a2f.c"
  , addr+cur), -1, addr + cur, 0);;
   switch (op->type) {
   ...
   case R_ANAL_OP_TYPE_CALL:
    ...
    sdb_array_add_num (db, "calls", op->jump, 0);;
    r_list_append (delayed_commands, r_str_newf ("axC %"
# 172 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                                       "lld"
# 172 "project/radare2/libr/core/p/core_a2f.c"
                                                              " %"
# 172 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                                                  "lld"
# 172 "project/radare2/libr/core/p/core_a2f.c"
   ...
   case R_ANAL_OP_TYPE_UCCALL:
    ...
    sdb_array_add_num (db, "ucalls", addr + cur, 0);;
    if (op->ptr != 
# 185 "project/radare2/libr/core/p/core_a2f.c" 3 4
                  0xFFFFFFFFFFFFFFFFULL
# 185 "project/radare2/libr/core/p/core_a2f.c"
                          ) {
     r_list_append (delayed_commands, r_str_newf ("axC %"
# 186 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                                        "lld"
# 186 "project/radare2/libr/core/p/core_a2f.c"
                                                               " %"
# 186 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                                                   "lld"
# 186 "project/radare2/libr/core/p/core_a2f.c"
   ...
   case R_ANAL_OP_TYPE_IRJMP:
    ...
    sdb_array_add_num (db, "ujmps", addr + cur, 0);;

    block_end = 
# 201 "project/radare2/libr/core/p/core_a2f.c" 3 4
               1
# 201 "project/radare2/libr/core/p/core_a2f.c"
                   ;
    break;
   case R_ANAL_OP_TYPE_TRAP:
    if (cur == 0) {
     ...
     block_end = 
# 210 "project/radare2/libr/core/p/core_a2f.c" 3 4
                1
# 210 "project/radare2/libr/core/p/core_a2f.c"
                    ;
    }
    break;
   case R_ANAL_OP_TYPE_CRET:
   case R_ANAL_OP_TYPE_RET:
    sdb_array_add_num (db, "rets", addr + cur, 0);;
    bbAdd (db, addr, addr + cur + op->size, 
# 216 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                           0xFFFFFFFFFFFFFFFFULL
# 216 "project/radare2/libr/core/p/core_a2f.c"
                                                   , 
# 216 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                                     0xFFFFFFFFFFFFFFFFULL
# 216 "project/radare2/libr/core/p/core_a2f.c"
    ...
    block_end = 
# 217 "project/radare2/libr/core/p/core_a2f.c" 3 4
               1
# 217 "project/radare2/libr/core/p/core_a2f.c"
                   ;
    break;
   case R_ANAL_OP_TYPE_CJMP:
    sdb_array_add_num (db, "cjmps", addr+cur, 0);;
    ...
    block_end = 
# 224 "project/radare2/libr/core/p/core_a2f.c" 3 4
               1
# 224 "project/radare2/libr/core/p/core_a2f.c"
                   ;
    r_list_append (delayed_commands, r_str_newf ("axc %"
# 225 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                                       "lld"
# 225 "project/radare2/libr/core/p/core_a2f.c"
                                                              " %"
# 225 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                                                  "lld"
# 225 "project/radare2/libr/core/p/core_a2f.c"
   ...
   case R_ANAL_OP_TYPE_JMP:
    sdb_array_add_num (db, "ujmps", addr+cur, 0);;
    bbAdd (db, addr, addr + cur + op->size, op->jump, 
# 229 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                                     0xFFFFFFFFFFFFFFFFULL
# 229 "project/radare2/libr/core/p/core_a2f.c"
                                                             );
    addTarget (core, stack, db, op->jump);
    block_end = 
# 231 "project/radare2/libr/core/p/core_a2f.c" 3 4
               1
# 231 "project/radare2/libr/core/p/core_a2f.c"
                   ;
    r_list_append (delayed_commands, r_str_newf ("axc %"
# 232 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                                       "lld"
# 232 "project/radare2/libr/core/p/core_a2f.c"
                                                              " %"
# 232 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                                                  "lld"
# 232 "project/radare2/libr/core/p/core_a2f.c"
...
# 236 "project/radare2/libr/core/p/core_a2f.c" 3 4
   fprintf(__stderrp,
# 236 "project/radare2/libr/core/p/core_a2f.c"
   "a2f: Invalid instruction\n"
# 236 "project/radare2/libr/core/p/core_a2f.c" 3 4
   )
# 236 "project/radare2/libr/core/p/core_a2f.c"
                                         ;
    block_end = 
# 237 "project/radare2/libr/core/p/core_a2f.c" 3 4
               1
# 237 "project/radare2/libr/core/p/core_a2f.c"
                   ;
    break;
   default:
    if (op->ptr != 
# 240 "project/radare2/libr/core/p/core_a2f.c" 3 4
                  0xFFFFFFFFFFFFFFFFULL
# 240 "project/radare2/libr/core/p/core_a2f.c"
                          ) {
     r_list_append (delayed_commands, r_str_newf ("axd %"
# 241 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                                        "lld"
# 241 "project/radare2/libr/core/p/core_a2f.c"
                                                               " %"
# 241 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                                                   "lld"
# 241 "project/radare2/libr/core/p/core_a2f.c"
   ...
   r_anal_op_free (op);
   op = 
# 247 "project/radare2/libr/core/p/core_a2f.c" 3 4
       ((void *)0)
# 247 "project/radare2/libr/core/p/core_a2f.c"
           ;
  }
 }
 if (block_end) {
  bbAdd (db, addr, addr + cur, 
# 251 "project/radare2/libr/core/p/core_a2f.c" 3 4
                              0xFFFFFFFFFFFFFFFFULL
# 251 "project/radare2/libr/core/p/core_a2f.c"
                                      , 
# 251 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                        0xFFFFFFFFFFFFFFFFULL
# 251 "project/radare2/libr/core/p/core_a2f.c"
...
static 
# 257 "project/radare2/libr/core/p/core_a2f.c" 3 4
      unsigned long long 
# 257 "project/radare2/libr/core/p/core_a2f.c"
           getFunctionSize(Sdb *db) {
 
# 258 "project/radare2/libr/core/p/core_a2f.c" 3 4
unsigned long long 
# 258 "project/radare2/libr/core/p/core_a2f.c"
     min = 
# 258 "project/radare2/libr/core/p/core_a2f.c" 3 4
           0xFFFFFFFFFFFFFFFFULL
# 258 "project/radare2/libr/core/p/core_a2f.c"
                   , max = 0;
 char *c, *bbs = sdb_get (db, "bbs", 
# 259 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                    ((void *)0)
# 259 "project/radare2/libr/core/p/core_a2f.c"
                                        );
 
# 260 "project/radare2/libr/core/p/core_a2f.c" 3 4
_Bool 
# 260 "project/radare2/libr/core/p/core_a2f.c"
     first = 
# 260 "project/radare2/libr/core/p/core_a2f.c" 3 4
             1
# 260 "project/radare2/libr/core/p/core_a2f.c"
...
# 261 "project/radare2/libr/core/p/core_a2f.c" 3 4
{ char *next; if (
# 261 "project/radare2/libr/core/p/core_a2f.c"
bbs
# 261 "project/radare2/libr/core/p/core_a2f.c" 3 4
) for (
# 261 "project/radare2/libr/core/p/core_a2f.c"
...
# 262 "project/radare2/libr/core/p/core_a2f.c" 3 4
 unsigned long long 
# 262 "project/radare2/libr/core/p/core_a2f.c"
      addr = sdb_atoi (c);
  
# 263 "project/radare2/libr/core/p/core_a2f.c" 3 4
 unsigned long long 
# 263 "project/radare2/libr/core/p/core_a2f.c"
      addr_end = sdb_num_get (db, sdb_fmt("bb.%"
# 263 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                  "llx"
# 263 "project/radare2/libr/core/p/core_a2f.c"
                                  ,addr), 
...
# 263 "project/radare2/libr/core/p/core_a2f.c"
  ...
  if (first) {
   ...
   max = addr_end;
   first = 
# 267 "project/radare2/libr/core/p/core_a2f.c" 3 4
          0
# 267 "project/radare2/libr/core/p/core_a2f.c"
               ;
  } else {
   if (addr < min) {
    min = addr;
...
# 276 "project/radare2/libr/core/p/core_a2f.c" 3 4
 if (!next) break; *(next-1) = ','; 
# 276 "project/radare2/libr/core/p/core_a2f.c"
 c 
# 276 "project/radare2/libr/core/p/core_a2f.c" 3 4
 = next; } }
# 276 "project/radare2/libr/core/p/core_a2f.c"
...
static 
# 282 "project/radare2/libr/core/p/core_a2f.c" 3 4
      _Bool 
# 282 "project/radare2/libr/core/p/core_a2f.c"
           analyzeFunction(RCore *core, 
# 282 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                        unsigned long long 
# 282 "project/radare2/libr/core/p/core_a2f.c"
                                             addr) {
 Sdb *db = sdb_new0 ();
 RFlagItem *fi;
 RList *delayed_commands = 
# 285 "project/radare2/libr/core/p/core_a2f.c" 3 4
                          ((void *)0)
# 285 "project/radare2/libr/core/p/core_a2f.c"
                              ;
 RListIter *iter;
 
# 287 "project/radare2/libr/core/p/core_a2f.c" 3 4
unsigned long long 
# 287 "project/radare2/libr/core/p/core_a2f.c"
     loc_addr = 0;
 char *command = 
# 288 "project/radare2/libr/core/p/core_a2f.c" 3 4
                ((void *)0)
# 288 "project/radare2/libr/core/p/core_a2f.c"
                    ;
 char *function_label;
 
# 290 "project/radare2/libr/core/p/core_a2f.c" 3 4
_Bool 
# 290 "project/radare2/libr/core/p/core_a2f.c"
     vars = r_config_get_b (core->config, "anal.vars");
 if (!db) {
  
# 292 "project/radare2/libr/core/p/core_a2f.c" 3 4
 fprintf(__stderrp,
# 292 "project/radare2/libr/core/p/core_a2f.c"
 "Cannot create db\n"
# 292 "project/radare2/libr/core/p/core_a2f.c" 3 4
 )
# 292 "project/radare2/libr/core/p/core_a2f.c"
                               ;
  return 
# 293 "project/radare2/libr/core/p/core_a2f.c" 3 4
        0
# 293 "project/radare2/libr/core/p/core_a2f.c"
             ;
 }
...
# 298 "project/radare2/libr/core/p/core_a2f.c" 3 4
 fprintf(__stderrp,
# 298 "project/radare2/libr/core/p/core_a2f.c"
 "Failed to initialize the delayed command list\n"
# 298 "project/radare2/libr/core/p/core_a2f.c" 3 4
 )
# 298 "project/radare2/libr/core/p/core_a2f.c"
                                                            ;
  sdb_free (db);
  return 
# 300 "project/radare2/libr/core/p/core_a2f.c" 3 4
        0
# 300 "project/radare2/libr/core/p/core_a2f.c"
             ;
 }

 
# 303 "project/radare2/libr/core/p/core_a2f.c" 3 4
unsigned long long 
# 303 "project/radare2/libr/core/p/core_a2f.c"
     a = analyzeStackBased (core, db, addr, delayed_commands);
 if (addr == 
# 304 "project/radare2/libr/core/p/core_a2f.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 304 "project/radare2/libr/core/p/core_a2f.c"
                    ) {
  
# 305 "project/radare2/libr/core/p/core_a2f.c" 3 4
 fprintf(__stderrp,
# 305 "project/radare2/libr/core/p/core_a2f.c"
...
# 305 "project/radare2/libr/core/p/core_a2f.c"
                                      ;
  return 
# 306 "project/radare2/libr/core/p/core_a2f.c" 3 4
        0
# 306 "project/radare2/libr/core/p/core_a2f.c"
             ;
 }
 if (a != 
# 308 "project/radare2/libr/core/p/core_a2f.c" 3 4
         0xFFFFFFFFFFFFFFFFULL
# 308 "project/radare2/libr/core/p/core_a2f.c"
                 ) {
  addr = a;
 }
...
# 327 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                       0
# 327 "project/radare2/libr/core/p/core_a2f.c"
                                            );
 if (fi && fi->name && strncmp (fi->name, "sect", 4)) {
  function_label = strdup (fi->name);
 } else {
  function_label = r_str_newf ("fcn.%08"
# 331 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                       "llx"
# 331 "project/radare2/libr/core/p/core_a2f.c"
                                              , addr);
 }

 loc_addr = sdb_num_get (db, "addr", 
# 334 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                    ((void *)0)
# 334 "project/radare2/libr/core/p/core_a2f.c"
                                        );
 RAnalFunction *fcn_at_addr = r_anal_get_function_at (core->anal, loc_addr);
 if (fcn_at_addr) {
  return 
# 337 "project/radare2/libr/core/p/core_a2f.c" 3 4
        0
# 337 "project/radare2/libr/core/p/core_a2f.c"
             ;
 }


 r_core_cmdf (core, "af+ 0x%08"
# 341 "project/radare2/libr/core/p/core_a2f.c" 3 4
                              "llx"
# 341 "project/radare2/libr/core/p/core_a2f.c"
                                     " %s", loc_addr, function_label);
 {
  char *c, *bbs = sdb_get (db, "bbs", 
# 343 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                     ((void *)0)
# 343 "project/radare2/libr/core/p/core_a2f.c"
                                         );
  
# 344 "project/radare2/libr/core/p/core_a2f.c" 3 4
 { char *next; if (
# 344 "project/radare2/libr/core/p/core_a2f.c"
 bbs
# 344 "project/radare2/libr/core/p/core_a2f.c" 3 4
 ) for (
# 344 "project/radare2/libr/core/p/core_a2f.c"
...
# 345 "project/radare2/libr/core/p/core_a2f.c" 3 4
  unsigned long long 
# 345 "project/radare2/libr/core/p/core_a2f.c"
       addr = sdb_atoi (c);
   
# 346 "project/radare2/libr/core/p/core_a2f.c" 3 4
  unsigned long long 
# 346 "project/radare2/libr/core/p/core_a2f.c"
       addr_end = sdb_num_get (db, sdb_fmt("bb.%"
# 346 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                   "llx"
# 346 "project/radare2/libr/core/p/core_a2f.c"
...
# 348 "project/radare2/libr/core/p/core_a2f.c" 3 4
  unsigned long long 
# 348 "project/radare2/libr/core/p/core_a2f.c"
       jump = sdb_array_get_num (db, sdb_fmt("bb.%"
# 348 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                     "llx"
# 348 "project/radare2/libr/core/p/core_a2f.c"
                                     ".to",addr), 0, 
...
# 349 "project/radare2/libr/core/p/core_a2f.c" 3 4
  unsigned long long 
# 349 "project/radare2/libr/core/p/core_a2f.c"
       fail = sdb_array_get_num (db, sdb_fmt("bb.%"
# 349 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                     "llx"
# 349 "project/radare2/libr/core/p/core_a2f.c"
                                     ".to",addr), 1, 
...
# 349 "project/radare2/libr/core/p/core_a2f.c"
   ...
   r_core_cmdf (core, "afb+ 0x%"
# 353 "project/radare2/libr/core/p/core_a2f.c" 3 4
                               "llx"
# 353 "project/radare2/libr/core/p/core_a2f.c"
                                      " 0x%"
# 353 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                            "llx"
# 353 "project/radare2/libr/core/p/core_a2f.c"
...
# 355 "project/radare2/libr/core/p/core_a2f.c" 3 4
  if (!next) break; *(next-1) = ','; 
# 355 "project/radare2/libr/core/p/core_a2f.c"
  c 
# 355 "project/radare2/libr/core/p/core_a2f.c" 3 4
  = next; } }
# 355 "project/radare2/libr/core/p/core_a2f.c"
  ...
  if (vars) {
   ...
   if (fcn && !
# 361 "project/radare2/libr/core/p/core_a2f.c" 3 4
              (!(
# 361 "project/radare2/libr/core/p/core_a2f.c"
              fcn->bbs
# 361 "project/radare2/libr/core/p/core_a2f.c" 3 4
              ) || !(
# 361 "project/radare2/libr/core/p/core_a2f.c"
...
# 361 "project/radare2/libr/core/p/core_a2f.c"
    ...
    r_core_cmdf (core, "afva @ 0x%"
# 362 "project/radare2/libr/core/p/core_a2f.c" 3 4
                                  "llx"
# 362 "project/radare2/libr/core/p/core_a2f.c"
                                         , addr);
   }
  }
  free (bbs);
...
# 368 "project/radare2/libr/core/p/core_a2f.c" 3 4
if (
# 368 "project/radare2/libr/core/p/core_a2f.c"
delayed_commands
# 368 "project/radare2/libr/core/p/core_a2f.c" 3 4
) for (
# 368 "project/radare2/libr/core/p/core_a2f.c"
...
# 368 "project/radare2/libr/core/p/core_a2f.c"
  ...
  if (command) {
   ...
   command = 
# 371 "project/radare2/libr/core/p/core_a2f.c" 3 4
            ((void *)0)
# 371 "project/radare2/libr/core/p/core_a2f.c"
                ;
  }
 }
# 386 "project/radare2/libr/core/p/core_a2f.c"
 ...
 sdb_free (db);
 return 
# 388 "project/radare2/libr/core/p/core_a2f.c" 3 4
       1
# 388 "project/radare2/libr/core/p/core_a2f.c"
           ;
}
...
# 397 "project/radare2/libr/core/p/core_a2f.c" 3 4
   fprintf(__stderrp,
# 397 "project/radare2/libr/core/p/core_a2f.c"
   "a2f: Failed to analyze function at 0x%08"
# 397 "project/radare2/libr/core/p/core_a2f.c" 3 4
   "llx"
# 397 "project/radare2/libr/core/p/core_a2f.c"
   ".\n", core->offset
...
# 401 "project/radare2/libr/core/p/core_a2f.c" 3 4
  fprintf(__stderrp,
# 401 "project/radare2/libr/core/p/core_a2f.c"
  "Usage: a2f @ address_of_function          # See anal.a2f\n"
# 401 "project/radare2/libr/core/p/core_a2f.c" 3 4
  )
# 401 "project/radare2/libr/core/p/core_a2f.c"
                                                                        ;
   
# 402 "project/radare2/libr/core/p/core_a2f.c" 3 4
  fprintf(__stderrp,
# 402 "project/radare2/libr/core/p/core_a2f.c"
  "a2f is an experimental analysis engine that replaces af.\n"
# 402 "project/radare2/libr/core/p/core_a2f.c" 3 4
  )
# 402 "project/radare2/libr/core/p/core_a2f.c"
                                                                        ;
  ...
  return 
# 405 "project/radare2/libr/core/p/core_a2f.c" 3 4
        1
# 405 "project/radare2/libr/core/p/core_a2f.c"
            ;
 }
 return 
# 407 "project/radare2/libr/core/p/core_a2f.c" 3 4
       0
# 407 "project/radare2/libr/core/p/core_a2f.c"
            ;
}
...
# 419 "project/radare2/libr/core/p/core_a2f.c" 3 4
__attribute__((visibility("default"))) 
# 419 "project/radare2/libr/core/p/core_a2f.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_CORE,
 .data = &r_core_plugin_a2f,
 .version = 
# 422 "project/radare2/libr/core/p/core_a2f.c" 3 4
           "5.5.4"

# 423 "project/radare2/libr/core/p/core_a2f.c"
};
