# 0 "project/radare2/libr/core/cmd_eval.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/cmd_eval.c"
...
# 6 "project/radare2/libr/core/cmd_eval.c" 2


# 7 "project/radare2/libr/core/cmd_eval.c"
...
# 30 "project/radare2/libr/core/cmd_eval.c" 3 4
((void *)0)

# 31 "project/radare2/libr/core/cmd_eval.c"
};
...
# 51 "project/radare2/libr/core/cmd_eval.c" 3 4
                             "/" ".local" "/" "share" "/" "radare2" "/" "cons" 
# 51 "project/radare2/libr/core/cmd_eval.c"
                                                                  " ./",
 
# 52 "project/radare2/libr/core/cmd_eval.c" 3 4
((void *)0)

# 53 "project/radare2/libr/core/cmd_eval.c"
};
...
static const char *help_msg_eco[] = {
 ...
 "Path:", "", "",
 "$DATADIR/radare2/cons", "", "~" 
# 65 "project/radare2/libr/core/cmd_eval.c" 3 4
                             "/" ".local" "/" "share" "/" "radare2" "/" "cons" 
# 65 "project/radare2/libr/core/cmd_eval.c"
                                                                  " ./",
 
# 66 "project/radare2/libr/core/cmd_eval.c" 3 4
((void *)0)

# 67 "project/radare2/libr/core/cmd_eval.c"
};

static 
# 69 "project/radare2/libr/core/cmd_eval.c" 3 4
      _Bool 
# 69 "project/radare2/libr/core/cmd_eval.c"
           getNext = 
# 69 "project/radare2/libr/core/cmd_eval.c" 3 4
                     0
# 69 "project/radare2/libr/core/cmd_eval.c"
...
static 
# 71 "project/radare2/libr/core/cmd_eval.c" 3 4
      _Bool 
# 71 "project/radare2/libr/core/cmd_eval.c"
           load_theme(RCore *core, const char *path) {
 if (!r_file_exists (path)) {
  return 
# 73 "project/radare2/libr/core/cmd_eval.c" 3 4
        0
# 73 "project/radare2/libr/core/cmd_eval.c"
             ;
 }
 core->cmdfilter = "ec ";
 
# 76 "project/radare2/libr/core/cmd_eval.c" 3 4
_Bool 
# 76 "project/radare2/libr/core/cmd_eval.c"
     res = r_core_cmd_file (core, path);
 if (res) {
  r_cons_pal_update_event ();
 }
 core->cmdfilter = 
# 80 "project/radare2/libr/core/cmd_eval.c" 3 4
                  ((void *)0)
# 80 "project/radare2/libr/core/cmd_eval.c"
                      ;
 return res;
}

static 
# 84 "project/radare2/libr/core/cmd_eval.c" 3 4
      _Bool 
# 84 "project/radare2/libr/core/cmd_eval.c"
           nextpal_item(RCore *core, PJ *pj, int mode, const char *file) {
 ...
 case 'n':
  if (core->theme && !strcmp (core->theme, "default")) {
   ...
   getNext = 
# 100 "project/radare2/libr/core/cmd_eval.c" 3 4
            0
# 100 "project/radare2/libr/core/cmd_eval.c"
                 ;
  }
  if (getNext) {
   core->theme = r_str_dup (core->theme, fn);
   getNext = 
# 104 "project/radare2/libr/core/cmd_eval.c" 3 4
            0
# 104 "project/radare2/libr/core/cmd_eval.c"
                 ;
   return 
# 105 "project/radare2/libr/core/cmd_eval.c" 3 4
         0
# 105 "project/radare2/libr/core/cmd_eval.c"
              ;
  } else if (core->theme) {
   if (!strcmp (core->theme, fn)) {
    getNext = 
# 108 "project/radare2/libr/core/cmd_eval.c" 3 4
             1
# 108 "project/radare2/libr/core/cmd_eval.c"
                 ;
   }
  } else {
   core->theme = r_str_dup (core->theme, fn);
   return 
# 112 "project/radare2/libr/core/cmd_eval.c" 3 4
         0
# 112 "project/radare2/libr/core/cmd_eval.c"
              ;
  }
  break;
 }
 return 
# 116 "project/radare2/libr/core/cmd_eval.c" 3 4
       1
# 116 "project/radare2/libr/core/cmd_eval.c"
           ;
}

static 
# 119 "project/radare2/libr/core/cmd_eval.c" 3 4
      _Bool 
# 119 "project/radare2/libr/core/cmd_eval.c"
           cmd_load_theme(RCore *core, const char *_arg) {
 
# 120 "project/radare2/libr/core/cmd_eval.c" 3 4
_Bool 
# 120 "project/radare2/libr/core/cmd_eval.c"
     failed = 
# 120 "project/radare2/libr/core/cmd_eval.c" 3 4
              0
# 120 "project/radare2/libr/core/cmd_eval.c"
 ...
 if (!_arg || !*_arg) {
  return 
# 123 "project/radare2/libr/core/cmd_eval.c" 3 4
        0
# 123 "project/radare2/libr/core/cmd_eval.c"
             ;
 }
 if (!r_str_cmp (_arg, "default", strlen (_arg))) {
  ...
  return 
# 128 "project/radare2/libr/core/cmd_eval.c" 3 4
        1
# 128 "project/radare2/libr/core/cmd_eval.c"
            ;
 }
 char *arg = strdup (_arg);

 char *tmp = r_str_newf (
# 132 "project/radare2/libr/core/cmd_eval.c" 3 4
                        ".local" "/" "share" "/" "radare2" "/" "cons" "/" 
# 132 "project/radare2/libr/core/cmd_eval.c"
                        "%s", arg);
 char *home = tmp ? r_str_home (tmp) : 
# 133 "project/radare2/libr/core/cmd_eval.c" 3 4
                                      ((void *)0)
# 133 "project/radare2/libr/core/cmd_eval.c"
                                          ;
 free (tmp);

 tmp = r_str_newf (
# 136 "project/radare2/libr/core/cmd_eval.c" 3 4
                  "share" "/" "radare2" "/" "5.5.4" "/" "cons" "/" 
# 136 "project/radare2/libr/core/cmd_eval.c"
                  "%s", arg);
 path = tmp ? r_str_r2_prefix (tmp) : 
# 137 "project/radare2/libr/core/cmd_eval.c" 3 4
                                     ((void *)0)
# 137 "project/radare2/libr/core/cmd_eval.c"
                                         ;
 free (tmp);
 ...
 if (load_theme (core, home)) {
  ...
  core->themepath = home;
  home = 
# 143 "project/radare2/libr/core/cmd_eval.c" 3 4
        ((void *)0)
# 143 "project/radare2/libr/core/cmd_eval.c"
            ;
 } else {
  if (load_theme (core, path)) {
   ...
   core->themepath = path;
   path = 
# 148 "project/radare2/libr/core/cmd_eval.c" 3 4
         ((void *)0)
# 148 "project/radare2/libr/core/cmd_eval.c"
             ;
  } else {
   if (load_theme (core, arg)) {
    ...
    core->themepath = arg;
    arg = 
# 153 "project/radare2/libr/core/cmd_eval.c" 3 4
         ((void *)0)
# 153 "project/radare2/libr/core/cmd_eval.c"
             ;
   } else {
    char *absfile = r_file_abspath (arg);
    
# 156 "project/radare2/libr/core/cmd_eval.c" 3 4
   fprintf(__stderrp,
# 156 "project/radare2/libr/core/cmd_eval.c"
   "eco: cannot open colorscheme profile (%s)\n", absfile
# 156 "project/radare2/libr/core/cmd_eval.c" 3 4
   )
# 156 "project/radare2/libr/core/cmd_eval.c"
                                                                   ;
    free (absfile);
    failed = 
# 158 "project/radare2/libr/core/cmd_eval.c" 3 4
            1
# 158 "project/radare2/libr/core/cmd_eval.c"
                ;
   }
  }
 }
...
# 172 "project/radare2/libr/core/cmd_eval.c" 3 4
if (
# 172 "project/radare2/libr/core/cmd_eval.c"
files
# 172 "project/radare2/libr/core/cmd_eval.c" 3 4
) for (
# 172 "project/radare2/libr/core/cmd_eval.c"
...
# 180 "project/radare2/libr/core/cmd_eval.c" 3 4
__attribute__((visibility("default"))) 
# 180 "project/radare2/libr/core/cmd_eval.c"
     char *r_core_get_theme(RCore *core) {
 return core->theme;
}


# 184 "project/radare2/libr/core/cmd_eval.c" 3 4
__attribute__((visibility("default"))) 
# 184 "project/radare2/libr/core/cmd_eval.c"
     RList *r_core_list_themes(RCore *core) {
 RList *list = r_list_newf (free);
 getNext = 
# 186 "project/radare2/libr/core/cmd_eval.c" 3 4
          0
# 186 "project/radare2/libr/core/cmd_eval.c"
               ;
 char *tmp = strdup ("default");
 r_list_append (list, tmp);
 char *path = r_str_home (
# 189 "project/radare2/libr/core/cmd_eval.c" 3 4
                         ".local" "/" "share" "/" "radare2" "/" "cons" "/"
# 189 "project/radare2/libr/core/cmd_eval.c"
                                                 );
 if (path) {
  list_themes_in_path (list, path);
  
# 192 "project/radare2/libr/core/cmd_eval.c" 3 4
 { free((void *)
# 192 "project/radare2/libr/core/cmd_eval.c"
 path
# 192 "project/radare2/libr/core/cmd_eval.c" 3 4
 ); 
# 192 "project/radare2/libr/core/cmd_eval.c"
...
# 192 "project/radare2/libr/core/cmd_eval.c"
 ...
 path = r_str_r2_prefix (
# 195 "project/radare2/libr/core/cmd_eval.c" 3 4
                        "share" "/" "radare2" "/" "5.5.4" "/" "cons" "/"
# 195 "project/radare2/libr/core/cmd_eval.c"
                                           );
 if (path) {
  list_themes_in_path (list, path);
  
# 198 "project/radare2/libr/core/cmd_eval.c" 3 4
 { free((void *)
# 198 "project/radare2/libr/core/cmd_eval.c"
 path
# 198 "project/radare2/libr/core/cmd_eval.c" 3 4
 ); 
# 198 "project/radare2/libr/core/cmd_eval.c"
...
static void nextpal(RCore *core, int mode) {
 ...
 RList *files = 
# 207 "project/radare2/libr/core/cmd_eval.c" 3 4
               ((void *)0)
# 207 "project/radare2/libr/core/cmd_eval.c"
                   ;
 RListIter *iter;
 const char *fn;
 char *path = 
# 210 "project/radare2/libr/core/cmd_eval.c" 3 4
             ((void *)0)
# 210 "project/radare2/libr/core/cmd_eval.c"
                 ;
 PJ *pj = 
# 211 "project/radare2/libr/core/cmd_eval.c" 3 4
         ((void *)0)
# 211 "project/radare2/libr/core/cmd_eval.c"
             ;
 if (mode == 'j') {
...
# 219 "project/radare2/libr/core/cmd_eval.c" 3 4
                         ".local" "/" "share" "/" "radare2" "/" "cons" "/"
# 219 "project/radare2/libr/core/cmd_eval.c"
                                                 );

 getNext = 
# 221 "project/radare2/libr/core/cmd_eval.c" 3 4
          0
# 221 "project/radare2/libr/core/cmd_eval.c"
               ;
...
# 227 "project/radare2/libr/core/cmd_eval.c" 3 4
  if (
# 227 "project/radare2/libr/core/cmd_eval.c"
  files
# 227 "project/radare2/libr/core/cmd_eval.c" 3 4
  ) for (
# 227 "project/radare2/libr/core/cmd_eval.c"
...
# 227 "project/radare2/libr/core/cmd_eval.c"
    ...
    if (*fn && *fn != '.') {
     if (mode == 'p') {
      const char *nfn = iter->n? iter->n->data: 
# 230 "project/radare2/libr/core/cmd_eval.c" 3 4
                                               ((void *)0)
# 230 "project/radare2/libr/core/cmd_eval.c"
                                                   ;
      if (!core->theme) {
       free (home);
       r_list_free (files);
...
# 236 "project/radare2/libr/core/cmd_eval.c" 3 4
     fprintf(__stderrp,
# 236 "project/radare2/libr/core/cmd_eval.c"
     "%s %s %s\n", r_str_get (nfn), r_str_get (core->theme), r_str_get (fn)
# 236 "project/radare2/libr/core/cmd_eval.c" 3 4
     )


                      
# 239 "project/radare2/libr/core/cmd_eval.c"
                     ;
      if (nfn && !strcmp (nfn, core->theme)) {
       r_list_free (files);
       files = 
# 242 "project/radare2/libr/core/cmd_eval.c" 3 4
              ((void *)0)
# 242 "project/radare2/libr/core/cmd_eval.c"
                  ;
       free (core->theme);
       core->theme = strdup (fn);
       
# 245 "project/radare2/libr/core/cmd_eval.c" 3 4
      { free((void *)
# 245 "project/radare2/libr/core/cmd_eval.c"
      home
# 245 "project/radare2/libr/core/cmd_eval.c" 3 4
      ); 
# 245 "project/radare2/libr/core/cmd_eval.c"
...
# 245 "project/radare2/libr/core/cmd_eval.c"
      ...
      if (!nextpal_item (core, pj, mode, fn)) {
       r_list_free (files);
       files = 
# 251 "project/radare2/libr/core/cmd_eval.c" 3 4
              ((void *)0)
# 251 "project/radare2/libr/core/cmd_eval.c"
                  ;
       
# 252 "project/radare2/libr/core/cmd_eval.c" 3 4
      { free((void *)
# 252 "project/radare2/libr/core/cmd_eval.c"
      home
# 252 "project/radare2/libr/core/cmd_eval.c" 3 4
      ); 
# 252 "project/radare2/libr/core/cmd_eval.c"
...
# 252 "project/radare2/libr/core/cmd_eval.c"
  ...
  r_list_free (files);
  files = 
# 260 "project/radare2/libr/core/cmd_eval.c" 3 4
         ((void *)0)
# 260 "project/radare2/libr/core/cmd_eval.c"
             ;
  
# 261 "project/radare2/libr/core/cmd_eval.c" 3 4
 { free((void *)
# 261 "project/radare2/libr/core/cmd_eval.c"
 home
# 261 "project/radare2/libr/core/cmd_eval.c" 3 4
 ); 
# 261 "project/radare2/libr/core/cmd_eval.c"
...
# 261 "project/radare2/libr/core/cmd_eval.c"
 ...
 path = r_str_r2_prefix (
# 264 "project/radare2/libr/core/cmd_eval.c" 3 4
                        "share" "/" "radare2" "/" "5.5.4" "/" "cons" "/"
# 264 "project/radare2/libr/core/cmd_eval.c"
                                           );
 if (path) {
...
# 269 "project/radare2/libr/core/cmd_eval.c" 3 4
  if (
# 269 "project/radare2/libr/core/cmd_eval.c"
  files
# 269 "project/radare2/libr/core/cmd_eval.c" 3 4
  ) for (
# 269 "project/radare2/libr/core/cmd_eval.c"
...
# 269 "project/radare2/libr/core/cmd_eval.c"
    ...
    if (*fn && *fn != '.') {
     if (mode == 'p') {
      const char *nfn = iter->n? iter->n->data: 
# 272 "project/radare2/libr/core/cmd_eval.c" 3 4
                                               ((void *)0)
# 272 "project/radare2/libr/core/cmd_eval.c"
                                                   ;
      if (!core->theme) {
       free (home);
       r_list_free (files);
...
# 278 "project/radare2/libr/core/cmd_eval.c" 3 4
     fprintf(__stderrp,
# 278 "project/radare2/libr/core/cmd_eval.c"
     "%s %s %s\n", r_str_get (nfn), r_str_get (core->theme), r_str_get (fn)
# 278 "project/radare2/libr/core/cmd_eval.c" 3 4
     )
...
# 281 "project/radare2/libr/core/cmd_eval.c"
                     ;
      if (nfn && !strcmp (nfn, core->theme)) {
       free (core->theme);
       core->theme = strdup (fn);
...
# 300 "project/radare2/libr/core/cmd_eval.c" 3 4
 { free((void *)
# 300 "project/radare2/libr/core/cmd_eval.c"
 core->theme
# 300 "project/radare2/libr/core/cmd_eval.c" 3 4
 ); 
# 300 "project/radare2/libr/core/cmd_eval.c"
...
# 300 "project/radare2/libr/core/cmd_eval.c"
 ...
 if (mode == 'l' && !core->theme && !
# 304 "project/radare2/libr/core/cmd_eval.c" 3 4
                                    (!(
# 304 "project/radare2/libr/core/cmd_eval.c"
                                    files
# 304 "project/radare2/libr/core/cmd_eval.c" 3 4
                                    ) || !(
# 304 "project/radare2/libr/core/cmd_eval.c"
...
# 304 "project/radare2/libr/core/cmd_eval.c"
 ...
 r_list_free (files);
 files = 
# 312 "project/radare2/libr/core/cmd_eval.c" 3 4
        ((void *)0)
# 312 "project/radare2/libr/core/cmd_eval.c"
            ;
 if (mode == 'j') {
  pj_end (pj);
...
# 320 "project/radare2/libr/core/cmd_eval.c" 3 4
__attribute__((visibility("default"))) 
# 320 "project/radare2/libr/core/cmd_eval.c"
     void r_core_echo(RCore *core, const char *input) {
 if (!strncmp (input, "64 ", 3)) {
  char *buf = strdup (input);
  r_base64_decode ((
# 323 "project/radare2/libr/core/cmd_eval.c" 3 4
                   unsigned char
# 323 "project/radare2/libr/core/cmd_eval.c"
                      *)buf, input + 3, -1);
  if (*buf) {
   r_cons_echo (buf);
  }
...
# 341 "project/radare2/libr/core/cmd_eval.c" 3 4
                              ((void *)0)
# 341 "project/radare2/libr/core/cmd_eval.c"
                                  , 0);
  break;
 case '?':
 default:
...
# 363 "project/radare2/libr/core/cmd_eval.c" 3 4
  fprintf(__stderrp,
# 363 "project/radare2/libr/core/cmd_eval.c"
...
# 363 "project/radare2/libr/core/cmd_eval.c"
 ...
 case 'n':
  ...
  return 
# 401 "project/radare2/libr/core/cmd_eval.c" 3 4
        1
# 401 "project/radare2/libr/core/cmd_eval.c"
            ;
 case 'x':
 ...
 case 'j':
  r_config_list (core->config, 
# 406 "project/radare2/libr/core/cmd_eval.c" 3 4
                              ((void *)0)
# 406 "project/radare2/libr/core/cmd_eval.c"
                                  , 'j');
  break;
 case 'v':
 ...
 case 'q':
  r_config_list (core->config, 
# 412 "project/radare2/libr/core/cmd_eval.c" 3 4
                              ((void *)0)
# 412 "project/radare2/libr/core/cmd_eval.c"
                                  , 'q');
  break;
 case 'c':
  switch (input[1]) {
  ...
  case 'o':
   if (input[2] == 'j') {
    ...
    r_core_editor (core, core->themepath, 
# 428 "project/radare2/libr/core/cmd_eval.c" 3 4
                                         ((void *)0)
# 428 "project/radare2/libr/core/cmd_eval.c"
                                             );
...
# 442 "project/radare2/libr/core/cmd_eval.c" 3 4
   if (
# 442 "project/radare2/libr/core/cmd_eval.c"
   themes_list
# 442 "project/radare2/libr/core/cmd_eval.c" 3 4
   ) for (
# 442 "project/radare2/libr/core/cmd_eval.c"
...
# 442 "project/radare2/libr/core/cmd_eval.c"
  ...
  case '*': r_cons_pal_list (1, 
# 455 "project/radare2/libr/core/cmd_eval.c" 3 4
                               ((void *)0)
# 455 "project/radare2/libr/core/cmd_eval.c"
                                   ); break;
  case 'h':
   if (input[2] == 'o') {
    ...
    r_cons_pal_list ('h', 
# 460 "project/radare2/libr/core/cmd_eval.c" 3 4
                         ((void *)0)
# 460 "project/radare2/libr/core/cmd_eval.c"
                             );
   }
   break;
  case 'j':
   r_cons_pal_list ('j', 
# 464 "project/radare2/libr/core/cmd_eval.c" 3 4
                        ((void *)0)
# 464 "project/radare2/libr/core/cmd_eval.c"
                            );
   break;
  case 'c':
  ...
  case '\0':
   r_cons_pal_list (0, 
# 470 "project/radare2/libr/core/cmd_eval.c" 3 4
                      ((void *)0)
# 470 "project/radare2/libr/core/cmd_eval.c"
                          );
   break;
  case 'r':
   r_cons_pal_random ();
  ...
  case 'H': {
   char *color_code = 
# 482 "project/radare2/libr/core/cmd_eval.c" 3 4
                     ((void *)0)
# 482 "project/radare2/libr/core/cmd_eval.c"
                         ;
   char *word = 
# 483 "project/radare2/libr/core/cmd_eval.c" 3 4
               ((void *)0)
# 483 "project/radare2/libr/core/cmd_eval.c"
                   ;
   int argc = 0;
...
# 497 "project/radare2/libr/core/cmd_eval.c" 3 4
    ((void *)0)
    
# 498 "project/radare2/libr/core/cmd_eval.c"
   };
    r_core_cmd_help (core, helpmsg);
    }
    r_str_argv_free (argv);
    return 
# 502 "project/radare2/libr/core/cmd_eval.c" 3 4
          0
# 502 "project/radare2/libr/core/cmd_eval.c"
               ;
   case '-':
    if (input[3] == '*') {
     r_meta_del (core->anal, R_META_TYPE_HIGHLIGHT, 0, 
# 505 "project/radare2/libr/core/cmd_eval.c" 3 4
                                                      0xFFFFFFFFFFFFFFFFULL
# 505 "project/radare2/libr/core/cmd_eval.c"
                                                              );
    } else {
    ...
    r_str_argv_free (argv);
    return 
# 511 "project/radare2/libr/core/cmd_eval.c" 3 4
          0
# 511 "project/radare2/libr/core/cmd_eval.c"
               ;
   case '.':
    r_meta_print_list_in_function (core->anal, R_META_TYPE_HIGHLIGHT, 0, core->offset, 
# 513 "project/radare2/libr/core/cmd_eval.c" 3 4
                                                                                      ((void *)0)
# 513 "project/radare2/libr/core/cmd_eval.c"
                                                                                          );
    r_str_argv_free (argv);
    return 
# 515 "project/radare2/libr/core/cmd_eval.c" 3 4
          0
# 515 "project/radare2/libr/core/cmd_eval.c"
               ;
   case '\0':
    r_meta_print_list_all (core->anal, R_META_TYPE_HIGHLIGHT, 0, 
# 517 "project/radare2/libr/core/cmd_eval.c" 3 4
                                                                ((void *)0)
# 517 "project/radare2/libr/core/cmd_eval.c"
                                                                    );
    r_str_argv_free (argv);
    return 
# 519 "project/radare2/libr/core/cmd_eval.c" 3 4
          0
# 519 "project/radare2/libr/core/cmd_eval.c"
               ;
   case 'j':
    r_meta_print_list_all (core->anal, R_META_TYPE_HIGHLIGHT, 'j', 
# 521 "project/radare2/libr/core/cmd_eval.c" 3 4
                                                                  ((void *)0)
# 521 "project/radare2/libr/core/cmd_eval.c"
                                                                      );
    r_str_argv_free (argv);
    return 
# 523 "project/radare2/libr/core/cmd_eval.c" 3 4
          0
# 523 "project/radare2/libr/core/cmd_eval.c"
               ;
   case '*':
    r_meta_print_list_all (core->anal, R_META_TYPE_HIGHLIGHT, '*', 
# 525 "project/radare2/libr/core/cmd_eval.c" 3 4
                                                                  ((void *)0)
# 525 "project/radare2/libr/core/cmd_eval.c"
                                                                      );
    r_str_argv_free (argv);
    return 
# 527 "project/radare2/libr/core/cmd_eval.c" 3 4
          0
# 527 "project/radare2/libr/core/cmd_eval.c"
               ;
   case ' ':
   case 'i':
    if (argc) {
...
# 532 "project/radare2/libr/core/cmd_eval.c" 3 4
                                        ((void *)0)
# 532 "project/radare2/libr/core/cmd_eval.c"
                                            );
     
# 533 "project/radare2/libr/core/cmd_eval.c" 3 4
    { free((void *)
# 533 "project/radare2/libr/core/cmd_eval.c"
    dup
# 533 "project/radare2/libr/core/cmd_eval.c" 3 4
    ); 
# 533 "project/radare2/libr/core/cmd_eval.c"
...
# 535 "project/radare2/libr/core/cmd_eval.c" 3 4
     fprintf(__stderrp,
# 535 "project/radare2/libr/core/cmd_eval.c"
     "Unknown color %s\n", argv[0]
# 535 "project/radare2/libr/core/cmd_eval.c" 3 4
     )
# 535 "project/radare2/libr/core/cmd_eval.c"
      ...
      r_str_argv_free (argv);
      return 
# 537 "project/radare2/libr/core/cmd_eval.c" 3 4
            1
# 537 "project/radare2/libr/core/cmd_eval.c"
                ;
     }
    }
    break;
...
# 543 "project/radare2/libr/core/cmd_eval.c" 3 4
    fprintf(__stderrp,
# 543 "project/radare2/libr/core/cmd_eval.c"
    "Usage: ecHw word [color]\n"
# 543 "project/radare2/libr/core/cmd_eval.c" 3 4
    )
# 543 "project/radare2/libr/core/cmd_eval.c"
                                          ;
     r_str_argv_free (argv);
     return 
# 545 "project/radare2/libr/core/cmd_eval.c" 3 4
           1
# 545 "project/radare2/libr/core/cmd_eval.c"
               ;
    }
    word = strdup (argv[0]);
    if (argc > 1) {
     ...
     color_code = r_cons_pal_parse (dup, 
# 550 "project/radare2/libr/core/cmd_eval.c" 3 4
                                        ((void *)0)
# 550 "project/radare2/libr/core/cmd_eval.c"
                                            );
     
# 551 "project/radare2/libr/core/cmd_eval.c" 3 4
    { free((void *)
# 551 "project/radare2/libr/core/cmd_eval.c"
    dup
# 551 "project/radare2/libr/core/cmd_eval.c" 3 4
    ); 
# 551 "project/radare2/libr/core/cmd_eval.c"
...
# 553 "project/radare2/libr/core/cmd_eval.c" 3 4
     fprintf(__stderrp,
# 553 "project/radare2/libr/core/cmd_eval.c"
     "Unknown color %s\n", argv[1]
# 553 "project/radare2/libr/core/cmd_eval.c" 3 4
     )
# 553 "project/radare2/libr/core/cmd_eval.c"
      ...
      free (word);
      return 
# 556 "project/radare2/libr/core/cmd_eval.c" 3 4
            1
# 556 "project/radare2/libr/core/cmd_eval.c"
                ;
     }
    }
    break;
...
# 561 "project/radare2/libr/core/cmd_eval.c" 3 4
   fprintf(__stderrp,
# 561 "project/radare2/libr/core/cmd_eval.c"
   "See ecH?\n"
# 561 "project/radare2/libr/core/cmd_eval.c" 3 4
   )
# 561 "project/radare2/libr/core/cmd_eval.c"
    ...
    r_str_argv_free (argv);
    return 
# 563 "project/radare2/libr/core/cmd_eval.c" 3 4
          1
# 563 "project/radare2/libr/core/cmd_eval.c"
              ;
   }
...
# 571 "project/radare2/libr/core/cmd_eval.c" 3 4
  { free((void *)
# 571 "project/radare2/libr/core/cmd_eval.c"
  word
# 571 "project/radare2/libr/core/cmd_eval.c" 3 4
  ); 
# 571 "project/radare2/libr/core/cmd_eval.c"
...
# 572 "project/radare2/libr/core/cmd_eval.c" 3 4
  { free((void *)
# 572 "project/radare2/libr/core/cmd_eval.c"
  dup
# 572 "project/radare2/libr/core/cmd_eval.c" 3 4
  ); 
# 572 "project/radare2/libr/core/cmd_eval.c"
...
# 591 "project/radare2/libr/core/cmd_eval.c" 3 4
     fprintf(__stderrp,
# 591 "project/radare2/libr/core/cmd_eval.c"
     "(%s)(%sCOLOR"
# 591 "project/radare2/libr/core/cmd_eval.c" 3 4
     "\x1b[0m"
# 591 "project/radare2/libr/core/cmd_eval.c"
...
# 599 "project/radare2/libr/core/cmd_eval.c" 3 4
  fprintf(__stderrp,
# 599 "project/radare2/libr/core/cmd_eval.c"
...
# 600 "project/radare2/libr/core/cmd_eval.c" 3 4
  fprintf(__stderrp,
# 600 "project/radare2/libr/core/cmd_eval.c"
  "NOTE: ~ is HOME and this can be changed with %%HOME=/tmp\n"
# 600 "project/radare2/libr/core/cmd_eval.c" 3 4
  )
# 600 "project/radare2/libr/core/cmd_eval.c"
                                                                        ;
   
# 601 "project/radare2/libr/core/cmd_eval.c" 3 4
  fprintf(__stderrp,
# 601 "project/radare2/libr/core/cmd_eval.c"
...
# 602 "project/radare2/libr/core/cmd_eval.c" 3 4
  fprintf(__stderrp,
# 602 "project/radare2/libr/core/cmd_eval.c"
  "  ed-   : rm ~/.radare2rc\n"
# 602 "project/radare2/libr/core/cmd_eval.c" 3 4
  )
# 602 "project/radare2/libr/core/cmd_eval.c"
   ...
   if (r_cons_is_interactive ()) {
    r_file_touch (file);
    char * res = r_cons_editor (file, 
# 612 "project/radare2/libr/core/cmd_eval.c" 3 4
                                     ((void *)0)
# 612 "project/radare2/libr/core/cmd_eval.c"
                                         );
    if (res) {
 ...
 case 'e':
  if (input[1] == ' ') {
   ...
   p = r_core_editor (core, 
# 630 "project/radare2/libr/core/cmd_eval.c" 3 4
                           ((void *)0)
# 630 "project/radare2/libr/core/cmd_eval.c"
                               , val);
   if (p) {
...
# 636 "project/radare2/libr/core/cmd_eval.c" 3 4
  fprintf(__stderrp,
# 636 "project/radare2/libr/core/cmd_eval.c"
  "Usage: ee varname # use $EDITOR to edit this config value\n"
# 636 "project/radare2/libr/core/cmd_eval.c" 3 4
  )
# 636 "project/radare2/libr/core/cmd_eval.c"
                                                                         ;
...
# 642 "project/radare2/libr/core/cmd_eval.c" 3 4
  fprintf(__stderrp,
# 642 "project/radare2/libr/core/cmd_eval.c"
  "r_config: '%s' is not a boolean variable.\n", input
# 642 "project/radare2/libr/core/cmd_eval.c" 3 4
  )
# 642 "project/radare2/libr/core/cmd_eval.c"
                                                                ;
  ...
  break;
 case 's':
  r_config_list (core->config, (input[1])? input + 1: 
# 646 "project/radare2/libr/core/cmd_eval.c" 3 4
                                                     ((void *)0)
# 646 "project/radare2/libr/core/cmd_eval.c"
                                                         , 's');
  break;
 case '-':
 ...
 case '*':
  r_config_list (core->config, 
# 653 "project/radare2/libr/core/cmd_eval.c" 3 4
                              ((void *)0)
# 653 "project/radare2/libr/core/cmd_eval.c"
                                  , 1);
  break;
 case 'r':
  if (input[1]) {
...
# 659 "project/radare2/libr/core/cmd_eval.c" 3 4
   fprintf(__stderrp,
# 659 "project/radare2/libr/core/cmd_eval.c"
   "cannot find key '%s'\n", key
# 659 "project/radare2/libr/core/cmd_eval.c" 3 4
   )
# 659 "project/radare2/libr/core/cmd_eval.c"
...
# 662 "project/radare2/libr/core/cmd_eval.c" 3 4
  fprintf(__stderrp,
# 662 "project/radare2/libr/core/cmd_eval.c"
  "Usage: er [key]  # make an eval key PERMANENTLY read only\n"
# 662 "project/radare2/libr/core/cmd_eval.c" 3 4
  )
# 662 "project/radare2/libr/core/cmd_eval.c"
                                                                         ;
...
# 666 "project/radare2/libr/core/cmd_eval.c" 3 4
                                         1
# 666 "project/radare2/libr/core/cmd_eval.c"
                                             );
  break;
 case '.':
 case ' ':
  if (r_str_endswith (input, ".")) {
   ...
   r_config_eval (core->config, input + 1, 
# 674 "project/radare2/libr/core/cmd_eval.c" 3 4
                                          0
# 674 "project/radare2/libr/core/cmd_eval.c"
                                               );
  }
  break;
 }
