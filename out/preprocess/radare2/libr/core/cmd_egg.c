# 0 "project/radare2/libr/core/cmd_egg.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/cmd_egg.c"
...
# 4 "project/radare2/libr/core/cmd_egg.c" 2
...
# 5 "project/radare2/libr/core/cmd_egg.c" 2



# 7 "project/radare2/libr/core/cmd_egg.c"
...
# 23 "project/radare2/libr/core/cmd_egg.c" 3 4
((void *)0)

# 24 "project/radare2/libr/core/cmd_egg.c"
};
...
static void showBuffer(RBuffer *b) {
 ...
 if (b && r_buf_size (b) > 0) {
  r_buf_seek (b, 0, 
# 44 "project/radare2/libr/core/cmd_egg.c" 3 4
                   0
# 44 "project/radare2/libr/core/cmd_egg.c"
                            );
...
# 83 "project/radare2/libr/core/cmd_egg.c"
static int cmd_egg_compile(REgg *egg) {
 RBuffer *b;
 int ret = 
# 85 "project/radare2/libr/core/cmd_egg.c" 3 4
          0
# 85 "project/radare2/libr/core/cmd_egg.c"
               ;
 char *p = r_egg_option_get (egg, "egg.shellcode");
 if (p && *p) {
  if (!r_egg_shellcode (egg, p)) {
   
# 89 "project/radare2/libr/core/cmd_egg.c" 3 4
  fprintf(__stderrp,
# 89 "project/radare2/libr/core/cmd_egg.c"
  "Unknown shellcode '%s'\n", p
# 89 "project/radare2/libr/core/cmd_egg.c" 3 4
  )
# 89 "project/radare2/libr/core/cmd_egg.c"
   ...
   free (p);
   return 
# 91 "project/radare2/libr/core/cmd_egg.c" 3 4
         0
# 91 "project/radare2/libr/core/cmd_egg.c"
              ;
  }
  free (p);
 } else {
  
# 95 "project/radare2/libr/core/cmd_egg.c" 3 4
 fprintf(__stderrp,
# 95 "project/radare2/libr/core/cmd_egg.c"
...
# 95 "project/radare2/libr/core/cmd_egg.c"
  ...
  free (p);
  return 
# 97 "project/radare2/libr/core/cmd_egg.c" 3 4
        0
# 97 "project/radare2/libr/core/cmd_egg.c"
             ;
 }
...
# 102 "project/radare2/libr/core/cmd_egg.c" 3 4
 fprintf(__stderrp,
# 102 "project/radare2/libr/core/cmd_egg.c"
...
# 102 "project/radare2/libr/core/cmd_egg.c"
                                               ;
  return 
# 103 "project/radare2/libr/core/cmd_egg.c" 3 4
        0
# 103 "project/radare2/libr/core/cmd_egg.c"
             ;
 }
 ...
 if ((b = r_egg_get_bin (egg))) {
  showBuffer (b);
  ret = 
# 117 "project/radare2/libr/core/cmd_egg.c" 3 4
       1
# 117 "project/radare2/libr/core/cmd_egg.c"
           ;
 }
...
static int cmd_egg(void *data, const char *input) {
 ...
 case 's':
  ...
  if (input[1] == ' ') {
   RBuffer *buf = 
# 142 "project/radare2/libr/core/cmd_egg.c" 3 4
                 ((void *)0)
# 142 "project/radare2/libr/core/cmd_egg.c"
                     ;
   const char *ooaa = input + 2;
   while (
# 144 "project/radare2/libr/core/cmd_egg.c" 3 4
         ((
# 144 "project/radare2/libr/core/cmd_egg.c"
         *ooaa
# 144 "project/radare2/libr/core/cmd_egg.c" 3 4
         ) == ' ' || (
# 144 "project/radare2/libr/core/cmd_egg.c"
...
# 159 "project/radare2/libr/core/cmd_egg.c" 3 4
  fprintf(__stderrp,
# 159 "project/radare2/libr/core/cmd_egg.c"
  "Usage: gs [syscallname] [parameters]\n"
# 159 "project/radare2/libr/core/cmd_egg.c" 3 4
  )
# 159 "project/radare2/libr/core/cmd_egg.c"
                                                    ;
...
# 166 "project/radare2/libr/core/cmd_egg.c" 3 4
   fprintf(__stderrp,
# 166 "project/radare2/libr/core/cmd_egg.c"
   "Cannot compile '%s'\n", input + 2
# 166 "project/radare2/libr/core/cmd_egg.c" 3 4
   )
# 166 "project/radare2/libr/core/cmd_egg.c"
...
# 169 "project/radare2/libr/core/cmd_egg.c" 3 4
  fprintf(__stderrp,
# 169 "project/radare2/libr/core/cmd_egg.c"
  "wat\n"
# 169 "project/radare2/libr/core/cmd_egg.c" 3 4
  )
# 169 "project/radare2/libr/core/cmd_egg.c"
...
# 174 "project/radare2/libr/core/cmd_egg.c" 3 4
  fprintf(__stderrp,
# 174 "project/radare2/libr/core/cmd_egg.c"
  "Cannot compile\n"
# 174 "project/radare2/libr/core/cmd_egg.c" 3 4
  )
# 174 "project/radare2/libr/core/cmd_egg.c"
...
# 183 "project/radare2/libr/core/cmd_egg.c" 3 4
  fprintf(__stderrp,
# 183 "project/radare2/libr/core/cmd_egg.c"
  "Usage: gp [padding]\n"
# 183 "project/radare2/libr/core/cmd_egg.c" 3 4
  )
# 183 "project/radare2/libr/core/cmd_egg.c"
 ...
 case 'e':
  if (input[1] == ' ') {
   ...
   while (
# 189 "project/radare2/libr/core/cmd_egg.c" 3 4
         ((
# 189 "project/radare2/libr/core/cmd_egg.c"
         *encoder
# 189 "project/radare2/libr/core/cmd_egg.c" 3 4
         ) == ' ' || (
# 189 "project/radare2/libr/core/cmd_egg.c"
...
# 201 "project/radare2/libr/core/cmd_egg.c" 3 4
   fprintf(__stderrp,
# 201 "project/radare2/libr/core/cmd_egg.c"
   "Usage: ge [encoder] [key]\n"
# 201 "project/radare2/libr/core/cmd_egg.c" 3 4
   )
# 201 "project/radare2/libr/core/cmd_egg.c"
                                          ;
...
# 205 "project/radare2/libr/core/cmd_egg.c" 3 4
  fprintf(__stderrp,
# 205 "project/radare2/libr/core/cmd_egg.c"
  "Usage: ge [encoder] [key]\n"
# 205 "project/radare2/libr/core/cmd_egg.c" 3 4
  )
# 205 "project/radare2/libr/core/cmd_egg.c"
...
# 219 "project/radare2/libr/core/cmd_egg.c" 3 4
   fprintf(__stderrp,
# 219 "project/radare2/libr/core/cmd_egg.c"
   "Usage: gi [shellcode-type]\n"
# 219 "project/radare2/libr/core/cmd_egg.c" 3 4
   )
# 219 "project/radare2/libr/core/cmd_egg.c"
                                           ;
...
# 222 "project/radare2/libr/core/cmd_egg.c" 3 4
  fprintf(__stderrp,
# 222 "project/radare2/libr/core/cmd_egg.c"
  "Usage: gi [shellcode-type]\n"
# 222 "project/radare2/libr/core/cmd_egg.c" 3 4
  )
# 222 "project/radare2/libr/core/cmd_egg.c"
...
# 230 "project/radare2/libr/core/cmd_egg.c" 3 4
 if (
# 230 "project/radare2/libr/core/cmd_egg.c"
 egg->plugins
# 230 "project/radare2/libr/core/cmd_egg.c" 3 4
 ) for (
# 230 "project/radare2/libr/core/cmd_egg.c"
...
# 230 "project/radare2/libr/core/cmd_egg.c"
   ...
   r_cons_printf ("%s  %6s : %s\n",
    (p->type == 
# 232 "project/radare2/libr/core/cmd_egg.c" 3 4
               0
# 232 "project/radare2/libr/core/cmd_egg.c"
                                     )?
...
# 246 "project/radare2/libr/core/cmd_egg.c" 3 4
  ((void *)0)
  
# 247 "project/radare2/libr/core/cmd_egg.c"
 };
...
# 281 "project/radare2/libr/core/cmd_egg.c" 3 4
    r_cons_strcat (
# 281 "project/radare2/libr/core/cmd_egg.c"
    o
# 281 "project/radare2/libr/core/cmd_egg.c" 3 4
    )
# 281 "project/radare2/libr/core/cmd_egg.c"
...
# 289 "project/radare2/libr/core/cmd_egg.c" 3 4
  fprintf(__stderrp,
# 289 "project/radare2/libr/core/cmd_egg.c"
  "TODO: list options\n"
# 289 "project/radare2/libr/core/cmd_egg.c" 3 4
  )
# 289 "project/radare2/libr/core/cmd_egg.c"
...
# 292 "project/radare2/libr/core/cmd_egg.c" 3 4
  fprintf(__stderrp,
# 292 "project/radare2/libr/core/cmd_egg.c"
  "Usage: gc [k=v]\n"
# 292 "project/radare2/libr/core/cmd_egg.c" 3 4
  )
# 292 "project/radare2/libr/core/cmd_egg.c"
 ...
 return 
# 300 "project/radare2/libr/core/cmd_egg.c" 3 4
       1
# 300 "project/radare2/libr/core/cmd_egg.c"
           ;
}
