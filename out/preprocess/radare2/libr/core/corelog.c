# 0 "project/radare2/libr/core/corelog.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/corelog.c"
...
# 4 "project/radare2/libr/core/corelog.c" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/core/corelog.c"
     int r_core_log_list(RCore *core, int n, int nth, char fmt) {
 int printed = 0;
...
# 49 "project/radare2/libr/core/corelog.c" 3 4
__attribute__((visibility("default"))) 
# 49 "project/radare2/libr/core/corelog.c"
     RCoreLog *r_core_log_new(void) {
 RCoreLog *log = 
# 50 "project/radare2/libr/core/corelog.c" 3 4
                (
# 50 "project/radare2/libr/core/corelog.c"
                RCoreLog
# 50 "project/radare2/libr/core/corelog.c" 3 4
                *)calloc(1,sizeof(
# 50 "project/radare2/libr/core/corelog.c"
...
# 50 "project/radare2/libr/core/corelog.c"
 ...
 if (!log) {
  return 
# 52 "project/radare2/libr/core/corelog.c" 3 4
        ((void *)0)
# 52 "project/radare2/libr/core/corelog.c"
            ;
 }
 r_core_log_init (log);
 return log;
...
# 58 "project/radare2/libr/core/corelog.c" 3 4
__attribute__((visibility("default"))) 
# 58 "project/radare2/libr/core/corelog.c"
     void r_core_log_init(RCoreLog *log) {
 log->first = 1;
 log->last = 1;
...
# 64 "project/radare2/libr/core/corelog.c" 3 4
__attribute__((visibility("default"))) 
# 64 "project/radare2/libr/core/corelog.c"
     void r_core_log_free(RCoreLog *log) {
 r_strpool_free (log->sp);
 free (log);
}


# 69 "project/radare2/libr/core/corelog.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 69 "project/radare2/libr/core/corelog.c"
          r_core_log_run(RCore *core, const char *_buf, RCoreLogCallback runLine) {
 ...
 free (obuf);
 return 
# 88 "project/radare2/libr/core/corelog.c" 3 4
       1
# 88 "project/radare2/libr/core/corelog.c"
           ;
}


# 91 "project/radare2/libr/core/corelog.c" 3 4
__attribute__((visibility("default"))) 
# 91 "project/radare2/libr/core/corelog.c"
     char *r_core_log_get(RCore *core, int index) {
 const char *host = r_config_get (core->config, "http.sync");
 if (host && *host) {
  char *url = index > 0
   ? r_str_newf ("%s/cmd/T%%20%d", host, index)
   : r_str_newf ("%s/cmd/T", host);
  char *res = r_socket_http_get (url, 
# 97 "project/radare2/libr/core/corelog.c" 3 4
                                     ((void *)0)
# 97 "project/radare2/libr/core/corelog.c"
                                         , 
# 97 "project/radare2/libr/core/corelog.c" 3 4
                                           ((void *)0)
# 97 "project/radare2/libr/core/corelog.c"
 ...
 return 
# 101 "project/radare2/libr/core/corelog.c" 3 4
       ((void *)0)
# 101 "project/radare2/libr/core/corelog.c"
           ;
}


# 104 "project/radare2/libr/core/corelog.c" 3 4
__attribute__((visibility("default"))) 
# 104 "project/radare2/libr/core/corelog.c"
     void r_core_log_add(RCore *core, const char *msg) {
 static 
# 105 "project/radare2/libr/core/corelog.c" 3 4
       _Bool 
# 105 "project/radare2/libr/core/corelog.c"
            inProcess = 
# 105 "project/radare2/libr/core/corelog.c" 3 4
                        0
# 105 "project/radare2/libr/core/corelog.c"
 ...
 if (core->cmdlog && *core->cmdlog) {
  ...
  inProcess = 
# 113 "project/radare2/libr/core/corelog.c" 3 4
             1
# 113 "project/radare2/libr/core/corelog.c"
                 ;
  r_core_cmd0 (core, core->cmdlog);
  inProcess = 
# 115 "project/radare2/libr/core/corelog.c" 3 4
             0
# 115 "project/radare2/libr/core/corelog.c"
                  ;
 }
}


# 119 "project/radare2/libr/core/corelog.c" 3 4
__attribute__((visibility("default"))) 
# 119 "project/radare2/libr/core/corelog.c"
     void r_core_log_del(RCore *core, int n) {
 int idx;
 if (n > 0) {
