# 0 "project/radare2/libr/core/cmd_info.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/core/cmd_info.c" 2
...
# 5 "project/radare2/libr/core/cmd_info.c" 2
...
# 6 "project/radare2/libr/core/cmd_info.c" 2
...
# 8 "project/radare2/libr/core/cmd_info.c" 2
# 1 "project/radare2/libr/core/../bin/pdb/pdb_downloader.h" 1
# 11 "project/radare2/libr/core/../bin/pdb/pdb_downloader.h"
...
# 15 "project/radare2/libr/core/../bin/pdb/pdb_downloader.h" 3 4
unsigned long long 
# 15 "project/radare2/libr/core/../bin/pdb/pdb_downloader.h"
     extract;
} SPDBOptions;
...
# 24 "project/radare2/libr/core/../bin/pdb/pdb_downloader.h" 3 4
unsigned long long 
# 24 "project/radare2/libr/core/../bin/pdb/pdb_downloader.h"
     extract;
} SPDBDownloaderOpt;
...
# 48 "project/radare2/libr/core/../bin/pdb/pdb_downloader.h" 3 4
__attribute__((visibility("default"))) 
# 48 "project/radare2/libr/core/../bin/pdb/pdb_downloader.h"
     int r_bin_pdb_download(RCore *core, PJ *pj, int isradjson, SPDBOptions *options);
# 9 "project/radare2/libr/core/cmd_info.c" 2
...
# 63 "project/radare2/libr/core/cmd_info.c" 3 4
((void *)0)

# 64 "project/radare2/libr/core/cmd_info.c"
};
...
# 74 "project/radare2/libr/core/cmd_info.c" 3 4
((void *)0)

# 75 "project/radare2/libr/core/cmd_info.c"
};
...
# 85 "project/radare2/libr/core/cmd_info.c" 3 4
__builtin___memset_chk (
# 85 "project/radare2/libr/core/cmd_info.c"
ws
# 85 "project/radare2/libr/core/cmd_info.c" 3 4
, 
# 85 "project/radare2/libr/core/cmd_info.c"
...
static 
# 94 "project/radare2/libr/core/cmd_info.c" 3 4
      _Bool 
# 94 "project/radare2/libr/core/cmd_info.c"
           demangle_internal(RCore *core, const char *lang, const char *s) {
 char *res = 
# 95 "project/radare2/libr/core/cmd_info.c" 3 4
            ((void *)0)
# 95 "project/radare2/libr/core/cmd_info.c"
                ;
 ...
 case R_BIN_NM_OBJC: res = r_bin_demangle_objc (
# 100 "project/radare2/libr/core/cmd_info.c" 3 4
                                               ((void *)0)
# 100 "project/radare2/libr/core/cmd_info.c"
                                                   , s); break;
 ...
 default:
  ...
  return 
# 107 "project/radare2/libr/core/cmd_info.c" 3 4
        1
# 107 "project/radare2/libr/core/cmd_info.c"
            ;
 }
 if (res) {
  if (*res) {
  ...
  free (res);
  return 
# 114 "project/radare2/libr/core/cmd_info.c" 3 4
        0
# 114 "project/radare2/libr/core/cmd_info.c"
             ;
 }
 return 
# 116 "project/radare2/libr/core/cmd_info.c" 3 4
       1
# 116 "project/radare2/libr/core/cmd_info.c"
           ;
}

static 
# 119 "project/radare2/libr/core/cmd_info.c" 3 4
      _Bool 
# 119 "project/radare2/libr/core/cmd_info.c"
           demangle(RCore *core, const char *s) {
 
# 120 "project/radare2/libr/core/cmd_info.c" 3 4
do { if (!(
# 120 "project/radare2/libr/core/cmd_info.c"
core && s
# 120 "project/radare2/libr/core/cmd_info.c" 3 4
...
"core && s"
# 120 "project/radare2/libr/core/cmd_info.c" 3 4
, 120); return (0); } } while (0)
# 120 "project/radare2/libr/core/cmd_info.c"
                                       ;
 const char *ss = strchr (s, ' ');
 if (!*s) {
  return 
# 123 "project/radare2/libr/core/cmd_info.c" 3 4
        0
# 123 "project/radare2/libr/core/cmd_info.c"
             ;
 }
 if (!ss) {
  ...
  return 
# 128 "project/radare2/libr/core/cmd_info.c" 3 4
        1
# 128 "project/radare2/libr/core/cmd_info.c"
            ;
 }
 char *p = strdup (s);
 char *q = p + (ss - s);
 *q = 0;
 ...
 free (p);
 return 
# 135 "project/radare2/libr/core/cmd_info.c" 3 4
       1
# 135 "project/radare2/libr/core/cmd_info.c"
           ;
}
...
static void cmd_info_here(RCore *core, PJ *pj, int mode) {
 ...
 if (item && mode == 
# 141 "project/radare2/libr/core/cmd_info.c" 3 4
                    0x008
# 141 "project/radare2/libr/core/cmd_info.c"
                               ) {
  pj_o (pj);
...
# 169 "project/radare2/libr/core/cmd_info.c" 3 4
   if (
# 169 "project/radare2/libr/core/cmd_info.c"
   refs
# 169 "project/radare2/libr/core/cmd_info.c" 3 4
   ) for (
# 169 "project/radare2/libr/core/cmd_info.c"
...
# 183 "project/radare2/libr/core/cmd_info.c" 3 4
   if (
# 183 "project/radare2/libr/core/cmd_info.c"
   refs
# 183 "project/radare2/libr/core/cmd_info.c" 3 4
   ) for (
# 183 "project/radare2/libr/core/cmd_info.c"
...
static void r_core_file_info(RCore *core, PJ *pj, int mode) {
 const char *fn = 
# 198 "project/radare2/libr/core/cmd_info.c" 3 4
                 ((void *)0)
# 198 "project/radare2/libr/core/cmd_info.c"
                     ;
 
# 199 "project/radare2/libr/core/cmd_info.c" 3 4
_Bool 
# 199 "project/radare2/libr/core/cmd_info.c"
     io_cache = r_config_get_i (core->config, "io.cache");
 ...
 if (mode == 
# 205 "project/radare2/libr/core/cmd_info.c" 3 4
            0x008
# 205 "project/radare2/libr/core/cmd_info.c"
                       ) {
  pj_o (pj);
 }
 if (mode == 
# 208 "project/radare2/libr/core/cmd_info.c" 3 4
            0x001
# 208 "project/radare2/libr/core/cmd_info.c"
                         ) {
  return;
 }
 if (mode == 
# 211 "project/radare2/libr/core/cmd_info.c" 3 4
            0x004
# 211 "project/radare2/libr/core/cmd_info.c"
                         ) {
  return;
 }
 if (info) {
  fn = info->file;
  if (mode == 
# 216 "project/radare2/libr/core/cmd_info.c" 3 4
             0x008
# 216 "project/radare2/libr/core/cmd_info.c"
                        ) {
   pj_ks (pj, "type", r_str_get (info->type));
  }
 } else {
  fn = desc ? desc->name: 
# 220 "project/radare2/libr/core/cmd_info.c" 3 4
                         ((void *)0)
# 220 "project/radare2/libr/core/cmd_info.c"
                             ;
 }
 if (mode == 
# 222 "project/radare2/libr/core/cmd_info.c" 3 4
            0x008
# 222 "project/radare2/libr/core/cmd_info.c"
                       ) {
  const char *uri = fn;
  if (!uri) {
...
# 233 "project/radare2/libr/core/cmd_info.c" 3 4
  unsigned long long 
# 233 "project/radare2/libr/core/cmd_info.c"
       fsz = r_io_desc_size (desc);
   pj_ki (pj, "fd", desc->fd);
   if (fsz != 
# 235 "project/radare2/libr/core/cmd_info.c" 3 4
             0xFFFFFFFFFFFFFFFFULL
# 235 "project/radare2/libr/core/cmd_info.c"
                     ) {
    char humansz[8];
    pj_kN (pj, "size", fsz);
   ...
   pj_kb (pj, "iorw", io_cache || desc->perm & 
# 241 "project/radare2/libr/core/cmd_info.c" 3 4
                                              2
# 241 "project/radare2/libr/core/cmd_info.c"
                                                      );
   pj_ks (pj, "mode", r_str_rwx_i (desc->perm & 
# 242 "project/radare2/libr/core/cmd_info.c" 3 4
                                               (4|2|1)
# 242 "project/radare2/libr/core/cmd_info.c"
                                                         ));
   if (desc->referer && *desc->referer) {
    pj_ks (pj, "referer", desc->referer);
   }
  }
  int v = r_anal_archinfo (core->anal, 
# 247 "project/radare2/libr/core/cmd_info.c" 3 4
                                      0
# 247 "project/radare2/libr/core/cmd_info.c"
                                                                 );
  if (v > 0) {
   pj_ki (pj, "minopsz", v);
  }
  v = r_anal_archinfo (core->anal, 
# 251 "project/radare2/libr/core/cmd_info.c" 3 4
                                  1
# 251 "project/radare2/libr/core/cmd_info.c"
                                                             );
  if (v > 0) {
   pj_ki (pj, "maxopsz", v);
  }
  v = r_anal_archinfo (core->anal, 
# 255 "project/radare2/libr/core/cmd_info.c" 3 4
                                  2
# 255 "project/radare2/libr/core/cmd_info.c"
                                                             );
  if (v > 0) {
   pj_ki (pj, "invopsz", v);
  }
  v = r_anal_archinfo (core->anal, 
# 259 "project/radare2/libr/core/cmd_info.c" 3 4
                                  4
# 259 "project/radare2/libr/core/cmd_info.c"
                                                       );
  if (v > 0) {
   pj_ki (pj, "pcalign", v);
  }
...
# 273 "project/radare2/libr/core/cmd_info.c" 3 4
                           0x004
# 273 "project/radare2/libr/core/cmd_info.c"
                                        ) {
  if (desc) {
   pair ("fd", sdb_fmt ("%d", desc->fd));
  }
  if (fn || (desc && desc->uri)) {
   char *escaped = r_str_escape_utf8_keep_printable (fn? fn: desc->uri, 
# 278 "project/radare2/libr/core/cmd_info.c" 3 4
                                                                       0
# 278 "project/radare2/libr/core/cmd_info.c"
                                                                            , 
# 278 "project/radare2/libr/core/cmd_info.c" 3 4
                                                                              0
# 278 "project/radare2/libr/core/cmd_info.c"
...
# 285 "project/radare2/libr/core/cmd_info.c" 3 4
  unsigned long long 
# 285 "project/radare2/libr/core/cmd_info.c"
       fsz = r_io_desc_size (desc);
   if (fsz != 
# 286 "project/radare2/libr/core/cmd_info.c" 3 4
             0xFFFFFFFFFFFFFFFFULL
# 286 "project/radare2/libr/core/cmd_info.c"
                     ) {
    char humansz[8];
  ...
  int v = r_anal_archinfo (core->anal, 
# 293 "project/radare2/libr/core/cmd_info.c" 3 4
                                      0
# 293 "project/radare2/libr/core/cmd_info.c"
                                                                 );
  if (v > 0) {
   pair ("minopsz", sdb_fmt ("%d", v));
  }
  v = r_anal_archinfo (core->anal, 
# 297 "project/radare2/libr/core/cmd_info.c" 3 4
                                  1
# 297 "project/radare2/libr/core/cmd_info.c"
                                                             );
  if (v > 0) {
   pair ("maxopsz", sdb_fmt ("%d", v));
  }
  v = r_anal_archinfo (core->anal, 
# 301 "project/radare2/libr/core/cmd_info.c" 3 4
                                  2
# 301 "project/radare2/libr/core/cmd_info.c"
                                                             );
  if (v > 0) {
   pair ("invopsz", sdb_fmt ("%d", v));
  }
  v = r_anal_archinfo (core->anal, 
# 305 "project/radare2/libr/core/cmd_info.c" 3 4
                                  4
# 305 "project/radare2/libr/core/cmd_info.c"
                                                       );
  if (v > 0) {
   pair ("pcalign", sdb_fmt ("%d", v));
  }
  if (desc) {
   pair ("mode", r_str_rwx_i (desc->perm & 
# 310 "project/radare2/libr/core/cmd_info.c" 3 4
                                          (4|2|1)
# 310 "project/radare2/libr/core/cmd_info.c"
                                                    ));
  }
  if (plugin) {
  ...
  if (desc) {
   pair ("iorw", r_str_bool (io_cache || desc->perm & 
# 316 "project/radare2/libr/core/cmd_info.c" 3 4
                                                     2
# 316 "project/radare2/libr/core/cmd_info.c"
                                                             ));
  }
...
static int bin_is_executable(RBinObject *obj){
 ...
 if (obj) {
  if (obj->info && obj->info->arch) {
   return 
# 338 "project/radare2/libr/core/cmd_info.c" 3 4
         1
# 338 "project/radare2/libr/core/cmd_info.c"
             ;
  }
  
# 340 "project/radare2/libr/core/cmd_info.c" 3 4
 if (
# 340 "project/radare2/libr/core/cmd_info.c"
 obj->sections
# 340 "project/radare2/libr/core/cmd_info.c" 3 4
 ) for (
# 340 "project/radare2/libr/core/cmd_info.c"
...
# 340 "project/radare2/libr/core/cmd_info.c"
                                        {
   if (sec->perm & 
# 341 "project/radare2/libr/core/cmd_info.c" 3 4
                  1
# 341 "project/radare2/libr/core/cmd_info.c"
                          ) {
    return 
# 342 "project/radare2/libr/core/cmd_info.c" 3 4
          1
# 342 "project/radare2/libr/core/cmd_info.c"
              ;
   }
  }
 }
 return 
# 346 "project/radare2/libr/core/cmd_info.c" 3 4
       0
# 346 "project/radare2/libr/core/cmd_info.c"
            ;
}
...
static void cmd_info_bin(RCore *core, int va, PJ *pj, int mode) {
 ...
 if (core->io->desc) {
  if (mode & 
# 353 "project/radare2/libr/core/cmd_info.c" 3 4
            0x008
# 353 "project/radare2/libr/core/cmd_info.c"
                       ) {
   if (!(mode & 
# 354 "project/radare2/libr/core/cmd_info.c" 3 4
               0x010
# 354 "project/radare2/libr/core/cmd_info.c"
                           )) {
    pj_o (pj);
   } else {
    array = 1;
   ...
   mode = 
# 359 "project/radare2/libr/core/cmd_info.c" 3 4
         0x008
# 359 "project/radare2/libr/core/cmd_info.c"
                    ;
   pj_k (pj, "core");
  }
  ...
  if (bin_is_executable (obj)) {
   if ((mode & 
# 364 "project/radare2/libr/core/cmd_info.c" 3 4
              0x008
# 364 "project/radare2/libr/core/cmd_info.c"
                         )) {
    pj_k (pj, "bin");
   }
   r_core_bin_info (core, 
# 367 "project/radare2/libr/core/cmd_info.c" 3 4
                         0x002
# 367 "project/radare2/libr/core/cmd_info.c"
                                            , pj, mode, va, 
# 367 "project/radare2/libr/core/cmd_info.c" 3 4
                                                            ((void *)0)
# 367 "project/radare2/libr/core/cmd_info.c"
...
# 367 "project/radare2/libr/core/cmd_info.c"
  ...
  if ((mode & 
# 369 "project/radare2/libr/core/cmd_info.c" 3 4
             0x008
# 369 "project/radare2/libr/core/cmd_info.c"
                        ) && array == 0) {
   pj_end (pj);
  }
 } else {
  
# 373 "project/radare2/libr/core/cmd_info.c" 3 4
 fprintf(__stderrp,
# 373 "project/radare2/libr/core/cmd_info.c"
 "No file selected\n"
# 373 "project/radare2/libr/core/cmd_info.c" 3 4
 )
# 373 "project/radare2/libr/core/cmd_info.c"
...
static void playMsg(RCore *core, const char *n, int len) {
 if (r_config_get_b (core->config, "scr.tts")) {
  ...
  if (s) {
   r_sys_tts (s, 
# 383 "project/radare2/libr/core/cmd_info.c" 3 4
                1
# 383 "project/radare2/libr/core/cmd_info.c"
                    );
   free (s);
  }
 }
...
static 
# 389 "project/radare2/libr/core/cmd_info.c" 3 4
      _Bool 
# 389 "project/radare2/libr/core/cmd_info.c"
           is_equal_file_hashes(RList *lfile_hashes, RList *rfile_hashes, 
# 389 "project/radare2/libr/core/cmd_info.c" 3 4
                                                                          _Bool 
# 389 "project/radare2/libr/core/cmd_info.c"
                                                                               *equal) {
 
# 390 "project/radare2/libr/core/cmd_info.c" 3 4
do { if (!(
# 390 "project/radare2/libr/core/cmd_info.c"
lfile_hashes
# 390 "project/radare2/libr/core/cmd_info.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 390 "project/radare2/libr/core/cmd_info.c"
"lfile_hashes"
# 390 "project/radare2/libr/core/cmd_info.c" 3 4
, 390); return (0); } } while (0)
# 390 "project/radare2/libr/core/cmd_info.c"
                                          ;
 
# 391 "project/radare2/libr/core/cmd_info.c" 3 4
do { if (!(
# 391 "project/radare2/libr/core/cmd_info.c"
rfile_hashes
# 391 "project/radare2/libr/core/cmd_info.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 391 "project/radare2/libr/core/cmd_info.c"
"rfile_hashes"
# 391 "project/radare2/libr/core/cmd_info.c" 3 4
, 391); return (0); } } while (0)
# 391 "project/radare2/libr/core/cmd_info.c"
                                          ;
 
# 392 "project/radare2/libr/core/cmd_info.c" 3 4
do { if (!(
# 392 "project/radare2/libr/core/cmd_info.c"
equal
# 392 "project/radare2/libr/core/cmd_info.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 392 "project/radare2/libr/core/cmd_info.c"
"equal"
# 392 "project/radare2/libr/core/cmd_info.c" 3 4
, 392); return (0); } } while (0)
# 392 "project/radare2/libr/core/cmd_info.c"
                                   ;

 *equal = 
# 394 "project/radare2/libr/core/cmd_info.c" 3 4
         1
# 394 "project/radare2/libr/core/cmd_info.c"
             ;
 RBinFileHash *fh_l, *fh_r;
 RListIter *hiter_l, *hiter_r;
 
# 397 "project/radare2/libr/core/cmd_info.c" 3 4
if (
# 397 "project/radare2/libr/core/cmd_info.c"
lfile_hashes
# 397 "project/radare2/libr/core/cmd_info.c" 3 4
) for (
# 397 "project/radare2/libr/core/cmd_info.c"
...
# 398 "project/radare2/libr/core/cmd_info.c" 3 4
 if (
# 398 "project/radare2/libr/core/cmd_info.c"
 rfile_hashes
# 398 "project/radare2/libr/core/cmd_info.c" 3 4
 ) for (
# 398 "project/radare2/libr/core/cmd_info.c"
...
# 398 "project/radare2/libr/core/cmd_info.c"
    ...
    *equal = 
# 403 "project/radare2/libr/core/cmd_info.c" 3 4
            0
# 403 "project/radare2/libr/core/cmd_info.c"
                 ;
    return 
# 404 "project/radare2/libr/core/cmd_info.c" 3 4
          1
# 404 "project/radare2/libr/core/cmd_info.c"
              ;
   }
  }
 }
 return 
# 408 "project/radare2/libr/core/cmd_info.c" 3 4
       1
# 408 "project/radare2/libr/core/cmd_info.c"
           ;
}

static int __r_core_bin_reload(RCore *r, const char *file, 
# 411 "project/radare2/libr/core/cmd_info.c" 3 4
                                                          unsigned long long 
# 411 "project/radare2/libr/core/cmd_info.c"
                                                               baseaddr) {
 int result = 0;
...
# 425 "project/radare2/libr/core/cmd_info.c" 3 4
                           ((void *)0)
# 425 "project/radare2/libr/core/cmd_info.c"
                               );
 if (core->allbins) {
  RBinFile *bf;
  RListIter *iter;
  
# 429 "project/radare2/libr/core/cmd_info.c" 3 4
 if (
# 429 "project/radare2/libr/core/cmd_info.c"
 core->bin->binfiles
# 429 "project/radare2/libr/core/cmd_info.c" 3 4
 ) for (
# 429 "project/radare2/libr/core/cmd_info.c"
...
static 
# 441 "project/radare2/libr/core/cmd_info.c" 3 4
      _Bool 
# 441 "project/radare2/libr/core/cmd_info.c"
           isKnownPackage(const char *cn) {
 if (*cn == 'L') {
  if (r_str_startswith (cn, "Lkotlin")) {
   return 
# 444 "project/radare2/libr/core/cmd_info.c" 3 4
         1
# 444 "project/radare2/libr/core/cmd_info.c"
             ;
  }
  if (r_str_startswith (cn, "Lcom/google")) {
   return 
# 447 "project/radare2/libr/core/cmd_info.c" 3 4
         1
# 447 "project/radare2/libr/core/cmd_info.c"
             ;
  }
  if (r_str_startswith (cn, "Lcom/facebook")) {
   return 
# 450 "project/radare2/libr/core/cmd_info.c" 3 4
         1
# 450 "project/radare2/libr/core/cmd_info.c"
             ;
  }
  if (r_str_startswith (cn, "Lokhttp")) {
   return 
# 453 "project/radare2/libr/core/cmd_info.c" 3 4
         1
# 453 "project/radare2/libr/core/cmd_info.c"
             ;
  }
  if (r_str_startswith (cn, "Landroid")) {
   return 
# 456 "project/radare2/libr/core/cmd_info.c" 3 4
         1
# 456 "project/radare2/libr/core/cmd_info.c"
             ;
  }
  if (r_str_startswith (cn, "Lokio")) {
   return 
# 459 "project/radare2/libr/core/cmd_info.c" 3 4
         1
# 459 "project/radare2/libr/core/cmd_info.c"
             ;
  }
 }
 return 
# 462 "project/radare2/libr/core/cmd_info.c" 3 4
       0
# 462 "project/radare2/libr/core/cmd_info.c"
            ;
}
...
# 467 "project/radare2/libr/core/cmd_info.c" 3 4
_Bool 
# 467 "project/radare2/libr/core/cmd_info.c"
     newline = r_cons_is_interactive ();
 int fd = r_io_fd_get_current (core->io);
 RIODesc *desc = r_io_desc_get (core->io, fd);
 int i;
 const 
# 471 "project/radare2/libr/core/cmd_info.c" 3 4
      _Bool 
# 471 "project/radare2/libr/core/cmd_info.c"
           va = core->io->va || r_config_get_b (core->config, "cfg.debug");
 int mode = 0;
 
# 473 "project/radare2/libr/core/cmd_info.c" 3 4
_Bool 
# 473 "project/radare2/libr/core/cmd_info.c"
     rdump = 
# 473 "project/radare2/libr/core/cmd_info.c" 3 4
             0
# 473 "project/radare2/libr/core/cmd_info.c"
...
# 475 "project/radare2/libr/core/cmd_info.c" 3 4
_Bool 
# 475 "project/radare2/libr/core/cmd_info.c"
     is_izzzj = 
# 475 "project/radare2/libr/core/cmd_info.c" 3 4
                0
# 475 "project/radare2/libr/core/cmd_info.c"
...
# 476 "project/radare2/libr/core/cmd_info.c" 3 4
_Bool 
# 476 "project/radare2/libr/core/cmd_info.c"
     is_idpij = 
# 476 "project/radare2/libr/core/cmd_info.c" 3 4
                0
# 476 "project/radare2/libr/core/cmd_info.c"
 ...
 Sdb *db;
 PJ *pj = 
# 478 "project/radare2/libr/core/cmd_info.c" 3 4
         ((void *)0)
# 478 "project/radare2/libr/core/cmd_info.c"
             ;
 ...
 if (i > 0) {
  switch (input[i - 1]) {
  case '*': mode = 
# 484 "project/radare2/libr/core/cmd_info.c" 3 4
                  0x001
# 484 "project/radare2/libr/core/cmd_info.c"
                               ; break;
  case 'j': mode = 
# 485 "project/radare2/libr/core/cmd_info.c" 3 4
                  0x008
# 485 "project/radare2/libr/core/cmd_info.c"
                             ; break;
  case 'q': mode = 
# 486 "project/radare2/libr/core/cmd_info.c" 3 4
                  0x004
# 486 "project/radare2/libr/core/cmd_info.c"
                               ; break;
  }
 }
 ...
 if (mode == 
# 496 "project/radare2/libr/core/cmd_info.c" 3 4
            0x008
# 496 "project/radare2/libr/core/cmd_info.c"
                       ) {
  if (!pj) { pj = r_core_pj_new (core); if (!pj) { return 1; } };
  int suffix_shift = 0;
  ...
  if (!strncmp (input, "zzz", 3)) {
   is_izzzj = 
# 507 "project/radare2/libr/core/cmd_info.c" 3 4
             1
# 507 "project/radare2/libr/core/cmd_info.c"
                 ;
  }
  if (!strncmp (input, "dpi", 3)) {
   is_idpij = 
# 510 "project/radare2/libr/core/cmd_info.c" 3 4
             1
# 510 "project/radare2/libr/core/cmd_info.c"
                 ;
  }
 }
...
# 539 "project/radare2/libr/core/cmd_info.c" 3 4
{ free((void *)
# 539 "project/radare2/libr/core/cmd_info.c"
core->table_query
# 539 "project/radare2/libr/core/cmd_info.c" 3 4
); 
# 539 "project/radare2/libr/core/cmd_info.c"
...
# 550 "project/radare2/libr/core/cmd_info.c" 3 4
  unsigned long long 
# 550 "project/radare2/libr/core/cmd_info.c"
   ...
   __r_core_bin_reload (core, 
# 558 "project/radare2/libr/core/cmd_info.c" 3 4
                             ((void *)0)
# 558 "project/radare2/libr/core/cmd_info.c"
                                 , baddr);
   r_core_block_read (core);
   newline = 
# 560 "project/radare2/libr/core/cmd_info.c" 3 4
            0
# 560 "project/radare2/libr/core/cmd_info.c"
                 ;
  }
  break;
  case 'k':
  {
   ...
   db = o? o->kv: 
# 566 "project/radare2/libr/core/cmd_info.c" 3 4
                 ((void *)0)
# 566 "project/radare2/libr/core/cmd_info.c"
                     ;

   switch (input[1]) {
   case 'v':
    if (db) {
     char *o = sdb_querys (db, 
# 571 "project/radare2/libr/core/cmd_info.c" 3 4
                              ((void *)0)
# 571 "project/radare2/libr/core/cmd_info.c"
                                  , 0, input + 3);
     if (o && *o) {
      
# 573 "project/radare2/libr/core/cmd_info.c" 3 4
     r_cons_strcat (
# 573 "project/radare2/libr/core/cmd_info.c"
     o
# 573 "project/radare2/libr/core/cmd_info.c" 3 4
     )
# 573 "project/radare2/libr/core/cmd_info.c"
    ...
    break;
   case '*':
    r_core_bin_export_info (core, 
# 579 "project/radare2/libr/core/cmd_info.c" 3 4
                                 0x001
# 579 "project/radare2/libr/core/cmd_info.c"
                                              );
    break;
   case '.':
   case ' ':
    if (db) {
     char *o = sdb_querys (db, 
# 584 "project/radare2/libr/core/cmd_info.c" 3 4
                              ((void *)0)
# 584 "project/radare2/libr/core/cmd_info.c"
                                  , 0, input + 2);
     if (o && *o) {
      
# 586 "project/radare2/libr/core/cmd_info.c" 3 4
     r_cons_strcat (
# 586 "project/radare2/libr/core/cmd_info.c"
     o
# 586 "project/radare2/libr/core/cmd_info.c" 3 4
     )
# 586 "project/radare2/libr/core/cmd_info.c"
   ...
   case '\0':
    if (db) {
     char *o = sdb_querys (db, 
# 593 "project/radare2/libr/core/cmd_info.c" 3 4
                              ((void *)0)
# 593 "project/radare2/libr/core/cmd_info.c"
                                  , 0, "*");
     if (o && *o) {
      
# 595 "project/radare2/libr/core/cmd_info.c" 3 4
     r_cons_strcat (
# 595 "project/radare2/libr/core/cmd_info.c"
     o
# 595 "project/radare2/libr/core/cmd_info.c" 3 4
     )
# 595 "project/radare2/libr/core/cmd_info.c"
...
# 602 "project/radare2/libr/core/cmd_info.c" 3 4
   fprintf(__stderrp,
# 602 "project/radare2/libr/core/cmd_info.c"
   "Usage: ik [sdb-query]\n"
# 602 "project/radare2/libr/core/cmd_info.c" 3 4
   )
# 602 "project/radare2/libr/core/cmd_info.c"
...
# 603 "project/radare2/libr/core/cmd_info.c" 3 4
   fprintf(__stderrp,
# 603 "project/radare2/libr/core/cmd_info.c"
   "Usage: ik*    # load all header information\n"
# 603 "project/radare2/libr/core/cmd_info.c" 3 4
   )
# 603 "project/radare2/libr/core/cmd_info.c"
                                                            ;
...
# 611 "project/radare2/libr/core/cmd_info.c" 3 4
   fprintf(__stderrp,
# 611 "project/radare2/libr/core/cmd_info.c"
   "Core file not open\n"
# 611 "project/radare2/libr/core/cmd_info.c" 3 4
   )
# 611 "project/radare2/libr/core/cmd_info.c"
...
# 615 "project/radare2/libr/core/cmd_info.c" 3 4
  unsigned long long 
# 615 "project/radare2/libr/core/cmd_info.c"
       baddr = r_config_get_i (core->config, "bin.baddr");
  ...
  case 'A':
   if (input[1] == 'j') {
    ...
    r_bin_list_archs (core->bin, 
# 631 "project/radare2/libr/core/cmd_info.c" 3 4
                                ((void *)0)
# 631 "project/radare2/libr/core/cmd_info.c"
                                    , 1);
    newline = 
# 632 "project/radare2/libr/core/cmd_info.c" 3 4
             0
# 632 "project/radare2/libr/core/cmd_info.c"
                  ;
   }
   break;
  case 'E':
  {
   if (input[1] == 'j' && input[2] == '.') {
    mode = 
# 638 "project/radare2/libr/core/cmd_info.c" 3 4
          0x008
# 638 "project/radare2/libr/core/cmd_info.c"
                     ;
    if (!pj) { pj = r_core_pj_new (core); if (!pj) { return 1; } };
    if (is_array) { pj_k (pj, "exports"); } if (0) { playMsg (core, "exports", 0);} r_core_bin_info (core, 
# 640 "project/radare2/libr/core/cmd_info.c" 3 4
   0x8000
# 640 "project/radare2/libr/core/cmd_info.c"
   , pj, mode, va, 
# 640 "project/radare2/libr/core/cmd_info.c" 3 4
   ((void *)0)
# 640 "project/radare2/libr/core/cmd_info.c"
   , input + 2);;
    ...
    if (is_array) { pj_k (pj, "exports"); } if (0) { playMsg (core, "exports", 0);} r_core_bin_info (core, 
# 642 "project/radare2/libr/core/cmd_info.c" 3 4
   0x8000
# 642 "project/radare2/libr/core/cmd_info.c"
   , pj, mode, va, 
# 642 "project/radare2/libr/core/cmd_info.c" 3 4
   ((void *)0)
# 642 "project/radare2/libr/core/cmd_info.c"
...
# 650 "project/radare2/libr/core/cmd_info.c" 3 4
   unsigned long long 
# 650 "project/radare2/libr/core/cmd_info.c"
        limit = r_config_get_i (core->config, "bin.hashlimit");
    RBinInfo *info = r_bin_get_info (core->bin);
    if (!info) {
     
# 653 "project/radare2/libr/core/cmd_info.c" 3 4
    fprintf(__stderrp,
# 653 "project/radare2/libr/core/cmd_info.c"
    "r_bin_get_info: Cannot get bin info\n"
# 653 "project/radare2/libr/core/cmd_info.c" 3 4
    )
# 653 "project/radare2/libr/core/cmd_info.c"
                                                     ;
...
# 659 "project/radare2/libr/core/cmd_info.c" 3 4
   _Bool 
# 659 "project/radare2/libr/core/cmd_info.c"
        equal = 
# 659 "project/radare2/libr/core/cmd_info.c" 3 4
                1
# 659 "project/radare2/libr/core/cmd_info.c"
                    ;
    if (!
# 660 "project/radare2/libr/core/cmd_info.c" 3 4
        (!(
# 660 "project/radare2/libr/core/cmd_info.c"
        new_hashes
# 660 "project/radare2/libr/core/cmd_info.c" 3 4
        ) || !(
# 660 "project/radare2/libr/core/cmd_info.c"
...
# 662 "project/radare2/libr/core/cmd_info.c" 3 4
     fprintf(__stderrp,
# 662 "project/radare2/libr/core/cmd_info.c"
     "is_equal_file_hashes: Cannot compare file hashes\n"
# 662 "project/radare2/libr/core/cmd_info.c" 3 4
     )
# 662 "project/radare2/libr/core/cmd_info.c"
                                                                   ;
    ...
    const 
# 669 "project/radare2/libr/core/cmd_info.c" 3 4
         _Bool 
# 669 "project/radare2/libr/core/cmd_info.c"
              is_json = input[1] == 'j';
    if (is_json) {
     pj_o (pj);
     
# 672 "project/radare2/libr/core/cmd_info.c" 3 4
    if (
# 672 "project/radare2/libr/core/cmd_info.c"
    new_hashes
# 672 "project/radare2/libr/core/cmd_info.c" 3 4
    ) for (
# 672 "project/radare2/libr/core/cmd_info.c"
...
# 677 "project/radare2/libr/core/cmd_info.c" 3 4
     if (
# 677 "project/radare2/libr/core/cmd_info.c"
     old_hashes
# 677 "project/radare2/libr/core/cmd_info.c" 3 4
     ) for (
# 677 "project/radare2/libr/core/cmd_info.c"
...
# 686 "project/radare2/libr/core/cmd_info.c" 3 4
     fprintf(__stderrp,
# 686 "project/radare2/libr/core/cmd_info.c"
...
# 686 "project/radare2/libr/core/cmd_info.c"
                                          ;
      hiter_new = 
# 687 "project/radare2/libr/core/cmd_info.c" 3 4
                 (
# 687 "project/radare2/libr/core/cmd_info.c"
                 new_hashes
# 687 "project/radare2/libr/core/cmd_info.c" 3 4
                 )? (
# 687 "project/radare2/libr/core/cmd_info.c"
...
# 687 "project/radare2/libr/core/cmd_info.c"
                                             ;
      hiter_old = 
# 688 "project/radare2/libr/core/cmd_info.c" 3 4
                 (
# 688 "project/radare2/libr/core/cmd_info.c"
                 old_hashes
# 688 "project/radare2/libr/core/cmd_info.c" 3 4
                 )? (
# 688 "project/radare2/libr/core/cmd_info.c"
...
# 688 "project/radare2/libr/core/cmd_info.c"
                                             ;
      while (
# 689 "project/radare2/libr/core/cmd_info.c" 3 4
            ((
# 689 "project/radare2/libr/core/cmd_info.c"
            hiter_new
# 689 "project/radare2/libr/core/cmd_info.c" 3 4
            )? 1: 0) 
# 689 "project/radare2/libr/core/cmd_info.c"
...
# 689 "project/radare2/libr/core/cmd_info.c"
       ...
       fh_new = (RBinFileHash *)
# 690 "project/radare2/libr/core/cmd_info.c" 3 4
                               (
# 690 "project/radare2/libr/core/cmd_info.c"
                               hiter_new
# 690 "project/radare2/libr/core/cmd_info.c" 3 4
                               )->data; (
# 690 "project/radare2/libr/core/cmd_info.c"
...
# 690 "project/radare2/libr/core/cmd_info.c"
                                                          ;
       fh_old = (RBinFileHash *)
# 691 "project/radare2/libr/core/cmd_info.c" 3 4
                               (
# 691 "project/radare2/libr/core/cmd_info.c"
                               hiter_old
# 691 "project/radare2/libr/core/cmd_info.c" 3 4
                               )->data; (
# 691 "project/radare2/libr/core/cmd_info.c"
...
# 693 "project/radare2/libr/core/cmd_info.c" 3 4
       fprintf(__stderrp,
# 693 "project/radare2/libr/core/cmd_info.c"
       "Wrong file hashes structure"
# 693 "project/radare2/libr/core/cmd_info.c" 3 4
       )
# 693 "project/radare2/libr/core/cmd_info.c"
                                              ;
...
# 696 "project/radare2/libr/core/cmd_info.c" 3 4
       fprintf(__stderrp,
# 696 "project/radare2/libr/core/cmd_info.c"
...
# 699 "project/radare2/libr/core/cmd_info.c" 3 4
       fprintf(__stderrp,
# 699 "project/radare2/libr/core/cmd_info.c"
       "- %s %s\n+ %s %s\n", fh_old->type, fh_old->hex, fh_new->type, fh_new->hex
# 699 "project/radare2/libr/core/cmd_info.c" 3 4
       )

                                   
# 701 "project/radare2/libr/core/cmd_info.c"
                                  ;
       }
      }
     } else {
      
# 705 "project/radare2/libr/core/cmd_info.c" 3 4
     if (
# 705 "project/radare2/libr/core/cmd_info.c"
     new_hashes
# 705 "project/radare2/libr/core/cmd_info.c" 3 4
     ) for (
# 705 "project/radare2/libr/core/cmd_info.c"
...
# 705 "project/radare2/libr/core/cmd_info.c"
     ...
     newline = 
# 709 "project/radare2/libr/core/cmd_info.c" 3 4
              0
# 709 "project/radare2/libr/core/cmd_info.c"
                   ;
    }
    r_list_free (old_hashes);
   }
   break;
  case 'Z':
   if (is_array) { pj_k (pj, "size"); } if (0) { playMsg (core, "size", 0);} r_core_bin_info (core, 
# 715 "project/radare2/libr/core/cmd_info.c" 3 4
  0x1000
# 715 "project/radare2/libr/core/cmd_info.c"
  , pj, mode, va, 
# 715 "project/radare2/libr/core/cmd_info.c" 3 4
  ((void *)0)
# 715 "project/radare2/libr/core/cmd_info.c"
...
# 715 "project/radare2/libr/core/cmd_info.c"
  ...
  case 'S':
   ...
   if ((input[1] == 'm' && input[2] == 'z') || !input[1]) {
    if (is_array) { pj_k (pj, "sections"); } if (0) { playMsg (core, "sections", 0);} r_core_bin_info (core, 
# 730 "project/radare2/libr/core/cmd_info.c" 3 4
   0x080
# 730 "project/radare2/libr/core/cmd_info.c"
   , pj, mode, va, 
# 730 "project/radare2/libr/core/cmd_info.c" 3 4
   ((void *)0)
# 730 "project/radare2/libr/core/cmd_info.c"
...
# 730 "project/radare2/libr/core/cmd_info.c"
    ...
    if (is_array) { pj_k (pj, "segments"); } if (0) { playMsg (core, "segments", 0);} r_core_bin_info (core, 
# 732 "project/radare2/libr/core/cmd_info.c" 3 4
   0x400000
# 732 "project/radare2/libr/core/cmd_info.c"
   , pj, mode, va, 
# 732 "project/radare2/libr/core/cmd_info.c" 3 4
   ((void *)0)
# 732 "project/radare2/libr/core/cmd_info.c"
...
# 732 "project/radare2/libr/core/cmd_info.c"
    ...
    int action = 
# 735 "project/radare2/libr/core/cmd_info.c" 3 4
                0x080
# 735 "project/radare2/libr/core/cmd_info.c"
                                       ;
    int param_shift = 0;
    if (input[1] == 'S') {
     name = "segments";
     input++;
     action = 
# 740 "project/radare2/libr/core/cmd_info.c" 3 4
             0x400000
# 740 "project/radare2/libr/core/cmd_info.c"
                                    ;
    }

    if (input[1] == '=') {
     mode = 
# 744 "project/radare2/libr/core/cmd_info.c" 3 4
           0x080
# 744 "project/radare2/libr/core/cmd_info.c"
                       ;
    } else if (input[1] == '*') {
     mode = 
# 746 "project/radare2/libr/core/cmd_info.c" 3 4
           0x001
# 746 "project/radare2/libr/core/cmd_info.c"
                        ;
    } else if (input[1] == 'q' && input[2] == '.') {
     mode = 
# 748 "project/radare2/libr/core/cmd_info.c" 3 4
           0x004
# 748 "project/radare2/libr/core/cmd_info.c"
                        ;
    } else if (input[1] == 'j' && input[2] == '.') {
     mode = 
# 750 "project/radare2/libr/core/cmd_info.c" 3 4
           0x008
# 750 "project/radare2/libr/core/cmd_info.c"
                      ;
     if (!pj) { pj = r_core_pj_new (core); if (!pj) { return 1; } };
    }
    if (mode == 
# 753 "project/radare2/libr/core/cmd_info.c" 3 4
               0x001 
# 753 "project/radare2/libr/core/cmd_info.c"
                             || mode == 
# 753 "project/radare2/libr/core/cmd_info.c" 3 4
                                        0x008 
# 753 "project/radare2/libr/core/cmd_info.c"
...
# 763 "project/radare2/libr/core/cmd_info.c" 3 4
    if (
# 763 "project/radare2/libr/core/cmd_info.c"
    objs
# 763 "project/radare2/libr/core/cmd_info.c" 3 4
    ) for (
# 763 "project/radare2/libr/core/cmd_info.c"
...
# 763 "project/radare2/libr/core/cmd_info.c"
      ...
      RBinObject *obj = bf->o;
      core->bin->cur = bf;
      if (is_array) { pj_k (pj, name); } if ((obj && obj->sections)? r_list_length (obj->sections): 0) { playMsg (core, name, (obj && obj->sections)? r_list_length (obj->sections): 0);} r_core_bin_info (core, action, pj, mode, va, 
# 766 "project/radare2/libr/core/cmd_info.c" 3 4
     ((void *)0)
# 766 "project/radare2/libr/core/cmd_info.c"
     , input + 1 + param_shift);
                                                                 ;
     }
     core->bin->cur = cur;
  ...
  case 'H':
   if (input[1] == 'H') {
    if (is_array) { pj_k (pj, "header"); } if (-1) { playMsg (core, "header", -1);} r_core_bin_info (core, 
# 783 "project/radare2/libr/core/cmd_info.c" 3 4
   0x80000
# 783 "project/radare2/libr/core/cmd_info.c"
   , pj, mode, va, 
# 783 "project/radare2/libr/core/cmd_info.c" 3 4
   ((void *)0)
# 783 "project/radare2/libr/core/cmd_info.c"
...
# 783 "project/radare2/libr/core/cmd_info.c"
  ...
  case 'h':
   if (is_array) { pj_k (pj, "fields"); } if (0) { playMsg (core, "fields", 0);} r_core_bin_info (core, 
# 787 "project/radare2/libr/core/cmd_info.c" 3 4
  0x100
# 787 "project/radare2/libr/core/cmd_info.c"
  , pj, mode, va, 
# 787 "project/radare2/libr/core/cmd_info.c" 3 4
  ((void *)0)
# 787 "project/radare2/libr/core/cmd_info.c"
...
# 794 "project/radare2/libr/core/cmd_info.c" 3 4
  if (
# 794 "project/radare2/libr/core/cmd_info.c"
  objs
# 794 "project/radare2/libr/core/cmd_info.c" 3 4
  ) for (
# 794 "project/radare2/libr/core/cmd_info.c"
...
# 794 "project/radare2/libr/core/cmd_info.c"
    ...
    RBinObject *obj = bf->o;
    core->bin->cur = bf;
    if (is_array) { pj_k (pj, "libs"); } if ((obj && obj->libs)? r_list_length (obj->libs): 0) { playMsg (core, "libs", (obj && obj->libs)? r_list_length (obj->libs): 0);} r_core_bin_info (core, 
# 797 "project/radare2/libr/core/cmd_info.c" 3 4
   0x200
# 797 "project/radare2/libr/core/cmd_info.c"
   , pj, mode, va, 
# 797 "project/radare2/libr/core/cmd_info.c" 3 4
   ((void *)0)
# 797 "project/radare2/libr/core/cmd_info.c"
...
# 797 "project/radare2/libr/core/cmd_info.c"
  ...
  case 'L': {
   ...
   newline = 
# 816 "project/radare2/libr/core/cmd_info.c" 3 4
            0
# 816 "project/radare2/libr/core/cmd_info.c"
                 ;
   goto done;
  }
  case 's': {
   ...
   if (input[1] == 'j' && input[2] == '.') {
    mode = 
# 824 "project/radare2/libr/core/cmd_info.c" 3 4
          0x008
# 824 "project/radare2/libr/core/cmd_info.c"
                     ;
    if (!pj) { pj = r_core_pj_new (core); if (!pj) { return 1; } };
   } else if (input[1] == 'q' && input[2] == 'q') {
    mode = 
# 827 "project/radare2/libr/core/cmd_info.c" 3 4
          0x020
# 827 "project/radare2/libr/core/cmd_info.c"
                         ;
   }
   
# 829 "project/radare2/libr/core/cmd_info.c" 3 4
  if (
# 829 "project/radare2/libr/core/cmd_info.c"
  objs
# 829 "project/radare2/libr/core/cmd_info.c" 3 4
  ) for (
# 829 "project/radare2/libr/core/cmd_info.c"
...
# 829 "project/radare2/libr/core/cmd_info.c"
    ...
    if (input[1] == 'j' && input[2] == '.') {
     if (is_array) { pj_k (pj, "symbols"); } if ((obj && obj->symbols)? r_list_length (obj->symbols): 0) { playMsg (core, "symbols", (obj && obj->symbols)? r_list_length (obj->symbols): 0);} r_core_bin_info (core, 
# 837 "project/radare2/libr/core/cmd_info.c" 3 4
    0x040
# 837 "project/radare2/libr/core/cmd_info.c"
    , pj, mode, va, 
# 837 "project/radare2/libr/core/cmd_info.c" 3 4
    ((void *)0)
# 837 "project/radare2/libr/core/cmd_info.c"
...
# 839 "project/radare2/libr/core/cmd_info.c" 3 4
    { free((void *)
# 839 "project/radare2/libr/core/cmd_info.c"
    core->table_query
# 839 "project/radare2/libr/core/cmd_info.c" 3 4
    ); 
# 839 "project/radare2/libr/core/cmd_info.c"
...
# 839 "project/radare2/libr/core/cmd_info.c"
     ...
     if (is_array) { pj_k (pj, "symbols"); } if ((obj && obj->symbols)? r_list_length (obj->symbols): 0) { playMsg (core, "symbols", (obj && obj->symbols)? r_list_length (obj->symbols): 0);} r_core_bin_info (core, 
# 841 "project/radare2/libr/core/cmd_info.c" 3 4
    0x040
# 841 "project/radare2/libr/core/cmd_info.c"
    , pj, mode, va, 
# 841 "project/radare2/libr/core/cmd_info.c" 3 4
    ((void *)0)
# 841 "project/radare2/libr/core/cmd_info.c"
    , input + 1);;
     ...
     mode = 
# 843 "project/radare2/libr/core/cmd_info.c" 3 4
           0x020
# 843 "project/radare2/libr/core/cmd_info.c"
                          ;
     if (is_array) { pj_k (pj, "symbols"); } if ((obj && obj->symbols)? r_list_length (obj->symbols): 0) { playMsg (core, "symbols", (obj && obj->symbols)? r_list_length (obj->symbols): 0);} r_core_bin_info (core, 
# 844 "project/radare2/libr/core/cmd_info.c" 3 4
    0x040
# 844 "project/radare2/libr/core/cmd_info.c"
    , pj, mode, va, 
# 844 "project/radare2/libr/core/cmd_info.c" 3 4
    ((void *)0)
# 844 "project/radare2/libr/core/cmd_info.c"
    , input + 1);;
     ...
     mode = 
# 846 "project/radare2/libr/core/cmd_info.c" 3 4
           0x004
# 846 "project/radare2/libr/core/cmd_info.c"
                        ;
     if (is_array) { pj_k (pj, "symbols"); } if (0) { playMsg (core, "symbols", 0);} r_core_bin_info (core, 
# 847 "project/radare2/libr/core/cmd_info.c" 3 4
    0x040
# 847 "project/radare2/libr/core/cmd_info.c"
    , pj, mode, va, 
# 847 "project/radare2/libr/core/cmd_info.c" 3 4
    ((void *)0)
# 847 "project/radare2/libr/core/cmd_info.c"
    , input + 2);;
     ...
     if (is_array) { pj_k (pj, "symbols"); } if ((obj && obj->symbols)? r_list_length (obj->symbols): 0) { playMsg (core, "symbols", (obj && obj->symbols)? r_list_length (obj->symbols): 0);} r_core_bin_info (core, 
# 849 "project/radare2/libr/core/cmd_info.c" 3 4
    0x040
# 849 "project/radare2/libr/core/cmd_info.c"
    , pj, mode, va, 
# 849 "project/radare2/libr/core/cmd_info.c" 3 4
    ((void *)0)
# 849 "project/radare2/libr/core/cmd_info.c"
  ...
  case 'R':
   if (is_array) { pj_k (pj, "resources"); } if (0) { playMsg (core, "resources", 0);} r_core_bin_info (core, 
# 858 "project/radare2/libr/core/cmd_info.c" 3 4
  0x100000
# 858 "project/radare2/libr/core/cmd_info.c"
  , pj, mode, va, 
# 858 "project/radare2/libr/core/cmd_info.c" 3 4
  ((void *)0)
# 858 "project/radare2/libr/core/cmd_info.c"
...
# 866 "project/radare2/libr/core/cmd_info.c" 3 4
   if (
# 866 "project/radare2/libr/core/cmd_info.c"
   objs
# 866 "project/radare2/libr/core/cmd_info.c" 3 4
   ) for (
# 866 "project/radare2/libr/core/cmd_info.c"
...
# 866 "project/radare2/libr/core/cmd_info.c"
                                   {
     core->bin->cur = bf;
     if (is_array) { pj_k (pj, "relocs"); } if (0) { playMsg (core, "relocs", 0);} r_core_bin_info (core, 
# 868 "project/radare2/libr/core/cmd_info.c" 3 4
    0x010
# 868 "project/radare2/libr/core/cmd_info.c"
    , pj, mode, va, 
# 868 "project/radare2/libr/core/cmd_info.c" 3 4
    ((void *)0)
# 868 "project/radare2/libr/core/cmd_info.c"
...
# 868 "project/radare2/libr/core/cmd_info.c"
   ...
   break;
  case 'X':
   if (is_array) { pj_k (pj, "source"); } if (0) { playMsg (core, "source", 0);} r_core_bin_info (core, 
# 875 "project/radare2/libr/core/cmd_info.c" 3 4
  0x800000
# 875 "project/radare2/libr/core/cmd_info.c"
  , pj, mode, va, 
# 875 "project/radare2/libr/core/cmd_info.c" 3 4
  ((void *)0)
# 875 "project/radare2/libr/core/cmd_info.c"
...
# 881 "project/radare2/libr/core/cmd_info.c" 3 4
   _Bool 
# 881 "project/radare2/libr/core/cmd_info.c"
        file_found;
    char *filename;
...
# 903 "project/radare2/libr/core/cmd_info.c" 3 4
    if (
# 903 "project/radare2/libr/core/cmd_info.c"
    server_l
# 903 "project/radare2/libr/core/cmd_info.c" 3 4
    ) for (
# 903 "project/radare2/libr/core/cmd_info.c"
...
# 911 "project/radare2/libr/core/cmd_info.c" 3 4
     fprintf(__stderrp,
# 911 "project/radare2/libr/core/cmd_info.c"
...
# 928 "project/radare2/libr/core/cmd_info.c" 3 4
      fprintf(__stderrp,
# 928 "project/radare2/libr/core/cmd_info.c"
      "Cannot get file's debug information\n"
# 928 "project/radare2/libr/core/cmd_info.c" 3 4
      )
# 928 "project/radare2/libr/core/cmd_info.c"
                                                       ;
      ...
      if (!file_found) {
       ...
       char* pdb_path = r_str_newf ("%s" 
# 953 "project/radare2/libr/core/cmd_info.c" 3 4
                                        "/" 
# 953 "project/radare2/libr/core/cmd_info.c"
                                                  "%s" 
# 953 "project/radare2/libr/core/cmd_info.c" 3 4
                                                       "/" 
# 953 "project/radare2/libr/core/cmd_info.c"
...
# 959 "project/radare2/libr/core/cmd_info.c" 3 4
       { free((void *)
# 959 "project/radare2/libr/core/cmd_info.c"
       pdb_path
# 959 "project/radare2/libr/core/cmd_info.c" 3 4
       ); 
# 959 "project/radare2/libr/core/cmd_info.c"
...
# 967 "project/radare2/libr/core/cmd_info.c" 3 4
      fprintf(__stderrp,
# 967 "project/radare2/libr/core/cmd_info.c"
      "File '%s' not found in file directory or symbol store\n", fn
# 967 "project/radare2/libr/core/cmd_info.c" 3 4
      )
# 967 "project/radare2/libr/core/cmd_info.c"
                                                                             ;
...
# 969 "project/radare2/libr/core/cmd_info.c" 3 4
      fprintf(__stderrp,
# 969 "project/radare2/libr/core/cmd_info.c"
      "Cannot open file\n"
# 969 "project/radare2/libr/core/cmd_info.c" 3 4
      )
# 969 "project/radare2/libr/core/cmd_info.c"
    ...
    if (is_array) { pj_k (pj, "dwarf"); } if (-1) { playMsg (core, "dwarf", -1);} r_core_bin_info (core, 
# 988 "project/radare2/libr/core/cmd_info.c" 3 4
   0x800
# 988 "project/radare2/libr/core/cmd_info.c"
   , pj, mode, va, 
# 988 "project/radare2/libr/core/cmd_info.c" 3 4
   ((void *)0)
# 988 "project/radare2/libr/core/cmd_info.c"
...
# 996 "project/radare2/libr/core/cmd_info.c" 3 4
  if (
# 996 "project/radare2/libr/core/cmd_info.c"
  objs
# 996 "project/radare2/libr/core/cmd_info.c" 3 4
  ) for (
# 996 "project/radare2/libr/core/cmd_info.c"
...
# 996 "project/radare2/libr/core/cmd_info.c"
    ...
    RBinObject *obj = bf->o;
    core->bin->cur = bf;
    if (is_array) { pj_k (pj, "imports"); } if ((obj && obj->imports)? r_list_length (obj->imports): 0) { playMsg (core, "imports", (obj && obj->imports)? r_list_length (obj->imports): 0);} r_core_bin_info (core, 
# 999 "project/radare2/libr/core/cmd_info.c" 3 4
   0x020
# 999 "project/radare2/libr/core/cmd_info.c"
   , pj, mode, va, 
# 999 "project/radare2/libr/core/cmd_info.c" 3 4
   ((void *)0)
# 999 "project/radare2/libr/core/cmd_info.c"
...
# 1012 "project/radare2/libr/core/cmd_info.c" 3 4
     if (
# 1012 "project/radare2/libr/core/cmd_info.c"
     objs
# 1012 "project/radare2/libr/core/cmd_info.c" 3 4
     ) for (
# 1012 "project/radare2/libr/core/cmd_info.c"
...
# 1012 "project/radare2/libr/core/cmd_info.c"
                                     {
       core->bin->cur = bf;
       if (is_array) { pj_k (pj, "info"); } if (0) { playMsg (core, "info", 0);} r_core_bin_info (core, 
# 1014 "project/radare2/libr/core/cmd_info.c" 3 4
      0x002
# 1014 "project/radare2/libr/core/cmd_info.c"
      , pj, mode, va, 
# 1014 "project/radare2/libr/core/cmd_info.c" 3 4
      ((void *)0)
# 1014 "project/radare2/libr/core/cmd_info.c"
...
# 1026 "project/radare2/libr/core/cmd_info.c" 3 4
     if (
# 1026 "project/radare2/libr/core/cmd_info.c"
     objs
# 1026 "project/radare2/libr/core/cmd_info.c" 3 4
     ) for (
# 1026 "project/radare2/libr/core/cmd_info.c"
...
# 1026 "project/radare2/libr/core/cmd_info.c"
       ...
       core->bin->cur = bf;
       if (input[1] == 'e') {
        if (is_array) { pj_k (pj, "initfini"); } if (0) { playMsg (core, "initfini", 0);} r_core_bin_info (core, 
# 1029 "project/radare2/libr/core/cmd_info.c" 3 4
       0x200000
# 1029 "project/radare2/libr/core/cmd_info.c"
       , pj, mode, va, 
# 1029 "project/radare2/libr/core/cmd_info.c" 3 4
       ((void *)0)
# 1029 "project/radare2/libr/core/cmd_info.c"
...
# 1029 "project/radare2/libr/core/cmd_info.c"
        ...
        if (is_array) { pj_k (pj, "entries"); } if (0) { playMsg (core, "entries", 0);} r_core_bin_info (core, 
# 1032 "project/radare2/libr/core/cmd_info.c" 3 4
       0x008
# 1032 "project/radare2/libr/core/cmd_info.c"
       , pj, mode, va, 
# 1032 "project/radare2/libr/core/cmd_info.c" 3 4
       ((void *)0)
# 1032 "project/radare2/libr/core/cmd_info.c"
...
# 1045 "project/radare2/libr/core/cmd_info.c" 3 4
     if (
# 1045 "project/radare2/libr/core/cmd_info.c"
     objs
# 1045 "project/radare2/libr/core/cmd_info.c" 3 4
     ) for (
# 1045 "project/radare2/libr/core/cmd_info.c"
...
# 1045 "project/radare2/libr/core/cmd_info.c"
                                     {
       core->bin->cur = bf;
       if (is_array) { pj_k (pj, "main"); } if (0) { playMsg (core, "main", 0);} r_core_bin_info (core, 
# 1047 "project/radare2/libr/core/cmd_info.c" 3 4
      0x004
# 1047 "project/radare2/libr/core/cmd_info.c"
      , pj, mode, va, 
# 1047 "project/radare2/libr/core/cmd_info.c" 3 4
      ((void *)0)
# 1047 "project/radare2/libr/core/cmd_info.c"
...
# 1059 "project/radare2/libr/core/cmd_info.c" 3 4
     if (
# 1059 "project/radare2/libr/core/cmd_info.c"
     objs
# 1059 "project/radare2/libr/core/cmd_info.c" 3 4
     ) for (
# 1059 "project/radare2/libr/core/cmd_info.c"
...
# 1059 "project/radare2/libr/core/cmd_info.c"
                                     {
       core->bin->cur = bf;
       if (is_array) { pj_k (pj, "memory"); } if (0) { playMsg (core, "memory", 0);} r_core_bin_info (core, 
# 1061 "project/radare2/libr/core/cmd_info.c" 3 4
      0x4000
# 1061 "project/radare2/libr/core/cmd_info.c"
      , pj, mode, va, 
# 1061 "project/radare2/libr/core/cmd_info.c" 3 4
      ((void *)0)
# 1061 "project/radare2/libr/core/cmd_info.c"
...
# 1073 "project/radare2/libr/core/cmd_info.c" 3 4
     if (
# 1073 "project/radare2/libr/core/cmd_info.c"
     objs
# 1073 "project/radare2/libr/core/cmd_info.c" 3 4
     ) for (
# 1073 "project/radare2/libr/core/cmd_info.c"
...
# 1073 "project/radare2/libr/core/cmd_info.c"
                                     {
       core->bin->cur = bf;
       if (is_array) { pj_k (pj, "trycatch"); } if (0) { playMsg (core, "trycatch", 0);} r_core_bin_info (core, 
# 1075 "project/radare2/libr/core/cmd_info.c" 3 4
      0x20000000
# 1075 "project/radare2/libr/core/cmd_info.c"
      , pj, mode, va, 
# 1075 "project/radare2/libr/core/cmd_info.c" 3 4
      ((void *)0)
# 1075 "project/radare2/libr/core/cmd_info.c"
...
# 1087 "project/radare2/libr/core/cmd_info.c" 3 4
     if (
# 1087 "project/radare2/libr/core/cmd_info.c"
     objs
# 1087 "project/radare2/libr/core/cmd_info.c" 3 4
     ) for (
# 1087 "project/radare2/libr/core/cmd_info.c"
...
# 1087 "project/radare2/libr/core/cmd_info.c"
                                     {
       core->bin->cur = bf;
       if (is_array) { pj_k (pj, "versioninfo"); } if (0) { playMsg (core, "versioninfo", 0);} r_core_bin_info (core, 
# 1089 "project/radare2/libr/core/cmd_info.c" 3 4
      0x10000
# 1089 "project/radare2/libr/core/cmd_info.c"
      , pj, mode, va, 
# 1089 "project/radare2/libr/core/cmd_info.c" 3 4
      ((void *)0)
# 1089 "project/radare2/libr/core/cmd_info.c"
...
# 1102 "project/radare2/libr/core/cmd_info.c" 3 4
     if (
# 1102 "project/radare2/libr/core/cmd_info.c"
     objs
# 1102 "project/radare2/libr/core/cmd_info.c" 3 4
     ) for (
# 1102 "project/radare2/libr/core/cmd_info.c"
...
# 1102 "project/radare2/libr/core/cmd_info.c"
                                     {
       core->bin->cur = bf;
       if (is_array) { pj_k (pj, "signature"); } if (0) { playMsg (core, "signature", 0);} r_core_bin_info (core, 
# 1104 "project/radare2/libr/core/cmd_info.c" 3 4
      0x20000
# 1104 "project/radare2/libr/core/cmd_info.c"
      , pj, mode, va, 
# 1104 "project/radare2/libr/core/cmd_info.c" 3 4
      ((void *)0)
# 1104 "project/radare2/libr/core/cmd_info.c"
...
# 1113 "project/radare2/libr/core/cmd_info.c" 3 4
   unsigned long long 
# 1113 "project/radare2/libr/core/cmd_info.c"
        addr = core->offset;
    
# 1114 "project/radare2/libr/core/cmd_info.c" 3 4
   _Bool 
# 1114 "project/radare2/libr/core/cmd_info.c"
        old_tmpseek = core->tmpseek;
    input++;
    if (input[1] == ' ') {
     const char *argstr = r_str_trim_head_ro (input + 2);
     
# 1118 "project/radare2/libr/core/cmd_info.c" 3 4
    unsigned long long 
# 1118 "project/radare2/libr/core/cmd_info.c"
         arg = r_num_get (
# 1118 "project/radare2/libr/core/cmd_info.c" 3 4
                          ((void *)0)
# 1118 "project/radare2/libr/core/cmd_info.c"
    ...
    core->tmpseek = 
# 1124 "project/radare2/libr/core/cmd_info.c" 3 4
                   0
# 1124 "project/radare2/libr/core/cmd_info.c"
                        ;
    r_core_cmdf (core, "e bin.str.purge=%s%s0x%" 
# 1125 "project/radare2/libr/core/cmd_info.c" 3 4
                                                "llx"
# 1125 "project/radare2/libr/core/cmd_info.c"
                                                       ,
      r_str_get (strpurge),
      (strpurge && *strpurge)? ",": "",
      addr);
    ...
    newline = 
# 1130 "project/radare2/libr/core/cmd_info.c" 3 4
             0
# 1130 "project/radare2/libr/core/cmd_info.c"
                  ;
   } else if (input[1] == 'z') {
    switch (input[2]) {
    case 'z':
     rdump = 
# 1134 "project/radare2/libr/core/cmd_info.c" 3 4
            1
# 1134 "project/radare2/libr/core/cmd_info.c"
                ;
     break;
    case '*':
     mode = 
# 1137 "project/radare2/libr/core/cmd_info.c" 3 4
           0x001
# 1137 "project/radare2/libr/core/cmd_info.c"
                        ;
     break;
    case 'j':
     mode = 
# 1140 "project/radare2/libr/core/cmd_info.c" 3 4
           0x008
# 1140 "project/radare2/libr/core/cmd_info.c"
                      ;
     if (!pj) { pj = r_core_pj_new (core); if (!pj) { return 1; } };
     break;
    case 'q':
     if (input[3] == 'q') {
      mode = 
# 1145 "project/radare2/libr/core/cmd_info.c" 3 4
            0x020
# 1145 "project/radare2/libr/core/cmd_info.c"
                           ;
      input++;
     } else {
      mode = 
# 1148 "project/radare2/libr/core/cmd_info.c" 3 4
            0x004
# 1148 "project/radare2/libr/core/cmd_info.c"
                         ;
     }
     break;
    default:
     mode = 
# 1152 "project/radare2/libr/core/cmd_info.c" 3 4
           0x000
# 1152 "project/radare2/libr/core/cmd_info.c"
                       ;
     break;
    }
    input++;
    ...
    if (is_array) { pj_k (pj, "strings"); } if (0) { playMsg (core, "strings", 0);} r_core_bin_info (core, 
# 1167 "project/radare2/libr/core/cmd_info.c" 3 4
   0x40000
# 1167 "project/radare2/libr/core/cmd_info.c"
   , pj, mode, va, 
# 1167 "project/radare2/libr/core/cmd_info.c" 3 4
   ((void *)0)
# 1167 "project/radare2/libr/core/cmd_info.c"
...
# 1193 "project/radare2/libr/core/cmd_info.c"
   } else {

    
# 1195 "project/radare2/libr/core/cmd_info.c" 3 4
   _Bool 
# 1195 "project/radare2/libr/core/cmd_info.c"
        validcmd = 
# 1195 "project/radare2/libr/core/cmd_info.c" 3 4
                   1
# 1195 "project/radare2/libr/core/cmd_info.c"
    ...
    case '*':
     validcmd = 
# 1199 "project/radare2/libr/core/cmd_info.c" 3 4
               0
# 1199 "project/radare2/libr/core/cmd_info.c"
                    ;
     break;
    case 'q':
     ...
     mode = (input[2] == 'q')
     ? 
# 1204 "project/radare2/libr/core/cmd_info.c" 3 4
      0x020
     
# 1205 "project/radare2/libr/core/cmd_info.c"
    : 
# 1205 "project/radare2/libr/core/cmd_info.c" 3 4
      0x004
# 1205 "project/radare2/libr/core/cmd_info.c"
                   ;
     input++;
...
# 1214 "project/radare2/libr/core/cmd_info.c" 3 4
    if (
# 1214 "project/radare2/libr/core/cmd_info.c"
    objs
# 1214 "project/radare2/libr/core/cmd_info.c" 3 4
    ) for (
# 1214 "project/radare2/libr/core/cmd_info.c"
...
# 1214 "project/radare2/libr/core/cmd_info.c"
      ...
      core->bin->cur = bf;
      RBinObject *obj = r_bin_cur_object (core->bin);
      if (is_array) { pj_k (pj, "strings"); } if ((obj && obj->strings)? r_list_length (obj->strings): 0) { playMsg (core, "strings", (obj && obj->strings)? r_list_length (obj->strings): 0);} r_core_bin_info (core, 
# 1217 "project/radare2/libr/core/cmd_info.c" 3 4
     0x001
# 1217 "project/radare2/libr/core/cmd_info.c"
     , pj, mode, va, 
# 1217 "project/radare2/libr/core/cmd_info.c" 3 4
     ((void *)0)
# 1217 "project/radare2/libr/core/cmd_info.c"
...
# 1228 "project/radare2/libr/core/cmd_info.c" 3 4
   fprintf(__stderrp,
# 1228 "project/radare2/libr/core/cmd_info.c"
   "Usage: ic[gljqc**] [class-index or name]\n"
# 1228 "project/radare2/libr/core/cmd_info.c" 3 4
   )
# 1228 "project/radare2/libr/core/cmd_info.c"
                                                         ;
...
# 1236 "project/radare2/libr/core/cmd_info.c" 3 4
   _Bool 
# 1236 "project/radare2/libr/core/cmd_info.c"
        fullGraph = 
# 1236 "project/radare2/libr/core/cmd_info.c" 3 4
                    1
# 1236 "project/radare2/libr/core/cmd_info.c"
...
# 1238 "project/radare2/libr/core/cmd_info.c" 3 4
    if (
# 1238 "project/radare2/libr/core/cmd_info.c"
    obj->classes
# 1238 "project/radare2/libr/core/cmd_info.c" 3 4
    ) for (
# 1238 "project/radare2/libr/core/cmd_info.c"
...
# 1248 "project/radare2/libr/core/cmd_info.c" 3 4
    if (
# 1248 "project/radare2/libr/core/cmd_info.c"
    obj->classes
# 1248 "project/radare2/libr/core/cmd_info.c" 3 4
    ) for (
# 1248 "project/radare2/libr/core/cmd_info.c"
...
# 1262 "project/radare2/libr/core/cmd_info.c" 3 4
   if (
# 1262 "project/radare2/libr/core/cmd_info.c"
   objs
# 1262 "project/radare2/libr/core/cmd_info.c" 3 4
   ) for (
# 1262 "project/radare2/libr/core/cmd_info.c"
...
# 1273 "project/radare2/libr/core/cmd_info.c" 3 4
     _Bool 
# 1273 "project/radare2/libr/core/cmd_info.c"
          radare2 = strstr (input, "**") != 
# 1273 "project/radare2/libr/core/cmd_info.c" 3 4
                                            ((void *)0)
# 1273 "project/radare2/libr/core/cmd_info.c"
                                                ;
      int idx = -1;
      const char * cls_name = 
# 1275 "project/radare2/libr/core/cmd_info.c" 3 4
                             ((void *)0)
# 1275 "project/radare2/libr/core/cmd_info.c"
                                 ;
      if (radare2) {
       input ++;
      }
...
# 1293 "project/radare2/libr/core/cmd_info.c" 3 4
     if (
# 1293 "project/radare2/libr/core/cmd_info.c"
     obj->classes
# 1293 "project/radare2/libr/core/cmd_info.c" 3 4
     ) for (
# 1293 "project/radare2/libr/core/cmd_info.c"
...
# 1296 "project/radare2/libr/core/cmd_info.c" 3 4
       if (
# 1296 "project/radare2/libr/core/cmd_info.c"
       cls->methods
# 1296 "project/radare2/libr/core/cmd_info.c" 3 4
       ) for (
# 1296 "project/radare2/libr/core/cmd_info.c"
...
# 1296 "project/radare2/libr/core/cmd_info.c"
                                                 {
         r_cons_printf ("ac %s %s 0x%08"
# 1297 "project/radare2/libr/core/cmd_info.c" 3 4
                                       "llx"
# 1297 "project/radare2/libr/core/cmd_info.c"
...
# 1307 "project/radare2/libr/core/cmd_info.c" 3 4
       if (
# 1307 "project/radare2/libr/core/cmd_info.c"
       cls->methods
# 1307 "project/radare2/libr/core/cmd_info.c" 3 4
       ) for (
# 1307 "project/radare2/libr/core/cmd_info.c"
...
# 1307 "project/radare2/libr/core/cmd_info.c"
                                                 {
         r_cons_printf ("f sym.%s @ 0x%"
# 1308 "project/radare2/libr/core/cmd_info.c" 3 4
                                       "llx" 
# 1308 "project/radare2/libr/core/cmd_info.c"
                                               "\n",
           sym->name, sym->vaddr);
        }
        input++;
...
# 1314 "project/radare2/libr/core/cmd_info.c" 3 4
       if (
# 1314 "project/radare2/libr/core/cmd_info.c"
       cls->methods
# 1314 "project/radare2/libr/core/cmd_info.c" 3 4
       ) for (
# 1314 "project/radare2/libr/core/cmd_info.c"
...
# 1314 "project/radare2/libr/core/cmd_info.c"
         ...
         r_cons_printf ("%s0x%"
# 1316 "project/radare2/libr/core/cmd_info.c" 3 4
                              "lld"
# 1316 "project/radare2/libr/core/cmd_info.c"
                                     , comma, sym->vaddr);
        }
        r_cons_newline ();
        input++;
...
# 1325 "project/radare2/libr/core/cmd_info.c" 3 4
       if (
# 1325 "project/radare2/libr/core/cmd_info.c"
       cls->methods
# 1325 "project/radare2/libr/core/cmd_info.c" 3 4
       ) for (
# 1325 "project/radare2/libr/core/cmd_info.c"
...
# 1325 "project/radare2/libr/core/cmd_info.c"
         ...
         if (sym->method_flags) {
          char *flags = r_core_bin_method_flags_str (sym->method_flags, 
# 1329 "project/radare2/libr/core/cmd_info.c" 3 4
                                                                       0x008
# 1329 "project/radare2/libr/core/cmd_info.c"
                                                                                  );
          pj_k (pj, "flags");
          pj_j (pj, flags);
          free (flags);
...
# 1341 "project/radare2/libr/core/cmd_info.c" 3 4
       if (
# 1341 "project/radare2/libr/core/cmd_info.c"
       cls->methods
# 1341 "project/radare2/libr/core/cmd_info.c" 3 4
       ) for (
# 1341 "project/radare2/libr/core/cmd_info.c"
...
# 1341 "project/radare2/libr/core/cmd_info.c"
         ...
         r_cons_printf ("0x%08"
# 1343 "project/radare2/libr/core/cmd_info.c" 3 4
                              "llx" 
# 1343 "project/radare2/libr/core/cmd_info.c"
                                      " method %s %s %s\n",
           sym->vaddr, cls->name, flags, sym->name);
         
# 1345 "project/radare2/libr/core/cmd_info.c" 3 4
        { free((void *)
# 1345 "project/radare2/libr/core/cmd_info.c"
        flags
# 1345 "project/radare2/libr/core/cmd_info.c" 3 4
        ); 
# 1345 "project/radare2/libr/core/cmd_info.c"
...
# 1355 "project/radare2/libr/core/cmd_info.c" 3 4
      if (
# 1355 "project/radare2/libr/core/cmd_info.c"
      obj->classes
# 1355 "project/radare2/libr/core/cmd_info.c" 3 4
      ) for (
# 1355 "project/radare2/libr/core/cmd_info.c"
...
# 1361 "project/radare2/libr/core/cmd_info.c" 3 4
      if (
# 1361 "project/radare2/libr/core/cmd_info.c"
      obj->classes
# 1361 "project/radare2/libr/core/cmd_info.c" 3 4
      ) for (
# 1361 "project/radare2/libr/core/cmd_info.c"
...
# 1362 "project/radare2/libr/core/cmd_info.c" 3 4
       if (
# 1362 "project/radare2/libr/core/cmd_info.c"
       cls->methods
# 1362 "project/radare2/libr/core/cmd_info.c" 3 4
       ) for (
# 1362 "project/radare2/libr/core/cmd_info.c"
...
# 1362 "project/radare2/libr/core/cmd_info.c"
         ...
         const char *comma = iter2->p? " ": "";
         r_cons_printf ("%s0x%"
# 1364 "project/radare2/libr/core/cmd_info.c" 3 4
                              "lld"
# 1364 "project/radare2/libr/core/cmd_info.c"
                                     , comma, sym->vaddr);
        }
        if (!
# 1366 "project/radare2/libr/core/cmd_info.c" 3 4
            (!(
# 1366 "project/radare2/libr/core/cmd_info.c"
            cls->methods
# 1366 "project/radare2/libr/core/cmd_info.c" 3 4
            ) || !(
# 1366 "project/radare2/libr/core/cmd_info.c"
...
# 1366 "project/radare2/libr/core/cmd_info.c"
       ...
       mode = 
# 1371 "project/radare2/libr/core/cmd_info.c" 3 4
             0x040
# 1371 "project/radare2/libr/core/cmd_info.c"
                             ;
       if (input[2] == '*') {
        mode |= 
# 1373 "project/radare2/libr/core/cmd_info.c" 3 4
               0x001
# 1373 "project/radare2/libr/core/cmd_info.c"
                            ;
       }
       if (is_array) { pj_k (pj, "classes"); } if (r_list_length (obj->classes)) { playMsg (core, "classes", r_list_length (obj->classes));} r_core_bin_info (core, 
# 1375 "project/radare2/libr/core/cmd_info.c" 3 4
      0x400
# 1375 "project/radare2/libr/core/cmd_info.c"
      , pj, mode, va, 
# 1375 "project/radare2/libr/core/cmd_info.c" 3 4
      ((void *)0)
# 1375 "project/radare2/libr/core/cmd_info.c"
...
# 1375 "project/radare2/libr/core/cmd_info.c"
       ...
       if (input[2] == 'j') {
        mode |= 
# 1379 "project/radare2/libr/core/cmd_info.c" 3 4
               0x008
# 1379 "project/radare2/libr/core/cmd_info.c"
                          ;
       }
       if (is_array) { pj_k (pj, "classes"); } if (r_list_length (obj->classes)) { playMsg (core, "classes", r_list_length (obj->classes));} r_core_bin_info (core, 
# 1381 "project/radare2/libr/core/cmd_info.c" 3 4
      0x400
# 1381 "project/radare2/libr/core/cmd_info.c"
      , pj, mode, va, 
# 1381 "project/radare2/libr/core/cmd_info.c" 3 4
      ((void *)0)
# 1381 "project/radare2/libr/core/cmd_info.c"
...
# 1393 "project/radare2/libr/core/cmd_info.c" 3 4
   if (
# 1393 "project/radare2/libr/core/cmd_info.c"
   objs
# 1393 "project/radare2/libr/core/cmd_info.c" 3 4
   ) for (
# 1393 "project/radare2/libr/core/cmd_info.c"
...
# 1393 "project/radare2/libr/core/cmd_info.c"
     ...
     if (obj && obj->classes) {
      ...
      if (is_array) { pj_k (pj, "classes"); } if (len) { playMsg (core, "classes", len);} r_core_bin_info (core, 
# 1398 "project/radare2/libr/core/cmd_info.c" 3 4
     0x400
# 1398 "project/radare2/libr/core/cmd_info.c"
     , pj, mode, va, 
# 1398 "project/radare2/libr/core/cmd_info.c" 3 4
     ((void *)0)
# 1398 "project/radare2/libr/core/cmd_info.c"
...
# 1407 "project/radare2/libr/core/cmd_info.c" 3 4
   fprintf(__stderrp,
# 1407 "project/radare2/libr/core/cmd_info.c"
   "|Usage: iD lang symbolname\n"
# 1407 "project/radare2/libr/core/cmd_info.c" 3 4
   )
# 1407 "project/radare2/libr/core/cmd_info.c"
                                           ;
  ...
  case 'a':
   switch (mode) {
   case 
# 1412 "project/radare2/libr/core/cmd_info.c" 3 4
       0x001
# 1412 "project/radare2/libr/core/cmd_info.c"
                    : cmd_info (core, "IieEcsSmz*"); break;
   case 
# 1413 "project/radare2/libr/core/cmd_info.c" 3 4
       0x008
# 1413 "project/radare2/libr/core/cmd_info.c"
                  : cmd_info (core, "IieEcsSmzj"); break;
   case 
# 1414 "project/radare2/libr/core/cmd_info.c" 3 4
       0x004
# 1414 "project/radare2/libr/core/cmd_info.c"
                    : cmd_info (core, "IieEcsSmzq"); break;
  ...
  case '*':
   if (mode == 
# 1422 "project/radare2/libr/core/cmd_info.c" 3 4
              0x001
# 1422 "project/radare2/libr/core/cmd_info.c"
                           ) {

    mode = 
# 1424 "project/radare2/libr/core/cmd_info.c" 3 4
          0x001
# 1424 "project/radare2/libr/core/cmd_info.c"
                       ;
   } else {
    mode = 
# 1426 "project/radare2/libr/core/cmd_info.c" 3 4
          0x001
# 1426 "project/radare2/libr/core/cmd_info.c"
                       ;
   }
   goto done;
  case 'q':
   mode = 
# 1430 "project/radare2/libr/core/cmd_info.c" 3 4
         0x004
# 1430 "project/radare2/libr/core/cmd_info.c"
                      ;
   cmd_info_bin (core, va, pj, mode);
   goto done;
  case 'j':
   mode = 
# 1434 "project/radare2/libr/core/cmd_info.c" 3 4
         0x008
# 1434 "project/radare2/libr/core/cmd_info.c"
                    ;
   if (is_array > 1) {
    mode |= 
# 1436 "project/radare2/libr/core/cmd_info.c" 3 4
           0x010
# 1436 "project/radare2/libr/core/cmd_info.c"
                       ;
   }
   cmd_info_bin (core, va, pj, mode);
   goto done;
 ...
 if (mode & 
# 1458 "project/radare2/libr/core/cmd_info.c" 3 4
           0x008
# 1458 "project/radare2/libr/core/cmd_info.c"
                      ) {
  if (is_array && !is_izzzj && !is_idpij) {
   pj_end (pj);
  }
