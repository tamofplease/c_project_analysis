# 0 "project/radare2/libr/core/cmd_log.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/cmd_log.c"
...
# 4 "project/radare2/libr/core/cmd_log.c" 2
...
typedef int RRef;
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_config.h" 2 3 4
...
# 9 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_th.h" 3 4
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_userconf.h" 1 3 4
...
# 6 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_config.h" 2 3 4
...
# 5 "project/radare2/libr/core/cmd_log.c" 2
...
# 23 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_debug.h" 3 4
...
# 7 "project/radare2/libr/core/cmd_log.c" 2



# 9 "project/radare2/libr/core/cmd_log.c"
static const char *help_msg_L[] = {
 "Usage:", "L[acio]", "[-name][ file]",
 "L", "", "show this help",
 "L", " blah."
# 12 "project/radare2/libr/core/cmd_log.c" 3 4
             "dylib"
# 12 "project/radare2/libr/core/cmd_log.c"
                      , "load plugin file",
...
# 27 "project/radare2/libr/core/cmd_log.c" 3 4
((void *)0)

# 28 "project/radare2/libr/core/cmd_log.c"
};
...
# 46 "project/radare2/libr/core/cmd_log.c" 3 4
((void *)0)

# 47 "project/radare2/libr/core/cmd_log.c"
};

static void screenlock(RCore *core) {

 char *pass = r_cons_password (
# 51 "project/radare2/libr/core/cmd_log.c" 3 4
                              "\x1b[7m" 
# 51 "project/radare2/libr/core/cmd_log.c"
                                           "Enter new password:"
# 51 "project/radare2/libr/core/cmd_log.c" 3 4
                                                                "\x1b[27m"
# 51 "project/radare2/libr/core/cmd_log.c"
 ...
 char *again = r_cons_password (
# 55 "project/radare2/libr/core/cmd_log.c" 3 4
                               "\x1b[7m" 
# 55 "project/radare2/libr/core/cmd_log.c"
                                            "Type it again:"
# 55 "project/radare2/libr/core/cmd_log.c" 3 4
                                                            "\x1b[27m"
# 55 "project/radare2/libr/core/cmd_log.c"
...
# 61 "project/radare2/libr/core/cmd_log.c" 3 4
 fprintf(__stderrp,
# 61 "project/radare2/libr/core/cmd_log.c"
 "Password mismatch!\n"
# 61 "project/radare2/libr/core/cmd_log.c" 3 4
 )
# 61 "project/radare2/libr/core/cmd_log.c"
...
# 66 "project/radare2/libr/core/cmd_log.c" 3 4
_Bool 
# 66 "project/radare2/libr/core/cmd_log.c"
     running = 
# 66 "project/radare2/libr/core/cmd_log.c" 3 4
               1
# 66 "project/radare2/libr/core/cmd_log.c"
...
# 68 "project/radare2/libr/core/cmd_log.c" 3 4
unsigned long long 
# 68 "project/radare2/libr/core/cmd_log.c"
     begin = r_time_now ();
 
# 69 "project/radare2/libr/core/cmd_log.c" 3 4
unsigned long long 
# 69 "project/radare2/libr/core/cmd_log.c"
     last = 
# 69 "project/radare2/libr/core/cmd_log.c" 3 4
...
# 69 "project/radare2/libr/core/cmd_log.c"
 ...
 do {
  ...
  if (last != 
# 75 "project/radare2/libr/core/cmd_log.c" 3 4
             0xFFFFFFFFFFFFFFFFULL
# 75 "project/radare2/libr/core/cmd_log.c"
                     ) {
  ...
  if (msg && !strcmp (msg, pass)) {
   running = 
# 82 "project/radare2/libr/core/cmd_log.c" 3 4
            0
# 82 "project/radare2/libr/core/cmd_log.c"
                 ;
  } else {
   
# 84 "project/radare2/libr/core/cmd_log.c" 3 4
  fprintf(__stderrp,
# 84 "project/radare2/libr/core/cmd_log.c"
  "\nInvalid password.\n"
# 84 "project/radare2/libr/core/cmd_log.c" 3 4
  )
# 84 "project/radare2/libr/core/cmd_log.c"
 ...
 r_cons_set_cup (
# 92 "project/radare2/libr/core/cmd_log.c" 3 4
                1
# 92 "project/radare2/libr/core/cmd_log.c"
                    );
 free (pass);
 
# 94 "project/radare2/libr/core/cmd_log.c" 3 4
fprintf(__stderrp,
# 94 "project/radare2/libr/core/cmd_log.c"
"Unlocked!\n"
# 94 "project/radare2/libr/core/cmd_log.c" 3 4
)
# 94 "project/radare2/libr/core/cmd_log.c"
...
# 104 "project/radare2/libr/core/cmd_log.c" 3 4
fprintf(__stderrp,
# 104 "project/radare2/libr/core/cmd_log.c"
...
# 105 "project/radare2/libr/core/cmd_log.c" 3 4
__builtin___snprintf_chk (
# 105 "project/radare2/libr/core/cmd_log.c"
prompt
# 105 "project/radare2/libr/core/cmd_log.c" 3 4
, 
# 105 "project/radare2/libr/core/cmd_log.c"
...
# 105 "project/radare2/libr/core/cmd_log.c"
 ...
 for (;;) {
  ...
  if (r_cons_fgets (buf, sizeof (buf), 0, 
# 110 "project/radare2/libr/core/cmd_log.c" 3 4
                                         ((void *)0)
# 110 "project/radare2/libr/core/cmd_log.c"
                                             ) < 0) {
   return 1;
  }
  if (!*buf) {
...
# 117 "project/radare2/libr/core/cmd_log.c" 3 4
  fprintf(__stderrp,
# 117 "project/radare2/libr/core/cmd_log.c"
  "/quit           quit the chat (same as ^D)\n"
# 117 "project/radare2/libr/core/cmd_log.c" 3 4
  )
# 117 "project/radare2/libr/core/cmd_log.c"
                                                          ;
   
# 118 "project/radare2/libr/core/cmd_log.c" 3 4
  fprintf(__stderrp,
# 118 "project/radare2/libr/core/cmd_log.c"
  "/name <nick>    set cfg.user name\n"
# 118 "project/radare2/libr/core/cmd_log.c" 3 4
  )
# 118 "project/radare2/libr/core/cmd_log.c"
                                                 ;
   
# 119 "project/radare2/libr/core/cmd_log.c" 3 4
  fprintf(__stderrp,
# 119 "project/radare2/libr/core/cmd_log.c"
  "/log            show full log\n"
# 119 "project/radare2/libr/core/cmd_log.c" 3 4
  )
# 119 "project/radare2/libr/core/cmd_log.c"
...
# 120 "project/radare2/libr/core/cmd_log.c" 3 4
  fprintf(__stderrp,
# 120 "project/radare2/libr/core/cmd_log.c"
  "/clear          clear text log messages\n"
# 120 "project/radare2/libr/core/cmd_log.c" 3 4
  )
# 120 "project/radare2/libr/core/cmd_log.c"
                                                       ;
...
# 122 "project/radare2/libr/core/cmd_log.c" 3 4
  __builtin___snprintf_chk (
# 122 "project/radare2/libr/core/cmd_log.c"
  msg
# 122 "project/radare2/libr/core/cmd_log.c" 3 4
  , 
# 122 "project/radare2/libr/core/cmd_log.c"
...
# 126 "project/radare2/libr/core/cmd_log.c" 3 4
  __builtin___snprintf_chk (
# 126 "project/radare2/libr/core/cmd_log.c"
  prompt
# 126 "project/radare2/libr/core/cmd_log.c" 3 4
  , 
# 126 "project/radare2/libr/core/cmd_log.c"
...
# 139 "project/radare2/libr/core/cmd_log.c" 3 4
  fprintf(__stderrp,
# 139 "project/radare2/libr/core/cmd_log.c"
  "Unknown command: %s\n", buf
# 139 "project/radare2/libr/core/cmd_log.c" 3 4
  )
# 139 "project/radare2/libr/core/cmd_log.c"
...
# 141 "project/radare2/libr/core/cmd_log.c" 3 4
  __builtin___snprintf_chk (
# 141 "project/radare2/libr/core/cmd_log.c"
  msg
# 141 "project/radare2/libr/core/cmd_log.c" 3 4
  , 
# 141 "project/radare2/libr/core/cmd_log.c"
...
static int getIndexFromLogString(const char *s) {
 ...
 int nlctr = 2;
 const char *nl = 
# 152 "project/radare2/libr/core/cmd_log.c" 3 4
                 ((void *)0)
# 152 "project/radare2/libr/core/cmd_log.c"
                     ;
 while (m > s) {
  if (*m == '\n') {
   nl = m;
...
static char *expr2cmd (RCoreLog *log, const char *line) {
 if (!line || !*line) {
  return 
# 168 "project/radare2/libr/core/cmd_log.c" 3 4
        ((void *)0)
# 168 "project/radare2/libr/core/cmd_log.c"
            ;
 }
 line++;
...
# 177 "project/radare2/libr/core/cmd_log.c" 3 4
   unsigned long long 
# 177 "project/radare2/libr/core/cmd_log.c"
        addr = r_num_get (
# 177 "project/radare2/libr/core/cmd_log.c" 3 4
                          ((void *)0)
# 177 "project/radare2/libr/core/cmd_log.c"
                              , line);
    return r_str_newf ("CCu base64:%s @ 0x%"
# 178 "project/radare2/libr/core/cmd_log.c" 3 4
                                           "llx"
# 178 "project/radare2/libr/core/cmd_log.c"
                                                  "\n", msg, addr);
   }
  }
  
# 181 "project/radare2/libr/core/cmd_log.c" 3 4
 fprintf(__stderrp,
# 181 "project/radare2/libr/core/cmd_log.c"
 "add-comment parsing error\n"
# 181 "project/radare2/libr/core/cmd_log.c" 3 4
 )
# 181 "project/radare2/libr/core/cmd_log.c"
                                        ;
...
# 187 "project/radare2/libr/core/cmd_log.c" 3 4
 fprintf(__stderrp,
# 187 "project/radare2/libr/core/cmd_log.c"
 "add-comment parsing error\n"
# 187 "project/radare2/libr/core/cmd_log.c" 3 4
 )
# 187 "project/radare2/libr/core/cmd_log.c"
 ...
 return 
# 189 "project/radare2/libr/core/cmd_log.c" 3 4
       ((void *)0)
# 189 "project/radare2/libr/core/cmd_log.c"
           ;
}
 ...
 case 'e':
  {
   char *p = strchr (input, ' ');
   if (p) {
    char *b = r_file_slurp (p + 1, 
# 228 "project/radare2/libr/core/cmd_log.c" 3 4
                                  ((void *)0)
# 228 "project/radare2/libr/core/cmd_log.c"
                                      );
    if (b) {
     r_cons_less_str (b, 
# 230 "project/radare2/libr/core/cmd_log.c" 3 4
                        ((void *)0)
# 230 "project/radare2/libr/core/cmd_log.c"
                            );
     free (b);
    } else {
     
# 233 "project/radare2/libr/core/cmd_log.c" 3 4
    fprintf(__stderrp,
# 233 "project/radare2/libr/core/cmd_log.c"
    "File not found\n"
# 233 "project/radare2/libr/core/cmd_log.c" 3 4
    )
# 233 "project/radare2/libr/core/cmd_log.c"
...
# 236 "project/radare2/libr/core/cmd_log.c" 3 4
   fprintf(__stderrp,
# 236 "project/radare2/libr/core/cmd_log.c"
   "Usage: less [filename]\n"
# 236 "project/radare2/libr/core/cmd_log.c" 3 4
   )
# 236 "project/radare2/libr/core/cmd_log.c"
...
# 253 "project/radare2/libr/core/cmd_log.c" 3 4
  fprintf(__stderrp,
# 253 "project/radare2/libr/core/cmd_log.c"
  "Only available when the screen is interactive\n"
# 253 "project/radare2/libr/core/cmd_log.c" 3 4
  )
# 253 "project/radare2/libr/core/cmd_log.c"
                                                             ;
 ...
 case '=':
  if (input[1] == '&') {
   if (input[2] == '&') {
    r_cons_break_push (
# 259 "project/radare2/libr/core/cmd_log.c" 3 4
                      ((void *)0)
# 259 "project/radare2/libr/core/cmd_log.c"
                          , 
# 259 "project/radare2/libr/core/cmd_log.c" 3 4
                            ((void *)0)
# 259 "project/radare2/libr/core/cmd_log.c"
...
# 269 "project/radare2/libr/core/cmd_log.c" 3 4
   fprintf(__stderrp,
# 269 "project/radare2/libr/core/cmd_log.c"
   "Background thread syncing with http.sync started.\n"
# 269 "project/radare2/libr/core/cmd_log.c" 3 4
   )
# 269 "project/radare2/libr/core/cmd_log.c"
                                                                  ;
    RCoreTask *task = r_core_task_new (core, 
# 270 "project/radare2/libr/core/cmd_log.c" 3 4
                                            1
# 270 "project/radare2/libr/core/cmd_log.c"
                                                , "T=&&", 
# 270 "project/radare2/libr/core/cmd_log.c" 3 4
                                                          ((void *)0)
# 270 "project/radare2/libr/core/cmd_log.c"
...
# 380 "project/radare2/libr/core/cmd_log.c" 3 4
  if (
# 380 "project/radare2/libr/core/cmd_log.c"
  core->rcmd->plist
# 380 "project/radare2/libr/core/cmd_log.c" 3 4
  ) for (
# 380 "project/radare2/libr/core/cmd_log.c"
...
# 396 "project/radare2/libr/core/cmd_log.c" 3 4
  if (
# 396 "project/radare2/libr/core/cmd_log.c"
  core->rcmd->plist
# 396 "project/radare2/libr/core/cmd_log.c" 3 4
  ) for (
# 396 "project/radare2/libr/core/cmd_log.c"
