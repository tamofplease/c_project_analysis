# 0 "project/radare2/libr/core/cmd_zign.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/core/cmd_zign.c"
...
# 4 "project/radare2/libr/core/cmd_zign.c" 2

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_sign.h" 1 3 4
# 6 "project/radare2/libr/core/cmd_zign.c" 2





# 10 "project/radare2/libr/core/cmd_zign.c"
...
# 30 "project/radare2/libr/core/cmd_zign.c" 3 4
((void *)0)

# 31 "project/radare2/libr/core/cmd_zign.c"
};
...
# 37 "project/radare2/libr/core/cmd_zign.c" 3 4
((void *)0)

# 38 "project/radare2/libr/core/cmd_zign.c"
};
...
# 45 "project/radare2/libr/core/cmd_zign.c" 3 4
((void *)0)

# 46 "project/radare2/libr/core/cmd_zign.c"
};
...
# 56 "project/radare2/libr/core/cmd_zign.c" 3 4
((void *)0)

# 57 "project/radare2/libr/core/cmd_zign.c"
};
...
# 65 "project/radare2/libr/core/cmd_zign.c" 3 4
((void *)0)

# 66 "project/radare2/libr/core/cmd_zign.c"
};
...
# 73 "project/radare2/libr/core/cmd_zign.c" 3 4
((void *)0)

# 74 "project/radare2/libr/core/cmd_zign.c"
};
...
# 86 "project/radare2/libr/core/cmd_zign.c" 3 4
((void *)0)

# 87 "project/radare2/libr/core/cmd_zign.c"
};
...
# 94 "project/radare2/libr/core/cmd_zign.c" 3 4
((void *)0)

# 95 "project/radare2/libr/core/cmd_zign.c"
};

static 
# 97 "project/radare2/libr/core/cmd_zign.c" 3 4
      _Bool 
# 97 "project/radare2/libr/core/cmd_zign.c"
           addGraphZign(RCore *core, const char *name, RList *args) {
 RSignGraph graph = { .cc = -1, .nbbs = -1, .edges = -1, .ebbs = -1, .bbsum = 0 };

 char *ptr;
 RListIter *iter;
 
# 102 "project/radare2/libr/core/cmd_zign.c" 3 4
if (
# 102 "project/radare2/libr/core/cmd_zign.c"
args
# 102 "project/radare2/libr/core/cmd_zign.c" 3 4
) for (
# 102 "project/radare2/libr/core/cmd_zign.c"
...
# 102 "project/radare2/libr/core/cmd_zign.c"
  ...
  if (r_str_startswith (ptr, "cc=")) {
   ...
   return 
# 114 "project/radare2/libr/core/cmd_zign.c" 3 4
         0
# 114 "project/radare2/libr/core/cmd_zign.c"
              ;
  }
 }
...
static inline 
# 120 "project/radare2/libr/core/cmd_zign.c" 3 4
             _Bool 
# 120 "project/radare2/libr/core/cmd_zign.c"
                  za_add(RCore *core, const char *input) {
 char *args = r_str_trim_dup (input + 1);
 if (!args) {
  return 
# 123 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 123 "project/radare2/libr/core/cmd_zign.c"
             ;
 }

 char *name = strtok (args, " ");
 char *stype = strtok (
# 127 "project/radare2/libr/core/cmd_zign.c" 3 4
                      ((void *)0)
# 127 "project/radare2/libr/core/cmd_zign.c"
                          , " ");
 char *sig = strtok (
# 128 "project/radare2/libr/core/cmd_zign.c" 3 4
                    ((void *)0)
# 128 "project/radare2/libr/core/cmd_zign.c"
                        , "");

 if (!stype || !sig || stype[1] != '\0') {
  
# 131 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 131 "project/radare2/libr/core/cmd_zign.c"
 "Invalid input\n"
# 131 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 131 "project/radare2/libr/core/cmd_zign.c"
  ...
  free (args);
  return 
# 133 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 133 "project/radare2/libr/core/cmd_zign.c"
             ;
 }
 char t = *stype;

 RList *lst = 
# 137 "project/radare2/libr/core/cmd_zign.c" 3 4
             ((void *)0)
# 137 "project/radare2/libr/core/cmd_zign.c"
                 ;
 
# 138 "project/radare2/libr/core/cmd_zign.c" 3 4
_Bool 
# 138 "project/radare2/libr/core/cmd_zign.c"
     ret = 
# 138 "project/radare2/libr/core/cmd_zign.c" 3 4
           0
# 138 "project/radare2/libr/core/cmd_zign.c"
...
# 161 "project/radare2/libr/core/cmd_zign.c" 3 4
  unsigned long long 
# 161 "project/radare2/libr/core/cmd_zign.c"
       offset = r_num_get (core->num, sig);
...
# 180 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 180 "project/radare2/libr/core/cmd_zign.c"
 "error: unknown zignature type\n"
# 180 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 180 "project/radare2/libr/core/cmd_zign.c"
                                            ;
...
# 199 "project/radare2/libr/core/cmd_zign.c" 3 4
   fprintf(__stderrp,
# 199 "project/radare2/libr/core/cmd_zign.c"
   "Usage: zaf [fcnname] [zigname]\n"
# 199 "project/radare2/libr/core/cmd_zign.c" 3 4
   )
# 199 "project/radare2/libr/core/cmd_zign.c"
                                               ;
    free (args);
    return 
# 201 "project/radare2/libr/core/cmd_zign.c" 3 4
          0
# 201 "project/radare2/libr/core/cmd_zign.c"
               ;
   }

   RAnalFunction *fcni = 
# 204 "project/radare2/libr/core/cmd_zign.c" 3 4
                        ((void *)0)
# 204 "project/radare2/libr/core/cmd_zign.c"
                            ;
   const char *zigname = (n == 2)? r_str_word_get0 (args, 1): 
# 205 "project/radare2/libr/core/cmd_zign.c" 3 4
                                                             ((void *)0)
# 205 "project/radare2/libr/core/cmd_zign.c"
                                                                 ;
   if (n > 0) {
...
# 217 "project/radare2/libr/core/cmd_zign.c" 3 4
   fprintf(__stderrp,
# 217 "project/radare2/libr/core/cmd_zign.c"
...
# 217 "project/radare2/libr/core/cmd_zign.c"
                                      ;
    return 
# 218 "project/radare2/libr/core/cmd_zign.c" 3 4
          0
# 218 "project/radare2/libr/core/cmd_zign.c"
               ;
   }
  }
  break;
 case 'c':
  r_cons_break_push (
# 223 "project/radare2/libr/core/cmd_zign.c" 3 4
                    ((void *)0)
# 223 "project/radare2/libr/core/cmd_zign.c"
                        , 
# 223 "project/radare2/libr/core/cmd_zign.c" 3 4
                          ((void *)0)
# 223 "project/radare2/libr/core/cmd_zign.c"
...
# 229 "project/radare2/libr/core/cmd_zign.c" 3 4
                                               0
# 229 "project/radare2/libr/core/cmd_zign.c"
                                                    );
  
# 230 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 230 "project/radare2/libr/core/cmd_zign.c"
 "generated zignatures: %d\n", count
# 230 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 230 "project/radare2/libr/core/cmd_zign.c"
                                              ;
 ...
 {
  int count = r_sign_all_functions (core->anal, 
# 235 "project/radare2/libr/core/cmd_zign.c" 3 4
                                               1
# 235 "project/radare2/libr/core/cmd_zign.c"
                                                   );
  
# 236 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 236 "project/radare2/libr/core/cmd_zign.c"
 "generated zignatures: %d\n", count
# 236 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 236 "project/radare2/libr/core/cmd_zign.c"
...
# 276 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 276 "project/radare2/libr/core/cmd_zign.c"
 "Usage: za[fF?] [args]\n"
# 276 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 276 "project/radare2/libr/core/cmd_zign.c"
                                    ;
  return 
# 277 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 277 "project/radare2/libr/core/cmd_zign.c"
             ;
 }

 return 
# 280 "project/radare2/libr/core/cmd_zign.c" 3 4
       1
# 280 "project/radare2/libr/core/cmd_zign.c"
           ;
}
...
# 289 "project/radare2/libr/core/cmd_zign.c" 3 4
                                             0
# 289 "project/radare2/libr/core/cmd_zign.c"
                                                  );
  }
  
# 291 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 291 "project/radare2/libr/core/cmd_zign.c"
 "Usage: zo filename\n"
# 291 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 291 "project/radare2/libr/core/cmd_zign.c"
                                 ;
  return 
# 292 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 292 "project/radare2/libr/core/cmd_zign.c"
             ;
 case 's':
  if (input[1] == ' ' && input[2]) {
...
# 297 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 297 "project/radare2/libr/core/cmd_zign.c"
 "Usage: zos filename\n"
# 297 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 297 "project/radare2/libr/core/cmd_zign.c"
                                  ;
  return 
# 298 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 298 "project/radare2/libr/core/cmd_zign.c"
             ;
 case 'z':
  if (input[1] == ' ' && input[2]) {
   return r_sign_load_gz (core->anal, input + 2, 
# 301 "project/radare2/libr/core/cmd_zign.c" 3 4
                                                0
# 301 "project/radare2/libr/core/cmd_zign.c"
                                                     );
  }
  
# 303 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 303 "project/radare2/libr/core/cmd_zign.c"
 "Usage: zoz filename\n"
# 303 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 303 "project/radare2/libr/core/cmd_zign.c"
                                  ;
  return 
# 304 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 304 "project/radare2/libr/core/cmd_zign.c"
             ;
 case '?':
...
# 309 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 309 "project/radare2/libr/core/cmd_zign.c"
 "Usage: zo[zs] filename\n"
# 309 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 309 "project/radare2/libr/core/cmd_zign.c"
                                     ;
  return 
# 310 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 310 "project/radare2/libr/core/cmd_zign.c"
             ;
 }

 return 
# 313 "project/radare2/libr/core/cmd_zign.c" 3 4
       1
# 313 "project/radare2/libr/core/cmd_zign.c"
           ;
}
...
# 323 "project/radare2/libr/core/cmd_zign.c" 3 4
  fprintf(__stderrp,
# 323 "project/radare2/libr/core/cmd_zign.c"
  "Usage: zs+zignspace\n"
# 323 "project/radare2/libr/core/cmd_zign.c" 3 4
  )
# 323 "project/radare2/libr/core/cmd_zign.c"
                                   ;
   return 
# 324 "project/radare2/libr/core/cmd_zign.c" 3 4
         0
# 324 "project/radare2/libr/core/cmd_zign.c"
              ;
  }
...
# 334 "project/radare2/libr/core/cmd_zign.c" 3 4
  fprintf(__stderrp,
# 334 "project/radare2/libr/core/cmd_zign.c"
  "Usage: zsr newname\n"
# 334 "project/radare2/libr/core/cmd_zign.c" 3 4
  )
# 334 "project/radare2/libr/core/cmd_zign.c"
                                  ;
   return 
# 335 "project/radare2/libr/core/cmd_zign.c" 3 4
         0
# 335 "project/radare2/libr/core/cmd_zign.c"
              ;
  }
  r_spaces_rename (zs, 
# 337 "project/radare2/libr/core/cmd_zign.c" 3 4
                      ((void *)0)
# 337 "project/radare2/libr/core/cmd_zign.c"
                          , input + 2);
  break;
 case '-':
  if (input[1] == '\x00') {
   ...
   r_spaces_unset (zs, 
# 343 "project/radare2/libr/core/cmd_zign.c" 3 4
                      ((void *)0)
# 343 "project/radare2/libr/core/cmd_zign.c"
                          );
  } else {
...
# 355 "project/radare2/libr/core/cmd_zign.c" 3 4
  fprintf(__stderrp,
# 355 "project/radare2/libr/core/cmd_zign.c"
  "Usage: zs zignspace\n"
# 355 "project/radare2/libr/core/cmd_zign.c" 3 4
  )
# 355 "project/radare2/libr/core/cmd_zign.c"
                                   ;
   return 
# 356 "project/radare2/libr/core/cmd_zign.c" 3 4
         0
# 356 "project/radare2/libr/core/cmd_zign.c"
              ;
  }
...
# 364 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 364 "project/radare2/libr/core/cmd_zign.c"
 "Usage: zs[+-*] [namespace]\n"
# 364 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 364 "project/radare2/libr/core/cmd_zign.c"
                                         ;
  return 
# 365 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 365 "project/radare2/libr/core/cmd_zign.c"
             ;
 }

 return 
# 368 "project/radare2/libr/core/cmd_zign.c" 3 4
       1
# 368 "project/radare2/libr/core/cmd_zign.c"
           ;
}
...
# 378 "project/radare2/libr/core/cmd_zign.c" 3 4
  fprintf(__stderrp,
# 378 "project/radare2/libr/core/cmd_zign.c"
  "Usage: zfd filename\n"
# 378 "project/radare2/libr/core/cmd_zign.c" 3 4
  )
# 378 "project/radare2/libr/core/cmd_zign.c"
                                   ;
   return 
# 379 "project/radare2/libr/core/cmd_zign.c" 3 4
         0
# 379 "project/radare2/libr/core/cmd_zign.c"
              ;
  }
...
# 386 "project/radare2/libr/core/cmd_zign.c" 3 4
  fprintf(__stderrp,
# 386 "project/radare2/libr/core/cmd_zign.c"
  "Usage: zfs filename\n"
# 386 "project/radare2/libr/core/cmd_zign.c" 3 4
  )
# 386 "project/radare2/libr/core/cmd_zign.c"
                                   ;
   return 
# 387 "project/radare2/libr/core/cmd_zign.c" 3 4
         0
# 387 "project/radare2/libr/core/cmd_zign.c"
              ;
  }
...
# 393 "project/radare2/libr/core/cmd_zign.c" 3 4
 if (
# 393 "project/radare2/libr/core/cmd_zign.c"
 files
# 393 "project/radare2/libr/core/cmd_zign.c" 3 4
 ) for (
# 393 "project/radare2/libr/core/cmd_zign.c"
...
# 405 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 405 "project/radare2/libr/core/cmd_zign.c"
 "Usage: zf[dsz] filename\n"
# 405 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 405 "project/radare2/libr/core/cmd_zign.c"
                                      ;
  return 
# 406 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 406 "project/radare2/libr/core/cmd_zign.c"
             ;
 }
 return 
# 408 "project/radare2/libr/core/cmd_zign.c" 3 4
       1
# 408 "project/radare2/libr/core/cmd_zign.c"
           ;
}
...
# 413 "project/radare2/libr/core/cmd_zign.c" 3 4
_Bool 
# 413 "project/radare2/libr/core/cmd_zign.c"
     bytes_only;
 
# 414 "project/radare2/libr/core/cmd_zign.c" 3 4
_Bool 
# 414 "project/radare2/libr/core/cmd_zign.c"
     rad;
 int collisions;
 int newfuncs;
 int count;
...
static void apply_name(RCore *core, RAnalFunction *fcn, RSignItem *it, 
# 427 "project/radare2/libr/core/cmd_zign.c" 3 4
                                                                      _Bool 
# 427 "project/radare2/libr/core/cmd_zign.c"
                                                                           rad) {
 
# 428 "project/radare2/libr/core/cmd_zign.c" 3 4
do { if (!(
# 428 "project/radare2/libr/core/cmd_zign.c"
core && fcn && it && it->name
# 428 "project/radare2/libr/core/cmd_zign.c" 3 4
...
# 428 "project/radare2/libr/core/cmd_zign.c"
 ...
 if (rad) {
  ...
  if (tmp) {
   r_cons_printf ("\"afn %s @ 0x%08" 
# 433 "project/radare2/libr/core/cmd_zign.c" 3 4
                                    "llx" 
# 433 "project/radare2/libr/core/cmd_zign.c"
                                            "\"\n", tmp, fcn->addr);
   free (tmp);
  }
  return;
 ...
 if (flag && flag->space && strcmp (flag->space->name, 
# 439 "project/radare2/libr/core/cmd_zign.c" 3 4
                                                      "functions"
# 439 "project/radare2/libr/core/cmd_zign.c"
                                                                          )) {
...
static void apply_flag(RCore *core, RSignItem *it, 
# 448 "project/radare2/libr/core/cmd_zign.c" 3 4
                                                  unsigned long long 
# 448 "project/radare2/libr/core/cmd_zign.c"
                                                       addr, int size, int count, const char *prefix, 
# 448 "project/radare2/libr/core/cmd_zign.c" 3 4
                                                                                                      _Bool 
# 448 "project/radare2/libr/core/cmd_zign.c"
                                                                                                           rad) {
 ...
 if (name) {
  if (rad) {
   char *tmp = r_name_filter2 (name);
   if (tmp) {
    r_cons_printf ("f %s %d @ 0x%08" 
# 455 "project/radare2/libr/core/cmd_zign.c" 3 4
                                    "llx" 
# 455 "project/radare2/libr/core/cmd_zign.c"
                                            "\n", tmp, size, addr);
    free (tmp);
   }
  } else {
...
static int searchBytesHitCB(RSignItem *it, RSearchKeyword *kw, 
# 465 "project/radare2/libr/core/cmd_zign.c" 3 4
                                                              unsigned long long 
# 465 "project/radare2/libr/core/cmd_zign.c"
                                                                   addr, void *user) {
 struct ctxSearchCB *ctx = (struct ctxSearchCB *)user;
 RAnalFunction *fcn = r_anal_get_fcn_in (ctx->core->anal, addr, 0);
 if (!fcn) {
  RCore *c = ctx->core;
  r_core_af (c, c->offset, 
# 470 "project/radare2/libr/core/cmd_zign.c" 3 4
                          ((void *)0)
# 470 "project/radare2/libr/core/cmd_zign.c"
                              , 
# 470 "project/radare2/libr/core/cmd_zign.c" 3 4
                                0
# 470 "project/radare2/libr/core/cmd_zign.c"
 ...
 if (ctx->bytes_only) {
  if (fcn) {
   char *tmp = 
# 478 "project/radare2/libr/core/cmd_zign.c" 3 4
              ((void *)0)
# 478 "project/radare2/libr/core/cmd_zign.c"
                  ;
   apply_name (ctx->core, fcn, it, ctx->rad);
   if (it->types && (tmp = r_str_newf ("%s;", it->types))) {
...
# 494 "project/radare2/libr/core/cmd_zign.c" 3 4
do { if (!(
# 494 "project/radare2/libr/core/cmd_zign.c"
types && *types != R_SIGN_END
# 494 "project/radare2/libr/core/cmd_zign.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 494 "project/radare2/libr/core/cmd_zign.c"
"types && *types != R_SIGN_END"
...
# 496 "project/radare2/libr/core/cmd_zign.c" 3 4
unsigned long long 
# 496 "project/radare2/libr/core/cmd_zign.c"
     sz = r_anal_function_realsize (fcn);
 RSignType t;
 
# 498 "project/radare2/libr/core/cmd_zign.c" 3 4
_Bool 
# 498 "project/radare2/libr/core/cmd_zign.c"
     collides = 
# 498 "project/radare2/libr/core/cmd_zign.c" 3 4
                0
# 498 "project/radare2/libr/core/cmd_zign.c"
                     ;
 if (!col || !
# 499 "project/radare2/libr/core/cmd_zign.c" 3 4
             (!(
# 499 "project/radare2/libr/core/cmd_zign.c"
             col
# 499 "project/radare2/libr/core/cmd_zign.c" 3 4
             ) || !(
# 499 "project/radare2/libr/core/cmd_zign.c"
...
# 499 "project/radare2/libr/core/cmd_zign.c"
  ...
  collides = 
# 501 "project/radare2/libr/core/cmd_zign.c" 3 4
            1
# 501 "project/radare2/libr/core/cmd_zign.c"
                ;
  ctx->collisions++;
 }
 int i = 0;
 while ((t = types[i++]) != R_SIGN_END) {
  const char *prefix = 
# 506 "project/radare2/libr/core/cmd_zign.c" 3 4
                      ((void *)0)
# 506 "project/radare2/libr/core/cmd_zign.c"
                          ;
  switch (t) {
  case R_SIGN_BYTES:
   ctx->bytes_count++;
...
# 537 "project/radare2/libr/core/cmd_zign.c" 3 4
  do { r_assert_log (R_LOGLVL_WARN, "(%s:%d):%s%s code should not be reached\n", "project/radare2/libr/core/cmd_zign.c", 537, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : ""); } while (0)
# 537 "project/radare2/libr/core/cmd_zign.c"
                      ;
   break;
  }
  if (prefix) {
   char *tmp = 
# 541 "project/radare2/libr/core/cmd_zign.c" 3 4
              ((void *)0)
# 541 "project/radare2/libr/core/cmd_zign.c"
                  ;
 ...
 if (!collides) {
  char *tmp = 
# 553 "project/radare2/libr/core/cmd_zign.c" 3 4
             ((void *)0)
# 553 "project/radare2/libr/core/cmd_zign.c"
                 ;
  apply_name (ctx->core, fcn, it, ctx->rad);
  if (it->types && (tmp = r_str_newf ("%s;", it->types))) {
   r_anal_str_to_fcn (ctx->core->anal, fcn, tmp);
...
static 
# 566 "project/radare2/libr/core/cmd_zign.c" 3 4
      _Bool 
# 566 "project/radare2/libr/core/cmd_zign.c"
           searchRange(RCore *core, 
# 566 "project/radare2/libr/core/cmd_zign.c" 3 4
                                    unsigned long long 
# 566 "project/radare2/libr/core/cmd_zign.c"
                                         from, 
...
# 566 "project/radare2/libr/core/cmd_zign.c" 3 4
                                                        _Bool 
# 566 "project/radare2/libr/core/cmd_zign.c"
                                                             rad, struct ctxSearchCB *ctx) {
 
# 567 "project/radare2/libr/core/cmd_zign.c" 3 4
unsigned char 
# 567 "project/radare2/libr/core/cmd_zign.c"
    *buf = malloc (core->blocksize);
 
# 568 "project/radare2/libr/core/cmd_zign.c" 3 4
unsigned long long 
# 568 "project/radare2/libr/core/cmd_zign.c"
     at;
 int rlen;
 
# 570 "project/radare2/libr/core/cmd_zign.c" 3 4
_Bool 
# 570 "project/radare2/libr/core/cmd_zign.c"
     retval = 
# 570 "project/radare2/libr/core/cmd_zign.c" 3 4
              1
# 570 "project/radare2/libr/core/cmd_zign.c"
 ...
 if (!buf) {
  return 
# 574 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 574 "project/radare2/libr/core/cmd_zign.c"
             ;
 }
 ...
 r_cons_break_push (
# 580 "project/radare2/libr/core/cmd_zign.c" 3 4
                   ((void *)0)
# 580 "project/radare2/libr/core/cmd_zign.c"
                       , 
# 580 "project/radare2/libr/core/cmd_zign.c" 3 4
                         ((void *)0)
# 580 "project/radare2/libr/core/cmd_zign.c"
 ...
 for (at = from; at < to; at += core->blocksize) {
  if (r_cons_is_breaked ()) {
   retval = 
# 583 "project/radare2/libr/core/cmd_zign.c" 3 4
           0
# 583 "project/radare2/libr/core/cmd_zign.c"
                ;
   break;
  }
  rlen = 
# 586 "project/radare2/libr/core/cmd_zign.c" 3 4
        (((
# 586 "project/radare2/libr/core/cmd_zign.c"
        core->blocksize
# 586 "project/radare2/libr/core/cmd_zign.c" 3 4
        )>(
# 586 "project/radare2/libr/core/cmd_zign.c"
...
# 586 "project/radare2/libr/core/cmd_zign.c"
  ...
  if (!r_io_is_valid_offset (core->io, at, 0)) {
   retval = 
# 588 "project/radare2/libr/core/cmd_zign.c" 3 4
           0
# 588 "project/radare2/libr/core/cmd_zign.c"
                ;
   break;
  }
...
# 593 "project/radare2/libr/core/cmd_zign.c" 3 4
  fprintf(__stderrp,
# 593 "project/radare2/libr/core/cmd_zign.c"
...
# 593 "project/radare2/libr/core/cmd_zign.c"
                                                                 ;
   retval = 
# 594 "project/radare2/libr/core/cmd_zign.c" 3 4
           0
# 594 "project/radare2/libr/core/cmd_zign.c"
                ;
   break;
  }
 }
...
# 607 "project/radare2/libr/core/cmd_zign.c" 3 4
do { if (!(
# 607 "project/radare2/libr/core/cmd_zign.c"
count < sizeof (sm->stypes) / sizeof (RSignType) - 1
# 607 "project/radare2/libr/core/cmd_zign.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 607 "project/radare2/libr/core/cmd_zign.c"
"count < sizeof (sm->stypes) / sizeof (RSignType) - 1"
...
static 
# 615 "project/radare2/libr/core/cmd_zign.c" 3 4
      _Bool 
# 615 "project/radare2/libr/core/cmd_zign.c"
           fill_search_metrics(RSignSearchMetrics *sm, RCore *c, void *user) {
 unsigned int i = 0;
...
# 639 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 639 "project/radare2/libr/core/cmd_zign.c"
 "New functions:  %d\n", ctx->newfuncs
# 639 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 639 "project/radare2/libr/core/cmd_zign.c"
...
# 642 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 642 "project/radare2/libr/core/cmd_zign.c"
 "collisions:  %d\n", ctx->collisions
# 642 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 642 "project/radare2/libr/core/cmd_zign.c"
...
# 645 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 645 "project/radare2/libr/core/cmd_zign.c"
 "bytes:  %d\n", ctx->bytes_count
# 645 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 645 "project/radare2/libr/core/cmd_zign.c"
...
# 649 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 649 "project/radare2/libr/core/cmd_zign.c"
 "graph:  %d\n", ctx->graph_count
# 649 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 649 "project/radare2/libr/core/cmd_zign.c"
...
# 653 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 653 "project/radare2/libr/core/cmd_zign.c"
 "offset: %d\n", ctx->offset_count
# 653 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 653 "project/radare2/libr/core/cmd_zign.c"
...
# 657 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 657 "project/radare2/libr/core/cmd_zign.c"
 "refs:   %d\n", ctx->refs_count
# 657 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 657 "project/radare2/libr/core/cmd_zign.c"
...
# 661 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 661 "project/radare2/libr/core/cmd_zign.c"
 "types:  %d\n", ctx->types_count
# 661 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 661 "project/radare2/libr/core/cmd_zign.c"
...
# 665 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 665 "project/radare2/libr/core/cmd_zign.c"
 "bbhash: %d\n", ctx->bbhash_count
# 665 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 665 "project/radare2/libr/core/cmd_zign.c"
...
# 669 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 669 "project/radare2/libr/core/cmd_zign.c"
 "next: %d\n", ctx->next_count
# 669 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 669 "project/radare2/libr/core/cmd_zign.c"
...
# 673 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 673 "project/radare2/libr/core/cmd_zign.c"
 "total:  %d\n", ctx->count
# 673 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 673 "project/radare2/libr/core/cmd_zign.c"
...
static 
# 677 "project/radare2/libr/core/cmd_zign.c" 3 4
      _Bool 
# 677 "project/radare2/libr/core/cmd_zign.c"
           search(RCore *core, 
# 677 "project/radare2/libr/core/cmd_zign.c" 3 4
                               _Bool 
# 677 "project/radare2/libr/core/cmd_zign.c"
...
# 683 "project/radare2/libr/core/cmd_zign.c" 3 4
  fprintf(__stderrp,
# 683 "project/radare2/libr/core/cmd_zign.c"
  "error: cannot create flagspace\n"
# 683 "project/radare2/libr/core/cmd_zign.c" 3 4
  )
# 683 "project/radare2/libr/core/cmd_zign.c"
                                              ;
   return 
# 684 "project/radare2/libr/core/cmd_zign.c" 3 4
         0
# 684 "project/radare2/libr/core/cmd_zign.c"
              ;
  }
 }
...
# 689 "project/radare2/libr/core/cmd_zign.c" 3 4
__builtin___memset_chk (
# 689 "project/radare2/libr/core/cmd_zign.c"
&ctx
# 689 "project/radare2/libr/core/cmd_zign.c" 3 4
, 
# 689 "project/radare2/libr/core/cmd_zign.c"
0, sizeof (struct ctxSearchCB)
# 689 "project/radare2/libr/core/cmd_zign.c" 3 4
...
# 694 "project/radare2/libr/core/cmd_zign.c" 3 4
_Bool 
# 694 "project/radare2/libr/core/cmd_zign.c"
     metsearch = fill_search_metrics (&sm, core, (void *)&ctx);
 if (!metsearch) {
  
# 696 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 696 "project/radare2/libr/core/cmd_zign.c"
 "No zign types enabled\n"
# 696 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 696 "project/radare2/libr/core/cmd_zign.c"
                                    ;
  return 
# 697 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 697 "project/radare2/libr/core/cmd_zign.c"
             ;
 }
 if (sm.stypes[0] == R_SIGN_BYTES && sm.stypes[1] == R_SIGN_END) {
  ctx.bytes_only = 
# 700 "project/radare2/libr/core/cmd_zign.c" 3 4
                  1
# 700 "project/radare2/libr/core/cmd_zign.c"
                      ;
 }
 ...
 if (r_config_get_i (core->config, "zign.bytes") && !only_func) {
  ...
  if (!list) {
   return 
# 708 "project/radare2/libr/core/cmd_zign.c" 3 4
         0
# 708 "project/radare2/libr/core/cmd_zign.c"
              ;
  }
  RListIter *iter;
  RIOMap *map;
  
# 712 "project/radare2/libr/core/cmd_zign.c" 3 4
 if (
# 712 "project/radare2/libr/core/cmd_zign.c"
 list
# 712 "project/radare2/libr/core/cmd_zign.c" 3 4
 ) for (
# 712 "project/radare2/libr/core/cmd_zign.c"
...
# 713 "project/radare2/libr/core/cmd_zign.c" 3 4
  fprintf(__stderrp,
# 713 "project/radare2/libr/core/cmd_zign.c"
  "[+] searching 0x%08"
# 713 "project/radare2/libr/core/cmd_zign.c" 3 4
  "llx"
# 713 "project/radare2/libr/core/cmd_zign.c"
...
# 713 "project/radare2/libr/core/cmd_zign.c"
                                                                                                       ;
   searchRange (core, 
# 714 "project/radare2/libr/core/cmd_zign.c" 3 4
                     r_itv_begin (
# 714 "project/radare2/libr/core/cmd_zign.c"
                     map
# 714 "project/radare2/libr/core/cmd_zign.c" 3 4
                     ->itv)
# 714 "project/radare2/libr/core/cmd_zign.c"
...
# 721 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 721 "project/radare2/libr/core/cmd_zign.c"
...
# 729 "project/radare2/libr/core/cmd_zign.c" 3 4
  fprintf(__stderrp,
# 729 "project/radare2/libr/core/cmd_zign.c"
  "error: cannot restore flagspace\n"
# 729 "project/radare2/libr/core/cmd_zign.c" 3 4
  )
# 729 "project/radare2/libr/core/cmd_zign.c"
                                               ;
   return 
# 730 "project/radare2/libr/core/cmd_zign.c" 3 4
         0
# 730 "project/radare2/libr/core/cmd_zign.c"
              ;
  }
 }
 print_ctx_hits (&ctx);
 return ctx.count > 0? 
# 734 "project/radare2/libr/core/cmd_zign.c" 3 4
                      1
# 734 "project/radare2/libr/core/cmd_zign.c"
                          : 
# 734 "project/radare2/libr/core/cmd_zign.c" 3 4
                            0
# 734 "project/radare2/libr/core/cmd_zign.c"
...
# 737 "project/radare2/libr/core/cmd_zign.c" 3 4
                                               _Bool 
# 737 "project/radare2/libr/core/cmd_zign.c"
                                                    json, RCore *core) {
 RListIter *itr;
 RSignCloseMatch *row;
 if (json) {
...
# 743 "project/radare2/libr/core/cmd_zign.c" 3 4
 if (
# 743 "project/radare2/libr/core/cmd_zign.c"
 list
# 743 "project/radare2/libr/core/cmd_zign.c" 3 4
 ) for (
# 743 "project/radare2/libr/core/cmd_zign.c"
...
# 755 "project/radare2/libr/core/cmd_zign.c" 3 4
 if (
# 755 "project/radare2/libr/core/cmd_zign.c"
 list
# 755 "project/radare2/libr/core/cmd_zign.c" 3 4
 ) for (
# 755 "project/radare2/libr/core/cmd_zign.c"
...
static RSignItem *item_frm_signame(RAnal *a, const char *signame) {
 ...
 char *value = sdb_querys (a->sdb_zigns, 
# 775 "project/radare2/libr/core/cmd_zign.c" 3 4
                                        ((void *)0)
# 775 "project/radare2/libr/core/cmd_zign.c"
                                            , 0, k);
 if (!value) {
  free (k);
  return 
# 778 "project/radare2/libr/core/cmd_zign.c" 3 4
        ((void *)0)
# 778 "project/radare2/libr/core/cmd_zign.c"
            ;
 }
 ...
 if (!it) {
  ...
  free (value);
  return 
# 785 "project/radare2/libr/core/cmd_zign.c" 3 4
        ((void *)0)
# 785 "project/radare2/libr/core/cmd_zign.c"
            ;
 }
 ...
 if (!r_sign_deserialize (a, it, k, value)) {
  r_sign_item_free (it);
  it = 
# 790 "project/radare2/libr/core/cmd_zign.c" 3 4
      ((void *)0)
# 790 "project/radare2/libr/core/cmd_zign.c"
          ;
 }
 free (k);
 free (value);
...
static double get_zb_threshold(RCore *core) {
 ...
 double thresh = r_num_get_float (
# 799 "project/radare2/libr/core/cmd_zign.c" 3 4
                                 ((void *)0)
# 799 "project/radare2/libr/core/cmd_zign.c"
                                     , th);
 if (thresh < 0.0 || thresh > 1.0) {
  
# 801 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 801 "project/radare2/libr/core/cmd_zign.c"
 "Invalid zign.threshold %s, using 0.0\n", th
# 801 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 801 "project/radare2/libr/core/cmd_zign.c"
                                                       ;
...
static 
# 807 "project/radare2/libr/core/cmd_zign.c" 3 4
      _Bool 
# 807 "project/radare2/libr/core/cmd_zign.c"
           bestmatch_fcn(RCore *core, const char *input, 
# 807 "project/radare2/libr/core/cmd_zign.c" 3 4
                                                         _Bool 
# 807 "project/radare2/libr/core/cmd_zign.c"
                                                              json) {
 
# 808 "project/radare2/libr/core/cmd_zign.c" 3 4
do { if (!(
# 808 "project/radare2/libr/core/cmd_zign.c"
input && core
# 808 "project/radare2/libr/core/cmd_zign.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 808 "project/radare2/libr/core/cmd_zign.c"
...
# 808 "project/radare2/libr/core/cmd_zign.c"
 ...
 if (!argv) {
  return 
# 812 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 812 "project/radare2/libr/core/cmd_zign.c"
             ;
 }
...
# 818 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 818 "project/radare2/libr/core/cmd_zign.c"
 "Need a signature\n"
# 818 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 818 "project/radare2/libr/core/cmd_zign.c"
  ...
  free (argv);
  return 
# 820 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 820 "project/radare2/libr/core/cmd_zign.c"
             ;
 }
 char *cs = strtok (
# 822 "project/radare2/libr/core/cmd_zign.c" 3 4
                   ((void *)0)
# 822 "project/radare2/libr/core/cmd_zign.c"
                       , " ");
 if (cs) {
  if ((count = atoi (cs)) <= 0) {
   free (argv);
   
# 826 "project/radare2/libr/core/cmd_zign.c" 3 4
  fprintf(__stderrp,
# 826 "project/radare2/libr/core/cmd_zign.c"
  "Invalid count\n"
# 826 "project/radare2/libr/core/cmd_zign.c" 3 4
  )
# 826 "project/radare2/libr/core/cmd_zign.c"
                             ;
   return 
# 827 "project/radare2/libr/core/cmd_zign.c" 3 4
         0
# 827 "project/radare2/libr/core/cmd_zign.c"
              ;
  }
  if (strtok (
# 829 "project/radare2/libr/core/cmd_zign.c" 3 4
             ((void *)0)
# 829 "project/radare2/libr/core/cmd_zign.c"
                 , " ")) {
   free (argv);
   
# 831 "project/radare2/libr/core/cmd_zign.c" 3 4
  fprintf(__stderrp,
# 831 "project/radare2/libr/core/cmd_zign.c"
  "Too many parameters\n"
# 831 "project/radare2/libr/core/cmd_zign.c" 3 4
  )
# 831 "project/radare2/libr/core/cmd_zign.c"
                                   ;
   return 
# 832 "project/radare2/libr/core/cmd_zign.c" 3 4
         0
# 832 "project/radare2/libr/core/cmd_zign.c"
              ;
  }
 }
...
# 837 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 837 "project/radare2/libr/core/cmd_zign.c"
 "Couldn't get signature for %s\n", zigname
# 837 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 837 "project/radare2/libr/core/cmd_zign.c"
                                                     ;
  free (argv);
  return 
# 839 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 839 "project/radare2/libr/core/cmd_zign.c"
             ;
 }
 free (argv);
 ...
 if (!r_config_get_i (core->config, "zign.bytes")) {
  ...
  it->bytes = 
# 845 "project/radare2/libr/core/cmd_zign.c" 3 4
             ((void *)0)
# 845 "project/radare2/libr/core/cmd_zign.c"
                 ;
 }
 if (!r_config_get_i (core->config, "zign.graph")) {
  r_sign_graph_free (it->graph);
  it->graph = 
# 849 "project/radare2/libr/core/cmd_zign.c" 3 4
             ((void *)0)
# 849 "project/radare2/libr/core/cmd_zign.c"
                 ;
 }
 ...
 if (list) {
  ...
  r_list_free (list);
  return 
# 859 "project/radare2/libr/core/cmd_zign.c" 3 4
        1
# 859 "project/radare2/libr/core/cmd_zign.c"
            ;
 }
 return 
# 861 "project/radare2/libr/core/cmd_zign.c" 3 4
       0
# 861 "project/radare2/libr/core/cmd_zign.c"
            ;
}

static 
# 864 "project/radare2/libr/core/cmd_zign.c" 3 4
      _Bool 
# 864 "project/radare2/libr/core/cmd_zign.c"
           bestmatch_sig(RCore *core, const char *input, 
# 864 "project/radare2/libr/core/cmd_zign.c" 3 4
                                                         _Bool 
# 864 "project/radare2/libr/core/cmd_zign.c"
                                                              json) {
 
# 865 "project/radare2/libr/core/cmd_zign.c" 3 4
do { if (!(
# 865 "project/radare2/libr/core/cmd_zign.c"
input && core
# 865 "project/radare2/libr/core/cmd_zign.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 865 "project/radare2/libr/core/cmd_zign.c"
"input && core"
# 865 "project/radare2/libr/core/cmd_zign.c" 3 4
, 865); return (0); } } while (0)
# 865 "project/radare2/libr/core/cmd_zign.c"
                                           ;
 int count = 5;
 if (!
# 867 "project/radare2/libr/core/cmd_zign.c" 3 4
     (!(
# 867 "project/radare2/libr/core/cmd_zign.c"
     input
# 867 "project/radare2/libr/core/cmd_zign.c" 3 4
     ) || !*(
# 867 "project/radare2/libr/core/cmd_zign.c"
...
# 870 "project/radare2/libr/core/cmd_zign.c" 3 4
  fprintf(__stderrp,
# 870 "project/radare2/libr/core/cmd_zign.c"
  "[!!] invalid number %s\n", input
# 870 "project/radare2/libr/core/cmd_zign.c" 3 4
  )
# 870 "project/radare2/libr/core/cmd_zign.c"
                                             ;
   return 
# 871 "project/radare2/libr/core/cmd_zign.c" 3 4
         0
# 871 "project/radare2/libr/core/cmd_zign.c"
              ;
  }
 }
...
# 877 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 877 "project/radare2/libr/core/cmd_zign.c"
 "No function at 0x%08" 
# 877 "project/radare2/libr/core/cmd_zign.c" 3 4
 "llx" 
# 877 "project/radare2/libr/core/cmd_zign.c"
 "\n", core->offset
...
# 877 "project/radare2/libr/core/cmd_zign.c"
                                                            ;
  return 
# 878 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 878 "project/radare2/libr/core/cmd_zign.c"
             ;
 }
 ...
 if (!item) {
  return 
# 883 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 883 "project/radare2/libr/core/cmd_zign.c"
             ;
 }
...
# 891 "project/radare2/libr/core/cmd_zign.c" 3 4
  fprintf(__stderrp,
# 891 "project/radare2/libr/core/cmd_zign.c"
  "Warning: Function signature is too small (%d < %d) See e zign.minsz \n", b->size, minsz
# 891 "project/radare2/libr/core/cmd_zign.c" 3 4
  )
# 891 "project/radare2/libr/core/cmd_zign.c"
                                                                                                    ;
...
# 899 "project/radare2/libr/core/cmd_zign.c" 3 4
_Bool 
# 899 "project/radare2/libr/core/cmd_zign.c"
     found = 
# 899 "project/radare2/libr/core/cmd_zign.c" 3 4
             0
# 899 "project/radare2/libr/core/cmd_zign.c"
 ...
 if (item->graph || item->bytes) {
  r_cons_break_push (
# 901 "project/radare2/libr/core/cmd_zign.c" 3 4
                    ((void *)0)
# 901 "project/radare2/libr/core/cmd_zign.c"
                        , 
# 901 "project/radare2/libr/core/cmd_zign.c" 3 4
                          ((void *)0)
# 901 "project/radare2/libr/core/cmd_zign.c"
  ...
  if (list) {
   found = 
# 904 "project/radare2/libr/core/cmd_zign.c" 3 4
          1
# 904 "project/radare2/libr/core/cmd_zign.c"
              ;
   print_possible_matches (list, json, core);
   r_list_free (list);
  }
...
# 910 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 910 "project/radare2/libr/core/cmd_zign.c"
 "Warning: no signatures types available for testing\n"
# 910 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 910 "project/radare2/libr/core/cmd_zign.c"
                                                                 ;
...
static 
# 917 "project/radare2/libr/core/cmd_zign.c" 3 4
      _Bool 
# 917 "project/radare2/libr/core/cmd_zign.c"
           bestmatch(void *data, const char *input) {
 
# 918 "project/radare2/libr/core/cmd_zign.c" 3 4
do { if (!(
# 918 "project/radare2/libr/core/cmd_zign.c"
data && input
# 918 "project/radare2/libr/core/cmd_zign.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 918 "project/radare2/libr/core/cmd_zign.c"
"data && input"
# 918 "project/radare2/libr/core/cmd_zign.c" 3 4
, 918); return (0); } } while (0)
# 918 "project/radare2/libr/core/cmd_zign.c"
                                           ;
 
# 919 "project/radare2/libr/core/cmd_zign.c" 3 4
_Bool 
# 919 "project/radare2/libr/core/cmd_zign.c"
     json = 
# 919 "project/radare2/libr/core/cmd_zign.c" 3 4
            0
# 919 "project/radare2/libr/core/cmd_zign.c"
 ...
 case 'r':
  ...
  if (*input == 'j') {
   input++;
   json = 
# 926 "project/radare2/libr/core/cmd_zign.c" 3 4
         1
# 926 "project/radare2/libr/core/cmd_zign.c"
             ;
  }
  return bestmatch_fcn (core, input, json);
 case 'j':
  json = 
# 930 "project/radare2/libr/core/cmd_zign.c" 3 4
        1
# 930 "project/radare2/libr/core/cmd_zign.c"
            ;
 ...
 default:
  ...
  return 
# 940 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 940 "project/radare2/libr/core/cmd_zign.c"
             ;
 }
}

static 
# 944 "project/radare2/libr/core/cmd_zign.c" 3 4
      _Bool 
# 944 "project/radare2/libr/core/cmd_zign.c"
           _sig_bytediff_cb(RLevBuf *va, RLevBuf *vb, 
# 944 "project/radare2/libr/core/cmd_zign.c" 3 4
                                                      unsigned int 
# 944 "project/radare2/libr/core/cmd_zign.c"
                                                           ia, 
...
# 944 "project/radare2/libr/core/cmd_zign.c"
 ...
 if ((a->bytes[ia] & a->mask[ia]) == (b->bytes[ib] & b->mask[ib])) {
  return 
# 949 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 949 "project/radare2/libr/core/cmd_zign.c"
             ;
 }
 return 
# 951 "project/radare2/libr/core/cmd_zign.c" 3 4
       1
# 951 "project/radare2/libr/core/cmd_zign.c"
           ;
}
# 971 "project/radare2/libr/core/cmd_zign.c"
static void print_zig_diff(RCore *c, RSignBytes *ab, RSignBytes *bb, RLevOp *ops) {
 struct lines {
  char *mask, *bytes, *land;
 } al, bl;
 
# 975 "project/radare2/libr/core/cmd_zign.c" 3 4
__builtin___memset_chk (
# 975 "project/radare2/libr/core/cmd_zign.c"
&al
# 975 "project/radare2/libr/core/cmd_zign.c" 3 4
, 
# 975 "project/radare2/libr/core/cmd_zign.c"
...
# 976 "project/radare2/libr/core/cmd_zign.c" 3 4
__builtin___memset_chk (
# 976 "project/radare2/libr/core/cmd_zign.c"
&bl
# 976 "project/radare2/libr/core/cmd_zign.c" 3 4
, 
# 976 "project/radare2/libr/core/cmd_zign.c"
...
# 976 "project/radare2/libr/core/cmd_zign.c"
 ...
 colsub = coladd = coldel = 
# 979 "project/radare2/libr/core/cmd_zign.c" 3 4
                           ((void *)0)
# 979 "project/radare2/libr/core/cmd_zign.c"
                               ;
...
# 988 "project/radare2/libr/core/cmd_zign.c" 3 4
_Bool 
# 988 "project/radare2/libr/core/cmd_zign.c"
     printb = 
# 988 "project/radare2/libr/core/cmd_zign.c" 3 4
              0
# 988 "project/radare2/libr/core/cmd_zign.c"
 ...
 for (i = 0; ops[i] != LEVEND; i++) {
  ...
  case LEVNOP:
   ...
   if (!printb && (ab->bytes[ia] != bb->bytes[ib] || ab->mask[ia] != bb->mask[ib])) {
    printb = 
# 994 "project/radare2/libr/core/cmd_zign.c" 3 4
            1
# 994 "project/radare2/libr/core/cmd_zign.c"
                ;
   }
   al.bytes = r_str_appendf (al.bytes, " %s%s%02x%s", r_str_get ((const char *)
# 996 "project/radare2/libr/core/cmd_zign.c" 3 4
  ((void *)0)
# 996 "project/radare2/libr/core/cmd_zign.c"
  ), r_str_get (" "), ab->bytes[ia], (const char *)
# 996 "project/radare2/libr/core/cmd_zign.c" 3 4
  ((void *)0)
# 996 "project/radare2/libr/core/cmd_zign.c"
  ? 
# 996 "project/radare2/libr/core/cmd_zign.c" 3 4
  "\x1b[0m"
# 996 "project/radare2/libr/core/cmd_zign.c"
  : ""); al.mask = r_str_appendf (al.mask, " %s%s%02x%s", r_str_get ((const char *)
# 996 "project/radare2/libr/core/cmd_zign.c" 3 4
  ((void *)0)
# 996 "project/radare2/libr/core/cmd_zign.c"
  ), r_str_get (" "), ab->mask[ia], (const char *)
# 996 "project/radare2/libr/core/cmd_zign.c" 3 4
  ((void *)0)
# 996 "project/radare2/libr/core/cmd_zign.c"
  ? 
# 996 "project/radare2/libr/core/cmd_zign.c" 3 4
  "\x1b[0m"
# 996 "project/radare2/libr/core/cmd_zign.c"
  : ""); al.land = r_str_appendf (al.land, " %s%s%02x%s", r_str_get ((const char *)
# 996 "project/radare2/libr/core/cmd_zign.c" 3 4
  ((void *)0)
# 996 "project/radare2/libr/core/cmd_zign.c"
  ), r_str_get (" "), ab->bytes[ia] & ab->mask[ia], (const char *)
# 996 "project/radare2/libr/core/cmd_zign.c" 3 4
  ((void *)0)
# 996 "project/radare2/libr/core/cmd_zign.c"
  ?
...
# 996 "project/radare2/libr/core/cmd_zign.c"
  : ""); ia++;;
   bl.bytes = r_str_appendf (bl.bytes, " %s%s%02x%s", r_str_get ((const char *)
# 997 "project/radare2/libr/core/cmd_zign.c" 3 4
  ((void *)0)
# 997 "project/radare2/libr/core/cmd_zign.c"
  ), r_str_get (" "), bb->bytes[ib], (const char *)
# 997 "project/radare2/libr/core/cmd_zign.c" 3 4
  ((void *)0)
# 997 "project/radare2/libr/core/cmd_zign.c"
  ? 
# 997 "project/radare2/libr/core/cmd_zign.c" 3 4
  "\x1b[0m"
# 997 "project/radare2/libr/core/cmd_zign.c"
  : ""); bl.mask = r_str_appendf (bl.mask, " %s%s%02x%s", r_str_get ((const char *)
# 997 "project/radare2/libr/core/cmd_zign.c" 3 4
  ((void *)0)
# 997 "project/radare2/libr/core/cmd_zign.c"
  ), r_str_get (" "), bb->mask[ib], (const char *)
# 997 "project/radare2/libr/core/cmd_zign.c" 3 4
  ((void *)0)
# 997 "project/radare2/libr/core/cmd_zign.c"
  ? 
# 997 "project/radare2/libr/core/cmd_zign.c" 3 4
  "\x1b[0m"
# 997 "project/radare2/libr/core/cmd_zign.c"
  : ""); bl.land = r_str_appendf (bl.land, " %s%s%02x%s", r_str_get ((const char *)
# 997 "project/radare2/libr/core/cmd_zign.c" 3 4
  ((void *)0)
# 997 "project/radare2/libr/core/cmd_zign.c"
  ), r_str_get (" "), bb->bytes[ib] & bb->mask[ib], (const char *)
# 997 "project/radare2/libr/core/cmd_zign.c" 3 4
  ((void *)0)
# 997 "project/radare2/libr/core/cmd_zign.c"
  ?
...
# 997 "project/radare2/libr/core/cmd_zign.c"
  : ""); ib++;;
   break;
  case LEVSUB:
   al.bytes = r_str_appendf (al.bytes, " %s%s%02x%s", r_str_get (colsub), r_str_get (" "), ab->bytes[ia], colsub? 
# 1000 "project/radare2/libr/core/cmd_zign.c" 3 4
  "\x1b[0m"
# 1000 "project/radare2/libr/core/cmd_zign.c"
  : ""); al.mask = r_str_appendf (al.mask, " %s%s%02x%s", r_str_get (colsub), r_str_get (" "), ab->mask[ia], colsub? 
# 1000 "project/radare2/libr/core/cmd_zign.c" 3 4
  "\x1b[0m"
# 1000 "project/radare2/libr/core/cmd_zign.c"
  : ""); al.land = r_str_appendf (al.land, " %s%s%02x%s", r_str_get (colsub), r_str_get (" "), ab->bytes[ia] & ab->mask[ia], colsub?
# 1000 "project/radare2/libr/core/cmd_zign.c" 3 4
  "\x1b[0m"
# 1000 "project/radare2/libr/core/cmd_zign.c"
  : ""); ia++;;
   bl.bytes = r_str_appendf (bl.bytes, " %s%s%02x%s", r_str_get (colsub), r_str_get ("^"), bb->bytes[ib], colsub? 
# 1001 "project/radare2/libr/core/cmd_zign.c" 3 4
  "\x1b[0m"
# 1001 "project/radare2/libr/core/cmd_zign.c"
  : ""); bl.mask = r_str_appendf (bl.mask, " %s%s%02x%s", r_str_get (colsub), r_str_get ("^"), bb->mask[ib], colsub? 
# 1001 "project/radare2/libr/core/cmd_zign.c" 3 4
  "\x1b[0m"
# 1001 "project/radare2/libr/core/cmd_zign.c"
  : ""); bl.land = r_str_appendf (bl.land, " %s%s%02x%s", r_str_get (colsub), r_str_get ("^"), bb->bytes[ib] & bb->mask[ib], colsub?
# 1001 "project/radare2/libr/core/cmd_zign.c" 3 4
  "\x1b[0m"
# 1001 "project/radare2/libr/core/cmd_zign.c"
  : ""); ib++;;
   printb = 
# 1002 "project/radare2/libr/core/cmd_zign.c" 3 4
           1
# 1002 "project/radare2/libr/core/cmd_zign.c"
               ;
   break;
  case LEVADD:
   al.bytes = r_str_append (al.bytes, "    "); al.mask = r_str_append (al.mask, "    "); al.land = r_str_append (al.land, "    ");;
   bl.bytes = r_str_appendf (bl.bytes, " %s%s%02x%s", r_str_get (coladd), r_str_get ("+"), bb->bytes[ib], coladd? 
# 1006 "project/radare2/libr/core/cmd_zign.c" 3 4
  "\x1b[0m"
# 1006 "project/radare2/libr/core/cmd_zign.c"
  : ""); bl.mask = r_str_appendf (bl.mask, " %s%s%02x%s", r_str_get (coladd), r_str_get ("+"), bb->mask[ib], coladd? 
# 1006 "project/radare2/libr/core/cmd_zign.c" 3 4
  "\x1b[0m"
# 1006 "project/radare2/libr/core/cmd_zign.c"
  : ""); bl.land = r_str_appendf (bl.land, " %s%s%02x%s", r_str_get (coladd), r_str_get ("+"), bb->bytes[ib] & bb->mask[ib], coladd?
# 1006 "project/radare2/libr/core/cmd_zign.c" 3 4
  "\x1b[0m"
# 1006 "project/radare2/libr/core/cmd_zign.c"
  : ""); ib++;;
   printb = 
# 1007 "project/radare2/libr/core/cmd_zign.c" 3 4
           1
# 1007 "project/radare2/libr/core/cmd_zign.c"
               ;
   break;
  case LEVDEL:
   al.bytes = r_str_appendf (al.bytes, " %s%s%02x%s", r_str_get (coldel), r_str_get ("-"), ab->bytes[ia], coldel? 
# 1010 "project/radare2/libr/core/cmd_zign.c" 3 4
  "\x1b[0m"
# 1010 "project/radare2/libr/core/cmd_zign.c"
  : ""); al.mask = r_str_appendf (al.mask, " %s%s%02x%s", r_str_get (coldel), r_str_get ("-"), ab->mask[ia], coldel? 
# 1010 "project/radare2/libr/core/cmd_zign.c" 3 4
  "\x1b[0m"
# 1010 "project/radare2/libr/core/cmd_zign.c"
  : ""); al.land = r_str_appendf (al.land, " %s%s%02x%s", r_str_get (coldel), r_str_get ("-"), ab->bytes[ia] & ab->mask[ia], coldel?
# 1010 "project/radare2/libr/core/cmd_zign.c" 3 4
  "\x1b[0m"
# 1010 "project/radare2/libr/core/cmd_zign.c"
  : ""); ia++;;
   bl.bytes = r_str_append (bl.bytes, "    "); bl.mask = r_str_append (bl.mask, "    "); bl.land = r_str_append (bl.land, "    ");;
   printb = 
# 1012 "project/radare2/libr/core/cmd_zign.c" 3 4
           1
# 1012 "project/radare2/libr/core/cmd_zign.c"
               ;
   break;
  default:
   
# 1015 "project/radare2/libr/core/cmd_zign.c" 3 4
  do { r_assert_log (R_LOGLVL_WARN, "(%s:%d):%s%s code should not be reached\n", "project/radare2/libr/core/cmd_zign.c", 1015, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : ""); } while (0)
# 1015 "project/radare2/libr/core/cmd_zign.c"
                      ;
   free (al.bytes); free (al.mask); free (al.land); 
# 1016 "project/radare2/libr/core/cmd_zign.c" 3 4
  __builtin___memset_chk (
# 1016 "project/radare2/libr/core/cmd_zign.c"
  &al
# 1016 "project/radare2/libr/core/cmd_zign.c" 3 4
  , 
# 1016 "project/radare2/libr/core/cmd_zign.c"
...
# 1016 "project/radare2/libr/core/cmd_zign.c"
  ;;
   free (bl.bytes); free (bl.mask); free (bl.land); 
# 1017 "project/radare2/libr/core/cmd_zign.c" 3 4
  __builtin___memset_chk (
# 1017 "project/radare2/libr/core/cmd_zign.c"
  &bl
# 1017 "project/radare2/libr/core/cmd_zign.c" 3 4
  , 
# 1017 "project/radare2/libr/core/cmd_zign.c"
...
# 1017 "project/radare2/libr/core/cmd_zign.c"
  ...
  if (!(al.bytes && al.mask && al.land && bl.bytes && bl.mask && bl.land)) {
   free (al.bytes); free (al.mask); free (al.land); 
# 1022 "project/radare2/libr/core/cmd_zign.c" 3 4
  __builtin___memset_chk (
# 1022 "project/radare2/libr/core/cmd_zign.c"
  &al
# 1022 "project/radare2/libr/core/cmd_zign.c" 3 4
  , 
# 1022 "project/radare2/libr/core/cmd_zign.c"
...
# 1022 "project/radare2/libr/core/cmd_zign.c"
  ;;
   free (bl.bytes); free (bl.mask); free (bl.land); 
# 1023 "project/radare2/libr/core/cmd_zign.c" 3 4
  __builtin___memset_chk (
# 1023 "project/radare2/libr/core/cmd_zign.c"
  &bl
# 1023 "project/radare2/libr/core/cmd_zign.c" 3 4
  , 
# 1023 "project/radare2/libr/core/cmd_zign.c"
...
# 1023 "project/radare2/libr/core/cmd_zign.c"
  ...
  if (i % 16 == 15 || ops[i + 1] == LEVEND) {
   ...
   free (al.bytes); free (al.mask); free (al.land); 
# 1045 "project/radare2/libr/core/cmd_zign.c" 3 4
  __builtin___memset_chk (
# 1045 "project/radare2/libr/core/cmd_zign.c"
  &al
# 1045 "project/radare2/libr/core/cmd_zign.c" 3 4
  , 
# 1045 "project/radare2/libr/core/cmd_zign.c"
...
# 1045 "project/radare2/libr/core/cmd_zign.c"
  ;;
   free (bl.bytes); free (bl.mask); free (bl.land); 
# 1046 "project/radare2/libr/core/cmd_zign.c" 3 4
  __builtin___memset_chk (
# 1046 "project/radare2/libr/core/cmd_zign.c"
  &bl
# 1046 "project/radare2/libr/core/cmd_zign.c" 3 4
  , 
# 1046 "project/radare2/libr/core/cmd_zign.c"
...
# 1046 "project/radare2/libr/core/cmd_zign.c"
  ;;
   ...
   ibstart = ib;
   printb = 
# 1049 "project/radare2/libr/core/cmd_zign.c" 3 4
           0
# 1049 "project/radare2/libr/core/cmd_zign.c"
                ;
  }
 }
}
...
static 
# 1057 "project/radare2/libr/core/cmd_zign.c" 3 4
      _Bool 
# 1057 "project/radare2/libr/core/cmd_zign.c"
           diff_zig(void *data, const char *input) {
 
# 1058 "project/radare2/libr/core/cmd_zign.c" 3 4
do { if (!(
# 1058 "project/radare2/libr/core/cmd_zign.c"
data && input
# 1058 "project/radare2/libr/core/cmd_zign.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1058 "project/radare2/libr/core/cmd_zign.c"
...
# 1063 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 1063 "project/radare2/libr/core/cmd_zign.c"
 "No function at 0x%08" 
# 1063 "project/radare2/libr/core/cmd_zign.c" 3 4
 "llx" 
# 1063 "project/radare2/libr/core/cmd_zign.c"
...
# 1063 "project/radare2/libr/core/cmd_zign.c"
                                                            ;
  return 
# 1064 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 1064 "project/radare2/libr/core/cmd_zign.c"
             ;
 }
 ...
 if (!argv) {
  return 
# 1069 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 1069 "project/radare2/libr/core/cmd_zign.c"
             ;
 }
...
# 1074 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 1074 "project/radare2/libr/core/cmd_zign.c"
 "Need a signature\n"
# 1074 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 1074 "project/radare2/libr/core/cmd_zign.c"
  ...
  free (argv);
  return 
# 1076 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 1076 "project/radare2/libr/core/cmd_zign.c"
             ;
 }

 if (strtok (
# 1079 "project/radare2/libr/core/cmd_zign.c" 3 4
            ((void *)0)
# 1079 "project/radare2/libr/core/cmd_zign.c"
                , " ")) {
  
# 1080 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 1080 "project/radare2/libr/core/cmd_zign.c"
 "too many arguments"
# 1080 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 1080 "project/radare2/libr/core/cmd_zign.c"
  ...
  free (argv);
  return 
# 1082 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 1082 "project/radare2/libr/core/cmd_zign.c"
             ;
 }
...
# 1087 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 1087 "project/radare2/libr/core/cmd_zign.c"
 "Couldn't get signature for %s\n", zigname
# 1087 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 1087 "project/radare2/libr/core/cmd_zign.c"
  ...
  free (argv);
  return 
# 1089 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 1089 "project/radare2/libr/core/cmd_zign.c"
             ;
 }
 free (argv);
...
# 1094 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 1094 "project/radare2/libr/core/cmd_zign.c"
 "Signature %s missing bytes\n", it->name
# 1094 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 1094 "project/radare2/libr/core/cmd_zign.c"
                                                   ;
  return 
# 1095 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 1095 "project/radare2/libr/core/cmd_zign.c"
             ;
 }
 ...
 if (!fit) {
  r_sign_item_free (it);
  return 
# 1105 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 1105 "project/radare2/libr/core/cmd_zign.c"
             ;
 }
 ...
 RLevOp *ops = 
# 1113 "project/radare2/libr/core/cmd_zign.c" 3 4
              ((void *)0)
# 1113 "project/radare2/libr/core/cmd_zign.c"
                  ;

 if (r_diff_levenshtein_path (&a, &b, 
# 1115 "project/radare2/libr/core/cmd_zign.c" 3 4
                                     0xFFFFFFFFU
# 1115 "project/radare2/libr/core/cmd_zign.c"
                                             , _sig_bytediff_cb, &ops) < 0) {
  
# 1116 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 1116 "project/radare2/libr/core/cmd_zign.c"
 "Diff failed\n"
# 1116 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 1116 "project/radare2/libr/core/cmd_zign.c"
 ...
 r_sign_item_free (it);
 return 
# 1124 "project/radare2/libr/core/cmd_zign.c" 3 4
       0
# 1124 "project/radare2/libr/core/cmd_zign.c"
            ;
}

static int cmdCompare(void *data, const char *input) {
 int result = 
# 1128 "project/radare2/libr/core/cmd_zign.c" 3 4
             1
# 1128 "project/radare2/libr/core/cmd_zign.c"
                 ;
 RCore *core = (RCore *)data;
...
# 1137 "project/radare2/libr/core/cmd_zign.c" 3 4
  fprintf(__stderrp,
# 1137 "project/radare2/libr/core/cmd_zign.c"
  "Usage: zc other_space\n"
# 1137 "project/radare2/libr/core/cmd_zign.c" 3 4
  )
# 1137 "project/radare2/libr/core/cmd_zign.c"
                                     ;
   result = 
# 1138 "project/radare2/libr/core/cmd_zign.c" 3 4
           0
# 1138 "project/radare2/libr/core/cmd_zign.c"
                ;
   break;
  }
...
# 1147 "project/radare2/libr/core/cmd_zign.c" 3 4
   fprintf(__stderrp,
# 1147 "project/radare2/libr/core/cmd_zign.c"
   "Usage: zcn other_space\n"
# 1147 "project/radare2/libr/core/cmd_zign.c" 3 4
   )
# 1147 "project/radare2/libr/core/cmd_zign.c"
                                       ;
    result = 
# 1148 "project/radare2/libr/core/cmd_zign.c" 3 4
            0
# 1148 "project/radare2/libr/core/cmd_zign.c"
                 ;
    break;
   }
   result = r_sign_diff_by_name (core->anal, options, input + 2, 
# 1151 "project/radare2/libr/core/cmd_zign.c" 3 4
                                                                0
# 1151 "project/radare2/libr/core/cmd_zign.c"
                                                                     );
   break;
  case '!':
   if (input[2] != ' ' || !input[3]) {
    
# 1155 "project/radare2/libr/core/cmd_zign.c" 3 4
   fprintf(__stderrp,
# 1155 "project/radare2/libr/core/cmd_zign.c"
   "Usage: zcn! other_space\n"
# 1155 "project/radare2/libr/core/cmd_zign.c" 3 4
   )
# 1155 "project/radare2/libr/core/cmd_zign.c"
                                        ;
    result = 
# 1156 "project/radare2/libr/core/cmd_zign.c" 3 4
            0
# 1156 "project/radare2/libr/core/cmd_zign.c"
                 ;
    break;
   }
   result = r_sign_diff_by_name (core->anal, options, input + 3, 
# 1159 "project/radare2/libr/core/cmd_zign.c" 3 4
                                                                1
# 1159 "project/radare2/libr/core/cmd_zign.c"
                                                                    );
   break;
  default:
   
# 1162 "project/radare2/libr/core/cmd_zign.c" 3 4
  fprintf(__stderrp,
# 1162 "project/radare2/libr/core/cmd_zign.c"
  "Usage: zcn! other_space\n"
# 1162 "project/radare2/libr/core/cmd_zign.c" 3 4
  )
# 1162 "project/radare2/libr/core/cmd_zign.c"
                                       ;
   result = 
# 1163 "project/radare2/libr/core/cmd_zign.c" 3 4
           0
# 1163 "project/radare2/libr/core/cmd_zign.c"
                ;
  }
  break;
 case '?':
...
# 1170 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 1170 "project/radare2/libr/core/cmd_zign.c"
 "Usage: zc[?n!] other_space\n"
# 1170 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 1170 "project/radare2/libr/core/cmd_zign.c"
                                         ;
  result = 
# 1171 "project/radare2/libr/core/cmd_zign.c" 3 4
          0
# 1171 "project/radare2/libr/core/cmd_zign.c"
               ;
 }
...
# 1182 "project/radare2/libr/core/cmd_zign.c" 3 4
__builtin___memset_chk (
# 1182 "project/radare2/libr/core/cmd_zign.c"
&ctx
# 1182 "project/radare2/libr/core/cmd_zign.c" 3 4
, 
# 1182 "project/radare2/libr/core/cmd_zign.c"
...
# 1188 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 1188 "project/radare2/libr/core/cmd_zign.c"
...
# 1197 "project/radare2/libr/core/cmd_zign.c" 3 4
  fprintf(__stderrp,
# 1197 "project/radare2/libr/core/cmd_zign.c"
  "error: cannot create flagspace\n"
# 1197 "project/radare2/libr/core/cmd_zign.c" 3 4
  )
# 1197 "project/radare2/libr/core/cmd_zign.c"
                                              ;
   return 
# 1198 "project/radare2/libr/core/cmd_zign.c" 3 4
         0
# 1198 "project/radare2/libr/core/cmd_zign.c"
              ;
  }
 }

 
# 1202 "project/radare2/libr/core/cmd_zign.c" 3 4
fprintf(__stderrp,
# 1202 "project/radare2/libr/core/cmd_zign.c"
"[+] searching function metrics\n"
# 1202 "project/radare2/libr/core/cmd_zign.c" 3 4
)
# 1202 "project/radare2/libr/core/cmd_zign.c"
 ...
 if (fcn) {
  r_cons_break_push (
# 1205 "project/radare2/libr/core/cmd_zign.c" 3 4
                    ((void *)0)
# 1205 "project/radare2/libr/core/cmd_zign.c"
                        , 
# 1205 "project/radare2/libr/core/cmd_zign.c" 3 4
                          ((void *)0)
# 1205 "project/radare2/libr/core/cmd_zign.c"
...
# 1209 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 1209 "project/radare2/libr/core/cmd_zign.c"
 "No function at 0x%08" 
# 1209 "project/radare2/libr/core/cmd_zign.c" 3 4
 "llx" 
# 1209 "project/radare2/libr/core/cmd_zign.c"
...
# 1216 "project/radare2/libr/core/cmd_zign.c" 3 4
  fprintf(__stderrp,
# 1216 "project/radare2/libr/core/cmd_zign.c"
  "error: cannot restore flagspace\n"
# 1216 "project/radare2/libr/core/cmd_zign.c" 3 4
  )
# 1216 "project/radare2/libr/core/cmd_zign.c"
                                               ;
   return 
# 1217 "project/radare2/libr/core/cmd_zign.c" 3 4
         0
# 1217 "project/radare2/libr/core/cmd_zign.c"
              ;
  }
 }
...
# 1231 "project/radare2/libr/core/cmd_zign.c" 3 4
                                       0
# 1231 "project/radare2/libr/core/cmd_zign.c"
                                            );
 case 'f':
  switch (input[1]) {
  case 0:
  case '*':
   return search (core, input[1] == '*', 
# 1236 "project/radare2/libr/core/cmd_zign.c" 3 4
                                        1
# 1236 "project/radare2/libr/core/cmd_zign.c"
                                            );
  default:
   
# 1238 "project/radare2/libr/core/cmd_zign.c" 3 4
  fprintf(__stderrp,
# 1238 "project/radare2/libr/core/cmd_zign.c"
  "Usage: z/[f*]\n"
# 1238 "project/radare2/libr/core/cmd_zign.c" 3 4
  )
# 1238 "project/radare2/libr/core/cmd_zign.c"
                             ;
   return 
# 1239 "project/radare2/libr/core/cmd_zign.c" 3 4
         0
# 1239 "project/radare2/libr/core/cmd_zign.c"
              ;
  }
 case '?':
...
# 1245 "project/radare2/libr/core/cmd_zign.c" 3 4
 fprintf(__stderrp,
# 1245 "project/radare2/libr/core/cmd_zign.c"
 "Usage: z/[f*]\n"
# 1245 "project/radare2/libr/core/cmd_zign.c" 3 4
 )
# 1245 "project/radare2/libr/core/cmd_zign.c"
                            ;
  return 
# 1246 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 1246 "project/radare2/libr/core/cmd_zign.c"
             ;
 }
 return 
# 1248 "project/radare2/libr/core/cmd_zign.c" 3 4
       1
# 1248 "project/radare2/libr/core/cmd_zign.c"
           ;
}
...
static int cmdInfo(void *data, const char *input) {
 if (!data || !input) {
  return 
# 1253 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 1253 "project/radare2/libr/core/cmd_zign.c"
             ;
 }
 RCore *core = (RCore *) data;
 r_flag_space_push (core->flags, 
# 1256 "project/radare2/libr/core/cmd_zign.c" 3 4
                                "sign"
# 1256 "project/radare2/libr/core/cmd_zign.c"
                                                );
 r_flag_list (core->flags, *input, input[0] ? input + 1: "");
 r_flag_space_pop (core->flags);
 return 
# 1259 "project/radare2/libr/core/cmd_zign.c" 3 4
       1
# 1259 "project/radare2/libr/core/cmd_zign.c"
           ;
}
...
static int cmd_zign(void *data, const char *input) {
 ...
 default:
  r_core_cmd_help (core, help_msg_z);
  return 
# 1306 "project/radare2/libr/core/cmd_zign.c" 3 4
        0
# 1306 "project/radare2/libr/core/cmd_zign.c"
             ;
 }

 return 
# 1309 "project/radare2/libr/core/cmd_zign.c" 3 4
       1
# 1309 "project/radare2/libr/core/cmd_zign.c"
           ;
}
