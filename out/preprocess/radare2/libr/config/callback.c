# 0 "project/radare2/libr/config/callback.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/config/callback.c"
...
# 4 "project/radare2/libr/config/callback.c" 2


# 5 "project/radare2/libr/config/callback.c"
static 
# 5 "project/radare2/libr/config/callback.c" 3 4
      _Bool 
# 5 "project/radare2/libr/config/callback.c"
           r_config_setter_q(void *data) {
 RConfigNode *node = data;
 *(node->cb_ptr_q) = node->i_value;
 return 
# 8 "project/radare2/libr/config/callback.c" 3 4
       1
# 8 "project/radare2/libr/config/callback.c"
           ;
}

static 
# 11 "project/radare2/libr/config/callback.c" 3 4
      _Bool 
# 11 "project/radare2/libr/config/callback.c"
           r_config_setter_i(void *data) {
 RConfigNode *node = data;
 *(node->cb_ptr_i) = node->i_value;
 return 
# 14 "project/radare2/libr/config/callback.c" 3 4
       1
# 14 "project/radare2/libr/config/callback.c"
           ;
}

static 
# 17 "project/radare2/libr/config/callback.c" 3 4
      _Bool 
# 17 "project/radare2/libr/config/callback.c"
           r_config_setter_s(void *data) {
 RConfigNode *node = data;
 if (!node->value || !*node->value) {
  free (*node->cb_ptr_s);
  *node->cb_ptr_s = 
# 21 "project/radare2/libr/config/callback.c" 3 4
                   ((void *)0)
# 21 "project/radare2/libr/config/callback.c"
                       ;
 } else {
  *node->cb_ptr_s = r_str_dup (*node->cb_ptr_s, node->value);
 }
 return 
# 25 "project/radare2/libr/config/callback.c" 3 4
       1
# 25 "project/radare2/libr/config/callback.c"
           ;
}


# 28 "project/radare2/libr/config/callback.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 28 "project/radare2/libr/config/callback.c"
          r_config_set_setter_q(RConfig *cfg, const char *name, 
# 28 "project/radare2/libr/config/callback.c" 3 4
                                                                unsigned long long 
# 28 "project/radare2/libr/config/callback.c"
                                                                     *ptr) {
 ...
 if (node) {
  ...
  return 
# 33 "project/radare2/libr/config/callback.c" 3 4
        1
# 33 "project/radare2/libr/config/callback.c"
            ;
 }
 return 
# 35 "project/radare2/libr/config/callback.c" 3 4
       0
# 35 "project/radare2/libr/config/callback.c"
            ;
}


# 38 "project/radare2/libr/config/callback.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 38 "project/radare2/libr/config/callback.c"
          r_config_set_setter_i(RConfig *cfg, const char *name, int *ptr) {
 RConfigNode *node = r_config_node_get (cfg, name);
 if (node) {
  node->cb_ptr_i = ptr;
  node->setter = (void *) &r_config_setter_i;
  return 
# 43 "project/radare2/libr/config/callback.c" 3 4
        1
# 43 "project/radare2/libr/config/callback.c"
            ;
 }
 return 
# 45 "project/radare2/libr/config/callback.c" 3 4
       0
# 45 "project/radare2/libr/config/callback.c"
            ;
}


# 48 "project/radare2/libr/config/callback.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 48 "project/radare2/libr/config/callback.c"
          r_config_set_setter_s(RConfig *cfg, const char *name, char * *ptr) {
 RConfigNode *node = r_config_node_get (cfg, name);
 if (node) {
  node->cb_ptr_s = ptr;
  node->setter = (void *) &r_config_setter_s;
  return 
# 53 "project/radare2/libr/config/callback.c" 3 4
        1
# 53 "project/radare2/libr/config/callback.c"
            ;
 }
 return 
# 55 "project/radare2/libr/config/callback.c" 3 4
       0
# 55 "project/radare2/libr/config/callback.c"
            ;
}


# 58 "project/radare2/libr/config/callback.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 58 "project/radare2/libr/config/callback.c"
          r_config_set_getter(RConfig *cfg, const char *key, RConfigCallback cb) {
 
# 59 "project/radare2/libr/config/callback.c" 3 4
do { if (!(
# 59 "project/radare2/libr/config/callback.c"
cfg && key
# 59 "project/radare2/libr/config/callback.c" 3 4
...
# 59 "project/radare2/libr/config/callback.c"
 ...
 if (node) {
  node->getter = cb;
  return 
# 63 "project/radare2/libr/config/callback.c" 3 4
        1
# 63 "project/radare2/libr/config/callback.c"
            ;
 }
 return 
# 65 "project/radare2/libr/config/callback.c" 3 4
       0
# 65 "project/radare2/libr/config/callback.c"
            ;
}


# 68 "project/radare2/libr/config/callback.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 68 "project/radare2/libr/config/callback.c"
          r_config_set_setter(RConfig *cfg, const char *key, RConfigCallback cb) {
 RConfigNode *node = r_config_node_get (cfg, key);
 if (node) {
  node->setter = cb;
  return 
# 72 "project/radare2/libr/config/callback.c" 3 4
        1
# 72 "project/radare2/libr/config/callback.c"
            ;
 }
 return 
# 74 "project/radare2/libr/config/callback.c" 3 4
       0
# 74 "project/radare2/libr/config/callback.c"
            ;
}
