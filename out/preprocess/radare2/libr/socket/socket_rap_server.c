# 0 "project/radare2/libr/socket/socket_rap_server.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/socket/socket_rap_server.c"
...
# 4 "project/radare2/libr/socket/socket_rap_server.c" 2
...
# 5 "project/radare2/libr/socket/socket_rap_server.c" 2

__attribute__((visibility("default"))) 
# 6 "project/radare2/libr/socket/socket_rap_server.c"
     RSocketRapServer *r_socket_rap_server_new(
# 6 "project/radare2/libr/socket/socket_rap_server.c" 3 4
                                               _Bool 
# 6 "project/radare2/libr/socket/socket_rap_server.c"
                                                    use_ssl, const char *port) {
 
# 7 "project/radare2/libr/socket/socket_rap_server.c" 3 4
do { if (!(
# 7 "project/radare2/libr/socket/socket_rap_server.c"
port
# 7 "project/radare2/libr/socket/socket_rap_server.c" 3 4
...
# 7 "project/radare2/libr/socket/socket_rap_server.c"
                                 ;
 RSocketRapServer *s = 
# 8 "project/radare2/libr/socket/socket_rap_server.c" 3 4
                      (
# 8 "project/radare2/libr/socket/socket_rap_server.c"
                      RSocketRapServer
# 8 "project/radare2/libr/socket/socket_rap_server.c" 3 4
                      *)calloc(1,sizeof(
# 8 "project/radare2/libr/socket/socket_rap_server.c"
...
# 8 "project/radare2/libr/socket/socket_rap_server.c"
 ...
 return 
# 18 "project/radare2/libr/socket/socket_rap_server.c" 3 4
       ((void *)0)
# 18 "project/radare2/libr/socket/socket_rap_server.c"
           ;
}


# 21 "project/radare2/libr/socket/socket_rap_server.c" 3 4
__attribute__((visibility("default"))) 
# 21 "project/radare2/libr/socket/socket_rap_server.c"
     RSocketRapServer *r_socket_rap_server_create(const char *pathname) {
 
# 22 "project/radare2/libr/socket/socket_rap_server.c" 3 4
do { if (!(
# 22 "project/radare2/libr/socket/socket_rap_server.c"
pathname
# 22 "project/radare2/libr/socket/socket_rap_server.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 22 "project/radare2/libr/socket/socket_rap_server.c"
"pathname"
# 22 "project/radare2/libr/socket/socket_rap_server.c" 3 4
, 22); return (((void *)0)); } } while (0)
# 22 "project/radare2/libr/socket/socket_rap_server.c"
                                     ;
 if (strlen (pathname) < 11) {
  return 
# 24 "project/radare2/libr/socket/socket_rap_server.c" 3 4
        ((void *)0)
# 24 "project/radare2/libr/socket/socket_rap_server.c"
            ;
 }
 if (strncmp (pathname, "rap", 3)) {
  return 
# 27 "project/radare2/libr/socket/socket_rap_server.c" 3 4
        ((void *)0)
# 27 "project/radare2/libr/socket/socket_rap_server.c"
            ;
 }
 
# 29 "project/radare2/libr/socket/socket_rap_server.c" 3 4
_Bool 
# 29 "project/radare2/libr/socket/socket_rap_server.c"
     is_ssl = (pathname[3] == 's');
...
# 34 "project/radare2/libr/socket/socket_rap_server.c" 3 4
__attribute__((visibility("default"))) 
# 34 "project/radare2/libr/socket/socket_rap_server.c"
     void r_socket_rap_server_free(RSocketRapServer *s) {
 if (s) {
  r_socket_free (s->fd);
  free (s);
 }
...
# 41 "project/radare2/libr/socket/socket_rap_server.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 41 "project/radare2/libr/socket/socket_rap_server.c"
          r_socket_rap_server_listen(RSocketRapServer *s, const char *certfile) {
 
# 42 "project/radare2/libr/socket/socket_rap_server.c" 3 4
do { if (!(
# 42 "project/radare2/libr/socket/socket_rap_server.c"
s && s->port && *s->port
# 42 "project/radare2/libr/socket/socket_rap_server.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 42 "project/radare2/libr/socket/socket_rap_server.c"
...
# 46 "project/radare2/libr/socket/socket_rap_server.c" 3 4
__attribute__((visibility("default"))) 
# 46 "project/radare2/libr/socket/socket_rap_server.c"
     RSocket* r_socket_rap_server_accept(RSocketRapServer *s) {
 
# 47 "project/radare2/libr/socket/socket_rap_server.c" 3 4
do { if (!(
# 47 "project/radare2/libr/socket/socket_rap_server.c"
s && s->fd
# 47 "project/radare2/libr/socket/socket_rap_server.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 47 "project/radare2/libr/socket/socket_rap_server.c"
...
# 51 "project/radare2/libr/socket/socket_rap_server.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 51 "project/radare2/libr/socket/socket_rap_server.c"
          r_socket_rap_server_continue(RSocketRapServer *s) {
 
# 52 "project/radare2/libr/socket/socket_rap_server.c" 3 4
do { if (!(
# 52 "project/radare2/libr/socket/socket_rap_server.c"
s && s->fd
# 52 "project/radare2/libr/socket/socket_rap_server.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 52 "project/radare2/libr/socket/socket_rap_server.c"
...
# 52 "project/radare2/libr/socket/socket_rap_server.c"
 ...
 int i;
 char *ptr = 
# 55 "project/radare2/libr/socket/socket_rap_server.c" 3 4
            ((void *)0)
# 55 "project/radare2/libr/socket/socket_rap_server.c"
                ;

 if (!r_socket_is_connected (s->fd)) {
  return 
# 58 "project/radare2/libr/socket/socket_rap_server.c" 3 4
        0
# 58 "project/radare2/libr/socket/socket_rap_server.c"
             ;
 }
...
# 68 "project/radare2/libr/socket/socket_rap_server.c" 3 4
  fprintf(__stderrp,
# 68 "project/radare2/libr/socket/socket_rap_server.c"
  "REPLY BACK %d\n", fd
# 68 "project/radare2/libr/socket/socket_rap_server.c" 3 4
  )
# 68 "project/radare2/libr/socket/socket_rap_server.c"
...
# 101 "project/radare2/libr/socket/socket_rap_server.c" 3 4
 unsigned long long 
# 101 "project/radare2/libr/socket/socket_rap_server.c"
      offset = r_read_be64 (s->buf + 1);
...
# 123 "project/radare2/libr/socket/socket_rap_server.c" 3 4
  { free((void *)
# 123 "project/radare2/libr/socket/socket_rap_server.c"
  ptr
# 123 "project/radare2/libr/socket/socket_rap_server.c" 3 4
  ); 
# 123 "project/radare2/libr/socket/socket_rap_server.c"
...
# 135 "project/radare2/libr/socket/socket_rap_server.c" 3 4
 fprintf(__stderrp,
# 135 "project/radare2/libr/socket/socket_rap_server.c"
...
# 135 "project/radare2/libr/socket/socket_rap_server.c"
  ...
  r_socket_close (s->fd);
  return 
# 137 "project/radare2/libr/socket/socket_rap_server.c" 3 4
        0
# 137 "project/radare2/libr/socket/socket_rap_server.c"
             ;
 }
 return 
# 139 "project/radare2/libr/socket/socket_rap_server.c" 3 4
       1
# 139 "project/radare2/libr/socket/socket_rap_server.c"
           ;
}
