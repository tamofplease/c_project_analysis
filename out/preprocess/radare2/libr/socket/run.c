# 0 "project/radare2/libr/socket/run.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/socket/run.c"
...
# 6 "project/radare2/libr/socket/run.c" 2
...
# 7 "project/radare2/libr/socket/run.c" 2
...
# 8 "project/radare2/libr/socket/run.c" 2
...
# 9 "project/radare2/libr/socket/run.c" 2
...
# 10 "project/radare2/libr/socket/run.c" 2
...
# 11 "project/radare2/libr/socket/run.c" 2
...
# 12 "project/radare2/libr/socket/run.c" 2
...
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/spawn.h" 1 3 4
# 34 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/spawn.h" 3 4
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/spawn.h" 1 3 4
# 35 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/spawn.h" 2 3 4
# 51 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/spawn.h" 3 4
...
int posix_spawnattr_setsigmask(posix_spawnattr_t * restrict,
    const sigset_t * restrict) ;
# 121 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/spawn.h" 3 4
...
# 128 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/spawn.h" 2 3 4
...
# 129 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/spawn.h" 2 3 4
...
int posix_spawnattr_setsuidcredport_np(posix_spawnattr_t * restrict, mach_port_t) ;
...
# 175 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/spawn.h" 3 4
...
# 19 "project/radare2/libr/socket/run.c" 2
...
# 23 "project/radare2/libr/socket/run.c" 2
...
# 24 "project/radare2/libr/socket/run.c" 2
...
# 26 "project/radare2/libr/socket/run.c" 2
...
# 28 "project/radare2/libr/socket/run.c" 2
...
# 30 "project/radare2/libr/socket/run.c" 2
...
# 31 "project/radare2/libr/socket/run.c" 2
...
# 32 "project/radare2/libr/socket/run.c" 2



# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/ioctl.h" 1 3 4
# 36 "project/radare2/libr/socket/run.c" 2
...
# 39 "project/radare2/libr/socket/run.c" 2

# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/errno.h" 1 3 4
# 41 "project/radare2/libr/socket/run.c" 2
# 50 "project/radare2/libr/socket/run.c"
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/util.h" 1 3 4
# 65 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/util.h" 3 4
...
# 66 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/util.h" 2 3 4
# 87 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/util.h" 3 4
...
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/utmp.h" 1 3 4
# 86 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/utmp.h" 3 4
struct lastlog {
 time_t ll_time;
 char ll_line[8];
 char ll_host[16];
...
# 108 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/util.h" 2 3 4
# 51 "project/radare2/libr/socket/run.c" 2
# 64 "project/radare2/libr/socket/run.c"

# 64 "project/radare2/libr/socket/run.c"
static int (*dyn_openpty)(int *amaster, int *aslave, char *name, struct termios *termp, struct winsize *winp) = 
# 64 "project/radare2/libr/socket/run.c" 3 4
                                                                                                               ((void *)0)
# 64 "project/radare2/libr/socket/run.c"
                                                                                                                   ;
static int (*dyn_login_tty)(int fd) = 
# 65 "project/radare2/libr/socket/run.c" 3 4
                                     ((void *)0)
# 65 "project/radare2/libr/socket/run.c"
                                         ;
static id_t (*dyn_forkpty)(int *amaster, char *name, struct termios *termp, struct winsize *winp) = 
# 66 "project/radare2/libr/socket/run.c" 3 4
                                                                                                   ((void *)0)
# 66 "project/radare2/libr/socket/run.c"
                                                                                                       ;
static void dyn_init(void) {
 if (!dyn_openpty) {
  dyn_openpty = r_lib_dl_sym (
# 69 "project/radare2/libr/socket/run.c" 3 4
                             ((void *)0)
# 69 "project/radare2/libr/socket/run.c"
                                 , "openpty");
 }
 if (!dyn_login_tty) {
  dyn_login_tty = r_lib_dl_sym (
# 72 "project/radare2/libr/socket/run.c" 3 4
                               ((void *)0)
# 72 "project/radare2/libr/socket/run.c"
                                   , "login_tty");
 }
 if (!dyn_forkpty) {
  dyn_forkpty = r_lib_dl_sym (
# 75 "project/radare2/libr/socket/run.c" 3 4
                             ((void *)0)
# 75 "project/radare2/libr/socket/run.c"
                                 , "forkpty");
 }
 ...
 if (!(dyn_openpty && dyn_login_tty && dyn_forkpty)) {
  void *libutil;
  if (!(libutil = r_lib_dl_open ("libutil." 
# 81 "project/radare2/libr/socket/run.c" 3 4
                                           "dylib"
# 81 "project/radare2/libr/socket/run.c"
                                                    ))) {
   
# 82 "project/radare2/libr/socket/run.c" 3 4
  fprintf(__stderrp,
# 82 "project/radare2/libr/socket/run.c"
  "[ERROR] rarun2: Could not find PTY utils, failed to load %s\n", "libutil." 
# 82 "project/radare2/libr/socket/run.c" 3 4
  "dylib")
# 82 "project/radare2/libr/socket/run.c"
                                                                                                 ;
...
# 101 "project/radare2/libr/socket/run.c" 3 4
__attribute__((visibility("default"))) 
# 101 "project/radare2/libr/socket/run.c"
     RRunProfile *r_run_new(const char *str) {
 RRunProfile *p = 
# 102 "project/radare2/libr/socket/run.c" 3 4
                 (
# 102 "project/radare2/libr/socket/run.c"
                 RRunProfile
# 102 "project/radare2/libr/socket/run.c" 3 4
                 *)calloc(1,sizeof(
# 102 "project/radare2/libr/socket/run.c"
...
# 112 "project/radare2/libr/socket/run.c" 3 4
__attribute__((visibility("default"))) 
# 112 "project/radare2/libr/socket/run.c"
     void r_run_reset(RRunProfile *p) {
 
# 113 "project/radare2/libr/socket/run.c" 3 4
do { if (!(
# 113 "project/radare2/libr/socket/run.c"
p
# 113 "project/radare2/libr/socket/run.c" 3 4
...
# 114 "project/radare2/libr/socket/run.c" 3 4
__builtin___memset_chk (
# 114 "project/radare2/libr/socket/run.c"
p
# 114 "project/radare2/libr/socket/run.c" 3 4
, 
# 114 "project/radare2/libr/socket/run.c"
0, sizeof (RRunProfile)
# 114 "project/radare2/libr/socket/run.c" 3 4
...
# 118 "project/radare2/libr/socket/run.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 118 "project/radare2/libr/socket/run.c"
          r_run_parse(RRunProfile *pf, const char *profile) {
 
# 119 "project/radare2/libr/socket/run.c" 3 4
do { if (!(
# 119 "project/radare2/libr/socket/run.c"
pf && profile
# 119 "project/radare2/libr/socket/run.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 119 "project/radare2/libr/socket/run.c"
"pf && profile"
# 119 "project/radare2/libr/socket/run.c" 3 4
, 119); return (0); } } while (0)
# 119 "project/radare2/libr/socket/run.c"
                                           ;
 char *p, *o, *str = strdup (profile);
 if (!str) {
  return 
# 122 "project/radare2/libr/socket/run.c" 3 4
        0
# 122 "project/radare2/libr/socket/run.c"
             ;
 }
 ...
 free (str);
 return 
# 134 "project/radare2/libr/socket/run.c" 3 4
       1
# 134 "project/radare2/libr/socket/run.c"
           ;
}


# 137 "project/radare2/libr/socket/run.c" 3 4
__attribute__((visibility("default"))) 
# 137 "project/radare2/libr/socket/run.c"
     void r_run_free(RRunProfile *r) {
 if (r) {
  free (r->_system);
  free (r->_program);
  free (r->_runlib);
...
static void set_limit(int n, int a, 
# 156 "project/radare2/libr/socket/run.c" 3 4
                                   unsigned long long 
# 156 "project/radare2/libr/socket/run.c"
                                        b) {

 if (n) {
  struct rlimit cl = {b, b};
  setrlimit (
# 160 "project/radare2/libr/socket/run.c" 3 4
            4
# 160 "project/radare2/libr/socket/run.c"
                       , &cl);
 } else {
...
static char *getstr(const char *src) {
 int len;
 char *ret = 
# 171 "project/radare2/libr/socket/run.c" 3 4
            ((void *)0)
# 171 "project/radare2/libr/socket/run.c"
                ;
...
# 184 "project/radare2/libr/socket/run.c" 3 4
   fprintf(__stderrp,
# 184 "project/radare2/libr/socket/run.c"
   "Missing \"\n"
# 184 "project/radare2/libr/socket/run.c" 3 4
   )
# 184 "project/radare2/libr/socket/run.c"
  ...
  return 
# 188 "project/radare2/libr/socket/run.c" 3 4
        ((void *)0)
# 188 "project/radare2/libr/socket/run.c"
            ;
 case '"':
  ret = strdup (src + 1);
  if (ret) {
...
# 200 "project/radare2/libr/socket/run.c" 3 4
   fprintf(__stderrp,
# 200 "project/radare2/libr/socket/run.c"
   "Missing \"\n"
# 200 "project/radare2/libr/socket/run.c" 3 4
   )
# 200 "project/radare2/libr/socket/run.c"
  ...
  return 
# 204 "project/radare2/libr/socket/run.c" 3 4
        ((void *)0)
# 204 "project/radare2/libr/socket/run.c"
            ;
 case '@':
  {
    ...
    *pat++ = 0;
    rep = strtol (src + 1, 
# 212 "project/radare2/libr/socket/run.c" 3 4
                          ((void *)0)
# 212 "project/radare2/libr/socket/run.c"
                              , 10);
    len = strlen (pat);
    if (rep > 0) {
     char *buf = malloc (rep);
   ...
   return r_file_slurp (src + 1, 
# 225 "project/radare2/libr/socket/run.c" 3 4
                                ((void *)0)
# 225 "project/radare2/libr/socket/run.c"
                                    );
  }
 case '`':
  {
  ...
  if (msg_len > 0) {
   msg [msg_len - 1] = 0;
   char *ret = r_sys_cmd_str (msg, 
# 233 "project/radare2/libr/socket/run.c" 3 4
                                  ((void *)0)
# 233 "project/radare2/libr/socket/run.c"
                                      , 
# 233 "project/radare2/libr/socket/run.c" 3 4
                                        ((void *)0)
# 233 "project/radare2/libr/socket/run.c"
 ...
 case '!':
  {
  char *a = r_sys_cmd_str (src + 1, 
# 243 "project/radare2/libr/socket/run.c" 3 4
                                   ((void *)0)
# 243 "project/radare2/libr/socket/run.c"
                                       , 
# 243 "project/radare2/libr/socket/run.c" 3 4
                                         ((void *)0)
# 243 "project/radare2/libr/socket/run.c"
 ...
 case ':':
  if (src[1] == '!') {
   ret = r_sys_cmd_str (src + 1, 
# 249 "project/radare2/libr/socket/run.c" 3 4
                                ((void *)0)
# 249 "project/radare2/libr/socket/run.c"
                                    , 
# 249 "project/radare2/libr/socket/run.c" 3 4
                                      ((void *)0)
# 249 "project/radare2/libr/socket/run.c"
  ...
  len = r_hex_str2bin (src + 1, (
# 254 "project/radare2/libr/socket/run.c" 3 4
                                unsigned char
# 254 "project/radare2/libr/socket/run.c"
                                   *)ret);
  if (len > 0) {
   ret[len] = 0;
   return ret;
...
# 259 "project/radare2/libr/socket/run.c" 3 4
 fprintf(__stderrp,
# 259 "project/radare2/libr/socket/run.c"
...
# 259 "project/radare2/libr/socket/run.c"
  ...
  free (ret);
  return 
# 261 "project/radare2/libr/socket/run.c" 3 4
        ((void *)0)
# 261 "project/radare2/libr/socket/run.c"
            ;
 }
...
# 289 "project/radare2/libr/socket/run.c"
 const char *argv0 = r->_system ? r->_system
  : r->_program ? r->_program
  : r->_args[0] ? r->_args[0]
  : "/path/to/exec";
 
# 293 "project/radare2/libr/socket/run.c" 3 4
fprintf(__stderrp,
# 293 "project/radare2/libr/socket/run.c"
"To disable aslr patch mach0.hdr.flags with:\n" "r2 -qwnc 'wx 000000 @ 0x18' %s\n", argv0
# 293 "project/radare2/libr/socket/run.c" 3 4
)
                                            
# 294 "project/radare2/libr/socket/run.c"
                                           ;
# 304 "project/radare2/libr/socket/run.c"
}
# 406 "project/radare2/libr/socket/run.c"
static int handle_redirection(const char *cmd, 
# 406 "project/radare2/libr/socket/run.c" 3 4
                                              _Bool 
# 406 "project/radare2/libr/socket/run.c"
                                                   in, 
# 406 "project/radare2/libr/socket/run.c" 3 4
...
# 406 "project/radare2/libr/socket/run.c"
 ...
 return 0;
# 481 "project/radare2/libr/socket/run.c"
}


# 483 "project/radare2/libr/socket/run.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 483 "project/radare2/libr/socket/run.c"
          r_run_parsefile(RRunProfile *p, const char *b) {
 
# 484 "project/radare2/libr/socket/run.c" 3 4
do { if (!(
# 484 "project/radare2/libr/socket/run.c"
p && b
# 484 "project/radare2/libr/socket/run.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 484 "project/radare2/libr/socket/run.c"
"p && b"
# 484 "project/radare2/libr/socket/run.c" 3 4
, 484); return (0); } } while (0)
# 484 "project/radare2/libr/socket/run.c"
                                    ;
 char *s = r_file_slurp (b, 
# 485 "project/radare2/libr/socket/run.c" 3 4
                           ((void *)0)
# 485 "project/radare2/libr/socket/run.c"
                               );
 if (s) {
  
# 487 "project/radare2/libr/socket/run.c" 3 4
 _Bool 
# 487 "project/radare2/libr/socket/run.c"
      ret = r_run_parse (p, s);
  free (s);
  return ret;
 }
...
# 494 "project/radare2/libr/socket/run.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 494 "project/radare2/libr/socket/run.c"
          r_run_parseline(RRunProfile *p, const char *b) {
 int must_free = 
# 495 "project/radare2/libr/socket/run.c" 3 4
                0
# 495 "project/radare2/libr/socket/run.c"
                     ;
 char *e = strchr (b, '=');
 if (!e || *b == '#') {
  return 0;
 ...
 *e++ = 0;
 if (*e == '$') {
  must_free = 
# 502 "project/radare2/libr/socket/run.c" 3 4
             1
# 502 "project/radare2/libr/socket/run.c"
                 ;
  e = r_sys_getenv (e);
 }
 if (!e) {
 ...
 if (!strcmp (b, "program")) {
  ...
  p->_daemon = 
# 511 "project/radare2/libr/socket/run.c" 3 4
              1
# 511 "project/radare2/libr/socket/run.c"
                  ;
  ...
  int n = atoi (b + 3);
  if (n >= 0 && n < 
# 588 "project/radare2/libr/socket/run.c" 3 4
                   512
# 588 "project/radare2/libr/socket/run.c"
                                      ) {
   p->_args[n] = getstr (e);
   p->_argc++;
  } else {
   
# 592 "project/radare2/libr/socket/run.c" 3 4
  fprintf(__stderrp,
# 592 "project/radare2/libr/socket/run.c"
...
# 599 "project/radare2/libr/socket/run.c" 3 4
  fprintf(__stderrp,
# 599 "project/radare2/libr/socket/run.c"
  "Cannot open '%s'\n", e
# 599 "project/radare2/libr/socket/run.c" 3 4
  )
# 599 "project/radare2/libr/socket/run.c"
                                   ;
   if (must_free == 
# 600 "project/radare2/libr/socket/run.c" 3 4
                   1
# 600 "project/radare2/libr/socket/run.c"
                       ) {
    free (e);
   }
   return 
# 603 "project/radare2/libr/socket/run.c" 3 4
         0
# 603 "project/radare2/libr/socket/run.c"
              ;
  }
  for (;;) {
  ...
  r_sys_setenv (e, 
# 627 "project/radare2/libr/socket/run.c" 3 4
                  ((void *)0)
# 627 "project/radare2/libr/socket/run.c"
                      );
 ...
 if (must_free == 
# 639 "project/radare2/libr/socket/run.c" 3 4
                 1
# 639 "project/radare2/libr/socket/run.c"
                     ) {
  free (e);
 }
 return 
# 642 "project/radare2/libr/socket/run.c" 3 4
       1
# 642 "project/radare2/libr/socket/run.c"
           ;
}


# 645 "project/radare2/libr/socket/run.c" 3 4
__attribute__((visibility("default"))) 
# 645 "project/radare2/libr/socket/run.c"
     const char *r_run_help(void) {
 return
 "program=/bin/ls\n"
 "arg1=/bin\n"
 "# arg2=hello\n"
...
static int fd_forward(int in_fd, int out_fd, char **buff) {
 ...
 if (ioctl (in_fd, 
# 698 "project/radare2/libr/socket/run.c" 3 4
                  ((__uint32_t)0x40000000 | ((sizeof(int) & 0x1fff) << 16) | ((('f')) << 8) | ((127)))
# 698 "project/radare2/libr/socket/run.c"
                          , &size) == -1) {
  perror ("ioctl");
  return -1;
 }
...
# 708 "project/radare2/libr/socket/run.c" 3 4
 fprintf(__stderrp,
# 708 "project/radare2/libr/socket/run.c"
...
# 744 "project/radare2/libr/socket/run.c"
static int redirect_socket_to_pty(RSocket *sock) {
 ...
 if (dyn_openpty && dyn_openpty (&fdm, &fds, 
# 750 "project/radare2/libr/socket/run.c" 3 4
                                            ((void *)0)
# 750 "project/radare2/libr/socket/run.c"
                                                , 
# 750 "project/radare2/libr/socket/run.c" 3 4
                                                  ((void *)0)
# 750 "project/radare2/libr/socket/run.c"
...
# 758 "project/radare2/libr/socket/run.c" 3 4
 fprintf(__stderrp,
# 758 "project/radare2/libr/socket/run.c"
 "cannot fork\n"
# 758 "project/radare2/libr/socket/run.c" 3 4
 )
# 758 "project/radare2/libr/socket/run.c"
 ...
 if (child_pid == 0) {
  ...
  char *buff = 
# 772 "project/radare2/libr/socket/run.c" 3 4
              ((void *)0)
# 772 "project/radare2/libr/socket/run.c"
                  ;
  int sockfd = sock->fd;
  int max_fd = fdm > sockfd ? fdm : sockfd;

  while (
# 776 "project/radare2/libr/socket/run.c" 3 4
        1
# 776 "project/radare2/libr/socket/run.c"
            ) {
   fd_set readfds;
   
# 778 "project/radare2/libr/socket/run.c" 3 4
  __builtin_bzero(
# 778 "project/radare2/libr/socket/run.c"
  &readfds
# 778 "project/radare2/libr/socket/run.c" 3 4
  , sizeof(*(
# 778 "project/radare2/libr/socket/run.c"
...
# 779 "project/radare2/libr/socket/run.c" 3 4
  __darwin_fd_set((
# 779 "project/radare2/libr/socket/run.c"
  fdm
# 779 "project/radare2/libr/socket/run.c" 3 4
  ), (
# 779 "project/radare2/libr/socket/run.c"
...
# 780 "project/radare2/libr/socket/run.c" 3 4
  __darwin_fd_set((
# 780 "project/radare2/libr/socket/run.c"
  sockfd
# 780 "project/radare2/libr/socket/run.c" 3 4
  ), (
# 780 "project/radare2/libr/socket/run.c"
...
# 780 "project/radare2/libr/socket/run.c"
   ...
   if (select (max_fd + 1, &readfds, 
# 782 "project/radare2/libr/socket/run.c" 3 4
                                    ((void *)0)
# 782 "project/radare2/libr/socket/run.c"
                                        , 
# 782 "project/radare2/libr/socket/run.c" 3 4
                                          ((void *)0)
# 782 "project/radare2/libr/socket/run.c"
...
# 782 "project/radare2/libr/socket/run.c"
   ...
   if (
# 787 "project/radare2/libr/socket/run.c" 3 4
      __darwin_fd_isset((
# 787 "project/radare2/libr/socket/run.c"
      fdm
# 787 "project/radare2/libr/socket/run.c" 3 4
      ), (
# 787 "project/radare2/libr/socket/run.c"
...
# 787 "project/radare2/libr/socket/run.c"
   ...
   if (
# 793 "project/radare2/libr/socket/run.c" 3 4
      __darwin_fd_isset((
# 793 "project/radare2/libr/socket/run.c"
      sockfd
# 793 "project/radare2/libr/socket/run.c" 3 4
      ), (
# 793 "project/radare2/libr/socket/run.c"
...
# 793 "project/radare2/libr/socket/run.c"
 ...
 cfmakeraw (&t);
 tcsetattr (0, 
# 822 "project/radare2/libr/socket/run.c" 3 4
              0
# 822 "project/radare2/libr/socket/run.c"
                     , &t);
...
# 831 "project/radare2/libr/socket/run.c" 3 4
__attribute__((visibility("default"))) 
# 831 "project/radare2/libr/socket/run.c"
     int r_run_config_env(RRunProfile *p) {
 int ret;
...
# 839 "project/radare2/libr/socket/run.c" 3 4
 fprintf(__stderrp,
# 839 "project/radare2/libr/socket/run.c"
...
# 839 "project/radare2/libr/socket/run.c"
 ...
 if (handle_redirection (p->_stdio, 
# 843 "project/radare2/libr/socket/run.c" 3 4
                                   1
# 843 "project/radare2/libr/socket/run.c"
                                       , 
# 843 "project/radare2/libr/socket/run.c" 3 4
                                         1
# 843 "project/radare2/libr/socket/run.c"
...
# 843 "project/radare2/libr/socket/run.c"
 ...
 if (handle_redirection (p->_stdin, 
# 846 "project/radare2/libr/socket/run.c" 3 4
                                   1
# 846 "project/radare2/libr/socket/run.c"
                                       , 
# 846 "project/radare2/libr/socket/run.c" 3 4
                                         0
# 846 "project/radare2/libr/socket/run.c"
...
# 846 "project/radare2/libr/socket/run.c"
 ...
 if (handle_redirection (p->_stdout, 
# 849 "project/radare2/libr/socket/run.c" 3 4
                                    0
# 849 "project/radare2/libr/socket/run.c"
                                         , 
# 849 "project/radare2/libr/socket/run.c" 3 4
                                           1
# 849 "project/radare2/libr/socket/run.c"
...
# 849 "project/radare2/libr/socket/run.c"
 ...
 if (handle_redirection (p->_stderr, 
# 852 "project/radare2/libr/socket/run.c" 3 4
                                    0
# 852 "project/radare2/libr/socket/run.c"
                                         , 
# 852 "project/radare2/libr/socket/run.c" 3 4
                                           0
# 852 "project/radare2/libr/socket/run.c"
...
# 852 "project/radare2/libr/socket/run.c"
 ...
 set_limit (p->_docore, 
# 859 "project/radare2/libr/socket/run.c" 3 4
                       4
# 859 "project/radare2/libr/socket/run.c"
                                  , 
# 859 "project/radare2/libr/socket/run.c" 3 4
                                    (((__uint64_t)1 << 63) - 1)
# 859 "project/radare2/libr/socket/run.c"
 ...
 if (p->_maxfd) {
  set_limit (p->_maxfd, 
# 861 "project/radare2/libr/socket/run.c" 3 4
                       8
# 861 "project/radare2/libr/socket/run.c"
                                    , p->_maxfd);
 }

 if (p->_maxproc) {
  set_limit (p->_maxproc, 
# 865 "project/radare2/libr/socket/run.c" 3 4
                         7
# 865 "project/radare2/libr/socket/run.c"
                                     , p->_maxproc);
 }

 if (p->_maxstack) {
  set_limit (p->_maxstack, 
# 869 "project/radare2/libr/socket/run.c" 3 4
                          3
# 869 "project/radare2/libr/socket/run.c"
                                      , p->_maxstack);
 }
 ...
 if (p->_connect) {
   ...
   *q = 0;
   if (!
# 880 "project/radare2/libr/socket/run.c" 3 4
       r_socket_connect (
# 880 "project/radare2/libr/socket/run.c"
       fd
# 880 "project/radare2/libr/socket/run.c" 3 4
       , 
# 880 "project/radare2/libr/socket/run.c"
...
# 881 "project/radare2/libr/socket/run.c" 3 4
   fprintf(__stderrp,
# 881 "project/radare2/libr/socket/run.c"
   "Cannot connect\n"
# 881 "project/radare2/libr/socket/run.c" 3 4
   )
# 881 "project/radare2/libr/socket/run.c"
...
# 887 "project/radare2/libr/socket/run.c" 3 4
    fprintf(__stderrp,
# 887 "project/radare2/libr/socket/run.c"
...
# 895 "project/radare2/libr/socket/run.c" 3 4
  fprintf(__stderrp,
# 895 "project/radare2/libr/socket/run.c"
...
# 901 "project/radare2/libr/socket/run.c" 3 4
 _Bool 
# 901 "project/radare2/libr/socket/run.c"
      is_child = 
# 901 "project/radare2/libr/socket/run.c" 3 4
                 0
# 901 "project/radare2/libr/socket/run.c"
                      ;
  if (!r_socket_listen (fd, p->_listen, 
# 902 "project/radare2/libr/socket/run.c" 3 4
                                       ((void *)0)
# 902 "project/radare2/libr/socket/run.c"
                                           )) {
   
# 903 "project/radare2/libr/socket/run.c" 3 4
  fprintf(__stderrp,
# 903 "project/radare2/libr/socket/run.c"
  "rarun2: cannot listen\n"
# 903 "project/radare2/libr/socket/run.c" 3 4
  )
# 903 "project/radare2/libr/socket/run.c"
                                     ;
  ...
  while (
# 907 "project/radare2/libr/socket/run.c" 3 4
        1
# 907 "project/radare2/libr/socket/run.c"
            ) {
   child = r_socket_accept (fd);
   if (child) {
    is_child = 
# 910 "project/radare2/libr/socket/run.c" 3 4
              1
# 910 "project/radare2/libr/socket/run.c"
                  ;
...
# 915 "project/radare2/libr/socket/run.c" 3 4
     fprintf(__stderrp,
# 915 "project/radare2/libr/socket/run.c"
     "rarun2: cannot fork\n"
# 915 "project/radare2/libr/socket/run.c" 3 4
     )
# 915 "project/radare2/libr/socket/run.c"
      ...
      is_child = 
# 921 "project/radare2/libr/socket/run.c" 3 4
                0
# 921 "project/radare2/libr/socket/run.c"
                     ;
     }
    }
...
# 927 "project/radare2/libr/socket/run.c" 3 4
    fprintf(__stderrp,
# 927 "project/radare2/libr/socket/run.c"
    "connected\n"
# 927 "project/radare2/libr/socket/run.c" 3 4
    )
# 927 "project/radare2/libr/socket/run.c"
...
# 930 "project/radare2/libr/socket/run.c" 3 4
      fprintf(__stderrp,
# 930 "project/radare2/libr/socket/run.c"
      "socket redirection failed\n"
# 930 "project/radare2/libr/socket/run.c" 3 4
      )
# 930 "project/radare2/libr/socket/run.c"
...
# 955 "project/radare2/libr/socket/run.c" 3 4
  fprintf(__stderrp,
# 955 "project/radare2/libr/socket/run.c"
...
# 959 "project/radare2/libr/socket/run.c" 3 4
   fprintf(__stderrp,
# 959 "project/radare2/libr/socket/run.c"
   "Cannot chroot to %s\n", p->_chroot
# 959 "project/radare2/libr/socket/run.c" 3 4
   )
# 959 "project/radare2/libr/socket/run.c"
...
# 964 "project/radare2/libr/socket/run.c" 3 4
    fprintf(__stderrp,
# 964 "project/radare2/libr/socket/run.c"
    "Cannot chdir to /\n"
# 964 "project/radare2/libr/socket/run.c" 3 4
    )
# 964 "project/radare2/libr/socket/run.c"
...
# 969 "project/radare2/libr/socket/run.c" 3 4
     fprintf(__stderrp,
# 969 "project/radare2/libr/socket/run.c"
...
# 977 "project/radare2/libr/socket/run.c" 3 4
  fprintf(__stderrp,
# 977 "project/radare2/libr/socket/run.c"
  "Cannot chdir after chroot to %s\n", p->_chgdir
# 977 "project/radare2/libr/socket/run.c" 3 4
  )
# 977 "project/radare2/libr/socket/run.c"
...
# 996 "project/radare2/libr/socket/run.c"
 if (p->_setuid) {
  ret = setgroups (0, 
# 997 "project/radare2/libr/socket/run.c" 3 4
                     ((void *)0)
# 997 "project/radare2/libr/socket/run.c"
                         );
  if (ret < 0) {
   return 1;
  }
...
# 1031 "project/radare2/libr/socket/run.c" 3 4
  fprintf(__stderrp,
# 1031 "project/radare2/libr/socket/run.c"
  "[ERROR] rarun2: Cannot create pipe\n"
# 1031 "project/radare2/libr/socket/run.c" 3 4
  )
# 1031 "project/radare2/libr/socket/run.c"
                                                  ;
...
# 1038 "project/radare2/libr/socket/run.c" 3 4
   fprintf(__stderrp,
# 1038 "project/radare2/libr/socket/run.c"
   "[ERROR] rarun2: Cannot write to the pipe\n"
# 1038 "project/radare2/libr/socket/run.c" 3 4
   )
# 1038 "project/radare2/libr/socket/run.c"
                                                         ;
...
# 1043 "project/radare2/libr/socket/run.c" 3 4
  fprintf(__stderrp,
# 1043 "project/radare2/libr/socket/run.c"
  "Invalid input\n"
# 1043 "project/radare2/libr/socket/run.c" 3 4
  )
# 1043 "project/radare2/libr/socket/run.c"
...
# 1049 "project/radare2/libr/socket/run.c" 3 4
  fprintf(__stderrp,
# 1049 "project/radare2/libr/socket/run.c"
...
# 1049 "project/radare2/libr/socket/run.c"
  ...
  p->_preload = strdup (
# 1054 "project/radare2/libr/socket/run.c" 3 4
                       "/usr/local/lib"
# 1054 "project/radare2/libr/socket/run.c"
                                "/libr2."
# 1054 "project/radare2/libr/socket/run.c" 3 4
                                         "dylib"
# 1054 "project/radare2/libr/socket/run.c"
 ...
 if (p->_libpath) {
# 1067 "project/radare2/libr/socket/run.c"
 ...
 if (p->_timeout) {
  ...
  if (!r_sys_fork ()) {
   ...
   if (use_signal < 1) {
    use_signal = 
# 1093 "project/radare2/libr/socket/run.c" 3 4
                9
# 1093 "project/radare2/libr/socket/run.c"
                       ;
   }
   sleep (p->_timeout);
   if (!kill (mypid, 0)) {
...
# 1114 "project/radare2/libr/socket/run.c" 3 4
__attribute__((visibility("default"))) 
# 1114 "project/radare2/libr/socket/run.c"
     int r_run_start(RRunProfile *p) {
...
# 1127 "project/radare2/libr/socket/run.c" 3 4
 unsigned int 
# 1127 "project/radare2/libr/socket/run.c"
      spflags = 0;
  spflags |= 
# 1128 "project/radare2/libr/socket/run.c" 3 4
            0x0040
# 1128 "project/radare2/libr/socket/run.c"
                               ;
  if (p->_aslr == 0) {
  ...
  if (p->_bits) {
   ...
   cpu = 
# 1138 "project/radare2/libr/socket/run.c" 3 4
        ((cpu_type_t) 7)
# 1138 "project/radare2/libr/socket/run.c"
                     ;
   if (p->_bits == 64) {
    cpu |= 
# 1140 "project/radare2/libr/socket/run.c" 3 4
          0x01000000
# 1140 "project/radare2/libr/socket/run.c"
                        ;
   }
...
# 1149 "project/radare2/libr/socket/run.c" 3 4
  ((void *)0)
# 1149 "project/radare2/libr/socket/run.c"
      , &attr, p->_args, envp);
  switch (ret) {
  case 0:
   break;
...
# 1154 "project/radare2/libr/socket/run.c" 3 4
  fprintf(__stderrp,
# 1154 "project/radare2/libr/socket/run.c"
...
# 1157 "project/radare2/libr/socket/run.c" 3 4
  fprintf(__stderrp,
# 1157 "project/radare2/libr/socket/run.c"
  "posix_spawnp: Unsupported architecture\n"
# 1157 "project/radare2/libr/socket/run.c" 3 4
  )
# 1157 "project/radare2/libr/socket/run.c"
                                                      ;
...
# 1160 "project/radare2/libr/socket/run.c" 3 4
  fprintf(__stderrp,
# 1160 "project/radare2/libr/socket/run.c"
...
# 1169 "project/radare2/libr/socket/run.c" 3 4
  fprintf(__stderrp,
# 1169 "project/radare2/libr/socket/run.c"
...
# 1183 "project/radare2/libr/socket/run.c" 3 4
    __builtin___snprintf_chk (
# 1183 "project/radare2/libr/socket/run.c"
    pidstr
# 1183 "project/radare2/libr/socket/run.c" 3 4
    , 
# 1183 "project/radare2/libr/socket/run.c"
...
# 1183 "project/radare2/libr/socket/run.c"
     ...
     r_file_dump (p->_pidfile,
       (const 
# 1185 "project/radare2/libr/socket/run.c" 3 4
             unsigned char
# 1185 "project/radare2/libr/socket/run.c"
                *)pidstr,
       strlen (pidstr), 0);
    }
    exit (0);
   ...
   if (p->_timeout) {
    ...
    if (!r_sys_fork ()) {
     ...
     if (use_signal < 1) {
      use_signal = 
# 1199 "project/radare2/libr/socket/run.c" 3 4
                  9
# 1199 "project/radare2/libr/socket/run.c"
                         ;
     }
     sleep (p->_timeout);
   ...
   if (bin_sh) {
    exit (execl (bin_sh, bin_sh, "-c", p->_system, 
# 1220 "project/radare2/libr/socket/run.c" 3 4
                                                  ((void *)0)
# 1220 "project/radare2/libr/socket/run.c"
                                                      ));
   } else {
...
# 1230 "project/radare2/libr/socket/run.c" 3 4
   fprintf(__stderrp,
# 1230 "project/radare2/libr/socket/run.c"
...
# 1243 "project/radare2/libr/socket/run.c" 3 4
   fprintf(__stderrp,
# 1243 "project/radare2/libr/socket/run.c"
   "rarun2: %s: file not found\n", p->_program
# 1243 "project/radare2/libr/socket/run.c" 3 4
   )
# 1243 "project/radare2/libr/socket/run.c"
                                                        ;
...
# 1266 "project/radare2/libr/socket/run.c" 3 4
  fprintf(__stderrp,
# 1266 "project/radare2/libr/socket/run.c"
  "PID: %d\n", r_sys_getpid ()
# 1266 "project/radare2/libr/socket/run.c" 3 4
  )
# 1266 "project/radare2/libr/socket/run.c"
...
# 1270 "project/radare2/libr/socket/run.c" 3 4
  __builtin___snprintf_chk (
# 1270 "project/radare2/libr/socket/run.c"
  pidstr
# 1270 "project/radare2/libr/socket/run.c" 3 4
  , 
# 1270 "project/radare2/libr/socket/run.c"
...
# 1270 "project/radare2/libr/socket/run.c"
   ...
   r_file_dump (p->_pidfile,
    (const 
# 1272 "project/radare2/libr/socket/run.c" 3 4
          unsigned char
# 1272 "project/radare2/libr/socket/run.c"
             *)pidstr,
    strlen (pidstr), 0);
  }
...
# 1298 "project/radare2/libr/socket/run.c" 3 4
    __builtin___snprintf_chk (
# 1298 "project/radare2/libr/socket/run.c"
    pidstr
# 1298 "project/radare2/libr/socket/run.c" 3 4
    , 
# 1298 "project/radare2/libr/socket/run.c"
...
# 1298 "project/radare2/libr/socket/run.c"
     ...
     r_file_dump (p->_pidfile,
       (const 
# 1300 "project/radare2/libr/socket/run.c" 3 4
             unsigned char
# 1300 "project/radare2/libr/socket/run.c"
                *)pidstr,
       strlen (pidstr), 0);
     exit (0);
    }
...
# 1320 "project/radare2/libr/socket/run.c" 3 4
  fprintf(__stderrp,
# 1320 "project/radare2/libr/socket/run.c"
...
# 1325 "project/radare2/libr/socket/run.c" 3 4
  fprintf(__stderrp,
# 1325 "project/radare2/libr/socket/run.c"
...
# 1330 "project/radare2/libr/socket/run.c" 3 4
  fprintf(__stderrp,
# 1330 "project/radare2/libr/socket/run.c"
...
# 1374 "project/radare2/libr/socket/run.c" 3 4
  fprintf(__stderrp,
# 1374 "project/radare2/libr/socket/run.c"
  "Too many arguments.\n"
# 1374 "project/radare2/libr/socket/run.c" 3 4
  )
# 1374 "project/radare2/libr/socket/run.c"
...
# 1382 "project/radare2/libr/socket/run.c" 3 4
__attribute__((visibility("default"))) 
# 1382 "project/radare2/libr/socket/run.c"
     char *r_run_get_environ_profile(char **env) {
 if (!env) {
  return 
# 1384 "project/radare2/libr/socket/run.c" 3 4
        ((void *)0)
# 1384 "project/radare2/libr/socket/run.c"
            ;
 }
 RStrBuf *sb = r_strbuf_new (
# 1386 "project/radare2/libr/socket/run.c" 3 4
                            ((void *)0)
# 1386 "project/radare2/libr/socket/run.c"
                                );
 while (*env) {
  char *k = strdup (*env);
  char *v = strchr (k, '=');
  if (v) {
   *v++ = 0;
   v = r_str_escape_latin1 (v, 
# 1392 "project/radare2/libr/socket/run.c" 3 4
                              0
# 1392 "project/radare2/libr/socket/run.c"
                                   , 
# 1392 "project/radare2/libr/socket/run.c" 3 4
                                     1
# 1392 "project/radare2/libr/socket/run.c"
