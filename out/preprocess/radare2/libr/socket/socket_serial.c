# 0 "project/radare2/libr/socket/socket_serial.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/socket/socket_serial.c" 2
...
# 5 "project/radare2/libr/socket/socket_serial.c" 2
...
# 9 "project/radare2/libr/socket/socket_serial.c" 2

# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/fcntl.h" 1 3 4
# 11 "project/radare2/libr/socket/socket_serial.c" 2
...
# 12 "project/radare2/libr/socket/socket_serial.c" 2


# 13 "project/radare2/libr/socket/socket_serial.c"
static int set_interface_attribs (int fd, int speed, int parity) {
 struct termios tty;
 
# 15 "project/radare2/libr/socket/socket_serial.c" 3 4
__builtin___memset_chk (
# 15 "project/radare2/libr/socket/socket_serial.c"
&tty
# 15 "project/radare2/libr/socket/socket_serial.c" 3 4
, 
# 15 "project/radare2/libr/socket/socket_serial.c"
...
# 22 "project/radare2/libr/socket/socket_serial.c" 3 4
                              0x00000300
# 22 "project/radare2/libr/socket/socket_serial.c"
                                   ) | 
# 22 "project/radare2/libr/socket/socket_serial.c" 3 4
                                       0x00000300
# 22 "project/radare2/libr/socket/socket_serial.c"
 ...
 tty.c_iflag &= ~
# 25 "project/radare2/libr/socket/socket_serial.c" 3 4
                0x00000001
# 25 "project/radare2/libr/socket/socket_serial.c"
                      ;
 tty.c_lflag = 0;

 tty.c_oflag = 0;
 tty.c_cc[
# 29 "project/radare2/libr/socket/socket_serial.c" 3 4
         16
# 29 "project/radare2/libr/socket/socket_serial.c"
             ] = 0;
 tty.c_cc[
# 30 "project/radare2/libr/socket/socket_serial.c" 3 4
         17
# 30 "project/radare2/libr/socket/socket_serial.c"
              ] = 5;

 tty.c_iflag &= ~(
# 32 "project/radare2/libr/socket/socket_serial.c" 3 4
                 0x00000200 
# 32 "project/radare2/libr/socket/socket_serial.c"
                      | 
# 32 "project/radare2/libr/socket/socket_serial.c" 3 4
                        0x00000400 
# 32 "project/radare2/libr/socket/socket_serial.c"
...
# 32 "project/radare2/libr/socket/socket_serial.c"
 ...
 tty.c_cflag |= (
# 34 "project/radare2/libr/socket/socket_serial.c" 3 4
                0x00008000 
# 34 "project/radare2/libr/socket/socket_serial.c"
                       | 
# 34 "project/radare2/libr/socket/socket_serial.c" 3 4
                         0x00000800
# 34 "project/radare2/libr/socket/socket_serial.c"
 ...
 tty.c_cflag &= ~(
# 36 "project/radare2/libr/socket/socket_serial.c" 3 4
                 0x00001000 
# 36 "project/radare2/libr/socket/socket_serial.c"
                        | 
# 36 "project/radare2/libr/socket/socket_serial.c" 3 4
                          0x00002000
# 36 "project/radare2/libr/socket/socket_serial.c"
 ...
 tty.c_cflag |= parity;
 tty.c_cflag &= ~
# 38 "project/radare2/libr/socket/socket_serial.c" 3 4
                0x00000400
# 38 "project/radare2/libr/socket/socket_serial.c"
                      ;

 tty.c_cflag &= ~
# 40 "project/radare2/libr/socket/socket_serial.c" 3 4
                (0x00010000 | 0x00020000)
# 40 "project/radare2/libr/socket/socket_serial.c"
                       ;


 if (tcsetattr (fd, 
# 43 "project/radare2/libr/socket/socket_serial.c" 3 4
                   0
# 43 "project/radare2/libr/socket/socket_serial.c"
                          , &tty) != 0) {
  return -1;
 }
 return 0;
...
# 49 "project/radare2/libr/socket/socket_serial.c" 3 4
__attribute__((visibility("default"))) 
# 49 "project/radare2/libr/socket/socket_serial.c"
     int r_socket_connect_serial(RSocket *sock, const char *path, int speed, int parity) {
 int fd = r_sandbox_open (path, 
# 50 "project/radare2/libr/socket/socket_serial.c" 3 4
                               0x0002 
# 50 "project/radare2/libr/socket/socket_serial.c"
                                      | 
# 50 "project/radare2/libr/socket/socket_serial.c" 3 4
                                        0
# 50 "project/radare2/libr/socket/socket_serial.c"
