# 0 "project/radare2/libr/socket/socket_rap_client.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/socket/socket_rap_client.c" 2
...
# 5 "project/radare2/libr/socket/socket_rap_client.c" 2


# 6 "project/radare2/libr/socket/socket_rap_client.c"
static 
# 6 "project/radare2/libr/socket/socket_rap_client.c" 3 4
      unsigned char 
# 6 "project/radare2/libr/socket/socket_rap_client.c"
          *r_rap_packet(
# 6 "project/radare2/libr/socket/socket_rap_client.c" 3 4
...
# 7 "project/radare2/libr/socket/socket_rap_client.c" 3 4
unsigned char 
# 7 "project/radare2/libr/socket/socket_rap_client.c"
    *buf = malloc (len + 5);
 if (buf) {
  buf[0] = type;
...
static void r_rap_packet_fill(
# 15 "project/radare2/libr/socket/socket_rap_client.c" 3 4
                             unsigned char 
# 15 "project/radare2/libr/socket/socket_rap_client.c"
                                 *buf, const 
# 15 "project/radare2/libr/socket/socket_rap_client.c" 3 4
                                             unsigned char
# 15 "project/radare2/libr/socket/socket_rap_client.c"
...
# 17 "project/radare2/libr/socket/socket_rap_client.c" 3 4
 unsigned int 
# 17 "project/radare2/libr/socket/socket_rap_client.c"
      curlen = r_read_be32 (buf + 1);
  
# 18 "project/radare2/libr/socket/socket_rap_client.c" 3 4
 __builtin___memcpy_chk (
# 18 "project/radare2/libr/socket/socket_rap_client.c"
 buf + 5
# 18 "project/radare2/libr/socket/socket_rap_client.c" 3 4
 , 
# 18 "project/radare2/libr/socket/socket_rap_client.c"
...
# 22 "project/radare2/libr/socket/socket_rap_client.c" 3 4
__attribute__((visibility("default"))) 
# 22 "project/radare2/libr/socket/socket_rap_client.c"
     int r_socket_rap_client_open(RSocket *s, const char *file, int rw) {
 r_socket_block_time (s, 
# 23 "project/radare2/libr/socket/socket_rap_client.c" 3 4
                        1
# 23 "project/radare2/libr/socket/socket_rap_client.c"
                            , 1, 0);
 size_t file_len0 = strlen (file) + 1;
 if (file_len0 > 255) {
  
# 26 "project/radare2/libr/socket/socket_rap_client.c" 3 4
 fprintf(__stderrp,
# 26 "project/radare2/libr/socket/socket_rap_client.c"
 "Filename too long\n"
# 26 "project/radare2/libr/socket/socket_rap_client.c" 3 4
 )
# 26 "project/radare2/libr/socket/socket_rap_client.c"
 ...
 buf[1] = rw;
 buf[2] = (
# 36 "project/radare2/libr/socket/socket_rap_client.c" 3 4
          unsigned char
# 36 "project/radare2/libr/socket/socket_rap_client.c"
             )(file_len0 & 0xff);
 
# 37 "project/radare2/libr/socket/socket_rap_client.c" 3 4
__builtin___memcpy_chk (
# 37 "project/radare2/libr/socket/socket_rap_client.c"
buf + 3
# 37 "project/radare2/libr/socket/socket_rap_client.c" 3 4
, 
# 37 "project/radare2/libr/socket/socket_rap_client.c"
...
# 42 "project/radare2/libr/socket/socket_rap_client.c" 3 4
__builtin___memset_chk (
# 42 "project/radare2/libr/socket/socket_rap_client.c"
buf
# 42 "project/radare2/libr/socket/socket_rap_client.c" 3 4
, 
# 42 "project/radare2/libr/socket/socket_rap_client.c"
...
# 42 "project/radare2/libr/socket/socket_rap_client.c"
                  ;
 int r = r_socket_read_block (s, (
# 43 "project/radare2/libr/socket/socket_rap_client.c" 3 4
                                 unsigned char
# 43 "project/radare2/libr/socket/socket_rap_client.c"
                                    *)buf, 5);
 if (r == 5) {
...
# 48 "project/radare2/libr/socket/socket_rap_client.c" 3 4
  fprintf(__stderrp,
# 48 "project/radare2/libr/socket/socket_rap_client.c"
...
# 51 "project/radare2/libr/socket/socket_rap_client.c" 3 4
 fprintf(__stderrp,
# 51 "project/radare2/libr/socket/socket_rap_client.c"
...
# 57 "project/radare2/libr/socket/socket_rap_client.c" 3 4
__attribute__((visibility("default"))) 
# 57 "project/radare2/libr/socket/socket_rap_client.c"
     char *r_socket_rap_client_command(RSocket *s, const char *cmd, RCoreBind *c) {
 char *buf = malloc (strlen (cmd) + 8);
 if (!buf) {
  return 
# 60 "project/radare2/libr/socket/socket_rap_client.c" 3 4
        ((void *)0)
# 60 "project/radare2/libr/socket/socket_rap_client.c"
            ;
 }
...
# 66 "project/radare2/libr/socket/socket_rap_client.c" 3 4
__builtin___memcpy_chk (
# 66 "project/radare2/libr/socket/socket_rap_client.c"
buf + 5
# 66 "project/radare2/libr/socket/socket_rap_client.c" 3 4
, 
# 66 "project/radare2/libr/socket/socket_rap_client.c"
...
# 66 "project/radare2/libr/socket/socket_rap_client.c"
 ...
 char bufr[8];
 r_socket_read_block (s, (
# 72 "project/radare2/libr/socket/socket_rap_client.c" 3 4
                         unsigned char
# 72 "project/radare2/libr/socket/socket_rap_client.c"
                            *)bufr, 5);
 while (bufr[0] == (char)(RAP_PACKET_CMD)) {
  ...
  if (rcmd) {
   r_socket_read_block (s, (
# 77 "project/radare2/libr/socket/socket_rap_client.c" 3 4
                           unsigned char
# 77 "project/radare2/libr/socket/socket_rap_client.c"
                              *)rcmd, cmd_len);
...
# 82 "project/radare2/libr/socket/socket_rap_client.c" 3 4
   unsigned char 
# 82 "project/radare2/libr/socket/socket_rap_client.c"
       *pkt = r_rap_packet ((RAP_PACKET_CMD | RAP_PACKET_REPLY), res_len);
    r_rap_packet_fill (pkt, (const 
# 83 "project/radare2/libr/socket/socket_rap_client.c" 3 4
                                  unsigned char
# 83 "project/radare2/libr/socket/socket_rap_client.c"
                                     *)res, res_len);
  ...
  bufr[0] = -1;
  (void) r_socket_read_block (s, (
# 93 "project/radare2/libr/socket/socket_rap_client.c" 3 4
                                 unsigned char
# 93 "project/radare2/libr/socket/socket_rap_client.c"
                                    *)bufr, 5);
 }
 if (bufr[0] != (char)(RAP_PACKET_CMD | RAP_PACKET_REPLY)) {
  
# 96 "project/radare2/libr/socket/socket_rap_client.c" 3 4
 fprintf(__stderrp,
# 96 "project/radare2/libr/socket/socket_rap_client.c"
...
# 96 "project/radare2/libr/socket/socket_rap_client.c"
                                                             ;
  return 
# 97 "project/radare2/libr/socket/socket_rap_client.c" 3 4
        ((void *)0)
# 97 "project/radare2/libr/socket/socket_rap_client.c"
            ;
 }
 size_t cmd_len = r_read_at_be32 (bufr, 1);
 if (cmd_len < 1 || cmd_len > 16384) {
  
# 101 "project/radare2/libr/socket/socket_rap_client.c" 3 4
 fprintf(__stderrp,
# 101 "project/radare2/libr/socket/socket_rap_client.c"
...
# 101 "project/radare2/libr/socket/socket_rap_client.c"
                                      ;
  return 
# 102 "project/radare2/libr/socket/socket_rap_client.c" 3 4
        ((void *)0)
# 102 "project/radare2/libr/socket/socket_rap_client.c"
            ;
 }
 char *cmd_output = calloc (1, cmd_len + 1);
 if (!cmd_output) {
  
# 106 "project/radare2/libr/socket/socket_rap_client.c" 3 4
 fprintf(__stderrp,
# 106 "project/radare2/libr/socket/socket_rap_client.c"
...
# 106 "project/radare2/libr/socket/socket_rap_client.c"
                                           ;
  return 
# 107 "project/radare2/libr/socket/socket_rap_client.c" 3 4
        ((void *)0)
# 107 "project/radare2/libr/socket/socket_rap_client.c"
            ;
 }
 r_socket_read_block (s, (
# 109 "project/radare2/libr/socket/socket_rap_client.c" 3 4
                         unsigned char
# 109 "project/radare2/libr/socket/socket_rap_client.c"
                            *)cmd_output, cmd_len);
...
# 115 "project/radare2/libr/socket/socket_rap_client.c" 3 4
__attribute__((visibility("default"))) 
# 115 "project/radare2/libr/socket/socket_rap_client.c"
     int r_socket_rap_client_write(RSocket *s, const 
# 115 "project/radare2/libr/socket/socket_rap_client.c" 3 4
                                                     unsigned char 
# 115 "project/radare2/libr/socket/socket_rap_client.c"
                                                         *buf, int count) {
 
# 116 "project/radare2/libr/socket/socket_rap_client.c" 3 4
unsigned char 
# 116 "project/radare2/libr/socket/socket_rap_client.c"
    *tmp;
 int ret;
 if (count < 1) {
  return count;
 ...
 if (!(tmp = (
# 125 "project/radare2/libr/socket/socket_rap_client.c" 3 4
             unsigned char 
# 125 "project/radare2/libr/socket/socket_rap_client.c"
                 *)malloc (count + 5))) {
  
# 126 "project/radare2/libr/socket/socket_rap_client.c" 3 4
 fprintf(__stderrp,
# 126 "project/radare2/libr/socket/socket_rap_client.c"
...
# 131 "project/radare2/libr/socket/socket_rap_client.c" 3 4
__builtin___memcpy_chk (
# 131 "project/radare2/libr/socket/socket_rap_client.c"
tmp + 5
# 131 "project/radare2/libr/socket/socket_rap_client.c" 3 4
, 
# 131 "project/radare2/libr/socket/socket_rap_client.c"
...
# 136 "project/radare2/libr/socket/socket_rap_client.c" 3 4
 fprintf(__stderrp,
# 136 "project/radare2/libr/socket/socket_rap_client.c"
 "__rap_write: error\n"
# 136 "project/radare2/libr/socket/socket_rap_client.c" 3 4
 )
# 136 "project/radare2/libr/socket/socket_rap_client.c"
...
# 148 "project/radare2/libr/socket/socket_rap_client.c" 3 4
__attribute__((visibility("default"))) 
# 148 "project/radare2/libr/socket/socket_rap_client.c"
     int r_socket_rap_client_read(RSocket *s, 
# 148 "project/radare2/libr/socket/socket_rap_client.c" 3 4
                                              unsigned char 
# 148 "project/radare2/libr/socket/socket_rap_client.c"
                                                  *buf, int count) {
 
# 149 "project/radare2/libr/socket/socket_rap_client.c" 3 4
unsigned char 
# 149 "project/radare2/libr/socket/socket_rap_client.c"
    tmp[32];
 if (count < 1) {
  return count;
 }
...
# 166 "project/radare2/libr/socket/socket_rap_client.c" 3 4
 fprintf(__stderrp,
# 166 "project/radare2/libr/socket/socket_rap_client.c"
 "__rap_read: Unexpected rap read reply " "(%d=0x%02x) expected (%d=0x%02x)\n", ret, tmp[0], 2, (RAP_PACKET_READ | RAP_PACKET_REPLY)
# 166 "project/radare2/libr/socket/socket_rap_client.c" 3 4
 )

                                                        
# 168 "project/radare2/libr/socket/socket_rap_client.c"
                                                       ;
  return -1;
 }
...
# 173 "project/radare2/libr/socket/socket_rap_client.c" 3 4
 fprintf(__stderrp,
# 173 "project/radare2/libr/socket/socket_rap_client.c"
...
# 180 "project/radare2/libr/socket/socket_rap_client.c" 3 4
__attribute__((visibility("default"))) 
# 180 "project/radare2/libr/socket/socket_rap_client.c"
     int r_socket_rap_client_seek(RSocket *s, 
# 180 "project/radare2/libr/socket/socket_rap_client.c" 3 4
                                              unsigned long long 
# 180 "project/radare2/libr/socket/socket_rap_client.c"
                                                   offset, int whence) {
 
# 181 "project/radare2/libr/socket/socket_rap_client.c" 3 4
unsigned char 
# 181 "project/radare2/libr/socket/socket_rap_client.c"
    tmp[10];
 tmp[0] = RAP_PACKET_SEEK;
 tmp[1] = (
# 183 "project/radare2/libr/socket/socket_rap_client.c" 3 4
          unsigned char
# 183 "project/radare2/libr/socket/socket_rap_client.c"
             )whence;
 r_write_be64 (tmp + 2, offset);
 (void)r_socket_write (s, &tmp, 10);
 r_socket_flush (s);
 int ret = r_socket_read_block (s, (
# 187 "project/radare2/libr/socket/socket_rap_client.c" 3 4
                                   unsigned char
# 187 "project/radare2/libr/socket/socket_rap_client.c"
                                      *)&tmp, 9);
 if (ret != 9) {
  
# 189 "project/radare2/libr/socket/socket_rap_client.c" 3 4
 fprintf(__stderrp,
# 189 "project/radare2/libr/socket/socket_rap_client.c"
...
# 195 "project/radare2/libr/socket/socket_rap_client.c" 3 4
 fprintf(__stderrp,
# 195 "project/radare2/libr/socket/socket_rap_client.c"
 "Unexpected seek reply (%02x -> %02x)\n", tmp[0], (RAP_PACKET_SEEK | RAP_PACKET_REPLY)
# 195 "project/radare2/libr/socket/socket_rap_client.c" 3 4
 )
# 195 "project/radare2/libr/socket/socket_rap_client.c"
                                                                                                 ;
