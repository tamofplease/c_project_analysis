# 0 "project/radare2/libr/socket/socket_http_server.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/socket/socket_http_server.c"
...
# 4 "project/radare2/libr/socket/socket_http_server.c" 2
...
# 5 "project/radare2/libr/socket/socket_http_server.c" 2


# 6 "project/radare2/libr/socket/socket_http_server.c"
static 
# 6 "project/radare2/libr/socket/socket_http_server.c" 3 4
      _Bool 
# 6 "project/radare2/libr/socket/socket_http_server.c"
           *breaked = 
# 6 "project/radare2/libr/socket/socket_http_server.c" 3 4
...
# 8 "project/radare2/libr/socket/socket_http_server.c" 3 4
__attribute__((visibility("default"))) 
# 8 "project/radare2/libr/socket/socket_http_server.c"
     void r_socket_http_server_set_breaked(
# 8 "project/radare2/libr/socket/socket_http_server.c" 3 4
                                           _Bool 
# 8 "project/radare2/libr/socket/socket_http_server.c"
                                                *b) {
...
# 12 "project/radare2/libr/socket/socket_http_server.c" 3 4
__attribute__((visibility("default"))) 
# 12 "project/radare2/libr/socket/socket_http_server.c"
     RSocketHTTPRequest *r_socket_http_accept (RSocket *s, RSocketHTTPOptions *so) {
 int content_length = 0, xx, yy;
 int pxx = 1, first = 0;
 char buf[1500], *p, *q;
 RSocketHTTPRequest *hr = 
# 16 "project/radare2/libr/socket/socket_http_server.c" 3 4
                         (
# 16 "project/radare2/libr/socket/socket_http_server.c"
                         RSocketHTTPRequest
# 16 "project/radare2/libr/socket/socket_http_server.c" 3 4
                         *)calloc(1,sizeof(
# 16 "project/radare2/libr/socket/socket_http_server.c"
...
# 16 "project/radare2/libr/socket/socket_http_server.c"
 ...
 if (!hr) {
  return 
# 18 "project/radare2/libr/socket/socket_http_server.c" 3 4
        ((void *)0)
# 18 "project/radare2/libr/socket/socket_http_server.c"
            ;
 }
 ...
 if (!hr->s) {
  free (hr);
  return 
# 27 "project/radare2/libr/socket/socket_http_server.c" 3 4
        ((void *)0)
# 27 "project/radare2/libr/socket/socket_http_server.c"
            ;
 }
 if (so->timeout > 0) {
  r_socket_block_time (hr->s, 
# 30 "project/radare2/libr/socket/socket_http_server.c" 3 4
                             1
# 30 "project/radare2/libr/socket/socket_http_server.c"
                                 , so->timeout, 0);
 }
 hr->auth = !so->httpauth;
 for (;;) {
...
# 40 "project/radare2/libr/socket/socket_http_server.c" 3 4
 __builtin___memset_chk (
# 40 "project/radare2/libr/socket/socket_http_server.c"
 buf
# 40 "project/radare2/libr/socket/socket_http_server.c" 3 4
 , 
# 40 "project/radare2/libr/socket/socket_http_server.c"
...
# 40 "project/radare2/libr/socket/socket_http_server.c"
  ...
  yy = r_socket_ready (hr->s, 0, 20 * 1000);
  ...
  if (first == 0) {
   ...
   if (strlen (buf)<3) {
    ...
    free (hr);
    return 
# 54 "project/radare2/libr/socket/socket_http_server.c" 3 4
          ((void *)0)
# 54 "project/radare2/libr/socket/socket_http_server.c"
              ;
   }
   p = strchr (buf, ' ');
   if (p) {
...
# 84 "project/radare2/libr/socket/socket_http_server.c" 3 4
    fprintf(__stderrp,
# 84 "project/radare2/libr/socket/socket_http_server.c"
...
# 84 "project/radare2/libr/socket/socket_http_server.c"
    ...
    if (r_base64_decode ((
# 88 "project/radare2/libr/socket/socket_http_server.c" 3 4
                         unsigned char 
# 88 "project/radare2/libr/socket/socket_http_server.c"
                             *)decauthtoken, authtoken, authlen) == -1) {
     
# 89 "project/radare2/libr/socket/socket_http_server.c" 3 4
    fprintf(__stderrp,
# 89 "project/radare2/libr/socket/socket_http_server.c"
...
# 91 "project/radare2/libr/socket/socket_http_server.c" 3 4
    if (
# 91 "project/radare2/libr/socket/socket_http_server.c"
    so->authtokens
# 91 "project/radare2/libr/socket/socket_http_server.c" 3 4
    ) for (
# 91 "project/radare2/libr/socket/socket_http_server.c"
...
# 91 "project/radare2/libr/socket/socket_http_server.c"
      ...
      if (!strcmp (decauthtoken, curauthtoken)) {
       hr->auth = 
# 93 "project/radare2/libr/socket/socket_http_server.c" 3 4
                 1
# 93 "project/radare2/libr/socket/socket_http_server.c"
                     ;
       break;
      }
     }
...
# 102 "project/radare2/libr/socket/socket_http_server.c" 3 4
    fprintf(__stderrp,
# 102 "project/radare2/libr/socket/socket_http_server.c"
...
# 102 "project/radare2/libr/socket/socket_http_server.c"
 ...
 if (content_length > 0) {
  r_socket_read_block (hr->s, (
# 108 "project/radare2/libr/socket/socket_http_server.c" 3 4
                              unsigned char
# 108 "project/radare2/libr/socket/socket_http_server.c"
                                 *)buf, 1);
  if (
# 109 "project/radare2/libr/socket/socket_http_server.c" 3 4
     ((((
# 109 "project/radare2/libr/socket/socket_http_server.c"
     1
# 109 "project/radare2/libr/socket/socket_http_server.c" 3 4
     ) > 0) && ((
# 109 "project/radare2/libr/socket/socket_http_server.c"
...
# 111 "project/radare2/libr/socket/socket_http_server.c" 3 4
  fprintf(__stderrp,
# 111 "project/radare2/libr/socket/socket_http_server.c"
...
# 111 "project/radare2/libr/socket/socket_http_server.c"
                                          ;
   return 
# 112 "project/radare2/libr/socket/socket_http_server.c" 3 4
         ((void *)0)
# 112 "project/radare2/libr/socket/socket_http_server.c"
             ;
  }
...
# 124 "project/radare2/libr/socket/socket_http_server.c" 3 4
__attribute__((visibility("default"))) 
# 124 "project/radare2/libr/socket/socket_http_server.c"
     void r_socket_http_response(RSocketHTTPRequest *rs, int code, const char *out, int len, const char *headers) {
 const char *strcode =
  code==200?"ok":
...
# 147 "project/radare2/libr/socket/socket_http_server.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 147 "project/radare2/libr/socket/socket_http_server.c"
         *r_socket_http_handle_upload(const 
# 147 "project/radare2/libr/socket/socket_http_server.c" 3 4
                                            unsigned char 
# 147 "project/radare2/libr/socket/socket_http_server.c"
                                                *str, int len, int *retlen) {
 if (retlen) {
  *retlen = 0;
 }
 if (!strncmp ((const char *)str, "----------", 10)) {
  ...
  if (!end) {
   return 
# 157 "project/radare2/libr/socket/socket_http_server.c" 3 4
         ((void *)0)
# 157 "project/radare2/libr/socket/socket_http_server.c"
             ;
  }
  ...
  if (data) {
   ...
   if (!ret) {
    return 
# 180 "project/radare2/libr/socket/socket_http_server.c" 3 4
          ((void *)0)
# 180 "project/radare2/libr/socket/socket_http_server.c"
              ;
   }
   
# 182 "project/radare2/libr/socket/socket_http_server.c" 3 4
  __builtin___memcpy_chk (
# 182 "project/radare2/libr/socket/socket_http_server.c"
  ret
# 182 "project/radare2/libr/socket/socket_http_server.c" 3 4
  , 
# 182 "project/radare2/libr/socket/socket_http_server.c"
...
# 182 "project/radare2/libr/socket/socket_http_server.c"
   ...
   return (
# 187 "project/radare2/libr/socket/socket_http_server.c" 3 4
          unsigned char
# 187 "project/radare2/libr/socket/socket_http_server.c"
             *)ret;
  }
 }
 return 
# 190 "project/radare2/libr/socket/socket_http_server.c" 3 4
       ((void *)0)
# 190 "project/radare2/libr/socket/socket_http_server.c"
           ;
}


# 193 "project/radare2/libr/socket/socket_http_server.c" 3 4
__attribute__((visibility("default"))) 
# 193 "project/radare2/libr/socket/socket_http_server.c"
     void r_socket_http_close(RSocketHTTPRequest *rs) {
 r_socket_close (rs->s);
}



# 198 "project/radare2/libr/socket/socket_http_server.c" 3 4
__attribute__((visibility("default"))) 
# 198 "project/radare2/libr/socket/socket_http_server.c"
     void r_socket_http_free(RSocketHTTPRequest *rs) {
 r_socket_free (rs->s);
 free (rs->path);
 free (rs->host);
 free (rs->agent);
