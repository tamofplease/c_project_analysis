# 0 "project/radare2/libr/asm/arch/pic/pic_baseline.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/arch/pic/pic_baseline.c"


# 1 "project/radare2/libr/asm/arch/pic/pic_baseline.h" 1
...
typedef int RRef;
# 7 "project/radare2/libr/asm/arch/pic/pic_baseline.h" 2
...
# 8 "project/radare2/libr/asm/arch/pic/pic_baseline.h" 2


# 9 "project/radare2/libr/asm/arch/pic/pic_baseline.h"
typedef enum {
...
# 32 "project/radare2/libr/asm/arch/pic/pic_baseline.h"
...
# 77 "project/radare2/libr/asm/arch/pic/pic_baseline.h" 3 4
                                         unsigned short 
# 77 "project/radare2/libr/asm/arch/pic/pic_baseline.h"
                                              instr);
...
# 79 "project/radare2/libr/asm/arch/pic/pic_baseline.h" 3 4
                                                           unsigned char 
# 79 "project/radare2/libr/asm/arch/pic/pic_baseline.h"
                                                               *b, int l);
# 4 "project/radare2/libr/asm/arch/pic/pic_baseline.c" 2
...
PicBaselineOpcode pic_baseline_get_opcode(
# 44 "project/radare2/libr/asm/arch/pic/pic_baseline.c" 3 4
                                         unsigned short 
# 44 "project/radare2/libr/asm/arch/pic/pic_baseline.c"
                                              instr) {
 if (instr & 0xf000) {
...
const PicBaselineOpInfo *pic_baseline_get_op_info(PicBaselineOpcode opcode) {
 if (opcode >= PIC_BASELINE_OPCODE_INVALID) {
  return 
# 188 "project/radare2/libr/asm/arch/pic/pic_baseline.c" 3 4
        ((void *)0)
# 188 "project/radare2/libr/asm/arch/pic/pic_baseline.c"
            ;
 }
...
int pic_baseline_disassemble(RAsmOp *op, char *opbuf, const 
# 194 "project/radare2/libr/asm/arch/pic/pic_baseline.c" 3 4
                                                           unsigned char 
# 194 "project/radare2/libr/asm/arch/pic/pic_baseline.c"
                                                               *b, int l) {
 ...
 if (!b || l < 2) {
  { op->size = 1; 
# 201 "project/radare2/libr/asm/arch/pic/pic_baseline.c" 3 4
 __builtin___strcpy_chk (
# 201 "project/radare2/libr/asm/arch/pic/pic_baseline.c"
 opbuf
# 201 "project/radare2/libr/asm/arch/pic/pic_baseline.c" 3 4
 , 
# 201 "project/radare2/libr/asm/arch/pic/pic_baseline.c"
...
# 204 "project/radare2/libr/asm/arch/pic/pic_baseline.c" 3 4
unsigned short 
# 204 "project/radare2/libr/asm/arch/pic/pic_baseline.c"
     instr = r_read_le16 (b);
 PicBaselineOpcode opcode = pic_baseline_get_opcode (instr);
 if (opcode == PIC_BASELINE_OPCODE_INVALID) {
  { op->size = 1; 
# 207 "project/radare2/libr/asm/arch/pic/pic_baseline.c" 3 4
 __builtin___strcpy_chk (
# 207 "project/radare2/libr/asm/arch/pic/pic_baseline.c"
 opbuf
# 207 "project/radare2/libr/asm/arch/pic/pic_baseline.c" 3 4
 , 
# 207 "project/radare2/libr/asm/arch/pic/pic_baseline.c"
...
# 207 "project/radare2/libr/asm/arch/pic/pic_baseline.c"
 ...
 if (!op_info) {
  { op->size = 1; 
# 212 "project/radare2/libr/asm/arch/pic/pic_baseline.c" 3 4
 __builtin___strcpy_chk (
# 212 "project/radare2/libr/asm/arch/pic/pic_baseline.c"
 opbuf
# 212 "project/radare2/libr/asm/arch/pic/pic_baseline.c" 3 4
 , 
# 212 "project/radare2/libr/asm/arch/pic/pic_baseline.c"
...
# 212 "project/radare2/libr/asm/arch/pic/pic_baseline.c"
 ...
 case PIC_BASELINE_OP_ARGS_3F:
  buf_asm = sdb_fmt ("%s 0x%x", op_info->mnemonic, instr & 0x7);
  break;
 case PIC_BASELINE_OP_ARGS_3K:
  buf_asm = sdb_fmt ("%s 0x%x", op_info->mnemonic, instr & 0x7);
  break;
 case PIC_BASELINE_OP_ARGS_1D_5F:
  buf_asm = sdb_fmt ("%s 0x%x, %c", op_info->mnemonic, instr & 0x1f,
      (instr & (1 << 5)) >> 5 ? 'f' : 'w');
  break;
 case PIC_BASELINE_OP_ARGS_5F:
  buf_asm = sdb_fmt ("%s 0x%x", op_info->mnemonic, instr & 0x1f);
  break;
 case PIC_BASELINE_OP_ARGS_3B_5F:
  buf_asm = sdb_fmt ("%s 0x%x, 0x%x", op_info->mnemonic, instr & 0x1f,
      (instr & (0x7 << 5)) >> 5);
  break;
 ...
 case PIC_BASELINE_OP_ARGS_9K:
  buf_asm = sdb_fmt ("%s 0x%x", op_info->mnemonic, instr & 0x1ff);
  break;
 }
 
# 251 "project/radare2/libr/asm/arch/pic/pic_baseline.c" 3 4
__builtin___strcpy_chk (
# 251 "project/radare2/libr/asm/arch/pic/pic_baseline.c"
opbuf
# 251 "project/radare2/libr/asm/arch/pic/pic_baseline.c" 3 4
, 
# 251 "project/radare2/libr/asm/arch/pic/pic_baseline.c"
