# 0 "project/radare2/libr/asm/arch/xap/dis.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/asm/arch/xap/dis.c" 2
...
# 5 "project/radare2/libr/asm/arch/xap/dis.c" 2
...
# 6 "project/radare2/libr/asm/arch/xap/dis.c" 2
...
# 7 "project/radare2/libr/asm/arch/xap/dis.c" 2
# 1 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include/stdarg.h" 1 3 4
# 99 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include/stdarg.h" 3 4
typedef __gnuc_va_list va_list;
# 8 "project/radare2/libr/asm/arch/xap/dis.c" 2

# 1 "project/radare2/libr/asm/arch/xap/dis.h" 1
...
typedef int RRef;
# 5 "project/radare2/libr/asm/arch/xap/dis.h" 2




# 8 "project/radare2/libr/asm/arch/xap/dis.h"
struct instruction {
 
# 9 "project/radare2/libr/asm/arch/xap/dis.h" 3 4
unsigned short 
# 9 "project/radare2/libr/asm/arch/xap/dis.h"
     in_mode:2,
   in_reg:2,
   in_opcode:4,
   in_operand:8;
...
# 86 "project/radare2/libr/asm/arch/xap/dis.h"
static void xap_decode(struct state *s, struct directive *d);
# 10 "project/radare2/libr/asm/arch/xap/dis.c" 2
...
# 15 "project/radare2/libr/asm/arch/xap/dis.c" 2


# 16 "project/radare2/libr/asm/arch/xap/dis.c"
static inline struct state *get_state(void) {
 
# 17 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
__builtin___memset_chk (
# 17 "project/radare2/libr/asm/arch/xap/dis.c"
&_state
# 17 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
, 
# 17 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 37 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 42 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
__builtin___sprintf_chk (
# 42 "project/radare2/libr/asm/arch/xap/dis.c"
d->d_asm
# 42 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
...
# 53 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
 __builtin___strcpy_chk (
# 53 "project/radare2/libr/asm/arch/xap/dis.c"
 d->d_asm
# 53 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
 , 
# 53 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 53 "project/radare2/libr/asm/arch/xap/dis.c"
  ...
  break;
 case 0x0004: 
# 55 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
               __builtin___strcpy_chk (
# 55 "project/radare2/libr/asm/arch/xap/dis.c"
               d->d_asm
# 55 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
               , 
# 55 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 55 "project/radare2/libr/asm/arch/xap/dis.c"
                                      ; break;
 case 0x0008: 
# 56 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
                 __builtin___strcpy_chk (
# 56 "project/radare2/libr/asm/arch/xap/dis.c"
                 d->d_asm
# 56 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
                 , 
# 56 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 56 "project/radare2/libr/asm/arch/xap/dis.c"
                                          ; break;
 case 0x000C: 
# 57 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
               __builtin___strcpy_chk (
# 57 "project/radare2/libr/asm/arch/xap/dis.c"
               d->d_asm
# 57 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
               , 
# 57 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 57 "project/radare2/libr/asm/arch/xap/dis.c"
                                      ; break;
 case 0xff09: 
# 58 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
              __builtin___strcpy_chk (
# 58 "project/radare2/libr/asm/arch/xap/dis.c"
              d->d_asm
# 58 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
              , 
# 58 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 58 "project/radare2/libr/asm/arch/xap/dis.c"
                                    ; break;
 case 0xfe09: 
# 59 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
                __builtin___strcpy_chk (
# 59 "project/radare2/libr/asm/arch/xap/dis.c"
                d->d_asm
# 59 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
                , 
# 59 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 59 "project/radare2/libr/asm/arch/xap/dis.c"
                                        ; break;
 case 0x0009: 
# 60 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
             __builtin___strcpy_chk (
# 60 "project/radare2/libr/asm/arch/xap/dis.c"
             d->d_asm
# 60 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
             , 
# 60 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 60 "project/radare2/libr/asm/arch/xap/dis.c"
                                 ; s->s_u = 1; break;
 case 0x00E2: 
# 61 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
               __builtin___strcpy_chk (
# 61 "project/radare2/libr/asm/arch/xap/dis.c"
               d->d_asm
# 61 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
               , 
# 61 "project/radare2/libr/asm/arch/xap/dis.c"
...
static char *regname(int reg) {
 ...
 return 
# 73 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
       ((void *)0)
# 73 "project/radare2/libr/asm/arch/xap/dis.c"
           ;
}
...
static int decode_known(struct state *s, struct directive *d) {
 char *op = 
# 91 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
           ((void *)0)
# 91 "project/radare2/libr/asm/arch/xap/dis.c"
               ;
 char *regn = 
# 92 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
             ((void *)0)
# 92 "project/radare2/libr/asm/arch/xap/dis.c"
                 ;
 int reg = 0;
 int ptr = 1;
 int idx = 1;
...
# 124 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
  __builtin___strcpy_chk (
# 124 "project/radare2/libr/asm/arch/xap/dis.c"
  d->d_asm
# 124 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
  , 
# 124 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 366 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
__builtin___sprintf_chk (
# 366 "project/radare2/libr/asm/arch/xap/dis.c"
d->d_asm
# 366 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
, 0, __builtin_object_size (
# 366 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 374 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
   __builtin___strcat_chk (
# 374 "project/radare2/libr/asm/arch/xap/dis.c"
   d->d_asm
# 374 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
   , 
# 374 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 375 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
   __builtin___strcat_chk (
# 375 "project/radare2/libr/asm/arch/xap/dis.c"
   d->d_asm
# 375 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
   , 
# 375 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 380 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
 __builtin___strcat_chk (
# 380 "project/radare2/libr/asm/arch/xap/dis.c"
 d->d_asm
# 380 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
 , 
# 380 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 383 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
 __builtin___strcat_chk (
# 383 "project/radare2/libr/asm/arch/xap/dis.c"
 d->d_asm
# 383 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
 , 
# 383 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 386 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
 __builtin___strcat_chk (
# 386 "project/radare2/libr/asm/arch/xap/dis.c"
 d->d_asm
# 386 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
 , 
# 386 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 417 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
__builtin___snprintf_chk (
# 417 "project/radare2/libr/asm/arch/xap/dis.c"
fmt
# 417 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
, 
# 417 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 418 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
__builtin___snprintf_chk (
# 418 "project/radare2/libr/asm/arch/xap/dis.c"
tmp
# 418 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
, 
# 418 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 419 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
__builtin___strcat_chk (
# 419 "project/radare2/libr/asm/arch/xap/dis.c"
d->d_asm
# 419 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
, 
# 419 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 424 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
 __builtin___snprintf_chk (
# 424 "project/radare2/libr/asm/arch/xap/dis.c"
 tmp
# 424 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
 , 
# 424 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 425 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
 __builtin___strcat_chk (
# 425 "project/radare2/libr/asm/arch/xap/dis.c"
 d->d_asm
# 425 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
 , 
# 425 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 427 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
  __builtin___strcat_chk (
# 427 "project/radare2/libr/asm/arch/xap/dis.c"
  d->d_asm
# 427 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
  , 
# 427 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 445 "project/radare2/libr/asm/arch/xap/dis.c"
 return 1;
}
...
# 458 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
__builtin___memcpy_chk (
# 458 "project/radare2/libr/asm/arch/xap/dis.c"
&d->d_inst
# 458 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
, 
# 458 "project/radare2/libr/asm/arch/xap/dis.c"
s->s_buf, sizeof(d->d_inst)
# 458 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
, __builtin_object_size (
# 458 "project/radare2/libr/asm/arch/xap/dis.c"
&d->d_inst
...
static inline struct directive *next_inst(struct state *s) {
 ...
 if (!d) {
  perror ("malloc()");
  return 
# 468 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
        ((void *)0)
# 468 "project/radare2/libr/asm/arch/xap/dis.c"
            ;
 }
 
# 470 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
__builtin___memset_chk (
# 470 "project/radare2/libr/asm/arch/xap/dis.c"
d
# 470 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
, 
# 470 "project/radare2/libr/asm/arch/xap/dis.c"
...
# 470 "project/radare2/libr/asm/arch/xap/dis.c"
 ...
 if (!rd) {
  free (d);
  return 
# 479 "project/radare2/libr/asm/arch/xap/dis.c" 3 4
        ((void *)0)
# 479 "project/radare2/libr/asm/arch/xap/dis.c"
            ;
 }
