# 0 "project/radare2/libr/asm/arch/z80/z80asm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/arch/z80/z80asm.c"
# 26 "project/radare2/libr/asm/arch/z80/z80asm.c"
# 1 "project/radare2/libr/asm/arch/z80/z80asm.h" 1
# 25 "project/radare2/libr/asm/arch/z80/z80asm.h"
...
# 26 "project/radare2/libr/asm/arch/z80/z80asm.h" 2
...
# 27 "project/radare2/libr/asm/arch/z80/z80asm.h" 2
...
# 28 "project/radare2/libr/asm/arch/z80/z80asm.h" 2
...
# 29 "project/radare2/libr/asm/arch/z80/z80asm.h" 2
...
# 30 "project/radare2/libr/asm/arch/z80/z80asm.h" 2
# 1 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include/stdarg.h" 1 3 4
# 99 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include/stdarg.h" 3 4
typedef __gnuc_va_list va_list;
# 31 "project/radare2/libr/asm/arch/z80/z80asm.h" 2
# 43 "project/radare2/libr/asm/arch/z80/z80asm.h"
...
# 27 "project/radare2/libr/asm/arch/z80/z80asm.c" 2
...
# 28 "project/radare2/libr/asm/arch/z80/z80asm.c" 2





# 32 "project/radare2/libr/asm/arch/z80/z80asm.c"
...
static const char *mnemonics[] = {
 ...
 "seek", 
# 50 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
        ((void *)0)

# 51 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
...
# 81 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                        ((void *)0)
# 81 "project/radare2/libr/asm/arch/z80/z80asm.c"
                            ;
...
static int sp;
static struct stack stack[200];


# 1 "project/radare2/libr/asm/arch/z80/expressions.c" 1
# 38 "project/radare2/libr/asm/arch/z80/expressions.c"
...
rd_number (const char **p, const char **endp, int base)
{
  ...
  if (verbose >= 6)
    fprintf (
# 47 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 47 "project/radare2/libr/asm/arch/z80/expressions.c"
  ...
  while (**p && (c = strchr (num, tolower ((const unsigned char)**p))))
    {
      ...
      if (verbose >= 7)
 fprintf (
# 55 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
         __stderrp
# 55 "project/radare2/libr/asm/arch/z80/expressions.c"
  ...
  *p = delspc (*p);
  if (verbose >= 7)
    fprintf (
# 64 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 64 "project/radare2/libr/asm/arch/z80/expressions.c"
...
rd_otherbasenumber (const char **p, int *valid, int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 74 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 74 "project/radare2/libr/asm/arch/z80/expressions.c"
                  ,
 ...
 *valid = 0;
 ...
 printerr (1, "base must be between 1 and z\n");
  ...
  if (isalpha ((const unsigned char)**p))
    return rd_number (p, 
# 97 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
                        ((void *)0)
# 97 "project/radare2/libr/asm/arch/z80/expressions.c"
                            , tolower ((unsigned char)c) - 'a' + 1);
  return rd_number (p, 
# 98 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
                      ((void *)0)
# 98 "project/radare2/libr/asm/arch/z80/expressions.c"
                          , c - '0' + 1);
}
...
rd_character (const char **p, int *valid, int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 106 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 106 "project/radare2/libr/asm/arch/z80/expressions.c"
                  ,
 ...
 *valid = 0;
  ...
  *valid = 0;
  ...
  if (verbose >= 7)
    fprintf (
# 179 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 179 "project/radare2/libr/asm/arch/z80/expressions.c"
   ...
   if (!l->ref->done)
     {
       ...
       if (verbose >= 6)
  fprintf (
# 226 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
          __stderrp
# 226 "project/radare2/libr/asm/arch/z80/expressions.c"
                ,
...
{
  struct label *l = 
# 245 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
                   ((void *)0)
# 245 "project/radare2/libr/asm/arch/z80/expressions.c"
                       ;
  int s;
  if (exists)
    *exists = 0;
  if (previous)
    *previous = 
# 250 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
               ((void *)0)
# 250 "project/radare2/libr/asm/arch/z80/expressions.c"
                   ;
  if (verbose >= 6)
    fprintf (
# 252 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 252 "project/radare2/libr/asm/arch/z80/expressions.c"
  ...
  for (s = level; s >= 0; --s)
    {
      if (check_label (stack[s].labels, p, &l,
         (**p == '.' && s == sp) ? previous : 
# 257 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
                                             ((void *)0)
# 257 "project/radare2/libr/asm/arch/z80/expressions.c"
                                                 , 0))
 break;
    }
  if (s < 0)
   ...
   if (verbose >= 7)
     fprintf (
# 270 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
             __stderrp
# 270 "project/radare2/libr/asm/arch/z80/expressions.c"
                   , "rd_label returns invalid value\n");
   return l != 
# 271 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
              ((void *)0)
# 271 "project/radare2/libr/asm/arch/z80/expressions.c"
                  ;
    }
  if (exists)
    *exists = 1;
  if (verbose >= 7)
    fprintf (
# 276 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 276 "project/radare2/libr/asm/arch/z80/expressions.c"
...
rd_value (const char **p, int *valid, int level, int *check, int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 286 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 286 "project/radare2/libr/asm/arch/z80/expressions.c"
 ...
 {
   (*p) += 2;
   return not ^ (sign * rd_number (p, 
# 320 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
                                     ((void *)0)
# 320 "project/radare2/libr/asm/arch/z80/expressions.c"
                                         , 0x10));
 }
      base = 8;
 ...
 *p = p2;
    ...
    case '%':
      (*p)++;
      return not ^ (sign * rd_number (p, 
# 383 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
                                        ((void *)0)
# 383 "project/radare2/libr/asm/arch/z80/expressions.c"
                                            , 2));
    case '\'':
    case '"':
      quote = **p;
      ...
      if (**p != quote)
 {
   ...
   return 0;
    ...
    case '?':
      rd_label (p, &exist, 
# 402 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
                          ((void *)0)
# 402 "project/radare2/libr/asm/arch/z80/expressions.c"
                              , level, 0);
 ...
 ++*p;
 return not ^ (sign * rd_number (p, 
# 429 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
                                   ((void *)0)
# 429 "project/radare2/libr/asm/arch/z80/expressions.c"
                                       , base));
      }
    default:
      {
 int value;
 exist = 1;
 value = rd_label (p, valid ? &exist : 
# 435 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
                                      ((void *)0)
# 435 "project/radare2/libr/asm/arch/z80/expressions.c"
                                          , 
# 435 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
                                            ((void *)0)
# 435 "project/radare2/libr/asm/arch/z80/expressions.c"
...
rd_factor (const char **p, int *valid, int level, int *check, int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 449 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 449 "project/radare2/libr/asm/arch/z80/expressions.c"
      ...
      else if (**p == '/')
 {
  ...
  if (verbose >= 7)
    fprintf (
# 474 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 474 "project/radare2/libr/asm/arch/z80/expressions.c"
...
rd_term (const char **p, int *valid, int level, int *check, int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 485 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 485 "project/radare2/libr/asm/arch/z80/expressions.c"
      ...
      else if (**p == '-')
 {
  ...
  if (verbose >= 7)
    fprintf (
# 505 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 505 "project/radare2/libr/asm/arch/z80/expressions.c"
        ...
        int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 516 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 516 "project/radare2/libr/asm/arch/z80/expressions.c"
      ...
      else if (**p == '>')
 {
  ...
  if (verbose >= 7)
    fprintf (
# 536 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 536 "project/radare2/libr/asm/arch/z80/expressions.c"
   ...
   int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 547 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 547 "project/radare2/libr/asm/arch/z80/expressions.c"
  ...
  *p = delspc (*p);
  ...
  if (verbose >= 7)
    fprintf (
# 577 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 577 "project/radare2/libr/asm/arch/z80/expressions.c"
                  , "%5d (0x%04x): rd_shift returned %d (%04x).\n",
      stack[sp].line, addr, result, result);
  return result;
}
        ...
        int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 588 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 588 "project/radare2/libr/asm/arch/z80/expressions.c"
 ...
 ++ * p;
  ...
  if (verbose >= 7)
    fprintf (
# 607 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 607 "project/radare2/libr/asm/arch/z80/expressions.c"
      ...
      int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 618 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 618 "project/radare2/libr/asm/arch/z80/expressions.c"
  ...
  *p = delspc (*p);
  ...
  if (verbose >= 7)
    fprintf (
# 629 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 629 "project/radare2/libr/asm/arch/z80/expressions.c"
      ...
      int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 640 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 640 "project/radare2/libr/asm/arch/z80/expressions.c"
                  , "%5d (0x%04x): Starting to read xor expression "
      "(string=%s).\n", stack[sp].line, addr, *p);
  result = rd_expr_and (p, valid, level, check, print_errors);
  if (verbose >= 7)
    fprintf (
# 644 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 644 "project/radare2/libr/asm/arch/z80/expressions.c"
  ...
  *p = delspc (*p);
  ...
  if (verbose >= 7)
    fprintf (
# 654 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 654 "project/radare2/libr/asm/arch/z80/expressions.c"
     ...
     int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 665 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 665 "project/radare2/libr/asm/arch/z80/expressions.c"
                  , "%5d (0x%04x): Starting to read or expression "
      "(string=%s).\n", stack[sp].line, addr, *p);
  result = rd_expr_xor (p, valid, level, check, print_errors);
  if (verbose >= 7)
    fprintf (
# 669 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 669 "project/radare2/libr/asm/arch/z80/expressions.c"
  ...
  *p = delspc (*p);
  ...
  if (verbose >= 7)
    fprintf (
# 679 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 679 "project/radare2/libr/asm/arch/z80/expressions.c"
     ...
     int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 691 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
            __stderrp
# 691 "project/radare2/libr/asm/arch/z80/expressions.c"
                  ,
 ...
 *valid = 0;
 ...
 printerr (1, "junk at end of expression: %s\n", *p);
  ...
  if (verbose >= 7)
    {
      fprintf (
# 736 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
              __stderrp
# 736 "project/radare2/libr/asm/arch/z80/expressions.c"
                    , "%5d (0x%04x): rd_expr returned %d (%04x).\n",
        stack[sp].line, addr, result, result);
      if (valid && !*valid)
 fprintf (
# 739 "project/radare2/libr/asm/arch/z80/expressions.c" 3 4
         __stderrp
# 739 "project/radare2/libr/asm/arch/z80/expressions.c"
...
# 92 "project/radare2/libr/asm/arch/z80/z80asm.c" 2


static void printerr(int error, const char *fmt, ...) {
# 110 "project/radare2/libr/asm/arch/z80/z80asm.c"
}
...
# 126 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
 fprintf(__stderrp,
# 126 "project/radare2/libr/asm/arch/z80/z80asm.c"
 "`,' expected. Remainder of line: %s\n", *p
# 126 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
 )
# 126 "project/radare2/libr/asm/arch/z80/z80asm.c"
                                                      ;
...
# 155 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
  fprintf(__stderrp,
# 155 "project/radare2/libr/asm/arch/z80/z80asm.c"
 ...
 for (i = 0; list[i]; i++) {
  ...
  while (*check) {
    ...
    *expr = input;
    ...
    rd_expr (&input, mem_delimiter, 
# 177 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                                   ((void *)0)
# 177 "project/radare2/libr/asm/arch/z80/z80asm.c"
                                       , sp, 0);
    had_expr = 1;
   } else if (*check == '+') {
    if (*input == '+' || *input == '-') {
     *expr = input;
     mem_delimiter = check[1];
     rd_expr (&input, mem_delimiter, 
# 183 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                                    ((void *)0)
# 183 "project/radare2/libr/asm/arch/z80/z80asm.c"
                                        , sp, 0);
    }
...
# 213 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                              ((void *)0)
# 213 "project/radare2/libr/asm/arch/z80/z80asm.c"
                                  );
}
...
# 232 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
 fprintf(__stderrp,
# 232 "project/radare2/libr/asm/arch/z80/z80asm.c"
...
# 243 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
 fprintf(__stderrp,
# 243 "project/radare2/libr/asm/arch/z80/z80asm.c"
...
static int compute_ref(struct reference *ref, int allow_invalid) {
 ...
 if (!ref->done) {
  ref->computed_value = rd_expr (&ptr, ref->delimiter,
   allow_invalid? &valid: 
# 267 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                         ((void *)0)
# 267 "project/radare2/libr/asm/arch/z80/z80asm.c"
                             ,
   ref->level, 1);
  if (valid) {
   ref->done = 1;
...
static int rd_ex1(const char **p) {
 ...
 const char *list[] = {
  "( sp )", "de", "af", 
# 311 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                       ((void *)0)
 
# 312 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 return indx (p, list, 1, 
# 313 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                         ((void *)0)
# 313 "project/radare2/libr/asm/arch/z80/z80asm.c"
                             );
}
...
static int rd_in(const char **p) {
 ...
 const char *list[] = {
  "b", "c", "d", "e", "h", "l", "f", "a", 
# 320 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                                         ((void *)0)
 
# 321 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 return indx (p, list, 1, 
# 322 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                         ((void *)0)
# 322 "project/radare2/libr/asm/arch/z80/z80asm.c"
                             );
}
...
static int rd_out(const char **p) {
 const char *list[] = {
  "b", "c", "d", "e", "h", "l", "0", "a", 
# 328 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                                         ((void *)0)
 
# 329 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 return indx (p, list, 1, 
# 330 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                         ((void *)0)
# 330 "project/radare2/libr/asm/arch/z80/z80asm.c"
                             );
}
...
static int rd_nnc(const char **p) {
 ...
 const char *list[] = {
  "( c )", "(*)", "a , (*)", 
# 338 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                            ((void *)0)
 
# 339 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
...
static int rd_c(const char **p) {
 const char *list[] = {
  "( c )", "( bc )", 
# 350 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                    ((void *)0)
 
# 351 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 return indx (p, list, 1, 
# 352 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                         ((void *)0)
# 352 "project/radare2/libr/asm/arch/z80/z80asm.c"
                             );
}
...
static int rd_a_hl(const char **p) {
 ...
 const char *list[] = {
  "a", "hl", 
# 359 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
            ((void *)0)
 
# 360 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 return indx (p, list, 1, 
# 361 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                         ((void *)0)
# 361 "project/radare2/libr/asm/arch/z80/z80asm.c"
                             );
}


static int rd_ld(const char **p) {
# 387 "project/radare2/libr/asm/arch/z80/z80asm.c"
 int i;
 const char *list[] = {
  "ixh", "ixl", "iyh", "iyl", "bc", "de", "hl", "sp", "ix",
  "iy", "b", "c", "d", "e", "h", "l", "( hl )", "a", "i",
  "r", "( bc )", "( de )", "( ix +)", "(iy +)", "(*)", 
# 391 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                                                      ((void *)0)
 
# 392 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 const char *nn;
 i = indx (p, list, 1, &nn);
 if (!i) {
...
static int rd_jp(const char **p) {
 ...
 const char *list[] = {
  ...
  "(hl)", 
# 427 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
         ((void *)0)
 
# 428 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 i = indx (p, list, 0, 
# 429 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                      ((void *)0)
# 429 "project/radare2/libr/asm/arch/z80/z80asm.c"
                          );
 if (i < 9) {
  return i;
 }
...
static int rd_jr(const char **p) {
 const char *list[] = {
  "nz", "z", "nc", "c", 
# 443 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                       ((void *)0)
 
# 444 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 return indx (p, list, 0, 
# 445 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                         ((void *)0)
# 445 "project/radare2/libr/asm/arch/z80/z80asm.c"
                             );
}
...
static int rd_a(const char **p) {
 const char *list[] = {
  "a", 
# 451 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
      ((void *)0)
 
# 452 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 return indx (p, list, 1, 
# 453 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                         ((void *)0)
# 453 "project/radare2/libr/asm/arch/z80/z80asm.c"
                             );
}
...
static int rd_stack(const char **p) {
 ...
 const char *list[] = {
  "bc", "de", "hl", "af", "ix", "iy", 
# 460 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                                     ((void *)0)
 
# 461 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 i = indx (p, list, 1, 
# 462 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                      ((void *)0)
# 462 "project/radare2/libr/asm/arch/z80/z80asm.c"
                          );
 if (i < 5) {
  return i;
 }
...
static int rd_r_add(const char **p) {
 ...
 const char *list[] = {
  ...
  "( hl )", "a", "( ix +)", "( iy +)", "hl", "ix", "iy", "*", 
# 478 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                                                             ((void *)0)
 
# 479 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 const char *nn;
 i = indx (p, list, 0, &nn);
 if (i == 18) {
...
static int rd_rr_(const char **p) {
 const char *list[] = {
  "bc", "de", "hl", "sp", 
# 509 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                         ((void *)0)
 
# 510 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 return indx (p, list, 1, 
# 511 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                         ((void *)0)
# 511 "project/radare2/libr/asm/arch/z80/z80asm.c"
                             );
}
...
static int rd_rrxx(const char **p) {
 const char *listx[] = {
  "bc", "de", "ix", "sp", 
# 517 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                         ((void *)0)
 
# 518 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 const char *listy[] = {
  "bc", "de", "iy", "sp", 
# 520 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                         ((void *)0)
 
# 521 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 const char *list[] = {
  "bc", "de", "hl", "sp", 
# 523 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                         ((void *)0)
 
# 524 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 if (indexed == 0xdd) {
  return indx (p, listx, 1, 
# 526 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                           ((void *)0)
# 526 "project/radare2/libr/asm/arch/z80/z80asm.c"
                               );
 }
 if (indexed == 0xfd) {
  return indx (p, listy, 1, 
# 529 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                           ((void *)0)
# 529 "project/radare2/libr/asm/arch/z80/z80asm.c"
                               );
 }
 return indx (p, list, 1, 
# 531 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                         ((void *)0)
# 531 "project/radare2/libr/asm/arch/z80/z80asm.c"
                             );
}
...
static int rd_r(const char **p) {
 ...
 const char *list[] = {
  ...
  "a", "( ix +)", "( iy +)", "*", 
# 541 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                                 ((void *)0)
 
# 542 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 i = indx (p, list, 0, &nn);
 if (i == 15) {
  readbyte = nn;
...
# 566 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                                                                    ((void *)0)
 
# 567 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
...
static int rd_cc(const char **p) {
 const char *list[] = {
  "nz", "z", "nc", "c", "po", "pe", "p", "m", 
# 590 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                                             ((void *)0)
 
# 591 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 return indx (p, list, 0, 
# 592 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                         ((void *)0)
# 592 "project/radare2/libr/asm/arch/z80/z80asm.c"
                             );
}
...
static int rd_r_rr(const char **p) {
 ...
 const char *list[] = {
  ...
  "l", "( hl )", "a", "( ix +)", "( iy +)", 
# 600 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                                           ((void *)0)
 
# 601 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 i = indx (p, list, 1, &indexjmp);
 if (!i) {
  return 0;
...
static int rd_hl(const char **p) {
 const char *list[] = {
  "hl", 
# 620 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
       ((void *)0)
 
# 621 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 return indx (p, list, 1, 
# 622 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                         ((void *)0)
# 622 "project/radare2/libr/asm/arch/z80/z80asm.c"
                             );
}
...
static int rd_hlx(const char **p) {
 ...
 const char *list[] = {
  "hl", "ix", "iy", 
# 629 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                   ((void *)0)
 
# 630 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 i = indx (p, list, 1, 
# 631 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                      ((void *)0)
# 631 "project/radare2/libr/asm/arch/z80/z80asm.c"
                          );
 if (i < 2) {
  return i;
 }
...
static int rd_af_(const char **p) {
 const char *list[] = {
  "af'", 
# 642 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
        ((void *)0)
 
# 643 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 return indx (p, list, 1, 
# 644 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                         ((void *)0)
# 644 "project/radare2/libr/asm/arch/z80/z80asm.c"
                             );
}
...
static int rd_0_2(const char **p) {
 const char *list[] = {
  "0", "", "1", "2", 
# 650 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                    ((void *)0)
 
# 651 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 return indx (p, list, 1, 
# 652 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                         ((void *)0)
# 652 "project/radare2/libr/asm/arch/z80/z80asm.c"
                             );
}
...
static int rd_ld_hl(const char **p) {
 ...
 const char *list[] = {
  "b", "c", "d", "e", "h", "l", "", "a", "*", 
# 659 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                                             ((void *)0)
 
# 660 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
...
static int rd_ld_nn(const char **p) {
 ...
 const char *list[] = {
  "bc", "de", "", "sp", "hl", "a", "ix", "iy", 
# 675 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                                              ((void *)0)
 
# 676 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 i = indx (p, list, 1, 
# 677 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                      ((void *)0)
# 677 "project/radare2/libr/asm/arch/z80/z80asm.c"
                          );
 if (i < 7) {
  return i;
 }
...
static int rd_lda(const char **p) {
 ...
 const char *list[] = {
  ...
  "l", "( hl )", "a", "i", "r", "(*)", "*", 
# 694 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                                           ((void *)0)
 
# 695 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 const char *nn;
 i = indx (p, list, 0, &nn);
 if (i == 2 || i == 5) {
...
static int rd_ldbcdehla(const char **p) {
 ...
 const char *list[] = {
  ...
  "ixl", "iyh", "iyl", "*", 
# 719 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                           ((void *)0)
 
# 720 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 const char *nn;
 i = indx (p, list, 0, &nn);
 if (i == 15) {
...
# 732 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
  fprintf(__stderrp,
# 732 "project/radare2/libr/asm/arch/z80/z80asm.c"
  "illegal use of index registers\n"
# 732 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
  )
# 732 "project/radare2/libr/asm/arch/z80/z80asm.c"
                                              ;
...
# 740 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
  fprintf(__stderrp,
# 740 "project/radare2/libr/asm/arch/z80/z80asm.c"
  "illegal use of index registers\n"
# 740 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
  )
# 740 "project/radare2/libr/asm/arch/z80/z80asm.c"
...
static int rd_nn_nn(const char **p) {
 ...
 const char *list[] = {
  "(*)", "*", 
# 754 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
             ((void *)0)
 
# 755 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
...
static int rd_sp(const char **p) {
 ...
 const char *list[] = {
  "hl", "ix", "iy", "(*)", "*", 
# 765 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                               ((void *)0)
 
# 766 "project/radare2/libr/asm/arch/z80/z80asm.c"
};
 const char *nn;
 i = indx (p, list, 0, &nn);
 if (i > 3) {
 ...
 switch (cmd) {
  ...
  case Z80_ADD:
   ...
   if (r == 15) {
    ...
    r--;
    obuf[obuflen++] = 0x09 + 0x10 * r;
    break;
   }
   if (has_argument (&ptr)) {
    if (r != 8) {
     
# 860 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
    fprintf(__stderrp,
# 860 "project/radare2/libr/asm/arch/z80/z80asm.c"
...
# 860 "project/radare2/libr/asm/arch/z80/z80asm.c"
  ...
  case Z80_BIT:
   ...
   obuf[obuflen++] = 0xCB;
   obuf[obuflen++] = 0x40 + (r - 1);
   break;
  case Z80_CALL:
   if ((r = rd_cc (&ptr))) {
    r--;
    obuf[obuflen++] = 0xC4 + 8 * r;
    rd_comma (&ptr);
   } else {
    obuf[obuflen++] = 0xCD;
   }
  ...
  case Z80_DEC:
   ...
   if (r < 0) {
    r--;
    obuf[obuflen++] = 0x05 - 8 * r;
    break;
   }
   r--;
   obuf[obuflen++] = 0x0B + 0x10 * r;
   break;
  case Z80_DI:
   obuf[obuflen++] = 0xF3;
   break;
  ...
  case Z80_INC:
   ...
   if (r < 0) {
    r++;
    obuf[obuflen++] = 0x04 - 8 * r;
    break;
   }
   r--;
   obuf[obuflen++] = 0x03 + 0x10 * r;
   break;
  case Z80_IND:
   obuf[obuflen++] = 0xED;
   obuf[obuflen++] = 0xAA;
  ...
  case Z80_LD:
   ...
   switch (r) {
    ...
    case 18:
     ...
     obuf[obuflen++] = 0x02 + 0x10 * (r == 18 ? 1 : 0);
     break;
    case 13:
     r = rd_ld_hl (&ptr) - 1;
     obuf[obuflen++] = 0x70 + r;
    ...
    case 21:
     ...
     if (r == 6 || r == 5) {
      obuf[obuflen++] = 0x22 + 0x10 * (r == 6 ? 1 : 0);
      break;
     }
     obuf[obuflen++] = 0xED;
     obuf[obuflen++] = 0x43 + 0x10 * --r;
     break;
    case 14:
     if (!(r = rd_lda (&ptr))) {
      break;
     ...
     if (r == 9 || r == 10) {
      obuf[obuflen++] = 0xED;
      obuf[obuflen++] = 0x57 + 8 * (r == 10 ? 1 : 0);
      break;
     }
     if (r == 7) {
      char n = r_num_math (
# 1105 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                          ((void *)0)
# 1105 "project/radare2/libr/asm/arch/z80/z80asm.c"
                              , readbyte);
      obuf[obuflen++] = 0x3E;
      obuf[obuflen++] = n;
      break;
    ...
    case 12:
     ...
     if (s == 7) {
      char n = r_num_math (
# 1127 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                          ((void *)0)
# 1127 "project/radare2/libr/asm/arch/z80/z80asm.c"
                              , readbyte);
      obuf[obuflen++] = 0x08 * (r - 7) + 0x6;
      obuf[obuflen++] = n;
     } else {
      obuf[obuflen++] = 0x40 + 0x08 * (r -7) + (s - 1);
     }
     break;
    case 1:
    case 2:
     ...
     if (s == 1) {
      obuf[obuflen++] = 0xED;
      obuf[obuflen++] = 0x4B + 0x10 * (r == 2 ? 1 : 0);
      break;
     }
     obuf[obuflen++] = 0x01 + (r == 2 ? 1 : 0) * 0x10;
     break;
    case 3:
     r = rd_nn_nn (&ptr);
     obuf[obuflen++] = 0x21 + (r == 1 ? 1 : 0) * 9;
     break;
    case 15:
    case 16:
     if (!rd_a (&ptr)) {
     ...
     obuf[obuflen++] = 0xED;
     obuf[obuflen++] = 0x47 + 0x08 * (r == 16 ? 1 : 0);
     break;
    case 4:
     r = rd_sp (&ptr);
     if (r == 1) {
...
# 1404 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
    fprintf(__stderrp,
# 1404 "project/radare2/libr/asm/arch/z80/z80asm.c"
    "parse error before: %s\n", ptr
# 1404 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
    )
# 1404 "project/radare2/libr/asm/arch/z80/z80asm.c"
  ...
  case Z80_DM:
   ...
   while (1) {
    ...
    if (have_quote) {
     ...
     ++ptr;
     while (*ptr != quote) {
      obuf[obuflen++] = rd_character (&ptr, 
# 1433 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
     ((void *)0)
# 1433 "project/radare2/libr/asm/arch/z80/z80asm.c"
     , 1);
      if (*ptr == 0) {
       
# 1435 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
      fprintf(__stderrp,
# 1435 "project/radare2/libr/asm/arch/z80/z80asm.c"
...
# 1450 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
    fprintf(__stderrp,
# 1450 "project/radare2/libr/asm/arch/z80/z80asm.c"
    "junk in byte definition: %s\n", ptr
# 1450 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
    )
# 1450 "project/radare2/libr/asm/arch/z80/z80asm.c"
                                                  ;
...
# 1458 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
   fprintf(__stderrp,
# 1458 "project/radare2/libr/asm/arch/z80/z80asm.c"
   "No data for word definition\n"
# 1458 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
   )
# 1458 "project/radare2/libr/asm/arch/z80/z80asm.c"
                                            ;
...
# 1468 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
    fprintf(__stderrp,
# 1468 "project/radare2/libr/asm/arch/z80/z80asm.c"
    "Missing expression in defw\n"
# 1468 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
    )
# 1468 "project/radare2/libr/asm/arch/z80/z80asm.c"
                                            ;
  ...
  case Z80_DS:
   r = rd_expr (&ptr, ',', 
# 1474 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                          ((void *)0)
# 1474 "project/radare2/libr/asm/arch/z80/z80asm.c"
                              , sp, 1);
   if (r < 0) {
    
# 1476 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
   fprintf(__stderrp,
# 1476 "project/radare2/libr/asm/arch/z80/z80asm.c"
   "ds should have its first argument >=0" " (not -0x%x)\n", -r
# 1476 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
   )
                           
# 1477 "project/radare2/libr/asm/arch/z80/z80asm.c"
                          ;
    break;
   }
   ptr = delspc (ptr);
  ...
  case Z80_ORG:
   addr = rd_expr (&ptr, '\0', 
# 1495 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
                              ((void *)0)
# 1495 "project/radare2/libr/asm/arch/z80/z80asm.c"
                                  , sp, 1) & 0xffff;
   break;
  case Z80_IF:
   break;
...
# 1500 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
  fprintf(__stderrp,
# 1500 "project/radare2/libr/asm/arch/z80/z80asm.c"
  "else without if\n"
# 1500 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
  )
# 1500 "project/radare2/libr/asm/arch/z80/z80asm.c"
...
# 1503 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
  fprintf(__stderrp,
# 1503 "project/radare2/libr/asm/arch/z80/z80asm.c"
  "endif without if\n"
# 1503 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
  )
# 1503 "project/radare2/libr/asm/arch/z80/z80asm.c"
...
# 1507 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
   fprintf(__stderrp,
# 1507 "project/radare2/libr/asm/arch/z80/z80asm.c"
   "endm outside macro definition\n"
# 1507 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
   )
# 1507 "project/radare2/libr/asm/arch/z80/z80asm.c"
                                              ;
...
# 1511 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
  fprintf(__stderrp,
# 1511 "project/radare2/libr/asm/arch/z80/z80asm.c"
  "seek error\n"
# 1511 "project/radare2/libr/asm/arch/z80/z80asm.c" 3 4
  )
# 1511 "project/radare2/libr/asm/arch/z80/z80asm.c"
