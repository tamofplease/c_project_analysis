# 0 "project/radare2/libr/asm/arch/hexagon/hexagon.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/arch/hexagon/hexagon.c"
...
# 4 "project/radare2/libr/asm/arch/hexagon/hexagon.c" 2
# 1 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include/stdbool.h" 1 3 4
# 5 "project/radare2/libr/asm/arch/hexagon/hexagon.c" 2
...
typedef int RRef;
# 6 "project/radare2/libr/asm/arch/hexagon/hexagon.c" 2
...
# 7 "project/radare2/libr/asm/arch/hexagon/hexagon.c" 2
...
# 8 "project/radare2/libr/asm/arch/hexagon/hexagon.c" 2
...
# 9 "project/radare2/libr/asm/arch/hexagon/hexagon.c" 2
# 1 "project/radare2/libr/asm/arch/hexagon/hexagon.h" 1
...
# 6 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
typedef enum {
 HEX_NOPRED,
 HEX_PRED_TRUE,
 HEX_PRED_FALSE,
...
# 50 "project/radare2/libr/asm/arch/hexagon/hexagon.h" 3 4
unsigned char 
# 50 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
    type;
 union {
  
# 52 "project/radare2/libr/asm/arch/hexagon/hexagon.h" 3 4
 unsigned char 
# 52 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
     reg;
  
# 53 "project/radare2/libr/asm/arch/hexagon/hexagon.h" 3 4
 unsigned int 
# 53 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
      imm;
  
# 54 "project/radare2/libr/asm/arch/hexagon/hexagon.h" 3 4
 unsigned char 
# 54 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
     pred;
  
# 55 "project/radare2/libr/asm/arch/hexagon/hexagon.h" 3 4
 unsigned char 
# 55 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
     cr;
  
# 56 "project/radare2/libr/asm/arch/hexagon/hexagon.h" 3 4
 unsigned char 
# 56 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
     sys;
 } op;
 
# 58 "project/radare2/libr/asm/arch/hexagon/hexagon.h" 3 4
unsigned char 
# 58 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
    attr;
} HexOp;
...
# 63 "project/radare2/libr/asm/arch/hexagon/hexagon.h" 3 4
unsigned int 
# 63 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
     mask;
 HexPred predicate;
 
# 65 "project/radare2/libr/asm/arch/hexagon/hexagon.h" 3 4
unsigned short 
# 65 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
     pf;
 
# 66 "project/radare2/libr/asm/arch/hexagon/hexagon.h" 3 4
_Bool 
# 66 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
     duplex;
 
# 67 "project/radare2/libr/asm/arch/hexagon/hexagon.h" 3 4
_Bool 
# 67 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
     compound;
 
# 68 "project/radare2/libr/asm/arch/hexagon/hexagon.h" 3 4
_Bool 
# 68 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
     last;
 int shift;
 
# 70 "project/radare2/libr/asm/arch/hexagon/hexagon.h" 3 4
unsigned char 
# 70 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
    op_count;
 HexOp ops[6];
 char mnem[128];
} HexInsn;
...
# 78 "project/radare2/libr/asm/arch/hexagon/hexagon.h" 3 4
_Bool 
# 78 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
     duplex;
 HexInsn ins[2];
} HexInsnCont;
...
# 86 "project/radare2/libr/asm/arch/hexagon/hexagon.h" 3 4
_Bool 
# 86 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
     loop0;
 
# 87 "project/radare2/libr/asm/arch/hexagon/hexagon.h" 3 4
_Bool 
# 87 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
     loop1;
 int cont_cnt;
 HexInsnCont ins[4];
} HexInsnPkt;
...
# 273 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
...
# 277 "project/radare2/libr/asm/arch/hexagon/hexagon.h" 3 4
_Bool 
# 277 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
    hex_if_duplex(
# 277 "project/radare2/libr/asm/arch/hexagon/hexagon.h" 3 4
                  unsigned int 
# 277 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
...
# 280 "project/radare2/libr/asm/arch/hexagon/hexagon.h" 3 4
                              unsigned int 
# 280 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
                                   hi_u32, HexInsn *hi, 
# 280 "project/radare2/libr/asm/arch/hexagon/hexagon.h" 3 4
                                                        unsigned int 
# 280 "project/radare2/libr/asm/arch/hexagon/hexagon.h"
                                                             addr);
# 10 "project/radare2/libr/asm/arch/hexagon/hexagon.c" 2
...
# 148 "project/radare2/libr/asm/arch/hexagon/hexagon.c" 3 4
  __builtin___sprintf_chk (
# 148 "project/radare2/libr/asm/arch/hexagon/hexagon.c"
  tmp
# 148 "project/radare2/libr/asm/arch/hexagon/hexagon.c" 3 4
...
inline 
# 217 "project/radare2/libr/asm/arch/hexagon/hexagon.c" 3 4
      _Bool 
# 217 "project/radare2/libr/asm/arch/hexagon/hexagon.c"
           hex_if_duplex(uint32_t insn_word)
{
 if ((insn_word & (3 << 14)) == 0) {
  return 
# 220 "project/radare2/libr/asm/arch/hexagon/hexagon.c" 3 4
        1
# 220 "project/radare2/libr/asm/arch/hexagon/hexagon.c"
            ;
 }
 return 
# 222 "project/radare2/libr/asm/arch/hexagon/hexagon.c" 3 4
       0
# 222 "project/radare2/libr/asm/arch/hexagon/hexagon.c"
            ;
}



# 226 "project/radare2/libr/asm/arch/hexagon/hexagon.c" 3 4
unsigned int 
# 226 "project/radare2/libr/asm/arch/hexagon/hexagon.c"
    constant_extender = 1;
