# 0 "project/radare2/libr/asm/arch/rsp/rsp_idec.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/arch/rsp/rsp_idec.c"


# 1 "project/radare2/libr/asm/arch/rsp/rsp_idec.h" 1
...
typedef int RRef;
# 6 "project/radare2/libr/asm/arch/rsp/rsp_idec.h" 2



# 8 "project/radare2/libr/asm/arch/rsp/rsp_idec.h"
...
static inline 
# 24 "project/radare2/libr/asm/arch/rsp/rsp_idec.h" 3 4
             unsigned long long 
# 24 "project/radare2/libr/asm/arch/rsp/rsp_idec.h"
                  rsp_mem_addr(
# 24 "project/radare2/libr/asm/arch/rsp/rsp_idec.h" 3 4
                               unsigned long long 
# 24 "project/radare2/libr/asm/arch/rsp/rsp_idec.h"
...
# 24 "project/radare2/libr/asm/arch/rsp/rsp_idec.h" 3 4
                                          unsigned long long 
# 24 "project/radare2/libr/asm/arch/rsp/rsp_idec.h"
                                               base) { addr &= 0xfff; addr |= base; return addr; }
...
# 164 "project/radare2/libr/asm/arch/rsp/rsp_idec.h" 3 4
unsigned long long 
# 164 "project/radare2/libr/asm/arch/rsp/rsp_idec.h"
     u;
 
# 165 "project/radare2/libr/asm/arch/rsp/rsp_idec.h" 3 4
long long 
# 165 "project/radare2/libr/asm/arch/rsp/rsp_idec.h"
     s;
} rsp_operand;
...
rsp_instruction rsp_instruction_decode(
# 177 "project/radare2/libr/asm/arch/rsp/rsp_idec.h" 3 4
                                      unsigned long long 
# 177 "project/radare2/libr/asm/arch/rsp/rsp_idec.h"
                                           pc, 
# 177 "project/radare2/libr/asm/arch/rsp/rsp_idec.h" 3 4
                                               unsigned int 
# 177 "project/radare2/libr/asm/arch/rsp/rsp_idec.h"
                                                    iw);
# 4 "project/radare2/libr/asm/arch/rsp/rsp_idec.c" 2
...
# 221 "project/radare2/libr/asm/arch/rsp/rsp_idec.c"
typedef struct {
 rsp_operand_type type;
 unsigned int u_shift;
 
# 224 "project/radare2/libr/asm/arch/rsp/rsp_idec.c" 3 4
unsigned int 
# 224 "project/radare2/libr/asm/arch/rsp/rsp_idec.c"
     u_mask;
 unsigned int u_lshift;
 unsigned int s_shift;
 
# 227 "project/radare2/libr/asm/arch/rsp/rsp_idec.c" 3 4
unsigned int 
# 227 "project/radare2/libr/asm/arch/rsp/rsp_idec.c"
     s_mask;
 
# 228 "project/radare2/libr/asm/arch/rsp/rsp_idec.c" 3 4
unsigned int 
# 228 "project/radare2/libr/asm/arch/rsp/rsp_idec.c"
     s_smask;
...
static const rsp_instruction_priv rsp_op_table[] = {
 ...
 { "sll", RSP_OP_SLL, 3, { { RSP_OPND_GP_REG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_SHIFT_AMOUNT, 6, 0x1f, 0, 0, 0, 0, 0 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "srl", RSP_OP_SRL, 3, { { RSP_OPND_GP_REG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_SHIFT_AMOUNT, 6, 0x1f, 0, 0, 0, 0, 0 } } }, { "sra", RSP_OP_SRA, 3, { { RSP_OPND_GP_REG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_SHIFT_AMOUNT, 6, 0x1f, 0, 0, 0, 0, 0 } } }, { "sllv", RSP_OP_SLLV, 3, { { RSP_OPND_GP_REG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "srlv", RSP_OP_SRLV, 3, { { RSP_OPND_GP_REG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 } } }, { "srav", RSP_OP_SRAV, 3, { { RSP_OPND_GP_REG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 } } },
 { "jr", RSP_OP_JR, 1, { { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "break", RSP_OP_BREAK, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "add", RSP_OP_ADD, 3, { { RSP_OPND_GP_REG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 } } }, { "addu", RSP_OP_ADDU, 3, { { RSP_OPND_GP_REG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 } } }, { "sub", RSP_OP_SUB, 3, { { RSP_OPND_GP_REG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 } } }, { "subu", RSP_OP_SUBU, 3, { { RSP_OPND_GP_REG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 } } }, { "and", RSP_OP_AND, 3, { { RSP_OPND_GP_REG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 } } }, { "or", RSP_OP_OR, 3, { { RSP_OPND_GP_REG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 } } }, { "xor", RSP_OP_XOR, 3, { { RSP_OPND_GP_REG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 } } }, { "nor", RSP_OP_NOR, 3, { { RSP_OPND_GP_REG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 } } },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "slt", RSP_OP_SLT, 3, { { RSP_OPND_GP_REG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 } } }, { "sltu", RSP_OP_SLTU, 3, { { RSP_OPND_GP_REG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },



 { "bltz", RSP_OP_BLTZ, 2, { { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_OFFSET, 0, 0, 0, 0, 0xffff, 0x8000, 2 } } }, { "bgez", RSP_OP_BGEZ, 2, { { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_OFFSET, 0, 0, 0, 0, 0xffff, 0x8000, 2 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "bltzal", RSP_OP_BLTZAL, 2, { { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_OFFSET, 0, 0, 0, 0, 0xffff, 0x8000, 2 } } }, { "bgezal", RSP_OP_BGEZAL, 2, { { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_OFFSET, 0, 0, 0, 0, 0xffff, 0x8000, 2 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },



 { "mfc0", RSP_OP_MFC0, 2, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C0_REG, 11, 0x0f, 0, 0, 0, 0, 0 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "mtc0", RSP_OP_MTC0, 2, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C0_REG, 11, 0x0f, 0, 0, 0, 0, 0 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 ...
 { "mfc2", RSP_OP_MFC2, 2, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_BYTE, 11, 0x1f, 0, 7, 0xf, 0, 0 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "cfc2", RSP_OP_CFC2, 2, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_CREG, 11, 0x03, 0, 0, 0, 0, 0 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "mtc2", RSP_OP_MTC2, 2, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_BYTE, 11, 0x1f, 0, 7, 0xf, 0, 0 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "ctc2", RSP_OP_CTC2, 2, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_CREG, 11, 0x03, 0, 0, 0, 0, 0 } } }, { "invalid", RSP_OP_INVALID, 0, },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 ...
 { "vmulf", RSP_OP_VMULF, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vmulu", RSP_OP_VMULU, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "vmudl", RSP_OP_VMUDL, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vmudm", RSP_OP_VMUDM, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vmudn", RSP_OP_VMUDN, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vmudh", RSP_OP_VMUDH, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } },
 { "vmacf", RSP_OP_VMACF, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vmacu", RSP_OP_VMACU, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "vmadl", RSP_OP_VMADL, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vmadm", RSP_OP_VMADM, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vmadn", RSP_OP_VMADN, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vmadh", RSP_OP_VMADH, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } },
 { "vadd", RSP_OP_VADD, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vsub", RSP_OP_VSUB, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "vabs", RSP_OP_VABS, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vaddc", RSP_OP_VADDC, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vsubc", RSP_OP_VSUBC, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "vsar", RSP_OP_VSAR, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_ACCU, 21, 0x03, 0, 0, 0, 0, 0 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "vlt", RSP_OP_VLT, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "veq", RSP_OP_VEQ, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vne", RSP_OP_VNE, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vge", RSP_OP_VGE, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vcl", RSP_OP_VCL, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vch", RSP_OP_VCH, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vcr", RSP_OP_VCR, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vmrg", RSP_OP_VMRG, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } },
 { "vand", RSP_OP_VAND, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vnand", RSP_OP_VNAND, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vor", RSP_OP_VOR, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vnor", RSP_OP_VNOR, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vxor", RSP_OP_VXOR, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "vnxor", RSP_OP_VNXOR, 3, { { RSP_OPND_C2_VREG, 6, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG, 11, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_C2_VREG_ELEMENT, 16, 0x1f, 0,21, 0xf, 0, 0 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "vrcp", RSP_OP_VRCP, 2, { { RSP_OPND_C2_VREG_SCALAR, 6, 0x1f, 0,11, 0x7, 0, 0 }, { RSP_OPND_C2_VREG_SCALAR, 16, 0x1f, 0,21, 0x7, 0, 0 } } }, { "vrcpl", RSP_OP_VRCPL, 2, { { RSP_OPND_C2_VREG_SCALAR, 6, 0x1f, 0,11, 0x7, 0, 0 }, { RSP_OPND_C2_VREG_SCALAR, 16, 0x1f, 0,21, 0x7, 0, 0 } } }, { "vrcph", RSP_OP_VRCPH, 2, { { RSP_OPND_C2_VREG_SCALAR, 6, 0x1f, 0,11, 0x7, 0, 0 }, { RSP_OPND_C2_VREG_SCALAR, 16, 0x1f, 0,21, 0x7, 0, 0 } } }, { "vmov", RSP_OP_VMOV, 2, { { RSP_OPND_C2_VREG_SCALAR, 6, 0x1f, 0,11, 0x7, 0, 0 }, { RSP_OPND_C2_VREG_SCALAR, 16, 0x1f, 0,21, 0x7, 0, 0 } } }, { "vrsq", RSP_OP_VRSQ, 2, { { RSP_OPND_C2_VREG_SCALAR, 6, 0x1f, 0,11, 0x7, 0, 0 }, { RSP_OPND_C2_VREG_SCALAR, 16, 0x1f, 0,21, 0x7, 0, 0 } } }, { "vrsql", RSP_OP_VRSQL, 2, { { RSP_OPND_C2_VREG_SCALAR, 6, 0x1f, 0,11, 0x7, 0, 0 }, { RSP_OPND_C2_VREG_SCALAR, 16, 0x1f, 0,21, 0x7, 0, 0 } } }, { "vrsqh", RSP_OP_VRSQH, 2, { { RSP_OPND_C2_VREG_SCALAR, 6, 0x1f, 0,11, 0x7, 0, 0 }, { RSP_OPND_C2_VREG_SCALAR, 16, 0x1f, 0,21, 0x7, 0, 0 } } }, { "vnop", RSP_OP_VNOP, 0, },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },



 { "lbv", RSP_OP_LBV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 0 } } }, { "lsv", RSP_OP_LSV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 1 } } }, { "llv", RSP_OP_LLV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 2 } } }, { "ldv", RSP_OP_LDV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 3 } } }, { "lqv", RSP_OP_LQV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 4 } } }, { "lrv", RSP_OP_LRV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 4 } } }, { "lpv", RSP_OP_LPV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 3 } } }, { "luv", RSP_OP_LUV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 3 } } },
 { "lhv", RSP_OP_LHV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 4 } } }, { "lfv", RSP_OP_LFV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 4 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "ltv", RSP_OP_LTV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 4 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },



 { "sbv", RSP_OP_SBV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 0 } } }, { "ssv", RSP_OP_SSV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 1 } } }, { "slv", RSP_OP_SLV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 2 } } }, { "sdv", RSP_OP_SDV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 3 } } }, { "sqv", RSP_OP_SQV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 4 } } }, { "srv", RSP_OP_SRV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 3 } } }, { "spv", RSP_OP_SPV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 3 } } }, { "suv", RSP_OP_SUV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 4 } } },
 { "shv", RSP_OP_SHV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 4 } } }, { "sfv", RSP_OP_SFV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 4 } } }, { "swv", RSP_OP_SWV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 4 } } }, { "stv", RSP_OP_STV, 2, { { RSP_OPND_C2_VREG_BYTE, 16, 0x1f, 0, 7, 0xf, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0x7f, 0x40, 4 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },



 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "j", RSP_OP_J, 1, { { RSP_OPND_TARGET, 0, 0x03ff, 2, 0, 0, 0, 0 } } }, { "jal", RSP_OP_JAL, 1, { { RSP_OPND_TARGET, 0, 0x03ff, 2, 0, 0, 0, 0 } } }, { "beq", RSP_OP_BEQ, 3, { { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_OFFSET, 0, 0, 0, 0, 0xffff, 0x8000, 2 } } }, { "bne", RSP_OP_BNE, 3, { { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_OFFSET, 0, 0, 0, 0, 0xffff, 0x8000, 2 } } }, { "blez", RSP_OP_BLEZ, 3, { { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_OFFSET, 0, 0, 0, 0, 0xffff, 0x8000, 2 } } }, { "bgtz", RSP_OP_BGTZ, 3, { { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_OFFSET, 0, 0, 0, 0, 0xffff, 0x8000, 2 } } },
 { "addi", RSP_OP_ADDI, 3, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_SIMM, 0, 0, 0, 0, 0xffff, 0x8000, 0 } } }, { "addiu", RSP_OP_ADDIU, 3, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_SIMM, 0, 0, 0, 0, 0xffff, 0x8000, 0 } } }, { "slti", RSP_OP_SLTI, 3, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_SIMM, 0, 0, 0, 0, 0xffff, 0x8000, 0 } } }, { "sltiu", RSP_OP_SLTIU, 3, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_SIMM, 0, 0, 0, 0, 0xffff, 0x8000, 0 } } }, { "andi", RSP_OP_ANDI, 3, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_ZIMM, 0, 0xffff, 0, 0, 0, 0, 0 } } }, { "ori", RSP_OP_ORI, 3, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_ZIMM, 0, 0xffff, 0, 0, 0, 0, 0 } } }, { "xori", RSP_OP_XORI, 3, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_GP_REG, 21, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_ZIMM, 0, 0xffff, 0, 0, 0, 0, 0 } } }, { "lui", RSP_OP_LUI, 2, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_ZIMM, 0, 0xffff, 16, 0, 0, 0, 0 } } },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "lb", RSP_OP_LB, 2, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0xffff, 0x8000, 0 } } }, { "lh", RSP_OP_LH, 2, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0xffff, 0x8000, 0 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "lw", RSP_OP_LW, 2, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0xffff, 0x8000, 0 } } }, { "lbu", RSP_OP_LBU, 2, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0xffff, 0x8000, 0 } } }, { "lhu", RSP_OP_LHU, 2, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0xffff, 0x8000, 0 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "sb", RSP_OP_SB, 2, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0xffff, 0x8000, 0 } } }, { "sh", RSP_OP_SH, 2, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0xffff, 0x8000, 0 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "sw", RSP_OP_SW, 2, { { RSP_OPND_GP_REG, 16, 0x1f, 0, 0, 0, 0, 0 }, { RSP_OPND_BASE_OFFSET, 21, 0x1f, 0, 0, 0xffff, 0x8000, 0 } } }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
 { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, }, { "invalid", RSP_OP_INVALID, 0, },
...
# 323 "project/radare2/libr/asm/arch/rsp/rsp_idec.c"
typedef struct {
 
# 324 "project/radare2/libr/asm/arch/rsp/rsp_idec.c" 3 4
unsigned short 
# 324 "project/radare2/libr/asm/arch/rsp/rsp_idec.c"
     offset;
 
# 325 "project/radare2/libr/asm/arch/rsp/rsp_idec.c" 3 4
unsigned char 
# 325 "project/radare2/libr/asm/arch/rsp/rsp_idec.c"
    shift;
 
# 326 "project/radare2/libr/asm/arch/rsp/rsp_idec.c" 3 4
unsigned char 
# 326 "project/radare2/libr/asm/arch/rsp/rsp_idec.c"
    mask;
} rsp_op_escape;

static const rsp_op_escape rsp_escapes_table[] = {
 { 0, 0, 0x3f }, { 0, 0, 0x3f }, { 64, 16, 0x1f }, { 64, 16, 0x1f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f },
 { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f },
 { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f },
 { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f },
 { 96, 21, 0x1f }, { 96, 21, 0x1f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 128, 21, 0x1f }, { 160, 0, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f },
 { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f },
 { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f },
 { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f },
 { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f },
 ...
 { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f },
 { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f },
 { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 224, 11, 0x1f }, { 224, 11, 0x1f }, { 288, 26, 0x3f }, { 288, 26, 0x3f },
 { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f },
 { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 256, 11, 0x1f }, { 256, 11, 0x1f }, { 288, 26, 0x3f }, { 288, 26, 0x3f },
 { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }, { 288, 26, 0x3f }
};


static const rsp_instruction_priv* rsp_decode_priv(
# 349 "project/radare2/libr/asm/arch/rsp/rsp_idec.c" 3 4
                                                  unsigned int 
# 349 "project/radare2/libr/asm/arch/rsp/rsp_idec.c"
                                                       iw) {
...
static inline 
# 361 "project/radare2/libr/asm/arch/rsp/rsp_idec.c" 3 4
             int 
# 361 "project/radare2/libr/asm/arch/rsp/rsp_idec.c"
                  rsp_sign_extend(
# 361 "project/radare2/libr/asm/arch/rsp/rsp_idec.c" 3 4
                                  int 
# 361 "project/radare2/libr/asm/arch/rsp/rsp_idec.c"
...
static rsp_operand rsp_operand_decode(
# 369 "project/radare2/libr/asm/arch/rsp/rsp_idec.c" 3 4
                                     unsigned long long 
# 369 "project/radare2/libr/asm/arch/rsp/rsp_idec.c"
                                          pc, 
# 369 "project/radare2/libr/asm/arch/rsp/rsp_idec.c" 3 4
                                              unsigned int 
# 369 "project/radare2/libr/asm/arch/rsp/rsp_idec.c"
                                                   iw, const rsp_operand_decoder* odec) {
 rsp_operand opnd;
...
rsp_instruction rsp_instruction_decode(
# 391 "project/radare2/libr/asm/arch/rsp/rsp_idec.c" 3 4
                                      unsigned long long 
# 391 "project/radare2/libr/asm/arch/rsp/rsp_idec.c"
                                           pc, 
# 391 "project/radare2/libr/asm/arch/rsp/rsp_idec.c" 3 4
                                               unsigned int 
# 391 "project/radare2/libr/asm/arch/rsp/rsp_idec.c"
