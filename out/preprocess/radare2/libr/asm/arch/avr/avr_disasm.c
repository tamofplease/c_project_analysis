# 0 "project/radare2/libr/asm/arch/avr/avr_disasm.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 26 "project/radare2/libr/asm/arch/avr/avr_disasm.c" 2
...
# 28 "project/radare2/libr/asm/arch/avr/avr_disasm.c" 2
...
typedef int RRef;
# 29 "project/radare2/libr/asm/arch/avr/avr_disasm.c" 2

# 1 "project/radare2/libr/asm/arch/avr/avr_disasm.h" 1
# 30 "project/radare2/libr/asm/arch/avr/avr_disasm.h"
...
# 31 "project/radare2/libr/asm/arch/avr/avr_disasm.c" 2
...
# 32 "project/radare2/libr/asm/arch/avr/avr_disasm.c" 2



# 1 "project/radare2/libr/asm/arch/avr/avr_instructionset.c" 1
# 46 "project/radare2/libr/asm/arch/avr/avr_instructionset.c"
instructionInfo instructionSet[145] = {
...
# 36 "project/radare2/libr/asm/arch/avr/avr_disasm.c" 2
...
int disassembleInstruction(avrDisassembleContext *context, disassembledInstruction *dInstruction, const assembledInstruction aInstruction) {
 ...
 dInstruction->alternateInstruction = 
# 89 "project/radare2/libr/asm/arch/avr/avr_disasm.c" 3 4
                                     ((void *)0)
# 89 "project/radare2/libr/asm/arch/avr/avr_disasm.c"
                                         ;
...
static int lookupInstruction(uint16_t opcode, int offset) {
 ...
 for (insidx = offset; insidx < 145; insidx++) {
  opcodeSearch = opcode;
