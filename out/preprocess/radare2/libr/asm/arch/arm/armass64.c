# 0 "project/radare2/libr/asm/arch/arm/armass64.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/arch/arm/armass64.c"
...
# 4 "project/radare2/libr/asm/arch/arm/armass64.c" 2
...
# 5 "project/radare2/libr/asm/arch/arm/armass64.c" 2
...
# 6 "project/radare2/libr/asm/arch/arm/armass64.c" 2
...
# 7 "project/radare2/libr/asm/arch/arm/armass64.c" 2
...
# 8 "project/radare2/libr/asm/arch/arm/armass64.c" 2


# 9 "project/radare2/libr/asm/arch/arm/armass64.c"
...
# 56 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
  unsigned short 
# 56 "project/radare2/libr/asm/arch/arm/armass64.c"
       sp_val;
  };
  struct {
   
# 59 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
  unsigned long long 
# 59 "project/radare2/libr/asm/arch/arm/armass64.c"
       immediate;
   
# 60 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
  _Bool 
# 60 "project/radare2/libr/asm/arch/arm/armass64.c"
       sign;
   
# 61 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
  _Bool 
# 61 "project/radare2/libr/asm/arch/arm/armass64.c"
       preindex;
  };
  struct {
   
# 64 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
  unsigned long long 
# 64 "project/radare2/libr/asm/arch/arm/armass64.c"
       shift_amount;
   ShiftType shift;
   
# 66 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
  _Bool 
# 66 "project/radare2/libr/asm/arch/arm/armass64.c"
       amount_present;
  };
  struct {
   
# 69 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
  unsigned int 
# 69 "project/radare2/libr/asm/arch/arm/armass64.c"
       mem_option;
  };
 };
} Operand;
...
# 78 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 78 "project/radare2/libr/asm/arch/arm/armass64.c"
     op[3];
 size_t op_len;
 
# 80 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned char 
# 80 "project/radare2/libr/asm/arch/arm/armass64.c"
    opcode[3];
 
# 81 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
_Bool 
# 81 "project/radare2/libr/asm/arch/arm/armass64.c"
     writeback;
 int operands_count;
 Operand operands[7];
} ArmOp;
...
static int get_mem_option(char *token) {
 ...
 const char *options[] = {"sy", "st", "ld", "xxx", "ish", "ishst",
   ...
   "xxx", "osh", "oshst", "oshld", 
# 92 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                                  ((void *)0)
# 92 "project/radare2/libr/asm/arch/arm/armass64.c"
                                      };
 int i = 0;
 while (options[i]) {
...
static int countLeadingZeros(
# 103 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                            unsigned long long 
# 103 "project/radare2/libr/asm/arch/arm/armass64.c"
                                 x) {
 int count = 64;
 while (x) {
  x >>= 1;
...
static int countTrailingZeros(
# 112 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                             unsigned long long 
# 112 "project/radare2/libr/asm/arch/arm/armass64.c"
                                  x) {
 int count = 0;
 while (x && !(x & 1)) {
  count++;
...
static int countLeadingOnes(
# 141 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                           unsigned long long 
# 141 "project/radare2/libr/asm/arch/arm/armass64.c"
                                x) {
 return countLeadingZeros (~x);
}

static int countTrailingOnes(
# 145 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                            unsigned long long 
# 145 "project/radare2/libr/asm/arch/arm/armass64.c"
                                 x) {
 return countTrailingZeros (~x);
}

static 
# 149 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      _Bool 
# 149 "project/radare2/libr/asm/arch/arm/armass64.c"
           isMask(
# 149 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                  unsigned long long 
# 149 "project/radare2/libr/asm/arch/arm/armass64.c"
...
static 
# 153 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      _Bool 
# 153 "project/radare2/libr/asm/arch/arm/armass64.c"
           isShiftedMask (
# 153 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                          unsigned long long 
# 153 "project/radare2/libr/asm/arch/arm/armass64.c"
...
static 
# 158 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      unsigned int 
# 158 "project/radare2/libr/asm/arch/arm/armass64.c"
...
# 158 "project/radare2/libr/asm/arch/arm/armass64.c"
                                                 reg_size) {
 if (imm == 0 || imm == 
# 159 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                       0xFFFFFFFFFFFFFFFFULL 
# 159 "project/radare2/libr/asm/arch/arm/armass64.c"
                                || (reg_size != 64
  && (imm >> reg_size != 0 || imm == (~0ULL >> (64 - reg_size))))) {
  return 
# 161 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
        0xFFFFFFFFU
# 161 "project/radare2/libr/asm/arch/arm/armass64.c"
                ;
 }

 
# 164 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 164 "project/radare2/libr/asm/arch/arm/armass64.c"
     size = reg_size;
 do {
  size >>= 1;
  
# 167 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
 unsigned long long 
# 167 "project/radare2/libr/asm/arch/arm/armass64.c"
      mask = (1ull << size) - 1;
...
# 174 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 174 "project/radare2/libr/asm/arch/arm/armass64.c"
     cto, i;
 
# 175 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned long long 
# 175 "project/radare2/libr/asm/arch/arm/armass64.c"
     mask = 
# 175 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
            0xFFFFFFFFFFFFFFFFULL 
# 175 "project/radare2/libr/asm/arch/arm/armass64.c"
 ...
 if (isShiftedMask (imm)) {
  ...
  if (!isShiftedMask (~imm)) {
   return 
# 184 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
         0xFFFFFFFFU
# 184 "project/radare2/libr/asm/arch/arm/armass64.c"
                 ;
  }

  
# 187 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
 unsigned int 
# 187 "project/radare2/libr/asm/arch/arm/armass64.c"
      clo = countLeadingOnes (imm);
  i = 64 - clo;
...
# 195 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 195 "project/radare2/libr/asm/arch/arm/armass64.c"
     immr = (size - i) & (size - 1);


 
# 198 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned long long 
# 198 "project/radare2/libr/asm/arch/arm/armass64.c"
     nimms = ~(size - 1) << 1;
...
# 203 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 203 "project/radare2/libr/asm/arch/arm/armass64.c"
     n = ((nimms >> 6) & 1) ^ 1;
 
# 204 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 204 "project/radare2/libr/asm/arch/arm/armass64.c"
     encoding = (n << 12) | (immr << 6) | (nimms & 0x3f);
 return encoding;
}

static inline 
# 208 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
             unsigned int 
# 208 "project/radare2/libr/asm/arch/arm/armass64.c"
                  encode1reg(ArmOp *op) {
 return op->operands[0].reg << 24;
}

static inline 
# 212 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
             unsigned int 
# 212 "project/radare2/libr/asm/arch/arm/armass64.c"
                  encode2regs(ArmOp *op) {
 return (op->operands[1].reg & 0x7) << 29 | (op->operands[1].reg & 0x18) << 13
  | encode1reg (op);
}

static inline 
# 217 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
             unsigned int 
# 217 "project/radare2/libr/asm/arch/arm/armass64.c"
                  encodeImm9(
# 217 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                             unsigned int 
# 217 "project/radare2/libr/asm/arch/arm/armass64.c"
...
static 
# 221 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      unsigned int 
# 221 "project/radare2/libr/asm/arch/arm/armass64.c"
           mov(ArmOp *op) {
 
# 222 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 222 "project/radare2/libr/asm/arch/arm/armass64.c"
     k = 0;
 
# 223 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 223 "project/radare2/libr/asm/arch/arm/armass64.c"
     data = 
# 223 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
            0xFFFFFFFFU
# 223 "project/radare2/libr/asm/arch/arm/armass64.c"
                    ;
 if (!(op->operands_count >= 2)) { return data; };
 if (!(op->operands[0].type == ARM_GPR)) { return data; };
 ...
 if (!strcmp (op->mnemonic, "mov")) {
  ...
  if (op->operands[1].type == ARM_GPR) {
   if (!(bits == ((op->operands[1].reg_type & ARM_REG64) ? 64 : 32))) { return data; };
   if (op->operands[0].reg_type & ARM_SP || op->operands[1].reg_type & ARM_SP) {
    k |= 0x0011;
  ...
  if (!(op->operands[1].type & ARM_CONSTANT)) { return data; };
  
# 245 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
 unsigned long long 
# 245 "project/radare2/libr/asm/arch/arm/armass64.c"
      imm = op->operands[1].immediate;
  
# 246 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
 unsigned long long 
# 246 "project/radare2/libr/asm/arch/arm/armass64.c"
      imm_inverse = ~imm;
  if (bits == 32) {
   if (!(imm <= 0xffffffff || imm_inverse <= 0xffffffff)) { return data; };
   imm &= 0xffffffff;
   imm_inverse &= 0xffffffff;
  }
  int shift;
  
# 253 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
 unsigned long long 
# 253 "project/radare2/libr/asm/arch/arm/armass64.c"
      mask = 0xffff;
  ...
  mask = 0xffff;
  for (shift = 0; shift < bits; shift += 16, mask <<= 16) {
   if (imm_inverse == (imm_inverse & mask)) {
    data = k | 0x00008012;
    imm_inverse >>= shift;
...
# 273 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
 unsigned int 
# 273 "project/radare2/libr/asm/arch/arm/armass64.c"
      bitmask = encodeBitMasksWithSize (op->operands[1].immediate, bits);
  if (!(bitmask != 
# 274 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
 0xFFFFFFFFU
# 274 "project/radare2/libr/asm/arch/arm/armass64.c"
 )) { return data; };
  data = k | 0xe0030032;
...
# 289 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned long long 
# 289 "project/radare2/libr/asm/arch/arm/armass64.c"
     imm = op->operands[1].immediate;
 if (!(imm <= 0xffff)) { return data; };
 int shift = 0;
 if (op->operands_count >= 3) {
  if (!(op->operands_count == 3)) { return data; };
  if (!(op->operands[2].type == ARM_SHIFT)) { return data; };
  if (!(op->operands[2].shift == ARM_LSL)) { return data; };
  shift = op->operands[2].shift_amount;
  if (!(!(shift & 0xf))) { return data; };
  if (!(shift < bits)) { return data; };
 }
 data = k;
 data |= (imm & 7) << 29;
 data |= (imm & 0x7f8) << 13;
...
static 
# 308 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      unsigned int 
# 308 "project/radare2/libr/asm/arch/arm/armass64.c"
           cb(ArmOp *op) {
 
# 309 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 309 "project/radare2/libr/asm/arch/arm/armass64.c"
     data = 
# 309 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
            0xFFFFFFFFU
# 309 "project/radare2/libr/asm/arch/arm/armass64.c"
 ...
 if (!strncmp (op->mnemonic, "cbnz", 4)) {
  if (op->operands[0].reg_type & ARM_REG64) {
   ...
   return 
# 317 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
         0xFFFFFFFFU
# 317 "project/radare2/libr/asm/arch/arm/armass64.c"
                 ;
  }
  ...
  if (op->operands[0].reg_type & ARM_REG64) {
   ...
   return 
# 325 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
         0xFFFFFFFFU
# 325 "project/radare2/libr/asm/arch/arm/armass64.c"
                 ;
  }
 } else {
  return 
# 328 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
        0xFFFFFFFFU
# 328 "project/radare2/libr/asm/arch/arm/armass64.c"
                ;
 }

 
# 331 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 331 "project/radare2/libr/asm/arch/arm/armass64.c"
     imm = op->operands[1].immediate;
...
static 
# 339 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      unsigned int 
# 339 "project/radare2/libr/asm/arch/arm/armass64.c"
           cmp(ArmOp *op) {
 
# 340 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 340 "project/radare2/libr/asm/arch/arm/armass64.c"
     data = 
# 340 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
            0xFFFFFFFFU
# 340 "project/radare2/libr/asm/arch/arm/armass64.c"
 ...
 if (op->operands[0].reg_type & ARM_REG64 && op->operands[1].reg_type & ARM_REG64) {
  ...
  if (op->operands[2].shift_amount > 31) {
   return 
# 346 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
         0xFFFFFFFFU
# 346 "project/radare2/libr/asm/arch/arm/armass64.c"
                 ;
  }
  k = 0x1f00006b;
  ...
  return 
# 357 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
        0xFFFFFFFFU
# 357 "project/radare2/libr/asm/arch/arm/armass64.c"
                ;
 }
...
static 
# 373 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      unsigned int 
# 373 "project/radare2/libr/asm/arch/arm/armass64.c"
           regsluop(ArmOp *op, int k) {
 
# 374 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 374 "project/radare2/libr/asm/arch/arm/armass64.c"
     data = 
# 374 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
            0xFFFFFFFFU
# 374 "project/radare2/libr/asm/arch/arm/armass64.c"
...
static 
# 416 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      unsigned int 
# 416 "project/radare2/libr/asm/arch/arm/armass64.c"
           reglsop(ArmOp *op, int k) {
 
# 417 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 417 "project/radare2/libr/asm/arch/arm/armass64.c"
     data = 
# 417 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
            0xFFFFFFFFU
# 417 "project/radare2/libr/asm/arch/arm/armass64.c"
 ...
 if (op->operands[2].type & ARM_GPR) {
  ...
  if (n > 0x100 || n < -0x100) {
   return 
# 432 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
         0xFFFFFFFFU
# 432 "project/radare2/libr/asm/arch/arm/armass64.c"
                 ;
  }
...
static 
# 473 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      unsigned int 
# 473 "project/radare2/libr/asm/arch/arm/armass64.c"
           lsop(ArmOp *op, int k, 
# 473 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                                  unsigned long long 
# 473 "project/radare2/libr/asm/arch/arm/armass64.c"
...
# 474 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 474 "project/radare2/libr/asm/arch/arm/armass64.c"
     data = 
# 474 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
            0xFFFFFFFFU
# 474 "project/radare2/libr/asm/arch/arm/armass64.c"
...
# 479 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
  long long 
# 479 "project/radare2/libr/asm/arch/arm/armass64.c"
       offset = op->operands[1].immediate - addr;
   if (!(op->operands[0].reg_type & ARM_REG64)) { return data; };
   if (!(!(offset & 0x3))) { return data; };
   if (!(-0x100000 <= offset && offset < 0x100000)) { return data; };
   offset >>= 2;
 ...
 if (!(op->operands[0].type == ARM_GPR)) { return data; };
 if (!(op->operands[1].type == ARM_GPR)) { return data; };
 if (!(op->operands[1].reg_type & ARM_REG64)) { return data; };
 k |= encode2regs (op);
 if (!strcmp (op->mnemonic, "ldrb") || !strcmp (op->mnemonic, "ldrh")
  || !strcmp (op->mnemonic, "strb") || !strcmp (op->mnemonic, "strh")) {
  if (!(op->operands[0].reg_type & ARM_REG32)) { return data; };
 ...
 if (op->operands[2].type & ARM_GPR) {
  ...
  if (op->operands[3].type == ARM_EXTEND) {
   ...
   case ARM_UXTW:
    if (!(op->operands[2].reg_type & ARM_REG32)) { return data; };
    break;
   case ARM_SXTX:
    k |= 0x00a00000;
    if (!(op->operands[2].reg_type & ARM_REG64)) { return data; };
    break;
   default:
    return data;
   }
  } else if (op->operands[3].type == ARM_SHIFT) {
   if (!(op->operands[3].shift == ARM_LSL)) { return data; };
   if (!(op->operands[2].reg_type & ARM_REG64)) { return data; };
   k |= 0x00200000;
  }
  if (op->operands[3].type == ARM_EXTEND || op->operands[3].type == ARM_SHIFT) {
   if (width == 'b') {
    if (!(op->operands[3].shift_amount == 0)) { return data; };
 ...
 if (!(op_count == 2 || op->operands[2].type == ARM_CONSTANT)) { return data; };
 if (!(!op->writeback || op->operands[2].preindex)) { return data; };
 int n = op_count == 2 ? 0 : op->operands[2].immediate;
 if (!op->writeback && (op_count == 2 || op->operands[2].preindex)) {
  if (!(n >= 0)) { return data; };
  if (width == 'b') {
   if (!(n <= 0xfff)) { return data; };
  } else if (width == 'h') {
   if (!(n <= 0x1ffe && !(n & 1))) { return data; }
   n >>= 1;
  } else {
   if (!(n <= 0x3ffc && !(n & 3))) { return data; };
   n >>= 2;
  }
  data = k | (n & 0x3f) << 18 | (n & 0xfc0) << 2 | 1;
  return data;
 }
 if (!(-0x100 <= n && n < 0x100)) { return data; }
...
static 
# 586 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      unsigned int 
# 586 "project/radare2/libr/asm/arch/arm/armass64.c"
           branch(ArmOp *op, 
# 586 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                             unsigned long long 
# 586 "project/radare2/libr/asm/arch/arm/armass64.c"
...
# 587 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 587 "project/radare2/libr/asm/arch/arm/armass64.c"
     data = 
# 587 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
            0xFFFFFFFFU
# 587 "project/radare2/libr/asm/arch/arm/armass64.c"
...
# 588 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned long long 
# 588 "project/radare2/libr/asm/arch/arm/armass64.c"
     n = 0;
...
static 
# 625 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      unsigned int 
# 625 "project/radare2/libr/asm/arch/arm/armass64.c"
           bdot(ArmOp *op, 
# 625 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                           unsigned long long 
# 625 "project/radare2/libr/asm/arch/arm/armass64.c"
...
# 626 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 626 "project/radare2/libr/asm/arch/arm/armass64.c"
     data = 
# 626 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
            0xFFFFFFFFU
# 626 "project/radare2/libr/asm/arch/arm/armass64.c"
...
static 
# 655 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      unsigned int 
# 655 "project/radare2/libr/asm/arch/arm/armass64.c"
           mem_barrier(ArmOp *op, 
# 655 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                                  unsigned long long 
# 655 "project/radare2/libr/asm/arch/arm/armass64.c"
                                       addr, int k) {
 
# 656 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 656 "project/radare2/libr/asm/arch/arm/armass64.c"
     data = 
# 656 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
            0xFFFFFFFFU
# 656 "project/radare2/libr/asm/arch/arm/armass64.c"
 ...
 if (!strncmp (op->mnemonic, "isb", 3)) {
  if (op->operands[0].mem_option == 15 || op->operands[0].type == ARM_NOTYPE) {
   ...
   return 
# 662 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
         0xFFFFFFFFU
# 662 "project/radare2/libr/asm/arch/arm/armass64.c"
                 ;
  }
 }
...
# 1 "project/radare2/libr/asm/arch/arm/armass64_const.h" 1
struct {
        const char *name;
        
# 3 "project/radare2/libr/asm/arch/arm/armass64_const.h" 3 4
       unsigned short 
# 3 "project/radare2/libr/asm/arch/arm/armass64_const.h"
            val;
} msr_const[] = {
 { "MDCCSR_EL0", 0x9808 },
 { "DBGDTRRX_EL0", 0x9828 },
 ...
 { 
# 634 "project/radare2/libr/asm/arch/arm/armass64_const.h" 3 4
  ((void *)0)
# 634 "project/radare2/libr/asm/arch/arm/armass64_const.h"
      , 0x0000 }
};
# 674 "project/radare2/libr/asm/arch/arm/armass64.c" 2

static 
# 675 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      unsigned int 
# 675 "project/radare2/libr/asm/arch/arm/armass64.c"
           msr(ArmOp *op, int w) {
 
# 676 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 676 "project/radare2/libr/asm/arch/arm/armass64.c"
     data = 
# 676 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
            0xFFFFFFFFU
# 676 "project/radare2/libr/asm/arch/arm/armass64.c"
...
# 677 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 677 "project/radare2/libr/asm/arch/arm/armass64.c"
     seq_data = 
# 677 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                0xFFFFFFFFU
# 677 "project/radare2/libr/asm/arch/arm/armass64.c"
...
# 680 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 680 "project/radare2/libr/asm/arch/arm/armass64.c"
     r, b;
...
static 
# 755 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      unsigned int 
# 755 "project/radare2/libr/asm/arch/arm/armass64.c"
           logical(ArmOp *op, 
# 755 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                              _Bool 
# 755 "project/radare2/libr/asm/arch/arm/armass64.c"
                                   invert, LogicalOp opc) {
 
# 756 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 756 "project/radare2/libr/asm/arch/arm/armass64.c"
     data = 
# 756 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
            0xFFFFFFFFU
# 756 "project/radare2/libr/asm/arch/arm/armass64.c"
 ...
 if (op2_type == ARM_CONSTANT) {
  if (invert) {
   ...
   return 
# 768 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
         0xFFFFFFFFU
# 768 "project/radare2/libr/asm/arch/arm/armass64.c"
                 ;
  }
  if (reg_type & ARM_REG64) {
   ...
   return 
# 775 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
         0xFFFFFFFFU
# 775 "project/radare2/libr/asm/arch/arm/armass64.c"
                 ;
  }

  
# 778 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
 _Bool 
# 778 "project/radare2/libr/asm/arch/arm/armass64.c"
      is64bit = reg_type & ARM_REG64;
...
# 784 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
 unsigned int 
# 784 "project/radare2/libr/asm/arch/arm/armass64.c"
      imm_orig = op->operands[2].immediate;
  
# 785 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
 unsigned int 
# 785 "project/radare2/libr/asm/arch/arm/armass64.c"
      imm = encodeBitMasksWithSize (invert? ~imm_orig: imm_orig, is64bit? 64: 32);
  if (imm == 
# 786 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
            0xFFFFFFFFU
# 786 "project/radare2/libr/asm/arch/arm/armass64.c"
                    ) {
   return 
# 787 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
         0xFFFFFFFFU
# 787 "project/radare2/libr/asm/arch/arm/armass64.c"
                 ;
  }
  data |= (imm & 0x1fff) << 10;
  ...
  if (reg_type & ARM_REG64) {
   ...
   return 
# 796 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
         0xFFFFFFFFU
# 796 "project/radare2/libr/asm/arch/arm/armass64.c"
                 ;
  }
  ...
  return 
# 816 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
        0xFFFFFFFFU
# 816 "project/radare2/libr/asm/arch/arm/armass64.c"
                ;
 }
...
static 
# 822 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      unsigned int 
# 822 "project/radare2/libr/asm/arch/arm/armass64.c"
           adrp(ArmOp *op, 
# 822 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                           unsigned long long 
# 822 "project/radare2/libr/asm/arch/arm/armass64.c"
...
# 823 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned long long 
# 823 "project/radare2/libr/asm/arch/arm/armass64.c"
     at = 0LL;
 
# 824 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 824 "project/radare2/libr/asm/arch/arm/armass64.c"
     data = k;
 if (op->operands[0].type == ARM_GPR) {
  data |= encode1reg (op);
 } else {
  
# 828 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
 fprintf(__stderrp,
# 828 "project/radare2/libr/asm/arch/arm/armass64.c"
 "Usage: adrp x0, addr\n"
# 828 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
 )
# 828 "project/radare2/libr/asm/arch/arm/armass64.c"
                                   ;
  return 
# 829 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
        0xFFFFFFFFU
# 829 "project/radare2/libr/asm/arch/arm/armass64.c"
                ;
 }
 if (op->operands[1].type == ARM_CONSTANT) {

  
# 833 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
 unsigned long long 
# 833 "project/radare2/libr/asm/arch/arm/armass64.c"
      imm = op->operands[1].immediate;
  if (imm > addr) {
   imm -= addr;
  }
...
# 839 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
 fprintf(__stderrp,
# 839 "project/radare2/libr/asm/arch/arm/armass64.c"
 "Usage: adrp, x0, addr\n"
# 839 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
 )
# 839 "project/radare2/libr/asm/arch/arm/armass64.c"
                                    ;
  return 
# 840 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
        0xFFFFFFFFU
# 840 "project/radare2/libr/asm/arch/arm/armass64.c"
                ;
 }
...
# 849 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 849 "project/radare2/libr/asm/arch/arm/armass64.c"
     immlo = at & 3;
 
# 850 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 850 "project/radare2/libr/asm/arch/arm/armass64.c"
     immhi = at >> 2;
 data += (immlo << 5);
 data += (immhi << 29);
 return data;
...
static 
# 856 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      unsigned int 
# 856 "project/radare2/libr/asm/arch/arm/armass64.c"
           adr(ArmOp *op, int addr) {
 
# 857 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 857 "project/radare2/libr/asm/arch/arm/armass64.c"
     data = 
# 857 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
            0xFFFFFFFFU
# 857 "project/radare2/libr/asm/arch/arm/armass64.c"
...
# 858 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned long long 
# 858 "project/radare2/libr/asm/arch/arm/armass64.c"
     at = 0LL;
...
# 867 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned char 
# 867 "project/radare2/libr/asm/arch/arm/armass64.c"
    b0 = at;
 
# 868 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned char 
# 868 "project/radare2/libr/asm/arch/arm/armass64.c"
    b1 = (at >> 3) & 0xff;
 
# 869 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned char 
# 869 "project/radare2/libr/asm/arch/arm/armass64.c"
    b2 = (at >> (8 + 7)) & 0xff;
 data += b0 << 29;
 data += b1 << 16;
 data += b2 << 24;
...
static 
# 876 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      unsigned int 
# 876 "project/radare2/libr/asm/arch/arm/armass64.c"
           stp(ArmOp *op, int k) {
 
# 877 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 877 "project/radare2/libr/asm/arch/arm/armass64.c"
     data = 
# 877 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
            0xFFFFFFFFU
# 877 "project/radare2/libr/asm/arch/arm/armass64.c"
...
static 
# 893 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      unsigned int 
# 893 "project/radare2/libr/asm/arch/arm/armass64.c"
           exception(ArmOp *op, 
# 893 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                                unsigned int 
# 893 "project/radare2/libr/asm/arch/arm/armass64.c"
...
# 894 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 894 "project/radare2/libr/asm/arch/arm/armass64.c"
     data = 
# 894 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
            0xFFFFFFFFU
# 894 "project/radare2/libr/asm/arch/arm/armass64.c"
...
static 
# 905 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      unsigned int 
# 905 "project/radare2/libr/asm/arch/arm/armass64.c"
           arithmetic(ArmOp *op, int k) {
 
# 906 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 906 "project/radare2/libr/asm/arch/arm/armass64.c"
     data = 
# 906 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
            0xFFFFFFFFU
# 906 "project/radare2/libr/asm/arch/arm/armass64.c"
...
static 
# 952 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      unsigned int 
# 952 "project/radare2/libr/asm/arch/arm/armass64.c"
           neg(ArmOp *op) {
...
static 
# 963 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      unsigned int 
# 963 "project/radare2/libr/asm/arch/arm/armass64.c"
           bitfield(ArmOp *op, int k) {
 
# 964 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
unsigned int 
# 964 "project/radare2/libr/asm/arch/arm/armass64.c"
     data = 
# 964 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
            0xFFFFFFFFU
# 964 "project/radare2/libr/asm/arch/arm/armass64.c"
                    ;
 if (!(op->operands_count == 4)) { return data; };
 if (!(op->operands[0].type == ARM_GPR)) { return data; };
 if (!(op->operands[1].type == ARM_GPR)) { return data; };
 if (!(op->operands[0].reg_type == op->operands[1].reg_type)) { return data; };
 if (!(op->operands[2].type == ARM_CONSTANT)) { return data; };
 if (!(op->operands[3].type == ARM_CONSTANT)) { return data; };
 int bits = (op->operands[0].reg_type & ARM_REG64) ? 64 : 32;
 ...
 if (!strcmp (op->mnemonic, "sbfx") || !strcmp (op->mnemonic, "ubfx")) {
  ...
  if (!(op->operands[2].immediate < bits)) { return data; };
  int temp = bits - op->operands[2].immediate;
  if (!(op->operands[3].immediate <= temp)) { return data; };
  op->operands[2].immediate = temp & (bits - 1);
  op->operands[3].immediate--;
 }
 if (!(op->operands[2].immediate < bits)) { return data; };
 if (!(op->operands[3].immediate < bits)) { return data; };
 if (bits == 64) {
  k |= 0x00004080;
 }
...
static 
# 992 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      _Bool 
# 992 "project/radare2/libr/asm/arch/arm/armass64.c"
           parseOperands(char* str, ArmOp *op) {
 char *t = strdup (str);
 int operand = 0;
 char *token = t;
 char *x;
 ...
 if (!token) {
  return 
# 1002 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
        0
# 1002 "project/radare2/libr/asm/arch/arm/armass64.c"
             ;
 }
...
# 1016 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
  fprintf(__stderrp,
# 1016 "project/radare2/libr/asm/arch/arm/armass64.c"
  "Too many operands\n"
# 1016 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
  )
# 1016 "project/radare2/libr/asm/arch/arm/armass64.c"
                                 ;
   return 
# 1017 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
         0
# 1017 "project/radare2/libr/asm/arch/arm/armass64.c"
              ;
  }
  ...
  if (strcmp (op->mnemonic, "msr") == 0 && operand == 1) {
   ...
   if ( token[0] == '#' || (token[0] >= '0' && token[0] <= '9')) {
    ...
    op->operands[operand].immediate = r_num_math (
# 1029 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                                                 ((void *)0)
# 1029 "project/radare2/libr/asm/arch/arm/armass64.c"
  ...
  if (op->operands[operand].type == ARM_SHIFT) {
   ...
   if (!*token || !isdigit((unsigned char)*token)) {
    return 
# 1105 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
          0
# 1105 "project/radare2/libr/asm/arch/arm/armass64.c"
               ;
   }
   op->operands[operand].shift_amount = r_num_math (
# 1107 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                                                   ((void *)0)
# 1107 "project/radare2/libr/asm/arch/arm/armass64.c"
                                                       , token);
   op->operands[operand].amount_present = 
# 1108 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                                         1
# 1108 "project/radare2/libr/asm/arch/arm/armass64.c"
                                             ;
   if (op->operands[operand].shift_amount > 63) {
    free (t);
    return 
# 1111 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
          0
# 1111 "project/radare2/libr/asm/arch/arm/armass64.c"
               ;
   }
   operand ++;
   token = next;
...
# 1123 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
  _Bool 
# 1123 "project/radare2/libr/asm/arch/arm/armass64.c"
       present = 
# 1123 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                 0
# 1123 "project/radare2/libr/asm/arch/arm/armass64.c"
   ...
   if (*token == '#') {
    present = 
# 1125 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
             1
# 1125 "project/radare2/libr/asm/arch/arm/armass64.c"
                 ;
    ++token;
   }
   if (!*token || !isdigit((unsigned char)*token)) {
    if (present) {
     return 
# 1130 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
           0
# 1130 "project/radare2/libr/asm/arch/arm/armass64.c"
                ;
    }
    op->operands[operand].shift_amount = 0;
    op->operands[operand].amount_present = 
# 1133 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                                          0
# 1133 "project/radare2/libr/asm/arch/arm/armass64.c"
                                               ;
   } else {
    op->operands[operand].shift_amount = r_num_math (
# 1135 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                                                    ((void *)0)
# 1135 "project/radare2/libr/asm/arch/arm/armass64.c"
                                                        , token);
    op->operands[operand].amount_present = 
# 1136 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                                          1
# 1136 "project/radare2/libr/asm/arch/arm/armass64.c"
                                              ;
   }
   operand++;
   token = next;
  ...
  case 'x':
   ...
   if (!strncmp(token + 1, "zr", 2)) {
    ...
    op->operands[operand].reg = r_num_math (
# 1157 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                                           ((void *)0)
# 1157 "project/radare2/libr/asm/arch/arm/armass64.c"
                                               , token + 1);
   }
   ...
   if (op->operands[operand].reg > 31) {
    free (t);
    return 
# 1162 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
          0
# 1162 "project/radare2/libr/asm/arch/arm/armass64.c"
               ;
   }
   break;
  case 'w':
   ...
   if (!strncmp(token + 1, "zr", 2)) {
    ...
    op->operands[operand].reg = r_num_math (
# 1178 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                                           ((void *)0)
# 1178 "project/radare2/libr/asm/arch/arm/armass64.c"
                                               , token + 1);
   }
   ...
   if (op->operands[operand].reg > 31) {
    free (t);
    return 
# 1183 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
          0
# 1183 "project/radare2/libr/asm/arch/arm/armass64.c"
               ;
   }
   break;
  case 'v':
   ...
   op->operands[operand].reg = r_num_math (
# 1189 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                                          ((void *)0)
# 1189 "project/radare2/libr/asm/arch/arm/armass64.c"
                                              , token + 1);
   break;
  case 's':
  case 'S':
  ...
  case '#':
   ...
   op->operands[operand].type = ARM_CONSTANT;
   op->operands[operand].immediate = r_num_math (
# 1237 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                                                ((void *)0)
# 1237 "project/radare2/libr/asm/arch/arm/armass64.c"
                                                    , token + 1);
  ...
  default:
   ...
   op->operands[operand].type = ARM_CONSTANT;
   op->operands[operand].immediate = r_num_math (
# 1247 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                                                ((void *)0)
# 1247 "project/radare2/libr/asm/arch/arm/armass64.c"
                                                    , token);
   op->operands[operand].preindex = token - t < index_bound;
   imm_count++;
   break;
  ...
  if (operand > 7) {
   free (t);
   return 
# 1257 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
         0
# 1257 "project/radare2/libr/asm/arch/arm/armass64.c"
              ;
  }
 }
 free (t);
 return 
# 1261 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
       1
# 1261 "project/radare2/libr/asm/arch/arm/armass64.c"
           ;
}

static 
# 1264 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      _Bool 
# 1264 "project/radare2/libr/asm/arch/arm/armass64.c"
           parseOpcode(const char *str, ArmOp *op) {
 char *in = strdup (str);
 ...
 if (!space) {
  ...
  op->mnemonic = in;
   return 
# 1270 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
         1
# 1270 "project/radare2/libr/asm/arch/arm/armass64.c"
             ;
 }
 space[0] = '\0';
 op->mnemonic = in;
...
# 1275 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                                        ((void *)0)
# 1275 "project/radare2/libr/asm/arch/arm/armass64.c"
                                            ;
 return parseOperands (space, op);
}

static 
# 1279 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
      _Bool 
# 1279 "project/radare2/libr/asm/arch/arm/armass64.c"
           handlePAC(
# 1279 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                     unsigned int 
# 1279 "project/radare2/libr/asm/arch/arm/armass64.c"
  ...
  *op = 0xbf2303d5;
  return 
# 1282 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
        1
# 1282 "project/radare2/libr/asm/arch/arm/armass64.c"
            ;
 }
 if (!strcmp (str, "autiaz")) {
  *op = 0x9f2303d5;
  return 
# 1286 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
        1
# 1286 "project/radare2/libr/asm/arch/arm/armass64.c"
            ;
 }
 if (!strcmp (str, "autibsp")) {
  *op = 0xff2303d5;
  return 
# 1290 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
        1
# 1290 "project/radare2/libr/asm/arch/arm/armass64.c"
            ;
 }
 if (!strcmp (str, "autibz")) {
  *op = 0xdf2303d5;
  return 
# 1294 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
        1
# 1294 "project/radare2/libr/asm/arch/arm/armass64.c"
            ;
 }
 if (!strcmp (str, "paciaz")) {
  *op = 0x1f2303d5;
  return 
# 1298 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
        1
# 1298 "project/radare2/libr/asm/arch/arm/armass64.c"
            ;
 }
 if (!strcmp (str, "pacibz")) {
  *op = 0x5f2303d5;
  return 
# 1302 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
        1
# 1302 "project/radare2/libr/asm/arch/arm/armass64.c"
            ;
 }
 if (!strcmp (str, "paciasp")) {
  *op = 0x3f2303d5;
  return 
# 1306 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
        1
# 1306 "project/radare2/libr/asm/arch/arm/armass64.c"
            ;
 }
 if (!strcmp (str, "pacibsp")) {
  *op = 0x7f2303d5;
  return 
# 1310 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
        1
# 1310 "project/radare2/libr/asm/arch/arm/armass64.c"
            ;
 }
 if (!strcmp (str, "retab")) {
  *op = 0xff0f5fd6;
  return 
# 1314 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
        1
# 1314 "project/radare2/libr/asm/arch/arm/armass64.c"
            ;
 }
 return 
# 1316 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
       0
# 1316 "project/radare2/libr/asm/arch/arm/armass64.c"
            ;
}


# 1319 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
_Bool 
# 1319 "project/radare2/libr/asm/arch/arm/armass64.c"
...
# 1319 "project/radare2/libr/asm/arch/arm/armass64.c"
 ...
 if (!parseOpcode (str, &ops)) {
  free (ops.mnemonic);
  return 
# 1323 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
        0
# 1323 "project/radare2/libr/asm/arch/arm/armass64.c"
             ;
 }
  ...
  *op = 0xdf3f03d5;
 } else if (handlePAC (op, str)) {
  free (ops.mnemonic);
  return 
# 1374 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
        1
# 1374 "project/radare2/libr/asm/arch/arm/armass64.c"
            ;
  ...
  *op = logical (&ops, 
# 1384 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                      0
# 1384 "project/radare2/libr/asm/arch/arm/armass64.c"
                           , ARM_ANDS);
 } else if (!strncmp (str, "and ", 4)) {
  *op = logical (&ops, 
# 1386 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                      0
# 1386 "project/radare2/libr/asm/arch/arm/armass64.c"
                           , ARM_AND);
 } else if (!strncmp (str, "bics ", 5)) {
  *op = logical (&ops, 
# 1388 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                      1
# 1388 "project/radare2/libr/asm/arch/arm/armass64.c"
                          , ARM_ANDS);
 } else if (!strncmp (str, "bic ", 4)) {
  *op = logical (&ops, 
# 1390 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                      1
# 1390 "project/radare2/libr/asm/arch/arm/armass64.c"
                          , ARM_AND);
 } else if (!strncmp (str, "eon ", 4)) {
  *op = logical (&ops, 
# 1392 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                      1
# 1392 "project/radare2/libr/asm/arch/arm/armass64.c"
                          , ARM_EOR);
 } else if (!strncmp (str, "eor ", 4)) {
  *op = logical (&ops, 
# 1394 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                      0
# 1394 "project/radare2/libr/asm/arch/arm/armass64.c"
                           , ARM_EOR);
 } else if (!strncmp (str, "orn ", 4)) {
  *op = logical (&ops, 
# 1396 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                      1
# 1396 "project/radare2/libr/asm/arch/arm/armass64.c"
                          , ARM_ORR);
 } else if (!strncmp (str, "orr ", 4)) {
  *op = logical (&ops, 
# 1398 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
                      0
# 1398 "project/radare2/libr/asm/arch/arm/armass64.c"
                           , ARM_ORR);
 } else if (!strncmp (str, "svc ", 4)) {
  *op = exception (&ops, 0x010000d4);
 } else if (!strncmp (str, "hvc ", 4)) {
  *op = exception (&ops, 0x020000d4);
 } else if (!strncmp (str, "smc ", 4)) {
  *op = exception (&ops, 0x030000d4);
 } else if (!strncmp (str, "brk ", 4)) {
  *op = exception (&ops, 0x000020d4);
 } else if (!strncmp (str, "hlt ", 4)) {
  ...
  *op = 
# 1436 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
       0xFFFFFFFFU
# 1436 "project/radare2/libr/asm/arch/arm/armass64.c"
               ;
 }
 free (ops.mnemonic);
 return *op != 
# 1439 "project/radare2/libr/asm/arch/arm/armass64.c" 3 4
              0xFFFFFFFFU
# 1439 "project/radare2/libr/asm/arch/arm/armass64.c"
                      ;
}
