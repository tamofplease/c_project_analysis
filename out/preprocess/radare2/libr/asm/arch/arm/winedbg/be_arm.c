# 0 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
# 21 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
...
# 22 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 2
...
# 23 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 2
...
# 24 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 2
...
typedef int RRef;
# 25 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 2
...
# 26 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 2
# 1 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.h" 1




# 4 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.h"
struct winedbg_arm_insn {
 
# 5 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.h" 3 4
unsigned long long 
# 5 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.h"
     pc;
 const 
# 6 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.h" 3 4
      unsigned char 
# 6 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.h"
          *buf;
 int thumb;
 char *str_asm;
 char *str_hex;
 
# 10 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.h" 3 4
unsigned long long 
# 10 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.h"
     jmp, fail;
};

int arm_disasm_one_insn(struct winedbg_arm_insn *arminsn);
void arm_set_pc(struct winedbg_arm_insn *arminsn, 
# 14 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.h" 3 4
                                                 unsigned long long 
# 14 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.h"
                                                      pc);
void arm_set_input_buffer(struct winedbg_arm_insn *arminsn, const 
# 15 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.h" 3 4
                                                                 unsigned char 
# 15 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.h"
                                                                     *buf);
...
# 27 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 2
# 37 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
...
static 
# 77 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 77 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           db_get_inst(const 
# 77 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                             unsigned char
# 77 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
...
# 78 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned int 
# 78 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     result = 0;

 switch (size) {
 case 4:
  result = *(
# 82 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
            unsigned int
# 82 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                *)buf;
  break;
 case 2:
  result = *(
# 85 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
            unsigned short
# 85 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                *)buf;
  break;
 }
 return result;
...
static 
# 91 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 91 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           arm_disasm_branch(struct winedbg_arm_insn *arminsn, 
# 91 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                               unsigned int 
# 91 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                    inst) {
 ...
 offset += 8;
 arminsn->str_asm = r_str_appendf (arminsn->str_asm, "b%s%s 0x%"
# 99 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                               "llx"
# 99 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                      , link ? "l" : "", tbl_cond[(((inst)) >> 28) & 0x0f], arminsn->pc+offset);
...
static 
# 106 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 106 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           arm_disasm_mul(struct winedbg_arm_insn *arminsn, 
# 106 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                            unsigned int 
# 106 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                 inst) {
 ...
 if (accu) {
  arminsn->str_asm = r_str_appendf (arminsn->str_asm, "mla%s%s %s, %s, %s, %s", tbl_cond[(((inst)) >> 28) & 0x0f], condcodes ? "s" : "",
    tbl_regs[((((inst)) >> (((4)) * 4)) & 0x0f)], tbl_regs[((((inst)) >> (((0)) * 4)) & 0x0f)],
    tbl_regs[((((inst)) >> (((2)) * 4)) & 0x0f)], tbl_regs[((((inst)) >> (((3)) * 4)) & 0x0f)]);
 } else {
  arminsn->str_asm = r_str_appendf (arminsn->str_asm, "mul%s%s %s, %s, %s", tbl_cond[(((inst)) >> 28) & 0x0f], condcodes ? "s" : "",
    tbl_regs[((((inst)) >> (((4)) * 4)) & 0x0f)], tbl_regs[((((inst)) >> (((0)) * 4)) & 0x0f)],
    tbl_regs[((((inst)) >> (((2)) * 4)) & 0x0f)]);
 }
 return 0;
}

static 
# 122 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 122 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           arm_disasm_longmul(struct winedbg_arm_insn *arminsn, 
# 122 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                unsigned int 
# 122 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                     inst) {
 ...
 arminsn->str_asm = r_str_appendf (arminsn->str_asm, "%s%s%s%s %s, %s, %s, %s", sign ? "s" : "u", accu ? "mlal" : "mull",
   tbl_cond[(((inst)) >> 28) & 0x0f], condcodes ? "s" : "",
   tbl_regs[((((inst)) >> (((3)) * 4)) & 0x0f)], tbl_regs[((((inst)) >> (((4)) * 4)) & 0x0f)],
   tbl_regs[((((inst)) >> (((0)) * 4)) & 0x0f)], tbl_regs[((((inst)) >> (((2)) * 4)) & 0x0f)]);
 return 0;
}

static 
# 134 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 134 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           arm_disasm_swp(struct winedbg_arm_insn *arminsn, 
# 134 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                            unsigned int 
# 134 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                 inst) {
 ...
 arminsn->str_asm = r_str_appendf (arminsn->str_asm, "swp%s%s %s, %s, [%s]", tbl_cond[(((inst)) >> 28) & 0x0f], byte ? "b" : "",
   tbl_regs[((((inst)) >> (((3)) * 4)) & 0x0f)], tbl_regs[((((inst)) >> (((0)) * 4)) & 0x0f)],
   tbl_regs[((((inst)) >> (((4)) * 4)) & 0x0f)]);
 return 0;
}

static 
# 143 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 143 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           arm_disasm_branchxchg(struct winedbg_arm_insn *arminsn, 
# 143 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                   unsigned int 
# 143 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                        inst) {
 arminsn->str_asm = r_str_appendf (arminsn->str_asm, "bx%s %s", tbl_cond[(((inst)) >> 28) & 0x0f], tbl_regs[((((inst)) >> (((0)) * 4)) & 0x0f)]);
 return 0;
}

static 
# 148 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 148 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           arm_disasm_mrstrans(struct winedbg_arm_insn *arminsn, 
# 148 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                 unsigned int 
# 148 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                      inst) {
 ...
 arminsn->str_asm = r_str_appendf (arminsn->str_asm, "mrs%s %s, %s", tbl_cond[(((inst)) >> 28) & 0x0f], tbl_regs[((((inst)) >> (((3)) * 4)) & 0x0f)],
   src ? "spsr" : "cpsr");
 return 0;
}

static 
# 156 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 156 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           arm_disasm_msrtrans(struct winedbg_arm_insn *arminsn, 
# 156 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                 unsigned int 
# 156 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                      inst) {
 ...
 if (!immediate) {
  arminsn->str_asm = r_str_appendf (arminsn->str_asm, "msr%s %s, %s", tbl_cond[(((inst)) >> 28) & 0x0f], dst ? "spsr" : "cpsr",
    tbl_regs[((((inst)) >> (((0)) * 4)) & 0x0f)]);
  return 0;
 }
 arminsn->str_asm = r_str_appendf (arminsn->str_asm, "msr%s %s, #%u", tbl_cond[(((inst)) >> 28) & 0x0f], dst ? "spsr" : "cpsr",
   (((inst & 0xff) >> (2 * ((((inst)) >> (((2)) * 4)) & 0x0f))) | ((inst & 0xff) << (32 - (2 * ((((inst)) >> (((2)) * 4)) & 0x0f))))));
 return 0;
}

static 
# 170 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 170 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           arm_disasm_wordmov(struct winedbg_arm_insn *arminsn, 
# 170 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                unsigned int 
# 170 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                     inst) {
 ...
 arminsn->str_asm = r_str_appendf (arminsn->str_asm, "mov%s%s %s, #%u", top ? "t" : "w", tbl_cond[(((inst)) >> 28) & 0x0f],
   tbl_regs[((((inst)) >> (((3)) * 4)) & 0x0f)],
   (((((inst)) >> (((4)) * 4)) & 0x0f) << 12) | (inst & 0x0fff));
 return 0;
}

static 
# 179 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 179 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           arm_disasm_nop(struct winedbg_arm_insn *arminsn, 
# 179 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                            unsigned int 
# 179 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                 inst) {
 arminsn->str_asm = r_str_appendf (arminsn->str_asm, "nop%s", tbl_cond[(((inst)) >> 28) & 0x0f]);
 return 0;
}

static 
# 184 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 184 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           arm_disasm_dataprocessing(struct winedbg_arm_insn *arminsn, 
# 184 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                       unsigned int 
# 184 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                            inst) {
 ...
 arminsn->str_asm = r_str_appendf (arminsn->str_asm, "%s%s%s", tbl_dataops[opcode], condcodes ? "s" : "", tbl_cond[(((inst)) >> 28) & 0x0f]);
 if (!no_dst) {
  arminsn->str_asm = r_str_appendf (arminsn->str_asm, " %s, ", tbl_regs[((((inst)) >> (((3)) * 4)) & 0x0f)]);
 } else {
  arminsn->str_asm = r_str_appendf (arminsn->str_asm, " ");
 }
 if (no_op1) {
  if (immediate) {
   arminsn->str_asm = r_str_appendf (arminsn->str_asm, "#%u", (((inst & 0xff) >> (2 * ((((inst)) >> (((2)) * 4)) & 0x0f))) | ((inst & 0xff) << (32 - (2 * ((((inst)) >> (((2)) * 4)) & 0x0f))))));
  } else {
   arminsn->str_asm = r_str_appendf (arminsn->str_asm, "%s", tbl_regs[((((inst)) >> (((0)) * 4)) & 0x0f)]);
  }
 } else {
  if (immediate) {
   arminsn->str_asm = r_str_appendf (arminsn->str_asm, "%s, #%u", tbl_regs[((((inst)) >> (((4)) * 4)) & 0x0f)],
     (((inst & 0xff) >> (2 * ((((inst)) >> (((2)) * 4)) & 0x0f))) | ((inst & 0xff) << (32 - (2 * ((((inst)) >> (((2)) * 4)) & 0x0f))))));
  } else if (((inst >> 4) & 0xff) == 0x00) {
   arminsn->str_asm = r_str_appendf (arminsn->str_asm, "%s, %s", tbl_regs[((((inst)) >> (((4)) * 4)) & 0x0f)],
     tbl_regs[((((inst)) >> (((0)) * 4)) & 0x0f)]);
  } else if (((inst >> 4) & 0x09) == 0x01) {
   arminsn->str_asm = r_str_appendf (arminsn->str_asm, "%s, %s, %s %s", tbl_regs[((((inst)) >> (((4)) * 4)) & 0x0f)],
     tbl_regs[((((inst)) >> (((0)) * 4)) & 0x0f)],
     tbl_shifts[(inst >> 5) & 0x03], tbl_regs[(inst >> 8) & 0x0f]);
  } else if (((inst >> 4) & 0x01) == 0x00) {
   arminsn->str_asm = r_str_appendf (arminsn->str_asm, "%s, %s, %s #%d", tbl_regs[((((inst)) >> (((4)) * 4)) & 0x0f)],
     tbl_regs[((((inst)) >> (((0)) * 4)) & 0x0f)], tbl_shifts[(inst >> 5) & 0x03],
     (inst >> 7) & 0x1f);
  } else {
   return inst;
  }
...
static 
# 225 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 225 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           arm_disasm_singletrans(struct winedbg_arm_insn *arminsn, 
# 225 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                    unsigned int 
# 225 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                         inst) {
 ...
 arminsn->str_asm = r_str_appendf (arminsn->str_asm, "%s%s%s%s", load ? "ldr" : "str", byte ? "b" : "", writeback ? "t" : "",
   tbl_cond[(((inst)) >> 28) & 0x0f]);
 arminsn->str_asm = r_str_appendf (arminsn->str_asm, " %s, ", tbl_regs[((((inst)) >> (((3)) * 4)) & 0x0f)]);
 if (indexing) {
  if (immediate) {
   arminsn->str_asm = r_str_appendf (arminsn->str_asm, "[%s, #%s%d]", tbl_regs[((((inst)) >> (((4)) * 4)) & 0x0f)], direction ? "" : "-", offset);
  } else if (((inst >> 4) & 0xff) == 0x00) {
   arminsn->str_asm = r_str_appendf (arminsn->str_asm, "[%s, %s]", tbl_regs[((((inst)) >> (((4)) * 4)) & 0x0f)],
     tbl_regs[((((inst)) >> (((0)) * 4)) & 0x0f)]);
  } else if (((inst >> 4) & 0x01) == 0x00) {
...
static 
# 267 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 267 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           arm_disasm_halfwordtrans(struct winedbg_arm_insn *arminsn, 
# 267 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                      unsigned int 
# 267 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                           inst) {
 ...
 arminsn->str_asm = r_str_appendf (arminsn->str_asm, "%s%s%s%s%s", load ? "ldr" : "str", sign ? "s" : "",
   halfword ? "h" : (sign ? "b" : ""), writeback ? "t" : "", tbl_cond[(((inst)) >> 28) & 0x0f]);
 arminsn->str_asm = r_str_appendf (arminsn->str_asm, " %s, ", tbl_regs[((((inst)) >> (((3)) * 4)) & 0x0f)]);
 if (indexing) {
  if (immediate) {
   arminsn->str_asm = r_str_appendf (arminsn->str_asm, "[%s, #%s%d]", tbl_regs[((((inst)) >> (((4)) * 4)) & 0x0f)], direction ? "" : "-", offset);
...
static 
# 298 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 298 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           arm_disasm_blocktrans(struct winedbg_arm_insn *arminsn, 
# 298 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                   unsigned int 
# 298 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                        inst) {
...
# 304 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
_Bool 
# 304 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     first = 
# 304 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
             1
# 304 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
 ...
 arminsn->str_asm = r_str_appendf (arminsn->str_asm, "%s%s%s %s%s, {", load ? "ldm" : "stm", tbl_addrmode[addrmode],
   tbl_cond[(((inst)) >> 28) & 0x0f], tbl_regs[((((inst)) >> (((4)) * 4)) & 0x0f)], writeback ? "!" : "");
 for (i = 0; i < 16; i++, inst >>= 1) {
  if (inst & 1) {
   arminsn->str_asm = r_str_appendf (arminsn->str_asm, "%s%s", first ? "" : ", ", tbl_regs[i]);
   first = 
# 311 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
          0
# 311 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
               ;
  }
 }
...
static 
# 318 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 318 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           arm_disasm_swi(struct winedbg_arm_insn *arminsn, 
# 318 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                            unsigned int 
# 318 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                 inst) {
 
# 319 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned int 
# 319 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     comment = inst & 0x00ffffff;
 arminsn->str_asm = r_str_appendf (arminsn->str_asm, "swi%s #%d", tbl_cond[(((inst)) >> 28) & 0x0f], comment);
 return 0;
}

static 
# 324 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 324 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           arm_disasm_coproctrans(struct winedbg_arm_insn *arminsn, 
# 324 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                    unsigned int 
# 324 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                         inst) {
 
# 325 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 325 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     CRm = inst & 0x0f;
 
# 326 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 326 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     CP_Opc2 = (inst >> 5) & 0x07;
 
# 327 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 327 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     CPnum = (inst >> 8) & 0x0f;
 
# 328 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 328 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     CRn = (inst >> 16) & 0x0f;
 
# 329 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 329 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     load = (inst >> 20) & 0x01;
 
# 330 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 330 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     CP_Opc1 = (inst >> 21) & 0x07;

 arminsn->str_asm = r_str_appendf (arminsn->str_asm, "%s%s %u, %u, %s, cr%u, cr%u, {%u}", load ? "mrc" : "mcr",
   tbl_cond[(((inst)) >> 28) & 0x0f], CPnum, CP_Opc1, tbl_regs[((((inst)) >> (((3)) * 4)) & 0x0f)], CRn, CRm, CP_Opc2);
 return 0;
}

static 
# 337 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 337 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           arm_disasm_coprocdataop(struct winedbg_arm_insn *arminsn, 
# 337 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                     unsigned int 
# 337 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                          inst) {
 
# 338 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 338 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     CRm = inst & 0x0f;
 
# 339 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 339 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     CP_Opc2 = (inst >> 5) & 0x07;
 
# 340 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 340 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     CPnum = (inst >> 8) & 0x0f;
 
# 341 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 341 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     CRd = (inst >> 12) & 0x0f;
 
# 342 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 342 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     CRn = (inst >> 16) & 0x0f;
 
# 343 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 343 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     CP_Opc1 = (inst >> 20) & 0x0f;

 arminsn->str_asm = r_str_appendf (arminsn->str_asm, "cdp%s %u, %u, cr%u, cr%u, cr%u, {%u}", tbl_cond[(((inst)) >> 28) & 0x0f],
   CPnum, CP_Opc1, CRd, CRn, CRm, CP_Opc2);
 return 0;
}

static 
# 350 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 350 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           arm_disasm_coprocdatatrans(struct winedbg_arm_insn *arminsn, 
# 350 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                        unsigned int 
# 350 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                             inst) {
 
# 351 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 351 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     CPnum = (inst >> 8) & 0x0f;
 
# 352 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 352 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     CRd = (inst >> 12) & 0x0f;
 
# 353 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 353 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     load = (inst >> 20) & 0x01;
 
# 354 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 354 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     writeback = (inst >> 21) & 0x01;
 
# 355 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 355 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     translen = (inst >> 22) & 0x01;
 
# 356 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 356 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     direction = (inst >> 23) & 0x01;
 
# 357 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 357 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     indexing = (inst >> 24) & 0x01;
 short offset = (inst & 0xff) << 2;

 arminsn->str_asm = r_str_appendf (arminsn->str_asm, "%s%s%s", load ? "ldc" : "stc", translen ? "l" : "", tbl_cond[(((inst)) >> 28) & 0x0f]);
 if (indexing) {
  arminsn->str_asm = r_str_appendf (arminsn->str_asm, " %u, cr%u, [%s, #%s%d]%s", CPnum, CRd, tbl_regs[((((inst)) >> (((4)) * 4)) & 0x0f)],
   direction ? "" : "-", offset, writeback ? "!" : "");
 } else {
  arminsn->str_asm = r_str_appendf (arminsn->str_asm, " %u, cr%u, [%s], #%s%d", CPnum, CRd, tbl_regs[((((inst)) >> (((4)) * 4)) & 0x0f)],
   direction ? "" : "-", offset);
 }
 return 0;
}
...
static 
# 371 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned short 
# 371 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb_disasm_hireg(struct winedbg_arm_insn *arminsn, 
# 371 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                unsigned short 
# 371 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                     inst) {
...
static 
# 399 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned short 
# 399 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb_disasm_aluop(struct winedbg_arm_insn *arminsn, 
# 399 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                unsigned short 
# 399 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                     inst) {
...
static 
# 408 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned short 
# 408 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb_disasm_pushpop(struct winedbg_arm_insn *arminsn, 
# 408 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                  unsigned short 
# 408 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                       inst) {
...
# 412 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
_Bool 
# 412 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     first = 
# 412 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
             1
# 412 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
 ...
 for (i = 0; i < 8; i++, inst >>= 1) {
  if (inst & 1) {
   arminsn->str_asm = r_str_appendf (arminsn->str_asm, "%s%s", first ? "" : ", ", tbl_regs[i]);
   first = 
# 419 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
          0
# 419 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
               ;
  }
 }
 if (lrpc) {
...
static 
# 430 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned short 
# 430 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb_disasm_blocktrans(struct winedbg_arm_insn *arminsn, 
# 430 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                     unsigned short 
# 430 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                          inst) {
...
# 433 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
_Bool 
# 433 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     first = 
# 433 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
             1
# 433 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
 ...
 for (i = 0; i < 8; i++, inst >>= 1) {
  if (inst & 1) {
   arminsn->str_asm = r_str_appendf (arminsn->str_asm, "%s%s", first ? "" : ", ", tbl_regs[i]);
   first = 
# 440 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
          0
# 440 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
               ;
  }
 }
...
static 
# 448 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned short 
# 448 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb_disasm_condbranch(struct winedbg_arm_insn *arminsn, 
# 448 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                     unsigned short 
# 448 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                          inst) {
 
# 449 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 449 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     offset = inst & 0x00ff;
 arminsn->str_asm = r_str_appendf (arminsn->str_asm, "b%s 0x%"
# 450 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                             "llx"
# 450 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                    , tbl_cond[(inst >> 8) & 0x0f], arminsn->pc+offset);
...
static 
# 457 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned short 
# 457 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb_disasm_uncondbranch(struct winedbg_arm_insn *arminsn, 
# 457 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                       unsigned short 
# 457 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                            inst) {
 ...
 offset += 4;
 arminsn->str_asm = r_str_appendf (arminsn->str_asm, "b 0x%"
# 464 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                           "llx"
# 464 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                  , arminsn->pc+offset);
...
static 
# 470 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned short 
# 470 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb_disasm_loadadr(struct winedbg_arm_insn *arminsn, 
# 470 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                  unsigned short 
# 470 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                       inst) {
 
# 471 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 471 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     src = (inst >> 11) & 0x01;
 
# 472 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 472 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     offset = (inst & 0xff) << 2;
...
static 
# 479 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned short 
# 479 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb_disasm_swi(struct winedbg_arm_insn *arminsn, 
# 479 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                              unsigned short 
# 479 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                   inst) {
 
# 480 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 480 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     comment = inst & 0x00ff;
...
static 
# 485 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned short 
# 485 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb_disasm_nop(struct winedbg_arm_insn *arminsn, 
# 485 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                              unsigned short 
# 485 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                   inst) {
...
static 
# 490 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned short 
# 490 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb_disasm_ldrpcrel(struct winedbg_arm_insn *arminsn, 
# 490 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                   unsigned short 
# 490 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                        inst) {
 
# 491 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 491 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     offset = (inst & 0xff) << 2;
...
static 
# 496 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned short 
# 496 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb_disasm_ldrsprel(struct winedbg_arm_insn *arminsn, 
# 496 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                   unsigned short 
# 496 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                        inst) {
 
# 497 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 497 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     offset = (inst & 0xff) << 2;
...
static 
# 503 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned short 
# 503 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb_disasm_addsprel(struct winedbg_arm_insn *arminsn, 
# 503 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                   unsigned short 
# 503 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                        inst) {
 
# 504 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 504 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     offset = (inst & 0x7f) << 2;
 if ((inst >> 7) & 0x01) {
...
static 
# 514 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned short 
# 514 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb_disasm_ldrimm(struct winedbg_arm_insn *arminsn, 
# 514 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                 unsigned short 
# 514 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                      inst) {
 
# 515 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 515 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     offset = (inst & 0x07c0) >> 6;
...
static 
# 523 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned short 
# 523 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb_disasm_ldrhimm(struct winedbg_arm_insn *arminsn, 
# 523 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                  unsigned short 
# 523 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                       inst) {
 
# 524 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 524 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     offset = (inst & 0x07c0) >> 5;
...
static 
# 530 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned short 
# 530 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb_disasm_ldrreg(struct winedbg_arm_insn *arminsn, 
# 530 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                 unsigned short 
# 530 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                      inst) {
...
static 
# 538 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned short 
# 538 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb_disasm_ldrsreg(struct winedbg_arm_insn *arminsn, 
# 538 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                  unsigned short 
# 538 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                       inst) {
...
static 
# 545 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned short 
# 545 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb_disasm_immop(struct winedbg_arm_insn *arminsn, 
# 545 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                unsigned short 
# 545 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                     inst) {
 
# 546 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 546 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     op = (inst >> 11) & 0x03;
...
static 
# 552 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned short 
# 552 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb_disasm_addsub(struct winedbg_arm_insn *arminsn, 
# 552 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                 unsigned short 
# 552 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                      inst) {
 
# 553 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 553 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     op = (inst >> 9) & 0x01;
 
# 554 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 554 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     immediate = (inst >> 10) & 0x01;
...
static 
# 567 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned short 
# 567 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb_disasm_movshift(struct winedbg_arm_insn *arminsn, 
# 567 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                   unsigned short 
# 567 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                        inst) {
 
# 568 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 568 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     op = (inst >> 11) & 0x03;
...
static 
# 574 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 574 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb2_disasm_branchlinked(struct winedbg_arm_insn *arminsn, 
# 574 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                        unsigned int 
# 574 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                             inst) {
 
# 575 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned int 
# 575 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     offset = (((inst & 0x07ff0000) >> 4) | ((inst & 0x000007ff) << 1)) + 4;
 arminsn->str_asm = r_str_appendf (arminsn->str_asm, "bl 0x%"
# 576 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                            "llx"
# 576 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                   , arminsn->pc+offset);
...
static 
# 582 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 582 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb2_disasm_misc(struct winedbg_arm_insn *arminsn, 
# 582 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                unsigned int 
# 582 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                     inst) {
 
# 583 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 583 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     op1 = (inst >> 20) & 0x03;
 
# 584 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 584 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     op2 = (inst >> 4) & 0x03;

 if (((((inst)) >> (((4)) * 4)) & 0x0f) != ((((inst)) >> (((0)) * 4)) & 0x0f)) {
  return inst;
 }

 if (op1 == 3 && op2 == 0) {
  arminsn->str_asm = r_str_appendf (arminsn->str_asm, "clz %s, %s ", tbl_regs[((((inst)) >> (((2)) * 4)) & 0x0f)],
    tbl_regs[((((inst)) >> (((0)) * 4)) & 0x0f)]);
  return 0;
 }
 ...
 if (op1 == 1) {
  ...
  arminsn->str_asm = r_str_appendf (arminsn->str_asm, "%s, %s ", tbl_regs[((((inst)) >> (((2)) * 4)) & 0x0f)], tbl_regs[((((inst)) >> (((0)) * 4)) & 0x0f)]);
  return 0;
 }
...
static 
# 618 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 618 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb2_disasm_mul(struct winedbg_arm_insn *arminsn, 
# 618 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                               unsigned int 
# 618 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                    inst) {
 
# 619 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 619 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     op1 = (inst >> 20) & 0x07;
 
# 620 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 620 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     op2 = (inst >> 4) & 0x03;
 ...
 if (op2 == 0 && ((((inst)) >> (((3)) * 4)) & 0x0f) != 0xf) {
  arminsn->str_asm = r_str_appendf (arminsn->str_asm, "mla %s, %s, %s, %s ", tbl_regs[((((inst)) >> (((2)) * 4)) & 0x0f)],
    tbl_regs[((((inst)) >> (((4)) * 4)) & 0x0f)],
    tbl_regs[((((inst)) >> (((0)) * 4)) & 0x0f)],
    tbl_regs[((((inst)) >> (((3)) * 4)) & 0x0f)]);
  return 0;
 ...
 if (op2 == 0 && ((((inst)) >> (((3)) * 4)) & 0x0f) == 0xf) {
  arminsn->str_asm = r_str_appendf (arminsn->str_asm, "mul %s, %s, %s ", tbl_regs[((((inst)) >> (((2)) * 4)) & 0x0f)],
    tbl_regs[((((inst)) >> (((4)) * 4)) & 0x0f)],
    tbl_regs[((((inst)) >> (((0)) * 4)) & 0x0f)]);
  return 0;
 }
 ...
 if (op2 == 1) {
  arminsn->str_asm = r_str_appendf (arminsn->str_asm, "mls %s, %s, %s, %s ", tbl_regs[((((inst)) >> (((2)) * 4)) & 0x0f)],
    tbl_regs[((((inst)) >> (((4)) * 4)) & 0x0f)],
    tbl_regs[((((inst)) >> (((0)) * 4)) & 0x0f)],
    tbl_regs[((((inst)) >> (((3)) * 4)) & 0x0f)]);
  return 0;
...
static 
# 652 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 652 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb2_disasm_longmuldiv(struct winedbg_arm_insn *arminsn, 
# 652 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                      unsigned int 
# 652 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                           inst) {
 
# 653 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 653 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     op1 = (inst >> 20) & 0x07;
 
# 654 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 654 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     op2 = (inst >> 4) & 0x0f;
 ...
 if (op2 == 0) {
  ...
  arminsn->str_asm = r_str_appendf (arminsn->str_asm, "%s, %s, %s, %s ",
    tbl_regs[((((inst)) >> (((3)) * 4)) & 0x0f)], tbl_regs[((((inst)) >> (((2)) * 4)) & 0x0f)],
    tbl_regs[((((inst)) >> (((4)) * 4)) & 0x0f)], tbl_regs[((((inst)) >> (((0)) * 4)) & 0x0f)]);
  return 0;
 }
 ...
 if (op2 == 0xffff) {
  ...
  arminsn->str_asm = r_str_appendf (arminsn->str_asm, "%s, %s, %s ", tbl_regs[((((inst)) >> (((2)) * 4)) & 0x0f)], tbl_regs[((((inst)) >> (((4)) * 4)) & 0x0f)],
    tbl_regs[((((inst)) >> (((0)) * 4)) & 0x0f)]);
  return 0;
 }
...
static 
# 698 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned int 
# 698 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           thumb2_disasm_coprocmov1(struct winedbg_arm_insn *arminsn, 
# 698 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                      unsigned int 
# 698 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                           inst) {
 
# 699 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 699 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     opc1 = (inst >> 21) & 0x07;
 
# 700 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 700 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     opc2 = (inst >> 5) & 0x07;

 if (opc2) {
  arminsn->str_asm = r_str_appendf (arminsn->str_asm,
    "%s%s\tp%u, #%u, %s, cr%u, cr%u, #%u", (inst & 0x00100000)?"mrc":"mcr",
    (inst & 0x10000000)?"2":"", ((((inst)) >> (((2)) * 4)) & 0x0f), opc1,
    tbl_regs[((((inst)) >> (((3)) * 4)) & 0x0f)], ((((inst)) >> (((4)) * 4)) & 0x0f), ((((inst)) >> (((0)) * 4)) & 0x0f), opc2);
 }
 else {
  arminsn->str_asm = r_str_appendf (arminsn->str_asm,
    "%s%s\tp%u, #%u, %s, cr%u, cr%u", (inst & 0x00100000)?"mrc":"mcr",
    (inst & 0x10000000)?"2":"", ((((inst)) >> (((2)) * 4)) & 0x0f), opc1,
    tbl_regs[((((inst)) >> (((3)) * 4)) & 0x0f)], ((((inst)) >> (((4)) * 4)) & 0x0f), ((((inst)) >> (((0)) * 4)) & 0x0f));
 }
 return 0;
}
...
# 718 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned int 
# 718 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     mask;
 
# 719 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned int 
# 719 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     pattern;
 
# 720 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned int 
# 720 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     (*func)(struct winedbg_arm_insn*, 
# 720 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                       unsigned int
# 720 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                           );
...
# 741 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                          ((void *)0) 
# 741 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                               }
};

struct inst_thumb16 {
 
# 745 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 745 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     mask;
 
# 746 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 746 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     pattern;
 
# 747 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 747 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     (*func)(struct winedbg_arm_insn*, 
# 747 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                       unsigned short
# 747 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
...
static const struct inst_thumb16 tbl_thumb16[] = {
 ...
 { 0x0000, 0x0000, 
# 770 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                  ((void *)0) 
# 770 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                       }
};
...
static const struct inst_arm tbl_thumb32[] = {
 ...
 { 0x00000000, 0x00000000, 
# 781 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                          ((void *)0) 
# 781 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                               }
};

void arm_set_pc(struct winedbg_arm_insn *arminsn, 
# 784 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                 unsigned long long 
# 784 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                      pc) {
 arminsn->pc = pc;
}

void arm_set_input_buffer(struct winedbg_arm_insn *arminsn, const 
# 788 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                 unsigned char 
# 788 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                     *buf) {
 arminsn->buf = buf;
}
...
void* arm_free(struct winedbg_arm_insn *arminsn) {
 ...
 free(arminsn);
 return 
# 808 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
       ((void *)0)
# 808 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
           ;
}
...
struct winedbg_arm_insn* arm_new() {
 ...
 ret->pc = 0;
 ret->thumb = 
# 815 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
             0
# 815 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                  ;
 ret->str_hex = 
# 816 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
               ((void *)0)
# 816 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                   ;
 ret->str_asm = 
# 817 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
               ((void *)0)
# 817 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                   ;
 return ret;
}
...
# 825 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned int 
# 825 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     inst;
 
# 826 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
unsigned short 
# 826 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
     tinst;
 int size;
 int matched = 0;
 ...
 if (!arminsn->thumb) {
  ...
  arminsn->str_hex = r_str_appendf (arminsn->str_hex, "%02x%02x%02x%02x",
    *((
# 849 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
      unsigned char
# 849 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
         *)(&inst)), *((
# 849 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                        unsigned char
# 849 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
...
# 849 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
  ...
  tinst = db_get_inst(arminsn->buf, 2);
  switch (tinst & 0xf800) {
  case 0xe800:
  case 0xf000:
  case 0xf800:
   size = 4;
   inst = db_get_inst(arminsn->buf+1, 2);
   inst |= (tinst << 16);
   ...
   arminsn->str_hex = r_str_appendf (arminsn->str_hex, "%02x%02x%02x%02x",
     *((
# 876 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
       unsigned char
# 876 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
          *)(&inst)), *((
# 876 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                         unsigned char
# 876 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
...
# 876 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
  ...
  arminsn->str_hex = r_str_appendf (arminsn->str_hex, "%02x%02x", *((
# 897 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                    unsigned char
# 897 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
                                                                       *)(&tinst)), *((
# 897 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c" 3 4
                                                                                       unsigned char
# 897 "project/radare2/libr/asm/arch/arm/winedbg/be_arm.c"
