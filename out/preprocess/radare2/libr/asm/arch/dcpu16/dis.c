# 0 "project/radare2/libr/asm/arch/dcpu16/dis.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/arch/dcpu16/dis.c"
...
# 6 "project/radare2/libr/asm/arch/dcpu16/dis.c" 2
...
# 7 "project/radare2/libr/asm/arch/dcpu16/dis.c" 2
...
# 8 "project/radare2/libr/asm/arch/dcpu16/dis.c" 2
...
static inline int needWord(unsigned char type) {
 return ((type <= 0x17) && (type > 0x0f))
  || (type == 0x1e) || (type == 0x1f);
}

static int valPrint(char *out, size_t len, unsigned char type, unsigned short value) {
 if (type <= 0x07) return 
# 61 "project/radare2/libr/asm/arch/dcpu16/dis.c" 3 4
                         __builtin___snprintf_chk (
# 61 "project/radare2/libr/asm/arch/dcpu16/dis.c"
                         out
# 61 "project/radare2/libr/asm/arch/dcpu16/dis.c" 3 4
                         , 
# 61 "project/radare2/libr/asm/arch/dcpu16/dis.c"
...
# 61 "project/radare2/libr/asm/arch/dcpu16/dis.c"
                                                              ;
 if (type <= 0x0f) return 
# 62 "project/radare2/libr/asm/arch/dcpu16/dis.c" 3 4
                         __builtin___snprintf_chk (
# 62 "project/radare2/libr/asm/arch/dcpu16/dis.c"
                         out
# 62 "project/radare2/libr/asm/arch/dcpu16/dis.c" 3 4
                         , 
# 62 "project/radare2/libr/asm/arch/dcpu16/dis.c"
...
# 62 "project/radare2/libr/asm/arch/dcpu16/dis.c"
                                                                       ;
 if (type <= 0x17) return 
# 63 "project/radare2/libr/asm/arch/dcpu16/dis.c" 3 4
                         __builtin___snprintf_chk (
# 63 "project/radare2/libr/asm/arch/dcpu16/dis.c"
                         out
# 63 "project/radare2/libr/asm/arch/dcpu16/dis.c" 3 4
                         , 
# 63 "project/radare2/libr/asm/arch/dcpu16/dis.c"
...
# 63 "project/radare2/libr/asm/arch/dcpu16/dis.c"
                                                                                     ;
 if (type <= 0x1d) return 
# 64 "project/radare2/libr/asm/arch/dcpu16/dis.c" 3 4
                         __builtin___snprintf_chk (
# 64 "project/radare2/libr/asm/arch/dcpu16/dis.c"
                         out
# 64 "project/radare2/libr/asm/arch/dcpu16/dis.c" 3 4
                         , 
# 64 "project/radare2/libr/asm/arch/dcpu16/dis.c"
...
# 64 "project/radare2/libr/asm/arch/dcpu16/dis.c"
                                                                            ;
 if (type == 0x1e) return 
# 65 "project/radare2/libr/asm/arch/dcpu16/dis.c" 3 4
                         __builtin___snprintf_chk (
# 65 "project/radare2/libr/asm/arch/dcpu16/dis.c"
                         out
# 65 "project/radare2/libr/asm/arch/dcpu16/dis.c" 3 4
                         , 
# 65 "project/radare2/libr/asm/arch/dcpu16/dis.c"
...
# 65 "project/radare2/libr/asm/arch/dcpu16/dis.c"
                                                             ;
 if (type == 0x1f) return 
# 66 "project/radare2/libr/asm/arch/dcpu16/dis.c" 3 4
                         __builtin___snprintf_chk (
# 66 "project/radare2/libr/asm/arch/dcpu16/dis.c"
                         out
# 66 "project/radare2/libr/asm/arch/dcpu16/dis.c" 3 4
                         , 
# 66 "project/radare2/libr/asm/arch/dcpu16/dis.c"
...
# 66 "project/radare2/libr/asm/arch/dcpu16/dis.c"
                                                           ;
 return 
# 67 "project/radare2/libr/asm/arch/dcpu16/dis.c" 3 4
       __builtin___snprintf_chk (
# 67 "project/radare2/libr/asm/arch/dcpu16/dis.c"
       out
# 67 "project/radare2/libr/asm/arch/dcpu16/dis.c" 3 4
       , 
# 67 "project/radare2/libr/asm/arch/dcpu16/dis.c"
...
static int instrPrint(char *out, const op* o) {
 ...
 if (o->code.opcode == 0) {
  ...
  return 
# 78 "project/radare2/libr/asm/arch/dcpu16/dis.c" 3 4
        __builtin___sprintf_chk (
# 78 "project/radare2/libr/asm/arch/dcpu16/dis.c"
        out
# 78 "project/radare2/libr/asm/arch/dcpu16/dis.c" 3 4
        , 0, __builtin_object_size (
# 78 "project/radare2/libr/asm/arch/dcpu16/dis.c"
...
# 79 "project/radare2/libr/asm/arch/dcpu16/dis.c"
                            ;
 }
 valPrint (arg, sizeof (arg), o->b.a_type, o->b.a);
 valPrint (arg2, sizeof (arg2), o->b.b_type, o->b.b);
 return 
# 83 "project/radare2/libr/asm/arch/dcpu16/dis.c" 3 4
       __builtin___sprintf_chk (
# 83 "project/radare2/libr/asm/arch/dcpu16/dis.c"
       out
# 83 "project/radare2/libr/asm/arch/dcpu16/dis.c" 3 4
       , 0, __builtin_object_size (
# 83 "project/radare2/libr/asm/arch/dcpu16/dis.c"
...
static int instrGet(unsigned short in, op* o, unsigned short a, unsigned short b) {
 int ret = 1;
