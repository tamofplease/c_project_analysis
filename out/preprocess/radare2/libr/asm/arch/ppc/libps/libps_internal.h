# 0 "project/radare2/libr/asm/arch/ppc/libps/libps_internal.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/arch/ppc/libps/libps_internal.h"
...
typedef int RRef;
# 6 "project/radare2/libr/asm/arch/ppc/libps/libps_internal.h" 2
