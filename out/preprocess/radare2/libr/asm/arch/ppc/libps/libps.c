# 0 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/arch/ppc/libps/libps.c"

# 1 "project/radare2/libr/asm/arch/ppc/libps/libps.h" 1
...
typedef int RRef;
# 6 "project/radare2/libr/asm/arch/ppc/libps/libps.h" 2


# 7 "project/radare2/libr/asm/arch/ppc/libps/libps.h"
typedef struct {
    
# 8 "project/radare2/libr/asm/arch/ppc/libps/libps.h" 3 4
   unsigned int 
# 8 "project/radare2/libr/asm/arch/ppc/libps/libps.h"
        value;
    
# 9 "project/radare2/libr/asm/arch/ppc/libps/libps.h" 3 4
   unsigned short 
# 9 "project/radare2/libr/asm/arch/ppc/libps/libps.h"
        type;
} ppcps_field_t;
...
# 17 "project/radare2/libr/asm/arch/ppc/libps/libps.h" 3 4
   unsigned int 
# 17 "project/radare2/libr/asm/arch/ppc/libps/libps.h"
        anal_op;
} ppcps_t;


# 20 "project/radare2/libr/asm/arch/ppc/libps/libps.h" 3 4
_Bool 
# 20 "project/radare2/libr/asm/arch/ppc/libps/libps.h"
    libps_decode(
# 20 "project/radare2/libr/asm/arch/ppc/libps/libps.h" 3 4
                 unsigned int 
# 20 "project/radare2/libr/asm/arch/ppc/libps/libps.h"
...
# 21 "project/radare2/libr/asm/arch/ppc/libps/libps.h" 3 4
                                       unsigned long long 
# 21 "project/radare2/libr/asm/arch/ppc/libps/libps.h"
                                            addr, ppcps_t* instr);
# 3 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 2
# 1 "project/radare2/libr/asm/arch/ppc/libps/libps_internal.h" 1
# 30 "project/radare2/libr/asm/arch/ppc/libps/libps_internal.h"
typedef enum {
    NO_OPERAND,
    OP_FA,
    OP_FB,
...
# 4 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 2
...
ps_opcode_t ps_opcodes_array[] = {
 { psq_lx, "psq_lx", (((((
# 24 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                    unsigned int
# 24 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                    )(4)) & 0x3f) << 26) | ((((
# 24 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                    unsigned int
# 24 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 24 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                unsigned int
# 24 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                )((0x3f))) & 0x3f) << 1)) | ((0) & 1)), { OP_FD, OP_RA, OP_RB, OP_WC, OP_IC}, "Paired Single Quantized Load Indexed"},
 { psq_stx, "psq_stx", (((((
# 25 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                      unsigned int
# 25 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                      )(4)) & 0x3f) << 26) | ((((
# 25 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                      unsigned int
# 25 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 25 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                  unsigned int
# 25 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                  )((0x3f))) & 0x3f) << 1)) | ((0) & 1)), { OP_FS, OP_RA, OP_RB, OP_WC, OP_IC}, "Paired Single Quantized Store Indexed"},
 { psq_lux, "psq_lux", (((((
# 26 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                      unsigned int
# 26 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                      )(4)) & 0x3f) << 26) | ((((
# 26 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                      unsigned int
# 26 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 26 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                   unsigned int
# 26 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                   )((0x3f))) & 0x3f) << 1)) | ((0) & 1)), { OP_FD, OP_RA, OP_RB, OP_WC, OP_IC}, "Paired Single Quantized Load with update Indexed"},
 { psq_stux, "psq_stux", (((((
# 27 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                        unsigned int
# 27 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                        )(4)) & 0x3f) << 26) | ((((
# 27 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                        unsigned int
# 27 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 27 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                     unsigned int
# 27 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                     )((0x3f))) & 0x3f) << 1)) | ((0) & 1)), { OP_FS, OP_RA, OP_RB, OP_WC, OP_IC}, "Paired Single Quantized Store with update Indexed"},

 { psq_l, "psq_l", ((((
# 29 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                  unsigned int
# 29 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                  )(56)) & 0x3f) << 26), ((((
# 29 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                           unsigned int
# 29 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                           )(0x3f)) & 0x3f) << 26), { OP_FD, OP_DRA, OP_WB, OP_IB}, "Paired Single Quantized Load"},
 { psq_lu, "psq_lu", ((((
# 30 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                    unsigned int
# 30 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                    )(57)) & 0x3f) << 26), ((((
# 30 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                             unsigned int
# 30 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                             )(0x3f)) & 0x3f) << 26), { OP_FD, OP_DRA, OP_WB, OP_IB}, "Paired Single Quantized Load with Update"},
 { psq_st, "psq_st", ((((
# 31 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                    unsigned int
# 31 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                    )(60)) & 0x3f) << 26), ((((
# 31 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                             unsigned int
# 31 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                             )(0x3f)) & 0x3f) << 26), { OP_FS, OP_DRA, OP_WB, OP_IB}, "Paired Single Quantized Store"},
 { psq_stu, "psq_stu", ((((
# 32 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                      unsigned int
# 32 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                      )(61)) & 0x3f) << 26), ((((
# 32 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                               unsigned int
# 32 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                               )(0x3f)) & 0x3f) << 26), { OP_FS, OP_DRA, OP_WB, OP_IB}, "Paired Single Quantized Store with update"},

 { ps_div, "ps_div", ((((((
# 34 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                    unsigned int
# 34 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                    )((4))) & 0x3f) << 26) | ((((
# 34 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                    unsigned int
# 34 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 34 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                     unsigned int
# 34 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                     )((0x1f))) & 0x1f) << 1)) | ((1) & 1)), { OP_FD, OP_FA, OP_FB}, "Paired Single Divide"},
 { ps_div_dot, "ps_div.", ((((((
# 35 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                         unsigned int
# 35 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                         )((4))) & 0x3f) << 26) | ((((
# 35 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                         unsigned int
# 35 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 35 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_sub, "ps_sub", ((((((
# 36 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                    unsigned int
# 36 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                    )((4))) & 0x3f) << 26) | ((((
# 36 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                    unsigned int
# 36 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 36 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                     unsigned int
# 36 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                     )((0x1f))) & 0x1f) << 1)) | ((1) & 1)), { OP_FD, OP_FA, OP_FB}, "Paired Single Subtract"},
 { ps_sub_dot, "ps_sub.", ((((((
# 37 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                         unsigned int
# 37 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                         )((4))) & 0x3f) << 26) | ((((
# 37 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                         unsigned int
# 37 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 37 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_add, "ps_add", ((((((
# 38 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                    unsigned int
# 38 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                    )((4))) & 0x3f) << 26) | ((((
# 38 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                    unsigned int
# 38 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 38 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                     unsigned int
# 38 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                     )((0x1f))) & 0x1f) << 1)) | ((1) & 1)), { OP_FD, OP_FA, OP_FB}, "Paired Single Add"},
 { ps_add_dot, "ps_add.", ((((((
# 39 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                         unsigned int
# 39 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                         )((4))) & 0x3f) << 26) | ((((
# 39 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                         unsigned int
# 39 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 39 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_sel, "ps_sel", ((((((
# 40 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                    unsigned int
# 40 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                    )((4))) & 0x3f) << 26) | ((((
# 40 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                    unsigned int
# 40 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 40 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                     unsigned int
# 40 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                     )((0x1f))) & 0x1f) << 1)) | ((1) & 1)), { OP_FD, OP_FA, OP_FC, OP_FB}, "Paired Single Select"},
 { ps_sel_dot, "ps_sel.", ((((((
# 41 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                         unsigned int
# 41 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                         )((4))) & 0x3f) << 26) | ((((
# 41 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                         unsigned int
# 41 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 41 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_res, "ps_res", ((((((
# 42 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                    unsigned int
# 42 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                    )((4))) & 0x3f) << 26) | ((((
# 42 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                    unsigned int
# 42 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 42 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                     unsigned int
# 42 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                     )((0x1f))) & 0x1f) << 1)) | ((1) & 1)), { OP_FD, OP_FB}, "Paired Single Reciprocal Estimate"},
 { ps_res_dot, "ps_res.", ((((((
# 43 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                         unsigned int
# 43 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                         )((4))) & 0x3f) << 26) | ((((
# 43 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                         unsigned int
# 43 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 43 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_mul, "ps_mul", ((((((
# 44 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                    unsigned int
# 44 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                    )((4))) & 0x3f) << 26) | ((((
# 44 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                    unsigned int
# 44 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 44 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                     unsigned int
# 44 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                     )((0x1f))) & 0x1f) << 1)) | ((1) & 1)), { OP_FD, OP_FA, OP_FC}, "Paired Single Multiply"},
 { ps_mul_dot, "ps_mul.", ((((((
# 45 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                         unsigned int
# 45 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                         )((4))) & 0x3f) << 26) | ((((
# 45 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                         unsigned int
# 45 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 45 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_rsqrte, "ps_rsqrte", ((((((
# 46 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                          unsigned int
# 46 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                          )((4))) & 0x3f) << 26) | ((((
# 46 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                          unsigned int
# 46 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 46 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                           unsigned int
# 46 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                           )((0x1f))) & 0x1f) << 1)) | ((1) & 1)), { OP_FD, OP_FB}, "Paired Single Reciprocal Square Root Estimate"},
 { ps_rsqrte_dot, "ps_rsqrte.", ((((((
# 47 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                               unsigned int
# 47 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                               )((4))) & 0x3f) << 26) | ((((
# 47 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                               unsigned int
# 47 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 47 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_msub, "ps_msub", ((((((
# 48 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                      unsigned int
# 48 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                      )((4))) & 0x3f) << 26) | ((((
# 48 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                      unsigned int
# 48 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 48 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                       unsigned int
# 48 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                       )((0x1f))) & 0x1f) << 1)) | ((1) & 1)), { OP_FD, OP_FA, OP_FC, OP_FB}, "Paired Single Multiply-Subtract"},
 { ps_msub_dot, "ps_msub.", ((((((
# 49 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                           unsigned int
# 49 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                           )((4))) & 0x3f) << 26) | ((((
# 49 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                           unsigned int
# 49 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 49 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_madd, "ps_madd", ((((((
# 50 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                      unsigned int
# 50 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                      )((4))) & 0x3f) << 26) | ((((
# 50 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                      unsigned int
# 50 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 50 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                       unsigned int
# 50 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                       )((0x1f))) & 0x1f) << 1)) | ((1) & 1)), { OP_FD, OP_FA, OP_FC, OP_FB}, "Paired Single Multiply-Add"},
 { ps_madd_dot, "ps_madd.", ((((((
# 51 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                           unsigned int
# 51 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                           )((4))) & 0x3f) << 26) | ((((
# 51 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                           unsigned int
# 51 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 51 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_nmsub, "ps_nmsub", ((((((
# 52 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                        unsigned int
# 52 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                        )((4))) & 0x3f) << 26) | ((((
# 52 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                        unsigned int
# 52 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 52 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                         unsigned int
# 52 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                         )((0x1f))) & 0x1f) << 1)) | ((1) & 1)), { OP_FD, OP_FA, OP_FC, OP_FB}, "Paired Single Negative Multiply-Subtract"},
 { ps_nmsub_dot, "ps_nmsub.", ((((((
# 53 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                             unsigned int
# 53 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                             )((4))) & 0x3f) << 26) | ((((
# 53 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                             unsigned int
# 53 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 53 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_nmadd, "ps_nmadd", ((((((
# 54 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                        unsigned int
# 54 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                        )((4))) & 0x3f) << 26) | ((((
# 54 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                        unsigned int
# 54 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 54 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                         unsigned int
# 54 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                         )((0x1f))) & 0x1f) << 1)) | ((1) & 1)), { OP_FD, OP_FA, OP_FC, OP_FB}, "Paired Single Negative Multiply-Add"},
 { ps_nmadd_dot, "ps_nmadd.", ((((((
# 55 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                             unsigned int
# 55 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                             )((4))) & 0x3f) << 26) | ((((
# 55 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                             unsigned int
# 55 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 55 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_neg, "ps_neg", ((((((
# 57 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                    unsigned int
# 57 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                    )((4))) & 0x3f) << 26) | ((((
# 57 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                    unsigned int
# 57 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 57 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                     unsigned int
# 57 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                     )((0x3ff))) & 0x3ff) << 1)) | ((1) & 1)), { OP_FD, OP_FB}, "Paired Single Negate"},
 { ps_neg_dot, "ps_neg.", ((((((
# 58 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                         unsigned int
# 58 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                         )((4))) & 0x3f) << 26) | ((((
# 58 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                         unsigned int
# 58 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 58 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_mr, "ps_mr", ((((((
# 59 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                  unsigned int
# 59 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                  )((4))) & 0x3f) << 26) | ((((
# 59 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                  unsigned int
# 59 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 59 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                   unsigned int
# 59 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                   )((0x3ff))) & 0x3ff) << 1)) | ((1) & 1)), { OP_FD, OP_FB}, "Paired Single Move Register"},
 { ps_mr_dot, "ps_mr.", ((((((
# 60 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                       unsigned int
# 60 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                       )((4))) & 0x3f) << 26) | ((((
# 60 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                       unsigned int
# 60 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 60 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_nabs, "ps_nabs", ((((((
# 61 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                      unsigned int
# 61 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                      )((4))) & 0x3f) << 26) | ((((
# 61 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                      unsigned int
# 61 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 61 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                        unsigned int
# 61 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                        )((0x3ff))) & 0x3ff) << 1)) | ((1) & 1)), { OP_FD, OP_FB}, "Paired Single Negative Absolute Value"},
 { ps_nabs_dot, "ps_nabs.", ((((((
# 62 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                           unsigned int
# 62 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                           )((4))) & 0x3f) << 26) | ((((
# 62 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                           unsigned int
# 62 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 62 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_abs, "ps_abs", ((((((
# 63 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                    unsigned int
# 63 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                    )((4))) & 0x3f) << 26) | ((((
# 63 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                    unsigned int
# 63 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 63 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                      unsigned int
# 63 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                      )((0x3ff))) & 0x3ff) << 1)) | ((1) & 1)), { OP_FD, OP_FB}, "Paired Single Absolute Value"},
 { ps_abs_dot, "ps_abs.", ((((((
# 64 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                         unsigned int
# 64 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                         )((4))) & 0x3f) << 26) | ((((
# 64 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                         unsigned int
# 64 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 64 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_sum0, "ps_sum0", ((((((
# 66 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                      unsigned int
# 66 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                      )((4))) & 0x3f) << 26) | ((((
# 66 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                      unsigned int
# 66 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 66 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                       unsigned int
# 66 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                       )((0x1f))) & 0x1f) << 1)) | ((1) & 1)), { OP_FD, OP_FA, OP_FC, OP_FB}, "Paired Single vector SUM high"},
 { ps_sum0_dot, "ps_sum0.", ((((((
# 67 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                           unsigned int
# 67 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                           )((4))) & 0x3f) << 26) | ((((
# 67 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                           unsigned int
# 67 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 67 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_sum1, "ps_sum1", ((((((
# 68 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                      unsigned int
# 68 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                      )((4))) & 0x3f) << 26) | ((((
# 68 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                      unsigned int
# 68 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 68 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                       unsigned int
# 68 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                       )((0x1f))) & 0x1f) << 1)) | ((1) & 1)), { OP_FD, OP_FA, OP_FC, OP_FB}, "Paired Single vector SUM low"},
 { ps_sum1_dot, "ps_sum1.", ((((((
# 69 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                           unsigned int
# 69 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                           )((4))) & 0x3f) << 26) | ((((
# 69 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                           unsigned int
# 69 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 69 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_muls0, "ps_muls0", ((((((
# 70 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                        unsigned int
# 70 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                        )((4))) & 0x3f) << 26) | ((((
# 70 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                        unsigned int
# 70 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 70 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                         unsigned int
# 70 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                         )((0x1f))) & 0x1f) << 1)) | ((1) & 1)), { OP_FD, OP_FA, OP_FC}, "Paired Single Multiply Scalar high"},
 { ps_muls0_dot, "ps_muls0.", ((((((
# 71 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                             unsigned int
# 71 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                             )((4))) & 0x3f) << 26) | ((((
# 71 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                             unsigned int
# 71 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 71 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_muls1, "ps_muls1", ((((((
# 72 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                        unsigned int
# 72 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                        )((4))) & 0x3f) << 26) | ((((
# 72 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                        unsigned int
# 72 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 72 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                         unsigned int
# 72 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                         )((0x1f))) & 0x1f) << 1)) | ((1) & 1)), { OP_FD, OP_FA, OP_FC}, "Paired Single Multiply Scalar low"},
 { ps_muls1_dot, "ps_muls1.", ((((((
# 73 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                             unsigned int
# 73 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                             )((4))) & 0x3f) << 26) | ((((
# 73 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                             unsigned int
# 73 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 73 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_madds0, "ps_madds0", ((((((
# 74 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                          unsigned int
# 74 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                          )((4))) & 0x3f) << 26) | ((((
# 74 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                          unsigned int
# 74 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 74 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                           unsigned int
# 74 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                           )((0x1f))) & 0x1f) << 1)) | ((1) & 1)), { OP_FD, OP_FA, OP_FC, OP_FB}, "Paired Single Multiply-Add Scalar high"},
 { ps_madds0_dot, "ps_madds0.", ((((((
# 75 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                               unsigned int
# 75 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                               )((4))) & 0x3f) << 26) | ((((
# 75 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                               unsigned int
# 75 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 75 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_madds1, "ps_madds1", ((((((
# 76 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                          unsigned int
# 76 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                          )((4))) & 0x3f) << 26) | ((((
# 76 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                          unsigned int
# 76 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 76 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                           unsigned int
# 76 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                           )((0x1f))) & 0x1f) << 1)) | ((1) & 1)), { OP_FD, OP_FA, OP_FC, OP_FB}, "Paired Single Multiply-Add Scalar low"},
 { ps_madds1_dot, "ps_madds1.", ((((((
# 77 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                               unsigned int
# 77 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                               )((4))) & 0x3f) << 26) | ((((
# 77 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                               unsigned int
# 77 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 77 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_cmpu0, "ps_cmpu0", (((((
# 79 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                        unsigned int
# 79 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                        )(4)) & 0x3f) << 26) | ((((
# 79 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                        unsigned int
# 79 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 79 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                    unsigned int
# 79 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                    )((0x3ff))) & 0x3ff) << 1)) | ((1) & 1)), { OP_crfD, OP_FA, OP_FB}, "Paired Singles Compare Unordered High"},
 { ps_cmpo0, "ps_cmpo0", (((((
# 80 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                        unsigned int
# 80 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                        )(4)) & 0x3f) << 26) | ((((
# 80 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                        unsigned int
# 80 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 80 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                     unsigned int
# 80 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                     )((0x3ff))) & 0x3ff) << 1)) | ((1) & 1)), { OP_crfD, OP_FA, OP_FB}, "Paired Singles Compare Ordered High"},
 { ps_cmpu1, "ps_cmpu1", (((((
# 81 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                        unsigned int
# 81 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                        )(4)) & 0x3f) << 26) | ((((
# 81 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                        unsigned int
# 81 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 81 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                     unsigned int
# 81 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                     )((0x3ff))) & 0x3ff) << 1)) | ((1) & 1)), { OP_crfD, OP_FA, OP_FB}, "Paired Singles Compare Unordered Low"},
 { ps_cmpo1, "ps_cmpo1", (((((
# 82 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                        unsigned int
# 82 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                        )(4)) & 0x3f) << 26) | ((((
# 82 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                        unsigned int
# 82 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 82 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                     unsigned int
# 82 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                     )((0x3ff))) & 0x3ff) << 1)) | ((1) & 1)), { OP_crfD, OP_FA, OP_FB}, "Paired Singles Compare Ordered Low"},

 { ps_merge00, "ps_merge00", ((((((
# 84 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                            unsigned int
# 84 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                            )((4))) & 0x3f) << 26) | ((((
# 84 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                            unsigned int
# 84 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 84 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                              unsigned int
# 84 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                              )((0x3ff))) & 0x3ff) << 1)) | ((1) & 1)), { OP_FD, OP_FA, OP_FB}, "Paired Single MERGE high"},
 { ps_merge00_dot, "ps_merge00.", ((((((
# 85 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                 unsigned int
# 85 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                 )((4))) & 0x3f) << 26) | ((((
# 85 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                 unsigned int
# 85 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 86 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                            unsigned int
# 86 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                            )((4))) & 0x3f) << 26) | ((((
# 86 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                            unsigned int
# 86 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 86 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                              unsigned int
# 86 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                              )((0x3ff))) & 0x3ff) << 1)) | ((1) & 1)), { OP_FD, OP_FA, OP_FB}, "Paired Single MERGE direct"},
 { ps_merge01_dot, "ps_merge01.", ((((((
# 87 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                 unsigned int
# 87 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                 )((4))) & 0x3f) << 26) | ((((
# 87 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                 unsigned int
# 87 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 88 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                            unsigned int
# 88 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                            )((4))) & 0x3f) << 26) | ((((
# 88 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                            unsigned int
# 88 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 88 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                              unsigned int
# 88 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                              )((0x3ff))) & 0x3ff) << 1)) | ((1) & 1)), { OP_FD, OP_FA, OP_FB}, "Paired Single MERGE swapped"},
 { ps_merge10_dot, "ps_merge10.", ((((((
# 89 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                 unsigned int
# 89 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                 )((4))) & 0x3f) << 26) | ((((
# 89 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                 unsigned int
# 89 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 90 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                            unsigned int
# 90 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                            )((4))) & 0x3f) << 26) | ((((
# 90 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                            unsigned int
# 90 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 90 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                              unsigned int
# 90 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                              )((0x3ff))) & 0x3ff) << 1)) | ((1) & 1)), { OP_FD, OP_FA, OP_FB}, "Paired Single MERGE low"},
 { ps_merge11_dot, "ps_merge11.", ((((((
# 91 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                 unsigned int
# 91 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                 )((4))) & 0x3f) << 26) | ((((
# 91 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                 unsigned int
# 91 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 91 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 { ps_dcbz_l, "dcbz_l", (((((
# 93 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                       unsigned int
# 93 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                       )(4)) & 0x3f) << 26) | ((((
# 93 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                       unsigned int
# 93 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 93 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                      unsigned int
# 93 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                      )((0x3ff))) & 0x3ff) << 1)) | ((1) & 1)), { OP_RA, OP_RB}, "Data Cache Block Set to Zero Locked"},

};


# 97 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
_Bool 
# 97 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
    libps_decode(
# 97 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                 unsigned int 
# 97 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 98 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
unsigned int 
# 98 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
     op = (data & ((((
# 98 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                  unsigned int
# 98 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 if ((op == ((((
# 100 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
           unsigned int
# 100 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
           )(4)) & 0x3f) << 26)) || (op == ((((
# 100 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                             unsigned int
# 100 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
  ...
  (op == ((((
# 101 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
        unsigned int
# 101 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
        )(57)) & 0x3f) << 26)) || (op == ((((
# 101 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                           unsigned int
# 101 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
  ...
  (op == ((((
# 102 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
        unsigned int
# 102 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
        )(61)) & 0x3f) << 26))) {
  
# 103 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
 unsigned int 
# 103 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
      size = sizeof (ps_opcodes_array) / sizeof (ps_opcode_t);
  ps_opcode_t* instruction = ps_opcodes_array;

  
# 106 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
 unsigned int 
# 106 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
      l, j;
  for (l = 0; l < size; l++) {
...
# 154 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
     unsigned short 
# 154 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
          imm = (
# 154 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                 unsigned short
# 154 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 155 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
     unsigned short 
# 155 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
          sign = (
# 155 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                  unsigned short
# 155 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 156 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
     short 
# 156 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
          displacement = 0;
      if (sign == 0) {
       displacement = imm;
      } else {
    ...
    return 
# 174 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
          1
# 174 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
              ;
   }
   instruction++;
  }
 ...
 return 
# 179 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
       0
# 179 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
            ;
}

void libps_snprint(char* str, int size, 
# 182 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
                                       unsigned long long 
# 182 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                            addr, ppcps_t* instr) {
 
# 183 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
unsigned int 
# 183 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
     i;
 int bufsize = size, add = 0;
 add = 
# 185 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
      __builtin___snprintf_chk (
# 185 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
      str
# 185 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
      , 
# 185 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 185 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
 ...
 for (i = 0; add > 0 && i < instr->n && add < bufsize; i++) {
  if (instr->operands[i].type == 1) {
   add += 
# 188 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
         __builtin___snprintf_chk (
# 188 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
         str + add
# 188 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
         , 
# 188 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 188 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
         , 2 > 1 ? 1 : 0), 
# 188 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
         " fr%u", instr->operands[i].value
# 188 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
         )
# 188 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                                                               ;
  } else if (instr->operands[i].type == 2) {
   add += 
# 190 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
         __builtin___snprintf_chk (
# 190 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
         str + add
# 190 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
         , 
# 190 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 190 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
         , 2 > 1 ? 1 : 0), 
# 190 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
         " 0x%x", instr->operands[i].value
# 190 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
         )
# 190 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                                                               ;
  } else if (instr->operands[i].type == 3) {
   add += 
# 192 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
         __builtin___snprintf_chk (
# 192 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
         str + add
# 192 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
         , 
# 192 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
...
# 192 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
         , 2 > 1 ? 1 : 0), 
# 192 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
         " 0x%x(r%d)", instr->operands[i].value, instr->operands[i + 1].value
# 192 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
         )
# 192 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
                                                                                                                  ;
   i++;
  } else if (instr->operands[i].type == 4) {
   add += 
# 195 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
         __builtin___snprintf_chk (
# 195 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
         str + add
# 195 "project/radare2/libr/asm/arch/ppc/libps/libps.c" 3 4
         , 
# 195 "project/radare2/libr/asm/arch/ppc/libps/libps.c"
