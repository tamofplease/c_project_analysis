# 0 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
...
# 2 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 2




static inline void anal_push(RAnalOp *op, pyc_opcode_object *op_obj, 
# 6 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 6 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg, 
# 6 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                                unsigned int 
# 6 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
...
# 6 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
 ...
 op->stackptr = 1 * push_cnt;
}

static inline void anal_pop(RAnalOp *op, pyc_opcode_object *op_obj, 
# 12 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 12 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg, 
# 12 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                               unsigned int 
# 12 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
...
static void anal_BEFORE_ASYNC_WITH(RAnalOp *op, pyc_opcode_object *op_obj, 
# 18 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                          unsigned int 
# 18 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                               oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_BEGIN_FINALLY(RAnalOp *op, pyc_opcode_object *op_obj, 
# 22 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 22 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_BINARY_ADD(RAnalOp *op, pyc_opcode_object *op_obj, 
# 26 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 26 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_ADD, 1);
}

static void anal_BINARY_AND(RAnalOp *op, pyc_opcode_object *op_obj, 
# 30 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 30 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_AND, 1);
}

static void anal_BINARY_CALL(RAnalOp *op, pyc_opcode_object *op_obj, 
# 34 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 34 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
...
static void anal_BINARY_DIVIDE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 40 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 40 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_DIV, 1);
}

static void anal_BINARY_FLOOR_DIVIDE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 44 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                            unsigned int 
# 44 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                                 oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_DIV, 1);
}

static void anal_BINARY_LSHIFT(RAnalOp *op, pyc_opcode_object *op_obj, 
# 48 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 48 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_SHL, 1);
}

static void anal_BINARY_MATRIX_MULTIPLY(RAnalOp *op, pyc_opcode_object *op_obj, 
# 52 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                               unsigned int 
# 52 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                                    oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_BINARY_MODULO(RAnalOp *op, pyc_opcode_object *op_obj, 
# 56 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 56 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_MOD, 1);
}

static void anal_BINARY_MULTIPLY(RAnalOp *op, pyc_opcode_object *op_obj, 
# 60 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                        unsigned int 
# 60 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                             oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_MUL, 1);
}

static void anal_BINARY_OR(RAnalOp *op, pyc_opcode_object *op_obj, 
# 64 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                  unsigned int 
# 64 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                       oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_OR, 1);
}

static void anal_BINARY_POWER(RAnalOp *op, pyc_opcode_object *op_obj, 
# 68 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                     unsigned int 
# 68 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                          oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_BINARY_RSHIFT(RAnalOp *op, pyc_opcode_object *op_obj, 
# 72 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 72 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_SHR, 1);
}

static void anal_BINARY_SUBSCR(RAnalOp *op, pyc_opcode_object *op_obj, 
# 76 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 76 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_BINARY_SUBTRACT(RAnalOp *op, pyc_opcode_object *op_obj, 
# 80 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                        unsigned int 
# 80 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                             oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_SUB, 1);
}

static void anal_BINARY_TRUE_DIVIDE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 84 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                           unsigned int 
# 84 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                                oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_DIV, 1);
}

static void anal_BINARY_XOR(RAnalOp *op, pyc_opcode_object *op_obj, 
# 88 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 88 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_XOR, 1);
}

static void anal_BREAK_LOOP(RAnalOp *op, pyc_opcode_object *op_obj, 
# 92 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 92 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg) {
...
static void anal_BUILD_CLASS(RAnalOp *op, pyc_opcode_object *op_obj, 
# 100 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 100 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_NEW, 2);
}

static void anal_BUILD_CONST_KEY_MAP(RAnalOp *op, pyc_opcode_object *op_obj, 
# 104 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                            unsigned int 
# 104 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                                 oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_NEW, oparg);
}

static void anal_BUILD_FUNCTION(RAnalOp *op, pyc_opcode_object *op_obj, 
# 108 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                       unsigned int 
# 108 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                            oparg) {
 op->type = R_ANAL_OP_TYPE_NEW;
}

static void anal_BUILD_LIST(RAnalOp *op, pyc_opcode_object *op_obj, 
# 112 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 112 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_NEW, oparg);
}

static void anal_BUILD_LIST_UNPACK(RAnalOp *op, pyc_opcode_object *op_obj, 
# 116 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                          unsigned int 
# 116 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                               oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_NEW, oparg - 1);
}

static void anal_BUILD_MAP(RAnalOp *op, pyc_opcode_object *op_obj, 
# 120 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                  unsigned int 
# 120 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                       oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_NEW, 2 * oparg - 1);
}

static void anal_BUILD_MAP_UNPACK(RAnalOp *op, pyc_opcode_object *op_obj, 
# 124 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                         unsigned int 
# 124 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                              oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_NEW, oparg - 1);
}

static void anal_BUILD_MAP_UNPACK_WITH_CALL(RAnalOp *op, pyc_opcode_object *op_obj, 
# 128 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                                   unsigned int 
# 128 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                                        oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_NEW, oparg);
}

static void anal_BUILD_SET(RAnalOp *op, pyc_opcode_object *op_obj, 
# 132 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                  unsigned int 
# 132 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                       oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_NEW, oparg - 1);
}

static void anal_BUILD_SET_UNPACK(RAnalOp *op, pyc_opcode_object *op_obj, 
# 136 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                         unsigned int 
# 136 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                              oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_NEW, oparg - 1);
}

static void anal_BUILD_SLICE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 140 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 140 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_NEW, oparg - 1);
}

static void anal_BUILD_STRING(RAnalOp *op, pyc_opcode_object *op_obj, 
# 144 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                     unsigned int 
# 144 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                          oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_NEW, oparg - 1);
}

static void anal_BUILD_TUPLE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 148 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 148 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_NEW, oparg - 1);
}

static void anal_BUILD_TUPLE_UNPACK(RAnalOp *op, pyc_opcode_object *op_obj, 
# 152 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                           unsigned int 
# 152 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                                oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_NEW, oparg - 1);
}

static void anal_BUILD_TUPLE_UNPACK_WITH_CALL(RAnalOp *op, pyc_opcode_object *op_obj, 
# 156 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                                     unsigned int 
# 156 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                                          oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_NEW, oparg);
}

static void anal_CALL_FUNCTION(RAnalOp *op, pyc_opcode_object *op_obj, 
# 160 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 160 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
...
static void anal_CALL_FUNCTION_EX(RAnalOp *op, pyc_opcode_object *op_obj, 
# 168 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                         unsigned int 
# 168 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                              oparg) {
 op->type = R_ANAL_OP_TYPE_ICALL;
 op->jump = -1;
}

static void anal_CALL_FUNCTION_KW(RAnalOp *op, pyc_opcode_object *op_obj, 
# 173 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                         unsigned int 
# 173 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                              oparg) {
 op->type = R_ANAL_OP_TYPE_ICALL;
 op->jump = -1;
}

static void anal_CALL_FUNCTION_VAR(RAnalOp *op, pyc_opcode_object *op_obj, 
# 178 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                          unsigned int 
# 178 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                               oparg) {
 op->type = R_ANAL_OP_TYPE_ICALL;
 op->jump = -1;
}

static void anal_CALL_FUNCTION_VAR_KW(RAnalOp *op, pyc_opcode_object *op_obj, 
# 183 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                             unsigned int 
# 183 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                                  oparg) {
 op->type = R_ANAL_OP_TYPE_ICALL;
 op->jump = -1;
}

static void anal_CALL_METHOD(RAnalOp *op, pyc_opcode_object *op_obj, 
# 188 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 188 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
 op->type = R_ANAL_OP_TYPE_ICALL;
 op->jump = -1;
}

static void anal_DELETE_ATTR(RAnalOp *op, pyc_opcode_object *op_obj, 
# 193 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 193 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_DELETE_DEREF(RAnalOp *op, pyc_opcode_object *op_obj, 
# 197 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                     unsigned int 
# 197 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                          oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_DELETE_FAST(RAnalOp *op, pyc_opcode_object *op_obj, 
# 201 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 201 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_DELETE_GLOBAL(RAnalOp *op, pyc_opcode_object *op_obj, 
# 205 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 205 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_DELETE_NAME(RAnalOp *op, pyc_opcode_object *op_obj, 
# 209 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 209 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_DELETE_SLICE_0(RAnalOp *op, pyc_opcode_object *op_obj, 
# 213 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                       unsigned int 
# 213 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                            oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_DELETE_SLICE_1(RAnalOp *op, pyc_opcode_object *op_obj, 
# 217 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                       unsigned int 
# 217 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                            oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_DELETE_SLICE_2(RAnalOp *op, pyc_opcode_object *op_obj, 
# 221 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                       unsigned int 
# 221 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                            oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_DELETE_SLICE_3(RAnalOp *op, pyc_opcode_object *op_obj, 
# 225 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                       unsigned int 
# 225 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                            oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_DELETE_SUBSCR(RAnalOp *op, pyc_opcode_object *op_obj, 
# 229 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 229 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_DUP_TOP(RAnalOp *op, pyc_opcode_object *op_obj, 
# 233 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                unsigned int 
# 233 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                     oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UPUSH, 1);
}

static void anal_DUP_TOPX(RAnalOp *op, pyc_opcode_object *op_obj, 
# 237 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                 unsigned int 
# 237 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                      oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UPUSH, 1);
}

static void anal_DUP_TOP_TWO(RAnalOp *op, pyc_opcode_object *op_obj, 
# 241 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 241 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UPUSH, 2);
}

static void anal_END_ASYNC_FOR(RAnalOp *op, pyc_opcode_object *op_obj, 
# 245 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 245 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {

 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_END_FINALLY(RAnalOp *op, pyc_opcode_object *op_obj, 
# 250 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 250 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
...
static void anal_EXEC_STMT(RAnalOp *op, pyc_opcode_object *op_obj, 
# 258 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                  unsigned int 
# 258 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                       oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_EXTENDED_ARG(RAnalOp *op, pyc_opcode_object *op_obj, 
# 262 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                     unsigned int 
# 262 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                          oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_FORMAT_VALUE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 266 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                     unsigned int 
# 266 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                          oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
 if ((oparg & 0x04) == 0x04) {
  op->stackop = R_ANAL_STACK_INC;
...
static void anal_FOR_LOOP(RAnalOp *op, pyc_opcode_object *op_obj, 
# 274 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                 unsigned int 
# 274 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                      oparg) {

 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_GET_AITER(RAnalOp *op, pyc_opcode_object *op_obj, 
# 279 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                  unsigned int 
# 279 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                       oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_GET_ANEXT(RAnalOp *op, pyc_opcode_object *op_obj, 
# 283 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                  unsigned int 
# 283 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                       oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_GET_AWAITABLE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 287 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 287 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_GET_ITER(RAnalOp *op, pyc_opcode_object *op_obj, 
# 291 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                 unsigned int 
# 291 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                      oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_GET_YIELD_FROM_ITER(RAnalOp *op, pyc_opcode_object *op_obj, 
# 295 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                            unsigned int 
# 295 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                                 oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_IMPORT_FROM(RAnalOp *op, pyc_opcode_object *op_obj, 
# 299 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 299 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_IMPORT_NAME(RAnalOp *op, pyc_opcode_object *op_obj, 
# 303 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 303 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_IMPORT_STAR(RAnalOp *op, pyc_opcode_object *op_obj, 
# 307 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 307 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_INPLACE_ADD(RAnalOp *op, pyc_opcode_object *op_obj, 
# 311 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 311 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
 op->type = R_ANAL_OP_TYPE_ADD;
}

static void anal_INPLACE_AND(RAnalOp *op, pyc_opcode_object *op_obj, 
# 315 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 315 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
 op->type = R_ANAL_OP_TYPE_AND;
}

static void anal_INPLACE_DIVIDE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 319 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                       unsigned int 
# 319 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                            oparg) {
 op->type = R_ANAL_OP_TYPE_DIV;
}

static void anal_INPLACE_FLOOR_DIVIDE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 323 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                             unsigned int 
# 323 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                                  oparg) {
 op->type = R_ANAL_OP_TYPE_DIV;
}

static void anal_INPLACE_LSHIFT(RAnalOp *op, pyc_opcode_object *op_obj, 
# 327 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                       unsigned int 
# 327 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                            oparg) {
 op->type = R_ANAL_OP_TYPE_SHL;
}

static void anal_INPLACE_MATRIX_MULTIPLY(RAnalOp *op, pyc_opcode_object *op_obj, 
# 331 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                                unsigned int 
# 331 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                                     oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_INPLACE_MODULO(RAnalOp *op, pyc_opcode_object *op_obj, 
# 335 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                       unsigned int 
# 335 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                            oparg) {
 op->type = R_ANAL_OP_TYPE_MOD;
}

static void anal_INPLACE_MULTIPLY(RAnalOp *op, pyc_opcode_object *op_obj, 
# 339 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                         unsigned int 
# 339 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                              oparg) {
 op->type = R_ANAL_OP_TYPE_MUL;
}

static void anal_INPLACE_OR(RAnalOp *op, pyc_opcode_object *op_obj, 
# 343 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 343 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg) {
 op->type = R_ANAL_OP_TYPE_OR;
}

static void anal_INPLACE_POWER(RAnalOp *op, pyc_opcode_object *op_obj, 
# 347 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 347 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_INPLACE_RSHIFT(RAnalOp *op, pyc_opcode_object *op_obj, 
# 351 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                       unsigned int 
# 351 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                            oparg) {
 op->type = R_ANAL_OP_TYPE_SHR;
}

static void anal_INPLACE_SUBTRACT(RAnalOp *op, pyc_opcode_object *op_obj, 
# 355 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                         unsigned int 
# 355 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                              oparg) {
 op->type = R_ANAL_OP_TYPE_SUB;
}

static void anal_INPLACE_TRUE_DIVIDE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 359 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                            unsigned int 
# 359 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                                 oparg) {
 op->type = R_ANAL_OP_TYPE_DIV;
}

static void anal_INPLACE_XOR(RAnalOp *op, pyc_opcode_object *op_obj, 
# 363 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 363 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
 op->type = R_ANAL_OP_TYPE_XOR;
}

static void anal_LIST_APPEND(RAnalOp *op, pyc_opcode_object *op_obj, 
# 367 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 367 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_LOAD_ASSERTION_ERROR(RAnalOp *op, pyc_opcode_object *op_obj, 
# 371 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                             unsigned int 
# 371 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                                  oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_LOAD_ATTR(RAnalOp *op, pyc_opcode_object *op_obj, 
# 375 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                  unsigned int 
# 375 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                       oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_LOAD_BUILD_CLASS(RAnalOp *op, pyc_opcode_object *op_obj, 
# 379 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                         unsigned int 
# 379 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                              oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_LOAD_CLASSDEREF(RAnalOp *op, pyc_opcode_object *op_obj, 
# 383 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                        unsigned int 
# 383 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                             oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_LOAD_CLOSURE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 387 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                     unsigned int 
# 387 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                          oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_LOAD_CONST(RAnalOp *op, pyc_opcode_object *op_obj, 
# 391 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 391 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_LOAD_DEREF(RAnalOp *op, pyc_opcode_object *op_obj, 
# 395 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 395 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_LOAD_FAST(RAnalOp *op, pyc_opcode_object *op_obj, 
# 399 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                  unsigned int 
# 399 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                       oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_LOAD_GLOBAL(RAnalOp *op, pyc_opcode_object *op_obj, 
# 403 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 403 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_LOAD_GLOBALS(RAnalOp *op, pyc_opcode_object *op_obj, 
# 407 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                     unsigned int 
# 407 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                          oparg) {
...
static void anal_LOAD_LOCAL(RAnalOp *op, pyc_opcode_object *op_obj, 
# 413 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 413 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_LOAD_LOCALS(RAnalOp *op, pyc_opcode_object *op_obj, 
# 417 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 417 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_LOAD_METHOD(RAnalOp *op, pyc_opcode_object *op_obj, 
# 421 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 421 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_LOAD_NAME(RAnalOp *op, pyc_opcode_object *op_obj, 
# 425 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                  unsigned int 
# 425 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                       oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_MAKE_CLOSURE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 429 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                     unsigned int 
# 429 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                          oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, oparg);
}

static void anal_MAKE_FUNCTION(RAnalOp *op, pyc_opcode_object *op_obj, 
# 433 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 433 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, oparg);
}

static void anal_MAP_ADD(RAnalOp *op, pyc_opcode_object *op_obj, 
# 437 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                unsigned int 
# 437 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                     oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_NOP(RAnalOp *op, pyc_opcode_object *op_obj, 
# 441 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                            unsigned int 
# 441 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                 oparg) {
 op->type = R_ANAL_OP_TYPE_NOP;
}

static void anal_POP_BLOCK(RAnalOp *op, pyc_opcode_object *op_obj, 
# 445 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                  unsigned int 
# 445 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                       oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_POP, 1);
}

static void anal_POP_EXCEPT(RAnalOp *op, pyc_opcode_object *op_obj, 
# 449 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 449 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_POP, 1);
}

static void anal_POP_FINALLY(RAnalOp *op, pyc_opcode_object *op_obj, 
# 453 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 453 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
...
static void anal_POP_TOP(RAnalOp *op, pyc_opcode_object *op_obj, 
# 459 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                unsigned int 
# 459 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                     oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_POP, 1);
}

static void anal_PRINT_EXPR(RAnalOp *op, pyc_opcode_object *op_obj, 
# 463 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 463 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_PRINT_ITEM(RAnalOp *op, pyc_opcode_object *op_obj, 
# 467 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 467 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_PRINT_ITEM_TO(RAnalOp *op, pyc_opcode_object *op_obj, 
# 471 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 471 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 2);
}

static void anal_PRINT_NEWLINE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 475 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 475 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_PRINT_NEWLINE_TO(RAnalOp *op, pyc_opcode_object *op_obj, 
# 479 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                         unsigned int 
# 479 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                              oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_RAISE_EXCEPTION(RAnalOp *op, pyc_opcode_object *op_obj, 
# 483 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                        unsigned int 
# 483 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                             oparg) {
...
static void anal_RAISE_VARARGS(RAnalOp *op, pyc_opcode_object *op_obj, 
# 489 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 489 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, oparg);
}

static void anal_RERAISE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 493 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                unsigned int 
# 493 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                     oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 3);
}

static void anal_RESERVE_FAST(RAnalOp *op, pyc_opcode_object *op_obj, 
# 497 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                     unsigned int 
# 497 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                          oparg) {
...
static void anal_RETURN_VALUE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 503 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                     unsigned int 
# 503 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                          oparg) {
 op->type = R_ANAL_OP_TYPE_RET;
 op->stackop = R_ANAL_STACK_INC;
 op->stackptr = -1;
 op->eob = 
# 507 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
          1
# 507 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
              ;
}

static void anal_ROT_FOUR(RAnalOp *op, pyc_opcode_object *op_obj, 
# 510 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                 unsigned int 
# 510 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                      oparg) {

 op->type = R_ANAL_OP_TYPE_XCHG;
}

static void anal_ROT_THREE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 515 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                  unsigned int 
# 515 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                       oparg) {

 op->type = R_ANAL_OP_TYPE_XCHG;
}

static void anal_ROT_TWO(RAnalOp *op, pyc_opcode_object *op_obj, 
# 520 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                unsigned int 
# 520 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                     oparg) {

 op->type = R_ANAL_OP_TYPE_XCHG;
}

static void anal_SETUP_ANNOTATIONS(RAnalOp *op, pyc_opcode_object *op_obj, 
# 525 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                          unsigned int 
# 525 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                               oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_SET_ADD(RAnalOp *op, pyc_opcode_object *op_obj, 
# 529 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                unsigned int 
# 529 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                     oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_SET_FUNC_ARGS(RAnalOp *op, pyc_opcode_object *op_obj, 
# 533 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 533 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
...
static void anal_SET_LINENO(RAnalOp *op, pyc_opcode_object *op_obj, 
# 539 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 539 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_SLICE_0(RAnalOp *op, pyc_opcode_object *op_obj, 
# 543 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                unsigned int 
# 543 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                     oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_SLICE_1(RAnalOp *op, pyc_opcode_object *op_obj, 
# 547 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                unsigned int 
# 547 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                     oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_SLICE_2(RAnalOp *op, pyc_opcode_object *op_obj, 
# 551 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                unsigned int 
# 551 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                     oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_SLICE_3(RAnalOp *op, pyc_opcode_object *op_obj, 
# 555 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                unsigned int 
# 555 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                     oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 2);
}

static void anal_STOP_CODE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 559 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                  unsigned int 
# 559 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                       oparg) {
 op->type = R_ANAL_OP_TYPE_TRAP;
}

static void anal_STORE_ANNOTATION(RAnalOp *op, pyc_opcode_object *op_obj, 
# 563 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                         unsigned int 
# 563 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                              oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_STORE_ATTR(RAnalOp *op, pyc_opcode_object *op_obj, 
# 567 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 567 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_STORE_DEREF(RAnalOp *op, pyc_opcode_object *op_obj, 
# 571 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 571 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_STORE_FAST(RAnalOp *op, pyc_opcode_object *op_obj, 
# 575 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 575 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_STORE_GLOBAL(RAnalOp *op, pyc_opcode_object *op_obj, 
# 579 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                     unsigned int 
# 579 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                          oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_STORE_LOCALS(RAnalOp *op, pyc_opcode_object *op_obj, 
# 583 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                     unsigned int 
# 583 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                          oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_STORE_MAP(RAnalOp *op, pyc_opcode_object *op_obj, 
# 587 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                  unsigned int 
# 587 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                       oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 2);
}

static void anal_STORE_NAME(RAnalOp *op, pyc_opcode_object *op_obj, 
# 591 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 591 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_STORE_SLICE_0(RAnalOp *op, pyc_opcode_object *op_obj, 
# 595 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 595 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 2);
}

static void anal_STORE_SLICE_1(RAnalOp *op, pyc_opcode_object *op_obj, 
# 599 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 599 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 3);
}

static void anal_STORE_SLICE_2(RAnalOp *op, pyc_opcode_object *op_obj, 
# 603 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 603 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 3);
}

static void anal_STORE_SLICE_3(RAnalOp *op, pyc_opcode_object *op_obj, 
# 607 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 607 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 4);
}

static void anal_STORE_SUBSCR(RAnalOp *op, pyc_opcode_object *op_obj, 
# 611 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                     unsigned int 
# 611 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                          oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 3);
}

static void anal_UNARY_CALL(RAnalOp *op, pyc_opcode_object *op_obj, 
# 615 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 615 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg) {
...
static void anal_UNARY_CONVERT(RAnalOp *op, pyc_opcode_object *op_obj, 
# 621 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 621 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_UNARY_INVERT(RAnalOp *op, pyc_opcode_object *op_obj, 
# 625 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                     unsigned int 
# 625 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                          oparg) {
 op->type = R_ANAL_OP_TYPE_NOT;
}

static void anal_UNARY_NEGATIVE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 629 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                       unsigned int 
# 629 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                            oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_UNARY_NOT(RAnalOp *op, pyc_opcode_object *op_obj, 
# 633 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                  unsigned int 
# 633 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                       oparg) {
 op->type = R_ANAL_OP_TYPE_NOT;
}

static void anal_UNARY_POSITIVE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 637 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                       unsigned int 
# 637 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                            oparg) {
 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_UNPACK_ARG(RAnalOp *op, pyc_opcode_object *op_obj, 
# 641 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 641 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, oparg - 1);
}

static void anal_UNPACK_EX(RAnalOp *op, pyc_opcode_object *op_obj, 
# 645 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                  unsigned int 
# 645 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                       oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, (oparg & 0xFF) + (oparg >> 8));
}

static void anal_UNPACK_LIST(RAnalOp *op, pyc_opcode_object *op_obj, 
# 649 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 649 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, oparg - 1);
}

static void anal_UNPACK_SEQUENCE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 653 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                        unsigned int 
# 653 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                             oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, oparg - 1);
}

static void anal_UNPACK_TUPLE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 657 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                     unsigned int 
# 657 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                          oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, oparg - 1);
}

static void anal_UNPACK_VARARG(RAnalOp *op, pyc_opcode_object *op_obj, 
# 661 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 661 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
...
static void anal_WITH_CLEANUP(RAnalOp *op, pyc_opcode_object *op_obj, 
# 667 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                     unsigned int 
# 667 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                          oparg) {

 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_WITH_CLEANUP_FINISH(RAnalOp *op, pyc_opcode_object *op_obj, 
# 672 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                            unsigned int 
# 672 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                                 oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 2);
}

static void anal_WITH_CLEANUP_START(RAnalOp *op, pyc_opcode_object *op_obj, 
# 676 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                           unsigned int 
# 676 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                                oparg) {

 op->type = R_ANAL_OP_TYPE_UNK;
}

static void anal_WITH_EXCEPT_START(RAnalOp *op, pyc_opcode_object *op_obj, 
# 681 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                          unsigned int 
# 681 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                               oparg) {
 anal_push (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_YIELD_FROM(RAnalOp *op, pyc_opcode_object *op_obj, 
# 685 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 685 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_YIELD_VALUE(RAnalOp *op, pyc_opcode_object *op_obj, 
# 689 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                    unsigned int 
# 689 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                         oparg) {
 anal_pop (op, op_obj, oparg, R_ANAL_OP_TYPE_UNK, 1);
}

static void anal_FOR_ITER(RAnalOp *op, pyc_opcode_object *op_obj, 
# 693 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                 unsigned int 
# 693 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                      oparg) {
 op->type = R_ANAL_OP_TYPE_CJMP;
 
# 695 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
unsigned long long 
# 695 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
     mid = op->jump;
 op->jump = op->fail;
 op->fail = mid;
}

static void anal_SETUP_LOOP(RAnalOp *op, pyc_opcode_object *op_obj, 
# 700 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 700 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg) {
 
# 701 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
unsigned long long 
# 701 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
     mid = op->jump;
 op->jump = op->fail;
 op->fail = mid;
}

static void anal_SETUP_EXCEPT(RAnalOp *op, pyc_opcode_object *op_obj, 
# 706 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                     unsigned int 
# 706 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                          oparg) {
 
# 707 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
unsigned long long 
# 707 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
     mid = op->jump;
 op->jump = op->fail;
 op->fail = mid;
}

static void anal_SETUP_FINALLY(RAnalOp *op, pyc_opcode_object *op_obj, 
# 712 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                      unsigned int 
# 712 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                           oparg) {
 
# 713 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
unsigned long long 
# 713 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
     mid = op->jump;
 op->jump = op->fail;
 op->fail = mid;
}

static void anal_SETUP_WITH(RAnalOp *op, pyc_opcode_object *op_obj, 
# 718 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                   unsigned int 
# 718 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                        oparg) {
 op->type = R_ANAL_OP_TYPE_CJMP;
 
# 720 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
unsigned long long 
# 720 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
     mid = op->jump;
 op->jump = op->fail;
 op->fail = mid;
}

static void anal_SETUP_ASYNC_WITH(RAnalOp *op, pyc_opcode_object *op_obj, 
# 725 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                                         unsigned int 
# 725 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                                              oparg) {
 op->type = R_ANAL_OP_TYPE_CJMP;
 
# 727 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
unsigned long long 
# 727 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
     mid = op->jump;
 op->jump = op->fail;
 op->fail = mid;
}
...
void anal_pyc_op(RAnalOp *op, pyc_opcode_object *op_obj, 
# 899 "project/radare2/libr/asm/arch/pyc/opcode_anal.c" 3 4
                                                        unsigned int 
# 899 "project/radare2/libr/asm/arch/pyc/opcode_anal.c"
                                                             oparg) {
 size_t i;
