# 0 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"


# 1 "project/radare2/libr/asm/arch/pyc/pyc_dis.h" 1
...
typedef int RRef;
# 7 "project/radare2/libr/asm/arch/pyc/pyc_dis.h" 2
...
# 8 "project/radare2/libr/asm/arch/pyc/pyc_dis.h" 2
...
# 9 "project/radare2/libr/asm/arch/pyc/pyc_dis.h" 2
...
# 10 "project/radare2/libr/asm/arch/pyc/pyc_dis.h" 2
...
# 12 "project/radare2/libr/asm/arch/pyc/pyc_dis.h" 2
...
# 57 "project/radare2/libr/asm/arch/pyc/pyc_dis.h" 3 4
unsigned int 
# 57 "project/radare2/libr/asm/arch/pyc/pyc_dis.h"
     argcount;
 
# 58 "project/radare2/libr/asm/arch/pyc/pyc_dis.h" 3 4
unsigned int 
# 58 "project/radare2/libr/asm/arch/pyc/pyc_dis.h"
     posonlyargcount;
 
# 59 "project/radare2/libr/asm/arch/pyc/pyc_dis.h" 3 4
unsigned int 
# 59 "project/radare2/libr/asm/arch/pyc/pyc_dis.h"
     kwonlyargcount;
 
# 60 "project/radare2/libr/asm/arch/pyc/pyc_dis.h" 3 4
unsigned int 
# 60 "project/radare2/libr/asm/arch/pyc/pyc_dis.h"
     nlocals;
 
# 61 "project/radare2/libr/asm/arch/pyc/pyc_dis.h" 3 4
unsigned int 
# 61 "project/radare2/libr/asm/arch/pyc/pyc_dis.h"
     stacksize;
 
# 62 "project/radare2/libr/asm/arch/pyc/pyc_dis.h" 3 4
unsigned int 
# 62 "project/radare2/libr/asm/arch/pyc/pyc_dis.h"
     flags;
 pyc_object *code;
 pyc_object *consts;
 pyc_object *names;
...
# 71 "project/radare2/libr/asm/arch/pyc/pyc_dis.h" 3 4
unsigned int 
# 71 "project/radare2/libr/asm/arch/pyc/pyc_dis.h"
     firstlineno;
 pyc_object *lnotab;
 
# 73 "project/radare2/libr/asm/arch/pyc/pyc_dis.h" 3 4
long long 
# 73 "project/radare2/libr/asm/arch/pyc/pyc_dis.h"
     start_offset;
 
# 74 "project/radare2/libr/asm/arch/pyc/pyc_dis.h" 3 4
long long 
# 74 "project/radare2/libr/asm/arch/pyc/pyc_dis.h"
     end_offset;
} pyc_code_object;

int r_pyc_disasm(RAsmOp *op, const 
# 77 "project/radare2/libr/asm/arch/pyc/pyc_dis.h" 3 4
                                  unsigned char 
# 77 "project/radare2/libr/asm/arch/pyc/pyc_dis.h"
                                      *buf, RList *cobjs, RList *interned_table, 
# 77 "project/radare2/libr/asm/arch/pyc/pyc_dis.h" 3 4
                                                                                 unsigned long long 
# 77 "project/radare2/libr/asm/arch/pyc/pyc_dis.h"
                                                                                      pc, pyc_opcodes *opcodes);
# 4 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 2

static const char *cmp_op[] = { "<", "<=", "==", "!=", ">", ">=", "in", "not in", "is", "is not", "exception match", "BAD" };

static char *parse_arg(pyc_opcode_object *op, 
# 7 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
                                             unsigned int 
# 7 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
                                                  oparg, RList *names, RList *consts, RList *varnames, RList *interned_table, RList *freevars, RList *cellvars, RList *opcode_arg_fmt);

int r_pyc_disasm(RAsmOp *opstruct, const 
# 9 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
                                        unsigned char 
# 9 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
                                            *code, RList *cobjs, RList *interned_table, 
# 9 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
                                                                                        unsigned long long 
# 9 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
                                                                                             pc, pyc_opcodes *ops) {
 pyc_code_object *cobj = 
# 10 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
                        ((void *)0)
# 10 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
                            , *t = 
# 10 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
                                   ((void *)0)
# 10 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
...
# 11 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
unsigned int 
# 11 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
     extended_arg = 0, i = 0, oparg;
 
# 12 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
long long 
# 12 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
     start_offset, end_offset;
 RListIter *iter = 
# 13 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
                  ((void *)0)
# 13 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
                      ;

 if (cobjs) {
  
# 16 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
 if (
# 16 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
 cobjs
# 16 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
 ) for (
# 16 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
...
# 16 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
 ...
 RList *varnames = cobj? cobj->varnames->data: 
# 28 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
                                              ((void *)0)
# 28 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
                                                  ;
 RList *consts = cobj?cobj->consts->data: 
# 29 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
                                         ((void *)0)
# 29 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
                                             ;
 RList *names = cobj?cobj->names->data: 
# 30 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
                                       ((void *)0)
# 30 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
                                           ;
 RList *freevars = cobj?cobj->freevars->data: 
# 31 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
                                             ((void *)0)
# 31 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
                                                 ;
 RList *cellvars = cobj? cobj->cellvars->data: 
# 32 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
                                              ((void *)0)
# 32 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
                                                  ;

 
# 34 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
unsigned char 
# 34 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
    op = code[i];
 i++;
...
static char *parse_arg(pyc_opcode_object *op, 
# 75 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
                                             unsigned int 
# 75 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
                                                  oparg, RList *names, RList *consts, RList *varnames, RList *interned_table, RList *freevars, RList *cellvars, RList *opcode_arg_fmt) {
 pyc_object *t = 
# 76 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
                ((void *)0)
# 76 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
                    ;
 char *arg = 
# 77 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
            ((void *)0)
# 77 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
                ;
 pyc_code_object *tmp_cobj;
 pyc_arg_fmt *fmt;
 RListIter *i = 
# 80 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
               ((void *)0)
# 80 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
                   ;


 
# 83 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
if (
# 83 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
opcode_arg_fmt
# 83 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
) for (
# 83 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
...
# 84 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
 ...
 if (op->type & HASCONST) {
  if (!consts) {
   return 
# 90 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
         ((void *)0)
# 90 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
             ;
  }
  t = (pyc_object *)r_list_get_n (consts, oparg);
  if (!t) {
   return 
# 94 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
         ((void *)0)
# 94 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
             ;
  }
  switch (t->type) {
  case TYPE_CODE_v0:
 ...
 if (op->type & HASNAME) {
  ...
  return 
# 125 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
        ((void *)0)
# 125 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
            ;
 }
 ...
 if (op->type & HASLOCAL) {
  ...
  return 
# 137 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
        ((void *)0)
# 137 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
            ;
 }
 ...
 if (op->type & HASFREE) {
  ...
  if (!t) {
   return 
# 156 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
         ((void *)0)
# 156 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
             ;
  }
...
static char *generic_array_obj_to_string(RList *l) {
 RListIter *iter = 
# 172 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
                  ((void *)0)
# 172 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
                      ;
 pyc_object *e = 
# 173 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
                ((void *)0)
# 173 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
                    ;

 RStrBuf *rbuf = r_strbuf_new (
# 175 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
                              ((void *)0)
# 175 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
                                  );

 
# 177 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
if (
# 177 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
l
# 177 "project/radare2/libr/asm/arch/pyc/pyc_dis.c" 3 4
) for (
# 177 "project/radare2/libr/asm/arch/pyc/pyc_dis.c"
