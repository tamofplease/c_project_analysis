# 0 "project/radare2/libr/asm/arch/sh/gnu/sh-dis.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 19 "project/radare2/libr/asm/arch/sh/gnu/sh-dis.c" 2
...
# 20 "project/radare2/libr/asm/arch/sh/gnu/sh-dis.c" 2
...
# 21 "project/radare2/libr/asm/arch/sh/gnu/sh-dis.c" 2



# 1 "project/radare2/libr/asm/arch/sh/gnu/sh-opc.h" 1
...
# 25 "project/radare2/libr/asm/arch/sh/gnu/sh-dis.c" 2
...
# 26 "project/radare2/libr/asm/arch/sh/gnu/sh-dis.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/include/mybfd.h" 1 3 4
# 27 "project/radare2/libr/asm/arch/sh/gnu/sh-dis.c" 2





# 31 "project/radare2/libr/asm/arch/sh/gnu/sh-dis.c"
static int
print_insn_shx (bfd_vma memaddr, struct disassemble_info *info)
{
      ...
      for (n = 0; n < 4; n++)
 {
   ...
   switch (i)
     ...
     default:
       fprintf(
# 150 "project/radare2/libr/asm/arch/sh/gnu/sh-dis.c" 3 4
              __stderrp
# 150 "project/radare2/libr/asm/arch/sh/gnu/sh-dis.c"
                    , "sh-dis: abort");
       return 0;
     }
 }
      ...
      for (n = 0; n < 3 && op->arg[n] != A_END; n++)
 {
       ...
       default:
        fprintf (
# 302 "project/radare2/libr/asm/arch/sh/gnu/sh-dis.c" 3 4
                __stderrp
# 302 "project/radare2/libr/asm/arch/sh/gnu/sh-dis.c"
                      , "sh-dis: abort");
        return 0;
     }
 }
# 330 "project/radare2/libr/asm/arch/sh/gnu/sh-dis.c"
      if (disp_pc && strcmp (op->name, "mova") != 0)
 {
   ...
   if (size == 2) {
    val=(info->flags & 2)? bfd_getl16 (bytes):bfd_getb16 (bytes);

    val= (val&0x8000)? (val | 0xFFFF0000):(val & 0x0000FFFF);
   } else {
    val=(info->flags & 2)? bfd_getl32 (bytes):bfd_getb32 (bytes);
   }
