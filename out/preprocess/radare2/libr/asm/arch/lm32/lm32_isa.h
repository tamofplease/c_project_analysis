# 0 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
# 0 "<built-in>"
# 0 "<command-line>"
...
typedef int RRef;
# 8 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 2





# 12 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
typedef struct r_asm_lm32_csr_t {
 
# 13 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
unsigned char 
# 13 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
    number;
 char name[8];
} RAsmLm32Csr;
...
# 44 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
unsigned char 
# 44 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
    number;
 char name[8];
} RAsmLm32Reg;
...
# 250 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
unsigned int 
# 250 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
     addr;

 
# 252 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
unsigned int 
# 252 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
     value;


 
# 255 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
unsigned char 
# 255 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
    op;

 RAsmLm32Opcode op_decode;

 
# 259 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
unsigned char 
# 259 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
    dest_reg;
 char dest_reg_str[8];

 
# 262 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
unsigned char 
# 262 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
    src0_reg;
 char src0_reg_str[8];

 
# 265 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
unsigned char 
# 265 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
    src1_reg;
 char src1_reg_str[8];

 
# 268 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
unsigned char 
# 268 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
    csr;
 char csr_reg_str[8];

 
# 271 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
int 
# 271 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
     immediate;

 
# 273 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
_Bool 
# 273 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
     pseudoInstruction;
} RAsmLm32Instruction;
# 283 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
static const int RAsmLm32OpShift = 26;
static const 
# 284 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
            unsigned int 
# 284 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
                 RAsmLm32OpMask = 0xfc000000;
static const int RAsmLm32RegUShift = 21;
static const 
# 286 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
            unsigned int 
# 286 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
                 RAsmLm32RegUMask = 0x03e00000;
static const int RAsmLm32RegVShift = 16;
static const 
# 288 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
            unsigned int 
# 288 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
                 RAsmLm32RegVMask = 0x001f0000;
static const int RAsmLm32RegWShift = 11;
static const 
# 290 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
            unsigned int 
# 290 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
                 RAsmLm32RegWMask = 0x0000f800;
static const 
# 291 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
            unsigned int 
# 291 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
                 RAsmLm32Imm5Mask = 0x0000001f;
static const 
# 292 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
            unsigned int 
# 292 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
                 RAsmLm32Imm16Mask = 0x0000ffff;
static const 
# 293 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
            unsigned int 
# 293 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
                 RAsmLm32Imm16SignBitPos = 15;
static const 
# 294 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
            unsigned int 
# 294 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
                 RAsmLm32Imm26Mask = 0x03ffffff;
static const 
# 295 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
            unsigned int 
# 295 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
                 RAsmLm32Imm26SignBitPos = 25;

static const 
# 297 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
            unsigned int 
# 297 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
                 RAsmLm32InstrImm5InvalidBitsMask = 0x0000ffe0;
static const 
# 298 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
            unsigned int 
# 298 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
                 RAsmLm32InstrOneRegInvalidBitsMask = 0x001fffff;
static const 
# 299 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
            unsigned int 
# 299 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
                 RAsmLm32InstrTwoRegsInvalidBitsMask = 0x001f07ff;
static const 
# 300 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
            unsigned int 
# 300 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
...
static 
# 305 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
      unsigned char 
# 305 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
          extract_opcode(
# 305 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
                         unsigned int 
# 305 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
...
static 
# 309 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
      unsigned char 
# 309 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
          extract_reg_u(
# 309 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
                        unsigned int 
# 309 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
...
static 
# 313 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
      unsigned char 
# 313 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
          extract_reg_v(
# 313 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
                        unsigned int 
# 313 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
...
static 
# 317 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
      unsigned char 
# 317 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
          extract_reg_w(
# 317 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
                        unsigned int 
# 317 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
...
static 
# 321 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
      unsigned char 
# 321 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
          extract_imm5(
# 321 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
                       unsigned int 
# 321 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
...
static 
# 325 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
      unsigned short 
# 325 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
           extract_imm16(
# 325 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
                         unsigned int 
# 325 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
...
static 
# 329 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
      unsigned int 
# 329 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
           extract_imm26(
# 329 "project/radare2/libr/asm/arch/lm32/lm32_isa.h" 3 4
                         unsigned int 
# 329 "project/radare2/libr/asm/arch/lm32/lm32_isa.h"
