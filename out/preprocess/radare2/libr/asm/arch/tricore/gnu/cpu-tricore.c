# 0 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 22 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 2
...
# 23 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 2
...
# 24 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 2
# 1 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include/stdbool.h" 1 3 4
# 25 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 2
...
# 28 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 2
...
# 29 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 2
...
# 31 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 2




# 34 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c"
...
{
 return 
# 80 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 3 4
       1
# 80 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c"
           ;
}
     ...
     const bfd_arch_info_type *b;
{
 if (a->arch != b->arch) {
  return 
# 89 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 3 4
        ((void *)0)
# 89 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c"
            ;
 }

 if (a->bits_per_word != b->bits_per_word) {
  return 
# 93 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 3 4
        ((void *)0)
# 93 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c"
            ;
 }
...
# 119 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 3 4
   0x0001
# 119 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c"
                   ,
    "tricore",
    "TriCore:Rider-A",
    3,
    
# 123 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 3 4
   0
# 123 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c"
        ,
...
# 135 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 3 4
   0x0002
# 135 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c"
                   ,
    "tricore",
    "TriCore:Rider-D",
    3,
    
# 139 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 3 4
   0
# 139 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c"
        ,
    bfd_default_compatible,
    bfd_default_scan,
    &arch_info_struct[2]
...
# 151 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 3 4
   0x0004
# 151 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c"
                   ,
    "tricore",
    "TriCore:V2",
    3,
    
# 155 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 3 4
   0
# 155 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c"
        ,
    bfd_default_compatible,
    bfd_default_scan,
...
# 169 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 3 4
 0x0002
# 169 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c"
                 ,
  "tricore",
  "TriCore:Rider-B",
  3,
  
# 173 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 3 4
 1
# 173 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c"
     ,
  bfd_default_compatible,
  bfd_default_scan,
  &arch_info_struct[0]
...
{
  switch (mach & 
# 190 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 3 4
                0x000f
# 190 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c"
                                   )
    {
    case 
# 192 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 3 4
        0x0001
# 192 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c"
                        :
    ...
    case 
# 232 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 3 4
        0x0002
# 232 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c"
                        :
    case 
# 233 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 3 4
        0x0004
# 233 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c"
                        :
      tricore_mask_abs = 0x0c0000ff;
      tricore_mask_absb = 0x0c0000ff;
      tricore_mask_b = 0x000000ff;
      ...
      tricore_mask_rrrw = 0x00e000ff;
      if ((mach & 
# 258 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 3 4
                 0x000f
# 258 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c"
                                    ) == 
# 258 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c" 3 4
                                         0x0004
# 258 "project/radare2/libr/asm/arch/tricore/gnu/cpu-tricore.c"
