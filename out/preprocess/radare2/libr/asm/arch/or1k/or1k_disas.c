# 0 "project/radare2/libr/asm/arch/or1k/or1k_disas.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/arch/or1k/or1k_disas.c"
...
# 4 "project/radare2/libr/asm/arch/or1k/or1k_disas.c" 2
# 1 "project/radare2/libr/asm/arch/or1k/or1k_disas.h" 1
...
# 4 "project/radare2/libr/asm/arch/or1k/or1k_disas.h" 2
# 51 "project/radare2/libr/asm/arch/or1k/or1k_disas.h"
...
# 94 "project/radare2/libr/asm/arch/or1k/or1k_disas.h" 3 4
unsigned int 
# 94 "project/radare2/libr/asm/arch/or1k/or1k_disas.h"
     mask;
 
# 95 "project/radare2/libr/asm/arch/or1k/or1k_disas.h" 3 4
unsigned int 
# 95 "project/radare2/libr/asm/arch/or1k/or1k_disas.h"
     shift;
} insn_oper_descr_t;
...
# 105 "project/radare2/libr/asm/arch/or1k/or1k_disas.h" 3 4
unsigned int 
# 105 "project/radare2/libr/asm/arch/or1k/or1k_disas.h"
     opcode;
 char *name;
 int type;
 int opcode_mask;
...
# 113 "project/radare2/libr/asm/arch/or1k/or1k_disas.h" 3 4
unsigned int 
# 113 "project/radare2/libr/asm/arch/or1k/or1k_disas.h"
     opcode;
 char *name;
 int type;
 int insn_type;
...
# 136 "project/radare2/libr/asm/arch/or1k/or1k_disas.h" 3 4
                                                              unsigned int 
# 136 "project/radare2/libr/asm/arch/or1k/or1k_disas.h"
                                                                   insn);
# 149 "project/radare2/libr/asm/arch/or1k/or1k_disas.h"

# 149 "project/radare2/libr/asm/arch/or1k/or1k_disas.h" 3 4
unsigned int 
# 149 "project/radare2/libr/asm/arch/or1k/or1k_disas.h"
    sign_extend(
# 149 "project/radare2/libr/asm/arch/or1k/or1k_disas.h" 3 4
...
static inline 
# 151 "project/radare2/libr/asm/arch/or1k/or1k_disas.h" 3 4
             unsigned int 
# 151 "project/radare2/libr/asm/arch/or1k/or1k_disas.h"
                  get_operand_mask(insn_type_descr_t *type_descr, insn_oper_t operand) {
 return type_descr->operands[operand].mask;
}

static inline 
# 155 "project/radare2/libr/asm/arch/or1k/or1k_disas.h" 3 4
             unsigned int 
# 155 "project/radare2/libr/asm/arch/or1k/or1k_disas.h"
                  get_operand_shift(insn_type_descr_t *type_descr, insn_oper_t operand) {
 return type_descr->operands[operand].shift;
}

static inline 
# 159 "project/radare2/libr/asm/arch/or1k/or1k_disas.h" 3 4
             unsigned int 
# 159 "project/radare2/libr/asm/arch/or1k/or1k_disas.h"
                  get_operand_value(
# 159 "project/radare2/libr/asm/arch/or1k/or1k_disas.h" 3 4
                                    unsigned int 
# 159 "project/radare2/libr/asm/arch/or1k/or1k_disas.h"
                                         insn, insn_type_descr_t *type_descr, insn_oper_t operand) {
...
# 172 "project/radare2/libr/asm/arch/or1k/or1k_disas.h" 3 4
do { if (!(
# 172 "project/radare2/libr/asm/arch/or1k/or1k_disas.h"
descr
# 172 "project/radare2/libr/asm/arch/or1k/or1k_disas.h" 3 4
...
# 172 "project/radare2/libr/asm/arch/or1k/or1k_disas.h"
 ...
 if (extra_descr == 
# 174 "project/radare2/libr/asm/arch/or1k/or1k_disas.h" 3 4
                   ((void *)0)
# 174 "project/radare2/libr/asm/arch/or1k/or1k_disas.h"
                       ) {
  return descr->type;
 } else {
...
# 5 "project/radare2/libr/asm/arch/or1k/or1k_disas.c" 2
...
insn_type_descr_t types[] = {
 ...
 [INSN_KABK] = {INSN_KABK, "%s r%d, r%d, 0x%x",
  {
   [INSN_OPER_K1] = {INSN_OPER_K1, (0x1f * 0x200000), 21},
   [INSN_OPER_A] = {INSN_OPER_A, (0x1f * 0x10000), 16},
   [INSN_OPER_B] = {INSN_OPER_B, (0x1f * 0x800), 11},
   [INSN_OPER_K2] = {INSN_OPER_K2, 0x7ff, 0}
  }
 },
 ...
 [INSN_N] = {INSN_N, "%s 0x%x",
  {
   [INSN_OPER_N] = {INSN_OPER_N, 0x3ffffff, 0}
  }
 },

 [INSN_K] = {INSN_K, "%s 0x%x",
  {
   [INSN_OPER_K] = {INSN_OPER_K, 0xffff, 0}
  }
 },
 ...
 [INSN_DK] = {INSN_DK, "%s r%d, 0x%x",
  {
   [INSN_OPER_K] = {INSN_OPER_K, 0xffff, 0},
   [INSN_OPER_D] = {INSN_OPER_D, (0x1f * 0x200000), 21}
  }
 },
 ...
 [INSN_AI] = {INSN_AI, "%s r%d, 0x%x",
  {
   [INSN_OPER_I] = {INSN_OPER_I, 0xffff, 0},
   [INSN_OPER_A] = {INSN_OPER_A, (0x1f * 0x10000), 16}
  }
 },
 ...
 [INSN_DAL] = {INSN_DAL, "%s r%d, r%d, 0x%x",
  {
   [INSN_OPER_D] = {INSN_OPER_D, (0x1f * 0x200000), 21},
   [INSN_OPER_A] = {INSN_OPER_A, (0x1f * 0x10000), 16},
   [INSN_OPER_L] = {INSN_OPER_L, 0x3f, 0}
  }
 },
...
insn_extra_t extra_0x5[] = {
 {(0x05<<26)|(0x1<<24), "l.nop", INSN_K, (0x3fULL * 0x4000000) | (0x3 << 24), R_ANAL_OP_TYPE_NOP},
 {0}
};

insn_extra_t extra_0x6[] = {
 {(0x06<<26)|(0<<16), "l.movhi", INSN_DK, (0x3fULL * 0x4000000) | (1 << 16)},
 {(0x06<<26)|(1<<16), "l.macrc", INSN_D, (0x3fULL * 0x4000000) | (1 << 16)},
 {0}
};

insn_extra_t extra_0x8[] = {
 {(0x08<<26)|(0x0), "l.sys", INSN_K, (0x3fULL * 0x4000000) | 0x3ff << 16},
 {(0x08<<26)|(0x100), "l.trap", INSN_K, (0x3fULL * 0x4000000) | 0x3ff << 16},
 {(0x08<<26)|(0x2000000), "l.msync", INSN_X, (0x3fULL * 0x4000000) | 0x3ffffff},
 {(0x08<<26)|(0x2800000), "l.psync", INSN_X, (0x3fULL * 0x4000000) | 0x3ffffff},
 {(0x08<<26)|(0x3000000), "l.csync", INSN_X, (0x3fULL * 0x4000000) | 0x3ffffff},
 {0}
};

insn_extra_t extra_0x2e[] = {
 {(0x2e<<26)|(0x0<<6), "l.slli", INSN_DAL, (0x3fULL * 0x4000000) | (0x3 << 6)},
 {(0x2e<<26)|(0x1<<6), "l.srli", INSN_DAL, (0x3fULL * 0x4000000) | (0x3 << 6)},
 {(0x2e<<26)|(0x2<<6), "l.srai", INSN_DAL, (0x3fULL * 0x4000000) | (0x3 << 6)},
 {(0x2e<<26)|(0x3<<6), "l.rori", INSN_DAL, (0x3fULL * 0x4000000) | (0x3 << 6)},
 {0}
};

insn_extra_t extra_0x2f[] = {
 {(0x2f<<26)|(0x0<<21), "l.sfeqi", INSN_AI, (0x3fULL * 0x4000000) | (0x1f << 21)},
 {(0x2f<<26)|(0x1<<21), "l.sfnei", INSN_AI, (0x3fULL * 0x4000000) | (0x1f << 21)},
 {(0x2f<<26)|(0x2<<21), "l.sfgtui", INSN_AI, (0x3fULL * 0x4000000) | (0x1f << 21)},
 {(0x2f<<26)|(0x3<<21), "l.sfgeui", INSN_AI, (0x3fULL * 0x4000000) | (0x1f << 21)},
 {(0x2f<<26)|(0x4<<21), "l.sfltui", INSN_AI, (0x3fULL * 0x4000000) | (0x1f << 21)},
 {(0x2f<<26)|(0x5<<21), "l.sfleui", INSN_AI, (0x3fULL * 0x4000000) | (0x1f << 21)},
 {(0x2f<<26)|(0xa<<21), "l.sfgtsi", INSN_AI, (0x3fULL * 0x4000000) | (0x1f << 21)},
 {(0x2f<<26)|(0xb<<21), "l.sfgesi", INSN_AI, (0x3fULL * 0x4000000) | (0x1f << 21)},
 {(0x2f<<26)|(0xc<<21), "l.sfltsi", INSN_AI, (0x3fULL * 0x4000000) | (0x1f << 21)},
 {(0x2f<<26)|(0xd<<21), "l.sflesi", INSN_AI, (0x3fULL * 0x4000000) | (0x1f << 21)},
 {0}
};

insn_extra_t extra_0x31[] = {
 {(0x31<<26)|(0x1), "l.mac", INSN_AB, (0x3fULL * 0x4000000) | (0xf)},
 {(0x31<<26)|(0x3), "l.macu", INSN_AB, (0x3fULL * 0x4000000) | (0xf)},
 {(0x31<<26)|(0x2), "l.msb", INSN_AB, (0x3fULL * 0x4000000) | (0xf)},
 {(0x31<<26)|(0x4), "l.msbu", INSN_AB, (0x3fULL * 0x4000000) | (0xf)},
 {0}
};

insn_extra_t extra_0x32[] = {
 {(0x32<<26)|(0x8), "lf.sfeq.s", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x9), "lf.sfne.s", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0xa), "lf.sfgt.s", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0xb), "lf.sfge.s", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0xc), "lf.sflt.s", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0xd), "lf.sfle.s", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x18), "lf.sfeq.d", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x19), "lf.sfne.d", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x1a), "lf.sfgt.d", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x1b), "lf.sfge.d", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x1c), "lf.sflt.d", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x1d), "lf.sfle.d", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x28), "lf.sfueq.s", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x29), "lf.sfune.s", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x2a), "lf.sfugt.s", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x2b), "lf.sfuge.s", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x2c), "lf.sfult.s", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x2d), "lf.sfule.s", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x2e), "lf.sfun.s", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x34), "lf.stod.d", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x35), "lf.dtos.d", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x38), "lf.sfueq.d", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x39), "lf.sfune.d", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x3a), "lf.sfugt.d", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x3b), "lf.sfuge.d", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x3c), "lf.sfult.d", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x3d), "lf.sfule.d", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x3e), "lf.sfun.d", INSN_AB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0xd<<4), "lf.cust1.s", INSN_AB, (0x3fULL * 0x4000000) | (0xf << 4)},
 {(0x32<<26)|(0xe<<4), "lf.cust1.d", INSN_AB, (0x3fULL * 0x4000000) | (0xf << 4)},
 {(0x32<<26)|(0x4), "lf.itof.s", INSN_DA, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x5), "lf.ftoi.s", INSN_DA, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x14), "lf.itof.d", INSN_DA, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x15), "lf.ftoi.d", INSN_DA, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x0), "lf.add.s", INSN_DAB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x1), "lf.sub.s", INSN_DAB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x2), "lf.mul.s", INSN_DAB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x3), "lf.div.s", INSN_DAB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x7), "lf.madd.s", INSN_DAB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x10), "lf.add.d", INSN_DAB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x11), "lf.sub.d", INSN_DAB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x12), "lf.mul.d", INSN_DAB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x13), "lf.div.d", INSN_DAB, (0x3fULL * 0x4000000) | (0xff)},
 {(0x32<<26)|(0x17), "lf.madd.d", INSN_DAB, (0x3fULL * 0x4000000) | (0xff)},
 {0}
};

insn_extra_t extra_0x38[] = {
 {(0x38<<26)|(0x0<<6)|(0xc), "l.exths", INSN_DA, (0x3fULL * 0x4000000) | (0xf << 6) | 0xf},
 {(0x38<<26)|(0x0<<6)|(0xd), "l.extws", INSN_DA, (0x3fULL * 0x4000000) | (0xf << 6) | 0xf},
 {(0x38<<26)|(0x1<<6)|(0xc), "l.extbs", INSN_DA, (0x3fULL * 0x4000000) | (0xf << 6) | 0xf},
 {(0x38<<26)|(0x1<<6)|(0xd), "l.extwz", INSN_DA, (0x3fULL * 0x4000000) | (0xf << 6) | 0xf},
 {(0x38<<26)|(0x2<<6)|(0xc), "l.exthz", INSN_DA, (0x3fULL * 0x4000000) | (0xf << 6) | 0xf},
 {(0x38<<26)|(0x3<<6)|(0xc), "l.extbz", INSN_DA, (0x3fULL * 0x4000000) | (0xf << 6) | 0xf},
 {(0x38<<26)|(0x0<<6)|(0x0), "l.add", INSN_DAB, (0x3fULL * 0x4000000) | (0xc << 6) | 0xf},
 {(0x38<<26)|(0x0<<6)|(0x1), "l.addc", INSN_DAB, (0x3fULL * 0x4000000) | (0xc << 6) | 0xf},
 {(0x38<<26)|(0x0<<6)|(0x2), "l.sub", INSN_DAB, (0x3fULL * 0x4000000) | (0xc << 6) | 0xf},
 {(0x38<<26)|(0x0<<6)|(0x3), "l.and", INSN_DAB, (0x3fULL * 0x4000000) | (0xc << 6) | 0xf},
 {(0x38<<26)|(0x0<<6)|(0x4), "l.or", INSN_DAB, (0x3fULL * 0x4000000) | (0xc << 6) | 0xf},
 {(0x38<<26)|(0x0<<6)|(0x5), "l.xor", INSN_DAB, (0x3fULL * 0x4000000) | (0xc << 6) | 0xf},
 {(0x38<<26)|(0x0<<6)|(0xe), "l.cmov", INSN_DAB, (0x3fULL * 0x4000000) | (0xc << 6) | 0xf},
 {(0x38<<26)|(0x0<<6)|(0xf), "l.ff1", INSN_DA, (0x3fULL * 0x4000000) | (0xc << 6) | 0xf},
 {(0x38<<26)|(0x0<<6)|(0x8), "l.sll", INSN_DAB, (0x3fULL * 0x4000000) | (0xf << 6) | 0xf},
 {(0x38<<26)|(0x1<<6)|(0x8), "l.srl", INSN_DAB, (0x3fULL * 0x4000000) | (0xf << 6) | 0xf},
 {(0x38<<26)|(0x2<<6)|(0x8), "l.sra", INSN_DAB, (0x3fULL * 0x4000000) | (0xf << 6) | 0xf},
 {(0x38<<26)|(0x3<<6)|(0x8), "l.ror", INSN_DAB, (0x3fULL * 0x4000000) | (0xf << 6) | 0xf},
 {(0x38<<26)|(0x1<<8)|(0xf), "l.fl1", INSN_DA, (0x3fULL * 0x4000000) | (0x3 << 8) | 0xf},
 {(0x38<<26)|(0x3<<8)|(0x6), "l.mul", INSN_DAB, (0x3fULL * 0x4000000) | (0x3 << 8) | 0xf},
 {(0x38<<26)|(0x3<<8)|(0x7), "l.muld", INSN_AB, (0x3fULL * 0x4000000) | (0x3 << 8) | 0xf},
 {(0x38<<26)|(0x3<<8)|(0x9), "l.div", INSN_DAB, (0x3fULL * 0x4000000) | (0x3 << 8) | 0xf},
 {(0x38<<26)|(0x3<<8)|(0xa), "l.divu", INSN_DAB, (0x3fULL * 0x4000000) | (0x3 << 8) | 0xf},
 {(0x38<<26)|(0x3<<8)|(0xb), "l.mulu", INSN_DAB, (0x3fULL * 0x4000000) | (0x3 << 8) | 0xf},
 {(0x38<<26)|(0x3<<8)|(0xc), "l.muldu", INSN_AB, (0x3fULL * 0x4000000) | (0x3 << 8) | 0xf},
 {0}
};

insn_extra_t extra_0x39[] = {
 {(0x39<<26)|(0x0<<21), "l.sfeq", INSN_AB, (0x3fULL * 0x4000000) | (0x1f << 21)},
 {(0x39<<26)|(0x1<<21), "l.sfne", INSN_AB, (0x3fULL * 0x4000000) | (0x1f << 21)},
 {(0x39<<26)|(0x2<<21), "l.sfgtu", INSN_AB, (0x3fULL * 0x4000000) | (0x1f << 21)},
 {(0x39<<26)|(0x3<<21), "l.sfgeu", INSN_AB, (0x3fULL * 0x4000000) | (0x1f << 21)},
 {(0x39<<26)|(0x4<<21), "l.sfltu", INSN_AB, (0x3fULL * 0x4000000) | (0x1f << 21)},
 {(0x39<<26)|(0x5<<21), "l.sfleu", INSN_AB, (0x3fULL * 0x4000000) | (0x1f << 21)},
 {(0x39<<26)|(0xa<<21), "l.sfgts", INSN_AB, (0x3fULL * 0x4000000) | (0x1f << 21)},
 {(0x39<<26)|(0xb<<21), "l.sfges", INSN_AB, (0x3fULL * 0x4000000) | (0x1f << 21)},
 {(0x39<<26)|(0xc<<21), "l.sflts", INSN_AB, (0x3fULL * 0x4000000) | (0x1f << 21)},
 {(0x39<<26)|(0xd<<21), "l.sfles", INSN_AB, (0x3fULL * 0x4000000) | (0x1f << 21)},
 {0}
};
...
insn_t or1k_insns[] = {
 ...
 [0x05] = {(0x05<<26), 
# 272 "project/radare2/libr/asm/arch/or1k/or1k_disas.c" 3 4
                      ((void *)0)
# 272 "project/radare2/libr/asm/arch/or1k/or1k_disas.c"
                          , INSN_X, R_ANAL_OP_TYPE_NULL, extra_0x5},
 [0x06] = {(0x06<<26), 
# 273 "project/radare2/libr/asm/arch/or1k/or1k_disas.c" 3 4
                      ((void *)0)
# 273 "project/radare2/libr/asm/arch/or1k/or1k_disas.c"
                          , INSN_X, R_ANAL_OP_TYPE_NULL, extra_0x6},
 [0x07] = {(0x07<<26)},
 [0x08] = {(0x08<<26), 
# 275 "project/radare2/libr/asm/arch/or1k/or1k_disas.c" 3 4
                      ((void *)0)
# 275 "project/radare2/libr/asm/arch/or1k/or1k_disas.c"
                          , INSN_X, R_ANAL_OP_TYPE_NULL, extra_0x8},
 [0x09] = {(0x09<<26), "l.rfe", INSN_X},
 [0x0a] = {(0x0a<<26), "lv.ext0a", INSN_X},
 [0x0b] = {(0x0b<<26)},
 [0x0c] = {(0x0c<<26)},
 [0x0d] = {(0x0d<<26)},
 [0x0e] = {(0x0e<<26)},
 ...
 [0x2e] = {(0x2e<<26), 
# 313 "project/radare2/libr/asm/arch/or1k/or1k_disas.c" 3 4
                      ((void *)0)
# 313 "project/radare2/libr/asm/arch/or1k/or1k_disas.c"
                          , INSN_X, R_ANAL_OP_TYPE_NULL, extra_0x2e},
 [0x2f] = {(0x2f<<26), 
# 314 "project/radare2/libr/asm/arch/or1k/or1k_disas.c" 3 4
                      ((void *)0)
# 314 "project/radare2/libr/asm/arch/or1k/or1k_disas.c"
                          , INSN_X, R_ANAL_OP_TYPE_NULL, extra_0x2f},
 [0x30] = {(0x30<<26), "l.mtspr", INSN_KABK},
 [0x31] = {(0x31<<26), 
# 316 "project/radare2/libr/asm/arch/or1k/or1k_disas.c" 3 4
                      ((void *)0)
# 316 "project/radare2/libr/asm/arch/or1k/or1k_disas.c"
                          , INSN_X, R_ANAL_OP_TYPE_NULL, extra_0x31},
 [0x32] = {(0x32<<26), 
# 317 "project/radare2/libr/asm/arch/or1k/or1k_disas.c" 3 4
                      ((void *)0)
# 317 "project/radare2/libr/asm/arch/or1k/or1k_disas.c"
                          , INSN_X, R_ANAL_OP_TYPE_NULL, extra_0x32},
 ...
 [0x38] = {(0x38<<26), 
# 323 "project/radare2/libr/asm/arch/or1k/or1k_disas.c" 3 4
                      ((void *)0)
# 323 "project/radare2/libr/asm/arch/or1k/or1k_disas.c"
                          , INSN_X, R_ANAL_OP_TYPE_NULL, extra_0x38},
 [0x39] = {(0x39<<26), 
# 324 "project/radare2/libr/asm/arch/or1k/or1k_disas.c" 3 4
                      ((void *)0)
# 324 "project/radare2/libr/asm/arch/or1k/or1k_disas.c"
                          , INSN_X, R_ANAL_OP_TYPE_NULL, extra_0x39},
 [0x3a] = {(0x3a<<26)},
 [0x3b] = {(0x3b<<26)},
...
insn_extra_t *find_extra_descriptor(insn_extra_t *extra_descr, 
# 335 "project/radare2/libr/asm/arch/or1k/or1k_disas.c" 3 4
                                                              unsigned int 
# 335 "project/radare2/libr/asm/arch/or1k/or1k_disas.c"
                                                                   insn) {
 
# 336 "project/radare2/libr/asm/arch/or1k/or1k_disas.c" 3 4
unsigned int 
# 336 "project/radare2/libr/asm/arch/or1k/or1k_disas.c"
     opcode;
 ...
 if (extra_descr->type != INSN_END) {
  ...
  return 
# 347 "project/radare2/libr/asm/arch/or1k/or1k_disas.c" 3 4
        ((void *)0)
# 347 "project/radare2/libr/asm/arch/or1k/or1k_disas.c"
            ;
 }
}


# 351 "project/radare2/libr/asm/arch/or1k/or1k_disas.c" 3 4
unsigned int 
# 351 "project/radare2/libr/asm/arch/or1k/or1k_disas.c"
    sign_extend(
# 351 "project/radare2/libr/asm/arch/or1k/or1k_disas.c" 3 4
                unsigned int 
# 351 "project/radare2/libr/asm/arch/or1k/or1k_disas.c"
...
# 354 "project/radare2/libr/asm/arch/or1k/or1k_disas.c" 3 4
unsigned int 
# 354 "project/radare2/libr/asm/arch/or1k/or1k_disas.c"
     first_bit = (mask ^ (mask >> 1)) & mask;
