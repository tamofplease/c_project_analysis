# 0 "project/radare2/libr/asm/d/sh.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/asm/d/sh.c" 2
...
# 5 "project/radare2/libr/asm/d/sh.c" 2
...
# 6 "project/radare2/libr/asm/d/sh.c" 2


# 7 "project/radare2/libr/asm/d/sh.c"
...
static struct kv kvs[] = {
  ...
  {
# 134 "project/radare2/libr/asm/d/sh.c" 3 4
  ((void *)0)
# 134 "project/radare2/libr/asm/d/sh.c"
      , 
# 134 "project/radare2/libr/asm/d/sh.c" 3 4
        ((void *)0)
# 134 "project/radare2/libr/asm/d/sh.c"
...
const char *gperf_sh_get(const char *s) {
  ...
  i++;}
  return 
# 149 "project/radare2/libr/asm/d/sh.c" 3 4
        ((void *)0)
# 149 "project/radare2/libr/asm/d/sh.c"
            ;
}
