# 0 "project/radare2/libr/asm/d/arc.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/asm/d/arc.c" 2
...
# 5 "project/radare2/libr/asm/d/arc.c" 2
...
# 6 "project/radare2/libr/asm/d/arc.c" 2


# 7 "project/radare2/libr/asm/d/arc.c"
...
static struct kv kvs[] = {
  ...
  {
# 127 "project/radare2/libr/asm/d/arc.c" 3 4
  ((void *)0)
# 127 "project/radare2/libr/asm/d/arc.c"
      , 
# 127 "project/radare2/libr/asm/d/arc.c" 3 4
        ((void *)0)
# 127 "project/radare2/libr/asm/d/arc.c"
...
const char *gperf_arc_get(const char *s) {
  ...
  i++;}
  return 
# 142 "project/radare2/libr/asm/d/arc.c" 3 4
        ((void *)0)
# 142 "project/radare2/libr/asm/d/arc.c"
            ;
}
