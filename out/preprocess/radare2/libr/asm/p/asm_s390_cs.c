# 0 "project/radare2/libr/asm/p/asm_s390_cs.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/p/asm_s390_cs.c"
...
# 6 "project/radare2/libr/asm/p/asm_s390_cs.c" 2
...
# 7 "project/radare2/libr/asm/p/asm_s390_cs.c" 2
...
# 8 "project/radare2/libr/asm/p/asm_s390_cs.c" 2


# 9 "project/radare2/libr/asm/p/asm_s390_cs.c"
static csh cd = 0;

static 
# 11 "project/radare2/libr/asm/p/asm_s390_cs.c" 3 4
      _Bool 
# 11 "project/radare2/libr/asm/p/asm_s390_cs.c"
           the_end(void *p) {
 if (cd) {
  cs_close (&cd);
  cd = 0;
 ...
 return 
# 16 "project/radare2/libr/asm/p/asm_s390_cs.c" 3 4
       1
# 16 "project/radare2/libr/asm/p/asm_s390_cs.c"
           ;
}

static int disassemble(RAsm *a, RAsmOp *op, const 
# 19 "project/radare2/libr/asm/p/asm_s390_cs.c" 3 4
                                                 unsigned char 
# 19 "project/radare2/libr/asm/p/asm_s390_cs.c"
                                                     *buf, int len) {
 static int omode = 0;
 int mode, n, ret;
 
# 22 "project/radare2/libr/asm/p/asm_s390_cs.c" 3 4
unsigned long long 
# 22 "project/radare2/libr/asm/p/asm_s390_cs.c"
     off = a->pc;
 cs_insn* insn = 
# 23 "project/radare2/libr/asm/p/asm_s390_cs.c" 3 4
                ((void *)0)
# 23 "project/radare2/libr/asm/p/asm_s390_cs.c"
                    ;
 ...
 n = cs_disasm (cd, (const 
# 39 "project/radare2/libr/asm/p/asm_s390_cs.c" 3 4
                          unsigned char
# 39 "project/radare2/libr/asm/p/asm_s390_cs.c"
                             *)buf, len, off, 1, &insn);
 if (n > 0) {
  if (insn->size > 0) {
   op->size = insn->size;
...
# 48 "project/radare2/libr/asm/p/asm_s390_cs.c" 3 4
   __builtin___memmove_chk (
# 48 "project/radare2/libr/asm/p/asm_s390_cs.c"
   ptrstr
# 48 "project/radare2/libr/asm/p/asm_s390_cs.c" 3 4
   , 
# 48 "project/radare2/libr/asm/p/asm_s390_cs.c"
   ptrstr + 4, strlen (ptrstr + 4) + 1
# 48 "project/radare2/libr/asm/p/asm_s390_cs.c" 3 4
...
RAsmPlugin r_asm_plugin_s390_cs = {
 ...
 .bits = 32 | 64,
 .endian = 
# 63 "project/radare2/libr/asm/p/asm_s390_cs.c" 3 4
          2
# 63 "project/radare2/libr/asm/p/asm_s390_cs.c"
                          ,
 .fini = the_end,
...
# 69 "project/radare2/libr/asm/p/asm_s390_cs.c" 3 4
__attribute__((visibility("default"))) 
# 69 "project/radare2/libr/asm/p/asm_s390_cs.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_s390_cs,
 .version = 
# 72 "project/radare2/libr/asm/p/asm_s390_cs.c" 3 4
           "5.5.4"

# 73 "project/radare2/libr/asm/p/asm_s390_cs.c"
};
