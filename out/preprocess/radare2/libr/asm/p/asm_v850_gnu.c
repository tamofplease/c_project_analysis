# 0 "project/radare2/libr/asm/p/asm_v850_gnu.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/p/asm_v850_gnu.c"
...
# 6 "project/radare2/libr/asm/p/asm_v850_gnu.c" 2
...
typedef int RRef;
# 7 "project/radare2/libr/asm/p/asm_v850_gnu.c" 2
# 1 "project/radare2/libr/asm/p/../arch/v850/gnu/v850.h" 1
# 31 "project/radare2/libr/asm/p/../arch/v850/gnu/v850.h"
...
# 102 "project/radare2/libr/asm/p/../arch/v850/gnu/v850.h"
...
struct v850_operand
{
  ...
  int shift;
# 135 "project/radare2/libr/asm/p/../arch/v850/gnu/v850.h"
  unsigned long (* insert)
    (unsigned long instruction, long op, const char ** errmsg);
# 154 "project/radare2/libr/asm/p/../arch/v850/gnu/v850.h"
...
# 242 "project/radare2/libr/asm/p/../arch/v850/gnu/v850.h"
extern int v850_msg_is_out_of_range (const char *);
# 8 "project/radare2/libr/asm/p/asm_v850_gnu.c" 2
...
# 9 "project/radare2/libr/asm/p/asm_v850_gnu.c" 2
...
# 10 "project/radare2/libr/asm/p/asm_v850_gnu.c" 2
...
# 11 "project/radare2/libr/asm/p/asm_v850_gnu.c" 2
...
# 12 "project/radare2/libr/asm/p/asm_v850_gnu.c" 2
...
# 13 "project/radare2/libr/asm/p/asm_v850_gnu.c" 2


# 14 "project/radare2/libr/asm/p/asm_v850_gnu.c"
static unsigned long Offset = 0;
static RStrBuf *buf_global = 
# 15 "project/radare2/libr/asm/p/asm_v850_gnu.c" 3 4
                            ((void *)0)
# 15 "project/radare2/libr/asm/p/asm_v850_gnu.c"
                                ;
static 
# 16 "project/radare2/libr/asm/p/asm_v850_gnu.c" 3 4
      unsigned char 
# 16 "project/radare2/libr/asm/p/asm_v850_gnu.c"
          bytes[8];

static int v850_buffer_read_memory(bfd_vma memaddr, bfd_byte *myaddr, 
# 18 "project/radare2/libr/asm/p/asm_v850_gnu.c" 3 4
                                                                     unsigned int 
# 18 "project/radare2/libr/asm/p/asm_v850_gnu.c"
...
# 26 "project/radare2/libr/asm/p/asm_v850_gnu.c" 3 4
__builtin___memcpy_chk (
# 26 "project/radare2/libr/asm/p/asm_v850_gnu.c"
myaddr
# 26 "project/radare2/libr/asm/p/asm_v850_gnu.c" 3 4
, 
# 26 "project/radare2/libr/asm/p/asm_v850_gnu.c"
...
# 38 "project/radare2/libr/asm/p/asm_v850_gnu.c" 3 4
...
# 41 "project/radare2/libr/asm/p/asm_v850_gnu.c"
static int disassemble(RAsm *a, RAsmOp *op, const 
# 41 "project/radare2/libr/asm/p/asm_v850_gnu.c" 3 4
                                                 unsigned char 
# 41 "project/radare2/libr/asm/p/asm_v850_gnu.c"
                                                     *buf, int len) {
...
# 45 "project/radare2/libr/asm/p/asm_v850_gnu.c" 3 4
__builtin___memcpy_chk (
# 45 "project/radare2/libr/asm/p/asm_v850_gnu.c"
bytes
# 45 "project/radare2/libr/asm/p/asm_v850_gnu.c" 3 4
, 
# 45 "project/radare2/libr/asm/p/asm_v850_gnu.c"
...
# 48 "project/radare2/libr/asm/p/asm_v850_gnu.c" 3 4
__builtin___memset_chk (
# 48 "project/radare2/libr/asm/p/asm_v850_gnu.c"
&disasm_obj
# 48 "project/radare2/libr/asm/p/asm_v850_gnu.c" 3 4
, 
# 48 "project/radare2/libr/asm/p/asm_v850_gnu.c"
...
# 48 "project/radare2/libr/asm/p/asm_v850_gnu.c"
 ...
 disasm_obj.flavour = (1 << ((((0 + 1) + 1) + 1)));
 if (!
# 51 "project/radare2/libr/asm/p/asm_v850_gnu.c" 3 4
     (!(
# 51 "project/radare2/libr/asm/p/asm_v850_gnu.c"
     a->cpu
# 51 "project/radare2/libr/asm/p/asm_v850_gnu.c" 3 4
     ) || !*(
# 51 "project/radare2/libr/asm/p/asm_v850_gnu.c"
...
# 51 "project/radare2/libr/asm/p/asm_v850_gnu.c"
  ...
  if (!strcmp (a->cpu, "e")) {
   disasm_obj.flavour = (1 << ((0 + 1)));
  } else if (!strcmp (a->cpu, "e1")) {
   disasm_obj.flavour = (1 << (((0 + 1) + 1)));
  } else if (!strcmp (a->cpu, "e2")) {
   disasm_obj.flavour = (1 << ((((0 + 1) + 1) + 1)));
  } else if (!strcmp (a->cpu, "e2v3")) {
   disasm_obj.flavour = (1 << (((((0 + 1) + 1) + 1) + 1)));
  } else if (!strcmp (a->cpu, "e3v5")) {
   disasm_obj.flavour = (1 << ((((((0 + 1) + 1) + 1) + 1) + 1)));
  }
 }
 ...
 disasm_obj.stream = 
# 70 "project/radare2/libr/asm/p/asm_v850_gnu.c" 3 4
                    __stdoutp
# 70 "project/radare2/libr/asm/p/asm_v850_gnu.c"
                          ;
...
RAsmPlugin r_asm_plugin_v850_gnu = {
 ...
 .bits = 32,
 .endian = 
# 89 "project/radare2/libr/asm/p/asm_v850_gnu.c" 3 4
          1
# 89 "project/radare2/libr/asm/p/asm_v850_gnu.c"
                             ,
...
# 95 "project/radare2/libr/asm/p/asm_v850_gnu.c" 3 4
__attribute__((visibility("default"))) 
# 95 "project/radare2/libr/asm/p/asm_v850_gnu.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_v850_gnu,
 .version = 
# 98 "project/radare2/libr/asm/p/asm_v850_gnu.c" 3 4
           "5.5.4"

# 99 "project/radare2/libr/asm/p/asm_v850_gnu.c"
};
