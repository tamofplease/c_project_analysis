# 0 "project/radare2/libr/asm/p/asm_hexagon.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/p/asm_hexagon.c"
...
typedef int RRef;
# 4 "project/radare2/libr/asm/p/asm_hexagon.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_hexagon.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_hexagon.c" 2
...
# 7 "project/radare2/libr/asm/p/asm_hexagon.c" 2
...
# 280 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/hexagon/hexagon.h"
                                                             addr);
# 8 "project/radare2/libr/asm/p/asm_hexagon.c" 2
...
# 9 "project/radare2/libr/asm/p/asm_hexagon.c" 2

static int disassemble (RAsm *a, RAsmOp *op, const 
# 10 "project/radare2/libr/asm/p/asm_hexagon.c" 3 4
                                                  unsigned char 
# 10 "project/radare2/libr/asm/p/asm_hexagon.c"
                                                      *buf, int l) {
 HexInsn hi = {0};
 
# 12 "project/radare2/libr/asm/p/asm_hexagon.c" 3 4
unsigned int 
# 12 "project/radare2/libr/asm/p/asm_hexagon.c"
     data = r_read_le32 (buf);
 op->size = hexagon_disasm_instruction (data, &hi, (
# 13 "project/radare2/libr/asm/p/asm_hexagon.c" 3 4
                                                   unsigned int
# 13 "project/radare2/libr/asm/p/asm_hexagon.c"
                                                       ) a->pc);
...
# 29 "project/radare2/libr/asm/p/asm_hexagon.c" 3 4
__attribute__((visibility("default"))) 
# 29 "project/radare2/libr/asm/p/asm_hexagon.c"
