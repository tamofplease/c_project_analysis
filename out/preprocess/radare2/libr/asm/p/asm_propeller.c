# 0 "project/radare2/libr/asm/p/asm_propeller.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/p/asm_propeller.c"
...
# 4 "project/radare2/libr/asm/p/asm_propeller.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_propeller.c" 2
...
typedef int RRef;
# 6 "project/radare2/libr/asm/p/asm_propeller.c" 2
...
# 7 "project/radare2/libr/asm/p/asm_propeller.c" 2
...
# 8 "project/radare2/libr/asm/p/asm_propeller.c" 2

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/propeller/propeller_disas.h" 1 3 4
...
int propeller_decode_command (const unsigned char* instr, struct propeller_cmd *cmd);
# 10 "project/radare2/libr/asm/p/asm_propeller.c" 2


# 11 "project/radare2/libr/asm/p/asm_propeller.c"
static int disassemble(RAsm *a, RAsmOp *op, const 
# 11 "project/radare2/libr/asm/p/asm_propeller.c" 3 4
                                                 unsigned char 
# 11 "project/radare2/libr/asm/p/asm_propeller.c"
                                                     *buf, int len) {
 const char *buf_asm;
...
RAsmPlugin r_asm_plugin_propeller = {
 ...
 .bits = 32,
 .endian = 
# 33 "project/radare2/libr/asm/p/asm_propeller.c" 3 4
          2
# 33 "project/radare2/libr/asm/p/asm_propeller.c"
                          ,
...
# 38 "project/radare2/libr/asm/p/asm_propeller.c" 3 4
__attribute__((visibility("default"))) 
# 38 "project/radare2/libr/asm/p/asm_propeller.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_propeller,
 .version = 
# 41 "project/radare2/libr/asm/p/asm_propeller.c" 3 4
           "5.5.4"

# 42 "project/radare2/libr/asm/p/asm_propeller.c"
};
