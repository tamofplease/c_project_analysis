# 0 "project/radare2/libr/asm/p/asm_rsp.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
typedef int RRef;
# 5 "project/radare2/libr/asm/p/asm_rsp.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_rsp.c" 2
...
# 7 "project/radare2/libr/asm/p/asm_rsp.c" 2
...
# 8 "project/radare2/libr/asm/p/asm_rsp.c" 2




# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/rsp/rsp_idec.h" 1
...
# 8 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/rsp/rsp_idec.h"
...
static inline 
# 24 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/rsp/rsp_idec.h" 3 4
             unsigned long long 
# 24 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/rsp/rsp_idec.h"
                  rsp_mem_addr(
# 24 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/rsp/rsp_idec.h" 3 4
                               unsigned long long 
# 24 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/rsp/rsp_idec.h"
...
# 164 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/rsp/rsp_idec.h" 3 4
unsigned long long 
# 164 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/rsp/rsp_idec.h"
     u;
 
# 165 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/rsp/rsp_idec.h" 3 4
long long 
# 165 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/rsp/rsp_idec.h"
     s;
} rsp_operand;
...
# 177 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/rsp/rsp_idec.h" 3 4
                                      unsigned long long 
# 177 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/rsp/rsp_idec.h"
                                           pc, 
# 177 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/rsp/rsp_idec.h" 3 4
                                               unsigned int 
# 177 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/rsp/rsp_idec.h"
                                                    iw);
# 13 "project/radare2/libr/asm/p/asm_rsp.c" 2


static int disassemble(RAsm *a, RAsmOp *op, const 
# 15 "project/radare2/libr/asm/p/asm_rsp.c" 3 4
                                                 unsigned char 
# 15 "project/radare2/libr/asm/p/asm_rsp.c"
                                                     *buf, int len) {
...
# 26 "project/radare2/libr/asm/p/asm_rsp.c" 3 4
unsigned int 
# 26 "project/radare2/libr/asm/p/asm_rsp.c"
 ...
 for (i = 0; i < r_instr.noperands; i++) {
  ...
  case RSP_OPND_TARGET:
   r_strbuf_appendf (&op->buf_asm, "0x%08"
# 39 "project/radare2/libr/asm/p/asm_rsp.c" 3 4
                                         "llx"
# 39 "project/radare2/libr/asm/p/asm_rsp.c"
                                                , r_instr.operands[i].u);
   break;
  case RSP_OPND_ZIMM:
   {
   int shift = (r_instr.operands[i].u & ~0xffff) ? 16 : 0;
   r_strbuf_appendf (&op->buf_asm, "0x%04"
# 44 "project/radare2/libr/asm/p/asm_rsp.c" 3 4
                                         "llx"
# 44 "project/radare2/libr/asm/p/asm_rsp.c"
                                                ,
    r_instr.operands[i].u >> shift);
   }
   break;
  case RSP_OPND_SIMM:
   r_strbuf_appendf (&op->buf_asm, "%s0x%04"
# 49 "project/radare2/libr/asm/p/asm_rsp.c" 3 4
                                           "llx"
# 49 "project/radare2/libr/asm/p/asm_rsp.c"
                                                  ,
   (r_instr.operands[i].s<0)?"-":"",
   (r_instr.operands[i].s<0)?-r_instr.operands[i].s:r_instr.operands[i].s);
   break;
  case RSP_OPND_SHIFT_AMOUNT:
   r_strbuf_appendf (&op->buf_asm, "%"
# 54 "project/radare2/libr/asm/p/asm_rsp.c" 3 4
                                     "llu"
# 54 "project/radare2/libr/asm/p/asm_rsp.c"
                                            , r_instr.operands[i].u);
   break;
  case RSP_OPND_BASE_OFFSET:
   ...
   (r_instr.operands[i].s<0)?"-":"",
   (
# 59 "project/radare2/libr/asm/p/asm_rsp.c" 3 4
   unsigned int
# 59 "project/radare2/libr/asm/p/asm_rsp.c"
       )((r_instr.operands[i].s<0)?-r_instr.operands[i].s:r_instr.operands[i].s),
  ...
  case RSP_OPND_C2_VREG_SCALAR:
   r_strbuf_appendf (&op->buf_asm, "%s[%u]", rsp_c2_vreg_names[r_instr.operands[i].u],
    (
# 77 "project/radare2/libr/asm/p/asm_rsp.c" 3 4
    unsigned int
# 77 "project/radare2/libr/asm/p/asm_rsp.c"
...
RAsmPlugin r_asm_plugin_rsp = {
 ...
 .bits = 32,
 .endian = 
# 96 "project/radare2/libr/asm/p/asm_rsp.c" 3 4
          3
# 96 "project/radare2/libr/asm/p/asm_rsp.c"
                         ,
 .license = "LGPL3",
...
# 102 "project/radare2/libr/asm/p/asm_rsp.c" 3 4
__attribute__((visibility("default"))) 
# 102 "project/radare2/libr/asm/p/asm_rsp.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_rsp,
 .version = 
# 105 "project/radare2/libr/asm/p/asm_rsp.c" 3 4
           "5.5.4"

# 106 "project/radare2/libr/asm/p/asm_rsp.c"
};
