# 0 "project/radare2/libr/asm/p/asm_v850.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/asm/p/asm_v850.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_v850.c" 2
...
typedef int RRef;
# 6 "project/radare2/libr/asm/p/asm_v850.c" 2
...
# 7 "project/radare2/libr/asm/p/asm_v850.c" 2
...
# 8 "project/radare2/libr/asm/p/asm_v850.c" 2
...
# 10 "project/radare2/libr/asm/p/asm_v850.c" 2


# 11 "project/radare2/libr/asm/p/asm_v850.c"
static int disassemble(RAsm *a, RAsmOp *op, const 
# 11 "project/radare2/libr/asm/p/asm_v850.c" 3 4
                                                 unsigned char 
# 11 "project/radare2/libr/asm/p/asm_v850.c"
                                                     *buf, int len) {
 struct v850_cmd cmd = {
...
RAsmPlugin r_asm_plugin_v850 = {
 ...
 .bits = 32,
 .endian = 
# 33 "project/radare2/libr/asm/p/asm_v850.c" 3 4
          1
# 33 "project/radare2/libr/asm/p/asm_v850.c"
                             ,
...
# 38 "project/radare2/libr/asm/p/asm_v850.c" 3 4
__attribute__((visibility("default"))) 
# 38 "project/radare2/libr/asm/p/asm_v850.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_v850,
 .version = 
# 41 "project/radare2/libr/asm/p/asm_v850.c" 3 4
           "5.5.4"

# 42 "project/radare2/libr/asm/p/asm_v850.c"
};
