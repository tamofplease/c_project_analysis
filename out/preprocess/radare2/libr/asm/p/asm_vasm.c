# 0 "project/radare2/libr/asm/p/asm_vasm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/p/asm_vasm.c"
...
typedef int RRef;
# 4 "project/radare2/libr/asm/p/asm_vasm.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_vasm.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_vasm.c" 2
...
# 7 "project/radare2/libr/asm/p/asm_vasm.c" 2


# 8 "project/radare2/libr/asm/p/asm_vasm.c"
static int assemble(RAsm *a, RAsmOp *op, const char *buf) {
 ...
 char *cmd = r_str_newf (
  ...
  ".org 0x%"
# 13 "project/radare2/libr/asm/p/asm_vasm.c" 3 4
           "llx"
# 13 "project/radare2/libr/asm/p/asm_vasm.c"
                  "\n%s\n__", cpu, a->pc, buf);
 
# 14 "project/radare2/libr/asm/p/asm_vasm.c" 3 4
unsigned char 
# 14 "project/radare2/libr/asm/p/asm_vasm.c"
    *out = (
# 14 "project/radare2/libr/asm/p/asm_vasm.c" 3 4
            unsigned char 
# 14 "project/radare2/libr/asm/p/asm_vasm.c"
...
RAsmPlugin r_asm_plugin_vasm = {
 .name = "vasm",
 .arch = 
# 26 "project/radare2/libr/asm/p/asm_vasm.c" 3 4
        ((void *)0)
# 26 "project/radare2/libr/asm/p/asm_vasm.c"
            ,
 .license = "MIT",
 ...
 .bits = 8 | 16 | 32 | 64,
 .endian = 
# 31 "project/radare2/libr/asm/p/asm_vasm.c" 3 4
          1
# 31 "project/radare2/libr/asm/p/asm_vasm.c"
                             ,
 .assemble = &assemble
};
...
# 36 "project/radare2/libr/asm/p/asm_vasm.c" 3 4
__attribute__((visibility("default"))) 
# 36 "project/radare2/libr/asm/p/asm_vasm.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_vasm,
 .version = 
# 39 "project/radare2/libr/asm/p/asm_vasm.c" 3 4
           "5.5.4"

# 40 "project/radare2/libr/asm/p/asm_vasm.c"
};
