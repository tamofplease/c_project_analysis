# 0 "project/radare2/libr/asm/p/asm_x86_nasm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/p/asm_x86_nasm.c"
...
# 4 "project/radare2/libr/asm/p/asm_x86_nasm.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_x86_nasm.c" 2


# 6 "project/radare2/libr/asm/p/asm_x86_nasm.c"
static int assemble(RAsm *a, RAsmOp *op, const char *buf) {
 char *ipath, *opath;
 if (a->syntax != R_ASM_SYNTAX_INTEL) {
  
# 9 "project/radare2/libr/asm/p/asm_x86_nasm.c" 3 4
 fprintf(__stderrp,
# 9 "project/radare2/libr/asm/p/asm_x86_nasm.c"
 "asm.x86.nasm does not support non-intel syntax\n"
# 9 "project/radare2/libr/asm/p/asm_x86_nasm.c" 3 4
 )
# 9 "project/radare2/libr/asm/p/asm_x86_nasm.c"
                                                             ;
...
# 24 "project/radare2/libr/asm/p/asm_x86_nasm.c" 3 4
                                                "llx"
# 24 "project/radare2/libr/asm/p/asm_x86_nasm.c"
                                                       "\n%s\n", a->bits, a->pc, buf);
 if (asm_buf) {
...
# 33 "project/radare2/libr/asm/p/asm_x86_nasm.c" 3 4
 unsigned char 
# 33 "project/radare2/libr/asm/p/asm_x86_nasm.c"
     buf[512];
  op->size = read (ofd, buf, sizeof (buf));
  r_asm_op_set_buf (op, buf, op->size);
 } else {
  
# 37 "project/radare2/libr/asm/p/asm_x86_nasm.c" 3 4
 fprintf(__stderrp,
# 37 "project/radare2/libr/asm/p/asm_x86_nasm.c"
 "Error running 'nasm'\n"
# 37 "project/radare2/libr/asm/p/asm_x86_nasm.c" 3 4
 )
# 37 "project/radare2/libr/asm/p/asm_x86_nasm.c"
...
RAsmPlugin r_asm_plugin_x86_nasm = {
 ...
 .bits = 16 | 32 | 64,
 .endian = 
# 56 "project/radare2/libr/asm/p/asm_x86_nasm.c" 3 4
          1
# 56 "project/radare2/libr/asm/p/asm_x86_nasm.c"
                             ,
 .assemble = &assemble
};
...
# 61 "project/radare2/libr/asm/p/asm_x86_nasm.c" 3 4
__attribute__((visibility("default"))) 
# 61 "project/radare2/libr/asm/p/asm_x86_nasm.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_x86_nasm,
 .version = 
# 64 "project/radare2/libr/asm/p/asm_x86_nasm.c" 3 4
           "5.5.4"

# 65 "project/radare2/libr/asm/p/asm_x86_nasm.c"
};
