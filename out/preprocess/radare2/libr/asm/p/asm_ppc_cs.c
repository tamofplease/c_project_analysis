# 0 "project/radare2/libr/asm/p/asm_ppc_cs.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/p/asm_ppc_cs.c"
...
# 4 "project/radare2/libr/asm/p/asm_ppc_cs.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_ppc_cs.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_ppc_cs.c" 2
# 1 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h" 1
# 15 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h"

# 15 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h"
typedef struct {
 const 
# 16 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h" 3 4
      unsigned char
# 16 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h"
         * end;
 const 
# 17 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h" 3 4
      unsigned char
# 17 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h"
         * pos;
 
# 18 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h" 3 4
unsigned short 
# 18 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h"
     inc;
        
# 19 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h" 3 4
       unsigned int 
# 19 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h"
            options;
} vle_handle;

typedef struct {
 
# 23 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h" 3 4
unsigned int 
# 23 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h"
     value;
 
# 24 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h" 3 4
unsigned short 
# 24 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h"
     type;
} vle_field_t;
...
# 30 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h" 3 4
unsigned short 
# 30 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h"
     n;
 
# 31 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h" 3 4
unsigned short 
# 31 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h"
     size;
 
# 32 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h" 3 4
unsigned int 
# 32 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h"
     anal_op;
 int cond;
} vle_t;

int vle_init(vle_handle* handle, const 
# 36 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h" 3 4
                                      unsigned char
# 36 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h"
                                         * buffer, const 
# 36 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h" 3 4
                                                         unsigned int 
# 36 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h"
...
# 38 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h" 3 4
                                  unsigned int 
# 38 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h"
                                       option);
void vle_free(vle_t* instr);
void vle_snprint(char* str, int size, 
# 40 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h" 3 4
                                     unsigned int 
# 40 "project/radare2/libr/asm/p/../arch/ppc/libvle/vle.h"
                                          addr, vle_t* instr);
# 7 "project/radare2/libr/asm/p/asm_ppc_cs.c" 2
# 1 "project/radare2/libr/asm/p/../arch/ppc/libps/libps.h" 1
...
# 8 "project/radare2/libr/asm/p/../arch/ppc/libps/libps.h" 3 4
   unsigned int 
# 8 "project/radare2/libr/asm/p/../arch/ppc/libps/libps.h"
        value;
    
# 9 "project/radare2/libr/asm/p/../arch/ppc/libps/libps.h" 3 4
   unsigned short 
# 9 "project/radare2/libr/asm/p/../arch/ppc/libps/libps.h"
        type;
} ppcps_field_t;
...
# 17 "project/radare2/libr/asm/p/../arch/ppc/libps/libps.h" 3 4
   unsigned int 
# 17 "project/radare2/libr/asm/p/../arch/ppc/libps/libps.h"
        anal_op;
} ppcps_t;


# 20 "project/radare2/libr/asm/p/../arch/ppc/libps/libps.h" 3 4
_Bool 
# 20 "project/radare2/libr/asm/p/../arch/ppc/libps/libps.h"
    libps_decode(
# 20 "project/radare2/libr/asm/p/../arch/ppc/libps/libps.h" 3 4
                 unsigned int 
# 20 "project/radare2/libr/asm/p/../arch/ppc/libps/libps.h"
                      data, ppcps_t* ps);
void libps_snprint(char* str, int size, 
# 21 "project/radare2/libr/asm/p/../arch/ppc/libps/libps.h" 3 4
                                       unsigned long long 
# 21 "project/radare2/libr/asm/p/../arch/ppc/libps/libps.h"
                                            addr, ppcps_t* instr);
# 8 "project/radare2/libr/asm/p/asm_ppc_cs.c" 2

static csh handle = 0;

static 
# 11 "project/radare2/libr/asm/p/asm_ppc_cs.c" 3 4
      _Bool 
# 11 "project/radare2/libr/asm/p/asm_ppc_cs.c"
           the_end(void *p) {
 if (handle) {
  cs_close (&handle);
  handle = 0;
 ...
 return 
# 16 "project/radare2/libr/asm/p/asm_ppc_cs.c" 3 4
       1
# 16 "project/radare2/libr/asm/p/asm_ppc_cs.c"
           ;
}

static int decompile_vle(RAsm *a, RAsmOp *op, const 
# 19 "project/radare2/libr/asm/p/asm_ppc_cs.c" 3 4
                                                   unsigned char 
# 19 "project/radare2/libr/asm/p/asm_ppc_cs.c"
                                                       *buf, int len) {
 vle_t* instr = 0;
 vle_handle handle = {0};
 if (len < 2) {
...
static int decompile_ps(RAsm *a, RAsmOp *op, const 
# 39 "project/radare2/libr/asm/p/asm_ppc_cs.c" 3 4
                                                  unsigned char 
# 39 "project/radare2/libr/asm/p/asm_ppc_cs.c"
                                                      *buf, int len) {
 ppcps_t instr = {0};
 if (len < 4) {
  return -1;
 ...
 op->size = 4;
 const 
# 45 "project/radare2/libr/asm/p/asm_ppc_cs.c" 3 4
      unsigned int 
# 45 "project/radare2/libr/asm/p/asm_ppc_cs.c"
...
# 56 "project/radare2/libr/asm/p/asm_ppc_cs.c" 3 4
                                                 unsigned char 
# 56 "project/radare2/libr/asm/p/asm_ppc_cs.c"
                                                     *buf, int len) {
 static int omode = -1, obits = -1;
 int n, ret;
 
# 59 "project/radare2/libr/asm/p/asm_ppc_cs.c" 3 4
unsigned long long 
# 59 "project/radare2/libr/asm/p/asm_ppc_cs.c"
     off = a->pc;
 cs_insn* insn;
...
# 97 "project/radare2/libr/asm/p/asm_ppc_cs.c" 3 4
                              unsigned char
# 97 "project/radare2/libr/asm/p/asm_ppc_cs.c"
                                 *) buf, len, off, 1, &insn);
 op->size = 4;
 if (n > 0 && insn->size > 0) {
...
RAsmPlugin r_asm_plugin_ppc_cs = {
 .name = "ppc",
 .desc = "Capstone ""v4"" PowerPC disassembler",
 .license = "BSD",
 .author = "pancake",
 .arch = "ppc",
 .cpus = "ppc,vle,ps",
 .bits = 32 | 64,
 .endian = 
# 120 "project/radare2/libr/asm/p/asm_ppc_cs.c" 3 4
          1 
# 120 "project/radare2/libr/asm/p/asm_ppc_cs.c"
                              | 
# 120 "project/radare2/libr/asm/p/asm_ppc_cs.c" 3 4
                                2
# 120 "project/radare2/libr/asm/p/asm_ppc_cs.c"
...
# 126 "project/radare2/libr/asm/p/asm_ppc_cs.c" 3 4
__attribute__((visibility("default"))) 
# 126 "project/radare2/libr/asm/p/asm_ppc_cs.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_ppc_cs,
 .version = 
# 129 "project/radare2/libr/asm/p/asm_ppc_cs.c" 3 4
           "5.5.4"

# 130 "project/radare2/libr/asm/p/asm_ppc_cs.c"
};
