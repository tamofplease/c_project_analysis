# 0 "project/radare2/libr/asm/p/asm_ebc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/p/asm_ebc.c"
...
# 4 "project/radare2/libr/asm/p/asm_ebc.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_ebc.c" 2
...
typedef int RRef;
# 6 "project/radare2/libr/asm/p/asm_ebc.c" 2
...
# 7 "project/radare2/libr/asm/p/asm_ebc.c" 2
...
# 8 "project/radare2/libr/asm/p/asm_ebc.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/ebc/ebc_disas.h" 1 3 4
# 26 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/ebc/ebc_disas.h" 3 4
enum ebc_opcodes {
 EBC_BREAK = 0x00,
 EBC_JMP = 0x01,
 EBC_JMP8 = 0x02,
...
# 9 "project/radare2/libr/asm/p/asm_ebc.c" 2


# 10 "project/radare2/libr/asm/p/asm_ebc.c"
static int disassemble(RAsm *a, RAsmOp *op, const 
# 10 "project/radare2/libr/asm/p/asm_ebc.c" 3 4
                                                 unsigned char 
# 10 "project/radare2/libr/asm/p/asm_ebc.c"
                                                     *buf, int len) {
...
RAsmPlugin r_asm_plugin_ebc = {
 ...
 .bits = 32|64,
 .endian = 
# 26 "project/radare2/libr/asm/p/asm_ebc.c" 3 4
          1
# 26 "project/radare2/libr/asm/p/asm_ebc.c"
                             ,
...
# 31 "project/radare2/libr/asm/p/asm_ebc.c" 3 4
__attribute__((visibility("default"))) 
# 31 "project/radare2/libr/asm/p/asm_ebc.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_ebc,
 .version = 
# 34 "project/radare2/libr/asm/p/asm_ebc.c" 3 4
           "5.5.4"

# 35 "project/radare2/libr/asm/p/asm_ebc.c"
};
