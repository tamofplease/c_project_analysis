# 0 "project/radare2/libr/asm/p/asm_m680x_cs.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/p/asm_m680x_cs.c"
...
# 4 "project/radare2/libr/asm/p/asm_m680x_cs.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_m680x_cs.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_m680x_cs.c" 2
# 15 "project/radare2/libr/asm/p/asm_m680x_cs.c"
...
static 
# 49 "project/radare2/libr/asm/p/asm_m680x_cs.c" 3 4
      _Bool 
# 49 "project/radare2/libr/asm/p/asm_m680x_cs.c"
           the_end(void *p) {
 if (cd) {
  cs_close (&cd);
  cd = 0;
 ...
 return 
# 54 "project/radare2/libr/asm/p/asm_m680x_cs.c" 3 4
       1
# 54 "project/radare2/libr/asm/p/asm_m680x_cs.c"
           ;
}

static int disassemble(RAsm *a, RAsmOp *op, const 
# 57 "project/radare2/libr/asm/p/asm_m680x_cs.c" 3 4
                                                 unsigned char 
# 57 "project/radare2/libr/asm/p/asm_m680x_cs.c"
                                                     *buf, int len) {
 static int omode = 0;
 int mode, n, ret;
 
# 60 "project/radare2/libr/asm/p/asm_m680x_cs.c" 3 4
unsigned long long 
# 60 "project/radare2/libr/asm/p/asm_m680x_cs.c"
     off = a->pc;
 cs_insn* insn = 
# 61 "project/radare2/libr/asm/p/asm_m680x_cs.c" 3 4
                ((void *)0)
# 61 "project/radare2/libr/asm/p/asm_m680x_cs.c"
                    ;
...
# 76 "project/radare2/libr/asm/p/asm_m680x_cs.c" 3 4
                          unsigned char
# 76 "project/radare2/libr/asm/p/asm_m680x_cs.c"
                             *)buf, len, off, 1, &insn);
 if (n > 0) {
  if (insn->size > 0) {
   op->size = insn->size;
...
# 85 "project/radare2/libr/asm/p/asm_m680x_cs.c" 3 4
   __builtin___memmove_chk (
# 85 "project/radare2/libr/asm/p/asm_m680x_cs.c"
   ptrstr
# 85 "project/radare2/libr/asm/p/asm_m680x_cs.c" 3 4
   , 
# 85 "project/radare2/libr/asm/p/asm_m680x_cs.c"
...
RAsmPlugin r_asm_plugin_m680x_cs = {
 ...
 .desc = "Capstone ""v4"" M680X Disassembler",
 .license = "BSD",
 .arch = "m680x",
 .bits = 8|32,
 .endian = 
# 101 "project/radare2/libr/asm/p/asm_m680x_cs.c" 3 4
          1
# 101 "project/radare2/libr/asm/p/asm_m680x_cs.c"
                             ,
 .fini = the_end,
 .disassemble = &disassemble,
};
# 117 "project/radare2/libr/asm/p/asm_m680x_cs.c"

# 117 "project/radare2/libr/asm/p/asm_m680x_cs.c" 3 4
__attribute__((visibility("default"))) 
# 117 "project/radare2/libr/asm/p/asm_m680x_cs.c"
 ...
 .version = 
# 120 "project/radare2/libr/asm/p/asm_m680x_cs.c" 3 4
           "5.5.4"

# 121 "project/radare2/libr/asm/p/asm_m680x_cs.c"
};
