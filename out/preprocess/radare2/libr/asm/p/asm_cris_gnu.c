# 0 "project/radare2/libr/asm/p/asm_cris_gnu.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/p/asm_cris_gnu.c"
# 12 "project/radare2/libr/asm/p/asm_cris_gnu.c"
...
# 15 "project/radare2/libr/asm/p/asm_cris_gnu.c" 2
...
typedef int RRef;
# 17 "project/radare2/libr/asm/p/asm_cris_gnu.c" 2
...
# 18 "project/radare2/libr/asm/p/asm_cris_gnu.c" 2
...
# 19 "project/radare2/libr/asm/p/asm_cris_gnu.c" 2
...
# 20 "project/radare2/libr/asm/p/asm_cris_gnu.c" 2
...
# 22 "project/radare2/libr/asm/p/asm_cris_gnu.c" 2



# 24 "project/radare2/libr/asm/p/asm_cris_gnu.c"
static unsigned long Offset = 0;
static RStrBuf *buf_global = 
# 25 "project/radare2/libr/asm/p/asm_cris_gnu.c" 3 4
                            ((void *)0)
# 25 "project/radare2/libr/asm/p/asm_cris_gnu.c"
                                ;
static unsigned char bytes[8];

static int cris_buffer_read_memory (bfd_vma memaddr, bfd_byte *myaddr, 
# 28 "project/radare2/libr/asm/p/asm_cris_gnu.c" 3 4
                                                                      unsigned int 
# 28 "project/radare2/libr/asm/p/asm_cris_gnu.c"
...
# 36 "project/radare2/libr/asm/p/asm_cris_gnu.c" 3 4
__builtin___memcpy_chk (
# 36 "project/radare2/libr/asm/p/asm_cris_gnu.c"
myaddr
# 36 "project/radare2/libr/asm/p/asm_cris_gnu.c" 3 4
, 
# 36 "project/radare2/libr/asm/p/asm_cris_gnu.c"
...
# 48 "project/radare2/libr/asm/p/asm_cris_gnu.c" 3 4
...
# 51 "project/radare2/libr/asm/p/asm_cris_gnu.c"
...
# 61 "project/radare2/libr/asm/p/asm_cris_gnu.c" 3 4
                                                 unsigned char 
# 61 "project/radare2/libr/asm/p/asm_cris_gnu.c"
                                                     *buf, int len) {
...
# 69 "project/radare2/libr/asm/p/asm_cris_gnu.c" 3 4
__builtin___memcpy_chk (
# 69 "project/radare2/libr/asm/p/asm_cris_gnu.c"
bytes
# 69 "project/radare2/libr/asm/p/asm_cris_gnu.c" 3 4
, 
# 69 "project/radare2/libr/asm/p/asm_cris_gnu.c"
...
# 72 "project/radare2/libr/asm/p/asm_cris_gnu.c" 3 4
__builtin___memset_chk (
# 72 "project/radare2/libr/asm/p/asm_cris_gnu.c"
&disasm_obj
# 72 "project/radare2/libr/asm/p/asm_cris_gnu.c" 3 4
, 
# 72 "project/radare2/libr/asm/p/asm_cris_gnu.c"
...
# 72 "project/radare2/libr/asm/p/asm_cris_gnu.c"
 ...
 disasm_obj.stream = 
# 81 "project/radare2/libr/asm/p/asm_cris_gnu.c" 3 4
                    __stdoutp
# 81 "project/radare2/libr/asm/p/asm_cris_gnu.c"
                          ;
...
RAsmPlugin r_asm_plugin_cris_gnu = {
 ...
 .bits = 32,
 .endian = 
# 137 "project/radare2/libr/asm/p/asm_cris_gnu.c" 3 4
          1
# 137 "project/radare2/libr/asm/p/asm_cris_gnu.c"
                             ,
...
# 143 "project/radare2/libr/asm/p/asm_cris_gnu.c" 3 4
__attribute__((visibility("default"))) 
# 143 "project/radare2/libr/asm/p/asm_cris_gnu.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_cris_gnu,
 .version = 
# 146 "project/radare2/libr/asm/p/asm_cris_gnu.c" 3 4
           "5.5.4"

# 147 "project/radare2/libr/asm/p/asm_cris_gnu.c"
};
