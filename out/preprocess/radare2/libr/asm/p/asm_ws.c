# 0 "project/radare2/libr/asm/p/asm_ws.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/p/asm_ws.c"
...
typedef int RRef;
# 4 "project/radare2/libr/asm/p/asm_ws.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_ws.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_ws.c" 2
...
# 7 "project/radare2/libr/asm/p/asm_ws.c" 2

# 1 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c" 1
# 11 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c"
...
# 22 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c" 3 4
                                   unsigned char 
# 22 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c"
                                       *buf, int len) {
 if (len < 1) {
  return WS_OP_UNK;
 }
...
# 34 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c" 3 4
                                  unsigned char 
# 34 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c"
                                      *buf, int len) {
 if (len < 1) {
  return WS_OP_UNK;
 }
...
# 46 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c" 3 4
                              unsigned char 
# 46 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c"
                                  *buf, int len) {
 const 
# 47 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c" 3 4
      unsigned char 
# 47 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c"
          *ptr;
...
static const 
# 58 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c" 3 4
            unsigned char 
# 58 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c"
...
# 58 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c"
                                             *buf, int len) {
 const 
# 59 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c" 3 4
      unsigned char 
# 59 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c"
          *ret;
 ret = buf;
 while (len - (ret - buf)) {
  switch (*ret) {
 ...
 return 
# 70 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c" 3 4
       ((void *)0)
# 70 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c"
           ;
}

static 
# 73 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c" 3 4
      int 
# 73 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c"
           get_ws_val(const 
# 73 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c" 3 4
                            unsigned char 
# 73 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c"
...
# 74 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c" 3 4
unsigned char 
# 74 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c"
    sig;
 int i, ret = 0;
 const 
# 76 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c" 3 4
      unsigned char 
# 76 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c"
...
# 95 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c" 3 4
                                    unsigned char 
# 95 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c"
                                        *buf, 
# 95 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c" 3 4
                                              unsigned char 
# 95 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c"
                                                  token, int len) {
 const 
# 96 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c" 3 4
      unsigned char 
# 96 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c"
...
# 106 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c" 3 4
                                  unsigned char 
# 106 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c"
                                      *buf, int len) {
 const char *buf_asm = 
# 107 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c" 3 4
                      ((void *)0)
# 107 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c"
                          ;
 const 
# 108 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c" 3 4
      unsigned char 
# 108 "project/radare2/libr/asm/p/../arch/whitespace/wsdis.c"
          *ptr = buf;
...
# 9 "project/radare2/libr/asm/p/asm_ws.c" 2

static int disassemble(RAsm *a, RAsmOp *op, const 
# 10 "project/radare2/libr/asm/p/asm_ws.c" 3 4
                                                 unsigned char 
# 10 "project/radare2/libr/asm/p/asm_ws.c"
                                                     *buf, int len) {
...
RAsmPlugin r_asm_plugin_ws = {
 ...
 .bits = 32,
 .endian = 
# 20 "project/radare2/libr/asm/p/asm_ws.c" 3 4
          0
# 20 "project/radare2/libr/asm/p/asm_ws.c"
                           ,
...
# 25 "project/radare2/libr/asm/p/asm_ws.c" 3 4
__attribute__((visibility("default"))) 
# 25 "project/radare2/libr/asm/p/asm_ws.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_ws,
 .version = 
# 28 "project/radare2/libr/asm/p/asm_ws.c" 3 4
           "5.5.4"

# 29 "project/radare2/libr/asm/p/asm_ws.c"
};
