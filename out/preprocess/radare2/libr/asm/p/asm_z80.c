# 0 "project/radare2/libr/asm/p/asm_z80.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/p/asm_z80.c"
...
typedef int RRef;
# 4 "project/radare2/libr/asm/p/asm_z80.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_z80.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_z80.c" 2
...
# 7 "project/radare2/libr/asm/p/asm_z80.c" 2

# 1 "project/radare2/libr/asm/p/../arch/z80/z80.c" 1
# 9 "project/radare2/libr/asm/p/../arch/z80/z80.c"
# 1 "project/radare2/libr/asm/p/../arch/z80/z80_tab.h" 1
# 11 "project/radare2/libr/asm/p/../arch/z80/z80_tab.h"
...
static 
# 28 "project/radare2/libr/asm/p/../arch/z80/z80_tab.h" 3 4
      unsigned char 
# 28 "project/radare2/libr/asm/p/../arch/z80/z80_tab.h"
...
static 
# 147 "project/radare2/libr/asm/p/../arch/z80/z80_tab.h" 3 4
      unsigned char 
# 147 "project/radare2/libr/asm/p/../arch/z80/z80_tab.h"
...
# 10 "project/radare2/libr/asm/p/../arch/z80/z80.c" 2

static 
# 11 "project/radare2/libr/asm/p/../arch/z80/z80.c" 3 4
      unsigned char 
# 11 "project/radare2/libr/asm/p/../arch/z80/z80.c"
          z80_op_24_branch_index_res (
# 11 "project/radare2/libr/asm/p/../arch/z80/z80.c" 3 4
                                      unsigned char 
# 11 "project/radare2/libr/asm/p/../arch/z80/z80.c"
                                          hex) {
...
static int z80OpLength (const 
# 28 "project/radare2/libr/asm/p/../arch/z80/z80.c" 3 4
                             unsigned char 
# 28 "project/radare2/libr/asm/p/../arch/z80/z80.c"
                                 *buf, int len) {
 const z80_opcode *op;
 int type = 0, ret = 0;
 if (len < 1) {
 ...
 if ((type & Z80_ARG8) && !(type & Z80_ARG16)) {
  ret++;
 }
 if (type & Z80_OP16) {
  ret += 2;
...
# 71 "project/radare2/libr/asm/p/../arch/z80/z80.c" 3 4
__attribute__((used)) 
# 71 "project/radare2/libr/asm/p/../arch/z80/z80.c"
              static int z80Disass (RAsmOp *op, const 
# 71 "project/radare2/libr/asm/p/../arch/z80/z80.c" 3 4
                                                      unsigned char 
# 71 "project/radare2/libr/asm/p/../arch/z80/z80.c"
                                                          *buf, int len) {
...
# 75 "project/radare2/libr/asm/p/../arch/z80/z80.c" 3 4
unsigned char 
# 75 "project/radare2/libr/asm/p/../arch/z80/z80.c"
    res;
 if (!ret) {
  return ret;
 }
...
# 9 "project/radare2/libr/asm/p/asm_z80.c" 2
# 1 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 1
# 26 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
# 1 "project/radare2/libr/asm/p/../arch/z80/z80asm.h" 1
# 28 "project/radare2/libr/asm/p/../arch/z80/z80asm.h"
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/errno.h" 1 3 4
# 29 "project/radare2/libr/asm/p/../arch/z80/z80asm.h" 2
# 43 "project/radare2/libr/asm/p/../arch/z80/z80asm.h"
enum mnemonic
{
...
# 27 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 2
...
# 1 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 1
# 38 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
...
rd_number (const char **p, const char **endp, int base)
{
  ...
  if (verbose >= 6)
    fprintf (
# 47 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 47 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
  ...
  while (**p && (c = strchr (num, tolower ((const unsigned char)**p))))
    {
      ...
      if (verbose >= 7)
 fprintf (
# 55 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
         __stderrp
# 55 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
  ...
  *p = delspc (*p);
  if (verbose >= 7)
    fprintf (
# 64 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 64 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
...
rd_otherbasenumber (const char **p, int *valid, int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 74 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 74 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
                  ,
 ...
 *valid = 0;
 ...
 printerr (1, "base must be between 1 and z\n");
  ...
  if (isalpha ((const unsigned char)**p))
    return rd_number (p, 0, tolower ((unsigned char)c) - 'a' + 1);
  return rd_number (p, 0, c - '0' + 1);
}
...
rd_character (const char **p, int *valid, int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 106 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 106 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
                  ,
 ...
 *valid = 0;
  ...
  *valid = 0;
  ...
  if (verbose >= 7)
    fprintf (
# 179 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 179 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
   ...
   if (!l->ref->done)
     {
       ...
       if (verbose >= 6)
  fprintf (
# 226 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
          __stderrp
# 226 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
                ,
   ...
   int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 252 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 252 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
 ...
 break;
  ...
  if (s < 0)
   ...
   if (verbose >= 7)
     fprintf (
# 270 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
             __stderrp
# 270 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
  ...
  if (verbose >= 7)
    fprintf (
# 276 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 276 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
...
rd_value (const char **p, int *valid, int level, int *check, int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 286 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 286 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
 ...
 {
   (*p) += 2;
   return not ^ (sign * rd_number (p, 0, 0x10));
 }
      base = 8;
 ...
 *p = p2;
    ...
    case '%':
      (*p)++;
      return not ^ (sign * rd_number (p, 0, 2));
    case '\'':
    case '"':
      quote = **p;
      ++*p;
 ...
 ++*p;
 return not ^ (sign * rd_number (p, 0, base));
      }
    default:
      {
 int value;
 exist = 1;
 value = rd_label (p, valid ? &exist : 0, 0, level, print_errors);
 if (!exist)
   *valid = 0;
...
rd_factor (const char **p, int *valid, int level, int *check, int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 449 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 449 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
      ...
      else if (**p == '/')
 {
  ...
  if (verbose >= 7)
    fprintf (
# 474 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 474 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
...
rd_term (const char **p, int *valid, int level, int *check, int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 485 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 485 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
      ...
      else if (**p == '-')
 {
  ...
  if (verbose >= 7)
    fprintf (
# 505 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 505 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
        ...
        int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 516 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 516 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
      ...
      else if (**p == '>')
 {
  ...
  if (verbose >= 7)
    fprintf (
# 536 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 536 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
   ...
   int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 547 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 547 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
  ...
  *p = delspc (*p);
  ...
  if (verbose >= 7)
    fprintf (
# 577 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 577 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
                  , "%5d (0x%04x): rd_shift returned %d (%04x).\n",
      stack[sp].line, addr, result, result);
  return result;
}
        ...
        int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 588 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 588 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
 ...
 ++ * p;
  ...
  if (verbose >= 7)
    fprintf (
# 607 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 607 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
      ...
      int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 618 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 618 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
  ...
  *p = delspc (*p);
  ...
  if (verbose >= 7)
    fprintf (
# 629 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 629 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
      ...
      int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 640 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 640 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
                  , "%5d (0x%04x): Starting to read xor expression "
      "(string=%s).\n", stack[sp].line, addr, *p);
  result = rd_expr_and (p, valid, level, check, print_errors);
  if (verbose >= 7)
    fprintf (
# 644 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 644 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
  ...
  *p = delspc (*p);
  ...
  if (verbose >= 7)
    fprintf (
# 654 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 654 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
     ...
     int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 665 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 665 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
                  , "%5d (0x%04x): Starting to read or expression "
      "(string=%s).\n", stack[sp].line, addr, *p);
  result = rd_expr_xor (p, valid, level, check, print_errors);
  if (verbose >= 7)
    fprintf (
# 669 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 669 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
  ...
  *p = delspc (*p);
  ...
  if (verbose >= 7)
    fprintf (
# 679 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 679 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
     ...
     int print_errors)
{
  ...
  if (verbose >= 6)
    fprintf (
# 691 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
            __stderrp
# 691 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
                  ,
 ...
 *valid = 0;
 ...
 printerr (1, "junk at end of expression: %s\n", *p);
  ...
  if (verbose >= 7)
    {
      fprintf (
# 736 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
              __stderrp
# 736 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
                    , "%5d (0x%04x): rd_expr returned %d (%04x).\n",
        stack[sp].line, addr, result, result);
      if (valid && !*valid)
 fprintf (
# 739 "project/radare2/libr/asm/p/../arch/z80/expressions.c" 3 4
         __stderrp
# 739 "project/radare2/libr/asm/p/../arch/z80/expressions.c"
...
# 92 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 2


static void printerr(int error, const char *fmt, ...) {
# 110 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
}
...
# 126 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
 fprintf(__stderrp,
# 126 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
...
# 155 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
  fprintf(__stderrp,
# 155 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
 ...
 for (i = 0; list[i]; i++) {
  ...
  while (*check) {
    ...
    *expr = input;
    ...
    rd_expr (&input, mem_delimiter, 0, sp, 0);
    had_expr = 1;
   } else if (*check == '+') {
    if (*input == '+' || *input == '-') {
     *expr = input;
...
# 232 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
 fprintf(__stderrp,
# 232 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
...
# 243 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
 fprintf(__stderrp,
# 243 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
...
# 387 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
 int i;
 const char *list[] = {
...
static int rd_rrxx(const char **p) {
 ...
 if (indexed == 0xdd) {
  return indx (p, listx, 1, 0);
 }
 if (indexed == 0xfd) {
  return indx (p, listy, 1, 0);
 }
 return indx (p, list, 1, 0);
}
...
# 732 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
  fprintf(__stderrp,
# 732 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
...
# 740 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
  fprintf(__stderrp,
# 740 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
  "illegal use of index registers\n"
# 740 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
  )
# 740 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
...
# 860 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
    fprintf(__stderrp,
# 860 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
...
# 1404 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
    fprintf(__stderrp,
# 1404 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
    "parse error before: %s\n", ptr
# 1404 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
    )
# 1404 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
  ...
  case Z80_DM:
   ...
   while (1) {
    ...
    if (have_quote) {
     ...
     ++ptr;
     while (*ptr != quote) {
      obuf[obuflen++] = rd_character (&ptr, 0, 1);
      if (*ptr == 0) {
       
# 1435 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
      fprintf(__stderrp,
# 1435 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
...
# 1450 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
    fprintf(__stderrp,
# 1450 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
...
# 1458 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
   fprintf(__stderrp,
# 1458 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
...
# 1468 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
    fprintf(__stderrp,
# 1468 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
...
# 1468 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
  ...
  case Z80_DEFS:
  case Z80_DS:
   r = rd_expr (&ptr, ',', 0, sp, 1);
   if (r < 0) {
    
# 1476 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
   fprintf(__stderrp,
# 1476 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
   "ds should have its first argument >=0" " (not -0x%x)\n", -r
# 1476 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
   )
                           
# 1477 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
                          ;
    break;
   }
   ptr = delspc (ptr);
  ...
  case Z80_END:
   break;
  case Z80_ORG:
   addr = rd_expr (&ptr, '\0', 0, sp, 1) & 0xffff;
   break;
  case Z80_IF:
   break;
  case Z80_ELSE:
   
# 1500 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
  fprintf(__stderrp,
# 1500 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
  "else without if\n"
# 1500 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
  )
# 1500 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
...
# 1503 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
  fprintf(__stderrp,
# 1503 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
  "endif without if\n"
# 1503 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
  )
# 1503 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
...
# 1507 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
   fprintf(__stderrp,
# 1507 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
...
# 1511 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
  fprintf(__stderrp,
# 1511 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
  "seek error\n"
# 1511 "project/radare2/libr/asm/p/../arch/z80/z80asm.c" 3 4
  )
# 1511 "project/radare2/libr/asm/p/../arch/z80/z80asm.c"
...
# 10 "project/radare2/libr/asm/p/asm_z80.c" 2

static int do_disassemble(RAsm *a, RAsmOp *op, const 
# 11 "project/radare2/libr/asm/p/asm_z80.c" 3 4
                                                    unsigned char 
# 11 "project/radare2/libr/asm/p/asm_z80.c"
                                                        *buf, int len) {
 return op->size = z80Disass (op, buf, len);
}

static int do_assemble(RAsm *a, RAsmOp *op, const char *buf) {
 return op->size = z80asm ((
# 16 "project/radare2/libr/asm/p/asm_z80.c" 3 4
                           unsigned char
# 16 "project/radare2/libr/asm/p/asm_z80.c"
                              *)r_strbuf_get (&op->buf), buf);
}
...
RAsmPlugin r_asm_plugin_z80 = {
 ...
 .bits = 8,
 .endian = 
# 26 "project/radare2/libr/asm/p/asm_z80.c" 3 4
          0
# 26 "project/radare2/libr/asm/p/asm_z80.c"
                           ,
...
# 32 "project/radare2/libr/asm/p/asm_z80.c" 3 4
__attribute__((visibility("default"))) 
# 32 "project/radare2/libr/asm/p/asm_z80.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_z80,
 .version = 
# 35 "project/radare2/libr/asm/p/asm_z80.c" 3 4
           "5.5.4"

# 36 "project/radare2/libr/asm/p/asm_z80.c"
};
