# 0 "project/radare2/libr/asm/p/asm_xcore_cs.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/asm/p/asm_xcore_cs.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_xcore_cs.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_xcore_cs.c" 2


# 7 "project/radare2/libr/asm/p/asm_xcore_cs.c"
static int disassemble(RAsm *a, RAsmOp *op, const 
# 7 "project/radare2/libr/asm/p/asm_xcore_cs.c" 3 4
                                                 unsigned char 
# 7 "project/radare2/libr/asm/p/asm_xcore_cs.c"
                                                     *buf, int len) {
 csh handle;
...
# 12 "project/radare2/libr/asm/p/asm_xcore_cs.c" 3 4
__builtin___memset_chk (
# 12 "project/radare2/libr/asm/p/asm_xcore_cs.c"
op
# 12 "project/radare2/libr/asm/p/asm_xcore_cs.c" 3 4
, 
# 12 "project/radare2/libr/asm/p/asm_xcore_cs.c"
...
# 12 "project/radare2/libr/asm/p/asm_xcore_cs.c"
 ...
 n = cs_disasm (handle, (
# 19 "project/radare2/libr/asm/p/asm_xcore_cs.c" 3 4
                        unsigned char
# 19 "project/radare2/libr/asm/p/asm_xcore_cs.c"
                           *)buf, len, a->pc, 1, &insn);
 if (n < 1) {
...
RAsmPlugin r_asm_plugin_xcore_cs = {
 .name = "xcore",
 .desc = "Capstone ""v4"" XCore disassembler",
 .license = "BSD",
 .author = "pancake",
 .arch = "xcore",
 .bits = 32,
 .endian = 
# 49 "project/radare2/libr/asm/p/asm_xcore_cs.c" 3 4
          1 
# 49 "project/radare2/libr/asm/p/asm_xcore_cs.c"
                              | 
# 49 "project/radare2/libr/asm/p/asm_xcore_cs.c" 3 4
                                2
# 49 "project/radare2/libr/asm/p/asm_xcore_cs.c"
...
# 54 "project/radare2/libr/asm/p/asm_xcore_cs.c" 3 4
__attribute__((visibility("default"))) 
# 54 "project/radare2/libr/asm/p/asm_xcore_cs.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_xcore_cs,
 .version = 
# 57 "project/radare2/libr/asm/p/asm_xcore_cs.c" 3 4
           "5.5.4"

# 58 "project/radare2/libr/asm/p/asm_xcore_cs.c"
};
