# 0 "project/radare2/libr/asm/p/asm_bf.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/p/asm_bf.c"
...
# 4 "project/radare2/libr/asm/p/asm_bf.c" 2


# 5 "project/radare2/libr/asm/p/asm_bf.c"
static int disassemble(RAsm *a, RAsmOp *op, const 
# 5 "project/radare2/libr/asm/p/asm_bf.c" 3 4
                                                 unsigned char 
# 5 "project/radare2/libr/asm/p/asm_bf.c"
                                                     *buf, int len) {
 const 
# 6 "project/radare2/libr/asm/p/asm_bf.c" 3 4
      unsigned char 
# 6 "project/radare2/libr/asm/p/asm_bf.c"
          *b;
 size_t rep = 1;
...
static 
# 61 "project/radare2/libr/asm/p/asm_bf.c" 3 4
      _Bool 
# 61 "project/radare2/libr/asm/p/asm_bf.c"
           _write_asm(RAsmOp *op, int value, int n) {
 
# 62 "project/radare2/libr/asm/p/asm_bf.c" 3 4
unsigned char 
# 62 "project/radare2/libr/asm/p/asm_bf.c"
    *opbuf = malloc (n);
 if (opbuf == 
# 63 "project/radare2/libr/asm/p/asm_bf.c" 3 4
             ((void *)0)
# 63 "project/radare2/libr/asm/p/asm_bf.c"
                 ) {
  return 
# 64 "project/radare2/libr/asm/p/asm_bf.c" 3 4
        1
# 64 "project/radare2/libr/asm/p/asm_bf.c"
            ;
 }
 
# 66 "project/radare2/libr/asm/p/asm_bf.c" 3 4
__builtin___memset_chk (
# 66 "project/radare2/libr/asm/p/asm_bf.c"
opbuf
# 66 "project/radare2/libr/asm/p/asm_bf.c" 3 4
, 
# 66 "project/radare2/libr/asm/p/asm_bf.c"
...
# 66 "project/radare2/libr/asm/p/asm_bf.c"
 ...
 free (opbuf);
 return 
# 69 "project/radare2/libr/asm/p/asm_bf.c" 3 4
       0
# 69 "project/radare2/libr/asm/p/asm_bf.c"
            ;
}
...
# 79 "project/radare2/libr/asm/p/asm_bf.c" 3 4
_Bool 
# 79 "project/radare2/libr/asm/p/asm_bf.c"
     write_err = 
# 79 "project/radare2/libr/asm/p/asm_bf.c" 3 4
                 0
# 79 "project/radare2/libr/asm/p/asm_bf.c"
...
RAsmPlugin r_asm_plugin_bf = {
 ...
 .bits = 16 | 32 | 64,
 .endian = 
# 129 "project/radare2/libr/asm/p/asm_bf.c" 3 4
          0
# 129 "project/radare2/libr/asm/p/asm_bf.c"
                           ,
 .desc = "Brainfuck",
...
# 136 "project/radare2/libr/asm/p/asm_bf.c" 3 4
__attribute__((visibility("default"))) 
# 136 "project/radare2/libr/asm/p/asm_bf.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_bf,
 .version = 
# 139 "project/radare2/libr/asm/p/asm_bf.c" 3 4
           "5.5.4"

# 140 "project/radare2/libr/asm/p/asm_bf.c"
};
