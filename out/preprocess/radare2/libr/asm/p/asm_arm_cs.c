# 0 "project/radare2/libr/asm/p/asm_arm_cs.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/p/asm_arm_cs.c"
...
# 4 "project/radare2/libr/asm/p/asm_arm_cs.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_arm_cs.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_arm_cs.c" 2
# 1 "project/radare2/libr/asm/p/cs_version.h" 1
...
# 5 "project/radare2/libr/asm/p/cs_version.h" 2
# 7 "project/radare2/libr/asm/p/asm_arm_cs.c" 2
# 1 "project/radare2/libr/asm/p/../arch/arm/asm-arm.h" 1
...
# 6 "project/radare2/libr/asm/p/../arch/arm/asm-arm.h"
int armass_assemble(const char *str, 
# 6 "project/radare2/libr/asm/p/../arch/arm/asm-arm.h" 3 4
                                    unsigned long long 
# 6 "project/radare2/libr/asm/p/../arch/arm/asm-arm.h"
                                         off, int thumb);
# 8 "project/radare2/libr/asm/p/asm_arm_cs.c" 2
# 1 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 1
static char *hack_handle_dp_imm(
# 1 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
                               unsigned int 
# 1 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
                                    insn) {
 char *buf_asm = 
# 2 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
                ((void *)0)
# 2 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
                    ;
 char *mnemonic = 
# 3 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
                 ((void *)0)
# 3 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
                     ;
 const 
# 4 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
      unsigned char 
# 4 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
          op0 = (insn >> 23) & 0x7;


 if (op0 == 3) {
  const 
# 8 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
       _Bool 
# 8 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
            sf = (insn >> 31) & 0x1;
  const 
# 9 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
       _Bool 
# 9 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
            op = (insn >> 30) & 0x1;
  const 
# 10 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
       _Bool 
# 10 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
            S = (insn >> 29) & 0x1;
  const 
# 11 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
       _Bool 
# 11 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
            o2 = (insn >> 22) & 0x1;
  if (sf && !S && !o2) {
   if (op) {
    mnemonic = "subg";
  ...
  if (mnemonic) {
   const 
# 20 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
        unsigned char 
# 20 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
            uimm6 = ((insn >> 16) & 0x3f) << 4;
   const 
# 21 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
        unsigned char 
# 21 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
            uimm4 = (insn >> 10) & 0xf;
   const 
# 22 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
        unsigned char 
# 22 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
            Xn = (insn >> 5) & 0x1f;
   const 
# 23 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
        unsigned char 
# 23 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
            Xd = (insn >> 0) & 0x1f;
 ...
 return 
# 30 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
       ((void *)0)
# 30 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
           ;
}

static char *hack_handle_br_exc_sys(
# 33 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
                                   unsigned int 
# 33 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
                                        insn) {
 char *buf_asm = 
# 34 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
                ((void *)0)
# 34 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
                    ;
 const char *mnemonic = "bti";
 const 
# 36 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
      unsigned char 
# 36 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
          op0 = (insn >> 29) & 0x7;
 const 
# 37 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
      unsigned short 
# 37 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
           op1 = (insn >> 12) & 0x3fff;
 
# 38 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
unsigned char 
# 38 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
    op2 = insn & 0x1f;


 if (op0 == 6 && op1 == 4146 && op2 == 31) {
  const 
# 42 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
       unsigned char 
# 42 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
           CRm = (insn >> 8) & 0xf;
  op2 = (insn >> 5) & 0x7;
  if (CRm == 4 && (op2 & 1) == 0) {
   switch (op2) {
...
static char *hack_handle_dp_reg(
# 64 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
                               unsigned int 
# 64 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
                                    insn) {
 char *buf_asm = 
# 65 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
                ((void *)0)
# 65 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
                    ;
 char *mnemonic = 
# 66 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
                 ((void *)0)
# 66 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
                     ;
 const 
# 67 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
      _Bool 
# 67 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
           op0 = (insn >> 30) & 0x1;
 const 
# 68 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
      _Bool 
# 68 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
           op1 = (insn >> 28) & 0x1;
 const 
# 69 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
      unsigned char 
# 69 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
          op2 = (insn >> 21) & 0xf;


 if (!op0 && op1 && op2 == 6) {
  const 
# 73 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
       _Bool 
# 73 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
            sf = (insn >> 31) & 0x1;
  const 
# 74 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
       _Bool 
# 74 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
            S = (insn >> 29) & 0x1;
  const 
# 75 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
       unsigned char 
# 75 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
           opcode = (insn >> 10) & 0x1f;
  if (sf) {
   if (!S) {
    if (opcode == 4) {
  ...
  if (mnemonic) {
   const 
# 90 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
        unsigned char 
# 90 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
            Xm = (insn >> 16) & 0x1f;
   const 
# 91 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
        unsigned char 
# 91 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
            Xn = (insn >> 5) & 0x1f;
   const 
# 92 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
        unsigned char 
# 92 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
            Xd = (insn >> 0) & 0x1f;
 ...
 return 
# 106 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
       ((void *)0)
# 106 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
           ;
}

static char *hack_handle_ldst(
# 109 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
                             unsigned int 
# 109 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
                                  insn) {
 char *buf_asm = 
# 110 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
                ((void *)0)
# 110 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
                    ;
 char *mnemonic = 
# 111 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
                 ((void *)0)
# 111 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
                     ;
 
# 112 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
_Bool 
# 112 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
     ignore_imm9 = 
# 112 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
                   0
# 112 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
                        ;
 const 
# 113 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
      unsigned char 
# 113 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
          op0 = (insn >> 28) & 0xf;
 const 
# 114 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
      _Bool 
# 114 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
           op1 = (insn >> 26) & 0x1;
 
# 115 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
unsigned char 
# 115 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
    op2 = (insn >> 23) & 0x3;
 const 
# 116 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
      _Bool 
# 116 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
           op3 = (insn >> 21) & 0x1;


 if (op0 == 13 && !op1 && (op2 == 2 || op2 == 3) && op3) {
  const 
# 120 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
       unsigned char 
# 120 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
           opc = (insn >> 22) & 0x3;
  const 
# 121 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
       unsigned short 
# 121 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
            imm9 = ((insn >> 12) & 0x1ff) << 4;
  op2 = (insn >> 10) & 0x3;
  const 
# 123 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
       unsigned char 
# 123 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
           Xn = (insn >> 5) & 0x1f;
  const 
# 124 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
       unsigned char 
# 124 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
           Xt = (insn >> 0) & 0x1f;
  ...
  if (op2 > 0) {
   ...
   case 0:
    mnemonic = "stzgm";
    ignore_imm9 = 
# 162 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
                 1
# 162 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
                     ;
    break;
   case 1:
    mnemonic = "ldg";
   ...
   case 2:
    mnemonic = "stgm";
    ignore_imm9 = 
# 169 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
                 1
# 169 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
                     ;
    break;
   case 3:
    mnemonic = "ldgm";
    ignore_imm9 = 
# 173 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
                 1
# 173 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
                     ;
    break;
   }
   if (ignore_imm9) {
  ...
  const 
# 188 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
       unsigned char 
# 188 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
           opc = (insn >> 30) & 0x3;
  const 
# 189 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
       _Bool 
# 189 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
            V = (insn >> 26) & 0x1;
  const 
# 190 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
       _Bool 
# 190 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
            L = (insn >> 22) & 0x1;

  if (opc == 1 && !V && !L) {
   const 
# 193 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
        unsigned char 
# 193 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
            imm7 = ((insn >> 15) & 0x7f) << 4;
   const 
# 194 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
        unsigned char 
# 194 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
            Xt2 = (insn >> 10) & 0x1f;
   const 
# 195 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
        unsigned char 
# 195 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
            Xn = (insn >> 5) & 0x1f;
   const 
# 196 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
        unsigned char 
# 196 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
            Xt = (insn >> 0) & 0x1f;
   switch (op2) {
   case 1:
   ...
   default:
    return 
# 211 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
          ((void *)0)
# 211 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
              ;
   }
   buf_asm = r_str_replace (buf_asm, "x31", "sp", 1);
   return buf_asm;
 ...
 return 
# 217 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
       ((void *)0)
# 217 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
           ;
}

static int hackyArmAsm(RAsm *a, RAsmOp *op, const 
# 220 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
                                                 unsigned char 
# 220 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
                                                     *buf, int len) {
 char *buf_asm = 
# 221 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
                ((void *)0)
# 221 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
                    ;

 if (a->bits == 64 && len >= 4) {
  
# 224 "project/radare2/libr/asm/p/./asm_arm_hacks.inc" 3 4
 unsigned int 
# 224 "project/radare2/libr/asm/p/./asm_arm_hacks.inc"
...
# 9 "project/radare2/libr/asm/p/asm_arm_cs.c" 2


# 10 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
_Bool 
# 10 "project/radare2/libr/asm/p/asm_arm_cs.c"
    arm64ass(const char *str, 
# 10 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
                              unsigned long long 
# 10 "project/radare2/libr/asm/p/asm_arm_cs.c"
                                   addr, 
...
# 12 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
                         ((void *)0)
# 12 "project/radare2/libr/asm/p/asm_arm_cs.c"
                             ;
static HtUU *ht_it = 
# 13 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
                    ((void *)0)
# 13 "project/radare2/libr/asm/p/asm_arm_cs.c"
                        ;

# 1 "project/radare2/libr/asm/p/cs_mnemonics.c" 1
static char *mnemonics(RAsm *a, int id, 
# 1 "project/radare2/libr/asm/p/cs_mnemonics.c" 3 4
                                       _Bool 
# 1 "project/radare2/libr/asm/p/cs_mnemonics.c"
                                            json) {
 int i;
 a->cur->disassemble (a, 
# 3 "project/radare2/libr/asm/p/cs_mnemonics.c" 3 4
                        ((void *)0)
# 3 "project/radare2/libr/asm/p/cs_mnemonics.c"
                            , 
# 3 "project/radare2/libr/asm/p/cs_mnemonics.c" 3 4
                              ((void *)0)
# 3 "project/radare2/libr/asm/p/cs_mnemonics.c"
...
# 7 "project/radare2/libr/asm/p/cs_mnemonics.c" 3 4
                                                ((void *)0)
# 7 "project/radare2/libr/asm/p/cs_mnemonics.c"
                                                    ;
  }
  return name? strdup (name): 
# 9 "project/radare2/libr/asm/p/cs_mnemonics.c" 3 4
                             ((void *)0)
# 9 "project/radare2/libr/asm/p/cs_mnemonics.c"
                                 ;
 }
...
# 16 "project/radare2/libr/asm/p/asm_arm_cs.c" 2

static 
# 17 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
      _Bool 
# 17 "project/radare2/libr/asm/p/asm_arm_cs.c"
           check_features(RAsm *a, cs_insn *insn) {
 int i;
 if (!insn || !insn->detail) {
  return 
# 20 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
        1
# 20 "project/radare2/libr/asm/p/asm_arm_cs.c"
            ;
 }
 for (i = 0; i < insn->detail->groups_count; i++) {
  ...
  if (!name) {
   return 
# 37 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
         1
# 37 "project/radare2/libr/asm/p/asm_arm_cs.c"
             ;
  }
  if (!strstr (a->features, name)) {
   return 
# 40 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
         0
# 40 "project/radare2/libr/asm/p/asm_arm_cs.c"
              ;
  }
 }
 return 
# 43 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
       1
# 43 "project/radare2/libr/asm/p/asm_arm_cs.c"
           ;
}
...
# 102 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
_Bool 
# 102 "project/radare2/libr/asm/p/asm_arm_cs.c"
     found;
 
# 103 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
unsigned long long 
# 103 "project/radare2/libr/asm/p/asm_arm_cs.c"
...
# 112 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
                                                 unsigned char 
# 112 "project/radare2/libr/asm/p/asm_arm_cs.c"
                                                     *buf, int len) {
 static int omode = -1;
 static int obits = 32;
 
# 115 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
_Bool 
# 115 "project/radare2/libr/asm/p/asm_arm_cs.c"
     disp_hash = a->immdisp;
 cs_insn* insn = 
# 116 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
                ((void *)0)
# 116 "project/radare2/libr/asm/p/asm_arm_cs.c"
                    ;
 cs_mode mode = 0;
 int ret, n = 0;
 
# 119 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
_Bool 
# 119 "project/radare2/libr/asm/p/asm_arm_cs.c"
     found = 
# 119 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
             0
# 119 "project/radare2/libr/asm/p/asm_arm_cs.c"
...
# 120 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
unsigned long long 
# 120 "project/radare2/libr/asm/p/asm_arm_cs.c"
     itcond;
 ...
 n = cs_disasm (cd, buf, 
# 173 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
                        (((
# 173 "project/radare2/libr/asm/p/asm_arm_cs.c"
                        4
# 173 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
                        )>(
# 173 "project/radare2/libr/asm/p/asm_arm_cs.c"
...
# 201 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
  __builtin___memmove_chk ((
# 201 "project/radare2/libr/asm/p/asm_arm_cs.c"
  insn->mnemonic
# 201 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
  ), (
# 201 "project/radare2/libr/asm/p/asm_arm_cs.c"
...
static int assemble(RAsm *a, RAsmOp *op, const char *buf) {
 const 
# 226 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
      _Bool 
# 226 "project/radare2/libr/asm/p/asm_arm_cs.c"
           is_thumb = (a->bits == 16);
 int opsize;
 
# 228 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
unsigned int 
# 228 "project/radare2/libr/asm/p/asm_arm_cs.c"
     opcode;
 if (a->bits == 64) {
...
# 236 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
  fprintf(__stderrp,
# 236 "project/radare2/libr/asm/p/asm_arm_cs.c"
  "Error: ARM assembler only supports 16 or 32 bits\n"
# 236 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
  )
# 236 "project/radare2/libr/asm/p/asm_arm_cs.c"
                                                                ;
 ...
 if (opcode == 
# 240 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
              0xFFFFFFFFU
# 240 "project/radare2/libr/asm/p/asm_arm_cs.c"
                      ) {
  return -1;
 }
 
# 243 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
unsigned char 
# 243 "project/radare2/libr/asm/p/asm_arm_cs.c"
    opbuf[4];
 if (is_thumb) {
  ...
  if (opsize == 4) {
   if (a->big_endian) {
    ...
    r_write_le16 (opbuf + 2, opcode & 
# 250 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
                                     0xFFFFU
# 250 "project/radare2/libr/asm/p/asm_arm_cs.c"
                                             );
   } else {
   ...
   if (a->big_endian) {
    r_write_le16 (opbuf, opcode & 
# 256 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
                                 0xFFFFU
# 256 "project/radare2/libr/asm/p/asm_arm_cs.c"
                                         );
   } else {
    r_write_be16 (opbuf, opcode & 
# 258 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
                                 0xFFFFU
# 258 "project/radare2/libr/asm/p/asm_arm_cs.c"
                                         );
   }
  }
 } else {
...
static 
# 274 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
      _Bool 
# 274 "project/radare2/libr/asm/p/asm_arm_cs.c"
           init(void* user) {
 if (!ht_it) {
  ht_it = ht_uu_new0 ();
 }
...
static 
# 284 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
      _Bool 
# 284 "project/radare2/libr/asm/p/asm_arm_cs.c"
           fini(void* user) {
 ht_uu_free (ht_it);
 ht_uu_free (ht_itblock);
 ht_it = 
# 287 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
        ((void *)0)
# 287 "project/radare2/libr/asm/p/asm_arm_cs.c"
            ;
 ht_itblock = 
# 288 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
             ((void *)0)
# 288 "project/radare2/libr/asm/p/asm_arm_cs.c"
                 ;
 return 0;
}
...
RAsmPlugin r_asm_plugin_arm_cs = {
 .name = "arm",
 .desc = "Capstone ""v4"" ARM disassembler",
 .cpus = ",v8,cortex",
 .features = "v8",
 .license = "BSD",
 .arch = "arm",
 .bits = 16 | 32 | 64,
 .endian = 
# 300 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
          1 
# 300 "project/radare2/libr/asm/p/asm_arm_cs.c"
                              | 
# 300 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
                                2
# 300 "project/radare2/libr/asm/p/asm_arm_cs.c"
...
# 317 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
__attribute__((visibility("default"))) 
# 317 "project/radare2/libr/asm/p/asm_arm_cs.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_arm_cs,
 .version = 
# 320 "project/radare2/libr/asm/p/asm_arm_cs.c" 3 4
           "5.5.4"

# 321 "project/radare2/libr/asm/p/asm_arm_cs.c"
};
