# 0 "project/radare2/libr/asm/p/asm_mcs96.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/p/asm_mcs96.c"
...
typedef int RRef;
# 4 "project/radare2/libr/asm/p/asm_mcs96.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_mcs96.c" 2
...
# 7 "project/radare2/libr/asm/p/asm_mcs96.c" 2
# 1 "project/radare2/libr/asm/p/../arch/mcs96/mcs96.h" 1




# 4 "project/radare2/libr/asm/p/../arch/mcs96/mcs96.h"
typedef struct mcs96_op_t {
 const char *ins;
 const 
# 6 "project/radare2/libr/asm/p/../arch/mcs96/mcs96.h" 3 4
      unsigned int 
# 6 "project/radare2/libr/asm/p/../arch/mcs96/mcs96.h"
           type;
} Mcs96Op;
# 29 "project/radare2/libr/asm/p/../arch/mcs96/mcs96.h"
static Mcs96Op mcs96_op[] = {
 ...
 {"sub", 0x8|0x200},
 {"sub", 0x80|0x200},
 {"mulu", 0x8|0x200|0x2000},
 {"mulu", 0x10|0x200|0x2000},
 {"mulu", 0x8|0x200|0x2000},
 {"mulu", 0x80|0x200|0x2000},
 {"andb", 0x8|0x200|0x1000},
 {"andb", 0x8|0x200},
 {"andb", 0x8|0x200},
 {"andb", 0x80|0x200},
 ...
 {"subb", 0x8|0x200},
 {"subb", 0x80|0x200},
 {"mulub", 0x8|0x200|0x2000},
 {"mulub", 0x8|0x200|0x2000},
 {"mulub", 0x8|0x200|0x2000},
 {"mulub", 0x80|0x200|0x2000},
 {"and", 0x4|0x100},
 {"and", 0x8|0x100},
 {"and", 0x4|0x100},
 {"and", 0x40|0x100},
 ...
 {"sub", 0x4|0x100},
 {"sub", 0x40|0x100},
 {"mulu", 0x4|0x100|0x2000},
 {"mulu", 0x8|0x100|0x2000},
 {"mulu", 0x4|0x100|0x2000},
 {"mulu", 0x40|0x100|0x2000},
 {"andb", 0x4|0x100|0x1000},
 {"andb", 0x4|0x100},
 {"andb", 0x4|0x100},
 {"andb", 0x40|0x100},
 {"addb", 0x4|0x100|0x1000},
 {"addb", 0x4|0x100},
 {"addb", 0x4|0x100},
 {"addb", 0x40|0x100},
 {"subb", 0x4|0x100|0x1000},
 {"subb", 0x4|0x100},
 {"subb", 0x4|0x100},
 {"subb", 0x40|0x100},
 {"mulub", 0x4|0x100|0x2000|0x1000},
 {"mulub", 0x4|0x100|0x2000},
 {"mulub", 0x4|0x100|0x2000},
 {"mulub", 0x40|0x100|0x2000},
 {"or", 0x4|0x100},
 {"or", 0x8|0x100},
 {"or", 0x4|0x100},
 {"or", 0x40|0x100},
 ...
 {"cmp", 0x4|0x100},
 {"cmp", 0x40|0x100},
 {"divu", 0x4|0x100|0x2000},
 {"divu", 0x8|0x100|0x2000},
 {"divu", 0x4|0x100|0x2000},
 {"divu", 0x40|0x100|0x2000},
 {"orb", 0x4|0x100|0x1000},
 {"orb", 0x4|0x100},
 {"orb", 0x4|0x100},
 {"orb", 0x40|0x100},
 {"xorb", 0x4|0x100|0x1000},
 {"xorb", 0x4|0x100},
 {"xorb", 0x4|0x100},
 {"xorb", 0x40|0x100},
 {"cmpb", 0x4|0x100|0x1000},
 {"cmpb", 0x4|0x100},
 {"cmpb", 0x4|0x100},
 {"cmpb", 0x40|0x100},
 {"divub", 0x4|0x100|0x2000|0x1000},
 {"divub", 0x4|0x100|0x2000},
 {"divub", 0x4|0x100|0x2000},
 {"divub", 0x40|0x100|0x2000},
 {"ld", 0x4|0x100},
 {"ld", 0x8|0x100},
 {"ld", 0x4|0x100},
 {"ld", 0x40|0x100},
 ...
 {"lbsze", 0x4|0x100},
 {"lbsze", 0x40|0x100},
 {"ldb", 0x4|0x100|0x1000},
 {"ldb", 0x4|0x100},
 {"ldb", 0x4|0x100},
 {"ldb", 0x40|0x100},
 {"addcb", 0x4|0x100|0x1000},
 {"addcb", 0x4|0x100},
 {"addcb", 0x4|0x100},
 {"addcb", 0x40|0x100},
 {"subcb", 0x4|0x100|0x1000},
 {"subcb", 0x4|0x100},
 {"subcb", 0x4|0x100},
 {"subcb", 0x40|0x100},
 {"ldbse", 0x4|0x100|0x1000},
 {"ldbse", 0x4|0x100},
 {"ldbse", 0x4|0x100},
 {"ldbse", 0x40|0x100},
 {"st", 0x4|0x100},
...
# 8 "project/radare2/libr/asm/p/asm_mcs96.c" 2

static int mcs96_len (const 
# 9 "project/radare2/libr/asm/p/asm_mcs96.c" 3 4
                           unsigned char 
# 9 "project/radare2/libr/asm/p/asm_mcs96.c"
                               *buf, int len, RStrBuf *asm_buf) {
 int ret = 1;
 if (buf[0] == 0xfe) {
  if (len < 2) {
   return 0;
  }
  if (mcs96_op[buf[1]].type & 0x2000) {
   if (mcs96_op[buf[1]].type & 0x80) {
    if (len < 3) {
     return 0;
    }
    ret = 6 + (buf[2] & 0x1);
   }
   if (mcs96_op[buf[1]].type & 0x40) {
    if (len < 3) {
     return 0;
    }
    ret = 5 + (buf[2] & 0x1);
   }
   if (mcs96_op[buf[1]].type & 0x20) {
    if (len < 3) {
     return 0;
    }
    ret = 4 + (buf[1] & 0x1);
   }
   if (mcs96_op[buf[1]].type & 0x10) {
    ret = 6;
   }
   if (mcs96_op[buf[1]].type & 0x8) {
    ret = 5;
   }
   if (mcs96_op[buf[1]].type & 0x4) {
    ret = 4;
   }
   if (mcs96_op[buf[1]].type & 0x2) {
    ret = 3;
   }
   if (ret <= len) {
    const 
# 47 "project/radare2/libr/asm/p/asm_mcs96.c" 3 4
         unsigned int 
# 47 "project/radare2/libr/asm/p/asm_mcs96.c"
              fe_idx = ((buf[1] & 0x70) >> 4) ^ 0x4;
    r_strbuf_set (asm_buf, mcs96_fe_op[fe_idx]);
    if ((mcs96_op[buf[1]].type & (0x100 | 0x1000)) == (0x100 | 0x1000) &&
 ...
 if (mcs96_op[buf[0]].type & 0x80) {
  if (len < 2) {
   return 0;
  }
  ret = 5 + (buf[1] & 0x1);
 }
 if (mcs96_op[buf[0]].type & 0x40) {
  if (len < 2) {
   return 0;
  }
  ret = 4 + (buf[1] & 0x1);
 }
 if (mcs96_op[buf[0]].type & 0x20) {
  if (len < 2) {
   return 0;
  }
  ret = 3 + (buf[1] & 0x1);
 }
 if (mcs96_op[buf[0]].type & 0x10) {
  ret = 5;
 }
 if (mcs96_op[buf[0]].type & 0x8) {
  ret = 4;
 }
 if (mcs96_op[buf[0]].type & 0x4) {
  ret = 3;
 }
 if (mcs96_op[buf[0]].type & 0x2) {
  ret = 2;
 }
 if (ret <= len) {
  r_strbuf_set (asm_buf, mcs96_op[buf[0]].ins);
  if ((mcs96_op[buf[0]].type & (0x100 | 0x1000)) == (0x100 | 0x1000) &&
...
# 101 "project/radare2/libr/asm/p/asm_mcs96.c" 3 4
                                                 unsigned char 
# 101 "project/radare2/libr/asm/p/asm_mcs96.c"
                                                     *buf, int len) {
...
RAsmPlugin r_asm_plugin_mcs96 = {
 ...
 .bits = 16,
 .endian = 
# 115 "project/radare2/libr/asm/p/asm_mcs96.c" 3 4
          0
# 115 "project/radare2/libr/asm/p/asm_mcs96.c"
                           ,
...
# 120 "project/radare2/libr/asm/p/asm_mcs96.c" 3 4
__attribute__((visibility("default"))) 
# 120 "project/radare2/libr/asm/p/asm_mcs96.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_mcs96,
 .version = 
# 123 "project/radare2/libr/asm/p/asm_mcs96.c" 3 4
           "5.5.4"

# 124 "project/radare2/libr/asm/p/asm_mcs96.c"
};
