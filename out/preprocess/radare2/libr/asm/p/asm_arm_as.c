# 0 "project/radare2/libr/asm/p/asm_arm_as.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/asm/p/asm_arm_as.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_arm_as.c" 2
...
static int assemble(RAsm *a, RAsmOp *op, const char *buf) {
 int bits = a->bits;
 char *as = "";
# 21 "project/radare2/libr/asm/p/asm_arm_as.c"
 char cmd_opt[4096];
 
# 22 "project/radare2/libr/asm/p/asm_arm_as.c" 3 4
__builtin___snprintf_chk (
# 22 "project/radare2/libr/asm/p/asm_arm_as.c"
cmd_opt
# 22 "project/radare2/libr/asm/p/asm_arm_as.c" 3 4
, 
# 22 "project/radare2/libr/asm/p/asm_arm_as.c"
...
, 2 > 1 ? 1 : 0), 
# 22 "project/radare2/libr/asm/p/asm_arm_as.c"
"%s %s", bits == 16 ? "-mthumb" : "", a->big_endian ? "-EB" : "-EL"
# 22 "project/radare2/libr/asm/p/asm_arm_as.c" 3 4
)

                                
# 24 "project/radare2/libr/asm/p/asm_arm_as.c"
                               ;
 return binutils_assemble (a, op, buf, as,
  bits == 64 ? "R2_ARM64_AS" : "R2_ARM32_AS",
  bits <= 32 ? ".syntax unified\n" : "", cmd_opt);
}

RAsmPlugin r_asm_plugin_arm_as = {
 .name = "arm.as",
 .desc = "as ARM Assembler (use ""R2_ARM32_AS"" and ""R2_ARM64_AS"" environment)",
 .arch = "arm",
 .author = "pancake",
 .license = "LGPL3",
 .bits = 16 | 32 | 64,
 .endian = 
# 37 "project/radare2/libr/asm/p/asm_arm_as.c" 3 4
          1 
# 37 "project/radare2/libr/asm/p/asm_arm_as.c"
                              | 
# 37 "project/radare2/libr/asm/p/asm_arm_as.c" 3 4
                                2
# 37 "project/radare2/libr/asm/p/asm_arm_as.c"
...
# 42 "project/radare2/libr/asm/p/asm_arm_as.c" 3 4
__attribute__((visibility("default"))) 
# 42 "project/radare2/libr/asm/p/asm_arm_as.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_arm_as,
 .version = 
# 45 "project/radare2/libr/asm/p/asm_arm_as.c" 3 4
           "5.5.4"

# 46 "project/radare2/libr/asm/p/asm_arm_as.c"
};
