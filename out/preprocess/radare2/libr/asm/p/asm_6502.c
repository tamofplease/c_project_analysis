# 0 "project/radare2/libr/asm/p/asm_6502.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/p/asm_6502.c"
...
typedef int RRef;
# 5 "project/radare2/libr/asm/p/asm_6502.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_6502.c" 2
...
# 7 "project/radare2/libr/asm/p/asm_6502.c" 2
...
# 8 "project/radare2/libr/asm/p/asm_6502.c" 2
# 1 "project/radare2/libr/asm/p/../arch/6502/6502dis.c" 1





# 1 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c" 1
...
# 1 "project/radare2/libr/asm/p/../arch/6502/../snes/snes_op_table.h" 1
...
# 8 "project/radare2/libr/asm/p/../arch/6502/../snes/snes_op_table.h"
enum {
 SNES_OP_8BIT = 1,
 SNES_OP_16BIT,
 SNES_OP_24BIT,
...
# 19 "project/radare2/libr/asm/p/../arch/6502/../snes/snes_op_table.h" 3 4
unsigned char 
# 19 "project/radare2/libr/asm/p/../arch/6502/../snes/snes_op_table.h"
    len;
 
# 20 "project/radare2/libr/asm/p/../arch/6502/../snes/snes_op_table.h" 3 4
unsigned char 
# 20 "project/radare2/libr/asm/p/../arch/6502/../snes/snes_op_table.h"
    flags;
} snes_op_t;
...
# 9 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c" 2

static int snesDisass(int M_flag, int X_flag, 
# 10 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c" 3 4
                                             unsigned long long 
# 10 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c"
                                                  pc, RAsmOp *op, const 
# 10 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c" 3 4
                                                                        unsigned char 
# 10 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c"
...
# 23 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c" 3 4
                                  unsigned int
# 23 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c"
                                      )(pc + 2 + (
# 23 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c" 3 4
                                                  signed char
# 23 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c"
...
# 32 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c" 3 4
                                           short
# 32 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c"
                                               )
# 32 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c" 3 4
                                                ((
# 32 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c"
...
# 32 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c"
   ...
   buf_asm = sdb_fmt (s_op->name, 
# 34 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c" 3 4
                                 ((
# 34 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c"
                                 buf + 1
# 34 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c" 3 4
                                 )[0]|((
# 34 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c"
...
# 44 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c" 3 4
                                               ((
# 44 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c"
                                               buf + 1
# 44 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c" 3 4
                                               )[0]|((
# 44 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c"
...
# 44 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c"
 ...
 case SNES_OP_IMM_X:
  if (X_flag) {
   ...
   buf_asm = sdb_fmt ("%s #0x%04x", s_op->name, 
# 51 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c" 3 4
                                               ((
# 51 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c"
                                               buf + 1
# 51 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c" 3 4
                                               )[0]|((
# 51 "project/radare2/libr/asm/p/../arch/6502/../snes/snesdis.c"
...
# 7 "project/radare2/libr/asm/p/../arch/6502/6502dis.c" 2

static struct {
 
# 9 "project/radare2/libr/asm/p/../arch/6502/6502dis.c" 3 4
unsigned char 
# 9 "project/radare2/libr/asm/p/../arch/6502/6502dis.c"
    op;
 char *name;
 size_t len;
} ops[] = {
 ...
 {0x53, "sre (0x%02x),y", 2},
 {-1, 
# 135 "project/radare2/libr/asm/p/../arch/6502/6502dis.c" 3 4
     ((void *)0)
# 135 "project/radare2/libr/asm/p/../arch/6502/6502dis.c"
         , 0}};

static int _6502Disass (
# 137 "project/radare2/libr/asm/p/../arch/6502/6502dis.c" 3 4
                       unsigned long long 
# 137 "project/radare2/libr/asm/p/../arch/6502/6502dis.c"
                            pc, RAsmOp *op, const 
# 137 "project/radare2/libr/asm/p/../arch/6502/6502dis.c" 3 4
                                                  unsigned char 
# 137 "project/radare2/libr/asm/p/../arch/6502/6502dis.c"
...
# 137 "project/radare2/libr/asm/p/../arch/6502/6502dis.c"
 ...
 int i;
 for (i=0; ops[i].name != 
# 139 "project/radare2/libr/asm/p/../arch/6502/6502dis.c" 3 4
                         ((void *)0)
# 139 "project/radare2/libr/asm/p/../arch/6502/6502dis.c"
                             ; i++) {
  if (ops[i].op == buf[0]) {
   const char *buf_asm = "invalid";
   int len = ops[i].len;
...
# 9 "project/radare2/libr/asm/p/asm_6502.c" 2

static int disassemble(RAsm *a, RAsmOp *op, const 
# 10 "project/radare2/libr/asm/p/asm_6502.c" 3 4
                                                 unsigned char 
# 10 "project/radare2/libr/asm/p/asm_6502.c"
                                                     *buf, int len) {
 
# 11 "project/radare2/libr/asm/p/asm_6502.c" 3 4
unsigned char 
# 11 "project/radare2/libr/asm/p/asm_6502.c"
    data[8];
 size_t min = 
# 12 "project/radare2/libr/asm/p/asm_6502.c" 3 4
             (((
# 12 "project/radare2/libr/asm/p/asm_6502.c"
             len
# 12 "project/radare2/libr/asm/p/asm_6502.c" 3 4
             )>(
# 12 "project/radare2/libr/asm/p/asm_6502.c"
...
# 13 "project/radare2/libr/asm/p/asm_6502.c" 3 4
__builtin___memcpy_chk (
# 13 "project/radare2/libr/asm/p/asm_6502.c"
data
# 13 "project/radare2/libr/asm/p/asm_6502.c" 3 4
, 
# 13 "project/radare2/libr/asm/p/asm_6502.c"
...
# 13 "project/radare2/libr/asm/p/asm_6502.c"
 ...
 return op->size = 
# 15 "project/radare2/libr/asm/p/asm_6502.c" 3 4
                  (((
# 15 "project/radare2/libr/asm/p/asm_6502.c"
                  dlen
# 15 "project/radare2/libr/asm/p/asm_6502.c" 3 4
                  )>(
# 15 "project/radare2/libr/asm/p/asm_6502.c"
...
RAsmPlugin r_asm_plugin_6502 = {
 ...
 .bits = 8|16,
 .endian = 
# 23 "project/radare2/libr/asm/p/asm_6502.c" 3 4
          1
# 23 "project/radare2/libr/asm/p/asm_6502.c"
                             ,
 .license = "LGPL3",
...
# 29 "project/radare2/libr/asm/p/asm_6502.c" 3 4
__attribute__((visibility("default"))) 
# 29 "project/radare2/libr/asm/p/asm_6502.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_6502,
 .version = 
# 32 "project/radare2/libr/asm/p/asm_6502.c" 3 4
           "5.5.4"

# 33 "project/radare2/libr/asm/p/asm_6502.c"
};
