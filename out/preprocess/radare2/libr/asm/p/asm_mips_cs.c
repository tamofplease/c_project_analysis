# 0 "project/radare2/libr/asm/p/asm_mips_cs.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/p/asm_mips_cs.c"
...
# 4 "project/radare2/libr/asm/p/asm_mips_cs.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_mips_cs.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_mips_cs.c" 2

 
# 7 "project/radare2/libr/asm/p/asm_mips_cs.c"
     int mips_assemble(const char *str, 
# 7 "project/radare2/libr/asm/p/asm_mips_cs.c" 3 4
                                        unsigned long long 
# 7 "project/radare2/libr/asm/p/asm_mips_cs.c"
                                             pc, 
# 7 "project/radare2/libr/asm/p/asm_mips_cs.c" 3 4
...
# 11 "project/radare2/libr/asm/p/asm_mips_cs.c" 2

static int disassemble(RAsm *a, RAsmOp *op, const 
# 12 "project/radare2/libr/asm/p/asm_mips_cs.c" 3 4
                                                 unsigned char 
# 12 "project/radare2/libr/asm/p/asm_mips_cs.c"
                                                     *buf, int len) {
 cs_insn* insn;
 int mode, n, ret = -1;
...
# 33 "project/radare2/libr/asm/p/asm_mips_cs.c" 3 4
__builtin___memset_chk (
# 33 "project/radare2/libr/asm/p/asm_mips_cs.c"
op
# 33 "project/radare2/libr/asm/p/asm_mips_cs.c" 3 4
, 
# 33 "project/radare2/libr/asm/p/asm_mips_cs.c"
...
# 33 "project/radare2/libr/asm/p/asm_mips_cs.c"
 ...
 n = cs_disasm (cd, (
# 48 "project/radare2/libr/asm/p/asm_mips_cs.c" 3 4
                    unsigned char
# 48 "project/radare2/libr/asm/p/asm_mips_cs.c"
                       *)buf, len, a->pc, 1, &insn);
 if (n < 1) {
...
# 73 "project/radare2/libr/asm/p/asm_mips_cs.c" 3 4
unsigned char 
# 73 "project/radare2/libr/asm/p/asm_mips_cs.c"
    *opbuf = (
# 73 "project/radare2/libr/asm/p/asm_mips_cs.c" 3 4
              unsigned char
# 73 "project/radare2/libr/asm/p/asm_mips_cs.c"
...
# 76 "project/radare2/libr/asm/p/asm_mips_cs.c" 3 4
 unsigned char 
# 76 "project/radare2/libr/asm/p/asm_mips_cs.c"
     *buf = opbuf;
  
# 77 "project/radare2/libr/asm/p/asm_mips_cs.c" 3 4
 unsigned char 
# 77 "project/radare2/libr/asm/p/asm_mips_cs.c"
     tmp = buf[0];
  buf[0] = buf[3];
  buf[3] = tmp;
  tmp = buf[1];
...
RAsmPlugin r_asm_plugin_mips_cs = {
 .name = "mips",
 .desc = "Capstone ""v4"" MIPS disassembler",
 .license = "BSD",
 .arch = "mips",
 .cpus = "mips32/64,micro,r6,v3,v2",
 .bits = 16|32|64,
 .endian = 
# 94 "project/radare2/libr/asm/p/asm_mips_cs.c" 3 4
          1 
# 94 "project/radare2/libr/asm/p/asm_mips_cs.c"
                              | 
# 94 "project/radare2/libr/asm/p/asm_mips_cs.c" 3 4
                                2
# 94 "project/radare2/libr/asm/p/asm_mips_cs.c"
...
# 101 "project/radare2/libr/asm/p/asm_mips_cs.c" 3 4
__attribute__((visibility("default"))) 
# 101 "project/radare2/libr/asm/p/asm_mips_cs.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_mips_cs,
 .version = 
# 104 "project/radare2/libr/asm/p/asm_mips_cs.c" 3 4
           "5.5.4"

# 105 "project/radare2/libr/asm/p/asm_mips_cs.c"
};
