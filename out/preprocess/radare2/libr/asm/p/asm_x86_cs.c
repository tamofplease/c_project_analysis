# 0 "project/radare2/libr/asm/p/asm_x86_cs.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/asm/p/asm_x86_cs.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_x86_cs.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_x86_cs.c" 2




# 9 "project/radare2/libr/asm/p/asm_x86_cs.c"
static csh cd = 0;
static int n = 0;

static 
# 12 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
      _Bool 
# 12 "project/radare2/libr/asm/p/asm_x86_cs.c"
           the_end(void *p) {
# 21 "project/radare2/libr/asm/p/asm_x86_cs.c"
 if (cd) {
  cs_close (&cd);
  cd = 0;
 }
 return 
# 25 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
       1
# 25 "project/radare2/libr/asm/p/asm_x86_cs.c"
           ;
}
...
# 29 "project/radare2/libr/asm/p/asm_x86_cs.c" 2

# 1 "project/radare2/libr/asm/p/asm_x86_vm.c" 1
# 30 "project/radare2/libr/asm/p/asm_x86_vm.c"
void decompile_vm(RAsm *a, RAsmOp *op, const 
# 30 "project/radare2/libr/asm/p/asm_x86_vm.c" 3 4
                                            unsigned char 
# 30 "project/radare2/libr/asm/p/asm_x86_vm.c"
                                                *buf, int len) {
...
# 31 "project/radare2/libr/asm/p/asm_x86_cs.c" 2

static 
# 32 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
      _Bool 
# 32 "project/radare2/libr/asm/p/asm_x86_cs.c"
           check_features(RAsm *a, cs_insn *insn) {
 if (!insn || !insn->detail) {
  return 
# 34 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
        0
# 34 "project/radare2/libr/asm/p/asm_x86_cs.c"
             ;
 }
 int i;
 for (i = 0; i < insn->detail->groups_count; i++) {
  ...
  if (!name) {
   return 
# 50 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
         1
# 50 "project/radare2/libr/asm/p/asm_x86_cs.c"
             ;
  }
  if (!strstr (a->features, name)) {
   return 
# 53 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
         0
# 53 "project/radare2/libr/asm/p/asm_x86_cs.c"
              ;
  }
 }
 return 
# 56 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
       1
# 56 "project/radare2/libr/asm/p/asm_x86_cs.c"
           ;
}

static int disassemble(RAsm *a, RAsmOp *op, const 
# 59 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
                                                 unsigned char 
# 59 "project/radare2/libr/asm/p/asm_x86_cs.c"
                                                     *buf, int len) {
 static int omode = 0;
 int mode, ret;
 
# 62 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
unsigned long long 
# 62 "project/radare2/libr/asm/p/asm_x86_cs.c"
     off = a->pc;
 ...
 if (!op) {
  return 
# 101 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
        1
# 101 "project/radare2/libr/asm/p/asm_x86_cs.c"
            ;
 }
 op->size = 1;
 cs_insn *insn = 
# 104 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
                ((void *)0)
# 104 "project/radare2/libr/asm/p/asm_x86_cs.c"
                    ;
...
# 132 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
   __builtin___memmove_chk (
# 132 "project/radare2/libr/asm/p/asm_x86_cs.c"
   ptrstr
# 132 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
   , 
# 132 "project/radare2/libr/asm/p/asm_x86_cs.c"
...
# 142 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
  __builtin___memcpy_chk (
# 142 "project/radare2/libr/asm/p/asm_x86_cs.c"
  buf_asm
# 142 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
  , 
# 142 "project/radare2/libr/asm/p/asm_x86_cs.c"
...
# 144 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
  __builtin___memcpy_chk (
# 144 "project/radare2/libr/asm/p/asm_x86_cs.c"
  buf_asm
# 144 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
  , 
# 144 "project/radare2/libr/asm/p/asm_x86_cs.c"
...
RAsmPlugin r_asm_plugin_x86_cs = {
 .name = "x86",
 .desc = "Capstone ""v4"" X86 disassembler",
 .license = "BSD",
 .arch = "x86",
 .bits = 16|32|64,
 .endian = 
# 163 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
          1
# 163 "project/radare2/libr/asm/p/asm_x86_cs.c"
                             ,
 .fini = the_end,
 .mnemonics = mnemonics,
...
# 173 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
__attribute__((visibility("default"))) 
# 173 "project/radare2/libr/asm/p/asm_x86_cs.c"
     RLibStruct *radare_plugin_function(void) {
 RLibStruct *rp = 
# 174 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
                 (
# 174 "project/radare2/libr/asm/p/asm_x86_cs.c"
                 RLibStruct
# 174 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
                 *)calloc(1,sizeof(
# 174 "project/radare2/libr/asm/p/asm_x86_cs.c"
...
# 174 "project/radare2/libr/asm/p/asm_x86_cs.c"
 ...
 if (rp) {
  ...
  rp->version = 
# 178 "project/radare2/libr/asm/p/asm_x86_cs.c" 3 4
               "5.5.4"
# 178 "project/radare2/libr/asm/p/asm_x86_cs.c"
                         ;
 }
 return rp;
}
