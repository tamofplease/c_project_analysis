# 0 "project/radare2/libr/asm/p/asm_jdh8.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/p/asm_jdh8.c"
...
typedef int RRef;
# 4 "project/radare2/libr/asm/p/asm_jdh8.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_jdh8.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_jdh8.c" 2
...
# 7 "project/radare2/libr/asm/p/asm_jdh8.c" 2
# 1 "project/radare2/libr/asm/p/../arch/jdh8/jdh8dis.c" 1
...
# 7 "project/radare2/libr/asm/p/../arch/jdh8/jdh8dis.c"
...
# 13 "project/radare2/libr/asm/p/../arch/jdh8/jdh8dis.c" 3 4
                          unsigned char 
# 13 "project/radare2/libr/asm/p/../arch/jdh8/jdh8dis.c"
                              hex) {
 
# 14 "project/radare2/libr/asm/p/../arch/jdh8/jdh8dis.c" 3 4
unsigned char 
# 14 "project/radare2/libr/asm/p/../arch/jdh8/jdh8dis.c"
    high = (hex & 0xf0) >> 4;
...
# 25 "project/radare2/libr/asm/p/../arch/jdh8/jdh8dis.c" 3 4
                                       unsigned char 
# 25 "project/radare2/libr/asm/p/../arch/jdh8/jdh8dis.c"
                                           *buf, int len) {
 int ilen = jdh_get_ins_len (*buf);
 const 
# 27 "project/radare2/libr/asm/p/../arch/jdh8/jdh8dis.c" 3 4
      unsigned char 
# 27 "project/radare2/libr/asm/p/../arch/jdh8/jdh8dis.c"
          high = (*buf & 0xf0) >> 4;
 const 
# 28 "project/radare2/libr/asm/p/../arch/jdh8/jdh8dis.c" 3 4
      unsigned char 
# 28 "project/radare2/libr/asm/p/../arch/jdh8/jdh8dis.c"
          low = (*buf & 0xf);
 if (ilen > len) {
  return op->size = 0;
 }
...
# 51 "project/radare2/libr/asm/p/../arch/jdh8/jdh8dis.c" 3 4
                                                  unsigned short
# 51 "project/radare2/libr/asm/p/../arch/jdh8/jdh8dis.c"
...
# 65 "project/radare2/libr/asm/p/../arch/jdh8/jdh8dis.c" 3 4
                                              unsigned short
# 65 "project/radare2/libr/asm/p/../arch/jdh8/jdh8dis.c"
                                                  )(buf[1] << 8) | buf[2]));
  break;
 case 6:
  if (ilen == 1) {
...
# 8 "project/radare2/libr/asm/p/asm_jdh8.c" 2

static int disassemble(RAsm *a, RAsmOp *r_op, const 
# 9 "project/radare2/libr/asm/p/asm_jdh8.c" 3 4
                                                   unsigned char 
# 9 "project/radare2/libr/asm/p/asm_jdh8.c"
                                                       *buf, int len) {
 int dlen = jdh8Disass(r_op, buf, len);
 return r_op->size = 
# 11 "project/radare2/libr/asm/p/asm_jdh8.c" 3 4
                    (((
# 11 "project/radare2/libr/asm/p/asm_jdh8.c"
                    0
# 11 "project/radare2/libr/asm/p/asm_jdh8.c" 3 4
                    )>(
# 11 "project/radare2/libr/asm/p/asm_jdh8.c"
...
RAsmPlugin r_asm_plugin_jdh8 = {
 ...
 .bits = 16,
 .endian = 
# 21 "project/radare2/libr/asm/p/asm_jdh8.c" 3 4
          1
# 21 "project/radare2/libr/asm/p/asm_jdh8.c"
                             ,
...
# 26 "project/radare2/libr/asm/p/asm_jdh8.c" 3 4
__attribute__((visibility("default"))) 
# 26 "project/radare2/libr/asm/p/asm_jdh8.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_jdh8,
 .version = 
# 29 "project/radare2/libr/asm/p/asm_jdh8.c" 3 4
           "5.5.4"

# 30 "project/radare2/libr/asm/p/asm_jdh8.c"
};
