# 0 "project/radare2/libr/asm/p/asm_arc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/p/asm_arc.c"
...
# 6 "project/radare2/libr/asm/p/asm_arc.c" 2
...
typedef int RRef;
# 7 "project/radare2/libr/asm/p/asm_arc.c" 2
...
# 8 "project/radare2/libr/asm/p/asm_arc.c" 2
...
# 9 "project/radare2/libr/asm/p/asm_arc.c" 2
...
# 10 "project/radare2/libr/asm/p/asm_arc.c" 2
...
# 11 "project/radare2/libr/asm/p/asm_arc.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/include/mybfd.h" 1 3 4
# 12 "project/radare2/libr/asm/p/asm_arc.c" 2



# 14 "project/radare2/libr/asm/p/asm_arc.c"
...
static 
# 19 "project/radare2/libr/asm/p/asm_arc.c" 3 4
      unsigned int 
# 19 "project/radare2/libr/asm/p/asm_arc.c"
           Offset = 0;
static RStrBuf *buf_global = 
# 20 "project/radare2/libr/asm/p/asm_arc.c" 3 4
                            ((void *)0)
# 20 "project/radare2/libr/asm/p/asm_arc.c"
                                ;
static int buf_len = 0;
static 
# 22 "project/radare2/libr/asm/p/asm_arc.c" 3 4
      unsigned char 
# 22 "project/radare2/libr/asm/p/asm_arc.c"
          bytes[32] = {0};
...
# 32 "project/radare2/libr/asm/p/asm_arc.c" 3 4
__builtin___memcpy_chk (
# 32 "project/radare2/libr/asm/p/asm_arc.c"
myaddr
# 32 "project/radare2/libr/asm/p/asm_arc.c" 3 4
, 
# 32 "project/radare2/libr/asm/p/asm_arc.c"
...
# 44 "project/radare2/libr/asm/p/asm_arc.c" 3 4
...
# 47 "project/radare2/libr/asm/p/asm_arc.c"
static int disassemble(RAsm *a, RAsmOp *op, const 
# 47 "project/radare2/libr/asm/p/asm_arc.c" 3 4
                                                 unsigned char 
# 47 "project/radare2/libr/asm/p/asm_arc.c"
                                                     *buf, int len) {
...
# 57 "project/radare2/libr/asm/p/asm_arc.c" 3 4
__builtin___memcpy_chk (
# 57 "project/radare2/libr/asm/p/asm_arc.c"
bytes
# 57 "project/radare2/libr/asm/p/asm_arc.c" 3 4
, 
# 57 "project/radare2/libr/asm/p/asm_arc.c"
...
# 60 "project/radare2/libr/asm/p/asm_arc.c" 3 4
__builtin___memset_chk (
# 60 "project/radare2/libr/asm/p/asm_arc.c"
&disasm_obj
# 60 "project/radare2/libr/asm/p/asm_arc.c" 3 4
, 
# 60 "project/radare2/libr/asm/p/asm_arc.c"
...
# 60 "project/radare2/libr/asm/p/asm_arc.c"
 ...
 disasm_obj.stream = 
# 69 "project/radare2/libr/asm/p/asm_arc.c" 3 4
                    __stdoutp
# 69 "project/radare2/libr/asm/p/asm_arc.c"
                          ;
 disasm_obj.mach = 0;
...
RAsmPlugin r_asm_plugin_arc = {
 ...
 .bits = 16 | 32,
 .endian = 
# 87 "project/radare2/libr/asm/p/asm_arc.c" 3 4
          1 
# 87 "project/radare2/libr/asm/p/asm_arc.c"
                              | 
# 87 "project/radare2/libr/asm/p/asm_arc.c" 3 4
                                2
# 87 "project/radare2/libr/asm/p/asm_arc.c"
...
# 94 "project/radare2/libr/asm/p/asm_arc.c" 3 4
__attribute__((visibility("default"))) 
# 94 "project/radare2/libr/asm/p/asm_arc.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_arc,
 .version = 
# 97 "project/radare2/libr/asm/p/asm_arc.c" 3 4
           "5.5.4"

# 98 "project/radare2/libr/asm/p/asm_arc.c"
};
