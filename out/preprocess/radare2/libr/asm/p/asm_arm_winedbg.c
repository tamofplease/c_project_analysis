# 0 "project/radare2/libr/asm/p/asm_arm_winedbg.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/p/asm_arm_winedbg.c"
...
# 6 "project/radare2/libr/asm/p/asm_arm_winedbg.c" 2
...
typedef int RRef;
# 7 "project/radare2/libr/asm/p/asm_arm_winedbg.c" 2
...
# 8 "project/radare2/libr/asm/p/asm_arm_winedbg.c" 2
...
# 9 "project/radare2/libr/asm/p/asm_arm_winedbg.c" 2
...
# 10 "project/radare2/libr/asm/p/asm_arm_winedbg.c" 2
# 1 "project/radare2/libr/asm/p/../arch/arm/winedbg/be_arm.h" 1




# 4 "project/radare2/libr/asm/p/../arch/arm/winedbg/be_arm.h"
struct winedbg_arm_insn {
 
# 5 "project/radare2/libr/asm/p/../arch/arm/winedbg/be_arm.h" 3 4
unsigned long long 
# 5 "project/radare2/libr/asm/p/../arch/arm/winedbg/be_arm.h"
     pc;
 const 
# 6 "project/radare2/libr/asm/p/../arch/arm/winedbg/be_arm.h" 3 4
      unsigned char 
# 6 "project/radare2/libr/asm/p/../arch/arm/winedbg/be_arm.h"
          *buf;
 int thumb;
 char *str_asm;
 char *str_hex;
 
# 10 "project/radare2/libr/asm/p/../arch/arm/winedbg/be_arm.h" 3 4
unsigned long long 
# 10 "project/radare2/libr/asm/p/../arch/arm/winedbg/be_arm.h"
     jmp, fail;
};

int arm_disasm_one_insn(struct winedbg_arm_insn *arminsn);
void arm_set_pc(struct winedbg_arm_insn *arminsn, 
# 14 "project/radare2/libr/asm/p/../arch/arm/winedbg/be_arm.h" 3 4
                                                 unsigned long long 
# 14 "project/radare2/libr/asm/p/../arch/arm/winedbg/be_arm.h"
                                                      pc);
void arm_set_input_buffer(struct winedbg_arm_insn *arminsn, const 
# 15 "project/radare2/libr/asm/p/../arch/arm/winedbg/be_arm.h" 3 4
                                                                 unsigned char 
# 15 "project/radare2/libr/asm/p/../arch/arm/winedbg/be_arm.h"
                                                                     *buf);
...
# 11 "project/radare2/libr/asm/p/asm_arm_winedbg.c" 2

static int disassemble(RAsm *a, RAsmOp *op, const 
# 12 "project/radare2/libr/asm/p/asm_arm_winedbg.c" 3 4
                                                 unsigned char 
# 12 "project/radare2/libr/asm/p/asm_arm_winedbg.c"
                                                     *buf, int len) {
 
# 13 "project/radare2/libr/asm/p/asm_arm_winedbg.c" 3 4
unsigned char 
# 13 "project/radare2/libr/asm/p/asm_arm_winedbg.c"
    buf2[4];
...
RAsmPlugin r_asm_plugin_arm_winedbg = {
 ...
 .bits = 16|32,
 .endian = 
# 40 "project/radare2/libr/asm/p/asm_arm_winedbg.c" 3 4
          1 
# 40 "project/radare2/libr/asm/p/asm_arm_winedbg.c"
                              | 
# 40 "project/radare2/libr/asm/p/asm_arm_winedbg.c" 3 4
                                2
# 40 "project/radare2/libr/asm/p/asm_arm_winedbg.c"
...
# 47 "project/radare2/libr/asm/p/asm_arm_winedbg.c" 3 4
__attribute__((visibility("default"))) 
# 47 "project/radare2/libr/asm/p/asm_arm_winedbg.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_arm_winedbg,
 .version = 
# 50 "project/radare2/libr/asm/p/asm_arm_winedbg.c" 3 4
           "5.5.4"

# 51 "project/radare2/libr/asm/p/asm_arm_winedbg.c"
};
