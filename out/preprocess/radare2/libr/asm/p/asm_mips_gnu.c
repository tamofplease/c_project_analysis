# 0 "project/radare2/libr/asm/p/asm_mips_gnu.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 6 "project/radare2/libr/asm/p/asm_mips_gnu.c" 2
...
typedef int RRef;
# 8 "project/radare2/libr/asm/p/asm_mips_gnu.c" 2
...
# 9 "project/radare2/libr/asm/p/asm_mips_gnu.c" 2
...
# 10 "project/radare2/libr/asm/p/asm_mips_gnu.c" 2
...
# 11 "project/radare2/libr/asm/p/asm_mips_gnu.c" 2
...
# 13 "project/radare2/libr/asm/p/asm_mips_gnu.c" 2
...
# 14 "project/radare2/libr/asm/p/asm_mips_gnu.c" 2

# 14 "project/radare2/libr/asm/p/asm_mips_gnu.c"
int mips_assemble(const char *str, 
# 14 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
                                  unsigned long long 
# 14 "project/radare2/libr/asm/p/asm_mips_gnu.c"
                                       pc, 
# 14 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
...
# 18 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
                            ((void *)0)
# 18 "project/radare2/libr/asm/p/asm_mips_gnu.c"
                                ;
static unsigned char bytes[4];
static char *pre_cpu = 
# 20 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
                      ((void *)0)
# 20 "project/radare2/libr/asm/p/asm_mips_gnu.c"
                          ;
static char *pre_features = 
# 21 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
                           ((void *)0)
# 21 "project/radare2/libr/asm/p/asm_mips_gnu.c"
                               ;
...
# 31 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
__builtin___memcpy_chk (
# 31 "project/radare2/libr/asm/p/asm_mips_gnu.c"
myaddr
# 31 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
, 
# 31 "project/radare2/libr/asm/p/asm_mips_gnu.c"
...
# 43 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
...
# 46 "project/radare2/libr/asm/p/asm_mips_gnu.c"
static int disassemble(struct r_asm_t *a, struct r_asm_op_t *op, const 
# 46 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
                                                                      unsigned char 
# 46 "project/radare2/libr/asm/p/asm_mips_gnu.c"
                                                                          *buf, int len) {
...
# 53 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
__builtin___memcpy_chk (
# 53 "project/radare2/libr/asm/p/asm_mips_gnu.c"
bytes
# 53 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
, 
# 53 "project/radare2/libr/asm/p/asm_mips_gnu.c"
...
# 57 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
 __builtin___memset_chk (
# 57 "project/radare2/libr/asm/p/asm_mips_gnu.c"
 &disasm_obj
# 57 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
 , 
# 57 "project/radare2/libr/asm/p/asm_mips_gnu.c"
...
# 57 "project/radare2/libr/asm/p/asm_mips_gnu.c"
 ...
 if (a->cpu && (!pre_cpu || !strcmp(a->cpu, pre_cpu))) {
  if (!r_str_casecmp (a->cpu, "mips64r2")) {
   disasm_obj.mach = 
# 63 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
                    65
# 63 "project/radare2/libr/asm/p/asm_mips_gnu.c"
                                        ;
  } else if (!r_str_casecmp (a->cpu, "mips32r2")) {
   disasm_obj.mach = 
# 65 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
                    33
# 65 "project/radare2/libr/asm/p/asm_mips_gnu.c"
                                        ;
  } else if (!r_str_casecmp (a->cpu, "mips64")) {
   disasm_obj.mach = 
# 67 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
                    64
# 67 "project/radare2/libr/asm/p/asm_mips_gnu.c"
                                      ;
  } else if (!r_str_casecmp (a->cpu, "mips32")) {
   disasm_obj.mach = 
# 69 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
                    32
# 69 "project/radare2/libr/asm/p/asm_mips_gnu.c"
                                      ;
  } else if (!r_str_casecmp (a->cpu, "loongson3a")) {
   disasm_obj.mach = 
# 71 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
                    3003
# 71 "project/radare2/libr/asm/p/asm_mips_gnu.c"
                                       ;
  } else if (!r_str_casecmp (a->cpu, "gs464")) {
   disasm_obj.mach = 
# 73 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
                    3003
# 73 "project/radare2/libr/asm/p/asm_mips_gnu.c"
                                       ;
  } else if (!r_str_casecmp (a->cpu, "gs464e")) {
   disasm_obj.mach = 
# 75 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
                    3004
# 75 "project/radare2/libr/asm/p/asm_mips_gnu.c"
                                        ;
  } else if (!r_str_casecmp (a->cpu, "gs264e")) {
   disasm_obj.mach = 
# 77 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
                    3005
# 77 "project/radare2/libr/asm/p/asm_mips_gnu.c"
                                        ;
  } else if (!r_str_casecmp (a->cpu, "loongson2e")) {
   disasm_obj.mach = 
# 79 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
                    3001
# 79 "project/radare2/libr/asm/p/asm_mips_gnu.c"
                                             ;
  } else if (!r_str_casecmp (a->cpu, "loongson2f")) {
   disasm_obj.mach = 
# 81 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
                    3002
# 81 "project/radare2/libr/asm/p/asm_mips_gnu.c"
                                             ;
  } else if (!r_str_casecmp (a->cpu, "mips32/64")) {

   disasm_obj.mach = 
# 84 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
                    3002
# 84 "project/radare2/libr/asm/p/asm_mips_gnu.c"
                                             ;
  }
  ...
  disasm_obj.mach = 
# 89 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
                   3002
# 89 "project/radare2/libr/asm/p/asm_mips_gnu.c"
                                            ;
 }
 ...
 mips_mode = a->bits;
 disasm_obj.arch = 
# 105 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
                  3002
# 105 "project/radare2/libr/asm/p/asm_mips_gnu.c"
                                 ;
 ...
 disasm_obj.stream = 
# 115 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
                    __stdoutp
# 115 "project/radare2/libr/asm/p/asm_mips_gnu.c"
                          ;
...
# 126 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
unsigned char 
# 126 "project/radare2/libr/asm/p/asm_mips_gnu.c"
    *opbuf = (
# 126 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
              unsigned char
# 126 "project/radare2/libr/asm/p/asm_mips_gnu.c"
...
# 129 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
 unsigned char 
# 129 "project/radare2/libr/asm/p/asm_mips_gnu.c"
     tmp = opbuf[0];
  opbuf[0] = opbuf[3];
  opbuf[3] = tmp;
  tmp = opbuf[1];
...
RAsmPlugin r_asm_plugin_mips_gnu = {
 ...
 .bits = 32 | 64,
 .endian = 
# 144 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
          1 
# 144 "project/radare2/libr/asm/p/asm_mips_gnu.c"
                              | 
# 144 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
                                2
# 144 "project/radare2/libr/asm/p/asm_mips_gnu.c"
...
# 151 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
__attribute__((visibility("default"))) 
# 151 "project/radare2/libr/asm/p/asm_mips_gnu.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_mips_gnu,
 .version = 
# 154 "project/radare2/libr/asm/p/asm_mips_gnu.c" 3 4
           "5.5.4"

# 155 "project/radare2/libr/asm/p/asm_mips_gnu.c"
};
