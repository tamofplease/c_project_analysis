# 0 "project/radare2/libr/asm/p/asm_tms320.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/p/asm_tms320.c"
# 9 "project/radare2/libr/asm/p/asm_tms320.c"
...
# 10 "project/radare2/libr/asm/p/asm_tms320.c" 2
...
typedef int RRef;
# 11 "project/radare2/libr/asm/p/asm_tms320.c" 2
...
# 12 "project/radare2/libr/asm/p/asm_tms320.c" 2
...
# 13 "project/radare2/libr/asm/p/asm_tms320.c" 2
...
# 15 "project/radare2/libr/asm/p/asm_tms320.c" 2
# 27 "project/radare2/libr/asm/p/asm_tms320.c"

# 27 "project/radare2/libr/asm/p/asm_tms320.c"
static csh cd = 0;

static int tms320c64x_disassemble(RAsm *a, RAsmOp *op, const 
# 29 "project/radare2/libr/asm/p/asm_tms320.c" 3 4
                                                            unsigned char 
# 29 "project/radare2/libr/asm/p/asm_tms320.c"
                                                                *buf, int len) {
 cs_insn* insn;
 int n = -1, ret = -1;
 int mode = 0;
...
# 34 "project/radare2/libr/asm/p/asm_tms320.c" 3 4
 __builtin___memset_chk (
# 34 "project/radare2/libr/asm/p/asm_tms320.c"
 op
# 34 "project/radare2/libr/asm/p/asm_tms320.c" 3 4
 , 
# 34 "project/radare2/libr/asm/p/asm_tms320.c"
...
# 34 "project/radare2/libr/asm/p/asm_tms320.c"
 ...
 r_str_case (buf_asm, 
# 63 "project/radare2/libr/asm/p/asm_tms320.c" 3 4
                     0
# 63 "project/radare2/libr/asm/p/asm_tms320.c"
                          );
...
# 1 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h" 1
...
# 93 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h" 3 4
unsigned char 
# 93 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h"
     f, n, v;
};
...
# 98 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h" 3 4
unsigned char 
# 98 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h"
     f, v;
};

struct tms320_instruction_head {
 
# 102 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h" 3 4
unsigned char 
# 102 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h"
     byte;
 
# 103 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h" 3 4
unsigned char 
# 103 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h"
     size;
 insn_item_t insn;
};
...
# 116 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h" 3 4
 unsigned char 
# 116 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h"
      opcode;
  
# 117 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h" 3 4
 unsigned char 
# 117 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h"
      stream[8];
  
# 118 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h" 3 4
 unsigned long long 
# 118 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h"
       opcode64;
 };


 
# 122 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h" 3 4
unsigned char 
# 122 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h"
      status;
 
# 123 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h" 3 4
unsigned char 
# 123 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h"
      length;
 char syntax[1024];
...
# 210 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h" 3 4
unsigned int 
# 210 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h"
       features;


} tms320_dasm_t;
# 240 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h"
extern int tms320_dasm(tms320_dasm_t *, const 
# 240 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h" 3 4
                                             unsigned char 
# 240 "project/radare2/libr/asm/p/../arch/tms320/tms320_dasm.h"
                                                 *, int);
...
# 74 "project/radare2/libr/asm/p/asm_tms320.c" 2

static tms320_dasm_t engine = { 0 };

static int tms320_disassemble(RAsm *a, RAsmOp *op, const 
# 77 "project/radare2/libr/asm/p/asm_tms320.c" 3 4
                                                        unsigned char 
# 77 "project/radare2/libr/asm/p/asm_tms320.c"
                                                            *buf, int len) {
 if (a->cpu && r_str_casecmp (a->cpu, "c54x") == 0) {
  ((&engine)->features = ((&engine)->features & ~0x00000FF) | (0x0000001));
 } else if (a->cpu && r_str_casecmp(a->cpu, "c55x+") == 0) {
  ((&engine)->features = ((&engine)->features & ~0x00000FF) | (0x0000003));
 } else if (a->cpu && r_str_casecmp(a->cpu, "c55x") == 0) {
  ((&engine)->features = ((&engine)->features & ~0x00000FF) | (0x0000002));
 } else {
...
static 
# 98 "project/radare2/libr/asm/p/asm_tms320.c" 3 4
      _Bool 
# 98 "project/radare2/libr/asm/p/asm_tms320.c"
           tms320_init(void * user) {
 return tms320_dasm_init (&engine);
}

static 
# 102 "project/radare2/libr/asm/p/asm_tms320.c" 3 4
      _Bool 
# 102 "project/radare2/libr/asm/p/asm_tms320.c"
           tms320_fini(void * user) {
...
RAsmPlugin r_asm_plugin_tms320 = {
 ...
 .bits = 32,
 .endian = 
# 118 "project/radare2/libr/asm/p/asm_tms320.c" 3 4
          1 
# 118 "project/radare2/libr/asm/p/asm_tms320.c"
                              | 
# 118 "project/radare2/libr/asm/p/asm_tms320.c" 3 4
                                2
# 118 "project/radare2/libr/asm/p/asm_tms320.c"
...
# 125 "project/radare2/libr/asm/p/asm_tms320.c" 3 4
__attribute__((visibility("default"))) 
# 125 "project/radare2/libr/asm/p/asm_tms320.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_tms320,
 .version = 
# 128 "project/radare2/libr/asm/p/asm_tms320.c" 3 4
           "5.5.4"

# 129 "project/radare2/libr/asm/p/asm_tms320.c"
};
