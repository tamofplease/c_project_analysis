# 0 "project/radare2/libr/asm/binutils_as.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/binutils_as.c"


# 1 "project/radare2/libr/asm/binutils_as.h" 1
...
typedef int RRef;
# 5 "project/radare2/libr/asm/binutils_as.h" 2
...
# 6 "project/radare2/libr/asm/binutils_as.h" 2


# 7 "project/radare2/libr/asm/binutils_as.h"
int binutils_assemble(RAsm *a, RAsmOp *op, const char *buf, const char *as, const char *env, const char *header, const char *cmd_opt);
# 4 "project/radare2/libr/asm/binutils_as.c" 2
...
int binutils_assemble(RAsm *a, RAsmOp *op, const char *buf, const char *as, const char *env, const char *header, const char *cmd_opt) {
 ...
 if (
# 10 "project/radare2/libr/asm/binutils_as.c" 3 4
    (!(
# 10 "project/radare2/libr/asm/binutils_as.c"
    as
# 10 "project/radare2/libr/asm/binutils_as.c" 3 4
    ) || !*(
# 10 "project/radare2/libr/asm/binutils_as.c"
...
# 11 "project/radare2/libr/asm/binutils_as.c" 3 4
 fprintf(__stderrp,
# 11 "project/radare2/libr/asm/binutils_as.c"
...
# 11 "project/radare2/libr/asm/binutils_as.c"
 ...
 const 
# 39 "project/radare2/libr/asm/binutils_as.c" 3 4
      _Bool 
# 39 "project/radare2/libr/asm/binutils_as.c"
           success = write (ifd, asm_buf, asm_buf_len) == asm_buf_len;
 free (asm_buf);
 if (!success) {
  goto beach;
 }
...
# 46 "project/radare2/libr/asm/binutils_as.c" 3 4
__builtin___snprintf_chk (
# 46 "project/radare2/libr/asm/binutils_as.c"
cmd
# 46 "project/radare2/libr/asm/binutils_as.c" 3 4
, 
# 46 "project/radare2/libr/asm/binutils_as.c"
...
# 46 "project/radare2/libr/asm/binutils_as.c"
 ...
 if (!r_sys_cmd (cmd)) {
  int len = 0;
  const 
# 49 "project/radare2/libr/asm/binutils_as.c" 3 4
       unsigned char 
# 49 "project/radare2/libr/asm/binutils_as.c"
           *begin, *end;
  close (ofd);
  ofd = r_sandbox_open (opath, 
# 51 "project/radare2/libr/asm/binutils_as.c" 3 4
                              0 
# 51 "project/radare2/libr/asm/binutils_as.c"
                                       | 
# 51 "project/radare2/libr/asm/binutils_as.c" 3 4
                                         0x0000
# 51 "project/radare2/libr/asm/binutils_as.c"
...
# 55 "project/radare2/libr/asm/binutils_as.c" 3 4
 unsigned char 
# 55 "project/radare2/libr/asm/binutils_as.c"
     obuf[4096];
  len = read (ofd, obuf, sizeof (obuf));
  begin = r_mem_mem (obuf, len, (const 
# 57 "project/radare2/libr/asm/binutils_as.c" 3 4
                                      unsigned char
# 57 "project/radare2/libr/asm/binutils_as.c"
                                         *)"BEGINMARK", 9);
  end = r_mem_mem (obuf, len, (const 
# 58 "project/radare2/libr/asm/binutils_as.c" 3 4
                                    unsigned char
# 58 "project/radare2/libr/asm/binutils_as.c"
                                       *)"ENDMARK", 7);
  if (!begin || !end || begin > end) {
   
# 60 "project/radare2/libr/asm/binutils_as.c" 3 4
  fprintf(__stderrp,
# 60 "project/radare2/libr/asm/binutils_as.c"
  "Cannot find water marks\n"
# 60 "project/radare2/libr/asm/binutils_as.c" 3 4
  )
# 60 "project/radare2/libr/asm/binutils_as.c"
                                       ;
...
# 72 "project/radare2/libr/asm/binutils_as.c" 3 4
 fprintf(__stderrp,
# 72 "project/radare2/libr/asm/binutils_as.c"
 "Error running: %s", cmd
# 72 "project/radare2/libr/asm/binutils_as.c" 3 4
 )
# 72 "project/radare2/libr/asm/binutils_as.c"
