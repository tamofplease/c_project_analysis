# 0 "project/radare2/libr/asm/asm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/asm/asm.c"
...
# 4 "project/radare2/libr/asm/asm.c" 2
...
# 5 "project/radare2/libr/asm/asm.c" 2
...
# 11 "project/radare2/libr/asm/asm.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/sdb/src/config.h" 1 3 4
# 12 "project/radare2/libr/asm/asm.c" 2

__attribute__((visibility("default"))) const char *
# 13 "project/radare2/libr/asm/asm.c"
r_asm_version
# 13 "project/radare2/libr/asm/asm.c" 3 4
(void) { return "" "5.5.4"; }
# 13 "project/radare2/libr/asm/asm.c"
                    ;
...
static char *directives[] = {
 ...
 ".echo", ".if", ".ifeq", ".endif",
 ".else", ".set", ".get", 
# 18 "project/radare2/libr/asm/asm.c" 3 4
                         ((void *)0)

# 19 "project/radare2/libr/asm/asm.c"
};
...
# 29 "project/radare2/libr/asm/asm.c" 3 4
 __builtin___strcpy_chk (
# 29 "project/radare2/libr/asm/asm.c"
 out
# 29 "project/radare2/libr/asm/asm.c" 3 4
 , 
# 29 "project/radare2/libr/asm/asm.c"
...
static int r_asm_pseudo_align(RAsmCode *acode, RAsmOp *op, char *input) {
 acode->code_align = r_num_math (
# 40 "project/radare2/libr/asm/asm.c" 3 4
                                ((void *)0)
# 40 "project/radare2/libr/asm/asm.c"
                                    , input);
 return 0;
}
...
# 63 "project/radare2/libr/asm/asm.c" 3 4
 fprintf(__stderrp,
# 63 "project/radare2/libr/asm/asm.c"
...
static inline int r_asm_pseudo_bits(RAsm *a, char *input) {
 if (!(r_asm_set_bits (a, r_num_math (
# 70 "project/radare2/libr/asm/asm.c" 3 4
                                     ((void *)0)
# 70 "project/radare2/libr/asm/asm.c"
                                         , input)))) {
  
# 71 "project/radare2/libr/asm/asm.c" 3 4
 fprintf(__stderrp,
# 71 "project/radare2/libr/asm/asm.c"
 "Error: Unsupported value for .bits.\n"
# 71 "project/radare2/libr/asm/asm.c" 3 4
 )
# 71 "project/radare2/libr/asm/asm.c"
                                                  ;
...
static inline int r_asm_pseudo_org(RAsm *a, char *input) {
 r_asm_set_pc (a, r_num_math (
# 78 "project/radare2/libr/asm/asm.c" 3 4
                             ((void *)0)
# 78 "project/radare2/libr/asm/asm.c"
                                 , input));
 return 0;
}
...
# 86 "project/radare2/libr/asm/asm.c" 3 4
unsigned long long 
# 86 "project/radare2/libr/asm/asm.c"
     s64 = r_num_math (
# 86 "project/radare2/libr/asm/asm.c" 3 4
                       ((void *)0)
# 86 "project/radare2/libr/asm/asm.c"
...
# 88 "project/radare2/libr/asm/asm.c" 3 4
 fprintf(__stderrp,
# 88 "project/radare2/libr/asm/asm.c"
 "int16 Out is out of range\n"
# 88 "project/radare2/libr/asm/asm.c" 3 4
 )
# 88 "project/radare2/libr/asm/asm.c"
                                        ;
...
# 92 "project/radare2/libr/asm/asm.c" 3 4
unsigned char 
# 92 "project/radare2/libr/asm/asm.c"
    *buf = (
# 92 "project/radare2/libr/asm/asm.c" 3 4
            unsigned char
# 92 "project/radare2/libr/asm/asm.c"
...
# 128 "project/radare2/libr/asm/asm.c" 3 4
unsigned char 
# 128 "project/radare2/libr/asm/asm.c"
    *buf = malloc (len);
 if (!buf) {
  return 0;
 }
 for (i = 0; i < len; i++) {
  ...
  int num = (int)r_num_math (
# 134 "project/radare2/libr/asm/asm.c" 3 4
                            ((void *)0)
# 134 "project/radare2/libr/asm/asm.c"
                                , word);
  buf[i] = num;
 }
...
static inline int r_asm_pseudo_fill(RAsmOp *op, char *input) {
 ...
 if (strchr (input, ',')) {
  int res = sscanf (input, "%d,%d,%d", &repeat, &size, &value);
  if (res != 3) {
   
# 147 "project/radare2/libr/asm/asm.c" 3 4
  fprintf(__stderrp,
# 147 "project/radare2/libr/asm/asm.c"
  "Invalid usage of .fill repeat,size,value\n"
# 147 "project/radare2/libr/asm/asm.c" 3 4
  )
# 147 "project/radare2/libr/asm/asm.c"
                                                        ;
   
# 148 "project/radare2/libr/asm/asm.c" 3 4
  fprintf(__stderrp,
# 148 "project/radare2/libr/asm/asm.c"
  "for example: .fill 1,0x100,0\n"
# 148 "project/radare2/libr/asm/asm.c" 3 4
  )
# 148 "project/radare2/libr/asm/asm.c"
                                            ;
...
# 152 "project/radare2/libr/asm/asm.c" 3 4
 unsigned long long 
# 152 "project/radare2/libr/asm/asm.c"
      v = r_num_math (
# 152 "project/radare2/libr/asm/asm.c" 3 4
                      ((void *)0)
# 152 "project/radare2/libr/asm/asm.c"
...
# 158 "project/radare2/libr/asm/asm.c" 3 4
 unsigned char 
# 158 "project/radare2/libr/asm/asm.c"
     *buf = malloc (size);
  if (buf) {
   for (i = 0; i < size; i += sizeof (value)) {
    
# 161 "project/radare2/libr/asm/asm.c" 3 4
   __builtin___memcpy_chk (
# 161 "project/radare2/libr/asm/asm.c"
   &buf[i]
# 161 "project/radare2/libr/asm/asm.c" 3 4
   , 
# 161 "project/radare2/libr/asm/asm.c"
...
static inline int r_asm_pseudo_incbin(RAsmOp *op, char *input) {
 ...
 size_t skip = (size_t)r_num_math (
# 178 "project/radare2/libr/asm/asm.c" 3 4
                                  ((void *)0)
# 178 "project/radare2/libr/asm/asm.c"
                                      , r_str_word_get0 (input, 1));
 size_t count = (size_t)r_num_math (
# 179 "project/radare2/libr/asm/asm.c" 3 4
                                   ((void *)0)
# 179 "project/radare2/libr/asm/asm.c"
                                       ,r_str_word_get0 (input, 2));
 char *content = r_file_slurp (input, &bytes_read);
 if (!content) {
  
# 182 "project/radare2/libr/asm/asm.c" 3 4
 fprintf(__stderrp,
# 182 "project/radare2/libr/asm/asm.c"
 "Could not open '%s'.\n", input
# 182 "project/radare2/libr/asm/asm.c" 3 4
 )
# 182 "project/radare2/libr/asm/asm.c"
...
static void plugin_free(RAsmPlugin *p) {
 if (p && p->fini) {
  p->fini (
# 203 "project/radare2/libr/asm/asm.c" 3 4
          ((void *)0)
# 203 "project/radare2/libr/asm/asm.c"
              );
 }
}


# 207 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) 
# 207 "project/radare2/libr/asm/asm.c"
     RAsm *r_asm_new(void) {
 int i;
 RAsm *a = 
# 209 "project/radare2/libr/asm/asm.c" 3 4
          (
# 209 "project/radare2/libr/asm/asm.c"
          RAsm
# 209 "project/radare2/libr/asm/asm.c" 3 4
          *)calloc(1,sizeof(
# 209 "project/radare2/libr/asm/asm.c"
...
# 209 "project/radare2/libr/asm/asm.c"
 ...
 if (!a) {
  return 
# 211 "project/radare2/libr/asm/asm.c" 3 4
        ((void *)0)
# 211 "project/radare2/libr/asm/asm.c"
            ;
 }
 a->dataalign = 1;
 a->bits = 
# 214 "project/radare2/libr/asm/asm.c" 3 4
          (4 | 8)
# 214 "project/radare2/libr/asm/asm.c"
                    ;
 a->bitshift = 0;
 ...
 if (!a->plugins) {
  free (a);
  return 
# 220 "project/radare2/libr/asm/asm.c" 3 4
        ((void *)0)
# 220 "project/radare2/libr/asm/asm.c"
            ;
 }
...
# 228 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 228 "project/radare2/libr/asm/asm.c"
          r_asm_setup(RAsm *a, const char *arch, int bits, int big_endian) {
 
# 229 "project/radare2/libr/asm/asm.c" 3 4
do { if (!(
# 229 "project/radare2/libr/asm/asm.c"
a && arch
# 229 "project/radare2/libr/asm/asm.c" 3 4
...
"a && arch"
# 229 "project/radare2/libr/asm/asm.c" 3 4
, 229); return (0); } } while (0)
# 229 "project/radare2/libr/asm/asm.c"
                                       ;
 
# 230 "project/radare2/libr/asm/asm.c" 3 4
_Bool 
# 230 "project/radare2/libr/asm/asm.c"
...
# 235 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) 
# 235 "project/radare2/libr/asm/asm.c"
     int r_asm_sub_names_input(RAsm *a, const char *f) {
 
# 236 "project/radare2/libr/asm/asm.c" 3 4
do { if (!(
# 236 "project/radare2/libr/asm/asm.c"
a && f
# 236 "project/radare2/libr/asm/asm.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 236 "project/radare2/libr/asm/asm.c"
...
# 236 "project/radare2/libr/asm/asm.c"
 ...
 if (!r_parse_use (a->ifilter, f)) {
  ...
  a->ifilter = 
# 242 "project/radare2/libr/asm/asm.c" 3 4
              ((void *)0)
# 242 "project/radare2/libr/asm/asm.c"
                  ;
  return 
# 243 "project/radare2/libr/asm/asm.c" 3 4
        0
# 243 "project/radare2/libr/asm/asm.c"
             ;
 }
 return 
# 245 "project/radare2/libr/asm/asm.c" 3 4
       1
# 245 "project/radare2/libr/asm/asm.c"
           ;
}


# 248 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) 
# 248 "project/radare2/libr/asm/asm.c"
     int r_asm_sub_names_output(RAsm *a, const char *f) {
 if (!a->ofilter) {
 ...
 if (!r_parse_use (a->ofilter, f)) {
  ...
  a->ofilter = 
# 254 "project/radare2/libr/asm/asm.c" 3 4
              ((void *)0)
# 254 "project/radare2/libr/asm/asm.c"
                  ;
  return 
# 255 "project/radare2/libr/asm/asm.c" 3 4
        0
# 255 "project/radare2/libr/asm/asm.c"
             ;
 }
 return 
# 257 "project/radare2/libr/asm/asm.c" 3 4
       1
# 257 "project/radare2/libr/asm/asm.c"
           ;
}


# 260 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) 
# 260 "project/radare2/libr/asm/asm.c"
 ...
 if (a->plugins) {
  ...
  a->plugins = 
# 269 "project/radare2/libr/asm/asm.c" 3 4
              ((void *)0)
# 269 "project/radare2/libr/asm/asm.c"
                  ;
 }
 ...
 ht_pp_free (a->flags);
 a->pair = 
# 275 "project/radare2/libr/asm/asm.c" 3 4
          ((void *)0)
# 275 "project/radare2/libr/asm/asm.c"
              ;
 free (a);
}


# 279 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) 
# 279 "project/radare2/libr/asm/asm.c"
     void r_asm_set_user_ptr(RAsm *a, void *user) {
 a->user = user;
}


# 283 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 283 "project/radare2/libr/asm/asm.c"
          r_asm_add(RAsm *a, RAsmPlugin *foo) {
 if (!foo->name) {
  return 
# 285 "project/radare2/libr/asm/asm.c" 3 4
        0
# 285 "project/radare2/libr/asm/asm.c"
             ;
 }
 if (foo->init) {
  foo->init (a->user);
 ...
 if (r_asm_is_valid (a, foo->name)) {
  return 
# 291 "project/radare2/libr/asm/asm.c" 3 4
        0
# 291 "project/radare2/libr/asm/asm.c"
             ;
 }
 r_list_append (a->plugins, foo);
 return 
# 294 "project/radare2/libr/asm/asm.c" 3 4
       1
# 294 "project/radare2/libr/asm/asm.c"
           ;
}


# 297 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) 
# 297 "project/radare2/libr/asm/asm.c"
     int r_asm_del(RAsm *a, const char *name) {

 return 
# 299 "project/radare2/libr/asm/asm.c" 3 4
       0
# 299 "project/radare2/libr/asm/asm.c"
            ;
}


# 302 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 302 "project/radare2/libr/asm/asm.c"
          r_asm_is_valid(RAsm *a, const char *name) {
 RAsmPlugin *h;
 RListIter *iter;
 if (!name || !*name) {
  return 
# 306 "project/radare2/libr/asm/asm.c" 3 4
        0
# 306 "project/radare2/libr/asm/asm.c"
             ;
 }
 
# 308 "project/radare2/libr/asm/asm.c" 3 4
if (
# 308 "project/radare2/libr/asm/asm.c"
a->plugins
# 308 "project/radare2/libr/asm/asm.c" 3 4
) for (
# 308 "project/radare2/libr/asm/asm.c"
...
# 308 "project/radare2/libr/asm/asm.c"
  ...
  if (!strcmp (h->name, name)) {
   return 
# 310 "project/radare2/libr/asm/asm.c" 3 4
         1
# 310 "project/radare2/libr/asm/asm.c"
             ;
  }
 }
 return 
# 313 "project/radare2/libr/asm/asm.c" 3 4
       0
# 313 "project/radare2/libr/asm/asm.c"
            ;
}


# 316 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 316 "project/radare2/libr/asm/asm.c"
          r_asm_use_assembler(RAsm *a, const char *name) {
 RAsmPlugin *h;
 RListIter *iter;
 if (a) {
  if (name && *name) {
   
# 321 "project/radare2/libr/asm/asm.c" 3 4
  if (
# 321 "project/radare2/libr/asm/asm.c"
  a->plugins
# 321 "project/radare2/libr/asm/asm.c" 3 4
  ) for (
# 321 "project/radare2/libr/asm/asm.c"
...
# 321 "project/radare2/libr/asm/asm.c"
    ...
    if (h->assemble && !strcmp (h->name, name)) {
     a->acur = h;
     return 
# 324 "project/radare2/libr/asm/asm.c" 3 4
           1
# 324 "project/radare2/libr/asm/asm.c"
               ;
    }
   }
  }
  a->acur = 
# 328 "project/radare2/libr/asm/asm.c" 3 4
           ((void *)0)
# 328 "project/radare2/libr/asm/asm.c"
               ;
 }
 return 
# 330 "project/radare2/libr/asm/asm.c" 3 4
       0
# 330 "project/radare2/libr/asm/asm.c"
            ;
}
...
static void load_asm_descriptions(RAsm *a, RAsmPlugin *p) {
 ...
 char *r2prefix = r_str_r2_prefix (
# 351 "project/radare2/libr/asm/asm.c" 3 4
                                  "share" "/" "radare2" "/" "5.5.4" "/" "opcodes"
# 351 "project/radare2/libr/asm/asm.c"
                                                );
 char *file = r_str_newf ("%s/%s.sdb", r_str_getf (r2prefix), arch);
 if (file) {
  sdb_free (a->pair);
  a->pair = sdb_new (
# 355 "project/radare2/libr/asm/asm.c" 3 4
                    ((void *)0)
# 355 "project/radare2/libr/asm/asm.c"
                        , file, 0);
  free (file);
 }
 free (r2prefix);
...
# 362 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 362 "project/radare2/libr/asm/asm.c"
          r_asm_use(RAsm *a, const char *name) {
 
# 363 "project/radare2/libr/asm/asm.c" 3 4
do { if (!(
# 363 "project/radare2/libr/asm/asm.c"
a
# 363 "project/radare2/libr/asm/asm.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 363 "project/radare2/libr/asm/asm.c"
"a"
# 363 "project/radare2/libr/asm/asm.c" 3 4
, 363); return (0); } } while (0)
# 363 "project/radare2/libr/asm/asm.c"
                               ;
 if (
# 364 "project/radare2/libr/asm/asm.c" 3 4
    (!(
# 364 "project/radare2/libr/asm/asm.c"
    name
# 364 "project/radare2/libr/asm/asm.c" 3 4
    ) || !*(
# 364 "project/radare2/libr/asm/asm.c"
...
# 364 "project/radare2/libr/asm/asm.c"
  ...
  return 
# 366 "project/radare2/libr/asm/asm.c" 3 4
        0
# 366 "project/radare2/libr/asm/asm.c"
             ;
 }
 RAsmPlugin *h;
 RListIter *iter;
 
# 370 "project/radare2/libr/asm/asm.c" 3 4
if (
# 370 "project/radare2/libr/asm/asm.c"
a->plugins
# 370 "project/radare2/libr/asm/asm.c" 3 4
) for (
# 370 "project/radare2/libr/asm/asm.c"
  ...
  if (h->arch) {
   if (!strcmp (h->name, name)) {
    if (!a->cur || (a->cur && strcmp (a->cur->arch, h->arch))) {
     ...
     r_asm_set_cpu (a, 
# 375 "project/radare2/libr/asm/asm.c" 3 4
                      ((void *)0)
# 375 "project/radare2/libr/asm/asm.c"
                          );
    }
    a->cur = h;
    return 
# 378 "project/radare2/libr/asm/asm.c" 3 4
          1
# 378 "project/radare2/libr/asm/asm.c"
              ;
   }
  } else {
   char *vv = strchr (name, '.');
   if (vv) {
    if (!strcmp (vv + 1, h->name)) {
     ...
     free (cpu);
     return 
# 388 "project/radare2/libr/asm/asm.c" 3 4
           1
# 388 "project/radare2/libr/asm/asm.c"
               ;
    }
   } else {
    if (!strcmp (name, h->name)) {
     h->arch = name;
     r_asm_set_cpu (a, 
# 393 "project/radare2/libr/asm/asm.c" 3 4
                      ((void *)0)
# 393 "project/radare2/libr/asm/asm.c"
                          );
     a->cur = h;
     return 
# 395 "project/radare2/libr/asm/asm.c" 3 4
           1
# 395 "project/radare2/libr/asm/asm.c"
               ;
    }
   }
  }
 ...
 sdb_free (a->pair);
 a->pair = 
# 401 "project/radare2/libr/asm/asm.c" 3 4
          ((void *)0)
# 401 "project/radare2/libr/asm/asm.c"
              ;
 if (strcmp (name, "null")) {
  return r_asm_use (a, "null");
 }
 return 
# 405 "project/radare2/libr/asm/asm.c" 3 4
       0
# 405 "project/radare2/libr/asm/asm.c"
            ;
}

 
# 408 "project/radare2/libr/asm/asm.c" 3 4
           __attribute__((visibility("default"))) 
# 408 "project/radare2/libr/asm/asm.c"
                 void r_asm_set_cpu(RAsm *a, const char *cpu) {
 if (a) {
  free (a->cpu);
  a->cpu = cpu? strdup (cpu): 
# 411 "project/radare2/libr/asm/asm.c" 3 4
                             ((void *)0)
# 411 "project/radare2/libr/asm/asm.c"
                                 ;
 }
}

static 
# 415 "project/radare2/libr/asm/asm.c" 3 4
      _Bool 
# 415 "project/radare2/libr/asm/asm.c"
           has_bits(RAsmPlugin *h, int bits) {
 return (h && h->bits && (bits & h->bits));
}

 
# 419 "project/radare2/libr/asm/asm.c" 3 4
           __attribute__((visibility("default"))) 
# 419 "project/radare2/libr/asm/asm.c"
                 int r_asm_set_bits(RAsm *a, int bits) {
 if (has_bits (a->cur, bits)) {
  a->bits = bits;
  return 
# 422 "project/radare2/libr/asm/asm.c" 3 4
        1
# 422 "project/radare2/libr/asm/asm.c"
            ;
 }
 return 
# 424 "project/radare2/libr/asm/asm.c" 3 4
       0
# 424 "project/radare2/libr/asm/asm.c"
            ;
}


# 427 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 427 "project/radare2/libr/asm/asm.c"
          r_asm_set_big_endian(RAsm *a, 
# 427 "project/radare2/libr/asm/asm.c" 3 4
                                        _Bool 
# 427 "project/radare2/libr/asm/asm.c"
                                             b) {
 
# 428 "project/radare2/libr/asm/asm.c" 3 4
do { if (!(
# 428 "project/radare2/libr/asm/asm.c"
a && a->cur
# 428 "project/radare2/libr/asm/asm.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 428 "project/radare2/libr/asm/asm.c"
"a && a->cur"
# 428 "project/radare2/libr/asm/asm.c" 3 4
, 428); return (0); } } while (0)
# 428 "project/radare2/libr/asm/asm.c"
                                         ;
 a->big_endian = 
# 429 "project/radare2/libr/asm/asm.c" 3 4
                0
# 429 "project/radare2/libr/asm/asm.c"
                     ;
 switch (a->cur->endian) {
 case 
# 431 "project/radare2/libr/asm/asm.c" 3 4
     0
# 431 "project/radare2/libr/asm/asm.c"
                      :
 case 
# 432 "project/radare2/libr/asm/asm.c" 3 4
     3
# 432 "project/radare2/libr/asm/asm.c"
                    :

  a->big_endian = b;
  break;
 case 
# 436 "project/radare2/libr/asm/asm.c" 3 4
     1
# 436 "project/radare2/libr/asm/asm.c"
                        :
  a->big_endian = 
# 437 "project/radare2/libr/asm/asm.c" 3 4
                 0
# 437 "project/radare2/libr/asm/asm.c"
                      ;
  break;
 case 
# 439 "project/radare2/libr/asm/asm.c" 3 4
     2
# 439 "project/radare2/libr/asm/asm.c"
                     :
  a->big_endian = 
# 440 "project/radare2/libr/asm/asm.c" 3 4
                 1
# 440 "project/radare2/libr/asm/asm.c"
                     ;
  break;
 default:
  
# 443 "project/radare2/libr/asm/asm.c" 3 4
 fprintf(__stderrp,
# 443 "project/radare2/libr/asm/asm.c"
...
# 449 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 449 "project/radare2/libr/asm/asm.c"
          r_asm_set_syntax(RAsm *a, int syntax) {
 ...
 case R_ASM_SYNTAX_JZ:
  a->syntax = syntax;
  return 
# 458 "project/radare2/libr/asm/asm.c" 3 4
        1
# 458 "project/radare2/libr/asm/asm.c"
            ;
 default:
  return 
# 460 "project/radare2/libr/asm/asm.c" 3 4
        0
# 460 "project/radare2/libr/asm/asm.c"
             ;
 }
}


# 464 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) 
# 464 "project/radare2/libr/asm/asm.c"
     int r_asm_set_pc(RAsm *a, 
# 464 "project/radare2/libr/asm/asm.c" 3 4
                               unsigned long long 
# 464 "project/radare2/libr/asm/asm.c"
                                    pc) {
 a->pc = pc;
 return 
# 466 "project/radare2/libr/asm/asm.c" 3 4
       1
# 466 "project/radare2/libr/asm/asm.c"
           ;
}

static 
# 469 "project/radare2/libr/asm/asm.c" 3 4
      _Bool 
# 469 "project/radare2/libr/asm/asm.c"
           __isInvalid (RAsmOp *op) {
 const char *buf_asm = r_strbuf_get (&op->buf_asm);
 return (buf_asm && *buf_asm && !strcmp (buf_asm, "invalid"));
}


# 474 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) 
# 474 "project/radare2/libr/asm/asm.c"
     int r_asm_disassemble(RAsm *a, RAsmOp *op, const 
# 474 "project/radare2/libr/asm/asm.c" 3 4
                                                      unsigned char 
# 474 "project/radare2/libr/asm/asm.c"
                                                          *buf, int len) {
...
# 476 "project/radare2/libr/asm/asm.c" 3 4
do { if (!(
# 476 "project/radare2/libr/asm/asm.c"
a && buf && op
# 476 "project/radare2/libr/asm/asm.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 476 "project/radare2/libr/asm/asm.c"
...
# 496 "project/radare2/libr/asm/asm.c" 3 4
  unsigned char 
# 496 "project/radare2/libr/asm/asm.c"
      *tmp = calloc (len, 1);
   if (tmp) {
...
# 530 "project/radare2/libr/asm/asm.c" 3 4
   unsigned short 
# 530 "project/radare2/libr/asm/asm.c"
        b = r_read_le16 (buf);
    r_strbuf_set (&op->buf_asm, sdb_fmt (".word 0x%04x", b));
   } else {
    
# 533 "project/radare2/libr/asm/asm.c" 3 4
   unsigned int 
# 533 "project/radare2/libr/asm/asm.c"
        b = r_read_le32 (buf);
 ...
 int opsz = (op->size > 0)? 
# 544 "project/radare2/libr/asm/asm.c" 3 4
                           (((
# 544 "project/radare2/libr/asm/asm.c"
                           0
# 544 "project/radare2/libr/asm/asm.c" 3 4
                           )>((((
# 544 "project/radare2/libr/asm/asm.c"
...
static 
# 551 "project/radare2/libr/asm/asm.c" 3 4
      _Bool 
# 551 "project/radare2/libr/asm/asm.c"
           assemblerMatches(RAsm *a, RAsmPlugin *h) {
 if (!a || !h->arch || !h->assemble || !has_bits (h, a->bits)) {
  return 
# 553 "project/radare2/libr/asm/asm.c" 3 4
        0
# 553 "project/radare2/libr/asm/asm.c"
             ;
 }
...
static Ase findAssembler(RAsm *a, const char *kw) {
 Ase ase = 
# 559 "project/radare2/libr/asm/asm.c" 3 4
          ((void *)0)
# 559 "project/radare2/libr/asm/asm.c"
              ;
 RAsmPlugin *h;
 RListIter *iter;
...
# 565 "project/radare2/libr/asm/asm.c" 3 4
if (
# 565 "project/radare2/libr/asm/asm.c"
a->plugins
# 565 "project/radare2/libr/asm/asm.c" 3 4
) for (
# 565 "project/radare2/libr/asm/asm.c"
...
static char *replace_directives_for(char *str, char *token) {
 ...
 char *p = 
# 581 "project/radare2/libr/asm/asm.c" 3 4
          ((void *)0)
# 581 "project/radare2/libr/asm/asm.c"
              ;
 char *q = str;
 
# 583 "project/radare2/libr/asm/asm.c" 3 4
_Bool 
# 583 "project/radare2/libr/asm/asm.c"
     changes = 
# 583 "project/radare2/libr/asm/asm.c" 3 4
               0
# 583 "project/radare2/libr/asm/asm.c"
 ...
 for (;;) {
   ...
   *p = _;
   ...
   q = nl;
   changes = 
# 599 "project/radare2/libr/asm/asm.c" 3 4
            1
# 599 "project/radare2/libr/asm/asm.c"
                ;
  } else {
   if (q) {
    r_strbuf_append (sb, q);
...
# 626 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) 
# 626 "project/radare2/libr/asm/asm.c"
     void r_asm_list_directives(void) {
 int i = 0;
 char *dir = directives[i++];
 while (dir) {
  printf ("%s\n", dir);
...
# 636 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) 
# 636 "project/radare2/libr/asm/asm.c"
     int r_asm_assemble(RAsm *a, RAsmOp *op, const char *buf) {
 
# 637 "project/radare2/libr/asm/asm.c" 3 4
do { if (!(
# 637 "project/radare2/libr/asm/asm.c"
a && op && buf
# 637 "project/radare2/libr/asm/asm.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 637 "project/radare2/libr/asm/asm.c"
...
# 647 "project/radare2/libr/asm/asm.c" 3 4
__builtin___memset_chk (
# 647 "project/radare2/libr/asm/asm.c"
op
# 647 "project/radare2/libr/asm/asm.c" 3 4
, 
# 647 "project/radare2/libr/asm/asm.c"
...
# 647 "project/radare2/libr/asm/asm.c"
 ...
 if (a->cur) {
  Ase ase = 
# 649 "project/radare2/libr/asm/asm.c" 3 4
           ((void *)0)
# 649 "project/radare2/libr/asm/asm.c"
               ;
  if (!a->cur->assemble) {
   ...
   if (!ase) {
    ...
    if (!ase) {
     ase = findAssembler (a, 
# 656 "project/radare2/libr/asm/asm.c" 3 4
                            ((void *)0)
# 656 "project/radare2/libr/asm/asm.c"
                                );
    }
   }
  } else {
...
# 670 "project/radare2/libr/asm/asm.c" 3 4
 unsigned char 
# 670 "project/radare2/libr/asm/asm.c"
     *opbuf = (
# 670 "project/radare2/libr/asm/asm.c" 3 4
               unsigned char
# 670 "project/radare2/libr/asm/asm.c"
...
# 678 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) 
# 678 "project/radare2/libr/asm/asm.c"
     RAsmCode* r_asm_mdisassemble(RAsm *a, const 
# 678 "project/radare2/libr/asm/asm.c" 3 4
                                                 unsigned char 
# 678 "project/radare2/libr/asm/asm.c"
                                                     *buf, int len) {
 
# 679 "project/radare2/libr/asm/asm.c" 3 4
do { if (!(
# 679 "project/radare2/libr/asm/asm.c"
a && buf && len >= 0
# 679 "project/radare2/libr/asm/asm.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 679 "project/radare2/libr/asm/asm.c"
...
# 683 "project/radare2/libr/asm/asm.c" 3 4
unsigned long long 
# 683 "project/radare2/libr/asm/asm.c"
     pc = a->pc;
 RAsmOp op;
 
# 685 "project/radare2/libr/asm/asm.c" 3 4
unsigned long long 
# 685 "project/radare2/libr/asm/asm.c"
     idx;
 size_t ret;
 ...
 if (!(acode = r_asm_code_new ())) {
  return 
# 690 "project/radare2/libr/asm/asm.c" 3 4
        ((void *)0)
# 690 "project/radare2/libr/asm/asm.c"
            ;
 }
...
# 695 "project/radare2/libr/asm/asm.c" 3 4
__builtin___memcpy_chk (
# 695 "project/radare2/libr/asm/asm.c"
acode->bytes
# 695 "project/radare2/libr/asm/asm.c" 3 4
, 
# 695 "project/radare2/libr/asm/asm.c"
...
# 695 "project/radare2/libr/asm/asm.c"
                               ;
 if (!(buf_asm = r_strbuf_new (
# 696 "project/radare2/libr/asm/asm.c" 3 4
                              ((void *)0)
# 696 "project/radare2/libr/asm/asm.c"
                                  ))) {
  return r_asm_code_free (acode);
 }
...
# 716 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) 
# 716 "project/radare2/libr/asm/asm.c"
     RAsmCode* r_asm_mdisassemble_hexstr(RAsm *a, RParse *p, const char *hexstr) {
 
# 717 "project/radare2/libr/asm/asm.c" 3 4
unsigned char 
# 717 "project/radare2/libr/asm/asm.c"
    *buf = malloc (strlen (hexstr) + 1);
 if (!buf) {
  return 
# 719 "project/radare2/libr/asm/asm.c" 3 4
        ((void *)0)
# 719 "project/radare2/libr/asm/asm.c"
            ;
 }
 ...
 if (len < 1) {
  free (buf);
  return 
# 724 "project/radare2/libr/asm/asm.c" 3 4
        ((void *)0)
# 724 "project/radare2/libr/asm/asm.c"
            ;
 }
 RAsmCode *ret = r_asm_mdisassemble (a, buf, (
# 726 "project/radare2/libr/asm/asm.c" 3 4
                                             unsigned long long
# 726 "project/radare2/libr/asm/asm.c"
                                                 )len);
 if (ret && p) {
...
# 744 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) 
# 744 "project/radare2/libr/asm/asm.c"
     RAsmCode *r_asm_massemble(RAsm *a, const char *assembly) {
 int num, stage, ret, idx, ctr, i, linenum = 0;
 char *lbuf = 
# 746 "project/radare2/libr/asm/asm.c" 3 4
             ((void *)0)
# 746 "project/radare2/libr/asm/asm.c"
                 , *ptr2, *ptr = 
# 746 "project/radare2/libr/asm/asm.c" 3 4
                                 ((void *)0)
# 746 "project/radare2/libr/asm/asm.c"
...
# 746 "project/radare2/libr/asm/asm.c"
                                                        ;
 const char *asmcpu = 
# 747 "project/radare2/libr/asm/asm.c" 3 4
                     ((void *)0)
# 747 "project/radare2/libr/asm/asm.c"
                         ;
 RAsmCode *acode = 
# 748 "project/radare2/libr/asm/asm.c" 3 4
                  ((void *)0)
# 748 "project/radare2/libr/asm/asm.c"
                      ;
 RAsmOp op = {0};
 
# 750 "project/radare2/libr/asm/asm.c" 3 4
unsigned long long 
# 750 "project/radare2/libr/asm/asm.c"
     off, pc;

 char *buf_token = 
# 752 "project/radare2/libr/asm/asm.c" 3 4
                  ((void *)0)
# 752 "project/radare2/libr/asm/asm.c"
                      ;
 size_t tokens_size = 32;
 char **tokens = calloc (sizeof (char*), tokens_size);
 if (!tokens) {
  return 
# 756 "project/radare2/libr/asm/asm.c" 3 4
        ((void *)0)
# 756 "project/radare2/libr/asm/asm.c"
            ;
 }
 if (!assembly) {
  free (tokens);
  return 
# 760 "project/radare2/libr/asm/asm.c" 3 4
        ((void *)0)
# 760 "project/radare2/libr/asm/asm.c"
            ;
 }
 ht_pp_free (a->flags);
 if (!(a->flags = ht_pp_new (__dup_val, __flag_free_kv, 
# 763 "project/radare2/libr/asm/asm.c" 3 4
                                                       ((void *)0)
# 763 "project/radare2/libr/asm/asm.c"
                                                           ))) {
  free (tokens);
  return 
# 765 "project/radare2/libr/asm/asm.c" 3 4
        ((void *)0)
# 765 "project/radare2/libr/asm/asm.c"
            ;
 }
 if (!(acode = r_asm_code_new ())) {
  free (tokens);
  return 
# 769 "project/radare2/libr/asm/asm.c" 3 4
        ((void *)0)
# 769 "project/radare2/libr/asm/asm.c"
            ;
 }
...
# 784 "project/radare2/libr/asm/asm.c" 3 4
                                        1
# 784 "project/radare2/libr/asm/asm.c"
                                            );
...
# 798 "project/radare2/libr/asm/asm.c" 3 4
 __builtin___snprintf_chk (
# 798 "project/radare2/libr/asm/asm.c"
 val
# 798 "project/radare2/libr/asm/asm.c" 3 4
 , 
# 798 "project/radare2/libr/asm/asm.c"
...
# 812 "project/radare2/libr/asm/asm.c" 3 4
   __builtin___snprintf_chk (
# 812 "project/radare2/libr/asm/asm.c"
   val
# 812 "project/radare2/libr/asm/asm.c" 3 4
   , 
# 812 "project/radare2/libr/asm/asm.c"
...
# 819 "project/radare2/libr/asm/asm.c" 3 4
_Bool 
# 819 "project/radare2/libr/asm/asm.c"
     labels = !!strchr (lbuf, ':');
...
# 830 "project/radare2/libr/asm/asm.c" 3 4
   fprintf(__stderrp,
# 830 "project/radare2/libr/asm/asm.c"
   "Too many tokens\n"
# 830 "project/radare2/libr/asm/asm.c" 3 4
   )
# 830 "project/radare2/libr/asm/asm.c"
...
# 835 "project/radare2/libr/asm/asm.c" 3 4
   fprintf(__stderrp,
# 835 "project/radare2/libr/asm/asm.c"
   "Too many tokens\n"
# 835 "project/radare2/libr/asm/asm.c" 3 4
   )
# 835 "project/radare2/libr/asm/asm.c"
...
# 854 "project/radare2/libr/asm/asm.c"
 pc = a->pc;
 
# 855 "project/radare2/libr/asm/asm.c" 3 4
_Bool 
# 855 "project/radare2/libr/asm/asm.c"
     inComment = 
# 855 "project/radare2/libr/asm/asm.c" 3 4
                 0
# 855 "project/radare2/libr/asm/asm.c"
 ...
 for (stage = 0; stage < 5; stage++) {
  ...
  inComment = 
# 860 "project/radare2/libr/asm/asm.c" 3 4
             0
# 860 "project/radare2/libr/asm/asm.c"
                  ;
  r_asm_set_pc (a, pc);
  for (idx = ret = i = 0, off = a->pc; i <= ctr; i++, idx += ret) {
   ...
   if (inComment) {
    if (!strncmp (ptr_start, "*/", 2)) {
     inComment = 
# 869 "project/radare2/libr/asm/asm.c" 3 4
                0
# 869 "project/radare2/libr/asm/asm.c"
                     ;
    }
    continue;
   }
   ...
   if (a->cur->arch && !strncmp (a->cur->arch, "avr", 3)) {
    for (ptr_start = buf_token; *ptr_start && ((*ptr_start)==' '||(*ptr_start)=='\t'||(*ptr_start)=='\n'||(*ptr_start)=='\r'||(*ptr_start)==' '|| (*ptr_start)==','||(*ptr_start)==';'||(*ptr_start)=='['||(*ptr_start)==']'|| (*ptr_start)=='('||(*ptr_start)==')'||(*ptr_start)=='{'||(*ptr_start)=='}'); ptr_start++);
   } else {
    for (ptr_start = buf_token; *ptr_start && 
# 877 "project/radare2/libr/asm/asm.c" 3 4
                                             ((
# 877 "project/radare2/libr/asm/asm.c"
                                             *ptr_start
# 877 "project/radare2/libr/asm/asm.c" 3 4
                                             ) == ' ' || (
# 877 "project/radare2/libr/asm/asm.c"
...
# 877 "project/radare2/libr/asm/asm.c"
   ...
   if (!strncmp (ptr_start, "/*", 2)) {
    if (!strstr (ptr_start + 2, "*/")) {
     inComment = 
# 881 "project/radare2/libr/asm/asm.c" 3 4
                1
# 881 "project/radare2/libr/asm/asm.c"
                    ;
    }
    continue;
   }
...
# 886 "project/radare2/libr/asm/asm.c" 3 4
   _Bool 
# 886 "project/radare2/libr/asm/asm.c"
        likely_comment = 
# 886 "project/radare2/libr/asm/asm.c" 3 4
                         1
# 886 "project/radare2/libr/asm/asm.c"
    ...
    if (cptr && ptr && cptr < ptr) {
     likely_comment = 
# 892 "project/radare2/libr/asm/asm.c" 3 4
                     0
# 892 "project/radare2/libr/asm/asm.c"
                          ;
     for (cptr += 1; cptr < ptr ; cptr += 1) {
      if ( ! isspace ((unsigned char) *cptr)) {
       likely_comment = 
# 895 "project/radare2/libr/asm/asm.c" 3 4
                       1
# 895 "project/radare2/libr/asm/asm.c"
                           ;
       break;
      }
     }
    ...
    likely_comment = likely_comment && ptr
     && !
# 903 "project/radare2/libr/asm/asm.c" 3 4
        (((
# 903 "project/radare2/libr/asm/asm.c"
        ptr[1]
# 903 "project/radare2/libr/asm/asm.c" 3 4
        )>=(
# 903 "project/radare2/libr/asm/asm.c"
...
# 904 "project/radare2/libr/asm/asm.c"
    && ptr[1] != '-' ;
    if (likely_comment) {
     *ptr = '\0';
    }
...
# 918 "project/radare2/libr/asm/asm.c" 3 4
   _Bool 
# 918 "project/radare2/libr/asm/asm.c"
        is_a_label = 
# 918 "project/radare2/libr/asm/asm.c" 3 4
                     1
# 918 "project/radare2/libr/asm/asm.c"
    ...
    while (*q) {
     if (*q == ' ') {
      is_a_label = 
# 922 "project/radare2/libr/asm/asm.c" 3 4
                  0
# 922 "project/radare2/libr/asm/asm.c"
                       ;
      break;
     }
     q++;
    ...
    if (is_a_label) {
      ...
      *ptr = ':';
      ...
      char *food = r_str_newf ("0x%"
# 936 "project/radare2/libr/asm/asm.c" 3 4
                                   "llx"
# 936 "project/radare2/libr/asm/asm.c"
                                          , off);
   ...
   if (*ptr_start == '.') {
    ...
    if (!strncmp (ptr, ".intel_syntax", 13)) {
     ...
     r_asm_set_big_endian (a, 
# 962 "project/radare2/libr/asm/asm.c" 3 4
                             1
# 962 "project/radare2/libr/asm/asm.c"
                                 );
    } else if (!strncmp (ptr, ".lil_endian", 7 + 4) || !strncmp (ptr, "little_endian", 7 + 6)) {
     r_asm_set_big_endian (a, 
# 964 "project/radare2/libr/asm/asm.c" 3 4
                             0
# 964 "project/radare2/libr/asm/asm.c"
                                  );
     ...
     ret = 
# 1009 "project/radare2/libr/asm/asm.c" 3 4
          1
# 1009 "project/radare2/libr/asm/asm.c"
              ;
    } else if (!strncmp (ptr, ".section", 8)) {
     ret = 
# 1011 "project/radare2/libr/asm/asm.c" 3 4
          1
# 1011 "project/radare2/libr/asm/asm.c"
              ;
...
# 1030 "project/radare2/libr/asm/asm.c" 3 4
     fprintf(__stderrp,
# 1030 "project/radare2/libr/asm/asm.c"
...
# 1036 "project/radare2/libr/asm/asm.c" 3 4
    fprintf(__stderrp,
# 1036 "project/radare2/libr/asm/asm.c"
    "Invalid use of the .offset directory. This directive is only supported in r2 -c 'waf'.\n"
# 1036 "project/radare2/libr/asm/asm.c" 3 4
    )
# 1036 "project/radare2/libr/asm/asm.c"
                                                                                                        ;
...
# 1043 "project/radare2/libr/asm/asm.c" 3 4
     fprintf(__stderrp,
# 1043 "project/radare2/libr/asm/asm.c"
...
# 1048 "project/radare2/libr/asm/asm.c" 3 4
    fprintf(__stderrp,
# 1048 "project/radare2/libr/asm/asm.c"
    "Unknown directive (%s)\n", ptr
# 1048 "project/radare2/libr/asm/asm.c" 3 4
    )
# 1048 "project/radare2/libr/asm/asm.c"
...
# 1055 "project/radare2/libr/asm/asm.c" 3 4
    fprintf(__stderrp,
# 1055 "project/radare2/libr/asm/asm.c"
    "!!! Oops (%s)\n", ptr
# 1055 "project/radare2/libr/asm/asm.c" 3 4
    )
# 1055 "project/radare2/libr/asm/asm.c"
...
# 1080 "project/radare2/libr/asm/asm.c" 3 4
    fprintf(__stderrp,
# 1080 "project/radare2/libr/asm/asm.c"
...
# 1080 "project/radare2/libr/asm/asm.c"
    ...
    acode->bytes = (
# 1088 "project/radare2/libr/asm/asm.c" 3 4
                   unsigned char
# 1088 "project/radare2/libr/asm/asm.c"
                      *)newbuf;
    
# 1089 "project/radare2/libr/asm/asm.c" 3 4
   __builtin___memcpy_chk (
# 1089 "project/radare2/libr/asm/asm.c"
   acode->bytes + idx
# 1089 "project/radare2/libr/asm/asm.c" 3 4
   , 
# 1089 "project/radare2/libr/asm/asm.c"
   r_strbuf_get (&op.buf), r_strbuf_length (&op.buf)
# 1089 "project/radare2/libr/asm/asm.c" 3 4
   , __builtin_object_size (
# 1089 "project/radare2/libr/asm/asm.c"
   acode->bytes + idx
...
# 1090 "project/radare2/libr/asm/asm.c" 3 4
   __builtin___memset_chk (
# 1090 "project/radare2/libr/asm/asm.c"
   acode->bytes + idx + ret
# 1090 "project/radare2/libr/asm/asm.c" 3 4
   , 
# 1090 "project/radare2/libr/asm/asm.c"
...
# 1090 "project/radare2/libr/asm/asm.c"
    ...
    if (op.buf_inc && r_buf_size (op.buf_inc) > 1) {
     ...
     r_buf_free (op.buf_inc);
     op.buf_inc = 
# 1094 "project/radare2/libr/asm/asm.c" 3 4
                 ((void *)0)
# 1094 "project/radare2/libr/asm/asm.c"
                     ;
     if (inc) {
...
# 1112 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 1112 "project/radare2/libr/asm/asm.c"
          r_asm_modify(RAsm *a, 
# 1112 "project/radare2/libr/asm/asm.c" 3 4
                                unsigned char 
# 1112 "project/radare2/libr/asm/asm.c"
...
# 1112 "project/radare2/libr/asm/asm.c"
                                                          val) {
 return (a->cur && a->cur->modify) ? a->cur->modify (a, buf, field, val): 
# 1113 "project/radare2/libr/asm/asm.c" 3 4
                                                                         0
# 1113 "project/radare2/libr/asm/asm.c"
                                                                              ;
}


# 1116 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) 
# 1116 "project/radare2/libr/asm/asm.c"
     int r_asm_get_offset(RAsm *a, int type, int idx) {
...
# 1123 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) 
# 1123 "project/radare2/libr/asm/asm.c"
     char *r_asm_describe(RAsm *a, const char* str) {
 return (a && a->pair)? sdb_get (a->pair, str, 0): 
# 1124 "project/radare2/libr/asm/asm.c" 3 4
                                                  ((void *)0)
# 1124 "project/radare2/libr/asm/asm.c"
                                                      ;
}


# 1127 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) 
# 1127 "project/radare2/libr/asm/asm.c"
     RList* r_asm_get_plugins(RAsm *a) {
 return a->plugins;
}


# 1131 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 1131 "project/radare2/libr/asm/asm.c"
          r_asm_set_arch(RAsm *a, const char *name, int bits) {
 return r_asm_use (a, name)? r_asm_set_bits (a, bits): 
# 1132 "project/radare2/libr/asm/asm.c" 3 4
                                                      0
# 1132 "project/radare2/libr/asm/asm.c"
                                                           ;
}



# 1136 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) 
# 1136 "project/radare2/libr/asm/asm.c"
     char *r_asm_to_string(RAsm *a, 
# 1136 "project/radare2/libr/asm/asm.c" 3 4
                                    unsigned long long 
# 1136 "project/radare2/libr/asm/asm.c"
                                         addr, const 
...
# 1137 "project/radare2/libr/asm/asm.c" 3 4
do { if (!(
# 1137 "project/radare2/libr/asm/asm.c"
a && b && l >= 0
# 1137 "project/radare2/libr/asm/asm.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1137 "project/radare2/libr/asm/asm.c"
...
# 1137 "project/radare2/libr/asm/asm.c"
 ...
 if (code) {
  ...
  code->assembly = 
# 1142 "project/radare2/libr/asm/asm.c" 3 4
                  ((void *)0)
# 1142 "project/radare2/libr/asm/asm.c"
                      ;
  r_asm_code_free (code);
  return buf_asm;
 }
 return 
# 1146 "project/radare2/libr/asm/asm.c" 3 4
       ((void *)0)
# 1146 "project/radare2/libr/asm/asm.c"
           ;
}


# 1149 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 1149 "project/radare2/libr/asm/asm.c"
         *r_asm_from_string(RAsm *a, 
# 1149 "project/radare2/libr/asm/asm.c" 3 4
                                     unsigned long long 
# 1149 "project/radare2/libr/asm/asm.c"
                                          addr, const char *b, int *l) {
 r_asm_set_pc (a, addr);
 RAsmCode *code = r_asm_massemble (a, b);
 if (code) {
  
# 1153 "project/radare2/libr/asm/asm.c" 3 4
 unsigned char 
# 1153 "project/radare2/libr/asm/asm.c"
     *buf = code->bytes;
  if (l) {
   *l = code->len;
  }
 ...
 return 
# 1160 "project/radare2/libr/asm/asm.c" 3 4
       ((void *)0)
# 1160 "project/radare2/libr/asm/asm.c"
           ;
}


# 1163 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) 
# 1163 "project/radare2/libr/asm/asm.c"
     int r_asm_syntax_from_string(const char *name) {
 
# 1164 "project/radare2/libr/asm/asm.c" 3 4
do { if (!(
# 1164 "project/radare2/libr/asm/asm.c"
name
# 1164 "project/radare2/libr/asm/asm.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1164 "project/radare2/libr/asm/asm.c"
...
# 1183 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) 
# 1183 "project/radare2/libr/asm/asm.c"
     char *r_asm_mnemonics(RAsm *a, int id, 
# 1183 "project/radare2/libr/asm/asm.c" 3 4
                                            _Bool 
# 1183 "project/radare2/libr/asm/asm.c"
                                                 json) {
 
# 1184 "project/radare2/libr/asm/asm.c" 3 4
do { if (!(
# 1184 "project/radare2/libr/asm/asm.c"
a && a->cur
# 1184 "project/radare2/libr/asm/asm.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1184 "project/radare2/libr/asm/asm.c"
...
# 1184 "project/radare2/libr/asm/asm.c"
 ...
 return 
# 1188 "project/radare2/libr/asm/asm.c" 3 4
       ((void *)0)
# 1188 "project/radare2/libr/asm/asm.c"
           ;
}


# 1191 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) 
# 1191 "project/radare2/libr/asm/asm.c"
     int r_asm_mnemonics_byname(RAsm *a, const char *name) {
 
# 1192 "project/radare2/libr/asm/asm.c" 3 4
do { if (!(
# 1192 "project/radare2/libr/asm/asm.c"
a && a->cur
# 1192 "project/radare2/libr/asm/asm.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1192 "project/radare2/libr/asm/asm.c"
...
# 1192 "project/radare2/libr/asm/asm.c"
 ...
 if (a->cur->mnemonics) {
  int i;
  for (i = 0; i < 1024; i++) {
   char *n = a->cur->mnemonics (a, i, 
# 1196 "project/radare2/libr/asm/asm.c" 3 4
                                     0
# 1196 "project/radare2/libr/asm/asm.c"
                                          );
   if (n && !strcmp (n, name)) {
    return i;
   }
...
# 1206 "project/radare2/libr/asm/asm.c" 3 4
__attribute__((visibility("default"))) 
# 1206 "project/radare2/libr/asm/asm.c"
     RAsmCode* r_asm_rasm_assemble(RAsm *a, const char *buf, 
# 1206 "project/radare2/libr/asm/asm.c" 3 4
                                                             _Bool 
# 1206 "project/radare2/libr/asm/asm.c"
                                                                  use_spp) {
 
# 1207 "project/radare2/libr/asm/asm.c" 3 4
do { if (!(
# 1207 "project/radare2/libr/asm/asm.c"
a && buf
# 1207 "project/radare2/libr/asm/asm.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1207 "project/radare2/libr/asm/asm.c"
"a && buf"
# 1207 "project/radare2/libr/asm/asm.c" 3 4
, 1207); return (((void *)0)); } } while (0)
# 1207 "project/radare2/libr/asm/asm.c"
                                     ;
 char *lbuf = strdup (buf);
 if (!lbuf) {
  return 
# 1210 "project/radare2/libr/asm/asm.c" 3 4
        ((void *)0)
# 1210 "project/radare2/libr/asm/asm.c"
            ;
 }
 RAsmCode *acode;
 if (use_spp) {
  Output out;
  out.fout = 
# 1215 "project/radare2/libr/asm/asm.c" 3 4
            ((void *)0)
# 1215 "project/radare2/libr/asm/asm.c"
                ;
