# 0 "project/radare2/libr/io/io_plugin.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/io/io_plugin.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/sdb/src/config.h" 1 3 4
# 5 "project/radare2/libr/io/io_plugin.c" 2


# 6 "project/radare2/libr/io/io_plugin.c"
static volatile RIOPlugin *default_plugin = 
# 6 "project/radare2/libr/io/io_plugin.c" 3 4
                                           ((void *)0)
# 6 "project/radare2/libr/io/io_plugin.c"
                                               ;
...
# 12 "project/radare2/libr/io/io_plugin.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 12 "project/radare2/libr/io/io_plugin.c"
          r_io_plugin_add(RIO *io, RIOPlugin *plugin) {
 
# 13 "project/radare2/libr/io/io_plugin.c" 3 4
do { if (!(
# 13 "project/radare2/libr/io/io_plugin.c"
io && plugin && io->plugins
# 13 "project/radare2/libr/io/io_plugin.c" 3 4
...
# 13 "project/radare2/libr/io/io_plugin.c"
 ...
 if (!plugin->name) {
  return 
# 15 "project/radare2/libr/io/io_plugin.c" 3 4
        0
# 15 "project/radare2/libr/io/io_plugin.c"
             ;
 }
 ls_append (io->plugins, plugin);
 return 
# 18 "project/radare2/libr/io/io_plugin.c" 3 4
       1
# 18 "project/radare2/libr/io/io_plugin.c"
           ;
}


# 21 "project/radare2/libr/io/io_plugin.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 21 "project/radare2/libr/io/io_plugin.c"
          r_io_plugin_init(RIO *io) {
 RIOPlugin *static_plugin;
 int i;
 if (!io) {
  return 
# 25 "project/radare2/libr/io/io_plugin.c" 3 4
        0
# 25 "project/radare2/libr/io/io_plugin.c"
             ;
 }
 ...
 for (i = 0; io_static_plugins[i]; i++) {
  ...
  static_plugin = 
# 32 "project/radare2/libr/io/io_plugin.c" 3 4
                 (
# 32 "project/radare2/libr/io/io_plugin.c"
                 RIOPlugin
# 32 "project/radare2/libr/io/io_plugin.c" 3 4
                 *)calloc(1,sizeof(
# 32 "project/radare2/libr/io/io_plugin.c"
...
# 32 "project/radare2/libr/io/io_plugin.c"
  ...
  if (!static_plugin) {
   return 
# 34 "project/radare2/libr/io/io_plugin.c" 3 4
         0
# 34 "project/radare2/libr/io/io_plugin.c"
              ;
  }
  
# 36 "project/radare2/libr/io/io_plugin.c" 3 4
 __builtin___memcpy_chk (
# 36 "project/radare2/libr/io/io_plugin.c"
 static_plugin
# 36 "project/radare2/libr/io/io_plugin.c" 3 4
 , 
# 36 "project/radare2/libr/io/io_plugin.c"
 io_static_plugins[i], sizeof (RIOPlugin)
# 36 "project/radare2/libr/io/io_plugin.c" 3 4
...
# 36 "project/radare2/libr/io/io_plugin.c"
 ...
 return 
# 39 "project/radare2/libr/io/io_plugin.c" 3 4
       1
# 39 "project/radare2/libr/io/io_plugin.c"
           ;
}


# 42 "project/radare2/libr/io/io_plugin.c" 3 4
__attribute__((visibility("default"))) 
# 42 "project/radare2/libr/io/io_plugin.c"
     RIOPlugin *r_io_plugin_get_default(RIO *io, const char *filename, 
# 42 "project/radare2/libr/io/io_plugin.c" 3 4
                                                                       _Bool 
# 42 "project/radare2/libr/io/io_plugin.c"
                                                                            many) {
 if (!default_plugin || !default_plugin->check || !default_plugin->check (io, filename, many) ) {
  return 
# 44 "project/radare2/libr/io/io_plugin.c" 3 4
        ((void *)0)
# 44 "project/radare2/libr/io/io_plugin.c"
            ;
 }
...
# 49 "project/radare2/libr/io/io_plugin.c" 3 4
__attribute__((visibility("default"))) 
# 49 "project/radare2/libr/io/io_plugin.c"
     RIOPlugin *r_io_plugin_resolve(RIO *io, const char *filename, 
# 49 "project/radare2/libr/io/io_plugin.c" 3 4
                                                                   _Bool 
# 49 "project/radare2/libr/io/io_plugin.c"
                                                                        many) {
...
# 52 "project/radare2/libr/io/io_plugin.c" 3 4
if ((
# 52 "project/radare2/libr/io/io_plugin.c"
io->plugins
# 52 "project/radare2/libr/io/io_plugin.c" 3 4
)) for (
# 52 "project/radare2/libr/io/io_plugin.c"
...
# 63 "project/radare2/libr/io/io_plugin.c" 3 4
__attribute__((visibility("default"))) 
# 63 "project/radare2/libr/io/io_plugin.c"
     RIOPlugin *r_io_plugin_byname(RIO *io, const char *name) {
 SdbListIter *iter;
 RIOPlugin *iop;
 
# 66 "project/radare2/libr/io/io_plugin.c" 3 4
if ((
# 66 "project/radare2/libr/io/io_plugin.c"
io->plugins
# 66 "project/radare2/libr/io/io_plugin.c" 3 4
)) for (
# 66 "project/radare2/libr/io/io_plugin.c"
...
# 66 "project/radare2/libr/io/io_plugin.c"
 ...
 return r_io_plugin_get_default (io, name, 
# 71 "project/radare2/libr/io/io_plugin.c" 3 4
                                          0
# 71 "project/radare2/libr/io/io_plugin.c"
                                               );
}


# 74 "project/radare2/libr/io/io_plugin.c" 3 4
__attribute__((visibility("default"))) 
# 74 "project/radare2/libr/io/io_plugin.c"
     int r_io_plugin_list(RIO *io) {
 RIOPlugin *plugin;
 SdbListIter *iter;
 char str[4];
 int n = 0;
...
# 80 "project/radare2/libr/io/io_plugin.c" 3 4
if ((
# 80 "project/radare2/libr/io/io_plugin.c"
io->plugins
# 80 "project/radare2/libr/io/io_plugin.c" 3 4
)) for (
# 80 "project/radare2/libr/io/io_plugin.c"
...
# 96 "project/radare2/libr/io/io_plugin.c" 3 4
__attribute__((visibility("default"))) 
# 96 "project/radare2/libr/io/io_plugin.c"
     int r_io_plugin_list_json(RIO *io) {
 RIOPlugin *plugin;
 SdbListIter *iter;
 PJ *pj = pj_new ();
 if (!pj) {
...
# 107 "project/radare2/libr/io/io_plugin.c" 3 4
if ((
# 107 "project/radare2/libr/io/io_plugin.c"
io->plugins
# 107 "project/radare2/libr/io/io_plugin.c" 3 4
)) for (
# 107 "project/radare2/libr/io/io_plugin.c"
...
# 132 "project/radare2/libr/io/io_plugin.c" 3 4
  if (
# 132 "project/radare2/libr/io/io_plugin.c"
  plist
# 132 "project/radare2/libr/io/io_plugin.c" 3 4
  ) for (
# 132 "project/radare2/libr/io/io_plugin.c"
...
# 154 "project/radare2/libr/io/io_plugin.c" 3 4
__attribute__((visibility("default"))) 
# 154 "project/radare2/libr/io/io_plugin.c"
     int r_io_plugin_read(RIODesc *desc, 
# 154 "project/radare2/libr/io/io_plugin.c" 3 4
                                         unsigned char 
# 154 "project/radare2/libr/io/io_plugin.c"
                                             *buf, int len) {
 if (!buf || !desc || !desc->plugin || len < 1 || !(desc->perm & 
# 155 "project/radare2/libr/io/io_plugin.c" 3 4
                                                                4
# 155 "project/radare2/libr/io/io_plugin.c"
                                                                        )) {
  return 0;
 }
 if (!desc->plugin->read) {
...
# 164 "project/radare2/libr/io/io_plugin.c" 3 4
__attribute__((visibility("default"))) 
# 164 "project/radare2/libr/io/io_plugin.c"
     int r_io_plugin_write(RIODesc *desc, const 
# 164 "project/radare2/libr/io/io_plugin.c" 3 4
                                                unsigned char 
# 164 "project/radare2/libr/io/io_plugin.c"
                                                    *buf, int len) {
 if (!buf || !desc || !desc->plugin || len < 1 || !(desc->perm & 
# 165 "project/radare2/libr/io/io_plugin.c" 3 4
                                                                2
# 165 "project/radare2/libr/io/io_plugin.c"
                                                                        )) {
  return 0;
 }
 ...
 const 
# 171 "project/radare2/libr/io/io_plugin.c" 3 4
      unsigned long long 
# 171 "project/radare2/libr/io/io_plugin.c"
           cur_addr = r_io_desc_seek (desc, 0LL, 
# 171 "project/radare2/libr/io/io_plugin.c" 3 4
                                                 1
# 171 "project/radare2/libr/io/io_plugin.c"
                                                              );
...
# 178 "project/radare2/libr/io/io_plugin.c" 3 4
__attribute__((visibility("default"))) 
# 178 "project/radare2/libr/io/io_plugin.c"
     int r_io_plugin_read_at(RIODesc *desc, 
# 178 "project/radare2/libr/io/io_plugin.c" 3 4
                                            unsigned long long 
# 178 "project/radare2/libr/io/io_plugin.c"
                                                 addr, 
...
# 178 "project/radare2/libr/io/io_plugin.c"
                                                           *buf, int len) {
 if (r_io_desc_is_chardevice (desc) || (r_io_desc_seek (desc, addr, 
# 179 "project/radare2/libr/io/io_plugin.c" 3 4
                                                                   0
# 179 "project/radare2/libr/io/io_plugin.c"
                                                                                ) == addr)) {
...
# 185 "project/radare2/libr/io/io_plugin.c" 3 4
__attribute__((visibility("default"))) 
# 185 "project/radare2/libr/io/io_plugin.c"
     int r_io_plugin_write_at(RIODesc *desc, 
# 185 "project/radare2/libr/io/io_plugin.c" 3 4
                                             unsigned long long 
# 185 "project/radare2/libr/io/io_plugin.c"
                                                  addr, const 
...
# 185 "project/radare2/libr/io/io_plugin.c"
                                                                  *buf, int len) {
 if (r_io_desc_is_chardevice (desc) || r_io_desc_seek (desc, addr, 
# 186 "project/radare2/libr/io/io_plugin.c" 3 4
                                                                  0
# 186 "project/radare2/libr/io/io_plugin.c"
                                                                               ) == addr) {
