# 0 "project/radare2/libr/io/p/io_r2k_windows.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/io/p/io_r2k_windows.c"
# 1 "project/radare2/libr/io/p/io_r2k_windows.h" 1
...
# 5 "project/radare2/libr/io/p/io_r2k_windows.h" 2
...
# 6 "project/radare2/libr/io/p/io_r2k_windows.h" 2





# 10 "project/radare2/libr/io/p/io_r2k_windows.h"
typedef struct {
 HANDLE hnd;
} RIOW32;
typedef struct _PPA {
...
# 54 "project/radare2/libr/io/p/io_r2k_windows.h"
extern HANDLE gHandleDriver;

BOOL StartStopService(LPCTSTR lpServiceName, BOOL bStop);
int GetSystemModules(RIO *io);
int ReadKernelMemory (
# 58 "project/radare2/libr/io/p/io_r2k_windows.h" 3 4
                     unsigned long long 
# 58 "project/radare2/libr/io/p/io_r2k_windows.h"
                          address, 
# 58 "project/radare2/libr/io/p/io_r2k_windows.h" 3 4
                                   unsigned char 
# 58 "project/radare2/libr/io/p/io_r2k_windows.h"
                                       *buf, int len);
int WriteKernelMemory (
# 59 "project/radare2/libr/io/p/io_r2k_windows.h" 3 4
                      unsigned long long 
# 59 "project/radare2/libr/io/p/io_r2k_windows.h"
                           address, const 
# 59 "project/radare2/libr/io/p/io_r2k_windows.h" 3 4
                                          unsigned char 
# 59 "project/radare2/libr/io/p/io_r2k_windows.h"
...
# 2 "project/radare2/libr/io/p/io_r2k_windows.c" 2

HANDLE gHandleDriver = 
# 3 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
                      ((void *)0)
# 3 "project/radare2/libr/io/p/io_r2k_windows.c"
                          ;
...
# 8 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
                                   ((void *)0)
# 8 "project/radare2/libr/io/p/io_r2k_windows.c"
                                       , 
# 8 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
                                         ((void *)0)
# 8 "project/radare2/libr/io/p/io_r2k_windows.c"
 ...
 if (hSCManager) {
  ...
  hService = CreateService (hSCManager, lpServiceName, lpDisplayName, SERVICE_START | DELETE | SERVICE_STOP, SERVICE_KERNEL_DRIVER, SERVICE_DEMAND_START, SERVICE_ERROR_IGNORE, rutaDriver_, 
# 11 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
                                                                                                                                                                                            ((void *)0)
# 11 "project/radare2/libr/io/p/io_r2k_windows.c"
                                                                                                                                                                                                , 
# 11 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
                                                                                                                                                                                                  ((void *)0)
# 11 "project/radare2/libr/io/p/io_r2k_windows.c"
...
static BOOL RemoveService(LPCTSTR lpServiceName) {
 ...
 BOOL ret = FALSE;
 HANDLE hSCManager = OpenSCManager (
# 25 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
                                   ((void *)0)
# 25 "project/radare2/libr/io/p/io_r2k_windows.c"
                                       , 
# 25 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
                                         ((void *)0)
# 25 "project/radare2/libr/io/p/io_r2k_windows.c"
...
# 43 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
                            ((void *)0)
# 43 "project/radare2/libr/io/p/io_r2k_windows.c"
                                , 
# 43 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
                                  ((void *)0)
# 43 "project/radare2/libr/io/p/io_r2k_windows.c"
 ...
 if (hSCManager) {
  ...
  if (hService) {
   if (!bStop) {
    if (StartService (hService, 0, 
# 48 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
                                  ((void *)0)
# 48 "project/radare2/libr/io/p/io_r2k_windows.c"
                                      )) {
     
# 49 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
    fprintf(__stderrp,
# 49 "project/radare2/libr/io/p/io_r2k_windows.c"
    "Service started [OK]\n"
# 49 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
    )
# 49 "project/radare2/libr/io/p/io_r2k_windows.c"
...
# 52 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
    fprintf(__stderrp,
# 52 "project/radare2/libr/io/p/io_r2k_windows.c"
...
# 56 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
    fprintf(__stderrp,
# 56 "project/radare2/libr/io/p/io_r2k_windows.c"
    "Service Stopped [OK]\n"
# 56 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
    )
# 56 "project/radare2/libr/io/p/io_r2k_windows.c"
...
# 59 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
    fprintf(__stderrp,
# 59 "project/radare2/libr/io/p/io_r2k_windows.c"
...
static BOOL InitDriver(VOID) {
 ...
 gHandleDriver = CreateFile (TEXT ("\\\\.\\r2k\\"), genericFlags, shareFlags,
  
# 74 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
 ((void *)0)
# 74 "project/radare2/libr/io/p/io_r2k_windows.c"
     , OPEN_ALWAYS, FILE_ATTRIBUTE_DIRECTORY, 0);
...
int GetSystemModules(RIO *io) {
 ...
 int i;
 LPVOID lpBufMods = 
# 92 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
                   ((void *)0)
# 92 "project/radare2/libr/io/p/io_r2k_windows.c"
                       ;
 int bufmodsize = 1024 * 1024;
 if(gHandleDriver) {
  if (!(lpBufMods = malloc (bufmodsize))) {
   
# 96 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
  fprintf(__stderrp,
# 96 "project/radare2/libr/io/p/io_r2k_windows.c"
  "[r2k] GetSystemModules: Error can't allocate %i bytes of memory.\n", bufmodsize
# 96 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
  )
# 96 "project/radare2/libr/io/p/io_r2k_windows.c"
                                                                                            ;
  ...
  if (DeviceIoControl (gHandleDriver, (((0x22) << 16) | ((1 | 2) << 14) | ((0x80a) << 2) | (0)), lpBufMods, bufmodsize, lpBufMods, bufmodsize, &bRead, 
# 99 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
                                                                                                                     ((void *)0)
# 99 "project/radare2/libr/io/p/io_r2k_windows.c"
                                                                                                                         )) {
...
# 108 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
 fprintf(__stderrp,
# 108 "project/radare2/libr/io/p/io_r2k_windows.c"
...
int ReadKernelMemory (
# 113 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
                     unsigned long long 
# 113 "project/radare2/libr/io/p/io_r2k_windows.c"
                          address, 
# 113 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
                                   unsigned char 
# 113 "project/radare2/libr/io/p/io_r2k_windows.c"
 ...
 DWORD ret = -1, bRead = 0;
 LPVOID lpBuffer = 
# 115 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
                  ((void *)0)
# 115 "project/radare2/libr/io/p/io_r2k_windows.c"
                      ;
 int bufsize;
 PPA p;
 
# 118 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
__builtin___memset_chk (
# 118 "project/radare2/libr/io/p/io_r2k_windows.c"
buf
# 118 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
, 
# 118 "project/radare2/libr/io/p/io_r2k_windows.c"
...
# 122 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
  fprintf(__stderrp,
# 122 "project/radare2/libr/io/p/io_r2k_windows.c"
  "[r2k] ReadKernelMemory: Error can't allocate %i bytes of memory.\n", bufsize
# 122 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
  )
# 122 "project/radare2/libr/io/p/io_r2k_windows.c"
                                                                                         ;
  ...
  p->len = len;
  if (DeviceIoControl (gHandleDriver, (((0x22) << 16) | ((1 | 2) << 14) | ((0x804) << 2) | (0)), lpBuffer, bufsize, lpBuffer, bufsize, &bRead, 
# 128 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
                                                                                                          ((void *)0)
# 128 "project/radare2/libr/io/p/io_r2k_windows.c"
                                                                                                              )) {
   
# 129 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
  __builtin___memcpy_chk (
# 129 "project/radare2/libr/io/p/io_r2k_windows.c"
  buf
# 129 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
  , 
# 129 "project/radare2/libr/io/p/io_r2k_windows.c"
...
# 137 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
 fprintf(__stderrp,
# 137 "project/radare2/libr/io/p/io_r2k_windows.c"
 "Driver not initialized.\n"
# 137 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
 )
# 137 "project/radare2/libr/io/p/io_r2k_windows.c"
...
int WriteKernelMemory (
# 142 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
                      unsigned long long 
# 142 "project/radare2/libr/io/p/io_r2k_windows.c"
                           address, const 
# 142 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
                                          unsigned char 
# 142 "project/radare2/libr/io/p/io_r2k_windows.c"
 ...
 DWORD ret = -1, bRead = 0;
 LPVOID lpBuffer = 
# 144 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
                  ((void *)0)
# 144 "project/radare2/libr/io/p/io_r2k_windows.c"
                      ;
 int bufsize;
 PPA p;
 if(gHandleDriver) {
...
# 150 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
  fprintf(__stderrp,
# 150 "project/radare2/libr/io/p/io_r2k_windows.c"
  "[r2k] WriteKernelMemory: Error can't allocate %i bytes of memory.\n", bufsize
# 150 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
  )
# 150 "project/radare2/libr/io/p/io_r2k_windows.c"
                                                                                          ;
...
# 156 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
 __builtin___memcpy_chk (
# 156 "project/radare2/libr/io/p/io_r2k_windows.c"
 &p->buffer
# 156 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
 , 
# 156 "project/radare2/libr/io/p/io_r2k_windows.c"
...
# 156 "project/radare2/libr/io/p/io_r2k_windows.c"
                              ;
  if (DeviceIoControl (gHandleDriver, (((0x22) << 16) | ((1 | 2) << 14) | ((0x805) << 2) | (0)), lpBuffer, bufsize, lpBuffer, bufsize, &bRead, 
# 157 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
                                                                                                           ((void *)0)
# 157 "project/radare2/libr/io/p/io_r2k_windows.c"
                                                                                                               )) {
   ret = len;
  } else {
   
# 160 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
  fprintf(__stderrp,
# 160 "project/radare2/libr/io/p/io_r2k_windows.c"
  "[r2k] WriteKernelMemory: Error IOCTL_WRITE_KERNEL_MEM.\n"
# 160 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
  )
# 160 "project/radare2/libr/io/p/io_r2k_windows.c"
                                                                      ;
...
# 165 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
 fprintf(__stderrp,
# 165 "project/radare2/libr/io/p/io_r2k_windows.c"
 "Driver not initialized.\n"
# 165 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
 )
# 165 "project/radare2/libr/io/p/io_r2k_windows.c"
...
# 176 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
  fprintf(__stderrp,
# 176 "project/radare2/libr/io/p/io_r2k_windows.c"
  "Installing driver: %s\n", driverPath
# 176 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
  )
# 176 "project/radare2/libr/io/p/io_r2k_windows.c"
...
# 182 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
  fprintf(__stderrp,
# 182 "project/radare2/libr/io/p/io_r2k_windows.c"
  "Error initalizating driver, try r2k://pathtodriver\nEx: radare2.exe r2k://c:\\r2k.sys"
# 182 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
  )
# 182 "project/radare2/libr/io/p/io_r2k_windows.c"
                                                                                                   ;
...
# 185 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
 fprintf(__stderrp,
# 185 "project/radare2/libr/io/p/io_r2k_windows.c"
 "Driver present [OK]\n"
# 185 "project/radare2/libr/io/p/io_r2k_windows.c" 3 4
 )
# 185 "project/radare2/libr/io/p/io_r2k_windows.c"
