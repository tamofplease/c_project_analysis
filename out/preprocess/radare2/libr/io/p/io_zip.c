# 0 "project/radare2/libr/io/p/io_zip.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/io/p/io_zip.c"
...
# 8 "project/radare2/libr/io/p/io_zip.c" 2
...
# 9 "project/radare2/libr/io/p/io_zip.c" 2
...
# 19 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/zip/include/zipconf.h" 3 4
...
extern zip_int64_t zip_add(struct zip *, const char *, struct zip_source *);
extern zip_int64_t zip_add_dir(struct zip *, const char *);
extern const char *zip_get_file_comment(struct zip *, zip_uint64_t, int *, int);
extern int zip_get_num_files(struct zip *);
extern int zip_rename(struct zip *, zip_uint64_t, const char *);
extern int zip_replace(struct zip *, zip_uint64_t, struct zip_source *);
extern int zip_set_file_comment(struct zip *, zip_uint64_t, const char *, int);
...
# 12 "project/radare2/libr/io/p/io_zip.c" 2



# 14 "project/radare2/libr/io/p/io_zip.c"
typedef enum {
...
# 25 "project/radare2/libr/io/p/io_zip.c" 3 4
unsigned int 
# 25 "project/radare2/libr/io/p/io_zip.c"
     len;
} RIOZipConstURI;
...
static RIOZipConstURI ZIP_URIS[] = {
 ...
 {"jar://", 6},
 {
# 32 "project/radare2/libr/io/p/io_zip.c" 3 4
 ((void *)0)
# 32 "project/radare2/libr/io/p/io_zip.c"
     , 0}
};
...
static RIOZipConstURI ZIP_ALL_URIS[] = {
 ...
 {"jarall://", 9},
 {
# 41 "project/radare2/libr/io/p/io_zip.c" 3 4
 ((void *)0)
# 41 "project/radare2/libr/io/p/io_zip.c"
     , 0}
};
...
# 51 "project/radare2/libr/io/p/io_zip.c" 3 4
unsigned long long 
# 51 "project/radare2/libr/io/p/io_zip.c"
     entry;
 int perm;
 
# 53 "project/radare2/libr/io/p/io_zip.c" 3 4
unsigned char 
# 53 "project/radare2/libr/io/p/io_zip.c"
    modified;
 RBuffer *b;
 char *password;
 
# 56 "project/radare2/libr/io/p/io_zip.c" 3 4
unsigned char 
# 56 "project/radare2/libr/io/p/io_zip.c"
    encryption_value;
 RIO * io_backref;
} RIOZipFileObj;
...
static 
# 64 "project/radare2/libr/io/p/io_zip.c" 3 4
      _Bool 
# 64 "project/radare2/libr/io/p/io_zip.c"
           r_io_zip_check_uri_many(const char *file) {
 int i;
 if (r_io_zip_has_uri_substr (file)) {
  for (i = 0; ZIP_ALL_URIS[i].name; i++) {
   if (!strncmp (file, ZIP_ALL_URIS[i].name, ZIP_ALL_URIS[i].len) && file[ZIP_ALL_URIS[i].len]) {
    return 
# 69 "project/radare2/libr/io/p/io_zip.c" 3 4
          1
# 69 "project/radare2/libr/io/p/io_zip.c"
              ;
   }
  }
 }
 return 
# 73 "project/radare2/libr/io/p/io_zip.c" 3 4
       0
# 73 "project/radare2/libr/io/p/io_zip.c"
            ;
}

static 
# 76 "project/radare2/libr/io/p/io_zip.c" 3 4
      _Bool 
# 76 "project/radare2/libr/io/p/io_zip.c"
           r_io_zip_check_uri(const char *file) {
 int i;
 if (r_io_zip_has_uri_substr (file)) {
  for (i = 0; ZIP_URIS[i].name; i++) {
   if (!strncmp (file, ZIP_URIS[i].name, ZIP_URIS[i].len) && file[ZIP_URIS[i].len]) {
    return 
# 81 "project/radare2/libr/io/p/io_zip.c" 3 4
          1
# 81 "project/radare2/libr/io/p/io_zip.c"
              ;
   }
  }
 }
 return 
# 85 "project/radare2/libr/io/p/io_zip.c" 3 4
       0
# 85 "project/radare2/libr/io/p/io_zip.c"
            ;
}

static 
# 88 "project/radare2/libr/io/p/io_zip.c" 3 4
      _Bool 
# 88 "project/radare2/libr/io/p/io_zip.c"
           r_io_zip_plugin_open(RIO *io, const char *file, 
# 88 "project/radare2/libr/io/p/io_zip.c" 3 4
                                                           _Bool 
# 88 "project/radare2/libr/io/p/io_zip.c"
                                                                many) {
 ...
 return 
# 95 "project/radare2/libr/io/p/io_zip.c" 3 4
       0
# 95 "project/radare2/libr/io/p/io_zip.c"
            ;
}

struct zip *r_io_zip_open_archive(const char *archivename, 
# 98 "project/radare2/libr/io/p/io_zip.c" 3 4
                                                          unsigned int 
# 98 "project/radare2/libr/io/p/io_zip.c"
                                                               perm, int mode, int rw) {
 struct zip * zipArch = 
# 99 "project/radare2/libr/io/p/io_zip.c" 3 4
                       ((void *)0)
# 99 "project/radare2/libr/io/p/io_zip.c"
                           ;
 int zip_errorp;
 if (!archivename) {
  return 
# 102 "project/radare2/libr/io/p/io_zip.c" 3 4
        ((void *)0)
# 102 "project/radare2/libr/io/p/io_zip.c"
            ;
 }
 ...
 if (zip_errorp == 
# 107 "project/radare2/libr/io/p/io_zip.c" 3 4
                  18
# 107 "project/radare2/libr/io/p/io_zip.c"
                              ) {
  
# 108 "project/radare2/libr/io/p/io_zip.c" 3 4
 fprintf(__stderrp,
# 108 "project/radare2/libr/io/p/io_zip.c"
...
# 109 "project/radare2/libr/io/p/io_zip.c" 3 4
                         11
# 109 "project/radare2/libr/io/p/io_zip.c"
                                    ) {
  
# 110 "project/radare2/libr/io/p/io_zip.c" 3 4
 fprintf(__stderrp,
# 110 "project/radare2/libr/io/p/io_zip.c"
...
# 111 "project/radare2/libr/io/p/io_zip.c" 3 4
                         9
# 111 "project/radare2/libr/io/p/io_zip.c"
                                     ) {
  
# 112 "project/radare2/libr/io/p/io_zip.c" 3 4
 fprintf(__stderrp,
# 112 "project/radare2/libr/io/p/io_zip.c"
...
# 113 "project/radare2/libr/io/p/io_zip.c" 3 4
                         5
# 113 "project/radare2/libr/io/p/io_zip.c"
                                    ) {
  
# 114 "project/radare2/libr/io/p/io_zip.c" 3 4
 fprintf(__stderrp,
# 114 "project/radare2/libr/io/p/io_zip.c"
...
# 115 "project/radare2/libr/io/p/io_zip.c" 3 4
                         19
# 115 "project/radare2/libr/io/p/io_zip.c"
                                     ) {
  
# 116 "project/radare2/libr/io/p/io_zip.c" 3 4
 fprintf(__stderrp,
# 116 "project/radare2/libr/io/p/io_zip.c"
...
# 117 "project/radare2/libr/io/p/io_zip.c" 3 4
                         21
# 117 "project/radare2/libr/io/p/io_zip.c"
                                      ) {
  
# 118 "project/radare2/libr/io/p/io_zip.c" 3 4
 fprintf(__stderrp,
# 118 "project/radare2/libr/io/p/io_zip.c"
...
# 120 "project/radare2/libr/io/p/io_zip.c" 3 4
 fprintf(__stderrp,
# 120 "project/radare2/libr/io/p/io_zip.c"
...
# 120 "project/radare2/libr/io/p/io_zip.c"
 ...
 return 
# 122 "project/radare2/libr/io/p/io_zip.c" 3 4
       ((void *)0)
# 122 "project/radare2/libr/io/p/io_zip.c"
           ;
}

static int r_io_zip_slurp_file(RIOZipFileObj *zfo) {
 struct zip_file *zFile = 
# 126 "project/radare2/libr/io/p/io_zip.c" 3 4
                         ((void *)0)
# 126 "project/radare2/libr/io/p/io_zip.c"
                             ;
 struct zip *zipArch;
 struct zip_stat sb;
 
# 129 "project/radare2/libr/io/p/io_zip.c" 3 4
_Bool 
# 129 "project/radare2/libr/io/p/io_zip.c"
     res = 
# 129 "project/radare2/libr/io/p/io_zip.c" 3 4
           0
# 129 "project/radare2/libr/io/p/io_zip.c"
 ...
 if (zipArch && zfo && zfo->entry != -1) {
  ...
  if (!zFile) {
   zip_close (zipArch);
   return 
# 141 "project/radare2/libr/io/p/io_zip.c" 3 4
         0
# 141 "project/radare2/libr/io/p/io_zip.c"
              ;
  }
  if (!zfo->b) {
   zfo->b = r_buf_new ();
...
# 148 "project/radare2/libr/io/p/io_zip.c" 3 4
  unsigned char 
# 148 "project/radare2/libr/io/p/io_zip.c"
      *buf = calloc (1, sb.size);
   if (buf) {
    zip_fread (zFile, buf, sb.size);
    r_buf_set_bytes (zfo->b, buf, sb.size);
    res = 
# 152 "project/radare2/libr/io/p/io_zip.c" 3 4
         1
# 152 "project/radare2/libr/io/p/io_zip.c"
             ;
    zfo->opened = 
# 153 "project/radare2/libr/io/p/io_zip.c" 3 4
                 1
# 153 "project/radare2/libr/io/p/io_zip.c"
                     ;
    free (buf);
   }
  }
...
RList * r_io_zip_get_files(char *archivename, 
# 163 "project/radare2/libr/io/p/io_zip.c" 3 4
                                             unsigned int 
# 163 "project/radare2/libr/io/p/io_zip.c"
                                                  perm, int mode, int rw) {
 struct zip *zipArch = r_io_zip_open_archive (archivename, perm, mode, rw);
 
# 165 "project/radare2/libr/io/p/io_zip.c" 3 4
unsigned long long 
# 165 "project/radare2/libr/io/p/io_zip.c"
     num_entries = 0, i = 0;
 RList *files = 
# 166 "project/radare2/libr/io/p/io_zip.c" 3 4
               ((void *)0)
# 166 "project/radare2/libr/io/p/io_zip.c"
                   ;
 struct zip_stat sb;
 char *name;
 if (zipArch) {
  ...
  if (!files) {
   zip_close (zipArch);
   return 
# 173 "project/radare2/libr/io/p/io_zip.c" 3 4
         ((void *)0)
# 173 "project/radare2/libr/io/p/io_zip.c"
             ;
  }
...
int r_io_zip_flush_file(RIOZipFileObj *zfo) {
 int res = 
# 189 "project/radare2/libr/io/p/io_zip.c" 3 4
          0
# 189 "project/radare2/libr/io/p/io_zip.c"
               ;
 struct zip * zipArch;
...
# 202 "project/radare2/libr/io/p/io_zip.c" 3 4
unsigned long long 
# 202 "project/radare2/libr/io/p/io_zip.c"
     tmpsz;
 const 
# 203 "project/radare2/libr/io/p/io_zip.c" 3 4
      unsigned char 
# 203 "project/radare2/libr/io/p/io_zip.c"
          *tmp = r_buf_data (zfo->b, &tmpsz);
 struct zip_source *s = zip_source_buffer (zipArch, tmp, tmpsz, 0);
 if (s && zfo->entry != -1) {
  if (zip_replace(zipArch, zfo->entry, s) == 0) {
   res = 
# 207 "project/radare2/libr/io/p/io_zip.c" 3 4
        1
# 207 "project/radare2/libr/io/p/io_zip.c"
            ;
  }
 } else if (s && zfo->name) {
  if (zip_add (zipArch, zfo->name, s) == 0) {
   ...
   res = 
# 212 "project/radare2/libr/io/p/io_zip.c" 3 4
        1
# 212 "project/radare2/libr/io/p/io_zip.c"
            ;
  }
 }
...
RIOZipFileObj *r_io_zip_create_new_file(const char *archivename, const char *filename, struct zip_stat *sb, 
# 236 "project/radare2/libr/io/p/io_zip.c" 3 4
                                                                                                           unsigned int 
# 236 "project/radare2/libr/io/p/io_zip.c"
                                                                                                                perm, int mode, int rw) {
 RIOZipFileObj *zfo = 
# 237 "project/radare2/libr/io/p/io_zip.c" 3 4
                     (
# 237 "project/radare2/libr/io/p/io_zip.c"
                     RIOZipFileObj
# 237 "project/radare2/libr/io/p/io_zip.c" 3 4
                     *)calloc(1,sizeof(
# 237 "project/radare2/libr/io/p/io_zip.c"
...
RIOZipFileObj* r_io_zip_alloc_zipfileobj(const char *archivename, const char *filename, 
# 252 "project/radare2/libr/io/p/io_zip.c" 3 4
                                                                                       unsigned int 
# 252 "project/radare2/libr/io/p/io_zip.c"
                                                                                            perm, int mode, int rw) {
 RIOZipFileObj *zfo = 
# 253 "project/radare2/libr/io/p/io_zip.c" 3 4
                     ((void *)0)
# 253 "project/radare2/libr/io/p/io_zip.c"
                         ;
 
# 254 "project/radare2/libr/io/p/io_zip.c" 3 4
unsigned long long 
# 254 "project/radare2/libr/io/p/io_zip.c"
     i, num_entries;
 struct zip_stat sb;
 struct zip *zipArch = r_io_zip_open_archive (archivename, perm, mode, rw);
 if (!zipArch) {
  return 
# 258 "project/radare2/libr/io/p/io_zip.c" 3 4
        ((void *)0)
# 258 "project/radare2/libr/io/p/io_zip.c"
            ;
 }
 num_entries = zip_get_num_files (zipArch);
 ...
 for (i = 0; i < num_entries; i++) {
  ...
  zip_stat_index (zipArch, i, 0, &sb);
  if (sb.name != 
# 265 "project/radare2/libr/io/p/io_zip.c" 3 4
                ((void *)0)
# 265 "project/radare2/libr/io/p/io_zip.c"
                    ) {
 ...
 if (!zfo) {
  zfo = r_io_zip_create_new_file (archivename,
   filename, 
# 277 "project/radare2/libr/io/p/io_zip.c" 3 4
            ((void *)0)
# 277 "project/radare2/libr/io/p/io_zip.c"
                , perm, mode, rw);
 }
 zip_close (zipArch);
 return zfo;
...
static RList *r_io_zip_open_many(RIO *io, const char *file, int rw, int mode) {
 RList *list_fds = 
# 285 "project/radare2/libr/io/p/io_zip.c" 3 4
                  ((void *)0)
# 285 "project/radare2/libr/io/p/io_zip.c"
                      ;
 RListIter *iter;
 RIODesc *res = 
# 287 "project/radare2/libr/io/p/io_zip.c" 3 4
               ((void *)0)
# 287 "project/radare2/libr/io/p/io_zip.c"
                   ;
 char *filename_in_zipfile, *zip_filename = 
# 288 "project/radare2/libr/io/p/io_zip.c" 3 4
                                           ((void *)0)
# 288 "project/radare2/libr/io/p/io_zip.c"
                                               , *zip_uri;

 if (!r_io_zip_plugin_open (io, file, 
# 290 "project/radare2/libr/io/p/io_zip.c" 3 4
                                     1
# 290 "project/radare2/libr/io/p/io_zip.c"
                                         )) {
  return 
# 291 "project/radare2/libr/io/p/io_zip.c" 3 4
        ((void *)0)
# 291 "project/radare2/libr/io/p/io_zip.c"
            ;
 }
 ...
 if (!zip_uri) {
  return 
# 296 "project/radare2/libr/io/p/io_zip.c" 3 4
        ((void *)0)
# 296 "project/radare2/libr/io/p/io_zip.c"
            ;
 }
  ...
  *zip_filename++ = 0;
  ...
  free (zip_uri);
  return 
# 308 "project/radare2/libr/io/p/io_zip.c" 3 4
        ((void *)0)
# 308 "project/radare2/libr/io/p/io_zip.c"
            ;
 }
 ...
 if (!filenames) {
  free (zip_uri);
  return 
# 315 "project/radare2/libr/io/p/io_zip.c" 3 4
        ((void *)0)
# 315 "project/radare2/libr/io/p/io_zip.c"
            ;
 }

 list_fds = r_list_new ();
 
# 319 "project/radare2/libr/io/p/io_zip.c" 3 4
if (
# 319 "project/radare2/libr/io/p/io_zip.c"
filenames
# 319 "project/radare2/libr/io/p/io_zip.c" 3 4
) for (
# 319 "project/radare2/libr/io/p/io_zip.c"
...
# 319 "project/radare2/libr/io/p/io_zip.c"
  ...
  RIOZipFileObj *zfo = r_io_zip_alloc_zipfileobj (zip_filename,
   filename_in_zipfile, 
# 326 "project/radare2/libr/io/p/io_zip.c" 3 4
                       1
# 326 "project/radare2/libr/io/p/io_zip.c"
                                 , mode, rw);

  if (zfo && zfo->entry == -1) {
   
# 329 "project/radare2/libr/io/p/io_zip.c" 3 4
  fprintf(__stderrp,
# 329 "project/radare2/libr/io/p/io_zip.c"
...
# 333 "project/radare2/libr/io/p/io_zip.c" 3 4
  _Bool 
# 333 "project/radare2/libr/io/p/io_zip.c"
       append = 
# 333 "project/radare2/libr/io/p/io_zip.c" 3 4
                0
# 333 "project/radare2/libr/io/p/io_zip.c"
   ...
   if (r_str_startswith (file, "apkall://") || r_str_startswith (file, "apk://")) {
    if (!strcmp (zfo->name, "AndroidManifest.xml")) {
     append = 
# 336 "project/radare2/libr/io/p/io_zip.c" 3 4
             1
# 336 "project/radare2/libr/io/p/io_zip.c"
                 ;
    } else if (r_str_endswith (zfo->name, ".dex")) {
     append = 
# 338 "project/radare2/libr/io/p/io_zip.c" 3 4
             1
# 338 "project/radare2/libr/io/p/io_zip.c"
                 ;
    }
   } else {
    append = 
# 341 "project/radare2/libr/io/p/io_zip.c" 3 4
            1
# 341 "project/radare2/libr/io/p/io_zip.c"
                ;
   }
   if (append) {
...
char * r_io_zip_get_by_file_idx(const char * archivename, const char *idx, 
# 358 "project/radare2/libr/io/p/io_zip.c" 3 4
                                                                          unsigned int 
# 358 "project/radare2/libr/io/p/io_zip.c"
                                                                               perm, int mode, int rw) {
 char *filename = 
# 359 "project/radare2/libr/io/p/io_zip.c" 3 4
                 ((void *)0)
# 359 "project/radare2/libr/io/p/io_zip.c"
                     ;
 
# 360 "project/radare2/libr/io/p/io_zip.c" 3 4
unsigned long long 
# 360 "project/radare2/libr/io/p/io_zip.c"
     i, num_entries;
 
# 361 "project/radare2/libr/io/p/io_zip.c" 3 4
unsigned int 
# 361 "project/radare2/libr/io/p/io_zip.c"
     file_idx = -1;
 struct zip_stat sb;
 struct zip * zipArch = r_io_zip_open_archive (archivename, perm, mode, rw);
 if (!idx || !zipArch) {
...
static RIODesc *r_io_zip_open(RIO *io, const char *file, int rw, int mode) {
 RIODesc *res = 
# 387 "project/radare2/libr/io/p/io_zip.c" 3 4
               ((void *)0)
# 387 "project/radare2/libr/io/p/io_zip.c"
                   ;
 char *pikaboo, *tmp;
 char *zip_filename = 
# 389 "project/radare2/libr/io/p/io_zip.c" 3 4
                     ((void *)0)
# 389 "project/radare2/libr/io/p/io_zip.c"
                         , *filename_in_zipfile = 
# 389 "project/radare2/libr/io/p/io_zip.c" 3 4
                                                  ((void *)0)
# 389 "project/radare2/libr/io/p/io_zip.c"
 ...
 if (!r_io_zip_plugin_open (io, file, 
# 391 "project/radare2/libr/io/p/io_zip.c" 3 4
                                     0
# 391 "project/radare2/libr/io/p/io_zip.c"
                                          )) {
  return 
# 392 "project/radare2/libr/io/p/io_zip.c" 3 4
        ((void *)0)
# 392 "project/radare2/libr/io/p/io_zip.c"
            ;
 }
 char *zip_uri = strdup (file);
 if (!zip_uri) {
  return 
# 396 "project/radare2/libr/io/p/io_zip.c" 3 4
        ((void *)0)
# 396 "project/radare2/libr/io/p/io_zip.c"
            ;
 }
 pikaboo = strstr (zip_uri, "://");
 if (pikaboo) {
  tmp = strstr (pikaboo + 3, "//");
  zip_filename = tmp ? strdup (tmp) : 
# 401 "project/radare2/libr/io/p/io_zip.c" 3 4
                                     ((void *)0)
# 401 "project/radare2/libr/io/p/io_zip.c"
                                         ;
...
# 410 "project/radare2/libr/io/p/io_zip.c" 3 4
    if (
# 410 "project/radare2/libr/io/p/io_zip.c"
    files
# 410 "project/radare2/libr/io/p/io_zip.c" 3 4
    ) for (
# 410 "project/radare2/libr/io/p/io_zip.c"
...
# 462 "project/radare2/libr/io/p/io_zip.c" 3 4
   1
# 462 "project/radare2/libr/io/p/io_zip.c"
             , mode, rw);
  } else {
   filename_in_zipfile = r_str_newf ("%s", zip_filename);
   
# 465 "project/radare2/libr/io/p/io_zip.c" 3 4
  { free((void *)
# 465 "project/radare2/libr/io/p/io_zip.c"
  tmp
# 465 "project/radare2/libr/io/p/io_zip.c" 3 4
  ); 
# 465 "project/radare2/libr/io/p/io_zip.c"
...
# 469 "project/radare2/libr/io/p/io_zip.c" 3 4
   { free((void *)
# 469 "project/radare2/libr/io/p/io_zip.c"
   filename_in_zipfile
# 469 "project/radare2/libr/io/p/io_zip.c" 3 4
   ); 
# 469 "project/radare2/libr/io/p/io_zip.c"
...
# 476 "project/radare2/libr/io/p/io_zip.c" 3 4
 fprintf(__stderrp,
# 476 "project/radare2/libr/io/p/io_zip.c"
 "usage: zip:///path/to/archive//filepath\n" "usage: zip:///path/to/archive::[number]\n" "Archive was not found.\n"
# 476 "project/radare2/libr/io/p/io_zip.c" 3 4
 )

                              
# 478 "project/radare2/libr/io/p/io_zip.c"
                             ;
 ...
 if (!filename_in_zipfile) {
  RList *files = 
# 484 "project/radare2/libr/io/p/io_zip.c" 3 4
                ((void *)0)
# 484 "project/radare2/libr/io/p/io_zip.c"
                    ;
  RListIter *iter;
  char *name;
...
# 490 "project/radare2/libr/io/p/io_zip.c" 3 4
  unsigned int 
# 490 "project/radare2/libr/io/p/io_zip.c"
       i = 0;
   
# 491 "project/radare2/libr/io/p/io_zip.c" 3 4
  if (
# 491 "project/radare2/libr/io/p/io_zip.c"
  files
# 491 "project/radare2/libr/io/p/io_zip.c" 3 4
  ) for (
# 491 "project/radare2/libr/io/p/io_zip.c"
...
# 491 "project/radare2/libr/io/p/io_zip.c"
 ...
 RIOZipFileObj *zfo = r_io_zip_alloc_zipfileobj (zip_filename, filename_in_zipfile, 
# 502 "project/radare2/libr/io/p/io_zip.c" 3 4
                                                                                   1
# 502 "project/radare2/libr/io/p/io_zip.c"
                                                                                             , mode, rw);
 if (zfo) {
  if (zfo->entry == -1) {
   
# 505 "project/radare2/libr/io/p/io_zip.c" 3 4
  fprintf(__stderrp,
# 505 "project/radare2/libr/io/p/io_zip.c"
  "Warning: File did not exist, creating a new one.\n"
# 505 "project/radare2/libr/io/p/io_zip.c" 3 4
  )
# 505 "project/radare2/libr/io/p/io_zip.c"
...
# 512 "project/radare2/libr/io/p/io_zip.c" 3 4
 fprintf(__stderrp,
# 512 "project/radare2/libr/io/p/io_zip.c"
 "Failed to open the archive %s and file %s\n", zip_filename, filename_in_zipfile
# 512 "project/radare2/libr/io/p/io_zip.c" 3 4
 )
                                     
# 513 "project/radare2/libr/io/p/io_zip.c"
                                    ;

  r_io_desc_free (res);
  res = 
# 516 "project/radare2/libr/io/p/io_zip.c" 3 4
       ((void *)0)
# 516 "project/radare2/libr/io/p/io_zip.c"
           ;
 }
done:
...
static 
# 525 "project/radare2/libr/io/p/io_zip.c" 3 4
      unsigned long long 
# 525 "project/radare2/libr/io/p/io_zip.c"
           r_io_zip_lseek(RIO *io, RIODesc *fd, 
# 525 "project/radare2/libr/io/p/io_zip.c" 3 4
                                                unsigned long long 
# 525 "project/radare2/libr/io/p/io_zip.c"
                                                     offset, int whence) {
...
# 527 "project/radare2/libr/io/p/io_zip.c" 3 4
unsigned long long 
# 527 "project/radare2/libr/io/p/io_zip.c"
     seek_val = 0;
 ...
 switch (whence) {
 case 
# 537 "project/radare2/libr/io/p/io_zip.c" 3 4
     0
# 537 "project/radare2/libr/io/p/io_zip.c"
             :
  seek_val = (r_buf_size (zfo->b) < offset)? r_buf_size (zfo->b): offset;
  io->off = seek_val;
  r_buf_seek (zfo->b, seek_val, 
# 540 "project/radare2/libr/io/p/io_zip.c" 3 4
                               0
# 540 "project/radare2/libr/io/p/io_zip.c"
                                        );
  return seek_val;
 case 
# 542 "project/radare2/libr/io/p/io_zip.c" 3 4
     1
# 542 "project/radare2/libr/io/p/io_zip.c"
             :
  seek_val = (r_buf_size (zfo->b) < (offset + r_buf_tell (zfo->b)))? r_buf_size (zfo->b): offset + r_buf_tell (zfo->b);
  io->off = seek_val;
  r_buf_seek (zfo->b, seek_val, 
# 545 "project/radare2/libr/io/p/io_zip.c" 3 4
                               0
# 545 "project/radare2/libr/io/p/io_zip.c"
                                        );
  return seek_val;
 case 
# 547 "project/radare2/libr/io/p/io_zip.c" 3 4
     2
# 547 "project/radare2/libr/io/p/io_zip.c"
             :
  seek_val = r_buf_size (zfo->b);
  io->off = seek_val;
  r_buf_seek (zfo->b, seek_val, 
# 550 "project/radare2/libr/io/p/io_zip.c" 3 4
                               0
# 550 "project/radare2/libr/io/p/io_zip.c"
                                        );
  return seek_val;
 }
 return seek_val;
...
static int r_io_zip_read(RIO *io, RIODesc *fd, 
# 556 "project/radare2/libr/io/p/io_zip.c" 3 4
                                              unsigned char 
# 556 "project/radare2/libr/io/p/io_zip.c"
                                                  *buf, int count) {
 RIOZipFileObj *zfo = 
# 557 "project/radare2/libr/io/p/io_zip.c" 3 4
                     ((void *)0)
# 557 "project/radare2/libr/io/p/io_zip.c"
                         ;
 if (!fd || !fd->data || !buf) {
  return -1;
 }
 ...
 if (r >= 0) {
  r_buf_seek (zfo->b, r, 
# 567 "project/radare2/libr/io/p/io_zip.c" 3 4
                        1
# 567 "project/radare2/libr/io/p/io_zip.c"
                                 );
 }
 return r;
}
...
static 
# 576 "project/radare2/libr/io/p/io_zip.c" 3 4
      _Bool 
# 576 "project/radare2/libr/io/p/io_zip.c"
           r_io_zip_truncate_buf(RIOZipFileObj *zfo, int size) {
 return r_buf_resize (zfo->b, size > 0? size: 0);
}

static 
# 580 "project/radare2/libr/io/p/io_zip.c" 3 4
      _Bool 
# 580 "project/radare2/libr/io/p/io_zip.c"
           r_io_zip_resize(RIO *io, RIODesc *fd, 
# 580 "project/radare2/libr/io/p/io_zip.c" 3 4
                                                 unsigned long long 
# 580 "project/radare2/libr/io/p/io_zip.c"
                                                      size) {
 ...
 if (!fd || !fd->data) {
  return 
# 583 "project/radare2/libr/io/p/io_zip.c" 3 4
        0
# 583 "project/radare2/libr/io/p/io_zip.c"
             ;
 }
 zfo = fd->data;
 if (r_io_zip_truncate_buf (zfo, size)) {
  ...
  r_io_zip_flush_file (zfo);
  return 
# 589 "project/radare2/libr/io/p/io_zip.c" 3 4
        1
# 589 "project/radare2/libr/io/p/io_zip.c"
            ;
 }
 return 
# 591 "project/radare2/libr/io/p/io_zip.c" 3 4
       0
# 591 "project/radare2/libr/io/p/io_zip.c"
            ;
}

static int r_io_zip_write(RIO *io, RIODesc *fd, const 
# 594 "project/radare2/libr/io/p/io_zip.c" 3 4
                                                     unsigned char 
# 594 "project/radare2/libr/io/p/io_zip.c"
                                                         *buf, int count) {
 RIOZipFileObj *zfo;
 int ret = 0;
 if (!fd || !fd->data || !buf) {
 ...
 zfo = fd->data;
 if (!(zfo->perm & 
# 601 "project/radare2/libr/io/p/io_zip.c" 3 4
                  2
# 601 "project/radare2/libr/io/p/io_zip.c"
                          )) {
  return -1;
 }
 ...
 if (ret >= 0) {
  r_buf_seek (zfo->b, ret, 
# 613 "project/radare2/libr/io/p/io_zip.c" 3 4
                          1
# 613 "project/radare2/libr/io/p/io_zip.c"
                                   );
 }
...
static 
# 621 "project/radare2/libr/io/p/io_zip.c" 3 4
      _Bool 
# 621 "project/radare2/libr/io/p/io_zip.c"
           r_io_zip_close(RIODesc *fd) {
 RIOZipFileObj *zfo;
 if (!fd || !fd->data) {
  return 
# 624 "project/radare2/libr/io/p/io_zip.c" 3 4
        0
# 624 "project/radare2/libr/io/p/io_zip.c"
             ;
 }
 zfo = fd->data;
 r_io_zip_free_zipfileobj (zfo);
 zfo = fd->data = 
# 628 "project/radare2/libr/io/p/io_zip.c" 3 4
                 ((void *)0)
# 628 "project/radare2/libr/io/p/io_zip.c"
                     ;
 return 
# 629 "project/radare2/libr/io/p/io_zip.c" 3 4
       1
# 629 "project/radare2/libr/io/p/io_zip.c"
           ;
}
...
# 648 "project/radare2/libr/io/p/io_zip.c" 3 4
__attribute__((visibility("default"))) 
# 648 "project/radare2/libr/io/p/io_zip.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_zip,
 .version = 
# 651 "project/radare2/libr/io/p/io_zip.c" 3 4
           "5.5.4"

# 652 "project/radare2/libr/io/p/io_zip.c"
};
