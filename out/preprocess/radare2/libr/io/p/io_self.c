# 0 "project/radare2/libr/io/p/io_self.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/io/p/io_self.c"
...
# 4 "project/radare2/libr/io/p/io_self.c" 2
...
# 5 "project/radare2/libr/io/p/io_self.c" 2
...
# 6 "project/radare2/libr/io/p/io_self.c" 2
...
# 8 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/vm_map.h" 2 3 4
...
# 9 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/vm_map.h" 2 3 4
...
# 10 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/vm_map.h" 2 3 4
...
# 11 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/vm_map.h" 2 3 4
...
# 12 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/vm_map.h" 2 3 4
...
# 14 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/vm_map.h" 2 3 4
# 28 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/vm_map.h" 3 4
 extern int mig_strncpy_zerofill(char *dest, const char *src, int len) __attribute__((weak_import));
# 59 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/vm_map.h" 3 4
...
# 60 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/vm_map.h" 2 3 4
...
# 11 "project/radare2/libr/io/p/io_self.c" 2
...
# 12 "project/radare2/libr/io/p/io_self.c" 2
...
# 13 "project/radare2/libr/io/p/io_self.c" 2
...
# 14 "project/radare2/libr/io/p/io_self.c" 2
...
# 18 "project/radare2/libr/io/p/io_self.c" 2



# 20 "project/radare2/libr/io/p/io_self.c"
void macosx_debug_regions (RIO *io, task_t task, mach_vm_address_t address, int max);
# 50 "project/radare2/libr/io/p/io_self.c"
typedef struct {
 char *name;
 
# 52 "project/radare2/libr/io/p/io_self.c" 3 4
unsigned long long 
# 52 "project/radare2/libr/io/p/io_self.c"
     from;
 
# 53 "project/radare2/libr/io/p/io_self.c" 3 4
unsigned long long 
# 53 "project/radare2/libr/io/p/io_self.c"
     to;
 int perm;
} RIOSelfSection;
...
static 
# 59 "project/radare2/libr/io/p/io_self.c" 3 4
      _Bool 
# 59 "project/radare2/libr/io/p/io_self.c"
           mameio = 
# 59 "project/radare2/libr/io/p/io_self.c" 3 4
                    0
# 59 "project/radare2/libr/io/p/io_self.c"
...
static int self_in_section(RIO *io, 
# 61 "project/radare2/libr/io/p/io_self.c" 3 4
                                   unsigned long long 
# 61 "project/radare2/libr/io/p/io_self.c"
                                        addr, int *left, int *perm) {
 int i;
 for (i = 0; i < self_sections_count; i++) {
  if (addr >= self_sections[i].from && addr < self_sections[i].to) {
   ...
   return 
# 71 "project/radare2/libr/io/p/io_self.c" 3 4
         1
# 71 "project/radare2/libr/io/p/io_self.c"
             ;
  }
 }
 return 
# 74 "project/radare2/libr/io/p/io_self.c" 3 4
       0
# 74 "project/radare2/libr/io/p/io_self.c"
            ;
}
...
static int update_self_regions(RIO *io, int pid) {
 ...
 kern_return_t rc;
 rc = task_for_pid (
# 82 "project/radare2/libr/io/p/io_self.c" 3 4
                   mach_task_self_
# 82 "project/radare2/libr/io/p/io_self.c"
                                    , pid, &task);
 if (rc) {
  
# 84 "project/radare2/libr/io/p/io_self.c" 3 4
 fprintf(__stderrp,
# 84 "project/radare2/libr/io/p/io_self.c"
 "task_for_pid failed\n"
# 84 "project/radare2/libr/io/p/io_self.c" 3 4
 )
# 84 "project/radare2/libr/io/p/io_self.c"
                                  ;
  return 
# 85 "project/radare2/libr/io/p/io_self.c" 3 4
        0
# 85 "project/radare2/libr/io/p/io_self.c"
             ;
 }
 macosx_debug_regions (io, task, (size_t)1, 1000);
 return 
# 88 "project/radare2/libr/io/p/io_self.c" 3 4
       1
# 88 "project/radare2/libr/io/p/io_self.c"
           ;
# 260 "project/radare2/libr/io/p/io_self.c"
}

static 
# 262 "project/radare2/libr/io/p/io_self.c" 3 4
      _Bool 
# 262 "project/radare2/libr/io/p/io_self.c"
...
static RIODesc *__open(RIO *io, const char *file, int rw, int mode) {
 ...
 if (r_sandbox_enable (0)) {
  return 
# 269 "project/radare2/libr/io/p/io_self.c" 3 4
        ((void *)0)
# 269 "project/radare2/libr/io/p/io_self.c"
            ;
 }
 io->va = 
# 271 "project/radare2/libr/io/p/io_self.c" 3 4
         1
# 271 "project/radare2/libr/io/p/io_self.c"
             ;
 ret = update_self_regions (io, pid);
 if (ret) {
  return r_io_desc_new (io, &r_io_plugin_self,
   file, rw, mode, 
# 275 "project/radare2/libr/io/p/io_self.c" 3 4
                  ((void *)0)
# 275 "project/radare2/libr/io/p/io_self.c"
                      );
 }
 return 
# 277 "project/radare2/libr/io/p/io_self.c" 3 4
       ((void *)0)
# 277 "project/radare2/libr/io/p/io_self.c"
           ;
}

static int __read(RIO *io, RIODesc *fd, 
# 280 "project/radare2/libr/io/p/io_self.c" 3 4
                                       unsigned char 
# 280 "project/radare2/libr/io/p/io_self.c"
                                           *buf, int len) {
 int left, perm;
 if (self_in_section (io, io->off, &left, &perm)) {
  if (perm & 
# 283 "project/radare2/libr/io/p/io_self.c" 3 4
            4
# 283 "project/radare2/libr/io/p/io_self.c"
                    ) {
   int newlen = 
# 284 "project/radare2/libr/io/p/io_self.c" 3 4
               (((
# 284 "project/radare2/libr/io/p/io_self.c"
               len
# 284 "project/radare2/libr/io/p/io_self.c" 3 4
               )>(
# 284 "project/radare2/libr/io/p/io_self.c"
...
# 285 "project/radare2/libr/io/p/io_self.c" 3 4
  unsigned char 
# 285 "project/radare2/libr/io/p/io_self.c"
      *ptr = (
# 285 "project/radare2/libr/io/p/io_self.c" 3 4
              unsigned char
# 285 "project/radare2/libr/io/p/io_self.c"
...
# 286 "project/radare2/libr/io/p/io_self.c" 3 4
  __builtin___memcpy_chk (
# 286 "project/radare2/libr/io/p/io_self.c"
  buf
# 286 "project/radare2/libr/io/p/io_self.c" 3 4
  , 
# 286 "project/radare2/libr/io/p/io_self.c"
...
# 293 "project/radare2/libr/io/p/io_self.c" 3 4
                                              unsigned char 
# 293 "project/radare2/libr/io/p/io_self.c"
                                                  *buf, int len) {
 if (fd->perm & 
# 294 "project/radare2/libr/io/p/io_self.c" 3 4
               2
# 294 "project/radare2/libr/io/p/io_self.c"
                       ) {
  int left, perm;
  if (self_in_section (io, io->off, &left, &perm)) {
   int newlen = 
# 297 "project/radare2/libr/io/p/io_self.c" 3 4
               (((
# 297 "project/radare2/libr/io/p/io_self.c"
               len
# 297 "project/radare2/libr/io/p/io_self.c" 3 4
               )>(
# 297 "project/radare2/libr/io/p/io_self.c"
...
# 298 "project/radare2/libr/io/p/io_self.c" 3 4
  unsigned char 
# 298 "project/radare2/libr/io/p/io_self.c"
      *ptr = (
# 298 "project/radare2/libr/io/p/io_self.c" 3 4
              unsigned char
# 298 "project/radare2/libr/io/p/io_self.c"
...
# 300 "project/radare2/libr/io/p/io_self.c" 3 4
   __builtin___memcpy_chk (
# 300 "project/radare2/libr/io/p/io_self.c"
   ptr
# 300 "project/radare2/libr/io/p/io_self.c" 3 4
   , 
# 300 "project/radare2/libr/io/p/io_self.c"
...
static 
# 308 "project/radare2/libr/io/p/io_self.c" 3 4
      unsigned long long 
# 308 "project/radare2/libr/io/p/io_self.c"
...
# 308 "project/radare2/libr/io/p/io_self.c"
 ...
 switch (whence) {
 case 
# 310 "project/radare2/libr/io/p/io_self.c" 3 4
     0
# 310 "project/radare2/libr/io/p/io_self.c"
             : return offset;
 case 
# 311 "project/radare2/libr/io/p/io_self.c" 3 4
     1
# 311 "project/radare2/libr/io/p/io_self.c"
             : return io->off + offset;
 case 
# 312 "project/radare2/libr/io/p/io_self.c" 3 4
     2
# 312 "project/radare2/libr/io/p/io_self.c"
             : return 
# 312 "project/radare2/libr/io/p/io_self.c" 3 4
...
static void got_alarm(int sig) {
 ...
 kill (r_sys_getpid (), 
# 320 "project/radare2/libr/io/p/io_self.c" 3 4
                       30
# 320 "project/radare2/libr/io/p/io_self.c"
                              );
...
static char *__system(RIO *io, RIODesc *fd, const char *cmd) {
 if (!strcmp (cmd, "pid")) {
  ...
  if (r_sandbox_enable (
# 331 "project/radare2/libr/io/p/io_self.c" 3 4
                       0
# 331 "project/radare2/libr/io/p/io_self.c"
                            )) {
   
# 332 "project/radare2/libr/io/p/io_self.c" 3 4
  fprintf(__stderrp,
# 332 "project/radare2/libr/io/p/io_self.c"
  "This is unsafe, so disabled by the sandbox\n"
# 332 "project/radare2/libr/io/p/io_self.c" 3 4
  )
# 332 "project/radare2/libr/io/p/io_self.c"
                                                          ;
   return 
# 333 "project/radare2/libr/io/p/io_self.c" 3 4
         ((void *)0)
# 333 "project/radare2/libr/io/p/io_self.c"
             ;
  }

  kill (r_sys_getpid (), 
# 336 "project/radare2/libr/io/p/io_self.c" 3 4
                        9
# 336 "project/radare2/libr/io/p/io_self.c"
                               );

 } else if (!strncmp (cmd, "call ", 5)) {
  size_t cbptr = 0;
  if (r_sandbox_enable (
# 340 "project/radare2/libr/io/p/io_self.c" 3 4
                       0
# 340 "project/radare2/libr/io/p/io_self.c"
                            )) {
   
# 341 "project/radare2/libr/io/p/io_self.c" 3 4
  fprintf(__stderrp,
# 341 "project/radare2/libr/io/p/io_self.c"
  "This is unsafe, so disabled by the sandbox\n"
# 341 "project/radare2/libr/io/p/io_self.c" 3 4
  )
# 341 "project/radare2/libr/io/p/io_self.c"
                                                          ;
   return 
# 342 "project/radare2/libr/io/p/io_self.c" 3 4
         ((void *)0)
# 342 "project/radare2/libr/io/p/io_self.c"
             ;
  }
  
# 344 "project/radare2/libr/io/p/io_self.c" 3 4
 unsigned long long 
# 344 "project/radare2/libr/io/p/io_self.c"
      result = 0;
  char *argv = strdup (cmd + 5);
  int argc = r_str_word_set0 (argv);
  if (argc == 0) {
   
# 348 "project/radare2/libr/io/p/io_self.c" 3 4
  fprintf(__stderrp,
# 348 "project/radare2/libr/io/p/io_self.c"
  "Usage: =!call [fcnptr] [a0] [a1] ...\n"
# 348 "project/radare2/libr/io/p/io_self.c" 3 4
  )
# 348 "project/radare2/libr/io/p/io_self.c"
                                                    ;
   free (argv);
   return 
# 350 "project/radare2/libr/io/p/io_self.c" 3 4
         ((void *)0)
# 350 "project/radare2/libr/io/p/io_self.c"
             ;
  }
  const char *sym = r_str_word_get0 (argv, 0);
  if (sym) {
   const char *symbol = cmd + 6;
   void *lib = r_lib_dl_open (
# 355 "project/radare2/libr/io/p/io_self.c" 3 4
                             ((void *)0)
# 355 "project/radare2/libr/io/p/io_self.c"
                                 );
   void *ptr = r_lib_dl_sym (lib, symbol);
   if (ptr) {
    cbptr = (
# 358 "project/radare2/libr/io/p/io_self.c" 3 4
            unsigned long long
# 358 "project/radare2/libr/io/p/io_self.c"
                )(size_t)ptr;
   } else {
    cbptr = r_num_math (
# 360 "project/radare2/libr/io/p/io_self.c" 3 4
                       ((void *)0)
# 360 "project/radare2/libr/io/p/io_self.c"
                           , symbol);
   }
   r_lib_dl_close (lib);
  }
...
# 369 "project/radare2/libr/io/p/io_self.c" 3 4
   fprintf(__stderrp,
# 369 "project/radare2/libr/io/p/io_self.c"
   "No callback defined\n"
# 369 "project/radare2/libr/io/p/io_self.c" 3 4
   )
# 369 "project/radare2/libr/io/p/io_self.c"
...
# 374 "project/radare2/libr/io/p/io_self.c" 3 4
   unsigned long long 
# 374 "project/radare2/libr/io/p/io_self.c"
        a0 = r_num_math (
# 374 "project/radare2/libr/io/p/io_self.c" 3 4
                         ((void *)0)
# 374 "project/radare2/libr/io/p/io_self.c"
                             , r_str_word_get0 (argv, 1));
    result = cb (a0);
   } else {
    
# 377 "project/radare2/libr/io/p/io_self.c" 3 4
   fprintf(__stderrp,
# 377 "project/radare2/libr/io/p/io_self.c"
   "No callback defined\n"
# 377 "project/radare2/libr/io/p/io_self.c" 3 4
   )
# 377 "project/radare2/libr/io/p/io_self.c"
...
# 381 "project/radare2/libr/io/p/io_self.c" 3 4
  unsigned long long 
# 381 "project/radare2/libr/io/p/io_self.c"
       a0 = r_num_math (
# 381 "project/radare2/libr/io/p/io_self.c" 3 4
                        ((void *)0)
# 381 "project/radare2/libr/io/p/io_self.c"
...
# 382 "project/radare2/libr/io/p/io_self.c" 3 4
  unsigned long long 
# 382 "project/radare2/libr/io/p/io_self.c"
       a1 = r_num_math (
# 382 "project/radare2/libr/io/p/io_self.c" 3 4
                        ((void *)0)
# 382 "project/radare2/libr/io/p/io_self.c"
                            , r_str_word_get0 (argv, 2));
   if (cb) {
    result = cb (a0, a1);
   } else {
    
# 386 "project/radare2/libr/io/p/io_self.c" 3 4
   fprintf(__stderrp,
# 386 "project/radare2/libr/io/p/io_self.c"
   "No callback defined\n"
# 386 "project/radare2/libr/io/p/io_self.c" 3 4
   )
# 386 "project/radare2/libr/io/p/io_self.c"
...
# 391 "project/radare2/libr/io/p/io_self.c" 3 4
  unsigned long long 
# 391 "project/radare2/libr/io/p/io_self.c"
       a0 = r_num_math (
# 391 "project/radare2/libr/io/p/io_self.c" 3 4
                        ((void *)0)
# 391 "project/radare2/libr/io/p/io_self.c"
...
# 392 "project/radare2/libr/io/p/io_self.c" 3 4
  unsigned long long 
# 392 "project/radare2/libr/io/p/io_self.c"
       a1 = r_num_math (
# 392 "project/radare2/libr/io/p/io_self.c" 3 4
                        ((void *)0)
# 392 "project/radare2/libr/io/p/io_self.c"
...
# 393 "project/radare2/libr/io/p/io_self.c" 3 4
  unsigned long long 
# 393 "project/radare2/libr/io/p/io_self.c"
       a2 = r_num_math (
# 393 "project/radare2/libr/io/p/io_self.c" 3 4
                        ((void *)0)
# 393 "project/radare2/libr/io/p/io_self.c"
                            , r_str_word_get0 (argv, 3));
   if (cb) {
    result = cb (a0, a1, a2);
   } else {
    
# 397 "project/radare2/libr/io/p/io_self.c" 3 4
   fprintf(__stderrp,
# 397 "project/radare2/libr/io/p/io_self.c"
   "No callback defined\n"
# 397 "project/radare2/libr/io/p/io_self.c" 3 4
   )
# 397 "project/radare2/libr/io/p/io_self.c"
...
# 402 "project/radare2/libr/io/p/io_self.c" 3 4
  unsigned long long 
# 402 "project/radare2/libr/io/p/io_self.c"
       a0 = r_num_math (
# 402 "project/radare2/libr/io/p/io_self.c" 3 4
                        ((void *)0)
# 402 "project/radare2/libr/io/p/io_self.c"
...
# 403 "project/radare2/libr/io/p/io_self.c" 3 4
  unsigned long long 
# 403 "project/radare2/libr/io/p/io_self.c"
       a1 = r_num_math (
# 403 "project/radare2/libr/io/p/io_self.c" 3 4
                        ((void *)0)
# 403 "project/radare2/libr/io/p/io_self.c"
...
# 404 "project/radare2/libr/io/p/io_self.c" 3 4
  unsigned long long 
# 404 "project/radare2/libr/io/p/io_self.c"
       a2 = r_num_math (
# 404 "project/radare2/libr/io/p/io_self.c" 3 4
                        ((void *)0)
# 404 "project/radare2/libr/io/p/io_self.c"
...
# 405 "project/radare2/libr/io/p/io_self.c" 3 4
  unsigned long long 
# 405 "project/radare2/libr/io/p/io_self.c"
       a3 = r_num_math (
# 405 "project/radare2/libr/io/p/io_self.c" 3 4
                        ((void *)0)
# 405 "project/radare2/libr/io/p/io_self.c"
                            , r_str_word_get0 (argv, 4));
   if (cb) {
    result = cb (a0, a1, a2, a3);
   } else {
    
# 409 "project/radare2/libr/io/p/io_self.c" 3 4
   fprintf(__stderrp,
# 409 "project/radare2/libr/io/p/io_self.c"
   "No callback defined\n"
# 409 "project/radare2/libr/io/p/io_self.c" 3 4
   )
# 409 "project/radare2/libr/io/p/io_self.c"
...
# 414 "project/radare2/libr/io/p/io_self.c" 3 4
  unsigned long long 
# 414 "project/radare2/libr/io/p/io_self.c"
       a0 = r_num_math (
# 414 "project/radare2/libr/io/p/io_self.c" 3 4
                        ((void *)0)
# 414 "project/radare2/libr/io/p/io_self.c"
...
# 415 "project/radare2/libr/io/p/io_self.c" 3 4
  unsigned long long 
# 415 "project/radare2/libr/io/p/io_self.c"
       a1 = r_num_math (
# 415 "project/radare2/libr/io/p/io_self.c" 3 4
                        ((void *)0)
# 415 "project/radare2/libr/io/p/io_self.c"
...
# 416 "project/radare2/libr/io/p/io_self.c" 3 4
  unsigned long long 
# 416 "project/radare2/libr/io/p/io_self.c"
       a2 = r_num_math (
# 416 "project/radare2/libr/io/p/io_self.c" 3 4
                        ((void *)0)
# 416 "project/radare2/libr/io/p/io_self.c"
...
# 417 "project/radare2/libr/io/p/io_self.c" 3 4
  unsigned long long 
# 417 "project/radare2/libr/io/p/io_self.c"
       a3 = r_num_math (
# 417 "project/radare2/libr/io/p/io_self.c" 3 4
                        ((void *)0)
# 417 "project/radare2/libr/io/p/io_self.c"
...
# 418 "project/radare2/libr/io/p/io_self.c" 3 4
  unsigned long long 
# 418 "project/radare2/libr/io/p/io_self.c"
       a4 = r_num_math (
# 418 "project/radare2/libr/io/p/io_self.c" 3 4
                        ((void *)0)
# 418 "project/radare2/libr/io/p/io_self.c"
                            , r_str_word_get0 (argv, 5));
   if (cb) {
    result = cb (a0, a1, a2, a3, a4);
   } else {
    
# 422 "project/radare2/libr/io/p/io_self.c" 3 4
   fprintf(__stderrp,
# 422 "project/radare2/libr/io/p/io_self.c"
   "No callback defined\n"
# 422 "project/radare2/libr/io/p/io_self.c" 3 4
   )
# 422 "project/radare2/libr/io/p/io_self.c"
...
# 425 "project/radare2/libr/io/p/io_self.c" 3 4
  fprintf(__stderrp,
# 425 "project/radare2/libr/io/p/io_self.c"
...
# 427 "project/radare2/libr/io/p/io_self.c" 3 4
 fprintf(__stderrp,
# 427 "project/radare2/libr/io/p/io_self.c"
 "RES %"
# 427 "project/radare2/libr/io/p/io_self.c" 3 4
 "lld"
# 427 "project/radare2/libr/io/p/io_self.c"
...
# 433 "project/radare2/libr/io/p/io_self.c" 3 4
 do { if (!(
# 433 "project/radare2/libr/io/p/io_self.c"
 secs >= 0
# 433 "project/radare2/libr/io/p/io_self.c" 3 4
...
# 433 "project/radare2/libr/io/p/io_self.c"
  ...
  r_sys_signal (
# 437 "project/radare2/libr/io/p/io_self.c" 3 4
               14
# 437 "project/radare2/libr/io/p/io_self.c"
                      , got_alarm);
  setitimer (
# 438 "project/radare2/libr/io/p/io_self.c" 3 4
            0
# 438 "project/radare2/libr/io/p/io_self.c"
                       , &tmout, 
# 438 "project/radare2/libr/io/p/io_self.c" 3 4
                                 ((void *)0)
# 438 "project/radare2/libr/io/p/io_self.c"
  ...
  const char *symbol = cmd + 6;
  void *lib = r_lib_dl_open (
# 448 "project/radare2/libr/io/p/io_self.c" 3 4
                            ((void *)0)
# 448 "project/radare2/libr/io/p/io_self.c"
                                );
  void *ptr = r_lib_dl_sym (lib, symbol);
  
# 450 "project/radare2/libr/io/p/io_self.c" 3 4
 fprintf(__stderrp,
# 450 "project/radare2/libr/io/p/io_self.c"
 "(%s) 0x%08"
# 450 "project/radare2/libr/io/p/io_self.c" 3 4
 "llx"
# 450 "project/radare2/libr/io/p/io_self.c"
...
# 450 "project/radare2/libr/io/p/io_self.c"
  ...
  void *lib = r_lib_dl_open (
# 453 "project/radare2/libr/io/p/io_self.c" 3 4
                            ((void *)0)
# 453 "project/radare2/libr/io/p/io_self.c"
                                );
...
# 459 "project/radare2/libr/io/p/io_self.c" 3 4
  fprintf(__stderrp,
# 459 "project/radare2/libr/io/p/io_self.c"
...
# 459 "project/radare2/libr/io/p/io_self.c"
                                                ;
   mameio = 
# 460 "project/radare2/libr/io/p/io_self.c" 3 4
           1
# 460 "project/radare2/libr/io/p/io_self.c"
               ;
  } else {
   
# 462 "project/radare2/libr/io/p/io_self.c" 3 4
  fprintf(__stderrp,
# 462 "project/radare2/libr/io/p/io_self.c"
...
# 468 "project/radare2/libr/io/p/io_self.c" 3 4
  fprintf(__stderrp,
# 468 "project/radare2/libr/io/p/io_self.c"
  "0x%08"
# 468 "project/radare2/libr/io/p/io_self.c" 3 4
  "llx"
# 468 "project/radare2/libr/io/p/io_self.c"
...
# 468 "project/radare2/libr/io/p/io_self.c" 3 4
  "llx"
# 468 "project/radare2/libr/io/p/io_self.c"
  " %s %s\n", self_sections[i].from, self_sections[i].to, r_str_rwx_i (self_sections[i].perm), self_sections[i].name
# 468 "project/radare2/libr/io/p/io_self.c" 3 4
  )


                          
# 471 "project/radare2/libr/io/p/io_self.c"
                         ;
  }
 } else {
  
# 474 "project/radare2/libr/io/p/io_self.c" 3 4
 fprintf(__stderrp,
# 474 "project/radare2/libr/io/p/io_self.c"
 "|Usage: =![cmd] [args]\n"
# 474 "project/radare2/libr/io/p/io_self.c" 3 4
 )
# 474 "project/radare2/libr/io/p/io_self.c"
...
# 475 "project/radare2/libr/io/p/io_self.c" 3 4
 fprintf(__stderrp,
# 475 "project/radare2/libr/io/p/io_self.c"
 "| =!pid               show getpid()\n"
# 475 "project/radare2/libr/io/p/io_self.c" 3 4
 )
# 475 "project/radare2/libr/io/p/io_self.c"
...
# 476 "project/radare2/libr/io/p/io_self.c" 3 4
 fprintf(__stderrp,
# 476 "project/radare2/libr/io/p/io_self.c"
...
# 477 "project/radare2/libr/io/p/io_self.c" 3 4
 fprintf(__stderrp,
# 477 "project/radare2/libr/io/p/io_self.c"
 "| =!kill              commit suicide\n"
# 477 "project/radare2/libr/io/p/io_self.c" 3 4
 )
# 477 "project/radare2/libr/io/p/io_self.c"
...
# 479 "project/radare2/libr/io/p/io_self.c" 3 4
 fprintf(__stderrp,
# 479 "project/radare2/libr/io/p/io_self.c"
...
# 481 "project/radare2/libr/io/p/io_self.c" 3 4
 fprintf(__stderrp,
# 481 "project/radare2/libr/io/p/io_self.c"
 "| =!dlsym [sym]       dlopen\n"
# 481 "project/radare2/libr/io/p/io_self.c" 3 4
 )
# 481 "project/radare2/libr/io/p/io_self.c"
...
# 482 "project/radare2/libr/io/p/io_self.c" 3 4
 fprintf(__stderrp,
# 482 "project/radare2/libr/io/p/io_self.c"
...
# 483 "project/radare2/libr/io/p/io_self.c" 3 4
 fprintf(__stderrp,
# 483 "project/radare2/libr/io/p/io_self.c"
...
# 483 "project/radare2/libr/io/p/io_self.c"
 ...
 return 
# 485 "project/radare2/libr/io/p/io_self.c" 3 4
       ((void *)0)
# 485 "project/radare2/libr/io/p/io_self.c"
           ;
}
...
# 502 "project/radare2/libr/io/p/io_self.c" 3 4
__attribute__((visibility("default"))) 
# 502 "project/radare2/libr/io/p/io_self.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_mach,
 .version = 
# 505 "project/radare2/libr/io/p/io_self.c" 3 4
           "5.5.4"

# 506 "project/radare2/libr/io/p/io_self.c"
};
...
void macosx_debug_regions (RIO *io, task_t task, mach_vm_address_t address, int max) {
 ...
 for (;;) {
  count = 
# 543 "project/radare2/libr/io/p/io_self.c" 3 4
         ((mach_msg_type_number_t) ((sizeof (vm_region_submap_info_data_64_t)) / sizeof (natural_t)))
# 543 "project/radare2/libr/io/p/io_self.c"
                                       ;
  kret = mach_vm_region_recurse (task, &address, &size, &nsubregions,
    (vm_region_recurse_info_t) &info, &count);
  if (kret != 
# 546 "project/radare2/libr/io/p/io_self.c" 3 4
             0
# 546 "project/radare2/libr/io/p/io_self.c"
                         ) {
   if (!num_printed) {
    
# 548 "project/radare2/libr/io/p/io_self.c" 3 4
   fprintf(__stderrp,
# 548 "project/radare2/libr/io/p/io_self.c"
...
# 548 "project/radare2/libr/io/p/io_self.c"
  ...
  if (!info.is_submap) {
   ...
   if (info.protection & 
# 580 "project/radare2/libr/io/p/io_self.c" 3 4
                        ((vm_prot_t) 0x01)
# 580 "project/radare2/libr/io/p/io_self.c"
                                    ) {
    perm |= 
# 581 "project/radare2/libr/io/p/io_self.c" 3 4
           4
# 581 "project/radare2/libr/io/p/io_self.c"
                   ;
   }
   if (info.protection & 
# 583 "project/radare2/libr/io/p/io_self.c" 3 4
                        ((vm_prot_t) 0x02)
# 583 "project/radare2/libr/io/p/io_self.c"
                                     ) {
    perm |= 
# 584 "project/radare2/libr/io/p/io_self.c" 3 4
           2
# 584 "project/radare2/libr/io/p/io_self.c"
                   ;
   }
   if (info.protection & 
# 586 "project/radare2/libr/io/p/io_self.c" 3 4
                        ((vm_prot_t) 0x04)
# 586 "project/radare2/libr/io/p/io_self.c"
                                       ) {
    perm |= 
# 587 "project/radare2/libr/io/p/io_self.c" 3 4
           1
# 587 "project/radare2/libr/io/p/io_self.c"
                   ;
   }
...
# 607 "project/radare2/libr/io/p/io_self.c" 3 4
  fprintf(__stderrp,
# 607 "project/radare2/libr/io/p/io_self.c"
  "Max %d num_printed %d\n", max, num_printed
# 607 "project/radare2/libr/io/p/io_self.c" 3 4
  )
# 607 "project/radare2/libr/io/p/io_self.c"
