# 0 "project/radare2/libr/io/p/io_rap.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/io/p/io_rap.c"
...
# 4 "project/radare2/libr/io/p/io_rap.c" 2
...
# 5 "project/radare2/libr/io/p/io_rap.c" 2
...
# 6 "project/radare2/libr/io/p/io_rap.c" 2
...
# 13 "project/radare2/libr/io/p/io_rap.c"
static int __rap_write(RIO *io, RIODesc *fd, const 
# 13 "project/radare2/libr/io/p/io_rap.c" 3 4
                                                  unsigned char 
# 13 "project/radare2/libr/io/p/io_rap.c"
                                                      *buf, int count) {
 RSocket *s = (((fd)->data)?(((RIORap*)((fd)->data))->client):
# 14 "project/radare2/libr/io/p/io_rap.c" 3 4
             ((void *)0)
# 14 "project/radare2/libr/io/p/io_rap.c"
             );
 return r_socket_rap_client_write (s, buf, count);
}

static 
# 18 "project/radare2/libr/io/p/io_rap.c" 3 4
      _Bool 
# 18 "project/radare2/libr/io/p/io_rap.c"
           __rap_accept(RIO *io, RIODesc *desc, int fd) {
 RIORap *rap = desc? desc->data: 
# 19 "project/radare2/libr/io/p/io_rap.c" 3 4
                                ((void *)0)
# 19 "project/radare2/libr/io/p/io_rap.c"
                                    ;
 if (rap && fd != -1) {
  rap->client = r_socket_new_from_fd (fd);
  return 
# 22 "project/radare2/libr/io/p/io_rap.c" 3 4
        1
# 22 "project/radare2/libr/io/p/io_rap.c"
            ;
 }
 return 
# 24 "project/radare2/libr/io/p/io_rap.c" 3 4
       0
# 24 "project/radare2/libr/io/p/io_rap.c"
            ;
}

static int __rap_read(RIO *io, RIODesc *fd, 
# 27 "project/radare2/libr/io/p/io_rap.c" 3 4
                                           unsigned char 
# 27 "project/radare2/libr/io/p/io_rap.c"
                                               *buf, int count) {
 RSocket *s = (((fd)->data)?(((RIORap*)((fd)->data))->client):
# 28 "project/radare2/libr/io/p/io_rap.c" 3 4
             ((void *)0)
# 28 "project/radare2/libr/io/p/io_rap.c"
             );
 return r_socket_rap_client_read (s, buf, count);
}

static 
# 32 "project/radare2/libr/io/p/io_rap.c" 3 4
      _Bool 
# 32 "project/radare2/libr/io/p/io_rap.c"
           __rap_close(RIODesc *fd) {
 int ret = 
# 33 "project/radare2/libr/io/p/io_rap.c" 3 4
          0
# 33 "project/radare2/libr/io/p/io_rap.c"
               ;
 if (((fd) && ((fd)->data) && ((fd)->plugin == &r_io_plugin_rap))) {
  if ((((fd)->data)?(((RIORap*)((fd)->data))->client):
# 35 "project/radare2/libr/io/p/io_rap.c" 3 4
     ((void *)0)
# 35 "project/radare2/libr/io/p/io_rap.c"
     ) != 
# 35 "project/radare2/libr/io/p/io_rap.c" 3 4
                       ((void *)0)
# 35 "project/radare2/libr/io/p/io_rap.c"
...
# 44 "project/radare2/libr/io/p/io_rap.c" 3 4
   { free((void *)
# 44 "project/radare2/libr/io/p/io_rap.c"
   r
# 44 "project/radare2/libr/io/p/io_rap.c" 3 4
   ); 
# 44 "project/radare2/libr/io/p/io_rap.c"
...
# 48 "project/radare2/libr/io/p/io_rap.c" 3 4
 fprintf(__stderrp,
# 48 "project/radare2/libr/io/p/io_rap.c"
 "__rap_close: fdesc is not a r_io_rap plugin\n"
# 48 "project/radare2/libr/io/p/io_rap.c" 3 4
 )
# 48 "project/radare2/libr/io/p/io_rap.c"
                                                          ;
...
static 
# 53 "project/radare2/libr/io/p/io_rap.c" 3 4
      unsigned long long 
# 53 "project/radare2/libr/io/p/io_rap.c"
           __rap_lseek(RIO *io, RIODesc *fd, 
# 53 "project/radare2/libr/io/p/io_rap.c" 3 4
                                             unsigned long long 
# 53 "project/radare2/libr/io/p/io_rap.c"
                                                  offset, int whence) {
 RSocket *s = (((fd)->data)?(((RIORap*)((fd)->data))->client):
# 54 "project/radare2/libr/io/p/io_rap.c" 3 4
             ((void *)0)
# 54 "project/radare2/libr/io/p/io_rap.c"
             );
 return r_socket_rap_client_seek (s, offset, whence);
}

static 
# 58 "project/radare2/libr/io/p/io_rap.c" 3 4
      _Bool 
# 58 "project/radare2/libr/io/p/io_rap.c"
           __rap_plugin_open(RIO *io, const char *pathname, 
# 58 "project/radare2/libr/io/p/io_rap.c" 3 4
                                                            _Bool 
# 58 "project/radare2/libr/io/p/io_rap.c"
                                                                 many) {
...
static RIODesc *__rap_open(RIO *io, const char *pathname, int rw, int mode) {
 ...
 if (!__rap_plugin_open (io, pathname, 0)) {
  return 
# 67 "project/radare2/libr/io/p/io_rap.c" 3 4
        ((void *)0)
# 67 "project/radare2/libr/io/p/io_rap.c"
            ;
 }
 
# 69 "project/radare2/libr/io/p/io_rap.c" 3 4
_Bool 
# 69 "project/radare2/libr/io/p/io_rap.c"
     is_ssl = (!strncmp (pathname, "raps://", 7));
 const char *host = pathname + (is_ssl? 7: 6);
 if (!(port = strchr (host, ':'))) {
  
# 72 "project/radare2/libr/io/p/io_rap.c" 3 4
 fprintf(__stderrp,
# 72 "project/radare2/libr/io/p/io_rap.c"
 "rap: wrong uri\n"
# 72 "project/radare2/libr/io/p/io_rap.c" 3 4
 )
# 72 "project/radare2/libr/io/p/io_rap.c"
                             ;
  return 
# 73 "project/radare2/libr/io/p/io_rap.c" 3 4
        ((void *)0)
# 73 "project/radare2/libr/io/p/io_rap.c"
            ;
 }
 listenmode = (*host == ':');
 *port++ = 0;
 if (!*port) {
  return 
# 78 "project/radare2/libr/io/p/io_rap.c" 3 4
        ((void *)0)
# 78 "project/radare2/libr/io/p/io_rap.c"
            ;
 }
 p = atoi (port);
...
# 86 "project/radare2/libr/io/p/io_rap.c" 3 4
 fprintf(__stderrp,
# 86 "project/radare2/libr/io/p/io_rap.c"
...
# 86 "project/radare2/libr/io/p/io_rap.c"
                                          ;
  return 
# 87 "project/radare2/libr/io/p/io_rap.c" 3 4
        ((void *)0)
# 87 "project/radare2/libr/io/p/io_rap.c"
            ;
 }
 if (listenmode) {
  if (p <= 0) {
   
# 91 "project/radare2/libr/io/p/io_rap.c" 3 4
  fprintf(__stderrp,
# 91 "project/radare2/libr/io/p/io_rap.c"
...
# 91 "project/radare2/libr/io/p/io_rap.c"
                                                        ;
   return 
# 92 "project/radare2/libr/io/p/io_rap.c" 3 4
         ((void *)0)
# 92 "project/radare2/libr/io/p/io_rap.c"
             ;
  }

  
# 95 "project/radare2/libr/io/p/io_rap.c" 3 4
 fprintf(__stderrp,
# 95 "project/radare2/libr/io/p/io_rap.c"
...
# 95 "project/radare2/libr/io/p/io_rap.c"
                                                                          ;
  RIORap *rior = 
# 96 "project/radare2/libr/io/p/io_rap.c" 3 4
                (
# 96 "project/radare2/libr/io/p/io_rap.c"
                RIORap
# 96 "project/radare2/libr/io/p/io_rap.c" 3 4
                *)calloc(1,sizeof(
# 96 "project/radare2/libr/io/p/io_rap.c"
...
# 96 "project/radare2/libr/io/p/io_rap.c"
                               ;
  rior->listener = 
# 97 "project/radare2/libr/io/p/io_rap.c" 3 4
                  1
# 97 "project/radare2/libr/io/p/io_rap.c"
                      ;
  rior->client = rior->fd = r_socket_new (is_ssl);
  if (!rior->fd) {
   free (rior);
   return 
# 101 "project/radare2/libr/io/p/io_rap.c" 3 4
         ((void *)0)
# 101 "project/radare2/libr/io/p/io_rap.c"
             ;
  }
  if (is_ssl) {
   if (file && *file) {
    if (!r_socket_listen (rior->fd, port, file)) {
     ...
     free (rior);
     return 
# 108 "project/radare2/libr/io/p/io_rap.c" 3 4
           ((void *)0)
# 108 "project/radare2/libr/io/p/io_rap.c"
               ;
    }
   } else {
    free (rior);
    return 
# 112 "project/radare2/libr/io/p/io_rap.c" 3 4
          ((void *)0)
# 112 "project/radare2/libr/io/p/io_rap.c"
              ;
   }
  } else {
   if (!r_socket_listen (rior->fd, port, 
# 115 "project/radare2/libr/io/p/io_rap.c" 3 4
                                        ((void *)0)
# 115 "project/radare2/libr/io/p/io_rap.c"
                                            )) {
    r_socket_free (rior->fd);
    free (rior);
    return 
# 118 "project/radare2/libr/io/p/io_rap.c" 3 4
          ((void *)0)
# 118 "project/radare2/libr/io/p/io_rap.c"
              ;
   }
  }
...
# 126 "project/radare2/libr/io/p/io_rap.c" 3 4
 fprintf(__stderrp,
# 126 "project/radare2/libr/io/p/io_rap.c"
...
# 126 "project/radare2/libr/io/p/io_rap.c"
                                       ;
  return 
# 127 "project/radare2/libr/io/p/io_rap.c" 3 4
        ((void *)0)
# 127 "project/radare2/libr/io/p/io_rap.c"
            ;
 }
 
# 129 "project/radare2/libr/io/p/io_rap.c" 3 4
fprintf(__stderrp,
# 129 "project/radare2/libr/io/p/io_rap.c"
...
# 130 "project/radare2/libr/io/p/io_rap.c" 3 4
                                      6
# 130 "project/radare2/libr/io/p/io_rap.c"
                                                        , 0)) {
  
# 131 "project/radare2/libr/io/p/io_rap.c" 3 4
 fprintf(__stderrp,
# 131 "project/radare2/libr/io/p/io_rap.c"
...
# 131 "project/radare2/libr/io/p/io_rap.c"
  ...
  r_socket_free (s);
  return 
# 133 "project/radare2/libr/io/p/io_rap.c" 3 4
        ((void *)0)
# 133 "project/radare2/libr/io/p/io_rap.c"
            ;
 }
 
# 135 "project/radare2/libr/io/p/io_rap.c" 3 4
fprintf(__stderrp,
# 135 "project/radare2/libr/io/p/io_rap.c"
...
# 135 "project/radare2/libr/io/p/io_rap.c"
                                                     ;
 RIORap *rior = 
# 136 "project/radare2/libr/io/p/io_rap.c" 3 4
               (
# 136 "project/radare2/libr/io/p/io_rap.c"
               RIORap
# 136 "project/radare2/libr/io/p/io_rap.c" 3 4
               *)calloc(1,sizeof(
# 136 "project/radare2/libr/io/p/io_rap.c"
...
# 136 "project/radare2/libr/io/p/io_rap.c"
 ...
 if (!rior) {
  r_socket_free (s);
  return 
# 139 "project/radare2/libr/io/p/io_rap.c" 3 4
        ((void *)0)
# 139 "project/radare2/libr/io/p/io_rap.c"
            ;
 }
 rior->listener = 
# 141 "project/radare2/libr/io/p/io_rap.c" 3 4
                 0
# 141 "project/radare2/libr/io/p/io_rap.c"
                      ;
 ...
 if (file && *file) {
  ...
  if (i == -1) {
   ...
   r_socket_free (s);
   return 
# 148 "project/radare2/libr/io/p/io_rap.c" 3 4
         ((void *)0)
# 148 "project/radare2/libr/io/p/io_rap.c"
             ;
  }
  if (i > 0) {
   
# 151 "project/radare2/libr/io/p/io_rap.c" 3 4
  fprintf(__stderrp,
# 151 "project/radare2/libr/io/p/io_rap.c"
...
static int __rap_listener(RIODesc *fd) {
 return (((fd) && ((fd)->data) && ((fd)->plugin == &r_io_plugin_rap)))? (((RIORap*)((fd)->data))->listener): 0;
}

static char *__rap_system(RIO *io, RIODesc *fd, const char *command) {
 RSocket *s = (((fd)->data)?(((RIORap*)((fd)->data))->client):
# 167 "project/radare2/libr/io/p/io_rap.c" 3 4
             ((void *)0)
# 167 "project/radare2/libr/io/p/io_rap.c"
             );

 return r_socket_rap_client_command (s, command, &io->corebind);
# 273 "project/radare2/libr/io/p/io_rap.c"
 return 
# 273 "project/radare2/libr/io/p/io_rap.c" 3 4
       ((void *)0)
# 273 "project/radare2/libr/io/p/io_rap.c"
           ;
}
...
# 293 "project/radare2/libr/io/p/io_rap.c" 3 4
__attribute__((visibility("default"))) 
# 293 "project/radare2/libr/io/p/io_rap.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_rap,
 .version = 
# 296 "project/radare2/libr/io/p/io_rap.c" 3 4
           "5.5.4"

# 297 "project/radare2/libr/io/p/io_rap.c"
};
