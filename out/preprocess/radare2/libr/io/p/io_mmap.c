# 0 "project/radare2/libr/io/p/io_mmap.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/io/p/io_mmap.c"
...
# 4 "project/radare2/libr/io/p/io_mmap.c" 2
...
# 5 "project/radare2/libr/io/p/io_mmap.c" 2
...
# 6 "project/radare2/libr/io/p/io_mmap.c" 2


# 7 "project/radare2/libr/io/p/io_mmap.c"
...
# 13 "project/radare2/libr/io/p/io_mmap.c" 3 4
unsigned char 
# 13 "project/radare2/libr/io/p/io_mmap.c"
    modified;
 RBuffer *buf;
 RIO * io_backref;
} RIOMMapFileObj;
...
static 
# 18 "project/radare2/libr/io/p/io_mmap.c" 3 4
      unsigned long long 
# 18 "project/radare2/libr/io/p/io_mmap.c"
           r_io_mmap_seek(RIO *io, RIOMMapFileObj *mmo, 
# 18 "project/radare2/libr/io/p/io_mmap.c" 3 4
                                                        unsigned long long 
# 18 "project/radare2/libr/io/p/io_mmap.c"
                                                             offset, int whence) {
 
# 19 "project/radare2/libr/io/p/io_mmap.c" 3 4
unsigned long long 
# 19 "project/radare2/libr/io/p/io_mmap.c"
     seek_val = r_buf_tell (mmo->buf);
 switch (whence) {
 case 
# 21 "project/radare2/libr/io/p/io_mmap.c" 3 4
     0
# 21 "project/radare2/libr/io/p/io_mmap.c"
             :
  seek_val = (r_buf_size (mmo->buf) < offset)? r_buf_size (mmo->buf): offset;
  r_buf_seek (mmo->buf, io->off = seek_val, 
# 23 "project/radare2/libr/io/p/io_mmap.c" 3 4
                                           0
# 23 "project/radare2/libr/io/p/io_mmap.c"
                                                    );
  return seek_val;
 case 
# 25 "project/radare2/libr/io/p/io_mmap.c" 3 4
     1
# 25 "project/radare2/libr/io/p/io_mmap.c"
             :
  seek_val = (r_buf_size (mmo->buf) < (offset + r_buf_tell (mmo->buf)))? r_buf_size (mmo->buf): offset + r_buf_tell (mmo->buf);
  r_buf_seek (mmo->buf, io->off = seek_val, 
# 27 "project/radare2/libr/io/p/io_mmap.c" 3 4
                                           0
# 27 "project/radare2/libr/io/p/io_mmap.c"
                                                    );
  return seek_val;
 case 
# 29 "project/radare2/libr/io/p/io_mmap.c" 3 4
     2
# 29 "project/radare2/libr/io/p/io_mmap.c"
             :
  seek_val = r_buf_size (mmo->buf);
  r_buf_seek (mmo->buf, io->off = seek_val, 
# 31 "project/radare2/libr/io/p/io_mmap.c" 3 4
                                           0
# 31 "project/radare2/libr/io/p/io_mmap.c"
                                                    );
  return seek_val;
 }
 return seek_val;
...
static 
# 37 "project/radare2/libr/io/p/io_mmap.c" 3 4
      _Bool 
# 37 "project/radare2/libr/io/p/io_mmap.c"
           r_io_mmap_refresh_buf(RIOMMapFileObj *mmo) {
 RIO* io = mmo->io_backref;
 
# 39 "project/radare2/libr/io/p/io_mmap.c" 3 4
unsigned long long 
# 39 "project/radare2/libr/io/p/io_mmap.c"
     cur = mmo->buf? r_buf_tell (mmo->buf): 0;
 if (mmo->buf) {
  r_buf_free (mmo->buf);
  mmo->buf = 
# 42 "project/radare2/libr/io/p/io_mmap.c" 3 4
            ((void *)0)
# 42 "project/radare2/libr/io/p/io_mmap.c"
                ;
 }
 mmo->buf = r_buf_new_mmap (mmo->filename, mmo->flags);
 if (mmo->buf) {
  r_io_mmap_seek (io, mmo, cur, 
# 46 "project/radare2/libr/io/p/io_mmap.c" 3 4
                               0
# 46 "project/radare2/libr/io/p/io_mmap.c"
                                       );
 }
 return mmo->buf != 
# 48 "project/radare2/libr/io/p/io_mmap.c" 3 4
                   ((void *)0)
# 48 "project/radare2/libr/io/p/io_mmap.c"
                       ;
}
...
# 54 "project/radare2/libr/io/p/io_mmap.c" 3 4
__builtin___memset_chk (
# 54 "project/radare2/libr/io/p/io_mmap.c"
mmo
# 54 "project/radare2/libr/io/p/io_mmap.c" 3 4
, 
# 54 "project/radare2/libr/io/p/io_mmap.c"
0, sizeof (RIOMMapFileObj)
# 54 "project/radare2/libr/io/p/io_mmap.c" 3 4
...
RIOMMapFileObj *r_io_mmap_create_new_file(RIO *io, const char *filename, int mode, int flags) {
 ...
 if (!io) {
  return 
# 61 "project/radare2/libr/io/p/io_mmap.c" 3 4
        ((void *)0)
# 61 "project/radare2/libr/io/p/io_mmap.c"
            ;
 }
 mmo = 
# 63 "project/radare2/libr/io/p/io_mmap.c" 3 4
      (
# 63 "project/radare2/libr/io/p/io_mmap.c"
      RIOMMapFileObj
# 63 "project/radare2/libr/io/p/io_mmap.c" 3 4
      *)calloc(1,sizeof(
# 63 "project/radare2/libr/io/p/io_mmap.c"
...
# 63 "project/radare2/libr/io/p/io_mmap.c"
 ...
 if (!mmo) {
  return 
# 65 "project/radare2/libr/io/p/io_mmap.c" 3 4
        ((void *)0)
# 65 "project/radare2/libr/io/p/io_mmap.c"
            ;
 }
 ...
 if (!r_io_mmap_refresh_buf (mmo)) {
  r_io_mmap_free (mmo);
  mmo = 
# 74 "project/radare2/libr/io/p/io_mmap.c" 3 4
       ((void *)0)
# 74 "project/radare2/libr/io/p/io_mmap.c"
           ;
 }
 return mmo;
}
...
static int r_io_mmap_read(RIO *io, RIODesc *fd, 
# 83 "project/radare2/libr/io/p/io_mmap.c" 3 4
                                               unsigned char 
# 83 "project/radare2/libr/io/p/io_mmap.c"
                                                   *buf, int count) {
 RIOMMapFileObj *mmo = 
# 84 "project/radare2/libr/io/p/io_mmap.c" 3 4
                      ((void *)0)
# 84 "project/radare2/libr/io/p/io_mmap.c"
                          ;
 if (!fd || !fd->data || !buf) {
  return -1;
 }
...
# 94 "project/radare2/libr/io/p/io_mmap.c" 3 4
                          1
# 94 "project/radare2/libr/io/p/io_mmap.c"
                                   );
 }
 return r;
}

static int r_io_mmap_write(RIO *io, RIODesc *fd, const 
# 99 "project/radare2/libr/io/p/io_mmap.c" 3 4
                                                      unsigned char 
# 99 "project/radare2/libr/io/p/io_mmap.c"
                                                          *buf, int count) {
 RIOMMapFileObj *mmo;
 int len = count;
 
# 102 "project/radare2/libr/io/p/io_mmap.c" 3 4
unsigned long long 
# 102 "project/radare2/libr/io/p/io_mmap.c"
     addr;
 ...
 addr = io->off;
 if ( !(mmo->flags & 
# 109 "project/radare2/libr/io/p/io_mmap.c" 3 4
                    2
# 109 "project/radare2/libr/io/p/io_mmap.c"
                            )) {
  return -1;
 }
 if ( (count + addr > r_buf_size (mmo->buf)) || r_buf_size (mmo->buf) == 0) {
  
# 113 "project/radare2/libr/io/p/io_mmap.c" 3 4
 unsigned long long 
# 113 "project/radare2/libr/io/p/io_mmap.c"
      sz = count + addr;
...
# 118 "project/radare2/libr/io/p/io_mmap.c" 3 4
 fprintf(__stderrp,
# 118 "project/radare2/libr/io/p/io_mmap.c"
 "io_mmap: failed to refresh the mmap backed buffer.\n"
# 118 "project/radare2/libr/io/p/io_mmap.c" 3 4
 )
# 118 "project/radare2/libr/io/p/io_mmap.c"
                                                                 ;
...
static RIODesc *r_io_mmap_open(RIO *io, const char *file, int flags, int mode) {
 ...
 return mmo? r_io_desc_new (io, &r_io_plugin_mmap, mmo->filename, flags, mode, mmo): 
# 129 "project/radare2/libr/io/p/io_mmap.c" 3 4
                                                                                    ((void *)0)
# 129 "project/radare2/libr/io/p/io_mmap.c"
                                                                                        ;
}

static 
# 132 "project/radare2/libr/io/p/io_mmap.c" 3 4
      unsigned long long 
# 132 "project/radare2/libr/io/p/io_mmap.c"
           r_io_mmap_lseek(RIO *io, RIODesc *fd, 
# 132 "project/radare2/libr/io/p/io_mmap.c" 3 4
                                                 unsigned long long 
# 132 "project/radare2/libr/io/p/io_mmap.c"
                                                      offset, int whence) {
...
static 
# 141 "project/radare2/libr/io/p/io_mmap.c" 3 4
      _Bool 
# 141 "project/radare2/libr/io/p/io_mmap.c"
           r_io_mmap_truncate(RIOMMapFileObj *mmo, 
# 141 "project/radare2/libr/io/p/io_mmap.c" 3 4
                                                   unsigned long long 
# 141 "project/radare2/libr/io/p/io_mmap.c"
                                                        size) {
...
# 144 "project/radare2/libr/io/p/io_mmap.c" 3 4
 fprintf(__stderrp,
# 144 "project/radare2/libr/io/p/io_mmap.c"
 "r_io_mmap_truncate: Error trying to refresh the mmap'ed file."
# 144 "project/radare2/libr/io/p/io_mmap.c" 3 4
 )
# 144 "project/radare2/libr/io/p/io_mmap.c"
                                                                          ;
  res = 
# 145 "project/radare2/libr/io/p/io_mmap.c" 3 4
       0
# 145 "project/radare2/libr/io/p/io_mmap.c"
            ;
 } else if (res) {
  
# 147 "project/radare2/libr/io/p/io_mmap.c" 3 4
 fprintf(__stderrp,
# 147 "project/radare2/libr/io/p/io_mmap.c"
 "r_io_mmap_truncate: Error trying to resize the file."
# 147 "project/radare2/libr/io/p/io_mmap.c" 3 4
 )
# 147 "project/radare2/libr/io/p/io_mmap.c"
                                                                 ;
...
static 
# 153 "project/radare2/libr/io/p/io_mmap.c" 3 4
      _Bool 
# 153 "project/radare2/libr/io/p/io_mmap.c"
...
static RIODesc *__open(RIO *io, const char *file, int flags, int mode) {
 if (!r_io_mmap_check (file)) {
  return 
# 159 "project/radare2/libr/io/p/io_mmap.c" 3 4
        ((void *)0)
# 159 "project/radare2/libr/io/p/io_mmap.c"
            ;
 }
...
# 164 "project/radare2/libr/io/p/io_mmap.c" 3 4
                                       unsigned char 
# 164 "project/radare2/libr/io/p/io_mmap.c"
                                           *buf, int len) {
 return r_io_mmap_read (io, fd, buf, len);
}

static int __write(RIO *io, RIODesc *fd, const 
# 168 "project/radare2/libr/io/p/io_mmap.c" 3 4
                                              unsigned char 
# 168 "project/radare2/libr/io/p/io_mmap.c"
                                                  *buf, int len) {
 return r_io_mmap_write(io, fd, buf, len);
}

static 
# 172 "project/radare2/libr/io/p/io_mmap.c" 3 4
      unsigned long long 
# 172 "project/radare2/libr/io/p/io_mmap.c"
...
static 
# 176 "project/radare2/libr/io/p/io_mmap.c" 3 4
      _Bool 
# 176 "project/radare2/libr/io/p/io_mmap.c"
           __close(RIODesc *fd) {
 if (!fd || !fd->data) {
  return 
# 178 "project/radare2/libr/io/p/io_mmap.c" 3 4
        0
# 178 "project/radare2/libr/io/p/io_mmap.c"
             ;
 }
 r_io_mmap_free ((RIOMMapFileObj *) fd->data);
 fd->data = 
# 181 "project/radare2/libr/io/p/io_mmap.c" 3 4
           ((void *)0)
# 181 "project/radare2/libr/io/p/io_mmap.c"
               ;
 return 
# 182 "project/radare2/libr/io/p/io_mmap.c" 3 4
       1
# 182 "project/radare2/libr/io/p/io_mmap.c"
           ;
}

static 
# 185 "project/radare2/libr/io/p/io_mmap.c" 3 4
      _Bool 
# 185 "project/radare2/libr/io/p/io_mmap.c"
...
# 185 "project/radare2/libr/io/p/io_mmap.c"
 ...
 if (!fd || !fd->data) {
  return 
# 187 "project/radare2/libr/io/p/io_mmap.c" 3 4
        0
# 187 "project/radare2/libr/io/p/io_mmap.c"
             ;
 }
...
# 207 "project/radare2/libr/io/p/io_mmap.c" 3 4
__attribute__((visibility("default"))) 
# 207 "project/radare2/libr/io/p/io_mmap.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_mmap,
 .version = 
# 210 "project/radare2/libr/io/p/io_mmap.c" 3 4
           "5.5.4"

# 211 "project/radare2/libr/io/p/io_mmap.c"
};
