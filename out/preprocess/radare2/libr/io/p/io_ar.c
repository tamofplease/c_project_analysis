# 0 "project/radare2/libr/io/p/io_ar.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/io/p/io_ar.c"
...
# 4 "project/radare2/libr/io/p/io_ar.c" 2
...
# 5 "project/radare2/libr/io/p/io_ar.c" 2


# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/ar.h" 1 3 4
# 56 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/ar.h" 3 4
struct ar_hdr {
 char ar_name[16];
 char ar_date[12];
 char ar_uid[6];
...
# 8 "project/radare2/libr/io/p/io_ar.c" 2



# 10 "project/radare2/libr/io/p/io_ar.c"
static const char *r_io_get_individual_schema(const char *file) {
 ...
 return 
# 17 "project/radare2/libr/io/p/io_ar.c" 3 4
       ((void *)0)
# 17 "project/radare2/libr/io/p/io_ar.c"
           ;
}

static 
# 20 "project/radare2/libr/io/p/io_ar.c" 3 4
      _Bool 
# 20 "project/radare2/libr/io/p/io_ar.c"
           r_io_ar_plugin_open(RIO *io, const char *file, 
# 20 "project/radare2/libr/io/p/io_ar.c" 3 4
                                                          _Bool 
# 20 "project/radare2/libr/io/p/io_ar.c"
                                                               many) {
 
# 21 "project/radare2/libr/io/p/io_ar.c" 3 4
do { if (!(
# 21 "project/radare2/libr/io/p/io_ar.c"
io && file
# 21 "project/radare2/libr/io/p/io_ar.c" 3 4
...
# 23 "project/radare2/libr/io/p/io_ar.c" 3 4
                                              ((void *)0)
# 23 "project/radare2/libr/io/p/io_ar.c"
                                                  );
 }
...
static 
# 28 "project/radare2/libr/io/p/io_ar.c" 3 4
      _Bool 
# 28 "project/radare2/libr/io/p/io_ar.c"
           r_io_ar_close(RIODesc *fd) {
 if (!fd || !fd->data) {
  return 
# 30 "project/radare2/libr/io/p/io_ar.c" 3 4
        0
# 30 "project/radare2/libr/io/p/io_ar.c"
             ;
 }
...
# 36 "project/radare2/libr/io/p/io_ar.c" 3 4
do { if (!(
# 36 "project/radare2/libr/io/p/io_ar.c"
r_io_ar_plugin_open (io, file, 
# 36 "project/radare2/libr/io/p/io_ar.c" 3 4
0
# 36 "project/radare2/libr/io/p/io_ar.c"
)
...
# 36 "project/radare2/libr/io/p/io_ar.c"
"r_io_ar_plugin_open (io, file, false)"
# 36 "project/radare2/libr/io/p/io_ar.c" 3 4
, 36); return (((void *)0)); } } while (0)
# 36 "project/radare2/libr/io/p/io_ar.c"
                                                                  ;
 char *uri = strdup (file);
 if (!uri) {
  return 
# 39 "project/radare2/libr/io/p/io_ar.c" 3 4
        ((void *)0)
# 39 "project/radare2/libr/io/p/io_ar.c"
            ;
 }
 RIODesc *res = 
# 41 "project/radare2/libr/io/p/io_ar.c" 3 4
               ((void *)0)
# 41 "project/radare2/libr/io/p/io_ar.c"
                   ;
...
# 67 "project/radare2/libr/io/p/io_ar.c" 3 4
_Bool 
# 67 "project/radare2/libr/io/p/io_ar.c"
     rw;
 int mode;
 RList *list;
} ar_many_data;
...
# 92 "project/radare2/libr/io/p/io_ar.c" 3 4
do { if (!(
# 92 "project/radare2/libr/io/p/io_ar.c"
io && file
# 92 "project/radare2/libr/io/p/io_ar.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 92 "project/radare2/libr/io/p/io_ar.c"
...
# 92 "project/radare2/libr/io/p/io_ar.c"
                                       ;
 ar_many_data data;
 if ((data.schema = r_io_get_individual_schema (file)) == 
# 94 "project/radare2/libr/io/p/io_ar.c" 3 4
                                                         ((void *)0)
# 94 "project/radare2/libr/io/p/io_ar.c"
                                                             ) {
  
# 95 "project/radare2/libr/io/p/io_ar.c" 3 4
 do { r_assert_log (R_LOGLVL_WARN, "(%s:%d):%s%s code should not be reached\n", "project/radare2/libr/io/p/io_ar.c", 95, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : ""); } while (0)
# 95 "project/radare2/libr/io/p/io_ar.c"
                     ;
  return 
# 96 "project/radare2/libr/io/p/io_ar.c" 3 4
        ((void *)0)
# 96 "project/radare2/libr/io/p/io_ar.c"
            ;
 }
 data.io = io;
 data.rw = rw;
 ...
 if (data.list && ar_open_all_cb (data.arname, (RArOpenManyCB)__io_ar_list, (void *)&data) < 0) {
  ...
  return 
# 105 "project/radare2/libr/io/p/io_ar.c" 3 4
        ((void *)0)
# 105 "project/radare2/libr/io/p/io_ar.c"
            ;
 }
 return data.list;
}
...
static 
# 110 "project/radare2/libr/io/p/io_ar.c" 3 4
      unsigned long long 
# 110 "project/radare2/libr/io/p/io_ar.c"
           r_io_ar_lseek(RIO *io, RIODesc *fd, 
# 110 "project/radare2/libr/io/p/io_ar.c" 3 4
                                               unsigned long long 
# 110 "project/radare2/libr/io/p/io_ar.c"
                                                    offset, int whence) {
 
# 111 "project/radare2/libr/io/p/io_ar.c" 3 4
do { if (!(
# 111 "project/radare2/libr/io/p/io_ar.c"
io && fd && fd->data
# 111 "project/radare2/libr/io/p/io_ar.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 111 "project/radare2/libr/io/p/io_ar.c"
...
# 114 "project/radare2/libr/io/p/io_ar.c" 3 4
unsigned long long 
# 114 "project/radare2/libr/io/p/io_ar.c"
     size = arf->end - arf->start;
 switch (whence) {
 case 
# 116 "project/radare2/libr/io/p/io_ar.c" 3 4
     0
# 116 "project/radare2/libr/io/p/io_ar.c"
             :
  io->off = 
# 117 "project/radare2/libr/io/p/io_ar.c" 3 4
           (((
# 117 "project/radare2/libr/io/p/io_ar.c"
           size
# 117 "project/radare2/libr/io/p/io_ar.c" 3 4
           )>(
# 117 "project/radare2/libr/io/p/io_ar.c"
...
# 117 "project/radare2/libr/io/p/io_ar.c"
  ...
  break;
 case 
# 119 "project/radare2/libr/io/p/io_ar.c" 3 4
     1
# 119 "project/radare2/libr/io/p/io_ar.c"
             :
  io->off = 
# 120 "project/radare2/libr/io/p/io_ar.c" 3 4
           (((
# 120 "project/radare2/libr/io/p/io_ar.c"
           size
# 120 "project/radare2/libr/io/p/io_ar.c" 3 4
           )>(
# 120 "project/radare2/libr/io/p/io_ar.c"
...
# 120 "project/radare2/libr/io/p/io_ar.c"
  ...
  break;
 case 
# 122 "project/radare2/libr/io/p/io_ar.c" 3 4
     2
# 122 "project/radare2/libr/io/p/io_ar.c"
             :
  io->off = size;
  break;
 default:
...
static int r_io_ar_read(RIO *io, RIODesc *fd, 
# 132 "project/radare2/libr/io/p/io_ar.c" 3 4
                                             unsigned char 
# 132 "project/radare2/libr/io/p/io_ar.c"
                                                 *buf, int count) {
 if (!fd || !fd->data || !buf) {
  return -1;
 }
...
static int r_io_ar_write(RIO *io, RIODesc *fd, const 
# 139 "project/radare2/libr/io/p/io_ar.c" 3 4
                                                    unsigned char 
# 139 "project/radare2/libr/io/p/io_ar.c"
                                                        *buf, int count) {
 if (!fd || !fd->data || !buf) {
  return -1;
 }
...
# 161 "project/radare2/libr/io/p/io_ar.c" 3 4
__attribute__((visibility("default"))) 
# 161 "project/radare2/libr/io/p/io_ar.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_ar,
 .version = 
# 164 "project/radare2/libr/io/p/io_ar.c" 3 4
           "5.5.4"

# 165 "project/radare2/libr/io/p/io_ar.c"
};
