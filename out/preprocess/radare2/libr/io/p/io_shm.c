# 0 "project/radare2/libr/io/p/io_shm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/io/p/io_shm.c"
...
# 4 "project/radare2/libr/io/p/io_shm.c" 2
...
# 5 "project/radare2/libr/io/p/io_shm.c" 2
# 18 "project/radare2/libr/io/p/io_shm.c"
...
#pragma pack()
# 170 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/ipc.h" 3 4


key_t ftok(const char *, int);

# 19 "project/radare2/libr/io/p/io_shm.c" 2
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/shm.h" 1 3 4
# 93 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/shm.h" 3 4
typedef unsigned short shmatt_t;
# 123 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/shm.h" 3 4
#pragma pack(4)
# 145 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/shm.h" 3 4
...
# 176 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/shm.h" 3 4
#pragma pack()
...
# 20 "project/radare2/libr/io/p/io_shm.c" 2
...
# 21 "project/radare2/libr/io/p/io_shm.c" 2


# 22 "project/radare2/libr/io/p/io_shm.c"
typedef struct {
 int fd;
 int id;
 
# 25 "project/radare2/libr/io/p/io_shm.c" 3 4
unsigned char 
# 25 "project/radare2/libr/io/p/io_shm.c"
    *buf;
 
# 26 "project/radare2/libr/io/p/io_shm.c" 3 4
unsigned int 
# 26 "project/radare2/libr/io/p/io_shm.c"
     size;
} RIOShm;
...
static int shm__write(RIO *io, RIODesc *fd, const 
# 32 "project/radare2/libr/io/p/io_shm.c" 3 4
                                                 unsigned char 
# 32 "project/radare2/libr/io/p/io_shm.c"
                                                     *buf, int count) {
 
# 33 "project/radare2/libr/io/p/io_shm.c" 3 4
do { if (!(
# 33 "project/radare2/libr/io/p/io_shm.c"
fd && fd->data
# 33 "project/radare2/libr/io/p/io_shm.c" 3 4
...
# 33 "project/radare2/libr/io/p/io_shm.c"
 ...
 if (shm->buf) {
  (void)
# 36 "project/radare2/libr/io/p/io_shm.c" 3 4
       __builtin___memcpy_chk (
# 36 "project/radare2/libr/io/p/io_shm.c"
       shm->buf + io->off
# 36 "project/radare2/libr/io/p/io_shm.c" 3 4
       , 
# 36 "project/radare2/libr/io/p/io_shm.c"
...
static int shm__read(RIO *io, RIODesc *fd, 
# 42 "project/radare2/libr/io/p/io_shm.c" 3 4
                                          unsigned char 
# 42 "project/radare2/libr/io/p/io_shm.c"
                                              *buf, int count) {
 
# 43 "project/radare2/libr/io/p/io_shm.c" 3 4
do { if (!(
# 43 "project/radare2/libr/io/p/io_shm.c"
fd && fd->data
# 43 "project/radare2/libr/io/p/io_shm.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 43 "project/radare2/libr/io/p/io_shm.c"
...
# 52 "project/radare2/libr/io/p/io_shm.c" 3 4
 __builtin___memcpy_chk (
# 52 "project/radare2/libr/io/p/io_shm.c"
 buf
# 52 "project/radare2/libr/io/p/io_shm.c" 3 4
 , 
# 52 "project/radare2/libr/io/p/io_shm.c"
 shm->buf + io->off , count
# 52 "project/radare2/libr/io/p/io_shm.c" 3 4
 , __builtin_object_size (
# 52 "project/radare2/libr/io/p/io_shm.c"
 buf
...
static 
# 58 "project/radare2/libr/io/p/io_shm.c" 3 4
      _Bool 
# 58 "project/radare2/libr/io/p/io_shm.c"
           shm__close(RIODesc *fd) {
 
# 59 "project/radare2/libr/io/p/io_shm.c" 3 4
do { if (!(
# 59 "project/radare2/libr/io/p/io_shm.c"
fd && fd->data
# 59 "project/radare2/libr/io/p/io_shm.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 59 "project/radare2/libr/io/p/io_shm.c"
...
# 64 "project/radare2/libr/io/p/io_shm.c" 3 4
{ free((void *)
# 64 "project/radare2/libr/io/p/io_shm.c"
fd->data
# 64 "project/radare2/libr/io/p/io_shm.c" 3 4
); 
# 64 "project/radare2/libr/io/p/io_shm.c"
...
static 
# 68 "project/radare2/libr/io/p/io_shm.c" 3 4
      unsigned long long 
# 68 "project/radare2/libr/io/p/io_shm.c"
           shm__lseek(RIO *io, RIODesc *fd, 
# 68 "project/radare2/libr/io/p/io_shm.c" 3 4
                                            unsigned long long 
# 68 "project/radare2/libr/io/p/io_shm.c"
                                                 offset, int whence) {
 
# 69 "project/radare2/libr/io/p/io_shm.c" 3 4
do { if (!(
# 69 "project/radare2/libr/io/p/io_shm.c"
fd && fd->data
# 69 "project/radare2/libr/io/p/io_shm.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 69 "project/radare2/libr/io/p/io_shm.c"
...
# 69 "project/radare2/libr/io/p/io_shm.c"
 ...
 switch (whence) {
 case 
# 72 "project/radare2/libr/io/p/io_shm.c" 3 4
     0
# 72 "project/radare2/libr/io/p/io_shm.c"
             :
  io->off = offset;
  break;
 case 
# 75 "project/radare2/libr/io/p/io_shm.c" 3 4
     1
# 75 "project/radare2/libr/io/p/io_shm.c"
             :
  ...
  break;
 case 
# 82 "project/radare2/libr/io/p/io_shm.c" 3 4
     2
# 82 "project/radare2/libr/io/p/io_shm.c"
             :
  io->off = ((int)shm->size > 0) ? shm->size : 
# 83 "project/radare2/libr/io/p/io_shm.c" 3 4
                                              0xFFFFFFFFFFFFFFFFULL
# 83 "project/radare2/libr/io/p/io_shm.c"
                                                      ;
  io->off += (int)offset;
  break;
 }
...
static 
# 90 "project/radare2/libr/io/p/io_shm.c" 3 4
      _Bool 
# 90 "project/radare2/libr/io/p/io_shm.c"
           shm__plugin_open(RIO *io, const char *pathname, 
# 90 "project/radare2/libr/io/p/io_shm.c" 3 4
                                                           _Bool 
# 90 "project/radare2/libr/io/p/io_shm.c"
                                                                many) {
...
static RIODesc *shm__open(RIO *io, const char *pathname, int rw, int mode) {
 if (!strncmp (pathname, "shm://", 6)) {
  RIOShm *shm = 
# 100 "project/radare2/libr/io/p/io_shm.c" 3 4
               (
# 100 "project/radare2/libr/io/p/io_shm.c"
               RIOShm
# 100 "project/radare2/libr/io/p/io_shm.c" 3 4
               *)calloc(1,sizeof(
# 100 "project/radare2/libr/io/p/io_shm.c"
...
# 100 "project/radare2/libr/io/p/io_shm.c"
  ...
  if (!shm) {
   return 
# 102 "project/radare2/libr/io/p/io_shm.c" 3 4
         ((void *)0)
# 102 "project/radare2/libr/io/p/io_shm.c"
             ;
  }
...
# 123 "project/radare2/libr/io/p/io_shm.c" 3 4
  fprintf(__stderrp,
# 123 "project/radare2/libr/io/p/io_shm.c"
  "Connected to shared memory 0x%08x\n", shm->id
# 123 "project/radare2/libr/io/p/io_shm.c" 3 4
  )
# 123 "project/radare2/libr/io/p/io_shm.c"
                                                          ;
...
# 126 "project/radare2/libr/io/p/io_shm.c" 3 4
 fprintf(__stderrp,
# 126 "project/radare2/libr/io/p/io_shm.c"
...
# 126 "project/radare2/libr/io/p/io_shm.c"
 ...
 return 
# 129 "project/radare2/libr/io/p/io_shm.c" 3 4
       ((void *)0)
# 129 "project/radare2/libr/io/p/io_shm.c"
           ;
}
...
# 154 "project/radare2/libr/io/p/io_shm.c"

# 154 "project/radare2/libr/io/p/io_shm.c" 3 4
...
# 154 "project/radare2/libr/io/p/io_shm.c"
 ...
 .version = 
# 157 "project/radare2/libr/io/p/io_shm.c" 3 4
           "5.5.4"

# 158 "project/radare2/libr/io/p/io_shm.c"
};
