# 0 "project/radare2/libr/io/p/io_r2pipe.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/io/p/io_r2pipe.c"
...
# 4 "project/radare2/libr/io/p/io_r2pipe.c" 2
...
# 5 "project/radare2/libr/io/p/io_r2pipe.c" 2
# 15 "project/radare2/libr/io/p/io_r2pipe.c"

# 15 "project/radare2/libr/io/p/io_r2pipe.c"
static int __write(RIO *io, RIODesc *fd, const 
# 15 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
                                              unsigned char 
# 15 "project/radare2/libr/io/p/io_r2pipe.c"
                                                  *buf, int count) {
 char fmt[4096];
...
# 27 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
 __builtin___snprintf_chk (
# 27 "project/radare2/libr/io/p/io_r2pipe.c"
 bufn
# 27 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
 , 
# 27 "project/radare2/libr/io/p/io_r2pipe.c"
...
# 27 "project/radare2/libr/io/p/io_r2pipe.c"
 ...
 int len = 
# 31 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
          __builtin___snprintf_chk (
# 31 "project/radare2/libr/io/p/io_r2pipe.c"
          fmt
# 31 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
          , 
# 31 "project/radare2/libr/io/p/io_r2pipe.c"
...
# 31 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
          "lld" 
# 31 "project/radare2/libr/io/p/io_r2pipe.c"
          ",\"data\":[%s]}", io->off, bufnum
# 31 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
          )

                  
# 33 "project/radare2/libr/io/p/io_r2pipe.c"
                 ;
 if (len >= sizeof (fmt)) {
  
# 35 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
 fprintf(__stderrp,
# 35 "project/radare2/libr/io/p/io_r2pipe.c"
 "r2pipe_write: error, fmt string has been truncated\n"
# 35 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
 )
# 35 "project/radare2/libr/io/p/io_r2pipe.c"
                                                                 ;
 ...
 rv = r2pipe_write (((R2Pipe*)(fd)->data), fmt);
 if (rv < 1) {
  
# 40 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
 fprintf(__stderrp,
# 40 "project/radare2/libr/io/p/io_r2pipe.c"
 "r2pipe_write: error\n"
# 40 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
 )
# 40 "project/radare2/libr/io/p/io_r2pipe.c"
 ...
 res = r2pipe_read (((R2Pipe*)(fd)->data));
...
# 53 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
                                       unsigned char 
# 53 "project/radare2/libr/io/p/io_r2pipe.c"
                                           *buf, int count) {
...
# 65 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
__builtin___snprintf_chk (
# 65 "project/radare2/libr/io/p/io_r2pipe.c"
fmt
# 65 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
, 
# 65 "project/radare2/libr/io/p/io_r2pipe.c"
...
"lld"
# 65 "project/radare2/libr/io/p/io_r2pipe.c"
",\"count\":%d}", io->off, count
# 65 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
)

                 
# 67 "project/radare2/libr/io/p/io_r2pipe.c"
                ;
 rv = r2pipe_write (((R2Pipe*)(fd)->data), fmt);
 if (rv < 1) {
  
# 70 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
 fprintf(__stderrp,
# 70 "project/radare2/libr/io/p/io_r2pipe.c"
 "r2pipe_write: error\n"
# 70 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
 )
# 70 "project/radare2/libr/io/p/io_r2pipe.c"
...
static 
# 125 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
      _Bool 
# 125 "project/radare2/libr/io/p/io_r2pipe.c"
           __close(RIODesc *fd) {
 if (!fd || !fd->data) {
  return 
# 127 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
        0
# 127 "project/radare2/libr/io/p/io_r2pipe.c"
             ;
 }
 r2pipe_close (fd->data);
 fd->data = 
# 130 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
           ((void *)0)
# 130 "project/radare2/libr/io/p/io_r2pipe.c"
               ;
 return 
# 131 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
       1
# 131 "project/radare2/libr/io/p/io_r2pipe.c"
           ;
}

static 
# 134 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
      unsigned long long 
# 134 "project/radare2/libr/io/p/io_r2pipe.c"
...
# 134 "project/radare2/libr/io/p/io_r2pipe.c"
 ...
 switch (whence) {
 case 
# 136 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
     0
# 136 "project/radare2/libr/io/p/io_r2pipe.c"
             : return offset;
 case 
# 137 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
     1
# 137 "project/radare2/libr/io/p/io_r2pipe.c"
             : return io->off + offset;
 case 
# 138 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
     2
# 138 "project/radare2/libr/io/p/io_r2pipe.c"
             : return 
# 138 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
...
static 
# 143 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
      _Bool 
# 143 "project/radare2/libr/io/p/io_r2pipe.c"
...
static RIODesc *__open(RIO *io, const char *pathname, int rw, int mode) {
 R2Pipe *r2p = 
# 148 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
              ((void *)0)
# 148 "project/radare2/libr/io/p/io_r2pipe.c"
                  ;
...
# 153 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
                           ((void *)0)
# 153 "project/radare2/libr/io/p/io_r2pipe.c"
                               ;
}

static char *__system(RIO *io, RIODesc *fd, const char *msg) {
 
# 157 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
do { if (!(
# 157 "project/radare2/libr/io/p/io_r2pipe.c"
io && fd && msg
# 157 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
...
# 157 "project/radare2/libr/io/p/io_r2pipe.c"
 ...
 int rv = r2pipe_write (((R2Pipe*)(fd)->data), fmt);
 pj_free (pj);
 if (rv < 1) {
  
# 167 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
 fprintf(__stderrp,
# 167 "project/radare2/libr/io/p/io_r2pipe.c"
 "r2pipe_write: error\n"
# 167 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
 )
# 167 "project/radare2/libr/io/p/io_r2pipe.c"
                                  ;
  return 
# 168 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
        ((void *)0)
# 168 "project/radare2/libr/io/p/io_r2pipe.c"
            ;
 }
 char *res = r2pipe_read (((R2Pipe*)(fd)->data));
...
# 176 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
 fprintf(__stderrp,
# 176 "project/radare2/libr/io/p/io_r2pipe.c"
 "RESULT %d\n", rescount
# 176 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
 )
# 176 "project/radare2/libr/io/p/io_r2pipe.c"
 ...
 free (res);
 return 
# 179 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
       ((void *)0)
# 179 "project/radare2/libr/io/p/io_r2pipe.c"
           ;
}
...
# 197 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
__attribute__((visibility("default"))) 
# 197 "project/radare2/libr/io/p/io_r2pipe.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_r2pipe,
 .version = 
# 200 "project/radare2/libr/io/p/io_r2pipe.c" 3 4
           "5.5.4"

# 201 "project/radare2/libr/io/p/io_r2pipe.c"
};
