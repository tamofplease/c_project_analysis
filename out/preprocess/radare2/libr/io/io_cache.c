# 0 "project/radare2/libr/io/io_cache.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/io/io_cache.c"
...
# 4 "project/radare2/libr/io/io_cache.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_skyline.h" 1 3 4
# 5 "project/radare2/libr/io/io_cache.c" 2


# 6 "project/radare2/libr/io/io_cache.c"
...
# 14 "project/radare2/libr/io/io_cache.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 14 "project/radare2/libr/io/io_cache.c"
          r_io_cache_at(RIO *io, 
# 14 "project/radare2/libr/io/io_cache.c" 3 4
                                 unsigned long long 
# 14 "project/radare2/libr/io/io_cache.c"
                                      addr) {
 
# 15 "project/radare2/libr/io/io_cache.c" 3 4
do { if (!(
# 15 "project/radare2/libr/io/io_cache.c"
io
# 15 "project/radare2/libr/io/io_cache.c" 3 4
...
# 19 "project/radare2/libr/io/io_cache.c" 3 4
__attribute__((visibility("default"))) 
# 19 "project/radare2/libr/io/io_cache.c"
     void r_io_cache_init(RIO *io) {
 
# 20 "project/radare2/libr/io/io_cache.c" 3 4
do { if (!(
# 20 "project/radare2/libr/io/io_cache.c"
io
# 20 "project/radare2/libr/io/io_cache.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 20 "project/radare2/libr/io/io_cache.c"
...
# 27 "project/radare2/libr/io/io_cache.c" 3 4
__attribute__((visibility("default"))) 
# 27 "project/radare2/libr/io/io_cache.c"
     void r_io_cache_fini(RIO *io) {
 
# 28 "project/radare2/libr/io/io_cache.c" 3 4
do { if (!(
# 28 "project/radare2/libr/io/io_cache.c"
io
# 28 "project/radare2/libr/io/io_cache.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 28 "project/radare2/libr/io/io_cache.c"
...
# 28 "project/radare2/libr/io/io_cache.c"
 ...
 io->buffer = 
# 32 "project/radare2/libr/io/io_cache.c" 3 4
             ((void *)0)
# 32 "project/radare2/libr/io/io_cache.c"
                 ;
 io->cached = 0;
}


# 36 "project/radare2/libr/io/io_cache.c" 3 4
__attribute__((visibility("default"))) 
# 36 "project/radare2/libr/io/io_cache.c"
     void r_io_cache_commit(RIO *io, 
# 36 "project/radare2/libr/io/io_cache.c" 3 4
                                     unsigned long long 
# 36 "project/radare2/libr/io/io_cache.c"
                                          from, 
...
# 37 "project/radare2/libr/io/io_cache.c" 3 4
do { if (!(
# 37 "project/radare2/libr/io/io_cache.c"
io
# 37 "project/radare2/libr/io/io_cache.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 37 "project/radare2/libr/io/io_cache.c"
...
# 41 "project/radare2/libr/io/io_cache.c" 3 4
for (
# 41 "project/radare2/libr/io/io_cache.c"
iter 
# 41 "project/radare2/libr/io/io_cache.c" 3 4
= (void **)(
# 41 "project/radare2/libr/io/io_cache.c"
...
# 41 "project/radare2/libr/io/io_cache.c"
  ...
  if (r_itv_overlap (c->itv, range)) {
   ...
   if (r_io_write_at (io, r_itv_begin (c->itv), c->data, r_itv_size (c->itv))) {
    c->written = 
# 47 "project/radare2/libr/io/io_cache.c" 3 4
                1
# 47 "project/radare2/libr/io/io_cache.c"
                    ;
   } else {
    
# 49 "project/radare2/libr/io/io_cache.c" 3 4
   fprintf(__stderrp,
# 49 "project/radare2/libr/io/io_cache.c"
   "Error writing change at 0x%08"
# 49 "project/radare2/libr/io/io_cache.c" 3 4
   "llx"
# 49 "project/radare2/libr/io/io_cache.c"
   "\n", r_itv_begin (c->itv)
...
# 57 "project/radare2/libr/io/io_cache.c" 3 4
__attribute__((visibility("default"))) 
# 57 "project/radare2/libr/io/io_cache.c"
     void r_io_cache_reset(RIO *io, int set) {
 
# 58 "project/radare2/libr/io/io_cache.c" 3 4
do { if (!(
# 58 "project/radare2/libr/io/io_cache.c"
io
# 58 "project/radare2/libr/io/io_cache.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 58 "project/radare2/libr/io/io_cache.c"
...
# 64 "project/radare2/libr/io/io_cache.c" 3 4
__attribute__((visibility("default"))) 
# 64 "project/radare2/libr/io/io_cache.c"
     int r_io_cache_invalidate(RIO *io, 
# 64 "project/radare2/libr/io/io_cache.c" 3 4
                                        unsigned long long 
# 64 "project/radare2/libr/io/io_cache.c"
                                             from, 
...
# 65 "project/radare2/libr/io/io_cache.c" 3 4
do { if (!(
# 65 "project/radare2/libr/io/io_cache.c"
io
# 65 "project/radare2/libr/io/io_cache.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 65 "project/radare2/libr/io/io_cache.c"
...
# 70 "project/radare2/libr/io/io_cache.c" 3 4
for (
# 70 "project/radare2/libr/io/io_cache.c"
iter 
# 70 "project/radare2/libr/io/io_cache.c" 3 4
= ((
# 70 "project/radare2/libr/io/io_cache.c"
...
# 70 "project/radare2/libr/io/io_cache.c"
  ...
  if (r_itv_overlap (c->itv, range)) {
   ...
   io->cached = cached;
   c->written = 
# 77 "project/radare2/libr/io/io_cache.c" 3 4
               0
# 77 "project/radare2/libr/io/io_cache.c"
                    ;
...
# 86 "project/radare2/libr/io/io_cache.c" 3 4
for (
# 86 "project/radare2/libr/io/io_cache.c"
iter 
# 86 "project/radare2/libr/io/io_cache.c" 3 4
= (void **)(
# 86 "project/radare2/libr/io/io_cache.c"
...
# 93 "project/radare2/libr/io/io_cache.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 93 "project/radare2/libr/io/io_cache.c"
          r_io_cache_list(RIO *io, int rad) {
 
# 94 "project/radare2/libr/io/io_cache.c" 3 4
do { if (!(
# 94 "project/radare2/libr/io/io_cache.c"
io
# 94 "project/radare2/libr/io/io_cache.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 94 "project/radare2/libr/io/io_cache.c"
...
# 94 "project/radare2/libr/io/io_cache.c"
 ...
 RIOCache *c;
 PJ *pj = 
# 98 "project/radare2/libr/io/io_cache.c" 3 4
         ((void *)0)
# 98 "project/radare2/libr/io/io_cache.c"
             ;
 if (rad == 2) {
  pj = pj_new ();
  pj_a (pj);
...
# 103 "project/radare2/libr/io/io_cache.c" 3 4
for (
# 103 "project/radare2/libr/io/io_cache.c"
iter 
# 103 "project/radare2/libr/io/io_cache.c" 3 4
= (void **)(
# 103 "project/radare2/libr/io/io_cache.c"
...
# 103 "project/radare2/libr/io/io_cache.c"
  ...
  c = *iter;
  const 
# 105 "project/radare2/libr/io/io_cache.c" 3 4
       unsigned long long 
# 105 "project/radare2/libr/io/io_cache.c"
            dataSize = r_itv_size (c->itv);
  if (rad == 1) {
   io->cb_printf ("wx ");
   for (i = 0; i < dataSize; i++) {
    io->cb_printf ("%02x", (
# 109 "project/radare2/libr/io/io_cache.c" 3 4
                           unsigned char
# 109 "project/radare2/libr/io/io_cache.c"
                              )(c->data[i] & 0xff));
   }
   io->cb_printf (" @ 0x%08"
# 111 "project/radare2/libr/io/io_cache.c" 3 4
                           "llx"
# 111 "project/radare2/libr/io/io_cache.c"
                                  , r_itv_begin (c->itv));
   io->cb_printf (" # replaces: ");
     for (i = 0; i < dataSize; i++) {
    io->cb_printf ("%02x", (
# 114 "project/radare2/libr/io/io_cache.c" 3 4
                           unsigned char
# 114 "project/radare2/libr/io/io_cache.c"
                              )(c->odata[i] & 0xff));
   }
   io->cb_printf ("\n");
  } else if (rad == 2) {
   ...
   io->cb_printf ("idx=%"
# 131 "project/radare2/libr/io/io_cache.c" 3 4
                        "zu"
# 131 "project/radare2/libr/io/io_cache.c"
                               " addr=0x%08"
# 131 "project/radare2/libr/io/io_cache.c" 3 4
                                            "llx"
# 131 "project/radare2/libr/io/io_cache.c"
...
# 131 "project/radare2/libr/io/io_cache.c"
 ...
 return 
# 149 "project/radare2/libr/io/io_cache.c" 3 4
       0
# 149 "project/radare2/libr/io/io_cache.c"
            ;
}


# 152 "project/radare2/libr/io/io_cache.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 152 "project/radare2/libr/io/io_cache.c"
          r_io_cache_write(RIO *io, 
# 152 "project/radare2/libr/io/io_cache.c" 3 4
                                    unsigned long long 
# 152 "project/radare2/libr/io/io_cache.c"
                                         addr, const 
...
# 153 "project/radare2/libr/io/io_cache.c" 3 4
do { if (!(
# 153 "project/radare2/libr/io/io_cache.c"
io && buf
# 153 "project/radare2/libr/io/io_cache.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 153 "project/radare2/libr/io/io_cache.c"
"io && buf"
# 153 "project/radare2/libr/io/io_cache.c" 3 4
, 153); return (0); } } while (0)
# 153 "project/radare2/libr/io/io_cache.c"
                                       ;
 RIOCache *ch = 
# 154 "project/radare2/libr/io/io_cache.c" 3 4
               (
# 154 "project/radare2/libr/io/io_cache.c"
               RIOCache
# 154 "project/radare2/libr/io/io_cache.c" 3 4
               *)calloc(1,sizeof(
# 154 "project/radare2/libr/io/io_cache.c"
...
# 154 "project/radare2/libr/io/io_cache.c"
 ...
 if (!ch) {
  return 
# 156 "project/radare2/libr/io/io_cache.c" 3 4
        0
# 156 "project/radare2/libr/io/io_cache.c"
             ;
 }
 ch->itv = (RInterval){addr, len};
 ch->odata = (
# 159 "project/radare2/libr/io/io_cache.c" 3 4
             unsigned char
# 159 "project/radare2/libr/io/io_cache.c"
                *)calloc (1, len + 1);
 if (!ch->odata) {
  free (ch);
  return 
# 162 "project/radare2/libr/io/io_cache.c" 3 4
        0
# 162 "project/radare2/libr/io/io_cache.c"
             ;
 }
 ch->data = (
# 164 "project/radare2/libr/io/io_cache.c" 3 4
            unsigned char
# 164 "project/radare2/libr/io/io_cache.c"
               *)calloc (1, len + 1);
 if (!ch->data) {
  free (ch->odata);
  free (ch);
  return 
# 168 "project/radare2/libr/io/io_cache.c" 3 4
        0
# 168 "project/radare2/libr/io/io_cache.c"
             ;
 }
 ch->written = 
# 170 "project/radare2/libr/io/io_cache.c" 3 4
              0
# 170 "project/radare2/libr/io/io_cache.c"
                   ;
 {
  const 
# 172 "project/radare2/libr/io/io_cache.c" 3 4
       _Bool 
# 172 "project/radare2/libr/io/io_cache.c"
            cm = io->cachemode;
  io->cachemode = 
# 173 "project/radare2/libr/io/io_cache.c" 3 4
                 0
# 173 "project/radare2/libr/io/io_cache.c"
                      ;
  ...
  if (io->nodup && !memcmp (ch->odata, buf, len)) {
   ...
   free (ch);
   return 
# 179 "project/radare2/libr/io/io_cache.c" 3 4
         0
# 179 "project/radare2/libr/io/io_cache.c"
              ;
  }
 }
 
# 182 "project/radare2/libr/io/io_cache.c" 3 4
__builtin___memcpy_chk (
# 182 "project/radare2/libr/io/io_cache.c"
ch->data
# 182 "project/radare2/libr/io/io_cache.c" 3 4
, 
# 182 "project/radare2/libr/io/io_cache.c"
...
# 182 "project/radare2/libr/io/io_cache.c"
 ...
 return 
# 187 "project/radare2/libr/io/io_cache.c" 3 4
       1
# 187 "project/radare2/libr/io/io_cache.c"
           ;
}


# 190 "project/radare2/libr/io/io_cache.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 190 "project/radare2/libr/io/io_cache.c"
          r_io_cache_read(RIO *io, 
# 190 "project/radare2/libr/io/io_cache.c" 3 4
                                   unsigned long long 
# 190 "project/radare2/libr/io/io_cache.c"
                                        addr, 
...
# 191 "project/radare2/libr/io/io_cache.c" 3 4
do { if (!(
# 191 "project/radare2/libr/io/io_cache.c"
io && buf
# 191 "project/radare2/libr/io/io_cache.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 191 "project/radare2/libr/io/io_cache.c"
...
# 191 "project/radare2/libr/io/io_cache.c"
 ...
 if (!iter) {
  return 
# 195 "project/radare2/libr/io/io_cache.c" 3 4
        0
# 195 "project/radare2/libr/io/io_cache.c"
             ;
 }
 const RSkylineItem *last = (RSkylineItem *)skyline->v.a + skyline->v.len;
 
# 198 "project/radare2/libr/io/io_cache.c" 3 4
_Bool 
# 198 "project/radare2/libr/io/io_cache.c"
     covered = 
# 198 "project/radare2/libr/io/io_cache.c" 3 4
               0
# 198 "project/radare2/libr/io/io_cache.c"
 ...
 while (iter != last) {
  const 
# 200 "project/radare2/libr/io/io_cache.c" 3 4
       unsigned long long 
# 200 "project/radare2/libr/io/io_cache.c"
            begin = r_itv_begin (iter->itv);
  const 
# 201 "project/radare2/libr/io/io_cache.c" 3 4
       unsigned long long 
# 201 "project/radare2/libr/io/io_cache.c"
            end = r_itv_end (iter->itv);
  if (end < addr) {
   iter++;
   continue;
  }
  const 
# 206 "project/radare2/libr/io/io_cache.c" 3 4
       long long 
# 206 "project/radare2/libr/io/io_cache.c"
            addr_offset = begin - addr;
  const 
# 207 "project/radare2/libr/io/io_cache.c" 3 4
       unsigned long long 
# 207 "project/radare2/libr/io/io_cache.c"
            buf_offset = addr_offset > 0 ? addr_offset : 0;
  const 
# 208 "project/radare2/libr/io/io_cache.c" 3 4
       unsigned long long 
# 208 "project/radare2/libr/io/io_cache.c"
            left = len - buf_offset;
  const 
# 209 "project/radare2/libr/io/io_cache.c" 3 4
       unsigned long long 
# 209 "project/radare2/libr/io/io_cache.c"
            cur_addr = addr + buf_offset;
  ...
  const 
# 215 "project/radare2/libr/io/io_cache.c" 3 4
       unsigned long long 
# 215 "project/radare2/libr/io/io_cache.c"
            cache_shift = addr_offset < 0 ? -addr_offset : 0;
  const 
# 216 "project/radare2/libr/io/io_cache.c" 3 4
       unsigned long long 
# 216 "project/radare2/libr/io/io_cache.c"
            cache_begin = r_itv_begin (cache->itv);
  if (end < cache_begin + cache_shift) {
   iter++;
   continue;
  }
  const 
# 221 "project/radare2/libr/io/io_cache.c" 3 4
       long long 
# 221 "project/radare2/libr/io/io_cache.c"
            cache_offset = begin - cache_begin + cache_shift;
  const 
# 222 "project/radare2/libr/io/io_cache.c" 3 4
       long long 
# 222 "project/radare2/libr/io/io_cache.c"
            read = 
# 222 "project/radare2/libr/io/io_cache.c" 3 4
                   (((
# 222 "project/radare2/libr/io/io_cache.c"
...
# 222 "project/radare2/libr/io/io_cache.c"
                   r_itv_size (iter->itv) - cache_shift
# 222 "project/radare2/libr/io/io_cache.c" 3 4
                   ))?(
# 222 "project/radare2/libr/io/io_cache.c"
                   r_itv_size (iter->itv) - cache_shift
...
# 232 "project/radare2/libr/io/io_cache.c" 3 4
  __builtin___memcpy_chk (
# 232 "project/radare2/libr/io/io_cache.c"
  buf + buf_offset
# 232 "project/radare2/libr/io/io_cache.c" 3 4
  , 
# 232 "project/radare2/libr/io/io_cache.c"
  cache->data + cache_offset, read
# 232 "project/radare2/libr/io/io_cache.c" 3 4
  , __builtin_object_size (
# 232 "project/radare2/libr/io/io_cache.c"
  buf + buf_offset
...
# 232 "project/radare2/libr/io/io_cache.c"
  ...
  covered = 
# 234 "project/radare2/libr/io/io_cache.c" 3 4
           1
# 234 "project/radare2/libr/io/io_cache.c"
               ;
  iter++;
 }
 return covered;
