# 0 "project/radare2/libr/io/ptrace_wrap.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/io/ptrace_wrap.c"
# 18 "project/radare2/libr/io/ptrace_wrap.c"
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/ptrace_wrap.h" 1 3 4
# 25 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/ptrace_wrap.h" 3 4
...
# 26 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/ptrace_wrap.h" 2 3 4
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/semaphore.h" 1 3 4
# 26 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/semaphore.h" 3 4
...
# 27 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/semaphore.h" 2 3 4
...
# 28 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/semaphore.h" 2 3 4
...
# 27 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/ptrace_wrap.h" 2 3 4
...
# 28 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/ptrace_wrap.h" 2 3 4
...
# 19 "project/radare2/libr/io/ptrace_wrap.c" 2
...
# 21 "project/radare2/libr/io/ptrace_wrap.c" 2
...
# 22 "project/radare2/libr/io/ptrace_wrap.c" 2
...
# 23 "project/radare2/libr/io/ptrace_wrap.c" 2
...
# 24 "project/radare2/libr/io/ptrace_wrap.c" 2


# 25 "project/radare2/libr/io/ptrace_wrap.c"
...
int ptrace_wrap_instance_start(ptrace_wrap_instance *inst) {
 ...
 r = pthread_create (&inst->th, 
# 39 "project/radare2/libr/io/ptrace_wrap.c" 3 4
                               ((void *)0)
# 39 "project/radare2/libr/io/ptrace_wrap.c"
                                   , (void *(*)(void *)) th_run, inst);
 if (r != 0) {
  sem_destroy (&inst->request_sem);
...
void ptrace_wrap_instance_stop(ptrace_wrap_instance *inst) {
 ...
 pthread_join (inst->th, 
# 52 "project/radare2/libr/io/ptrace_wrap.c" 3 4
                        ((void *)0)
# 52 "project/radare2/libr/io/ptrace_wrap.c"
                            );
 sem_destroy (&inst->request_sem);
 sem_destroy (&inst->result_sem);
}
...
static void wrap_ptrace(ptrace_wrap_instance *inst) {
  ...
  *inst->request.ptrace._errno = 
# 64 "project/radare2/libr/io/ptrace_wrap.c" 3 4
                                (*__error())
# 64 "project/radare2/libr/io/ptrace_wrap.c"
                                     ;
 }
}
...
stop:
 return 
# 102 "project/radare2/libr/io/ptrace_wrap.c" 3 4
       ((void *)0)
# 102 "project/radare2/libr/io/ptrace_wrap.c"
           ;
}
...
# 119 "project/radare2/libr/io/ptrace_wrap.c" 3 4
(*__error()) 
# 119 "project/radare2/libr/io/ptrace_wrap.c"
      = _errno;
...
# 140 "project/radare2/libr/io/ptrace_wrap.c" 3 4
(*__error()) 
# 140 "project/radare2/libr/io/ptrace_wrap.c"
      = _errno;
