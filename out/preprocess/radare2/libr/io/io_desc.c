# 0 "project/radare2/libr/io/io_desc.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/io/io_desc.c" 2




__attribute__((visibility("default"))) 
# 8 "project/radare2/libr/io/io_desc.c"
     RIODesc* r_io_desc_new(RIO* io, RIOPlugin* plugin, const char* uri, int perm, int mode, void* data) {
 
# 9 "project/radare2/libr/io/io_desc.c" 3 4
do { if (!(
# 9 "project/radare2/libr/io/io_desc.c"
io && plugin && uri
# 9 "project/radare2/libr/io/io_desc.c" 3 4
...
"io && plugin && uri"
# 9 "project/radare2/libr/io/io_desc.c" 3 4
, 9); return (((void *)0)); } } while (0)
# 9 "project/radare2/libr/io/io_desc.c"
                                                ;
 
# 10 "project/radare2/libr/io/io_desc.c" 3 4
unsigned int 
# 10 "project/radare2/libr/io/io_desc.c"
     fd32 = 0;
 if (io->files) {
  if (!r_id_pool_grab_id (io->files->pool, &fd32)) {
   return 
# 13 "project/radare2/libr/io/io_desc.c" 3 4
         ((void *)0)
# 13 "project/radare2/libr/io/io_desc.c"
             ;
  }
 }
 RIODesc* desc = 
# 16 "project/radare2/libr/io/io_desc.c" 3 4
                (
# 16 "project/radare2/libr/io/io_desc.c"
                RIODesc
# 16 "project/radare2/libr/io/io_desc.c" 3 4
                *)calloc(1,sizeof(
# 16 "project/radare2/libr/io/io_desc.c"
...
# 29 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) 
# 29 "project/radare2/libr/io/io_desc.c"
     void r_io_desc_free(RIODesc* desc) {
 if (desc) {
  free (desc->uri);
  free (desc->referer);
  free (desc->name);
...
# 43 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 43 "project/radare2/libr/io/io_desc.c"
          r_io_desc_add(RIO* io, RIODesc* desc) {
 
# 44 "project/radare2/libr/io/io_desc.c" 3 4
do { if (!(
# 44 "project/radare2/libr/io/io_desc.c"
io && desc && desc->io
# 44 "project/radare2/libr/io/io_desc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 44 "project/radare2/libr/io/io_desc.c"
...
# 47 "project/radare2/libr/io/io_desc.c" 3 4
 fprintf(__stderrp,
# 47 "project/radare2/libr/io/io_desc.c"
...
# 48 "project/radare2/libr/io/io_desc.c" 3 4
 fprintf(__stderrp,
# 48 "project/radare2/libr/io/io_desc.c"
...
# 48 "project/radare2/libr/io/io_desc.c"
  ...
  r_sys_backtrace ();
  return 
# 50 "project/radare2/libr/io/io_desc.c" 3 4
        0
# 50 "project/radare2/libr/io/io_desc.c"
             ;
 }
 return 
# 52 "project/radare2/libr/io/io_desc.c" 3 4
       1
# 52 "project/radare2/libr/io/io_desc.c"
           ;
}



# 56 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 56 "project/radare2/libr/io/io_desc.c"
          r_io_desc_del(RIO* io, int fd) {
 
# 57 "project/radare2/libr/io/io_desc.c" 3 4
do { if (!(
# 57 "project/radare2/libr/io/io_desc.c"
io && io->files
# 57 "project/radare2/libr/io/io_desc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 57 "project/radare2/libr/io/io_desc.c"
...
# 57 "project/radare2/libr/io/io_desc.c"
 ...
 if (desc == io->desc) {
  io->desc = 
# 60 "project/radare2/libr/io/io_desc.c" 3 4
            ((void *)0)
# 60 "project/radare2/libr/io/io_desc.c"
                ;
 }
 ...
 r_io_desc_free (desc);
 return 
# 65 "project/radare2/libr/io/io_desc.c" 3 4
       1
# 65 "project/radare2/libr/io/io_desc.c"
           ;
}


# 68 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) 
# 68 "project/radare2/libr/io/io_desc.c"
     RIODesc* r_io_desc_get(RIO* io, int fd) {
 
# 69 "project/radare2/libr/io/io_desc.c" 3 4
do { if (!(
# 69 "project/radare2/libr/io/io_desc.c"
io && io->files
# 69 "project/radare2/libr/io/io_desc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 69 "project/radare2/libr/io/io_desc.c"
...
# 73 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) 
# 73 "project/radare2/libr/io/io_desc.c"
     RIODesc *r_io_desc_get_byuri(RIO *io, const char *uri) {
 
# 74 "project/radare2/libr/io/io_desc.c" 3 4
do { if (!(
# 74 "project/radare2/libr/io/io_desc.c"
io && io->files
# 74 "project/radare2/libr/io/io_desc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 74 "project/radare2/libr/io/io_desc.c"
...
# 74 "project/radare2/libr/io/io_desc.c"
 ...
 return 
# 82 "project/radare2/libr/io/io_desc.c" 3 4
       ((void *)0)
# 82 "project/radare2/libr/io/io_desc.c"
           ;
}


# 85 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) 
# 85 "project/radare2/libr/io/io_desc.c"
     RIODesc *r_io_desc_get_next(RIO *io, RIODesc *desc) {
 
# 86 "project/radare2/libr/io/io_desc.c" 3 4
do { if (!(
# 86 "project/radare2/libr/io/io_desc.c"
desc && io && io->files
# 86 "project/radare2/libr/io/io_desc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 86 "project/radare2/libr/io/io_desc.c"
"desc && io && io->files"
# 86 "project/radare2/libr/io/io_desc.c" 3 4
, 86); return (((void *)0)); } } while (0)
# 86 "project/radare2/libr/io/io_desc.c"
                                                    ;
 const int next_fd = r_io_fd_get_next (io, desc->fd);
 if (next_fd == -1) {
  return 
# 89 "project/radare2/libr/io/io_desc.c" 3 4
        ((void *)0)
# 89 "project/radare2/libr/io/io_desc.c"
            ;
 }
...
# 94 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) 
# 94 "project/radare2/libr/io/io_desc.c"
     RIODesc *r_io_desc_get_prev(RIO *io, RIODesc *desc) {
 
# 95 "project/radare2/libr/io/io_desc.c" 3 4
do { if (!(
# 95 "project/radare2/libr/io/io_desc.c"
desc && io && io->files
# 95 "project/radare2/libr/io/io_desc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 95 "project/radare2/libr/io/io_desc.c"
"desc && io && io->files"
# 95 "project/radare2/libr/io/io_desc.c" 3 4
, 95); return (((void *)0)); } } while (0)
# 95 "project/radare2/libr/io/io_desc.c"
                                                    ;
 const int prev_fd = r_io_fd_get_prev (io, desc->fd);
 if (prev_fd == -1) {
  return 
# 98 "project/radare2/libr/io/io_desc.c" 3 4
        ((void *)0)
# 98 "project/radare2/libr/io/io_desc.c"
            ;
 }
...
# 103 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) 
# 103 "project/radare2/libr/io/io_desc.c"
     RIODesc *r_io_desc_get_highest(RIO *io) {
 int fd = r_io_fd_get_highest (io);
 if (fd == -1) {
  return 
# 106 "project/radare2/libr/io/io_desc.c" 3 4
        ((void *)0)
# 106 "project/radare2/libr/io/io_desc.c"
            ;
 }
...
# 111 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) 
# 111 "project/radare2/libr/io/io_desc.c"
     RIODesc *r_io_desc_get_lowest(RIO *io) {
 int fd = r_io_fd_get_lowest (io);
 if (fd == -1) {
  return 
# 114 "project/radare2/libr/io/io_desc.c" 3 4
        ((void *)0)
# 114 "project/radare2/libr/io/io_desc.c"
            ;
 }
 return r_io_desc_get (io, fd);
}
...
# 119 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) 
# 119 "project/radare2/libr/io/io_desc.c"
     RIODesc *r_io_desc_open(RIO *io, const char *uri, int perm, int mode) {
 
# 120 "project/radare2/libr/io/io_desc.c" 3 4
do { if (!(
# 120 "project/radare2/libr/io/io_desc.c"
io && uri
# 120 "project/radare2/libr/io/io_desc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 120 "project/radare2/libr/io/io_desc.c"
"io && uri"
# 120 "project/radare2/libr/io/io_desc.c" 3 4
, 120); return (((void *)0)); } } while (0)
# 120 "project/radare2/libr/io/io_desc.c"
                                      ;
 RIOPlugin *plugin = r_io_plugin_resolve (io, uri, 0);
 if (!plugin || !plugin->open) {
  return 
# 123 "project/radare2/libr/io/io_desc.c" 3 4
        ((void *)0)
# 123 "project/radare2/libr/io/io_desc.c"
            ;
 }
 RIODesc *desc = plugin->open (io, uri, perm, mode);
 if (!desc) {
  return 
# 127 "project/radare2/libr/io/io_desc.c" 3 4
        ((void *)0)
# 127 "project/radare2/libr/io/io_desc.c"
            ;
 }
 ...
 if (!r_io_desc_add (io, desc)) {
  r_io_desc_free (desc);
  return 
# 141 "project/radare2/libr/io/io_desc.c" 3 4
        ((void *)0)
# 141 "project/radare2/libr/io/io_desc.c"
            ;
 }
 return desc;
}
...
# 146 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) 
# 146 "project/radare2/libr/io/io_desc.c"
     RIODesc *r_io_desc_open_plugin(RIO *io, RIOPlugin *plugin, const char *uri, int perm, int mode) {
 
# 147 "project/radare2/libr/io/io_desc.c" 3 4
do { if (!(
# 147 "project/radare2/libr/io/io_desc.c"
io && io->files && uri && plugin
# 147 "project/radare2/libr/io/io_desc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 147 "project/radare2/libr/io/io_desc.c"
"io && io->files && uri && plugin"
# 147 "project/radare2/libr/io/io_desc.c" 3 4
, 147); return (((void *)0)); } } while (0)
# 147 "project/radare2/libr/io/io_desc.c"
                                                             ;
 if (!plugin->open || !plugin->check || !plugin->check (io, uri, 
# 148 "project/radare2/libr/io/io_desc.c" 3 4
                                                                0
# 148 "project/radare2/libr/io/io_desc.c"
                                                                     )) {
  return 
# 149 "project/radare2/libr/io/io_desc.c" 3 4
        ((void *)0)
# 149 "project/radare2/libr/io/io_desc.c"
            ;
 }
 RIODesc *desc = plugin->open (io, uri, perm, mode);
 if (!desc) {
  return 
# 153 "project/radare2/libr/io/io_desc.c" 3 4
        ((void *)0)
# 153 "project/radare2/libr/io/io_desc.c"
            ;
 }
 ...
 if (!r_io_desc_add (io, desc)) {
  r_io_desc_free (desc);
  return 
# 167 "project/radare2/libr/io/io_desc.c" 3 4
        ((void *)0)
# 167 "project/radare2/libr/io/io_desc.c"
            ;
 }
 return desc;
}
...
# 173 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 173 "project/radare2/libr/io/io_desc.c"
          r_io_desc_close(RIODesc *desc) {
 if (!desc || !desc->io || !desc->plugin) {
  return 
# 175 "project/radare2/libr/io/io_desc.c" 3 4
        0
# 175 "project/radare2/libr/io/io_desc.c"
             ;
 }
 RIO *io = desc->io;
 if (desc->plugin->close && !desc->plugin->close (desc)) {
  return 
# 179 "project/radare2/libr/io/io_desc.c" 3 4
        0
# 179 "project/radare2/libr/io/io_desc.c"
             ;
 }

 r_io_desc_del (io, desc->fd);
 return 
# 183 "project/radare2/libr/io/io_desc.c" 3 4
       1
# 183 "project/radare2/libr/io/io_desc.c"
           ;
}



# 187 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) 
# 187 "project/radare2/libr/io/io_desc.c"
     int r_io_desc_write(RIODesc *desc, const 
# 187 "project/radare2/libr/io/io_desc.c" 3 4
                                              unsigned char
# 187 "project/radare2/libr/io/io_desc.c"
                                                 * buf, int len) {
 
# 188 "project/radare2/libr/io/io_desc.c" 3 4
do { if (!(
# 188 "project/radare2/libr/io/io_desc.c"
desc && buf
# 188 "project/radare2/libr/io/io_desc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 188 "project/radare2/libr/io/io_desc.c"
...
# 188 "project/radare2/libr/io/io_desc.c"
 ...
 if (desc->io && (desc->io->p_cache & 2)) {
  return r_io_desc_cache_write (desc,
    r_io_desc_seek (desc, 0LL, 
# 195 "project/radare2/libr/io/io_desc.c" 3 4
                              1
# 195 "project/radare2/libr/io/io_desc.c"
                                           ), buf, len);
 }
...
# 201 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) 
# 201 "project/radare2/libr/io/io_desc.c"
     int r_io_desc_read(RIODesc *desc, 
# 201 "project/radare2/libr/io/io_desc.c" 3 4
                                       unsigned char 
# 201 "project/radare2/libr/io/io_desc.c"
                                           *buf, int len) {
 
# 202 "project/radare2/libr/io/io_desc.c" 3 4
do { if (!(
# 202 "project/radare2/libr/io/io_desc.c"
desc && buf
# 202 "project/radare2/libr/io/io_desc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 202 "project/radare2/libr/io/io_desc.c"
...
# 202 "project/radare2/libr/io/io_desc.c"
 ...
 if (!(desc->perm & 
# 204 "project/radare2/libr/io/io_desc.c" 3 4
                   4
# 204 "project/radare2/libr/io/io_desc.c"
                           )) {
  return -1;
 }
 
# 207 "project/radare2/libr/io/io_desc.c" 3 4
unsigned long long 
# 207 "project/radare2/libr/io/io_desc.c"
     seek = r_io_desc_seek (desc, 0LL, 
# 207 "project/radare2/libr/io/io_desc.c" 3 4
                                       1
# 207 "project/radare2/libr/io/io_desc.c"
                                                    );
 if (desc->io->cachemode) {
  if (seek != 
# 209 "project/radare2/libr/io/io_desc.c" 3 4
             0xFFFFFFFFFFFFFFFFULL 
# 209 "project/radare2/libr/io/io_desc.c"
                      && r_io_cache_at (desc->io, seek)) {
...
# 222 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 222 "project/radare2/libr/io/io_desc.c"
          r_io_desc_seek(RIODesc* desc, 
# 222 "project/radare2/libr/io/io_desc.c" 3 4
                                        unsigned long long 
# 222 "project/radare2/libr/io/io_desc.c"
                                             offset, int whence) {
 if (!desc || !desc->plugin || !desc->plugin->seek) {
  return (
# 224 "project/radare2/libr/io/io_desc.c" 3 4
         unsigned long long
# 224 "project/radare2/libr/io/io_desc.c"
             ) -1;
 }
...
# 229 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 229 "project/radare2/libr/io/io_desc.c"
          r_io_desc_size(RIODesc* desc) {
 if (!desc || !desc->plugin || !desc->plugin->seek) {
  return 0LL;
 }
 
# 233 "project/radare2/libr/io/io_desc.c" 3 4
unsigned long long 
# 233 "project/radare2/libr/io/io_desc.c"
     off = r_io_desc_seek (desc, 0LL, 
# 233 "project/radare2/libr/io/io_desc.c" 3 4
                                      1
# 233 "project/radare2/libr/io/io_desc.c"
                                                   );
 
# 234 "project/radare2/libr/io/io_desc.c" 3 4
unsigned long long 
# 234 "project/radare2/libr/io/io_desc.c"
     ret = r_io_desc_seek (desc, 0LL, 
# 234 "project/radare2/libr/io/io_desc.c" 3 4
                                      2
# 234 "project/radare2/libr/io/io_desc.c"
                                                   );

 r_io_desc_seek (desc, off, 
# 236 "project/radare2/libr/io/io_desc.c" 3 4
                           0
# 236 "project/radare2/libr/io/io_desc.c"
                                        );
 return ret;
}


# 240 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 240 "project/radare2/libr/io/io_desc.c"
          r_io_desc_resize(RIODesc *desc, 
# 240 "project/radare2/libr/io/io_desc.c" 3 4
                                          unsigned long long 
# 240 "project/radare2/libr/io/io_desc.c"
                                               newsize) {
...
# 242 "project/radare2/libr/io/io_desc.c" 3 4
 _Bool 
# 242 "project/radare2/libr/io/io_desc.c"
      ret = desc->plugin->resize (desc->io, desc, newsize);
 ...
 return 
# 248 "project/radare2/libr/io/io_desc.c" 3 4
       0
# 248 "project/radare2/libr/io/io_desc.c"
            ;
}


# 251 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 251 "project/radare2/libr/io/io_desc.c"
          r_io_desc_is_blockdevice(RIODesc *desc) {
 if (!desc || !desc->plugin || !desc->plugin->is_blockdevice) {
  return 
# 253 "project/radare2/libr/io/io_desc.c" 3 4
        0
# 253 "project/radare2/libr/io/io_desc.c"
             ;
 }
...
# 258 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 258 "project/radare2/libr/io/io_desc.c"
          r_io_desc_is_chardevice(RIODesc *desc) {
 if (!desc || !desc->plugin || !desc->plugin->is_chardevice) {
  return 
# 260 "project/radare2/libr/io/io_desc.c" 3 4
        0
# 260 "project/radare2/libr/io/io_desc.c"
             ;
 }
...
# 265 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 265 "project/radare2/libr/io/io_desc.c"
          r_io_desc_exchange(RIO* io, int fd, int fdx) {
 RIODesc* desc, * descx;
 if (!(desc = r_io_desc_get (io, fd)) || !(descx = r_io_desc_get (io, fdx))) {
  return 
# 268 "project/radare2/libr/io/io_desc.c" 3 4
        0
# 268 "project/radare2/libr/io/io_desc.c"
             ;
 }
 desc->fd = fdx;
 descx->fd = fd;
...
# 281 "project/radare2/libr/io/io_desc.c" 3 4
unsigned int 
# 281 "project/radare2/libr/io/io_desc.c"
     map_id;
 if (r_id_storage_get_lowest (io->maps, &map_id)) {
  do {
   ...
   if (map->fd == fdx) {
    map->perm &= (desc->perm | 
# 286 "project/radare2/libr/io/io_desc.c" 3 4
                              1
# 286 "project/radare2/libr/io/io_desc.c"
                                      );
   } else if (map->fd == fd) {
    map->perm &= (descx->perm | 
# 288 "project/radare2/libr/io/io_desc.c" 3 4
                               1
# 288 "project/radare2/libr/io/io_desc.c"
                                       );
   }
  } while (r_id_storage_get_next (io->maps, &map_id));
 }
 return 
# 292 "project/radare2/libr/io/io_desc.c" 3 4
       1
# 292 "project/radare2/libr/io/io_desc.c"
           ;
}


# 295 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 295 "project/radare2/libr/io/io_desc.c"
          r_io_desc_is_dbg(RIODesc *desc) {
 if (desc && desc->plugin) {
  return desc->plugin->isdbg;
 }
 return 
# 299 "project/radare2/libr/io/io_desc.c" 3 4
       0
# 299 "project/radare2/libr/io/io_desc.c"
            ;
}


# 302 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) 
# 302 "project/radare2/libr/io/io_desc.c"
     int r_io_desc_get_pid(RIODesc *desc) {
...
# 319 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) 
# 319 "project/radare2/libr/io/io_desc.c"
     int r_io_desc_get_tid(RIODesc *desc) {
...
# 336 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 336 "project/radare2/libr/io/io_desc.c"
          r_io_desc_get_base(RIODesc *desc, 
# 336 "project/radare2/libr/io/io_desc.c" 3 4
                                            unsigned long long 
# 336 "project/radare2/libr/io/io_desc.c"
                                                 *base) {
 if (!base || !desc || !desc->plugin || !desc->plugin->isdbg || !desc->plugin->getbase) {
  return 
# 338 "project/radare2/libr/io/io_desc.c" 3 4
        0
# 338 "project/radare2/libr/io/io_desc.c"
             ;
 }
...
# 343 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) 
# 343 "project/radare2/libr/io/io_desc.c"
     int r_io_desc_read_at(RIODesc *desc, 
# 343 "project/radare2/libr/io/io_desc.c" 3 4
                                          unsigned long long 
# 343 "project/radare2/libr/io/io_desc.c"
                                               addr, 
...
# 343 "project/radare2/libr/io/io_desc.c"
                                                         *buf, int len) {
 if (desc && buf && (r_io_desc_seek (desc, addr, 
# 344 "project/radare2/libr/io/io_desc.c" 3 4
                                                0
# 344 "project/radare2/libr/io/io_desc.c"
                                                             ) == addr)) {
...
# 350 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) 
# 350 "project/radare2/libr/io/io_desc.c"
     int r_io_desc_write_at(RIODesc *desc, 
# 350 "project/radare2/libr/io/io_desc.c" 3 4
                                           unsigned long long 
# 350 "project/radare2/libr/io/io_desc.c"
                                                addr, const 
...
# 350 "project/radare2/libr/io/io_desc.c"
                                                                *buf, int len) {
 if (desc && buf && (r_io_desc_seek (desc, addr, 
# 351 "project/radare2/libr/io/io_desc.c" 3 4
                                                0
# 351 "project/radare2/libr/io/io_desc.c"
                                                             ) == addr)) {
...
# 357 "project/radare2/libr/io/io_desc.c" 3 4
__attribute__((visibility("default"))) 
# 357 "project/radare2/libr/io/io_desc.c"
     int r_io_desc_extend(RIODesc *desc, 
# 357 "project/radare2/libr/io/io_desc.c" 3 4
                                         unsigned long long 
# 357 "project/radare2/libr/io/io_desc.c"
                                              size) {
...
# 367 "project/radare2/libr/io/io_desc.c" 3 4
     _Bool 
# 367 "project/radare2/libr/io/io_desc.c"
          r_io_desc_init(RIO* io) {
 
# 368 "project/radare2/libr/io/io_desc.c" 3 4
do { if (!(
# 368 "project/radare2/libr/io/io_desc.c"
io
# 368 "project/radare2/libr/io/io_desc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 368 "project/radare2/libr/io/io_desc.c"
...
# 368 "project/radare2/libr/io/io_desc.c"
 ...
 if (!io->files) {
  return 
# 374 "project/radare2/libr/io/io_desc.c" 3 4
        0
# 374 "project/radare2/libr/io/io_desc.c"
             ;
 }
 return 
# 376 "project/radare2/libr/io/io_desc.c" 3 4
       1
# 376 "project/radare2/libr/io/io_desc.c"
           ;
}

static 
# 379 "project/radare2/libr/io/io_desc.c" 3 4
      _Bool 
# 379 "project/radare2/libr/io/io_desc.c"
           desc_fini_cb(void* user, void* data, 
# 379 "project/radare2/libr/io/io_desc.c" 3 4
                                                unsigned int 
# 379 "project/radare2/libr/io/io_desc.c"
                                                     id) {
 ...
 r_io_desc_free (desc);
 return 
# 385 "project/radare2/libr/io/io_desc.c" 3 4
       1
# 385 "project/radare2/libr/io/io_desc.c"
           ;
}
...
# 390 "project/radare2/libr/io/io_desc.c" 3 4
do { if (!(
# 390 "project/radare2/libr/io/io_desc.c"
io
# 390 "project/radare2/libr/io/io_desc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 390 "project/radare2/libr/io/io_desc.c"
...
# 390 "project/radare2/libr/io/io_desc.c"
 ...
 if (io->files) {
  ...
  io->files = 
# 394 "project/radare2/libr/io/io_desc.c" 3 4
             ((void *)0)
# 394 "project/radare2/libr/io/io_desc.c"
                 ;
 }

 io->desc = 
# 397 "project/radare2/libr/io/io_desc.c" 3 4
           ((void *)0)
# 397 "project/radare2/libr/io/io_desc.c"
               ;
}
