# 0 "project/radare2/libr/io/io_fd.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/io/io_fd.c"
...
# 4 "project/radare2/libr/io/io_fd.c" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/io/io_fd.c"
     int r_io_fd_open(RIO *io, const char *uri, int flags, int mode) {
 RIODesc *desc = r_io_desc_open (io, uri, flags, mode);
 return desc ? desc->fd : -1;
}


# 10 "project/radare2/libr/io/io_fd.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 10 "project/radare2/libr/io/io_fd.c"
          r_io_fd_close(RIO *io, int fd) {
 return r_io_desc_close (r_io_desc_get (io, fd));
}



# 15 "project/radare2/libr/io/io_fd.c" 3 4
__attribute__((visibility("default"))) 
# 15 "project/radare2/libr/io/io_fd.c"
     int r_io_fd_read(RIO *io, int fd, 
# 15 "project/radare2/libr/io/io_fd.c" 3 4
                                       unsigned char 
# 15 "project/radare2/libr/io/io_fd.c"
                                           *buf, int len) {
 
# 16 "project/radare2/libr/io/io_fd.c" 3 4
do { if (!(
# 16 "project/radare2/libr/io/io_fd.c"
io && buf
# 16 "project/radare2/libr/io/io_fd.c" 3 4
...
# 28 "project/radare2/libr/io/io_fd.c" 3 4
__attribute__((visibility("default"))) 
# 28 "project/radare2/libr/io/io_fd.c"
     int r_io_fd_write(RIO *io, int fd, const 
# 28 "project/radare2/libr/io/io_fd.c" 3 4
                                              unsigned char 
# 28 "project/radare2/libr/io/io_fd.c"
                                                  *buf, int len) {
 
# 29 "project/radare2/libr/io/io_fd.c" 3 4
do { if (!(
# 29 "project/radare2/libr/io/io_fd.c"
io && buf
# 29 "project/radare2/libr/io/io_fd.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 29 "project/radare2/libr/io/io_fd.c"
...
# 40 "project/radare2/libr/io/io_fd.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 40 "project/radare2/libr/io/io_fd.c"
          r_io_fd_seek(RIO *io, int fd, 
# 40 "project/radare2/libr/io/io_fd.c" 3 4
                                        unsigned long long 
# 40 "project/radare2/libr/io/io_fd.c"
                                             addr, int whence) {
 
# 41 "project/radare2/libr/io/io_fd.c" 3 4
do { if (!(
# 41 "project/radare2/libr/io/io_fd.c"
io
# 41 "project/radare2/libr/io/io_fd.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 41 "project/radare2/libr/io/io_fd.c"
"io"
# 41 "project/radare2/libr/io/io_fd.c" 3 4
, 41); return (0xFFFFFFFFFFFFFFFFULL); } } while (0)
# 41 "project/radare2/libr/io/io_fd.c"
                                   ;
...
# 45 "project/radare2/libr/io/io_fd.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 45 "project/radare2/libr/io/io_fd.c"
          r_io_fd_size(RIO *io, int fd) {
 return r_io_desc_size (r_io_desc_get (io, fd));
}


# 49 "project/radare2/libr/io/io_fd.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 49 "project/radare2/libr/io/io_fd.c"
          r_io_fd_resize(RIO *io, int fd, 
# 49 "project/radare2/libr/io/io_fd.c" 3 4
                                          unsigned long long 
# 49 "project/radare2/libr/io/io_fd.c"
                                               newsize) {
...
# 53 "project/radare2/libr/io/io_fd.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 53 "project/radare2/libr/io/io_fd.c"
          r_io_fd_is_blockdevice(RIO *io, int fd) {
 return r_io_desc_is_blockdevice (r_io_desc_get (io, fd));
}


# 57 "project/radare2/libr/io/io_fd.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 57 "project/radare2/libr/io/io_fd.c"
          r_io_fd_is_chardevice(RIO *io, int fd) {
 return r_io_desc_is_chardevice (r_io_desc_get (io, fd));
}



# 62 "project/radare2/libr/io/io_fd.c" 3 4
__attribute__((visibility("default"))) 
# 62 "project/radare2/libr/io/io_fd.c"
     int r_io_fd_read_at(RIO *io, int fd, 
# 62 "project/radare2/libr/io/io_fd.c" 3 4
                                          unsigned long long 
# 62 "project/radare2/libr/io/io_fd.c"
                                               addr, 
...
# 71 "project/radare2/libr/io/io_fd.c" 3 4
__attribute__((visibility("default"))) 
# 71 "project/radare2/libr/io/io_fd.c"
     int r_io_fd_write_at(RIO *io, int fd, 
# 71 "project/radare2/libr/io/io_fd.c" 3 4
                                           unsigned long long 
# 71 "project/radare2/libr/io/io_fd.c"
                                                addr, const 
...
# 72 "project/radare2/libr/io/io_fd.c" 3 4
do { if (!(
# 72 "project/radare2/libr/io/io_fd.c"
io && buf
# 72 "project/radare2/libr/io/io_fd.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 72 "project/radare2/libr/io/io_fd.c"
...
# 77 "project/radare2/libr/io/io_fd.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 77 "project/radare2/libr/io/io_fd.c"
          r_io_fd_is_dbg(RIO *io, int fd) {
 
# 78 "project/radare2/libr/io/io_fd.c" 3 4
do { if (!(
# 78 "project/radare2/libr/io/io_fd.c"
io && io->files
# 78 "project/radare2/libr/io/io_fd.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 78 "project/radare2/libr/io/io_fd.c"
...
# 78 "project/radare2/libr/io/io_fd.c"
                                             ;
 RIODesc *desc = r_io_desc_get (io, fd);
 return desc? r_io_desc_is_dbg (desc): 
# 80 "project/radare2/libr/io/io_fd.c" 3 4
                                      0
# 80 "project/radare2/libr/io/io_fd.c"
                                           ;
}


# 83 "project/radare2/libr/io/io_fd.c" 3 4
__attribute__((visibility("default"))) 
# 83 "project/radare2/libr/io/io_fd.c"
     int r_io_fd_get_pid(RIO *io, int fd) {
 if (!io || !io->files) {
  return -2;
 }
 RIODesc *desc = r_io_desc_get (io, fd);
...
# 91 "project/radare2/libr/io/io_fd.c" 3 4
__attribute__((visibility("default"))) 
# 91 "project/radare2/libr/io/io_fd.c"
     int r_io_fd_get_tid(RIO *io, int fd) {
 
# 92 "project/radare2/libr/io/io_fd.c" 3 4
do { if (!(
# 92 "project/radare2/libr/io/io_fd.c"
io && io->files
# 92 "project/radare2/libr/io/io_fd.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 92 "project/radare2/libr/io/io_fd.c"
...
# 97 "project/radare2/libr/io/io_fd.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 97 "project/radare2/libr/io/io_fd.c"
          r_io_fd_get_base (RIO *io, int fd, 
# 97 "project/radare2/libr/io/io_fd.c" 3 4
                                             unsigned long long 
# 97 "project/radare2/libr/io/io_fd.c"
                                                  *base) {
 
# 98 "project/radare2/libr/io/io_fd.c" 3 4
do { if (!(
# 98 "project/radare2/libr/io/io_fd.c"
io && io->files && base
# 98 "project/radare2/libr/io/io_fd.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 98 "project/radare2/libr/io/io_fd.c"
...
# 103 "project/radare2/libr/io/io_fd.c" 3 4
__attribute__((visibility("default"))) 
# 103 "project/radare2/libr/io/io_fd.c"
     const char *r_io_fd_get_name(RIO *io, int fd) {
 
# 104 "project/radare2/libr/io/io_fd.c" 3 4
do { if (!(
# 104 "project/radare2/libr/io/io_fd.c"
io && io->files
# 104 "project/radare2/libr/io/io_fd.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 104 "project/radare2/libr/io/io_fd.c"
"io && io->files"
# 104 "project/radare2/libr/io/io_fd.c" 3 4
, 104); return (((void *)0)); } } while (0)
# 104 "project/radare2/libr/io/io_fd.c"
                                            ;
 RIODesc *desc = r_io_desc_get (io, fd);
 return desc? desc->name: 
# 106 "project/radare2/libr/io/io_fd.c" 3 4
                         ((void *)0)
# 106 "project/radare2/libr/io/io_fd.c"
                             ;
}


# 109 "project/radare2/libr/io/io_fd.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 109 "project/radare2/libr/io/io_fd.c"
          r_io_use_fd(RIO* io, int fd) {
 
# 110 "project/radare2/libr/io/io_fd.c" 3 4
do { if (!(
# 110 "project/radare2/libr/io/io_fd.c"
io
# 110 "project/radare2/libr/io/io_fd.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 110 "project/radare2/libr/io/io_fd.c"
"io"
# 110 "project/radare2/libr/io/io_fd.c" 3 4
, 110); return (0); } } while (0)
# 110 "project/radare2/libr/io/io_fd.c"
                                ;
 if (!io->desc) {
  io->desc = r_io_desc_get (io, fd);
  return io->desc != 
# 113 "project/radare2/libr/io/io_fd.c" 3 4
                    ((void *)0)
# 113 "project/radare2/libr/io/io_fd.c"
                        ;
 }
 if (io->desc->fd != fd) {
  RIODesc* desc;
  ...
  if (!(desc = r_io_desc_get (io, fd))) {
   return 
# 119 "project/radare2/libr/io/io_fd.c" 3 4
         0
# 119 "project/radare2/libr/io/io_fd.c"
              ;
  }
  io->desc = desc;
 }
 return 
# 123 "project/radare2/libr/io/io_fd.c" 3 4
       1
# 123 "project/radare2/libr/io/io_fd.c"
           ;
}


# 126 "project/radare2/libr/io/io_fd.c" 3 4
__attribute__((visibility("default"))) 
# 126 "project/radare2/libr/io/io_fd.c"
     int r_io_fd_get_current(RIO *io) {
 
# 127 "project/radare2/libr/io/io_fd.c" 3 4
do { if (!(
# 127 "project/radare2/libr/io/io_fd.c"
io
# 127 "project/radare2/libr/io/io_fd.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 127 "project/radare2/libr/io/io_fd.c"
...
# 134 "project/radare2/libr/io/io_fd.c" 3 4
__attribute__((visibility("default"))) 
# 134 "project/radare2/libr/io/io_fd.c"
     int r_io_fd_get_next(RIO *io, int fd) {
 
# 135 "project/radare2/libr/io/io_fd.c" 3 4
do { if (!(
# 135 "project/radare2/libr/io/io_fd.c"
io
# 135 "project/radare2/libr/io/io_fd.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 135 "project/radare2/libr/io/io_fd.c"
...
# 135 "project/radare2/libr/io/io_fd.c"
                             ;
 int ret = fd;
 if (!r_id_storage_get_next (io->files, (
# 137 "project/radare2/libr/io/io_fd.c" 3 4
                                        unsigned int 
# 137 "project/radare2/libr/io/io_fd.c"
                                             *)&ret)) {
  return -1;
 }
 return ret;
...
# 143 "project/radare2/libr/io/io_fd.c" 3 4
__attribute__((visibility("default"))) 
# 143 "project/radare2/libr/io/io_fd.c"
     int r_io_fd_get_prev(RIO *io, int fd) {
 
# 144 "project/radare2/libr/io/io_fd.c" 3 4
do { if (!(
# 144 "project/radare2/libr/io/io_fd.c"
io
# 144 "project/radare2/libr/io/io_fd.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 144 "project/radare2/libr/io/io_fd.c"
...
# 144 "project/radare2/libr/io/io_fd.c"
                             ;
 int ret = fd;
 if (!r_id_storage_get_prev (io->files, (
# 146 "project/radare2/libr/io/io_fd.c" 3 4
                                        unsigned int 
# 146 "project/radare2/libr/io/io_fd.c"
                                             *)&ret)) {
  return -1;
 }
 return ret;
...
# 152 "project/radare2/libr/io/io_fd.c" 3 4
__attribute__((visibility("default"))) 
# 152 "project/radare2/libr/io/io_fd.c"
     int r_io_fd_get_highest(RIO *io) {
 
# 153 "project/radare2/libr/io/io_fd.c" 3 4
do { if (!(
# 153 "project/radare2/libr/io/io_fd.c"
io
# 153 "project/radare2/libr/io/io_fd.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 153 "project/radare2/libr/io/io_fd.c"
...
# 153 "project/radare2/libr/io/io_fd.c"
                             ;
 int fd = -1;
 if (!r_id_storage_get_highest (io->files, (
# 155 "project/radare2/libr/io/io_fd.c" 3 4
                                           unsigned int 
# 155 "project/radare2/libr/io/io_fd.c"
                                                *)&fd)) {
  return -1;
 }
 return fd;
...
# 161 "project/radare2/libr/io/io_fd.c" 3 4
__attribute__((visibility("default"))) 
# 161 "project/radare2/libr/io/io_fd.c"
     int r_io_fd_get_lowest(RIO *io) {
 
# 162 "project/radare2/libr/io/io_fd.c" 3 4
do { if (!(
# 162 "project/radare2/libr/io/io_fd.c"
io
# 162 "project/radare2/libr/io/io_fd.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 162 "project/radare2/libr/io/io_fd.c"
...
# 162 "project/radare2/libr/io/io_fd.c"
                             ;
 int fd = -1;
 if (!r_id_storage_get_lowest (io->files, (
# 164 "project/radare2/libr/io/io_fd.c" 3 4
                                          unsigned int 
# 164 "project/radare2/libr/io/io_fd.c"
                                               *)&fd)) {
  return -1;
 }
 return fd;
