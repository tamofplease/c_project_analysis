# 0 "project/radare2/libr/io/p_cache.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/io/p_cache.c"
...
# 4 "project/radare2/libr/io/p_cache.c" 2




# 7 "project/radare2/libr/io/p_cache.c"
const 
# 7 "project/radare2/libr/io/p_cache.c" 3 4
     unsigned long long 
# 7 "project/radare2/libr/io/p_cache.c"
          cleanup_masks[] = {
 0x0000000000000001,
...
# 74 "project/radare2/libr/io/p_cache.c" 3 4
do { if (!(
# 74 "project/radare2/libr/io/p_cache.c"
kv
# 74 "project/radare2/libr/io/p_cache.c" 3 4
...
# 78 "project/radare2/libr/io/p_cache.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 78 "project/radare2/libr/io/p_cache.c"
          r_io_desc_cache_init(RIODesc *desc) {
 if (!desc || desc->cache) {
  return 
# 80 "project/radare2/libr/io/p_cache.c" 3 4
        0
# 80 "project/radare2/libr/io/p_cache.c"
             ;
 }
 return (desc->cache = ht_up_new (
# 82 "project/radare2/libr/io/p_cache.c" 3 4
                                 ((void *)0)
# 82 "project/radare2/libr/io/p_cache.c"
                                     , pcache_kv_free, 
# 82 "project/radare2/libr/io/p_cache.c" 3 4
                                                       ((void *)0)
# 82 "project/radare2/libr/io/p_cache.c"
...
# 85 "project/radare2/libr/io/p_cache.c" 3 4
__attribute__((visibility("default"))) 
# 85 "project/radare2/libr/io/p_cache.c"
     int r_io_desc_cache_write(RIODesc *desc, 
# 85 "project/radare2/libr/io/p_cache.c" 3 4
                                              unsigned long long 
# 85 "project/radare2/libr/io/p_cache.c"
                                                   paddr, const 
...
# 87 "project/radare2/libr/io/p_cache.c" 3 4
unsigned long long 
# 87 "project/radare2/libr/io/p_cache.c"
     caddr, desc_sz = r_io_desc_size (desc);
 ...
 caddr = paddr / 
# 99 "project/radare2/libr/io/p_cache.c" 3 4
                (sizeof(unsigned long long) * 8)
# 99 "project/radare2/libr/io/p_cache.c"
                                    ;
 cbaddr = paddr % 
# 100 "project/radare2/libr/io/p_cache.c" 3 4
                 (sizeof(unsigned long long) * 8)
# 100 "project/radare2/libr/io/p_cache.c"
                                     ;
 while (written < len) {

  if (!(cache = (RIODescCache *)ht_up_find (desc->cache, caddr, 
# 103 "project/radare2/libr/io/p_cache.c" 3 4
                                                               ((void *)0)
# 103 "project/radare2/libr/io/p_cache.c"
                                                                   ))) {

   cache = 
# 105 "project/radare2/libr/io/p_cache.c" 3 4
          (
# 105 "project/radare2/libr/io/p_cache.c"
          RIODescCache
# 105 "project/radare2/libr/io/p_cache.c" 3 4
          *)calloc(1,sizeof(
# 105 "project/radare2/libr/io/p_cache.c"
...
# 105 "project/radare2/libr/io/p_cache.c"
  ...
  if ((len - written) > (
# 113 "project/radare2/libr/io/p_cache.c" 3 4
                        (sizeof(unsigned long long) * 8) 
# 113 "project/radare2/libr/io/p_cache.c"
                                             - cbaddr)) {
   written += (
# 114 "project/radare2/libr/io/p_cache.c" 3 4
              (sizeof(unsigned long long) * 8) 
# 114 "project/radare2/libr/io/p_cache.c"
                                   - cbaddr);

   for (; cbaddr < 
# 116 "project/radare2/libr/io/p_cache.c" 3 4
                  (sizeof(unsigned long long) * 8)
# 116 "project/radare2/libr/io/p_cache.c"
                                      ; cbaddr++) {
...
# 141 "project/radare2/libr/io/p_cache.c" 3 4
__attribute__((visibility("default"))) 
# 141 "project/radare2/libr/io/p_cache.c"
     int r_io_desc_cache_read(RIODesc *desc, 
# 141 "project/radare2/libr/io/p_cache.c" 3 4
                                             unsigned long long 
# 141 "project/radare2/libr/io/p_cache.c"
                                                  paddr, 
...
# 143 "project/radare2/libr/io/p_cache.c" 3 4
unsigned char 
# 143 "project/radare2/libr/io/p_cache.c"
    *ptr = buf;
 
# 144 "project/radare2/libr/io/p_cache.c" 3 4
unsigned long long 
# 144 "project/radare2/libr/io/p_cache.c"
     caddr, desc_sz = r_io_desc_size (desc);
 int cbaddr, amount = 0;
 ...
 caddr = paddr / 
# 155 "project/radare2/libr/io/p_cache.c" 3 4
                (sizeof(unsigned long long) * 8)
# 155 "project/radare2/libr/io/p_cache.c"
                                    ;
 cbaddr = paddr % 
# 156 "project/radare2/libr/io/p_cache.c" 3 4
                 (sizeof(unsigned long long) * 8)
# 156 "project/radare2/libr/io/p_cache.c"
                                     ;
 while (amount < len) {

  if (!(cache = (RIODescCache *)ht_up_find (desc->cache, caddr, 
# 159 "project/radare2/libr/io/p_cache.c" 3 4
                                                               ((void *)0)
# 159 "project/radare2/libr/io/p_cache.c"
                                                                   ))) {
   amount += (
# 160 "project/radare2/libr/io/p_cache.c" 3 4
             (sizeof(unsigned long long) * 8) 
# 160 "project/radare2/libr/io/p_cache.c"
                                  - cbaddr);
   ptr += (
# 161 "project/radare2/libr/io/p_cache.c" 3 4
          (sizeof(unsigned long long) * 8) 
# 161 "project/radare2/libr/io/p_cache.c"
                               - cbaddr);
   goto beach;
  }
  if ((len - amount) > (
# 164 "project/radare2/libr/io/p_cache.c" 3 4
                       (sizeof(unsigned long long) * 8) 
# 164 "project/radare2/libr/io/p_cache.c"
                                            - cbaddr)) {
   amount += (
# 165 "project/radare2/libr/io/p_cache.c" 3 4
             (sizeof(unsigned long long) * 8) 
# 165 "project/radare2/libr/io/p_cache.c"
                                  - cbaddr);
   for (; cbaddr < 
# 166 "project/radare2/libr/io/p_cache.c" 3 4
                  (sizeof(unsigned long long) * 8)
# 166 "project/radare2/libr/io/p_cache.c"
                                      ; cbaddr++) {
...
static 
# 198 "project/radare2/libr/io/p_cache.c" 3 4
      _Bool 
# 198 "project/radare2/libr/io/p_cache.c"
           __desc_cache_list_cb(void *user, const 
# 198 "project/radare2/libr/io/p_cache.c" 3 4
                                                  unsigned long long 
# 198 "project/radare2/libr/io/p_cache.c"
                                                       k, const void *v) {
 ...
 RIOCache *cache = 
# 200 "project/radare2/libr/io/p_cache.c" 3 4
                  ((void *)0)
# 200 "project/radare2/libr/io/p_cache.c"
                      ;
 
# 201 "project/radare2/libr/io/p_cache.c" 3 4
unsigned long long 
# 201 "project/radare2/libr/io/p_cache.c"
     blockaddr;
 int byteaddr, i;
 if (!writes) {
  return 
# 204 "project/radare2/libr/io/p_cache.c" 3 4
        0
# 204 "project/radare2/libr/io/p_cache.c"
             ;
 }
 const RIODescCache *dcache = v;
 blockaddr = k * 
# 207 "project/radare2/libr/io/p_cache.c" 3 4
                (sizeof(unsigned long long) * 8)
# 207 "project/radare2/libr/io/p_cache.c"
                                    ;
 for (i = byteaddr = 0; byteaddr < 
# 208 "project/radare2/libr/io/p_cache.c" 3 4
                                  (sizeof(unsigned long long) * 8)
# 208 "project/radare2/libr/io/p_cache.c"
                                                      ; byteaddr++) {
  if (dcache->cached & (0x1LL << byteaddr)) {
   if (!cache) {
    cache = 
# 211 "project/radare2/libr/io/p_cache.c" 3 4
           (
# 211 "project/radare2/libr/io/p_cache.c"
           RIOCache
# 211 "project/radare2/libr/io/p_cache.c" 3 4
           *)calloc(1,sizeof(
# 211 "project/radare2/libr/io/p_cache.c"
...
# 211 "project/radare2/libr/io/p_cache.c"
    ...
    if (!cache) {
     return 
# 213 "project/radare2/libr/io/p_cache.c" 3 4
           0
# 213 "project/radare2/libr/io/p_cache.c"
                ;
    }
    cache->data = malloc (
# 215 "project/radare2/libr/io/p_cache.c" 3 4
                         (sizeof(unsigned long long) * 8) 
# 215 "project/radare2/libr/io/p_cache.c"
                                              - byteaddr);
    if (!cache->data) {
     free (cache);
     return 
# 218 "project/radare2/libr/io/p_cache.c" 3 4
           0
# 218 "project/radare2/libr/io/p_cache.c"
                ;
    }
...
# 225 "project/radare2/libr/io/p_cache.c" 3 4
  unsigned char 
# 225 "project/radare2/libr/io/p_cache.c"
      *data = realloc (cache->data, i);
   if (!data) {
    __riocache_free ((void *) cache);
    return 
# 228 "project/radare2/libr/io/p_cache.c" 3 4
          0
# 228 "project/radare2/libr/io/p_cache.c"
               ;
   }
   cache->data = data;
   cache->itv.size = i;
...
# 233 "project/radare2/libr/io/p_cache.c" 3 4
  r_list_append ((
# 233 "project/radare2/libr/io/p_cache.c"
  writes
# 233 "project/radare2/libr/io/p_cache.c" 3 4
  ), (
# 233 "project/radare2/libr/io/p_cache.c"
...
# 233 "project/radare2/libr/io/p_cache.c"
                             ;
   cache = 
# 234 "project/radare2/libr/io/p_cache.c" 3 4
          ((void *)0)
# 234 "project/radare2/libr/io/p_cache.c"
              ;
  }
 }
 if (cache) {
...
# 243 "project/radare2/libr/io/p_cache.c" 3 4
 r_list_append ((
# 243 "project/radare2/libr/io/p_cache.c"
 writes
# 243 "project/radare2/libr/io/p_cache.c" 3 4
 ), (
# 243 "project/radare2/libr/io/p_cache.c"
...
# 243 "project/radare2/libr/io/p_cache.c"
 ...
 return 
# 245 "project/radare2/libr/io/p_cache.c" 3 4
       1
# 245 "project/radare2/libr/io/p_cache.c"
           ;
}


# 248 "project/radare2/libr/io/p_cache.c" 3 4
__attribute__((visibility("default"))) 
# 248 "project/radare2/libr/io/p_cache.c"
     RList *r_io_desc_cache_list(RIODesc *desc) {
 if (!desc || !desc->io || !desc->io->desc || !desc->io->p_cache || !desc->cache) {
  return 
# 250 "project/radare2/libr/io/p_cache.c" 3 4
        ((void *)0)
# 250 "project/radare2/libr/io/p_cache.c"
            ;
 }
 RList *writes = r_list_newf ((RListFree)__riocache_free);
 if (!writes) {
  return 
# 254 "project/radare2/libr/io/p_cache.c" 3 4
        ((void *)0)
# 254 "project/radare2/libr/io/p_cache.c"
            ;
 }
 ...
 desc->io->desc = desc;
 desc->io->p_cache = 
# 259 "project/radare2/libr/io/p_cache.c" 3 4
                    0
# 259 "project/radare2/libr/io/p_cache.c"
                         ;

 RIOCache *c;
 RListIter *iter;
 
# 263 "project/radare2/libr/io/p_cache.c" 3 4
if (
# 263 "project/radare2/libr/io/p_cache.c"
writes
# 263 "project/radare2/libr/io/p_cache.c" 3 4
) for (
# 263 "project/radare2/libr/io/p_cache.c"
...
# 263 "project/radare2/libr/io/p_cache.c"
                                 {
  const 
# 264 "project/radare2/libr/io/p_cache.c" 3 4
       unsigned long long 
# 264 "project/radare2/libr/io/p_cache.c"
            itvSize = r_itv_size (c->itv);
  c->odata = calloc (1, itvSize);
  if (!c->odata) {
   r_list_free (writes);
   return 
# 268 "project/radare2/libr/io/p_cache.c" 3 4
         ((void *)0)
# 268 "project/radare2/libr/io/p_cache.c"
             ;
  }
  r_io_pread_at (desc->io, r_itv_begin (c->itv), c->odata, itvSize);
 }
 desc->io->p_cache = 
# 272 "project/radare2/libr/io/p_cache.c" 3 4
                    1
# 272 "project/radare2/libr/io/p_cache.c"
                        ;
...
static 
# 277 "project/radare2/libr/io/p_cache.c" 3 4
      _Bool 
# 277 "project/radare2/libr/io/p_cache.c"
           __desc_cache_commit_cb(void *user, const 
# 277 "project/radare2/libr/io/p_cache.c" 3 4
                                                    unsigned long long 
# 277 "project/radare2/libr/io/p_cache.c"
                                                         k, const void *v) {
...
# 280 "project/radare2/libr/io/p_cache.c" 3 4
unsigned char 
# 280 "project/radare2/libr/io/p_cache.c"
    buf[
# 280 "project/radare2/libr/io/p_cache.c" 3 4
        (sizeof(unsigned long long) * 8)
# 280 "project/radare2/libr/io/p_cache.c"
 ...
 if (!desc || !desc->io) {
  return 
# 282 "project/radare2/libr/io/p_cache.c" 3 4
        0
# 282 "project/radare2/libr/io/p_cache.c"
             ;
 }
 const RIODescCache *dcache = v;
 
# 285 "project/radare2/libr/io/p_cache.c" 3 4
unsigned long long 
# 285 "project/radare2/libr/io/p_cache.c"
     blockaddr = 
# 285 "project/radare2/libr/io/p_cache.c" 3 4
                 (sizeof(unsigned long long) * 8) 
# 285 "project/radare2/libr/io/p_cache.c"
                                      * k;
 for (i = byteaddr = 0; byteaddr < 
# 286 "project/radare2/libr/io/p_cache.c" 3 4
                                  (sizeof(unsigned long long) * 8)
# 286 "project/radare2/libr/io/p_cache.c"
                                                      ; byteaddr++) {
 ...
 if (i > 0) {
  r_io_pwrite_at (desc->io, blockaddr + 
# 296 "project/radare2/libr/io/p_cache.c" 3 4
                                       (sizeof(unsigned long long) * 8) 
# 296 "project/radare2/libr/io/p_cache.c"
                                                            - i, buf, i);
 }
 return 
# 298 "project/radare2/libr/io/p_cache.c" 3 4
       1
# 298 "project/radare2/libr/io/p_cache.c"
           ;
}


# 301 "project/radare2/libr/io/p_cache.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 301 "project/radare2/libr/io/p_cache.c"
          r_io_desc_cache_commit(RIODesc *desc) {
 RIODesc *current;
 if (!desc || !(desc->perm & 
# 303 "project/radare2/libr/io/p_cache.c" 3 4
                            2
# 303 "project/radare2/libr/io/p_cache.c"
                                    ) || !desc->io || !desc->io->files || !desc->io->p_cache) {
  return 
# 304 "project/radare2/libr/io/p_cache.c" 3 4
        0
# 304 "project/radare2/libr/io/p_cache.c"
             ;
 }
 if (!desc->cache) {
  return 
# 307 "project/radare2/libr/io/p_cache.c" 3 4
        1
# 307 "project/radare2/libr/io/p_cache.c"
            ;
 }
 current = desc->io->desc;
 desc->io->desc = desc;
 desc->io->p_cache = 
# 311 "project/radare2/libr/io/p_cache.c" 3 4
                    0
# 311 "project/radare2/libr/io/p_cache.c"
                         ;
 ht_up_foreach (desc->cache, __desc_cache_commit_cb, desc);
 ht_up_free (desc->cache);
 desc->cache = 
# 314 "project/radare2/libr/io/p_cache.c" 3 4
              ((void *)0)
# 314 "project/radare2/libr/io/p_cache.c"
                  ;
 desc->io->p_cache = 
# 315 "project/radare2/libr/io/p_cache.c" 3 4
                    1
# 315 "project/radare2/libr/io/p_cache.c"
                        ;
 desc->io->desc = current;
 return 
# 317 "project/radare2/libr/io/p_cache.c" 3 4
       1
# 317 "project/radare2/libr/io/p_cache.c"
           ;
}

static 
# 320 "project/radare2/libr/io/p_cache.c" 3 4
      _Bool 
# 320 "project/radare2/libr/io/p_cache.c"
           __desc_cache_cleanup_cb(void *user, const 
# 320 "project/radare2/libr/io/p_cache.c" 3 4
                                                     unsigned long long 
# 320 "project/radare2/libr/io/p_cache.c"
                                                          k, const void *v) {
...
# 322 "project/radare2/libr/io/p_cache.c" 3 4
unsigned long long 
# 322 "project/radare2/libr/io/p_cache.c"
     size, blockaddr;
 int byteaddr;
 if (!desc || !desc->cache) {
  return 
# 325 "project/radare2/libr/io/p_cache.c" 3 4
        0
# 325 "project/radare2/libr/io/p_cache.c"
             ;
 }
 RIODescCache *cache = (RIODescCache *)v;
 blockaddr = 
# 328 "project/radare2/libr/io/p_cache.c" 3 4
            (sizeof(unsigned long long) * 8) 
# 328 "project/radare2/libr/io/p_cache.c"
                                 * k;
 size = r_io_desc_size (desc);
 if (size <= blockaddr) {
  ht_up_delete (desc->cache, k);
  return 
# 332 "project/radare2/libr/io/p_cache.c" 3 4
        1
# 332 "project/radare2/libr/io/p_cache.c"
            ;
 }
 if (size <= (blockaddr + 
# 334 "project/radare2/libr/io/p_cache.c" 3 4
                         (sizeof(unsigned long long) * 8) 
# 334 "project/radare2/libr/io/p_cache.c"
                                              - 1)) {
 ...
 return 
# 339 "project/radare2/libr/io/p_cache.c" 3 4
       1
# 339 "project/radare2/libr/io/p_cache.c"
           ;
}


# 342 "project/radare2/libr/io/p_cache.c" 3 4
__attribute__((visibility("default"))) 
# 342 "project/radare2/libr/io/p_cache.c"
     void r_io_desc_cache_cleanup(RIODesc *desc) {
 if (desc && desc->cache) {
...
static 
# 348 "project/radare2/libr/io/p_cache.c" 3 4
      _Bool 
# 348 "project/radare2/libr/io/p_cache.c"
           __desc_fini_cb (void *user, void *data, 
# 348 "project/radare2/libr/io/p_cache.c" 3 4
                                                   unsigned int 
# 348 "project/radare2/libr/io/p_cache.c"
                                                        id) {
 ...
 if (desc->cache) {
  ht_up_free (desc->cache);
  desc->cache = 
# 352 "project/radare2/libr/io/p_cache.c" 3 4
               ((void *)0)
# 352 "project/radare2/libr/io/p_cache.c"
                   ;
 }
 return 
# 354 "project/radare2/libr/io/p_cache.c" 3 4
       1
# 354 "project/radare2/libr/io/p_cache.c"
           ;
}


# 357 "project/radare2/libr/io/p_cache.c" 3 4
__attribute__((visibility("default"))) 
# 357 "project/radare2/libr/io/p_cache.c"
     void r_io_desc_cache_fini(RIODesc *desc) {
 __desc_fini_cb (
# 358 "project/radare2/libr/io/p_cache.c" 3 4
                ((void *)0)
# 358 "project/radare2/libr/io/p_cache.c"
                    , (void *) desc, 0);
}


# 361 "project/radare2/libr/io/p_cache.c" 3 4
__attribute__((visibility("default"))) 
# 361 "project/radare2/libr/io/p_cache.c"
     void r_io_desc_cache_fini_all(RIO *io) {
 if (io && io->files) {
  r_id_storage_foreach (io->files, __desc_fini_cb, 
# 363 "project/radare2/libr/io/p_cache.c" 3 4
                                                  ((void *)0)
# 363 "project/radare2/libr/io/p_cache.c"
                                                      );
 }
}
