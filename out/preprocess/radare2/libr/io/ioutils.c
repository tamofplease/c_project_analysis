# 0 "project/radare2/libr/io/ioutils.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/io/ioutils.c" 2
...
# 9 "project/radare2/libr/io/ioutils.c"
          r_io_addr_is_mapped(RIO *io, 
# 9 "project/radare2/libr/io/ioutils.c" 3 4
                                       unsigned long long 
# 9 "project/radare2/libr/io/ioutils.c"
                                            vaddr) {
 
# 10 "project/radare2/libr/io/ioutils.c" 3 4
do { if (!(
# 10 "project/radare2/libr/io/ioutils.c"
io
# 10 "project/radare2/libr/io/ioutils.c" 3 4
...
# 18 "project/radare2/libr/io/ioutils.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 18 "project/radare2/libr/io/ioutils.c"
          r_io_is_valid_offset(RIO* io, 
# 18 "project/radare2/libr/io/ioutils.c" 3 4
                                        unsigned long long 
# 18 "project/radare2/libr/io/ioutils.c"
                                             offset, int hasperm) {
 
# 19 "project/radare2/libr/io/ioutils.c" 3 4
do { if (!(
# 19 "project/radare2/libr/io/ioutils.c"
io
# 19 "project/radare2/libr/io/ioutils.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 19 "project/radare2/libr/io/ioutils.c"
...
# 19 "project/radare2/libr/io/ioutils.c"
                                ;
 if (io->mask) {
  if (offset > io->mask && hasperm & 
# 21 "project/radare2/libr/io/ioutils.c" 3 4
                                    1
# 21 "project/radare2/libr/io/ioutils.c"
                                            ) {
   return 
# 22 "project/radare2/libr/io/ioutils.c" 3 4
         0
# 22 "project/radare2/libr/io/ioutils.c"
              ;
  }
 }
 if (io->va) {
  if (!hasperm) {
   ...
   return map? map->perm & 
# 29 "project/radare2/libr/io/ioutils.c" 3 4
                          4
# 29 "project/radare2/libr/io/ioutils.c"
                                  : 
# 29 "project/radare2/libr/io/ioutils.c" 3 4
                                    0
# 29 "project/radare2/libr/io/ioutils.c"
  ...
  RIOMap* map = r_io_map_get_at (io, offset);
  return map? (map->perm & hasperm) == hasperm: 
# 32 "project/radare2/libr/io/ioutils.c" 3 4
                                               0
# 32 "project/radare2/libr/io/ioutils.c"
                                                    ;
 }
 if (!io->desc) {
  return 
# 35 "project/radare2/libr/io/ioutils.c" 3 4
        0
# 35 "project/radare2/libr/io/ioutils.c"
             ;
 }
 if (offset > r_io_desc_size (io->desc)) {
  return 
# 38 "project/radare2/libr/io/ioutils.c" 3 4
        0
# 38 "project/radare2/libr/io/ioutils.c"
             ;
 }
...
# 44 "project/radare2/libr/io/ioutils.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 44 "project/radare2/libr/io/ioutils.c"
          r_io_read_i(RIO* io, 
# 44 "project/radare2/libr/io/ioutils.c" 3 4
                               unsigned long long 
# 44 "project/radare2/libr/io/ioutils.c"
...
# 45 "project/radare2/libr/io/ioutils.c" 3 4
unsigned char 
# 45 "project/radare2/libr/io/ioutils.c"
    buf[8];
 
# 46 "project/radare2/libr/io/ioutils.c" 3 4
do { if (!(
# 46 "project/radare2/libr/io/ioutils.c"
io && val
# 46 "project/radare2/libr/io/ioutils.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 46 "project/radare2/libr/io/ioutils.c"
...
# 46 "project/radare2/libr/io/ioutils.c"
                                       ;
 size = 
# 47 "project/radare2/libr/io/ioutils.c" 3 4
       (((
# 47 "project/radare2/libr/io/ioutils.c"
       size
# 47 "project/radare2/libr/io/ioutils.c" 3 4
       )<(
# 47 "project/radare2/libr/io/ioutils.c"
...
# 47 "project/radare2/libr/io/ioutils.c"
 ...
 if (!r_io_read_at (io, addr, buf, size)) {
  return 
# 49 "project/radare2/libr/io/ioutils.c" 3 4
        0
# 49 "project/radare2/libr/io/ioutils.c"
             ;
 }

 *val = r_read_ble (buf, endian, size * 8);
 return 
# 53 "project/radare2/libr/io/ioutils.c" 3 4
       1
# 53 "project/radare2/libr/io/ioutils.c"
           ;
}


# 56 "project/radare2/libr/io/ioutils.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 56 "project/radare2/libr/io/ioutils.c"
          r_io_write_i(RIO* io, 
# 56 "project/radare2/libr/io/ioutils.c" 3 4
                                unsigned long long 
# 56 "project/radare2/libr/io/ioutils.c"
...
# 57 "project/radare2/libr/io/ioutils.c" 3 4
unsigned char 
# 57 "project/radare2/libr/io/ioutils.c"
    buf[8];
 
# 58 "project/radare2/libr/io/ioutils.c" 3 4
do { if (!(
# 58 "project/radare2/libr/io/ioutils.c"
io && val
# 58 "project/radare2/libr/io/ioutils.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 58 "project/radare2/libr/io/ioutils.c"
...
# 58 "project/radare2/libr/io/ioutils.c"
                                       ;
 size = 
# 59 "project/radare2/libr/io/ioutils.c" 3 4
       (((
# 59 "project/radare2/libr/io/ioutils.c"
       size
# 59 "project/radare2/libr/io/ioutils.c" 3 4
       )<(
# 59 "project/radare2/libr/io/ioutils.c"
