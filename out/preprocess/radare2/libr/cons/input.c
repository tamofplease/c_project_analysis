# 0 "project/radare2/libr/cons/input.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/cons/input.c" 2


# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/errno.h" 1 3 4
# 7 "project/radare2/libr/cons/input.c" 2
...
# 12 "project/radare2/libr/cons/input.c"
static char *readbuffer = 
# 12 "project/radare2/libr/cons/input.c" 3 4
                         ((void *)0)
# 12 "project/radare2/libr/cons/input.c"
                             ;
static int readbuffer_length = 0;
static 
# 14 "project/radare2/libr/cons/input.c" 3 4
      _Bool 
# 14 "project/radare2/libr/cons/input.c"
           bufactive = 
# 14 "project/radare2/libr/cons/input.c" 3 4
                       1
# 14 "project/radare2/libr/cons/input.c"
                           ;
# 35 "project/radare2/libr/cons/input.c"

# 35 "project/radare2/libr/cons/input.c" 3 4
__attribute__((visibility("default"))) 
# 35 "project/radare2/libr/cons/input.c"
     int r_cons_controlz(int ch) {

 if (ch == 0x1a) {
  r_cons_show_cursor (
# 38 "project/radare2/libr/cons/input.c" 3 4
                     1
# 38 "project/radare2/libr/cons/input.c"
                         );
  r_cons_enable_mouse (
# 39 "project/radare2/libr/cons/input.c" 3 4
                      0
# 39 "project/radare2/libr/cons/input.c"
                           );
  r_sys_stop ();
  return 0;
 }
...
# 94 "project/radare2/libr/cons/input.c" 3 4
__attribute__((visibility("default"))) 
# 94 "project/radare2/libr/cons/input.c"
     int r_cons_arrow_to_hjkl(int ch) {
# 122 "project/radare2/libr/cons/input.c"
 r_cons_singleton ()->mouse_event = 0;

 switch ((
# 124 "project/radare2/libr/cons/input.c" 3 4
         unsigned char
# 124 "project/radare2/libr/cons/input.c"
            )ch) {
 ...
 case 0x4f:
  ch = r_cons_readchar ();
# 157 "project/radare2/libr/cons/input.c"
  ch = 0xf1 + (ch & 0xf);
  break;
 case '[':
  ch = r_cons_readchar ();
  ...
  case '<':
   {
    ...
    case 2:
     if (ch == 'M') {
      return 
# 198 "project/radare2/libr/cons/input.c" 3 4
            127
# 198 "project/radare2/libr/cons/input.c"
                    ;
     }
     return -
# 200 "project/radare2/libr/cons/input.c" 3 4
            127
# 200 "project/radare2/libr/cons/input.c"
                    ;
    case 64:
     return 'k';
    case 65:
  ...
  case '[':
   ...
   switch (ch) {
   case '2': ch = 
# 216 "project/radare2/libr/cons/input.c" 3 4
                 0xfb
# 216 "project/radare2/libr/cons/input.c"
                               ; break;
   case 'A': ch = 
# 217 "project/radare2/libr/cons/input.c" 3 4
                 0xf1
# 217 "project/radare2/libr/cons/input.c"
                              ; break;
   case 'B': ch = 
# 218 "project/radare2/libr/cons/input.c" 3 4
                 0xf2
# 218 "project/radare2/libr/cons/input.c"
                              ; break;
   case 'C': ch = 
# 219 "project/radare2/libr/cons/input.c" 3 4
                 0xf3
# 219 "project/radare2/libr/cons/input.c"
                              ; break;
   case 'D': ch = 
# 220 "project/radare2/libr/cons/input.c" 3 4
                 0xf4
# 220 "project/radare2/libr/cons/input.c"
                              ; break;
   }
   break;
  case '9':
   ...
   r_cons_singleton ()->mouse_event = 1;
   if (ch == '6') {
    ch = 'k';
   } else if (ch == '7') {
    ch = 'j';
  ...
  case '2':
   ...
   case 0x7e:
    ch = 
# 251 "project/radare2/libr/cons/input.c" 3 4
        0xfc
# 251 "project/radare2/libr/cons/input.c"
                      ;
    break;
   default:
    r_cons_readchar ();
    switch (ch) {
    case '0': ch = 
# 256 "project/radare2/libr/cons/input.c" 3 4
                  0xf9
# 256 "project/radare2/libr/cons/input.c"
                               ; break;
    case '1': ch = 
# 257 "project/radare2/libr/cons/input.c" 3 4
                  0xfa
# 257 "project/radare2/libr/cons/input.c"
                                ; break;
    case '3': ch = 
# 258 "project/radare2/libr/cons/input.c" 3 4
                  0xfb
# 258 "project/radare2/libr/cons/input.c"
                                ; break;
    }
    break;
   }
  ...
  case '1':
   ...
   switch (ch) {
   case '1': ch = 
# 266 "project/radare2/libr/cons/input.c" 3 4
                 0xf1
# 266 "project/radare2/libr/cons/input.c"
                              ; break;
   case '2': ch = 
# 267 "project/radare2/libr/cons/input.c" 3 4
                 0xf2
# 267 "project/radare2/libr/cons/input.c"
                              ; break;
   case '3': ch = 
# 268 "project/radare2/libr/cons/input.c" 3 4
                 0xf3
# 268 "project/radare2/libr/cons/input.c"
                              ; break;
   case '4': ch = 
# 269 "project/radare2/libr/cons/input.c" 3 4
                 0xf4
# 269 "project/radare2/libr/cons/input.c"
                              ; break;
   case '5': ch = 
# 270 "project/radare2/libr/cons/input.c" 3 4
                 0xf5
# 270 "project/radare2/libr/cons/input.c"
                              ; break;

   case '7': ch = 
# 272 "project/radare2/libr/cons/input.c" 3 4
                 0xf6
# 272 "project/radare2/libr/cons/input.c"
                              ; break;
   case '8': ch = 
# 273 "project/radare2/libr/cons/input.c" 3 4
                 0xf7
# 273 "project/radare2/libr/cons/input.c"
                              ; break;
   case '9': ch = 
# 274 "project/radare2/libr/cons/input.c" 3 4
                 0xf8
# 274 "project/radare2/libr/cons/input.c"
                              ; break;
# 299 "project/radare2/libr/cons/input.c"
   case ';':
    ch = r_cons_readchar ();
    switch (ch) {
    case '2':
...
# 347 "project/radare2/libr/cons/input.c" 3 4
__attribute__((visibility("default"))) 
# 347 "project/radare2/libr/cons/input.c"
 ...
 if (cons->echo) {
  r_cons_set_raw (
# 352 "project/radare2/libr/cons/input.c" 3 4
                 0
# 352 "project/radare2/libr/cons/input.c"
                      );
  r_cons_show_cursor (
# 353 "project/radare2/libr/cons/input.c" 3 4
                     1
# 353 "project/radare2/libr/cons/input.c"
                         );
 }
...
# 360 "project/radare2/libr/cons/input.c" 3 4
(*__error()) 
# 360 "project/radare2/libr/cons/input.c"
      = 0;
 if (cons->user_fgets) {
  { ret=cons->user_fgets (buf, len); goto beach; };
 }
 printf ("%s", cons->line->prompt);
 fflush (
# 365 "project/radare2/libr/cons/input.c" 3 4
        __stdoutp
# 365 "project/radare2/libr/cons/input.c"
              );
 *buf = '\0';
 if (color) {
  const char *p = cons->context->pal.input;
  if (
# 369 "project/radare2/libr/cons/input.c" 3 4
     ((
# 369 "project/radare2/libr/cons/input.c"
     p
# 369 "project/radare2/libr/cons/input.c" 3 4
     ) && *(
# 369 "project/radare2/libr/cons/input.c"
...
# 369 "project/radare2/libr/cons/input.c"
   ...
   fwrite (p, strlen (p), 1, 
# 370 "project/radare2/libr/cons/input.c" 3 4
                            __stdoutp
# 370 "project/radare2/libr/cons/input.c"
                                  );
   fflush (
# 371 "project/radare2/libr/cons/input.c" 3 4
          __stdoutp
# 371 "project/radare2/libr/cons/input.c"
                );
  }
 }
 if (!fgets (buf, len, cons->fdin)) {
  if (color) {
   printf (
# 376 "project/radare2/libr/cons/input.c" 3 4
          "\x1b[0m"
# 376 "project/radare2/libr/cons/input.c"
                     );
   fflush (
# 377 "project/radare2/libr/cons/input.c" 3 4
          __stdoutp
# 377 "project/radare2/libr/cons/input.c"
                );
  }
  { ret=-1; goto beach; };
 }
 if (feof (cons->fdin)) {
  if (color) {
   printf (
# 383 "project/radare2/libr/cons/input.c" 3 4
          "\x1b[0m"
# 383 "project/radare2/libr/cons/input.c"
                     );
  }
  { ret=-2; goto beach; };
 }
 ...
 if (color) {
  printf (
# 389 "project/radare2/libr/cons/input.c" 3 4
         "\x1b[0m"
# 389 "project/radare2/libr/cons/input.c"
                    );
 }
 ret = strlen (buf);
beach:
...
# 397 "project/radare2/libr/cons/input.c" 3 4
__attribute__((visibility("default"))) 
# 397 "project/radare2/libr/cons/input.c"
     int r_cons_any_key(const char *msg) {
 if (msg && *msg) {
  r_cons_printf ("\n-- %s --\n", msg);
 } else {
  
# 401 "project/radare2/libr/cons/input.c" 3 4
 r_cons_strcat (
# 401 "project/radare2/libr/cons/input.c"
 "\n--press any key--\n"
# 401 "project/radare2/libr/cons/input.c" 3 4
 )
# 401 "project/radare2/libr/cons/input.c"
...
# 560 "project/radare2/libr/cons/input.c"

# 560 "project/radare2/libr/cons/input.c" 3 4
__attribute__((visibility("default"))) 
# 560 "project/radare2/libr/cons/input.c"
     int r_cons_readchar_timeout(
# 560 "project/radare2/libr/cons/input.c" 3 4
                                 unsigned int 
# 560 "project/radare2/libr/cons/input.c"
                                      usec) {
...
# 564 "project/radare2/libr/cons/input.c" 3 4
__builtin_bzero(
# 564 "project/radare2/libr/cons/input.c"
&fdset
# 564 "project/radare2/libr/cons/input.c" 3 4
, sizeof(*(
# 564 "project/radare2/libr/cons/input.c"
...
# 565 "project/radare2/libr/cons/input.c" 3 4
__builtin_bzero(
# 565 "project/radare2/libr/cons/input.c"
&errset
# 565 "project/radare2/libr/cons/input.c" 3 4
, sizeof(*(
# 565 "project/radare2/libr/cons/input.c"
...
# 566 "project/radare2/libr/cons/input.c" 3 4
__darwin_fd_set((
# 566 "project/radare2/libr/cons/input.c"
0
# 566 "project/radare2/libr/cons/input.c" 3 4
), (
# 566 "project/radare2/libr/cons/input.c"
...
# 566 "project/radare2/libr/cons/input.c"
 ...
 r_cons_set_raw (1);
 if (select (1, &fdset, 
# 570 "project/radare2/libr/cons/input.c" 3 4
                       ((void *)0)
# 570 "project/radare2/libr/cons/input.c"
                           , &errset, &tv) == 1) {
  return r_cons_readchar ();
 }
 r_cons_set_raw (0);
...
# 581 "project/radare2/libr/cons/input.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 581 "project/radare2/libr/cons/input.c"
          r_cons_readpush(const char *str, int len) {
 char *res = (len + readbuffer_length > 0) ? realloc (readbuffer, len + readbuffer_length) : 
# 582 "project/radare2/libr/cons/input.c" 3 4
                                                                                            ((void *)0)
# 582 "project/radare2/libr/cons/input.c"
                                                                                                ;
 if (res) {
  readbuffer = res;
  
# 585 "project/radare2/libr/cons/input.c" 3 4
 __builtin___memmove_chk (
# 585 "project/radare2/libr/cons/input.c"
 readbuffer + readbuffer_length
# 585 "project/radare2/libr/cons/input.c" 3 4
 , 
# 585 "project/radare2/libr/cons/input.c"
 str, len
...
# 585 "project/radare2/libr/cons/input.c"
  ...
  return 
# 587 "project/radare2/libr/cons/input.c" 3 4
        1
# 587 "project/radare2/libr/cons/input.c"
            ;
 }
 return 
# 589 "project/radare2/libr/cons/input.c" 3 4
       0
# 589 "project/radare2/libr/cons/input.c"
            ;
}


# 592 "project/radare2/libr/cons/input.c" 3 4
__attribute__((visibility("default"))) 
# 592 "project/radare2/libr/cons/input.c"
     void r_cons_readflush(void) {
 
# 593 "project/radare2/libr/cons/input.c" 3 4
{ free((void *)
# 593 "project/radare2/libr/cons/input.c"
readbuffer
# 593 "project/radare2/libr/cons/input.c" 3 4
); 
# 593 "project/radare2/libr/cons/input.c"
...
# 597 "project/radare2/libr/cons/input.c" 3 4
__attribute__((visibility("default"))) 
# 597 "project/radare2/libr/cons/input.c"
     void r_cons_switchbuf(
# 597 "project/radare2/libr/cons/input.c" 3 4
                           _Bool 
# 597 "project/radare2/libr/cons/input.c"
                                active) {
...
# 605 "project/radare2/libr/cons/input.c" 3 4
__attribute__((visibility("default"))) 
# 605 "project/radare2/libr/cons/input.c"
...
# 611 "project/radare2/libr/cons/input.c" 3 4
 __builtin___memmove_chk (
# 611 "project/radare2/libr/cons/input.c"
 readbuffer
# 611 "project/radare2/libr/cons/input.c" 3 4
 , 
# 611 "project/radare2/libr/cons/input.c"
 readbuffer + 1, readbuffer_length
# 611 "project/radare2/libr/cons/input.c" 3 4
 , __builtin_object_size (
# 611 "project/radare2/libr/cons/input.c"
 readbuffer
...
# 611 "project/radare2/libr/cons/input.c"
 ...
 r_cons_set_raw (1);
# 629 "project/radare2/libr/cons/input.c"
...
# 639 "project/radare2/libr/cons/input.c" 3 4
__builtin_bzero(
# 639 "project/radare2/libr/cons/input.c"
&readfds
# 639 "project/radare2/libr/cons/input.c" 3 4
, sizeof(*(
# 639 "project/radare2/libr/cons/input.c"
...
# 640 "project/radare2/libr/cons/input.c" 3 4
__darwin_fd_set((0), (
# 640 "project/radare2/libr/cons/input.c"
&readfds
# 640 "project/radare2/libr/cons/input.c" 3 4
))
# 640 "project/radare2/libr/cons/input.c"
                               ;
 r_signal_sigmask (0, 
# 641 "project/radare2/libr/cons/input.c" 3 4
                     ((void *)0)
# 641 "project/radare2/libr/cons/input.c"
                         , &sigmask);
 
# 642 "project/radare2/libr/cons/input.c" 3 4
(*(
# 642 "project/radare2/libr/cons/input.c"
&sigmask
# 642 "project/radare2/libr/cons/input.c" 3 4
) &= ~__sigbits(28), 0)
# 642 "project/radare2/libr/cons/input.c"
                              ;
 while (pselect (
# 643 "project/radare2/libr/cons/input.c" 3 4
                0 
# 643 "project/radare2/libr/cons/input.c"
                             + 1, &readfds, 
# 643 "project/radare2/libr/cons/input.c" 3 4
                                            ((void *)0)
# 643 "project/radare2/libr/cons/input.c"
...
# 643 "project/radare2/libr/cons/input.c"
                                                            , &sigmask) == -1) {
  if (
# 644 "project/radare2/libr/cons/input.c" 3 4
     (*__error()) 
# 644 "project/radare2/libr/cons/input.c"
           == 
# 644 "project/radare2/libr/cons/input.c" 3 4
              9
# 644 "project/radare2/libr/cons/input.c"
...
# 645 "project/radare2/libr/cons/input.c" 3 4
  fprintf(__stderrp,
# 645 "project/radare2/libr/cons/input.c"
  "r_cons_readchar (): EBADF\n"
# 645 "project/radare2/libr/cons/input.c" 3 4
  )
# 645 "project/radare2/libr/cons/input.c"
                                         ;
 ...
 ssize_t ret = read (
# 654 "project/radare2/libr/cons/input.c" 3 4
                    0
# 654 "project/radare2/libr/cons/input.c"
                                , buf, 1);
...
# 666 "project/radare2/libr/cons/input.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 666 "project/radare2/libr/cons/input.c"
          r_cons_yesno(int def, const char *fmt, ...) {
 va_list ap;
 
# 668 "project/radare2/libr/cons/input.c" 3 4
unsigned char 
# 668 "project/radare2/libr/cons/input.c"
    key = (
# 668 "project/radare2/libr/cons/input.c" 3 4
           unsigned char
# 668 "project/radare2/libr/cons/input.c"
...
# 669 "project/radare2/libr/cons/input.c" 3 4
__builtin_va_start(
# 669 "project/radare2/libr/cons/input.c"
ap
# 669 "project/radare2/libr/cons/input.c" 3 4
,
# 669 "project/radare2/libr/cons/input.c"
...
# 672 "project/radare2/libr/cons/input.c" 3 4
 __builtin_va_end(
# 672 "project/radare2/libr/cons/input.c"
 ap
# 672 "project/radare2/libr/cons/input.c" 3 4
 )
# 672 "project/radare2/libr/cons/input.c"
 ...
 vfprintf (
# 675 "project/radare2/libr/cons/input.c" 3 4
          __stderrp
# 675 "project/radare2/libr/cons/input.c"
                , fmt, ap);
 
# 676 "project/radare2/libr/cons/input.c" 3 4
__builtin_va_end(
# 676 "project/radare2/libr/cons/input.c"
ap
# 676 "project/radare2/libr/cons/input.c" 3 4
)
# 676 "project/radare2/libr/cons/input.c"
           ;
 fflush (
# 677 "project/radare2/libr/cons/input.c" 3 4
        __stderrp
# 677 "project/radare2/libr/cons/input.c"
              );
 r_cons_set_raw (
# 678 "project/radare2/libr/cons/input.c" 3 4
                1
# 678 "project/radare2/libr/cons/input.c"
                    );
 char buf[] = " ?\n";
 if (read (0, buf + 1, 1) == 1) {
  key = (
# 681 "project/radare2/libr/cons/input.c" 3 4
        unsigned char
# 681 "project/radare2/libr/cons/input.c"
           )buf[1];
  if (write (2, buf, 3) == 3) {
   if (key == 'Y') {
    key = 'y';
   ...
   r_cons_set_raw (
# 686 "project/radare2/libr/cons/input.c" 3 4
                  0
# 686 "project/radare2/libr/cons/input.c"
                       );
   if (key == '\n' || key == '\r') {
    key = def;
   }
 ...
 return 
# 693 "project/radare2/libr/cons/input.c" 3 4
       0
# 693 "project/radare2/libr/cons/input.c"
            ;
}


# 696 "project/radare2/libr/cons/input.c" 3 4
__attribute__((visibility("default"))) 
# 696 "project/radare2/libr/cons/input.c"
     char *r_cons_password(const char *msg) {
 int i = 0;
 printf ("\r%s", msg);
 fflush (
# 699 "project/radare2/libr/cons/input.c" 3 4
        __stdoutp
# 699 "project/radare2/libr/cons/input.c"
              );
 r_cons_set_raw (1);

 RCons *a = r_cons_singleton ();
 a->term_raw.c_lflag &= ~(
# 703 "project/radare2/libr/cons/input.c" 3 4
                         0x00000008 
# 703 "project/radare2/libr/cons/input.c"
                              | 
# 703 "project/radare2/libr/cons/input.c" 3 4
                                0x00000010
# 703 "project/radare2/libr/cons/input.c"
 ...
 tcsetattr (0, 
# 707 "project/radare2/libr/cons/input.c" 3 4
              1
# 707 "project/radare2/libr/cons/input.c"
                       , &a->term_raw);
 r_sys_signal (
# 708 "project/radare2/libr/cons/input.c" 3 4
              18
# 708 "project/radare2/libr/cons/input.c"
                     , 
# 708 "project/radare2/libr/cons/input.c" 3 4
                       (void (*)(int))1
# 708 "project/radare2/libr/cons/input.c"
 ...
 if (!buf) {
  return 
# 713 "project/radare2/libr/cons/input.c" 3 4
        ((void *)0)
# 713 "project/radare2/libr/cons/input.c"
            ;
 }
 while (i < buf_size - 1) {
  int ch = r_cons_readchar ();
 ...
 r_sys_signal (
# 733 "project/radare2/libr/cons/input.c" 3 4
              18
# 733 "project/radare2/libr/cons/input.c"
                     , 
# 733 "project/radare2/libr/cons/input.c" 3 4
                       (void (*)(int))0
# 733 "project/radare2/libr/cons/input.c"
...
# 738 "project/radare2/libr/cons/input.c" 3 4
__attribute__((visibility("default"))) 
# 738 "project/radare2/libr/cons/input.c"
     char *r_cons_input(const char *msg) {
 char *oprompt = r_line_get_prompt ();
 if (!oprompt) {
  return 
# 741 "project/radare2/libr/cons/input.c" 3 4
        ((void *)0)
# 741 "project/radare2/libr/cons/input.c"
            ;
 }
 if (msg) {
 ...
 if (buf) {
  *buf = 0;
  r_cons_fgets (buf, buf_size, 0, 
# 752 "project/radare2/libr/cons/input.c" 3 4
                                 ((void *)0)
# 752 "project/radare2/libr/cons/input.c"
                                     );
