# 0 "project/radare2/libr/cons/pager.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/cons/pager.c"
...
# 4 "project/radare2/libr/cons/pager.c" 2
...
# 5 "project/radare2/libr/cons/pager.c" 2
...
# 7 "project/radare2/libr/cons/pager.c" 2
...
# 14 "project/radare2/libr/cons/pager.c" 3 4
 (1? (1?"\x1b[7m": "\x1b[27m"): (1?"[":"]"))
# 14 "project/radare2/libr/cons/pager.c"
                           ,
  
# 15 "project/radare2/libr/cons/pager.c" 3 4
 (1? (0?"\x1b[7m": "\x1b[27m"): (0?"[":"]"))
 
# 16 "project/radare2/libr/cons/pager.c"
};
 int linv[2] = {
  strlen (inv[0]),
  strlen (inv[1])
...
# 22 "project/radare2/libr/cons/pager.c" 3 4
if (
# 22 "project/radare2/libr/cons/pager.c"
ml
# 22 "project/radare2/libr/cons/pager.c" 3 4
) for (
# 22 "project/radare2/libr/cons/pager.c"
...
# 33 "project/radare2/libr/cons/pager.c" 3 4
                                     ((void *)0)
# 33 "project/radare2/libr/cons/pager.c"
                                         , 
# 33 "project/radare2/libr/cons/pager.c" 3 4
                                           ((void *)0)
# 33 "project/radare2/libr/cons/pager.c"
...
# 65 "project/radare2/libr/cons/pager.c" 3 4
  r_cons_strcat (
# 65 "project/radare2/libr/cons/pager.c"
  p->str
# 65 "project/radare2/libr/cons/pager.c" 3 4
  )
# 65 "project/radare2/libr/cons/pager.c"
...
# 101 "project/radare2/libr/cons/pager.c" 3 4
     _Bool 
# 101 "project/radare2/libr/cons/pager.c"
          pager_all_matches(const char *s, RRegex *rx, RList **mla, int *lines, int lcount) {
 
# 102 "project/radare2/libr/cons/pager.c" 3 4
_Bool 
# 102 "project/radare2/libr/cons/pager.c"
     res = 
# 102 "project/radare2/libr/cons/pager.c" 3 4
           0
# 102 "project/radare2/libr/cons/pager.c"
 ...
 for (l = 0; l < lcount; l++) {
  m.rm_so = 0;
  const char *loff = s + lines[l];
  char *clean = strdup (loff);
  if (!clean) {
   return 
# 110 "project/radare2/libr/cons/pager.c" 3 4
         0
# 110 "project/radare2/libr/cons/pager.c"
              ;
  }
  int *cpos = 
# 112 "project/radare2/libr/cons/pager.c" 3 4
             ((void *)0)
# 112 "project/radare2/libr/cons/pager.c"
                 ;
  int ncpos = r_str_ansi_filter (clean, 
# 113 "project/radare2/libr/cons/pager.c" 3 4
                                       ((void *)0)
# 113 "project/radare2/libr/cons/pager.c"
                                           , &cpos, -1);
  m.rm_eo = slen = strlen (clean);
  r_list_purge (mla[l]);
  while (!r_regex_exec (rx, clean, 1, &m, 
# 116 "project/radare2/libr/cons/pager.c" 3 4
                                         00004
# 116 "project/radare2/libr/cons/pager.c"
                                                         )) {
   if (!cpos || m.rm_so >= ncpos) {
    break;
   }
   RRegexMatch *ms = 
# 120 "project/radare2/libr/cons/pager.c" 3 4
                    (
# 120 "project/radare2/libr/cons/pager.c"
                    RRegexMatch
# 120 "project/radare2/libr/cons/pager.c" 3 4
                    *)calloc(1,sizeof(
# 120 "project/radare2/libr/cons/pager.c"
...
# 120 "project/radare2/libr/cons/pager.c"
   ...
   m.rm_eo = slen;
   res = 
# 128 "project/radare2/libr/cons/pager.c" 3 4
        1
# 128 "project/radare2/libr/cons/pager.c"
            ;
  }
  free (cpos);
  free (clean);
 ...
 int lines_size = 128;
 int *lines = 
# 138 "project/radare2/libr/cons/pager.c" 3 4
             ((void *)0)
# 138 "project/radare2/libr/cons/pager.c"
                 ;
 int i, row = 0;
 int sidx = 0;
 ...
 if (lines_size * sizeof (int) < lines_size) {
  return 
# 143 "project/radare2/libr/cons/pager.c" 3 4
        ((void *)0)
# 143 "project/radare2/libr/cons/pager.c"
            ;
 }
  ...
  for (i = 0; s[i]; i++) {
   if (row >= lines_size) {
    ...
    if (lines_size * sizeof (int) < lines_size) {
     free (lines);
     return 
# 154 "project/radare2/libr/cons/pager.c" 3 4
           ((void *)0)
# 154 "project/radare2/libr/cons/pager.c"
               ;
    }
    ...
    if (!tmp) {
     free (lines);
     return 
# 159 "project/radare2/libr/cons/pager.c" 3 4
           ((void *)0)
# 159 "project/radare2/libr/cons/pager.c"
               ;
    }
    lines = tmp;
   }
