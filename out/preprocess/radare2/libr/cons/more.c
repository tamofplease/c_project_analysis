# 0 "project/radare2/libr/cons/more.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/cons/more.c"
...
# 4 "project/radare2/libr/cons/more.c" 2
...
# 5 "project/radare2/libr/cons/more.c" 2
...
# 6 "project/radare2/libr/cons/more.c" 2
# 1 "project/radare2/libr/cons/pager_private.h" 1



 
# 4 "project/radare2/libr/cons/pager_private.h"
     void pager_color_line(const char *line, RStrpool *p, RList *ml);
 void pager_printpage(const char *line, int *index, RList **mla, int from, int to, int w);
 int pager_next_match(int from, RList **mla, int lcount);
 int pager_prev_match(int from, RList **mla);
 
# 8 "project/radare2/libr/cons/pager_private.h" 3 4
     _Bool 
# 8 "project/radare2/libr/cons/pager_private.h"
          pager_all_matches(const char *s, RRegex *rx, RList **mla, int *lines, int lcount);
 int *pager_splitlines(char *s, int *lines_count);
# 7 "project/radare2/libr/cons/more.c" 2


# 8 "project/radare2/libr/cons/more.c" 3 4
__attribute__((visibility("default"))) 
# 8 "project/radare2/libr/cons/more.c"
     int r_cons_more_str(const char *str, const char *exitkeys) {
 static 
# 9 "project/radare2/libr/cons/more.c" 3 4
       _Bool 
# 9 "project/radare2/libr/cons/more.c"
            inHelp = 
# 9 "project/radare2/libr/cons/more.c" 3 4
                     0
# 9 "project/radare2/libr/cons/more.c"
 ...
 int lines_count = 0;
 RRegex *rx = 
# 20 "project/radare2/libr/cons/more.c" 3 4
             ((void *)0)
# 20 "project/radare2/libr/cons/more.c"
                 ;
 ...
 if (lines_count < 1) {
  mla = 
# 40 "project/radare2/libr/cons/more.c" 3 4
       ((void *)0)
# 40 "project/radare2/libr/cons/more.c"
           ;
 } else {
 ...
 r_cons_set_raw (
# 53 "project/radare2/libr/cons/more.c" 3 4
                1
# 53 "project/radare2/libr/cons/more.c"
                    );
 r_cons_show_cursor (
# 54 "project/radare2/libr/cons/more.c" 3 4
                    0
# 54 "project/radare2/libr/cons/more.c"
                         );
 r_cons_reset ();
 h = 0;
 while (ui) {
  w = r_cons_get_size (&h);
  to = 
# 59 "project/radare2/libr/cons/more.c" 3 4
      (((
# 59 "project/radare2/libr/cons/more.c"
      lines_count
# 59 "project/radare2/libr/cons/more.c" 3 4
      )>(
# 59 "project/radare2/libr/cons/more.c"
...
# 59 "project/radare2/libr/cons/more.c"
  ...
  case '?':
   if (!inHelp) {
    inHelp = 
# 85 "project/radare2/libr/cons/more.c" 3 4
            1
# 85 "project/radare2/libr/cons/more.c"
                ;
    r_cons_more_str (r_cons_more_help, 
# 86 "project/radare2/libr/cons/more.c" 3 4
                                      ((void *)0)
# 86 "project/radare2/libr/cons/more.c"
                                          );
    inHelp = 
# 87 "project/radare2/libr/cons/more.c" 3 4
            0
# 87 "project/radare2/libr/cons/more.c"
                 ;
   }
   break;
  case ' ': from += h; break;
  ...
  case '/':
   ...
   from = 
# 102 "project/radare2/libr/cons/more.c" 3 4
         (((
# 102 "project/radare2/libr/cons/more.c"
         lines_count - 1
# 102 "project/radare2/libr/cons/more.c" 3 4
         )>(
# 102 "project/radare2/libr/cons/more.c"
...
# 102 "project/radare2/libr/cons/more.c"
 ...
 r_cons_reset_colors ();
 r_cons_set_raw (
# 137 "project/radare2/libr/cons/more.c" 3 4
                0
# 137 "project/radare2/libr/cons/more.c"
                     );
 r_cons_show_cursor (
# 138 "project/radare2/libr/cons/more.c" 3 4
                    1
# 138 "project/radare2/libr/cons/more.c"
                        );
 free (ostr);
 return 0;
}
...
# 143 "project/radare2/libr/cons/more.c" 3 4
__attribute__((visibility("default"))) 
# 143 "project/radare2/libr/cons/more.c"
     void r_cons_more(void) {
 (void)r_cons_more_str (r_cons_context ()->buffer, 
# 144 "project/radare2/libr/cons/more.c" 3 4
                                                  ((void *)0)
# 144 "project/radare2/libr/cons/more.c"
                                                      );
}
