# 0 "project/radare2/libr/cons/pixel.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/cons/pixel.c"
...
# 4 "project/radare2/libr/cons/pixel.c" 2
...
# 5 "project/radare2/libr/cons/pixel.c" 2

__attribute__((visibility("default"))) 
# 6 "project/radare2/libr/cons/pixel.c"
     RConsPixel *r_cons_pixel_new(int w, int h) {
 if (UT64_MUL_OVFCHK (w, h)) {
  return 
# 8 "project/radare2/libr/cons/pixel.c" 3 4
        ((void *)0)
# 8 "project/radare2/libr/cons/pixel.c"
            ;
 }
 RConsPixel *p = 
# 10 "project/radare2/libr/cons/pixel.c" 3 4
                (
# 10 "project/radare2/libr/cons/pixel.c"
                RConsPixel
# 10 "project/radare2/libr/cons/pixel.c" 3 4
                *)malloc(sizeof(
# 10 "project/radare2/libr/cons/pixel.c"
...
# 10 "project/radare2/libr/cons/pixel.c"
 ...
 if (!p) {
  return 
# 12 "project/radare2/libr/cons/pixel.c" 3 4
        ((void *)0)
# 12 "project/radare2/libr/cons/pixel.c"
            ;
 }
 p->w = w;
 p->h = h;
 ...
 if (!p->buf) {
  free (p);
  return 
# 20 "project/radare2/libr/cons/pixel.c" 3 4
        ((void *)0)
# 20 "project/radare2/libr/cons/pixel.c"
            ;
 }
 return p;
}
...
# 25 "project/radare2/libr/cons/pixel.c" 3 4
__attribute__((visibility("default"))) 
# 25 "project/radare2/libr/cons/pixel.c"
...
# 32 "project/radare2/libr/cons/pixel.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 32 "project/radare2/libr/cons/pixel.c"
         r_cons_pixel_get(RConsPixel *p, int x, int y) {
 
# 33 "project/radare2/libr/cons/pixel.c" 3 4
do { if (!(
# 33 "project/radare2/libr/cons/pixel.c"
p
# 33 "project/radare2/libr/cons/pixel.c" 3 4
...
# 46 "project/radare2/libr/cons/pixel.c" 3 4
__attribute__((visibility("default"))) 
# 46 "project/radare2/libr/cons/pixel.c"
     void r_cons_pixel_set(RConsPixel *p, int x, int y, 
# 46 "project/radare2/libr/cons/pixel.c" 3 4
                                                        unsigned char 
# 46 "project/radare2/libr/cons/pixel.c"
                                                            v) {
 
# 47 "project/radare2/libr/cons/pixel.c" 3 4
do { if (!(
# 47 "project/radare2/libr/cons/pixel.c"
p
# 47 "project/radare2/libr/cons/pixel.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 47 "project/radare2/libr/cons/pixel.c"
...
# 60 "project/radare2/libr/cons/pixel.c" 3 4
__attribute__((visibility("default"))) 
# 60 "project/radare2/libr/cons/pixel.c"
     void r_cons_pixel_sets(RConsPixel *p, int x, int y, const char *s) {
 
# 61 "project/radare2/libr/cons/pixel.c" 3 4
do { if (!(
# 61 "project/radare2/libr/cons/pixel.c"
p && s
# 61 "project/radare2/libr/cons/pixel.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 61 "project/radare2/libr/cons/pixel.c"
...
# 77 "project/radare2/libr/cons/pixel.c" 3 4
                                  unsigned char
# 77 "project/radare2/libr/cons/pixel.c"
                                     *)s, e - s, &ch);
  if (chsz < 1) {
   chsz = 1;
  }
...
# 89 "project/radare2/libr/cons/pixel.c" 3 4
__attribute__((visibility("default"))) 
# 89 "project/radare2/libr/cons/pixel.c"
     void r_cons_pixel_fill(RConsPixel *p, int _x, int _y, int w, int h, int v) {
 
# 90 "project/radare2/libr/cons/pixel.c" 3 4
do { if (!(
# 90 "project/radare2/libr/cons/pixel.c"
p
# 90 "project/radare2/libr/cons/pixel.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 90 "project/radare2/libr/cons/pixel.c"
...
# 102 "project/radare2/libr/cons/pixel.c" 3 4
__attribute__((visibility("default"))) 
# 102 "project/radare2/libr/cons/pixel.c"
     char *r_cons_pixel_drain(RConsPixel *p) {
 
# 103 "project/radare2/libr/cons/pixel.c" 3 4
do { if (!(
# 103 "project/radare2/libr/cons/pixel.c"
p
# 103 "project/radare2/libr/cons/pixel.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 103 "project/radare2/libr/cons/pixel.c"
...
# 109 "project/radare2/libr/cons/pixel.c" 3 4
__attribute__((visibility("default"))) 
# 109 "project/radare2/libr/cons/pixel.c"
     char *r_cons_pixel_tostring(RConsPixel *p) {
 
# 110 "project/radare2/libr/cons/pixel.c" 3 4
do { if (!(
# 110 "project/radare2/libr/cons/pixel.c"
p
# 110 "project/radare2/libr/cons/pixel.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 110 "project/radare2/libr/cons/pixel.c"
"p"
# 110 "project/radare2/libr/cons/pixel.c" 3 4
, 110); return (((void *)0)); } } while (0)
# 110 "project/radare2/libr/cons/pixel.c"
                              ;
 RStrBuf *sb = r_strbuf_new (
# 111 "project/radare2/libr/cons/pixel.c" 3 4
                            ((void *)0)
# 111 "project/radare2/libr/cons/pixel.c"
                                );
 size_t x, y;
 for (y = 0; y < p->h; y += 4) {
  for (x = 0; x < p->w; x += 2) {
...
# 119 "project/radare2/libr/cons/pixel.c" 3 4
  unsigned char 
# 119 "project/radare2/libr/cons/pixel.c"
      *X = p->buf + (x + ((y + 0) * p->w));
   int u = 0;
   u |= (X[0]?
# 121 "project/radare2/libr/cons/pixel.c" 3 4
             1
# 121 "project/radare2/libr/cons/pixel.c"
                :0);
   u |= (X[1]?
# 122 "project/radare2/libr/cons/pixel.c" 3 4
             8
# 122 "project/radare2/libr/cons/pixel.c"
                :0);
   X = p->buf + (x + ((y + 1) * p->w));
   u |= (X[0]?
# 124 "project/radare2/libr/cons/pixel.c" 3 4
             2
# 124 "project/radare2/libr/cons/pixel.c"
                :0);
   u |= (X[1]?
# 125 "project/radare2/libr/cons/pixel.c" 3 4
             16
# 125 "project/radare2/libr/cons/pixel.c"
                :0);
   X = p->buf + (x + ((y + 2) * p->w));
   u |= (X[0]?
# 127 "project/radare2/libr/cons/pixel.c" 3 4
             4
# 127 "project/radare2/libr/cons/pixel.c"
                :0);
   u |= (X[1]?
# 128 "project/radare2/libr/cons/pixel.c" 3 4
             32
# 128 "project/radare2/libr/cons/pixel.c"
                :0);
   X = p->buf + (x + ((y + 3) * p->w));
   u |= (X[0]?
# 130 "project/radare2/libr/cons/pixel.c" 3 4
             (1 << 8)
# 130 "project/radare2/libr/cons/pixel.c"
                :0);
   u |= (X[1]?
# 131 "project/radare2/libr/cons/pixel.c" 3 4
             (2 << 8)
# 131 "project/radare2/libr/cons/pixel.c"
                :0);
...
# 140 "project/radare2/libr/cons/pixel.c" 3 4
__attribute__((visibility("default"))) 
# 140 "project/radare2/libr/cons/pixel.c"
     void r_cons_pixel_flush(RConsPixel *p, int sx, int sy) {
 
# 141 "project/radare2/libr/cons/pixel.c" 3 4
do { if (!(
# 141 "project/radare2/libr/cons/pixel.c"
p
# 141 "project/radare2/libr/cons/pixel.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 141 "project/radare2/libr/cons/pixel.c"
...
# 146 "project/radare2/libr/cons/pixel.c" 3 4
  unsigned char 
# 146 "project/radare2/libr/cons/pixel.c"
      *X = p->buf + (x + (y * p->w));
   int u = 0;
   u |= (X[0]?
# 148 "project/radare2/libr/cons/pixel.c" 3 4
             1
# 148 "project/radare2/libr/cons/pixel.c"
                :0);
   u |= (X[1]?
# 149 "project/radare2/libr/cons/pixel.c" 3 4
             8
# 149 "project/radare2/libr/cons/pixel.c"
                :0);
   X = p->buf + (x + ((y + 1) * p->w));
   u |= (X[0]?
# 151 "project/radare2/libr/cons/pixel.c" 3 4
             2
# 151 "project/radare2/libr/cons/pixel.c"
                :0);
   u |= (X[1]?
# 152 "project/radare2/libr/cons/pixel.c" 3 4
             16
# 152 "project/radare2/libr/cons/pixel.c"
                :0);
   X = p->buf + (x + ((y + 2) * p->w));
   u |= (X[0]?
# 154 "project/radare2/libr/cons/pixel.c" 3 4
             4
# 154 "project/radare2/libr/cons/pixel.c"
                :0);
   u |= (X[1]?
# 155 "project/radare2/libr/cons/pixel.c" 3 4
             32
# 155 "project/radare2/libr/cons/pixel.c"
                :0);
   X = p->buf + (x + ((y + 3) * p->w));
   u |= (X[0]?
# 157 "project/radare2/libr/cons/pixel.c" 3 4
             (1 << 8)
# 157 "project/radare2/libr/cons/pixel.c"
                :0);
   u |= (X[1]?
# 158 "project/radare2/libr/cons/pixel.c" 3 4
             (2 << 8)
# 158 "project/radare2/libr/cons/pixel.c"
                :0);
   if (u) {
    RBraile b = r_print_braile (u);
    int px = sx + (x / 2);
...
# 167 "project/radare2/libr/cons/pixel.c" 3 4
     r_cons_strcat (
# 167 "project/radare2/libr/cons/pixel.c"
     b.str
# 167 "project/radare2/libr/cons/pixel.c" 3 4
     )
# 167 "project/radare2/libr/cons/pixel.c"
