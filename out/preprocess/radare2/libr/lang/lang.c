# 0 "project/radare2/libr/lang/lang.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/lang/lang.c"
...
typedef int RRef;
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_lang.h" 2 3 4
...
# 6 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_lang.h" 2 3 4
...
# 4 "project/radare2/libr/lang/lang.c" 2
...
# 5 "project/radare2/libr/lang/lang.c" 2

__attribute__((visibility("default"))) const char *
# 6 "project/radare2/libr/lang/lang.c"
r_lang_version
# 6 "project/radare2/libr/lang/lang.c" 3 4
(void) { return "" "5.5.4"; }
# 6 "project/radare2/libr/lang/lang.c"
                    ;

# 1 "project/radare2/libr/lang/p/spp.c" 1
...
# 4 "project/radare2/libr/lang/p/spp.c" 2
...
# 5 "project/radare2/libr/lang/p/spp.c" 2




# 8 "project/radare2/libr/lang/p/spp.c"
static RLang *Glang = 
# 8 "project/radare2/libr/lang/p/spp.c" 3 4
                     ((void *)0)
# 8 "project/radare2/libr/lang/p/spp.c"
                         ;


# 1 "project/radare2/libr/lang/p/../../../shlr/spp/spp.h" 1
# 9 "project/radare2/libr/lang/p/../../../shlr/spp/spp.h"
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/errno.h" 1 3 4
# 10 "project/radare2/libr/lang/p/../../../shlr/spp/spp.h" 2
# 94 "project/radare2/libr/lang/p/../../../shlr/spp/spp.h"
typedef struct {
 RStrBuf *cout;
 FILE *fout;
 int size;
...
# 12 "project/radare2/libr/lang/p/spp.c" 2
# 1 "project/radare2/libr/lang/p/spp_r2.inc" 1
...
static int spp_r2_set (SppState *state, Output *out, char *buf) {
 char *eq, *val = "";
 ...
 if (spp_r2_var_set (buf, val) == -1) {
  fprintf (
# 32 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
          __stderrp
# 32 "project/radare2/libr/lang/p/spp_r2.inc"
                , "Invalid variable name '%s' at line %d\n", buf, state->lineno);
 }
 return 0;
}

static int spp_r2_get (SppState *state, Output *out, char *buf) {
 if (!state->echo[state->ifl]) {
  return 0;
 }
...
static int spp_r2_getrandom (SppState *state, Output *out, char *buf) {
 if (!state->echo[state->ifl]) {
  return 0;
 }
...
static int spp_r2_add (SppState *state, Output *out, char *buf) {
 char *eq = strchr (buf, ' ');
 int ret = 0;
 if (!state->echo[state->ifl]) {
  return 0;
...
# 77 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
 __builtin___snprintf_chk (
# 77 "project/radare2/libr/lang/p/spp_r2.inc"
 res
# 77 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
 , 
# 77 "project/radare2/libr/lang/p/spp_r2.inc"
...
# 81 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
 fprintf(__stderrp,
# 81 "project/radare2/libr/lang/p/spp_r2.inc"
 "/* syntax error */\n"
# 81 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
 )
# 81 "project/radare2/libr/lang/p/spp_r2.inc"
...
static int spp_r2_sub (SppState *state, Output *out, char *buf) {
 char *eq = strchr (buf, ' ');
 char *var;
 int ret = 0;
 if (!state->echo[state->ifl]) {
...
static int spp_r2_trace (SppState *state, Output *out, char *buf) {
 if (state->echo[state->ifl]) {
  fprintf (
# 107 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
          __stderrp
# 107 "project/radare2/libr/lang/p/spp_r2.inc"
                , "%.1000s\n", buf);
 }
 return 0;
}
...
static int spp_r2_echo (SppState *state, Output *out, char *buf) {
 if (state->echo[state->ifl]) {
  r_cons_printf ("%s", buf);
 }
...
static int spp_r2_error (SppState *state, Output *out, char *buf) {
 if (!state->echo[state->ifl]) {
  return 0;
 }
 fprintf (
# 125 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
         __stderrp
# 125 "project/radare2/libr/lang/p/spp_r2.inc"
               , "ERROR: %s (line=%d)\n", buf, state->lineno);
 return -1;
}

static int spp_r2_warning (SppState *state, Output *out, char *buf) {
 if (!state->echo[state->ifl]) {
  return 0;
 }
 fprintf (
# 133 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
         __stderrp
# 133 "project/radare2/libr/lang/p/spp_r2.inc"
               , "WARNING: %s (line=%d)\n", buf, state->lineno);
 return 0;
}

static int spp_r2_r2 (SppState *state, Output *out, char *buf) {
...
static int spp_r2_system (SppState *state, Output *out, char *buf) {
 if (!state->echo[state->ifl]) {
  return 0;
 }
 char *str = r_sys_cmd_str (buf, 
# 150 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
                                ((void *)0)
# 150 "project/radare2/libr/lang/p/spp_r2.inc"
                                    , 
# 150 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
                                      ((void *)0)
# 150 "project/radare2/libr/lang/p/spp_r2.inc"
...
static int spp_r2_include (SppState *state, Output *out, char *buf) {
 if (!state->echo[state->ifl]) {
  return 0;
 }
...
# 171 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
  __builtin___strcat_chk (
# 171 "project/radare2/libr/lang/p/spp_r2.inc"
  b
# 171 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
  , 
# 171 "project/radare2/libr/lang/p/spp_r2.inc"
...
# 172 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
  __builtin___strcat_chk (
# 172 "project/radare2/libr/lang/p/spp_r2.inc"
  b
# 172 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
  , 
# 172 "project/radare2/libr/lang/p/spp_r2.inc"
...
static int spp_r2_if (SppState *state, Output *out, char *buf) {
 char *var = spp_r2_var_get (buf);
...
static int spp_r2_ifeq (SppState *state, Output *out, char *buf) {
 char *value = buf;
 char *eq = strchr (buf, ' ');
 if (eq) {
  *eq = '\0';
...
static int spp_r2_hex (SppState *state, Output *out, char *buf) {
 size_t i;
 for (i = 0; buf[i]; i++) {
...
static int spp_r2_grepline (SppState *state, Output *out, char *buf) {
 FILE *fd;
 char b[1024];
 int line;
...
# 251 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
  fprintf(__stderrp,
# 251 "project/radare2/libr/lang/p/spp_r2.inc"
  "Unable to open '%s'\n", buf
# 251 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
  )
# 251 "project/radare2/libr/lang/p/spp_r2.inc"
...
static int spp_r2_else (SppState *state, Output *out, char *buf) {
 state->echo[state->ifl] = state->echo[state->ifl] ? 0 : 1;
 return 0;
}

static int spp_r2_ifnot (SppState *state, Output *out, char *buf) {
 spp_r2_if (state, out, buf);
 spp_r2_else (state, out, buf);
 return 1;
}

static int spp_r2_ifin (SppState *state, Output *out, char *buf) {
 char *var, *ptr;
 if (!state->echo[state->ifl]) {
  return 1;
 }
...
static int spp_r2_endif (SppState *state, Output *out, char *buf) {
 return -1;
}

static int spp_r2_default (SppState *state, Output *out, char *buf) {
 if (!state->echo[state->ifl]) {
  return 0;
 }
 if (buf[-1] != ';') {
  fprintf (
# 294 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
          __stderrp
# 294 "project/radare2/libr/lang/p/spp_r2.inc"
...
static FILE *spp_r2_pipe_fd = 
# 300 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
                             ((void *)0)
# 300 "project/radare2/libr/lang/p/spp_r2.inc"
                                 ;


static int spp_r2_pipe (SppState *state, Output *out, char *buf) {
...
static char *spp_r2_switch_str = 
# 310 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
                                ((void *)0)
# 310 "project/radare2/libr/lang/p/spp_r2.inc"
                                    ;

static int spp_r2_switch (SppState *state, Output *out, char *buf) {
 char *var = spp_r2_var_get (buf);
 if (var) {
...
static int spp_r2_case (SppState *state, Output *out, char *buf) {
 state->echo[state->ifl] = strcmp (buf, spp_r2_switch_str)?0:1;
 return 0;
}

static int spp_r2_endswitch (SppState *state, Output *out, char *buf) {
 free (spp_r2_switch_str);
 spp_r2_switch_str = 
# 330 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
                    ((void *)0)
# 330 "project/radare2/libr/lang/p/spp_r2.inc"
                        ;
 return -1;
}

static int spp_r2_endpipe (SppState *state, Output *out, char *buf) {
 ...
 do {
  ...
  if (ret + 1024 > outlen) {
   ...
   if (!tstr) {
    fprintf (
# 351 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
            __stderrp
# 351 "project/radare2/libr/lang/p/spp_r2.inc"
                  , "Out of memory.\n");
    break;
   }
   str = tstr;
 ...
 spp_r2_pipe_fd = 
# 362 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
                 ((void *)0)
# 362 "project/radare2/libr/lang/p/spp_r2.inc"
                     ;
 free (str);
...
static int spp_r2_fputs (Output *out, char *buf) {
...
static SppTag spp_r2_tags[] = {
 ...
 { "r2", spp_r2_r2 },
 { 
# 406 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
  ((void *)0)
# 406 "project/radare2/libr/lang/p/spp_r2.inc"
      , spp_r2_default },
 { 
# 407 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
  ((void *)0) 
# 407 "project/radare2/libr/lang/p/spp_r2.inc"
       }
};

static int spp_r2_arg_i (char *arg) {
 r_sys_setenv ("SPP_INCDIR", arg);
 return 0;
}

static int spp_r2_arg_d (char *arg) {
...
static struct Arg spp_r2_args[] = {
 ...
 { 
# 430 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
  ((void *)0) 
# 430 "project/radare2/libr/lang/p/spp_r2.inc"
       }
};

__attribute__ ((visibility ("hidden"))) SppProc spp_r2_proc = {
 .name = "sppr2",
 .tags = (struct Tag **)spp_r2_tags,
 .args = (struct Arg **)spp_r2_args,
 .token = " ",
 .eof = 
# 438 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
       ((void *)0)
# 438 "project/radare2/libr/lang/p/spp_r2.inc"
           ,
 .tag_pre = "{",
 .tag_post = "}",
 .chop = 1,
 .fputs = spp_r2_fputs,
 .multiline = 
# 443 "project/radare2/libr/lang/p/spp_r2.inc" 3 4
             ((void *)0)
# 443 "project/radare2/libr/lang/p/spp_r2.inc"
                 ,
 .default_echo = 1,
 .tag_begin = 0,
};
# 13 "project/radare2/libr/lang/p/spp.c" 2

static 
# 14 "project/radare2/libr/lang/p/spp.c" 3 4
      _Bool 
# 14 "project/radare2/libr/lang/p/spp.c"
           lang_spp_init(RLang *l) {
 Glang = l;
 return 
# 16 "project/radare2/libr/lang/p/spp.c" 3 4
       1
# 16 "project/radare2/libr/lang/p/spp.c"
           ;
}

static 
# 19 "project/radare2/libr/lang/p/spp.c" 3 4
      _Bool 
# 19 "project/radare2/libr/lang/p/spp.c"
           lang_spp_run(RLang *lang, const char *code, int len) {
 Output out;
 out.fout = 
# 21 "project/radare2/libr/lang/p/spp.c" 3 4
           ((void *)0)
# 21 "project/radare2/libr/lang/p/spp.c"
               ;
 out.cout = r_strbuf_new (
# 22 "project/radare2/libr/lang/p/spp.c" 3 4
                         ((void *)0)
# 22 "project/radare2/libr/lang/p/spp.c"
                             );
 r_strbuf_init (out.cout);
 spp_proc_set (&spp_r2_proc, 
# 24 "project/radare2/libr/lang/p/spp.c" 3 4
                            ((void *)0)
# 24 "project/radare2/libr/lang/p/spp.c"
                                , 0);
 char *c = strdup (code);
 spp_eval (c, &out);
 free (c);
 ...
 free (data);
 return 
# 31 "project/radare2/libr/lang/p/spp.c" 3 4
       1
# 31 "project/radare2/libr/lang/p/spp.c"
           ;
}

static 
# 34 "project/radare2/libr/lang/p/spp.c" 3 4
      _Bool 
# 34 "project/radare2/libr/lang/p/spp.c"
           lang_spp_file(RLang *lang, const char *file) {
 size_t len;
...
static RLangPlugin r_lang_plugin_spp = {
 ...
 .example = "Hello {{{r2 ?E Hello world}}}",
 .run = lang_spp_run,
 .init = (void*)lang_spp_init,
 .run_file = (void*)lang_spp_file,
};
# 9 "project/radare2/libr/lang/lang.c" 2

# 1 "project/radare2/libr/lang/p/pipe.c" 1
# 123 "project/radare2/libr/lang/p/pipe.c"
...
static 
# 131 "project/radare2/libr/lang/p/pipe.c" 3 4
      _Bool 
# 131 "project/radare2/libr/lang/p/pipe.c"
           lang_pipe_run(RLang *lang, const char *code, int len) {
...
# 139 "project/radare2/libr/lang/p/pipe.c" 3 4
 fprintf(__stderrp,
# 139 "project/radare2/libr/lang/p/pipe.c"
 "r_lang_pipe: pipe failed on input\n"
# 139 "project/radare2/libr/lang/p/pipe.c" 3 4
 )
# 139 "project/radare2/libr/lang/p/pipe.c"
                                                ;
  ...
  return 
# 143 "project/radare2/libr/lang/p/pipe.c" 3 4
        0
# 143 "project/radare2/libr/lang/p/pipe.c"
             ;
 }
 if (pipe (output) != 0) {
  
# 146 "project/radare2/libr/lang/p/pipe.c" 3 4
 fprintf(__stderrp,
# 146 "project/radare2/libr/lang/p/pipe.c"
 "r_lang_pipe: pipe failed on output\n"
# 146 "project/radare2/libr/lang/p/pipe.c" 3 4
 )
# 146 "project/radare2/libr/lang/p/pipe.c"
                                                 ;
  ...
  return 
# 150 "project/radare2/libr/lang/p/pipe.c" 3 4
        0
# 150 "project/radare2/libr/lang/p/pipe.c"
             ;
 }
 ...
 if (child == -1) {
  ...
  close (output[1]);
  fflush (
# 168 "project/radare2/libr/lang/p/pipe.c" 3 4
         __stdoutp
# 168 "project/radare2/libr/lang/p/pipe.c"
               );
  fflush (
# 169 "project/radare2/libr/lang/p/pipe.c" 3 4
         __stderrp
# 169 "project/radare2/libr/lang/p/pipe.c"
               );
  r_sys_exit (0, 
# 170 "project/radare2/libr/lang/p/pipe.c" 3 4
                1
# 170 "project/radare2/libr/lang/p/pipe.c"
                    );
  return 
# 171 "project/radare2/libr/lang/p/pipe.c" 3 4
        0
# 171 "project/radare2/libr/lang/p/pipe.c"
             ;
 } else {
  ...
  close (input[0]);
  r_cons_break_push (
# 178 "project/radare2/libr/lang/p/pipe.c" 3 4
                    ((void *)0)
# 178 "project/radare2/libr/lang/p/pipe.c"
                        , 
# 178 "project/radare2/libr/lang/p/pipe.c" 3 4
                          ((void *)0)
# 178 "project/radare2/libr/lang/p/pipe.c"
...
# 183 "project/radare2/libr/lang/p/pipe.c" 3 4
  __builtin___memset_chk (
# 183 "project/radare2/libr/lang/p/pipe.c"
  buf
# 183 "project/radare2/libr/lang/p/pipe.c" 3 4
  , 
# 183 "project/radare2/libr/lang/p/pipe.c"
...
# 200 "project/radare2/libr/lang/p/pipe.c" 3 4
   fprintf(__stderrp,
# 200 "project/radare2/libr/lang/p/pipe.c"
   "r_lang_pipe: NULL reply for (%s)\n", buf
# 200 "project/radare2/libr/lang/p/pipe.c" 3 4
   )
# 200 "project/radare2/libr/lang/p/pipe.c"
                                                      ;
  ...
  if (term_in) {
   safe_in = open (term_in, 
# 212 "project/radare2/libr/lang/p/pipe.c" 3 4
                           0x0000
# 212 "project/radare2/libr/lang/p/pipe.c"
                                   );
   if (safe_in != -1) {
    dup2 (safe_in, 0);
   } else {
    
# 216 "project/radare2/libr/lang/p/pipe.c" 3 4
   fprintf(__stderrp,
# 216 "project/radare2/libr/lang/p/pipe.c"
...
# 216 "project/radare2/libr/lang/p/pipe.c"
 ...
 waitpid (child, 
# 229 "project/radare2/libr/lang/p/pipe.c" 3 4
                ((void *)0)
# 229 "project/radare2/libr/lang/p/pipe.c"
                    , 
# 229 "project/radare2/libr/lang/p/pipe.c" 3 4
                      0x00000001
# 229 "project/radare2/libr/lang/p/pipe.c"
 ...
 return 
# 231 "project/radare2/libr/lang/p/pipe.c" 3 4
       1
# 231 "project/radare2/libr/lang/p/pipe.c"
           ;
# 295 "project/radare2/libr/lang/p/pipe.c"
}

static 
# 297 "project/radare2/libr/lang/p/pipe.c" 3 4
      _Bool 
# 297 "project/radare2/libr/lang/p/pipe.c"
           lang_pipe_file(RLang *lang, const char *file) {
...
# 11 "project/radare2/libr/lang/lang.c" 2
# 1 "project/radare2/libr/lang/p/c.c" 1
# 10 "project/radare2/libr/lang/p/c.c"
static int ac = 0;
static const char **av = 
# 11 "project/radare2/libr/lang/p/c.c" 3 4
                        ((void *)0)
# 11 "project/radare2/libr/lang/p/c.c"
                            ;

static 
# 13 "project/radare2/libr/lang/p/c.c" 3 4
      _Bool 
# 13 "project/radare2/libr/lang/p/c.c"
           lang_c_set_argv(RLang *lang, int argc, const char **argv) {
 ac = argc;
 av = argv;
 return 
# 16 "project/radare2/libr/lang/p/c.c" 3 4
       1
# 16 "project/radare2/libr/lang/p/c.c"
           ;
}
...
static int lang_c_file(RLang *lang, const char *file) {
 ...
 if (strlen (file) > (sizeof (name) - 10)) {
  return 
# 25 "project/radare2/libr/lang/p/c.c" 3 4
        0
# 25 "project/radare2/libr/lang/p/c.c"
             ;
 }
 if (!strstr (file, ".c")) {
  
# 28 "project/radare2/libr/lang/p/c.c" 3 4
 __builtin___sprintf_chk (
# 28 "project/radare2/libr/lang/p/c.c"
 name
# 28 "project/radare2/libr/lang/p/c.c" 3 4
 , 0, __builtin_object_size (
# 28 "project/radare2/libr/lang/p/c.c"
...
# 30 "project/radare2/libr/lang/p/c.c" 3 4
 __builtin___strcpy_chk (
# 30 "project/radare2/libr/lang/p/c.c"
 name
# 30 "project/radare2/libr/lang/p/c.c" 3 4
 , 
# 30 "project/radare2/libr/lang/p/c.c"
...
# 33 "project/radare2/libr/lang/p/c.c" 3 4
 fprintf(__stderrp,
# 33 "project/radare2/libr/lang/p/c.c"
 "file not found (%s)\n", name
# 33 "project/radare2/libr/lang/p/c.c" 3 4
 )
# 33 "project/radare2/libr/lang/p/c.c"
                                        ;
  return 
# 34 "project/radare2/libr/lang/p/c.c" 3 4
        0
# 34 "project/radare2/libr/lang/p/c.c"
             ;
 }
 ...
 cc = r_sys_getenv ("CC");
 if (
# 51 "project/radare2/libr/lang/p/c.c" 3 4
    (!(
# 51 "project/radare2/libr/lang/p/c.c"
    cc
# 51 "project/radare2/libr/lang/p/c.c" 3 4
    ) || !*(
# 51 "project/radare2/libr/lang/p/c.c"
...
# 51 "project/radare2/libr/lang/p/c.c"
 ...
 char *buf = r_str_newf ("%s -fPIC -shared \"%s\" -o \"%s/lib%s." 
# 57 "project/radare2/libr/lang/p/c.c" 3 4
                                                                 "dylib" 
# 57 "project/radare2/libr/lang/p/c.c"
                                                                           "\""
  " $(PKG_CONFIG_PATH=%s pkg-config --cflags --libs r_core)",
  cc, file_esc, libpath_esc, libname_esc, 
# 59 "project/radare2/libr/lang/p/c.c" 3 4
                                         "/usr/local/lib" 
# 59 "project/radare2/libr/lang/p/c.c"
                                                   "/pkgconfig");
 free (libname_esc);
 free (libpath_esc);
 free (file_esc);
 ...
 if (r_sandbox_system (buf, 1) != 0) {
  free (buf);
  return 
# 66 "project/radare2/libr/lang/p/c.c" 3 4
        0
# 66 "project/radare2/libr/lang/p/c.c"
             ;
 }
 free (buf);
 buf = r_str_newf ("%s/lib%s."
# 69 "project/radare2/libr/lang/p/c.c" 3 4
                             "dylib"
# 69 "project/radare2/libr/lang/p/c.c"
                                      , libpath, libname);
 ...
 if (lib) {
  ...
  if (fcn) {
   ...
   ac = 0;
   av = 
# 77 "project/radare2/libr/lang/p/c.c" 3 4
       ((void *)0)
# 77 "project/radare2/libr/lang/p/c.c"
           ;
  } else {
   
# 79 "project/radare2/libr/lang/p/c.c" 3 4
  fprintf(__stderrp,
# 79 "project/radare2/libr/lang/p/c.c"
...
# 83 "project/radare2/libr/lang/p/c.c" 3 4
 fprintf(__stderrp,
# 83 "project/radare2/libr/lang/p/c.c"
 "Cannot open library\n"
# 83 "project/radare2/libr/lang/p/c.c" 3 4
 )
# 83 "project/radare2/libr/lang/p/c.c"
...
static int lang_c_init(void *user) {
 ...
 return 
# 92 "project/radare2/libr/lang/p/c.c" 3 4
       1
# 92 "project/radare2/libr/lang/p/c.c"
           ;
}

static 
# 95 "project/radare2/libr/lang/p/c.c" 3 4
      _Bool 
# 95 "project/radare2/libr/lang/p/c.c"
           lang_c_run(RLang *lang, const char *code, int len) {
 FILE *fd = r_sandbox_fopen (".tmp.c", "w");
 if (!fd) {
  
# 98 "project/radare2/libr/lang/p/c.c" 3 4
 fprintf(__stderrp,
# 98 "project/radare2/libr/lang/p/c.c"
 "Cannot open .tmp.c\n"
# 98 "project/radare2/libr/lang/p/c.c" 3 4
 )
# 98 "project/radare2/libr/lang/p/c.c"
                                 ;
  return 
# 99 "project/radare2/libr/lang/p/c.c" 3 4
        0
# 99 "project/radare2/libr/lang/p/c.c"
             ;
 }
 ...
 r_file_rm (".tmp.c");
 return 
# 107 "project/radare2/libr/lang/p/c.c" 3 4
       1
# 107 "project/radare2/libr/lang/p/c.c"
           ;
}
# 119 "project/radare2/libr/lang/p/c.c"
static RLangPlugin r_lang_plugin_c = {
 .name = "c",
 .ext = "c",
 .desc = "C language extension",
 .license = "LGPL",
 .example = "" "#include <r_core.h>\n" "\nvoid entry(RCore *core, int argc, const char **argv) {\n" "    char *s = r_core_cmd_str (core, \"?E hello world\");\n" "    printf(\"%s\", s);\n" "    free (s);\n" "}\n" "",
 .run = lang_c_run,
 .init = (void*)lang_c_init,
 .run_file = (void*)lang_c_file,
 .set_argv = (void*)lang_c_set_argv,
};
# 12 "project/radare2/libr/lang/lang.c" 2
# 1 "project/radare2/libr/lang/p/v.c" 1
...
static 
# 9 "project/radare2/libr/lang/p/v.c" 3 4
      _Bool 
# 9 "project/radare2/libr/lang/p/v.c"
           lang_v_file(RLang *lang, const char *file);
...
static void runlib(void *user, const char *lib) {
 ...
 if (vl) {
  ...
  if (fcn) {
   fcn (user, 0, 
# 101 "project/radare2/libr/lang/p/v.c" 3 4
                ((void *)0)
# 101 "project/radare2/libr/lang/p/v.c"
                    );
  } else {
   
# 103 "project/radare2/libr/lang/p/v.c" 3 4
  fprintf(__stderrp,
# 103 "project/radare2/libr/lang/p/v.c"
  "Cannot find '%s' symbol in library\n", r2v_sym
# 103 "project/radare2/libr/lang/p/v.c" 3 4
  )
# 103 "project/radare2/libr/lang/p/v.c"
                                                           ;
...
# 107 "project/radare2/libr/lang/p/v.c" 3 4
 fprintf(__stderrp,
# 107 "project/radare2/libr/lang/p/v.c"
...
static 
# 111 "project/radare2/libr/lang/p/v.c" 3 4
      _Bool 
# 111 "project/radare2/libr/lang/p/v.c"
           __run(RLang *lang, const char *code, int len) {
 r_file_rm (".tmp.v");
 ...
 if (fd) {
  ...
  r_sandbox_system ("v -gc boehm -shared -o .tmp.v."
# 129 "project/radare2/libr/lang/p/v.c" 3 4
                                                   "dylib"
# 129 "project/radare2/libr/lang/p/v.c"
                                                            " .tmp.v", 1);


  vcode_fini (&vcode);
  return 
# 133 "project/radare2/libr/lang/p/v.c" 3 4
        1
# 133 "project/radare2/libr/lang/p/v.c"
            ;
 }
 
# 135 "project/radare2/libr/lang/p/v.c" 3 4
fprintf(__stderrp,
# 135 "project/radare2/libr/lang/p/v.c"
"Cannot open .tmp.v\n"
# 135 "project/radare2/libr/lang/p/v.c" 3 4
)
# 135 "project/radare2/libr/lang/p/v.c"
                                ;
 return 
# 136 "project/radare2/libr/lang/p/v.c" 3 4
       0
# 136 "project/radare2/libr/lang/p/v.c"
            ;
}

static 
# 139 "project/radare2/libr/lang/p/v.c" 3 4
      _Bool 
# 139 "project/radare2/libr/lang/p/v.c"
           lang_v_file(RLang *lang, const char *file) {
 if (!lang || 
# 140 "project/radare2/libr/lang/p/v.c" 3 4
             (!(
# 140 "project/radare2/libr/lang/p/v.c"
             file
# 140 "project/radare2/libr/lang/p/v.c" 3 4
             ) || !*(
# 140 "project/radare2/libr/lang/p/v.c"
...
# 140 "project/radare2/libr/lang/p/v.c"
  ...
  return 
# 141 "project/radare2/libr/lang/p/v.c" 3 4
        0
# 141 "project/radare2/libr/lang/p/v.c"
             ;
 }
 if (!r_str_endswith (file, ".v")) {
  return 
# 144 "project/radare2/libr/lang/p/v.c" 3 4
        0
# 144 "project/radare2/libr/lang/p/v.c"
             ;
 }
 if (strcmp (file, ".tmp.v")) {
  char *code = r_file_slurp (file, 
# 147 "project/radare2/libr/lang/p/v.c" 3 4
                                  ((void *)0)
# 147 "project/radare2/libr/lang/p/v.c"
                                      );
  
# 148 "project/radare2/libr/lang/p/v.c" 3 4
 _Bool 
# 148 "project/radare2/libr/lang/p/v.c"
      r = __run (lang, code, -1);
  free (code);
  return r;
 }
...
# 153 "project/radare2/libr/lang/p/v.c" 3 4
 fprintf(__stderrp,
# 153 "project/radare2/libr/lang/p/v.c"
 "file not found (%s)\n", file
# 153 "project/radare2/libr/lang/p/v.c" 3 4
 )
# 153 "project/radare2/libr/lang/p/v.c"
                                        ;
  return 
# 154 "project/radare2/libr/lang/p/v.c" 3 4
        0
# 154 "project/radare2/libr/lang/p/v.c"
             ;
 }
 r_sys_setenv ("PKG_CONFIG_PATH", 
# 156 "project/radare2/libr/lang/p/v.c" 3 4
                                 "/usr/local/lib"
# 156 "project/radare2/libr/lang/p/v.c"
                                          "/pkgconfig");
 char *lib = r_str_replace (strdup (file), ".v", "."
# 157 "project/radare2/libr/lang/p/v.c" 3 4
                                                   "dylib"
# 157 "project/radare2/libr/lang/p/v.c"
                                                            , 1);
 ...
 if (r_sandbox_system (buf, 1) != 0) {
  ...
  free (lib);
  return 
# 162 "project/radare2/libr/lang/p/v.c" 3 4
        0
# 162 "project/radare2/libr/lang/p/v.c"
             ;
 }
 free (buf);
...
static 
# 171 "project/radare2/libr/lang/p/v.c" 3 4
      _Bool 
# 171 "project/radare2/libr/lang/p/v.c"
           lang_v_run(RLang *lang, const char *code, int len) {
...
# 13 "project/radare2/libr/lang/lang.c" 2
# 1 "project/radare2/libr/lang/p/vala.c" 1
# 9 "project/radare2/libr/lang/p/vala.c"
static 
# 9 "project/radare2/libr/lang/p/vala.c" 3 4
      _Bool 
# 9 "project/radare2/libr/lang/p/vala.c"
           lang_vala_file(RLang *lang, const char *file, 
# 9 "project/radare2/libr/lang/p/vala.c" 3 4
                                                         _Bool 
# 9 "project/radare2/libr/lang/p/vala.c"
                                                              silent) {
 ...
 if (strlen (file) > 500) {
  return 
# 16 "project/radare2/libr/lang/p/vala.c" 3 4
        0
# 16 "project/radare2/libr/lang/p/vala.c"
             ;
 }
 if (!strstr (file, ".vala")) {
  
# 19 "project/radare2/libr/lang/p/vala.c" 3 4
 __builtin___sprintf_chk (
# 19 "project/radare2/libr/lang/p/vala.c"
 name
# 19 "project/radare2/libr/lang/p/vala.c" 3 4
 , 0, __builtin_object_size (
# 19 "project/radare2/libr/lang/p/vala.c"
...
# 21 "project/radare2/libr/lang/p/vala.c" 3 4
 __builtin___strcpy_chk (
# 21 "project/radare2/libr/lang/p/vala.c"
 name
# 21 "project/radare2/libr/lang/p/vala.c" 3 4
 , 
# 21 "project/radare2/libr/lang/p/vala.c"
...
# 24 "project/radare2/libr/lang/p/vala.c" 3 4
 fprintf(__stderrp,
# 24 "project/radare2/libr/lang/p/vala.c"
 "file not found (%s)\n", name
# 24 "project/radare2/libr/lang/p/vala.c" 3 4
 )
# 24 "project/radare2/libr/lang/p/vala.c"
                                        ;
  return 
# 25 "project/radare2/libr/lang/p/vala.c" 3 4
        0
# 25 "project/radare2/libr/lang/p/vala.c"
             ;
 }
...
# 34 "project/radare2/libr/lang/p/vala.c" 3 4
  __builtin___strcpy_chk (
# 34 "project/radare2/libr/lang/p/vala.c"
  srcdir
# 34 "project/radare2/libr/lang/p/vala.c" 3 4
  , 
# 34 "project/radare2/libr/lang/p/vala.c"
...
# 38 "project/radare2/libr/lang/p/vala.c" 3 4
 __builtin___strcpy_chk (
# 38 "project/radare2/libr/lang/p/vala.c"
 srcdir
# 38 "project/radare2/libr/lang/p/vala.c" 3 4
 , 
# 38 "project/radare2/libr/lang/p/vala.c"
...
# 38 "project/radare2/libr/lang/p/vala.c"
 ...
 r_sys_setenv ("PKG_CONFIG_PATH", 
# 40 "project/radare2/libr/lang/p/vala.c" 3 4
                                 "/usr/local/lib"
# 40 "project/radare2/libr/lang/p/vala.c"
                                          "/pkgconfig");
 vapidir = r_sys_getenv ("VAPIDIR");
 char *tail = silent? " > /dev/null 2>&1": "";
 char *src = r_file_slurp (name, 
# 43 "project/radare2/libr/lang/p/vala.c" 3 4
                                ((void *)0)
# 43 "project/radare2/libr/lang/p/vala.c"
                                    );
 const char *pkgs = "";
 const char *libs = "";
 if (src) {
 ...
 if (vapidir) {
  if (*vapidir) {
   len = 
# 56 "project/radare2/libr/lang/p/vala.c" 3 4
        __builtin___snprintf_chk (
# 56 "project/radare2/libr/lang/p/vala.c"
        buf
# 56 "project/radare2/libr/lang/p/vala.c" 3 4
        , 
# 56 "project/radare2/libr/lang/p/vala.c"
...
# 56 "project/radare2/libr/lang/p/vala.c" 3 4
        , 2 > 1 ? 1 : 0), 
# 56 "project/radare2/libr/lang/p/vala.c"
        "valac --disable-warnings -d %s --vapidir=%s --pkg r_core %s -C %s %s", srcdir, vapidir, pkgs, name, tail
# 56 "project/radare2/libr/lang/p/vala.c" 3 4
        )
                                      
# 57 "project/radare2/libr/lang/p/vala.c"
                                     ;
   if (len >= sizeof (buf)) {
    free (vapidir);
    free (srcdir);
    free (libname);
    return 
# 62 "project/radare2/libr/lang/p/vala.c" 3 4
          0
# 62 "project/radare2/libr/lang/p/vala.c"
               ;
   }
  }
  free (vapidir);
  ...
  len = 
# 67 "project/radare2/libr/lang/p/vala.c" 3 4
       __builtin___snprintf_chk (
# 67 "project/radare2/libr/lang/p/vala.c"
       buf
# 67 "project/radare2/libr/lang/p/vala.c" 3 4
       , 
# 67 "project/radare2/libr/lang/p/vala.c"
...
# 67 "project/radare2/libr/lang/p/vala.c" 3 4
       , 2 > 1 ? 1 : 0), 
# 67 "project/radare2/libr/lang/p/vala.c"
       "valac --disable-warnings -d %s %s --pkg r_core -C %s %s", srcdir, pkgs, name, tail
# 67 "project/radare2/libr/lang/p/vala.c" 3 4
       )
# 67 "project/radare2/libr/lang/p/vala.c"
                                                                                                                            ;
  if (len >= sizeof (buf)) {
   ...
   free (libname);
   return 
# 71 "project/radare2/libr/lang/p/vala.c" 3 4
         0
# 71 "project/radare2/libr/lang/p/vala.c"
              ;
  }
 }
 free (srcdir);
 if (r_sandbox_system (buf, 1) != 0) {
  free (libname);
  return 
# 77 "project/radare2/libr/lang/p/vala.c" 3 4
        0
# 77 "project/radare2/libr/lang/p/vala.c"
             ;
 }
 p = strstr (name, ".vala");
 if (p) {
 ...
 len = 
# 88 "project/radare2/libr/lang/p/vala.c" 3 4
      __builtin___snprintf_chk (
# 88 "project/radare2/libr/lang/p/vala.c"
      buf
# 88 "project/radare2/libr/lang/p/vala.c" 3 4
      , 
# 88 "project/radare2/libr/lang/p/vala.c"
...
# 89 "project/radare2/libr/lang/p/vala.c"
                                                                             ;
 if (len >= sizeof (buf) || r_sandbox_system (buf, 1) != 0) {
  free (libname);
  return 
# 92 "project/radare2/libr/lang/p/vala.c" 3 4
        0
# 92 "project/radare2/libr/lang/p/vala.c"
             ;
 }

 len = 
# 95 "project/radare2/libr/lang/p/vala.c" 3 4
      __builtin___snprintf_chk (
# 95 "project/radare2/libr/lang/p/vala.c"
      buf
# 95 "project/radare2/libr/lang/p/vala.c" 3 4
      , 
# 95 "project/radare2/libr/lang/p/vala.c"
...
# 95 "project/radare2/libr/lang/p/vala.c"
 ...
 if (len >= sizeof (buf)) {
  return 
# 98 "project/radare2/libr/lang/p/vala.c" 3 4
        0
# 98 "project/radare2/libr/lang/p/vala.c"
             ;
 }
...
# 108 "project/radare2/libr/lang/p/vala.c" 3 4
  fprintf(__stderrp,
# 108 "project/radare2/libr/lang/p/vala.c"
  "Cannot find 'entry' symbol in library\n"
# 108 "project/radare2/libr/lang/p/vala.c" 3 4
  )
# 108 "project/radare2/libr/lang/p/vala.c"
...
# 112 "project/radare2/libr/lang/p/vala.c" 3 4
 fprintf(__stderrp,
# 112 "project/radare2/libr/lang/p/vala.c"
 "Cannot open library\n"
# 112 "project/radare2/libr/lang/p/vala.c" 3 4
 )
# 112 "project/radare2/libr/lang/p/vala.c"
 ...
 r_file_rm (buf);
 len = 
# 115 "project/radare2/libr/lang/p/vala.c" 3 4
      __builtin___snprintf_chk (
# 115 "project/radare2/libr/lang/p/vala.c"
      buf
# 115 "project/radare2/libr/lang/p/vala.c" 3 4
      , 
# 115 "project/radare2/libr/lang/p/vala.c"
...
# 115 "project/radare2/libr/lang/p/vala.c"
 ...
 if (len >= sizeof (buf)) {
  return 
# 117 "project/radare2/libr/lang/p/vala.c" 3 4
        0
# 117 "project/radare2/libr/lang/p/vala.c"
             ;
 }
...
static 
# 124 "project/radare2/libr/lang/p/vala.c" 3 4
      _Bool 
# 124 "project/radare2/libr/lang/p/vala.c"
           vala_run_file(RLang *lang, const char *file) {
 return lang_vala_file(lang, file, 
# 125 "project/radare2/libr/lang/p/vala.c" 3 4
                                  0
# 125 "project/radare2/libr/lang/p/vala.c"
                                       );
}

static 
# 128 "project/radare2/libr/lang/p/vala.c" 3 4
      _Bool 
# 128 "project/radare2/libr/lang/p/vala.c"
           lang_vala_init(void *user) {

 return 
# 130 "project/radare2/libr/lang/p/vala.c" 3 4
       1
# 130 "project/radare2/libr/lang/p/vala.c"
           ;
}

static 
# 133 "project/radare2/libr/lang/p/vala.c" 3 4
      _Bool 
# 133 "project/radare2/libr/lang/p/vala.c"
           lang_vala_run(RLang *lang, const char *code, int len) {
 
# 134 "project/radare2/libr/lang/p/vala.c" 3 4
_Bool 
# 134 "project/radare2/libr/lang/p/vala.c"
     silent = !strncmp (code, "-s", 2);
 ...
 if (fd) {
  ...
  r_file_rm (".tmp.vala");
  return 
# 146 "project/radare2/libr/lang/p/vala.c" 3 4
        1
# 146 "project/radare2/libr/lang/p/vala.c"
            ;
 }
 
# 148 "project/radare2/libr/lang/p/vala.c" 3 4
fprintf(__stderrp,
# 148 "project/radare2/libr/lang/p/vala.c"
"Cannot open .tmp.vala\n"
# 148 "project/radare2/libr/lang/p/vala.c" 3 4
)
# 148 "project/radare2/libr/lang/p/vala.c"
                                   ;
 return 
# 149 "project/radare2/libr/lang/p/vala.c" 3 4
       0
# 149 "project/radare2/libr/lang/p/vala.c"
            ;
}
...
# 14 "project/radare2/libr/lang/lang.c" 2
# 1 "project/radare2/libr/lang/p/rust.c" 1
...
static int lang_rust_file(RLang *lang, const char *file) {
 ...
 if (strlen (file) > (sizeof (name) - 10)) {
  return 
# 13 "project/radare2/libr/lang/p/rust.c" 3 4
        0
# 13 "project/radare2/libr/lang/p/rust.c"
             ;
 }
 if (!strstr (file, ".rs")) {
  
# 16 "project/radare2/libr/lang/p/rust.c" 3 4
 __builtin___sprintf_chk (
# 16 "project/radare2/libr/lang/p/rust.c"
 name
# 16 "project/radare2/libr/lang/p/rust.c" 3 4
 , 0, __builtin_object_size (
# 16 "project/radare2/libr/lang/p/rust.c"
...
# 18 "project/radare2/libr/lang/p/rust.c" 3 4
 __builtin___strcpy_chk (
# 18 "project/radare2/libr/lang/p/rust.c"
 name
# 18 "project/radare2/libr/lang/p/rust.c" 3 4
 , 
# 18 "project/radare2/libr/lang/p/rust.c"
...
# 21 "project/radare2/libr/lang/p/rust.c" 3 4
 fprintf(__stderrp,
# 21 "project/radare2/libr/lang/p/rust.c"
 "file not found (%s)\n", name
# 21 "project/radare2/libr/lang/p/rust.c" 3 4
 )
# 21 "project/radare2/libr/lang/p/rust.c"
                                        ;
  return 
# 22 "project/radare2/libr/lang/p/rust.c" 3 4
        0
# 22 "project/radare2/libr/lang/p/rust.c"
             ;
 }
 ...
 r_sys_setenv ("PKG_CONFIG_PATH", 
# 34 "project/radare2/libr/lang/p/rust.c" 3 4
                                 "/usr/local/lib"
# 34 "project/radare2/libr/lang/p/rust.c"
                                          "/pkgconfig");
 p = strstr (name, ".rs"); if (p) *p=0;
 cc = r_sys_getenv ("RUSTC");
 if (cc && !*cc) {
  
# 38 "project/radare2/libr/lang/p/rust.c" 3 4
 { free((void *)
# 38 "project/radare2/libr/lang/p/rust.c"
 cc
# 38 "project/radare2/libr/lang/p/rust.c" 3 4
 ); 
# 38 "project/radare2/libr/lang/p/rust.c"
...
# 38 "project/radare2/libr/lang/p/rust.c"
 ...
 char *cmd = r_str_newf ("%s --crate-type dylib %s -o %s/lib%s."
# 43 "project/radare2/libr/lang/p/rust.c" 3 4
                                                               "dylib"
# 43 "project/radare2/libr/lang/p/rust.c"
                                                                        " -L native=/usr/local/lib/ -l r_core",
  cc, file, libpath, libname);
 free (cc);
 if (r_sandbox_system (cmd, 1) != 0) {
  free (cmd);
  return 
# 48 "project/radare2/libr/lang/p/rust.c" 3 4
        0
# 48 "project/radare2/libr/lang/p/rust.c"
             ;
 }
 free (cmd);

 char *path = r_str_newf ("%s/lib%s."
# 52 "project/radare2/libr/lang/p/rust.c" 3 4
                                    "dylib"
# 52 "project/radare2/libr/lang/p/rust.c"
                                             , libpath, libname);
 lib = r_lib_dl_open (path);
 if (lib!= 
# 54 "project/radare2/libr/lang/p/rust.c" 3 4
          ((void *)0)
# 54 "project/radare2/libr/lang/p/rust.c"
              ) {
  void (*fcn)(RCore *);
  fcn = r_lib_dl_sym (lib, "entry");
  if (fcn) fcn (lang->user);
  else 
# 58 "project/radare2/libr/lang/p/rust.c" 3 4
      fprintf(__stderrp,
# 58 "project/radare2/libr/lang/p/rust.c"
      "Cannot find 'entry' symbol in library\n"
# 58 "project/radare2/libr/lang/p/rust.c" 3 4
      )
# 58 "project/radare2/libr/lang/p/rust.c"
...
# 61 "project/radare2/libr/lang/p/rust.c" 3 4
 fprintf(__stderrp,
# 61 "project/radare2/libr/lang/p/rust.c"
 "Cannot open library\n"
# 61 "project/radare2/libr/lang/p/rust.c" 3 4
 )
# 61 "project/radare2/libr/lang/p/rust.c"
...
static int lang_rust_init(void *user) {
 ...
 return 
# 70 "project/radare2/libr/lang/p/rust.c" 3 4
       1
# 70 "project/radare2/libr/lang/p/rust.c"
           ;
}

static 
# 73 "project/radare2/libr/lang/p/rust.c" 3 4
      _Bool 
# 73 "project/radare2/libr/lang/p/rust.c"
           lang_rust_run(RLang *lang, const char *code, int len) {
 FILE *fd = r_sandbox_fopen ("_tmp.rs", "w");
 if (!fd) {
  
# 76 "project/radare2/libr/lang/p/rust.c" 3 4
 fprintf(__stderrp,
# 76 "project/radare2/libr/lang/p/rust.c"
 "Cannot open _tmp.rs\n"
# 76 "project/radare2/libr/lang/p/rust.c" 3 4
 )
# 76 "project/radare2/libr/lang/p/rust.c"
                                  ;
  return 
# 77 "project/radare2/libr/lang/p/rust.c" 3 4
        0
# 77 "project/radare2/libr/lang/p/rust.c"
             ;
 }
 ...
 r_file_rm ("_tmp.rs");
 return 
# 115 "project/radare2/libr/lang/p/rust.c" 3 4
       1
# 115 "project/radare2/libr/lang/p/rust.c"
           ;
}
...
# 15 "project/radare2/libr/lang/lang.c" 2
# 1 "project/radare2/libr/lang/p/zig.c" 1
...
static 
# 7 "project/radare2/libr/lang/p/zig.c" 3 4
      _Bool 
# 7 "project/radare2/libr/lang/p/zig.c"
           lang_zig_file(RLang *lang, const char *file) {
 void *lib;
 char *a, *cc, *p;
 const char *libpath, *libname;
...
# 13 "project/radare2/libr/lang/p/zig.c" 3 4
 fprintf(__stderrp,
# 13 "project/radare2/libr/lang/p/zig.c"
 "file not found (%s)\n", file
# 13 "project/radare2/libr/lang/p/zig.c" 3 4
 )
# 13 "project/radare2/libr/lang/p/zig.c"
                                        ;
  return 
# 14 "project/radare2/libr/lang/p/zig.c" 3 4
        0
# 14 "project/radare2/libr/lang/p/zig.c"
             ;
 }
...
# 33 "project/radare2/libr/lang/p/zig.c" 3 4
 { free((void *)
# 33 "project/radare2/libr/lang/p/zig.c"
 cc
# 33 "project/radare2/libr/lang/p/zig.c" 3 4
 ); 
# 33 "project/radare2/libr/lang/p/zig.c"
...
# 33 "project/radare2/libr/lang/p/zig.c"
 ...
 char *cmd = r_str_newf ("zig build-lib --output %s.%s --release-fast %s.zig --library r_core", name, 
# 38 "project/radare2/libr/lang/p/zig.c" 3 4
                                                                                                     "dylib"
# 38 "project/radare2/libr/lang/p/zig.c"
                                                                                                              , name);
 if (r_sandbox_system (cmd, 1) != 0) {
  free (name);
  free (cmd);
  free (cc);
  return 
# 43 "project/radare2/libr/lang/p/zig.c" 3 4
        0
# 43 "project/radare2/libr/lang/p/zig.c"
             ;
 }
 free (cmd);

 char *path = r_str_newf ("%s/%s.%s", libpath, libname, 
# 47 "project/radare2/libr/lang/p/zig.c" 3 4
                                                       "dylib"
# 47 "project/radare2/libr/lang/p/zig.c"
                                                                );
 lib = r_lib_dl_open (path);
 if (lib) {
  void (*fcn)(RCore *);
...
# 55 "project/radare2/libr/lang/p/zig.c" 3 4
  fprintf(__stderrp,
# 55 "project/radare2/libr/lang/p/zig.c"
  "Cannot find 'entry' symbol in library\n"
# 55 "project/radare2/libr/lang/p/zig.c" 3 4
  )
# 55 "project/radare2/libr/lang/p/zig.c"
...
# 59 "project/radare2/libr/lang/p/zig.c" 3 4
 fprintf(__stderrp,
# 59 "project/radare2/libr/lang/p/zig.c"
 "Cannot open library\n"
# 59 "project/radare2/libr/lang/p/zig.c" 3 4
 )
# 59 "project/radare2/libr/lang/p/zig.c"
  ...
  free (cc);
  return 
# 62 "project/radare2/libr/lang/p/zig.c" 3 4
        0
# 62 "project/radare2/libr/lang/p/zig.c"
             ;
 }
 r_file_rm (path);
 free (path);
 free (cc);
 return 
# 67 "project/radare2/libr/lang/p/zig.c" 3 4
       1
# 67 "project/radare2/libr/lang/p/zig.c"
           ;
}

static 
# 70 "project/radare2/libr/lang/p/zig.c" 3 4
      _Bool 
# 70 "project/radare2/libr/lang/p/zig.c"
           lang_zig_init(void *user) {

 return 
# 72 "project/radare2/libr/lang/p/zig.c" 3 4
       1
# 72 "project/radare2/libr/lang/p/zig.c"
           ;
}

static 
# 75 "project/radare2/libr/lang/p/zig.c" 3 4
      _Bool 
# 75 "project/radare2/libr/lang/p/zig.c"
           lang_zig_run(RLang *lang, const char *code, int len) {
...
# 98 "project/radare2/libr/lang/p/zig.c" 3 4
 fprintf(__stderrp,
# 98 "project/radare2/libr/lang/p/zig.c"
 "Cannot open %s\n", file
# 98 "project/radare2/libr/lang/p/zig.c" 3 4
 )
# 98 "project/radare2/libr/lang/p/zig.c"
 ...
 return 
# 100 "project/radare2/libr/lang/p/zig.c" 3 4
       1
# 100 "project/radare2/libr/lang/p/zig.c"
           ;
}
...
# 16 "project/radare2/libr/lang/lang.c" 2

# 1 "project/radare2/libr/lang/p/cpipe.c" 1
# 10 "project/radare2/libr/lang/p/cpipe.c"
static int lang_cpipe_file(RLang *lang, const char *file) {
 ...
 if (strlen (file) > (sizeof (name)-10)) {
  return 
# 15 "project/radare2/libr/lang/p/cpipe.c" 3 4
        0
# 15 "project/radare2/libr/lang/p/cpipe.c"
             ;
 }
 if (!strstr (file, ".c")) {
  
# 18 "project/radare2/libr/lang/p/cpipe.c" 3 4
 __builtin___sprintf_chk (
# 18 "project/radare2/libr/lang/p/cpipe.c"
 name
# 18 "project/radare2/libr/lang/p/cpipe.c" 3 4
 , 0, __builtin_object_size (
# 18 "project/radare2/libr/lang/p/cpipe.c"
...
# 20 "project/radare2/libr/lang/p/cpipe.c" 3 4
 __builtin___strcpy_chk (
# 20 "project/radare2/libr/lang/p/cpipe.c"
 name
# 20 "project/radare2/libr/lang/p/cpipe.c" 3 4
 , 
# 20 "project/radare2/libr/lang/p/cpipe.c"
...
# 23 "project/radare2/libr/lang/p/cpipe.c" 3 4
 fprintf(__stderrp,
# 23 "project/radare2/libr/lang/p/cpipe.c"
 "file not found (%s)\n", name
# 23 "project/radare2/libr/lang/p/cpipe.c" 3 4
 )
# 23 "project/radare2/libr/lang/p/cpipe.c"
                                        ;
  return 
# 24 "project/radare2/libr/lang/p/cpipe.c" 3 4
        0
# 24 "project/radare2/libr/lang/p/cpipe.c"
             ;
 }
 ...
 cc = r_sys_getenv ("CC");
 if (
# 41 "project/radare2/libr/lang/p/cpipe.c" 3 4
    (!(
# 41 "project/radare2/libr/lang/p/cpipe.c"
    cc
# 41 "project/radare2/libr/lang/p/cpipe.c" 3 4
    ) || !*(
# 41 "project/radare2/libr/lang/p/cpipe.c"
...
# 41 "project/radare2/libr/lang/p/cpipe.c"
 ...
 char *buf = r_str_newf ("%s \"%s\" -o \"%s/bin%s\""
  ...
  cc, file_esc, libpath_esc, libname_esc, 
# 50 "project/radare2/libr/lang/p/cpipe.c" 3 4
                                         "/usr/local/lib" 
# 50 "project/radare2/libr/lang/p/cpipe.c"
                                                   "/pkgconfig");
 free (libname_esc);
 free (libpath_esc);
 free (file_esc);
 ...
 if (r_sandbox_system (buf, 1) == 0) {
  ...
  r_sys_setenv ("LD_LIBRARY_PATH", 
# 57 "project/radare2/libr/lang/p/cpipe.c" 3 4
                                  "/usr/local/lib"
# 57 "project/radare2/libr/lang/p/cpipe.c"
                                           );
...
static int lang_cpipe_init(void *user) {
 ...
 return 
# 71 "project/radare2/libr/lang/p/cpipe.c" 3 4
       1
# 71 "project/radare2/libr/lang/p/cpipe.c"
           ;
}

static 
# 74 "project/radare2/libr/lang/p/cpipe.c" 3 4
      _Bool 
# 74 "project/radare2/libr/lang/p/cpipe.c"
           lang_cpipe_run(RLang *lang, const char *code, int len) {
 FILE *fd = r_sandbox_fopen (".tmp.c", "w");
 if (!fd) {
  
# 77 "project/radare2/libr/lang/p/cpipe.c" 3 4
 fprintf(__stderrp,
# 77 "project/radare2/libr/lang/p/cpipe.c"
 "Cannot open .tmp.c\n"
# 77 "project/radare2/libr/lang/p/cpipe.c" 3 4
 )
# 77 "project/radare2/libr/lang/p/cpipe.c"
                                 ;
  return 
# 78 "project/radare2/libr/lang/p/cpipe.c" 3 4
        0
# 78 "project/radare2/libr/lang/p/cpipe.c"
             ;
 }
 ...
 r_file_rm (".tmp.c");
 return 
# 89 "project/radare2/libr/lang/p/cpipe.c" 3 4
       1
# 89 "project/radare2/libr/lang/p/cpipe.c"
           ;
}
...
static RLangPlugin r_lang_plugin_cpipe = {
 ...
 .fini = 
# 99 "project/radare2/libr/lang/p/cpipe.c" 3 4
        ((void *)0)
# 99 "project/radare2/libr/lang/p/cpipe.c"
            ,
 .run_file = (void*)lang_cpipe_file,
};
# 18 "project/radare2/libr/lang/lang.c" 2


# 1 "project/radare2/libr/lang/p/go.c" 1
...
static 
# 9 "project/radare2/libr/lang/p/go.c" 3 4
      _Bool 
# 9 "project/radare2/libr/lang/p/go.c"
           lang_go_file(RLang *lang, const char *file);
...
static void gorunlib(void *user, const char *lib) {
 ...
 if (vl) {
  ...
  if (fcn) {
   fcn (user, 0, 
# 78 "project/radare2/libr/lang/p/go.c" 3 4
                ((void *)0)
# 78 "project/radare2/libr/lang/p/go.c"
                    );
  } else {
   
# 80 "project/radare2/libr/lang/p/go.c" 3 4
  fprintf(__stderrp,
# 80 "project/radare2/libr/lang/p/go.c"
  "Cannot find '%s' symbol in library.\n", r2go_sym
# 80 "project/radare2/libr/lang/p/go.c" 3 4
  )
# 80 "project/radare2/libr/lang/p/go.c"
...
# 87 "project/radare2/libr/lang/p/go.c" 3 4
 fprintf(__stderrp,
# 87 "project/radare2/libr/lang/p/go.c"
 "Cannot open '%s' library.\n", lib
# 87 "project/radare2/libr/lang/p/go.c" 3 4
 )
# 87 "project/radare2/libr/lang/p/go.c"
...
static 
# 91 "project/radare2/libr/lang/p/go.c" 3 4
      _Bool 
# 91 "project/radare2/libr/lang/p/go.c"
           __gorun(RLang *lang, const char *code, int len) {
...
# 100 "project/radare2/libr/lang/p/go.c" 3 4
 _Bool 
# 100 "project/radare2/libr/lang/p/go.c"
      has_entry = strstr (body, "func entry");
  if (!has_entry) {
   fputs ("//export entry\n", fd);
  ...
  gorunlib (lang->user, "tmp."
# 112 "project/radare2/libr/lang/p/go.c" 3 4
                             "dylib"
# 112 "project/radare2/libr/lang/p/go.c"
                                      );
  r_file_rm ("tmp.go");
  r_file_rm ("tmp."
# 114 "project/radare2/libr/lang/p/go.c" 3 4
                  "dylib"
# 114 "project/radare2/libr/lang/p/go.c"
                           );
  gocode_fini (&gocode);
  return 
# 116 "project/radare2/libr/lang/p/go.c" 3 4
        1
# 116 "project/radare2/libr/lang/p/go.c"
            ;
 }
 
# 118 "project/radare2/libr/lang/p/go.c" 3 4
fprintf(__stderrp,
# 118 "project/radare2/libr/lang/p/go.c"
"Cannot open tmp.go\n"
# 118 "project/radare2/libr/lang/p/go.c" 3 4
)
# 118 "project/radare2/libr/lang/p/go.c"
                                ;
 return 
# 119 "project/radare2/libr/lang/p/go.c" 3 4
       0
# 119 "project/radare2/libr/lang/p/go.c"
            ;
}

static 
# 122 "project/radare2/libr/lang/p/go.c" 3 4
      _Bool 
# 122 "project/radare2/libr/lang/p/go.c"
           lang_go_file(RLang *lang, const char *file) {
 if (!lang || 
# 123 "project/radare2/libr/lang/p/go.c" 3 4
             (!(
# 123 "project/radare2/libr/lang/p/go.c"
             file
# 123 "project/radare2/libr/lang/p/go.c" 3 4
             ) || !*(
# 123 "project/radare2/libr/lang/p/go.c"
...
# 123 "project/radare2/libr/lang/p/go.c"
  ...
  return 
# 124 "project/radare2/libr/lang/p/go.c" 3 4
        0
# 124 "project/radare2/libr/lang/p/go.c"
             ;
 }
 if (!r_str_endswith (file, ".go")) {
  return 
# 127 "project/radare2/libr/lang/p/go.c" 3 4
        0
# 127 "project/radare2/libr/lang/p/go.c"
             ;
 }
 if (strcmp (file, "tmp.go")) {
  char *code = r_file_slurp (file, 
# 130 "project/radare2/libr/lang/p/go.c" 3 4
                                  ((void *)0)
# 130 "project/radare2/libr/lang/p/go.c"
                                      );
  
# 131 "project/radare2/libr/lang/p/go.c" 3 4
 _Bool 
# 131 "project/radare2/libr/lang/p/go.c"
      r = __gorun (lang, code, -1);
  free (code);
  return r;
 }
 if (!r_file_exists (file)) {
  
# 136 "project/radare2/libr/lang/p/go.c" 3 4
 fprintf(__stderrp,
# 136 "project/radare2/libr/lang/p/go.c"
 "file not found (%s)\n", file
# 136 "project/radare2/libr/lang/p/go.c" 3 4
 )
# 136 "project/radare2/libr/lang/p/go.c"
                                        ;
  return 
# 137 "project/radare2/libr/lang/p/go.c" 3 4
        0
# 137 "project/radare2/libr/lang/p/go.c"
             ;
 }
 r_sys_setenv ("PKG_CONFIG_PATH", 
# 139 "project/radare2/libr/lang/p/go.c" 3 4
                                 "/usr/local/lib"
# 139 "project/radare2/libr/lang/p/go.c"
                                          "/pkgconfig");
 char *lib = r_str_replace (strdup (file), ".go", "."
# 140 "project/radare2/libr/lang/p/go.c" 3 4
                                                    "dylib"
# 140 "project/radare2/libr/lang/p/go.c"
                                                             , 1);
 ...
 if (r_sandbox_system (buf, 1) != 0) {
  ...
  free (lib);
  return 
# 145 "project/radare2/libr/lang/p/go.c" 3 4
        0
# 145 "project/radare2/libr/lang/p/go.c"
             ;
 }
 free (buf);
...
static 
# 154 "project/radare2/libr/lang/p/go.c" 3 4
      _Bool 
# 154 "project/radare2/libr/lang/p/go.c"
           lang_go_run(RLang *lang, const char *code, int len) {
...
# 21 "project/radare2/libr/lang/lang.c" 2
# 1 "project/radare2/libr/lang/p/lib.c" 1
...
static 
# 7 "project/radare2/libr/lang/p/lib.c" 3 4
      _Bool 
# 7 "project/radare2/libr/lang/p/lib.c"
           lang_lib_init(RLang *user) {
 return 
# 8 "project/radare2/libr/lang/p/lib.c" 3 4
       1
# 8 "project/radare2/libr/lang/p/lib.c"
           ;
}

static 
# 11 "project/radare2/libr/lang/p/lib.c" 3 4
      _Bool 
# 11 "project/radare2/libr/lang/p/lib.c"
           lang_lib_file_run(RLang *user, const char *file) {
 char *libpath;
 void *lib;
 if (!(libpath = r_str_new (file))) {
  return 
# 15 "project/radare2/libr/lang/p/lib.c" 3 4
        0
# 15 "project/radare2/libr/lang/p/lib.c"
             ;
 }
 ...
 if (!r_file_exists (libpath)) {
  if (!r_str_endswith (libpath, 
# 21 "project/radare2/libr/lang/p/lib.c" 3 4
                               "dylib"
# 21 "project/radare2/libr/lang/p/lib.c"
                                        )) {
   libpath = r_str_appendf (libpath, ".%s", 
# 22 "project/radare2/libr/lang/p/lib.c" 3 4
                                           "dylib"
# 22 "project/radare2/libr/lang/p/lib.c"
                                                    );
  }
 }
 if (!r_file_exists (libpath)) {
  free (libpath);
  return 
# 27 "project/radare2/libr/lang/p/lib.c" 3 4
        0
# 27 "project/radare2/libr/lang/p/lib.c"
             ;
 }
...
# 37 "project/radare2/libr/lang/p/lib.c" 3 4
  fprintf(__stderrp,
# 37 "project/radare2/libr/lang/p/lib.c"
  "Cannot find 'entry' symbol in library\n"
# 37 "project/radare2/libr/lang/p/lib.c" 3 4
  )
# 37 "project/radare2/libr/lang/p/lib.c"
 ...
 free (libpath);
 return 
# 42 "project/radare2/libr/lang/p/lib.c" 3 4
       1
# 42 "project/radare2/libr/lang/p/lib.c"
           ;
}
...
static RLangPlugin r_lang_plugin_lib = {
 .name = "lib",
 .ext = 
# 47 "project/radare2/libr/lang/p/lib.c" 3 4
       "dylib"
# 47 "project/radare2/libr/lang/p/lib.c"
                ,
...
# 22 "project/radare2/libr/lang/lang.c" 2

static RLang *__lang = 
# 23 "project/radare2/libr/lang/lang.c" 3 4
                      ((void *)0)
# 23 "project/radare2/libr/lang/lang.c"
                          ;


# 25 "project/radare2/libr/lang/lang.c" 3 4
__attribute__((visibility("default"))) 
# 25 "project/radare2/libr/lang/lang.c"
     void r_lang_plugin_free (RLangPlugin *p) {
 if (p && p->fini) {
  p->fini (__lang);
 }
}
...
# 31 "project/radare2/libr/lang/lang.c" 3 4
__attribute__((visibility("default"))) 
# 31 "project/radare2/libr/lang/lang.c"
     RLang *r_lang_new(void) {
 RLang *lang = 
# 32 "project/radare2/libr/lang/lang.c" 3 4
              (
# 32 "project/radare2/libr/lang/lang.c"
              RLang
# 32 "project/radare2/libr/lang/lang.c" 3 4
              *)calloc(1,sizeof(
# 32 "project/radare2/libr/lang/lang.c"
...
# 32 "project/radare2/libr/lang/lang.c"
 ...
 if (!lang) {
  return 
# 34 "project/radare2/libr/lang/lang.c" 3 4
        ((void *)0)
# 34 "project/radare2/libr/lang/lang.c"
            ;
 }
 lang->user = 
# 36 "project/radare2/libr/lang/lang.c" 3 4
             ((void *)0)
# 36 "project/radare2/libr/lang/lang.c"
                 ;
 lang->langs = r_list_new ();
 if (!lang->langs) {
  r_lang_free (lang);
  return 
# 40 "project/radare2/libr/lang/lang.c" 3 4
        ((void *)0)
# 40 "project/radare2/libr/lang/lang.c"
            ;
 }
 ...
 if (!lang->defs) {
  r_lang_free (lang);
  return 
# 46 "project/radare2/libr/lang/lang.c" 3 4
        ((void *)0)
# 46 "project/radare2/libr/lang/lang.c"
            ;
 }
...
# 68 "project/radare2/libr/lang/lang.c" 3 4
__attribute__((visibility("default"))) 
# 68 "project/radare2/libr/lang/lang.c"
     void r_lang_free(RLang *lang) {
 if (lang) {
  __lang = 
# 70 "project/radare2/libr/lang/lang.c" 3 4
          ((void *)0)
# 70 "project/radare2/libr/lang/lang.c"
              ;
  r_lang_undef (lang, 
# 71 "project/radare2/libr/lang/lang.c" 3 4
                     ((void *)0)
# 71 "project/radare2/libr/lang/lang.c"
                         );
...
# 83 "project/radare2/libr/lang/lang.c" 3 4
__attribute__((visibility("default"))) 
# 83 "project/radare2/libr/lang/lang.c"
     void r_lang_set_user_ptr(RLang *lang, void *user) {
 lang->user = user;
}


# 87 "project/radare2/libr/lang/lang.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 87 "project/radare2/libr/lang/lang.c"
          r_lang_define(RLang *lang, const char *type, const char *name, void *value) {
 RLangDef *def;
 RListIter *iter;
 
# 90 "project/radare2/libr/lang/lang.c" 3 4
if (
# 90 "project/radare2/libr/lang/lang.c"
lang->defs
# 90 "project/radare2/libr/lang/lang.c" 3 4
) for (
# 90 "project/radare2/libr/lang/lang.c"
...
# 90 "project/radare2/libr/lang/lang.c"
  ...
  if (!r_str_casecmp (name, def->name)) {
   def->value = value;
   return 
# 93 "project/radare2/libr/lang/lang.c" 3 4
          1
# 93 "project/radare2/libr/lang/lang.c"
              ;
  }
 }
 def = 
# 96 "project/radare2/libr/lang/lang.c" 3 4
      (
# 96 "project/radare2/libr/lang/lang.c"
      RLangDef
# 96 "project/radare2/libr/lang/lang.c" 3 4
      *)calloc(1,sizeof(
# 96 "project/radare2/libr/lang/lang.c"
...
# 96 "project/radare2/libr/lang/lang.c"
 ...
 if (!def) {
  return 
# 98 "project/radare2/libr/lang/lang.c" 3 4
        0
# 98 "project/radare2/libr/lang/lang.c"
             ;
 }
 ...
 return 
# 104 "project/radare2/libr/lang/lang.c" 3 4
       1
# 104 "project/radare2/libr/lang/lang.c"
           ;
}


# 107 "project/radare2/libr/lang/lang.c" 3 4
__attribute__((visibility("default"))) 
# 107 "project/radare2/libr/lang/lang.c"
     void r_lang_def_free (RLangDef *def) {
 free (def->name);
 free (def->type);
 free (def);
}
...
# 113 "project/radare2/libr/lang/lang.c" 3 4
__attribute__((visibility("default"))) 
# 113 "project/radare2/libr/lang/lang.c"
     void r_lang_undef(RLang *lang, const char *name) {
 if (name && *name) {
  RLangDef *def;
  RListIter *iter;

  
# 118 "project/radare2/libr/lang/lang.c" 3 4
 if (
# 118 "project/radare2/libr/lang/lang.c"
 lang->defs
# 118 "project/radare2/libr/lang/lang.c" 3 4
 ) for (
# 118 "project/radare2/libr/lang/lang.c"
...
# 118 "project/radare2/libr/lang/lang.c"
  ...
  r_list_free (lang->defs);
  lang->defs = 
# 126 "project/radare2/libr/lang/lang.c" 3 4
              ((void *)0)
# 126 "project/radare2/libr/lang/lang.c"
                  ;
 }
}


# 130 "project/radare2/libr/lang/lang.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 130 "project/radare2/libr/lang/lang.c"
          r_lang_setup(RLang *lang) {
 if (lang && lang->cur && lang->cur->setup) {
  return lang->cur->setup (lang);
 }
 return 
# 134 "project/radare2/libr/lang/lang.c" 3 4
       0
# 134 "project/radare2/libr/lang/lang.c"
            ;
}


# 137 "project/radare2/libr/lang/lang.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 137 "project/radare2/libr/lang/lang.c"
          r_lang_add(RLang *lang, RLangPlugin *foo) {
 if (foo && (!r_lang_get_by_name (lang, foo->name))) {
  ...
  return 
# 143 "project/radare2/libr/lang/lang.c" 3 4
        1
# 143 "project/radare2/libr/lang/lang.c"
            ;
 }
 return 
# 145 "project/radare2/libr/lang/lang.c" 3 4
       0
# 145 "project/radare2/libr/lang/lang.c"
            ;
}



# 149 "project/radare2/libr/lang/lang.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 149 "project/radare2/libr/lang/lang.c"
          r_lang_list(RLang *lang) {
 RListIter *iter;
 RLangPlugin *h;
 if (!lang) {
  return 
# 153 "project/radare2/libr/lang/lang.c" 3 4
        0
# 153 "project/radare2/libr/lang/lang.c"
             ;
 }
 
# 155 "project/radare2/libr/lang/lang.c" 3 4
if (
# 155 "project/radare2/libr/lang/lang.c"
lang->langs
# 155 "project/radare2/libr/lang/lang.c" 3 4
) for (
# 155 "project/radare2/libr/lang/lang.c"
...
# 155 "project/radare2/libr/lang/lang.c"
 ...
 return 
# 161 "project/radare2/libr/lang/lang.c" 3 4
       1
# 161 "project/radare2/libr/lang/lang.c"
           ;
}


# 164 "project/radare2/libr/lang/lang.c" 3 4
__attribute__((visibility("default"))) 
# 164 "project/radare2/libr/lang/lang.c"
     RLangPlugin *r_lang_get_by_extension (RLang *lang, const char *ext) {
 RListIter *iter;
 RLangPlugin *h;
...
# 171 "project/radare2/libr/lang/lang.c" 3 4
if (
# 171 "project/radare2/libr/lang/lang.c"
lang->langs
# 171 "project/radare2/libr/lang/lang.c" 3 4
) for (
# 171 "project/radare2/libr/lang/lang.c"
...
# 171 "project/radare2/libr/lang/lang.c"
 ...
 return 
# 176 "project/radare2/libr/lang/lang.c" 3 4
       ((void *)0)
# 176 "project/radare2/libr/lang/lang.c"
           ;
}


# 179 "project/radare2/libr/lang/lang.c" 3 4
__attribute__((visibility("default"))) 
# 179 "project/radare2/libr/lang/lang.c"
     RLangPlugin *r_lang_get_by_name (RLang *lang, const char *name) {
 RListIter *iter;
 RLangPlugin *h;
 
# 182 "project/radare2/libr/lang/lang.c" 3 4
if (
# 182 "project/radare2/libr/lang/lang.c"
lang->langs
# 182 "project/radare2/libr/lang/lang.c" 3 4
) for (
# 182 "project/radare2/libr/lang/lang.c"
...
# 182 "project/radare2/libr/lang/lang.c"
 ...
 return 
# 190 "project/radare2/libr/lang/lang.c" 3 4
       ((void *)0)
# 190 "project/radare2/libr/lang/lang.c"
           ;
}


# 193 "project/radare2/libr/lang/lang.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 193 "project/radare2/libr/lang/lang.c"
          r_lang_use(RLang *lang, const char *name) {
 RLangPlugin *h = r_lang_get_by_name (lang, name);
 if (h) {
  lang->cur = h;
  return 
# 197 "project/radare2/libr/lang/lang.c" 3 4
        1
# 197 "project/radare2/libr/lang/lang.c"
            ;
 }
 return 
# 199 "project/radare2/libr/lang/lang.c" 3 4
       0
# 199 "project/radare2/libr/lang/lang.c"
            ;
}



# 203 "project/radare2/libr/lang/lang.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 203 "project/radare2/libr/lang/lang.c"
          r_lang_set_argv(RLang *lang, int argc, char **argv) {
 if (lang->cur && lang->cur->set_argv) {
  return lang->cur->set_argv (lang, argc, argv);
 }
 return 
# 207 "project/radare2/libr/lang/lang.c" 3 4
       0
# 207 "project/radare2/libr/lang/lang.c"
            ;
}


# 210 "project/radare2/libr/lang/lang.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 210 "project/radare2/libr/lang/lang.c"
          r_lang_run(RLang *lang, const char *code, int len) {
 if (lang->cur && lang->cur->run) {
  return lang->cur->run (lang, code, len);
 }
 return 
# 214 "project/radare2/libr/lang/lang.c" 3 4
       0
# 214 "project/radare2/libr/lang/lang.c"
            ;
}


# 217 "project/radare2/libr/lang/lang.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 217 "project/radare2/libr/lang/lang.c"
          r_lang_run_string(RLang *lang, const char *code) {
 return r_lang_run (lang, code, strlen (code));
}


# 221 "project/radare2/libr/lang/lang.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 221 "project/radare2/libr/lang/lang.c"
          r_lang_run_file(RLang *lang, const char *file) {
 
# 222 "project/radare2/libr/lang/lang.c" 3 4
_Bool 
# 222 "project/radare2/libr/lang/lang.c"
     ret = 
# 222 "project/radare2/libr/lang/lang.c" 3 4
           0
# 222 "project/radare2/libr/lang/lang.c"
...
# 229 "project/radare2/libr/lang/lang.c" 3 4
    fprintf(__stderrp,
# 229 "project/radare2/libr/lang/lang.c"
    "Could not open '%s'.\n", file
# 229 "project/radare2/libr/lang/lang.c" 3 4
    )
# 229 "project/radare2/libr/lang/lang.c"
...
# 243 "project/radare2/libr/lang/lang.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 243 "project/radare2/libr/lang/lang.c"
          r_lang_prompt(RLang *lang) {
 char buf[1024];
 const char *p;

 if (!lang || !lang->cur) {
  return 
# 248 "project/radare2/libr/lang/lang.c" 3 4
        0
# 248 "project/radare2/libr/lang/lang.c"
             ;
 }
 ...
 if (lang->cur->prompt) {
  if (lang->cur->prompt (lang)) {
   return 
# 253 "project/radare2/libr/lang/lang.c" 3 4
         1
# 253 "project/radare2/libr/lang/lang.c"
             ;
  }
 }
...
# 269 "project/radare2/libr/lang/lang.c" 3 4
 __builtin___snprintf_chk (
# 269 "project/radare2/libr/lang/lang.c"
 buf
# 269 "project/radare2/libr/lang/lang.c" 3 4
 , 
# 269 "project/radare2/libr/lang/lang.c"
...
# 283 "project/radare2/libr/lang/lang.c" 3 4
 __builtin___strncpy_chk (
# 283 "project/radare2/libr/lang/lang.c"
 buf
# 283 "project/radare2/libr/lang/lang.c" 3 4
 , 
# 283 "project/radare2/libr/lang/lang.c"
...
# 283 "project/radare2/libr/lang/lang.c"
  ...
  if (*buf == '!') {
   if (buf[1]) {
    ...
    char *foo, *code = 
# 288 "project/radare2/libr/lang/lang.c" 3 4
                      ((void *)0)
# 288 "project/radare2/libr/lang/lang.c"
                          ;
    do {
     foo = r_cons_editor (
# 290 "project/radare2/libr/lang/lang.c" 3 4
                         ((void *)0)
# 290 "project/radare2/libr/lang/lang.c"
                             , code);
  ...
  if (!strcmp (buf, "q")) {
   free (prompt);
   return 
# 309 "project/radare2/libr/lang/lang.c" 3 4
         1
# 309 "project/radare2/libr/lang/lang.c"
             ;
  }
  if (!strcmp (buf, "?")) {
   RLangDef *def;
...
# 314 "project/radare2/libr/lang/lang.c" 3 4
  fprintf(__stderrp,
# 314 "project/radare2/libr/lang/lang.c"
...
# 318 "project/radare2/libr/lang/lang.c"
                          ;
   
# 319 "project/radare2/libr/lang/lang.c" 3 4
  fprintf(__stderrp,
# 319 "project/radare2/libr/lang/lang.c"
  "%s example:\n", lang->cur->name
# 319 "project/radare2/libr/lang/lang.c" 3 4
  )
# 319 "project/radare2/libr/lang/lang.c"
...
# 321 "project/radare2/libr/lang/lang.c" 3 4
   fprintf(__stderrp,
# 321 "project/radare2/libr/lang/lang.c"
   "%s", *lang->cur->help
# 321 "project/radare2/libr/lang/lang.c" 3 4
   )
# 321 "project/radare2/libr/lang/lang.c"
   ...
   if (!
# 323 "project/radare2/libr/lang/lang.c" 3 4
       (!(
# 323 "project/radare2/libr/lang/lang.c"
       lang->defs
# 323 "project/radare2/libr/lang/lang.c" 3 4
       ) || !(
# 323 "project/radare2/libr/lang/lang.c"
...
# 324 "project/radare2/libr/lang/lang.c" 3 4
   fprintf(__stderrp,
# 324 "project/radare2/libr/lang/lang.c"
   "variables:\n"
# 324 "project/radare2/libr/lang/lang.c" 3 4
   )
# 324 "project/radare2/libr/lang/lang.c"
...
# 326 "project/radare2/libr/lang/lang.c" 3 4
  if (
# 326 "project/radare2/libr/lang/lang.c"
  lang->defs
# 326 "project/radare2/libr/lang/lang.c" 3 4
  ) for (
# 326 "project/radare2/libr/lang/lang.c"
...
# 327 "project/radare2/libr/lang/lang.c" 3 4
   fprintf(__stderrp,
# 327 "project/radare2/libr/lang/lang.c"
   "  %s %s\n", def->type, def->name
# 327 "project/radare2/libr/lang/lang.c" 3 4
   )
# 327 "project/radare2/libr/lang/lang.c"
 ...
 line->history = hist;
 clearerr (
# 337 "project/radare2/libr/lang/lang.c" 3 4
          __stdinp
# 337 "project/radare2/libr/lang/lang.c"
               );
 printf ("\n");
 free (prompt);
 return 
# 340 "project/radare2/libr/lang/lang.c" 3 4
       1
# 340 "project/radare2/libr/lang/lang.c"
           ;
}
