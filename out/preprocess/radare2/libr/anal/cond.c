# 0 "project/radare2/libr/anal/cond.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/anal/cond.c"
...
# 4 "project/radare2/libr/anal/cond.c" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/anal/cond.c"
     const char *r_anal_cond_tostring(int cc) {
 switch (cc) {
...
# 27 "project/radare2/libr/anal/cond.c" 3 4
__attribute__((visibility("default"))) 
# 27 "project/radare2/libr/anal/cond.c"
     RAnalCond *r_anal_cond_new(void) {
 return 
# 28 "project/radare2/libr/anal/cond.c" 3 4
       (
# 28 "project/radare2/libr/anal/cond.c"
       RAnalCond
# 28 "project/radare2/libr/anal/cond.c" 3 4
       *)calloc(1,sizeof(
# 28 "project/radare2/libr/anal/cond.c"
...
# 31 "project/radare2/libr/anal/cond.c" 3 4
__attribute__((visibility("default"))) 
# 31 "project/radare2/libr/anal/cond.c"
     void r_anal_cond_fini (RAnalCond *c) {
 if (!c) {
  return;
 }
 ...
 c->arg[0] = c->arg[1] = 
# 37 "project/radare2/libr/anal/cond.c" 3 4
                        ((void *)0)
# 37 "project/radare2/libr/anal/cond.c"
                            ;
}


# 40 "project/radare2/libr/anal/cond.c" 3 4
__attribute__((visibility("default"))) 
# 40 "project/radare2/libr/anal/cond.c"
     void r_anal_cond_free (RAnalCond *c) {
 if (!c) {
  return;
 }
 r_anal_cond_fini (c);
...
# 49 "project/radare2/libr/anal/cond.c" 3 4
__attribute__((visibility("default"))) 
# 49 "project/radare2/libr/anal/cond.c"
     RAnalCond *r_anal_cond_clone(RAnalCond *cond) {
 RAnalCond *c = 
# 50 "project/radare2/libr/anal/cond.c" 3 4
               (
# 50 "project/radare2/libr/anal/cond.c"
               RAnalCond
# 50 "project/radare2/libr/anal/cond.c" 3 4
               *)malloc(sizeof(
# 50 "project/radare2/libr/anal/cond.c"
...
# 50 "project/radare2/libr/anal/cond.c"
 ...
 if (!c) {
  return 
# 52 "project/radare2/libr/anal/cond.c" 3 4
        ((void *)0)
# 52 "project/radare2/libr/anal/cond.c"
            ;
 }
 
# 54 "project/radare2/libr/anal/cond.c" 3 4
__builtin___memcpy_chk (
# 54 "project/radare2/libr/anal/cond.c"
c
# 54 "project/radare2/libr/anal/cond.c" 3 4
, 
# 54 "project/radare2/libr/anal/cond.c"
cond, sizeof (RAnalCond)
# 54 "project/radare2/libr/anal/cond.c" 3 4
...
# 71 "project/radare2/libr/anal/cond.c" 3 4
__attribute__((visibility("default"))) 
# 71 "project/radare2/libr/anal/cond.c"
     int r_anal_cond_eval(RAnal *anal, RAnalCond *cond) {

 
# 73 "project/radare2/libr/anal/cond.c" 3 4
long long 
# 73 "project/radare2/libr/anal/cond.c"
     arg0 = (
# 73 "project/radare2/libr/anal/cond.c" 3 4
             long long
# 73 "project/radare2/libr/anal/cond.c"
                 ) r_anal_value_to_ut64 (anal, cond->arg[0]);
 if (cond->arg[1]) {
  
# 75 "project/radare2/libr/anal/cond.c" 3 4
 long long 
# 75 "project/radare2/libr/anal/cond.c"
      arg1 = (
# 75 "project/radare2/libr/anal/cond.c" 3 4
              long long
# 75 "project/radare2/libr/anal/cond.c"
                  ) r_anal_value_to_ut64 (anal, cond->arg[1]);
  switch (cond->type) {
 ...
 return 
# 94 "project/radare2/libr/anal/cond.c" 3 4
       0
# 94 "project/radare2/libr/anal/cond.c"
            ;
}



# 98 "project/radare2/libr/anal/cond.c" 3 4
__attribute__((visibility("default"))) 
# 98 "project/radare2/libr/anal/cond.c"
     char *r_anal_cond_to_string(RAnalCond *cond) {
 char *val0, *val1, *out = 
# 99 "project/radare2/libr/anal/cond.c" 3 4
                          ((void *)0)
# 99 "project/radare2/libr/anal/cond.c"
                              ;
 const char *cnd;
 if (!cond) {
  return 
# 102 "project/radare2/libr/anal/cond.c" 3 4
        ((void *)0)
# 102 "project/radare2/libr/anal/cond.c"
            ;
 }
 cnd = condstring (cond);
 ...
 if (val0) {
  if (
# 108 "project/radare2/libr/anal/cond.c" 3 4
     (!
# 108 "project/radare2/libr/anal/cond.c"
     cond
# 108 "project/radare2/libr/anal/cond.c" 3 4
     ->arg[1] || 
# 108 "project/radare2/libr/anal/cond.c"
...
# 111 "project/radare2/libr/anal/cond.c" 3 4
   __builtin___snprintf_chk (
# 111 "project/radare2/libr/anal/cond.c"
   out
# 111 "project/radare2/libr/anal/cond.c" 3 4
   , 
# 111 "project/radare2/libr/anal/cond.c"
...
# 117 "project/radare2/libr/anal/cond.c" 3 4
    __builtin___snprintf_chk (
# 117 "project/radare2/libr/anal/cond.c"
    out
# 117 "project/radare2/libr/anal/cond.c" 3 4
    , 
# 117 "project/radare2/libr/anal/cond.c"
...
# 127 "project/radare2/libr/anal/cond.c" 3 4
__attribute__((visibility("default"))) 
# 127 "project/radare2/libr/anal/cond.c"
     RAnalCond *r_anal_cond_new_from_op(RAnalOp *op) {
 RAnalCond *cond;
 if (!(cond = r_anal_cond_new ())) {
  return 
# 130 "project/radare2/libr/anal/cond.c" 3 4
        ((void *)0)
# 130 "project/radare2/libr/anal/cond.c"
            ;
 }
 ...
 cond->arg[0] = op->src[0];
 op->src[0] = 
# 135 "project/radare2/libr/anal/cond.c" 3 4
             ((void *)0)
# 135 "project/radare2/libr/anal/cond.c"
                 ;
 cond->arg[1] = op->src[1];
 op->src[1] = 
# 137 "project/radare2/libr/anal/cond.c" 3 4
             ((void *)0)
# 137 "project/radare2/libr/anal/cond.c"
                 ;
...
# 143 "project/radare2/libr/anal/cond.c" 3 4
__attribute__((visibility("default"))) 
# 143 "project/radare2/libr/anal/cond.c"
     RAnalCond *r_anal_cond_new_from_string(const char *str) {
 RAnalCond *cond = 
# 144 "project/radare2/libr/anal/cond.c" 3 4
                  (
# 144 "project/radare2/libr/anal/cond.c"
                  RAnalCond
# 144 "project/radare2/libr/anal/cond.c" 3 4
                  *)malloc(sizeof(
# 144 "project/radare2/libr/anal/cond.c"
