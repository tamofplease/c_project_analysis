# 0 "project/radare2/libr/anal/p/anal_s390_cs.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/anal/p/anal_s390_cs.c"
...
# 4 "project/radare2/libr/anal/p/anal_s390_cs.c" 2
...
# 5 "project/radare2/libr/anal/p/anal_s390_cs.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_s390_cs.c" 2
# 1 "/usr/local/Cellar/capstone/4.0.2/include/capstone/systemz.h" 1 3 4
# 7 "project/radare2/libr/anal/p/anal_s390_cs.c" 2
# 15 "project/radare2/libr/anal/p/anal_s390_cs.c"
...
# 57 "project/radare2/libr/anal/p/anal_s390_cs.c" 3 4
                                        unsigned long long 
# 57 "project/radare2/libr/anal/p/anal_s390_cs.c"
                                             addr, const 
# 57 "project/radare2/libr/anal/p/anal_s390_cs.c" 3 4
                                                         unsigned char 
# 57 "project/radare2/libr/anal/p/anal_s390_cs.c"
 ...
 if (ret == CS_ERR_OK) {
  ...
  int n = cs_disasm (handle, (const 
# 66 "project/radare2/libr/anal/p/anal_s390_cs.c" 3 4
                                   unsigned char
# 66 "project/radare2/libr/anal/p/anal_s390_cs.c"
                                      *)buf, len, addr, 1, &insn);
  if (n < 1) {
   ...
   case SYSZ_INS_JG:
    op->type = R_ANAL_OP_TYPE_CJMP;
    op->jump = insn->detail->sysz.operands[0].imm;
   ...
   case SYSZ_INS_J:
    ...
    op->jump = insn->detail->sysz.operands[0].imm;
    op->fail = 
# 140 "project/radare2/libr/anal/p/anal_s390_cs.c" 3 4
              0xFFFFFFFFFFFFFFFFULL
# 140 "project/radare2/libr/anal/p/anal_s390_cs.c"
                      ;
    break;
   }
  }
...
static 
# 150 "project/radare2/libr/anal/p/anal_s390_cs.c" 3 4
      _Bool 
# 150 "project/radare2/libr/anal/p/anal_s390_cs.c"
...
static int archinfo(RAnal *anal, int q) {
 switch (q) {
 case 
# 191 "project/radare2/libr/anal/p/anal_s390_cs.c" 3 4
     8
# 191 "project/radare2/libr/anal/p/anal_s390_cs.c"
                               :
 case 
# 192 "project/radare2/libr/anal/p/anal_s390_cs.c" 3 4
     4
# 192 "project/radare2/libr/anal/p/anal_s390_cs.c"
                          :
  return 2;
 case 
# 194 "project/radare2/libr/anal/p/anal_s390_cs.c" 3 4
     1
# 194 "project/radare2/libr/anal/p/anal_s390_cs.c"
                                :
  return 6;
 case 
# 196 "project/radare2/libr/anal/p/anal_s390_cs.c" 3 4
     0
# 196 "project/radare2/libr/anal/p/anal_s390_cs.c"
                                :
  return 2;
 }
 return 2;
...
RAnalPlugin r_anal_plugin_s390_cs = {
 ...
 .esil = 
# 205 "project/radare2/libr/anal/p/anal_s390_cs.c" 3 4
        0
# 205 "project/radare2/libr/anal/p/anal_s390_cs.c"
             ,
 .license = "BSD",
 .arch = "s390",
 .bits = 32 | 64,
...
# 215 "project/radare2/libr/anal/p/anal_s390_cs.c" 3 4
__attribute__((visibility("default"))) 
# 215 "project/radare2/libr/anal/p/anal_s390_cs.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ANAL,
 .data = &r_anal_plugin_sysz,
 .version = 
# 218 "project/radare2/libr/anal/p/anal_s390_cs.c" 3 4
           "5.5.4"

# 219 "project/radare2/libr/anal/p/anal_s390_cs.c"
};
