# 0 "project/radare2/libr/anal/p/anal_sparc_cs.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/anal/p/anal_sparc_cs.c"
...
# 4 "project/radare2/libr/anal/p/anal_sparc_cs.c" 2
...
# 5 "project/radare2/libr/anal/p/anal_sparc_cs.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_sparc_cs.c" 2
# 1 "/usr/local/Cellar/capstone/4.0.2/include/capstone/sparc.h" 1 3 4
# 7 "project/radare2/libr/anal/p/anal_sparc_cs.c" 2
# 15 "project/radare2/libr/anal/p/anal_sparc_cs.c"
...
static int parse_reg_name(RRegItem *reg, csh handle, cs_insn *insn, int reg_num) {
 ...
 switch (insn->detail->sparc.operands[reg_num].type) {
 case SPARC_OP_REG:
  reg->name = (char *)cs_reg_name (handle, insn->detail->sparc.operands[reg_num].reg);
  break;
 case SPARC_OP_MEM:
  if (insn->detail->sparc.operands[reg_num].mem.base != SPARC_REG_INVALID) {
   reg->name = (char *)cs_reg_name (handle, insn->detail->sparc.operands[reg_num].mem.base);
   break;
  }
 default:
  break;
...
static void op_fillval(RAnalOp *op, csh handle, cs_insn *insn) {
 static RRegItem reg;
 switch (op->type & 
# 78 "project/radare2/libr/anal/p/anal_sparc_cs.c" 3 4
                   0x8000ffff
# 78 "project/radare2/libr/anal/p/anal_sparc_cs.c"
                                      ) {
 case R_ANAL_OP_TYPE_LOAD:
  if (insn->detail->sparc.operands[0].type == SPARC_OP_MEM) {
   
# 81 "project/radare2/libr/anal/p/anal_sparc_cs.c" 3 4
  __builtin___memset_chk (&
# 81 "project/radare2/libr/anal/p/anal_sparc_cs.c"
  reg
# 81 "project/radare2/libr/anal/p/anal_sparc_cs.c" 3 4
  , 0, sizeof (
# 81 "project/radare2/libr/anal/p/anal_sparc_cs.c"
...
# 81 "project/radare2/libr/anal/p/anal_sparc_cs.c"
   ...
   op->src[0]->delta = insn->detail->sparc.operands[0].mem.disp;
  }
  break;
 case R_ANAL_OP_TYPE_STORE:
  if (insn->detail->sparc.operands[1].type == SPARC_OP_MEM) {
   
# 90 "project/radare2/libr/anal/p/anal_sparc_cs.c" 3 4
  __builtin___memset_chk (&
# 90 "project/radare2/libr/anal/p/anal_sparc_cs.c"
  reg
# 90 "project/radare2/libr/anal/p/anal_sparc_cs.c" 3 4
  , 0, sizeof (
# 90 "project/radare2/libr/anal/p/anal_sparc_cs.c"
...
# 90 "project/radare2/libr/anal/p/anal_sparc_cs.c"
   ...
   op->dst->delta = insn->detail->sparc.operands[1].mem.disp;
  }
  break;
 }
}
...
# 100 "project/radare2/libr/anal/p/anal_sparc_cs.c" 3 4
                                        unsigned long long 
# 100 "project/radare2/libr/anal/p/anal_sparc_cs.c"
                                             addr, const 
# 100 "project/radare2/libr/anal/p/anal_sparc_cs.c" 3 4
                                                         unsigned char 
# 100 "project/radare2/libr/anal/p/anal_sparc_cs.c"
...
# 127 "project/radare2/libr/anal/p/anal_sparc_cs.c" 3 4
                              unsigned char
# 127 "project/radare2/libr/anal/p/anal_sparc_cs.c"
                                 *)buf, len, addr, 1, &insn);
 if (n < 1) {
  ...
  case SPARC_INS_UNIMP:
   ...
   break;
  case SPARC_INS_CALL:
   switch (insn->detail->sparc.operands[0].type) {
   case SPARC_OP_MEM:
   ...
   default:
    ...
    op->delay = 1;
    op->jump = insn->detail->sparc.operands[0].imm;
    break;
   }
   break;
  case SPARC_INS_NOP:
  ...
  case SPARC_INS_FB:
   ...
   case SPARC_OP_REG:
    ...
    op->delay = 1;
    if (insn->detail->sparc.cc != SPARC_CC_ICC_N) {
     op->jump = insn->detail->sparc.operands[1].imm;
    }
    if (insn->detail->sparc.cc != SPARC_CC_ICC_A) {
     op->fail = addr + 8;
    }
    break;
   case SPARC_OP_IMM:
...
static 
# 324 "project/radare2/libr/anal/p/anal_sparc_cs.c" 3 4
      _Bool 
# 324 "project/radare2/libr/anal/p/anal_sparc_cs.c"
...
RAnalPlugin r_anal_plugin_sparc_cs = {
 ...
 .esil = 
# 389 "project/radare2/libr/anal/p/anal_sparc_cs.c" 3 4
        1
# 389 "project/radare2/libr/anal/p/anal_sparc_cs.c"
            ,
 .license = "BSD",
 .arch = "sparc",
 .bits = 32|64,
...
# 399 "project/radare2/libr/anal/p/anal_sparc_cs.c" 3 4
__attribute__((visibility("default"))) 
# 399 "project/radare2/libr/anal/p/anal_sparc_cs.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ANAL,
 .data = &r_anal_plugin_sparc_cs,
 .version = 
# 402 "project/radare2/libr/anal/p/anal_sparc_cs.c" 3 4
           "5.5.4"

# 403 "project/radare2/libr/anal/p/anal_sparc_cs.c"
};
