# 0 "project/radare2/libr/anal/p/anal_hexagon.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
typedef int RRef;
# 4 "project/radare2/libr/anal/p/anal_hexagon.c" 2
...
# 5 "project/radare2/libr/anal/p/anal_hexagon.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_hexagon.c" 2
...
# 8 "project/radare2/libr/anal/p/anal_hexagon.c" 2
...
# 280 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/hexagon/hexagon.h"
                                                             addr);
# 9 "project/radare2/libr/anal/p/anal_hexagon.c" 2
...
# 10 "project/radare2/libr/anal/p/anal_hexagon.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/anal/arch/hexagon/hexagon_anal.h" 1
int hexagon_anal_instruction(HexInsn *hi, RAnalOp *op);
# 11 "project/radare2/libr/anal/p/anal_hexagon.c" 2

static int hexagon_v6_op(RAnal *anal, RAnalOp *op, 
# 12 "project/radare2/libr/anal/p/anal_hexagon.c" 3 4
                                                  unsigned long long 
# 12 "project/radare2/libr/anal/p/anal_hexagon.c"
                                                       addr, const 
# 12 "project/radare2/libr/anal/p/anal_hexagon.c" 3 4
                                                                   unsigned char 
# 12 "project/radare2/libr/anal/p/anal_hexagon.c"
...
# 16 "project/radare2/libr/anal/p/anal_hexagon.c" 3 4
unsigned int 
# 16 "project/radare2/libr/anal/p/anal_hexagon.c"
     data = r_read_le32 (buf);
 HexInsn hi = {0};
 int size = hexagon_disasm_instruction (data, &hi, (
# 18 "project/radare2/libr/anal/p/anal_hexagon.c" 3 4
                                                   unsigned int
# 18 "project/radare2/libr/anal/p/anal_hexagon.c"
                                                       ) addr);
 op->size = size;
 if (size < 1) {
  return size;
...
static 
# 28 "project/radare2/libr/anal/p/anal_hexagon.c" 3 4
      _Bool 
# 28 "project/radare2/libr/anal/p/anal_hexagon.c"
...
RAnalPlugin r_anal_plugin_hexagon = {
 ...
 .op = hexagon_v6_op,
 .esil = 
# 101 "project/radare2/libr/anal/p/anal_hexagon.c" 3 4
        0
# 101 "project/radare2/libr/anal/p/anal_hexagon.c"
             ,
...
# 106 "project/radare2/libr/anal/p/anal_hexagon.c" 3 4
__attribute__((visibility("default"))) 
# 106 "project/radare2/libr/anal/p/anal_hexagon.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ANAL,
 .data = &r_anal_plugin_hexagon_v6,
 .version = 
# 109 "project/radare2/libr/anal/p/anal_hexagon.c" 3 4
           "5.5.4"

# 110 "project/radare2/libr/anal/p/anal_hexagon.c"
};
