# 0 "project/radare2/libr/anal/p/anal_pic.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/anal/p/anal_pic.c"
...
typedef int RRef;
# 4 "project/radare2/libr/anal/p/anal_pic.c" 2
...
# 5 "project/radare2/libr/anal/p/anal_pic.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_pic.c" 2

# 1 "project/radare2/libr/anal/p/../../asm/arch/pic/pic_midrange.h" 1
...
# 7 "project/radare2/libr/anal/p/../../asm/arch/pic/pic_midrange.h" 2



# 9 "project/radare2/libr/anal/p/../../asm/arch/pic/pic_midrange.h"
typedef enum {
...
# 38 "project/radare2/libr/anal/p/../../asm/arch/pic/pic_midrange.h"
...
PicMidrangeOpcode pic_midrange_get_opcode (
# 99 "project/radare2/libr/anal/p/../../asm/arch/pic/pic_midrange.h" 3 4
                                          unsigned short 
# 99 "project/radare2/libr/anal/p/../../asm/arch/pic/pic_midrange.h"
                                               instr);
const PicMidrangeOpInfo *pic_midrange_get_op_info (PicMidrangeOpcode opcode);
int pic_midrange_disassemble (RAsmOp *op, char *opbuf, const 
# 101 "project/radare2/libr/anal/p/../../asm/arch/pic/pic_midrange.h" 3 4
                                                            unsigned char 
# 101 "project/radare2/libr/anal/p/../../asm/arch/pic/pic_midrange.h"
                                                                *b, int l);
# 8 "project/radare2/libr/anal/p/anal_pic.c" 2

typedef struct _pic_midrange_op_args_val {
 
# 10 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned short 
# 10 "project/radare2/libr/anal/p/anal_pic.c"
     f;
 
# 11 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned short 
# 11 "project/radare2/libr/anal/p/anal_pic.c"
     k;
 
# 12 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned char 
# 12 "project/radare2/libr/anal/p/anal_pic.c"
    d;
 
# 13 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned char 
# 13 "project/radare2/libr/anal/p/anal_pic.c"
    m;
 
# 14 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned char 
# 14 "project/radare2/libr/anal/p/anal_pic.c"
    n;
 
# 15 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned char 
# 15 "project/radare2/libr/anal/p/anal_pic.c"
    b;
} PicMidrangeOpArgsVal;

typedef void (*pic_midrange_inst_handler_t) (RAnal *anal, RAnalOp *op,
          
# 19 "project/radare2/libr/anal/p/anal_pic.c" 3 4
         unsigned long long 
# 19 "project/radare2/libr/anal/p/anal_pic.c"
              addr,
...
# 74 "project/radare2/libr/anal/p/anal_pic.c"
static void _inst__NOP (RAnal *anal, RAnalOp *op, 
# 74 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 74 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {}

static void _inst__RETFIE (RAnal *anal, RAnalOp *op, 
# 76 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 76 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_RET;
}

static void _inst__OPTION (RAnal *anal, RAnalOp *op, 
# 80 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 80 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_STORE;
}

static void _inst__TRIS (RAnal *anal, RAnalOp *op, 
# 84 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 84 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_STORE;
}

static void _inst__RETURN (RAnal *anal, RAnalOp *op, 
# 88 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 88 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_RET;
 r_strbuf_append (&op->esil, "0x1f,stkptr,==,$z,?{,BREAK,},");
 r_strbuf_append (&op->esil, "_stack,stkptr,2,*,+,[2],2,*,pc,=,");
 r_strbuf_append (&op->esil, "0x01,stkptr,-=,");
 r_strbuf_append (&op->esil, "0xff,stkptr,==,$z,?{,0x1f,stkptr,=,},");
}

static void _inst__CALL (RAnal *anal, RAnalOp *op, 
# 96 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 96 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 
# 97 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 97 "project/radare2/libr/anal/p/anal_pic.c"
     pclath;
 op->type = R_ANAL_OP_TYPE_CALL;
 r_anal_esil_reg_read (anal->esil, "pclath", &pclath, 
# 99 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                                     ((void *)0)
# 99 "project/radare2/libr/anal/p/anal_pic.c"
                                                         );
 op->jump = 2 * (((pclath & 0x78) << 8) + args->k);
 r_strbuf_appendf (&op->esil, "8,pclath,0x78,&,<<,0x%x,+,2,*,pc,=,", args->k);
 r_strbuf_append (&op->esil, "0x1f,stkptr,==,$z,?{,0xff,stkptr,=,},");
 r_strbuf_append (&op->esil, "0x0f,stkptr,==,$z,?{,0xff,stkptr,=,},");
 r_strbuf_append (&op->esil, "0x01,stkptr,+=,");
 r_strbuf_appendf (&op->esil, "0x%" 
# 105 "project/radare2/libr/anal/p/anal_pic.c" 3 4
"llx" 
# 105 "project/radare2/libr/anal/p/anal_pic.c"
",_stack,stkptr,2,*,+,=[2],", (addr + 2) / 2);
}

static void _inst__GOTO (RAnal *anal, RAnalOp *op, 
# 108 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 108 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 
# 109 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 109 "project/radare2/libr/anal/p/anal_pic.c"
     pclath;
 op->type = R_ANAL_OP_TYPE_JMP;
 r_anal_esil_reg_read (anal->esil, "pclath", &pclath, 
# 111 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                                     ((void *)0)
# 111 "project/radare2/libr/anal/p/anal_pic.c"
                                                         );
 op->jump = 2 * (((pclath & 0x78) << 8) + args->k);
 r_strbuf_appendf (&op->esil, "8,pclath,0x78,&,<<,0x%x,+,2,*,pc,=,", args->k);
}

static void _inst__BCF (RAnal *anal, RAnalOp *op, 
# 116 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 116 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 
# 117 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned char 
# 117 "project/radare2/libr/anal/p/anal_pic.c"
    mask = ~(1 << args->b);
 r_strbuf_appendf (&op->esil, "bsr,0x80,*,0x%x,+,_sram,+" ",[1],0x%x,&," "bsr,0x80,*,0x%x,+,_sram,+" ",=[1],", args->f, mask, args->f)

                            ;
}

static void _inst__BSF (RAnal *anal, RAnalOp *op, 
# 123 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 123 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 
# 124 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned char 
# 124 "project/radare2/libr/anal/p/anal_pic.c"
    mask = (1 << args->b);
 r_strbuf_appendf (&op->esil, "bsr,0x80,*,0x%x,+,_sram,+" ",[1],0x%x,|," "bsr,0x80,*,0x%x,+,_sram,+" ",=[1],", args->f, mask, args->f)
...
static void _inst__BTFSC (RAnal *anal, RAnalOp *op, 
# 130 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 130 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 
# 131 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned char 
# 131 "project/radare2/libr/anal/p/anal_pic.c"
    mask = (1 << args->b);
 op->type = R_ANAL_OP_TYPE_CJMP;
 op->jump = addr + 4;
 op->fail = addr + 2;
 r_strbuf_appendf (&op->esil, "bsr,0x80,*,0x%x,+,_sram,+" ",[1],0x%x,&,!,?{,0x%" 
# 135 "project/radare2/libr/anal/p/anal_pic.c" 3 4
"llx" 
# 135 "project/radare2/libr/anal/p/anal_pic.c"
",pc,=,},", args->f, mask, op->jump)
                             ;
}

static void _inst__BTFSS (RAnal *anal, RAnalOp *op, 
# 139 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 139 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 
# 140 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned char 
# 140 "project/radare2/libr/anal/p/anal_pic.c"
    mask = (1 << args->b);
 op->type = R_ANAL_OP_TYPE_CJMP;
 op->jump = addr + 4;
 op->fail = addr + 2;
 r_strbuf_appendf (&op->esil, "bsr,0x80,*,0x%x,+,_sram,+" ",[1],0x%x,&,?{,0x%" 
# 144 "project/radare2/libr/anal/p/anal_pic.c" 3 4
"llx" 
# 144 "project/radare2/libr/anal/p/anal_pic.c"
",pc,=,},", args->f, mask, op->jump)
                    ;
}

static void _inst__BRA (RAnal *anal, RAnalOp *op, 
# 148 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 148 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 
# 149 "project/radare2/libr/anal/p/anal_pic.c" 3 4
short 
# 149 "project/radare2/libr/anal/p/anal_pic.c"
     branch = args->k;
 op->type = R_ANAL_OP_TYPE_JMP;
 branch |= ((branch & 0x100) ? 0xfe00 : 0);
 op->jump = addr + 2 * (branch + 1);
 r_strbuf_appendf (&op->esil, "%s0x%x,1,+,2,*,pc,+=,", branch < 0 ? "-" : "", branch < 0 ? -branch : branch)
                                   ;
}

static void _inst__BRW (RAnal *anal, RAnalOp *op, 
# 157 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 157 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 
# 158 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 158 "project/radare2/libr/anal/p/anal_pic.c"
     wreg;
 op->type = R_ANAL_OP_TYPE_UJMP;
 r_anal_esil_reg_read (anal->esil, "wreg", &wreg, 
# 160 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                                 ((void *)0)
# 160 "project/radare2/libr/anal/p/anal_pic.c"
                                                     );
 op->jump = addr + 2 * (wreg + 1);
 r_strbuf_append (&op->esil, "wreg,1,+,2,*,pc,+=,");
}

static void _inst__CLR (RAnal *anal, RAnalOp *op, 
# 165 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 165 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 if (args->d) {
  r_strbuf_appendf (&op->esil, "0x00," "bsr,0x80,*,0x%x,+,_sram,+" ",=[1],", args->f);
 } else {
  r_strbuf_append (&op->esil, "0x00,wreg,=,");
 }
 r_strbuf_append (&op->esil, "1,z,=,");
}

static void _inst__SUBWF (RAnal *anal, RAnalOp *op, 
# 174 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 174 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_SUB;
 if (args->d) {
  r_strbuf_appendf (&op->esil, "wreg," "bsr,0x80,*,0x%x,+,_sram,+" "," "-" "=[1]," "$z,z,:=," "7,$c,c,:=," "4,$c,dc,:=,", args->f);
 } else {
  r_strbuf_appendf (&op->esil, "bsr,0x80,*,0x%x,+,_sram,+" ",[1]," "wreg," "-" "=," "$z,z,:=," "7,$c,c,:=," "4,$c,dc,:=,", args->f);
  r_strbuf_append (&op->esil, "wreg,0x00,-,wreg,=,c,!=,dc,!=,");
 }
}

static void _inst__DECFSZ (RAnal *anal, RAnalOp *op, 
# 184 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 184 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_CJMP;
 op->jump = addr + 4;
 op->fail = addr + 2;
 if (args->d) {
  r_strbuf_appendf (&op->esil, "0x01," "bsr,0x80,*,0x%x,+,_sram,+" ",-=[1],", args->f);
 } else {
  r_strbuf_appendf (&op->esil, "0x01," "bsr,0x80,*,0x%x,+,_sram,+" ",[1],-,wreg,=,", args->f)
              ;
 }
 r_strbuf_appendf (&op->esil, "bsr,0x80,*,0x%x,+,_sram,+" ",[1],!,?{,0x%" 
# 194 "project/radare2/libr/anal/p/anal_pic.c" 3 4
"llx" 
# 194 "project/radare2/libr/anal/p/anal_pic.c"
",pc,=,},", args->f, op->jump)
              ;
}

static void _inst__INCFSZ (RAnal *anal, RAnalOp *op, 
# 198 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 198 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_CJMP;
 op->jump = addr + 4;
 op->fail = addr + 2;
 ...
 r_strbuf_appendf (&op->esil, "bsr,0x80,*,0x%x,+,_sram,+" ",[1],!,?{,0x%" 
# 208 "project/radare2/libr/anal/p/anal_pic.c" 3 4
"llx" 
# 208 "project/radare2/libr/anal/p/anal_pic.c"
",pc,=,},", args->f, op->jump)
              ;
}

static void _inst__INCF (RAnal *anal, RAnalOp *op, 
# 212 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 212 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
...
static void _inst__DECF (RAnal *anal, RAnalOp *op, 
# 223 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 223 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_SUB;
 if (args->d) {
  r_strbuf_appendf (&op->esil, "0x01," "bsr,0x80,*,0x%x,+,_sram,+" ",-=[1],", args->f);
...
static void _inst__IORWF (RAnal *anal, RAnalOp *op, 
# 234 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 234 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
...
static void _inst__ANDWF (RAnal *anal, RAnalOp *op, 
# 243 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 243 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
...
static void _inst__XORWF (RAnal *anal, RAnalOp *op, 
# 252 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 252 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
...
static void _inst__ADDWF (RAnal *anal, RAnalOp *op, 
# 261 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 261 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_ADD;
 if (args->d) {
  r_strbuf_appendf (&op->esil, "wreg," "bsr,0x80,*,0x%x,+,_sram,+" "," "+" "=[1]," "$z,z,:=," "7,$c,c,:=," "4,$c,dc,:=,", args->f);
...
static void _inst__SUBLW (RAnal *anal, RAnalOp *op, 
# 270 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 270 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_SUB;
 r_strbuf_appendf (&op->esil, "0x%x,wreg," "-" "=," "$z,z,:=," "7,$c,c,:=," "4,$c,dc,:=,", args->k);
}

static void _inst__ADDLW (RAnal *anal, RAnalOp *op, 
# 275 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 275 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_ADD;
 r_strbuf_appendf (&op->esil, "0x%x,wreg," "+" "=," "$z,z,:=," "7,$c,c,:=," "4,$c,dc,:=,", args->k);
}

static void _inst__IORLW (RAnal *anal, RAnalOp *op, 
# 280 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 280 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_OR;
 r_strbuf_appendf (&op->esil, "0x%x,wreg," "|" "=," "$z,z,:=," "7,$c,c,:=," "4,$c,dc,:=,", args->k);
}

static void _inst__ANDLW (RAnal *anal, RAnalOp *op, 
# 285 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 285 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_AND;
 r_strbuf_appendf (&op->esil, "0x%x,wreg," "&" "=," "$z,z,:=," "7,$c,c,:=," "4,$c,dc,:=,", args->k);
}

static void _inst__XORLW (RAnal *anal, RAnalOp *op, 
# 290 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 290 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_XOR;
 r_strbuf_appendf (&op->esil, "0x%x,wreg," "^" "=," "$z,z,:=," "7,$c,c,:=," "4,$c,dc,:=,", args->k);
}

static void _inst__MOVLW (RAnal *anal, RAnalOp *op, 
# 295 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 295 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_LOAD;
 r_strbuf_appendf (&op->esil, "0x%x,wreg,=,", args->k);
}

static void _inst__RETLW (RAnal *anal, RAnalOp *op, 
# 300 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 300 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_RET;
 r_strbuf_appendf (&op->esil, "0x%x,wreg,=,", args->k);
 r_strbuf_append (&op->esil, "0x1f,stkptr,==,$z,?{,BREAK,},");
...
static void _inst__MOVLP (RAnal *anal, RAnalOp *op, 
# 309 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 309 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_LOAD;
 r_strbuf_appendf (&op->esil, "0x%x,pclath,=,", args->f);
}

static void _inst__MOVLB (RAnal *anal, RAnalOp *op, 
# 314 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 314 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_LOAD;
 r_strbuf_appendf (&op->esil, "0x%x,bsr,=,", args->k);
}

static void _inst__CALLW (RAnal *anal, RAnalOp *op, 
# 319 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 319 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_UCALL;
 r_strbuf_append (&op->esil, "8,pclath,<<,0x%x,+,wreg,2,*,pc,=,");
 r_strbuf_append (&op->esil, "0x1f,stkptr,==,$z,?{,0xff,stkptr,=,},");
 r_strbuf_append (&op->esil, "0x0f,stkptr,==,$z,?{,0xff,stkptr,=,},");
 r_strbuf_append (&op->esil, "0x01,stkptr,+=,");
 r_strbuf_appendf (&op->esil, "0x%" 
# 325 "project/radare2/libr/anal/p/anal_pic.c" 3 4
"llx" 
# 325 "project/radare2/libr/anal/p/anal_pic.c"
",_stack,stkptr,2,*,+,=[2],", (addr + 2) / 2);
}

static void _inst__MOVWF (RAnal *anal, RAnalOp *op, 
# 328 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 328 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_STORE;
 r_strbuf_appendf (&op->esil, "wreg," "bsr,0x80,*,0x%x,+,_sram,+" ",=[1],", args->f);
}

static void _inst__MOVF (RAnal *anal, RAnalOp *op, 
# 333 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 333 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_LOAD;
 if (args->d) {
  r_strbuf_appendf (&op->esil, "bsr,0x80,*,0x%x,+,_sram,+" ",[1]," "bsr,0x80,*,0x%x,+,_sram,+" ",=[1],", args->f, args->f)

                       ;
 } else {
  r_strbuf_appendf (&op->esil, "bsr,0x80,*,0x%x,+,_sram,+" ",[1],wreg,=,", args->f);
 }
 r_strbuf_append (&op->esil, "$z,z,:=,");
}

static void _inst__SWAPF (RAnal *anal, RAnalOp *op, 
# 345 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 345 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 r_strbuf_appendf (&op->esil, "4," "bsr,0x80,*,0x%x,+,_sram,+" ",[1],>>,0x0f,&,", args->f);
 r_strbuf_appendf (&op->esil, "4," "bsr,0x80,*,0x%x,+,_sram,+" ",[1],<<,0xf0,&,", args->f);
 r_strbuf_append (&op->esil, "|,");
 r_strbuf_appendf (&op->esil, "bsr,0x80,*,0x%x,+,_sram,+" ",=[1],", args->f);
}

static void _inst__LSLF (RAnal *anal, RAnalOp *op, 
# 352 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 352 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_SHL;
 r_strbuf_appendf (&op->esil, "7," "bsr,0x80,*,0x%x,+,_sram,+" ",[1],>>,c,=,", args->f);
 if (args->d) {
  r_strbuf_appendf (&op->esil, "1," "bsr,0x80,*,0x%x,+,_sram,+" ",<<=[1],", args->f);
 } else {
  r_strbuf_appendf (&op->esil, "1," "bsr,0x80,*,0x%x,+,_sram,+" ",[1],<<,wreg,=,", args->f)
              ;
 }
 r_strbuf_append (&op->esil, "$z,z,:=,");
}

static void _inst__LSRF (RAnal *anal, RAnalOp *op, 
# 364 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 364 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_SHR;
 r_strbuf_appendf (&op->esil, "1," "bsr,0x80,*,0x%x,+,_sram,+" ",[1],&,c,=,", args->f);
 if (args->d) {
  r_strbuf_appendf (&op->esil, "1," "bsr,0x80,*,0x%x,+,_sram,+" ",>>=[1],", args->f);
 } else {
  r_strbuf_appendf (&op->esil, "1," "bsr,0x80,*,0x%x,+,_sram,+" ",[1],>>,wreg,=,", args->f)
...
static void _inst__ASRF (RAnal *anal, RAnalOp *op, 
# 376 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 376 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_SHR;
 r_strbuf_appendf (&op->esil, "1," "bsr,0x80,*,0x%x,+,_sram,+" ",[1],&,c,=,", args->f);
 r_strbuf_appendf (&op->esil, "1," "bsr,0x80,*,0x%x,+,_sram,+" ",[1],>>,", args->f);
 r_strbuf_appendf (&op->esil, "0x80," "bsr,0x80,*,0x%x,+,_sram,+" ",[1],&,", args->f);
 if (args->d) {
  r_strbuf_appendf (&op->esil, "|," "bsr,0x80,*,0x%x,+,_sram,+" ",=[1],", args->f);
 } else {
  r_strbuf_append (&op->esil, "|,wreg,=,");
 }
 r_strbuf_append (&op->esil, "$z,z,:=,");
}

static void _inst__RRF (RAnal *anal, RAnalOp *op, 
# 389 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 389 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_ROR;
 r_strbuf_appendf (&op->esil, "1," "bsr,0x80,*,0x%x,+,_sram,+" ",[1],&,", args->f);
 if (args->d) {
  r_strbuf_appendf (&op->esil, "1," "bsr,0x80,*,0x%x,+,_sram,+" ",>>=[1]," "c," "bsr,0x80,*,0x%x,+,_sram,+" ",|=[1],", args->f, args->f)

                       ;
 } else {
  r_strbuf_appendf (&op->esil, "1," "bsr,0x80,*,0x%x,+,_sram,+" ",[1],>>,wreg,=," "c,wreg,|=[1],", args->f)
...
static void _inst__RLF (RAnal *anal, RAnalOp *op, 
# 404 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 404 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_ROL;
 r_strbuf_appendf (&op->esil, "7," "bsr,0x80,*,0x%x,+,_sram,+" ",[1],>>,", args->f);
 if (args->d) {
  r_strbuf_appendf (&op->esil, "1," "bsr,0x80,*,0x%x,+,_sram,+" ",<<=[1]," "c," "bsr,0x80,*,0x%x,+,_sram,+" ",|=[1],", args->f, args->f)
...
static void _inst__COMF (RAnal *anal, RAnalOp *op, 
# 419 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 419 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 if (args->d) {
  r_strbuf_appendf (&op->esil, "0xff," "bsr,0x80,*,0x%x,+,_sram,+" ",^=[1],", args->f);
 } else {
  r_strbuf_appendf (&op->esil, "0xff," "bsr,0x80,*,0x%x,+,_sram,+" ",^,wreg,=,", args->f);
 }
 r_strbuf_append (&op->esil, "$z,z,:=,");
}

static void _inst__RESET (RAnal *anal, RAnalOp *op, 
# 428 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 428 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_JMP;
 op->jump = 0;
 r_strbuf_append (&op->esil, "0x0,pc,=,");
 r_strbuf_append (&op->esil, "0x1f,stkptr,=,");
}

static void _inst__ADDFSR (RAnal *anal, RAnalOp *op, 
# 435 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 435 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_ADD;
 if (args->n == 0) {
  r_strbuf_appendf (&op->esil, "0x%x,fsr0l,+=,", args->k);
  r_strbuf_append (&op->esil, "7,$c,?{,0x01,fsr0h,+=,},");
 } else {
  r_strbuf_appendf (&op->esil, "0x%x,fsr1l,+=,", args->k);
  r_strbuf_append (&op->esil, "7,$c,?{,0x01,fsr1h,+=,},");
 }
}

static void _inst__CLRWDT (RAnal *anal, RAnalOp *op, 
# 446 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 446 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 r_strbuf_append (&op->esil, "1,to,=,");
 r_strbuf_append (&op->esil, "1,pd,=,");
}

static void _inst__SLEEP (RAnal *anal, RAnalOp *op, 
# 451 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 451 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 r_strbuf_append (&op->esil, "1,to,=,");
 r_strbuf_append (&op->esil, "0,pd,=,");
}

static void _inst__SUBWFB (RAnal *anal, RAnalOp *op, 
# 456 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 456 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_SUB;
 r_strbuf_append (&op->esil, "c,!=,");
 if (args->d) {
  r_strbuf_appendf (&op->esil, "c,wreg," "+," "bsr,0x80,*,0x%x,+,_sram,+" "," "-" "=[1]," "$z,z,:=," "7,$c,c,:=," "4,$c,dc,:=,", args->f);
 } else {
  r_strbuf_appendf (&op->esil, "c," "bsr,0x80,*,0x%x,+,_sram,+" ",[1]," "-" "," "wreg," "-" "=," "$z,z,:=," "7,$c,c,:=," "4,$c,dc,:=,", args->f);
  r_strbuf_append (&op->esil, "wreg,0x00,-,wreg,=,c,!=,dc,!=,");
 }
}

static void _inst__ADDWFC (RAnal *anal, RAnalOp *op, 
# 467 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 467 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 op->type = R_ANAL_OP_TYPE_ADD;
 if (args->d) {
  r_strbuf_appendf (&op->esil, "c,wreg," "+," "bsr,0x80,*,0x%x,+,_sram,+" "," "+" "=[1]," "$z,z,:=," "7,$c,c,:=," "4,$c,dc,:=,", args->f);
...
static void _inst__MOVIW_1 (RAnal *anal, RAnalOp *op, 
# 476 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 476 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 if (args->n == 0) {
  if (!(args->m & 2)) {
   r_strbuf_appendf (&op->esil, "1,fsr0l,%s=,", (args->m & 1) ? "-" : "+");
   r_strbuf_appendf (&op->esil, "7,$c%s,fsr0h,%s,", (args->m & 1) ? ",!" : "", (args->m & 1) ? "-" : "+")
                                 ;
  }
  r_strbuf_append (&op->esil, "indf0,wreg,=,");
  r_strbuf_append (&op->esil, "$z,z,:=,");
  if (args->m & 2) {
   r_strbuf_appendf (&op->esil, "1,fsr0l,%s=,", (args->m & 1) ? "-" : "+");
   r_strbuf_appendf (&op->esil, "7,$c%s,fsr0h,%s,", (args->m & 1) ? ",!" : "", (args->m & 1) ? "-" : "+")
  ...
  if (!(args->m & 2)) {
   r_strbuf_appendf (&op->esil, "1,fsr1l,%s=,", (args->m & 1) ? "-" : "+");
   r_strbuf_appendf (&op->esil, "7,$c%s,fsr1h,%s,", (args->m & 1) ? ",!" : "", (args->m & 1) ? "-" : "+")
                                 ;
  }
  r_strbuf_append (&op->esil, "indf1,wreg,=,");
  r_strbuf_append (&op->esil, "$z,z,:=,");
  if (args->m & 2) {
   r_strbuf_appendf (&op->esil, "1,fsr1l,%s=,", (args->m & 1) ? "-" : "+");
   r_strbuf_appendf (&op->esil, "7,$c%s,fsr1h,%s,", (args->m & 1) ? ",!" : "", (args->m & 1) ? "-" : "+")
...
static void _inst__MOVWI_1 (RAnal *anal, RAnalOp *op, 
# 506 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 506 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 if (args->n == 0) {
  if (!(args->m & 2)) {
   r_strbuf_appendf (&op->esil, "1,fsr0l,%s=,", (args->m & 1) ? "-" : "+");
   r_strbuf_appendf (&op->esil, "$c7%s,fsr0h,%s,", (args->m & 1) ? ",!" : "", (args->m & 1) ? "-" : "+")
                                 ;
  }
  r_strbuf_append (&op->esil, "wreg,indf0=,");
  r_strbuf_append (&op->esil, "$z,z,:=,");
  if (args->m & 2) {
   r_strbuf_appendf (&op->esil, "1,fsr0l,%s=,", (args->m & 1) ? "-" : "+");
   r_strbuf_appendf (&op->esil, "$c7%s,fsr0h,%s,", (args->m & 1) ? ",!" : "", (args->m & 1) ? "-" : "+")
  ...
  if (!(args->m & 2)) {
   r_strbuf_appendf (&op->esil, "1,fsr1l,%s=,", (args->m & 1) ? "-" : "+");
   r_strbuf_appendf (&op->esil, "$c7,fsr1h,%s,", (args->m & 1) ? ",!" : "");
  }
  r_strbuf_append (&op->esil, "wreg,indf1=,");
  r_strbuf_append (&op->esil, "$z,z,:=,");
  if (args->m & 2) {
   r_strbuf_appendf (&op->esil, "1,fsr1l,%s=,", (args->m & 1) ? "-" : "+");
   r_strbuf_appendf (&op->esil, "$c7%s,fsr1h,%s,", (args->m & 1) ? ",!" : "", (args->m & 1) ? "-" : "+")
                                 ;
  }
 }
}

static void _inst__MOVIW_2 (RAnal *anal, RAnalOp *op, 
# 535 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 535 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 if (args->n == 0) {
  r_strbuf_append (&op->esil, "fsr0l,8,fsr0h,<<,+,");
 } else {
  r_strbuf_append (&op->esil, "fsr1l,8,fsr1h,<<,+,");
 }
 r_strbuf_appendf (&op->esil, "0x%x,+,[1],wreg,=,", args->k);
}

static void _inst__MOVWI_2 (RAnal *anal, RAnalOp *op, 
# 544 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned long long 
# 544 "project/radare2/libr/anal/p/anal_pic.c"
addr, PicMidrangeOpArgsVal *args) {
 r_strbuf_append (&op->esil, "wreg,");
 if (args->n == 0) {
  r_strbuf_append (&op->esil, "fsr0l,8,fsr0h,<<,+,");
...
static const PicMidrangeOpAnalInfo pic_midrange_op_anal_info[52] = {
 { PIC_MIDRANGE_OPCODE_NOP, PIC_MIDRANGE_OP_ARGS_NONE, _inst__NOP }, { PIC_MIDRANGE_OPCODE_RETURN, PIC_MIDRANGE_OP_ARGS_NONE, _inst__RETURN },
 { PIC_MIDRANGE_OPCODE_RETFIE, PIC_MIDRANGE_OP_ARGS_NONE, _inst__RETFIE }, { PIC_MIDRANGE_OPCODE_OPTION, PIC_MIDRANGE_OP_ARGS_NONE, _inst__OPTION },
 { PIC_MIDRANGE_OPCODE_SLEEP, PIC_MIDRANGE_OP_ARGS_NONE, _inst__SLEEP }, { PIC_MIDRANGE_OPCODE_CLRWDT, PIC_MIDRANGE_OP_ARGS_NONE, _inst__CLRWDT },
 { PIC_MIDRANGE_OPCODE_TRIS, PIC_MIDRANGE_OP_ARGS_2F, _inst__TRIS }, { PIC_MIDRANGE_OPCODE_MOVWF, PIC_MIDRANGE_OP_ARGS_7F, _inst__MOVWF },
 { PIC_MIDRANGE_OPCODE_CLR, PIC_MIDRANGE_OP_ARGS_1D_7F, _inst__CLR }, { PIC_MIDRANGE_OPCODE_SUBWF, PIC_MIDRANGE_OP_ARGS_1D_7F, _inst__SUBWF },
 { PIC_MIDRANGE_OPCODE_DECF, PIC_MIDRANGE_OP_ARGS_1D_7F, _inst__DECF }, { PIC_MIDRANGE_OPCODE_IORWF, PIC_MIDRANGE_OP_ARGS_1D_7F, _inst__IORWF },
 { PIC_MIDRANGE_OPCODE_ANDWF, PIC_MIDRANGE_OP_ARGS_1D_7F, _inst__ANDWF }, { PIC_MIDRANGE_OPCODE_XORWF, PIC_MIDRANGE_OP_ARGS_1D_7F, _inst__XORWF },
 { PIC_MIDRANGE_OPCODE_ADDWF, PIC_MIDRANGE_OP_ARGS_1D_7F, _inst__ADDWF }, { PIC_MIDRANGE_OPCODE_MOVF, PIC_MIDRANGE_OP_ARGS_1D_7F, _inst__MOVF },
 { PIC_MIDRANGE_OPCODE_COMF, PIC_MIDRANGE_OP_ARGS_1D_7F, _inst__COMF }, { PIC_MIDRANGE_OPCODE_INCF, PIC_MIDRANGE_OP_ARGS_1D_7F, _inst__INCF },
 { PIC_MIDRANGE_OPCODE_DECFSZ, PIC_MIDRANGE_OP_ARGS_1D_7F, _inst__DECFSZ }, { PIC_MIDRANGE_OPCODE_RRF, PIC_MIDRANGE_OP_ARGS_1D_7F, _inst__RRF },
 { PIC_MIDRANGE_OPCODE_RLF, PIC_MIDRANGE_OP_ARGS_1D_7F, _inst__RLF }, { PIC_MIDRANGE_OPCODE_SWAPF, PIC_MIDRANGE_OP_ARGS_1D_7F, _inst__SWAPF },
 { PIC_MIDRANGE_OPCODE_INCFSZ, PIC_MIDRANGE_OP_ARGS_1D_7F, _inst__INCFSZ }, { PIC_MIDRANGE_OPCODE_BCF, PIC_MIDRANGE_OP_ARGS_3B_7F, _inst__BCF },
 { PIC_MIDRANGE_OPCODE_BSF, PIC_MIDRANGE_OP_ARGS_3B_7F, _inst__BSF }, { PIC_MIDRANGE_OPCODE_BTFSC, PIC_MIDRANGE_OP_ARGS_3B_7F, _inst__BTFSC },
 { PIC_MIDRANGE_OPCODE_BTFSS, PIC_MIDRANGE_OP_ARGS_3B_7F, _inst__BTFSS }, { PIC_MIDRANGE_OPCODE_CALL, PIC_MIDRANGE_OP_ARGS_11K, _inst__CALL },
 { PIC_MIDRANGE_OPCODE_GOTO, PIC_MIDRANGE_OP_ARGS_11K, _inst__GOTO }, { PIC_MIDRANGE_OPCODE_MOVLW, PIC_MIDRANGE_OP_ARGS_8K, _inst__MOVLW },
 { PIC_MIDRANGE_OPCODE_RETLW, PIC_MIDRANGE_OP_ARGS_8K, _inst__RETLW }, { PIC_MIDRANGE_OPCODE_IORLW, PIC_MIDRANGE_OP_ARGS_8K, _inst__IORLW },
 { PIC_MIDRANGE_OPCODE_ANDLW, PIC_MIDRANGE_OP_ARGS_8K, _inst__ANDLW }, { PIC_MIDRANGE_OPCODE_XORLW, PIC_MIDRANGE_OP_ARGS_8K, _inst__XORLW },
 { PIC_MIDRANGE_OPCODE_SUBLW, PIC_MIDRANGE_OP_ARGS_8K, _inst__SUBLW }, { PIC_MIDRANGE_OPCODE_ADDLW, PIC_MIDRANGE_OP_ARGS_8K, _inst__ADDLW },
 { PIC_MIDRANGE_OPCODE_RESET, PIC_MIDRANGE_OP_ARGS_NONE, _inst__RESET }, { PIC_MIDRANGE_OPCODE_CALLW, PIC_MIDRANGE_OP_ARGS_NONE, _inst__CALLW },
 { PIC_MIDRANGE_OPCODE_BRW, PIC_MIDRANGE_OP_ARGS_NONE, _inst__BRW }, { PIC_MIDRANGE_OPCODE_MOVIW_1, PIC_MIDRANGE_OP_ARGS_1N_2M, _inst__MOVIW_1 },
 { PIC_MIDRANGE_OPCODE_MOVWI_1, PIC_MIDRANGE_OP_ARGS_1N_2M, _inst__MOVWI_1 }, { PIC_MIDRANGE_OPCODE_MOVLB, PIC_MIDRANGE_OP_ARGS_4K, _inst__MOVLB },
 { PIC_MIDRANGE_OPCODE_LSLF, PIC_MIDRANGE_OP_ARGS_1D_7F, _inst__LSLF }, { PIC_MIDRANGE_OPCODE_LSRF, PIC_MIDRANGE_OP_ARGS_1D_7F, _inst__LSRF },
 { PIC_MIDRANGE_OPCODE_ASRF, PIC_MIDRANGE_OP_ARGS_1D_7F, _inst__ASRF }, { PIC_MIDRANGE_OPCODE_SUBWFB, PIC_MIDRANGE_OP_ARGS_1D_7F, _inst__SUBWFB },
 { PIC_MIDRANGE_OPCODE_ADDWFC, PIC_MIDRANGE_OP_ARGS_1D_7F, _inst__ADDWFC }, { PIC_MIDRANGE_OPCODE_ADDFSR, PIC_MIDRANGE_OP_ARGS_1N_6K, _inst__ADDFSR },
 { PIC_MIDRANGE_OPCODE_MOVLP, PIC_MIDRANGE_OP_ARGS_7F, _inst__MOVLP }, { PIC_MIDRANGE_OPCODE_BRA, PIC_MIDRANGE_OP_ARGS_9K, _inst__BRA },
 { PIC_MIDRANGE_OPCODE_MOVIW_2, PIC_MIDRANGE_OP_ARGS_1N_6K, _inst__MOVIW_2 }, { PIC_MIDRANGE_OPCODE_MOVWI_2, PIC_MIDRANGE_OP_ARGS_1N_6K, _inst__MOVWI_2 }
};

static void anal_pic_midrange_extract_args (
# 584 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                           unsigned short 
# 584 "project/radare2/libr/anal/p/anal_pic.c"
                                                instr,
         PicMidrangeOpArgs args,
         PicMidrangeOpArgsVal *args_val) {

 
# 588 "project/radare2/libr/anal/p/anal_pic.c" 3 4
__builtin___memset_chk (
# 588 "project/radare2/libr/anal/p/anal_pic.c"
args_val
# 588 "project/radare2/libr/anal/p/anal_pic.c" 3 4
, 
# 588 "project/radare2/libr/anal/p/anal_pic.c"
0, sizeof (PicMidrangeOpArgsVal)
# 588 "project/radare2/libr/anal/p/anal_pic.c" 3 4
...
# 588 "project/radare2/libr/anal/p/anal_pic.c"
 ...
 case PIC_MIDRANGE_OP_ARGS_2F:
  args_val->f = instr & 0x3;
  return;
 case PIC_MIDRANGE_OP_ARGS_7F:
  args_val->f = instr & 0x7f;
  return;
...
static RIODesc *cpu_memory_map (RIOBind *iob, RIODesc *desc, 
# 636 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                                            unsigned int 
# 636 "project/radare2/libr/anal/p/anal_pic.c"
                                                                 addr,
    
# 637 "project/radare2/libr/anal/p/anal_pic.c" 3 4
   unsigned int 
# 637 "project/radare2/libr/anal/p/anal_pic.c"
        size) {
 char *mstr = r_str_newf ("malloc://%d", size);
 if (desc && iob->fd_get_name (iob->io, desc->fd)) {
  iob->fd_remap (iob->io, desc->fd, addr);
 } else {
  desc = iob->open_at (iob->io, mstr, 
# 642 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                     (4|2)
# 642 "project/radare2/libr/anal/p/anal_pic.c"
                                              , 0, addr);
 }
 free (mstr);
 return desc;
...
static 
# 648 "project/radare2/libr/anal/p/anal_pic.c" 3 4
      _Bool 
# 648 "project/radare2/libr/anal/p/anal_pic.c"
           pic_midrange_reg_write (RReg *reg, const char *regname, 
# 648 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                                                   unsigned int 
# 648 "project/radare2/libr/anal/p/anal_pic.c"
                                                                        num) {
 if (reg) {
  ...
  if (item) {
   ...
   return 
# 653 "project/radare2/libr/anal/p/anal_pic.c" 3 4
         1
# 653 "project/radare2/libr/anal/p/anal_pic.c"
             ;
  }
 }
 return 
# 656 "project/radare2/libr/anal/p/anal_pic.c" 3 4
       0
# 656 "project/radare2/libr/anal/p/anal_pic.c"
            ;
}

static void anal_pic_midrange_malloc (RAnal *anal, 
# 659 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                                  _Bool 
# 659 "project/radare2/libr/anal/p/anal_pic.c"
                                                       force) {
 static 
# 660 "project/radare2/libr/anal/p/anal_pic.c" 3 4
       _Bool 
# 660 "project/radare2/libr/anal/p/anal_pic.c"
            init_done = 
# 660 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                        0
# 660 "project/radare2/libr/anal/p/anal_pic.c"
 ...
 if (!init_done || force) {
  ...
  init_done = 
# 679 "project/radare2/libr/anal/p/anal_pic.c" 3 4
             1
# 679 "project/radare2/libr/anal/p/anal_pic.c"
                 ;
 }
}

static int anal_pic_midrange_op (RAnal *anal, RAnalOp *op, 
# 683 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                                          unsigned long long 
# 683 "project/radare2/libr/anal/p/anal_pic.c"
                                                               addr,
     const 
# 684 "project/radare2/libr/anal/p/anal_pic.c" 3 4
          unsigned char 
# 684 "project/radare2/libr/anal/p/anal_pic.c"
              *buf, int len) {

 
# 686 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned short 
# 686 "project/radare2/libr/anal/p/anal_pic.c"
     instr;
 int i;

 anal_pic_midrange_malloc (anal, 
# 689 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                0
# 689 "project/radare2/libr/anal/p/anal_pic.c"
                                     );
...
static void pic18_cond_branch (RAnalOp *op, 
# 720 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                           unsigned long long 
# 720 "project/radare2/libr/anal/p/anal_pic.c"
                                                addr, const 
# 720 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                                            unsigned char 
# 720 "project/radare2/libr/anal/p/anal_pic.c"
 ...
 op->type = R_ANAL_OP_TYPE_CJMP;
 op->jump = addr + 2 + 2 * (*(
# 722 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                             unsigned short 
# 722 "project/radare2/libr/anal/p/anal_pic.c"
                                  *)buf & 0xff);
 op->fail = addr + op->size;
 op->cycles = 2;
 r_strbuf_setf (&op->esil, "%s,?,{,0x%" 
# 725 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                       "llx" 
# 725 "project/radare2/libr/anal/p/anal_pic.c"
                                               ",pc,=,}", flag, op->jump);
}

static int anal_pic_pic18_op(RAnal *anal, RAnalOp *op, 
# 728 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                                      unsigned long long 
# 728 "project/radare2/libr/anal/p/anal_pic.c"
                                                           addr, const 
# 728 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                                                       unsigned char 
# 728 "project/radare2/libr/anal/p/anal_pic.c"
...
# 736 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned short 
# 736 "project/radare2/libr/anal/p/anal_pic.c"
     b = *(
# 736 "project/radare2/libr/anal/p/anal_pic.c" 3 4
           unsigned short 
# 736 "project/radare2/libr/anal/p/anal_pic.c"
...
# 737 "project/radare2/libr/anal/p/anal_pic.c" 3 4
unsigned int 
# 737 "project/radare2/libr/anal/p/anal_pic.c"
     dword_instr = 0;
 
# 738 "project/radare2/libr/anal/p/anal_pic.c" 3 4
__builtin___memcpy_chk (
# 738 "project/radare2/libr/anal/p/anal_pic.c"
&dword_instr
# 738 "project/radare2/libr/anal/p/anal_pic.c" 3 4
, 
# 738 "project/radare2/libr/anal/p/anal_pic.c"
...
# 738 "project/radare2/libr/anal/p/anal_pic.c"
 ...
 case 0x1a:
  ...
  op->cycles = 2;
  op->jump = addr + 2 + 2 * (*(
# 758 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                              unsigned short 
# 758 "project/radare2/libr/anal/p/anal_pic.c"
                                   *)buf & 0x7ff);
  r_strbuf_setf (&op->esil, "0x%" 
# 759 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                 "llx" 
# 759 "project/radare2/libr/anal/p/anal_pic.c"
                                         ",pc,=", op->jump);
  return op->size;
 }
 switch (b >> 12) {
 ...
 case 0xef:
  ...
  r_strbuf_setf (&op->esil, "0x%" 
# 824 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                 "llx" 
# 824 "project/radare2/libr/anal/p/anal_pic.c"
                                         ",pc,=", op->jump);
  op->type = R_ANAL_OP_TYPE_JMP;
  return op->size;
 case 0xf:
  ...
  r_strbuf_setf (&op->esil, "0x%x,wreg,+=,$z,z,:=,7,$s,n,:=,7,$c,c,:=,7,$o,ov,:=,", *(
# 831 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                                                                     unsigned short 
# 831 "project/radare2/libr/anal/p/anal_pic.c"
                                                                                          *)buf & 0xff);
  return op->size;
 case 0xe:
  op->type = R_ANAL_OP_TYPE_LOAD;
...
# 836 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                             unsigned short
# 836 "project/radare2/libr/anal/p/anal_pic.c"
                                                 * )buf & 0xff);
  return op->size;
 case 0xd:
  op->type = R_ANAL_OP_TYPE_MUL;
  op->cycles = 1;
  r_strbuf_setf (&op->esil, "0x%x,wreg,*,prod,=", *(
# 841 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                                   unsigned short 
# 841 "project/radare2/libr/anal/p/anal_pic.c"
                                                        *)buf & 0xff);
  return op->size;
 case 0xc:
  op->type = R_ANAL_OP_TYPE_RET;
  op->cycles = 2;
  r_strbuf_setf (&op->esil, "0x%x,wreg,=,tos,pc,=,", *(
# 846 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                                      unsigned short 
# 846 "project/radare2/libr/anal/p/anal_pic.c"
                                                           *)buf & 0xff);
  return op->size;
 case 0xb:
  op->type = R_ANAL_OP_TYPE_AND;
  op->cycles = 1;
  r_strbuf_setf (&op->esil, "0x%x,wreg,&=,$z,z,:=,7,$s,n,:=,", *(
# 851 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                                                unsigned short 
# 851 "project/radare2/libr/anal/p/anal_pic.c"
                                                                     *)buf & 0xff);
  return op->size;
 case 0xa:
  op->type = R_ANAL_OP_TYPE_XOR;
  op->cycles = 1;
  r_strbuf_setf (&op->esil, "0x%x,wreg,^=,$z,z,:=,7,$s,n,:=,", *(
# 856 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                                                unsigned short 
# 856 "project/radare2/libr/anal/p/anal_pic.c"
                                                                     *)buf & 0xff);
  return op->size;
 case 0x9:
  op->type = R_ANAL_OP_TYPE_OR;
  op->cycles = 1;
  r_strbuf_setf (&op->esil, "0x%x,wreg,^=,$z,z,:=,7,$s,n,:=,", *(
# 861 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                                                unsigned short 
# 861 "project/radare2/libr/anal/p/anal_pic.c"
                                                                     *)buf & 0xff);
  return op->size;
 case 0x8:
  op->type = R_ANAL_OP_TYPE_SUB;
  ...
  r_strbuf_setf (&op->esil, "wreg,0x%x,-,wreg,=,$z,z,:=,7,$s,n,:=,7,$c,c,:=,7,$o,ov,:=,", *(
# 867 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                                                                           unsigned short 
# 867 "project/radare2/libr/anal/p/anal_pic.c"
                                                                                                *)buf & 0xff);
  return op->size;
 };
 ...
 case 0x10:
  op->type = R_ANAL_OP_TYPE_LOAD;
  op->cycles = 1;
  r_strbuf_setf (&op->esil, "0x%x,bsr,=,", *(
# 954 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                            unsigned short 
# 954 "project/radare2/libr/anal/p/anal_pic.c"
                                                 *)buf & 0xf);
  return op->size;
 };
 switch (b) {
...
static 
# 1007 "project/radare2/libr/anal/p/anal_pic.c" 3 4
      _Bool 
# 1007 "project/radare2/libr/anal/p/anal_pic.c"
           anal_pic_midrange_set_reg_profile (RAnal *esil) {
 const char *p =
  "=PC	pc\n"
  "=SP	stkptr\n"
  "=A0	porta\n"
...
static 
# 1037 "project/radare2/libr/anal/p/anal_pic.c" 3 4
      _Bool 
# 1037 "project/radare2/libr/anal/p/anal_pic.c"
           anal_pic_pic18_set_reg_profile(RAnal *esil) {
 const char *p =
...
static int anal_pic_op(RAnal *anal, RAnalOp *op, 
# 1157 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                                unsigned long long 
# 1157 "project/radare2/libr/anal/p/anal_pic.c"
                                                     addr, const 
# 1157 "project/radare2/libr/anal/p/anal_pic.c" 3 4
                                                                 unsigned char 
# 1157 "project/radare2/libr/anal/p/anal_pic.c"
...
static 
# 1171 "project/radare2/libr/anal/p/anal_pic.c" 3 4
      _Bool 
# 1171 "project/radare2/libr/anal/p/anal_pic.c"
           anal_pic_set_reg_profile(RAnal *anal) {
 if (anal->cpu && strcasecmp (anal->cpu, "baseline") == 0) {
 ...
 return 
# 1182 "project/radare2/libr/anal/p/anal_pic.c" 3 4
       0
# 1182 "project/radare2/libr/anal/p/anal_pic.c"
            ;
}
...
RAnalPlugin r_anal_plugin_pic = {
 ...
 .esil = 
# 1193 "project/radare2/libr/anal/p/anal_pic.c" 3 4
        1

# 1194 "project/radare2/libr/anal/p/anal_pic.c"
};



# 1197 "project/radare2/libr/anal/p/anal_pic.c" 3 4
__attribute__((visibility("default"))) 
# 1197 "project/radare2/libr/anal/p/anal_pic.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ANAL,
 .data = &r_anal_plugin_pic,
 .version = 
# 1200 "project/radare2/libr/anal/p/anal_pic.c" 3 4
           "5.5.4"

# 1201 "project/radare2/libr/anal/p/anal_pic.c"
};
