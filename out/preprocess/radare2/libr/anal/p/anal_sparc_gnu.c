# 0 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
...
# 4 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 2
...
typedef int RRef;
# 6 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 2
...
# 7 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 2
...
# 8 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 2



# 10 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
enum {
 GPR_G0 = 0,
 GPR_G1 = 1,
 GPR_G2 = 2,
...
# 163 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
enum {
 OP_0 = 0,
 OP_1 = 1,
 OP_2 = 2,
...
static 
# 271 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
      long long 
# 271 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
           get_immed_sgnext(const 
# 271 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
                                  unsigned long long 
# 271 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
                                       insn, const 
...
# 271 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
                                                       nbit) {
 const 
# 272 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
      unsigned long long 
# 272 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
           mask = ~(((
# 272 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
                      unsigned long long
# 272 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
 ...
 return (
# 273 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
        long long
# 273 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
            ) ((insn & ~mask)
  | (((insn & ((
# 274 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
               unsigned long long
# 274 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
                   )1 << nbit)) >> nbit) * mask));
}

static RAnalValue * value_fill_addr_pc_disp(const 
# 277 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
                                                 unsigned long long 
# 277 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
                                                      addr, const 
# 277 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
                                                                  long long 
# 277 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
...
static RAnalValue * value_fill_addr_reg_disp(RAnal const * const anal, const int ireg, const 
# 290 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
                                                                                            long long 
# 290 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
                                                                                                 disp) {
 RAnalValue *val = r_anal_value_new();
 val->reg = r_reg_get(anal->reg, gpr_regs[ireg], R_REG_TYPE_GPR);
 val->delta = disp;
...
static void anal_call(RAnalOp *op, const 
# 297 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
                                        unsigned int 
# 297 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
                                             insn, const 
# 297 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
                                                         unsigned long long 
# 297 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
                                                              addr) {
 const 
# 298 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
      long long 
# 298 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
           disp = (get_immed_sgnext(insn, 29) * 4);
...
static void anal_jmpl(RAnal const * const anal, RAnalOp *op, const 
# 305 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
                                                                  unsigned int 
# 305 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
                                                                       insn, const 
# 305 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
                                                                                   unsigned long long 
# 305 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
...
# 306 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
long long 
# 306 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
     disp = 0;
 if ((((insn) >> 13) & 1)) {
  disp = get_immed_sgnext (insn, 12);
 }

 if ((((insn) >> 25) & 0x1f) == GPR_O7) {
  op->type = R_ANAL_OP_TYPE_UCALL;
  op->fail = addr + 4;
 } else if ((((insn) >> 25) & 0x1f) == GPR_G0
  && (((insn) >> 13) & 1) == 1
  && ((((insn) >> 14) & 0x1f) == GPR_I7 || (((insn) >> 14) & 0x1f) == GPR_O7)
  && disp == 8) {
   op->type = R_ANAL_OP_TYPE_RET;
   op->eob = 
# 319 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
            1
# 319 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
                ;
   return;
   }
 else {
  ...
  op->eob = 
# 324 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
           1
# 324 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
               ;
 }

 if((((insn) >> 13) & 1)) {
  op->dst = value_fill_addr_reg_disp(anal, (((insn) >> 14) & 0x1f), disp);
 } else {
  op->dst = value_fill_addr_reg_regdelta(anal, (((insn) >> 14) & 0x1f), (((insn) >> 0) & 0x1f));
 }
}

static void anal_branch(RAnalOp *op, const 
# 334 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
                                          unsigned int 
# 334 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
                                               insn, const 
# 334 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
                                                           unsigned long long 
# 334 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
...
# 335 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
long long 
# 335 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
     disp = 0;
 int r_cond = 0;
 op->eob = 
# 337 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
          1
# 337 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
              ;


 if((((insn) >> 22) & 0x7) == OP2_Bicc || (((insn) >> 22) & 0x7) == OP2_BPcc) {
  r_cond = icc_to_r_cond ((((insn) >> 25) & 0x1f));
 } else if((((insn) >> 22) & 0x7) == OP2_FBfcc || (((insn) >> 22) & 0x7) == OP2_FBPfcc) {
  r_cond = fcc_to_r_cond ((((insn) >> 25) & 0x1f));
 } else if((((insn) >> 22) & 0x7) == OP2_BPr) {
 ...
 if ((((insn) >> 22) & 0x7) == OP2_Bicc || (((insn) >> 22) & 0x7) == OP2_FBfcc) {
  disp = get_immed_sgnext(insn, 21) * 4;
 } else if ((((insn) >> 22) & 0x7) == OP2_BPcc || (((insn) >> 22) & 0x7) == OP2_FBPfcc) {
  disp = get_immed_sgnext (insn, 18) * 4;
 } else if ((((insn) >> 22) & 0x7) == OP2_BPr) {
  disp = get_immed_sgnext ((((((insn) >> 20) & 3) << 14) | (((insn) >> 0) & 0x3fff)), 15) * 4;
 }
 op->dst = value_fill_addr_pc_disp (addr, disp);
 op->jump = addr + disp;
}
...
static int sparc_op(RAnal *anal, RAnalOp *op, 
# 372 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
                                             unsigned long long 
# 372 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
                                                  addr, const 
# 372 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
                                                              unsigned char 
# 372 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
...
# 374 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
unsigned int 
# 374 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
     insn;
...
# 386 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
 __builtin___memcpy_chk (
# 386 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
 &insn
# 386 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
 , 
# 386 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
...
# 386 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
 ...
 } else if((((insn) >> 30) & 0x3) == OP_1) {
  anal_call(op, insn, addr);
 } else if((((insn) >> 30) & 0x3) == OP_2) {
  switch((((insn) >> 19) & 0x3f))
   {
  case OP32_INV1:
  case OP32_INV2:
...
static 
# 467 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
      _Bool 
# 467 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
...
# 622 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
__attribute__((visibility("default"))) 
# 622 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ANAL,
 .data = &r_anal_plugin_sparc_gnu,
 .version = 
# 625 "project/radare2/libr/anal/p/anal_sparc_gnu.c" 3 4
           "5.5.4"

# 626 "project/radare2/libr/anal/p/anal_sparc_gnu.c"
};
