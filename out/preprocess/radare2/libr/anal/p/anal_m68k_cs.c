# 0 "project/radare2/libr/anal/p/anal_m68k_cs.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/anal/p/anal_m68k_cs.c"
...
# 4 "project/radare2/libr/anal/p/anal_m68k_cs.c" 2
...
# 5 "project/radare2/libr/anal/p/anal_m68k_cs.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_m68k_cs.c" 2
# 19 "project/radare2/libr/anal/p/anal_m68k_cs.c"
# 1 "/usr/local/Cellar/capstone/4.0.2/include/capstone/m68k.h" 1 3 4
# 20 "project/radare2/libr/anal/p/anal_m68k_cs.c" 2
# 29 "project/radare2/libr/anal/p/anal_m68k_cs.c"

# 29 "project/radare2/libr/anal/p/anal_m68k_cs.c"
static inline 
# 29 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
             unsigned long long 
# 29 "project/radare2/libr/anal/p/anal_m68k_cs.c"
                  make_64bits_address(
# 29 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
...
# 29 "project/radare2/libr/anal/p/anal_m68k_cs.c"
                                           address) {
 return 
# 30 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
       0xFFFFFFFFU 
# 30 "project/radare2/libr/anal/p/anal_m68k_cs.c"
                & address;
}

static inline void handle_branch_instruction(RAnalOp *op, 
# 33 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
                                                         unsigned long long 
# 33 "project/radare2/libr/anal/p/anal_m68k_cs.c"
                                                              addr, cs_m68k *m68k, 
# 33 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
                                                                                   unsigned int 
# 33 "project/radare2/libr/anal/p/anal_m68k_cs.c"
...
static inline void handle_jump_instruction(RAnalOp *op, 
# 49 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
                                                       unsigned long long 
# 49 "project/radare2/libr/anal/p/anal_m68k_cs.c"
                                                            addr, cs_m68k *m68k, 
# 49 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
                                                                                 unsigned int 
# 49 "project/radare2/libr/anal/p/anal_m68k_cs.c"
...
static void opex(RStrBuf *buf, csh handle, cs_insn *insn) {
 ...
 for (i = 0; i < x->op_count; i++) {
  ...
  case M68K_OP_IMM:
   pj_ks (pj, "type", "imm");
   pj_kN (pj, "value", (
# 81 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
                       long long
# 81 "project/radare2/libr/anal/p/anal_m68k_cs.c"
                           )op->imm);
   break;
  case M68K_OP_MEM:
   pj_ks (pj, "type", "mem");
...
static int parse_reg_name(RRegItem *reg, csh handle, cs_insn *insn, int reg_num) {
 ...
 switch (insn->detail->m68k.operands[reg_num].type) {
 case M68K_OP_REG:
  reg->name = (char *)cs_reg_name (handle, insn->detail->m68k.operands[reg_num].reg);
  break;
 case M68K_OP_MEM:
  if (insn->detail->m68k.operands[reg_num].mem.base_reg != M68K_REG_INVALID) {
   reg->name = (char *)cs_reg_name (handle, insn->detail->m68k.operands[reg_num].mem.base_reg);
  }
  break;
 default:
  break;
...
static void op_fillval(RAnalOp *op, csh handle, cs_insn *insn) {
 static RRegItem reg;
 switch (op->type & 
# 138 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
                   0x8000ffff
# 138 "project/radare2/libr/anal/p/anal_m68k_cs.c"
                                      ) {
 case R_ANAL_OP_TYPE_MOV:
  
# 140 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
 __builtin___memset_chk (&
# 140 "project/radare2/libr/anal/p/anal_m68k_cs.c"
 reg
# 140 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
 , 0, sizeof (
# 140 "project/radare2/libr/anal/p/anal_m68k_cs.c"
...
# 140 "project/radare2/libr/anal/p/anal_m68k_cs.c"
                ;
  if (insn->detail->m68k.operands[1].type == M68K_OP_MEM) {
   op->src[0] = r_anal_value_new ();
   op->src[0]->reg = &reg;
   parse_reg_name (op->src[0]->reg, handle, insn, 1);
   op->src[0]->delta = insn->detail->m68k.operands[0].mem.disp;
  } else if (insn->detail->m68k.operands[0].type == M68K_OP_MEM) {
   op->dst = r_anal_value_new ();
   op->dst->reg = &reg;
   parse_reg_name (op->dst->reg, handle, insn, 0);
   op->dst->delta = insn->detail->m68k.operands[1].mem.disp;
  }
  break;
 case R_ANAL_OP_TYPE_LEA:
  
# 154 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
 __builtin___memset_chk (&
# 154 "project/radare2/libr/anal/p/anal_m68k_cs.c"
 reg
# 154 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
 , 0, sizeof (
# 154 "project/radare2/libr/anal/p/anal_m68k_cs.c"
...
# 165 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
                                        unsigned long long 
# 165 "project/radare2/libr/anal/p/anal_m68k_cs.c"
                                             addr, const 
# 165 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
                                                         unsigned char 
# 165 "project/radare2/libr/anal/p/anal_m68k_cs.c"
 ...
 n = cs_disasm (handle, (
# 211 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
                        unsigned char
# 211 "project/radare2/libr/anal/p/anal_m68k_cs.c"
                           *)buf, len, addr, 1, &insn);
 if (n < 1 || insn->size < 1) {
 ...
 if (!memcmp (buf, "\xff\xff", 
# 218 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
                              (((
# 218 "project/radare2/libr/anal/p/anal_m68k_cs.c"
                              len
# 218 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
                              )>(
# 218 "project/radare2/libr/anal/p/anal_m68k_cs.c"
...
# 218 "project/radare2/libr/anal/p/anal_m68k_cs.c"
 ...
 case M68K_INS_LINK:
  ...
  op->stackptr = -(
# 561 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
                  short
# 561 "project/radare2/libr/anal/p/anal_m68k_cs.c"
                      )insn->detail->m68k.operands[1].imm;
  break;
 case M68K_INS_LSR:
  op->type = R_ANAL_OP_TYPE_SHR;
  break;
...
static 
# 710 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
      _Bool 
# 710 "project/radare2/libr/anal/p/anal_m68k_cs.c"
...
RAnalPlugin r_anal_plugin_m68k_cs = {
 ...
 .license = "BSD",
 .esil = 
# 772 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
        0
# 772 "project/radare2/libr/anal/p/anal_m68k_cs.c"
             ,
 .arch = "m68k",
...
# 789 "project/radare2/libr/anal/p/anal_m68k_cs.c"

# 789 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
__attribute__((visibility("default"))) 
# 789 "project/radare2/libr/anal/p/anal_m68k_cs.c"
 ...
 .version = 
# 792 "project/radare2/libr/anal/p/anal_m68k_cs.c" 3 4
           "5.5.4"

# 793 "project/radare2/libr/anal/p/anal_m68k_cs.c"
};
