# 0 "project/radare2/libr/anal/p/anal_tms320.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/anal/p/anal_tms320.c"
# 9 "project/radare2/libr/anal/p/anal_tms320.c"
...
# 10 "project/radare2/libr/anal/p/anal_tms320.c" 2
# 1 "project/radare2/libr/anal/p/anal_tms320c64x.c" 1
...
# 5 "project/radare2/libr/anal/p/anal_tms320c64x.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_tms320c64x.c" 2
# 25 "project/radare2/libr/anal/p/anal_tms320c64x.c"
...
static void opex(RStrBuf *buf, csh handle, cs_insn *insn) {
 ...
 for (i = 0; i < x->op_count; i++) {
  ...
  case TMS320C64X_OP_MEM:
   ...
   pj_kN (pj, "disp", (
# 51 "project/radare2/libr/anal/p/anal_tms320c64x.c" 3 4
                      long long
# 51 "project/radare2/libr/anal/p/anal_tms320c64x.c"
                          )op->mem.disp);
   break;
  default:
...
static int tms320c64x_analop(RAnal *a, RAnalOp *op, 
# 67 "project/radare2/libr/anal/p/anal_tms320c64x.c" 3 4
                                                   unsigned long long 
# 67 "project/radare2/libr/anal/p/anal_tms320c64x.c"
                                                        addr, const 
# 67 "project/radare2/libr/anal/p/anal_tms320c64x.c" 3 4
                                                                    unsigned char 
# 67 "project/radare2/libr/anal/p/anal_tms320c64x.c"
...
# 86 "project/radare2/libr/anal/p/anal_tms320c64x.c" 3 4
                              unsigned char
# 86 "project/radare2/libr/anal/p/anal_tms320c64x.c"
                                 *)buf, len, addr, 1, &insn);
 if (n < 1) {
  ...
  case TMS320C64X_INS_B:
   ...
   op->jump = insn->detail->tms320c64x.operands[0].imm + (addr & 0xFFFFFFFF00000000);
   break;
...
# 11 "project/radare2/libr/anal/p/anal_tms320.c" 2
# 1 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h" 1
...
# 93 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h" 3 4
unsigned char 
# 93 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h"
     f, n, v;
};
...
# 98 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h" 3 4
unsigned char 
# 98 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h"
     f, v;
};

struct tms320_instruction_head {
 
# 102 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h" 3 4
unsigned char 
# 102 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h"
     byte;
 
# 103 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h" 3 4
unsigned char 
# 103 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h"
     size;
 insn_item_t insn;
};
...
# 116 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h" 3 4
 unsigned char 
# 116 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h"
      opcode;
  
# 117 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h" 3 4
 unsigned char 
# 117 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h"
      stream[8];
  
# 118 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h" 3 4
 unsigned long long 
# 118 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h"
       opcode64;
 };


 
# 122 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h" 3 4
unsigned char 
# 122 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h"
      status;
 
# 123 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h" 3 4
unsigned char 
# 123 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h"
      length;
 char syntax[1024];
...
# 210 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h" 3 4
unsigned int 
# 210 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h"
       features;


} tms320_dasm_t;
# 240 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h"
extern int tms320_dasm(tms320_dasm_t *, const 
# 240 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h" 3 4
                                             unsigned char 
# 240 "project/radare2/libr/anal/p/../../asm/arch/tms320/tms320_dasm.h"
                                                 *, int);
...
# 12 "project/radare2/libr/anal/p/anal_tms320.c" 2

static tms320_dasm_t engine = { 0 };

typedef int (* TMS_ANAL_OP_FN)(RAnal *anal, RAnalOp *op, 
# 15 "project/radare2/libr/anal/p/anal_tms320.c" 3 4
                                                        unsigned long long 
# 15 "project/radare2/libr/anal/p/anal_tms320.c"
                                                             addr, const 
# 15 "project/radare2/libr/anal/p/anal_tms320.c" 3 4
                                                                         unsigned char 
# 15 "project/radare2/libr/anal/p/anal_tms320.c"
...
int tms320_c54x_op(RAnal *anal, RAnalOp *op, 
# 17 "project/radare2/libr/anal/p/anal_tms320.c" 3 4
                                            unsigned long long 
# 17 "project/radare2/libr/anal/p/anal_tms320.c"
                                                 addr, const 
# 17 "project/radare2/libr/anal/p/anal_tms320.c" 3 4
                                                             unsigned char 
# 17 "project/radare2/libr/anal/p/anal_tms320.c"
                                                                 *buf, int len);
int tms320_c55x_op(RAnal *anal, RAnalOp *op, 
# 18 "project/radare2/libr/anal/p/anal_tms320.c" 3 4
                                            unsigned long long 
# 18 "project/radare2/libr/anal/p/anal_tms320.c"
                                                 addr, const 
# 18 "project/radare2/libr/anal/p/anal_tms320.c" 3 4
                                                             unsigned char 
# 18 "project/radare2/libr/anal/p/anal_tms320.c"
...
# 19 "project/radare2/libr/anal/p/anal_tms320.c" 3 4
                                                 unsigned long long 
# 19 "project/radare2/libr/anal/p/anal_tms320.c"
                                                      addr, const 
# 19 "project/radare2/libr/anal/p/anal_tms320.c" 3 4
                                                                  unsigned char 
# 19 "project/radare2/libr/anal/p/anal_tms320.c"
...
static 
# 21 "project/radare2/libr/anal/p/anal_tms320.c" 3 4
      _Bool 
# 21 "project/radare2/libr/anal/p/anal_tms320.c"
           match(const char * str, const char * token) {
 return !strncasecmp(str, token, strlen(token));
}

int tms320_c54x_op(RAnal *anal, RAnalOp *op, 
# 25 "project/radare2/libr/anal/p/anal_tms320.c" 3 4
                                            unsigned long long 
# 25 "project/radare2/libr/anal/p/anal_tms320.c"
                                                 addr, const 
# 25 "project/radare2/libr/anal/p/anal_tms320.c" 3 4
                                                             unsigned char 
# 25 "project/radare2/libr/anal/p/anal_tms320.c"
...
int tms320_c55x_op(RAnal *anal, RAnalOp *op, 
# 30 "project/radare2/libr/anal/p/anal_tms320.c" 3 4
                                            unsigned long long 
# 30 "project/radare2/libr/anal/p/anal_tms320.c"
                                                 addr, const 
# 30 "project/radare2/libr/anal/p/anal_tms320.c" 3 4
                                                             unsigned char 
# 30 "project/radare2/libr/anal/p/anal_tms320.c"
...
int tms320_op(RAnal * anal, RAnalOp * op, 
# 83 "project/radare2/libr/anal/p/anal_tms320.c" 3 4
                                         unsigned long long 
# 83 "project/radare2/libr/anal/p/anal_tms320.c"
                                              addr, const 
# 83 "project/radare2/libr/anal/p/anal_tms320.c" 3 4
                                                          unsigned char 
# 83 "project/radare2/libr/anal/p/anal_tms320.c"
...
# 123 "project/radare2/libr/anal/p/anal_tms320.c" 3 4
__attribute__((visibility("default"))) 
# 123 "project/radare2/libr/anal/p/anal_tms320.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ANAL,
 .data = &r_anal_plugin_tms320,
 .version = 
# 126 "project/radare2/libr/anal/p/anal_tms320.c" 3 4
           "5.5.4"

# 127 "project/radare2/libr/anal/p/anal_tms320.c"
};
