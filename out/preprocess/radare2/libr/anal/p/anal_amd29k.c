# 0 "project/radare2/libr/anal/p/anal_amd29k.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/anal/p/anal_amd29k.c"
...
# 4 "project/radare2/libr/anal/p/anal_amd29k.c" 2
...
# 5 "project/radare2/libr/anal/p/anal_amd29k.c" 2
# 1 "project/radare2/libr/anal/p/../../asm/arch/amd29k/amd29k.h" 1
# 14 "project/radare2/libr/anal/p/../../asm/arch/amd29k/amd29k.h"

# 14 "project/radare2/libr/anal/p/../../asm/arch/amd29k/amd29k.h"
typedef struct amd29k_instr_s {
 const char* mnemonic;
 
# 16 "project/radare2/libr/anal/p/../../asm/arch/amd29k/amd29k.h" 3 4
unsigned long long 
# 16 "project/radare2/libr/anal/p/../../asm/arch/amd29k/amd29k.h"
            op_type;
 
# 17 "project/radare2/libr/anal/p/../../asm/arch/amd29k/amd29k.h" 3 4
unsigned int 
# 17 "project/radare2/libr/anal/p/../../asm/arch/amd29k/amd29k.h"
            operands[6];
 char type[6];
} amd29k_instr_t;


# 21 "project/radare2/libr/anal/p/../../asm/arch/amd29k/amd29k.h" 3 4
_Bool 
# 21 "project/radare2/libr/anal/p/../../asm/arch/amd29k/amd29k.h"
...
# 22 "project/radare2/libr/anal/p/../../asm/arch/amd29k/amd29k.h" 3 4
                                                      unsigned long long 
# 22 "project/radare2/libr/anal/p/../../asm/arch/amd29k/amd29k.h"
                                                           address, amd29k_instr_t* instruction);


# 24 "project/radare2/libr/anal/p/../../asm/arch/amd29k/amd29k.h" 3 4
_Bool 
# 24 "project/radare2/libr/anal/p/../../asm/arch/amd29k/amd29k.h"
    amd29k_instr_is_ret(amd29k_instr_t* instruction);

# 25 "project/radare2/libr/anal/p/../../asm/arch/amd29k/amd29k.h" 3 4
unsigned long long 
# 25 "project/radare2/libr/anal/p/../../asm/arch/amd29k/amd29k.h"
    amd29k_instr_jump(
# 25 "project/radare2/libr/anal/p/../../asm/arch/amd29k/amd29k.h" 3 4
                      unsigned long long 
# 25 "project/radare2/libr/anal/p/../../asm/arch/amd29k/amd29k.h"
                           address, amd29k_instr_t* instruction);
# 6 "project/radare2/libr/anal/p/anal_amd29k.c" 2


static 
# 8 "project/radare2/libr/anal/p/anal_amd29k.c" 3 4
      _Bool 
# 8 "project/radare2/libr/anal/p/anal_amd29k.c"
...
# 285 "project/radare2/libr/anal/p/anal_amd29k.c" 3 4
                                        unsigned long long 
# 285 "project/radare2/libr/anal/p/anal_amd29k.c"
                                             addr, const 
# 285 "project/radare2/libr/anal/p/anal_amd29k.c" 3 4
                                                         unsigned char 
# 285 "project/radare2/libr/anal/p/anal_amd29k.c"
 ...
 op->size = 4;
 op->eob = 
# 287 "project/radare2/libr/anal/p/anal_amd29k.c" 3 4
          0
# 287 "project/radare2/libr/anal/p/anal_amd29k.c"
               ;
 ...
 if (amd29k_instr_decode (buf, len, &instruction, a->cpu)) {
  ...
  case R_ANAL_OP_TYPE_ICALL:
   if (amd29k_instr_is_ret (&instruction)) {
    ...
    op->eob = 
# 307 "project/radare2/libr/anal/p/anal_amd29k.c" 3 4
             1
# 307 "project/radare2/libr/anal/p/anal_amd29k.c"
                 ;
   }
  ...
  case R_ANAL_OP_TYPE_RET:
   op->eob = 
# 312 "project/radare2/libr/anal/p/anal_amd29k.c" 3 4
            1
# 312 "project/radare2/libr/anal/p/anal_amd29k.c"
                ;
...
RAnalPlugin r_anal_plugin_amd29k = {
 ...
 .license = "BSD",
 .esil = 
# 328 "project/radare2/libr/anal/p/anal_amd29k.c" 3 4
        0
# 328 "project/radare2/libr/anal/p/anal_amd29k.c"
             ,
 .arch = "amd29k",
 .bits = 32,
 .archinfo = archinfo,
...
# 337 "project/radare2/libr/anal/p/anal_amd29k.c" 3 4
__attribute__((visibility("default"))) 
# 337 "project/radare2/libr/anal/p/anal_amd29k.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ANAL,
 .data = &r_anal_plugin_amd29k,
 .version = 
# 340 "project/radare2/libr/anal/p/anal_amd29k.c" 3 4
           "5.5.4"

# 341 "project/radare2/libr/anal/p/anal_amd29k.c"
};
