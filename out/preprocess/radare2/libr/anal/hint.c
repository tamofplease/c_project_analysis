# 0 "project/radare2/libr/anal/hint.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/anal/hint.c"
...
# 4 "project/radare2/libr/anal/hint.c" 2
...
# 9 "project/radare2/libr/anal/hint.c"
typedef struct r_anal_ranged_hint_record_base_t {
 RBNode rb;
 
# 11 "project/radare2/libr/anal/hint.c" 3 4
unsigned long long 
# 11 "project/radare2/libr/anal/hint.c"
     addr;
} RAnalRangedHintRecordBase;

typedef struct r_anal_arch_hint_record_t {
 RAnalRangedHintRecordBase base;
 char *arch;
} RAnalArchHintRecord;
...
# 25 "project/radare2/libr/anal/hint.c" 3 4
unsigned long long 
# 25 "project/radare2/libr/anal/hint.c"
     addr = *(const 
# 25 "project/radare2/libr/anal/hint.c" 3 4
                    unsigned long long 
# 25 "project/radare2/libr/anal/hint.c"
                         *)incoming;
 const RAnalRangedHintRecordBase *in_tree_record = 
# 26 "project/radare2/libr/anal/hint.c" 3 4
                                                  ((
# 26 "project/radare2/libr/anal/hint.c"
                                                  const RAnalRangedHintRecordBase 
# 26 "project/radare2/libr/anal/hint.c" 3 4
                                                  *)((char *)(__typeof__(((
# 26 "project/radare2/libr/anal/hint.c"
                                                  const RAnalRangedHintRecordBase 
...
static void bits_hint_record_free_rb(RBNode *node, void *user) {
 free (
# 61 "project/radare2/libr/anal/hint.c" 3 4
      ((
# 61 "project/radare2/libr/anal/hint.c"
      RAnalRangedHintRecordBase 
# 61 "project/radare2/libr/anal/hint.c" 3 4
      *)((char *)(__typeof__(((
# 61 "project/radare2/libr/anal/hint.c"
...
static void arch_hint_record_free_rb(RBNode *node, void *user) {
 RAnalArchHintRecord *record = (RAnalArchHintRecord *)
# 65 "project/radare2/libr/anal/hint.c" 3 4
                                                     ((
# 65 "project/radare2/libr/anal/hint.c"
                                                     RAnalRangedHintRecordBase 
# 65 "project/radare2/libr/anal/hint.c" 3 4
                                                     *)((char *)(__typeof__(((
# 65 "project/radare2/libr/anal/hint.c"
...
void r_anal_hint_storage_init(RAnal *a) {
 a->addr_hints = ht_up_new (
# 72 "project/radare2/libr/anal/hint.c" 3 4
                           ((void *)0)
# 72 "project/radare2/libr/anal/hint.c"
...
# 72 "project/radare2/libr/anal/hint.c"
 ...
 a->arch_hints = 
# 73 "project/radare2/libr/anal/hint.c" 3 4
                ((void *)0)
# 73 "project/radare2/libr/anal/hint.c"
                    ;
 a->bits_hints = 
# 74 "project/radare2/libr/anal/hint.c" 3 4
                ((void *)0)
# 74 "project/radare2/libr/anal/hint.c"
                    ;
}
...
void r_anal_hint_storage_fini(RAnal *a) {
 ...
 r_rbtree_free (a->arch_hints, arch_hint_record_free_rb, 
# 80 "project/radare2/libr/anal/hint.c" 3 4
                                                        ((void *)0)
# 80 "project/radare2/libr/anal/hint.c"
                                                            );
 r_rbtree_free (a->bits_hints, bits_hint_record_free_rb, 
# 81 "project/radare2/libr/anal/hint.c" 3 4
                                                        ((void *)0)
# 81 "project/radare2/libr/anal/hint.c"
                                                            );
}


# 84 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 84 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_clear(RAnal *a) {
...
# 91 "project/radare2/libr/anal/hint.c" 3 4
unsigned long long 
# 91 "project/radare2/libr/anal/hint.c"
     addr;
 
# 92 "project/radare2/libr/anal/hint.c" 3 4
unsigned long long 
# 92 "project/radare2/libr/anal/hint.c"
     size;
} DeleteRangeCtx;

static 
# 95 "project/radare2/libr/anal/hint.c" 3 4
      _Bool 
# 95 "project/radare2/libr/anal/hint.c"
           addr_hint_range_delete_cb(void *user, const 
# 95 "project/radare2/libr/anal/hint.c" 3 4
                                                       unsigned long long 
# 95 "project/radare2/libr/anal/hint.c"
 ...
 if (key < ctx->addr || key >= ctx->addr + ctx->size) {
  return 
# 98 "project/radare2/libr/anal/hint.c" 3 4
        1
# 98 "project/radare2/libr/anal/hint.c"
            ;
 }
 ht_up_delete (ctx->ht, key);
 return 
# 101 "project/radare2/libr/anal/hint.c" 3 4
       1
# 101 "project/radare2/libr/anal/hint.c"
           ;
}


# 104 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 104 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_del(RAnal *a, 
# 104 "project/radare2/libr/anal/hint.c" 3 4
                                    unsigned long long 
# 104 "project/radare2/libr/anal/hint.c"
                                         addr, 
...
# 104 "project/radare2/libr/anal/hint.c"
 ...
 while (
# 115 "project/radare2/libr/anal/hint.c" 3 4
       1
# 115 "project/radare2/libr/anal/hint.c"
           ) {
  RBNode *node = r_rbtree_lower_bound (a->arch_hints, &addr, ranged_hint_record_cmp, 
# 116 "project/radare2/libr/anal/hint.c" 3 4
                                                                                    ((void *)0)
# 116 "project/radare2/libr/anal/hint.c"
                                                                                        );
  if (!node) {
   return;
  }
  RAnalRangedHintRecordBase *base = 
# 120 "project/radare2/libr/anal/hint.c" 3 4
                                   ((
# 120 "project/radare2/libr/anal/hint.c"
                                   RAnalRangedHintRecordBase 
# 120 "project/radare2/libr/anal/hint.c" 3 4
                                   *)((char *)(__typeof__(((
# 120 "project/radare2/libr/anal/hint.c"
...
# 120 "project/radare2/libr/anal/hint.c"
 ...
 while (
# 126 "project/radare2/libr/anal/hint.c" 3 4
       1
# 126 "project/radare2/libr/anal/hint.c"
           ) {
  RBNode *node = r_rbtree_lower_bound (a->bits_hints, &addr, ranged_hint_record_cmp, 
# 127 "project/radare2/libr/anal/hint.c" 3 4
                                                                                    ((void *)0)
# 127 "project/radare2/libr/anal/hint.c"
                                                                                        );
  if (!node) {
   return;
  }
  RAnalRangedHintRecordBase *base = 
# 131 "project/radare2/libr/anal/hint.c" 3 4
                                   ((
# 131 "project/radare2/libr/anal/hint.c"
                                   RAnalRangedHintRecordBase 
# 131 "project/radare2/libr/anal/hint.c" 3 4
                                   *)((char *)(__typeof__(((
# 131 "project/radare2/libr/anal/hint.c"
...
static void unset_addr_hint_record(RAnal *anal, RAnalAddrHintType type, 
# 139 "project/radare2/libr/anal/hint.c" 3 4
                                                                       unsigned long long 
# 139 "project/radare2/libr/anal/hint.c"
                                                                            addr) {
 RVector *records = ht_up_find (anal->addr_hints, addr, 
# 140 "project/radare2/libr/anal/hint.c" 3 4
                                                       ((void *)0)
# 140 "project/radare2/libr/anal/hint.c"
                                                           );
 if (!records) {
  return;
 }
 ...
 for (i = 0; i < records->len; i++) {
  ...
  if (record->type == type) {
   addr_hint_record_fini (record, 
# 148 "project/radare2/libr/anal/hint.c" 3 4
                                 ((void *)0)
# 148 "project/radare2/libr/anal/hint.c"
                                     );
   r_vector_remove_at (records, i, 
# 149 "project/radare2/libr/anal/hint.c" 3 4
                                  ((void *)0)
# 149 "project/radare2/libr/anal/hint.c"
                                      );
   return;
  }
 }
...
static RAnalAddrHintRecord *ensure_addr_hint_record(RAnal *anal, RAnalAddrHintType type, 
# 156 "project/radare2/libr/anal/hint.c" 3 4
                                                                                        unsigned long long 
# 156 "project/radare2/libr/anal/hint.c"
                                                                                             addr) {
 RVector *records = ht_up_find (anal->addr_hints, addr, 
# 157 "project/radare2/libr/anal/hint.c" 3 4
                                                       ((void *)0)
# 157 "project/radare2/libr/anal/hint.c"
                                                           );
 if (!records) {
  records = r_vector_new (sizeof (RAnalAddrHintRecord), addr_hint_record_fini, 
# 159 "project/radare2/libr/anal/hint.c" 3 4
                                                                              ((void *)0)
# 159 "project/radare2/libr/anal/hint.c"
                                                                                  );
  if (!records) {
   return 
# 161 "project/radare2/libr/anal/hint.c" 3 4
         ((void *)0)
# 161 "project/radare2/libr/anal/hint.c"
             ;
  }
...
# 166 "project/radare2/libr/anal/hint.c" 3 4
if (!r_vector_empty (
# 166 "project/radare2/libr/anal/hint.c"
records
# 166 "project/radare2/libr/anal/hint.c" 3 4
)) for (
# 166 "project/radare2/libr/anal/hint.c"
...
# 166 "project/radare2/libr/anal/hint.c"
 ...
 RAnalAddrHintRecord *record = r_vector_push (records, 
# 172 "project/radare2/libr/anal/hint.c" 3 4
                                                      ((void *)0)
# 172 "project/radare2/libr/anal/hint.c"
                                                          );
 
# 173 "project/radare2/libr/anal/hint.c" 3 4
__builtin___memset_chk (
# 173 "project/radare2/libr/anal/hint.c"
record
# 173 "project/radare2/libr/anal/hint.c" 3 4
, 
# 173 "project/radare2/libr/anal/hint.c"
...
# 186 "project/radare2/libr/anal/hint.c"
static RAnalRangedHintRecordBase *ensure_ranged_hint_record(RBTree *tree, 
# 186 "project/radare2/libr/anal/hint.c" 3 4
                                                                         unsigned long long 
# 186 "project/radare2/libr/anal/hint.c"
                                                                              addr, size_t sz) {
 RBNode *node = r_rbtree_find (*tree, &addr, ranged_hint_record_cmp, 
# 187 "project/radare2/libr/anal/hint.c" 3 4
                                                                    ((void *)0)
# 187 "project/radare2/libr/anal/hint.c"
                                                                        );
 if (node) {
  return 
# 189 "project/radare2/libr/anal/hint.c" 3 4
        ((
# 189 "project/radare2/libr/anal/hint.c"
        RAnalRangedHintRecordBase 
# 189 "project/radare2/libr/anal/hint.c" 3 4
        *)((char *)(__typeof__(((
# 189 "project/radare2/libr/anal/hint.c"
...
# 192 "project/radare2/libr/anal/hint.c" 3 4
__builtin___memset_chk (
# 192 "project/radare2/libr/anal/hint.c"
record
# 192 "project/radare2/libr/anal/hint.c" 3 4
, 
# 192 "project/radare2/libr/anal/hint.c"
...
# 192 "project/radare2/libr/anal/hint.c"
 ...
 if (!record) {
  return 
# 194 "project/radare2/libr/anal/hint.c" 3 4
        ((void *)0)
# 194 "project/radare2/libr/anal/hint.c"
            ;
 }
 record->addr = addr;
 r_rbtree_insert (tree, &addr, &record->rb, ranged_hint_record_cmp, 
# 197 "project/radare2/libr/anal/hint.c" 3 4
                                                                   ((void *)0)
# 197 "project/radare2/libr/anal/hint.c"
                                                                       );
 return record;
}


# 201 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 201 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_set_offset(RAnal *a, 
# 201 "project/radare2/libr/anal/hint.c" 3 4
                                           unsigned long long 
# 201 "project/radare2/libr/anal/hint.c"
                                                addr, const char *typeoff) {
 do { RAnalAddrHintRecord *r = ensure_addr_hint_record (a, R_ANAL_ADDR_HINT_TYPE_TYPE_OFFSET, addr); if (!r) { break; } free (r->type_offset); r->type_offset = strdup (typeoff); } while(0)
...
# 208 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 208 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_set_nword(RAnal *a, 
# 208 "project/radare2/libr/anal/hint.c" 3 4
                                          unsigned long long 
# 208 "project/radare2/libr/anal/hint.c"
                                               addr, int nword) {
 do { RAnalAddrHintRecord *r = ensure_addr_hint_record (a, R_ANAL_ADDR_HINT_TYPE_NWORD, addr); if (!r) { break; } r->nword = nword; } while(0);
}


# 212 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 212 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_set_jump(RAnal *a, 
# 212 "project/radare2/libr/anal/hint.c" 3 4
                                         unsigned long long 
# 212 "project/radare2/libr/anal/hint.c"
                                              addr, 
...
# 212 "project/radare2/libr/anal/hint.c"
                                                         jump) {
 do { RAnalAddrHintRecord *r = ensure_addr_hint_record (a, R_ANAL_ADDR_HINT_TYPE_JUMP, addr); if (!r) { break; } r->jump = jump; } while(0);
}


# 216 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 216 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_set_fail(RAnal *a, 
# 216 "project/radare2/libr/anal/hint.c" 3 4
                                         unsigned long long 
# 216 "project/radare2/libr/anal/hint.c"
                                              addr, 
...
# 216 "project/radare2/libr/anal/hint.c"
                                                         fail) {
 do { RAnalAddrHintRecord *r = ensure_addr_hint_record (a, R_ANAL_ADDR_HINT_TYPE_FAIL, addr); if (!r) { break; } r->fail = fail; } while(0);
}


# 220 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 220 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_set_newbits(RAnal *a, 
# 220 "project/radare2/libr/anal/hint.c" 3 4
                                            unsigned long long 
# 220 "project/radare2/libr/anal/hint.c"
                                                 addr, int bits) {
 do { RAnalAddrHintRecord *r = ensure_addr_hint_record (a, R_ANAL_ADDR_HINT_TYPE_NEW_BITS, addr); if (!r) { break; } r->newbits = bits; } while(0);
}


# 224 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 224 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_set_high(RAnal *a, 
# 224 "project/radare2/libr/anal/hint.c" 3 4
                                         unsigned long long 
# 224 "project/radare2/libr/anal/hint.c"
                                              addr) {
 do { RAnalAddrHintRecord *r = ensure_addr_hint_record (a, R_ANAL_ADDR_HINT_TYPE_HIGH, addr); if (!r) { break; } } while(0);
}


# 228 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 228 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_set_immbase(RAnal *a, 
# 228 "project/radare2/libr/anal/hint.c" 3 4
                                            unsigned long long 
# 228 "project/radare2/libr/anal/hint.c"
                                                 addr, int base) {
 if (base) {
  do { RAnalAddrHintRecord *r = ensure_addr_hint_record (a, R_ANAL_ADDR_HINT_TYPE_IMMBASE, addr); if (!r) { break; } r->immbase = base; } while(0);
 } else {
...
# 236 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 236 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_set_pointer(RAnal *a, 
# 236 "project/radare2/libr/anal/hint.c" 3 4
                                            unsigned long long 
# 236 "project/radare2/libr/anal/hint.c"
                                                 addr, 
...
# 236 "project/radare2/libr/anal/hint.c"
                                                            ptr) {
 do { RAnalAddrHintRecord *r = ensure_addr_hint_record (a, R_ANAL_ADDR_HINT_TYPE_PTR, addr); if (!r) { break; } r->ptr = ptr; } while(0);
}


# 240 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 240 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_set_ret(RAnal *a, 
# 240 "project/radare2/libr/anal/hint.c" 3 4
                                        unsigned long long 
# 240 "project/radare2/libr/anal/hint.c"
                                             addr, 
...
# 240 "project/radare2/libr/anal/hint.c"
                                                        val) {
 do { RAnalAddrHintRecord *r = ensure_addr_hint_record (a, R_ANAL_ADDR_HINT_TYPE_RET, addr); if (!r) { break; } r->retval = val; } while(0);
}


# 244 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 244 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_set_syntax(RAnal *a, 
# 244 "project/radare2/libr/anal/hint.c" 3 4
                                           unsigned long long 
# 244 "project/radare2/libr/anal/hint.c"
                                                addr, const char *syn) {
 do { RAnalAddrHintRecord *r = ensure_addr_hint_record (a, R_ANAL_ADDR_HINT_TYPE_SYNTAX, addr); if (!r) { break; } free (r->syntax); r->syntax = strdup (syn); } while(0)
...
# 251 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 251 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_set_opcode(RAnal *a, 
# 251 "project/radare2/libr/anal/hint.c" 3 4
                                           unsigned long long 
# 251 "project/radare2/libr/anal/hint.c"
                                                addr, const char *opcode) {
 do { RAnalAddrHintRecord *r = ensure_addr_hint_record (a, R_ANAL_ADDR_HINT_TYPE_OPCODE, addr); if (!r) { break; } free (r->opcode); r->opcode = strdup (opcode); } while(0)
...
# 258 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 258 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_set_esil(RAnal *a, 
# 258 "project/radare2/libr/anal/hint.c" 3 4
                                         unsigned long long 
# 258 "project/radare2/libr/anal/hint.c"
                                              addr, const char *esil) {
 do { RAnalAddrHintRecord *r = ensure_addr_hint_record (a, R_ANAL_ADDR_HINT_TYPE_ESIL, addr); if (!r) { break; } free (r->esil); r->esil = strdup (esil); } while(0)
...
# 265 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 265 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_set_type (RAnal *a, 
# 265 "project/radare2/libr/anal/hint.c" 3 4
                                          unsigned long long 
# 265 "project/radare2/libr/anal/hint.c"
                                               addr, int type) {
 do { RAnalAddrHintRecord *r = ensure_addr_hint_record (a, R_ANAL_ADDR_HINT_TYPE_OPTYPE, addr); if (!r) { break; } r->optype = type; } while(0);
}


# 269 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 269 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_set_size(RAnal *a, 
# 269 "project/radare2/libr/anal/hint.c" 3 4
                                         unsigned long long 
# 269 "project/radare2/libr/anal/hint.c"
                                              addr, 
...
# 269 "project/radare2/libr/anal/hint.c"
                                                         size) {
 do { RAnalAddrHintRecord *r = ensure_addr_hint_record (a, R_ANAL_ADDR_HINT_TYPE_SIZE, addr); if (!r) { break; } r->size = size; } while(0);
}


# 273 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 273 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_set_stackframe(RAnal *a, 
# 273 "project/radare2/libr/anal/hint.c" 3 4
                                               unsigned long long 
# 273 "project/radare2/libr/anal/hint.c"
                                                    addr, 
...
# 273 "project/radare2/libr/anal/hint.c"
                                                               size) {
 do { RAnalAddrHintRecord *r = ensure_addr_hint_record (a, R_ANAL_ADDR_HINT_TYPE_STACKFRAME, addr); if (!r) { break; } r->stackframe = size; } while(0);
}


# 277 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 277 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_set_val(RAnal *a, 
# 277 "project/radare2/libr/anal/hint.c" 3 4
                                        unsigned long long 
# 277 "project/radare2/libr/anal/hint.c"
                                             addr, 
...
# 277 "project/radare2/libr/anal/hint.c"
                                                        v) {
 do { RAnalAddrHintRecord *r = ensure_addr_hint_record (a, R_ANAL_ADDR_HINT_TYPE_VAL, addr); if (!r) { break; } r->val = v; } while(0);
}


# 281 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 281 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_set_arch(RAnal *a, 
# 281 "project/radare2/libr/anal/hint.c" 3 4
                                         unsigned long long 
# 281 "project/radare2/libr/anal/hint.c"
                                              addr, const char *arch) {
 RAnalArchHintRecord *record = (RAnalArchHintRecord *)ensure_ranged_hint_record (&a->arch_hints, addr, sizeof (RAnalArchHintRecord));
 if (!record) {
  return;
 }
 free (record->arch);
 record->arch = arch ? strdup (arch) : 
# 287 "project/radare2/libr/anal/hint.c" 3 4
                                      ((void *)0)
# 287 "project/radare2/libr/anal/hint.c"
                                          ;
}


# 290 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 290 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_set_bits(RAnal *a, 
# 290 "project/radare2/libr/anal/hint.c" 3 4
                                         unsigned long long 
# 290 "project/radare2/libr/anal/hint.c"
                                              addr, int bits) {
 ...
 if (a->hint_cbs.on_bits) {
  a->hint_cbs.on_bits (a, addr, bits, 
# 297 "project/radare2/libr/anal/hint.c" 3 4
                                     1
# 297 "project/radare2/libr/anal/hint.c"
                                         );
 }
}


# 301 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 301 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_unset_size(RAnal *a, 
# 301 "project/radare2/libr/anal/hint.c" 3 4
                                           unsigned long long 
# 301 "project/radare2/libr/anal/hint.c"
                                                addr) {
...
# 305 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 305 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_unset_esil(RAnal *a, 
# 305 "project/radare2/libr/anal/hint.c" 3 4
                                           unsigned long long 
# 305 "project/radare2/libr/anal/hint.c"
                                                addr) {
...
# 309 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 309 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_unset_opcode(RAnal *a, 
# 309 "project/radare2/libr/anal/hint.c" 3 4
                                             unsigned long long 
# 309 "project/radare2/libr/anal/hint.c"
                                                  addr) {
...
# 313 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 313 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_unset_high(RAnal *a, 
# 313 "project/radare2/libr/anal/hint.c" 3 4
                                           unsigned long long 
# 313 "project/radare2/libr/anal/hint.c"
                                                addr) {
...
# 317 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 317 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_unset_immbase(RAnal *a, 
# 317 "project/radare2/libr/anal/hint.c" 3 4
                                              unsigned long long 
# 317 "project/radare2/libr/anal/hint.c"
                                                   addr) {
...
# 321 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 321 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_unset_nword(RAnal *a, 
# 321 "project/radare2/libr/anal/hint.c" 3 4
                                            unsigned long long 
# 321 "project/radare2/libr/anal/hint.c"
                                                 addr) {
...
# 325 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 325 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_unset_syntax(RAnal *a, 
# 325 "project/radare2/libr/anal/hint.c" 3 4
                                             unsigned long long 
# 325 "project/radare2/libr/anal/hint.c"
                                                  addr) {
...
# 329 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 329 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_unset_pointer(RAnal *a, 
# 329 "project/radare2/libr/anal/hint.c" 3 4
                                              unsigned long long 
# 329 "project/radare2/libr/anal/hint.c"
                                                   addr) {
...
# 333 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 333 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_unset_ret(RAnal *a, 
# 333 "project/radare2/libr/anal/hint.c" 3 4
                                          unsigned long long 
# 333 "project/radare2/libr/anal/hint.c"
                                               addr) {
...
# 337 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 337 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_unset_offset(RAnal *a, 
# 337 "project/radare2/libr/anal/hint.c" 3 4
                                             unsigned long long 
# 337 "project/radare2/libr/anal/hint.c"
                                                  addr) {
...
# 341 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 341 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_unset_jump(RAnal *a, 
# 341 "project/radare2/libr/anal/hint.c" 3 4
                                           unsigned long long 
# 341 "project/radare2/libr/anal/hint.c"
                                                addr) {
...
# 345 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 345 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_unset_fail(RAnal *a, 
# 345 "project/radare2/libr/anal/hint.c" 3 4
                                           unsigned long long 
# 345 "project/radare2/libr/anal/hint.c"
                                                addr) {
...
# 349 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 349 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_unset_newbits(RAnal *a, 
# 349 "project/radare2/libr/anal/hint.c" 3 4
                                              unsigned long long 
# 349 "project/radare2/libr/anal/hint.c"
                                                   addr) {
...
# 353 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 353 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_unset_val (RAnal *a, 
# 353 "project/radare2/libr/anal/hint.c" 3 4
                                           unsigned long long 
# 353 "project/radare2/libr/anal/hint.c"
                                                addr) {
...
# 357 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 357 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_unset_type (RAnal *a, 
# 357 "project/radare2/libr/anal/hint.c" 3 4
                                            unsigned long long 
# 357 "project/radare2/libr/anal/hint.c"
                                                 addr) {
...
# 361 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 361 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_unset_stackframe(RAnal *a, 
# 361 "project/radare2/libr/anal/hint.c" 3 4
                                                 unsigned long long 
# 361 "project/radare2/libr/anal/hint.c"
                                                      addr) {
...
# 365 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 365 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_unset_arch(RAnal *a, 
# 365 "project/radare2/libr/anal/hint.c" 3 4
                                           unsigned long long 
# 365 "project/radare2/libr/anal/hint.c"
                                                addr) {
 r_rbtree_delete (&a->arch_hints, &addr, ranged_hint_record_cmp, 
# 366 "project/radare2/libr/anal/hint.c" 3 4
                                                                ((void *)0)
# 366 "project/radare2/libr/anal/hint.c"
...
# 369 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 369 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_unset_bits(RAnal *a, 
# 369 "project/radare2/libr/anal/hint.c" 3 4
                                           unsigned long long 
# 369 "project/radare2/libr/anal/hint.c"
                                                addr) {
 r_rbtree_delete (&a->bits_hints, &addr, ranged_hint_record_cmp, 
# 370 "project/radare2/libr/anal/hint.c" 3 4
                                                                ((void *)0)
# 370 "project/radare2/libr/anal/hint.c"
...
# 373 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 373 "project/radare2/libr/anal/hint.c"
     void r_anal_hint_free(RAnalHint *h) {
 if (h) {
  free (h->arch);
  free (h->esil);
  free (h->opcode);
...
# 384 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 384 "project/radare2/libr/anal/hint.c"
                         const char *r_anal_hint_arch_at(RAnal *anal, 
# 384 "project/radare2/libr/anal/hint.c" 3 4
                                                                      unsigned long long 
# 384 "project/radare2/libr/anal/hint.c"
                                                                           addr, 
...
# 384 "project/radare2/libr/anal/hint.c"
                                                                                                 *hint_addr) {
 RBNode *node = r_rbtree_upper_bound (anal->arch_hints, &addr, ranged_hint_record_cmp, 
# 385 "project/radare2/libr/anal/hint.c" 3 4
                                                                                      ((void *)0)
# 385 "project/radare2/libr/anal/hint.c"
                                                                                          );
 if (!node) {
  if (hint_addr) {
   *hint_addr = 
# 388 "project/radare2/libr/anal/hint.c" 3 4
               0xFFFFFFFFFFFFFFFFULL
# 388 "project/radare2/libr/anal/hint.c"
                       ;
  }
  return 
# 390 "project/radare2/libr/anal/hint.c" 3 4
        ((void *)0)
# 390 "project/radare2/libr/anal/hint.c"
            ;
 }
 RAnalArchHintRecord *record = (RAnalArchHintRecord *)
# 392 "project/radare2/libr/anal/hint.c" 3 4
                                                     ((
# 392 "project/radare2/libr/anal/hint.c"
                                                     RAnalRangedHintRecordBase 
# 392 "project/radare2/libr/anal/hint.c" 3 4
                                                     *)((char *)(__typeof__(((
# 392 "project/radare2/libr/anal/hint.c"
...
# 399 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 399 "project/radare2/libr/anal/hint.c"
     int r_anal_hint_bits_at(RAnal *anal, 
# 399 "project/radare2/libr/anal/hint.c" 3 4
                                          unsigned long long 
# 399 "project/radare2/libr/anal/hint.c"
                                               addr, 
...
# 399 "project/radare2/libr/anal/hint.c"
                                                                     *hint_addr) {
 RBNode *node = r_rbtree_upper_bound (anal->bits_hints, &addr, ranged_hint_record_cmp, 
# 400 "project/radare2/libr/anal/hint.c" 3 4
                                                                                      ((void *)0)
# 400 "project/radare2/libr/anal/hint.c"
                                                                                          );
 if (!node) {
  if (hint_addr) {
   *hint_addr = 
# 403 "project/radare2/libr/anal/hint.c" 3 4
               0xFFFFFFFFFFFFFFFFULL
# 403 "project/radare2/libr/anal/hint.c"
                       ;
  }
  return 0;
 }
 RAnalBitsHintRecord *record = (RAnalBitsHintRecord *)
# 407 "project/radare2/libr/anal/hint.c" 3 4
                                                     ((
# 407 "project/radare2/libr/anal/hint.c"
                                                     RAnalRangedHintRecordBase 
# 407 "project/radare2/libr/anal/hint.c" 3 4
                                                     *)((char *)(__typeof__(((
# 407 "project/radare2/libr/anal/hint.c"
...
# 414 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 414 "project/radare2/libr/anal/hint.c"
                const RVector *r_anal_addr_hints_at(RAnal *anal, 
# 414 "project/radare2/libr/anal/hint.c" 3 4
                                                                                                unsigned long long 
# 414 "project/radare2/libr/anal/hint.c"
                                                                                                     addr) {
 return ht_up_find (anal->addr_hints, addr, 
# 415 "project/radare2/libr/anal/hint.c" 3 4
                                           ((void *)0)
# 415 "project/radare2/libr/anal/hint.c"
                                               );
}
...
static 
# 423 "project/radare2/libr/anal/hint.c" 3 4
      _Bool 
# 423 "project/radare2/libr/anal/hint.c"
           addr_hint_foreach_cb(void *user, const 
# 423 "project/radare2/libr/anal/hint.c" 3 4
                                                  unsigned long long 
# 423 "project/radare2/libr/anal/hint.c"
                                                       key, const void *value) {
...
# 428 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 428 "project/radare2/libr/anal/hint.c"
     void r_anal_addr_hints_foreach(RAnal *anal, RAnalAddrHintRecordsCb cb, void *user) {
 AddrHintForeachCtx ctx = { cb, user };
 ht_up_foreach (anal->addr_hints, addr_hint_foreach_cb, &ctx);
}


# 433 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 433 "project/radare2/libr/anal/hint.c"
     void r_anal_arch_hints_foreach(RAnal *anal, RAnalArchHintCb cb, void *user) {
 RBIter iter;
 RAnalRangedHintRecordBase *record;
 
# 436 "project/radare2/libr/anal/hint.c" 3 4
for ((
# 436 "project/radare2/libr/anal/hint.c"
iter
# 436 "project/radare2/libr/anal/hint.c" 3 4
) = r_rbtree_first (
# 436 "project/radare2/libr/anal/hint.c"
...
# 437 "project/radare2/libr/anal/hint.c" 3 4
 _Bool 
# 437 "project/radare2/libr/anal/hint.c"
      cont = cb (record->addr, ((RAnalArchHintRecord *)record)->arch, user);
  if (!cont) {
   break;
  }
 }
...
# 444 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 444 "project/radare2/libr/anal/hint.c"
     void r_anal_bits_hints_foreach(RAnal *anal, RAnalBitsHintCb cb, void *user) {
 RBIter iter;
 RAnalRangedHintRecordBase *record;
 
# 447 "project/radare2/libr/anal/hint.c" 3 4
for ((
# 447 "project/radare2/libr/anal/hint.c"
iter
# 447 "project/radare2/libr/anal/hint.c" 3 4
) = r_rbtree_first (
# 447 "project/radare2/libr/anal/hint.c"
...
# 448 "project/radare2/libr/anal/hint.c" 3 4
 _Bool 
# 448 "project/radare2/libr/anal/hint.c"
      cont = cb (record->addr, ((RAnalBitsHintRecord *)record)->bits, user);
  if (!cont) {
   break;
  }
 }
...
static void hint_merge(RAnalHint *hint, RAnalAddrHintRecord *record) {
 ...
 case R_ANAL_ADDR_HINT_TYPE_SIZE:
  ...
  break;
 case R_ANAL_ADDR_HINT_TYPE_SYNTAX:
  hint->syntax = record->syntax ? strdup (record->syntax) : 
# 485 "project/radare2/libr/anal/hint.c" 3 4
                                                           ((void *)0)
# 485 "project/radare2/libr/anal/hint.c"
                                                               ;
  break;
 case R_ANAL_ADDR_HINT_TYPE_OPTYPE:
  ...
  break;
 case R_ANAL_ADDR_HINT_TYPE_OPCODE:
  hint->opcode = record->opcode ? strdup (record->opcode) : 
# 491 "project/radare2/libr/anal/hint.c" 3 4
                                                           ((void *)0)
# 491 "project/radare2/libr/anal/hint.c"
                                                               ;
  break;
 case R_ANAL_ADDR_HINT_TYPE_TYPE_OFFSET:
  hint->offset = record->type_offset ? strdup (record->type_offset) : 
# 494 "project/radare2/libr/anal/hint.c" 3 4
                                                                     ((void *)0)
# 494 "project/radare2/libr/anal/hint.c"
                                                                         ;
  break;
 case R_ANAL_ADDR_HINT_TYPE_ESIL:
  hint->esil = record->esil ? strdup (record->esil) : 
# 497 "project/radare2/libr/anal/hint.c" 3 4
                                                     ((void *)0)
# 497 "project/radare2/libr/anal/hint.c"
                                                         ;
  break;
 case R_ANAL_ADDR_HINT_TYPE_HIGH:
  hint->high = 
# 500 "project/radare2/libr/anal/hint.c" 3 4
              1
# 500 "project/radare2/libr/anal/hint.c"
                  ;
  break;
...
# 508 "project/radare2/libr/anal/hint.c" 3 4
__attribute__((visibility("default"))) 
# 508 "project/radare2/libr/anal/hint.c"
     RAnalHint *r_anal_hint_get(RAnal *a, 
# 508 "project/radare2/libr/anal/hint.c" 3 4
                                          unsigned long long 
# 508 "project/radare2/libr/anal/hint.c"
                                               addr) {
 RAnalHint *hint = 
# 509 "project/radare2/libr/anal/hint.c" 3 4
                  (
# 509 "project/radare2/libr/anal/hint.c"
                  RAnalHint
# 509 "project/radare2/libr/anal/hint.c" 3 4
                  *)calloc(1,sizeof(
# 509 "project/radare2/libr/anal/hint.c"
...
# 509 "project/radare2/libr/anal/hint.c"
 ...
 if (!hint) {
  return 
# 511 "project/radare2/libr/anal/hint.c" 3 4
        ((void *)0)
# 511 "project/radare2/libr/anal/hint.c"
            ;
 }
 hint->addr = addr;
 hint->jump = 
# 514 "project/radare2/libr/anal/hint.c" 3 4
             0xFFFFFFFFFFFFFFFFULL
# 514 "project/radare2/libr/anal/hint.c"
                     ;
 hint->fail = 
# 515 "project/radare2/libr/anal/hint.c" 3 4
             0xFFFFFFFFFFFFFFFFULL
# 515 "project/radare2/libr/anal/hint.c"
                     ;
 hint->ret = 
# 516 "project/radare2/libr/anal/hint.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 516 "project/radare2/libr/anal/hint.c"
                    ;
 hint->val = 
# 517 "project/radare2/libr/anal/hint.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 517 "project/radare2/libr/anal/hint.c"
                    ;
 hint->stackframe = 
# 518 "project/radare2/libr/anal/hint.c" 3 4
                   0xFFFFFFFFFFFFFFFFULL
# 518 "project/radare2/libr/anal/hint.c"
                           ;
 const RVector *records = r_anal_addr_hints_at (a, addr);
 if (records) {
  RAnalAddrHintRecord *record;
  
# 522 "project/radare2/libr/anal/hint.c" 3 4
 if (!r_vector_empty (
# 522 "project/radare2/libr/anal/hint.c"
 records
# 522 "project/radare2/libr/anal/hint.c" 3 4
 )) for (
# 522 "project/radare2/libr/anal/hint.c"
...
# 526 "project/radare2/libr/anal/hint.c" 3 4
                                                 ((void *)0)
# 526 "project/radare2/libr/anal/hint.c"
                                                     );
 hint->arch = arch ? strdup (arch) : 
# 527 "project/radare2/libr/anal/hint.c" 3 4
                                    ((void *)0)
# 527 "project/radare2/libr/anal/hint.c"
                                        ;
 hint->bits = r_anal_hint_bits_at (a, addr, 
# 528 "project/radare2/libr/anal/hint.c" 3 4
                                           ((void *)0)
# 528 "project/radare2/libr/anal/hint.c"
                                               );
 if ((!records || r_vector_empty (records)) && !hint->arch && !hint->bits) {

  free (hint);
  return 
# 532 "project/radare2/libr/anal/hint.c" 3 4
        ((void *)0)
# 532 "project/radare2/libr/anal/hint.c"
            ;
 }
 return hint;
}
