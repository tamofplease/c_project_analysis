# 0 "project/radare2/libr/anal/xrefs.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/anal/xrefs.c"
...
# 4 "project/radare2/libr/anal/xrefs.c" 2



# 6 "project/radare2/libr/anal/xrefs.c"
static RAnalRef *r_anal_ref_new(
# 6 "project/radare2/libr/anal/xrefs.c" 3 4
                               unsigned long long 
# 6 "project/radare2/libr/anal/xrefs.c"
                                    addr, 
# 6 "project/radare2/libr/anal/xrefs.c" 3 4
...
# 6 "project/radare2/libr/anal/xrefs.c"
                                                        type) {
 RAnalRef *ref = 
# 7 "project/radare2/libr/anal/xrefs.c" 3 4
                (
# 7 "project/radare2/libr/anal/xrefs.c"
                RAnalRef
# 7 "project/radare2/libr/anal/xrefs.c" 3 4
                *)malloc(sizeof(
# 7 "project/radare2/libr/anal/xrefs.c"
...
# 20 "project/radare2/libr/anal/xrefs.c" 3 4
__attribute__((visibility("default"))) 
# 20 "project/radare2/libr/anal/xrefs.c"
     RList *r_anal_ref_list_new(void) {
...
static 
# 32 "project/radare2/libr/anal/xrefs.c" 3 4
      _Bool 
# 32 "project/radare2/libr/anal/xrefs.c"
           appendRef(void *u, const 
# 32 "project/radare2/libr/anal/xrefs.c" 3 4
                                    unsigned long long 
# 32 "project/radare2/libr/anal/xrefs.c"
                                         k, const void *v) {
 ...
 if (cloned) {
  ...
  return 
# 38 "project/radare2/libr/anal/xrefs.c" 3 4
        1
# 38 "project/radare2/libr/anal/xrefs.c"
            ;
 }
 return 
# 40 "project/radare2/libr/anal/xrefs.c" 3 4
       0
# 40 "project/radare2/libr/anal/xrefs.c"
            ;
}

static 
# 43 "project/radare2/libr/anal/xrefs.c" 3 4
      _Bool 
# 43 "project/radare2/libr/anal/xrefs.c"
           mylistrefs_cb(void *list, const 
# 43 "project/radare2/libr/anal/xrefs.c" 3 4
                                           unsigned long long 
# 43 "project/radare2/libr/anal/xrefs.c"
                                                k, const void *v) {
 ...
 return 
# 46 "project/radare2/libr/anal/xrefs.c" 3 4
       1
# 46 "project/radare2/libr/anal/xrefs.c"
           ;
}
...
# 69 "project/radare2/libr/anal/xrefs.c" 3 4
                              unsigned long long 
# 69 "project/radare2/libr/anal/xrefs.c"
                                   addr, RList *list) {
 if (addr == 
# 70 "project/radare2/libr/anal/xrefs.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 70 "project/radare2/libr/anal/xrefs.c"
                    ) {
  ht_up_foreach (m, mylistrefs_cb, list);
 } else {
  
# 73 "project/radare2/libr/anal/xrefs.c" 3 4
 _Bool 
# 73 "project/radare2/libr/anal/xrefs.c"
      found;
...
static void setxref(HtUP *m, 
# 82 "project/radare2/libr/anal/xrefs.c" 3 4
                            unsigned long long 
# 82 "project/radare2/libr/anal/xrefs.c"
                                 from, 
# 82 "project/radare2/libr/anal/xrefs.c" 3 4
                                       unsigned long long 
# 82 "project/radare2/libr/anal/xrefs.c"
...
# 83 "project/radare2/libr/anal/xrefs.c" 3 4
_Bool 
# 83 "project/radare2/libr/anal/xrefs.c"
     found;
 HtUP *ht = ht_up_find (m, from, &found);
 if (!found) {
  ht = ht_up_new (
# 86 "project/radare2/libr/anal/xrefs.c" 3 4
                 ((void *)0)
# 86 "project/radare2/libr/anal/xrefs.c"
                     , xrefs_ref_free, 
# 86 "project/radare2/libr/anal/xrefs.c" 3 4
                                       ((void *)0)
# 86 "project/radare2/libr/anal/xrefs.c"
...
# 99 "project/radare2/libr/anal/xrefs.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 99 "project/radare2/libr/anal/xrefs.c"
          r_anal_xrefs_set(RAnal *anal, 
# 99 "project/radare2/libr/anal/xrefs.c" 3 4
                                        unsigned long long 
# 99 "project/radare2/libr/anal/xrefs.c"
                                             from, 
# 99 "project/radare2/libr/anal/xrefs.c" 3 4
                                                   unsigned long long 
# 99 "project/radare2/libr/anal/xrefs.c"
                                                        to, const RAnalRefType type) {
 
# 100 "project/radare2/libr/anal/xrefs.c" 3 4
do { if (!(
# 100 "project/radare2/libr/anal/xrefs.c"
anal
# 100 "project/radare2/libr/anal/xrefs.c" 3 4
...
"anal"
# 100 "project/radare2/libr/anal/xrefs.c" 3 4
, 100); return (0); } } while (0)
# 100 "project/radare2/libr/anal/xrefs.c"
                                  ;
 if (from == to) {
  return 
# 102 "project/radare2/libr/anal/xrefs.c" 3 4
        0
# 102 "project/radare2/libr/anal/xrefs.c"
             ;
 }
 if (anal->iob.is_valid_offset) {
  if (!anal->iob.is_valid_offset (anal->iob.io, from, 0)) {
   return 
# 106 "project/radare2/libr/anal/xrefs.c" 3 4
         0
# 106 "project/radare2/libr/anal/xrefs.c"
              ;
  }
  if (!anal->iob.is_valid_offset (anal->iob.io, to, 0)) {
   return 
# 109 "project/radare2/libr/anal/xrefs.c" 3 4
         0
# 109 "project/radare2/libr/anal/xrefs.c"
              ;
  }
 }
 ...
 return 
# 114 "project/radare2/libr/anal/xrefs.c" 3 4
       1
# 114 "project/radare2/libr/anal/xrefs.c"
           ;
}


# 117 "project/radare2/libr/anal/xrefs.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 117 "project/radare2/libr/anal/xrefs.c"
          r_anal_xrefs_deln(RAnal *anal, 
# 117 "project/radare2/libr/anal/xrefs.c" 3 4
                                         unsigned long long 
# 117 "project/radare2/libr/anal/xrefs.c"
                                              from, 
...
# 118 "project/radare2/libr/anal/xrefs.c" 3 4
do { if (!(
# 118 "project/radare2/libr/anal/xrefs.c"
anal
# 118 "project/radare2/libr/anal/xrefs.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 118 "project/radare2/libr/anal/xrefs.c"
...
# 118 "project/radare2/libr/anal/xrefs.c"
 ...
 HtUP *d = ht_up_find (anal->dict_refs, from, 
# 123 "project/radare2/libr/anal/xrefs.c" 3 4
                                             ((void *)0)
# 123 "project/radare2/libr/anal/xrefs.c"
                                                 );
 if (d) {
  ht_up_delete (d, to);
 }
 d = ht_up_find (anal->dict_xrefs, to, 
# 127 "project/radare2/libr/anal/xrefs.c" 3 4
                                      ((void *)0)
# 127 "project/radare2/libr/anal/xrefs.c"
                                          );
 if (d) {
  ht_up_delete (d, from);
 }
 ...
 return 
# 132 "project/radare2/libr/anal/xrefs.c" 3 4
       1
# 132 "project/radare2/libr/anal/xrefs.c"
           ;
}


# 135 "project/radare2/libr/anal/xrefs.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 135 "project/radare2/libr/anal/xrefs.c"
          r_anal_xref_del(RAnal *anal, 
# 135 "project/radare2/libr/anal/xrefs.c" 3 4
                                       unsigned long long 
# 135 "project/radare2/libr/anal/xrefs.c"
                                            from, 
...
# 136 "project/radare2/libr/anal/xrefs.c" 3 4
do { if (!(
# 136 "project/radare2/libr/anal/xrefs.c"
anal
# 136 "project/radare2/libr/anal/xrefs.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 136 "project/radare2/libr/anal/xrefs.c"
...
# 137 "project/radare2/libr/anal/xrefs.c" 3 4
_Bool 
# 137 "project/radare2/libr/anal/xrefs.c"
     res = 
# 137 "project/radare2/libr/anal/xrefs.c" 3 4
           0
# 137 "project/radare2/libr/anal/xrefs.c"
...
# 146 "project/radare2/libr/anal/xrefs.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 146 "project/radare2/libr/anal/xrefs.c"
          r_anal_xrefs_from(RAnal *anal, RList *list, const char *kind, const RAnalRefType type, 
# 146 "project/radare2/libr/anal/xrefs.c" 3 4
                                                                                                 unsigned long long 
# 146 "project/radare2/libr/anal/xrefs.c"
                                                                                                      addr) {
 
# 147 "project/radare2/libr/anal/xrefs.c" 3 4
do { if (!(
# 147 "project/radare2/libr/anal/xrefs.c"
anal && list
# 147 "project/radare2/libr/anal/xrefs.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 147 "project/radare2/libr/anal/xrefs.c"
"anal && list"
# 147 "project/radare2/libr/anal/xrefs.c" 3 4
, 147); return (0); } } while (0)
# 147 "project/radare2/libr/anal/xrefs.c"
                                          ;
 listxrefs (anal->dict_refs, addr, list);
 sortxrefs (list);
 return 
# 150 "project/radare2/libr/anal/xrefs.c" 3 4
       1
# 150 "project/radare2/libr/anal/xrefs.c"
           ;
}


# 153 "project/radare2/libr/anal/xrefs.c" 3 4
__attribute__((visibility("default"))) 
# 153 "project/radare2/libr/anal/xrefs.c"
     RList *r_anal_xrefs_get(RAnal *anal, 
# 153 "project/radare2/libr/anal/xrefs.c" 3 4
                                          unsigned long long 
# 153 "project/radare2/libr/anal/xrefs.c"
                                               to) {
 
# 154 "project/radare2/libr/anal/xrefs.c" 3 4
do { if (!(
# 154 "project/radare2/libr/anal/xrefs.c"
anal
# 154 "project/radare2/libr/anal/xrefs.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 154 "project/radare2/libr/anal/xrefs.c"
...
# 154 "project/radare2/libr/anal/xrefs.c"
 ...
 if (!list) {
  return 
# 157 "project/radare2/libr/anal/xrefs.c" 3 4
        ((void *)0)
# 157 "project/radare2/libr/anal/xrefs.c"
            ;
 }
 listxrefs (anal->dict_xrefs, to, list);
 sortxrefs (list);
 if (
# 161 "project/radare2/libr/anal/xrefs.c" 3 4
    (!(
# 161 "project/radare2/libr/anal/xrefs.c"
    list
# 161 "project/radare2/libr/anal/xrefs.c" 3 4
    ) || !(
# 161 "project/radare2/libr/anal/xrefs.c"
...
# 161 "project/radare2/libr/anal/xrefs.c"
  ...
  r_list_free (list);
  list = 
# 163 "project/radare2/libr/anal/xrefs.c" 3 4
        ((void *)0)
# 163 "project/radare2/libr/anal/xrefs.c"
            ;
 }
 return list;
}
...
# 168 "project/radare2/libr/anal/xrefs.c" 3 4
__attribute__((visibility("default"))) 
# 168 "project/radare2/libr/anal/xrefs.c"
     RList *r_anal_refs_get(RAnal *anal, 
# 168 "project/radare2/libr/anal/xrefs.c" 3 4
                                         unsigned long long 
# 168 "project/radare2/libr/anal/xrefs.c"
                                              from) {
 
# 169 "project/radare2/libr/anal/xrefs.c" 3 4
do { if (!(
# 169 "project/radare2/libr/anal/xrefs.c"
anal
# 169 "project/radare2/libr/anal/xrefs.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 169 "project/radare2/libr/anal/xrefs.c"
"anal"
# 169 "project/radare2/libr/anal/xrefs.c" 3 4
, 169); return (((void *)0)); } } while (0)
# 169 "project/radare2/libr/anal/xrefs.c"
                                 ;
 RList *list = r_anal_ref_list_new ();
 if (!list) {
  return 
# 172 "project/radare2/libr/anal/xrefs.c" 3 4
        ((void *)0)
# 172 "project/radare2/libr/anal/xrefs.c"
            ;
 }
 listxrefs (anal->dict_refs, from, list);
 sortxrefs (list);
 if (
# 176 "project/radare2/libr/anal/xrefs.c" 3 4
    (!(
# 176 "project/radare2/libr/anal/xrefs.c"
    list
# 176 "project/radare2/libr/anal/xrefs.c" 3 4
    ) || !(
# 176 "project/radare2/libr/anal/xrefs.c"
...
# 176 "project/radare2/libr/anal/xrefs.c"
  ...
  r_list_free (list);
  list = 
# 178 "project/radare2/libr/anal/xrefs.c" 3 4
        ((void *)0)
# 178 "project/radare2/libr/anal/xrefs.c"
            ;
 }
 return list;
}
...
# 183 "project/radare2/libr/anal/xrefs.c" 3 4
__attribute__((visibility("default"))) 
# 183 "project/radare2/libr/anal/xrefs.c"
     RList *r_anal_xrefs_get_from(RAnal *anal, 
# 183 "project/radare2/libr/anal/xrefs.c" 3 4
                                               unsigned long long 
# 183 "project/radare2/libr/anal/xrefs.c"
                                                    to) {
 
# 184 "project/radare2/libr/anal/xrefs.c" 3 4
do { if (!(
# 184 "project/radare2/libr/anal/xrefs.c"
anal
# 184 "project/radare2/libr/anal/xrefs.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 184 "project/radare2/libr/anal/xrefs.c"
"anal"
# 184 "project/radare2/libr/anal/xrefs.c" 3 4
, 184); return (((void *)0)); } } while (0)
# 184 "project/radare2/libr/anal/xrefs.c"
                                 ;
 RList *list = r_anal_ref_list_new ();
 if (!list) {
  return 
# 187 "project/radare2/libr/anal/xrefs.c" 3 4
        ((void *)0)
# 187 "project/radare2/libr/anal/xrefs.c"
            ;
 }
 listxrefs (anal->dict_refs, to, list);
 sortxrefs (list);
 if (
# 191 "project/radare2/libr/anal/xrefs.c" 3 4
    (!(
# 191 "project/radare2/libr/anal/xrefs.c"
    list
# 191 "project/radare2/libr/anal/xrefs.c" 3 4
    ) || !(
# 191 "project/radare2/libr/anal/xrefs.c"
...
# 191 "project/radare2/libr/anal/xrefs.c"
  ...
  r_list_free (list);
  list = 
# 193 "project/radare2/libr/anal/xrefs.c" 3 4
        ((void *)0)
# 193 "project/radare2/libr/anal/xrefs.c"
            ;
 }
 return list;
}
...
# 198 "project/radare2/libr/anal/xrefs.c" 3 4
__attribute__((visibility("default"))) 
# 198 "project/radare2/libr/anal/xrefs.c"
     void r_anal_xrefs_list(RAnal *anal, int rad) {
 
# 199 "project/radare2/libr/anal/xrefs.c" 3 4
do { if (!(
# 199 "project/radare2/libr/anal/xrefs.c"
anal
# 199 "project/radare2/libr/anal/xrefs.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 199 "project/radare2/libr/anal/xrefs.c"
...
# 199 "project/radare2/libr/anal/xrefs.c"
 ...
 RAnalRef *ref;
 PJ *pj = 
# 202 "project/radare2/libr/anal/xrefs.c" 3 4
         ((void *)0)
# 202 "project/radare2/libr/anal/xrefs.c"
             ;
 RList *list = r_anal_ref_list_new ();
 listxrefs (anal->dict_refs, 
# 204 "project/radare2/libr/anal/xrefs.c" 3 4
                            0xFFFFFFFFFFFFFFFFULL
# 204 "project/radare2/libr/anal/xrefs.c"
                                    , list);
 sortxrefs (list);
 if (rad == 'j') {
...
# 213 "project/radare2/libr/anal/xrefs.c" 3 4
if (
# 213 "project/radare2/libr/anal/xrefs.c"
list
# 213 "project/radare2/libr/anal/xrefs.c" 3 4
) for (
# 213 "project/radare2/libr/anal/xrefs.c"
...
# 213 "project/radare2/libr/anal/xrefs.c"
  ...
  switch (rad) {
  case '*':
   anal->cb_printf ("ax%c 0x%"
# 217 "project/radare2/libr/anal/xrefs.c" 3 4
                             "llx"
# 217 "project/radare2/libr/anal/xrefs.c"
                                    " 0x%"
# 217 "project/radare2/libr/anal/xrefs.c" 3 4
                                          "llx"
# 217 "project/radare2/libr/anal/xrefs.c"
  ...
  case '\0':
   {
    ...
    if (name) {
     r_str_replace_ch (name, ' ', 0, 
# 223 "project/radare2/libr/anal/xrefs.c" 3 4
                                    1
# 223 "project/radare2/libr/anal/xrefs.c"
                                        );
    ...
    anal->cb_printf (" 0x%"
# 229 "project/radare2/libr/anal/xrefs.c" 3 4
                          "llx"
# 229 "project/radare2/libr/anal/xrefs.c"
                                 " -> %9s -> 0x%"
# 229 "project/radare2/libr/anal/xrefs.c" 3 4
                                                 "llx"
# 229 "project/radare2/libr/anal/xrefs.c"
    ...
    if (name) {
     r_str_replace_ch (name, ' ', 0, 
# 232 "project/radare2/libr/anal/xrefs.c" 3 4
                                    1
# 232 "project/radare2/libr/anal/xrefs.c"
                                        );
     anal->cb_printf (" %s\n", name);
     free (name);
    } else {
   ...
   break;
  case 'q':
   anal->cb_printf ("0x%08"
# 241 "project/radare2/libr/anal/xrefs.c" 3 4
                          "llx"
# 241 "project/radare2/libr/anal/xrefs.c"
                                 " -> 0x%08"
# 241 "project/radare2/libr/anal/xrefs.c" 3 4
                                            "llx"
# 241 "project/radare2/libr/anal/xrefs.c"
  ...
  case 'j':
   {
    ...
    if (name) {
     r_str_replace_ch (name, ' ', 0, 
# 248 "project/radare2/libr/anal/xrefs.c" 3 4
                                    1
# 248 "project/radare2/libr/anal/xrefs.c"
                                        );
     pj_ks (pj, "name", name);
     free (name);
    }
    ...
    if (name) {
     r_str_replace_ch (name, ' ', 0, 
# 257 "project/radare2/libr/anal/xrefs.c" 3 4
                                    1
# 257 "project/radare2/libr/anal/xrefs.c"
                                        );
...
# 276 "project/radare2/libr/anal/xrefs.c" 3 4
__attribute__((visibility("default"))) 
# 276 "project/radare2/libr/anal/xrefs.c"
     const char *r_anal_xrefs_type_tostring(RAnalRefType type) {
 switch (type) {
...
# 292 "project/radare2/libr/anal/xrefs.c" 3 4
__attribute__((visibility("default"))) 
# 292 "project/radare2/libr/anal/xrefs.c"
     RAnalRefType r_anal_xrefs_type(char ch) {
 switch (ch) {
 case R_ANAL_REF_TYPE_CODE:
 case R_ANAL_REF_TYPE_CALL:
 case R_ANAL_REF_TYPE_DATA:
...
# 305 "project/radare2/libr/anal/xrefs.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 305 "project/radare2/libr/anal/xrefs.c"
          r_anal_xrefs_init(RAnal *anal) {
 
# 306 "project/radare2/libr/anal/xrefs.c" 3 4
do { if (!(
# 306 "project/radare2/libr/anal/xrefs.c"
anal
# 306 "project/radare2/libr/anal/xrefs.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 306 "project/radare2/libr/anal/xrefs.c"
"anal"
# 306 "project/radare2/libr/anal/xrefs.c" 3 4
, 306); return (0); } } while (0)
# 306 "project/radare2/libr/anal/xrefs.c"
                                  ;
 ht_up_free (anal->dict_refs);
 anal->dict_refs = 
# 308 "project/radare2/libr/anal/xrefs.c" 3 4
                  ((void *)0)
# 308 "project/radare2/libr/anal/xrefs.c"
                      ;
 ht_up_free (anal->dict_xrefs);
 anal->dict_xrefs = 
# 310 "project/radare2/libr/anal/xrefs.c" 3 4
                   ((void *)0)
# 310 "project/radare2/libr/anal/xrefs.c"
                       ;

 HtUP *tmp = ht_up_new (
# 312 "project/radare2/libr/anal/xrefs.c" 3 4
                       ((void *)0)
# 312 "project/radare2/libr/anal/xrefs.c"
                           , xrefs_ht_free, 
# 312 "project/radare2/libr/anal/xrefs.c" 3 4
                                            ((void *)0)
# 312 "project/radare2/libr/anal/xrefs.c"
 ...
 if (!tmp) {
  return 
# 314 "project/radare2/libr/anal/xrefs.c" 3 4
        0
# 314 "project/radare2/libr/anal/xrefs.c"
             ;
 }
 anal->dict_refs = tmp;

 tmp = ht_up_new (
# 318 "project/radare2/libr/anal/xrefs.c" 3 4
                 ((void *)0)
# 318 "project/radare2/libr/anal/xrefs.c"
                     , xrefs_ht_free, 
# 318 "project/radare2/libr/anal/xrefs.c" 3 4
                                      ((void *)0)
# 318 "project/radare2/libr/anal/xrefs.c"
 ...
 if (!tmp) {
  ht_up_free (anal->dict_refs);
  anal->dict_refs = 
# 321 "project/radare2/libr/anal/xrefs.c" 3 4
                   ((void *)0)
# 321 "project/radare2/libr/anal/xrefs.c"
                       ;
  return 
# 322 "project/radare2/libr/anal/xrefs.c" 3 4
        0
# 322 "project/radare2/libr/anal/xrefs.c"
             ;
 }
 anal->dict_xrefs = tmp;
 return 
# 325 "project/radare2/libr/anal/xrefs.c" 3 4
       1
# 325 "project/radare2/libr/anal/xrefs.c"
           ;
}

static 
# 328 "project/radare2/libr/anal/xrefs.c" 3 4
      _Bool 
# 328 "project/radare2/libr/anal/xrefs.c"
           count_cb(void *user, const 
# 328 "project/radare2/libr/anal/xrefs.c" 3 4
                                      unsigned long long 
# 328 "project/radare2/libr/anal/xrefs.c"
                                           k, const void *v) {
 (*(
# 329 "project/radare2/libr/anal/xrefs.c" 3 4
   unsigned long long 
# 329 "project/radare2/libr/anal/xrefs.c"
        *)user) += ((HtUP *)v)->count;
 return 
# 330 "project/radare2/libr/anal/xrefs.c" 3 4
       1
# 330 "project/radare2/libr/anal/xrefs.c"
           ;
}


# 333 "project/radare2/libr/anal/xrefs.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 333 "project/radare2/libr/anal/xrefs.c"
          r_anal_xrefs_count(RAnal *anal) {
 
# 334 "project/radare2/libr/anal/xrefs.c" 3 4
unsigned long long 
# 334 "project/radare2/libr/anal/xrefs.c"
     ret = 0;
...
static RList *fcn_get_refs(RAnalFunction *fcn, HtUP *ht) {
 ...
 if (!list) {
  return 
# 344 "project/radare2/libr/anal/xrefs.c" 3 4
        ((void *)0)
# 344 "project/radare2/libr/anal/xrefs.c"
            ;
 }
 
# 346 "project/radare2/libr/anal/xrefs.c" 3 4
if (
# 346 "project/radare2/libr/anal/xrefs.c"
fcn->bbs
# 346 "project/radare2/libr/anal/xrefs.c" 3 4
) for (
# 346 "project/radare2/libr/anal/xrefs.c"
...
# 350 "project/radare2/libr/anal/xrefs.c" 3 4
  unsigned long long 
# 350 "project/radare2/libr/anal/xrefs.c"
       at = bb->addr + r_anal_bb_offset_inst (bb, i);
...
# 358 "project/radare2/libr/anal/xrefs.c" 3 4
__attribute__((visibility("default"))) 
# 358 "project/radare2/libr/anal/xrefs.c"
     RList *r_anal_function_get_refs(RAnalFunction *fcn) {
 
# 359 "project/radare2/libr/anal/xrefs.c" 3 4
do { if (!(
# 359 "project/radare2/libr/anal/xrefs.c"
fcn
# 359 "project/radare2/libr/anal/xrefs.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 359 "project/radare2/libr/anal/xrefs.c"
...
# 363 "project/radare2/libr/anal/xrefs.c" 3 4
__attribute__((visibility("default"))) 
# 363 "project/radare2/libr/anal/xrefs.c"
     RList *r_anal_function_get_xrefs(RAnalFunction *fcn) {
 
# 364 "project/radare2/libr/anal/xrefs.c" 3 4
do { if (!(
# 364 "project/radare2/libr/anal/xrefs.c"
fcn
# 364 "project/radare2/libr/anal/xrefs.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 364 "project/radare2/libr/anal/xrefs.c"
...
# 368 "project/radare2/libr/anal/xrefs.c" 3 4
__attribute__((visibility("default"))) 
# 368 "project/radare2/libr/anal/xrefs.c"
     const char *r_anal_ref_type_tostring(RAnalRefType t) {
 switch (t) {
 case R_ANAL_REF_TYPE_NULL:
  return "null";
 case R_ANAL_REF_TYPE_CODE:
