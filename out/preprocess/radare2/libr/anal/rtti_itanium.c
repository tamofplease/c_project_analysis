# 0 "project/radare2/libr/anal/rtti_itanium.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/anal/rtti_itanium.c" 2
...
# 5 "project/radare2/libr/anal/rtti_itanium.c" 2
# 16 "project/radare2/libr/anal/rtti_itanium.c"
...
# 25 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 25 "project/radare2/libr/anal/rtti_itanium.c"
     class_vtable_addr;
 
# 26 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 26 "project/radare2/libr/anal/rtti_itanium.c"
     typeinfo_addr;
 
# 27 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 27 "project/radare2/libr/anal/rtti_itanium.c"
     vtable_addr;
 
# 28 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 28 "project/radare2/libr/anal/rtti_itanium.c"
     name_addr;
 char *name;
 
# 30 "project/radare2/libr/anal/rtti_itanium.c" 3 4
_Bool 
# 30 "project/radare2/libr/anal/rtti_itanium.c"
     name_unique;
} class_type_info;

typedef struct base_class_type_info_t {
 
# 34 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 34 "project/radare2/libr/anal/rtti_itanium.c"
     base_class_addr;
 
# 35 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 35 "project/radare2/libr/anal/rtti_itanium.c"
     flags;
 enum flags_masks_e {
  base_is_virtual = 0x1,
  base_is_public = 0x2
...
# 44 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 44 "project/radare2/libr/anal/rtti_itanium.c"
     class_vtable_addr;
 
# 45 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 45 "project/radare2/libr/anal/rtti_itanium.c"
     typeinfo_addr;
 
# 46 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 46 "project/radare2/libr/anal/rtti_itanium.c"
     vtable_addr;
 
# 47 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 47 "project/radare2/libr/anal/rtti_itanium.c"
     name_addr;
 char *name;
 
# 49 "project/radare2/libr/anal/rtti_itanium.c" 3 4
_Bool 
# 49 "project/radare2/libr/anal/rtti_itanium.c"
     name_unique;
 
# 50 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 50 "project/radare2/libr/anal/rtti_itanium.c"
     base_class_addr;
} si_class_type_info;
...
# 55 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 55 "project/radare2/libr/anal/rtti_itanium.c"
     class_vtable_addr;
 
# 56 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 56 "project/radare2/libr/anal/rtti_itanium.c"
     typeinfo_addr;
 
# 57 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 57 "project/radare2/libr/anal/rtti_itanium.c"
     vtable_addr;
 
# 58 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 58 "project/radare2/libr/anal/rtti_itanium.c"
     name_addr;
 char *name;
 
# 60 "project/radare2/libr/anal/rtti_itanium.c" 3 4
_Bool 
# 60 "project/radare2/libr/anal/rtti_itanium.c"
     name_unique;
 int vmi_flags;
 int vmi_base_count;
...
static 
# 72 "project/radare2/libr/anal/rtti_itanium.c" 3 4
      _Bool 
# 72 "project/radare2/libr/anal/rtti_itanium.c"
           rtti_itanium_read_type_name(RVTableContext *context, 
# 72 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                unsigned long long 
# 72 "project/radare2/libr/anal/rtti_itanium.c"
                                                                     addr, class_type_info *cti) {
 
# 73 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 73 "project/radare2/libr/anal/rtti_itanium.c"
     at;
 if (!context->read_addr (context->anal, addr, &at)) {
  return 
# 75 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        0
# 75 "project/radare2/libr/anal/rtti_itanium.c"
             ;
 }
 
# 77 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 77 "project/radare2/libr/anal/rtti_itanium.c"
     unique_mask = 1ULL << ((context->word_size) * 8 - 1);
 cti->name_unique = (at & unique_mask) == 0;
 at &= ~unique_mask;
 cti->name_addr = at;
 
# 81 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned char 
# 81 "project/radare2/libr/anal/rtti_itanium.c"
    buf[256];
 if (!context->anal->iob.read_at (context->anal->iob.io, at, buf, sizeof (buf))) {
  return 
# 83 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        0
# 83 "project/radare2/libr/anal/rtti_itanium.c"
             ;
 }
 buf[256 - 1] = 0;
 ...
 if (!cti->name) {
  return 
# 88 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        0
# 88 "project/radare2/libr/anal/rtti_itanium.c"
             ;
 }
 return 
# 90 "project/radare2/libr/anal/rtti_itanium.c" 3 4
       1
# 90 "project/radare2/libr/anal/rtti_itanium.c"
           ;
}


static char *rtti_itanium_read_type_name_custom(RVTableContext *context, 
# 94 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                        unsigned long long 
# 94 "project/radare2/libr/anal/rtti_itanium.c"
                                                                             addr, 
# 94 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                                   unsigned long long 
# 94 "project/radare2/libr/anal/rtti_itanium.c"
...
# 95 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 95 "project/radare2/libr/anal/rtti_itanium.c"
     at;
 if (!context->read_addr (context->anal, addr, &at)) {
  return 
# 97 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        ((void *)0)
# 97 "project/radare2/libr/anal/rtti_itanium.c"
            ;
 }
 
# 99 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 99 "project/radare2/libr/anal/rtti_itanium.c"
     unique_mask = 1ULL << ((context->word_size) * 8 - 1);
 *unique_name = (at & unique_mask) == 0;
 at &= ~unique_mask;
 *str_addr = at;
 
# 103 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned char 
# 103 "project/radare2/libr/anal/rtti_itanium.c"
    buf[256];
 if (!context->anal->iob.read_at (context->anal->iob.io, at, buf, sizeof (buf))) {
  return 
# 105 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        ((void *)0)
# 105 "project/radare2/libr/anal/rtti_itanium.c"
            ;
 }
 buf[256 - 1] = 0;
...
static void rtti_itanium_class_type_info_free(class_type_info *cti) {
 if (cti == 
# 120 "project/radare2/libr/anal/rtti_itanium.c" 3 4
           ((void *)0)
# 120 "project/radare2/libr/anal/rtti_itanium.c"
               ) {
  return;
 }
...
static 
# 128 "project/radare2/libr/anal/rtti_itanium.c" 3 4
      _Bool 
# 128 "project/radare2/libr/anal/rtti_itanium.c"
           rtti_itanium_class_type_info_init(RVTableContext *context, 
# 128 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                      unsigned long long 
# 128 "project/radare2/libr/anal/rtti_itanium.c"
                                                                           addr, class_type_info *cti) {
...
# 130 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 130 "project/radare2/libr/anal/rtti_itanium.c"
     at;
 if (addr == 
# 131 "project/radare2/libr/anal/rtti_itanium.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 131 "project/radare2/libr/anal/rtti_itanium.c"
                    ) {
  return 
# 132 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        0
# 132 "project/radare2/libr/anal/rtti_itanium.c"
             ;
 }
 if (!context->read_addr (context->anal, addr, &at)) {
  return 
# 135 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        0
# 135 "project/radare2/libr/anal/rtti_itanium.c"
             ;
 }
 cti->vtable_addr = at;
 return rtti_itanium_read_type_name (context, addr + (context->word_size), cti);
}

static class_type_info *rtti_itanium_class_type_info_new(RVTableContext *context, 
# 141 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                                 unsigned long long 
# 141 "project/radare2/libr/anal/rtti_itanium.c"
                                                                                      addr, 
# 141 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                                            unsigned long long 
# 141 "project/radare2/libr/anal/rtti_itanium.c"
                                                                                                 source_vtable) {
 class_type_info *result = 
# 142 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                          (
# 142 "project/radare2/libr/anal/rtti_itanium.c"
                          class_type_info
# 142 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                          *)calloc(1,sizeof(
# 142 "project/radare2/libr/anal/rtti_itanium.c"
...
# 142 "project/radare2/libr/anal/rtti_itanium.c"
 ...
 if (!result) {
  return 
# 144 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        ((void *)0)
# 144 "project/radare2/libr/anal/rtti_itanium.c"
            ;
 }
 ...
 if (!rtti_itanium_class_type_info_init (context, addr, result)) {
  ...
  return 
# 149 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        ((void *)0)
# 149 "project/radare2/libr/anal/rtti_itanium.c"
            ;
 }
...
static void rtti_itanium_vmi_class_type_info_free(vmi_class_type_info *cti) {
 if (cti == 
# 166 "project/radare2/libr/anal/rtti_itanium.c" 3 4
           ((void *)0)
# 166 "project/radare2/libr/anal/rtti_itanium.c"
               ) {
  return;
 }
...
static 
# 174 "project/radare2/libr/anal/rtti_itanium.c" 3 4
      _Bool 
# 174 "project/radare2/libr/anal/rtti_itanium.c"
           rtti_itanium_vmi_class_type_info_init(RVTableContext *context, 
# 174 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                          unsigned long long 
# 174 "project/radare2/libr/anal/rtti_itanium.c"
                                                                               addr, vmi_class_type_info *vmi_cti) {
 vmi_cti->type = R_TYPEINFO_TYPE_VMI_CLASS;
 
# 176 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 176 "project/radare2/libr/anal/rtti_itanium.c"
     at;
 if (addr == 
# 177 "project/radare2/libr/anal/rtti_itanium.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 177 "project/radare2/libr/anal/rtti_itanium.c"
                    ) {
  return 
# 178 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        0
# 178 "project/radare2/libr/anal/rtti_itanium.c"
             ;
 }
 if (!context->read_addr (context->anal, addr, &at)) {
  return 
# 181 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        0
# 181 "project/radare2/libr/anal/rtti_itanium.c"
             ;
 }
 ...
 if (!rtti_itanium_read_type_name (context, addr, (class_type_info *)vmi_cti)) {
  return 
# 186 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        0
# 186 "project/radare2/libr/anal/rtti_itanium.c"
             ;
 }
 addr += (context->word_size);
 if (!context->read_addr (context->anal, addr, &at)) {
  return 
# 190 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        0
# 190 "project/radare2/libr/anal/rtti_itanium.c"
             ;
 }
 ...
 if (!context->read_addr (context->anal, addr, &at)) {
  return 
# 195 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        0
# 195 "project/radare2/libr/anal/rtti_itanium.c"
             ;
 }
 at = at & 0xffffffff;
 if (at < 1 || at > 0xfffff) {
  
# 199 "project/radare2/libr/anal/rtti_itanium.c" 3 4
 fprintf(__stderrp,
# 199 "project/radare2/libr/anal/rtti_itanium.c"
...
# 199 "project/radare2/libr/anal/rtti_itanium.c"
                                           ;
  return 
# 200 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        0
# 200 "project/radare2/libr/anal/rtti_itanium.c"
             ;
 }
 ...
 if (!vmi_cti->vmi_bases) {
  return 
# 205 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        0
# 205 "project/radare2/libr/anal/rtti_itanium.c"
             ;
 }
 
# 207 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 207 "project/radare2/libr/anal/rtti_itanium.c"
     tmp_addr = addr + 0x4;
 ...
 for (i = 0; i < vmi_cti->vmi_base_count; i++) {
  if (!context->read_addr (context->anal, tmp_addr, &at)) {
   return 
# 212 "project/radare2/libr/anal/rtti_itanium.c" 3 4
         0
# 212 "project/radare2/libr/anal/rtti_itanium.c"
              ;
  }
  ...
  if (!context->read_addr (context->anal, tmp_addr, &at)) {
   return 
# 217 "project/radare2/libr/anal/rtti_itanium.c" 3 4
         0
# 217 "project/radare2/libr/anal/rtti_itanium.c"
              ;
  }
 ...
 return 
# 222 "project/radare2/libr/anal/rtti_itanium.c" 3 4
       1
# 222 "project/radare2/libr/anal/rtti_itanium.c"
           ;
}

static vmi_class_type_info *rtti_itanium_vmi_class_type_info_new(RVTableContext *context, 
# 225 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                                         unsigned long long 
# 225 "project/radare2/libr/anal/rtti_itanium.c"
                                                                                              addr, 
# 225 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                                                    unsigned long long 
# 225 "project/radare2/libr/anal/rtti_itanium.c"
                                                                                                         source_vtable) {
 vmi_class_type_info *result = 
# 226 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                              (
# 226 "project/radare2/libr/anal/rtti_itanium.c"
                              vmi_class_type_info
# 226 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                              *)calloc(1,sizeof(
# 226 "project/radare2/libr/anal/rtti_itanium.c"
...
# 226 "project/radare2/libr/anal/rtti_itanium.c"
 ...
 if (!result) {
  return 
# 228 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        ((void *)0)
# 228 "project/radare2/libr/anal/rtti_itanium.c"
            ;
 }
 ...
 if (!rtti_itanium_vmi_class_type_info_init (context, addr, result)) {
  ...
  return 
# 233 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        ((void *)0)
# 233 "project/radare2/libr/anal/rtti_itanium.c"
            ;
 }
...
static void rtti_itanium_si_class_type_info_free(si_class_type_info *cti) {
 if (cti == 
# 249 "project/radare2/libr/anal/rtti_itanium.c" 3 4
           ((void *)0)
# 249 "project/radare2/libr/anal/rtti_itanium.c"
               ) {
  return;
 }
...
static 
# 257 "project/radare2/libr/anal/rtti_itanium.c" 3 4
      _Bool 
# 257 "project/radare2/libr/anal/rtti_itanium.c"
           rtti_itanium_si_class_type_info_init(RVTableContext *context, 
# 257 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                         unsigned long long 
# 257 "project/radare2/libr/anal/rtti_itanium.c"
                                                                              addr, si_class_type_info *si_cti) {
 si_cti->type = R_TYPEINFO_TYPE_SI_CLASS;
 
# 259 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 259 "project/radare2/libr/anal/rtti_itanium.c"
     at;
 if (addr == 
# 260 "project/radare2/libr/anal/rtti_itanium.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 260 "project/radare2/libr/anal/rtti_itanium.c"
                    ) {
  return 
# 261 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        0
# 261 "project/radare2/libr/anal/rtti_itanium.c"
             ;
 }
 if (!context->read_addr (context->anal, addr, &at)) {
  return 
# 264 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        0
# 264 "project/radare2/libr/anal/rtti_itanium.c"
             ;
 }
 si_cti->vtable_addr = at;
 if (!rtti_itanium_read_type_name (context, addr + (context->word_size), (class_type_info *)si_cti)) {
  return 
# 268 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        0
# 268 "project/radare2/libr/anal/rtti_itanium.c"
             ;
 }
 if (!context->read_addr (context->anal, addr + 2 * (context->word_size), &at)) {
  return 
# 271 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        0
# 271 "project/radare2/libr/anal/rtti_itanium.c"
             ;
 }
 si_cti->base_class_addr = at;
 return 
# 274 "project/radare2/libr/anal/rtti_itanium.c" 3 4
       1
# 274 "project/radare2/libr/anal/rtti_itanium.c"
           ;
}

static si_class_type_info *rtti_itanium_si_class_type_info_new(RVTableContext *context, 
# 277 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                                       unsigned long long 
# 277 "project/radare2/libr/anal/rtti_itanium.c"
                                                                                            addr, 
# 277 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                                                  unsigned long long 
# 277 "project/radare2/libr/anal/rtti_itanium.c"
                                                                                                       source_vtable) {
 si_class_type_info *result = 
# 278 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                             (
# 278 "project/radare2/libr/anal/rtti_itanium.c"
                             si_class_type_info
# 278 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                             *)calloc(1,sizeof(
# 278 "project/radare2/libr/anal/rtti_itanium.c"
...
# 278 "project/radare2/libr/anal/rtti_itanium.c"
 ...
 if (!result) {
  return 
# 280 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        ((void *)0)
# 280 "project/radare2/libr/anal/rtti_itanium.c"
            ;
 }
 ...
 if (!rtti_itanium_si_class_type_info_init (context, addr, result)) {
  ...
  return 
# 285 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        ((void *)0)
# 285 "project/radare2/libr/anal/rtti_itanium.c"
            ;
 }
...
# 303 "project/radare2/libr/anal/rtti_itanium.c" 3 4
 do { r_assert_log (R_LOGLVL_ERROR, "file %s: line %d (%s): should not be reached\n", "project/radare2/libr/anal/rtti_itanium.c", 303, ((const char*) (__func__))); return (
# 303 "project/radare2/libr/anal/rtti_itanium.c"
 "__class_type_info"
# 303 "project/radare2/libr/anal/rtti_itanium.c" 3 4
 ); } while (0)
# 303 "project/radare2/libr/anal/rtti_itanium.c"
 ...
 return 
# 305 "project/radare2/libr/anal/rtti_itanium.c" 3 4
       ((void *)0)
# 305 "project/radare2/libr/anal/rtti_itanium.c"
           ;
}
static void rtti_itanium_print_class_type_info(class_type_info *cti, const char *prefix) {
 r_cons_printf ("%sType Info at 0x%08" 
# 308 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                      "llx" 
# 308 "project/radare2/libr/anal/rtti_itanium.c"
                                              ":\n"
   "%s  Type Info type: %s\n"
   "%s  Belongs to class vtable: 0x%08" 
# 310 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                       "llx" 
# 310 "project/radare2/libr/anal/rtti_itanium.c"
                                               "\n"
   "%s  Reference to RTTI's type class: 0x%08" 
# 311 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                              "llx" 
# 311 "project/radare2/libr/anal/rtti_itanium.c"
                                                      "\n"
   "%s  Reference to type's name: 0x%08" 
# 312 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                        "llx" 
# 312 "project/radare2/libr/anal/rtti_itanium.c"
                                                "\n"
   "%s  Type Name: %s\n"
   "%s  Name unique: %s\n",
...
# 340 "project/radare2/libr/anal/rtti_itanium.c" 3 4
r_cons_strcat (
# 340 "project/radare2/libr/anal/rtti_itanium.c"
pj_string (pj)
# 340 "project/radare2/libr/anal/rtti_itanium.c" 3 4
)
# 340 "project/radare2/libr/anal/rtti_itanium.c"
...
static void rtti_itanium_print_vmi_class_type_info(vmi_class_type_info *vmi_cti, const char *prefix) {
 r_cons_printf ("%sType Info at 0x%08" 
# 345 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                      "llx" 
# 345 "project/radare2/libr/anal/rtti_itanium.c"
                                              ":\n"
   "%s  Type Info type: %s\n"
   "%s  Belongs to class vtable: 0x%08" 
# 347 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                       "llx" 
# 347 "project/radare2/libr/anal/rtti_itanium.c"
                                               "\n"
   "%s  Reference to RTTI's type class: 0x%08" 
# 348 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                              "llx" 
# 348 "project/radare2/libr/anal/rtti_itanium.c"
                                                      "\n"
   "%s  Reference to type's name: 0x%08" 
# 349 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                        "llx" 
# 349 "project/radare2/libr/anal/rtti_itanium.c"
                                                "\n"
   "%s  Type Name: %s\n"
   "%s  Name unique: %s\n"
   "%s  Flags: 0x%x\n"
 ...
 int i;
 for (i = 0; i < vmi_cti->vmi_base_count; i++) {
  r_cons_printf ("%s    Base class type descriptor address: 0x%08" 
# 367 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                  "llx" 
# 367 "project/radare2/libr/anal/rtti_itanium.c"
                                                                          "\n"
          "%s    Base class flags: 0x%" 
# 368 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                       "llx"
          
# 369 "project/radare2/libr/anal/rtti_itanium.c"
         "\n",
...
# 402 "project/radare2/libr/anal/rtti_itanium.c" 3 4
r_cons_strcat (
# 402 "project/radare2/libr/anal/rtti_itanium.c"
pj_string (pj)
# 402 "project/radare2/libr/anal/rtti_itanium.c" 3 4
)
# 402 "project/radare2/libr/anal/rtti_itanium.c"
...
static void rtti_itanium_print_si_class_type_info(si_class_type_info *si_cti, const char *prefix) {
 r_cons_printf ("%sType Info at 0x%08" 
# 407 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                      "llx" 
# 407 "project/radare2/libr/anal/rtti_itanium.c"
                                              ":\n"
   "%s  Type Info type: %s\n"
   "%s  Belongs to class vtable: 0x%08" 
# 409 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                       "llx" 
# 409 "project/radare2/libr/anal/rtti_itanium.c"
                                               "\n"
   "%s  Reference to RTTI's type class: 0x%08" 
# 410 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                              "llx" 
# 410 "project/radare2/libr/anal/rtti_itanium.c"
                                                      "\n"
   "%s  Reference to type's name: 0x%08" 
# 411 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                        "llx" 
# 411 "project/radare2/libr/anal/rtti_itanium.c"
                                                "\n"
   "%s  Type Name: %s\n"
   "%s  Name unique: %s\n"
   "%s  Reference to parent's type info: 0x%08" 
# 414 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                               "llx" 
# 414 "project/radare2/libr/anal/rtti_itanium.c"
                                                       "\n",
...
# 442 "project/radare2/libr/anal/rtti_itanium.c" 3 4
r_cons_strcat (
# 442 "project/radare2/libr/anal/rtti_itanium.c"
pj_string (pj)
# 442 "project/radare2/libr/anal/rtti_itanium.c" 3 4
)
# 442 "project/radare2/libr/anal/rtti_itanium.c"
...
# 446 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                                   unsigned long long 
# 446 "project/radare2/libr/anal/rtti_itanium.c"
                                                                                        atAddress) {
 RCore *core = context->anal->coreb.core;
 
# 448 "project/radare2/libr/anal/rtti_itanium.c" 3 4
do { if (!(
# 448 "project/radare2/libr/anal/rtti_itanium.c"
core
# 448 "project/radare2/libr/anal/rtti_itanium.c" 3 4
...
# 458 "project/radare2/libr/anal/rtti_itanium.c" 3 4
if (
# 458 "project/radare2/libr/anal/rtti_itanium.c"
flags
# 458 "project/radare2/libr/anal/rtti_itanium.c" 3 4
) for (
# 458 "project/radare2/libr/anal/rtti_itanium.c"
...
# 458 "project/radare2/libr/anal/rtti_itanium.c"
                                   {
  if (strstr (flag->name, "__vmi_class_type_info")) {
   return R_TYPEINFO_TYPE_VMI_CLASS;
  } else if (strstr (flag->name, "__si_class_type_info")) {
   return R_TYPEINFO_TYPE_SI_CLASS;
  } else if (strstr (flag->name, "__class_type_info")) {
...
static 
# 472 "project/radare2/libr/anal/rtti_itanium.c" 3 4
      _Bool 
# 472 "project/radare2/libr/anal/rtti_itanium.c"
           can_section_contain_rtti_vpointer(RBinSection *section) {
 if (!section) {
  return 
# 474 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        0
# 474 "project/radare2/libr/anal/rtti_itanium.c"
             ;
 }
 if (section->is_data) {
  return 
# 477 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        1
# 477 "project/radare2/libr/anal/rtti_itanium.c"
            ;
 }
...
static class_type_info *create_class_type(
# 484 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                         unsigned long long 
# 484 "project/radare2/libr/anal/rtti_itanium.c"
                                              vtable_addr, char *name, 
# 484 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                       unsigned long long 
# 484 "project/radare2/libr/anal/rtti_itanium.c"
                                                                            name_addr, 
...
# 484 "project/radare2/libr/anal/rtti_itanium.c"
                                                                                                                                  source_vtable) {
 class_type_info *result = 
# 485 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                          (
# 485 "project/radare2/libr/anal/rtti_itanium.c"
                          class_type_info
# 485 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                          *)calloc(1,sizeof(
# 485 "project/radare2/libr/anal/rtti_itanium.c"
...
# 485 "project/radare2/libr/anal/rtti_itanium.c"
 ...
 if (!result) {
  return 
# 487 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        ((void *)0)
# 487 "project/radare2/libr/anal/rtti_itanium.c"
            ;
 }
...
static si_class_type_info *create_si_class_type(
# 500 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                               unsigned long long 
# 500 "project/radare2/libr/anal/rtti_itanium.c"
                                                    vtable_addr, char *name, 
# 500 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                             unsigned long long 
# 500 "project/radare2/libr/anal/rtti_itanium.c"
...
# 500 "project/radare2/libr/anal/rtti_itanium.c"
                                                                                                                                                            source_vtable) {
 si_class_type_info *result = 
# 501 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                             (
# 501 "project/radare2/libr/anal/rtti_itanium.c"
                             si_class_type_info
# 501 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                             *)calloc(1,sizeof(
# 501 "project/radare2/libr/anal/rtti_itanium.c"
...
# 501 "project/radare2/libr/anal/rtti_itanium.c"
 ...
 if (!result) {
  return 
# 503 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        ((void *)0)
# 503 "project/radare2/libr/anal/rtti_itanium.c"
            ;
 }
...
static vmi_class_type_info *create_vmi_class_type(
# 516 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                 unsigned long long 
# 516 "project/radare2/libr/anal/rtti_itanium.c"
                                                      vtable_addr, char *name, 
# 516 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                               unsigned long long 
# 516 "project/radare2/libr/anal/rtti_itanium.c"
...
# 516 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                                                                             unsigned int 
# 516 "project/radare2/libr/anal/rtti_itanium.c"
                                                                                                                                  base_count, base_class_type_info *bases, 
# 516 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                                                                                                                           unsigned long long 
# 516 "project/radare2/libr/anal/rtti_itanium.c"
                                                                                                                                                                                typeinfo_addr, 
...
# 516 "project/radare2/libr/anal/rtti_itanium.c"
                                                                                                                                                                                                    source_vtable) {
 vmi_class_type_info *result = 
# 517 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                              (
# 517 "project/radare2/libr/anal/rtti_itanium.c"
                              vmi_class_type_info
# 517 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                              *)calloc(1,sizeof(
# 517 "project/radare2/libr/anal/rtti_itanium.c"
...
# 517 "project/radare2/libr/anal/rtti_itanium.c"
 ...
 if (!result) {
  return 
# 519 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        ((void *)0)
# 519 "project/radare2/libr/anal/rtti_itanium.c"
            ;
 }
...
# 542 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                               unsigned long long 
# 542 "project/radare2/libr/anal/rtti_itanium.c"
                                                                    vtable_addr, 
# 542 "project/radare2/libr/anal/rtti_itanium.c" 3 4
...
# 560 "project/radare2/libr/anal/rtti_itanium.c" 3 4
 unsigned long long 
# 560 "project/radare2/libr/anal/rtti_itanium.c"
      rtti_vptr = 0;
  
# 561 "project/radare2/libr/anal/rtti_itanium.c" 3 4
 unsigned long long 
# 561 "project/radare2/libr/anal/rtti_itanium.c"
      addr = rtti_addr;
  if (!context->read_addr (context->anal, addr, &rtti_vptr)) {
   return 
# 563 "project/radare2/libr/anal/rtti_itanium.c" 3 4
         ((void *)0)
# 563 "project/radare2/libr/anal/rtti_itanium.c"
             ;
  }
...
# 571 "project/radare2/libr/anal/rtti_itanium.c" 3 4
 unsigned long long 
# 571 "project/radare2/libr/anal/rtti_itanium.c"
      name_addr = 0;
  
# 572 "project/radare2/libr/anal/rtti_itanium.c" 3 4
 _Bool 
# 572 "project/radare2/libr/anal/rtti_itanium.c"
      name_unique = 
# 572 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                    0
# 572 "project/radare2/libr/anal/rtti_itanium.c"
  ...
  if (!type_name) {
   return 
# 575 "project/radare2/libr/anal/rtti_itanium.c" 3 4
         ((void *)0)
# 575 "project/radare2/libr/anal/rtti_itanium.c"
             ;
  }
...
# 582 "project/radare2/libr/anal/rtti_itanium.c" 3 4
 unsigned long long 
# 582 "project/radare2/libr/anal/rtti_itanium.c"
      base_type_rtti = 0;
...
# 594 "project/radare2/libr/anal/rtti_itanium.c" 3 4
 unsigned long long 
# 594 "project/radare2/libr/anal/rtti_itanium.c"
      integers = 0;
  if (!context->read_addr (context->anal, addr, &integers)) {
   return create_class_type (rtti_vptr, type_name, name_addr, name_unique, rtti_addr, vtable_addr);
  }
  
# 598 "project/radare2/libr/anal/rtti_itanium.c" 3 4
 unsigned int 
# 598 "project/radare2/libr/anal/rtti_itanium.c"
      vmi_flags = integers & 0xffffffff;
  addr += 0x4;
  if (!context->read_addr (context->anal, addr, &integers)) {
   return create_class_type (rtti_vptr, type_name, name_addr, name_unique, rtti_addr, vtable_addr);
  }
...
# 607 "project/radare2/libr/anal/rtti_itanium.c" 3 4
 unsigned int 
# 607 "project/radare2/libr/anal/rtti_itanium.c"
      vmi_base_count = integers;
...
# 613 "project/radare2/libr/anal/rtti_itanium.c" 3 4
 unsigned long long 
# 613 "project/radare2/libr/anal/rtti_itanium.c"
      tmp_addr = addr + 0x4;
...
# 633 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                           unsigned long long 
# 633 "project/radare2/libr/anal/rtti_itanium.c"
                                                                                vtable_addr) {
...
# 641 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 641 "project/radare2/libr/anal/rtti_itanium.c"
     rtti_ptr = vtable_addr - (context->word_size);
 
# 642 "project/radare2/libr/anal/rtti_itanium.c" 3 4
unsigned long long 
# 642 "project/radare2/libr/anal/rtti_itanium.c"
     rtti_addr;

 if (!context->read_addr (context->anal, rtti_ptr, &rtti_addr)) {
  return 
# 645 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        ((void *)0)
# 645 "project/radare2/libr/anal/rtti_itanium.c"
            ;
 }
...
# 652 "project/radare2/libr/anal/rtti_itanium.c" 3 4
 unsigned long long 
# 652 "project/radare2/libr/anal/rtti_itanium.c"
      follow;
  if (!context->read_addr (context->anal, rtti_addr, &follow)) {
   return 
# 654 "project/radare2/libr/anal/rtti_itanium.c" 3 4
         ((void *)0)
# 654 "project/radare2/libr/anal/rtti_itanium.c"
             ;
  }
...
# 671 "project/radare2/libr/anal/rtti_itanium.c" 3 4
 do { r_assert_log (R_LOGLVL_ERROR, "file %s: line %d (%s): should not be reached\n", "project/radare2/libr/anal/rtti_itanium.c", 671, ((const char*) (__func__))); return (((void *)0)); } while (0)
# 671 "project/radare2/libr/anal/rtti_itanium.c"
                               ;
 }
 return 
# 673 "project/radare2/libr/anal/rtti_itanium.c" 3 4
       0
# 673 "project/radare2/libr/anal/rtti_itanium.c"
            ;
}
...
# 693 "project/radare2/libr/anal/rtti_itanium.c" 3 4
 do { r_assert_log (R_LOGLVL_ERROR, "file %s: line %d (%s): should not be reached\n", "project/radare2/libr/anal/rtti_itanium.c", 693, ((const char*) (__func__))); return; } while (0)
# 693 "project/radare2/libr/anal/rtti_itanium.c"
                       ;
 }
}


# 697 "project/radare2/libr/anal/rtti_itanium.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 697 "project/radare2/libr/anal/rtti_itanium.c"
          r_anal_rtti_itanium_print_at_vtable(RVTableContext *context, 
# 697 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                       unsigned long long 
# 697 "project/radare2/libr/anal/rtti_itanium.c"
                                                                            addr, int mode) {
 
# 698 "project/radare2/libr/anal/rtti_itanium.c" 3 4
_Bool 
# 698 "project/radare2/libr/anal/rtti_itanium.c"
     use_json = mode == 'j';
 class_type_info *cti = rtti_itanium_type_info_new (context, addr);
 if (!cti) {
  return 
# 701 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        0
# 701 "project/radare2/libr/anal/rtti_itanium.c"
             ;
 }
 ...
 case R_TYPEINFO_TYPE_VMI_CLASS: {
  ...
  return 
# 714 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        1
# 714 "project/radare2/libr/anal/rtti_itanium.c"
            ;
 case R_TYPEINFO_TYPE_SI_CLASS: {
  ...
  return 
# 724 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        1
# 724 "project/radare2/libr/anal/rtti_itanium.c"
            ;
 case R_TYPEINFO_TYPE_CLASS: {
  if (use_json) {
  ...
  return 
# 733 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        1
# 733 "project/radare2/libr/anal/rtti_itanium.c"
            ;
 default:
  rtti_itanium_class_type_info_free (cti);
  
# 736 "project/radare2/libr/anal/rtti_itanium.c" 3 4
 do { r_assert_log (R_LOGLVL_ERROR, "file %s: line %d (%s): should not be reached\n", "project/radare2/libr/anal/rtti_itanium.c", 736, ((const char*) (__func__))); return (0); } while (0)
# 736 "project/radare2/libr/anal/rtti_itanium.c"
                                ;
 }
 return 
# 738 "project/radare2/libr/anal/rtti_itanium.c" 3 4
       0
# 738 "project/radare2/libr/anal/rtti_itanium.c"
            ;
}


# 741 "project/radare2/libr/anal/rtti_itanium.c" 3 4
__attribute__((visibility("default"))) 
# 741 "project/radare2/libr/anal/rtti_itanium.c"
     char *r_anal_rtti_itanium_demangle_class_name(RVTableContext *context, const char *name) {
 if (!name || !*name) {
  return 
# 743 "project/radare2/libr/anal/rtti_itanium.c" 3 4
        ((void *)0)
# 743 "project/radare2/libr/anal/rtti_itanium.c"
            ;
 }

 char *result = 
# 746 "project/radare2/libr/anal/rtti_itanium.c" 3 4
               ((void *)0)
# 746 "project/radare2/libr/anal/rtti_itanium.c"
                   ;

 if (name[0] != '_') {
  char *to_demangle = r_str_newf ("_Z%s", name);
  result = context->anal->binb.demangle (
# 750 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                        ((void *)0)
# 750 "project/radare2/libr/anal/rtti_itanium.c"
                                            , "cxx", to_demangle, 0, 
# 750 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                                     0
# 750 "project/radare2/libr/anal/rtti_itanium.c"
  ...
  result = context->anal->binb.demangle (
# 753 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                        ((void *)0)
# 753 "project/radare2/libr/anal/rtti_itanium.c"
                                            , "cxx", name, 0, 
# 753 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                                              0
# 753 "project/radare2/libr/anal/rtti_itanium.c"
...
static void recovery_apply_vtable(RVTableContext *context, const char *class_name, RVTableInfo *vtable_info) {
 ...
 RAnalVTable vtable = { .id = 
# 764 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                             ((void *)0)
# 764 "project/radare2/libr/anal/rtti_itanium.c"
                                 , .offset = 0, .size = 0, .addr = vtable_info->saddr};
 r_anal_class_vtable_set (context->anal, class_name, &vtable);
 r_anal_class_vtable_fini (&vtable);

 RVTableMethodInfo *vmeth;
 
# 769 "project/radare2/libr/anal/rtti_itanium.c" 3 4
if (!r_vector_empty (
# 769 "project/radare2/libr/anal/rtti_itanium.c"
&vtable_info->methods
# 769 "project/radare2/libr/anal/rtti_itanium.c" 3 4
)) for (
# 769 "project/radare2/libr/anal/rtti_itanium.c"
...
# 773 "project/radare2/libr/anal/rtti_itanium.c" 3 4
                                     "lld"
# 773 "project/radare2/libr/anal/rtti_itanium.c"
                                            , meth.vtable_offset);
...
# 792 "project/radare2/libr/anal/rtti_itanium.c" 3 4
 unsigned long long 
# 792 "project/radare2/libr/anal/rtti_itanium.c"
      base_addr = si_class->base_class_addr;
  base_addr += (context->word_size);
...
# 806 "project/radare2/libr/anal/rtti_itanium.c" 3 4
  unsigned long long 
# 806 "project/radare2/libr/anal/rtti_itanium.c"
       base_addr = base_class_info->base_class_addr + (context->word_size);
   if (rtti_itanium_read_type_name (context, base_addr, &base_info)) {
...
# 821 "project/radare2/libr/anal/rtti_itanium.c" 3 4
__attribute__((visibility("default"))) 
# 821 "project/radare2/libr/anal/rtti_itanium.c"
     void r_anal_rtti_itanium_recover_all(RVTableContext *context, RList *vtables) {
...
# 829 "project/radare2/libr/anal/rtti_itanium.c" 3 4
if (
# 829 "project/radare2/libr/anal/rtti_itanium.c"
vtables
# 829 "project/radare2/libr/anal/rtti_itanium.c" 3 4
) for (
# 829 "project/radare2/libr/anal/rtti_itanium.c"
...
# 849 "project/radare2/libr/anal/rtti_itanium.c" 3 4
if (
# 849 "project/radare2/libr/anal/rtti_itanium.c"
rtti_list
# 849 "project/radare2/libr/anal/rtti_itanium.c" 3 4
) for (
# 849 "project/radare2/libr/anal/rtti_itanium.c"
