# 0 "project/radare2/libr/anal/value.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/anal/value.c" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/anal/value.c"
     RAnalValue *r_anal_value_new(void) {
 return 
# 6 "project/radare2/libr/anal/value.c" 3 4
       (
# 6 "project/radare2/libr/anal/value.c"
       RAnalValue
# 6 "project/radare2/libr/anal/value.c" 3 4
       *)calloc(1,sizeof(
# 6 "project/radare2/libr/anal/value.c"
...
# 9 "project/radare2/libr/anal/value.c" 3 4
__attribute__((visibility("default"))) 
# 9 "project/radare2/libr/anal/value.c"
     RAnalValue *r_anal_value_new_from_string(const char *str) {

 return 
# 11 "project/radare2/libr/anal/value.c" 3 4
       ((void *)0)
# 11 "project/radare2/libr/anal/value.c"
           ;
}


# 14 "project/radare2/libr/anal/value.c" 3 4
__attribute__((visibility("default"))) 
# 14 "project/radare2/libr/anal/value.c"
     RAnalValue *r_anal_value_copy(RAnalValue *ov) {
 
# 15 "project/radare2/libr/anal/value.c" 3 4
do { if (!(
# 15 "project/radare2/libr/anal/value.c"
ov
# 15 "project/radare2/libr/anal/value.c" 3 4
...
# 15 "project/radare2/libr/anal/value.c"
 ...
 RAnalValue *v = 
# 17 "project/radare2/libr/anal/value.c" 3 4
                (
# 17 "project/radare2/libr/anal/value.c"
                RAnalValue
# 17 "project/radare2/libr/anal/value.c" 3 4
                *)calloc(1,sizeof(
# 17 "project/radare2/libr/anal/value.c"
...
# 17 "project/radare2/libr/anal/value.c"
 ...
 if (!v) {
  return 
# 19 "project/radare2/libr/anal/value.c" 3 4
        ((void *)0)
# 19 "project/radare2/libr/anal/value.c"
            ;
 }

 
# 22 "project/radare2/libr/anal/value.c" 3 4
__builtin___memcpy_chk (
# 22 "project/radare2/libr/anal/value.c"
v
# 22 "project/radare2/libr/anal/value.c" 3 4
, 
# 22 "project/radare2/libr/anal/value.c"
ov, sizeof (RAnalValue)
# 22 "project/radare2/libr/anal/value.c" 3 4
...
# 28 "project/radare2/libr/anal/value.c" 3 4
__attribute__((visibility("default"))) 
# 28 "project/radare2/libr/anal/value.c"
     void r_anal_value_free(RAnalValue *value) {
 free (value);
...
# 40 "project/radare2/libr/anal/value.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 40 "project/radare2/libr/anal/value.c"
          r_anal_value_to_ut64(RAnal *anal, RAnalValue *val) {
 
# 41 "project/radare2/libr/anal/value.c" 3 4
unsigned long long 
# 41 "project/radare2/libr/anal/value.c"
     num;
 if (!val) {
  return 0LL;
 }
...
# 58 "project/radare2/libr/anal/value.c" 3 4
 fprintf(__stderrp,
# 58 "project/radare2/libr/anal/value.c"
 "TODO: memref for to_ut64 not supported\n"
# 58 "project/radare2/libr/anal/value.c" 3 4
 )
# 58 "project/radare2/libr/anal/value.c"
                                                     ;
...
# 64 "project/radare2/libr/anal/value.c" 3 4
__attribute__((visibility("default"))) 
# 64 "project/radare2/libr/anal/value.c"
     int r_anal_value_set_ut64(RAnal *anal, RAnalValue *val, 
# 64 "project/radare2/libr/anal/value.c" 3 4
                                                             unsigned long long 
# 64 "project/radare2/libr/anal/value.c"
                                                                  num) {
...
# 67 "project/radare2/libr/anal/value.c" 3 4
  unsigned char 
# 67 "project/radare2/libr/anal/value.c"
      data[8];
   
# 68 "project/radare2/libr/anal/value.c" 3 4
  unsigned long long 
# 68 "project/radare2/libr/anal/value.c"
       addr = r_anal_value_to_ut64 (anal, val);
   r_mem_set_num (data, val->memref, num);
   anal->iob.write_at (anal->iob.io, addr, data, val->memref);
  } else {
   
# 72 "project/radare2/libr/anal/value.c" 3 4
  fprintf(__stderrp,
# 72 "project/radare2/libr/anal/value.c"
  "No IO binded to r_anal\n"
# 72 "project/radare2/libr/anal/value.c" 3 4
  )
# 72 "project/radare2/libr/anal/value.c"
                                      ;
 ...
 return 
# 79 "project/radare2/libr/anal/value.c" 3 4
       0
# 79 "project/radare2/libr/anal/value.c"
            ;
}


# 82 "project/radare2/libr/anal/value.c" 3 4
__attribute__((visibility("default"))) 
# 82 "project/radare2/libr/anal/value.c"
     char *r_anal_value_to_string (RAnalValue *value) {
 char *out = 
# 83 "project/radare2/libr/anal/value.c" 3 4
            ((void *)0)
# 83 "project/radare2/libr/anal/value.c"
                ;
 if (value) {
  out = r_str_new ("");
  if (!value->base && !value->reg) {
   if (value->imm != -1LL) {
    out = r_str_appendf (out, "0x%"
# 88 "project/radare2/libr/anal/value.c" 3 4
                                  "llx"
# 88 "project/radare2/libr/anal/value.c"
                                         , value->imm);
   } else {
   ...
   if (value->base != 0) {
    out = r_str_appendf (out, "0x%" 
# 112 "project/radare2/libr/anal/value.c" 3 4
                                   "llx"
# 112 "project/radare2/libr/anal/value.c"
                                          , value->base);
   }
   if (value->delta > 0) {
    out = r_str_appendf (out, "+0x%" 
# 115 "project/radare2/libr/anal/value.c" 3 4
                                    "llx"
# 115 "project/radare2/libr/anal/value.c"
                                           , value->delta);
   } else if (value->delta < 0) {
    out = r_str_appendf (out, "-0x%" 
# 117 "project/radare2/libr/anal/value.c" 3 4
                                    "llx"
# 117 "project/radare2/libr/anal/value.c"
                                           , -value->delta);
   }
   if (value->memref) {
    out = r_str_append (out, "]");
