# 0 "project/radare2/libr/anal/meta.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/anal/meta.c" 2
...
# 5 "project/radare2/libr/anal/meta.c" 2


# 6 "project/radare2/libr/anal/meta.c"
static 
# 6 "project/radare2/libr/anal/meta.c" 3 4
      _Bool 
# 6 "project/radare2/libr/anal/meta.c"
           item_matches_filter(RAnalMetaItem *item, RAnalMetaType type, const RSpace *space) {
...
static 
# 18 "project/radare2/libr/anal/meta.c" 3 4
      _Bool 
# 18 "project/radare2/libr/anal/meta.c"
           find_node_cb(RIntervalNode *node, void *user) {
 FindCtx *ctx = user;
 if (item_matches_filter (node->data, ctx->type, ctx->space)) {
  ctx->node = node;
  return 
# 22 "project/radare2/libr/anal/meta.c" 3 4
        0
# 22 "project/radare2/libr/anal/meta.c"
             ;
 }
 return 
# 24 "project/radare2/libr/anal/meta.c" 3 4
       1
# 24 "project/radare2/libr/anal/meta.c"
           ;
}

static RIntervalNode *find_node_at(RAnal *anal, RAnalMetaType type, const RSpace *space, 
# 27 "project/radare2/libr/anal/meta.c" 3 4
                                                                                                   unsigned long long 
# 27 "project/radare2/libr/anal/meta.c"
                                                                                                        addr) {
 FindCtx ctx = {
  .type = type,
  .space = space,
  .node = 
# 31 "project/radare2/libr/anal/meta.c" 3 4
         ((void *)0)
 
# 32 "project/radare2/libr/anal/meta.c"
};
 r_interval_tree_all_at (&anal->meta, addr, find_node_cb, &ctx);
 return ctx.node;
}

static RIntervalNode *find_node_in(RAnal *anal, RAnalMetaType type, const RSpace *space, 
# 37 "project/radare2/libr/anal/meta.c" 3 4
                                                                                                   unsigned long long 
# 37 "project/radare2/libr/anal/meta.c"
                                                                                                        addr) {
 FindCtx ctx = {
  .type = type,
  .space = space,
  .node = 
# 41 "project/radare2/libr/anal/meta.c" 3 4
         ((void *)0)
 
# 42 "project/radare2/libr/anal/meta.c"
};
 r_interval_tree_all_in (&anal->meta, addr, 
# 43 "project/radare2/libr/anal/meta.c" 3 4
                                           1
# 43 "project/radare2/libr/anal/meta.c"
                                               , find_node_cb, &ctx);
 return ctx.node;
}
...
static 
# 54 "project/radare2/libr/anal/meta.c" 3 4
      _Bool 
# 54 "project/radare2/libr/anal/meta.c"
           collect_nodes_cb(RIntervalNode *node, void *user) {
 CollectCtx *ctx = user;
 if (item_matches_filter (node->data, ctx->type, ctx->space)) {
  r_pvector_push (ctx->result, node);
 }
 return 
# 59 "project/radare2/libr/anal/meta.c" 3 4
       1
# 59 "project/radare2/libr/anal/meta.c"
           ;
}

static RPVector *collect_nodes_at(RAnal *anal, RAnalMetaType type, const RSpace *space, 
# 62 "project/radare2/libr/anal/meta.c" 3 4
                                                                                                  unsigned long long 
# 62 "project/radare2/libr/anal/meta.c"
                                                                                                       addr) {
 CollectCtx ctx = {
  .type = type,
  .space = space,
  .result = r_pvector_new (
# 66 "project/radare2/libr/anal/meta.c" 3 4
                          ((void *)0)
# 66 "project/radare2/libr/anal/meta.c"
                              )
 };
 if (!ctx.result) {
  return 
# 69 "project/radare2/libr/anal/meta.c" 3 4
        ((void *)0)
# 69 "project/radare2/libr/anal/meta.c"
            ;
 }
...
static RPVector *collect_nodes_in(RAnal *anal, RAnalMetaType type, const RSpace *space, 
# 75 "project/radare2/libr/anal/meta.c" 3 4
                                                                                                  unsigned long long 
# 75 "project/radare2/libr/anal/meta.c"
                                                                                                       addr) {
 CollectCtx ctx = {
  .type = type,
  .space = space,
  .result = r_pvector_new (
# 79 "project/radare2/libr/anal/meta.c" 3 4
                          ((void *)0)
# 79 "project/radare2/libr/anal/meta.c"
                              )
 };
 if (!ctx.result) {
  return 
# 82 "project/radare2/libr/anal/meta.c" 3 4
        ((void *)0)
# 82 "project/radare2/libr/anal/meta.c"
            ;
 }
 r_interval_tree_all_in (&anal->meta, addr, 
# 84 "project/radare2/libr/anal/meta.c" 3 4
                                           1
# 84 "project/radare2/libr/anal/meta.c"
                                               , collect_nodes_cb, &ctx);
 return ctx.result;
}

static RPVector *collect_nodes_intersect(RAnal *anal, RAnalMetaType type, const RSpace *space, 
# 88 "project/radare2/libr/anal/meta.c" 3 4
                                                                                                         unsigned long long 
# 88 "project/radare2/libr/anal/meta.c"
                                                                                                              start, 
# 88 "project/radare2/libr/anal/meta.c" 3 4
                                                                                                                     unsigned long long 
# 88 "project/radare2/libr/anal/meta.c"
 ...
 CollectCtx ctx = {
  ...
  .space = space,
  .result = r_pvector_new (
# 92 "project/radare2/libr/anal/meta.c" 3 4
                          ((void *)0)
# 92 "project/radare2/libr/anal/meta.c"
                              )
 };
 if (!ctx.result) {
  return 
# 95 "project/radare2/libr/anal/meta.c" 3 4
        ((void *)0)
# 95 "project/radare2/libr/anal/meta.c"
            ;
 }
 r_interval_tree_all_intersect (&anal->meta, start, end, 
# 97 "project/radare2/libr/anal/meta.c" 3 4
                                                        1
# 97 "project/radare2/libr/anal/meta.c"
                                                            , collect_nodes_cb, &ctx);
 return ctx.result;
}

static 
# 101 "project/radare2/libr/anal/meta.c" 3 4
      _Bool 
# 101 "project/radare2/libr/anal/meta.c"
           meta_set(RAnal *a, RAnalMetaType type, int subtype, 
# 101 "project/radare2/libr/anal/meta.c" 3 4
                                                               unsigned long long 
# 101 "project/radare2/libr/anal/meta.c"
                                                                    from, 
...
# 101 "project/radare2/libr/anal/meta.c"
 ...
 if (to < from) {
  return 
# 103 "project/radare2/libr/anal/meta.c" 3 4
        0
# 103 "project/radare2/libr/anal/meta.c"
             ;
 }
 RSpace *space = r_spaces_current (&a->meta_spaces);
 RIntervalNode *node = find_node_at (a, type, space, from);
 RAnalMetaItem *item = node ? node->data : 
# 107 "project/radare2/libr/anal/meta.c" 3 4
                                          (
# 107 "project/radare2/libr/anal/meta.c"
                                          RAnalMetaItem
# 107 "project/radare2/libr/anal/meta.c" 3 4
                                          *)calloc(1,sizeof(
# 107 "project/radare2/libr/anal/meta.c"
...
# 107 "project/radare2/libr/anal/meta.c"
 ...
 if (!item) {
  return 
# 109 "project/radare2/libr/anal/meta.c" 3 4
        0
# 109 "project/radare2/libr/anal/meta.c"
             ;
 }
 item->type = type;
 ...
 item->space = space;
 free (item->str);
 item->str = str ? strdup (str) : 
# 115 "project/radare2/libr/anal/meta.c" 3 4
                                 ((void *)0)
# 115 "project/radare2/libr/anal/meta.c"
                                     ;
 if (str && !item->str) {
  if (!node) {
   free (item);
  ...
  return 
# 120 "project/radare2/libr/anal/meta.c" 3 4
        0
# 120 "project/radare2/libr/anal/meta.c"
             ;
 }
 if (!node) {
 ...
 return 
# 127 "project/radare2/libr/anal/meta.c" 3 4
       1
# 127 "project/radare2/libr/anal/meta.c"
           ;
}


# 130 "project/radare2/libr/anal/meta.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 130 "project/radare2/libr/anal/meta.c"
          r_meta_set_string(RAnal *a, RAnalMetaType type, 
# 130 "project/radare2/libr/anal/meta.c" 3 4
                                                          unsigned long long 
# 130 "project/radare2/libr/anal/meta.c"
                                                               addr, const char *s) {
...
# 134 "project/radare2/libr/anal/meta.c" 3 4
__attribute__((visibility("default"))) 
# 134 "project/radare2/libr/anal/meta.c"
     const char *r_meta_get_string(RAnal *a, RAnalMetaType type, 
# 134 "project/radare2/libr/anal/meta.c" 3 4
                                                                 unsigned long long 
# 134 "project/radare2/libr/anal/meta.c"
                                                                      addr) {
 ...
 if (!node) {
  return 
# 137 "project/radare2/libr/anal/meta.c" 3 4
        ((void *)0)
# 137 "project/radare2/libr/anal/meta.c"
            ;
 }
...
static void del(RAnal *a, RAnalMetaType type, const RSpace *space, 
# 144 "project/radare2/libr/anal/meta.c" 3 4
                                                                  unsigned long long 
# 144 "project/radare2/libr/anal/meta.c"
                                                                       addr, 
# 144 "project/radare2/libr/anal/meta.c" 3 4
                                                                             unsigned long long 
# 144 "project/radare2/libr/anal/meta.c"
                                                                                  size) {
 RPVector *victims = 
# 145 "project/radare2/libr/anal/meta.c" 3 4
                    ((void *)0)
# 145 "project/radare2/libr/anal/meta.c"
                        ;
 if (size == 
# 146 "project/radare2/libr/anal/meta.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 146 "project/radare2/libr/anal/meta.c"
                    ) {

  victims = r_pvector_new (
# 148 "project/radare2/libr/anal/meta.c" 3 4
                          ((void *)0)
# 148 "project/radare2/libr/anal/meta.c"
                              );
  if (!victims) {
   return;
  }
...
# 154 "project/radare2/libr/anal/meta.c" 3 4
 if ((
# 154 "project/radare2/libr/anal/meta.c"
 &a->meta
# 154 "project/radare2/libr/anal/meta.c" 3 4
 )->root) for ((
# 154 "project/radare2/libr/anal/meta.c"
...
# 160 "project/radare2/libr/anal/meta.c" 3 4
 unsigned long long 
# 160 "project/radare2/libr/anal/meta.c"
      end = size ? addr + size - 1 : addr;
  if (end < addr) {
   end = 
# 162 "project/radare2/libr/anal/meta.c" 3 4
        0xFFFFFFFFFFFFFFFFULL
# 162 "project/radare2/libr/anal/meta.c"
                ;
  }
...
# 170 "project/radare2/libr/anal/meta.c" 3 4
for (
# 170 "project/radare2/libr/anal/meta.c"
it 
# 170 "project/radare2/libr/anal/meta.c" 3 4
= (void **)(
# 170 "project/radare2/libr/anal/meta.c"
...
# 170 "project/radare2/libr/anal/meta.c"
                                {
  r_interval_tree_delete (&a->meta, *it, 
# 171 "project/radare2/libr/anal/meta.c" 3 4
                                        1
# 171 "project/radare2/libr/anal/meta.c"
                                            );
 }
...
# 176 "project/radare2/libr/anal/meta.c" 3 4
__attribute__((visibility("default"))) 
# 176 "project/radare2/libr/anal/meta.c"
     void r_meta_del(RAnal *a, RAnalMetaType type, 
# 176 "project/radare2/libr/anal/meta.c" 3 4
                                                   unsigned long long 
# 176 "project/radare2/libr/anal/meta.c"
                                                        addr, 
...
# 180 "project/radare2/libr/anal/meta.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 180 "project/radare2/libr/anal/meta.c"
          r_meta_set(RAnal *a, RAnalMetaType type, 
# 180 "project/radare2/libr/anal/meta.c" 3 4
                                                   unsigned long long 
# 180 "project/radare2/libr/anal/meta.c"
                                                        addr, 
...
# 184 "project/radare2/libr/anal/meta.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 184 "project/radare2/libr/anal/meta.c"
          r_meta_set_with_subtype(RAnal *m, RAnalMetaType type, int subtype, 
# 184 "project/radare2/libr/anal/meta.c" 3 4
                                                                             unsigned long long 
# 184 "project/radare2/libr/anal/meta.c"
                                                                                  addr, 
...
# 185 "project/radare2/libr/anal/meta.c" 3 4
do { if (!(
# 185 "project/radare2/libr/anal/meta.c"
m && size
# 185 "project/radare2/libr/anal/meta.c" 3 4
...
# 186 "project/radare2/libr/anal/meta.c" 3 4
unsigned long long 
# 186 "project/radare2/libr/anal/meta.c"
     end = addr + size - 1;
 if (end < addr) {
  end = 
# 188 "project/radare2/libr/anal/meta.c" 3 4
       0xFFFFFFFFFFFFFFFFULL
# 188 "project/radare2/libr/anal/meta.c"
               ;
 }
...
# 193 "project/radare2/libr/anal/meta.c" 3 4
__attribute__((visibility("default"))) 
# 193 "project/radare2/libr/anal/meta.c"
     RAnalMetaItem *r_meta_get_at(RAnal *a, 
# 193 "project/radare2/libr/anal/meta.c" 3 4
                                            unsigned long long 
# 193 "project/radare2/libr/anal/meta.c"
                                                 addr, RAnalMetaType type, 
# 193 "project/radare2/libr/anal/meta.c" 3 4
                                                                                            unsigned long long 
# 193 "project/radare2/libr/anal/meta.c"
                                                                                                 *size) {
...
# 198 "project/radare2/libr/anal/meta.c" 3 4
                           ((void *)0)
# 198 "project/radare2/libr/anal/meta.c"
                               ;
}


# 201 "project/radare2/libr/anal/meta.c" 3 4
__attribute__((visibility("default"))) 
# 201 "project/radare2/libr/anal/meta.c"
     RIntervalNode *r_meta_get_in(RAnal *a, 
# 201 "project/radare2/libr/anal/meta.c" 3 4
                                            unsigned long long 
# 201 "project/radare2/libr/anal/meta.c"
                                                 addr, RAnalMetaType type) {
...
# 205 "project/radare2/libr/anal/meta.c" 3 4
__attribute__((visibility("default"))) 
# 205 "project/radare2/libr/anal/meta.c"
     RPVector *r_meta_get_all_at(RAnal *a, 
# 205 "project/radare2/libr/anal/meta.c" 3 4
                                                                           unsigned long long 
# 205 "project/radare2/libr/anal/meta.c"
                                                                                at) {
...
# 209 "project/radare2/libr/anal/meta.c" 3 4
__attribute__((visibility("default"))) 
# 209 "project/radare2/libr/anal/meta.c"
     RPVector *r_meta_get_all_in(RAnal *a, 
# 209 "project/radare2/libr/anal/meta.c" 3 4
                                           unsigned long long 
# 209 "project/radare2/libr/anal/meta.c"
                                                at, RAnalMetaType type) {
 return collect_nodes_in (a, type, r_spaces_current (&a->meta_spaces), at);
}


# 213 "project/radare2/libr/anal/meta.c" 3 4
__attribute__((visibility("default"))) 
# 213 "project/radare2/libr/anal/meta.c"
     RPVector *r_meta_get_all_intersect(RAnal *a, 
# 213 "project/radare2/libr/anal/meta.c" 3 4
                                                  unsigned long long 
# 213 "project/radare2/libr/anal/meta.c"
                                                       start, 
# 213 "project/radare2/libr/anal/meta.c" 3 4
                                                              unsigned long long 
# 213 "project/radare2/libr/anal/meta.c"
                                                                   size, RAnalMetaType type) {
 
# 214 "project/radare2/libr/anal/meta.c" 3 4
do { if (!(
# 214 "project/radare2/libr/anal/meta.c"
size
# 214 "project/radare2/libr/anal/meta.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 214 "project/radare2/libr/anal/meta.c"
"size"
# 214 "project/radare2/libr/anal/meta.c" 3 4
, 214); return (((void *)0)); } } while (0)
# 214 "project/radare2/libr/anal/meta.c"
                                 ;
 
# 215 "project/radare2/libr/anal/meta.c" 3 4
unsigned long long 
# 215 "project/radare2/libr/anal/meta.c"
     end = start + size - 1;
 if (end < start) {
  end = 
# 217 "project/radare2/libr/anal/meta.c" 3 4
       0xFFFFFFFFFFFFFFFFULL
# 217 "project/radare2/libr/anal/meta.c"
               ;
 }
...
# 222 "project/radare2/libr/anal/meta.c" 3 4
__attribute__((visibility("default"))) 
# 222 "project/radare2/libr/anal/meta.c"
...
# 239 "project/radare2/libr/anal/meta.c" 3 4
__attribute__((visibility("default"))) 
# 239 "project/radare2/libr/anal/meta.c"
     void r_meta_print(RAnal *a, RAnalMetaItem *d, 
# 239 "project/radare2/libr/anal/meta.c" 3 4
                                                   unsigned long long 
# 239 "project/radare2/libr/anal/meta.c"
                                                        start, 
...
# 240 "project/radare2/libr/anal/meta.c" 3 4
do { if (!(
# 240 "project/radare2/libr/anal/meta.c"
!(rad == 'j' && !pj)
# 240 "project/radare2/libr/anal/meta.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 240 "project/radare2/libr/anal/meta.c"
...
# 243 "project/radare2/libr/anal/meta.c" 3 4
_Bool 
# 243 "project/radare2/libr/anal/meta.c"
     esc_bslash = core ? core->print->esc_bslash : 
# 243 "project/radare2/libr/anal/meta.c" 3 4
                                                   0
# 243 "project/radare2/libr/anal/meta.c"
                                                        ;
 ...
 char *str = 
# 248 "project/radare2/libr/anal/meta.c" 3 4
            ((void *)0)
# 248 "project/radare2/libr/anal/meta.c"
                ;
 if (d->str) {
  if (d->type == R_META_TYPE_STRING) {
   if (d->subtype == R_STRING_ENC_UTF8) {
    str = r_str_escape_utf8 (d->str, 
# 252 "project/radare2/libr/anal/meta.c" 3 4
                                    0
# 252 "project/radare2/libr/anal/meta.c"
                                         , esc_bslash);
   } else {
    if (!d->subtype) {
     esc_bslash = 
# 255 "project/radare2/libr/anal/meta.c" 3 4
                 0
# 255 "project/radare2/libr/anal/meta.c"
                      ;
    }
    str = r_str_escape_latin1 (d->str, 
# 257 "project/radare2/libr/anal/meta.c" 3 4
                                      0
# 257 "project/radare2/libr/anal/meta.c"
                                           , esc_bslash, 
# 257 "project/radare2/libr/anal/meta.c" 3 4
                                                         0
# 257 "project/radare2/libr/anal/meta.c"
...
# 295 "project/radare2/libr/anal/meta.c" 3 4
   unsigned char 
# 295 "project/radare2/libr/anal/meta.c"
       r = 0, g = 0, b = 0, A = 0;
  ...
  default:
   ...
   case R_META_TYPE_COMMENT:
    ...
    char *s = sdb_encode ((const 
# 347 "project/radare2/libr/anal/meta.c" 3 4
                                unsigned char
# 347 "project/radare2/libr/anal/meta.c"
                                   *)pstr, -1);
    if (!s) {
     s = strdup (pstr);
    }
    if (rad) {
     if (!strcmp (type, "CCu")) {
      a->cb_printf ("%s base64:%s @ 0x%08" 
# 353 "project/radare2/libr/anal/meta.c" 3 4
                                          "llx" 
# 353 "project/radare2/libr/anal/meta.c"
                                                  "\n",
        type, s, start);
     } else {
      a->cb_printf ("%s %s @ 0x%08" 
# 356 "project/radare2/libr/anal/meta.c" 3 4
                                   "llx" 
# 356 "project/radare2/libr/anal/meta.c"
                                           "\n",
        type, pstr, start);
     }
    } else {
     if (!strcmp (type, "CCu")) {
      ...
      a->cb_printf ("0x%08" 
# 362 "project/radare2/libr/anal/meta.c" 3 4
                           "llx" 
# 362 "project/radare2/libr/anal/meta.c"
                                   " %s \"%s\"\n",
        start, type, mys);
      free (mys);
     } else {
      a->cb_printf ("0x%08"
# 366 "project/radare2/libr/anal/meta.c" 3 4
                          "llx"
# 366 "project/radare2/libr/anal/meta.c"
                                 " %s \"%s\"\n",
        start, type, pstr);
     }
    }
   ...
   case R_META_TYPE_STRING:
    if (rad) {
     ...
     a->cb_printf ("%s %" 
# 384 "project/radare2/libr/anal/meta.c" 3 4
                         "llu" 
# 384 "project/radare2/libr/anal/meta.c"
                                 " @ 0x%08" 
# 384 "project/radare2/libr/anal/meta.c" 3 4
                                            "llx" 
# 384 "project/radare2/libr/anal/meta.c"
     ...
     if (show_full) {
      a->cb_printf ("0x%08" 
# 396 "project/radare2/libr/anal/meta.c" 3 4
                           "llx" 
# 396 "project/radare2/libr/anal/meta.c"
                                   " %s[%" 
# 396 "project/radare2/libr/anal/meta.c" 3 4
                                           "llu" 
# 396 "project/radare2/libr/anal/meta.c"
      ...
      a->cb_printf ("%s[%" 
# 399 "project/radare2/libr/anal/meta.c" 3 4
                          "llu" 
# 399 "project/radare2/libr/anal/meta.c"
                                  "] \"%s\"\n",
        enc, size, pstr);
     }
    }
   ...
   case R_META_TYPE_DATA:
    if (rad) {
     a->cb_printf ("%s %" 
# 407 "project/radare2/libr/anal/meta.c" 3 4
                         "llu" 
# 407 "project/radare2/libr/anal/meta.c"
                                 " @ 0x%08" 
# 407 "project/radare2/libr/anal/meta.c" 3 4
                                            "llx" 
# 407 "project/radare2/libr/anal/meta.c"
     ...
     if (show_full) {
      ...
      a->cb_printf ("0x%08" 
# 413 "project/radare2/libr/anal/meta.c" 3 4
                           "llx" 
# 413 "project/radare2/libr/anal/meta.c"
                                   " %s %s %"
# 413 "project/radare2/libr/anal/meta.c" 3 4
                                             "llu"
# 413 "project/radare2/libr/anal/meta.c"
      ...
      a->cb_printf ("%" 
# 418 "project/radare2/libr/anal/meta.c" 3 4
                       "llu" 
# 418 "project/radare2/libr/anal/meta.c"
                               "\n", size);
     }
    }
    break;
   ...
   case R_META_TYPE_FORMAT:
    if (rad) {
     a->cb_printf ("%s %" 
# 425 "project/radare2/libr/anal/meta.c" 3 4
                         "llu" 
# 425 "project/radare2/libr/anal/meta.c"
                                 " %s @ 0x%08" 
# 425 "project/radare2/libr/anal/meta.c" 3 4
                                               "llx" 
# 425 "project/radare2/libr/anal/meta.c"
     ...
     if (show_full) {
      ...
      a->cb_printf ("0x%08" 
# 431 "project/radare2/libr/anal/meta.c" 3 4
                           "llx" 
# 431 "project/radare2/libr/anal/meta.c"
                                   " %s %" 
# 431 "project/radare2/libr/anal/meta.c" 3 4
                                           "llu" 
# 431 "project/radare2/libr/anal/meta.c"
      ...
      a->cb_printf ("%" 
# 434 "project/radare2/libr/anal/meta.c" 3 4
                       "llu" 
# 434 "project/radare2/libr/anal/meta.c"
                               " %s\n", size, pstr);
     }
    }
    break;
   case R_META_TYPE_VARTYPE:
    if (rad) {
     a->cb_printf ("%s %s @ 0x%08" 
# 440 "project/radare2/libr/anal/meta.c" 3 4
                                  "llx" 
# 440 "project/radare2/libr/anal/meta.c"
                                          "\n",
       r_meta_type_to_string (d->type), pstr, start);
    } else {
     a->cb_printf ("0x%08" 
# 443 "project/radare2/libr/anal/meta.c" 3 4
                          "llx" 
# 443 "project/radare2/libr/anal/meta.c"
                                  " %s\n", start, pstr);
    }
    break;
...
# 448 "project/radare2/libr/anal/meta.c" 3 4
    unsigned char 
# 448 "project/radare2/libr/anal/meta.c"
        r = 0, g = 0, b = 0, A = 0;
     const char *esc = strchr (d->str, '\x1b');
     r_cons_rgb_parse (esc, &r, &g, &b, &A);
     a->cb_printf ("%s rgb:%02x%02x%02x @ 0x%08" 
# 451 "project/radare2/libr/anal/meta.c" 3 4
                                                "llx" 
# 451 "project/radare2/libr/anal/meta.c"
                                                        "\n",
   ...
   default:
    if (rad) {
     a->cb_printf ("%s %" 
# 458 "project/radare2/libr/anal/meta.c" 3 4
                         "llu" 
# 458 "project/radare2/libr/anal/meta.c"
                                 " 0x%08" 
# 458 "project/radare2/libr/anal/meta.c" 3 4
                                          "llx" 
# 458 "project/radare2/libr/anal/meta.c"
     ...
     a->cb_printf ("0x%08" 
# 463 "project/radare2/libr/anal/meta.c" 3 4
                          "llx" 
# 463 "project/radare2/libr/anal/meta.c"
                                  " array[%" 
# 463 "project/radare2/libr/anal/meta.c" 3 4
                                             "llu" 
# 463 "project/radare2/libr/anal/meta.c"
...
# 477 "project/radare2/libr/anal/meta.c" 3 4
__attribute__((visibility("default"))) 
# 477 "project/radare2/libr/anal/meta.c"
     void r_meta_print_list_at(RAnal *a, 
# 477 "project/radare2/libr/anal/meta.c" 3 4
                                         unsigned long long 
# 477 "project/radare2/libr/anal/meta.c"
                                              addr, int rad, const char *tq) {
...
# 483 "project/radare2/libr/anal/meta.c" 3 4
for (
# 483 "project/radare2/libr/anal/meta.c"
it 
# 483 "project/radare2/libr/anal/meta.c" 3 4
= (void **)(
# 483 "project/radare2/libr/anal/meta.c"
...
# 483 "project/radare2/libr/anal/meta.c"
  ...
  r_meta_print (a, node->data, node->start, r_meta_node_size (node), rad, 
# 485 "project/radare2/libr/anal/meta.c" 3 4
                                                                         ((void *)0)
# 485 "project/radare2/libr/anal/meta.c"
                                                                             , 
# 485 "project/radare2/libr/anal/meta.c" 3 4
                                                                               1
# 485 "project/radare2/libr/anal/meta.c"
...
static void print_meta_list(RAnal *a, int type, int rad, 
# 490 "project/radare2/libr/anal/meta.c" 3 4
                                                        unsigned long long 
# 490 "project/radare2/libr/anal/meta.c"
                                                             addr, const char *tq) {
 PJ *pj = 
# 491 "project/radare2/libr/anal/meta.c" 3 4
         ((void *)0)
# 491 "project/radare2/libr/anal/meta.c"
             ;
 RTable *t = 
# 492 "project/radare2/libr/anal/meta.c" 3 4
            ((void *)0)
# 492 "project/radare2/libr/anal/meta.c"
                ;
 if (rad == ',') {
  t = r_table_new ("meta");
 ...
 RAnalFunction *fcn = 
# 509 "project/radare2/libr/anal/meta.c" 3 4
                     ((void *)0)
# 509 "project/radare2/libr/anal/meta.c"
                         ;
 if (addr != 
# 510 "project/radare2/libr/anal/meta.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 510 "project/radare2/libr/anal/meta.c"
                    ) {
...
# 519 "project/radare2/libr/anal/meta.c" 3 4
if ((
# 519 "project/radare2/libr/anal/meta.c"
&a->meta
# 519 "project/radare2/libr/anal/meta.c" 3 4
)->root) for ((
# 519 "project/radare2/libr/anal/meta.c"
...
# 519 "project/radare2/libr/anal/meta.c"
  ...
  if (t) {
   ...
   r_meta_print (a, item, node->start, r_meta_node_size (node), rad, pj, 
# 535 "project/radare2/libr/anal/meta.c" 3 4
                                                                        1
# 535 "project/radare2/libr/anal/meta.c"
                                                                            );
  }
 }
...
# 554 "project/radare2/libr/anal/meta.c" 3 4
__attribute__((visibility("default"))) 
# 554 "project/radare2/libr/anal/meta.c"
     void r_meta_print_list_all(RAnal *a, int type, int rad, const char *tq) {
 print_meta_list (a, type, rad, 
# 555 "project/radare2/libr/anal/meta.c" 3 4
                               0xFFFFFFFFFFFFFFFFULL
# 555 "project/radare2/libr/anal/meta.c"
                                       , tq);
}


# 558 "project/radare2/libr/anal/meta.c" 3 4
__attribute__((visibility("default"))) 
# 558 "project/radare2/libr/anal/meta.c"
     void r_meta_print_list_in_function(RAnal *a, int type, int rad, 
# 558 "project/radare2/libr/anal/meta.c" 3 4
                                                                     unsigned long long 
# 558 "project/radare2/libr/anal/meta.c"
                                                                          addr, const char *tq) {
...
# 562 "project/radare2/libr/anal/meta.c" 3 4
__attribute__((visibility("default"))) 
# 562 "project/radare2/libr/anal/meta.c"
     void r_meta_rebase(RAnal *anal, 
# 562 "project/radare2/libr/anal/meta.c" 3 4
                                     unsigned long long 
# 562 "project/radare2/libr/anal/meta.c"
                                          diff) {
...
# 570 "project/radare2/libr/anal/meta.c" 3 4
if ((
# 570 "project/radare2/libr/anal/meta.c"
&old
# 570 "project/radare2/libr/anal/meta.c" 3 4
)->root) for ((
# 570 "project/radare2/libr/anal/meta.c"
...
# 572 "project/radare2/libr/anal/meta.c" 3 4
 unsigned long long 
# 572 "project/radare2/libr/anal/meta.c"
      newstart = node->start + diff;
  
# 573 "project/radare2/libr/anal/meta.c" 3 4
 unsigned long long 
# 573 "project/radare2/libr/anal/meta.c"
      newend = node->end + diff;
  if (newend < newstart) {
 ...
 old.free = 
# 581 "project/radare2/libr/anal/meta.c" 3 4
           ((void *)0)
# 581 "project/radare2/libr/anal/meta.c"
               ;
 r_interval_tree_fini (&old);
}


# 585 "project/radare2/libr/anal/meta.c" 3 4
__attribute__((visibility("default"))) 
# 585 "project/radare2/libr/anal/meta.c"
     void r_meta_space_unset_for(RAnal *a, const RSpace *space) {
 del (a, R_META_TYPE_ANY, space, 0, 
# 586 "project/radare2/libr/anal/meta.c" 3 4
                                   0xFFFFFFFFFFFFFFFFULL
# 586 "project/radare2/libr/anal/meta.c"
                                           );
}


# 589 "project/radare2/libr/anal/meta.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 589 "project/radare2/libr/anal/meta.c"
          r_meta_get_size(RAnal *a, RAnalMetaType type) {
 
# 590 "project/radare2/libr/anal/meta.c" 3 4
do { if (!(
# 590 "project/radare2/libr/anal/meta.c"
a
# 590 "project/radare2/libr/anal/meta.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 590 "project/radare2/libr/anal/meta.c"
...
# 594 "project/radare2/libr/anal/meta.c" 3 4
unsigned long long 
# 594 "project/radare2/libr/anal/meta.c"
     sum = 0;
 RIntervalTreeIter it;
 RAnalMetaItem *item;
 RIntervalNode *prev = 
# 597 "project/radare2/libr/anal/meta.c" 3 4
                      ((void *)0)
# 597 "project/radare2/libr/anal/meta.c"
                          ;
 
# 598 "project/radare2/libr/anal/meta.c" 3 4
if ((
# 598 "project/radare2/libr/anal/meta.c"
&a->meta
# 598 "project/radare2/libr/anal/meta.c" 3 4
)->root) for ((
# 598 "project/radare2/libr/anal/meta.c"
...
# 603 "project/radare2/libr/anal/meta.c" 3 4
 unsigned long long 
# 603 "project/radare2/libr/anal/meta.c"
      start = 
# 603 "project/radare2/libr/anal/meta.c" 3 4
              (((
# 603 "project/radare2/libr/anal/meta.c"
...
# 610 "project/radare2/libr/anal/meta.c" 3 4
__attribute__((visibility("default"))) 
# 610 "project/radare2/libr/anal/meta.c"
     int r_meta_space_count_for(RAnal *a, const RSpace *space) {
 int r = 0;
 RIntervalTreeIter it;
 RAnalMetaItem *item;
 
# 614 "project/radare2/libr/anal/meta.c" 3 4
if ((
# 614 "project/radare2/libr/anal/meta.c"
&a->meta
# 614 "project/radare2/libr/anal/meta.c" 3 4
)->root) for ((
# 614 "project/radare2/libr/anal/meta.c"
...
# 622 "project/radare2/libr/anal/meta.c" 3 4
__attribute__((visibility("default"))) 
# 622 "project/radare2/libr/anal/meta.c"
     void r_meta_set_data_at(RAnal *a, 
# 622 "project/radare2/libr/anal/meta.c" 3 4
                                       unsigned long long 
# 622 "project/radare2/libr/anal/meta.c"
                                            addr, 
...
# 623 "project/radare2/libr/anal/meta.c" 3 4
do { if (!(
# 623 "project/radare2/libr/anal/meta.c"
wordsz
# 623 "project/radare2/libr/anal/meta.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 623 "project/radare2/libr/anal/meta.c"
...
# 623 "project/radare2/libr/anal/meta.c"
                         ;
 r_meta_set (a, R_META_TYPE_DATA, addr, wordsz, 
# 624 "project/radare2/libr/anal/meta.c" 3 4
                                               ((void *)0)
# 624 "project/radare2/libr/anal/meta.c"
                                                   );
}
