# 0 "project/radare2/libr/anal/codemeta.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/anal/codemeta.c" 2




__attribute__((visibility("default"))) 
# 8 "project/radare2/libr/anal/codemeta.c"
     RCodeMetaItem *r_codemeta_item_clone(RCodeMetaItem *code) {
 
# 9 "project/radare2/libr/anal/codemeta.c" 3 4
do { if (!(
# 9 "project/radare2/libr/anal/codemeta.c"
code
# 9 "project/radare2/libr/anal/codemeta.c" 3 4
...
# 11 "project/radare2/libr/anal/codemeta.c" 3 4
__builtin___memcpy_chk (
# 11 "project/radare2/libr/anal/codemeta.c"
mi
# 11 "project/radare2/libr/anal/codemeta.c" 3 4
, 
# 11 "project/radare2/libr/anal/codemeta.c"
code, sizeof (RCodeMetaItem)
# 11 "project/radare2/libr/anal/codemeta.c" 3 4
...
# 29 "project/radare2/libr/anal/codemeta.c" 3 4
__attribute__((visibility("default"))) 
# 29 "project/radare2/libr/anal/codemeta.c"
     RCodeMeta *r_codemeta_clone(RCodeMeta *code) {
 RCodeMeta *r = r_codemeta_new (code->code);
 RCodeMetaItem *mi;
 
# 32 "project/radare2/libr/anal/codemeta.c" 3 4
if (!r_vector_empty (
# 32 "project/radare2/libr/anal/codemeta.c"
&code->annotations
# 32 "project/radare2/libr/anal/codemeta.c" 3 4
)) for (
# 32 "project/radare2/libr/anal/codemeta.c"
...
# 38 "project/radare2/libr/anal/codemeta.c" 3 4
__attribute__((visibility("default"))) 
# 38 "project/radare2/libr/anal/codemeta.c"
     RCodeMeta *r_codemeta_new(const char *code) {
 RCodeMeta *r = 
# 39 "project/radare2/libr/anal/codemeta.c" 3 4
               (
# 39 "project/radare2/libr/anal/codemeta.c"
               RCodeMeta
# 39 "project/radare2/libr/anal/codemeta.c" 3 4
               *)calloc(1,sizeof(
# 39 "project/radare2/libr/anal/codemeta.c"
...
# 39 "project/radare2/libr/anal/codemeta.c"
 ...
 if (!r) {
  return 
# 41 "project/radare2/libr/anal/codemeta.c" 3 4
        ((void *)0)
# 41 "project/radare2/libr/anal/codemeta.c"
            ;
 }
 r->tree = r_crbtree_new (
# 43 "project/radare2/libr/anal/codemeta.c" 3 4
                         ((void *)0)
# 43 "project/radare2/libr/anal/codemeta.c"
                             );
 r->code = code? strdup (code): 
# 44 "project/radare2/libr/anal/codemeta.c" 3 4
                               ((void *)0)
# 44 "project/radare2/libr/anal/codemeta.c"
                                   ;
 r_vector_init (&r->annotations, sizeof (RCodeMetaItem), (RVectorFree)r_codemeta_item_fini, 
# 45 "project/radare2/libr/anal/codemeta.c" 3 4
                                                                                           ((void *)0)
# 45 "project/radare2/libr/anal/codemeta.c"
                                                                                               );
 return r;
}


# 49 "project/radare2/libr/anal/codemeta.c" 3 4
__attribute__((visibility("default"))) 
# 49 "project/radare2/libr/anal/codemeta.c"
     RCodeMetaItem *r_codemeta_item_new(void) {
 return 
# 50 "project/radare2/libr/anal/codemeta.c" 3 4
       (
# 50 "project/radare2/libr/anal/codemeta.c"
       RCodeMetaItem
# 50 "project/radare2/libr/anal/codemeta.c" 3 4
       *)calloc(1,sizeof(
# 50 "project/radare2/libr/anal/codemeta.c"
...
# 53 "project/radare2/libr/anal/codemeta.c" 3 4
__attribute__((visibility("default"))) 
# 53 "project/radare2/libr/anal/codemeta.c"
     void r_codemeta_item_free(RCodeMetaItem *mi) {
 if (mi) {
...
# 60 "project/radare2/libr/anal/codemeta.c" 3 4
__attribute__((visibility("default"))) 
# 60 "project/radare2/libr/anal/codemeta.c"
     void r_codemeta_item_fini(RCodeMetaItem *mi) {
 
# 61 "project/radare2/libr/anal/codemeta.c" 3 4
do { if (!(
# 61 "project/radare2/libr/anal/codemeta.c"
mi
# 61 "project/radare2/libr/anal/codemeta.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 61 "project/radare2/libr/anal/codemeta.c"
...
# 78 "project/radare2/libr/anal/codemeta.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 78 "project/radare2/libr/anal/codemeta.c"
          r_codemeta_item_is_reference(RCodeMetaItem *mi) {
 
# 79 "project/radare2/libr/anal/codemeta.c" 3 4
do { if (!(
# 79 "project/radare2/libr/anal/codemeta.c"
mi
# 79 "project/radare2/libr/anal/codemeta.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 79 "project/radare2/libr/anal/codemeta.c"
...
# 83 "project/radare2/libr/anal/codemeta.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 83 "project/radare2/libr/anal/codemeta.c"
          r_codemeta_item_is_variable(RCodeMetaItem *mi) {
 
# 84 "project/radare2/libr/anal/codemeta.c" 3 4
do { if (!(
# 84 "project/radare2/libr/anal/codemeta.c"
mi
# 84 "project/radare2/libr/anal/codemeta.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 84 "project/radare2/libr/anal/codemeta.c"
...
# 88 "project/radare2/libr/anal/codemeta.c" 3 4
__attribute__((visibility("default"))) 
# 88 "project/radare2/libr/anal/codemeta.c"
     void r_codemeta_free(RCodeMeta *code) {
 if (!code) {
  return;
 }
...
# 94 "project/radare2/libr/anal/codemeta.c" 3 4
free((
# 94 "project/radare2/libr/anal/codemeta.c"
code->code
# 94 "project/radare2/libr/anal/codemeta.c" 3 4
))
# 94 "project/radare2/libr/anal/codemeta.c"
...
# 95 "project/radare2/libr/anal/codemeta.c" 3 4
free((
# 95 "project/radare2/libr/anal/codemeta.c"
code
# 95 "project/radare2/libr/anal/codemeta.c" 3 4
))
# 95 "project/radare2/libr/anal/codemeta.c"
...
static int cmp_ins(void *incoming, void *in, void *user) {
 ...
 if (mid > mid2) {
  ...
  const 
# 110 "project/radare2/libr/anal/codemeta.c" 3 4
       unsigned int 
# 110 "project/radare2/libr/anal/codemeta.c"
            mod = (mi->end - mi->start) & 0x1;
  const 
# 111 "project/radare2/libr/anal/codemeta.c" 3 4
       unsigned int 
# 111 "project/radare2/libr/anal/codemeta.c"
            mod2 = (mi2->end - mi2->start) & 0x1;
  if (mod > mod2) {
   return -1;
  } else if (mod < mod2) {
   return 1;
...
static int cmp_find_min_mid(void *incoming, void *in, void *user) {
 ...
 if (mid > search_mid[0]) {
  ...
  if (mid < min_mid) {
   ...
   const 
# 137 "project/radare2/libr/anal/codemeta.c" 3 4
        unsigned int 
# 137 "project/radare2/libr/anal/codemeta.c"
             mod = (mi->end - mi->start) & 0x1;
   const 
# 138 "project/radare2/libr/anal/codemeta.c" 3 4
        unsigned int 
# 138 "project/radare2/libr/anal/codemeta.c"
             min_mod = (min[0]->end - min[0]->start) & 0x1;
   if (mod < min_mod) {
    min[0] = mi;
   }
  }
...
# 153 "project/radare2/libr/anal/codemeta.c" 3 4
__attribute__((visibility("default"))) 
# 153 "project/radare2/libr/anal/codemeta.c"
     void r_codemeta_add_item(RCodeMeta *code, RCodeMetaItem *mi) {
 
# 154 "project/radare2/libr/anal/codemeta.c" 3 4
do { if (!(
# 154 "project/radare2/libr/anal/codemeta.c"
code && mi
# 154 "project/radare2/libr/anal/codemeta.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 154 "project/radare2/libr/anal/codemeta.c"
...
# 154 "project/radare2/libr/anal/codemeta.c"
 ...
 r_crbtree_insert (code->tree, mi, cmp_ins, 
# 156 "project/radare2/libr/anal/codemeta.c" 3 4
                                           ((void *)0)
# 156 "project/radare2/libr/anal/codemeta.c"
                                               );
}


# 159 "project/radare2/libr/anal/codemeta.c" 3 4
__attribute__((visibility("default"))) 
# 159 "project/radare2/libr/anal/codemeta.c"
     RPVector *r_codemeta_at(RCodeMeta *code, size_t offset) {
 return r_codemeta_in (code, offset, offset + 1);
}


# 163 "project/radare2/libr/anal/codemeta.c" 3 4
__attribute__((visibility("default"))) 
# 163 "project/radare2/libr/anal/codemeta.c"
     RPVector *r_codemeta_in(RCodeMeta *code, size_t start, size_t end) {
 
# 164 "project/radare2/libr/anal/codemeta.c" 3 4
do { if (!(
# 164 "project/radare2/libr/anal/codemeta.c"
code
# 164 "project/radare2/libr/anal/codemeta.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 164 "project/radare2/libr/anal/codemeta.c"
"code"
# 164 "project/radare2/libr/anal/codemeta.c" 3 4
, 164); return (((void *)0)); } } while (0)
# 164 "project/radare2/libr/anal/codemeta.c"
                                 ;
 RPVector *r = r_pvector_new (
# 165 "project/radare2/libr/anal/codemeta.c" 3 4
                             ((void *)0)
# 165 "project/radare2/libr/anal/codemeta.c"
                                 );
 if (!r) {
  return 
# 167 "project/radare2/libr/anal/codemeta.c" 3 4
        ((void *)0)
# 167 "project/radare2/libr/anal/codemeta.c"
            ;
 }

 size_t search_start = start / 2;
 RCodeMetaItem *min = 
# 171 "project/radare2/libr/anal/codemeta.c" 3 4
                     ((void *)0)
# 171 "project/radare2/libr/anal/codemeta.c"
                         ;
 r_crbtree_find (code->tree, &search_start, cmp_find_min_mid, &min);
 if (min) {
  const size_t end_mid = (end - 1) + ((
# 174 "project/radare2/libr/anal/codemeta.c" 3 4
                                      18446744073709551615UL 
# 174 "project/radare2/libr/anal/codemeta.c"
                                               - end - 1) / 2);
  RRBNode *node = r_crbtree_find_node (code->tree, min, cmp_ins, 
# 175 "project/radare2/libr/anal/codemeta.c" 3 4
                                                                ((void *)0)
# 175 "project/radare2/libr/anal/codemeta.c"
                                                                    );
 ...
 return r;
# 211 "project/radare2/libr/anal/codemeta.c"
}


# 213 "project/radare2/libr/anal/codemeta.c" 3 4
__attribute__((visibility("default"))) 
# 213 "project/radare2/libr/anal/codemeta.c"
     RVector *r_codemeta_line_offsets(RCodeMeta *code) {
 
# 214 "project/radare2/libr/anal/codemeta.c" 3 4
do { if (!(
# 214 "project/radare2/libr/anal/codemeta.c"
code
# 214 "project/radare2/libr/anal/codemeta.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 214 "project/radare2/libr/anal/codemeta.c"
...
# 214 "project/radare2/libr/anal/codemeta.c"
                                 ;
 RVector *r = r_vector_new (sizeof (
# 215 "project/radare2/libr/anal/codemeta.c" 3 4
                                   unsigned long long
# 215 "project/radare2/libr/anal/codemeta.c"
                                       ), 
# 215 "project/radare2/libr/anal/codemeta.c" 3 4
                                          ((void *)0)
# 215 "project/radare2/libr/anal/codemeta.c"
...
# 215 "project/radare2/libr/anal/codemeta.c"
 ...
 if (!r) {
  return 
# 217 "project/radare2/libr/anal/codemeta.c" 3 4
        ((void *)0)
# 217 "project/radare2/libr/anal/codemeta.c"
            ;
 }
 size_t cur = 0;
...
# 225 "project/radare2/libr/anal/codemeta.c" 3 4
 unsigned long long 
# 225 "project/radare2/libr/anal/codemeta.c"
      offset = 
# 225 "project/radare2/libr/anal/codemeta.c" 3 4
...
# 227 "project/radare2/libr/anal/codemeta.c" 3 4
 for (
# 227 "project/radare2/libr/anal/codemeta.c"
 it 
# 227 "project/radare2/libr/anal/codemeta.c" 3 4
 = (void **)(
# 227 "project/radare2/libr/anal/codemeta.c"
...
# 243 "project/radare2/libr/anal/codemeta.c" 3 4
__attribute__((visibility("default"))) 
# 243 "project/radare2/libr/anal/codemeta.c"
     void r_codemeta_print_json(RCodeMeta *code) {
 PJ *pj = pj_new ();
 if (!pj) {
  return;
 }
...
# 257 "project/radare2/libr/anal/codemeta.c" 3 4
if (!r_vector_empty (
# 257 "project/radare2/libr/anal/codemeta.c"
&code->annotations
# 257 "project/radare2/libr/anal/codemeta.c" 3 4
)) for (
# 257 "project/radare2/libr/anal/codemeta.c"
...
# 257 "project/radare2/libr/anal/codemeta.c"
  ...
  pj_o (pj);
  pj_kn (pj, "start", (
# 259 "project/radare2/libr/anal/codemeta.c" 3 4
                      unsigned long long
# 259 "project/radare2/libr/anal/codemeta.c"
                          )annotation->start);
  pj_kn (pj, "end", (
# 260 "project/radare2/libr/anal/codemeta.c" 3 4
                    unsigned long long
# 260 "project/radare2/libr/anal/codemeta.c"
                        )annotation->end);
  ...
  case R_CODEMETA_TYPE_SYNTAX_HIGHLIGHT:
   ...
   type_str = 
# 289 "project/radare2/libr/anal/codemeta.c" 3 4
             ((void *)0)
# 289 "project/radare2/libr/anal/codemeta.c"
                 ;
...
# 341 "project/radare2/libr/anal/codemeta.c"
static void print_offset_in_binary_line_bar(RCodeMeta *code, 
# 341 "project/radare2/libr/anal/codemeta.c" 3 4
                                                            unsigned long long 
# 341 "project/radare2/libr/anal/codemeta.c"
                                                                 offset, size_t width) {
 if (width < 8) {
 ...
 r_cons_printf ("    ");
 if (offset == 
# 352 "project/radare2/libr/anal/codemeta.c" 3 4
              0xFFFFFFFFFFFFFFFFULL
# 352 "project/radare2/libr/anal/codemeta.c"
                      ) {
  
# 353 "project/radare2/libr/anal/codemeta.c" 3 4
 r_cons_strcat (
# 353 "project/radare2/libr/anal/codemeta.c"
 "          "
# 353 "project/radare2/libr/anal/codemeta.c" 3 4
 )
# 353 "project/radare2/libr/anal/codemeta.c"
...
# 355 "project/radare2/libr/anal/codemeta.c" 3 4
  r_cons_strcat (
# 355 "project/radare2/libr/anal/codemeta.c"
  " "
# 355 "project/radare2/libr/anal/codemeta.c" 3 4
  )
# 355 "project/radare2/libr/anal/codemeta.c"
  ...
  do { if (cons->context->color_mode) { r_cons_printf ("%s", ((cons && cons->context->pal.offset) ? cons->context->pal.offset : 
# 359 "project/radare2/libr/anal/codemeta.c" 3 4
 "\x1b[32m"
# 359 "project/radare2/libr/anal/codemeta.c"
 )); } } while (0)
                      ;
  r_cons_printf ("0x%08" 
# 361 "project/radare2/libr/anal/codemeta.c" 3 4
                        "llx"
# 361 "project/radare2/libr/anal/codemeta.c"
                               , offset);
  do { if (cons->context->color_mode) { r_cons_printf ("%s", (
# 362 "project/radare2/libr/anal/codemeta.c" 3 4
 "\x1b[0m"
# 362 "project/radare2/libr/anal/codemeta.c"
 )); } } while (0);
 }
 r_cons_printf ("    |");
}

static void print_disasm_in_binary_line_bar(RCodeMeta *code, 
# 367 "project/radare2/libr/anal/codemeta.c" 3 4
                                                            unsigned long long 
# 367 "project/radare2/libr/anal/codemeta.c"
                                                                 offset, size_t width, RAnal *anal) {
 width = 40;
 RCons *cons = r_cons_singleton ();
 r_cons_printf ("    ");
 if (offset == 
# 371 "project/radare2/libr/anal/codemeta.c" 3 4
              0xFFFFFFFFFFFFFFFFULL
# 371 "project/radare2/libr/anal/codemeta.c"
                      ) {
  const char *pad = r_str_pad (' ', width);
  
# 373 "project/radare2/libr/anal/codemeta.c" 3 4
 r_cons_strcat (
# 373 "project/radare2/libr/anal/codemeta.c"
 pad
# 373 "project/radare2/libr/anal/codemeta.c" 3 4
 )
# 373 "project/radare2/libr/anal/codemeta.c"
  ...
  if (anal && anal->coreb.core) {
   ...
   char *c = r_str_newf ("pid 1 @ 0x%" 
# 377 "project/radare2/libr/anal/codemeta.c" 3 4
                                      "llx" 
# 377 "project/radare2/libr/anal/codemeta.c"
                                              " @e:asm.flags=0@e:asm.lines=0@e:asm.bytes=0", offset);
   char *res = anal->coreb.cmdstrf (core, c);
   free (c);
   r_str_trim (res);
   int w = r_str_ansi_len (res);
   
# 382 "project/radare2/libr/anal/codemeta.c" 3 4
  r_cons_strcat (
# 382 "project/radare2/libr/anal/codemeta.c"
  res
# 382 "project/radare2/libr/anal/codemeta.c" 3 4
  )
# 382 "project/radare2/libr/anal/codemeta.c"
...
# 385 "project/radare2/libr/anal/codemeta.c" 3 4
   r_cons_strcat (
# 385 "project/radare2/libr/anal/codemeta.c"
   pad
# 385 "project/radare2/libr/anal/codemeta.c" 3 4
   )
# 385 "project/radare2/libr/anal/codemeta.c"
   ...
   do { if (cons->context->color_mode) { r_cons_printf ("%s", ((cons && cons->context->pal.offset) ? cons->context->pal.offset : 
# 394 "project/radare2/libr/anal/codemeta.c" 3 4
  "\x1b[32m"
# 394 "project/radare2/libr/anal/codemeta.c"
  )); } } while (0);
   r_cons_printf ("0x%08" 
# 395 "project/radare2/libr/anal/codemeta.c" 3 4
                         "llx"
# 395 "project/radare2/libr/anal/codemeta.c"
                                , offset);
   do { if (cons->context->color_mode) { r_cons_printf ("%s", (
# 396 "project/radare2/libr/anal/codemeta.c" 3 4
  "\x1b[0m"
# 396 "project/radare2/libr/anal/codemeta.c"
  )); } } while (0);
   const char *pad = r_str_pad (' ', width - 11);
   
# 398 "project/radare2/libr/anal/codemeta.c" 3 4
  r_cons_strcat (
# 398 "project/radare2/libr/anal/codemeta.c"
  pad
# 398 "project/radare2/libr/anal/codemeta.c" 3 4
  )
# 398 "project/radare2/libr/anal/codemeta.c"
...
# 404 "project/radare2/libr/anal/codemeta.c" 3 4
__attribute__((visibility("default"))) 
# 404 "project/radare2/libr/anal/codemeta.c"
     void r_codemeta_print_internal(RCodeMeta *code, RVector *line_offsets, RAnal *anal) {
...
# 416 "project/radare2/libr/anal/codemeta.c" 3 4
 unsigned long long 
# 416 "project/radare2/libr/anal/codemeta.c"
      *offset;
  
# 417 "project/radare2/libr/anal/codemeta.c" 3 4
 unsigned long long 
# 417 "project/radare2/libr/anal/codemeta.c"
      offset_max = 0;
  
# 418 "project/radare2/libr/anal/codemeta.c" 3 4
 if (!r_vector_empty (
# 418 "project/radare2/libr/anal/codemeta.c"
 line_offsets
# 418 "project/radare2/libr/anal/codemeta.c" 3 4
 )) for (
# 418 "project/radare2/libr/anal/codemeta.c"
...
# 418 "project/radare2/libr/anal/codemeta.c"
                                         {
   if (*offset != 
# 419 "project/radare2/libr/anal/codemeta.c" 3 4
                 0xFFFFFFFFFFFFFFFFULL 
# 419 "project/radare2/libr/anal/codemeta.c"
                          && *offset > offset_max) {
    offset_max = *offset;
   }
  }
...
# 434 "project/radare2/libr/anal/codemeta.c" 3 4
if (!r_vector_empty (
# 434 "project/radare2/libr/anal/codemeta.c"
&code->annotations
# 434 "project/radare2/libr/anal/codemeta.c" 3 4
)) for (
# 434 "project/radare2/libr/anal/codemeta.c"
...
# 434 "project/radare2/libr/anal/codemeta.c"
  ...
  const char *color = 
# 442 "project/radare2/libr/anal/codemeta.c" 3 4
                     "\x1b[0m"
# 442 "project/radare2/libr/anal/codemeta.c"
                                ;
  switch (annotation->syntax_highlight.type) {
  case R_SYNTAX_HIGHLIGHT_TYPE_COMMENT:
   color = (cons && cons->context->pal.comment) ? cons->context->pal.comment
       : 
# 446 "project/radare2/libr/anal/codemeta.c" 3 4
        "\x1b[37m"
# 446 "project/radare2/libr/anal/codemeta.c"
                   ;
   break;
  case R_SYNTAX_HIGHLIGHT_TYPE_KEYWORD:
   color = (cons && cons->context->pal.pop) ? cons->context->pal.pop
       : 
# 450 "project/radare2/libr/anal/codemeta.c" 3 4
        "\x1b[35m"
# 450 "project/radare2/libr/anal/codemeta.c"
                     ;
   break;
  case R_SYNTAX_HIGHLIGHT_TYPE_DATATYPE:
   color = (cons && cons->context->pal.func_var_type) ? cons->context->pal.func_var_type
       : 
# 454 "project/radare2/libr/anal/codemeta.c" 3 4
        "\x1b[34m"
# 454 "project/radare2/libr/anal/codemeta.c"
                  ;
   break;
  case R_SYNTAX_HIGHLIGHT_TYPE_FUNCTION_NAME:
   color = (cons && cons->context->pal.fname) ? cons->context->pal.fname
       : 
# 458 "project/radare2/libr/anal/codemeta.c" 3 4
        "\x1b[31m"
# 458 "project/radare2/libr/anal/codemeta.c"
                 ;
   break;
  case R_SYNTAX_HIGHLIGHT_TYPE_CONSTANT_VARIABLE:
   color = (cons && cons->context->pal.num) ? cons->context->pal.num
       : 
# 462 "project/radare2/libr/anal/codemeta.c" 3 4
        "\x1b[33m"
# 462 "project/radare2/libr/anal/codemeta.c"
                    ;
  default:
   break;
  }
...
# 473 "project/radare2/libr/anal/codemeta.c" 3 4
   unsigned long long 
# 473 "project/radare2/libr/anal/codemeta.c"
        offset = 0;
    if (line_idx < line_offsets->len) {
     offset = *(
# 475 "project/radare2/libr/anal/codemeta.c" 3 4
               unsigned long long 
# 475 "project/radare2/libr/anal/codemeta.c"
                    *)r_vector_index_ptr (line_offsets, line_idx);
    }
    if (anal) {
  ...
  do { if (cons->context->color_mode) { r_cons_printf ("%s", (color)); } } while (0);
  for (; cur < annotation->end && cur < len; cur++) {


   if (line_offsets && (cur == 0 || code->code[cur - 1] == '\n')) {
    
# 494 "project/radare2/libr/anal/codemeta.c" 3 4
   unsigned long long 
# 494 "project/radare2/libr/anal/codemeta.c"
        offset = 0;
    if (line_idx < line_offsets->len) {
     offset = *(
# 496 "project/radare2/libr/anal/codemeta.c" 3 4
               unsigned long long 
# 496 "project/radare2/libr/anal/codemeta.c"
                    *)r_vector_index_ptr (line_offsets, line_idx);
    }
    do { if (cons->context->color_mode) { r_cons_printf ("%s", (
# 498 "project/radare2/libr/anal/codemeta.c" 3 4
   "\x1b[0m"
# 498 "project/radare2/libr/anal/codemeta.c"
   )); } } while (0);
    if (anal) {
     print_disasm_in_binary_line_bar (code, offset, offset_width, anal);
    } else {
  ...
  do { if (cons->context->color_mode) { r_cons_printf ("%s", (
# 509 "project/radare2/libr/anal/codemeta.c" 3 4
 "\x1b[0m"
# 509 "project/radare2/libr/anal/codemeta.c"
 )); } } while (0);
 }
...
# 517 "project/radare2/libr/anal/codemeta.c" 3 4
  unsigned long long 
# 517 "project/radare2/libr/anal/codemeta.c"
       offset = 0;
   if (line_idx < line_offsets->len) {
    offset = *(
# 519 "project/radare2/libr/anal/codemeta.c" 3 4
              unsigned long long 
# 519 "project/radare2/libr/anal/codemeta.c"
                   *)r_vector_index_ptr (line_offsets, line_idx);
   }
   if (anal) {
    print_disasm_in_binary_line_bar (code, offset, offset_width, anal);
...
# 532 "project/radare2/libr/anal/codemeta.c" 3 4
__attribute__((visibility("default"))) 
# 532 "project/radare2/libr/anal/codemeta.c"
     void r_codemeta_print_disasm(RCodeMeta *code, RVector *line_offsets, void *anal) {
 r_codemeta_print_internal (code, line_offsets, anal);
}



# 537 "project/radare2/libr/anal/codemeta.c" 3 4
__attribute__((visibility("default"))) 
# 537 "project/radare2/libr/anal/codemeta.c"
     void r_codemeta_print(RCodeMeta *code, RVector *line_offsets) {
 r_codemeta_print_internal (code, line_offsets, 
# 538 "project/radare2/libr/anal/codemeta.c" 3 4
                                               ((void *)0)
# 538 "project/radare2/libr/anal/codemeta.c"
                                                   );
}

static 
# 541 "project/radare2/libr/anal/codemeta.c" 3 4
      _Bool 
# 541 "project/radare2/libr/anal/codemeta.c"
           foreach_offset_annotation(void *user, const 
# 541 "project/radare2/libr/anal/codemeta.c" 3 4
                                                       unsigned long long 
# 541 "project/radare2/libr/anal/codemeta.c"
                                                            offset, const void *val) {
 RCodeMeta *code = user;
 ...
 r_cons_printf ("CCu base64:%s @ 0x%" 
# 545 "project/radare2/libr/anal/codemeta.c" 3 4
                                     "llx" 
# 545 "project/radare2/libr/anal/codemeta.c"
                                             "\n", b64statement, annotation->offset.offset);
 free (b64statement);
 return 
# 547 "project/radare2/libr/anal/codemeta.c" 3 4
       1
# 547 "project/radare2/libr/anal/codemeta.c"
           ;
}


# 550 "project/radare2/libr/anal/codemeta.c" 3 4
__attribute__((visibility("default"))) 
# 550 "project/radare2/libr/anal/codemeta.c"
     void r_codemeta_print_comment_cmds(RCodeMeta *code) {
 RCodeMetaItem *annotation;
 HtUP *ht = ht_up_new0 ();
 
# 553 "project/radare2/libr/anal/codemeta.c" 3 4
if (!r_vector_empty (
# 553 "project/radare2/libr/anal/codemeta.c"
&code->annotations
# 553 "project/radare2/libr/anal/codemeta.c" 3 4
)) for (
# 553 "project/radare2/libr/anal/codemeta.c"
...
# 553 "project/radare2/libr/anal/codemeta.c"
  ...
  RCodeMetaItem *prev_annot = ht_up_find (ht, annotation->offset.offset, 
# 558 "project/radare2/libr/anal/codemeta.c" 3 4
                                                                        ((void *)0)
# 558 "project/radare2/libr/anal/codemeta.c"
                                                                            );
  if (prev_annot) {
