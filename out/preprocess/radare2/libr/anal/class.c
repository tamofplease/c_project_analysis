# 0 "project/radare2/libr/anal/class.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/anal/class.c" 2
...
# 7 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_graph_drawable.h" 2 3 4
...
# 6 "project/radare2/libr/anal/class.c" 2
# 1 "project/radare2/libr/anal/../include/r_anal.h" 1
# 7 "project/radare2/libr/anal/class.c" 2
# 1 "project/radare2/libr/anal/../include/r_util/r_graph.h" 1
# 8 "project/radare2/libr/anal/class.c" 2


# 9 "project/radare2/libr/anal/class.c"
...
static const char *attr_type_id(RAnalClassAttrType attr_type) {
 ...
 default:
  return 
# 51 "project/radare2/libr/anal/class.c" 3 4
        ((void *)0)
# 51 "project/radare2/libr/anal/class.c"
            ;
 }
}


# 55 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 55 "project/radare2/libr/anal/class.c"
...
# 72 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 72 "project/radare2/libr/anal/class.c"
     void r_anal_class_delete(RAnal *anal, const char *name) {
...
# 91 "project/radare2/libr/anal/class.c" 3 4
{ char *next; if (
# 91 "project/radare2/libr/anal/class.c"
attr_type_array
# 91 "project/radare2/libr/anal/class.c" 3 4
) for (
# 91 "project/radare2/libr/anal/class.c"
...
# 97 "project/radare2/libr/anal/class.c" 3 4
  { char *next; if (
# 97 "project/radare2/libr/anal/class.c"
  attr_id_array
# 97 "project/radare2/libr/anal/class.c" 3 4
  ) for (
# 97 "project/radare2/libr/anal/class.c"
...
# 102 "project/radare2/libr/anal/class.c" 3 4
   if (!next) break; *(next-1) = ','; 
# 102 "project/radare2/libr/anal/class.c"
   attr_id 
# 102 "project/radare2/libr/anal/class.c" 3 4
   = next; } }
# 102 "project/radare2/libr/anal/class.c"
...
# 106 "project/radare2/libr/anal/class.c" 3 4
 if (!next) break; *(next-1) = ','; 
# 106 "project/radare2/libr/anal/class.c"
 attr_type 
# 106 "project/radare2/libr/anal/class.c" 3 4
 = next; } }
# 106 "project/radare2/libr/anal/class.c"
...
static 
# 118 "project/radare2/libr/anal/class.c" 3 4
      _Bool 
# 118 "project/radare2/libr/anal/class.c"
           r_anal_class_exists_raw(RAnal *anal, const char *name) {
 return sdb_exists (anal->sdb_classes, key_class (name));
}


# 122 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 122 "project/radare2/libr/anal/class.c"
          r_anal_class_exists(RAnal *anal, const char *name) {
 char *class_name_sanitized = r_str_sanitize_sdb_key (name);
 if (!class_name_sanitized) {
  return 
# 125 "project/radare2/libr/anal/class.c" 3 4
        0
# 125 "project/radare2/libr/anal/class.c"
             ;
 }
 
# 127 "project/radare2/libr/anal/class.c" 3 4
_Bool 
# 127 "project/radare2/libr/anal/class.c"
     r = r_anal_class_exists_raw (anal, class_name_sanitized);
 free (class_name_sanitized);
 return r;
}


# 132 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 132 "project/radare2/libr/anal/class.c"
     SdbList *r_anal_class_get_all(RAnal *anal, 
# 132 "project/radare2/libr/anal/class.c" 3 4
                                                _Bool 
# 132 "project/radare2/libr/anal/class.c"
                                                     sorted) {
...
# 136 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 136 "project/radare2/libr/anal/class.c"
     void r_anal_class_foreach(RAnal *anal, SdbForeachCallback cb, void *user) {
 sdb_foreach (anal->sdb_classes, cb, user);
}

static 
# 140 "project/radare2/libr/anal/class.c" 3 4
      _Bool 
# 140 "project/radare2/libr/anal/class.c"
           rename_key(Sdb *sdb, const char *key_old, const char *key_new) {
 char *content = sdb_get (sdb, key_old, 0);
 if (!content) {
  return 
# 143 "project/radare2/libr/anal/class.c" 3 4
        0
# 143 "project/radare2/libr/anal/class.c"
             ;
 }
 ...
 free (content);
 return 
# 148 "project/radare2/libr/anal/class.c" 3 4
       1
# 148 "project/radare2/libr/anal/class.c"
           ;
}


# 151 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 151 "project/radare2/libr/anal/class.c"
     RAnalClassErr r_anal_class_rename(RAnal *anal, const char *old_name, const char *new_name) {
...
# 179 "project/radare2/libr/anal/class.c" 3 4
{ char *next; if (
# 179 "project/radare2/libr/anal/class.c"
attr_types
# 179 "project/radare2/libr/anal/class.c" 3 4
) for (
# 179 "project/radare2/libr/anal/class.c"
...
# 182 "project/radare2/libr/anal/class.c" 3 4
 { char *next; if (
# 182 "project/radare2/libr/anal/class.c"
 attr_ids
# 182 "project/radare2/libr/anal/class.c" 3 4
 ) for (
# 182 "project/radare2/libr/anal/class.c"
...
# 186 "project/radare2/libr/anal/class.c" 3 4
  if (!next) break; *(next-1) = ','; 
# 186 "project/radare2/libr/anal/class.c"
  attr_id_cur 
# 186 "project/radare2/libr/anal/class.c" 3 4
  = next; } }
# 186 "project/radare2/libr/anal/class.c"
...
# 192 "project/radare2/libr/anal/class.c" 3 4
 if (!next) break; *(next-1) = ','; 
# 192 "project/radare2/libr/anal/class.c"
 attr_type_cur 
# 192 "project/radare2/libr/anal/class.c" 3 4
 = next; } }
# 192 "project/radare2/libr/anal/class.c"
...
static char *r_anal_class_get_attr_raw(RAnal *anal, const char *class_name, RAnalClassAttrType attr_type, const char *attr_id, 
# 211 "project/radare2/libr/anal/class.c" 3 4
                                                                                                                              _Bool 
# 211 "project/radare2/libr/anal/class.c"
                                                                                                                                   specific) {
...
# 221 "project/radare2/libr/anal/class.c" 3 4
                                                                                                                          _Bool 
# 221 "project/radare2/libr/anal/class.c"
                                                                                                                               specific) {
 char *class_name_sanitized = r_str_sanitize_sdb_key (class_name);
 if (!class_name_sanitized) {
  return 
# 224 "project/radare2/libr/anal/class.c" 3 4
        0
# 224 "project/radare2/libr/anal/class.c"
             ;
 }
 ...
 if (!attr_id_sanitized) {
  free (class_name_sanitized);
  return 
# 229 "project/radare2/libr/anal/class.c" 3 4
        0
# 229 "project/radare2/libr/anal/class.c"
             ;
 }
...
# 398 "project/radare2/libr/anal/class.c" 3 4
unsigned long long 
# 398 "project/radare2/libr/anal/class.c"
     id = 0;
 char *key = key_attr_type_attrs (class_name, attr_type_id (attr_type));
 do {
  
# 401 "project/radare2/libr/anal/class.c" 3 4
 __builtin___snprintf_chk (
# 401 "project/radare2/libr/anal/class.c"
 out
# 401 "project/radare2/libr/anal/class.c" 3 4
 , 
# 401 "project/radare2/libr/anal/class.c"
...
static char *flagname_attr(const char *attr_type, const char *class_name, const char *attr_id) {
 ...
 if (!class_name_sanitized) {
  return 
# 409 "project/radare2/libr/anal/class.c" 3 4
        ((void *)0)
# 409 "project/radare2/libr/anal/class.c"
            ;
 }
 char *attr_id_sanitized = r_str_sanitize_sdb_key (attr_id);
 if (!attr_id_sanitized) {
  free (class_name_sanitized);
  return 
# 414 "project/radare2/libr/anal/class.c" 3 4
        ((void *)0)
# 414 "project/radare2/libr/anal/class.c"
            ;
 }
...
static void r_anal_class_set_flag(RAnal *anal, const char *name, 
# 422 "project/radare2/libr/anal/class.c" 3 4
                                                                unsigned long long 
# 422 "project/radare2/libr/anal/class.c"
                                                                     addr, 
# 422 "project/radare2/libr/anal/class.c" 3 4
                                                                           unsigned int 
# 422 "project/radare2/libr/anal/class.c"
...
# 446 "project/radare2/libr/anal/class.c" 3 4
unsigned long long 
# 446 "project/radare2/libr/anal/class.c"
     addr = flag->offset;
...
# 487 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 487 "project/radare2/libr/anal/class.c"
     void r_anal_class_method_fini(RAnalMethod *meth) {
 free (meth->name);
}
...
# 493 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 493 "project/radare2/libr/anal/class.c"
     RAnalClassErr r_anal_class_method_get(RAnal *anal, const char *class_name, const char *meth_name, RAnalMethod *meth) {
 char *content = r_anal_class_get_attr (anal, class_name, R_ANAL_CLASS_ATTR_TYPE_METHOD, meth_name, 
# 494 "project/radare2/libr/anal/class.c" 3 4
                                                                                                   0
# 494 "project/radare2/libr/anal/class.c"
                                                                                                        );
 if (!content) {
  return R_ANAL_CLASS_ERR_NONEXISTENT_ATTR;
 }
 ...
 meth->addr = r_num_math (
# 503 "project/radare2/libr/anal/class.c" 3 4
                         ((void *)0)
# 503 "project/radare2/libr/anal/class.c"
                             , cur);
 ...
 sdb_anext (cur, 
# 510 "project/radare2/libr/anal/class.c" 3 4
                ((void *)0)
# 510 "project/radare2/libr/anal/class.c"
                    );
...
# 530 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 530 "project/radare2/libr/anal/class.c"
     RVector *r_anal_class_method_get_all(RAnal *anal, const char *class_name) {
 RVector *vec = r_vector_new (sizeof(RAnalMethod), r_anal_class_method_fini_proxy, 
# 531 "project/radare2/libr/anal/class.c" 3 4
                                                                                  ((void *)0)
# 531 "project/radare2/libr/anal/class.c"
                                                                                      );
 if (!vec) {
  return 
# 533 "project/radare2/libr/anal/class.c" 3 4
        ((void *)0)
# 533 "project/radare2/libr/anal/class.c"
            ;
 }
 ...
 if (!class_name_sanitized) {
  r_vector_free (vec);
  return 
# 539 "project/radare2/libr/anal/class.c" 3 4
        ((void *)0)
# 539 "project/radare2/libr/anal/class.c"
            ;
 }
...
# 546 "project/radare2/libr/anal/class.c" 3 4
{ char *next; if (
# 546 "project/radare2/libr/anal/class.c"
array
# 546 "project/radare2/libr/anal/class.c" 3 4
) for (
# 546 "project/radare2/libr/anal/class.c"
...
# 551 "project/radare2/libr/anal/class.c" 3 4
 if (!next) break; *(next-1) = ','; 
# 551 "project/radare2/libr/anal/class.c"
 cur 
# 551 "project/radare2/libr/anal/class.c" 3 4
 = next; } }
# 551 "project/radare2/libr/anal/class.c"
...
# 558 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 558 "project/radare2/libr/anal/class.c"
     RAnalClassErr r_anal_class_method_set(RAnal *anal, const char *class_name, RAnalMethod *meth) {
 char *content = sdb_fmt ("%"
# 559 "project/radare2/libr/anal/class.c" 3 4
                            "llu"
# 559 "project/radare2/libr/anal/class.c"
                                   "%c%"
# 559 "project/radare2/libr/anal/class.c" 3 4
                                        "lld"
# 559 "project/radare2/libr/anal/class.c"
...
# 568 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 568 "project/radare2/libr/anal/class.c"
     RAnalClassErr r_anal_class_method_rename(RAnal *anal, const char *class_name, const char *old_meth_name, const char *new_meth_name) {
...
# 585 "project/radare2/libr/anal/class.c" 3 4
{ char *next; if (
# 585 "project/radare2/libr/anal/class.c"
array
# 585 "project/radare2/libr/anal/class.c" 3 4
) for (
# 585 "project/radare2/libr/anal/class.c"
...
# 589 "project/radare2/libr/anal/class.c" 3 4
 if (!next) break; *(next-1) = ','; 
# 589 "project/radare2/libr/anal/class.c"
 cur 
# 589 "project/radare2/libr/anal/class.c" 3 4
 = next; } }
# 589 "project/radare2/libr/anal/class.c"
...
# 600 "project/radare2/libr/anal/class.c" 3 4
{ char *next; if (
# 600 "project/radare2/libr/anal/class.c"
array
# 600 "project/radare2/libr/anal/class.c" 3 4
) for (
# 600 "project/radare2/libr/anal/class.c"
...
# 602 "project/radare2/libr/anal/class.c" 3 4
 if (!next) break; *(next-1) = ','; 
# 602 "project/radare2/libr/anal/class.c"
 cur 
# 602 "project/radare2/libr/anal/class.c" 3 4
 = next; } }
# 602 "project/radare2/libr/anal/class.c"
...
# 607 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 607 "project/radare2/libr/anal/class.c"
     RAnalClassErr r_anal_class_method_delete(RAnal *anal, const char *class_name, const char *meth_name) {
 char *class_name_sanitized = r_str_sanitize_sdb_key (class_name);
 if (!class_name_sanitized) {
  return R_ANAL_CLASS_ERR_OTHER;
 }
...
# 629 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 629 "project/radare2/libr/anal/class.c"
     void r_anal_class_base_fini(RAnalBaseClass *base) {
 free (base->id);
 free (base->class_name);
}


# 634 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 634 "project/radare2/libr/anal/class.c"
     RAnalClassErr r_anal_class_base_get(RAnal *anal, const char *class_name, const char *base_id, RAnalBaseClass *base) {
 char *content = r_anal_class_get_attr (anal, class_name, R_ANAL_CLASS_ATTR_TYPE_BASE, base_id, 
# 635 "project/radare2/libr/anal/class.c" 3 4
                                                                                               0
# 635 "project/radare2/libr/anal/class.c"
                                                                                                    );
 if (!content) {
  return R_ANAL_CLASS_ERR_NONEXISTENT_ATTR;
 }
 ...
 sdb_anext (cur, 
# 656 "project/radare2/libr/anal/class.c" 3 4
                ((void *)0)
# 656 "project/radare2/libr/anal/class.c"
                    );

 base->offset = r_num_math (
# 658 "project/radare2/libr/anal/class.c" 3 4
                           ((void *)0)
# 658 "project/radare2/libr/anal/class.c"
                               , cur);
...
# 677 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 677 "project/radare2/libr/anal/class.c"
     RVector *r_anal_class_base_get_all(RAnal *anal, const char *class_name) {
 RVector *vec = r_vector_new (sizeof(RAnalBaseClass), r_anal_class_base_fini_proxy, 
# 678 "project/radare2/libr/anal/class.c" 3 4
                                                                                   ((void *)0)
# 678 "project/radare2/libr/anal/class.c"
                                                                                       );
 if (!vec) {
  return 
# 680 "project/radare2/libr/anal/class.c" 3 4
        ((void *)0)
# 680 "project/radare2/libr/anal/class.c"
            ;
 }
 ...
 if (!class_name_sanitized) {
  r_vector_free (vec);
  return 
# 686 "project/radare2/libr/anal/class.c" 3 4
        ((void *)0)
# 686 "project/radare2/libr/anal/class.c"
            ;
 }
...
# 693 "project/radare2/libr/anal/class.c" 3 4
{ char *next; if (
# 693 "project/radare2/libr/anal/class.c"
array
# 693 "project/radare2/libr/anal/class.c" 3 4
) for (
# 693 "project/radare2/libr/anal/class.c"
...
# 698 "project/radare2/libr/anal/class.c" 3 4
 if (!next) break; *(next-1) = ','; 
# 698 "project/radare2/libr/anal/class.c"
 cur 
# 698 "project/radare2/libr/anal/class.c" 3 4
 = next; } }
# 698 "project/radare2/libr/anal/class.c"
...
static RAnalClassErr r_anal_class_base_set_raw(RAnal *anal, const char *class_name, RAnalBaseClass *base, const char *base_class_name_sanitized) {
 char *content = sdb_fmt ("%s" 
# 706 "project/radare2/libr/anal/class.c" 3 4
                              "," 
# 706 "project/radare2/libr/anal/class.c"
                                     "%"
# 706 "project/radare2/libr/anal/class.c" 3 4
                                        "llu"
# 706 "project/radare2/libr/anal/class.c"
                                               , base_class_name_sanitized, base->offset);
 RAnalClassErr err;
 if (base->id) {
...
# 721 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 721 "project/radare2/libr/anal/class.c"
     RAnalClassErr r_anal_class_base_set(RAnal *anal, const char *class_name, RAnalBaseClass *base) {
...
# 734 "project/radare2/libr/anal/class.c" 3 4
 if (!r_vector_empty (
# 734 "project/radare2/libr/anal/class.c"
 bases
# 734 "project/radare2/libr/anal/class.c" 3 4
 )) for (
# 734 "project/radare2/libr/anal/class.c"
...
# 748 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 748 "project/radare2/libr/anal/class.c"
     RAnalClassErr r_anal_class_base_delete(RAnal *anal, const char *class_name, const char *base_id) {
...
static 
# 757 "project/radare2/libr/anal/class.c" 3 4
      _Bool 
# 757 "project/radare2/libr/anal/class.c"
           r_anal_class_base_delete_class_cb(void *user, const char *k, const char *v) {
 (void)v;
 DeleteClassCtx *ctx = user;
 RVector *bases = r_anal_class_base_get_all (ctx->anal, k);
 RAnalBaseClass *base;
 
# 762 "project/radare2/libr/anal/class.c" 3 4
if (!r_vector_empty (
# 762 "project/radare2/libr/anal/class.c"
bases
# 762 "project/radare2/libr/anal/class.c" 3 4
)) for (
# 762 "project/radare2/libr/anal/class.c"
...
# 762 "project/radare2/libr/anal/class.c"
 ...
 r_vector_free (bases);
 return 
# 768 "project/radare2/libr/anal/class.c" 3 4
       1
# 768 "project/radare2/libr/anal/class.c"
           ;
}
...
static 
# 782 "project/radare2/libr/anal/class.c" 3 4
      _Bool 
# 782 "project/radare2/libr/anal/class.c"
           r_anal_class_base_rename_class_cb(void *user, const char *k, const char *v) {
 (void)v;
 RenameClassCtx *ctx = user;
 RVector *bases = r_anal_class_base_get_all (ctx->anal, k);
 RAnalBaseClass *base;
 
# 787 "project/radare2/libr/anal/class.c" 3 4
if (!r_vector_empty (
# 787 "project/radare2/libr/anal/class.c"
bases
# 787 "project/radare2/libr/anal/class.c" 3 4
)) for (
# 787 "project/radare2/libr/anal/class.c"
...
# 807 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 807 "project/radare2/libr/anal/class.c"
     void r_anal_class_vtable_fini(RAnalVTable *vtable) {
 free (vtable->id);
}


# 811 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 811 "project/radare2/libr/anal/class.c"
     RAnalClassErr r_anal_class_vtable_get(RAnal *anal, const char *class_name, const char *vtable_id, RAnalVTable *vtable) {
 char *content = r_anal_class_get_attr (anal, class_name, R_ANAL_CLASS_ATTR_TYPE_VTABLE, vtable_id, 
# 812 "project/radare2/libr/anal/class.c" 3 4
                                                                                                   0
# 812 "project/radare2/libr/anal/class.c"
                                                                                                        );
 if (!content) {
  return R_ANAL_CLASS_ERR_NONEXISTENT_ATTR;
 }
 ...
 vtable->addr = r_num_math (
# 821 "project/radare2/libr/anal/class.c" 3 4
                           ((void *)0)
# 821 "project/radare2/libr/anal/class.c"
                               , cur);
 ...
 vtable->offset = r_num_math (
# 830 "project/radare2/libr/anal/class.c" 3 4
                             ((void *)0)
# 830 "project/radare2/libr/anal/class.c"
                                 , cur);

 if (next) {
  cur = next;
  sdb_anext (cur, 
# 834 "project/radare2/libr/anal/class.c" 3 4
                 ((void *)0)
# 834 "project/radare2/libr/anal/class.c"
                     );
  vtable->size = r_num_get (
# 835 "project/radare2/libr/anal/class.c" 3 4
                           ((void *)0)
# 835 "project/radare2/libr/anal/class.c"
                               , cur);
 } else {
  vtable->size = 0;
 }
...
# 856 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 856 "project/radare2/libr/anal/class.c"
     RVector *r_anal_class_vtable_get_all(RAnal *anal, const char *class_name) {
 RVector *vec = r_vector_new (sizeof(RAnalVTable), r_anal_class_vtable_fini_proxy, 
# 857 "project/radare2/libr/anal/class.c" 3 4
                                                                                  ((void *)0)
# 857 "project/radare2/libr/anal/class.c"
                                                                                      );
 if (!vec) {
  return 
# 859 "project/radare2/libr/anal/class.c" 3 4
        ((void *)0)
# 859 "project/radare2/libr/anal/class.c"
            ;
 }
 ...
 if (!class_name_sanitized) {
  r_vector_free (vec);
  return 
# 865 "project/radare2/libr/anal/class.c" 3 4
        ((void *)0)
# 865 "project/radare2/libr/anal/class.c"
            ;
 }
...
# 872 "project/radare2/libr/anal/class.c" 3 4
{ char *next; if (
# 872 "project/radare2/libr/anal/class.c"
array
# 872 "project/radare2/libr/anal/class.c" 3 4
) for (
# 872 "project/radare2/libr/anal/class.c"
...
# 877 "project/radare2/libr/anal/class.c" 3 4
 if (!next) break; *(next-1) = ','; 
# 877 "project/radare2/libr/anal/class.c"
 cur 
# 877 "project/radare2/libr/anal/class.c" 3 4
 = next; } }
# 877 "project/radare2/libr/anal/class.c"
...
static 
# 884 "project/radare2/libr/anal/class.c" 3 4
      _Bool 
# 884 "project/radare2/libr/anal/class.c"
           vtable_exists_at(RAnal *anal, const char *class_name, 
# 884 "project/radare2/libr/anal/class.c" 3 4
                                                                 unsigned long long 
# 884 "project/radare2/libr/anal/class.c"
                                                                      addr) {
...
# 888 "project/radare2/libr/anal/class.c" 3 4
 if (!r_vector_empty (
# 888 "project/radare2/libr/anal/class.c"
 vtables
# 888 "project/radare2/libr/anal/class.c" 3 4
 )) for (
# 888 "project/radare2/libr/anal/class.c"
...
# 888 "project/radare2/libr/anal/class.c"
   ...
   if (addr == existing_vtable->addr) {
    ...
    return 
# 891 "project/radare2/libr/anal/class.c" 3 4
          1
# 891 "project/radare2/libr/anal/class.c"
              ;
   }
  }
 }
 r_vector_free (vtables);
 return 
# 896 "project/radare2/libr/anal/class.c" 3 4
       0
# 896 "project/radare2/libr/anal/class.c"
            ;
}


# 899 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 899 "project/radare2/libr/anal/class.c"
     RAnalClassErr r_anal_class_vtable_set(RAnal *anal, const char *class_name, RAnalVTable *vtable) {
 if (vtable_exists_at (anal, class_name, vtable->addr)) {
  return R_ANAL_CLASS_ERR_OTHER;
 }
 char *content = sdb_fmt ("0x%"
# 903 "project/radare2/libr/anal/class.c" 3 4
                              "llx" "," 
# 903 "project/radare2/libr/anal/class.c"
                                             "%"
# 903 "project/radare2/libr/anal/class.c" 3 4
                                                "llu" "," 
# 903 "project/radare2/libr/anal/class.c"
...
# 903 "project/radare2/libr/anal/class.c" 3 4
                                                                  "llu"
# 903 "project/radare2/libr/anal/class.c"
                                                                         , vtable->addr, vtable->offset, vtable->size);
 if (vtable->id) {
...
# 927 "project/radare2/libr/anal/class.c" 3 4
{ char *next; if (
# 927 "project/radare2/libr/anal/class.c"
array
# 927 "project/radare2/libr/anal/class.c" 3 4
) for (
# 927 "project/radare2/libr/anal/class.c"
...
# 931 "project/radare2/libr/anal/class.c" 3 4
 if (!next) break; *(next-1) = ','; 
# 931 "project/radare2/libr/anal/class.c"
 cur 
# 931 "project/radare2/libr/anal/class.c" 3 4
 = next; } }
# 931 "project/radare2/libr/anal/class.c"
...
# 942 "project/radare2/libr/anal/class.c" 3 4
{ char *next; if (
# 942 "project/radare2/libr/anal/class.c"
array
# 942 "project/radare2/libr/anal/class.c" 3 4
) for (
# 942 "project/radare2/libr/anal/class.c"
...
# 944 "project/radare2/libr/anal/class.c" 3 4
 if (!next) break; *(next-1) = ','; 
# 944 "project/radare2/libr/anal/class.c"
 cur 
# 944 "project/radare2/libr/anal/class.c" 3 4
 = next; } }
# 944 "project/radare2/libr/anal/class.c"
...
# 949 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 949 "project/radare2/libr/anal/class.c"
     RAnalClassErr r_anal_class_vtable_delete(RAnal *anal, const char *class_name, const char *vtable_id) {
 char *class_name_sanitized = r_str_sanitize_sdb_key (class_name);
 if (!class_name_sanitized) {
  return R_ANAL_CLASS_ERR_OTHER;
 }
...
# 972 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 972 "project/radare2/libr/anal/class.c"
     void r_anal_class_print(RAnal *anal, const char *class_name, 
# 972 "project/radare2/libr/anal/class.c" 3 4
                                                                  _Bool 
# 972 "project/radare2/libr/anal/class.c"
                                                                       detailed) {
 
# 973 "project/radare2/libr/anal/class.c" 3 4
r_cons_strcat (
# 973 "project/radare2/libr/anal/class.c"
class_name
# 973 "project/radare2/libr/anal/class.c" 3 4
)
# 973 "project/radare2/libr/anal/class.c"
...
# 978 "project/radare2/libr/anal/class.c" 3 4
 _Bool 
# 978 "project/radare2/libr/anal/class.c"
      first = 
# 978 "project/radare2/libr/anal/class.c" 3 4
              1
# 978 "project/radare2/libr/anal/class.c"
...
# 979 "project/radare2/libr/anal/class.c" 3 4
 if (!r_vector_empty (
# 979 "project/radare2/libr/anal/class.c"
 bases
# 979 "project/radare2/libr/anal/class.c" 3 4
 )) for (
# 979 "project/radare2/libr/anal/class.c"
...
# 981 "project/radare2/libr/anal/class.c" 3 4
   r_cons_strcat (
# 981 "project/radare2/libr/anal/class.c"
   ": "
# 981 "project/radare2/libr/anal/class.c" 3 4
   )
# 981 "project/radare2/libr/anal/class.c"
                      ;
    first = 
# 982 "project/radare2/libr/anal/class.c" 3 4
           0
# 982 "project/radare2/libr/anal/class.c"
                ;
   } else {
    
# 984 "project/radare2/libr/anal/class.c" 3 4
   r_cons_strcat (
# 984 "project/radare2/libr/anal/class.c"
   ", "
# 984 "project/radare2/libr/anal/class.c" 3 4
   )
# 984 "project/radare2/libr/anal/class.c"
...
# 986 "project/radare2/libr/anal/class.c" 3 4
  r_cons_strcat (
# 986 "project/radare2/libr/anal/class.c"
  base->class_name
# 986 "project/radare2/libr/anal/class.c" 3 4
  )
# 986 "project/radare2/libr/anal/class.c"
...
# 991 "project/radare2/libr/anal/class.c" 3 4
r_cons_strcat (
# 991 "project/radare2/libr/anal/class.c"
"\n"
# 991 "project/radare2/libr/anal/class.c" 3 4
)
# 991 "project/radare2/libr/anal/class.c"
...
# 998 "project/radare2/libr/anal/class.c" 3 4
  if (!r_vector_empty (
# 998 "project/radare2/libr/anal/class.c"
  vtables
# 998 "project/radare2/libr/anal/class.c" 3 4
  )) for (
# 998 "project/radare2/libr/anal/class.c"
...
# 998 "project/radare2/libr/anal/class.c"
                                     {
    r_cons_printf ("  (vtable at 0x%"
# 999 "project/radare2/libr/anal/class.c" 3 4
                                    "llx"
# 999 "project/radare2/libr/anal/class.c"
                                           , vtable->addr);
    if (vtable->offset > 0) {
     r_cons_printf (" in class at +0x%"
# 1001 "project/radare2/libr/anal/class.c" 3 4
                                      "llx"
# 1001 "project/radare2/libr/anal/class.c"
                                             ")\n", vtable->offset);
    } else {
     
# 1003 "project/radare2/libr/anal/class.c" 3 4
    r_cons_strcat (
# 1003 "project/radare2/libr/anal/class.c"
    ")\n"
# 1003 "project/radare2/libr/anal/class.c" 3 4
    )
# 1003 "project/radare2/libr/anal/class.c"
...
# 1012 "project/radare2/libr/anal/class.c" 3 4
  if (!r_vector_empty (
# 1012 "project/radare2/libr/anal/class.c"
  methods
# 1012 "project/radare2/libr/anal/class.c" 3 4
  )) for (
# 1012 "project/radare2/libr/anal/class.c"
...
# 1012 "project/radare2/libr/anal/class.c"
                                   {
    r_cons_printf ("  %s @ 0x%"
# 1013 "project/radare2/libr/anal/class.c" 3 4
                              "llx"
# 1013 "project/radare2/libr/anal/class.c"
                                     , meth->name, meth->addr);
    if (meth->vtable_offset >= 0) {
     r_cons_printf (" (vtable + 0x%"
# 1015 "project/radare2/libr/anal/class.c" 3 4
                                   "llx"
# 1015 "project/radare2/libr/anal/class.c"
                                          ")\n", (
# 1015 "project/radare2/libr/anal/class.c" 3 4
                                                  unsigned long long
# 1015 "project/radare2/libr/anal/class.c"
...
# 1017 "project/radare2/libr/anal/class.c" 3 4
    r_cons_strcat (
# 1017 "project/radare2/libr/anal/class.c"
    "\n"
# 1017 "project/radare2/libr/anal/class.c" 3 4
    )
# 1017 "project/radare2/libr/anal/class.c"
...
# 1029 "project/radare2/libr/anal/class.c" 3 4
 if (!r_vector_empty (
# 1029 "project/radare2/libr/anal/class.c"
 bases
# 1029 "project/radare2/libr/anal/class.c" 3 4
 )) for (
# 1029 "project/radare2/libr/anal/class.c"
...
# 1029 "project/radare2/libr/anal/class.c"
                                {
   r_cons_printf ("acb %s %s %"
# 1030 "project/radare2/libr/anal/class.c" 3 4
                              "llu"
# 1030 "project/radare2/libr/anal/class.c"
...
# 1038 "project/radare2/libr/anal/class.c" 3 4
 if (!r_vector_empty (
# 1038 "project/radare2/libr/anal/class.c"
 vtables
# 1038 "project/radare2/libr/anal/class.c" 3 4
 )) for (
# 1038 "project/radare2/libr/anal/class.c"
...
# 1038 "project/radare2/libr/anal/class.c"
                                    {
   r_cons_printf ("acv %s 0x%"
# 1039 "project/radare2/libr/anal/class.c" 3 4
                             "llx"
# 1039 "project/radare2/libr/anal/class.c"
                                    " %"
# 1039 "project/radare2/libr/anal/class.c" 3 4
                                        "llu"
# 1039 "project/radare2/libr/anal/class.c"
...
# 1047 "project/radare2/libr/anal/class.c" 3 4
 if (!r_vector_empty (
# 1047 "project/radare2/libr/anal/class.c"
 methods
# 1047 "project/radare2/libr/anal/class.c" 3 4
 )) for (
# 1047 "project/radare2/libr/anal/class.c"
...
# 1047 "project/radare2/libr/anal/class.c"
                                  {
   r_cons_printf ("acm %s %s 0x%"
# 1048 "project/radare2/libr/anal/class.c" 3 4
                                "llx"
# 1048 "project/radare2/libr/anal/class.c"
                                       " %"
# 1048 "project/radare2/libr/anal/class.c" 3 4
                                           "lld"
# 1048 "project/radare2/libr/anal/class.c"
...
# 1054 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 1054 "project/radare2/libr/anal/class.c"
     void r_anal_class_json(RAnal *anal, PJ *j, const char *class_name) {
 pj_o (j);
...
# 1063 "project/radare2/libr/anal/class.c" 3 4
 if (!r_vector_empty (
# 1063 "project/radare2/libr/anal/class.c"
 bases
# 1063 "project/radare2/libr/anal/class.c" 3 4
 )) for (
# 1063 "project/radare2/libr/anal/class.c"
...
# 1079 "project/radare2/libr/anal/class.c" 3 4
 if (!r_vector_empty (
# 1079 "project/radare2/libr/anal/class.c"
 vtables
# 1079 "project/radare2/libr/anal/class.c" 3 4
 )) for (
# 1079 "project/radare2/libr/anal/class.c"
...
# 1094 "project/radare2/libr/anal/class.c" 3 4
 if (!r_vector_empty (
# 1094 "project/radare2/libr/anal/class.c"
 methods
# 1094 "project/radare2/libr/anal/class.c" 3 4
 )) for (
# 1094 "project/radare2/libr/anal/class.c"
...
# 1094 "project/radare2/libr/anal/class.c"
   ...
   if (meth->vtable_offset >= 0) {
    pj_kn (j, "vtable_offset", (
# 1099 "project/radare2/libr/anal/class.c" 3 4
                               unsigned long long
# 1099 "project/radare2/libr/anal/class.c"
                                   )meth->vtable_offset);
   }
   pj_end (j);
  }
...
static 
# 1115 "project/radare2/libr/anal/class.c" 3 4
      _Bool 
# 1115 "project/radare2/libr/anal/class.c"
           r_anal_class_list_json_cb(void *user, const char *k, const char *v) {
 ListJsonCtx *ctx = user;
 r_anal_class_json (ctx->anal, ctx->j, k);
 return 
# 1118 "project/radare2/libr/anal/class.c" 3 4
       1
# 1118 "project/radare2/libr/anal/class.c"
           ;
}
...
# 1138 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 1138 "project/radare2/libr/anal/class.c"
     void r_anal_class_list(RAnal *anal, int mode) {
 if (mode == 'j') {
...
# 1148 "project/radare2/libr/anal/class.c" 3 4
 if ((
# 1148 "project/radare2/libr/anal/class.c"
 classes
# 1148 "project/radare2/libr/anal/class.c" 3 4
 )) for (
# 1148 "project/radare2/libr/anal/class.c"
...
# 1152 "project/radare2/libr/anal/class.c" 3 4
 if ((
# 1152 "project/radare2/libr/anal/class.c"
 classes
# 1152 "project/radare2/libr/anal/class.c" 3 4
 )) for (
# 1152 "project/radare2/libr/anal/class.c"
...
# 1156 "project/radare2/libr/anal/class.c" 3 4
 if ((
# 1156 "project/radare2/libr/anal/class.c"
 classes
# 1156 "project/radare2/libr/anal/class.c" 3 4
 )) for (
# 1156 "project/radare2/libr/anal/class.c"
...
# 1163 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 1163 "project/radare2/libr/anal/class.c"
     void r_anal_class_list_bases(RAnal *anal, const char *class_name) {
 char *class_name_sanitized = r_str_sanitize_sdb_key (class_name);
 if (!class_name_sanitized) {
  return;
 }
...
# 1177 "project/radare2/libr/anal/class.c" 3 4
if (!r_vector_empty (
# 1177 "project/radare2/libr/anal/class.c"
bases
# 1177 "project/radare2/libr/anal/class.c" 3 4
)) for (
# 1177 "project/radare2/libr/anal/class.c"
...
# 1177 "project/radare2/libr/anal/class.c"
                               {
  r_cons_printf ("  %4s %s @ +0x%"
# 1178 "project/radare2/libr/anal/class.c" 3 4
                                 "llx"
# 1178 "project/radare2/libr/anal/class.c"
...
# 1183 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 1183 "project/radare2/libr/anal/class.c"
     void r_anal_class_list_vtables(RAnal *anal, const char *class_name) {
 char *class_name_sanitized = r_str_sanitize_sdb_key (class_name);
 if (!class_name_sanitized) {
  return;
 }
...
# 1198 "project/radare2/libr/anal/class.c" 3 4
 if (!r_vector_empty (
# 1198 "project/radare2/libr/anal/class.c"
 vtables
# 1198 "project/radare2/libr/anal/class.c" 3 4
 )) for (
# 1198 "project/radare2/libr/anal/class.c"
...
# 1198 "project/radare2/libr/anal/class.c"
                                    {
   r_cons_printf ("  %4s vtable 0x%"
# 1199 "project/radare2/libr/anal/class.c" 3 4
                                   "llx"
# 1199 "project/radare2/libr/anal/class.c"
                                          " @ +0x%"
# 1199 "project/radare2/libr/anal/class.c" 3 4
                                                   "llx"
# 1199 "project/radare2/libr/anal/class.c"
...
static void list_all_functions_at_vtable_offset(RAnal *anal, const char *class_name, 
# 1205 "project/radare2/libr/anal/class.c" 3 4
                                                                                    unsigned long long 
# 1205 "project/radare2/libr/anal/class.c"
                                                                                         offset) {
 RVTableContext vtableContext;
 r_anal_vtable_begin (anal, &vtableContext);
 
# 1208 "project/radare2/libr/anal/class.c" 3 4
unsigned char 
# 1208 "project/radare2/libr/anal/class.c"
    function_ptr_size = vtableContext.word_size;

 
# 1210 "project/radare2/libr/anal/class.c" 3 4
unsigned long long 
# 1210 "project/radare2/libr/anal/class.c"
     func_address;
 RVector *vtables = r_anal_class_vtable_get_all (anal, class_name);
 RAnalVTable *vtable;
...
# 1218 "project/radare2/libr/anal/class.c" 3 4
if (!r_vector_empty (
# 1218 "project/radare2/libr/anal/class.c"
vtables
# 1218 "project/radare2/libr/anal/class.c" 3 4
)) for (
# 1218 "project/radare2/libr/anal/class.c"
...
# 1218 "project/radare2/libr/anal/class.c"
  ...
  if (vtableContext.read_addr(anal, vtable->addr+offset, &func_address))
   r_cons_printf ("Function address: 0x%08"
# 1224 "project/radare2/libr/anal/class.c" 3 4
                                          "llx"
# 1224 "project/radare2/libr/anal/class.c"
...
# 1229 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 1229 "project/radare2/libr/anal/class.c"
     void r_anal_class_list_vtable_offset_functions(RAnal *anal, const char *class_name, 
# 1229 "project/radare2/libr/anal/class.c" 3 4
                                                                                         unsigned long long 
# 1229 "project/radare2/libr/anal/class.c"
                                                                                              offset) {
 if (class_name) {
  ...
  SdbList *classes = r_anal_class_get_all (anal, 
# 1243 "project/radare2/libr/anal/class.c" 3 4
                                                1
# 1243 "project/radare2/libr/anal/class.c"
                                                    );
  SdbListIter *iter;
  SdbKv *kv;
  
# 1246 "project/radare2/libr/anal/class.c" 3 4
 if ((
# 1246 "project/radare2/libr/anal/class.c"
 classes
# 1246 "project/radare2/libr/anal/class.c" 3 4
 )) for (
# 1246 "project/radare2/libr/anal/class.c"
...
# 1261 "project/radare2/libr/anal/class.c" 3 4
__attribute__((visibility("default"))) 
# 1261 "project/radare2/libr/anal/class.c"
     RGraph *r_anal_class_get_inheritance_graph(RAnal *anal) {
 
# 1262 "project/radare2/libr/anal/class.c" 3 4
do { if (!(
# 1262 "project/radare2/libr/anal/class.c"
anal
# 1262 "project/radare2/libr/anal/class.c" 3 4
...
# 1262 "project/radare2/libr/anal/class.c"
 ...
 if (!class_graph) {
  return 
# 1265 "project/radare2/libr/anal/class.c" 3 4
        ((void *)0)
# 1265 "project/radare2/libr/anal/class.c"
            ;
 }
 SdbList *classes = r_anal_class_get_all (anal, 
# 1267 "project/radare2/libr/anal/class.c" 3 4
                                               1
# 1267 "project/radare2/libr/anal/class.c"
                                                   );
 if (!classes) {
  r_graph_free (class_graph);
  return 
# 1270 "project/radare2/libr/anal/class.c" 3 4
        ((void *)0)
# 1270 "project/radare2/libr/anal/class.c"
            ;
 }
 ...
 if (!hashmap) {
  ...
  ls_free (classes);
  return 
# 1276 "project/radare2/libr/anal/class.c" 3 4
        ((void *)0)
# 1276 "project/radare2/libr/anal/class.c"
            ;
 }
 SdbListIter *iter;
 SdbKv *kv;
...
# 1281 "project/radare2/libr/anal/class.c" 3 4
if ((
# 1281 "project/radare2/libr/anal/class.c"
classes
# 1281 "project/radare2/libr/anal/class.c" 3 4
)) for (
# 1281 "project/radare2/libr/anal/class.c"
...
# 1281 "project/radare2/libr/anal/class.c"
  ...
  RGraphNode *curr_node = ht_pp_find (hashmap, name, 
# 1284 "project/radare2/libr/anal/class.c" 3 4
                                                    ((void *)0)
# 1284 "project/radare2/libr/anal/class.c"
                                                        );
  if (!curr_node) {
   curr_node = r_graph_add_node_info (class_graph, name, 
# 1286 "project/radare2/libr/anal/class.c" 3 4
                                                        ((void *)0)
# 1286 "project/radare2/libr/anal/class.c"
                                                            , 0);
   if (!curr_node) {
    goto failure;
   }
...
# 1295 "project/radare2/libr/anal/class.c" 3 4
 if (!r_vector_empty (
# 1295 "project/radare2/libr/anal/class.c"
 bases
# 1295 "project/radare2/libr/anal/class.c" 3 4
 )) for (
# 1295 "project/radare2/libr/anal/class.c"
...
# 1296 "project/radare2/libr/anal/class.c" 3 4
  _Bool 
# 1296 "project/radare2/libr/anal/class.c"
       base_found = 
# 1296 "project/radare2/libr/anal/class.c" 3 4
                    0
# 1296 "project/radare2/libr/anal/class.c"
   ...
   if (!base_found) {
    base_node = r_graph_add_node_info (class_graph, base->class_name, 
# 1300 "project/radare2/libr/anal/class.c" 3 4
                                                                     ((void *)0)
# 1300 "project/radare2/libr/anal/class.c"
                                                                         , 0);
    if (!base_node) {
     goto failure;
    }
...
failure:
 ...
 r_graph_free (class_graph);
 return 
# 1318 "project/radare2/libr/anal/class.c" 3 4
       ((void *)0)
# 1318 "project/radare2/libr/anal/class.c"
           ;
}
