# 0 "project/radare2/libr/anal/op.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/anal/op.c" 2



__attribute__((visibility("default"))) 
# 7 "project/radare2/libr/anal/op.c"
     RAnalOp *r_anal_op_new(void) {
 RAnalOp *op = 
# 8 "project/radare2/libr/anal/op.c" 3 4
              (
# 8 "project/radare2/libr/anal/op.c"
              RAnalOp
# 8 "project/radare2/libr/anal/op.c" 3 4
              *)malloc(sizeof(
# 8 "project/radare2/libr/anal/op.c"
...
# 13 "project/radare2/libr/anal/op.c" 3 4
__attribute__((visibility("default"))) 
# 13 "project/radare2/libr/anal/op.c"
     RList *r_anal_op_list_new(void) {
...
# 21 "project/radare2/libr/anal/op.c" 3 4
__attribute__((visibility("default"))) 
# 21 "project/radare2/libr/anal/op.c"
     void r_anal_op_init(RAnalOp *op) {
 if (op) {
  
# 23 "project/radare2/libr/anal/op.c" 3 4
 __builtin___memset_chk (
# 23 "project/radare2/libr/anal/op.c"
 op
# 23 "project/radare2/libr/anal/op.c" 3 4
 , 
# 23 "project/radare2/libr/anal/op.c"
...
# 23 "project/radare2/libr/anal/op.c"
                             ;
  op->addr = 
# 24 "project/radare2/libr/anal/op.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 24 "project/radare2/libr/anal/op.c"
                    ;
  op->jump = 
# 25 "project/radare2/libr/anal/op.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 25 "project/radare2/libr/anal/op.c"
                    ;
  op->fail = 
# 26 "project/radare2/libr/anal/op.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 26 "project/radare2/libr/anal/op.c"
                    ;
  op->ptr = 
# 27 "project/radare2/libr/anal/op.c" 3 4
           0xFFFFFFFFFFFFFFFFULL
# 27 "project/radare2/libr/anal/op.c"
                   ;
  op->refptr = 0;
  op->val = 
# 29 "project/radare2/libr/anal/op.c" 3 4
           0xFFFFFFFFFFFFFFFFULL
# 29 "project/radare2/libr/anal/op.c"
                   ;
  op->disp = 
# 30 "project/radare2/libr/anal/op.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 30 "project/radare2/libr/anal/op.c"
                    ;
 }
}


# 34 "project/radare2/libr/anal/op.c" 3 4
__attribute__((visibility("default"))) 
# 34 "project/radare2/libr/anal/op.c"
 ...
 op->src[0] = 
# 41 "project/radare2/libr/anal/op.c" 3 4
             ((void *)0)
# 41 "project/radare2/libr/anal/op.c"
                 ;
 op->src[1] = 
# 42 "project/radare2/libr/anal/op.c" 3 4
             ((void *)0)
# 42 "project/radare2/libr/anal/op.c"
                 ;
 op->src[2] = 
# 43 "project/radare2/libr/anal/op.c" 3 4
             ((void *)0)
# 43 "project/radare2/libr/anal/op.c"
                 ;
 r_anal_value_free (op->dst);
 op->dst = 
# 45 "project/radare2/libr/anal/op.c" 3 4
          ((void *)0)
# 45 "project/radare2/libr/anal/op.c"
              ;
 r_list_free (op->access);
 op->access = 
# 47 "project/radare2/libr/anal/op.c" 3 4
             ((void *)0)
# 47 "project/radare2/libr/anal/op.c"
                 ;
 r_strbuf_fini (&op->opex);
 r_strbuf_fini (&op->esil);
 r_anal_switch_op_free (op->switch_op);
 op->switch_op = 
# 51 "project/radare2/libr/anal/op.c" 3 4
                ((void *)0)
# 51 "project/radare2/libr/anal/op.c"
                    ;
 
# 52 "project/radare2/libr/anal/op.c" 3 4
{ free((void *)
# 52 "project/radare2/libr/anal/op.c"
op->mnemonic
# 52 "project/radare2/libr/anal/op.c" 3 4
); 
# 52 "project/radare2/libr/anal/op.c"
...
# 55 "project/radare2/libr/anal/op.c" 3 4
__attribute__((visibility("default"))) 
# 55 "project/radare2/libr/anal/op.c"
     void r_anal_op_free(void *_op) {
 if (!_op) {
  return;
 }
 r_anal_op_fini (_op);
 
# 60 "project/radare2/libr/anal/op.c" 3 4
__builtin___memset_chk (
# 60 "project/radare2/libr/anal/op.c"
_op
# 60 "project/radare2/libr/anal/op.c" 3 4
, 
# 60 "project/radare2/libr/anal/op.c"
...
# 90 "project/radare2/libr/anal/op.c" 3 4
__attribute__((visibility("default"))) 
# 90 "project/radare2/libr/anal/op.c"
     int r_anal_op(RAnal *anal, RAnalOp *op, 
# 90 "project/radare2/libr/anal/op.c" 3 4
                                             unsigned long long 
# 90 "project/radare2/libr/anal/op.c"
                                                  addr, const 
...
# 92 "project/radare2/libr/anal/op.c" 3 4
do { if (!(
# 92 "project/radare2/libr/anal/op.c"
anal && op && len > 0
# 92 "project/radare2/libr/anal/op.c" 3 4
...
# 92 "project/radare2/libr/anal/op.c"
 ...
 int ret = 
# 94 "project/radare2/libr/anal/op.c" 3 4
          (((
# 94 "project/radare2/libr/anal/op.c"
          2
# 94 "project/radare2/libr/anal/op.c" 3 4
          )>(
# 94 "project/radare2/libr/anal/op.c"
...
# 94 "project/radare2/libr/anal/op.c"
 ...
 } else if (!memcmp (data, "\xff\xff\xff\xff", 
# 117 "project/radare2/libr/anal/op.c" 3 4
                                              (((
# 117 "project/radare2/libr/anal/op.c"
                                              4
# 117 "project/radare2/libr/anal/op.c" 3 4
                                              )>(
# 117 "project/radare2/libr/anal/op.c"
...
# 127 "project/radare2/libr/anal/op.c" 3 4
  fprintf(__stderrp,
# 127 "project/radare2/libr/anal/op.c"
  "Warning: unhandled R_ANAL_OP_MASK_DISASM in r_anal_op\n"
# 127 "project/radare2/libr/anal/op.c" 3 4
  )
# 127 "project/radare2/libr/anal/op.c"
                                                                     ;
...
# 140 "project/radare2/libr/anal/op.c" 3 4
__attribute__((visibility("default"))) 
# 140 "project/radare2/libr/anal/op.c"
     RAnalOp *r_anal_op_copy(RAnalOp *op) {
 RAnalOp *nop = 
# 141 "project/radare2/libr/anal/op.c" 3 4
               (
# 141 "project/radare2/libr/anal/op.c"
               RAnalOp
# 141 "project/radare2/libr/anal/op.c" 3 4
               *)calloc(1,sizeof(
# 141 "project/radare2/libr/anal/op.c"
...
# 141 "project/radare2/libr/anal/op.c"
 ...
 if (!nop) {
  return 
# 143 "project/radare2/libr/anal/op.c" 3 4
        ((void *)0)
# 143 "project/radare2/libr/anal/op.c"
            ;
 }
 *nop = *op;
 if (op->mnemonic) {
  ...
  if (!nop->mnemonic) {
   free (nop);
   return 
# 150 "project/radare2/libr/anal/op.c" 3 4
         ((void *)0)
# 150 "project/radare2/libr/anal/op.c"
             ;
  }
 } else {
  nop->mnemonic = 
# 153 "project/radare2/libr/anal/op.c" 3 4
                 ((void *)0)
# 153 "project/radare2/libr/anal/op.c"
                     ;
 }
...
# 163 "project/radare2/libr/anal/op.c" 3 4
 if (
# 163 "project/radare2/libr/anal/op.c"
 op->access
# 163 "project/radare2/libr/anal/op.c" 3 4
 ) for (
# 163 "project/radare2/libr/anal/op.c"
...
# 173 "project/radare2/libr/anal/op.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 173 "project/radare2/libr/anal/op.c"
          r_anal_op_nonlinear(int t) {
 t &= 
# 174 "project/radare2/libr/anal/op.c" 3 4
     0x8000ffff
# 174 "project/radare2/libr/anal/op.c"
                        ;
 switch (t) {
 ...
 case R_ANAL_OP_TYPE_RET:
  return 
# 198 "project/radare2/libr/anal/op.c" 3 4
        1
# 198 "project/radare2/libr/anal/op.c"
            ;
 default:
  return 
# 200 "project/radare2/libr/anal/op.c" 3 4
        0
# 200 "project/radare2/libr/anal/op.c"
             ;
 }
}


# 204 "project/radare2/libr/anal/op.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 204 "project/radare2/libr/anal/op.c"
          r_anal_op_ismemref(int t) {
 t &= 
# 205 "project/radare2/libr/anal/op.c" 3 4
     0x8000ffff
# 205 "project/radare2/libr/anal/op.c"
                        ;
 switch (t) {
 case R_ANAL_OP_TYPE_LOAD:
 case R_ANAL_OP_TYPE_MOV:
 ...
 case R_ANAL_OP_TYPE_CMP:
  return 
# 212 "project/radare2/libr/anal/op.c" 3 4
        1
# 212 "project/radare2/libr/anal/op.c"
            ;
 default:
  return 
# 214 "project/radare2/libr/anal/op.c" 3 4
        0
# 214 "project/radare2/libr/anal/op.c"
             ;
 }
}
...
static struct optype {
 ...
 {0,
# 283 "project/radare2/libr/anal/op.c" 3 4
   ((void *)0)
# 283 "project/radare2/libr/anal/op.c"
       }
};


# 286 "project/radare2/libr/anal/op.c" 3 4
__attribute__((visibility("default"))) 
# 286 "project/radare2/libr/anal/op.c"
     int r_anal_optype_from_string(const char *type) {
 int i;
...
# 296 "project/radare2/libr/anal/op.c" 3 4
__attribute__((visibility("default"))) 
# 296 "project/radare2/libr/anal/op.c"
     const char *r_anal_optype_to_string(int t) {
 
# 297 "project/radare2/libr/anal/op.c" 3 4
_Bool 
# 297 "project/radare2/libr/anal/op.c"
     once = 
# 297 "project/radare2/libr/anal/op.c" 3 4
            1
# 297 "project/radare2/libr/anal/op.c"
...
repeat:
 ...
 if (once) {
  once = 
# 364 "project/radare2/libr/anal/op.c" 3 4
        0
# 364 "project/radare2/libr/anal/op.c"
             ;
  t &= 
# 365 "project/radare2/libr/anal/op.c" 3 4
      0x8000ffff
# 365 "project/radare2/libr/anal/op.c"
                         ;
  goto repeat;
 }
 return "undefined";
...
# 371 "project/radare2/libr/anal/op.c" 3 4
__attribute__((visibility("default"))) 
# 371 "project/radare2/libr/anal/op.c"
     const char *r_anal_op_to_esil_string(RAnal *anal, RAnalOp *op) {
 return r_strbuf_get (&op->esil);
}



# 376 "project/radare2/libr/anal/op.c" 3 4
__attribute__((visibility("default"))) 
# 376 "project/radare2/libr/anal/op.c"
     char *r_anal_op_to_string(RAnal *anal, RAnalOp *op) {
 RAnalBlock *bb;
 RAnalFunction *f;
 char *cstr, ret[128];
...
# 395 "project/radare2/libr/anal/op.c" 3 4
 __builtin___snprintf_chk (
# 395 "project/radare2/libr/anal/op.c"
 ret
# 395 "project/radare2/libr/anal/op.c" 3 4
 , 
# 395 "project/radare2/libr/anal/op.c"
...
# 400 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 400 "project/radare2/libr/anal/op.c"
  ret
# 400 "project/radare2/libr/anal/op.c" 3 4
  , 
# 400 "project/radare2/libr/anal/op.c"
...
# 403 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 403 "project/radare2/libr/anal/op.c"
  ret
# 403 "project/radare2/libr/anal/op.c" 3 4
  , 
# 403 "project/radare2/libr/anal/op.c"
...
# 407 "project/radare2/libr/anal/op.c" 3 4
 __builtin___snprintf_chk (
# 407 "project/radare2/libr/anal/op.c"
 ret
# 407 "project/radare2/libr/anal/op.c" 3 4
 , 
# 407 "project/radare2/libr/anal/op.c"
...
# 413 "project/radare2/libr/anal/op.c" 3 4
 __builtin___snprintf_chk (
# 413 "project/radare2/libr/anal/op.c"
 ret
# 413 "project/radare2/libr/anal/op.c" 3 4
 , 
# 413 "project/radare2/libr/anal/op.c"
...
# 418 "project/radare2/libr/anal/op.c" 3 4
 __builtin___snprintf_chk (
# 418 "project/radare2/libr/anal/op.c"
 ret
# 418 "project/radare2/libr/anal/op.c" 3 4
 , 
# 418 "project/radare2/libr/anal/op.c"
...
# 421 "project/radare2/libr/anal/op.c" 3 4
 __builtin___snprintf_chk (
# 421 "project/radare2/libr/anal/op.c"
 ret
# 421 "project/radare2/libr/anal/op.c" 3 4
 , 
# 421 "project/radare2/libr/anal/op.c"
...
# 427 "project/radare2/libr/anal/op.c" 3 4
 __builtin___snprintf_chk (
# 427 "project/radare2/libr/anal/op.c"
 ret
# 427 "project/radare2/libr/anal/op.c" 3 4
 , 
# 427 "project/radare2/libr/anal/op.c"
...
# 432 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 432 "project/radare2/libr/anal/op.c"
  ret
# 432 "project/radare2/libr/anal/op.c" 3 4
  , 
# 432 "project/radare2/libr/anal/op.c"
...
# 434 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 434 "project/radare2/libr/anal/op.c"
  ret
# 434 "project/radare2/libr/anal/op.c" 3 4
  , 
# 434 "project/radare2/libr/anal/op.c"
...
# 442 "project/radare2/libr/anal/op.c" 3 4
   __builtin___snprintf_chk (
# 442 "project/radare2/libr/anal/op.c"
   ret
# 442 "project/radare2/libr/anal/op.c" 3 4
   , 
# 442 "project/radare2/libr/anal/op.c"
...
# 444 "project/radare2/libr/anal/op.c" 3 4
   __builtin___snprintf_chk (
# 444 "project/radare2/libr/anal/op.c"
   ret
# 444 "project/radare2/libr/anal/op.c" 3 4
   , 
# 444 "project/radare2/libr/anal/op.c"
...
# 449 "project/radare2/libr/anal/op.c" 3 4
   __builtin___snprintf_chk (
# 449 "project/radare2/libr/anal/op.c"
   ret
# 449 "project/radare2/libr/anal/op.c" 3 4
   , 
# 449 "project/radare2/libr/anal/op.c"
...
# 451 "project/radare2/libr/anal/op.c" 3 4
   __builtin___snprintf_chk (
# 451 "project/radare2/libr/anal/op.c"
   ret
# 451 "project/radare2/libr/anal/op.c" 3 4
   , 
# 451 "project/radare2/libr/anal/op.c"
...
# 457 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 457 "project/radare2/libr/anal/op.c"
  ret
# 457 "project/radare2/libr/anal/op.c" 3 4
  , 
# 457 "project/radare2/libr/anal/op.c"
...
# 459 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 459 "project/radare2/libr/anal/op.c"
  ret
# 459 "project/radare2/libr/anal/op.c" 3 4
  , 
# 459 "project/radare2/libr/anal/op.c"
...
# 464 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 464 "project/radare2/libr/anal/op.c"
  ret
# 464 "project/radare2/libr/anal/op.c" 3 4
  , 
# 464 "project/radare2/libr/anal/op.c"
...
# 466 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 466 "project/radare2/libr/anal/op.c"
  ret
# 466 "project/radare2/libr/anal/op.c" 3 4
  , 
# 466 "project/radare2/libr/anal/op.c"
...
# 471 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 471 "project/radare2/libr/anal/op.c"
  ret
# 471 "project/radare2/libr/anal/op.c" 3 4
  , 
# 471 "project/radare2/libr/anal/op.c"
...
# 473 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 473 "project/radare2/libr/anal/op.c"
  ret
# 473 "project/radare2/libr/anal/op.c" 3 4
  , 
# 473 "project/radare2/libr/anal/op.c"
...
# 478 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 478 "project/radare2/libr/anal/op.c"
  ret
# 478 "project/radare2/libr/anal/op.c" 3 4
  , 
# 478 "project/radare2/libr/anal/op.c"
...
# 480 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 480 "project/radare2/libr/anal/op.c"
  ret
# 480 "project/radare2/libr/anal/op.c" 3 4
  , 
# 480 "project/radare2/libr/anal/op.c"
...
# 485 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 485 "project/radare2/libr/anal/op.c"
  ret
# 485 "project/radare2/libr/anal/op.c" 3 4
  , 
# 485 "project/radare2/libr/anal/op.c"
...
# 487 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 487 "project/radare2/libr/anal/op.c"
  ret
# 487 "project/radare2/libr/anal/op.c" 3 4
  , 
# 487 "project/radare2/libr/anal/op.c"
...
# 492 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 492 "project/radare2/libr/anal/op.c"
  ret
# 492 "project/radare2/libr/anal/op.c" 3 4
  , 
# 492 "project/radare2/libr/anal/op.c"
...
# 494 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 494 "project/radare2/libr/anal/op.c"
  ret
# 494 "project/radare2/libr/anal/op.c" 3 4
  , 
# 494 "project/radare2/libr/anal/op.c"
...
# 499 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 499 "project/radare2/libr/anal/op.c"
  ret
# 499 "project/radare2/libr/anal/op.c" 3 4
  , 
# 499 "project/radare2/libr/anal/op.c"
...
# 501 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 501 "project/radare2/libr/anal/op.c"
  ret
# 501 "project/radare2/libr/anal/op.c" 3 4
  , 
# 501 "project/radare2/libr/anal/op.c"
...
# 505 "project/radare2/libr/anal/op.c" 3 4
 __builtin___snprintf_chk (
# 505 "project/radare2/libr/anal/op.c"
 ret
# 505 "project/radare2/libr/anal/op.c" 3 4
 , 
# 505 "project/radare2/libr/anal/op.c"
...
# 508 "project/radare2/libr/anal/op.c" 3 4
 __builtin___memcpy_chk (
# 508 "project/radare2/libr/anal/op.c"
 ret
# 508 "project/radare2/libr/anal/op.c" 3 4
 , 
# 508 "project/radare2/libr/anal/op.c"
...
# 511 "project/radare2/libr/anal/op.c" 3 4
 __builtin___memcpy_chk (
# 511 "project/radare2/libr/anal/op.c"
 ret
# 511 "project/radare2/libr/anal/op.c" 3 4
 , 
# 511 "project/radare2/libr/anal/op.c"
...
# 514 "project/radare2/libr/anal/op.c" 3 4
 __builtin___memcpy_chk (
# 514 "project/radare2/libr/anal/op.c"
 ret
# 514 "project/radare2/libr/anal/op.c" 3 4
 , 
# 514 "project/radare2/libr/anal/op.c"
...
# 519 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 519 "project/radare2/libr/anal/op.c"
  ret
# 519 "project/radare2/libr/anal/op.c" 3 4
  , 
# 519 "project/radare2/libr/anal/op.c"
...
# 522 "project/radare2/libr/anal/op.c" 3 4
  __builtin___strcpy_chk (
# 522 "project/radare2/libr/anal/op.c"
  ret
# 522 "project/radare2/libr/anal/op.c" 3 4
  , 
# 522 "project/radare2/libr/anal/op.c"
...
# 526 "project/radare2/libr/anal/op.c" 3 4
 __builtin___memcpy_chk (
# 526 "project/radare2/libr/anal/op.c"
 ret
# 526 "project/radare2/libr/anal/op.c" 3 4
 , 
# 526 "project/radare2/libr/anal/op.c"
...
# 530 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 530 "project/radare2/libr/anal/op.c"
  ret
# 530 "project/radare2/libr/anal/op.c" 3 4
  , 
# 530 "project/radare2/libr/anal/op.c"
...
# 532 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 532 "project/radare2/libr/anal/op.c"
  ret
# 532 "project/radare2/libr/anal/op.c" 3 4
  , 
# 532 "project/radare2/libr/anal/op.c"
...
# 537 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 537 "project/radare2/libr/anal/op.c"
  ret
# 537 "project/radare2/libr/anal/op.c" 3 4
  , 
# 537 "project/radare2/libr/anal/op.c"
...
# 539 "project/radare2/libr/anal/op.c" 3 4
  __builtin___snprintf_chk (
# 539 "project/radare2/libr/anal/op.c"
  ret
# 539 "project/radare2/libr/anal/op.c" 3 4
  , 
# 539 "project/radare2/libr/anal/op.c"
...
# 546 "project/radare2/libr/anal/op.c" 3 4
 fprintf(__stderrp,
# 546 "project/radare2/libr/anal/op.c"
...
# 546 "project/radare2/libr/anal/op.c"
  ...
  free (a1);
  return 
# 550 "project/radare2/libr/anal/op.c" 3 4
        ((void *)0)
# 550 "project/radare2/libr/anal/op.c"
            ;
 default:
  free (r0);
  free (a0);
  free (a1);
  return 
# 555 "project/radare2/libr/anal/op.c" 3 4
        ((void *)0)
# 555 "project/radare2/libr/anal/op.c"
            ;
 }
 free (r0);
 free (a0);
...
# 563 "project/radare2/libr/anal/op.c" 3 4
__attribute__((visibility("default"))) 
# 563 "project/radare2/libr/anal/op.c"
     const char *r_anal_stackop_tostring(int s) {
 switch (s) {
...
# 581 "project/radare2/libr/anal/op.c" 3 4
__attribute__((visibility("default"))) 
# 581 "project/radare2/libr/anal/op.c"
     const char *r_anal_op_family_to_string(int n) {
 switch (n) {
 ...
 return 
# 595 "project/radare2/libr/anal/op.c" 3 4
       ((void *)0)
# 595 "project/radare2/libr/anal/op.c"
           ;
}


# 598 "project/radare2/libr/anal/op.c" 3 4
__attribute__((visibility("default"))) 
# 598 "project/radare2/libr/anal/op.c"
     int r_anal_op_family_from_string(const char *f) {
 struct op_family {
  const char *name;
  int id;
 };
...
# 626 "project/radare2/libr/anal/op.c" 3 4
__attribute__((visibility("default"))) 
# 626 "project/radare2/libr/anal/op.c"
     int r_anal_op_hint(RAnalOp *op, RAnalHint *hint) {
 int changes = 0;
 if (hint) {
  if (hint->val != 
# 629 "project/radare2/libr/anal/op.c" 3 4
                  0xFFFFFFFFFFFFFFFFULL
# 629 "project/radare2/libr/anal/op.c"
                          ) {
   op->val = hint->val;
   changes++;
  }
  ...
  if (hint->jump != 
# 637 "project/radare2/libr/anal/op.c" 3 4
                   0xFFFFFFFFFFFFFFFFULL
# 637 "project/radare2/libr/anal/op.c"
                           ) {
   op->jump = hint->jump;
   changes++;
  }
  if (hint->fail != 
# 641 "project/radare2/libr/anal/op.c" 3 4
                   0xFFFFFFFFFFFFFFFFULL
# 641 "project/radare2/libr/anal/op.c"
                           ) {
   op->fail = hint->fail;
   changes++;
  }
...
# 666 "project/radare2/libr/anal/op.c" 3 4
__attribute__((visibility("default"))) 
# 666 "project/radare2/libr/anal/op.c"
     int r_anal_op_reg_delta(RAnal *anal, 
# 666 "project/radare2/libr/anal/op.c" 3 4
                                          unsigned long long 
# 666 "project/radare2/libr/anal/op.c"
                                               addr, const char *name) {
 
# 667 "project/radare2/libr/anal/op.c" 3 4
unsigned char 
# 667 "project/radare2/libr/anal/op.c"
    buf[32];
