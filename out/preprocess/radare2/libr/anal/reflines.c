# 0 "project/radare2/libr/anal/reflines.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/anal/reflines.c"
...
# 4 "project/radare2/libr/anal/reflines.c" 2
# 12 "project/radare2/libr/anal/reflines.c"

# 12 "project/radare2/libr/anal/reflines.c"
typedef struct refline_end {
 int val;
 
# 14 "project/radare2/libr/anal/reflines.c" 3 4
_Bool 
# 14 "project/radare2/libr/anal/reflines.c"
     is_from;
 RAnalRefline *r;
} ReflineEnd;
...
static ReflineEnd *refline_end_new(
# 26 "project/radare2/libr/anal/reflines.c" 3 4
                                  unsigned long long 
# 26 "project/radare2/libr/anal/reflines.c"
                                       val, 
# 26 "project/radare2/libr/anal/reflines.c" 3 4
                                            _Bool 
# 26 "project/radare2/libr/anal/reflines.c"
                                                 is_from, RAnalRefline *ref) {
 ReflineEnd *re = 
# 27 "project/radare2/libr/anal/reflines.c" 3 4
                 (
# 27 "project/radare2/libr/anal/reflines.c"
                 struct refline_end
# 27 "project/radare2/libr/anal/reflines.c" 3 4
                 *)calloc(1,sizeof(
# 27 "project/radare2/libr/anal/reflines.c"
...
# 27 "project/radare2/libr/anal/reflines.c"
 ...
 if (!re) {
  return 
# 29 "project/radare2/libr/anal/reflines.c" 3 4
        ((void *)0)
# 29 "project/radare2/libr/anal/reflines.c"
            ;
 }
 re->val = val;
 re->is_from = is_from;
...
static 
# 37 "project/radare2/libr/anal/reflines.c" 3 4
      _Bool 
# 37 "project/radare2/libr/anal/reflines.c"
           add_refline(RList *list, RList *sten, 
# 37 "project/radare2/libr/anal/reflines.c" 3 4
                                                 unsigned long long 
# 37 "project/radare2/libr/anal/reflines.c"
                                                      addr, 
...
# 37 "project/radare2/libr/anal/reflines.c"
 ...
 ReflineEnd *re1, *re2;
 RAnalRefline *item = 
# 39 "project/radare2/libr/anal/reflines.c" 3 4
                     (
# 39 "project/radare2/libr/anal/reflines.c"
                     RAnalRefline
# 39 "project/radare2/libr/anal/reflines.c" 3 4
                     *)calloc(1,sizeof(
# 39 "project/radare2/libr/anal/reflines.c"
...
# 39 "project/radare2/libr/anal/reflines.c"
 ...
 if (!item) {
  return 
# 41 "project/radare2/libr/anal/reflines.c" 3 4
        0
# 41 "project/radare2/libr/anal/reflines.c"
             ;
 }
 item->from = addr;
 item->to = to;
 ...
 *idx += 1;
 ...
 re1 = refline_end_new (item->from, 
# 51 "project/radare2/libr/anal/reflines.c" 3 4
                                   1
# 51 "project/radare2/libr/anal/reflines.c"
                                       , item);
 if (!re1) {
  free (item);
  return 
# 54 "project/radare2/libr/anal/reflines.c" 3 4
        0
# 54 "project/radare2/libr/anal/reflines.c"
             ;
 }
 r_list_add_sorted (sten, re1, (RListComparator)cmp_asc);

 re2 = refline_end_new (item->to, 
# 58 "project/radare2/libr/anal/reflines.c" 3 4
                                 0
# 58 "project/radare2/libr/anal/reflines.c"
                                      , item);
 if (!re2) {
  free (re1);
  free (item);
  return 
# 62 "project/radare2/libr/anal/reflines.c" 3 4
        0
# 62 "project/radare2/libr/anal/reflines.c"
             ;
 }
 r_list_add_sorted (sten, re2, (RListComparator)cmp_asc);
 return 
# 65 "project/radare2/libr/anal/reflines.c" 3 4
       1
# 65 "project/radare2/libr/anal/reflines.c"
           ;
}


# 68 "project/radare2/libr/anal/reflines.c" 3 4
__attribute__((visibility("default"))) 
# 68 "project/radare2/libr/anal/reflines.c"
     void r_anal_reflines_free (RAnalRefline *rl) {
 free (rl);
}
# 80 "project/radare2/libr/anal/reflines.c"

# 80 "project/radare2/libr/anal/reflines.c" 3 4
__attribute__((visibility("default"))) 
# 80 "project/radare2/libr/anal/reflines.c"
     RList *r_anal_reflines_get(RAnal *anal, 
# 80 "project/radare2/libr/anal/reflines.c" 3 4
                                             unsigned long long 
# 80 "project/radare2/libr/anal/reflines.c"
                                                  addr, const 
...
# 80 "project/radare2/libr/anal/reflines.c" 3 4
                                                                        unsigned long long 
# 80 "project/radare2/libr/anal/reflines.c"
                                                                             len, int nlines, int linesout, int linescall) {
 RList *list, *sten;
 RListIter *iter;
 RAnalOp op;
 struct refline_end *el;
 const 
# 85 "project/radare2/libr/anal/reflines.c" 3 4
      unsigned char 
# 85 "project/radare2/libr/anal/reflines.c"
          *ptr = buf;
 const 
# 86 "project/radare2/libr/anal/reflines.c" 3 4
      unsigned char 
# 86 "project/radare2/libr/anal/reflines.c"
          *end = buf + len;
 
# 87 "project/radare2/libr/anal/reflines.c" 3 4
unsigned char 
# 87 "project/radare2/libr/anal/reflines.c"
    *free_levels;
 int sz = 0, count = 0;
 
# 89 "project/radare2/libr/anal/reflines.c" 3 4
unsigned long long 
# 89 "project/radare2/libr/anal/reflines.c"
     opc = addr;

 
# 91 "project/radare2/libr/anal/reflines.c" 3 4
__builtin___memset_chk (
# 91 "project/radare2/libr/anal/reflines.c"
&op
# 91 "project/radare2/libr/anal/reflines.c" 3 4
, 
# 91 "project/radare2/libr/anal/reflines.c"
...
# 91 "project/radare2/libr/anal/reflines.c"
                            ;
# 103 "project/radare2/libr/anal/reflines.c"
 list = r_list_newf (free);
 if (!list) {
  return 
# 105 "project/radare2/libr/anal/reflines.c" 3 4
        ((void *)0)
# 105 "project/radare2/libr/anal/reflines.c"
            ;
 }
 ...
 r_cons_break_push (
# 111 "project/radare2/libr/anal/reflines.c" 3 4
                   ((void *)0)
# 111 "project/radare2/libr/anal/reflines.c"
                       , 
# 111 "project/radare2/libr/anal/reflines.c" 3 4
                         ((void *)0)
# 111 "project/radare2/libr/anal/reflines.c"
...
# 128 "project/radare2/libr/anal/reflines.c" 3 4
   unsigned long long 
# 128 "project/radare2/libr/anal/reflines.c"
        skip = 0;
    
# 129 "project/radare2/libr/anal/reflines.c" 3 4
   for (
# 129 "project/radare2/libr/anal/reflines.c"
   it 
# 129 "project/radare2/libr/anal/reflines.c" 3 4
   = (void **)(
# 129 "project/radare2/libr/anal/reflines.c"
...
do_skip:
  ...
  case R_ANAL_OP_TYPE_JMP:
   ...
   if (!op.delay && op.fail != 
# 189 "project/radare2/libr/anal/reflines.c" 3 4
                              0xFFFFFFFFFFFFFFFFULL 
# 189 "project/radare2/libr/anal/reflines.c"
...
# 205 "project/radare2/libr/anal/reflines.c" 3 4
  if (
# 205 "project/radare2/libr/anal/reflines.c"
  op.switch_op->cases
# 205 "project/radare2/libr/anal/reflines.c" 3 4
  ) for (
# 205 "project/radare2/libr/anal/reflines.c"
...
# 205 "project/radare2/libr/anal/reflines.c"
 ...
 free_levels = 
# 223 "project/radare2/libr/anal/reflines.c" 3 4
              (unsigned char*)calloc(
# 223 "project/radare2/libr/anal/reflines.c"
              r_list_length (list) + 1
# 223 "project/radare2/libr/anal/reflines.c" 3 4
...
# 229 "project/radare2/libr/anal/reflines.c" 3 4
if (
# 229 "project/radare2/libr/anal/reflines.c"
sten
# 229 "project/radare2/libr/anal/reflines.c" 3 4
) for (
# 229 "project/radare2/libr/anal/reflines.c"
...
# 257 "project/radare2/libr/anal/reflines.c"
 free (free_levels);
 r_list_free (sten);
 return list;
...
list_err:
 ...
 r_list_free (list);
 return 
# 265 "project/radare2/libr/anal/reflines.c" 3 4
       ((void *)0)
# 265 "project/radare2/libr/anal/reflines.c"
           ;
}


# 268 "project/radare2/libr/anal/reflines.c" 3 4
__attribute__((visibility("default"))) 
# 268 "project/radare2/libr/anal/reflines.c"
     int r_anal_reflines_middle(RAnal *a, RList* list, 
# 268 "project/radare2/libr/anal/reflines.c" 3 4
                                                                          unsigned long long 
# 268 "project/radare2/libr/anal/reflines.c"
                                                                               addr, int len) {
...
# 272 "project/radare2/libr/anal/reflines.c" 3 4
 if (
# 272 "project/radare2/libr/anal/reflines.c"
 list
# 272 "project/radare2/libr/anal/reflines.c" 3 4
 ) for (
# 272 "project/radare2/libr/anal/reflines.c"
...
# 272 "project/radare2/libr/anal/reflines.c"
   ...
   if ((ref->to > addr) && (ref->to < addr + len)) {
    return 
# 274 "project/radare2/libr/anal/reflines.c" 3 4
          1
# 274 "project/radare2/libr/anal/reflines.c"
              ;
   }
  }
 }
 return 
# 278 "project/radare2/libr/anal/reflines.c" 3 4
       0
# 278 "project/radare2/libr/anal/reflines.c"
            ;
}

static const char* get_corner_char(RAnalRefline *ref, 
# 281 "project/radare2/libr/anal/reflines.c" 3 4
                                                     unsigned long long 
# 281 "project/radare2/libr/anal/reflines.c"
                                                          addr, 
# 281 "project/radare2/libr/anal/reflines.c" 3 4
                                                                _Bool 
# 281 "project/radare2/libr/anal/reflines.c"
...
static void add_spaces(RBuffer *b, int level, int pos, 
# 300 "project/radare2/libr/anal/reflines.c" 3 4
                                                      _Bool 
# 300 "project/radare2/libr/anal/reflines.c"
                                                           wide) {
 if (pos != -1) {
  if (wide) {
   pos *= 2;
...
static void fill_level(RBuffer *b, int pos, char ch, RAnalRefline *r, 
# 313 "project/radare2/libr/anal/reflines.c" 3 4
                                                                     _Bool 
# 313 "project/radare2/libr/anal/reflines.c"
                                                                          wide) {
 int sz = r->level;
 if (wide) {
  sz *= 2;
 ...
 if (pos == -1) {
  ...
  int pdlen = strlen (pd);
  if (pdlen > 0) {
   r_buf_write_at (b, pos, (const 
# 324 "project/radare2/libr/anal/reflines.c" 3 4
                                 unsigned char 
# 324 "project/radare2/libr/anal/reflines.c"
                                     *)pd, pdlen);
  }
 }
}
...
static inline 
# 329 "project/radare2/libr/anal/reflines.c" 3 4
             _Bool 
# 329 "project/radare2/libr/anal/reflines.c"
                  refline_kept(RAnalRefline *ref, 
# 329 "project/radare2/libr/anal/reflines.c" 3 4
                                                  _Bool 
# 329 "project/radare2/libr/anal/reflines.c"
                                                       middle_after, 
...
# 329 "project/radare2/libr/anal/reflines.c"
 ...
 if (middle_after) {
  if (ref->direction < 0) {
   if (ref->from == addr) {
    return 
# 333 "project/radare2/libr/anal/reflines.c" 3 4
          0
# 333 "project/radare2/libr/anal/reflines.c"
               ;
   }
  } else {
   if (ref->to == addr) {
    return 
# 337 "project/radare2/libr/anal/reflines.c" 3 4
          0
# 337 "project/radare2/libr/anal/reflines.c"
               ;
   }
  }
 }
 return 
# 341 "project/radare2/libr/anal/reflines.c" 3 4
       1
# 341 "project/radare2/libr/anal/reflines.c"
           ;
}
...
# 346 "project/radare2/libr/anal/reflines.c" 3 4
__attribute__((visibility("default"))) 
# 346 "project/radare2/libr/anal/reflines.c"
     RAnalRefStr *r_anal_reflines_str(void *_core, 
# 346 "project/radare2/libr/anal/reflines.c" 3 4
                                                   unsigned long long 
# 346 "project/radare2/libr/anal/reflines.c"
                                                        addr, int opts) {
...
# 355 "project/radare2/libr/anal/reflines.c" 3 4
_Bool 
# 355 "project/radare2/libr/anal/reflines.c"
     wide = opts & R_ANAL_REFLINE_TYPE_WIDE;
 int dir = 0, pos = -1, max_level = -1;
 
# 357 "project/radare2/libr/anal/reflines.c" 3 4
_Bool 
# 357 "project/radare2/libr/anal/reflines.c"
     middle_before = opts & R_ANAL_REFLINE_TYPE_MIDDLE_BEFORE;
 
# 358 "project/radare2/libr/anal/reflines.c" 3 4
_Bool 
# 358 "project/radare2/libr/anal/reflines.c"
     middle_after = opts & R_ANAL_REFLINE_TYPE_MIDDLE_AFTER;
 char *str = 
# 359 "project/radare2/libr/anal/reflines.c" 3 4
            ((void *)0)
# 359 "project/radare2/libr/anal/reflines.c"
                ;
 char *col_str = 
# 360 "project/radare2/libr/anal/reflines.c" 3 4
                ((void *)0)
# 360 "project/radare2/libr/anal/reflines.c"
                    ;

 
# 362 "project/radare2/libr/anal/reflines.c" 3 4
do { if (!(
# 362 "project/radare2/libr/anal/reflines.c"
cons && anal && anal->reflines
# 362 "project/radare2/libr/anal/reflines.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 362 "project/radare2/libr/anal/reflines.c"
"cons && anal && anal->reflines"
# 362 "project/radare2/libr/anal/reflines.c" 3 4
, 362); return (((void *)0)); } } while (0)
# 362 "project/radare2/libr/anal/reflines.c"
                                                           ;
 ...
 if (!lvls) {
  return 
# 366 "project/radare2/libr/anal/reflines.c" 3 4
        ((void *)0)
# 366 "project/radare2/libr/anal/reflines.c"
            ;
 }
 
# 368 "project/radare2/libr/anal/reflines.c" 3 4
if (
# 368 "project/radare2/libr/anal/reflines.c"
anal->reflines
# 368 "project/radare2/libr/anal/reflines.c" 3 4
) for (
# 368 "project/radare2/libr/anal/reflines.c"
...
# 368 "project/radare2/libr/anal/reflines.c"
  ...
  if (cons->context && cons->context->breaked) {
   r_list_free (lvls);
   return 
# 371 "project/radare2/libr/anal/reflines.c" 3 4
         ((void *)0)
# 371 "project/radare2/libr/anal/reflines.c"
             ;
  }
  if (((((ref)->from > (ref)->to && (addr) < (ref)->from && (addr) > (ref)->to) || ((ref)->from < (ref)->to && (addr) > (ref)->from && (addr) < (ref)->to)) || (addr) == (ref)->from || (addr) == (ref)->to) && refline_kept (ref, middle_after, addr)) {
...
# 381 "project/radare2/libr/anal/reflines.c" 3 4
if (
# 381 "project/radare2/libr/anal/reflines.c"
lvls
# 381 "project/radare2/libr/anal/reflines.c" 3 4
) for (
# 381 "project/radare2/libr/anal/reflines.c"
...
# 381 "project/radare2/libr/anal/reflines.c"
  ...
  if (cons->context && cons->context->breaked) {
   ...
   r_buf_free (c);
   return 
# 386 "project/radare2/libr/anal/reflines.c" 3 4
         ((void *)0)
# 386 "project/radare2/libr/anal/reflines.c"
             ;
  }
  if ((ref->from == addr || ref->to == addr) && !middle_after) {
   ...
   if (!pos) {
    ...
    r_buf_write_at (b, ch_pos, (
# 398 "project/radare2/libr/anal/reflines.c" 3 4
                               unsigned char 
# 398 "project/radare2/libr/anal/reflines.c"
                                   *)corner, 1);
    r_buf_write_at (c, ch_pos, (
# 399 "project/radare2/libr/anal/reflines.c" 3 4
                               unsigned char 
# 399 "project/radare2/libr/anal/reflines.c"
                                   *)col, 1);
 ...
 r_buf_free (c);
 b = 
# 441 "project/radare2/libr/anal/reflines.c" 3 4
    ((void *)0)
# 441 "project/radare2/libr/anal/reflines.c"
        ;
 c = 
# 442 "project/radare2/libr/anal/reflines.c" 3 4
    ((void *)0)
# 442 "project/radare2/libr/anal/reflines.c"
        ;
 if (!str || !col_str) {
  r_list_free (lvls);
  ...
  r_buf_free (c);
  return 
# 450 "project/radare2/libr/anal/reflines.c" 3 4
        ((void *)0)
# 450 "project/radare2/libr/anal/reflines.c"
            ;
 }
...
# 456 "project/radare2/libr/anal/reflines.c" 3 4
  __builtin___memmove_chk ((
# 456 "project/radare2/libr/anal/reflines.c"
  str
# 456 "project/radare2/libr/anal/reflines.c" 3 4
  ), (
# 456 "project/radare2/libr/anal/reflines.c"
...
# 457 "project/radare2/libr/anal/reflines.c" 3 4
  __builtin___memmove_chk ((
# 457 "project/radare2/libr/anal/reflines.c"
  col_str
# 457 "project/radare2/libr/anal/reflines.c" 3 4
  ), (
# 457 "project/radare2/libr/anal/reflines.c"
...
# 461 "project/radare2/libr/anal/reflines.c" 3 4
  __builtin___memset_chk (
# 461 "project/radare2/libr/anal/reflines.c"
  pfx
# 461 "project/radare2/libr/anal/reflines.c" 3 4
  , 
# 461 "project/radare2/libr/anal/reflines.c"
...
# 461 "project/radare2/libr/anal/reflines.c"
 ...
 r_list_free (lvls);
 RAnalRefStr *out = 
# 479 "project/radare2/libr/anal/reflines.c" 3 4
                   (
# 479 "project/radare2/libr/anal/reflines.c"
                   RAnalRefStr
# 479 "project/radare2/libr/anal/reflines.c" 3 4
                   *)calloc(1,sizeof(
# 479 "project/radare2/libr/anal/reflines.c"
...
# 485 "project/radare2/libr/anal/reflines.c" 3 4
__attribute__((visibility("default"))) 
# 485 "project/radare2/libr/anal/reflines.c"
     void r_anal_reflines_str_free(RAnalRefStr *refstr) {
 free (refstr->str);
 free (refstr->cols);
 free (refstr);
}
