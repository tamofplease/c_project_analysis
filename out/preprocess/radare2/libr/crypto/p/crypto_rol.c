# 0 "project/radare2/libr/crypto/p/crypto_rol.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/crypto/p/crypto_rol.c"
...
# 4 "project/radare2/libr/crypto/p/crypto_rol.c" 2
...
# 5 "project/radare2/libr/crypto/p/crypto_rol.c" 2




# 8 "project/radare2/libr/crypto/p/crypto_rol.c"
enum { MAX_rol_KEY_SIZE = 32768 };

struct rol_state {
 
# 11 "project/radare2/libr/crypto/p/crypto_rol.c" 3 4
unsigned char 
# 11 "project/radare2/libr/crypto/p/crypto_rol.c"
    key[MAX_rol_KEY_SIZE];
 int key_size;
};

static 
# 15 "project/radare2/libr/crypto/p/crypto_rol.c" 3 4
      _Bool 
# 15 "project/radare2/libr/crypto/p/crypto_rol.c"
           rol_init(struct rol_state *const state, const 
# 15 "project/radare2/libr/crypto/p/crypto_rol.c" 3 4
                                                         unsigned char 
# 15 "project/radare2/libr/crypto/p/crypto_rol.c"
                                                             *key, int keylen) {
 if (!state || !key || keylen < 1 || keylen > MAX_rol_KEY_SIZE) {
  return 
# 17 "project/radare2/libr/crypto/p/crypto_rol.c" 3 4
        0
# 17 "project/radare2/libr/crypto/p/crypto_rol.c"
             ;
 }
 int i;
 ...
 return 
# 24 "project/radare2/libr/crypto/p/crypto_rol.c" 3 4
       1
# 24 "project/radare2/libr/crypto/p/crypto_rol.c"
           ;
}

static void rol_crypt(struct rol_state *const state, const 
# 27 "project/radare2/libr/crypto/p/crypto_rol.c" 3 4
                                                          unsigned char 
# 27 "project/radare2/libr/crypto/p/crypto_rol.c"
                                                              *inbuf, 
# 27 "project/radare2/libr/crypto/p/crypto_rol.c" 3 4
                                                                      unsigned char 
# 27 "project/radare2/libr/crypto/p/crypto_rol.c"
...
# 30 "project/radare2/libr/crypto/p/crypto_rol.c" 3 4
 unsigned char 
# 30 "project/radare2/libr/crypto/p/crypto_rol.c"
     count = state->key[i % state->key_size] & 7;
  
# 31 "project/radare2/libr/crypto/p/crypto_rol.c" 3 4
 unsigned char 
# 31 "project/radare2/libr/crypto/p/crypto_rol.c"
     inByte = inbuf[i];
...
static 
# 39 "project/radare2/libr/crypto/p/crypto_rol.c" 3 4
      _Bool 
# 39 "project/radare2/libr/crypto/p/crypto_rol.c"
           rol_set_key(RCrypto *cry, const 
# 39 "project/radare2/libr/crypto/p/crypto_rol.c" 3 4
                                           unsigned char 
# 39 "project/radare2/libr/crypto/p/crypto_rol.c"
...
static 
# 48 "project/radare2/libr/crypto/p/crypto_rol.c" 3 4
      _Bool 
# 48 "project/radare2/libr/crypto/p/crypto_rol.c"
           rol_use(const char *algo) {
 return !strcmp (algo, "rol");
}

static 
# 52 "project/radare2/libr/crypto/p/crypto_rol.c" 3 4
      _Bool 
# 52 "project/radare2/libr/crypto/p/crypto_rol.c"
...
# 54 "project/radare2/libr/crypto/p/crypto_rol.c" 3 4
 fprintf(__stderrp,
# 54 "project/radare2/libr/crypto/p/crypto_rol.c"
 "Use ROR\n"
# 54 "project/radare2/libr/crypto/p/crypto_rol.c" 3 4
 )
# 54 "project/radare2/libr/crypto/p/crypto_rol.c"
                      ;
  return 
# 55 "project/radare2/libr/crypto/p/crypto_rol.c" 3 4
        0
# 55 "project/radare2/libr/crypto/p/crypto_rol.c"
             ;
 }
 
# 57 "project/radare2/libr/crypto/p/crypto_rol.c" 3 4
unsigned char 
# 57 "project/radare2/libr/crypto/p/crypto_rol.c"
    *obuf = calloc (1, len);
 if (!obuf) {
  return 
# 59 "project/radare2/libr/crypto/p/crypto_rol.c" 3 4
        0
# 59 "project/radare2/libr/crypto/p/crypto_rol.c"
             ;
 }
 ...
 free (obuf);
 return 
# 64 "project/radare2/libr/crypto/p/crypto_rol.c" 3 4
       1
# 64 "project/radare2/libr/crypto/p/crypto_rol.c"
           ;
}
...
# 77 "project/radare2/libr/crypto/p/crypto_rol.c" 3 4
__attribute__((visibility("default"))) 
# 77 "project/radare2/libr/crypto/p/crypto_rol.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_CRYPTO,
 .data = &r_crypto_plugin_rol,
 .version = 
# 80 "project/radare2/libr/crypto/p/crypto_rol.c" 3 4
           "5.5.4"

# 81 "project/radare2/libr/crypto/p/crypto_rol.c"
};
