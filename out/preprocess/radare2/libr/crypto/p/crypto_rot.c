# 0 "project/radare2/libr/crypto/p/crypto_rot.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/crypto/p/crypto_rot.c"
...
# 4 "project/radare2/libr/crypto/p/crypto_rot.c" 2
...
# 5 "project/radare2/libr/crypto/p/crypto_rot.c" 2


# 6 "project/radare2/libr/crypto/p/crypto_rot.c"
int mod(int a, int b) {
 if (b < 0) {
  return mod (-a, -b);
 }
...
static 
# 17 "project/radare2/libr/crypto/p/crypto_rot.c" 3 4
      _Bool 
# 17 "project/radare2/libr/crypto/p/crypto_rot.c"
           rot_init(
# 17 "project/radare2/libr/crypto/p/crypto_rot.c" 3 4
                    unsigned char 
# 17 "project/radare2/libr/crypto/p/crypto_rot.c"
...
# 17 "project/radare2/libr/crypto/p/crypto_rot.c"
  ...
  *rotkey = (
# 20 "project/radare2/libr/crypto/p/crypto_rot.c" 3 4
            unsigned char
# 20 "project/radare2/libr/crypto/p/crypto_rot.c"
               )mod (i, 26);
  return 
# 21 "project/radare2/libr/crypto/p/crypto_rot.c" 3 4
        1
# 21 "project/radare2/libr/crypto/p/crypto_rot.c"
            ;
 }
 return 
# 23 "project/radare2/libr/crypto/p/crypto_rot.c" 3 4
       0
# 23 "project/radare2/libr/crypto/p/crypto_rot.c"
            ;
}

static void rot_crypt(
# 26 "project/radare2/libr/crypto/p/crypto_rot.c" 3 4
                     unsigned char 
# 26 "project/radare2/libr/crypto/p/crypto_rot.c"
                         key, const 
# 26 "project/radare2/libr/crypto/p/crypto_rot.c" 3 4
                                    unsigned char 
# 26 "project/radare2/libr/crypto/p/crypto_rot.c"
...
static void rot_decrypt(
# 40 "project/radare2/libr/crypto/p/crypto_rot.c" 3 4
                       unsigned char 
# 40 "project/radare2/libr/crypto/p/crypto_rot.c"
                           key, const 
# 40 "project/radare2/libr/crypto/p/crypto_rot.c" 3 4
                                      unsigned char 
# 40 "project/radare2/libr/crypto/p/crypto_rot.c"
...
static 
# 55 "project/radare2/libr/crypto/p/crypto_rot.c" 3 4
      unsigned char 
# 55 "project/radare2/libr/crypto/p/crypto_rot.c"
          rot_key;
static int flag = 0;

static 
# 58 "project/radare2/libr/crypto/p/crypto_rot.c" 3 4
      _Bool 
# 58 "project/radare2/libr/crypto/p/crypto_rot.c"
           rot_set_key(RCrypto *cry, const 
# 58 "project/radare2/libr/crypto/p/crypto_rot.c" 3 4
                                           unsigned char 
# 58 "project/radare2/libr/crypto/p/crypto_rot.c"
...
static 
# 68 "project/radare2/libr/crypto/p/crypto_rot.c" 3 4
      _Bool 
# 68 "project/radare2/libr/crypto/p/crypto_rot.c"
           rot_use(const char *algo) {
 return !strcmp (algo, "rot");
}

static 
# 72 "project/radare2/libr/crypto/p/crypto_rot.c" 3 4
      _Bool 
# 72 "project/radare2/libr/crypto/p/crypto_rot.c"
...
# 73 "project/radare2/libr/crypto/p/crypto_rot.c" 3 4
unsigned char 
# 73 "project/radare2/libr/crypto/p/crypto_rot.c"
    *obuf = calloc (1, len);
 if (!obuf) {
  return 
# 75 "project/radare2/libr/crypto/p/crypto_rot.c" 3 4
        0
# 75 "project/radare2/libr/crypto/p/crypto_rot.c"
             ;
 }
 if (flag == 0) {
 ...
 free (obuf);
 return 
# 84 "project/radare2/libr/crypto/p/crypto_rot.c" 3 4
       1
# 84 "project/radare2/libr/crypto/p/crypto_rot.c"
           ;
}

static 
# 87 "project/radare2/libr/crypto/p/crypto_rot.c" 3 4
      _Bool 
# 87 "project/radare2/libr/crypto/p/crypto_rot.c"
...
# 101 "project/radare2/libr/crypto/p/crypto_rot.c" 3 4
__attribute__((visibility("default"))) 
# 101 "project/radare2/libr/crypto/p/crypto_rot.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_CRYPTO,
 .data = &r_crypto_plugin_rot,
 .version = 
# 104 "project/radare2/libr/crypto/p/crypto_rot.c" 3 4
           "5.5.4"

# 105 "project/radare2/libr/crypto/p/crypto_rot.c"
};
