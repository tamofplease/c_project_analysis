# 0 "project/radare2/libr/crypto/p/crypto_rc4.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/crypto/p/crypto_rc4.c" 2
...
# 5 "project/radare2/libr/crypto/p/crypto_rc4.c" 2



# 7 "project/radare2/libr/crypto/p/crypto_rc4.c"
struct rc4_state {
 
# 8 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
unsigned char 
# 8 "project/radare2/libr/crypto/p/crypto_rc4.c"
    perm[256];
 
# 9 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
unsigned char 
# 9 "project/radare2/libr/crypto/p/crypto_rc4.c"
    index1;
 
# 10 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
unsigned char 
# 10 "project/radare2/libr/crypto/p/crypto_rc4.c"
    index2;
 int key_size;
};

static __inline void swap_bytes(
# 14 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
                               unsigned char 
# 14 "project/radare2/libr/crypto/p/crypto_rc4.c"
                                   *a, 
# 14 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
                                       unsigned char 
# 14 "project/radare2/libr/crypto/p/crypto_rc4.c"
...
# 16 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
 unsigned char 
# 16 "project/radare2/libr/crypto/p/crypto_rc4.c"
     temp = *a;
  *a = *b;
  *b = temp;
 }
...
static 
# 27 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
      _Bool 
# 27 "project/radare2/libr/crypto/p/crypto_rc4.c"
           rc4_init(struct rc4_state *const state, const 
# 27 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
                                                         unsigned char 
# 27 "project/radare2/libr/crypto/p/crypto_rc4.c"
                                                             *key, int keylen) {
 
# 28 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
unsigned char 
# 28 "project/radare2/libr/crypto/p/crypto_rc4.c"
    j;
 int i;

 if (!state || !key || keylen < 1) {
  return 
# 32 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
        0
# 32 "project/radare2/libr/crypto/p/crypto_rc4.c"
             ;
 }
 ...
 for (i = 0; i < 256; i++) {
  state->perm[i] = (
# 37 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
                   unsigned char
# 37 "project/radare2/libr/crypto/p/crypto_rc4.c"
                      )i;
 }
 state->index1 = 0;
 state->index2 = 0;
 ...
 return 
# 47 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
       1
# 47 "project/radare2/libr/crypto/p/crypto_rc4.c"
           ;
}
...
static void rc4_crypt(struct rc4_state *const state, const 
# 56 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
                                                          unsigned char 
# 56 "project/radare2/libr/crypto/p/crypto_rc4.c"
                                                              *inbuf, 
# 56 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
                                                                      unsigned char 
# 56 "project/radare2/libr/crypto/p/crypto_rc4.c"
...
# 58 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
unsigned char 
# 58 "project/radare2/libr/crypto/p/crypto_rc4.c"
    j;
...
static 
# 77 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
      _Bool 
# 77 "project/radare2/libr/crypto/p/crypto_rc4.c"
           rc4_set_key(RCrypto *cry, const 
# 77 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
                                           unsigned char 
# 77 "project/radare2/libr/crypto/p/crypto_rc4.c"
...
static 
# 85 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
      _Bool 
# 85 "project/radare2/libr/crypto/p/crypto_rc4.c"
           rc4_use(const char *algo) {
 return !strcmp (algo, "rc4");
}

static 
# 89 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
      _Bool 
# 89 "project/radare2/libr/crypto/p/crypto_rc4.c"
...
# 90 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
unsigned char 
# 90 "project/radare2/libr/crypto/p/crypto_rc4.c"
    *obuf = calloc (1, len);
 if (!obuf) {
  return 
# 92 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
        0
# 92 "project/radare2/libr/crypto/p/crypto_rc4.c"
             ;
 }
 ...
 free (obuf);
 return 
# 97 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
       0
# 97 "project/radare2/libr/crypto/p/crypto_rc4.c"
            ;
}

static 
# 100 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
      _Bool 
# 100 "project/radare2/libr/crypto/p/crypto_rc4.c"
...
# 114 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
__attribute__((visibility("default"))) 
# 114 "project/radare2/libr/crypto/p/crypto_rc4.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_CRYPTO,
 .data = &r_crypto_plugin_rc4,
 .version = 
# 117 "project/radare2/libr/crypto/p/crypto_rc4.c" 3 4
           "5.5.4"

# 118 "project/radare2/libr/crypto/p/crypto_rc4.c"
};
