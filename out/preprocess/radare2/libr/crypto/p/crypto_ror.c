# 0 "project/radare2/libr/crypto/p/crypto_ror.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/crypto/p/crypto_ror.c"
...
# 2 "project/radare2/libr/crypto/p/crypto_ror.c" 2
...
# 3 "project/radare2/libr/crypto/p/crypto_ror.c" 2




# 6 "project/radare2/libr/crypto/p/crypto_ror.c"
enum { MAX_ror_KEY_SIZE = 32768 };

struct ror_state {
 
# 9 "project/radare2/libr/crypto/p/crypto_ror.c" 3 4
unsigned char 
# 9 "project/radare2/libr/crypto/p/crypto_ror.c"
    key[MAX_ror_KEY_SIZE];
 int key_size;
};

static 
# 13 "project/radare2/libr/crypto/p/crypto_ror.c" 3 4
      _Bool 
# 13 "project/radare2/libr/crypto/p/crypto_ror.c"
           ror_init(struct ror_state *const state, const 
# 13 "project/radare2/libr/crypto/p/crypto_ror.c" 3 4
                                                         unsigned char 
# 13 "project/radare2/libr/crypto/p/crypto_ror.c"
                                                             *key, int keylen) {
 if (!state || !key || keylen < 1 || keylen > MAX_ror_KEY_SIZE) {
  return 
# 15 "project/radare2/libr/crypto/p/crypto_ror.c" 3 4
        0
# 15 "project/radare2/libr/crypto/p/crypto_ror.c"
             ;
 }
 int i;
 ...
 return 
# 22 "project/radare2/libr/crypto/p/crypto_ror.c" 3 4
       1
# 22 "project/radare2/libr/crypto/p/crypto_ror.c"
           ;
}

static void ror_crypt(struct ror_state *const state, const 
# 25 "project/radare2/libr/crypto/p/crypto_ror.c" 3 4
                                                          unsigned char 
# 25 "project/radare2/libr/crypto/p/crypto_ror.c"
                                                              *inbuf, 
# 25 "project/radare2/libr/crypto/p/crypto_ror.c" 3 4
                                                                      unsigned char 
# 25 "project/radare2/libr/crypto/p/crypto_ror.c"
...
# 28 "project/radare2/libr/crypto/p/crypto_ror.c" 3 4
 unsigned char 
# 28 "project/radare2/libr/crypto/p/crypto_ror.c"
     count = state->key[i % state->key_size] & 7;
  
# 29 "project/radare2/libr/crypto/p/crypto_ror.c" 3 4
 unsigned char 
# 29 "project/radare2/libr/crypto/p/crypto_ror.c"
     inByte = inbuf[i];
...
static 
# 37 "project/radare2/libr/crypto/p/crypto_ror.c" 3 4
      _Bool 
# 37 "project/radare2/libr/crypto/p/crypto_ror.c"
           ror_set_key(RCrypto *cry, const 
# 37 "project/radare2/libr/crypto/p/crypto_ror.c" 3 4
                                           unsigned char 
# 37 "project/radare2/libr/crypto/p/crypto_ror.c"
...
static 
# 46 "project/radare2/libr/crypto/p/crypto_ror.c" 3 4
      _Bool 
# 46 "project/radare2/libr/crypto/p/crypto_ror.c"
           ror_use(const char *algo) {
 return !strcmp (algo, "ror");
}

static 
# 50 "project/radare2/libr/crypto/p/crypto_ror.c" 3 4
      _Bool 
# 50 "project/radare2/libr/crypto/p/crypto_ror.c"
...
# 52 "project/radare2/libr/crypto/p/crypto_ror.c" 3 4
 fprintf(__stderrp,
# 52 "project/radare2/libr/crypto/p/crypto_ror.c"
 "USE ROL\n"
# 52 "project/radare2/libr/crypto/p/crypto_ror.c" 3 4
 )
# 52 "project/radare2/libr/crypto/p/crypto_ror.c"
                      ;
  return 
# 53 "project/radare2/libr/crypto/p/crypto_ror.c" 3 4
        0
# 53 "project/radare2/libr/crypto/p/crypto_ror.c"
             ;
 }
 
# 55 "project/radare2/libr/crypto/p/crypto_ror.c" 3 4
unsigned char 
# 55 "project/radare2/libr/crypto/p/crypto_ror.c"
    *obuf = calloc (1, len);
 if (!obuf) {
  return 
# 57 "project/radare2/libr/crypto/p/crypto_ror.c" 3 4
        0
# 57 "project/radare2/libr/crypto/p/crypto_ror.c"
             ;
 }
 ...
 free (obuf);
 return 
# 62 "project/radare2/libr/crypto/p/crypto_ror.c" 3 4
       1
# 62 "project/radare2/libr/crypto/p/crypto_ror.c"
           ;
}
...
# 75 "project/radare2/libr/crypto/p/crypto_ror.c" 3 4
__attribute__((visibility("default"))) 
# 75 "project/radare2/libr/crypto/p/crypto_ror.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_CRYPTO,
 .data = &r_crypto_plugin_ror,
 .version = 
# 78 "project/radare2/libr/crypto/p/crypto_ror.c" 3 4
           "5.5.4"

# 79 "project/radare2/libr/crypto/p/crypto_ror.c"
};
