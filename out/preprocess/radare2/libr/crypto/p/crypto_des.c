# 0 "project/radare2/libr/crypto/p/crypto_des.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/crypto/p/crypto_des.c"
...
# 4 "project/radare2/libr/crypto/p/crypto_des.c" 2
...
# 5 "project/radare2/libr/crypto/p/crypto_des.c" 2
...
# 6 "project/radare2/libr/crypto/p/crypto_des.c" 2


# 7 "project/radare2/libr/crypto/p/crypto_des.c"
struct des_state {
 
# 8 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
unsigned int 
# 8 "project/radare2/libr/crypto/p/crypto_des.c"
     keylo[16];
 
# 9 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
unsigned int 
# 9 "project/radare2/libr/crypto/p/crypto_des.c"
     keyhi[16];
 
# 10 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
unsigned int 
# 10 "project/radare2/libr/crypto/p/crypto_des.c"
     buflo;
 
# 11 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
unsigned int 
# 11 "project/radare2/libr/crypto/p/crypto_des.c"
     bufhi;
 int key_size;
 int rounds;
 int i;
...
static 
# 19 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
      unsigned int 
# 19 "project/radare2/libr/crypto/p/crypto_des.c"
           be32(const 
# 19 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
                      unsigned char 
# 19 "project/radare2/libr/crypto/p/crypto_des.c"
...
# 20 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
unsigned int 
# 20 "project/radare2/libr/crypto/p/crypto_des.c"
     val = buf4[0] << 8;
 val |= buf4[1];
 val <<= 8;
 val |= buf4[2];
...
static void wbe32(
# 29 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
                 unsigned char 
# 29 "project/radare2/libr/crypto/p/crypto_des.c"
                     *buf4, 
# 29 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
                            unsigned int 
# 29 "project/radare2/libr/crypto/p/crypto_des.c"
...
static int des_encrypt (struct des_state *st, const 
# 36 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
                                                   unsigned char 
# 36 "project/radare2/libr/crypto/p/crypto_des.c"
                                                       *input, 
# 36 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
                                                               unsigned char 
# 36 "project/radare2/libr/crypto/p/crypto_des.c"
 ...
 if (!st || !input || !output) {
  return 
# 38 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
        0
# 38 "project/radare2/libr/crypto/p/crypto_des.c"
             ;
 }
 ...
 return 
# 56 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
       1
# 56 "project/radare2/libr/crypto/p/crypto_des.c"
           ;
}

static int des_decrypt (struct des_state *st, const 
# 59 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
                                                   unsigned char 
# 59 "project/radare2/libr/crypto/p/crypto_des.c"
                                                       *input, 
# 59 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
                                                               unsigned char 
# 59 "project/radare2/libr/crypto/p/crypto_des.c"
 ...
 if (!st || !input || !output) {
  return 
# 61 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
        0
# 61 "project/radare2/libr/crypto/p/crypto_des.c"
             ;
 }
 st->buflo = be32 (input + 0);
 st->bufhi = be32 (input + 4);
 ...
 wbe32 (output + 4, st->buflo);
 return 
# 77 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
       1
# 77 "project/radare2/libr/crypto/p/crypto_des.c"
           ;
}

static 
# 80 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
      _Bool 
# 80 "project/radare2/libr/crypto/p/crypto_des.c"
           des_set_key (RCrypto *cry, const 
# 80 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
                                            unsigned char 
# 80 "project/radare2/libr/crypto/p/crypto_des.c"
                                                *key, int keylen, int mode, int direction) {
 
# 81 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
unsigned int 
# 81 "project/radare2/libr/crypto/p/crypto_des.c"
     keylo, keyhi, i;
 if (keylen != 
# 82 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
              8
# 82 "project/radare2/libr/crypto/p/crypto_des.c"
                          ) {
  return 
# 83 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
        0
# 83 "project/radare2/libr/crypto/p/crypto_des.c"
             ;
 }
 ...
 st.key_size = 
# 89 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
              8
# 89 "project/radare2/libr/crypto/p/crypto_des.c"
                          ;
 st.rounds = 16;
 cry->dir = direction;
 ...
 return 
# 100 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
       1
# 100 "project/radare2/libr/crypto/p/crypto_des.c"
           ;
}
...
static 
# 107 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
      _Bool 
# 107 "project/radare2/libr/crypto/p/crypto_des.c"
           des_use (const char *algo) {
 return algo && !strcmp (algo, "des-ecb");
}

static 
# 111 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
      _Bool 
# 111 "project/radare2/libr/crypto/p/crypto_des.c"
...
# 111 "project/radare2/libr/crypto/p/crypto_des.c"
 ...
 if (len <= 0) {
  return 
# 113 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
        0
# 113 "project/radare2/libr/crypto/p/crypto_des.c"
             ;
 }


 const int diff = (
# 117 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
                  8 
# 117 "project/radare2/libr/crypto/p/crypto_des.c"
                                 - (len % 
# 117 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
                                          8
# 117 "project/radare2/libr/crypto/p/crypto_des.c"
...
# 119 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
                          8
# 119 "project/radare2/libr/crypto/p/crypto_des.c"
                                        ;

 
# 121 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
unsigned char 
# 121 "project/radare2/libr/crypto/p/crypto_des.c"
    *const obuf = calloc (1, size);
 if (!obuf) {
  return 
# 123 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
        0
# 123 "project/radare2/libr/crypto/p/crypto_des.c"
             ;
 }

 
# 126 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
unsigned char 
# 126 "project/radare2/libr/crypto/p/crypto_des.c"
    *const ibuf = calloc (1, size);
 if (!ibuf) {
  free (obuf);
  return 
# 129 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
        0
# 129 "project/radare2/libr/crypto/p/crypto_des.c"
             ;
 }

 
# 132 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
__builtin___memset_chk (
# 132 "project/radare2/libr/crypto/p/crypto_des.c"
ibuf + len
# 132 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
, 
# 132 "project/radare2/libr/crypto/p/crypto_des.c"
...
# 133 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
__builtin___memcpy_chk (
# 133 "project/radare2/libr/crypto/p/crypto_des.c"
ibuf
# 133 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
, 
# 133 "project/radare2/libr/crypto/p/crypto_des.c"
...
# 143 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
  unsigned int 
# 143 "project/radare2/libr/crypto/p/crypto_des.c"
       next = (
# 143 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
               8 
# 143 "project/radare2/libr/crypto/p/crypto_des.c"
...
# 148 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
  unsigned int 
# 148 "project/radare2/libr/crypto/p/crypto_des.c"
       next = (
# 148 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
               8 
# 148 "project/radare2/libr/crypto/p/crypto_des.c"
...
static 
# 159 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
      _Bool 
# 159 "project/radare2/libr/crypto/p/crypto_des.c"
...
# 173 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
__attribute__((visibility("default"))) 
# 173 "project/radare2/libr/crypto/p/crypto_des.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_CRYPTO,
 .data = &r_crypto_plugin_des,
 .version = 
# 176 "project/radare2/libr/crypto/p/crypto_des.c" 3 4
           "5.5.4"

# 177 "project/radare2/libr/crypto/p/crypto_des.c"
};
