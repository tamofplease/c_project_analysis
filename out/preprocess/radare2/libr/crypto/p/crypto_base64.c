# 0 "project/radare2/libr/crypto/p/crypto_base64.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/crypto/p/crypto_base64.c"
...
# 4 "project/radare2/libr/crypto/p/crypto_base64.c" 2
...
# 5 "project/radare2/libr/crypto/p/crypto_base64.c" 2
...
# 6 "project/radare2/libr/crypto/p/crypto_base64.c" 2


# 7 "project/radare2/libr/crypto/p/crypto_base64.c"
static 
# 7 "project/radare2/libr/crypto/p/crypto_base64.c" 3 4
      _Bool 
# 7 "project/radare2/libr/crypto/p/crypto_base64.c"
           base64_set_key(RCrypto *cry, const 
# 7 "project/radare2/libr/crypto/p/crypto_base64.c" 3 4
                                              unsigned char 
# 7 "project/radare2/libr/crypto/p/crypto_base64.c"
 ...
 cry->dir = direction;
 return 
# 9 "project/radare2/libr/crypto/p/crypto_base64.c" 3 4
       1
# 9 "project/radare2/libr/crypto/p/crypto_base64.c"
           ;
}
...
static 
# 16 "project/radare2/libr/crypto/p/crypto_base64.c" 3 4
      _Bool 
# 16 "project/radare2/libr/crypto/p/crypto_base64.c"
           base64_use(const char *algo) {
 return !strcmp (algo, "base64");
}

static 
# 20 "project/radare2/libr/crypto/p/crypto_base64.c" 3 4
      _Bool 
# 20 "project/radare2/libr/crypto/p/crypto_base64.c"
...
# 22 "project/radare2/libr/crypto/p/crypto_base64.c" 3 4
unsigned char 
# 22 "project/radare2/libr/crypto/p/crypto_base64.c"
    *obuf = 
# 22 "project/radare2/libr/crypto/p/crypto_base64.c" 3 4
            ((void *)0)
# 22 "project/radare2/libr/crypto/p/crypto_base64.c"
 ...
 if (cry->dir == 0) {
  ...
  if (!obuf) {
   return 
# 27 "project/radare2/libr/crypto/p/crypto_base64.c" 3 4
         0
# 27 "project/radare2/libr/crypto/p/crypto_base64.c"
              ;
  }
  r_base64_encode ((char *)obuf, (const 
# 29 "project/radare2/libr/crypto/p/crypto_base64.c" 3 4
                                       unsigned char 
# 29 "project/radare2/libr/crypto/p/crypto_base64.c"
                                           *)buf, len);
 } else if (cry->dir == 1) {
  olen = 4 + ((len / 4) * 3);
  if (len > 0) {
  ...
  if (!obuf) {
   return 
# 37 "project/radare2/libr/crypto/p/crypto_base64.c" 3 4
         0
# 37 "project/radare2/libr/crypto/p/crypto_base64.c"
              ;
  }
 ...
 free (obuf);
 return 
# 45 "project/radare2/libr/crypto/p/crypto_base64.c" 3 4
       1
# 45 "project/radare2/libr/crypto/p/crypto_base64.c"
           ;
}

static 
# 48 "project/radare2/libr/crypto/p/crypto_base64.c" 3 4
      _Bool 
# 48 "project/radare2/libr/crypto/p/crypto_base64.c"
...
# 62 "project/radare2/libr/crypto/p/crypto_base64.c" 3 4
__attribute__((visibility("default"))) 
# 62 "project/radare2/libr/crypto/p/crypto_base64.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_CRYPTO,
 .data = &r_crypto_plugin_base64,
 .version = 
# 65 "project/radare2/libr/crypto/p/crypto_base64.c" 3 4
           "5.5.4"

# 66 "project/radare2/libr/crypto/p/crypto_base64.c"
};
