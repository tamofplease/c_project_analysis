# 0 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
...
# 4 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 2
...
# 5 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 2
...
# 271 "project/radare2/libr/crypto/p/crypto_aes_algo.h"
                                             *);
# 6 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 2



static 
# 9 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
      _Bool 
# 9 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
           aes_cbc_set_key(RCrypto *cry, const 
# 9 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
                                               unsigned char 
# 9 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
 ...
 if (!(keylen == 128 / 8 || keylen == 192 / 8 || keylen == 256 / 8)) {
  return 
# 11 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
        0
# 11 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
             ;
 }
 cry->key_len = keylen;
 
# 14 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
__builtin___memcpy_chk (
# 14 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
cry->key
# 14 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
, 
# 14 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
...
# 14 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
 ...
 cry->dir = direction;
 return 
# 16 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
       1
# 16 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
           ;
}
...
static 
# 23 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
      _Bool 
# 23 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
           aes_cbc_set_iv(RCrypto *cry, const 
# 23 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
                                              unsigned char 
# 23 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
                                                  *iv_src, int ivlen) {
 if (ivlen != 16) {
  return 
# 25 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
        0
# 25 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
             ;
 }
 cry->iv = calloc (1, 16);
 
# 28 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
__builtin___memcpy_chk (
# 28 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
cry->iv
# 28 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
, 
# 28 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
...
# 28 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
                                    ;
 return 
# 29 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
       1
# 29 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
           ;
}

static 
# 32 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
      _Bool 
# 32 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
           aes_cbc_use(const char *algo) {
 return algo && !strcmp (algo, "aes-cbc");
}

static 
# 36 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
      _Bool 
# 36 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
...
# 36 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
                                          *buf, int len) {
 if (
# 37 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
    ((void *)0) 
# 37 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
         == cry->iv) {
  
# 38 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
 fprintf(__stderrp,
# 38 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
 "IV not set. Use -I [iv]\n"
# 38 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
 )
# 38 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
                                      ;
  return 
# 39 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
        0
# 39 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
             ;
 }
 struct aes_state st;
...
# 46 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
unsigned char 
# 46 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
    *const obuf = calloc (1, size);
 if (!obuf) {
  return 
# 48 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
        0
# 48 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
             ;
 }

 
# 51 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
unsigned char 
# 51 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
    *const ibuf = calloc (1, size);
 if (!ibuf) {
  free (obuf);
  return 
# 54 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
        0
# 54 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
             ;
 }

 
# 57 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
__builtin___memset_chk (
# 57 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
ibuf
# 57 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
, 
# 57 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
...
# 58 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
__builtin___memcpy_chk (
# 58 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
ibuf
# 58 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
, 
# 58 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
...
# 67 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
__builtin___memcpy_chk (
# 67 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
st.key
# 67 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
, 
# 67 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
...
# 67 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
 ...
 if (cry->dir == 0) {
  for (i = 0; i < blocks; i++) {
   for (j = 0; j < 16; j++) {
    ibuf[i * 16 + j] ^= cry->iv[j];
   }
   aes_encrypt (&st, ibuf + 16 * i, obuf + 16 * i);
   
# 76 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
  __builtin___memcpy_chk (
# 76 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
  cry->iv
# 76 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
  , 
# 76 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
...
# 76 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
  ...
  for (i = 0; i < blocks; i++) {
   aes_decrypt (&st, ibuf + 16 * i, obuf + 16 * i);
   for (j = 0; j < 16; j++) {
    obuf[i * 16 + j] ^= cry->iv[j];
   }
   
# 84 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
  __builtin___memcpy_chk (
# 84 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
  cry->iv
# 84 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
  , 
# 84 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
...
# 84 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
 ...
 free (ibuf);
 return 
# 91 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
       1
# 91 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
           ;
}

static 
# 94 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
      _Bool 
# 94 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
...
# 109 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
__attribute__((visibility("default"))) 
# 109 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_CRYPTO,
 .data = &r_crypto_plugin_aes_cbc,
 .version = 
# 112 "project/radare2/libr/crypto/p/crypto_aes_cbc.c" 3 4
           "5.5.4"

# 113 "project/radare2/libr/crypto/p/crypto_aes_cbc.c"
};
