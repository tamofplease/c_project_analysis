# 0 "project/radare2/libr/util/charset.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/charset.c"
...
# 4 "project/radare2/libr/util/charset.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/sdb/src/config.h" 1 3 4
# 5 "project/radare2/libr/util/charset.c" 2





# 9 "project/radare2/libr/util/charset.c"
...
# 17 "project/radare2/libr/util/charset.c" 3 4
((void *)0)

# 18 "project/radare2/libr/util/charset.c"
};


# 20 "project/radare2/libr/util/charset.c" 3 4
__attribute__((visibility("default"))) 
# 20 "project/radare2/libr/util/charset.c"
     SdbGperf *r_charset_get_gperf(const char *k) {
 ...
 return 
# 29 "project/radare2/libr/util/charset.c" 3 4
       ((void *)0)
# 29 "project/radare2/libr/util/charset.c"
           ;
}
...
# 37 "project/radare2/libr/util/charset.c" 3 4
__attribute__((visibility("default"))) 
# 37 "project/radare2/libr/util/charset.c"
     RList *r_charset_list(RCharset *ch) {
 ...
 const char *cs = 
# 48 "project/radare2/libr/util/charset.c" 3 4
                 "/usr/local" "/" "share" "/" "radare2" "/" "5.5.4" "/" 
# 48 "project/radare2/libr/util/charset.c"
                                                      "charsets" 
# 48 "project/radare2/libr/util/charset.c" 3 4
                                                                 "/"
# 48 "project/radare2/libr/util/charset.c"
...
# 52 "project/radare2/libr/util/charset.c" 3 4
if (
# 52 "project/radare2/libr/util/charset.c"
files
# 52 "project/radare2/libr/util/charset.c" 3 4
) for (
# 52 "project/radare2/libr/util/charset.c"
...
# 63 "project/radare2/libr/util/charset.c" 3 4
__attribute__((visibility("default"))) 
# 63 "project/radare2/libr/util/charset.c"
     RCharset *r_charset_new(void) {
 RCharset *ch = 
# 64 "project/radare2/libr/util/charset.c" 3 4
               (
# 64 "project/radare2/libr/util/charset.c"
               RCharset
# 64 "project/radare2/libr/util/charset.c" 3 4
               *)calloc(1,sizeof(
# 64 "project/radare2/libr/util/charset.c"
...
# 72 "project/radare2/libr/util/charset.c" 3 4
__attribute__((visibility("default"))) 
# 72 "project/radare2/libr/util/charset.c"
     void r_charset_free(RCharset *c) {
 if (c) {
  sdb_free (c->db);
...
# 80 "project/radare2/libr/util/charset.c" 3 4
__attribute__((visibility("default"))) 
# 80 "project/radare2/libr/util/charset.c"
     void r_charset_close(RCharset *c) {
 c->loaded = 
# 81 "project/radare2/libr/util/charset.c" 3 4
            0
# 81 "project/radare2/libr/util/charset.c"
                 ;
}


# 84 "project/radare2/libr/util/charset.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 84 "project/radare2/libr/util/charset.c"
          r_charset_use(RCharset *c, const char *cf) {
 
# 85 "project/radare2/libr/util/charset.c" 3 4
do { if (!(
# 85 "project/radare2/libr/util/charset.c"
c && cf
# 85 "project/radare2/libr/util/charset.c" 3 4
...
# 86 "project/radare2/libr/util/charset.c" 3 4
_Bool 
# 86 "project/radare2/libr/util/charset.c"
     rc = 
# 86 "project/radare2/libr/util/charset.c" 3 4
          0
# 86 "project/radare2/libr/util/charset.c"
 ...
 if (gp) {
  ...
  if (sdb_open_gperf (c->db, gp) != -1) {
   rc = r_charset_open (c, 
# 92 "project/radare2/libr/util/charset.c" 3 4
                          ((void *)0)
# 92 "project/radare2/libr/util/charset.c"
                              );
   r_sys_setenv ("RABIN2_CHARSET", cf);
   rc = 
# 94 "project/radare2/libr/util/charset.c" 3 4
       1
# 94 "project/radare2/libr/util/charset.c"
           ;
  }
 } else {
  const char *cs = 
# 97 "project/radare2/libr/util/charset.c" 3 4
                  "/usr/local" "/" "share" "/" "radare2" "/" "5.5.4" "/" 
# 97 "project/radare2/libr/util/charset.c"
                                                       "charsets" 
# 97 "project/radare2/libr/util/charset.c" 3 4
                                                                  "/"
# 97 "project/radare2/libr/util/charset.c"
...
# 108 "project/radare2/libr/util/charset.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 108 "project/radare2/libr/util/charset.c"
          r_charset_open(RCharset *c, const char *cs) {
 
# 109 "project/radare2/libr/util/charset.c" 3 4
do { if (!(
# 109 "project/radare2/libr/util/charset.c"
c
# 109 "project/radare2/libr/util/charset.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 109 "project/radare2/libr/util/charset.c"
...
# 109 "project/radare2/libr/util/charset.c"
 ...
 SdbListIter *iter;
 SdbKv *kv;
 SdbList *sdbls = sdb_foreach_list (c->db, 
# 120 "project/radare2/libr/util/charset.c" 3 4
                                          1
# 120 "project/radare2/libr/util/charset.c"
                                              );

 c->loaded = 
# 122 "project/radare2/libr/util/charset.c" 3 4
            0
# 122 "project/radare2/libr/util/charset.c"
                 ;
 
# 123 "project/radare2/libr/util/charset.c" 3 4
if ((
# 123 "project/radare2/libr/util/charset.c"
sdbls
# 123 "project/radare2/libr/util/charset.c" 3 4
)) for (
# 123 "project/radare2/libr/util/charset.c"
...
# 123 "project/radare2/libr/util/charset.c"
  ...
  c->loaded = 
# 135 "project/radare2/libr/util/charset.c" 3 4
             1
# 135 "project/radare2/libr/util/charset.c"
                 ;
 }
 ls_free (sdbls);

 return 
# 139 "project/radare2/libr/util/charset.c" 3 4
       1
# 139 "project/radare2/libr/util/charset.c"
           ;
}



# 143 "project/radare2/libr/util/charset.c" 3 4
__attribute__((visibility("default"))) 
# 143 "project/radare2/libr/util/charset.c"
     RCharsetRune *r_charset_rune_new(const 
# 143 "project/radare2/libr/util/charset.c" 3 4
                                            unsigned char 
# 143 "project/radare2/libr/util/charset.c"
                                                *ch, const 
...
# 144 "project/radare2/libr/util/charset.c" 3 4
do { if (!(
# 144 "project/radare2/libr/util/charset.c"
ch && hx
# 144 "project/radare2/libr/util/charset.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 144 "project/radare2/libr/util/charset.c"
"ch && hx"
# 144 "project/radare2/libr/util/charset.c" 3 4
, 144); return (((void *)0)); } } while (0)
# 144 "project/radare2/libr/util/charset.c"
                                     ;
 RCharsetRune* c = 
# 145 "project/radare2/libr/util/charset.c" 3 4
                  (
# 145 "project/radare2/libr/util/charset.c"
                  RCharsetRune
# 145 "project/radare2/libr/util/charset.c" 3 4
                  *)calloc(1,sizeof(
# 145 "project/radare2/libr/util/charset.c"
...
# 145 "project/radare2/libr/util/charset.c"
 ...
 if (!c) {
  return 
# 147 "project/radare2/libr/util/charset.c" 3 4
        ((void *)0)
# 147 "project/radare2/libr/util/charset.c"
            ;
 }
 c->ch = (
# 149 "project/radare2/libr/util/charset.c" 3 4
         unsigned char 
# 149 "project/radare2/libr/util/charset.c"
             *) strdup ((char *) ch);
 c->hx = (
# 150 "project/radare2/libr/util/charset.c" 3 4
         unsigned char 
# 150 "project/radare2/libr/util/charset.c"
             *) strdup ((char *) hx);
 c->left = 
# 151 "project/radare2/libr/util/charset.c" 3 4
          ((void *)0)
# 151 "project/radare2/libr/util/charset.c"
              ;
 c->right = 
# 152 "project/radare2/libr/util/charset.c" 3 4
           ((void *)0)
# 152 "project/radare2/libr/util/charset.c"
               ;
 return c;
}


# 156 "project/radare2/libr/util/charset.c" 3 4
__attribute__((visibility("default"))) 
# 156 "project/radare2/libr/util/charset.c"
     void r_charset_rune_free(RCharsetRune *c) {
 if (c) {
  free (c->ch);
  free (c->hx);
  free (c);
...
# 197 "project/radare2/libr/util/charset.c"

# 197 "project/radare2/libr/util/charset.c" 3 4
__attribute__((visibility("default"))) 
# 197 "project/radare2/libr/util/charset.c"
     size_t r_charset_encode_str(RCharset *rc, 
# 197 "project/radare2/libr/util/charset.c" 3 4
                                               unsigned char 
# 197 "project/radare2/libr/util/charset.c"
                                                   *out, size_t out_len, const 
# 197 "project/radare2/libr/util/charset.c" 3 4
                                                                               unsigned char 
# 197 "project/radare2/libr/util/charset.c"
                                                                                   *in, size_t in_len) {
...
# 205 "project/radare2/libr/util/charset.c" 3 4
_Bool 
# 205 "project/radare2/libr/util/charset.c"
     fine = 
# 205 "project/radare2/libr/util/charset.c" 3 4
            0
# 205 "project/radare2/libr/util/charset.c"
...
# 207 "project/radare2/libr/util/charset.c" 3 4
 unsigned char 
# 207 "project/radare2/libr/util/charset.c"
     ch_in = in[i];
  
# 208 "project/radare2/libr/util/charset.c" 3 4
 __builtin___snprintf_chk (
# 208 "project/radare2/libr/util/charset.c"
 k
# 208 "project/radare2/libr/util/charset.c" 3 4
 , 
# 208 "project/radare2/libr/util/charset.c"
...
# 208 "project/radare2/libr/util/charset.c"
  ...
  if (res) {
   ...
   fine = 
# 217 "project/radare2/libr/util/charset.c" 3 4
         1
# 217 "project/radare2/libr/util/charset.c"
             ;
   r_str_unescape (res);
...
# 231 "project/radare2/libr/util/charset.c" 3 4
__attribute__((visibility("default"))) 
# 231 "project/radare2/libr/util/charset.c"
     size_t r_charset_decode_str(RCharset *rc, 
# 231 "project/radare2/libr/util/charset.c" 3 4
                                               unsigned char 
# 231 "project/radare2/libr/util/charset.c"
                                                   *out, size_t out_len, const 
...
# 231 "project/radare2/libr/util/charset.c"
 ...
 for (cur = 0; cur < in_len; cur++) {
  ...
  size_t toread = 
# 241 "project/radare2/libr/util/charset.c" 3 4
                 (((
# 241 "project/radare2/libr/util/charset.c"
                 left + 1
# 241 "project/radare2/libr/util/charset.c" 3 4
                 )>(
# 241 "project/radare2/libr/util/charset.c"
...
# 247 "project/radare2/libr/util/charset.c" 3 4
 _Bool 
# 247 "project/radare2/libr/util/charset.c"
      found = 
# 247 "project/radare2/libr/util/charset.c" 3 4
              0
# 247 "project/radare2/libr/util/charset.c"
  ...
  for (j = toread; cur < in_len && j > 0; j--) {
   left = in_len - cur + 1;
   toread = 
# 250 "project/radare2/libr/util/charset.c" 3 4
           (((
# 250 "project/radare2/libr/util/charset.c"
           left
# 250 "project/radare2/libr/util/charset.c" 3 4
           )>(
# 250 "project/radare2/libr/util/charset.c"
...
# 262 "project/radare2/libr/util/charset.c" 3 4
   __builtin___snprintf_chk (
# 262 "project/radare2/libr/util/charset.c"
   str_hx
# 262 "project/radare2/libr/util/charset.c" 3 4
   , 
# 262 "project/radare2/libr/util/charset.c"
...
# 262 "project/radare2/libr/util/charset.c"
    ...
    const size_t ll = 
# 266 "project/radare2/libr/util/charset.c" 3 4
                     (((
# 266 "project/radare2/libr/util/charset.c"
                     left
# 266 "project/radare2/libr/util/charset.c" 3 4
                     )>(
# 266 "project/radare2/libr/util/charset.c"
...
# 266 "project/radare2/libr/util/charset.c"
    ...
    found = 
# 271 "project/radare2/libr/util/charset.c" 3 4
           1
# 271 "project/radare2/libr/util/charset.c"
               ;
    cur += j - 1;
    free (str_hx);
    break;
...
# 278 "project/radare2/libr/util/charset.c" 3 4
  __builtin___strcpy_chk (
# 278 "project/radare2/libr/util/charset.c"
  o
# 278 "project/radare2/libr/util/charset.c" 3 4
  , 
# 278 "project/radare2/libr/util/charset.c"
