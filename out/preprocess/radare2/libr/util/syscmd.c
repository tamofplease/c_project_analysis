# 0 "project/radare2/libr/util/syscmd.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/syscmd.c"
...
# 4 "project/radare2/libr/util/syscmd.c" 2
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/errno.h" 1 3 4
# 5 "project/radare2/libr/util/syscmd.c" 2
...
# 12 "project/radare2/libr/util/syscmd.c"
 ...
 const char *n = fpath;
 char *nn, *u_rwx = 
# 17 "project/radare2/libr/util/syscmd.c" 3 4
                   ((void *)0)
# 17 "project/radare2/libr/util/syscmd.c"
                       ;
 ...
 const 
# 24 "project/radare2/libr/util/syscmd.c" 3 4
      _Bool 
# 24 "project/radare2/libr/util/syscmd.c"
           isdir = r_file_is_directory (n);
 if (isdir) {
...
# 45 "project/radare2/libr/util/syscmd.c" 3 4
 unsigned int 
# 45 "project/radare2/libr/util/syscmd.c"
      ifmt = sb.st_mode & 
# 45 "project/radare2/libr/util/syscmd.c" 3 4
                          0170000
# 45 "project/radare2/libr/util/syscmd.c"
  ...
  if (sb.st_mode & 
# 53 "project/radare2/libr/util/syscmd.c" 3 4
                  0004000
# 53 "project/radare2/libr/util/syscmd.c"
                         ) {
   u_rwx[2] = (sb.st_mode & 
# 54 "project/radare2/libr/util/syscmd.c" 3 4
                           0000100
# 54 "project/radare2/libr/util/syscmd.c"
                                  ) ? 's' : 'S';
  }
  if (isdir) {
   fch = 'd';
   ...
   switch (ifmt) {
   case 
# 60 "project/radare2/libr/util/syscmd.c" 3 4
       0020000
# 60 "project/radare2/libr/util/syscmd.c"
              : fch = 'c'; break;
   case 
# 61 "project/radare2/libr/util/syscmd.c" 3 4
       0060000
# 61 "project/radare2/libr/util/syscmd.c"
              : fch = 'b'; break;
   case 
# 62 "project/radare2/libr/util/syscmd.c" 3 4
       0120000
# 62 "project/radare2/libr/util/syscmd.c"
              : fch = 'l'; break;
   case 
# 63 "project/radare2/libr/util/syscmd.c" 3 4
       0010000
# 63 "project/radare2/libr/util/syscmd.c"
              : fch = 'p'; break;


   case 
# 66 "project/radare2/libr/util/syscmd.c" 3 4
       0140000
# 66 "project/radare2/libr/util/syscmd.c"
               : fch = 's'; break;
...
# 88 "project/radare2/libr/util/syscmd.c" 3 4
                          0170000
# 88 "project/radare2/libr/util/syscmd.c"
                                ) == 
# 88 "project/radare2/libr/util/syscmd.c" 3 4
                                     0120000
# 88 "project/radare2/libr/util/syscmd.c"
...
# 91 "project/radare2/libr/util/syscmd.c" 3 4
                         0004000
# 91 "project/radare2/libr/util/syscmd.c"
                                ) {
   const char *eUID = "🔼";
   icon = eUID;
...
# 128 "project/radare2/libr/util/syscmd.c" 3 4
 fprintf(__stderrp,
# 128 "project/radare2/libr/util/syscmd.c"
 "unknown format\n"
# 128 "project/radare2/libr/util/syscmd.c" 3 4
 )
# 128 "project/radare2/libr/util/syscmd.c"
...
# 136 "project/radare2/libr/util/syscmd.c" 3 4
__attribute__((visibility("default"))) 
# 136 "project/radare2/libr/util/syscmd.c"
     char *r_syscmd_ls(const char *input, int cons_width) {
 char *res = 
# 137 "project/radare2/libr/util/syscmd.c" 3 4
            ((void *)0)
# 137 "project/radare2/libr/util/syscmd.c"
                ;
 const char *path = ".";
 char *d = 
# 139 "project/radare2/libr/util/syscmd.c" 3 4
          ((void *)0)
# 139 "project/radare2/libr/util/syscmd.c"
              ;
 char *p = 
# 140 "project/radare2/libr/util/syscmd.c" 3 4
          ((void *)0)
# 140 "project/radare2/libr/util/syscmd.c"
              ;
 char *homepath = 
# 141 "project/radare2/libr/util/syscmd.c" 3 4
                 ((void *)0)
# 141 "project/radare2/libr/util/syscmd.c"
                     ;
 char *pattern = 
# 142 "project/radare2/libr/util/syscmd.c" 3 4
                ((void *)0)
# 142 "project/radare2/libr/util/syscmd.c"
                    ;
 int printfmt = 0;
 RListIter *iter;
 char *name;
...
# 165 "project/radare2/libr/util/syscmd.c" 3 4
 fprintf(__stderrp,
# 165 "project/radare2/libr/util/syscmd.c"
 "Sandbox forbids listing directories\n"
# 165 "project/radare2/libr/util/syscmd.c" 3 4
 )
# 165 "project/radare2/libr/util/syscmd.c"
                                                  ;
  return 
# 166 "project/radare2/libr/util/syscmd.c" 3 4
        ((void *)0)
# 166 "project/radare2/libr/util/syscmd.c"
            ;
 }
 if (*input && input[0] == ' ') {
  input++;
...
# 173 "project/radare2/libr/util/syscmd.c" 3 4
  fprintf(__stderrp,
# 173 "project/radare2/libr/util/syscmd.c"
...
# 173 "project/radare2/libr/util/syscmd.c"
                                                                      ;
   return 
# 174 "project/radare2/libr/util/syscmd.c" 3 4
         ((void *)0)
# 174 "project/radare2/libr/util/syscmd.c"
             ;
  }
 ...
 if (!path || !*path) {
  ...
  if (!strncmp (path + 1, "home", 4) || !strncmp (path + 1, "HOME", 4)) {
   homepath = r_str_home ((strlen (path) > 5)? path + 6: 
# 206 "project/radare2/libr/util/syscmd.c" 3 4
                                                        ((void *)0)
# 206 "project/radare2/libr/util/syscmd.c"
                                                            );
   if (homepath) {
    path = (const char *)homepath;
   }
 ...
 if (!r_file_is_directory (path)) {
  ...
  if (p) {
   ...
   if (!d) {
    free (homepath);
    return 
# 219 "project/radare2/libr/util/syscmd.c" 3 4
          ((void *)0)
# 219 "project/radare2/libr/util/syscmd.c"
              ;
   }
   
# 221 "project/radare2/libr/util/syscmd.c" 3 4
  __builtin___memcpy_chk (
# 221 "project/radare2/libr/util/syscmd.c"
  d
# 221 "project/radare2/libr/util/syscmd.c" 3 4
  , 
# 221 "project/radare2/libr/util/syscmd.c"
...
# 232 "project/radare2/libr/util/syscmd.c" 3 4
                                               0
# 232 "project/radare2/libr/util/syscmd.c"
                                                    );
  free (homepath);
  free (pattern);
  free (d);
...
# 250 "project/radare2/libr/util/syscmd.c" 3 4
_Bool 
# 250 "project/radare2/libr/util/syscmd.c"
     needs_newline = 
# 250 "project/radare2/libr/util/syscmd.c" 3 4
                     0
# 250 "project/radare2/libr/util/syscmd.c"
...
# 252 "project/radare2/libr/util/syscmd.c" 3 4
if (
# 252 "project/radare2/libr/util/syscmd.c"
files
# 252 "project/radare2/libr/util/syscmd.c" 3 4
) for (
# 252 "project/radare2/libr/util/syscmd.c"
  ...
  if (r_str_glob (name, pattern)) {
   if (*n) {
    ...
    if (linelen > cons_width) {
     needs_newline = 
# 262 "project/radare2/libr/util/syscmd.c" 3 4
                    1
# 262 "project/radare2/libr/util/syscmd.c"
                        ;
    }
    res = showfile (res, nth, n, name, printfmt, needs_newline);
    if (needs_newline) {
     needs_newline = 
# 266 "project/radare2/libr/util/syscmd.c" 3 4
                    0
# 266 "project/radare2/libr/util/syscmd.c"
                         ;
     linelen = 0;
    }
   }
...
# 297 "project/radare2/libr/util/syscmd.c" 3 4
__attribute__((visibility("default"))) 
# 297 "project/radare2/libr/util/syscmd.c"
     char *r_syscmd_sort(const char *file) {
 const char *p = 
# 298 "project/radare2/libr/util/syscmd.c" 3 4
                ((void *)0)
# 298 "project/radare2/libr/util/syscmd.c"
                    ;
 RList *list = 
# 299 "project/radare2/libr/util/syscmd.c" 3 4
              ((void *)0)
# 299 "project/radare2/libr/util/syscmd.c"
                  ;
 if (file) {
  if ((p = strchr (file, ' '))) {
   p = p + 1;
 ...
 if (p && *p) {
  ...
  r_str_trim (filename);
  char *data = r_file_slurp (filename, 
# 310 "project/radare2/libr/util/syscmd.c" 3 4
                                      ((void *)0)
# 310 "project/radare2/libr/util/syscmd.c"
                                          );
  if (!data) {
   
# 312 "project/radare2/libr/util/syscmd.c" 3 4
  fprintf(__stderrp,
# 312 "project/radare2/libr/util/syscmd.c"
...
# 322 "project/radare2/libr/util/syscmd.c" 3 4
 fprintf(__stderrp,
# 322 "project/radare2/libr/util/syscmd.c"
 "Usage: sort [file]\n"
# 322 "project/radare2/libr/util/syscmd.c" 3 4
 )
# 322 "project/radare2/libr/util/syscmd.c"
 ...
 return 
# 324 "project/radare2/libr/util/syscmd.c" 3 4
       ((void *)0)
# 324 "project/radare2/libr/util/syscmd.c"
           ;
}


# 327 "project/radare2/libr/util/syscmd.c" 3 4
__attribute__((visibility("default"))) 
# 327 "project/radare2/libr/util/syscmd.c"
     char *r_syscmd_head(const char *file, int count) {
 const char *p = 
# 328 "project/radare2/libr/util/syscmd.c" 3 4
                ((void *)0)
# 328 "project/radare2/libr/util/syscmd.c"
                    ;
 if (file) {
  if ((p = strchr (file, ' '))) {
   p = p + 1;
...
# 341 "project/radare2/libr/util/syscmd.c" 3 4
  fprintf(__stderrp,
# 341 "project/radare2/libr/util/syscmd.c"
  "No such file or directory\n"
# 341 "project/radare2/libr/util/syscmd.c" 3 4
  )
# 341 "project/radare2/libr/util/syscmd.c"
...
# 346 "project/radare2/libr/util/syscmd.c" 3 4
 fprintf(__stderrp,
# 346 "project/radare2/libr/util/syscmd.c"
 "Usage: head 7 [file]\n"
# 346 "project/radare2/libr/util/syscmd.c" 3 4
 )
# 346 "project/radare2/libr/util/syscmd.c"
 ...
 return 
# 348 "project/radare2/libr/util/syscmd.c" 3 4
       ((void *)0)
# 348 "project/radare2/libr/util/syscmd.c"
           ;
}


# 351 "project/radare2/libr/util/syscmd.c" 3 4
__attribute__((visibility("default"))) 
# 351 "project/radare2/libr/util/syscmd.c"
     char *r_syscmd_tail(const char *file, int count) {
 const char *p = 
# 352 "project/radare2/libr/util/syscmd.c" 3 4
                ((void *)0)
# 352 "project/radare2/libr/util/syscmd.c"
                    ;
 if (file) {
  if ((p = strchr (file, ' '))) {
   p = p + 1;
...
# 365 "project/radare2/libr/util/syscmd.c" 3 4
  fprintf(__stderrp,
# 365 "project/radare2/libr/util/syscmd.c"
  "No such file or directory\n"
# 365 "project/radare2/libr/util/syscmd.c" 3 4
  )
# 365 "project/radare2/libr/util/syscmd.c"
...
# 370 "project/radare2/libr/util/syscmd.c" 3 4
 fprintf(__stderrp,
# 370 "project/radare2/libr/util/syscmd.c"
 "Usage: tail 7 [file]\n"
# 370 "project/radare2/libr/util/syscmd.c" 3 4
 )
# 370 "project/radare2/libr/util/syscmd.c"
 ...
 return 
# 372 "project/radare2/libr/util/syscmd.c" 3 4
       ((void *)0)
# 372 "project/radare2/libr/util/syscmd.c"
           ;
}


# 375 "project/radare2/libr/util/syscmd.c" 3 4
__attribute__((visibility("default"))) 
# 375 "project/radare2/libr/util/syscmd.c"
     char *r_syscmd_uniq(const char *file) {
 const char *p = 
# 376 "project/radare2/libr/util/syscmd.c" 3 4
                ((void *)0)
# 376 "project/radare2/libr/util/syscmd.c"
                    ;
 RList *list = 
# 377 "project/radare2/libr/util/syscmd.c" 3 4
              ((void *)0)
# 377 "project/radare2/libr/util/syscmd.c"
                  ;
 if (file) {
  if ((p = strchr (file, ' '))) {
   p = p + 1;
 ...
 if (p && *p) {
  ...
  r_str_trim (filename);
  char *data = r_file_slurp (filename, 
# 388 "project/radare2/libr/util/syscmd.c" 3 4
                                      ((void *)0)
# 388 "project/radare2/libr/util/syscmd.c"
                                          );
  if (!data) {
   
# 390 "project/radare2/libr/util/syscmd.c" 3 4
  fprintf(__stderrp,
# 390 "project/radare2/libr/util/syscmd.c"
  "No such file or directory\n"
# 390 "project/radare2/libr/util/syscmd.c" 3 4
  )
# 390 "project/radare2/libr/util/syscmd.c"
...
# 401 "project/radare2/libr/util/syscmd.c" 3 4
 fprintf(__stderrp,
# 401 "project/radare2/libr/util/syscmd.c"
 "Usage: uniq [file]\n"
# 401 "project/radare2/libr/util/syscmd.c" 3 4
 )
# 401 "project/radare2/libr/util/syscmd.c"
 ...
 return 
# 403 "project/radare2/libr/util/syscmd.c" 3 4
       ((void *)0)
# 403 "project/radare2/libr/util/syscmd.c"
           ;
}


# 406 "project/radare2/libr/util/syscmd.c" 3 4
__attribute__((visibility("default"))) 
# 406 "project/radare2/libr/util/syscmd.c"
     char *r_syscmd_join(const char *file1, const char *file2) {
 const char *p1 = 
# 407 "project/radare2/libr/util/syscmd.c" 3 4
                 ((void *)0)
# 407 "project/radare2/libr/util/syscmd.c"
                     , *p2 = 
# 407 "project/radare2/libr/util/syscmd.c" 3 4
                             ((void *)0)
# 407 "project/radare2/libr/util/syscmd.c"
                                 ;
 RList *list1, *list2, *list = r_list_newf (
# 408 "project/radare2/libr/util/syscmd.c" 3 4
                                           ((void *)0)
# 408 "project/radare2/libr/util/syscmd.c"
                                               );
 if (!list) {
  return 
# 410 "project/radare2/libr/util/syscmd.c" 3 4
        ((void *)0)
# 410 "project/radare2/libr/util/syscmd.c"
            ;
 }
 if (file1) {
  if ((p1 = strchr (file1, ' '))) {
 ...
 if (p1 && *p1 && p2 && *p2 ) {
  ...
  char *data1 = r_file_slurp (filename1, 
# 431 "project/radare2/libr/util/syscmd.c" 3 4
                                        ((void *)0)
# 431 "project/radare2/libr/util/syscmd.c"
                                            );
  char *data2 = r_file_slurp (filename2, 
# 432 "project/radare2/libr/util/syscmd.c" 3 4
                                        ((void *)0)
# 432 "project/radare2/libr/util/syscmd.c"
                                            );
  char *data = 
# 433 "project/radare2/libr/util/syscmd.c" 3 4
              ((void *)0)
# 433 "project/radare2/libr/util/syscmd.c"
                  ;
  RListIter *iter1, *iter2;
  if (!data1 && !data2) {
   
# 436 "project/radare2/libr/util/syscmd.c" 3 4
  fprintf(__stderrp,
# 436 "project/radare2/libr/util/syscmd.c"
...
# 442 "project/radare2/libr/util/syscmd.c" 3 4
  if (
# 442 "project/radare2/libr/util/syscmd.c"
  list1
# 442 "project/radare2/libr/util/syscmd.c" 3 4
  ) for (
# 442 "project/radare2/libr/util/syscmd.c"
...
# 451 "project/radare2/libr/util/syscmd.c" 3 4
   if (
# 451 "project/radare2/libr/util/syscmd.c"
   list2
# 451 "project/radare2/libr/util/syscmd.c" 3 4
   ) for (
# 451 "project/radare2/libr/util/syscmd.c"
...
# 472 "project/radare2/libr/util/syscmd.c" 3 4
 fprintf(__stderrp,
# 472 "project/radare2/libr/util/syscmd.c"
...
# 472 "project/radare2/libr/util/syscmd.c"
 ...
 return 
# 474 "project/radare2/libr/util/syscmd.c" 3 4
       ((void *)0)
# 474 "project/radare2/libr/util/syscmd.c"
           ;
}


# 477 "project/radare2/libr/util/syscmd.c" 3 4
__attribute__((visibility("default"))) 
# 477 "project/radare2/libr/util/syscmd.c"
     char *r_syscmd_cat(const char *file) {
 const char *p = 
# 478 "project/radare2/libr/util/syscmd.c" 3 4
                ((void *)0)
# 478 "project/radare2/libr/util/syscmd.c"
                    ;
 if (file) {
  if ((p = strchr (file, ' '))) {
   p = p + 1;
 ...
 if (p && *p) {
  ...
  r_str_trim (filename);
  char *data = r_file_slurp (filename, 
# 489 "project/radare2/libr/util/syscmd.c" 3 4
                                      ((void *)0)
# 489 "project/radare2/libr/util/syscmd.c"
                                          );
  if (!data) {
   
# 491 "project/radare2/libr/util/syscmd.c" 3 4
  fprintf(__stderrp,
# 491 "project/radare2/libr/util/syscmd.c"
  "No such file or directory\n"
# 491 "project/radare2/libr/util/syscmd.c" 3 4
  )
# 491 "project/radare2/libr/util/syscmd.c"
...
# 496 "project/radare2/libr/util/syscmd.c" 3 4
 fprintf(__stderrp,
# 496 "project/radare2/libr/util/syscmd.c"
 "Usage: cat [file]\n"
# 496 "project/radare2/libr/util/syscmd.c" 3 4
 )
# 496 "project/radare2/libr/util/syscmd.c"
 ...
 return 
# 498 "project/radare2/libr/util/syscmd.c" 3 4
       ((void *)0)
# 498 "project/radare2/libr/util/syscmd.c"
           ;
}


# 501 "project/radare2/libr/util/syscmd.c" 3 4
__attribute__((visibility("default"))) 
# 501 "project/radare2/libr/util/syscmd.c"
     char *r_syscmd_mkdir(const char *dir) {
 const char *suffix = r_str_trim_head_ro (strchr (dir, ' '));
 if (!suffix || !strncmp (suffix, "-p", 3)) {
  return r_str_dup (
# 504 "project/radare2/libr/util/syscmd.c" 3 4
                   ((void *)0)
# 504 "project/radare2/libr/util/syscmd.c"
 ...
 if (!ret) {
  if (
# 512 "project/radare2/libr/util/syscmd.c" 3 4
     ((*__error()) != 17)
# 512 "project/radare2/libr/util/syscmd.c"
                          ) {
 ...
 free (dirname);
 return 
# 519 "project/radare2/libr/util/syscmd.c" 3 4
       ((void *)0)
# 519 "project/radare2/libr/util/syscmd.c"
           ;
}


# 522 "project/radare2/libr/util/syscmd.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 522 "project/radare2/libr/util/syscmd.c"
          r_syscmd_mv(const char *input) {
 if (strlen (input) < 3) {
  
# 524 "project/radare2/libr/util/syscmd.c" 3 4
 fprintf(__stderrp,
# 524 "project/radare2/libr/util/syscmd.c"
 "Usage: mv src dst\n"
# 524 "project/radare2/libr/util/syscmd.c" 3 4
 )
# 524 "project/radare2/libr/util/syscmd.c"
                                ;
  return 
# 525 "project/radare2/libr/util/syscmd.c" 3 4
        0
# 525 "project/radare2/libr/util/syscmd.c"
             ;
 }
 char *inp = strdup (input + 2);
 char *arg = strchr (inp, ' ');
 
# 529 "project/radare2/libr/util/syscmd.c" 3 4
_Bool 
# 529 "project/radare2/libr/util/syscmd.c"
     rc = 
# 529 "project/radare2/libr/util/syscmd.c" 3 4
          0
# 529 "project/radare2/libr/util/syscmd.c"
...
# 533 "project/radare2/libr/util/syscmd.c" 3 4
  fprintf(__stderrp,
# 533 "project/radare2/libr/util/syscmd.c"
  "Cannot move file\n"
# 533 "project/radare2/libr/util/syscmd.c" 3 4
  )
# 533 "project/radare2/libr/util/syscmd.c"
...
# 536 "project/radare2/libr/util/syscmd.c" 3 4
 fprintf(__stderrp,
# 536 "project/radare2/libr/util/syscmd.c"
 "Usage: mv src dst\n"
# 536 "project/radare2/libr/util/syscmd.c" 3 4
 )
# 536 "project/radare2/libr/util/syscmd.c"
