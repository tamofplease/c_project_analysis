# 0 "project/radare2/libr/util/cache.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/cache.c"
...
# 6 "project/radare2/libr/util/cache.c" 2


__attribute__((visibility("default"))) 
# 8 "project/radare2/libr/util/cache.c"
     RCache *r_cache_new(void) {
 RCache *c = 
# 9 "project/radare2/libr/util/cache.c" 3 4
            (
# 9 "project/radare2/libr/util/cache.c"
            RCache
# 9 "project/radare2/libr/util/cache.c" 3 4
            *)calloc(1,sizeof(
# 9 "project/radare2/libr/util/cache.c"
...
# 9 "project/radare2/libr/util/cache.c"
 ...
 if (!c) {
  return 
# 11 "project/radare2/libr/util/cache.c" 3 4
        ((void *)0)
# 11 "project/radare2/libr/util/cache.c"
            ;
 }
 c->buf = 
# 13 "project/radare2/libr/util/cache.c" 3 4
         ((void *)0)
# 13 "project/radare2/libr/util/cache.c"
             ;
 c->base = 0;
 c->len = 0;
 return c;
...
# 19 "project/radare2/libr/util/cache.c" 3 4
__attribute__((visibility("default"))) 
# 19 "project/radare2/libr/util/cache.c"
     void r_cache_free(RCache *c) {
 if (c) {
  free (c->buf);
 }
 free (c);
...
# 26 "project/radare2/libr/util/cache.c" 3 4
__attribute__((visibility("default"))) 
# 26 "project/radare2/libr/util/cache.c"
     const 
# 26 "project/radare2/libr/util/cache.c" 3 4
           unsigned char 
# 26 "project/radare2/libr/util/cache.c"
               *r_cache_get(RCache *c, 
# 26 "project/radare2/libr/util/cache.c" 3 4
                                       unsigned long long 
# 26 "project/radare2/libr/util/cache.c"
                                            addr, int *len) {
 if (!c->buf) {
  return 
# 28 "project/radare2/libr/util/cache.c" 3 4
        ((void *)0)
# 28 "project/radare2/libr/util/cache.c"
            ;
 }
 if (len) {
  *len = c->base - addr;
 ...
 if (addr < c->base) {
  return 
# 34 "project/radare2/libr/util/cache.c" 3 4
        ((void *)0)
# 34 "project/radare2/libr/util/cache.c"
            ;
 }
 if (addr > (c->base + c->len)) {
  return 
# 37 "project/radare2/libr/util/cache.c" 3 4
        ((void *)0)
# 37 "project/radare2/libr/util/cache.c"
            ;
 }
 if (len) {
...
# 46 "project/radare2/libr/util/cache.c" 3 4
__attribute__((visibility("default"))) 
# 46 "project/radare2/libr/util/cache.c"
     int r_cache_set(RCache *c, 
# 46 "project/radare2/libr/util/cache.c" 3 4
                                unsigned long long 
# 46 "project/radare2/libr/util/cache.c"
                                     addr, const 
...
# 55 "project/radare2/libr/util/cache.c" 3 4
 __builtin___memcpy_chk (
# 55 "project/radare2/libr/util/cache.c"
 c->buf
# 55 "project/radare2/libr/util/cache.c" 3 4
 , 
# 55 "project/radare2/libr/util/cache.c"
...
# 59 "project/radare2/libr/util/cache.c" 3 4
 unsigned char 
# 59 "project/radare2/libr/util/cache.c"
     *b;
...
# 67 "project/radare2/libr/util/cache.c" 3 4
 __builtin___memset_chk (
# 67 "project/radare2/libr/util/cache.c"
 b
# 67 "project/radare2/libr/util/cache.c" 3 4
 , 
# 67 "project/radare2/libr/util/cache.c"
...
# 68 "project/radare2/libr/util/cache.c" 3 4
 __builtin___memcpy_chk (
# 68 "project/radare2/libr/util/cache.c"
 b + baselen
# 68 "project/radare2/libr/util/cache.c" 3 4
 , 
# 68 "project/radare2/libr/util/cache.c"
...
# 69 "project/radare2/libr/util/cache.c" 3 4
 __builtin___memcpy_chk (
# 69 "project/radare2/libr/util/cache.c"
 b
# 69 "project/radare2/libr/util/cache.c" 3 4
 , 
# 69 "project/radare2/libr/util/cache.c"
...
# 75 "project/radare2/libr/util/cache.c" 3 4
 unsigned char 
# 75 "project/radare2/libr/util/cache.c"
     *b;
...
# 82 "project/radare2/libr/util/cache.c" 3 4
 __builtin___memcpy_chk (
# 82 "project/radare2/libr/util/cache.c"
 b + baselen
# 82 "project/radare2/libr/util/cache.c" 3 4
 , 
# 82 "project/radare2/libr/util/cache.c"
...
# 86 "project/radare2/libr/util/cache.c" 3 4
 __builtin___memcpy_chk (
# 86 "project/radare2/libr/util/cache.c"
 c->buf
# 86 "project/radare2/libr/util/cache.c" 3 4
 , 
# 86 "project/radare2/libr/util/cache.c"
...
# 91 "project/radare2/libr/util/cache.c" 3 4
__attribute__((visibility("default"))) 
# 91 "project/radare2/libr/util/cache.c"
     void r_cache_flush(RCache *c) {
 if (c) {
  c->base = 0;
  c->len = 0;
  
# 95 "project/radare2/libr/util/cache.c" 3 4
 { free((void *)
# 95 "project/radare2/libr/util/cache.c"
 c->buf
# 95 "project/radare2/libr/util/cache.c" 3 4
 ); 
# 95 "project/radare2/libr/util/cache.c"
