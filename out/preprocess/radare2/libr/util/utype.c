# 0 "project/radare2/libr/util/utype.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/utype.c"
...
# 4 "project/radare2/libr/util/utype.c" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/util/utype.c"
     int r_type_set(Sdb *TDB, 
# 5 "project/radare2/libr/util/utype.c" 3 4
                              unsigned long long 
# 5 "project/radare2/libr/util/utype.c"
                                   at, const char *field, 
# 5 "project/radare2/libr/util/utype.c" 3 4
...
# 8 "project/radare2/libr/util/utype.c" 3 4
__builtin___sprintf_chk (
# 8 "project/radare2/libr/util/utype.c"
var
# 8 "project/radare2/libr/util/utype.c" 3 4
...
# 8 "project/radare2/libr/util/utype.c"
                                    ;
 kind = sdb_const_get (TDB, var, 
# 9 "project/radare2/libr/util/utype.c" 3 4
                                ((void *)0)
# 9 "project/radare2/libr/util/utype.c"
                                    );
 if (kind) {
  const char *p = sdb_const_get (TDB, kind, 
# 11 "project/radare2/libr/util/utype.c" 3 4
                                           ((void *)0)
# 11 "project/radare2/libr/util/utype.c"
                                               );
  if (p) {
   
# 13 "project/radare2/libr/util/utype.c" 3 4
  __builtin___snprintf_chk (
# 13 "project/radare2/libr/util/utype.c"
  var
# 13 "project/radare2/libr/util/utype.c" 3 4
  , 
# 13 "project/radare2/libr/util/utype.c"
...
# 13 "project/radare2/libr/util/utype.c"
                                                          ;
   int off = sdb_array_get_num (TDB, var, 1, 
# 14 "project/radare2/libr/util/utype.c" 3 4
                                            ((void *)0)
# 14 "project/radare2/libr/util/utype.c"
                                                );

   
# 16 "project/radare2/libr/util/utype.c" 3 4
  fprintf(__stderrp,
# 16 "project/radare2/libr/util/utype.c"
  "wv 0x%08"
# 16 "project/radare2/libr/util/utype.c" 3 4
  "llx"
# 16 "project/radare2/libr/util/utype.c"
...
# 16 "project/radare2/libr/util/utype.c"
                                                             ;
   return 
# 17 "project/radare2/libr/util/utype.c" 3 4
         1
# 17 "project/radare2/libr/util/utype.c"
             ;
  }
  
# 19 "project/radare2/libr/util/utype.c" 3 4
 fprintf(__stderrp,
# 19 "project/radare2/libr/util/utype.c"
...
# 19 "project/radare2/libr/util/utype.c"
 ...
 return 
# 21 "project/radare2/libr/util/utype.c" 3 4
       0
# 21 "project/radare2/libr/util/utype.c"
            ;
}


# 24 "project/radare2/libr/util/utype.c" 3 4
__attribute__((visibility("default"))) 
# 24 "project/radare2/libr/util/utype.c"
     int r_type_kind(Sdb *TDB, const char *name) {
 if (!name) {
  return -1;
 }
...
# 50 "project/radare2/libr/util/utype.c" 3 4
__attribute__((visibility("default"))) 
# 50 "project/radare2/libr/util/utype.c"
     RList* r_type_get_enum (Sdb *TDB, const char *name) {
 char *p, var[130];
 int n;

 if (r_type_kind (TDB, name) != R_TYPE_ENUM) {
  return 
# 55 "project/radare2/libr/util/utype.c" 3 4
        ((void *)0)
# 55 "project/radare2/libr/util/utype.c"
            ;
 }
 RList *res = r_list_new ();
 
# 58 "project/radare2/libr/util/utype.c" 3 4
__builtin___snprintf_chk (
# 58 "project/radare2/libr/util/utype.c"
var
# 58 "project/radare2/libr/util/utype.c" 3 4
, 
# 58 "project/radare2/libr/util/utype.c"
...
# 58 "project/radare2/libr/util/utype.c"
                                             ;
 for (n = 0; (p = sdb_array_get (TDB, var, n, 
# 59 "project/radare2/libr/util/utype.c" 3 4
                                             ((void *)0)
# 59 "project/radare2/libr/util/utype.c"
                                                 )); n++) {
  RTypeEnum *member = 
# 60 "project/radare2/libr/util/utype.c" 3 4
                     (
# 60 "project/radare2/libr/util/utype.c"
                     RTypeEnum
# 60 "project/radare2/libr/util/utype.c" 3 4
                     *)calloc(1,sizeof(
# 60 "project/radare2/libr/util/utype.c"
...
# 60 "project/radare2/libr/util/utype.c"
  ...
  if (member) {
   ...
   if (var2) {
    char *val = sdb_array_get (TDB, var2, 0, 
# 64 "project/radare2/libr/util/utype.c" 3 4
                                            ((void *)0)
# 64 "project/radare2/libr/util/utype.c"
                                                );
    if (val) {
     member->name = p;
     member->val = val;
...
# 81 "project/radare2/libr/util/utype.c" 3 4
__attribute__((visibility("default"))) 
# 81 "project/radare2/libr/util/utype.c"
     char *r_type_enum_member(Sdb *TDB, const char *name, const char *member, 
# 81 "project/radare2/libr/util/utype.c" 3 4
                                                                              unsigned long long 
# 81 "project/radare2/libr/util/utype.c"
                                                                                   val) {
 if (r_type_kind (TDB, name) != R_TYPE_ENUM) {
  return 
# 83 "project/radare2/libr/util/utype.c" 3 4
        ((void *)0)
# 83 "project/radare2/libr/util/utype.c"
            ;
 }
 const char *q = member
  ? sdb_fmt ("enum.%s.%s", name, member)
  : sdb_fmt ("enum.%s.0x%"
# 87 "project/radare2/libr/util/utype.c" 3 4
                         "llx"
# 87 "project/radare2/libr/util/utype.c"
                                , name, val);
 return sdb_get (TDB, q, 0);
}


# 91 "project/radare2/libr/util/utype.c" 3 4
__attribute__((visibility("default"))) 
# 91 "project/radare2/libr/util/utype.c"
     char *r_type_enum_getbitfield(Sdb *TDB, const char *name, 
# 91 "project/radare2/libr/util/utype.c" 3 4
                                                               unsigned long long 
# 91 "project/radare2/libr/util/utype.c"
                                                                    val) {
 char *q, *ret = 
# 92 "project/radare2/libr/util/utype.c" 3 4
                ((void *)0)
# 92 "project/radare2/libr/util/utype.c"
                    ;
 const char *res;
 int i;
 ...
 if (r_type_kind (TDB, name) != R_TYPE_ENUM) {
  return 
# 97 "project/radare2/libr/util/utype.c" 3 4
        ((void *)0)
# 97 "project/radare2/libr/util/utype.c"
            ;
 }
 
# 99 "project/radare2/libr/util/utype.c" 3 4
_Bool 
# 99 "project/radare2/libr/util/utype.c"
     isFirst = 
# 99 "project/radare2/libr/util/utype.c" 3 4
               1
# 99 "project/radare2/libr/util/utype.c"
                   ;
 ret = r_str_appendf (ret, "0x%08"
# 100 "project/radare2/libr/util/utype.c" 3 4
                                 "llx"
# 100 "project/radare2/libr/util/utype.c"
                                        " : ", val);
 for (i = 0; i < 32; i++) {
  
# 102 "project/radare2/libr/util/utype.c" 3 4
 unsigned int 
# 102 "project/radare2/libr/util/utype.c"
      n = 1ULL << i;
  if (!(val & n)) {
   continue;
  }
  ...
  if (isFirst) {
   isFirst = 
# 109 "project/radare2/libr/util/utype.c" 3 4
            0
# 109 "project/radare2/libr/util/utype.c"
                 ;
  } else {
...
# 122 "project/radare2/libr/util/utype.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 122 "project/radare2/libr/util/utype.c"
          r_type_get_bitsize(Sdb *TDB, const char *type) {
 char *query;
...
# 146 "project/radare2/libr/util/utype.c" 3 4
 unsigned long long 
# 146 "project/radare2/libr/util/utype.c"
      r = sdb_num_get (TDB, query, 0);
  free (query);
  return r;
 }
...
# 154 "project/radare2/libr/util/utype.c" 3 4
 unsigned long long 
# 154 "project/radare2/libr/util/utype.c"
      ret = 0;
  if (members) {
   do {
...
# 164 "project/radare2/libr/util/utype.c" 3 4
   { free((void *)
# 164 "project/radare2/libr/util/utype.c"
   query
# 164 "project/radare2/libr/util/utype.c" 3 4
   ); 
# 164 "project/radare2/libr/util/utype.c"
...
# 164 "project/radare2/libr/util/utype.c"
     ...
     *tmp++ = 0;
     ...
     int elements = r_num_math (
# 175 "project/radare2/libr/util/utype.c" 3 4
                               ((void *)0)
# 175 "project/radare2/libr/util/utype.c"
                                   , tmp);
     if (elements == 0) {
      elements = 1;
     }
...
# 182 "project/radare2/libr/util/utype.c" 3 4
     unsigned long long 
# 182 "project/radare2/libr/util/utype.c"
          sz = r_type_get_bitsize (TDB, subtype) * elements;
      ret = sz > ret ? sz : ret;
     }
    }
    free (subtype);
...
# 197 "project/radare2/libr/util/utype.c" 3 4
__attribute__((visibility("default"))) 
# 197 "project/radare2/libr/util/utype.c"
     char *r_type_get_struct_memb(Sdb *TDB, const char *type, int offset) {
 int i, cur_offset, next_offset = 0;
 char *res = 
# 199 "project/radare2/libr/util/utype.c" 3 4
            ((void *)0)
# 199 "project/radare2/libr/util/utype.c"
                ;

 if (offset < 0) {
  return 
# 202 "project/radare2/libr/util/utype.c" 3 4
        ((void *)0)
# 202 "project/radare2/libr/util/utype.c"
            ;
 }
 ...
 if (!members) {
  ...
  return 
# 208 "project/radare2/libr/util/utype.c" 3 4
        ((void *)0)
# 208 "project/radare2/libr/util/utype.c"
            ;
 }
 ...
 for (i = 0; i < nargs ; i++) {
  ...
  cur_offset = r_num_math (
# 226 "project/radare2/libr/util/utype.c" 3 4
                          ((void *)0)
# 226 "project/radare2/libr/util/utype.c"
                              , r_str_word_get0 (subtype, len - 2));
  ...
  int arrsz = r_num_math (
# 239 "project/radare2/libr/util/utype.c" 3 4
                         ((void *)0)
# 239 "project/radare2/libr/util/utype.c"
                             , r_str_word_get0 (subtype, len - 1));
...
# 273 "project/radare2/libr/util/utype.c" 3 4
__attribute__((visibility("default"))) 
# 273 "project/radare2/libr/util/utype.c"
     RList* r_type_get_by_offset(Sdb *TDB, 
# 273 "project/radare2/libr/util/utype.c" 3 4
                                           unsigned long long 
# 273 "project/radare2/libr/util/utype.c"
                                                offset) {
 RList *offtypes = r_list_new ();
 SdbList *ls = sdb_foreach_list (TDB, 
# 275 "project/radare2/libr/util/utype.c" 3 4
                                     1
# 275 "project/radare2/libr/util/utype.c"
                                         );
 SdbListIter *lsi;
 SdbKv *kv;
 
# 278 "project/radare2/libr/util/utype.c" 3 4
if ((
# 278 "project/radare2/libr/util/utype.c"
ls
# 278 "project/radare2/libr/util/utype.c" 3 4
)) for (
# 278 "project/radare2/libr/util/utype.c"
...
static RList *types_range_list(Sdb *db, 
# 294 "project/radare2/libr/util/utype.c" 3 4
                                       unsigned long long 
# 294 "project/radare2/libr/util/utype.c"
                                            addr) {
 RList *list = 
# 295 "project/radare2/libr/util/utype.c" 3 4
              ((void *)0)
# 295 "project/radare2/libr/util/utype.c"
                  ;
 
# 296 "project/radare2/libr/util/utype.c" 3 4
unsigned long long 
# 296 "project/radare2/libr/util/utype.c"
     base = ((addr)>>16);
 char *s = r_str_newf ("range.%"
# 297 "project/radare2/libr/util/utype.c" 3 4
                               "llx"
# 297 "project/radare2/libr/util/utype.c"
                                      , base);
 if (s) {
...
static void types_range_del(Sdb *db, 
# 308 "project/radare2/libr/util/utype.c" 3 4
                                    unsigned long long 
# 308 "project/radare2/libr/util/utype.c"
                                         addr) {
 
# 309 "project/radare2/libr/util/utype.c" 3 4
unsigned long long 
# 309 "project/radare2/libr/util/utype.c"
     base = ((addr)>>16);
 const char *k = sdb_fmt ("range.%"
# 310 "project/radare2/libr/util/utype.c" 3 4
                                  "llx"
# 310 "project/radare2/libr/util/utype.c"
                                         , base);
 char valstr[
# 311 "project/radare2/libr/util/utype.c" 3 4
            64
# 311 "project/radare2/libr/util/utype.c"
                         ];
 const char *v = sdb_itoa (addr, valstr, 
# 312 "project/radare2/libr/util/utype.c" 3 4
                                        16
# 312 "project/radare2/libr/util/utype.c"
                                                    );
 sdb_array_remove (db, k, v, 0);
}

static void types_range_add(Sdb *db, 
# 316 "project/radare2/libr/util/utype.c" 3 4
                                    unsigned long long 
# 316 "project/radare2/libr/util/utype.c"
                                         addr) {
 
# 317 "project/radare2/libr/util/utype.c" 3 4
unsigned long long 
# 317 "project/radare2/libr/util/utype.c"
     base = ((addr)>>16);
 const char *k = sdb_fmt ("range.%"
# 318 "project/radare2/libr/util/utype.c" 3 4
                                  "llx"
# 318 "project/radare2/libr/util/utype.c"
                                         , base);
 (void)sdb_array_add_num (db, k, addr, 0);
}


# 322 "project/radare2/libr/util/utype.c" 3 4
__attribute__((visibility("default"))) 
# 322 "project/radare2/libr/util/utype.c"
     char *r_type_link_at(Sdb *TDB, 
# 322 "project/radare2/libr/util/utype.c" 3 4
                                    unsigned long long 
# 322 "project/radare2/libr/util/utype.c"
                                         addr) {
 if (addr == 
# 323 "project/radare2/libr/util/utype.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 323 "project/radare2/libr/util/utype.c"
                    ) {
  return 
# 324 "project/radare2/libr/util/utype.c" 3 4
        ((void *)0)
# 324 "project/radare2/libr/util/utype.c"
            ;
 }
 const char *query = sdb_fmt ("link.%08"
# 326 "project/radare2/libr/util/utype.c" 3 4
                                       "llx"
# 326 "project/radare2/libr/util/utype.c"
                                              , addr);
...
# 332 "project/radare2/libr/util/utype.c" 3 4
 if (
# 332 "project/radare2/libr/util/utype.c"
 list
# 332 "project/radare2/libr/util/utype.c" 3 4
 ) for (
# 332 "project/radare2/libr/util/utype.c"
...
# 333 "project/radare2/libr/util/utype.c" 3 4
  unsigned long long 
# 333 "project/radare2/libr/util/utype.c"
       laddr = r_num_get (
# 333 "project/radare2/libr/util/utype.c" 3 4
                          ((void *)0)
# 333 "project/radare2/libr/util/utype.c"
   ...
   if (addr > laddr) {
    ...
    const char *lk = sdb_fmt ("link.%08"
# 336 "project/radare2/libr/util/utype.c" 3 4
                                       "llx"
# 336 "project/radare2/libr/util/utype.c"
                                              , laddr);
...
# 349 "project/radare2/libr/util/utype.c" 3 4
__attribute__((visibility("default"))) 
# 349 "project/radare2/libr/util/utype.c"
     int r_type_set_link(Sdb *TDB, const char *type, 
# 349 "project/radare2/libr/util/utype.c" 3 4
                                                     unsigned long long 
# 349 "project/radare2/libr/util/utype.c"
                                                          addr) {
 if (sdb_const_get (TDB, type, 0)) {
  char *laddr = r_str_newf ("link.%08"
# 351 "project/radare2/libr/util/utype.c" 3 4
                                     "llx"
# 351 "project/radare2/libr/util/utype.c"
                                            , addr);
  sdb_set (TDB, laddr, type, 0);
  types_range_add (TDB, addr);
  free (laddr);
  return 
# 355 "project/radare2/libr/util/utype.c" 3 4
        1
# 355 "project/radare2/libr/util/utype.c"
            ;
 }
 return 
# 357 "project/radare2/libr/util/utype.c" 3 4
       0
# 357 "project/radare2/libr/util/utype.c"
            ;
}


# 360 "project/radare2/libr/util/utype.c" 3 4
__attribute__((visibility("default"))) 
# 360 "project/radare2/libr/util/utype.c"
     int r_type_link_offset(Sdb *TDB, const char *type, 
# 360 "project/radare2/libr/util/utype.c" 3 4
                                                        unsigned long long 
# 360 "project/radare2/libr/util/utype.c"
                                                             addr) {
 if (sdb_const_get (TDB, type, 0)) {
  char *laddr = r_str_newf ("offset.%08"
# 362 "project/radare2/libr/util/utype.c" 3 4
                                       "llx"
# 362 "project/radare2/libr/util/utype.c"
                                              , addr);
  sdb_set (TDB, laddr, type, 0);
  free (laddr);
  return 
# 365 "project/radare2/libr/util/utype.c" 3 4
        1
# 365 "project/radare2/libr/util/utype.c"
            ;
 }
 return 
# 367 "project/radare2/libr/util/utype.c" 3 4
       0
# 367 "project/radare2/libr/util/utype.c"
            ;
}


# 370 "project/radare2/libr/util/utype.c" 3 4
__attribute__((visibility("default"))) 
# 370 "project/radare2/libr/util/utype.c"
     int r_type_unlink(Sdb *TDB, 
# 370 "project/radare2/libr/util/utype.c" 3 4
                                 unsigned long long 
# 370 "project/radare2/libr/util/utype.c"
                                      addr) {
 char *laddr = sdb_fmt ("link.%08"
# 371 "project/radare2/libr/util/utype.c" 3 4
                                 "llx"
# 371 "project/radare2/libr/util/utype.c"
                                        , addr);
 sdb_unset (TDB, laddr, 0);
 types_range_del (TDB, addr);
 return 
# 374 "project/radare2/libr/util/utype.c" 3 4
       1
# 374 "project/radare2/libr/util/utype.c"
           ;
}

static char *fmt_struct_union(Sdb *TDB, char *var, 
# 377 "project/radare2/libr/util/utype.c" 3 4
                                                  _Bool 
# 377 "project/radare2/libr/util/utype.c"
                                                       is_typedef) {

 char *p = 
# 379 "project/radare2/libr/util/utype.c" 3 4
          ((void *)0)
# 379 "project/radare2/libr/util/utype.c"
              , *vars = 
# 379 "project/radare2/libr/util/utype.c" 3 4
                        ((void *)0)
# 379 "project/radare2/libr/util/utype.c"
...
# 379 "project/radare2/libr/util/utype.c"
 ...
 for (n = 0; (p = sdb_array_get (TDB, nfields, n, 
# 383 "project/radare2/libr/util/utype.c" 3 4
                                                 ((void *)0)
# 383 "project/radare2/libr/util/utype.c"
                                                     )); n++) {
  char *struct_name = 
# 384 "project/radare2/libr/util/utype.c" 3 4
                     ((void *)0)
# 384 "project/radare2/libr/util/utype.c"
                         ;
  const char *tfmt = 
# 385 "project/radare2/libr/util/utype.c" 3 4
                    ((void *)0)
# 385 "project/radare2/libr/util/utype.c"
                        ;
  
# 386 "project/radare2/libr/util/utype.c" 3 4
 _Bool 
# 386 "project/radare2/libr/util/utype.c"
      isStruct = 
# 386 "project/radare2/libr/util/utype.c" 3 4
                 0
# 386 "project/radare2/libr/util/utype.c"
...
# 387 "project/radare2/libr/util/utype.c" 3 4
 _Bool 
# 387 "project/radare2/libr/util/utype.c"
      isEnum = 
# 387 "project/radare2/libr/util/utype.c" 3 4
               0
# 387 "project/radare2/libr/util/utype.c"
...
# 388 "project/radare2/libr/util/utype.c" 3 4
 _Bool 
# 388 "project/radare2/libr/util/utype.c"
      isfp = 
# 388 "project/radare2/libr/util/utype.c" 3 4
             0
# 388 "project/radare2/libr/util/utype.c"
...
# 389 "project/radare2/libr/util/utype.c" 3 4
 __builtin___snprintf_chk (
# 389 "project/radare2/libr/util/utype.c"
 var2
# 389 "project/radare2/libr/util/utype.c" 3 4
 , 
# 389 "project/radare2/libr/util/utype.c"
...
# 389 "project/radare2/libr/util/utype.c"
  ...
  int elements = sdb_array_get_num (TDB, var2, alen - 1, 
# 391 "project/radare2/libr/util/utype.c" 3 4
                                                        ((void *)0)
# 391 "project/radare2/libr/util/utype.c"
                                                            );
  char *type = sdb_array_get (TDB, var2, 0, 
# 392 "project/radare2/libr/util/utype.c" 3 4
                                           ((void *)0)
# 392 "project/radare2/libr/util/utype.c"
                                               );
  if (type) {
   char var3[128] = {0};
   ...
   if ((strstr (type, "*(") || strstr (type, " *")) && strncmp (type, "char *", 7)) {
    isfp = 
# 397 "project/radare2/libr/util/utype.c" 3 4
          1
# 397 "project/radare2/libr/util/utype.c"
              ;
   } else if (r_str_startswith (type, "struct ")) {
    struct_name = type + 7;

    
# 401 "project/radare2/libr/util/utype.c" 3 4
   __builtin___snprintf_chk (
# 401 "project/radare2/libr/util/utype.c"
   var3
# 401 "project/radare2/libr/util/utype.c" 3 4
   , 
# 401 "project/radare2/libr/util/utype.c"
...
# 401 "project/radare2/libr/util/utype.c"
                                                           ;
    tfmt = sdb_const_get (TDB, var3, 
# 402 "project/radare2/libr/util/utype.c" 3 4
                                    ((void *)0)
# 402 "project/radare2/libr/util/utype.c"
                                        );
    isStruct = 
# 403 "project/radare2/libr/util/utype.c" 3 4
              1
# 403 "project/radare2/libr/util/utype.c"
                  ;
   } else {

    if (!strcmp (type, "char") && elements > 0) {
     tfmt = sdb_const_get (TDB, "type.char *", 
# 407 "project/radare2/libr/util/utype.c" 3 4
                                              ((void *)0)
# 407 "project/radare2/libr/util/utype.c"
                                                  );
     if (tfmt && *tfmt == '*') {
      tfmt++;
     }
...
# 413 "project/radare2/libr/util/utype.c" 3 4
     __builtin___snprintf_chk (
# 413 "project/radare2/libr/util/utype.c"
     var3
# 413 "project/radare2/libr/util/utype.c" 3 4
     , 
# 413 "project/radare2/libr/util/utype.c"
...
# 413 "project/radare2/libr/util/utype.c"
                                                   ;
      isEnum = 
# 414 "project/radare2/libr/util/utype.c" 3 4
              1
# 414 "project/radare2/libr/util/utype.c"
                  ;
     } else {
      
# 416 "project/radare2/libr/util/utype.c" 3 4
     __builtin___snprintf_chk (
# 416 "project/radare2/libr/util/utype.c"
     var3
# 416 "project/radare2/libr/util/utype.c" 3 4
     , 
# 416 "project/radare2/libr/util/utype.c"
...
# 416 "project/radare2/libr/util/utype.c"
     ...
     tfmt = sdb_const_get (TDB, var3, 
# 418 "project/radare2/libr/util/utype.c" 3 4
                                     ((void *)0)
# 418 "project/radare2/libr/util/utype.c"
                                         );
    }
   ...
   if (isfp) {
    ...
    (void) r_str_replace_ch (type, ' ', '_', 
# 428 "project/radare2/libr/util/utype.c" 3 4
                                            1
# 428 "project/radare2/libr/util/utype.c"
                                                );
    if (elements > 0) {
...
# 448 "project/radare2/libr/util/utype.c" 3 4
   fprintf(__stderrp,
# 448 "project/radare2/libr/util/utype.c"
...
# 461 "project/radare2/libr/util/utype.c" 3 4
__attribute__((visibility("default"))) 
# 461 "project/radare2/libr/util/utype.c"
     char *r_type_format(Sdb *TDB, const char *t) {
 char var[130], var2[132];
 const char *kind = sdb_const_get (TDB, t, 
# 463 "project/radare2/libr/util/utype.c" 3 4
                                          ((void *)0)
# 463 "project/radare2/libr/util/utype.c"
                                              );
 if (!kind) {
  return 
# 465 "project/radare2/libr/util/utype.c" 3 4
        ((void *)0)
# 465 "project/radare2/libr/util/utype.c"
            ;
 }

 
# 468 "project/radare2/libr/util/utype.c" 3 4
__builtin___snprintf_chk (
# 468 "project/radare2/libr/util/utype.c"
var
# 468 "project/radare2/libr/util/utype.c" 3 4
, 
# 468 "project/radare2/libr/util/utype.c"
...
# 468 "project/radare2/libr/util/utype.c"
                                              ;
 if (!strcmp (kind, "type")) {
  const char *fmt = sdb_const_get (TDB, var, 
# 470 "project/radare2/libr/util/utype.c" 3 4
                                            ((void *)0)
# 470 "project/radare2/libr/util/utype.c"
                                                );
  if (fmt) {
   return strdup (fmt);
  }
 } else if (!strcmp (kind, "struct") || !strcmp (kind, "union")) {
  return fmt_struct_union(TDB, var, 
# 475 "project/radare2/libr/util/utype.c" 3 4
                                   0
# 475 "project/radare2/libr/util/utype.c"
                                        );
 }
 if (!strcmp (kind, "typedef")) {
  
# 478 "project/radare2/libr/util/utype.c" 3 4
 __builtin___snprintf_chk (
# 478 "project/radare2/libr/util/utype.c"
 var2
# 478 "project/radare2/libr/util/utype.c" 3 4
 , 
# 478 "project/radare2/libr/util/utype.c"
...
# 478 "project/radare2/libr/util/utype.c"
                                                ;
  const char *type = sdb_const_get (TDB, var2, 
# 479 "project/radare2/libr/util/utype.c" 3 4
                                              ((void *)0)
# 479 "project/radare2/libr/util/utype.c"
                                                  );

  if (type && !strcmp (type, "struct")) {
   return fmt_struct_union (TDB, var, 
# 482 "project/radare2/libr/util/utype.c" 3 4
                                     1
# 482 "project/radare2/libr/util/utype.c"
                                         );
  }
 }
 return 
# 485 "project/radare2/libr/util/utype.c" 3 4
       ((void *)0)
# 485 "project/radare2/libr/util/utype.c"
           ;
}


# 488 "project/radare2/libr/util/utype.c" 3 4
__attribute__((visibility("default"))) 
# 488 "project/radare2/libr/util/utype.c"
     void r_type_del(Sdb *TDB, const char *name) {
 ...
 if (!strcmp (kind, "type")) {
  ...
  for (i = 0; i< n; i++) {
   char *p = sdb_array_get (TDB, elements_key, i, 
# 502 "project/radare2/libr/util/utype.c" 3 4
                                                 ((void *)0)
# 502 "project/radare2/libr/util/utype.c"
                                                     );
...
# 523 "project/radare2/libr/util/utype.c" 3 4
 if (
# 523 "project/radare2/libr/util/utype.c"
 list
# 523 "project/radare2/libr/util/utype.c" 3 4
 ) for (
# 523 "project/radare2/libr/util/utype.c"
...
# 537 "project/radare2/libr/util/utype.c" 3 4
 fprintf(__stderrp,
# 537 "project/radare2/libr/util/utype.c"
...
# 542 "project/radare2/libr/util/utype.c" 3 4
__attribute__((visibility("default"))) 
# 542 "project/radare2/libr/util/utype.c"
     int r_type_func_exist(Sdb *TDB, const char *func_name) {
 const char *fcn = sdb_const_get (TDB, func_name, 0);
 return fcn && !strcmp (fcn, "func");
}


# 547 "project/radare2/libr/util/utype.c" 3 4
__attribute__((visibility("default"))) 
# 547 "project/radare2/libr/util/utype.c"
     const char *r_type_func_ret(Sdb *TDB, const char *func_name){
 const char *query = sdb_fmt ("func.%s.ret", func_name);
 return sdb_const_get (TDB, query, 0);
}


# 552 "project/radare2/libr/util/utype.c" 3 4
__attribute__((visibility("default"))) 
# 552 "project/radare2/libr/util/utype.c"
     int r_type_func_args_count(Sdb *TDB, const char *func_name) {
 const char *query = sdb_fmt ("func.%s.args", func_name);
 return sdb_num_get (TDB, query, 0);
}


# 557 "project/radare2/libr/util/utype.c" 3 4
__attribute__((visibility("default"))) 
# 557 "project/radare2/libr/util/utype.c"
           char *r_type_func_args_type(Sdb *TDB, const char *func_name, int i) {
 ...
 return 
# 568 "project/radare2/libr/util/utype.c" 3 4
       ((void *)0)
# 568 "project/radare2/libr/util/utype.c"
           ;
}


# 571 "project/radare2/libr/util/utype.c" 3 4
__attribute__((visibility("default"))) 
# 571 "project/radare2/libr/util/utype.c"
     const char *r_type_func_args_name(Sdb *TDB, const char *func_name, int i) {
 const char *query = sdb_fmt ("func.%s.arg.%d", func_name, i);
 ...
 return 
# 578 "project/radare2/libr/util/utype.c" 3 4
       ((void *)0)
# 578 "project/radare2/libr/util/utype.c"
           ;
}
...
static inline 
# 583 "project/radare2/libr/util/utype.c" 3 4
             _Bool 
# 583 "project/radare2/libr/util/utype.c"
                  is_function(const char *name) {
...
static char *type_func_try_guess(Sdb *TDB, char *name) {
 if (strlen(name) < 4) {
  return 
# 589 "project/radare2/libr/util/utype.c" 3 4
        ((void *)0)
# 589 "project/radare2/libr/util/utype.c"
            ;
 }

 const char *res = sdb_const_get(TDB, name, 
# 592 "project/radare2/libr/util/utype.c" 3 4
                                           ((void *)0)
# 592 "project/radare2/libr/util/utype.c"
                                               );
 if (is_function(res)) {
  return strdup(name);
 }
 ...
 return 
# 597 "project/radare2/libr/util/utype.c" 3 4
       ((void *)0)
# 597 "project/radare2/libr/util/utype.c"
           ;
}

static inline 
# 600 "project/radare2/libr/util/utype.c" 3 4
             _Bool 
# 600 "project/radare2/libr/util/utype.c"
                  is_auto_named(char *func_name, size_t slen) {
 return slen > 4 && (r_str_startswith (func_name, "fcn.") || r_str_startswith (func_name, "loc."));
}

static inline 
# 604 "project/radare2/libr/util/utype.c" 3 4
             _Bool 
# 604 "project/radare2/libr/util/utype.c"
                  has_r_prefixes(char *func_name, int offset, size_t slen) {
...
# 653 "project/radare2/libr/util/utype.c" 3 4
__attribute__((visibility("default"))) 
# 653 "project/radare2/libr/util/utype.c"
           char *r_type_func_guess(Sdb *TDB, char *func_name) {
 char *str = func_name;
 char *result = 
# 655 "project/radare2/libr/util/utype.c" 3 4
               ((void *)0)
# 655 "project/radare2/libr/util/utype.c"
                   ;
 
# 656 "project/radare2/libr/util/utype.c" 3 4
do { if (!(
# 656 "project/radare2/libr/util/utype.c"
TDB
# 656 "project/radare2/libr/util/utype.c" 3 4
...
"TDB"
# 656 "project/radare2/libr/util/utype.c" 3 4
, 656); return (0); } } while (0)
# 656 "project/radare2/libr/util/utype.c"
                                 ;
 
# 657 "project/radare2/libr/util/utype.c" 3 4
do { if (!(
# 657 "project/radare2/libr/util/utype.c"
func_name
# 657 "project/radare2/libr/util/utype.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 657 "project/radare2/libr/util/utype.c"
"func_name"
# 657 "project/radare2/libr/util/utype.c" 3 4
, 657); return (0); } } while (0)
# 657 "project/radare2/libr/util/utype.c"
                                       ;

 size_t slen = strlen (str);
 if (slen < 4 || is_auto_named(str, slen)) {
  return 
# 661 "project/radare2/libr/util/utype.c" 3 4
        ((void *)0)
# 661 "project/radare2/libr/util/utype.c"
            ;
 }
