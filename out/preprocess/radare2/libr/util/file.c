# 0 "project/radare2/libr/util/file.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/file.c"
...
typedef int RRef;
# 4 "project/radare2/libr/util/file.c" 2
...
# 5 "project/radare2/libr/util/file.c" 2




# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/fcntl.h" 1 3 4
# 10 "project/radare2/libr/util/file.c" 2
...
# 11 "project/radare2/libr/util/file.c" 2
...
# 14 "project/radare2/libr/util/file.c" 2
# 1 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include-fixed/limits.h" 1 3 4
# 15 "project/radare2/libr/util/file.c" 2
...
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/copyfile.h" 1 3 4
# 38 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/copyfile.h" 3 4

struct _copyfile_state;
typedef struct _copyfile_state * copyfile_state_t;
typedef uint32_t copyfile_flags_t;
# 55 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/copyfile.h" 3 4
...
# 131 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/copyfile.h" 3 4

# 23 "project/radare2/libr/util/file.c" 2
# 36 "project/radare2/libr/util/file.c"

# 36 "project/radare2/libr/util/file.c"
static int file_stat(const char *file, struct stat* const pStat) {
 
# 37 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 37 "project/radare2/libr/util/file.c"
file && pStat
# 37 "project/radare2/libr/util/file.c" 3 4
...
# 37 "project/radare2/libr/util/file.c"
                                        ;
# 47 "project/radare2/libr/util/file.c"
...
# 54 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 54 "project/radare2/libr/util/file.c"
     char *r_file_new(const char *root, ...) {
 va_list ap;
 
# 56 "project/radare2/libr/util/file.c" 3 4
__builtin_va_start(
# 56 "project/radare2/libr/util/file.c"
ap
# 56 "project/radare2/libr/util/file.c" 3 4
,
# 56 "project/radare2/libr/util/file.c"
...
# 56 "project/radare2/libr/util/file.c"
 ...
 if (!strcmp (root, "~")) {
  char *h = r_str_home (
# 59 "project/radare2/libr/util/file.c" 3 4
                       ((void *)0)
# 59 "project/radare2/libr/util/file.c"
                           );
  if (!h) {
   
# 61 "project/radare2/libr/util/file.c" 3 4
  __builtin_va_end(
# 61 "project/radare2/libr/util/file.c"
  ap
# 61 "project/radare2/libr/util/file.c" 3 4
  )
# 61 "project/radare2/libr/util/file.c"
   ...
   r_strbuf_free (sb);
   return 
# 63 "project/radare2/libr/util/file.c" 3 4
         ((void *)0)
# 63 "project/radare2/libr/util/file.c"
             ;
  }
 ...
 r_strbuf_append (sb, 
# 70 "project/radare2/libr/util/file.c" 3 4
                     "/"
# 70 "project/radare2/libr/util/file.c"
                              );
 const char *arg = 
# 71 "project/radare2/libr/util/file.c" 3 4
                  __builtin_va_arg(
# 71 "project/radare2/libr/util/file.c"
                  ap
# 71 "project/radare2/libr/util/file.c" 3 4
                  ,
# 71 "project/radare2/libr/util/file.c"
...
# 71 "project/radare2/libr/util/file.c"
 ...
 while (arg) {
  r_strbuf_append (sb, 
# 73 "project/radare2/libr/util/file.c" 3 4
                      "/"
# 73 "project/radare2/libr/util/file.c"
                               );
  r_strbuf_append (sb, arg);
  arg = 
# 75 "project/radare2/libr/util/file.c" 3 4
       __builtin_va_arg(
# 75 "project/radare2/libr/util/file.c"
       ap
# 75 "project/radare2/libr/util/file.c" 3 4
       ,
# 75 "project/radare2/libr/util/file.c"
...
# 77 "project/radare2/libr/util/file.c" 3 4
__builtin_va_end(
# 77 "project/radare2/libr/util/file.c"
ap
# 77 "project/radare2/libr/util/file.c" 3 4
)
# 77 "project/radare2/libr/util/file.c"
...
# 84 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 84 "project/radare2/libr/util/file.c"
          r_file_truncate(const char *filename, 
# 84 "project/radare2/libr/util/file.c" 3 4
                                                unsigned long long 
# 84 "project/radare2/libr/util/file.c"
                                                     newsize) {
 
# 85 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 85 "project/radare2/libr/util/file.c"
filename
# 85 "project/radare2/libr/util/file.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 85 "project/radare2/libr/util/file.c"
...
# 85 "project/radare2/libr/util/file.c"
 ...
 if (r_file_is_directory (filename)) {
  return 
# 88 "project/radare2/libr/util/file.c" 3 4
        0
# 88 "project/radare2/libr/util/file.c"
             ;
 }
 if (!r_file_exists (filename) || !r_file_is_regular (filename)) {
  return 
# 91 "project/radare2/libr/util/file.c" 3 4
        0
# 91 "project/radare2/libr/util/file.c"
             ;
 }
 fd = r_sandbox_open (filename, 
# 93 "project/radare2/libr/util/file.c" 3 4
                               0x0002 
# 93 "project/radare2/libr/util/file.c"
                               | 
# 93 "project/radare2/libr/util/file.c" 3 4
                               0x0080
# 93 "project/radare2/libr/util/file.c"
 ...
 if (fd == -1) {
  return 
# 95 "project/radare2/libr/util/file.c" 3 4
        0
# 95 "project/radare2/libr/util/file.c"
             ;
 }
...
# 103 "project/radare2/libr/util/file.c" 3 4
 fprintf(__stderrp,
# 103 "project/radare2/libr/util/file.c"
 "Could not resize %s file\n", filename
# 103 "project/radare2/libr/util/file.c" 3 4
 )
# 103 "project/radare2/libr/util/file.c"
                                                 ;
  close (fd);
  return 
# 105 "project/radare2/libr/util/file.c" 3 4
        0
# 105 "project/radare2/libr/util/file.c"
             ;
 }
 close (fd);
 return 
# 108 "project/radare2/libr/util/file.c" 3 4
       1
# 108 "project/radare2/libr/util/file.c"
           ;
}
...
# 116 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 116 "project/radare2/libr/util/file.c"
     const char *r_file_basename(const char *path) {
 
# 117 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 117 "project/radare2/libr/util/file.c"
path
# 117 "project/radare2/libr/util/file.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 117 "project/radare2/libr/util/file.c"
...
# 117 "project/radare2/libr/util/file.c"
                                 ;
 const char *ptr = r_str_rchr (path, 
# 118 "project/radare2/libr/util/file.c" 3 4
                                    ((void *)0)
# 118 "project/radare2/libr/util/file.c"
                                        , '/');
 if (ptr) {
  path = ptr + 1;
 } else {
  if ((ptr = r_str_rchr (path, 
# 122 "project/radare2/libr/util/file.c" 3 4
                              ((void *)0)
# 122 "project/radare2/libr/util/file.c"
                                  , '\\'))) {
   path = ptr + 1;
  }
 }
...
# 135 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 135 "project/radare2/libr/util/file.c"
     char *r_file_dirname(const char *path) {
 
# 136 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 136 "project/radare2/libr/util/file.c"
path
# 136 "project/radare2/libr/util/file.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 136 "project/radare2/libr/util/file.c"
"path"
# 136 "project/radare2/libr/util/file.c" 3 4
, 136); return (((void *)0)); } } while (0)
# 136 "project/radare2/libr/util/file.c"
                                 ;
 char *newpath = strdup (path);
 char *ptr = (char*)r_str_rchr (newpath, 
# 138 "project/radare2/libr/util/file.c" 3 4
                                        ((void *)0)
# 138 "project/radare2/libr/util/file.c"
                                            , '/');
 if (ptr) {
  *ptr = 0;
 } else {
  ptr = (char*)r_str_rchr (newpath, 
# 142 "project/radare2/libr/util/file.c" 3 4
                                   ((void *)0)
# 142 "project/radare2/libr/util/file.c"
                                       , '\\');
  if (ptr) {
   *ptr = 0;
  }
...
# 150 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 150 "project/radare2/libr/util/file.c"
          r_file_is_c(const char *file) {
 
# 151 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 151 "project/radare2/libr/util/file.c"
file
# 151 "project/radare2/libr/util/file.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 151 "project/radare2/libr/util/file.c"
...
# 151 "project/radare2/libr/util/file.c"
 ...
 if (ext) {
  ...
  || !strcmp (ext, "h")) {
   return 
# 158 "project/radare2/libr/util/file.c" 3 4
         1
# 158 "project/radare2/libr/util/file.c"
             ;
  }
 }
 return 
# 161 "project/radare2/libr/util/file.c" 3 4
       0
# 161 "project/radare2/libr/util/file.c"
            ;
}


# 164 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 164 "project/radare2/libr/util/file.c"
          r_file_is_regular(const char *str) {
 struct stat buf = {0};
 if (!str || !*str || file_stat (str, &buf) == -1) {
  return 
# 167 "project/radare2/libr/util/file.c" 3 4
        0
# 167 "project/radare2/libr/util/file.c"
             ;
 }
 return ((
# 169 "project/radare2/libr/util/file.c" 3 4
         0100000 
# 169 "project/radare2/libr/util/file.c"
                 & buf.st_mode) == 
# 169 "project/radare2/libr/util/file.c" 3 4
                                   0100000
# 169 "project/radare2/libr/util/file.c"
...
# 172 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 172 "project/radare2/libr/util/file.c"
          r_file_is_directory(const char *str) {
 struct stat buf = {0};
 
# 174 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 174 "project/radare2/libr/util/file.c"
!
# 174 "project/radare2/libr/util/file.c" 3 4
(!(
# 174 "project/radare2/libr/util/file.c"
...
"!R_STR_ISEMPTY (str)"
# 174 "project/radare2/libr/util/file.c" 3 4
, 174); return (0); } } while (0)
# 174 "project/radare2/libr/util/file.c"
                                                  ;
 if (file_stat (str, &buf) == -1) {
  return 
# 176 "project/radare2/libr/util/file.c" 3 4
        0
# 176 "project/radare2/libr/util/file.c"
             ;
 }

 if ((
# 179 "project/radare2/libr/util/file.c" 3 4
     0060000 
# 179 "project/radare2/libr/util/file.c"
             & buf.st_mode) == 
# 179 "project/radare2/libr/util/file.c" 3 4
                               0060000
# 179 "project/radare2/libr/util/file.c"
  ...
  return 
# 180 "project/radare2/libr/util/file.c" 3 4
        0
# 180 "project/radare2/libr/util/file.c"
             ;
 }

 return 
# 183 "project/radare2/libr/util/file.c" 3 4
       0040000 
# 183 "project/radare2/libr/util/file.c"
               == (
# 183 "project/radare2/libr/util/file.c" 3 4
                   0040000 
# 183 "project/radare2/libr/util/file.c"
...
# 186 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 186 "project/radare2/libr/util/file.c"
          r_file_fexists(const char *fmt, ...) {
 int ret;
 char string[1024];
 va_list ap;
 
# 190 "project/radare2/libr/util/file.c" 3 4
__builtin_va_start(
# 190 "project/radare2/libr/util/file.c"
ap
# 190 "project/radare2/libr/util/file.c" 3 4
,
# 190 "project/radare2/libr/util/file.c"
...
# 191 "project/radare2/libr/util/file.c" 3 4
__builtin___vsnprintf_chk (
# 191 "project/radare2/libr/util/file.c"
string
# 191 "project/radare2/libr/util/file.c" 3 4
, 
# 191 "project/radare2/libr/util/file.c"
...
# 193 "project/radare2/libr/util/file.c" 3 4
__builtin_va_end(
# 193 "project/radare2/libr/util/file.c"
ap
# 193 "project/radare2/libr/util/file.c" 3 4
)
# 193 "project/radare2/libr/util/file.c"
...
# 197 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 197 "project/radare2/libr/util/file.c"
          r_file_exists(const char *str) {
 char *absfile = r_file_abspath (str);
 struct stat buf = {0};
 
# 200 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 200 "project/radare2/libr/util/file.c"
!
# 200 "project/radare2/libr/util/file.c" 3 4
(!(
# 200 "project/radare2/libr/util/file.c"
...
"!R_STR_ISEMPTY (str)"
# 200 "project/radare2/libr/util/file.c" 3 4
, 200); return (0); } } while (0)
# 200 "project/radare2/libr/util/file.c"
                                                  ;
 if (file_stat (absfile, &buf) == -1) {
  free (absfile);
  return 
# 203 "project/radare2/libr/util/file.c" 3 4
        0
# 203 "project/radare2/libr/util/file.c"
             ;
 }
 free (absfile);
 return 
# 206 "project/radare2/libr/util/file.c" 3 4
       0100000 
# 206 "project/radare2/libr/util/file.c"
               == (
# 206 "project/radare2/libr/util/file.c" 3 4
                   0100000 
# 206 "project/radare2/libr/util/file.c"
...
# 209 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 209 "project/radare2/libr/util/file.c"
          r_file_size(const char *str) {
 
# 210 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 210 "project/radare2/libr/util/file.c"
!
# 210 "project/radare2/libr/util/file.c" 3 4
(!(
# 210 "project/radare2/libr/util/file.c"
...
# 210 "project/radare2/libr/util/file.c"
 ...
 return (
# 215 "project/radare2/libr/util/file.c" 3 4
        unsigned long long
# 215 "project/radare2/libr/util/file.c"
            )buf.st_size;
}


# 218 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 218 "project/radare2/libr/util/file.c"
          r_file_is_abspath(const char *file) {
 
# 219 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 219 "project/radare2/libr/util/file.c"
!
# 219 "project/radare2/libr/util/file.c" 3 4
(!(
# 219 "project/radare2/libr/util/file.c"
...
# 223 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 223 "project/radare2/libr/util/file.c"
     char *r_file_abspath_rel(const char *cwd, const char *file) {
 char *ret = 
# 224 "project/radare2/libr/util/file.c" 3 4
            ((void *)0)
# 224 "project/radare2/libr/util/file.c"
                ;
 ...
 if (!strncmp (file, "~/", 2) || !strncmp (file, "~\\", 2)) {
  ...
  if (cwd && *file != '/') {
   ret = r_str_newf ("%s" 
# 236 "project/radare2/libr/util/file.c" 3 4
                         "/" 
# 236 "project/radare2/libr/util/file.c"
                                   "%s", cwd, file);
  }
# 261 "project/radare2/libr/util/file.c"
 }
 if (!ret) {
  ret = strdup (file);
 }

 char *abspath = realpath (ret, 
# 266 "project/radare2/libr/util/file.c" 3 4
                               ((void *)0)
# 266 "project/radare2/libr/util/file.c"
                                   );
 if (abspath) {
  free (ret);
  ret = abspath;
...
# 275 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 275 "project/radare2/libr/util/file.c"
     char *r_file_abspath(const char *file) {
 
# 276 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 276 "project/radare2/libr/util/file.c"
file
# 276 "project/radare2/libr/util/file.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 276 "project/radare2/libr/util/file.c"
...
# 276 "project/radare2/libr/util/file.c"
 ...
 return 
# 283 "project/radare2/libr/util/file.c" 3 4
       ((void *)0)
# 283 "project/radare2/libr/util/file.c"
           ;
}


# 286 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 286 "project/radare2/libr/util/file.c"
     char *r_file_binsh(void) {
 char *bin_sh = r_sys_getenv ("SHELL");
 if (
# 288 "project/radare2/libr/util/file.c" 3 4
    (!(
# 288 "project/radare2/libr/util/file.c"
    bin_sh
# 288 "project/radare2/libr/util/file.c" 3 4
    ) || !*(
# 288 "project/radare2/libr/util/file.c"
...
# 288 "project/radare2/libr/util/file.c"
  ...
  if (
# 291 "project/radare2/libr/util/file.c" 3 4
     (!(
# 291 "project/radare2/libr/util/file.c"
     bin_sh
# 291 "project/radare2/libr/util/file.c" 3 4
     ) || !*(
# 291 "project/radare2/libr/util/file.c"
...
# 291 "project/radare2/libr/util/file.c"
   ...
   free (bin_sh);
   bin_sh = strdup (
# 293 "project/radare2/libr/util/file.c" 3 4
                   "/bin/sh"
# 293 "project/radare2/libr/util/file.c"
                             );
  }
 }
 return bin_sh;
...
# 299 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 299 "project/radare2/libr/util/file.c"
     char *r_file_path(const char *bin) {
 
# 300 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 300 "project/radare2/libr/util/file.c"
bin
# 300 "project/radare2/libr/util/file.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 300 "project/radare2/libr/util/file.c"
...
# 300 "project/radare2/libr/util/file.c"
                                ;
 char *file = 
# 301 "project/radare2/libr/util/file.c" 3 4
             ((void *)0)
# 301 "project/radare2/libr/util/file.c"
                 ;
 char *path = 
# 302 "project/radare2/libr/util/file.c" 3 4
             ((void *)0)
# 302 "project/radare2/libr/util/file.c"
                 ;
 char *str, *ptr;
 ...
 if (!strncmp (bin, "./", 2)) {
  return r_file_exists (bin)
   ? r_file_abspath (bin): 
# 307 "project/radare2/libr/util/file.c" 3 4
                          ((void *)0)
# 307 "project/radare2/libr/util/file.c"
                              ;
 }
 ...
 if (path_env) {
  ...
  do {
   ptr = strchr (str, 
# 318 "project/radare2/libr/util/file.c" 3 4
                     ":"
# 318 "project/radare2/libr/util/file.c"
                                 [0]);
   if (ptr) {
    *ptr = '\0';
    file = r_str_newf ("%s" 
# 321 "project/radare2/libr/util/file.c" 3 4
                      "/" 
# 321 "project/radare2/libr/util/file.c"
                      "%s%s", str, bin, extension);
...
# 337 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 337 "project/radare2/libr/util/file.c"
     char *r_stdin_slurp(int *sz) {
 ...
 if ((newfd = dup (0)) < 0) {
  return 
# 344 "project/radare2/libr/util/file.c" 3 4
        ((void *)0)
# 344 "project/radare2/libr/util/file.c"
            ;
 }
 ...
 if (!buf) {
  close (newfd);
  return 
# 349 "project/radare2/libr/util/file.c" 3 4
        ((void *)0)
# 349 "project/radare2/libr/util/file.c"
            ;
 }
 for (i = ret = 0; i >= 0; i += ret) {
  char *new = realloc (buf, i + 1024);
  if (!new) {
   
# 354 "project/radare2/libr/util/file.c" 3 4
  fprintf(__stderrp,
# 354 "project/radare2/libr/util/file.c"
  "Cannot realloc to %d\n", i+1024
# 354 "project/radare2/libr/util/file.c" 3 4
  )
# 354 "project/radare2/libr/util/file.c"
   ...
   free (buf);
   return 
# 356 "project/radare2/libr/util/file.c" 3 4
         ((void *)0)
# 356 "project/radare2/libr/util/file.c"
             ;
  }
  buf = new;
  ret = read (0, buf + i, 1024);
  if (ret < 1) {
   break;
  }
 }
...
# 366 "project/radare2/libr/util/file.c" 3 4
 { free((void *)
# 366 "project/radare2/libr/util/file.c"
 buf
# 366 "project/radare2/libr/util/file.c" 3 4
 ); 
# 366 "project/radare2/libr/util/file.c"
...
# 376 "project/radare2/libr/util/file.c" 3 4
 { free((void *)
# 376 "project/radare2/libr/util/file.c"
 buf
# 376 "project/radare2/libr/util/file.c" 3 4
 ); 
# 376 "project/radare2/libr/util/file.c"
...
# 385 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 385 "project/radare2/libr/util/file.c"
     char *r_file_slurp(const char *str, size_t *usz) {
 
# 386 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 386 "project/radare2/libr/util/file.c"
str
# 386 "project/radare2/libr/util/file.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 386 "project/radare2/libr/util/file.c"
...
# 386 "project/radare2/libr/util/file.c"
 ...
 if (!r_file_exists (str)) {
  return 
# 391 "project/radare2/libr/util/file.c" 3 4
        ((void *)0)
# 391 "project/radare2/libr/util/file.c"
            ;
 }
 FILE *fd = r_sandbox_fopen (str, "rb");
 if (!fd) {
  return 
# 395 "project/radare2/libr/util/file.c" 3 4
        ((void *)0)
# 395 "project/radare2/libr/util/file.c"
            ;
 }
 if (fseek (fd, 0, 
# 397 "project/radare2/libr/util/file.c" 3 4
                  2
# 397 "project/radare2/libr/util/file.c"
                          ) == -1) {
 ...
 if (sz < 0) {
  fclose (fd);
  return 
# 403 "project/radare2/libr/util/file.c" 3 4
        ((void *)0)
# 403 "project/radare2/libr/util/file.c"
            ;
 }
 ...
 if (!sz) {
  if (r_file_is_regular (str)) {
   char *buf = 
# 414 "project/radare2/libr/util/file.c" 3 4
              ((void *)0)
# 414 "project/radare2/libr/util/file.c"
                  ;
   long size = 0;
   (void)fseek (fd, 0, 
# 416 "project/radare2/libr/util/file.c" 3 4
                      0
# 416 "project/radare2/libr/util/file.c"
                              );
   do {
    char *nbuf = realloc (buf, size + 1024);
    if (!nbuf) {
     break;
    }
    buf = nbuf;
    size_t r = fread (buf + size, 1, 1024, fd);
    if (ferror (fd)) {
     
# 425 "project/radare2/libr/util/file.c" 3 4
    { free((void *)
# 425 "project/radare2/libr/util/file.c"
    buf
# 425 "project/radare2/libr/util/file.c" 3 4
    ); 
# 425 "project/radare2/libr/util/file.c"
...
# 425 "project/radare2/libr/util/file.c"
   ...
   if (!nbuf) {
    free (buf);
    return 
# 433 "project/radare2/libr/util/file.c" 3 4
          ((void *)0)
# 433 "project/radare2/libr/util/file.c"
              ;
   }
   buf = nbuf;
   buf[size] = '\0';
  ...
  sz = 
# 445 "project/radare2/libr/util/file.c" 3 4
      0xFFFFU
# 445 "project/radare2/libr/util/file.c"
              ;
 }
 rewind (fd);
 ...
 if (!ret) {
  fclose (fd);
  return 
# 451 "project/radare2/libr/util/file.c" 3 4
        ((void *)0)
# 451 "project/radare2/libr/util/file.c"
            ;
 }
 size_t rsz = fread (ret, 1, sz, fd);
 if (rsz != sz) {
  
# 455 "project/radare2/libr/util/file.c" 3 4
 fprintf(__stderrp,
# 455 "project/radare2/libr/util/file.c"
 "Warning: r_file_slurp: fread: truncated read (%d / %d)\n", (int)rsz, (int)sz
# 455 "project/radare2/libr/util/file.c" 3 4
 )
# 455 "project/radare2/libr/util/file.c"
                                                                                        ;
...
# 466 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 466 "project/radare2/libr/util/file.c"
         *r_file_gzslurp(const char *str, int *outlen, int origonfail) {
 
# 467 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 467 "project/radare2/libr/util/file.c"
str
# 467 "project/radare2/libr/util/file.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 467 "project/radare2/libr/util/file.c"
...
# 472 "project/radare2/libr/util/file.c" 3 4
unsigned char 
# 472 "project/radare2/libr/util/file.c"
    *in = (
# 472 "project/radare2/libr/util/file.c" 3 4
           unsigned char
# 472 "project/radare2/libr/util/file.c"
 ...
 if (!in) {
  return 
# 474 "project/radare2/libr/util/file.c" 3 4
        ((void *)0)
# 474 "project/radare2/libr/util/file.c"
            ;
 }
 
# 476 "project/radare2/libr/util/file.c" 3 4
unsigned char 
# 476 "project/radare2/libr/util/file.c"
    *out = r_inflate (in, (int)sz, 
# 476 "project/radare2/libr/util/file.c" 3 4
                                   ((void *)0)
# 476 "project/radare2/libr/util/file.c"
                                       , outlen);
...
# 489 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 489 "project/radare2/libr/util/file.c"
         *r_file_slurp_hexpairs(const char *str, int *usz) {
 
# 490 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 490 "project/radare2/libr/util/file.c"
str
# 490 "project/radare2/libr/util/file.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 490 "project/radare2/libr/util/file.c"
...
# 494 "project/radare2/libr/util/file.c" 3 4
unsigned char 
# 494 "project/radare2/libr/util/file.c"
    *ret;
 long sz;
 int c, bytes = 0;
 FILE *fd = r_sandbox_fopen (str, "rb");
 if (!fd) {
  return 
# 499 "project/radare2/libr/util/file.c" 3 4
        ((void *)0)
# 499 "project/radare2/libr/util/file.c"
            ;
 }
 (void) fseek (fd, 0, 
# 501 "project/radare2/libr/util/file.c" 3 4
                     2
# 501 "project/radare2/libr/util/file.c"
                             );
 sz = ftell (fd);
 (void) fseek (fd, 0, 
# 503 "project/radare2/libr/util/file.c" 3 4
                     0
# 503 "project/radare2/libr/util/file.c"
                             );
 ret = (
# 504 "project/radare2/libr/util/file.c" 3 4
       unsigned char
# 504 "project/radare2/libr/util/file.c"
          *)malloc ((sz>>1)+1);
 if (!ret) {
  fclose (fd);
  return 
# 507 "project/radare2/libr/util/file.c" 3 4
        ((void *)0)
# 507 "project/radare2/libr/util/file.c"
            ;
 }
 for (;;) {
  if (fscanf (fd, " #%*[^\n]") == 1) {
  ...
  fclose (fd);
  return 
# 522 "project/radare2/libr/util/file.c" 3 4
        ((void *)0)
# 522 "project/radare2/libr/util/file.c"
            ;
 }
 ret[bytes] = '\0';
 fclose (fd);
...
# 532 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 532 "project/radare2/libr/util/file.c"
     char *r_file_slurp_range(const char *str, 
# 532 "project/radare2/libr/util/file.c" 3 4
                                               unsigned long long 
# 532 "project/radare2/libr/util/file.c"
                                                    off, int sz, int *osz) {
 ...
 if (!fd) {
  return 
# 537 "project/radare2/libr/util/file.c" 3 4
        ((void *)0)
# 537 "project/radare2/libr/util/file.c"
            ;
 }

 if (fseek (fd, off, 
# 540 "project/radare2/libr/util/file.c" 3 4
                    0
# 540 "project/radare2/libr/util/file.c"
                            ) < 0) {
  fclose (fd);
  return 
# 542 "project/radare2/libr/util/file.c" 3 4
        ((void *)0)
# 542 "project/radare2/libr/util/file.c"
            ;
 }
...
# 561 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 561 "project/radare2/libr/util/file.c"
     char *r_file_slurp_random_line(const char *file) {
 
# 562 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 562 "project/radare2/libr/util/file.c"
file
# 562 "project/radare2/libr/util/file.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 562 "project/radare2/libr/util/file.c"
...
# 567 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 567 "project/radare2/libr/util/file.c"
     char *r_file_slurp_random_line_count(const char *file, int *line) {
 
# 568 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 568 "project/radare2/libr/util/file.c"
file && line
# 568 "project/radare2/libr/util/file.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 568 "project/radare2/libr/util/file.c"
"file && line"
# 568 "project/radare2/libr/util/file.c" 3 4
, 568); return (((void *)0)); } } while (0)
# 568 "project/radare2/libr/util/file.c"
                                         ;

 char *ptr = 
# 570 "project/radare2/libr/util/file.c" 3 4
            ((void *)0)
# 570 "project/radare2/libr/util/file.c"
                , *str;
 size_t i, lines, selection = -1;
 int start = *line;
 if ((str = r_file_slurp (file, 
# 573 "project/radare2/libr/util/file.c" 3 4
                               ((void *)0)
# 573 "project/radare2/libr/util/file.c"
                                   ))) {
  r_num_irand ();
  for (i = 0; str[i]; i++) {
   if (str[i] == '\n') {
  ...
  if ((selection < start) || (selection == -1)) {
   free (str);
   return 
# 586 "project/radare2/libr/util/file.c" 3 4
         ((void *)0)
# 586 "project/radare2/libr/util/file.c"
             ;
  } else {
...
# 610 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 610 "project/radare2/libr/util/file.c"
     char *r_file_slurp_line(const char *file, int line, int context) {
 
# 611 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 611 "project/radare2/libr/util/file.c"
file
# 611 "project/radare2/libr/util/file.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 611 "project/radare2/libr/util/file.c"
...
# 611 "project/radare2/libr/util/file.c"
 ...
 size_t sz;
 char *ptr = 
# 614 "project/radare2/libr/util/file.c" 3 4
            ((void *)0)
# 614 "project/radare2/libr/util/file.c"
                , *str = r_file_slurp (file, &sz);
 ...
 if (str) {
  ...
  if (line > lines) {
   free (str);
   return 
# 624 "project/radare2/libr/util/file.c" 3 4
         ((void *)0)
# 624 "project/radare2/libr/util/file.c"
             ;
  }
  lines = line - 1;
  for (i = 0; str[i]&&lines; i++) {
...
# 645 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 645 "project/radare2/libr/util/file.c"
     char *r_file_slurp_lines_from_bottom(const char *file, int line) {
 
# 646 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 646 "project/radare2/libr/util/file.c"
file
# 646 "project/radare2/libr/util/file.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 646 "project/radare2/libr/util/file.c"
"file"
# 646 "project/radare2/libr/util/file.c" 3 4
, 646); return (((void *)0)); } } while (0)
# 646 "project/radare2/libr/util/file.c"
                                 ;
 int i, lines = 0;
 size_t sz;
 char *ptr = 
# 649 "project/radare2/libr/util/file.c" 3 4
            ((void *)0)
# 649 "project/radare2/libr/util/file.c"
                , *str = r_file_slurp (file, &sz);
...
# 673 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 673 "project/radare2/libr/util/file.c"
     char *r_file_slurp_lines(const char *file, int line, int count) {
 
# 674 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 674 "project/radare2/libr/util/file.c"
file
# 674 "project/radare2/libr/util/file.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 674 "project/radare2/libr/util/file.c"
...
# 674 "project/radare2/libr/util/file.c"
 ...
 size_t sz;
 char *ptr = 
# 677 "project/radare2/libr/util/file.c" 3 4
            ((void *)0)
# 677 "project/radare2/libr/util/file.c"
                , *str = r_file_slurp (file, &sz);
 ...
 if (str) {
  ...
  if (line > lines) {
   free (str);
   return 
# 687 "project/radare2/libr/util/file.c" 3 4
         ((void *)0)
# 687 "project/radare2/libr/util/file.c"
             ;
  }
  lines = line - 1;
  for (i = 0; str[i]&&lines; i++) {
...
# 712 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 712 "project/radare2/libr/util/file.c"
     char *r_file_root(const char *root, const char *path) {
 
# 713 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 713 "project/radare2/libr/util/file.c"
root && path
# 713 "project/radare2/libr/util/file.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 713 "project/radare2/libr/util/file.c"
...
# 713 "project/radare2/libr/util/file.c"
 ...
 ret = r_str_append (strdup (root), 
# 725 "project/radare2/libr/util/file.c" 3 4
                                   "/"
# 725 "project/radare2/libr/util/file.c"
                                            );
...
# 731 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 731 "project/radare2/libr/util/file.c"
          r_file_hexdump(const char *file, const 
# 731 "project/radare2/libr/util/file.c" 3 4
                                                 unsigned char 
# 731 "project/radare2/libr/util/file.c"
                                                     *buf, int len, int append) {
 FILE *fd;
 int i,j;
 if (!file || !*file || !buf || len < 0) {
  
# 735 "project/radare2/libr/util/file.c" 3 4
 fprintf(__stderrp,
# 735 "project/radare2/libr/util/file.c"
 "r_file_hexdump file: %s buf: %p\n", file, buf
# 735 "project/radare2/libr/util/file.c" 3 4
 )
# 735 "project/radare2/libr/util/file.c"
                                                         ;
  return 
# 736 "project/radare2/libr/util/file.c" 3 4
        0
# 736 "project/radare2/libr/util/file.c"
             ;
 }
 if (append) {
...
# 745 "project/radare2/libr/util/file.c" 3 4
 fprintf(__stderrp,
# 745 "project/radare2/libr/util/file.c"
...
# 745 "project/radare2/libr/util/file.c"
                                                 ;
  return 
# 746 "project/radare2/libr/util/file.c" 3 4
        0
# 746 "project/radare2/libr/util/file.c"
             ;
 }
 for (i = 0; i < len; i += 16) {
  int l = 
# 749 "project/radare2/libr/util/file.c" 3 4
         (((
# 749 "project/radare2/libr/util/file.c"
         16
# 749 "project/radare2/libr/util/file.c" 3 4
         )>(
# 749 "project/radare2/libr/util/file.c"
...
# 749 "project/radare2/libr/util/file.c"
                            ;
  fprintf (fd, "0x%08"
# 750 "project/radare2/libr/util/file.c" 3 4
                     "llx"
# 750 "project/radare2/libr/util/file.c"
                            "  ", (
# 750 "project/radare2/libr/util/file.c" 3 4
                                   unsigned long long
# 750 "project/radare2/libr/util/file.c"
  ...
  for (j = 0; j < 16; j++) {
   fprintf (fd, "%c", j < l && 
# 762 "project/radare2/libr/util/file.c" 3 4
                              ((
# 762 "project/radare2/libr/util/file.c"
                              buf[i + j]
# 762 "project/radare2/libr/util/file.c" 3 4
                              ) >=' ' && (
# 762 "project/radare2/libr/util/file.c"
...
# 762 "project/radare2/libr/util/file.c"
 ...
 fclose (fd);
 return 
# 767 "project/radare2/libr/util/file.c" 3 4
       1
# 767 "project/radare2/libr/util/file.c"
           ;
}


# 770 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 770 "project/radare2/libr/util/file.c"
          r_file_touch(const char *file) {
 
# 771 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 771 "project/radare2/libr/util/file.c"
file
# 771 "project/radare2/libr/util/file.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 771 "project/radare2/libr/util/file.c"
"file"
# 771 "project/radare2/libr/util/file.c" 3 4
, 771); return (0); } } while (0)
# 771 "project/radare2/libr/util/file.c"
                                  ;
 return r_file_dump (file, 
# 772 "project/radare2/libr/util/file.c" 3 4
                          ((void *)0)
# 772 "project/radare2/libr/util/file.c"
                              , 0, 
# 772 "project/radare2/libr/util/file.c" 3 4
                                   1
# 772 "project/radare2/libr/util/file.c"
...
# 775 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 775 "project/radare2/libr/util/file.c"
          r_file_dump(const char *file, const 
# 775 "project/radare2/libr/util/file.c" 3 4
                                              unsigned char 
# 775 "project/radare2/libr/util/file.c"
                                                  *buf, int len, 
...
# 776 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 776 "project/radare2/libr/util/file.c"
!
# 776 "project/radare2/libr/util/file.c" 3 4
(!(
# 776 "project/radare2/libr/util/file.c"
...
# 785 "project/radare2/libr/util/file.c" 3 4
 fprintf(__stderrp,
# 785 "project/radare2/libr/util/file.c"
 "Cannot open '%s' for writing\n", file
# 785 "project/radare2/libr/util/file.c" 3 4
 )
# 785 "project/radare2/libr/util/file.c"
                                                 ;
  return 
# 786 "project/radare2/libr/util/file.c" 3 4
        0
# 786 "project/radare2/libr/util/file.c"
             ;
 }
 if (buf) {
  if (len < 0) {
...
# 793 "project/radare2/libr/util/file.c" 3 4
  r_sys_perror_str(
# 793 "project/radare2/libr/util/file.c"
  "r_file_dump: fwrite: error\n"
# 793 "project/radare2/libr/util/file.c" 3 4
  );
# 793 "project/radare2/libr/util/file.c"
                                               ;
   fclose (fd);
   return 
# 795 "project/radare2/libr/util/file.c" 3 4
         0
# 795 "project/radare2/libr/util/file.c"
              ;
  }
 }
 fclose (fd);
 return 
# 799 "project/radare2/libr/util/file.c" 3 4
       1
# 799 "project/radare2/libr/util/file.c"
           ;
}


# 802 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 802 "project/radare2/libr/util/file.c"
          r_file_move(const char *src, const char *dst) {
 
# 803 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 803 "project/radare2/libr/util/file.c"
!
# 803 "project/radare2/libr/util/file.c" 3 4
(!(
# 803 "project/radare2/libr/util/file.c"
...
# 803 "project/radare2/libr/util/file.c"
"!R_STR_ISEMPTY (src) && !R_STR_ISEMPTY (dst)"
# 803 "project/radare2/libr/util/file.c" 3 4
, 803); return (0); } } while (0)
# 803 "project/radare2/libr/util/file.c"
                                                                          ;
 if (r_sandbox_enable (0)) {
  return 
# 805 "project/radare2/libr/util/file.c" 3 4
        0
# 805 "project/radare2/libr/util/file.c"
             ;
 }
 ...
 return 
# 822 "project/radare2/libr/util/file.c" 3 4
       1
# 822 "project/radare2/libr/util/file.c"
           ;
}


# 825 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 825 "project/radare2/libr/util/file.c"
          r_file_rm(const char *file) {
 
# 826 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 826 "project/radare2/libr/util/file.c"
!
# 826 "project/radare2/libr/util/file.c" 3 4
(!(
# 826 "project/radare2/libr/util/file.c"
...
"!R_STR_ISEMPTY (file)"
# 826 "project/radare2/libr/util/file.c" 3 4
, 826); return (0); } } while (0)
# 826 "project/radare2/libr/util/file.c"
                                                   ;
 if (r_sandbox_enable (0)) {
  return 
# 828 "project/radare2/libr/util/file.c" 3 4
        0
# 828 "project/radare2/libr/util/file.c"
             ;
 }
...
# 853 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 853 "project/radare2/libr/util/file.c"
     char *r_file_readlink(const char *path) {
 
# 854 "project/radare2/libr/util/file.c" 3 4
do { if (!(
# 854 "project/radare2/libr/util/file.c"
!
# 854 "project/radare2/libr/util/file.c" 3 4
(!(
# 854 "project/radare2/libr/util/file.c"
...
# 859 "project/radare2/libr/util/file.c" 3 4
 __builtin___strncpy_chk (
# 859 "project/radare2/libr/util/file.c"
 pathbuf
# 859 "project/radare2/libr/util/file.c" 3 4
 , 
# 859 "project/radare2/libr/util/file.c"
 path, sizeof (pathbuf) - 1
# 859 "project/radare2/libr/util/file.c" 3 4
...
# 859 "project/radare2/libr/util/file.c"
 ...
 return 
# 870 "project/radare2/libr/util/file.c" 3 4
       ((void *)0)
# 870 "project/radare2/libr/util/file.c"
           ;
}


# 873 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 873 "project/radare2/libr/util/file.c"
     int r_file_mmap_write(const char *file, 
# 873 "project/radare2/libr/util/file.c" 3 4
                                             unsigned long long 
# 873 "project/radare2/libr/util/file.c"
                                                  addr, const 
...
# 873 "project/radare2/libr/util/file.c"
                                                                  *buf, int len) {
# 906 "project/radare2/libr/util/file.c"
 int fd = r_sandbox_open (file, 
# 906 "project/radare2/libr/util/file.c" 3 4
                               0x0002 
# 906 "project/radare2/libr/util/file.c"
                               | 
# 906 "project/radare2/libr/util/file.c" 3 4
...
# 910 "project/radare2/libr/util/file.c" 3 4
unsigned char 
# 910 "project/radare2/libr/util/file.c"
    *mmap_buf;
 if (fd == -1) {
  return -1;
 }
 if ((
# 914 "project/radare2/libr/util/file.c" 3 4
     long long
# 914 "project/radare2/libr/util/file.c"
         )addr < 0) {
  return -1;
 }
 mmap_buf = mmap (
# 917 "project/radare2/libr/util/file.c" 3 4
                 ((void *)0)
# 917 "project/radare2/libr/util/file.c"
                     , mmlen * 2, 
# 917 "project/radare2/libr/util/file.c" 3 4
                                  0x01
# 917 "project/radare2/libr/util/file.c"
...
# 921 "project/radare2/libr/util/file.c" 3 4
__builtin___memcpy_chk (
# 921 "project/radare2/libr/util/file.c"
mmap_buf + rest
# 921 "project/radare2/libr/util/file.c" 3 4
, 
# 921 "project/radare2/libr/util/file.c"
...
# 921 "project/radare2/libr/util/file.c"
 ...
 msync (mmap_buf + rest, len, 
# 923 "project/radare2/libr/util/file.c" 3 4
                             0x0002
# 923 "project/radare2/libr/util/file.c"
                                          );
...
# 933 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 933 "project/radare2/libr/util/file.c"
     int r_file_mmap_read (const char *file, 
# 933 "project/radare2/libr/util/file.c" 3 4
                                             unsigned long long 
# 933 "project/radare2/libr/util/file.c"
                                                  addr, 
...
# 933 "project/radare2/libr/util/file.c"
                                                            *buf, int len) {
# 971 "project/radare2/libr/util/file.c"
 int fd = r_sandbox_open (file, 
# 971 "project/radare2/libr/util/file.c" 3 4
                               0x0000
# 971 "project/radare2/libr/util/file.c"
                                       , 0644);
...
# 975 "project/radare2/libr/util/file.c" 3 4
unsigned char 
# 975 "project/radare2/libr/util/file.c"
    *mmap_buf;
 if (fd == -1) {
  return -1;
 }
 mmap_buf = mmap (
# 979 "project/radare2/libr/util/file.c" 3 4
                 ((void *)0)
# 979 "project/radare2/libr/util/file.c"
                     , mmlen*2, 
# 979 "project/radare2/libr/util/file.c" 3 4
                                0x01
# 979 "project/radare2/libr/util/file.c"
...
# 983 "project/radare2/libr/util/file.c" 3 4
__builtin___memcpy_chk (
# 983 "project/radare2/libr/util/file.c"
buf
# 983 "project/radare2/libr/util/file.c" 3 4
, 
# 983 "project/radare2/libr/util/file.c"
...
# 998 "project/radare2/libr/util/file.c" 3 4
unsigned char 
# 998 "project/radare2/libr/util/file.c"
    empty = m->len == 0;
 m->buf = mmap (
# 999 "project/radare2/libr/util/file.c" 3 4
               ((void *)0)
# 999 "project/radare2/libr/util/file.c"
                   , (empty?1024:m->len) ,
  m->rw?
# 1000 "project/radare2/libr/util/file.c" 3 4
       0x01
# 1000 "project/radare2/libr/util/file.c"
                |
# 1000 "project/radare2/libr/util/file.c" 3 4
                 0x02
# 1000 "project/radare2/libr/util/file.c"
...
# 1001 "project/radare2/libr/util/file.c" 3 4
 0x0001
# 1001 "project/radare2/libr/util/file.c"
           , fd, (off_t)m->base);
 if (m->buf == 
# 1002 "project/radare2/libr/util/file.c" 3 4
              ((void *)-1)
# 1002 "project/radare2/libr/util/file.c"
                        ) {
  m->buf = 
# 1003 "project/radare2/libr/util/file.c" 3 4
          ((void *)0)
# 1003 "project/radare2/libr/util/file.c"
              ;
 }
 return m;
}
# 1055 "project/radare2/libr/util/file.c"

# 1055 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 1055 "project/radare2/libr/util/file.c"
     RMmap *r_file_mmap_arch(RMmap *mmap, const char *filename, int fd) {
...
# 1070 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 1070 "project/radare2/libr/util/file.c"
     RMmap *r_file_mmap(const char *file, 
# 1070 "project/radare2/libr/util/file.c" 3 4
                                          _Bool 
# 1070 "project/radare2/libr/util/file.c"
                                               rw, 
...
# 1070 "project/radare2/libr/util/file.c"
                                                        base) {
 RMmap *m = 
# 1071 "project/radare2/libr/util/file.c" 3 4
           ((void *)0)
# 1071 "project/radare2/libr/util/file.c"
               ;
 int fd = -1;
 if (!rw && !r_file_exists (file)) {
  return m;
 }
 fd = r_sandbox_open (file, rw? 
# 1076 "project/radare2/libr/util/file.c" 3 4
                               0x0002 
# 1076 "project/radare2/libr/util/file.c"
                               | 
# 1076 "project/radare2/libr/util/file.c" 3 4
                               0x0080
# 1076 "project/radare2/libr/util/file.c"
...
# 1078 "project/radare2/libr/util/file.c" 3 4
 fprintf(__stderrp,
# 1078 "project/radare2/libr/util/file.c"
 "r_file_mmap: file does not exis.\n"
# 1078 "project/radare2/libr/util/file.c" 3 4
 )
# 1078 "project/radare2/libr/util/file.c"
                                               ;
 ...
 m = 
# 1082 "project/radare2/libr/util/file.c" 3 4
    (
# 1082 "project/radare2/libr/util/file.c"
    RMmap
# 1082 "project/radare2/libr/util/file.c" 3 4
    *)malloc(sizeof(
# 1082 "project/radare2/libr/util/file.c"
...
# 1082 "project/radare2/libr/util/file.c"
 ...
 if (!m) {
  ...
  return 
# 1087 "project/radare2/libr/util/file.c" 3 4
        ((void *)0)
# 1087 "project/radare2/libr/util/file.c"
            ;
 }
 m->base = base;
 m->rw = rw;
 m->fd = fd;
 m->len = fd != -1? lseek (fd, (off_t)0, 
# 1092 "project/radare2/libr/util/file.c" 3 4
                                        2
# 1092 "project/radare2/libr/util/file.c"
                                                ) : 0;
...
# 1101 "project/radare2/libr/util/file.c" 3 4
 { free((void *)
# 1101 "project/radare2/libr/util/file.c"
 m
# 1101 "project/radare2/libr/util/file.c" 3 4
 ); 
# 1101 "project/radare2/libr/util/file.c"
...
# 1101 "project/radare2/libr/util/file.c"
           ;
  return 
# 1102 "project/radare2/libr/util/file.c" 3 4
        ((void *)0)
# 1102 "project/radare2/libr/util/file.c"
            ;
 }
...
# 1115 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 1115 "project/radare2/libr/util/file.c"
     void r_file_mmap_free(RMmap *m) {
 if (!m) {
  return;
 }
# 1130 "project/radare2/libr/util/file.c"
 if (m->fd == -1) {
  free (m);
  return;
 }
...
# 1142 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 1142 "project/radare2/libr/util/file.c"
     char *r_file_temp(const char *prefix) {
 if (!prefix) {
  prefix = "";
 }
 char *path = r_file_tmpdir ();
 char *res = r_str_newf ("%s/%s.%"
# 1147 "project/radare2/libr/util/file.c" 3 4
                                 "llx"
# 1147 "project/radare2/libr/util/file.c"
                                        , path, prefix, r_time_now ());
 free (path);
 return res;
}


# 1152 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 1152 "project/radare2/libr/util/file.c"
...
# 1186 "project/radare2/libr/util/file.c"
 char pfxx[1024];
 ...
 mode_t mask = umask (
# 1201 "project/radare2/libr/util/file.c" 3 4
                     0000020 
# 1201 "project/radare2/libr/util/file.c"
                             | 
# 1201 "project/radare2/libr/util/file.c" 3 4
                               0000002
# 1201 "project/radare2/libr/util/file.c"
 ...
 if (suffix && *suffix) {
  ...
  const char c = (char)(
# 1207 "project/radare2/libr/util/file.c" 3 4
                       ((void *)0) 
# 1207 "project/radare2/libr/util/file.c"
                            != xpos ? *(xpos + 1) : 0);
  if (0 != c) {
   xpos[1] = 0;
   h = mkstemp (name);
 ...
 if (oname) {
  *oname = (h!=-1)? strdup (name): 
# 1222 "project/radare2/libr/util/file.c" 3 4
                                  ((void *)0)
# 1222 "project/radare2/libr/util/file.c"
                                      ;
 }
 free (name);
...
# 1230 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 1230 "project/radare2/libr/util/file.c"
     char *r_file_tmpdir(void) {
# 1263 "project/radare2/libr/util/file.c"
 char *path = r_sys_getenv ("TMPDIR");
 if (path && !*path) {
  
# 1265 "project/radare2/libr/util/file.c" 3 4
 { free((void *)
# 1265 "project/radare2/libr/util/file.c"
 path
# 1265 "project/radare2/libr/util/file.c" 3 4
 ); 
# 1265 "project/radare2/libr/util/file.c"
...
# 1265 "project/radare2/libr/util/file.c"
 ...
 if (!r_file_is_directory (path)) {
  free (path);
  return 
# 1281 "project/radare2/libr/util/file.c" 3 4
        ((void *)0)
# 1281 "project/radare2/libr/util/file.c"
            ;
...
# 1287 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 1287 "project/radare2/libr/util/file.c"
          r_file_copy(const char *src, const char *dst) {
 
# 1288 "project/radare2/libr/util/file.c" 3 4
do { if (!(((
# 1288 "project/radare2/libr/util/file.c"
src
# 1288 "project/radare2/libr/util/file.c" 3 4
) && *(
# 1288 "project/radare2/libr/util/file.c"
...
# 1288 "project/radare2/libr/util/file.c" 3 4
, 1288); return (0); } } while (0)
# 1288 "project/radare2/libr/util/file.c"
                                                                              ;
 if (!strcmp (src, dst)) {
  return 
# 1290 "project/radare2/libr/util/file.c" 3 4
        0
# 1290 "project/radare2/libr/util/file.c"
             ;
 }
...
# 1295 "project/radare2/libr/util/file.c" 3 4
                              (1<<3) 
# 1295 "project/radare2/libr/util/file.c"
                                            | 
# 1295 "project/radare2/libr/util/file.c" 3 4
                                              (1<<2)
# 1295 "project/radare2/libr/util/file.c"
                                                            ) != -1;
# 1319 "project/radare2/libr/util/file.c"
}

static 
# 1321 "project/radare2/libr/util/file.c" 3 4
      _Bool 
# 1321 "project/radare2/libr/util/file.c"
           dir_recursive(RList *dst, const char *dir) {
 char *name;
 RListIter *iter;
 
# 1324 "project/radare2/libr/util/file.c" 3 4
_Bool 
# 1324 "project/radare2/libr/util/file.c"
     ret = 
# 1324 "project/radare2/libr/util/file.c" 3 4
           1
# 1324 "project/radare2/libr/util/file.c"
 ...
 if (!files) {
  return 
# 1327 "project/radare2/libr/util/file.c" 3 4
        0
# 1327 "project/radare2/libr/util/file.c"
             ;
 }
 
# 1329 "project/radare2/libr/util/file.c" 3 4
if (
# 1329 "project/radare2/libr/util/file.c"
files
# 1329 "project/radare2/libr/util/file.c" 3 4
) for (
# 1329 "project/radare2/libr/util/file.c"
...
# 1329 "project/radare2/libr/util/file.c"
  ...
  path = r_str_newf ("%s" 
# 1334 "project/radare2/libr/util/file.c" 3 4
                         "/" 
# 1334 "project/radare2/libr/util/file.c"
                                   "%s", dir, name);
  if (!path) {
   ret = 
# 1336 "project/radare2/libr/util/file.c" 3 4
        0
# 1336 "project/radare2/libr/util/file.c"
             ;
   break;
  }
  if (!r_list_append (dst, path)) {
   ret = 
# 1340 "project/radare2/libr/util/file.c" 3 4
        0
# 1340 "project/radare2/libr/util/file.c"
             ;
   free (path);
   break;
  }
  if (r_file_is_directory (path)) {
   if (!dir_recursive (dst, path)) {
    ret = 
# 1346 "project/radare2/libr/util/file.c" 3 4
         0
# 1346 "project/radare2/libr/util/file.c"
              ;
    break;
   }
  }
...
# 1355 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 1355 "project/radare2/libr/util/file.c"
     RList *r_file_lsrf(const char *dir) {
 RList *ret = r_list_new ();
 if (!ret) {
  return 
# 1358 "project/radare2/libr/util/file.c" 3 4
        ((void *)0)
# 1358 "project/radare2/libr/util/file.c"
            ;
 }
 if (!dir_recursive (ret, dir)) {
  r_list_free (ret);
  return 
# 1362 "project/radare2/libr/util/file.c" 3 4
        ((void *)0)
# 1362 "project/radare2/libr/util/file.c"
            ;
 }
 return ret;
}
...
# 1367 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 1367 "project/radare2/libr/util/file.c"
          r_file_rm_rf(const char *dir) {
 ...
 if (!files) {
  return 
# 1373 "project/radare2/libr/util/file.c" 3 4
        0
# 1373 "project/radare2/libr/util/file.c"
             ;
 }
...
# 1378 "project/radare2/libr/util/file.c" 3 4
if (
# 1378 "project/radare2/libr/util/file.c"
files
# 1378 "project/radare2/libr/util/file.c" 3 4
) for (
# 1378 "project/radare2/libr/util/file.c"
...
# 1392 "project/radare2/libr/util/file.c" 3 4
if (
# 1392 "project/radare2/libr/util/file.c"
files
# 1392 "project/radare2/libr/util/file.c" 3 4
) for (
# 1392 "project/radare2/libr/util/file.c"
...
# 1409 "project/radare2/libr/util/file.c" 3 4
__attribute__((visibility("default"))) 
# 1409 "project/radare2/libr/util/file.c"
     RList* r_file_glob(const char *_globbed_path, int maxdepth) {
  ...
  *glob = '\0';
  char *last_slash = (char *)r_str_last (globbed_path, 
# 1417 "project/radare2/libr/util/file.c" 3 4
                                                      "/"
# 1417 "project/radare2/libr/util/file.c"
                                                               );
  *glob = '*';
  char *path, *glob_ptr;
  if (last_slash) {
   ...
   path = r_str_newf (".%s", 
# 1431 "project/radare2/libr/util/file.c" 3 4
                            "/"
# 1431 "project/radare2/libr/util/file.c"
                                     );
  }
  ...
  if (!path) {
   ...
   free (globbed_path);
   return 
# 1437 "project/radare2/libr/util/file.c" 3 4
         ((void *)0)
# 1437 "project/radare2/libr/util/file.c"
             ;
  }
