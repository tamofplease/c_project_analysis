# 0 "project/radare2/libr/util/regex/regerror.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 39 "project/radare2/libr/util/regex/regerror.c" 2
...
# 40 "project/radare2/libr/util/regex/regerror.c" 2
...
# 41 "project/radare2/libr/util/regex/regerror.c" 2
...
# 42 "project/radare2/libr/util/regex/regerror.c" 2
...
# 43 "project/radare2/libr/util/regex/regerror.c" 2
...
# 44 "project/radare2/libr/util/regex/regerror.c" 2
...
# 45 "project/radare2/libr/util/regex/regerror.c" 2
# 1 "project/radare2/libr/util/regex/utils.h" 1
# 46 "project/radare2/libr/util/regex/regerror.c" 2


# 47 "project/radare2/libr/util/regex/regerror.c"
static struct rerr {
 int code;
 const char *name;
 const char *explain;
 ...
 { 
# 52 "project/radare2/libr/util/regex/regerror.c" 3 4
  1
# 52 "project/radare2/libr/util/regex/regerror.c"
                 , "R_REGEX_NOMATCH", "regexec() failed to match" },
 { 
# 53 "project/radare2/libr/util/regex/regerror.c" 3 4
  2
# 53 "project/radare2/libr/util/regex/regerror.c"
                , "R_REGEX_BADPAT", "invalid regular expression" },
 { 
# 54 "project/radare2/libr/util/regex/regerror.c" 3 4
  3
# 54 "project/radare2/libr/util/regex/regerror.c"
                  , "R_REGEX_ECOLLATE", "invalid collating element" },
 { 
# 55 "project/radare2/libr/util/regex/regerror.c" 3 4
  4
# 55 "project/radare2/libr/util/regex/regerror.c"
                , "R_REGEX_ECTYPE", "invalid character class" },
 { 
# 56 "project/radare2/libr/util/regex/regerror.c" 3 4
  5
# 56 "project/radare2/libr/util/regex/regerror.c"
                 , "R_REGEX_EESCAPE", "trailing backslash (\\)" },
 { 
# 57 "project/radare2/libr/util/regex/regerror.c" 3 4
  6
# 57 "project/radare2/libr/util/regex/regerror.c"
                 , "R_REGEX_ESUBREG", "invalid backreference number" },
 { 
# 58 "project/radare2/libr/util/regex/regerror.c" 3 4
  7
# 58 "project/radare2/libr/util/regex/regerror.c"
                , "R_REGEX_EBRACK", "brackets ([ ]) not balanced" },
 { 
# 59 "project/radare2/libr/util/regex/regerror.c" 3 4
  8
# 59 "project/radare2/libr/util/regex/regerror.c"
                , "R_REGEX_EPAREN", "parentheses not balanced" },
 { 
# 60 "project/radare2/libr/util/regex/regerror.c" 3 4
  9
# 60 "project/radare2/libr/util/regex/regerror.c"
                , "R_REGEX_EBRACE", "braces not balanced" },
 { 
# 61 "project/radare2/libr/util/regex/regerror.c" 3 4
  10
# 61 "project/radare2/libr/util/regex/regerror.c"
               , "R_REGEX_BADBR", "invalid repetition count(s)" },
 { 
# 62 "project/radare2/libr/util/regex/regerror.c" 3 4
  11
# 62 "project/radare2/libr/util/regex/regerror.c"
                , "R_REGEX_ERANGE", "invalid character range" },
 { 
# 63 "project/radare2/libr/util/regex/regerror.c" 3 4
  12
# 63 "project/radare2/libr/util/regex/regerror.c"
                , "R_REGEX_ESPACE", "out of memory" },
 { 
# 64 "project/radare2/libr/util/regex/regerror.c" 3 4
  13
# 64 "project/radare2/libr/util/regex/regerror.c"
                , "R_REGEX_BADRPT", "repetition-operator operand invalid" },
 { 
# 65 "project/radare2/libr/util/regex/regerror.c" 3 4
  14
# 65 "project/radare2/libr/util/regex/regerror.c"
               , "R_REGEX_EMPTY", "empty (sub)expression" },
 { 
# 66 "project/radare2/libr/util/regex/regerror.c" 3 4
  15
# 66 "project/radare2/libr/util/regex/regerror.c"
                , "R_REGEX_ASSERT", "\"can't happen\" -- you found a bug" },
 { 
# 67 "project/radare2/libr/util/regex/regerror.c" 3 4
  16
# 67 "project/radare2/libr/util/regex/regerror.c"
                , "R_REGEX_INVARG", "invalid argument to regex routine" },
...
static char * regatoi(const RRegex *preg, char *localbuf, size_t localbufsize) {
 ...
 (void)
# 86 "project/radare2/libr/util/regex/regerror.c" 3 4
      __builtin___snprintf_chk (
# 86 "project/radare2/libr/util/regex/regerror.c"
      localbuf
# 86 "project/radare2/libr/util/regex/regerror.c" 3 4
      , 
# 86 "project/radare2/libr/util/regex/regerror.c"
...
# 94 "project/radare2/libr/util/regex/regerror.c" 3 4
__attribute__((visibility("default"))) 
# 94 "project/radare2/libr/util/regex/regerror.c"
     char *r_regex_error(RRegex *rx, int errcode) {
 size_t errbuf_size = 128;
 char *errbuf = malloc (errbuf_size);
 struct rerr *r;
 int target = errcode &~ 
# 98 "project/radare2/libr/util/regex/regerror.c" 3 4
                        0400
# 98 "project/radare2/libr/util/regex/regerror.c"
                                    ;
 const char *s;
 char convbuf[50];

 if (errcode == 
# 102 "project/radare2/libr/util/regex/regerror.c" 3 4
               255
# 102 "project/radare2/libr/util/regex/regerror.c"
                           ) {
  ...
  if (errcode & 
# 110 "project/radare2/libr/util/regex/regerror.c" 3 4
               0400
# 110 "project/radare2/libr/util/regex/regerror.c"
                           ) {
   if (r->code != 0) {
    r_str_ncpy (convbuf, r->name, sizeof (convbuf)-1);
   } else {
    
# 114 "project/radare2/libr/util/regex/regerror.c" 3 4
   __builtin___snprintf_chk (
# 114 "project/radare2/libr/util/regex/regerror.c"
   convbuf
# 114 "project/radare2/libr/util/regex/regerror.c" 3 4
   , 
# 114 "project/radare2/libr/util/regex/regerror.c"
...
# 114 "project/radare2/libr/util/regex/regerror.c"
 ...
 if (!
# 121 "project/radare2/libr/util/regex/regerror.c" 3 4
     (!(
# 121 "project/radare2/libr/util/regex/regerror.c"
     s
# 121 "project/radare2/libr/util/regex/regerror.c" 3 4
     ) || !*(
# 121 "project/radare2/libr/util/regex/regerror.c"
