# 0 "project/radare2/libr/util/buf_sparse.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/buf_sparse.c"
...
# 4 "project/radare2/libr/util/buf_sparse.c" 2


# 5 "project/radare2/libr/util/buf_sparse.c"
struct buf_sparse_priv {
 RList *sparse;
 
# 7 "project/radare2/libr/util/buf_sparse.c" 3 4
unsigned long long 
# 7 "project/radare2/libr/util/buf_sparse.c"
     offset;
};
...
static 
# 16 "project/radare2/libr/util/buf_sparse.c" 3 4
      _Bool 
# 16 "project/radare2/libr/util/buf_sparse.c"
           sparse_limits(RList *l, 
# 16 "project/radare2/libr/util/buf_sparse.c" 3 4
                                   unsigned long long 
# 16 "project/radare2/libr/util/buf_sparse.c"
                                        *max) {
 
# 17 "project/radare2/libr/util/buf_sparse.c" 3 4
_Bool 
# 17 "project/radare2/libr/util/buf_sparse.c"
     set = 
# 17 "project/radare2/libr/util/buf_sparse.c" 3 4
           0
# 17 "project/radare2/libr/util/buf_sparse.c"
...
# 21 "project/radare2/libr/util/buf_sparse.c" 3 4
if (
# 21 "project/radare2/libr/util/buf_sparse.c"
l
# 21 "project/radare2/libr/util/buf_sparse.c" 3 4
) for (
# 21 "project/radare2/libr/util/buf_sparse.c"
...
# 21 "project/radare2/libr/util/buf_sparse.c"
  ...
  if (set) {
   ...
   set = 
# 27 "project/radare2/libr/util/buf_sparse.c" 3 4
        1
# 27 "project/radare2/libr/util/buf_sparse.c"
            ;
   if (max) {
    *max = s->to;
   }
...
static RBufferSparse *sparse_append(RList *l, 
# 36 "project/radare2/libr/util/buf_sparse.c" 3 4
                                             unsigned long long 
# 36 "project/radare2/libr/util/buf_sparse.c"
                                                  addr, const 
# 36 "project/radare2/libr/util/buf_sparse.c" 3 4
                                                              unsigned char 
# 36 "project/radare2/libr/util/buf_sparse.c"
...
# 36 "project/radare2/libr/util/buf_sparse.c"
 ...
 if (l && data) {
  RBufferSparse *s = 
# 38 "project/radare2/libr/util/buf_sparse.c" 3 4
                    (
# 38 "project/radare2/libr/util/buf_sparse.c"
                    RBufferSparse
# 38 "project/radare2/libr/util/buf_sparse.c" 3 4
                    *)calloc(1,sizeof(
# 38 "project/radare2/libr/util/buf_sparse.c"
...
# 45 "project/radare2/libr/util/buf_sparse.c" 3 4
   __builtin___memcpy_chk (
# 45 "project/radare2/libr/util/buf_sparse.c"
   s->data
# 45 "project/radare2/libr/util/buf_sparse.c" 3 4
   , 
# 45 "project/radare2/libr/util/buf_sparse.c"
...
# 45 "project/radare2/libr/util/buf_sparse.c"
                              ;
    return r_list_append (l, s)? s: 
# 46 "project/radare2/libr/util/buf_sparse.c" 3 4
                                   ((void *)0)
# 46 "project/radare2/libr/util/buf_sparse.c"
                                       ;
   }
   free (s);
  }
 ...
 return 
# 51 "project/radare2/libr/util/buf_sparse.c" 3 4
       ((void *)0)
# 51 "project/radare2/libr/util/buf_sparse.c"
           ;
}


static 
# 55 "project/radare2/libr/util/buf_sparse.c" 3 4
      long long 
# 55 "project/radare2/libr/util/buf_sparse.c"
           sparse_write(RList *l, 
# 55 "project/radare2/libr/util/buf_sparse.c" 3 4
                                  unsigned long long 
# 55 "project/radare2/libr/util/buf_sparse.c"
                                       addr, const 
...
# 58 "project/radare2/libr/util/buf_sparse.c" 3 4
unsigned long long 
# 58 "project/radare2/libr/util/buf_sparse.c"
     olen = len;

 
# 60 "project/radare2/libr/util/buf_sparse.c" 3 4
if (
# 60 "project/radare2/libr/util/buf_sparse.c"
l
# 60 "project/radare2/libr/util/buf_sparse.c" 3 4
) for (
# 60 "project/radare2/libr/util/buf_sparse.c"
...
# 62 "project/radare2/libr/util/buf_sparse.c" 3 4
  unsigned long long 
# 62 "project/radare2/libr/util/buf_sparse.c"
       delta = addr - s->from;
   
# 63 "project/radare2/libr/util/buf_sparse.c" 3 4
  unsigned long long 
# 63 "project/radare2/libr/util/buf_sparse.c"
       reallen = s->size - delta >= len? len: s->size - delta;
   
# 64 "project/radare2/libr/util/buf_sparse.c" 3 4
  __builtin___memcpy_chk (
# 64 "project/radare2/libr/util/buf_sparse.c"
  s->data + delta
# 64 "project/radare2/libr/util/buf_sparse.c" 3 4
  , 
# 64 "project/radare2/libr/util/buf_sparse.c"
...
# 81 "project/radare2/libr/util/buf_sparse.c" 3 4
do { if (!(
# 81 "project/radare2/libr/util/buf_sparse.c"
priv
# 81 "project/radare2/libr/util/buf_sparse.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "WARNING (%s:%d):%s%s runtime check failed: (%s)\n", "project/radare2/libr/util/buf_sparse.c", 81, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : "", 
# 81 "project/radare2/libr/util/buf_sparse.c"
"priv"
# 81 "project/radare2/libr/util/buf_sparse.c" 3 4
); } } while (0)
...
static 
# 85 "project/radare2/libr/util/buf_sparse.c" 3 4
      _Bool 
# 85 "project/radare2/libr/util/buf_sparse.c"
           buf_sparse_init(RBuffer *b, const void *user) {
 struct buf_sparse_priv *priv = 
# 86 "project/radare2/libr/util/buf_sparse.c" 3 4
                               (
# 86 "project/radare2/libr/util/buf_sparse.c"
                               struct buf_sparse_priv
# 86 "project/radare2/libr/util/buf_sparse.c" 3 4
                               *)calloc(1,sizeof(
# 86 "project/radare2/libr/util/buf_sparse.c"
...
# 86 "project/radare2/libr/util/buf_sparse.c"
 ...
 if (!priv) {
  return 
# 88 "project/radare2/libr/util/buf_sparse.c" 3 4
        0
# 88 "project/radare2/libr/util/buf_sparse.c"
             ;
 }
 ...
 b->priv = priv;
 return 
# 93 "project/radare2/libr/util/buf_sparse.c" 3 4
       1
# 93 "project/radare2/libr/util/buf_sparse.c"
           ;
}

static 
# 96 "project/radare2/libr/util/buf_sparse.c" 3 4
      _Bool 
# 96 "project/radare2/libr/util/buf_sparse.c"
           buf_sparse_fini(RBuffer *b) {
 struct buf_sparse_priv *priv = get_priv_sparse (b);
 r_list_free (priv->sparse);
 
# 99 "project/radare2/libr/util/buf_sparse.c" 3 4
{ free((void *)
# 99 "project/radare2/libr/util/buf_sparse.c"
b->priv
# 99 "project/radare2/libr/util/buf_sparse.c" 3 4
); 
# 99 "project/radare2/libr/util/buf_sparse.c"
...
# 99 "project/radare2/libr/util/buf_sparse.c"
                ;
 return 
# 100 "project/radare2/libr/util/buf_sparse.c" 3 4
       1
# 100 "project/radare2/libr/util/buf_sparse.c"
           ;
}

static 
# 103 "project/radare2/libr/util/buf_sparse.c" 3 4
      _Bool 
# 103 "project/radare2/libr/util/buf_sparse.c"
           buf_sparse_resize(RBuffer *b, 
# 103 "project/radare2/libr/util/buf_sparse.c" 3 4
                                         unsigned long long 
# 103 "project/radare2/libr/util/buf_sparse.c"
                                              newsize) {
...
# 108 "project/radare2/libr/util/buf_sparse.c" 3 4
if (
# 108 "project/radare2/libr/util/buf_sparse.c"
priv->sparse
# 108 "project/radare2/libr/util/buf_sparse.c" 3 4
) for (
# 108 "project/radare2/libr/util/buf_sparse.c"
...
# 108 "project/radare2/libr/util/buf_sparse.c"
  ...
  if (s->from >= newsize) {
   ...
   RBufferSparse *ns = 
# 112 "project/radare2/libr/util/buf_sparse.c" 3 4
                      (
# 112 "project/radare2/libr/util/buf_sparse.c"
                      RBufferSparse
# 112 "project/radare2/libr/util/buf_sparse.c" 3 4
                      *)malloc(sizeof(
# 112 "project/radare2/libr/util/buf_sparse.c"
...
# 116 "project/radare2/libr/util/buf_sparse.c" 3 4
  unsigned char 
# 116 "project/radare2/libr/util/buf_sparse.c"
      *tmp = realloc (s->data, s->size);
   if (!tmp) {
    free (ns);
    return 
# 119 "project/radare2/libr/util/buf_sparse.c" 3 4
          0
# 119 "project/radare2/libr/util/buf_sparse.c"
               ;
   }

   s->data = 
# 122 "project/radare2/libr/util/buf_sparse.c" 3 4
            ((void *)0)
# 122 "project/radare2/libr/util/buf_sparse.c"
                ;
   ns->data = tmp;
...
# 129 "project/radare2/libr/util/buf_sparse.c" 3 4
unsigned long long 
# 129 "project/radare2/libr/util/buf_sparse.c"
     max;
 ...
 return 
# 134 "project/radare2/libr/util/buf_sparse.c" 3 4
       1
# 134 "project/radare2/libr/util/buf_sparse.c"
           ;
}

static 
# 137 "project/radare2/libr/util/buf_sparse.c" 3 4
      unsigned long long 
# 137 "project/radare2/libr/util/buf_sparse.c"
           buf_sparse_size(RBuffer *b) {
 struct buf_sparse_priv *priv = get_priv_sparse (b);
 
# 139 "project/radare2/libr/util/buf_sparse.c" 3 4
unsigned long long 
# 139 "project/radare2/libr/util/buf_sparse.c"
     max;
...
static 
# 144 "project/radare2/libr/util/buf_sparse.c" 3 4
      long long 
# 144 "project/radare2/libr/util/buf_sparse.c"
           buf_sparse_read(RBuffer *b, 
# 144 "project/radare2/libr/util/buf_sparse.c" 3 4
                                       unsigned char 
# 144 "project/radare2/libr/util/buf_sparse.c"
                                           *buf, 
...
# 148 "project/radare2/libr/util/buf_sparse.c" 3 4
unsigned long long 
# 148 "project/radare2/libr/util/buf_sparse.c"
     max = 0;

 
# 150 "project/radare2/libr/util/buf_sparse.c" 3 4
__builtin___memset_chk (
# 150 "project/radare2/libr/util/buf_sparse.c"
buf
# 150 "project/radare2/libr/util/buf_sparse.c" 3 4
, 
# 150 "project/radare2/libr/util/buf_sparse.c"
...
# 151 "project/radare2/libr/util/buf_sparse.c" 3 4
if (
# 151 "project/radare2/libr/util/buf_sparse.c"
priv->sparse
# 151 "project/radare2/libr/util/buf_sparse.c" 3 4
) for (
# 151 "project/radare2/libr/util/buf_sparse.c"
...
# 157 "project/radare2/libr/util/buf_sparse.c" 3 4
   unsigned long long 
# 157 "project/radare2/libr/util/buf_sparse.c"
        l = 
# 157 "project/radare2/libr/util/buf_sparse.c" 3 4
            (((
# 157 "project/radare2/libr/util/buf_sparse.c"
            priv->offset + len - c->from
# 157 "project/radare2/libr/util/buf_sparse.c" 3 4
            )>(
# 157 "project/radare2/libr/util/buf_sparse.c"
            c->size
...
# 158 "project/radare2/libr/util/buf_sparse.c" 3 4
   __builtin___memcpy_chk (
# 158 "project/radare2/libr/util/buf_sparse.c"
   buf + c->from - priv->offset
# 158 "project/radare2/libr/util/buf_sparse.c" 3 4
   , 
# 158 "project/radare2/libr/util/buf_sparse.c"
   c->data, l
...
# 160 "project/radare2/libr/util/buf_sparse.c" 3 4
   unsigned long long 
# 160 "project/radare2/libr/util/buf_sparse.c"
        l = 
# 160 "project/radare2/libr/util/buf_sparse.c" 3 4
            (((
# 160 "project/radare2/libr/util/buf_sparse.c"
...
# 161 "project/radare2/libr/util/buf_sparse.c" 3 4
   __builtin___memcpy_chk (
# 161 "project/radare2/libr/util/buf_sparse.c"
   buf
# 161 "project/radare2/libr/util/buf_sparse.c" 3 4
   , 
# 161 "project/radare2/libr/util/buf_sparse.c"
   c->data + priv->offset - c->from, l
# 161 "project/radare2/libr/util/buf_sparse.c" 3 4
   , __builtin_object_size (
# 161 "project/radare2/libr/util/buf_sparse.c"
   buf
...
# 168 "project/radare2/libr/util/buf_sparse.c" 3 4
unsigned long long 
# 168 "project/radare2/libr/util/buf_sparse.c"
     r = 
# 168 "project/radare2/libr/util/buf_sparse.c" 3 4
         (((
# 168 "project/radare2/libr/util/buf_sparse.c"
...
static 
# 173 "project/radare2/libr/util/buf_sparse.c" 3 4
      long long 
# 173 "project/radare2/libr/util/buf_sparse.c"
           buf_sparse_write(RBuffer *b, const 
# 173 "project/radare2/libr/util/buf_sparse.c" 3 4
                                              unsigned char 
# 173 "project/radare2/libr/util/buf_sparse.c"
                                                  *buf, 
...
# 175 "project/radare2/libr/util/buf_sparse.c" 3 4
long long 
# 175 "project/radare2/libr/util/buf_sparse.c"
     r = sparse_write (priv->sparse, priv->offset, buf, len);
 priv->offset += r;
 return r;
}

static 
# 180 "project/radare2/libr/util/buf_sparse.c" 3 4
      long long 
# 180 "project/radare2/libr/util/buf_sparse.c"
           buf_sparse_seek(RBuffer *b, 
# 180 "project/radare2/libr/util/buf_sparse.c" 3 4
                                       long long 
# 180 "project/radare2/libr/util/buf_sparse.c"
                                            addr, int whence) {
...
# 182 "project/radare2/libr/util/buf_sparse.c" 3 4
unsigned long long 
# 182 "project/radare2/libr/util/buf_sparse.c"
     max;
 if (addr < 0 && (-addr) > (
# 183 "project/radare2/libr/util/buf_sparse.c" 3 4
                           long long
# 183 "project/radare2/libr/util/buf_sparse.c"
                               )priv->offset) {
  return -1;
 }
 ...
 switch (whence) {
 case 
# 188 "project/radare2/libr/util/buf_sparse.c" 3 4
     1
# 188 "project/radare2/libr/util/buf_sparse.c"
              :
  priv->offset += addr;
  break;
 case 
# 191 "project/radare2/libr/util/buf_sparse.c" 3 4
     0
# 191 "project/radare2/libr/util/buf_sparse.c"
              :
  priv->offset = addr;
  break;
 case 
# 194 "project/radare2/libr/util/buf_sparse.c" 3 4
     2
# 194 "project/radare2/libr/util/buf_sparse.c"
              :
...
# 201 "project/radare2/libr/util/buf_sparse.c" 3 4
 do { r_assert_log (R_LOGLVL_WARN, "(%s:%d):%s%s code should not be reached\n", "project/radare2/libr/util/buf_sparse.c", 201, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : ""); } while (0)
# 201 "project/radare2/libr/util/buf_sparse.c"
                     ;
  return -1;
 }
 return priv->offset;
