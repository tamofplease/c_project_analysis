# 0 "project/radare2/libr/util/chmod.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/chmod.c"
...
# 4 "project/radare2/libr/util/chmod.c" 2
...
# 10 "project/radare2/libr/util/chmod.c"
static 
# 10 "project/radare2/libr/util/chmod.c" 3 4
      _Bool 
# 10 "project/radare2/libr/util/chmod.c"
           chmodr(const char *, int recursive);
static 
# 11 "project/radare2/libr/util/chmod.c" 3 4
      _Bool 
# 11 "project/radare2/libr/util/chmod.c"
           parsemode(const char *);
static void recurse(const char *path, int rec, 
# 12 "project/radare2/libr/util/chmod.c" 3 4
                                              _Bool 
# 12 "project/radare2/libr/util/chmod.c"
                                                   (*fn)(const char *,int));
...
# 18 "project/radare2/libr/util/chmod.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 18 "project/radare2/libr/util/chmod.c"
          r_file_chmod(const char *file, const char *mod, int recursive) {

 oper = '=';
 mode = 0;
 if (!parsemode (mod)) {
  return 
# 23 "project/radare2/libr/util/chmod.c" 3 4
        0
# 23 "project/radare2/libr/util/chmod.c"
             ;
 }
...
static 
# 33 "project/radare2/libr/util/chmod.c" 3 4
      _Bool 
# 33 "project/radare2/libr/util/chmod.c"
           chmodr(const char *path, int rflag) {
 struct stat st;

 if (stat (path, &st) == -1) {
  return 
# 37 "project/radare2/libr/util/chmod.c" 3 4
        0
# 37 "project/radare2/libr/util/chmod.c"
             ;
 }
...
# 53 "project/radare2/libr/util/chmod.c" 3 4
 fprintf(__stderrp,
# 53 "project/radare2/libr/util/chmod.c"
 "chmod %s:", path
# 53 "project/radare2/libr/util/chmod.c" 3 4
 )
# 53 "project/radare2/libr/util/chmod.c"
                            ;
  return 
# 54 "project/radare2/libr/util/chmod.c" 3 4
        0
# 54 "project/radare2/libr/util/chmod.c"
             ;
 }
 ...
 return 
# 60 "project/radare2/libr/util/chmod.c" 3 4
       1
# 60 "project/radare2/libr/util/chmod.c"
           ;
}

static 
# 63 "project/radare2/libr/util/chmod.c" 3 4
      _Bool 
# 63 "project/radare2/libr/util/chmod.c"
 ...
 if (*end == '\0') {
  if (octal & 04000) {
   mode |= 
# 72 "project/radare2/libr/util/chmod.c" 3 4
          0004000
# 72 "project/radare2/libr/util/chmod.c"
                 ;
  }
  if (octal & 02000) {
   mode |= 
# 75 "project/radare2/libr/util/chmod.c" 3 4
          0002000
# 75 "project/radare2/libr/util/chmod.c"
                 ;
  }
  if (octal & 00400) {
   mode |= 
# 78 "project/radare2/libr/util/chmod.c" 3 4
          0000400
# 78 "project/radare2/libr/util/chmod.c"
                 ;
  }
  if (octal & 00200) {
   mode |= 
# 81 "project/radare2/libr/util/chmod.c" 3 4
          0000200
# 81 "project/radare2/libr/util/chmod.c"
                 ;
  }
  if (octal & 00100) {
   mode |= 
# 84 "project/radare2/libr/util/chmod.c" 3 4
          0000100
# 84 "project/radare2/libr/util/chmod.c"
                 ;
  }
  if (octal & 00040) {
   mode |= 
# 87 "project/radare2/libr/util/chmod.c" 3 4
          0000040
# 87 "project/radare2/libr/util/chmod.c"
                 ;
  }
  if (octal & 00020) {
   mode |= 
# 90 "project/radare2/libr/util/chmod.c" 3 4
          0000020
# 90 "project/radare2/libr/util/chmod.c"
                 ;
  }
  if (octal & 00010) {
   mode |= 
# 93 "project/radare2/libr/util/chmod.c" 3 4
          0000010
# 93 "project/radare2/libr/util/chmod.c"
                 ;
  }
  if (octal & 00004) {
   mode |= 
# 96 "project/radare2/libr/util/chmod.c" 3 4
          0000004
# 96 "project/radare2/libr/util/chmod.c"
                 ;
  }
  if (octal & 00002) {
   mode |= 
# 99 "project/radare2/libr/util/chmod.c" 3 4
          0000002
# 99 "project/radare2/libr/util/chmod.c"
                 ;
  }
  if (octal & 00001) {
   mode |= 
# 102 "project/radare2/libr/util/chmod.c" 3 4
          0000001
# 102 "project/radare2/libr/util/chmod.c"
                 ;
  }
  return 
# 104 "project/radare2/libr/util/chmod.c" 3 4
        1
# 104 "project/radare2/libr/util/chmod.c"
            ;
 }
 for (p = str; *p; p++) {
  switch(*p) {
  ...
  case 'u':
   mask |= 
# 110 "project/radare2/libr/util/chmod.c" 3 4
          0000700
# 110 "project/radare2/libr/util/chmod.c"
                 ;
   break;
  case 'g':
   mask |= 
# 113 "project/radare2/libr/util/chmod.c" 3 4
          0000070
# 113 "project/radare2/libr/util/chmod.c"
                 ;
   break;
  case 'o':
   mask |= 
# 116 "project/radare2/libr/util/chmod.c" 3 4
          0000007
# 116 "project/radare2/libr/util/chmod.c"
                 ;
   break;
  case 'a':
   mask |= 
# 119 "project/radare2/libr/util/chmod.c" 3 4
          0000700
# 119 "project/radare2/libr/util/chmod.c"
                 |
# 119 "project/radare2/libr/util/chmod.c" 3 4
                  0000070
# 119 "project/radare2/libr/util/chmod.c"
...
# 119 "project/radare2/libr/util/chmod.c"
  ...
  case 'r':
   mode |= 
# 129 "project/radare2/libr/util/chmod.c" 3 4
          0000400
# 129 "project/radare2/libr/util/chmod.c"
                 |
# 129 "project/radare2/libr/util/chmod.c" 3 4
                  0000040
# 129 "project/radare2/libr/util/chmod.c"
...
# 129 "project/radare2/libr/util/chmod.c"
  ...
  case 'w':
   mode |= 
# 132 "project/radare2/libr/util/chmod.c" 3 4
          0000200
# 132 "project/radare2/libr/util/chmod.c"
                 |
# 132 "project/radare2/libr/util/chmod.c" 3 4
                  0000020
# 132 "project/radare2/libr/util/chmod.c"
...
# 132 "project/radare2/libr/util/chmod.c"
  ...
  case 'x':
   mode |= 
# 135 "project/radare2/libr/util/chmod.c" 3 4
          0000100
# 135 "project/radare2/libr/util/chmod.c"
                 |
# 135 "project/radare2/libr/util/chmod.c" 3 4
                  0000010
# 135 "project/radare2/libr/util/chmod.c"
...
# 135 "project/radare2/libr/util/chmod.c"
  ...
  case 's':
   mode |= 
# 138 "project/radare2/libr/util/chmod.c" 3 4
          0004000
# 138 "project/radare2/libr/util/chmod.c"
                 |
# 138 "project/radare2/libr/util/chmod.c" 3 4
                  0002000
# 138 "project/radare2/libr/util/chmod.c"
...
# 142 "project/radare2/libr/util/chmod.c" 3 4
  fprintf(__stderrp,
# 142 "project/radare2/libr/util/chmod.c"
  "%s: invalid mode\n", str
# 142 "project/radare2/libr/util/chmod.c" 3 4
  )
# 142 "project/radare2/libr/util/chmod.c"
                                     ;
   return 
# 143 "project/radare2/libr/util/chmod.c" 3 4
         0
# 143 "project/radare2/libr/util/chmod.c"
              ;
  }
 }
 if (mask) {
 ...
 return 
# 149 "project/radare2/libr/util/chmod.c" 3 4
       1
# 149 "project/radare2/libr/util/chmod.c"
           ;
}
...
static char *agetcwd(void) {
 ...
 if (!buf) {
  return 
# 155 "project/radare2/libr/util/chmod.c" 3 4
        ((void *)0)
# 155 "project/radare2/libr/util/chmod.c"
            ;
 }
 if (!getcwd (buf, 4096)) {
  
# 158 "project/radare2/libr/util/chmod.c" 3 4
 fprintf(__stderrp,
# 158 "project/radare2/libr/util/chmod.c"
 "getcwd:"
# 158 "project/radare2/libr/util/chmod.c" 3 4
 )
# 158 "project/radare2/libr/util/chmod.c"
...
static void recurse(const char *path, int rec, 
# 163 "project/radare2/libr/util/chmod.c" 3 4
                                              _Bool 
# 163 "project/radare2/libr/util/chmod.c"
                                                   (*fn)(const char *,int)) {
 char *cwd;
 struct dirent *d;
 struct stat st;
 ...
 if (lstat (path, &st) == -1 || !
# 169 "project/radare2/libr/util/chmod.c" 3 4
                                (((
# 169 "project/radare2/libr/util/chmod.c"
                                st.st_mode
# 169 "project/radare2/libr/util/chmod.c" 3 4
                                ) & 0170000) == 0040000)
# 169 "project/radare2/libr/util/chmod.c"
...
# 172 "project/radare2/libr/util/chmod.c" 3 4
 fprintf(__stderrp,
# 172 "project/radare2/libr/util/chmod.c"
 "opendir %s:", path
# 172 "project/radare2/libr/util/chmod.c" 3 4
 )
# 172 "project/radare2/libr/util/chmod.c"
...
# 177 "project/radare2/libr/util/chmod.c" 3 4
 fprintf(__stderrp,
# 177 "project/radare2/libr/util/chmod.c"
 "chdir %s:", path
# 177 "project/radare2/libr/util/chmod.c" 3 4
 )
# 177 "project/radare2/libr/util/chmod.c"
...
# 190 "project/radare2/libr/util/chmod.c" 3 4
 fprintf(__stderrp,
# 190 "project/radare2/libr/util/chmod.c"
 "chdir %s:", cwd
# 190 "project/radare2/libr/util/chmod.c" 3 4
 )
# 190 "project/radare2/libr/util/chmod.c"
