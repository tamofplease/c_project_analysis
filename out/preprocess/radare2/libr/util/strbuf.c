# 0 "project/radare2/libr/util/strbuf.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
typedef int RRef;
# 4 "project/radare2/libr/util/strbuf.c" 2
...
# 5 "project/radare2/libr/util/strbuf.c" 2


__attribute__((visibility("default"))) 
# 7 "project/radare2/libr/util/strbuf.c"
     RStrBuf *r_strbuf_new(const char *str) {
 RStrBuf *s = 
# 8 "project/radare2/libr/util/strbuf.c" 3 4
             (
# 8 "project/radare2/libr/util/strbuf.c"
             RStrBuf
# 8 "project/radare2/libr/util/strbuf.c" 3 4
             *)calloc(1,sizeof(
# 8 "project/radare2/libr/util/strbuf.c"
...
# 15 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 15 "project/radare2/libr/util/strbuf.c"
          r_strbuf_equals(RStrBuf *sa, RStrBuf *sb) {
 
# 16 "project/radare2/libr/util/strbuf.c" 3 4
do { if (!(
# 16 "project/radare2/libr/util/strbuf.c"
sa && sb
# 16 "project/radare2/libr/util/strbuf.c" 3 4
...
# 16 "project/radare2/libr/util/strbuf.c"
 ...
 if (sa->len != sb->len) {
  return 
# 18 "project/radare2/libr/util/strbuf.c" 3 4
        0
# 18 "project/radare2/libr/util/strbuf.c"
             ;
 }
...
# 23 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 23 "project/radare2/libr/util/strbuf.c"
          r_strbuf_is_empty(RStrBuf *sb) {
 return sb->len == 0;
}


# 27 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) 
# 27 "project/radare2/libr/util/strbuf.c"
     int r_strbuf_length(RStrBuf *sb) {
 
# 28 "project/radare2/libr/util/strbuf.c" 3 4
do { if (!(
# 28 "project/radare2/libr/util/strbuf.c"
sb
# 28 "project/radare2/libr/util/strbuf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 28 "project/radare2/libr/util/strbuf.c"
...
# 32 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) 
# 32 "project/radare2/libr/util/strbuf.c"
     void r_strbuf_init(RStrBuf *sb) {
 
# 33 "project/radare2/libr/util/strbuf.c" 3 4
do { if (!(
# 33 "project/radare2/libr/util/strbuf.c"
sb
# 33 "project/radare2/libr/util/strbuf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 33 "project/radare2/libr/util/strbuf.c"
...
# 34 "project/radare2/libr/util/strbuf.c" 3 4
__builtin___memset_chk (
# 34 "project/radare2/libr/util/strbuf.c"
sb
# 34 "project/radare2/libr/util/strbuf.c" 3 4
, 
# 34 "project/radare2/libr/util/strbuf.c"
...
# 37 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) 
# 37 "project/radare2/libr/util/strbuf.c"
     const char *r_strbuf_initf(RStrBuf *sb, const char *fmt, ...) {
 
# 38 "project/radare2/libr/util/strbuf.c" 3 4
do { if (!(
# 38 "project/radare2/libr/util/strbuf.c"
sb && fmt
# 38 "project/radare2/libr/util/strbuf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 38 "project/radare2/libr/util/strbuf.c"
...
# 41 "project/radare2/libr/util/strbuf.c" 3 4
__builtin_va_start(
# 41 "project/radare2/libr/util/strbuf.c"
ap
# 41 "project/radare2/libr/util/strbuf.c" 3 4
,
# 41 "project/radare2/libr/util/strbuf.c"
...
# 43 "project/radare2/libr/util/strbuf.c" 3 4
__builtin_va_end(
# 43 "project/radare2/libr/util/strbuf.c"
ap
# 43 "project/radare2/libr/util/strbuf.c" 3 4
)
# 43 "project/radare2/libr/util/strbuf.c"
...
# 47 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 47 "project/radare2/libr/util/strbuf.c"
          r_strbuf_copy(RStrBuf *dst, RStrBuf *src) {
 
# 48 "project/radare2/libr/util/strbuf.c" 3 4
do { if (!(
# 48 "project/radare2/libr/util/strbuf.c"
dst && src
# 48 "project/radare2/libr/util/strbuf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 48 "project/radare2/libr/util/strbuf.c"
...
# 48 "project/radare2/libr/util/strbuf.c"
 ...
 if (src->ptr) {
  ...
  if (!p) {
   return 
# 52 "project/radare2/libr/util/strbuf.c" 3 4
         0
# 52 "project/radare2/libr/util/strbuf.c"
              ;
  }
  
# 54 "project/radare2/libr/util/strbuf.c" 3 4
 __builtin___memcpy_chk (
# 54 "project/radare2/libr/util/strbuf.c"
 p
# 54 "project/radare2/libr/util/strbuf.c" 3 4
 , 
# 54 "project/radare2/libr/util/strbuf.c"
...
# 59 "project/radare2/libr/util/strbuf.c" 3 4
 { free((void *)
# 59 "project/radare2/libr/util/strbuf.c"
 dst->ptr
# 59 "project/radare2/libr/util/strbuf.c" 3 4
 ); 
# 59 "project/radare2/libr/util/strbuf.c"
...
# 60 "project/radare2/libr/util/strbuf.c" 3 4
 __builtin___memcpy_chk (
# 60 "project/radare2/libr/util/strbuf.c"
 dst->buf
# 60 "project/radare2/libr/util/strbuf.c" 3 4
 , 
# 60 "project/radare2/libr/util/strbuf.c"
 src->buf, sizeof (dst->buf)
# 60 "project/radare2/libr/util/strbuf.c" 3 4
 , __builtin_object_size (
# 60 "project/radare2/libr/util/strbuf.c"
 dst->buf
...
# 60 "project/radare2/libr/util/strbuf.c"
 ...
 dst->len = src->len;
 return 
# 63 "project/radare2/libr/util/strbuf.c" 3 4
       1
# 63 "project/radare2/libr/util/strbuf.c"
           ;
}


# 66 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 66 "project/radare2/libr/util/strbuf.c"
          r_strbuf_reserve(RStrBuf *sb, size_t len) {
 
# 67 "project/radare2/libr/util/strbuf.c" 3 4
do { if (!(
# 67 "project/radare2/libr/util/strbuf.c"
sb
# 67 "project/radare2/libr/util/strbuf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 67 "project/radare2/libr/util/strbuf.c"
...
# 67 "project/radare2/libr/util/strbuf.c"
 ...
 if ((sb->ptr && len < sb->ptrlen) || (!sb->ptr && len < sizeof (sb->buf))) {
  return 
# 70 "project/radare2/libr/util/strbuf.c" 3 4
        1
# 70 "project/radare2/libr/util/strbuf.c"
            ;
 }
 char *newptr = realloc (sb->ptr, len + 1);
 if (!newptr) {
  return 
# 74 "project/radare2/libr/util/strbuf.c" 3 4
        0
# 74 "project/radare2/libr/util/strbuf.c"
             ;
 }
 if (!sb->ptr) {
  
# 77 "project/radare2/libr/util/strbuf.c" 3 4
 __builtin___memcpy_chk (
# 77 "project/radare2/libr/util/strbuf.c"
 newptr
# 77 "project/radare2/libr/util/strbuf.c" 3 4
 , 
# 77 "project/radare2/libr/util/strbuf.c"
...
# 77 "project/radare2/libr/util/strbuf.c"
 ...
 sb->ptrlen = len + 1;
 return 
# 81 "project/radare2/libr/util/strbuf.c" 3 4
       1
# 81 "project/radare2/libr/util/strbuf.c"
           ;
}


# 84 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 84 "project/radare2/libr/util/strbuf.c"
          r_strbuf_setbin(RStrBuf *sb, const 
# 84 "project/radare2/libr/util/strbuf.c" 3 4
                                             unsigned char 
# 84 "project/radare2/libr/util/strbuf.c"
                                                 *s, size_t l) {
 
# 85 "project/radare2/libr/util/strbuf.c" 3 4
do { if (!(
# 85 "project/radare2/libr/util/strbuf.c"
sb && s
# 85 "project/radare2/libr/util/strbuf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 85 "project/radare2/libr/util/strbuf.c"
...
# 85 "project/radare2/libr/util/strbuf.c"
 ...
 if (l >= sizeof (sb->buf)) {
  ...
  if (!ptr || l + 1 > sb->ptrlen) {
   ...
   if (!ptr) {
    return 
# 91 "project/radare2/libr/util/strbuf.c" 3 4
          0
# 91 "project/radare2/libr/util/strbuf.c"
               ;
   }
   
# 93 "project/radare2/libr/util/strbuf.c" 3 4
  { free((void *)
# 93 "project/radare2/libr/util/strbuf.c"
  sb->ptr
# 93 "project/radare2/libr/util/strbuf.c" 3 4
  ); 
# 93 "project/radare2/libr/util/strbuf.c"
...
# 97 "project/radare2/libr/util/strbuf.c" 3 4
 __builtin___memcpy_chk (
# 97 "project/radare2/libr/util/strbuf.c"
 ptr
# 97 "project/radare2/libr/util/strbuf.c" 3 4
 , 
# 97 "project/radare2/libr/util/strbuf.c"
...
# 100 "project/radare2/libr/util/strbuf.c" 3 4
 { free((void *)
# 100 "project/radare2/libr/util/strbuf.c"
 sb->ptr
# 100 "project/radare2/libr/util/strbuf.c" 3 4
 ); 
# 100 "project/radare2/libr/util/strbuf.c"
...
# 101 "project/radare2/libr/util/strbuf.c" 3 4
 __builtin___memcpy_chk (
# 101 "project/radare2/libr/util/strbuf.c"
 sb->buf
# 101 "project/radare2/libr/util/strbuf.c" 3 4
 , 
# 101 "project/radare2/libr/util/strbuf.c"
...
# 101 "project/radare2/libr/util/strbuf.c"
 ...
 sb->len = l;
 sb->weakref = 
# 105 "project/radare2/libr/util/strbuf.c" 3 4
              0
# 105 "project/radare2/libr/util/strbuf.c"
                   ;
 return 
# 106 "project/radare2/libr/util/strbuf.c" 3 4
       1
# 106 "project/radare2/libr/util/strbuf.c"
           ;
}



# 110 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 110 "project/radare2/libr/util/strbuf.c"
          r_strbuf_slice(RStrBuf *sb, int from, int len) {
 
# 111 "project/radare2/libr/util/strbuf.c" 3 4
do { if (!(
# 111 "project/radare2/libr/util/strbuf.c"
sb && from >= 0 && len >= 0
# 111 "project/radare2/libr/util/strbuf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 111 "project/radare2/libr/util/strbuf.c"
"sb && from >= 0 && len >= 0"
# 111 "project/radare2/libr/util/strbuf.c" 3 4
, 111); return (0); } } while (0)
# 111 "project/radare2/libr/util/strbuf.c"
                                                         ;
 if (from < 1 && len >= sb->len) {
  return 
# 113 "project/radare2/libr/util/strbuf.c" 3 4
        0
# 113 "project/radare2/libr/util/strbuf.c"
             ;
 }
 ...
 if (from >= len) {
  ...
  free (r);
  return 
# 124 "project/radare2/libr/util/strbuf.c" 3 4
        0
# 124 "project/radare2/libr/util/strbuf.c"
             ;
 }
 r_strbuf_set (sb, r);
 free (r);
 return 
# 128 "project/radare2/libr/util/strbuf.c" 3 4
       1
# 128 "project/radare2/libr/util/strbuf.c"
           ;
}


# 131 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 131 "project/radare2/libr/util/strbuf.c"
          r_strbuf_setptr(RStrBuf *sb, char *s, int len) {
 
# 132 "project/radare2/libr/util/strbuf.c" 3 4
do { if (!(
# 132 "project/radare2/libr/util/strbuf.c"
sb
# 132 "project/radare2/libr/util/strbuf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 132 "project/radare2/libr/util/strbuf.c"
...
# 132 "project/radare2/libr/util/strbuf.c"
 ...
 sb->ptr = s;
 sb->weakref = 
# 141 "project/radare2/libr/util/strbuf.c" 3 4
              1
# 141 "project/radare2/libr/util/strbuf.c"
                  ;
 return 
# 142 "project/radare2/libr/util/strbuf.c" 3 4
       1
# 142 "project/radare2/libr/util/strbuf.c"
           ;
}


# 145 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) 
# 145 "project/radare2/libr/util/strbuf.c"
     const char *r_strbuf_set(RStrBuf *sb, const char *s) {
 
# 146 "project/radare2/libr/util/strbuf.c" 3 4
do { if (!(
# 146 "project/radare2/libr/util/strbuf.c"
sb
# 146 "project/radare2/libr/util/strbuf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 146 "project/radare2/libr/util/strbuf.c"
...
# 146 "project/radare2/libr/util/strbuf.c"
 ...
 size_t len = strlen (s);
 if (!r_strbuf_setbin (sb, (const 
# 152 "project/radare2/libr/util/strbuf.c" 3 4
                                 unsigned char
# 152 "project/radare2/libr/util/strbuf.c"
                                    *)s, len)) {
  return 
# 153 "project/radare2/libr/util/strbuf.c" 3 4
        ((void *)0)
# 153 "project/radare2/libr/util/strbuf.c"
            ;
 }
 sb->len = len;
 return r_strbuf_get (sb);
...
# 159 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) 
# 159 "project/radare2/libr/util/strbuf.c"
     const char *r_strbuf_setf(RStrBuf *sb, const char *fmt, ...) {
 
# 160 "project/radare2/libr/util/strbuf.c" 3 4
do { if (!(
# 160 "project/radare2/libr/util/strbuf.c"
sb && fmt
# 160 "project/radare2/libr/util/strbuf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 160 "project/radare2/libr/util/strbuf.c"
"sb && fmt"
# 160 "project/radare2/libr/util/strbuf.c" 3 4
, 160); return (0); } } while (0)
# 160 "project/radare2/libr/util/strbuf.c"
                                       ;

 va_list ap;
 
# 163 "project/radare2/libr/util/strbuf.c" 3 4
__builtin_va_start(
# 163 "project/radare2/libr/util/strbuf.c"
ap
# 163 "project/radare2/libr/util/strbuf.c" 3 4
,
# 163 "project/radare2/libr/util/strbuf.c"
...
# 165 "project/radare2/libr/util/strbuf.c" 3 4
__builtin_va_end(
# 165 "project/radare2/libr/util/strbuf.c"
ap
# 165 "project/radare2/libr/util/strbuf.c" 3 4
)
# 165 "project/radare2/libr/util/strbuf.c"
...
# 169 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) 
# 169 "project/radare2/libr/util/strbuf.c"
     const char *r_strbuf_vsetf(RStrBuf *sb, const char *fmt, va_list ap) {
 
# 170 "project/radare2/libr/util/strbuf.c" 3 4
do { if (!(
# 170 "project/radare2/libr/util/strbuf.c"
sb && fmt
# 170 "project/radare2/libr/util/strbuf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 170 "project/radare2/libr/util/strbuf.c"
"sb && fmt"
# 170 "project/radare2/libr/util/strbuf.c" 3 4
, 170); return (0); } } while (0)
# 170 "project/radare2/libr/util/strbuf.c"
                                       ;

 const char *ret = 
# 172 "project/radare2/libr/util/strbuf.c" 3 4
                  ((void *)0)
# 172 "project/radare2/libr/util/strbuf.c"
                      ;
 va_list ap2;
 
# 174 "project/radare2/libr/util/strbuf.c" 3 4
__builtin_va_copy(
# 174 "project/radare2/libr/util/strbuf.c"
ap2
# 174 "project/radare2/libr/util/strbuf.c" 3 4
,
# 174 "project/radare2/libr/util/strbuf.c"
...
# 174 "project/radare2/libr/util/strbuf.c"
 ...
 char string[1024];
 int rc = 
# 176 "project/radare2/libr/util/strbuf.c" 3 4
         __builtin___vsnprintf_chk (
# 176 "project/radare2/libr/util/strbuf.c"
         string
# 176 "project/radare2/libr/util/strbuf.c" 3 4
         , 
# 176 "project/radare2/libr/util/strbuf.c"
...
# 182 "project/radare2/libr/util/strbuf.c" 3 4
 __builtin___vsnprintf_chk (
# 182 "project/radare2/libr/util/strbuf.c"
 p
# 182 "project/radare2/libr/util/strbuf.c" 3 4
 , 
# 182 "project/radare2/libr/util/strbuf.c"
...
# 189 "project/radare2/libr/util/strbuf.c" 3 4
__builtin_va_end(
# 189 "project/radare2/libr/util/strbuf.c"
ap2
# 189 "project/radare2/libr/util/strbuf.c" 3 4
)
# 189 "project/radare2/libr/util/strbuf.c"
...
# 193 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 193 "project/radare2/libr/util/strbuf.c"
          r_strbuf_prepend(RStrBuf *sb, const char *s) {
 
# 194 "project/radare2/libr/util/strbuf.c" 3 4
do { if (!(
# 194 "project/radare2/libr/util/strbuf.c"
sb && s
# 194 "project/radare2/libr/util/strbuf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 194 "project/radare2/libr/util/strbuf.c"
...
# 194 "project/radare2/libr/util/strbuf.c"
 ...
 if (l == 0) {
  return 
# 198 "project/radare2/libr/util/strbuf.c" 3 4
        1
# 198 "project/radare2/libr/util/strbuf.c"
            ;
 }
 int newlen = l + sb->len;
 char *ns = malloc (newlen + 1);
 
# 202 "project/radare2/libr/util/strbuf.c" 3 4
_Bool 
# 202 "project/radare2/libr/util/strbuf.c"
     ret = 
# 202 "project/radare2/libr/util/strbuf.c" 3 4
           0
# 202 "project/radare2/libr/util/strbuf.c"
...
# 204 "project/radare2/libr/util/strbuf.c" 3 4
 __builtin___memcpy_chk (
# 204 "project/radare2/libr/util/strbuf.c"
 ns
# 204 "project/radare2/libr/util/strbuf.c" 3 4
 , 
# 204 "project/radare2/libr/util/strbuf.c"
...
# 206 "project/radare2/libr/util/strbuf.c" 3 4
 __builtin___memcpy_chk (
# 206 "project/radare2/libr/util/strbuf.c"
 ns + l
# 206 "project/radare2/libr/util/strbuf.c" 3 4
 , 
# 206 "project/radare2/libr/util/strbuf.c"
...
# 214 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 214 "project/radare2/libr/util/strbuf.c"
          r_strbuf_append(RStrBuf *sb, const char *s) {
 
# 215 "project/radare2/libr/util/strbuf.c" 3 4
do { if (!(
# 215 "project/radare2/libr/util/strbuf.c"
sb && s
# 215 "project/radare2/libr/util/strbuf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 215 "project/radare2/libr/util/strbuf.c"
...
# 221 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 221 "project/radare2/libr/util/strbuf.c"
          r_strbuf_append_n(RStrBuf *sb, const char *s, size_t l) {
 
# 222 "project/radare2/libr/util/strbuf.c" 3 4
do { if (!(
# 222 "project/radare2/libr/util/strbuf.c"
sb && s
# 222 "project/radare2/libr/util/strbuf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 222 "project/radare2/libr/util/strbuf.c"
"sb && s"
# 222 "project/radare2/libr/util/strbuf.c" 3 4
, 222); return (0); } } while (0)
# 222 "project/radare2/libr/util/strbuf.c"
                                     ;

 if (sb->weakref) {
  return 
# 225 "project/radare2/libr/util/strbuf.c" 3 4
        0
# 225 "project/radare2/libr/util/strbuf.c"
             ;
 }
 ...
 if (l == 0) {
  return 
# 230 "project/radare2/libr/util/strbuf.c" 3 4
        1
# 230 "project/radare2/libr/util/strbuf.c"
            ;
 }

 if ((sb->len + l + 1) <= sizeof (sb->buf)) {
  
# 234 "project/radare2/libr/util/strbuf.c" 3 4
 __builtin___memcpy_chk (
# 234 "project/radare2/libr/util/strbuf.c"
 sb->buf + sb->len
# 234 "project/radare2/libr/util/strbuf.c" 3 4
 , 
# 234 "project/radare2/libr/util/strbuf.c"
...
# 236 "project/radare2/libr/util/strbuf.c" 3 4
 { free((void *)
# 236 "project/radare2/libr/util/strbuf.c"
 sb->ptr
# 236 "project/radare2/libr/util/strbuf.c" 3 4
 ); 
# 236 "project/radare2/libr/util/strbuf.c"
...
# 240 "project/radare2/libr/util/strbuf.c" 3 4
 _Bool 
# 240 "project/radare2/libr/util/strbuf.c"
      allocated = 
# 240 "project/radare2/libr/util/strbuf.c" 3 4
                  1
# 240 "project/radare2/libr/util/strbuf.c"
...
# 244 "project/radare2/libr/util/strbuf.c" 3 4
   __builtin___memcpy_chk (
# 244 "project/radare2/libr/util/strbuf.c"
   p
# 244 "project/radare2/libr/util/strbuf.c" 3 4
   , 
# 244 "project/radare2/libr/util/strbuf.c"
...
# 244 "project/radare2/libr/util/strbuf.c"
   ...
   allocated = 
# 249 "project/radare2/libr/util/strbuf.c" 3 4
              0
# 249 "project/radare2/libr/util/strbuf.c"
                   ;
  }
  if (allocated) {
   if (!p) {
    return 
# 253 "project/radare2/libr/util/strbuf.c" 3 4
          0
# 253 "project/radare2/libr/util/strbuf.c"
               ;
   }
   sb->ptr = p;
   sb->ptrlen = newlen;
...
# 259 "project/radare2/libr/util/strbuf.c" 3 4
  __builtin___memcpy_chk (
# 259 "project/radare2/libr/util/strbuf.c"
  p + sb->len
# 259 "project/radare2/libr/util/strbuf.c" 3 4
  , 
# 259 "project/radare2/libr/util/strbuf.c"
...
# 259 "project/radare2/libr/util/strbuf.c"
 ...
 sb->len += l;
 return 
# 264 "project/radare2/libr/util/strbuf.c" 3 4
       1
# 264 "project/radare2/libr/util/strbuf.c"
           ;
}


# 267 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 267 "project/radare2/libr/util/strbuf.c"
          r_strbuf_appendf(RStrBuf *sb, const char *fmt, ...) {
 va_list ap;

 
# 270 "project/radare2/libr/util/strbuf.c" 3 4
do { if (!(
# 270 "project/radare2/libr/util/strbuf.c"
sb && fmt
# 270 "project/radare2/libr/util/strbuf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 270 "project/radare2/libr/util/strbuf.c"
...
# 272 "project/radare2/libr/util/strbuf.c" 3 4
__builtin_va_start(
# 272 "project/radare2/libr/util/strbuf.c"
ap
# 272 "project/radare2/libr/util/strbuf.c" 3 4
,
# 272 "project/radare2/libr/util/strbuf.c"
...
# 273 "project/radare2/libr/util/strbuf.c" 3 4
_Bool 
# 273 "project/radare2/libr/util/strbuf.c"
     ret = r_strbuf_vappendf (sb, fmt, ap);
 
# 274 "project/radare2/libr/util/strbuf.c" 3 4
__builtin_va_end(
# 274 "project/radare2/libr/util/strbuf.c"
ap
# 274 "project/radare2/libr/util/strbuf.c" 3 4
)
# 274 "project/radare2/libr/util/strbuf.c"
...
# 278 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 278 "project/radare2/libr/util/strbuf.c"
          r_strbuf_vappendf(RStrBuf *sb, const char *fmt, va_list ap) {
 int ret;
 va_list ap2;
 char string[1024];

 
# 283 "project/radare2/libr/util/strbuf.c" 3 4
do { if (!(
# 283 "project/radare2/libr/util/strbuf.c"
sb && fmt
# 283 "project/radare2/libr/util/strbuf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 283 "project/radare2/libr/util/strbuf.c"
...
# 283 "project/radare2/libr/util/strbuf.c"
 ...
 if (sb->weakref) {
  return 
# 286 "project/radare2/libr/util/strbuf.c" 3 4
        0
# 286 "project/radare2/libr/util/strbuf.c"
             ;
 }
 
# 288 "project/radare2/libr/util/strbuf.c" 3 4
__builtin_va_copy(
# 288 "project/radare2/libr/util/strbuf.c"
ap2
# 288 "project/radare2/libr/util/strbuf.c" 3 4
,
# 288 "project/radare2/libr/util/strbuf.c"
...
# 288 "project/radare2/libr/util/strbuf.c"
                 ;
 ret = 
# 289 "project/radare2/libr/util/strbuf.c" 3 4
      __builtin___vsnprintf_chk (
# 289 "project/radare2/libr/util/strbuf.c"
      string
# 289 "project/radare2/libr/util/strbuf.c" 3 4
      , 
# 289 "project/radare2/libr/util/strbuf.c"
...
# 293 "project/radare2/libr/util/strbuf.c" 3 4
  __builtin_va_end(
# 293 "project/radare2/libr/util/strbuf.c"
  ap2
# 293 "project/radare2/libr/util/strbuf.c" 3 4
  )
# 293 "project/radare2/libr/util/strbuf.c"
              ;
   return 
# 294 "project/radare2/libr/util/strbuf.c" 3 4
         0
# 294 "project/radare2/libr/util/strbuf.c"
              ;
  }
  *p = 0;
  
# 297 "project/radare2/libr/util/strbuf.c" 3 4
 __builtin___vsnprintf_chk (
# 297 "project/radare2/libr/util/strbuf.c"
 p
# 297 "project/radare2/libr/util/strbuf.c" 3 4
 , 
# 297 "project/radare2/libr/util/strbuf.c"
...
# 297 "project/radare2/libr/util/strbuf.c"
  ...
  ret = 
# 303 "project/radare2/libr/util/strbuf.c" 3 4
       0
# 303 "project/radare2/libr/util/strbuf.c"
            ;
 }
 
# 305 "project/radare2/libr/util/strbuf.c" 3 4
__builtin_va_end(
# 305 "project/radare2/libr/util/strbuf.c"
ap2
# 305 "project/radare2/libr/util/strbuf.c" 3 4
)
# 305 "project/radare2/libr/util/strbuf.c"
...
# 309 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) 
# 309 "project/radare2/libr/util/strbuf.c"
     char *r_strbuf_get(RStrBuf *sb) {
 
# 310 "project/radare2/libr/util/strbuf.c" 3 4
do { if (!(
# 310 "project/radare2/libr/util/strbuf.c"
sb
# 310 "project/radare2/libr/util/strbuf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 310 "project/radare2/libr/util/strbuf.c"
...
# 314 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 314 "project/radare2/libr/util/strbuf.c"
         *r_strbuf_getbin(RStrBuf *sb, int *len) {
 
# 315 "project/radare2/libr/util/strbuf.c" 3 4
do { if (!(
# 315 "project/radare2/libr/util/strbuf.c"
sb
# 315 "project/radare2/libr/util/strbuf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 315 "project/radare2/libr/util/strbuf.c"
...
# 315 "project/radare2/libr/util/strbuf.c"
 ...
 return (
# 319 "project/radare2/libr/util/strbuf.c" 3 4
        unsigned char 
# 319 "project/radare2/libr/util/strbuf.c"
            *)(sb->ptr ? sb->ptr : sb->buf);
}
...
# 330 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) 
# 330 "project/radare2/libr/util/strbuf.c"
     char *r_strbuf_drain(RStrBuf *sb) {
 
# 331 "project/radare2/libr/util/strbuf.c" 3 4
do { if (!(
# 331 "project/radare2/libr/util/strbuf.c"
sb
# 331 "project/radare2/libr/util/strbuf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 331 "project/radare2/libr/util/strbuf.c"
...
# 337 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) 
# 337 "project/radare2/libr/util/strbuf.c"
     char *r_strbuf_drain_nofree(RStrBuf *sb) {
 
# 338 "project/radare2/libr/util/strbuf.c" 3 4
do { if (!(
# 338 "project/radare2/libr/util/strbuf.c"
sb
# 338 "project/radare2/libr/util/strbuf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 338 "project/radare2/libr/util/strbuf.c"
"sb"
# 338 "project/radare2/libr/util/strbuf.c" 3 4
, 338); return (((void *)0)); } } while (0)
# 338 "project/radare2/libr/util/strbuf.c"
                               ;
 char *ret = drain (sb);
 sb->ptr = 
# 340 "project/radare2/libr/util/strbuf.c" 3 4
          ((void *)0)
# 340 "project/radare2/libr/util/strbuf.c"
              ;
 sb->len = 0;
 sb->buf[0] = '\0';
 return ret;
...
# 346 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) 
# 346 "project/radare2/libr/util/strbuf.c"
...
# 353 "project/radare2/libr/util/strbuf.c" 3 4
__attribute__((visibility("default"))) 
# 353 "project/radare2/libr/util/strbuf.c"
     void r_strbuf_fini(RStrBuf *sb) {
 if (sb && !sb->weakref) {
  
# 355 "project/radare2/libr/util/strbuf.c" 3 4
 { free((void *)
# 355 "project/radare2/libr/util/strbuf.c"
 sb->ptr
# 355 "project/radare2/libr/util/strbuf.c" 3 4
 ); 
# 355 "project/radare2/libr/util/strbuf.c"
