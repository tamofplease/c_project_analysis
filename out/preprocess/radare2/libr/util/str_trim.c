# 0 "project/radare2/libr/util/str_trim.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/str_trim.c"
...
typedef int RRef;
# 4 "project/radare2/libr/util/str_trim.c" 2
...
# 5 "project/radare2/libr/util/str_trim.c" 2
...
# 7 "project/radare2/libr/util/str_trim.c" 2
...
# 14 "project/radare2/libr/util/str_trim.c"
     void r_str_trim_path(char *s) {
 char *src, *dst, *p;
 int i = 0;
 if (!s || !*s) {
  return;
...
# 59 "project/radare2/libr/util/str_trim.c" 3 4
__attribute__((visibility("default"))) 
# 59 "project/radare2/libr/util/str_trim.c"
     char* r_str_trim_lines(char *str) {
 RList *list = r_str_split_list (str, "\n", 0);
 char *s;
 RListIter *iter;
 RStrBuf *sb = r_strbuf_new ("");
 
# 64 "project/radare2/libr/util/str_trim.c" 3 4
if (
# 64 "project/radare2/libr/util/str_trim.c"
list
# 64 "project/radare2/libr/util/str_trim.c" 3 4
) for (
# 64 "project/radare2/libr/util/str_trim.c"
...
# 64 "project/radare2/libr/util/str_trim.c"
  ...
  r_str_ansi_filter (s, 
# 66 "project/radare2/libr/util/str_trim.c" 3 4
                       ((void *)0)
# 66 "project/radare2/libr/util/str_trim.c"
                           , 
# 66 "project/radare2/libr/util/str_trim.c" 3 4
                             ((void *)0)
# 66 "project/radare2/libr/util/str_trim.c"
...
# 77 "project/radare2/libr/util/str_trim.c" 3 4
__attribute__((visibility("default"))) 
# 77 "project/radare2/libr/util/str_trim.c"
...
# 85 "project/radare2/libr/util/str_trim.c" 3 4
__attribute__((visibility("default"))) 
# 85 "project/radare2/libr/util/str_trim.c"
     const char *r_str_trim_head_ro(const char *str) {
 
# 86 "project/radare2/libr/util/str_trim.c" 3 4
do { if (!(
# 86 "project/radare2/libr/util/str_trim.c"
str
# 86 "project/radare2/libr/util/str_trim.c" 3 4
...
# 86 "project/radare2/libr/util/str_trim.c"
                                ;
 for (; *str && 
# 87 "project/radare2/libr/util/str_trim.c" 3 4
               ((
# 87 "project/radare2/libr/util/str_trim.c"
               *str
# 87 "project/radare2/libr/util/str_trim.c" 3 4
               ) == ' ' || (
# 87 "project/radare2/libr/util/str_trim.c"
...
# 94 "project/radare2/libr/util/str_trim.c" 3 4
__attribute__((visibility("default"))) 
# 94 "project/radare2/libr/util/str_trim.c"
     const char *r_str_trim_head_wp(const char *str) {
 
# 95 "project/radare2/libr/util/str_trim.c" 3 4
do { if (!(
# 95 "project/radare2/libr/util/str_trim.c"
str
# 95 "project/radare2/libr/util/str_trim.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 95 "project/radare2/libr/util/str_trim.c"
...
# 95 "project/radare2/libr/util/str_trim.c"
                                ;
 for (; *str && !
# 96 "project/radare2/libr/util/str_trim.c" 3 4
                ((
# 96 "project/radare2/libr/util/str_trim.c"
                *str
# 96 "project/radare2/libr/util/str_trim.c" 3 4
                ) == ' ' || (
# 96 "project/radare2/libr/util/str_trim.c"
...
# 104 "project/radare2/libr/util/str_trim.c" 3 4
__attribute__((visibility("default"))) 
# 104 "project/radare2/libr/util/str_trim.c"
     void r_str_trim_head(char *str) {
 char *p = (char *)r_str_trim_head_ro (str);
 if (p && p != str) {
  
# 107 "project/radare2/libr/util/str_trim.c" 3 4
 __builtin___memmove_chk (
# 107 "project/radare2/libr/util/str_trim.c"
 str
# 107 "project/radare2/libr/util/str_trim.c" 3 4
 , 
# 107 "project/radare2/libr/util/str_trim.c"
...
# 114 "project/radare2/libr/util/str_trim.c" 3 4
__attribute__((visibility("default"))) 
# 114 "project/radare2/libr/util/str_trim.c"
     void r_str_trim_args(char *str) {
 const char *quotes = "\"'";
 const char *isquote;
 int idx, _b = 0, q = 0;
 
# 118 "project/radare2/libr/util/str_trim.c" 3 4
unsigned char 
# 118 "project/radare2/libr/util/str_trim.c"
    *b = (
# 118 "project/radare2/libr/util/str_trim.c" 3 4
          unsigned char
# 118 "project/radare2/libr/util/str_trim.c"
 ...
 while (*ws) {
  ...
  if (isquote) {
   ...
   _b = 
# 132 "project/radare2/libr/util/str_trim.c" 3 4
       ( (*(
# 132 "project/radare2/libr/util/str_trim.c"
       b
# 132 "project/radare2/libr/util/str_trim.c" 3 4
       ) & (1<<(
# 132 "project/radare2/libr/util/str_trim.c"
...
# 136 "project/radare2/libr/util/str_trim.c" 3 4
 __builtin___memmove_chk (
# 136 "project/radare2/libr/util/str_trim.c"
 ws + 1
# 136 "project/radare2/libr/util/str_trim.c" 3 4
 , 
# 136 "project/radare2/libr/util/str_trim.c"
  ...
  if (q == 1) {
   ...
   for (; *ch; ch++) {
    ...
    if (isquote) {
     idx = (int)(size_t)(isquote - quotes);
     _b = 
# 148 "project/radare2/libr/util/str_trim.c" 3 4
         ( (*(
# 148 "project/radare2/libr/util/str_trim.c"
         b
# 148 "project/radare2/libr/util/str_trim.c" 3 4
         ) & (1<<(
# 148 "project/radare2/libr/util/str_trim.c"
...
# 148 "project/radare2/libr/util/str_trim.c"
     ...
     if (!_b) {
      ...
      _b = 
# 152 "project/radare2/libr/util/str_trim.c" 3 4
          ( (*(
# 152 "project/radare2/libr/util/str_trim.c"
          b
# 152 "project/radare2/libr/util/str_trim.c" 3 4
          ) & (1<<(
# 152 "project/radare2/libr/util/str_trim.c"
...
# 172 "project/radare2/libr/util/str_trim.c" 3 4
__attribute__((visibility("default"))) 
# 172 "project/radare2/libr/util/str_trim.c"
     void r_str_trim_tail(char *str) {
 
# 173 "project/radare2/libr/util/str_trim.c" 3 4
do { if (!(
# 173 "project/radare2/libr/util/str_trim.c"
str
# 173 "project/radare2/libr/util/str_trim.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 173 "project/radare2/libr/util/str_trim.c"
...
# 173 "project/radare2/libr/util/str_trim.c"
 ...
 while (length-- > 0) {
  if (
# 176 "project/radare2/libr/util/str_trim.c" 3 4
     ((
# 176 "project/radare2/libr/util/str_trim.c"
     str[length]
# 176 "project/radare2/libr/util/str_trim.c" 3 4
     ) == ' ' || (
# 176 "project/radare2/libr/util/str_trim.c"
...
# 186 "project/radare2/libr/util/str_trim.c" 3 4
__attribute__((visibility("default"))) 
# 186 "project/radare2/libr/util/str_trim.c"
     void r_str_trim(char *str) {
 r_str_trim_head (str);
 r_str_trim_tail (str);
}
...
# 193 "project/radare2/libr/util/str_trim.c" 3 4
__attribute__((visibility("default"))) 
# 193 "project/radare2/libr/util/str_trim.c"
...
# 200 "project/radare2/libr/util/str_trim.c" 3 4
__attribute__((visibility("default"))) 
# 200 "project/radare2/libr/util/str_trim.c"
     int r_str_ansi_trim(char *str, int str_len, int n) {
 
# 201 "project/radare2/libr/util/str_trim.c" 3 4
do { if (!(
# 201 "project/radare2/libr/util/str_trim.c"
str
# 201 "project/radare2/libr/util/str_trim.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 201 "project/radare2/libr/util/str_trim.c"
