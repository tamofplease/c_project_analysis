# 0 "project/radare2/libr/util/alloc.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/util/alloc.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_alloc.h" 1 3 4
# 5 "project/radare2/libr/util/alloc.c" 2

__attribute__((visibility("default"))) 
# 6 "project/radare2/libr/util/alloc.c"
     void r_alloc_init (void) {



}
# 61 "project/radare2/libr/util/alloc.c"

# 61 "project/radare2/libr/util/alloc.c" 3 4
__attribute__((visibility("default"))) 
# 61 "project/radare2/libr/util/alloc.c"
     void* r_malloc_aligned(size_t size, size_t alignment) {
 int offset = alignment - 1 + sizeof (void*);
 void* p1 = 
# 63 "project/radare2/libr/util/alloc.c" 3 4
           malloc((
# 63 "project/radare2/libr/util/alloc.c"
           size + offset
# 63 "project/radare2/libr/util/alloc.c" 3 4
           ))
# 63 "project/radare2/libr/util/alloc.c"
 ...
 if (!p1) {
  return 
# 65 "project/radare2/libr/util/alloc.c" 3 4
        ((void *)0)
# 65 "project/radare2/libr/util/alloc.c"
            ;
 }
...
# 72 "project/radare2/libr/util/alloc.c" 3 4
__attribute__((visibility("default"))) 
# 72 "project/radare2/libr/util/alloc.c"
     void r_free_aligned(void *p) {
 
# 73 "project/radare2/libr/util/alloc.c" 3 4
free((
# 73 "project/radare2/libr/util/alloc.c"
((void**)p)[-1]
# 73 "project/radare2/libr/util/alloc.c" 3 4
))
# 73 "project/radare2/libr/util/alloc.c"
