# 0 "project/radare2/libr/util/sstext.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/sstext.c"
...
# 6 "project/radare2/libr/util/sstext.c" 2
...
# 7 "project/radare2/libr/util/sstext.c" 2
...
# 8 "project/radare2/libr/util/sstext.c" 2



# 10 "project/radare2/libr/util/sstext.c"
typedef struct {
 char ch;
 const char *l[3];
} SevenSegments;
...
# 455 "project/radare2/libr/util/sstext.c" 3 4
__attribute__((visibility("default"))) 
# 455 "project/radare2/libr/util/sstext.c"
     char *r_str_ss(const char* msg, const char *nl, int cs) {
 if (!nl) {
  nl = "\n";
 }
 int i, j, n;
...
# 464 "project/radare2/libr/util/sstext.c" 3 4
if (
# 464 "project/radare2/libr/util/sstext.c"
lines
# 464 "project/radare2/libr/util/sstext.c" 3 4
) for (
# 464 "project/radare2/libr/util/sstext.c"
