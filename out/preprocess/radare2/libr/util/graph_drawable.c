# 0 "project/radare2/libr/util/graph_drawable.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/graph_drawable.c"
...
# 2 "project/radare2/libr/util/graph_drawable.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_graph_drawable.h" 1 3 4
# 17 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_graph_drawable.h" 3 4
...
__attribute__((visibility("default"))) void r_graph_free_node_info(void *ptr);
__attribute__((visibility("default"))) RGraphNodeInfo *r_graph_create_node_info(const char *title, const char *body, unsigned long long offset);
__attribute__((visibility("default"))) RGraphNode *r_graph_add_node_info(RGraph *graph, const char *title, const char *body, unsigned long long offset);
# 40 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_graph_drawable.h" 3 4
__attribute__((visibility("default"))) char *r_graph_drawable_to_dot(RGraph *graph, const char *node_properties, const char *edge_properties);
...
__attribute__((visibility("default"))) void r_graph_drawable_to_json(RGraph *graph, PJ *pj, _Bool use_offset);
# 3 "project/radare2/libr/util/graph_drawable.c" 2

__attribute__((visibility("default"))) 
# 4 "project/radare2/libr/util/graph_drawable.c"
     void r_graph_free_node_info(void *ptr) {
 if (!ptr) {
  return;
 }
...
# 14 "project/radare2/libr/util/graph_drawable.c" 3 4
__attribute__((visibility("default"))) 
# 14 "project/radare2/libr/util/graph_drawable.c"
     RGraphNodeInfo *r_graph_create_node_info(const char *title, const char *body, 
# 14 "project/radare2/libr/util/graph_drawable.c" 3 4
                                                                                   unsigned long long 
# 14 "project/radare2/libr/util/graph_drawable.c"
                                                                                        offset) {
 RGraphNodeInfo *data = 
# 15 "project/radare2/libr/util/graph_drawable.c" 3 4
                       (
# 15 "project/radare2/libr/util/graph_drawable.c"
                       RGraphNodeInfo
# 15 "project/radare2/libr/util/graph_drawable.c" 3 4
                       *)calloc(1,sizeof(
# 15 "project/radare2/libr/util/graph_drawable.c"
...
# 15 "project/radare2/libr/util/graph_drawable.c"
 ...
 if (data) {
  data->title = 
# 17 "project/radare2/libr/util/graph_drawable.c" 3 4
               ((
# 17 "project/radare2/libr/util/graph_drawable.c"
               title
# 17 "project/radare2/libr/util/graph_drawable.c" 3 4
               ) ? strdup ((
# 17 "project/radare2/libr/util/graph_drawable.c"
...
# 17 "project/radare2/libr/util/graph_drawable.c"
                                ;
  data->body = 
# 18 "project/radare2/libr/util/graph_drawable.c" 3 4
              ((
# 18 "project/radare2/libr/util/graph_drawable.c"
              body
# 18 "project/radare2/libr/util/graph_drawable.c" 3 4
              ) ? strdup ((
# 18 "project/radare2/libr/util/graph_drawable.c"
...
# 24 "project/radare2/libr/util/graph_drawable.c" 3 4
__attribute__((visibility("default"))) 
# 24 "project/radare2/libr/util/graph_drawable.c"
     RGraphNode *r_graph_add_node_info(RGraph *graph, const char *title, const char *body, 
# 24 "project/radare2/libr/util/graph_drawable.c" 3 4
                                                                                           unsigned long long 
# 24 "project/radare2/libr/util/graph_drawable.c"
                                                                                                offset) {
 
# 25 "project/radare2/libr/util/graph_drawable.c" 3 4
do { if (!(
# 25 "project/radare2/libr/util/graph_drawable.c"
graph
# 25 "project/radare2/libr/util/graph_drawable.c" 3 4
...
"graph"
# 25 "project/radare2/libr/util/graph_drawable.c" 3 4
, 25); return (((void *)0)); } } while (0)
# 25 "project/radare2/libr/util/graph_drawable.c"
                                  ;
 RGraphNodeInfo *data = r_graph_create_node_info (title, body, offset);
 if (!data) {
  return 
# 28 "project/radare2/libr/util/graph_drawable.c" 3 4
        ((void *)0)
# 28 "project/radare2/libr/util/graph_drawable.c"
            ;
 }
...
# 37 "project/radare2/libr/util/graph_drawable.c" 3 4
__attribute__((visibility("default"))) 
# 37 "project/radare2/libr/util/graph_drawable.c"
     char *r_graph_drawable_to_dot(RGraph *graph, const char *node_properties, const char *edge_properties) {
 RList *nodes = graph->nodes;
 RListIter *it, *itt;
 RGraphNode *node = 
# 40 "project/radare2/libr/util/graph_drawable.c" 3 4
                   ((void *)0)
# 40 "project/radare2/libr/util/graph_drawable.c"
                       , *target = 
# 40 "project/radare2/libr/util/graph_drawable.c" 3 4
                                   ((void *)0)
# 40 "project/radare2/libr/util/graph_drawable.c"
...
# 51 "project/radare2/libr/util/graph_drawable.c" 3 4
if (
# 51 "project/radare2/libr/util/graph_drawable.c"
nodes
# 51 "project/radare2/libr/util/graph_drawable.c" 3 4
) for (
# 51 "project/radare2/libr/util/graph_drawable.c"
...
# 61 "project/radare2/libr/util/graph_drawable.c" 3 4
 if (
# 61 "project/radare2/libr/util/graph_drawable.c"
 node->out_nodes
# 61 "project/radare2/libr/util/graph_drawable.c" 3 4
 ) for (
# 61 "project/radare2/libr/util/graph_drawable.c"
...
# 69 "project/radare2/libr/util/graph_drawable.c" 3 4
__attribute__((visibility("default"))) 
# 69 "project/radare2/libr/util/graph_drawable.c"
     void r_graph_drawable_to_json(RGraph *graph, PJ *pj, 
# 69 "project/radare2/libr/util/graph_drawable.c" 3 4
                                                                             _Bool 
# 69 "project/radare2/libr/util/graph_drawable.c"
                                                                                  use_offset) {
 RList *nodes = graph->nodes, *neighbours = 
# 70 "project/radare2/libr/util/graph_drawable.c" 3 4
                                           ((void *)0)
# 70 "project/radare2/libr/util/graph_drawable.c"
                                               ;
 RListIter *it, *itt;
 RGraphNode *node = 
# 72 "project/radare2/libr/util/graph_drawable.c" 3 4
                   ((void *)0)
# 72 "project/radare2/libr/util/graph_drawable.c"
                       , *neighbour = 
# 72 "project/radare2/libr/util/graph_drawable.c" 3 4
                                      ((void *)0)
# 72 "project/radare2/libr/util/graph_drawable.c"
...
# 80 "project/radare2/libr/util/graph_drawable.c" 3 4
if (
# 80 "project/radare2/libr/util/graph_drawable.c"
nodes
# 80 "project/radare2/libr/util/graph_drawable.c" 3 4
) for (
# 80 "project/radare2/libr/util/graph_drawable.c"
...
# 96 "project/radare2/libr/util/graph_drawable.c" 3 4
 if (
# 96 "project/radare2/libr/util/graph_drawable.c"
 neighbours
# 96 "project/radare2/libr/util/graph_drawable.c" 3 4
 ) for (
# 96 "project/radare2/libr/util/graph_drawable.c"
