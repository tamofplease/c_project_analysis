# 0 "project/radare2/libr/util/log.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 7 "project/radare2/libr/util/log.c" 2




# 10 "project/radare2/libr/util/log.c"
static RList *log_cbs = 
# 10 "project/radare2/libr/util/log.c" 3 4
                       ((void *)0)
# 10 "project/radare2/libr/util/log.c"
                           ;
...
static 
# 13 "project/radare2/libr/util/log.c" 3 4
      _Bool 
# 13 "project/radare2/libr/util/log.c"
           cfg_logsrcinfo = 
# 13 "project/radare2/libr/util/log.c" 3 4
                            0
# 13 "project/radare2/libr/util/log.c"
                                 ;
static 
# 14 "project/radare2/libr/util/log.c" 3 4
      _Bool 
# 14 "project/radare2/libr/util/log.c"
           cfg_logcolors = 
# 14 "project/radare2/libr/util/log.c" 3 4
                           0
# 14 "project/radare2/libr/util/log.c"
...
# 27 "project/radare2/libr/util/log.c" 3 4
__attribute__((visibility("default"))) 
# 27 "project/radare2/libr/util/log.c"
     void r_log_set_level(RLogLevel level) {
 cfg_loglvl = level;
}


# 31 "project/radare2/libr/util/log.c" 3 4
__attribute__((visibility("default"))) 
# 31 "project/radare2/libr/util/log.c"
     void r_log_set_traplevel(RLogLevel level) {
 cfg_logtraplvl = level;
}


# 35 "project/radare2/libr/util/log.c" 3 4
__attribute__((visibility("default"))) 
# 35 "project/radare2/libr/util/log.c"
     void r_log_set_file(const char *filename) {
 int value_len = r_str_nlen (filename, 512) + 1;
 
# 37 "project/radare2/libr/util/log.c" 3 4
__builtin___strncpy_chk (
# 37 "project/radare2/libr/util/log.c"
cfg_logfile
# 37 "project/radare2/libr/util/log.c" 3 4
, 
# 37 "project/radare2/libr/util/log.c"
...
# 40 "project/radare2/libr/util/log.c" 3 4
__attribute__((visibility("default"))) 
# 40 "project/radare2/libr/util/log.c"
     void r_log_set_srcinfo(
# 40 "project/radare2/libr/util/log.c" 3 4
                            _Bool 
# 40 "project/radare2/libr/util/log.c"
                                 show_info) {
...
# 44 "project/radare2/libr/util/log.c" 3 4
__attribute__((visibility("default"))) 
# 44 "project/radare2/libr/util/log.c"
     void r_log_set_colors(
# 44 "project/radare2/libr/util/log.c" 3 4
                           _Bool 
# 44 "project/radare2/libr/util/log.c"
                                show_info) {
...
# 52 "project/radare2/libr/util/log.c" 3 4
__attribute__((visibility("default"))) 
# 52 "project/radare2/libr/util/log.c"
     void r_log_add_callback(RLogCallback cbfunc) {
 if (!log_cbs) {
  log_cbs = r_list_new ();
 }
...
# 65 "project/radare2/libr/util/log.c" 3 4
__attribute__((visibility("default"))) 
# 65 "project/radare2/libr/util/log.c"
     void r_log_del_callback(RLogCallback cbfunc) {
 if (log_cbs) {
...
# 71 "project/radare2/libr/util/log.c" 3 4
__attribute__((visibility("default"))) 
# 71 "project/radare2/libr/util/log.c"
     void r_vlog(const char *funcname, const char *filename,
 
# 72 "project/radare2/libr/util/log.c" 3 4
unsigned int 
# 72 "project/radare2/libr/util/log.c"
     lineno, RLogLevel level, const char *tag, const char *fmtstr, va_list args) {
 va_list args_copy;
 
# 74 "project/radare2/libr/util/log.c" 3 4
__builtin_va_copy(
# 74 "project/radare2/libr/util/log.c"
args_copy
# 74 "project/radare2/libr/util/log.c" 3 4
,
# 74 "project/radare2/libr/util/log.c"
...
# 79 "project/radare2/libr/util/log.c" 3 4
 __builtin_va_end(
# 79 "project/radare2/libr/util/log.c"
 args_copy
# 79 "project/radare2/libr/util/log.c" 3 4
 )
# 79 "project/radare2/libr/util/log.c"
 ...
 if (!tag) {
  tag = 
# 88 "project/radare2/libr/util/log.c" 3 4
       (((
# 88 "project/radare2/libr/util/log.c"
       level
# 88 "project/radare2/libr/util/log.c" 3 4
       )>=(
# 88 "project/radare2/libr/util/log.c"
...
# 88 "project/radare2/libr/util/log.c"
 ...
 int offset = 
# 90 "project/radare2/libr/util/log.c" 3 4
             __builtin___snprintf_chk (
# 90 "project/radare2/libr/util/log.c"
             output_buf
# 90 "project/radare2/libr/util/log.c" 3 4
             , 
# 90 "project/radare2/libr/util/log.c"
...
# 90 "project/radare2/libr/util/log.c"
 ...
 if (cfg_logsrcinfo) {
  offset += 
# 92 "project/radare2/libr/util/log.c" 3 4
           __builtin___snprintf_chk (
# 92 "project/radare2/libr/util/log.c"
           output_buf + offset
# 92 "project/radare2/libr/util/log.c" 3 4
           , 
# 92 "project/radare2/libr/util/log.c"
...
# 92 "project/radare2/libr/util/log.c" 3 4
           , 2 > 1 ? 1 : 0), 
# 92 "project/radare2/libr/util/log.c"
           "%s in %s:%i: ", funcname, filename, lineno
# 92 "project/radare2/libr/util/log.c" 3 4
           )
# 92 "project/radare2/libr/util/log.c"
                                                                                                                   ;
...
# 94 "project/radare2/libr/util/log.c" 3 4
__builtin___vsnprintf_chk (
# 94 "project/radare2/libr/util/log.c"
output_buf + offset
# 94 "project/radare2/libr/util/log.c" 3 4
, 
# 94 "project/radare2/libr/util/log.c"
...
# 101 "project/radare2/libr/util/log.c" 3 4
 if (
# 101 "project/radare2/libr/util/log.c"
 log_cbs
# 101 "project/radare2/libr/util/log.c" 3 4
 ) for (
# 101 "project/radare2/libr/util/log.c"
...
# 101 "project/radare2/libr/util/log.c"
                                  {
   cb (output_buf, funcname, filename, lineno, level, 
# 102 "project/radare2/libr/util/log.c" 3 4
                                                     ((void *)0)
# 102 "project/radare2/libr/util/log.c"
                                                         , fmtstr, args_copy);
  }
 } else {
  fprintf (
# 105 "project/radare2/libr/util/log.c" 3 4
          __stderrp
# 105 "project/radare2/libr/util/log.c"
                , "%s", output_buf);
 }
 
# 107 "project/radare2/libr/util/log.c" 3 4
__builtin_va_end(
# 107 "project/radare2/libr/util/log.c"
args_copy
# 107 "project/radare2/libr/util/log.c" 3 4
)
# 107 "project/radare2/libr/util/log.c"
...
# 119 "project/radare2/libr/util/log.c" 3 4
  fprintf(__stderrp,
# 119 "project/radare2/libr/util/log.c"
...
# 119 "project/radare2/libr/util/log.c"
 ...
 if (level >= cfg_logtraplvl && level != R_LOGLVL_NONE) {
  fflush (
# 124 "project/radare2/libr/util/log.c" 3 4
         __stdoutp
# 124 "project/radare2/libr/util/log.c"
               );
  fflush (
# 125 "project/radare2/libr/util/log.c" 3 4
         __stderrp
# 125 "project/radare2/libr/util/log.c"
               );

  
# 127 "project/radare2/libr/util/log.c" 3 4
 __builtin_trap()
# 127 "project/radare2/libr/util/log.c"
                    ;
 }
}
# 141 "project/radare2/libr/util/log.c"

# 141 "project/radare2/libr/util/log.c" 3 4
__attribute__((visibility("default"))) 
# 141 "project/radare2/libr/util/log.c"
     void r_log(const char *funcname, const char *filename, 
# 141 "project/radare2/libr/util/log.c" 3 4
                                                            unsigned int 
# 141 "project/radare2/libr/util/log.c"
                                                                 lineno, RLogLevel level, const char *tag, const char *fmtstr, ...) {
 va_list args;

 
# 144 "project/radare2/libr/util/log.c" 3 4
__builtin_va_start(
# 144 "project/radare2/libr/util/log.c"
args
# 144 "project/radare2/libr/util/log.c" 3 4
,
# 144 "project/radare2/libr/util/log.c"
...
# 146 "project/radare2/libr/util/log.c" 3 4
__builtin_va_end(
# 146 "project/radare2/libr/util/log.c"
args
# 146 "project/radare2/libr/util/log.c" 3 4
)
# 146 "project/radare2/libr/util/log.c"
