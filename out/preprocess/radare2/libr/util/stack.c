# 0 "project/radare2/libr/util/stack.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/util/stack.c" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/util/stack.c"
     RStack *r_stack_new(
# 5 "project/radare2/libr/util/stack.c" 3 4
                         unsigned int 
# 5 "project/radare2/libr/util/stack.c"
                              n) {
 RStack *s = 
# 6 "project/radare2/libr/util/stack.c" 3 4
            (
# 6 "project/radare2/libr/util/stack.c"
            RStack
# 6 "project/radare2/libr/util/stack.c" 3 4
            *)calloc(1,sizeof(
# 6 "project/radare2/libr/util/stack.c"
...
# 6 "project/radare2/libr/util/stack.c"
 ...
 if (!s) {
  return 
# 8 "project/radare2/libr/util/stack.c" 3 4
        ((void *)0)
# 8 "project/radare2/libr/util/stack.c"
            ;
 }
 s->elems = 
# 10 "project/radare2/libr/util/stack.c" 3 4
           (
# 10 "project/radare2/libr/util/stack.c"
           void *
# 10 "project/radare2/libr/util/stack.c" 3 4
           *)calloc(
# 10 "project/radare2/libr/util/stack.c"
...
# 10 "project/radare2/libr/util/stack.c"
 ...
 if (!s->elems) {
  free (s);
  return 
# 13 "project/radare2/libr/util/stack.c" 3 4
        ((void *)0)
# 13 "project/radare2/libr/util/stack.c"
            ;
 }
 s->n_elems = n;
 s->top = -1;
...
# 20 "project/radare2/libr/util/stack.c" 3 4
__attribute__((visibility("default"))) 
# 20 "project/radare2/libr/util/stack.c"
     RStack *r_stack_newf(
# 20 "project/radare2/libr/util/stack.c" 3 4
                          unsigned int 
# 20 "project/radare2/libr/util/stack.c"
...
# 28 "project/radare2/libr/util/stack.c" 3 4
__attribute__((visibility("default"))) 
# 28 "project/radare2/libr/util/stack.c"
...
# 41 "project/radare2/libr/util/stack.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 41 "project/radare2/libr/util/stack.c"
          r_stack_push(RStack *s, void *el) {
 if (s->top == s->n_elems - 1) {
  ...
  if (!elems) {
   return 
# 47 "project/radare2/libr/util/stack.c" 3 4
         0
# 47 "project/radare2/libr/util/stack.c"
              ;
  }
  s->elems = elems;
 }
 ...
 s->elems[s->top] = el;
 return 
# 54 "project/radare2/libr/util/stack.c" 3 4
       1
# 54 "project/radare2/libr/util/stack.c"
           ;
}



# 58 "project/radare2/libr/util/stack.c" 3 4
__attribute__((visibility("default"))) 
# 58 "project/radare2/libr/util/stack.c"
     void *r_stack_pop(RStack *s) {
 if (s->top == -1) {
  return 
# 60 "project/radare2/libr/util/stack.c" 3 4
        ((void *)0)
# 60 "project/radare2/libr/util/stack.c"
            ;
 }
...
# 67 "project/radare2/libr/util/stack.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 67 "project/radare2/libr/util/stack.c"
          r_stack_is_empty(RStack *s) {
 return s->top == -1;
}


# 71 "project/radare2/libr/util/stack.c" 3 4
__attribute__((visibility("default"))) 
# 71 "project/radare2/libr/util/stack.c"
     size_t r_stack_size(RStack *s) {
 return (size_t)(s->top + 1);
}


# 75 "project/radare2/libr/util/stack.c" 3 4
__attribute__((visibility("default"))) 
# 75 "project/radare2/libr/util/stack.c"
     void *r_stack_peek(RStack *s) {
 return r_stack_is_empty (s)? 
# 76 "project/radare2/libr/util/stack.c" 3 4
                             ((void *)0)
# 76 "project/radare2/libr/util/stack.c"
                                 : s->elems[s->top];
}
