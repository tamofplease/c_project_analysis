# 0 "project/radare2/libr/util/unum.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 8 "project/radare2/libr/util/unum.c" 2
# 1 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include-fixed/math.h" 1 3 4
# 46 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include-fixed/math.h" 3 4
...
# 9 "project/radare2/libr/util/unum.c" 2
...
# 10 "project/radare2/libr/util/unum.c" 2



# 12 "project/radare2/libr/util/unum.c"
static 
# 12 "project/radare2/libr/util/unum.c" 3 4
      unsigned long long 
# 12 "project/radare2/libr/util/unum.c"
           r_num_tailff(RNum *num, const char *hex);
...
# 32 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 32 "project/radare2/libr/util/unum.c"
     size_t r_num_bit_count(
# 32 "project/radare2/libr/util/unum.c" 3 4
                            unsigned int 
# 32 "project/radare2/libr/util/unum.c"
                                 val) {
# 41 "project/radare2/libr/util/unum.c"
 return val? __builtin_clz (val): 0;

}


# 45 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 45 "project/radare2/libr/util/unum.c"
     void r_num_irand(void) {
 r_num_srand (r_time_now ());
}


# 49 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 49 "project/radare2/libr/util/unum.c"
     int r_num_rand(int max) {
 static 
# 50 "project/radare2/libr/util/unum.c" 3 4
       _Bool 
# 50 "project/radare2/libr/util/unum.c"
            rand_initialized = 
# 50 "project/radare2/libr/util/unum.c" 3 4
                               0
# 50 "project/radare2/libr/util/unum.c"
 ...
 if (!rand_initialized) {
  r_num_irand ();
  rand_initialized = 
# 53 "project/radare2/libr/util/unum.c" 3 4
                    1
# 53 "project/radare2/libr/util/unum.c"
                        ;
 }
 if (!max) {
  max = 1;
...
# 61 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 61 "project/radare2/libr/util/unum.c"
     void r_num_minmax_swap(
# 61 "project/radare2/libr/util/unum.c" 3 4
                            unsigned long long 
# 61 "project/radare2/libr/util/unum.c"
                                 *a, 
...
# 63 "project/radare2/libr/util/unum.c" 3 4
 unsigned long long 
# 63 "project/radare2/libr/util/unum.c"
      tmp = *a;
  *a = *b;
  *b = tmp;
 }
...
# 69 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 69 "project/radare2/libr/util/unum.c"
     void r_num_minmax_swap_i(int *a, int *b) {
 if (*a > *b) {
  
# 71 "project/radare2/libr/util/unum.c" 3 4
 unsigned long long 
# 71 "project/radare2/libr/util/unum.c"
      tmp = *a;
  *a = *b;
  *b = tmp;
 }
...
# 77 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 77 "project/radare2/libr/util/unum.c"
     RNum *r_num_new(RNumCallback cb, RNumCallback2 cb2, void *ptr) {
 RNum *num = 
# 78 "project/radare2/libr/util/unum.c" 3 4
            (
# 78 "project/radare2/libr/util/unum.c"
            RNum
# 78 "project/radare2/libr/util/unum.c" 3 4
            *)calloc(1,sizeof(
# 78 "project/radare2/libr/util/unum.c"
...
# 78 "project/radare2/libr/util/unum.c"
 ...
 if (!num) {
  return 
# 80 "project/radare2/libr/util/unum.c" 3 4
        ((void *)0)
# 80 "project/radare2/libr/util/unum.c"
            ;
 }
 num->value = 0LL;
 num->callback = cb;
...
# 89 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 89 "project/radare2/libr/util/unum.c"
     void r_num_free(RNum *num) {
 free (num);
}
# 110 "project/radare2/libr/util/unum.c"

# 110 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 110 "project/radare2/libr/util/unum.c"
     char *r_num_units(char *buf, size_t len, 
# 110 "project/radare2/libr/util/unum.c" 3 4
                                              unsigned long long 
# 110 "project/radare2/libr/util/unum.c"
                                                   num) {
 ...
 if (!buf) {
  ...
  if (!buf) {
   return 
# 117 "project/radare2/libr/util/unum.c" 3 4
         ((void *)0)
# 117 "project/radare2/libr/util/unum.c"
             ;
  }
 }
 fnum = (long double)num;
 if (num >= (1ULL << 60)) { unit = 'E'; fnum /= (1ULL << 60); } else
 if (num >= (1ULL << 50)) { unit = 'P'; fnum /= (1ULL << 50); } else
 if (num >= (1ULL << 40)) { unit = 'T'; fnum /= (1ULL << 40); } else
 if (num >= (1ULL << 30)) { unit = 'G'; fnum /= (1ULL << 30); } else
 if (num >= (1ULL << 20)) { unit = 'M'; fnum /= (1ULL << 20); } else
 if (num >= (1ULL << 10)) { unit = 'K'; fnum /= (1ULL << 10); } else {
  unit = '\0';
 }
 fmt_str = ((double)ceill (fnum) == (double)fnum)
  ? "%.0" 
# 130 "project/radare2/libr/util/unum.c" 3 4
         "Lf" 
# 130 "project/radare2/libr/util/unum.c"
                 "%c"
  : "%.1" 
# 131 "project/radare2/libr/util/unum.c" 3 4
         "Lf" 
# 131 "project/radare2/libr/util/unum.c"
                 "%c";
 
# 132 "project/radare2/libr/util/unum.c" 3 4
__builtin___snprintf_chk (
# 132 "project/radare2/libr/util/unum.c"
buf
# 132 "project/radare2/libr/util/unum.c" 3 4
, 
# 132 "project/radare2/libr/util/unum.c"
...
# 136 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 136 "project/radare2/libr/util/unum.c"
     const char *r_num_get_name(RNum *num, 
# 136 "project/radare2/libr/util/unum.c" 3 4
                                           unsigned long long 
# 136 "project/radare2/libr/util/unum.c"
                                                n) {
 ...
 return 
# 147 "project/radare2/libr/util/unum.c" 3 4
       ((void *)0)
# 147 "project/radare2/libr/util/unum.c"
           ;
}
...
static 
# 159 "project/radare2/libr/util/unum.c" 3 4
      unsigned long long 
# 159 "project/radare2/libr/util/unum.c"
           r_num_from_binary(const char *str) {
 int i, j;
 
# 161 "project/radare2/libr/util/unum.c" 3 4
unsigned long long 
# 161 "project/radare2/libr/util/unum.c"
     ret = 0;
 ...
 sscanf (str, "0x%"
# 169 "project/radare2/libr/util/unum.c" 3 4
                  "llx"
# 169 "project/radare2/libr/util/unum.c"
                         , &ret);
 return ret;
}


# 173 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 173 "project/radare2/libr/util/unum.c"
          r_num_from_ternary(const char *inp) {
 if (!inp) {
  return 0LL;
 }
 const char *p;
...
# 179 "project/radare2/libr/util/unum.c" 3 4
unsigned long long 
# 179 "project/radare2/libr/util/unum.c"
     fr = 0;
 for (p = inp; *p ; p++, pos--) {
  
# 181 "project/radare2/libr/util/unum.c" 3 4
 unsigned long long 
# 181 "project/radare2/libr/util/unum.c"
      n012 = 0;
  switch (*p) {
  case '0':
  case '1':
  case '2':
   n012 = *p - '0';
   fr += (
# 187 "project/radare2/libr/util/unum.c" 3 4
         unsigned long long
# 187 "project/radare2/libr/util/unum.c"
             )(n012 * pow (3, pos - 1));
   break;
  }
 }
...
# 196 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 196 "project/radare2/libr/util/unum.c"
          r_num_get(RNum *num, const char *str) {
 int i, j, ok;
 char lch, len;
 
# 199 "project/radare2/libr/util/unum.c" 3 4
unsigned long long 
# 199 "project/radare2/libr/util/unum.c"
     ret = 0LL;
 
# 200 "project/radare2/libr/util/unum.c" 3 4
unsigned int 
# 200 "project/radare2/libr/util/unum.c"
     s, a;
 ...
 if (!strncmp (str, "1u", 2)) {
  if (num && num->value == 
# 215 "project/radare2/libr/util/unum.c" 3 4
                          0xFFFFFFFFFFFFFFFFULL
# 215 "project/radare2/libr/util/unum.c"
                                  ) {
   num->value = 0;
  }
  switch (atoi (str + 2)) {
  case 64: return (
# 219 "project/radare2/libr/util/unum.c" 3 4
                  unsigned long long
# 219 "project/radare2/libr/util/unum.c"
                      )
# 219 "project/radare2/libr/util/unum.c" 3 4
                       0xFFFFFFFFFFFFFFFFULL
# 219 "project/radare2/libr/util/unum.c"
                               ;
  case 32: return (
# 220 "project/radare2/libr/util/unum.c" 3 4
                  unsigned long long
# 220 "project/radare2/libr/util/unum.c"
                      )
# 220 "project/radare2/libr/util/unum.c" 3 4
                       0xFFFFFFFFU
# 220 "project/radare2/libr/util/unum.c"
                               ;
  case 16: return (
# 221 "project/radare2/libr/util/unum.c" 3 4
                  unsigned long long
# 221 "project/radare2/libr/util/unum.c"
                      )
# 221 "project/radare2/libr/util/unum.c" 3 4
                       0xFFFFU
# 221 "project/radare2/libr/util/unum.c"
                               ;
  case 8: return (
# 222 "project/radare2/libr/util/unum.c" 3 4
                 unsigned long long
# 222 "project/radare2/libr/util/unum.c"
                     )
# 222 "project/radare2/libr/util/unum.c" 3 4
                      0xFFU
# 222 "project/radare2/libr/util/unum.c"
 ...
 if (str[0] && str[1] && str[2]) {
  if (str[0] == '\'' && str[2] == '\'') {
   return (
# 236 "project/radare2/libr/util/unum.c" 3 4
          unsigned long long
# 236 "project/radare2/libr/util/unum.c"
              )str[1];
  }
 }
 ...
 if (len > 3 && str[4] == ':') {
  if (sscanf (str, "%04x", &s) == 1) {
   if (sscanf (str + 5, "%04x", &a) == 1) {
    return (
# 244 "project/radare2/libr/util/unum.c" 3 4
           unsigned long long
# 244 "project/radare2/libr/util/unum.c"
               ) ((s<<4) + a);
   }
  }
 } else if (len > 6 && str[6] == ':') {
  if (sscanf (str, "0x%04x:0x%04x", &s, &a) == 2) {
   return (
# 249 "project/radare2/libr/util/unum.c" 3 4
          unsigned long long
# 249 "project/radare2/libr/util/unum.c"
              ) ((s << 4) + a);
  }
  if (sscanf (str, "0x%04x:%04x", &s, &a) == 2) {
   return (
# 252 "project/radare2/libr/util/unum.c" 3 4
          unsigned long long
# 252 "project/radare2/libr/util/unum.c"
              ) ((s << 4) + a);
  }
 }
 if (str[0] == '0' && str[1] == 'b') {
  ...
  if (sscanf (str + 2, "%"
# 267 "project/radare2/libr/util/unum.c" 3 4
                         "llo"
# 267 "project/radare2/libr/util/unum.c"
                                , &ret) != 1) {
...
# 280 "project/radare2/libr/util/unum.c" 3 4
   (*__error()) 
# 280 "project/radare2/libr/util/unum.c"
         = 0;
    ret = strtoull (s, 
# 281 "project/radare2/libr/util/unum.c" 3 4
                      ((void *)0)
# 281 "project/radare2/libr/util/unum.c"
                          , 16);
    free (s);
   }
  } else {
   
# 285 "project/radare2/libr/util/unum.c" 3 4
  (*__error()) 
# 285 "project/radare2/libr/util/unum.c"
        = 0;
   ret = strtoull (str + 2, 
# 286 "project/radare2/libr/util/unum.c" 3 4
                           ((void *)0)
# 286 "project/radare2/libr/util/unum.c"
                               , 16);

  }
  if (
# 289 "project/radare2/libr/util/unum.c" 3 4
     (*__error()) 
# 289 "project/radare2/libr/util/unum.c"
           == 
# 289 "project/radare2/libr/util/unum.c" 3 4
              34
# 289 "project/radare2/libr/util/unum.c"
...
# 296 "project/radare2/libr/util/unum.c" 3 4
 _Bool 
# 296 "project/radare2/libr/util/unum.c"
      zero_read = 
# 296 "project/radare2/libr/util/unum.c" 3 4
                  0
# 296 "project/radare2/libr/util/unum.c"
  ...
  if (*str == '0' && 
# 298 "project/radare2/libr/util/unum.c" 3 4
                    ((
# 298 "project/radare2/libr/util/unum.c"
                    *(str + 1)
# 298 "project/radare2/libr/util/unum.c" 3 4
                    ) >= '0' && (
# 298 "project/radare2/libr/util/unum.c"
...
# 298 "project/radare2/libr/util/unum.c"
  ...
  case 'h':
   if (!sscanf (str, "%"
# 304 "project/radare2/libr/util/unum.c" 3 4
                       "llx"
# 304 "project/radare2/libr/util/unum.c"
                              "%n", &ret, &chars_read)
       || chars_read != len_num) {
  ...
  case 'o':
   if (!sscanf (str, "%"
# 310 "project/radare2/libr/util/unum.c" 3 4
                       "llo"
# 310 "project/radare2/libr/util/unum.c"
                              "%n", &ret, &chars_read)
       || chars_read != len_num) {
    error (num, "invalid octal number");
   }
  ...
  case 'b':
   ret = 0;
   ok = 
# 317 "project/radare2/libr/util/unum.c" 3 4
       1
# 317 "project/radare2/libr/util/unum.c"
           ;
   if (strlen (str) <= 65) {
    for (j = 0, i = strlen (str) - 2; i >= 0; i--, j++) {
     if (str[i] == '1') {
      ...
      ok = 
# 324 "project/radare2/libr/util/unum.c" 3 4
          0
# 324 "project/radare2/libr/util/unum.c"
               ;
      break;
     }
    }
    ...
    ok = 
# 329 "project/radare2/libr/util/unum.c" 3 4
        0
# 329 "project/radare2/libr/util/unum.c"
             ;
  ...
  case 't':
   ret = 0;
   ok = 
# 338 "project/radare2/libr/util/unum.c" 3 4
       1
# 338 "project/radare2/libr/util/unum.c"
           ;
   
# 339 "project/radare2/libr/util/unum.c" 3 4
  unsigned long long 
# 339 "project/radare2/libr/util/unum.c"
       x = 1;
   for (i = strlen (str) - 2; i >= 0; i--) {
    if (str[i] < '0' || '2' < str[i]) {
     ok = 
# 342 "project/radare2/libr/util/unum.c" 3 4
         0
# 342 "project/radare2/libr/util/unum.c"
              ;
     break;
    }
    ret += x * (str[i] - '0');
  ...
  case 'K': case 'k':
   if (strchr (str, '.')) {
    ...
    if (sscanf (str, "%lf%n", &d, &chars_read)) {
     ret = (
# 356 "project/radare2/libr/util/unum.c" 3 4
           unsigned long long
# 356 "project/radare2/libr/util/unum.c"
               )(d * (1ULL << 10));
    } else {
     zero_read = 
# 358 "project/radare2/libr/util/unum.c" 3 4
                1
# 358 "project/radare2/libr/util/unum.c"
                    ;
    }
   } else {
    if (sscanf (str, "%"
# 361 "project/radare2/libr/util/unum.c" 3 4
                       "lld"
# 361 "project/radare2/libr/util/unum.c"
                              "%n", &ret, &chars_read)) {
     ret *= (1ULL << 10);
    } else {
     zero_read = 
# 364 "project/radare2/libr/util/unum.c" 3 4
                1
# 364 "project/radare2/libr/util/unum.c"
                    ;
    }
   }
  ...
  case 'M': case 'm':
   if (strchr (str, '.')) {
    ...
    if (sscanf (str, "%lf%n", &d, &chars_read)) {
     ret = (
# 375 "project/radare2/libr/util/unum.c" 3 4
           unsigned long long
# 375 "project/radare2/libr/util/unum.c"
               )(d * (1ULL << 20));
    } else {
     zero_read = 
# 377 "project/radare2/libr/util/unum.c" 3 4
                1
# 377 "project/radare2/libr/util/unum.c"
                    ;
    }
   } else {
    if (sscanf (str, "%"
# 380 "project/radare2/libr/util/unum.c" 3 4
                       "lld"
# 380 "project/radare2/libr/util/unum.c"
                              "%n", &ret, &chars_read)) {
     ret *= (1ULL << 20);
    } else {
     zero_read = 
# 383 "project/radare2/libr/util/unum.c" 3 4
                1
# 383 "project/radare2/libr/util/unum.c"
                    ;
    }
   }
   if (zero_read || chars_read != len_num) {
  ...
  case 'G': case 'g':
   if (strchr (str, '.')) {
    ...
    if (sscanf (str, "%lf%n", &d, &chars_read)) {
     ret = (
# 394 "project/radare2/libr/util/unum.c" 3 4
           unsigned long long
# 394 "project/radare2/libr/util/unum.c"
               )(d * (1ULL << 30));
    } else {
     zero_read = 
# 396 "project/radare2/libr/util/unum.c" 3 4
                1
# 396 "project/radare2/libr/util/unum.c"
                    ;
    }
   } else {
    if (sscanf (str, "%"
# 399 "project/radare2/libr/util/unum.c" 3 4
                       "lld"
# 399 "project/radare2/libr/util/unum.c"
                              "%n", &ret, &chars_read)) {
     ret *= (1ULL << 30);
    } else {
     zero_read = 
# 402 "project/radare2/libr/util/unum.c" 3 4
                1
# 402 "project/radare2/libr/util/unum.c"
                    ;
    }
   }
   if (zero_read || chars_read != len_num) {
...
# 417 "project/radare2/libr/util/unum.c" 3 4
  (*__error()) 
# 417 "project/radare2/libr/util/unum.c"
        = 0;
   ret = strtoull (str, &endptr, 10);
   if (
# 419 "project/radare2/libr/util/unum.c" 3 4
      (*__error()) 
# 419 "project/radare2/libr/util/unum.c"
            == 
# 419 "project/radare2/libr/util/unum.c" 3 4
               34
# 419 "project/radare2/libr/util/unum.c"
   ...
   if (!
# 422 "project/radare2/libr/util/unum.c" 3 4
       ((
# 422 "project/radare2/libr/util/unum.c"
       *str
# 422 "project/radare2/libr/util/unum.c" 3 4
       ) >= '0' && (
# 422 "project/radare2/libr/util/unum.c"
...
# 466 "project/radare2/libr/util/unum.c"

# 466 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 466 "project/radare2/libr/util/unum.c"
          r_num_math(RNum *num, const char *str) {

 
# 468 "project/radare2/libr/util/unum.c" 3 4
unsigned long long 
# 468 "project/radare2/libr/util/unum.c"
     ret;
 const char *err = 
# 469 "project/radare2/libr/util/unum.c" 3 4
                  ((void *)0)
# 469 "project/radare2/libr/util/unum.c"
                      ;
 if (!str || !*str) {
  return 0LL;
 }
...
# 479 "project/radare2/libr/util/unum.c" 3 4
 fprintf(__stderrp,
# 479 "project/radare2/libr/util/unum.c"
 "r_num_calc error: (%s) in (%s)\n", err, str
# 479 "project/radare2/libr/util/unum.c" 3 4
 )
# 479 "project/radare2/libr/util/unum.c"
                                                       ;
 ...
 return ret;
# 538 "project/radare2/libr/util/unum.c"
}


# 540 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 540 "project/radare2/libr/util/unum.c"
     int r_num_is_float(RNum *num, const char *str) {
 return (
# 541 "project/radare2/libr/util/unum.c" 3 4
        ((
# 541 "project/radare2/libr/util/unum.c"
        *str
# 541 "project/radare2/libr/util/unum.c" 3 4
        ) >= '0' && (
# 541 "project/radare2/libr/util/unum.c"
...
# 541 "project/radare2/libr/util/unum.c"
                        && (strchr (str, '.') || str[strlen (str) - 1] == 'f'));
}


# 544 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 544 "project/radare2/libr/util/unum.c"
...
# 550 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 550 "project/radare2/libr/util/unum.c"
     int r_num_to_bits(char *out, 
# 550 "project/radare2/libr/util/unum.c" 3 4
                                  unsigned long long 
# 550 "project/radare2/libr/util/unum.c"
                                       num) {
...
# 586 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 586 "project/radare2/libr/util/unum.c"
     int r_num_to_ternary(char *out, 
# 586 "project/radare2/libr/util/unum.c" 3 4
                                     unsigned long long 
# 586 "project/radare2/libr/util/unum.c"
                                          num) {
 if (out == 
# 587 "project/radare2/libr/util/unum.c" 3 4
           ((void *)0)
# 587 "project/radare2/libr/util/unum.c"
               ) {
  return 
# 588 "project/radare2/libr/util/unum.c" 3 4
        0
# 588 "project/radare2/libr/util/unum.c"
             ;
 }
 int i;
 for (i = 0; num; i++, num /= 3) {
 ...
 r_str_reverse (out);
 return 
# 601 "project/radare2/libr/util/unum.c" 3 4
       1
# 601 "project/radare2/libr/util/unum.c"
           ;
}


# 604 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 604 "project/radare2/libr/util/unum.c"
          r_num_chs(int cylinder, int head, int sector, int sectorsize) {
 if (sectorsize < 1) {
  sectorsize = 512;
 }
 return (
# 608 "project/radare2/libr/util/unum.c" 3 4
        unsigned long long
# 608 "project/radare2/libr/util/unum.c"
            )cylinder * (
# 608 "project/radare2/libr/util/unum.c" 3 4
                         unsigned long long
# 608 "project/radare2/libr/util/unum.c"
...
# 611 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 611 "project/radare2/libr/util/unum.c"
     int r_num_conditional(RNum *num, const char *str) {
 char *lgt, *t, *p, *s = strdup (str);
 int res = 0;
 
# 614 "project/radare2/libr/util/unum.c" 3 4
unsigned long long 
# 614 "project/radare2/libr/util/unum.c"
     n, a, b;
 p = s;
 do {
  t = strchr (p, ',');
...
# 684 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 684 "project/radare2/libr/util/unum.c"
     int r_num_is_valid_input(RNum *num, const char *input_value) {
 
# 685 "project/radare2/libr/util/unum.c" 3 4
unsigned long long 
# 685 "project/radare2/libr/util/unum.c"
     value = input_value ? r_num_math (num, input_value) : 0;
 return !(value == 0 && input_value && *input_value != '0') || !(value == 0 && input_value && *input_value != '@');
}


# 689 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 689 "project/radare2/libr/util/unum.c"
          r_num_get_input_value(RNum *num, const char *input_value) {
 
# 690 "project/radare2/libr/util/unum.c" 3 4
unsigned long long 
# 690 "project/radare2/libr/util/unum.c"
     value = input_value ? r_num_math (num, input_value) : 0;
 return value;
}
...
static int escape_char(char* dst, char byte) {
  ...
  *(dst++) = '\\';
  *(dst++) = 'x';
  *(dst++) = (((byte >> 4) & 0xf) > 9 ? 'a' + ((byte >> 4) & 0xf) - 10 : '0' + ((byte >> 4) & 0xf));
  *(dst++) = (((byte) & 0xf) > 9 ? 'a' + ((byte) & 0xf) - 10 : '0' + ((byte) & 0xf));
  *dst = 0;
  return 4;
 }
 return 0;
...
# 713 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 713 "project/radare2/libr/util/unum.c"
     char* r_num_as_string(RNum *___, 
# 713 "project/radare2/libr/util/unum.c" 3 4
                                      unsigned long long 
# 713 "project/radare2/libr/util/unum.c"
                                           n, 
...
# 713 "project/radare2/libr/util/unum.c"
 ...
 int len = sizeof (
# 716 "project/radare2/libr/util/unum.c" 3 4
                  unsigned long long
# 716 "project/radare2/libr/util/unum.c"
                      );
 
# 717 "project/radare2/libr/util/unum.c" 3 4
unsigned long long 
# 717 "project/radare2/libr/util/unum.c"
     num = n;
 str[stri=0] = 0;
 while (len--) {
  char ch = (num & 0xff);
  if (ch >= 32 && ch < 127) {
   ...
   if (ch) {
    return 
# 728 "project/radare2/libr/util/unum.c" 3 4
          ((void *)0)
# 728 "project/radare2/libr/util/unum.c"
              ;
   }
  }
  ret |= (num & 0xff);
 ...
 return 
# 740 "project/radare2/libr/util/unum.c" 3 4
       ((void *)0)
# 740 "project/radare2/libr/util/unum.c"
           ;
}


# 743 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 743 "project/radare2/libr/util/unum.c"
          r_is_valid_input_num_value(RNum *num, const char *input_value) {
 if (!input_value) {
  return 
# 745 "project/radare2/libr/util/unum.c" 3 4
        0
# 745 "project/radare2/libr/util/unum.c"
             ;
 }
 
# 747 "project/radare2/libr/util/unum.c" 3 4
unsigned long long 
# 747 "project/radare2/libr/util/unum.c"
     value = r_num_math (num, input_value);
 return !(value == 0 && *input_value != '0');
}



# 752 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 752 "project/radare2/libr/util/unum.c"
          r_get_input_num_value(RNum *num, const char *str) {
 return (str && *str)? r_num_math (num, str) : 0;
}


static inline 
# 757 "project/radare2/libr/util/unum.c" 3 4
             unsigned long long 
# 757 "project/radare2/libr/util/unum.c"
                  __nth_nibble(
# 757 "project/radare2/libr/util/unum.c" 3 4
                               unsigned long long 
# 757 "project/radare2/libr/util/unum.c"
...
# 763 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 763 "project/radare2/libr/util/unum.c"
          r_num_tail_base(RNum *num, 
# 763 "project/radare2/libr/util/unum.c" 3 4
                                     unsigned long long 
# 763 "project/radare2/libr/util/unum.c"
                                          addr, 
...
# 765 "project/radare2/libr/util/unum.c" 3 4
_Bool 
# 765 "project/radare2/libr/util/unum.c"
     ready = 
# 765 "project/radare2/libr/util/unum.c" 3 4
             0
# 765 "project/radare2/libr/util/unum.c"
...
# 766 "project/radare2/libr/util/unum.c" 3 4
unsigned long long 
# 766 "project/radare2/libr/util/unum.c"
     res = 0;
 for (i = 0; i < 16; i++) {
  
# 768 "project/radare2/libr/util/unum.c" 3 4
 unsigned long long 
# 768 "project/radare2/libr/util/unum.c"
      o = __nth_nibble (off, i);
  if (!ready) {
   
# 770 "project/radare2/libr/util/unum.c" 3 4
  _Bool 
# 770 "project/radare2/libr/util/unum.c"
       iseq = __nth_nibble (addr, i) == o;
   if (i == 0 && !iseq) {
    return 
# 772 "project/radare2/libr/util/unum.c" 3 4
          0xFFFFFFFFFFFFFFFFULL
# 772 "project/radare2/libr/util/unum.c"
                  ;
   }
   if (iseq) {
    continue;
  ...
  ready = 
# 778 "project/radare2/libr/util/unum.c" 3 4
         1
# 778 "project/radare2/libr/util/unum.c"
             ;
  
# 779 "project/radare2/libr/util/unum.c" 3 4
 unsigned char 
# 779 "project/radare2/libr/util/unum.c"
     pos = (15 - i) * 4;
  res |= (o << pos);
 }
 return res;
...
# 785 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 785 "project/radare2/libr/util/unum.c"
          r_num_tail(RNum *num, 
# 785 "project/radare2/libr/util/unum.c" 3 4
                                unsigned long long 
# 785 "project/radare2/libr/util/unum.c"
...
# 786 "project/radare2/libr/util/unum.c" 3 4
unsigned long long 
# 786 "project/radare2/libr/util/unum.c"
     mask = 0LL;
 
# 787 "project/radare2/libr/util/unum.c" 3 4
unsigned long long 
# 787 "project/radare2/libr/util/unum.c"
     n = 0;
 char *p;
 int i;
...
# 797 "project/radare2/libr/util/unum.c" 3 4
 __builtin___strcpy_chk (
# 797 "project/radare2/libr/util/unum.c"
 p
# 797 "project/radare2/libr/util/unum.c" 3 4
 , 
# 797 "project/radare2/libr/util/unum.c"
...
# 798 "project/radare2/libr/util/unum.c" 3 4
 __builtin___strcpy_chk (
# 798 "project/radare2/libr/util/unum.c"
 p + 2
# 798 "project/radare2/libr/util/unum.c" 3 4
 , 
# 798 "project/radare2/libr/util/unum.c"
...
# 798 "project/radare2/libr/util/unum.c"
                    ;
  if (isxdigit ((
# 799 "project/radare2/libr/util/unum.c" 3 4
                unsigned char
# 799 "project/radare2/libr/util/unum.c"
                   )hex[0])) {
   n = r_num_math (num, p);
  } else {
   
# 802 "project/radare2/libr/util/unum.c" 3 4
  fprintf(__stderrp,
# 802 "project/radare2/libr/util/unum.c"
  "Invalid argument\n"
# 802 "project/radare2/libr/util/unum.c" 3 4
  )
# 802 "project/radare2/libr/util/unum.c"
 ...
 mask = 
# 808 "project/radare2/libr/util/unum.c" 3 4
       0xFFFFFFFFFFFFFFFFULL 
# 808 "project/radare2/libr/util/unum.c"
                << i;
 return (addr & mask) | n;
}

static 
# 812 "project/radare2/libr/util/unum.c" 3 4
      unsigned long long 
# 812 "project/radare2/libr/util/unum.c"
           r_num_tailff(RNum *num, const char *hex) {
 
# 813 "project/radare2/libr/util/unum.c" 3 4
unsigned long long 
# 813 "project/radare2/libr/util/unum.c"
     n = 0;
...
# 821 "project/radare2/libr/util/unum.c" 3 4
 __builtin___strcpy_chk (
# 821 "project/radare2/libr/util/unum.c"
 p
# 821 "project/radare2/libr/util/unum.c" 3 4
 , 
# 821 "project/radare2/libr/util/unum.c"
...
# 822 "project/radare2/libr/util/unum.c" 3 4
 __builtin___strcpy_chk (
# 822 "project/radare2/libr/util/unum.c"
 p + 2
# 822 "project/radare2/libr/util/unum.c" 3 4
 , 
# 822 "project/radare2/libr/util/unum.c"
...
# 822 "project/radare2/libr/util/unum.c"
                    ;
  if (isxdigit ((
# 823 "project/radare2/libr/util/unum.c" 3 4
                unsigned char
# 823 "project/radare2/libr/util/unum.c"
                   )hex[0])) {
   n = r_num_get (num, p);
  } else {
   
# 826 "project/radare2/libr/util/unum.c" 3 4
  fprintf(__stderrp,
# 826 "project/radare2/libr/util/unum.c"
  "Invalid argument\n"
# 826 "project/radare2/libr/util/unum.c" 3 4
  )
# 826 "project/radare2/libr/util/unum.c"
   ...
   free (p);
   return 
# 828 "project/radare2/libr/util/unum.c" 3 4
         0xFFFFFFFFFFFFFFFFULL
# 828 "project/radare2/libr/util/unum.c"
                 ;
  }
  free (p);
 }
 
# 832 "project/radare2/libr/util/unum.c" 3 4
unsigned long long 
# 832 "project/radare2/libr/util/unum.c"
     left = ((
# 832 "project/radare2/libr/util/unum.c" 3 4
              0xFFFFFFFFFFFFFFFFULL 
# 832 "project/radare2/libr/util/unum.c"
...
# 836 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 836 "project/radare2/libr/util/unum.c"
     int r_num_between(RNum *num, const char *input_value) {
 int i;
 
# 838 "project/radare2/libr/util/unum.c" 3 4
unsigned long long 
# 838 "project/radare2/libr/util/unum.c"
     ns[3];
 ...
 r_list_free (nums);
 return num->value = 
# 855 "project/radare2/libr/util/unum.c" 3 4
                    (((
# 855 "project/radare2/libr/util/unum.c"
                    ns[1]
# 855 "project/radare2/libr/util/unum.c" 3 4
                    )>=(
# 855 "project/radare2/libr/util/unum.c"
...
# 858 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 858 "project/radare2/libr/util/unum.c"
          r_num_is_op(const char c) {
 return c == '/' || c == '+' || c == '-' || c == '*' ||
  c == '%' || c == '&' || c == '^' || c == '|';
}
...
# 864 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 864 "project/radare2/libr/util/unum.c"
     int r_num_str_len(const char *str) {
 int i = 0, len = 0, st;
 st = 0;
 if (str[0] == '(') {
  i++;
...
# 904 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 904 "project/radare2/libr/util/unum.c"
     int r_num_str_split(char *str) {
 int i = 0, count = 0;
...
# 916 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 916 "project/radare2/libr/util/unum.c"
     RList *r_num_str_split_list(char *str) {
...
# 926 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 926 "project/radare2/libr/util/unum.c"
     void *r_num_dup(
# 926 "project/radare2/libr/util/unum.c" 3 4
                     unsigned long long 
# 926 "project/radare2/libr/util/unum.c"
...
# 927 "project/radare2/libr/util/unum.c" 3 4
unsigned long long 
# 927 "project/radare2/libr/util/unum.c"
     *hn = malloc (sizeof (
# 927 "project/radare2/libr/util/unum.c" 3 4
                           unsigned long long
# 927 "project/radare2/libr/util/unum.c"
 ...
 if (!hn) {
  return 
# 929 "project/radare2/libr/util/unum.c" 3 4
        ((void *)0)
# 929 "project/radare2/libr/util/unum.c"
            ;
 }
 *hn = n;
 return (void*)hn;
...
# 935 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 935 "project/radare2/libr/util/unum.c"
     double r_num_cos(double a) {
 return cos (a);
}


# 939 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) 
# 939 "project/radare2/libr/util/unum.c"
     double r_num_sin(double a) {
 return sin (a);
}
...
# 946 "project/radare2/libr/util/unum.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 946 "project/radare2/libr/util/unum.c"
          r_num_segaddr(
# 946 "project/radare2/libr/util/unum.c" 3 4
                        unsigned long long 
# 946 "project/radare2/libr/util/unum.c"
...
# 952 "project/radare2/libr/util/unum.c" 3 4
 unsigned int 
# 952 "project/radare2/libr/util/unum.c"
      csbase = (sb << 4);
  if (addr > csbase) {
   *a = sb;
   *b = addr - csbase;
