# 0 "project/radare2/libr/util/prof.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/util/prof.c" 2


# 5 "project/radare2/libr/util/prof.c"
...
# 30 "project/radare2/libr/util/prof.c" 3 4
__attribute__((visibility("default"))) 
# 30 "project/radare2/libr/util/prof.c"
     void r_prof_start(struct r_prof_t *p) {
 tv *when = &p->when;
 p->result = 0.0;
 gettimeofday(when, 
# 33 "project/radare2/libr/util/prof.c" 3 4
                   ((void *)0)
# 33 "project/radare2/libr/util/prof.c"
                       );
}


# 36 "project/radare2/libr/util/prof.c" 3 4
__attribute__((visibility("default"))) 
# 36 "project/radare2/libr/util/prof.c"
     double r_prof_end(struct r_prof_t *p) {
 tv end, diff, *when = &p->when;
 int sign;
 gettimeofday (&end, 
# 39 "project/radare2/libr/util/prof.c" 3 4
                    ((void *)0)
# 39 "project/radare2/libr/util/prof.c"
                        );
 sign = timeval_subtract (&diff, when, &end);
 p->result = 
# 41 "project/radare2/libr/util/prof.c" 3 4
            (((
# 41 "project/radare2/libr/util/prof.c"
...
# 42 "project/radare2/libr/util/prof.c"
                                      ;
 return 
# 43 "project/radare2/libr/util/prof.c" 3 4
       (((
# 43 "project/radare2/libr/util/prof.c"
       sign
# 43 "project/radare2/libr/util/prof.c" 3 4
       )<0)?-(
# 43 "project/radare2/libr/util/prof.c"
