# 0 "project/radare2/libr/util/randomart.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 37 "project/radare2/libr/util/randomart.c" 2
...
# 43 "project/radare2/libr/util/randomart.c"
     char *r_print_randomart(const 
# 43 "project/radare2/libr/util/randomart.c" 3 4
                                   unsigned char 
# 43 "project/radare2/libr/util/randomart.c"
                                       *dgst_raw, 
# 43 "project/radare2/libr/util/randomart.c" 3 4
...
# 50 "project/radare2/libr/util/randomart.c" 3 4
unsigned char 
# 50 "project/radare2/libr/util/randomart.c"
     field[(8 * 2 + 1)][(8 + 1)];
 
# 51 "project/radare2/libr/util/randomart.c" 3 4
unsigned int 
# 51 "project/radare2/libr/util/randomart.c"
      i, b;
 int x, y;
 ...
 retval = calloc (1, 2*((8 * 2 + 1)+3) + ((8 + 1) * ((8 * 2 + 1)+3))+ 7 + sizeof (
# 58 "project/radare2/libr/util/randomart.c" 3 4
                                                                               "llx"
# 58 "project/radare2/libr/util/randomart.c"
                                                                                      ));


 
# 61 "project/radare2/libr/util/randomart.c" 3 4
__builtin___memset_chk (
# 61 "project/radare2/libr/util/randomart.c"
field
# 61 "project/radare2/libr/util/randomart.c" 3 4
, 
# 61 "project/radare2/libr/util/randomart.c"
0, (8 * 2 + 1) * (8 + 1) * sizeof(char)
# 61 "project/radare2/libr/util/randomart.c" 3 4
...
# 61 "project/radare2/libr/util/randomart.c"
 ...
 for (i = 0; i < dgst_raw_len; i++) {
  ...
  for (b = 0; b < 4; b++) {
   ...
   x = 
# 76 "project/radare2/libr/util/randomart.c" 3 4
      (((
# 76 "project/radare2/libr/util/randomart.c"
      x
# 76 "project/radare2/libr/util/randomart.c" 3 4
      )>(
# 76 "project/radare2/libr/util/randomart.c"
...
# 76 "project/radare2/libr/util/randomart.c"
                 ;
   y = 
# 77 "project/radare2/libr/util/randomart.c" 3 4
      (((
# 77 "project/radare2/libr/util/randomart.c"
      y
# 77 "project/radare2/libr/util/randomart.c" 3 4
      )>(
# 77 "project/radare2/libr/util/randomart.c"
...
# 77 "project/radare2/libr/util/randomart.c"
                 ;
   x = 
# 78 "project/radare2/libr/util/randomart.c" 3 4
      (((
# 78 "project/radare2/libr/util/randomart.c"
      x
# 78 "project/radare2/libr/util/randomart.c" 3 4
      )>(
# 78 "project/radare2/libr/util/randomart.c"
...
# 78 "project/radare2/libr/util/randomart.c"
                             ;
   y = 
# 79 "project/radare2/libr/util/randomart.c" 3 4
      (((
# 79 "project/radare2/libr/util/randomart.c"
      y
# 79 "project/radare2/libr/util/randomart.c" 3 4
      )>(
# 79 "project/radare2/libr/util/randomart.c"
...
# 98 "project/radare2/libr/util/randomart.c" 3 4
__builtin___sprintf_chk (
# 98 "project/radare2/libr/util/randomart.c"
retval
# 98 "project/radare2/libr/util/randomart.c" 3 4
 ...
 *p++ = '\n';
  ...
  *p++ = '|';
  for (x = 0; x < (8 * 2 + 1); x++) {
   *p++ = augmentation_string[
# 113 "project/radare2/libr/util/randomart.c" 3 4
                             (((
# 113 "project/radare2/libr/util/randomart.c"
                             field[x][y]
# 113 "project/radare2/libr/util/randomart.c" 3 4
                             )>(
# 113 "project/radare2/libr/util/randomart.c"
