# 0 "project/radare2/libr/util/zip.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/util/zip.c" 2
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                              ...
                                                              ;
# 5 "project/radare2/libr/util/zip.c" 2
...
# 10 "project/radare2/libr/util/zip.c"
...
static 
# 26 "project/radare2/libr/util/zip.c" 3 4
      unsigned char 
# 26 "project/radare2/libr/util/zip.c"
          *r_inflatew(const 
# 26 "project/radare2/libr/util/zip.c" 3 4
                            unsigned char 
# 26 "project/radare2/libr/util/zip.c"
                                *src, int srcLen, int *consumed, int *dstLen, int wbits) {
 int err = 0;
 size_t out_size = 0;
 
# 29 "project/radare2/libr/util/zip.c" 3 4
unsigned char 
# 29 "project/radare2/libr/util/zip.c"
    *dst = 
# 29 "project/radare2/libr/util/zip.c" 3 4
           ((void *)0)
# 29 "project/radare2/libr/util/zip.c"
...
# 30 "project/radare2/libr/util/zip.c" 3 4
unsigned char 
# 30 "project/radare2/libr/util/zip.c"
    *tmp_ptr;
 z_stream stream;

 if (srcLen <= 0) {
  return 
# 34 "project/radare2/libr/util/zip.c" 3 4
        ((void *)0)
# 34 "project/radare2/libr/util/zip.c"
            ;
 }

 
# 37 "project/radare2/libr/util/zip.c" 3 4
__builtin___memset_chk (
# 37 "project/radare2/libr/util/zip.c"
&stream
# 37 "project/radare2/libr/util/zip.c" 3 4
, 
# 37 "project/radare2/libr/util/zip.c"
...
# 37 "project/radare2/libr/util/zip.c"
 ...
 stream.zalloc = 
# 41 "project/radare2/libr/util/zip.c" 3 4
                0
# 41 "project/radare2/libr/util/zip.c"
                      ;
 stream.zfree = 
# 42 "project/radare2/libr/util/zip.c" 3 4
                0
# 42 "project/radare2/libr/util/zip.c"
                      ;
 stream.opaque = 
# 43 "project/radare2/libr/util/zip.c" 3 4
                0
# 43 "project/radare2/libr/util/zip.c"
                      ;

 if (
# 45 "project/radare2/libr/util/zip.c" 3 4
    inflateInit2_((
# 45 "project/radare2/libr/util/zip.c"
    &stream
# 45 "project/radare2/libr/util/zip.c" 3 4
    ), (
# 45 "project/radare2/libr/util/zip.c"
...
# 45 "project/radare2/libr/util/zip.c"
  ...
  return 
# 46 "project/radare2/libr/util/zip.c" 3 4
        ((void *)0)
# 46 "project/radare2/libr/util/zip.c"
            ;
 }
 ...
 do {
  ...
  err = inflate (&stream, 
# 63 "project/radare2/libr/util/zip.c" 3 4
                         0
# 63 "project/radare2/libr/util/zip.c"
                                   );
  if (err < 0) {
   
# 65 "project/radare2/libr/util/zip.c" 3 4
  fprintf(__stderrp,
# 65 "project/radare2/libr/util/zip.c"
  "inflate error: %d %s\n", err, gzerr (-err)
# 65 "project/radare2/libr/util/zip.c" 3 4
  )
# 65 "project/radare2/libr/util/zip.c"
...
# 68 "project/radare2/libr/util/zip.c" 3 4
                1
# 68 "project/radare2/libr/util/zip.c"
                            );
 ...
 if (consumed) {
  *consumed = (const 
# 74 "project/radare2/libr/util/zip.c" 3 4
                    unsigned char 
# 74 "project/radare2/libr/util/zip.c"
                        *)stream.next_in - (const 
# 74 "project/radare2/libr/util/zip.c" 3 4
                                                  unsigned char 
# 74 "project/radare2/libr/util/zip.c"
                                                      *)src;
 ...
 free (dst);
 return 
# 83 "project/radare2/libr/util/zip.c" 3 4
       ((void *)0)
# 83 "project/radare2/libr/util/zip.c"
           ;
}


# 86 "project/radare2/libr/util/zip.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 86 "project/radare2/libr/util/zip.c"
         *r_inflate(const 
# 86 "project/radare2/libr/util/zip.c" 3 4
                          unsigned char 
# 86 "project/radare2/libr/util/zip.c"
                              *src, int srcLen, int *consumed, int *dstLen) {
 return r_inflatew (src, srcLen, consumed, dstLen, 
# 87 "project/radare2/libr/util/zip.c" 3 4
                                                  15 
# 87 "project/radare2/libr/util/zip.c"
                                                            + 32);
}


# 90 "project/radare2/libr/util/zip.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 90 "project/radare2/libr/util/zip.c"
         *r_inflate_raw(const 
# 90 "project/radare2/libr/util/zip.c" 3 4
                              unsigned char 
# 90 "project/radare2/libr/util/zip.c"
                                  *src, int srcLen, int *consumed, int *dstLen) {
 return r_inflatew (src, srcLen, consumed, dstLen, -
# 91 "project/radare2/libr/util/zip.c" 3 4
                                                   15
# 91 "project/radare2/libr/util/zip.c"
                                                            );
}
