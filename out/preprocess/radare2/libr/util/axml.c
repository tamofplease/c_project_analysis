# 0 "project/radare2/libr/util/axml.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/axml.c"
...
# 4 "project/radare2/libr/util/axml.c" 2
...
typedef int RRef;
# 5 "project/radare2/libr/util/axml.c" 2
...
# 6 "project/radare2/libr/util/axml.c" 2

# 1 "project/radare2/libr/util/axml_resources.h" 1
...
# 1590 "project/radare2/libr/util/axml_resources.h"
                                                                           ;
# 8 "project/radare2/libr/util/axml.c" 2
...
typedef struct { 
# 34 "project/radare2/libr/util/axml.c" 3 4
unsigned short 
# 34 "project/radare2/libr/util/axml.c"
type; 
# 34 "project/radare2/libr/util/axml.c" 3 4
unsigned short 
# 34 "project/radare2/libr/util/axml.c"
...
# 39 "project/radare2/libr/util/axml.c"
  chunk_header_t;


typedef struct { 
# 42 "project/radare2/libr/util/axml.c" 3 4
unsigned int 
# 42 "project/radare2/libr/util/axml.c"
string_count; 
# 42 "project/radare2/libr/util/axml.c" 3 4
unsigned int 
# 42 "project/radare2/libr/util/axml.c"
...
# 50 "project/radare2/libr/util/axml.c"
  string_pool_t;

typedef struct { 
# 52 "project/radare2/libr/util/axml.c" 3 4
unsigned short 
# 52 "project/radare2/libr/util/axml.c"
size; 
# 52 "project/radare2/libr/util/axml.c" 3 4
unsigned char 
# 52 "project/radare2/libr/util/axml.c"
...
# 52 "project/radare2/libr/util/axml.c" 3 4
__attribute__((__packed__))
# 61 "project/radare2/libr/util/axml.c"
   resource_value_t
# 61 "project/radare2/libr/util/axml.c"
                  ;

typedef struct { 
# 63 "project/radare2/libr/util/axml.c" 3 4
unsigned int 
# 63 "project/radare2/libr/util/axml.c"
namespace; 
# 63 "project/radare2/libr/util/axml.c" 3 4
unsigned int 
# 63 "project/radare2/libr/util/axml.c"
...
# 69 "project/radare2/libr/util/axml.c"
  attribute_t;

typedef struct { 
# 71 "project/radare2/libr/util/axml.c" 3 4
unsigned int 
# 71 "project/radare2/libr/util/axml.c"
line; 
# 71 "project/radare2/libr/util/axml.c" 3 4
unsigned int 
# 71 "project/radare2/libr/util/axml.c"
...
unsigned short 
# 71 "project/radare2/libr/util/axml.c"
unused2; attribute_t attributes[]; } 
# 71 "project/radare2/libr/util/axml.c" 3 4
__attribute__((__packed__))
# 83 "project/radare2/libr/util/axml.c"
   start_element_t
# 83 "project/radare2/libr/util/axml.c"
                 ;

typedef struct { 
# 85 "project/radare2/libr/util/axml.c" 3 4
unsigned int 
# 85 "project/radare2/libr/util/axml.c"
line; 
# 85 "project/radare2/libr/util/axml.c" 3 4
unsigned int 
# 85 "project/radare2/libr/util/axml.c"
...
# 91 "project/radare2/libr/util/axml.c"
  end_element_t;

typedef struct { 
# 93 "project/radare2/libr/util/axml.c" 3 4
unsigned int 
# 93 "project/radare2/libr/util/axml.c"
line; 
# 93 "project/radare2/libr/util/axml.c" 3 4
unsigned int 
# 93 "project/radare2/libr/util/axml.c"
...
# 99 "project/radare2/libr/util/axml.c"
  namespace_t;

static char *string_lookup(string_pool_t *pool, const 
# 101 "project/radare2/libr/util/axml.c" 3 4
                                                     unsigned char 
# 101 "project/radare2/libr/util/axml.c"
                                                         *data, 
# 101 "project/radare2/libr/util/axml.c" 3 4
                                                                unsigned long long 
# 101 "project/radare2/libr/util/axml.c"
...
# 101 "project/radare2/libr/util/axml.c"
 ...
 if (i > r_read_le32 (&pool->string_count)) {
  return 
# 103 "project/radare2/libr/util/axml.c" 3 4
        ((void *)0)
# 103 "project/radare2/libr/util/axml.c"
            ;
 }

 
# 106 "project/radare2/libr/util/axml.c" 3 4
unsigned int 
# 106 "project/radare2/libr/util/axml.c"
     offset = r_read_le32 (&pool->offsets[i]);
 
# 107 "project/radare2/libr/util/axml.c" 3 4
unsigned char 
# 107 "project/radare2/libr/util/axml.c"
    *start = (
# 107 "project/radare2/libr/util/axml.c" 3 4
              unsigned char 
# 107 "project/radare2/libr/util/axml.c"
                  *)((uintptr_t)data + r_read_le32 (&pool->strings_offset) + 8 + offset);

 char *name = 
# 109 "project/radare2/libr/util/axml.c" 3 4
             ((void *)0)
# 109 "project/radare2/libr/util/axml.c"
                 ;
 if (pool->flags & FLAG_UTF8) {
  if ((
# 111 "project/radare2/libr/util/axml.c" 3 4
      unsigned long long
# 111 "project/radare2/libr/util/axml.c"
          )start > (
# 111 "project/radare2/libr/util/axml.c" 3 4
                    unsigned long long
# 111 "project/radare2/libr/util/axml.c"
                        )data + data_size - sizeof(
# 111 "project/radare2/libr/util/axml.c" 3 4
                                                   unsigned short
# 111 "project/radare2/libr/util/axml.c"
                                                       )) {
   return 
# 112 "project/radare2/libr/util/axml.c" 3 4
         ((void *)0)
# 112 "project/radare2/libr/util/axml.c"
             ;
  }


  
# 116 "project/radare2/libr/util/axml.c" 3 4
 unsigned int 
# 116 "project/radare2/libr/util/axml.c"
      n = *start++;
  if (n & 0x80) {
   n = ((n & 0x7f) << 8) | *start++;
  }
  ...
  if ((
# 122 "project/radare2/libr/util/axml.c" 3 4
      unsigned long long
# 122 "project/radare2/libr/util/axml.c"
          )start > (
# 122 "project/radare2/libr/util/axml.c" 3 4
                    unsigned long long
# 122 "project/radare2/libr/util/axml.c"
...
# 122 "project/radare2/libr/util/axml.c"
   ...
   return 
# 123 "project/radare2/libr/util/axml.c" 3 4
         ((void *)0)
# 123 "project/radare2/libr/util/axml.c"
             ;
  }
  ...
  if (n > data_size) {
   return 
# 133 "project/radare2/libr/util/axml.c" 3 4
         ((void *)0)
# 133 "project/radare2/libr/util/axml.c"
             ;
  }
  ...
  if ((
# 146 "project/radare2/libr/util/axml.c" 3 4
      unsigned long long
# 146 "project/radare2/libr/util/axml.c"
          )start > (
# 146 "project/radare2/libr/util/axml.c" 3 4
                    unsigned long long
# 146 "project/radare2/libr/util/axml.c"
...
# 146 "project/radare2/libr/util/axml.c"
   ...
   free (name);
   return 
# 148 "project/radare2/libr/util/axml.c" 3 4
         ((void *)0)
# 148 "project/radare2/libr/util/axml.c"
             ;
  }

  
# 151 "project/radare2/libr/util/axml.c" 3 4
 __builtin___memcpy_chk (
# 151 "project/radare2/libr/util/axml.c"
 name
# 151 "project/radare2/libr/util/axml.c" 3 4
 , 
# 151 "project/radare2/libr/util/axml.c"
...
# 151 "project/radare2/libr/util/axml.c"
  ...
  if ((
# 157 "project/radare2/libr/util/axml.c" 3 4
      unsigned long long
# 157 "project/radare2/libr/util/axml.c"
          )start > (
# 157 "project/radare2/libr/util/axml.c" 3 4
                    unsigned long long
# 157 "project/radare2/libr/util/axml.c"
...
# 157 "project/radare2/libr/util/axml.c"
   ...
   return 
# 158 "project/radare2/libr/util/axml.c" 3 4
         ((void *)0)
# 158 "project/radare2/libr/util/axml.c"
             ;
  }

  
# 161 "project/radare2/libr/util/axml.c" 3 4
 unsigned short 
# 161 "project/radare2/libr/util/axml.c"
      *start16 = (
# 161 "project/radare2/libr/util/axml.c" 3 4
                  unsigned short 
# 161 "project/radare2/libr/util/axml.c"
...
# 164 "project/radare2/libr/util/axml.c" 3 4
 unsigned int 
# 164 "project/radare2/libr/util/axml.c"
      n = r_read_le16 (start16++);
  if (n & 0x8000) {
  ...
  if (n * 2 > data_size) {
   return 
# 173 "project/radare2/libr/util/axml.c" 3 4
         ((void *)0)
# 173 "project/radare2/libr/util/axml.c"
             ;
  }
  ...
  if ((
# 178 "project/radare2/libr/util/axml.c" 3 4
      unsigned long long
# 178 "project/radare2/libr/util/axml.c"
          )start16 > (
# 178 "project/radare2/libr/util/axml.c" 3 4
                      unsigned long long
# 178 "project/radare2/libr/util/axml.c"
...
# 178 "project/radare2/libr/util/axml.c"
   ...
   free (name);
   return 
# 180 "project/radare2/libr/util/axml.c" 3 4
         ((void *)0)
# 180 "project/radare2/libr/util/axml.c"
             ;
  }


  if (r_str_utf16_to_utf8 ((
# 184 "project/radare2/libr/util/axml.c" 3 4
                           unsigned char 
# 184 "project/radare2/libr/util/axml.c"
                               *)name, n * 2, (const 
# 184 "project/radare2/libr/util/axml.c" 3 4
                                                     unsigned char 
# 184 "project/radare2/libr/util/axml.c"
...
# 186 "project/radare2/libr/util/axml.c" 3 4
  fprintf(__stderrp,
# 186 "project/radare2/libr/util/axml.c"
  "Failed to decode UTF16-LE\n"
# 186 "project/radare2/libr/util/axml.c" 3 4
  )
# 186 "project/radare2/libr/util/axml.c"
                                         ;
   return 
# 187 "project/radare2/libr/util/axml.c" 3 4
         ((void *)0)
# 187 "project/radare2/libr/util/axml.c"
             ;
  }
...
static char *resource_value(string_pool_t *pool, const 
# 198 "project/radare2/libr/util/axml.c" 3 4
                                                      unsigned char 
# 198 "project/radare2/libr/util/axml.c"
                                                          *data, 
# 198 "project/radare2/libr/util/axml.c" 3 4
                                                                 unsigned long long 
# 198 "project/radare2/libr/util/axml.c"
 ...
 case RESOURCE_STRING:
  return string_lookup (pool, data, data_size, r_read_le32 (&value->data.d), 
# 206 "project/radare2/libr/util/axml.c" 3 4
                                                                            ((void *)0)
# 206 "project/radare2/libr/util/axml.c"
                                                                                );
 case RESOURCE_FLOAT:
...
# 216 "project/radare2/libr/util/axml.c" 3 4
 fprintf(__stderrp,
# 216 "project/radare2/libr/util/axml.c"
 "Resource type is not recognized: %#x\n", value->type
# 216 "project/radare2/libr/util/axml.c" 3 4
 )
# 216 "project/radare2/libr/util/axml.c"
                                                                ;
...
static 
# 222 "project/radare2/libr/util/axml.c" 3 4
      _Bool 
# 222 "project/radare2/libr/util/axml.c"
           dump_element(RStrBuf *sb, string_pool_t *pool, namespace_t *namespace,
  const 
# 223 "project/radare2/libr/util/axml.c" 3 4
       unsigned char 
# 223 "project/radare2/libr/util/axml.c"
           *data, 
# 223 "project/radare2/libr/util/axml.c" 3 4
                  unsigned long long 
# 223 "project/radare2/libr/util/axml.c"
                       data_size, start_element_t *element, size_t element_size,
  const 
# 224 "project/radare2/libr/util/axml.c" 3 4
       unsigned int 
# 224 "project/radare2/libr/util/axml.c"
            *resource_map, 
# 224 "project/radare2/libr/util/axml.c" 3 4
                           unsigned int 
# 224 "project/radare2/libr/util/axml.c"
...
# 225 "project/radare2/libr/util/axml.c" 3 4
unsigned int 
# 225 "project/radare2/libr/util/axml.c"
     i;

 char *name = string_lookup (pool, data, data_size, r_read_le32 (&element->name), 
# 227 "project/radare2/libr/util/axml.c" 3 4
                                                                                 ((void *)0)
# 227 "project/radare2/libr/util/axml.c"
                                                                                     );
 for (i = 0; i < *depth; i++) {
  r_strbuf_appendf (sb, "\t");
 }
...
# 234 "project/radare2/libr/util/axml.c" 3 4
 unsigned short 
# 234 "project/radare2/libr/util/axml.c"
      count = r_read_le16 (&element->attribute_count);
  if (*depth == 0 && namespace) {
   char *key = string_lookup (pool, data, data_size, namespace->prefix, 
# 236 "project/radare2/libr/util/axml.c" 3 4
                                                                       ((void *)0)
# 236 "project/radare2/libr/util/axml.c"
                                                                           );
   char *value = string_lookup (pool, data, data_size, namespace->uri, 
# 237 "project/radare2/libr/util/axml.c" 3 4
                                                                      ((void *)0)
# 237 "project/radare2/libr/util/axml.c"
                                                                          );
...
# 245 "project/radare2/libr/util/axml.c" 3 4
  fprintf(__stderrp,
# 245 "project/radare2/libr/util/axml.c"
...
# 245 "project/radare2/libr/util/axml.c"
   ...
   free (name);
   return 
# 247 "project/radare2/libr/util/axml.c" 3 4
         0
# 247 "project/radare2/libr/util/axml.c"
              ;
  }
...
# 256 "project/radare2/libr/util/axml.c" 3 4
  unsigned int 
# 256 "project/radare2/libr/util/axml.c"
       key_index = r_read_le32 (&a.name);
   const char *key = (const char *)string_lookup (pool, data, data_size, key_index, 
# 257 "project/radare2/libr/util/axml.c" 3 4
                                                                                   ((void *)0)
# 257 "project/radare2/libr/util/axml.c"
                                                                                       );
   
# 258 "project/radare2/libr/util/axml.c" 3 4
  _Bool 
# 258 "project/radare2/libr/util/axml.c"
       resource_key = 
# 258 "project/radare2/libr/util/axml.c" 3 4
                      0
# 258 "project/radare2/libr/util/axml.c"
   ...
   if (key && *key == '\0') {
    ...
    key = "null";
    resource_key = 
# 263 "project/radare2/libr/util/axml.c" 3 4
                  1
# 263 "project/radare2/libr/util/axml.c"
                      ;
    if (resource_map && key_index < resource_map_length) {
     
# 265 "project/radare2/libr/util/axml.c" 3 4
    unsigned int 
# 265 "project/radare2/libr/util/axml.c"
         resource = r_read_le32 (&resource_map[key_index]);
   ...
   if (r_read_le32 (&a.namespace) != -1 && namespace && namespace->prefix != -1) {
    char *ns = string_lookup (pool, data, data_size, namespace->prefix, 
# 278 "project/radare2/libr/util/axml.c" 3 4
                                                                       ((void *)0)
# 278 "project/radare2/libr/util/axml.c"
                                                                           );
 ...
 free (name);
 return 
# 298 "project/radare2/libr/util/axml.c" 3 4
       1
# 298 "project/radare2/libr/util/axml.c"
           ;
}


# 301 "project/radare2/libr/util/axml.c" 3 4
__attribute__((visibility("default"))) 
# 301 "project/radare2/libr/util/axml.c"
     char *r_axml_decode(const 
# 301 "project/radare2/libr/util/axml.c" 3 4
                               unsigned char 
# 301 "project/radare2/libr/util/axml.c"
                                   *data, const 
...
# 301 "project/radare2/libr/util/axml.c"
                                                     data_size) {
 string_pool_t *pool = 
# 302 "project/radare2/libr/util/axml.c" 3 4
                      ((void *)0)
# 302 "project/radare2/libr/util/axml.c"
                          ;
 namespace_t *namespace = 
# 303 "project/radare2/libr/util/axml.c" 3 4
                         ((void *)0)
# 303 "project/radare2/libr/util/axml.c"
                             ;
 const 
# 304 "project/radare2/libr/util/axml.c" 3 4
      unsigned int 
# 304 "project/radare2/libr/util/axml.c"
           *resource_map = 
# 304 "project/radare2/libr/util/axml.c" 3 4
                           ((void *)0)
# 304 "project/radare2/libr/util/axml.c"
...
# 305 "project/radare2/libr/util/axml.c" 3 4
unsigned int 
# 305 "project/radare2/libr/util/axml.c"
     resource_map_length = 0;
 RStrBuf *sb = 
# 306 "project/radare2/libr/util/axml.c" 3 4
              ((void *)0)
# 306 "project/radare2/libr/util/axml.c"
                  ;
 
# 307 "project/radare2/libr/util/axml.c" 3 4
int 
# 307 "project/radare2/libr/util/axml.c"
     depth = 0;

 if (!data_size) {
  return 
# 310 "project/radare2/libr/util/axml.c" 3 4
        ((void *)0)
# 310 "project/radare2/libr/util/axml.c"
            ;
 }

 
# 313 "project/radare2/libr/util/axml.c" 3 4
do { if (!(
# 313 "project/radare2/libr/util/axml.c"
data
# 313 "project/radare2/libr/util/axml.c" 3 4
...
# 313 "project/radare2/libr/util/axml.c"
 ...
 RBuffer *buffer = r_buf_new_with_pointers (data, data_size, 
# 315 "project/radare2/libr/util/axml.c" 3 4
                                                            0
# 315 "project/radare2/libr/util/axml.c"
                                                                 );
 if (!buffer) {
  
# 317 "project/radare2/libr/util/axml.c" 3 4
 fprintf(__stderrp,
# 317 "project/radare2/libr/util/axml.c"
 "Error allocating RBuffer\n"
# 317 "project/radare2/libr/util/axml.c" 3 4
 )
# 317 "project/radare2/libr/util/axml.c"
                                       ;
...
# 321 "project/radare2/libr/util/axml.c" 3 4
unsigned long long 
# 321 "project/radare2/libr/util/axml.c"
     offset = 0;

 chunk_header_t header = {0};
 if (r_buf_fread_at (buffer, offset, (
# 324 "project/radare2/libr/util/axml.c" 3 4
                                     unsigned char 
# 324 "project/radare2/libr/util/axml.c"
                                         *)&header, "ssi", 1) != sizeof(header)) {
  goto bad;
 }
...
# 332 "project/radare2/libr/util/axml.c" 3 4
unsigned long long 
# 332 "project/radare2/libr/util/axml.c"
     binary_size = header.size;
 ...
 while (offset < binary_size) {
  if (r_buf_fread_at (buffer, offset, (
# 342 "project/radare2/libr/util/axml.c" 3 4
                                      unsigned char 
# 342 "project/radare2/libr/util/axml.c"
                                          *)&header, "ssi", 1) != sizeof(header)) {
   goto bad;
  }

  
# 346 "project/radare2/libr/util/axml.c" 3 4
 unsigned short 
# 346 "project/radare2/libr/util/axml.c"
      type = header.type;
...
# 354 "project/radare2/libr/util/axml.c" 3 4
  unsigned short 
# 354 "project/radare2/libr/util/axml.c"
...
# 374 "project/radare2/libr/util/axml.c" 3 4
  unsigned short 
# 374 "project/radare2/libr/util/axml.c"
       header_size = header.size;
   if (header_size == 0 || header_size > data_size) {
    goto bad;
   }
   ...
   if (!dump_element (sb, pool, namespace, data, data_size, element, header_size,
     resource_map, resource_map_length, &depth, 
# 390 "project/radare2/libr/util/axml.c" 3 4
                                               1
# 390 "project/radare2/libr/util/axml.c"
                                                   )) {
    free (element);
    goto bad;
   }
  ...
  case TYPE_END_ELEMENT: {
   ...
   if (!dump_element (sb, pool, namespace, data, data_size, (start_element_t *)&end, 0,
     resource_map, resource_map_length, &depth, 
# 413 "project/radare2/libr/util/axml.c" 3 4
                                               0
# 413 "project/radare2/libr/util/axml.c"
                                                    )) {
    goto bad;
   }
  } break;
  case TYPE_START_NAMESPACE: {
   ...
   if (r_buf_fread_at (buffer, offset, (
# 421 "project/radare2/libr/util/axml.c" 3 4
                                       unsigned char 
# 421 "project/radare2/libr/util/axml.c"
                                           *)namespace, "iiii", 1) != sizeof(*namespace)) {
    goto bad;
   }
  } break;
  ...
  case TYPE_RESOURCE_MAP:
   resource_map = (
# 428 "project/radare2/libr/util/axml.c" 3 4
                  unsigned int 
# 428 "project/radare2/libr/util/axml.c"
                       *)(data + offset);
   resource_map_length = header.size;
   if (resource_map_length > data_size - offset) {
    goto bad;
   }
   resource_map_length /= sizeof(
# 433 "project/radare2/libr/util/axml.c" 3 4
                                unsigned int
# 433 "project/radare2/libr/util/axml.c"
                                    );
   break;
  default:
   
# 436 "project/radare2/libr/util/axml.c" 3 4
  fprintf(__stderrp,
# 436 "project/radare2/libr/util/axml.c"
  "Type is not recognized: %#x\n", type
# 436 "project/radare2/libr/util/axml.c" 3 4
  )
# 436 "project/radare2/libr/util/axml.c"
                                                 ;
...
# 447 "project/radare2/libr/util/axml.c" 3 4
fprintf(__stderrp,
# 447 "project/radare2/libr/util/axml.c"
...
error:
 ...
 r_strbuf_free (sb);
 return 
# 453 "project/radare2/libr/util/axml.c" 3 4
       ((void *)0)
# 453 "project/radare2/libr/util/axml.c"
           ;
}
