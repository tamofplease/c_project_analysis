# 0 "project/radare2/libr/util/thread_sem.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/thread_sem.c"
...
# 4 "project/radare2/libr/util/thread_sem.c" 2
# 13 "project/radare2/libr/util/thread_sem.c"
...
# 14 "project/radare2/libr/util/thread_sem.c" 2
# 1 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include-fixed/limits.h" 1 3 4
# 15 "project/radare2/libr/util/thread_sem.c" 2


__attribute__((visibility("default"))) 
# 17 "project/radare2/libr/util/thread_sem.c"
     RThreadSemaphore *r_th_sem_new(unsigned int initial) {
 RThreadSemaphore *sem = 
# 18 "project/radare2/libr/util/thread_sem.c" 3 4
                        (
# 18 "project/radare2/libr/util/thread_sem.c"
                        RThreadSemaphore
# 18 "project/radare2/libr/util/thread_sem.c" 3 4
                        *)malloc(sizeof(
# 18 "project/radare2/libr/util/thread_sem.c"
...
# 18 "project/radare2/libr/util/thread_sem.c"
 ...
 if (!sem) {
  return 
# 20 "project/radare2/libr/util/thread_sem.c" 3 4
        ((void *)0)
# 20 "project/radare2/libr/util/thread_sem.c"
            ;
 }
 ...
 sem->sem = sem_open (name, 
# 32 "project/radare2/libr/util/thread_sem.c" 3 4
                           0x00000200 
# 32 "project/radare2/libr/util/thread_sem.c"
                                   | 
# 32 "project/radare2/libr/util/thread_sem.c" 3 4
                                     0x00000800
# 32 "project/radare2/libr/util/thread_sem.c"
...
# 32 "project/radare2/libr/util/thread_sem.c"
                                                              , initial);
 if (sem->sem == 
# 33 "project/radare2/libr/util/thread_sem.c" 3 4
                ((sem_t *)-1)
# 33 "project/radare2/libr/util/thread_sem.c"
                          ) {
  free (sem);
  return 
# 35 "project/radare2/libr/util/thread_sem.c" 3 4
        ((void *)0)
# 35 "project/radare2/libr/util/thread_sem.c"
            ;
 }
# 56 "project/radare2/libr/util/thread_sem.c"
 return sem;
}


# 59 "project/radare2/libr/util/thread_sem.c" 3 4
__attribute__((visibility("default"))) 
# 59 "project/radare2/libr/util/thread_sem.c"
     void r_th_sem_free(RThreadSemaphore *sem) {
 if (!sem) {
  return;
 }
...
# 78 "project/radare2/libr/util/thread_sem.c" 3 4
__attribute__((visibility("default"))) 
# 78 "project/radare2/libr/util/thread_sem.c"
     void r_th_sem_post(RThreadSemaphore *sem) {
...
# 86 "project/radare2/libr/util/thread_sem.c" 3 4
__attribute__((visibility("default"))) 
# 86 "project/radare2/libr/util/thread_sem.c"
     void r_th_sem_wait(RThreadSemaphore *sem) {
