# 0 "project/radare2/libr/util/new_rbtree.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/new_rbtree.c"
# 32 "project/radare2/libr/util/new_rbtree.c"
...
# 33 "project/radare2/libr/util/new_rbtree.c" 2


# 34 "project/radare2/libr/util/new_rbtree.c"
...
# 43 "project/radare2/libr/util/new_rbtree.c" 3 4
__attribute__((visibility("default"))) 
# 43 "project/radare2/libr/util/new_rbtree.c"
     RRBTree *r_crbtree_new(RRBFree freefn) {
 RRBTree *tree = 
# 44 "project/radare2/libr/util/new_rbtree.c" 3 4
                (
# 44 "project/radare2/libr/util/new_rbtree.c"
                RRBTree
# 44 "project/radare2/libr/util/new_rbtree.c" 3 4
                *)calloc(1,sizeof(
# 44 "project/radare2/libr/util/new_rbtree.c"
...
# 51 "project/radare2/libr/util/new_rbtree.c" 3 4
__attribute__((visibility("default"))) 
# 51 "project/radare2/libr/util/new_rbtree.c"
     void r_crbtree_clear(RRBTree *tree) {
 
# 52 "project/radare2/libr/util/new_rbtree.c" 3 4
do { if (!(
# 52 "project/radare2/libr/util/new_rbtree.c"
tree
# 52 "project/radare2/libr/util/new_rbtree.c" 3 4
...
# 52 "project/radare2/libr/util/new_rbtree.c"
                       ;
 RRBNode *iter = tree->root, *save = 
# 53 "project/radare2/libr/util/new_rbtree.c" 3 4
                                    ((void *)0)
# 53 "project/radare2/libr/util/new_rbtree.c"
                                        ;
 ...
 tree->root = 
# 72 "project/radare2/libr/util/new_rbtree.c" 3 4
             ((void *)0)
# 72 "project/radare2/libr/util/new_rbtree.c"
                 ;
}


# 75 "project/radare2/libr/util/new_rbtree.c" 3 4
__attribute__((visibility("default"))) 
# 75 "project/radare2/libr/util/new_rbtree.c"
     void r_crbtree_free(RRBTree *tree) {
 if (!tree) {
  return;
 }
...
# 83 "project/radare2/libr/util/new_rbtree.c" 3 4
__attribute__((visibility("default"))) 
# 83 "project/radare2/libr/util/new_rbtree.c"
     RRBNode *r_crbtree_find_node(RRBTree *tree, void *data, RRBComparator cmp, void *user) {
 
# 84 "project/radare2/libr/util/new_rbtree.c" 3 4
do { if (!(
# 84 "project/radare2/libr/util/new_rbtree.c"
tree && cmp
# 84 "project/radare2/libr/util/new_rbtree.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 84 "project/radare2/libr/util/new_rbtree.c"
...
# 84 "project/radare2/libr/util/new_rbtree.c"
 ...
 return 
# 94 "project/radare2/libr/util/new_rbtree.c" 3 4
       ((void *)0)
# 94 "project/radare2/libr/util/new_rbtree.c"
           ;
}


# 97 "project/radare2/libr/util/new_rbtree.c" 3 4
__attribute__((visibility("default"))) 
# 97 "project/radare2/libr/util/new_rbtree.c"
     void *r_crbtree_find(RRBTree *tree, void *data, RRBComparator cmp, void *user) {
 
# 98 "project/radare2/libr/util/new_rbtree.c" 3 4
do { if (!(
# 98 "project/radare2/libr/util/new_rbtree.c"
tree && cmp
# 98 "project/radare2/libr/util/new_rbtree.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 98 "project/radare2/libr/util/new_rbtree.c"
"tree && cmp"
# 98 "project/radare2/libr/util/new_rbtree.c" 3 4
, 98); return (((void *)0)); } } while (0)
# 98 "project/radare2/libr/util/new_rbtree.c"
                                        ;
 RRBNode *node = r_crbtree_find_node (tree, data, cmp, user);
 return node ? node->data : 
# 100 "project/radare2/libr/util/new_rbtree.c" 3 4
                           ((void *)0)
# 100 "project/radare2/libr/util/new_rbtree.c"
                               ;
}

static RRBNode *_node_new(void *data, RRBNode *parent) {
 RRBNode *node = 
# 104 "project/radare2/libr/util/new_rbtree.c" 3 4
                (
# 104 "project/radare2/libr/util/new_rbtree.c"
                RRBNode
# 104 "project/radare2/libr/util/new_rbtree.c" 3 4
                *)calloc(1,sizeof(
# 104 "project/radare2/libr/util/new_rbtree.c"
...
# 105 "project/radare2/libr/util/new_rbtree.c" 3 4
do { if (!(
# 105 "project/radare2/libr/util/new_rbtree.c"
node
# 105 "project/radare2/libr/util/new_rbtree.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 105 "project/radare2/libr/util/new_rbtree.c"
...
# 117 "project/radare2/libr/util/new_rbtree.c" 3 4
do { if (!(
# 117 "project/radare2/libr/util/new_rbtree.c"
root
# 117 "project/radare2/libr/util/new_rbtree.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 117 "project/radare2/libr/util/new_rbtree.c"
...
# 131 "project/radare2/libr/util/new_rbtree.c" 3 4
do { if (!(
# 131 "project/radare2/libr/util/new_rbtree.c"
root
# 131 "project/radare2/libr/util/new_rbtree.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 131 "project/radare2/libr/util/new_rbtree.c"
...
# 137 "project/radare2/libr/util/new_rbtree.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 137 "project/radare2/libr/util/new_rbtree.c"
          r_crbtree_insert(RRBTree *tree, void *data, RRBComparator cmp, void *user) {
 
# 138 "project/radare2/libr/util/new_rbtree.c" 3 4
do { if (!(
# 138 "project/radare2/libr/util/new_rbtree.c"
tree && data && cmp
# 138 "project/radare2/libr/util/new_rbtree.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 138 "project/radare2/libr/util/new_rbtree.c"
"tree && data && cmp"
# 138 "project/radare2/libr/util/new_rbtree.c" 3 4
, 138); return (0); } } while (0)
# 138 "project/radare2/libr/util/new_rbtree.c"
                                                 ;
 
# 139 "project/radare2/libr/util/new_rbtree.c" 3 4
_Bool 
# 139 "project/radare2/libr/util/new_rbtree.c"
     inserted = 
# 139 "project/radare2/libr/util/new_rbtree.c" 3 4
                0
# 139 "project/radare2/libr/util/new_rbtree.c"
 ...
 if (tree->root == 
# 141 "project/radare2/libr/util/new_rbtree.c" 3 4
                  ((void *)0)
# 141 "project/radare2/libr/util/new_rbtree.c"
                      ) {
  tree->root = _node_new (data, 
# 142 "project/radare2/libr/util/new_rbtree.c" 3 4
                               ((void *)0)
# 142 "project/radare2/libr/util/new_rbtree.c"
                                   );
  if (tree->root == 
# 143 "project/radare2/libr/util/new_rbtree.c" 3 4
                   ((void *)0)
# 143 "project/radare2/libr/util/new_rbtree.c"
                       ) {
   return 
# 144 "project/radare2/libr/util/new_rbtree.c" 3 4
         0
# 144 "project/radare2/libr/util/new_rbtree.c"
              ;
  }
  inserted = 
# 146 "project/radare2/libr/util/new_rbtree.c" 3 4
            1
# 146 "project/radare2/libr/util/new_rbtree.c"
                ;
  goto out_exit;
 }
...
# 151 "project/radare2/libr/util/new_rbtree.c" 3 4
__builtin___memset_chk (
# 151 "project/radare2/libr/util/new_rbtree.c"
&head
# 151 "project/radare2/libr/util/new_rbtree.c" 3 4
, 
# 151 "project/radare2/libr/util/new_rbtree.c"
...
# 151 "project/radare2/libr/util/new_rbtree.c"
                                   ;
 RRBNode *g = 
# 152 "project/radare2/libr/util/new_rbtree.c" 3 4
             ((void *)0)
# 152 "project/radare2/libr/util/new_rbtree.c"
                 , *parent = &head;
 RRBNode *p = 
# 153 "project/radare2/libr/util/new_rbtree.c" 3 4
             ((void *)0)
# 153 "project/radare2/libr/util/new_rbtree.c"
                 , *q = tree->root;
 int dir = 0, last = 0;
 ...
 for (;;) {
  if (!q) {
   ...
   if (!q) {
    return 
# 163 "project/radare2/libr/util/new_rbtree.c" 3 4
          0
# 163 "project/radare2/libr/util/new_rbtree.c"
               ;
   }
   p->link[dir] = q;
   inserted = 
# 166 "project/radare2/libr/util/new_rbtree.c" 3 4
             1
# 166 "project/radare2/libr/util/new_rbtree.c"
                 ;
  } else if (((q->link[0]) != 
# 167 "project/radare2/libr/util/new_rbtree.c" 3 4
            ((void *)0) 
# 167 "project/radare2/libr/util/new_rbtree.c"
            && (q->link[0])->red == 1) && ((q->link[1]) != 
# 167 "project/radare2/libr/util/new_rbtree.c" 3 4
                                   ((void *)0) 
# 167 "project/radare2/libr/util/new_rbtree.c"
                                   && (q->link[1])->red == 1)) {
  ...
  if (((q) != 
# 174 "project/radare2/libr/util/new_rbtree.c" 3 4
     ((void *)0) 
# 174 "project/radare2/libr/util/new_rbtree.c"
     && (q)->red == 1) && ((p) != 
# 174 "project/radare2/libr/util/new_rbtree.c" 3 4
                   ((void *)0) 
# 174 "project/radare2/libr/util/new_rbtree.c"
...
out_exit:
 ...
 tree->root->red = 0;
 tree->root->parent = 
# 212 "project/radare2/libr/util/new_rbtree.c" 3 4
                     ((void *)0)
# 212 "project/radare2/libr/util/new_rbtree.c"
                         ;
 if (inserted) {
  tree->size++;
 }
...
# 225 "project/radare2/libr/util/new_rbtree.c" 3 4
__builtin___memcpy_chk (
# 225 "project/radare2/libr/util/new_rbtree.c"
&node_a_tmp
# 225 "project/radare2/libr/util/new_rbtree.c" 3 4
, 
# 225 "project/radare2/libr/util/new_rbtree.c"
node_a, sizeof (RRBNode)
# 225 "project/radare2/libr/util/new_rbtree.c" 3 4
, __builtin_object_size (
# 225 "project/radare2/libr/util/new_rbtree.c"
&node_a_tmp
...
# 226 "project/radare2/libr/util/new_rbtree.c" 3 4
__builtin___memcpy_chk (
# 226 "project/radare2/libr/util/new_rbtree.c"
&node_b_tmp
# 226 "project/radare2/libr/util/new_rbtree.c" 3 4
, 
# 226 "project/radare2/libr/util/new_rbtree.c"
node_b, sizeof (RRBNode)
# 226 "project/radare2/libr/util/new_rbtree.c" 3 4
, __builtin_object_size (
# 226 "project/radare2/libr/util/new_rbtree.c"
&node_b_tmp
...
# 290 "project/radare2/libr/util/new_rbtree.c" 3 4
__attribute__((visibility("default"))) 
# 290 "project/radare2/libr/util/new_rbtree.c"
     void *r_crbtree_take(RRBTree *tree, void *data, RRBComparator cmp, void *user) {
 
# 291 "project/radare2/libr/util/new_rbtree.c" 3 4
do { if (!(
# 291 "project/radare2/libr/util/new_rbtree.c"
tree && data && tree->size && tree->root && cmp
# 291 "project/radare2/libr/util/new_rbtree.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 291 "project/radare2/libr/util/new_rbtree.c"
"tree && data && tree->size && tree->root && cmp"
# 291 "project/radare2/libr/util/new_rbtree.c" 3 4
, 291); return (((void *)0)); } } while (0)
# 291 "project/radare2/libr/util/new_rbtree.c"
                                                                            ;

 RRBNode head;
 
# 294 "project/radare2/libr/util/new_rbtree.c" 3 4
__builtin___memset_chk (
# 294 "project/radare2/libr/util/new_rbtree.c"
&head
# 294 "project/radare2/libr/util/new_rbtree.c" 3 4
, 
# 294 "project/radare2/libr/util/new_rbtree.c"
...
# 294 "project/radare2/libr/util/new_rbtree.c"
                                   ;
 RRBNode *q = &head, *p = 
# 295 "project/radare2/libr/util/new_rbtree.c" 3 4
                         ((void *)0)
# 295 "project/radare2/libr/util/new_rbtree.c"
                             , *g = 
# 295 "project/radare2/libr/util/new_rbtree.c" 3 4
                                    ((void *)0)
# 295 "project/radare2/libr/util/new_rbtree.c"
                                        ;
 RRBNode *found = 
# 296 "project/radare2/libr/util/new_rbtree.c" 3 4
                 ((void *)0)
# 296 "project/radare2/libr/util/new_rbtree.c"
                     ;
 int dir = 1, last;
 ...
 while (q->link[dir]) {
  ...
  dir = (
# 314 "project/radare2/libr/util/new_rbtree.c" 3 4
        _Bool
# 314 "project/radare2/libr/util/new_rbtree.c"
            )(dir > 0);

  if (((q) != 
# 316 "project/radare2/libr/util/new_rbtree.c" 3 4
     ((void *)0) 
# 316 "project/radare2/libr/util/new_rbtree.c"
     && (q)->red == 1) || ((q->link[dir]) != 
# 316 "project/radare2/libr/util/new_rbtree.c" 3 4
                   ((void *)0) 
# 316 "project/radare2/libr/util/new_rbtree.c"
  ...
  if (((q->link[!dir]) != 
# 319 "project/radare2/libr/util/new_rbtree.c" 3 4
     ((void *)0) 
# 319 "project/radare2/libr/util/new_rbtree.c"
     && (q->link[!dir])->red == 1)) {
   ...
   if (sibling) {
    if (!((sibling->link[!last]) != 
# 325 "project/radare2/libr/util/new_rbtree.c" 3 4
        ((void *)0) 
# 325 "project/radare2/libr/util/new_rbtree.c"
        && (sibling->link[!last])->red == 1) && !((sibling->link[last]) != 
# 325 "project/radare2/libr/util/new_rbtree.c" 3 4
                                          ((void *)0) 
# 325 "project/radare2/libr/util/new_rbtree.c"
                                          && (sibling->link[last])->red == 1)) {
     ...
     int dir2 = (
# 331 "project/radare2/libr/util/new_rbtree.c" 3 4
                _Bool
# 331 "project/radare2/libr/util/new_rbtree.c"
                    )(g->link[1] == p);

     if (((sibling->link[last]) != 
# 333 "project/radare2/libr/util/new_rbtree.c" 3 4
        ((void *)0) 
# 333 "project/radare2/libr/util/new_rbtree.c"
        && (sibling->link[last])->red == 1)) {
 ...
 void *ret = 
# 348 "project/radare2/libr/util/new_rbtree.c" 3 4
            ((void *)0)
# 348 "project/radare2/libr/util/new_rbtree.c"
                ;

 if (found) {
  _set_link (p, q->link[q->link[0] == 
# 351 "project/radare2/libr/util/new_rbtree.c" 3 4
                                     ((void *)0)
# 351 "project/radare2/libr/util/new_rbtree.c"
                                         ], p->link[1] == q);
  if (q != found) {
   q->link[0] = 
# 353 "project/radare2/libr/util/new_rbtree.c" 3 4
               ((void *)0)
# 353 "project/radare2/libr/util/new_rbtree.c"
                   ;
   q->link[1] = 
# 354 "project/radare2/libr/util/new_rbtree.c" 3 4
               ((void *)0)
# 354 "project/radare2/libr/util/new_rbtree.c"
                   ;
   q->parent = 
# 355 "project/radare2/libr/util/new_rbtree.c" 3 4
              ((void *)0)
# 355 "project/radare2/libr/util/new_rbtree.c"
                  ;
 ...
 if (tree->root) {
  tree->root->red = 0;
  tree->root->parent = 
# 367 "project/radare2/libr/util/new_rbtree.c" 3 4
                      ((void *)0)
# 367 "project/radare2/libr/util/new_rbtree.c"
                          ;
 } else {
  
# 369 "project/radare2/libr/util/new_rbtree.c" 3 4
 do { if (!(
# 369 "project/radare2/libr/util/new_rbtree.c"
 tree->size == 0
# 369 "project/radare2/libr/util/new_rbtree.c" 3 4
 )) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 369 "project/radare2/libr/util/new_rbtree.c"
...
# 374 "project/radare2/libr/util/new_rbtree.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 374 "project/radare2/libr/util/new_rbtree.c"
          r_crbtree_delete(RRBTree *tree, void *data, RRBComparator cmp, void *user) {
 
# 375 "project/radare2/libr/util/new_rbtree.c" 3 4
do { if (!(
# 375 "project/radare2/libr/util/new_rbtree.c"
tree && data && tree->size && tree->root && cmp
# 375 "project/radare2/libr/util/new_rbtree.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 375 "project/radare2/libr/util/new_rbtree.c"
...
# 383 "project/radare2/libr/util/new_rbtree.c" 3 4
__attribute__((visibility("default"))) 
# 383 "project/radare2/libr/util/new_rbtree.c"
     RRBNode *r_crbtree_first_node(RRBTree *tree) {
 
# 384 "project/radare2/libr/util/new_rbtree.c" 3 4
do { if (!(
# 384 "project/radare2/libr/util/new_rbtree.c"
tree
# 384 "project/radare2/libr/util/new_rbtree.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 384 "project/radare2/libr/util/new_rbtree.c"
"tree"
# 384 "project/radare2/libr/util/new_rbtree.c" 3 4
, 384); return (((void *)0)); } } while (0)
# 384 "project/radare2/libr/util/new_rbtree.c"
                                 ;
 if (!tree->root) {

  return 
# 387 "project/radare2/libr/util/new_rbtree.c" 3 4
        ((void *)0)
# 387 "project/radare2/libr/util/new_rbtree.c"
            ;
 }
...
# 396 "project/radare2/libr/util/new_rbtree.c" 3 4
__attribute__((visibility("default"))) 
# 396 "project/radare2/libr/util/new_rbtree.c"
     RRBNode *r_crbtree_last_node(RRBTree *tree) {
 
# 397 "project/radare2/libr/util/new_rbtree.c" 3 4
do { if (!(
# 397 "project/radare2/libr/util/new_rbtree.c"
tree
# 397 "project/radare2/libr/util/new_rbtree.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 397 "project/radare2/libr/util/new_rbtree.c"
"tree"
# 397 "project/radare2/libr/util/new_rbtree.c" 3 4
, 397); return (((void *)0)); } } while (0)
# 397 "project/radare2/libr/util/new_rbtree.c"
                                 ;
 if (!tree->root) {

  return 
# 400 "project/radare2/libr/util/new_rbtree.c" 3 4
        ((void *)0)
# 400 "project/radare2/libr/util/new_rbtree.c"
            ;
 }
 RRBNode *node = tree->root;
 while (node->link[1]) {
...
# 409 "project/radare2/libr/util/new_rbtree.c" 3 4
__attribute__((visibility("default"))) 
# 409 "project/radare2/libr/util/new_rbtree.c"
     RRBNode *r_rbnode_next(RRBNode *node) {
 
# 410 "project/radare2/libr/util/new_rbtree.c" 3 4
do { if (!(
# 410 "project/radare2/libr/util/new_rbtree.c"
node
# 410 "project/radare2/libr/util/new_rbtree.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 410 "project/radare2/libr/util/new_rbtree.c"
...
# 426 "project/radare2/libr/util/new_rbtree.c" 3 4
__attribute__((visibility("default"))) 
# 426 "project/radare2/libr/util/new_rbtree.c"
     RRBNode *r_rbnode_prev(RRBNode *node) {
 
# 427 "project/radare2/libr/util/new_rbtree.c" 3 4
do { if (!(
# 427 "project/radare2/libr/util/new_rbtree.c"
node
# 427 "project/radare2/libr/util/new_rbtree.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 427 "project/radare2/libr/util/new_rbtree.c"
