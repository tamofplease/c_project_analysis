# 0 "project/radare2/libr/util/ubase64.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/ubase64.c"
...
# 7 "project/radare2/libr/util/ubase64.c" 2
...
# 8 "project/radare2/libr/util/ubase64.c" 2
...
# 9 "project/radare2/libr/util/ubase64.c" 2
...
# 10 "project/radare2/libr/util/ubase64.c" 2



# 12 "project/radare2/libr/util/ubase64.c"
static const char cb64[] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
static const char cd64[] = "|$$$}rstuvwxyz{$$$$$$$>?@ABCDEFGHIJKLMNOPQRSTUVW$$$$$$XYZ[\\]^_`abcdefghijklmnopq";

static void local_b64_encode(const 
# 15 "project/radare2/libr/util/ubase64.c" 3 4
                                  unsigned char 
# 15 "project/radare2/libr/util/ubase64.c"
                                      in[3], char out[4], int len) {
 if (len < 1) {
  return;
 }
 out[0] = cb64[in[0] >> 2];
...
# 25 "project/radare2/libr/util/ubase64.c" 3 4
                                             unsigned char 
# 25 "project/radare2/libr/util/ubase64.c"
                                                 out[3]) {
 int len = 3;
 
# 27 "project/radare2/libr/util/ubase64.c" 3 4
unsigned char 
# 27 "project/radare2/libr/util/ubase64.c"
    i, v[4] = { 0 };
 for (i = 0; i < 4; i++) {
  if (in[i] < 43 || in[i] > 122) {
   return -1;
...
# 45 "project/radare2/libr/util/ubase64.c" 3 4
__attribute__((visibility("default"))) 
# 45 "project/radare2/libr/util/ubase64.c"
     int r_base64_decode(
# 45 "project/radare2/libr/util/ubase64.c" 3 4
                         unsigned char 
# 45 "project/radare2/libr/util/ubase64.c"
                             *bout, const char *bin, int len) {
 int in, out;
 if (len < 0) {
  len = strlen (bin);
 }
...
# 62 "project/radare2/libr/util/ubase64.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 62 "project/radare2/libr/util/ubase64.c"
         *r_base64_decode_dyn(const char *in, int len) {
 
# 63 "project/radare2/libr/util/ubase64.c" 3 4
unsigned char 
# 63 "project/radare2/libr/util/ubase64.c"
    *bout;
 if (!in) {
  return 
# 65 "project/radare2/libr/util/ubase64.c" 3 4
        ((void *)0)
# 65 "project/radare2/libr/util/ubase64.c"
            ;
 }
 if (len < 0) {
  len = strlen (in) + 1;
 ...
 if (r_base64_decode (bout, in, len) == -1) {
  free (bout);
  return 
# 73 "project/radare2/libr/util/ubase64.c" 3 4
        ((void *)0)
# 73 "project/radare2/libr/util/ubase64.c"
            ;
 }
 return bout;
}
...
# 78 "project/radare2/libr/util/ubase64.c" 3 4
__attribute__((visibility("default"))) 
# 78 "project/radare2/libr/util/ubase64.c"
     int r_base64_encode(char *bout, const 
# 78 "project/radare2/libr/util/ubase64.c" 3 4
                                           unsigned char 
# 78 "project/radare2/libr/util/ubase64.c"
                                               *bin, int len) {
...
# 91 "project/radare2/libr/util/ubase64.c" 3 4
__attribute__((visibility("default"))) 
# 91 "project/radare2/libr/util/ubase64.c"
     char *r_base64_encode_dyn(const char *str, int len) {
 char *bout;
 int in, out;
 if (!str) {
  return 
# 95 "project/radare2/libr/util/ubase64.c" 3 4
        ((void *)0)
# 95 "project/radare2/libr/util/ubase64.c"
            ;
 }
 if (len < 0) {
  len = strlen (str);
 ...
 if (olen < len) {
  return 
# 102 "project/radare2/libr/util/ubase64.c" 3 4
        ((void *)0)
# 102 "project/radare2/libr/util/ubase64.c"
            ;
 }
 bout = (char *)malloc (olen);
 if (!bout) {
  return 
# 106 "project/radare2/libr/util/ubase64.c" 3 4
        ((void *)0)
# 106 "project/radare2/libr/util/ubase64.c"
            ;
 }
 for (in = out = 0; in < len; in += 3, out += 4) {
  local_b64_encode ((const 
# 109 "project/radare2/libr/util/ubase64.c" 3 4
                          unsigned char 
# 109 "project/radare2/libr/util/ubase64.c"
                              *)str + in, (char *)bout + out,
   (len - in) > 3 ? 3 : len - in);
 }
 bout[out] = 0;
 return bout;
