# 0 "project/radare2/libr/util/signal.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/signal.c"
...
# 4 "project/radare2/libr/util/signal.c" 2


# 1 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include/stddef.h" 1 3 4
# 7 "project/radare2/libr/util/signal.c" 2


# 8 "project/radare2/libr/util/signal.c"
static struct {
 const char *name;
 int code;
} signals[] = {
 { "SIGINT", 
# 12 "project/radare2/libr/util/signal.c" 3 4
            2 
# 12 "project/radare2/libr/util/signal.c"
                   },
 { "SIGILL", 
# 13 "project/radare2/libr/util/signal.c" 3 4
            4 
# 13 "project/radare2/libr/util/signal.c"
                   },
 { "SIGABRT", 
# 14 "project/radare2/libr/util/signal.c" 3 4
             6 
# 14 "project/radare2/libr/util/signal.c"
                     },
 { "SIGFPE", 
# 15 "project/radare2/libr/util/signal.c" 3 4
            8 
# 15 "project/radare2/libr/util/signal.c"
                   },
 { "SIGSEGV", 
# 16 "project/radare2/libr/util/signal.c" 3 4
             11 
# 16 "project/radare2/libr/util/signal.c"
                     },
 { "SIGTERM", 
# 17 "project/radare2/libr/util/signal.c" 3 4
             15 
# 17 "project/radare2/libr/util/signal.c"
                     },
 ...
 { "SIGHUP", 
# 25 "project/radare2/libr/util/signal.c" 3 4
            1 
# 25 "project/radare2/libr/util/signal.c"
                   },
 { "SIGQUIT", 
# 26 "project/radare2/libr/util/signal.c" 3 4
             3 
# 26 "project/radare2/libr/util/signal.c"
                     },
 { "SIGTRAP", 
# 27 "project/radare2/libr/util/signal.c" 3 4
             5 
# 27 "project/radare2/libr/util/signal.c"
                     },
 { "SIGBUS", 
# 28 "project/radare2/libr/util/signal.c" 3 4
            10 
# 28 "project/radare2/libr/util/signal.c"
                   },
 { "SIGKILL", 
# 29 "project/radare2/libr/util/signal.c" 3 4
             9 
# 29 "project/radare2/libr/util/signal.c"
                     },
 { "SIGUSR1", 
# 30 "project/radare2/libr/util/signal.c" 3 4
             30 
# 30 "project/radare2/libr/util/signal.c"
                     },
 { "SIGUSR2", 
# 31 "project/radare2/libr/util/signal.c" 3 4
             31 
# 31 "project/radare2/libr/util/signal.c"
                     },
 { "SIGPIPE", 
# 32 "project/radare2/libr/util/signal.c" 3 4
             13 
# 32 "project/radare2/libr/util/signal.c"
                     },
 { "SIGALRM", 
# 33 "project/radare2/libr/util/signal.c" 3 4
             14 
# 33 "project/radare2/libr/util/signal.c"
                     },
 { "SIGCHLD", 
# 34 "project/radare2/libr/util/signal.c" 3 4
             20 
# 34 "project/radare2/libr/util/signal.c"
                     },
 { "SIGCONT", 
# 35 "project/radare2/libr/util/signal.c" 3 4
             19 
# 35 "project/radare2/libr/util/signal.c"
                     },
 { "SIGSTOP", 
# 36 "project/radare2/libr/util/signal.c" 3 4
             17 
# 36 "project/radare2/libr/util/signal.c"
                     },
 { "SIGTSTP", 
# 37 "project/radare2/libr/util/signal.c" 3 4
             18 
# 37 "project/radare2/libr/util/signal.c"
                     },
 { "SIGTTIN", 
# 38 "project/radare2/libr/util/signal.c" 3 4
             21 
# 38 "project/radare2/libr/util/signal.c"
                     },
 { "SIGTTOU", 
# 39 "project/radare2/libr/util/signal.c" 3 4
             22 
# 39 "project/radare2/libr/util/signal.c"
                     },
 { "SIGURG", 
# 40 "project/radare2/libr/util/signal.c" 3 4
            16 
# 40 "project/radare2/libr/util/signal.c"
                   },
 { "SIGXCPU", 
# 41 "project/radare2/libr/util/signal.c" 3 4
             24 
# 41 "project/radare2/libr/util/signal.c"
                     },
 { "SIGXFSZ", 
# 42 "project/radare2/libr/util/signal.c" 3 4
             25 
# 42 "project/radare2/libr/util/signal.c"
                     },
 { "SIGVTALRM", 
# 43 "project/radare2/libr/util/signal.c" 3 4
               26 
# 43 "project/radare2/libr/util/signal.c"
                         },
 { "SIGPROF", 
# 44 "project/radare2/libr/util/signal.c" 3 4
             27 
# 44 "project/radare2/libr/util/signal.c"
                     },
 { "SIGSYS", 
# 45 "project/radare2/libr/util/signal.c" 3 4
            12 
# 45 "project/radare2/libr/util/signal.c"
                   },

 { 
# 47 "project/radare2/libr/util/signal.c" 3 4
  ((void *)0) 
# 47 "project/radare2/libr/util/signal.c"
       }
};


# 50 "project/radare2/libr/util/signal.c" 3 4
__attribute__((visibility("default"))) 
# 50 "project/radare2/libr/util/signal.c"
     int r_signal_from_string(const char *e) {
 int i;
...
# 61 "project/radare2/libr/util/signal.c" 3 4
__attribute__((visibility("default"))) 
# 61 "project/radare2/libr/util/signal.c"
     const char* r_signal_to_string(int code) {
 int i;
 for (i = 1; signals[i].name; i++) {
 ...
 return 
# 68 "project/radare2/libr/util/signal.c" 3 4
       ((void *)0)
# 68 "project/radare2/libr/util/signal.c"
           ;
}



# 72 "project/radare2/libr/util/signal.c" 3 4
__attribute__((visibility("default"))) 
# 72 "project/radare2/libr/util/signal.c"
     void r_signal_sigmask(int how, const sigset_t *newmask, sigset_t *oldmask) {
...
# 79 "project/radare2/libr/util/signal.c" 3 4
__attribute__((visibility("default"))) 
# 79 "project/radare2/libr/util/signal.c"
     const char *r_signal_to_human(int signum) {

 switch (signum) {
 case 
# 82 "project/radare2/libr/util/signal.c" 3 4
     14
# 82 "project/radare2/libr/util/signal.c"
            : return "Alarm Clock";
 case 
# 83 "project/radare2/libr/util/signal.c" 3 4
     10
# 83 "project/radare2/libr/util/signal.c"
           : return "Bus Error";
 case 
# 84 "project/radare2/libr/util/signal.c" 3 4
     20
# 84 "project/radare2/libr/util/signal.c"
            : return "Child";
 case 
# 85 "project/radare2/libr/util/signal.c" 3 4
     19
# 85 "project/radare2/libr/util/signal.c"
            : return "Continue Execution";

 case 
# 87 "project/radare2/libr/util/signal.c" 3 4
     7
# 87 "project/radare2/libr/util/signal.c"
           : return "Hardware Error";

 case 
# 89 "project/radare2/libr/util/signal.c" 3 4
     8
# 89 "project/radare2/libr/util/signal.c"
           : return "Floating Point Exception";
 case 
# 90 "project/radare2/libr/util/signal.c" 3 4
     1
# 90 "project/radare2/libr/util/signal.c"
           : return "Hangup";
 case 
# 91 "project/radare2/libr/util/signal.c" 3 4
     4
# 91 "project/radare2/libr/util/signal.c"
           : return "Illegal instruction";
 case 
# 92 "project/radare2/libr/util/signal.c" 3 4
     6
# 92 "project/radare2/libr/util/signal.c"
            : return "Abort";
 case 
# 93 "project/radare2/libr/util/signal.c" 3 4
     9
# 93 "project/radare2/libr/util/signal.c"
            : return "Killed";
 case 
# 94 "project/radare2/libr/util/signal.c" 3 4
     27
# 94 "project/radare2/libr/util/signal.c"
 ...
 case 
# 100 "project/radare2/libr/util/signal.c" 3 4
     3
# 100 "project/radare2/libr/util/signal.c"
            : return "Quit";
 case 
# 101 "project/radare2/libr/util/signal.c" 3 4
     11
# 101 "project/radare2/libr/util/signal.c"
            : return "Segmentation fault";
 case 
# 102 "project/radare2/libr/util/signal.c" 3 4
     17
# 102 "project/radare2/libr/util/signal.c"
            : return "Stopped";
 case 
# 103 "project/radare2/libr/util/signal.c" 3 4
     12
# 103 "project/radare2/libr/util/signal.c"
           : return "Bad system call";
 case 
# 104 "project/radare2/libr/util/signal.c" 3 4
     15
# 104 "project/radare2/libr/util/signal.c"
            : return "Terminated";
 case 
# 105 "project/radare2/libr/util/signal.c" 3 4
     18
# 105 "project/radare2/libr/util/signal.c"
            : return "Stopped";
 case 
# 106 "project/radare2/libr/util/signal.c" 3 4
     13
# 106 "project/radare2/libr/util/signal.c"
            : return "Broken pipe";
 case 
# 107 "project/radare2/libr/util/signal.c" 3 4
     21
# 107 "project/radare2/libr/util/signal.c"
            : return "Stopped";
 case 
# 108 "project/radare2/libr/util/signal.c" 3 4
     22
# 108 "project/radare2/libr/util/signal.c"
            : return "Stopped";
 case 
# 109 "project/radare2/libr/util/signal.c" 3 4
     16
# 109 "project/radare2/libr/util/signal.c"
           : return "Urgent";
 case 
# 110 "project/radare2/libr/util/signal.c" 3 4
     30
# 110 "project/radare2/libr/util/signal.c"
            : return "User Defined Signal 1";
 case 
# 111 "project/radare2/libr/util/signal.c" 3 4
     31
# 111 "project/radare2/libr/util/signal.c"
            : return "User Defined Signal 2";
 case 
# 112 "project/radare2/libr/util/signal.c" 3 4
     26
# 112 "project/radare2/libr/util/signal.c"
              : return "Virtual Timer Expired";
 case 
# 113 "project/radare2/libr/util/signal.c" 3 4
     28
# 113 "project/radare2/libr/util/signal.c"
             : return "Window Changed Size";
 case 
# 114 "project/radare2/libr/util/signal.c" 3 4
     24
# 114 "project/radare2/libr/util/signal.c"
            : return "CPU time limit exceeded";
 case 
# 115 "project/radare2/libr/util/signal.c" 3 4
     25
# 115 "project/radare2/libr/util/signal.c"
