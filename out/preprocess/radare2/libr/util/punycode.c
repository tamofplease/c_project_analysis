# 0 "project/radare2/libr/util/punycode.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/punycode.c"
...
typedef int RRef;
# 4 "project/radare2/libr/util/punycode.c" 2
...
# 5 "project/radare2/libr/util/punycode.c" 2
# 14 "project/radare2/libr/util/punycode.c"

# 14 "project/radare2/libr/util/punycode.c"
int utf32len (
# 14 "project/radare2/libr/util/punycode.c" 3 4
             unsigned int 
# 14 "project/radare2/libr/util/punycode.c"
                  *input) {
 int i = 0;
...
# 22 "project/radare2/libr/util/punycode.c" 3 4
unsigned char 
# 22 "project/radare2/libr/util/punycode.c"
   *utf32toutf8 (
# 22 "project/radare2/libr/util/punycode.c" 3 4
                 unsigned int 
# 22 "project/radare2/libr/util/punycode.c"
...
# 24 "project/radare2/libr/util/punycode.c" 3 4
 fprintf(__stderrp,
# 24 "project/radare2/libr/util/punycode.c"
 "ERROR input is null\n"
# 24 "project/radare2/libr/util/punycode.c" 3 4
 )
# 24 "project/radare2/libr/util/punycode.c"
                                  ;
  return 
# 25 "project/radare2/libr/util/punycode.c" 3 4
        ((void *)0)
# 25 "project/radare2/libr/util/punycode.c"
            ;
 }
...
# 31 "project/radare2/libr/util/punycode.c" 3 4
unsigned char 
# 31 "project/radare2/libr/util/punycode.c"
    *result = calloc (4, len + 1);
 if (!result) {
  
# 33 "project/radare2/libr/util/punycode.c" 3 4
 fprintf(__stderrp,
# 33 "project/radare2/libr/util/punycode.c"
 "ERROR: out of memory\n"
# 33 "project/radare2/libr/util/punycode.c" 3 4
 )
# 33 "project/radare2/libr/util/punycode.c"
                                   ;
  return 
# 34 "project/radare2/libr/util/punycode.c" 3 4
        ((void *)0)
# 34 "project/radare2/libr/util/punycode.c"
            ;
 }
...
# 57 "project/radare2/libr/util/punycode.c" 3 4
  fprintf(__stderrp,
# 57 "project/radare2/libr/util/punycode.c"
...
# 57 "project/radare2/libr/util/punycode.c"
   ...
   free (result);
   return 
# 59 "project/radare2/libr/util/punycode.c" 3 4
         ((void *)0)
# 59 "project/radare2/libr/util/punycode.c"
             ;
  }
 }
...
# 67 "project/radare2/libr/util/punycode.c" 3 4
unsigned int 
# 67 "project/radare2/libr/util/punycode.c"
    *utf8toutf32 (const 
# 67 "project/radare2/libr/util/punycode.c" 3 4
                        unsigned char 
# 67 "project/radare2/libr/util/punycode.c"
...
# 69 "project/radare2/libr/util/punycode.c" 3 4
 fprintf(__stderrp,
# 69 "project/radare2/libr/util/punycode.c"
 "ERROR input is null\n"
# 69 "project/radare2/libr/util/punycode.c" 3 4
 )
# 69 "project/radare2/libr/util/punycode.c"
                                  ;
  return 
# 70 "project/radare2/libr/util/punycode.c" 3 4
        ((void *)0)
# 70 "project/radare2/libr/util/punycode.c"
            ;
 }
...
# 77 "project/radare2/libr/util/punycode.c" 3 4
unsigned int 
# 77 "project/radare2/libr/util/punycode.c"
     *result = calloc (strlen ((const char *) input) + 1, 4);

 if (!result) {
  
# 80 "project/radare2/libr/util/punycode.c" 3 4
 fprintf(__stderrp,
# 80 "project/radare2/libr/util/punycode.c"
 "ERROR: out of memory\n"
# 80 "project/radare2/libr/util/punycode.c" 3 4
 )
# 80 "project/radare2/libr/util/punycode.c"
                                   ;
  return 
# 81 "project/radare2/libr/util/punycode.c" 3 4
        ((void *)0)
# 81 "project/radare2/libr/util/punycode.c"
            ;
 }
...
# 104 "project/radare2/libr/util/punycode.c" 3 4
  fprintf(__stderrp,
# 104 "project/radare2/libr/util/punycode.c"
...
# 104 "project/radare2/libr/util/punycode.c"
   ...
   free (result);
   return 
# 106 "project/radare2/libr/util/punycode.c" 3 4
         ((void *)0)
# 106 "project/radare2/libr/util/punycode.c"
             ;
  }
  result[j] = val;
  j++;
...
# 116 "project/radare2/libr/util/punycode.c" 3 4
unsigned int 
# 116 "project/radare2/libr/util/punycode.c"
    adapt_bias(
# 116 "project/radare2/libr/util/punycode.c" 3 4
               unsigned int 
# 116 "project/radare2/libr/util/punycode.c"
                    delta, unsigned n_points, int is_first) {
 
# 117 "project/radare2/libr/util/punycode.c" 3 4
unsigned int 
# 117 "project/radare2/libr/util/punycode.c"
     k = 0;
...
static 
# 139 "project/radare2/libr/util/punycode.c" 3 4
      unsigned int 
# 139 "project/radare2/libr/util/punycode.c"
           encode_var_int(const 
# 139 "project/radare2/libr/util/punycode.c" 3 4
                                unsigned int 
# 139 "project/radare2/libr/util/punycode.c"
                                     bias, const 
...
# 140 "project/radare2/libr/util/punycode.c" 3 4
unsigned int 
# 140 "project/radare2/libr/util/punycode.c"
     i, k, q, t;
 i = 0;
 k = 36;
 q = delta;
 ...
 while (
# 145 "project/radare2/libr/util/punycode.c" 3 4
       1
# 145 "project/radare2/libr/util/punycode.c"
           ) {
  if (k <= bias) {
   t = 1;
  } else if (k >= bias + 26) {
...
static 
# 169 "project/radare2/libr/util/punycode.c" 3 4
      unsigned int 
# 169 "project/radare2/libr/util/punycode.c"
           decode_digit(
# 169 "project/radare2/libr/util/punycode.c" 3 4
                        unsigned int 
# 169 "project/radare2/libr/util/punycode.c"
                             v) {
 if (
# 170 "project/radare2/libr/util/punycode.c" 3 4
    ((
# 170 "project/radare2/libr/util/punycode.c"
    v
# 170 "project/radare2/libr/util/punycode.c" 3 4
    ) >= '0' && (
# 170 "project/radare2/libr/util/punycode.c"
...
# 170 "project/radare2/libr/util/punycode.c"
 ...
 return 
# 179 "project/radare2/libr/util/punycode.c" 3 4
       0xFFFFFFFFU
# 179 "project/radare2/libr/util/punycode.c"
               ;
}


# 182 "project/radare2/libr/util/punycode.c" 3 4
__attribute__((visibility("default"))) 
# 182 "project/radare2/libr/util/punycode.c"
     char *r_punycode_encode(const 
# 182 "project/radare2/libr/util/punycode.c" 3 4
                                   unsigned char 
# 182 "project/radare2/libr/util/punycode.c"
                                       *src, int srclen, int *dstlen) {
 
# 183 "project/radare2/libr/util/punycode.c" 3 4
unsigned int 
# 183 "project/radare2/libr/util/punycode.c"
     m, n;
 
# 184 "project/radare2/libr/util/punycode.c" 3 4
unsigned int 
# 184 "project/radare2/libr/util/punycode.c"
     b, h;
 
# 185 "project/radare2/libr/util/punycode.c" 3 4
unsigned int 
# 185 "project/radare2/libr/util/punycode.c"
     si, di;
 
# 186 "project/radare2/libr/util/punycode.c" 3 4
unsigned int 
# 186 "project/radare2/libr/util/punycode.c"
     delta, bias;
 
# 187 "project/radare2/libr/util/punycode.c" 3 4
unsigned int 
# 187 "project/radare2/libr/util/punycode.c"
     *actualsrc = 
# 187 "project/radare2/libr/util/punycode.c" 3 4
                  ((void *)0)
# 187 "project/radare2/libr/util/punycode.c"
...
# 188 "project/radare2/libr/util/punycode.c" 3 4
unsigned int 
# 188 "project/radare2/libr/util/punycode.c"
     len = 0;
 char *dst = 
# 189 "project/radare2/libr/util/punycode.c" 3 4
            ((void *)0)
# 189 "project/radare2/libr/util/punycode.c"
                ;
 ...
 *dstlen = 0;
 ...
 if (!src || srclen < 1) {
  return 
# 194 "project/radare2/libr/util/punycode.c" 3 4
        ((void *)0)
# 194 "project/radare2/libr/util/punycode.c"
            ;
 }
 ...
 if (!actualsrc) {
  return 
# 199 "project/radare2/libr/util/punycode.c" 3 4
        ((void *)0)
# 199 "project/radare2/libr/util/punycode.c"
            ;
 }
 ...
 if (!dst) {
  free (actualsrc);
  return 
# 207 "project/radare2/libr/util/punycode.c" 3 4
        ((void *)0)
# 207 "project/radare2/libr/util/punycode.c"
            ;
 }
 ...
 for (delta = 0; h < len; n++, delta++) {
  for (m = 
# 226 "project/radare2/libr/util/punycode.c" 3 4
          0xFFFFFFFFU
# 226 "project/radare2/libr/util/punycode.c"
                  , si = 0; si < len; si++) {
  ...
  if ((m - n) > (
# 232 "project/radare2/libr/util/punycode.c" 3 4
                0xFFFFFFFFU 
# 232 "project/radare2/libr/util/punycode.c"
                         - delta) / (h + 1)) {
   free (actualsrc);
   free (dst);
   return 
# 235 "project/radare2/libr/util/punycode.c" 3 4
         ((void *)0)
# 235 "project/radare2/libr/util/punycode.c"
             ;
  }
  ...
  for (si = 0; si < len; si++) {
   if (actualsrc[si] < n) {
    if (++delta == 0) {
     ...
     free (dst);
     return 
# 246 "project/radare2/libr/util/punycode.c" 3 4
           ((void *)0)
# 246 "project/radare2/libr/util/punycode.c"
               ;
    }
...
# 261 "project/radare2/libr/util/punycode.c" 3 4
__attribute__((visibility("default"))) 
# 261 "project/radare2/libr/util/punycode.c"
     char *r_punycode_decode(const char *src, int srclen, int *dstlen) {
 const char *p;
 
# 263 "project/radare2/libr/util/punycode.c" 3 4
unsigned int 
# 263 "project/radare2/libr/util/punycode.c"
     si, di;
 
# 264 "project/radare2/libr/util/punycode.c" 3 4
unsigned int 
# 264 "project/radare2/libr/util/punycode.c"
     b, n, t, i, k, w;
 
# 265 "project/radare2/libr/util/punycode.c" 3 4
unsigned int 
# 265 "project/radare2/libr/util/punycode.c"
     digit, org_i, bias;
 
# 266 "project/radare2/libr/util/punycode.c" 3 4
unsigned int 
# 266 "project/radare2/libr/util/punycode.c"
     *dst = 
# 266 "project/radare2/libr/util/punycode.c" 3 4
            ((void *)0)
# 266 "project/radare2/libr/util/punycode.c"
...
# 267 "project/radare2/libr/util/punycode.c" 3 4
unsigned char 
# 267 "project/radare2/libr/util/punycode.c"
    *finaldst = 
# 267 "project/radare2/libr/util/punycode.c" 3 4
                ((void *)0)
# 267 "project/radare2/libr/util/punycode.c"
 ...
 *dstlen = 0;
 if (!src || srclen < 1) {
  return 
# 271 "project/radare2/libr/util/punycode.c" 3 4
        ((void *)0)
# 271 "project/radare2/libr/util/punycode.c"
            ;
 }
 ...
 if (!dst) {
  return 
# 276 "project/radare2/libr/util/punycode.c" 3 4
        ((void *)0)
# 276 "project/radare2/libr/util/punycode.c"
            ;
 }
 ...
 for (si = 0; si < srclen; si++) {
  if (src[si] & 0x80) {
   free (dst);
   return 
# 282 "project/radare2/libr/util/punycode.c" 3 4
         ((void *)0)
# 282 "project/radare2/libr/util/punycode.c"
             ;
  }
 }
 ...
 for (si = b + (b > 0); si < srclen; di++) {
  ...
  for (w = 1, k = 36;; k += 36) {
   ...
   if (digit == 
# 306 "project/radare2/libr/util/punycode.c" 3 4
               0xFFFFFFFFU
# 306 "project/radare2/libr/util/punycode.c"
                       ) {
    free (dst);
    return 
# 308 "project/radare2/libr/util/punycode.c" 3 4
          ((void *)0)
# 308 "project/radare2/libr/util/punycode.c"
              ;
   }

   if (digit > (
# 311 "project/radare2/libr/util/punycode.c" 3 4
               0xFFFFFFFFU 
# 311 "project/radare2/libr/util/punycode.c"
                        - i) / w) {
    free (dst);
    return 
# 313 "project/radare2/libr/util/punycode.c" 3 4
          ((void *)0)
# 313 "project/radare2/libr/util/punycode.c"
              ;
   }
   ...
   if (w > 
# 330 "project/radare2/libr/util/punycode.c" 3 4
          0xFFFFFFFFU 
# 330 "project/radare2/libr/util/punycode.c"
                   / (36 - t)) {
    free (dst);
    return 
# 332 "project/radare2/libr/util/punycode.c" 3 4
          ((void *)0)
# 332 "project/radare2/libr/util/punycode.c"
              ;
   }
  ...
  if (i / (di + 1) > 
# 340 "project/radare2/libr/util/punycode.c" 3 4
                    0xFFFFFFFFU 
# 340 "project/radare2/libr/util/punycode.c"
                             - n) {
   free (dst);
   return 
# 342 "project/radare2/libr/util/punycode.c" 3 4
         ((void *)0)
# 342 "project/radare2/libr/util/punycode.c"
             ;
  }
...
# 348 "project/radare2/libr/util/punycode.c" 3 4
 __builtin___memmove_chk (
# 348 "project/radare2/libr/util/punycode.c"
 dst + i + 1
# 348 "project/radare2/libr/util/punycode.c" 3 4
 , 
# 348 "project/radare2/libr/util/punycode.c"
...
# 357 "project/radare2/libr/util/punycode.c" 3 4
 fprintf(__stderrp,
# 357 "project/radare2/libr/util/punycode.c"
...
# 357 "project/radare2/libr/util/punycode.c"
                                      ;
  return 
# 358 "project/radare2/libr/util/punycode.c" 3 4
        ((void *)0)
# 358 "project/radare2/libr/util/punycode.c"
            ;
 }
