# 0 "project/radare2/libr/util/buf_bytes.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/buf_bytes.c"
...
# 4 "project/radare2/libr/util/buf_bytes.c" 2


# 5 "project/radare2/libr/util/buf_bytes.c"
struct buf_bytes_user {
 const 
# 6 "project/radare2/libr/util/buf_bytes.c" 3 4
      unsigned char 
# 6 "project/radare2/libr/util/buf_bytes.c"
          *data;
 const 
# 7 "project/radare2/libr/util/buf_bytes.c" 3 4
      unsigned char 
# 7 "project/radare2/libr/util/buf_bytes.c"
          *data_steal;
 
# 8 "project/radare2/libr/util/buf_bytes.c" 3 4
unsigned long long 
# 8 "project/radare2/libr/util/buf_bytes.c"
     length;
 
# 9 "project/radare2/libr/util/buf_bytes.c" 3 4
_Bool 
# 9 "project/radare2/libr/util/buf_bytes.c"
     steal;
};

struct buf_bytes_priv {
 
# 13 "project/radare2/libr/util/buf_bytes.c" 3 4
unsigned char 
# 13 "project/radare2/libr/util/buf_bytes.c"
    *buf;
 
# 14 "project/radare2/libr/util/buf_bytes.c" 3 4
unsigned long long 
# 14 "project/radare2/libr/util/buf_bytes.c"
     length;
 
# 15 "project/radare2/libr/util/buf_bytes.c" 3 4
unsigned long long 
# 15 "project/radare2/libr/util/buf_bytes.c"
     offset;
 
# 16 "project/radare2/libr/util/buf_bytes.c" 3 4
_Bool 
# 16 "project/radare2/libr/util/buf_bytes.c"
     is_bufowner;
};
...
# 21 "project/radare2/libr/util/buf_bytes.c" 3 4
do { if (!(
# 21 "project/radare2/libr/util/buf_bytes.c"
priv
# 21 "project/radare2/libr/util/buf_bytes.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "WARNING (%s:%d):%s%s runtime check failed: (%s)\n", "project/radare2/libr/util/buf_bytes.c", 21, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : "", 
# 21 "project/radare2/libr/util/buf_bytes.c"
"priv"
# 21 "project/radare2/libr/util/buf_bytes.c" 3 4
); } } while (0)
...
static 
# 25 "project/radare2/libr/util/buf_bytes.c" 3 4
      _Bool 
# 25 "project/radare2/libr/util/buf_bytes.c"
           buf_bytes_init(RBuffer *b, const void *user) {
 const struct buf_bytes_user *u = (const struct buf_bytes_user *)user;
 struct buf_bytes_priv *priv = 
# 27 "project/radare2/libr/util/buf_bytes.c" 3 4
                              (
# 27 "project/radare2/libr/util/buf_bytes.c"
                              struct buf_bytes_priv
# 27 "project/radare2/libr/util/buf_bytes.c" 3 4
                              *)calloc(1,sizeof(
# 27 "project/radare2/libr/util/buf_bytes.c"
...
# 27 "project/radare2/libr/util/buf_bytes.c"
 ...
 if (!priv) {
  return 
# 29 "project/radare2/libr/util/buf_bytes.c" 3 4
        0
# 29 "project/radare2/libr/util/buf_bytes.c"
             ;
 }
 ...
 if (u->data_steal) {
  priv->buf = (
# 35 "project/radare2/libr/util/buf_bytes.c" 3 4
              unsigned char 
# 35 "project/radare2/libr/util/buf_bytes.c"
                  *)u->data_steal;
  ...
  if (!priv->buf) {
   free (priv);
   return 
# 41 "project/radare2/libr/util/buf_bytes.c" 3 4
         0
# 41 "project/radare2/libr/util/buf_bytes.c"
              ;
  }
  if (priv->length) {
   
# 44 "project/radare2/libr/util/buf_bytes.c" 3 4
  __builtin___memmove_chk (
# 44 "project/radare2/libr/util/buf_bytes.c"
  priv->buf
# 44 "project/radare2/libr/util/buf_bytes.c" 3 4
  , 
# 44 "project/radare2/libr/util/buf_bytes.c"
...
# 44 "project/radare2/libr/util/buf_bytes.c"
  ...
  priv->is_bufowner = 
# 46 "project/radare2/libr/util/buf_bytes.c" 3 4
                     1
# 46 "project/radare2/libr/util/buf_bytes.c"
                         ;
 }
 b->priv = priv;
 return 
# 49 "project/radare2/libr/util/buf_bytes.c" 3 4
       1
# 49 "project/radare2/libr/util/buf_bytes.c"
           ;
}

static 
# 52 "project/radare2/libr/util/buf_bytes.c" 3 4
      _Bool 
# 52 "project/radare2/libr/util/buf_bytes.c"
           buf_bytes_fini(RBuffer *b) {
 struct buf_bytes_priv *priv = get_priv_bytes (b);
 if (priv->is_bufowner) {
  free (priv->buf);
 }
 
# 57 "project/radare2/libr/util/buf_bytes.c" 3 4
{ free((void *)
# 57 "project/radare2/libr/util/buf_bytes.c"
b->priv
# 57 "project/radare2/libr/util/buf_bytes.c" 3 4
); 
# 57 "project/radare2/libr/util/buf_bytes.c"
...
# 57 "project/radare2/libr/util/buf_bytes.c"
                ;
 return 
# 58 "project/radare2/libr/util/buf_bytes.c" 3 4
       1
# 58 "project/radare2/libr/util/buf_bytes.c"
           ;
}

static 
# 61 "project/radare2/libr/util/buf_bytes.c" 3 4
      _Bool 
# 61 "project/radare2/libr/util/buf_bytes.c"
           buf_bytes_resize(RBuffer *b, 
# 61 "project/radare2/libr/util/buf_bytes.c" 3 4
                                        unsigned long long 
# 61 "project/radare2/libr/util/buf_bytes.c"
                                             newsize) {
...
# 64 "project/radare2/libr/util/buf_bytes.c" 3 4
 unsigned char 
# 64 "project/radare2/libr/util/buf_bytes.c"
     *t = realloc (priv->buf, newsize);
  if (!t) {
   return 
# 66 "project/radare2/libr/util/buf_bytes.c" 3 4
         0
# 66 "project/radare2/libr/util/buf_bytes.c"
              ;
  }
  priv->buf = t;
  
# 69 "project/radare2/libr/util/buf_bytes.c" 3 4
 __builtin___memset_chk (
# 69 "project/radare2/libr/util/buf_bytes.c"
 priv->buf + priv->length
# 69 "project/radare2/libr/util/buf_bytes.c" 3 4
 , 
# 69 "project/radare2/libr/util/buf_bytes.c"
 b->Oxff_priv, newsize - priv->length
# 69 "project/radare2/libr/util/buf_bytes.c" 3 4
 , __builtin_object_size (
# 69 "project/radare2/libr/util/buf_bytes.c"
 priv->buf + priv->length
...
# 69 "project/radare2/libr/util/buf_bytes.c"
 ...
 priv->length = newsize;
 return 
# 72 "project/radare2/libr/util/buf_bytes.c" 3 4
       1
# 72 "project/radare2/libr/util/buf_bytes.c"
           ;
}

static 
# 75 "project/radare2/libr/util/buf_bytes.c" 3 4
      long long 
# 75 "project/radare2/libr/util/buf_bytes.c"
           buf_bytes_read(RBuffer *b, 
# 75 "project/radare2/libr/util/buf_bytes.c" 3 4
                                      unsigned char 
# 75 "project/radare2/libr/util/buf_bytes.c"
                                          *buf, 
...
# 77 "project/radare2/libr/util/buf_bytes.c" 3 4
unsigned long long 
# 77 "project/radare2/libr/util/buf_bytes.c"
     real_len = priv->length < priv->offset? 0: 
# 77 "project/radare2/libr/util/buf_bytes.c" 3 4
                                                (((
# 77 "project/radare2/libr/util/buf_bytes.c"
...
# 78 "project/radare2/libr/util/buf_bytes.c" 3 4
__builtin___memmove_chk (
# 78 "project/radare2/libr/util/buf_bytes.c"
buf
# 78 "project/radare2/libr/util/buf_bytes.c" 3 4
, 
# 78 "project/radare2/libr/util/buf_bytes.c"
priv->buf + priv->offset, real_len
# 78 "project/radare2/libr/util/buf_bytes.c" 3 4
, __builtin_object_size (
# 78 "project/radare2/libr/util/buf_bytes.c"
buf
...
static 
# 83 "project/radare2/libr/util/buf_bytes.c" 3 4
      long long 
# 83 "project/radare2/libr/util/buf_bytes.c"
           buf_bytes_write(RBuffer *b, const 
# 83 "project/radare2/libr/util/buf_bytes.c" 3 4
                                             unsigned char 
# 83 "project/radare2/libr/util/buf_bytes.c"
                                                 *buf, 
...
# 86 "project/radare2/libr/util/buf_bytes.c" 3 4
 _Bool 
# 86 "project/radare2/libr/util/buf_bytes.c"
      r = r_buf_resize (b, priv->offset + len);
  if (!r) {
   return -1;
  }
 }
 
# 91 "project/radare2/libr/util/buf_bytes.c" 3 4
__builtin___memmove_chk (
# 91 "project/radare2/libr/util/buf_bytes.c"
priv->buf + priv->offset
# 91 "project/radare2/libr/util/buf_bytes.c" 3 4
, 
# 91 "project/radare2/libr/util/buf_bytes.c"
buf, len
...
static 
# 96 "project/radare2/libr/util/buf_bytes.c" 3 4
      unsigned long long 
# 96 "project/radare2/libr/util/buf_bytes.c"
           buf_bytes_get_size(RBuffer *b) {
 struct buf_bytes_priv *priv = get_priv_bytes (b);
 return priv->length;
}

static 
# 101 "project/radare2/libr/util/buf_bytes.c" 3 4
      long long 
# 101 "project/radare2/libr/util/buf_bytes.c"
           buf_bytes_seek(RBuffer *b, 
# 101 "project/radare2/libr/util/buf_bytes.c" 3 4
                                      long long 
# 101 "project/radare2/libr/util/buf_bytes.c"
                                           addr, int whence) {
 struct buf_bytes_priv *priv = get_priv_bytes (b);
 if (addr < 0 && (-addr) > (
# 103 "project/radare2/libr/util/buf_bytes.c" 3 4
                           long long
# 103 "project/radare2/libr/util/buf_bytes.c"
                               )priv->offset) {
  return -1;
 }
 ...
 switch (whence) {
 case 
# 108 "project/radare2/libr/util/buf_bytes.c" 3 4
     1
# 108 "project/radare2/libr/util/buf_bytes.c"
              :
  priv->offset += addr;
  break;
 case 
# 111 "project/radare2/libr/util/buf_bytes.c" 3 4
     0
# 111 "project/radare2/libr/util/buf_bytes.c"
              :
  priv->offset = addr;
  break;
 case 
# 114 "project/radare2/libr/util/buf_bytes.c" 3 4
     2
# 114 "project/radare2/libr/util/buf_bytes.c"
              :
  priv->offset = priv->length + addr;
  break;
 default:
  
# 118 "project/radare2/libr/util/buf_bytes.c" 3 4
 do { r_assert_log (R_LOGLVL_WARN, "(%s:%d):%s%s code should not be reached\n", "project/radare2/libr/util/buf_bytes.c", 118, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : ""); } while (0)
# 118 "project/radare2/libr/util/buf_bytes.c"
                     ;
  return -1;
 }
 return priv->offset;
...
static 
# 124 "project/radare2/libr/util/buf_bytes.c" 3 4
      unsigned char 
# 124 "project/radare2/libr/util/buf_bytes.c"
          *buf_bytes_get_whole_buf(RBuffer *b, 
# 124 "project/radare2/libr/util/buf_bytes.c" 3 4
                                               unsigned long long 
# 124 "project/radare2/libr/util/buf_bytes.c"
                                                    *sz) {
