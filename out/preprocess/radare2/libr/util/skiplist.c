# 0 "project/radare2/libr/util/skiplist.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/skiplist.c"
# 10 "project/radare2/libr/util/skiplist.c"
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_skiplist.h" 1 3 4
# 13 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_skiplist.h" 3 4
...
# 14 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_skiplist.h" 2 3 4
...
# 11 "project/radare2/libr/util/skiplist.c" 2




# 14 "project/radare2/libr/util/skiplist.c"
static RSkipListNode *r_skiplist_node_new(void *data, int level) {
 RSkipListNode *res = 
# 15 "project/radare2/libr/util/skiplist.c" 3 4
                     (
# 15 "project/radare2/libr/util/skiplist.c"
                     RSkipListNode
# 15 "project/radare2/libr/util/skiplist.c" 3 4
                     *)calloc(1,sizeof(
# 15 "project/radare2/libr/util/skiplist.c"
...
# 15 "project/radare2/libr/util/skiplist.c"
 ...
 if (!res) {
  return 
# 17 "project/radare2/libr/util/skiplist.c" 3 4
        ((void *)0)
# 17 "project/radare2/libr/util/skiplist.c"
            ;
 }
 res->forward = 
# 19 "project/radare2/libr/util/skiplist.c" 3 4
               (
# 19 "project/radare2/libr/util/skiplist.c"
               RSkipListNode *
# 19 "project/radare2/libr/util/skiplist.c" 3 4
               *)calloc(
# 19 "project/radare2/libr/util/skiplist.c"
...
# 19 "project/radare2/libr/util/skiplist.c"
 ...
 if (!res->forward) {
  free (res);
  return 
# 22 "project/radare2/libr/util/skiplist.c" 3 4
        ((void *)0)
# 22 "project/radare2/libr/util/skiplist.c"
            ;
 }
 res->data = data;
 return res;
...
static RSkipListNode *find_insertpoint(RSkipList *list, void *data, RSkipListNode **updates, 
# 51 "project/radare2/libr/util/skiplist.c" 3 4
                                                                                            _Bool 
# 51 "project/radare2/libr/util/skiplist.c"
                                                                                                 by_data) {
...
static 
# 74 "project/radare2/libr/util/skiplist.c" 3 4
      _Bool 
# 74 "project/radare2/libr/util/skiplist.c"
           delete_element(RSkipList* list, void* data, 
# 74 "project/radare2/libr/util/skiplist.c" 3 4
                                                       _Bool 
# 74 "project/radare2/libr/util/skiplist.c"
                                                            by_data) {
 int i;
 RSkipListNode *update[31 + 1], *x;
 ...
 if (x == list->head || list->compare(x->data, data) != 0) {
  return 
# 82 "project/radare2/libr/util/skiplist.c" 3 4
        0
# 82 "project/radare2/libr/util/skiplist.c"
             ;
 }
 ...
 list->size--;
 return 
# 101 "project/radare2/libr/util/skiplist.c" 3 4
       1
# 101 "project/radare2/libr/util/skiplist.c"
           ;
}
...
# 108 "project/radare2/libr/util/skiplist.c" 3 4
__attribute__((visibility("default"))) 
# 108 "project/radare2/libr/util/skiplist.c"
     RSkipList* r_skiplist_new(RListFree freefn, RListComparator comparefn) {
 RSkipList *list = 
# 109 "project/radare2/libr/util/skiplist.c" 3 4
                  (
# 109 "project/radare2/libr/util/skiplist.c"
                  RSkipList
# 109 "project/radare2/libr/util/skiplist.c" 3 4
                  *)calloc(1,sizeof(
# 109 "project/radare2/libr/util/skiplist.c"
...
# 109 "project/radare2/libr/util/skiplist.c"
 ...
 if (!list) {
  return 
# 111 "project/radare2/libr/util/skiplist.c" 3 4
        ((void *)0)
# 111 "project/radare2/libr/util/skiplist.c"
            ;
 }

 list->head = r_skiplist_node_new (
# 114 "project/radare2/libr/util/skiplist.c" 3 4
                                  ((void *)0)
# 114 "project/radare2/libr/util/skiplist.c"
                                      , 31);
 if (!list->head) {
  free (list);
  return 
# 117 "project/radare2/libr/util/skiplist.c" 3 4
        ((void *)0)
# 117 "project/radare2/libr/util/skiplist.c"
            ;
 }
...
# 129 "project/radare2/libr/util/skiplist.c" 3 4
__attribute__((visibility("default"))) 
# 129 "project/radare2/libr/util/skiplist.c"
     void r_skiplist_purge(RSkipList *list) {
 RSkipListNode *n;
 if (!list) {
  return;
 }
...
# 146 "project/radare2/libr/util/skiplist.c" 3 4
__attribute__((visibility("default"))) 
# 146 "project/radare2/libr/util/skiplist.c"
     void r_skiplist_free(RSkipList *list) {
 if (!list) {
  return;
 }
...
# 157 "project/radare2/libr/util/skiplist.c" 3 4
__attribute__((visibility("default"))) 
# 157 "project/radare2/libr/util/skiplist.c"
     RSkipListNode* r_skiplist_insert(RSkipList* list, void* data) {
 RSkipListNode *update[31 + 1];
 RSkipListNode *x;
 int i, x_level, new_level;


 x = find_insertpoint (list, data, update, 
# 163 "project/radare2/libr/util/skiplist.c" 3 4
                                          1
# 163 "project/radare2/libr/util/skiplist.c"
                                              );
 ...
 for (x_level = 0; rand () < 
# 170 "project/radare2/libr/util/skiplist.c" 3 4
                            0x7fffffff 
# 170 "project/radare2/libr/util/skiplist.c"
                                     / 2 && x_level < 31; x_level++) {
  ;
 }
 ...
 if (!x) {
  return 
# 186 "project/radare2/libr/util/skiplist.c" 3 4
        ((void *)0)
# 186 "project/radare2/libr/util/skiplist.c"
            ;
 }
...
# 201 "project/radare2/libr/util/skiplist.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 201 "project/radare2/libr/util/skiplist.c"
          r_skiplist_insert_autofree(RSkipList* list, void* data) {
 ...
 if (node && data != node->data) {
  ...
  return 
# 207 "project/radare2/libr/util/skiplist.c" 3 4
        0
# 207 "project/radare2/libr/util/skiplist.c"
             ;
 }
 return 
# 209 "project/radare2/libr/util/skiplist.c" 3 4
       1
# 209 "project/radare2/libr/util/skiplist.c"
           ;
}



# 213 "project/radare2/libr/util/skiplist.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 213 "project/radare2/libr/util/skiplist.c"
          r_skiplist_delete(RSkipList* list, void* data) {
 return delete_element (list, data, 
# 214 "project/radare2/libr/util/skiplist.c" 3 4
                                   1
# 214 "project/radare2/libr/util/skiplist.c"
                                       );
}



# 218 "project/radare2/libr/util/skiplist.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 218 "project/radare2/libr/util/skiplist.c"
          r_skiplist_delete_node(RSkipList *list, RSkipListNode *node) {
 return delete_element (list, node, 
# 219 "project/radare2/libr/util/skiplist.c" 3 4
                                   0
# 219 "project/radare2/libr/util/skiplist.c"
                                        );
}


# 222 "project/radare2/libr/util/skiplist.c" 3 4
__attribute__((visibility("default"))) 
# 222 "project/radare2/libr/util/skiplist.c"
     RSkipListNode* r_skiplist_find(RSkipList* list, void* data) {
 RSkipListNode* x = find_insertpoint (list, data, 
# 223 "project/radare2/libr/util/skiplist.c" 3 4
                                                 ((void *)0)
# 223 "project/radare2/libr/util/skiplist.c"
                                                     , 
# 223 "project/radare2/libr/util/skiplist.c" 3 4
                                                       1
# 223 "project/radare2/libr/util/skiplist.c"
 ...
 return 
# 227 "project/radare2/libr/util/skiplist.c" 3 4
       ((void *)0)
# 227 "project/radare2/libr/util/skiplist.c"
           ;
}


# 230 "project/radare2/libr/util/skiplist.c" 3 4
__attribute__((visibility("default"))) 
# 230 "project/radare2/libr/util/skiplist.c"
     RSkipListNode* r_skiplist_find_geq(RSkipList* list, void* data) {
 RSkipListNode* x = find_insertpoint (list, data, 
# 231 "project/radare2/libr/util/skiplist.c" 3 4
                                                 ((void *)0)
# 231 "project/radare2/libr/util/skiplist.c"
                                                     , 
# 231 "project/radare2/libr/util/skiplist.c" 3 4
                                                       1
# 231 "project/radare2/libr/util/skiplist.c"
...
# 232 "project/radare2/libr/util/skiplist.c" 3 4
                             ((void *)0)
# 232 "project/radare2/libr/util/skiplist.c"
                                 ;
}


# 235 "project/radare2/libr/util/skiplist.c" 3 4
__attribute__((visibility("default"))) 
# 235 "project/radare2/libr/util/skiplist.c"
     RSkipListNode* r_skiplist_find_leq(RSkipList* list, void* data) {
 RSkipListNode *x = list->head;
 int i;
 ...
 return x != list->head ? x : 
# 245 "project/radare2/libr/util/skiplist.c" 3 4
                             ((void *)0)
# 245 "project/radare2/libr/util/skiplist.c"
                                 ;
}



# 249 "project/radare2/libr/util/skiplist.c" 3 4
__attribute__((visibility("default"))) 
# 249 "project/radare2/libr/util/skiplist.c"
     void r_skiplist_join(RSkipList *l1, RSkipList *l2) {
 RSkipListNode *it;
 void *data;

 
# 253 "project/radare2/libr/util/skiplist.c" 3 4
if (
# 253 "project/radare2/libr/util/skiplist.c"
l2
# 253 "project/radare2/libr/util/skiplist.c" 3 4
) for (
# 253 "project/radare2/libr/util/skiplist.c"
...
# 261 "project/radare2/libr/util/skiplist.c" 3 4
__attribute__((visibility("default"))) 
# 261 "project/radare2/libr/util/skiplist.c"
     void *r_skiplist_get_first(RSkipList *list) {
 if (!list) {
  return 
# 263 "project/radare2/libr/util/skiplist.c" 3 4
        ((void *)0)
# 263 "project/radare2/libr/util/skiplist.c"
            ;
 }
 RSkipListNode *res = list->head->forward[0];
 return res == list->head ? 
# 266 "project/radare2/libr/util/skiplist.c" 3 4
                           ((void *)0) 
# 266 "project/radare2/libr/util/skiplist.c"
                                : res->data;
}



# 270 "project/radare2/libr/util/skiplist.c" 3 4
__attribute__((visibility("default"))) 
# 270 "project/radare2/libr/util/skiplist.c"
     void *r_skiplist_get_n(RSkipList *list, int n) {
 int count = 0;
 RSkipListNode *node;
 void *data;
 if (!list || n < 0) {
  return 
# 275 "project/radare2/libr/util/skiplist.c" 3 4
        ((void *)0)
# 275 "project/radare2/libr/util/skiplist.c"
            ;
 }
 
# 277 "project/radare2/libr/util/skiplist.c" 3 4
if (
# 277 "project/radare2/libr/util/skiplist.c"
list
# 277 "project/radare2/libr/util/skiplist.c" 3 4
) for (
# 277 "project/radare2/libr/util/skiplist.c"
...
# 277 "project/radare2/libr/util/skiplist.c"
 ...
 return 
# 283 "project/radare2/libr/util/skiplist.c" 3 4
       ((void *)0)
# 283 "project/radare2/libr/util/skiplist.c"
           ;
}



# 287 "project/radare2/libr/util/skiplist.c" 3 4
__attribute__((visibility("default"))) 
# 287 "project/radare2/libr/util/skiplist.c"
     void* r_skiplist_get_geq(RSkipList* list, void* data) {
 RSkipListNode *x = r_skiplist_find_geq (list, data);
 return x ? x->data : 
# 289 "project/radare2/libr/util/skiplist.c" 3 4
                     ((void *)0)
# 289 "project/radare2/libr/util/skiplist.c"
                         ;
}


# 292 "project/radare2/libr/util/skiplist.c" 3 4
__attribute__((visibility("default"))) 
# 292 "project/radare2/libr/util/skiplist.c"
     void* r_skiplist_get_leq(RSkipList* list, void* data) {
 RSkipListNode *x = r_skiplist_find_leq (list, data);
 return x ? x->data : 
# 294 "project/radare2/libr/util/skiplist.c" 3 4
                     ((void *)0)
# 294 "project/radare2/libr/util/skiplist.c"
                         ;
}



# 298 "project/radare2/libr/util/skiplist.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 298 "project/radare2/libr/util/skiplist.c"
          r_skiplist_empty(RSkipList *list) {
 return list->size == 0;
}
...
# 306 "project/radare2/libr/util/skiplist.c" 3 4
__attribute__((visibility("default"))) 
# 306 "project/radare2/libr/util/skiplist.c"
     RList *r_skiplist_to_list(RSkipList *list) {
 RList *res = r_list_new ();
 RSkipListNode *n;
 void *data;

 
# 311 "project/radare2/libr/util/skiplist.c" 3 4
if (
# 311 "project/radare2/libr/util/skiplist.c"
list
# 311 "project/radare2/libr/util/skiplist.c" 3 4
) for (
# 311 "project/radare2/libr/util/skiplist.c"
