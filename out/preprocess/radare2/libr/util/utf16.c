# 0 "project/radare2/libr/util/utf16.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/utf16.c"
...
typedef int RRef;
# 4 "project/radare2/libr/util/utf16.c" 2
...
# 5 "project/radare2/libr/util/utf16.c" 2


__attribute__((visibility("default"))) 
# 7 "project/radare2/libr/util/utf16.c"
     int r_utf16_decode(const 
# 7 "project/radare2/libr/util/utf16.c" 3 4
                              unsigned char 
# 7 "project/radare2/libr/util/utf16.c"
...
# 7 "project/radare2/libr/util/utf16.c"
 ...
 if (ptrlen > 1) {
  if (ch) {
   *ch = (
# 28 "project/radare2/libr/util/utf16.c" 3 4
         unsigned int
# 28 "project/radare2/libr/util/utf16.c"
             )ptr[low];
  }
  return 1;
 }
...
# 36 "project/radare2/libr/util/utf16.c" 3 4
__attribute__((visibility("default"))) 
# 36 "project/radare2/libr/util/utf16.c"
     int r_utf16le_decode(const 
# 36 "project/radare2/libr/util/utf16.c" 3 4
                                unsigned char 
# 36 "project/radare2/libr/util/utf16.c"
                                    *ptr, int ptrlen, RRune *ch) {
 return r_utf16_decode (ptr, ptrlen, ch, 
# 37 "project/radare2/libr/util/utf16.c" 3 4
                                        0
# 37 "project/radare2/libr/util/utf16.c"
                                             );
}



# 41 "project/radare2/libr/util/utf16.c" 3 4
__attribute__((visibility("default"))) 
# 41 "project/radare2/libr/util/utf16.c"
     int r_utf16be_decode(const 
# 41 "project/radare2/libr/util/utf16.c" 3 4
                                unsigned char 
# 41 "project/radare2/libr/util/utf16.c"
                                    *ptr, int ptrlen, RRune *ch) {
 return r_utf16_decode (ptr, ptrlen, ch, 
# 42 "project/radare2/libr/util/utf16.c" 3 4
                                        1
# 42 "project/radare2/libr/util/utf16.c"
                                            );
}



# 46 "project/radare2/libr/util/utf16.c" 3 4
__attribute__((visibility("default"))) 
# 46 "project/radare2/libr/util/utf16.c"
     int r_utf16le_encode(
# 46 "project/radare2/libr/util/utf16.c" 3 4
                          unsigned char 
# 46 "project/radare2/libr/util/utf16.c"
                              *ptr, RRune ch) {
