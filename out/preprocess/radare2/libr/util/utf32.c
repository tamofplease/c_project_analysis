# 0 "project/radare2/libr/util/utf32.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/utf32.c"
...
typedef int RRef;
# 4 "project/radare2/libr/util/utf32.c" 2
...
# 5 "project/radare2/libr/util/utf32.c" 2


__attribute__((visibility("default"))) 
# 7 "project/radare2/libr/util/utf32.c"
     int r_utf32_decode(const 
# 7 "project/radare2/libr/util/utf32.c" 3 4
                              unsigned char 
# 7 "project/radare2/libr/util/utf32.c"
...
# 7 "project/radare2/libr/util/utf32.c"
 ...
 if (ptrlen > 3) {
  ...
  if (ch) {
   int i;
   *ch = (
# 21 "project/radare2/libr/util/utf32.c" 3 4
         unsigned int
# 21 "project/radare2/libr/util/utf32.c"
             )ptr[low];
   for (i = 1; i < 4; i++) {
    *ch |= (
# 23 "project/radare2/libr/util/utf32.c" 3 4
           unsigned int
# 23 "project/radare2/libr/util/utf32.c"
               )ptr[3 - high + i * sign] << 8 * i;
   }
  }
...
# 38 "project/radare2/libr/util/utf32.c" 3 4
__attribute__((visibility("default"))) 
# 38 "project/radare2/libr/util/utf32.c"
     int r_utf32le_decode(const 
# 38 "project/radare2/libr/util/utf32.c" 3 4
                                unsigned char 
# 38 "project/radare2/libr/util/utf32.c"
                                    *ptr, int ptrlen, RRune *ch) {
 return r_utf32_decode (ptr, ptrlen, ch, 
# 39 "project/radare2/libr/util/utf32.c" 3 4
                                        0
# 39 "project/radare2/libr/util/utf32.c"
                                             );
}



# 43 "project/radare2/libr/util/utf32.c" 3 4
__attribute__((visibility("default"))) 
# 43 "project/radare2/libr/util/utf32.c"
     int r_utf32be_decode(const 
# 43 "project/radare2/libr/util/utf32.c" 3 4
                                unsigned char 
# 43 "project/radare2/libr/util/utf32.c"
                                    *ptr, int ptrlen, RRune *ch) {
 return r_utf32_decode (ptr, ptrlen, ch, 
# 44 "project/radare2/libr/util/utf32.c" 3 4
                                        1
# 44 "project/radare2/libr/util/utf32.c"
                                            );
}
