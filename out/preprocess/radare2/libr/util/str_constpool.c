# 0 "project/radare2/libr/util/str_constpool.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/str_constpool.c"
...
typedef int RRef;
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_str_constpool.h" 2 3 4
...
# 6 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/sdb/src/ls.h" 2 3 4
...
# 4 "project/radare2/libr/util/str_constpool.c" 2


# 5 "project/radare2/libr/util/str_constpool.c"
static void kv_fini(HtPPKv *kv) {
 free (kv->key);
}


# 9 "project/radare2/libr/util/str_constpool.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 9 "project/radare2/libr/util/str_constpool.c"
          r_str_constpool_init(RStrConstPool *pool) {
 pool->ht = ht_pp_new (
# 10 "project/radare2/libr/util/str_constpool.c" 3 4
                      ((void *)0)
# 10 "project/radare2/libr/util/str_constpool.c"
                          , kv_fini, 
# 10 "project/radare2/libr/util/str_constpool.c" 3 4
                                     ((void *)0)
# 10 "project/radare2/libr/util/str_constpool.c"
 ...
 return pool->ht != 
# 11 "project/radare2/libr/util/str_constpool.c" 3 4
                   ((void *)0)
# 11 "project/radare2/libr/util/str_constpool.c"
                       ;
}


# 14 "project/radare2/libr/util/str_constpool.c" 3 4
__attribute__((visibility("default"))) 
# 14 "project/radare2/libr/util/str_constpool.c"
     void r_str_constpool_fini(RStrConstPool *pool) {
 ht_pp_free (pool->ht);
}


# 18 "project/radare2/libr/util/str_constpool.c" 3 4
__attribute__((visibility("default"))) 
# 18 "project/radare2/libr/util/str_constpool.c"
     const char *r_str_constpool_get(RStrConstPool *pool, const char *str) {
 if (!str) {
  return 
# 20 "project/radare2/libr/util/str_constpool.c" 3 4
        ((void *)0)
# 20 "project/radare2/libr/util/str_constpool.c"
            ;
 }
 HtPPKv *kv = ht_pp_find_kv (pool->ht, str, 
# 22 "project/radare2/libr/util/str_constpool.c" 3 4
                                           ((void *)0)
# 22 "project/radare2/libr/util/str_constpool.c"
                                               );
 if (kv) {
  return kv->key;
 }
 ht_pp_insert (pool->ht, str, 
# 26 "project/radare2/libr/util/str_constpool.c" 3 4
                             ((void *)0)
# 26 "project/radare2/libr/util/str_constpool.c"
                                 );
 kv = ht_pp_find_kv (pool->ht, str, 
# 27 "project/radare2/libr/util/str_constpool.c" 3 4
                                   ((void *)0)
# 27 "project/radare2/libr/util/str_constpool.c"
                                       );
 if (kv) {
  return kv->key;
 }
 return 
# 31 "project/radare2/libr/util/str_constpool.c" 3 4
       ((void *)0)
# 31 "project/radare2/libr/util/str_constpool.c"
           ;
}
