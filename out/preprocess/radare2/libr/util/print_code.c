# 0 "project/radare2/libr/util/print_code.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/print_code.c"
...
# 4 "project/radare2/libr/util/print_code.c" 2
...
# 5 "project/radare2/libr/util/print_code.c" 2


# 6 "project/radare2/libr/util/print_code.c"
static const char* bits_to_c_code_fmtstr(int bits) {
 switch (bits) {
 case 16:
  return "0x%04" 
# 9 "project/radare2/libr/util/print_code.c" 3 4
                "llx"
# 9 "project/radare2/libr/util/print_code.c"
                       ;
 case 32:
  return "0x%08" 
# 11 "project/radare2/libr/util/print_code.c" 3 4
                "llx" 
# 11 "project/radare2/libr/util/print_code.c"
                        "U";
 case 64:
  return "0x%016" 
# 13 "project/radare2/libr/util/print_code.c" 3 4
                 "llx" 
# 13 "project/radare2/libr/util/print_code.c"
                         "ULL";
 }
 return "0x%02" 
# 15 "project/radare2/libr/util/print_code.c" 3 4
               "llx"
# 15 "project/radare2/libr/util/print_code.c"
                      ;
}

static int get_instruction_size(RPrint *p, 
# 18 "project/radare2/libr/util/print_code.c" 3 4
                                          unsigned long long 
# 18 "project/radare2/libr/util/print_code.c"
                                               at) {
 char *is = p->coreb.cmdstrf (p->coreb.core, "ao @ 0x%08" 
# 19 "project/radare2/libr/util/print_code.c" 3 4
                                                         "llx" 
# 19 "project/radare2/libr/util/print_code.c"
                                                                 "~^size[1]", at);
 int res = atoi (is);
 free (is);
 return res;
...
static void print_c_instructions(RPrint *p, 
# 25 "project/radare2/libr/util/print_code.c" 3 4
                                           unsigned long long 
# 25 "project/radare2/libr/util/print_code.c"
                                                addr, const 
# 25 "project/radare2/libr/util/print_code.c" 3 4
                                                            unsigned char 
# 25 "project/radare2/libr/util/print_code.c"
...
# 35 "project/radare2/libr/util/print_code.c" 3 4
 unsigned long long 
# 35 "project/radare2/libr/util/print_code.c"
      at = addr + i;
  ...
  p->cb_printf (" ");
  size_t limit = 
# 43 "project/radare2/libr/util/print_code.c" 3 4
                (((
# 43 "project/radare2/libr/util/print_code.c"
                i + inst_size
# 43 "project/radare2/libr/util/print_code.c" 3 4
                )>(
# 43 "project/radare2/libr/util/print_code.c"
...
# 43 "project/radare2/libr/util/print_code.c"
                                          ;
  for (k = i; k < limit; k++) {
   r_print_cursor (p, k, 1, 
# 45 "project/radare2/libr/util/print_code.c" 3 4
                           1
# 45 "project/radare2/libr/util/print_code.c"
                               );
   p->cb_printf (fmtstr, r_read_ble (buf++, p->big_endian, 8));
   r_print_cursor (p, k, 1, 
# 47 "project/radare2/libr/util/print_code.c" 3 4
                           0
# 47 "project/radare2/libr/util/print_code.c"
                                );
   p->cb_printf (", ");
  }
  size_t j = k - i;
  ...
  p->cb_printf ("%*s", 
# 52 "project/radare2/libr/util/print_code.c" 3 4
                      (((
# 52 "project/radare2/libr/util/print_code.c"
                      pad
# 52 "project/radare2/libr/util/print_code.c" 3 4
                      )>(
# 52 "project/radare2/libr/util/print_code.c"
...
# 52 "project/radare2/libr/util/print_code.c"
  ...
  if (j == inst_size) {
   char *instr = p->coreb.cmdstrf (p->coreb.core, "pi 1 @ 0x%08" 
# 55 "project/radare2/libr/util/print_code.c" 3 4
                                                                "llx"
# 55 "project/radare2/libr/util/print_code.c"
                                                                       , at);
   r_str_trim (instr);
   p->cb_printf (" /* %s */\n", instr);
   free (instr);
...
static void print_c_code(RPrint *p, 
# 67 "project/radare2/libr/util/print_code.c" 3 4
                                   unsigned long long 
# 67 "project/radare2/libr/util/print_code.c"
                                        addr, const 
# 67 "project/radare2/libr/util/print_code.c" 3 4
                                                    unsigned char 
# 67 "project/radare2/libr/util/print_code.c"
                                                        *buf, int len, int ws, int w) {
 size_t i;

 ws = 
# 70 "project/radare2/libr/util/print_code.c" 3 4
     (((
# 70 "project/radare2/libr/util/print_code.c"
     1
# 70 "project/radare2/libr/util/print_code.c" 3 4
     )>((((
# 70 "project/radare2/libr/util/print_code.c"
...
# 97 "project/radare2/libr/util/print_code.c" 3 4
__attribute__((visibility("default"))) 
# 97 "project/radare2/libr/util/print_code.c"
     void r_print_code(RPrint *p, 
# 97 "project/radare2/libr/util/print_code.c" 3 4
                                  unsigned long long 
# 97 "project/radare2/libr/util/print_code.c"
                                       addr, const 
# 97 "project/radare2/libr/util/print_code.c" 3 4
                                                   unsigned char 
# 97 "project/radare2/libr/util/print_code.c"
                                                       *buf, int len, char lang) {
 
# 98 "project/radare2/libr/util/print_code.c" 3 4
do { if (!(
# 98 "project/radare2/libr/util/print_code.c"
p && buf
# 98 "project/radare2/libr/util/print_code.c" 3 4
...
# 98 "project/radare2/libr/util/print_code.c"
 ...
 case 'y':
  p->cb_printf ("$hex_%"
# 225 "project/radare2/libr/util/print_code.c" 3 4
                       "llx"
# 225 "project/radare2/libr/util/print_code.c"
                              " = {", addr);
  for (i = 0; !r_print_is_interrupted () && i < len; i++) {
   r_print_cursor (p, i, 1, 1);
 ...
 case 'p':
  ...
  break;
 case 'h':
  print_c_code (p, addr, buf, len, 2, p->cols / 2);
  break;
 case 'w':
  print_c_code (p, addr, buf, len, 4, p->cols / 3);
  break;
 case 'i':
  print_c_instructions (p, addr, buf, len);
  break;
 case 'd':
  print_c_code (p, addr, buf, len, 8, p->cols / 5);
  break;
 default:
  print_c_code (p, addr, buf, len, 1, (int)(p->cols / 1.5));
  break;
 }
}
