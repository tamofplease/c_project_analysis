# 0 "project/radare2/libr/util/tree.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/util/tree.c" 2


# 5 "project/radare2/libr/util/tree.c"
...
# 22 "project/radare2/libr/util/tree.c" 3 4
 if (
# 22 "project/radare2/libr/util/tree.c"
 el->children
# 22 "project/radare2/libr/util/tree.c" 3 4
 ) for (
# 22 "project/radare2/libr/util/tree.c"
...
static RTreeNode *node_new (RTree *t, void *data) {
 RTreeNode *n = 
# 60 "project/radare2/libr/util/tree.c" 3 4
               (
# 60 "project/radare2/libr/util/tree.c"
               RTreeNode
# 60 "project/radare2/libr/util/tree.c" 3 4
               *)calloc(1,sizeof(
# 60 "project/radare2/libr/util/tree.c"
...
# 60 "project/radare2/libr/util/tree.c"
 ...
 if (!n) {
  return 
# 62 "project/radare2/libr/util/tree.c" 3 4
        ((void *)0)
# 62 "project/radare2/libr/util/tree.c"
            ;
 }
...
# 70 "project/radare2/libr/util/tree.c" 3 4
__attribute__((visibility("default"))) 
# 70 "project/radare2/libr/util/tree.c"
     RTree *r_tree_new (void) {
 return 
# 71 "project/radare2/libr/util/tree.c" 3 4
       (
# 71 "project/radare2/libr/util/tree.c"
       RTree
# 71 "project/radare2/libr/util/tree.c" 3 4
       *)calloc(1,sizeof(
# 71 "project/radare2/libr/util/tree.c"
...
# 74 "project/radare2/libr/util/tree.c" 3 4
__attribute__((visibility("default"))) 
# 74 "project/radare2/libr/util/tree.c"
     void r_tree_free (RTree* t) {
 if (!t) {
  return;
 }
...
# 83 "project/radare2/libr/util/tree.c" 3 4
__attribute__((visibility("default"))) 
# 83 "project/radare2/libr/util/tree.c"
     void r_tree_reset (RTree *t) {
 if (!t) {
  return;
 }
 ...
 free_all_children (t);
 t->root = 
# 89 "project/radare2/libr/util/tree.c" 3 4
          ((void *)0)
# 89 "project/radare2/libr/util/tree.c"
              ;
}
...
# 97 "project/radare2/libr/util/tree.c" 3 4
__attribute__((visibility("default"))) 
# 97 "project/radare2/libr/util/tree.c"
     RTreeNode *r_tree_add_node (RTree *t, RTreeNode *node, void *child_data) {
 RTreeNode *child;
 RTreeVisitor vis = { 0 };
 ...
 if (!t || (node && node->tree != t) || (t->root && !node)) {
  return 
# 103 "project/radare2/libr/util/tree.c" 3 4
        ((void *)0)
# 103 "project/radare2/libr/util/tree.c"
            ;
 }
...
# 122 "project/radare2/libr/util/tree.c" 3 4
__attribute__((visibility("default"))) 
# 122 "project/radare2/libr/util/tree.c"
     void r_tree_dfs (RTree *t, RTreeVisitor *vis) {
 if (!t || !t->root) {
  return;
 }
...
# 130 "project/radare2/libr/util/tree.c" 3 4
__attribute__((visibility("default"))) 
# 130 "project/radare2/libr/util/tree.c"
     void r_tree_bfs (RTree *t, RTreeVisitor *vis) {
 RQueue *q;
...
# 155 "project/radare2/libr/util/tree.c" 3 4
  if (
# 155 "project/radare2/libr/util/tree.c"
  el->children
# 155 "project/radare2/libr/util/tree.c" 3 4
  ) for (
# 155 "project/radare2/libr/util/tree.c"
