# 0 "project/radare2/libr/util/bitmap.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/bitmap.c"
...
# 4 "project/radare2/libr/util/bitmap.c" 2
# 14 "project/radare2/libr/util/bitmap.c"
__attribute__((visibility("default"))) 
# 14 "project/radare2/libr/util/bitmap.c"
     RBitmap *r_bitmap_new(size_t len) {
 RBitmap *b = 
# 15 "project/radare2/libr/util/bitmap.c" 3 4
             (
# 15 "project/radare2/libr/util/bitmap.c"
             RBitmap
# 15 "project/radare2/libr/util/bitmap.c" 3 4
             *)calloc(1,sizeof(
# 15 "project/radare2/libr/util/bitmap.c"
...
# 15 "project/radare2/libr/util/bitmap.c"
 ...
 if (!b) {
  return 
# 17 "project/radare2/libr/util/bitmap.c" 3 4
        ((void *)0)
# 17 "project/radare2/libr/util/bitmap.c"
            ;
 }
 b->length = len;
 b->bitmap = calloc (((((len) + (((sizeof(
# 20 "project/radare2/libr/util/bitmap.c" 3 4
                    unsigned long long
# 20 "project/radare2/libr/util/bitmap.c"
                    ) * 8) - 1))) & ~(((sizeof(
# 20 "project/radare2/libr/util/bitmap.c" 3 4
                    unsigned long long
# 20 "project/radare2/libr/util/bitmap.c"
...
# 24 "project/radare2/libr/util/bitmap.c" 3 4
__attribute__((visibility("default"))) 
# 24 "project/radare2/libr/util/bitmap.c"
     void r_bitmap_set_bytes(RBitmap *b, const 
# 24 "project/radare2/libr/util/bitmap.c" 3 4
                                               unsigned char 
# 24 "project/radare2/libr/util/bitmap.c"
                                                   *buf, int len) {
...
# 28 "project/radare2/libr/util/bitmap.c" 3 4
__builtin___memcpy_chk (
# 28 "project/radare2/libr/util/bitmap.c"
b->bitmap
# 28 "project/radare2/libr/util/bitmap.c" 3 4
, 
# 28 "project/radare2/libr/util/bitmap.c"
...
# 31 "project/radare2/libr/util/bitmap.c" 3 4
__attribute__((visibility("default"))) 
# 31 "project/radare2/libr/util/bitmap.c"
...
# 36 "project/radare2/libr/util/bitmap.c" 3 4
__attribute__((visibility("default"))) 
# 36 "project/radare2/libr/util/bitmap.c"
     void r_bitmap_set(RBitmap *b, size_t bit) {
 if (bit < b->length) {
  b->bitmap[(bit >> 
# 38 "project/radare2/libr/util/bitmap.c" 3 4
                   6
# 38 "project/radare2/libr/util/bitmap.c"
                                     )] |=
   ((
# 39 "project/radare2/libr/util/bitmap.c" 3 4
    unsigned long long
# 39 "project/radare2/libr/util/bitmap.c"
            )1 << (bit & ((sizeof(
# 39 "project/radare2/libr/util/bitmap.c" 3 4
                         unsigned long long
# 39 "project/radare2/libr/util/bitmap.c"
...
# 43 "project/radare2/libr/util/bitmap.c" 3 4
__attribute__((visibility("default"))) 
# 43 "project/radare2/libr/util/bitmap.c"
     void r_bitmap_unset(RBitmap *b, size_t bit) {
 if (bit < b->length) {
  b->bitmap[(bit >> 
# 45 "project/radare2/libr/util/bitmap.c" 3 4
                   6
# 45 "project/radare2/libr/util/bitmap.c"
                                     )] &=
   ~((
# 46 "project/radare2/libr/util/bitmap.c" 3 4
     unsigned long long
# 46 "project/radare2/libr/util/bitmap.c"
             )1 << (bit & ((sizeof(
# 46 "project/radare2/libr/util/bitmap.c" 3 4
                          unsigned long long
# 46 "project/radare2/libr/util/bitmap.c"
...
# 50 "project/radare2/libr/util/bitmap.c" 3 4
__attribute__((visibility("default"))) 
# 50 "project/radare2/libr/util/bitmap.c"
     int r_bitmap_test(RBitmap *b, size_t bit) {
 if (bit < b->length) {
  
# 52 "project/radare2/libr/util/bitmap.c" 3 4
 unsigned long long 
# 52 "project/radare2/libr/util/bitmap.c"
          bword = b->bitmap[ (bit >> 
# 52 "project/radare2/libr/util/bitmap.c" 3 4
                                     6
# 52 "project/radare2/libr/util/bitmap.c"
                                                       )];
  return (((bword)>>((bit & ((sizeof(
# 53 "project/radare2/libr/util/bitmap.c" 3 4
        unsigned long long
# 53 "project/radare2/libr/util/bitmap.c"
        ) * 8) - 1)))) & 1);
 }
 return -1;
}
