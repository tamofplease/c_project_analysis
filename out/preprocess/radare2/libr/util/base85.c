# 0 "project/radare2/libr/util/base85.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 27 "project/radare2/libr/util/base85.c" 2
...
# 28 "project/radare2/libr/util/base85.c" 2
...
# 29 "project/radare2/libr/util/base85.c" 2
...
# 30 "project/radare2/libr/util/base85.c" 2
...
# 31 "project/radare2/libr/util/base85.c" 2
...
typedef int RRef;
# 32 "project/radare2/libr/util/base85.c" 2


# 33 "project/radare2/libr/util/base85.c"
...
# 71 "project/radare2/libr/util/base85.c" 3 4
__attribute__((visibility("default"))) 
# 71 "project/radare2/libr/util/base85.c"
     void r_base85_decode_tuple(unsigned long tuple, int count) {
 int i;
 for (i = 1; i < count; i++) {
  putchar(tuple >> ((4 - i) * 8));
 }
...
# 78 "project/radare2/libr/util/base85.c" 3 4
__attribute__((visibility("default"))) 
# 78 "project/radare2/libr/util/base85.c"
     void r_base85_encode(FILE *fp, int delims, int wrap, int y_abbr) {
 int c, count = 0, len = 0;
 ...
 for (;;) {
  c = getc(fp);
  if (c != 
# 87 "project/radare2/libr/util/base85.c" 3 4
          (-1)
# 87 "project/radare2/libr/util/base85.c"
             ) {
   tuple |= c << ((3 - count++) * 8);
   if (count < 4) {
    continue;
  ...
  if (c == 
# 96 "project/radare2/libr/util/base85.c" 3 4
          (-1)
# 96 "project/radare2/libr/util/base85.c"
             ) {
   break;
  }
  tuple = 0;
...
# 108 "project/radare2/libr/util/base85.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 108 "project/radare2/libr/util/base85.c"
          r_base85_decode(FILE *fp, int delims, int ignore_garbage) {
 int c, count = 0, end = 0;
...
# 119 "project/radare2/libr/util/base85.c" 3 4
                 (-1)
# 119 "project/radare2/libr/util/base85.c"
                    ) {
   
# 120 "project/radare2/libr/util/base85.c" 3 4
  fprintf(__stderrp,
# 120 "project/radare2/libr/util/base85.c"
  "ascii85: missing <~"
# 120 "project/radare2/libr/util/base85.c" 3 4
  )
# 120 "project/radare2/libr/util/base85.c"
                                 ;
   return 
# 121 "project/radare2/libr/util/base85.c" 3 4
         0
# 121 "project/radare2/libr/util/base85.c"
              ;
  }
 }
 for (;;) {
...
# 137 "project/radare2/libr/util/base85.c" 3 4
   fprintf(__stderrp,
# 137 "project/radare2/libr/util/base85.c"
   "ascii85: ~ without >\n"
# 137 "project/radare2/libr/util/base85.c" 3 4
   )
# 137 "project/radare2/libr/util/base85.c"
                                     ;
    return 
# 138 "project/radare2/libr/util/base85.c" 3 4
          0
# 138 "project/radare2/libr/util/base85.c"
               ;
   }
   c = 
# 140 "project/radare2/libr/util/base85.c" 3 4
      (-1)
# 140 "project/radare2/libr/util/base85.c"
         ;
   end = 1;
  }
  if (c == 
# 143 "project/radare2/libr/util/base85.c" 3 4
          (-1)
# 143 "project/radare2/libr/util/base85.c"
             ) {
   if (delims && !end) {
    
# 145 "project/radare2/libr/util/base85.c" 3 4
   fprintf(__stderrp,
# 145 "project/radare2/libr/util/base85.c"
   "ascii85: missing ~>"
# 145 "project/radare2/libr/util/base85.c" 3 4
   )
# 145 "project/radare2/libr/util/base85.c"
                                  ;
    return 
# 146 "project/radare2/libr/util/base85.c" 3 4
          0
# 146 "project/radare2/libr/util/base85.c"
               ;
   }
   if (count > 0) {
    tuple += pows[count-1];
...
# 158 "project/radare2/libr/util/base85.c" 3 4
  fprintf(__stderrp,
# 158 "project/radare2/libr/util/base85.c"
...
# 158 "project/radare2/libr/util/base85.c"
                                                  ;
   return 
# 159 "project/radare2/libr/util/base85.c" 3 4
         0
# 159 "project/radare2/libr/util/base85.c"
              ;
  }
  tuple += (c - '!') * pows[count++];
  if (count == 5) {
 ...
 return 
# 168 "project/radare2/libr/util/base85.c" 3 4
       1
# 168 "project/radare2/libr/util/base85.c"
           ;
}
