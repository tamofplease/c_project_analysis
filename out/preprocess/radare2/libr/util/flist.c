# 0 "project/radare2/libr/util/flist.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/flist.c"
...
typedef int RRef;
# 15 "project/radare2/libr/util/flist.c" 2
# 28 "project/radare2/libr/util/flist.c"
...
# 28 "project/radare2/libr/util/flist.c"
 ...
 if (!(it = (void **)calloc (n + 2, sizeof (void*)))) {
  return 
# 31 "project/radare2/libr/util/flist.c" 3 4
        ((void *)0)
# 31 "project/radare2/libr/util/flist.c"
            ;
 }
 *it = it;
 
# 34 "project/radare2/libr/util/flist.c" 3 4
__builtin___memset_chk (
# 34 "project/radare2/libr/util/flist.c"
++it
# 34 "project/radare2/libr/util/flist.c" 3 4
, 
# 34 "project/radare2/libr/util/flist.c"
...
# 39 "project/radare2/libr/util/flist.c" 3 4
__attribute__((visibility("default"))) 
# 39 "project/radare2/libr/util/flist.c"
...
# 47 "project/radare2/libr/util/flist.c" 3 4
__attribute__((visibility("default"))) 
# 47 "project/radare2/libr/util/flist.c"
...
# 52 "project/radare2/libr/util/flist.c" 3 4
__attribute__((visibility("default"))) 
# 52 "project/radare2/libr/util/flist.c"
...
# 57 "project/radare2/libr/util/flist.c" 3 4
__attribute__((visibility("default"))) 
# 57 "project/radare2/libr/util/flist.c"
     void r_flist_delete(void **it, int idx) {
 for (; (it)!=*(it); (it)--) {} (it)++;
 free (it[idx]);
 it[idx] = 
# 60 "project/radare2/libr/util/flist.c" 3 4
          ((void *)0)
# 60 "project/radare2/libr/util/flist.c"
              ;
 for (it += idx; *it; it++) {
  *it = *(it + 1);
 }
...
# 70 "project/radare2/libr/util/flist.c" 3 4
__attribute__((visibility("default"))) 
# 70 "project/radare2/libr/util/flist.c"
     void r_flist_free(void **it) {
 void *pos;
 for (; (it)!=*(it); (it)--) {} (it)++; while (*(it)!=0 && ((pos) = *((it)++))) {
  free (pos);
 }
 for (; (it)!=*(it); (it)--) {} (it)++;
 free (--it);
...
# 79 "project/radare2/libr/util/flist.c" 3 4
__attribute__((visibility("default"))) 
# 79 "project/radare2/libr/util/flist.c"
