# 0 "project/radare2/libr/util/spaces.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/spaces.c"
...
# 7 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_spaces.h" 2 3 4
...
# 4 "project/radare2/libr/util/spaces.c" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/util/spaces.c"
     RSpaces *r_spaces_new(const char *name) {
 RSpaces *sp = 
# 6 "project/radare2/libr/util/spaces.c" 3 4
              (
# 6 "project/radare2/libr/util/spaces.c"
              RSpaces
# 6 "project/radare2/libr/util/spaces.c" 3 4
              *)calloc(1,sizeof(
# 6 "project/radare2/libr/util/spaces.c"
...
# 6 "project/radare2/libr/util/spaces.c"
 ...
 if (!sp || !r_spaces_init (sp, name)) {
  free (sp);
  return 
# 9 "project/radare2/libr/util/spaces.c" 3 4
        ((void *)0)
# 9 "project/radare2/libr/util/spaces.c"
            ;
 }
 return sp;
}
...
# 22 "project/radare2/libr/util/spaces.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 22 "project/radare2/libr/util/spaces.c"
          r_spaces_init(RSpaces *sp, const char *name) {
 
# 23 "project/radare2/libr/util/spaces.c" 3 4
do { if (!(
# 23 "project/radare2/libr/util/spaces.c"
sp && name
# 23 "project/radare2/libr/util/spaces.c" 3 4
...
# 23 "project/radare2/libr/util/spaces.c"
 ...
 sp->current = 
# 33 "project/radare2/libr/util/spaces.c" 3 4
              ((void *)0)
# 33 "project/radare2/libr/util/spaces.c"
                  ;
 ...
 return 
# 44 "project/radare2/libr/util/spaces.c" 3 4
       1
# 44 "project/radare2/libr/util/spaces.c"
           ;

fail:
 r_spaces_fini (sp);
 return 
# 48 "project/radare2/libr/util/spaces.c" 3 4
       0
# 48 "project/radare2/libr/util/spaces.c"
            ;
}


# 51 "project/radare2/libr/util/spaces.c" 3 4
__attribute__((visibility("default"))) 
# 51 "project/radare2/libr/util/spaces.c"
     void r_spaces_free(RSpaces *sp) {
 r_spaces_fini (sp);
 free (sp);
}


# 56 "project/radare2/libr/util/spaces.c" 3 4
__attribute__((visibility("default"))) 
# 56 "project/radare2/libr/util/spaces.c"
     void r_spaces_fini(RSpaces *sp) {
 r_list_free (sp->spacestack);
 sp->spacestack = 
# 58 "project/radare2/libr/util/spaces.c" 3 4
                 ((void *)0)
# 58 "project/radare2/libr/util/spaces.c"
                     ;
 r_crbtree_free (sp->spaces);
 sp->spaces = 
# 60 "project/radare2/libr/util/spaces.c" 3 4
             ((void *)0)
# 60 "project/radare2/libr/util/spaces.c"
                 ;
 sp->event = 
# 61 "project/radare2/libr/util/spaces.c" 3 4
            ((void *)0)
# 61 "project/radare2/libr/util/spaces.c"
                ;
 sp->current = 
# 62 "project/radare2/libr/util/spaces.c" 3 4
              ((void *)0)
# 62 "project/radare2/libr/util/spaces.c"
                  ;
 
# 63 "project/radare2/libr/util/spaces.c" 3 4
{ free((void *)
# 63 "project/radare2/libr/util/spaces.c"
sp->name
# 63 "project/radare2/libr/util/spaces.c" 3 4
); 
# 63 "project/radare2/libr/util/spaces.c"
...
# 66 "project/radare2/libr/util/spaces.c" 3 4
__attribute__((visibility("default"))) 
# 66 "project/radare2/libr/util/spaces.c"
     void r_spaces_purge(RSpaces *sp) {
 sp->current = 
# 67 "project/radare2/libr/util/spaces.c" 3 4
              ((void *)0)
# 67 "project/radare2/libr/util/spaces.c"
                  ;
 r_list_purge (sp->spacestack);
 r_crbtree_free (sp->spaces);
 sp->spaces = 
# 70 "project/radare2/libr/util/spaces.c" 3 4
             ((void *)0)
# 70 "project/radare2/libr/util/spaces.c"
                 ;
}
...
# 78 "project/radare2/libr/util/spaces.c" 3 4
__attribute__((visibility("default"))) 
# 78 "project/radare2/libr/util/spaces.c"
     RSpace *r_spaces_get(RSpaces *sp, const char *name) {
 if (!name) {
  return 
# 80 "project/radare2/libr/util/spaces.c" 3 4
        ((void *)0)
# 80 "project/radare2/libr/util/spaces.c"
            ;
 }
 return r_crbtree_find (sp->spaces, (void *)name, name_space_cmp, 
# 82 "project/radare2/libr/util/spaces.c" 3 4
                                                                 ((void *)0)
# 82 "project/radare2/libr/util/spaces.c"
                                                                     );
}
...
# 91 "project/radare2/libr/util/spaces.c" 3 4
__attribute__((visibility("default"))) 
# 91 "project/radare2/libr/util/spaces.c"
     RSpace *r_spaces_add(RSpaces *sp, const char *name) {
 
# 92 "project/radare2/libr/util/spaces.c" 3 4
do { if (!(
# 92 "project/radare2/libr/util/spaces.c"
sp
# 92 "project/radare2/libr/util/spaces.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 92 "project/radare2/libr/util/spaces.c"
"sp"
# 92 "project/radare2/libr/util/spaces.c" 3 4
, 92); return (((void *)0)); } } while (0)
# 92 "project/radare2/libr/util/spaces.c"
                               ;
 if (!name || !*name || *name == '*') {
  return 
# 94 "project/radare2/libr/util/spaces.c" 3 4
        ((void *)0)
# 94 "project/radare2/libr/util/spaces.c"
            ;
 }
 ...
 s = 
# 102 "project/radare2/libr/util/spaces.c" 3 4
    (
# 102 "project/radare2/libr/util/spaces.c"
    RSpace
# 102 "project/radare2/libr/util/spaces.c" 3 4
    *)calloc(1,sizeof(
# 102 "project/radare2/libr/util/spaces.c"
...
# 102 "project/radare2/libr/util/spaces.c"
 ...
 if (!s) {
  return 
# 104 "project/radare2/libr/util/spaces.c" 3 4
        ((void *)0)
# 104 "project/radare2/libr/util/spaces.c"
            ;
 }
 ...
 if (!s->name) {
  free (s);
  return 
# 110 "project/radare2/libr/util/spaces.c" 3 4
        ((void *)0)
# 110 "project/radare2/libr/util/spaces.c"
            ;
 }

 r_crbtree_insert (sp->spaces, s, space_cmp, 
# 113 "project/radare2/libr/util/spaces.c" 3 4
                                            ((void *)0)
# 113 "project/radare2/libr/util/spaces.c"
                                                );
 return s;
}


# 117 "project/radare2/libr/util/spaces.c" 3 4
__attribute__((visibility("default"))) 
# 117 "project/radare2/libr/util/spaces.c"
     RSpace *r_spaces_set(RSpaces *sp, const char *name) {
 sp->current = r_spaces_add (sp, name);
 return sp->current;
}

static inline 
# 122 "project/radare2/libr/util/spaces.c" 3 4
             _Bool 
# 122 "project/radare2/libr/util/spaces.c"
                  spaces_unset_single(RSpaces *sp, const char *name) {
 RSpace *space = r_spaces_get (sp, name);
 if (!space) {
  return 
# 125 "project/radare2/libr/util/spaces.c" 3 4
        0
# 125 "project/radare2/libr/util/spaces.c"
             ;
 }
 ...
 if (sp->current == space) {
  sp->current = 
# 131 "project/radare2/libr/util/spaces.c" 3 4
               ((void *)0)
# 131 "project/radare2/libr/util/spaces.c"
                   ;
 }
 return r_crbtree_delete (sp->spaces, (void *)name, name_space_cmp, 
# 133 "project/radare2/libr/util/spaces.c" 3 4
                                                                   ((void *)0)
# 133 "project/radare2/libr/util/spaces.c"
                                                                       );
}


# 136 "project/radare2/libr/util/spaces.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 136 "project/radare2/libr/util/spaces.c"
          r_spaces_unset(RSpaces *sp, const char *name) {
 if (name) {
 ...
 if (!names) {
  return 
# 143 "project/radare2/libr/util/spaces.c" 3 4
        0
# 143 "project/radare2/libr/util/spaces.c"
             ;
 }
...
# 148 "project/radare2/libr/util/spaces.c" 3 4
for ((
# 148 "project/radare2/libr/util/spaces.c"
iter
# 148 "project/radare2/libr/util/spaces.c" 3 4
) = (
# 148 "project/radare2/libr/util/spaces.c"
...
# 154 "project/radare2/libr/util/spaces.c" 3 4
_Bool 
# 154 "project/radare2/libr/util/spaces.c"
     res = 
# 154 "project/radare2/libr/util/spaces.c" 3 4
           0
# 154 "project/radare2/libr/util/spaces.c"
...
# 155 "project/radare2/libr/util/spaces.c" 3 4
if (
# 155 "project/radare2/libr/util/spaces.c"
names
# 155 "project/radare2/libr/util/spaces.c" 3 4
) for (
# 155 "project/radare2/libr/util/spaces.c"
...
# 162 "project/radare2/libr/util/spaces.c" 3 4
__attribute__((visibility("default"))) 
# 162 "project/radare2/libr/util/spaces.c"
     int r_spaces_count(RSpaces *sp, const char *name) {
 RSpace *s = r_spaces_get (sp, name);
 if (!s) {
  return 0;
 }
...
# 172 "project/radare2/libr/util/spaces.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 172 "project/radare2/libr/util/spaces.c"
          r_spaces_push(RSpaces *sp, const char *name) {
 
# 173 "project/radare2/libr/util/spaces.c" 3 4
do { if (!(
# 173 "project/radare2/libr/util/spaces.c"
sp
# 173 "project/radare2/libr/util/spaces.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 173 "project/radare2/libr/util/spaces.c"
...
# 175 "project/radare2/libr/util/spaces.c" 3 4
r_list_append ((
# 175 "project/radare2/libr/util/spaces.c"
sp->spacestack
# 175 "project/radare2/libr/util/spaces.c" 3 4
), (
# 175 "project/radare2/libr/util/spaces.c"
sp->current? sp->current->name: "*"
# 175 "project/radare2/libr/util/spaces.c" 3 4
))
# 175 "project/radare2/libr/util/spaces.c"
                                                                 ;
 ...
 return 
# 177 "project/radare2/libr/util/spaces.c" 3 4
       1
# 177 "project/radare2/libr/util/spaces.c"
           ;
}


# 180 "project/radare2/libr/util/spaces.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 180 "project/radare2/libr/util/spaces.c"
          r_spaces_pop(RSpaces *sp) {
 char *name = r_list_pop (sp->spacestack);
 if (!name) {
  return 
# 183 "project/radare2/libr/util/spaces.c" 3 4
        0
# 183 "project/radare2/libr/util/spaces.c"
             ;
 }

 RSpace *s = r_spaces_get (sp, name);
 r_spaces_set (sp, s? s->name: 
# 187 "project/radare2/libr/util/spaces.c" 3 4
                              ((void *)0)
# 187 "project/radare2/libr/util/spaces.c"
                                  );
 return 
# 188 "project/radare2/libr/util/spaces.c" 3 4
       1
# 188 "project/radare2/libr/util/spaces.c"
           ;
}


# 191 "project/radare2/libr/util/spaces.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 191 "project/radare2/libr/util/spaces.c"
          r_spaces_rename(RSpaces *sp, const char *oname, const char *nname) {
 if (!oname && !sp->current) {
  return 
# 193 "project/radare2/libr/util/spaces.c" 3 4
        0
# 193 "project/radare2/libr/util/spaces.c"
             ;
 }
 ...
 if (oname) {
  ...
  if (!s) {
   return 
# 200 "project/radare2/libr/util/spaces.c" 3 4
         0
# 200 "project/radare2/libr/util/spaces.c"
              ;
  }
 } else {
  s = sp->current;
 ...
 if (sn) {
  return 
# 208 "project/radare2/libr/util/spaces.c" 3 4
        0
# 208 "project/radare2/libr/util/spaces.c"
             ;
 }
 ...
 r_crbtree_take (sp->spaces, s->name, name_space_cmp, 
# 218 "project/radare2/libr/util/spaces.c" 3 4
                                                     ((void *)0)
# 218 "project/radare2/libr/util/spaces.c"
                                                         );
 free (s->name);
 s->name = strdup (nname);
 r_crbtree_insert (sp->spaces, s, space_cmp, 
# 221 "project/radare2/libr/util/spaces.c" 3 4
                                            ((void *)0)
# 221 "project/radare2/libr/util/spaces.c"
                                                );

 return 
# 223 "project/radare2/libr/util/spaces.c" 3 4
       1
# 223 "project/radare2/libr/util/spaces.c"
           ;
}
