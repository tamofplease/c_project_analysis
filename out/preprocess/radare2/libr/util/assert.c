# 0 "project/radare2/libr/util/assert.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/assert.c"
...
# 4 "project/radare2/libr/util/assert.c" 2
# 17 "project/radare2/libr/util/assert.c"

# 17 "project/radare2/libr/util/assert.c"
static void print_message(RLogLevel level, const char *fmt, va_list args) {
 
# 18 "project/radare2/libr/util/assert.c" 3 4
r_vlog (__func__, "project/radare2/libr/util/assert.c", 18, 
# 18 "project/radare2/libr/util/assert.c"
level
# 18 "project/radare2/libr/util/assert.c" 3 4
, ((void *)0), 
# 18 "project/radare2/libr/util/assert.c"
...
# 25 "project/radare2/libr/util/assert.c" 3 4
__attribute__((visibility("default"))) 
# 25 "project/radare2/libr/util/assert.c"
     void r_assert_log(RLogLevel level, const char *fmt, ...) {
 va_list args;
 
# 27 "project/radare2/libr/util/assert.c" 3 4
__builtin_va_start(
# 27 "project/radare2/libr/util/assert.c"
args
# 27 "project/radare2/libr/util/assert.c" 3 4
,
# 27 "project/radare2/libr/util/assert.c"
...
# 29 "project/radare2/libr/util/assert.c" 3 4
__builtin_va_end(
# 29 "project/radare2/libr/util/assert.c"
args
# 29 "project/radare2/libr/util/assert.c" 3 4
)
# 29 "project/radare2/libr/util/assert.c"
...
# 34 "project/radare2/libr/util/assert.c" 3 4
  __builtin_trap()
# 34 "project/radare2/libr/util/assert.c"
                     ;
  }
  free (env);
 }
