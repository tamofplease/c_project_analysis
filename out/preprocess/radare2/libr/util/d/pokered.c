# 0 "project/radare2/libr/util/d/pokered.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/util/d/pokered.c" 2
...
# 5 "project/radare2/libr/util/d/pokered.c" 2
...
# 6 "project/radare2/libr/util/d/pokered.c" 2


# 7 "project/radare2/libr/util/d/pokered.c"
...
static struct kv kvs[] = {
  ...
  {"0xaa","k"},
  {
# 123 "project/radare2/libr/util/d/pokered.c" 3 4
  ((void *)0)
# 123 "project/radare2/libr/util/d/pokered.c"
      , 
# 123 "project/radare2/libr/util/d/pokered.c" 3 4
        ((void *)0)
# 123 "project/radare2/libr/util/d/pokered.c"
...
const char *gperf_pokered_get(const char *s) {
  ...
  i++;}
  return 
# 138 "project/radare2/libr/util/d/pokered.c" 3 4
        ((void *)0)
# 138 "project/radare2/libr/util/d/pokered.c"
            ;
}
