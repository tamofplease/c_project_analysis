# 0 "project/radare2/libr/util/d/ascii.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/util/d/ascii.c" 2
...
# 5 "project/radare2/libr/util/d/ascii.c" 2
...
# 6 "project/radare2/libr/util/d/ascii.c" 2


# 7 "project/radare2/libr/util/d/ascii.c"
...
static struct kv kvs[] = {
  ...
  {"0x27","'"},
  {
# 103 "project/radare2/libr/util/d/ascii.c" 3 4
  ((void *)0)
# 103 "project/radare2/libr/util/d/ascii.c"
      , 
# 103 "project/radare2/libr/util/d/ascii.c" 3 4
        ((void *)0)
# 103 "project/radare2/libr/util/d/ascii.c"
...
const char *gperf_ascii_get(const char *s) {
  ...
  i++;}
  return 
# 118 "project/radare2/libr/util/d/ascii.c" 3 4
        ((void *)0)
# 118 "project/radare2/libr/util/d/ascii.c"
            ;
}
