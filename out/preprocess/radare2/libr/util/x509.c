# 0 "project/radare2/libr/util/x509.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/util/x509.c"
...
# 4 "project/radare2/libr/util/x509.c" 2
...
# 8 "project/radare2/libr/util/x509.c" 2

static 
# 9 "project/radare2/libr/util/x509.c" 3 4
      _Bool 
# 9 "project/radare2/libr/util/x509.c"
           r_x509_parse_validity(RX509Validity *validity, RASN1Object *object) {
 RASN1Object *o;
 if (!validity || !object || object->list.length != 2) {
  return 
# 12 "project/radare2/libr/util/x509.c" 3 4
        0
# 12 "project/radare2/libr/util/x509.c"
             ;
 }
 if (object->klass == 
# 14 "project/radare2/libr/util/x509.c" 3 4
                     0x00 
# 14 "project/radare2/libr/util/x509.c"
                                     &&
  object->tag == 
# 15 "project/radare2/libr/util/x509.c" 3 4
                0x10 
# 15 "project/radare2/libr/util/x509.c"
                             &&
  object->form == 
# 16 "project/radare2/libr/util/x509.c" 3 4
                 0x20
# 16 "project/radare2/libr/util/x509.c"
                                 ) {
  o = object->list.objects[0];
  if (o->klass == 
# 18 "project/radare2/libr/util/x509.c" 3 4
                 0x00 
# 18 "project/radare2/libr/util/x509.c"
                                 && o->form == 
# 18 "project/radare2/libr/util/x509.c" 3 4
                                               0x00
# 18 "project/radare2/libr/util/x509.c"
   ...
   if (o->tag == 
# 19 "project/radare2/libr/util/x509.c" 3 4
                0x17
# 19 "project/radare2/libr/util/x509.c"
                           ) {
    validity->notBefore = r_asn1_stringify_utctime (o->sector, o->length);
   } else if (o->tag == 
# 21 "project/radare2/libr/util/x509.c" 3 4
                       0x18
# 21 "project/radare2/libr/util/x509.c"
                                          ) {
  ...
  if (o && o->klass == 
# 26 "project/radare2/libr/util/x509.c" 3 4
                      0x00 
# 26 "project/radare2/libr/util/x509.c"
                                      && o->form == 
# 26 "project/radare2/libr/util/x509.c" 3 4
                                                    0x00
# 26 "project/radare2/libr/util/x509.c"
   ...
   if (o->tag == 
# 27 "project/radare2/libr/util/x509.c" 3 4
                0x17
# 27 "project/radare2/libr/util/x509.c"
                           ) {
    validity->notAfter = r_asn1_stringify_utctime (o->sector, o->length);
   } else if (o->tag == 
# 29 "project/radare2/libr/util/x509.c" 3 4
                       0x18
# 29 "project/radare2/libr/util/x509.c"
                                          ) {
 ...
 return 
# 34 "project/radare2/libr/util/x509.c" 3 4
       1
# 34 "project/radare2/libr/util/x509.c"
           ;
}

static inline 
# 37 "project/radare2/libr/util/x509.c" 3 4
             _Bool 
# 37 "project/radare2/libr/util/x509.c"
                  is_oid_object (RASN1Object *object) {
 return object->list.objects[0] &&
  object->list.objects[0]->klass == 
# 39 "project/radare2/libr/util/x509.c" 3 4
                                   0x00 
# 39 "project/radare2/libr/util/x509.c"
                                                   &&
  object->list.objects[0]->tag == 
# 40 "project/radare2/libr/util/x509.c" 3 4
                                 0x06
# 40 "project/radare2/libr/util/x509.c"
                                        ;
}


# 43 "project/radare2/libr/util/x509.c" 3 4
_Bool 
# 43 "project/radare2/libr/util/x509.c"
    r_x509_parse_algorithmidentifier (RX509AlgorithmIdentifier *ai, RASN1Object *object) {
 
# 44 "project/radare2/libr/util/x509.c" 3 4
do { if (!(
# 44 "project/radare2/libr/util/x509.c"
ai && object
# 44 "project/radare2/libr/util/x509.c" 3 4
...
# 44 "project/radare2/libr/util/x509.c"
 ...
 if (object->list.length < 1 || !object->list.objects || !is_oid_object (object)) {
   return 
# 47 "project/radare2/libr/util/x509.c" 3 4
         0
# 47 "project/radare2/libr/util/x509.c"
              ;
 }

 ai->algorithm = r_asn1_stringify_oid (object->list.objects[0]->sector, object->list.objects[0]->length);
 ai->parameters = 
# 51 "project/radare2/libr/util/x509.c" 3 4
                 ((void *)0)
# 51 "project/radare2/libr/util/x509.c"
                     ;

 return 
# 53 "project/radare2/libr/util/x509.c" 3 4
       1
# 53 "project/radare2/libr/util/x509.c"
           ;
}


# 56 "project/radare2/libr/util/x509.c" 3 4
_Bool 
# 56 "project/radare2/libr/util/x509.c"
    r_x509_parse_subjectpublickeyinfo (RX509SubjectPublicKeyInfo *spki, RASN1Object *object) {
 RASN1Object *o;
 if (!spki || !object || object->list.length != 2) {
  return 
# 59 "project/radare2/libr/util/x509.c" 3 4
        0
# 59 "project/radare2/libr/util/x509.c"
             ;
 }
 ...
 return 
# 75 "project/radare2/libr/util/x509.c" 3 4
       1
# 75 "project/radare2/libr/util/x509.c"
           ;
}


# 78 "project/radare2/libr/util/x509.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 78 "project/radare2/libr/util/x509.c"
          r_x509_parse_name(RX509Name *name, RASN1Object *object) {
 
# 79 "project/radare2/libr/util/x509.c" 3 4
unsigned int 
# 79 "project/radare2/libr/util/x509.c"
     i;
 if (!name || !object || !object->list.length) {
  return 
# 81 "project/radare2/libr/util/x509.c" 3 4
        0
# 81 "project/radare2/libr/util/x509.c"
             ;
 }
 if (object->klass == 
# 83 "project/radare2/libr/util/x509.c" 3 4
                     0x00 
# 83 "project/radare2/libr/util/x509.c"
                                     && object->tag == 
# 83 "project/radare2/libr/util/x509.c" 3 4
                                                       0x10
# 83 "project/radare2/libr/util/x509.c"
  ...
  if (!name->names) {
   name->length = 0;
   return 
# 88 "project/radare2/libr/util/x509.c" 3 4
         0
# 88 "project/radare2/libr/util/x509.c"
              ;
  }
...
# 93 "project/radare2/libr/util/x509.c" 3 4
  { free((void *)
# 93 "project/radare2/libr/util/x509.c"
  name->names
# 93 "project/radare2/libr/util/x509.c" 3 4
  ); 
# 93 "project/radare2/libr/util/x509.c"
...
# 93 "project/radare2/libr/util/x509.c"
                      ;
   return 
# 94 "project/radare2/libr/util/x509.c" 3 4
         0
# 94 "project/radare2/libr/util/x509.c"
              ;
  }
  for (i = 0; i < object->list.length; i++) {
   RASN1Object *o = object->list.objects[i];
   if (o && o->klass == 
# 98 "project/radare2/libr/util/x509.c" 3 4
                       0x00 
# 98 "project/radare2/libr/util/x509.c"
                                       &&
    o->tag == 
# 99 "project/radare2/libr/util/x509.c" 3 4
             0x11 
# 99 "project/radare2/libr/util/x509.c"
                     &&
    o->form == 
# 100 "project/radare2/libr/util/x509.c" 3 4
              0x20 
# 100 "project/radare2/libr/util/x509.c"
                               &&
    o->list.length == 1) {
    o = o->list.objects[0];
    if (o && o->list.length > 1 &&
     o->klass == 
# 104 "project/radare2/libr/util/x509.c" 3 4
                0x00 
# 104 "project/radare2/libr/util/x509.c"
                                &&
     o->tag == 
# 105 "project/radare2/libr/util/x509.c" 3 4
              0x10
# 105 "project/radare2/libr/util/x509.c"
                          ) {
     if (o->list.objects[0]->klass == 
# 106 "project/radare2/libr/util/x509.c" 3 4
                                     0x00 
# 106 "project/radare2/libr/util/x509.c"
                                                     &&
      o->list.objects[0]->tag == 
# 107 "project/radare2/libr/util/x509.c" 3 4
                                0x06
# 107 "project/radare2/libr/util/x509.c"
                                       ) {
      name->oids[i] = r_asn1_stringify_oid (o->list.objects[0]->sector, o->list.objects[0]->length);
     }
     RASN1Object *obj1 = o->list.objects[1];
     if (obj1 && obj1->klass == 
# 111 "project/radare2/libr/util/x509.c" 3 4
                               0x00
# 111 "project/radare2/libr/util/x509.c"
                                              ) {
 ...
 return 
# 118 "project/radare2/libr/util/x509.c" 3 4
       1
# 118 "project/radare2/libr/util/x509.c"
           ;
}


# 121 "project/radare2/libr/util/x509.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 121 "project/radare2/libr/util/x509.c"
          r_x509_parse_extension(RX509Extension *ext, RASN1Object *object) {
 RASN1Object *o;
 if (!ext || !object || object->list.length != 2) {
  return 
# 124 "project/radare2/libr/util/x509.c" 3 4
        0
# 124 "project/radare2/libr/util/x509.c"
             ;
 }
 o = object->list.objects[0];
 if (o && o->tag == 
# 127 "project/radare2/libr/util/x509.c" 3 4
                   0x06
# 127 "project/radare2/libr/util/x509.c"
                          ) {
  ext->extnID = r_asn1_stringify_oid (o->sector, o->length);
  o = object->list.objects[1];
  if (o->tag == 
# 130 "project/radare2/libr/util/x509.c" 3 4
               0x01 
# 130 "project/radare2/libr/util/x509.c"
  ...
  if (o->tag == 
# 135 "project/radare2/libr/util/x509.c" 3 4
               0x04
# 135 "project/radare2/libr/util/x509.c"
                              ) {
   ext->extnValue = r_asn1_create_binary (o->sector, o->length);
  }
 }
 return 
# 139 "project/radare2/libr/util/x509.c" 3 4
       1
# 139 "project/radare2/libr/util/x509.c"
           ;
}


# 142 "project/radare2/libr/util/x509.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 142 "project/radare2/libr/util/x509.c"
          r_x509_parse_extensions(RX509Extensions *ext, RASN1Object *object) {
 
# 143 "project/radare2/libr/util/x509.c" 3 4
unsigned int 
# 143 "project/radare2/libr/util/x509.c"
     i;
 if (!ext || !object || object->list.length != 1 || !object->list.objects[0]->length) {
  return 
# 145 "project/radare2/libr/util/x509.c" 3 4
        0
# 145 "project/radare2/libr/util/x509.c"
             ;
 }
 ...
 if (!ext->extensions) {
  return 
# 150 "project/radare2/libr/util/x509.c" 3 4
        0
# 150 "project/radare2/libr/util/x509.c"
             ;
 }
 ext->length = object->list.length;
 for (i = 0; i < object->list.length; i++) {
  ext->extensions[i] = 
# 154 "project/radare2/libr/util/x509.c" 3 4
                      (
# 154 "project/radare2/libr/util/x509.c"
                      RX509Extension
# 154 "project/radare2/libr/util/x509.c" 3 4
                      *)calloc(1,sizeof(
# 154 "project/radare2/libr/util/x509.c"
...
# 154 "project/radare2/libr/util/x509.c"
  ...
  if (!r_x509_parse_extension (ext->extensions[i], object->list.objects[i])) {
   ...
   ext->extensions[i] = 
# 157 "project/radare2/libr/util/x509.c" 3 4
                       ((void *)0)
# 157 "project/radare2/libr/util/x509.c"
                           ;
  }
 }
 return 
# 160 "project/radare2/libr/util/x509.c" 3 4
       1
# 160 "project/radare2/libr/util/x509.c"
           ;
}


# 163 "project/radare2/libr/util/x509.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 163 "project/radare2/libr/util/x509.c"
          r_x509_parse_tbscertificate (RX509TBSCertificate *tbsc, RASN1Object *object) {
 RASN1Object **elems;
 
# 165 "project/radare2/libr/util/x509.c" 3 4
unsigned int 
# 165 "project/radare2/libr/util/x509.c"
     i;
 
# 166 "project/radare2/libr/util/x509.c" 3 4
unsigned int 
# 166 "project/radare2/libr/util/x509.c"
     shift = 0;
 if (!tbsc || !object || object->list.length < 6) {
  return 
# 168 "project/radare2/libr/util/x509.c" 3 4
        0
# 168 "project/radare2/libr/util/x509.c"
             ;
 }
 ...
 if (elems[0]->list.length == 1 &&
  elems[0]->klass == 
# 173 "project/radare2/libr/util/x509.c" 3 4
                    0x80 
# 173 "project/radare2/libr/util/x509.c"
                                  &&
  elems[0]->form == 
# 174 "project/radare2/libr/util/x509.c" 3 4
                   0x20 
# 174 "project/radare2/libr/util/x509.c"
                                    &&
  elems[0]->list.objects[0]->tag == 
# 175 "project/radare2/libr/util/x509.c" 3 4
                                   0x02 
# 175 "project/radare2/libr/util/x509.c"
                                               &&
  elems[0]->list.objects[0]->length == 1) {

  tbsc->version = (
# 178 "project/radare2/libr/util/x509.c" 3 4
                  unsigned int
# 178 "project/radare2/libr/util/x509.c"
                      )elems[0]->list.objects[0]->sector[0];
  shift = 1;
 } else {
  tbsc->version = 0;
 }
 if (shift < object->list.length && elems[shift]->klass == 
# 183 "project/radare2/libr/util/x509.c" 3 4
                                                          0x00 
# 183 "project/radare2/libr/util/x509.c"
                                                                          && elems[shift]->tag == 
# 183 "project/radare2/libr/util/x509.c" 3 4
                                                                                                  0x02
# 183 "project/radare2/libr/util/x509.c"
 ...
 if (tbsc->version > 0) {
  for (i = shift + 6; i < object->list.length; i++) {
   if (!elems[i] || elems[i]->klass != 
# 193 "project/radare2/libr/util/x509.c" 3 4
                                      0x80
# 193 "project/radare2/libr/util/x509.c"
                                                   ) {
    continue;
   }
   if (elems[i]->tag == 1) {
   ...
   if (tbsc->version == 2 && elems[i]->tag == 3 && elems[i]->form == 
# 208 "project/radare2/libr/util/x509.c" 3 4
                                                                    0x20
# 208 "project/radare2/libr/util/x509.c"
                                                                                    ) {
 ...
 return 
# 213 "project/radare2/libr/util/x509.c" 3 4
       1
# 213 "project/radare2/libr/util/x509.c"
           ;
}


# 216 "project/radare2/libr/util/x509.c" 3 4
__attribute__((visibility("default"))) 
# 216 "project/radare2/libr/util/x509.c"
     RX509Certificate *r_x509_parse_certificate(RASN1Object *object) {
 if (!object) {
  return 
# 218 "project/radare2/libr/util/x509.c" 3 4
        ((void *)0)
# 218 "project/radare2/libr/util/x509.c"
            ;
 }
 RX509Certificate *cert = 
# 220 "project/radare2/libr/util/x509.c" 3 4
                         (
# 220 "project/radare2/libr/util/x509.c"
                         RX509Certificate
# 220 "project/radare2/libr/util/x509.c" 3 4
                         *)calloc(1,sizeof(
# 220 "project/radare2/libr/util/x509.c"
...
# 220 "project/radare2/libr/util/x509.c"
 ...
 if (object->klass != 
# 224 "project/radare2/libr/util/x509.c" 3 4
                     0x00 
# 224 "project/radare2/libr/util/x509.c"
                                     || object->form != 
# 224 "project/radare2/libr/util/x509.c" 3 4
                                                        0x20 
# 224 "project/radare2/libr/util/x509.c"
...
# 225 "project/radare2/libr/util/x509.c" 3 4
 { free((void *)
# 225 "project/radare2/libr/util/x509.c"
 cert
# 225 "project/radare2/libr/util/x509.c" 3 4
 ); 
# 225 "project/radare2/libr/util/x509.c"
...
# 230 "project/radare2/libr/util/x509.c" 3 4
 { free((void *)
# 230 "project/radare2/libr/util/x509.c"
 cert
# 230 "project/radare2/libr/util/x509.c" 3 4
 ); 
# 230 "project/radare2/libr/util/x509.c"
...
# 230 "project/radare2/libr/util/x509.c"
 ...
 if (tmp->klass != 
# 233 "project/radare2/libr/util/x509.c" 3 4
                  0x00 
# 233 "project/radare2/libr/util/x509.c"
                                  || tmp->form != 
# 233 "project/radare2/libr/util/x509.c" 3 4
                                                  0x00 
# 233 "project/radare2/libr/util/x509.c"
...
# 234 "project/radare2/libr/util/x509.c" 3 4
 { free((void *)
# 234 "project/radare2/libr/util/x509.c"
 cert
# 234 "project/radare2/libr/util/x509.c" 3 4
 ); 
# 234 "project/radare2/libr/util/x509.c"
...
# 241 "project/radare2/libr/util/x509.c" 3 4
 { free((void *)
# 241 "project/radare2/libr/util/x509.c"
 cert
# 241 "project/radare2/libr/util/x509.c" 3 4
 ); 
# 241 "project/radare2/libr/util/x509.c"
...
# 248 "project/radare2/libr/util/x509.c" 3 4
__attribute__((visibility("default"))) 
# 248 "project/radare2/libr/util/x509.c"
     RX509Certificate *r_x509_parse_certificate2(const 
# 248 "project/radare2/libr/util/x509.c" 3 4
                                                       unsigned char 
# 248 "project/radare2/libr/util/x509.c"
                                                           *buffer, 
...
# 248 "project/radare2/libr/util/x509.c"
 ...
 if (!buffer || !length) {
  return 
# 252 "project/radare2/libr/util/x509.c" 3 4
        ((void *)0)
# 252 "project/radare2/libr/util/x509.c"
            ;
 }
...
# 260 "project/radare2/libr/util/x509.c" 3 4
__attribute__((visibility("default"))) 
# 260 "project/radare2/libr/util/x509.c"
     RX509CRLEntry *r_x509_parse_crlentry(RASN1Object *object) {
 RX509CRLEntry *entry;
 if (!object || object->list.length != 2) {
  return 
# 263 "project/radare2/libr/util/x509.c" 3 4
        ((void *)0)
# 263 "project/radare2/libr/util/x509.c"
            ;
 }
 entry = (RX509CRLEntry *)malloc (sizeof (RX509CRLEntry));
 if (!entry) {
  return 
# 267 "project/radare2/libr/util/x509.c" 3 4
        ((void *)0)
# 267 "project/radare2/libr/util/x509.c"
            ;
 }
...
# 274 "project/radare2/libr/util/x509.c" 3 4
__attribute__((visibility("default"))) 
# 274 "project/radare2/libr/util/x509.c"
     RX509CertificateRevocationList *r_x509_parse_crl(RASN1Object *object) {
 if (!object || object->list.length < 4) {
  return 
# 276 "project/radare2/libr/util/x509.c" 3 4
        ((void *)0)
# 276 "project/radare2/libr/util/x509.c"
            ;
 }
 RX509CertificateRevocationList *crl = 
# 278 "project/radare2/libr/util/x509.c" 3 4
                                      (
# 278 "project/radare2/libr/util/x509.c"
                                      RX509CertificateRevocationList
# 278 "project/radare2/libr/util/x509.c" 3 4
                                      *)calloc(1,sizeof(
# 278 "project/radare2/libr/util/x509.c"
...
# 278 "project/radare2/libr/util/x509.c"
 ...
 if (!crl) {
  return 
# 280 "project/radare2/libr/util/x509.c" 3 4
        ((void *)0)
# 280 "project/radare2/libr/util/x509.c"
            ;
 }
 ...
 if (!elems) {
  free (crl);
  return 
# 285 "project/radare2/libr/util/x509.c" 3 4
        ((void *)0)
# 285 "project/radare2/libr/util/x509.c"
            ;
 }
 if (elems[0]) {
...
# 300 "project/radare2/libr/util/x509.c" 3 4
 unsigned int 
# 300 "project/radare2/libr/util/x509.c"
      i;
  crl->revokedCertificates = calloc (object->list.objects[4]->list.length, sizeof (RX509CRLEntry *));
  if (!crl->revokedCertificates) {
   free (crl);
   return 
# 304 "project/radare2/libr/util/x509.c" 3 4
         ((void *)0)
# 304 "project/radare2/libr/util/x509.c"
             ;
  }
...
# 314 "project/radare2/libr/util/x509.c" 3 4
__attribute__((visibility("default"))) 
# 314 "project/radare2/libr/util/x509.c"
     void r_x509_free_algorithmidentifier(RX509AlgorithmIdentifier *ai) {
 if (ai) {
...
# 330 "project/radare2/libr/util/x509.c" 3 4
__attribute__((visibility("default"))) 
# 330 "project/radare2/libr/util/x509.c"
     void r_x509_free_name(RX509Name *name) {
 
# 331 "project/radare2/libr/util/x509.c" 3 4
unsigned int 
# 331 "project/radare2/libr/util/x509.c"
     i;
 if (!name) {
  return;
 }
...
# 340 "project/radare2/libr/util/x509.c" 3 4
 { free((void *)
# 340 "project/radare2/libr/util/x509.c"
 name->names
# 340 "project/radare2/libr/util/x509.c" 3 4
 ); 
# 340 "project/radare2/libr/util/x509.c"
...
# 341 "project/radare2/libr/util/x509.c" 3 4
 { free((void *)
# 341 "project/radare2/libr/util/x509.c"
 name->oids
# 341 "project/radare2/libr/util/x509.c" 3 4
 ); 
# 341 "project/radare2/libr/util/x509.c"
...
# 356 "project/radare2/libr/util/x509.c" 3 4
unsigned int 
# 356 "project/radare2/libr/util/x509.c"
     i;
 if (!ex) {
  return;
 }
...
# 413 "project/radare2/libr/util/x509.c" 3 4
unsigned int 
# 413 "project/radare2/libr/util/x509.c"
     i;
 if (crl) {
  ...
  if (crl->revokedCertificates) {
   for (i = 0; i < crl->length; i++) {
    ...
    crl->revokedCertificates[i] = 
# 422 "project/radare2/libr/util/x509.c" 3 4
                                 ((void *)0)
# 422 "project/radare2/libr/util/x509.c"
                                     ;
   }
   
# 424 "project/radare2/libr/util/x509.c" 3 4
  { free((void *)
# 424 "project/radare2/libr/util/x509.c"
...
# 443 "project/radare2/libr/util/x509.c" 3 4
unsigned int 
# 443 "project/radare2/libr/util/x509.c"
     i;
 if (!name) {
  return;
 }
...
static void r_x509_subjectpublickeyinfo_dump(RX509SubjectPublicKeyInfo *spki, const char *pad, RStrBuf *sb) {
 ...
 RASN1String *m = 
# 467 "project/radare2/libr/util/x509.c" 3 4
                 ((void *)0)
# 467 "project/radare2/libr/util/x509.c"
                     ;
...
# 481 "project/radare2/libr/util/x509.c" 3 4
unsigned int 
# 481 "project/radare2/libr/util/x509.c"
     i;
 if (!exts) {
  return;
 }
...
static void r_x509_tbscertificate_dump(RX509TBSCertificate *tbsc, const char *pad, RStrBuf *sb) {
 RASN1String *sid = 
# 504 "project/radare2/libr/util/x509.c" 3 4
                   ((void *)0)
# 504 "project/radare2/libr/util/x509.c"
                       , *iid = 
# 504 "project/radare2/libr/util/x509.c" 3 4
                                ((void *)0)
# 504 "project/radare2/libr/util/x509.c"
...
void r_x509_certificate_dump (RX509Certificate *cert, const char *pad, RStrBuf *sb) {
 RASN1String *algo = 
# 555 "project/radare2/libr/util/x509.c" 3 4
                    ((void *)0)
# 555 "project/radare2/libr/util/x509.c"
                        ;
 char *pad2;
 if (!cert) {
  return;
...
void r_x509_crlentry_dump (RX509CRLEntry *crle, const char *pad, RStrBuf *sb) {
 RASN1String *id = 
# 582 "project/radare2/libr/util/x509.c" 3 4
                  ((void *)0)
# 582 "project/radare2/libr/util/x509.c"
                      , *utc = 
# 582 "project/radare2/libr/util/x509.c" 3 4
                               ((void *)0)
# 582 "project/radare2/libr/util/x509.c"
...
# 600 "project/radare2/libr/util/x509.c" 3 4
__attribute__((visibility("default"))) 
# 600 "project/radare2/libr/util/x509.c"
     char *r_x509_crl_to_string(RX509CertificateRevocationList *crl, const char *pad) {
 RASN1String *algo = 
# 601 "project/radare2/libr/util/x509.c" 3 4
                    ((void *)0)
# 601 "project/radare2/libr/util/x509.c"
                        , *last = 
# 601 "project/radare2/libr/util/x509.c" 3 4
                                  ((void *)0)
# 601 "project/radare2/libr/util/x509.c"
...
# 602 "project/radare2/libr/util/x509.c" 3 4
unsigned int 
# 602 "project/radare2/libr/util/x509.c"
     i;
 char *pad2, *pad3;
 if (!crl) {
  return 
# 605 "project/radare2/libr/util/x509.c" 3 4
        ((void *)0)
# 605 "project/radare2/libr/util/x509.c"
            ;
 }
 if (!pad) {
  pad = "";
 ...
 if (!pad3) {
  return 
# 612 "project/radare2/libr/util/x509.c" 3 4
        ((void *)0)
# 612 "project/radare2/libr/util/x509.c"
            ;
 }
 pad2 = pad3 + 2;
...
# 635 "project/radare2/libr/util/x509.c" 3 4
__attribute__((visibility("default"))) 
# 635 "project/radare2/libr/util/x509.c"
     void r_x509_validity_json(PJ *pj, RX509Validity *validity) {
 if (validity) {
...
# 646 "project/radare2/libr/util/x509.c" 3 4
__attribute__((visibility("default"))) 
# 646 "project/radare2/libr/util/x509.c"
     void r_x509_name_json(PJ *pj, RX509Name *name) {
 
# 647 "project/radare2/libr/util/x509.c" 3 4
unsigned int 
# 647 "project/radare2/libr/util/x509.c"
     i;
 for (i = 0; i < name->length; i++) {
  if (!name->oids[i] || !name->names[i]) {
   continue;
...
# 656 "project/radare2/libr/util/x509.c" 3 4
__attribute__((visibility("default"))) 
# 656 "project/radare2/libr/util/x509.c"
     void r_x509_subjectpublickeyinfo_json(PJ *pj, RX509SubjectPublicKeyInfo *spki) {
 RASN1String *m = 
# 657 "project/radare2/libr/util/x509.c" 3 4
                 ((void *)0)
# 657 "project/radare2/libr/util/x509.c"
                     ;
 if (spki) {
...
# 679 "project/radare2/libr/util/x509.c" 3 4
__attribute__((visibility("default"))) 
# 679 "project/radare2/libr/util/x509.c"
     void r_x509_extensions_json(PJ *pj, RX509Extensions *exts) {
 if (exts) {
  RASN1String *m = 
# 681 "project/radare2/libr/util/x509.c" 3 4
                  ((void *)0)
# 681 "project/radare2/libr/util/x509.c"
                      ;
  
# 682 "project/radare2/libr/util/x509.c" 3 4
 unsigned int 
# 682 "project/radare2/libr/util/x509.c"
      i;
  pj_a (pj);
  for (i = 0; i < exts->length; i++) {
   RX509Extension *e = exts->extensions[i];
...
# 711 "project/radare2/libr/util/x509.c" 3 4
__attribute__((visibility("default"))) 
# 711 "project/radare2/libr/util/x509.c"
     void r_x509_crlentry_json(PJ *pj, RX509CRLEntry *crle) {
 RASN1String *m = 
# 712 "project/radare2/libr/util/x509.c" 3 4
                 ((void *)0)
# 712 "project/radare2/libr/util/x509.c"
                     ;
 if (crle) {
  if (crle->userCertificate) {
...
# 727 "project/radare2/libr/util/x509.c" 3 4
__attribute__((visibility("default"))) 
# 727 "project/radare2/libr/util/x509.c"
     void r_x509_crl_json(PJ *pj, RX509CertificateRevocationList *crl) {
 
# 728 "project/radare2/libr/util/x509.c" 3 4
unsigned int 
# 728 "project/radare2/libr/util/x509.c"
     i;
 if (crl) {
...
# 752 "project/radare2/libr/util/x509.c" 3 4
__attribute__((visibility("default"))) 
# 752 "project/radare2/libr/util/x509.c"
     void r_x509_tbscertificate_json(PJ *pj, RX509TBSCertificate *tbsc) {
 pj_o (pj);
 RASN1String *m = 
# 754 "project/radare2/libr/util/x509.c" 3 4
                 ((void *)0)
# 754 "project/radare2/libr/util/x509.c"
                     ;
 if (tbsc) {
...
# 798 "project/radare2/libr/util/x509.c" 3 4
__attribute__((visibility("default"))) 
# 798 "project/radare2/libr/util/x509.c"
     void r_x509_certificate_json(PJ *pj, RX509Certificate *certificate) {
 if (!certificate) {
  return;
 }
 RASN1String *m = 
# 802 "project/radare2/libr/util/x509.c" 3 4
                 ((void *)0)
# 802 "project/radare2/libr/util/x509.c"
                     ;
 pj_o (pj);
