# 0 "project/radare2/libr/magic/magic.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 5 "project/radare2/libr/magic/magic.c" 2
...
# 6 "project/radare2/libr/magic/magic.c" 2

__attribute__((visibility("default"))) const char *
# 7 "project/radare2/libr/magic/magic.c"
r_magic_version
# 7 "project/radare2/libr/magic/magic.c" 3 4
(void) { return "" "5.5.4"; }
# 7 "project/radare2/libr/magic/magic.c"
                      ;
# 43 "project/radare2/libr/magic/magic.c"
...
# 44 "project/radare2/libr/magic/magic.c" 2
# 54 "project/radare2/libr/magic/magic.c"
...
static int info_from_stat(RMagic *ms, unsigned short md) {
 ...
 if (
# 81 "project/radare2/libr/magic/magic.c" 3 4
    (((
# 81 "project/radare2/libr/magic/magic.c"
    md
# 81 "project/radare2/libr/magic/magic.c" 3 4
    ) & 0170000) == 0100000)
# 81 "project/radare2/libr/magic/magic.c"
...
# 99 "project/radare2/libr/magic/magic.c" 3 4
_Bool 
# 99 "project/radare2/libr/magic/magic.c"
     ispipe = 
# 99 "project/radare2/libr/magic/magic.c" 3 4
              0
# 99 "project/radare2/libr/magic/magic.c"
 ...
 if (!(buf = malloc (
# 110 "project/radare2/libr/magic/magic.c" 3 4
                    (256 * 1024) 
# 110 "project/radare2/libr/magic/magic.c"
                            + (1 + sizeof(union VALUETYPE))))) {
  return 
# 111 "project/radare2/libr/magic/magic.c" 3 4
        ((void *)0)
# 111 "project/radare2/libr/magic/magic.c"
            ;
 }
 ...
 if (!inname) {
  if (fstat (fd, &sb) == 0 && 
# 125 "project/radare2/libr/magic/magic.c" 3 4
                             (((
# 125 "project/radare2/libr/magic/magic.c"
                             sb.st_mode
# 125 "project/radare2/libr/magic/magic.c" 3 4
                             ) & 0170000) == 0010000)
# 125 "project/radare2/libr/magic/magic.c"
   ...
   ispipe = 
# 126 "project/radare2/libr/magic/magic.c" 3 4
           1
# 126 "project/radare2/libr/magic/magic.c"
               ;
  }
 } else {
  int flags = 
# 129 "project/radare2/libr/magic/magic.c" 3 4
             0x0000
# 129 "project/radare2/libr/magic/magic.c"
                     |
# 129 "project/radare2/libr/magic/magic.c" 3 4
                      0
# 129 "project/radare2/libr/magic/magic.c"
  ...
  if (stat (inname, &sb) == 0 && 
# 131 "project/radare2/libr/magic/magic.c" 3 4
                                (((
# 131 "project/radare2/libr/magic/magic.c"
                                sb.st_mode
# 131 "project/radare2/libr/magic/magic.c" 3 4
                                ) & 0170000) == 0010000)
# 131 "project/radare2/libr/magic/magic.c"
   ...
   flags |= 
# 133 "project/radare2/libr/magic/magic.c" 3 4
           0x00000004
# 133 "project/radare2/libr/magic/magic.c"
                     ;

   ispipe = 
# 135 "project/radare2/libr/magic/magic.c" 3 4
           1
# 135 "project/radare2/libr/magic/magic.c"
               ;
  }
  
# 137 "project/radare2/libr/magic/magic.c" 3 4
 (*__error()) 
# 137 "project/radare2/libr/magic/magic.c"
       = 0;
  if ((fd = open (inname, flags)) < 0) {
   
# 139 "project/radare2/libr/magic/magic.c" 3 4
  fprintf(__stderrp,
# 139 "project/radare2/libr/magic/magic.c"
  "couldn't open file\n"
# 139 "project/radare2/libr/magic/magic.c" 3 4
  )
# 139 "project/radare2/libr/magic/magic.c"
  ...
  if ((flags = fcntl (fd, 
# 147 "project/radare2/libr/magic/magic.c" 3 4
                         3
# 147 "project/radare2/libr/magic/magic.c"
                                )) != -1) {
   flags &= ~
# 148 "project/radare2/libr/magic/magic.c" 3 4
            0x00000004
# 148 "project/radare2/libr/magic/magic.c"
                      ;
   (void)fcntl (fd, 
# 149 "project/radare2/libr/magic/magic.c" 3 4
                   4
# 149 "project/radare2/libr/magic/magic.c"
                          , flags);
  }
 ...
 if (ispipe) {
  ...
  while ((r = read(fd, (void *)&buf[nbytes],
      (size_t)(
# 163 "project/radare2/libr/magic/magic.c" 3 4
              (256 * 1024) 
# 163 "project/radare2/libr/magic/magic.c"
                      - nbytes))) > 0) {
   nbytes += r;
   if (r < 
# 165 "project/radare2/libr/magic/magic.c" 3 4
          512
# 165 "project/radare2/libr/magic/magic.c"
                  ) {
    break;
   }
  }
  ...
  if ((nbytes = read(fd, (char *)buf, 
# 180 "project/radare2/libr/magic/magic.c" 3 4
                                     (256 * 1024)
# 180 "project/radare2/libr/magic/magic.c"
                                            )) == -1) {
   file_error(ms, 
# 181 "project/radare2/libr/magic/magic.c" 3 4
                 (*__error())
# 181 "project/radare2/libr/magic/magic.c"
 ...
 (void)
# 188 "project/radare2/libr/magic/magic.c" 3 4
      __builtin___memset_chk (
# 188 "project/radare2/libr/magic/magic.c"
      buf + nbytes
# 188 "project/radare2/libr/magic/magic.c" 3 4
      , 
# 188 "project/radare2/libr/magic/magic.c"
      0, (1 + sizeof(union VALUETYPE))
# 188 "project/radare2/libr/magic/magic.c" 3 4
...
# 196 "project/radare2/libr/magic/magic.c" 3 4
                                      ((void *)0)
# 196 "project/radare2/libr/magic/magic.c"
                                          ;
}
...
# 202 "project/radare2/libr/magic/magic.c" 3 4
__attribute__((visibility("default"))) 
# 202 "project/radare2/libr/magic/magic.c"
     RMagic* r_magic_new(int flags) {
 RMagic *ms = 
# 203 "project/radare2/libr/magic/magic.c" 3 4
             (
# 203 "project/radare2/libr/magic/magic.c"
             RMagic
# 203 "project/radare2/libr/magic/magic.c" 3 4
             *)calloc(1,sizeof(
# 203 "project/radare2/libr/magic/magic.c"
...
# 203 "project/radare2/libr/magic/magic.c"
 ...
 if (!ms) {
  return 
# 205 "project/radare2/libr/magic/magic.c" 3 4
        ((void *)0)
# 205 "project/radare2/libr/magic/magic.c"
            ;
 }
 r_magic_setflags (ms, flags);
 ms->o.buf = ms->o.pbuf = 
# 208 "project/radare2/libr/magic/magic.c" 3 4
                         ((void *)0)
# 208 "project/radare2/libr/magic/magic.c"
                             ;
 ms->c.li = malloc ((ms->c.len = 10) * sizeof (*ms->c.li));
 if (!ms->c.li) {
  free (ms);
  return 
# 212 "project/radare2/libr/magic/magic.c" 3 4
        ((void *)0)
# 212 "project/radare2/libr/magic/magic.c"
            ;
 }
 file_reset (ms);
 ms->mlist = 
# 215 "project/radare2/libr/magic/magic.c" 3 4
            ((void *)0)
# 215 "project/radare2/libr/magic/magic.c"
                ;
 ms->file = "unknown";
 ms->line = 0;
 return ms;
...
# 221 "project/radare2/libr/magic/magic.c" 3 4
__attribute__((visibility("default"))) 
# 221 "project/radare2/libr/magic/magic.c"
...
# 231 "project/radare2/libr/magic/magic.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 231 "project/radare2/libr/magic/magic.c"
          r_magic_load_buffer(RMagic* ms, const 
# 231 "project/radare2/libr/magic/magic.c" 3 4
                                                unsigned char 
# 231 "project/radare2/libr/magic/magic.c"
                                                    *magicdata, size_t magicdata_size) {
 if (magicdata_size > 0 && *magicdata == '#') {
  struct mlist *ml = file_apprentice (ms, (const char *)magicdata, magicdata_size, 
# 233 "project/radare2/libr/magic/magic.c" 3 4
                                                                                  0
# 233 "project/radare2/libr/magic/magic.c"
                                                                                           );
  if (ml) {
   free_mlist (ms->mlist);
   ms->mlist = ml;
   return 
# 237 "project/radare2/libr/magic/magic.c" 3 4
         1
# 237 "project/radare2/libr/magic/magic.c"
             ;
  }
 } else {
  
# 240 "project/radare2/libr/magic/magic.c" 3 4
 fprintf(__stderrp,
# 240 "project/radare2/libr/magic/magic.c"
...
# 240 "project/radare2/libr/magic/magic.c"
 ...
 return 
# 242 "project/radare2/libr/magic/magic.c" 3 4
       0
# 242 "project/radare2/libr/magic/magic.c"
            ;
}


# 245 "project/radare2/libr/magic/magic.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 245 "project/radare2/libr/magic/magic.c"
          r_magic_load(RMagic* ms, const char *magicfile) {
 struct mlist *ml = file_apprentice (ms, magicfile, strlen (magicfile), 
# 246 "project/radare2/libr/magic/magic.c" 3 4
                                                                       0
# 246 "project/radare2/libr/magic/magic.c"
                                                                                );
 if (ml) {
  free_mlist (ms->mlist);
  ms->mlist = ml;
  return 
# 250 "project/radare2/libr/magic/magic.c" 3 4
        1
# 250 "project/radare2/libr/magic/magic.c"
            ;
 }
 return 
# 252 "project/radare2/libr/magic/magic.c" 3 4
       0
# 252 "project/radare2/libr/magic/magic.c"
            ;
}


# 255 "project/radare2/libr/magic/magic.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 255 "project/radare2/libr/magic/magic.c"
          r_magic_compile(RMagic *ms, const char *magicfile) {
 struct mlist *ml = file_apprentice (ms, magicfile, strlen (magicfile), 
# 256 "project/radare2/libr/magic/magic.c" 3 4
                                                                       2
# 256 "project/radare2/libr/magic/magic.c"
                                                                                   );
 free_mlist (ml);
 return ml != 
# 258 "project/radare2/libr/magic/magic.c" 3 4
             ((void *)0)
# 258 "project/radare2/libr/magic/magic.c"
                 ;
}


# 261 "project/radare2/libr/magic/magic.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 261 "project/radare2/libr/magic/magic.c"
          r_magic_check(RMagic *ms, const char *magicfile) {
 struct mlist *ml = file_apprentice (ms, magicfile, strlen (magicfile), 
# 262 "project/radare2/libr/magic/magic.c" 3 4
                                                                       1
# 262 "project/radare2/libr/magic/magic.c"
                                                                                 );
 free_mlist (ml);
 return ml != 
# 264 "project/radare2/libr/magic/magic.c" 3 4
             ((void *)0)
# 264 "project/radare2/libr/magic/magic.c"
                 ;
}


# 267 "project/radare2/libr/magic/magic.c" 3 4
__attribute__((visibility("default"))) 
# 267 "project/radare2/libr/magic/magic.c"
     const char* r_magic_descriptor(RMagic *ms, int fd) {
 return file_or_fd (ms, 
# 268 "project/radare2/libr/magic/magic.c" 3 4
                       ((void *)0)
# 268 "project/radare2/libr/magic/magic.c"
                           , fd);
}


# 271 "project/radare2/libr/magic/magic.c" 3 4
__attribute__((visibility("default"))) 
# 271 "project/radare2/libr/magic/magic.c"
     const char * r_magic_file(RMagic *ms, const char *inname) {
 return file_or_fd (ms, inname, 0);
}


# 275 "project/radare2/libr/magic/magic.c" 3 4
__attribute__((visibility("default"))) 
# 275 "project/radare2/libr/magic/magic.c"
     const char * r_magic_buffer(RMagic *ms, const void *buf, size_t nb) {
 if (file_reset (ms) == -1) {
  return 
# 277 "project/radare2/libr/magic/magic.c" 3 4
        ((void *)0)
# 277 "project/radare2/libr/magic/magic.c"
            ;
 }
 if (file_buffer (ms, -1, 
# 279 "project/radare2/libr/magic/magic.c" 3 4
                         ((void *)0)
# 279 "project/radare2/libr/magic/magic.c"
                             , buf, nb) == -1) {
  return 
# 280 "project/radare2/libr/magic/magic.c" 3 4
        ((void *)0)
# 280 "project/radare2/libr/magic/magic.c"
            ;
 }
...
# 285 "project/radare2/libr/magic/magic.c" 3 4
__attribute__((visibility("default"))) 
# 285 "project/radare2/libr/magic/magic.c"
     const char *r_magic_error(RMagic *ms) {
 if (ms && ms->haderr) {
  return ms->o.buf;
 }
 return 
# 289 "project/radare2/libr/magic/magic.c" 3 4
       ((void *)0)
# 289 "project/radare2/libr/magic/magic.c"
           ;
}


# 292 "project/radare2/libr/magic/magic.c" 3 4
__attribute__((visibility("default"))) 
# 292 "project/radare2/libr/magic/magic.c"
...
# 299 "project/radare2/libr/magic/magic.c" 3 4
__attribute__((visibility("default"))) 
# 299 "project/radare2/libr/magic/magic.c"
