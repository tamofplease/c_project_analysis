# 0 "project/radare2/libr/magic/fsmagic.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/magic/fsmagic.c"
# 33 "project/radare2/libr/magic/fsmagic.c"
...
# 34 "project/radare2/libr/magic/fsmagic.c" 2
...
# 38 "project/radare2/libr/magic/fsmagic.c" 2
...
# 39 "project/radare2/libr/magic/fsmagic.c" 2
# 61 "project/radare2/libr/magic/fsmagic.c"
static int bad_link(RMagic *ms, int err, char *buf) {

 const char *errfmt = (err == 
# 63 "project/radare2/libr/magic/fsmagic.c" 3 4
                             62
# 63 "project/radare2/libr/magic/fsmagic.c"
                                  )?
 ...
 if (ms->flags & 
# 69 "project/radare2/libr/magic/fsmagic.c" 3 4
                0x000200
# 69 "project/radare2/libr/magic/fsmagic.c"
                             ) {
...
int file_fsmagic(struct r_magic_set *ms, const char *fn, struct stat *sb) {
 int ret = 0;
 int mime = ms->flags & 
# 80 "project/radare2/libr/magic/fsmagic.c" 3 4
                       (0x000010|0x000400)
# 80 "project/radare2/libr/magic/fsmagic.c"
                                   ;

 char buf[
# 82 "project/radare2/libr/magic/fsmagic.c" 3 4
         1024
# 82 "project/radare2/libr/magic/fsmagic.c"
               +4];
 int nch;
 ...
 if ((ms->flags & 
# 93 "project/radare2/libr/magic/fsmagic.c" 3 4
                 0x000002
# 93 "project/radare2/libr/magic/fsmagic.c"
                                ) == 0)
  ret = lstat (fn, sb);
 else
 ...
 if (ret) {
  if (ms->flags & 
# 100 "project/radare2/libr/magic/fsmagic.c" 3 4
                 0x000200
# 100 "project/radare2/libr/magic/fsmagic.c"
                              ) {
   file_error (ms, 
# 101 "project/radare2/libr/magic/fsmagic.c" 3 4
                  (*__error())
# 101 "project/radare2/libr/magic/fsmagic.c"
                       , "cannot stat `%s'", fn);
   return -1;
  }
  if (file_printf (ms, "cannot open `%s' (%s)",
      fn, strerror (
# 105 "project/radare2/libr/magic/fsmagic.c" 3 4
                   (*__error())
# 105 "project/radare2/libr/magic/fsmagic.c"
                        )) == -1)
   return -1;
  return 1;
 }
 ...
 if (mime) {
  if ((sb->st_mode & 
# 111 "project/radare2/libr/magic/fsmagic.c" 3 4
                    0170000
# 111 "project/radare2/libr/magic/fsmagic.c"
                          ) != 
# 111 "project/radare2/libr/magic/fsmagic.c" 3 4
                               0100000
# 111 "project/radare2/libr/magic/fsmagic.c"
   ...
   if ((mime & 
# 112 "project/radare2/libr/magic/fsmagic.c" 3 4
              0x000010
# 112 "project/radare2/libr/magic/fsmagic.c"
                               ) &&
  ...
  if (sb->st_mode & 
# 120 "project/radare2/libr/magic/fsmagic.c" 3 4
                   0004000
# 120 "project/radare2/libr/magic/fsmagic.c"
                          )
  ...
  if (sb->st_mode & 
# 125 "project/radare2/libr/magic/fsmagic.c" 3 4
                   0002000
# 125 "project/radare2/libr/magic/fsmagic.c"
                          )
  ...
  if (sb->st_mode & 
# 130 "project/radare2/libr/magic/fsmagic.c" 3 4
                   0001000
# 130 "project/radare2/libr/magic/fsmagic.c"
                          )
 ...
 switch (sb->st_mode & 
# 136 "project/radare2/libr/magic/fsmagic.c" 3 4
                      0170000
# 136 "project/radare2/libr/magic/fsmagic.c"
                            ) {
 case 
# 137 "project/radare2/libr/magic/fsmagic.c" 3 4
     0040000
# 137 "project/radare2/libr/magic/fsmagic.c"
            :
 ...
 case 
# 142 "project/radare2/libr/magic/fsmagic.c" 3 4
     0020000
# 142 "project/radare2/libr/magic/fsmagic.c"
            :
  ...
  if ((ms->flags & 
# 148 "project/radare2/libr/magic/fsmagic.c" 3 4
                  0x000008
# 148 "project/radare2/libr/magic/fsmagic.c"
                                 ) != 0)
   break;
# 162 "project/radare2/libr/magic/fsmagic.c"
 ...
 case 
# 168 "project/radare2/libr/magic/fsmagic.c" 3 4
     0060000
# 168 "project/radare2/libr/magic/fsmagic.c"
            :
  ...
  if ((ms->flags & 
# 174 "project/radare2/libr/magic/fsmagic.c" 3 4
                  0x000008
# 174 "project/radare2/libr/magic/fsmagic.c"
                                 ) != 0)
   break;
# 188 "project/radare2/libr/magic/fsmagic.c"
 ...
 case 
# 195 "project/radare2/libr/magic/fsmagic.c" 3 4
     0010000
# 195 "project/radare2/libr/magic/fsmagic.c"
            :
  if((ms->flags & 
# 196 "project/radare2/libr/magic/fsmagic.c" 3 4
                 0x000008
# 196 "project/radare2/libr/magic/fsmagic.c"
                                ) != 0)
   break;
 ...
 case 
# 207 "project/radare2/libr/magic/fsmagic.c" 3 4
     0120000
# 207 "project/radare2/libr/magic/fsmagic.c"
            :
  if ((nch = readlink (fn, buf, 
# 208 "project/radare2/libr/magic/fsmagic.c" 3 4
                               1024
# 208 "project/radare2/libr/magic/fsmagic.c"
                                     -1)) <= 0) {
   if (ms->flags & 
# 209 "project/radare2/libr/magic/fsmagic.c" 3 4
                  0x000200
# 209 "project/radare2/libr/magic/fsmagic.c"
                               ) {
       file_error (ms, 
# 210 "project/radare2/libr/magic/fsmagic.c" 3 4
                      (*__error())
# 210 "project/radare2/libr/magic/fsmagic.c"
                           , "unreadable symlink `%s'", fn);
       return -1;
   }
   if (file_printf(ms,
       "unreadable symlink `%s' (%s)", fn,
       strerror(
# 215 "project/radare2/libr/magic/fsmagic.c" 3 4
               (*__error())
# 215 "project/radare2/libr/magic/fsmagic.c"
                    )) == -1)
    return -1;
   return 1;
  }
  ...
  if (*buf == '/') {
   if (stat(buf, &tstatbuf) < 0)
    return bad_link(ms, 
# 224 "project/radare2/libr/magic/fsmagic.c" 3 4
                       (*__error())
# 224 "project/radare2/libr/magic/fsmagic.c"
                            , buf);
  } else {
   char *tmp;
   char buf2[
# 227 "project/radare2/libr/magic/fsmagic.c" 3 4
            1024
# 227 "project/radare2/libr/magic/fsmagic.c"
                  +
# 227 "project/radare2/libr/magic/fsmagic.c" 3 4
                   1024
# 227 "project/radare2/libr/magic/fsmagic.c"
   ...
   if (!(tmp = strrchr(fn, '/'))) {
    ...
    if (tmp - fn + 1 > 
# 232 "project/radare2/libr/magic/fsmagic.c" 3 4
                      1024
# 232 "project/radare2/libr/magic/fsmagic.c"
                            ) {
     if (ms->flags & 
# 233 "project/radare2/libr/magic/fsmagic.c" 3 4
                    0x000200
# 233 "project/radare2/libr/magic/fsmagic.c"
                                 ) {
...
# 241 "project/radare2/libr/magic/fsmagic.c" 3 4
   __builtin___snprintf_chk (
# 241 "project/radare2/libr/magic/fsmagic.c"
   buf2
# 241 "project/radare2/libr/magic/fsmagic.c" 3 4
   , 
# 241 "project/radare2/libr/magic/fsmagic.c"
...
# 241 "project/radare2/libr/magic/fsmagic.c"
   ...
   if (stat (tmp, &tstatbuf) < 0)
    return bad_link(ms, 
# 245 "project/radare2/libr/magic/fsmagic.c" 3 4
                       (*__error())
# 245 "project/radare2/libr/magic/fsmagic.c"
                            , buf);
  }


  if ((ms->flags & 
# 249 "project/radare2/libr/magic/fsmagic.c" 3 4
                  0x000002
# 249 "project/radare2/libr/magic/fsmagic.c"
                                 ) != 0) {
   const char *p;
   ms->flags &= 
# 251 "project/radare2/libr/magic/fsmagic.c" 3 4
               0x000002
# 251 "project/radare2/libr/magic/fsmagic.c"
                              ;
   p = r_magic_file(ms, buf);
   ms->flags |= 
# 253 "project/radare2/libr/magic/fsmagic.c" 3 4
               0x000002
# 253 "project/radare2/libr/magic/fsmagic.c"
                              ;
   return p != 
# 254 "project/radare2/libr/magic/fsmagic.c" 3 4
              ((void *)0) 
# 254 "project/radare2/libr/magic/fsmagic.c"
                   ? 1 : -1;
  } else {
 ...
 return 1;
# 269 "project/radare2/libr/magic/fsmagic.c"
 case 
# 269 "project/radare2/libr/magic/fsmagic.c" 3 4
     0100000
# 269 "project/radare2/libr/magic/fsmagic.c"
            :
  break;
...
# 288 "project/radare2/libr/magic/fsmagic.c"
 if ((ms->flags & 
# 288 "project/radare2/libr/magic/fsmagic.c" 3 4
                 0x000008
# 288 "project/radare2/libr/magic/fsmagic.c"
                                ) == 0 && sb->st_size == 0) {
  if ((!mime || (mime & 
# 289 "project/radare2/libr/magic/fsmagic.c" 3 4
                       0x000010
# 289 "project/radare2/libr/magic/fsmagic.c"
                                        )) &&
