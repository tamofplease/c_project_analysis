# 0 "project/radare2/libr/magic/softmagic.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 33 "project/radare2/libr/magic/softmagic.c" 2
...
typedef int RRef;
# 7 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_magic.h" 2 3 4
...
# 44 "project/radare2/libr/magic/file.h" 2
...
# 45 "project/radare2/libr/magic/file.h" 2
...
# 37 "project/radare2/libr/magic/softmagic.c" 2
...
# 42 "project/radare2/libr/magic/softmagic.c" 2


# 43 "project/radare2/libr/magic/softmagic.c"
static int match(RMagic *, struct r_magic *, 
# 43 "project/radare2/libr/magic/softmagic.c" 3 4
                                            unsigned int
# 43 "project/radare2/libr/magic/softmagic.c"
                                                ,
    const 
# 44 "project/radare2/libr/magic/softmagic.c" 3 4
         unsigned char 
# 44 "project/radare2/libr/magic/softmagic.c"
             *, size_t, int);
static int mget(RMagic *, const 
# 45 "project/radare2/libr/magic/softmagic.c" 3 4
                               unsigned char 
# 45 "project/radare2/libr/magic/softmagic.c"
                                   *,
    struct r_magic *, size_t, unsigned int);
static int magiccheck(RMagic *, struct r_magic *);
static 
# 48 "project/radare2/libr/magic/softmagic.c" 3 4
      int 
# 48 "project/radare2/libr/magic/softmagic.c"
           mprint(RMagic *, struct r_magic *);
static void mdebug(
# 49 "project/radare2/libr/magic/softmagic.c" 3 4
                  unsigned int
# 49 "project/radare2/libr/magic/softmagic.c"
                      , const char *, size_t);
static int mcopy(RMagic *, union VALUETYPE *, int, int,
    const 
# 51 "project/radare2/libr/magic/softmagic.c" 3 4
         unsigned char 
# 51 "project/radare2/libr/magic/softmagic.c"
             *, 
# 51 "project/radare2/libr/magic/softmagic.c" 3 4
                unsigned int
# 51 "project/radare2/libr/magic/softmagic.c"
...
# 70 "project/radare2/libr/magic/softmagic.c"
int file_softmagic(RMagic *ms, const 
# 70 "project/radare2/libr/magic/softmagic.c" 3 4
                                    unsigned char 
# 70 "project/radare2/libr/magic/softmagic.c"
                                        *buf, size_t nbytes, int mode) {
 struct mlist *ml;
 int rv;
...
static int match(RMagic *ms, struct r_magic *magic, 
# 108 "project/radare2/libr/magic/softmagic.c" 3 4
                                                   unsigned int 
# 108 "project/radare2/libr/magic/softmagic.c"
                                                        nmagic, const 
# 108 "project/radare2/libr/magic/softmagic.c" 3 4
                                                                      unsigned char 
# 108 "project/radare2/libr/magic/softmagic.c"
                                                                          *s, size_t nbytes, int mode) {
 
# 109 "project/radare2/libr/magic/softmagic.c" 3 4
unsigned int 
# 109 "project/radare2/libr/magic/softmagic.c"
     magindex = 0;
 ...
 for (magindex = 0; magindex < nmagic; magindex++) {
  ...
  if ((m->flag & 
# 123 "project/radare2/libr/magic/softmagic.c" 3 4
                0x20
# 123 "project/radare2/libr/magic/softmagic.c"
                       ) != mode) {
  ...
  if (*((ms->flags & 
# 164 "project/radare2/libr/magic/softmagic.c" 3 4
      (0x000010|0x000400)
# 164 "project/radare2/libr/magic/softmagic.c"
      ) ? m->mimetype : m->desc)) {
   need_separator = 1;
   printed_something = 1;
  ...
  while (++magindex < nmagic - 1 && magic[magindex].cont_level != 0) {
   ...
   ms->offset = m->offset;
   if (m->flag & 
# 196 "project/radare2/libr/magic/softmagic.c" 3 4
                0x02
# 196 "project/radare2/libr/magic/softmagic.c"
                      ) {
    ms->offset += ms->c.li[cont_level - 1].off;
   }

   if (m->cond == 
# 200 "project/radare2/libr/magic/softmagic.c" 3 4
                 3 
# 200 "project/radare2/libr/magic/softmagic.c"
                           || m->cond == 
# 200 "project/radare2/libr/magic/softmagic.c" 3 4
                                         2
# 200 "project/radare2/libr/magic/softmagic.c"
   ...
   default:
    ...
    if (m->type != 
# 218 "project/radare2/libr/magic/softmagic.c" 3 4
                  3
# 218 "project/radare2/libr/magic/softmagic.c"
                              ) {
    ...
    if (*((ms->flags & 
# 228 "project/radare2/libr/magic/softmagic.c" 3 4
        (0x000010|0x000400)
# 228 "project/radare2/libr/magic/softmagic.c"
        ) ? m->mimetype : m->desc)) {
     printed_something = 1;
     if (print_sep (ms, firstline) == -1) {
      return -1;
    ...
    if (need_separator
        && ((m->flag & 
# 242 "project/radare2/libr/magic/softmagic.c" 3 4
                      0x10
# 242 "project/radare2/libr/magic/softmagic.c"
                             ) == 0)
        && *((ms->flags & 
# 243 "project/radare2/libr/magic/softmagic.c" 3 4
           (0x000010|0x000400)
# 243 "project/radare2/libr/magic/softmagic.c"
           ) ? m->mimetype : m->desc)) {
     if (file_printf (ms, " ") == -1) {
      return -1;
     }
    ...
    if (*((ms->flags & 
# 252 "project/radare2/libr/magic/softmagic.c" 3 4
        (0x000010|0x000400)
# 252 "project/radare2/libr/magic/softmagic.c"
        ) ? m->mimetype : m->desc)) {
     need_separator = 1;
    }
  ...
  if ((ms->flags & 
# 271 "project/radare2/libr/magic/softmagic.c" 3 4
                  0x000020
# 271 "project/radare2/libr/magic/softmagic.c"
                                  ) == 0 && printed_something) {
   return 1;
  }
 }
...
static int check_fmt(RMagic *ms, struct r_magic *m) {
 ...
 if (!strchr (((ms->flags & 
# 282 "project/radare2/libr/magic/softmagic.c" 3 4
             (0x000010|0x000400)
# 282 "project/radare2/libr/magic/softmagic.c"
             ) ? m->mimetype : m->desc), '%')) {
  return 0;
 }

 rc = r_regex_init (&rx, "%[-0-9\\.]*s", 
# 286 "project/radare2/libr/magic/softmagic.c" 3 4
                                        0001
# 286 "project/radare2/libr/magic/softmagic.c"
                                                        |
# 286 "project/radare2/libr/magic/softmagic.c" 3 4
                                                         0004
# 286 "project/radare2/libr/magic/softmagic.c"
 ...
 if (rc) {
  ...
  rc = r_regex_exec (&rx, ((ms->flags & 
# 293 "project/radare2/libr/magic/softmagic.c" 3 4
                         (0x000010|0x000400)
# 293 "project/radare2/libr/magic/softmagic.c"
                         ) ? m->mimetype : m->desc), 0, 0, 0);
  r_regex_fini (&rx);
  return !rc;
 }
}
...
char * strdupn(const char *str, size_t n) {
 ...
 if (!(copy = malloc (len + 1))) {
  return 
# 305 "project/radare2/libr/magic/softmagic.c" 3 4
        ((void *)0)
# 305 "project/radare2/libr/magic/softmagic.c"
            ;
 }
 (void)
# 307 "project/radare2/libr/magic/softmagic.c" 3 4
      __builtin___memcpy_chk (
# 307 "project/radare2/libr/magic/softmagic.c"
      copy
# 307 "project/radare2/libr/magic/softmagic.c" 3 4
      , 
# 307 "project/radare2/libr/magic/softmagic.c"
...
static 
# 312 "project/radare2/libr/magic/softmagic.c" 3 4
      int 
# 312 "project/radare2/libr/magic/softmagic.c"
           mprint(RMagic *ms, struct r_magic *m) {
 
# 313 "project/radare2/libr/magic/softmagic.c" 3 4
unsigned long long 
# 313 "project/radare2/libr/magic/softmagic.c"
     v;
 float vf;
 double vd;
 
# 316 "project/radare2/libr/magic/softmagic.c" 3 4
unsigned long long 
# 316 "project/radare2/libr/magic/softmagic.c"
     t = 0;
  char *buf = 
# 317 "project/radare2/libr/magic/softmagic.c" 3 4
             ((void *)0)
# 317 "project/radare2/libr/magic/softmagic.c"
                 ;
 union VALUETYPE *p = &ms->ms_value;
 char pp[
# 319 "project/radare2/libr/magic/softmagic.c" 3 4
        (26)
# 319 "project/radare2/libr/magic/softmagic.c"
                          ];

   switch (m->type) {
   case 
# 322 "project/radare2/libr/magic/softmagic.c" 3 4
       1
# 322 "project/radare2/libr/magic/softmagic.c"
                :
  v = file_signextend(ms, m, (
# 323 "project/radare2/libr/magic/softmagic.c" 3 4
                             unsigned long long
# 323 "project/radare2/libr/magic/softmagic.c"
                                 )p->b);
  ...
  case 1:
   buf = malloc (2);
   if (
# 329 "project/radare2/libr/magic/softmagic.c" 3 4
      __builtin___snprintf_chk (
# 329 "project/radare2/libr/magic/softmagic.c"
      buf
# 329 "project/radare2/libr/magic/softmagic.c" 3 4
      , 
# 329 "project/radare2/libr/magic/softmagic.c"
...
# 329 "project/radare2/libr/magic/softmagic.c"
   ...
   if (file_printf (ms, ((ms->flags & 
# 333 "project/radare2/libr/magic/softmagic.c" 3 4
                       (0x000010|0x000400)
# 333 "project/radare2/libr/magic/softmagic.c"
                       ) ? m->mimetype : m->desc), buf) == -1) {
    free (buf);
    return -1;
   }
   break;
  default:
   if (file_printf (ms, ((ms->flags & 
# 339 "project/radare2/libr/magic/softmagic.c" 3 4
                       (0x000010|0x000400)
# 339 "project/radare2/libr/magic/softmagic.c"
                       ) ? m->mimetype : m->desc), (
# 339 "project/radare2/libr/magic/softmagic.c" 3 4
                                      unsigned char
# 339 "project/radare2/libr/magic/softmagic.c"
  ...
  break;
   case 
# 346 "project/radare2/libr/magic/softmagic.c" 3 4
       2
# 346 "project/radare2/libr/magic/softmagic.c"
                 :
   case 
# 347 "project/radare2/libr/magic/softmagic.c" 3 4
       7
# 347 "project/radare2/libr/magic/softmagic.c"
                   :
   case 
# 348 "project/radare2/libr/magic/softmagic.c" 3 4
       10
# 348 "project/radare2/libr/magic/softmagic.c"
                   :
  v = file_signextend (ms, m, (
# 349 "project/radare2/libr/magic/softmagic.c" 3 4
                              unsigned long long
# 349 "project/radare2/libr/magic/softmagic.c"
                                  )p->h);
  switch (check_fmt (ms, m)) {
  case -1:
   return -1;
  case 1:
   buf = malloc (32);
   if (
# 355 "project/radare2/libr/magic/softmagic.c" 3 4
      __builtin___snprintf_chk (
# 355 "project/radare2/libr/magic/softmagic.c"
      buf
# 355 "project/radare2/libr/magic/softmagic.c" 3 4
      , 
# 355 "project/radare2/libr/magic/softmagic.c"
...
# 355 "project/radare2/libr/magic/softmagic.c"
   ...
   if (file_printf(ms, ((ms->flags & 
# 359 "project/radare2/libr/magic/softmagic.c" 3 4
                      (0x000010|0x000400)
# 359 "project/radare2/libr/magic/softmagic.c"
                      ) ? m->mimetype : m->desc), buf) == -1) {
    free (buf);
    return -1;
   }
  ...
  default:
   if (file_printf (ms, ((ms->flags & 
# 365 "project/radare2/libr/magic/softmagic.c" 3 4
                       (0x000010|0x000400)
# 365 "project/radare2/libr/magic/softmagic.c"
                       ) ? m->mimetype : m->desc), (unsigned short)v) == -1) {
    return -1;
   }
   break;
  }
  ...
  break;
   case 
# 372 "project/radare2/libr/magic/softmagic.c" 3 4
       4
# 372 "project/radare2/libr/magic/softmagic.c"
                :
   case 
# 373 "project/radare2/libr/magic/softmagic.c" 3 4
       8
# 373 "project/radare2/libr/magic/softmagic.c"
                  :
   case 
# 374 "project/radare2/libr/magic/softmagic.c" 3 4
       11
# 374 "project/radare2/libr/magic/softmagic.c"
                  :
   case 
# 375 "project/radare2/libr/magic/softmagic.c" 3 4
       23
# 375 "project/radare2/libr/magic/softmagic.c"
                  :
  v = file_signextend(ms, m, (
# 376 "project/radare2/libr/magic/softmagic.c" 3 4
                             unsigned long long
# 376 "project/radare2/libr/magic/softmagic.c"
                                 )p->l);
  switch (check_fmt(ms, m)) {
  case -1:
   return -1;
  case 1:
   buf = malloc (32);
   if (
# 382 "project/radare2/libr/magic/softmagic.c" 3 4
      __builtin___snprintf_chk (
# 382 "project/radare2/libr/magic/softmagic.c"
      buf
# 382 "project/radare2/libr/magic/softmagic.c" 3 4
      , 
# 382 "project/radare2/libr/magic/softmagic.c"
...
# 382 "project/radare2/libr/magic/softmagic.c"
   ...
   if (file_printf(ms, ((ms->flags & 
# 386 "project/radare2/libr/magic/softmagic.c" 3 4
                      (0x000010|0x000400)
# 386 "project/radare2/libr/magic/softmagic.c"
                      ) ? m->mimetype : m->desc), buf) == -1) {
    free (buf);
    return -1;
   }
  ...
  default:
   if (file_printf (ms, ((ms->flags & 
# 392 "project/radare2/libr/magic/softmagic.c" 3 4
                       (0x000010|0x000400)
# 392 "project/radare2/libr/magic/softmagic.c"
                       ) ? m->mimetype : m->desc), (
# 392 "project/radare2/libr/magic/softmagic.c" 3 4
                                      unsigned int
# 392 "project/radare2/libr/magic/softmagic.c"
  ...
  t = ms->offset + sizeof(
# 397 "project/radare2/libr/magic/softmagic.c" 3 4
                         int
# 397 "project/radare2/libr/magic/softmagic.c"
                             );
    break;
   case 
# 399 "project/radare2/libr/magic/softmagic.c" 3 4
       24
# 399 "project/radare2/libr/magic/softmagic.c"
                :
   case 
# 400 "project/radare2/libr/magic/softmagic.c" 3 4
       26
# 400 "project/radare2/libr/magic/softmagic.c"
                  :
   case 
# 401 "project/radare2/libr/magic/softmagic.c" 3 4
       25
# 401 "project/radare2/libr/magic/softmagic.c"
                  :
  v = file_signextend(ms, m, p->q);
  if (file_printf (ms, ((ms->flags & 
# 403 "project/radare2/libr/magic/softmagic.c" 3 4
                      (0x000010|0x000400)
# 403 "project/radare2/libr/magic/softmagic.c"
                      ) ? m->mimetype : m->desc), (
# 403 "project/radare2/libr/magic/softmagic.c" 3 4
                                     unsigned long long
# 403 "project/radare2/libr/magic/softmagic.c"
  ...
  t = ms->offset + sizeof(
# 406 "project/radare2/libr/magic/softmagic.c" 3 4
                         unsigned long long
# 406 "project/radare2/libr/magic/softmagic.c"
                             );
    break;

   case 
# 409 "project/radare2/libr/magic/softmagic.c" 3 4
       5
# 409 "project/radare2/libr/magic/softmagic.c"
                  :
   case 
# 410 "project/radare2/libr/magic/softmagic.c" 3 4
       13
# 410 "project/radare2/libr/magic/softmagic.c"
                   :
   case 
# 411 "project/radare2/libr/magic/softmagic.c" 3 4
       18
# 411 "project/radare2/libr/magic/softmagic.c"
                      :
   case 
# 412 "project/radare2/libr/magic/softmagic.c" 3 4
       19
# 412 "project/radare2/libr/magic/softmagic.c"
                      :
  if (m->reln == '=' || m->reln == '!') {
   if (file_printf (ms, ((ms->flags & 
# 414 "project/radare2/libr/magic/softmagic.c" 3 4
                       (0x000010|0x000400)
# 414 "project/radare2/libr/magic/softmagic.c"
                       ) ? m->mimetype : m->desc), m->value.s) == -1) {
    return -1;
   }
   ...
   if (file_printf (ms, ((ms->flags & 
# 423 "project/radare2/libr/magic/softmagic.c" 3 4
                       (0x000010|0x000400)
# 423 "project/radare2/libr/magic/softmagic.c"
                       ) ? m->mimetype : m->desc), p->s) == -1) {
    return -1;
   }
   t = ms->offset + strlen (p->s);
   if (m->type == 
# 427 "project/radare2/libr/magic/softmagic.c" 3 4
                 13
# 427 "project/radare2/libr/magic/softmagic.c"
                             ) {
    t++;
   }
  }
  break;
 case 
# 432 "project/radare2/libr/magic/softmagic.c" 3 4
     6
# 432 "project/radare2/libr/magic/softmagic.c"
              :
 case 
# 433 "project/radare2/libr/magic/softmagic.c" 3 4
     9
# 433 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 434 "project/radare2/libr/magic/softmagic.c" 3 4
     12
# 434 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 435 "project/radare2/libr/magic/softmagic.c" 3 4
     21
# 435 "project/radare2/libr/magic/softmagic.c"
                :
  if (file_printf (ms, ((ms->flags & 
# 436 "project/radare2/libr/magic/softmagic.c" 3 4
                      (0x000010|0x000400)
# 436 "project/radare2/libr/magic/softmagic.c"
                      ) ? m->mimetype : m->desc), file_fmttime (p->l, 1, pp)) == -1) {
   return -1;
  }
  t = ms->offset + sizeof(time_t);
  break;
 case 
# 441 "project/radare2/libr/magic/softmagic.c" 3 4
     14
# 441 "project/radare2/libr/magic/softmagic.c"
               :
 case 
# 442 "project/radare2/libr/magic/softmagic.c" 3 4
     15
# 442 "project/radare2/libr/magic/softmagic.c"
                 :
 case 
# 443 "project/radare2/libr/magic/softmagic.c" 3 4
     16
# 443 "project/radare2/libr/magic/softmagic.c"
                 :
 case 
# 444 "project/radare2/libr/magic/softmagic.c" 3 4
     22
# 444 "project/radare2/libr/magic/softmagic.c"
                 :
  if (file_printf (ms, ((ms->flags & 
# 445 "project/radare2/libr/magic/softmagic.c" 3 4
                      (0x000010|0x000400)
# 445 "project/radare2/libr/magic/softmagic.c"
                      ) ? m->mimetype : m->desc), file_fmttime (p->l, 0, pp)) == -1) {
   return -1;
  }
  t = ms->offset + sizeof(time_t);
  break;
 case 
# 450 "project/radare2/libr/magic/softmagic.c" 3 4
     27
# 450 "project/radare2/libr/magic/softmagic.c"
               :
 case 
# 451 "project/radare2/libr/magic/softmagic.c" 3 4
     29
# 451 "project/radare2/libr/magic/softmagic.c"
                 :
 case 
# 452 "project/radare2/libr/magic/softmagic.c" 3 4
     28
# 452 "project/radare2/libr/magic/softmagic.c"
                 :
  if (file_printf (ms, ((ms->flags & 
# 453 "project/radare2/libr/magic/softmagic.c" 3 4
                      (0x000010|0x000400)
# 453 "project/radare2/libr/magic/softmagic.c"
                      ) ? m->mimetype : m->desc), file_fmttime ((
# 453 "project/radare2/libr/magic/softmagic.c" 3 4
                                                   unsigned int
# 453 "project/radare2/libr/magic/softmagic.c"
                                                       )p->q, 1, pp)) == -1) {
  ...
  t = ms->offset + sizeof(
# 456 "project/radare2/libr/magic/softmagic.c" 3 4
                         unsigned long long
# 456 "project/radare2/libr/magic/softmagic.c"
                             );
  break;
 case 
# 458 "project/radare2/libr/magic/softmagic.c" 3 4
     30
# 458 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 459 "project/radare2/libr/magic/softmagic.c" 3 4
     32
# 459 "project/radare2/libr/magic/softmagic.c"
                  :
 case 
# 460 "project/radare2/libr/magic/softmagic.c" 3 4
     31
# 460 "project/radare2/libr/magic/softmagic.c"
                  :
  if (file_printf (ms, ((ms->flags & 
# 461 "project/radare2/libr/magic/softmagic.c" 3 4
                      (0x000010|0x000400)
# 461 "project/radare2/libr/magic/softmagic.c"
                      ) ? m->mimetype : m->desc), file_fmttime ((
# 461 "project/radare2/libr/magic/softmagic.c" 3 4
                                                   unsigned int
# 461 "project/radare2/libr/magic/softmagic.c"
  ...
  t = ms->offset + sizeof(
# 464 "project/radare2/libr/magic/softmagic.c" 3 4
                         unsigned long long
# 464 "project/radare2/libr/magic/softmagic.c"
                             );
  break;
   case 
# 466 "project/radare2/libr/magic/softmagic.c" 3 4
       33
# 466 "project/radare2/libr/magic/softmagic.c"
                 :
   case 
# 467 "project/radare2/libr/magic/softmagic.c" 3 4
       34
# 467 "project/radare2/libr/magic/softmagic.c"
                   :
   case 
# 468 "project/radare2/libr/magic/softmagic.c" 3 4
       35
# 468 "project/radare2/libr/magic/softmagic.c"
                   :
  vf = p->f;
  switch (check_fmt(ms, m)) {
  case -1:
  ...
  case 1:
   buf = malloc (32);
   if (
# 475 "project/radare2/libr/magic/softmagic.c" 3 4
      __builtin___snprintf_chk (
# 475 "project/radare2/libr/magic/softmagic.c"
      buf
# 475 "project/radare2/libr/magic/softmagic.c" 3 4
      , 
# 475 "project/radare2/libr/magic/softmagic.c"
...
# 475 "project/radare2/libr/magic/softmagic.c"
   ...
   if (file_printf (ms, ((ms->flags & 
# 479 "project/radare2/libr/magic/softmagic.c" 3 4
                       (0x000010|0x000400)
# 479 "project/radare2/libr/magic/softmagic.c"
                       ) ? m->mimetype : m->desc), buf) == -1) {
    free (buf);
    return -1;
   }
  ...
  default:
   if (file_printf (ms, ((ms->flags & 
# 485 "project/radare2/libr/magic/softmagic.c" 3 4
                       (0x000010|0x000400)
# 485 "project/radare2/libr/magic/softmagic.c"
                       ) ? m->mimetype : m->desc), vf) == -1) {
    return -1;
   }
   break;
  }
  t = ms->offset + sizeof(float);
    break;
   case 
# 492 "project/radare2/libr/magic/softmagic.c" 3 4
       36
# 492 "project/radare2/libr/magic/softmagic.c"
                  :
   case 
# 493 "project/radare2/libr/magic/softmagic.c" 3 4
       37
# 493 "project/radare2/libr/magic/softmagic.c"
                    :
   case 
# 494 "project/radare2/libr/magic/softmagic.c" 3 4
       38
# 494 "project/radare2/libr/magic/softmagic.c"
                    :
  vd = p->d;
  switch (check_fmt(ms, m)) {
  case -1:
  ...
  case 1:
   buf = malloc (32);
   if (
# 501 "project/radare2/libr/magic/softmagic.c" 3 4
      __builtin___snprintf_chk (
# 501 "project/radare2/libr/magic/softmagic.c"
      buf
# 501 "project/radare2/libr/magic/softmagic.c" 3 4
      , 
# 501 "project/radare2/libr/magic/softmagic.c"
...
# 501 "project/radare2/libr/magic/softmagic.c"
   ...
   if (file_printf (ms, ((ms->flags & 
# 505 "project/radare2/libr/magic/softmagic.c" 3 4
                       (0x000010|0x000400)
# 505 "project/radare2/libr/magic/softmagic.c"
                       ) ? m->mimetype : m->desc), buf) == -1) {
    free (buf);
    return -1;
   }
  ...
  default:
   if (file_printf (ms, ((ms->flags & 
# 511 "project/radare2/libr/magic/softmagic.c" 3 4
                       (0x000010|0x000400)
# 511 "project/radare2/libr/magic/softmagic.c"
                       ) ? m->mimetype : m->desc), vd) == -1) {
    return -1;
   }
   break;
  }
  t = ms->offset + sizeof(double);
    break;
 case 
# 518 "project/radare2/libr/magic/softmagic.c" 3 4
     17
# 518 "project/radare2/libr/magic/softmagic.c"
               : {
  char *cp;
  int rval;
  ...
  rval = file_printf(ms, ((ms->flags & 
# 527 "project/radare2/libr/magic/softmagic.c" 3 4
                        (0x000010|0x000400)
# 527 "project/radare2/libr/magic/softmagic.c"
                        ) ? m->mimetype : m->desc), cp);
  free(cp);
  ...
  if ((m->
# 534 "project/radare2/libr/magic/softmagic.c" 3 4
         _u._s._flags 
# 534 "project/radare2/libr/magic/softmagic.c"
                   & 
# 534 "project/radare2/libr/magic/softmagic.c" 3 4
                     (1 << (4))
# 534 "project/radare2/libr/magic/softmagic.c"
 ...
 case 
# 542 "project/radare2/libr/magic/softmagic.c" 3 4
     20
# 542 "project/radare2/libr/magic/softmagic.c"
                :
  if (file_printf (ms, ((ms->flags & 
# 543 "project/radare2/libr/magic/softmagic.c" 3 4
                      (0x000010|0x000400)
# 543 "project/radare2/libr/magic/softmagic.c"
                      ) ? m->mimetype : m->desc), m->value.s) == -1) {
   return -1;
  }
  if ((m->
# 546 "project/radare2/libr/magic/softmagic.c" 3 4
         _u._s._flags 
# 546 "project/radare2/libr/magic/softmagic.c"
                   & 
# 546 "project/radare2/libr/magic/softmagic.c" 3 4
                     (1 << (4))
# 546 "project/radare2/libr/magic/softmagic.c"
  ...
  break;
 case 
# 552 "project/radare2/libr/magic/softmagic.c" 3 4
     3
# 552 "project/radare2/libr/magic/softmagic.c"
                 :
  if (file_printf (ms, ((ms->flags & 
# 553 "project/radare2/libr/magic/softmagic.c" 3 4
                      (0x000010|0x000400)
# 553 "project/radare2/libr/magic/softmagic.c"
                      ) ? m->mimetype : m->desc), m->value.s) == -1) {
   return -1;
  }
  t = ms->offset;
...
# 597 "project/radare2/libr/magic/softmagic.c"
static void cvt_8(union VALUETYPE *p, const struct r_magic *m) {
 if (m->
# 598 "project/radare2/libr/magic/softmagic.c" 3 4
_u._mask
# 598 "project/radare2/libr/magic/softmagic.c"
) switch (m->mask_op & 
# 598 "project/radare2/libr/magic/softmagic.c" 3 4
0x07
# 598 "project/radare2/libr/magic/softmagic.c"
...
static void cvt_16(union VALUETYPE *p, const struct r_magic *m) {
 if (m->
# 602 "project/radare2/libr/magic/softmagic.c" 3 4
_u._mask
# 602 "project/radare2/libr/magic/softmagic.c"
) switch (m->mask_op & 
# 602 "project/radare2/libr/magic/softmagic.c" 3 4
0x07
# 602 "project/radare2/libr/magic/softmagic.c"
...
static void cvt_32(union VALUETYPE *p, const struct r_magic *m) {
 if (m->
# 606 "project/radare2/libr/magic/softmagic.c" 3 4
_u._mask
# 606 "project/radare2/libr/magic/softmagic.c"
) switch (m->mask_op & 
# 606 "project/radare2/libr/magic/softmagic.c" 3 4
0x07
# 606 "project/radare2/libr/magic/softmagic.c"
...
static void cvt_64(union VALUETYPE *p, const struct r_magic *m) {
 if (m->
# 610 "project/radare2/libr/magic/softmagic.c" 3 4
_u._mask
# 610 "project/radare2/libr/magic/softmagic.c"
) switch (m->mask_op & 
# 610 "project/radare2/libr/magic/softmagic.c" 3 4
0x07
# 610 "project/radare2/libr/magic/softmagic.c"
...
# 630 "project/radare2/libr/magic/softmagic.c"
static void cvt_float(union VALUETYPE *p, const struct r_magic *m) {
 if (m->
# 631 "project/radare2/libr/magic/softmagic.c" 3 4
_u._mask
# 631 "project/radare2/libr/magic/softmagic.c"
) switch (m->mask_op & 
# 631 "project/radare2/libr/magic/softmagic.c" 3 4
0x07
# 631 "project/radare2/libr/magic/softmagic.c"
...
static void cvt_double(union VALUETYPE *p, const struct r_magic *m) {
 if (m->
# 635 "project/radare2/libr/magic/softmagic.c" 3 4
_u._mask
# 635 "project/radare2/libr/magic/softmagic.c"
) switch (m->mask_op & 
# 635 "project/radare2/libr/magic/softmagic.c" 3 4
0x07
# 635 "project/radare2/libr/magic/softmagic.c"
...
static int mconvert(RMagic *ms, struct r_magic *m) {
 ...
 switch (m->type) {
 case 
# 647 "project/radare2/libr/magic/softmagic.c" 3 4
     1
# 647 "project/radare2/libr/magic/softmagic.c"
              :
  cvt_8(p, m);
  return 1;
 case 
# 650 "project/radare2/libr/magic/softmagic.c" 3 4
     2
# 650 "project/radare2/libr/magic/softmagic.c"
               :
  cvt_16(p, m);
  return 1;
 case 
# 653 "project/radare2/libr/magic/softmagic.c" 3 4
     4
# 653 "project/radare2/libr/magic/softmagic.c"
              :
 case 
# 654 "project/radare2/libr/magic/softmagic.c" 3 4
     6
# 654 "project/radare2/libr/magic/softmagic.c"
              :
 case 
# 655 "project/radare2/libr/magic/softmagic.c" 3 4
     14
# 655 "project/radare2/libr/magic/softmagic.c"
               :
  cvt_32(p, m);
  return 1;
 case 
# 658 "project/radare2/libr/magic/softmagic.c" 3 4
     24
# 658 "project/radare2/libr/magic/softmagic.c"
              :
 case 
# 659 "project/radare2/libr/magic/softmagic.c" 3 4
     27
# 659 "project/radare2/libr/magic/softmagic.c"
               :
 case 
# 660 "project/radare2/libr/magic/softmagic.c" 3 4
     30
# 660 "project/radare2/libr/magic/softmagic.c"
                :
  cvt_64(p, m);
  return 1;
 case 
# 663 "project/radare2/libr/magic/softmagic.c" 3 4
     5
# 663 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 664 "project/radare2/libr/magic/softmagic.c" 3 4
     18
# 664 "project/radare2/libr/magic/softmagic.c"
                    :
 case 
# 665 "project/radare2/libr/magic/softmagic.c" 3 4
     19
# 665 "project/radare2/libr/magic/softmagic.c"
                    : {
  size_t len;
 ...
 case 
# 676 "project/radare2/libr/magic/softmagic.c" 3 4
     13
# 676 "project/radare2/libr/magic/softmagic.c"
                 : {
 ...
 case 
# 692 "project/radare2/libr/magic/softmagic.c" 3 4
     7
# 692 "project/radare2/libr/magic/softmagic.c"
                 :
  p->h = (short)((p->hs[0]<<8)|(p->hs[1]));
  cvt_16(p, m);
  return 1;
 case 
# 696 "project/radare2/libr/magic/softmagic.c" 3 4
     8
# 696 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 697 "project/radare2/libr/magic/softmagic.c" 3 4
     9
# 697 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 698 "project/radare2/libr/magic/softmagic.c" 3 4
     15
# 698 "project/radare2/libr/magic/softmagic.c"
                 :
  p->l = (
# 699 "project/radare2/libr/magic/softmagic.c" 3 4
         int
# 699 "project/radare2/libr/magic/softmagic.c"
             ) r_read_be32 (p->hl);
  cvt_32(p, m);
  return 1;
 case 
# 702 "project/radare2/libr/magic/softmagic.c" 3 4
     26
# 702 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 703 "project/radare2/libr/magic/softmagic.c" 3 4
     29
# 703 "project/radare2/libr/magic/softmagic.c"
                 :
 case 
# 704 "project/radare2/libr/magic/softmagic.c" 3 4
     32
# 704 "project/radare2/libr/magic/softmagic.c"
                  :
  p->q = (
# 705 "project/radare2/libr/magic/softmagic.c" 3 4
         unsigned long long
# 705 "project/radare2/libr/magic/softmagic.c"
             )
      (((
# 706 "project/radare2/libr/magic/softmagic.c" 3 4
        unsigned long long
# 706 "project/radare2/libr/magic/softmagic.c"
            )p->hq[0]<<56)|((
# 706 "project/radare2/libr/magic/softmagic.c" 3 4
                             unsigned long long
# 706 "project/radare2/libr/magic/softmagic.c"
       ...
       ((
# 707 "project/radare2/libr/magic/softmagic.c" 3 4
        unsigned long long
# 707 "project/radare2/libr/magic/softmagic.c"
            )p->hq[2]<<40)|((
# 707 "project/radare2/libr/magic/softmagic.c" 3 4
                             unsigned long long
# 707 "project/radare2/libr/magic/softmagic.c"
       ...
       ((
# 708 "project/radare2/libr/magic/softmagic.c" 3 4
        unsigned long long
# 708 "project/radare2/libr/magic/softmagic.c"
            )p->hq[4]<<24)|((
# 708 "project/radare2/libr/magic/softmagic.c" 3 4
                             unsigned long long
# 708 "project/radare2/libr/magic/softmagic.c"
       ...
       ((
# 709 "project/radare2/libr/magic/softmagic.c" 3 4
        unsigned long long
# 709 "project/radare2/libr/magic/softmagic.c"
            )p->hq[6]<<8)|((
# 709 "project/radare2/libr/magic/softmagic.c" 3 4
                            unsigned long long
# 709 "project/radare2/libr/magic/softmagic.c"
  ...
  return 1;
 case 
# 712 "project/radare2/libr/magic/softmagic.c" 3 4
     10
# 712 "project/radare2/libr/magic/softmagic.c"
                 :
  p->h = (short)((p->hs[1]<<8)|(p->hs[0]));
  cvt_16(p, m);
  return 1;
 case 
# 716 "project/radare2/libr/magic/softmagic.c" 3 4
     11
# 716 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 717 "project/radare2/libr/magic/softmagic.c" 3 4
     12
# 717 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 718 "project/radare2/libr/magic/softmagic.c" 3 4
     16
# 718 "project/radare2/libr/magic/softmagic.c"
                 :
  p->l = (
# 719 "project/radare2/libr/magic/softmagic.c" 3 4
         int
# 719 "project/radare2/libr/magic/softmagic.c"
             ) r_read_le32 (p->hl);
  cvt_32(p, m);
  return 1;
 case 
# 722 "project/radare2/libr/magic/softmagic.c" 3 4
     25
# 722 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 723 "project/radare2/libr/magic/softmagic.c" 3 4
     28
# 723 "project/radare2/libr/magic/softmagic.c"
                 :
 case 
# 724 "project/radare2/libr/magic/softmagic.c" 3 4
     31
# 724 "project/radare2/libr/magic/softmagic.c"
                  :
  p->q = (
# 725 "project/radare2/libr/magic/softmagic.c" 3 4
         unsigned long long
# 725 "project/radare2/libr/magic/softmagic.c"
             )
      (((
# 726 "project/radare2/libr/magic/softmagic.c" 3 4
        unsigned long long
# 726 "project/radare2/libr/magic/softmagic.c"
            )p->hq[7]<<56)|((
# 726 "project/radare2/libr/magic/softmagic.c" 3 4
                             unsigned long long
# 726 "project/radare2/libr/magic/softmagic.c"
       ...
       ((
# 727 "project/radare2/libr/magic/softmagic.c" 3 4
        unsigned long long
# 727 "project/radare2/libr/magic/softmagic.c"
            )p->hq[5]<<40)|((
# 727 "project/radare2/libr/magic/softmagic.c" 3 4
                             unsigned long long
# 727 "project/radare2/libr/magic/softmagic.c"
       ...
       ((
# 728 "project/radare2/libr/magic/softmagic.c" 3 4
        unsigned long long
# 728 "project/radare2/libr/magic/softmagic.c"
            )p->hq[3]<<24)|((
# 728 "project/radare2/libr/magic/softmagic.c" 3 4
                             unsigned long long
# 728 "project/radare2/libr/magic/softmagic.c"
       ...
       ((
# 729 "project/radare2/libr/magic/softmagic.c" 3 4
        unsigned long long
# 729 "project/radare2/libr/magic/softmagic.c"
            )p->hq[1]<<8)|((
# 729 "project/radare2/libr/magic/softmagic.c" 3 4
                            unsigned long long
# 729 "project/radare2/libr/magic/softmagic.c"
  ...
  return 1;
 case 
# 732 "project/radare2/libr/magic/softmagic.c" 3 4
     23
# 732 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 733 "project/radare2/libr/magic/softmagic.c" 3 4
     21
# 733 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 734 "project/radare2/libr/magic/softmagic.c" 3 4
     22
# 734 "project/radare2/libr/magic/softmagic.c"
                 :
  p->l = (
# 735 "project/radare2/libr/magic/softmagic.c" 3 4
         int
# 735 "project/radare2/libr/magic/softmagic.c"
             )
      ((p->hl[1]<<24)|(p->hl[0]<<16)|(p->hl[3]<<8)|(p->hl[2]));
  cvt_32(p, m);
  return 1;
 case 
# 739 "project/radare2/libr/magic/softmagic.c" 3 4
     33
# 739 "project/radare2/libr/magic/softmagic.c"
               :
  cvt_float(p, m);
  return 1;
 case 
# 742 "project/radare2/libr/magic/softmagic.c" 3 4
     34
# 742 "project/radare2/libr/magic/softmagic.c"
                 :
  p->l = ((
# 743 "project/radare2/libr/magic/softmagic.c" 3 4
           unsigned int
# 743 "project/radare2/libr/magic/softmagic.c"
               )p->hl[0]<<24)|((
# 743 "project/radare2/libr/magic/softmagic.c" 3 4
                                unsigned int
# 743 "project/radare2/libr/magic/softmagic.c"
   ...
   ((
# 744 "project/radare2/libr/magic/softmagic.c" 3 4
    unsigned int
# 744 "project/radare2/libr/magic/softmagic.c"
        )p->hl[2]<<8) |((
# 744 "project/radare2/libr/magic/softmagic.c" 3 4
                         unsigned int
# 744 "project/radare2/libr/magic/softmagic.c"
  ...
  return 1;
 case 
# 747 "project/radare2/libr/magic/softmagic.c" 3 4
     35
# 747 "project/radare2/libr/magic/softmagic.c"
                 :
  p->l = ((
# 748 "project/radare2/libr/magic/softmagic.c" 3 4
           unsigned int
# 748 "project/radare2/libr/magic/softmagic.c"
               )p->hl[3]<<24)|((
# 748 "project/radare2/libr/magic/softmagic.c" 3 4
                                unsigned int
# 748 "project/radare2/libr/magic/softmagic.c"
   ...
   ((
# 749 "project/radare2/libr/magic/softmagic.c" 3 4
    unsigned int
# 749 "project/radare2/libr/magic/softmagic.c"
        )p->hl[1]<<8) |((
# 749 "project/radare2/libr/magic/softmagic.c" 3 4
                         unsigned int
# 749 "project/radare2/libr/magic/softmagic.c"
  ...
  return 1;
 case 
# 752 "project/radare2/libr/magic/softmagic.c" 3 4
     36
# 752 "project/radare2/libr/magic/softmagic.c"
                :
  cvt_double(p, m);
  return 1;
 case 
# 755 "project/radare2/libr/magic/softmagic.c" 3 4
     37
# 755 "project/radare2/libr/magic/softmagic.c"
                  :
  p->q = ((
# 756 "project/radare2/libr/magic/softmagic.c" 3 4
           unsigned long long
# 756 "project/radare2/libr/magic/softmagic.c"
               )p->hq[0]<<56)|((
# 756 "project/radare2/libr/magic/softmagic.c" 3 4
                                unsigned long long
# 756 "project/radare2/libr/magic/softmagic.c"
   ...
   ((
# 757 "project/radare2/libr/magic/softmagic.c" 3 4
    unsigned long long
# 757 "project/radare2/libr/magic/softmagic.c"
        )p->hq[2]<<40)|((
# 757 "project/radare2/libr/magic/softmagic.c" 3 4
                         unsigned long long
# 757 "project/radare2/libr/magic/softmagic.c"
   ...
   ((
# 758 "project/radare2/libr/magic/softmagic.c" 3 4
    unsigned long long
# 758 "project/radare2/libr/magic/softmagic.c"
        )p->hq[4]<<24)|((
# 758 "project/radare2/libr/magic/softmagic.c" 3 4
                         unsigned long long
# 758 "project/radare2/libr/magic/softmagic.c"
   ...
   ((
# 759 "project/radare2/libr/magic/softmagic.c" 3 4
    unsigned long long
# 759 "project/radare2/libr/magic/softmagic.c"
        )p->hq[6]<<8) |((
# 759 "project/radare2/libr/magic/softmagic.c" 3 4
                         unsigned long long
# 759 "project/radare2/libr/magic/softmagic.c"
  ...
  return 1;
 case 
# 762 "project/radare2/libr/magic/softmagic.c" 3 4
     38
# 762 "project/radare2/libr/magic/softmagic.c"
                  :
  p->q = ((
# 763 "project/radare2/libr/magic/softmagic.c" 3 4
           unsigned long long
# 763 "project/radare2/libr/magic/softmagic.c"
               )p->hq[7]<<56)|((
# 763 "project/radare2/libr/magic/softmagic.c" 3 4
                                unsigned long long
# 763 "project/radare2/libr/magic/softmagic.c"
   ...
   ((
# 764 "project/radare2/libr/magic/softmagic.c" 3 4
    unsigned long long
# 764 "project/radare2/libr/magic/softmagic.c"
        )p->hq[5]<<40)|((
# 764 "project/radare2/libr/magic/softmagic.c" 3 4
                         unsigned long long
# 764 "project/radare2/libr/magic/softmagic.c"
   ...
   ((
# 765 "project/radare2/libr/magic/softmagic.c" 3 4
    unsigned long long
# 765 "project/radare2/libr/magic/softmagic.c"
        )p->hq[3]<<24)|((
# 765 "project/radare2/libr/magic/softmagic.c" 3 4
                         unsigned long long
# 765 "project/radare2/libr/magic/softmagic.c"
   ...
   ((
# 766 "project/radare2/libr/magic/softmagic.c" 3 4
    unsigned long long
# 766 "project/radare2/libr/magic/softmagic.c"
        )p->hq[1]<<8) |((
# 766 "project/radare2/libr/magic/softmagic.c" 3 4
                         unsigned long long
# 766 "project/radare2/libr/magic/softmagic.c"
  ...
  return 1;
 case 
# 769 "project/radare2/libr/magic/softmagic.c" 3 4
     17
# 769 "project/radare2/libr/magic/softmagic.c"
               :
 case 
# 770 "project/radare2/libr/magic/softmagic.c" 3 4
     20
# 770 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 771 "project/radare2/libr/magic/softmagic.c" 3 4
     3
# 771 "project/radare2/libr/magic/softmagic.c"
                 :
  return 1;
 default:
...
static void mdebug(
# 780 "project/radare2/libr/magic/softmagic.c" 3 4
                  unsigned int 
# 780 "project/radare2/libr/magic/softmagic.c"
                       offset, const char *str, size_t len) {
 
# 781 "project/radare2/libr/magic/softmagic.c" 3 4
fprintf(__stderrp,
# 781 "project/radare2/libr/magic/softmagic.c"
"mget @%d: ", offset
# 781 "project/radare2/libr/magic/softmagic.c" 3 4
)
# 781 "project/radare2/libr/magic/softmagic.c"
                              ;
 file_showstr (
# 782 "project/radare2/libr/magic/softmagic.c" 3 4
              __stderrp
# 782 "project/radare2/libr/magic/softmagic.c"
                    , str, len);
 (void) fputc('\n', 
# 783 "project/radare2/libr/magic/softmagic.c" 3 4
                   __stderrp
# 783 "project/radare2/libr/magic/softmagic.c"
                         );
 (void) fputc('\n', 
# 784 "project/radare2/libr/magic/softmagic.c" 3 4
                   __stderrp
# 784 "project/radare2/libr/magic/softmagic.c"
                         );
}

static int mcopy(RMagic *ms, union VALUETYPE *p, int type, int indir, const 
# 787 "project/radare2/libr/magic/softmagic.c" 3 4
                                                                           unsigned char 
# 787 "project/radare2/libr/magic/softmagic.c"
                                                                               *s, 
# 787 "project/radare2/libr/magic/softmagic.c" 3 4
                                                                                   unsigned int 
# 787 "project/radare2/libr/magic/softmagic.c"
                                                                                        offset, size_t nbytes, size_t linecnt) {
 ...
 if (indir == 0) {
  switch (type) {
  case 
# 794 "project/radare2/libr/magic/softmagic.c" 3 4
      20
# 794 "project/radare2/libr/magic/softmagic.c"
                 :
   ...
   return 0;
  case 
# 799 "project/radare2/libr/magic/softmagic.c" 3 4
      17
# 799 "project/radare2/libr/magic/softmagic.c"
                : {
   const char *b;
   const char *c;
   const char *last;
   ...
   if (!s) {
    ms->search.s_len = 0;
    ms->search.s = 
# 808 "project/radare2/libr/magic/softmagic.c" 3 4
                  ((void *)0)
# 808 "project/radare2/libr/magic/softmagic.c"
                      ;
    return 0;
   }
  ...
  case 
# 832 "project/radare2/libr/magic/softmagic.c" 3 4
      18
# 832 "project/radare2/libr/magic/softmagic.c"
                     :
  case 
# 833 "project/radare2/libr/magic/softmagic.c" 3 4
      19
# 833 "project/radare2/libr/magic/softmagic.c"
                     : {
   const 
# 834 "project/radare2/libr/magic/softmagic.c" 3 4
        unsigned char 
# 834 "project/radare2/libr/magic/softmagic.c"
            *src = s + offset;
   const 
# 835 "project/radare2/libr/magic/softmagic.c" 3 4
        unsigned char 
# 835 "project/radare2/libr/magic/softmagic.c"
            *esrc = s + nbytes;
   char *dst = p->s;
   char *edst = &p->s[sizeof(p->s) - 1];

   if (type == 
# 839 "project/radare2/libr/magic/softmagic.c" 3 4
              18
# 839 "project/radare2/libr/magic/softmagic.c"
                             ) {
    src++;
   }
   ...
   for ( ; src < esrc; src += 2, dst++) {
    ...
    if (*dst == '\0') {
     if (type == 
# 856 "project/radare2/libr/magic/softmagic.c" 3 4
                18 
# 856 "project/radare2/libr/magic/softmagic.c"
                                ? *(src - 1) != '\0' : *(src + 1) != '\0') {
      *dst = ' ';
     }
    }
  ...
  case 
# 864 "project/radare2/libr/magic/softmagic.c" 3 4
      5
# 864 "project/radare2/libr/magic/softmagic.c"
                 :
  case 
# 865 "project/radare2/libr/magic/softmagic.c" 3 4
      13
# 865 "project/radare2/libr/magic/softmagic.c"
                  :
  default:
   break;
  }
 ...
 if (offset >= nbytes) {
  (void)
# 872 "project/radare2/libr/magic/softmagic.c" 3 4
       __builtin___memset_chk (
# 872 "project/radare2/libr/magic/softmagic.c"
       p
# 872 "project/radare2/libr/magic/softmagic.c" 3 4
       , 
# 872 "project/radare2/libr/magic/softmagic.c"
...
# 872 "project/radare2/libr/magic/softmagic.c"
 ...
 (void)
# 878 "project/radare2/libr/magic/softmagic.c" 3 4
      __builtin___memcpy_chk (
# 878 "project/radare2/libr/magic/softmagic.c"
      p
# 878 "project/radare2/libr/magic/softmagic.c" 3 4
      , 
# 878 "project/radare2/libr/magic/softmagic.c"
...
# 878 "project/radare2/libr/magic/softmagic.c"
 ...
 if (nbytes < sizeof (*p)) {
  (void)
# 885 "project/radare2/libr/magic/softmagic.c" 3 4
       __builtin___memset_chk (
# 885 "project/radare2/libr/magic/softmagic.c"
       ((char *)(void *)p) + nbytes
# 885 "project/radare2/libr/magic/softmagic.c" 3 4
       , 
# 885 "project/radare2/libr/magic/softmagic.c"
...
# 886 "project/radare2/libr/magic/softmagic.c"
                       ;
 }
 return 0;
}

static int mget(RMagic *ms, const 
# 891 "project/radare2/libr/magic/softmagic.c" 3 4
                                 unsigned char 
# 891 "project/radare2/libr/magic/softmagic.c"
                                     *s, struct r_magic *m, size_t nbytes, unsigned int cont_level) {
 
# 892 "project/radare2/libr/magic/softmagic.c" 3 4
unsigned int 
# 892 "project/radare2/libr/magic/softmagic.c"
     offset = ms->offset;
 
# 893 "project/radare2/libr/magic/softmagic.c" 3 4
unsigned int 
# 893 "project/radare2/libr/magic/softmagic.c"
     count = m->
# 893 "project/radare2/libr/magic/softmagic.c" 3 4
                _u._s._count
# 893 "project/radare2/libr/magic/softmagic.c"
 ...
 if (mcopy (ms, p, m->type, m->flag & 
# 896 "project/radare2/libr/magic/softmagic.c" 3 4
                                     0x01
# 896 "project/radare2/libr/magic/softmagic.c"
                                          , s, offset, nbytes, count) == -1) {
  return -1;
 }

 if ((ms->flags & 
# 900 "project/radare2/libr/magic/softmagic.c" 3 4
                 0x000001
# 900 "project/radare2/libr/magic/softmagic.c"
                              ) != 0) {
 ...
 if (m->flag & 
# 905 "project/radare2/libr/magic/softmagic.c" 3 4
              0x01
# 905 "project/radare2/libr/magic/softmagic.c"
                   ) {
  int off = m->in_offset;
  if (m->in_op & 
# 907 "project/radare2/libr/magic/softmagic.c" 3 4
                0x80
# 907 "project/radare2/libr/magic/softmagic.c"
                               ) {
   const union VALUETYPE *q =
       ((const void *)(s + offset + off));
   switch (m->in_type) {
   case 
# 911 "project/radare2/libr/magic/softmagic.c" 3 4
       1
# 911 "project/radare2/libr/magic/softmagic.c"
                :
    off = q->b;
    break;
   case 
# 914 "project/radare2/libr/magic/softmagic.c" 3 4
       2
# 914 "project/radare2/libr/magic/softmagic.c"
                 :
    off = q->h;
    break;
   case 
# 917 "project/radare2/libr/magic/softmagic.c" 3 4
       7
# 917 "project/radare2/libr/magic/softmagic.c"
                   :
    off = (short)((q->hs[0]<<8)|(q->hs[1]));
    break;
   case 
# 920 "project/radare2/libr/magic/softmagic.c" 3 4
       10
# 920 "project/radare2/libr/magic/softmagic.c"
                   :
    off = (short)((q->hs[1]<<8)|(q->hs[0]));
    break;
   case 
# 923 "project/radare2/libr/magic/softmagic.c" 3 4
       4
# 923 "project/radare2/libr/magic/softmagic.c"
                :
    off = q->l;
    break;
   case 
# 926 "project/radare2/libr/magic/softmagic.c" 3 4
       8
# 926 "project/radare2/libr/magic/softmagic.c"
                  :
    off = (
# 927 "project/radare2/libr/magic/softmagic.c" 3 4
          int
# 927 "project/radare2/libr/magic/softmagic.c"
              )((q->hl[0]<<24)|(q->hl[1]<<16)| (q->hl[2]<<8)|(q->hl[3]));
    break;
   case 
# 929 "project/radare2/libr/magic/softmagic.c" 3 4
       11
# 929 "project/radare2/libr/magic/softmagic.c"
                  :
    off = (
# 930 "project/radare2/libr/magic/softmagic.c" 3 4
          int
# 930 "project/radare2/libr/magic/softmagic.c"
              )((q->hl[3]<<24)|(q->hl[2]<<16)| (q->hl[1]<<8)|(q->hl[0]));
    break;
   case 
# 932 "project/radare2/libr/magic/softmagic.c" 3 4
       23
# 932 "project/radare2/libr/magic/softmagic.c"
                  :
    off = (
# 933 "project/radare2/libr/magic/softmagic.c" 3 4
          int
# 933 "project/radare2/libr/magic/softmagic.c"
              )((q->hl[1]<<24)|(q->hl[0]<<16)| (q->hl[3]<<8)|(q->hl[2]));
    break;
   }
  }
  switch (m->in_type) {
  case 
# 938 "project/radare2/libr/magic/softmagic.c" 3 4
      1
# 938 "project/radare2/libr/magic/softmagic.c"
               :
   if (nbytes < (offset + 1)) {
    return 0;
   }
   if (off) {
    switch (m->in_op & 
# 943 "project/radare2/libr/magic/softmagic.c" 3 4
                      0x07
# 943 "project/radare2/libr/magic/softmagic.c"
                                   ) {
    case 
# 944 "project/radare2/libr/magic/softmagic.c" 3 4
        0
# 944 "project/radare2/libr/magic/softmagic.c"
                  : offset = p->b & off; break;
    case 
# 945 "project/radare2/libr/magic/softmagic.c" 3 4
        1
# 945 "project/radare2/libr/magic/softmagic.c"
                 : offset = p->b | off; break;
    case 
# 946 "project/radare2/libr/magic/softmagic.c" 3 4
        2
# 946 "project/radare2/libr/magic/softmagic.c"
                  : offset = p->b ^ off; break;
    case 
# 947 "project/radare2/libr/magic/softmagic.c" 3 4
        3
# 947 "project/radare2/libr/magic/softmagic.c"
                  : offset = p->b + off; break;
    case 
# 948 "project/radare2/libr/magic/softmagic.c" 3 4
        4
# 948 "project/radare2/libr/magic/softmagic.c"
                    : offset = p->b - off; break;
    case 
# 949 "project/radare2/libr/magic/softmagic.c" 3 4
        5
# 949 "project/radare2/libr/magic/softmagic.c"
                       : offset = p->b * off; break;
    case 
# 950 "project/radare2/libr/magic/softmagic.c" 3 4
        6
# 950 "project/radare2/libr/magic/softmagic.c"
                     : offset = p->b / off; break;
    case 
# 951 "project/radare2/libr/magic/softmagic.c" 3 4
        7
# 951 "project/radare2/libr/magic/softmagic.c"
                     : offset = p->b % off; break;
    }
   } else {
    offset = p->b;
   ...
   if (m->in_op & 
# 956 "project/radare2/libr/magic/softmagic.c" 3 4
                 0x40
# 956 "project/radare2/libr/magic/softmagic.c"
                               ) {
    offset = ~offset;
   }
   break;
  case 
# 960 "project/radare2/libr/magic/softmagic.c" 3 4
      7
# 960 "project/radare2/libr/magic/softmagic.c"
                  :
   if (nbytes < (offset + 2)) {
    return 0;
   }
   if (off) {
    switch (m->in_op & 
# 965 "project/radare2/libr/magic/softmagic.c" 3 4
                      0x07
# 965 "project/radare2/libr/magic/softmagic.c"
                                   ) {
    case 
# 966 "project/radare2/libr/magic/softmagic.c" 3 4
        0
# 966 "project/radare2/libr/magic/softmagic.c"
                  : offset = (short)((p->hs[0]<<8)| (p->hs[1])) & off; break;
    case 
# 967 "project/radare2/libr/magic/softmagic.c" 3 4
        1
# 967 "project/radare2/libr/magic/softmagic.c"
                 : offset = (short)((p->hs[0]<<8)| (p->hs[1])) | off; break;
    case 
# 968 "project/radare2/libr/magic/softmagic.c" 3 4
        2
# 968 "project/radare2/libr/magic/softmagic.c"
                  : offset = (short)((p->hs[0]<<8)| (p->hs[1])) ^ off; break;
    case 
# 969 "project/radare2/libr/magic/softmagic.c" 3 4
        3
# 969 "project/radare2/libr/magic/softmagic.c"
                  : offset = (short)((p->hs[0]<<8)| (p->hs[1])) + off; break;
    case 
# 970 "project/radare2/libr/magic/softmagic.c" 3 4
        4
# 970 "project/radare2/libr/magic/softmagic.c"
                    : offset = (short)((p->hs[0]<<8)| (p->hs[1])) - off; break;
    case 
# 971 "project/radare2/libr/magic/softmagic.c" 3 4
        5
# 971 "project/radare2/libr/magic/softmagic.c"
                       : offset = (short)((p->hs[0]<<8)| (p->hs[1])) * off; break;
    case 
# 972 "project/radare2/libr/magic/softmagic.c" 3 4
        6
# 972 "project/radare2/libr/magic/softmagic.c"
                     : offset = (short)((p->hs[0]<<8)| (p->hs[1])) / off; break;
    case 
# 973 "project/radare2/libr/magic/softmagic.c" 3 4
        7
# 973 "project/radare2/libr/magic/softmagic.c"
                     : offset = (short)((p->hs[0]<<8)| (p->hs[1])) % off; break;
    }
   } else {
   ...
   if (m->in_op & 
# 979 "project/radare2/libr/magic/softmagic.c" 3 4
                 0x40
# 979 "project/radare2/libr/magic/softmagic.c"
                               ) {
    offset = ~offset;
   }
   break;
  case 
# 983 "project/radare2/libr/magic/softmagic.c" 3 4
      10
# 983 "project/radare2/libr/magic/softmagic.c"
                  :
   if (nbytes < (offset + 2)) {
    return 0;
   }
   if (off) {
    switch (m->in_op & 
# 988 "project/radare2/libr/magic/softmagic.c" 3 4
                      0x07
# 988 "project/radare2/libr/magic/softmagic.c"
                                   ) {
    case 
# 989 "project/radare2/libr/magic/softmagic.c" 3 4
        0
# 989 "project/radare2/libr/magic/softmagic.c"
                  : offset = (short)((p->hs[1]<<8)| (p->hs[0])) & off; break;
    case 
# 990 "project/radare2/libr/magic/softmagic.c" 3 4
        1
# 990 "project/radare2/libr/magic/softmagic.c"
                 : offset = (short)((p->hs[1]<<8)| (p->hs[0])) | off; break;
    case 
# 991 "project/radare2/libr/magic/softmagic.c" 3 4
        2
# 991 "project/radare2/libr/magic/softmagic.c"
                  : offset = (short)((p->hs[1]<<8)| (p->hs[0])) ^ off; break;
    case 
# 992 "project/radare2/libr/magic/softmagic.c" 3 4
        3
# 992 "project/radare2/libr/magic/softmagic.c"
                  : offset = (short)((p->hs[1]<<8)| (p->hs[0])) + off; break;
    case 
# 993 "project/radare2/libr/magic/softmagic.c" 3 4
        4
# 993 "project/radare2/libr/magic/softmagic.c"
                    : offset = (short)((p->hs[1]<<8)| (p->hs[0])) - off; break;
    case 
# 994 "project/radare2/libr/magic/softmagic.c" 3 4
        5
# 994 "project/radare2/libr/magic/softmagic.c"
                       : offset = (short)((p->hs[1]<<8)| (p->hs[0])) * off; break;
    case 
# 995 "project/radare2/libr/magic/softmagic.c" 3 4
        6
# 995 "project/radare2/libr/magic/softmagic.c"
                     : offset = (short)((p->hs[1]<<8)| (p->hs[0])) / off; break;
    case 
# 996 "project/radare2/libr/magic/softmagic.c" 3 4
        7
# 996 "project/radare2/libr/magic/softmagic.c"
                     : offset = (short)((p->hs[1]<<8)| (p->hs[0])) % off; break;
    }
   } else {
   ...
   if (m->in_op & 
# 1001 "project/radare2/libr/magic/softmagic.c" 3 4
                 0x40
# 1001 "project/radare2/libr/magic/softmagic.c"
                               ) {
    offset = ~offset;
   }
   break;
  case 
# 1005 "project/radare2/libr/magic/softmagic.c" 3 4
      2
# 1005 "project/radare2/libr/magic/softmagic.c"
                :
   if (nbytes < (offset + 2)) {
    return 0;
   }
   if (off) {
    switch (m->in_op & 
# 1010 "project/radare2/libr/magic/softmagic.c" 3 4
                      0x07
# 1010 "project/radare2/libr/magic/softmagic.c"
                                   ) {
    case 
# 1011 "project/radare2/libr/magic/softmagic.c" 3 4
        0
# 1011 "project/radare2/libr/magic/softmagic.c"
                  : offset = p->h & off; break;
    case 
# 1012 "project/radare2/libr/magic/softmagic.c" 3 4
        1
# 1012 "project/radare2/libr/magic/softmagic.c"
                 : offset = p->h | off; break;
    case 
# 1013 "project/radare2/libr/magic/softmagic.c" 3 4
        2
# 1013 "project/radare2/libr/magic/softmagic.c"
                  : offset = p->h ^ off; break;
    case 
# 1014 "project/radare2/libr/magic/softmagic.c" 3 4
        3
# 1014 "project/radare2/libr/magic/softmagic.c"
                  : offset = p->h + off; break;
    case 
# 1015 "project/radare2/libr/magic/softmagic.c" 3 4
        4
# 1015 "project/radare2/libr/magic/softmagic.c"
                    : offset = p->h - off; break;
    case 
# 1016 "project/radare2/libr/magic/softmagic.c" 3 4
        5
# 1016 "project/radare2/libr/magic/softmagic.c"
                       : offset = p->h * off; break;
    case 
# 1017 "project/radare2/libr/magic/softmagic.c" 3 4
        6
# 1017 "project/radare2/libr/magic/softmagic.c"
                     : offset = p->h / off; break;
    case 
# 1018 "project/radare2/libr/magic/softmagic.c" 3 4
        7
# 1018 "project/radare2/libr/magic/softmagic.c"
                     : offset = p->h % off; break;
    }
   } else {
    offset = p->h;
   ...
   if (m->in_op & 
# 1023 "project/radare2/libr/magic/softmagic.c" 3 4
                 0x40
# 1023 "project/radare2/libr/magic/softmagic.c"
                               ) {
    offset = ~offset;
   }
   break;
  case 
# 1027 "project/radare2/libr/magic/softmagic.c" 3 4
      8
# 1027 "project/radare2/libr/magic/softmagic.c"
                 :
   if (nbytes < (offset + 4)) {
    return 0;
   }
   if (off) {
    switch (m->in_op & 
# 1032 "project/radare2/libr/magic/softmagic.c" 3 4
                      0x07
# 1032 "project/radare2/libr/magic/softmagic.c"
                                   ) {
    case 
# 1033 "project/radare2/libr/magic/softmagic.c" 3 4
        0
# 1033 "project/radare2/libr/magic/softmagic.c"
                  :
     offset = (
# 1034 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1034 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[0]<<24)| (p->hl[1]<<16)| (p->hl[2]<<8)| (p->hl[3])) & off;
     break;
    case 
# 1036 "project/radare2/libr/magic/softmagic.c" 3 4
        1
# 1036 "project/radare2/libr/magic/softmagic.c"
                 :
     offset = (
# 1037 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1037 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[0]<<24)| (p->hl[1]<<16)| (p->hl[2]<<8)| (p->hl[3])) | off;
     break;
    case 
# 1039 "project/radare2/libr/magic/softmagic.c" 3 4
        2
# 1039 "project/radare2/libr/magic/softmagic.c"
                  :
     offset = (
# 1040 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1040 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[0]<<24)| (p->hl[1]<<16)| (p->hl[2]<<8)| (p->hl[3])) ^ off;
     break;
    case 
# 1042 "project/radare2/libr/magic/softmagic.c" 3 4
        3
# 1042 "project/radare2/libr/magic/softmagic.c"
                  :
     offset = (
# 1043 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1043 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[0]<<24)| (p->hl[1]<<16)| (p->hl[2]<<8)| (p->hl[3])) + off;
     break;
    case 
# 1045 "project/radare2/libr/magic/softmagic.c" 3 4
        4
# 1045 "project/radare2/libr/magic/softmagic.c"
                    :
     offset = (
# 1046 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1046 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[0]<<24)| (p->hl[1]<<16)| (p->hl[2]<<8)| (p->hl[3])) - off;
     break;
    case 
# 1048 "project/radare2/libr/magic/softmagic.c" 3 4
        5
# 1048 "project/radare2/libr/magic/softmagic.c"
                       :
     offset = (
# 1049 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1049 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[0]<<24)| (p->hl[1]<<16)| (p->hl[2]<<8)| (p->hl[3])) * off;
     break;
    case 
# 1051 "project/radare2/libr/magic/softmagic.c" 3 4
        6
# 1051 "project/radare2/libr/magic/softmagic.c"
                     :
     offset = (
# 1052 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1052 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[0]<<24)| (p->hl[1]<<16)| (p->hl[2]<<8)| (p->hl[3])) / off;
     break;
    case 
# 1054 "project/radare2/libr/magic/softmagic.c" 3 4
        7
# 1054 "project/radare2/libr/magic/softmagic.c"
                     :
     offset = (
# 1055 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1055 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[0]<<24)| (p->hl[1]<<16)| (p->hl[2]<<8)| (p->hl[3])) % off;
     break;
    }
   } else {
    offset = (
# 1059 "project/radare2/libr/magic/softmagic.c" 3 4
             int
# 1059 "project/radare2/libr/magic/softmagic.c"
                 ) ((p->hl[0] << 24) | (p->hl[1] << 16) | (p->hl[2] << 8) | (p->hl[3]));
   }
   if (m->in_op & 
# 1061 "project/radare2/libr/magic/softmagic.c" 3 4
                 0x40
# 1061 "project/radare2/libr/magic/softmagic.c"
                               ) {
    offset = ~offset;
   }
   break;
  case 
# 1065 "project/radare2/libr/magic/softmagic.c" 3 4
      11
# 1065 "project/radare2/libr/magic/softmagic.c"
                 :
   if (nbytes < (offset + 4)) {
    return 0;
   }
   if (off) {
    switch (m->in_op & 
# 1070 "project/radare2/libr/magic/softmagic.c" 3 4
                      0x07
# 1070 "project/radare2/libr/magic/softmagic.c"
                                   ) {
    case 
# 1071 "project/radare2/libr/magic/softmagic.c" 3 4
        0
# 1071 "project/radare2/libr/magic/softmagic.c"
                  :
     offset = (
# 1072 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1072 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[3]<<24)| (p->hl[2]<<16)| (p->hl[1]<<8)| (p->hl[0])) & off;
     break;
    case 
# 1074 "project/radare2/libr/magic/softmagic.c" 3 4
        1
# 1074 "project/radare2/libr/magic/softmagic.c"
                 :
     offset = (
# 1075 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1075 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[3]<<24)| (p->hl[2]<<16)| (p->hl[1]<<8)| (p->hl[0])) | off;
     break;
    case 
# 1077 "project/radare2/libr/magic/softmagic.c" 3 4
        2
# 1077 "project/radare2/libr/magic/softmagic.c"
                  :
     offset = (
# 1078 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1078 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[3]<<24)| (p->hl[2]<<16)| (p->hl[1]<<8)| (p->hl[0])) ^ off;
     break;
    case 
# 1080 "project/radare2/libr/magic/softmagic.c" 3 4
        3
# 1080 "project/radare2/libr/magic/softmagic.c"
                  :
     offset = (
# 1081 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1081 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[3]<<24)| (p->hl[2]<<16)| (p->hl[1]<<8)| (p->hl[0])) + off;
     break;
    case 
# 1083 "project/radare2/libr/magic/softmagic.c" 3 4
        4
# 1083 "project/radare2/libr/magic/softmagic.c"
                    :
     offset = (
# 1084 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1084 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[3]<<24)| (p->hl[2]<<16)| (p->hl[1]<<8)| (p->hl[0])) - off;
     break;
    case 
# 1086 "project/radare2/libr/magic/softmagic.c" 3 4
        5
# 1086 "project/radare2/libr/magic/softmagic.c"
                       :
     offset = (
# 1087 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1087 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[3]<<24)| (p->hl[2]<<16)| (p->hl[1]<<8)| (p->hl[0])) * off;
     break;
    case 
# 1089 "project/radare2/libr/magic/softmagic.c" 3 4
        6
# 1089 "project/radare2/libr/magic/softmagic.c"
                     :
     offset = (
# 1090 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1090 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[3]<<24)| (p->hl[2]<<16)| (p->hl[1]<<8)| (p->hl[0])) / off;
     break;
    case 
# 1092 "project/radare2/libr/magic/softmagic.c" 3 4
        7
# 1092 "project/radare2/libr/magic/softmagic.c"
                     :
     offset = (
# 1093 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1093 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[3]<<24)| (p->hl[2]<<16)| (p->hl[1]<<8)| (p->hl[0])) % off;
     break;
    }
   } else {
    offset = (
# 1097 "project/radare2/libr/magic/softmagic.c" 3 4
             int
# 1097 "project/radare2/libr/magic/softmagic.c"
                 ) (((
# 1097 "project/radare2/libr/magic/softmagic.c" 3 4
                      unsigned int
# 1097 "project/radare2/libr/magic/softmagic.c"
   ...
   if (m->in_op & 
# 1099 "project/radare2/libr/magic/softmagic.c" 3 4
                 0x40
# 1099 "project/radare2/libr/magic/softmagic.c"
                               ) {
    offset = ~offset;
   }
   break;
  case 
# 1103 "project/radare2/libr/magic/softmagic.c" 3 4
      23
# 1103 "project/radare2/libr/magic/softmagic.c"
                 :
   if (nbytes < (offset + 4)) {
    return 0;
   }
   if (off) {
    switch (m->in_op & 
# 1108 "project/radare2/libr/magic/softmagic.c" 3 4
                      0x07
# 1108 "project/radare2/libr/magic/softmagic.c"
                                   ) {
    case 
# 1109 "project/radare2/libr/magic/softmagic.c" 3 4
        0
# 1109 "project/radare2/libr/magic/softmagic.c"
                  :
     offset = (
# 1110 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1110 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[1]<<24)| (p->hl[0]<<16)| (p->hl[3]<<8)| (p->hl[2])) & off;
     break;
    case 
# 1112 "project/radare2/libr/magic/softmagic.c" 3 4
        1
# 1112 "project/radare2/libr/magic/softmagic.c"
                 :
     offset = (
# 1113 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1113 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[1]<<24)| (p->hl[0]<<16)| (p->hl[3]<<8)| (p->hl[2])) | off;
     break;
    case 
# 1115 "project/radare2/libr/magic/softmagic.c" 3 4
        2
# 1115 "project/radare2/libr/magic/softmagic.c"
                  :
     offset = (
# 1116 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1116 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[1]<<24)| (p->hl[0]<<16)| (p->hl[3]<<8)| (p->hl[2])) ^ off;
     break;
    case 
# 1118 "project/radare2/libr/magic/softmagic.c" 3 4
        3
# 1118 "project/radare2/libr/magic/softmagic.c"
                  :
     offset = (
# 1119 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1119 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[1]<<24)| (p->hl[0]<<16)| (p->hl[3]<<8)| (p->hl[2])) + off;
     break;
    case 
# 1121 "project/radare2/libr/magic/softmagic.c" 3 4
        4
# 1121 "project/radare2/libr/magic/softmagic.c"
                    :
     offset = (
# 1122 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1122 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[1]<<24)| (p->hl[0]<<16)| (p->hl[3]<<8)| (p->hl[2])) - off;
     break;
    case 
# 1124 "project/radare2/libr/magic/softmagic.c" 3 4
        5
# 1124 "project/radare2/libr/magic/softmagic.c"
                       :
     offset = (
# 1125 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1125 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[1]<<24)| (p->hl[0]<<16)| (p->hl[3]<<8)| (p->hl[2])) * off;
     break;
    case 
# 1127 "project/radare2/libr/magic/softmagic.c" 3 4
        6
# 1127 "project/radare2/libr/magic/softmagic.c"
                     :
     offset = (
# 1128 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1128 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[1]<<24)| (p->hl[0]<<16)| (p->hl[3]<<8)| (p->hl[2])) / off;
     break;
    case 
# 1130 "project/radare2/libr/magic/softmagic.c" 3 4
        7
# 1130 "project/radare2/libr/magic/softmagic.c"
                     :
     offset = (
# 1131 "project/radare2/libr/magic/softmagic.c" 3 4
              int
# 1131 "project/radare2/libr/magic/softmagic.c"
                  )((p->hl[1]<<24)| (p->hl[0]<<16)| (p->hl[3]<<8)| (p->hl[2])) % off;
     break;
    }
   } else {
    offset = (
# 1135 "project/radare2/libr/magic/softmagic.c" 3 4
             int
# 1135 "project/radare2/libr/magic/softmagic.c"
                 ) ((p->hl[1] << 24) | (p->hl[0] << 16) | (p->hl[3] << 8) | (p->hl[2]));
   }
   if (m->in_op & 
# 1137 "project/radare2/libr/magic/softmagic.c" 3 4
                 0x40
# 1137 "project/radare2/libr/magic/softmagic.c"
                               ) {
    offset = ~offset;
   }
   break;
  case 
# 1141 "project/radare2/libr/magic/softmagic.c" 3 4
      4
# 1141 "project/radare2/libr/magic/softmagic.c"
               :
   if (nbytes < (offset + 4)) {
    return 0;
   }
   if (off) {
    switch (m->in_op & 
# 1146 "project/radare2/libr/magic/softmagic.c" 3 4
                      0x07
# 1146 "project/radare2/libr/magic/softmagic.c"
                                   ) {
    case 
# 1147 "project/radare2/libr/magic/softmagic.c" 3 4
        0
# 1147 "project/radare2/libr/magic/softmagic.c"
                  : offset = p->l & off; break;
    case 
# 1148 "project/radare2/libr/magic/softmagic.c" 3 4
        1
# 1148 "project/radare2/libr/magic/softmagic.c"
                 : offset = p->l | off; break;
    case 
# 1149 "project/radare2/libr/magic/softmagic.c" 3 4
        2
# 1149 "project/radare2/libr/magic/softmagic.c"
                  : offset = p->l ^ off; break;
    case 
# 1150 "project/radare2/libr/magic/softmagic.c" 3 4
        3
# 1150 "project/radare2/libr/magic/softmagic.c"
                  : offset = p->l + off; break;
    case 
# 1151 "project/radare2/libr/magic/softmagic.c" 3 4
        4
# 1151 "project/radare2/libr/magic/softmagic.c"
                    : offset = p->l - off; break;
    case 
# 1152 "project/radare2/libr/magic/softmagic.c" 3 4
        5
# 1152 "project/radare2/libr/magic/softmagic.c"
                       : offset = p->l * off; break;
    case 
# 1153 "project/radare2/libr/magic/softmagic.c" 3 4
        6
# 1153 "project/radare2/libr/magic/softmagic.c"
                     : offset = p->l / off; break;
    case 
# 1154 "project/radare2/libr/magic/softmagic.c" 3 4
        7
# 1154 "project/radare2/libr/magic/softmagic.c"
                     : offset = p->l % off; break;
    }
   } else {
    offset = p->l;
   ...
   if (m->in_op & 
# 1159 "project/radare2/libr/magic/softmagic.c" 3 4
                 0x40
# 1159 "project/radare2/libr/magic/softmagic.c"
                               ) {
    offset = ~offset;
   }
   break;
  ...
  if (m->flag & 
# 1165 "project/radare2/libr/magic/softmagic.c" 3 4
               0x04
# 1165 "project/radare2/libr/magic/softmagic.c"
                          ) {
  ...
  if ((ms->flags & 
# 1173 "project/radare2/libr/magic/softmagic.c" 3 4
                  0x000001
# 1173 "project/radare2/libr/magic/softmagic.c"
                               ) != 0) {
 ...
 switch (m->type) {
 case 
# 1182 "project/radare2/libr/magic/softmagic.c" 3 4
     1
# 1182 "project/radare2/libr/magic/softmagic.c"
              :
  if (nbytes < (offset + 1)) {
   return 0;
  }
  break;
 case 
# 1187 "project/radare2/libr/magic/softmagic.c" 3 4
     2
# 1187 "project/radare2/libr/magic/softmagic.c"
               :
 case 
# 1188 "project/radare2/libr/magic/softmagic.c" 3 4
     7
# 1188 "project/radare2/libr/magic/softmagic.c"
                 :
 case 
# 1189 "project/radare2/libr/magic/softmagic.c" 3 4
     10
# 1189 "project/radare2/libr/magic/softmagic.c"
                 :
  if (nbytes < (offset + 2)) {
   return 0;
  }
  break;
 case 
# 1194 "project/radare2/libr/magic/softmagic.c" 3 4
     4
# 1194 "project/radare2/libr/magic/softmagic.c"
              :
 case 
# 1195 "project/radare2/libr/magic/softmagic.c" 3 4
     8
# 1195 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 1196 "project/radare2/libr/magic/softmagic.c" 3 4
     11
# 1196 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 1197 "project/radare2/libr/magic/softmagic.c" 3 4
     23
# 1197 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 1198 "project/radare2/libr/magic/softmagic.c" 3 4
     6
# 1198 "project/radare2/libr/magic/softmagic.c"
              :
 case 
# 1199 "project/radare2/libr/magic/softmagic.c" 3 4
     9
# 1199 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 1200 "project/radare2/libr/magic/softmagic.c" 3 4
     12
# 1200 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 1201 "project/radare2/libr/magic/softmagic.c" 3 4
     21
# 1201 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 1202 "project/radare2/libr/magic/softmagic.c" 3 4
     14
# 1202 "project/radare2/libr/magic/softmagic.c"
               :
 case 
# 1203 "project/radare2/libr/magic/softmagic.c" 3 4
     15
# 1203 "project/radare2/libr/magic/softmagic.c"
                 :
 case 
# 1204 "project/radare2/libr/magic/softmagic.c" 3 4
     16
# 1204 "project/radare2/libr/magic/softmagic.c"
                 :
 case 
# 1205 "project/radare2/libr/magic/softmagic.c" 3 4
     22
# 1205 "project/radare2/libr/magic/softmagic.c"
                 :
 case 
# 1206 "project/radare2/libr/magic/softmagic.c" 3 4
     33
# 1206 "project/radare2/libr/magic/softmagic.c"
               :
 case 
# 1207 "project/radare2/libr/magic/softmagic.c" 3 4
     34
# 1207 "project/radare2/libr/magic/softmagic.c"
                 :
 case 
# 1208 "project/radare2/libr/magic/softmagic.c" 3 4
     35
# 1208 "project/radare2/libr/magic/softmagic.c"
                 :
  if (nbytes < (offset + 4)) {
   return 0;
  }
  break;
 case 
# 1213 "project/radare2/libr/magic/softmagic.c" 3 4
     36
# 1213 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 1214 "project/radare2/libr/magic/softmagic.c" 3 4
     37
# 1214 "project/radare2/libr/magic/softmagic.c"
                  :
 case 
# 1215 "project/radare2/libr/magic/softmagic.c" 3 4
     38
# 1215 "project/radare2/libr/magic/softmagic.c"
                  :
  if (nbytes < (offset + 8)) {
   return 0;
  }
  break;
 case 
# 1220 "project/radare2/libr/magic/softmagic.c" 3 4
     5
# 1220 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 1221 "project/radare2/libr/magic/softmagic.c" 3 4
     13
# 1221 "project/radare2/libr/magic/softmagic.c"
                 :
 case 
# 1222 "project/radare2/libr/magic/softmagic.c" 3 4
     20
# 1222 "project/radare2/libr/magic/softmagic.c"
                :
  ...
  break;
 case 
# 1227 "project/radare2/libr/magic/softmagic.c" 3 4
     17
# 1227 "project/radare2/libr/magic/softmagic.c"
               :
  if (nbytes < offset) {
   return 0;
  }
  break;
 case 
# 1232 "project/radare2/libr/magic/softmagic.c" 3 4
     3
# 1232 "project/radare2/libr/magic/softmagic.c"
                 :
 default:
  break;
 }
...
static 
# 1239 "project/radare2/libr/magic/softmagic.c" 3 4
      unsigned long long 
# 1239 "project/radare2/libr/magic/softmagic.c"
           file_strncmp(const char *s1, const char *s2, size_t len, 
# 1239 "project/radare2/libr/magic/softmagic.c" 3 4
                                                                    unsigned int 
# 1239 "project/radare2/libr/magic/softmagic.c"
                                                                         flags) {
 ...
 const 
# 1246 "project/radare2/libr/magic/softmagic.c" 3 4
      unsigned char 
# 1246 "project/radare2/libr/magic/softmagic.c"
          *a = (const 
# 1246 "project/radare2/libr/magic/softmagic.c" 3 4
                      unsigned char 
# 1246 "project/radare2/libr/magic/softmagic.c"
                          *)s1;
 const 
# 1247 "project/radare2/libr/magic/softmagic.c" 3 4
      unsigned char 
# 1247 "project/radare2/libr/magic/softmagic.c"
          *b = (const 
# 1247 "project/radare2/libr/magic/softmagic.c" 3 4
                      unsigned char 
# 1247 "project/radare2/libr/magic/softmagic.c"
...
# 1248 "project/radare2/libr/magic/softmagic.c" 3 4
unsigned long long 
# 1248 "project/radare2/libr/magic/softmagic.c"
     v;
 ...
 if (0L == flags) {
  ...
  while (len-- > 0) {
   if ((flags & 
# 1263 "project/radare2/libr/magic/softmagic.c" 3 4
               (1 << (2))
# 1263 "project/radare2/libr/magic/softmagic.c"
                                      ) &&
       islower(*a)) {
    if ((v = tolower (*b++) - *a++) != '\0') {
     break;
...
# 1268 "project/radare2/libr/magic/softmagic.c" 3 4
                      (1 << (3))
# 1268 "project/radare2/libr/magic/softmagic.c"
                                             ) && isupper(*a)) {
    if ((v = toupper (*b++) - *a++) != '\0') {
     break;
    }
   } else if ((flags & 
# 1272 "project/radare2/libr/magic/softmagic.c" 3 4
                      (1 << (0))
# 1272 "project/radare2/libr/magic/softmagic.c"
                                          ) && isspace(*a)) {
    a++;
    if (isspace(*b++)) {
     while (isspace (*b)) {
...
# 1282 "project/radare2/libr/magic/softmagic.c" 3 4
                      (1 << (1))
# 1282 "project/radare2/libr/magic/softmagic.c"
                                                   ) && isspace(*a)) {
    a++;
    while (isspace (*b)) {
     b++;
...
static 
# 1297 "project/radare2/libr/magic/softmagic.c" 3 4
      unsigned long long 
# 1297 "project/radare2/libr/magic/softmagic.c"
           file_strncmp16(const char *a, const char *b, size_t len, 
# 1297 "project/radare2/libr/magic/softmagic.c" 3 4
                                                                    unsigned int 
# 1297 "project/radare2/libr/magic/softmagic.c"
                                                                         flags) {
...
# 1308 "project/radare2/libr/magic/softmagic.c" 3 4
unsigned long long 
# 1308 "project/radare2/libr/magic/softmagic.c"
     l = m->value.q;
 
# 1309 "project/radare2/libr/magic/softmagic.c" 3 4
unsigned long long 
# 1309 "project/radare2/libr/magic/softmagic.c"
     v;
 float fl, fv;
 double dl, dv;
 int matched;
 ...
 switch (m->type) {
 case 
# 1316 "project/radare2/libr/magic/softmagic.c" 3 4
     1
# 1316 "project/radare2/libr/magic/softmagic.c"
              :
  v = p->b;
  break;
 case 
# 1319 "project/radare2/libr/magic/softmagic.c" 3 4
     2
# 1319 "project/radare2/libr/magic/softmagic.c"
               :
 case 
# 1320 "project/radare2/libr/magic/softmagic.c" 3 4
     7
# 1320 "project/radare2/libr/magic/softmagic.c"
                 :
 case 
# 1321 "project/radare2/libr/magic/softmagic.c" 3 4
     10
# 1321 "project/radare2/libr/magic/softmagic.c"
                 :
  v = p->h;
  break;
 case 
# 1324 "project/radare2/libr/magic/softmagic.c" 3 4
     4
# 1324 "project/radare2/libr/magic/softmagic.c"
              :
 case 
# 1325 "project/radare2/libr/magic/softmagic.c" 3 4
     8
# 1325 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 1326 "project/radare2/libr/magic/softmagic.c" 3 4
     11
# 1326 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 1327 "project/radare2/libr/magic/softmagic.c" 3 4
     23
# 1327 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 1328 "project/radare2/libr/magic/softmagic.c" 3 4
     6
# 1328 "project/radare2/libr/magic/softmagic.c"
              :
 case 
# 1329 "project/radare2/libr/magic/softmagic.c" 3 4
     9
# 1329 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 1330 "project/radare2/libr/magic/softmagic.c" 3 4
     12
# 1330 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 1331 "project/radare2/libr/magic/softmagic.c" 3 4
     21
# 1331 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 1332 "project/radare2/libr/magic/softmagic.c" 3 4
     14
# 1332 "project/radare2/libr/magic/softmagic.c"
               :
 case 
# 1333 "project/radare2/libr/magic/softmagic.c" 3 4
     15
# 1333 "project/radare2/libr/magic/softmagic.c"
                 :
 case 
# 1334 "project/radare2/libr/magic/softmagic.c" 3 4
     16
# 1334 "project/radare2/libr/magic/softmagic.c"
                 :
 case 
# 1335 "project/radare2/libr/magic/softmagic.c" 3 4
     22
# 1335 "project/radare2/libr/magic/softmagic.c"
                 :
  v = p->l;
  break;
 case 
# 1338 "project/radare2/libr/magic/softmagic.c" 3 4
     24
# 1338 "project/radare2/libr/magic/softmagic.c"
              :
 case 
# 1339 "project/radare2/libr/magic/softmagic.c" 3 4
     25
# 1339 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 1340 "project/radare2/libr/magic/softmagic.c" 3 4
     26
# 1340 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 1341 "project/radare2/libr/magic/softmagic.c" 3 4
     27
# 1341 "project/radare2/libr/magic/softmagic.c"
               :
 case 
# 1342 "project/radare2/libr/magic/softmagic.c" 3 4
     29
# 1342 "project/radare2/libr/magic/softmagic.c"
                 :
 case 
# 1343 "project/radare2/libr/magic/softmagic.c" 3 4
     28
# 1343 "project/radare2/libr/magic/softmagic.c"
                 :
 case 
# 1344 "project/radare2/libr/magic/softmagic.c" 3 4
     30
# 1344 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 1345 "project/radare2/libr/magic/softmagic.c" 3 4
     32
# 1345 "project/radare2/libr/magic/softmagic.c"
                  :
 case 
# 1346 "project/radare2/libr/magic/softmagic.c" 3 4
     31
# 1346 "project/radare2/libr/magic/softmagic.c"
                  :
  v = p->q;
  break;
 case 
# 1349 "project/radare2/libr/magic/softmagic.c" 3 4
     33
# 1349 "project/radare2/libr/magic/softmagic.c"
               :
 case 
# 1350 "project/radare2/libr/magic/softmagic.c" 3 4
     34
# 1350 "project/radare2/libr/magic/softmagic.c"
                 :
 case 
# 1351 "project/radare2/libr/magic/softmagic.c" 3 4
     35
# 1351 "project/radare2/libr/magic/softmagic.c"
                 :
  fl = m->value.f;
  fv = p->f;
  switch (m->reln) {
  ...
  return matched;
 case 
# 1365 "project/radare2/libr/magic/softmagic.c" 3 4
     36
# 1365 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 1366 "project/radare2/libr/magic/softmagic.c" 3 4
     37
# 1366 "project/radare2/libr/magic/softmagic.c"
                  :
 case 
# 1367 "project/radare2/libr/magic/softmagic.c" 3 4
     38
# 1367 "project/radare2/libr/magic/softmagic.c"
                  :
  dl = m->value.d;
  dv = p->d;
  switch (m->reln) {
  ...
  return matched;
 case 
# 1381 "project/radare2/libr/magic/softmagic.c" 3 4
     3
# 1381 "project/radare2/libr/magic/softmagic.c"
                 :
  l = 0;
  v = 0;
  break;
 case 
# 1385 "project/radare2/libr/magic/softmagic.c" 3 4
     5
# 1385 "project/radare2/libr/magic/softmagic.c"
                :
 case 
# 1386 "project/radare2/libr/magic/softmagic.c" 3 4
     13
# 1386 "project/radare2/libr/magic/softmagic.c"
                 :
  l = 0;
  v = file_strncmp (m->value.s, p->s, (size_t)m->vallen, m->
# 1388 "project/radare2/libr/magic/softmagic.c" 3 4
                                                           _u._s._flags
# 1388 "project/radare2/libr/magic/softmagic.c"
                                                                    );
  break;
 case 
# 1390 "project/radare2/libr/magic/softmagic.c" 3 4
     18
# 1390 "project/radare2/libr/magic/softmagic.c"
                    :
 case 
# 1391 "project/radare2/libr/magic/softmagic.c" 3 4
     19
# 1391 "project/radare2/libr/magic/softmagic.c"
                    :
  l = 0;
  v = file_strncmp16 (m->value.s, p->s, (size_t)m->vallen, m->
# 1393 "project/radare2/libr/magic/softmagic.c" 3 4
                                                             _u._s._flags
# 1393 "project/radare2/libr/magic/softmagic.c"
                                                                      );
  break;
 case 
# 1395 "project/radare2/libr/magic/softmagic.c" 3 4
     20
# 1395 "project/radare2/libr/magic/softmagic.c"
                : {
  size_t slen, idx;
  ...
  slen = 
# 1402 "project/radare2/libr/magic/softmagic.c" 3 4
        (((
# 1402 "project/radare2/libr/magic/softmagic.c"
        m->vallen
# 1402 "project/radare2/libr/magic/softmagic.c" 3 4
        )>(
# 1402 "project/radare2/libr/magic/softmagic.c"
...
# 1402 "project/radare2/libr/magic/softmagic.c"
  ...
  for (idx = 0; m->
# 1406 "project/radare2/libr/magic/softmagic.c" 3 4
                  _u._s._count 
# 1406 "project/radare2/libr/magic/softmagic.c"
                            == 0 || idx < m->
# 1406 "project/radare2/libr/magic/softmagic.c" 3 4
                                             _u._s._count
# 1406 "project/radare2/libr/magic/softmagic.c"
   ...
   v = file_strncmp (m->value.s, ms->search.s + idx, slen, m->
# 1413 "project/radare2/libr/magic/softmagic.c" 3 4
                                                             _u._s._flags
# 1413 "project/radare2/libr/magic/softmagic.c"
                                                                      );
   if (v == 0) {
 ...
 case 
# 1421 "project/radare2/libr/magic/softmagic.c" 3 4
     17
# 1421 "project/radare2/libr/magic/softmagic.c"
               : {
  int rc;
  RRegex rx;
  char *errmsg;
...
# 1432 "project/radare2/libr/magic/softmagic.c" 3 4
     0001
# 1432 "project/radare2/libr/magic/softmagic.c"
                     |
# 1432 "project/radare2/libr/magic/softmagic.c" 3 4
                      0010
# 1432 "project/radare2/libr/magic/softmagic.c"
                                     |
      ((m->
# 1433 "project/radare2/libr/magic/softmagic.c" 3 4
          _u._s._flags 
# 1433 "project/radare2/libr/magic/softmagic.c"
                    & 
# 1433 "project/radare2/libr/magic/softmagic.c" 3 4
                      ((1 << (2))|(1 << (3)))
# 1433 "project/radare2/libr/magic/softmagic.c"
...
# 1433 "project/radare2/libr/magic/softmagic.c"
  ...
  if (rc) {
   ...
   free (errmsg);
   v = (
# 1439 "project/radare2/libr/magic/softmagic.c" 3 4
       unsigned long long
# 1439 "project/radare2/libr/magic/softmagic.c"
           ) - 1;
  } else {
   ...
   rc = r_regex_exec (&rx, (const char *)ms->search.s, 1, pmatch, 
# 1451 "project/radare2/libr/magic/softmagic.c" 3 4
                                                                 00004
# 1451 "project/radare2/libr/magic/softmagic.c"
                                                                                 );
   ...
   case 0:
    ...
    break;
   case 
# 1462 "project/radare2/libr/magic/softmagic.c" 3 4
       1
# 1462 "project/radare2/libr/magic/softmagic.c"
                      :
    v = 1;
    break;
   default:
    ...
    free (errmsg);
    v = 
# 1469 "project/radare2/libr/magic/softmagic.c" 3 4
       0xFFFFFFFFFFFFFFFFULL
# 1469 "project/radare2/libr/magic/softmagic.c"
               ;
    break;
   }
   r_regex_fini (&rx);
  ...
  if (v == (
# 1474 "project/radare2/libr/magic/softmagic.c" 3 4
           unsigned long long
# 1474 "project/radare2/libr/magic/softmagic.c"
               )-1) {
   return -1;
  }
  break;
 ...
 case 'x':
  if ((ms->flags & 
# 1487 "project/radare2/libr/magic/softmagic.c" 3 4
                  0x000001
# 1487 "project/radare2/libr/magic/softmagic.c"
                               ) != 0) {
   (void)fprintf (
# 1488 "project/radare2/libr/magic/softmagic.c" 3 4
                 __stderrp
# 1488 "project/radare2/libr/magic/softmagic.c"
                       , "%" 
# 1488 "project/radare2/libr/magic/softmagic.c" 3 4
                             "llu" 
# 1488 "project/radare2/libr/magic/softmagic.c"
...
# 1488 "project/radare2/libr/magic/softmagic.c"
 ...
 case '!':
  matched = v != l;
  if ((ms->flags & 
# 1494 "project/radare2/libr/magic/softmagic.c" 3 4
                  0x000001
# 1494 "project/radare2/libr/magic/softmagic.c"
                               ) != 0) {
   fprintf (
# 1495 "project/radare2/libr/magic/softmagic.c" 3 4
           __stderrp
# 1495 "project/radare2/libr/magic/softmagic.c"
                 , "%" 
# 1495 "project/radare2/libr/magic/softmagic.c" 3 4
                       "llu" 
# 1495 "project/radare2/libr/magic/softmagic.c"
...
# 1495 "project/radare2/libr/magic/softmagic.c"
 ...
 case '=':
  matched = v == l;
  if ((ms->flags & 
# 1500 "project/radare2/libr/magic/softmagic.c" 3 4
                  0x000001
# 1500 "project/radare2/libr/magic/softmagic.c"
                               ) != 0) {
   
# 1501 "project/radare2/libr/magic/softmagic.c" 3 4
  fprintf(__stderrp,
# 1501 "project/radare2/libr/magic/softmagic.c"
  "%" 
# 1501 "project/radare2/libr/magic/softmagic.c" 3 4
  "llu" 
# 1501 "project/radare2/libr/magic/softmagic.c"
...
# 1501 "project/radare2/libr/magic/softmagic.c"
 ...
 case '>':
  if (m->flag & 
# 1505 "project/radare2/libr/magic/softmagic.c" 3 4
               0x08
# 1505 "project/radare2/libr/magic/softmagic.c"
                       ) {
   matched = v > l;
   if ((ms->flags & 
# 1507 "project/radare2/libr/magic/softmagic.c" 3 4
                   0x000001
# 1507 "project/radare2/libr/magic/softmagic.c"
                                ) != 0) {
    
# 1508 "project/radare2/libr/magic/softmagic.c" 3 4
   fprintf(__stderrp,
# 1508 "project/radare2/libr/magic/softmagic.c"
   "%" 
# 1508 "project/radare2/libr/magic/softmagic.c" 3 4
   "llu" 
# 1508 "project/radare2/libr/magic/softmagic.c"
...
# 1508 "project/radare2/libr/magic/softmagic.c"
   ...
   matched = (
# 1511 "project/radare2/libr/magic/softmagic.c" 3 4
             unsigned long long
# 1511 "project/radare2/libr/magic/softmagic.c"
                 ) v > (
# 1511 "project/radare2/libr/magic/softmagic.c" 3 4
                        unsigned long long
# 1511 "project/radare2/libr/magic/softmagic.c"
   ...
   if ((ms->flags & 
# 1512 "project/radare2/libr/magic/softmagic.c" 3 4
                   0x000001
# 1512 "project/radare2/libr/magic/softmagic.c"
                                ) != 0) {
    
# 1513 "project/radare2/libr/magic/softmagic.c" 3 4
   fprintf(__stderrp,
# 1513 "project/radare2/libr/magic/softmagic.c"
   "%" 
# 1513 "project/radare2/libr/magic/softmagic.c" 3 4
   "llu" 
# 1513 "project/radare2/libr/magic/softmagic.c"
...
# 1513 "project/radare2/libr/magic/softmagic.c"
 ...
 case '<':
  if (m->flag & 
# 1518 "project/radare2/libr/magic/softmagic.c" 3 4
               0x08
# 1518 "project/radare2/libr/magic/softmagic.c"
                       ) {
   matched = v < l;
   if ((ms->flags & 
# 1520 "project/radare2/libr/magic/softmagic.c" 3 4
                   0x000001
# 1520 "project/radare2/libr/magic/softmagic.c"
                                ) != 0) {
    
# 1521 "project/radare2/libr/magic/softmagic.c" 3 4
   fprintf(__stderrp,
# 1521 "project/radare2/libr/magic/softmagic.c"
   "%" 
# 1521 "project/radare2/libr/magic/softmagic.c" 3 4
   "llu" 
# 1521 "project/radare2/libr/magic/softmagic.c"
...
# 1521 "project/radare2/libr/magic/softmagic.c"
   ...
   matched = (
# 1524 "project/radare2/libr/magic/softmagic.c" 3 4
             unsigned long long
# 1524 "project/radare2/libr/magic/softmagic.c"
                 ) v < (
# 1524 "project/radare2/libr/magic/softmagic.c" 3 4
                        unsigned long long
# 1524 "project/radare2/libr/magic/softmagic.c"
   ...
   if ((ms->flags & 
# 1525 "project/radare2/libr/magic/softmagic.c" 3 4
                   0x000001
# 1525 "project/radare2/libr/magic/softmagic.c"
                                ) != 0) {
    
# 1526 "project/radare2/libr/magic/softmagic.c" 3 4
   fprintf(__stderrp,
# 1526 "project/radare2/libr/magic/softmagic.c"
   "%" 
# 1526 "project/radare2/libr/magic/softmagic.c" 3 4
   "lld" 
# 1526 "project/radare2/libr/magic/softmagic.c"
...
# 1526 "project/radare2/libr/magic/softmagic.c"
 ...
 case '&':
  matched = (v & l) == l;
  if ((ms->flags & 
# 1532 "project/radare2/libr/magic/softmagic.c" 3 4
                  0x000001
# 1532 "project/radare2/libr/magic/softmagic.c"
                               ) != 0) {
   
# 1533 "project/radare2/libr/magic/softmagic.c" 3 4
  fprintf(__stderrp,
# 1533 "project/radare2/libr/magic/softmagic.c"
  "((%" 
# 1533 "project/radare2/libr/magic/softmagic.c" 3 4
  "llx" 
# 1533 "project/radare2/libr/magic/softmagic.c"
...
# 1533 "project/radare2/libr/magic/softmagic.c"
 ...
 case '^':
  matched = (v & l) != l;
  if ((ms->flags & 
# 1538 "project/radare2/libr/magic/softmagic.c" 3 4
                  0x000001
# 1538 "project/radare2/libr/magic/softmagic.c"
                               ) != 0) {
   
# 1539 "project/radare2/libr/magic/softmagic.c" 3 4
  fprintf(__stderrp,
# 1539 "project/radare2/libr/magic/softmagic.c"
  "((%" 
# 1539 "project/radare2/libr/magic/softmagic.c" 3 4
  "llx" 
# 1539 "project/radare2/libr/magic/softmagic.c"
