# 0 "project/radare2/libr/bp/bp_plugin.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/bp/bp_plugin.c" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/bp/bp_plugin.c"
     int r_bp_plugin_del(RBreakpoint *bp, const char *name) {
 RListIter *iter;
 RBreakpointPlugin *h;
 if (name && *name) {
  
# 9 "project/radare2/libr/bp/bp_plugin.c" 3 4
 if (
# 9 "project/radare2/libr/bp/bp_plugin.c"
 bp->plugins
# 9 "project/radare2/libr/bp/bp_plugin.c" 3 4
 ) for (
# 9 "project/radare2/libr/bp/bp_plugin.c"
...
# 9 "project/radare2/libr/bp/bp_plugin.c"
   ...
   if (!strcmp (h->name, name)) {
    if (bp->cur == h) {
     bp->cur = 
# 12 "project/radare2/libr/bp/bp_plugin.c" 3 4
              ((void *)0)
# 12 "project/radare2/libr/bp/bp_plugin.c"
                  ;
    }
    r_list_delete (bp->plugins, iter);
    bp->nbps--;
    return 
# 16 "project/radare2/libr/bp/bp_plugin.c" 3 4
          1
# 16 "project/radare2/libr/bp/bp_plugin.c"
              ;
   }
  }
 }
 return 
# 20 "project/radare2/libr/bp/bp_plugin.c" 3 4
       0
# 20 "project/radare2/libr/bp/bp_plugin.c"
            ;
}


# 23 "project/radare2/libr/bp/bp_plugin.c" 3 4
__attribute__((visibility("default"))) 
# 23 "project/radare2/libr/bp/bp_plugin.c"
     int r_bp_plugin_add(RBreakpoint *bp, RBreakpointPlugin *foo) {
 RListIter *iter;
 RBreakpointPlugin *h;
 if (!bp) {
  
# 27 "project/radare2/libr/bp/bp_plugin.c" 3 4
 fprintf(__stderrp,
# 27 "project/radare2/libr/bp/bp_plugin.c"
 "Cannot add plugin because dbg->bp is null and/or plugin is null\n"
# 27 "project/radare2/libr/bp/bp_plugin.c" 3 4
 )
# 27 "project/radare2/libr/bp/bp_plugin.c"
                                                                              ;
  return 
# 28 "project/radare2/libr/bp/bp_plugin.c" 3 4
        0
# 28 "project/radare2/libr/bp/bp_plugin.c"
             ;
 }

 
# 31 "project/radare2/libr/bp/bp_plugin.c" 3 4
if (
# 31 "project/radare2/libr/bp/bp_plugin.c"
bp->bps
# 31 "project/radare2/libr/bp/bp_plugin.c" 3 4
) for (
# 31 "project/radare2/libr/bp/bp_plugin.c"
...
# 31 "project/radare2/libr/bp/bp_plugin.c"
  ...
  if (!strcmp (h->name, foo->name)) {
   return 
# 33 "project/radare2/libr/bp/bp_plugin.c" 3 4
         0
# 33 "project/radare2/libr/bp/bp_plugin.c"
              ;
  }
 }
 bp->nbps++;
 ...
 return 
# 38 "project/radare2/libr/bp/bp_plugin.c" 3 4
       1
# 38 "project/radare2/libr/bp/bp_plugin.c"
           ;
}


# 41 "project/radare2/libr/bp/bp_plugin.c" 3 4
__attribute__((visibility("default"))) 
# 41 "project/radare2/libr/bp/bp_plugin.c"
     int r_bp_use(RBreakpoint *bp, const char *name, int bits) {
 RListIter *iter;
 bp->bits = bits;
 RBreakpointPlugin *h;
 
# 45 "project/radare2/libr/bp/bp_plugin.c" 3 4
if (
# 45 "project/radare2/libr/bp/bp_plugin.c"
bp->plugins
# 45 "project/radare2/libr/bp/bp_plugin.c" 3 4
) for (
# 45 "project/radare2/libr/bp/bp_plugin.c"
...
# 45 "project/radare2/libr/bp/bp_plugin.c"
  ...
  if (!strcmp (h->name, name)) {
   bp->cur = h;
   return 
# 48 "project/radare2/libr/bp/bp_plugin.c" 3 4
         1
# 48 "project/radare2/libr/bp/bp_plugin.c"
             ;
  }
 }
 return 
# 51 "project/radare2/libr/bp/bp_plugin.c" 3 4
       0
# 51 "project/radare2/libr/bp/bp_plugin.c"
            ;
}



# 55 "project/radare2/libr/bp/bp_plugin.c" 3 4
__attribute__((visibility("default"))) 
# 55 "project/radare2/libr/bp/bp_plugin.c"
     void r_bp_plugin_list(RBreakpoint *bp) {
 RListIter *iter;
 RBreakpointPlugin *b;
 
# 58 "project/radare2/libr/bp/bp_plugin.c" 3 4
if (
# 58 "project/radare2/libr/bp/bp_plugin.c"
bp->plugins
# 58 "project/radare2/libr/bp/bp_plugin.c" 3 4
) for (
# 58 "project/radare2/libr/bp/bp_plugin.c"
