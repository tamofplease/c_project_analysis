# 0 "project/radare2/libr/bp/bp_watch.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/bp/bp_watch.c" 2


# 5 "project/radare2/libr/bp/bp_watch.c"
static void r_bp_watch_add_hw(RBreakpoint *bp, RBreakpointItem *b) {
 if (bp->breakpoint) {
  bp->breakpoint (bp, b, 
# 7 "project/radare2/libr/bp/bp_watch.c" 3 4
                        1
# 7 "project/radare2/libr/bp/bp_watch.c"
                            );
 }
}


# 11 "project/radare2/libr/bp/bp_watch.c" 3 4
__attribute__((visibility("default"))) 
# 11 "project/radare2/libr/bp/bp_watch.c"
     RBreakpointItem* r_bp_watch_add(RBreakpoint *bp, 
# 11 "project/radare2/libr/bp/bp_watch.c" 3 4
                                                      unsigned long long 
# 11 "project/radare2/libr/bp/bp_watch.c"
 ...
 RBreakpointItem *b;
 if (addr == 
# 13 "project/radare2/libr/bp/bp_watch.c" 3 4
            0xFFFFFFFFFFFFFFFFULL 
# 13 "project/radare2/libr/bp/bp_watch.c"
                     || size < 1) {
  return 
# 14 "project/radare2/libr/bp/bp_watch.c" 3 4
        ((void *)0)
# 14 "project/radare2/libr/bp/bp_watch.c"
            ;
 }
 if (r_bp_get_in (bp, addr, perm)) {
  
# 17 "project/radare2/libr/bp/bp_watch.c" 3 4
 fprintf(__stderrp,
# 17 "project/radare2/libr/bp/bp_watch.c"
...
# 17 "project/radare2/libr/bp/bp_watch.c"
                                                      ;
  return 
# 18 "project/radare2/libr/bp/bp_watch.c" 3 4
        ((void *)0)
# 18 "project/radare2/libr/bp/bp_watch.c"
            ;
 }
 b = r_bp_item_new (bp);
 ...
 b->size = size;
 b->enabled = 
# 23 "project/radare2/libr/bp/bp_watch.c" 3 4
             1
# 23 "project/radare2/libr/bp/bp_watch.c"
                 ;
 b->perm = perm;
 b->hw = hw;
 if (hw) {
...
# 29 "project/radare2/libr/bp/bp_watch.c" 3 4
 fprintf(__stderrp,
# 29 "project/radare2/libr/bp/bp_watch.c"
 "[TODO]: Software watchpoint is not implemented yet (use ESIL)\n"
# 29 "project/radare2/libr/bp/bp_watch.c" 3 4
 )
# 29 "project/radare2/libr/bp/bp_watch.c"
                                                                            ;
...
# 37 "project/radare2/libr/bp/bp_watch.c" 3 4
__attribute__((visibility("default"))) 
# 37 "project/radare2/libr/bp/bp_watch.c"
     void r_bp_watch_del(void) {
}
