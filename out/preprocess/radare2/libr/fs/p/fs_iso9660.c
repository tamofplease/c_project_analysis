# 0 "project/radare2/libr/fs/p/fs_iso9660.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/fs/p/fs_iso9660.c"
# 10 "project/radare2/libr/fs/p/fs_iso9660.c"
...
static RFSFile* iso9660__open(RFSRoot *root, const char *path, 
# 8 "project/radare2/libr/fs/p/fs_grub_base.c" 3 4
                                                           _Bool 
# 8 "project/radare2/libr/fs/p/fs_grub_base.c"
                                                                create) {
 RFSFile *file = r_fs_file_new (root, path);
 GrubFS *gfs = grubfs_new (&grub_iso9660_fs, &root->iob);
 file->ptr = gfs;
 file->p = root->p;
 grubfs_bind_io (
...
static int iso9660__read(RFSFile *file, 
...
static void iso9660__close(RFSFile *file) {
 GrubFS *gfs = file->ptr;
...
static RList *iso9660__dir(RFSRoot *root, const char *path, int view) {
 GrubFS *gfs;
...
static int iso9660__mount(RFSRoot *root) {
 int ret;
 GrubFS *gfs = grubfs_new (&grub_iso9660_fs, &root->iob);
 root->ptr = gfs;
 grubfs_bind_io (&root->iob, root->delta);
...
static void iso9660__umount(RFSRoot *root) {
...
RFSPlugin r_fs_plugin_iso9660 = {
 .name = "iso9660",
 .desc = "ISO9660 filesystem",
 .license = "GPL2",
 .open = iso9660__open,
 .read = iso9660__read,
 .close = iso9660__close,
 .dir = iso9660__dir,
 .mount = iso9660__mount,
 .umount = iso9660__umount,
};
# 11 "project/radare2/libr/fs/p/fs_iso9660.c" 2
