# 0 "project/radare2/libr/fs/p/fs_reiserfs.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/fs/p/fs_reiserfs.c"
# 10 "project/radare2/libr/fs/p/fs_reiserfs.c"
...
static RFSFile* reiserfs__open(RFSRoot *root, const char *path, 
# 8 "project/radare2/libr/fs/p/fs_grub_base.c" 3 4
                                                           _Bool 
# 8 "project/radare2/libr/fs/p/fs_grub_base.c"
                                                                create) {
 RFSFile *file = r_fs_file_new (root, path);
 GrubFS *gfs = grubfs_new (&grub_reiserfs_fs, &root->iob);
 file->ptr = gfs;
 file->p = root->p;
 grubfs_bind_io (
...
static int reiserfs__read(RFSFile *file, 
...
static void reiserfs__close(RFSFile *file) {
 GrubFS *gfs = file->ptr;
...
static RList *reiserfs__dir(RFSRoot *root, const char *path, int view) {
 GrubFS *gfs;
...
static int reiserfs__mount(RFSRoot *root) {
 int ret;
 GrubFS *gfs = grubfs_new (&grub_reiserfs_fs, &root->iob);
 root->ptr = gfs;
 grubfs_bind_io (&root->iob, root->delta);
...
static void reiserfs__umount(RFSRoot *root) {
...
RFSPlugin r_fs_plugin_reiserfs = {
 .name = "reiserfs",
 .desc = "REISERFS filesystem",
 .license = "GPL2",
 .open = reiserfs__open,
 .read = reiserfs__read,
 .close = reiserfs__close,
 .dir = reiserfs__dir,
 .mount = reiserfs__mount,
 .umount = reiserfs__umount,
};
# 11 "project/radare2/libr/fs/p/fs_reiserfs.c" 2
