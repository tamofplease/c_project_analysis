# 0 "project/radare2/libr/fs/p/fs_ext2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/fs/p/fs_ext2.c"
# 10 "project/radare2/libr/fs/p/fs_ext2.c"
...
static RFSFile* ext2__open(RFSRoot *root, const char *path, 
...
static int ext2__read(RFSFile *file, 
...
static void ext2__close(RFSFile *file) {
 GrubFS *gfs = file->ptr;
...
static RList *ext2__dir(RFSRoot *root, const char *path, int view) {
 GrubFS *gfs;
...
static int ext2__mount(RFSRoot *root) {
 int ret;
 GrubFS *gfs = grubfs_new (&grub_ext2_fs, &root->iob);
 root->ptr = gfs;
 grubfs_bind_io (&root->iob, root->delta);
...
static void ext2__umount(RFSRoot *root) {
...
# 11 "project/radare2/libr/fs/p/fs_ext2.c" 2
