# 0 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
...
# 4 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 2
...
# 5 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 2
...
# 6 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 2
...
# 7 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 2
...
# 8 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 2
...
# 9 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 2
...
# 10 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 2
...
# 11 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 2


# 12 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
static int replace(int argc, const char *argv[], char *newstr) {
 ...
 struct {
  ...
  { 
# 193 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
   ((void *)0) 
# 193 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
        }
 };

 for (i=0; ops[i].op != 
# 196 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
                       ((void *)0)
# 196 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
                           ; i++) {
  if (!strcmp (ops[i].op, argv[0])) {
   if (newstr != 
# 198 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
                ((void *)0)
# 198 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
                    ) {
    for (j=k=0;ops[i].str[j]!='\0';j++,k++) {
     if (ops[i].str[j]>='1' && ops[i].str[j]<='9') {
      const char *w = argv[ ops[i].str[j]-'0' ];
      if (w != 
# 202 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
              ((void *)0)
# 202 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
                  ) {
       
# 203 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
      __builtin___strcpy_chk (
# 203 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
      newstr+k
# 203 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
      , 
# 203 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
...
# 203 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
   ...
   return 
# 212 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
         1
# 212 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
             ;
  }
 }
 ...
 if (newstr != 
# 217 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
              ((void *)0)
# 217 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
                  ) {
  newstr[0] = '\0';
  for (i=0; i<argc; i++) {
   
# 220 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
  __builtin___strcat_chk (
# 220 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
  newstr
# 220 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
  , 
# 220 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
...
# 221 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
  __builtin___strcat_chk (
# 221 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
  newstr
# 221 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
  , 
# 221 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
...
# 221 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
 ...
 return 
# 225 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
       0
# 225 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
            ;
}
...
static int parse(RParse *p, const char *data, char *str) {
 ...
 || !strcmp (data, "DEPRECATED")) {
  str[0] = 0;
  return 
# 241 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
        1
# 241 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
            ;
 }
 ...
 if (!(buf = malloc (len + 1))) {
  return 
# 246 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
        0
# 246 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
             ;
 }
 
# 248 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
__builtin___memcpy_chk (
# 248 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
buf
# 248 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
, 
# 248 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
...
# 267 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
  __builtin___strncpy_chk (
# 267 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
  w0
# 267 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
  , 
# 267 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
...
# 269 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
  __builtin___strncpy_chk (
# 269 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
  w1
# 269 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
  , 
# 269 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
...
# 283 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
   __builtin___strncpy_chk (
# 283 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
   w1
# 283 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
   , 
# 283 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
...
# 285 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
   __builtin___strncpy_chk (
# 285 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
   w2
# 285 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
   , 
# 285 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
...
# 294 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
    __builtin___strncpy_chk (
# 294 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
    w2
# 294 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
    , 
# 294 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
...
# 296 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
    __builtin___strncpy_chk (
# 296 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
    w3
# 296 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
    , 
# 296 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
...
# 306 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
     __builtin___strncpy_chk (
# 306 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
     w3
# 306 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
     , 
# 306 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
...
# 308 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
     __builtin___strncpy_chk (
# 308 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
     w4
# 308 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
     , 
# 308 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
   ...
   replace (nw, wa, str);
{
 ...
 if (!strcmp (w1, w2)) {
  char a[32], b[32];
# 341 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
  do { int snprintf_len1_ = 
# 341 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
...
# 341 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
 ; if (snprintf_len1_ < 32 && snprintf_len2_ < 32) { p = r_str_replace (p, a, b, 0); } } while (0);
  do { int snprintf_len1_ = 
# 342 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
 __builtin___snprintf_chk (
# 342 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
 a
# 342 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
 , 
# 342 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
...
# 342 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
 ; if (snprintf_len1_ < 32 && snprintf_len2_ < 32) { p = r_str_replace (p, a, b, 0); } } while (0);
  do { int snprintf_len1_ = 
# 343 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
 __builtin___snprintf_chk (
# 343 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
 a
# 343 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
 , 
# 343 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
...
# 343 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
 ; if (snprintf_len1_ < 32 && snprintf_len2_ < 32) { p = r_str_replace (p, a, b, 0); } } while (0);
  do { int snprintf_len1_ = 
# 344 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
 __builtin___snprintf_chk (
# 344 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
 a
# 344 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
 , 
# 344 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
...
# 344 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
 ; if (snprintf_len1_ < 32 && snprintf_len2_ < 32) { p = r_str_replace (p, a, b, 0); } } while (0);
  do { int snprintf_len1_ = 
# 345 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
 __builtin___snprintf_chk (
# 345 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
 a
# 345 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
 , 
# 345 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
...
# 345 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
 ; if (snprintf_len1_ < 32 && snprintf_len2_ < 32) { p = r_str_replace (p, a, b, 0); } } while (0);
  do { int snprintf_len1_ = 
# 346 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
 __builtin___snprintf_chk (
# 346 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
 a
# 346 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
 , 
# 346 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
...
# 346 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
 ; if (snprintf_len1_ < 32 && snprintf_len2_ < 32) { p = r_str_replace (p, a, b, 0); } } while (0);
  do { int snprintf_len1_ = 
# 347 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
 __builtin___snprintf_chk (
# 347 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
 a
# 347 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
 , 
# 347 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
...
# 349 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
__builtin___strcpy_chk (
# 349 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
str
# 349 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
, 
# 349 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
...
# 349 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
 ...
 free (buf);
 return 
# 355 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
       1
# 355 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
           ;
}
...
RParsePlugin r_parse_plugin_dalvik_pseudo = {
 ...
 .init = 
# 361 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
        ((void *)0)
# 361 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
            ,
 .fini = 
# 362 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
        ((void *)0)
# 362 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
            ,
 .parse = parse,
};
...
# 367 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
__attribute__((visibility("default"))) 
# 367 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_PARSE,
 .data = &r_parse_plugin_dalvik_pseudo,
 .version = 
# 370 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c" 3 4
           "5.5.4"

# 371 "project/radare2/libr/parse/p/parse_dalvik_pseudo.c"
};
