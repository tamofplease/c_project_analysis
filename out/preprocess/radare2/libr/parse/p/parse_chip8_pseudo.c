# 0 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
...
# 4 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 2
...
# 5 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 2
...
# 6 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 2
...
# 7 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 2
...
# 8 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 2





# 12 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
static void concat(char *buf, size_t len, const char** args) {
 ...
 while ((arg = *args++)) {
  if (
# 18 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
     __builtin___snprintf_chk (
# 18 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
     dest
# 18 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
     , 
# 18 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
...
static int replace(int argc, char *argv[], char *newstr, size_t len) {
 ...
 struct {
  ...
  { "add", (const char*[]){ argv[1], " += ", argv[2], 
# 33 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                                      ((void *)0) 
# 33 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                                           } },
  { "and", (const char*[]){ argv[1], " &= ", argv[2], 
# 34 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                                      ((void *)0) 
# 34 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                                           } },
  { "cls", (const char*[]){ "clear_screen()", 
# 35 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                              ((void *)0) 
# 35 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                                   } },
  { "drw", (const char*[]){ "draw(", argv[1], ", ", argv[2], ", ", argv[3], ")", 
# 36 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                                                                 ((void *)0) 
# 36 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                                                                      } },
  { "exit", (const char*[]){ "exit()", 
# 37 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                      ((void *)0) 
# 37 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                           } },
  { "high", (const char*[]){ "high_res()", 
# 38 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                          ((void *)0) 
# 38 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                               } },
  { "jp", (const char*[]){ "goto ", argv[1], 
# 39 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                              ((void *)0) 
# 39 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                                   } },
  { "ld", (const char*[]){ argv[1], " = ", argv[2], 
# 40 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                                     ((void *)0) 
# 40 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                                          } },
  { "low", (const char*[]){ "low_res()", 
# 41 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                         ((void *)0) 
# 41 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                              } },
  { "or", (const char*[]){ argv[1], " |= ", argv[2], 
# 42 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                                      ((void *)0) 
# 42 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                                           } },
  { "rnd", (const char*[]){ argv[1], " = random(256) & ", argv[2], 
# 43 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                                                   ((void *)0) 
# 43 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                                                        } },
  { "scd", (const char*[]){ "scroll_down(", argv[1], ")", 
# 44 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                                          ((void *)0) 
# 44 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                                               } },
  { "scl", (const char*[]){ "scroll_left()", 
# 45 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                             ((void *)0) 
# 45 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                                  } },
  { "scr", (const char*[]){ "scroll_right()", 
# 46 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                              ((void *)0) 
# 46 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                                   } },
  { "se", (const char*[]){ "skip_next_instr if ", argv[1], " == ", argv[2], 
# 47 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                                                             ((void *)0) 
# 47 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                                                                  } },
  { "shl", (const char*[]){ argv[1], " <<= 1", 
# 48 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                               ((void *)0) 
# 48 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                                    } },
  { "shr", (const char*[]){ argv[1], " >>= 1", 
# 49 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                               ((void *)0) 
# 49 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                                    } },
  { "sknp", (const char*[]){ "skip_next_instr if !key_pressed(", argv[1], ")", 
# 50 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                                                              ((void *)0) 
# 50 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                                                                   } },
  { "skp", (const char*[]){ "skip_next_instr if key_pressed(", argv[1], ")", 
# 51 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                                                             ((void *)0) 
# 51 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                                                                  } },
  { "sne", (const char*[]){ "skip_next_instr if ", argv[1], " != ", argv[2], 
# 52 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                                                             ((void *)0) 
# 52 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                                                                  } },
  { "sub", (const char*[]){ argv[1], " -= ", argv[2], 
# 53 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                                      ((void *)0) 
# 53 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                                           } },
  { "subn", (const char*[]){ argv[1], " = ", argv[2], " - ", argv[1], 
# 54 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                                                     ((void *)0) 
# 54 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                                                          } },
  { "xor", (const char*[]){ argv[1], " ^= ", argv[2], 
# 55 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                                                      ((void *)0) 
# 55 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                                                           } },
  { 
# 56 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
   ((void *)0) 
# 56 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
        }
 };
 ...
 for (i = 0; ops[i].op; i++) {
  if (!strcmp (ops[i].op, argv[0]) && newstr) {
   ...
   return 
# 62 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
         1
# 62 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
             ;
  }
 }

 return 
# 66 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
       0
# 66 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
            ;
}
...
# 77 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
 __builtin___memcpy_chk (
# 77 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
 token
# 77 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
 , 
# 77 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
...
static int parse(RParse *p, const char *data, char *str) {
 int i;
 char *argv[4] = { 
# 93 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                        ((void *)0)
# 93 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
                            , 
# 93 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
                              ((void *)0)
# 93 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
...
# 93 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
 ...
 if (!replace (argc, argv, str, 64)) {
  
# 97 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
 __builtin___strcpy_chk (
# 97 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
 str
# 97 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
 , 
# 97 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
...
# 97 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
 ...
 return 
# 104 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
       1
# 104 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
           ;
}
...
# 114 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
__attribute__((visibility("default"))) 
# 114 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_PARSE,
 .data = &r_parse_plugin_chip8_pseudo,
 .version = 
# 117 "project/radare2/libr/parse/p/parse_chip8_pseudo.c" 3 4
           "5.5.4"

# 118 "project/radare2/libr/parse/p/parse_chip8_pseudo.c"
};
