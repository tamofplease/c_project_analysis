# 0 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
...
# 4 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 2
...
# 5 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 2
...
# 6 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 2
...
# 7 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 2


# 8 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
static int replace(int argc, const char *argv[], char *newstr) {
 ...
 struct {
  ...
  { 0, "sub", "# = # - #", { 1, 2, 3 } },
  { 0, 
# 50 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
      ((void *)0) 
# 50 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
           }
 };
 if (!newstr) {
  return 
# 53 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
        0
# 53 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
             ;
 }
...
# 82 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
      __builtin___strcpy_chk (
# 82 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
      newstr + k
# 82 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
      , 
# 82 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
...
# 82 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
   ...
   r_str_replace_char (newstr, '}', ')');
   return 
# 93 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
         1
# 93 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
             ;
  }
 }
...
# 100 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
 __builtin___strcat_chk (
# 100 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
 newstr
# 100 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
 , 
# 100 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
...
# 101 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
 __builtin___strcat_chk (
# 101 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
 newstr
# 101 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
 , 
# 101 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
...
# 101 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
 ...
 r_str_replace_char (newstr, '}', ')');
 return 
# 106 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
       0
# 106 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
            ;
}
...
static int parse(RParse *p, const char *data, char *str) {
 ...
 if (len >= sizeof (w0)) {
  return 
# 115 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
        0
# 115 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
             ;
 }

 if (!(buf = malloc (len + 1))) {
  return 
# 119 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
        0
# 119 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
             ;
 }
 
# 121 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
__builtin___memcpy_chk (
# 121 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
buf
# 121 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
, 
# 121 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
...
# 133 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
  __builtin___strncpy_chk (
# 133 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
  w0
# 133 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
  , 
# 133 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
...
# 134 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
  __builtin___strncpy_chk (
# 134 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
  w1
# 134 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
  , 
# 134 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
...
# 147 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
   fprintf(__stderrp,
# 147 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
   "Unbalanced bracket\n"
# 147 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
   )
# 147 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
    ...
    free(buf);
    return 
# 149 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
          0
# 149 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
               ;
   }
   ptr = strchr (ptr, ',');
   if (ptr) {
...
# 157 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
   __builtin___strncpy_chk (
# 157 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
   w1
# 157 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
   , 
# 157 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
...
# 158 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
   __builtin___strncpy_chk (
# 158 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
   w2
# 158 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
   , 
# 158 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
...
# 166 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
    __builtin___strncpy_chk (
# 166 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
    w2
# 166 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
    , 
# 166 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
...
# 167 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
    __builtin___strncpy_chk (
# 167 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
    w3
# 167 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
    , 
# 167 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
...
# 180 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
    __builtin___memmove_chk ((
# 180 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
    num + 1
# 180 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
    ), (
# 180 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
...
# 186 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
      __builtin___snprintf_chk (
# 186 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
      ptr
# 186 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
      , 
# 186 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
...
# 188 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
      __builtin___snprintf_chk (
# 188 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
      ptr
# 188 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
      , 
# 188 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
...
# 212 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
 __builtin___strcpy_chk (
# 212 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
 str
# 212 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
 , 
# 212 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
...
# 212 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
 ...
 free (buf);
 return 
# 216 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
       1
# 216 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
           ;
}
...
# 226 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
__attribute__((visibility("default"))) 
# 226 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_PARSE,
 .data = &r_parse_plugin_riscv_pseudo,
 .version = 
# 229 "project/radare2/libr/parse/p/parse_riscv_pseudo.c" 3 4
           "5.5.4"
# 229 "project/radare2/libr/parse/p/parse_riscv_pseudo.c"
                     };
