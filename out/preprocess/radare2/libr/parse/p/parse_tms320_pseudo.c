# 0 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
...
# 4 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 2
...
# 5 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 2
...
# 6 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 2
...
# 7 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 2




# 10 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
static int replace(int argc, const char *argv[], char *newstr) {
 ...
 struct {
  ...
  {3, "shlmb", "3 = << 1"},
  {4, "set", "4 = 2 .bitset 1 .. 2"},
  {4, "clr", "4 = 2 .bitclear 1 .. 2"},
  {0, "invalid", ""},
  {0, "nop", ""},
  {0, 
# 95 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
     ((void *)0)
# 95 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
         }
 };
 if (!newstr) {
  return 
# 98 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
        0
# 98 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
             ;
 }
 ...
 for (i = 0; ops[i].op; i++) {
  ...
  if (!strcmp (ops[i].op, argv[0])) {
   for (j = k = 0; ops[i].str[j]; j++, k++) {
    if (
# 109 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
       ((
# 109 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
       ops[i].str[j]
# 109 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
       ) >= '0' && (
# 109 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
...
# 109 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
     ...
     if (index >= 0 && index < argc) {
      ...
      if (!
# 113 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
          (!(
# 113 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
          w
# 113 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
          ) || !*(
# 113 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
...
# 114 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
      __builtin___memmove_chk ((
# 114 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
      newstr + k
# 114 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
      ), (
# 114 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
...
# 124 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
   __builtin___strcat_chk (
# 124 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
   newstr + k
# 124 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
   , 
# 124 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
...
# 125 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
   __builtin___strcat_chk (
# 125 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
   newstr + k + 3
# 125 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
   , 
# 125 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
...
# 125 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
   ...
   return 
# 127 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
         1
# 127 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
             ;
  }
 }
...
# 134 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
 __builtin___strcat_chk (
# 134 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
 newstr
# 134 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
 , 
# 134 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
...
# 135 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
 __builtin___strcat_chk (
# 135 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
 newstr
# 135 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
 , 
# 135 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
...
# 135 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
 ...
 return 
# 137 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
       0
# 137 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
            ;
}
...
static int parse(RParse *p, const char *data, char *str) {
 ...
 if (
# 144 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
    (!(
# 144 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
    data
# 144 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
    ) || !*(
# 144 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
...
# 144 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
  ...
  *str = 0;
  return 
# 146 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
        0
# 146 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
             ;
 }
 ...
 wa[0] = buf;
 RList *list = 
# 156 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
              ((void *)0)
# 156 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
                  ;
 if (sp) {
  *sp++ = 0;
...
# 161 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
 if (
# 161 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
 list
# 161 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
 ) for (
# 161 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
...
# 161 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
 ...
 return 
# 174 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
       1
# 174 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
           ;
}
...
# 184 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
__attribute__((visibility("default"))) 
# 184 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_PARSE,
 .data = &r_parse_plugin_tms320_pseudo,
 .version = 
# 187 "project/radare2/libr/parse/p/parse_tms320_pseudo.c" 3 4
           "5.5.4"
# 187 "project/radare2/libr/parse/p/parse_tms320_pseudo.c"
                     };
