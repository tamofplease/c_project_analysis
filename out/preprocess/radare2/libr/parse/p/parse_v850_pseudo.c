# 0 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
...
# 4 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 2
...
# 5 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 2
...
# 6 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 2
...
# 7 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 2




# 10 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
static int replace(int argc, const char *argv[], char *newstr) {
 ...
 struct {
  ...
  {2, "jarl", "call 1 # 2"},
  {0, 
# 66 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
     ((void *)0)
# 66 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
         }
 };
 if (!newstr) {
  return 
# 69 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
        0
# 69 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
             ;
 }
 ...
 for (i = 0; ops[i].op; i++) {
  ...
  if (!strcmp (ops[i].op, argv[0])) {
   for (j = k = 0; ops[i].str[j]; j++, k++) {
    if (
# 80 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
       ((
# 80 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
       ops[i].str[j]
# 80 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
       ) >= '0' && (
# 80 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
...
# 80 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
     ...
     if (index >= 0 && index < argc) {
      ...
      if (!
# 84 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
          (!(
# 84 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
          w
# 84 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
          ) || !*(
# 84 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
...
# 85 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
      __builtin___memmove_chk ((
# 85 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
      newstr + k
# 85 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
      ), (
# 85 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
...
# 104 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
   __builtin___strcat_chk (
# 104 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
   newstr + k
# 104 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
   , 
# 104 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
...
# 105 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
   __builtin___strcat_chk (
# 105 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
   newstr + k + 3
# 105 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
   , 
# 105 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
...
# 105 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
   ...
   return 
# 107 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
         1
# 107 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
             ;
  }
 }
...
# 114 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
 __builtin___strcat_chk (
# 114 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
 newstr
# 114 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
 , 
# 114 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
...
# 115 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
 __builtin___strcat_chk (
# 115 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
 newstr
# 115 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
 , 
# 115 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
...
# 115 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
 ...
 r_str_replace_in (newstr, strlen (newstr), "+= -", "-= ", 
# 117 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
                                                          1
# 117 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
                                                              );
 r_str_replace_in (newstr, strlen (newstr), " + -", " - ", 
# 118 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
                                                          1
# 118 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
                                                              );

 return 
# 120 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
       0
# 120 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
            ;
}
...
# 138 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
  __builtin___sprintf_chk (
# 138 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
  buf
# 138 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
...
# 145 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
_Bool 
# 145 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
     braces = 
# 145 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
              0
# 145 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
 ...
 for (;*p;p++) {
  ...
  case '{':
   braces = 
# 150 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
           1
# 150 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
               ;
   break;
  case '}':
   braces = 
# 153 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
           0
# 153 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
                ;
   break;
  case ',':
   if (braces) {
...
static int parse(RParse *p, const char *data, char *str) {
 ...
 if (
# 168 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
    (!(
# 168 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
    data
# 168 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
    ) || !*(
# 168 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
...
# 168 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
  ...
  *str = 0;
  return 
# 170 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
        0
# 170 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
             ;
 }
 ...
 wa[0] = buf;
 RList *list = 
# 180 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
              ((void *)0)
# 180 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
                  ;
 if (sp) {
  *sp++ = 0;
...
# 185 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
 if (
# 185 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
 list
# 185 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
 ) for (
# 185 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
...
# 185 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
 ...
 return 
# 198 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
       1
# 198 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
           ;
}
...
# 208 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
__attribute__((visibility("default"))) 
# 208 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_PARSE,
 .data = &r_parse_plugin_v850_pseudo,
 .version = 
# 211 "project/radare2/libr/parse/p/parse_v850_pseudo.c" 3 4
           "5.5.4"
# 211 "project/radare2/libr/parse/p/parse_v850_pseudo.c"
                     };
