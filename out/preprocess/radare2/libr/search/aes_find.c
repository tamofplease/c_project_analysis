# 0 "project/radare2/libr/search/aes_find.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 13 "project/radare2/libr/search/aes_find.c" 2
...
static const unsigned char InvSbox[256] = {
    ...
    0x55, 0x21, 0x0c, 0x7d};
# 14 "project/radare2/libr/search/aes_find.c" 2
# 22 "project/radare2/libr/search/aes_find.c"

# 22 "project/radare2/libr/search/aes_find.c"
static 
# 22 "project/radare2/libr/search/aes_find.c" 3 4
      _Bool 
# 22 "project/radare2/libr/search/aes_find.c"
           aes256_key_test(const unsigned char *buf) {
 
# 23 "project/radare2/libr/search/aes_find.c" 3 4
_Bool 
# 23 "project/radare2/libr/search/aes_find.c"
     word1 = buf[32] == (buf[0] ^ Sbox[buf[29]] ^ 1)
  && buf[33] == (buf[1] ^ Sbox[buf[30]])
  && buf[34] == (buf[2] ^ Sbox[buf[31]])
  && buf[35] == (buf[3] ^ Sbox[buf[28]]);
 
# 27 "project/radare2/libr/search/aes_find.c" 3 4
_Bool 
# 27 "project/radare2/libr/search/aes_find.c"
     word2 = (buf[36] == (buf[4] ^ buf[32])
  && buf[37] == (buf[5] ^ buf[33])
  && buf[38] == (buf[6] ^ buf[34])
  && buf[39] == (buf[7] ^ buf[35]));
 return word1 && word2;
...
static 
# 34 "project/radare2/libr/search/aes_find.c" 3 4
      _Bool 
# 34 "project/radare2/libr/search/aes_find.c"
           aes192_key_test(const unsigned char *buf) {
 
# 35 "project/radare2/libr/search/aes_find.c" 3 4
_Bool 
# 35 "project/radare2/libr/search/aes_find.c"
     word1 = buf[24] == (buf[0] ^ Sbox[buf[21]] ^ 1)
  && buf[25] == (buf[1] ^ Sbox[buf[22]])
  && buf[26] == (buf[2] ^ Sbox[buf[23]])
  && buf[27] == (buf[3] ^ Sbox[buf[20]]);
 
# 39 "project/radare2/libr/search/aes_find.c" 3 4
_Bool 
# 39 "project/radare2/libr/search/aes_find.c"
     word2 = buf[28] == (buf[4] ^ buf[24])
  && buf[29] == (buf[5] ^ buf[25])
  && buf[30] == (buf[6] ^ buf[26])
  && buf[31] == (buf[7] ^ buf[27]);
 return word1 && word2;
...
static 
# 46 "project/radare2/libr/search/aes_find.c" 3 4
      _Bool 
# 46 "project/radare2/libr/search/aes_find.c"
           aes128_key_test(const unsigned char *buf) {
 
# 47 "project/radare2/libr/search/aes_find.c" 3 4
_Bool 
# 47 "project/radare2/libr/search/aes_find.c"
     word1 = buf[16] == (buf[0] ^ Sbox[buf[13]] ^ 1)
  && buf[17] == (buf[1] ^ Sbox[buf[14]])
  && buf[18] == (buf[2] ^ Sbox[buf[15]])
  && buf[19] == (buf[3] ^ Sbox[buf[12]]);
 
# 51 "project/radare2/libr/search/aes_find.c" 3 4
_Bool 
# 51 "project/radare2/libr/search/aes_find.c"
...
# 58 "project/radare2/libr/search/aes_find.c" 3 4
                                       unsigned long long 
# 58 "project/radare2/libr/search/aes_find.c"
                                            from, const 
# 58 "project/radare2/libr/search/aes_find.c" 3 4
                                                        unsigned char 
# 58 "project/radare2/libr/search/aes_find.c"
...
# 64 "project/radare2/libr/search/aes_find.c" 3 4
if (
# 64 "project/radare2/libr/search/aes_find.c"
s->kws
# 64 "project/radare2/libr/search/aes_find.c" 3 4
) for (
# 64 "project/radare2/libr/search/aes_find.c"
...
# 64 "project/radare2/libr/search/aes_find.c"
  ...
  if (last >= 0) {
   for (i = 0; i < last; i++) {
    ...
    if (len - i - 32 >= 0 && aes192_key_test (buf + i)) {
    ...
    if (len - i - 40 >= 0 && aes256_key_test (buf + i)) {
