# 0 "project/radare2/libr/search/search.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/search/search.c"
...
# 4 "project/radare2/libr/search/search.c" 2


# 1 "project/radare2/libr/search/search.h" 1

 
# 2 "project/radare2/libr/search/search.h"
     int search_kw_update(RSearch *s, 
# 2 "project/radare2/libr/search/search.h" 3 4
                                      unsigned long long 
# 2 "project/radare2/libr/search/search.h"
                                           from, const 
# 2 "project/radare2/libr/search/search.h" 3 4
...
# 2 "project/radare2/libr/search/search.h"
                                                           *buf, int len);
 int search_aes_update(RSearch *s, 
# 3 "project/radare2/libr/search/search.h" 3 4
                                       unsigned long long 
# 3 "project/radare2/libr/search/search.h"
                                            from, const 
# 3 "project/radare2/libr/search/search.h" 3 4
                                                        unsigned char 
# 3 "project/radare2/libr/search/search.h"
                                                            *buf, int len);
 int search_privkey_update(RSearch *s, 
# 4 "project/radare2/libr/search/search.h" 3 4
                                           unsigned long long 
# 4 "project/radare2/libr/search/search.h"
                                                from, const 
# 4 "project/radare2/libr/search/search.h" 3 4
                                                            unsigned char 
# 4 "project/radare2/libr/search/search.h"
                                                                *buf, int len);
 int search_deltakey_update(RSearch *s, 
# 5 "project/radare2/libr/search/search.h" 3 4
                                            unsigned long long 
# 5 "project/radare2/libr/search/search.h"
                                                 from, const 
# 5 "project/radare2/libr/search/search.h" 3 4
                                                             unsigned char 
# 5 "project/radare2/libr/search/search.h"
                                                                 *buf, int len);
 int search_strings_update(RSearch *s, 
# 6 "project/radare2/libr/search/search.h" 3 4
                                           unsigned long long 
# 6 "project/radare2/libr/search/search.h"
                                                from, const 
# 6 "project/radare2/libr/search/search.h" 3 4
                                                            unsigned char 
# 6 "project/radare2/libr/search/search.h"
                                                                *buf, int len);
 int search_regexp_update(RSearch *s, 
# 7 "project/radare2/libr/search/search.h" 3 4
                                          unsigned long long 
# 7 "project/radare2/libr/search/search.h"
                                               from, const 
# 7 "project/radare2/libr/search/search.h" 3 4
                                                           unsigned char 
# 7 "project/radare2/libr/search/search.h"
                                                               *buf, int len);
# 7 "project/radare2/libr/search/search.c" 2





# 11 "project/radare2/libr/search/search.c" 3 4
__attribute__((visibility("default"))) const char *
# 11 "project/radare2/libr/search/search.c"
r_search_version
# 11 "project/radare2/libr/search/search.c" 3 4
(void) { return "" "5.5.4"; }
# 11 "project/radare2/libr/search/search.c"
...
# 14 "project/radare2/libr/search/search.c" 3 4
unsigned long long 
# 14 "project/radare2/libr/search/search.c"
     end;
 int len;
 
# 16 "project/radare2/libr/search/search.c" 3 4
unsigned char 
# 16 "project/radare2/libr/search/search.c"
    data[];
} RSearchLeftover;


# 19 "project/radare2/libr/search/search.c" 3 4
__attribute__((visibility("default"))) 
# 19 "project/radare2/libr/search/search.c"
     RSearch *r_search_new(int mode) {
 RSearch *s = 
# 20 "project/radare2/libr/search/search.c" 3 4
             (
# 20 "project/radare2/libr/search/search.c"
             RSearch
# 20 "project/radare2/libr/search/search.c" 3 4
             *)calloc(1,sizeof(
# 20 "project/radare2/libr/search/search.c"
...
# 20 "project/radare2/libr/search/search.c"
 ...
 if (!s) {
  return 
# 22 "project/radare2/libr/search/search.c" 3 4
        ((void *)0)
# 22 "project/radare2/libr/search/search.c"
            ;
 }
 if (!r_search_set_mode (s, mode)) {
  free (s);
  
# 26 "project/radare2/libr/search/search.c" 3 4
 fprintf(__stderrp,
# 26 "project/radare2/libr/search/search.c"
 "Cannot init search for mode %d\n", mode
# 26 "project/radare2/libr/search/search.c" 3 4
 )
# 26 "project/radare2/libr/search/search.c"
                                                   ;
  return 
# 27 "project/radare2/libr/search/search.c" 3 4
        0
# 27 "project/radare2/libr/search/search.c"
             ;
 }
 s->inverse = 
# 29 "project/radare2/libr/search/search.c" 3 4
             0
# 29 "project/radare2/libr/search/search.c"
                  ;
 s->data = 
# 30 "project/radare2/libr/search/search.c" 3 4
          ((void *)0)
# 30 "project/radare2/libr/search/search.c"
              ;
 s->datafree = free;
 s->user = 
# 32 "project/radare2/libr/search/search.c" 3 4
          ((void *)0)
# 32 "project/radare2/libr/search/search.c"
              ;
 s->callback = 
# 33 "project/radare2/libr/search/search.c" 3 4
              ((void *)0)
# 33 "project/radare2/libr/search/search.c"
                  ;
 s->align = 0;
 s->distance = 0;
 s->contiguous = 0;
 s->overlap = 
# 37 "project/radare2/libr/search/search.c" 3 4
             0
# 37 "project/radare2/libr/search/search.c"
                  ;
 s->pattern_size = 0;
 s->string_max = 255;
 s->string_min = 3;
 ...
 if (!s->kws) {
  r_search_free (s);
  return 
# 47 "project/radare2/libr/search/search.c" 3 4
        ((void *)0)
# 47 "project/radare2/libr/search/search.c"
            ;
 }
...
# 53 "project/radare2/libr/search/search.c" 3 4
__attribute__((visibility("default"))) 
# 53 "project/radare2/libr/search/search.c"
     void r_search_free(RSearch *s) {
 if (s) {
  r_list_free (s->hits);
  r_list_free (s->kws);
...
# 65 "project/radare2/libr/search/search.c" 3 4
__attribute__((visibility("default"))) 
# 65 "project/radare2/libr/search/search.c"
     int r_search_set_string_limits(RSearch *s, 
# 65 "project/radare2/libr/search/search.c" 3 4
                                                unsigned int 
# 65 "project/radare2/libr/search/search.c"
                                                     min, 
...
# 65 "project/radare2/libr/search/search.c"
 ...
 if (max < min) {
  return 
# 67 "project/radare2/libr/search/search.c" 3 4
        0
# 67 "project/radare2/libr/search/search.c"
             ;
 }
 s->string_min = min;
 s->string_max = max;
 return 
# 71 "project/radare2/libr/search/search.c" 3 4
       1
# 71 "project/radare2/libr/search/search.c"
           ;
}

static int search_magic_update(RSearch *s, 
# 74 "project/radare2/libr/search/search.c" 3 4
                                          unsigned long long 
# 74 "project/radare2/libr/search/search.c"
                                               from, const 
# 74 "project/radare2/libr/search/search.c" 3 4
                                                           unsigned char 
# 74 "project/radare2/libr/search/search.c"
...
# 75 "project/radare2/libr/search/search.c" 3 4
fprintf(__stderrp,
# 75 "project/radare2/libr/search/search.c"
"TODO: import libr/core/cmd_search.c /m implementation into rsearch\n"
# 75 "project/radare2/libr/search/search.c" 3 4
)
# 75 "project/radare2/libr/search/search.c"
                                                                                ;
 return 
# 76 "project/radare2/libr/search/search.c" 3 4
       0
# 76 "project/radare2/libr/search/search.c"
            ;
}


# 79 "project/radare2/libr/search/search.c" 3 4
__attribute__((visibility("default"))) 
# 79 "project/radare2/libr/search/search.c"
     int r_search_set_mode(RSearch *s, int mode) {
 s->update = 
# 80 "project/radare2/libr/search/search.c" 3 4
            ((void *)0)
# 80 "project/radare2/libr/search/search.c"
                ;
 switch (mode) {
 ...
 if (s->update || mode == R_SEARCH_PATTERN) {
  s->mode = mode;
  return 
# 92 "project/radare2/libr/search/search.c" 3 4
        1
# 92 "project/radare2/libr/search/search.c"
            ;
 }
 return 
# 94 "project/radare2/libr/search/search.c" 3 4
       0
# 94 "project/radare2/libr/search/search.c"
            ;
}


# 97 "project/radare2/libr/search/search.c" 3 4
__attribute__((visibility("default"))) 
# 97 "project/radare2/libr/search/search.c"
     int r_search_begin(RSearch *s) {
 RListIter *iter;
 RSearchKeyword *kw;
 
# 100 "project/radare2/libr/search/search.c" 3 4
if (
# 100 "project/radare2/libr/search/search.c"
s->kws
# 100 "project/radare2/libr/search/search.c" 3 4
) for (
# 100 "project/radare2/libr/search/search.c"
...
# 100 "project/radare2/libr/search/search.c"
 ...
 return 
# 104 "project/radare2/libr/search/search.c" 3 4
       1
# 104 "project/radare2/libr/search/search.c"
           ;
}



# 108 "project/radare2/libr/search/search.c" 3 4
__attribute__((visibility("default"))) 
# 108 "project/radare2/libr/search/search.c"
     int r_search_hit_new(RSearch *s, RSearchKeyword *kw, 
# 108 "project/radare2/libr/search/search.c" 3 4
                                                          unsigned long long 
# 108 "project/radare2/libr/search/search.c"
                                                               addr) {
...
# 110 "project/radare2/libr/search/search.c" 3 4
 fprintf(__stderrp,
# 110 "project/radare2/libr/search/search.c"
 "0x%08"
# 110 "project/radare2/libr/search/search.c" 3 4
 "llx"
# 110 "project/radare2/libr/search/search.c"
...
# 117 "project/radare2/libr/search/search.c" 3 4
  fprintf(__stderrp,
# 117 "project/radare2/libr/search/search.c"
  "0x%08"
# 117 "project/radare2/libr/search/search.c" 3 4
  "llx"
# 117 "project/radare2/libr/search/search.c"
  " Sequential hit ignored.\n", addr
# 117 "project/radare2/libr/search/search.c" 3 4
  )
# 117 "project/radare2/libr/search/search.c"
                                                            ;
 ...
 s->nhits++;
 RSearchHit* hit = 
# 133 "project/radare2/libr/search/search.c" 3 4
                  (
# 133 "project/radare2/libr/search/search.c"
                  RSearchHit
# 133 "project/radare2/libr/search/search.c" 3 4
                  *)calloc(1,sizeof(
# 133 "project/radare2/libr/search/search.c"
...
# 133 "project/radare2/libr/search/search.c"
 ...
 int search_deltakey_update(RSearch *s, 
# 144 "project/radare2/libr/search/search.c" 3 4
                                            unsigned long long 
# 144 "project/radare2/libr/search/search.c"
                                                 from, const 
# 144 "project/radare2/libr/search/search.c" 3 4
                                                             unsigned char 
# 144 "project/radare2/libr/search/search.c"
...
# 150 "project/radare2/libr/search/search.c" 3 4
if (
# 150 "project/radare2/libr/search/search.c"
s->kws
# 150 "project/radare2/libr/search/search.c" 3 4
) for (
# 150 "project/radare2/libr/search/search.c"
...
# 150 "project/radare2/libr/search/search.c"
                                  {
  longest = 
# 151 "project/radare2/libr/search/search.c" 3 4
           (((
# 151 "project/radare2/libr/search/search.c"
           longest
# 151 "project/radare2/libr/search/search.c" 3 4
           )>(
# 151 "project/radare2/libr/search/search.c"
...
# 169 "project/radare2/libr/search/search.c" 3 4
  if (
# 169 "project/radare2/libr/search/search.c"
  s->kws
# 169 "project/radare2/libr/search/search.c" 3 4
  ) for (
# 169 "project/radare2/libr/search/search.c"
...
# 170 "project/radare2/libr/search/search.c" 3 4
   unsigned char 
# 170 "project/radare2/libr/search/search.c"
       *i = kw->bin_keyword, *j = kw->bin_keyword + kw->keyword_length;
    for (; i < j; i++) {
     *i = -*i;
    }
   }
...
# 179 "project/radare2/libr/search/search.c" 3 4
 unsigned char 
# 179 "project/radare2/libr/search/search.c"
     *i = (
# 179 "project/radare2/libr/search/search.c" 3 4
           unsigned char 
# 179 "project/radare2/libr/search/search.c"
...
# 181 "project/radare2/libr/search/search.c" 3 4
  unsigned char 
# 181 "project/radare2/libr/search/search.c"
      t = *i;
   *i++ = *--j;
   *j = t;
  }
...
# 187 "project/radare2/libr/search/search.c" 3 4
unsigned long long 
# 187 "project/radare2/libr/search/search.c"
     len1 = left->len + 
# 187 "project/radare2/libr/search/search.c" 3 4
                        (((
# 187 "project/radare2/libr/search/search.c"
...
# 188 "project/radare2/libr/search/search.c" 3 4
__builtin___memcpy_chk (
# 188 "project/radare2/libr/search/search.c"
left->data + left->len
# 188 "project/radare2/libr/search/search.c" 3 4
, 
# 188 "project/radare2/libr/search/search.c"
...
# 189 "project/radare2/libr/search/search.c" 3 4
if (
# 189 "project/radare2/libr/search/search.c"
s->kws
# 189 "project/radare2/libr/search/search.c" 3 4
) for (
# 189 "project/radare2/libr/search/search.c"
...
# 190 "project/radare2/libr/search/search.c" 3 4
 unsigned char 
# 190 "project/radare2/libr/search/search.c"
     *a = kw->bin_keyword;
  ...
  for (; i + kw->keyword_length < len1 && i < left->len; i++) {
   if ((
# 196 "project/radare2/libr/search/search.c" 3 4
       unsigned char
# 196 "project/radare2/libr/search/search.c"
          )(left->data[i+1] - left->data[i]) == a[0]) {
    j = 1;
    while (j < kw->keyword_length && (
# 198 "project/radare2/libr/search/search.c" 3 4
                                     unsigned char
# 198 "project/radare2/libr/search/search.c"
                                        )(left->data[i+j+1] - left->data[i+j]) == a[j]) {
     j++;
    }
  ...
  for (; i + kw->keyword_length < len; i++) {
   if ((
# 221 "project/radare2/libr/search/search.c" 3 4
       unsigned char
# 221 "project/radare2/libr/search/search.c"
          )(buf[i+1] - buf[i]) == a[0]) {
    j = 1;
    while (j < kw->keyword_length && (
# 223 "project/radare2/libr/search/search.c" 3 4
                                     unsigned char
# 223 "project/radare2/libr/search/search.c"
                                        )(buf[i+j+1] - buf[i+j]) == a[j]) {
     j++;
    }
    if (j == kw->keyword_length) {
...
# 247 "project/radare2/libr/search/search.c" 3 4
  __builtin___memmove_chk (
# 247 "project/radare2/libr/search/search.c"
  left->data
# 247 "project/radare2/libr/search/search.c" 3 4
  , 
# 247 "project/radare2/libr/search/search.c"
  left->data + len1 - longest + 1, longest - 1
# 247 "project/radare2/libr/search/search.c" 3 4
  , __builtin_object_size (
# 247 "project/radare2/libr/search/search.c"
  left->data
...
# 251 "project/radare2/libr/search/search.c" 3 4
 __builtin___memcpy_chk (
# 251 "project/radare2/libr/search/search.c"
 left->data
# 251 "project/radare2/libr/search/search.c" 3 4
 , 
# 251 "project/radare2/libr/search/search.c"
 buf + len - longest + 1, longest - 1
# 251 "project/radare2/libr/search/search.c" 3 4
 , __builtin_object_size (
# 251 "project/radare2/libr/search/search.c"
 left->data
...
# 303 "project/radare2/libr/search/search.c"
static 
# 303 "project/radare2/libr/search/search.c" 3 4
      _Bool 
# 303 "project/radare2/libr/search/search.c"
           brute_force_match(RSearch *s, RSearchKeyword *kw, const 
# 303 "project/radare2/libr/search/search.c" 3 4
                                                                   unsigned char 
# 303 "project/radare2/libr/search/search.c"
                                                                       *buf, int i) {
...
# 310 "project/radare2/libr/search/search.c" 3 4
   unsigned char 
# 310 "project/radare2/libr/search/search.c"
       a = buf[i + j], b = kw->bin_keyword[j];
    if (kw->icase) {
     a = tolower (a);
     b = tolower (b);
    }
...
# 338 "project/radare2/libr/search/search.c" 3 4
  unsigned char 
# 338 "project/radare2/libr/search/search.c"
      a = buf[i + j], b = kw->bin_keyword[j];
   if (kw->icase) {
    a = tolower (a);
    b = tolower (b);
 ...
 int search_kw_update(RSearch *s, 
# 361 "project/radare2/libr/search/search.c" 3 4
                                      unsigned long long 
# 361 "project/radare2/libr/search/search.c"
                                           from, const 
# 361 "project/radare2/libr/search/search.c" 3 4
                                                       unsigned char 
# 361 "project/radare2/libr/search/search.c"
...
# 368 "project/radare2/libr/search/search.c" 3 4
if (
# 368 "project/radare2/libr/search/search.c"
s->kws
# 368 "project/radare2/libr/search/search.c" 3 4
) for (
# 368 "project/radare2/libr/search/search.c"
...
# 368 "project/radare2/libr/search/search.c"
                                  {
  longest = 
# 369 "project/radare2/libr/search/search.c" 3 4
           (((
# 369 "project/radare2/libr/search/search.c"
           longest
# 369 "project/radare2/libr/search/search.c" 3 4
           )>(
# 369 "project/radare2/libr/search/search.c"
...
# 389 "project/radare2/libr/search/search.c" 3 4
 unsigned char 
# 389 "project/radare2/libr/search/search.c"
     *i = (
# 389 "project/radare2/libr/search/search.c" 3 4
           unsigned char 
# 389 "project/radare2/libr/search/search.c"
...
# 391 "project/radare2/libr/search/search.c" 3 4
  unsigned char 
# 391 "project/radare2/libr/search/search.c"
      t = *i;
   *i++ = *--j;
   *j = t;
  }
...
# 397 "project/radare2/libr/search/search.c" 3 4
unsigned long long 
# 397 "project/radare2/libr/search/search.c"
     len1 = left->len + 
# 397 "project/radare2/libr/search/search.c" 3 4
                        (((
# 397 "project/radare2/libr/search/search.c"
...
# 398 "project/radare2/libr/search/search.c" 3 4
__builtin___memcpy_chk (
# 398 "project/radare2/libr/search/search.c"
left->data + left->len
# 398 "project/radare2/libr/search/search.c" 3 4
, 
# 398 "project/radare2/libr/search/search.c"
...
# 399 "project/radare2/libr/search/search.c" 3 4
if (
# 399 "project/radare2/libr/search/search.c"
s->kws
# 399 "project/radare2/libr/search/search.c" 3 4
) for (
# 399 "project/radare2/libr/search/search.c"
...
# 442 "project/radare2/libr/search/search.c" 3 4
  __builtin___memmove_chk (
# 442 "project/radare2/libr/search/search.c"
  left->data
# 442 "project/radare2/libr/search/search.c" 3 4
  , 
# 442 "project/radare2/libr/search/search.c"
...
# 446 "project/radare2/libr/search/search.c" 3 4
 __builtin___memcpy_chk (
# 446 "project/radare2/libr/search/search.c"
 left->data
# 446 "project/radare2/libr/search/search.c" 3 4
 , 
# 446 "project/radare2/libr/search/search.c"
...
# 453 "project/radare2/libr/search/search.c" 3 4
__attribute__((visibility("default"))) 
# 453 "project/radare2/libr/search/search.c"
     void r_search_set_distance(RSearch *s, int dist) {
 if (dist>=
# 454 "project/radare2/libr/search/search.c" 3 4
          10
# 454 "project/radare2/libr/search/search.c"
                               ) {
  
# 455 "project/radare2/libr/search/search.c" 3 4
 fprintf(__stderrp,
# 455 "project/radare2/libr/search/search.c"
 "Invalid distance\n"
# 455 "project/radare2/libr/search/search.c" 3 4
 )
# 455 "project/radare2/libr/search/search.c"
...
# 463 "project/radare2/libr/search/search.c" 3 4
__attribute__((visibility("default"))) 
# 463 "project/radare2/libr/search/search.c"
     void r_search_pattern_size(RSearch *s, int size) {
 s->pattern_size = size;
}


# 467 "project/radare2/libr/search/search.c" 3 4
__attribute__((visibility("default"))) 
# 467 "project/radare2/libr/search/search.c"
     void r_search_set_callback(RSearch *s, RSearchCallback(callback), void *user) {
 s->callback = callback;
 s->user = user;
}
...
# 474 "project/radare2/libr/search/search.c" 3 4
__attribute__((visibility("default"))) 
# 474 "project/radare2/libr/search/search.c"
     int r_search_update(RSearch *s, 
# 474 "project/radare2/libr/search/search.c" 3 4
                                     unsigned long long 
# 474 "project/radare2/libr/search/search.c"
                                          from, const 
...
# 482 "project/radare2/libr/search/search.c" 3 4
 fprintf(__stderrp,
# 482 "project/radare2/libr/search/search.c"
 "r_search_update: No search method defined\n"
# 482 "project/radare2/libr/search/search.c" 3 4
 )
# 482 "project/radare2/libr/search/search.c"
                                                        ;
...
static int listcb(RSearchKeyword *k, void *user, 
# 487 "project/radare2/libr/search/search.c" 3 4
                                                unsigned long long 
# 487 "project/radare2/libr/search/search.c"
                                                     addr) {
 RSearchHit *hit = 
# 488 "project/radare2/libr/search/search.c" 3 4
                  (
# 488 "project/radare2/libr/search/search.c"
                  RSearchHit
# 488 "project/radare2/libr/search/search.c" 3 4
                  *)calloc(1,sizeof(
# 488 "project/radare2/libr/search/search.c"
...
# 498 "project/radare2/libr/search/search.c" 3 4
__attribute__((visibility("default"))) 
# 498 "project/radare2/libr/search/search.c"
     RList *r_search_find(RSearch *s, 
# 498 "project/radare2/libr/search/search.c" 3 4
                                      unsigned long long 
# 498 "project/radare2/libr/search/search.c"
                                           addr, const 
...
# 506 "project/radare2/libr/search/search.c" 3 4
__attribute__((visibility("default"))) 
# 506 "project/radare2/libr/search/search.c"
     int r_search_kw_add(RSearch *s, RSearchKeyword *kw) {
 if (!kw || !kw->keyword_length) {
  return 
# 508 "project/radare2/libr/search/search.c" 3 4
        0
# 508 "project/radare2/libr/search/search.c"
             ;
 }
 kw->kwidx = s->n_kws++;
 r_list_append (s->kws, kw);
 return 
# 512 "project/radare2/libr/search/search.c" 3 4
       1
# 512 "project/radare2/libr/search/search.c"
           ;
}



# 516 "project/radare2/libr/search/search.c" 3 4
__attribute__((visibility("default"))) 
# 516 "project/radare2/libr/search/search.c"
     void r_search_string_prepare_backward(RSearch *s) {
 RListIter *iter;
 RSearchKeyword *kw;

 
# 520 "project/radare2/libr/search/search.c" 3 4
if (
# 520 "project/radare2/libr/search/search.c"
s->kws
# 520 "project/radare2/libr/search/search.c" 3 4
) for (
# 520 "project/radare2/libr/search/search.c"
...
# 521 "project/radare2/libr/search/search.c" 3 4
 unsigned char 
# 521 "project/radare2/libr/search/search.c"
     *i = kw->bin_keyword, *j = kw->bin_keyword + kw->keyword_length;
  while (i < j) {
   
# 523 "project/radare2/libr/search/search.c" 3 4
  unsigned char 
# 523 "project/radare2/libr/search/search.c"
      t = *i;
   *i++ = *--j;
   *j = t;
  }
...
# 530 "project/radare2/libr/search/search.c" 3 4
  unsigned char 
# 530 "project/radare2/libr/search/search.c"
      t = *i;
   *i++ = *--j;
   *j = t;
  }
...
# 537 "project/radare2/libr/search/search.c" 3 4
__attribute__((visibility("default"))) 
# 537 "project/radare2/libr/search/search.c"
     void r_search_reset(RSearch *s, int mode) {
 s->nhits = 0;
 if (!r_search_set_mode (s, mode)) {
  
# 540 "project/radare2/libr/search/search.c" 3 4
 fprintf(__stderrp,
# 540 "project/radare2/libr/search/search.c"
 "Cannot init search for mode %d\n", mode
# 540 "project/radare2/libr/search/search.c" 3 4
 )
# 540 "project/radare2/libr/search/search.c"
...
# 544 "project/radare2/libr/search/search.c" 3 4
__attribute__((visibility("default"))) 
# 544 "project/radare2/libr/search/search.c"
     void r_search_kw_reset(RSearch *s) {
 r_list_purge (s->kws);
 r_list_purge (s->hits);
 if (s->datafree) {
  s->datafree (s->data);
  s->datafree = free;
  s->data = 
# 550 "project/radare2/libr/search/search.c" 3 4
           ((void *)0)
# 550 "project/radare2/libr/search/search.c"
               ;
 }
}
