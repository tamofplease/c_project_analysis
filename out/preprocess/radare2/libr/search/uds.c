# 0 "project/radare2/libr/search/uds.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 20 "project/radare2/libr/search/uds.c" 2
...
# 21 "project/radare2/libr/search/uds.c" 2
...
# 22 "project/radare2/libr/search/uds.c" 2
...
# 27 "project/radare2/libr/search/uds.c"
...
# 55 "project/radare2/libr/search/uds.c"

# 55 "project/radare2/libr/search/uds.c" 3 4
__attribute__((visibility("default"))) 
# 55 "project/radare2/libr/search/uds.c"
     RList *r_search_find_uds(RSearch *search, 
# 55 "project/radare2/libr/search/uds.c" 3 4
                                               unsigned long long 
# 55 "project/radare2/libr/search/uds.c"
                                                    addr, const 
...
# 58 "project/radare2/libr/search/uds.c" 3 4
 fprintf(__stderrp,
# 58 "project/radare2/libr/search/uds.c"
 "requires at least 1024 bytes. %zd\n", size
# 58 "project/radare2/libr/search/uds.c" 3 4
 )
# 58 "project/radare2/libr/search/uds.c"
                                                      ;
  r_list_free (list);
  return 
# 60 "project/radare2/libr/search/uds.c" 3 4
        ((void *)0)
# 60 "project/radare2/libr/search/uds.c"
            ;
 }
 ...
 unsigned char UDS_local[sizeof (UDS)];
 for (i = 1; i < size - (512 * 2); i++) {
  for (stride = 6; stride <= 32; stride += 2) {

   
# 72 "project/radare2/libr/search/uds.c" 3 4
  __builtin___memcpy_chk (
# 72 "project/radare2/libr/search/uds.c"
  UDS_local
# 72 "project/radare2/libr/search/uds.c" 3 4
  , 
# 72 "project/radare2/libr/search/uds.c"
...
# 72 "project/radare2/libr/search/uds.c"
                                  ;
   max_score = 0;
   for (k = 0; k < 512; k += stride) {
    
# 75 "project/radare2/libr/search/uds.c" 3 4
   _Bool 
# 75 "project/radare2/libr/search/uds.c"
        flag = 
# 75 "project/radare2/libr/search/uds.c" 3 4
               0
# 75 "project/radare2/libr/search/uds.c"
                    ;
    for (j = 0; j < sizeof (UDS); j++) {
     ...
     if ((data[i + k] == UDS_local[j]) && (UDS_local[j] != 0)) {
      ...
      UDS_local[j] = 0;
      flag = 
# 82 "project/radare2/libr/search/uds.c" 3 4
            1
# 82 "project/radare2/libr/search/uds.c"
                ;
     }
    }
    if (!flag) {
 ...
 for (j = 0; j < 20; j++) {
  ...
  RSearchUds *uh = 
# 112 "project/radare2/libr/search/uds.c" 3 4
                  (
# 112 "project/radare2/libr/search/uds.c"
                  RSearchUds
# 112 "project/radare2/libr/search/uds.c" 3 4
                  *)calloc(1,sizeof(
# 112 "project/radare2/libr/search/uds.c"
...
# 121 "project/radare2/libr/search/uds.c" 3 4
  fprintf(__stderrp,
# 121 "project/radare2/libr/search/uds.c"
  "UDS DB position: %x with a score of %d and a stride of %d:\n", candb_position, max_score, max_stride
# 121 "project/radare2/libr/search/uds.c" 3 4
  )
# 121 "project/radare2/libr/search/uds.c"
                                                                                                                 ;
...
# 126 "project/radare2/libr/search/uds.c" 3 4
    fprintf(__stderrp,
# 126 "project/radare2/libr/search/uds.c"
    "%02x ", data[candb_position + i * max_stride + j]
# 126 "project/radare2/libr/search/uds.c" 3 4
    )
# 126 "project/radare2/libr/search/uds.c"
                                                                ;
...
# 128 "project/radare2/libr/search/uds.c" 3 4
   fprintf(__stderrp,
# 128 "project/radare2/libr/search/uds.c"
   "\n"
# 128 "project/radare2/libr/search/uds.c" 3 4
   )
# 128 "project/radare2/libr/search/uds.c"
...
# 130 "project/radare2/libr/search/uds.c" 3 4
  fprintf(__stderrp,
# 130 "project/radare2/libr/search/uds.c"
  "\n"
# 130 "project/radare2/libr/search/uds.c" 3 4
  )
# 130 "project/radare2/libr/search/uds.c"
