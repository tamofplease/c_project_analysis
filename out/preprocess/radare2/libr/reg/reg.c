# 0 "project/radare2/libr/reg/reg.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/reg/reg.c"
...
# 4 "project/radare2/libr/reg/reg.c" 2
...
# 5 "project/radare2/libr/reg/reg.c" 2

__attribute__((visibility("default"))) const char *
# 6 "project/radare2/libr/reg/reg.c"
r_reg_version
# 6 "project/radare2/libr/reg/reg.c" 3 4
(void) { return "" "5.5.4"; }
# 6 "project/radare2/libr/reg/reg.c"
                    ;

static const char *types[R_REG_TYPE_LAST + 1] = {
 "gpr", "drx", "fpu", "mmx", "xmm", "ymm", "flg", "seg", 
# 9 "project/radare2/libr/reg/reg.c" 3 4
                                                        ((void *)0)

# 10 "project/radare2/libr/reg/reg.c"
};
...
# 15 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) 
# 15 "project/radare2/libr/reg/reg.c"
     const char *r_reg_32_to_64(RReg *reg, const char *rreg32) {
 int i, j = -1;
 RListIter *iter;
 RRegItem *item;
 for (i = 0; i < R_REG_TYPE_LAST; i++) {
  
# 20 "project/radare2/libr/reg/reg.c" 3 4
 if (
# 20 "project/radare2/libr/reg/reg.c"
 reg->regset[i].regs
# 20 "project/radare2/libr/reg/reg.c" 3 4
 ) for (
# 20 "project/radare2/libr/reg/reg.c"
...
# 29 "project/radare2/libr/reg/reg.c" 3 4
  if (
# 29 "project/radare2/libr/reg/reg.c"
  reg->regset[i].regs
# 29 "project/radare2/libr/reg/reg.c" 3 4
  ) for (
# 29 "project/radare2/libr/reg/reg.c"
...
# 29 "project/radare2/libr/reg/reg.c"
 ...
 return 
# 36 "project/radare2/libr/reg/reg.c" 3 4
       ((void *)0)
# 36 "project/radare2/libr/reg/reg.c"
           ;
}
...
# 42 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) 
# 42 "project/radare2/libr/reg/reg.c"
     const char *r_reg_64_to_32(RReg *reg, const char *rreg64) {
 int i, j = -1;
 RListIter *iter;
 RRegItem *item;
 for (i = 0; i < R_REG_TYPE_LAST; i++) {
  
# 47 "project/radare2/libr/reg/reg.c" 3 4
 if (
# 47 "project/radare2/libr/reg/reg.c"
 reg->regset[i].regs
# 47 "project/radare2/libr/reg/reg.c" 3 4
 ) for (
# 47 "project/radare2/libr/reg/reg.c"
...
# 56 "project/radare2/libr/reg/reg.c" 3 4
  if (
# 56 "project/radare2/libr/reg/reg.c"
  reg->regset[i].regs
# 56 "project/radare2/libr/reg/reg.c" 3 4
  ) for (
# 56 "project/radare2/libr/reg/reg.c"
...
# 56 "project/radare2/libr/reg/reg.c"
 ...
 return 
# 63 "project/radare2/libr/reg/reg.c" 3 4
       ((void *)0)
# 63 "project/radare2/libr/reg/reg.c"
           ;
}


# 66 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) 
# 66 "project/radare2/libr/reg/reg.c"
     const char *r_reg_get_type(int idx) {
 return (idx >= 0 && idx < R_REG_TYPE_LAST) ? types[idx] : 
# 67 "project/radare2/libr/reg/reg.c" 3 4
                                                          ((void *)0)
# 67 "project/radare2/libr/reg/reg.c"
                                                              ;
}


# 70 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) 
# 70 "project/radare2/libr/reg/reg.c"
     const char *r_reg_get_name_by_type(RReg *reg, const char *alias_name) {
 const int n = r_reg_get_name_idx (alias_name);
 return (n != -1)? r_reg_get_name (reg, n): 
# 72 "project/radare2/libr/reg/reg.c" 3 4
                                           ((void *)0)
# 72 "project/radare2/libr/reg/reg.c"
                                               ;
}


# 75 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) 
# 75 "project/radare2/libr/reg/reg.c"
     int r_reg_default_bits(RReg *reg) {
 return reg->bits_default;
}


# 79 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) 
# 79 "project/radare2/libr/reg/reg.c"
     int r_reg_type_by_name(const char *str) {
 
# 80 "project/radare2/libr/reg/reg.c" 3 4
do { if (!(
# 80 "project/radare2/libr/reg/reg.c"
str
# 80 "project/radare2/libr/reg/reg.c" 3 4
...
# 93 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) 
# 93 "project/radare2/libr/reg/reg.c"
...
# 99 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) 
# 99 "project/radare2/libr/reg/reg.c"
     int r_reg_get_name_idx(const char *type) {
 
# 100 "project/radare2/libr/reg/reg.c" 3 4
do { if (!(
# 100 "project/radare2/libr/reg/reg.c"
type
# 100 "project/radare2/libr/reg/reg.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 100 "project/radare2/libr/reg/reg.c"
...
# 135 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 135 "project/radare2/libr/reg/reg.c"
          r_reg_set_name(RReg *reg, int role, const char *name) {
 
# 136 "project/radare2/libr/reg/reg.c" 3 4
do { if (!(
# 136 "project/radare2/libr/reg/reg.c"
reg && name
# 136 "project/radare2/libr/reg/reg.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 136 "project/radare2/libr/reg/reg.c"
"reg && name"
# 136 "project/radare2/libr/reg/reg.c" 3 4
, 136); return (0); } } while (0)
# 136 "project/radare2/libr/reg/reg.c"
                                         ;
 if (role >= 0 && role < R_REG_NAME_LAST) {
  reg->name[role] = r_str_dup (reg->name[role], name);
  return 
# 139 "project/radare2/libr/reg/reg.c" 3 4
        1
# 139 "project/radare2/libr/reg/reg.c"
            ;
 }
 return 
# 141 "project/radare2/libr/reg/reg.c" 3 4
       0
# 141 "project/radare2/libr/reg/reg.c"
            ;
}


# 144 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) 
# 144 "project/radare2/libr/reg/reg.c"
     const char *r_reg_get_name(RReg *reg, int role) {
 if (reg && role >= 0 && role < R_REG_NAME_LAST) {
  return reg->name[role];
 }
 return 
# 148 "project/radare2/libr/reg/reg.c" 3 4
       ((void *)0)
# 148 "project/radare2/libr/reg/reg.c"
           ;
}
...
# 157 "project/radare2/libr/reg/reg.c" 3 4
((void *)0)

# 158 "project/radare2/libr/reg/reg.c"
};


# 160 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) 
# 160 "project/radare2/libr/reg/reg.c"
     const char *r_reg_get_role(int role) {
 if (role >= 0 && role < R_REG_NAME_LAST) {
  return roles[role];
 }
 return 
# 164 "project/radare2/libr/reg/reg.c" 3 4
       ((void *)0)
# 164 "project/radare2/libr/reg/reg.c"
           ;
}


# 167 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) 
# 167 "project/radare2/libr/reg/reg.c"
...
# 168 "project/radare2/libr/reg/reg.c" 3 4
do { if (!(
# 168 "project/radare2/libr/reg/reg.c"
reg
# 168 "project/radare2/libr/reg/reg.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 168 "project/radare2/libr/reg/reg.c"
...
# 169 "project/radare2/libr/reg/reg.c" 3 4
unsigned int 
# 169 "project/radare2/libr/reg/reg.c"
     i;

 r_list_free (reg->roregs);
 reg->roregs = 
# 172 "project/radare2/libr/reg/reg.c" 3 4
              ((void *)0)
# 172 "project/radare2/libr/reg/reg.c"
                  ;
 
# 173 "project/radare2/libr/reg/reg.c" 3 4
{ free((void *)
# 173 "project/radare2/libr/reg/reg.c"
reg->reg_profile_str
# 173 "project/radare2/libr/reg/reg.c" 3 4
); 
# 173 "project/radare2/libr/reg/reg.c"
...
# 174 "project/radare2/libr/reg/reg.c" 3 4
{ free((void *)
# 174 "project/radare2/libr/reg/reg.c"
reg->reg_profile_cmt
# 174 "project/radare2/libr/reg/reg.c" 3 4
); 
# 174 "project/radare2/libr/reg/reg.c"
...
# 178 "project/radare2/libr/reg/reg.c" 3 4
  { free((void *)
# 178 "project/radare2/libr/reg/reg.c"
  reg->name[i]
# 178 "project/radare2/libr/reg/reg.c" 3 4
  ); 
# 178 "project/radare2/libr/reg/reg.c"
...
# 178 "project/radare2/libr/reg/reg.c"
 ...
 for (i = 0; i < R_REG_TYPE_LAST; i++) {
  ...
  reg->regset[i].ht_regs = 
# 183 "project/radare2/libr/reg/reg.c" 3 4
                          ((void *)0)
# 183 "project/radare2/libr/reg/reg.c"
                              ;
  ...
  if (init) {
   ...
   r_list_free (reg->regset[i].regs);
   reg->regset[i].regs = 
# 192 "project/radare2/libr/reg/reg.c" 3 4
                        ((void *)0)
# 192 "project/radare2/libr/reg/reg.c"
                            ;
   ...
   reg->regset[i].arena = 
# 197 "project/radare2/libr/reg/reg.c" 3 4
                         ((void *)0)
# 197 "project/radare2/libr/reg/reg.c"
                             ;
   r_list_free (reg->regset[i].pool);
   reg->regset[i].pool = 
# 199 "project/radare2/libr/reg/reg.c" 3 4
                        ((void *)0)
# 199 "project/radare2/libr/reg/reg.c"
                            ;
  }
 }
 if (!init) {
  ...
  reg->allregs = 
# 204 "project/radare2/libr/reg/reg.c" 3 4
                ((void *)0)
# 204 "project/radare2/libr/reg/reg.c"
                    ;
 }
 reg->size = 0;
}
...
# 215 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) 
# 215 "project/radare2/libr/reg/reg.c"
     void r_reg_reindex(RReg *reg) {
 int i, index;
 RListIter *iter;
 RRegItem *r;
 RList *all = r_list_newf (
# 219 "project/radare2/libr/reg/reg.c" 3 4
                          ((void *)0)
# 219 "project/radare2/libr/reg/reg.c"
                              );
 for (i = 0; i < R_REG_TYPE_LAST; i++) {
  
# 221 "project/radare2/libr/reg/reg.c" 3 4
 if (
# 221 "project/radare2/libr/reg/reg.c"
 reg->regset[i].regs
# 221 "project/radare2/libr/reg/reg.c" 3 4
 ) for (
# 221 "project/radare2/libr/reg/reg.c"
...
# 227 "project/radare2/libr/reg/reg.c" 3 4
if (
# 227 "project/radare2/libr/reg/reg.c"
all
# 227 "project/radare2/libr/reg/reg.c" 3 4
) for (
# 227 "project/radare2/libr/reg/reg.c"
...
# 234 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) 
# 234 "project/radare2/libr/reg/reg.c"
     RRegItem *r_reg_index_get(RReg *reg, int idx) {
 RRegItem *r;
 RListIter *iter;
 if (idx < 0) {
  return 
# 238 "project/radare2/libr/reg/reg.c" 3 4
        ((void *)0)
# 238 "project/radare2/libr/reg/reg.c"
            ;
 }
 if (!reg->allregs) {
  r_reg_reindex (reg);
...
# 243 "project/radare2/libr/reg/reg.c" 3 4
if (
# 243 "project/radare2/libr/reg/reg.c"
reg->allregs
# 243 "project/radare2/libr/reg/reg.c" 3 4
) for (
# 243 "project/radare2/libr/reg/reg.c"
...
# 243 "project/radare2/libr/reg/reg.c"
 ...
 return 
# 248 "project/radare2/libr/reg/reg.c" 3 4
       ((void *)0)
# 248 "project/radare2/libr/reg/reg.c"
           ;
}


# 251 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) 
# 251 "project/radare2/libr/reg/reg.c"
     void r_reg_free(RReg *reg) {
 if (reg) {
  r_reg_free_internal (reg, 
# 253 "project/radare2/libr/reg/reg.c" 3 4
                           0
# 253 "project/radare2/libr/reg/reg.c"
                                );
  free (reg);
 }
}
...
# 258 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) 
# 258 "project/radare2/libr/reg/reg.c"
     RReg *r_reg_init(RReg *reg) {
 
# 259 "project/radare2/libr/reg/reg.c" 3 4
do { if (!(
# 259 "project/radare2/libr/reg/reg.c"
reg
# 259 "project/radare2/libr/reg/reg.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 259 "project/radare2/libr/reg/reg.c"
...
# 259 "project/radare2/libr/reg/reg.c"
 ...
 for (i = 0; i < R_REG_TYPE_LAST; i++) {
  ...
  if (!arena) {
   free (reg);
   return 
# 266 "project/radare2/libr/reg/reg.c" 3 4
         ((void *)0)
# 266 "project/radare2/libr/reg/reg.c"
             ;
  }
  reg->regset[i].pool = r_list_newf ((RListFree)r_reg_arena_free);
  reg->regset[i].regs = r_list_newf ((RListFree)r_reg_item_free);
  
# 270 "project/radare2/libr/reg/reg.c" 3 4
 r_list_append ((
# 270 "project/radare2/libr/reg/reg.c"
 reg->regset[i].pool
# 270 "project/radare2/libr/reg/reg.c" 3 4
 ), (
# 270 "project/radare2/libr/reg/reg.c"
...
# 270 "project/radare2/libr/reg/reg.c"
 ...
 for (i = 0; i < R_REG_TYPE_LAST; i++) {
  reg->regset[i].cur = 
# 275 "project/radare2/libr/reg/reg.c" 3 4
                      ((
# 275 "project/radare2/libr/reg/reg.c"
                      reg->regset[i].pool
# 275 "project/radare2/libr/reg/reg.c" 3 4
                      )? (
# 275 "project/radare2/libr/reg/reg.c"
...
# 280 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) 
# 280 "project/radare2/libr/reg/reg.c"
     RReg *r_reg_new(void) {
 return r_reg_init (
# 281 "project/radare2/libr/reg/reg.c" 3 4
                   (
# 281 "project/radare2/libr/reg/reg.c"
                   RReg
# 281 "project/radare2/libr/reg/reg.c" 3 4
                   *)calloc(1,sizeof(
# 281 "project/radare2/libr/reg/reg.c"
...
# 284 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 284 "project/radare2/libr/reg/reg.c"
          r_reg_is_readonly(RReg *reg, RRegItem *item) {
 const char *name;
 RListIter *iter;
 if (!reg->roregs) {
  return 
# 288 "project/radare2/libr/reg/reg.c" 3 4
        0
# 288 "project/radare2/libr/reg/reg.c"
             ;
 }

 
# 291 "project/radare2/libr/reg/reg.c" 3 4
if (
# 291 "project/radare2/libr/reg/reg.c"
reg->roregs
# 291 "project/radare2/libr/reg/reg.c" 3 4
) for (
# 291 "project/radare2/libr/reg/reg.c"
...
# 291 "project/radare2/libr/reg/reg.c"
  ...
  if (!strcmp (item->name, name)) {
   return 
# 293 "project/radare2/libr/reg/reg.c" 3 4
         1
# 293 "project/radare2/libr/reg/reg.c"
             ;
  }
 }
 return 
# 296 "project/radare2/libr/reg/reg.c" 3 4
       0
# 296 "project/radare2/libr/reg/reg.c"
            ;
}


# 299 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 299 "project/radare2/libr/reg/reg.c"
          r_reg_setv(RReg *reg, const char *name, 
# 299 "project/radare2/libr/reg/reg.c" 3 4
                                                  unsigned long long 
# 299 "project/radare2/libr/reg/reg.c"
                                                       val) {
 
# 300 "project/radare2/libr/reg/reg.c" 3 4
do { if (!(
# 300 "project/radare2/libr/reg/reg.c"
reg && name
# 300 "project/radare2/libr/reg/reg.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 300 "project/radare2/libr/reg/reg.c"
"reg && name"
# 300 "project/radare2/libr/reg/reg.c" 3 4
, 300); return (0xFFFFFFFFFFFFFFFFULL); } } while (0)
# 300 "project/radare2/libr/reg/reg.c"
                                            ;
 RRegItem *ri = r_reg_get (reg, name, -1);
 return ri? r_reg_set_value (reg, ri, val): 
# 302 "project/radare2/libr/reg/reg.c" 3 4
                                           0xFFFFFFFFFFFFFFFFULL
# 302 "project/radare2/libr/reg/reg.c"
                                                   ;
}


# 305 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 305 "project/radare2/libr/reg/reg.c"
          r_reg_getv(RReg *reg, const char *name) {
 
# 306 "project/radare2/libr/reg/reg.c" 3 4
do { if (!(
# 306 "project/radare2/libr/reg/reg.c"
reg && name
# 306 "project/radare2/libr/reg/reg.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 306 "project/radare2/libr/reg/reg.c"
"reg && name"
# 306 "project/radare2/libr/reg/reg.c" 3 4
, 306); return (0xFFFFFFFFFFFFFFFFULL); } } while (0)
# 306 "project/radare2/libr/reg/reg.c"
                                            ;
 RRegItem *ri = r_reg_get (reg, name, -1);
 return ri? r_reg_get_value (reg, ri): 
# 308 "project/radare2/libr/reg/reg.c" 3 4
                                      0xFFFFFFFFFFFFFFFFULL
# 308 "project/radare2/libr/reg/reg.c"
                                              ;
}


# 311 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) 
# 311 "project/radare2/libr/reg/reg.c"
     RRegItem *r_reg_get(RReg *reg, const char *name, int type) {
 int i, e;
 
# 313 "project/radare2/libr/reg/reg.c" 3 4
do { if (!(
# 313 "project/radare2/libr/reg/reg.c"
reg && name
# 313 "project/radare2/libr/reg/reg.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 313 "project/radare2/libr/reg/reg.c"
...
# 335 "project/radare2/libr/reg/reg.c" 3 4
  _Bool 
# 335 "project/radare2/libr/reg/reg.c"
       found = 
# 335 "project/radare2/libr/reg/reg.c" 3 4
               0
# 335 "project/radare2/libr/reg/reg.c"
 ...
 return 
# 342 "project/radare2/libr/reg/reg.c" 3 4
       ((void *)0)
# 342 "project/radare2/libr/reg/reg.c"
           ;
}


# 345 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) 
# 345 "project/radare2/libr/reg/reg.c"
     RList *r_reg_get_list(RReg *reg, int type) {
 ...
 if (type < 0 || type > (R_REG_TYPE_LAST - 1)) {
  return 
# 353 "project/radare2/libr/reg/reg.c" 3 4
        ((void *)0)
# 353 "project/radare2/libr/reg/reg.c"
            ;
 }
...
# 370 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) 
# 370 "project/radare2/libr/reg/reg.c"
     RRegItem *r_reg_get_at(RReg *reg, int type, int regsize, int delta) {
 
# 371 "project/radare2/libr/reg/reg.c" 3 4
do { if (!(
# 371 "project/radare2/libr/reg/reg.c"
reg
# 371 "project/radare2/libr/reg/reg.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 371 "project/radare2/libr/reg/reg.c"
...
# 375 "project/radare2/libr/reg/reg.c" 3 4
if (
# 375 "project/radare2/libr/reg/reg.c"
list
# 375 "project/radare2/libr/reg/reg.c" 3 4
) for (
# 375 "project/radare2/libr/reg/reg.c"
...
# 375 "project/radare2/libr/reg/reg.c"
  ...
  if (ri->size == regsize) {
   if (
# 377 "project/radare2/libr/reg/reg.c" 3 4
      (((
# 377 "project/radare2/libr/reg/reg.c"
      ri->offset
# 377 "project/radare2/libr/reg/reg.c" 3 4
      )/8)+(((
# 377 "project/radare2/libr/reg/reg.c"
...
# 377 "project/radare2/libr/reg/reg.c"
 ...
 return 
# 382 "project/radare2/libr/reg/reg.c" 3 4
       ((void *)0)
# 382 "project/radare2/libr/reg/reg.c"
           ;
}



# 386 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) 
# 386 "project/radare2/libr/reg/reg.c"
     RRegItem *r_reg_next_diff(RReg *reg, int type, const 
# 386 "project/radare2/libr/reg/reg.c" 3 4
                                                          unsigned char 
# 386 "project/radare2/libr/reg/reg.c"
                                                              *buf, int buflen, RRegItem *prev_ri, int regsize) {
 
# 387 "project/radare2/libr/reg/reg.c" 3 4
do { if (!(
# 387 "project/radare2/libr/reg/reg.c"
reg && buf
# 387 "project/radare2/libr/reg/reg.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 387 "project/radare2/libr/reg/reg.c"
"reg && buf"
# 387 "project/radare2/libr/reg/reg.c" 3 4
, 387); return (((void *)0)); } } while (0)
# 387 "project/radare2/libr/reg/reg.c"
                                       ;
 if (type < 0 || type > (R_REG_TYPE_LAST - 1)) {
  return 
# 389 "project/radare2/libr/reg/reg.c" 3 4
        ((void *)0)
# 389 "project/radare2/libr/reg/reg.c"
            ;
 }
...
# 397 "project/radare2/libr/reg/reg.c" 3 4
if (
# 397 "project/radare2/libr/reg/reg.c"
list
# 397 "project/radare2/libr/reg/reg.c" 3 4
) for (
# 397 "project/radare2/libr/reg/reg.c"
...
# 397 "project/radare2/libr/reg/reg.c"
 ...
 return 
# 405 "project/radare2/libr/reg/reg.c" 3 4
       ((void *)0)
# 405 "project/radare2/libr/reg/reg.c"
           ;
}


# 408 "project/radare2/libr/reg/reg.c" 3 4
__attribute__((visibility("default"))) 
# 408 "project/radare2/libr/reg/reg.c"
     RRegSet *r_reg_regset_get(RReg *r, int type) {
 
# 409 "project/radare2/libr/reg/reg.c" 3 4
do { if (!(
# 409 "project/radare2/libr/reg/reg.c"
r
# 409 "project/radare2/libr/reg/reg.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 409 "project/radare2/libr/reg/reg.c"
"r"
# 409 "project/radare2/libr/reg/reg.c" 3 4
, 409); return (((void *)0)); } } while (0)
# 409 "project/radare2/libr/reg/reg.c"
                              ;
 if (type < 0 || type >= R_REG_TYPE_LAST) {
  return 
# 411 "project/radare2/libr/reg/reg.c" 3 4
        ((void *)0)
# 411 "project/radare2/libr/reg/reg.c"
            ;
 }
 RRegSet *rs = &r->regset[type];
 return rs->arena ? rs : 
# 414 "project/radare2/libr/reg/reg.c" 3 4
                        ((void *)0)
# 414 "project/radare2/libr/reg/reg.c"
                            ;
}
