# 0 "project/radare2/libr/main/rasign2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/main/rasign2.c"
...
# 4 "project/radare2/libr/main/rasign2.c" 2
...
# 5 "project/radare2/libr/main/rasign2.c" 2


# 6 "project/radare2/libr/main/rasign2.c"
struct rasignconf {
 const char *ofile, *space;
 size_t a_cnt;
 
# 9 "project/radare2/libr/main/rasign2.c" 3 4
_Bool 
# 9 "project/radare2/libr/main/rasign2.c"
     merge, sdb, ar, rad, quiet, json, flirt, collision;
};
...
static RCore *opencore(const char *fname) {
 RIODesc * rfile = 
# 32 "project/radare2/libr/main/rasign2.c" 3 4
                  ((void *)0)
# 32 "project/radare2/libr/main/rasign2.c"
                      ;
 RCore *c = r_core_new ();
 if (!c) {
  
# 35 "project/radare2/libr/main/rasign2.c" 3 4
 fprintf(__stderrp,
# 35 "project/radare2/libr/main/rasign2.c"
 "Count not get core\n"
# 35 "project/radare2/libr/main/rasign2.c" 3 4
 )
# 35 "project/radare2/libr/main/rasign2.c"
                                 ;
  return 
# 36 "project/radare2/libr/main/rasign2.c" 3 4
        ((void *)0)
# 36 "project/radare2/libr/main/rasign2.c"
            ;
 }
 r_core_loadlibs (c, 
# 38 "project/radare2/libr/main/rasign2.c" 3 4
                    0xFFFFFFFFU
# 38 "project/radare2/libr/main/rasign2.c"
                                       , 
# 38 "project/radare2/libr/main/rasign2.c" 3 4
                                         ((void *)0)
# 38 "project/radare2/libr/main/rasign2.c"
                                             );
 r_config_set_b (c->config, "scr.interactive", 
# 39 "project/radare2/libr/main/rasign2.c" 3 4
                                              0
# 39 "project/radare2/libr/main/rasign2.c"
                                                   );
 if (fname) {
...
# 50 "project/radare2/libr/main/rasign2.c" 3 4
  fprintf(__stderrp,
# 50 "project/radare2/libr/main/rasign2.c"
...
# 50 "project/radare2/libr/main/rasign2.c"
   ...
   r_core_free (c);
   return 
# 52 "project/radare2/libr/main/rasign2.c" 3 4
         ((void *)0)
# 52 "project/radare2/libr/main/rasign2.c"
             ;
  }
  (void)r_core_bin_load (c, 
# 54 "project/radare2/libr/main/rasign2.c" 3 4
                           ((void *)0)
# 54 "project/radare2/libr/main/rasign2.c"
                               , 
# 54 "project/radare2/libr/main/rasign2.c" 3 4
...
static void find_functions(RCore *core, size_t count) {
 const char *cmd = 
# 62 "project/radare2/libr/main/rasign2.c" 3 4
                  ((void *)0)
# 62 "project/radare2/libr/main/rasign2.c"
                      ;
 switch (count) {
 case 0: cmd = "aa"; break;
...
# 83 "project/radare2/libr/main/rasign2.c" 3 4
 fprintf(__stderrp,
# 83 "project/radare2/libr/main/rasign2.c"
...
static int handle_sdb(const char *fname, struct rasignconf *conf) {
 ...
 r_config_set_b (core->config, "scr.interactive", 
# 97 "project/radare2/libr/main/rasign2.c" 3 4
                                                 0
# 97 "project/radare2/libr/main/rasign2.c"
                                                      );
 if (conf->ofile && r_file_exists (conf->ofile)) {
  r_sign_load (core->anal, conf->ofile, 
# 99 "project/radare2/libr/main/rasign2.c" 3 4
                                       1
# 99 "project/radare2/libr/main/rasign2.c"
                                           );
 }
...
# 114 "project/radare2/libr/main/rasign2.c" 3 4
 fprintf(__stderrp,
# 114 "project/radare2/libr/main/rasign2.c"
 "Could not get core\n"
# 114 "project/radare2/libr/main/rasign2.c" 3 4
 )
# 114 "project/radare2/libr/main/rasign2.c"
 ...
 if (conf->ofile && r_file_exists (conf->ofile)) {
  r_sign_load (core->anal, conf->ofile, 
# 125 "project/radare2/libr/main/rasign2.c" 3 4
                                       1
# 125 "project/radare2/libr/main/rasign2.c"
                                           );
 }
...
# 139 "project/radare2/libr/main/rasign2.c" 3 4
do { if (!(
# 139 "project/radare2/libr/main/rasign2.c"
fname
# 139 "project/radare2/libr/main/rasign2.c" 3 4
...
# 143 "project/radare2/libr/main/rasign2.c" 3 4
 fprintf(__stderrp,
# 143 "project/radare2/libr/main/rasign2.c"
 "Failed to alloc io\n"
# 143 "project/radare2/libr/main/rasign2.c" 3 4
 )
# 143 "project/radare2/libr/main/rasign2.c"
                                 ;
  return 
# 144 "project/radare2/libr/main/rasign2.c" 3 4
        ((void *)0)
# 144 "project/radare2/libr/main/rasign2.c"
            ;
 }
...
# 149 "project/radare2/libr/main/rasign2.c" 3 4
 fprintf(__stderrp,
# 149 "project/radare2/libr/main/rasign2.c"
 "Failed to alloc\n"
# 149 "project/radare2/libr/main/rasign2.c" 3 4
 )
# 149 "project/radare2/libr/main/rasign2.c"
  ...
  r_io_free (io);
  return 
# 151 "project/radare2/libr/main/rasign2.c" 3 4
        ((void *)0)
# 151 "project/radare2/libr/main/rasign2.c"
            ;
 }
...
# 157 "project/radare2/libr/main/rasign2.c" 3 4
_Bool 
# 157 "project/radare2/libr/main/rasign2.c"
     fail = 
# 157 "project/radare2/libr/main/rasign2.c" 3 4
            0
# 157 "project/radare2/libr/main/rasign2.c"
...
# 161 "project/radare2/libr/main/rasign2.c" 3 4
 if (
# 161 "project/radare2/libr/main/rasign2.c"
 list_fds
# 161 "project/radare2/libr/main/rasign2.c" 3 4
 ) for (
# 161 "project/radare2/libr/main/rasign2.c"
...
# 161 "project/radare2/libr/main/rasign2.c"
   ...
   if (!u) {
    fail = 
# 164 "project/radare2/libr/main/rasign2.c" 3 4
          1
# 164 "project/radare2/libr/main/rasign2.c"
              ;
    break;
   }
 ...
 if (fail) {
  r_list_free (uris);
  uris = 
# 174 "project/radare2/libr/main/rasign2.c" 3 4
        ((void *)0)
# 174 "project/radare2/libr/main/rasign2.c"
            ;
 }
 return uris;
}
...
static int dump_flirt(const char *ifile) {
 RCore *core = opencore (
# 180 "project/radare2/libr/main/rasign2.c" 3 4
                        ((void *)0)
# 180 "project/radare2/libr/main/rasign2.c"
                            );
...
# 193 "project/radare2/libr/main/rasign2.c" 3 4
_Bool 
# 193 "project/radare2/libr/main/rasign2.c"
     collision = 
# 193 "project/radare2/libr/main/rasign2.c" 3 4
                 0
# 193 "project/radare2/libr/main/rasign2.c"
 ...
 if (conf->collision && conf->ofile) {
  collision = 
# 195 "project/radare2/libr/main/rasign2.c" 3 4
             1
# 195 "project/radare2/libr/main/rasign2.c"
                 ;
 }
 conf->collision = 
# 197 "project/radare2/libr/main/rasign2.c" 3 4
                  0
# 197 "project/radare2/libr/main/rasign2.c"
                       ;
...
# 202 "project/radare2/libr/main/rasign2.c" 3 4
if (
# 202 "project/radare2/libr/main/rasign2.c"
uris
# 202 "project/radare2/libr/main/rasign2.c" 3 4
) for (
# 202 "project/radare2/libr/main/rasign2.c"
...
# 204 "project/radare2/libr/main/rasign2.c" 3 4
  fprintf(__stderrp,
# 204 "project/radare2/libr/main/rasign2.c"
  "\nProcessing %s...\n", u
# 204 "project/radare2/libr/main/rasign2.c" 3 4
  )
# 204 "project/radare2/libr/main/rasign2.c"
...
# 210 "project/radare2/libr/main/rasign2.c" 3 4
  fprintf(__stderrp,
# 210 "project/radare2/libr/main/rasign2.c"
  "[!!] skipping %s because it is not a .o file\n", u
# 210 "project/radare2/libr/main/rasign2.c" 3 4
  )
# 210 "project/radare2/libr/main/rasign2.c"
                                                               ;
...
# 216 "project/radare2/libr/main/rasign2.c" 3 4
 fprintf(__stderrp,
# 216 "project/radare2/libr/main/rasign2.c"
 "Computing collisions on sdb file\n"
# 216 "project/radare2/libr/main/rasign2.c" 3 4
 )
# 216 "project/radare2/libr/main/rasign2.c"
                                               ;
...
# 219 "project/radare2/libr/main/rasign2.c" 3 4
                                  1
# 219 "project/radare2/libr/main/rasign2.c"
                                      );
   r_sign_resolve_collisions (anal);
...
# 232 "project/radare2/libr/main/rasign2.c" 3 4
__attribute__((visibility("default"))) 
# 232 "project/radare2/libr/main/rasign2.c"
     int r_main_rasign2(int argc, const char **argv) {
 int c;
 RGetopt opt;
 ...
 while ((c = r_getopt_next (&opt)) != -1) {
  ...
  case 'A':
   conf.ar = 
# 241 "project/radare2/libr/main/rasign2.c" 3 4
            1
# 241 "project/radare2/libr/main/rasign2.c"
                ;
   break;
  case 'a':
   conf.a_cnt++;
  ...
  case 'c':
   conf.collision = 
# 250 "project/radare2/libr/main/rasign2.c" 3 4
                   1
# 250 "project/radare2/libr/main/rasign2.c"
                       ;
   break;
  case 'S':
   conf.sdb = 
# 253 "project/radare2/libr/main/rasign2.c" 3 4
             1
# 253 "project/radare2/libr/main/rasign2.c"
                 ;
   break;
  case 's':
   conf.space = opt.arg;
  ...
  case 'r':
   conf.rad = 
# 259 "project/radare2/libr/main/rasign2.c" 3 4
             1
# 259 "project/radare2/libr/main/rasign2.c"
                 ;
   break;
  case 'j':
   conf.json = 
# 262 "project/radare2/libr/main/rasign2.c" 3 4
              1
# 262 "project/radare2/libr/main/rasign2.c"
                  ;
   break;
  case 'm':
   conf.merge = 
# 265 "project/radare2/libr/main/rasign2.c" 3 4
               1
# 265 "project/radare2/libr/main/rasign2.c"
                   ;
   break;
  case 'q':
   conf.quiet = 
# 268 "project/radare2/libr/main/rasign2.c" 3 4
               1
# 268 "project/radare2/libr/main/rasign2.c"
                   ;
   break;
  case 'f':
   conf.flirt = 
# 271 "project/radare2/libr/main/rasign2.c" 3 4
               1
# 271 "project/radare2/libr/main/rasign2.c"
                   ;
   break;
  case 'v':
...
# 285 "project/radare2/libr/main/rasign2.c" 3 4
 fprintf(__stderrp,
# 285 "project/radare2/libr/main/rasign2.c"
 "Invalid analysis (too many -a's?)\n"
# 285 "project/radare2/libr/main/rasign2.c" 3 4
 )
# 285 "project/radare2/libr/main/rasign2.c"
                                                ;
...
# 291 "project/radare2/libr/main/rasign2.c" 3 4
 fprintf(__stderrp,
# 291 "project/radare2/libr/main/rasign2.c"
 "must provide a file\n"
# 291 "project/radare2/libr/main/rasign2.c" 3 4
 )
# 291 "project/radare2/libr/main/rasign2.c"
...
# 299 "project/radare2/libr/main/rasign2.c" 3 4
  fprintf(__stderrp,
# 299 "project/radare2/libr/main/rasign2.c"
  "Only FLIRT output is supported for FLIRT files\n"
# 299 "project/radare2/libr/main/rasign2.c" 3 4
  )
# 299 "project/radare2/libr/main/rasign2.c"
                                                              ;
...
# 303 "project/radare2/libr/main/rasign2.c" 3 4
  fprintf(__stderrp,
# 303 "project/radare2/libr/main/rasign2.c"
  "Can't use -S with -f\n"
# 303 "project/radare2/libr/main/rasign2.c" 3 4
  )
# 303 "project/radare2/libr/main/rasign2.c"
...
# 309 "project/radare2/libr/main/rasign2.c" 3 4
  fprintf(__stderrp,
# 309 "project/radare2/libr/main/rasign2.c"
  "JSON does not work with .a files currently\n"
# 309 "project/radare2/libr/main/rasign2.c" 3 4
  )
# 309 "project/radare2/libr/main/rasign2.c"
                                                          ;
...
# 313 "project/radare2/libr/main/rasign2.c" 3 4
  fprintf(__stderrp,
# 313 "project/radare2/libr/main/rasign2.c"
  "Rasign2 can not currently handle .a files with -c and -r\n"
# 313 "project/radare2/libr/main/rasign2.c" 3 4
  )
# 313 "project/radare2/libr/main/rasign2.c"
                                                                        ;
...
# 317 "project/radare2/libr/main/rasign2.c" 3 4
  fprintf(__stderrp,
# 317 "project/radare2/libr/main/rasign2.c"
  "Can't use -S with -A\n"
# 317 "project/radare2/libr/main/rasign2.c" 3 4
  )
# 317 "project/radare2/libr/main/rasign2.c"
...
# 323 "project/radare2/libr/main/rasign2.c" 3 4
  fprintf(__stderrp,
# 323 "project/radare2/libr/main/rasign2.c"
  "Option -a invalid with -S\n"
# 323 "project/radare2/libr/main/rasign2.c" 3 4
  )
# 323 "project/radare2/libr/main/rasign2.c"
                                         ;
...
# 328 "project/radare2/libr/main/rasign2.c" 3 4
   fprintf(__stderrp,
# 328 "project/radare2/libr/main/rasign2.c"
   "Option '-So -' is only useful with '-c'\n"
# 328 "project/radare2/libr/main/rasign2.c" 3 4
   )
# 328 "project/radare2/libr/main/rasign2.c"
                                                        ;
