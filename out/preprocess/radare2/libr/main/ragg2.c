# 0 "project/radare2/libr/main/ragg2.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/main/ragg2.c" 2
...
# 6 "project/radare2/libr/main/ragg2.c" 2




# 9 "project/radare2/libr/main/ragg2.c"
typedef struct {
 RLib *l;
 REgg *e;
...
static REggState *__es_new(void) {
 REggState *es = 
# 22 "project/radare2/libr/main/ragg2.c" 3 4
                (
# 22 "project/radare2/libr/main/ragg2.c"
                REggState
# 22 "project/radare2/libr/main/ragg2.c" 3 4
                *)calloc(1,sizeof(
# 22 "project/radare2/libr/main/ragg2.c"
...
# 22 "project/radare2/libr/main/ragg2.c"
 ...
 if (es) {
  es->l = r_lib_new (
# 24 "project/radare2/libr/main/ragg2.c" 3 4
                    ((void *)0)
# 24 "project/radare2/libr/main/ragg2.c"
                        , 
# 24 "project/radare2/libr/main/ragg2.c" 3 4
                          ((void *)0)
# 24 "project/radare2/libr/main/ragg2.c"
...
static int __lib_egg_cb(RLibPlugin *pl, void *user, void *data) {
 ...
 r_egg_add (es->e, hand);
 return 
# 42 "project/radare2/libr/main/ragg2.c" 3 4
       1
# 42 "project/radare2/libr/main/ragg2.c"
           ;
}
...
static void __load_plugins(REggState *es) {
 ...
 r_lib_add_handler (es->l, R_LIB_TYPE_EGG, "egg plugins", &__lib_egg_cb, 
# 50 "project/radare2/libr/main/ragg2.c" 3 4
                                                                        ((void *)0)
# 50 "project/radare2/libr/main/ragg2.c"
                                                                            , es);

 char *path = r_sys_getenv (
# 52 "project/radare2/libr/main/ragg2.c" 3 4
                           "R2_LIBR_PLUGINS"
# 52 "project/radare2/libr/main/ragg2.c"
                                    );
 if (!
# 53 "project/radare2/libr/main/ragg2.c" 3 4
     (!(
# 53 "project/radare2/libr/main/ragg2.c"
     path
# 53 "project/radare2/libr/main/ragg2.c" 3 4
     ) || !*(
# 53 "project/radare2/libr/main/ragg2.c"
...
# 58 "project/radare2/libr/main/ragg2.c" 3 4
                                  ".local" "/" "share" "/" "radare2" "/" "plugins"
# 58 "project/radare2/libr/main/ragg2.c"
                                                 );
...
# 63 "project/radare2/libr/main/ragg2.c" 3 4
                                   "lib/radare2/" "5.5.4"
# 63 "project/radare2/libr/main/ragg2.c"
                                             );
 char *extrasdir = r_str_r2_prefix (
# 64 "project/radare2/libr/main/ragg2.c" 3 4
                                   "lib/radare2-extras/" "5.5.4"
# 64 "project/radare2/libr/main/ragg2.c"
                                            );
 char *bindingsdir = r_str_r2_prefix (
# 65 "project/radare2/libr/main/ragg2.c" 3 4
                                     "lib/radare2-bindings/" "5.5.4"
# 65 "project/radare2/libr/main/ragg2.c"
                                                );
...
# 124 "project/radare2/libr/main/ragg2.c" 3 4
if (
# 124 "project/radare2/libr/main/ragg2.c"
egg->plugins
# 124 "project/radare2/libr/main/ragg2.c" 3 4
) for (
# 124 "project/radare2/libr/main/ragg2.c"
...
# 124 "project/radare2/libr/main/ragg2.c"
                                       {
  if (p->type == 
# 125 "project/radare2/libr/main/ragg2.c" 3 4
                0
# 125 "project/radare2/libr/main/ragg2.c"
                                      ) {
   printf ("%10s : %s\n", p->name, p->desc);
  }
 }
...
# 130 "project/radare2/libr/main/ragg2.c" 3 4
if (
# 130 "project/radare2/libr/main/ragg2.c"
egg->plugins
# 130 "project/radare2/libr/main/ragg2.c" 3 4
) for (
# 130 "project/radare2/libr/main/ragg2.c"
...
# 130 "project/radare2/libr/main/ragg2.c"
                                       {
  if (p->type == 
# 131 "project/radare2/libr/main/ragg2.c" 3 4
                1
# 131 "project/radare2/libr/main/ragg2.c"
                                    ) {
   printf ("%10s : %s\n", p->name, p->desc);
  }
 }
...
static int create(const char *format, const char *arch, int bits, const 
# 137 "project/radare2/libr/main/ragg2.c" 3 4
                                                                       unsigned char 
# 137 "project/radare2/libr/main/ragg2.c"
                                                                           *code, int codelen) {
 RBin *bin = r_bin_new ();
 RBinArchOptions opts;
 RBuffer *b;
 r_bin_arch_options_init (&opts, arch, bits);
 b = r_bin_create (bin, format, code, codelen, 
# 142 "project/radare2/libr/main/ragg2.c" 3 4
                                              ((void *)0)
# 142 "project/radare2/libr/main/ragg2.c"
                                                  , 0, &opts);
 if (b) {
  
# 144 "project/radare2/libr/main/ragg2.c" 3 4
 unsigned long long 
# 144 "project/radare2/libr/main/ragg2.c"
      blen;
  const 
# 145 "project/radare2/libr/main/ragg2.c" 3 4
       unsigned char 
# 145 "project/radare2/libr/main/ragg2.c"
           *tmp = r_buf_data (b, &blen);
  if (write (1, tmp, blen) != blen) {
   
# 147 "project/radare2/libr/main/ragg2.c" 3 4
  fprintf(__stderrp,
# 147 "project/radare2/libr/main/ragg2.c"
...
# 151 "project/radare2/libr/main/ragg2.c" 3 4
 fprintf(__stderrp,
# 151 "project/radare2/libr/main/ragg2.c"
...
static int openfile(const char *f, int x) {
 int fd = open (f, 
# 158 "project/radare2/libr/main/ragg2.c" 3 4
                  0x0002 
# 158 "project/radare2/libr/main/ragg2.c"
                         | 
# 158 "project/radare2/libr/main/ragg2.c" 3 4
                           0x00000200
# 158 "project/radare2/libr/main/ragg2.c"
 ...
 if (fd == -1) {
  fd = open (f, 
# 160 "project/radare2/libr/main/ragg2.c" 3 4
               0x0002
# 160 "project/radare2/libr/main/ragg2.c"
                     );
  if (fd == -1) {
   return -1;
  }
...
# 176 "project/radare2/libr/main/ragg2.c" 3 4
 fprintf(__stderrp,
# 176 "project/radare2/libr/main/ragg2.c"
 "Could not resize\n"
# 176 "project/radare2/libr/main/ragg2.c" 3 4
 )
# 176 "project/radare2/libr/main/ragg2.c"
...
# 186 "project/radare2/libr/main/ragg2.c" 3 4
__attribute__((visibility("default"))) 
# 186 "project/radare2/libr/main/ragg2.c"
     int r_main_ragg2(int argc, const char **argv) {
 const char *file = 
# 187 "project/radare2/libr/main/ragg2.c" 3 4
                   ((void *)0)
# 187 "project/radare2/libr/main/ragg2.c"
                       ;
 const char *padding = 
# 188 "project/radare2/libr/main/ragg2.c" 3 4
                      ((void *)0)
# 188 "project/radare2/libr/main/ragg2.c"
                          ;
 const char *pattern = 
# 189 "project/radare2/libr/main/ragg2.c" 3 4
                      ((void *)0)
# 189 "project/radare2/libr/main/ragg2.c"
                          ;
 const char *str = 
# 190 "project/radare2/libr/main/ragg2.c" 3 4
                  ((void *)0)
# 190 "project/radare2/libr/main/ragg2.c"
                      ;
 char *bytes = 
# 191 "project/radare2/libr/main/ragg2.c" 3 4
              ((void *)0)
# 191 "project/radare2/libr/main/ragg2.c"
                  ;
 const char *contents = 
# 192 "project/radare2/libr/main/ragg2.c" 3 4
                       ((void *)0)
# 192 "project/radare2/libr/main/ragg2.c"
                           ;
 const char *arch = 
# 193 "project/radare2/libr/main/ragg2.c" 3 4
                   "x86"
# 193 "project/radare2/libr/main/ragg2.c"
                             ;
 const char *os = 
# 194 "project/radare2/libr/main/ragg2.c" 3 4
                 "darwin"
# 194 "project/radare2/libr/main/ragg2.c"
                              ;
 const char *format = "raw";
 
# 196 "project/radare2/libr/main/ragg2.c" 3 4
_Bool 
# 196 "project/radare2/libr/main/ragg2.c"
     show_execute = 
# 196 "project/radare2/libr/main/ragg2.c" 3 4
                    0
# 196 "project/radare2/libr/main/ragg2.c"
...
# 197 "project/radare2/libr/main/ragg2.c" 3 4
_Bool 
# 197 "project/radare2/libr/main/ragg2.c"
     show_execute_rop = 
# 197 "project/radare2/libr/main/ragg2.c" 3 4
                        0
# 197 "project/radare2/libr/main/ragg2.c"
...
# 198 "project/radare2/libr/main/ragg2.c" 3 4
_Bool 
# 198 "project/radare2/libr/main/ragg2.c"
     show_hex = 
# 198 "project/radare2/libr/main/ragg2.c" 3 4
                1
# 198 "project/radare2/libr/main/ragg2.c"
...
# 199 "project/radare2/libr/main/ragg2.c" 3 4
_Bool 
# 199 "project/radare2/libr/main/ragg2.c"
     show_asm = 
# 199 "project/radare2/libr/main/ragg2.c" 3 4
                0
# 199 "project/radare2/libr/main/ragg2.c"
...
# 200 "project/radare2/libr/main/ragg2.c" 3 4
_Bool 
# 200 "project/radare2/libr/main/ragg2.c"
     show_raw = 
# 200 "project/radare2/libr/main/ragg2.c" 3 4
                0
# 200 "project/radare2/libr/main/ragg2.c"
...
# 203 "project/radare2/libr/main/ragg2.c" 3 4
unsigned long long 
# 203 "project/radare2/libr/main/ragg2.c"
     get_offset = 0;
 const char *shellcode = 
# 204 "project/radare2/libr/main/ragg2.c" 3 4
                        ((void *)0)
# 204 "project/radare2/libr/main/ragg2.c"
                            ;
 const char *encoder = 
# 205 "project/radare2/libr/main/ragg2.c" 3 4
                      ((void *)0)
# 205 "project/radare2/libr/main/ragg2.c"
                          ;
 const char *eggprg = 
# 206 "project/radare2/libr/main/ragg2.c" 3 4
                     ((void *)0)
# 206 "project/radare2/libr/main/ragg2.c"
                         ;
 char *sequence = 
# 207 "project/radare2/libr/main/ragg2.c" 3 4
                 ((void *)0)
# 207 "project/radare2/libr/main/ragg2.c"
                     ;
 int bits = (
# 208 "project/radare2/libr/main/ragg2.c" 3 4
            (4 | 8) 
# 208 "project/radare2/libr/main/ragg2.c"
                       & 
# 208 "project/radare2/libr/main/ragg2.c" 3 4
                         8
# 208 "project/radare2/libr/main/ragg2.c"
 ...
 int fmt = 0;
 const char *ofile = 
# 210 "project/radare2/libr/main/ragg2.c" 3 4
                    ((void *)0)
# 210 "project/radare2/libr/main/ragg2.c"
                        ;
 int ofileauto = 0;
 RBuffer *b;
 int c, i, fd = -1;
 ...
 while ((c = r_getopt_next (&opt)) != -1) {
  ...
  case 'a':
   ...
   if (!strcmp (arch, "trace")) {
    show_asm = 
# 228 "project/radare2/libr/main/ragg2.c" 3 4
              1
# 228 "project/radare2/libr/main/ragg2.c"
                  ;
    show_hex = 
# 229 "project/radare2/libr/main/ragg2.c" 3 4
              0
# 229 "project/radare2/libr/main/ragg2.c"
                   ;
   }
   break;
  case 'e':
  ...
  case 'C':
   if (
# 245 "project/radare2/libr/main/ragg2.c" 3 4
      (!(
# 245 "project/radare2/libr/main/ragg2.c"
      opt.arg
# 245 "project/radare2/libr/main/ragg2.c" 3 4
      ) || !*(
# 245 "project/radare2/libr/main/ragg2.c"
...
# 246 "project/radare2/libr/main/ragg2.c" 3 4
   fprintf(__stderrp,
# 246 "project/radare2/libr/main/ragg2.c"
...
# 259 "project/radare2/libr/main/ragg2.c" 3 4
   unsigned char 
# 259 "project/radare2/libr/main/ragg2.c"
       *b;
    *p++ = 0;
    off = r_num_math (
# 261 "project/radare2/libr/main/ragg2.c" 3 4
                     ((void *)0)
# 261 "project/radare2/libr/main/ragg2.c"
                         , arg);
    b = malloc (strlen (opt.arg) + 1);
    len = r_hex_str2bin (p, b);
    if (len > 0) {
     r_egg_patch (es->e, off, (const 
# 265 "project/radare2/libr/main/ragg2.c" 3 4
                                    unsigned char 
# 265 "project/radare2/libr/main/ragg2.c"
                                        *)b, len);
    } else {
     
# 267 "project/radare2/libr/main/ragg2.c" 3 4
    fprintf(__stderrp,
# 267 "project/radare2/libr/main/ragg2.c"
...
# 271 "project/radare2/libr/main/ragg2.c" 3 4
   fprintf(__stderrp,
# 271 "project/radare2/libr/main/ragg2.c"
   "Missing colon in -w\n"
# 271 "project/radare2/libr/main/ragg2.c" 3 4
   )
# 271 "project/radare2/libr/main/ragg2.c"
...
# 278 "project/radare2/libr/main/ragg2.c" 3 4
  unsigned int 
# 278 "project/radare2/libr/main/ragg2.c"
       n = r_num_math (
# 278 "project/radare2/libr/main/ragg2.c" 3 4
                       ((void *)0)
# 278 "project/radare2/libr/main/ragg2.c"
                           , opt.arg);
   append = 1;
   r_egg_patch (es->e, -1, (const 
# 280 "project/radare2/libr/main/ragg2.c" 3 4
                                 unsigned char 
# 280 "project/radare2/libr/main/ragg2.c"
                                     *)&n, 4);
   }
   break;
  case 'N':
...
# 285 "project/radare2/libr/main/ragg2.c" 3 4
  unsigned long long 
# 285 "project/radare2/libr/main/ragg2.c"
       n = r_num_math (
# 285 "project/radare2/libr/main/ragg2.c" 3 4
                       ((void *)0)
# 285 "project/radare2/libr/main/ragg2.c"
                           , opt.arg);
   r_egg_patch (es->e, -1, (const 
# 286 "project/radare2/libr/main/ragg2.c" 3 4
                                 unsigned char 
# 286 "project/radare2/libr/main/ragg2.c"
                                     *)&n, 8);
   append = 1;
   }
   break;
...
# 292 "project/radare2/libr/main/ragg2.c" 3 4
  unsigned int 
# 292 "project/radare2/libr/main/ragg2.c"
       off, n;
   char *p = strchr (opt.arg, ':');
   if (p) {
    *p = 0;
    off = r_num_math (
# 296 "project/radare2/libr/main/ragg2.c" 3 4
                     ((void *)0)
# 296 "project/radare2/libr/main/ragg2.c"
                         , opt.arg);
    n = r_num_math (
# 297 "project/radare2/libr/main/ragg2.c" 3 4
                   ((void *)0)
# 297 "project/radare2/libr/main/ragg2.c"
                       , p + 1);
    *p = ':';

    r_egg_patch (es->e, off, (const 
# 300 "project/radare2/libr/main/ragg2.c" 3 4
                                   unsigned char 
# 300 "project/radare2/libr/main/ragg2.c"
                                       *)&n, 4);
   } else {
    
# 302 "project/radare2/libr/main/ragg2.c" 3 4
   fprintf(__stderrp,
# 302 "project/radare2/libr/main/ragg2.c"
   "Missing colon in -d\n"
# 302 "project/radare2/libr/main/ragg2.c" 3 4
   )
# 302 "project/radare2/libr/main/ragg2.c"
...
# 310 "project/radare2/libr/main/ragg2.c" 3 4
   unsigned long long 
# 310 "project/radare2/libr/main/ragg2.c"
        n, off = r_num_math (
# 310 "project/radare2/libr/main/ragg2.c" 3 4
                             ((void *)0)
# 310 "project/radare2/libr/main/ragg2.c"
                                 , opt.arg);
    n = r_num_math (
# 311 "project/radare2/libr/main/ragg2.c" 3 4
                   ((void *)0)
# 311 "project/radare2/libr/main/ragg2.c"
                       , p + 1);

    r_egg_patch (es->e, off, (const 
# 313 "project/radare2/libr/main/ragg2.c" 3 4
                                   unsigned char 
# 313 "project/radare2/libr/main/ragg2.c"
                                       *)&n, 8);
   } else {
    
# 315 "project/radare2/libr/main/ragg2.c" 3 4
   fprintf(__stderrp,
# 315 "project/radare2/libr/main/ragg2.c"
   "Missing colon in -d\n"
# 315 "project/radare2/libr/main/ragg2.c" 3 4
   )
# 315 "project/radare2/libr/main/ragg2.c"
  ...
  case 'I':
   if (
# 329 "project/radare2/libr/main/ragg2.c" 3 4
      (!(
# 329 "project/radare2/libr/main/ragg2.c"
      opt.arg
# 329 "project/radare2/libr/main/ragg2.c" 3 4
      ) || !*(
# 329 "project/radare2/libr/main/ragg2.c"
...
# 330 "project/radare2/libr/main/ragg2.c" 3 4
   fprintf(__stderrp,
# 330 "project/radare2/libr/main/ragg2.c"
...
# 330 "project/radare2/libr/main/ragg2.c"
  ...
  case 'F':
   ...
   show_asm = 
# 365 "project/radare2/libr/main/ragg2.c" 3 4
             0
# 365 "project/radare2/libr/main/ragg2.c"
                  ;
   break;
  case 'f':
   format = opt.arg;
   show_asm = 
# 369 "project/radare2/libr/main/ragg2.c" 3 4
             0
# 369 "project/radare2/libr/main/ragg2.c"
                  ;
   break;
  case 's':
   show_asm = 
# 372 "project/radare2/libr/main/ragg2.c" 3 4
             1
# 372 "project/radare2/libr/main/ragg2.c"
                 ;
   show_hex = 
# 373 "project/radare2/libr/main/ragg2.c" 3 4
             0
# 373 "project/radare2/libr/main/ragg2.c"
                  ;
   break;
  case 'k':
   os = opt.arg;
  ...
  case 'r':
   show_raw = 
# 379 "project/radare2/libr/main/ragg2.c" 3 4
             1
# 379 "project/radare2/libr/main/ragg2.c"
                 ;
   break;
  case 'x':

   show_execute = 
# 383 "project/radare2/libr/main/ragg2.c" 3 4
                 1
# 383 "project/radare2/libr/main/ragg2.c"
                     ;
   break;
  case 'X':
...
# 437 "project/radare2/libr/main/ragg2.c" 3 4
  fprintf(__stderrp,
# 437 "project/radare2/libr/main/ragg2.c"
...
# 437 "project/radare2/libr/main/ragg2.c"
  ...
  printf ("Little endian: %d\n", r_debruijn_offset (get_offset, 
# 444 "project/radare2/libr/main/ragg2.c" 3 4
                                                               0
# 444 "project/radare2/libr/main/ragg2.c"
                                                                    ));
  printf ("Big endian: %d\n", r_debruijn_offset (get_offset, 
# 445 "project/radare2/libr/main/ragg2.c" 3 4
                                                            1
# 445 "project/radare2/libr/main/ragg2.c"
                                                                ));
  free (sequence);
  __es_free (es);
  return 0;
 ...
 if (file) {
  if (
# 454 "project/radare2/libr/main/ragg2.c" 3 4
     (!(
# 454 "project/radare2/libr/main/ragg2.c"
     file
# 454 "project/radare2/libr/main/ragg2.c" 3 4
     ) || !*(
# 454 "project/radare2/libr/main/ragg2.c"
...
# 455 "project/radare2/libr/main/ragg2.c" 3 4
  fprintf(__stderrp,
# 455 "project/radare2/libr/main/ragg2.c"
...
# 461 "project/radare2/libr/main/ragg2.c" 3 4
                                  __stdinp
# 461 "project/radare2/libr/main/ragg2.c"
                                       )) {
     break;
    }
    if (feof (
# 464 "project/radare2/libr/main/ragg2.c" 3 4
             __stdinp
# 464 "project/radare2/libr/main/ragg2.c"
                  )) {
     break;
    }
...
# 475 "project/radare2/libr/main/ragg2.c" 3 4
   fprintf(__stderrp,
# 475 "project/radare2/libr/main/ragg2.c"
...
# 475 "project/radare2/libr/main/ragg2.c"
   ...
   if (buf && l > 0) {
    r_egg_raw (es->e, (const 
# 482 "project/radare2/libr/main/ragg2.c" 3 4
                            unsigned char 
# 482 "project/radare2/libr/main/ragg2.c"
                                *)buf, (int)l);
   } else {
    
# 484 "project/radare2/libr/main/ragg2.c" 3 4
   fprintf(__stderrp,
# 484 "project/radare2/libr/main/ragg2.c"
   "Error loading '%s'\n", textFile
# 484 "project/radare2/libr/main/ragg2.c" 3 4
   )
# 484 "project/radare2/libr/main/ragg2.c"
...
# 500 "project/radare2/libr/main/ragg2.c" 3 4
   fprintf(__stderrp,
# 500 "project/radare2/libr/main/ragg2.c"
   "Cannot open '%s'\n", file
# 500 "project/radare2/libr/main/ragg2.c" 3 4
   )
# 500 "project/radare2/libr/main/ragg2.c"
...
# 506 "project/radare2/libr/main/ragg2.c" 3 4
  fprintf(__stderrp,
# 506 "project/radare2/libr/main/ragg2.c"
  "Cannot parse egg program.\n"
# 506 "project/radare2/libr/main/ragg2.c" 3 4
  )
# 506 "project/radare2/libr/main/ragg2.c"
                                         ;
...
# 514 "project/radare2/libr/main/ragg2.c" 3 4
  fprintf(__stderrp,
# 514 "project/radare2/libr/main/ragg2.c"
  "r_egg_compile: fail\n"
# 514 "project/radare2/libr/main/ragg2.c" 3 4
  )
# 514 "project/radare2/libr/main/ragg2.c"
 ...
 if (str) {
  ...
  if (l > 0) {
   r_egg_raw (es->e, (const 
# 525 "project/radare2/libr/main/ragg2.c" 3 4
                           unsigned char 
# 525 "project/radare2/libr/main/ragg2.c"
                               *)str, l);
  }
 }
 ...
 if (contents) {
  ...
  if (buf && l > 0) {
   r_egg_raw (es->e, (const 
# 534 "project/radare2/libr/main/ragg2.c" 3 4
                           unsigned char 
# 534 "project/radare2/libr/main/ragg2.c"
                               *)buf, (int)l);
  } else {
   
# 536 "project/radare2/libr/main/ragg2.c" 3 4
  fprintf(__stderrp,
# 536 "project/radare2/libr/main/ragg2.c"
  "Error loading '%s'\n", contents
# 536 "project/radare2/libr/main/ragg2.c" 3 4
  )
# 536 "project/radare2/libr/main/ragg2.c"
...
# 544 "project/radare2/libr/main/ragg2.c" 3 4
  fprintf(__stderrp,
# 544 "project/radare2/libr/main/ragg2.c"
  "Unknown shellcode '%s'\n", shellcode
# 544 "project/radare2/libr/main/ragg2.c" 3 4
  )
# 544 "project/radare2/libr/main/ragg2.c"
...
# 551 "project/radare2/libr/main/ragg2.c" 3 4
 unsigned char 
# 551 "project/radare2/libr/main/ragg2.c"
     *b = malloc (strlen (bytes) + 1);
  int len = r_hex_str2bin (bytes, b);
  if (len > 0) {
   if (!r_egg_raw (es->e, b, len)) {
    
# 555 "project/radare2/libr/main/ragg2.c" 3 4
   fprintf(__stderrp,
# 555 "project/radare2/libr/main/ragg2.c"
   "Unknown '%s'\n", shellcode
# 555 "project/radare2/libr/main/ragg2.c" 3 4
   )
# 555 "project/radare2/libr/main/ragg2.c"
...
# 560 "project/radare2/libr/main/ragg2.c" 3 4
  fprintf(__stderrp,
# 560 "project/radare2/libr/main/ragg2.c"
...
# 560 "project/radare2/libr/main/ragg2.c"
  ...
  free (bytes);
  bytes = 
# 564 "project/radare2/libr/main/ragg2.c" 3 4
         ((void *)0)
# 564 "project/radare2/libr/main/ragg2.c"
             ;
 }
...
# 585 "project/radare2/libr/main/ragg2.c" 3 4
  fprintf(__stderrp,
# 585 "project/radare2/libr/main/ragg2.c"
  "cannot open file '%s'\n", opt.arg
# 585 "project/radare2/libr/main/ragg2.c" 3 4
  )
# 585 "project/radare2/libr/main/ragg2.c"
 ...
 if (ofile) {
  fd = openfile (ofile, (fmt!='r'));
  if (fd == -1) {
   
# 593 "project/radare2/libr/main/ragg2.c" 3 4
  fprintf(__stderrp,
# 593 "project/radare2/libr/main/ragg2.c"
  "cannot open file '%s'\n", ofile
# 593 "project/radare2/libr/main/ragg2.c" 3 4
  )
# 593 "project/radare2/libr/main/ragg2.c"
...
# 601 "project/radare2/libr/main/ragg2.c" 3 4
  fprintf(__stderrp,
# 601 "project/radare2/libr/main/ragg2.c"
...
# 607 "project/radare2/libr/main/ragg2.c" 3 4
  fprintf(__stderrp,
# 607 "project/radare2/libr/main/ragg2.c"
  "Invalid encoder '%s'\n", encoder
# 607 "project/radare2/libr/main/ragg2.c" 3 4
  )
# 607 "project/radare2/libr/main/ragg2.c"
 ...
 if (pattern) {
  r_egg_pattern (es->e, r_num_math (
# 619 "project/radare2/libr/main/ragg2.c" 3 4
                                   ((void *)0)
# 619 "project/radare2/libr/main/ragg2.c"
                                       , pattern));
 }
...
# 627 "project/radare2/libr/main/ragg2.c" 3 4
 fprintf(__stderrp,
# 627 "project/radare2/libr/main/ragg2.c"
 "r_egg_get_bin: invalid egg :(\n"
# 627 "project/radare2/libr/main/ragg2.c" 3 4
 )
# 627 "project/radare2/libr/main/ragg2.c"
                                            ;
...
# 653 "project/radare2/libr/main/ragg2.c" 3 4
  unsigned long long 
# 653 "project/radare2/libr/main/ragg2.c"
       blen;
   const 
# 654 "project/radare2/libr/main/ragg2.c" 3 4
        unsigned char 
# 654 "project/radare2/libr/main/ragg2.c"
            *tmp = r_buf_data (b, &blen);
   if (write (1, tmp, blen) != blen) {
    
# 656 "project/radare2/libr/main/ragg2.c" 3 4
   fprintf(__stderrp,
# 656 "project/radare2/libr/main/ragg2.c"
   "Failed to write buffer\n"
# 656 "project/radare2/libr/main/ragg2.c" 3 4
   )
# 656 "project/radare2/libr/main/ragg2.c"
...
# 661 "project/radare2/libr/main/ragg2.c" 3 4
   fprintf(__stderrp,
# 661 "project/radare2/libr/main/ragg2.c"
   "No format specified wtf\n"
# 661 "project/radare2/libr/main/ragg2.c" 3 4
   )
# 661 "project/radare2/libr/main/ragg2.c"
                                        ;
...
# 665 "project/radare2/libr/main/ragg2.c" 3 4
  unsigned long long 
# 665 "project/radare2/libr/main/ragg2.c"
       tmpsz;
   const 
# 666 "project/radare2/libr/main/ragg2.c" 3 4
        unsigned char 
# 666 "project/radare2/libr/main/ragg2.c"
   ...
   case 'r':
    if (show_str) {
     ...
     r_buf_seek (b, 0, 
# 682 "project/radare2/libr/main/ragg2.c" 3 4
                      0
# 682 "project/radare2/libr/main/ragg2.c"
                               );
     for (i = 0; i < tmpsz; i++) {
      printf ("%02x", tmp[i]);
     }
...
# 699 "project/radare2/libr/main/ragg2.c" 3 4
   fprintf(__stderrp,
# 699 "project/radare2/libr/main/ragg2.c"
