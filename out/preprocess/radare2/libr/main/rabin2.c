# 0 "project/radare2/libr/main/rabin2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/main/rabin2.c"
...
# 4 "project/radare2/libr/main/rabin2.c" 2





# 1 "project/radare2/libr/main/../../libr/bin/pdb/pdb_downloader.h" 1
# 11 "project/radare2/libr/main/../../libr/bin/pdb/pdb_downloader.h"
...
# 15 "project/radare2/libr/main/../../libr/bin/pdb/pdb_downloader.h" 3 4
unsigned long long 
# 15 "project/radare2/libr/main/../../libr/bin/pdb/pdb_downloader.h"
     extract;
} SPDBOptions;
...
# 24 "project/radare2/libr/main/../../libr/bin/pdb/pdb_downloader.h" 3 4
unsigned long long 
# 24 "project/radare2/libr/main/../../libr/bin/pdb/pdb_downloader.h"
     extract;
} SPDBDownloaderOpt;
...
# 48 "project/radare2/libr/main/../../libr/bin/pdb/pdb_downloader.h" 3 4
__attribute__((visibility("default"))) 
# 48 "project/radare2/libr/main/../../libr/bin/pdb/pdb_downloader.h"
     int r_bin_pdb_download(RCore *core, PJ *pj, int isradjson, SPDBOptions *options);
# 10 "project/radare2/libr/main/rabin2.c" 2
...
# 96 "project/radare2/libr/main/rabin2.c" 3 4
                       _Bool 
# 96 "project/radare2/libr/main/rabin2.c"
                            liberate) {
 static char *stdin_buf = 
# 97 "project/radare2/libr/main/rabin2.c" 3 4
                         ((void *)0)
# 97 "project/radare2/libr/main/rabin2.c"
                             ;

 if (liberate) {
  free (stdin_buf);
  stdin_buf = 
# 101 "project/radare2/libr/main/rabin2.c" 3 4
             ((void *)0)
# 101 "project/radare2/libr/main/rabin2.c"
                 ;
  return 
# 102 "project/radare2/libr/main/rabin2.c" 3 4
        ((void *)0)
# 102 "project/radare2/libr/main/rabin2.c"
            ;
 }
 if (!stdin_buf) {
  ...
  if (!stdin_buf) {
   return 
# 108 "project/radare2/libr/main/rabin2.c" 3 4
         ((void *)0)
# 108 "project/radare2/libr/main/rabin2.c"
             ;
  }
 }
 
# 111 "project/radare2/libr/main/rabin2.c" 3 4
__builtin___memset_chk (
# 111 "project/radare2/libr/main/rabin2.c"
stdin_buf
# 111 "project/radare2/libr/main/rabin2.c" 3 4
, 
# 111 "project/radare2/libr/main/rabin2.c"
...
# 111 "project/radare2/libr/main/rabin2.c"
                                     ;
 if (!fgets (stdin_buf, 96096, 
# 112 "project/radare2/libr/main/rabin2.c" 3 4
                                       __stdinp
# 112 "project/radare2/libr/main/rabin2.c"
                                            )) {
  return 
# 113 "project/radare2/libr/main/rabin2.c" 3 4
        ((void *)0)
# 113 "project/radare2/libr/main/rabin2.c"
            ;
 }
 if (feof (
# 115 "project/radare2/libr/main/rabin2.c" 3 4
          __stdinp
# 115 "project/radare2/libr/main/rabin2.c"
               )) {
  return 
# 116 "project/radare2/libr/main/rabin2.c" 3 4
        ((void *)0)
# 116 "project/radare2/libr/main/rabin2.c"
            ;
 }
...
static void __sdb_prompt(Sdb *sdb) {
 char *line;
 for (; (line = stdin_gets (
# 123 "project/radare2/libr/main/rabin2.c" 3 4
                           0
# 123 "project/radare2/libr/main/rabin2.c"
                                ));) {
  sdb_query (sdb, line);
  free (line);
 }
...
static 
# 129 "project/radare2/libr/main/rabin2.c" 3 4
      _Bool 
# 129 "project/radare2/libr/main/rabin2.c"
           isBinopHelp(const char *op) {
 if (!op) {
  return 
# 131 "project/radare2/libr/main/rabin2.c" 3 4
        0
# 131 "project/radare2/libr/main/rabin2.c"
             ;
 }
 if (!strcmp (op, "help")) {
  return 
# 134 "project/radare2/libr/main/rabin2.c" 3 4
        1
# 134 "project/radare2/libr/main/rabin2.c"
            ;
 }
 if (!strcmp (op, "?")) {
  return 
# 137 "project/radare2/libr/main/rabin2.c" 3 4
        1
# 137 "project/radare2/libr/main/rabin2.c"
            ;
 }
 if (!strcmp (op, "h")) {
  return 
# 140 "project/radare2/libr/main/rabin2.c" 3 4
        1
# 140 "project/radare2/libr/main/rabin2.c"
            ;
 }
 return 
# 142 "project/radare2/libr/main/rabin2.c" 3 4
       0
# 142 "project/radare2/libr/main/rabin2.c"
            ;
}

static 
# 145 "project/radare2/libr/main/rabin2.c" 3 4
      _Bool 
# 145 "project/radare2/libr/main/rabin2.c"
           extract_binobj(const RBinFile *bf, RBinXtrData *data, int idx) {
 
# 146 "project/radare2/libr/main/rabin2.c" 3 4
unsigned long long 
# 146 "project/radare2/libr/main/rabin2.c"
     bin_size = data? data->size: 0;
 
# 147 "project/radare2/libr/main/rabin2.c" 3 4
unsigned char 
# 147 "project/radare2/libr/main/rabin2.c"
    *bytes;
 const char *xtr_type = "";
 char *arch = "unknown";
 int bits = 0, nb;
 char *libname = 
# 151 "project/radare2/libr/main/rabin2.c" 3 4
                ((void *)0)
# 151 "project/radare2/libr/main/rabin2.c"
                    ;
 const char *filename = bf? bf->file: 
# 152 "project/radare2/libr/main/rabin2.c" 3 4
                                     ((void *)0)
# 152 "project/radare2/libr/main/rabin2.c"
                                         ;
 char *path = 
# 153 "project/radare2/libr/main/rabin2.c" 3 4
             ((void *)0)
# 153 "project/radare2/libr/main/rabin2.c"
                 , *ptr = 
# 153 "project/radare2/libr/main/rabin2.c" 3 4
                          ((void *)0)
# 153 "project/radare2/libr/main/rabin2.c"
...
# 154 "project/radare2/libr/main/rabin2.c" 3 4
_Bool 
# 154 "project/radare2/libr/main/rabin2.c"
     res = 
# 154 "project/radare2/libr/main/rabin2.c" 3 4
           0
# 154 "project/radare2/libr/main/rabin2.c"
 ...
 if (!bf || !data || !filename) {
  return 
# 157 "project/radare2/libr/main/rabin2.c" 3 4
        0
# 157 "project/radare2/libr/main/rabin2.c"
             ;
 }
 if (data->metadata) {
...
# 166 "project/radare2/libr/main/rabin2.c" 3 4
 fprintf(__stderrp,
# 166 "project/radare2/libr/main/rabin2.c"
...
# 166 "project/radare2/libr/main/rabin2.c"
                                    ;
  return 
# 167 "project/radare2/libr/main/rabin2.c" 3 4
        0
# 167 "project/radare2/libr/main/rabin2.c"
             ;
 }
 bytes = malloc (bin_size);
 if (!bytes) {
  
# 171 "project/radare2/libr/main/rabin2.c" 3 4
 fprintf(__stderrp,
# 171 "project/radare2/libr/main/rabin2.c"
...
# 171 "project/radare2/libr/main/rabin2.c"
                                             ;
  return 
# 172 "project/radare2/libr/main/rabin2.c" 3 4
        0
# 172 "project/radare2/libr/main/rabin2.c"
             ;
 }
 nb = r_buf_read_at (data->buf, 0, bytes, bin_size);
 if (nb <= 0) {
  
# 176 "project/radare2/libr/main/rabin2.c" 3 4
 fprintf(__stderrp,
# 176 "project/radare2/libr/main/rabin2.c"
...
# 176 "project/radare2/libr/main/rabin2.c"
                                    ;
  return 
# 177 "project/radare2/libr/main/rabin2.c" 3 4
        0
# 177 "project/radare2/libr/main/rabin2.c"
             ;
 }
 if (!arch) {
  arch = "unknown";
 ...
 if (!path) {
  return 
# 184 "project/radare2/libr/main/rabin2.c" 3 4
        0
# 184 "project/radare2/libr/main/rabin2.c"
             ;
 }
...
# 191 "project/radare2/libr/main/rabin2.c" 3 4
 fprintf(__stderrp,
# 191 "project/radare2/libr/main/rabin2.c"
...
# 191 "project/radare2/libr/main/rabin2.c"
                                           ;
  return 
# 192 "project/radare2/libr/main/rabin2.c" 3 4
        0
# 192 "project/radare2/libr/main/rabin2.c"
             ;
 }
...
# 200 "project/radare2/libr/main/rabin2.c" 3 4
 fprintf(__stderrp,
# 200 "project/radare2/libr/main/rabin2.c"
 "Error extracting %s\n", outfile
# 200 "project/radare2/libr/main/rabin2.c" 3 4
 )
# 200 "project/radare2/libr/main/rabin2.c"
                                           ;
  res = 
# 201 "project/radare2/libr/main/rabin2.c" 3 4
       0
# 201 "project/radare2/libr/main/rabin2.c"
            ;
 } else {
  printf ("%s created (%"
# 203 "project/radare2/libr/main/rabin2.c" 3 4
                        "lld"
# 203 "project/radare2/libr/main/rabin2.c"
                               ")\n", outfile, bin_size);
  res = 
# 204 "project/radare2/libr/main/rabin2.c" 3 4
       1
# 204 "project/radare2/libr/main/rabin2.c"
           ;
 }
...
static int rabin_extract(RBin *bin, int all) {
 RBinXtrData *data = 
# 215 "project/radare2/libr/main/rabin2.c" 3 4
                    ((void *)0)
# 215 "project/radare2/libr/main/rabin2.c"
                        ;
 int res = 
# 216 "project/radare2/libr/main/rabin2.c" 3 4
          0
# 216 "project/radare2/libr/main/rabin2.c"
               ;
...
# 225 "project/radare2/libr/main/rabin2.c" 3 4
 if (
# 225 "project/radare2/libr/main/rabin2.c"
 bf->xtr_data
# 225 "project/radare2/libr/main/rabin2.c" 3 4
 ) for (
# 225 "project/radare2/libr/main/rabin2.c"
...
static int rabin_dump_symbols(RBin *bin, int len) {
 ...
 if (!symbols) {
  return 
# 244 "project/radare2/libr/main/rabin2.c" 3 4
        0
# 244 "project/radare2/libr/main/rabin2.c"
             ;
 }
...
# 250 "project/radare2/libr/main/rabin2.c" 3 4
if (
# 250 "project/radare2/libr/main/rabin2.c"
symbols
# 250 "project/radare2/libr/main/rabin2.c" 3 4
) for (
# 250 "project/radare2/libr/main/rabin2.c"
...
# 258 "project/radare2/libr/main/rabin2.c" 3 4
 unsigned char 
# 258 "project/radare2/libr/main/rabin2.c"
     *buf = calloc (1, len);
  if (!buf) {
   return 
# 260 "project/radare2/libr/main/rabin2.c" 3 4
         0
# 260 "project/radare2/libr/main/rabin2.c"
              ;
  }
  ...
  if (!ret) {
   free (buf);
   return 
# 265 "project/radare2/libr/main/rabin2.c" 3 4
         0
# 265 "project/radare2/libr/main/rabin2.c"
              ;
  }
...
# 271 "project/radare2/libr/main/rabin2.c" 3 4
  fprintf(__stderrp,
# 271 "project/radare2/libr/main/rabin2.c"
...
# 271 "project/radare2/libr/main/rabin2.c"
 ...
 return 
# 276 "project/radare2/libr/main/rabin2.c" 3 4
       1
# 276 "project/radare2/libr/main/rabin2.c"
           ;
}

static 
# 279 "project/radare2/libr/main/rabin2.c" 3 4
      _Bool 
# 279 "project/radare2/libr/main/rabin2.c"
           __dumpSections(RBin *bin, const char *scnname, const char *output, const char *file) {
 RList *sections;
 RListIter *iter;
 RBinSection *section;
 
# 283 "project/radare2/libr/main/rabin2.c" 3 4
unsigned char 
# 283 "project/radare2/libr/main/rabin2.c"
    *buf;
 char *ret;
 int r;
 ...
 if (!(sections = r_bin_get_sections (bin))) {
  return 
# 288 "project/radare2/libr/main/rabin2.c" 3 4
        0
# 288 "project/radare2/libr/main/rabin2.c"
             ;
 }

 
# 291 "project/radare2/libr/main/rabin2.c" 3 4
if (
# 291 "project/radare2/libr/main/rabin2.c"
sections
# 291 "project/radare2/libr/main/rabin2.c" 3 4
) for (
# 291 "project/radare2/libr/main/rabin2.c"
...
# 291 "project/radare2/libr/main/rabin2.c"
  ...
  if (!strcmp (scnname, section->name)) {
   if (!(buf = malloc (section->size))) {
    return 
# 294 "project/radare2/libr/main/rabin2.c" 3 4
          0
# 294 "project/radare2/libr/main/rabin2.c"
               ;
   }
   if ((section->size * 2) + 1 < section->size) {
    free (buf);
    return 
# 298 "project/radare2/libr/main/rabin2.c" 3 4
          0
# 298 "project/radare2/libr/main/rabin2.c"
               ;
   }
   if (!(ret = malloc (section->size*2+1))) {
    free (buf);
    return 
# 302 "project/radare2/libr/main/rabin2.c" 3 4
          0
# 302 "project/radare2/libr/main/rabin2.c"
               ;
   }
   if (section->paddr > r_buf_size (bin->cur->buf) ||
    ...
    free (ret);
    return 
# 308 "project/radare2/libr/main/rabin2.c" 3 4
          0
# 308 "project/radare2/libr/main/rabin2.c"
               ;
   }
   ...
   if (r < 1) {
    ...
    free (ret);
    return 
# 315 "project/radare2/libr/main/rabin2.c" 3 4
          0
# 315 "project/radare2/libr/main/rabin2.c"
               ;
   }
 ...
 return 
# 329 "project/radare2/libr/main/rabin2.c" 3 4
       1
# 329 "project/radare2/libr/main/rabin2.c"
           ;
}

static int rabin_do_operation(RBin *bin, const char *op, int rad, const char *output, const char *file) {
 char *arg = 
# 333 "project/radare2/libr/main/rabin2.c" 3 4
            ((void *)0)
# 333 "project/radare2/libr/main/rabin2.c"
                , *ptr = 
# 333 "project/radare2/libr/main/rabin2.c" 3 4
                         ((void *)0)
# 333 "project/radare2/libr/main/rabin2.c"
...
# 334 "project/radare2/libr/main/rabin2.c" 3 4
_Bool 
# 334 "project/radare2/libr/main/rabin2.c"
     rc = 
# 334 "project/radare2/libr/main/rabin2.c" 3 4
          1
# 334 "project/radare2/libr/main/rabin2.c"
 ...
 if (!(arg = strdup (op))) {
  return 
# 338 "project/radare2/libr/main/rabin2.c" 3 4
        0
# 338 "project/radare2/libr/main/rabin2.c"
             ;
 }
 if ((ptr = strchr (arg, '/'))) {
  *ptr++ = 0;
 ...
 switch (arg[0]) {
 case 'e':
  rc = r_bin_wr_entry (bin, r_num_math (
# 359 "project/radare2/libr/main/rabin2.c" 3 4
                                       ((void *)0)
# 359 "project/radare2/libr/main/rabin2.c"
                                           , ptr));
  if (rc) {
...
# 371 "project/radare2/libr/main/rabin2.c" 3 4
   unsigned long long 
# 371 "project/radare2/libr/main/rabin2.c"
        a = ptr2? r_num_math (
# 371 "project/radare2/libr/main/rabin2.c" 3 4
                              ((void *)0)
# 371 "project/radare2/libr/main/rabin2.c"
...
# 418 "project/radare2/libr/main/rabin2.c" 3 4
    0xFFFFFFFFFFFFFFFFULL
# 418 "project/radare2/libr/main/rabin2.c"
  ...
  if (plg && plg->signature) {
   char *sign = plg->signature (cur, rad == 
# 428 "project/radare2/libr/main/rabin2.c" 3 4
                                           0x008
# 428 "project/radare2/libr/main/rabin2.c"
                                                      );
   if (sign) {
    r_cons_println (sign);
    r_cons_flush ();
  ...
  break;
 case 'r':
  r_bin_wr_scn_resize (bin, ptr, r_num_math (
# 438 "project/radare2/libr/main/rabin2.c" 3 4
                                            ((void *)0)
# 438 "project/radare2/libr/main/rabin2.c"
                                                , ptr2));
  rc = r_bin_wr_output (bin, output);
  break;
 case 'p':
  {
   int perms = (int)r_num_math (
# 443 "project/radare2/libr/main/rabin2.c" 3 4
                               ((void *)0)
# 443 "project/radare2/libr/main/rabin2.c"
                                   , ptr2);
   if (!perms) {
...
# 453 "project/radare2/libr/main/rabin2.c" 3 4
 fprintf(__stderrp,
# 453 "project/radare2/libr/main/rabin2.c"
...
# 457 "project/radare2/libr/main/rabin2.c" 3 4
 fprintf(__stderrp,
# 457 "project/radare2/libr/main/rabin2.c"
 "Cannot dump :(\n"
# 457 "project/radare2/libr/main/rabin2.c" 3 4
 )
# 457 "project/radare2/libr/main/rabin2.c"
 ...
 free (arg);
 return 
# 460 "project/radare2/libr/main/rabin2.c" 3 4
       1
# 460 "project/radare2/libr/main/rabin2.c"
           ;
error:
 free (arg);
 return 
# 463 "project/radare2/libr/main/rabin2.c" 3 4
       0
# 463 "project/radare2/libr/main/rabin2.c"
            ;
}

static int rabin_show_srcline(RBin *bin, 
# 466 "project/radare2/libr/main/rabin2.c" 3 4
                                        unsigned long long 
# 466 "project/radare2/libr/main/rabin2.c"
                                             at) {
 char *srcline;
 if (at != 
# 468 "project/radare2/libr/main/rabin2.c" 3 4
          0xFFFFFFFFFFFFFFFFULL 
# 468 "project/radare2/libr/main/rabin2.c"
                   && (srcline = r_bin_addr2text (bin, at, 
# 468 "project/radare2/libr/main/rabin2.c" 3 4
                                                           1
# 468 "project/radare2/libr/main/rabin2.c"
                                                               ))) {
  ...
  free (srcline);
  return 
# 471 "project/radare2/libr/main/rabin2.c" 3 4
        1
# 471 "project/radare2/libr/main/rabin2.c"
            ;
 }
 return 
# 473 "project/radare2/libr/main/rabin2.c" 3 4
       0
# 473 "project/radare2/libr/main/rabin2.c"
            ;
}
...
static int __lib_bin_cb(RLibPlugin *pl, void *user, void *data) {
 ...
 r_bin_add (bin, hand);
 return 
# 482 "project/radare2/libr/main/rabin2.c" 3 4
       1
# 482 "project/radare2/libr/main/rabin2.c"
           ;
}

static int __lib_bin_dt(RLibPlugin *pl, void *p, void *u) {
 return 
# 486 "project/radare2/libr/main/rabin2.c" 3 4
       1
# 486 "project/radare2/libr/main/rabin2.c"
           ;
}
...
static int __lib_bin_xtr_cb(RLibPlugin *pl, void *user, void *data) {
 ...
 return 
# 495 "project/radare2/libr/main/rabin2.c" 3 4
       1
# 495 "project/radare2/libr/main/rabin2.c"
           ;
}

static int __lib_bin_xtr_dt(RLibPlugin *pl, void *p, void *u) {
 return 
# 499 "project/radare2/libr/main/rabin2.c" 3 4
       1
# 499 "project/radare2/libr/main/rabin2.c"
           ;
}
...
static int __lib_bin_ldr_cb(RLibPlugin *pl, void *user, void *data) {
 ...
 return 
# 508 "project/radare2/libr/main/rabin2.c" 3 4
       1
# 508 "project/radare2/libr/main/rabin2.c"
           ;
}

static int __lib_bin_ldr_dt(RLibPlugin *pl, void *p, void *u) {
 return 
# 512 "project/radare2/libr/main/rabin2.c" 3 4
       1
# 512 "project/radare2/libr/main/rabin2.c"
           ;
}

static void setup_trylib_from_environment(RBin *bin, int type) {
 
# 516 "project/radare2/libr/main/rabin2.c" 3 4
_Bool 
# 516 "project/radare2/libr/main/rabin2.c"
     trylib = 
# 516 "project/radare2/libr/main/rabin2.c" 3 4
              0
# 516 "project/radare2/libr/main/rabin2.c"
 ...
 if (type == R_BIN_NM_SWIFT) {
  trylib = 
# 518 "project/radare2/libr/main/rabin2.c" 3 4
          1
# 518 "project/radare2/libr/main/rabin2.c"
              ;
...
# 529 "project/radare2/libr/main/rabin2.c" 3 4
_Bool 
# 529 "project/radare2/libr/main/rabin2.c"
     syscmd = bin->demangle_usecmd;
 char *res = 
# 530 "project/radare2/libr/main/rabin2.c" 3 4
            ((void *)0)
# 530 "project/radare2/libr/main/rabin2.c"
                ;
 switch (type) {
 case R_BIN_NM_CXX: res = r_bin_demangle_cxx (
# 532 "project/radare2/libr/main/rabin2.c" 3 4
                                             ((void *)0)
# 532 "project/radare2/libr/main/rabin2.c"
                                                 , file, 0); break;
 case R_BIN_NM_JAVA: res = r_bin_demangle_java (file); break;
 case R_BIN_NM_OBJC: res = r_bin_demangle_objc (
# 534 "project/radare2/libr/main/rabin2.c" 3 4
                                               ((void *)0)
# 534 "project/radare2/libr/main/rabin2.c"
                                                   , file); break;
 ...
 case R_BIN_NM_RUST: res = r_bin_demangle_rust (
# 537 "project/radare2/libr/main/rabin2.c" 3 4
                                               ((void *)0)
# 537 "project/radare2/libr/main/rabin2.c"
                                                   , file, 0); break;
 default:
  
# 539 "project/radare2/libr/main/rabin2.c" 3 4
 fprintf(__stderrp,
# 539 "project/radare2/libr/main/rabin2.c"
...
static void __listPlugins(RBin *bin, const char* plugin_name, PJ *pj, int rad) {
 int format = (rad == 
# 546 "project/radare2/libr/main/rabin2.c" 3 4
                     0x008
# 546 "project/radare2/libr/main/rabin2.c"
                                ) ? 'j': rad? 'q': 0;
...
# 555 "project/radare2/libr/main/rabin2.c" 3 4
__attribute__((visibility("default"))) 
# 555 "project/radare2/libr/main/rabin2.c"
     int r_main_rabin2(int argc, const char **argv) {
 RBin *bin = 
# 556 "project/radare2/libr/main/rabin2.c" 3 4
            ((void *)0)
# 556 "project/radare2/libr/main/rabin2.c"
                ;
 const char *name = 
# 557 "project/radare2/libr/main/rabin2.c" 3 4
                   ((void *)0)
# 557 "project/radare2/libr/main/rabin2.c"
                       ;
 const char *file = 
# 558 "project/radare2/libr/main/rabin2.c" 3 4
                   ((void *)0)
# 558 "project/radare2/libr/main/rabin2.c"
                       ;
 const char *output = 
# 559 "project/radare2/libr/main/rabin2.c" 3 4
                     ((void *)0)
# 559 "project/radare2/libr/main/rabin2.c"
                         ;
 int rad = 0;
 
# 561 "project/radare2/libr/main/rabin2.c" 3 4
unsigned long long 
# 561 "project/radare2/libr/main/rabin2.c"
     laddr = 
# 561 "project/radare2/libr/main/rabin2.c" 3 4
             0xFFFFFFFFFFFFFFFFULL
# 561 "project/radare2/libr/main/rabin2.c"
...
# 562 "project/radare2/libr/main/rabin2.c" 3 4
unsigned long long 
# 562 "project/radare2/libr/main/rabin2.c"
     baddr = 
# 562 "project/radare2/libr/main/rabin2.c" 3 4
             0xFFFFFFFFFFFFFFFFULL
# 562 "project/radare2/libr/main/rabin2.c"
                     ;
 const char *do_demangle = 
# 563 "project/radare2/libr/main/rabin2.c" 3 4
                          ((void *)0)
# 563 "project/radare2/libr/main/rabin2.c"
                              ;
 const char *query = 
# 564 "project/radare2/libr/main/rabin2.c" 3 4
                    ((void *)0)
# 564 "project/radare2/libr/main/rabin2.c"
                        ;
 int c, bits = 0, actions = 0;
 char* create = 
# 566 "project/radare2/libr/main/rabin2.c" 3 4
               ((void *)0)
# 566 "project/radare2/libr/main/rabin2.c"
                   ;
 
# 567 "project/radare2/libr/main/rabin2.c" 3 4
_Bool 
# 567 "project/radare2/libr/main/rabin2.c"
     va = 
# 567 "project/radare2/libr/main/rabin2.c" 3 4
          1
# 567 "project/radare2/libr/main/rabin2.c"
...
# 568 "project/radare2/libr/main/rabin2.c" 3 4
unsigned long long 
# 568 "project/radare2/libr/main/rabin2.c"
     action = 
# 568 "project/radare2/libr/main/rabin2.c" 3 4
              0x000000
# 568 "project/radare2/libr/main/rabin2.c"
                           ;
 char *tmp, *ptr, *arch_name = 
# 569 "project/radare2/libr/main/rabin2.c" 3 4
                              ((void *)0)
# 569 "project/radare2/libr/main/rabin2.c"
                                  ;
 const char *arch = 
# 570 "project/radare2/libr/main/rabin2.c" 3 4
                   ((void *)0)
# 570 "project/radare2/libr/main/rabin2.c"
                       ;
 const char *forcebin = 
# 571 "project/radare2/libr/main/rabin2.c" 3 4
                       ((void *)0)
# 571 "project/radare2/libr/main/rabin2.c"
                           ;
 const char *chksum = 
# 572 "project/radare2/libr/main/rabin2.c" 3 4
                     ((void *)0)
# 572 "project/radare2/libr/main/rabin2.c"
                         ;
 const char *op = 
# 573 "project/radare2/libr/main/rabin2.c" 3 4
                 ((void *)0)
# 573 "project/radare2/libr/main/rabin2.c"
                     ;
...
# 579 "project/radare2/libr/main/rabin2.c" 3 4
unsigned long long 
# 579 "project/radare2/libr/main/rabin2.c"
     at = 
# 579 "project/radare2/libr/main/rabin2.c" 3 4
          0xFFFFFFFFFFFFFFFFULL
# 579 "project/radare2/libr/main/rabin2.c"
...
# 585 "project/radare2/libr/main/rabin2.c" 3 4
                                   ".local" "/" "share" "/" "radare2" "/" "plugins"
# 585 "project/radare2/libr/main/rabin2.c"
                                                  );
  char *plugindir = r_str_r2_prefix (
# 586 "project/radare2/libr/main/rabin2.c" 3 4
                                    "lib/radare2/" "5.5.4"
# 586 "project/radare2/libr/main/rabin2.c"
                                              );
  char *extrasdir = r_str_r2_prefix (
# 587 "project/radare2/libr/main/rabin2.c" 3 4
                                    "lib/radare2-extras/" "5.5.4"
# 587 "project/radare2/libr/main/rabin2.c"
                                             );
  char *bindingsdir = r_str_r2_prefix (
# 588 "project/radare2/libr/main/rabin2.c" 3 4
                                      "lib/radare2-bindings/" "5.5.4"
# 588 "project/radare2/libr/main/rabin2.c"
                                                 );
  RLib *l = r_lib_new (
# 589 "project/radare2/libr/main/rabin2.c" 3 4
                      ((void *)0)
# 589 "project/radare2/libr/main/rabin2.c"
                          , 
# 589 "project/radare2/libr/main/rabin2.c" 3 4
                            ((void *)0)
# 589 "project/radare2/libr/main/rabin2.c"
...
# 597 "project/radare2/libr/main/rabin2.c" 3 4
                            "R2_LIBR_PLUGINS"
# 597 "project/radare2/libr/main/rabin2.c"
                                     );
  if (path && *path) {
 ...
 free (tmp);
# 625 "project/radare2/libr/main/rabin2.c"
 ...
 while ((c = r_getopt_next (&opt)) != -1) {
  ...
  case 'g':
   { actions++; action |= (
# 670 "project/radare2/libr/main/rabin2.c" 3 4
  0x010000
# 670 "project/radare2/libr/main/rabin2.c"
  ); };
   { actions++; action |= (
# 671 "project/radare2/libr/main/rabin2.c" 3 4
  0x000002
# 671 "project/radare2/libr/main/rabin2.c"
  ); };
   { actions++; action |= (
# 672 "project/radare2/libr/main/rabin2.c" 3 4
  0x000004
# 672 "project/radare2/libr/main/rabin2.c"
  ); };
   { actions++; action |= (
# 673 "project/radare2/libr/main/rabin2.c" 3 4
  0x000008
# 673 "project/radare2/libr/main/rabin2.c"
  ); };
   { actions++; action |= (
# 674 "project/radare2/libr/main/rabin2.c" 3 4
  0x20000000
# 674 "project/radare2/libr/main/rabin2.c"
  ); };
   { actions++; action |= (
# 675 "project/radare2/libr/main/rabin2.c" 3 4
  0x200000000
# 675 "project/radare2/libr/main/rabin2.c"
  ); };
   { actions++; action |= (
# 676 "project/radare2/libr/main/rabin2.c" 3 4
  0x000080
# 676 "project/radare2/libr/main/rabin2.c"
  ); };
   { actions++; action |= (
# 677 "project/radare2/libr/main/rabin2.c" 3 4
  0x040000
# 677 "project/radare2/libr/main/rabin2.c"
  ); };
   { actions++; action |= (
# 678 "project/radare2/libr/main/rabin2.c" 3 4
  0x000010
# 678 "project/radare2/libr/main/rabin2.c"
  ); };
   { actions++; action |= (
# 679 "project/radare2/libr/main/rabin2.c" 3 4
  0x000100
# 679 "project/radare2/libr/main/rabin2.c"
  ); };
   { actions++; action |= (
# 680 "project/radare2/libr/main/rabin2.c" 3 4
  0x020000
# 680 "project/radare2/libr/main/rabin2.c"
  ); };
   { actions++; action |= (
# 681 "project/radare2/libr/main/rabin2.c" 3 4
  0x000001
# 681 "project/radare2/libr/main/rabin2.c"
  ); };
   { actions++; action |= (
# 682 "project/radare2/libr/main/rabin2.c" 3 4
  0x10000000
# 682 "project/radare2/libr/main/rabin2.c"
  ); };
   { actions++; action |= (
# 683 "project/radare2/libr/main/rabin2.c" 3 4
  0x000800
# 683 "project/radare2/libr/main/rabin2.c"
  ); };
   { actions++; action |= (
# 684 "project/radare2/libr/main/rabin2.c" 3 4
  0x000200
# 684 "project/radare2/libr/main/rabin2.c"
  ); };
   { actions++; action |= (
# 685 "project/radare2/libr/main/rabin2.c" 3 4
  0x002000
# 685 "project/radare2/libr/main/rabin2.c"
  ); };
   { actions++; action |= (
# 686 "project/radare2/libr/main/rabin2.c" 3 4
  0x800000
# 686 "project/radare2/libr/main/rabin2.c"
  ); };
   break;
  case 'V': { actions++; action |= (
# 688 "project/radare2/libr/main/rabin2.c" 3 4
           0x800000
# 688 "project/radare2/libr/main/rabin2.c"
           ); }; break;
  case 'T': { actions++; action |= (
# 689 "project/radare2/libr/main/rabin2.c" 3 4
           0x80000000
# 689 "project/radare2/libr/main/rabin2.c"
           ); }; break;
  case 't': { actions++; action |= (
# 690 "project/radare2/libr/main/rabin2.c" 3 4
           0x40000000
# 690 "project/radare2/libr/main/rabin2.c"
           ); }; break;
  case 'w': { actions++; action |= (
# 691 "project/radare2/libr/main/rabin2.c" 3 4
           0x100000000
# 691 "project/radare2/libr/main/rabin2.c"
           ); }; break;
  case 'q':
   rad = (rad & 
# 693 "project/radare2/libr/main/rabin2.c" 3 4
               0x004 
# 693 "project/radare2/libr/main/rabin2.c"
                             ?
    
# 694 "project/radare2/libr/main/rabin2.c" 3 4
   0x020 
# 694 "project/radare2/libr/main/rabin2.c"
                   : 
# 694 "project/radare2/libr/main/rabin2.c" 3 4
                     0x004
# 694 "project/radare2/libr/main/rabin2.c"
   ...
   break;
  case 'j': rad = 
# 696 "project/radare2/libr/main/rabin2.c" 3 4
                 0x008
# 696 "project/radare2/libr/main/rabin2.c"
                            ; break;
  case 'A': { actions++; action |= (
# 697 "project/radare2/libr/main/rabin2.c" 3 4
           0x004000
# 697 "project/radare2/libr/main/rabin2.c"
           ); }; break;
  case 'a': arch = opt.arg; break;
  case 'C':
   { actions++; action |= (
# 700 "project/radare2/libr/main/rabin2.c" 3 4
  0x008000
# 700 "project/radare2/libr/main/rabin2.c"
  ); };
  ...
  case 'c':
   if ((action & (
# 707 "project/radare2/libr/main/rabin2.c" 3 4
      0x010000
# 707 "project/radare2/libr/main/rabin2.c"
      ))) {
    rad = 
# 708 "project/radare2/libr/main/rabin2.c" 3 4
         0x040
# 708 "project/radare2/libr/main/rabin2.c"
                         ;
   } else {
      { actions++; action |= (
# 710 "project/radare2/libr/main/rabin2.c" 3 4
     0x010000
# 710 "project/radare2/libr/main/rabin2.c"
     ); };
   }
   break;
  case 'f': arch_name = strdup (opt.arg); break;
  case 'F': forcebin = opt.arg; break;
  case 'b': bits = r_num_math (
# 715 "project/radare2/libr/main/rabin2.c" 3 4
                              ((void *)0)
# 715 "project/radare2/libr/main/rabin2.c"
                                  , opt.arg); break;
  case 'm':
   at = r_num_math (
# 717 "project/radare2/libr/main/rabin2.c" 3 4
                   ((void *)0)
# 717 "project/radare2/libr/main/rabin2.c"
                       , opt.arg);
   { actions++; action |= (
# 718 "project/radare2/libr/main/rabin2.c" 3 4
  0x000400
# 718 "project/radare2/libr/main/rabin2.c"
  ); };
   break;
  case 'i':
   { actions++; action |= (
# 721 "project/radare2/libr/main/rabin2.c" 3 4
  0x000002
# 721 "project/radare2/libr/main/rabin2.c"
  ); };
   break;
  case 's':
   { actions++; action |= (
# 724 "project/radare2/libr/main/rabin2.c" 3 4
  0x000004
# 724 "project/radare2/libr/main/rabin2.c"
  ); };
   break;
  case 'S':
   if ((action & (
# 727 "project/radare2/libr/main/rabin2.c" 3 4
      0x20000000
# 727 "project/radare2/libr/main/rabin2.c"
      ))) {
    action &= ~
# 728 "project/radare2/libr/main/rabin2.c" 3 4
              0x20000000
# 728 "project/radare2/libr/main/rabin2.c"
                                ;
    action |= 
# 729 "project/radare2/libr/main/rabin2.c" 3 4
             0x200000000
# 729 "project/radare2/libr/main/rabin2.c"
                                       ;
   } else if ((action & (
# 730 "project/radare2/libr/main/rabin2.c" 3 4
             0x000008
# 730 "project/radare2/libr/main/rabin2.c"
             ))) {
    action &= ~
# 731 "project/radare2/libr/main/rabin2.c" 3 4
              0x000008
# 731 "project/radare2/libr/main/rabin2.c"
                                ;
    action |= 
# 732 "project/radare2/libr/main/rabin2.c" 3 4
             0x20000000
# 732 "project/radare2/libr/main/rabin2.c"
                               ;
   } else {
    { actions++; action |= (
# 734 "project/radare2/libr/main/rabin2.c" 3 4
   0x000008
# 734 "project/radare2/libr/main/rabin2.c"
   ); };
   }
   break;
  case 'z':
   if ((action & (
# 738 "project/radare2/libr/main/rabin2.c" 3 4
      0x000080
# 738 "project/radare2/libr/main/rabin2.c"
      ))) {
    if (rawstr) {
    ...
    { actions++; action |= (
# 747 "project/radare2/libr/main/rabin2.c" 3 4
   0x000080
# 747 "project/radare2/libr/main/rabin2.c"
   ); };
   }
   break;
  case 'Z': { actions++; action |= (
# 750 "project/radare2/libr/main/rabin2.c" 3 4
           0x040000
# 750 "project/radare2/libr/main/rabin2.c"
           ); }; break;
  case 'I': { actions++; action |= (
# 751 "project/radare2/libr/main/rabin2.c" 3 4
           0x000010
# 751 "project/radare2/libr/main/rabin2.c"
           ); }; break;
  case 'H':
   { actions++; action |= (
# 753 "project/radare2/libr/main/rabin2.c" 3 4
  0x000100
# 753 "project/radare2/libr/main/rabin2.c"
  ); };
   break;
  case 'd': { actions++; action |= (
# 755 "project/radare2/libr/main/rabin2.c" 3 4
           0x020000
# 755 "project/radare2/libr/main/rabin2.c"
           ); }; break;
  case 'P':
   if ((action & (
# 757 "project/radare2/libr/main/rabin2.c" 3 4
      0x080000
# 757 "project/radare2/libr/main/rabin2.c"
      ))) {
    { actions++; action |= (
# 758 "project/radare2/libr/main/rabin2.c" 3 4
   0x100000
# 758 "project/radare2/libr/main/rabin2.c"
   ); };
   } else {
    { actions++; action |= (
# 760 "project/radare2/libr/main/rabin2.c" 3 4
   0x080000
# 760 "project/radare2/libr/main/rabin2.c"
   ); };
   }
   break;
  case 'D':
  ...
  case 'e':
   if (action & 
# 774 "project/radare2/libr/main/rabin2.c" 3 4
               0x000001
# 774 "project/radare2/libr/main/rabin2.c"
                                ) {
    action &= ~
# 775 "project/radare2/libr/main/rabin2.c" 3 4
              0x000001
# 775 "project/radare2/libr/main/rabin2.c"
                               ;
    action |= 
# 776 "project/radare2/libr/main/rabin2.c" 3 4
             0x10000000
# 776 "project/radare2/libr/main/rabin2.c"
                               ;
   } else {
    { actions++; action |= (
# 778 "project/radare2/libr/main/rabin2.c" 3 4
   0x000001
# 778 "project/radare2/libr/main/rabin2.c"
   ); };
   }
   break;
  case 'E': { actions++; action |= (
# 781 "project/radare2/libr/main/rabin2.c" 3 4
           0x400000
# 781 "project/radare2/libr/main/rabin2.c"
           ); }; break;
  case 'U': { actions++; action |= (
# 782 "project/radare2/libr/main/rabin2.c" 3 4
           0x8000000
# 782 "project/radare2/libr/main/rabin2.c"
           ); }; break;
  case 'Q': { actions++; action |= (
# 783 "project/radare2/libr/main/rabin2.c" 3 4
           0x200000
# 783 "project/radare2/libr/main/rabin2.c"
           ); }; break;
  case 'M': { actions++; action |= (
# 784 "project/radare2/libr/main/rabin2.c" 3 4
           0x000800
# 784 "project/radare2/libr/main/rabin2.c"
           ); }; break;
  case 'l': { actions++; action |= (
# 785 "project/radare2/libr/main/rabin2.c" 3 4
           0x000200
# 785 "project/radare2/libr/main/rabin2.c"
           ); }; break;
  case 'R': { actions++; action |= (
# 786 "project/radare2/libr/main/rabin2.c" 3 4
           0x002000
# 786 "project/radare2/libr/main/rabin2.c"
           ); }; break;
  case 'x': { actions++; action |= (
# 787 "project/radare2/libr/main/rabin2.c" 3 4
           0x001000
# 787 "project/radare2/libr/main/rabin2.c"
           ); }; break;
  case 'X': { actions++; action |= (
# 788 "project/radare2/libr/main/rabin2.c" 3 4
           0x1000000
# 788 "project/radare2/libr/main/rabin2.c"
           ); }; break;
  case 'O':
   op = opt.arg;
   { actions++; action |= (
# 791 "project/radare2/libr/main/rabin2.c" 3 4
  0x000020
# 791 "project/radare2/libr/main/rabin2.c"
  ); };
   if (*op == 'c') {
...
# 810 "project/radare2/libr/main/rabin2.c" 3 4
   fprintf(__stderrp,
# 810 "project/radare2/libr/main/rabin2.c"
   "Missing filename\n"
# 810 "project/radare2/libr/main/rabin2.c" 3 4
   )
# 810 "project/radare2/libr/main/rabin2.c"
  ...
  case 'p': va = 
# 816 "project/radare2/libr/main/rabin2.c" 3 4
                0
# 816 "project/radare2/libr/main/rabin2.c"
                     ; break;
  case 'r': rad = 
# 817 "project/radare2/libr/main/rabin2.c" 3 4
                 1
# 817 "project/radare2/libr/main/rabin2.c"
                     ; break;
  case 'v':
     r_core_fini (&core);
  ...
  case 'L':
   { actions++; action |= (
# 822 "project/radare2/libr/main/rabin2.c" 3 4
  0x4000000
# 822 "project/radare2/libr/main/rabin2.c"
  ); };
   break;
  case 'G':
   laddr = r_num_math (
# 825 "project/radare2/libr/main/rabin2.c" 3 4
                      ((void *)0)
# 825 "project/radare2/libr/main/rabin2.c"
                          , opt.arg);
   if (laddr == 
# 826 "project/radare2/libr/main/rabin2.c" 3 4
               0xFFFFFFFFFFFFFFFFULL
# 826 "project/radare2/libr/main/rabin2.c"
                       ) {
    va = 
# 827 "project/radare2/libr/main/rabin2.c" 3 4
        0
# 827 "project/radare2/libr/main/rabin2.c"
             ;
   }
   break;
  case 'B':
   baddr = r_num_math (
# 831 "project/radare2/libr/main/rabin2.c" 3 4
                      ((void *)0)
# 831 "project/radare2/libr/main/rabin2.c"
                          , opt.arg);
   break;
  case '@':
   at = r_num_math (
# 834 "project/radare2/libr/main/rabin2.c" 3 4
                   ((void *)0)
# 834 "project/radare2/libr/main/rabin2.c"
                       , opt.arg);
   if (at == 0LL && *opt.arg != '0') {
    at = 
# 836 "project/radare2/libr/main/rabin2.c" 3 4
        0xFFFFFFFFFFFFFFFFULL
# 836 "project/radare2/libr/main/rabin2.c"
                ;
   }
   break;
  case 'n':
  ...
  default:
   action |= 
# 853 "project/radare2/libr/main/rabin2.c" 3 4
            0x000040
# 853 "project/radare2/libr/main/rabin2.c"
                          ;
   break;
  }
 }
 ...
 PJ *pj = 
# 859 "project/radare2/libr/main/rabin2.c" 3 4
         ((void *)0)
# 859 "project/radare2/libr/main/rabin2.c"
             ;
 if (rad == 
# 860 "project/radare2/libr/main/rabin2.c" 3 4
           0x008
# 860 "project/radare2/libr/main/rabin2.c"
                      ) {
 ...
 if ((action & (
# 867 "project/radare2/libr/main/rabin2.c" 3 4
    0x4000000
# 867 "project/radare2/libr/main/rabin2.c"
    ))) {
  const char* plugin_name = 
# 868 "project/radare2/libr/main/rabin2.c" 3 4
                           ((void *)0)
# 868 "project/radare2/libr/main/rabin2.c"
                               ;
  if (opt.ind < argc) {
  ...
  if (rad == 
# 873 "project/radare2/libr/main/rabin2.c" 3 4
            0x008
# 873 "project/radare2/libr/main/rabin2.c"
                       ) {
 ...
 if (do_demangle) {
  char *res = 
# 883 "project/radare2/libr/main/rabin2.c" 3 4
             ((void *)0)
# 883 "project/radare2/libr/main/rabin2.c"
                 ;
  if ((argc - opt.ind) < 2) {
   r_core_fini (&core);
  ...
  if (!strcmp (file, "-")) {
   for (;;) {
    file = stdin_gets (
# 893 "project/radare2/libr/main/rabin2.c" 3 4
                      0
# 893 "project/radare2/libr/main/rabin2.c"
                           );
    if (!file || !*file) {
     break;
    }
...
# 899 "project/radare2/libr/main/rabin2.c" 3 4
    fprintf(__stderrp,
# 899 "project/radare2/libr/main/rabin2.c"
    "Unknown lang to demangle. Use: cxx, java, objc, swift\n"
# 899 "project/radare2/libr/main/rabin2.c" 3 4
    )
# 899 "project/radare2/libr/main/rabin2.c"
                                                                       ;
...
# 908 "project/radare2/libr/main/rabin2.c" 3 4
   { free((void *)
# 908 "project/radare2/libr/main/rabin2.c"
   res
# 908 "project/radare2/libr/main/rabin2.c" 3 4
   ); 
# 908 "project/radare2/libr/main/rabin2.c"
...
# 909 "project/radare2/libr/main/rabin2.c" 3 4
   { free((void *)
# 909 "project/radare2/libr/main/rabin2.c"
   file
# 909 "project/radare2/libr/main/rabin2.c" 3 4
   ); 
# 909 "project/radare2/libr/main/rabin2.c"
...
# 909 "project/radare2/libr/main/rabin2.c"
   ...
   char *r = stdin_gets (
# 911 "project/radare2/libr/main/rabin2.c" 3 4
                        1
# 911 "project/radare2/libr/main/rabin2.c"
                            );
   free (r);
  } else {
   res = __demangleAs (bin, type, file);
...
# 932 "project/radare2/libr/main/rabin2.c" 3 4
 fprintf(__stderrp,
# 932 "project/radare2/libr/main/rabin2.c"
...
# 932 "project/radare2/libr/main/rabin2.c"
 ...
 if (!query) {
  if (action & 
# 938 "project/radare2/libr/main/rabin2.c" 3 4
              0x000040 
# 938 "project/radare2/libr/main/rabin2.c"
                             || action == 
# 938 "project/radare2/libr/main/rabin2.c" 3 4
                                          0x000000 
# 938 "project/radare2/libr/main/rabin2.c"
 ...
 if (arch) {
   ...
   *ptr = '\0';
   bits = r_num_math (
# 947 "project/radare2/libr/main/rabin2.c" 3 4
                     ((void *)0)
# 947 "project/radare2/libr/main/rabin2.c"
                         , ptr+1);
  }
 }
 if (action & 
# 950 "project/radare2/libr/main/rabin2.c" 3 4
             0x008000
# 950 "project/radare2/libr/main/rabin2.c"
                             ) {

  RBuffer *b;
  int datalen, codelen;
  
# 954 "project/radare2/libr/main/rabin2.c" 3 4
 unsigned char 
# 954 "project/radare2/libr/main/rabin2.c"
     *data = 
# 954 "project/radare2/libr/main/rabin2.c" 3 4
             ((void *)0)
# 954 "project/radare2/libr/main/rabin2.c"
...
# 957 "project/radare2/libr/main/rabin2.c" 3 4
  fprintf(__stderrp,
# 957 "project/radare2/libr/main/rabin2.c"
...
# 957 "project/radare2/libr/main/rabin2.c"
  ...
  *p++ = 0;
   ...
   *p2++ = 0;
   ...
   data = 
# 972 "project/radare2/libr/main/rabin2.c" 3 4
         ((void *)0)
# 972 "project/radare2/libr/main/rabin2.c"
             ;
   datalen = 0;
  }
...
# 985 "project/radare2/libr/main/rabin2.c" 3 4
  unsigned long long 
# 985 "project/radare2/libr/main/rabin2.c"
       tmpsz;
   const 
# 986 "project/radare2/libr/main/rabin2.c" 3 4
        unsigned char 
# 986 "project/radare2/libr/main/rabin2.c"
            *tmp = r_buf_data (b, &tmpsz);
   if (r_file_dump (file, tmp, tmpsz, 0)) {
    
# 988 "project/radare2/libr/main/rabin2.c" 3 4
   fprintf(__stderrp,
# 988 "project/radare2/libr/main/rabin2.c"
   "Dumped %" 
# 988 "project/radare2/libr/main/rabin2.c" 3 4
   "lld" 
# 988 "project/radare2/libr/main/rabin2.c"
...
# 989 "project/radare2/libr/main/rabin2.c"
                ;
    (void)r_file_chmod (file, "+x", 0);
   } else {
    
# 992 "project/radare2/libr/main/rabin2.c" 3 4
   fprintf(__stderrp,
# 992 "project/radare2/libr/main/rabin2.c"
...
# 996 "project/radare2/libr/main/rabin2.c" 3 4
  fprintf(__stderrp,
# 996 "project/radare2/libr/main/rabin2.c"
...
# 996 "project/radare2/libr/main/rabin2.c"
 ...
 if (rawstr == 2) {
  action &= ~
# 1002 "project/radare2/libr/main/rabin2.c" 3 4
 0x000080
# 1002 "project/radare2/libr/main/rabin2.c"
                                 ;
 }
...
# 1007 "project/radare2/libr/main/rabin2.c" 3 4
 fprintf(__stderrp,
# 1007 "project/radare2/libr/main/rabin2.c"
 "Missing file.\n"
# 1007 "project/radare2/libr/main/rabin2.c" 3 4
 )
# 1007 "project/radare2/libr/main/rabin2.c"
 ...
 if (file && *file && action & 
# 1012 "project/radare2/libr/main/rabin2.c" 3 4
                              0x200000
# 1012 "project/radare2/libr/main/rabin2.c"
                                              ) {
  ...
  if (child == 0) {
   return waitpid (child, 
# 1020 "project/radare2/libr/main/rabin2.c" 3 4
                         ((void *)0)
# 1020 "project/radare2/libr/main/rabin2.c"
                             , 0);
  }
...
# 1025 "project/radare2/libr/main/rabin2.c" 3 4
  fprintf(__stderrp,
# 1025 "project/radare2/libr/main/rabin2.c"
  "%s is loaded at 0x%"
# 1025 "project/radare2/libr/main/rabin2.c" 3 4
  "llx"
# 1025 "project/radare2/libr/main/rabin2.c"
...
# 1030 "project/radare2/libr/main/rabin2.c" 3 4
 fprintf(__stderrp,
# 1030 "project/radare2/libr/main/rabin2.c"
 "Cannot open the '%s' library\n", file
# 1030 "project/radare2/libr/main/rabin2.c" 3 4
 )
# 1030 "project/radare2/libr/main/rabin2.c"
                                                 ;
 ...
 if (action & 
# 1034 "project/radare2/libr/main/rabin2.c" 3 4
             0x1000000
# 1034 "project/radare2/libr/main/rabin2.c"
                              ) {
  RList *files = r_list_newf (
# 1035 "project/radare2/libr/main/rabin2.c" 3 4
                             ((void *)0)
# 1035 "project/radare2/libr/main/rabin2.c"
                                 );
...
# 1041 "project/radare2/libr/main/rabin2.c" 3 4
  fprintf(__stderrp,
# 1041 "project/radare2/libr/main/rabin2.c"
  "Usage: rabin2 -X [fat|zip] foo.zip a b c\n"
# 1041 "project/radare2/libr/main/rabin2.c" 3 4
  )
# 1041 "project/radare2/libr/main/rabin2.c"
                                                        ;
...
# 1046 "project/radare2/libr/main/rabin2.c" 3 4
 fprintf(__stderrp,
# 1046 "project/radare2/libr/main/rabin2.c"
 "FMT %s\n", format
# 1046 "project/radare2/libr/main/rabin2.c" 3 4
 )
# 1046 "project/radare2/libr/main/rabin2.c"
...
# 1047 "project/radare2/libr/main/rabin2.c" 3 4
 fprintf(__stderrp,
# 1047 "project/radare2/libr/main/rabin2.c"
 "PKG %s\n", file
# 1047 "project/radare2/libr/main/rabin2.c" 3 4
 )
# 1047 "project/radare2/libr/main/rabin2.c"
...
# 1049 "project/radare2/libr/main/rabin2.c" 3 4
  fprintf(__stderrp,
# 1049 "project/radare2/libr/main/rabin2.c"
  "ADD %s\n", argv[i]
# 1049 "project/radare2/libr/main/rabin2.c" 3 4
  )
# 1049 "project/radare2/libr/main/rabin2.c"
...
# 1055 "project/radare2/libr/main/rabin2.c" 3 4
  _Bool 
# 1055 "project/radare2/libr/main/rabin2.c"
       ret = r_buf_dump (buf, file);
   r_buf_free (buf);
   if (!ret) {
    rc = 1;
   }
 ...
 if (file && *file) {
  if (r_core_file_open (&core, file, 
# 1067 "project/radare2/libr/main/rabin2.c" 3 4
                                    4
# 1067 "project/radare2/libr/main/rabin2.c"
                                            , 0)) {
   fd = r_io_fd_get_current (core.io);
   if (fd == -1) {
    
# 1070 "project/radare2/libr/main/rabin2.c" 3 4
   fprintf(__stderrp,
# 1070 "project/radare2/libr/main/rabin2.c"
   "r_core: Cannot open file '%s'\n", file
# 1070 "project/radare2/libr/main/rabin2.c" 3 4
   )
# 1070 "project/radare2/libr/main/rabin2.c"
                                                    ;
...
# 1075 "project/radare2/libr/main/rabin2.c" 3 4
  fprintf(__stderrp,
# 1075 "project/radare2/libr/main/rabin2.c"
  "r_core: Cannot open file '%s'\n", file
# 1075 "project/radare2/libr/main/rabin2.c" 3 4
  )
# 1075 "project/radare2/libr/main/rabin2.c"
...
# 1094 "project/radare2/libr/main/rabin2.c" 3 4
  fprintf(__stderrp,
# 1094 "project/radare2/libr/main/rabin2.c"
  "r_bin: Cannot open file\n"
# 1094 "project/radare2/libr/main/rabin2.c" 3 4
  )
# 1094 "project/radare2/libr/main/rabin2.c"
                                       ;
 ...
 if (baddr != 
# 1102 "project/radare2/libr/main/rabin2.c" 3 4
             0xFFFFFFFFFFFFFFFFULL
# 1102 "project/radare2/libr/main/rabin2.c"
                     ) {
...
# 1114 "project/radare2/libr/main/rabin2.c" 3 4
                                 0x001
# 1114 "project/radare2/libr/main/rabin2.c"
                                              );
   r_cons_flush ();
  } else {
   if (!strcmp (query, "-")) {
...
# 1135 "project/radare2/libr/main/rabin2.c"
 core.bin = bin;
 bin->cb_printf = r_cons_printf;
 filter.offset = at;
 filter.name = name;
 r_cons_new ()->context->is_interactive = 
# 1139 "project/radare2/libr/main/rabin2.c" 3 4
                                         0
# 1139 "project/radare2/libr/main/rabin2.c"
                                              ;

 if ((rad==
# 1141 "project/radare2/libr/main/rabin2.c" 3 4
    0x008
# 1141 "project/radare2/libr/main/rabin2.c"
    &&actions>0)) {
  pj_o (pj);
 }

 if (action & 
# 1145 "project/radare2/libr/main/rabin2.c" 3 4
             0x004000 
# 1145 "project/radare2/libr/main/rabin2.c"
                                 || ((arch || bits || arch_name) &&
  !r_bin_select (bin, arch, bits, arch_name))) {
  if (rad == 
# 1147 "project/radare2/libr/main/rabin2.c" 3 4
            0x020 
# 1147 "project/radare2/libr/main/rabin2.c"
                            || rad == 
# 1147 "project/radare2/libr/main/rabin2.c" 3 4
                                      0x004
# 1147 "project/radare2/libr/main/rabin2.c"
   ...
   r_bin_list_archs (bin, pj, (rad == 
# 1150 "project/radare2/libr/main/rabin2.c" 3 4
                                     0x008
# 1150 "project/radare2/libr/main/rabin2.c"
                                                )? 'j': 1);
  }
  free (arch_name);
 }
 if (action & 
# 1154 "project/radare2/libr/main/rabin2.c" 3 4
             0x100000
# 1154 "project/radare2/libr/main/rabin2.c"
                                ) {
  SPDBOptions pdbopts;
...
# 1162 "project/radare2/libr/main/rabin2.c" 3 4
  { free((void *)
# 1162 "project/radare2/libr/main/rabin2.c"
  tmp
# 1162 "project/radare2/libr/main/rabin2.c" 3 4
  ); 
# 1162 "project/radare2/libr/main/rabin2.c"
...
# 1162 "project/radare2/libr/main/rabin2.c"
  ...
  r_bin_pdb_download (&core, pj, (rad==
# 1165 "project/radare2/libr/main/rabin2.c" 3 4
                                0x008
# 1165 "project/radare2/libr/main/rabin2.c"
                                &&actions>0), &pdbopts);
 }
 ...
 { if (action&(
# 1173 "project/radare2/libr/main/rabin2.c" 3 4
0x000008
# 1173 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1173 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1173 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "sections"); if (!r_core_bin_info (&core, 
# 1173 "project/radare2/libr/main/rabin2.c" 3 4
0x080
# 1173 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
# 1173 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1173 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_b (pj, 
...
# 1173 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1174 "project/radare2/libr/main/rabin2.c" 3 4
0x20000000
# 1174 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1174 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1174 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "segments"); if (!r_core_bin_info (&core, 
# 1174 "project/radare2/libr/main/rabin2.c" 3 4
0x400000
# 1174 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
...
# 1174 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1175 "project/radare2/libr/main/rabin2.c" 3 4
0x000001
# 1175 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1175 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1175 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "entries"); if (!r_core_bin_info (&core, 
# 1175 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1175 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
...
# 1175 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1176 "project/radare2/libr/main/rabin2.c" 3 4
0x10000000
# 1176 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1176 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1176 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "initfini"); if (!r_core_bin_info (&core, 
# 1176 "project/radare2/libr/main/rabin2.c" 3 4
0x200000
# 1176 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
...
# 1176 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1177 "project/radare2/libr/main/rabin2.c" 3 4
0x000800
# 1177 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1177 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1177 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "main"); if (!r_core_bin_info (&core, 
# 1177 "project/radare2/libr/main/rabin2.c" 3 4
0x004
# 1177 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
...
# 1177 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1178 "project/radare2/libr/main/rabin2.c" 3 4
0x000002
# 1178 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1178 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1178 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "imports"); if (!r_core_bin_info (&core, 
# 1178 "project/radare2/libr/main/rabin2.c" 3 4
0x020
# 1178 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
...
# 1178 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1179 "project/radare2/libr/main/rabin2.c" 3 4
0x010000
# 1179 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1179 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1179 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "classes"); if (!r_core_bin_info (&core, 
# 1179 "project/radare2/libr/main/rabin2.c" 3 4
0x400
# 1179 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
...
# 1179 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1180 "project/radare2/libr/main/rabin2.c" 3 4
0x000004
# 1180 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1180 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1180 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "symbols"); if (!r_core_bin_info (&core, 
# 1180 "project/radare2/libr/main/rabin2.c" 3 4
0x040
# 1180 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
...
# 1180 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1181 "project/radare2/libr/main/rabin2.c" 3 4
0x400000
# 1181 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1181 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1181 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "exports"); if (!r_core_bin_info (&core, 
# 1181 "project/radare2/libr/main/rabin2.c" 3 4
0x8000
# 1181 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
...
# 1181 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1182 "project/radare2/libr/main/rabin2.c" 3 4
0x8000000
# 1182 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1182 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1182 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "resources"); if (!r_core_bin_info (&core, 
# 1182 "project/radare2/libr/main/rabin2.c" 3 4
0x100000
# 1182 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
...
# 1182 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1183 "project/radare2/libr/main/rabin2.c" 3 4
0x000080
# 1183 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1183 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1183 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "strings"); if (!r_core_bin_info (&core, 
# 1183 "project/radare2/libr/main/rabin2.c" 3 4
0x001
# 1183 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
...
# 1183 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1184 "project/radare2/libr/main/rabin2.c" 3 4
0x000010
# 1184 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1184 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1184 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "info"); if (!r_core_bin_info (&core, 
# 1184 "project/radare2/libr/main/rabin2.c" 3 4
0x002
# 1184 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
...
# 1184 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1185 "project/radare2/libr/main/rabin2.c" 3 4
0x000100
# 1185 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1185 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1185 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "fields"); if (!r_core_bin_info (&core, 
# 1185 "project/radare2/libr/main/rabin2.c" 3 4
0x100
# 1185 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
...
# 1185 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1186 "project/radare2/libr/main/rabin2.c" 3 4
0x2000000
# 1186 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1186 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1186 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "header"); if (!r_core_bin_info (&core, 
# 1186 "project/radare2/libr/main/rabin2.c" 3 4
0x80000
# 1186 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
...
# 1186 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1187 "project/radare2/libr/main/rabin2.c" 3 4
0x000200
# 1187 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1187 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1187 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "libs"); if (!r_core_bin_info (&core, 
# 1187 "project/radare2/libr/main/rabin2.c" 3 4
0x200
# 1187 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
...
# 1187 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1188 "project/radare2/libr/main/rabin2.c" 3 4
0x002000
# 1188 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1188 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1188 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "relocs"); if (!r_core_bin_info (&core, 
# 1188 "project/radare2/libr/main/rabin2.c" 3 4
0x010
# 1188 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
...
# 1188 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1189 "project/radare2/libr/main/rabin2.c" 3 4
0x020000
# 1189 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1189 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1189 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "dwarf"); if (!r_core_bin_info (&core, 
# 1189 "project/radare2/libr/main/rabin2.c" 3 4
0x800
# 1189 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
...
# 1189 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1190 "project/radare2/libr/main/rabin2.c" 3 4
0x080000
# 1190 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1190 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1190 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "pdb"); if (!r_core_bin_info (&core, 
# 1190 "project/radare2/libr/main/rabin2.c" 3 4
0x2000
# 1190 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
...
# 1190 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1191 "project/radare2/libr/main/rabin2.c" 3 4
0x040000
# 1191 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1191 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1191 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "size"); if (!r_core_bin_info (&core, 
# 1191 "project/radare2/libr/main/rabin2.c" 3 4
0x1000
# 1191 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
...
# 1191 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1192 "project/radare2/libr/main/rabin2.c" 3 4
0x800000
# 1192 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1192 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1192 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "versioninfo"); if (!r_core_bin_info (&core, 
# 1192 "project/radare2/libr/main/rabin2.c" 3 4
0x10000
# 1192 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
...
# 1192 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1193 "project/radare2/libr/main/rabin2.c" 3 4
0x80000000
# 1193 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1193 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1193 "project/radare2/libr/main/rabin2.c"
...
# 1193 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1194 "project/radare2/libr/main/rabin2.c" 3 4
0x40000000
# 1194 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1194 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1194 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "hashes"); if (!r_core_bin_info (&core, 
# 1194 "project/radare2/libr/main/rabin2.c" 3 4
0x10000000
# 1194 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
...
# 1194 "project/radare2/libr/main/rabin2.c"
 ...
 { if (action&(
# 1195 "project/radare2/libr/main/rabin2.c" 3 4
0x200000000
# 1195 "project/radare2/libr/main/rabin2.c"
)) { if ((rad==
# 1195 "project/radare2/libr/main/rabin2.c" 3 4
0x008
# 1195 "project/radare2/libr/main/rabin2.c"
&&actions>0)) pj_k (pj, "sections mapping"); if (!r_core_bin_info (&core, 
# 1195 "project/radare2/libr/main/rabin2.c" 3 4
0x40000000
# 1195 "project/radare2/libr/main/rabin2.c"
, pj, rad, va, &filter, chksum)) { if ((rad==
...
# 1195 "project/radare2/libr/main/rabin2.c"
 ...
 if (action & 
# 1196 "project/radare2/libr/main/rabin2.c" 3 4
             0x000400
# 1196 "project/radare2/libr/main/rabin2.c"
                              ) {
  rabin_show_srcline (bin, at);
 }
 if (action & 
# 1199 "project/radare2/libr/main/rabin2.c" 3 4
             0x001000
# 1199 "project/radare2/libr/main/rabin2.c"
                              ) {
  RBinFile *bf = r_bin_cur (bin);
  if (bf && bf->xtr_data) {
...
# 1204 "project/radare2/libr/main/rabin2.c" 3 4
  fprintf(__stderrp,
# 1204 "project/radare2/libr/main/rabin2.c"
  "Cannot extract bins from '%s'. No supported " "plugins found!\n", bin->file
# 1204 "project/radare2/libr/main/rabin2.c" 3 4
  )

                                  
# 1206 "project/radare2/libr/main/rabin2.c"
                                 ;
  }
 }
 if (op && action & 
# 1209 "project/radare2/libr/main/rabin2.c" 3 4
                   0x000020
# 1209 "project/radare2/libr/main/rabin2.c"
                                      ) {
  rabin_do_operation (bin, op, rad, output, file);
 }
 if ((rad==
# 1212 "project/radare2/libr/main/rabin2.c" 3 4
    0x008
# 1212 "project/radare2/libr/main/rabin2.c"
    &&actions>0)) {
  pj_end (pj);
  r_cons_println (pj_string (pj));
 }
