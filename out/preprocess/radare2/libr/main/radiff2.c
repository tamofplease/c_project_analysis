# 0 "project/radare2/libr/main/radiff2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/main/radiff2.c"
...
# 4 "project/radare2/libr/main/radiff2.c" 2



# 6 "project/radare2/libr/main/radiff2.c"
enum {
 MODE_DIFF,
 MODE_DIFF_STRS,
 MODE_DIFF_IMPORTS,
...
# 32 "project/radare2/libr/main/radiff2.c" 3 4
unsigned long long 
# 32 "project/radare2/libr/main/radiff2.c"
     gdiff_start;
 
# 33 "project/radare2/libr/main/radiff2.c" 3 4
_Bool 
# 33 "project/radare2/libr/main/radiff2.c"
     zignatures;
 const char *file;
 const char *file2;
 
# 36 "project/radare2/libr/main/radiff2.c" 3 4
unsigned int 
# 36 "project/radare2/libr/main/radiff2.c"
     count;
 int showcount;
 int useva;
 int delta;
...
# 41 "project/radare2/libr/main/radiff2.c" 3 4
_Bool 
# 41 "project/radare2/libr/main/radiff2.c"
     json_started;
 int diffmode;
 int diffops;
 int mode;
...
# 46 "project/radare2/libr/main/radiff2.c" 3 4
_Bool 
# 46 "project/radare2/libr/main/radiff2.c"
     disasm;
 
# 47 "project/radare2/libr/main/radiff2.c" 3 4
_Bool 
# 47 "project/radare2/libr/main/radiff2.c"
     pdc;
 
# 48 "project/radare2/libr/main/radiff2.c" 3 4
_Bool 
# 48 "project/radare2/libr/main/radiff2.c"
     quiet;
 RCore *core;
 const char *arch;
 const char *runcmd;
...
# 55 "project/radare2/libr/main/radiff2.c" 3 4
_Bool 
# 55 "project/radare2/libr/main/radiff2.c"
     verbose;
 RList *evals;
 PJ *pj;
} RadiffOptions;
...
static RCore *opencore(RadiffOptions *ro, const char *f) {
 RListIter *iter;
 const 
# 62 "project/radare2/libr/main/radiff2.c" 3 4
      unsigned long long 
# 62 "project/radare2/libr/main/radiff2.c"
           baddr = 
# 62 "project/radare2/libr/main/radiff2.c" 3 4
...
# 62 "project/radare2/libr/main/radiff2.c"
 ...
 if (!c) {
  return 
# 66 "project/radare2/libr/main/radiff2.c" 3 4
        ((void *)0)
# 66 "project/radare2/libr/main/radiff2.c"
            ;
 }
 r_core_loadlibs (c, 
# 68 "project/radare2/libr/main/radiff2.c" 3 4
                    0xFFFFFFFFU
# 68 "project/radare2/libr/main/radiff2.c"
                                       , 
# 68 "project/radare2/libr/main/radiff2.c" 3 4
                                         ((void *)0)
# 68 "project/radare2/libr/main/radiff2.c"
 ...
 r_config_set_i (c->config, "scr.interactive", 
# 70 "project/radare2/libr/main/radiff2.c" 3 4
                                              0
# 70 "project/radare2/libr/main/radiff2.c"
                                                   );
 
# 71 "project/radare2/libr/main/radiff2.c" 3 4
if (
# 71 "project/radare2/libr/main/radiff2.c"
ro->evals
# 71 "project/radare2/libr/main/radiff2.c" 3 4
) for (
# 71 "project/radare2/libr/main/radiff2.c"
...
# 72 "project/radare2/libr/main/radiff2.c" 3 4
                              0
# 72 "project/radare2/libr/main/radiff2.c"
                                   );
 }
 if (f) {
  RIODesc * rfile = 
# 75 "project/radare2/libr/main/radiff2.c" 3 4
                   ((void *)0)
# 75 "project/radare2/libr/main/radiff2.c"
                       ;
  ...
  if (!rfile) {
   r_core_free (c);
   return 
# 86 "project/radare2/libr/main/radiff2.c" 3 4
         ((void *)0)
# 86 "project/radare2/libr/main/radiff2.c"
             ;
  }
  (void) r_core_bin_load (c, 
# 88 "project/radare2/libr/main/radiff2.c" 3 4
                            ((void *)0)
# 88 "project/radare2/libr/main/radiff2.c"
                                , baddr);
  (void) r_core_bin_update_arch_bits (c);


  if (
# 92 "project/radare2/libr/main/radiff2.c" 3 4
     (!(
# 92 "project/radare2/libr/main/radiff2.c"
     r_bin_get_sections (c->bin)
# 92 "project/radare2/libr/main/radiff2.c" 3 4
     ) || !(
# 92 "project/radare2/libr/main/radiff2.c"
     r_bin_get_sections (c->bin)
...
# 92 "project/radare2/libr/main/radiff2.c"
   ...
   r_config_set_i (c->config, "io.va", 
# 93 "project/radare2/libr/main/radiff2.c" 3 4
                                      0
# 93 "project/radare2/libr/main/radiff2.c"
                                           );
  }
  if (ro->anal_all) {
   const char *cmd = "aac";
...
static void readstr(char *s, int sz, const 
# 116 "project/radare2/libr/main/radiff2.c" 3 4
                                          unsigned char 
# 116 "project/radare2/libr/main/radiff2.c"
                                              *buf, int len) {
 *s = 0;
 int last = 
# 118 "project/radare2/libr/main/radiff2.c" 3 4
           (((
# 118 "project/radare2/libr/main/radiff2.c"
           len
# 118 "project/radare2/libr/main/radiff2.c" 3 4
           )>(
# 118 "project/radare2/libr/main/radiff2.c"
...
# 126 "project/radare2/libr/main/radiff2.c" 3 4
__builtin___strncpy_chk (
# 126 "project/radare2/libr/main/radiff2.c"
s
# 126 "project/radare2/libr/main/radiff2.c" 3 4
, 
# 126 "project/radare2/libr/main/radiff2.c"
 ...
 case 'u':
  if (op->a_len > 0) {
   ...
   if (*s) {
    if (!ro->quiet) {
     printf (
# 144 "project/radare2/libr/main/radiff2.c" 3 4
            "\x1b[31m"
# 144 "project/radare2/libr/main/radiff2.c"
                     );
    }
    printf ("-0x%08"
# 146 "project/radare2/libr/main/radiff2.c" 3 4
                   "llx"
# 146 "project/radare2/libr/main/radiff2.c"
                          ":", op->a_off);
    int len = op->a_len;
    for (i = 0; i < len; i++) {
    ...
    if (!ro->quiet) {
     ...
     free (p);
     printf (
# 155 "project/radare2/libr/main/radiff2.c" 3 4
            "\x1b[0m"
# 155 "project/radare2/libr/main/radiff2.c"
                       );
    }
    printf ("\n");
   }
  ...
  if (op->b_len > 0) {
   ...
   if (*s) {
    if (!ro->quiet) {
     printf (
# 164 "project/radare2/libr/main/radiff2.c" 3 4
            "\x1b[32m"
# 164 "project/radare2/libr/main/radiff2.c"
                       );
    }
    printf ("+0x%08"
# 166 "project/radare2/libr/main/radiff2.c" 3 4
                   "llx"
# 166 "project/radare2/libr/main/radiff2.c"
                          ":", op->b_off);
    ...
    if (!ro->quiet) {
     ...
     free (p);
     printf (
# 174 "project/radare2/libr/main/radiff2.c" 3 4
            "\x1b[0m"
# 174 "project/radare2/libr/main/radiff2.c"
                       );
    }
    printf ("\n");
   }
...
# 182 "project/radare2/libr/main/radiff2.c" 3 4
  fprintf(__stderrp,
# 182 "project/radare2/libr/main/radiff2.c"
  "r2cmds (-r) + disasm (-D) not yet implemented\n"
# 182 "project/radare2/libr/main/radiff2.c" 3 4
  )
# 182 "project/radare2/libr/main/radiff2.c"
                                                             ;
  ...
  if (op->a_len == op->b_len) {
   ...
   printf (" @ 0x%08"
# 189 "project/radare2/libr/main/radiff2.c" 3 4
                    "llx" 
# 189 "project/radare2/libr/main/radiff2.c"
                            "\n", op->b_off);
  } else {
   if (op->a_len > 0) {
    printf ("r-%d @ 0x%08"
# 192 "project/radare2/libr/main/radiff2.c" 3 4
                         "llx" 
# 192 "project/radare2/libr/main/radiff2.c"
                                 "\n",
     op->a_len, op->a_off + ro->delta);
   }
   if (op->b_len > 0) {
    printf ("r+%d @ 0x%08"
# 196 "project/radare2/libr/main/radiff2.c" 3 4
                         "llx" 
# 196 "project/radare2/libr/main/radiff2.c"
                                 "\n",
    ...
    printf (" @ 0x%08"
# 202 "project/radare2/libr/main/radiff2.c" 3 4
                     "llx" 
# 202 "project/radare2/libr/main/radiff2.c"
                             "\n", op->b_off + ro->delta);
   }
...
# 210 "project/radare2/libr/main/radiff2.c" 3 4
  fprintf(__stderrp,
# 210 "project/radare2/libr/main/radiff2.c"
  "JSON (-j) + disasm (-D) not yet implemented\n"
# 210 "project/radare2/libr/main/radiff2.c" 3 4
  )
# 210 "project/radare2/libr/main/radiff2.c"
                                                           ;
 ...
 default:
  if (ro->disasm) {
   int i;
   printf ("--- 0x%08"
# 227 "project/radare2/libr/main/radiff2.c" 3 4
                     "llx" 
# 227 "project/radare2/libr/main/radiff2.c"
                             "  ", op->a_off);
   if (!ro->core) {
   ...
   if (ro->core) {
    int len = 
# 242 "project/radare2/libr/main/radiff2.c" 3 4
             (((
# 242 "project/radare2/libr/main/radiff2.c"
             4
# 242 "project/radare2/libr/main/radiff2.c" 3 4
             )>(
# 242 "project/radare2/libr/main/radiff2.c"
...
# 242 "project/radare2/libr/main/radiff2.c"
    ...
    if (ro->quiet) {
     ...
     char *bufasm = r_str_prefix_all (acbufasm, 
# 250 "project/radare2/libr/main/radiff2.c" 3 4
                                               "\x1b[31m"
# 250 "project/radare2/libr/main/radiff2.c"
                                                        "- ");
     printf ("%s"
# 251 "project/radare2/libr/main/radiff2.c" 3 4
                "\x1b[0m"
# 251 "project/radare2/libr/main/radiff2.c"
                           , bufasm);
     free (bufasm);
    }
    free (acbufasm);
   ...
   printf ("0x%08"
# 258 "project/radare2/libr/main/radiff2.c" 3 4
                 "llx" 
# 258 "project/radare2/libr/main/radiff2.c"
                         " ", op->a_off);
   for (i = 0; i < op->a_len; i++) {
    printf ("%02x", op->a_buf[i]);
   }
  ...
  if (ro->disasm) {
   int i;
   printf ("+++ 0x%08"
# 265 "project/radare2/libr/main/radiff2.c" 3 4
                     "llx" 
# 265 "project/radare2/libr/main/radiff2.c"
                             "  ", op->b_off);
   if (!ro->core) {
    ro->core = opencore (ro, 
# 267 "project/radare2/libr/main/radiff2.c" 3 4
                            ((void *)0)
# 267 "project/radare2/libr/main/radiff2.c"
                                );
   }
   for (i = 0; i < op->b_len; i++) {
    printf ("%02x", op->b_buf[i]);
   ...
   if (ro->core) {
    int len = 
# 274 "project/radare2/libr/main/radiff2.c" 3 4
             (((
# 274 "project/radare2/libr/main/radiff2.c"
             4
# 274 "project/radare2/libr/main/radiff2.c" 3 4
             )>(
# 274 "project/radare2/libr/main/radiff2.c"
...
# 274 "project/radare2/libr/main/radiff2.c"
    ...
    if (ro->quiet) {
     ...
     char *bufasm = r_str_prefix_all (acbufasm, 
# 283 "project/radare2/libr/main/radiff2.c" 3 4
                                               "\x1b[32m"
# 283 "project/radare2/libr/main/radiff2.c"
                                                          "+ ");
     printf ("%s\n" 
# 284 "project/radare2/libr/main/radiff2.c" 3 4
                   "\x1b[0m"
# 284 "project/radare2/libr/main/radiff2.c"
                              , bufasm);
     free (bufasm);
     free (acbufasm);
    }
   ...
   printf (" 0x%08"
# 295 "project/radare2/libr/main/radiff2.c" 3 4
                  "llx" 
# 295 "project/radare2/libr/main/radiff2.c"
                          "\n", op->b_off);
  }
  return 1;
 }
...
void print_bytes(const void *p, size_t len, 
# 302 "project/radare2/libr/main/radiff2.c" 3 4
                                           _Bool 
# 302 "project/radare2/libr/main/radiff2.c"
                                                big_endian) {
 size_t i;
 for (i = 0; i < len; i++) {
  
# 305 "project/radare2/libr/main/radiff2.c" 3 4
 unsigned char 
# 305 "project/radare2/libr/main/radiff2.c"
     ch = ((
# 305 "project/radare2/libr/main/radiff2.c" 3 4
            unsigned char
# 305 "project/radare2/libr/main/radiff2.c"
               *) p)[big_endian ? (len - i - 1) : i];
  if (write (1, &ch, 1) != 1) {
   break;
  }
 }
...
# 314 "project/radare2/libr/main/radiff2.c" 3 4
unsigned long long 
# 314 "project/radare2/libr/main/radiff2.c"
     offset_diff = op->a_off - ro->gdiff_start;
 ...
 if (offset_diff > 0) {
  ...
  if (ro->gdiff_start <= 
# 326 "project/radare2/libr/main/radiff2.c" 3 4
                        (0x7fff * 2 + 1)
# 326 "project/radare2/libr/main/radiff2.c"
                                 ) {
   opcode = 249;
   USAddr = (unsigned short) ro->gdiff_start;
  } else if (ro->gdiff_start <= 0x7fffffff) {
   opcode = 252;
  ...
  if (opcode != 255 && offset_diff <= 
# 337 "project/radare2/libr/main/radiff2.c" 3 4
                                     (0x7f * 2 + 1)
# 337 "project/radare2/libr/main/radiff2.c"
                                              ) {
   UCLen = (unsigned char) offset_diff;
  } else if (opcode != 255 && offset_diff <= 
# 339 "project/radare2/libr/main/radiff2.c" 3 4
                                            (0x7fff * 2 + 1)
# 339 "project/radare2/libr/main/radiff2.c"
                                                     ) {
   USLen = (unsigned short) offset_diff;
   opcode += 1;
  } else if (opcode != 255 && offset_diff <= 0x7fffffff) {
   ILen = (int) offset_diff;
   opcode += 2;
  } else if (offset_diff > 0x7fffffff) {
   int times = offset_diff / 0x7fffffff;
   int max = 0x7fffffff;
   size_t i;
   for (i = 0; i < times; i++) {
    print_bytes (&opcode, sizeof (opcode), 
# 350 "project/radare2/libr/main/radiff2.c" 3 4
                                          1
# 350 "project/radare2/libr/main/radiff2.c"
                                              );


    print_bytes (&max, sizeof (max), 
# 353 "project/radare2/libr/main/radiff2.c" 3 4
                                    1
# 353 "project/radare2/libr/main/radiff2.c"
                                        );
   }
  }
  ...
  print_bytes (&opcode, sizeof (opcode), 
# 358 "project/radare2/libr/main/radiff2.c" 3 4
                                        1
# 358 "project/radare2/libr/main/radiff2.c"
                                            );


  if (opcode <= 251) {
   print_bytes (&USAddr, sizeof (USAddr), 
# 362 "project/radare2/libr/main/radiff2.c" 3 4
                                         1
# 362 "project/radare2/libr/main/radiff2.c"
                                             );
  } else if (opcode < 255) {
   print_bytes (&IAddr, sizeof (IAddr), 
# 364 "project/radare2/libr/main/radiff2.c" 3 4
                                       1
# 364 "project/radare2/libr/main/radiff2.c"
                                           );
  } else {
   print_bytes (&ro->gdiff_start, sizeof (ro->gdiff_start), 
# 366 "project/radare2/libr/main/radiff2.c" 3 4
                                                           1
# 366 "project/radare2/libr/main/radiff2.c"
                                                               );
  }
  ...
  case 249:
  case 252:
   print_bytes (&UCLen, sizeof (UCLen), 
# 373 "project/radare2/libr/main/radiff2.c" 3 4
                                       1
# 373 "project/radare2/libr/main/radiff2.c"
                                           );
   break;
  case 250:
  case 253:
   print_bytes (&USLen, sizeof (USLen), 
# 377 "project/radare2/libr/main/radiff2.c" 3 4
                                       1
# 377 "project/radare2/libr/main/radiff2.c"
                                           );
   break;
  case 251:
  case 254:
  case 255:
   print_bytes (&ILen, sizeof (ILen), 
# 382 "project/radare2/libr/main/radiff2.c" 3 4
                                     1
# 382 "project/radare2/libr/main/radiff2.c"
                                         );
   break;
  }
 }
...
# 389 "project/radare2/libr/main/radiff2.c" 3 4
 unsigned char 
# 389 "project/radare2/libr/main/radiff2.c"
     data = op->b_len;
  (void) write (1, &data, 1);
 } else if (op->b_len <= 
# 391 "project/radare2/libr/main/radiff2.c" 3 4
                        (0x7fff * 2 + 1)
# 391 "project/radare2/libr/main/radiff2.c"
                                 ) {
  USLen = (
# 392 "project/radare2/libr/main/radiff2.c" 3 4
          unsigned short
# 392 "project/radare2/libr/main/radiff2.c"
              ) op->b_len;
  
# 393 "project/radare2/libr/main/radiff2.c" 3 4
 unsigned char 
# 393 "project/radare2/libr/main/radiff2.c"
     data = 247;
  (void) write (1, &data, 1);
  print_bytes (&USLen, sizeof (USLen), 
# 395 "project/radare2/libr/main/radiff2.c" 3 4
                                      1
# 395 "project/radare2/libr/main/radiff2.c"
                                          );
 } else if (op->b_len <= 0x7fffffff) {
  
# 397 "project/radare2/libr/main/radiff2.c" 3 4
 unsigned char 
# 397 "project/radare2/libr/main/radiff2.c"
     data = 248;
  (void) write (1, &data, 1);
  ILen = (int) op->b_len;
  print_bytes (&ILen, sizeof (ILen), 
# 400 "project/radare2/libr/main/radiff2.c" 3 4
                                    1
# 400 "project/radare2/libr/main/radiff2.c"
                                        );
 } else {

  int times = op->b_len / 0x7fffffff;
  int max = 0x7fffffff;
  size_t i;
  for (i = 0; i < times; i++) {
   
# 407 "project/radare2/libr/main/radiff2.c" 3 4
  unsigned char 
# 407 "project/radare2/libr/main/radiff2.c"
      data = 248;
   if (write (1, &data, 1) != 1) {
    break;
   }
   print_bytes (&max, sizeof (max), 
# 411 "project/radare2/libr/main/radiff2.c" 3 4
                                   1
# 411 "project/radare2/libr/main/radiff2.c"
                                       );
   print_bytes (op->b_buf, max, 
# 412 "project/radare2/libr/main/radiff2.c" 3 4
                               0
# 412 "project/radare2/libr/main/radiff2.c"
                                    );
   op->b_buf += max;
  }
  ...
  print_bytes (&remain_size, sizeof (remain_size), 
# 419 "project/radare2/libr/main/radiff2.c" 3 4
                                                  1
# 419 "project/radare2/libr/main/radiff2.c"
                                                      );
 }
 print_bytes (op->b_buf, op->b_len, 
# 421 "project/radare2/libr/main/radiff2.c" 3 4
                                   0
# 421 "project/radare2/libr/main/radiff2.c"
                                        );
...
static void dump_cols(
# 476 "project/radare2/libr/main/radiff2.c" 3 4
                     unsigned char 
# 476 "project/radare2/libr/main/radiff2.c"
                         *a, int as, 
# 476 "project/radare2/libr/main/radiff2.c" 3 4
                                     unsigned char 
# 476 "project/radare2/libr/main/radiff2.c"
...
# 477 "project/radare2/libr/main/radiff2.c" 3 4
unsigned int 
# 477 "project/radare2/libr/main/radiff2.c"
     sz = 
# 477 "project/radare2/libr/main/radiff2.c" 3 4
          (((
# 477 "project/radare2/libr/main/radiff2.c"
...
# 478 "project/radare2/libr/main/radiff2.c" 3 4
unsigned int 
# 478 "project/radare2/libr/main/radiff2.c"
     i, j;
 int ctx = 2;
 int pad = 0;
 if (!a || !b || as < 0 || bs < 0) {
...
# 494 "project/radare2/libr/main/radiff2.c" 3 4
 fprintf(__stderrp,
# 494 "project/radare2/libr/main/radiff2.c"
...
# 494 "project/radare2/libr/main/radiff2.c"
 ...
 r_cons_break_push (
# 497 "project/radare2/libr/main/radiff2.c" 3 4
                   ((void *)0)
# 497 "project/radare2/libr/main/radiff2.c"
                       , 
# 497 "project/radare2/libr/main/radiff2.c" 3 4
                         ((void *)0)
# 497 "project/radare2/libr/main/radiff2.c"
...
# 506 "project/radare2/libr/main/radiff2.c" 3 4
 _Bool 
# 506 "project/radare2/libr/main/radiff2.c"
      eq = !memcmp (a + i, b + i, w);
  if (eq) {
   ctx--;
   if (ctx == -1) {
  ...
  r_cons_printf (eq? 
# 520 "project/radare2/libr/main/radiff2.c" 3 4
                    "\x1b[32m"
# 520 "project/radare2/libr/main/radiff2.c"
                               : 
# 520 "project/radare2/libr/main/radiff2.c" 3 4
                                 "\x1b[31m"
# 520 "project/radare2/libr/main/radiff2.c"
  ...
  r_cons_printf (
# 522 "project/radare2/libr/main/radiff2.c" 3 4
                "\x1b[0m"
# 522 "project/radare2/libr/main/radiff2.c"
                           );
  for (j = 0; j < w; j++) {
   
# 524 "project/radare2/libr/main/radiff2.c" 3 4
  _Bool 
# 524 "project/radare2/libr/main/radiff2.c"
       eq2 = a[i + j] == b[i + j];
   if (!eq) {
    r_cons_printf (eq2? 
# 526 "project/radare2/libr/main/radiff2.c" 3 4
                       "\x1b[32m"
# 526 "project/radare2/libr/main/radiff2.c"
                                  : 
# 526 "project/radare2/libr/main/radiff2.c" 3 4
                                    "\x1b[31m"
# 526 "project/radare2/libr/main/radiff2.c"
   ...
   if (!eq) {
    r_cons_printf (
# 530 "project/radare2/libr/main/radiff2.c" 3 4
                  "\x1b[0m"
# 530 "project/radare2/libr/main/radiff2.c"
                             );
   }
  }
  for (j = 0; j < pad; j++) {
...
# 538 "project/radare2/libr/main/radiff2.c" 3 4
  _Bool 
# 538 "project/radare2/libr/main/radiff2.c"
       eq2 = a[i + j] == b[i + j];
   if (!eq) {
    r_cons_printf (eq2? 
# 540 "project/radare2/libr/main/radiff2.c" 3 4
                       "\x1b[32m"
# 540 "project/radare2/libr/main/radiff2.c"
                                  : 
# 540 "project/radare2/libr/main/radiff2.c" 3 4
                                    "\x1b[31m"
# 540 "project/radare2/libr/main/radiff2.c"
   ...
   r_cons_printf ("%c", 
# 542 "project/radare2/libr/main/radiff2.c" 3 4
                       ((
# 542 "project/radare2/libr/main/radiff2.c"
                       a[i + j]
# 542 "project/radare2/libr/main/radiff2.c" 3 4
                       ) >=' ' && (
# 542 "project/radare2/libr/main/radiff2.c"
...
# 542 "project/radare2/libr/main/radiff2.c"
   ...
   if (!eq) {
    r_cons_printf (
# 544 "project/radare2/libr/main/radiff2.c" 3 4
                  "\x1b[0m"
# 544 "project/radare2/libr/main/radiff2.c"
                             );
   }
  }
  for (j = 0; j < pad; j++) {
...
# 552 "project/radare2/libr/main/radiff2.c" 3 4
  _Bool 
# 552 "project/radare2/libr/main/radiff2.c"
       eq2 = a[i + j] == b[i + j];
   if (!eq) {
    r_cons_printf (eq2? 
# 554 "project/radare2/libr/main/radiff2.c" 3 4
                       "\x1b[32m"
# 554 "project/radare2/libr/main/radiff2.c"
                                  : 
# 554 "project/radare2/libr/main/radiff2.c" 3 4
                                    "\x1b[31m"
# 554 "project/radare2/libr/main/radiff2.c"
   ...
   if (!eq) {
    r_cons_printf (
# 558 "project/radare2/libr/main/radiff2.c" 3 4
                  "\x1b[0m"
# 558 "project/radare2/libr/main/radiff2.c"
                             );
   }
  }
  for (j = 0; j < pad; j++) {
...
# 566 "project/radare2/libr/main/radiff2.c" 3 4
  _Bool 
# 566 "project/radare2/libr/main/radiff2.c"
       eq2 = a[i + j] == b[i + j];
   if (!eq) {
    r_cons_printf (eq2? 
# 568 "project/radare2/libr/main/radiff2.c" 3 4
                       "\x1b[32m"
# 568 "project/radare2/libr/main/radiff2.c"
                                  : 
# 568 "project/radare2/libr/main/radiff2.c" 3 4
                                    "\x1b[31m"
# 568 "project/radare2/libr/main/radiff2.c"
   ...
   r_cons_printf ("%c", 
# 570 "project/radare2/libr/main/radiff2.c" 3 4
                       ((
# 570 "project/radare2/libr/main/radiff2.c"
                       b[i + j]
# 570 "project/radare2/libr/main/radiff2.c" 3 4
                       ) >=' ' && (
# 570 "project/radare2/libr/main/radiff2.c"
...
# 570 "project/radare2/libr/main/radiff2.c"
   ...
   if (!eq) {
    r_cons_printf (
# 572 "project/radare2/libr/main/radiff2.c" 3 4
                  "\x1b[0m"
# 572 "project/radare2/libr/main/radiff2.c"
                             );
   }
  }
  r_cons_printf ("\n");
 ...
 r_cons_break_end ();
 r_cons_printf ("\n"
# 579 "project/radare2/libr/main/radiff2.c" 3 4
                   "\x1b[0m"
# 579 "project/radare2/libr/main/radiff2.c"
                              );
 r_cons_flush ();
 if (as != bs) {
  r_cons_printf ("...\n");
...
static void dump_cols_hexii(
# 586 "project/radare2/libr/main/radiff2.c" 3 4
                           unsigned char 
# 586 "project/radare2/libr/main/radiff2.c"
                               *a, int as, 
# 586 "project/radare2/libr/main/radiff2.c" 3 4
                                           unsigned char 
# 586 "project/radare2/libr/main/radiff2.c"
...
# 587 "project/radare2/libr/main/radiff2.c" 3 4
_Bool 
# 587 "project/radare2/libr/main/radiff2.c"
     spacy = 
# 587 "project/radare2/libr/main/radiff2.c" 3 4
             0
# 587 "project/radare2/libr/main/radiff2.c"
...
# 588 "project/radare2/libr/main/radiff2.c" 3 4
unsigned int 
# 588 "project/radare2/libr/main/radiff2.c"
     sz = 
# 588 "project/radare2/libr/main/radiff2.c" 3 4
          (((
# 588 "project/radare2/libr/main/radiff2.c"
...
# 589 "project/radare2/libr/main/radiff2.c" 3 4
unsigned int 
# 589 "project/radare2/libr/main/radiff2.c"
     i, j;
 int ctx = 2;
 int pad = 0;
 if (!a || !b || as < 0 || bs < 0) {
 ...
 r_cons_break_push (
# 596 "project/radare2/libr/main/radiff2.c" 3 4
                   ((void *)0)
# 596 "project/radare2/libr/main/radiff2.c"
                       , 
# 596 "project/radare2/libr/main/radiff2.c" 3 4
                         ((void *)0)
# 596 "project/radare2/libr/main/radiff2.c"
...
# 605 "project/radare2/libr/main/radiff2.c" 3 4
 _Bool 
# 605 "project/radare2/libr/main/radiff2.c"
      eq = !memcmp (a + i, b + i, w);
  if (eq) {
   ctx--;
   if (ctx == -1) {
  ...
  r_cons_printf (eq? 
# 619 "project/radare2/libr/main/radiff2.c" 3 4
                    "\x1b[32m"
# 619 "project/radare2/libr/main/radiff2.c"
                               : 
# 619 "project/radare2/libr/main/radiff2.c" 3 4
                                 "\x1b[31m"
# 619 "project/radare2/libr/main/radiff2.c"
  ...
  r_cons_printf ("0x%08x%c ", i, eq? ' ': '!');
  r_cons_printf (
# 621 "project/radare2/libr/main/radiff2.c" 3 4
                "\x1b[0m"
# 621 "project/radare2/libr/main/radiff2.c"
                           );
  for (j = 0; j < w; j++) {
   
# 623 "project/radare2/libr/main/radiff2.c" 3 4
  _Bool 
# 623 "project/radare2/libr/main/radiff2.c"
       eq2 = a[i + j] == b[i + j];
   if (!eq) {
    r_cons_printf (eq2? 
# 625 "project/radare2/libr/main/radiff2.c" 3 4
                       "\x1b[32m"
# 625 "project/radare2/libr/main/radiff2.c"
                                  : 
# 625 "project/radare2/libr/main/radiff2.c" 3 4
                                    "\x1b[31m"
# 625 "project/radare2/libr/main/radiff2.c"
...
# 627 "project/radare2/libr/main/radiff2.c" 3 4
  unsigned char 
# 627 "project/radare2/libr/main/radiff2.c"
      ch = a[i + j];
   if (spacy) {
    p (" ");
   }
...
# 635 "project/radare2/libr/main/radiff2.c" 3 4
             ((
# 635 "project/radare2/libr/main/radiff2.c"
             ch
# 635 "project/radare2/libr/main/radiff2.c" 3 4
             ) >=' ' && (
# 635 "project/radare2/libr/main/radiff2.c"
...
# 635 "project/radare2/libr/main/radiff2.c"
   ...
   if (!eq) {
    r_cons_printf (
# 641 "project/radare2/libr/main/radiff2.c" 3 4
                  "\x1b[0m"
# 641 "project/radare2/libr/main/radiff2.c"
                             );
   }
  }
  for (j = 0; j < pad; j++) {
...
# 652 "project/radare2/libr/main/radiff2.c" 3 4
  _Bool 
# 652 "project/radare2/libr/main/radiff2.c"
       eq2 = a[i + j] == b[i + j];
   if (!eq) {
    r_cons_printf (eq2? 
# 654 "project/radare2/libr/main/radiff2.c" 3 4
                       "\x1b[32m"
# 654 "project/radare2/libr/main/radiff2.c"
                                  : 
# 654 "project/radare2/libr/main/radiff2.c" 3 4
                                    "\x1b[31m"
# 654 "project/radare2/libr/main/radiff2.c"
...
# 656 "project/radare2/libr/main/radiff2.c" 3 4
  unsigned char 
# 656 "project/radare2/libr/main/radiff2.c"
      ch = b[i + j];
   if (spacy) {
    p (" ");
   }
...
# 664 "project/radare2/libr/main/radiff2.c" 3 4
             ((
# 664 "project/radare2/libr/main/radiff2.c"
             ch
# 664 "project/radare2/libr/main/radiff2.c" 3 4
             ) >=' ' && (
# 664 "project/radare2/libr/main/radiff2.c"
...
# 664 "project/radare2/libr/main/radiff2.c"
   ...
   if (!eq) {
    r_cons_printf (
# 670 "project/radare2/libr/main/radiff2.c" 3 4
                  "\x1b[0m"
# 670 "project/radare2/libr/main/radiff2.c"
                             );
   }
  }
  for (j = 0; j < pad; j++) {
 ...
 r_cons_break_end ();
 r_cons_printf ("\n"
# 680 "project/radare2/libr/main/radiff2.c" 3 4
                   "\x1b[0m"
# 680 "project/radare2/libr/main/radiff2.c"
                              );
 r_cons_flush ();
 if (as != bs) {
  r_cons_printf ("...\n");
...
static char *handle_sha256(const 
# 687 "project/radare2/libr/main/radiff2.c" 3 4
                                unsigned char 
# 687 "project/radare2/libr/main/radiff2.c"
                                    *block, int len) {
 int i = 0;
 char *p = malloc (128);
 
# 690 "project/radare2/libr/main/radiff2.c" 3 4
struct r_hash_t 
# 690 "project/radare2/libr/main/radiff2.c"
      *ctx = r_hash_new (
# 690 "project/radare2/libr/main/radiff2.c" 3 4
                         1
# 690 "project/radare2/libr/main/radiff2.c"
...
# 690 "project/radare2/libr/main/radiff2.c"
 ...
 const 
# 691 "project/radare2/libr/main/radiff2.c" 3 4
      unsigned char 
# 691 "project/radare2/libr/main/radiff2.c"
          *c = r_hash_do_sha256 (ctx, block, len);
 if (!c) {
  r_hash_free (ctx);
  free (p);
  return 
# 695 "project/radare2/libr/main/radiff2.c" 3 4
        ((void *)0)
# 695 "project/radare2/libr/main/radiff2.c"
            ;
 }
 char *r = p;
 for (i = 0; i < 
# 698 "project/radare2/libr/main/radiff2.c" 3 4
                32
# 698 "project/radare2/libr/main/radiff2.c"
                                  ; i++) {
  
# 699 "project/radare2/libr/main/radiff2.c" 3 4
 __builtin___snprintf_chk (
# 699 "project/radare2/libr/main/radiff2.c"
 r + (i * 2)
# 699 "project/radare2/libr/main/radiff2.c" 3 4
 , 
# 699 "project/radare2/libr/main/radiff2.c"
...
static 
# 705 "project/radare2/libr/main/radiff2.c" 3 4
      unsigned char 
# 705 "project/radare2/libr/main/radiff2.c"
          *slurp(RadiffOptions *ro, RCore **c, const char *file, size_t *sz) {
 int fd;
 RIO *io;
 if (c && file && strstr (file, "://")) {
  
# 709 "project/radare2/libr/main/radiff2.c" 3 4
 unsigned char 
# 709 "project/radare2/libr/main/radiff2.c"
     *data = 
# 709 "project/radare2/libr/main/radiff2.c" 3 4
             ((void *)0)
# 709 "project/radare2/libr/main/radiff2.c"
...
# 710 "project/radare2/libr/main/radiff2.c" 3 4
 unsigned long long 
# 710 "project/radare2/libr/main/radiff2.c"
      size;
  if (!*c) {
   *c = opencore (ro, 
# 712 "project/radare2/libr/main/radiff2.c" 3 4
                     ((void *)0)
# 712 "project/radare2/libr/main/radiff2.c"
                         );
  }
  if (!*c) {
   
# 715 "project/radare2/libr/main/radiff2.c" 3 4
  fprintf(__stderrp,
# 715 "project/radare2/libr/main/radiff2.c"
  "opencore failed\n"
# 715 "project/radare2/libr/main/radiff2.c" 3 4
  )
# 715 "project/radare2/libr/main/radiff2.c"
                               ;
   return 
# 716 "project/radare2/libr/main/radiff2.c" 3 4
         ((void *)0)
# 716 "project/radare2/libr/main/radiff2.c"
             ;
  }
  io = (*c)->io;
  fd = r_io_fd_open (io, file, 
# 719 "project/radare2/libr/main/radiff2.c" 3 4
                              4
# 719 "project/radare2/libr/main/radiff2.c"
                                      , 0);
  if (fd < 1) {
   return 
# 721 "project/radare2/libr/main/radiff2.c" 3 4
         ((void *)0)
# 721 "project/radare2/libr/main/radiff2.c"
             ;
  }
  size = r_io_fd_size (io, fd);
  if (size > 0 && size < 
# 724 "project/radare2/libr/main/radiff2.c" 3 4
                        0x7FFFFFFF
# 724 "project/radare2/libr/main/radiff2.c"
                                ) {
   data = calloc (1, size);
...
# 731 "project/radare2/libr/main/radiff2.c" 3 4
   fprintf(__stderrp,
# 731 "project/radare2/libr/main/radiff2.c"
   "slurp: read error\n"
# 731 "project/radare2/libr/main/radiff2.c" 3 4
   )
# 731 "project/radare2/libr/main/radiff2.c"
...
# 732 "project/radare2/libr/main/radiff2.c" 3 4
   { free((void *)
# 732 "project/radare2/libr/main/radiff2.c"
   data
# 732 "project/radare2/libr/main/radiff2.c" 3 4
   ); 
# 732 "project/radare2/libr/main/radiff2.c"
...
# 735 "project/radare2/libr/main/radiff2.c" 3 4
  fprintf(__stderrp,
# 735 "project/radare2/libr/main/radiff2.c"
  "slurp: Invalid file size\n"
# 735 "project/radare2/libr/main/radiff2.c" 3 4
  )
# 735 "project/radare2/libr/main/radiff2.c"
                                        ;
 ...
 return (
# 740 "project/radare2/libr/main/radiff2.c" 3 4
        unsigned char 
# 740 "project/radare2/libr/main/radiff2.c"
            *) r_file_slurp (file, sz);
}
...
static 
# 747 "project/radare2/libr/main/radiff2.c" 3 4
      unsigned char 
# 747 "project/radare2/libr/main/radiff2.c"
          *get_symbols(RCore *c, int *len) {
 RListIter *iter;

 if (!c || !len) {
  return 
# 751 "project/radare2/libr/main/radiff2.c" 3 4
        ((void *)0)
# 751 "project/radare2/libr/main/radiff2.c"
            ;
 }
...
# 757 "project/radare2/libr/main/radiff2.c" 3 4
if (
# 757 "project/radare2/libr/main/radiff2.c"
list
# 757 "project/radare2/libr/main/radiff2.c" 3 4
) for (
# 757 "project/radare2/libr/main/radiff2.c"
 ...
 *len = strlen (buf);
 r_list_free (reslist);
 return (
# 763 "project/radare2/libr/main/radiff2.c" 3 4
        unsigned char
# 763 "project/radare2/libr/main/radiff2.c"
           *)buf;
}

static 
# 766 "project/radare2/libr/main/radiff2.c" 3 4
      unsigned char 
# 766 "project/radare2/libr/main/radiff2.c"
          *get_imports(RCore *c, int *len) {
 RListIter *iter;
 RBinImport *str, *old = 
# 768 "project/radare2/libr/main/radiff2.c" 3 4
                        ((void *)0)
# 768 "project/radare2/libr/main/radiff2.c"
                            ;
 
# 769 "project/radare2/libr/main/radiff2.c" 3 4
unsigned char 
# 769 "project/radare2/libr/main/radiff2.c"
    *buf, *ptr;

 if (!c || !len) {
  return 
# 772 "project/radare2/libr/main/radiff2.c" 3 4
        ((void *)0)
# 772 "project/radare2/libr/main/radiff2.c"
            ;
 }
...
# 781 "project/radare2/libr/main/radiff2.c" 3 4
if (
# 781 "project/radare2/libr/main/radiff2.c"
list
# 781 "project/radare2/libr/main/radiff2.c" 3 4
) for (
# 781 "project/radare2/libr/main/radiff2.c"
...
# 781 "project/radare2/libr/main/radiff2.c"
 ...
 if (!ptr) {
  return 
# 789 "project/radare2/libr/main/radiff2.c" 3 4
        ((void *)0)
# 789 "project/radare2/libr/main/radiff2.c"
            ;
 }

 old = 
# 792 "project/radare2/libr/main/radiff2.c" 3 4
      ((void *)0)
# 792 "project/radare2/libr/main/radiff2.c"
          ;

 
# 794 "project/radare2/libr/main/radiff2.c" 3 4
if (
# 794 "project/radare2/libr/main/radiff2.c"
list
# 794 "project/radare2/libr/main/radiff2.c" 3 4
) for (
# 794 "project/radare2/libr/main/radiff2.c"
...
# 799 "project/radare2/libr/main/radiff2.c" 3 4
 __builtin___memcpy_chk (
# 799 "project/radare2/libr/main/radiff2.c"
 ptr
# 799 "project/radare2/libr/main/radiff2.c" 3 4
 , 
# 799 "project/radare2/libr/main/radiff2.c"
...
static 
# 815 "project/radare2/libr/main/radiff2.c" 3 4
      unsigned char 
# 815 "project/radare2/libr/main/radiff2.c"
          *get_strings(RCore *c, int *len) {
 RList *list = r_bin_get_strings (c->bin);
 RListIter *iter;
 RBinString *str, *old = 
# 818 "project/radare2/libr/main/radiff2.c" 3 4
                        ((void *)0)
# 818 "project/radare2/libr/main/radiff2.c"
                            ;
 
# 819 "project/radare2/libr/main/radiff2.c" 3 4
unsigned char 
# 819 "project/radare2/libr/main/radiff2.c"
    *buf, *ptr;
...
# 825 "project/radare2/libr/main/radiff2.c" 3 4
if (
# 825 "project/radare2/libr/main/radiff2.c"
list
# 825 "project/radare2/libr/main/radiff2.c" 3 4
) for (
# 825 "project/radare2/libr/main/radiff2.c"
...
# 825 "project/radare2/libr/main/radiff2.c"
 ...
 if (!ptr) {
  return 
# 834 "project/radare2/libr/main/radiff2.c" 3 4
        ((void *)0)
# 834 "project/radare2/libr/main/radiff2.c"
            ;
 }

 old = 
# 837 "project/radare2/libr/main/radiff2.c" 3 4
      ((void *)0)
# 837 "project/radare2/libr/main/radiff2.c"
          ;

 
# 839 "project/radare2/libr/main/radiff2.c" 3 4
if (
# 839 "project/radare2/libr/main/radiff2.c"
list
# 839 "project/radare2/libr/main/radiff2.c" 3 4
) for (
# 839 "project/radare2/libr/main/radiff2.c"
...
# 843 "project/radare2/libr/main/radiff2.c" 3 4
 __builtin___memcpy_chk (
# 843 "project/radare2/libr/main/radiff2.c"
 ptr
# 843 "project/radare2/libr/main/radiff2.c" 3 4
 , 
# 843 "project/radare2/libr/main/radiff2.c"
...
static char *get_graph_commands(RCore *c, 
# 854 "project/radare2/libr/main/radiff2.c" 3 4
                                         unsigned long long 
# 854 "project/radare2/libr/main/radiff2.c"
                                              off) {
 
# 855 "project/radare2/libr/main/radiff2.c" 3 4
_Bool 
# 855 "project/radare2/libr/main/radiff2.c"
     tmp_html = r_cons_context ()->is_html;
 r_cons_context ()->is_html = 
# 856 "project/radare2/libr/main/radiff2.c" 3 4
                             0
# 856 "project/radare2/libr/main/radiff2.c"
                                  ;
 r_cons_push ();
 r_core_anal_graph (c, off, 
# 858 "project/radare2/libr/main/radiff2.c" 3 4
                           2 
# 858 "project/radare2/libr/main/radiff2.c"
                                                 | 
# 858 "project/radare2/libr/main/radiff2.c" 3 4
                                                   4 
# 858 "project/radare2/libr/main/radiff2.c"
...
# 858 "project/radare2/libr/main/radiff2.c"
 ...
 r_cons_pop ();
 r_cons_echo (
# 862 "project/radare2/libr/main/radiff2.c" 3 4
             ((void *)0)
# 862 "project/radare2/libr/main/radiff2.c"
                 );
 r_cons_context ()->is_html = tmp_html;
 return retstr;
}

static void __generate_graph(RCore *c, 
# 867 "project/radare2/libr/main/radiff2.c" 3 4
                                      unsigned long long 
# 867 "project/radare2/libr/main/radiff2.c"
                                           off) {
 
# 868 "project/radare2/libr/main/radiff2.c" 3 4
do { if (!(
# 868 "project/radare2/libr/main/radiff2.c"
c
# 868 "project/radare2/libr/main/radiff2.c" 3 4
...
# 868 "project/radare2/libr/main/radiff2.c"
 ...
 char *str = ptr;
 r_cons_break_push (
# 871 "project/radare2/libr/main/radiff2.c" 3 4
                   ((void *)0)
# 871 "project/radare2/libr/main/radiff2.c"
                       , 
# 871 "project/radare2/libr/main/radiff2.c" 3 4
                         ((void *)0)
# 871 "project/radare2/libr/main/radiff2.c"
...
static void __print_diff_graph(RCore *c, 
# 900 "project/radare2/libr/main/radiff2.c" 3 4
                                        unsigned long long 
# 900 "project/radare2/libr/main/radiff2.c"
                                             off, int gmode) {
 int opts = 
# 901 "project/radare2/libr/main/radiff2.c" 3 4
           2 
# 901 "project/radare2/libr/main/radiff2.c"
                                 | 
# 901 "project/radare2/libr/main/radiff2.c" 3 4
                                   4
# 901 "project/radare2/libr/main/radiff2.c"
 ...
 case GRAPH_STAR_MODE:
  r_core_anal_graph (c, off, opts | 
# 909 "project/radare2/libr/main/radiff2.c" 3 4
                                    64
# 909 "project/radare2/libr/main/radiff2.c"
                                                    );
  break;
 ...
 case GRAPH_JSON_MODE:
  r_core_anal_graph (c, off, opts | 
# 929 "project/radare2/libr/main/radiff2.c" 3 4
                                   8
# 929 "project/radare2/libr/main/radiff2.c"
                                                   );
  break;
 case GRAPH_JSON_DIS_MODE:
  r_core_anal_graph (c, off, opts | 
# 932 "project/radare2/libr/main/radiff2.c" 3 4
                                   8 
# 932 "project/radare2/libr/main/radiff2.c"
                                                    | 
# 932 "project/radare2/libr/main/radiff2.c" 3 4
                                                      32
# 932 "project/radare2/libr/main/radiff2.c"
...
# 944 "project/radare2/libr/main/radiff2.c" 3 4
__builtin___memset_chk (
# 944 "project/radare2/libr/main/radiff2.c"
ro
# 944 "project/radare2/libr/main/radiff2.c" 3 4
, 
# 944 "project/radare2/libr/main/radiff2.c"
0, sizeof (RadiffOptions)
# 944 "project/radare2/libr/main/radiff2.c" 3 4
, __builtin_object_size (
# 944 "project/radare2/libr/main/radiff2.c"
ro
...
# 944 "project/radare2/libr/main/radiff2.c"
 ...
 ro->threshold = -1;
 ro->useva = 
# 946 "project/radare2/libr/main/radiff2.c" 3 4
            1
# 946 "project/radare2/libr/main/radiff2.c"
                ;
 ro->evals = r_list_newf (
# 947 "project/radare2/libr/main/radiff2.c" 3 4
                         ((void *)0)
# 947 "project/radare2/libr/main/radiff2.c"
                             );
 ro->mode = MODE_DIFF;
...
static void fileobj(RadiffOptions *ro, const char *ro_file, const 
# 958 "project/radare2/libr/main/radiff2.c" 3 4
                                                                 unsigned char 
# 958 "project/radare2/libr/main/radiff2.c"
                                                                     *buf, size_t sz) {
 PJ *pj = ro->pj;
 pj_o (pj);
...
# 969 "project/radare2/libr/main/radiff2.c" 3 4
__attribute__((visibility("default"))) 
# 969 "project/radare2/libr/main/radiff2.c"
     int r_main_radiff2(int argc, const char **argv) {
 RadiffOptions ro;
 const char *columnSort = 
# 971 "project/radare2/libr/main/radiff2.c" 3 4
                         ((void *)0)
# 971 "project/radare2/libr/main/radiff2.c"
                             ;
 const char *addr = 
# 972 "project/radare2/libr/main/radiff2.c" 3 4
                   ((void *)0)
# 972 "project/radare2/libr/main/radiff2.c"
                       ;
 RCore *c = 
# 973 "project/radare2/libr/main/radiff2.c" 3 4
           ((void *)0)
# 973 "project/radare2/libr/main/radiff2.c"
               , *c2 = 
# 973 "project/radare2/libr/main/radiff2.c" 3 4
                       ((void *)0)
# 973 "project/radare2/libr/main/radiff2.c"
...
# 974 "project/radare2/libr/main/radiff2.c" 3 4
unsigned char 
# 974 "project/radare2/libr/main/radiff2.c"
    *bufa = 
# 974 "project/radare2/libr/main/radiff2.c" 3 4
            ((void *)0)
# 974 "project/radare2/libr/main/radiff2.c"
...
# 976 "project/radare2/libr/main/radiff2.c" 3 4
unsigned long long 
# 976 "project/radare2/libr/main/radiff2.c"
     sza = 0, szb = 0;
 double sim = 0.0;
 RDiff *d;
 RGetopt opt;
 ...
 while ((o = r_getopt_next (&opt)) != -1) {
  ...
  case 'p':
   ro.useva = 
# 1002 "project/radare2/libr/main/radiff2.c" 3 4
             0
# 1002 "project/radare2/libr/main/radiff2.c"
                  ;
   break;
  case 'r':
   ro.diffmode = 'r';
...
# 1045 "project/radare2/libr/main/radiff2.c" 3 4
   fprintf(__stderrp,
# 1045 "project/radare2/libr/main/radiff2.c"
   "-i expects [s,i] for symbols or imports diffing\n"
# 1045 "project/radare2/libr/main/radiff2.c" 3 4
   )
# 1045 "project/radare2/libr/main/radiff2.c"
                                                                ;
  ...
  case 'n':
   ro.showbare = 
# 1050 "project/radare2/libr/main/radiff2.c" 3 4
                1
# 1050 "project/radare2/libr/main/radiff2.c"
                    ;
   break;
  case 'O':
   ro.diffops = 1;
  ...
  case 'D':
   if (ro.disasm) {
    ro.pdc = 
# 1064 "project/radare2/libr/main/radiff2.c" 3 4
            1
# 1064 "project/radare2/libr/main/radiff2.c"
                ;
    ro.disasm = 
# 1065 "project/radare2/libr/main/radiff2.c" 3 4
               0
# 1065 "project/radare2/libr/main/radiff2.c"
                    ;
    ro.mode = MODE_CODE;
   } else {
    ro.disasm = 
# 1068 "project/radare2/libr/main/radiff2.c" 3 4
               1
# 1068 "project/radare2/libr/main/radiff2.c"
                   ;
   }
   break;
  case 'h':
  ...
  case 'q':
   ro.quiet = 
# 1098 "project/radare2/libr/main/radiff2.c" 3 4
             1
# 1098 "project/radare2/libr/main/radiff2.c"
                 ;
   break;
  case 'V':
   ro.verbose = 
# 1101 "project/radare2/libr/main/radiff2.c" 3 4
               1
# 1101 "project/radare2/libr/main/radiff2.c"
                   ;
   break;
  case 'j':
   ro.diffmode = 'j';
  ...
  case 'Z':
   ro.zignatures = 
# 1111 "project/radare2/libr/main/radiff2.c" 3 4
                  1
# 1111 "project/radare2/libr/main/radiff2.c"
                      ;
   break;
  default:
   return show_help (0);
 ...
 ro.file = (opt.ind < argc)? argv[opt.ind]: 
# 1121 "project/radare2/libr/main/radiff2.c" 3 4
                                           ((void *)0)
# 1121 "project/radare2/libr/main/radiff2.c"
                                               ;
 ro.file2 = (opt.ind + 1 < argc)? argv[opt.ind + 1]: 
# 1122 "project/radare2/libr/main/radiff2.c" 3 4
                                                    ((void *)0)
# 1122 "project/radare2/libr/main/radiff2.c"
                                                        ;

 if (
# 1124 "project/radare2/libr/main/radiff2.c" 3 4
    (!(
# 1124 "project/radare2/libr/main/radiff2.c"
    ro.file
# 1124 "project/radare2/libr/main/radiff2.c" 3 4
    ) || !*(
# 1124 "project/radare2/libr/main/radiff2.c"
...
# 1125 "project/radare2/libr/main/radiff2.c" 3 4
 fprintf(__stderrp,
# 1125 "project/radare2/libr/main/radiff2.c"
...
# 1137 "project/radare2/libr/main/radiff2.c" 3 4
  fprintf(__stderrp,
# 1137 "project/radare2/libr/main/radiff2.c"
  "Cannot open '%s'\n", r_str_getf (ro.file)
# 1137 "project/radare2/libr/main/radiff2.c" 3 4
  )
# 1137 "project/radare2/libr/main/radiff2.c"
...
# 1141 "project/radare2/libr/main/radiff2.c" 3 4
  fprintf(__stderrp,
# 1141 "project/radare2/libr/main/radiff2.c"
  "Cannot open '%s'\n", r_str_getf (ro.file2)
# 1141 "project/radare2/libr/main/radiff2.c" 3 4
  )
# 1141 "project/radare2/libr/main/radiff2.c"
...
# 1174 "project/radare2/libr/main/radiff2.c" 3 4
  unsigned long long 
# 1174 "project/radare2/libr/main/radiff2.c"
       addra = r_num_math (c->num, addr);
   bufa = (
# 1175 "project/radare2/libr/main/radiff2.c" 3 4
          unsigned char 
# 1175 "project/radare2/libr/main/radiff2.c"
              *) r_core_cmd_strf (c, "af;pdc @ 0x%08"
# 1175 "project/radare2/libr/main/radiff2.c" 3 4
                                                     "llx"
# 1175 "project/radare2/libr/main/radiff2.c"
                                                            , addra);
   sza = (
# 1176 "project/radare2/libr/main/radiff2.c" 3 4
         unsigned long long
# 1176 "project/radare2/libr/main/radiff2.c"
             )strlen ((const char *) bufa);

   
# 1178 "project/radare2/libr/main/radiff2.c" 3 4
  unsigned long long 
# 1178 "project/radare2/libr/main/radiff2.c"
       addrb = r_num_math (c2->num, addr);
   bufb = (
# 1179 "project/radare2/libr/main/radiff2.c" 3 4
          unsigned char 
# 1179 "project/radare2/libr/main/radiff2.c"
              *) r_core_cmd_strf (c2, "af;pdc @ 0x%08"
# 1179 "project/radare2/libr/main/radiff2.c" 3 4
                                                      "llx"
# 1179 "project/radare2/libr/main/radiff2.c"
                                                             , addrb);
   szb = (
# 1180 "project/radare2/libr/main/radiff2.c" 3 4
         unsigned long long
# 1180 "project/radare2/libr/main/radiff2.c"
             )strlen ((const char *) bufb);
   ro.mode = MODE_DIFF;
...
# 1191 "project/radare2/libr/main/radiff2.c" 3 4
   unsigned long long 
# 1191 "project/radare2/libr/main/radiff2.c"
        off = r_num_math (c->num, words);

    r_core_anal_fcn (c, off, 
# 1193 "project/radare2/libr/main/radiff2.c" 3 4
                            0xFFFFFFFFFFFFFFFFULL
# 1193 "project/radare2/libr/main/radiff2.c"
                                    , R_ANAL_REF_TYPE_NULL, depth);
    r_core_anal_fcn (c2, r_num_math (c2->num, second),
     
# 1195 "project/radare2/libr/main/radiff2.c" 3 4
    0xFFFFFFFFFFFFFFFFULL
# 1195 "project/radare2/libr/main/radiff2.c"
            , R_ANAL_REF_TYPE_NULL, depth);
    r_core_gdiff (c, c2);
...
# 1200 "project/radare2/libr/main/radiff2.c" 3 4
    0xFFFFFFFFFFFFFFFFULL
# 1200 "project/radare2/libr/main/radiff2.c"
            , R_ANAL_REF_TYPE_NULL, depth);
    r_core_anal_fcn (c2, r_num_math (c2->num, words),
     
# 1202 "project/radare2/libr/main/radiff2.c" 3 4
    0xFFFFFFFFFFFFFFFFULL
# 1202 "project/radare2/libr/main/radiff2.c"
            , R_ANAL_REF_TYPE_NULL, depth);
    r_core_gdiff (c, c2);
...
# 1250 "project/radare2/libr/main/radiff2.c" 3 4
  fprintf(__stderrp,
# 1250 "project/radare2/libr/main/radiff2.c"
  "radiff2: Cannot open %s\n", r_str_getf (ro.file)
# 1250 "project/radare2/libr/main/radiff2.c" 3 4
  )
# 1250 "project/radare2/libr/main/radiff2.c"
                                                             ;
...
# 1256 "project/radare2/libr/main/radiff2.c" 3 4
  fprintf(__stderrp,
# 1256 "project/radare2/libr/main/radiff2.c"
  "radiff2: Cannot open: %s\n", r_str_getf (ro.file2)
# 1256 "project/radare2/libr/main/radiff2.c" 3 4
  )
# 1256 "project/radare2/libr/main/radiff2.c"
...
# 1261 "project/radare2/libr/main/radiff2.c" 3 4
  fprintf(__stderrp,
# 1261 "project/radare2/libr/main/radiff2.c"
  "File size differs %"
# 1261 "project/radare2/libr/main/radiff2.c" 3 4
  "llu"
# 1261 "project/radare2/libr/main/radiff2.c"
...
# 1261 "project/radare2/libr/main/radiff2.c"
 ...
 case MODE_COLSII:
  if (!c && !
# 1272 "project/radare2/libr/main/radiff2.c" 3 4
            (!(
# 1272 "project/radare2/libr/main/radiff2.c"
            ro.evals
# 1272 "project/radare2/libr/main/radiff2.c" 3 4
            ) || !(
# 1272 "project/radare2/libr/main/radiff2.c"
...
# 1272 "project/radare2/libr/main/radiff2.c"
   ...
   c = opencore (&ro, 
# 1273 "project/radare2/libr/main/radiff2.c" 3 4
                     ((void *)0)
# 1273 "project/radare2/libr/main/radiff2.c"
                         );
  }
  dump_cols_hexii (bufa, (int)sza, bufb, (int)szb, (r_cons_get_size (
# 1275 "project/radare2/libr/main/radiff2.c" 3 4
                                                                    ((void *)0)
# 1275 "project/radare2/libr/main/radiff2.c"
                                                                        ) > 112)? 16: 8);
  break;
 case MODE_COLS:
  if (!c && !
# 1278 "project/radare2/libr/main/radiff2.c" 3 4
            (!(
# 1278 "project/radare2/libr/main/radiff2.c"
            ro.evals
# 1278 "project/radare2/libr/main/radiff2.c" 3 4
            ) || !(
# 1278 "project/radare2/libr/main/radiff2.c"
...
# 1278 "project/radare2/libr/main/radiff2.c"
   ...
   c = opencore (&ro, 
# 1279 "project/radare2/libr/main/radiff2.c" 3 4
                     ((void *)0)
# 1279 "project/radare2/libr/main/radiff2.c"
                         );
  }
  dump_cols (bufa, (int)sza, bufb, (int)szb, (r_cons_get_size (
# 1281 "project/radare2/libr/main/radiff2.c" 3 4
                                                              ((void *)0)
# 1281 "project/radare2/libr/main/radiff2.c"
                                                                  ) > 112)? 16: 8);
  break;
 case MODE_DIFF:
 case MODE_DIFF_STRS:
 ...
 case MODE_DIFF_IMPORTS:
  ...
  if (ro.diffmode == 'U') {
   ...
   r_diff_buffers (d, bufa, (
# 1308 "project/radare2/libr/main/radiff2.c" 3 4
                            unsigned int
# 1308 "project/radare2/libr/main/radiff2.c"
                                )sza, bufb, (
# 1308 "project/radare2/libr/main/radiff2.c" 3 4
                                             unsigned int
# 1308 "project/radare2/libr/main/radiff2.c"
   ...
   r_diff_buffers (d, bufa, (
# 1312 "project/radare2/libr/main/radiff2.c" 3 4
                            unsigned int
# 1312 "project/radare2/libr/main/radiff2.c"
                                )sza, bufb, (
# 1312 "project/radare2/libr/main/radiff2.c" 3 4
                                             unsigned int
# 1312 "project/radare2/libr/main/radiff2.c"
 ...
 case MODE_DIST_LEVENSHTEIN:
  {
   ...
   if (d) {
    ...
    r_diff_buffers_distance (d, bufa, (
# 1330 "project/radare2/libr/main/radiff2.c" 3 4
                                      unsigned int
# 1330 "project/radare2/libr/main/radiff2.c"
                                          )sza, bufb, (
# 1330 "project/radare2/libr/main/radiff2.c" 3 4
                                                       unsigned int
# 1330 "project/radare2/libr/main/radiff2.c"
 ...
 if (ro.pj) {
  ...
  free (s);
  ro.pj = 
# 1349 "project/radare2/libr/main/radiff2.c" 3 4
         ((void *)0)
# 1349 "project/radare2/libr/main/radiff2.c"
             ;
 }
 free (bufa);
 free (bufb);
