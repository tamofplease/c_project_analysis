# 0 "project/radare2/libr/main/rahash2.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/main/rahash2.c" 2
...
# 5 "project/radare2/libr/main/rahash2.c" 2
...
# 6 "project/radare2/libr/main/rahash2.c" 2
...
# 7 "project/radare2/libr/main/rahash2.c" 2
...
# 8 "project/radare2/libr/main/rahash2.c" 2
...
# 9 "project/radare2/libr/main/rahash2.c" 2
...
# 11 "project/radare2/libr/main/rahash2.c" 2


# 12 "project/radare2/libr/main/rahash2.c"
static 
# 12 "project/radare2/libr/main/rahash2.c" 3 4
      unsigned long long 
# 12 "project/radare2/libr/main/rahash2.c"
           from = 0LL;
static 
# 13 "project/radare2/libr/main/rahash2.c" 3 4
      unsigned long long 
# 13 "project/radare2/libr/main/rahash2.c"
           to = 0LL;
static 
# 14 "project/radare2/libr/main/rahash2.c" 3 4
      _Bool 
# 14 "project/radare2/libr/main/rahash2.c"
           incremental = 
# 14 "project/radare2/libr/main/rahash2.c" 3 4
                         1
# 14 "project/radare2/libr/main/rahash2.c"
...
# 19 "project/radare2/libr/main/rahash2.c" 3 4
        ((void *)0)
# 19 "project/radare2/libr/main/rahash2.c"
            ;

static void compare_hashes(const 
# 21 "project/radare2/libr/main/rahash2.c" 3 4
                                struct r_hash_t 
# 21 "project/radare2/libr/main/rahash2.c"
                                      *ctx, const 
# 21 "project/radare2/libr/main/rahash2.c" 3 4
                                                  unsigned char 
# 21 "project/radare2/libr/main/rahash2.c"
                                                      *compare, int length, int *ret) {
 if (compare) {
...
# 27 "project/radare2/libr/main/rahash2.c" 3 4
  fprintf(__stderrp,
# 27 "project/radare2/libr/main/rahash2.c"
...
static void do_hash_seed(const char *seed) {
 ...
 if (!seed) {
  _s = 
# 36 "project/radare2/libr/main/rahash2.c" 3 4
      ((void *)0)
# 36 "project/radare2/libr/main/rahash2.c"
          ;
  return;
 }
 _s = &s;
 if (!strcmp (seed, "-")) {
  s.buf = (
# 41 "project/radare2/libr/main/rahash2.c" 3 4
          unsigned char 
# 41 "project/radare2/libr/main/rahash2.c"
              *)r_stdin_slurp (&s.len);
  return;
 }
 if (seed[0] == '@') {
  size_t len;
  s.buf = (
# 46 "project/radare2/libr/main/rahash2.c" 3 4
          unsigned char 
# 46 "project/radare2/libr/main/rahash2.c"
              *)r_file_slurp (seed + 1, &len);
  s.len = (size_t)len;
  return;
 }
 s.buf = (
# 50 "project/radare2/libr/main/rahash2.c" 3 4
         unsigned char 
# 50 "project/radare2/libr/main/rahash2.c"
             *) malloc (strlen (seed) + 128);
 if (!s.buf) {
  _s = 
# 52 "project/radare2/libr/main/rahash2.c" 3 4
      ((void *)0)
# 52 "project/radare2/libr/main/rahash2.c"
          ;
  return;
 }
 if (*seed == '^') {
...
# 62 "project/radare2/libr/main/rahash2.c" 3 4
 __builtin___strcpy_chk (
# 62 "project/radare2/libr/main/rahash2.c"
 (char *) s.buf
# 62 "project/radare2/libr/main/rahash2.c" 3 4
 , 
# 62 "project/radare2/libr/main/rahash2.c"
...
# 67 "project/radare2/libr/main/rahash2.c" 3 4
  __builtin___strcpy_chk (
# 67 "project/radare2/libr/main/rahash2.c"
  (char *) s.buf
# 67 "project/radare2/libr/main/rahash2.c" 3 4
  , 
# 67 "project/radare2/libr/main/rahash2.c"
...
# 69 "project/radare2/libr/main/rahash2.c" 3 4
  fprintf(__stderrp,
# 69 "project/radare2/libr/main/rahash2.c"
  "Warning: This is not an hexpair, assuming a string, prefix it with 's:' to skip this message."
# 69 "project/radare2/libr/main/rahash2.c" 3 4
  )
# 69 "project/radare2/libr/main/rahash2.c"
                                                                                                           ;
...
static void do_hash_hexprint(const 
# 74 "project/radare2/libr/main/rahash2.c" 3 4
                                  unsigned char 
# 74 "project/radare2/libr/main/rahash2.c"
                                      *c, int len, int ule, PJ *pj, int rad) {
 int i;
...
# 82 "project/radare2/libr/main/rahash2.c" 3 4
  __builtin___snprintf_chk (
# 82 "project/radare2/libr/main/rahash2.c"
  buf + i * 2
# 82 "project/radare2/libr/main/rahash2.c" 3 4
  , 
# 82 "project/radare2/libr/main/rahash2.c"
...
# 86 "project/radare2/libr/main/rahash2.c" 3 4
  __builtin___snprintf_chk (
# 86 "project/radare2/libr/main/rahash2.c"
  buf + i * 2
# 86 "project/radare2/libr/main/rahash2.c" 3 4
  , 
# 86 "project/radare2/libr/main/rahash2.c"
...
static void do_hash_print(
# 97 "project/radare2/libr/main/rahash2.c" 3 4
                         struct r_hash_t 
# 97 "project/radare2/libr/main/rahash2.c"
                               *ctx, 
# 97 "project/radare2/libr/main/rahash2.c" 3 4
                                     unsigned long long 
# 97 "project/radare2/libr/main/rahash2.c"
                                          hash, int dlen, PJ *pj, int rad, int ule) {
 char *o;
 const 
# 99 "project/radare2/libr/main/rahash2.c" 3 4
      unsigned char 
# 99 "project/radare2/libr/main/rahash2.c"
          *c = ctx->digest;
 ...
 case 0:
  if (!quiet) {
   printf ("0x%08"
# 104 "project/radare2/libr/main/rahash2.c" 3 4
                 "llx" 
# 104 "project/radare2/libr/main/rahash2.c"
                         "-0x%08"
# 104 "project/radare2/libr/main/rahash2.c" 3 4
                                 "llx" 
# 104 "project/radare2/libr/main/rahash2.c"
  ...
  if (hash & 
# 107 "project/radare2/libr/main/rahash2.c" 3 4
            (1ULL << R_HASH_IDX_SSDEEP)
# 107 "project/radare2/libr/main/rahash2.c"
                         ) {
   printf ("%s\n", ctx->digest);
  } else if (dlen == 
# 109 "project/radare2/libr/main/rahash2.c" 3 4
                    0
# 109 "project/radare2/libr/main/rahash2.c"
                                       ) {
   printf("%.8f\n", ctx->entropy);
  } else {
 ...
 case 'n':
  if (hash & 
# 120 "project/radare2/libr/main/rahash2.c" 3 4
            (1ULL << R_HASH_IDX_SSDEEP)
# 120 "project/radare2/libr/main/rahash2.c"
                         ) {
   printf ("%s", ctx->digest);
  } else {
   do_hash_hexprint (c, dlen, ule, pj, rad);
...
static int do_hash_internal(
# 140 "project/radare2/libr/main/rahash2.c" 3 4
                           struct r_hash_t 
# 140 "project/radare2/libr/main/rahash2.c"
                                 *ctx, 
# 140 "project/radare2/libr/main/rahash2.c" 3 4
                                       unsigned long long 
# 140 "project/radare2/libr/main/rahash2.c"
...
# 140 "project/radare2/libr/main/rahash2.c" 3 4
                                                        unsigned char 
# 140 "project/radare2/libr/main/rahash2.c"
                                                            *buf, int len, PJ *pj, int rad, int print, int le) {
 if (len < 0) {
  return 0;
 }
...
static int do_hash(const char *file, const char *algo, RIO *io, int bsize, int rad, int ule, const 
# 155 "project/radare2/libr/main/rahash2.c" 3 4
                                                                                                  unsigned char 
# 155 "project/radare2/libr/main/rahash2.c"
                                                                                                      *compare) {
 
# 156 "project/radare2/libr/main/rahash2.c" 3 4
unsigned long long 
# 156 "project/radare2/libr/main/rahash2.c"
     j, fsize, algobit = r_hash_name_to_bits (algo);
 
# 157 "project/radare2/libr/main/rahash2.c" 3 4
struct r_hash_t 
# 157 "project/radare2/libr/main/rahash2.c"
      *ctx;
 
# 158 "project/radare2/libr/main/rahash2.c" 3 4
unsigned char 
# 158 "project/radare2/libr/main/rahash2.c"
    *buf;
 int ret = 0;
 
# 160 "project/radare2/libr/main/rahash2.c" 3 4
unsigned long long 
# 160 "project/radare2/libr/main/rahash2.c"
     i;
 if (algobit == 
# 161 "project/radare2/libr/main/rahash2.c" 3 4
               0
# 161 "project/radare2/libr/main/rahash2.c"
                          ) {
  
# 162 "project/radare2/libr/main/rahash2.c" 3 4
 fprintf(__stderrp,
# 162 "project/radare2/libr/main/rahash2.c"
 "rahash2: Invalid hashing algorithm specified\n"
# 162 "project/radare2/libr/main/rahash2.c" 3 4
 )
# 162 "project/radare2/libr/main/rahash2.c"
                                                           ;
...
# 167 "project/radare2/libr/main/rahash2.c" 3 4
 fprintf(__stderrp,
# 167 "project/radare2/libr/main/rahash2.c"
 "rahash2: Invalid file size\n"
# 167 "project/radare2/libr/main/rahash2.c" 3 4
 )
# 167 "project/radare2/libr/main/rahash2.c"
                                         ;
...
# 180 "project/radare2/libr/main/rahash2.c" 3 4
 fprintf(__stderrp,
# 180 "project/radare2/libr/main/rahash2.c"
 "rahash2: Invalid -f -t range\n"
# 180 "project/radare2/libr/main/rahash2.c" 3 4
 )
# 180 "project/radare2/libr/main/rahash2.c"
                                           ;
...
# 184 "project/radare2/libr/main/rahash2.c" 3 4
 fprintf(__stderrp,
# 184 "project/radare2/libr/main/rahash2.c"
 "rahash2: Unknown file size\n"
# 184 "project/radare2/libr/main/rahash2.c" 3 4
 )
# 184 "project/radare2/libr/main/rahash2.c"
                                         ;
 ...
 PJ *pj = 
# 191 "project/radare2/libr/main/rahash2.c" 3 4
         ((void *)0)
# 191 "project/radare2/libr/main/rahash2.c"
             ;
 if (rad == 'j') {
  pj = pj_new ();
  if (!pj) {
 ...
 ctx = r_hash_new (
# 200 "project/radare2/libr/main/rahash2.c" 3 4
                  1
# 200 "project/radare2/libr/main/rahash2.c"
                      , algobit);

 if (incremental) {
  for (i = 1; i < 
# 203 "project/radare2/libr/main/rahash2.c" 3 4
                 ((1ULL << (((63)>(R_HASH_NUM_INDICES))?(R_HASH_NUM_INDICES):(63)))-1)
# 203 "project/radare2/libr/main/rahash2.c"
                           ; i <<= 1) {
   if (algobit & i) {
    
# 205 "project/radare2/libr/main/rahash2.c" 3 4
   unsigned long long 
# 205 "project/radare2/libr/main/rahash2.c"
        hashbit = i & algobit;
...
# 245 "project/radare2/libr/main/rahash2.c" 3 4
  fprintf(__stderrp,
# 245 "project/radare2/libr/main/rahash2.c"
  "Warning: Seed ignored on per-block hashing.\n"
# 245 "project/radare2/libr/main/rahash2.c" 3 4
  )
# 245 "project/radare2/libr/main/rahash2.c"
                                                           ;
  ...
  for (i = 1; i < 
# 247 "project/radare2/libr/main/rahash2.c" 3 4
                 ((1ULL << (((63)>(R_HASH_NUM_INDICES))?(R_HASH_NUM_INDICES):(63)))-1)
# 247 "project/radare2/libr/main/rahash2.c"
                           ; i <<= 1) {
   
# 248 "project/radare2/libr/main/rahash2.c" 3 4
  unsigned long long 
# 248 "project/radare2/libr/main/rahash2.c"
       f, t, ofrom, oto;
   if (algobit & i) {
    
# 250 "project/radare2/libr/main/rahash2.c" 3 4
   unsigned long long 
# 250 "project/radare2/libr/main/rahash2.c"
        hashbit = i & algobit;
    ofrom = from;
    oto = to;
    f = from;
...
# 265 "project/radare2/libr/main/rahash2.c" 3 4
                                   ((void *)0)
# 265 "project/radare2/libr/main/rahash2.c"
                                       , 0, pj, rad, 1, ule);
    from = ofrom;
    to = oto;
   }
...
# 314 "project/radare2/libr/main/rahash2.c" 3 4
unsigned long long 
# 314 "project/radare2/libr/main/rahash2.c"
     bits;
 
# 315 "project/radare2/libr/main/rahash2.c" 3 4
unsigned long long 
# 315 "project/radare2/libr/main/rahash2.c"
     i;
 for (i = 0; i < 
# 316 "project/radare2/libr/main/rahash2.c" 3 4
                (8*sizeof(unsigned long long))
# 316 "project/radare2/libr/main/rahash2.c"
                            ; i++) {
  bits = 1ULL << i;
 ...
 for (i = 0;; i++) {
  bits = ((
# 328 "project/radare2/libr/main/rahash2.c" 3 4
          unsigned long long
# 328 "project/radare2/libr/main/rahash2.c"
              ) 1) << i;
...
# 346 "project/radare2/libr/main/rahash2.c"
static 
# 346 "project/radare2/libr/main/rahash2.c" 3 4
      _Bool 
# 346 "project/radare2/libr/main/rahash2.c"
           is_power_of_two(const 
# 346 "project/radare2/libr/main/rahash2.c" 3 4
                                 unsigned long long 
# 346 "project/radare2/libr/main/rahash2.c"
                                      x) {
...
static int encrypt_or_decrypt(const char *algo, int direction, const char *hashstr, int hashstr_len, const 
# 351 "project/radare2/libr/main/rahash2.c" 3 4
                                                                                                          unsigned char 
# 351 "project/radare2/libr/main/rahash2.c"
                                                                                                              *iv, int ivlen, int mode) {
 
# 352 "project/radare2/libr/main/rahash2.c" 3 4
_Bool 
# 352 "project/radare2/libr/main/rahash2.c"
...
# 361 "project/radare2/libr/main/rahash2.c" 3 4
    fprintf(__stderrp,
# 361 "project/radare2/libr/main/rahash2.c"
    "Invalid IV.\n"
# 361 "project/radare2/libr/main/rahash2.c" 3 4
    )
# 361 "project/radare2/libr/main/rahash2.c"
...
# 365 "project/radare2/libr/main/rahash2.c" 3 4
                                unsigned char 
# 365 "project/radare2/libr/main/rahash2.c"
                                    *) buf, buflen);

    int result_size = 0;
    
# 368 "project/radare2/libr/main/rahash2.c" 3 4
   unsigned char 
# 368 "project/radare2/libr/main/rahash2.c"
       *result = r_crypto_get_output (cry, &result_size);
    if (result) {
     if (write (1, result, result_size) != result_size) {
      
# 371 "project/radare2/libr/main/rahash2.c" 3 4
     fprintf(__stderrp,
# 371 "project/radare2/libr/main/rahash2.c"
...
# 376 "project/radare2/libr/main/rahash2.c" 3 4
   fprintf(__stderrp,
# 376 "project/radare2/libr/main/rahash2.c"
   "Invalid key\n"
# 376 "project/radare2/libr/main/rahash2.c" 3 4
   )
# 376 "project/radare2/libr/main/rahash2.c"
...
# 380 "project/radare2/libr/main/rahash2.c" 3 4
  fprintf(__stderrp,
# 380 "project/radare2/libr/main/rahash2.c"
...
# 384 "project/radare2/libr/main/rahash2.c" 3 4
 fprintf(__stderrp,
# 384 "project/radare2/libr/main/rahash2.c"
...
static int encrypt_or_decrypt_file(const char *algo, int direction, const char *filename, const 
# 389 "project/radare2/libr/main/rahash2.c" 3 4
                                                                                               unsigned char 
# 389 "project/radare2/libr/main/rahash2.c"
                                                                                                   *iv, int ivlen, int mode) {
 
# 390 "project/radare2/libr/main/rahash2.c" 3 4
_Bool 
# 390 "project/radare2/libr/main/rahash2.c"
     no_key_mode = !strcmp ("base64", algo) || !strcmp ("base91", algo) || !strcmp ("punycode", algo);
 if (no_key_mode || s.len > 0) {
  RCrypto *cry = r_crypto_new ();
  if (r_crypto_use (cry, algo)) {
...
# 396 "project/radare2/libr/main/rahash2.c" 3 4
   unsigned char 
# 396 "project/radare2/libr/main/rahash2.c"
       *buf;
    if (strcmp (filename, "-") == 0) {
     int sz;
     buf = (
# 399 "project/radare2/libr/main/rahash2.c" 3 4
           unsigned char 
# 399 "project/radare2/libr/main/rahash2.c"
               *)r_stdin_slurp (&sz);
     file_size = (size_t)sz;
    } else {
     buf = (
# 402 "project/radare2/libr/main/rahash2.c" 3 4
           unsigned char 
# 402 "project/radare2/libr/main/rahash2.c"
               *)r_file_slurp (filename, &file_size);
    }
    if (!buf) {
     
# 405 "project/radare2/libr/main/rahash2.c" 3 4
    fprintf(__stderrp,
# 405 "project/radare2/libr/main/rahash2.c"
    "rahash2: Cannot open '%s'\n", filename
# 405 "project/radare2/libr/main/rahash2.c" 3 4
    )
# 405 "project/radare2/libr/main/rahash2.c"
                                                     ;
...
# 410 "project/radare2/libr/main/rahash2.c" 3 4
    fprintf(__stderrp,
# 410 "project/radare2/libr/main/rahash2.c"
    "Invalid IV.\n"
# 410 "project/radare2/libr/main/rahash2.c" 3 4
    )
# 410 "project/radare2/libr/main/rahash2.c"
...
# 418 "project/radare2/libr/main/rahash2.c" 3 4
   unsigned char 
# 418 "project/radare2/libr/main/rahash2.c"
       *result = r_crypto_get_output (cry, &result_size);
    if (result) {
...
# 425 "project/radare2/libr/main/rahash2.c" 3 4
   fprintf(__stderrp,
# 425 "project/radare2/libr/main/rahash2.c"
   "Invalid key\n"
# 425 "project/radare2/libr/main/rahash2.c" 3 4
   )
# 425 "project/radare2/libr/main/rahash2.c"
...
# 429 "project/radare2/libr/main/rahash2.c" 3 4
  fprintf(__stderrp,
# 429 "project/radare2/libr/main/rahash2.c"
  "Unknown %s algorithm '%s'\n", ((!direction)? "encryption": "decryption"), algo
# 429 "project/radare2/libr/main/rahash2.c" 3 4
  )
# 429 "project/radare2/libr/main/rahash2.c"
...
# 433 "project/radare2/libr/main/rahash2.c" 3 4
 fprintf(__stderrp,
# 433 "project/radare2/libr/main/rahash2.c"
 "%s key not defined. Use -S [key]\n", ((!direction)? "Encryption": "Decryption")
# 433 "project/radare2/libr/main/rahash2.c" 3 4
 )
# 433 "project/radare2/libr/main/rahash2.c"
...
# 438 "project/radare2/libr/main/rahash2.c" 3 4
__attribute__((visibility("default"))) 
# 438 "project/radare2/libr/main/rahash2.c"
     int r_main_rahash2(int argc, const char **argv) {
 
# 439 "project/radare2/libr/main/rahash2.c" 3 4
unsigned long long 
# 439 "project/radare2/libr/main/rahash2.c"
     i;
 int ret, c, rad = 0, bsize = 0, numblocks = 0, ule = 0;
 const char *file = 
# 441 "project/radare2/libr/main/rahash2.c" 3 4
                   ((void *)0)
# 441 "project/radare2/libr/main/rahash2.c"
                       ;
 const char *algo = "sha256";
 const char *seed = 
# 443 "project/radare2/libr/main/rahash2.c" 3 4
                   ((void *)0)
# 443 "project/radare2/libr/main/rahash2.c"
                       ;
 const char *decrypt = 
# 444 "project/radare2/libr/main/rahash2.c" 3 4
                      ((void *)0)
# 444 "project/radare2/libr/main/rahash2.c"
                          ;
 const char *encrypt = 
# 445 "project/radare2/libr/main/rahash2.c" 3 4
                      ((void *)0)
# 445 "project/radare2/libr/main/rahash2.c"
                          ;
 char *hashstr = 
# 446 "project/radare2/libr/main/rahash2.c" 3 4
                ((void *)0)
# 446 "project/radare2/libr/main/rahash2.c"
                    ;
 
# 447 "project/radare2/libr/main/rahash2.c" 3 4
unsigned char 
# 447 "project/radare2/libr/main/rahash2.c"
    *iv = 
# 447 "project/radare2/libr/main/rahash2.c" 3 4
          ((void *)0)
# 447 "project/radare2/libr/main/rahash2.c"
 ...
 int ivlen = -1;
 const char *ivseed = 
# 449 "project/radare2/libr/main/rahash2.c" 3 4
                     ((void *)0)
# 449 "project/radare2/libr/main/rahash2.c"
                         ;
 const char *compareStr = 
# 450 "project/radare2/libr/main/rahash2.c" 3 4
                         ((void *)0)
# 450 "project/radare2/libr/main/rahash2.c"
                             ;
 const char *ptype = 
# 451 "project/radare2/libr/main/rahash2.c" 3 4
                    ((void *)0)
# 451 "project/radare2/libr/main/rahash2.c"
                        ;
 
# 452 "project/radare2/libr/main/rahash2.c" 3 4
unsigned char 
# 452 "project/radare2/libr/main/rahash2.c"
    *compareBin = 
# 452 "project/radare2/libr/main/rahash2.c" 3 4
                  ((void *)0)
# 452 "project/radare2/libr/main/rahash2.c"
...
# 456 "project/radare2/libr/main/rahash2.c" 3 4
unsigned long long 
# 456 "project/radare2/libr/main/rahash2.c"
     algobit;
 
# 457 "project/radare2/libr/main/rahash2.c" 3 4
struct r_hash_t 
# 457 "project/radare2/libr/main/rahash2.c"
      *ctx;
 RIO *io;
...
# 468 "project/radare2/libr/main/rahash2.c" 3 4
   fprintf(__stderrp,
# 468 "project/radare2/libr/main/rahash2.c"
   "error: -i argument must be positive\n"
# 468 "project/radare2/libr/main/rahash2.c" 3 4
   )
# 468 "project/radare2/libr/main/rahash2.c"
                                                    ;
  ...
  case 'B': incremental = 
# 484 "project/radare2/libr/main/rahash2.c" 3 4
                         0
# 484 "project/radare2/libr/main/rahash2.c"
                              ; break;
  case 'b': bsize = (int) r_num_math (
# 485 "project/radare2/libr/main/rahash2.c" 3 4
                                     ((void *)0)
# 485 "project/radare2/libr/main/rahash2.c"
                                         , opt.arg); break;
  case 'f': from = r_num_math (
# 486 "project/radare2/libr/main/rahash2.c" 3 4
                              ((void *)0)
# 486 "project/radare2/libr/main/rahash2.c"
                                  , opt.arg); break;
  case 't': to = 1 + r_num_math (
# 487 "project/radare2/libr/main/rahash2.c" 3 4
                                ((void *)0)
# 487 "project/radare2/libr/main/rahash2.c"
                                    , opt.arg); break;
  case 'v': return r_main_version_print ("rahash2");
  case 'h': return do_help (0);
  case 's': { if (hashstr) { 
# 490 "project/radare2/libr/main/rahash2.c" 3 4
           fprintf(__stderrp,
# 490 "project/radare2/libr/main/rahash2.c"
           "Hashstring already defined\n"
# 490 "project/radare2/libr/main/rahash2.c" 3 4
           )
# 490 "project/radare2/libr/main/rahash2.c"
           ; return 1; } hashstr_hex = 0; hashstr = (char*)opt.arg;}; break;
  case 'x': { if (hashstr) { 
# 491 "project/radare2/libr/main/rahash2.c" 3 4
           fprintf(__stderrp,
# 491 "project/radare2/libr/main/rahash2.c"
           "Hashstring already defined\n"
# 491 "project/radare2/libr/main/rahash2.c" 3 4
           )
# 491 "project/radare2/libr/main/rahash2.c"
           ; return 1; } hashstr_hex = 1; hashstr = (char*)opt.arg;}; break;
...
# 497 "project/radare2/libr/main/rahash2.c" 3 4
 fprintf(__stderrp,
# 497 "project/radare2/libr/main/rahash2.c"
 "rahash2: Option -E and -D are incompatible with each other.\n"
# 497 "project/radare2/libr/main/rahash2.c" 3 4
 )
# 497 "project/radare2/libr/main/rahash2.c"
                                                                          ;
...
# 503 "project/radare2/libr/main/rahash2.c" 3 4
  fprintf(__stderrp,
# 503 "project/radare2/libr/main/rahash2.c"
...
# 506 "project/radare2/libr/main/rahash2.c" 3 4
 _Bool 
# 506 "project/radare2/libr/main/rahash2.c"
      flag = 
# 506 "project/radare2/libr/main/rahash2.c" 3 4
             0
# 506 "project/radare2/libr/main/rahash2.c"
...
# 513 "project/radare2/libr/main/rahash2.c" 3 4
  fprintf(__stderrp,
# 513 "project/radare2/libr/main/rahash2.c"
...
# 519 "project/radare2/libr/main/rahash2.c" 3 4
  fprintf(__stderrp,
# 519 "project/radare2/libr/main/rahash2.c"
...
# 528 "project/radare2/libr/main/rahash2.c" 3 4
  fprintf(__stderrp,
# 528 "project/radare2/libr/main/rahash2.c"
...
# 532 "project/radare2/libr/main/rahash2.c" 3 4
  fprintf(__stderrp,
# 532 "project/radare2/libr/main/rahash2.c"
  "rahash2: Given -c hash has %d byte(s) but the selected algorithm returns %d byte(s).\n", compareBin_len, r_hash_size (algobit)
# 532 "project/radare2/libr/main/rahash2.c" 3 4
  )


                          
# 535 "project/radare2/libr/main/rahash2.c"
                         ;
   free (compareBin);
   return 1;
  }
 ...
 if ((
# 540 "project/radare2/libr/main/rahash2.c" 3 4
     long long
# 540 "project/radare2/libr/main/rahash2.c"
         ) from >= 0 && (
# 540 "project/radare2/libr/main/rahash2.c" 3 4
                         long long
# 540 "project/radare2/libr/main/rahash2.c"
...
# 545 "project/radare2/libr/main/rahash2.c" 3 4
  fprintf(__stderrp,
# 545 "project/radare2/libr/main/rahash2.c"
  "Invalid -f or -t offsets\n"
# 545 "project/radare2/libr/main/rahash2.c" 3 4
  )
# 545 "project/radare2/libr/main/rahash2.c"
                                        ;
 ...
 if (ivseed) {
  iv = (
# 561 "project/radare2/libr/main/rahash2.c" 3 4
       unsigned char 
# 561 "project/radare2/libr/main/rahash2.c"
           *) malloc (strlen (ivseed) + 128);
  if (!strncmp (ivseed, "s:", 2)) {
   
# 563 "project/radare2/libr/main/rahash2.c" 3 4
  __builtin___strcpy_chk (
# 563 "project/radare2/libr/main/rahash2.c"
  (char *) iv
# 563 "project/radare2/libr/main/rahash2.c" 3 4
  , 
# 563 "project/radare2/libr/main/rahash2.c"
...
# 568 "project/radare2/libr/main/rahash2.c" 3 4
   __builtin___strcpy_chk (
# 568 "project/radare2/libr/main/rahash2.c"
   (char *) iv
# 568 "project/radare2/libr/main/rahash2.c" 3 4
   , 
# 568 "project/radare2/libr/main/rahash2.c"
...
# 568 "project/radare2/libr/main/rahash2.c"
 ...
 if (hashstr) {
  ...
  if (!strcmp (hashstr, "-")) {
   ...
   bytes_read = fread ((void *) hashstr, 1, 32768 - 1, 
# 583 "project/radare2/libr/main/rahash2.c" 3 4
                                                       __stdinp
# 583 "project/radare2/libr/main/rahash2.c"
                                                            );
   if (bytes_read < 1) {
    bytes_read = 0;
   }
...
# 591 "project/radare2/libr/main/rahash2.c" 3 4
  unsigned char 
# 591 "project/radare2/libr/main/rahash2.c"
      *out = malloc ((strlen (hashstr) + 1) * 2);
   hashstr_len = r_hex_str2bin (hashstr, out);
   if (hashstr_len < 1) {
    
# 594 "project/radare2/libr/main/rahash2.c" 3 4
   fprintf(__stderrp,
# 594 "project/radare2/libr/main/rahash2.c"
   "Invalid hex string\n"
# 594 "project/radare2/libr/main/rahash2.c" 3 4
   )
# 594 "project/radare2/libr/main/rahash2.c"
...
# 608 "project/radare2/libr/main/rahash2.c" 3 4
   fprintf(__stderrp,
# 608 "project/radare2/libr/main/rahash2.c"
   "Invalid -f.\n"
# 608 "project/radare2/libr/main/rahash2.c" 3 4
   )
# 608 "project/radare2/libr/main/rahash2.c"
...
# 615 "project/radare2/libr/main/rahash2.c" 3 4
   fprintf(__stderrp,
# 615 "project/radare2/libr/main/rahash2.c"
   "Invalid -t.\n"
# 615 "project/radare2/libr/main/rahash2.c" 3 4
   )
# 615 "project/radare2/libr/main/rahash2.c"
...
# 638 "project/radare2/libr/main/rahash2.c" 3 4
    __builtin___memcpy_chk (
# 638 "project/radare2/libr/main/rahash2.c"
    str
# 638 "project/radare2/libr/main/rahash2.c" 3 4
    , 
# 638 "project/radare2/libr/main/rahash2.c"
...
# 639 "project/radare2/libr/main/rahash2.c" 3 4
    __builtin___memcpy_chk (
# 639 "project/radare2/libr/main/rahash2.c"
    str + s.len
# 639 "project/radare2/libr/main/rahash2.c" 3 4
    , 
# 639 "project/radare2/libr/main/rahash2.c"
...
# 641 "project/radare2/libr/main/rahash2.c" 3 4
    __builtin___memcpy_chk (
# 641 "project/radare2/libr/main/rahash2.c"
    str
# 641 "project/radare2/libr/main/rahash2.c" 3 4
    , 
# 641 "project/radare2/libr/main/rahash2.c"
...
# 642 "project/radare2/libr/main/rahash2.c" 3 4
    __builtin___memcpy_chk (
# 642 "project/radare2/libr/main/rahash2.c"
    str + strsz
# 642 "project/radare2/libr/main/rahash2.c" 3 4
    , 
# 642 "project/radare2/libr/main/rahash2.c"
...
# 649 "project/radare2/libr/main/rahash2.c" 3 4
   fprintf(__stderrp,
# 649 "project/radare2/libr/main/rahash2.c"
   "Invalid algorithm. See -E, -D maybe?\n"
# 649 "project/radare2/libr/main/rahash2.c" 3 4
   )
# 649 "project/radare2/libr/main/rahash2.c"
                                                     ;
   ...
   PJ *pj = 
# 656 "project/radare2/libr/main/rahash2.c" 3 4
           ((void *)0)
# 656 "project/radare2/libr/main/rahash2.c"
               ;
   if (rad == 'j') {
    pj = pj_new ();
    if (!pj) {
   ...
   for (i = 1; i < 
# 668 "project/radare2/libr/main/rahash2.c" 3 4
                  ((1ULL << (((63)>(R_HASH_NUM_INDICES))?(R_HASH_NUM_INDICES):(63)))-1)
# 668 "project/radare2/libr/main/rahash2.c"
                            ; i <<= 1) {
    if (algobit & i) {
     
# 670 "project/radare2/libr/main/rahash2.c" 3 4
    unsigned long long 
# 670 "project/radare2/libr/main/rahash2.c"
         hashbit = i & algobit;
     ctx = r_hash_new (
# 671 "project/radare2/libr/main/rahash2.c" 3 4
                      1
# 671 "project/radare2/libr/main/rahash2.c"
                          , hashbit);
     from = 0;
     to = strsz;
     do_hash_internal (ctx, hashbit, (const 
# 674 "project/radare2/libr/main/rahash2.c" 3 4
                                           unsigned char 
# 674 "project/radare2/libr/main/rahash2.c"
                                               *) str, strsz, pj, rad, 1, ule);
...
# 700 "project/radare2/libr/main/rahash2.c" 3 4
 fprintf(__stderrp,
# 700 "project/radare2/libr/main/rahash2.c"
 "rahash2: Invalid block size\n"
# 700 "project/radare2/libr/main/rahash2.c" 3 4
 )
# 700 "project/radare2/libr/main/rahash2.c"
                                          ;
...
# 710 "project/radare2/libr/main/rahash2.c" 3 4
  fprintf(__stderrp,
# 710 "project/radare2/libr/main/rahash2.c"
...
# 710 "project/radare2/libr/main/rahash2.c"
  ...
  if (encrypt) {
   ...
   RIODesc *desc = 
# 729 "project/radare2/libr/main/rahash2.c" 3 4
                  ((void *)0)
# 729 "project/radare2/libr/main/rahash2.c"
                      ;
   if (!strcmp (argv[i], "-")) {
    int sz = 0;
    
# 732 "project/radare2/libr/main/rahash2.c" 3 4
   unsigned char 
# 732 "project/radare2/libr/main/rahash2.c"
       *buf = (
# 732 "project/radare2/libr/main/rahash2.c" 3 4
               unsigned char 
# 732 "project/radare2/libr/main/rahash2.c"
    ...
    if (sz > 0) {
     desc = r_io_open_nomap (io, uri, 
# 735 "project/radare2/libr/main/rahash2.c" 3 4
                                     4
# 735 "project/radare2/libr/main/rahash2.c"
                                             , 0);
     if (!desc) {
      
# 737 "project/radare2/libr/main/rahash2.c" 3 4
     fprintf(__stderrp,
# 737 "project/radare2/libr/main/rahash2.c"
     "rahash2: Cannot open malloc://1024\n"
# 737 "project/radare2/libr/main/rahash2.c" 3 4
     )
# 737 "project/radare2/libr/main/rahash2.c"
                                                     ;
...
# 747 "project/radare2/libr/main/rahash2.c" 3 4
    fprintf(__stderrp,
# 747 "project/radare2/libr/main/rahash2.c"
    "rahash2: Cannot hash directories\n"
# 747 "project/radare2/libr/main/rahash2.c" 3 4
    )
# 747 "project/radare2/libr/main/rahash2.c"
                                                  ;
    ...
    desc = r_io_open_nomap (io, argv[i], 
# 751 "project/radare2/libr/main/rahash2.c" 3 4
                                        4
# 751 "project/radare2/libr/main/rahash2.c"
                                                , 0);
    if (!desc) {
     
# 753 "project/radare2/libr/main/rahash2.c" 3 4
    fprintf(__stderrp,
# 753 "project/radare2/libr/main/rahash2.c"
    "rahash2: Cannot open '%s'\n", argv[i]
# 753 "project/radare2/libr/main/rahash2.c" 3 4
    )
# 753 "project/radare2/libr/main/rahash2.c"
