# 0 "project/radare2/libr/main/r2agent.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/main/r2agent.c"


# 1 "project/radare2/libr/main/index.h" 1
...
"</body>"
"</html>";
# 4 "project/radare2/libr/main/r2agent.c" 2
...
# 5 "project/radare2/libr/main/r2agent.c" 2
...
# 6 "project/radare2/libr/main/r2agent.c" 2
# 17 "project/radare2/libr/main/r2agent.c"
...
# 33 "project/radare2/libr/main/r2agent.c" 3 4
__attribute__((visibility("default"))) 
# 33 "project/radare2/libr/main/r2agent.c"
     int r_main_r2agent(int argc, const char **argv) {
 RSocket *s;
...
# 40 "project/radare2/libr/main/r2agent.c" 3 4
_Bool 
# 40 "project/radare2/libr/main/r2agent.c"
     listenlocal = 
# 40 "project/radare2/libr/main/r2agent.c" 3 4
                   1
# 40 "project/radare2/libr/main/r2agent.c"
 ...
 const char *httpauthfile = 
# 42 "project/radare2/libr/main/r2agent.c" 3 4
                           ((void *)0)
# 42 "project/radare2/libr/main/r2agent.c"
                               ;
 char *pfile = 
# 43 "project/radare2/libr/main/r2agent.c" 3 4
              ((void *)0)
# 43 "project/radare2/libr/main/r2agent.c"
                  ;
 
# 44 "project/radare2/libr/main/r2agent.c" 3 4
__builtin___memset_chk (
# 44 "project/radare2/libr/main/r2agent.c"
&so
# 44 "project/radare2/libr/main/r2agent.c" 3 4
, 
# 44 "project/radare2/libr/main/r2agent.c"
...
# 44 "project/radare2/libr/main/r2agent.c"
 ...
 while ((c = r_getopt_next (&opt)) != -1) {
  ...
  case 'a':
   listenlocal = 
# 51 "project/radare2/libr/main/r2agent.c" 3 4
                0
# 51 "project/radare2/libr/main/r2agent.c"
                     ;
   break;
  case 's':
   dosandbox = 1;
  ...
  case 'u':
   so.httpauth = 
# 64 "project/radare2/libr/main/r2agent.c" 3 4
                1
# 64 "project/radare2/libr/main/r2agent.c"
                    ;
   break;
  case 't':
...
# 85 "project/radare2/libr/main/r2agent.c" 3 4
  fprintf(__stderrp,
# 85 "project/radare2/libr/main/r2agent.c"
...
# 94 "project/radare2/libr/main/r2agent.c" 3 4
  fprintf(__stderrp,
# 94 "project/radare2/libr/main/r2agent.c"
...
# 94 "project/radare2/libr/main/r2agent.c"
 ...
 s = r_socket_new (
# 110 "project/radare2/libr/main/r2agent.c" 3 4
                  0
# 110 "project/radare2/libr/main/r2agent.c"
                       );
 s->local = listenlocal;
 if (!r_socket_listen (s, port, 
# 112 "project/radare2/libr/main/r2agent.c" 3 4
                               ((void *)0)
# 112 "project/radare2/libr/main/r2agent.c"
                                   )) {
  
# 113 "project/radare2/libr/main/r2agent.c" 3 4
 fprintf(__stderrp,
# 113 "project/radare2/libr/main/r2agent.c"
 "Cannot listen on %d\n", s->port
# 113 "project/radare2/libr/main/r2agent.c" 3 4
 )
# 113 "project/radare2/libr/main/r2agent.c"
...
# 118 "project/radare2/libr/main/r2agent.c" 3 4
fprintf(__stderrp,
# 118 "project/radare2/libr/main/r2agent.c"
"http://localhost:%d/\n", s->port
# 118 "project/radare2/libr/main/r2agent.c" 3 4
)
# 118 "project/radare2/libr/main/r2agent.c"
                                           ;
 if (dosandbox && !r_sandbox_enable (
# 119 "project/radare2/libr/main/r2agent.c" 3 4
                                    1
# 119 "project/radare2/libr/main/r2agent.c"
                                        )) {
  
# 120 "project/radare2/libr/main/r2agent.c" 3 4
 fprintf(__stderrp,
# 120 "project/radare2/libr/main/r2agent.c"
 "sandbox: Cannot be enabled.\n"
# 120 "project/radare2/libr/main/r2agent.c" 3 4
 )
# 120 "project/radare2/libr/main/r2agent.c"
                                          ;
 ...
 while (!r_cons_singleton ()->context->breaked) {
  char *result_heap = 
# 130 "project/radare2/libr/main/r2agent.c" 3 4
                     ((void *)0)
# 130 "project/radare2/libr/main/r2agent.c"
                         ;
  ...
  if (!rs->auth) {
   r_socket_http_response (rs, 401, "", 0, 
# 138 "project/radare2/libr/main/r2agent.c" 3 4
                                          ((void *)0)
# 138 "project/radare2/libr/main/r2agent.c"
                                              );
  }
  if (!strcmp (rs->method, "GET")) {
   if (!strncmp (rs->path, "/proc/kill/", 11)) {
    ...
    if (pid > 0) {
     ...
     r_sandbox_kill (pid, 
# 148 "project/radare2/libr/main/r2agent.c" 3 4
                         9
# 148 "project/radare2/libr/main/r2agent.c"
                                );
...
# 164 "project/radare2/libr/main/r2agent.c" 3 4
   __builtin___snprintf_chk (
# 164 "project/radare2/libr/main/r2agent.c"
   cmd
# 164 "project/radare2/libr/main/r2agent.c" 3 4
   , 
# 164 "project/radare2/libr/main/r2agent.c"
...
# 164 "project/radare2/libr/main/r2agent.c" 3 4
   , 2 > 1 ? 1 : 0), 
# 164 "project/radare2/libr/main/r2agent.c"
   "r2 -q %s-e http.port=%d -c=h \"%s\"", listenlocal? "": "-e http.bind=public ", session_port, escaped_filename
# 164 "project/radare2/libr/main/r2agent.c" 3 4
   )

                                    
# 166 "project/radare2/libr/main/r2agent.c"
                                   ;
...
# 179 "project/radare2/libr/main/r2agent.c" 3 4
   __builtin___sprintf_chk (
# 179 "project/radare2/libr/main/r2agent.c"
   result_heap
# 179 "project/radare2/libr/main/r2agent.c" 3 4
   , 0, __builtin_object_size (
# 179 "project/radare2/libr/main/r2agent.c"
...
# 179 "project/radare2/libr/main/r2agent.c" 3 4
   , 2 > 1 ? 1 : 0), 
# 179 "project/radare2/libr/main/r2agent.c"
   "<html><body>" "<a href='/'>back</a><hr size=1/>" " - <a target='_blank' href='http://localhost:%d/'>open</a><br />" " - <a href='/proc/kill/%d'>kill</a><br />" "</body></html>", session_port, pid
# 179 "project/radare2/libr/main/r2agent.c" 3 4
   )
...
# 184 "project/radare2/libr/main/r2agent.c"
                                       ;
    
# 185 "project/radare2/libr/main/r2agent.c" 3 4
   fprintf(__stderrp,
# 185 "project/radare2/libr/main/r2agent.c"
   "\nchild pid %d\n\n", pid
# 185 "project/radare2/libr/main/r2agent.c" 3 4
   )
# 185 "project/radare2/libr/main/r2agent.c"
  ...
  r_socket_http_response (rs, 200, result, 0, 
# 188 "project/radare2/libr/main/r2agent.c" 3 4
                                             ((void *)0)
# 188 "project/radare2/libr/main/r2agent.c"
                                                 );
  r_socket_http_close (rs);
  free (result_heap);
  result_heap = 
# 191 "project/radare2/libr/main/r2agent.c" 3 4
               ((void *)0)
# 191 "project/radare2/libr/main/r2agent.c"
                   ;
 }
 r_cons_free ();
 free (pfile);
