# 0 "project/radare2/libr/debug/dsignal.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/debug/dsignal.c"
...
# 4 "project/radare2/libr/debug/dsignal.c" 2
...
# 9 "project/radare2/libr/debug/dsignal.c"
static struct {
 const char *k;
 const char *v;
} signals[] = {
 ...
 { "SIGRTMAX", "NSIG" },
 { 
# 50 "project/radare2/libr/debug/dsignal.c" 3 4
  ((void *)0) 
# 50 "project/radare2/libr/debug/dsignal.c"
       }
};


# 53 "project/radare2/libr/debug/dsignal.c" 3 4
__attribute__((visibility("default"))) 
# 53 "project/radare2/libr/debug/dsignal.c"
     void r_debug_signal_init(RDebug *dbg) {
 int i;

 dbg->sgnls = sdb_new (
# 56 "project/radare2/libr/debug/dsignal.c" 3 4
              ((void *)0)
# 56 "project/radare2/libr/debug/dsignal.c"
                  , "signals", 0);
 for (i=0; signals[i].k; i++) {
  sdb_set (dbg->sgnls, signals[i].k, signals[i].v, 0);
  sdb_set (dbg->sgnls, signals[i].v, signals[i].k, 0);
 }
}

static 
# 63 "project/radare2/libr/debug/dsignal.c" 3 4
      _Bool 
# 63 "project/radare2/libr/debug/dsignal.c"
           siglistcb (void *p, const char *k, const char *v) {
 static char key[32] = "cfg.";
 RDebug *dbg = (RDebug *)p;
 int opt, mode = dbg->_mode;
 if (atoi (k) > 0) {
  
# 68 "project/radare2/libr/debug/dsignal.c" 3 4
 __builtin___strncpy_chk (
# 68 "project/radare2/libr/debug/dsignal.c"
 key + 4
# 68 "project/radare2/libr/debug/dsignal.c" 3 4
 , 
# 68 "project/radare2/libr/debug/dsignal.c"
...
# 68 "project/radare2/libr/debug/dsignal.c"
                         ;
  opt = sdb_num_get (dbg->sgnls, key, 0);
  if (opt) {
 ...
 return 
# 85 "project/radare2/libr/debug/dsignal.c" 3 4
       1
# 85 "project/radare2/libr/debug/dsignal.c"
           ;
}

static 
# 88 "project/radare2/libr/debug/dsignal.c" 3 4
      _Bool 
# 88 "project/radare2/libr/debug/dsignal.c"
           siglistjsoncb(void *p, const char *k, const char *v) {
 static char key[32] = "cfg.";
 RDebug *dbg = (RDebug *)p;
 int opt;
 if (atoi (k) > 0) {
  
# 93 "project/radare2/libr/debug/dsignal.c" 3 4
 __builtin___strncpy_chk (
# 93 "project/radare2/libr/debug/dsignal.c"
 key + 4
# 93 "project/radare2/libr/debug/dsignal.c" 3 4
 , 
# 93 "project/radare2/libr/debug/dsignal.c"
...
# 93 "project/radare2/libr/debug/dsignal.c"
                         ;
  opt = (int)sdb_num_get (dbg->sgnls, key, 0);
  pj_o (dbg->pj);
 ...
 return 
# 108 "project/radare2/libr/debug/dsignal.c" 3 4
       1
# 108 "project/radare2/libr/debug/dsignal.c"
           ;
}


# 111 "project/radare2/libr/debug/dsignal.c" 3 4
__attribute__((visibility("default"))) 
# 111 "project/radare2/libr/debug/dsignal.c"
     void r_debug_signal_list(RDebug *dbg, int mode) {
 dbg->_mode = mode;
 switch (mode) {
 case 0:
 case 1:
  sdb_foreach (dbg->sgnls, siglistcb, dbg);
  break;
 case 2:
  if (!dbg->pj) {
   return;
  ...
  pj_a (dbg->pj);
  sdb_foreach (dbg->sgnls, siglistjsoncb, dbg);
  pj_end (dbg->pj);
...
# 131 "project/radare2/libr/debug/dsignal.c" 3 4
__attribute__((visibility("default"))) 
# 131 "project/radare2/libr/debug/dsignal.c"
     int r_debug_signal_send(RDebug *dbg, int num) {
 return r_sandbox_kill (dbg->pid, num);
}


# 135 "project/radare2/libr/debug/dsignal.c" 3 4
__attribute__((visibility("default"))) 
# 135 "project/radare2/libr/debug/dsignal.c"
     void r_debug_signal_setup(RDebug *dbg, int num, int opt) {
 sdb_queryf (dbg->sgnls, "cfg.%d=%d", num, opt);
}


# 139 "project/radare2/libr/debug/dsignal.c" 3 4
__attribute__((visibility("default"))) 
# 139 "project/radare2/libr/debug/dsignal.c"
     int r_debug_signal_what(RDebug *dbg, int num) {
 char k[32];
 
# 141 "project/radare2/libr/debug/dsignal.c" 3 4
__builtin___snprintf_chk (
# 141 "project/radare2/libr/debug/dsignal.c"
k
# 141 "project/radare2/libr/debug/dsignal.c" 3 4
, 
# 141 "project/radare2/libr/debug/dsignal.c"
...
# 141 "project/radare2/libr/debug/dsignal.c"
                                       ;
 return sdb_num_get (dbg->sgnls, k, 0);
}


# 145 "project/radare2/libr/debug/dsignal.c" 3 4
__attribute__((visibility("default"))) 
# 145 "project/radare2/libr/debug/dsignal.c"
     int r_debug_signal_set(RDebug *dbg, int num, 
# 145 "project/radare2/libr/debug/dsignal.c" 3 4
                                                  unsigned long long 
# 145 "project/radare2/libr/debug/dsignal.c"
                                                       addr) {
...
# 152 "project/radare2/libr/debug/dsignal.c" 3 4
__attribute__((visibility("default"))) 
# 152 "project/radare2/libr/debug/dsignal.c"
     RList *r_debug_kill_list(RDebug *dbg) {
 if (dbg->h->kill_list) {
  return dbg->h->kill_list (dbg);
 }
 return 
# 156 "project/radare2/libr/debug/dsignal.c" 3 4
       ((void *)0)
# 156 "project/radare2/libr/debug/dsignal.c"
           ;
}


# 159 "project/radare2/libr/debug/dsignal.c" 3 4
__attribute__((visibility("default"))) 
# 159 "project/radare2/libr/debug/dsignal.c"
     int r_debug_kill_setup(RDebug *dbg, int sig, int action) {
 
# 160 "project/radare2/libr/debug/dsignal.c" 3 4
fprintf(__stderrp,
# 160 "project/radare2/libr/debug/dsignal.c"
...
# 160 "project/radare2/libr/debug/dsignal.c"
 ...
 return 
# 167 "project/radare2/libr/debug/dsignal.c" 3 4
       0
# 167 "project/radare2/libr/debug/dsignal.c"
            ;
}
