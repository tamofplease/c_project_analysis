# 0 "project/radare2/libr/debug/dreg.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/debug/dreg.c"
...
# 4 "project/radare2/libr/debug/dreg.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_debug.h" 1 3 4
# 5 "project/radare2/libr/debug/dreg.c" 2



__attribute__((visibility("default"))) 
# 8 "project/radare2/libr/debug/dreg.c"
     int r_debug_reg_sync(RDebug *dbg, int type, int write) {
 int i, n, size;
 if (!dbg || !dbg->reg || !dbg->h) {
  return 
# 11 "project/radare2/libr/debug/dreg.c" 3 4
        0
# 11 "project/radare2/libr/debug/dreg.c"
             ;
 }

 if (r_debug_is_dead (dbg)) {
  return 
# 15 "project/radare2/libr/debug/dreg.c" 3 4
        0
# 15 "project/radare2/libr/debug/dreg.c"
             ;
 }

 if (write && !dbg->h->reg_write) {
  return 
# 19 "project/radare2/libr/debug/dreg.c" 3 4
        0
# 19 "project/radare2/libr/debug/dreg.c"
             ;
 }
 if (!write && !dbg->h->reg_read) {
  return 
# 22 "project/radare2/libr/debug/dreg.c" 3 4
        0
# 22 "project/radare2/libr/debug/dreg.c"
             ;
 }
...
# 47 "project/radare2/libr/debug/dreg.c" 3 4
  unsigned char 
# 47 "project/radare2/libr/debug/dreg.c"
      *buf = r_reg_get_bytes (dbg->reg, i, &size);
   if (!buf || !dbg->h->reg_write (dbg, i, buf, size)) {
    if (i == R_REG_TYPE_GPR) {
     
# 50 "project/radare2/libr/debug/dreg.c" 3 4
    fprintf(__stderrp,
# 50 "project/radare2/libr/debug/dreg.c"
    "r_debug_reg: error writing " "registers %d to %d\n", i, dbg->tid
# 50 "project/radare2/libr/debug/dreg.c" 3 4
    )
                                          
# 51 "project/radare2/libr/debug/dreg.c"
                                         ;
    }
    if (type != R_REG_TYPE_ALL || i == R_REG_TYPE_GPR) {
     free (buf);
     return 
# 55 "project/radare2/libr/debug/dreg.c" 3 4
           0
# 55 "project/radare2/libr/debug/dreg.c"
                ;
    }
   }
   free (buf);
...
# 64 "project/radare2/libr/debug/dreg.c" 3 4
   unsigned char 
# 64 "project/radare2/libr/debug/dreg.c"
       *buf = calloc (1 + 1, bufsize);
    if (!buf) {
     return 
# 66 "project/radare2/libr/debug/dreg.c" 3 4
           0
# 66 "project/radare2/libr/debug/dreg.c"
                ;
    }
 ...
 return 
# 84 "project/radare2/libr/debug/dreg.c" 3 4
       1
# 84 "project/radare2/libr/debug/dreg.c"
           ;
}


# 87 "project/radare2/libr/debug/dreg.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 87 "project/radare2/libr/debug/dreg.c"
          r_debug_reg_list(RDebug *dbg, int type, int size, PJ *pj, int rad, const char *use_color) {
 int delta, cols, n = 0;
 const char *fmt, *fmt2, *kwhites;
 RPrint *pr = 
# 90 "project/radare2/libr/debug/dreg.c" 3 4
             ((void *)0)
# 90 "project/radare2/libr/debug/dreg.c"
                 ;
 int colwidth = 20;
 RListIter *iter;
 RRegItem *item;
...
# 95 "project/radare2/libr/debug/dreg.c" 3 4
unsigned long long 
# 95 "project/radare2/libr/debug/dreg.c"
     diff;
 char strvalue[256];
 
# 97 "project/radare2/libr/debug/dreg.c" 3 4
_Bool 
# 97 "project/radare2/libr/debug/dreg.c"
     isJson = (rad == 'j' || rad == 'J');
 if (isJson && !pj) {
  
# 99 "project/radare2/libr/debug/dreg.c" 3 4
 fprintf(__stderrp,
# 99 "project/radare2/libr/debug/dreg.c"
 "rad=='j' requires pj != NULL\n"
# 99 "project/radare2/libr/debug/dreg.c" 3 4
 )
# 99 "project/radare2/libr/debug/dreg.c"
                                           ;
  return 
# 100 "project/radare2/libr/debug/dreg.c" 3 4
        0
# 100 "project/radare2/libr/debug/dreg.c"
             ;
 }
 if (!dbg || !dbg->reg) {
  return 
# 103 "project/radare2/libr/debug/dreg.c" 3 4
        0
# 103 "project/radare2/libr/debug/dreg.c"
             ;
 }
 ...
 if (dbg->bits & 
# 112 "project/radare2/libr/debug/dreg.c" 3 4
                8
# 112 "project/radare2/libr/debug/dreg.c"
                             ) {
 ...
 int itmidx = -1;
 dbg->creg = 
# 137 "project/radare2/libr/debug/dreg.c" 3 4
            ((void *)0)
# 137 "project/radare2/libr/debug/dreg.c"
                ;
 head = r_reg_get_list (dbg->reg, type);
 if (!head) {
  return 
# 140 "project/radare2/libr/debug/dreg.c" 3 4
        0
# 140 "project/radare2/libr/debug/dreg.c"
             ;
 }
 if (rad == 1 || rad == '*') {
  dbg->cb_printf ("fs+%s\n", 
# 143 "project/radare2/libr/debug/dreg.c" 3 4
                            "registers"
# 143 "project/radare2/libr/debug/dreg.c"
                                                );
 }
 
# 145 "project/radare2/libr/debug/dreg.c" 3 4
if (
# 145 "project/radare2/libr/debug/dreg.c"
head
# 145 "project/radare2/libr/debug/dreg.c" 3 4
) for (
# 145 "project/radare2/libr/debug/dreg.c"
...
# 146 "project/radare2/libr/debug/dreg.c" 3 4
 unsigned long long 
# 146 "project/radare2/libr/debug/dreg.c"
      value;
  utX valueBig;
  if (type != -1) {
  ...
  if (dbg->q_regs) {
   if (!
# 158 "project/radare2/libr/debug/dreg.c" 3 4
       (!(
# 158 "project/radare2/libr/debug/dreg.c"
       dbg->q_regs
# 158 "project/radare2/libr/debug/dreg.c" 3 4
       ) || !(
# 158 "project/radare2/libr/debug/dreg.c"
...
# 162 "project/radare2/libr/debug/dreg.c" 3 4
   _Bool 
# 162 "project/radare2/libr/debug/dreg.c"
        found = 
# 162 "project/radare2/libr/debug/dreg.c" 3 4
                0
# 162 "project/radare2/libr/debug/dreg.c"
...
# 163 "project/radare2/libr/debug/dreg.c" 3 4
   if (
# 163 "project/radare2/libr/debug/dreg.c"
   q_reg
# 163 "project/radare2/libr/debug/dreg.c" 3 4
   ) for (
# 163 "project/radare2/libr/debug/dreg.c"
...
# 163 "project/radare2/libr/debug/dreg.c"
     ...
     if (!strcmp (item->name, q_name)) {
      found = 
# 165 "project/radare2/libr/debug/dreg.c" 3 4
             1
# 165 "project/radare2/libr/debug/dreg.c"
                 ;
      break;
     }
    }
  ...
  if (regSize < 80) {
   ...
   r_reg_arena_swap (dbg->reg, 
# 181 "project/radare2/libr/debug/dreg.c" 3 4
                              0
# 181 "project/radare2/libr/debug/dreg.c"
                                   );
   diff = r_reg_get_value (dbg->reg, item);
   r_reg_arena_swap (dbg->reg, 
# 183 "project/radare2/libr/debug/dreg.c" 3 4
                              0
# 183 "project/radare2/libr/debug/dreg.c"
                                   );
   delta = value - diff;
   if (isJson) {
    pj_kn (pj, item->name, value);
   } else {
    if (pr && pr->wide_offsets && dbg->bits & 
# 188 "project/radare2/libr/debug/dreg.c" 3 4
                                             8
# 188 "project/radare2/libr/debug/dreg.c"
                                                          ) {
     
# 189 "project/radare2/libr/debug/dreg.c" 3 4
    __builtin___snprintf_chk (
# 189 "project/radare2/libr/debug/dreg.c"
    strvalue
# 189 "project/radare2/libr/debug/dreg.c" 3 4
    , 
# 189 "project/radare2/libr/debug/dreg.c"
...
# 191 "project/radare2/libr/debug/dreg.c" 3 4
    __builtin___snprintf_chk (
# 191 "project/radare2/libr/debug/dreg.c"
    strvalue
# 191 "project/radare2/libr/debug/dreg.c" 3 4
    , 
# 191 "project/radare2/libr/debug/dreg.c"
...
# 198 "project/radare2/libr/debug/dreg.c" 3 4
    __builtin___snprintf_chk (
# 198 "project/radare2/libr/debug/dreg.c"
    strvalue
# 198 "project/radare2/libr/debug/dreg.c" 3 4
    , 
# 198 "project/radare2/libr/debug/dreg.c"
...
# 198 "project/radare2/libr/debug/dreg.c" 3 4
    "llx"
# 198 "project/radare2/libr/debug/dreg.c"
    "", valueBig.v80.High, valueBig.v80.Low
# 198 "project/radare2/libr/debug/dreg.c" 3 4
    )
# 198 "project/radare2/libr/debug/dreg.c"
                                                                                                      ;
...
# 201 "project/radare2/libr/debug/dreg.c" 3 4
    __builtin___snprintf_chk (
# 201 "project/radare2/libr/debug/dreg.c"
    strvalue
# 201 "project/radare2/libr/debug/dreg.c" 3 4
    , 
# 201 "project/radare2/libr/debug/dreg.c"
...
# 201 "project/radare2/libr/debug/dreg.c" 3 4
    "llx"
# 201 "project/radare2/libr/debug/dreg.c"
    "", valueBig.v96.High, valueBig.v96.Low
# 201 "project/radare2/libr/debug/dreg.c" 3 4
    )
# 201 "project/radare2/libr/debug/dreg.c"
                                                                                                      ;
...
# 204 "project/radare2/libr/debug/dreg.c" 3 4
    __builtin___snprintf_chk (
# 204 "project/radare2/libr/debug/dreg.c"
    strvalue
# 204 "project/radare2/libr/debug/dreg.c" 3 4
    , 
# 204 "project/radare2/libr/debug/dreg.c"
...
# 204 "project/radare2/libr/debug/dreg.c" 3 4
    "llx"
# 204 "project/radare2/libr/debug/dreg.c"
    "", valueBig.v128.High, valueBig.v128.Low
# 204 "project/radare2/libr/debug/dreg.c" 3 4
    )
# 204 "project/radare2/libr/debug/dreg.c"
                                                                                                                 ;
...
# 207 "project/radare2/libr/debug/dreg.c" 3 4
    __builtin___snprintf_chk (
# 207 "project/radare2/libr/debug/dreg.c"
    strvalue
# 207 "project/radare2/libr/debug/dreg.c" 3 4
    , 
# 207 "project/radare2/libr/debug/dreg.c"
...
# 208 "project/radare2/libr/debug/dreg.c"
                                                                                                     ;
     break;
    default:
     
# 211 "project/radare2/libr/debug/dreg.c" 3 4
    __builtin___snprintf_chk (
# 211 "project/radare2/libr/debug/dreg.c"
    strvalue
# 211 "project/radare2/libr/debug/dreg.c" 3 4
    , 
# 211 "project/radare2/libr/debug/dreg.c"
   ...
   case '=':
    {
     ...
     if (highlight) {
      a = 
# 243 "project/radare2/libr/debug/dreg.c" 3 4
         "\x1b[7m"
# 243 "project/radare2/libr/debug/dreg.c"
                     ;
      b = 
# 244 "project/radare2/libr/debug/dreg.c" 3 4
         "\x1b[27m"
# 244 "project/radare2/libr/debug/dreg.c"
                           ;
      dbg->creg = item->name;
     }
     
# 247 "project/radare2/libr/debug/dreg.c" 3 4
    __builtin___strcpy_chk (
# 247 "project/radare2/libr/debug/dreg.c"
    whites
# 247 "project/radare2/libr/debug/dreg.c" 3 4
    , 
# 247 "project/radare2/libr/debug/dreg.c"
...
# 251 "project/radare2/libr/debug/dreg.c" 3 4
    __builtin___snprintf_chk (
# 251 "project/radare2/libr/debug/dreg.c"
    content
# 251 "project/radare2/libr/debug/dreg.c" 3 4
    , 
# 251 "project/radare2/libr/debug/dreg.c"
...
# 252 "project/radare2/libr/debug/dreg.c"
                                             ;
...
# 257 "project/radare2/libr/debug/dreg.c" 3 4
    __builtin___memset_chk (
# 257 "project/radare2/libr/debug/dreg.c"
    whites
# 257 "project/radare2/libr/debug/dreg.c" 3 4
    , 
# 257 "project/radare2/libr/debug/dreg.c"
...
# 257 "project/radare2/libr/debug/dreg.c"
     ...
     if (highlight) {
      dbg->cb_printf (
# 262 "project/radare2/libr/debug/dreg.c" 3 4
                     "\x1b[27m"
# 262 "project/radare2/libr/debug/dreg.c"
                                       );
     }
     if (delta && use_color) {
      dbg->cb_printf (
# 265 "project/radare2/libr/debug/dreg.c" 3 4
                     "\x1b[0m"
# 265 "project/radare2/libr/debug/dreg.c"
                                );
     }
    }
    break;
...
# 273 "project/radare2/libr/debug/dreg.c" 3 4
    __builtin___snprintf_chk (
# 273 "project/radare2/libr/debug/dreg.c"
    woot
# 273 "project/radare2/libr/debug/dreg.c" 3 4
    , 
# 273 "project/radare2/libr/debug/dreg.c"
...
# 274 "project/radare2/libr/debug/dreg.c"
                                                  ;
...
# 281 "project/radare2/libr/debug/dreg.c" 3 4
                                               "\x1b[0m"
# 281 "project/radare2/libr/debug/dreg.c"
                                                          "\n");
    } else {
     dbg->cb_printf (fmt, item->name, strvalue, "\n");
    }
...
# 301 "project/radare2/libr/debug/dreg.c" 3 4
__attribute__((visibility("default"))) 
# 301 "project/radare2/libr/debug/dreg.c"
     int r_debug_reg_set(struct r_debug_t *dbg, const char *name, 
# 301 "project/radare2/libr/debug/dreg.c" 3 4
                                                                  unsigned long long 
# 301 "project/radare2/libr/debug/dreg.c"
                                                                       num) {
 ...
 if (!dbg || !dbg->reg) {
  return 
# 305 "project/radare2/libr/debug/dreg.c" 3 4
        0
# 305 "project/radare2/libr/debug/dreg.c"
             ;
 }
 if (role != -1) {
...
# 313 "project/radare2/libr/debug/dreg.c" 3 4
                                        1
# 313 "project/radare2/libr/debug/dreg.c"
                                            );
 }
 return (ri != 
# 315 "project/radare2/libr/debug/dreg.c" 3 4
              ((void *)0)
# 315 "project/radare2/libr/debug/dreg.c"
                  );
}


# 318 "project/radare2/libr/debug/dreg.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 318 "project/radare2/libr/debug/dreg.c"
          r_debug_reg_get(RDebug *dbg, const char *name) {

 return r_debug_reg_get_err (dbg, name, 
# 320 "project/radare2/libr/debug/dreg.c" 3 4
                                       ((void *)0)
# 320 "project/radare2/libr/debug/dreg.c"
                                           , 
# 320 "project/radare2/libr/debug/dreg.c" 3 4
                                             ((void *)0)
# 320 "project/radare2/libr/debug/dreg.c"
...
# 323 "project/radare2/libr/debug/dreg.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 323 "project/radare2/libr/debug/dreg.c"
          r_debug_reg_get_err(RDebug *dbg, const char *name, int *err, utX *value) {
 RRegItem *ri = 
# 324 "project/radare2/libr/debug/dreg.c" 3 4
               ((void *)0)
# 324 "project/radare2/libr/debug/dreg.c"
                   ;
 
# 325 "project/radare2/libr/debug/dreg.c" 3 4
unsigned long long 
# 325 "project/radare2/libr/debug/dreg.c"
     ret = 0LL;
 int role = r_reg_get_name_idx (name);
 ...
 if (!dbg || !dbg->reg) {
  ...
  return 
# 335 "project/radare2/libr/debug/dreg.c" 3 4
        0xFFFFFFFFFFFFFFFFULL
# 335 "project/radare2/libr/debug/dreg.c"
                ;
 }
 if (role != -1) {
  name = r_reg_get_name (dbg->reg, role);
...
# 340 "project/radare2/libr/debug/dreg.c" 3 4
  fprintf(__stderrp,
# 340 "project/radare2/libr/debug/dreg.c"
  "No debug register profile defined for '%s'.\n", pname
# 340 "project/radare2/libr/debug/dreg.c" 3 4
  )
# 340 "project/radare2/libr/debug/dreg.c"
                                                                  ;
   ...
   return 
# 344 "project/radare2/libr/debug/dreg.c" 3 4
         0xFFFFFFFFFFFFFFFFULL
# 344 "project/radare2/libr/debug/dreg.c"
                 ;
  }
 }
 ri = r_reg_get (dbg->reg, name, R_REG_TYPE_ALL);
 if (ri) {
  r_debug_reg_sync (dbg, R_REG_TYPE_ALL, 
# 349 "project/radare2/libr/debug/dreg.c" 3 4
                                        0
# 349 "project/radare2/libr/debug/dreg.c"
                                             );
  if (value && ri->size > 64) {
   if (err) {
    *err = ri->size;
...
# 367 "project/radare2/libr/debug/dreg.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 367 "project/radare2/libr/debug/dreg.c"
          r_debug_num_callback(RNum *userptr, const char *str, int *ok) {
 RDebug *dbg = (RDebug *)userptr;

 return r_debug_reg_get_err (dbg, str, ok, 
# 370 "project/radare2/libr/debug/dreg.c" 3 4
                                          ((void *)0)
# 370 "project/radare2/libr/debug/dreg.c"
                                              );
}
