# 0 "project/radare2/libr/debug/dmap.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/debug/dmap.c" 2




# 7 "project/radare2/libr/debug/dmap.c"
...
static void print_debug_map_line(RDebug *dbg, RDebugMap *map, 
# 28 "project/radare2/libr/debug/dmap.c" 3 4
                                                             unsigned long long 
# 28 "project/radare2/libr/debug/dmap.c"
                                                                  addr, const char *input) {
 char humansz[8];
 if (input[0] == 'q') {
  char *name = (map->name && *map->name)
   ? r_str_newf ("%s.%s", map->name, r_str_rwx_i (map->perm))
   : r_str_newf ("%08" 
# 33 "project/radare2/libr/debug/dmap.c" 3 4
                      "llx" 
# 33 "project/radare2/libr/debug/dmap.c"
                              ".%s", map->addr, r_str_rwx_i (map->perm));
  r_name_filter (name, 0);
  r_num_units (humansz, sizeof (humansz), map->addr_end - map->addr);
  dbg->cb_printf ("0x%016" 
# 36 "project/radare2/libr/debug/dmap.c" 3 4
                          "llx" 
# 36 "project/radare2/libr/debug/dmap.c"
                                  " - 0x%016" 
# 36 "project/radare2/libr/debug/dmap.c" 3 4
                                              "llx" 
# 36 "project/radare2/libr/debug/dmap.c"
  ...
  const char *fmtstr = dbg->bits & 
# 45 "project/radare2/libr/debug/dmap.c" 3 4
                                  8
   
# 46 "project/radare2/libr/debug/dmap.c"
  ? "0x%016" 
# 46 "project/radare2/libr/debug/dmap.c" 3 4
             "llx" 
# 46 "project/radare2/libr/debug/dmap.c"
                     " - 0x%016" 
# 46 "project/radare2/libr/debug/dmap.c" 3 4
...
# 46 "project/radare2/libr/debug/dmap.c"
                                         " %c %s %6s %c %s %s %s%s%s\n"
   : "0x%08" 
# 47 "project/radare2/libr/debug/dmap.c" 3 4
            "llx" 
# 47 "project/radare2/libr/debug/dmap.c"
                    " - 0x%08" 
# 47 "project/radare2/libr/debug/dmap.c" 3 4
                               "llx" 
# 47 "project/radare2/libr/debug/dmap.c"
...
# 50 "project/radare2/libr/debug/dmap.c" 3 4
                                                            ((void *)0)
# 50 "project/radare2/libr/debug/dmap.c"
                                                                ;
  if (!flagname) {
   flagname = "";
  } else if (map->name) {
...
# 79 "project/radare2/libr/debug/dmap.c" 3 4
__attribute__((visibility("default"))) 
# 79 "project/radare2/libr/debug/dmap.c"
     void r_debug_map_list(RDebug *dbg, 
# 79 "project/radare2/libr/debug/dmap.c" 3 4
                                        unsigned long long 
# 79 "project/radare2/libr/debug/dmap.c"
                                             addr, const char *input) {
 ...
 RDebugMap *map;
 PJ *pj = 
# 83 "project/radare2/libr/debug/dmap.c" 3 4
         ((void *)0)
# 83 "project/radare2/libr/debug/dmap.c"
             ;
 if (!dbg) {
  return;
 }
...
# 108 "project/radare2/libr/debug/dmap.c" 3 4
 if (
# 108 "project/radare2/libr/debug/dmap.c"
 maps
# 108 "project/radare2/libr/debug/dmap.c" 3 4
 ) for (
# 108 "project/radare2/libr/debug/dmap.c"
   ...
   case '*':
    {
     char *name = (map->name && *map->name)
      ? r_str_newf ("%s.%s", map->name, r_str_rwx_i (map->perm))
      : r_str_newf ("%08" 
# 117 "project/radare2/libr/debug/dmap.c" 3 4
                         "llx" 
# 117 "project/radare2/libr/debug/dmap.c"
                                 ".%s", map->addr, r_str_rwx_i (map->perm));
     r_name_filter (name, 0);
     dbg->cb_printf ("f map.%s 0x%08" 
# 119 "project/radare2/libr/debug/dmap.c" 3 4
                                     "llx" 
# 119 "project/radare2/libr/debug/dmap.c"
                                             " 0x%08" 
# 119 "project/radare2/libr/debug/dmap.c" 3 4
                                                      "llx" 
# 119 "project/radare2/libr/debug/dmap.c"
...
static int findMinMax(RList *maps, 
# 170 "project/radare2/libr/debug/dmap.c" 3 4
                                  unsigned long long 
# 170 "project/radare2/libr/debug/dmap.c"
                                       *min, 
# 170 "project/radare2/libr/debug/dmap.c" 3 4
                                             unsigned long long 
# 170 "project/radare2/libr/debug/dmap.c"
                                                  *max, int skip, int width) {
 RDebugMap *map;
 RListIter *iter;
 *min = 
# 173 "project/radare2/libr/debug/dmap.c" 3 4
       0xFFFFFFFFFFFFFFFFULL
# 173 "project/radare2/libr/debug/dmap.c"
               ;
 *max = 0;
 
# 175 "project/radare2/libr/debug/dmap.c" 3 4
if (
# 175 "project/radare2/libr/debug/dmap.c"
maps
# 175 "project/radare2/libr/debug/dmap.c" 3 4
) for (
# 175 "project/radare2/libr/debug/dmap.c"
...
static void print_debug_maps_ascii_art(RDebug *dbg, RList *maps, 
# 190 "project/radare2/libr/debug/dmap.c" 3 4
                                                                unsigned long long 
# 190 "project/radare2/libr/debug/dmap.c"
                                                                     addr, int colors) {
 
# 191 "project/radare2/libr/debug/dmap.c" 3 4
unsigned long long 
# 191 "project/radare2/libr/debug/dmap.c"
     mul;
 
# 192 "project/radare2/libr/debug/dmap.c" 3 4
unsigned long long 
# 192 "project/radare2/libr/debug/dmap.c"
     min = -1, max = 0;
 int width = r_cons_get_size (
# 193 "project/radare2/libr/debug/dmap.c" 3 4
                             ((void *)0)
# 193 "project/radare2/libr/debug/dmap.c"
                                 ) - 90;
 RListIter *iter;
 RDebugMap *map;
...
# 202 "project/radare2/libr/debug/dmap.c" 3 4
unsigned long long 
# 202 "project/radare2/libr/debug/dmap.c"
     last = min;
 if (min != -1 && mul != 0) {
...
# 209 "project/radare2/libr/debug/dmap.c" 3 4
 if (
# 209 "project/radare2/libr/debug/dmap.c"
 maps
# 209 "project/radare2/libr/debug/dmap.c" 3 4
 ) for (
# 209 "project/radare2/libr/debug/dmap.c"
...
# 209 "project/radare2/libr/debug/dmap.c"
   ...
   if (colors) {
    color_suffix = 
# 212 "project/radare2/libr/debug/dmap.c" 3 4
                  "\x1b[0m"
# 212 "project/radare2/libr/debug/dmap.c"
                             ;
   ...
   if ((map->addr - last) > 
# 227 "project/radare2/libr/debug/dmap.c" 3 4
                           0xFFFFFFFFU
# 227 "project/radare2/libr/debug/dmap.c"
                                   ) {
    mul = findMinMax (maps, &min, &max, skip, width);
   }
   skip++;
   fmtstr = dbg->bits & 
# 231 "project/radare2/libr/debug/dmap.c" 3 4
                       8
    
# 232 "project/radare2/libr/debug/dmap.c"
   ? "map %4.8s %c %s0x%016" 
# 232 "project/radare2/libr/debug/dmap.c" 3 4
                             "llx" 
# 232 "project/radare2/libr/debug/dmap.c"
                                     "%s |"
    : "map %4.8s %c %s0x%08" 
# 233 "project/radare2/libr/debug/dmap.c" 3 4
                            "llx" 
# 233 "project/radare2/libr/debug/dmap.c"
                                    "%s |";
...
# 240 "project/radare2/libr/debug/dmap.c" 3 4
   unsigned long long 
# 240 "project/radare2/libr/debug/dmap.c"
        pos = min + (col * mul);
    
# 241 "project/radare2/libr/debug/dmap.c" 3 4
   unsigned long long 
# 241 "project/radare2/libr/debug/dmap.c"
        npos = min + ((col + 1) * mul);
   ...
   fmtstr = dbg->bits & 
# 248 "project/radare2/libr/debug/dmap.c" 3 4
                       8 
# 248 "project/radare2/libr/debug/dmap.c"
                                     ?
    "| %s0x%016" 
# 249 "project/radare2/libr/debug/dmap.c" 3 4
                "llx" 
# 249 "project/radare2/libr/debug/dmap.c"
                        "%s %s %s\n" :
    "| %s0x%08" 
# 250 "project/radare2/libr/debug/dmap.c" 3 4
               "llx" 
# 250 "project/radare2/libr/debug/dmap.c"
                       "%s %s %s\n";
...
# 258 "project/radare2/libr/debug/dmap.c" 3 4
__attribute__((visibility("default"))) 
# 258 "project/radare2/libr/debug/dmap.c"
     void r_debug_map_list_visual(RDebug *dbg, 
# 258 "project/radare2/libr/debug/dmap.c" 3 4
                                               unsigned long long 
# 258 "project/radare2/libr/debug/dmap.c"
                                                    addr, const char *input, int colors) {
 if (dbg) {
  int i;
  for (i = 0; i < 2; i++) {
   RList *maps = (i == 0) ? dbg->maps : dbg->maps_user;
...
# 268 "project/radare2/libr/debug/dmap.c" 3 4
    if (
# 268 "project/radare2/libr/debug/dmap.c"
    maps
# 268 "project/radare2/libr/debug/dmap.c" 3 4
    ) for (
# 268 "project/radare2/libr/debug/dmap.c"
...
# 281 "project/radare2/libr/debug/dmap.c" 3 4
__attribute__((visibility("default"))) 
# 281 "project/radare2/libr/debug/dmap.c"
     RDebugMap *r_debug_map_new(char *name, 
# 281 "project/radare2/libr/debug/dmap.c" 3 4
                                            unsigned long long 
# 281 "project/radare2/libr/debug/dmap.c"
                                                 addr, 
# 281 "project/radare2/libr/debug/dmap.c" 3 4
                                                       unsigned long long 
# 281 "project/radare2/libr/debug/dmap.c"
                                                            addr_end, int perm, int user) {
 RDebugMap *map;

 if (!name || addr > addr_end) {
  
# 285 "project/radare2/libr/debug/dmap.c" 3 4
 fprintf(__stderrp,
# 285 "project/radare2/libr/debug/dmap.c"
 "r_debug_map_new: error (			%" 
# 285 "project/radare2/libr/debug/dmap.c" 3 4
 "llx" 
# 285 "project/radare2/libr/debug/dmap.c"
 ">%" 
...
# 286 "project/radare2/libr/debug/dmap.c"
                                                ;
  return 
# 287 "project/radare2/libr/debug/dmap.c" 3 4
        ((void *)0)
# 287 "project/radare2/libr/debug/dmap.c"
            ;
 }
 map = 
# 289 "project/radare2/libr/debug/dmap.c" 3 4
      (
# 289 "project/radare2/libr/debug/dmap.c"
      RDebugMap
# 289 "project/radare2/libr/debug/dmap.c" 3 4
      *)calloc(1,sizeof(
# 289 "project/radare2/libr/debug/dmap.c"
...
# 289 "project/radare2/libr/debug/dmap.c"
 ...
 if (!map) {
  return 
# 291 "project/radare2/libr/debug/dmap.c" 3 4
        ((void *)0)
# 291 "project/radare2/libr/debug/dmap.c"
            ;
 }
...
# 302 "project/radare2/libr/debug/dmap.c" 3 4
__attribute__((visibility("default"))) 
# 302 "project/radare2/libr/debug/dmap.c"
     RList *r_debug_modules_list(RDebug *dbg) {
 return (dbg && dbg->h && dbg->h->modules_get)?
  dbg->h->modules_get (dbg): 
# 304 "project/radare2/libr/debug/dmap.c" 3 4
                            ((void *)0)
# 304 "project/radare2/libr/debug/dmap.c"
                                ;
}


# 307 "project/radare2/libr/debug/dmap.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 307 "project/radare2/libr/debug/dmap.c"
          r_debug_map_sync(RDebug *dbg) {
 
# 308 "project/radare2/libr/debug/dmap.c" 3 4
_Bool 
# 308 "project/radare2/libr/debug/dmap.c"
     ret = 
# 308 "project/radare2/libr/debug/dmap.c" 3 4
           0
# 308 "project/radare2/libr/debug/dmap.c"
 ...
 if (dbg && dbg->h && dbg->h->map_get) {
  ...
  if (newmaps) {
   ...
   dbg->maps = newmaps;
   ret = 
# 314 "project/radare2/libr/debug/dmap.c" 3 4
        1
# 314 "project/radare2/libr/debug/dmap.c"
            ;
  }
 }
 return ret;
...
# 320 "project/radare2/libr/debug/dmap.c" 3 4
__attribute__((visibility("default"))) 
# 320 "project/radare2/libr/debug/dmap.c"
     RDebugMap* r_debug_map_alloc(RDebug *dbg, 
# 320 "project/radare2/libr/debug/dmap.c" 3 4
                                               unsigned long long 
# 320 "project/radare2/libr/debug/dmap.c"
                                                    addr, int size, 
...
# 320 "project/radare2/libr/debug/dmap.c"
                                                                         thp) {
 RDebugMap *map = 
# 321 "project/radare2/libr/debug/dmap.c" 3 4
                 ((void *)0)
# 321 "project/radare2/libr/debug/dmap.c"
                     ;
...
# 328 "project/radare2/libr/debug/dmap.c" 3 4
__attribute__((visibility("default"))) 
# 328 "project/radare2/libr/debug/dmap.c"
     int r_debug_map_dealloc(RDebug *dbg, RDebugMap *map) {
 
# 329 "project/radare2/libr/debug/dmap.c" 3 4
_Bool 
# 329 "project/radare2/libr/debug/dmap.c"
     ret = 
# 329 "project/radare2/libr/debug/dmap.c" 3 4
           0
# 329 "project/radare2/libr/debug/dmap.c"
...
# 330 "project/radare2/libr/debug/dmap.c" 3 4
unsigned long long 
# 330 "project/radare2/libr/debug/dmap.c"
     addr = map->addr;
 if (dbg && dbg->h && dbg->h->map_dealloc) {
  if (dbg->h->map_dealloc (dbg, addr, map->size)) {
   ret = 
# 333 "project/radare2/libr/debug/dmap.c" 3 4
        1
# 333 "project/radare2/libr/debug/dmap.c"
            ;
  }
 }
 return (int)ret;
...
# 339 "project/radare2/libr/debug/dmap.c" 3 4
__attribute__((visibility("default"))) 
# 339 "project/radare2/libr/debug/dmap.c"
     RDebugMap *r_debug_map_get(RDebug *dbg, 
# 339 "project/radare2/libr/debug/dmap.c" 3 4
                                             unsigned long long 
# 339 "project/radare2/libr/debug/dmap.c"
                                                  addr) {
 RDebugMap *map, *ret = 
# 340 "project/radare2/libr/debug/dmap.c" 3 4
                       ((void *)0)
# 340 "project/radare2/libr/debug/dmap.c"
                           ;
 RListIter *iter;
 
# 342 "project/radare2/libr/debug/dmap.c" 3 4
if (
# 342 "project/radare2/libr/debug/dmap.c"
dbg->maps
# 342 "project/radare2/libr/debug/dmap.c" 3 4
) for (
# 342 "project/radare2/libr/debug/dmap.c"
...
# 351 "project/radare2/libr/debug/dmap.c" 3 4
__attribute__((visibility("default"))) 
# 351 "project/radare2/libr/debug/dmap.c"
     void r_debug_map_free(RDebugMap *map) {
 free (map->name);
 free (map->file);
 free (map);
}
...
# 357 "project/radare2/libr/debug/dmap.c" 3 4
__attribute__((visibility("default"))) 
# 357 "project/radare2/libr/debug/dmap.c"
     RList *r_debug_map_list_new(void) {
 RList *list = r_list_new ();
 if (!list) {
  return 
# 360 "project/radare2/libr/debug/dmap.c" 3 4
        ((void *)0)
# 360 "project/radare2/libr/debug/dmap.c"
            ;
 }
