# 0 "project/radare2/libr/debug/arg.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/debug/arg.c"
...
# 4 "project/radare2/libr/debug/arg.c" 2

__attribute__((visibility("default"))) unsigned long long 
# 5 "project/radare2/libr/debug/arg.c"
          r_debug_arg_get(RDebug *dbg, const char *cc, int num) {
 
# 6 "project/radare2/libr/debug/arg.c" 3 4
do { if (!(
# 6 "project/radare2/libr/debug/arg.c"
dbg
# 6 "project/radare2/libr/debug/arg.c" 3 4
...
"dbg"
# 6 "project/radare2/libr/debug/arg.c" 3 4
, 6); return (0xFFFFFFFFFFFFFFFFULL); } } while (0)
# 6 "project/radare2/libr/debug/arg.c"
                                    ;
 if (!cc) {
 ...
 if (dbg->anal) {
  if (!
# 11 "project/radare2/libr/debug/arg.c" 3 4
      (!(
# 11 "project/radare2/libr/debug/arg.c"
      cc
# 11 "project/radare2/libr/debug/arg.c" 3 4
      ) || !*(
# 11 "project/radare2/libr/debug/arg.c"
...
# 13 "project/radare2/libr/debug/arg.c" 3 4
   unsigned long long 
# 13 "project/radare2/libr/debug/arg.c"
        sp = r_debug_reg_get (dbg, "SP");
    if (dbg->bits == 64) {
     
# 15 "project/radare2/libr/debug/arg.c" 3 4
    unsigned long long 
# 15 "project/radare2/libr/debug/arg.c"
         n64;
     sp += 8;
     sp += 8 * num;
     dbg->iob.read_at (dbg->iob.io, sp, (
# 18 "project/radare2/libr/debug/arg.c" 3 4
                                        unsigned char
# 18 "project/radare2/libr/debug/arg.c"
                                           *)&n64, sizeof(
# 18 "project/radare2/libr/debug/arg.c" 3 4
                                                          unsigned long long
# 18 "project/radare2/libr/debug/arg.c"
     ...
     return (
# 20 "project/radare2/libr/debug/arg.c" 3 4
            unsigned long long
# 20 "project/radare2/libr/debug/arg.c"
                )n64;
    } else {
     sp += 4;
     sp += 4 * num;
     
# 24 "project/radare2/libr/debug/arg.c" 3 4
    unsigned int 
# 24 "project/radare2/libr/debug/arg.c"
         n32;
     dbg->iob.read_at (dbg->iob.io, sp, (
# 25 "project/radare2/libr/debug/arg.c" 3 4
                                        unsigned char
# 25 "project/radare2/libr/debug/arg.c"
                                           *)&n32, sizeof(
# 25 "project/radare2/libr/debug/arg.c" 3 4
                                                          unsigned int
# 25 "project/radare2/libr/debug/arg.c"
     ...
     return (
# 27 "project/radare2/libr/debug/arg.c" 3 4
            unsigned long long
# 27 "project/radare2/libr/debug/arg.c"
                )n32;
    }
   }
...
# 37 "project/radare2/libr/debug/arg.c" 3 4
__builtin___snprintf_chk (
# 37 "project/radare2/libr/debug/arg.c"
reg
# 37 "project/radare2/libr/debug/arg.c" 3 4
, 
# 37 "project/radare2/libr/debug/arg.c"
...
# 41 "project/radare2/libr/debug/arg.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 41 "project/radare2/libr/debug/arg.c"
          r_debug_arg_set(RDebug *dbg, const char *cc, int num, 
# 41 "project/radare2/libr/debug/arg.c" 3 4
                                                                unsigned long long 
# 41 "project/radare2/libr/debug/arg.c"
                                                                     val) {
 
# 42 "project/radare2/libr/debug/arg.c" 3 4
do { if (!(
# 42 "project/radare2/libr/debug/arg.c"
dbg
# 42 "project/radare2/libr/debug/arg.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 42 "project/radare2/libr/debug/arg.c"
...
# 42 "project/radare2/libr/debug/arg.c"
                                 ;
 if (!
# 43 "project/radare2/libr/debug/arg.c" 3 4
     (!(
# 43 "project/radare2/libr/debug/arg.c"
     cc
# 43 "project/radare2/libr/debug/arg.c" 3 4
     ) || !*(
# 43 "project/radare2/libr/debug/arg.c"
...
# 43 "project/radare2/libr/debug/arg.c"
 ...
 if (rn) {
  ...
  return 
# 49 "project/radare2/libr/debug/arg.c" 3 4
        1
# 49 "project/radare2/libr/debug/arg.c"
            ;
 }
 char reg[32];
 
# 52 "project/radare2/libr/debug/arg.c" 3 4
__builtin___snprintf_chk (
# 52 "project/radare2/libr/debug/arg.c"
reg
# 52 "project/radare2/libr/debug/arg.c" 3 4
, 
# 52 "project/radare2/libr/debug/arg.c"
...
# 52 "project/radare2/libr/debug/arg.c"
 ...
 return 
# 54 "project/radare2/libr/debug/arg.c" 3 4
       1
# 54 "project/radare2/libr/debug/arg.c"
           ;
}
