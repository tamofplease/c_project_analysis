# 0 "project/radare2/libr/debug/pid.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/debug/pid.c"
...
# 4 "project/radare2/libr/debug/pid.c" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/debug/pid.c"
     RDebugPid *r_debug_pid_new(const char *path, int pid, int uid, char status, 
# 5 "project/radare2/libr/debug/pid.c" 3 4
                                                                                 unsigned long long 
# 5 "project/radare2/libr/debug/pid.c"
                                                                                      pc) {
 RDebugPid *p = 
# 6 "project/radare2/libr/debug/pid.c" 3 4
               (
# 6 "project/radare2/libr/debug/pid.c"
               RDebugPid
# 6 "project/radare2/libr/debug/pid.c" 3 4
               *)calloc(1,sizeof(
# 6 "project/radare2/libr/debug/pid.c"
...
# 6 "project/radare2/libr/debug/pid.c"
 ...
 if (!p) {
  return 
# 8 "project/radare2/libr/debug/pid.c" 3 4
        ((void *)0)
# 8 "project/radare2/libr/debug/pid.c"
            ;
 }
 ...
 p->status = status;
 p->runnable = 
# 14 "project/radare2/libr/debug/pid.c" 3 4
              1
# 14 "project/radare2/libr/debug/pid.c"
                  ;
 p->pc = pc;
 return p;
}
...
# 19 "project/radare2/libr/debug/pid.c" 3 4
__attribute__((visibility("default"))) 
# 19 "project/radare2/libr/debug/pid.c"
     RDebugPid *r_debug_pid_free(RDebugPid *pid) {
 if (pid) {
  free (pid->path);
  free (pid);
 }
 return 
# 24 "project/radare2/libr/debug/pid.c" 3 4
       ((void *)0)
# 24 "project/radare2/libr/debug/pid.c"
           ;
}


# 27 "project/radare2/libr/debug/pid.c" 3 4
__attribute__((visibility("default"))) 
# 27 "project/radare2/libr/debug/pid.c"
     RList *r_debug_pids(RDebug *dbg, int pid) {
 if (dbg && dbg->h && dbg->h->pids) {
  return dbg->h->pids (dbg, pid);
 }
 return 
# 31 "project/radare2/libr/debug/pid.c" 3 4
       ((void *)0)
# 31 "project/radare2/libr/debug/pid.c"
           ;
}



# 35 "project/radare2/libr/debug/pid.c" 3 4
__attribute__((visibility("default"))) 
# 35 "project/radare2/libr/debug/pid.c"
     int r_debug_pid_list(RDebug *dbg, int pid, char fmt) {
 RList *list;
 RListIter *iter;
 RDebugPid *p;
 if (dbg && dbg->h && dbg->h->pids) {
  list = dbg->h->pids (dbg, 
# 40 "project/radare2/libr/debug/pid.c" 3 4
                           (((
# 40 "project/radare2/libr/debug/pid.c"
                           0
# 40 "project/radare2/libr/debug/pid.c" 3 4
                           )>(
# 40 "project/radare2/libr/debug/pid.c"
...
# 40 "project/radare2/libr/debug/pid.c"
  ...
  if (!list) {
   return 
# 42 "project/radare2/libr/debug/pid.c" 3 4
         0
# 42 "project/radare2/libr/debug/pid.c"
              ;
  }
  PJ *j = pj_new ();
  pj_a (j);
  
# 46 "project/radare2/libr/debug/pid.c" 3 4
 if (
# 46 "project/radare2/libr/debug/pid.c"
 list
# 46 "project/radare2/libr/debug/pid.c" 3 4
 ) for (
# 46 "project/radare2/libr/debug/pid.c"
...
# 46 "project/radare2/libr/debug/pid.c"
 ...
 return 
# 72 "project/radare2/libr/debug/pid.c" 3 4
       0
# 72 "project/radare2/libr/debug/pid.c"
            ;
}


# 75 "project/radare2/libr/debug/pid.c" 3 4
__attribute__((visibility("default"))) 
# 75 "project/radare2/libr/debug/pid.c"
     int r_debug_thread_list(RDebug *dbg, int pid, char fmt) {
 RList *list;
 RListIter *iter;
 RDebugPid *p;
 RAnalFunction *fcn = 
# 79 "project/radare2/libr/debug/pid.c" 3 4
                     ((void *)0)
# 79 "project/radare2/libr/debug/pid.c"
                         ;
 RDebugMap *map = 
# 80 "project/radare2/libr/debug/pid.c" 3 4
                 ((void *)0)
# 80 "project/radare2/libr/debug/pid.c"
                     ;
 RStrBuf *path = 
# 81 "project/radare2/libr/debug/pid.c" 3 4
                ((void *)0)
# 81 "project/radare2/libr/debug/pid.c"
                    ;
 if (pid == -1) {
  return 
# 83 "project/radare2/libr/debug/pid.c" 3 4
        0
# 83 "project/radare2/libr/debug/pid.c"
             ;
 }
 if (dbg && dbg->h && dbg->h->threads) {
  ...
  if (!list) {
   return 
# 88 "project/radare2/libr/debug/pid.c" 3 4
         0
# 88 "project/radare2/libr/debug/pid.c"
              ;
  }
  PJ *j = pj_new ();
  pj_a (j);
  
# 92 "project/radare2/libr/debug/pid.c" 3 4
 if (
# 92 "project/radare2/libr/debug/pid.c"
 list
# 92 "project/radare2/libr/debug/pid.c" 3 4
 ) for (
# 92 "project/radare2/libr/debug/pid.c"
...
# 92 "project/radare2/libr/debug/pid.c"
   ...
   if (p->pc != 0) {
    ...
    r_strbuf_appendf (path, "(0x%" 
# 100 "project/radare2/libr/debug/pid.c" 3 4
                                  "llx" 
# 100 "project/radare2/libr/debug/pid.c"
                                          ")", p->pc);

    fcn = r_anal_get_fcn_in (dbg->anal, p->pc, 0);
    if (fcn) {
     r_strbuf_appendf (path, " in %s+0x%" 
# 104 "project/radare2/libr/debug/pid.c" 3 4
                                         "llx"
# 104 "project/radare2/libr/debug/pid.c"
                                                , fcn->name, (p->pc - fcn->addr));
    }
   }
   switch (fmt) {
   case 'j':
 ...
 return 
# 131 "project/radare2/libr/debug/pid.c" 3 4
       0
# 131 "project/radare2/libr/debug/pid.c"
            ;
}



# 135 "project/radare2/libr/debug/pid.c" 3 4
__attribute__((visibility("default"))) 
# 135 "project/radare2/libr/debug/pid.c"
     int r_debug_pid_parent(RDebugPid *pid) {

 return 0;
}
# 159 "project/radare2/libr/debug/pid.c"

# 159 "project/radare2/libr/debug/pid.c" 3 4
__attribute__((visibility("default"))) 
# 159 "project/radare2/libr/debug/pid.c"
     int r_debug_pid_set_state(struct r_debug_t *dbg, int status) {
 return 
# 160 "project/radare2/libr/debug/pid.c" 3 4
       1
# 160 "project/radare2/libr/debug/pid.c"
           ;
}



# 164 "project/radare2/libr/debug/pid.c" 3 4
__attribute__((visibility("default"))) 
# 164 "project/radare2/libr/debug/pid.c"
     struct r_debug_pid_t *r_debug_pid_get_status(struct r_debug_t *dbg, int pid) {
 return 
# 165 "project/radare2/libr/debug/pid.c" 3 4
       ((void *)0)
# 165 "project/radare2/libr/debug/pid.c"
           ;
}
