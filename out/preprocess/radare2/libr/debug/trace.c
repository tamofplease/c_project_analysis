# 0 "project/radare2/libr/debug/trace.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/debug/trace.c"
...
# 4 "project/radare2/libr/debug/trace.c" 2



__attribute__((visibility("default"))) 
# 7 "project/radare2/libr/debug/trace.c"
     RDebugTrace *r_debug_trace_new (void) {
 RDebugTrace *t = 
# 8 "project/radare2/libr/debug/trace.c" 3 4
                 (
# 8 "project/radare2/libr/debug/trace.c"
                 RDebugTrace
# 8 "project/radare2/libr/debug/trace.c" 3 4
                 *)calloc(1,sizeof(
# 8 "project/radare2/libr/debug/trace.c"
...
# 8 "project/radare2/libr/debug/trace.c"
 ...
 if (!t) {
  return 
# 10 "project/radare2/libr/debug/trace.c" 3 4
        ((void *)0)
# 10 "project/radare2/libr/debug/trace.c"
            ;
 }
 t->tag = 1;
 t->addresses = 
# 13 "project/radare2/libr/debug/trace.c" 3 4
               ((void *)0)
# 13 "project/radare2/libr/debug/trace.c"
                   ;
 t->enabled = 
# 14 "project/radare2/libr/debug/trace.c" 3 4
             0
# 14 "project/radare2/libr/debug/trace.c"
                  ;
 t->traces = r_list_new ();
 if (!t->traces) {
  r_debug_trace_free (t);
  return 
# 18 "project/radare2/libr/debug/trace.c" 3 4
        ((void *)0)
# 18 "project/radare2/libr/debug/trace.c"
            ;
 }
 t->traces->free = free;
 t->ht = ht_pp_new0 ();
 if (!t->ht) {
  r_debug_trace_free (t);
  return 
# 24 "project/radare2/libr/debug/trace.c" 3 4
        ((void *)0)
# 24 "project/radare2/libr/debug/trace.c"
            ;
 }
 return t;
}
...
# 29 "project/radare2/libr/debug/trace.c" 3 4
__attribute__((visibility("default"))) 
# 29 "project/radare2/libr/debug/trace.c"
     void r_debug_trace_free (RDebugTrace *trace) {
 if (!trace) {
  return;
 }
...
# 36 "project/radare2/libr/debug/trace.c" 3 4
{ free((void *)
# 36 "project/radare2/libr/debug/trace.c"
trace
# 36 "project/radare2/libr/debug/trace.c" 3 4
); 
# 36 "project/radare2/libr/debug/trace.c"
...
# 41 "project/radare2/libr/debug/trace.c" 3 4
__attribute__((visibility("default"))) 
# 41 "project/radare2/libr/debug/trace.c"
     int r_debug_trace_tag (RDebug *dbg, int tag) {

 return (dbg->trace->tag = (tag>0)? tag: 
# 43 "project/radare2/libr/debug/trace.c" 3 4
                                        0xFFFFFFFFU
# 43 "project/radare2/libr/debug/trace.c"
                                                );
}


# 46 "project/radare2/libr/debug/trace.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 46 "project/radare2/libr/debug/trace.c"
          r_debug_trace_ins_before(RDebug *dbg) {
 RListIter *it, *it_tmp;
 RAnalValue *val;
 
# 49 "project/radare2/libr/debug/trace.c" 3 4
unsigned char 
# 49 "project/radare2/libr/debug/trace.c"
    buf_pc[32];


 
# 52 "project/radare2/libr/debug/trace.c" 3 4
unsigned long long 
# 52 "project/radare2/libr/debug/trace.c"
     pc = r_debug_reg_get (dbg, dbg->reg->name[R_REG_NAME_PC]);
 if (!dbg->iob.read_at) {
  return 
# 54 "project/radare2/libr/debug/trace.c" 3 4
        0
# 54 "project/radare2/libr/debug/trace.c"
             ;
 }
 if (!dbg->iob.read_at (dbg->iob.io, pc, buf_pc, sizeof (buf_pc))) {
  return 
# 57 "project/radare2/libr/debug/trace.c" 3 4
        0
# 57 "project/radare2/libr/debug/trace.c"
             ;
 }
 dbg->cur_op = 
# 59 "project/radare2/libr/debug/trace.c" 3 4
              (
# 59 "project/radare2/libr/debug/trace.c"
              RAnalOp
# 59 "project/radare2/libr/debug/trace.c" 3 4
              *)calloc(1,sizeof(
# 59 "project/radare2/libr/debug/trace.c"
...
# 59 "project/radare2/libr/debug/trace.c"
 ...
 if (!dbg->cur_op) {
  return 
# 61 "project/radare2/libr/debug/trace.c" 3 4
        0
# 61 "project/radare2/libr/debug/trace.c"
             ;
 }
 if (!r_anal_op (dbg->anal, dbg->cur_op, pc, buf_pc, sizeof (buf_pc), R_ANAL_OP_MASK_VAL)) {
  r_anal_op_free (dbg->cur_op);
  dbg->cur_op = 
# 65 "project/radare2/libr/debug/trace.c" 3 4
               ((void *)0)
# 65 "project/radare2/libr/debug/trace.c"
                   ;
  return 
# 66 "project/radare2/libr/debug/trace.c" 3 4
        0
# 66 "project/radare2/libr/debug/trace.c"
             ;
 }


 
# 70 "project/radare2/libr/debug/trace.c" 3 4
if (
# 70 "project/radare2/libr/debug/trace.c"
dbg->cur_op->access
# 70 "project/radare2/libr/debug/trace.c" 3 4
) for (
# 70 "project/radare2/libr/debug/trace.c"
...
# 79 "project/radare2/libr/debug/trace.c" 3 4
   fprintf(__stderrp,
# 79 "project/radare2/libr/debug/trace.c"
...
# 86 "project/radare2/libr/debug/trace.c" 3 4
   unsigned long long 
# 86 "project/radare2/libr/debug/trace.c"
        addr = 0;
    addr += val->delta;
    if (val->seg) {
 ...
 return 
# 107 "project/radare2/libr/debug/trace.c" 3 4
       1
# 107 "project/radare2/libr/debug/trace.c"
           ;
}


# 110 "project/radare2/libr/debug/trace.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 110 "project/radare2/libr/debug/trace.c"
          r_debug_trace_ins_after(RDebug *dbg) {
 RListIter *it;
 RAnalValue *val;


 r_debug_reg_sync (dbg, R_REG_TYPE_ALL, 
# 115 "project/radare2/libr/debug/trace.c" 3 4
                                       0
# 115 "project/radare2/libr/debug/trace.c"
                                            );
 
# 116 "project/radare2/libr/debug/trace.c" 3 4
if (
# 116 "project/radare2/libr/debug/trace.c"
dbg->cur_op->access
# 116 "project/radare2/libr/debug/trace.c" 3 4
) for (
# 116 "project/radare2/libr/debug/trace.c"
...
# 125 "project/radare2/libr/debug/trace.c" 3 4
   r_log (__func__, "project/radare2/libr/debug/trace.c", 125, R_LOGLVL_ERROR, ((void *)0), 
# 125 "project/radare2/libr/debug/trace.c"
...
# 128 "project/radare2/libr/debug/trace.c" 3 4
  unsigned long long 
# 128 "project/radare2/libr/debug/trace.c"
       data = r_reg_get_value (dbg->reg, val->reg);
...
# 136 "project/radare2/libr/debug/trace.c" 3 4
  unsigned char 
# 136 "project/radare2/libr/debug/trace.c"
      buf[32] = { 0 };
   if (!dbg->iob.read_at (dbg->iob.io, val->base, buf, val->memref)) {
    
# 138 "project/radare2/libr/debug/trace.c" 3 4
   fprintf(__stderrp,
# 138 "project/radare2/libr/debug/trace.c"
   "Error reading memory at 0x%"
# 138 "project/radare2/libr/debug/trace.c" 3 4
   "llx"
# 138 "project/radare2/libr/debug/trace.c"
   "\n", val->base
...
# 138 "project/radare2/libr/debug/trace.c"
 ...
 r_anal_op_free (dbg->cur_op);
 dbg->cur_op = 
# 154 "project/radare2/libr/debug/trace.c" 3 4
              ((void *)0)
# 154 "project/radare2/libr/debug/trace.c"
                  ;
 return 
# 155 "project/radare2/libr/debug/trace.c" 3 4
       1
# 155 "project/radare2/libr/debug/trace.c"
           ;
}
...
# 161 "project/radare2/libr/debug/trace.c" 3 4
__attribute__((visibility("default"))) 
# 161 "project/radare2/libr/debug/trace.c"
     int r_debug_trace_pc(RDebug *dbg, 
# 161 "project/radare2/libr/debug/trace.c" 3 4
                                       unsigned long long 
# 161 "project/radare2/libr/debug/trace.c"
                                            pc) {
 
# 162 "project/radare2/libr/debug/trace.c" 3 4
unsigned char 
# 162 "project/radare2/libr/debug/trace.c"
    buf[32];
 RAnalOp op = {0};
 if (!dbg->iob.is_valid_offset (dbg->iob.io, pc, 0)) {
  
# 165 "project/radare2/libr/debug/trace.c" 3 4
 fprintf(__stderrp,
# 165 "project/radare2/libr/debug/trace.c"
 "trace_pc: cannot read memory at 0x%"
# 165 "project/radare2/libr/debug/trace.c" 3 4
 "llx"
# 165 "project/radare2/libr/debug/trace.c"
 "\n", pc
...
# 165 "project/radare2/libr/debug/trace.c"
                                                               ;
  return 
# 166 "project/radare2/libr/debug/trace.c" 3 4
        0
# 166 "project/radare2/libr/debug/trace.c"
             ;
 }
 (void)dbg->iob.read_at (dbg->iob.io, pc, buf, sizeof (buf));
 if (r_anal_op (dbg->anal, &op, pc, buf, sizeof (buf), R_ANAL_OP_MASK_ESIL) < 1) {
  
# 170 "project/radare2/libr/debug/trace.c" 3 4
 fprintf(__stderrp,
# 170 "project/radare2/libr/debug/trace.c"
 "trace_pc: cannot get opcode size at 0x%"
# 170 "project/radare2/libr/debug/trace.c" 3 4
 "llx"
# 170 "project/radare2/libr/debug/trace.c"
 "\n", pc
...
# 170 "project/radare2/libr/debug/trace.c"
                                                                   ;
  return 
# 171 "project/radare2/libr/debug/trace.c" 3 4
        0
# 171 "project/radare2/libr/debug/trace.c"
             ;
 }
 r_debug_trace_op (dbg, &op);
 r_anal_op_fini (&op);
 return 
# 175 "project/radare2/libr/debug/trace.c" 3 4
       1
# 175 "project/radare2/libr/debug/trace.c"
           ;
}


# 178 "project/radare2/libr/debug/trace.c" 3 4
__attribute__((visibility("default"))) 
# 178 "project/radare2/libr/debug/trace.c"
     void r_debug_trace_op(RDebug *dbg, RAnalOp *op) {
 static 
# 179 "project/radare2/libr/debug/trace.c" 3 4
       unsigned long long 
# 179 "project/radare2/libr/debug/trace.c"
            oldpc = 
# 179 "project/radare2/libr/debug/trace.c" 3 4
...
# 185 "project/radare2/libr/debug/trace.c" 3 4
   fprintf(__stderrp,
# 185 "project/radare2/libr/debug/trace.c"
   "Run aeim to get dbg->anal->esil initialized\n"
# 185 "project/radare2/libr/debug/trace.c" 3 4
   )
# 185 "project/radare2/libr/debug/trace.c"
                                                            ;
 ...
 if (oldpc != 
# 189 "project/radare2/libr/debug/trace.c" 3 4
             0xFFFFFFFFFFFFFFFFULL
# 189 "project/radare2/libr/debug/trace.c"
                     ) {
...
# 195 "project/radare2/libr/debug/trace.c" 3 4
__attribute__((visibility("default"))) 
# 195 "project/radare2/libr/debug/trace.c"
     void r_debug_trace_at(RDebug *dbg, const char *str) {

 free (dbg->trace->addresses);
 dbg->trace->addresses = (str&&*str)? strdup (str): 
# 198 "project/radare2/libr/debug/trace.c" 3 4
                                                   ((void *)0)
# 198 "project/radare2/libr/debug/trace.c"
                                                       ;
}


# 201 "project/radare2/libr/debug/trace.c" 3 4
__attribute__((visibility("default"))) 
# 201 "project/radare2/libr/debug/trace.c"
     RDebugTracepoint *r_debug_trace_get(RDebug *dbg, 
# 201 "project/radare2/libr/debug/trace.c" 3 4
                                                      unsigned long long 
# 201 "project/radare2/libr/debug/trace.c"
                                                           addr) {
 ...
 return ht_pp_find (dbg->trace->ht,
  sdb_fmt ("trace.%d.%"
# 204 "project/radare2/libr/debug/trace.c" 3 4
                      "llx"
# 204 "project/radare2/libr/debug/trace.c"
                             , tag, addr), 
# 204 "project/radare2/libr/debug/trace.c" 3 4
                                           ((void *)0)
# 204 "project/radare2/libr/debug/trace.c"
...
# 213 "project/radare2/libr/debug/trace.c" 3 4
__attribute__((visibility("default"))) 
# 213 "project/radare2/libr/debug/trace.c"
     void r_debug_trace_list(RDebug *dbg, int mode, 
# 213 "project/radare2/libr/debug/trace.c" 3 4
                                                    unsigned long long 
# 213 "project/radare2/libr/debug/trace.c"
                                                         offset) {
...
# 216 "project/radare2/libr/debug/trace.c" 3 4
_Bool 
# 216 "project/radare2/libr/debug/trace.c"
     flag = 
# 216 "project/radare2/libr/debug/trace.c" 3 4
            0
# 216 "project/radare2/libr/debug/trace.c"
...
# 222 "project/radare2/libr/debug/trace.c" 3 4
if (
# 222 "project/radare2/libr/debug/trace.c"
dbg->trace->traces
# 222 "project/radare2/libr/debug/trace.c" 3 4
) for (
# 222 "project/radare2/libr/debug/trace.c"
...
# 222 "project/radare2/libr/debug/trace.c"
  ...
  if (!trace->tag || (tag & trace->tag)) {
   ...
   case 'q':
    dbg->cb_printf ("0x%"
# 226 "project/radare2/libr/debug/trace.c" 3 4
                        "llx"
# 226 "project/radare2/libr/debug/trace.c"
                               "\n", trace->addr);
    break;
   case '=': {
    RListInfo *info = 
# 229 "project/radare2/libr/debug/trace.c" 3 4
                     (
# 229 "project/radare2/libr/debug/trace.c"
                     RListInfo
# 229 "project/radare2/libr/debug/trace.c" 3 4
                     *)calloc(1,sizeof(
# 229 "project/radare2/libr/debug/trace.c"
...
# 229 "project/radare2/libr/debug/trace.c"
    ...
    flag = 
# 239 "project/radare2/libr/debug/trace.c" 3 4
          1
# 239 "project/radare2/libr/debug/trace.c"
              ;
   } break;
   case 1:
   case '*':
    dbg->cb_printf ("dt+ 0x%"
# 243 "project/radare2/libr/debug/trace.c" 3 4
                            "llx"
# 243 "project/radare2/libr/debug/trace.c"
                                   " %d\n", trace->addr, trace->times);
    break;
   default:
    dbg->cb_printf ("0x%08"
# 246 "project/radare2/libr/debug/trace.c" 3 4
                          "llx"
# 246 "project/radare2/libr/debug/trace.c"
                                 " size=%d count=%d times=%d tag=%d\n",
 ...
 if (flag) {
  ...
  r_table_visual_list (table, info_list, offset, 1,
   r_cons_get_size (
# 258 "project/radare2/libr/debug/trace.c" 3 4
                   ((void *)0)
# 258 "project/radare2/libr/debug/trace.c"
                       ), io->va);
...
static int r_debug_trace_is_traceable(RDebug *dbg, 
# 266 "project/radare2/libr/debug/trace.c" 3 4
                                                  unsigned long long 
# 266 "project/radare2/libr/debug/trace.c"
                                                       addr) {
 if (dbg->trace->addresses) {
  char addr_str[32];
  
# 269 "project/radare2/libr/debug/trace.c" 3 4
 __builtin___snprintf_chk (
# 269 "project/radare2/libr/debug/trace.c"
 addr_str
# 269 "project/radare2/libr/debug/trace.c" 3 4
 , 
# 269 "project/radare2/libr/debug/trace.c"
...
# 269 "project/radare2/libr/debug/trace.c"
  ...
  if (!strstr (dbg->trace->addresses, addr_str)) {
   return 
# 271 "project/radare2/libr/debug/trace.c" 3 4
         0
# 271 "project/radare2/libr/debug/trace.c"
              ;
  }
 }
 return 
# 274 "project/radare2/libr/debug/trace.c" 3 4
       1
# 274 "project/radare2/libr/debug/trace.c"
           ;
}


# 277 "project/radare2/libr/debug/trace.c" 3 4
__attribute__((visibility("default"))) 
# 277 "project/radare2/libr/debug/trace.c"
     RDebugTracepoint *r_debug_trace_add (RDebug *dbg, 
# 277 "project/radare2/libr/debug/trace.c" 3 4
                                                       unsigned long long 
# 277 "project/radare2/libr/debug/trace.c"
                                                            addr, int size) {
 ...
 if (!r_debug_trace_is_traceable (dbg, addr)) {
  return 
# 281 "project/radare2/libr/debug/trace.c" 3 4
        ((void *)0)
# 281 "project/radare2/libr/debug/trace.c"
            ;
 }
 r_anal_trace_bb (dbg->anal, addr);
 tp = 
# 284 "project/radare2/libr/debug/trace.c" 3 4
     (
# 284 "project/radare2/libr/debug/trace.c"
     RDebugTracepoint
# 284 "project/radare2/libr/debug/trace.c" 3 4
     *)calloc(1,sizeof(
# 284 "project/radare2/libr/debug/trace.c"
...
# 284 "project/radare2/libr/debug/trace.c"
 ...
 if (!tp) {
  return 
# 286 "project/radare2/libr/debug/trace.c" 3 4
        ((void *)0)
# 286 "project/radare2/libr/debug/trace.c"
            ;
 }
 tp->stamp = r_time_now ();
 tp->addr = addr;
 ...
 ht_pp_update (dbg->trace->ht,
  sdb_fmt ("trace.%d.%"
# 296 "project/radare2/libr/debug/trace.c" 3 4
                      "llx"
# 296 "project/radare2/libr/debug/trace.c"
                             , tag, addr), tp);
 return tp;
}


# 300 "project/radare2/libr/debug/trace.c" 3 4
__attribute__((visibility("default"))) 
# 300 "project/radare2/libr/debug/trace.c"
     void r_debug_trace_reset (RDebug *dbg) {
