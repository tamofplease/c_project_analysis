# 0 "project/radare2/libr/debug/p/debug_qnx.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/debug/p/debug_qnx.c" 2
...
# 5 "project/radare2/libr/debug/p/debug_qnx.c" 2
...
# 6 "project/radare2/libr/debug/p/debug_qnx.c" 2


__attribute__((visibility("default"))) 
# 8 "project/radare2/libr/debug/p/debug_qnx.c"
     RDebugPid *__r_debug_pid_new(const char *path, int pid, char status, 
# 8 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
                                                                          unsigned long long 
# 8 "project/radare2/libr/debug/p/debug_qnx.c"
                                                                               pc) {
 RDebugPid *p = 
# 9 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
               (
# 9 "project/radare2/libr/debug/p/debug_qnx.c"
               RDebugPid
# 9 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
               *)calloc(1,sizeof(
# 9 "project/radare2/libr/debug/p/debug_qnx.c"
...
# 9 "project/radare2/libr/debug/p/debug_qnx.c"
 ...
 if (!p) {
  return 
# 11 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
        ((void *)0)
# 11 "project/radare2/libr/debug/p/debug_qnx.c"
            ;
 }
 p->path = strdup (path);
 p->pid = pid;
 p->status = status;
 p->runnable = 
# 16 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
              1
# 16 "project/radare2/libr/debug/p/debug_qnx.c"
                  ;
 p->pc = pc;
 return p;
}

# 20 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
__attribute__((visibility("default"))) 
# 20 "project/radare2/libr/debug/p/debug_qnx.c"
     void *__r_debug_pid_free(RDebugPid *pid) {
 free (pid->path);
 free (pid);
 return 
# 23 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
       ((void *)0)
# 23 "project/radare2/libr/debug/p/debug_qnx.c"
           ;
}
...
# 31 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
                        ((void *)0)
# 31 "project/radare2/libr/debug/p/debug_qnx.c"
                            ;
static 
# 32 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
      unsigned char 
# 32 "project/radare2/libr/debug/p/debug_qnx.c"
          *reg_buf = 
# 32 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
                     ((void *)0)
# 32 "project/radare2/libr/debug/p/debug_qnx.c"
...
static 
# 40 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
      _Bool 
# 40 "project/radare2/libr/debug/p/debug_qnx.c"
           r_debug_qnx_select (RDebug *dbg, int pid, int tid) {
 return qnxr_select (desc, pid, tid);
}

static RList *r_debug_qnx_tids (RDebug *dbg, int pid) {
 
# 45 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
fprintf(__stderrp,
# 45 "project/radare2/libr/debug/p/debug_qnx.c"
"%s: TODO: Threads\n", __func__
# 45 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
)
# 45 "project/radare2/libr/debug/p/debug_qnx.c"
                                         ;
 return 
# 46 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
       ((void *)0)
# 46 "project/radare2/libr/debug/p/debug_qnx.c"
           ;
}
...
static RList *r_debug_qnx_pids (RDebug *dbg, int pid) {
 ...
 if (!list) {
  return 
# 53 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
        ((void *)0)
# 53 "project/radare2/libr/debug/p/debug_qnx.c"
            ;
 }
...
static int r_debug_qnx_reg_read(RDebug *dbg, int type, 
# 67 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
                                                      unsigned char 
# 67 "project/radare2/libr/debug/p/debug_qnx.c"
                                                          *buf, int size) {
 int copy_size;
 int buflen = 0;
 if (!desc) {
...
# 80 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
 fprintf(__stderrp,
# 80 "project/radare2/libr/debug/p/debug_qnx.c"
 "r_debug_qnx_reg_read: small buffer %d vs %d\n", (int)size, (int)len
# 80 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
 )
                        
# 81 "project/radare2/libr/debug/p/debug_qnx.c"
                       ;
 }
 copy_size = 
# 83 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
            (((
# 83 "project/radare2/libr/debug/p/debug_qnx.c"
            len
# 83 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
            )>(
# 83 "project/radare2/libr/debug/p/debug_qnx.c"
...
# 83 "project/radare2/libr/debug/p/debug_qnx.c"
                             ;
 buflen = 
# 84 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
         (((
# 84 "project/radare2/libr/debug/p/debug_qnx.c"
         len
# 84 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
         )>(
# 84 "project/radare2/libr/debug/p/debug_qnx.c"
...
# 87 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
  unsigned char 
# 87 "project/radare2/libr/debug/p/debug_qnx.c"
      *new_buf = realloc (reg_buf, copy_size);
   if (!new_buf) {
    return -1;
   }
   reg_buf = new_buf;
...
# 102 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
__builtin___memset_chk (
# 102 "project/radare2/libr/debug/p/debug_qnx.c"
...
# 103 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
__builtin___memcpy_chk (
# 103 "project/radare2/libr/debug/p/debug_qnx.c"
(void *)(volatile void *) buf
# 103 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
, 
# 103 "project/radare2/libr/debug/p/debug_qnx.c"
desc->recv.data, copy_size
# 103 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
, __builtin_object_size (
# 103 "project/radare2/libr/debug/p/debug_qnx.c"
(void *)(volatile void *) buf
...
# 104 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
__builtin___memset_chk (
# 104 "project/radare2/libr/debug/p/debug_qnx.c"
...
# 105 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
__builtin___memcpy_chk (
# 105 "project/radare2/libr/debug/p/debug_qnx.c"
(void *)(volatile void *) reg_buf
# 105 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
, 
# 105 "project/radare2/libr/debug/p/debug_qnx.c"
...
static RList *r_debug_qnx_map_get(RDebug *dbg) {
 return 
# 111 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
       ((void *)0)
# 111 "project/radare2/libr/debug/p/debug_qnx.c"
           ;
}

static int r_debug_qnx_reg_write(RDebug *dbg, int type, const 
# 114 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
                                                             unsigned char 
# 114 "project/radare2/libr/debug/p/debug_qnx.c"
                                                                 *buf, int size) {
 int buflen = 0;
...
# 136 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
 unsigned char 
# 136 "project/radare2/libr/debug/p/debug_qnx.c"
...
# 141 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
 __builtin___memset_chk (
# 141 "project/radare2/libr/debug/p/debug_qnx.c"
 new_buf + buf_size
# 141 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
 , 
# 141 "project/radare2/libr/debug/p/debug_qnx.c"
...
# 141 "project/radare2/libr/debug/p/debug_qnx.c"
 ...
 RRegItem *current = 
# 144 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
                    ((void *)0)
# 144 "project/radare2/libr/debug/p/debug_qnx.c"
                        ;
 for (;;) {
...
# 150 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
 unsigned long long 
# 150 "project/radare2/libr/debug/p/debug_qnx.c"
      val = r_reg_get_value (dbg->reg, current);
  int bytes = bits / 8;
  qnxr_write_reg (desc, current->name, (char *)&val, bytes);
 }
 return 
# 154 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
       1
# 154 "project/radare2/libr/debug/p/debug_qnx.c"
           ;
}

static 
# 157 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
      _Bool 
# 157 "project/radare2/libr/debug/p/debug_qnx.c"
           r_debug_qnx_continue(RDebug *dbg, int pid, int tid, int sig) {
 qnxr_continue (desc, -1);
 return 
# 159 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
       1
# 159 "project/radare2/libr/debug/p/debug_qnx.c"
           ;
}

static 
# 162 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
      _Bool 
# 162 "project/radare2/libr/debug/p/debug_qnx.c"
           r_debug_qnx_step(RDebug *dbg) {
 qnxr_step (desc, -1);
 return 
# 164 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
       1
# 164 "project/radare2/libr/debug/p/debug_qnx.c"
           ;
}
...
static int r_debug_qnx_stop(RDebug *dbg) {
 qnxr_stop (desc);
 return 
# 178 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
       1
# 178 "project/radare2/libr/debug/p/debug_qnx.c"
           ;
}

static 
# 181 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
      _Bool 
# 181 "project/radare2/libr/debug/p/debug_qnx.c"
           r_debug_qnx_attach(RDebug *dbg, int pid) {
 RIODesc *d = dbg->iob.io->desc;
 dbg->swstep = 
# 183 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
              0
# 183 "project/radare2/libr/debug/p/debug_qnx.c"
                   ;
 ...
 if (d && d->plugin && d->plugin->name && d->data) {
  if (!strcmp ("qnx", d->plugin->name)) {
   ...
   if ((desc = &g->desc)) {
    ...
    case R_SYS_ARCH_X86:
     if (bits == 16 || bits == 32) {
      qnxr_set_architecture (&g->desc, 
# 194 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
                                      1
# 194 "project/radare2/libr/debug/p/debug_qnx.c"
                                            );
     } else {
      
# 196 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
     fprintf(__stderrp,
# 196 "project/radare2/libr/debug/p/debug_qnx.c"
     "Not supported register %s %d profile\n", dbg->arch, bits
# 196 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
     )
# 196 "project/radare2/libr/debug/p/debug_qnx.c"
                                                                        ;
      return 
# 197 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
            0
# 197 "project/radare2/libr/debug/p/debug_qnx.c"
                 ;
     }
     break;
    case R_SYS_ARCH_ARM:
     if (bits == 16 || bits == 32) {
      qnxr_set_architecture (&g->desc, 
# 202 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
                                      2
# 202 "project/radare2/libr/debug/p/debug_qnx.c"
                                            );
     } else {
      
# 204 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
     fprintf(__stderrp,
# 204 "project/radare2/libr/debug/p/debug_qnx.c"
     "Not supported register %s %d profile\n", dbg->arch, bits
# 204 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
     )
# 204 "project/radare2/libr/debug/p/debug_qnx.c"
                                                                        ;
      return 
# 205 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
            0
# 205 "project/radare2/libr/debug/p/debug_qnx.c"
                 ;
     }
     break;
    }
...
# 214 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
  fprintf(__stderrp,
# 214 "project/radare2/libr/debug/p/debug_qnx.c"
...
# 214 "project/radare2/libr/debug/p/debug_qnx.c"
                                                                             ;
   return 
# 215 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
         0
# 215 "project/radare2/libr/debug/p/debug_qnx.c"
              ;
  }
 }
 ...
 dbg->pid = 0;
 return 
# 220 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
       1
# 220 "project/radare2/libr/debug/p/debug_qnx.c"
           ;
}

static 
# 223 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
      _Bool 
# 223 "project/radare2/libr/debug/p/debug_qnx.c"
           r_debug_qnx_detach (RDebug *dbg, int pid) {
 qnxr_disconnect (desc);
 free (reg_buf);
 return 
# 226 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
       1
# 226 "project/radare2/libr/debug/p/debug_qnx.c"
           ;
}
...
static const char *r_debug_qnx_reg_profile (RDebug *dbg) {
 ...
 return 
# 326 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
       ((void *)0)
# 326 "project/radare2/libr/debug/p/debug_qnx.c"
           ;
}

static int r_debug_qnx_breakpoint (RBreakpoint *bp, RBreakpointItem *b, 
# 329 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
                                                                       _Bool 
# 329 "project/radare2/libr/debug/p/debug_qnx.c"
                                                                            set) {
 if (!b) {
  return 
# 331 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
        0
# 331 "project/radare2/libr/debug/p/debug_qnx.c"
             ;
 }
 int ret = set
  ? b->hw
...
RDebugPlugin r_debug_plugin_qnx = {
 ...
 .arch = "x86,arm",
 .bits = 
# 347 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
        4
# 347 "project/radare2/libr/debug/p/debug_qnx.c"
                     ,
...
# 366 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
__attribute__((visibility("default"))) 
# 366 "project/radare2/libr/debug/p/debug_qnx.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_DBG,
 .data = &r_debug_plugin_qnx,
 .version = 
# 369 "project/radare2/libr/debug/p/debug_qnx.c" 3 4
           "5.5.4"
# 369 "project/radare2/libr/debug/p/debug_qnx.c"
                     };
