# 0 "project/radare2/libr/debug/p/debug_bochs.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/debug/p/debug_bochs.c" 2
...
# 5 "project/radare2/libr/debug/p/debug_bochs.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/bochs/include/libbochs.h" 1 3 4
# 11 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/bochs/include/libbochs.h" 3 4
...
# 6 "project/radare2/libr/debug/p/debug_bochs.c" 2


# 7 "project/radare2/libr/debug/p/debug_bochs.c"
static 
# 7 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
      _Bool 
# 7 "project/radare2/libr/debug/p/debug_bochs.c"
           bCapturaRegs = 
# 7 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
...
# 7 "project/radare2/libr/debug/p/debug_bochs.c"
                              ;
static 
# 8 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
      _Bool 
# 8 "project/radare2/libr/debug/p/debug_bochs.c"
           bStep = 
# 8 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                   0
# 8 "project/radare2/libr/debug/p/debug_bochs.c"
                        ;
static 
# 9 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
      _Bool 
# 9 "project/radare2/libr/debug/p/debug_bochs.c"
           bBreak = 
# 9 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                    0
# 9 "project/radare2/libr/debug/p/debug_bochs.c"
                         ;
static 
# 10 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
      _Bool 
# 10 "project/radare2/libr/debug/p/debug_bochs.c"
           bAjusta = 
# 10 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                     1
# 10 "project/radare2/libr/debug/p/debug_bochs.c"
...
static 
# 12 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
      unsigned long long 
# 12 "project/radare2/libr/debug/p/debug_bochs.c"
           ripStop = 0LL;
...
# 18 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                         ((void *)0)
# 18 "project/radare2/libr/debug/p/debug_bochs.c"
                             ;

static 
# 20 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
      _Bool 
# 20 "project/radare2/libr/debug/p/debug_bochs.c"
           isBochs(RDebug *dbg) {
 RIODesc *d = dbg->iob.io->desc;
 if (d && d->plugin && d->plugin->name) {
  if (!strcmp ("bochs", d->plugin->name)) {
   return 
# 24 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
         1
# 24 "project/radare2/libr/debug/p/debug_bochs.c"
             ;
  }
 }
 
# 27 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
fprintf(__stderrp,
# 27 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 27 "project/radare2/libr/debug/p/debug_bochs.c"
                                                          ;
 return 
# 28 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
       0
# 28 "project/radare2/libr/debug/p/debug_bochs.c"
            ;
}

static int r_debug_bochs_breakpoint (RBreakpoint *bp, RBreakpointItem *b, 
# 31 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                                                                         _Bool 
# 31 "project/radare2/libr/debug/p/debug_bochs.c"
                                                                              set) {
 char cmd[64];
 char num[4];
 char addr[19];
...
# 36 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
unsigned long long 
# 36 "project/radare2/libr/debug/p/debug_bochs.c"
     a;
 int n,i,lenRec;

 if (!b) {
  return 
# 40 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
        0
# 40 "project/radare2/libr/debug/p/debug_bochs.c"
             ;
 }
 if (set) {

  
# 44 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
 __builtin___sprintf_chk (
# 44 "project/radare2/libr/debug/p/debug_bochs.c"
 cmd
# 44 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
...
# 44 "project/radare2/libr/debug/p/debug_bochs.c"
                                        ;
  bochs_send_cmd (desc, cmd, 
# 45 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                            1
# 45 "project/radare2/libr/debug/p/debug_bochs.c"
                                );
  bCapturaRegs = 
# 46 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                1
# 46 "project/radare2/libr/debug/p/debug_bochs.c"
                    ;
 } else {
  ...
  bochs_send_cmd (desc,"blist",
# 55 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                              1
# 55 "project/radare2/libr/debug/p/debug_bochs.c"
                                  );
...
# 63 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
    __builtin___strncpy_chk (
# 63 "project/radare2/libr/debug/p/debug_bochs.c"
    num
# 63 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
    , 
# 63 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 65 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
    __builtin___strncpy_chk (
# 65 "project/radare2/libr/debug/p/debug_bochs.c"
    addr
# 65 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
    , 
# 65 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 65 "project/radare2/libr/debug/p/debug_bochs.c"
     ...
     addr[18] = 0;
     n = r_num_get (
# 67 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                   ((void *)0)
# 67 "project/radare2/libr/debug/p/debug_bochs.c"
                       ,num);
     a = r_num_get (
# 68 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                   ((void *)0)
# 68 "project/radare2/libr/debug/p/debug_bochs.c"
                       ,addr);
...
# 78 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
  __builtin___snprintf_chk (
# 78 "project/radare2/libr/debug/p/debug_bochs.c"
  bufcmd
# 78 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
  , 
# 78 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 78 "project/radare2/libr/debug/p/debug_bochs.c"
   ...
   bochs_send_cmd (desc, bufcmd, 
# 80 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                                1
# 80 "project/radare2/libr/debug/p/debug_bochs.c"
                                    );
  }

 }
 return 
# 84 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
       1
# 84 "project/radare2/libr/debug/p/debug_bochs.c"
           ;
}

static int r_debug_bochs_reg_read(RDebug *dbg, int type, 
# 87 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                                                        unsigned char 
# 87 "project/radare2/libr/debug/p/debug_bochs.c"
                                                            *buf, int size) {
 char strReg[19];
 char regname[4];
 char strBase[19];
...
# 93 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
unsigned long long 
# 93 "project/radare2/libr/debug/p/debug_bochs.c"
     val = 0, valRIP = 0;
 if (!isBochs (dbg)) {
  return 0;
 }
 ...
 if (bCapturaRegs == 
# 99 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                    1
# 99 "project/radare2/libr/debug/p/debug_bochs.c"
                        ) {
  bochs_send_cmd (desc, "regs", 
# 100 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                               1
# 100 "project/radare2/libr/debug/p/debug_bochs.c"
                                   );
  ...
  while (desc->data[i] != 0 && i < lenRec -4 ) {
   if ( (desc->data[i] == (
# 108 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                          unsigned char
# 108 "project/radare2/libr/debug/p/debug_bochs.c"
                             )'r' && desc->data[i + 3] == (
# 108 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                                                           unsigned char
# 108 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 109 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
   __builtin___strncpy_chk (
# 109 "project/radare2/libr/debug/p/debug_bochs.c"
   regname
# 109 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
   , 
# 109 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 111 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
   __builtin___strncpy_chk (
# 111 "project/radare2/libr/debug/p/debug_bochs.c"
   &strReg[2]
# 111 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
   , 
# 111 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 112 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
   __builtin___strncpy_chk (
# 112 "project/radare2/libr/debug/p/debug_bochs.c"
   &strReg[10]
# 112 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
   , 
# 112 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 112 "project/radare2/libr/debug/p/debug_bochs.c"
    ...
    i += 22;
    val = r_num_get (
# 117 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                    ((void *)0)
# 117 "project/radare2/libr/debug/p/debug_bochs.c"
                        , strReg);

    
# 119 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
   __builtin___memcpy_chk (
# 119 "project/radare2/libr/debug/p/debug_bochs.c"
   &buf[pos]
# 119 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
   , 
# 119 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 119 "project/radare2/libr/debug/p/debug_bochs.c"
  ...
  bochs_send_cmd (desc, "info cpu", 
# 132 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                                   1
# 132 "project/radare2/libr/debug/p/debug_bochs.c"
                                       );
  if (strstr (desc->data,"PC_32")) {
   bAjusta = 
# 134 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
            1
# 134 "project/radare2/libr/debug/p/debug_bochs.c"
                ;

  } else if (strstr (desc->data,"PC_80")) {
   bAjusta = 
# 137 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
            0
# 137 "project/radare2/libr/debug/p/debug_bochs.c"
                 ;

  } else if (strstr (desc->data,"PC_64")) {
   bAjusta = 
# 140 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
            0
# 140 "project/radare2/libr/debug/p/debug_bochs.c"
                 ;

  } else {
   
# 143 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
  fprintf(__stderrp,
# 143 "project/radare2/libr/debug/p/debug_bochs.c"
  "[unknown mode]\n%s\n", desc->data
# 143 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
  )
# 143 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 163 "project/radare2/libr/debug/p/debug_bochs.c"
  bochs_send_cmd (desc, "sreg", 
# 163 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                               1
# 163 "project/radare2/libr/debug/p/debug_bochs.c"
                                   );
...
# 171 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
   __builtin___strncpy_chk (
# 171 "project/radare2/libr/debug/p/debug_bochs.c"
   &strReg[0]
# 171 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
   , 
# 171 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 171 "project/radare2/libr/debug/p/debug_bochs.c"
    ...
    strReg[6] = 0;
    val = r_num_get (
# 173 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                    ((void *)0)
# 173 "project/radare2/libr/debug/p/debug_bochs.c"
                        , strReg);
    
# 174 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
   __builtin___strncpy_chk (
# 174 "project/radare2/libr/debug/p/debug_bochs.c"
   regname
# 174 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
   , 
# 174 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 177 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
    __builtin___strncpy_chk (
# 177 "project/radare2/libr/debug/p/debug_bochs.c"
    strBase
# 177 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
    , 
# 177 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 180 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
     __builtin___strncpy_chk (
# 180 "project/radare2/libr/debug/p/debug_bochs.c"
     strLimit
# 180 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
     , 
# 180 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 185 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
   __builtin___memcpy_chk (
# 185 "project/radare2/libr/debug/p/debug_bochs.c"
   &buf[pos]
# 185 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
   , 
# 185 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 197 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
  __builtin___memcpy_chk (
# 197 "project/radare2/libr/debug/p/debug_bochs.c"
  &buf[0]
# 197 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
  , 
# 197 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 199 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
  __builtin___memcpy_chk (
# 199 "project/radare2/libr/debug/p/debug_bochs.c"
  &buf[0]
# 199 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
  , 
# 199 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 202 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
 __builtin___memcpy_chk (
# 202 "project/radare2/libr/debug/p/debug_bochs.c"
 saveRegs
# 202 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
 , 
# 202 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 202 "project/radare2/libr/debug/p/debug_bochs.c"
                           ;
  bCapturaRegs = 
# 203 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                0
# 203 "project/radare2/libr/debug/p/debug_bochs.c"
                     ;

 } else {
  
# 206 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
 __builtin___memcpy_chk (
# 206 "project/radare2/libr/debug/p/debug_bochs.c"
 buf
# 206 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
 , 
# 206 "project/radare2/libr/debug/p/debug_bochs.c"
...
static int r_debug_bochs_reg_write(RDebug *dbg, int type, const 
# 212 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                                                               unsigned char 
# 212 "project/radare2/libr/debug/p/debug_bochs.c"
                                                                   *buf, int size) {
...
static RList *r_debug_bochs_map_get(RDebug* dbg) {
 if (!isBochs (dbg)) {
  return 
# 224 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
        ((void *)0)
# 224 "project/radare2/libr/debug/p/debug_bochs.c"
            ;
 }
 ...
 if (!list) {
  return 
# 230 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
        ((void *)0)
# 230 "project/radare2/libr/debug/p/debug_bochs.c"
            ;
 }
 mr = 
# 232 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
     (
# 232 "project/radare2/libr/debug/p/debug_bochs.c"
     RDebugMap
# 232 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
     *)calloc(1,sizeof(
# 232 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 232 "project/radare2/libr/debug/p/debug_bochs.c"
 ...
 if (!mr) {
  r_list_free (list);
  return 
# 235 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
        ((void *)0)
# 235 "project/radare2/libr/debug/p/debug_bochs.c"
            ;
 }
 mr->name = strdup ("fake");
 mr->addr = 0;
 mr->addr_end = 
# 239 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
               0xFFFFFFFFU
# 239 "project/radare2/libr/debug/p/debug_bochs.c"
                       ;
 mr->size = 
# 240 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
           0xFFFFFFFFU
# 240 "project/radare2/libr/debug/p/debug_bochs.c"
                   ;
 mr->perm = 0;
 mr->user = 0;
...
static 
# 247 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
      _Bool 
# 247 "project/radare2/libr/debug/p/debug_bochs.c"
           r_debug_bochs_step(RDebug *dbg) {
 if (isBochs (dbg)) {
  bochs_send_cmd (desc, "s", 
# 249 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                            1
# 249 "project/radare2/libr/debug/p/debug_bochs.c"
                                );
  bCapturaRegs = 
# 250 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                1
# 250 "project/radare2/libr/debug/p/debug_bochs.c"
                    ;
  bStep = 
# 251 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
         1
# 251 "project/radare2/libr/debug/p/debug_bochs.c"
             ;
  return 
# 252 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
        1
# 252 "project/radare2/libr/debug/p/debug_bochs.c"
            ;
 }
 return 
# 254 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
       0
# 254 "project/radare2/libr/debug/p/debug_bochs.c"
            ;
}

static 
# 257 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
      _Bool 
# 257 "project/radare2/libr/debug/p/debug_bochs.c"
           r_debug_bochs_continue(RDebug *dbg, int pid, int tid, int sig) {

 bochs_send_cmd (desc, "c", 
# 259 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                           0
# 259 "project/radare2/libr/debug/p/debug_bochs.c"
                                );
 bCapturaRegs = 
# 260 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
               1
# 260 "project/radare2/libr/debug/p/debug_bochs.c"
                   ;
 bBreak = 
# 261 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
         0
# 261 "project/radare2/libr/debug/p/debug_bochs.c"
              ;
 return 
# 262 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
       1
# 262 "project/radare2/libr/debug/p/debug_bochs.c"
           ;
}

static void bochs_debug_break(void *u) {
 
# 266 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
fprintf(__stderrp,
# 266 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 266 "project/radare2/libr/debug/p/debug_bochs.c"
 ...
 bochs_cmd_stop (desc);
 bBreak = 
# 268 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
         1
# 268 "project/radare2/libr/debug/p/debug_bochs.c"
             ;
}
...
static RDebugReasonType r_debug_bochs_wait(RDebug *dbg, int pid) {
 if (!isBochs (dbg)) {
  return 
# 273 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
        0
# 273 "project/radare2/libr/debug/p/debug_bochs.c"
             ;
 }
 char strIP[19];
 int i = 0;
 ...
 if (bStep) {
  bStep = 
# 283 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
         0
# 283 "project/radare2/libr/debug/p/debug_bochs.c"
              ;
 } else {
...
# 291 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
    fprintf(__stderrp,
# 291 "project/radare2/libr/debug/p/debug_bochs.c"
    "ctrl+c %s\n", desc->data
# 291 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
    )
# 291 "project/radare2/libr/debug/p/debug_bochs.c"
                                       ;
     bBreak = 
# 292 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
             0
# 292 "project/radare2/libr/debug/p/debug_bochs.c"
                  ;
     break;
    }
    i--;
    if (!i) {
     bBreak = 
# 297 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
             0
# 297 "project/radare2/libr/debug/p/debug_bochs.c"
                  ;
     
# 298 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
    fprintf(__stderrp,
# 298 "project/radare2/libr/debug/p/debug_bochs.c"
    "empty ctrl+c.\n"
# 298 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
    )
# 298 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 316 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
   __builtin___strncpy_chk (
# 316 "project/radare2/libr/debug/p/debug_bochs.c"
   strIP
# 316 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
   , 
# 316 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 316 "project/radare2/libr/debug/p/debug_bochs.c"
    ...
    ripStop = r_num_get (
# 319 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                        ((void *)0)
# 319 "project/radare2/libr/debug/p/debug_bochs.c"
                            , strIP);
   }
  }
 }
...
static int r_debug_bochs_stop(RDebug *dbg) {
 ...
 return 
# 333 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
       1
# 333 "project/radare2/libr/debug/p/debug_bochs.c"
           ;
}

static 
# 336 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
      _Bool 
# 336 "project/radare2/libr/debug/p/debug_bochs.c"
           r_debug_bochs_attach(RDebug *dbg, int pid) {
 RIODesc *d = dbg->iob.io->desc;

 dbg->swstep = 
# 339 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
              0
# 339 "project/radare2/libr/debug/p/debug_bochs.c"
                   ;
...
# 346 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
   fprintf(__stderrp,
# 346 "project/radare2/libr/debug/p/debug_bochs.c"
   "bochs attach: ok\n"
# 346 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
   )
# 346 "project/radare2/libr/debug/p/debug_bochs.c"
    ...
    bCapturaRegs = 
# 348 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                  1
# 348 "project/radare2/libr/debug/p/debug_bochs.c"
                      ;
    bStep = 
# 349 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
           0
# 349 "project/radare2/libr/debug/p/debug_bochs.c"
                ;
    bBreak = 
# 350 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
            0
# 350 "project/radare2/libr/debug/p/debug_bochs.c"
                 ;
   }
  }
 }
 return 
# 354 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
       1
# 354 "project/radare2/libr/debug/p/debug_bochs.c"
           ;
}

static 
# 357 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
      _Bool 
# 357 "project/radare2/libr/debug/p/debug_bochs.c"
           r_debug_bochs_detach(RDebug *dbg, int pid) {

 free (saveRegs);
 return 
# 360 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
       1
# 360 "project/radare2/libr/debug/p/debug_bochs.c"
           ;
}
...
# 540 "project/radare2/libr/debug/p/debug_bochs.c"
 ...
 return 
# 542 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
       ((void *)0)
# 542 "project/radare2/libr/debug/p/debug_bochs.c"
           ;
}
...
RDebugPlugin r_debug_plugin_bochs = {
 ...
 .arch = "x86",
 .bits = 
# 549 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
        2 
# 549 "project/radare2/libr/debug/p/debug_bochs.c"
                      | 
# 549 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
                        4 
# 549 "project/radare2/libr/debug/p/debug_bochs.c"
...
# 565 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
__attribute__((visibility("default"))) 
# 565 "project/radare2/libr/debug/p/debug_bochs.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_DBG,
 .data = &r_debug_plugin_bochs,
 .version = 
# 568 "project/radare2/libr/debug/p/debug_bochs.c" 3 4
           "5.5.4"

# 569 "project/radare2/libr/debug/p/debug_bochs.c"
};
