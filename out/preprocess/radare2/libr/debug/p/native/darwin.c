# 0 "project/radare2/libr/debug/p/native/darwin.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/debug/p/native/darwin.c"
...
# 2 "project/radare2/libr/debug/p/native/darwin.c" 2


# 3 "project/radare2/libr/debug/p/native/darwin.c"
int pids_cmdline(int pid, char *cmdline) {
 int fd;
 
# 5 "project/radare2/libr/debug/p/native/darwin.c" 3 4
__builtin___sprintf_chk (
# 5 "project/radare2/libr/debug/p/native/darwin.c"
cmdline
# 5 "project/radare2/libr/debug/p/native/darwin.c" 3 4
...
# 37 "project/radare2/libr/debug/p/native/darwin.c" 3 4
  __builtin___sprintf_chk (
# 37 "project/radare2/libr/debug/p/native/darwin.c"
  buf
# 37 "project/radare2/libr/debug/p/native/darwin.c" 3 4
  , 0, __builtin_object_size (
# 37 "project/radare2/libr/debug/p/native/darwin.c"
