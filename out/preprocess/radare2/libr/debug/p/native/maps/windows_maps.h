# 0 "project/radare2/libr/debug/p/native/maps/windows_maps.h"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/debug/p/native/maps/windows_maps.h" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/debug/p/native/maps/windows_maps.h"
     RList *r_w32_dbg_modules(RDebug *dbg);

# 6 "project/radare2/libr/debug/p/native/maps/windows_maps.h" 3 4
__attribute__((visibility("default"))) 
# 6 "project/radare2/libr/debug/p/native/maps/windows_maps.h"
     RList *r_w32_dbg_maps(RDebug *dbg);
