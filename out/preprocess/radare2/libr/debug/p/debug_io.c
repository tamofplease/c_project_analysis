# 0 "project/radare2/libr/debug/p/debug_io.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/debug/p/debug_io.c"
...
# 4 "project/radare2/libr/debug/p/debug_io.c" 2
...
# 5 "project/radare2/libr/debug/p/debug_io.c" 2
...
# 6 "project/radare2/libr/debug/p/debug_io.c" 2


# 7 "project/radare2/libr/debug/p/debug_io.c"
static 
# 7 "project/radare2/libr/debug/p/debug_io.c" 3 4
      _Bool 
# 7 "project/radare2/libr/debug/p/debug_io.c"
           __io_step(RDebug *dbg) {
 free (dbg->iob.system (dbg->iob.io, "ds"));
 return 
# 9 "project/radare2/libr/debug/p/debug_io.c" 3 4
       1
# 9 "project/radare2/libr/debug/p/debug_io.c"
           ;
}

static 
# 12 "project/radare2/libr/debug/p/debug_io.c" 3 4
      _Bool 
# 12 "project/radare2/libr/debug/p/debug_io.c"
           __io_step_over(RDebug *dbg) {
 free (dbg->iob.system (dbg->iob.io, "dso"));
 return 
# 14 "project/radare2/libr/debug/p/debug_io.c" 3 4
       1
# 14 "project/radare2/libr/debug/p/debug_io.c"
           ;
}
...
static RList *__io_maps(RDebug *dbg) {
 ...
 if (!str) {
  r_list_free (list);
  return 
# 22 "project/radare2/libr/debug/p/debug_io.c" 3 4
        ((void *)0)
# 22 "project/radare2/libr/debug/p/debug_io.c"
            ;
 }
 char *ostr = str;
 
# 25 "project/radare2/libr/debug/p/debug_io.c" 3 4
unsigned long long 
# 25 "project/radare2/libr/debug/p/debug_io.c"
     map_start, map_end;
 char perm[32];
 char name[512];
 for (;;) {
...
# 45 "project/radare2/libr/debug/p/debug_io.c" 3 4
   __builtin___memmove_chk (
# 45 "project/radare2/libr/debug/p/debug_io.c"
   _s_
# 45 "project/radare2/libr/debug/p/debug_io.c" 3 4
   , 
# 45 "project/radare2/libr/debug/p/debug_io.c"
...
# 49 "project/radare2/libr/debug/p/debug_io.c" 3 4
   __builtin___memmove_chk (
# 49 "project/radare2/libr/debug/p/debug_io.c"
   _s_
# 49 "project/radare2/libr/debug/p/debug_io.c" 3 4
   , 
# 49 "project/radare2/libr/debug/p/debug_io.c"
...
# 49 "project/radare2/libr/debug/p/debug_io.c"
   ...
   sscanf (str, "0x%"
# 51 "project/radare2/libr/debug/p/debug_io.c" 3 4
                    "llx"
# 51 "project/radare2/libr/debug/p/debug_io.c"
                           " - 0x%"
# 51 "project/radare2/libr/debug/p/debug_io.c" 3 4
                                   "llx"
# 51 "project/radare2/libr/debug/p/debug_io.c"
...
static 
# 72 "project/radare2/libr/debug/p/debug_io.c" 3 4
      _Bool 
# 72 "project/radare2/libr/debug/p/debug_io.c"
           __io_attach(RDebug *dbg, int pid) {
 return 
# 73 "project/radare2/libr/debug/p/debug_io.c" 3 4
       1
# 73 "project/radare2/libr/debug/p/debug_io.c"
           ;
}
...
# 93 "project/radare2/libr/debug/p/debug_io.c" 3 4
                                            unsigned char 
# 93 "project/radare2/libr/debug/p/debug_io.c"
                                                *buf, int size) {
...
# 98 "project/radare2/libr/debug/p/debug_io.c" 3 4
  fprintf(__stderrp,
# 98 "project/radare2/libr/debug/p/debug_io.c"
...
# 104 "project/radare2/libr/debug/p/debug_io.c" 3 4
unsigned char 
# 104 "project/radare2/libr/debug/p/debug_io.c"
    *bregs = calloc (1, strlen (dr8));
 if (!bregs) {
  free (dr8);
  return -1;
 }
...
# 112 "project/radare2/libr/debug/p/debug_io.c" 3 4
 __builtin___memcpy_chk (
# 112 "project/radare2/libr/debug/p/debug_io.c"
 buf
# 112 "project/radare2/libr/debug/p/debug_io.c" 3 4
 , 
# 112 "project/radare2/libr/debug/p/debug_io.c"
...
static 
# 125 "project/radare2/libr/debug/p/debug_io.c" 3 4
      _Bool 
# 125 "project/radare2/libr/debug/p/debug_io.c"
           __io_continue(RDebug *dbg, int pid, int tid, int sig) {
 dbg->iob.system (dbg->iob.io, "dc");
 r_cons_flush ();
 return 
# 128 "project/radare2/libr/debug/p/debug_io.c" 3 4
       1
# 128 "project/radare2/libr/debug/p/debug_io.c"
           ;
}


static 
# 132 "project/radare2/libr/debug/p/debug_io.c" 3 4
      _Bool 
# 132 "project/radare2/libr/debug/p/debug_io.c"
           __io_kill(RDebug *dbg, int pid, int tid, int sig) {
 const char *cmd = sdb_fmt ("dk %d", sig);
 dbg->iob.system (dbg->iob.io, cmd);
 r_cons_flush ();
 return 
# 136 "project/radare2/libr/debug/p/debug_io.c" 3 4
       1
# 136 "project/radare2/libr/debug/p/debug_io.c"
           ;
}
...
RDebugPlugin r_debug_plugin_io = {
 ...
 .arch = "any",
 .bits = 
# 143 "project/radare2/libr/debug/p/debug_io.c" 3 4
        4 
# 143 "project/radare2/libr/debug/p/debug_io.c"
                      | 
# 143 "project/radare2/libr/debug/p/debug_io.c" 3 4
                        8
# 143 "project/radare2/libr/debug/p/debug_io.c"
...
# 164 "project/radare2/libr/debug/p/debug_io.c" 3 4
__attribute__((visibility("default"))) 
# 164 "project/radare2/libr/debug/p/debug_io.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_DBG,
 .data = &r_debug_plugin_io,
 .version = 
# 167 "project/radare2/libr/debug/p/debug_io.c" 3 4
           "5.5.4"

# 168 "project/radare2/libr/debug/p/debug_io.c"
};
