# 0 "project/radare2/libr/egg/egg_Cfile.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/egg/egg_Cfile.c"
...
# 4 "project/radare2/libr/egg/egg_Cfile.c" 2



# 6 "project/radare2/libr/egg/egg_Cfile.c"
struct cEnv_t {
 char *SFLIBPATH;
 char *CC;
 const char *OBJCOPY;
...
# 37 "project/radare2/libr/egg/egg_Cfile.c" 3 4
fprintf(__stderrp,
# 37 "project/radare2/libr/egg/egg_Cfile.c"
...
# 37 "project/radare2/libr/egg/egg_Cfile.c"
                                                        ;
 return 
# 38 "project/radare2/libr/egg/egg_Cfile.c" 3 4
       ((void *)0)
# 38 "project/radare2/libr/egg/egg_Cfile.c"
           ;
}

static inline 
# 41 "project/radare2/libr/egg/egg_Cfile.c" 3 4
             _Bool 
# 41 "project/radare2/libr/egg/egg_Cfile.c"
                  r_egg_Cfile_armOrMips(const char *arch) {
...
static inline 
# 59 "project/radare2/libr/egg/egg_Cfile.c" 3 4
             _Bool 
# 59 "project/radare2/libr/egg/egg_Cfile.c"
                  r_egg_Cfile_check_cEnv(struct cEnv_t *cEnv) {
 return (!cEnv->SFLIBPATH || !cEnv->CC || !cEnv->CFLAGS || !cEnv->LDFLAGS
  || !cEnv->SHDR || !cEnv->TRIPLET);
}

static inline 
# 64 "project/radare2/libr/egg/egg_Cfile.c" 3 4
             _Bool 
# 64 "project/radare2/libr/egg/egg_Cfile.c"
                  isXNU(const char *os) {
...
# 71 "project/radare2/libr/egg/egg_Cfile.c" 3 4
_Bool 
# 71 "project/radare2/libr/egg/egg_Cfile.c"
     use_clang;
 char *buffer = 
# 72 "project/radare2/libr/egg/egg_Cfile.c" 3 4
               ((void *)0)
# 72 "project/radare2/libr/egg/egg_Cfile.c"
                   ;
 char *output = 
# 73 "project/radare2/libr/egg/egg_Cfile.c" 3 4
               ((void *)0)
# 73 "project/radare2/libr/egg/egg_Cfile.c"
                   ;

 if (!cEnv) {
  return 
# 76 "project/radare2/libr/egg/egg_Cfile.c" 3 4
        ((void *)0)
# 76 "project/radare2/libr/egg/egg_Cfile.c"
            ;
 }
...
# 87 "project/radare2/libr/egg/egg_Cfile.c" 3 4
  fprintf(__stderrp,
# 87 "project/radare2/libr/egg/egg_Cfile.c"
  "Cannot find SFLIBPATH env var.\n" "Please define it, or fix r2 installation.\n"
# 87 "project/radare2/libr/egg/egg_Cfile.c" 3 4
  )
                                                     
# 88 "project/radare2/libr/egg/egg_Cfile.c"
                                                    ;
   goto fail;
  }
 ...
 use_clang = 
# 148 "project/radare2/libr/egg/egg_Cfile.c" 3 4
            0
# 148 "project/radare2/libr/egg/egg_Cfile.c"
                 ;
 if (!strcmp (cEnv->TRIPLET, "darwin-arm-64")) {
  free (cEnv->CC);
  cEnv->CC = strdup ("xcrun --sdk iphoneos gcc -arch arm64 -miphoneos-version-min=0.0");
  use_clang = 
# 152 "project/radare2/libr/egg/egg_Cfile.c" 3 4
             1
# 152 "project/radare2/libr/egg/egg_Cfile.c"
                 ;
  ...
  use_clang = 
# 157 "project/radare2/libr/egg/egg_Cfile.c" 3 4
             1
# 157 "project/radare2/libr/egg/egg_Cfile.c"
                 ;
  cEnv->TEXT = "0.__TEXT.__text";
 }
...
# 197 "project/radare2/libr/egg/egg_Cfile.c" 3 4
 fprintf(__stderrp,
# 197 "project/radare2/libr/egg/egg_Cfile.c"
...
fail:
 ...
 return 
# 209 "project/radare2/libr/egg/egg_Cfile.c" 3 4
       ((void *)0)
# 209 "project/radare2/libr/egg/egg_Cfile.c"
           ;
}

static 
# 212 "project/radare2/libr/egg/egg_Cfile.c" 3 4
      _Bool 
# 212 "project/radare2/libr/egg/egg_Cfile.c"
           r_egg_Cfile_parseCompiled(const char *file) {
 char *fileExt = r_str_newf ("%s.tmp", file);
 char *buffer = r_file_slurp (fileExt, 
# 214 "project/radare2/libr/egg/egg_Cfile.c" 3 4
                                      ((void *)0)
# 214 "project/radare2/libr/egg/egg_Cfile.c"
                                          );
 if (!buffer) {
  
# 216 "project/radare2/libr/egg/egg_Cfile.c" 3 4
 fprintf(__stderrp,
# 216 "project/radare2/libr/egg/egg_Cfile.c"
 "Could not open '%s'.\n", fileExt
# 216 "project/radare2/libr/egg/egg_Cfile.c" 3 4
 )
# 216 "project/radare2/libr/egg/egg_Cfile.c"
 ...
 buffer = r_str_replace (buffer, "rdata", "text", 
# 220 "project/radare2/libr/egg/egg_Cfile.c" 3 4
                                                 0
# 220 "project/radare2/libr/egg/egg_Cfile.c"
                                                      );
 buffer = r_str_replace (buffer, "rodata", "text", 
# 221 "project/radare2/libr/egg/egg_Cfile.c" 3 4
                                                  0
# 221 "project/radare2/libr/egg/egg_Cfile.c"
                                                       );
 buffer = r_str_replace (buffer, "get_pc_thunk.bx", "__getesp__", 
# 222 "project/radare2/libr/egg/egg_Cfile.c" 3 4
                                                                 1
# 222 "project/radare2/libr/egg/egg_Cfile.c"
                                                                     );
 ...
 if (!r_file_dump (fileExt, (const 
# 232 "project/radare2/libr/egg/egg_Cfile.c" 3 4
                                  unsigned char
# 232 "project/radare2/libr/egg/egg_Cfile.c"
...
# 233 "project/radare2/libr/egg/egg_Cfile.c" 3 4
 fprintf(__stderrp,
# 233 "project/radare2/libr/egg/egg_Cfile.c"
...
# 233 "project/radare2/libr/egg/egg_Cfile.c"
 ...
 free (fileExt);
 return 
# 239 "project/radare2/libr/egg/egg_Cfile.c" 3 4
       1
# 239 "project/radare2/libr/egg/egg_Cfile.c"
           ;
...
fail:
 ...
 free (fileExt);
 return 
# 244 "project/radare2/libr/egg/egg_Cfile.c" 3 4
       0
# 244 "project/radare2/libr/egg/egg_Cfile.c"
            ;
}


# 247 "project/radare2/libr/egg/egg_Cfile.c" 3 4
__attribute__((visibility("default"))) 
# 247 "project/radare2/libr/egg/egg_Cfile.c"
     char* r_egg_Cfile_parser(const char *file, const char *arch, const char *os, int bits) {
 char *output = 
# 248 "project/radare2/libr/egg/egg_Cfile.c" 3 4
               ((void *)0)
# 248 "project/radare2/libr/egg/egg_Cfile.c"
                   ;
 char *fileExt = 
# 249 "project/radare2/libr/egg/egg_Cfile.c" 3 4
                ((void *)0)
# 249 "project/radare2/libr/egg/egg_Cfile.c"
                    ;
...
# 260 "project/radare2/libr/egg/egg_Cfile.c" 3 4
fprintf(__stderrp,
# 260 "project/radare2/libr/egg/egg_Cfile.c"
"%s\n", cmd
# 260 "project/radare2/libr/egg/egg_Cfile.c" 3 4
)
# 260 "project/radare2/libr/egg/egg_Cfile.c"
 ...
 if (!r_file_dump (fileExt, (const 
# 270 "project/radare2/libr/egg/egg_Cfile.c" 3 4
                                  unsigned char
# 270 "project/radare2/libr/egg/egg_Cfile.c"
                                     *) cEnv->SHDR, strlen (cEnv->SHDR), 
# 270 "project/radare2/libr/egg/egg_Cfile.c" 3 4
                                                                         0
# 270 "project/radare2/libr/egg/egg_Cfile.c"
                                                                              )) {
  
# 271 "project/radare2/libr/egg/egg_Cfile.c" 3 4
 fprintf(__stderrp,
# 271 "project/radare2/libr/egg/egg_Cfile.c"
 "Error while opening %s.s\n", file
# 271 "project/radare2/libr/egg/egg_Cfile.c" 3 4
 )
# 271 "project/radare2/libr/egg/egg_Cfile.c"
...
# 280 "project/radare2/libr/egg/egg_Cfile.c" 3 4
fprintf(__stderrp,
# 280 "project/radare2/libr/egg/egg_Cfile.c"
"%s\n", cmd
# 280 "project/radare2/libr/egg/egg_Cfile.c" 3 4
)
# 280 "project/radare2/libr/egg/egg_Cfile.c"
...
# 292 "project/radare2/libr/egg/egg_Cfile.c" 3 4
 fprintf(__stderrp,
# 292 "project/radare2/libr/egg/egg_Cfile.c"
 "Linkage failed!\n"
# 292 "project/radare2/libr/egg/egg_Cfile.c" 3 4
 )
# 292 "project/radare2/libr/egg/egg_Cfile.c"
...
# 302 "project/radare2/libr/egg/egg_Cfile.c" 3 4
 fprintf(__stderrp,
# 302 "project/radare2/libr/egg/egg_Cfile.c"
 "Cannot find %s.o\n", file
# 302 "project/radare2/libr/egg/egg_Cfile.c" 3 4
 )
# 302 "project/radare2/libr/egg/egg_Cfile.c"
...
# 311 "project/radare2/libr/egg/egg_Cfile.c" 3 4
 fprintf(__stderrp,
# 311 "project/radare2/libr/egg/egg_Cfile.c"
...
# 316 "project/radare2/libr/egg/egg_Cfile.c" 3 4
  fprintf(__stderrp,
# 316 "project/radare2/libr/egg/egg_Cfile.c"
  "objcopy failed!\n"
# 316 "project/radare2/libr/egg/egg_Cfile.c" 3 4
  )
# 316 "project/radare2/libr/egg/egg_Cfile.c"
 ...
 free (fileExt);
 if ((fileExt = r_str_newf ("%s.text", file)) == 
# 332 "project/radare2/libr/egg/egg_Cfile.c" 3 4
                                                ((void *)0)
# 332 "project/radare2/libr/egg/egg_Cfile.c"
                                                    ) {
  goto fail;
 }
...
fail:
 ...
 r_egg_Cfile_free_cEnv (cEnv);
 return 
# 344 "project/radare2/libr/egg/egg_Cfile.c" 3 4
       ((void *)0)
# 344 "project/radare2/libr/egg/egg_Cfile.c"
           ;
}
