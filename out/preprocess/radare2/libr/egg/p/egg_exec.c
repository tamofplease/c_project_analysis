# 0 "project/radare2/libr/egg/p/egg_exec.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/egg/p/egg_exec.c"
...
# 3 "project/radare2/libr/egg/p/egg_exec.c" 2
# 17 "project/radare2/libr/egg/p/egg_exec.c"

# 17 "project/radare2/libr/egg/p/egg_exec.c"
static 
# 17 "project/radare2/libr/egg/p/egg_exec.c" 3 4
      unsigned char 
# 17 "project/radare2/libr/egg/p/egg_exec.c"
          x86_osx_suid_binsh[] =
...
static 
# 24 "project/radare2/libr/egg/p/egg_exec.c" 3 4
      unsigned char 
# 24 "project/radare2/libr/egg/p/egg_exec.c"
          x86_osx_binsh[] =
 "\x41\xb0\x02\x49\xc1\xe0\x18\x49\x83\xc8\x17"
...
static 
# 33 "project/radare2/libr/egg/p/egg_exec.c" 3 4
      unsigned char 
# 33 "project/radare2/libr/egg/p/egg_exec.c"
          x86_linux_binsh[] =
 "\x31\xc0\x50\x68"
 "\x2f\x2f\x73\x68\x68\x2f\x62\x69\x6e"
 "\x89\xe3\x50\x53\x89\xe1\x99\xb0\x0b\xcd\x80";
# 45 "project/radare2/libr/egg/p/egg_exec.c"
static 
# 45 "project/radare2/libr/egg/p/egg_exec.c" 3 4
      unsigned char 
# 45 "project/radare2/libr/egg/p/egg_exec.c"
          x86_64_linux_binsh[] =
...
static 
# 48 "project/radare2/libr/egg/p/egg_exec.c" 3 4
      unsigned char 
# 48 "project/radare2/libr/egg/p/egg_exec.c"
          arm_linux_binsh[] =
...
static 
# 54 "project/radare2/libr/egg/p/egg_exec.c" 3 4
      unsigned char 
# 54 "project/radare2/libr/egg/p/egg_exec.c"
          thumb_linux_binsh[] =
...
static RBuffer *build (REgg *egg) {
 ...
 const 
# 60 "project/radare2/libr/egg/p/egg_exec.c" 3 4
      unsigned char 
# 60 "project/radare2/libr/egg/p/egg_exec.c"
          *sc = 
# 60 "project/radare2/libr/egg/p/egg_exec.c" 3 4
                ((void *)0)
# 60 "project/radare2/libr/egg/p/egg_exec.c"
 ...
 if (suid && *suid=='f') {
  free (suid);
  suid = 
# 67 "project/radare2/libr/egg/p/egg_exec.c" 3 4
        ((void *)0)
# 67 "project/radare2/libr/egg/p/egg_exec.c"
            ;
 }
 switch (egg->os) {
 case 
# 70 "project/radare2/libr/egg/p/egg_exec.c" 3 4
     0x0ad593a1
# 70 "project/radare2/libr/egg/p/egg_exec.c"
                 :
 case 
# 71 "project/radare2/libr/egg/p/egg_exec.c" 3 4
     0xd86d1ae2
# 71 "project/radare2/libr/egg/p/egg_exec.c"
                    :
  switch (egg->arch) {
  case R_SYS_ARCH_X86:
   if (suid) {
  ...
  break;
 case 
# 86 "project/radare2/libr/egg/p/egg_exec.c" 3 4
     0x5ca62a43
# 86 "project/radare2/libr/egg/p/egg_exec.c"
                   :
  if (suid) {
   
# 88 "project/radare2/libr/egg/p/egg_exec.c" 3 4
  fprintf(__stderrp,
# 88 "project/radare2/libr/egg/p/egg_exec.c"
  ...
  case R_SYS_ARCH_X86:
   ...
   case 64:
    ...
    if (shell && *shell) {
     ...
     if (len > sizeof (
# 101 "project/radare2/libr/egg/p/egg_exec.c" 3 4
                      long long
# 101 "project/radare2/libr/egg/p/egg_exec.c"
                          ) - 1) {
      *shell = 0;
      
# 103 "project/radare2/libr/egg/p/egg_exec.c" 3 4
     fprintf(__stderrp,
# 103 "project/radare2/libr/egg/p/egg_exec.c"
...
# 106 "project/radare2/libr/egg/p/egg_exec.c" 3 4
    long long 
# 106 "project/radare2/libr/egg/p/egg_exec.c"
         b = 0;
     
# 107 "project/radare2/libr/egg/p/egg_exec.c" 3 4
    __builtin___memcpy_chk (
# 107 "project/radare2/libr/egg/p/egg_exec.c"
    &b
# 107 "project/radare2/libr/egg/p/egg_exec.c" 3 4
    , 
# 107 "project/radare2/libr/egg/p/egg_exec.c"
...
# 107 "project/radare2/libr/egg/p/egg_exec.c"
                                      ;
     b = -b;
     shell = realloc (shell, sizeof (
# 109 "project/radare2/libr/egg/p/egg_exec.c" 3 4
                                    long long
# 109 "project/radare2/libr/egg/p/egg_exec.c"
                                        ) + 1);
     if (!shell) {
      break;
     }
     r_str_ncpy (shell, (char *)&b, sizeof (
# 113 "project/radare2/libr/egg/p/egg_exec.c" 3 4
                                           long long
# 113 "project/radare2/libr/egg/p/egg_exec.c"
                                               ));
     shell[sizeof (
# 114 "project/radare2/libr/egg/p/egg_exec.c" 3 4
                  long long
# 114 "project/radare2/libr/egg/p/egg_exec.c"
                      )] = 0;
     cd = 4;
     r_buf_set_bytes (buf, sc, strlen ((const char *)sc));
     r_buf_write_at (buf, cd, (const 
# 117 "project/radare2/libr/egg/p/egg_exec.c" 3 4
                                    unsigned char 
# 117 "project/radare2/libr/egg/p/egg_exec.c"
                                        *)shell, sizeof (
# 117 "project/radare2/libr/egg/p/egg_exec.c" 3 4
                                                         long long
# 117 "project/radare2/libr/egg/p/egg_exec.c"
...
# 122 "project/radare2/libr/egg/p/egg_exec.c" 3 4
   fprintf(__stderrp,
# 122 "project/radare2/libr/egg/p/egg_exec.c"
   "Unsupported arch %d bits\n", egg->bits
# 122 "project/radare2/libr/egg/p/egg_exec.c" 3 4
   )
# 122 "project/radare2/libr/egg/p/egg_exec.c"
                                                    ;
...
# 134 "project/radare2/libr/egg/p/egg_exec.c" 3 4
   fprintf(__stderrp,
# 134 "project/radare2/libr/egg/p/egg_exec.c"
   "Unsupported arch %d bits\n", egg->bits
# 134 "project/radare2/libr/egg/p/egg_exec.c" 3 4
   )
# 134 "project/radare2/libr/egg/p/egg_exec.c"
...
# 140 "project/radare2/libr/egg/p/egg_exec.c" 3 4
 fprintf(__stderrp,
# 140 "project/radare2/libr/egg/p/egg_exec.c"
 "Unsupported os %x\n", egg->os
# 140 "project/radare2/libr/egg/p/egg_exec.c" 3 4
 )
# 140 "project/radare2/libr/egg/p/egg_exec.c"
 ...
 if (sc) {
  ...
  if (shell && *shell) {
   if (cd) {
    r_buf_write_at (buf, cd, (const 
# 148 "project/radare2/libr/egg/p/egg_exec.c" 3 4
                                   unsigned char 
# 148 "project/radare2/libr/egg/p/egg_exec.c"
                                       *)shell, strlen (shell) + 1);
   } else {
    
# 150 "project/radare2/libr/egg/p/egg_exec.c" 3 4
   fprintf(__stderrp,
# 150 "project/radare2/libr/egg/p/egg_exec.c"
   "Cannot set shell\n"
# 150 "project/radare2/libr/egg/p/egg_exec.c" 3 4
   )
# 150 "project/radare2/libr/egg/p/egg_exec.c"
...
REggPlugin r_egg_plugin_exec = {
 .name = "exec",
 .type = 
# 162 "project/radare2/libr/egg/p/egg_exec.c" 3 4
        0
# 162 "project/radare2/libr/egg/p/egg_exec.c"
                              ,
...
# 168 "project/radare2/libr/egg/p/egg_exec.c" 3 4
__attribute__((visibility("default"))) 
# 168 "project/radare2/libr/egg/p/egg_exec.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_EGG,
 .data = &r_egg_plugin_exec,
 .version = 
# 171 "project/radare2/libr/egg/p/egg_exec.c" 3 4
           "5.5.4"

# 172 "project/radare2/libr/egg/p/egg_exec.c"
};
