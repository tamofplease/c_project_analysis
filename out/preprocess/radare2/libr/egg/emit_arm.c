# 0 "project/radare2/libr/egg/emit_arm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/egg/emit_arm.c"
...
# 4 "project/radare2/libr/egg/emit_arm.c" 2
# 17 "project/radare2/libr/egg/emit_arm.c"

# 17 "project/radare2/libr/egg/emit_arm.c"
static char *regs[] = { "r0", "r1", "r2", "r3", "r4" };
...
static char *emit_syscall(REgg *egg, int num) {
 ...
 switch (egg->os) {
 case 
# 28 "project/radare2/libr/egg/emit_arm.c" 3 4
     0xd86d1ae2
# 28 "project/radare2/libr/egg/emit_arm.c"
                    :
 case 
# 29 "project/radare2/libr/egg/emit_arm.c" 3 4
     0x0ad593a1
# 29 "project/radare2/libr/egg/emit_arm.c"
                 :
 case 
# 30 "project/radare2/libr/egg/emit_arm.c" 3 4
     0x0ad58830
# 30 "project/radare2/libr/egg/emit_arm.c"
                 :
 case 
# 31 "project/radare2/libr/egg/emit_arm.c" 3 4
     0x5cb23c16
# 31 "project/radare2/libr/egg/emit_arm.c"
                   :
  svc = 0x80;
  break;
 case 
# 34 "project/radare2/libr/egg/emit_arm.c" 3 4
     0x14945c70
# 34 "project/radare2/libr/egg/emit_arm.c"
                     :
  svc = 0x8000;
  break;
 case 
# 37 "project/radare2/libr/egg/emit_arm.c" 3 4
     0x5ca62a43
# 37 "project/radare2/libr/egg/emit_arm.c"
                   :
  svc = 0;
  break;
 }
 return r_str_newf (": mov ""r7" ", `.arg`\n: svc 0x%x\n", svc);
}
...
# 66 "project/radare2/libr/egg/emit_arm.c" 3 4
__builtin_va_start(
# 66 "project/radare2/libr/egg/emit_arm.c"
ap
# 66 "project/radare2/libr/egg/emit_arm.c" 3 4
,
# 66 "project/radare2/libr/egg/emit_arm.c"
...
# 67 "project/radare2/libr/egg/emit_arm.c" 3 4
__builtin___vsnprintf_chk (
# 67 "project/radare2/libr/egg/emit_arm.c"
buf
# 67 "project/radare2/libr/egg/emit_arm.c" 3 4
, 
# 67 "project/radare2/libr/egg/emit_arm.c"
...
# 69 "project/radare2/libr/egg/emit_arm.c" 3 4
__builtin_va_end(
# 69 "project/radare2/libr/egg/emit_arm.c"
ap
# 69 "project/radare2/libr/egg/emit_arm.c" 3 4
)
# 69 "project/radare2/libr/egg/emit_arm.c"
...
# 146 "project/radare2/libr/egg/emit_arm.c" 3 4
  __builtin___strncpy_chk (
# 146 "project/radare2/libr/egg/emit_arm.c"
  lastargs[num - 1]
# 146 "project/radare2/libr/egg/emit_arm.c" 3 4
  , 
# 146 "project/radare2/libr/egg/emit_arm.c"
  str, sizeof(lastargs[0]) - 1
# 146 "project/radare2/libr/egg/emit_arm.c" 3 4
...
# 149 "project/radare2/libr/egg/emit_arm.c" 3 4
   fprintf(__stderrp,
# 149 "project/radare2/libr/egg/emit_arm.c"
...
# 152 "project/radare2/libr/egg/emit_arm.c" 3 4
  __builtin___snprintf_chk (
# 152 "project/radare2/libr/egg/emit_arm.c"
  lastargs[num - 1]
# 152 "project/radare2/libr/egg/emit_arm.c" 3 4
  , 
# 152 "project/radare2/libr/egg/emit_arm.c"
...
# 152 "project/radare2/libr/egg/emit_arm.c"
 ...
 case '&':
  if (d) {
   r_egg_printf (egg, "  add ""fp" ", %d\n", d);
  }
  r_egg_printf (egg, "  push {""fp" "}\n");
  if (d) {
   r_egg_printf (egg, "  sub ""fp" ", %d\n", d);
  }
  break;
 }
}
...
# 181 "project/radare2/libr/egg/emit_arm.c" 3 4
__builtin___sprintf_chk (
# 181 "project/radare2/libr/egg/emit_arm.c"
str
# 181 "project/radare2/libr/egg/emit_arm.c" 3 4
, 0, __builtin_object_size (
# 181 "project/radare2/libr/egg/emit_arm.c"
...
static void emit_get_var(REgg *egg, int type, char *out, int idx) {
 switch (type) {
 case 0: 
# 193 "project/radare2/libr/egg/emit_arm.c" 3 4
        __builtin___sprintf_chk (
# 193 "project/radare2/libr/egg/emit_arm.c"
        out
# 193 "project/radare2/libr/egg/emit_arm.c" 3 4
        , 0, __builtin_object_size (
# 193 "project/radare2/libr/egg/emit_arm.c"
...
# 193 "project/radare2/libr/egg/emit_arm.c"
                                        ; break;
 case 1: 
# 194 "project/radare2/libr/egg/emit_arm.c" 3 4
        __builtin___sprintf_chk (
# 194 "project/radare2/libr/egg/emit_arm.c"
        out
# 194 "project/radare2/libr/egg/emit_arm.c" 3 4
        , 0, __builtin_object_size (
# 194 "project/radare2/libr/egg/emit_arm.c"
...
static void emit_branch(REgg *egg, char *b, char *g, char *e, char *n, int sz, const char *dst) {
 char *p, str[64];
 char *arg = 
# 209 "project/radare2/libr/egg/emit_arm.c" 3 4
            ((void *)0)
# 209 "project/radare2/libr/egg/emit_arm.c"
                ;
 char *op = "beq";
 ...
 r_egg_printf (egg, "  pop ""r7" "\n");
 r_egg_printf (egg, "  cmp %s, ""r7" "\n", p);
...
static void emit_load(REgg *egg, const char *dst, int sz) {
 switch (sz) {
 case 'l':
  r_egg_printf (egg, "  mov ""r7" ", %s\n", dst);
  r_egg_printf (egg, "  mov ""r7" ", [""r7" "]\n");
  break;
 case 'b':
  r_egg_printf (egg, "  mov ""r7" ", %s\n", dst);
  r_egg_printf (egg, "  movz ""r7" ", [""r7" "]\n");
  break;
 default:
