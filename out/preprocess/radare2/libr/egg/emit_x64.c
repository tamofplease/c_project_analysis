# 0 "project/radare2/libr/egg/emit_x64.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/egg/emit_x64.c"



# 1 "project/radare2/libr/egg/emit_x86.c" 1
...
# 19 "project/radare2/libr/egg/emit_x86.c"

# 19 "project/radare2/libr/egg/emit_x86.c"
static char *regs[] = { "rax", "rdi", "rsi", "rdx", "r10", "r8", "r9" };
# 35 "project/radare2/libr/egg/emit_x86.c"
static void emit_init (REgg *egg) {

if (0) {
 r_egg_printf (egg, "mov %%" "rsp" ", %%" "rbp" "\n");
} else {
 r_egg_printf (egg, "mov " "rbp" ", " "rsp" "\n");
}
}
...
# 57 "project/radare2/libr/egg/emit_x86.c" 3 4
 __builtin___snprintf_chk (
# 57 "project/radare2/libr/egg/emit_x86.c"
 p
# 57 "project/radare2/libr/egg/emit_x86.c" 3 4
 , 
# 57 "project/radare2/libr/egg/emit_x86.c"
...
# 59 "project/radare2/libr/egg/emit_x86.c"
                  ;
# 68 "project/radare2/libr/egg/emit_x86.c"
  break;
 default:
  return 
...
static void emit_frame_end (REgg *egg, int sz, int ctx) {
 if (sz>0) {
  if (0) {
   r_egg_printf (egg, "  add $%d, %%""rsp""\n", sz);
   r_egg_printf (egg, "  pop %%""rbp""\n");
  } else {
   r_egg_printf (egg, "  add ""rsp"", %d\n", sz);
   r_egg_printf (egg, "  pop ""rbp""\n");
  }
 }
 if (ctx > 0) {
...
# 138 "project/radare2/libr/egg/emit_x86.c"
  ...
  if (0) {
   r_egg_printf (egg, "  mov %d(%%""rsp""), %%%s\n", k, reg);
  } else {
   if (k > 0) {
    r_egg_printf (egg, "  mov %s, [""rsp""+%d]\n", reg, k);
   } else if (k < 0) {
    r_egg_printf (egg, "  mov %s, [""rsp""%d]\n", reg, k);
   } else {
    r_egg_printf (egg, "  mov %s, [""rsp""]\n", reg);
   }
  }
 }
}
...
# 173 "project/radare2/libr/egg/emit_x86.c"
                 *)(s+i-4);
  p = r_egg_mkvar (egg, str2, dstvar, i+(8 -4));
  if (0) {
 ...
 p = r_egg_mkvar (egg, str2, dstvar, j+4+(8 -4));
 if (0) {
  r_egg_printf (egg, "  lea %s, %%" "rax" "\n", p);
 } else {
  r_egg_printf (egg, "  lea " "rax" ", %s\n", p);
 }
 free (p);

 p = r_egg_mkvar (egg, str2, dstvar, 0);
 if (0) {
  r_egg_printf (egg, "  mov %%" "rax" ", %s\n", p);
 } else {
  r_egg_printf (egg, "  mov %s, " "rax" "\n", p);
 }
 free (p);
...
static void emit_arg (REgg *egg, int xs, int num, const char *str) {
 ...
 case '&':
  if (0) {
   if (d != 0) {
    r_egg_printf (egg, "  addl $%d, %%" "rbp" "\n", d);
   }
   r_egg_printf (egg, "  pushl %%""rbp""\n");
   if (d != 0) {
    r_egg_printf (egg, "  subl $%d, %%" "rbp" "\n", d);
   }
  } else {
   if (d != 0) {
    r_egg_printf (egg, "  add " "rbp" ", %d\n", d);
   }
   r_egg_printf (egg, "  push ""rbp""\n");
   if (d != 0) {
    r_egg_printf (egg, "  sub " "rbp" ", %d\n", d);
   }
  }
  break;
 }
...
static void emit_restore_stack (REgg *egg, int size) {
 if (0) {
  r_egg_printf (egg, "  add $%d, %%" "rsp" " /* args */\n", size);
 } else {
  r_egg_printf (egg, "  add " "rsp" ", %d\n", size);
 }
}
...
static void emit_while_end (REgg *egg, const char *labelback) {
  ...
  r_egg_printf (egg, "  pop ""rax""\n");
  r_egg_printf (egg, "  test ""rax"", ""rax""\n");
...
static void emit_load_ptr(REgg *egg, const char *dst) {
 ...
 if (0) {
  r_egg_printf (egg, "  leal %d(%%""rbp""), %%""rax""\n", d);
 } else {
  r_egg_printf (egg, "  lea ""rax"", [""rbp""+%d]\n", d);
 }
...
# 409 "project/radare2/libr/egg/emit_x86.c"
 ...
 if (0) {
  r_egg_printf (egg, "  pop %%""rax""\n");
  r_egg_printf (egg, "  cmp%c %s, %%""rax""\n", sz, p);
 } else {
  r_egg_printf (egg, "  pop ""rax""\n");
  r_egg_printf (egg, "  cmp ""rax"", %s\n", p);
 }
...
static void emit_load(REgg *egg, const char *dst, int sz) {
 if (0) {
  switch (sz) {
  case 'l':
   r_egg_printf (egg, "  movl %s, %%""rax""\n", dst);
   r_egg_printf (egg, "  movl (%%""rax""), %%""rax""\n");
   break;
  case 'b':
   r_egg_printf (egg, "  movl %s, %%""rax""\n", dst);
   r_egg_printf (egg, "  movzb (%%""rax""), %%""rax""\n");
   break;
  default:

   r_egg_printf (egg, "  mov%c %s, %%""rax""\n", sz, dst);
   r_egg_printf (egg, "  mov%c (%%""rax""), %%""rax""\n", sz);
  }
 } else {
  switch (sz) {
  case 'l':
   r_egg_printf (egg, "  mov ""rax"", %s\n", dst);
   r_egg_printf (egg, "  mov ""rax"", [""rax""]\n");
   break;
  case 'b':
   r_egg_printf (egg, "  mov ""rax"", %s\n", dst);
   r_egg_printf (egg, "  movz ""rax"", [""rax""]\n");
   break;
  default:
...
static void emit_get_ar (REgg *egg, char *out, int idx) {
 const char *reg = emit_regs (egg, 1 + idx);
...
# 5 "project/radare2/libr/egg/emit_x64.c" 2
