# 0 "project/radare2/libr/hash/adler32.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/libr/hash/adler32.c" 2

__attribute__((visibility("default"))) unsigned int 
# 5 "project/radare2/libr/hash/adler32.c"
          r_hash_adler32(const 
# 5 "project/radare2/libr/hash/adler32.c" 3 4
                               unsigned char 
# 5 "project/radare2/libr/hash/adler32.c"
                                   *data, int len) {
 static const int MOD_ADLER = 65521;
 
# 7 "project/radare2/libr/hash/adler32.c" 3 4
unsigned int 
# 7 "project/radare2/libr/hash/adler32.c"
     a = 1, b = 0;
 int index;
