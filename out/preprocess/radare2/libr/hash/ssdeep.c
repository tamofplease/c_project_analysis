# 0 "project/radare2/libr/hash/ssdeep.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/hash/ssdeep.c"
...
# 6 "project/radare2/libr/hash/ssdeep.c" 2
...
# 7 "project/radare2/libr/hash/ssdeep.c" 2
...
# 14 "project/radare2/libr/hash/ssdeep.c"
typedef struct {
 
# 15 "project/radare2/libr/hash/ssdeep.c" 3 4
unsigned char 
# 15 "project/radare2/libr/hash/ssdeep.c"
    window[7];
 
# 16 "project/radare2/libr/hash/ssdeep.c" 3 4
unsigned int 
# 16 "project/radare2/libr/hash/ssdeep.c"
     h1;
 
# 17 "project/radare2/libr/hash/ssdeep.c" 3 4
unsigned int 
# 17 "project/radare2/libr/hash/ssdeep.c"
     h2;
 
# 18 "project/radare2/libr/hash/ssdeep.c" 3 4
unsigned int 
# 18 "project/radare2/libr/hash/ssdeep.c"
     h3;
 
# 19 "project/radare2/libr/hash/ssdeep.c" 3 4
unsigned int 
# 19 "project/radare2/libr/hash/ssdeep.c"
     bh1;
 
# 20 "project/radare2/libr/hash/ssdeep.c" 3 4
unsigned int 
# 20 "project/radare2/libr/hash/ssdeep.c"
     bh2;
 size_t n;
 int bs;
 char hs1[64 + 1];
...
static inline 
# 31 "project/radare2/libr/hash/ssdeep.c" 3 4
             unsigned int 
# 31 "project/radare2/libr/hash/ssdeep.c"
                  sum_hash(
# 31 "project/radare2/libr/hash/ssdeep.c" 3 4
                           unsigned char 
# 31 "project/radare2/libr/hash/ssdeep.c"
...
# 31 "project/radare2/libr/hash/ssdeep.c"
                                       h) {
 return (h * 0x01000193) ^ c;
}

static inline 
# 35 "project/radare2/libr/hash/ssdeep.c" 3 4
             unsigned int 
# 35 "project/radare2/libr/hash/ssdeep.c"
                  roll_sum(State *s) {
 return s->h1 + s->h2 + s->h3;
}

static inline void roll_hash(State *s, 
# 39 "project/radare2/libr/hash/ssdeep.c" 3 4
                                      unsigned char 
# 39 "project/radare2/libr/hash/ssdeep.c"
                                          c) {
 s->h2 -= s->h1;
 s->h2 += 7 * c;
 s->h1 += c;
...
static inline void process_byte(State *s, 
# 53 "project/radare2/libr/hash/ssdeep.c" 3 4
                                         unsigned char 
# 53 "project/radare2/libr/hash/ssdeep.c"
                                             b) {
...
# 58 "project/radare2/libr/hash/ssdeep.c" 3 4
unsigned int 
# 58 "project/radare2/libr/hash/ssdeep.c"
     rh = roll_sum (s);
 if (rh % s->bs == s->bs - 1) {
  if (s->hs1_len < 64 - 1) {
...
# 65 "project/radare2/libr/hash/ssdeep.c" 3 4
 unsigned int 
# 65 "project/radare2/libr/hash/ssdeep.c"
      bs2 = s->bs * 2;
  if (rh % bs2 == bs2 - 1) {
   if (s->hs2_len < (64 / 2) - 1) {
...
# 84 "project/radare2/libr/hash/ssdeep.c" 3 4
__attribute__((visibility("default"))) 
# 84 "project/radare2/libr/hash/ssdeep.c"
     char *r_hash_ssdeep(const 
# 84 "project/radare2/libr/hash/ssdeep.c" 3 4
                               unsigned char 
# 84 "project/radare2/libr/hash/ssdeep.c"
                                   *buf, size_t len) {
 ...
 for (;;) {
  ...
  if (s.hs1_len < (64 / 2)) {
   ...
   if (!s.bs) {
    ...
    return 
# 98 "project/radare2/libr/hash/ssdeep.c" 3 4
          ((void *)0)
# 98 "project/radare2/libr/hash/ssdeep.c"
              ;
   }
   s.bh1 = 0x28021967;
   s.bh2 = 0x28021967;
