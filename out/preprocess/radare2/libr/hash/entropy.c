# 0 "project/radare2/libr/hash/entropy.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/libr/hash/entropy.c"
...
# 9 "project/radare2/libr/hash/entropy.c" 2
...
# 10 "project/radare2/libr/hash/entropy.c" 2
...
typedef int RRef;
# 11 "project/radare2/libr/hash/entropy.c" 2

__attribute__((visibility("default"))) 
# 12 "project/radare2/libr/hash/entropy.c"
     double r_hash_entropy(const 
# 12 "project/radare2/libr/hash/entropy.c" 3 4
                                 unsigned char 
# 12 "project/radare2/libr/hash/entropy.c"
                                     *data, 
# 12 "project/radare2/libr/hash/entropy.c" 3 4
...
# 16 "project/radare2/libr/hash/entropy.c" 3 4
unsigned long long 
# 16 "project/radare2/libr/hash/entropy.c"
     i, count[256] = {0};
 double h = 0;
 for (i = 0; i < size; i++) {
  count[data[i]]++;
...
# 29 "project/radare2/libr/hash/entropy.c" 3 4
__attribute__((visibility("default"))) 
# 29 "project/radare2/libr/hash/entropy.c"
     double r_hash_entropy_fraction(const 
# 29 "project/radare2/libr/hash/entropy.c" 3 4
                                          unsigned char 
# 29 "project/radare2/libr/hash/entropy.c"
                                              *data, 
...
# 29 "project/radare2/libr/hash/entropy.c"
 ...
 return size ? r_hash_entropy (data, size) /
  log2 ((double) 
# 31 "project/radare2/libr/hash/entropy.c" 3 4
                (((
# 31 "project/radare2/libr/hash/entropy.c"
                size
# 31 "project/radare2/libr/hash/entropy.c" 3 4
                )>(
# 31 "project/radare2/libr/hash/entropy.c"
