# 0 "project/radare2/shlr/winkd/iob_net.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 3 "project/radare2/shlr/winkd/iob_net.c" 2
...
# 5 "project/radare2/shlr/winkd/iob_net.c" 2
...
# 6 "project/radare2/shlr/winkd/iob_net.c" 2
...
# 7 "project/radare2/shlr/winkd/iob_net.c" 2
...
# 8 "project/radare2/shlr/winkd/iob_net.c" 2
...
# 6 "project/radare2/shlr/winkd/kd.h" 2
...
# 10 "project/radare2/shlr/winkd/iob_net.c" 2


typedef struct iobnet_t {
 RSocket *sock;
 
# 14 "project/radare2/shlr/winkd/iob_net.c" 3 4
_Bool 
# 14 "project/radare2/shlr/winkd/iob_net.c"
     hasDatakey;


 
# 17 "project/radare2/shlr/winkd/iob_net.c" 3 4
unsigned char 
# 17 "project/radare2/shlr/winkd/iob_net.c"
    buf[4096];
 int off;
 int size;
...
# 22 "project/radare2/shlr/winkd/iob_net.c" 3 4
unsigned char 
# 22 "project/radare2/shlr/winkd/iob_net.c"
    key[32];

 
# 24 "project/radare2/shlr/winkd/iob_net.c" 3 4
unsigned char 
# 24 "project/radare2/shlr/winkd/iob_net.c"
    datakey[32];

 
# 26 "project/radare2/shlr/winkd/iob_net.c" 3 4
unsigned char 
# 26 "project/radare2/shlr/winkd/iob_net.c"
    hmackey[32];

 
# 28 "project/radare2/shlr/winkd/iob_net.c" 3 4
unsigned char 
# 28 "project/radare2/shlr/winkd/iob_net.c"
    version;
} iobnet_t;
...
static const 
# 34 "project/radare2/shlr/winkd/iob_net.c" 3 4
            unsigned long long 
# 34 "project/radare2/shlr/winkd/iob_net.c"
                 pow36[] = { 1, 36, 1296, 46656, 1679616, 60466176, 2176782336,
 78364164096, 2821109907456, 101559956668416, 3656158440062976,
 131621703842267136, 4738381338321616896 };

static 
# 38 "project/radare2/shlr/winkd/iob_net.c" 3 4
      unsigned long long 
# 38 "project/radare2/shlr/winkd/iob_net.c"
           base36_decode(const char *str) {
 
# 39 "project/radare2/shlr/winkd/iob_net.c" 3 4
unsigned long long 
# 39 "project/radare2/shlr/winkd/iob_net.c"
     ret = 0;
 size_t i;
...
# 44 "project/radare2/shlr/winkd/iob_net.c" 3 4
 fprintf(__stderrp,
# 44 "project/radare2/shlr/winkd/iob_net.c"
...
# 51 "project/radare2/shlr/winkd/iob_net.c" 3 4
  fprintf(__stderrp,
# 51 "project/radare2/shlr/winkd/iob_net.c"
...
# 54 "project/radare2/shlr/winkd/iob_net.c" 3 4
 unsigned char 
# 54 "project/radare2/shlr/winkd/iob_net.c"
     v = d32[c - '0'];

  if (v == '$') {
   
# 57 "project/radare2/shlr/winkd/iob_net.c" 3 4
  fprintf(__stderrp,
# 57 "project/radare2/shlr/winkd/iob_net.c"
  "Error: %s is not a valid base36 encoded string\n", str
# 57 "project/radare2/shlr/winkd/iob_net.c" 3 4
  )
# 57 "project/radare2/shlr/winkd/iob_net.c"
  ...
  if (i == 12) {
   if (v > 3 || 
# 63 "project/radare2/shlr/winkd/iob_net.c" 3 4
               ((0xFFFFFFFFFFFFFFFFULL - (
# 63 "project/radare2/shlr/winkd/iob_net.c"
               ret
# 63 "project/radare2/shlr/winkd/iob_net.c" 3 4
               )) < (
# 63 "project/radare2/shlr/winkd/iob_net.c"
...
static 
# 78 "project/radare2/shlr/winkd/iob_net.c" 3 4
      _Bool 
# 78 "project/radare2/shlr/winkd/iob_net.c"
           _initializeDatakey(iobnet_t *obj, 
# 78 "project/radare2/shlr/winkd/iob_net.c" 3 4
                                             unsigned char 
# 78 "project/radare2/shlr/winkd/iob_net.c"
                                                 *resbuf, int size) {
 
# 79 "project/radare2/shlr/winkd/iob_net.c" 3 4
struct r_hash_t 
# 79 "project/radare2/shlr/winkd/iob_net.c"
      *ctx = r_hash_new (
# 79 "project/radare2/shlr/winkd/iob_net.c" 3 4
                         1
# 79 "project/radare2/shlr/winkd/iob_net.c"
...
# 79 "project/radare2/shlr/winkd/iob_net.c"
 ...
 if (!ctx) {
  return 
# 81 "project/radare2/shlr/winkd/iob_net.c" 3 4
        0
# 81 "project/radare2/shlr/winkd/iob_net.c"
             ;
 }

 r_hash_do_begin (ctx, 
# 84 "project/radare2/shlr/winkd/iob_net.c" 3 4
                      (1ULL << R_HASH_IDX_SHA256)
# 84 "project/radare2/shlr/winkd/iob_net.c"
                                   );
 r_hash_do_sha256 (ctx, obj->key, 
# 85 "project/radare2/shlr/winkd/iob_net.c" 3 4
                                 32
# 85 "project/radare2/shlr/winkd/iob_net.c"
                                                   );
 r_hash_do_sha256 (ctx, resbuf, size);
 r_hash_do_end (ctx, 
# 87 "project/radare2/shlr/winkd/iob_net.c" 3 4
                    (1ULL << R_HASH_IDX_SHA256)
# 87 "project/radare2/shlr/winkd/iob_net.c"
                                 );
 
# 88 "project/radare2/shlr/winkd/iob_net.c" 3 4
__builtin___memcpy_chk (
# 88 "project/radare2/shlr/winkd/iob_net.c"
obj->datakey
# 88 "project/radare2/shlr/winkd/iob_net.c" 3 4
, 
# 88 "project/radare2/shlr/winkd/iob_net.c"
...
# 88 "project/radare2/shlr/winkd/iob_net.c"
 ...
 r_hash_free (ctx);
 return 
# 91 "project/radare2/shlr/winkd/iob_net.c" 3 4
       1
# 91 "project/radare2/shlr/winkd/iob_net.c"
           ;
}
...
static void *iob_net_open(const char *path) {
 ...
 iobnet_t *obj = 
# 97 "project/radare2/shlr/winkd/iob_net.c" 3 4
                (
# 97 "project/radare2/shlr/winkd/iob_net.c"
                iobnet_t
# 97 "project/radare2/shlr/winkd/iob_net.c" 3 4
                *)calloc(1,sizeof(
# 97 "project/radare2/shlr/winkd/iob_net.c"
...
# 97 "project/radare2/shlr/winkd/iob_net.c"
 ...
 if (!obj) {
  return 
# 99 "project/radare2/shlr/winkd/iob_net.c" 3 4
        ((void *)0)
# 99 "project/radare2/shlr/winkd/iob_net.c"
            ;
 }
 ...
 if (
# 104 "project/radare2/shlr/winkd/iob_net.c" 3 4
    (!(
# 104 "project/radare2/shlr/winkd/iob_net.c"
    port
# 104 "project/radare2/shlr/winkd/iob_net.c" 3 4
    ) || !*(
# 104 "project/radare2/shlr/winkd/iob_net.c"
...
# 105 "project/radare2/shlr/winkd/iob_net.c" 3 4
 fprintf(__stderrp,
# 105 "project/radare2/shlr/winkd/iob_net.c"
 "Missing port. Use winkd://host:udp-port:x.x.x.x.\n"
# 105 "project/radare2/shlr/winkd/iob_net.c" 3 4
 )
# 105 "project/radare2/shlr/winkd/iob_net.c"
                                                               ;
  ...
  free (obj);
  return 
# 108 "project/radare2/shlr/winkd/iob_net.c" 3 4
        ((void *)0)
# 108 "project/radare2/shlr/winkd/iob_net.c"
            ;
 }
 *port++ = 0;
 char *key = strchr (port, ':');
 if (
# 112 "project/radare2/shlr/winkd/iob_net.c" 3 4
    (!(
# 112 "project/radare2/shlr/winkd/iob_net.c"
    key
# 112 "project/radare2/shlr/winkd/iob_net.c" 3 4
    ) || !*(
# 112 "project/radare2/shlr/winkd/iob_net.c"
...
# 113 "project/radare2/shlr/winkd/iob_net.c" 3 4
 fprintf(__stderrp,
# 113 "project/radare2/shlr/winkd/iob_net.c"
 "Missing key. Use winkd://host:udp-port:x.x.x.x.\n"
# 113 "project/radare2/shlr/winkd/iob_net.c" 3 4
 )
# 113 "project/radare2/shlr/winkd/iob_net.c"
                                                              ;
  ...
  free (obj);
  return 
# 116 "project/radare2/shlr/winkd/iob_net.c" 3 4
        ((void *)0)
# 116 "project/radare2/shlr/winkd/iob_net.c"
            ;
 }
 *key++ = 0;
 ...
 if (!
# 136 "project/radare2/shlr/winkd/iob_net.c" 3 4
     r_socket_connect (
# 136 "project/radare2/shlr/winkd/iob_net.c"
     sock
# 136 "project/radare2/shlr/winkd/iob_net.c" 3 4
     , 
# 136 "project/radare2/shlr/winkd/iob_net.c"
...
# 136 "project/radare2/shlr/winkd/iob_net.c"
  ...
  r_socket_free (sock);
  return 
# 140 "project/radare2/shlr/winkd/iob_net.c" 3 4
        ((void *)0)
# 140 "project/radare2/shlr/winkd/iob_net.c"
            ;
 }
 obj->sock = sock;
...
static 
# 148 "project/radare2/shlr/winkd/iob_net.c" 3 4
      _Bool 
# 148 "project/radare2/shlr/winkd/iob_net.c"
           iob_net_close(void *p) {
 int ret = 
# 149 "project/radare2/shlr/winkd/iob_net.c" 3 4
          1
# 149 "project/radare2/shlr/winkd/iob_net.c"
              ;
 iobnet_t *obj = (iobnet_t *)p;

 if (r_socket_close (obj->sock)) {
  ret = 
# 153 "project/radare2/shlr/winkd/iob_net.c" 3 4
       0
# 153 "project/radare2/shlr/winkd/iob_net.c"
            ;
 }
...
static 
# 161 "project/radare2/shlr/winkd/iob_net.c" 3 4
      _Bool 
# 161 "project/radare2/shlr/winkd/iob_net.c"
           _encrypt(iobnet_t *obj, 
# 161 "project/radare2/shlr/winkd/iob_net.c" 3 4
                                   unsigned char 
# 161 "project/radare2/shlr/winkd/iob_net.c"
                                       *buf, int size, int type) {
 
# 162 "project/radare2/shlr/winkd/iob_net.c" 3 4
_Bool 
# 162 "project/radare2/shlr/winkd/iob_net.c"
     ret = 
# 162 "project/radare2/shlr/winkd/iob_net.c" 3 4
           0
# 162 "project/radare2/shlr/winkd/iob_net.c"
 ...
 if (!cry) {
  return 
# 165 "project/radare2/shlr/winkd/iob_net.c" 3 4
        0
# 165 "project/radare2/shlr/winkd/iob_net.c"
             ;
 }
 ...
 if (!r_crypto_set_iv (cry, buf + size - 16, 16)) {
  goto end;
 }


 if (r_crypto_final (cry, buf, size - 16) == 0) {
  goto end;
 }

 int sz;
 
# 198 "project/radare2/shlr/winkd/iob_net.c" 3 4
unsigned char 
# 198 "project/radare2/shlr/winkd/iob_net.c"
    *encbuf = r_crypto_get_output (cry, &sz);
 if (!encbuf) {
  goto end;
 }
 
# 202 "project/radare2/shlr/winkd/iob_net.c" 3 4
__builtin___memcpy_chk (
# 202 "project/radare2/shlr/winkd/iob_net.c"
buf
# 202 "project/radare2/shlr/winkd/iob_net.c" 3 4
, 
# 202 "project/radare2/shlr/winkd/iob_net.c"
...
# 202 "project/radare2/shlr/winkd/iob_net.c"
 ...
 free (encbuf);
 ret = 
# 205 "project/radare2/shlr/winkd/iob_net.c" 3 4
      1
# 205 "project/radare2/shlr/winkd/iob_net.c"
          ;
end:
 r_crypto_free (cry);
 return ret;
...
static 
# 221 "project/radare2/shlr/winkd/iob_net.c" 3 4
      unsigned char 
# 221 "project/radare2/shlr/winkd/iob_net.c"
          *_createKDNetPacket(iobnet_t *obj, const 
# 221 "project/radare2/shlr/winkd/iob_net.c" 3 4
                                                   unsigned char 
# 221 "project/radare2/shlr/winkd/iob_net.c"
                                                       *buf, int size, int *osize, 
# 221 "project/radare2/shlr/winkd/iob_net.c" 3 4
                                                                                   unsigned long long 
# 221 "project/radare2/shlr/winkd/iob_net.c"
                                                                                        seqno, 
...
# 224 "project/radare2/shlr/winkd/iob_net.c" 3 4
unsigned char 
# 224 "project/radare2/shlr/winkd/iob_net.c"
    padsize = -(size + 8) & 0x0F;

 int encsize = sizeof (kdnet_packet_t) + 8 + size + padsize + 16;
 
# 227 "project/radare2/shlr/winkd/iob_net.c" 3 4
unsigned char 
# 227 "project/radare2/shlr/winkd/iob_net.c"
    *encbuf = calloc (1, encsize);
 if (!encbuf) {
  return 
# 229 "project/radare2/shlr/winkd/iob_net.c" 3 4
        ((void *)0)
# 229 "project/radare2/shlr/winkd/iob_net.c"
            ;
 }


 r_write_at_be32 (encbuf, 0x4d444247, 0);
...
# 243 "project/radare2/shlr/winkd/iob_net.c" 3 4
__builtin___memcpy_chk (
# 243 "project/radare2/shlr/winkd/iob_net.c"
encbuf + sizeof (kdnet_packet_t) + 8
# 243 "project/radare2/shlr/winkd/iob_net.c" 3 4
, 
# 243 "project/radare2/shlr/winkd/iob_net.c"
buf, size
...
# 243 "project/radare2/shlr/winkd/iob_net.c"
 ...
 int off = sizeof (kdnet_packet_t) + 8 + size + padsize;
 
# 247 "project/radare2/shlr/winkd/iob_net.c" 3 4
struct r_hash_t 
# 247 "project/radare2/shlr/winkd/iob_net.c"
      *ctx = r_hash_new (
# 247 "project/radare2/shlr/winkd/iob_net.c" 3 4
                         1
# 247 "project/radare2/shlr/winkd/iob_net.c"
...
# 247 "project/radare2/shlr/winkd/iob_net.c"
 ...
 if (!ctx) {
  free (encbuf);
  return 
# 250 "project/radare2/shlr/winkd/iob_net.c" 3 4
        ((void *)0)
# 250 "project/radare2/shlr/winkd/iob_net.c"
            ;
 }
 r_hash_do_hmac_sha256 (ctx, encbuf, off, obj->hmackey, 32);

 
# 254 "project/radare2/shlr/winkd/iob_net.c" 3 4
__builtin___memcpy_chk (
# 254 "project/radare2/shlr/winkd/iob_net.c"
encbuf + off
# 254 "project/radare2/shlr/winkd/iob_net.c" 3 4
, 
# 254 "project/radare2/shlr/winkd/iob_net.c"
...
# 254 "project/radare2/shlr/winkd/iob_net.c"
 ...
 if (!_encrypt (obj, encbuf + sizeof (kdnet_packet_t), encsize - sizeof (kdnet_packet_t), type)) {
  free (encbuf);
  return 
# 260 "project/radare2/shlr/winkd/iob_net.c" 3 4
        ((void *)0)
# 260 "project/radare2/shlr/winkd/iob_net.c"
            ;
 }
...
static 
# 269 "project/radare2/shlr/winkd/iob_net.c" 3 4
      _Bool 
# 269 "project/radare2/shlr/winkd/iob_net.c"
           _decrypt(iobnet_t *obj, 
# 269 "project/radare2/shlr/winkd/iob_net.c" 3 4
                                   unsigned char 
# 269 "project/radare2/shlr/winkd/iob_net.c"
                                       *buf, int size, int type) {
 
# 270 "project/radare2/shlr/winkd/iob_net.c" 3 4
_Bool 
# 270 "project/radare2/shlr/winkd/iob_net.c"
     ret = 
# 270 "project/radare2/shlr/winkd/iob_net.c" 3 4
           0
# 270 "project/radare2/shlr/winkd/iob_net.c"
 ...
 if (!cry) {
  return 
# 273 "project/radare2/shlr/winkd/iob_net.c" 3 4
        0
# 273 "project/radare2/shlr/winkd/iob_net.c"
             ;
 }
 if (!r_crypto_use (cry, "aes-cbc")) {
  goto end;
...
# 306 "project/radare2/shlr/winkd/iob_net.c" 3 4
unsigned char 
# 306 "project/radare2/shlr/winkd/iob_net.c"
    *decbuf = r_crypto_get_output (cry, &sz);
 if (!decbuf) {
  goto end;
 }
 
# 310 "project/radare2/shlr/winkd/iob_net.c" 3 4
__builtin___memcpy_chk (
# 310 "project/radare2/shlr/winkd/iob_net.c"
buf
# 310 "project/radare2/shlr/winkd/iob_net.c" 3 4
, 
# 310 "project/radare2/shlr/winkd/iob_net.c"
...
# 310 "project/radare2/shlr/winkd/iob_net.c"
                                            ;
 ret = 
# 311 "project/radare2/shlr/winkd/iob_net.c" 3 4
      1
# 311 "project/radare2/shlr/winkd/iob_net.c"
          ;
...
static 
# 324 "project/radare2/shlr/winkd/iob_net.c" 3 4
      _Bool 
# 324 "project/radare2/shlr/winkd/iob_net.c"
           _sendResponsePacket(iobnet_t *obj, const 
# 324 "project/radare2/shlr/winkd/iob_net.c" 3 4
                                                    unsigned char 
# 324 "project/radare2/shlr/winkd/iob_net.c"
                                                        *pokedata) {
...
# 334 "project/radare2/shlr/winkd/iob_net.c" 3 4
unsigned char 
# 334 "project/radare2/shlr/winkd/iob_net.c"
    *resbuf = calloc (1, 322);
 if (!resbuf) {
  return 
# 336 "project/radare2/shlr/winkd/iob_net.c" 3 4
        0
# 336 "project/radare2/shlr/winkd/iob_net.c"
             ;
 }
...
# 342 "project/radare2/shlr/winkd/iob_net.c" 3 4
__builtin___memcpy_chk (
# 342 "project/radare2/shlr/winkd/iob_net.c"
resbuf + 2
# 342 "project/radare2/shlr/winkd/iob_net.c" 3 4
, 
# 342 "project/radare2/shlr/winkd/iob_net.c"
...
# 350 "project/radare2/shlr/winkd/iob_net.c" 3 4
unsigned long long 
# 350 "project/radare2/shlr/winkd/iob_net.c"
     seqno = r_read_be64 (pokedata) >> 8;
 
# 351 "project/radare2/shlr/winkd/iob_net.c" 3 4
unsigned char 
# 351 "project/radare2/shlr/winkd/iob_net.c"
    *pkt = _createKDNetPacket (obj, resbuf, 322, &size, seqno, 1);
 if (!pkt) {
  
# 353 "project/radare2/shlr/winkd/iob_net.c" 3 4
 { free((void *)
# 353 "project/radare2/shlr/winkd/iob_net.c"
 resbuf
# 353 "project/radare2/shlr/winkd/iob_net.c" 3 4
 ); 
# 353 "project/radare2/shlr/winkd/iob_net.c"
...
# 353 "project/radare2/shlr/winkd/iob_net.c"
 ...
 if (r_socket_write (obj->sock, (void *)pkt, size) < 0) {
  ...
  free (resbuf);
  return 
# 359 "project/radare2/shlr/winkd/iob_net.c" 3 4
        0
# 359 "project/radare2/shlr/winkd/iob_net.c"
             ;
 }

 _initializeDatakey (obj, resbuf, 322);
 obj->hasDatakey = 
# 363 "project/radare2/shlr/winkd/iob_net.c" 3 4
                  1
# 363 "project/radare2/shlr/winkd/iob_net.c"
                      ;

 free (pkt);
 free (resbuf);
 return 
# 367 "project/radare2/shlr/winkd/iob_net.c" 3 4
       1
# 367 "project/radare2/shlr/winkd/iob_net.c"
           ;
}

static 
# 370 "project/radare2/shlr/winkd/iob_net.c" 3 4
      _Bool 
# 370 "project/radare2/shlr/winkd/iob_net.c"
           _processControlPacket(iobnet_t *obj, const 
# 370 "project/radare2/shlr/winkd/iob_net.c" 3 4
                                                      unsigned char 
# 370 "project/radare2/shlr/winkd/iob_net.c"
                                                          *ctrlbuf, int size) {
 if (obj->hasDatakey) {
  return 
# 372 "project/radare2/shlr/winkd/iob_net.c" 3 4
        1
# 372 "project/radare2/shlr/winkd/iob_net.c"
            ;
 }

 
# 375 "project/radare2/shlr/winkd/iob_net.c" 3 4
unsigned long long 
# 375 "project/radare2/shlr/winkd/iob_net.c"
     kdnetdata = r_read_be64 (ctrlbuf);
 if ((kdnetdata & 0x80) != 0) {
  
# 377 "project/radare2/shlr/winkd/iob_net.c" 3 4
 fprintf(__stderrp,
# 377 "project/radare2/shlr/winkd/iob_net.c"
...
# 377 "project/radare2/shlr/winkd/iob_net.c"
                                                ;
  return 
# 378 "project/radare2/shlr/winkd/iob_net.c" 3 4
        0
# 378 "project/radare2/shlr/winkd/iob_net.c"
             ;
 }
...
# 383 "project/radare2/shlr/winkd/iob_net.c" 3 4
 fprintf(__stderrp,
# 383 "project/radare2/shlr/winkd/iob_net.c"
...
# 383 "project/radare2/shlr/winkd/iob_net.c"
                                                       ;
  return 
# 384 "project/radare2/shlr/winkd/iob_net.c" 3 4
        0
# 384 "project/radare2/shlr/winkd/iob_net.c"
             ;
 }

 return 
# 387 "project/radare2/shlr/winkd/iob_net.c" 3 4
       1
# 387 "project/radare2/shlr/winkd/iob_net.c"
           ;
}


# 390 "project/radare2/shlr/winkd/iob_net.c" 3 4
_Bool 
# 390 "project/radare2/shlr/winkd/iob_net.c"
    _verifyhmac(iobnet_t *obj) {
 
# 391 "project/radare2/shlr/winkd/iob_net.c" 3 4
struct r_hash_t 
# 391 "project/radare2/shlr/winkd/iob_net.c"
      *ctx = r_hash_new (
# 391 "project/radare2/shlr/winkd/iob_net.c" 3 4
                         1
# 391 "project/radare2/shlr/winkd/iob_net.c"
...
# 391 "project/radare2/shlr/winkd/iob_net.c"
 ...
 if (!ctx) {
  return 
# 393 "project/radare2/shlr/winkd/iob_net.c" 3 4
        0
# 393 "project/radare2/shlr/winkd/iob_net.c"
             ;
 }
 r_hash_do_hmac_sha256 (ctx, obj->buf, obj->size - 16, obj->hmackey, 32);
 int ret = memcmp (ctx->digest, obj->buf + obj->size - 16, 16);
 ...
 if (obj->size == 0) {
  do {
   ...
   if (obj->size < 0) {
    ...
    if (
# 411 "project/radare2/shlr/winkd/iob_net.c" 3 4
       (*__error()) 
# 411 "project/radare2/shlr/winkd/iob_net.c"
             == 
# 411 "project/radare2/shlr/winkd/iob_net.c" 3 4
                4
# 411 "project/radare2/shlr/winkd/iob_net.c"
...
# 417 "project/radare2/shlr/winkd/iob_net.c" 3 4
  __builtin___memcpy_chk (
# 417 "project/radare2/shlr/winkd/iob_net.c"
  &pkt
# 417 "project/radare2/shlr/winkd/iob_net.c" 3 4
  , 
# 417 "project/radare2/shlr/winkd/iob_net.c"
  obj->buf, sizeof (kdnet_packet_t)
# 417 "project/radare2/shlr/winkd/iob_net.c" 3 4
  , __builtin_object_size (
# 417 "project/radare2/shlr/winkd/iob_net.c"
  &pkt
...
# 417 "project/radare2/shlr/winkd/iob_net.c"
   ...
   if (r_read_be32 (obj->buf) != 0x4d444247) {
    
# 421 "project/radare2/shlr/winkd/iob_net.c" 3 4
   fprintf(__stderrp,
# 421 "project/radare2/shlr/winkd/iob_net.c"
...
# 434 "project/radare2/shlr/winkd/iob_net.c" 3 4
   fprintf(__stderrp,
# 434 "project/radare2/shlr/winkd/iob_net.c"
...
# 443 "project/radare2/shlr/winkd/iob_net.c" 3 4
    fprintf(__stderrp,
# 443 "project/radare2/shlr/winkd/iob_net.c"
...
# 452 "project/radare2/shlr/winkd/iob_net.c" 3 4
 unsigned char 
# 452 "project/radare2/shlr/winkd/iob_net.c"
     padsize = r_read_at_be64 (obj->buf, sizeof (kdnet_packet_t)) & 0xF;
  obj->size -= 16 + padsize;


  obj->off = sizeof (kdnet_packet_t) + 8;
...
# 466 "project/radare2/shlr/winkd/iob_net.c" 3 4
 fprintf(__stderrp,
# 466 "project/radare2/shlr/winkd/iob_net.c"
...
# 472 "project/radare2/shlr/winkd/iob_net.c" 3 4
__builtin___memcpy_chk (
# 472 "project/radare2/shlr/winkd/iob_net.c"
obuf
# 472 "project/radare2/shlr/winkd/iob_net.c" 3 4
, 
# 472 "project/radare2/shlr/winkd/iob_net.c"
obj->buf + obj->off, count
# 472 "project/radare2/shlr/winkd/iob_net.c" 3 4
, __builtin_object_size (
# 472 "project/radare2/shlr/winkd/iob_net.c"
obuf
...
static int iob_net_write(void *p, const uint8_t *buf, const uint64_t count, const int timeout) {
 static 
# 484 "project/radare2/shlr/winkd/iob_net.c" 3 4
       unsigned long long 
# 484 "project/radare2/shlr/winkd/iob_net.c"
            seqno = 1;
 iobnet_t *obj = (iobnet_t *)p;
...
# 491 "project/radare2/shlr/winkd/iob_net.c" 3 4
  __builtin___memcpy_chk (
# 491 "project/radare2/shlr/winkd/iob_net.c"
  &pkt
# 491 "project/radare2/shlr/winkd/iob_net.c" 3 4
  , 
# 491 "project/radare2/shlr/winkd/iob_net.c"
  buf, sizeof (kd_packet_t)
# 491 "project/radare2/shlr/winkd/iob_net.c" 3 4
  , __builtin_object_size (
# 491 "project/radare2/shlr/winkd/iob_net.c"
  &pkt
...
# 495 "project/radare2/shlr/winkd/iob_net.c" 3 4
  __builtin___memcpy_chk (
# 495 "project/radare2/shlr/winkd/iob_net.c"
  obj->buf
# 495 "project/radare2/shlr/winkd/iob_net.c" 3 4
  , 
# 495 "project/radare2/shlr/winkd/iob_net.c"
...
# 497 "project/radare2/shlr/winkd/iob_net.c" 3 4
  __builtin___memcpy_chk (
# 497 "project/radare2/shlr/winkd/iob_net.c"
  obj->buf
# 497 "project/radare2/shlr/winkd/iob_net.c" 3 4
  , 
# 497 "project/radare2/shlr/winkd/iob_net.c"
...
# 502 "project/radare2/shlr/winkd/iob_net.c" 3 4
 __builtin___memcpy_chk (
# 502 "project/radare2/shlr/winkd/iob_net.c"
 obj->buf + obj->off
# 502 "project/radare2/shlr/winkd/iob_net.c" 3 4
 , 
# 502 "project/radare2/shlr/winkd/iob_net.c"
...
# 508 "project/radare2/shlr/winkd/iob_net.c" 3 4
 unsigned char 
# 508 "project/radare2/shlr/winkd/iob_net.c"
     *pkt = _createKDNetPacket (obj, obj->buf, obj->size, &size, seqno, 0);
  if (!pkt) {
   return -1;
  }
  if (r_socket_write (obj->sock, (void *)pkt, size) < 0) {
...
io_backend_t iob_net = {
 ...
 .type = 1,
 .init = 
# 528 "project/radare2/shlr/winkd/iob_net.c" 3 4
        ((void *)0)
# 528 "project/radare2/shlr/winkd/iob_net.c"
            ,
 .deinit = 
# 529 "project/radare2/shlr/winkd/iob_net.c" 3 4
          ((void *)0)
# 529 "project/radare2/shlr/winkd/iob_net.c"
              ,
 .config = 
# 530 "project/radare2/shlr/winkd/iob_net.c" 3 4
          ((void *)0)
# 530 "project/radare2/shlr/winkd/iob_net.c"
              ,
 .open = &iob_net_open,
 .close = &iob_net_close,
 .read = &iob_net_read,
