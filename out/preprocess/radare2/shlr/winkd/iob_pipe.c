# 0 "project/radare2/shlr/winkd/iob_pipe.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/winkd/iob_pipe.c"
...
# 3 "project/radare2/shlr/winkd/iob_pipe.c" 2
...
# 4 "project/radare2/shlr/winkd/iob_pipe.c" 2
...
# 5 "project/radare2/shlr/winkd/iob_pipe.c" 2
...
typedef int RRef;
# 6 "project/radare2/shlr/winkd/iob_pipe.c" 2
...
# 7 "project/radare2/shlr/winkd/iob_pipe.c" 2
...
# 8 "project/radare2/shlr/winkd/iob_pipe.c" 2
# 57 "project/radare2/shlr/winkd/iob_pipe.c"
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/errno.h" 1 3 4
# 58 "project/radare2/shlr/winkd/iob_pipe.c" 2
...
# 61 "project/radare2/shlr/winkd/iob_pipe.c" 2


# 62 "project/radare2/shlr/winkd/iob_pipe.c"
static void *iob_pipe_open(const char *path) {
 int sock;
 struct sockaddr_un sa;

 sock = socket (
# 66 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
               1
# 66 "project/radare2/shlr/winkd/iob_pipe.c"
                      , 
# 66 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
                        1
# 66 "project/radare2/shlr/winkd/iob_pipe.c"
...
# 72 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
__builtin___memset_chk (
# 72 "project/radare2/shlr/winkd/iob_pipe.c"
&sa
# 72 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
, 
# 72 "project/radare2/shlr/winkd/iob_pipe.c"
...
# 72 "project/radare2/shlr/winkd/iob_pipe.c"
 ...
 sa.sun_family = 
# 74 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
                1
# 74 "project/radare2/shlr/winkd/iob_pipe.c"
                       ;
...
static 
# 85 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
      _Bool 
# 85 "project/radare2/shlr/winkd/iob_pipe.c"
           iob_pipe_close(void *p) {
...
# 98 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
 __builtin_bzero(
# 98 "project/radare2/shlr/winkd/iob_pipe.c"
 &readset
# 98 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
 , sizeof(*(
# 98 "project/radare2/shlr/winkd/iob_pipe.c"
...
# 99 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
 __darwin_fd_set((
# 99 "project/radare2/shlr/winkd/iob_pipe.c"
 fd
# 99 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
 ), (
# 99 "project/radare2/shlr/winkd/iob_pipe.c"
...
# 99 "project/radare2/shlr/winkd/iob_pipe.c"
                      ;
  result = select (fd + 1, &readset, 
# 100 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
                                    ((void *)0)
# 100 "project/radare2/shlr/winkd/iob_pipe.c"
                                        , 
# 100 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
                                          ((void *)0)
# 100 "project/radare2/shlr/winkd/iob_pipe.c"
  ...
  if (result < 1) {
   if (
# 102 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
      (*__error()) 
# 102 "project/radare2/shlr/winkd/iob_pipe.c"
            == 
# 102 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
               4
# 102 "project/radare2/shlr/winkd/iob_pipe.c"
  ...
  if (
# 110 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
     __darwin_fd_isset((
# 110 "project/radare2/shlr/winkd/iob_pipe.c"
     fd
# 110 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
     ), (
# 110 "project/radare2/shlr/winkd/iob_pipe.c"
...
# 110 "project/radare2/shlr/winkd/iob_pipe.c"
 ...
 return 
# 114 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
       4
# 114 "project/radare2/shlr/winkd/iob_pipe.c"
            ;
}
...
# 120 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
 r_sys_perror_str(
# 120 "project/radare2/shlr/winkd/iob_pipe.c"
 "iob_pipe_write, send"
# 120 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
 );
# 120 "project/radare2/shlr/winkd/iob_pipe.c"
                                      ;
  if (
# 121 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
     (*__error()) 
# 121 "project/radare2/shlr/winkd/iob_pipe.c"
           == 
# 121 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
              32
# 121 "project/radare2/shlr/winkd/iob_pipe.c"
...
io_backend_t iob_pipe = {
 ...
 .type = 0,
 .init = 
# 132 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
        ((void *)0)
# 132 "project/radare2/shlr/winkd/iob_pipe.c"
            ,
 .deinit = 
# 133 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
          ((void *)0)
# 133 "project/radare2/shlr/winkd/iob_pipe.c"
              ,
 .config = 
# 134 "project/radare2/shlr/winkd/iob_pipe.c" 3 4
          ((void *)0)
# 134 "project/radare2/shlr/winkd/iob_pipe.c"
              ,
 .open = &iob_pipe_open,
