# 0 "project/radare2/shlr/zip/zip/zip_source_free.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 37 "project/radare2/shlr/zip/zip/zip_source_free.c" 2
...
# 39 "project/radare2/shlr/zip/zip/zip_source_free.c" 2




# 42 "project/radare2/shlr/zip/zip/zip_source_free.c" 3 4
extern 
# 42 "project/radare2/shlr/zip/zip/zip_source_free.c"
          void
zip_source_free(struct zip_source *src)
{
    if (src == 
# 45 "project/radare2/shlr/zip/zip/zip_source_free.c" 3 4
              ((void *)0)
# 45 "project/radare2/shlr/zip/zip/zip_source_free.c"
                  )
 return;
 ...
 zip_source_close(src);
    ...
    if (src->src == 
# 51 "project/radare2/shlr/zip/zip/zip_source_free.c" 3 4
                   ((void *)0)
# 51 "project/radare2/shlr/zip/zip/zip_source_free.c"
                       )
 (void)src->cb.f(src->ud, 
# 52 "project/radare2/shlr/zip/zip/zip_source_free.c" 3 4
                         ((void *)0)
# 52 "project/radare2/shlr/zip/zip/zip_source_free.c"
                             , 0, ZIP_SOURCE_FREE);
    else {
 (void)src->cb.l(src->src, src->ud, 
# 54 "project/radare2/shlr/zip/zip/zip_source_free.c" 3 4
                                   ((void *)0)
# 54 "project/radare2/shlr/zip/zip/zip_source_free.c"
                                       , 0, ZIP_SOURCE_FREE);
