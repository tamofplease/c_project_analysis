# 0 "project/radare2/shlr/zip/zip/zip_get_num_files.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/zip/zip/zip_get_num_files.c"
# 37 "project/radare2/shlr/zip/zip/zip_get_num_files.c"
...
# 38 "project/radare2/shlr/zip/zip/zip_get_num_files.c" 2




# 41 "project/radare2/shlr/zip/zip/zip_get_num_files.c" 3 4
extern 
# 41 "project/radare2/shlr/zip/zip/zip_get_num_files.c"
          int
zip_get_num_files(struct zip *za)
{
    if (za == 
# 44 "project/radare2/shlr/zip/zip/zip_get_num_files.c" 3 4
             ((void *)0)
# 44 "project/radare2/shlr/zip/zip/zip_get_num_files.c"
                 )
 return -1;
