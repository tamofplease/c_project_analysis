# 0 "project/radare2/shlr/zip/zip/zip_utf-8.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/zip/zip/zip_utf-8.c"
# 36 "project/radare2/shlr/zip/zip/zip_utf-8.c"
...
# 37 "project/radare2/shlr/zip/zip/zip_utf-8.c" 2
...
# 119 "project/radare2/shlr/zip/zip/zip_utf-8.c"
enum zip_encoding_type
_zip_guess_encoding(struct zip_string *str, enum zip_encoding_type expected_encoding)
{
    ...
    if (str == 
# 126 "project/radare2/shlr/zip/zip/zip_utf-8.c" 3 4
              ((void *)0)
# 126 "project/radare2/shlr/zip/zip/zip_utf-8.c"
                  )
     ...
     zip_uint32_t *utf8_lenp, struct zip_error *error)
{
 ...
 if (utf8_lenp)
     *utf8_lenp = 0;
 return 
# 246 "project/radare2/shlr/zip/zip/zip_utf-8.c" 3 4
       ((void *)0)
# 246 "project/radare2/shlr/zip/zip/zip_utf-8.c"
           ;
    }
...
# 253 "project/radare2/shlr/zip/zip/zip_utf-8.c" 3 4
                                                 ((void *)0)
# 253 "project/radare2/shlr/zip/zip/zip_utf-8.c"
                                                     ) {
 _zip_error_set(error, 
# 254 "project/radare2/shlr/zip/zip/zip_utf-8.c" 3 4
                      14
# 254 "project/radare2/shlr/zip/zip/zip_utf-8.c"
                                   , 0);
 return 
# 255 "project/radare2/shlr/zip/zip/zip_utf-8.c" 3 4
       ((void *)0)
# 255 "project/radare2/shlr/zip/zip/zip_utf-8.c"
           ;
    }
