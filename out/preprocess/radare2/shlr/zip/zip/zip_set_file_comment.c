# 0 "project/radare2/shlr/zip/zip/zip_set_file_comment.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 37 "project/radare2/shlr/zip/zip/zip_set_file_comment.c" 2
...
# 40 "project/radare2/shlr/zip/zip/zip_set_file_comment.c" 2




# 43 "project/radare2/shlr/zip/zip/zip_set_file_comment.c" 3 4
extern 
# 43 "project/radare2/shlr/zip/zip/zip_set_file_comment.c"
          int
zip_set_file_comment(struct zip *za, zip_uint64_t idx, const char *comment, int len)
{
    if (len < 0 || len > 
# 46 "project/radare2/shlr/zip/zip/zip_set_file_comment.c" 3 4
                        0xFFFFU
# 46 "project/radare2/shlr/zip/zip/zip_set_file_comment.c"
                                      ) {
        _zip_error_set(&za->error, 
# 47 "project/radare2/shlr/zip/zip/zip_set_file_comment.c" 3 4
                                  18
# 47 "project/radare2/shlr/zip/zip/zip_set_file_comment.c"
                                              , 0);
        return -1;
    }
