# 0 "project/radare2/shlr/zip/zip/zip_unchange.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 37 "project/radare2/shlr/zip/zip/zip_unchange.c" 2
...
# 39 "project/radare2/shlr/zip/zip/zip_unchange.c" 2




# 42 "project/radare2/shlr/zip/zip/zip_unchange.c" 3 4
extern 
# 42 "project/radare2/shlr/zip/zip/zip_unchange.c"
          int
...
# 56 "project/radare2/shlr/zip/zip/zip_unchange.c" 3 4
                           18
# 56 "project/radare2/shlr/zip/zip/zip_unchange.c"
                                       , 0);
 return -1;
    }

    if (!allow_duplicates && za->entry[idx].changes && (za->entry[idx].changes->changed & 0x0002u)) {
 i = _zip_name_locate(za, _zip_get_name(za, idx, 
# 61 "project/radare2/shlr/zip/zip/zip_unchange.c" 3 4
                                                8u
# 61 "project/radare2/shlr/zip/zip/zip_unchange.c"
                                                                , 
# 61 "project/radare2/shlr/zip/zip/zip_unchange.c" 3 4
                                                                  ((void *)0)
# 61 "project/radare2/shlr/zip/zip/zip_unchange.c"
...
# 61 "project/radare2/shlr/zip/zip/zip_unchange.c"
 ...
 if (i >= 0 && (zip_uint64_t)i != idx) {
     _zip_error_set(&za->error, 
# 63 "project/radare2/shlr/zip/zip/zip_unchange.c" 3 4
                               10
# 63 "project/radare2/shlr/zip/zip/zip_unchange.c"
                                            , 0);
     return -1;
 }
    }
...
# 69 "project/radare2/shlr/zip/zip/zip_unchange.c" 3 4
                            ((void *)0)
# 69 "project/radare2/shlr/zip/zip/zip_unchange.c"
                                ;
