# 0 "project/radare2/shlr/zip/zip/zip_source_close.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 37 "project/radare2/shlr/zip/zip/zip_source_close.c" 2
...
zip_source_close(struct zip_source *src)
{
 ...
 return;
    ...
    if (src->src == 
# 46 "project/radare2/shlr/zip/zip/zip_source_close.c" 3 4
                   ((void *)0)
# 46 "project/radare2/shlr/zip/zip/zip_source_close.c"
                       )
 (void)src->cb.f(src->ud, 
# 47 "project/radare2/shlr/zip/zip/zip_source_close.c" 3 4
                         ((void *)0)
# 47 "project/radare2/shlr/zip/zip/zip_source_close.c"
                             , 0, ZIP_SOURCE_CLOSE);
    else {
 (void)src->cb.l(src->src, src->ud, 
# 49 "project/radare2/shlr/zip/zip/zip_source_close.c" 3 4
                                   ((void *)0)
# 49 "project/radare2/shlr/zip/zip/zip_source_close.c"
                                       , 0, ZIP_SOURCE_CLOSE);
