# 0 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 37 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c" 2
...
# 39 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c" 2




# 42 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c" 3 4
extern 
# 42 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c"
          int
zip_set_archive_comment(struct zip *za, const char *comment, zip_uint16_t len)
{
    ...
    if (((za)->ch_flags & 
# 47 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c" 3 4
       2u
# 47 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c"
       )) {
 _zip_error_set(&za->error, 
# 48 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c" 3 4
                           25
# 48 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c"
                                        , 0);
 return -1;
    }

    if (len > 0 && comment == 
# 52 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c" 3 4
                             ((void *)0)
# 52 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c"
                                 ) {
 _zip_error_set(&za->error, 
# 53 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c" 3 4
                           18
# 53 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c"
                                       , 0);
 return -1;
    }

    if (len > 0) {
 if ((cstr=_zip_string_new((const zip_uint8_t *)comment, len, 
# 58 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c" 3 4
                                                             0u
# 58 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c"
                                                                             , &za->error)) == 
# 58 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c" 3 4
                                                                                               ((void *)0)
# 58 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c"
 ...
 if (_zip_guess_encoding(cstr, ZIP_ENCODING_UNKNOWN) == ZIP_ENCODING_CP437) {
     ...
     _zip_error_set(&za->error, 
# 63 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c" 3 4
                               18
# 63 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c"
                                           , 0);
     return -1;
 }
    }
 ...
 cstr = 
# 68 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c" 3 4
       ((void *)0)
# 68 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c"
           ;

    _zip_string_free(za->comment_changes);
    za->comment_changes = 
# 71 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c" 3 4
                         ((void *)0)
# 71 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c"
                             ;

    if (((za->comment_orig && _zip_string_equal(za->comment_orig, cstr))
  || (za->comment_orig == 
# 74 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c" 3 4
                         ((void *)0) 
# 74 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c"
                              && cstr == 
# 74 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c" 3 4
                                         ((void *)0)
# 74 "project/radare2/shlr/zip/zip/zip_set_archive_comment.c"
