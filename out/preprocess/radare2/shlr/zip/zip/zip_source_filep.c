# 0 "project/radare2/shlr/zip/zip/zip_source_filep.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 37 "project/radare2/shlr/zip/zip/zip_source_filep.c" 2
...
# 38 "project/radare2/shlr/zip/zip/zip_source_filep.c" 2
...
# 39 "project/radare2/shlr/zip/zip/zip_source_filep.c" 2
...
# 40 "project/radare2/shlr/zip/zip/zip_source_filep.c" 2
...
# 41 "project/radare2/shlr/zip/zip/zip_source_filep.c" 2
...
# 43 "project/radare2/shlr/zip/zip/zip_source_filep.c" 2
...
# 61 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
extern 
# 61 "project/radare2/shlr/zip/zip/zip_source_filep.c"
          struct zip_source *
zip_source_filep(struct zip *za, FILE *file, zip_uint64_t start,
   zip_int64_t len)
{
    if (za == 
# 65 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
             ((void *)0)
# 65 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                 )
 return 
# 66 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
       ((void *)0)
# 66 "project/radare2/shlr/zip/zip/zip_source_filep.c"
           ;

    if (file == 
# 68 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
               ((void *)0) 
# 68 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                    || len < -1) {
 _zip_error_set(&za->error, 
# 69 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
                           18
# 69 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                                       , 0);
 return 
# 70 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
       ((void *)0)
# 70 "project/radare2/shlr/zip/zip/zip_source_filep.c"
           ;
    }

    return _zip_source_file_or_p(za, 
# 73 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
                                    ((void *)0)
# 73 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                                        , file, start, len, 1, 
# 73 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
                                                               ((void *)0)
# 73 "project/radare2/shlr/zip/zip/zip_source_filep.c"
        ...
        const struct zip_stat *st)
{
    ...
    if (file == 
# 86 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
               ((void *)0) 
# 86 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                    && fname == 
# 86 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
                                ((void *)0)
# 86 "project/radare2/shlr/zip/zip/zip_source_filep.c"
 ...
 _zip_error_set(&za->error, 
# 87 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
                           18
# 87 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                                       , 0);
 return 
# 88 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
       ((void *)0)
# 88 "project/radare2/shlr/zip/zip/zip_source_filep.c"
           ;
    }

    if ((f=(struct read_file *)malloc(sizeof(struct read_file))) == 
# 91 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
                                                                   ((void *)0)
# 91 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                                                                       ) {
 _zip_error_set(&za->error, 
# 92 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
                           14
# 92 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                                        , 0);
 return 
# 93 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
       ((void *)0)
# 93 "project/radare2/shlr/zip/zip/zip_source_filep.c"
           ;
    }

    f->fname = 
# 96 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
              ((void *)0)
# 96 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                  ;
    if (fname) {
 if ((f->fname=strdup(fname)) == 
# 98 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
                                ((void *)0)
# 98 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                                    ) {
     _zip_error_set(&za->error, 
# 99 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
                               14
# 99 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                                            , 0);
     free(f);
     return 
# 101 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
           ((void *)0)
# 101 "project/radare2/shlr/zip/zip/zip_source_filep.c"
               ;
 }
    }
    f->f = file;
...
# 109 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
__builtin___memcpy_chk (
# 109 "project/radare2/shlr/zip/zip/zip_source_filep.c"
&f->st
# 109 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
, 
# 109 "project/radare2/shlr/zip/zip/zip_source_filep.c"
...
# 113 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
                                                     ((void *)0)
# 113 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                                                         ) {
 free(f);
 return 
# 115 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
       ((void *)0)
# 115 "project/radare2/shlr/zip/zip/zip_source_filep.c"
           ;
    }
...
# 136 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
                                        ((void *)0)
# 136 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                                            ) {
  z->e[0] = 
# 137 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
           11
# 137 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                      ;
  z->e[1] = 
# 138 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
           (*__error())
# 138 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                ;
  return -1;
     }
 }
 ...
 if (z->closep && z->off > 0) {
     if (fseek(z->f, (off_t)z->off, 
# 144 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
                                    0
# 144 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                                            ) < 0) {
  z->e[0] = 
# 145 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
           4
# 145 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                      ;
  z->e[1] = 
# 146 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
           (*__error())
# 146 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                ;
  return -1;
     }
 }
 ...
 if (!z->closep) {
     ...
     if (fseek(z->f, (off_t)(z->off + (zip_uint64_t)(z->len-z->remain)), 
# 162 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
                                                                         0
# 162 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                                                                                 ) < 0) {
  z->e[0] = 
# 163 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
           4
# 163 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                      ;
  z->e[1] = 
# 164 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
           (*__error())
# 164 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                ;
  return -1;
     }
 }
 ...
 if ((i=fread(buf, 1, n, z->f)) == 0) {
            if (ferror(z->f)) {
                z->e[0] = 
# 171 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
                         5
# 171 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                                    ;
                z->e[1] = 
# 172 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
                         (*__error())
# 172 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                              ;
                return -1;
            }
 }
 ...
 if (z->fname) {
     fclose(z->f);
     z->f = 
# 185 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
           ((void *)0)
# 185 "project/radare2/shlr/zip/zip/zip_source_filep.c"
               ;
 }
 return 0;
...
# 195 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
 __builtin___memcpy_chk (
# 195 "project/radare2/shlr/zip/zip/zip_source_filep.c"
 data
# 195 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
 , 
# 195 "project/radare2/shlr/zip/zip/zip_source_filep.c"
...
# 195 "project/radare2/shlr/zip/zip/zip_source_filep.c"
  ...
  if (err != 0) {
      z->e[0] = 
# 207 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
               5
# 207 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                          ;
      z->e[1] = 
# 208 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
               (*__error())
# 208 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                    ;
      return -1;
  }
  ...
  zip_stat_init(st);
  st->mtime = fst.
# 215 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
                 st_mtimespec.tv_sec
# 215 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                         ;
  st->valid |= 
# 216 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
              0x0010u
# 216 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                            ;
  if (z->len != -1) {
      st->size = (zip_uint64_t)z->len;
      st->valid |= 
# 219 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
                  0x0004u
# 219 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                               ;
  }
  else if ((fst.st_mode&
# 221 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
                       0170000
# 221 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                             ) == 
# 221 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
                                  0100000
# 221 "project/radare2/shlr/zip/zip/zip_source_filep.c"
      ...
      st->valid |= 
# 223 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
                  0x0004u
# 223 "project/radare2/shlr/zip/zip/zip_source_filep.c"
                               ;
  }
     }
     return sizeof(z->st);
...
# 233 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
__builtin___memcpy_chk (
# 233 "project/radare2/shlr/zip/zip/zip_source_filep.c"
data
# 233 "project/radare2/shlr/zip/zip/zip_source_filep.c" 3 4
, 
# 233 "project/radare2/shlr/zip/zip/zip_source_filep.c"
