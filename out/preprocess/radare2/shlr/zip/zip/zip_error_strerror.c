# 0 "project/radare2/shlr/zip/zip/zip_error_strerror.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 37 "project/radare2/shlr/zip/zip/zip_error_strerror.c" 2
...
# 38 "project/radare2/shlr/zip/zip/zip_error_strerror.c" 2
...
# 39 "project/radare2/shlr/zip/zip/zip_error_strerror.c" 2
...
# 40 "project/radare2/shlr/zip/zip/zip_error_strerror.c" 2
...
# 42 "project/radare2/shlr/zip/zip/zip_error_strerror.c" 2
...
# 54 "project/radare2/shlr/zip/zip/zip_error_strerror.c" 3 4
__builtin___sprintf_chk (
# 54 "project/radare2/shlr/zip/zip/zip_error_strerror.c"
buf
# 54 "project/radare2/shlr/zip/zip/zip_error_strerror.c" 3 4
...
, 2 > 1 ? 1 : 0), 
# 54 "project/radare2/shlr/zip/zip/zip_error_strerror.c"
"Unknown error %d", err->zip_err
# 54 "project/radare2/shlr/zip/zip/zip_error_strerror.c" 3 4
)
# 54 "project/radare2/shlr/zip/zip/zip_error_strerror.c"
                                              ;
 zs = 
# 55 "project/radare2/shlr/zip/zip/zip_error_strerror.c" 3 4
     ((void *)0)
# 55 "project/radare2/shlr/zip/zip/zip_error_strerror.c"
         ;
 ss = buf;
    }
    else {
 ...
 case 
# 62 "project/radare2/shlr/zip/zip/zip_error_strerror.c" 3 4
     1
# 62 "project/radare2/shlr/zip/zip/zip_error_strerror.c"
               :
     ss = strerror(err->sys_err);
     break;

 case 
# 66 "project/radare2/shlr/zip/zip/zip_error_strerror.c" 3 4
     2
# 66 "project/radare2/shlr/zip/zip/zip_error_strerror.c"
                :
 ...
 default:
     ss = 
# 71 "project/radare2/shlr/zip/zip/zip_error_strerror.c" 3 4
         ((void *)0)
# 71 "project/radare2/shlr/zip/zip/zip_error_strerror.c"
             ;
 }
    }

    if (ss == 
# 75 "project/radare2/shlr/zip/zip/zip_error_strerror.c" 3 4
             ((void *)0)
# 75 "project/radare2/shlr/zip/zip/zip_error_strerror.c"
                 )
 return zs;
    else {
 if ((s=(char *)malloc(strlen(ss)
         + (zs ? strlen(zs)+2 : 0) + 1)) == 
# 79 "project/radare2/shlr/zip/zip/zip_error_strerror.c" 3 4
                                           ((void *)0)
# 79 "project/radare2/shlr/zip/zip/zip_error_strerror.c"
                                               )
     return _zip_err_str[
# 80 "project/radare2/shlr/zip/zip/zip_error_strerror.c" 3 4
                        14
# 80 "project/radare2/shlr/zip/zip/zip_error_strerror.c"
                                     ];

 
# 82 "project/radare2/shlr/zip/zip/zip_error_strerror.c" 3 4
__builtin___sprintf_chk (
# 82 "project/radare2/shlr/zip/zip/zip_error_strerror.c"
s
# 82 "project/radare2/shlr/zip/zip/zip_error_strerror.c" 3 4
, 0, __builtin_object_size (
# 82 "project/radare2/shlr/zip/zip/zip_error_strerror.c"
...
# 85 "project/radare2/shlr/zip/zip/zip_error_strerror.c"
    ;
 err->str = s;
