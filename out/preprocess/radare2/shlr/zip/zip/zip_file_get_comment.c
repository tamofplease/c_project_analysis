# 0 "project/radare2/shlr/zip/zip/zip_file_get_comment.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 37 "project/radare2/shlr/zip/zip/zip_file_get_comment.c" 2





# 41 "project/radare2/shlr/zip/zip/zip_file_get_comment.c" 3 4
extern 
# 41 "project/radare2/shlr/zip/zip/zip_file_get_comment.c"
          const char *
zip_file_get_comment(struct zip *za, zip_uint64_t idx, zip_uint32_t *lenp, zip_flags_t flags)
{
    ...
    if ((de=_zip_get_dirent(za, idx, flags, 
# 48 "project/radare2/shlr/zip/zip/zip_file_get_comment.c" 3 4
                                           ((void *)0)
# 48 "project/radare2/shlr/zip/zip/zip_file_get_comment.c"
                                               )) == 
# 48 "project/radare2/shlr/zip/zip/zip_file_get_comment.c" 3 4
                                                     ((void *)0)
# 48 "project/radare2/shlr/zip/zip/zip_file_get_comment.c"
 ...
 return 
# 49 "project/radare2/shlr/zip/zip/zip_file_get_comment.c" 3 4
       ((void *)0)
# 49 "project/radare2/shlr/zip/zip/zip_file_get_comment.c"
           ;

    if ((str=_zip_string_get(de->comment, &len, flags, &za->error)) == 
# 51 "project/radare2/shlr/zip/zip/zip_file_get_comment.c" 3 4
                                                                      ((void *)0)
# 51 "project/radare2/shlr/zip/zip/zip_file_get_comment.c"
                                                                          )
 return 
# 52 "project/radare2/shlr/zip/zip/zip_file_get_comment.c" 3 4
       ((void *)0)
# 52 "project/radare2/shlr/zip/zip/zip_file_get_comment.c"
           ;
