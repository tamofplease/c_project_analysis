# 0 "project/radare2/shlr/zip/zip/zip_source_window.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 37 "project/radare2/shlr/zip/zip/zip_source_window.c" 2
...
# 38 "project/radare2/shlr/zip/zip/zip_source_window.c" 2
...
# 40 "project/radare2/shlr/zip/zip/zip_source_window.c" 2
...
zip_source_window(struct zip *za, struct zip_source *src, zip_uint64_t start, zip_uint64_t len)
{
    ...
    if (src == 
# 58 "project/radare2/shlr/zip/zip/zip_source_window.c" 3 4
              ((void *)0)
# 58 "project/radare2/shlr/zip/zip/zip_source_window.c"
                  ) {
 _zip_error_set(&za->error, 
# 59 "project/radare2/shlr/zip/zip/zip_source_window.c" 3 4
                           18
# 59 "project/radare2/shlr/zip/zip/zip_source_window.c"
                                       , 0);
 return 
# 60 "project/radare2/shlr/zip/zip/zip_source_window.c" 3 4
       ((void *)0)
# 60 "project/radare2/shlr/zip/zip/zip_source_window.c"
           ;
    }

    if ((ctx=(struct window *)malloc(sizeof(*ctx))) == 
# 63 "project/radare2/shlr/zip/zip/zip_source_window.c" 3 4
                                                      ((void *)0)
# 63 "project/radare2/shlr/zip/zip/zip_source_window.c"
                                                          ) {
 _zip_error_set(&za->error, 
# 64 "project/radare2/shlr/zip/zip/zip_source_window.c" 3 4
                           14
# 64 "project/radare2/shlr/zip/zip/zip_source_window.c"
                                        , 0);
 return 
# 65 "project/radare2/shlr/zip/zip/zip_source_window.c" 3 4
       ((void *)0)
# 65 "project/radare2/shlr/zip/zip/zip_source_window.c"
           ;
    }
     ...
     zip_uint64_t len, enum zip_source_cmd cmd)
{
 ...
 for (n=0; n<ctx->skip; n+=(zip_uint64_t)ret) {
  ...
  return 
# 93 "project/radare2/shlr/zip/zip/zip_source_window.c" 3 4
        -2
# 93 "project/radare2/shlr/zip/zip/zip_source_window.c"
                            ;
     if (ret==0) {
  ctx->e[0] = 
# 95 "project/radare2/shlr/zip/zip/zip_source_window.c" 3 4
             17
# 95 "project/radare2/shlr/zip/zip/zip_source_window.c"
                       ;
  ctx->e[1] = 0;
  return -1;
     }
 ...
 if ((ret=zip_source_read(src, data, len)) < 0)
     return 
# 110 "project/radare2/shlr/zip/zip/zip_source_window.c" 3 4
           -2
# 110 "project/radare2/shlr/zip/zip/zip_source_window.c"
                               ;
 ...
 ctx->left -= (zip_uint64_t)ret;
     ...
     if (ctx->left > 0) {
  ctx->e[0] = 
# 116 "project/radare2/shlr/zip/zip/zip_source_window.c" 3 4
             17
# 116 "project/radare2/shlr/zip/zip/zip_source_window.c"
                       ;
  ctx->e[1] = 0;
  return -1;
     }
    ...
    case ZIP_SOURCE_STAT:
 {
     ...
     st->size = ctx->len;
     st->valid |= 
# 133 "project/radare2/shlr/zip/zip/zip_source_window.c" 3 4
                 0x0004u
# 133 "project/radare2/shlr/zip/zip/zip_source_window.c"
                              ;
     st->valid &= ~(
# 134 "project/radare2/shlr/zip/zip/zip_source_window.c" 3 4
                   0x0020u
# 134 "project/radare2/shlr/zip/zip/zip_source_window.c"
                               |
# 134 "project/radare2/shlr/zip/zip/zip_source_window.c" 3 4
                                0x0008u
# 134 "project/radare2/shlr/zip/zip/zip_source_window.c"
...
# 139 "project/radare2/shlr/zip/zip/zip_source_window.c" 3 4
__builtin___memcpy_chk (
# 139 "project/radare2/shlr/zip/zip/zip_source_window.c"
data
# 139 "project/radare2/shlr/zip/zip/zip_source_window.c" 3 4
, 
# 139 "project/radare2/shlr/zip/zip/zip_source_window.c"
