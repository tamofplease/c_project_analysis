# 0 "project/radare2/shlr/zip/zip/zip_error_to_str.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 37 "project/radare2/shlr/zip/zip/zip_error_to_str.c" 2
...
# 38 "project/radare2/shlr/zip/zip/zip_error_to_str.c" 2
...
# 39 "project/radare2/shlr/zip/zip/zip_error_to_str.c" 2
...
# 40 "project/radare2/shlr/zip/zip/zip_error_to_str.c" 2
...
# 42 "project/radare2/shlr/zip/zip/zip_error_to_str.c" 2




# 45 "project/radare2/shlr/zip/zip/zip_error_to_str.c" 3 4
extern 
# 45 "project/radare2/shlr/zip/zip/zip_error_to_str.c"
          int
zip_error_to_str(char *buf, zip_uint64_t len, int ze, int se)
{
 ...
 return 
# 51 "project/radare2/shlr/zip/zip/zip_error_to_str.c" 3 4
       __builtin___snprintf_chk (
# 51 "project/radare2/shlr/zip/zip/zip_error_to_str.c"
       buf
# 51 "project/radare2/shlr/zip/zip/zip_error_to_str.c" 3 4
       , 
# 51 "project/radare2/shlr/zip/zip/zip_error_to_str.c"
...
# 51 "project/radare2/shlr/zip/zip/zip_error_to_str.c"
    ...
    case 
# 56 "project/radare2/shlr/zip/zip/zip_error_to_str.c" 3 4
        1
# 56 "project/radare2/shlr/zip/zip/zip_error_to_str.c"
                  :
 ss = strerror(se);
 break;

    case 
# 60 "project/radare2/shlr/zip/zip/zip_error_to_str.c" 3 4
        2
# 60 "project/radare2/shlr/zip/zip/zip_error_to_str.c"
                   :
 ss = zError(se);
 break;
    ...
    default:
 ss = 
# 65 "project/radare2/shlr/zip/zip/zip_error_to_str.c" 3 4
     ((void *)0)
# 65 "project/radare2/shlr/zip/zip/zip_error_to_str.c"
         ;
    }

    return 
# 68 "project/radare2/shlr/zip/zip/zip_error_to_str.c" 3 4
          __builtin___snprintf_chk (
# 68 "project/radare2/shlr/zip/zip/zip_error_to_str.c"
          buf
# 68 "project/radare2/shlr/zip/zip/zip_error_to_str.c" 3 4
          , 
# 68 "project/radare2/shlr/zip/zip/zip_error_to_str.c"
...
# 69 "project/radare2/shlr/zip/zip/zip_error_to_str.c"
                                          ;
}
