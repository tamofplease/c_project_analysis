# 0 "project/radare2/shlr/zip/zip/zip_error.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 37 "project/radare2/shlr/zip/zip/zip_error.c" 2
...
# 39 "project/radare2/shlr/zip/zip/zip_error.c" 2
...
{
    if (err == 
# 45 "project/radare2/shlr/zip/zip/zip_error.c" 3 4
              ((void *)0)
# 45 "project/radare2/shlr/zip/zip/zip_error.c"
                  )
 return;

    err->zip_err = 
# 48 "project/radare2/shlr/zip/zip/zip_error.c" 3 4
                  0
# 48 "project/radare2/shlr/zip/zip/zip_error.c"
                           ;
    err->sys_err = 0;
}
...
_zip_error_fini(struct zip_error *err)
{
    free(err->str);
    err->str = 
# 67 "project/radare2/shlr/zip/zip/zip_error.c" 3 4
              ((void *)0)
# 67 "project/radare2/shlr/zip/zip/zip_error.c"
                  ;
}
 ...
 *zep = err->zip_err;
    if (sep) {
 if (zip_error_get_sys_type(err->zip_err) != 
# 78 "project/radare2/shlr/zip/zip/zip_error.c" 3 4
                                            0
# 78 "project/radare2/shlr/zip/zip/zip_error.c"
                                                       )
     *sep = err->sys_err;
 else
     *sep = 0;
...
{
    err->zip_err = 
# 90 "project/radare2/shlr/zip/zip/zip_error.c" 3 4
                  0
# 90 "project/radare2/shlr/zip/zip/zip_error.c"
                           ;
    err->sys_err = 0;
    err->str = 
# 92 "project/radare2/shlr/zip/zip/zip_error.c" 3 4
              ((void *)0)
# 92 "project/radare2/shlr/zip/zip/zip_error.c"
                  ;
}
...
# 119 "project/radare2/shlr/zip/zip/zip_error.c" 3 4
extern 
# 119 "project/radare2/shlr/zip/zip/zip_error.c"
          void
...
# 129 "project/radare2/shlr/zip/zip/zip_error.c" 3 4
extern 
# 129 "project/radare2/shlr/zip/zip/zip_error.c"
          void
zip_error_clear(struct zip *za)
{
    if (za == 
# 132 "project/radare2/shlr/zip/zip/zip_error.c" 3 4
             ((void *)0)
# 132 "project/radare2/shlr/zip/zip/zip_error.c"
                 )
 return;
