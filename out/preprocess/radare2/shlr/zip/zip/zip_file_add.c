# 0 "project/radare2/shlr/zip/zip/zip_file_add.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 37 "project/radare2/shlr/zip/zip/zip_file_add.c" 2
# 46 "project/radare2/shlr/zip/zip/zip_file_add.c"

# 46 "project/radare2/shlr/zip/zip/zip_file_add.c" 3 4
extern 
# 46 "project/radare2/shlr/zip/zip/zip_file_add.c"
          zip_int64_t
...
{
    if (name == 
# 49 "project/radare2/shlr/zip/zip/zip_file_add.c" 3 4
               ((void *)0) 
# 49 "project/radare2/shlr/zip/zip/zip_file_add.c"
                    || source == 
# 49 "project/radare2/shlr/zip/zip/zip_file_add.c" 3 4
                                 ((void *)0)
# 49 "project/radare2/shlr/zip/zip/zip_file_add.c"
...
# 50 "project/radare2/shlr/zip/zip/zip_file_add.c" 3 4
                           18
# 50 "project/radare2/shlr/zip/zip/zip_file_add.c"
                                       , 0);
 return -1;
    }

    return _zip_file_replace(za, 
# 54 "project/radare2/shlr/zip/zip/zip_file_add.c" 3 4
                                0xFFFFFFFFFFFFFFFFULL
# 54 "project/radare2/shlr/zip/zip/zip_file_add.c"
                                              , name, source, flags);
}
