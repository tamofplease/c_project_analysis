# 0 "project/radare2/shlr/zip/zip/zip_source_crc.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 37 "project/radare2/shlr/zip/zip/zip_source_crc.c" 2
...
# 38 "project/radare2/shlr/zip/zip/zip_source_crc.c" 2
...
# 40 "project/radare2/shlr/zip/zip/zip_source_crc.c" 2
...
zip_source_crc(struct zip *za, struct zip_source *src, int validate)
{
    ...
    if (src == 
# 59 "project/radare2/shlr/zip/zip/zip_source_crc.c" 3 4
              ((void *)0)
# 59 "project/radare2/shlr/zip/zip/zip_source_crc.c"
                  ) {
 _zip_error_set(&za->error, 
# 60 "project/radare2/shlr/zip/zip/zip_source_crc.c" 3 4
                           18
# 60 "project/radare2/shlr/zip/zip/zip_source_crc.c"
                                       , 0);
 return 
# 61 "project/radare2/shlr/zip/zip/zip_source_crc.c" 3 4
       ((void *)0)
# 61 "project/radare2/shlr/zip/zip/zip_source_crc.c"
           ;
    }

    if ((ctx=(struct crc_context *)malloc(sizeof(*ctx))) == 
# 64 "project/radare2/shlr/zip/zip/zip_source_crc.c" 3 4
                                                           ((void *)0)
# 64 "project/radare2/shlr/zip/zip/zip_source_crc.c"
                                                               ) {
 _zip_error_set(&za->error, 
# 65 "project/radare2/shlr/zip/zip/zip_source_crc.c" 3 4
                           14
# 65 "project/radare2/shlr/zip/zip/zip_source_crc.c"
                                        , 0);
 return 
# 66 "project/radare2/shlr/zip/zip/zip_source_crc.c" 3 4
       ((void *)0)
# 66 "project/radare2/shlr/zip/zip/zip_source_crc.c"
           ;
    }
  ...
  zip_uint64_t len, enum zip_source_cmd cmd)
{
 ...
 ctx->eof = 0;
 ctx->crc = (zip_uint32_t)crc32(0, 
# 92 "project/radare2/shlr/zip/zip/zip_source_crc.c" 3 4
                                  ((void *)0)
# 92 "project/radare2/shlr/zip/zip/zip_source_crc.c"
                                      , 0);
 ctx->size = 0;
 ...
 if ((n=zip_source_read(src, data, len)) < 0)
     return 
# 102 "project/radare2/shlr/zip/zip/zip_source_crc.c" 3 4
           -2
# 102 "project/radare2/shlr/zip/zip/zip_source_crc.c"
                               ;
 ...
 if (n == 0) {
  ...
  if (zip_source_stat(src, &st) < 0)
      return 
# 110 "project/radare2/shlr/zip/zip/zip_source_crc.c" 3 4
            -2
# 110 "project/radare2/shlr/zip/zip/zip_source_crc.c"
                                ;

  if ((st.valid & 
# 112 "project/radare2/shlr/zip/zip/zip_source_crc.c" 3 4
                 0x0020u
# 112 "project/radare2/shlr/zip/zip/zip_source_crc.c"
                             ) && st.crc != ctx->crc) {
      ctx->e[0] = 
# 113 "project/radare2/shlr/zip/zip/zip_source_crc.c" 3 4
                 7
# 113 "project/radare2/shlr/zip/zip/zip_source_crc.c"
                           ;
      ctx->e[1] = 0;
  ...
  if ((st.valid & 
# 118 "project/radare2/shlr/zip/zip/zip_source_crc.c" 3 4
                 0x0004u
# 118 "project/radare2/shlr/zip/zip/zip_source_crc.c"
                              ) && st.size != ctx->size) {
      ctx->e[0] = 
# 119 "project/radare2/shlr/zip/zip/zip_source_crc.c" 3 4
                 21
# 119 "project/radare2/shlr/zip/zip/zip_source_crc.c"
                              ;
      ctx->e[1] = 0;
    ...
    case ZIP_SOURCE_STAT:
 {
  ...
  st->comp_method = 
# 147 "project/radare2/shlr/zip/zip/zip_source_crc.c" 3 4
                   0
# 147 "project/radare2/shlr/zip/zip/zip_source_crc.c"
                               ;
  st->encryption_method = 
# 148 "project/radare2/shlr/zip/zip/zip_source_crc.c" 3 4
                         0
# 148 "project/radare2/shlr/zip/zip/zip_source_crc.c"
                                    ;
  st->valid |= 
# 149 "project/radare2/shlr/zip/zip/zip_source_crc.c" 3 4
              0x0004u
# 149 "project/radare2/shlr/zip/zip/zip_source_crc.c"
                           |
# 149 "project/radare2/shlr/zip/zip/zip_source_crc.c" 3 4
                            0x0020u
# 149 "project/radare2/shlr/zip/zip/zip_source_crc.c"
...
# 155 "project/radare2/shlr/zip/zip/zip_source_crc.c" 3 4
__builtin___memcpy_chk (
# 155 "project/radare2/shlr/zip/zip/zip_source_crc.c"
data
# 155 "project/radare2/shlr/zip/zip/zip_source_crc.c" 3 4
, 
# 155 "project/radare2/shlr/zip/zip/zip_source_crc.c"
