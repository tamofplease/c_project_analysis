# 0 "project/radare2/shlr/zip/zip/zip_source_zip.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 37 "project/radare2/shlr/zip/zip/zip_source_zip.c" 2
...
# 38 "project/radare2/shlr/zip/zip/zip_source_zip.c" 2
...
# 40 "project/radare2/shlr/zip/zip/zip_source_zip.c" 2




# 43 "project/radare2/shlr/zip/zip/zip_source_zip.c" 3 4
extern 
# 43 "project/radare2/shlr/zip/zip/zip_source_zip.c"
          struct zip_source *
...
# 48 "project/radare2/shlr/zip/zip/zip_source_zip.c" 3 4
                                  18
# 48 "project/radare2/shlr/zip/zip/zip_source_zip.c"
                                              , 0);
        return 
# 49 "project/radare2/shlr/zip/zip/zip_source_zip.c" 3 4
              ((void *)0)
# 49 "project/radare2/shlr/zip/zip/zip_source_zip.c"
                  ;
    }
 ...
 len = 0;
    ...
    if (start == 0 && len == 0)
 flags |= 
# 56 "project/radare2/shlr/zip/zip/zip_source_zip.c" 3 4
         4u
# 56 "project/radare2/shlr/zip/zip/zip_source_zip.c"
                          ;
    else
 flags &= ~
# 58 "project/radare2/shlr/zip/zip/zip_source_zip.c" 3 4
          4u
# 58 "project/radare2/shlr/zip/zip/zip_source_zip.c"
                           ;

    return _zip_source_zip_new(za, srcza, srcidx, flags, start, (zip_uint64_t)len, 
# 60 "project/radare2/shlr/zip/zip/zip_source_zip.c" 3 4
                                                                                  ((void *)0)
# 60 "project/radare2/shlr/zip/zip/zip_source_zip.c"
                                                                                      );
}
