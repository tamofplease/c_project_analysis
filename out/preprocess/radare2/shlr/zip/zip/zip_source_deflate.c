# 0 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
# 36 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
...
# 37 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 2
...
# 38 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 2
...
# 40 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 2
     ...
     zip_int32_t cm, int flags)
{
    ...
    if (src == 
# 70 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
              ((void *)0) 
# 70 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                   || (cm != 
# 70 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                             8 
# 70 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
...
# 71 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                           18
# 71 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                                       , 0);
 return 
# 72 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
       ((void *)0)
# 72 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
           ;
    }

    if ((ctx=(struct deflate *)malloc(sizeof(*ctx))) == 
# 75 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                                                       ((void *)0)
# 75 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                                                           ) {
 _zip_error_set(&za->error, 
# 76 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                           14
# 76 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                                        , 0);
 return 
# 77 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
       ((void *)0)
# 77 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
           ;
    }
    ...
    ctx->eof = 0;
    if (flags & 
# 82 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
               1
# 82 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                               ) {
 if (zip_get_archive_flag(za, 
# 83 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                             1u
# 83 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                                            , 0))
     ctx->mem_level = 8;
 else
     ctx->mem_level = 
# 86 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                     9
# 86 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                                  ;
    }

    if ((s2=zip_source_layered(za, src,
          ((flags & 
# 90 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                   1
# 90 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                                   )
    ? deflate_compress : deflate_decompress),
          ctx)) == 
# 92 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                  ((void *)0)
# 92 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                      ) {
 deflate_free(ctx);
 return 
# 94 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
       ((void *)0)
# 94 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
           ;
    }
       ...
       void *data, zip_uint64_t len)
{
 ...
 return 0;
    ...
    while (!end) {
 ret = deflate(&ctx->zstr, ctx->eof ? 
# 120 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                                     4 
# 120 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                                              : 0);

 switch (ret) {
 case 
# 123 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
     0
# 123 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
         :
 case 
# 124 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
     1
# 124 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                 :
 ...
 case 
# 132 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
     (-5)
# 132 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                :
 ...
 case 
# 156 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
     2
# 156 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                :
 case 
# 157 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
     (-3)
# 157 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                 :
 case 
# 158 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
     (-2)
# 158 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                   :
 case 
# 159 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
     (-4)
# 159 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                :
     ctx->e[0] = 
# 160 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                13
# 160 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                           ;
     ctx->e[1] = ret;
  ...
  void *data, zip_uint64_t len)
{
 ...
 ret = inflate(&ctx->zstr, 
# 194 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                          2
# 194 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                                      );

 switch (ret) {
 case 
# 197 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
     0
# 197 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
         :
     break;

 case 
# 200 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
     1
# 200 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                 :
     ctx->eof = 1;
     end = 1;
     break;
 ...
 case 
# 205 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
     (-5)
# 205 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                :
     if (ctx->zstr.avail_in == 0) {
  if (ctx->eof) {
      end = 1;
 ...
 case 
# 226 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
     2
# 226 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                :
 case 
# 227 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
     (-3)
# 227 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                 :
 case 
# 228 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
     (-2)
# 228 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                   :
 case 
# 229 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
     (-4)
# 229 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                :
     ctx->e[0] = 
# 230 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                13
# 230 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                           ;
     ctx->e[1] = ret;
     end = 1;
     break;
   ...
   zip_uint64_t len, enum zip_source_cmd cmd)
{
 ...
 ctx->zstr.zalloc = 
# 256 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                   0
# 256 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                         ;
 ctx->zstr.zfree = 
# 257 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                  0
# 257 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                        ;
 ctx->zstr.opaque = 
# 258 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                   ((void *)0)
# 258 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                       ;
 ctx->zstr.avail_in = 0;
 ctx->zstr.next_in = 
# 260 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                    ((void *)0)
# 260 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                        ;
 ctx->zstr.avail_out = 0;
 ctx->zstr.next_out = 
# 262 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                     ((void *)0)
# 262 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                         ;


 if ((ret=
# 265 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
         deflateInit2_((
# 265 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
         &ctx->zstr
# 265 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
         ),(9),(8),(
# 265 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
...
# 265 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
         ctx->mem_level
# 265 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
         ), (0), "1.2.8", (int)sizeof(z_stream))

                            
# 267 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                           ) != 
# 267 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                                0
# 267 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                                    ) {
     ctx->e[0] = 
# 268 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                13
# 268 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                           ;
     ctx->e[1] = ret;
     return -1;
 }
 ...
 return 0;
    ...
    case ZIP_SOURCE_STAT:
     ...
     st->comp_method = 
# 288 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                      8
# 288 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                                    ;
     st->valid |= 
# 289 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                 0x0040u
# 289 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                                     ;
     if (ctx->eof) {
  st->comp_size = ctx->size;
  st->valid |= 
# 292 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
              0x0008u
# 292 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                                ;
     }
     else
  st->valid &= ~
# 295 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
               0x0008u
# 295 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                                 ;
 }
 return 0;
...
# 300 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
__builtin___memcpy_chk (
# 300 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
data
# 300 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
, 
# 300 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
...
# 300 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
 ...
 return 0;
    ...
    default:
 ctx->e[0] = 
# 308 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
            18
# 308 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                        ;
 ctx->e[1] = 0;
 return -1;
    }
     ...
     zip_uint64_t len, enum zip_source_cmd cmd)
{
 ...
 if ((n=zip_source_read(src, ctx->buffer, sizeof(ctx->buffer))) < 0)
     return 
# 329 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
           -2
# 329 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                               ;

 ctx->zstr.zalloc = 
# 331 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                   0
# 331 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                         ;
 ctx->zstr.zfree = 
# 332 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                  0
# 332 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                        ;
 ctx->zstr.opaque = 
# 333 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                   ((void *)0)
# 333 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                       ;
 ctx->zstr.next_in = (Bytef *)ctx->buffer;
 ctx->zstr.avail_in = (uInt)n ;
 ...
 if ((ret=
# 338 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
         inflateInit2_((
# 338 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
         &ctx->zstr
# 338 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
         ), (
# 338 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
...
# 338 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
     ...
     ctx->e[0] = 
# 339 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                13
# 339 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                           ;
     ctx->e[1] = ret;
    ...
    case ZIP_SOURCE_STAT:
 {
     ...
     st->comp_method = 
# 359 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
                      0
# 359 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                                  ;
...
# 369 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
__builtin___memcpy_chk (
# 369 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
data
# 369 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
, 
# 369 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
...
# 369 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
 ...
 return 0;
    ...
    default:
 ctx->e[0] = 
# 378 "project/radare2/shlr/zip/zip/zip_source_deflate.c" 3 4
            18
# 378 "project/radare2/shlr/zip/zip/zip_source_deflate.c"
                        ;
 ctx->e[1] = 0;
 return -1;
    }
