# 0 "project/radare2/shlr/zip/zip/zip_delete.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 37 "project/radare2/shlr/zip/zip/zip_delete.c" 2




# 40 "project/radare2/shlr/zip/zip/zip_delete.c" 3 4
extern 
# 40 "project/radare2/shlr/zip/zip/zip_delete.c"
          int
zip_delete(struct zip *za, zip_uint64_t idx)
{
    if (idx >= za->nentry) {
 _zip_error_set(&za->error, 
# 44 "project/radare2/shlr/zip/zip/zip_delete.c" 3 4
                           18
# 44 "project/radare2/shlr/zip/zip/zip_delete.c"
                                       , 0);
 return -1;
    }

    if (((za)->ch_flags & 
# 48 "project/radare2/shlr/zip/zip/zip_delete.c" 3 4
       2u
# 48 "project/radare2/shlr/zip/zip/zip_delete.c"
       )) {
 _zip_error_set(&za->error, 
# 49 "project/radare2/shlr/zip/zip/zip_delete.c" 3 4
                           25
# 49 "project/radare2/shlr/zip/zip/zip_delete.c"
                                        , 0);
 return -1;
    }
