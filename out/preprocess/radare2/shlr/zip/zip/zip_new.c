# 0 "project/radare2/shlr/zip/zip/zip_new.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 37 "project/radare2/shlr/zip/zip/zip_new.c" 2
...
# 39 "project/radare2/shlr/zip/zip/zip_new.c" 2
...
# 53 "project/radare2/shlr/zip/zip/zip_new.c" 3 4
                      14
# 53 "project/radare2/shlr/zip/zip/zip_new.c"
                                   , 0);
 return 
# 54 "project/radare2/shlr/zip/zip/zip_new.c" 3 4
       ((void *)0)
# 54 "project/radare2/shlr/zip/zip/zip_new.c"
           ;
    }

    za->zn = 
# 57 "project/radare2/shlr/zip/zip/zip_new.c" 3 4
            ((void *)0)
# 57 "project/radare2/shlr/zip/zip/zip_new.c"
                ;
    za->zp = 
# 58 "project/radare2/shlr/zip/zip/zip_new.c" 3 4
            ((void *)0)
# 58 "project/radare2/shlr/zip/zip/zip_new.c"
                ;
    za->open_flags = 0;
    _zip_error_init(&za->error);
    za->flags = za->ch_flags = 0;
    za->default_password = 
# 62 "project/radare2/shlr/zip/zip/zip_new.c" 3 4
                          ((void *)0)
# 62 "project/radare2/shlr/zip/zip/zip_new.c"
                              ;
    za->comment_orig = za->comment_changes = 
# 63 "project/radare2/shlr/zip/zip/zip_new.c" 3 4
                                            ((void *)0)
# 63 "project/radare2/shlr/zip/zip/zip_new.c"
                                                ;
    za->comment_changed = 0;
    za->nentry = za->nentry_alloc = 0;
    za->entry = 
# 66 "project/radare2/shlr/zip/zip/zip_new.c" 3 4
               ((void *)0)
# 66 "project/radare2/shlr/zip/zip/zip_new.c"
                   ;
    za->nfile = za->nfile_alloc = 0;
    za->file = 
# 68 "project/radare2/shlr/zip/zip/zip_new.c" 3 4
              ((void *)0)
# 68 "project/radare2/shlr/zip/zip/zip_new.c"
                  ;
    za->tempdir = 
# 69 "project/radare2/shlr/zip/zip/zip_new.c" 3 4
                 ((void *)0)
# 69 "project/radare2/shlr/zip/zip/zip_new.c"
                     ;
