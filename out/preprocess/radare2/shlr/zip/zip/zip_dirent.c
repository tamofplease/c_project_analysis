# 0 "project/radare2/shlr/zip/zip/zip_dirent.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/zip/zip/zip_dirent.c"
# 36 "project/radare2/shlr/zip/zip/zip_dirent.c"
...
# 37 "project/radare2/shlr/zip/zip/zip_dirent.c" 2
...
# 38 "project/radare2/shlr/zip/zip/zip_dirent.c" 2
...
# 39 "project/radare2/shlr/zip/zip/zip_dirent.c" 2
...
# 40 "project/radare2/shlr/zip/zip/zip_dirent.c" 2
...
# 41 "project/radare2/shlr/zip/zip/zip_dirent.c" 2
...
# 42 "project/radare2/shlr/zip/zip/zip_dirent.c" 2
...
# 45 "project/radare2/shlr/zip/zip/zip_dirent.c" 2
...
# 77 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                      20
# 77 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                     , 0);
 return -1;
    }
 ...
 return 0;
  ...
  realloc(cd->entry, sizeof(*(cd->entry))*nentry))) == 
# 85 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                      ((void *)0)
# 85 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                          ) {
 _zip_error_set(error, 
# 86 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                      14
# 86 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                   , 0);
 return -1;
    }
...
_zip_cdir_new(zip_uint64_t nentry, struct zip_error *error)
{
    ...
    if ((cd=(struct zip_cdir *)malloc(sizeof(*cd))) == 
# 107 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                      ((void *)0)
# 107 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                          ) {
 _zip_error_set(error, 
# 108 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                      14
# 108 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                   , 0);
 return 
# 109 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
       ((void *)0)
# 109 "project/radare2/shlr/zip/zip/zip_dirent.c"
           ;
    }

    if (nentry == 0) {
 cd->entry = 
# 113 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
            ((void *)0)
# 113 "project/radare2/shlr/zip/zip/zip_dirent.c"
                ;
    } else if ((nentry > 
# 114 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                        18446744073709551615UL
# 114 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                /sizeof(*(cd->entry))) || (cd->entry=(struct zip_entry *)malloc(sizeof(*(cd->entry))*(size_t)nentry)) == 
# 114 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                                                                                                         ((void *)0)
# 114 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                                                                                                             ) {
 _zip_error_set(error, 
# 115 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                      14
# 115 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                   , 0);
 free(cd);
 return 
# 117 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
       ((void *)0)
# 117 "project/radare2/shlr/zip/zip/zip_dirent.c"
           ;
    }
 ...
 _zip_entry_init(cd->entry+i);
    ...
    cd->size = cd->offset = 0;
    cd->comment = 
# 125 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                 ((void *)0)
# 125 "project/radare2/shlr/zip/zip/zip_dirent.c"
                     ;
...
# 143 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                  5
# 143 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                             , 
# 143 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                               (*__error())
# 143 "project/radare2/shlr/zip/zip/zip_dirent.c"
 ...
 if ((ret=_zip_dirent_write(entry->changes ? entry->changes : entry->orig, fp, 
# 153 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                                              512u
# 153 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                                                            , &za->error)) < 0)
     return -1;
 if (ret)
     is_zip64 = 1;
    ...
    if ((off=ftell(fp)) < 0) {
        _zip_error_set(&za->error, 
# 160 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                  5
# 160 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                             , 
# 160 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                               (*__error())
# 160 "project/radare2/shlr/zip/zip/zip_dirent.c"
    ...
    if (offset > 
# 165 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                0xFFFFFFFFU 
# 165 "project/radare2/shlr/zip/zip/zip_dirent.c"
                               || survivors > 
# 165 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                              0xFFFFU
# 165 "project/radare2/shlr/zip/zip/zip_dirent.c"
 ...
 is_zip64 = 1;
    ...
    if (is_zip64) {
 fwrite("PK\6\6", 1, 4, fp);
 _zip_write8(56 -12, fp);
 _zip_write2(45, fp);
 _zip_write2(45, fp);
 _zip_write4(0, fp);
 _zip_write4(0, fp);
 ...
 _zip_write4(1, fp);
    ...
    fwrite("PK\5\6", 1, 4, fp);
    _zip_write4(0, fp);
    _zip_write2(survivors >= 
# 190 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                            0xFFFFU 
# 190 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                           ? 
# 190 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                             0xFFFFU 
# 190 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                            : (zip_uint16_t)survivors, fp);
    _zip_write2(survivors >= 
# 191 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                            0xFFFFU 
# 191 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                           ? 
# 191 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                             0xFFFFU 
# 191 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                            : (zip_uint16_t)survivors, fp);
    _zip_write4(size >= 
# 192 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                       0xFFFFFFFFU 
# 192 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                      ? 
# 192 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                        0xFFFFFFFFU 
# 192 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                       : (zip_uint32_t)size, fp);
    _zip_write4(offset >= 
# 193 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                         0xFFFFFFFFU 
# 193 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                        ? 
# 193 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                          0xFFFFFFFFU 
# 193 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                         : (zip_uint32_t)offset, fp);
 ...
 fwrite(comment->raw, 1, comment->length, fp);
    ...
    if (ferror(fp)) {
 _zip_error_set(&za->error, 
# 202 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                           6
# 202 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                       , 
# 202 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                         (*__error())
# 202 "project/radare2/shlr/zip/zip/zip_dirent.c"
...
_zip_dirent_clone(const struct zip_dirent *sde)
{
    ...
    if ((tde=(struct zip_dirent *)malloc(sizeof(*tde))) == 
# 216 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                          ((void *)0)
# 216 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                              )
 return 
# 217 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
       ((void *)0)
# 217 "project/radare2/shlr/zip/zip/zip_dirent.c"
           ;

    if (sde)
 
# 220 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
__builtin___memcpy_chk (
# 220 "project/radare2/shlr/zip/zip/zip_dirent.c"
tde
# 220 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
, 
# 220 "project/radare2/shlr/zip/zip/zip_dirent.c"
...
{
    if (!zde->cloned || zde->changed & 0x0002u)
 _zip_string_free(zde->filename);
    if (!zde->cloned || zde->changed & 0x0008u)
 _zip_ef_free(zde->extra_fields);
    if (!zde->cloned || zde->changed & 0x0004u)
...
{
    if (zde == 
# 248 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
              ((void *)0)
# 248 "project/radare2/shlr/zip/zip/zip_dirent.c"
                  )
 return;
...
_zip_dirent_init(struct zip_dirent *de)
{
    ...
    de->bitflags = 0;
    de->comp_method = 
# 267 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                     -1
# 267 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                   ;
    de->last_mod = 0;
    de->crc = 0;
    de->comp_size = 0;
    de->uncomp_size = 0;
    de->filename = 
# 272 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                  ((void *)0)
# 272 "project/radare2/shlr/zip/zip/zip_dirent.c"
                      ;
    de->extra_fields = 
# 273 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                      ((void *)0)
# 273 "project/radare2/shlr/zip/zip/zip_dirent.c"
                          ;
    de->comment = 
# 274 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                 ((void *)0)
# 274 "project/radare2/shlr/zip/zip/zip_dirent.c"
                     ;
    de->disk_number = 0;
    de->int_attrib = 0;
    de->ext_attrib = 0;
...
{
    if (de->uncomp_size >= 
# 286 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                          0xFFFFFFFFU 
# 286 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                         || de->comp_size >= 
# 286 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                             0xFFFFFFFFU
 
# 287 "project/radare2/shlr/zip/zip/zip_dirent.c"
|| ((flags & 
# 287 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
             512u
# 287 "project/radare2/shlr/zip/zip/zip_dirent.c"
                           ) && de->offset >= 
# 287 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
...
_zip_dirent_new(void)
{
    ...
    if ((de=(struct zip_dirent *)malloc(sizeof(*de))) == 
# 300 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                        ((void *)0)
# 300 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                            )
 return 
# 301 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
       ((void *)0)
# 301 "project/radare2/shlr/zip/zip/zip_dirent.c"
           ;

    _zip_dirent_init(de);
    return de;
}
# 327 "project/radare2/shlr/zip/zip/zip_dirent.c"
int
_zip_dirent_read(struct zip_dirent *zde, FILE *fp,
   const unsigned char **bufp, zip_uint64_t *leftp, int local,
   struct zip_error *error)
{
    unsigned char buf[46u];
 ...
 size = 46u;
    ...
    if (leftp && (*leftp < size)) {
 _zip_error_set(error, 
# 344 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                      19
# 344 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                  , 0);
 return -1;
    }
 ...
 if ((fread(buf, 1, size, fp)<size)) {
     _zip_error_set(error, 
# 355 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                          5
# 355 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                     , 
# 355 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                       (*__error())
# 355 "project/radare2/shlr/zip/zip/zip_dirent.c"
 ...
 cur = buf;
    ...
    if (memcmp(cur, (local ? "PK\3\4" : "PK\1\2"), 4) != 0) {
 _zip_error_set(error, 
# 362 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                      19
# 362 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                  , 0);
 return -1;
    }
    cur += 4;
 ...
 zde->offset = _zip_read4(&cur);
    ...
    zde->filename = 
# 405 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                   ((void *)0)
# 405 "project/radare2/shlr/zip/zip/zip_dirent.c"
                       ;
    zde->extra_fields = 
# 406 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                       ((void *)0)
# 406 "project/radare2/shlr/zip/zip/zip_dirent.c"
                           ;
    zde->comment = 
# 407 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                  ((void *)0)
# 407 "project/radare2/shlr/zip/zip/zip_dirent.c"
                      ;
    ...
    if (leftp && (*leftp < size)) {
 _zip_error_set(error, 
# 412 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                      21
# 412 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                   , 0);
 return -1;
    }

    if (filename_len) {
 zde->filename = _zip_read_string(bufp ? &cur : 
# 417 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                               ((void *)0)
# 417 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                   , fp, filename_len, 1, error);
 if (!zde->filename)
     return -1;

 if (zde->bitflags & 0x0800) {
     if (_zip_guess_encoding(zde->filename, ZIP_ENCODING_UTF8_KNOWN) == ZIP_ENCODING_ERROR) {
  _zip_error_set(error, 
# 423 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                       21
# 423 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                    , 0);
  return -1;
     }
 }
    ...
    if (ef_len) {
 zip_uint8_t *ef = _zip_read_data(bufp ? &cur : 
# 430 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                               ((void *)0)
# 430 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                   , fp, ef_len, 0, error);

 if (ef == 
# 432 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
          ((void *)0)
# 432 "project/radare2/shlr/zip/zip/zip_dirent.c"
              )
     return -1;
 if ((zde->extra_fields=_zip_ef_parse(ef, ef_len, local ? 
# 434 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                         256u 
# 434 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                                      : 
# 434 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                                        512u
# 434 "project/radare2/shlr/zip/zip/zip_dirent.c"
...
# 434 "project/radare2/shlr/zip/zip/zip_dirent.c"
 ...
 if (local)
    ...
    if (comment_len) {
 zde->comment = _zip_read_string(bufp ? &cur : 
# 444 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                              ((void *)0)
# 444 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                  , fp, comment_len, 0, error);
 if (!zde->comment)
     return -1;
 ...
 if (zde->bitflags & 0x0800) {
  ...
  _zip_error_set(error, 
# 450 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                       21
# 450 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                    , 0);
  return -1;
     }
 }
    ...
    zde->filename = _zip_dirent_process_ef_utf_8(zde, 0x7075, zde->filename);
    zde->comment = _zip_dirent_process_ef_utf_8(zde, 0x6375, zde->comment);



    if (zde->uncomp_size == 
# 461 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                           0xFFFFFFFFU 
# 461 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                          || zde->comp_size == 
# 461 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                               0xFFFFFFFFU 
# 461 "project/radare2/shlr/zip/zip/zip_dirent.c"
...
# 461 "project/radare2/shlr/zip/zip/zip_dirent.c"
 ...
 const zip_uint8_t *ef = _zip_ef_get_by_id(zde->extra_fields, &got_len, 0x0001, 0, local ? 
# 463 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                                                                256u 
# 463 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                                                                             : 
# 463 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                                                                               512u
# 463 "project/radare2/shlr/zip/zip/zip_dirent.c"
 ...
 if (ef == 
# 465 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
          ((void *)0)
# 465 "project/radare2/shlr/zip/zip/zip_dirent.c"
              )
     return -1;
 ...
 if (local)
     ...
     needed_len = ((zde->uncomp_size == 
# 472 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                       0xFFFFFFFFU
# 472 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                     ) + (zde->comp_size == 
# 472 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                                            0xFFFFFFFFU
# 472 "project/radare2/shlr/zip/zip/zip_dirent.c"
...
# 472 "project/radare2/shlr/zip/zip/zip_dirent.c"
  ...
  + (zde->disk_number == 
# 473 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                        0xFFFFU
# 473 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                      ) * 4;

 if (got_len != needed_len) {
     _zip_error_set(error, 
# 476 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                          21
# 476 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                       , 0);
     return -1;
 }

 if (zde->uncomp_size == 
# 480 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                        0xFFFFFFFFU
# 480 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                      )
     zde->uncomp_size = _zip_read8(&ef);
 else if (local)
     ef += 8;
 if (zde->comp_size == 
# 484 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                      0xFFFFFFFFU
# 484 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                    )
     zde->comp_size = _zip_read8(&ef);
 if (!local) {
     if (zde->offset == 
# 487 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                       0xFFFFFFFFU
# 487 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                     )
  zde->offset = _zip_read8(&ef);
     if (zde->disk_number == 
# 489 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                            0xFFFFU
# 489 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                          )
  zde->disk_number = _zip_read4(&ef);
    ...
    if (!local) {
        if (zde->offset > 
# 495 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                         ((long long)0x7FFFFFFFFFFFFFFFULL)
# 495 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                    ) {
            _zip_error_set(error, 
# 496 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                 4
# 496 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                            , 
# 496 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                              27
# 496 "project/radare2/shlr/zip/zip/zip_dirent.c"
...
_zip_dirent_process_ef_utf_8(const struct zip_dirent *de, zip_uint16_t id, struct zip_string *str)
{
    ...
    const zip_uint8_t *ef = _zip_ef_get_by_id(de->extra_fields, &ef_len, id, 0, (
# 519 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                                               256u
# 519 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                                               |
# 519 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                                               512u
# 519 "project/radare2/shlr/zip/zip/zip_dirent.c"
...
# 519 "project/radare2/shlr/zip/zip/zip_dirent.c"
    ...
    if (ef == 
# 521 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
             ((void *)0) 
# 521 "project/radare2/shlr/zip/zip/zip_dirent.c"
                  || ef_len < 5 || ef[0] != 1)
 return str;
 ...
 struct zip_string *ef_str = _zip_string_new(ef, ef_len-5, ZIP_ENCODING_UTF8_KNOWN, 
# 528 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                                                   ((void *)0)
# 528 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                                                       );

 if (ef_str != 
# 530 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
              ((void *)0)
# 530 "project/radare2/shlr/zip/zip/zip_dirent.c"
                  ) {
...
_zip_dirent_size(FILE *f, zip_uint16_t flags, struct zip_error *error)
{
    zip_int32_t size;
    int local = (flags & 
# 545 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                        256u
# 545 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                    );
    int i;
    unsigned char b[6];
    ...
    if (fseek(f, local ? 26 : 28, 
# 552 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                 1
# 552 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                         ) < 0) {
 _zip_error_set(error, 
# 553 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                      4
# 553 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                 , 
# 553 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                   (*__error())
# 553 "project/radare2/shlr/zip/zip/zip_dirent.c"
 ...
 _zip_error_set(error, 
# 558 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                      5
# 558 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                 , 
# 558 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                   (*__error())
# 558 "project/radare2/shlr/zip/zip/zip_dirent.c"
...
# 606 "project/radare2/shlr/zip/zip/zip_dirent.c"
 last_mod = mktime(&torrenttime);
    ...
    de->bitflags = 2;
    de->comp_method = 
# 612 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                     8
# 612 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                   ;
    ...
    de->extra_fields = 
# 620 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                      ((void *)0)
# 620 "project/radare2/shlr/zip/zip/zip_dirent.c"
                          ;
    _zip_string_free(de->comment);
    de->comment = 
# 622 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                 ((void *)0)
# 622 "project/radare2/shlr/zip/zip/zip_dirent.c"
                     ;
}
# 637 "project/radare2/shlr/zip/zip/zip_dirent.c"
int
_zip_dirent_write(struct zip_dirent *de, FILE *fp, zip_flags_t flags, struct zip_error *error)
{
    ...
    ef = 
# 647 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
        ((void *)0)
# 647 "project/radare2/shlr/zip/zip/zip_dirent.c"
            ;

    is_zip64 = 0;

    fwrite((flags & 
# 651 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                   256u
# 651 "project/radare2/shlr/zip/zip/zip_dirent.c"
                               ) ? "PK\3\4" : "PK\1\2", 1, 4, fp);
 ...
 if (name_enc == ZIP_ENCODING_UTF8_KNOWN) {
     ef = _zip_ef_utf8(0x7075, de->filename, error);
     if (ef == 
# 664 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
              ((void *)0)
# 664 "project/radare2/shlr/zip/zip/zip_dirent.c"
                  )
  return -1;
 }
 if ((flags & 
# 667 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
             256u
# 667 "project/radare2/shlr/zip/zip/zip_dirent.c"
                         ) == 0 && com_enc == ZIP_ENCODING_UTF8_KNOWN){
     struct zip_extra_field *ef2 = _zip_ef_utf8(0x6375, de->comment, error);
     if (ef2 == 
# 669 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
               ((void *)0)
# 669 "project/radare2/shlr/zip/zip/zip_dirent.c"
                   ) {
  _zip_ef_free(ef);
  return -1;
     }
    ...
    ef_zip64_p = ef_zip64;
    if (flags & 
# 679 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
               256u
# 679 "project/radare2/shlr/zip/zip/zip_dirent.c"
                           ) {
 if ((flags & 1024) || de->comp_size > 
# 680 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                    0xFFFFFFFFU 
# 680 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                                   || de->uncomp_size > 
# 680 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                                                        0xFFFFFFFFU
# 680 "project/radare2/shlr/zip/zip/zip_dirent.c"
 ...
 if ((flags & 1024) || de->comp_size > 
# 686 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                    0xFFFFFFFFU 
# 686 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                                   || de->uncomp_size > 
# 686 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                                                        0xFFFFFFFFU 
# 686 "project/radare2/shlr/zip/zip/zip_dirent.c"
...
# 686 "project/radare2/shlr/zip/zip/zip_dirent.c"
     ...
     if (de->comp_size >= 
# 687 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                         0xFFFFFFFFU
# 687 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                       )
  _zip_poke8(de->comp_size, &ef_zip64_p);
     if (de->uncomp_size >= 
# 689 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                           0xFFFFFFFFU
# 689 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                         )
  _zip_poke8(de->uncomp_size, &ef_zip64_p);
     if (de->offset >= 
# 691 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                      0xFFFFFFFFU
# 691 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                    )
 ...
 struct zip_extra_field *ef64 = _zip_ef_new(0x0001, (zip_uint16_t)(ef_zip64_p-ef_zip64), ef_zip64, (
# 697 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                                                                        256u
# 697 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                                                                        |
# 697 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                                                                        512u
# 697 "project/radare2/shlr/zip/zip/zip_dirent.c"
 ...
 is_zip64 = 1;
    ...
    if ((flags & (
# 703 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                 256u
# 703 "project/radare2/shlr/zip/zip/zip_dirent.c"
                             |1024)) == (
# 703 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                       256u
# 703 "project/radare2/shlr/zip/zip/zip_dirent.c"
 ...
 is_really_zip64 = is_zip64;
    ...
    if ((flags & 
# 708 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                256u
# 708 "project/radare2/shlr/zip/zip/zip_dirent.c"
                            ) == 0)
 _zip_write2(is_really_zip64 ? 45 : de->version_madeby, fp);
    ...
    if (de->comp_size < 
# 719 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                       0xFFFFFFFFU
# 719 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                     )
 _zip_write4((zip_uint32_t)de->comp_size, fp);
    else
 _zip_write4(
# 722 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
            0xFFFFFFFFU
# 722 "project/radare2/shlr/zip/zip/zip_dirent.c"
                          , fp);
    if (de->uncomp_size < 
# 723 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                         0xFFFFFFFFU
# 723 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                       )
 _zip_write4((zip_uint32_t)de->uncomp_size, fp);
    else
 _zip_write4(
# 726 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
            0xFFFFFFFFU
# 726 "project/radare2/shlr/zip/zip/zip_dirent.c"
                          , fp);

    _zip_write2(_zip_string_length(de->filename), fp);
    _zip_write2(_zip_ef_size(de->extra_fields, flags) + _zip_ef_size(ef, (
# 729 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                                        256u
# 729 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                                        |
# 729 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                                        512u
# 729 "project/radare2/shlr/zip/zip/zip_dirent.c"
    ...
    if ((flags & 
# 731 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                256u
# 731 "project/radare2/shlr/zip/zip/zip_dirent.c"
                            ) == 0) {
 ...
 if (de->offset < 
# 736 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                 0xFFFFFFFFU
# 736 "project/radare2/shlr/zip/zip/zip_dirent.c"
                               )
     _zip_write4((zip_uint32_t)de->offset, fp);
 else
     _zip_write4(
# 739 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                0xFFFFFFFFU
# 739 "project/radare2/shlr/zip/zip/zip_dirent.c"
                              , fp);
    }
 ...
 _zip_string_write(de->filename, fp);
    ...
    if (ef)
 _zip_ef_write(ef, (
# 746 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                  256u
# 746 "project/radare2/shlr/zip/zip/zip_dirent.c"
                  |
# 746 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                  512u
# 746 "project/radare2/shlr/zip/zip/zip_dirent.c"
 ...
 _zip_ef_write(de->extra_fields, flags, fp);
    ...
    if ((flags & 
# 750 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                256u
# 750 "project/radare2/shlr/zip/zip/zip_dirent.c"
                            ) == 0) {
 if (de->comment)
    ...
    if (ferror(fp)) {
 _zip_error_set(error, 
# 758 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                      6
# 758 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                  , 
# 758 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                    (*__error())
# 758 "project/radare2/shlr/zip/zip/zip_dirent.c"
...
# 772 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
   __builtin___memset_chk (
# 772 "project/radare2/shlr/zip/zip/zip_dirent.c"
   &tm
# 772 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
   , 
# 772 "project/radare2/shlr/zip/zip/zip_dirent.c"
...
_zip_ef_utf8(zip_uint16_t id, struct zip_string *str, struct zip_error *error)
{
    ...
    raw = _zip_string_get(str, &len, 
# 798 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                    64u
# 798 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                  , 
# 798 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                    ((void *)0)
# 798 "project/radare2/shlr/zip/zip/zip_dirent.c"
    ...
    if (len+5 > 
# 800 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
               0xFFFFU
# 800 "project/radare2/shlr/zip/zip/zip_dirent.c"
                             ) {

    }

    if ((data=(zip_uint8_t *)malloc(len+5)) == 
# 804 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                              ((void *)0)
# 804 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                  ) {
 _zip_error_set(error, 
# 805 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                      14
# 805 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                   , 0);
 return 
# 806 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
       ((void *)0)
# 806 "project/radare2/shlr/zip/zip/zip_dirent.c"
           ;
    }
...
# 812 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
   __builtin___memcpy_chk (
# 812 "project/radare2/shlr/zip/zip/zip_dirent.c"
   p
# 812 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
   , 
# 812 "project/radare2/shlr/zip/zip/zip_dirent.c"
...
# 812 "project/radare2/shlr/zip/zip/zip_dirent.c"
    ...
    ef = _zip_ef_new(id, (zip_uint16_t)(p-data), data, (
# 815 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                      256u
# 815 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                      |
# 815 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                      512u
# 815 "project/radare2/shlr/zip/zip/zip_dirent.c"
...
{
    if (error == 
# 825 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                ((void *)0)
# 825 "project/radare2/shlr/zip/zip/zip_dirent.c"
                    )
 error = &za->error;

    if (idx >= za->nentry) {
 _zip_error_set(error, 
# 829 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                      18
# 829 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                  , 0);
 return 
# 830 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
       ((void *)0)
# 830 "project/radare2/shlr/zip/zip/zip_dirent.c"
           ;
    }

    if ((flags & 
# 833 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                8u
# 833 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                ) || za->entry[idx].changes == 
# 833 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                               ((void *)0)
# 833 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                                   ) {
 if (za->entry[idx].orig == 
# 834 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                           ((void *)0)
# 834 "project/radare2/shlr/zip/zip/zip_dirent.c"
                               ) {
     _zip_error_set(error, 
# 835 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                          18
# 835 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                      , 0);
     return 
# 836 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
           ((void *)0)
# 836 "project/radare2/shlr/zip/zip/zip_dirent.c"
               ;
 }
 if (za->entry[idx].deleted && (flags & 
# 838 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                       8u
# 838 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                       ) == 0) {
     _zip_error_set(error, 
# 839 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                          23
# 839 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                        , 0);
     return 
# 840 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
           ((void *)0)
# 840 "project/radare2/shlr/zip/zip/zip_dirent.c"
               ;
 }
...
_zip_read_data(const zip_uint8_t **buf, FILE *fp, size_t len, int nulp, struct zip_error *error)
{
    ...
    if (len == 0 && nulp == 0)
 return 
# 897 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
       ((void *)0)
# 897 "project/radare2/shlr/zip/zip/zip_dirent.c"
           ;

    r = (zip_uint8_t *)malloc(nulp ? len+1 : len);
    if (!r) {
 _zip_error_set(error, 
# 901 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                      14
# 901 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                   , 0);
 return 
# 902 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
       ((void *)0)
# 902 "project/radare2/shlr/zip/zip/zip_dirent.c"
           ;
    }

    if (buf) {
 
# 906 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
__builtin___memcpy_chk (
# 906 "project/radare2/shlr/zip/zip/zip_dirent.c"
r
# 906 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
, 
# 906 "project/radare2/shlr/zip/zip/zip_dirent.c"
 ...
 *buf += len;
 ...
 if (fread(r, 1, len, fp)<len) {
     free(r);
            if (ferror(fp))
                _zip_error_set(error, 
# 913 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                     5
# 913 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                , 
# 913 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                  (*__error())
# 913 "project/radare2/shlr/zip/zip/zip_dirent.c"
                ...
                _zip_error_set(error, 
# 915 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                     21
# 915 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                  , 0);
     return 
# 916 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
           ((void *)0)
# 916 "project/radare2/shlr/zip/zip/zip_dirent.c"
               ;
 }
    }
...
_zip_read_string(const zip_uint8_t **buf, FILE *fp, zip_uint16_t len, int nulp, struct zip_error *error)
{
    ...
    if ((raw=_zip_read_data(buf, fp, len, nulp, error)) == 
# 940 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                                          ((void *)0)
# 940 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                              )
 return 
# 941 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
       ((void *)0)
# 941 "project/radare2/shlr/zip/zip/zip_dirent.c"
           ;

    s = _zip_string_new(raw, len, 
# 943 "project/radare2/shlr/zip/zip/zip_dirent.c" 3 4
                                 0u
# 943 "project/radare2/shlr/zip/zip/zip_dirent.c"
                                                 , error);
    free(raw);
    return s;
}
