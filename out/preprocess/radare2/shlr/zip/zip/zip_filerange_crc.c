# 0 "project/radare2/shlr/zip/zip/zip_filerange_crc.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 37 "project/radare2/shlr/zip/zip/zip_filerange_crc.c" 2
...
# 38 "project/radare2/shlr/zip/zip/zip_filerange_crc.c" 2
...
# 40 "project/radare2/shlr/zip/zip/zip_filerange_crc.c" 2
     ...
     struct zip_error *errp)
{
    ...
    *crcp = crc32(0L, 
# 51 "project/radare2/shlr/zip/zip/zip_filerange_crc.c" 3 4
                     0
# 51 "project/radare2/shlr/zip/zip/zip_filerange_crc.c"
                           , 0);

    if (fseek(fp, start, 
# 53 "project/radare2/shlr/zip/zip/zip_filerange_crc.c" 3 4
                         0
# 53 "project/radare2/shlr/zip/zip/zip_filerange_crc.c"
                                 ) != 0) {
 _zip_error_set(errp, 
# 54 "project/radare2/shlr/zip/zip/zip_filerange_crc.c" 3 4
                     4
# 54 "project/radare2/shlr/zip/zip/zip_filerange_crc.c"
                                , 
# 54 "project/radare2/shlr/zip/zip/zip_filerange_crc.c" 3 4
                                  (*__error())
# 54 "project/radare2/shlr/zip/zip/zip_filerange_crc.c"
 ...
 return -1;
    ...
    while (len > 0) {
 n = len > 8192 ? 8192 : (size_t)len;
 if ((n=fread(buf, 1, n, fp)) == 0) {
     _zip_error_set(errp, 
# 61 "project/radare2/shlr/zip/zip/zip_filerange_crc.c" 3 4
                         5
# 61 "project/radare2/shlr/zip/zip/zip_filerange_crc.c"
                                    , 
# 61 "project/radare2/shlr/zip/zip/zip_filerange_crc.c" 3 4
                                      (*__error())
# 61 "project/radare2/shlr/zip/zip/zip_filerange_crc.c"
