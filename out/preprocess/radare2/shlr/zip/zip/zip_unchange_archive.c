# 0 "project/radare2/shlr/zip/zip/zip_unchange_archive.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 37 "project/radare2/shlr/zip/zip/zip_unchange_archive.c" 2
...
# 39 "project/radare2/shlr/zip/zip/zip_unchange_archive.c" 2




# 42 "project/radare2/shlr/zip/zip/zip_unchange_archive.c" 3 4
extern 
# 42 "project/radare2/shlr/zip/zip/zip_unchange_archive.c"
          int
zip_unchange_archive(struct zip *za)
{
 ...
 za->comment_changes = 
# 47 "project/radare2/shlr/zip/zip/zip_unchange_archive.c" 3 4
                      ((void *)0)
# 47 "project/radare2/shlr/zip/zip/zip_unchange_archive.c"
                          ;
