# 0 "project/radare2/shlr/zip/zip/zip_source_read.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 37 "project/radare2/shlr/zip/zip/zip_source_read.c" 2
...
zip_source_read(struct zip_source *src, void *data, zip_uint64_t len)
{
    ...
    if (!src->is_open || len > 
# 45 "project/radare2/shlr/zip/zip/zip_source_read.c" 3 4
                              ((long long)0x7FFFFFFFFFFFFFFFULL) 
# 45 "project/radare2/shlr/zip/zip/zip_source_read.c"
                                            || (len > 0 && data == 
# 45 "project/radare2/shlr/zip/zip/zip_source_read.c" 3 4
                                                                   ((void *)0)
# 45 "project/radare2/shlr/zip/zip/zip_source_read.c"
 ...
 return -1;
    ...
    if (src->src == 
# 50 "project/radare2/shlr/zip/zip/zip_source_read.c" 3 4
                   ((void *)0)
# 50 "project/radare2/shlr/zip/zip/zip_source_read.c"
                       )
 return src->cb.f(src->ud, data, len, ZIP_SOURCE_READ);
    ...
    if (ret < 0) {
 if (ret == 
# 56 "project/radare2/shlr/zip/zip/zip_source_read.c" 3 4
           -2
# 56 "project/radare2/shlr/zip/zip/zip_source_read.c"
                               )
