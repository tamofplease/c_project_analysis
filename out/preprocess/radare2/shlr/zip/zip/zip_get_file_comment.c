# 0 "project/radare2/shlr/zip/zip/zip_get_file_comment.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/zip/zip/zip_get_file_comment.c"
# 37 "project/radare2/shlr/zip/zip/zip_get_file_comment.c"
...
# 38 "project/radare2/shlr/zip/zip/zip_get_file_comment.c" 2




# 41 "project/radare2/shlr/zip/zip/zip_get_file_comment.c" 3 4
extern 
# 41 "project/radare2/shlr/zip/zip/zip_get_file_comment.c"
          const char *
zip_get_file_comment(struct zip *za, zip_uint64_t idx, int *lenp, int flags)
{
    ...
    if ((s=zip_file_get_comment(za, idx, &len, (zip_flags_t)flags)) != 
# 47 "project/radare2/shlr/zip/zip/zip_get_file_comment.c" 3 4
                                                                      ((void *)0)
# 47 "project/radare2/shlr/zip/zip/zip_get_file_comment.c"
                                                                          ) {
 if (lenp)
     *lenp = (int)len;
    }
