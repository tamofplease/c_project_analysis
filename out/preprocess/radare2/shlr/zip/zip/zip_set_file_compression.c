# 0 "project/radare2/shlr/zip/zip/zip_set_file_compression.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 37 "project/radare2/shlr/zip/zip/zip_set_file_compression.c" 2




# 40 "project/radare2/shlr/zip/zip/zip_set_file_compression.c" 3 4
extern 
# 40 "project/radare2/shlr/zip/zip/zip_set_file_compression.c"
          int
...
# 48 "project/radare2/shlr/zip/zip/zip_set_file_compression.c" 3 4
                           18
# 48 "project/radare2/shlr/zip/zip/zip_set_file_compression.c"
                                       , 0);
 return -1;
    }

    if (((za)->ch_flags & 
# 52 "project/radare2/shlr/zip/zip/zip_set_file_compression.c" 3 4
       2u
# 52 "project/radare2/shlr/zip/zip/zip_set_file_compression.c"
       )) {
 _zip_error_set(&za->error, 
# 53 "project/radare2/shlr/zip/zip/zip_set_file_compression.c" 3 4
                           25
# 53 "project/radare2/shlr/zip/zip/zip_set_file_compression.c"
                                        , 0);
 return -1;
    }

    if (method != 
# 57 "project/radare2/shlr/zip/zip/zip_set_file_compression.c" 3 4
                 -1 
# 57 "project/radare2/shlr/zip/zip/zip_set_file_compression.c"
                                && method != 
# 57 "project/radare2/shlr/zip/zip/zip_set_file_compression.c" 3 4
                                             0 
# 57 "project/radare2/shlr/zip/zip/zip_set_file_compression.c"
...
# 57 "project/radare2/shlr/zip/zip/zip_set_file_compression.c"
 ...
 _zip_error_set(&za->error, 
# 58 "project/radare2/shlr/zip/zip/zip_set_file_compression.c" 3 4
                           16
# 58 "project/radare2/shlr/zip/zip/zip_set_file_compression.c"
                                             , 0);
 return -1;
    }
    ...
    old_method = (e->orig == 
# 64 "project/radare2/shlr/zip/zip/zip_set_file_compression.c" 3 4
                            ((void *)0) 
# 64 "project/radare2/shlr/zip/zip/zip_set_file_compression.c"
                                 ? 
# 64 "project/radare2/shlr/zip/zip/zip_set_file_compression.c" 3 4
                                   -1 
# 64 "project/radare2/shlr/zip/zip/zip_set_file_compression.c"
 ...
 if (e->changes) {
     e->changes->changed &= ~0x0001u;
     if (e->changes->changed == 0) {
  _zip_dirent_free(e->changes);
  e->changes = 
# 73 "project/radare2/shlr/zip/zip/zip_set_file_compression.c" 3 4
              ((void *)0)
# 73 "project/radare2/shlr/zip/zip/zip_set_file_compression.c"
                  ;
     }
 }
    }
        ...
        if (e->changes == 
# 78 "project/radare2/shlr/zip/zip/zip_set_file_compression.c" 3 4
                         ((void *)0)
# 78 "project/radare2/shlr/zip/zip/zip_set_file_compression.c"
                             ) {
            if ((e->changes=_zip_dirent_clone(e->orig)) == 
# 79 "project/radare2/shlr/zip/zip/zip_set_file_compression.c" 3 4
                                                          ((void *)0)
# 79 "project/radare2/shlr/zip/zip/zip_set_file_compression.c"
                                                              ) {
                _zip_error_set(&za->error, 
# 80 "project/radare2/shlr/zip/zip/zip_set_file_compression.c" 3 4
                                          14
# 80 "project/radare2/shlr/zip/zip/zip_set_file_compression.c"
                                                       , 0);
                return -1;
            }
        }
