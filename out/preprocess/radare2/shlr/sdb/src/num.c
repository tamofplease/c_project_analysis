# 0 "project/radare2/shlr/sdb/src/num.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/sdb/src/num.c"
...
# 4 "project/radare2/shlr/sdb/src/num.c" 2



__attribute__ ((visibility ("default"))) 
# 7 "project/radare2/shlr/sdb/src/num.c" 3 4
       _Bool 
# 7 "project/radare2/shlr/sdb/src/num.c"
            sdb_num_exists (Sdb *s, const char *key) {
 const char *o = sdb_const_get (s, key, 
# 8 "project/radare2/shlr/sdb/src/num.c" 3 4
                                       ((void *)0)
# 8 "project/radare2/shlr/sdb/src/num.c"
                                           );
 return o ? (*o >= '0' && *o <= '9'): 
# 9 "project/radare2/shlr/sdb/src/num.c" 3 4
                                     0
# 9 "project/radare2/shlr/sdb/src/num.c"
                                          ;
}
...
# 19 "project/radare2/shlr/sdb/src/num.c" 3 4
                                                   ((void *)0)
# 19 "project/radare2/shlr/sdb/src/num.c"
                                                       ));
...
__attribute__ ((visibility ("default"))) int sdb_num_set(Sdb *s, const char *key, unsigned long long v, unsigned int cas) {
 char *val, b[64];
 int numbase = sdb_num_base (sdb_const_get (s, key, 
# 26 "project/radare2/shlr/sdb/src/num.c" 3 4
                                                   ((void *)0)
# 26 "project/radare2/shlr/sdb/src/num.c"
                                                       ));
 val = sdb_itoa (v, b, numbase);
 return sdb_set (s, key, val, cas);
}

__attribute__ ((visibility ("default"))) unsigned long long sdb_num_inc(Sdb *s, const char *key, unsigned long long n2, unsigned int cas) {
 unsigned int c;
 unsigned long long n = sdb_num_get (s, key, &c);
 unsigned long long res = n + n2;
 if ((cas && c != cas) || res < n) {
  return 0LL;
 }
...
__attribute__ ((visibility ("default"))) unsigned long long sdb_num_dec(Sdb *s, const char *key, unsigned long long n2, unsigned int cas) {
 unsigned int c;
 unsigned long long n = sdb_num_get (s, key, &c);
 if (cas && c != cas) {
  return 0LL;
...
__attribute__ ((visibility ("default"))) int sdb_num_min(Sdb *db, const char*k, unsigned long long n, unsigned int cas) {
 const char* a = sdb_const_get (db, k, 
# 58 "project/radare2/shlr/sdb/src/num.c" 3 4
                                      ((void *)0)
# 58 "project/radare2/shlr/sdb/src/num.c"
                                          );
 return (!a || n < sdb_atoi (a))
  ? sdb_num_set (db, k, n, cas): 0;
}

__attribute__ ((visibility ("default"))) int sdb_num_max(Sdb *db, const char*k, unsigned long long n, unsigned int cas) {
 const char* a = sdb_const_get (db, k, 
# 64 "project/radare2/shlr/sdb/src/num.c" 3 4
                                      ((void *)0)
# 64 "project/radare2/shlr/sdb/src/num.c"
                                          );
 return (!a || n > sdb_atoi (a))
  ? sdb_num_set (db, k, n, cas): 0;
}
...
__attribute__ ((visibility ("default"))) int sdb_bool_set(Sdb *db, const char *str, 
# 69 "project/radare2/shlr/sdb/src/num.c" 3 4
                                                  _Bool 
# 69 "project/radare2/shlr/sdb/src/num.c"
                                                       v, unsigned int cas) {
 return sdb_set (db, str, v? "true": "false", cas);
}

__attribute__ ((visibility ("default"))) 
# 73 "project/radare2/shlr/sdb/src/num.c" 3 4
       _Bool 
# 73 "project/radare2/shlr/sdb/src/num.c"
            sdb_bool_get(Sdb *db, const char *str, unsigned int *cas) {
...
__attribute__ ((visibility ("default"))) int sdb_ptr_set(Sdb *db, const char *key, void *p, unsigned int cas) {
 return sdb_num_set (db, key, (unsigned long long)(size_t)p, cas);
}
