# 0 "project/radare2/shlr/sdb/src/ls.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/shlr/sdb/src/ls.c" 2
...
# 5 "project/radare2/shlr/sdb/src/ls.c" 2
# 16 "project/radare2/shlr/sdb/src/ls.c"
__attribute__ ((visibility ("default"))) SdbList *ls_newf(SdbListFree freefn) {
 SdbList *list = ls_new ();
 if (list) {
  list->free = freefn;
...
__attribute__ ((visibility ("default"))) SdbList *ls_new(void) {
 SdbList *list = (SdbList*)calloc(1, sizeof(SdbList));
 if (!list) {
  return 
# 27 "project/radare2/shlr/sdb/src/ls.c" 3 4
        ((void *)0)
# 27 "project/radare2/shlr/sdb/src/ls.c"
            ;
 }
 return list;
}
...
static SdbListIter *_merge(SdbListIter *first, SdbListIter *second, SdbListComparator cmp) {
 SdbListIter *next = 
# 50 "project/radare2/shlr/sdb/src/ls.c" 3 4
                    ((void *)0)
# 50 "project/radare2/shlr/sdb/src/ls.c"
                        , *result = 
# 50 "project/radare2/shlr/sdb/src/ls.c" 3 4
                                    ((void *)0)
# 50 "project/radare2/shlr/sdb/src/ls.c"
...
# 50 "project/radare2/shlr/sdb/src/ls.c"
 ...
 while (first || second) {
  ...
  if (!head) {
   ...
   head = result;
   head->p = 
# 68 "project/radare2/shlr/sdb/src/ls.c" 3 4
            ((void *)0)
# 68 "project/radare2/shlr/sdb/src/ls.c"
                ;
  } else {
   result->n = next;
   next->p = result;
 ...
 head->p = 
# 75 "project/radare2/shlr/sdb/src/ls.c" 3 4
          ((void *)0)
# 75 "project/radare2/shlr/sdb/src/ls.c"
              ;
 next->n = 
# 76 "project/radare2/shlr/sdb/src/ls.c" 3 4
          ((void *)0)
# 76 "project/radare2/shlr/sdb/src/ls.c"
              ;
 return head;
}
...
static SdbListIter * _sdb_list_split(SdbListIter *head) {
 ...
 if (count < 24) {
  return 
# 95 "project/radare2/shlr/sdb/src/ls.c" 3 4
        ((void *)0)
# 95 "project/radare2/shlr/sdb/src/ls.c"
            ;
 }
 SdbListIter *tmp = slow->n;
 slow->n = 
# 98 "project/radare2/shlr/sdb/src/ls.c" 3 4
          ((void *)0)
# 98 "project/radare2/shlr/sdb/src/ls.c"
              ;
 return tmp;
}
...
__attribute__ ((visibility ("default"))) 
# 116 "project/radare2/shlr/sdb/src/ls.c" 3 4
       _Bool 
# 116 "project/radare2/shlr/sdb/src/ls.c"
            ls_merge_sort(SdbList *list, SdbListComparator cmp) {
 if (!cmp) {
  return 
# 118 "project/radare2/shlr/sdb/src/ls.c" 3 4
        0
# 118 "project/radare2/shlr/sdb/src/ls.c"
             ;
 }
 if (list && list->head && cmp) {
  ...
  list->tail = iter;
  list->sorted = 
# 129 "project/radare2/shlr/sdb/src/ls.c" 3 4
                1
# 129 "project/radare2/shlr/sdb/src/ls.c"
                    ;
 }
 return 
# 131 "project/radare2/shlr/sdb/src/ls.c" 3 4
       1
# 131 "project/radare2/shlr/sdb/src/ls.c"
           ;
}

__attribute__ ((visibility ("default"))) 
# 134 "project/radare2/shlr/sdb/src/ls.c" 3 4
       _Bool 
# 134 "project/radare2/shlr/sdb/src/ls.c"
            ls_sort(SdbList *list, SdbListComparator cmp) {
 if (!cmp || list->cmp == cmp) {
  return 
# 136 "project/radare2/shlr/sdb/src/ls.c" 3 4
        0
# 136 "project/radare2/shlr/sdb/src/ls.c"
             ;
 }
 if (list->length > 24) {
 ...
 list->cmp = cmp;
 list->sorted = 
# 144 "project/radare2/shlr/sdb/src/ls.c" 3 4
               1
# 144 "project/radare2/shlr/sdb/src/ls.c"
                   ;
 return 
# 145 "project/radare2/shlr/sdb/src/ls.c" 3 4
       1
# 145 "project/radare2/shlr/sdb/src/ls.c"
           ;
}
...
__attribute__ ((visibility ("default"))) void ls_delete(SdbList *list, SdbListIter *iter) {
 ...
 if (list->free && iter->data) {
  list->free (iter->data);
  iter->data = 
# 155 "project/radare2/shlr/sdb/src/ls.c" 3 4
              ((void *)0)
# 155 "project/radare2/shlr/sdb/src/ls.c"
                  ;
 }
 free (iter);
}
...
__attribute__ ((visibility ("default"))) 
# 160 "project/radare2/shlr/sdb/src/ls.c" 3 4
       _Bool 
# 160 "project/radare2/shlr/sdb/src/ls.c"
            ls_delete_data(SdbList *list, void *ptr) {
 void *kvp;
 SdbListIter *iter;
 if ((list)) for (iter = (list)->head; iter && (kvp = iter->data); iter = iter->n) {
  if (ptr == kvp) {
   ls_delete (list, iter);
   return 
# 166 "project/radare2/shlr/sdb/src/ls.c" 3 4
         1
# 166 "project/radare2/shlr/sdb/src/ls.c"
             ;
  }
 }
 return 
# 169 "project/radare2/shlr/sdb/src/ls.c" 3 4
       0
# 169 "project/radare2/shlr/sdb/src/ls.c"
            ;
}
...
__attribute__ ((visibility ("default"))) void ls_destroy(SdbList *list) {
 ...
 list->head = list->tail = 
# 202 "project/radare2/shlr/sdb/src/ls.c" 3 4
                          ((void *)0)
# 202 "project/radare2/shlr/sdb/src/ls.c"
                              ;
 list->length = 0;
}
...
__attribute__ ((visibility ("default"))) void ls_free(SdbList *list) {
 ...
 ls_destroy (list);
 list->free = 
# 211 "project/radare2/shlr/sdb/src/ls.c" 3 4
             ((void *)0)
# 211 "project/radare2/shlr/sdb/src/ls.c"
                 ;
 free (list);
}
...
__attribute__ ((visibility ("default"))) SdbListIter *ls_append(SdbList *list, void *data) {
 ...
 if (!list) {
  return 
# 218 "project/radare2/shlr/sdb/src/ls.c" 3 4
        ((void *)0)
# 218 "project/radare2/shlr/sdb/src/ls.c"
            ;
 }
 it = (SdbListIter*)malloc(sizeof(SdbListIter));
 if (!it) {
  return 
# 222 "project/radare2/shlr/sdb/src/ls.c" 3 4
        ((void *)0)
# 222 "project/radare2/shlr/sdb/src/ls.c"
            ;
 }
 if (list->tail) {
  list->tail->n = it;
 ...
 it->p = list->tail;
 it->n = 
# 229 "project/radare2/shlr/sdb/src/ls.c" 3 4
        ((void *)0)
# 229 "project/radare2/shlr/sdb/src/ls.c"
            ;
 list->tail = it;
 if (!list->head) {
  list->head = it;
 ...
 list->length++;
 list->sorted = 
# 235 "project/radare2/shlr/sdb/src/ls.c" 3 4
               0
# 235 "project/radare2/shlr/sdb/src/ls.c"
                    ;
 return it;
}

__attribute__ ((visibility ("default"))) SdbListIter *ls_prepend(SdbList *list, void *data) {
 SdbListIter *it = (SdbListIter*)malloc(sizeof(SdbListIter));
 if (!it) {
  return 
# 242 "project/radare2/shlr/sdb/src/ls.c" 3 4
        ((void *)0)
# 242 "project/radare2/shlr/sdb/src/ls.c"
            ;
 }
 if (list->head) {
  list->head->p = it;
 ...
 it->n = list->head;
 it->p = 
# 249 "project/radare2/shlr/sdb/src/ls.c" 3 4
        ((void *)0)
# 249 "project/radare2/shlr/sdb/src/ls.c"
            ;
 list->head = it;
 if (!list->tail) {
  list->tail = it;
 ...
 list->length++;
 list->sorted = 
# 255 "project/radare2/shlr/sdb/src/ls.c" 3 4
               0
# 255 "project/radare2/shlr/sdb/src/ls.c"
                    ;
 return it;
}
...
__attribute__ ((visibility ("default"))) void *ls_pop(SdbList *list) {
 void *data = 
# 260 "project/radare2/shlr/sdb/src/ls.c" 3 4
             ((void *)0)
# 260 "project/radare2/shlr/sdb/src/ls.c"
                 ;
 SdbListIter *iter;
 if (list) {
  if (list->tail) {
   ...
   if (list->head == list->tail) {
    list->head = list->tail = 
# 266 "project/radare2/shlr/sdb/src/ls.c" 3 4
                             ((void *)0)
# 266 "project/radare2/shlr/sdb/src/ls.c"
                                 ;
   } else {
    list->tail = iter->p;
    list->tail->n = 
# 269 "project/radare2/shlr/sdb/src/ls.c" 3 4
                   ((void *)0)
# 269 "project/radare2/shlr/sdb/src/ls.c"
                       ;
   }
   data = iter->data;
   free (iter);
 ...
 return 
# 277 "project/radare2/shlr/sdb/src/ls.c" 3 4
       ((void *)0)
# 277 "project/radare2/shlr/sdb/src/ls.c"
           ;
}
...
__attribute__ ((visibility ("default"))) SdbList *ls_clone(SdbList *list) {
 if (!list) {
  return 
# 282 "project/radare2/shlr/sdb/src/ls.c" 3 4
        ((void *)0)
# 282 "project/radare2/shlr/sdb/src/ls.c"
            ;
 }
 SdbList *r = ls_new ();
 if (!r) {
  return 
# 286 "project/radare2/shlr/sdb/src/ls.c" 3 4
        ((void *)0)
# 286 "project/radare2/shlr/sdb/src/ls.c"
            ;
 }
 void *v;
 SdbListIter *iter;
 if ((list)) for (iter = (list)->head; iter && (v = iter->data); iter = iter->n) {
  ls_append (r, v);
 }
 return r;
}

__attribute__ ((visibility ("default"))) int ls_join(SdbList *list1, SdbList *list2) {
 if (!list1 || !list2) {
  return 0;
 }
 if (!(list2->length)) {
 ...
 if (!(list1->length)) {
  ...
  list1->tail = list2->tail;
  list1->tail->n = 
# 310 "project/radare2/shlr/sdb/src/ls.c" 3 4
                  ((void *)0)
# 310 "project/radare2/shlr/sdb/src/ls.c"
                      ;
 }
 list1->length += list2->length;
 list2->head = list2->tail = 
# 313 "project/radare2/shlr/sdb/src/ls.c" 3 4
                            ((void *)0)
# 313 "project/radare2/shlr/sdb/src/ls.c"
                                ;
 list1->sorted = 
# 314 "project/radare2/shlr/sdb/src/ls.c" 3 4
                0
# 314 "project/radare2/shlr/sdb/src/ls.c"
                     ;
 return 1;
}
...
__attribute__ ((visibility ("default"))) SdbListIter *ls_insert(SdbList *list, int n, void *data) {
 ...
 if (list) {
  ...
  for (it = list->head, i = 0; it && it->data; it = it->n, i++) {
   if (i == n) {
    item = (SdbListIter*)calloc(1, sizeof(SdbListIter));
    if (!item) {
     return 
# 330 "project/radare2/shlr/sdb/src/ls.c" 3 4
           ((void *)0)
# 330 "project/radare2/shlr/sdb/src/ls.c"
               ;
    }
    item->data = data;
    item->n = it;
    ...
    list->length++;
    list->sorted = 
# 340 "project/radare2/shlr/sdb/src/ls.c" 3 4
                  0
# 340 "project/radare2/shlr/sdb/src/ls.c"
                       ;
    return item;
   }
  }
...
__attribute__ ((visibility ("default"))) void *ls_pop_head(SdbList *list) {
 void *data = 
# 350 "project/radare2/shlr/sdb/src/ls.c" 3 4
             ((void *)0)
# 350 "project/radare2/shlr/sdb/src/ls.c"
                 ;
 SdbListIter *iter;
 if (list) {
  if (list->head) {
   ...
   if (list->head == list->tail) {
    list->head = list->tail = 
# 356 "project/radare2/shlr/sdb/src/ls.c" 3 4
                             ((void *)0)
# 356 "project/radare2/shlr/sdb/src/ls.c"
                                 ;
   } else {
    list->head = iter->n;
    list->head->p = 
# 359 "project/radare2/shlr/sdb/src/ls.c" 3 4
                   ((void *)0)
# 359 "project/radare2/shlr/sdb/src/ls.c"
                       ;
   }
   data = iter->data;
   free (iter);
 ...
 return 
# 367 "project/radare2/shlr/sdb/src/ls.c" 3 4
       ((void *)0)
# 367 "project/radare2/shlr/sdb/src/ls.c"
           ;
}
...
__attribute__ ((visibility ("default"))) int ls_del_n(SdbList *list, int n) {
 ...
 if (!list) {
  return 
# 375 "project/radare2/shlr/sdb/src/ls.c" 3 4
        0
# 375 "project/radare2/shlr/sdb/src/ls.c"
             ;
 }
 for (it = list->head, i = 0; it && it->data; it = it->n, i++)
  if (i == n) {
   if (!it->p && !it->n) {
    list->head = list->tail = 
# 380 "project/radare2/shlr/sdb/src/ls.c" 3 4
                             ((void *)0)
# 380 "project/radare2/shlr/sdb/src/ls.c"
                                 ;
   } else if (!it->p) {
    it->n->p = 
# 382 "project/radare2/shlr/sdb/src/ls.c" 3 4
              ((void *)0)
# 382 "project/radare2/shlr/sdb/src/ls.c"
                  ;
    list->head = it->n;
   } else if (!it->n) {
    it->p->n = 
# 385 "project/radare2/shlr/sdb/src/ls.c" 3 4
              ((void *)0)
# 385 "project/radare2/shlr/sdb/src/ls.c"
                  ;
    list->tail = it->p;
   } else {
    it->p->n = it->n;
   ...
   list->length--;
   return 
# 393 "project/radare2/shlr/sdb/src/ls.c" 3 4
         1
# 393 "project/radare2/shlr/sdb/src/ls.c"
             ;
  }
 return 
# 395 "project/radare2/shlr/sdb/src/ls.c" 3 4
       0
# 395 "project/radare2/shlr/sdb/src/ls.c"
            ;
}
