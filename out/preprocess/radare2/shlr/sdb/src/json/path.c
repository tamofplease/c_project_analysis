# 0 "project/radare2/shlr/sdb/src/json/path.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/shlr/sdb/src/json/path.c" 2
...
# 5 "project/radare2/shlr/sdb/src/json/path.c" 2
...
# 6 "project/radare2/shlr/sdb/src/json/path.c" 2
