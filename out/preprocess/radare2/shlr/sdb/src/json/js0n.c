# 0 "project/radare2/shlr/sdb/src/json/js0n.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/sdb/src/json/js0n.c"
...
# 7 "project/radare2/shlr/sdb/src/json/../types.h" 2
...
# 8 "project/radare2/shlr/sdb/src/json/../types.h" 2
...
# 11 "project/radare2/shlr/sdb/src/json/../types.h" 2
...
# 7 "project/radare2/shlr/sdb/src/json/js0n.c" 2
# 22 "project/radare2/shlr/sdb/src/json/js0n.c"
...
int sdb_js0n(const unsigned char *js, unsigned int len, unsigned int *out) {
 unsigned int prev = 0;
...
# 68 "project/radare2/shlr/sdb/src/json/js0n.c"
...
# 97 "project/radare2/shlr/sdb/src/json/js0n.c"
...
l_bad:
 return 1;
l_up:
 if(depth == 1) prev = *out++ = ((cur+0) - js);
 ++depth;
 goto l_loop;
l_down:
 --depth;
 if(depth == 1) prev = *out++ = ((cur+0) - (js + prev) + 1);
 goto l_loop;
l_qup:
 if(depth == 1) prev = *out++ = ((cur+1) - js);
 go = gostring;
 goto l_loop;
l_qdown:
 if(depth == 1) prev = *out++ = ((cur+-1) - (js + prev) + 1);
 go = gostruct;
 goto l_loop;
l_esc:
 go = goesc;
