# 0 "project/radare2/shlr/sdb/src/ht_pu.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/sdb/src/ht_pu.c"
...
# 2 "project/radare2/shlr/sdb/src/ht_pu.c" 2
# 1 "project/radare2/shlr/sdb/src/ht_pu.h" 1
# 9 "project/radare2/shlr/sdb/src/ht_pu.h"
# 1 "project/radare2/shlr/sdb/src/ht_inc.h" 1
...
# 67 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
       _Bool 
# 67 "project/radare2/shlr/sdb/src/ht_inc.h"
            (*HtPUForeachCallback)(void *user, const void *, const unsigned long long);
...
# 100 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
       _Bool 
# 100 "project/radare2/shlr/sdb/src/ht_inc.h"
            ht_pu_insert(HtPU* ht, const void * key, unsigned long long value);

__attribute__ ((visibility ("default"))) 
# 102 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
       _Bool 
# 102 "project/radare2/shlr/sdb/src/ht_inc.h"
            ht_pu_update(HtPU* ht, const void * key, unsigned long long value);

__attribute__ ((visibility ("default"))) 
# 104 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
       _Bool 
# 104 "project/radare2/shlr/sdb/src/ht_inc.h"
            ht_pu_update_key(HtPU* ht, const void * old_key, const void * new_key);

__attribute__ ((visibility ("default"))) 
# 106 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
       _Bool 
# 106 "project/radare2/shlr/sdb/src/ht_inc.h"
            ht_pu_delete(HtPU* ht, const void * key);

__attribute__ ((visibility ("default"))) unsigned long long ht_pu_find(HtPU* ht, const void * key, 
# 108 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
                                                                 _Bool
# 108 "project/radare2/shlr/sdb/src/ht_inc.h"
                                                                     * found);
...
__attribute__ ((visibility ("default"))) HtPUKv* ht_pu_find_kv(HtPU* ht, const void * key, 
# 115 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
                                                                  _Bool
# 115 "project/radare2/shlr/sdb/src/ht_inc.h"
                                                                      * found);
...
# 116 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
       _Bool 
# 116 "project/radare2/shlr/sdb/src/ht_inc.h"
            ht_pu_insert_kv(HtPU *ht, HtPUKv *kv, 
# 116 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
                                                         _Bool 
# 116 "project/radare2/shlr/sdb/src/ht_inc.h"
                                                              update);
# 10 "project/radare2/shlr/sdb/src/ht_pu.h" 2

__attribute__ ((visibility ("default"))) HtPU* ht_pu_new0(void);
# 3 "project/radare2/shlr/sdb/src/ht_pu.c" 2
...
static inline unsigned int hashfn(HtPU *ht, const void * k) {
 return ht->opt.hashfn ? ht->opt.hashfn (k) : ((unsigned int)(uintptr_t)(k));
}

static inline unsigned int bucketfn(HtPU *ht, const void * k) {
 return hashfn (ht, k) % ht->size;
}

static inline void * dupkey(HtPU *ht, const void * k) {
 return ht->opt.dupkey ? ht->opt.dupkey (k) : (void *)k;
}

static inline unsigned long long dupval(HtPU *ht, const unsigned long long v) {
 return ht->opt.dupvalue ? ht->opt.dupvalue (v) : (unsigned long long)v;
}

static inline unsigned int calcsize_key(HtPU *ht, const void * k) {
 return ht->opt.calcsizeK ? ht->opt.calcsizeK (k) : 0;
}

static inline unsigned int calcsize_val(HtPU *ht, const unsigned long long v) {
 return ht->opt.calcsizeV ? ht->opt.calcsizeV (v) : 0;
}

static inline void freefn(HtPU *ht, HtPUKv *kv) {
 if (ht->opt.freefn) {
  ht->opt.freefn (kv);
 }
}
...
# 62 "project/radare2/shlr/sdb/src/ht_inc.c"
                  is_kv_equal(HtPU *ht, const void * key, const unsigned int key_len, const HtPUKv *kv) {
...
static inline HtPUKv *kv_at(HtPU *ht, HtPUBucket *bt, unsigned int i) {
 return (HtPUKv *)((char *)bt->arr + i * ht->opt.elem_size);
}

static inline HtPUKv *next_kv(HtPU *ht, HtPUKv *kv) {
 return (HtPUKv *)((char *)kv + ht->opt.elem_size);
}
# 101 "project/radare2/shlr/sdb/src/ht_inc.c"
static HtPU* internal_ht_new(unsigned int size, unsigned int prime_idx, HtPUOptions *opt) {
 HtPU* ht = calloc (1, sizeof (*ht));
 if (!ht) {
  return 
...
# 112 "project/radare2/shlr/sdb/src/ht_inc.c"
 ...
 if (ht->opt.elem_size == 0) {
  ht->opt.elem_size = sizeof (HtPUKv);
 }
 return ht;
}
...
static void internal_ht_grow(HtPU* ht) {
 HtPU* ht2;
 HtPU swap;
...
static void check_growing(HtPU *ht) {
 if (ht->count >= 1 * ht->size) {
  internal_ht_grow (ht);
 }
}

static HtPUKv *reserve_kv(HtPU *ht, const void * key, const int key_len, 
# 189 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
                                                                                  _Bool 
# 189 "project/radare2/shlr/sdb/src/ht_inc.c"
                                                                                       update) {
 HtPUBucket *bt = &ht->table[bucketfn (ht, key)];
 HtPUKv *kvtmp;
 unsigned int j;
...
# 200 "project/radare2/shlr/sdb/src/ht_inc.c"
 ...
 HtPUKv *newkvarr = realloc (bt->arr, (bt->count + 1) * ht->opt.elem_size);
 if (!newkvarr) {
  return 
...
# 215 "project/radare2/shlr/sdb/src/ht_inc.c"
                                                              update) {
 HtPUKv *kv_dst = reserve_kv (ht, kv->key, kv->key_len, update);
 if (!kv_dst) {
  return 
...
# 226 "project/radare2/shlr/sdb/src/ht_inc.c"
           insert_update(HtPU *ht, const void * key, unsigned long long value, 
# 226 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
                                                                                _Bool 
# 226 "project/radare2/shlr/sdb/src/ht_inc.c"
                                                                                     update) {
 unsigned int key_len = calcsize_key (ht, key);
 HtPUKv* kv_dst = reserve_kv (ht, key, key_len, update);
 if (!kv_dst) {
  return 
...
# 256 "project/radare2/shlr/sdb/src/ht_inc.c"
     found;
 unsigned long long value = ht_pu_find (ht, old_key, &found);
 if (!found) {
  return 
...
# 265 "project/radare2/shlr/sdb/src/ht_inc.c"
 ...
 HtPUBucket *bt = &ht->table[bucketfn (ht, old_key)];
...
# 330 "project/radare2/shlr/sdb/src/ht_inc.c"
                                                                     * found) {
 HtPUKv *res = ht_pu_find_kv (ht, key, found);
...
# 4 "project/radare2/shlr/sdb/src/ht_pu.c" 2

static void free_kv_key(HtPUKv *kv) {
 free (kv->key);
}
...
__attribute__ ((visibility ("default"))) HtPU* ht_pu_new0(void) {
 HtPUOptions opt = {
  .cmp = (HtPUListComparator)strcmp,
  .hashfn = (HtPUHashFunction)sdb_hash,
  .dupkey = (HtPUDupKey)strdup,
  .dupvalue = 
# 15 "project/radare2/shlr/sdb/src/ht_pu.c" 3 4
             ((void *)0)
# 15 "project/radare2/shlr/sdb/src/ht_pu.c"
                 ,
  .calcsizeK = (HtPUCalcSizeK)strlen,
  .calcsizeV = 
# 17 "project/radare2/shlr/sdb/src/ht_pu.c" 3 4
              ((void *)0)
# 17 "project/radare2/shlr/sdb/src/ht_pu.c"
                  ,
  .freefn = free_kv_key,
  .elem_size = sizeof (HtPUKv),
 };
 return ht_pu_new_opt (&opt);
}
