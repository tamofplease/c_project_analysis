# 0 "project/radare2/shlr/sdb/src/json.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/shlr/sdb/src/json.c" 2
...
# 5 "project/radare2/shlr/sdb/src/json.c" 2
# 1 "project/radare2/shlr/sdb/src/json/rangstr.c" 1
# 9 "project/radare2/shlr/sdb/src/json/rangstr.c"
...
# 10 "project/radare2/shlr/sdb/src/json/rangstr.c" 2
# 20 "project/radare2/shlr/sdb/src/json/rangstr.c"
__attribute__ ((visibility ("hidden"))) Rangstr rangstr_null(void) {
 Rangstr rs = {0, 0, 0, 0, 0};
 return rs;
}

__attribute__ ((visibility ("hidden"))) Rangstr rangstr_new (const char *s) {
 Rangstr rs;
 if (!s) {
  return rangstr_null ();
 }
...
__attribute__ ((visibility ("hidden"))) int rangstr_length (Rangstr* rs) {
 if (rs->t > rs->f) {
  return rs->t - rs->f;
 }
 return 0;
...
__attribute__ ((visibility ("hidden"))) int rangstr_int (Rangstr *s) {
 if (!s || !s->p) {
  return 0;
 }
...
__attribute__ ((visibility ("hidden"))) char *rangstr_dup (Rangstr *rs) {
 if (!rs->p) {
  return 
# 75 "project/radare2/shlr/sdb/src/json/rangstr.c" 3 4
        ((void *)0)
# 75 "project/radare2/shlr/sdb/src/json/rangstr.c"
            ;
 }
...
# 80 "project/radare2/shlr/sdb/src/json/rangstr.c" 3 4
 __builtin___memcpy_chk (
# 80 "project/radare2/shlr/sdb/src/json/rangstr.c"
 p
# 80 "project/radare2/shlr/sdb/src/json/rangstr.c" 3 4
 , 
# 80 "project/radare2/shlr/sdb/src/json/rangstr.c"
...
__attribute__ ((visibility ("hidden"))) Rangstr rangstr_news (const char *s, unsigned int *res, int i) {
 Rangstr rs;
 rs.next = 1;
 rs.f = res[i];
 rs.t = res[i]+res[i+1];
...
__attribute__ ((visibility ("hidden"))) int rangstr_cmp (Rangstr *a, Rangstr *b) {
 int la = a->t - a->f;
 int lb = b->t - b->f;
...
__attribute__ ((visibility ("hidden"))) int rangstr_find (Rangstr* a, char ch) {
 size_t i = a->f;
 while (i < a->t && a->p[i] && a->p[i] != ch) i++;
 return (i < a->t && a->p[i]) ? (int) i: -1;
}

__attribute__ ((visibility ("hidden"))) const char *rangstr_str (Rangstr* rs) {
 return rs->p + rs->f;
}
# 6 "project/radare2/shlr/sdb/src/json.c" 2
# 1 "project/radare2/shlr/sdb/src/json/js0n.c" 1
...
# 7 "project/radare2/shlr/sdb/src/json.c" 2
# 1 "project/radare2/shlr/sdb/src/json/path.c" 1
...
# 1 "project/radare2/shlr/sdb/src/json/rangstr.c" 1
# 7 "project/radare2/shlr/sdb/src/json/path.c" 2


__attribute__ ((visibility ("hidden"))) void json_path_first(Rangstr *s) {
 char *p;
 if (!s->p) {
  return;
 }
...
__attribute__ ((visibility ("hidden"))) int json_path_next(Rangstr *s) {
 int stop = '.';
 if (!s||!s->p||!s->p[s->t]) {
  return 0;
 }
...
# 113 "project/radare2/shlr/sdb/src/json/path.c"
__attribute__ ((visibility ("hidden"))) Rangstr json_find (const char *s, Rangstr *rs) {

 unsigned int resfix[1024] = {0};
 unsigned int *res = resfix;
 int i, j, n, len, ret;
 Rangstr rsn;
 ...
 len = strlen (s);
 if (len > 1024) {
  res = calloc (len + 1, sizeof (unsigned int));
  if (!res) {
   fprintf(
# 128 "project/radare2/shlr/sdb/src/json/path.c" 3 4
  __stderrp
# 128 "project/radare2/shlr/sdb/src/json/path.c"
...
__attribute__ ((visibility ("hidden"))) Rangstr json_get (const char *js, const char *p) {
 int x, n = 0;
 size_t rst;
...
# 8 "project/radare2/shlr/sdb/src/json.c" 2
# 1 "project/radare2/shlr/sdb/src/json/api.c" 1
# 10 "project/radare2/shlr/sdb/src/json/api.c"
...
# 9 "project/radare2/shlr/sdb/src/json.c" 2
# 1 "project/radare2/shlr/sdb/src/json/indent.c" 1
...
__attribute__ ((visibility ("default"))) char *sdb_json_indent(const char *s, const char *tab) {
 ...
 if (!s) {
  return 
# 21 "project/radare2/shlr/sdb/src/json/indent.c" 3 4
        ((void *)0)
# 21 "project/radare2/shlr/sdb/src/json/indent.c"
            ;
 }
 ...
 for (idx = 0; s[idx]; idx++) {
  if (o_size > 0x7fffffff - (indent * tab_len + 2)) {
   return 
# 27 "project/radare2/shlr/sdb/src/json/indent.c" 3 4
         ((void *)0)
# 27 "project/radare2/shlr/sdb/src/json/indent.c"
             ;
  }
 ...
 if (!O) {
  return 
# 55 "project/radare2/shlr/sdb/src/json/indent.c" 3 4
        ((void *)0)
# 55 "project/radare2/shlr/sdb/src/json/indent.c"
            ;
 }
...
__attribute__ ((visibility ("default"))) char *sdb_json_unindent(const char *s) {
 ...
 if (!O) {
  return 
# 115 "project/radare2/shlr/sdb/src/json/indent.c" 3 4
        ((void *)0)
# 115 "project/radare2/shlr/sdb/src/json/indent.c"
            ;
 }
 
# 117 "project/radare2/shlr/sdb/src/json/indent.c" 3 4
__builtin___memset_chk (
# 117 "project/radare2/shlr/sdb/src/json/indent.c"
O
# 117 "project/radare2/shlr/sdb/src/json/indent.c" 3 4
, 
# 117 "project/radare2/shlr/sdb/src/json/indent.c"
...
# 10 "project/radare2/shlr/sdb/src/json.c" 2
...
__attribute__ ((visibility ("default"))) 
# 16 "project/radare2/shlr/sdb/src/json.c" 3 4
       _Bool 
# 16 "project/radare2/shlr/sdb/src/json.c"
            sdb_json_get_bool(const char *json, const char *path) {
 Rangstr rs = json_get (json, path);
...
__attribute__ ((visibility ("default"))) char *sdb_json_get(Sdb *s, const char *k, const char *p, unsigned int *cas) {
 Rangstr rs;
 char *u, *v = sdb_get (s, k, cas);
 if (!v) {
  return 
# 26 "project/radare2/shlr/sdb/src/json.c" 3 4
        ((void *)0)
# 26 "project/radare2/shlr/sdb/src/json.c"
            ;
 }
 rs = json_get (v, p);
 u = rangstr_dup (&rs);
...
static 
# 81 "project/radare2/shlr/sdb/src/json.c" 3 4
      _Bool 
# 81 "project/radare2/shlr/sdb/src/json.c"
           isstring(const char *s) {
 if (!strcmp (s, "true")) {
  return 
# 83 "project/radare2/shlr/sdb/src/json.c" 3 4
        0
# 83 "project/radare2/shlr/sdb/src/json.c"
             ;
 }
 if (!strcmp (s, "false")) {
  return 
# 86 "project/radare2/shlr/sdb/src/json.c" 3 4
        0
# 86 "project/radare2/shlr/sdb/src/json.c"
             ;
 }
 for (; *s; s++) {
  if (*s < '0' || *s > '9') {
   return 
# 90 "project/radare2/shlr/sdb/src/json.c" 3 4
         1
# 90 "project/radare2/shlr/sdb/src/json.c"
             ;
  }
 }
 return 
# 93 "project/radare2/shlr/sdb/src/json.c" 3 4
       0
# 93 "project/radare2/shlr/sdb/src/json.c"
            ;
}
...
__attribute__ ((visibility ("default"))) int sdb_json_unset(Sdb *s, const char *k, const char *p, unsigned int cas) {
 return sdb_json_set (s, k, p, 
# 104 "project/radare2/shlr/sdb/src/json.c" 3 4
                              ((void *)0)
# 104 "project/radare2/shlr/sdb/src/json.c"
                                  , cas);
}

__attribute__ ((visibility ("default"))) 
# 107 "project/radare2/shlr/sdb/src/json.c" 3 4
       _Bool 
# 107 "project/radare2/shlr/sdb/src/json.c"
            sdb_json_set(Sdb *s, const char *k, const char *p, const char *v, unsigned int cas) {
 int l, idx, len[3], jslen = 0;
 char *b, *str = 
# 109 "project/radare2/shlr/sdb/src/json.c" 3 4
                ((void *)0)
# 109 "project/radare2/shlr/sdb/src/json.c"
                    ;
 const char *beg[3];
 const char *end[3];
 const char *js;
 ...
 if (!s || !k || !v) {
  return 
# 117 "project/radare2/shlr/sdb/src/json.c" 3 4
        0
# 117 "project/radare2/shlr/sdb/src/json.c"
             ;
 }
...
# 127 "project/radare2/shlr/sdb/src/json.c" 3 4
  __builtin___sprintf_chk (
# 127 "project/radare2/shlr/sdb/src/json.c"
  b
# 127 "project/radare2/shlr/sdb/src/json.c" 3 4
  , 0, __builtin_object_size (
# 127 "project/radare2/shlr/sdb/src/json.c"
...
# 127 "project/radare2/shlr/sdb/src/json.c"
   ...
   return 
# 135 "project/radare2/shlr/sdb/src/json.c" 3 4
         1
# 135 "project/radare2/shlr/sdb/src/json.c"
             ;
  }
  return 
# 137 "project/radare2/shlr/sdb/src/json.c" 3 4
        0
# 137 "project/radare2/shlr/sdb/src/json.c"
             ;
 }
 jslen++;
 if (cas && c != cas) {
  return 
# 141 "project/radare2/shlr/sdb/src/json.c" 3 4
        0
# 141 "project/radare2/shlr/sdb/src/json.c"
             ;
 }
 rs = json_get (js, p);
 if (!rs.p) {
  ...
  if (buf) {
   ...
   curlen = 
# 157 "project/radare2/shlr/sdb/src/json.c" 3 4
           __builtin___sprintf_chk (
# 157 "project/radare2/shlr/sdb/src/json.c"
           buf
# 157 "project/radare2/shlr/sdb/src/json.c" 3 4
           , 0, __builtin_object_size (
# 157 "project/radare2/shlr/sdb/src/json.c"
...
# 157 "project/radare2/shlr/sdb/src/json.c" 3 4
           , 2 > 1 ? 1 : 0), 
# 157 "project/radare2/shlr/sdb/src/json.c"
           "{\"%s\":%s%s%s%s", p, quote, v, quote, end
# 157 "project/radare2/shlr/sdb/src/json.c" 3 4
           )
                            
# 158 "project/radare2/shlr/sdb/src/json.c"
                           ;
   
# 159 "project/radare2/shlr/sdb/src/json.c" 3 4
  __builtin___strcpy_chk (
# 159 "project/radare2/shlr/sdb/src/json.c"
  buf + curlen
# 159 "project/radare2/shlr/sdb/src/json.c" 3 4
  , 
# 159 "project/radare2/shlr/sdb/src/json.c"
...
# 159 "project/radare2/shlr/sdb/src/json.c"
   ...
   return 
# 162 "project/radare2/shlr/sdb/src/json.c" 3 4
         1
# 162 "project/radare2/shlr/sdb/src/json.c"
             ;
  }

  return 
# 165 "project/radare2/shlr/sdb/src/json.c" 3 4
        0
# 165 "project/radare2/shlr/sdb/src/json.c"
             ;
 }
 ...
 if (*v) {
  ...
  if (msz < 1) {
   return 
# 189 "project/radare2/shlr/sdb/src/json.c" 3 4
         0
# 189 "project/radare2/shlr/sdb/src/json.c"
              ;
  }
  str = malloc (msz);
  if (!str) {
   return 
# 193 "project/radare2/shlr/sdb/src/json.c" 3 4
         0
# 193 "project/radare2/shlr/sdb/src/json.c"
              ;
  }
  idx = len[0];
  
# 196 "project/radare2/shlr/sdb/src/json.c" 3 4
 __builtin___memcpy_chk (
# 196 "project/radare2/shlr/sdb/src/json.c"
 str
# 196 "project/radare2/shlr/sdb/src/json.c" 3 4
 , 
# 196 "project/radare2/shlr/sdb/src/json.c"
...
# 209 "project/radare2/shlr/sdb/src/json.c" 3 4
 __builtin___memcpy_chk (
# 209 "project/radare2/shlr/sdb/src/json.c"
 str + idx
# 209 "project/radare2/shlr/sdb/src/json.c" 3 4
 , 
# 209 "project/radare2/shlr/sdb/src/json.c"
...
# 224 "project/radare2/shlr/sdb/src/json.c" 3 4
 __builtin___memcpy_chk (
# 224 "project/radare2/shlr/sdb/src/json.c"
 str + idx
# 224 "project/radare2/shlr/sdb/src/json.c" 3 4
 , 
# 224 "project/radare2/shlr/sdb/src/json.c"
...
# 224 "project/radare2/shlr/sdb/src/json.c"
  ...
  if (!str) {
   return 
# 247 "project/radare2/shlr/sdb/src/json.c" 3 4
         0
# 247 "project/radare2/shlr/sdb/src/json.c"
              ;
  }

  
# 250 "project/radare2/shlr/sdb/src/json.c" 3 4
 __builtin___memcpy_chk (
# 250 "project/radare2/shlr/sdb/src/json.c"
 str
# 250 "project/radare2/shlr/sdb/src/json.c" 3 4
 , 
# 250 "project/radare2/shlr/sdb/src/json.c"
...
# 251 "project/radare2/shlr/sdb/src/json.c" 3 4
 __builtin___memcpy_chk (
# 251 "project/radare2/shlr/sdb/src/json.c"
 str + len[0]
# 251 "project/radare2/shlr/sdb/src/json.c" 3 4
 , 
# 251 "project/radare2/shlr/sdb/src/json.c"
...
# 251 "project/radare2/shlr/sdb/src/json.c"
 ...
 return 
# 255 "project/radare2/shlr/sdb/src/json.c" 3 4
       1
# 255 "project/radare2/shlr/sdb/src/json.c"
           ;
}
...
__attribute__ ((visibility ("default"))) const char *sdb_json_format(SdbJsonString *s, const char *fmt, ...) {
 ...
 double arg_f;
 va_list ap;
# 274 "project/radare2/shlr/sdb/src/json.c"
 if (!s) {
  return 
# 275 "project/radare2/shlr/sdb/src/json.c" 3 4
        ((void *)0)
# 275 "project/radare2/shlr/sdb/src/json.c"
            ;
 }
 if (!s->buf) {
  s->blen = 1024;
  ...
  if (!s->buf) {
   return 
# 281 "project/radare2/shlr/sdb/src/json.c" 3 4
         ((void *)0)
# 281 "project/radare2/shlr/sdb/src/json.c"
             ;
  }
  *s->buf = 0;
 }
...
# 288 "project/radare2/shlr/sdb/src/json.c" 3 4
__builtin_va_start(
# 288 "project/radare2/shlr/sdb/src/json.c"
ap
# 288 "project/radare2/shlr/sdb/src/json.c" 3 4
,
# 288 "project/radare2/shlr/sdb/src/json.c"
...
# 288 "project/radare2/shlr/sdb/src/json.c"
 ...
 for (; *fmt; fmt++) {
  if (*fmt == '%') {
   ...
   switch (*fmt) {
   case 'b':
    if (s->len + 32 > s->blen) { s->blen *= 2; x = realloc (s->buf, s->blen); if (!x) { 
# 294 "project/radare2/shlr/sdb/src/json.c" 3 4
   __builtin_va_end(
# 294 "project/radare2/shlr/sdb/src/json.c"
   ap
# 294 "project/radare2/shlr/sdb/src/json.c" 3 4
   )
# 294 "project/radare2/shlr/sdb/src/json.c"
...
# 294 "project/radare2/shlr/sdb/src/json.c"
   ; } s->buf = x; };
    arg_i = 
# 295 "project/radare2/shlr/sdb/src/json.c" 3 4
           __builtin_va_arg(
# 295 "project/radare2/shlr/sdb/src/json.c"
           ap
# 295 "project/radare2/shlr/sdb/src/json.c" 3 4
           ,
# 295 "project/radare2/shlr/sdb/src/json.c"
...
# 297 "project/radare2/shlr/sdb/src/json.c" 3 4
   __builtin___memcpy_chk (
# 297 "project/radare2/shlr/sdb/src/json.c"
   s->buf + s->len
# 297 "project/radare2/shlr/sdb/src/json.c" 3 4
   , 
# 297 "project/radare2/shlr/sdb/src/json.c"
   (arg_i == 4)? "true": "false", 5
# 297 "project/radare2/shlr/sdb/src/json.c" 3 4
   , __builtin_object_size (
# 297 "project/radare2/shlr/sdb/src/json.c"
   s->buf + s->len
...
# 297 "project/radare2/shlr/sdb/src/json.c"
   ...
   case 'f':
    if (s->len + 32 > s->blen) { s->blen *= 2; x = realloc (s->buf, s->blen); if (!x) { 
# 301 "project/radare2/shlr/sdb/src/json.c" 3 4
   __builtin_va_end(
# 301 "project/radare2/shlr/sdb/src/json.c"
   ap
# 301 "project/radare2/shlr/sdb/src/json.c" 3 4
   )
# 301 "project/radare2/shlr/sdb/src/json.c"
...
# 301 "project/radare2/shlr/sdb/src/json.c"
   ; } s->buf = x; };
    arg_f = 
# 302 "project/radare2/shlr/sdb/src/json.c" 3 4
           __builtin_va_arg(
# 302 "project/radare2/shlr/sdb/src/json.c"
           ap
# 302 "project/radare2/shlr/sdb/src/json.c" 3 4
           ,
# 302 "project/radare2/shlr/sdb/src/json.c"
...
# 303 "project/radare2/shlr/sdb/src/json.c" 3 4
   __builtin___snprintf_chk (
# 303 "project/radare2/shlr/sdb/src/json.c"
   tmp
# 303 "project/radare2/shlr/sdb/src/json.c" 3 4
   , 
# 303 "project/radare2/shlr/sdb/src/json.c"
...
# 304 "project/radare2/shlr/sdb/src/json.c" 3 4
   __builtin___memcpy_chk (
# 304 "project/radare2/shlr/sdb/src/json.c"
   s->buf + s->len
# 304 "project/radare2/shlr/sdb/src/json.c" 3 4
   , 
# 304 "project/radare2/shlr/sdb/src/json.c"
...
# 304 "project/radare2/shlr/sdb/src/json.c"
   ...
   case 'l':
    if (s->len + 32 > s->blen) { s->blen *= 2; x = realloc (s->buf, s->blen); if (!x) { 
# 308 "project/radare2/shlr/sdb/src/json.c" 3 4
   __builtin_va_end(
# 308 "project/radare2/shlr/sdb/src/json.c"
   ap
# 308 "project/radare2/shlr/sdb/src/json.c" 3 4
   )
# 308 "project/radare2/shlr/sdb/src/json.c"
...
# 308 "project/radare2/shlr/sdb/src/json.c"
   ; } s->buf = x; };
    arg_l = 
# 309 "project/radare2/shlr/sdb/src/json.c" 3 4
           __builtin_va_arg(
# 309 "project/radare2/shlr/sdb/src/json.c"
           ap
# 309 "project/radare2/shlr/sdb/src/json.c" 3 4
           ,
# 309 "project/radare2/shlr/sdb/src/json.c"
...
# 310 "project/radare2/shlr/sdb/src/json.c" 3 4
   __builtin___snprintf_chk (
# 310 "project/radare2/shlr/sdb/src/json.c"
   tmp
# 310 "project/radare2/shlr/sdb/src/json.c" 3 4
   , 
# 310 "project/radare2/shlr/sdb/src/json.c"
...
# 311 "project/radare2/shlr/sdb/src/json.c" 3 4
   __builtin___memcpy_chk (
# 311 "project/radare2/shlr/sdb/src/json.c"
   s->buf + s->len
# 311 "project/radare2/shlr/sdb/src/json.c" 3 4
   , 
# 311 "project/radare2/shlr/sdb/src/json.c"
...
# 311 "project/radare2/shlr/sdb/src/json.c"
   ...
   case 'i':
    if (s->len + 32 > s->blen) { s->blen *= 2; x = realloc (s->buf, s->blen); if (!x) { 
# 316 "project/radare2/shlr/sdb/src/json.c" 3 4
   __builtin_va_end(
# 316 "project/radare2/shlr/sdb/src/json.c"
   ap
# 316 "project/radare2/shlr/sdb/src/json.c" 3 4
   )
# 316 "project/radare2/shlr/sdb/src/json.c"
...
# 316 "project/radare2/shlr/sdb/src/json.c"
   ; } s->buf = x; };
    arg_i = 
# 317 "project/radare2/shlr/sdb/src/json.c" 3 4
           __builtin_va_arg(
# 317 "project/radare2/shlr/sdb/src/json.c"
           ap
# 317 "project/radare2/shlr/sdb/src/json.c" 3 4
           ,
# 317 "project/radare2/shlr/sdb/src/json.c"
...
# 318 "project/radare2/shlr/sdb/src/json.c" 3 4
   __builtin___snprintf_chk (
# 318 "project/radare2/shlr/sdb/src/json.c"
   tmp
# 318 "project/radare2/shlr/sdb/src/json.c" 3 4
   , 
# 318 "project/radare2/shlr/sdb/src/json.c"
...
# 319 "project/radare2/shlr/sdb/src/json.c" 3 4
   __builtin___memcpy_chk (
# 319 "project/radare2/shlr/sdb/src/json.c"
   s->buf + s->len
# 319 "project/radare2/shlr/sdb/src/json.c" 3 4
   , 
# 319 "project/radare2/shlr/sdb/src/json.c"
...
# 319 "project/radare2/shlr/sdb/src/json.c"
   ...
   case 's':
    arg_s = 
# 323 "project/radare2/shlr/sdb/src/json.c" 3 4
           __builtin_va_arg(
# 323 "project/radare2/shlr/sdb/src/json.c"
           ap
# 323 "project/radare2/shlr/sdb/src/json.c" 3 4
           ,
# 323 "project/radare2/shlr/sdb/src/json.c"
...
# 323 "project/radare2/shlr/sdb/src/json.c"
                              ;
    if (s->len + strlen (arg_s) + 3 > s->blen) { s->blen *= 2; x = realloc (s->buf, s->blen); if (!x) { 
# 324 "project/radare2/shlr/sdb/src/json.c" 3 4
   __builtin_va_end(
# 324 "project/radare2/shlr/sdb/src/json.c"
   ap
# 324 "project/radare2/shlr/sdb/src/json.c" 3 4
   )
# 324 "project/radare2/shlr/sdb/src/json.c"
...
# 324 "project/radare2/shlr/sdb/src/json.c"
   ...
   if (s->len + 10 > s->blen) { s->blen *= 2; x = realloc (s->buf, s->blen); if (!x) { 
# 336 "project/radare2/shlr/sdb/src/json.c" 3 4
  __builtin_va_end(
# 336 "project/radare2/shlr/sdb/src/json.c"
  ap
# 336 "project/radare2/shlr/sdb/src/json.c" 3 4
  )
# 336 "project/radare2/shlr/sdb/src/json.c"
...
# 341 "project/radare2/shlr/sdb/src/json.c" 3 4
__builtin_va_end(
# 341 "project/radare2/shlr/sdb/src/json.c"
ap
# 341 "project/radare2/shlr/sdb/src/json.c" 3 4
)
# 341 "project/radare2/shlr/sdb/src/json.c"
