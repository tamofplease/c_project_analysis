# 0 "project/radare2/shlr/sdb/src/ht_up.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/sdb/src/ht_up.c"
...
# 2 "project/radare2/shlr/sdb/src/ht_up.c" 2
# 1 "project/radare2/shlr/sdb/src/ht_up.h" 1
# 10 "project/radare2/shlr/sdb/src/ht_up.h"
# 1 "project/radare2/shlr/sdb/src/ht_inc.h" 1
...
# 67 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
       _Bool 
# 67 "project/radare2/shlr/sdb/src/ht_inc.h"
            (*HtUPForeachCallback)(void *user, const unsigned long long, const void *);
...
# 100 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
       _Bool 
# 100 "project/radare2/shlr/sdb/src/ht_inc.h"
            ht_up_insert(HtUP* ht, const unsigned long long key, void * value);

__attribute__ ((visibility ("default"))) 
# 102 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
       _Bool 
# 102 "project/radare2/shlr/sdb/src/ht_inc.h"
            ht_up_update(HtUP* ht, const unsigned long long key, void * value);

__attribute__ ((visibility ("default"))) 
# 104 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
       _Bool 
# 104 "project/radare2/shlr/sdb/src/ht_inc.h"
            ht_up_update_key(HtUP* ht, const unsigned long long old_key, const unsigned long long new_key);

__attribute__ ((visibility ("default"))) 
# 106 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
       _Bool 
# 106 "project/radare2/shlr/sdb/src/ht_inc.h"
            ht_up_delete(HtUP* ht, const unsigned long long key);

__attribute__ ((visibility ("default"))) void * ht_up_find(HtUP* ht, const unsigned long long key, 
# 108 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
                                                                 _Bool
# 108 "project/radare2/shlr/sdb/src/ht_inc.h"
                                                                     * found);
...
__attribute__ ((visibility ("default"))) HtUPKv* ht_up_find_kv(HtUP* ht, const unsigned long long key, 
# 115 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
                                                                  _Bool
# 115 "project/radare2/shlr/sdb/src/ht_inc.h"
                                                                      * found);
...
# 116 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
       _Bool 
# 116 "project/radare2/shlr/sdb/src/ht_inc.h"
            ht_up_insert_kv(HtUP *ht, HtUPKv *kv, 
# 116 "project/radare2/shlr/sdb/src/ht_inc.h" 3 4
                                                         _Bool 
# 116 "project/radare2/shlr/sdb/src/ht_inc.h"
                                                              update);
# 11 "project/radare2/shlr/sdb/src/ht_up.h" 2
...
# 3 "project/radare2/shlr/sdb/src/ht_up.c" 2
...
static inline unsigned int hashfn(HtUP *ht, const unsigned long long k) {
 return ht->opt.hashfn ? ht->opt.hashfn (k) : ((unsigned int)(k));
}

static inline unsigned int bucketfn(HtUP *ht, const unsigned long long k) {
 return hashfn (ht, k) % ht->size;
}

static inline unsigned long long dupkey(HtUP *ht, const unsigned long long k) {
 return ht->opt.dupkey ? ht->opt.dupkey (k) : (unsigned long long)k;
}

static inline void * dupval(HtUP *ht, const void * v) {
 return ht->opt.dupvalue ? ht->opt.dupvalue (v) : (void *)v;
}

static inline unsigned int calcsize_key(HtUP *ht, const unsigned long long k) {
 return ht->opt.calcsizeK ? ht->opt.calcsizeK (k) : 0;
}

static inline unsigned int calcsize_val(HtUP *ht, const void * v) {
 return ht->opt.calcsizeV ? ht->opt.calcsizeV (v) : 0;
}

static inline void freefn(HtUP *ht, HtUPKv *kv) {
 if (ht->opt.freefn) {
  ht->opt.freefn (kv);
 }
}
...
# 62 "project/radare2/shlr/sdb/src/ht_inc.c"
                  is_kv_equal(HtUP *ht, const unsigned long long key, const unsigned int key_len, const HtUPKv *kv) {
...
static inline HtUPKv *kv_at(HtUP *ht, HtUPBucket *bt, unsigned int i) {
 return (HtUPKv *)((char *)bt->arr + i * ht->opt.elem_size);
}

static inline HtUPKv *next_kv(HtUP *ht, HtUPKv *kv) {
 return (HtUPKv *)((char *)kv + ht->opt.elem_size);
}
# 101 "project/radare2/shlr/sdb/src/ht_inc.c"
static HtUP* internal_ht_new(unsigned int size, unsigned int prime_idx, HtUPOptions *opt) {
 HtUP* ht = calloc (1, sizeof (*ht));
 if (!ht) {
  return 
...
# 112 "project/radare2/shlr/sdb/src/ht_inc.c"
 ...
 if (ht->opt.elem_size == 0) {
  ht->opt.elem_size = sizeof (HtUPKv);
 }
 return ht;
}
...
static void internal_ht_grow(HtUP* ht) {
 HtUP* ht2;
 HtUP swap;
...
static void check_growing(HtUP *ht) {
 if (ht->count >= 1 * ht->size) {
  internal_ht_grow (ht);
 }
}

static HtUPKv *reserve_kv(HtUP *ht, const unsigned long long key, const int key_len, 
# 189 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
                                                                                  _Bool 
# 189 "project/radare2/shlr/sdb/src/ht_inc.c"
                                                                                       update) {
 HtUPBucket *bt = &ht->table[bucketfn (ht, key)];
 HtUPKv *kvtmp;
 unsigned int j;
...
# 200 "project/radare2/shlr/sdb/src/ht_inc.c"
 ...
 HtUPKv *newkvarr = realloc (bt->arr, (bt->count + 1) * ht->opt.elem_size);
 if (!newkvarr) {
  return 
...
# 215 "project/radare2/shlr/sdb/src/ht_inc.c"
                                                              update) {
 HtUPKv *kv_dst = reserve_kv (ht, kv->key, kv->key_len, update);
 if (!kv_dst) {
  return 
...
# 226 "project/radare2/shlr/sdb/src/ht_inc.c"
           insert_update(HtUP *ht, const unsigned long long key, void * value, 
# 226 "project/radare2/shlr/sdb/src/ht_inc.c" 3 4
                                                                                _Bool 
# 226 "project/radare2/shlr/sdb/src/ht_inc.c"
                                                                                     update) {
 unsigned int key_len = calcsize_key (ht, key);
 HtUPKv* kv_dst = reserve_kv (ht, key, key_len, update);
 if (!kv_dst) {
  return 
...
# 256 "project/radare2/shlr/sdb/src/ht_inc.c"
     found;
 void * value = ht_up_find (ht, old_key, &found);
 if (!found) {
  return 
...
# 265 "project/radare2/shlr/sdb/src/ht_inc.c"
 ...
 HtUPBucket *bt = &ht->table[bucketfn (ht, old_key)];
...
# 330 "project/radare2/shlr/sdb/src/ht_inc.c"
                                                                     * found) {
 HtUPKv *res = ht_up_find_kv (ht, key, found);
...
# 4 "project/radare2/shlr/sdb/src/ht_up.c" 2

static HtUP* internal_ht_default_new(unsigned int size, unsigned int prime_idx, HtUPDupValue valdup, HtUPKvFreeFunc pair_free, HtUPCalcSizeV calcsizeV) {
 HtUPOptions opt = {
  .cmp = 
# 7 "project/radare2/shlr/sdb/src/ht_up.c" 3 4
        ((void *)0)
# 7 "project/radare2/shlr/sdb/src/ht_up.c"
            ,
  .hashfn = 
# 8 "project/radare2/shlr/sdb/src/ht_up.c" 3 4
           ((void *)0)
# 8 "project/radare2/shlr/sdb/src/ht_up.c"
               ,
  .dupkey = 
# 9 "project/radare2/shlr/sdb/src/ht_up.c" 3 4
           ((void *)0)
# 9 "project/radare2/shlr/sdb/src/ht_up.c"
               ,
  .dupvalue = valdup,
  .calcsizeK = 
# 11 "project/radare2/shlr/sdb/src/ht_up.c" 3 4
              ((void *)0)
# 11 "project/radare2/shlr/sdb/src/ht_up.c"
                  ,
  .calcsizeV = calcsizeV,
  .freefn = pair_free,
  .elem_size = sizeof (HtUPKv),
 };
 return internal_ht_new (size, prime_idx, &opt);
}

__attribute__ ((visibility ("default"))) HtUP* ht_up_new(HtUPDupValue valdup, HtUPKvFreeFunc pair_free, HtUPCalcSizeV calcsizeV) {
...
__attribute__ ((visibility ("default"))) HtUP* ht_up_new0(void) {
 return ht_up_new (
# 25 "project/radare2/shlr/sdb/src/ht_up.c" 3 4
                 ((void *)0)
# 25 "project/radare2/shlr/sdb/src/ht_up.c"
                     , 
# 25 "project/radare2/shlr/sdb/src/ht_up.c" 3 4
                       ((void *)0)
# 25 "project/radare2/shlr/sdb/src/ht_up.c"
...
__attribute__ ((visibility ("default"))) HtUP* ht_up_new_size(unsigned int initial_size, HtUPDupValue valdup, HtUPKvFreeFunc pair_free, HtUPCalcSizeV calcsizeV) {
 unsigned int i = 0;

 while (i < (sizeof (ht_primes_sizes) / sizeof (ht_primes_sizes[0])) &&
  ht_primes_sizes[i] * 1 < initial_size) {
  i++;
 }
 if (i == (sizeof (ht_primes_sizes) / sizeof (ht_primes_sizes[0]))) {
  i = ((unsigned int)0xffffffff);
 }

 unsigned int sz = compute_size (i, (unsigned int)(initial_size * (2 - 1)));
