# 0 "project/radare2/shlr/grub/partmap/msdos.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
typedef int RRef;
# 21 "project/radare2/shlr/grub/partmap/msdos.c" 2
...
# 22 "project/radare2/shlr/grub/partmap/msdos.c" 2
...
# 23 "project/radare2/shlr/grub/partmap/msdos.c" 2
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 24 "project/radare2/shlr/grub/partmap/msdos.c" 2
...
# 25 "project/radare2/shlr/grub/partmap/msdos.c" 2
...
# 25 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/file.h" 3 4
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/fs.h" 1 3 4
# 29 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/fs.h" 3 4
struct grub_file;
...
# 27 "project/radare2/shlr/grub/partmap/msdos.c" 2


# 28 "project/radare2/shlr/grub/partmap/msdos.c"
     ...
     void *closure)
{
 ...
 for (;;) {
  ...
  if (mbr.signature != 
# 74 "project/radare2/shlr/grub/partmap/msdos.c" 3 4
                      ((grub_uint16_t) (0xaa55))
# 74 "project/radare2/shlr/grub/partmap/msdos.c"
                                                                    ) {
   fprintf (
# 75 "project/radare2/shlr/grub/partmap/msdos.c" 3 4
           __stderrp
# 75 "project/radare2/shlr/grub/partmap/msdos.c"
                 , "msdos: no signature\n");
  ...
  for (i = 0; i < 4; i++)
   if (mbr.entries[i].flag & 0x7f) {
    fprintf (
# 81 "project/radare2/shlr/grub/partmap/msdos.c" 3 4
            __stderrp
# 81 "project/radare2/shlr/grub/partmap/msdos.c"
                  , "msdos: bad boot flag\n");
  ...
  for (p.index = 0; p.index < 4; p.index++) {
   ...
   p.start = p.offset + 
# 89 "project/radare2/shlr/grub/partmap/msdos.c" 3 4
                       ((grub_uint32_t) (
# 89 "project/radare2/shlr/grub/partmap/msdos.c"
                       e->start
# 89 "project/radare2/shlr/grub/partmap/msdos.c" 3 4
                       ))
# 89 "project/radare2/shlr/grub/partmap/msdos.c"
                                                  ;
   p.len = 
# 90 "project/radare2/shlr/grub/partmap/msdos.c" 3 4
          ((grub_uint32_t) (
# 90 "project/radare2/shlr/grub/partmap/msdos.c"
          e->length
# 90 "project/radare2/shlr/grub/partmap/msdos.c" 3 4
          ))
# 90 "project/radare2/shlr/grub/partmap/msdos.c"
...
# 93 "project/radare2/shlr/grub/partmap/msdos.c" 3 4
  grub_real_dprintf("/tmp", 93, 
# 93 "project/radare2/shlr/grub/partmap/msdos.c"
  "partition"
# 93 "project/radare2/shlr/grub/partmap/msdos.c" 3 4
  , 
# 93 "project/radare2/shlr/grub/partmap/msdos.c"
  "partition %d: flag 0x%x, type 0x%x, start 0x%"
# 93 "project/radare2/shlr/grub/partmap/msdos.c" 3 4
  "llx"
# 93 "project/radare2/shlr/grub/partmap/msdos.c"
  ", len 0x%"
...
# 97 "project/radare2/shlr/grub/partmap/msdos.c"
                 ;


   if (e->type == 
# 100 "project/radare2/shlr/grub/partmap/msdos.c" 3 4
                 0xee 
# 100 "project/radare2/shlr/grub/partmap/msdos.c"
                                                 && p.index == 0)
     ...
     && ! grub_msdos_partition_is_extended (e->type))
   {
    ...
    if (hook (disk, &p, closure)) {
     fprintf (
# 110 "project/radare2/shlr/grub/partmap/msdos.c" 3 4
             __stderrp
# 110 "project/radare2/shlr/grub/partmap/msdos.c"
                   , "msdos: hook fail\n");
     return grub_errno;
    }
   } else if (p.number < 4)
  ...
  for (i = 0; i < 4; i++) {
   ...
   if (grub_msdos_partition_is_extended (e->type)) {
    p.offset = ext_offset + 
# 124 "project/radare2/shlr/grub/partmap/msdos.c" 3 4
                           ((grub_uint32_t) (
# 124 "project/radare2/shlr/grub/partmap/msdos.c"
                           e->start
# 124 "project/radare2/shlr/grub/partmap/msdos.c" 3 4
                           ))
# 124 "project/radare2/shlr/grub/partmap/msdos.c"
