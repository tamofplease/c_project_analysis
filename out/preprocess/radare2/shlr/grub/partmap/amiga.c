# 0 "project/radare2/shlr/grub/partmap/amiga.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 22 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/disk.h" 3 4
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 21 "project/radare2/shlr/grub/partmap/amiga.c" 2
...
void grub_halt (void);
# 22 "project/radare2/shlr/grub/partmap/amiga.c" 2
...
# 23 "project/radare2/shlr/grub/partmap/amiga.c" 2
...
# 24 "project/radare2/shlr/grub/partmap/amiga.c" 2


# 25 "project/radare2/shlr/grub/partmap/amiga.c"
struct grub_amiga_rdsk { grub_uint8_t magic[4]; grub_uint32_t size; grub_int32_t checksum; grub_uint32_t scsihost; grub_uint32_t blksz; grub_uint32_t flags; grub_uint32_t badblcklst; grub_uint32_t partitionlst; grub_uint32_t fslst; } 
# 25 "project/radare2/shlr/grub/partmap/amiga.c" 3 4
__attribute__((__packed__))
# 40 "project/radare2/shlr/grub/partmap/amiga.c"
  ;


# 42 "project/radare2/shlr/grub/partmap/amiga.c"
struct grub_amiga_partition { grub_uint8_t magic[4]; grub_int32_t size; grub_int32_t checksum; grub_uint32_t scsihost; grub_uint32_t next; grub_uint32_t flags; grub_uint32_t unused1[2]; grub_uint32_t devflags; grub_uint8_t namelen; grub_uint8_t name[31]; grub_uint32_t unused2[15]; grub_uint32_t unused3[3]; grub_uint32_t heads; grub_uint32_t unused4; grub_uint32_t block_per_track; grub_uint32_t unused5[3]; grub_uint32_t lowcyl; grub_uint32_t highcyl; grub_uint32_t firstcyl; } 
# 42 "project/radare2/shlr/grub/partmap/amiga.c" 3 4
__attribute__((__packed__))
# 67 "project/radare2/shlr/grub/partmap/amiga.c"
  ;


# 69 "project/radare2/shlr/grub/partmap/amiga.c"
        ...
        void *closure)
{
      ...
      if (grub_strcmp ((char *) rdsk.magic, "RDSK") == 0)
 {
   ...
   next = 
# 96 "project/radare2/shlr/grub/partmap/amiga.c" 3 4
         grub_swap_bytes32(
# 96 "project/radare2/shlr/grub/partmap/amiga.c"
         rdsk.partitionlst
# 96 "project/radare2/shlr/grub/partmap/amiga.c" 3 4
         )
# 96 "project/radare2/shlr/grub/partmap/amiga.c"
 ...
 return grub_errno;
      ...
      part.start = (
# 115 "project/radare2/shlr/grub/partmap/amiga.c" 3 4
                   grub_swap_bytes32(
# 115 "project/radare2/shlr/grub/partmap/amiga.c"
                   apart.lowcyl
# 115 "project/radare2/shlr/grub/partmap/amiga.c" 3 4
                   )
      
# 116 "project/radare2/shlr/grub/partmap/amiga.c"
     * 
# 116 "project/radare2/shlr/grub/partmap/amiga.c" 3 4
       grub_swap_bytes32(
# 116 "project/radare2/shlr/grub/partmap/amiga.c"
       apart.heads
# 116 "project/radare2/shlr/grub/partmap/amiga.c" 3 4
...
# 117 "project/radare2/shlr/grub/partmap/amiga.c"
     * 
# 117 "project/radare2/shlr/grub/partmap/amiga.c" 3 4
       grub_swap_bytes32(
# 117 "project/radare2/shlr/grub/partmap/amiga.c"
       apart.block_per_track
# 117 "project/radare2/shlr/grub/partmap/amiga.c" 3 4
       )
# 117 "project/radare2/shlr/grub/partmap/amiga.c"
                                               );
      part.len = ((
# 118 "project/radare2/shlr/grub/partmap/amiga.c" 3 4
                  grub_swap_bytes32(
# 118 "project/radare2/shlr/grub/partmap/amiga.c"
                  apart.highcyl
# 118 "project/radare2/shlr/grub/partmap/amiga.c" 3 4
                  )
     
# 119 "project/radare2/shlr/grub/partmap/amiga.c"
    - 
# 119 "project/radare2/shlr/grub/partmap/amiga.c" 3 4
      grub_swap_bytes32(
# 119 "project/radare2/shlr/grub/partmap/amiga.c"
      apart.lowcyl
# 119 "project/radare2/shlr/grub/partmap/amiga.c" 3 4
...
# 119 "project/radare2/shlr/grub/partmap/amiga.c"
                                      + 1)
    * 
# 120 "project/radare2/shlr/grub/partmap/amiga.c" 3 4
     grub_swap_bytes32(
# 120 "project/radare2/shlr/grub/partmap/amiga.c"
     apart.heads
# 120 "project/radare2/shlr/grub/partmap/amiga.c" 3 4
     )
    
# 121 "project/radare2/shlr/grub/partmap/amiga.c"
   * 
# 121 "project/radare2/shlr/grub/partmap/amiga.c" 3 4
     grub_swap_bytes32(
# 121 "project/radare2/shlr/grub/partmap/amiga.c"
     apart.block_per_track
# 121 "project/radare2/shlr/grub/partmap/amiga.c" 3 4
...
# 121 "project/radare2/shlr/grub/partmap/amiga.c"
 ...
 return grub_errno;
      ...
      next = 
# 131 "project/radare2/shlr/grub/partmap/amiga.c" 3 4
            grub_swap_bytes32(
# 131 "project/radare2/shlr/grub/partmap/amiga.c"
            apart.next
# 131 "project/radare2/shlr/grub/partmap/amiga.c" 3 4
            )
# 131 "project/radare2/shlr/grub/partmap/amiga.c"
