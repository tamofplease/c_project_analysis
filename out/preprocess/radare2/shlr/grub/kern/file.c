# 0 "project/radare2/shlr/grub/kern/file.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/grub/kern/file.c"
# 20 "project/radare2/shlr/grub/kern/file.c"
...
void grub_halt (void);
# 21 "project/radare2/shlr/grub/kern/file.c" 2

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/file.h" 1 3 4
# 24 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/file.h" 3 4
...
grub_ssize_t grub_file_pb_read (grub_file_t file, void *buf, grub_size_t len,
    int total);
# 23 "project/radare2/shlr/grub/kern/file.c" 2
...
# 24 "project/radare2/shlr/grub/kern/file.c" 2
...
# 27 "project/radare2/shlr/grub/kern/file.c" 2


# 28 "project/radare2/shlr/grub/kern/file.c"
                                     ;
;
;
;
...
# 58 "project/radare2/shlr/grub/kern/file.c" 3 4
     grub_memmove ((
# 58 "project/radare2/shlr/grub/kern/file.c"
     ret
# 58 "project/radare2/shlr/grub/kern/file.c" 3 4
     ), (
# 58 "project/radare2/shlr/grub/kern/file.c"
...
grub_file_pb_read (grub_file_t file, void *b, grub_size_t len, int total)
{
  ...
  if ((len < 
# 206 "project/radare2/shlr/grub/kern/file.c" 3 4
            (1 << 20)
# 206 "project/radare2/shlr/grub/kern/file.c"
                                 ) || (total == 0))
