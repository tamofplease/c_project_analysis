# 0 "project/radare2/shlr/grub/kern/err.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 21 "project/radare2/shlr/grub/kern/err.c" 2
...
void grub_halt (void);
# 22 "project/radare2/shlr/grub/kern/err.c" 2
...
# 25 "project/radare2/shlr/grub/kern/err.c" 2


# 26 "project/radare2/shlr/grub/kern/err.c"
                      ;
;
...
char grub_errmsg[256];

static struct
{
  grub_err_t no;
  char errmsg[256];
} grub_error_stack_items[10];
...
# 58 "project/radare2/shlr/grub/kern/err.c" 3 4
 __builtin_va_start(
# 58 "project/radare2/shlr/grub/kern/err.c"
 ap
# 58 "project/radare2/shlr/grub/kern/err.c" 3 4
 ,
# 58 "project/radare2/shlr/grub/kern/err.c"
...
# 58 "project/radare2/shlr/grub/kern/err.c"
                   ;
  grub_vsnprintf (grub_errmsg, sizeof (grub_errmsg), 
# 59 "project/radare2/shlr/grub/kern/err.c" 3 4
                                                    ((const char *) (
# 59 "project/radare2/shlr/grub/kern/err.c"
                                                    fmt
# 59 "project/radare2/shlr/grub/kern/err.c" 3 4
                                                    ))
# 59 "project/radare2/shlr/grub/kern/err.c"
...
# 60 "project/radare2/shlr/grub/kern/err.c" 3 4
 __builtin_va_end(
# 60 "project/radare2/shlr/grub/kern/err.c"
 ap
# 60 "project/radare2/shlr/grub/kern/err.c" 3 4
 )
# 60 "project/radare2/shlr/grub/kern/err.c"
...
# 70 "project/radare2/shlr/grub/kern/err.c" 3 4
 __builtin_va_start(
# 70 "project/radare2/shlr/grub/kern/err.c"
 ap
# 70 "project/radare2/shlr/grub/kern/err.c" 3 4
 ,
# 70 "project/radare2/shlr/grub/kern/err.c"
...
# 70 "project/radare2/shlr/grub/kern/err.c"
                   ;
  grub_vprintf (
# 71 "project/radare2/shlr/grub/kern/err.c" 3 4
               ((const char *) (
# 71 "project/radare2/shlr/grub/kern/err.c"
               fmt
# 71 "project/radare2/shlr/grub/kern/err.c" 3 4
               ))
# 71 "project/radare2/shlr/grub/kern/err.c"
...
# 72 "project/radare2/shlr/grub/kern/err.c" 3 4
 __builtin_va_end(
# 72 "project/radare2/shlr/grub/kern/err.c"
 ap
# 72 "project/radare2/shlr/grub/kern/err.c" 3 4
 )
# 72 "project/radare2/shlr/grub/kern/err.c"
...
grub_error_push (void)
{
  ...
  if (grub_error_stack_pos < 10)
    {

      grub_error_stack_items[grub_error_stack_pos].no = grub_errno;
      
# 85 "project/radare2/shlr/grub/kern/err.c" 3 4
     grub_memmove ((
# 85 "project/radare2/shlr/grub/kern/err.c"
...
# 87 "project/radare2/shlr/grub/kern/err.c"
                                       ;
...
# 113 "project/radare2/shlr/grub/kern/err.c" 3 4
     grub_memmove ((
# 113 "project/radare2/shlr/grub/kern/err.c"
     grub_errmsg
# 113 "project/radare2/shlr/grub/kern/err.c" 3 4
     ), (
# 113 "project/radare2/shlr/grub/kern/err.c"
...
# 115 "project/radare2/shlr/grub/kern/err.c"
                                       ;
  ...
  do
    {
      if (grub_errno != GRUB_ERR_NONE)
        grub_err_printf (
# 136 "project/radare2/shlr/grub/kern/err.c" 3 4
                        ((const char *) (
# 136 "project/radare2/shlr/grub/kern/err.c"
                        "error: %s.\n"
# 136 "project/radare2/shlr/grub/kern/err.c" 3 4
                        ))
# 136 "project/radare2/shlr/grub/kern/err.c"
