# 0 "project/radare2/shlr/grub/kern/partition.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/grub/kern/partition.c"
# 19 "project/radare2/shlr/grub/kern/partition.c"
...
void grub_halt (void);
# 20 "project/radare2/shlr/grub/kern/partition.c" 2
...
# 21 "project/radare2/shlr/grub/kern/partition.c" 2
...
# 22 "project/radare2/shlr/grub/kern/partition.c" 2
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 23 "project/radare2/shlr/grub/kern/partition.c" 2


# 24 "project/radare2/shlr/grub/kern/partition.c"
                                   ;
;
;
;
...
# 48 "project/radare2/shlr/grub/kern/partition.c" 3 4
     grub_memmove ((
# 48 "project/radare2/shlr/grub/kern/partition.c"
     c->p
# 48 "project/radare2/shlr/grub/kern/partition.c" 3 4
     ), (
# 48 "project/radare2/shlr/grub/kern/partition.c"
...
# 98 "project/radare2/shlr/grub/kern/partition.c" 3 4
     for (
# 98 "project/radare2/shlr/grub/kern/partition.c"
     partmap 
# 98 "project/radare2/shlr/grub/kern/partition.c" 3 4
...
# 99 "project/radare2/shlr/grub/kern/partition.c"
     {
...
# 166 "project/radare2/shlr/grub/kern/partition.c" 3 4
     for (
# 166 "project/radare2/shlr/grub/kern/partition.c"
     partmap 
# 166 "project/radare2/shlr/grub/kern/partition.c" 3 4
     = grub_partition_map_list; 
# 166 "project/radare2/shlr/grub/kern/partition.c"
...
# 167 "project/radare2/shlr/grub/kern/partition.c"
{
   grub_err_t err;
...
# 193 "project/radare2/shlr/grub/kern/partition.c" 3 4
 for (
# 193 "project/radare2/shlr/grub/kern/partition.c"
 partmap 
# 193 "project/radare2/shlr/grub/kern/partition.c" 3 4
 = grub_partition_map_list; 
# 193 "project/radare2/shlr/grub/kern/partition.c"
...
# 194 "project/radare2/shlr/grub/kern/partition.c"
   {
      grub_err_t err;
...
# 228 "project/radare2/shlr/grub/kern/partition.c" 3 4
  grub_memmove ((
# 228 "project/radare2/shlr/grub/kern/partition.c"
  out + strl + 1
# 228 "project/radare2/shlr/grub/kern/partition.c" 3 4
  ), (
# 228 "project/radare2/shlr/grub/kern/partition.c"
...
# 230 "project/radare2/shlr/grub/kern/partition.c" 3 4
  grub_memmove ((
# 230 "project/radare2/shlr/grub/kern/partition.c"
  out
# 230 "project/radare2/shlr/grub/kern/partition.c" 3 4
  ), (
# 230 "project/radare2/shlr/grub/kern/partition.c"
...
# 230 "project/radare2/shlr/grub/kern/partition.c"
      ...
      else
 {
  if (out){
    grub_free(out);
    out = 
# 238 "project/radare2/shlr/grub/kern/partition.c" 3 4
         ((void *)0)
# 238 "project/radare2/shlr/grub/kern/partition.c"
             ;
  }
   curlen = strl;
   out = grub_strdup (buf);
