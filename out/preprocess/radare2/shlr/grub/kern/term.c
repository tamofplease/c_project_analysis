# 0 "project/radare2/shlr/grub/kern/term.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 23 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/list.h" 3 4
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/symbol.h" 1 3 4
# 24 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/list.h" 2 3 4
...
# 25 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/list.h" 2 3 4
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/misc.h" 1 3 4
# 26 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/misc.h" 3 4
...
# 20 "project/radare2/shlr/grub/kern/term.c" 2
...
# 22 "project/radare2/shlr/grub/kern/term.c" 2
...
# 24 "project/radare2/shlr/grub/kern/term.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/time.h" 1 3 4
# 24 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/time.h" 3 4
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/cpu/time.h" 1 3 4
# 22 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/cpu/time.h" 3 4
...
# 25 "project/radare2/shlr/grub/kern/term.c" 2


# 26 "project/radare2/shlr/grub/kern/term.c"
                            ;
;
;
;
...
void (*grub_newline_hook) (void) = 
# 46 "project/radare2/shlr/grub/kern/term.c" 3 4
                                  ((void *)0)
# 46 "project/radare2/shlr/grub/kern/term.c"
                                      ;
...
# 86 "project/radare2/shlr/grub/kern/term.c" 3 4
     for (
# 86 "project/radare2/shlr/grub/kern/term.c"
     term 
# 86 "project/radare2/shlr/grub/kern/term.c" 3 4
     = grub_term_outputs; 
# 86 "project/radare2/shlr/grub/kern/term.c"
...
# 87 "project/radare2/shlr/grub/kern/term.c"
...
# 102 "project/radare2/shlr/grub/kern/term.c" 3 4
     for (
# 102 "project/radare2/shlr/grub/kern/term.c"
     term 
# 102 "project/radare2/shlr/grub/kern/term.c" 3 4
     = grub_term_inputs; 
# 102 "project/radare2/shlr/grub/kern/term.c"
...
# 103 "project/radare2/shlr/grub/kern/term.c"
     {
...
# 118 "project/radare2/shlr/grub/kern/term.c" 3 4
 for (
# 118 "project/radare2/shlr/grub/kern/term.c"
 term 
# 118 "project/radare2/shlr/grub/kern/term.c" 3 4
 = grub_term_inputs; 
# 118 "project/radare2/shlr/grub/kern/term.c"
...
# 119 "project/radare2/shlr/grub/kern/term.c"
 {
    int key = term->checkkey ();
    if (key != -1)
      return key;
...
# 134 "project/radare2/shlr/grub/kern/term.c" 3 4
 for (
# 134 "project/radare2/shlr/grub/kern/term.c"
 term 
# 134 "project/radare2/shlr/grub/kern/term.c" 3 4
 = grub_term_inputs; 
# 134 "project/radare2/shlr/grub/kern/term.c"
...
# 135 "project/radare2/shlr/grub/kern/term.c"
 {
...
# 148 "project/radare2/shlr/grub/kern/term.c" 3 4
 for (
# 148 "project/radare2/shlr/grub/kern/term.c"
 term 
# 148 "project/radare2/shlr/grub/kern/term.c" 3 4
 = grub_term_outputs; 
# 148 "project/radare2/shlr/grub/kern/term.c"
...
# 149 "project/radare2/shlr/grub/kern/term.c"
 {
    if ((term->flags & 
# 150 "project/radare2/shlr/grub/kern/term.c" 3 4
                      (1 << 2)
# 150 "project/radare2/shlr/grub/kern/term.c"
                                    ) || (grub_env_get ("debug")))
      {
 grub_putcode ('\n', term);
 grub_term_refresh (term);
...
# 165 "project/radare2/shlr/grub/kern/term.c" 3 4
 for (
# 165 "project/radare2/shlr/grub/kern/term.c"
 term 
# 165 "project/radare2/shlr/grub/kern/term.c" 3 4
 = grub_term_outputs; 
# 165 "project/radare2/shlr/grub/kern/term.c"
...
# 166 "project/radare2/shlr/grub/kern/term.c"
...
# 174 "project/radare2/shlr/grub/kern/term.c" 3 4
 for (
# 174 "project/radare2/shlr/grub/kern/term.c"
 term 
# 174 "project/radare2/shlr/grub/kern/term.c" 3 4
 = grub_term_outputs; 
# 174 "project/radare2/shlr/grub/kern/term.c"
...
# 175 "project/radare2/shlr/grub/kern/term.c"
   grub_term_refresh (term);
}
