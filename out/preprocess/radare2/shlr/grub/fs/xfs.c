# 0 "project/radare2/shlr/grub/fs/xfs.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/grub/fs/xfs.c"
# 20 "project/radare2/shlr/grub/fs/xfs.c"
...
# 21 "project/radare2/shlr/grub/fs/xfs.c" 2
...
grub_ssize_t grub_file_pb_read (grub_file_t file, void *buf, grub_size_t len,
    int total);
# 22 "project/radare2/shlr/grub/fs/xfs.c" 2
...
# 23 "project/radare2/shlr/grub/fs/xfs.c" 2
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 25 "project/radare2/shlr/grub/fs/xfs.c" 2
...
unsigned int grub_fshelp_log2blksize (unsigned int blksize,
          unsigned int *pow);
# 27 "project/radare2/shlr/grub/fs/xfs.c" 2
# 35 "project/radare2/shlr/grub/fs/xfs.c"

# 35 "project/radare2/shlr/grub/fs/xfs.c"
struct grub_xfs_sblock { grub_uint8_t magic[4]; grub_uint32_t bsize; grub_uint8_t unused1[24]; grub_uint16_t uuid[8]; grub_uint8_t unused2[8]; grub_uint64_t rootino; grub_uint8_t unused3[20]; grub_uint32_t agsize; grub_uint8_t unused4[20]; grub_uint8_t label[12]; grub_uint8_t log2_bsize; grub_uint8_t log2_sect; grub_uint8_t log2_inode; grub_uint8_t log2_inop; grub_uint8_t log2_agblk; grub_uint8_t unused6[67]; grub_uint8_t log2_dirblk; } 
# 35 "project/radare2/shlr/grub/fs/xfs.c" 3 4
__attribute__((__packed__))
# 55 "project/radare2/shlr/grub/fs/xfs.c"
   ;


# 57 "project/radare2/shlr/grub/fs/xfs.c"
struct grub_xfs_dir_header { grub_uint8_t count; grub_uint8_t smallino; union { grub_uint32_t i4; grub_uint64_t i8; } 
# 57 "project/radare2/shlr/grub/fs/xfs.c" 3 4
__attribute__((__packed__)) 
# 57 "project/radare2/shlr/grub/fs/xfs.c"
parent; } 
# 57 "project/radare2/shlr/grub/fs/xfs.c" 3 4
__attribute__((__packed__))
# 68 "project/radare2/shlr/grub/fs/xfs.c"
  ;


# 70 "project/radare2/shlr/grub/fs/xfs.c"
struct grub_xfs_dir_entry { grub_uint8_t len; grub_uint16_t offset; char name[1]; } 
# 70 "project/radare2/shlr/grub/fs/xfs.c" 3 4
__attribute__((__packed__))
...
# 77 "project/radare2/shlr/grub/fs/xfs.c"
 ;

struct grub_xfs_dir2_entry { grub_uint64_t inode; grub_uint8_t len; } 
# 79 "project/radare2/shlr/grub/fs/xfs.c" 3 4
__attribute__((__packed__))
...
# 84 "project/radare2/shlr/grub/fs/xfs.c"
 ;

typedef grub_unaligned_uint32_t grub_xfs_extent[4];

struct grub_xfs_btree_node { grub_uint8_t magic[4]; grub_uint16_t level; grub_uint16_t numrecs; grub_uint64_t left; grub_uint64_t right; grub_uint64_t keys[1]; } 
# 88 "project/radare2/shlr/grub/fs/xfs.c" 3 4
__attribute__((__packed__))
# 97 "project/radare2/shlr/grub/fs/xfs.c"
  ;


# 99 "project/radare2/shlr/grub/fs/xfs.c"
struct grub_xfs_btree_root { grub_uint16_t level; grub_uint16_t numrecs; grub_unaligned_uint64_t keys[1]; } 
# 99 "project/radare2/shlr/grub/fs/xfs.c" 3 4
__attribute__((__packed__))
...
# 105 "project/radare2/shlr/grub/fs/xfs.c"
 ;

struct grub_xfs_inode { grub_uint8_t magic[2]; grub_uint16_t mode; grub_uint8_t version; grub_uint8_t format; grub_uint8_t unused2[50]; grub_uint64_t size; grub_uint64_t nblocks; grub_uint32_t extsize; grub_uint32_t nextents; grub_uint8_t unused3[20]; union { char raw[156]; struct dir { struct grub_xfs_dir_header dirhead; struct grub_xfs_dir_entry direntry[1]; } dir; grub_xfs_extent extents[9]; struct grub_xfs_btree_root btree; } 
# 107 "project/radare2/shlr/grub/fs/xfs.c" 3 4
__attribute__((__packed__)) 
# 107 "project/radare2/shlr/grub/fs/xfs.c"
data; } 
# 107 "project/radare2/shlr/grub/fs/xfs.c" 3 4
__attribute__((__packed__))
# 132 "project/radare2/shlr/grub/fs/xfs.c"
  ;


# 134 "project/radare2/shlr/grub/fs/xfs.c"
struct grub_xfs_dirblock_tail { grub_uint32_t leaf_count; grub_uint32_t leaf_stale; } 
# 134 "project/radare2/shlr/grub/fs/xfs.c" 3 4
__attribute__((__packed__))
...
# 139 "project/radare2/shlr/grub/fs/xfs.c"
 ;
...
# 193 "project/radare2/shlr/grub/fs/xfs.c"
static inline grub_uint64_t
grub_xfs_inode_block (struct grub_xfs_data *data,
        grub_uint64_t ino)
{
  long long int inoinag = (
# 197 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                         grub_swap_bytes64(
# 197 "project/radare2/shlr/grub/fs/xfs.c"
                         ino
# 197 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                         ) 
# 197 "project/radare2/shlr/grub/fs/xfs.c"
                         & ((1LL << ((data)->sblock.log2_agblk + (data)->sblock.log2_inop)) - 1));
  long long ag = (
# 198 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                grub_swap_bytes64(
# 198 "project/radare2/shlr/grub/fs/xfs.c"
                ino
# 198 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                ) 
# 198 "project/radare2/shlr/grub/fs/xfs.c"
  ...
  block <<= (data->sblock.log2_bsize - 
# 202 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                                      9
# 202 "project/radare2/shlr/grub/fs/xfs.c"
                                                           );
  return block;
}
...
{
  int inoag = (
# 211 "project/radare2/shlr/grub/fs/xfs.c" 3 4
             grub_swap_bytes64(
# 211 "project/radare2/shlr/grub/fs/xfs.c"
             ino
# 211 "project/radare2/shlr/grub/fs/xfs.c" 3 4
             ) 
# 211 "project/radare2/shlr/grub/fs/xfs.c"
  ...
  if (node->inode.format == 3)
    {
      ...
      nrec = 
# 252 "project/radare2/shlr/grub/fs/xfs.c" 3 4
            ({ grub_uint16_t _x = (
# 252 "project/radare2/shlr/grub/fs/xfs.c"
            node->inode.data.btree.numrecs
# 252 "project/radare2/shlr/grub/fs/xfs.c" 3 4
      ...
      do
        {
          ...
          for (i = 0; i < nrec; i++)
            {
              if (fileblock < 
# 260 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                             grub_swap_bytes64(
# 260 "project/radare2/shlr/grub/fs/xfs.c"
                             keys[i]
# 260 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                             )
# 260 "project/radare2/shlr/grub/fs/xfs.c"
...
# 272 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                             grub_swap_bytes64(
# 272 "project/radare2/shlr/grub/fs/xfs.c"
                             keys[i - 1 + nrec]
# 272 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                             )
                              
# 273 "project/radare2/shlr/grub/fs/xfs.c"
                             << (node->data->sblock.log2_bsize
                                  - 
# 274 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                                   9
# 274 "project/radare2/shlr/grub/fs/xfs.c"
                                                        ),
          ...
          nrec = 
# 285 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                ({ grub_uint16_t _x = (
# 285 "project/radare2/shlr/grub/fs/xfs.c"
                leaf->numrecs
# 285 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 285 "project/radare2/shlr/grub/fs/xfs.c"
  ...
  else if (node->inode.format == 2)
    {
      nrec = 
# 292 "project/radare2/shlr/grub/fs/xfs.c" 3 4
            grub_swap_bytes32(
# 292 "project/radare2/shlr/grub/fs/xfs.c"
            node->inode.nextents
# 292 "project/radare2/shlr/grub/fs/xfs.c" 3 4
            )
# 292 "project/radare2/shlr/grub/fs/xfs.c"
...
# 307 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                           grub_swap_bytes32(
# 307 "project/radare2/shlr/grub/fs/xfs.c"
                           exts[ex][1]
# 307 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                           ) 
# 307 "project/radare2/shlr/grub/fs/xfs.c"
                           & (0x1ff)) << 43 | (grub_uint64_t) 
# 307 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                           grub_swap_bytes32(
# 307 "project/radare2/shlr/grub/fs/xfs.c"
                           exts[ex][2]
...
# 308 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                            grub_swap_bytes32(
# 308 "project/radare2/shlr/grub/fs/xfs.c"
                            exts[ex][0]
# 308 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                            ) 
# 308 "project/radare2/shlr/grub/fs/xfs.c"
...
# 308 "project/radare2/shlr/grub/fs/xfs.c"
                            >> 9);
      grub_uint64_t size = (
# 309 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                          grub_swap_bytes32(
# 309 "project/radare2/shlr/grub/fs/xfs.c"
                          exts[ex][3]
# 309 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                          ) 
# 309 "project/radare2/shlr/grub/fs/xfs.c"
  ...
  return (((ret) >> (node->data)->sblock.log2_agblk) * (node->data)->agsize + ((ret) & ((1LL << (node->data)->sblock.log2_agblk) - 1)));
}
...
# 340 "project/radare2/shlr/grub/fs/xfs.c" 3 4
   grub_swap_bytes64(
# 340 "project/radare2/shlr/grub/fs/xfs.c"
   node->inode.size
# 340 "project/radare2/shlr/grub/fs/xfs.c" 3 4
   )
# 340 "project/radare2/shlr/grub/fs/xfs.c"
    ...
    node->data->sblock.log2_bsize
    - 
# 342 "project/radare2/shlr/grub/fs/xfs.c" 3 4
     9
# 342 "project/radare2/shlr/grub/fs/xfs.c"
                          );
}
...
{
  int size = 
# 349 "project/radare2/shlr/grub/fs/xfs.c" 3 4
            grub_swap_bytes64(
# 349 "project/radare2/shlr/grub/fs/xfs.c"
            node->inode.size
# 349 "project/radare2/shlr/grub/fs/xfs.c" 3 4
            )
# 349 "project/radare2/shlr/grub/fs/xfs.c"
...
{
  if ((
# 383 "project/radare2/shlr/grub/fs/xfs.c" 3 4
      ({ grub_uint16_t _x = (
# 383 "project/radare2/shlr/grub/fs/xfs.c"
      mode
# 383 "project/radare2/shlr/grub/fs/xfs.c" 3 4
      ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
       
# 384 "project/radare2/shlr/grub/fs/xfs.c"
      & 0170000) == 0040000)
    return GRUB_FSHELP_DIR;
  else if ((
# 386 "project/radare2/shlr/grub/fs/xfs.c" 3 4
           ({ grub_uint16_t _x = (
# 386 "project/radare2/shlr/grub/fs/xfs.c"
           mode
# 386 "project/radare2/shlr/grub/fs/xfs.c" 3 4
           ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
     
# 387 "project/radare2/shlr/grub/fs/xfs.c"
    & 0170000) == 0120000)
    return GRUB_FSHELP_SYMLINK;
  else if ((
# 389 "project/radare2/shlr/grub/fs/xfs.c" 3 4
           ({ grub_uint16_t _x = (
# 389 "project/radare2/shlr/grub/fs/xfs.c"
           mode
# 389 "project/radare2/shlr/grub/fs/xfs.c" 3 4
           ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
     
# 390 "project/radare2/shlr/grub/fs/xfs.c"
    & 0170000) == 0100000)
        ...
        void *closure)
{
 ...
 if (smallino)
   {
     parent = 
# 458 "project/radare2/shlr/grub/fs/xfs.c" 3 4
             grub_swap_bytes32(
# 458 "project/radare2/shlr/grub/fs/xfs.c"
             diro->inode.data.dir.dirhead.parent.i4
# 458 "project/radare2/shlr/grub/fs/xfs.c" 3 4
             )
# 458 "project/radare2/shlr/grub/fs/xfs.c"
                                                                      ;
     parent = 
# 459 "project/radare2/shlr/grub/fs/xfs.c" 3 4
             grub_swap_bytes64(
# 459 "project/radare2/shlr/grub/fs/xfs.c"
             parent
# 459 "project/radare2/shlr/grub/fs/xfs.c" 3 4
             )
# 459 "project/radare2/shlr/grub/fs/xfs.c"
 ...
 for (i = 0; i < diro->inode.data.dir.dirhead.count; i++)
  ...
  char name[de->len + 1];
     ...
     if (smallino)
       {
  ino = 
# 488 "project/radare2/shlr/grub/fs/xfs.c" 3 4
       grub_swap_bytes32(
# 488 "project/radare2/shlr/grub/fs/xfs.c"
       *(grub_uint32_t *) inopos
# 488 "project/radare2/shlr/grub/fs/xfs.c" 3 4
       )
# 488 "project/radare2/shlr/grub/fs/xfs.c"
                                                   ;
  ino = 
# 489 "project/radare2/shlr/grub/fs/xfs.c" 3 4
       grub_swap_bytes64(
# 489 "project/radare2/shlr/grub/fs/xfs.c"
       ino
# 489 "project/radare2/shlr/grub/fs/xfs.c" 3 4
       )
# 489 "project/radare2/shlr/grub/fs/xfs.c"
...
# 494 "project/radare2/shlr/grub/fs/xfs.c" 3 4
    grub_memmove ((
# 494 "project/radare2/shlr/grub/fs/xfs.c"
    name
# 494 "project/radare2/shlr/grub/fs/xfs.c" 3 4
    ), (
# 494 "project/radare2/shlr/grub/fs/xfs.c"
...
# 494 "project/radare2/shlr/grub/fs/xfs.c"
 ...
 for (blk = 0;
      blk < (
# 525 "project/radare2/shlr/grub/fs/xfs.c" 3 4
            grub_swap_bytes64(
# 525 "project/radare2/shlr/grub/fs/xfs.c"
            dir->inode.size
# 525 "project/radare2/shlr/grub/fs/xfs.c" 3 4
            )
      
# 526 "project/radare2/shlr/grub/fs/xfs.c"
     >> dirblk_log2);
      blk++)
   {
     ...
     entries = (
# 545 "project/radare2/shlr/grub/fs/xfs.c" 3 4
               grub_swap_bytes32(
# 545 "project/radare2/shlr/grub/fs/xfs.c"
               tail->leaf_count
# 545 "project/radare2/shlr/grub/fs/xfs.c" 3 4
               )
         
# 546 "project/radare2/shlr/grub/fs/xfs.c"
        - 
# 546 "project/radare2/shlr/grub/fs/xfs.c" 3 4
          grub_swap_bytes32(
# 546 "project/radare2/shlr/grub/fs/xfs.c"
          tail->leaf_stale
# 546 "project/radare2/shlr/grub/fs/xfs.c" 3 4
  ...
  if (*freetag == 0XFFFF)
    {
      ...
      pos += 
# 564 "project/radare2/shlr/grub/fs/xfs.c" 3 4
            ({ grub_uint16_t _x = (
# 564 "project/radare2/shlr/grub/fs/xfs.c"
            *skip
# 564 "project/radare2/shlr/grub/fs/xfs.c" 3 4
            ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 564 "project/radare2/shlr/grub/fs/xfs.c"
  ...
  pos = (pos) + ((((8 + 1 + direntry->len + 2) + 8 - 1) / 8) * 8);
  pos = ((((pos) + 8 - 1) / 8) * 8);
       }
   }
 grub_free (dirblock);
...
grub_xfs_mount (grub_disk_t disk)
{
  ...
  data->bsize = 
# 635 "project/radare2/shlr/grub/fs/xfs.c" 3 4
               grub_swap_bytes32(
# 635 "project/radare2/shlr/grub/fs/xfs.c"
               data->sblock.bsize
# 635 "project/radare2/shlr/grub/fs/xfs.c" 3 4
               )
# 635 "project/radare2/shlr/grub/fs/xfs.c"
                                                    ;
  data->agsize = 
# 636 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                grub_swap_bytes32(
# 636 "project/radare2/shlr/grub/fs/xfs.c"
                data->sblock.agsize
# 636 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                )
# 636 "project/radare2/shlr/grub/fs/xfs.c"
  ...
  void *closure)
{
  ...
  info.dir = ((filetype & 
# 671 "project/radare2/shlr/grub/fs/xfs.c" 3 4
                         0xff
# 671 "project/radare2/shlr/grub/fs/xfs.c"
                                              ) == GRUB_FSHELP_DIR);
  grub_free (node);
...
# 735 "project/radare2/shlr/grub/fs/xfs.c" 3 4
   grub_memmove ((
# 735 "project/radare2/shlr/grub/fs/xfs.c"
   &data->diropen
# 735 "project/radare2/shlr/grub/fs/xfs.c" 3 4
   ), (
# 735 "project/radare2/shlr/grub/fs/xfs.c"
...
# 735 "project/radare2/shlr/grub/fs/xfs.c"
   sizeof (struct grub_fshelp_node) - sizeof (struct grub_xfs_inode) + (1 << data->sblock.log2_inode)
# 735 "project/radare2/shlr/grub/fs/xfs.c" 3 4
   ))


                                    
# 738 "project/radare2/shlr/grub/fs/xfs.c"
                                   ;

  file->size = 
# 740 "project/radare2/shlr/grub/fs/xfs.c" 3 4
              grub_swap_bytes64(
# 740 "project/radare2/shlr/grub/fs/xfs.c"
              data->diropen.inode.size
# 740 "project/radare2/shlr/grub/fs/xfs.c" 3 4
              )
# 740 "project/radare2/shlr/grub/fs/xfs.c"
                                                         ;
...
# 803 "project/radare2/shlr/grub/fs/xfs.c" 3 4
       ({ grub_uint16_t _x = (
# 803 "project/radare2/shlr/grub/fs/xfs.c"
       data->sblock.uuid[0]
# 803 "project/radare2/shlr/grub/fs/xfs.c" 3 4
       ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 803 "project/radare2/shlr/grub/fs/xfs.c"
...
# 804 "project/radare2/shlr/grub/fs/xfs.c" 3 4
       ({ grub_uint16_t _x = (
# 804 "project/radare2/shlr/grub/fs/xfs.c"
       data->sblock.uuid[1]
# 804 "project/radare2/shlr/grub/fs/xfs.c" 3 4
       ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 804 "project/radare2/shlr/grub/fs/xfs.c"
...
# 805 "project/radare2/shlr/grub/fs/xfs.c" 3 4
       ({ grub_uint16_t _x = (
# 805 "project/radare2/shlr/grub/fs/xfs.c"
       data->sblock.uuid[2]
# 805 "project/radare2/shlr/grub/fs/xfs.c" 3 4
       ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 805 "project/radare2/shlr/grub/fs/xfs.c"
...
# 806 "project/radare2/shlr/grub/fs/xfs.c" 3 4
       ({ grub_uint16_t _x = (
# 806 "project/radare2/shlr/grub/fs/xfs.c"
       data->sblock.uuid[3]
# 806 "project/radare2/shlr/grub/fs/xfs.c" 3 4
       ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 806 "project/radare2/shlr/grub/fs/xfs.c"
...
# 807 "project/radare2/shlr/grub/fs/xfs.c" 3 4
       ({ grub_uint16_t _x = (
# 807 "project/radare2/shlr/grub/fs/xfs.c"
       data->sblock.uuid[4]
# 807 "project/radare2/shlr/grub/fs/xfs.c" 3 4
       ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 807 "project/radare2/shlr/grub/fs/xfs.c"
...
# 808 "project/radare2/shlr/grub/fs/xfs.c" 3 4
       ({ grub_uint16_t _x = (
# 808 "project/radare2/shlr/grub/fs/xfs.c"
       data->sblock.uuid[5]
# 808 "project/radare2/shlr/grub/fs/xfs.c" 3 4
       ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 808 "project/radare2/shlr/grub/fs/xfs.c"
...
# 809 "project/radare2/shlr/grub/fs/xfs.c" 3 4
       ({ grub_uint16_t _x = (
# 809 "project/radare2/shlr/grub/fs/xfs.c"
       data->sblock.uuid[6]
# 809 "project/radare2/shlr/grub/fs/xfs.c" 3 4
       ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 809 "project/radare2/shlr/grub/fs/xfs.c"
...
# 810 "project/radare2/shlr/grub/fs/xfs.c" 3 4
       ({ grub_uint16_t _x = (
# 810 "project/radare2/shlr/grub/fs/xfs.c"
       data->sblock.uuid[7]
# 810 "project/radare2/shlr/grub/fs/xfs.c" 3 4
       ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 810 "project/radare2/shlr/grub/fs/xfs.c"
    ...
    *uuid = 
# 813 "project/radare2/shlr/grub/fs/xfs.c" 3 4
           ((void *)0)
# 813 "project/radare2/shlr/grub/fs/xfs.c"
               ;
