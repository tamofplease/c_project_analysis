# 0 "project/radare2/shlr/grub/fs/befs.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/grub/fs/befs.c"
...
fail:
  grub_error (GRUB_ERR_BAD_FS, "not an " "befs" "" " filesystem");
...
# 4 "project/radare2/shlr/grub/fs/befs.c" 2
