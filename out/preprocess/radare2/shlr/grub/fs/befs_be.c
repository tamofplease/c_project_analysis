# 0 "project/radare2/shlr/grub/fs/befs_be.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/grub/fs/befs_be.c"



# 1 "project/radare2/shlr/grub/fs/afs.c" 1
# 20 "project/radare2/shlr/grub/fs/afs.c"
...
# 21 "project/radare2/shlr/grub/fs/afs.c" 2
...
grub_ssize_t grub_file_pb_read (grub_file_t file, void *buf, grub_size_t len,
    int total);
# 22 "project/radare2/shlr/grub/fs/afs.c" 2
...
# 23 "project/radare2/shlr/grub/fs/afs.c" 2
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 25 "project/radare2/shlr/grub/fs/afs.c" 2
...
unsigned int grub_fshelp_log2blksize (unsigned int blksize,
          unsigned int *pow);
# 27 "project/radare2/shlr/grub/fs/afs.c" 2
# 99 "project/radare2/shlr/grub/fs/afs.c"
...
{
  struct grub_afs_blockrun direct[12];
...
# 160 "project/radare2/shlr/grub/fs/afs.c"
...
{
  return ((grub_afs_off_t) 
# 231 "project/radare2/shlr/grub/fs/afs.c" 3 4
                          grub_swap_bytes32(
# 231 "project/radare2/shlr/grub/fs/afs.c"
                          run->group
# 231 "project/radare2/shlr/grub/fs/afs.c" 3 4
                          )
   
# 232 "project/radare2/shlr/grub/fs/afs.c"
  * sb->block_per_group + 
# 232 "project/radare2/shlr/grub/fs/afs.c" 3 4
                          ({ grub_uint16_t _x = (
# 232 "project/radare2/shlr/grub/fs/afs.c"
                          run->start
# 232 "project/radare2/shlr/grub/fs/afs.c" 3 4
...
# 241 "project/radare2/shlr/grub/fs/afs.c" 3 4
                                                    9
# 241 "project/radare2/shlr/grub/fs/afs.c"
                                                                         ),
...
grub_afs_read_block (grub_fshelp_node_t node, grub_disk_addr_t fileblock)
{
  ...
  if (fileblock < 
# 252 "project/radare2/shlr/grub/fs/afs.c" 3 4
                 grub_swap_bytes64(
# 252 "project/radare2/shlr/grub/fs/afs.c"
                 ds->max_direct_range
# 252 "project/radare2/shlr/grub/fs/afs.c" 3 4
                 )
# 252 "project/radare2/shlr/grub/fs/afs.c"
                                                         )
    {
      ...
      for (i = 0; i < 12; i++)
        {
          if (fileblock < 
# 258 "project/radare2/shlr/grub/fs/afs.c" 3 4
                         ({ grub_uint16_t _x = (
# 258 "project/radare2/shlr/grub/fs/afs.c"
                         ds->direct[i].len
# 258 "project/radare2/shlr/grub/fs/afs.c" 3 4
                         ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 258 "project/radare2/shlr/grub/fs/afs.c"
          ...
          fileblock -= 
# 260 "project/radare2/shlr/grub/fs/afs.c" 3 4
                      ({ grub_uint16_t _x = (
# 260 "project/radare2/shlr/grub/fs/afs.c"
                      ds->direct[i].len
# 260 "project/radare2/shlr/grub/fs/afs.c" 3 4
                      ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 260 "project/radare2/shlr/grub/fs/afs.c"
...
# 263 "project/radare2/shlr/grub/fs/afs.c" 3 4
                      grub_swap_bytes64(
# 263 "project/radare2/shlr/grub/fs/afs.c"
...
# 263 "project/radare2/shlr/grub/fs/afs.c"
                                                                )
    {
      ...
      fileblock -= 
# 270 "project/radare2/shlr/grub/fs/afs.c" 3 4
                  grub_swap_bytes64(
# 270 "project/radare2/shlr/grub/fs/afs.c"
                  ds->max_direct_range
# 270 "project/radare2/shlr/grub/fs/afs.c" 3 4
                  )
# 270 "project/radare2/shlr/grub/fs/afs.c"
      ...
      for (i = 0; i < ds->indirect.len; i++, blk++)
        {
          ...
          if (grub_disk_read (node->data->disk,
                              blk * (sb->block_size >> 
# 276 "project/radare2/shlr/grub/fs/afs.c" 3 4
                                                      9
# 276 "project/radare2/shlr/grub/fs/afs.c"
                                                                           ),
                              0, sizeof (indir),
                              indir))
            return 0;
          ...
          for (j = 0; j < ptrs_per_blk; j++)
            {
              if (fileblock < 
# 283 "project/radare2/shlr/grub/fs/afs.c" 3 4
                             ({ grub_uint16_t _x = (
# 283 "project/radare2/shlr/grub/fs/afs.c"
                             indir[j].len
# 283 "project/radare2/shlr/grub/fs/afs.c" 3 4
                             ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 283 "project/radare2/shlr/grub/fs/afs.c"
              ...
              fileblock -= 
# 286 "project/radare2/shlr/grub/fs/afs.c" 3 4
                          ({ grub_uint16_t _x = (
# 286 "project/radare2/shlr/grub/fs/afs.c"
                          indir[j].len
# 286 "project/radare2/shlr/grub/fs/afs.c" 3 4
                          ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 286 "project/radare2/shlr/grub/fs/afs.c"
  ...
  else
    {
      ...
      int cur_pos = fileblock - 
# 296 "project/radare2/shlr/grub/fs/afs.c" 3 4
                               grub_swap_bytes64(
# 296 "project/radare2/shlr/grub/fs/afs.c"
                               ds->max_indirect_range
# 296 "project/radare2/shlr/grub/fs/afs.c" 3 4
                               )
# 296 "project/radare2/shlr/grub/fs/afs.c"
      ...
      if (grub_disk_read (node->data->disk,
                          (grub_afs_run_to_num (sb, &ds->double_indirect)
                           + idblk) *
                          (sb->block_size >> 
# 312 "project/radare2/shlr/grub/fs/afs.c" 3 4
                                            9
# 312 "project/radare2/shlr/grub/fs/afs.c"
                                                                 ),
                          0, sizeof (indir),
                          indir))
        return 0;
      ...
      if (grub_disk_read (node->data->disk,
                          ...
                          (sb->block_size >> 
# 319 "project/radare2/shlr/grub/fs/afs.c" 3 4
                                            9
# 319 "project/radare2/shlr/grub/fs/afs.c"
                                                                 ),
                          0, sizeof (indir),
                          indir))
        return 0;
...
# 340 "project/radare2/shlr/grub/fs/afs.c" 3 4
                               grub_swap_bytes64(
# 340 "project/radare2/shlr/grub/fs/afs.c"
...
# 340 "project/radare2/shlr/grub/fs/afs.c"
    ...
    node->data->sblock.block_shift
                                - 
# 342 "project/radare2/shlr/grub/fs/afs.c" 3 4
                                 9
# 342 "project/radare2/shlr/grub/fs/afs.c"
                                                      );
}
...
grub_afs_read_symlink (grub_fshelp_node_t node)
{
  char *ret;
  grub_afs_off_t size = 
# 349 "project/radare2/shlr/grub/fs/afs.c" 3 4
                       grub_swap_bytes64(
# 349 "project/radare2/shlr/grub/fs/afs.c"
                       node->inode.stream.size
# 349 "project/radare2/shlr/grub/fs/afs.c" 3 4
                       )
# 349 "project/radare2/shlr/grub/fs/afs.c"
...
# 357 "project/radare2/shlr/grub/fs/afs.c" 3 4
     grub_memmove ((
# 357 "project/radare2/shlr/grub/fs/afs.c"
     ret
# 357 "project/radare2/shlr/grub/fs/afs.c" 3 4
     ), (
# 357 "project/radare2/shlr/grub/fs/afs.c"
     (char *) &(node->inode.stream)
# 357 "project/radare2/shlr/grub/fs/afs.c" 3 4
     ), (
# 357 "project/radare2/shlr/grub/fs/afs.c"
...
# 358 "project/radare2/shlr/grub/fs/afs.c"
                                ;
      return ret;
    }
  ret = grub_zalloc (size + 1);
        ...
        void *closure)
{
  ...
  if ((dir->inode.stream.size == 0)
      || ((
# 381 "project/radare2/shlr/grub/fs/afs.c" 3 4
          grub_swap_bytes32(
# 381 "project/radare2/shlr/grub/fs/afs.c"
          dir->inode.mode
# 381 "project/radare2/shlr/grub/fs/afs.c" 3 4
          ) 
# 381 "project/radare2/shlr/grub/fs/afs.c"
  ...
  grub_afs_read_file (dir, 0, 0, 0, 
# 389 "project/radare2/shlr/grub/fs/afs.c" 3 4
                                   grub_swap_bytes64(
# 389 "project/radare2/shlr/grub/fs/afs.c"
                                   head.root
# 389 "project/radare2/shlr/grub/fs/afs.c" 3 4
                                   )
# 389 "project/radare2/shlr/grub/fs/afs.c"
  ...
  for (i = 0; i < (int) 
# 394 "project/radare2/shlr/grub/fs/afs.c" 3 4
                       grub_swap_bytes32(
# 394 "project/radare2/shlr/grub/fs/afs.c"
                       head.tree_depth
# 394 "project/radare2/shlr/grub/fs/afs.c" 3 4
                       ) 
# 394 "project/radare2/shlr/grub/fs/afs.c"
                                                           - 1; i++)
    {
      ...
      blk = 
# 398 "project/radare2/shlr/grub/fs/afs.c" 3 4
           grub_swap_bytes64(
# 398 "project/radare2/shlr/grub/fs/afs.c"
           ((grub_afs_bvalue_t *) ((char *) ((grub_uint16_t *) ((char *) (node) + 
# 398 "project/radare2/shlr/grub/fs/afs.c" 3 4
           ((
# 398 "project/radare2/shlr/grub/fs/afs.c"
           sizeof (struct grub_afs_bnode) + node->key_size 
# 398 "project/radare2/shlr/grub/fs/afs.c" 3 4
           + (size_t) 
# 398 "project/radare2/shlr/grub/fs/afs.c"
           8 
...
# 398 "project/radare2/shlr/grub/fs/afs.c"
                                                           ;
      grub_afs_read_file (dir, 0, 0, 0, blk, 1024, (char *) node);
      if (grub_errno)
        return 0;
    }
      ...
      while (1)
        {
          ...
          index = ((grub_uint16_t *) ((char *) (node) + 
# 413 "project/radare2/shlr/grub/fs/afs.c" 3 4
                 ((
# 413 "project/radare2/shlr/grub/fs/afs.c"
                 sizeof (struct grub_afs_bnode) + node->key_size 
# 413 "project/radare2/shlr/grub/fs/afs.c" 3 4
                 + (size_t) 
# 413 "project/radare2/shlr/grub/fs/afs.c"
...
# 413 "project/radare2/shlr/grub/fs/afs.c"
   ...
   key_start = (cur_key > 0)
     ? 
# 416 "project/radare2/shlr/grub/fs/afs.c" 3 4
      ({ grub_uint16_t _x = (
# 416 "project/radare2/shlr/grub/fs/afs.c"
      index[cur_key - 1]
# 416 "project/radare2/shlr/grub/fs/afs.c" 3 4
      ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); }) 
# 416 "project/radare2/shlr/grub/fs/afs.c"
                                             : 0;
          key_size = 
# 417 "project/radare2/shlr/grub/fs/afs.c" 3 4
                    ({ grub_uint16_t _x = (
# 417 "project/radare2/shlr/grub/fs/afs.c"
                    index[cur_key]
# 417 "project/radare2/shlr/grub/fs/afs.c" 3 4
                    ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); }) 
# 417 "project/radare2/shlr/grub/fs/afs.c"
...
# 430 "project/radare2/shlr/grub/fs/afs.c" 3 4
                                      grub_swap_bytes64(
# 430 "project/radare2/shlr/grub/fs/afs.c"
                                      ((grub_afs_bvalue_t *) ((char *) ((grub_uint16_t *) ((char *) (node) + 
# 430 "project/radare2/shlr/grub/fs/afs.c" 3 4
                                      ((
# 430 "project/radare2/shlr/grub/fs/afs.c"
...
# 430 "project/radare2/shlr/grub/fs/afs.c" 3 4
                                      - 1))
# 430 "project/radare2/shlr/grub/fs/afs.c"
                                      )) + node->key_count * 2)) [cur_key]
# 430 "project/radare2/shlr/grub/fs/afs.c" 3 4
                                      )
                                                
# 431 "project/radare2/shlr/grub/fs/afs.c"
                                               ,
                                       &fdiro->inode))
                return 0;

              
# 435 "project/radare2/shlr/grub/fs/afs.c" 3 4
             grub_memmove ((
# 435 "project/radare2/shlr/grub/fs/afs.c"
             filename
# 435 "project/radare2/shlr/grub/fs/afs.c" 3 4
             ), (
# 435 "project/radare2/shlr/grub/fs/afs.c"
             &node->key_data[key_start]
# 435 "project/radare2/shlr/grub/fs/afs.c" 3 4
             ), (
# 435 "project/radare2/shlr/grub/fs/afs.c"
             key_size
...
# 435 "project/radare2/shlr/grub/fs/afs.c"
              ...
              mode = (
# 438 "project/radare2/shlr/grub/fs/afs.c" 3 4
                     grub_swap_bytes32(
# 438 "project/radare2/shlr/grub/fs/afs.c"
                     fdiro->inode.mode
# 438 "project/radare2/shlr/grub/fs/afs.c" 3 4
                     ) 
# 438 "project/radare2/shlr/grub/fs/afs.c"
  ...
  type = GRUB_FSHELP_SYMLINK;
          ...
          cur_key++;
          if (cur_key >= 
# 453 "project/radare2/shlr/grub/fs/afs.c" 3 4
                        grub_swap_bytes32(
# 453 "project/radare2/shlr/grub/fs/afs.c"
                        node->key_count
# 453 "project/radare2/shlr/grub/fs/afs.c" 3 4
                        )
# 453 "project/radare2/shlr/grub/fs/afs.c"
            ...
            {
              if (node->right == ((grub_afs_bvalue_t)-1))
                break;

              grub_afs_read_file (dir, 0, 0, 0, 
# 458 "project/radare2/shlr/grub/fs/afs.c" 3 4
                                               grub_swap_bytes64(
# 458 "project/radare2/shlr/grub/fs/afs.c"
                                               node->right
# 458 "project/radare2/shlr/grub/fs/afs.c" 3 4
                                               )
# 458 "project/radare2/shlr/grub/fs/afs.c"
...
{
  if (
# 474 "project/radare2/shlr/grub/fs/afs.c" 3 4
     grub_swap_bytes32(
# 474 "project/radare2/shlr/grub/fs/afs.c"
     sb->magic1
# 474 "project/radare2/shlr/grub/fs/afs.c" 3 4
     ) 
# 474 "project/radare2/shlr/grub/fs/afs.c"
    ...
    {
      sb->magic2 = 
# 476 "project/radare2/shlr/grub/fs/afs.c" 3 4
                  grub_swap_bytes32(
# 476 "project/radare2/shlr/grub/fs/afs.c"
                  sb->magic2
# 476 "project/radare2/shlr/grub/fs/afs.c" 3 4
                  )
# 476 "project/radare2/shlr/grub/fs/afs.c"
                                                ;
      sb->magic3 = 
# 477 "project/radare2/shlr/grub/fs/afs.c" 3 4
                  grub_swap_bytes32(
# 477 "project/radare2/shlr/grub/fs/afs.c"
                  sb->magic3
# 477 "project/radare2/shlr/grub/fs/afs.c" 3 4
                  )
# 477 "project/radare2/shlr/grub/fs/afs.c"
                                                ;
      sb->block_shift = 
# 478 "project/radare2/shlr/grub/fs/afs.c" 3 4
                       grub_swap_bytes32(
# 478 "project/radare2/shlr/grub/fs/afs.c"
                       sb->block_shift
# 478 "project/radare2/shlr/grub/fs/afs.c" 3 4
                       )
# 478 "project/radare2/shlr/grub/fs/afs.c"
                                                          ;
      sb->block_size = 
# 479 "project/radare2/shlr/grub/fs/afs.c" 3 4
                      grub_swap_bytes32(
# 479 "project/radare2/shlr/grub/fs/afs.c"
                      sb->block_size
# 479 "project/radare2/shlr/grub/fs/afs.c" 3 4
                      )
# 479 "project/radare2/shlr/grub/fs/afs.c"
                                                        ;
      sb->used_blocks = 
# 480 "project/radare2/shlr/grub/fs/afs.c" 3 4
                       grub_swap_bytes64(
# 480 "project/radare2/shlr/grub/fs/afs.c"
                       sb->used_blocks
# 480 "project/radare2/shlr/grub/fs/afs.c" 3 4
                       )
# 480 "project/radare2/shlr/grub/fs/afs.c"
                                                          ;
      sb->num_blocks = 
# 481 "project/radare2/shlr/grub/fs/afs.c" 3 4
                      grub_swap_bytes64(
# 481 "project/radare2/shlr/grub/fs/afs.c"
                      sb->num_blocks
# 481 "project/radare2/shlr/grub/fs/afs.c" 3 4
                      )
# 481 "project/radare2/shlr/grub/fs/afs.c"
                                                        ;
      sb->inode_size = 
# 482 "project/radare2/shlr/grub/fs/afs.c" 3 4
                      grub_swap_bytes32(
# 482 "project/radare2/shlr/grub/fs/afs.c"
                      sb->inode_size
# 482 "project/radare2/shlr/grub/fs/afs.c" 3 4
                      )
# 482 "project/radare2/shlr/grub/fs/afs.c"
...
# 483 "project/radare2/shlr/grub/fs/afs.c" 3 4
                             grub_swap_bytes32(
# 483 "project/radare2/shlr/grub/fs/afs.c"
                             sb->alloc_group_count
# 483 "project/radare2/shlr/grub/fs/afs.c" 3 4
                             )
# 483 "project/radare2/shlr/grub/fs/afs.c"
                                                                      ;
      sb->alloc_group_shift = 
# 484 "project/radare2/shlr/grub/fs/afs.c" 3 4
                             grub_swap_bytes32(
# 484 "project/radare2/shlr/grub/fs/afs.c"
                             sb->alloc_group_shift
# 484 "project/radare2/shlr/grub/fs/afs.c" 3 4
                             )
# 484 "project/radare2/shlr/grub/fs/afs.c"
                                                                      ;
      sb->block_per_group = 
# 485 "project/radare2/shlr/grub/fs/afs.c" 3 4
                           grub_swap_bytes32(
# 485 "project/radare2/shlr/grub/fs/afs.c"
                           sb->block_per_group
# 485 "project/radare2/shlr/grub/fs/afs.c" 3 4
                           )
# 485 "project/radare2/shlr/grub/fs/afs.c"
                                                                  ;
      sb->alloc_group_count = 
# 486 "project/radare2/shlr/grub/fs/afs.c" 3 4
                             grub_swap_bytes32(
# 486 "project/radare2/shlr/grub/fs/afs.c"
                             sb->alloc_group_count
# 486 "project/radare2/shlr/grub/fs/afs.c" 3 4
                             )
# 486 "project/radare2/shlr/grub/fs/afs.c"
                                                                      ;
      sb->log_size = 
# 487 "project/radare2/shlr/grub/fs/afs.c" 3 4
                    grub_swap_bytes32(
# 487 "project/radare2/shlr/grub/fs/afs.c"
                    sb->log_size
# 487 "project/radare2/shlr/grub/fs/afs.c" 3 4
                    )
# 487 "project/radare2/shlr/grub/fs/afs.c"
  ...
  if ((sb->magic2 != 0xdd121031) ||
      (sb->magic3 != 0x15b6830e))
    return 0;
...
fail:
  grub_error (GRUB_ERR_BAD_FS, "not an " "befs" "_be" " filesystem");
...
# 568 "project/radare2/shlr/grub/fs/afs.c" 3 4
 grub_memmove ((
# 568 "project/radare2/shlr/grub/fs/afs.c"
 data->inode
# 568 "project/radare2/shlr/grub/fs/afs.c" 3 4
 ), (
# 568 "project/radare2/shlr/grub/fs/afs.c"
...
# 568 "project/radare2/shlr/grub/fs/afs.c"
  ...
  file->size = 
# 571 "project/radare2/shlr/grub/fs/afs.c" 3 4
              grub_swap_bytes64(
# 571 "project/radare2/shlr/grub/fs/afs.c"
              data->inode->stream.size
# 571 "project/radare2/shlr/grub/fs/afs.c" 3 4
              )
# 571 "project/radare2/shlr/grub/fs/afs.c"
                                                          ;
  ...
  grub_fshelp_node_t node, void *closure)
{
  ...
  info.dir = ((filetype & 
# 615 "project/radare2/shlr/grub/fs/afs.c" 3 4
                         0xff
# 615 "project/radare2/shlr/grub/fs/afs.c"
                                              ) == GRUB_FSHELP_DIR);
  info.mtimeset = 1;

  info.mtime = 
# 618 "project/radare2/shlr/grub/fs/afs.c" 3 4
              grub_swap_bytes64(
# 618 "project/radare2/shlr/grub/fs/afs.c"
...
grub_afs_label (grub_device_t device, char **label)
{
  ...
  if (data)
    ...
    *label = 
# 671 "project/radare2/shlr/grub/fs/afs.c" 3 4
            ((void *)0)
# 671 "project/radare2/shlr/grub/fs/afs.c"
                ;
...
# 5 "project/radare2/shlr/grub/fs/befs_be.c" 2
