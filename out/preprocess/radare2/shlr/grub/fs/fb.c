# 0 "project/radare2/shlr/grub/fs/fb.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/grub/fs/fb.c"
# 19 "project/radare2/shlr/grub/fs/fb.c"
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/fs.h" 1 3 4
# 23 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/fs.h" 3 4
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/device.h" 1 3 4
# 23 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/device.h" 3 4
...
int grub_device_iterate (int (*hook) (const char *name, void *closure),
    void *closure);
# 24 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/fs.h" 2 3 4
...
# 26 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/fs.h" 2 3 4
...
# 20 "project/radare2/shlr/grub/fs/fb.c" 2
...
# 21 "project/radare2/shlr/grub/fs/fb.c" 2
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 22 "project/radare2/shlr/grub/fs/fb.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/file.h" 1 3 4
# 28 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/file.h" 3 4
struct grub_file
{
...
grub_ssize_t grub_file_pb_read (grub_file_t file, void *buf, grub_size_t len,
    int total);
# 23 "project/radare2/shlr/grub/fs/fb.c" 2

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/fbfs.h" 1 3 4
# 31 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/fbfs.h" 3 4
struct fb_mbr { grub_uint8_t jmp_code; grub_uint8_t jmp_ofs; grub_uint8_t boot_code[0x1ab]; grub_uint8_t max_sec; grub_uint16_t lba; grub_uint8_t spt; grub_uint8_t heads; grub_uint16_t boot_base; grub_uint32_t fb_magic; grub_uint8_t mbr_table[0x46]; grub_uint16_t end_magic; } __attribute__((__packed__))
# 45 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/fbfs.h" 3 4
  ;

struct fb_data { grub_uint16_t boot_size; grub_uint16_t flags; grub_uint8_t ver_major; grub_uint8_t ver_minor; grub_uint16_t list_used; grub_uint16_t list_size; grub_uint16_t pri_size; grub_uint32_t ext_size; } __attribute__((__packed__))
# 58 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/fbfs.h" 3 4
  ;

struct fb_ar_data { grub_uint32_t ar_magic; grub_uint8_t ver_major; grub_uint8_t ver_minor; grub_uint16_t list_used; grub_uint16_t list_size; grub_uint16_t pri_size; grub_uint32_t ext_size; } __attribute__((__packed__))
# 70 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/fbfs.h" 3 4
  ;

struct fbm_file { grub_uint8_t size; grub_uint8_t flag; grub_uint32_t data_start; grub_uint32_t data_size; grub_uint32_t data_time; char name[0]; } __attribute__((__packed__))
# 81 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/fbfs.h" 3 4
  ;
# 25 "project/radare2/shlr/grub/fs/fb.c" 2


# 26 "project/radare2/shlr/grub/fs/fb.c"
struct grub_fb_data
{
  grub_uint32_t ofs;
...
grub_fbfs_mount (grub_disk_t disk)
{
  ...
  if (*grub32 == 
# 51 "project/radare2/shlr/grub/fs/fb.c" 3 4
                0x52414246
# 51 "project/radare2/shlr/grub/fs/fb.c"
                                )
    {
      ofs = 0;
      boot_base = 0;
    ...
    {
      if ((m->fb_magic != 
# 60 "project/radare2/shlr/grub/fs/fb.c" 3 4
                         0x46424246
# 60 "project/radare2/shlr/grub/fs/fb.c"
                                      ) || (m->end_magic != 0xaa55))
 goto fail;
 ...
 goto fail;
  ...
  if ((d->ver_major != 
# 73 "project/radare2/shlr/grub/fs/fb.c" 3 4
                      1
# 73 "project/radare2/shlr/grub/fs/fb.c"
                                  ) || (d->ver_minor != 
# 73 "project/radare2/shlr/grub/fs/fb.c" 3 4
                                                        6
# 73 "project/radare2/shlr/grub/fs/fb.c"
...
# 94 "project/radare2/shlr/grub/fs/fb.c" 3 4
     grub_memmove ((
# 94 "project/radare2/shlr/grub/fs/fb.c"
     p1
# 94 "project/radare2/shlr/grub/fs/fb.c" 3 4
     ), (
# 94 "project/radare2/shlr/grub/fs/fb.c"
        ...
        void *closure)
{
  ...
  while (p->size)
    {
      info.mtime = 
# 136 "project/radare2/shlr/grub/fs/fb.c" 3 4
                  ((grub_uint32_t) (
# 136 "project/radare2/shlr/grub/fs/fb.c"
                  p->data_time
# 136 "project/radare2/shlr/grub/fs/fb.c" 3 4
                  ))
# 136 "project/radare2/shlr/grub/fs/fb.c"
