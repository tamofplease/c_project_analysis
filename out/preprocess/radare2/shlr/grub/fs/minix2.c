# 0 "project/radare2/shlr/grub/fs/minix2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/grub/fs/minix2.c"

# 1 "project/radare2/shlr/grub/fs/minix.c" 1
# 20 "project/radare2/shlr/grub/fs/minix.c"
...
# 21 "project/radare2/shlr/grub/fs/minix.c" 2
...
grub_ssize_t grub_file_pb_read (grub_file_t file, void *buf, grub_size_t len,
    int total);
# 22 "project/radare2/shlr/grub/fs/minix.c" 2
...
# 23 "project/radare2/shlr/grub/fs/minix.c" 2
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 25 "project/radare2/shlr/grub/fs/minix.c" 2
# 59 "project/radare2/shlr/grub/fs/minix.c"
  ...
  if (data->version == 1)
    {
      ...
      grub_disk_read (data->disk,
        zone << (1 + 
# 127 "project/radare2/shlr/grub/fs/minix.c" 3 4
               ((grub_uint16_t) (
# 127 "project/radare2/shlr/grub/fs/minix.c"
               sblock->log2_zone_size
# 127 "project/radare2/shlr/grub/fs/minix.c" 3 4
               ))
# 127 "project/radare2/shlr/grub/fs/minix.c"
               ),
      ...
      return 
# 130 "project/radare2/shlr/grub/fs/minix.c" 3 4
            ((grub_uint16_t) (
# 130 "project/radare2/shlr/grub/fs/minix.c"
            indir16
# 130 "project/radare2/shlr/grub/fs/minix.c" 3 4
            ))
# 130 "project/radare2/shlr/grub/fs/minix.c"
  ...
  else
    {
      ...
      grub_disk_read (data->disk,
        zone << (1 + 
# 136 "project/radare2/shlr/grub/fs/minix.c" 3 4
               ((grub_uint16_t) (
# 136 "project/radare2/shlr/grub/fs/minix.c"
               sblock->log2_zone_size
# 136 "project/radare2/shlr/grub/fs/minix.c" 3 4
               ))
# 136 "project/radare2/shlr/grub/fs/minix.c"
      ...
      return 
# 139 "project/radare2/shlr/grub/fs/minix.c" 3 4
            ((grub_uint32_t) (
# 139 "project/radare2/shlr/grub/fs/minix.c"
            indir32
# 139 "project/radare2/shlr/grub/fs/minix.c" 3 4
            ))
# 139 "project/radare2/shlr/grub/fs/minix.c"
...
# 151 "project/radare2/shlr/grub/fs/minix.c" 3 4
          ((grub_uint16_t) (
# 151 "project/radare2/shlr/grub/fs/minix.c"
...
# 151 "project/radare2/shlr/grub/fs/minix.c"
  ...
  blk -= 7;
  if (blk < (1024U << 
# 155 "project/radare2/shlr/grub/fs/minix.c" 3 4
           ((grub_uint16_t) (
# 155 "project/radare2/shlr/grub/fs/minix.c"
           sblock->log2_zone_size
# 155 "project/radare2/shlr/grub/fs/minix.c" 3 4
           ))
# 155 "project/radare2/shlr/grub/fs/minix.c"
    ...
    {
      indir = grub_get_indir ((data->version == 1 ? 
# 157 "project/radare2/shlr/grub/fs/minix.c" 3 4
                             ((grub_uint16_t) (
# 157 "project/radare2/shlr/grub/fs/minix.c"
...
# 157 "project/radare2/shlr/grub/fs/minix.c"
  ...
  blk -= (1024U << 
# 162 "project/radare2/shlr/grub/fs/minix.c" 3 4
        ((grub_uint16_t) (
# 162 "project/radare2/shlr/grub/fs/minix.c"
        sblock->log2_zone_size
# 162 "project/radare2/shlr/grub/fs/minix.c" 3 4
        ))
# 162 "project/radare2/shlr/grub/fs/minix.c"
  ...
  if (blk < ((1024U << 
# 163 "project/radare2/shlr/grub/fs/minix.c" 3 4
            ((grub_uint16_t) (
# 163 "project/radare2/shlr/grub/fs/minix.c"
            sblock->log2_zone_size
# 163 "project/radare2/shlr/grub/fs/minix.c" 3 4
            ))
# 163 "project/radare2/shlr/grub/fs/minix.c"
      ...
      * ((1024U << 
# 164 "project/radare2/shlr/grub/fs/minix.c" 3 4
        ((grub_uint16_t) (
# 164 "project/radare2/shlr/grub/fs/minix.c"
        sblock->log2_zone_size
# 164 "project/radare2/shlr/grub/fs/minix.c" 3 4
        ))
# 164 "project/radare2/shlr/grub/fs/minix.c"
    ...
    {
      indir = grub_get_indir ((data->version == 1 ? 
# 166 "project/radare2/shlr/grub/fs/minix.c" 3 4
                             ((grub_uint16_t) (
# 166 "project/radare2/shlr/grub/fs/minix.c"
...
# 166 "project/radare2/shlr/grub/fs/minix.c" 3 4
                             ((grub_uint32_t) (
# 166 "project/radare2/shlr/grub/fs/minix.c"
                             data->inode2.double_indir_zone
# 166 "project/radare2/shlr/grub/fs/minix.c" 3 4
                             ))
# 166 "project/radare2/shlr/grub/fs/minix.c"
                             ),
         blk / (1024U << 
# 167 "project/radare2/shlr/grub/fs/minix.c" 3 4
              ((grub_uint16_t) (
# 167 "project/radare2/shlr/grub/fs/minix.c"
              sblock->log2_zone_size
# 167 "project/radare2/shlr/grub/fs/minix.c" 3 4
              ))
# 167 "project/radare2/shlr/grub/fs/minix.c"
      ...
      indir = grub_get_indir (indir, blk % (1024U << 
# 169 "project/radare2/shlr/grub/fs/minix.c" 3 4
                                          ((grub_uint16_t) (
# 169 "project/radare2/shlr/grub/fs/minix.c"
                                          sblock->log2_zone_size
# 169 "project/radare2/shlr/grub/fs/minix.c" 3 4
                                          ))
# 169 "project/radare2/shlr/grub/fs/minix.c"
        ...
        int pos, grub_disk_addr_t len, char *buf)
{
  ...
  if (len + pos > (data->version == 1 ? 
# 196 "project/radare2/shlr/grub/fs/minix.c" 3 4
                 ((grub_uint16_t) (
# 196 "project/radare2/shlr/grub/fs/minix.c"
                 data->inode.size
# 196 "project/radare2/shlr/grub/fs/minix.c" 3 4
                 )) 
# 196 "project/radare2/shlr/grub/fs/minix.c"
...
# 196 "project/radare2/shlr/grub/fs/minix.c"
    ...
    len = (data->version == 1 ? 
# 197 "project/radare2/shlr/grub/fs/minix.c" 3 4
         ((grub_uint16_t) (
# 197 "project/radare2/shlr/grub/fs/minix.c"
         data->inode.size
# 197 "project/radare2/shlr/grub/fs/minix.c" 3 4
         )) 
# 197 "project/radare2/shlr/grub/fs/minix.c"
...
# 197 "project/radare2/shlr/grub/fs/minix.c"
  ...
  blockcnt = (len + pos + 1024U - 1) / 1024U;

  for (i = pos / 1024U; i < blockcnt; i++)
    {
      int blknr;
      int blockoff = pos % 1024U;
      int blockend = 1024U;
      ...
      if (i == (pos / (int) 1024U))
 {
   ...
   blockend -= skipfirst;
      ...
      grub_disk_read (data->disk, blknr << (1 + 
# 231 "project/radare2/shlr/grub/fs/minix.c" 3 4
                                          ((grub_uint16_t) (
# 231 "project/radare2/shlr/grub/fs/minix.c"
                                          sblock->log2_zone_size
# 231 "project/radare2/shlr/grub/fs/minix.c" 3 4
                                          ))
# 231 "project/radare2/shlr/grub/fs/minix.c"
...
grub_minix_read_inode (struct grub_minix_data *data, int ino)
{
  ...
  block = ((2 + 
# 259 "project/radare2/shlr/grub/fs/minix.c" 3 4
               ((grub_uint16_t) (
# 259 "project/radare2/shlr/grub/fs/minix.c"
               sblock->inode_bmap_size
# 259 "project/radare2/shlr/grub/fs/minix.c" 3 4
               ))
     
# 260 "project/radare2/shlr/grub/fs/minix.c"
    + 
# 260 "project/radare2/shlr/grub/fs/minix.c" 3 4
      ((grub_uint16_t) (
# 260 "project/radare2/shlr/grub/fs/minix.c"
      sblock->zone_bmap_size
# 260 "project/radare2/shlr/grub/fs/minix.c" 3 4
      ))
# 260 "project/radare2/shlr/grub/fs/minix.c"
                                               )
  ...
  if (data->version == 1)
    {
      block += ino / (
# 265 "project/radare2/shlr/grub/fs/minix.c" 3 4
                     0x200 
# 265 "project/radare2/shlr/grub/fs/minix.c"
                                           / sizeof (struct grub_minix_inode));
      int offs = (ino % (
# 266 "project/radare2/shlr/grub/fs/minix.c" 3 4
                        0x200
    
# 267 "project/radare2/shlr/grub/fs/minix.c"
   / sizeof (struct grub_minix_inode))
    * sizeof (struct grub_minix_inode));
    ...
    {
      block += ino / (
# 275 "project/radare2/shlr/grub/fs/minix.c" 3 4
                     0x200
        
# 276 "project/radare2/shlr/grub/fs/minix.c"
       / sizeof (struct grub_minix2_inode));
      int offs = (ino
    % (
# 278 "project/radare2/shlr/grub/fs/minix.c" 3 4
      0x200 
# 278 "project/radare2/shlr/grub/fs/minix.c"
                            / sizeof (struct grub_minix2_inode))
    * sizeof (struct grub_minix2_inode));
...
grub_minix_lookup_symlink (struct grub_minix_data *data, int ino)
{
  ...
  char symlink[(data->version == 1 ? 
# 295 "project/radare2/shlr/grub/fs/minix.c" 3 4
              ((grub_uint16_t) (
# 295 "project/radare2/shlr/grub/fs/minix.c"
              data->inode.size
# 295 "project/radare2/shlr/grub/fs/minix.c" 3 4
              )) 
# 295 "project/radare2/shlr/grub/fs/minix.c"
...
# 295 "project/radare2/shlr/grub/fs/minix.c"
  ...
  if (grub_minix_read_file (data, 0, 0, 0,
       (data->version == 1 ? 
# 303 "project/radare2/shlr/grub/fs/minix.c" 3 4
      ((grub_uint16_t) (
# 303 "project/radare2/shlr/grub/fs/minix.c"
      data->inode.size
# 303 "project/radare2/shlr/grub/fs/minix.c" 3 4
      )) 
# 303 "project/radare2/shlr/grub/fs/minix.c"
...
# 303 "project/radare2/shlr/grub/fs/minix.c"
  ...
  symlink[(data->version == 1 ? 
# 306 "project/radare2/shlr/grub/fs/minix.c" 3 4
         ((grub_uint16_t) (
# 306 "project/radare2/shlr/grub/fs/minix.c"
         data->inode.size
# 306 "project/radare2/shlr/grub/fs/minix.c" 3 4
         )) 
# 306 "project/radare2/shlr/grub/fs/minix.c"
...
grub_minix_find_file (struct grub_minix_data *data, const char *path)
{
 ...
 {
   dirino = data->ino;
   grub_minix_read_inode (data, 
# 389 "project/radare2/shlr/grub/fs/minix.c" 3 4
                               ((grub_uint16_t) (
# 389 "project/radare2/shlr/grub/fs/minix.c"
                               ino
# 389 "project/radare2/shlr/grub/fs/minix.c" 3 4
                               ))
# 389 "project/radare2/shlr/grub/fs/minix.c"
   ...
   if (((data->version == 1 ? 
# 392 "project/radare2/shlr/grub/fs/minix.c" 3 4
       ((grub_uint16_t) (
# 392 "project/radare2/shlr/grub/fs/minix.c"
       data->inode.mode
# 392 "project/radare2/shlr/grub/fs/minix.c" 3 4
       )) 
# 392 "project/radare2/shlr/grub/fs/minix.c"
   ...
   if (next)
     {
       ...
       next++;
        ...
        if (((data->version == 1 ? 
# 421 "project/radare2/shlr/grub/fs/minix.c" 3 4
            ((grub_uint16_t) (
# 421 "project/radare2/shlr/grub/fs/minix.c"
            data->inode.mode
# 421 "project/radare2/shlr/grub/fs/minix.c" 3 4
            )) 
# 421 "project/radare2/shlr/grub/fs/minix.c"
...
# 421 "project/radare2/shlr/grub/fs/minix.c"
   ...
   continue;
    ...
    } while (pos < (data->version == 1 ? 
# 433 "project/radare2/shlr/grub/fs/minix.c" 3 4
                  ((grub_uint16_t) (
# 433 "project/radare2/shlr/grub/fs/minix.c"
                  data->inode.size
# 433 "project/radare2/shlr/grub/fs/minix.c" 3 4
                  )) 
# 433 "project/radare2/shlr/grub/fs/minix.c"
...
grub_minix_mount (grub_disk_t disk)
{
  ...
  grub_disk_read (disk, 2, 0,
    sizeof (struct grub_minix_sblock),&data->sblock);
  if (grub_errno)
    goto fail;

  if (
# 457 "project/radare2/shlr/grub/fs/minix.c" 3 4
     ((grub_uint16_t) (
# 457 "project/radare2/shlr/grub/fs/minix.c"
     data->sblock.magic
# 457 "project/radare2/shlr/grub/fs/minix.c" 3 4
     )) 
# 457 "project/radare2/shlr/grub/fs/minix.c"
...
# 462 "project/radare2/shlr/grub/fs/minix.c" 3 4
          ((grub_uint16_t) (
# 462 "project/radare2/shlr/grub/fs/minix.c"
          data->sblock.magic
# 462 "project/radare2/shlr/grub/fs/minix.c" 3 4
          )) 
# 462 "project/radare2/shlr/grub/fs/minix.c"
...
# 467 "project/radare2/shlr/grub/fs/minix.c" 3 4
          ((grub_uint16_t) (
# 467 "project/radare2/shlr/grub/fs/minix.c"
          data->sblock.magic
# 467 "project/radare2/shlr/grub/fs/minix.c" 3 4
          )) 
# 467 "project/radare2/shlr/grub/fs/minix.c"
...
# 472 "project/radare2/shlr/grub/fs/minix.c" 3 4
          ((grub_uint16_t) (
# 472 "project/radare2/shlr/grub/fs/minix.c"
          data->sblock.magic
# 472 "project/radare2/shlr/grub/fs/minix.c" 3 4
          )) 
# 472 "project/radare2/shlr/grub/fs/minix.c"
  ...
  void *closure)
{
  ...
  if (((data->version == 1 ? 
# 513 "project/radare2/shlr/grub/fs/minix.c" 3 4
      ((grub_uint16_t) (
# 513 "project/radare2/shlr/grub/fs/minix.c"
      data->inode.mode
# 513 "project/radare2/shlr/grub/fs/minix.c" 3 4
      )) 
# 513 "project/radare2/shlr/grub/fs/minix.c"
...
# 513 "project/radare2/shlr/grub/fs/minix.c"
  ...
  if (hook)
  while (pos < (data->version == 1 ? 
# 520 "project/radare2/shlr/grub/fs/minix.c" 3 4
              ((grub_uint16_t) (
# 520 "project/radare2/shlr/grub/fs/minix.c"
              data->inode.size
# 520 "project/radare2/shlr/grub/fs/minix.c" 3 4
              )) 
# 520 "project/radare2/shlr/grub/fs/minix.c"
...
# 520 "project/radare2/shlr/grub/fs/minix.c"
 ...
 return grub_errno;
      ...
      grub_minix_read_inode (data, 
# 545 "project/radare2/shlr/grub/fs/minix.c" 3 4
                                  ((grub_uint16_t) (
# 545 "project/radare2/shlr/grub/fs/minix.c"
                                  ino
# 545 "project/radare2/shlr/grub/fs/minix.c" 3 4
                                  ))
# 545 "project/radare2/shlr/grub/fs/minix.c"
                                                        );
      info.dir = (((data->version == 1 ? 
# 546 "project/radare2/shlr/grub/fs/minix.c" 3 4
                  ((grub_uint16_t) (
# 546 "project/radare2/shlr/grub/fs/minix.c"
                  data->inode.mode
# 546 "project/radare2/shlr/grub/fs/minix.c" 3 4
                  )) 
# 546 "project/radare2/shlr/grub/fs/minix.c"
...
grub_minix_open (struct grub_file *file, const char *name)
{
  ...
  file->data = data;
  file->size = (data->version == 1 ? 
# 596 "project/radare2/shlr/grub/fs/minix.c" 3 4
              ((grub_uint16_t) (
# 596 "project/radare2/shlr/grub/fs/minix.c"
              data->inode.size
# 596 "project/radare2/shlr/grub/fs/minix.c" 3 4
              )) 
# 596 "project/radare2/shlr/grub/fs/minix.c"
...
# 3 "project/radare2/shlr/grub/fs/minix2.c" 2
