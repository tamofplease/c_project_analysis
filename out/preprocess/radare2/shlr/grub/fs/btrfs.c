# 0 "project/radare2/shlr/grub/fs/btrfs.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/grub/fs/btrfs.c"
# 20 "project/radare2/shlr/grub/fs/btrfs.c"
...
# 21 "project/radare2/shlr/grub/fs/btrfs.c" 2
...
grub_ssize_t grub_file_pb_read (grub_file_t file, void *buf, grub_size_t len,
    int total);
# 22 "project/radare2/shlr/grub/fs/btrfs.c" 2
...
# 23 "project/radare2/shlr/grub/fs/btrfs.c" 2
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 25 "project/radare2/shlr/grub/fs/btrfs.c" 2




# 28 "project/radare2/shlr/grub/fs/btrfs.c"
struct btrfs_superblock { grub_uint8_t dummy1[32]; grub_uint16_t uuid[8]; grub_uint8_t dummy2[16]; grub_uint8_t signature[sizeof ("_BHRfS_M") - 1]; } 
# 28 "project/radare2/shlr/grub/fs/btrfs.c" 3 4
...
# 35 "project/radare2/shlr/grub/fs/btrfs.c"
 ;
...
grub_btrfs_mount (grub_disk_t disk)
{
  ...
  if (! data)
    return 
# 47 "project/radare2/shlr/grub/fs/btrfs.c" 3 4
          ((void *)0)
# 47 "project/radare2/shlr/grub/fs/btrfs.c"
              ;
  ...
  if (grub_memcmp ((char *) data->sblock.signature, "_BHRfS_M", sizeof ("_BHRfS_M") - 1))
    {
 ...
 fail:
  grub_free (data);
  return 
# 63 "project/radare2/shlr/grub/fs/btrfs.c" 3 4
        ((void *)0)
# 63 "project/radare2/shlr/grub/fs/btrfs.c"
            ;
}
...
grub_btrfs_uuid (grub_device_t device, char **uuid)
{
  ...
  *uuid = 
# 93 "project/radare2/shlr/grub/fs/btrfs.c" 3 4
         ((void *)0)
# 93 "project/radare2/shlr/grub/fs/btrfs.c"
             ;
...
# 100 "project/radare2/shlr/grub/fs/btrfs.c" 3 4
    ({ grub_uint16_t _x = (
# 100 "project/radare2/shlr/grub/fs/btrfs.c"
    data->sblock.uuid[0]
# 100 "project/radare2/shlr/grub/fs/btrfs.c" 3 4
...
# 101 "project/radare2/shlr/grub/fs/btrfs.c" 3 4
    ({ grub_uint16_t _x = (
# 101 "project/radare2/shlr/grub/fs/btrfs.c"
    data->sblock.uuid[1]
# 101 "project/radare2/shlr/grub/fs/btrfs.c" 3 4
    ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 101 "project/radare2/shlr/grub/fs/btrfs.c"
...
# 102 "project/radare2/shlr/grub/fs/btrfs.c" 3 4
    ({ grub_uint16_t _x = (
# 102 "project/radare2/shlr/grub/fs/btrfs.c"
    data->sblock.uuid[2]
# 102 "project/radare2/shlr/grub/fs/btrfs.c" 3 4
    ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 102 "project/radare2/shlr/grub/fs/btrfs.c"
...
# 103 "project/radare2/shlr/grub/fs/btrfs.c" 3 4
    ({ grub_uint16_t _x = (
# 103 "project/radare2/shlr/grub/fs/btrfs.c"
    data->sblock.uuid[3]
# 103 "project/radare2/shlr/grub/fs/btrfs.c" 3 4
    ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 103 "project/radare2/shlr/grub/fs/btrfs.c"
...
# 104 "project/radare2/shlr/grub/fs/btrfs.c" 3 4
    ({ grub_uint16_t _x = (
# 104 "project/radare2/shlr/grub/fs/btrfs.c"
    data->sblock.uuid[4]
# 104 "project/radare2/shlr/grub/fs/btrfs.c" 3 4
    ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 104 "project/radare2/shlr/grub/fs/btrfs.c"
...
# 105 "project/radare2/shlr/grub/fs/btrfs.c" 3 4
    ({ grub_uint16_t _x = (
# 105 "project/radare2/shlr/grub/fs/btrfs.c"
    data->sblock.uuid[5]
# 105 "project/radare2/shlr/grub/fs/btrfs.c" 3 4
    ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 105 "project/radare2/shlr/grub/fs/btrfs.c"
...
# 106 "project/radare2/shlr/grub/fs/btrfs.c" 3 4
    ({ grub_uint16_t _x = (
# 106 "project/radare2/shlr/grub/fs/btrfs.c"
    data->sblock.uuid[6]
# 106 "project/radare2/shlr/grub/fs/btrfs.c" 3 4
    ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 106 "project/radare2/shlr/grub/fs/btrfs.c"
...
# 107 "project/radare2/shlr/grub/fs/btrfs.c" 3 4
    ({ grub_uint16_t _x = (
# 107 "project/radare2/shlr/grub/fs/btrfs.c"
    data->sblock.uuid[7]
# 107 "project/radare2/shlr/grub/fs/btrfs.c" 3 4
    ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 107 "project/radare2/shlr/grub/fs/btrfs.c"
