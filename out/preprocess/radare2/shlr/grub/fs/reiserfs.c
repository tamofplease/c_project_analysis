# 0 "project/radare2/shlr/grub/fs/reiserfs.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/grub/fs/reiserfs.c"
# 33 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 25 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/err.h" 3 4
typedef enum
  {
    GRUB_ERR_NONE = 0,
...
# 34 "project/radare2/shlr/grub/fs/reiserfs.c" 2
...
grub_ssize_t grub_file_pb_read (grub_file_t file, void *buf, grub_size_t len,
    int total);
# 35 "project/radare2/shlr/grub/fs/reiserfs.c" 2
...
# 36 "project/radare2/shlr/grub/fs/reiserfs.c" 2
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 38 "project/radare2/shlr/grub/fs/reiserfs.c" 2
...
unsigned int grub_fshelp_log2blksize (unsigned int blksize,
          unsigned int *pow);
# 40 "project/radare2/shlr/grub/fs/reiserfs.c" 2
...
# 42 "project/radare2/shlr/grub/fs/reiserfs.c" 2
# 60 "project/radare2/shlr/grub/fs/reiserfs.c"
...
struct grub_reiserfs_superblock { grub_uint32_t block_count; grub_uint32_t block_free_count; grub_uint32_t root_block; grub_uint32_t journal_block; grub_uint32_t journal_device; grub_uint32_t journal_original_size; grub_uint32_t journal_max_transaction_size; grub_uint32_t journal_block_count; grub_uint32_t journal_max_batch; grub_uint32_t journal_max_commit_age; grub_uint32_t journal_max_transaction_age; grub_uint16_t block_size; grub_uint16_t oid_max_size; grub_uint16_t oid_current_size; grub_uint16_t state; grub_uint8_t magic_string[12]; grub_uint32_t function_hash_code; grub_uint16_t tree_height; grub_uint16_t bitmap_number; grub_uint16_t version; grub_uint16_t reserved; grub_uint32_t inode_generation; grub_uint8_t unused[4]; grub_uint16_t uuid[8]; } 
# 70 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
__attribute__((__packed__))
# 97 "project/radare2/shlr/grub/fs/reiserfs.c"
  ;


# 99 "project/radare2/shlr/grub/fs/reiserfs.c"
struct grub_reiserfs_journal_header { grub_uint32_t last_flush_uid; grub_uint32_t unflushed_offset; grub_uint32_t mount_id; } 
# 99 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
__attribute__((__packed__))
...
# 105 "project/radare2/shlr/grub/fs/reiserfs.c"
 ;

struct grub_reiserfs_description_block { grub_uint32_t id; grub_uint32_t len; grub_uint32_t mount_id; grub_uint32_t real_blocks[0]; } 
# 107 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
__attribute__((__packed__))
...
# 114 "project/radare2/shlr/grub/fs/reiserfs.c"
 ;

struct grub_reiserfs_commit_block { grub_uint32_t id; grub_uint32_t len; grub_uint32_t real_blocks[0]; } 
# 116 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
__attribute__((__packed__))
...
# 122 "project/radare2/shlr/grub/fs/reiserfs.c"
 ;

struct grub_reiserfs_stat_item_v1 { grub_uint16_t mode; grub_uint16_t hardlink_count; grub_uint16_t uid; grub_uint16_t gid; grub_uint32_t size; grub_uint32_t atime; grub_uint32_t mtime; grub_uint32_t ctime; grub_uint32_t rdev; grub_uint32_t first_direct_byte; } 
# 124 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
__attribute__((__packed__))
# 137 "project/radare2/shlr/grub/fs/reiserfs.c"
  ;


# 139 "project/radare2/shlr/grub/fs/reiserfs.c"
struct grub_reiserfs_stat_item_v2 { grub_uint16_t mode; grub_uint16_t reserved; grub_uint32_t hardlink_count; grub_uint64_t size; grub_uint32_t uid; grub_uint32_t gid; grub_uint32_t atime; grub_uint32_t mtime; grub_uint32_t ctime; grub_uint32_t blocks; grub_uint32_t first_direct_byte; } 
# 139 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
__attribute__((__packed__))
# 153 "project/radare2/shlr/grub/fs/reiserfs.c"
  ;


# 155 "project/radare2/shlr/grub/fs/reiserfs.c"
struct grub_reiserfs_key { grub_uint32_t directory_id; grub_uint32_t object_id; union { struct { grub_uint32_t offset; grub_uint32_t type; } 
# 155 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
__attribute__((__packed__)) 
# 155 "project/radare2/shlr/grub/fs/reiserfs.c"
v1; struct { grub_uint64_t offset_type; } 
# 155 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
__attribute__((__packed__)) 
# 155 "project/radare2/shlr/grub/fs/reiserfs.c"
v2; } u; } 
# 155 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
__attribute__((__packed__))
# 174 "project/radare2/shlr/grub/fs/reiserfs.c"
  ;


# 176 "project/radare2/shlr/grub/fs/reiserfs.c"
struct grub_reiserfs_item_header { struct grub_reiserfs_key key; union { grub_uint16_t free_space; grub_uint16_t entry_count; } 
# 176 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
__attribute__((__packed__)) 
# 176 "project/radare2/shlr/grub/fs/reiserfs.c"
u; grub_uint16_t item_size; grub_uint16_t item_location; grub_uint16_t version; } 
# 176 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
__attribute__((__packed__))
# 189 "project/radare2/shlr/grub/fs/reiserfs.c"
  ;


# 191 "project/radare2/shlr/grub/fs/reiserfs.c"
struct grub_reiserfs_block_header { grub_uint16_t level; grub_uint16_t item_count; grub_uint16_t free_space; grub_uint16_t reserved; struct grub_reiserfs_key block_right_delimiting_key; } 
# 191 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
__attribute__((__packed__))
...
# 199 "project/radare2/shlr/grub/fs/reiserfs.c"
 ;

struct grub_reiserfs_disk_child { grub_uint32_t block_number; grub_uint16_t size; grub_uint16_t reserved; } 
# 201 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
__attribute__((__packed__))
...
# 207 "project/radare2/shlr/grub/fs/reiserfs.c"
 ;

struct grub_reiserfs_directory_header { grub_uint32_t offset; grub_uint32_t directory_id; grub_uint32_t object_id; grub_uint16_t location; grub_uint16_t state; } 
# 209 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
__attribute__((__packed__))
...
# 217 "project/radare2/shlr/grub/fs/reiserfs.c"
 ;
...
# 242 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                        ((grub_uint64_t) (
# 242 "project/radare2/shlr/grub/fs/reiserfs.c"
...
{
  switch (
# 263 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
         ((grub_uint32_t) (
# 263 "project/radare2/shlr/grub/fs/reiserfs.c"
         key->u.v1.type
# 263 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
         ))
# 263 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 341 "project/radare2/shlr/grub/fs/reiserfs.c"
static grub_uint64_t
grub_reiserfs_get_key_offset (const struct grub_reiserfs_key *key)
{
  if (grub_reiserfs_get_key_version (key) == 1)
    return 
# 345 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
          ((grub_uint32_t) (
# 345 "project/radare2/shlr/grub/fs/reiserfs.c"
          key->u.v1.offset
# 345 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
          ))
# 345 "project/radare2/shlr/grub/fs/reiserfs.c"
    ...
    return 
# 347 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
          ((grub_uint64_t) (
# 347 "project/radare2/shlr/grub/fs/reiserfs.c"
          key->u.v2.offset_type
# 347 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
          )) 
# 347 "project/radare2/shlr/grub/fs/reiserfs.c"
                              ...
                              grub_uint64_t value)
{
  if (grub_reiserfs_get_key_version (key) == 1)
    key->u.v1.offset = 
# 356 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                      ((grub_uint32_t) (
# 356 "project/radare2/shlr/grub/fs/reiserfs.c"
                      value
# 356 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                      ))
# 356 "project/radare2/shlr/grub/fs/reiserfs.c"
    ...
    key->u.v2.offset_type
      = ((key->u.v2.offset_type & 
# 359 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                                 ((grub_uint64_t) (
# 359 "project/radare2/shlr/grub/fs/reiserfs.c"
                                 15ULL << 60
# 359 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                                 ))
# 359 "project/radare2/shlr/grub/fs/reiserfs.c"
         ...
         | 
# 360 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
          ((grub_uint64_t) (
# 360 "project/radare2/shlr/grub/fs/reiserfs.c"
          value & (~0ULL >> 4)
# 360 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
          ))
# 360 "project/radare2/shlr/grub/fs/reiserfs.c"
                            ...
                            int version)
{
  ...
  if (version == 1)
    key->u.v1.type = 
# 403 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                    ((grub_uint32_t) (
# 403 "project/radare2/shlr/grub/fs/reiserfs.c"
                    type
# 403 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                    ))
# 403 "project/radare2/shlr/grub/fs/reiserfs.c"
    ...
    key->u.v2.offset_type
      = ((key->u.v2.offset_type & 
# 406 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                                 ((grub_uint64_t) (
# 406 "project/radare2/shlr/grub/fs/reiserfs.c"
                                 ~0ULL >> 4
# 406 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                                 ))
# 406 "project/radare2/shlr/grub/fs/reiserfs.c"
         ...
         | 
# 407 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
          ((grub_uint64_t) (
# 407 "project/radare2/shlr/grub/fs/reiserfs.c"
          (grub_uint64_t) type << 60
# 407 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
          ))
# 407 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                       );
...
# 409 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 do { if (!(
# 409 "project/radare2/shlr/grub/fs/reiserfs.c"
 grub_reiserfs_get_key_type (key) == grub_type
# 409 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 )) { r_assert_log (R_LOGLVL_WARN, "WARNING (%s:%d):%s%s runtime check failed: (%s)\n", "project/radare2/shlr/grub/fs/reiserfs.c", 409, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : "", 
# 409 "project/radare2/shlr/grub/fs/reiserfs.c"
 "grub_reiserfs_get_key_type (key) == grub_type"
# 409 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 ); } } while (0)
                            ...
                            const struct grub_reiserfs_key *key2)
{
  ...
  id1 = 
# 426 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ((grub_uint32_t) (
# 426 "project/radare2/shlr/grub/fs/reiserfs.c"
       key1->directory_id
# 426 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ))
# 426 "project/radare2/shlr/grub/fs/reiserfs.c"
                                            ;
  id2 = 
# 427 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ((grub_uint32_t) (
# 427 "project/radare2/shlr/grub/fs/reiserfs.c"
       key2->directory_id
# 427 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ))
# 427 "project/radare2/shlr/grub/fs/reiserfs.c"
  ...
  id1 = 
# 433 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ((grub_uint32_t) (
# 433 "project/radare2/shlr/grub/fs/reiserfs.c"
       key1->object_id
# 433 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ))
# 433 "project/radare2/shlr/grub/fs/reiserfs.c"
                                         ;
  id2 = 
# 434 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ((grub_uint32_t) (
# 434 "project/radare2/shlr/grub/fs/reiserfs.c"
       key2->object_id
# 434 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ))
# 434 "project/radare2/shlr/grub/fs/reiserfs.c"
                        ...
                        struct grub_fshelp_node *item)
{
  ...
  block_size = 
# 497 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
              ((grub_uint16_t) (
# 497 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 497 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                            ;
  block_number = 
# 498 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                ((grub_uint32_t) (
# 498 "project/radare2/shlr/grub/fs/reiserfs.c"
                data->superblock.root_block
# 498 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                ))
# 498 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                              ;
...
# 511 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                                                   9
# 511 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                                        ),
                      (((grub_off_t) block_number * block_size)
                       & (
# 513 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                         0x200 
# 513 "project/radare2/shlr/grub/fs/reiserfs.c"
                                               - 1)),
                      block_size, block_header);
      if (grub_errno)
        goto fail;
      current_level = 
# 517 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                     ((grub_uint16_t) (
# 517 "project/radare2/shlr/grub/fs/reiserfs.c"
                     block_header->level
# 517 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                     ))
# 517 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 518 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
     grub_real_dprintf("/tmp", 518, 
# 518 "project/radare2/shlr/grub/fs/reiserfs.c"
     "reiserfs_tree"
# 518 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
     , 
# 518 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 521 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
         grub_real_dprintf("/tmp", 521, 
# 521 "project/radare2/shlr/grub/fs/reiserfs.c"
         "reiserfs_tree"
# 521 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
         , 
# 521 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 521 "project/radare2/shlr/grub/fs/reiserfs.c"
      ...
      item_count = 
# 526 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                  ((grub_uint16_t) (
# 526 "project/radare2/shlr/grub/fs/reiserfs.c"
                  block_header->item_count
# 526 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                  ))
# 526 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                             ;
      
# 527 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
     grub_real_dprintf("/tmp", 527, 
# 527 "project/radare2/shlr/grub/fs/reiserfs.c"
     "reiserfs_tree"
# 527 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
     , 
# 527 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 528 "project/radare2/shlr/grub/fs/reiserfs.c"
                              ;
      if (current_level > 1)
        {
          ...
          block_number = 
# 549 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                        ((grub_uint32_t) (
# 549 "project/radare2/shlr/grub/fs/reiserfs.c"
                        children[i].block_number
# 549 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                        ))
# 549 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                                   ;
...
# 573 "project/radare2/shlr/grub/fs/reiserfs.c"
        }
      else
        {
          ...
          for (i = 0;
               ...
               i++)
            {
# 594 "project/radare2/shlr/grub/fs/reiserfs.c"
            }
          if (i < item_count)
...
# 617 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
     grub_memmove ((
# 617 "project/radare2/shlr/grub/fs/reiserfs.c"
     &(item->header)
# 617 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
     ), (
# 617 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 618 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                            ;
...
# 625 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 do { if (!(
# 625 "project/radare2/shlr/grub/fs/reiserfs.c"
 grub_errno == GRUB_ERR_NONE
# 625 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 )) { r_assert_log (R_LOGLVL_WARN, "WARNING (%s:%d):%s%s runtime check failed: (%s)\n", "project/radare2/shlr/grub/fs/reiserfs.c", 625, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : "", 
# 625 "project/radare2/shlr/grub/fs/reiserfs.c"
 "grub_errno == GRUB_ERR_NONE"
# 625 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 ); } } while (0)
...
# 630 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 do { if (!(
# 630 "project/radare2/shlr/grub/fs/reiserfs.c"
 grub_errno != GRUB_ERR_NONE
# 630 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 )) { r_assert_log (R_LOGLVL_WARN, "WARNING (%s:%d):%s%s runtime check failed: (%s)\n", "project/radare2/shlr/grub/fs/reiserfs.c", 630, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : "", 
# 630 "project/radare2/shlr/grub/fs/reiserfs.c"
 "grub_errno != GRUB_ERR_NONE"
# 630 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 ); } } while (0)
...
# 632 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 do { if (!(
# 632 "project/radare2/shlr/grub/fs/reiserfs.c"
 grub_errno != GRUB_ERR_NONE
# 632 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 )) { r_assert_log (R_LOGLVL_WARN, "WARNING (%s:%d):%s%s runtime check failed: (%s)\n", "project/radare2/shlr/grub/fs/reiserfs.c", 632, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : "", 
# 632 "project/radare2/shlr/grub/fs/reiserfs.c"
 "grub_errno != GRUB_ERR_NONE"
# 632 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 ); } } while (0)
...
# 648 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 grub_memmove ((
# 648 "project/radare2/shlr/grub/fs/reiserfs.c"
 &key
# 648 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 ), (
# 648 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 648 "project/radare2/shlr/grub/fs/reiserfs.c"
  ...
  block_size = 
# 659 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
              ((grub_uint16_t) (
# 659 "project/radare2/shlr/grub/fs/reiserfs.c"
              node->data->superblock.block_size
# 659 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
              ))
# 659 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                                  ;
  len = 
# 660 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ((grub_uint16_t) (
# 660 "project/radare2/shlr/grub/fs/reiserfs.c"
       found.header.item_size
# 660 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ))
# 660 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                ;
  block = (grub_disk_addr_t)found.block_number
    * ((grub_disk_addr_t)block_size >> 
# 662 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                                       9
# 662 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                            );
  offset = 
# 663 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
          ((grub_uint16_t) (
# 663 "project/radare2/shlr/grub/fs/reiserfs.c"
          found.header.item_location
# 663 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
          ))
# 663 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                       ;
...
grub_reiserfs_mount (grub_disk_t disk)
{
  ...
  if (! data)
    goto fail;
  grub_disk_read (disk, 0x10000 / 
# 689 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                                                     0x200
# 689 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                                          ,
                  0, sizeof (data->superblock), &(data->superblock));
  if (grub_errno)
    goto fail;
  if (grub_memcmp (data->superblock.magic_string,
                   "ReIsEr", sizeof ("ReIsEr") - 1))
    {
      ...
      void *closure)
{
  ...
  block_size = 
# 733 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
              ((grub_uint16_t) (
# 733 "project/radare2/shlr/grub/fs/reiserfs.c"
              data->superblock.block_size
# 733 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
              ))
# 733 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 739 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 grub_real_dprintf("/tmp", 739, 
# 739 "project/radare2/shlr/grub/fs/reiserfs.c"
 "reiserfs"
# 739 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 , 
# 739 "project/radare2/shlr/grub/fs/reiserfs.c"
  ...
  do
    {
      ...
      grub_disk_read (data->disk,
                      block_number * (block_size >> 
# 750 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                                                   9
# 750 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                                        ),
                      (((grub_off_t) block_number * block_size)
                       & (
# 752 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                         0x200 
# 752 "project/radare2/shlr/grub/fs/reiserfs.c"
                                               - 1)),
                      block_size, (char *) block_header);
      if (grub_errno)
        goto fail;
# 767 "project/radare2/shlr/grub/fs/reiserfs.c"
      item_headers = (struct grub_reiserfs_item_header *) (block_header + 1);
      directory_headers
        = ((struct grub_reiserfs_directory_header *)
           ((char *) block_header
            + 
# 771 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
             ((grub_uint16_t) (
# 771 "project/radare2/shlr/grub/fs/reiserfs.c"
             item_headers[block_position].item_location
# 771 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
             ))
# 771 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                                          ));
      entry_count
        = 
# 773 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
         ((grub_uint16_t) (
# 773 "project/radare2/shlr/grub/fs/reiserfs.c"
         item_headers[block_position].u.entry_count
# 773 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
         ))
# 773 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                                      ;
      for (entry_number = 0; entry_number < entry_count; entry_number++)
        {
          ...
          grub_uint16_t entry_state
            = 
# 779 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
             ((grub_uint16_t) (
# 779 "project/radare2/shlr/grub/fs/reiserfs.c"
             directory_header->state
# 779 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
             ))
# 779 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                       ;

          if (entry_state & ((grub_uint16_t) 0x04))
            {
       ...
       enum grub_fshelp_filetype entry_type;
              ...
              entry_name = (((char *) directory_headers)
                            + 
# 789 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                             ((grub_uint16_t) (
# 789 "project/radare2/shlr/grub/fs/reiserfs.c"
                             directory_header->location
# 789 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                             ))
# 789 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                                          );
                  ...
                  if (entry_item->block_number != 0)
                    {
                      ...
                      entry_version
                        = 
# 831 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                         ((grub_uint16_t) (
# 831 "project/radare2/shlr/grub/fs/reiserfs.c"
                         entry_item->header.version
# 831 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                         ))
# 831 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                                      ;
                      ...
                      if (entry_version == 0)
                        {
                          ...
                          grub_disk_read (data->disk,
                                          entry_block_number * (block_size >> 
# 844 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                                                                             9
# 844 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                                                                  ),
                                          
# 845 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                                         ((grub_uint16_t) (
# 845 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 845 "project/radare2/shlr/grub/fs/reiserfs.c"
                          ...
                          if (grub_errno)
                            goto fail;
# 876 "project/radare2/shlr/grub/fs/reiserfs.c"
                          if ((
# 876 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                              ((grub_uint16_t) (
# 876 "project/radare2/shlr/grub/fs/reiserfs.c"
                              entry_v1_stat.mode
# 876 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
...
# 876 "project/radare2/shlr/grub/fs/reiserfs.c"
                      ...
                      else
                        {
                          ...
                          grub_disk_read (data->disk,
                                          entry_block_number * (block_size >> 
# 886 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                                                                             9
# 886 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                                                                  ),
                                          
# 887 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                                         ((grub_uint16_t) (
# 887 "project/radare2/shlr/grub/fs/reiserfs.c"
                                         entry_item->header.item_location
# 887 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                                         ))
# 887 "project/radare2/shlr/grub/fs/reiserfs.c"
                          ...
                          if (grub_errno)
                            goto fail;
# 922 "project/radare2/shlr/grub/fs/reiserfs.c"
                          if ((
# 922 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                              ((grub_uint16_t) (
# 922 "project/radare2/shlr/grub/fs/reiserfs.c"
                              entry_v2_stat.mode
# 922 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
...
# 933 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                       grub_real_dprintf("/tmp", 933, 
# 933 "project/radare2/shlr/grub/fs/reiserfs.c"
                       "reiserfs"
# 933 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                       , 
# 933 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 935 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                ;
                      grub_free (entry_item);
                      continue;
                    }
...
# 942 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                 grub_real_dprintf("/tmp", 942, 
# 942 "project/radare2/shlr/grub/fs/reiserfs.c"
                 "reiserfs"
# 942 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                 , 
# 942 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 943 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                      ;
                  ret = 1;
                  goto found;
                }
...
# 969 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 do { if (!(
# 969 "project/radare2/shlr/grub/fs/reiserfs.c"
 grub_errno == GRUB_ERR_NONE
# 969 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 )) { r_assert_log (R_LOGLVL_WARN, "WARNING (%s:%d):%s%s runtime check failed: (%s)\n", "project/radare2/shlr/grub/fs/reiserfs.c", 969, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : "", 
# 969 "project/radare2/shlr/grub/fs/reiserfs.c"
 "grub_errno == GRUB_ERR_NONE"
# 969 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 ); } } while (0)
...
# 973 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 do { if (!(
# 973 "project/radare2/shlr/grub/fs/reiserfs.c"
 grub_errno != GRUB_ERR_NONE
# 973 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 )) { r_assert_log (R_LOGLVL_WARN, "WARNING (%s:%d):%s%s runtime check failed: (%s)\n", "project/radare2/shlr/grub/fs/reiserfs.c", 973, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : "", 
# 973 "project/radare2/shlr/grub/fs/reiserfs.c"
 "grub_errno != GRUB_ERR_NONE"
# 973 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 ); } } while (0)
...
grub_reiserfs_open (struct grub_file *file, const char *name)
{
  ...
  if (! data)
    goto fail;
  block_size = 
# 995 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
              ((grub_uint16_t) (
# 995 "project/radare2/shlr/grub/fs/reiserfs.c"
              data->superblock.block_size
# 995 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
              ))
# 995 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                            ;
  key.directory_id = 
# 996 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                    ((grub_uint32_t) (
# 996 "project/radare2/shlr/grub/fs/reiserfs.c"
                    1
# 996 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                    ))
# 996 "project/radare2/shlr/grub/fs/reiserfs.c"
                                        ;
  key.object_id = 
# 997 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                 ((grub_uint32_t) (
# 997 "project/radare2/shlr/grub/fs/reiserfs.c"
                 2
# 997 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                 ))
# 997 "project/radare2/shlr/grub/fs/reiserfs.c"
  ...
  entry_version = 
# 1024 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                 ((grub_uint16_t) (
# 1024 "project/radare2/shlr/grub/fs/reiserfs.c"
                 info.header.version
# 1024 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                 ))
# 1024 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                       ;
  entry_location = 
# 1025 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                  ((grub_uint16_t) (
# 1025 "project/radare2/shlr/grub/fs/reiserfs.c"
                  info.header.item_location
# 1025 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                  ))
# 1025 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                              ;
  ...
  if (entry_version == 0)
    {
      ...
      grub_disk_read (data->disk,
                      block_number * (block_size >> 
# 1031 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                                                   9
# 1031 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                                        ),
                      entry_location
                      + (((grub_off_t) block_number * block_size)
                         & (
# 1034 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                           0x200 
# 1034 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                 - 1)),
                      sizeof (entry_v1_stat), &entry_v1_stat);
      if (grub_errno)
        goto fail;
      file->size = (grub_off_t) 
# 1038 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                               ((grub_uint64_t) (
# 1038 "project/radare2/shlr/grub/fs/reiserfs.c"
                               entry_v1_stat.size
# 1038 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                               ))
# 1038 "project/radare2/shlr/grub/fs/reiserfs.c"
  ...
  else
    {
      ...
      grub_disk_read (data->disk,
                      block_number * (block_size >> 
# 1044 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                                                    9
# 1044 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                                         ),
                      entry_location
                      + (((grub_off_t) block_number * block_size)
                         & (
# 1047 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                           0x200 
# 1047 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                 - 1)),
                      sizeof (entry_v2_stat), &entry_v2_stat);
      if (grub_errno)
        goto fail;
      file->size = (grub_off_t) 
# 1051 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                               ((grub_uint64_t) (
# 1051 "project/radare2/shlr/grub/fs/reiserfs.c"
                               entry_v2_stat.size
# 1051 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                               ))
# 1051 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 1053 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 grub_real_dprintf("/tmp", 1053, 
# 1053 "project/radare2/shlr/grub/fs/reiserfs.c"
 "reiserfs"
# 1053 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 , 
# 1053 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 1053 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 , 
# 1053 "project/radare2/shlr/grub/fs/reiserfs.c"
 (unsigned int) file->size, (unsigned int) (file->size >> 32), (unsigned int) file->size
# 1053 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 )

                                                                             
# 1055 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                                            ;
  file->offset = 0;
  file->data = found;
  return GRUB_ERR_NONE;
...
# 1061 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 do { if (!(
# 1061 "project/radare2/shlr/grub/fs/reiserfs.c"
 grub_errno != GRUB_ERR_NONE
# 1061 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 )) { r_assert_log (R_LOGLVL_WARN, "WARNING (%s:%d):%s%s runtime check failed: (%s)\n", "project/radare2/shlr/grub/fs/reiserfs.c", 1061, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : "", 
# 1061 "project/radare2/shlr/grub/fs/reiserfs.c"
 "grub_errno != GRUB_ERR_NONE"
# 1061 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 ); } } while (0)
...
grub_reiserfs_read (grub_file_t file, char *buf, grub_size_t len)
{
  ...
  struct grub_fshelp_node found;
  grub_uint16_t block_size = 
# 1075 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                            ((grub_uint16_t) (
# 1075 "project/radare2/shlr/grub/fs/reiserfs.c"
                            data->superblock.block_size
# 1075 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                            ))
# 1075 "project/radare2/shlr/grub/fs/reiserfs.c"
  ...
  current_position = 0;
  final_position = ((len + initial_position) < (file->size) ? (len + initial_position) : (file->size));
  
# 1090 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 grub_real_dprintf("/tmp", 1090, 
# 1090 "project/radare2/shlr/grub/fs/reiserfs.c"
 "reiserfs"
# 1090 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 , 
# 1090 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 1090 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 , 
# 1090 "project/radare2/shlr/grub/fs/reiserfs.c"
 (unsigned long long) initial_position, (unsigned long long) final_position, (unsigned long long) (final_position - initial_position), (unsigned long) len
# 1090 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 )
...
# 1095 "project/radare2/shlr/grub/fs/reiserfs.c"
                     ;
  while (current_position < final_position)
    {
      ...
      if (found.block_number == 0)
        goto fail;
      item_size = 
# 1104 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                 ((grub_uint16_t) (
# 1104 "project/radare2/shlr/grub/fs/reiserfs.c"
                 found.header.item_size
# 1104 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                 ))
# 1104 "project/radare2/shlr/grub/fs/reiserfs.c"
      ...
      switch (found.type)
        ...
        case GRUB_REISERFS_DIRECT:
          block = (grub_disk_addr_t)found.block_number
      * ((grub_disk_addr_t)block_size >> 
# 1109 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                                         9
# 1109 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                              );
          
# 1110 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
         grub_real_dprintf("/tmp", 1110, 
# 1110 "project/radare2/shlr/grub/fs/reiserfs.c"
         "reiserfs_blocktype"
# 1110 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
         , 
# 1110 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 1110 "project/radare2/shlr/grub/fs/reiserfs.c"
          ...
          if (initial_position < current_position + item_size)
            {
              offset = (((signed) (initial_position - current_position)) > (0) ? ((signed) (initial_position - current_position)) : (0));
              length = (((item_size) < (final_position - current_position) ? (item_size) : (final_position - current_position))
                        - offset);
              
# 1116 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
             grub_real_dprintf("/tmp", 1116, 
# 1116 "project/radare2/shlr/grub/fs/reiserfs.c"
             "reiserfs"
# 1116 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
             , 
# 1116 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 1116 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
             , 
# 1116 "project/radare2/shlr/grub/fs/reiserfs.c"
             (unsigned) block, (unsigned) offset, (unsigned) (offset + length)
# 1116 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
             )


                                                         
# 1119 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                        ;
       ...
       found.data->disk->closure = file->closure;
              grub_disk_read (found.data->disk,
                              ...
                              offset
                              + 
# 1125 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                               ((grub_uint16_t) (
# 1125 "project/radare2/shlr/grub/fs/reiserfs.c"
                               found.header.item_location
# 1125 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                               ))
# 1125 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 1142 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                                                             9
# 1142 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                                                  ),
                          
# 1143 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                         ((grub_uint16_t) (
# 1143 "project/radare2/shlr/grub/fs/reiserfs.c"
                         found.header.item_location
# 1143 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                         ))
# 1143 "project/radare2/shlr/grub/fs/reiserfs.c"
          ...
          for (indirect_block = 0;
            ...
            {
              block = 
# 1153 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                     ((grub_uint32_t) (
# 1153 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 1153 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                                           *
                      (block_size >> 
# 1154 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                                    9
# 1154 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                         );
              
# 1155 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
             grub_real_dprintf("/tmp", 1155, 
# 1155 "project/radare2/shlr/grub/fs/reiserfs.c"
             "reiserfs_blocktype"
# 1155 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
             , 
# 1155 "project/radare2/shlr/grub/fs/reiserfs.c"
              ...
              if (current_position + block_size >= initial_position)
                {
                  offset = (((signed) (initial_position - current_position)) > (0) ? ((signed) (initial_position - current_position)) : (0))
                                  ;
                  length = (((block_size) < (final_position - current_position) ? (block_size) : (final_position - current_position))
                            - offset);
                  
# 1162 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                 grub_real_dprintf("/tmp", 1162, 
# 1162 "project/radare2/shlr/grub/fs/reiserfs.c"
                 "reiserfs"
# 1162 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                 , 
# 1162 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 1165 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                            ;
...
# 1192 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 grub_real_dprintf("/tmp", 1192, 
# 1192 "project/radare2/shlr/grub/fs/reiserfs.c"
 "reiserfs"
# 1192 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 , 
# 1192 "project/radare2/shlr/grub/fs/reiserfs.c"
...
# 1192 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 , 
# 1192 "project/radare2/shlr/grub/fs/reiserfs.c"
 (unsigned long long) (current_position - initial_position), (unsigned long) len
# 1192 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
 )


                      
# 1195 "project/radare2/shlr/grub/fs/reiserfs.c"
                     ;
  return current_position - initial_position;
# 1244 "project/radare2/shlr/grub/fs/reiserfs.c"
 fail:
  grub_free (indirect_block_ptr);
  return 0;
}
  ...
  void *closure)
{
  ...
  info.dir = ((filetype & 
# 1278 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                         0xff
# 1278 "project/radare2/shlr/grub/fs/reiserfs.c"
                                              ) == GRUB_FSHELP_DIR);
  grub_free (node);
     ...
     void *closure)
{
  ...
  if (! data)
    goto fail;
  root_key.directory_id = 
# 1299 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                         ((grub_uint32_t) (
# 1299 "project/radare2/shlr/grub/fs/reiserfs.c"
                         1
# 1299 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                         ))
# 1299 "project/radare2/shlr/grub/fs/reiserfs.c"
                                             ;
  root_key.object_id = 
# 1300 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                      ((grub_uint32_t) (
# 1300 "project/radare2/shlr/grub/fs/reiserfs.c"
                      2
# 1300 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                      ))
# 1300 "project/radare2/shlr/grub/fs/reiserfs.c"
...
{
  *label = grub_malloc (16);
  if (*label)
    {
      grub_disk_read (device->disk,
                      0x10000 / 
# 1336 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
                                                   0x200
# 1336 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                                        ,
                      0x64, 16,
                      *label);
    }
...
# 1353 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ({ grub_uint16_t _x = (
# 1353 "project/radare2/shlr/grub/fs/reiserfs.c"
       data->superblock.uuid[0]
# 1353 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 1353 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                  ,
        
# 1354 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ({ grub_uint16_t _x = (
# 1354 "project/radare2/shlr/grub/fs/reiserfs.c"
       data->superblock.uuid[1]
# 1354 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 1354 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                  ,
        
# 1355 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ({ grub_uint16_t _x = (
# 1355 "project/radare2/shlr/grub/fs/reiserfs.c"
       data->superblock.uuid[2]
# 1355 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 1355 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                  ,
        
# 1356 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ({ grub_uint16_t _x = (
# 1356 "project/radare2/shlr/grub/fs/reiserfs.c"
       data->superblock.uuid[3]
# 1356 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 1356 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                  ,
        
# 1357 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ({ grub_uint16_t _x = (
# 1357 "project/radare2/shlr/grub/fs/reiserfs.c"
       data->superblock.uuid[4]
# 1357 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 1357 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                  ,
        
# 1358 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ({ grub_uint16_t _x = (
# 1358 "project/radare2/shlr/grub/fs/reiserfs.c"
       data->superblock.uuid[5]
# 1358 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 1358 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                  ,
        
# 1359 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ({ grub_uint16_t _x = (
# 1359 "project/radare2/shlr/grub/fs/reiserfs.c"
       data->superblock.uuid[6]
# 1359 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 1359 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                  ,
        
# 1360 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ({ grub_uint16_t _x = (
# 1360 "project/radare2/shlr/grub/fs/reiserfs.c"
       data->superblock.uuid[7]
# 1360 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
       ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 1360 "project/radare2/shlr/grub/fs/reiserfs.c"
                                                  );
    ...
    *uuid = 
# 1363 "project/radare2/shlr/grub/fs/reiserfs.c" 3 4
           ((void *)0)
# 1363 "project/radare2/shlr/grub/fs/reiserfs.c"
               ;
