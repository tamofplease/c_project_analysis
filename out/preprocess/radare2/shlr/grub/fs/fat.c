# 0 "project/radare2/shlr/grub/fs/fat.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/grub/fs/fat.c"
# 20 "project/radare2/shlr/grub/fs/fat.c"
...
# 21 "project/radare2/shlr/grub/fs/fat.c" 2
...
# 22 "project/radare2/shlr/grub/fs/fat.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/fshelp.h" 1 3 4
# 26 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/fshelp.h" 3 4
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 27 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/fshelp.h" 2 3 4
...
unsigned int grub_fshelp_log2blksize (unsigned int blksize,
          unsigned int *pow);
# 23 "project/radare2/shlr/grub/fs/fat.c" 2
...
grub_ssize_t grub_file_pb_read (grub_file_t file, void *buf, grub_size_t len,
    int total);
# 25 "project/radare2/shlr/grub/fs/fat.c" 2
...
# 28 "project/radare2/shlr/grub/fs/fat.c" 2
...
# 52 "project/radare2/shlr/grub/fs/fat.c" 3 4
__attribute__((__packed__))
# 100 "project/radare2/shlr/grub/fs/fat.c"
  ;

# 101 "project/radare2/shlr/grub/fs/fat.c"
struct grub_fat_dir_entry { grub_uint8_t name[11]; grub_uint8_t attr; grub_uint8_t nt_reserved; grub_uint8_t c_time_tenth; grub_uint16_t c_time; grub_uint16_t c_date; grub_uint16_t a_date; grub_uint16_t first_cluster_high; grub_uint16_t w_time; grub_uint16_t w_date; grub_uint16_t first_cluster_low; grub_uint32_t file_size; } 
# 101 "project/radare2/shlr/grub/fs/fat.c" 3 4
__attribute__((__packed__))
# 116 "project/radare2/shlr/grub/fs/fat.c"
  ;


# 118 "project/radare2/shlr/grub/fs/fat.c"
struct grub_fat_long_name_entry { grub_uint8_t id; grub_uint16_t name1[5]; grub_uint8_t attr; grub_uint8_t reserved; grub_uint8_t checksum; grub_uint16_t name2[6]; grub_uint16_t first_cluster; grub_uint16_t name3[2]; } 
# 118 "project/radare2/shlr/grub/fs/fat.c" 3 4
__attribute__((__packed__))
# 129 "project/radare2/shlr/grub/fs/fat.c"
  ;


# 131 "project/radare2/shlr/grub/fs/fat.c"
...
grub_fat_mount (grub_disk_t disk)
{
  ...
  data->logical_sector_bits =
    fat_log2 (
# 200 "project/radare2/shlr/grub/fs/fat.c" 3 4
             ((grub_uint16_t) (
# 200 "project/radare2/shlr/grub/fs/fat.c"
             bpb.bytes_per_sector
# 200 "project/radare2/shlr/grub/fs/fat.c" 3 4
             ))
# 200 "project/radare2/shlr/grub/fs/fat.c"
                                                    );
  if (data->logical_sector_bits < 
# 201 "project/radare2/shlr/grub/fs/fat.c" 3 4
                                 9
# 201 "project/radare2/shlr/grub/fs/fat.c"
                                                      )
    goto fail;
  data->logical_sector_bits -= 
# 203 "project/radare2/shlr/grub/fs/fat.c" 3 4
                              9
# 203 "project/radare2/shlr/grub/fs/fat.c"
                                                   ;
  ...
  data->fat_sector = (
# 211 "project/radare2/shlr/grub/fs/fat.c" 3 4
                     ((grub_uint16_t) (
# 211 "project/radare2/shlr/grub/fs/fat.c"
                     bpb.num_reserved_sectors
# 211 "project/radare2/shlr/grub/fs/fat.c" 3 4
                     ))
        
# 212 "project/radare2/shlr/grub/fs/fat.c"
       << data->logical_sector_bits);
  ...
  data->sectors_per_fat = ((bpb.sectors_per_fat_16
       ? 
# 217 "project/radare2/shlr/grub/fs/fat.c" 3 4
        ((grub_uint16_t) (
# 217 "project/radare2/shlr/grub/fs/fat.c"
        bpb.sectors_per_fat_16
# 217 "project/radare2/shlr/grub/fs/fat.c" 3 4
        ))
       
# 218 "project/radare2/shlr/grub/fs/fat.c"
      : 
# 218 "project/radare2/shlr/grub/fs/fat.c" 3 4
        ((grub_uint32_t) (
# 218 "project/radare2/shlr/grub/fs/fat.c"
...
# 218 "project/radare2/shlr/grub/fs/fat.c"
  ...
  data->num_sectors = ((bpb.num_total_sectors_16
   ? 
# 225 "project/radare2/shlr/grub/fs/fat.c" 3 4
    ((grub_uint16_t) (
# 225 "project/radare2/shlr/grub/fs/fat.c"
    bpb.num_total_sectors_16
# 225 "project/radare2/shlr/grub/fs/fat.c" 3 4
    ))
   
# 226 "project/radare2/shlr/grub/fs/fat.c"
  : 
# 226 "project/radare2/shlr/grub/fs/fat.c" 3 4
    ((grub_uint32_t) (
# 226 "project/radare2/shlr/grub/fs/fat.c"
...
# 226 "project/radare2/shlr/grub/fs/fat.c"
  ...
  data->num_root_sectors
    = ((((grub_uint32_t) 
# 237 "project/radare2/shlr/grub/fs/fat.c" 3 4
                        ((grub_uint16_t) (
# 237 "project/radare2/shlr/grub/fs/fat.c"
                        bpb.num_root_entries
# 237 "project/radare2/shlr/grub/fs/fat.c" 3 4
                        ))
  
# 238 "project/radare2/shlr/grub/fs/fat.c"
 * 32
  + 
# 239 "project/radare2/shlr/grub/fs/fat.c" 3 4
   ((grub_uint16_t) (
# 239 "project/radare2/shlr/grub/fs/fat.c"
   bpb.bytes_per_sector
# 239 "project/radare2/shlr/grub/fs/fat.c" 3 4
   )) 
# 239 "project/radare2/shlr/grub/fs/fat.c"
                                           - 1)
 >> (data->logical_sector_bits + 
# 240 "project/radare2/shlr/grub/fs/fat.c" 3 4
                                9
# 240 "project/radare2/shlr/grub/fs/fat.c"
                                                     ))
       << (data->logical_sector_bits));
  ...
  if (! bpb.sectors_per_fat_16)
    {
      ...
      grub_uint16_t flags = 
# 254 "project/radare2/shlr/grub/fs/fat.c" 3 4
                           ((grub_uint16_t) (
# 254 "project/radare2/shlr/grub/fs/fat.c"
...
# 254 "project/radare2/shlr/grub/fs/fat.c"
      ...
      data->root_cluster = 
# 256 "project/radare2/shlr/grub/fs/fat.c" 3 4
                          ((grub_uint32_t) (
# 256 "project/radare2/shlr/grub/fs/fat.c"
...
# 256 "project/radare2/shlr/grub/fs/fat.c"
      ...
      else
 {
  ...
  first_fat = 
# 304 "project/radare2/shlr/grub/fs/fat.c" 3 4
             ((grub_uint32_t) (
# 304 "project/radare2/shlr/grub/fs/fat.c"
             first_fat
# 304 "project/radare2/shlr/grub/fs/fat.c" 3 4
             ))
# 304 "project/radare2/shlr/grub/fs/fat.c"
  ...
  if (bpb.sectors_per_fat_16)
    data->uuid = 
# 324 "project/radare2/shlr/grub/fs/fat.c" 3 4
                ((grub_uint32_t) (
# 324 "project/radare2/shlr/grub/fs/fat.c"
...
# 324 "project/radare2/shlr/grub/fs/fat.c"
    ...
    data->uuid = 
# 326 "project/radare2/shlr/grub/fs/fat.c" 3 4
                ((grub_uint32_t) (
# 326 "project/radare2/shlr/grub/fs/fat.c"
      ...
      grub_off_t offset, grub_size_t len, char *buf)
{
  ...
  if (data->file_cluster == ~0U)
    {
      size = (data->num_root_sectors << 
# 366 "project/radare2/shlr/grub/fs/fat.c" 3 4
                                       9
# 366 "project/radare2/shlr/grub/fs/fat.c"
                                                            ) - offset;
      if (size > len)
 size = len;
 ...
 return -1;
  ...
  logical_cluster_bits = (data->cluster_bits
     + data->logical_sector_bits
     + 
# 379 "project/radare2/shlr/grub/fs/fat.c" 3 4
      9
# 379 "project/radare2/shlr/grub/fs/fat.c"
                           );
      ...
      while (logical_cluster > data->cur_cluster_num)
 {
   ...
   next_cluster = 
# 417 "project/radare2/shlr/grub/fs/fat.c" 3 4
                 ((grub_uint32_t) (
# 417 "project/radare2/shlr/grub/fs/fat.c"
                 next_cluster
# 417 "project/radare2/shlr/grub/fs/fat.c" 3 4
                 ))
# 417 "project/radare2/shlr/grub/fs/fat.c"
...
# 431 "project/radare2/shlr/grub/fs/fat.c" 3 4
  grub_real_dprintf("/tmp", 431, 
# 431 "project/radare2/shlr/grub/fs/fat.c"
  "fat"
# 431 "project/radare2/shlr/grub/fs/fat.c" 3 4
  , 
# 431 "project/radare2/shlr/grub/fs/fat.c"
...
# 432 "project/radare2/shlr/grub/fs/fat.c"
                               ;
        ...
        void *closure)
{
 ...
 break;
      ...
      if (dir.attr == (0x01 | 0x02 | 0x04 | 0x08))
 {
...
# 535 "project/radare2/shlr/grub/fs/fat.c" 3 4
  grub_memmove ((
# 535 "project/radare2/shlr/grub/fs/fat.c"
  unibuf + slot * 13
# 535 "project/radare2/shlr/grub/fs/fat.c" 3 4
  ), (
# 535 "project/radare2/shlr/grub/fs/fat.c"
...
# 536 "project/radare2/shlr/grub/fs/fat.c" 3 4
  grub_memmove ((
# 536 "project/radare2/shlr/grub/fs/fat.c"
  unibuf + slot * 13 + 5
# 536 "project/radare2/shlr/grub/fs/fat.c" 3 4
  ), (
# 536 "project/radare2/shlr/grub/fs/fat.c"
...
# 537 "project/radare2/shlr/grub/fs/fat.c" 3 4
  grub_memmove ((
# 537 "project/radare2/shlr/grub/fs/fat.c"
  unibuf + slot * 13 + 11
# 537 "project/radare2/shlr/grub/fs/fat.c" 3 4
  ), (
# 537 "project/radare2/shlr/grub/fs/fat.c"
...
# 537 "project/radare2/shlr/grub/fs/fat.c"
   ...
   continue;
      ...
      if (!(grub_fshelp_view & R_FS_VIEW_DELETED)) {
        if (dir.name[0] == 0xe5 || (dir.attr & ~(0x01 | 0x02 | 0x04 | 0x10 | 0x20 | 0x08)))
   continue;
      }
      ...
      if (checksum != -1 && slot == 0)
 {
  ...
  unibuf[u] = 
# 563 "project/radare2/shlr/grub/fs/fat.c" 3 4
             ((grub_uint16_t) (
# 563 "project/radare2/shlr/grub/fs/fat.c"
             unibuf[u]
# 563 "project/radare2/shlr/grub/fs/fat.c" 3 4
             ))
# 563 "project/radare2/shlr/grub/fs/fat.c"
  ...
  if (grub_strcasecmp (c->dirname, filename) == 0)
    {
      ...
      data->attr = dir->attr;
      data->file_size = 
# 645 "project/radare2/shlr/grub/fs/fat.c" 3 4
                       ((grub_uint32_t) (
# 645 "project/radare2/shlr/grub/fs/fat.c"
                       dir->file_size
# 645 "project/radare2/shlr/grub/fs/fat.c" 3 4
                       ))
# 645 "project/radare2/shlr/grub/fs/fat.c"
                                                        ;
      data->file_cluster = ((
# 646 "project/radare2/shlr/grub/fs/fat.c" 3 4
                            ((grub_uint16_t) (
# 646 "project/radare2/shlr/grub/fs/fat.c"
...
# 646 "project/radare2/shlr/grub/fs/fat.c"
                                                                       << 16)
          | 
# 647 "project/radare2/shlr/grub/fs/fat.c" 3 4
           ((grub_uint16_t) (
# 647 "project/radare2/shlr/grub/fs/fat.c"
...
# 691 "project/radare2/shlr/grub/fs/fat.c" 3 4
     grub_memmove ((
# 691 "project/radare2/shlr/grub/fs/fat.c"
     dirname
# 691 "project/radare2/shlr/grub/fs/fat.c" 3 4
     ), (
# 691 "project/radare2/shlr/grub/fs/fat.c"
...
# 734 "project/radare2/shlr/grub/fs/fat.c" 3 4
 grub_memmove ((
# 734 "project/radare2/shlr/grub/fs/fat.c"
 dirname
# 734 "project/radare2/shlr/grub/fs/fat.c" 3 4
 ), (
# 734 "project/radare2/shlr/grub/fs/fat.c"
...
grub_fat_uuid (grub_device_t device, char **uuid)
{
  ...
  if (data)
    ...
    *uuid = 
# 862 "project/radare2/shlr/grub/fs/fat.c" 3 4
           ((void *)0)
# 862 "project/radare2/shlr/grub/fs/fat.c"
               ;
