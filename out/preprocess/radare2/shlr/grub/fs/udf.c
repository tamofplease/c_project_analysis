# 0 "project/radare2/shlr/grub/fs/udf.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/grub/fs/udf.c"
# 20 "project/radare2/shlr/grub/fs/udf.c"
...
# 21 "project/radare2/shlr/grub/fs/udf.c" 2
...
grub_ssize_t grub_file_pb_read (grub_file_t file, void *buf, grub_size_t len,
    int total);
# 22 "project/radare2/shlr/grub/fs/udf.c" 2
...
# 23 "project/radare2/shlr/grub/fs/udf.c" 2
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 25 "project/radare2/shlr/grub/fs/udf.c" 2
...
unsigned int grub_fshelp_log2blksize (unsigned int blksize,
          unsigned int *pow);
# 27 "project/radare2/shlr/grub/fs/udf.c" 2
...
# 28 "project/radare2/shlr/grub/fs/udf.c" 2
# 115 "project/radare2/shlr/grub/fs/udf.c"

# 115 "project/radare2/shlr/grub/fs/udf.c"
struct grub_udf_lb_addr { grub_uint32_t block_num; grub_uint16_t part_ref; } 
# 115 "project/radare2/shlr/grub/fs/udf.c" 3 4
...
# 120 "project/radare2/shlr/grub/fs/udf.c"
 ;

struct grub_udf_short_ad { grub_uint32_t length; grub_uint32_t position; } 
# 122 "project/radare2/shlr/grub/fs/udf.c" 3 4
__attribute__((__packed__))
...
# 127 "project/radare2/shlr/grub/fs/udf.c"
 ;

struct grub_udf_long_ad { grub_uint32_t length; struct grub_udf_lb_addr block; grub_uint8_t imp_use[6]; } 
# 129 "project/radare2/shlr/grub/fs/udf.c" 3 4
__attribute__((__packed__))
...
# 135 "project/radare2/shlr/grub/fs/udf.c"
 ;

struct grub_udf_extent_ad { grub_uint32_t length; grub_uint32_t start; } 
# 137 "project/radare2/shlr/grub/fs/udf.c" 3 4
__attribute__((__packed__))
...
# 142 "project/radare2/shlr/grub/fs/udf.c"
 ;

struct grub_udf_charspec { grub_uint8_t charset_type; grub_uint8_t charset_info[63]; } 
# 144 "project/radare2/shlr/grub/fs/udf.c" 3 4
__attribute__((__packed__))
...
# 149 "project/radare2/shlr/grub/fs/udf.c"
 ;

struct grub_udf_timestamp { grub_uint16_t type_and_timezone; grub_uint16_t year; grub_uint8_t month; grub_uint8_t day; grub_uint8_t hour; grub_uint8_t minute; grub_uint8_t second; grub_uint8_t centi_seconds; grub_uint8_t hundreds_of_micro_seconds; grub_uint8_t micro_seconds; } 
# 151 "project/radare2/shlr/grub/fs/udf.c" 3 4
__attribute__((__packed__))
# 164 "project/radare2/shlr/grub/fs/udf.c"
  ;


# 166 "project/radare2/shlr/grub/fs/udf.c"
struct grub_udf_regid { grub_uint8_t flags; grub_uint8_t ident[23]; grub_uint8_t ident_suffix[8]; } 
# 166 "project/radare2/shlr/grub/fs/udf.c" 3 4
__attribute__((__packed__))
...
# 172 "project/radare2/shlr/grub/fs/udf.c"
 ;
struct grub_udf_tag { grub_uint16_t tag_ident; grub_uint16_t desc_version; grub_uint8_t tag_checksum; grub_uint8_t reserved; grub_uint16_t tag_serial_number; grub_uint16_t desc_crc; grub_uint16_t desc_crc_length; grub_uint32_t tag_location; } 
# 173 "project/radare2/shlr/grub/fs/udf.c" 3 4
__attribute__((__packed__))
# 184 "project/radare2/shlr/grub/fs/udf.c"
  ;


# 186 "project/radare2/shlr/grub/fs/udf.c"
struct grub_udf_fileset { struct grub_udf_tag tag; struct grub_udf_timestamp datetime; grub_uint16_t interchange_level; grub_uint16_t max_interchange_level; grub_uint32_t charset_list; grub_uint32_t max_charset_list; grub_uint32_t fileset_num; grub_uint32_t fileset_desc_num; struct grub_udf_charspec vol_charset; grub_uint8_t vol_ident[128]; struct grub_udf_charspec fileset_charset; grub_uint8_t fileset_ident[32]; grub_uint8_t copyright_file_ident[32]; grub_uint8_t abstract_file_ident[32]; struct grub_udf_long_ad root_icb; struct grub_udf_regid domain_ident; struct grub_udf_long_ad next_ext; struct grub_udf_long_ad streamdir_icb; } 
# 186 "project/radare2/shlr/grub/fs/udf.c" 3 4
__attribute__((__packed__))
# 207 "project/radare2/shlr/grub/fs/udf.c"
  ;


# 209 "project/radare2/shlr/grub/fs/udf.c"
struct grub_udf_icbtag { grub_uint32_t prior_recorded_num_direct_entries; grub_uint16_t strategy_type; grub_uint16_t strategy_parameter; grub_uint16_t num_entries; grub_uint8_t reserved; grub_uint8_t file_type; struct grub_udf_lb_addr parent_idb; grub_uint16_t flags; } 
# 209 "project/radare2/shlr/grub/fs/udf.c" 3 4
__attribute__((__packed__))
# 220 "project/radare2/shlr/grub/fs/udf.c"
  ;


# 222 "project/radare2/shlr/grub/fs/udf.c"
struct grub_udf_file_ident { struct grub_udf_tag tag; grub_uint16_t version_num; grub_uint8_t characteristics; grub_uint8_t file_ident_length; struct grub_udf_long_ad icb; grub_uint16_t imp_use_length; } 
# 222 "project/radare2/shlr/grub/fs/udf.c" 3 4
__attribute__((__packed__))
# 231 "project/radare2/shlr/grub/fs/udf.c"
  ;


# 233 "project/radare2/shlr/grub/fs/udf.c"
struct grub_udf_file_entry { struct grub_udf_tag tag; struct grub_udf_icbtag icbtag; grub_uint32_t uid; grub_uint32_t gid; grub_uint32_t permissions; grub_uint16_t link_count; grub_uint8_t record_format; grub_uint8_t record_display_attr; grub_uint32_t record_length; grub_uint64_t file_size; grub_uint64_t blocks_recorded; struct grub_udf_timestamp access_time; struct grub_udf_timestamp modification_time; struct grub_udf_timestamp attr_time; grub_uint32_t checkpoint; struct grub_udf_long_ad extended_attr_idb; struct grub_udf_regid imp_ident; grub_uint64_t unique_id; grub_uint32_t ext_attr_length; grub_uint32_t alloc_descs_length; grub_uint8_t ext_attr[1872]; } 
# 233 "project/radare2/shlr/grub/fs/udf.c" 3 4
__attribute__((__packed__))
# 257 "project/radare2/shlr/grub/fs/udf.c"
  ;


# 259 "project/radare2/shlr/grub/fs/udf.c"
struct grub_udf_extended_file_entry { struct grub_udf_tag tag; struct grub_udf_icbtag icbtag; grub_uint32_t uid; grub_uint32_t gid; grub_uint32_t permissions; grub_uint16_t link_count; grub_uint8_t record_format; grub_uint8_t record_display_attr; grub_uint32_t record_length; grub_uint64_t file_size; grub_uint64_t object_size; grub_uint64_t blocks_recorded; struct grub_udf_timestamp access_time; struct grub_udf_timestamp modification_time; struct grub_udf_timestamp create_time; struct grub_udf_timestamp attr_time; grub_uint32_t checkpoint; grub_uint32_t reserved; struct grub_udf_long_ad extended_attr_icb; struct grub_udf_long_ad streamdir_icb; struct grub_udf_regid imp_ident; grub_uint64_t unique_id; grub_uint32_t ext_attr_length; grub_uint32_t alloc_descs_length; grub_uint8_t ext_attr[1832]; } 
# 259 "project/radare2/shlr/grub/fs/udf.c" 3 4
__attribute__((__packed__))
# 287 "project/radare2/shlr/grub/fs/udf.c"
  ;


# 289 "project/radare2/shlr/grub/fs/udf.c"
struct grub_udf_vrs { grub_uint8_t type; grub_uint8_t magic[5]; grub_uint8_t version; } 
# 289 "project/radare2/shlr/grub/fs/udf.c" 3 4
__attribute__((__packed__))
...
# 295 "project/radare2/shlr/grub/fs/udf.c"
 ;

struct grub_udf_avdp { struct grub_udf_tag tag; struct grub_udf_extent_ad vds; } 
# 297 "project/radare2/shlr/grub/fs/udf.c" 3 4
__attribute__((__packed__))
...
# 302 "project/radare2/shlr/grub/fs/udf.c"
 ;

struct grub_udf_pd { struct grub_udf_tag tag; grub_uint32_t seq_num; grub_uint16_t flags; grub_uint16_t part_num; struct grub_udf_regid contents; grub_uint8_t contents_use[128]; grub_uint32_t access_type; grub_uint32_t start; grub_uint32_t length; } 
# 304 "project/radare2/shlr/grub/fs/udf.c" 3 4
__attribute__((__packed__))
# 316 "project/radare2/shlr/grub/fs/udf.c"
  ;


# 318 "project/radare2/shlr/grub/fs/udf.c"
...
{
  part_ref = 
# 380 "project/radare2/shlr/grub/fs/udf.c" 3 4
            ((grub_uint16_t) (
# 380 "project/radare2/shlr/grub/fs/udf.c"
            part_ref
# 380 "project/radare2/shlr/grub/fs/udf.c" 3 4
            ))
# 380 "project/radare2/shlr/grub/fs/udf.c"
  ...
  return (
# 388 "project/radare2/shlr/grub/fs/udf.c" 3 4
         ((grub_uint32_t) (
# 388 "project/radare2/shlr/grub/fs/udf.c"
         data->pds[data->pms[part_ref]->type1.part_num].start
# 388 "project/radare2/shlr/grub/fs/udf.c" 3 4
         ))
          
# 389 "project/radare2/shlr/grub/fs/udf.c"
         + 
# 389 "project/radare2/shlr/grub/fs/udf.c" 3 4
           ((grub_uint32_t) (
# 389 "project/radare2/shlr/grub/fs/udf.c"
           block
# 389 "project/radare2/shlr/grub/fs/udf.c" 3 4
     ...
     struct grub_fshelp_node *node)
{
  ...
  if (grub_disk_read (data->disk, block << 2, 0,
        sizeof (struct grub_udf_file_entry),
        &node->fe))
    return grub_errno;

  if ((
# 411 "project/radare2/shlr/grub/fs/udf.c" 3 4
      ((grub_uint16_t) (
# 411 "project/radare2/shlr/grub/fs/udf.c"
      node->fe.tag.tag_ident
# 411 "project/radare2/shlr/grub/fs/udf.c" 3 4
      )) 
# 411 "project/radare2/shlr/grub/fs/udf.c"
                                   != 0x0105) &&
      (
# 412 "project/radare2/shlr/grub/fs/udf.c" 3 4
      ((grub_uint16_t) (
# 412 "project/radare2/shlr/grub/fs/udf.c"
      node->fe.tag.tag_ident
# 412 "project/radare2/shlr/grub/fs/udf.c" 3 4
      )) 
# 412 "project/radare2/shlr/grub/fs/udf.c"
...
grub_udf_read_block (grub_fshelp_node_t node, grub_disk_addr_t fileblock)
{
  ...
  if (
# 427 "project/radare2/shlr/grub/fs/udf.c" 3 4
     ((grub_uint16_t) (
# 427 "project/radare2/shlr/grub/fs/udf.c"
     node->fe.tag.tag_ident
# 427 "project/radare2/shlr/grub/fs/udf.c" 3 4
     )) 
# 427 "project/radare2/shlr/grub/fs/udf.c"
                                  == 0x0105)
    {
      ptr = (char *) &node->fe.ext_attr[0] + 
# 429 "project/radare2/shlr/grub/fs/udf.c" 3 4
                                            ((grub_uint32_t) (
# 429 "project/radare2/shlr/grub/fs/udf.c"
                                            node->fe.ext_attr_length
# 429 "project/radare2/shlr/grub/fs/udf.c" 3 4
                                            ))
# 429 "project/radare2/shlr/grub/fs/udf.c"
                                                                          ;
      len = 
# 430 "project/radare2/shlr/grub/fs/udf.c" 3 4
           ((grub_uint32_t) (
# 430 "project/radare2/shlr/grub/fs/udf.c"
           node->fe.alloc_descs_length
# 430 "project/radare2/shlr/grub/fs/udf.c" 3 4
           ))
# 430 "project/radare2/shlr/grub/fs/udf.c"
                                            ;
    ...
    {
      ptr = (char *) &node->efe.ext_attr[0] + 
# 434 "project/radare2/shlr/grub/fs/udf.c" 3 4
                                             ((grub_uint32_t) (
# 434 "project/radare2/shlr/grub/fs/udf.c"
                                             node->efe.ext_attr_length
# 434 "project/radare2/shlr/grub/fs/udf.c" 3 4
                                             ))
# 434 "project/radare2/shlr/grub/fs/udf.c"
                                                                            ;
      len = 
# 435 "project/radare2/shlr/grub/fs/udf.c" 3 4
           ((grub_uint32_t) (
# 435 "project/radare2/shlr/grub/fs/udf.c"
           node->efe.alloc_descs_length
# 435 "project/radare2/shlr/grub/fs/udf.c" 3 4
           ))
# 435 "project/radare2/shlr/grub/fs/udf.c"
                                             ;
  ...
  if ((
# 438 "project/radare2/shlr/grub/fs/udf.c" 3 4
      ((grub_uint16_t) (
# 438 "project/radare2/shlr/grub/fs/udf.c"
      node->fe.icbtag.flags
# 438 "project/radare2/shlr/grub/fs/udf.c" 3 4
      )) 
# 438 "project/radare2/shlr/grub/fs/udf.c"
                                  & 0x0007)
      == 0x0000)
    {
      ...
      filebytes = fileblock * 2048;
      while (len > 0)
 {
   if (filebytes < 
# 447 "project/radare2/shlr/grub/fs/udf.c" 3 4
                  ((grub_uint32_t) (
# 447 "project/radare2/shlr/grub/fs/udf.c"
                  ad->length
# 447 "project/radare2/shlr/grub/fs/udf.c" 3 4
                  ))
# 447 "project/radare2/shlr/grub/fs/udf.c"
     ...
     return ((
# 448 "project/radare2/shlr/grub/fs/udf.c" 3 4
             ((grub_uint32_t) (
# 448 "project/radare2/shlr/grub/fs/udf.c"
             ad->position
# 448 "project/radare2/shlr/grub/fs/udf.c" 3 4
             )) 
# 448 "project/radare2/shlr/grub/fs/udf.c"
   ...
   filebytes -= 
# 454 "project/radare2/shlr/grub/fs/udf.c" 3 4
               ((grub_uint32_t) (
# 454 "project/radare2/shlr/grub/fs/udf.c"
               ad->length
# 454 "project/radare2/shlr/grub/fs/udf.c" 3 4
               ))
# 454 "project/radare2/shlr/grub/fs/udf.c"
 ...
 {
   if (filebytes < 
# 467 "project/radare2/shlr/grub/fs/udf.c" 3 4
                  ((grub_uint32_t) (
# 467 "project/radare2/shlr/grub/fs/udf.c"
                  ad->length
# 467 "project/radare2/shlr/grub/fs/udf.c" 3 4
                  ))
# 467 "project/radare2/shlr/grub/fs/udf.c"
     ...
     return ((
# 468 "project/radare2/shlr/grub/fs/udf.c" 3 4
             ((grub_uint32_t) (
# 468 "project/radare2/shlr/grub/fs/udf.c"
             ad->block.block_num
# 468 "project/radare2/shlr/grub/fs/udf.c" 3 4
             )) 
# 468 "project/radare2/shlr/grub/fs/udf.c"
   ...
   filebytes -= 
# 474 "project/radare2/shlr/grub/fs/udf.c" 3 4
               ((grub_uint32_t) (
# 474 "project/radare2/shlr/grub/fs/udf.c"
               ad->length
# 474 "project/radare2/shlr/grub/fs/udf.c" 3 4
               ))
# 474 "project/radare2/shlr/grub/fs/udf.c"
...
{
  switch (
# 491 "project/radare2/shlr/grub/fs/udf.c" 3 4
         ((grub_uint16_t) (
# 491 "project/radare2/shlr/grub/fs/udf.c"
         node->fe.icbtag.flags
# 491 "project/radare2/shlr/grub/fs/udf.c" 3 4
         )) 
# 491 "project/radare2/shlr/grub/fs/udf.c"
 ...
 ptr = ((
# 497 "project/radare2/shlr/grub/fs/udf.c" 3 4
        ((grub_uint16_t) (
# 497 "project/radare2/shlr/grub/fs/udf.c"
        node->fe.tag.tag_ident
# 497 "project/radare2/shlr/grub/fs/udf.c" 3 4
        )) 
# 497 "project/radare2/shlr/grub/fs/udf.c"
        ...
        ((char *) &node->fe.ext_attr[0]
                + 
# 499 "project/radare2/shlr/grub/fs/udf.c" 3 4
                 ((grub_uint32_t) (
# 499 "project/radare2/shlr/grub/fs/udf.c"
                 node->fe.ext_attr_length
# 499 "project/radare2/shlr/grub/fs/udf.c" 3 4
                 ))
# 499 "project/radare2/shlr/grub/fs/udf.c"
        ...
        ((char *) &node->efe.ext_attr[0]
                + 
# 501 "project/radare2/shlr/grub/fs/udf.c" 3 4
                 ((grub_uint32_t) (
# 501 "project/radare2/shlr/grub/fs/udf.c"
                 node->efe.ext_attr_length
# 501 "project/radare2/shlr/grub/fs/udf.c" 3 4
                 ))
# 501 "project/radare2/shlr/grub/fs/udf.c"
...
# 503 "project/radare2/shlr/grub/fs/udf.c" 3 4
grub_memmove ((
# 503 "project/radare2/shlr/grub/fs/udf.c"
buf
# 503 "project/radare2/shlr/grub/fs/udf.c" 3 4
), (
# 503 "project/radare2/shlr/grub/fs/udf.c"
...
# 515 "project/radare2/shlr/grub/fs/udf.c" 3 4
                                ((grub_uint64_t) (
# 515 "project/radare2/shlr/grub/fs/udf.c"
                                node->fe.file_size
# 515 "project/radare2/shlr/grub/fs/udf.c" 3 4
                                ))
# 515 "project/radare2/shlr/grub/fs/udf.c"
...
grub_udf_mount (grub_disk_t disk)
{
  ...
  for (block = 16;; block++)
    {
      ...
      if (grub_disk_read (disk, block << 2, 0,
     sizeof (struct grub_udf_vrs), &vrs))
 {
   ...
   goto fail;
      ...
      if ((!grub_memcmp (vrs.magic, "NSR03", 5)) ||
   (!grub_memcmp (vrs.magic, "NSR02", 5)))
 break;

      if ((grub_memcmp (vrs.magic, "BEA01", 5)) &&
   (grub_memcmp (vrs.magic, "BOOT2", 5)) &&
   (grub_memcmp (vrs.magic, "CD001", 5)) &&
   (grub_memcmp (vrs.magic, "CDW02", 5)) &&
   (grub_memcmp (vrs.magic, "TEA01", 5)))
 {
   grub_error (GRUB_ERR_BAD_FS, "not an UDF filesystem");
   goto fail;
 }
  ...
  while (1)
    {
      ...
      if (grub_disk_read (disk, *sblklist << 2, 0,
     sizeof (struct grub_udf_avdp), &avdp))
 {
   ...
   goto fail;
      ...
      if (
# 575 "project/radare2/shlr/grub/fs/udf.c" 3 4
         ((grub_uint16_t) (
# 575 "project/radare2/shlr/grub/fs/udf.c"
         avdp.tag.tag_ident
# 575 "project/radare2/shlr/grub/fs/udf.c" 3 4
         )) 
# 575 "project/radare2/shlr/grub/fs/udf.c"
 ...
 {
   block = 
# 577 "project/radare2/shlr/grub/fs/udf.c" 3 4
          ((grub_uint32_t) (
# 577 "project/radare2/shlr/grub/fs/udf.c"
          avdp.vds.start
# 577 "project/radare2/shlr/grub/fs/udf.c" 3 4
          ))
# 577 "project/radare2/shlr/grub/fs/udf.c"
     ...
     sizeof (struct grub_udf_tag), &tag))
 {
   ...
   goto fail;
      ...
      tag.tag_ident = 
# 602 "project/radare2/shlr/grub/fs/udf.c" 3 4
                     ((grub_uint16_t) (
# 602 "project/radare2/shlr/grub/fs/udf.c"
                     tag.tag_ident
# 602 "project/radare2/shlr/grub/fs/udf.c" 3 4
                     ))
# 602 "project/radare2/shlr/grub/fs/udf.c"
                                        ;
      if (tag.tag_ident == 0x0005)
 {
   if (data->npd >= 2)
     {
      ...
      else if (tag.tag_ident == 0x0006)
 {
   ...
   if (data->npm + 
# 635 "project/radare2/shlr/grub/fs/udf.c" 3 4
                  ((grub_uint32_t) (
# 635 "project/radare2/shlr/grub/fs/udf.c"
                  data->lvd.num_part_maps
# 635 "project/radare2/shlr/grub/fs/udf.c" 3 4
                  )) 
# 635 "project/radare2/shlr/grub/fs/udf.c"
                                                > 6)
   ...
   for (k = 
# 642 "project/radare2/shlr/grub/fs/udf.c" 3 4
           ((grub_uint32_t) (
# 642 "project/radare2/shlr/grub/fs/udf.c"
           data->lvd.num_part_maps
# 642 "project/radare2/shlr/grub/fs/udf.c" 3 4
           ))
# 642 "project/radare2/shlr/grub/fs/udf.c"
...
# 652 "project/radare2/shlr/grub/fs/udf.c" 3 4
                                                ((grub_uint32_t) (
# 652 "project/radare2/shlr/grub/fs/udf.c"
                                                ppm->length
# 652 "project/radare2/shlr/grub/fs/udf.c" 3 4
                                                ))
# 652 "project/radare2/shlr/grub/fs/udf.c"
      ...
      if (j == data->npd)
 {
  ...
  if (
# 698 "project/radare2/shlr/grub/fs/udf.c" 3 4
     ((grub_uint16_t) (
# 698 "project/radare2/shlr/grub/fs/udf.c"
     root_fs.tag.tag_ident
# 698 "project/radare2/shlr/grub/fs/udf.c" 3 4
     )) 
# 698 "project/radare2/shlr/grub/fs/udf.c"
                                 != 0x0100)
...
# 730 "project/radare2/shlr/grub/fs/udf.c" 3 4
 grub_memmove ((
# 730 "project/radare2/shlr/grub/fs/udf.c"
 (char *) child
# 730 "project/radare2/shlr/grub/fs/udf.c" 3 4
 ), (
# 730 "project/radare2/shlr/grub/fs/udf.c"
...
# 731 "project/radare2/shlr/grub/fs/udf.c"
                                        ;
  ...
  while (offset < 
# 736 "project/radare2/shlr/grub/fs/udf.c" 3 4
                 ((grub_uint64_t) (
# 736 "project/radare2/shlr/grub/fs/udf.c"
                 dir->fe.file_size
# 736 "project/radare2/shlr/grub/fs/udf.c" 3 4
                 ))
# 736 "project/radare2/shlr/grub/fs/udf.c"
 ...
 return 0;
      ...
      if (
# 742 "project/radare2/shlr/grub/fs/udf.c" 3 4
         ((grub_uint16_t) (
# 742 "project/radare2/shlr/grub/fs/udf.c"
         dirent.tag.tag_ident
# 742 "project/radare2/shlr/grub/fs/udf.c" 3 4
         )) 
# 742 "project/radare2/shlr/grub/fs/udf.c"
                                    != 0x0101)
...
# 755 "project/radare2/shlr/grub/fs/udf.c" 3 4
                                 ((grub_uint16_t) (
# 755 "project/radare2/shlr/grub/fs/udf.c"
                                 dirent.imp_use_length
# 755 "project/radare2/shlr/grub/fs/udf.c" 3 4
                                 ))
# 755 "project/radare2/shlr/grub/fs/udf.c"
                                                            ;
      if (dirent.characteristics & 0x08)
 {
      ...
      else
 {
   ...
   type = ((dirent.characteristics & 0x02) ?
  ...
  void *closure)
{
  ...
  info.dir = ((filetype & 
# 832 "project/radare2/shlr/grub/fs/udf.c" 3 4
                         0xff
# 832 "project/radare2/shlr/grub/fs/udf.c"
                                              ) == GRUB_FSHELP_DIR);
  grub_free (node);
...
grub_udf_open (struct grub_file *file, const char *name)
{
  ...
  file->offset = 0;
  file->size = 
# 897 "project/radare2/shlr/grub/fs/udf.c" 3 4
              ((grub_uint64_t) (
# 897 "project/radare2/shlr/grub/fs/udf.c"
              foundnode->fe.file_size
# 897 "project/radare2/shlr/grub/fs/udf.c" 3 4
              ))
# 897 "project/radare2/shlr/grub/fs/udf.c"
                                           ;
