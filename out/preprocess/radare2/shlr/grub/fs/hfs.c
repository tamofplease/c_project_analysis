# 0 "project/radare2/shlr/grub/fs/hfs.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/grub/fs/hfs.c"
# 23 "project/radare2/shlr/grub/fs/hfs.c"
...
# 24 "project/radare2/shlr/grub/fs/hfs.c" 2
...
grub_ssize_t grub_file_pb_read (grub_file_t file, void *buf, grub_size_t len,
    int total);
# 25 "project/radare2/shlr/grub/fs/hfs.c" 2
...
# 26 "project/radare2/shlr/grub/fs/hfs.c" 2
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 28 "project/radare2/shlr/grub/fs/hfs.c" 2

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/hfs.h" 1 3 4
# 28 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/hfs.h" 3 4
...
struct grub_hfs_sblock { grub_uint16_t magic; grub_uint8_t unused[18]; grub_uint32_t blksz; grub_uint8_t unused2[4]; grub_uint16_t first_block; grub_uint8_t unused4[6]; grub_uint8_t volname[28]; grub_uint8_t unused5[52]; grub_uint64_t num_serial; grub_uint16_t embed_sig; struct grub_hfs_extent embed_extent; grub_uint8_t unused6[4]; grub_hfs_datarecord_t extent_recs; grub_uint32_t catalog_size; grub_hfs_datarecord_t catalog_recs; } __attribute__((__packed__))
# 65 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/hfs.h" 3 4
  ;
# 30 "project/radare2/shlr/grub/fs/hfs.c" 2
# 41 "project/radare2/shlr/grub/fs/hfs.c"
...
struct grub_hfs_node { grub_uint32_t next; grub_uint32_t prev; grub_uint8_t type; grub_uint8_t level; grub_uint16_t reccnt; grub_uint16_t unused; } 
# 58 "project/radare2/shlr/grub/fs/hfs.c" 3 4
__attribute__((__packed__))
# 67 "project/radare2/shlr/grub/fs/hfs.c"
  ;



# 70 "project/radare2/shlr/grub/fs/hfs.c"
struct grub_hfs_treeheader { grub_uint16_t tree_depth; grub_uint32_t root_node; grub_uint32_t leaves; grub_uint32_t first_leaf; grub_uint32_t last_leaf; grub_uint16_t node_size; grub_uint16_t key_size; grub_uint32_t nodes; grub_uint32_t free_nodes; grub_uint8_t unused[76]; } 
# 70 "project/radare2/shlr/grub/fs/hfs.c" 3 4
__attribute__((__packed__))
# 84 "project/radare2/shlr/grub/fs/hfs.c"
  ;



# 87 "project/radare2/shlr/grub/fs/hfs.c"
...
struct grub_hfs_catalog_key { grub_uint8_t unused; grub_uint32_t parent_dir; grub_uint8_t strlen; grub_uint8_t str[31]; } 
# 105 "project/radare2/shlr/grub/fs/hfs.c" 3 4
__attribute__((__packed__))
# 116 "project/radare2/shlr/grub/fs/hfs.c"
  ;
...
# 121 "project/radare2/shlr/grub/fs/hfs.c"
struct grub_hfs_extent_key { grub_uint8_t forktype; grub_uint32_t fileid; grub_uint16_t first_block; } 
# 121 "project/radare2/shlr/grub/fs/hfs.c" 3 4
__attribute__((__packed__))
# 130 "project/radare2/shlr/grub/fs/hfs.c"
  ;



# 133 "project/radare2/shlr/grub/fs/hfs.c"
struct grub_hfs_dirrec { grub_uint8_t type; grub_uint8_t unused[5]; grub_uint32_t dirid; } 
# 133 "project/radare2/shlr/grub/fs/hfs.c" 3 4
__attribute__((__packed__))
...
# 140 "project/radare2/shlr/grub/fs/hfs.c"
 ;


struct grub_hfs_filerec { grub_uint8_t type; grub_uint8_t unused[19]; grub_uint32_t fileid; grub_uint8_t unused2[2]; grub_uint32_t size; grub_uint8_t unused3[44]; grub_hfs_datarecord_t extents; } 
# 143 "project/radare2/shlr/grub/fs/hfs.c" 3 4
__attribute__((__packed__))
# 157 "project/radare2/shlr/grub/fs/hfs.c"
  ;




# 161 "project/radare2/shlr/grub/fs/hfs.c"
...
# 188 "project/radare2/shlr/grub/fs/hfs.c" 3 4
 grub_memmove ((
# 188 "project/radare2/shlr/grub/fs/hfs.c"
 dr
# 188 "project/radare2/shlr/grub/fs/hfs.c" 3 4
 ), (
# 188 "project/radare2/shlr/grub/fs/hfs.c"
...
# 188 "project/radare2/shlr/grub/fs/hfs.c"
  ...
  key.forktype = 0;
  key.fileid = 
# 191 "project/radare2/shlr/grub/fs/hfs.c" 3 4
              grub_swap_bytes32(
# 191 "project/radare2/shlr/grub/fs/hfs.c"
              file
# 191 "project/radare2/shlr/grub/fs/hfs.c" 3 4
              )
# 191 "project/radare2/shlr/grub/fs/hfs.c"
  ...
  if (cache && cache_file == file && block > cache_pos)
    {
      pos = cache_pos;
      key.first_block = 
# 196 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                       ({ grub_uint16_t _x = (
# 196 "project/radare2/shlr/grub/fs/hfs.c"
                       pos
# 196 "project/radare2/shlr/grub/fs/hfs.c" 3 4
...
# 197 "project/radare2/shlr/grub/fs/hfs.c" 3 4
     grub_memmove ((
# 197 "project/radare2/shlr/grub/fs/hfs.c"
     dr
# 197 "project/radare2/shlr/grub/fs/hfs.c" 3 4
     ), (
# 197 "project/radare2/shlr/grub/fs/hfs.c"
...
# 197 "project/radare2/shlr/grub/fs/hfs.c"
      ...
      for (i = 0; i < 3; i++)
 {
   ...
   if (
# 208 "project/radare2/shlr/grub/fs/hfs.c" 3 4
      ({ grub_uint16_t _x = (
# 208 "project/radare2/shlr/grub/fs/hfs.c"
      dr[i].count
# 208 "project/radare2/shlr/grub/fs/hfs.c" 3 4
      ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); }) 
# 208 "project/radare2/shlr/grub/fs/hfs.c"
     ...
     {
       int first = 
# 210 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                  ({ grub_uint16_t _x = (
# 210 "project/radare2/shlr/grub/fs/hfs.c"
                  dr[i].first_block
# 210 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                  ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 210 "project/radare2/shlr/grub/fs/hfs.c"
...
# 218 "project/radare2/shlr/grub/fs/hfs.c" 3 4
   grub_memmove ((
# 218 "project/radare2/shlr/grub/fs/hfs.c"
   cache_dr
# 218 "project/radare2/shlr/grub/fs/hfs.c" 3 4
   ), (
# 218 "project/radare2/shlr/grub/fs/hfs.c"
...
# 218 "project/radare2/shlr/grub/fs/hfs.c"
       ...
       return (
# 221 "project/radare2/shlr/grub/fs/hfs.c" 3 4
              ({ grub_uint16_t _x = (
# 221 "project/radare2/shlr/grub/fs/hfs.c"
              data->sblock.first_block
# 221 "project/radare2/shlr/grub/fs/hfs.c" 3 4
              ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
        
# 222 "project/radare2/shlr/grub/fs/hfs.c"
       + (first + block - pos) * (data->blksz >> 9));
     }


   pos += 
# 226 "project/radare2/shlr/grub/fs/hfs.c" 3 4
         ({ grub_uint16_t _x = (
# 226 "project/radare2/shlr/grub/fs/hfs.c"
         dr[i].count
# 226 "project/radare2/shlr/grub/fs/hfs.c" 3 4
         ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 226 "project/radare2/shlr/grub/fs/hfs.c"
      ...
      key.first_block = 
# 230 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                       ({ grub_uint16_t _x = (
# 230 "project/radare2/shlr/grub/fs/hfs.c"
                       pos
# 230 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                       ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 230 "project/radare2/shlr/grub/fs/hfs.c"
...
grub_hfs_mount (grub_disk_t disk)
{
  ...
  if (grub_disk_read (disk, 2, 0,
        sizeof (struct grub_hfs_sblock), &data->sblock))
    goto fail;


  if (
# 330 "project/radare2/shlr/grub/fs/hfs.c" 3 4
     ({ grub_uint16_t _x = (
# 330 "project/radare2/shlr/grub/fs/hfs.c"
     data->sblock.magic
# 330 "project/radare2/shlr/grub/fs/hfs.c" 3 4
     ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); }) 
# 330 "project/radare2/shlr/grub/fs/hfs.c"
...
# 333 "project/radare2/shlr/grub/fs/hfs.c" 3 4
     fprintf(__stderrp,
# 333 "project/radare2/shlr/grub/fs/hfs.c"
     "not an HFS filesystem %x vs %x\n", 
# 333 "project/radare2/shlr/grub/fs/hfs.c" 3 4
     0x4244
# 333 "project/radare2/shlr/grub/fs/hfs.c"
     , 
...
# 333 "project/radare2/shlr/grub/fs/hfs.c"
  ...
  if (
# 338 "project/radare2/shlr/grub/fs/hfs.c" 3 4
     ({ grub_uint16_t _x = (
# 338 "project/radare2/shlr/grub/fs/hfs.c"
     data->sblock.embed_sig
# 338 "project/radare2/shlr/grub/fs/hfs.c" 3 4
     ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); }) 
# 338 "project/radare2/shlr/grub/fs/hfs.c"
                                               == 0x482B)
...
# 341 "project/radare2/shlr/grub/fs/hfs.c" 3 4
     fprintf(__stderrp,
# 341 "project/radare2/shlr/grub/fs/hfs.c"
...
# 341 "project/radare2/shlr/grub/fs/hfs.c"
  ...
  data->blksz = 
# 345 "project/radare2/shlr/grub/fs/hfs.c" 3 4
               grub_swap_bytes32(
# 345 "project/radare2/shlr/grub/fs/hfs.c"
               data->sblock.blksz
# 345 "project/radare2/shlr/grub/fs/hfs.c" 3 4
               )
# 345 "project/radare2/shlr/grub/fs/hfs.c"
  ...
  first_block = ((
# 349 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                 ({ grub_uint16_t _x = (
# 349 "project/radare2/shlr/grub/fs/hfs.c"
                 data->sblock.extent_recs[0].first_block
# 349 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                 ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
    
# 350 "project/radare2/shlr/grub/fs/hfs.c"
   * (data->blksz >> 9))
   + 
# 351 "project/radare2/shlr/grub/fs/hfs.c" 3 4
    ({ grub_uint16_t _x = (
# 351 "project/radare2/shlr/grub/fs/hfs.c"
    data->sblock.first_block
# 351 "project/radare2/shlr/grub/fs/hfs.c" 3 4
    ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 351 "project/radare2/shlr/grub/fs/hfs.c"
  ...
  if (grub_disk_read (data->disk, first_block, 0,
    ...
    goto fail;
  data->ext_root = 
# 356 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                  grub_swap_bytes32(
# 356 "project/radare2/shlr/grub/fs/hfs.c"
                  treehead.head.root_node
# 356 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                  )
# 356 "project/radare2/shlr/grub/fs/hfs.c"
                                                            ;
  data->ext_size = 
# 357 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                  ({ grub_uint16_t _x = (
# 357 "project/radare2/shlr/grub/fs/hfs.c"
                  treehead.head.node_size
# 357 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                  ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 357 "project/radare2/shlr/grub/fs/hfs.c"
                                                            ;
  ...
  first_block = ((
# 360 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                 ({ grub_uint16_t _x = (
# 360 "project/radare2/shlr/grub/fs/hfs.c"
                 data->sblock.catalog_recs[0].first_block
# 360 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                 ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
    
# 361 "project/radare2/shlr/grub/fs/hfs.c"
   * (data->blksz >> 9))
   + 
# 362 "project/radare2/shlr/grub/fs/hfs.c" 3 4
    ({ grub_uint16_t _x = (
# 362 "project/radare2/shlr/grub/fs/hfs.c"
    data->sblock.first_block
# 362 "project/radare2/shlr/grub/fs/hfs.c" 3 4
    ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 362 "project/radare2/shlr/grub/fs/hfs.c"
  ...
  if (grub_disk_read (data->disk, first_block, 0,
    ...
    goto fail;
  data->cat_root = 
# 366 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                  grub_swap_bytes32(
# 366 "project/radare2/shlr/grub/fs/hfs.c"
                  treehead.head.root_node
# 366 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                  )
# 366 "project/radare2/shlr/grub/fs/hfs.c"
                                                            ;
  data->cat_size = 
# 367 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                  ({ grub_uint16_t _x = (
# 367 "project/radare2/shlr/grub/fs/hfs.c"
                  treehead.head.node_size
# 367 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                  ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 367 "project/radare2/shlr/grub/fs/hfs.c"
  ...
  key.parent_dir = 
# 371 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                  grub_swap_bytes32(
# 371 "project/radare2/shlr/grub/fs/hfs.c"
                  1
# 371 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                  )
# 371 "project/radare2/shlr/grub/fs/hfs.c"
...
# 379 "project/radare2/shlr/grub/fs/hfs.c" 3 4
     fprintf(__stderrp,
# 379 "project/radare2/shlr/grub/fs/hfs.c"
...
# 379 "project/radare2/shlr/grub/fs/hfs.c"
  ...
  data->rootdir = 
# 386 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                 grub_swap_bytes32(
# 386 "project/radare2/shlr/grub/fs/hfs.c"
                 dir.dirid
# 386 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                 )
# 386 "project/radare2/shlr/grub/fs/hfs.c"
        ...
        struct grub_hfs_catalog_key *k2)
{
  ...
  cmp = (
# 626 "project/radare2/shlr/grub/fs/hfs.c" 3 4
        grub_swap_bytes32(
# 626 "project/radare2/shlr/grub/fs/hfs.c"
        k1->parent_dir
# 626 "project/radare2/shlr/grub/fs/hfs.c" 3 4
        ) 
# 626 "project/radare2/shlr/grub/fs/hfs.c"
        ...
        struct grub_hfs_extent_key *k2)
{
  ...
  if (cmp == 0)
    cmp = 
# 649 "project/radare2/shlr/grub/fs/hfs.c" 3 4
         grub_swap_bytes32(
# 649 "project/radare2/shlr/grub/fs/hfs.c"
         k1->fileid
# 649 "project/radare2/shlr/grub/fs/hfs.c" 3 4
         ) 
# 649 "project/radare2/shlr/grub/fs/hfs.c"
...
# 649 "project/radare2/shlr/grub/fs/hfs.c"
  ...
  if (cmp == 0)
    cmp = (
# 651 "project/radare2/shlr/grub/fs/hfs.c" 3 4
          ({ grub_uint16_t _x = (
# 651 "project/radare2/shlr/grub/fs/hfs.c"
          k1->first_block
# 651 "project/radare2/shlr/grub/fs/hfs.c" 3 4
          ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
    
# 652 "project/radare2/shlr/grub/fs/hfs.c"
   - 
# 652 "project/radare2/shlr/grub/fs/hfs.c" 3 4
     ({ grub_uint16_t _x = (
# 652 "project/radare2/shlr/grub/fs/hfs.c"
     k2->first_block
# 652 "project/radare2/shlr/grub/fs/hfs.c" 3 4
...
# 677 "project/radare2/shlr/grub/fs/hfs.c"
if (nodesize != 512) {

# 678 "project/radare2/shlr/grub/fs/hfs.c" 3 4
fprintf(__stderrp,
# 678 "project/radare2/shlr/grub/fs/hfs.c"
"Unhandled nodesize %d != 512\n", nodesize
# 678 "project/radare2/shlr/grub/fs/hfs.c" 3 4
)
# 678 "project/radare2/shlr/grub/fs/hfs.c"
                                                   ;
...
# 701 "project/radare2/shlr/grub/fs/hfs.c"
  do
    {
      int i;
 ...
 return grub_errno;
      ...
      for (i = 0; i < 
# 726 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                     ({ grub_uint16_t _x = (
# 726 "project/radare2/shlr/grub/fs/hfs.c"
                     node.node.reccnt
# 726 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                     ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 726 "project/radare2/shlr/grub/fs/hfs.c"
                                                        ; i++)
 {
   ...
   struct pointer { grub_uint8_t keylen; grub_uint8_t key; } 
# 729 "project/radare2/shlr/grub/fs/hfs.c" 3 4
  __attribute__((__packed__))
...
# 734 "project/radare2/shlr/grub/fs/hfs.c"
     *pnt;
   pnt = (struct pointer *) (
# 735 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                            ({ grub_uint16_t _x = (
# 735 "project/radare2/shlr/grub/fs/hfs.c"
                            node.offsets[pos]
# 735 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                            ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
        
# 736 "project/radare2/shlr/grub/fs/hfs.c"
       + node.rawnode);
   ...
   struct grub_hfs_record rec =
     {
       ...
       nodesize - 
# 743 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                 ({ grub_uint16_t _x = (
# 743 "project/radare2/shlr/grub/fs/hfs.c"
                 node.offsets[pos]
# 743 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                 ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
       
# 744 "project/radare2/shlr/grub/fs/hfs.c"
      - pnt->keylen - 1
     };
   ...
   if (node_hook (&node.node, &rec, closure)) {
     ...
     return 0;
      ...
      idx = 
# 754 "project/radare2/shlr/grub/fs/hfs.c" 3 4
           grub_swap_bytes32(
# 754 "project/radare2/shlr/grub/fs/hfs.c"
           node.node.next
# 754 "project/radare2/shlr/grub/fs/hfs.c" 3 4
           )
# 754 "project/radare2/shlr/grub/fs/hfs.c"
  ...
  if (cmp <= 0)
    {
      ...
      c->found = 
# 790 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                grub_swap_bytes32(
# 790 "project/radare2/shlr/grub/fs/hfs.c"
                *node
# 790 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                )
# 790 "project/radare2/shlr/grub/fs/hfs.c"
...
# 805 "project/radare2/shlr/grub/fs/hfs.c" 3 4
  grub_memmove ((
# 805 "project/radare2/shlr/grub/fs/hfs.c"
  c->datar
# 805 "project/radare2/shlr/grub/fs/hfs.c" 3 4
  ), (
# 805 "project/radare2/shlr/grub/fs/hfs.c"
...
# 806 "project/radare2/shlr/grub/fs/hfs.c"
                                                              ;
   return 1;
 }
    }
     ...
     void *closure)
{
  ...
  if (grub_hfs_cmp_catkeys (rec->key, (void *) c->key) <= 0)
    c->found = 
# 869 "project/radare2/shlr/grub/fs/hfs.c" 3 4
              grub_swap_bytes32(
# 869 "project/radare2/shlr/grub/fs/hfs.c"
              *(grub_uint32_t *) rec->data
# 869 "project/radare2/shlr/grub/fs/hfs.c" 3 4
              )
# 869 "project/radare2/shlr/grub/fs/hfs.c"
                                                             ;
  ...
  if (hnd->type == 0xFF && ckey->strlen > 0)
    {
      c->isleaf = 1;
      c->next = 
# 874 "project/radare2/shlr/grub/fs/hfs.c" 3 4
               grub_swap_bytes32(
# 874 "project/radare2/shlr/grub/fs/hfs.c"
               hnd->next
# 874 "project/radare2/shlr/grub/fs/hfs.c" 3 4
               )
# 874 "project/radare2/shlr/grub/fs/hfs.c"
      ...
      if (
# 877 "project/radare2/shlr/grub/fs/hfs.c" 3 4
         grub_swap_bytes32(
# 877 "project/radare2/shlr/grub/fs/hfs.c"
         ckey->parent_dir
# 877 "project/radare2/shlr/grub/fs/hfs.c" 3 4
         ) 
# 877 "project/radare2/shlr/grub/fs/hfs.c"
        ...
        void *closure)
{
  ...
  if (
# 894 "project/radare2/shlr/grub/fs/hfs.c" 3 4
     grub_swap_bytes32(
# 894 "project/radare2/shlr/grub/fs/hfs.c"
     ckey->parent_dir
# 894 "project/radare2/shlr/grub/fs/hfs.c" 3 4
     )
      
# 895 "project/radare2/shlr/grub/fs/hfs.c"
     != 
# 895 "project/radare2/shlr/grub/fs/hfs.c" 3 4
        grub_swap_bytes32(
# 895 "project/radare2/shlr/grub/fs/hfs.c"
        (origkey)->parent_dir
# 895 "project/radare2/shlr/grub/fs/hfs.c" 3 4
        ...
        void *closure)
{
  ...
  struct grub_hfs_catalog_key key = {0, 
# 911 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                                       grub_swap_bytes32(
# 911 "project/radare2/shlr/grub/fs/hfs.c"
                                       dir
# 911 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                                       )
# 911 "project/radare2/shlr/grub/fs/hfs.c"
      ...
      if (next)
 {
   while (*next == '/')
     *(next++) = '\0';
      ...
      key.parent_dir = 
# 990 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                      grub_swap_bytes32(
# 990 "project/radare2/shlr/grub/fs/hfs.c"
                      inode
# 990 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                      )
# 990 "project/radare2/shlr/grub/fs/hfs.c"
 ...
 goto fail;
      ...
      inode = 
# 1005 "project/radare2/shlr/grub/fs/hfs.c" 3 4
             grub_swap_bytes32(
# 1005 "project/radare2/shlr/grub/fs/hfs.c"
             fdrec.dir.dirid
# 1005 "project/radare2/shlr/grub/fs/hfs.c" 3 4
             )
# 1005 "project/radare2/shlr/grub/fs/hfs.c"
...
# 1010 "project/radare2/shlr/grub/fs/hfs.c" 3 4
   grub_memmove ((
# 1010 "project/radare2/shlr/grub/fs/hfs.c"
   retdata
# 1010 "project/radare2/shlr/grub/fs/hfs.c" 3 4
   ), (
# 1010 "project/radare2/shlr/grub/fs/hfs.c"
...
# 1107 "project/radare2/shlr/grub/fs/hfs.c" 3 4
 grub_memmove ((
# 1107 "project/radare2/shlr/grub/fs/hfs.c"
 data->extents
# 1107 "project/radare2/shlr/grub/fs/hfs.c" 3 4
 ), (
# 1107 "project/radare2/shlr/grub/fs/hfs.c"
...
# 1107 "project/radare2/shlr/grub/fs/hfs.c"
                                                                          ;
  file->size = 
# 1108 "project/radare2/shlr/grub/fs/hfs.c" 3 4
              grub_swap_bytes32(
# 1108 "project/radare2/shlr/grub/fs/hfs.c"
              frec.size
# 1108 "project/radare2/shlr/grub/fs/hfs.c" 3 4
              )
# 1108 "project/radare2/shlr/grub/fs/hfs.c"
                                          ;
  data->size = 
# 1109 "project/radare2/shlr/grub/fs/hfs.c" 3 4
              grub_swap_bytes32(
# 1109 "project/radare2/shlr/grub/fs/hfs.c"
              frec.size
# 1109 "project/radare2/shlr/grub/fs/hfs.c" 3 4
              )
# 1109 "project/radare2/shlr/grub/fs/hfs.c"
                                          ;
  data->fileid = 
# 1110 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                grub_swap_bytes32(
# 1110 "project/radare2/shlr/grub/fs/hfs.c"
                frec.fileid
# 1110 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                )
# 1110 "project/radare2/shlr/grub/fs/hfs.c"
...
grub_hfs_uuid (grub_device_t device, char **uuid)
{
  ...
  if (data && data->sblock.num_serial != 0)
    {
      *uuid = grub_xasprintf ("%016"
# 1163 "project/radare2/shlr/grub/fs/hfs.c" 3 4
                                   "llx"
# 1163 "project/radare2/shlr/grub/fs/hfs.c"
                                          ,
        (unsigned long long)
        
# 1165 "project/radare2/shlr/grub/fs/hfs.c" 3 4
       grub_swap_bytes64(
# 1165 "project/radare2/shlr/grub/fs/hfs.c"
       data->sblock.num_serial
# 1165 "project/radare2/shlr/grub/fs/hfs.c" 3 4
       )
# 1165 "project/radare2/shlr/grub/fs/hfs.c"
                                                 );
    ...
    *uuid = 
# 1168 "project/radare2/shlr/grub/fs/hfs.c" 3 4
           ((void *)0)
# 1168 "project/radare2/shlr/grub/fs/hfs.c"
               ;
