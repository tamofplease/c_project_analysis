# 0 "project/radare2/shlr/grub/fs/fshelp.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 21 "project/radare2/shlr/grub/fs/fshelp.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/mm.h" 1 3 4
# 23 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/mm.h" 3 4
...
# 22 "project/radare2/shlr/grub/fs/fshelp.c" 2
...
void grub_halt (void);
# 23 "project/radare2/shlr/grub/fs/fshelp.c" 2
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 24 "project/radare2/shlr/grub/fs/fshelp.c" 2
...
unsigned int grub_fshelp_log2blksize (unsigned int blksize,
          unsigned int *pow);
# 25 "project/radare2/shlr/grub/fs/fshelp.c" 2



# 27 "project/radare2/shlr/grub/fs/fshelp.c"
                            ;
;
;
;
  ...
  void *closure)
{
  ...
  if (filetype == GRUB_FSHELP_UNKNOWN ||
      (grub_strcmp (c->name, filename) &&
       (! (filetype & 
# 75 "project/radare2/shlr/grub/fs/fshelp.c" 3 4
                     0x100
# 75 "project/radare2/shlr/grub/fs/fshelp.c"
                                                 ) ||
 grub_strncasecmp (c->name, filename, 
# 76 "project/radare2/shlr/grub/fs/fshelp.c" 3 4
                                     2147483647L
# 76 "project/radare2/shlr/grub/fs/fshelp.c"
                                                  ))))
    {
      grub_free (node);
      return 0;
  ...
  *(c->type) = filetype & ~
# 83 "project/radare2/shlr/grub/fs/fshelp.c" 3 4
                          0x100
# 83 "project/radare2/shlr/grub/fs/fshelp.c"
                                                      ;
         ...
         grub_off_t filesize, int log2blocksize)
{
  ...
  int blocksize = 1 << (log2blocksize + 
# 290 "project/radare2/shlr/grub/fs/fshelp.c" 3 4
                                       9
# 290 "project/radare2/shlr/grub/fs/fshelp.c"
                                                            );
  ...
  blockcnt = ((len + pos) + blocksize - 1) >>
    (log2blocksize + 
# 301 "project/radare2/shlr/grub/fs/fshelp.c" 3 4
                    9
# 301 "project/radare2/shlr/grub/fs/fshelp.c"
                                         );

  for (i = pos >> (log2blocksize + 
# 303 "project/radare2/shlr/grub/fs/fshelp.c" 3 4
                                  9
# 303 "project/radare2/shlr/grub/fs/fshelp.c"
                                                       ); i < blockcnt; i++)
    {
      ...
      if (i == blockcnt - 1)
 {
   ...
   if (! blockend)
     blockend = blocksize;
      ...
      if (i == (pos >> (log2blocksize + 
# 328 "project/radare2/shlr/grub/fs/fshelp.c" 3 4
                                       9
# 328 "project/radare2/shlr/grub/fs/fshelp.c"
                                                            )))
 {
   skipfirst = blockoff;
   blockend -= skipfirst;
