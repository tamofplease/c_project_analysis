# 0 "project/radare2/shlr/gdb/src/gdbclient/core.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 12 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/gdbclient/responses.h" 3 4
...
# 13 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/gdbclient/responses.h" 2 3 4
...
# 4 "project/radare2/shlr/gdb/src/gdbclient/core.c" 2
...
# 5 "project/radare2/shlr/gdb/src/gdbclient/core.c" 2
...
# 6 "project/radare2/shlr/gdb/src/gdbclient/core.c" 2
...
# 7 "project/radare2/shlr/gdb/src/gdbclient/core.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/qnx/include/arch.h" 1 3 4
# 8 "project/radare2/shlr/gdb/src/gdbclient/core.c" 2
...
# 10 "project/radare2/shlr/gdb/src/gdbclient/core.c" 2
...
# 11 "project/radare2/shlr/gdb/src/gdbclient/core.c" 2
...
# 14 "project/radare2/shlr/gdb/src/gdbclient/core.c" 2


# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/errno.h" 1 3 4
# 17 "project/radare2/shlr/gdb/src/gdbclient/core.c" 2
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/fcntl.h" 1 3 4
# 18 "project/radare2/shlr/gdb/src/gdbclient/core.c" 2
# 30 "project/radare2/shlr/gdb/src/gdbclient/core.c"

# 30 "project/radare2/shlr/gdb/src/gdbclient/core.c"
extern char hex2char (char *hex);
# 73 "project/radare2/shlr/gdb/src/gdbclient/core.c"
static struct {
 
# 74 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
unsigned char 
# 74 "project/radare2/shlr/gdb/src/gdbclient/core.c"
    *buf;
 
# 75 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
unsigned long long 
# 75 "project/radare2/shlr/gdb/src/gdbclient/core.c"
     buflen, maxlen;
 
# 76 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
_Bool 
# 76 "project/radare2/shlr/gdb/src/gdbclient/core.c"
     valid, init;
} reg_cache;
...
static void reg_cache_init(libgdbr_t *g) {
 ...
 reg_cache.buflen = 0;
 reg_cache.valid = 
# 82 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  0
# 82 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                       ;
 reg_cache.init = 
# 83 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                 0
# 83 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                      ;
 if ((reg_cache.buf = malloc (reg_cache.maxlen))) {
  reg_cache.init = 
# 85 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  1
# 85 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                      ;
 }
}
...
static void gdbr_break_process(void *arg) {
 ...
 (void)g;
 g->isbreaked = 
# 92 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
               1
# 92 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                   ;
}


# 95 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
_Bool 
# 95 "project/radare2/shlr/gdb/src/gdbclient/core.c"
    gdbr_lock_tryenter(libgdbr_t *g) {
 if (!r_th_lock_tryenter (g->gdbr_lock)) {
  return 
# 97 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
        0
# 97 "project/radare2/shlr/gdb/src/gdbclient/core.c"
             ;
 }
 g->gdbr_lock_depth++;
 r_cons_break_push (gdbr_break_process, g);
 return 
# 101 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       1
# 101 "project/radare2/shlr/gdb/src/gdbclient/core.c"
           ;
}


# 104 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
_Bool 
# 104 "project/radare2/shlr/gdb/src/gdbclient/core.c"
    gdbr_lock_enter(libgdbr_t *g) {
 r_cons_break_push (gdbr_break_process, g);
 ...
 if (g->isbreaked) {
  return 
# 111 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
        0
# 111 "project/radare2/shlr/gdb/src/gdbclient/core.c"
             ;
 }
 return 
# 113 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       1
# 113 "project/radare2/shlr/gdb/src/gdbclient/core.c"
           ;
}
...
# 121 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
_Bool 
# 121 "project/radare2/shlr/gdb/src/gdbclient/core.c"
     last_leave = g->gdbr_lock_depth == 1;
 g->gdbr_lock_depth--;
 r_th_lock_leave (g->gdbr_lock);

 if (last_leave) {
  g->isbreaked = 
# 126 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                0
# 126 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                     ;
 }
}
...
static int gdbr_connect_lldb(libgdbr_t *g) {
 ...
 if (send_msg (g, "g") < 0 || read_packet (g, 
# 140 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                             0
# 140 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                                  ) < 0 || send_ack (g) < 0) {
  ret = -1;
  goto end;
 }
...
# 148 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                          1
# 148 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                              ;
...
int gdbr_connect(libgdbr_t *g, const char *host, int port) {
 ...
 int ret = -1;
 void *bed = 
# 160 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
            ((void *)0)
# 160 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                ;
...
# 171 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
unsigned int 
# 171 "project/radare2/shlr/gdb/src/gdbclient/core.c"
     env_pktsz = 0;
 if ((env_pktsz_str = r_sys_getenv ("R2_GDB_PKTSZ"))) {
  if ((env_pktsz = (
# 173 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                   unsigned int
# 173 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                       )strtoul (env_pktsz_str, 
# 173 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                                ((void *)0)
# 173 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                                    , 10))) {
   g->stub_features.pkt_sz = 
# 174 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                            (((
# 174 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                            env_pktsz
# 174 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                            )>(4))?(
# 174 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 174 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 if (*host == '/') {
  ...
  ret = 
# 183 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       r_socket_connect (
# 183 "project/radare2/shlr/gdb/src/gdbclient/core.c"
       g->sock
# 183 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       , 
# 183 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 183 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 read_packet (g, 
# 194 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                1
# 194 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                    );
 g->connected = 1;
 bed = r_cons_sleep_begin ();

 for (i = 0; i < 5 && !g->isbreaked; i++) {
  ret = send_msg (g, message);
  if (ret < 0) {
   continue;
  }
  ret = read_packet (g, 
# 203 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                       0
# 203 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                            );
  if (ret < 0) {
   continue;
  }
 ...
 if (g->isbreaked) {
  g->isbreaked = 
# 215 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                0
# 215 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                     ;
  ret = -1;
  goto end;
 }
 ...
 if (env_pktsz > 0) {
  g->stub_features.pkt_sz = 
# 223 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                           ((((((
# 223 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                           env_pktsz
# 223 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                           )>(
# 223 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 223 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 if (g->stub_features.QStartNoAckMode) {
  ...
  read_packet (g, 
# 230 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                 0
# 230 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                      );
  if (!strncmp (g->data, "OK", 2)) {

   send_ack (g);
   g->no_ack = 
# 234 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
              1
# 234 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                  ;
  }
 }
 if (g->remote_type == 
# 237 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                      1
# 237 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                          ) {
 ...
 g->stub_features.qC = 
# 243 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                      1
# 243 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                          ;
 g->pid = g->tid = 0;
 ...
 read_packet (g, 
# 248 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                0
# 248 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                     );
 if ((ret = handle_qC (g)) < 0) {
  g->stub_features.qC = 
# 250 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                       0
# 250 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                            ;
 }
 ...
 read_packet (g, 
# 262 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                0
# 262 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                     );
 ret = send_ack (g);
 if (ret < 0) {
  goto end;
...
int gdbr_disconnect(libgdbr_t *g) {
 ...
 reg_cache.valid = 
# 292 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  0
# 292 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                       ;
 g->stop_reason.is_valid = 
# 293 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                          0
# 293 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                               ;
 free (reg_cache.buf);
 if (g->target.valid) {
...
int gdbr_select(libgdbr_t *g, int pid, int tid) {
 ...
 reg_cache.valid = 
# 312 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  0
# 312 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                       ;
 g->pid = pid;
 g->tid = tid;
 
# 315 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
__builtin___strcpy_chk (
# 315 "project/radare2/shlr/gdb/src/gdbclient/core.c"
cmd
# 315 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
, 
# 315 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 315 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 g->stop_reason.is_valid = 
# 320 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                          0
# 320 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                               ;
 if (send_msg (g, cmd) < 0 || read_packet (g, 
# 321 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                             0
# 321 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                                  ) < 0 || send_ack (g) < 0) {
  ret = -1;
  goto end;
 }
...
int gdbr_check_vcont(libgdbr_t *g) {
 int ret = -1;
 char *ptr = 
# 338 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
            ((void *)0)
# 338 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                ;
 ...
 if (send_msg (g, "vCont?") < 0 || read_packet (g, 
# 347 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                                  0
# 347 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                                       ) < 0 || send_ack (g) < 0) {
  ret = -1;
  goto end;
 }
...
# 352 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                   0
# 352 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                        ;
  ret = 0;
  goto end;
 }
...
# 364 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                             1
# 364 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                 ;
   break;
  case 'S':
   g->stub_features.vcont.S = 
# 367 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                             1
# 367 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                 ;
   break;
  case 'c':
   g->stub_features.vcont.c = 
# 370 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                             1
# 370 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                 ;
   break;
  case 'C':
   g->stub_features.vcont.C = 
# 373 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                             1
# 373 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                 ;
   break;
  case 't':
   g->stub_features.vcont.t = 
# 376 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                             1
# 376 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                 ;
   break;
  case 'r':
   g->stub_features.vcont.r = 
# 379 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                             1
# 379 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                 ;
   break;
  }
  g->stub_features.vContSupported = 
# 382 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                   1
# 382 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                       ;
  ptr = strtok (
# 383 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
               ((void *)0)
# 383 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                   , ";");
 }
...
int gdbr_stop_reason(libgdbr_t *g) {
 ...
 if (!g || send_msg (g, "?") < 0 || read_packet (g, 
# 397 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                                   0
# 397 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                                        ) < 0) {
  ret = -1;
  goto end;
 }
...
int gdbr_check_extended_mode(libgdbr_t *g) {
 ...
 g->stop_reason.is_valid = 
# 413 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                          0
# 413 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                               ;
 reg_cache.valid = 
# 414 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  0
# 414 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                       ;
 ...
 read_packet (g, 
# 421 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                0
# 421 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                     );
 ret = send_ack (g);
 if (ret < 0) {
  g->stub_features.extended_mode = 0;
...
int gdbr_attach(libgdbr_t *g, int pid) {
 int ret = -1;
 char *cmd = 
# 442 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
            ((void *)0)
# 442 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                ;
 size_t buffer_size;
 ...
 g->stop_reason.is_valid = 
# 452 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                          0
# 452 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                               ;
 reg_cache.valid = 
# 453 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  0
# 453 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                       ;
 ...
 buffer_size = strlen (
# 465 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                      "vAttach;"
# 465 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                ) + (sizeof (int) * 2) + 1;
 ...
 ret = 
# 472 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
      __builtin___snprintf_chk (
# 472 "project/radare2/shlr/gdb/src/gdbclient/core.c"
      cmd
# 472 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
      , 
# 472 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 472 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 if (read_packet (g, 
# 482 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                    0
# 482 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                         ) < 0) {
  ret = -1;
  goto end;
 }
...
int gdbr_detach(libgdbr_t *g) {
 ...
 reg_cache.valid = 
# 507 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  0
# 507 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                       ;
 g->stop_reason.is_valid = 
# 508 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                          0
# 508 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                               ;
 ret = send_msg (g, "D");
 if (ret < 0) {
  ret = -1;
...
int gdbr_detach_pid(libgdbr_t *g, int pid) {
 char *cmd = 
# 522 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
            ((void *)0)
# 522 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                ;
 int ret = -1;
 size_t buffer_size;
 ...
 reg_cache.valid = 
# 534 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  0
# 534 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                       ;
 g->stop_reason.is_valid = 
# 535 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                          0
# 535 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                               ;

 buffer_size = strlen (
# 537 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                      "D;"
# 537 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                   ) + (sizeof (pid) * 2) + 1;
 cmd = calloc (buffer_size, sizeof (char));
 if (!cmd) {
  ret = -1;
 ...
 if ((
# 544 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
     __builtin___snprintf_chk (
# 544 "project/radare2/shlr/gdb/src/gdbclient/core.c"
     cmd
# 544 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
     , 
# 544 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 544 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 read_packet (g, 
# 554 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                0
# 554 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                     );
 if ((ret = send_ack (g)) < 0) {
  goto end;
 }
...
int gdbr_kill(libgdbr_t *g) {
 ...
 reg_cache.valid = 
# 584 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  0
# 584 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                       ;
 g->stop_reason.is_valid = 
# 585 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                          0
# 585 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                               ;
...
int gdbr_kill_pid(libgdbr_t *g, int pid) {
 char *cmd = 
# 607 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
            ((void *)0)
# 607 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                ;
 int ret = -1;
 size_t buffer_size;
 ...
 reg_cache.valid = 
# 619 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  0
# 619 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                       ;
 g->stop_reason.is_valid = 
# 620 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                          0
# 620 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                               ;

 buffer_size = strlen (
# 622 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                      "vKill;"
# 622 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                 ) + (sizeof (pid) * 2) + 1;
 cmd = calloc (buffer_size, sizeof (char));
 if (!cmd) {
  ret = -1;
 ...
 if ((
# 629 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
     __builtin___snprintf_chk (
# 629 "project/radare2/shlr/gdb/src/gdbclient/core.c"
     cmd
# 629 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
     , 
# 629 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 629 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 read_packet (g, 
# 637 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                0
# 637 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                     );
 if ((ret = send_ack (g)) < 0) {
  goto end;
 }
...
static int gdbr_read_registers_lldb(libgdbr_t *g) {
 ...
 if (send_msg (g, "?") < 0 || read_packet (g, 
# 667 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                             0
# 667 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                                  ) < 0) {
  ret = -1;
  goto end;
 }
...
# 676 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 __builtin___memcpy_chk (
# 676 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 reg_cache.buf
# 676 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 , 
# 676 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 g->data, reg_cache.buflen
# 676 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 , __builtin_object_size (
# 676 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 reg_cache.buf
...
# 676 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                                  ;
  reg_cache.valid = 
# 677 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                   1
# 677 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                       ;
 }
...
# 694 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 __builtin___memcpy_chk (
# 694 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 g->data
# 694 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 , 
# 694 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 reg_cache.buf, reg_cache.buflen
# 694 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 , __builtin_object_size (
# 694 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 g->data
...
# 694 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 if (g->remote_type == 
# 704 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                      1 
# 704 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                           && !g->stub_features.lldb.g) {
  ret = gdbr_read_registers_lldb (g);
  goto end;
 }
 if ((ret = send_msg (g, 
# 708 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                        "g"
# 708 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                    )) < 0) {
  goto end;
 }
 if (read_packet (g, 
# 711 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                    0
# 711 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                         ) < 0 || handle_g (g) < 0) {
  ret = -1;
  goto end;
 }
...
# 717 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 __builtin___memset_chk (
# 717 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 reg_cache.buf
# 717 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 , 
# 717 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 718 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 __builtin___memcpy_chk (
# 718 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 reg_cache.buf
# 718 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 , 
# 718 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 718 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                                  ;
  reg_cache.valid = 
# 719 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                   1
# 719 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                       ;
 }
...
# 728 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                              unsigned long long 
# 728 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                                   address, 
# 728 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                                            unsigned char 
# 728 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 g->stub_features.pkt_sz = 
# 744 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                          (((
# 744 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                          g->stub_features.pkt_sz
# 744 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                          )>(4))?(
# 744 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 744 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 for (pkt = 0; pkt < num_pkts; pkt++) {
  if (
# 750 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
     __builtin___snprintf_chk (
# 750 "project/radare2/shlr/gdb/src/gdbclient/core.c"
     command
# 750 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
     , 
# 750 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 753 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                     < 0) {
   ret_len = -1;
   goto end;
  }
  ...
  if (read_packet (g, 
# 761 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                     0
# 761 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                          ) < 0) {
   ret_len = -1;
   goto end;
  }
...
# 772 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
  fprintf(__stderrp,
# 772 "project/radare2/shlr/gdb/src/gdbclient/core.c"
  "oops\n"
# 772 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
  )
# 772 "project/radare2/shlr/gdb/src/gdbclient/core.c"
  ...
  int left = 
# 775 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
            (((
# 775 "project/radare2/shlr/gdb/src/gdbclient/core.c"
            g->data_len
# 775 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
            )>(
# 775 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 777 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
  __builtin___memcpy_chk (
# 777 "project/radare2/shlr/gdb/src/gdbclient/core.c"
  buf + delta
# 777 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
  , 
# 777 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 777 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 if (last) {
  if (
# 782 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
     __builtin___snprintf_chk (
# 782 "project/radare2/shlr/gdb/src/gdbclient/core.c"
     command
# 782 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
     , 
# 782 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 785 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                  < 0) {
   ret_len = -1;
   goto end;
  }
  ...
  if (read_packet (g, 
# 793 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                     0
# 793 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                          ) < 0) {
   ret_len = -1;
   goto end;
  }
  ...
  int left = 
# 802 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
            (((
# 802 "project/radare2/shlr/gdb/src/gdbclient/core.c"
            g->data_len
# 802 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
            )>(
# 802 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 804 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
  __builtin___memcpy_chk (
# 804 "project/radare2/shlr/gdb/src/gdbclient/core.c"
  buf + delta
# 804 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
  , 
# 804 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 813 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                  unsigned long long 
# 813 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                       address, 
# 813 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                                unsigned char 
# 813 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 861 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                   unsigned long long 
# 861 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 864 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
unsigned long long 
# 864 "project/radare2/shlr/gdb/src/gdbclient/core.c"
     num_pkts, last, data_sz;
 char *tmp;
 if (!g || !data) {
  return -1;
 }
 g->stub_features.pkt_sz = 
# 869 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                          (((
# 869 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                          g->stub_features.pkt_sz
# 869 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                          )>(4))?(
# 869 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 869 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 for (pkt = num_pkts - 1; pkt >= 0; pkt--) {
  if ((command_len = 
# 885 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                    __builtin___snprintf_chk (
# 885 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                    tmp
# 885 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                    , 
# 885 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 885 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                    "M"
# 885 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                    , address + (pkt * data_sz), data_sz
# 885 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                    )

                                          
# 887 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                         ) < 0) {
   ret = -1;
   goto end;
  }
  ...
  if ((ret = read_packet (g, 
# 895 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                            0
# 895 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                 )) < 0) {
   goto end;
  }
  if ((ret = handle_M (g)) < 0) {
 ...
 if (last) {
  if ((command_len = 
# 903 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                    __builtin___snprintf_chk (
# 903 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                    tmp
# 903 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                    , 
# 903 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 903 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                    "M"
# 903 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                    , address + (num_pkts * data_sz), last
# 903 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                    )

                                            
# 905 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                           ) < 0) {
   ret = -1;
   goto end;
  }
  ...
  if ((ret = read_packet (g, 
# 913 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                            0
# 913 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                 )) < 0) {
   goto end;
  }
  if ((ret = handle_M (g)) < 0) {
...
int gdbr_step(libgdbr_t *g, int tid) {
 ...
 if (tid <= 0 || write_thread_id (thread_id, sizeof (thread_id) - 1, g->pid, tid,
      g->stub_features.multiprocess) < 0) {
  send_vcont (g, "vCont?", 
# 940 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                          ((void *)0)
# 940 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                              );
  send_vcont (g, sdb_fmt ("Hc%d", tid), 
# 941 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                       ((void *)0)
# 941 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                           );
  ret = send_vcont (g, 
# 942 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                      "s"
# 942 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                , 
# 942 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                  ((void *)0)
# 942 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 ret = send_vcont (g, 
# 946 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                     "s"
# 946 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                               , thread_id);
end:
 gdbr_lock_leave (g);
 return ret;
...
# 962 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 __builtin___strncpy_chk (
# 962 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 command
# 962 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 , "c"
# 962 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 964 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 __builtin___snprintf_chk (
# 964 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 command
# 964 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 , 
# 964 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 964 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 if (tid <= 0 || write_thread_id (thread_id, sizeof (thread_id) - 1, g->pid, tid,
      g->stub_features.multiprocess) < 0) {
  ret = send_vcont (g, command, 
# 968 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                               ((void *)0)
# 968 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                   );
  goto end;
 }
...
int gdbr_write_bin_registers(libgdbr_t *g, const char *regs, int len) {
 ...
 char *command = 
# 981 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                ((void *)0)
# 981 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                    ;
 ...
 buffer_size = len * 2 + 8;
 reg_cache.valid = 
# 992 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  0
# 992 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                       ;
...
# 999 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
__builtin___snprintf_chk (
# 999 "project/radare2/shlr/gdb/src/gdbclient/core.c"
command
# 999 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
, 
# 999 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 999 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 if (read_packet (g, 
# 1005 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                    0
# 1005 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                         ) >= 0) {
  handle_G (g);
 } else {
  ret = -1;
...
int gdbr_write_register(libgdbr_t *g, int index, char *value, int len) {
 ...
 reg_cache.valid = 
# 1031 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  0
# 1031 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                       ;
 ret = 
# 1032 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
      __builtin___snprintf_chk (
# 1032 "project/radare2/shlr/gdb/src/gdbclient/core.c"
      command
# 1032 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
      , 
# 1032 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1034 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 fprintf(__stderrp,
# 1034 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1039 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
__builtin___memset_chk (
# 1039 "project/radare2/shlr/gdb/src/gdbclient/core.c"
command + ret
# 1039 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
, 
# 1039 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1039 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 if (read_packet (g, 
# 1045 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                    0
# 1045 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                         ) < 0 || handle_P (g) < 0) {
  ret = -1;
  goto end;
 }
 if (g->last_code == 
# 1049 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                    -1
# 1049 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                     ) {
  g->stub_features.P = 
# 1050 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                      0
# 1050 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                           ;
  ret = -1;
  goto end;
 }
...
int gdbr_write_reg(libgdbr_t *g, const char *name, char *value, int len) {
 ...
 reg_cache.valid = 
# 1072 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  0
# 1072 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                       ;
...
# 1080 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 fprintf(__stderrp,
# 1080 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1090 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
__builtin___memcpy_chk (
# 1090 "project/radare2/shlr/gdb/src/gdbclient/core.c"
g->data + (g->registers[i].offset / 8)
# 1090 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
, 
# 1090 "project/radare2/shlr/gdb/src/gdbclient/core.c"
value, len
...
int gdbr_write_registers(libgdbr_t *g, char *registers) {
 ...
 command = buff = value = 
# 1107 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                         ((void *)0)
# 1107 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                             ;
 ...
 gdbr_read_registers (g);
 reg_cache.valid = 
# 1118 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  0
# 1118 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                       ;
...
# 1125 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
__builtin___memcpy_chk (
# 1125 "project/radare2/shlr/gdb/src/gdbclient/core.c"
buff
# 1125 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
, 
# 1125 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1125 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 while (reg) {
  ...
  if (name_end == 
# 1129 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                 ((void *)0)
# 1129 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                     ) {
   
# 1130 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
  fprintf(__stderrp,
# 1130 "project/radare2/shlr/gdb/src/gdbclient/core.c"
  ...
  *name_end = '\0';
  ...
  while (g->registers[i].size > 0) {
   if (strcmp (g->registers[i].name, reg) == 0) {
    const 
# 1139 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
         unsigned long long 
# 1139 "project/radare2/shlr/gdb/src/gdbclient/core.c"
              register_size = g->registers[i].size;
    const 
# 1140 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
         unsigned long long 
# 1140 "project/radare2/shlr/gdb/src/gdbclient/core.c"
              offset = g->registers[i].offset;
...
# 1147 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
   __builtin___memset_chk (
# 1147 "project/radare2/shlr/gdb/src/gdbclient/core.c"
   value
# 1147 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
   , 
# 1147 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1154 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
   __builtin___strcpy_chk (
# 1154 "project/radare2/shlr/gdb/src/gdbclient/core.c"
   value + (register_size * 2 - val_len)
# 1154 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
   , 
# 1154 "project/radare2/shlr/gdb/src/gdbclient/core.c"
   name_end
...
# 1159 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
   { free((void *)
# 1159 "project/radare2/shlr/gdb/src/gdbclient/core.c"
   value
# 1159 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
   ); 
# 1159 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1159 "project/radare2/shlr/gdb/src/gdbclient/core.c"
  ...
  reg = strtok (
# 1163 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
               ((void *)0)
# 1163 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                   , " ,");
 }
...
# 1172 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
__builtin___snprintf_chk (
# 1172 "project/radare2/shlr/gdb/src/gdbclient/core.c"
command
# 1172 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
, 
# 1172 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1172 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 read_packet (g, 
# 1178 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                0
# 1178 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                     );
 handle_G (g);
...
int test_command(libgdbr_t *g, const char *command) {
 ...
 read_packet (g, 
# 1206 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                0
# 1206 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                     );
...
int send_vcont(libgdbr_t *g, const char *command, const char *thread_id) {
 ...
 int ret = -1;
 void *bed = 
# 1218 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
            ((void *)0)
# 1218 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                ;
 ...
 if (!g->stub_features.vContSupported) {
  ret = 
# 1225 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       __builtin___snprintf_chk (
# 1225 "project/radare2/shlr/gdb/src/gdbclient/core.c"
       tmp
# 1225 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       , 
# 1225 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1227 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 _Bool 
# 1227 "project/radare2/shlr/gdb/src/gdbclient/core.c"
      supported = 
# 1227 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  0
# 1227 "project/radare2/shlr/gdb/src/gdbclient/core.c"
  ...
  case 's':
   if (g->stub_features.vcont.s) {
    supported = 
# 1231 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
               1
# 1231 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                   ;
   }
   break;
  case 'S':
   if (g->stub_features.vcont.S) {
    supported = 
# 1236 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
               1
# 1236 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                   ;
   }
   break;
  case 'c':
   if (g->stub_features.vcont.c) {
    supported = 
# 1241 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
               1
# 1241 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                   ;
   }
   break;
  case 'C':
   if (g->stub_features.vcont.C) {
    supported = 
# 1246 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
               1
# 1246 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                   ;
   }
   break;
  case 't':
   if (g->stub_features.vcont.t) {
    supported = 
# 1251 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
               1
# 1251 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                   ;
   }
   break;
  case 'r':
   if (g->stub_features.vcont.r) {
    supported = 
# 1256 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
               1
# 1256 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                   ;
   }
   break;
  }
  if (supported) {
   if (!thread_id) {
    ret = 
# 1262 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
         __builtin___snprintf_chk (
# 1262 "project/radare2/shlr/gdb/src/gdbclient/core.c"
         tmp
# 1262 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
         , 
# 1262 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1262 "project/radare2/shlr/gdb/src/gdbclient/core.c"
    ...
    ret = 
# 1264 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
         __builtin___snprintf_chk (
# 1264 "project/radare2/shlr/gdb/src/gdbclient/core.c"
         tmp
# 1264 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
         , 
# 1264 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1264 "project/radare2/shlr/gdb/src/gdbclient/core.c"
   ...
   ret = 
# 1267 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
        __builtin___snprintf_chk (
# 1267 "project/radare2/shlr/gdb/src/gdbclient/core.c"
        tmp
# 1267 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
        , 
# 1267 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1267 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 reg_cache.valid = 
# 1277 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  0
# 1277 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                       ;
 g->stop_reason.is_valid = 
# 1278 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                          0
# 1278 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                               ;
 ret = send_msg (g, tmp);
 if (ret < 0) {
  goto end;
 ...
 bed = r_cons_sleep_begin ();
 while ((ret = read_packet (g, 
# 1285 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                              1
# 1285 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                  )) < 0 && !g->isbreaked && r_socket_is_connected (g->sock));
 if (g->isbreaked) {
  g->isbreaked = 
# 1287 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                0
# 1287 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                     ;

  r_socket_write (g->sock, "\x03", 1);

  if (read_packet (g, 
# 1291 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                     0
# 1291 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                          ) < 0) {
   ret = -1;
   goto end;
  }
...
# 1304 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                        unsigned long long 
# 1304 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                             address, const char *conditions, enum Breakpoint type, int sizebp) {
 char tmp[255] = { 0 };
 int ret = -1;
 ...
 case BREAKPOINT:
  ret = 
# 1314 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       __builtin___snprintf_chk (
# 1314 "project/radare2/shlr/gdb/src/gdbclient/core.c"
       tmp
# 1314 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       , 
# 1314 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1315 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                               ;
  break;
 case HARDWARE_BREAKPOINT:
  ret = 
# 1318 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       __builtin___snprintf_chk (
# 1318 "project/radare2/shlr/gdb/src/gdbclient/core.c"
       tmp
# 1318 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       , 
# 1318 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1319 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                                ;
  break;
 case WRITE_WATCHPOINT:
  ret = 
# 1322 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       __builtin___snprintf_chk (
# 1322 "project/radare2/shlr/gdb/src/gdbclient/core.c"
       tmp
# 1322 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       , 
# 1322 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1323 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                                ;
  break;
 case READ_WATCHPOINT:
  ret = 
# 1326 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       __builtin___snprintf_chk (
# 1326 "project/radare2/shlr/gdb/src/gdbclient/core.c"
       tmp
# 1326 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       , 
# 1326 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1327 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                                ;
  break;
 case ACCESS_WATCHPOINT:
  ret = 
# 1330 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       __builtin___snprintf_chk (
# 1330 "project/radare2/shlr/gdb/src/gdbclient/core.c"
       tmp
# 1330 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       , 
# 1330 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1331 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                                ;
  break;
 default:
  break;
 ...
 g->stop_reason.is_valid = 
# 1344 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                          0
# 1344 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                               ;
 if ((ret = send_msg (g, tmp)) < 0) {
  goto end;
 }
 ...
 if ((ret = read_packet (g, 
# 1349 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                           0
# 1349 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                )) < 0) {
  goto end;
 }
...
# 1359 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                             unsigned long long 
# 1359 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                  address, const char *conditions, int sizebp) {
 return set_bp (g, address, conditions, BREAKPOINT, sizebp);
}

int gdbr_set_hwbp(libgdbr_t *g, 
# 1363 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                               unsigned long long 
# 1363 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                    address, const char *conditions, int sizebp) {
 return set_bp (g, address, conditions, HARDWARE_BREAKPOINT, sizebp);
}

int gdbr_set_hww(libgdbr_t *g, 
# 1367 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                              unsigned long long 
# 1367 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                   address, const char *conditions, int sizebp) {
 return set_bp (g, address, conditions, WRITE_WATCHPOINT, sizebp);
}

int gdbr_set_hwr(libgdbr_t *g, 
# 1371 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                              unsigned long long 
# 1371 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                   address, const char *conditions, int sizebp) {
 return set_bp (g, address, conditions, READ_WATCHPOINT, sizebp);
}

int gdbr_set_hwa(libgdbr_t *g, 
# 1375 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                              unsigned long long 
# 1375 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                   address, const char *conditions, int sizebp) {
 return set_bp (g, address, conditions, ACCESS_WATCHPOINT, sizebp);
}

int gdbr_remove_bp(libgdbr_t *g, 
# 1379 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                unsigned long long 
# 1379 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                     address, int sizebp) {
 return remove_bp (g, address, BREAKPOINT, sizebp);
}
int gdbr_remove_hwbp(libgdbr_t *g, 
# 1382 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                  unsigned long long 
# 1382 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                       address, int sizebp) {
 return remove_bp (g, address, HARDWARE_BREAKPOINT, sizebp);
}

int gdbr_remove_hww(libgdbr_t *g, 
# 1386 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                 unsigned long long 
# 1386 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                      address, int sizebp) {
 return remove_bp (g, address, WRITE_WATCHPOINT, sizebp);
}

int gdbr_remove_hwr(libgdbr_t *g, 
# 1390 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                 unsigned long long 
# 1390 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                      address, int sizebp) {
 return remove_bp (g, address, READ_WATCHPOINT, sizebp);
}

int gdbr_remove_hwa(libgdbr_t *g, 
# 1394 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                 unsigned long long 
# 1394 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                      address, int sizebp) {
...
# 1399 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                           unsigned long long 
# 1399 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                address, enum Breakpoint type, int sizebp) {
 char tmp[255] = { 0 };
 int ret = -1;
 ...
 case BREAKPOINT:
  ret = 
# 1409 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       __builtin___snprintf_chk (
# 1409 "project/radare2/shlr/gdb/src/gdbclient/core.c"
       tmp
# 1409 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       , 
# 1409 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1409 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 case HARDWARE_BREAKPOINT:
  ret = 
# 1412 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       __builtin___snprintf_chk (
# 1412 "project/radare2/shlr/gdb/src/gdbclient/core.c"
       tmp
# 1412 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       , 
# 1412 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1412 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 case WRITE_WATCHPOINT:
  ret = 
# 1415 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       __builtin___snprintf_chk (
# 1415 "project/radare2/shlr/gdb/src/gdbclient/core.c"
       tmp
# 1415 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       , 
# 1415 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1415 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 case READ_WATCHPOINT:
  ret = 
# 1418 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       __builtin___snprintf_chk (
# 1418 "project/radare2/shlr/gdb/src/gdbclient/core.c"
       tmp
# 1418 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       , 
# 1418 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1418 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 case ACCESS_WATCHPOINT:
  ret = 
# 1421 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       __builtin___snprintf_chk (
# 1421 "project/radare2/shlr/gdb/src/gdbclient/core.c"
       tmp
# 1421 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       , 
# 1421 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1421 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 g->stop_reason.is_valid = 
# 1434 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                          0
# 1434 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                               ;
 if ((ret = send_msg (g, tmp)) < 0) {
  goto end;
 }
 if ((ret = read_packet (g, 
# 1438 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                           0
# 1438 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                )) < 0) {
  goto end;
 }
...
# 1457 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 fprintf(__stderrp,
# 1457 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1468 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
__builtin___strcpy_chk (
# 1468 "project/radare2/shlr/gdb/src/gdbclient/core.c"
buf
# 1468 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
, 
# 1468 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1470 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
__builtin___snprintf_chk (
# 1470 "project/radare2/shlr/gdb/src/gdbclient/core.c"
buf + strlen (buf)
# 1470 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
, 
# 1470 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1470 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 read_packet (g, 
# 1474 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                0
# 1474 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                     );
...
# 1488 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                unsigned char 
# 1488 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                    *buf, 
# 1488 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                          unsigned long long 
# 1488 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1491 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
unsigned long long 
# 1491 "project/radare2/shlr/gdb/src/gdbclient/core.c"
     data_sz;
 ret = 0;
 if (!g || !buf || !max_len) {
  return -1;
 ...
 if (max_len >= 
# 1496 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
               2147483647
# 1496 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                        ) {
  
# 1497 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 fprintf(__stderrp,
# 1497 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 "%s: Too big a file read requested: %"
# 1497 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 "lld"
# 1497 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 , __func__, max_len
...
# 1501 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 fprintf(__stderrp,
# 1501 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1501 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 g->stub_features.pkt_sz = 
# 1508 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                          (((
# 1508 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                          g->stub_features.pkt_sz
# 1508 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                          )>(4))?(
# 1508 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1508 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 while (ret < max_len) {
  if ((ret1 = 
# 1512 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
             __builtin___snprintf_chk (
# 1512 "project/radare2/shlr/gdb/src/gdbclient/core.c"
             command
# 1512 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
             , 
# 1512 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1515 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                ) < 0) {
   ret = -1;
   goto end;
  }
  ...
  if (read_packet (g, 
# 1523 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                     0
# 1523 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                          ) < 0) {
   ret = -1;
   goto end;
  }
...
# 1550 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 fprintf(__stderrp,
# 1550 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 "%s: No remote file opened\n", __func__
# 1550 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 )
# 1550 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1557 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
__builtin___snprintf_chk (
# 1557 "project/radare2/shlr/gdb/src/gdbclient/core.c"
buf
# 1557 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
, 
# 1557 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
, 2 > 1 ? 1 : 0), 
# 1557 "project/radare2/shlr/gdb/src/gdbclient/core.c"
"vFile:close:%x", g->remote_file_fd
# 1557 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
)
# 1557 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                                                     ;
 ...
 read_packet (g, 
# 1561 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                0
# 1561 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                     );
...
void gdbr_invalidate_reg_cache() {
 reg_cache.valid = 
# 1574 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  0
# 1574 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                       ;
}
...
# 1589 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
__builtin___strcpy_chk (
# 1589 "project/radare2/shlr/gdb/src/gdbclient/core.c"
buf
# 1589 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
, 
# 1589 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1589 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 g->stop_reason.is_valid = 
# 1594 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                          0
# 1594 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                               ;
 reg_cache.valid = 
# 1595 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  0
# 1595 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                       ;
 ...
 if ((ret = read_packet (g, 
# 1600 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                           0
# 1600 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                )) < 0) {
  goto end;
 }
 while (1) {
  ...
  if ((ret = read_packet (g, 
# 1625 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                            0
# 1625 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                 )) < 0) {
   goto end;
  }
 }
...
char* gdbr_exec_file_read(libgdbr_t *g, int pid) {
 ...
 char *path = 
# 1641 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
             ((void *)0)
# 1641 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                 ;
 
# 1642 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
unsigned long long 
# 1642 "project/radare2/shlr/gdb/src/gdbclient/core.c"
     len, off = 0;
 int ret = -1;

 if (!g) {
  return 
# 1646 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
        ((void *)0)
# 1646 "project/radare2/shlr/gdb/src/gdbclient/core.c"
            ;
 }

 len = g->stub_features.pkt_sz;
 
# 1650 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
__builtin___memset_chk (
# 1650 "project/radare2/shlr/gdb/src/gdbclient/core.c"
pidstr
# 1650 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
, 
# 1650 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1652 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 __builtin___snprintf_chk (
# 1652 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 pidstr
# 1652 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
 , 
# 1652 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1652 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 while (1) {
  if (
# 1659 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
     __builtin___snprintf_chk (
# 1659 "project/radare2/shlr/gdb/src/gdbclient/core.c"
     msg
# 1659 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
     , 
# 1659 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1661 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                        < 0) {
   ret = -1;
   goto end;
  }
  if (send_msg (g, msg) < 0 || read_packet (g, 
# 1665 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                              0
# 1665 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                                   ) < 0
 ...
 if (ret != 0) {
  ...
  return 
# 1696 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
        ((void *)0)
# 1696 "project/radare2/shlr/gdb/src/gdbclient/core.c"
            ;
 }
 return path;
}
...
# 1701 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
_Bool 
# 1701 "project/radare2/shlr/gdb/src/gdbclient/core.c"
    gdbr_is_thread_dead (libgdbr_t *g, int pid, int tid) {
 
# 1702 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
_Bool 
# 1702 "project/radare2/shlr/gdb/src/gdbclient/core.c"
     ret = 
# 1702 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
           0
# 1702 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 if (!g) {
  return 
# 1705 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
        0
# 1705 "project/radare2/shlr/gdb/src/gdbclient/core.c"
             ;
 }
 if (g->stub_features.multiprocess && pid <= 0) {
  return 
# 1708 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
        0
# 1708 "project/radare2/shlr/gdb/src/gdbclient/core.c"
             ;
 }
 ...
 if (
# 1719 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
    __builtin___snprintf_chk (
# 1719 "project/radare2/shlr/gdb/src/gdbclient/core.c"
    msg
# 1719 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
    , 
# 1719 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1719 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 if (send_msg (g, msg) < 0 || read_packet (g, 
# 1722 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                             0
# 1722 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                                  ) < 0 || send_ack (g) < 0) {
  goto end;
 }
 if (g->data_len == 3 && g->data[0] == 'E') {
  ret = 
# 1726 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       1
# 1726 "project/radare2/shlr/gdb/src/gdbclient/core.c"
           ;
 } else {
  ret = 
# 1728 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       0
# 1728 "project/radare2/shlr/gdb/src/gdbclient/core.c"
            ;
 }
...
RList* gdbr_pids_list(libgdbr_t *g, int pid) {
 int ret = -1;
 RList *list = 
# 1738 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
              ((void *)0)
# 1738 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                  ;
 int tpid = -1, ttid = -1;
 char *ptr, *ptr2, *exec_file;
 RDebugPid *dpid = 
# 1741 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  ((void *)0)
# 1741 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                      ;
 RListIter *iter = 
# 1742 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  ((void *)0)
# 1742 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                      ;

 if (!g) {
  return 
# 1745 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
        ((void *)0)
# 1745 "project/radare2/shlr/gdb/src/gdbclient/core.c"
            ;
 }
...
# 1765 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
fprintf(__stderrp,
# 1765 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1765 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 if (send_msg (g, "qfThreadInfo") < 0 || read_packet (g, 
# 1771 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                                        0
# 1771 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                                             ) < 0 || send_ack (g) < 0
...
# 1789 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
  if (
# 1789 "project/radare2/shlr/gdb/src/gdbclient/core.c"
  list
# 1789 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
  ) for (
# 1789 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1789 "project/radare2/shlr/gdb/src/gdbclient/core.c"
   ...
   if (!(dpid = 
# 1794 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
               (
# 1794 "project/radare2/shlr/gdb/src/gdbclient/core.c"
               RDebugPid
# 1794 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
               *)calloc(1,sizeof(
# 1794 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1794 "project/radare2/shlr/gdb/src/gdbclient/core.c"
   ...
   dpid->uid = dpid->gid = -1;
   dpid->runnable = 
# 1804 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                   1
# 1804 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                       ;
   dpid->status = R_DBG_PROC_STOP;
   r_list_append (list, dpid);
   ptr = ptr2;
  }
  if (send_msg (g, "qsThreadInfo") < 0 || read_packet (g, 
# 1809 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                                         0
# 1809 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                                              ) < 0
       || send_ack (g) < 0 || g->data_len == 0
...
# 1829 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
  if (
# 1829 "project/radare2/shlr/gdb/src/gdbclient/core.c"
  list
# 1829 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
  ) for (
# 1829 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1829 "project/radare2/shlr/gdb/src/gdbclient/core.c"
  ...
  return 
# 1837 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
        ((void *)0)
# 1837 "project/radare2/shlr/gdb/src/gdbclient/core.c"
            ;
 }
 return list;
}
...
RList* gdbr_threads_list(libgdbr_t *g, int pid) {
 int ret = -1;
 RList *list = 
# 1844 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
              ((void *)0)
# 1844 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                  ;
 int tpid = -1, ttid = -1;
 char *ptr, *ptr2, *exec_file;
 RDebugPid *dpid = 
# 1847 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  ((void *)0)
# 1847 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                      ;
 RListIter *iter = 
# 1848 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                  ((void *)0)
# 1848 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                      ;

 if (!g) {
  return 
# 1851 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
        ((void *)0)
# 1851 "project/radare2/shlr/gdb/src/gdbclient/core.c"
            ;
 }
 ...
 if (send_msg (g, "qfThreadInfo") < 0 || read_packet (g, 
# 1865 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                                        0
# 1865 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                                             ) < 0 || send_ack (g) < 0
      || g->data_len == 0 || g->data[0] != 'm') {
  ret = -1;
  goto end;
 ...
 while (1) {
  ...
  while (ptr) {
   ...
   if (!(dpid = 
# 1891 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
               (
# 1891 "project/radare2/shlr/gdb/src/gdbclient/core.c"
               RDebugPid
# 1891 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
               *)calloc(1,sizeof(
# 1891 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1891 "project/radare2/shlr/gdb/src/gdbclient/core.c"
   ...
   dpid->pid = ttid;
   dpid->runnable = 
# 1897 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                   1
# 1897 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                       ;
  ...
  if (send_msg (g, "qsThreadInfo") < 0 || read_packet (g, 
# 1905 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                                         0
# 1905 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                                              ) < 0
       || send_ack (g) < 0 || g->data_len == 0
       || (g->data[0] != 'm' && g->data[0] != 'l')) {
   ret = -1;
...
# 1916 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
if (
# 1916 "project/radare2/shlr/gdb/src/gdbclient/core.c"
list
# 1916 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
) for (
# 1916 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1931 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
  if (
# 1931 "project/radare2/shlr/gdb/src/gdbclient/core.c"
  list
# 1931 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
  ) for (
# 1931 "project/radare2/shlr/gdb/src/gdbclient/core.c"
...
# 1931 "project/radare2/shlr/gdb/src/gdbclient/core.c"
  ...
  return 
# 1939 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
        ((void *)0)
# 1939 "project/radare2/shlr/gdb/src/gdbclient/core.c"
            ;
 }
 return list;
}
...
# 1944 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
unsigned long long 
# 1944 "project/radare2/shlr/gdb/src/gdbclient/core.c"
    gdbr_get_baddr(libgdbr_t *g) {
 
# 1945 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
unsigned long long 
# 1945 "project/radare2/shlr/gdb/src/gdbclient/core.c"
     off, min = 
# 1945 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
...
# 1945 "project/radare2/shlr/gdb/src/gdbclient/core.c"
 ...
 if (!g) {
  return 
# 1948 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
        18446744073709551615ULL
# 1948 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                  ;
 }
 ...
 if (send_msg (g, "qOffsets") < 0 || read_packet (g, 
# 1954 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                                                    0
# 1954 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                                                         ) < 0
      || send_ack (g) < 0 || g->data_len == 0) {
  min = 
# 1956 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       18446744073709551615ULL
# 1956 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                 ;
  goto end;
 }
 if (r_str_startswith (g->data, "TextSeg=")) {
  ...
  off = strtoull (ptr, 
# 1964 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                      ((void *)0)
# 1964 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                          , 16);
  if (off < min) {
   min = off;
  }
  ...
  if (*ptr && r_str_startswith (ptr, "DataSeg=")) {
   ...
   off = strtoull (ptr, 
# 1977 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                       ((void *)0)
# 1977 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                           , 16);
   if (off < min) {
    min = off;
   }
 ...
 off = strtoull (ptr, 
# 1991 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                     ((void *)0)
# 1991 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                         , 16);
 if (off < min) {
  min = off;
 }
 if (!(ptr = strchr (ptr, ';')) || !r_str_startswith (ptr + 1, "Data=")) {
  min = 
# 1996 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       18446744073709551615ULL
# 1996 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                 ;
  goto end;
 }
 ptr += strlen (";Data=");
 if (!isxdigit ((unsigned char)*ptr)) {
  min = 
# 2001 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
       18446744073709551615ULL
# 2001 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                 ;
  goto end;
 }
 off = strtoull (ptr, 
# 2004 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                     ((void *)0)
# 2004 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                         , 16);
 if (off < min) {
  min = off;
 }
 ...
 if (r_str_startswith (ptr, "Bss=")) {
  ...
  off = strtoull (ptr, 
# 2017 "project/radare2/shlr/gdb/src/gdbclient/core.c" 3 4
                      ((void *)0)
# 2017 "project/radare2/shlr/gdb/src/gdbclient/core.c"
                          , 16);
  if (off < min) {
   min = off;
  }
