# 0 "project/radare2/shlr/gdb/src/gdbserver/core.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/gdb/src/gdbserver/core.c"
...
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/gdbserver/core.h" 1 3 4
...
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/gdbserver/core.h" 2 3 4
...
# 6 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/gdbserver/core.h" 2 3 4
...
# 8 "project/radare2/shlr/gdb/src/gdbserver/core.c" 2
...
# 9 "project/radare2/shlr/gdb/src/gdbserver/core.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/libgdbr.h" 1 3 4
# 10 "project/radare2/shlr/gdb/src/gdbserver/core.c" 2
...
# 11 "project/radare2/shlr/gdb/src/gdbserver/core.c" 2
...
# 12 "project/radare2/shlr/gdb/src/gdbserver/core.c" 2
...
# 13 "project/radare2/shlr/gdb/src/gdbserver/core.c" 2


# 14 "project/radare2/shlr/gdb/src/gdbserver/core.c"
...
# 20 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
__builtin___snprintf_chk (
# 20 "project/radare2/shlr/gdb/src/gdbserver/core.c"
buf
# 20 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
, 
# 20 "project/radare2/shlr/gdb/src/gdbserver/core.c"
...
# 21 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                            ;
...
static int _server_handle_qOffsets(libgdbr_t *g, gdbr_server_cmd_cb cmd_cb, void *core_ptr) {
 char buf[64], *ptr;
 ptr = buf + 
# 43 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
            __builtin___sprintf_chk (
# 43 "project/radare2/shlr/gdb/src/gdbserver/core.c"
            buf
# 43 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
            , 0, __builtin_object_size (
# 43 "project/radare2/shlr/gdb/src/gdbserver/core.c"
...
static int _server_handle_exec_file_read(libgdbr_t *g, gdbr_server_cmd_cb cb,
 ...
 if (*ptr != ':') {
  int pid;
  if ((pid = (int) strtol (ptr, 
# 65 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
                               ((void *)0)
# 65 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                                   , 16)) <= 0 || pid != g->pid) {
...
# 73 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
__builtin___snprintf_chk (
# 73 "project/radare2/shlr/gdb/src/gdbserver/core.c"
cmd
# 73 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
, 
# 73 "project/radare2/shlr/gdb/src/gdbserver/core.c"
...
# 92 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
unsigned long long 
# 92 "project/radare2/shlr/gdb/src/gdbserver/core.c"
     memlen, memlen2, addr;
 g->data[g->data_len] = '\0';
 if (sscanf (g->data + 1, "%"
# 94 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
                            "llx"
# 94 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                                   ",%"
# 94 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
                                       "llx"
# 94 "project/radare2/shlr/gdb/src/gdbserver/core.c"
...
# 107 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
__builtin___snprintf_chk (
# 107 "project/radare2/shlr/gdb/src/gdbserver/core.c"
buf
# 107 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
, 
# 107 "project/radare2/shlr/gdb/src/gdbserver/core.c"
...
# 109 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
fprintf(__stderrp,
# 109 "project/radare2/shlr/gdb/src/gdbserver/core.c"
"buf: %s\n", buf
# 109 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
)
# 109 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                          ;
 if (cmd_cb (g, core_ptr, buf, 
# 110 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
                              ((void *)0)
# 110 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                                  , 0) < 0) {
  free (buf);
  return send_msg (g, "E01");
 }
...
static int _server_handle_s(libgdbr_t *g, gdbr_server_cmd_cb cmd_cb, void *core_ptr) {
 ...
 if (cmd_cb (g, core_ptr, "ds", 
# 127 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
                               ((void *)0)
# 127 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                                   , 0) < 0) {
  send_msg (g, "E01");
  return -1;
 }
...
static int _server_handle_c(libgdbr_t *g, gdbr_server_cmd_cb cmd_cb, void *core_ptr) {
 ...
 if (cmd_cb (g, core_ptr, "dc", 
# 147 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
                               ((void *)0)
# 147 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                                   , 0) < 0) {
  send_msg (g, "E01");
  return -1;
 }
...
# 209 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
unsigned long long 
# 209 "project/radare2/shlr/gdb/src/gdbserver/core.c"
     addr;
 char cmd[64];
 sscanf (g->data, "%c%d,%"
# 211 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
                         "llx"
# 211 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                                , &set, &type, &addr);
 if (type != 0) {
...
# 219 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
 __builtin___snprintf_chk (
# 219 "project/radare2/shlr/gdb/src/gdbserver/core.c"
 cmd
# 219 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
 , 
# 219 "project/radare2/shlr/gdb/src/gdbserver/core.c"
...
# 223 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
 __builtin___snprintf_chk (
# 223 "project/radare2/shlr/gdb/src/gdbserver/core.c"
 cmd
# 223 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
 , 
# 223 "project/radare2/shlr/gdb/src/gdbserver/core.c"
...
# 223 "project/radare2/shlr/gdb/src/gdbserver/core.c"
 ...
 if (cmd_cb (g, core_ptr, cmd, 
# 228 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
                              ((void *)0)
# 228 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                                  , 0) < 0) {
  send_msg (g, "E01");
  return -1;
 }
...
static int _server_handle_vCont(libgdbr_t *g, gdbr_server_cmd_cb cmd_cb, void *core_ptr) {
 char *action = 
# 236 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
               ((void *)0)
# 236 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                   ;
 if (send_ack (g) < 0) {
  return -1;
 }
 ...
 while ((action = strtok (
# 248 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
                         ((void *)0)
# 248 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                             , ";"))) {
  
# 249 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
 fprintf(__stderrp,
# 249 "project/radare2/shlr/gdb/src/gdbserver/core.c"
 "action: %s\n", action
# 249 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
 )
# 249 "project/radare2/shlr/gdb/src/gdbserver/core.c"
  ...
  case 's':
   ...
   if (cmd_cb (g, core_ptr, "ds", 
# 253 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
                                 ((void *)0)
# 253 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                                     , 0) < 0) {
    send_msg (g, "E01");
    return -1;
   }
  ...
  case 'c':
   ...
   if (cmd_cb (g, core_ptr, "dc", 
# 260 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
                                 ((void *)0)
# 260 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                                     , 0) < 0) {
    send_msg (g, "E01");
    return -1;
   }
...
# 301 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
__builtin___snprintf_chk (
# 301 "project/radare2/shlr/gdb/src/gdbserver/core.c"
cmd
# 301 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
, 
# 301 "project/radare2/shlr/gdb/src/gdbserver/core.c"
...
# 301 "project/radare2/shlr/gdb/src/gdbserver/core.c"
 ...
 if (cmd_cb (g, core_ptr, cmd, 
# 303 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
                              ((void *)0)
# 303 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                                  , 0) < 0) {
  send_msg (g, "E01");
  return -1;
 }
...
# 326 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
__builtin___snprintf_chk (
# 326 "project/radare2/shlr/gdb/src/gdbserver/core.c"
cmd
# 326 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
, 
# 326 "project/radare2/shlr/gdb/src/gdbserver/core.c"
...
# 326 "project/radare2/shlr/gdb/src/gdbserver/core.c"
 ...
 if (cmd_cb (g, core_ptr, cmd, 
# 328 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
                              ((void *)0)
# 328 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                                  , 0) < 0) {
  send_msg (g, "E01");
  return -1;
 }
...
# 374 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
__builtin___memset_chk (
# 374 "project/radare2/shlr/gdb/src/gdbserver/core.c"
buf
# 374 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
, 
# 374 "project/radare2/shlr/gdb/src/gdbserver/core.c"
...
# 386 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
unsigned long long 
# 386 "project/radare2/shlr/gdb/src/gdbserver/core.c"
     addr;
 int length;
 char *cmd, *buf;
 if (send_ack (g) < 0) {
 ...
 g->data[g->data_len] = 0;
 sscanf (g->data, "m%"
# 393 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
                     "llx"
# 393 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                            , &addr);
...
static int _server_handle_p(libgdbr_t *g, gdbr_server_cmd_cb cmd_cb, void *core_ptr) {
 ...
 regnum = strtol (g->data + 1, 
# 426 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
                              ((void *)0)
# 426 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                                  , 16);
 ...
 if (
# 433 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
    __builtin___snprintf_chk (
# 433 "project/radare2/shlr/gdb/src/gdbserver/core.c"
    cmd
# 433 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
    , 
# 433 "project/radare2/shlr/gdb/src/gdbserver/core.c"
...
static int _server_handle_P(libgdbr_t *g, gdbr_server_cmd_cb cmd_cb, void *core_ptr) {
 ...
 regnum = strtol (g->data + 1, 
# 458 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
                              ((void *)0)
# 458 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                                  , 16);
...
# 469 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
__builtin___snprintf_chk (
# 469 "project/radare2/shlr/gdb/src/gdbserver/core.c"
cmd
# 469 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
, 
# 469 "project/radare2/shlr/gdb/src/gdbserver/core.c"
...
, 2 > 1 ? 1 : 0), 
# 469 "project/radare2/shlr/gdb/src/gdbserver/core.c"
"dr %s=0x%s", g->registers[regnum].name, ptr
# 469 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
)
# 469 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                                                                     ;
 if (cmd_cb (g, core_ptr, cmd, 
# 470 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
                              ((void *)0)
# 470 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                                  , 0) < 0) {
  free (cmd);
  send_msg (g, "E01");
  return -1;
...
int gdbr_server_serve(libgdbr_t *g, gdbr_server_cmd_cb cmd_cb, void *core_ptr) {
 ...
 while (1) {
  if (read_packet (g, 
# 500 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
                     0
# 500 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                          ) < 0) {
   continue;
  }
  if (g->data_len == 0) {
  ...
  if (r_str_startswith (g->data, "QStartNoAckMode")) {
   ...
   g->no_ack = 
# 648 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
              1
# 648 "project/radare2/shlr/gdb/src/gdbserver/core.c"
                  ;
   if (g->server_debug) {
    
# 650 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
   fprintf(__stderrp,
# 650 "project/radare2/shlr/gdb/src/gdbserver/core.c"
   "[noack mode enabled]\n"
# 650 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
   )
# 650 "project/radare2/shlr/gdb/src/gdbserver/core.c"
...
# 660 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
  fprintf(__stderrp,
# 660 "project/radare2/shlr/gdb/src/gdbserver/core.c"
  "Unknown packet: %s\n", g->data
# 660 "project/radare2/shlr/gdb/src/gdbserver/core.c" 3 4
  )
# 660 "project/radare2/shlr/gdb/src/gdbserver/core.c"
