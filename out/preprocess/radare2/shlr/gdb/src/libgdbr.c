# 0 "project/radare2/shlr/gdb/src/libgdbr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/gdb/src/libgdbr.c"
...
# 4 "project/radare2/shlr/gdb/src/libgdbr.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/qnx/include/arch.h" 1 3 4
# 5 "project/radare2/shlr/gdb/src/libgdbr.c" 2




# 8 "project/radare2/shlr/gdb/src/libgdbr.c"
int gdbr_init(libgdbr_t *g, 
# 8 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
                           _Bool 
# 8 "project/radare2/shlr/gdb/src/libgdbr.c"
                                is_server) {
 if (!g) {
...
# 12 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
__builtin___memset_chk (
# 12 "project/radare2/shlr/gdb/src/libgdbr.c"
g
# 12 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
, 
# 12 "project/radare2/shlr/gdb/src/libgdbr.c"
...
# 12 "project/radare2/shlr/gdb/src/libgdbr.c"
                                 ;
 g->no_ack = 
# 13 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
            0
# 13 "project/radare2/shlr/gdb/src/libgdbr.c"
                 ;
 g->stub_features.extended_mode = -1;
 g->stub_features.pkt_sz = 64;
 g->stub_features.P = 
# 16 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
                     1
# 16 "project/radare2/shlr/gdb/src/libgdbr.c"
                         ;
 g->remote_file_fd = -1;
...
# 30 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
 { free((void *)
# 30 "project/radare2/shlr/gdb/src/libgdbr.c"
 g->send_buff
# 30 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
 ); 
# 30 "project/radare2/shlr/gdb/src/libgdbr.c"
...
# 30 "project/radare2/shlr/gdb/src/libgdbr.c"
 ...
 g->gdbr_lock = r_th_lock_new (
# 34 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
                              1
# 34 "project/radare2/shlr/gdb/src/libgdbr.c"
                                  );
 g->gdbr_lock_depth = 0;
 g->last_code = 
# 36 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
               0
# 36 "project/radare2/shlr/gdb/src/libgdbr.c"
                     ;
 g->connected = 0;
 g->data_len = 0;
 g->data_max = 4096;
...
# 42 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
 { free((void *)
# 42 "project/radare2/shlr/gdb/src/libgdbr.c"
 g->send_buff
# 42 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
 ); 
# 42 "project/radare2/shlr/gdb/src/libgdbr.c"
...
# 43 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
 { free((void *)
# 43 "project/radare2/shlr/gdb/src/libgdbr.c"
 g->read_buff
# 43 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
 ); 
# 43 "project/radare2/shlr/gdb/src/libgdbr.c"
...
# 43 "project/radare2/shlr/gdb/src/libgdbr.c"
 ...
 g->remote_type = 
# 46 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
                 0
# 46 "project/radare2/shlr/gdb/src/libgdbr.c"
                                    ;
 g->isbreaked = 
# 47 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
               0
# 47 "project/radare2/shlr/gdb/src/libgdbr.c"
                    ;
 return 0;
}


# 51 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
_Bool 
# 51 "project/radare2/shlr/gdb/src/libgdbr.c"
    gdbr_set_architecture(libgdbr_t *g, int arch, int bits) {
 if (!g) {
  return 
# 53 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
        0
# 53 "project/radare2/shlr/gdb/src/libgdbr.c"
             ;
 }
 if (g->target.valid && g->registers) {
  return 
# 56 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
        1
# 56 "project/radare2/shlr/gdb/src/libgdbr.c"
            ;
 }
...
# 61 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
 fprintf(__stderrp,
# 61 "project/radare2/shlr/gdb/src/libgdbr.c"
...
# 61 "project/radare2/shlr/gdb/src/libgdbr.c"
                                          ;
  return 
# 62 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
        0
# 62 "project/radare2/shlr/gdb/src/libgdbr.c"
             ;
 }
 if (!gdbr_set_reg_profile (g, regprofile)) {
  return 
# 65 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
        0
# 65 "project/radare2/shlr/gdb/src/libgdbr.c"
             ;
 }
 g->target.arch = arch;
 g->target.bits = bits;
 g->target.valid = 
# 69 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
                  1
# 69 "project/radare2/shlr/gdb/src/libgdbr.c"
                      ;

 return 
# 71 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
       1
# 71 "project/radare2/shlr/gdb/src/libgdbr.c"
           ;
}
...
const char *gdbr_get_reg_profile(int arch, int bits) {
 ...
 case R_SYS_ARCH_X86:
  if (bits == 32) {
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/reg/x86_32.h" 1 3 4

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/reg/x86_32.h" 3 4
return strdup (
"=PC	eip\n"
"=SP	esp\n"
"=BP	ebp\n"
...
# 79 "project/radare2/shlr/gdb/src/libgdbr.c" 2
  
# 79 "project/radare2/shlr/gdb/src/libgdbr.c"
 } else if (bits == 64) {
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/reg/x86_64.h" 1 3 4

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/reg/x86_64.h" 3 4
return strdup (
"=PC	rip\n"
"=SP	rsp\n"
"=BP	rbp\n"
...
# 81 "project/radare2/shlr/gdb/src/libgdbr.c" 2
  
# 81 "project/radare2/shlr/gdb/src/libgdbr.c"
 } else {
   
# 82 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
  fprintf(__stderrp,
# 82 "project/radare2/shlr/gdb/src/libgdbr.c"
...
# 82 "project/radare2/shlr/gdb/src/libgdbr.c"
                                                            ;
   return 
# 83 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
         ((void *)0)
# 83 "project/radare2/shlr/gdb/src/libgdbr.c"
             ;
  }
  break;
 case R_SYS_ARCH_ARM:
  if (bits == 32) {
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/reg/arm32.h" 1 3 4

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/reg/arm32.h" 3 4
return strdup (
"=PC	pc\n"
"=SP	sp\n"
"=A0	r0\n"
...
# 89 "project/radare2/shlr/gdb/src/libgdbr.c" 2
  
# 89 "project/radare2/shlr/gdb/src/libgdbr.c"
 } else if (bits == 64) {
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/reg/arm64.h" 1 3 4

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/reg/arm64.h" 3 4
return strdup (
"=PC	pc\n"
"=SP	sp\n"
"=BP	x29\n"
...
# 91 "project/radare2/shlr/gdb/src/libgdbr.c" 2
  
# 91 "project/radare2/shlr/gdb/src/libgdbr.c"
 } else {
   
# 92 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
  fprintf(__stderrp,
# 92 "project/radare2/shlr/gdb/src/libgdbr.c"
...
# 92 "project/radare2/shlr/gdb/src/libgdbr.c"
                                                            ;
   return 
# 93 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
         ((void *)0)
# 93 "project/radare2/shlr/gdb/src/libgdbr.c"
             ;
  }
  break;
 case R_SYS_ARCH_SH:
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/reg/sh.h" 1 3 4

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/reg/sh.h" 3 4
return strdup (
"=PC    pc\n"
"=SP    r15\n"
"=BP    r14\n"
...
# 98 "project/radare2/shlr/gdb/src/libgdbr.c" 2
  
# 98 "project/radare2/shlr/gdb/src/libgdbr.c"
 break;
 case R_SYS_ARCH_LM32:
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/reg/lm32.h" 1 3 4

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/reg/lm32.h" 3 4
return strdup (
"=PC    PC\n"
"=SP    sp\n"
"=BP    gp\n"
...
# 101 "project/radare2/shlr/gdb/src/libgdbr.c" 2
  
# 101 "project/radare2/shlr/gdb/src/libgdbr.c"
 break;
 case R_SYS_ARCH_RISCV:
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/reg/riscv.h" 1 3 4

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/reg/riscv.h" 3 4
return strdup (
 "=PC	pc\n"
 "=SP	sp\n"
 "=LR	ra\n"
...
# 104 "project/radare2/shlr/gdb/src/libgdbr.c" 2
  
# 104 "project/radare2/shlr/gdb/src/libgdbr.c"
 break;
 case R_SYS_ARCH_MIPS:
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/reg/mips.h" 1 3 4

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/reg/mips.h" 3 4
return strdup (
"=PC    pc\n"
"=SP    sp\n"
"=BP    gp\n"
...
# 107 "project/radare2/shlr/gdb/src/libgdbr.c" 2
  
# 107 "project/radare2/shlr/gdb/src/libgdbr.c"
 break;
 case R_SYS_ARCH_AVR:
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/reg/avr.h" 1 3 4

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/reg/avr.h" 3 4
return strdup (
"=PC    pc\n"
"=SP    sp\n"
"gpr	r0	.8	0	0\n"
...
# 110 "project/radare2/shlr/gdb/src/libgdbr.c" 2
  
# 110 "project/radare2/shlr/gdb/src/libgdbr.c"
 break;
 case R_SYS_ARCH_V850:
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/reg/v850.h" 1 3 4

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/reg/v850.h" 3 4
return strdup (
"=PC    pc\n"
"=SP    sp\n"
"gpr	r0	.32	0	0\n"
...
# 113 "project/radare2/shlr/gdb/src/libgdbr.c" 2
  
# 113 "project/radare2/shlr/gdb/src/libgdbr.c"
 break;
 }
 return 
# 115 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
       ((void *)0)
# 115 "project/radare2/shlr/gdb/src/libgdbr.c"
           ;
}
...
# 124 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
 fprintf(__stderrp,
# 124 "project/radare2/shlr/gdb/src/libgdbr.c"
...
# 143 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
{ free((void *)
# 143 "project/radare2/shlr/gdb/src/libgdbr.c"
g->data
# 143 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
); 
# 143 "project/radare2/shlr/gdb/src/libgdbr.c"
...
# 145 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
{ free((void *)
# 145 "project/radare2/shlr/gdb/src/libgdbr.c"
g->send_buff
# 145 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
); 
# 145 "project/radare2/shlr/gdb/src/libgdbr.c"
...
# 146 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
{ free((void *)
# 146 "project/radare2/shlr/gdb/src/libgdbr.c"
g->read_buff
# 146 "project/radare2/shlr/gdb/src/libgdbr.c" 3 4
); 
# 146 "project/radare2/shlr/gdb/src/libgdbr.c"
