# 0 "project/radare2/shlr/capstone/tests/test_evm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/capstone/tests/test_evm.c"
...
# 5 "project/radare2/shlr/capstone/tests/test_evm.c" 2
...
# 6 "project/radare2/shlr/capstone/tests/test_evm.c" 2
...
# 8 "project/radare2/shlr/capstone/tests/test_evm.c" 2
...
# 9 "project/radare2/shlr/capstone/tests/test_evm.c" 2


# 10 "project/radare2/shlr/capstone/tests/test_evm.c"
static csh handle;
...
static void print_insn_detail(csh cs_handle, cs_insn *ins)
{
 ...
 if (ins->detail == 
# 37 "project/radare2/shlr/capstone/tests/test_evm.c" 3 4
                   ((void *)0)
# 37 "project/radare2/shlr/capstone/tests/test_evm.c"
                       )
  return;
...
static void test()
{
 ...
 struct platform platforms[] = {
  {
   CS_ARCH_EVM,
   0,
   (unsigned char *)"\x60\x61\x50",
   sizeof("\x60\x61\x50") - 1,
   "EVM"
  },
 };
 ...
 for (i = 0; i < sizeof(platforms)/sizeof(platforms[0]); i++) {
  ...
  if (count) {
   ...
   for (j = 0; j < count; j++) {
    printf("0x%" 
# 99 "project/radare2/shlr/capstone/tests/test_evm.c" 3 4
                "ll" "x" 
# 99 "project/radare2/shlr/capstone/tests/test_evm.c"
                       ":\t%s\t%s\n", insn[j].address, insn[j].mnemonic, insn[j].op_str);
    print_insn_detail(handle, &insn[j]);
   }
   printf("0x%" 
# 102 "project/radare2/shlr/capstone/tests/test_evm.c" 3 4
               "ll" "x" 
# 102 "project/radare2/shlr/capstone/tests/test_evm.c"
