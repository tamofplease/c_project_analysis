# 0 "project/radare2/shlr/capstone/tests/test_ppc.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 5 "project/radare2/shlr/capstone/tests/test_ppc.c" 2
...
# 7 "project/radare2/shlr/capstone/tests/test_ppc.c" 2
...
# 8 "project/radare2/shlr/capstone/tests/test_ppc.c" 2


# 9 "project/radare2/shlr/capstone/tests/test_ppc.c"
struct platform {
 cs_arch arch;
 cs_mode mode;
 unsigned char *code;
...
static void print_insn_detail(cs_insn *ins)
{
 ...
 if (ins->detail == 
# 66 "project/radare2/shlr/capstone/tests/test_ppc.c" 3 4
                   ((void *)0)
# 66 "project/radare2/shlr/capstone/tests/test_ppc.c"
                       )
  return;
...
# 82 "project/radare2/shlr/capstone/tests/test_ppc.c" 3 4
                                             "ll" "x" 
# 82 "project/radare2/shlr/capstone/tests/test_ppc.c"
                                                    "\n", i, op->imm);
    break;
   case PPC_OP_MEM:
...
static void test()
{
 ...
 struct platform platforms[] = {
  {
   CS_ARCH_PPC,
   CS_MODE_BIG_ENDIAN,
   (unsigned char*)"\x43\x20\x0c\x07\x41\x56\xff\x17\x80\x20\x00\x00\x80\x3f\x00\x00\x10\x43\x23\x0e\xd0\x44\x00\x80\x4c\x43\x22\x02\x2d\x03\x00\x80\x7c\x43\x20\x14\x7c\x43\x20\x93\x4f\x20\x00\x21\x4c\xc8\x00\x21\x40\x82\x00\x14",
   sizeof("\x43\x20\x0c\x07\x41\x56\xff\x17\x80\x20\x00\x00\x80\x3f\x00\x00\x10\x43\x23\x0e\xd0\x44\x00\x80\x4c\x43\x22\x02\x2d\x03\x00\x80\x7c\x43\x20\x14\x7c\x43\x20\x93\x4f\x20\x00\x21\x4c\xc8\x00\x21\x40\x82\x00\x14") - 1,
   "PPC-64",
  },
  {
   CS_ARCH_PPC,
   (cs_mode)(CS_MODE_BIG_ENDIAN + CS_MODE_QPX),
   (unsigned char*)"\x10\x60\x2a\x10\x10\x64\x28\x88\x7c\x4a\x5d\x0f",
   sizeof("\x10\x60\x2a\x10\x10\x64\x28\x88\x7c\x4a\x5d\x0f") - 1,
   "PPC-64 + QPX",
  },
 };
 ...
 for (i = 0; i < sizeof(platforms)/sizeof(platforms[0]); i++) {
  ...
  if (count) {
   ...
   for (j = 0; j < count; j++) {
    printf("0x%" 
# 160 "project/radare2/shlr/capstone/tests/test_ppc.c" 3 4
                "ll" "x" 
# 160 "project/radare2/shlr/capstone/tests/test_ppc.c"
                       ":\t%s\t%s\n", insn[j].address, insn[j].mnemonic, insn[j].op_str);
    print_insn_detail(&insn[j]);
   }
   printf("0x%" 
# 163 "project/radare2/shlr/capstone/tests/test_ppc.c" 3 4
               "ll" "x" 
# 163 "project/radare2/shlr/capstone/tests/test_ppc.c"
