# 0 "project/radare2/shlr/capstone/tests/test_mips.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/capstone/tests/test_mips.c"
...
# 5 "project/radare2/shlr/capstone/tests/test_mips.c" 2
...
# 6 "project/radare2/shlr/capstone/tests/test_mips.c" 2
...
# 8 "project/radare2/shlr/capstone/tests/test_mips.c" 2
...
# 9 "project/radare2/shlr/capstone/tests/test_mips.c" 2


# 10 "project/radare2/shlr/capstone/tests/test_mips.c"
struct platform {
 cs_arch arch;
 cs_mode mode;
 unsigned char *code;
...
static void print_insn_detail(cs_insn *ins)
{
 ...
 if (ins->detail == 
# 38 "project/radare2/shlr/capstone/tests/test_mips.c" 3 4
                   ((void *)0)
# 38 "project/radare2/shlr/capstone/tests/test_mips.c"
                       )
  return;
...
# 54 "project/radare2/shlr/capstone/tests/test_mips.c" 3 4
                                             "ll" "x" 
# 54 "project/radare2/shlr/capstone/tests/test_mips.c"
                                                    "\n", i, op->imm);
    break;
   case MIPS_OP_MEM:
...
# 62 "project/radare2/shlr/capstone/tests/test_mips.c" 3 4
                                              "ll" "x" 
# 62 "project/radare2/shlr/capstone/tests/test_mips.c"
                                                     "\n", i, op->mem.disp);
...
static void test()
{
 ...
 struct platform platforms[] = {
  {
   ...
   (unsigned char *)"\x0C\x10\x00\x97\x00\x00\x00\x00\x24\x02\x00\x0c\x8f\xa2\x00\x00\x34\x21\x34\x56",
   sizeof("\x0C\x10\x00\x97\x00\x00\x00\x00\x24\x02\x00\x0c\x8f\xa2\x00\x00\x34\x21\x34\x56") - 1,
   "MIPS-32 (Big-endian)"
  },
  {
   CS_ARCH_MIPS,
   (cs_mode)(CS_MODE_MIPS64 | CS_MODE_LITTLE_ENDIAN),
   (unsigned char *)"\x56\x34\x21\x34\xc2\x17\x01\x00",
   sizeof("\x56\x34\x21\x34\xc2\x17\x01\x00") - 1,
   "MIPS-64-EL (Little-endian)"
  },
  {
   CS_ARCH_MIPS,
   (cs_mode)(CS_MODE_MIPS32R6 | CS_MODE_MICRO | CS_MODE_BIG_ENDIAN),
   (unsigned char*)"\x00\x07\x00\x07\x00\x11\x93\x7c\x01\x8c\x8b\x7c\x00\xc7\x48\xd0",
   sizeof("\x00\x07\x00\x07\x00\x11\x93\x7c\x01\x8c\x8b\x7c\x00\xc7\x48\xd0") - 1,
   "MIPS-32R6 | Micro (Big-endian)"
  },
  {
   CS_ARCH_MIPS,
   (cs_mode)(CS_MODE_MIPS32R6 | CS_MODE_BIG_ENDIAN),
   (unsigned char*)"\xec\x80\x00\x19\x7c\x43\x22\xa0",
   sizeof("\xec\x80\x00\x19\x7c\x43\x22\xa0") - 1,
   "MIPS-32R6 (Big-endian)"
  },
  {
   CS_ARCH_MIPS,
   (cs_mode)(CS_MODE_MIPS64 | CS_MODE_MIPS2 | CS_MODE_LITTLE_ENDIAN),
   (unsigned char *)"\x70\x00\xb2\xff",
   sizeof("\x70\x00\xb2\xff") - 1,
 ...
 for (i = 0; i < sizeof(platforms)/sizeof(platforms[0]); i++) {
  ...
  if (count) {
   ...
   for (j = 0; j < count; j++) {
    printf("0x%" 
# 149 "project/radare2/shlr/capstone/tests/test_mips.c" 3 4
                "ll" "x" 
# 149 "project/radare2/shlr/capstone/tests/test_mips.c"
                       ":\t%s\t%s\n", insn[j].address, insn[j].mnemonic, insn[j].op_str);
    print_insn_detail(&insn[j]);
   }
   printf("0x%" 
# 152 "project/radare2/shlr/capstone/tests/test_mips.c" 3 4
               "ll" "x" 
# 152 "project/radare2/shlr/capstone/tests/test_mips.c"
