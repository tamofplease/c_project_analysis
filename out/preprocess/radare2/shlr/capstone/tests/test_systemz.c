# 0 "project/radare2/shlr/capstone/tests/test_systemz.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/capstone/tests/test_systemz.c"
...
# 5 "project/radare2/shlr/capstone/tests/test_systemz.c" 2
...
# 7 "project/radare2/shlr/capstone/tests/test_systemz.c" 2
...
# 8 "project/radare2/shlr/capstone/tests/test_systemz.c" 2


# 9 "project/radare2/shlr/capstone/tests/test_systemz.c"
struct platform {
 cs_arch arch;
 cs_mode mode;
 unsigned char *code;
...
static void print_insn_detail(cs_insn *ins)
{
 ...
 if (ins->detail == 
# 37 "project/radare2/shlr/capstone/tests/test_systemz.c" 3 4
                   ((void *)0)
# 37 "project/radare2/shlr/capstone/tests/test_systemz.c"
                       )
  return;
...
# 56 "project/radare2/shlr/capstone/tests/test_systemz.c" 3 4
                                             "ll" "x" 
# 56 "project/radare2/shlr/capstone/tests/test_systemz.c"
                                                    "\n", i, op->imm);
    break;
   case SYSZ_OP_MEM:
    ...
    if (op->mem.length != 0)
     printf("\t\t\toperands[%u].mem.length: 0x%" 
# 67 "project/radare2/shlr/capstone/tests/test_systemz.c" 3 4
                                                "ll" "x" 
# 67 "project/radare2/shlr/capstone/tests/test_systemz.c"
                                                       "\n", i, op->mem.length);
    if (op->mem.disp != 0)
     printf("\t\t\toperands[%u].mem.disp: 0x%" 
# 69 "project/radare2/shlr/capstone/tests/test_systemz.c" 3 4
                                              "ll" "x" 
# 69 "project/radare2/shlr/capstone/tests/test_systemz.c"
                                                     "\n", i, op->mem.disp);
...
static void test()
{
 ...
 struct platform platforms[] = {
  {
   CS_ARCH_SYSZ,
   CS_MODE_BIG_ENDIAN,
   (unsigned char*)"\xed\x00\x00\x00\x00\x1a\x5a\x0f\x1f\xff\xc2\x09\x80\x00\x00\x00\x07\xf7\xeb\x2a\xff\xff\x7f\x57\xe3\x01\xff\xff\x7f\x57\xeb\x00\xf0\x00\x00\x24\xb2\x4f\x00\x78\xec\x18\x00\x00\xc1\x7f",
   sizeof("\xed\x00\x00\x00\x00\x1a\x5a\x0f\x1f\xff\xc2\x09\x80\x00\x00\x00\x07\xf7\xeb\x2a\xff\xff\x7f\x57\xe3\x01\xff\xff\x7f\x57\xeb\x00\xf0\x00\x00\x24\xb2\x4f\x00\x78\xec\x18\x00\x00\xc1\x7f") - 1,
   "SystemZ",
  },
 };
 ...
 for (i = 0; i < sizeof(platforms)/sizeof(platforms[0]); i++) {
  ...
  if (count) {
   ...
   for (j = 0; j < count; j++) {
    printf("0x%" 
# 119 "project/radare2/shlr/capstone/tests/test_systemz.c" 3 4
                "ll" "x" 
# 119 "project/radare2/shlr/capstone/tests/test_systemz.c"
                       ":\t%s\t%s\n", insn[j].address, insn[j].mnemonic, insn[j].op_str);
    print_insn_detail(&insn[j]);
   }
   printf("0x%" 
# 122 "project/radare2/shlr/capstone/tests/test_systemz.c" 3 4
               "ll" "x" 
# 122 "project/radare2/shlr/capstone/tests/test_systemz.c"
