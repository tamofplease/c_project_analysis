# 0 "project/radare2/shlr/capstone/tests/test_skipdata.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/capstone/tests/test_skipdata.c"
...
# 5 "project/radare2/shlr/capstone/tests/test_skipdata.c" 2
...
# 6 "project/radare2/shlr/capstone/tests/test_skipdata.c" 2
...
# 8 "project/radare2/shlr/capstone/tests/test_skipdata.c" 2
...
# 9 "project/radare2/shlr/capstone/tests/test_skipdata.c" 2


# 10 "project/radare2/shlr/capstone/tests/test_skipdata.c"
struct platform {
 cs_arch arch;
 cs_mode mode;
 unsigned char *code;
...
# 41 "project/radare2/shlr/capstone/tests/test_skipdata.c"
static void test()
{
# 62 "project/radare2/shlr/capstone/tests/test_skipdata.c"
 struct platform platforms[] = {
# 103 "project/radare2/shlr/capstone/tests/test_skipdata.c"
 };
 ...
 for (i = 0; i < sizeof(platforms)/sizeof(platforms[0]); i++) {
  ...
  if (count) {
   ...
   for (j = 0; j < count; j++) {
    printf("0x%" 
# 136 "project/radare2/shlr/capstone/tests/test_skipdata.c" 3 4
                "ll" "x" 
# 136 "project/radare2/shlr/capstone/tests/test_skipdata.c"
                       ":\t%s\t\t%s\n",
   ...
   printf("0x%" 
# 141 "project/radare2/shlr/capstone/tests/test_skipdata.c" 3 4
               "ll" "x" 
# 141 "project/radare2/shlr/capstone/tests/test_skipdata.c"
...
{
 test();
# 183 "project/radare2/shlr/capstone/tests/test_skipdata.c"
 return 0;
}
