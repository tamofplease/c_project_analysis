# 0 "project/radare2/shlr/capstone/tests/test_tms320c64x.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 5 "project/radare2/shlr/capstone/tests/test_tms320c64x.c" 2
...
# 7 "project/radare2/shlr/capstone/tests/test_tms320c64x.c" 2


# 8 "project/radare2/shlr/capstone/tests/test_tms320c64x.c"
struct platform {
 cs_arch arch;
 cs_mode mode;
 unsigned char *code;
...
static void print_insn_detail(cs_insn *ins)
{
 ...
 if (ins->detail == 
# 36 "project/radare2/shlr/capstone/tests/test_tms320c64x.c" 3 4
                   ((void *)0)
# 36 "project/radare2/shlr/capstone/tests/test_tms320c64x.c"
                       )
  return;
...
static void test()
{
 ...
 struct platform platforms[] = {
  {
   CS_ARCH_TMS320C64X,
   CS_MODE_BIG_ENDIAN,
   (unsigned char*)"\x01\xac\x88\x40\x81\xac\x88\x43\x00\x00\x00\x00\x02\x90\x32\x96\x02\x80\x46\x9e\x05\x3c\x83\xe6\x0b\x0c\x8b\x24",
   sizeof("\x01\xac\x88\x40\x81\xac\x88\x43\x00\x00\x00\x00\x02\x90\x32\x96\x02\x80\x46\x9e\x05\x3c\x83\xe6\x0b\x0c\x8b\x24") - 1,
   "TMS320C64x",
  },
 };
 ...
 for (i = 0; i < sizeof(platforms)/sizeof(platforms[0]); i++) {
  ...
  if (count) {
   ...
   for (j = 0; j < count; j++) {
    printf("0x%"
# 168 "project/radare2/shlr/capstone/tests/test_tms320c64x.c" 3 4
               "ll" "x"
# 168 "project/radare2/shlr/capstone/tests/test_tms320c64x.c"
                     ":\t%s\t%s\n", insn[j].address, insn[j].mnemonic, insn[j].op_str);
    print_insn_detail(&insn[j]);
   }
   printf("0x%"
# 171 "project/radare2/shlr/capstone/tests/test_tms320c64x.c" 3 4
              "ll" "x"
# 171 "project/radare2/shlr/capstone/tests/test_tms320c64x.c"
