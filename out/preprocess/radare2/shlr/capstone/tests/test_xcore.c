# 0 "project/radare2/shlr/capstone/tests/test_xcore.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/capstone/tests/test_xcore.c"
...
# 5 "project/radare2/shlr/capstone/tests/test_xcore.c" 2
...
# 7 "project/radare2/shlr/capstone/tests/test_xcore.c" 2
...
# 8 "project/radare2/shlr/capstone/tests/test_xcore.c" 2


# 9 "project/radare2/shlr/capstone/tests/test_xcore.c"
struct platform {
 cs_arch arch;
 cs_mode mode;
 unsigned char *code;
...
static void print_insn_detail(cs_insn *ins)
{
 ...
 if (ins->detail == 
# 37 "project/radare2/shlr/capstone/tests/test_xcore.c" 3 4
                   ((void *)0)
# 37 "project/radare2/shlr/capstone/tests/test_xcore.c"
                       )
  return;
...
static void test()
{
 ...
 struct platform platforms[] = {
  {
   CS_ARCH_XCORE,
   CS_MODE_BIG_ENDIAN,
   (unsigned char*)"\xfe\x0f\xfe\x17\x13\x17\xc6\xfe\xec\x17\x97\xf8\xec\x4f\x1f\xfd\xec\x37\x07\xf2\x45\x5b\xf9\xfa\x02\x06\x1b\x10\x09\xfd\xec\xa7",
   sizeof("\xfe\x0f\xfe\x17\x13\x17\xc6\xfe\xec\x17\x97\xf8\xec\x4f\x1f\xfd\xec\x37\x07\xf2\x45\x5b\xf9\xfa\x02\x06\x1b\x10\x09\xfd\xec\xa7") - 1,
   "XCore",
  },
 };
 ...
 for (i = 0; i < sizeof(platforms)/sizeof(platforms[0]); i++) {
  ...
  if (count) {
   ...
   for (j = 0; j < count; j++) {
    printf("0x%" 
# 114 "project/radare2/shlr/capstone/tests/test_xcore.c" 3 4
                "ll" "x" 
# 114 "project/radare2/shlr/capstone/tests/test_xcore.c"
                       ":\t%s\t%s\n", insn[j].address, insn[j].mnemonic, insn[j].op_str);
    print_insn_detail(&insn[j]);
   }
   printf("0x%" 
# 117 "project/radare2/shlr/capstone/tests/test_xcore.c" 3 4
               "ll" "x" 
# 117 "project/radare2/shlr/capstone/tests/test_xcore.c"
