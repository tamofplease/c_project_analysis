# 0 "project/radare2/shlr/capstone/cstool/cstool_riscv.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 5 "project/radare2/shlr/capstone/cstool/cstool_riscv.c" 2
...
# 6 "project/radare2/shlr/capstone/cstool/cstool_riscv.c" 2


# 7 "project/radare2/shlr/capstone/cstool/cstool_riscv.c"
...
void print_insn_detail_riscv(csh handle, cs_insn *ins)
{
 ...
 if (ins->detail == 
# 15 "project/radare2/shlr/capstone/cstool/cstool_riscv.c" 3 4
                   ((void *)0)
# 15 "project/radare2/shlr/capstone/cstool/cstool_riscv.c"
                       )
  return;
