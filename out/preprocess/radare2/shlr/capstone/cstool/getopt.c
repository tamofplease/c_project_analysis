# 0 "project/radare2/shlr/capstone/cstool/getopt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/capstone/cstool/getopt.c"
...
# 2 "project/radare2/shlr/capstone/cstool/getopt.c" 2
...
# 3 "project/radare2/shlr/capstone/cstool/getopt.c" 2
...
# 5 "project/radare2/shlr/capstone/cstool/getopt.c" 2
...
optreset;
const char *optarg;
# 20 "project/radare2/shlr/capstone/cstool/getopt.c"
int getopt (int nargc, char * const nargv[], const char *ostr)
{
 ...
 if (*++oli != ':') {
  optarg = 
# 55 "project/radare2/shlr/capstone/cstool/getopt.c" 3 4
          ((void *)0)
# 55 "project/radare2/shlr/capstone/cstool/getopt.c"
              ;
  if (!*place)
   ++optind;
 } else {
