# 0 "project/radare2/shlr/capstone/suite/cstest/src/m680x_detail.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 6 "project/radare2/shlr/capstone/suite/cstest/src/m680x_detail.c" 2


# 7 "project/radare2/shlr/capstone/suite/cstest/src/m680x_detail.c"
