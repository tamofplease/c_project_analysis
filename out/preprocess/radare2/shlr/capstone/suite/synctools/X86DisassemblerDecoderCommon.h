...
# 63 "project/radare2/shlr/capstone/suite/synctools/X86DisassemblerDecoderCommon.h"
enum attributeBits {
...
# 281 "project/radare2/shlr/capstone/suite/synctools/X86DisassemblerDecoderCommon.h"
typedef enum {
...
# 341 "project/radare2/shlr/capstone/suite/synctools/X86DisassemblerDecoderCommon.h"
typedef enum {
 MODRM_ONEENTRY, MODRM_SPLITRM, MODRM_SPLITMISC, MODRM_SPLITREG, MODRM_FULL,
 MODRM_max
} ModRMDecisionType;
# 408 "project/radare2/shlr/capstone/suite/synctools/X86DisassemblerDecoderCommon.h"
typedef enum {
...
# 456 "project/radare2/shlr/capstone/suite/synctools/X86DisassemblerDecoderCommon.h"
typedef enum {
...
# 477 "project/radare2/shlr/capstone/suite/synctools/X86DisassemblerDecoderCommon.h"
typedef enum {
 MODE_16BIT,
 MODE_32BIT,
 MODE_64BIT
