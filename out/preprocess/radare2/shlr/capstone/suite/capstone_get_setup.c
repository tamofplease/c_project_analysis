# 0 "project/radare2/shlr/capstone/suite/capstone_get_setup.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 15 "project/radare2/shlr/capstone/suite/capstone_get_setup.c" 2
...
# 16 "project/radare2/shlr/capstone/suite/capstone_get_setup.c" 2


# 17 "project/radare2/shlr/capstone/suite/capstone_get_setup.c"
int main()
{
 ...
 if (cs_support(
# 67 "project/radare2/shlr/capstone/suite/capstone_get_setup.c" 3 4
               (CS_ARCH_ALL + 1)
# 67 "project/radare2/shlr/capstone/suite/capstone_get_setup.c"
                              )) {
  printf("diet=1 ");
 }
 if (cs_support(
# 70 "project/radare2/shlr/capstone/suite/capstone_get_setup.c" 3 4
               (CS_ARCH_ALL + 2)
# 70 "project/radare2/shlr/capstone/suite/capstone_get_setup.c"
                                    )) {
  printf("x86_reduce=1 ");
 }
 printf("\n");
