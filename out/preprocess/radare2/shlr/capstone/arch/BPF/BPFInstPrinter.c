# 0 "project/radare2/shlr/capstone/arch/BPF/BPFInstPrinter.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 5 "project/radare2/shlr/capstone/arch/BPF/BPFInstPrinter.c" 2

# 1 "project/radare2/shlr/capstone/arch/BPF/BPFConstants.h" 1
# 7 "project/radare2/shlr/capstone/arch/BPF/BPFInstPrinter.c" 2
# 1 "project/radare2/shlr/capstone/arch/BPF/BPFInstPrinter.h" 1
...
# 8 "project/radare2/shlr/capstone/arch/BPF/BPFInstPrinter.h" 2

# 1 "project/radare2/shlr/capstone/arch/BPF/../../MCInst.h" 1
# 22 "project/radare2/shlr/capstone/arch/BPF/../../MCInst.h"
...
# 10 "project/radare2/shlr/capstone/arch/BPF/BPFInstPrinter.h" 2
...
# 11 "project/radare2/shlr/capstone/arch/BPF/BPFInstPrinter.h" 2

struct SStream;

void BPF_printInst(MCInst *MI, struct SStream *O, void *Info);
# 8 "project/radare2/shlr/capstone/arch/BPF/BPFInstPrinter.c" 2
# 1 "project/radare2/shlr/capstone/arch/BPF/BPFMapping.h" 1
# 9 "project/radare2/shlr/capstone/arch/BPF/BPFMapping.h"
# 1 "project/radare2/shlr/capstone/arch/BPF/../../cs_priv.h" 1
# 12 "project/radare2/shlr/capstone/arch/BPF/../../cs_priv.h"
# 1 "project/radare2/shlr/capstone/arch/BPF/../../MCInst.h" 1
...
void BPF_reg_access(const cs_insn *insn,
  cs_regs regs_read, uint8_t *regs_read_count,
  cs_regs regs_write, uint8_t *regs_write_count);
# 9 "project/radare2/shlr/capstone/arch/BPF/BPFInstPrinter.c" 2
...
static void convert_operands(MCInst *MI, cs_bpf *bpf)
{
 ...
 bpf->op_count = 0;
 if (((opcode) & 0x7) == 0x00 || ((opcode) & 0x7) == 0x01) {
  switch (((opcode) & 0xe0)) {
  case 0x00:
  ...
  case 0x40:
   ...
   break;
  case 0x60:
   if ((((cs_struct*)MI->csh)->mode & CS_MODE_BPF_EXTENDED)) {
 ...
 if (((opcode) & 0x7) == 0x02 || ((opcode) & 0x7) == 0x03) {
  if (!(((cs_struct*)MI->csh)->mode & CS_MODE_BPF_EXTENDED)) {
 ...
 if (((opcode) & 0x7) == 0x05) {
  for (i = 0; i < mc_op_count; i++) {
   ...
   if (MCOperand_isImm(op)) {
    ...
    if (((opcode) & 0xf0) == 0x00 ||
      (!(((cs_struct*)MI->csh)->mode & CS_MODE_BPF_EXTENDED) && i >= 1) ||
      ((((cs_struct*)MI->csh)->mode & CS_MODE_BPF_EXTENDED) && i == 2))
...
static void print_operand(MCInst *MI, struct SStream *O, const cs_bpf_op *op)
{
 ...
 case BPF_OP_IMM:
  SStream_concat(O, "0x%" 
# 215 "project/radare2/shlr/capstone/arch/BPF/BPFInstPrinter.c" 3 4
                         "ll" "x"
# 215 "project/radare2/shlr/capstone/arch/BPF/BPFInstPrinter.c"
                               , op->imm);
  break;
 case BPF_OP_OFF:
...
void BPF_printInst(MCInst *MI, struct SStream *O, void *PrinterInfo)
{
 ...
 insn.detail = 
# 260 "project/radare2/shlr/capstone/arch/BPF/BPFInstPrinter.c" 3 4
              ((void *)0)
# 260 "project/radare2/shlr/capstone/arch/BPF/BPFInstPrinter.c"
                  ;
