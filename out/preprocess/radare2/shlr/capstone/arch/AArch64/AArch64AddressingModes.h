# 0 "project/radare2/shlr/capstone/arch/AArch64/AArch64AddressingModes.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/capstone/arch/AArch64/AArch64AddressingModes.h"
# 20 "project/radare2/shlr/capstone/arch/AArch64/AArch64AddressingModes.h"
# 1 "project/radare2/shlr/capstone/arch/AArch64/../../MathExtras.h" 1
# 37 "project/radare2/shlr/capstone/arch/AArch64/../../MathExtras.h"
...
# 61 "project/radare2/shlr/capstone/arch/AArch64/../../MathExtras.h"
...
# 117 "project/radare2/shlr/capstone/arch/AArch64/../../MathExtras.h"
 return Count;
}
...
# 175 "project/radare2/shlr/capstone/arch/AArch64/../../MathExtras.h"
 return Count;
}
...
# 204 "project/radare2/shlr/capstone/arch/AArch64/../../MathExtras.h"
}
...
# 234 "project/radare2/shlr/capstone/arch/AArch64/../../MathExtras.h"
}
...
# 387 "project/radare2/shlr/capstone/arch/AArch64/../../MathExtras.h"
...
# 424 "project/radare2/shlr/capstone/arch/AArch64/../../MathExtras.h"
...
# 21 "project/radare2/shlr/capstone/arch/AArch64/AArch64AddressingModes.h" 2
...
static inline bool AArch64_AM_isSVEMaskOfIdenticalElements8(int64_t Imm)
{
 ...
 union {
  int64_t Whole;
  int8_t Parts[(sizeof(int64_t)/sizeof(int8_t))];
 } Vec;

 Vec.Whole = Imm;

 for(i = 1; i < (sizeof(int64_t)/sizeof(int8_t)); i++) {
...
static inline bool AArch64_AM_isSVEMaskOfIdenticalElements16(int64_t Imm)
{
 ...
 union {
  int64_t Whole;
  int16_t Parts[(sizeof(int64_t)/sizeof(int16_t))];
 } Vec;

 Vec.Whole = Imm;

 for(i = 1; i < (sizeof(int64_t)/sizeof(int16_t)); i++) {
  if (Vec.Parts[i] != Vec.Parts[0])
   return false;
 }
...
static inline bool AArch64_AM_isSVEMaskOfIdenticalElements32(int64_t Imm)
{
 ...
 union {
  int64_t Whole;
  int32_t Parts[(sizeof(int64_t)/sizeof(int32_t))];
 } Vec;

 Vec.Whole = Imm;

 for(i = 1; i < (sizeof(int64_t)/sizeof(int32_t)); i++) {
  if (Vec.Parts[i] != Vec.Parts[0])
   return false;
 }
