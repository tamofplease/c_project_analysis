# 0 "project/radare2/shlr/capstone/arch/WASM/WASMInstPrinter.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 1 "project/radare2/shlr/capstone/arch/WASM/WASMInstPrinter.h" 1
...
# 9 "project/radare2/shlr/capstone/arch/WASM/WASMInstPrinter.h" 2
# 1 "project/radare2/shlr/capstone/arch/WASM/../../MCInst.h" 1
# 22 "project/radare2/shlr/capstone/arch/WASM/../../MCInst.h"
...
# 22 "project/radare2/shlr/capstone/arch/WASM/../../MCRegisterInfo.h"
# 1 "/usr/local/include/capstone/platform.h" 1 3 4
...
# 26 "project/radare2/shlr/capstone/arch/WASM/../../MCRegisterInfo.h"
...
# 10 "project/radare2/shlr/capstone/arch/WASM/WASMInstPrinter.h" 2
...
# 11 "project/radare2/shlr/capstone/arch/WASM/WASMInstPrinter.h" 2
# 1 "project/radare2/shlr/capstone/arch/WASM/../../cs_priv.h" 1
# 12 "project/radare2/shlr/capstone/arch/WASM/../../cs_priv.h"
# 1 "project/radare2/shlr/capstone/arch/WASM/../../MCInst.h" 1
...
struct customized_mnem {
 ...
 char mnemonic[
# 46 "project/radare2/shlr/capstone/arch/WASM/../../cs_priv.h" 3 4
              32
# 46 "project/radare2/shlr/capstone/arch/WASM/../../cs_priv.h"
                              ];
};
...
# 12 "project/radare2/shlr/capstone/arch/WASM/WASMInstPrinter.h" 2

struct SStream;

void WASM_printInst(MCInst *MI, struct SStream *O, void *Info);
void printOperand(MCInst *MI, unsigned OpNo, SStream *O);
# 5 "project/radare2/shlr/capstone/arch/WASM/WASMInstPrinter.c" 2
...
# 6 "project/radare2/shlr/capstone/arch/WASM/WASMInstPrinter.c" 2
...
void WASM_printInst(MCInst *MI, struct SStream *O, void *PrinterInfo)
{
 ...
 switch (MI->wasm_data.type) {
  ...
  case WASM_OP_UINT32:
   SStream_concat(O, "\t0x%2" 
# 25 "project/radare2/shlr/capstone/arch/WASM/WASMInstPrinter.c" 3 4
                             "x"
# 25 "project/radare2/shlr/capstone/arch/WASM/WASMInstPrinter.c"
                                   , MI->wasm_data.uint32);
   break;

  case WASM_OP_UINT64:
   SStream_concat(O, "\t0x%2" 
# 29 "project/radare2/shlr/capstone/arch/WASM/WASMInstPrinter.c" 3 4
                             "ll" "x"
# 29 "project/radare2/shlr/capstone/arch/WASM/WASMInstPrinter.c"
                                   , MI->wasm_data.uint64);
   break;
