# 0 "project/radare2/shlr/capstone/arch/M680X/M680XDisassembler.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/capstone/arch/M680X/M680XDisassembler.c"
...
# 9 "project/radare2/shlr/capstone/arch/M680X/M680XDisassembler.c" 2
...
# 10 "project/radare2/shlr/capstone/arch/M680X/M680XDisassembler.c" 2
...
# 11 "project/radare2/shlr/capstone/arch/M680X/M680XDisassembler.c" 2

# 1 "project/radare2/shlr/capstone/arch/M680X/../../cs_priv.h" 1
# 10 "project/radare2/shlr/capstone/arch/M680X/../../cs_priv.h"
...
# 11 "project/radare2/shlr/capstone/arch/M680X/../../cs_priv.h" 2
...
# 26 "project/radare2/shlr/capstone/arch/M680X/../../MCRegisterInfo.h"
...
# 13 "project/radare2/shlr/capstone/arch/M680X/../../cs_priv.h" 2
# 1 "project/radare2/shlr/capstone/arch/M680X/../../SStream.h" 1
...
# 8 "project/radare2/shlr/capstone/arch/M680X/../../SStream.h" 2
...
# 14 "project/radare2/shlr/capstone/arch/M680X/../../cs_priv.h" 2
...
typedef 
# 21 "project/radare2/shlr/capstone/arch/M680X/../../cs_priv.h" 3 4
       _Bool 
# 21 "project/radare2/shlr/capstone/arch/M680X/../../cs_priv.h"
...
struct customized_mnem {
 ...
 char mnemonic[
# 46 "project/radare2/shlr/capstone/arch/M680X/../../cs_priv.h" 3 4
              32
# 46 "project/radare2/shlr/capstone/arch/M680X/../../cs_priv.h"
                              ];
};
...
# 70 "project/radare2/shlr/capstone/arch/M680X/../../cs_priv.h" 3 4
_Bool 
# 70 "project/radare2/shlr/capstone/arch/M680X/../../cs_priv.h"
     doing_mem;
 unsigned short *insn_cache;
 GetRegisterName_t get_regname;
 
# 73 "project/radare2/shlr/capstone/arch/M680X/../../cs_priv.h" 3 4
_Bool 
# 73 "project/radare2/shlr/capstone/arch/M680X/../../cs_priv.h"
     skipdata;
...
# 13 "project/radare2/shlr/capstone/arch/M680X/M680XDisassembler.c" 2
# 1 "project/radare2/shlr/capstone/arch/M680X/../../utils.h" 1
# 10 "project/radare2/shlr/capstone/arch/M680X/../../utils.h"
...
# 11 "project/radare2/shlr/capstone/arch/M680X/../../utils.h" 2


# 1 "project/radare2/shlr/capstone/arch/M680X/../../cs_priv.h" 1
# 14 "project/radare2/shlr/capstone/arch/M680X/../../utils.h" 2
...
# 19 "project/radare2/shlr/capstone/arch/M680X/../../utils.h"
...
# 26 "project/radare2/shlr/capstone/arch/M680X/../../utils.h" 3 4
_Bool 
# 26 "project/radare2/shlr/capstone/arch/M680X/../../utils.h"
     branch;
 
# 27 "project/radare2/shlr/capstone/arch/M680X/../../utils.h" 3 4
_Bool 
# 27 "project/radare2/shlr/capstone/arch/M680X/../../utils.h"
     indirect_branch;
...
# 67 "project/radare2/shlr/capstone/arch/M680X/../../utils.h" 3 4
_Bool 
# 67 "project/radare2/shlr/capstone/arch/M680X/../../utils.h"
    arr_exist8(unsigned char *arr, unsigned char max, unsigned int id);


# 69 "project/radare2/shlr/capstone/arch/M680X/../../utils.h" 3 4
_Bool 
# 69 "project/radare2/shlr/capstone/arch/M680X/../../utils.h"
...
# 14 "project/radare2/shlr/capstone/arch/M680X/M680XDisassembler.c" 2

# 1 "project/radare2/shlr/capstone/arch/M680X/../../MCInst.h" 1
# 16 "project/radare2/shlr/capstone/arch/M680X/M680XDisassembler.c" 2
# 1 "project/radare2/shlr/capstone/arch/M680X/../../MCInstrDesc.h" 1
# 29 "project/radare2/shlr/capstone/arch/M680X/../../MCInstrDesc.h"
...
# 95 "project/radare2/shlr/capstone/arch/M680X/../../MCInstrDesc.h"
enum {
 MCID_Variadic = 0,
 MCID_HasOptionalDef,
 MCID_Pseudo,
...
# 143 "project/radare2/shlr/capstone/arch/M680X/../../MCInstrDesc.h" 3 4
_Bool 
# 143 "project/radare2/shlr/capstone/arch/M680X/../../MCInstrDesc.h"
    MCOperandInfo_isPredicate(const MCOperandInfo *m);


# 145 "project/radare2/shlr/capstone/arch/M680X/../../MCInstrDesc.h" 3 4
_Bool 
# 145 "project/radare2/shlr/capstone/arch/M680X/../../MCInstrDesc.h"
    MCOperandInfo_isOptionalDef(const MCOperandInfo *m);
# 17 "project/radare2/shlr/capstone/arch/M680X/M680XDisassembler.c" 2
# 1 "project/radare2/shlr/capstone/arch/M680X/../../MCRegisterInfo.h" 1
# 18 "project/radare2/shlr/capstone/arch/M680X/M680XDisassembler.c" 2
# 1 "project/radare2/shlr/capstone/arch/M680X/M680XInstPrinter.h" 1
# 12 "project/radare2/shlr/capstone/arch/M680X/M680XInstPrinter.h"
struct SStream;
...
void M680X_post_printer(csh handle, cs_insn *flat_insn, char *insn_asm,
 MCInst *mci);
# 19 "project/radare2/shlr/capstone/arch/M680X/M680XDisassembler.c" 2
# 1 "project/radare2/shlr/capstone/arch/M680X/M680XDisassembler.h" 1
# 9 "project/radare2/shlr/capstone/arch/M680X/M680XDisassembler.h"

# 9 "project/radare2/shlr/capstone/arch/M680X/M680XDisassembler.h" 3 4
_Bool 
# 9 "project/radare2/shlr/capstone/arch/M680X/M680XDisassembler.h"
    M680X_getInstruction(csh ud, const uint8_t *code, size_t code_len,
 MCInst *instr, uint16_t *size, uint64_t address, void *info);
void M680X_get_insn_id(cs_struct *h, cs_insn *insn, unsigned int id);
void M680X_reg_access(const cs_insn *insn,
 cs_regs regs_read, uint8_t *regs_read_count,
 cs_regs regs_write, uint8_t *regs_write_count);
# 20 "project/radare2/shlr/capstone/arch/M680X/M680XDisassembler.c" 2
# 1 "project/radare2/shlr/capstone/arch/M680X/M680XDisassemblerInternals.h" 1
...
# 21 "project/radare2/shlr/capstone/arch/M680X/M680XDisassembler.c" 2
