# 0 "project/radare2/shlr/bochs/src/libbochs.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 6 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/bochs/include/libbochs.h" 2 3 4
...
# 4 "project/radare2/shlr/bochs/src/libbochs.c" 2


# 5 "project/radare2/shlr/bochs/src/libbochs.c"
static char *lpTmpBuffer;
# 42 "project/radare2/shlr/bochs/src/libbochs.c"
void bochs_reset_buffer(libbochs_t* b) {
 
# 43 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
__builtin___memset_chk (
# 43 "project/radare2/shlr/bochs/src/libbochs.c"
b->data
# 43 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
, 
# 43 "project/radare2/shlr/bochs/src/libbochs.c"
...
# 47 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
_Bool 
# 47 "project/radare2/shlr/bochs/src/libbochs.c"
    bochs_cmd_stop(libbochs_t * b) {
# 68 "project/radare2/shlr/bochs/src/libbochs.c"
 return 0;

}


# 72 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
_Bool 
# 72 "project/radare2/shlr/bochs/src/libbochs.c"
    bochs_wait(libbochs_t *b) {
# 94 "project/radare2/shlr/bochs/src/libbochs.c"
 int flags,n;
 bochs_reset_buffer (b);
 flags = fcntl (b->hReadPipeIn, 
# 96 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
                               3
# 96 "project/radare2/shlr/bochs/src/libbochs.c"
                                      , 0);
 (void) fcntl (b->hReadPipeIn, (flags | 
# 97 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
                                       0x00000004
# 97 "project/radare2/shlr/bochs/src/libbochs.c"
                                                 ));
 for (;;) {
  n = read (b->hReadPipeIn, lpTmpBuffer, 0x5800 * 2 - 1);
  if (n > 0) {
   lpTmpBuffer[n] = 0;
   if (b->punteroBuffer + n >= 0x5800 * 2 - 1) {
    bochs_reset_buffer(b);
   }

   
# 106 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
  __builtin___memcpy_chk (
# 106 "project/radare2/shlr/bochs/src/libbochs.c"
  b->data + b->punteroBuffer
# 106 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
  , 
# 106 "project/radare2/shlr/bochs/src/libbochs.c"
  lpTmpBuffer, n + 1
...
# 106 "project/radare2/shlr/bochs/src/libbochs.c"
 ...
 (void) fcntl (b->hReadPipeIn, (flags | ~
# 113 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
                                        0x00000004
# 113 "project/radare2/shlr/bochs/src/libbochs.c"
                                                  ));
 return 
# 114 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
       1
# 114 "project/radare2/shlr/bochs/src/libbochs.c"
           ;

}

void bochs_send_cmd(libbochs_t* b, const char *cmd, 
# 118 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
                                                   _Bool 
# 118 "project/radare2/shlr/bochs/src/libbochs.c"
                                                        bWait) {
...
# 128 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
 fprintf(__stderrp,
# 128 "project/radare2/shlr/bochs/src/libbochs.c"
...
# 137 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
                             unsigned long long 
# 137 "project/radare2/shlr/bochs/src/libbochs.c"
                                  addr, int count, 
# 137 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
                                                   unsigned char 
# 137 "project/radare2/shlr/bochs/src/libbochs.c"
 ...
 totalread = (count >0x5800 * 2 / 3)? 0x5800 * 2 / 3: count;
 
# 142 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
__builtin___snprintf_chk (
# 142 "project/radare2/shlr/bochs/src/libbochs.c"
buff
# 142 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
, 
# 142 "project/radare2/shlr/bochs/src/libbochs.c"
...
# 142 "project/radare2/shlr/bochs/src/libbochs.c"
                                                                           ;
 bochs_send_cmd (b, buff, 
# 143 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
                         1
# 143 "project/radare2/shlr/bochs/src/libbochs.c"
                             );
 data = strstr (&b->data[0], "[bochs]:");
 if (!data) {
  
# 146 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
 fprintf(__stderrp,
# 146 "project/radare2/shlr/bochs/src/libbochs.c"
...
# 146 "project/radare2/shlr/bochs/src/libbochs.c"
                                                  ;
  return 
# 147 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
        0
# 147 "project/radare2/shlr/bochs/src/libbochs.c"
             ;
 }
 lenRec = strlen (data);
...
void bochs_close(libbochs_t* b) {
 b->isRunning = 
# 170 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
               0
# 170 "project/radare2/shlr/bochs/src/libbochs.c"
                    ;
# 181 "project/radare2/shlr/bochs/src/libbochs.c"
 close (b->hReadPipeIn);
 close (b->hWritePipeOut);
 kill (b->pid, 
# 183 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
              9
# 183 "project/radare2/shlr/bochs/src/libbochs.c"
                     );
 
# 184 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
{ free((void *)
# 184 "project/radare2/shlr/bochs/src/libbochs.c"
b->data
# 184 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
); 
# 184 "project/radare2/shlr/bochs/src/libbochs.c"
...
# 185 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
{ free((void *)
# 185 "project/radare2/shlr/bochs/src/libbochs.c"
lpTmpBuffer
# 185 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
); 
# 185 "project/radare2/shlr/bochs/src/libbochs.c"
...
# 189 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
_Bool 
# 189 "project/radare2/shlr/bochs/src/libbochs.c"
    bochs_open(libbochs_t* b, const char * pathBochs, const char * pathConfig) {
 
# 190 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
_Bool 
# 190 "project/radare2/shlr/bochs/src/libbochs.c"
     result = 
# 190 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
              0
# 190 "project/radare2/shlr/bochs/src/libbochs.c"
 ...
 b->data = malloc (0x5800 * 2);
 if (!b->data) {
  return 
# 194 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
        0
# 194 "project/radare2/shlr/bochs/src/libbochs.c"
             ;
 }
 lpTmpBuffer = malloc (0x5800 * 2);
 if (!lpTmpBuffer) {
  
# 198 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
 { free((void *)
# 198 "project/radare2/shlr/bochs/src/libbochs.c"
 b->data
# 198 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
 ); 
# 198 "project/radare2/shlr/bochs/src/libbochs.c"
...
# 198 "project/radare2/shlr/bochs/src/libbochs.c"
                 ;
  return 
# 199 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
        0
# 199 "project/radare2/shlr/bochs/src/libbochs.c"
             ;
 }
# 243 "project/radare2/shlr/bochs/src/libbochs.c"
 int aStdinPipe[2];
 int aStdoutPipe[2];
 int nChild;
...
# 248 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
 fprintf(__stderrp,
# 248 "project/radare2/shlr/bochs/src/libbochs.c"
...
# 248 "project/radare2/shlr/bochs/src/libbochs.c"
                                                            ;
  return 
# 249 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
        0
# 249 "project/radare2/shlr/bochs/src/libbochs.c"
             ;
 }
...
# 254 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
 fprintf(__stderrp,
# 254 "project/radare2/shlr/bochs/src/libbochs.c"
...
# 254 "project/radare2/shlr/bochs/src/libbochs.c"
                                                             ;
  return 
# 255 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
        0
# 255 "project/radare2/shlr/bochs/src/libbochs.c"
             ;
 }
 ...
 if (0 == nChild) {
  ...
  if (dup2 (aStdinPipe[0], 
# 261 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
                                  0
# 261 "project/radare2/shlr/bochs/src/libbochs.c"
                                              ) == -1) {
   
# 262 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
  fprintf(__stderrp,
# 262 "project/radare2/shlr/bochs/src/libbochs.c"
...
# 262 "project/radare2/shlr/bochs/src/libbochs.c"
                                      ;
   return 
# 263 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
         0
# 263 "project/radare2/shlr/bochs/src/libbochs.c"
              ;
  }


  if (dup2 (aStdoutPipe[1], 
# 267 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
                                    1
# 267 "project/radare2/shlr/bochs/src/libbochs.c"
                                                 ) == -1) {
   
# 268 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
  fprintf(__stderrp,
# 268 "project/radare2/shlr/bochs/src/libbochs.c"
...
# 268 "project/radare2/shlr/bochs/src/libbochs.c"
                                       ;
   return 
# 269 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
         0
# 269 "project/radare2/shlr/bochs/src/libbochs.c"
              ;
  }


  if (dup2 (aStdoutPipe[1], 
# 273 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
                                    2
# 273 "project/radare2/shlr/bochs/src/libbochs.c"
                                                 ) == -1) {
   
# 274 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
  fprintf(__stderrp,
# 274 "project/radare2/shlr/bochs/src/libbochs.c"
...
# 274 "project/radare2/shlr/bochs/src/libbochs.c"
                                       ;
   return 
# 275 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
         0
# 275 "project/radare2/shlr/bochs/src/libbochs.c"
              ;
  }
  ...
  close (aStdoutPipe[0]);
  close (aStdoutPipe[1]);
  (void) execl (pathBochs, pathBochs, "-q", "-f", pathConfig, 
# 282 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
                                                             ((void *)0)
# 282 "project/radare2/shlr/bochs/src/libbochs.c"
                                                                 );
  perror ("execl");
  exit (1);
 } else if (nChild > 0) {
...
# 290 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
  fprintf(__stderrp,
# 290 "project/radare2/shlr/bochs/src/libbochs.c"
  "boch_open failed"
# 290 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
  )
# 290 "project/radare2/shlr/bochs/src/libbochs.c"
   ...
   b->isRunning = 
# 295 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
                 1
# 295 "project/radare2/shlr/bochs/src/libbochs.c"
                     ;
   bochs_reset_buffer (b);
   
# 297 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
  fprintf(__stderrp,
# 297 "project/radare2/shlr/bochs/src/libbochs.c"
  "Waiting for bochs...\n"
# 297 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
  )
# 297 "project/radare2/shlr/bochs/src/libbochs.c"
...
# 299 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
   fprintf(__stderrp,
# 299 "project/radare2/shlr/bochs/src/libbochs.c"
   "Ready.\n"
# 299 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
   )
# 299 "project/radare2/shlr/bochs/src/libbochs.c"
    ...
    b->pid = nChild;
    result = 
# 301 "project/radare2/shlr/bochs/src/libbochs.c" 3 4
            1
# 301 "project/radare2/shlr/bochs/src/libbochs.c"
                ;
   } else {
    bochs_close (b);
   }
