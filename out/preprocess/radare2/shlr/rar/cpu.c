# 0 "project/radare2/shlr/rar/cpu.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/shlr/rar/cpu.c"
...
# 5 "project/radare2/shlr/rar/cpu.c" 2
...
# 6 "project/radare2/shlr/rar/cpu.c" 2
...
# 12 "project/radare2/shlr/rar/cpu.c"
static const char *skipspaces(const char *x) { if (x) while (*x==' '||*x=='\t') x++; return x; }
...
# 125 "project/radare2/shlr/rar/cpu.c"
...
static inline const char *opcode_str (int n) {
 ...
 return 
# 138 "project/radare2/shlr/rar/cpu.c" 3 4
       ((void *)0)
# 138 "project/radare2/shlr/rar/cpu.c"
           ;
}
