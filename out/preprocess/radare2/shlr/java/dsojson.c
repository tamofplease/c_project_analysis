# 0 "project/radare2/shlr/java/dsojson.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
typedef int RRef;
# 7 "project/radare2/shlr/java/dsojson.h" 2
...
# 8 "project/radare2/shlr/java/dsojson.h" 2
...
# 112 "project/radare2/shlr/java/dsojson.h"
                                                        len );
# 4 "project/radare2/shlr/java/dsojson.c" 2
# 1 "project/radare2/shlr/java/class.h" 1
# 12 "project/radare2/shlr/java/class.h"
...
# 1068 "project/radare2/shlr/java/class.h"
                                                       buf_sz);
# 5 "project/radare2/shlr/java/dsojson.c" 2
...
# 34 "project/radare2/shlr/java/dsojson.c" 3 4
if (
# 34 "project/radare2/shlr/java/dsojson.c"
the_list
# 34 "project/radare2/shlr/java/dsojson.c" 3 4
) for (
# 34 "project/radare2/shlr/java/dsojson.c"
...
static char * build_str_from_str_list_for_iterable (RList *the_list, int is_array) {
 char *res = 
# 46 "project/radare2/shlr/java/dsojson.c" 3 4
            ((void *)0)
# 46 "project/radare2/shlr/java/dsojson.c"
                , *str;
 int len = 3, pos = 1;
 RListIter *iter = 
# 48 "project/radare2/shlr/java/dsojson.c" 3 4
                  ((void *)0)
# 48 "project/radare2/shlr/java/dsojson.c"
                      ;
 RList *str_list = build_str_list_from_iterable (the_list);

 
# 51 "project/radare2/shlr/java/dsojson.c" 3 4
if (
# 51 "project/radare2/shlr/java/dsojson.c"
str_list
# 51 "project/radare2/shlr/java/dsojson.c" 3 4
) for (
# 51 "project/radare2/shlr/java/dsojson.c"
...
# 58 "project/radare2/shlr/java/dsojson.c" 3 4
 __builtin___strcpy_chk (
# 58 "project/radare2/shlr/java/dsojson.c"
 res
# 58 "project/radare2/shlr/java/dsojson.c" 3 4
 , 
# 58 "project/radare2/shlr/java/dsojson.c"
...
# 59 "project/radare2/shlr/java/dsojson.c" 3 4
 if (
# 59 "project/radare2/shlr/java/dsojson.c"
 str_list
# 59 "project/radare2/shlr/java/dsojson.c" 3 4
 ) for (
# 59 "project/radare2/shlr/java/dsojson.c"
...
# 59 "project/radare2/shlr/java/dsojson.c"
                                      {
   pos += 
# 60 "project/radare2/shlr/java/dsojson.c" 3 4
         __builtin___snprintf_chk (
# 60 "project/radare2/shlr/java/dsojson.c"
         res+pos
# 60 "project/radare2/shlr/java/dsojson.c" 3 4
         , 
# 60 "project/radare2/shlr/java/dsojson.c"
...
# 61 "project/radare2/shlr/java/dsojson.c"
                         ;
  }
  
# 63 "project/radare2/shlr/java/dsojson.c" 3 4
 __builtin___strcat_chk (
# 63 "project/radare2/shlr/java/dsojson.c"
 res
# 63 "project/radare2/shlr/java/dsojson.c" 3 4
 , 
# 63 "project/radare2/shlr/java/dsojson.c"
...
# 85 "project/radare2/shlr/java/dsojson.c" 3 4
unsigned char 
# 85 "project/radare2/shlr/java/dsojson.c"
    dso_json_char_needs_hexing ( 
# 85 "project/radare2/shlr/java/dsojson.c" 3 4
                                 unsigned char 
# 85 "project/radare2/shlr/java/dsojson.c"
...
char * dso_json_obj_to_str (DsoJsonObj * dso_obj) {
 ...
 return 
# 113 "project/radare2/shlr/java/dsojson.c" 3 4
       ((void *)0)
# 113 "project/radare2/shlr/java/dsojson.c"
           ;
}
...
static const DsoJsonInfo* get_type_info (unsigned int type) {
 ...
 return 
# 138 "project/radare2/shlr/java/dsojson.c" 3 4
       ((void *)0)
# 138 "project/radare2/shlr/java/dsojson.c"
           ;
}
...
static RList * dso_json_get_list (DsoJsonObj *dso_obj) {
 RList *the_list = 
# 155 "project/radare2/shlr/java/dsojson.c" 3 4
                  ((void *)0)
# 155 "project/radare2/shlr/java/dsojson.c"
                      ;
 if (dso_obj) {
  switch (dso_obj->info->type) {
...
static char * dso_json_get_str_data (DsoJsonObj *dso_obj) {
 ...
 return 
# 169 "project/radare2/shlr/java/dsojson.c" 3 4
       ((void *)0)
# 169 "project/radare2/shlr/java/dsojson.c"
           ;
}

static DsoJsonStr * dso_json_get_str (DsoJsonObj *dso_obj) {
 DsoJsonStr * str = 
# 173 "project/radare2/shlr/java/dsojson.c" 3 4
                   ((void *)0)
# 173 "project/radare2/shlr/java/dsojson.c"
                       ;
 if (dso_obj) {
  switch (dso_obj->info->type) {
...
DsoJsonObj * dso_json_null_new () {
 ...
 if (!x) return 
# 186 "project/radare2/shlr/java/dsojson.c" 3 4
               ((void *)0)
# 186 "project/radare2/shlr/java/dsojson.c"
                   ;
...
DsoJsonObj * dso_json_str_new () {
 ...
 if (!x) return 
# 197 "project/radare2/shlr/java/dsojson.c" 3 4
               ((void *)0)
# 197 "project/radare2/shlr/java/dsojson.c"
                   ;
...
# 206 "project/radare2/shlr/java/dsojson.c" 3 4
 { free((void *)
# 206 "project/radare2/shlr/java/dsojson.c"
 x->data
# 206 "project/radare2/shlr/java/dsojson.c" 3 4
 ); 
# 206 "project/radare2/shlr/java/dsojson.c"
...
DsoJsonObj * dso_json_dict_entry_new () {
 DsoJsonObj *x = dso_json_null_new ();
 if (!x) return 
# 213 "project/radare2/shlr/java/dsojson.c" 3 4
               ((void *)0)
# 213 "project/radare2/shlr/java/dsojson.c"
                   ;
 ...
 if (!x->val._dict_entry) {
  ...
  return 
# 218 "project/radare2/shlr/java/dsojson.c" 3 4
        ((void *)0)
# 218 "project/radare2/shlr/java/dsojson.c"
            ;
 }
...
DsoJsonObj * dso_json_dict_entry_new_from_key_obj_val_obj (DsoJsonObj *key, DsoJsonObj *value) {
 ...
 if (!x) return 
# 227 "project/radare2/shlr/java/dsojson.c" 3 4
               ((void *)0)
# 227 "project/radare2/shlr/java/dsojson.c"
                   ;
...
void dso_json_dict_entry_free (void *y) {
 ...
 if (entry) {
  ...
  entry->key = 
# 240 "project/radare2/shlr/java/dsojson.c" 3 4
              ((void *)0)
# 240 "project/radare2/shlr/java/dsojson.c"
                  ;
  entry->value = 
# 241 "project/radare2/shlr/java/dsojson.c" 3 4
                ((void *)0)
# 241 "project/radare2/shlr/java/dsojson.c"
                    ;
 }
 free (entry);
}
...
char * dso_json_dict_entry_to_str (DsoJsonDictEntry * entry) {
 char *res = 
# 247 "project/radare2/shlr/java/dsojson.c" 3 4
            ((void *)0)
# 247 "project/radare2/shlr/java/dsojson.c"
                ;
 if (entry) {
...
# 257 "project/radare2/shlr/java/dsojson.c" 3 4
    __builtin___snprintf_chk (
# 257 "project/radare2/shlr/java/dsojson.c"
    res
# 257 "project/radare2/shlr/java/dsojson.c" 3 4
    , 
# 257 "project/radare2/shlr/java/dsojson.c"
...
# 259 "project/radare2/shlr/java/dsojson.c" 3 4
    __builtin___snprintf_chk (
# 259 "project/radare2/shlr/java/dsojson.c"
    res
# 259 "project/radare2/shlr/java/dsojson.c" 3 4
    , 
# 259 "project/radare2/shlr/java/dsojson.c"
...
int dso_json_dict_entry_set_key_str (DsoJsonObj * entry_obj, char *key) {
 int res = 
# 270 "project/radare2/shlr/java/dsojson.c" 3 4
          0
# 270 "project/radare2/shlr/java/dsojson.c"
               ;
 if (dso_json_is_dict_entry (entry_obj)) {
  ...
  entry->key = o_key;
  res = 
# 278 "project/radare2/shlr/java/dsojson.c" 3 4
       1
# 278 "project/radare2/shlr/java/dsojson.c"
           ;
 }
 return res;
}
...
int dso_json_dict_entry_set_key_str_len (DsoJsonObj * entry_obj, char *key, unsigned int len) {
 int res = 
# 284 "project/radare2/shlr/java/dsojson.c" 3 4
          0
# 284 "project/radare2/shlr/java/dsojson.c"
               ;
 if (dso_json_is_dict_entry (entry_obj)) {
  DsoJsonDictEntry *entry = (DsoJsonDictEntry *)entry_obj;
  ...
  entry->key = o_key;
  res = 
# 292 "project/radare2/shlr/java/dsojson.c" 3 4
       1
# 292 "project/radare2/shlr/java/dsojson.c"
           ;
 }
 return res;
}
...
int dso_json_dict_entry_set_key_num (DsoJsonObj * entry_obj, 
# 297 "project/radare2/shlr/java/dsojson.c" 3 4
                                                            long long 
# 297 "project/radare2/shlr/java/dsojson.c"
                                                                 num) {
 int res = 
# 298 "project/radare2/shlr/java/dsojson.c" 3 4
          0
# 298 "project/radare2/shlr/java/dsojson.c"
               ;
 if (dso_json_is_dict_entry (entry_obj)) {
  DsoJsonDictEntry *entry = (DsoJsonDictEntry *)entry_obj;
  ...
  entry->key = o_key;
  res = 
# 306 "project/radare2/shlr/java/dsojson.c" 3 4
       1
# 306 "project/radare2/shlr/java/dsojson.c"
           ;
 }
 return res;
}
...
int dso_json_dict_entry_value_append_str (DsoJsonObj *entry_obj, char *str) {
 int res = 
# 312 "project/radare2/shlr/java/dsojson.c" 3 4
          0
# 312 "project/radare2/shlr/java/dsojson.c"
               ;
 if (dso_json_is_dict_entry (entry_obj)) {
...
int dso_json_dict_entry_value_append_str_len (DsoJsonObj *entry_obj, char *str, unsigned int len) {
 int res = 
# 322 "project/radare2/shlr/java/dsojson.c" 3 4
          0
# 322 "project/radare2/shlr/java/dsojson.c"
               ;
 if (dso_json_is_dict_entry (entry_obj)) {
...
int dso_json_dict_entry_value_append_num (DsoJsonObj *entry_obj, 
# 331 "project/radare2/shlr/java/dsojson.c" 3 4
                                                                long long 
# 331 "project/radare2/shlr/java/dsojson.c"
                                                                     num) {
 int res = 
# 332 "project/radare2/shlr/java/dsojson.c" 3 4
          0
# 332 "project/radare2/shlr/java/dsojson.c"
               ;
 if (dso_json_is_dict_entry (entry_obj)) {
...
int dso_json_dict_entry_value_append_obj (DsoJsonObj *entry_obj, DsoJsonObj *obj) {
 if (dso_json_is_dict_entry (entry_obj)) {
  ...
  if (dso_json_is_list (x->value)) {
   ...
   return 
# 358 "project/radare2/shlr/java/dsojson.c" 3 4
         1
# 358 "project/radare2/shlr/java/dsojson.c"
             ;
  }
 }
 return 
# 361 "project/radare2/shlr/java/dsojson.c" 3 4
       0
# 361 "project/radare2/shlr/java/dsojson.c"
            ;
}

int dso_json_dict_entry_value_set_str (DsoJsonObj *entry_obj, char *str) {
 int res = 
# 365 "project/radare2/shlr/java/dsojson.c" 3 4
          0
# 365 "project/radare2/shlr/java/dsojson.c"
               ;
 if (dso_json_is_dict_entry (entry_obj)) {
...
int dso_json_dict_entry_value_set_str_len (DsoJsonObj *entry_obj, char *str, unsigned int len) {
 int res = 
# 374 "project/radare2/shlr/java/dsojson.c" 3 4
          0
# 374 "project/radare2/shlr/java/dsojson.c"
               ;
 if (dso_json_is_dict_entry (entry_obj)) {
...
int dso_json_dict_entry_value_set_num (DsoJsonObj *entry_obj, 
# 382 "project/radare2/shlr/java/dsojson.c" 3 4
                                                             long long 
# 382 "project/radare2/shlr/java/dsojson.c"
                                                                  num) {
 int res = 
# 383 "project/radare2/shlr/java/dsojson.c" 3 4
          0
# 383 "project/radare2/shlr/java/dsojson.c"
               ;
 if (dso_json_is_dict_entry (entry_obj)) {
...
int dso_json_dict_entry_value_set_empty_dict (DsoJsonObj *entry_obj) {
 int res = 
# 392 "project/radare2/shlr/java/dsojson.c" 3 4
          0
# 392 "project/radare2/shlr/java/dsojson.c"
               ;
 if (dso_json_is_dict_entry (entry_obj)) {
...
int dso_json_dict_entry_value_set_empty_list (DsoJsonObj *entry_obj) {
 int res = 
# 401 "project/radare2/shlr/java/dsojson.c" 3 4
          0
# 401 "project/radare2/shlr/java/dsojson.c"
               ;
 if (dso_json_is_dict_entry (entry_obj)) {
...
int dso_json_dict_entry_value_set_obj (DsoJsonObj *entry_obj, DsoJsonObj *obj) {
 if (dso_json_is_dict_entry (entry_obj)) {
  ...
  entry->value = obj;
  return 
# 414 "project/radare2/shlr/java/dsojson.c" 3 4
        1
# 414 "project/radare2/shlr/java/dsojson.c"
            ;
 }
 return 
# 416 "project/radare2/shlr/java/dsojson.c" 3 4
       0
# 416 "project/radare2/shlr/java/dsojson.c"
            ;
}
...
# 427 "project/radare2/shlr/java/dsojson.c" 3 4
  { free((void *)
# 427 "project/radare2/shlr/java/dsojson.c"
  x
# 427 "project/radare2/shlr/java/dsojson.c" 3 4
  ); 
# 427 "project/radare2/shlr/java/dsojson.c"
...
void dso_json_list_free (DsoJsonObj *x) {
 ...
 if (x->val._list && x->val._list->json_list) {
  ...
  x->val._list->json_list = 
# 437 "project/radare2/shlr/java/dsojson.c" 3 4
                           ((void *)0)
# 437 "project/radare2/shlr/java/dsojson.c"
                               ;
 }
}
...
int dso_json_list_append (DsoJsonObj *list_obj, DsoJsonObj *y) {
 if (get_type (list_obj) == DSO_JSON_LIST) {
  ...
  return 
# 452 "project/radare2/shlr/java/dsojson.c" 3 4
        1
# 452 "project/radare2/shlr/java/dsojson.c"
            ;
 }
 return 
# 454 "project/radare2/shlr/java/dsojson.c" 3 4
       0
# 454 "project/radare2/shlr/java/dsojson.c"
            ;
}
...
int dso_json_list_append_str (DsoJsonObj *list_obj, char *y) {
 ...
 return 
# 464 "project/radare2/shlr/java/dsojson.c" 3 4
       0
# 464 "project/radare2/shlr/java/dsojson.c"
            ;
}

int dso_json_list_append_num (DsoJsonObj *list_obj, 
# 467 "project/radare2/shlr/java/dsojson.c" 3 4
                                                   unsigned long long 
# 467 "project/radare2/shlr/java/dsojson.c"
                                                        y) {
 if (get_type (list_obj) == DSO_JSON_LIST) {
 ...
 return 
# 474 "project/radare2/shlr/java/dsojson.c" 3 4
       0
# 474 "project/radare2/shlr/java/dsojson.c"
            ;
}
...
DsoJsonObj * dso_json_dict_new () {
 ...
 if (x) {
  ...
  if (!x->val._dict) {
   dso_json_null_free (x);
   return 
# 484 "project/radare2/shlr/java/dsojson.c" 3 4
         ((void *)0)
# 484 "project/radare2/shlr/java/dsojson.c"
             ;
  }
...
void dso_json_dict_free (void *y) {
 ...
 if (x && x->json_dict) {
  ...
  x->json_dict = 
# 495 "project/radare2/shlr/java/dsojson.c" 3 4
                ((void *)0)
# 495 "project/radare2/shlr/java/dsojson.c"
                    ;
 }
 free (x);
}
...
int dso_json_dict_insert_key_obj (DsoJsonObj *dict, DsoJsonObj *key, DsoJsonObj *value) {
 int res = 
# 569 "project/radare2/shlr/java/dsojson.c" 3 4
          0
# 569 "project/radare2/shlr/java/dsojson.c"
               ;
 RList* the_list = dso_json_get_list (dict);
 if (!the_list) return 
# 571 "project/radare2/shlr/java/dsojson.c" 3 4
                      0
# 571 "project/radare2/shlr/java/dsojson.c"
                           ;
 if (get_type (key) != DSO_JSON_STR) return 
# 572 "project/radare2/shlr/java/dsojson.c" 3 4
                                           0
# 572 "project/radare2/shlr/java/dsojson.c"
                                                ;
 ...
 if (value && key && !dso_json_dict_contains_key_obj (dict, key)) {
  ...
  res = 
# 577 "project/radare2/shlr/java/dsojson.c" 3 4
       1
# 577 "project/radare2/shlr/java/dsojson.c"
           ;
  ...
  r_list_append (the_list, entry);
  res = 
# 582 "project/radare2/shlr/java/dsojson.c" 3 4
       1
# 582 "project/radare2/shlr/java/dsojson.c"
           ;
 } else {
...
int dso_json_dict_remove_key_str (DsoJsonObj *dict, char *key) {
 ...
 DsoJsonObj *dso_obj;
 int res = 
# 597 "project/radare2/shlr/java/dsojson.c" 3 4
          0
# 597 "project/radare2/shlr/java/dsojson.c"
               ;
 RList* the_list = dso_json_get_list (dict);
 if (the_list) {
  
# 600 "project/radare2/shlr/java/dsojson.c" 3 4
 if (
# 600 "project/radare2/shlr/java/dsojson.c"
 the_list
# 600 "project/radare2/shlr/java/dsojson.c" 3 4
 ) for (
# 600 "project/radare2/shlr/java/dsojson.c"
...
# 600 "project/radare2/shlr/java/dsojson.c"
   ...
   if (get_type (dso_obj) == DSO_JSON_DICT_ENTRY &&
    ...
    if (!cmpDsoStr_to_str (dso_json_get_str (dso_obj), key)) {
     res = 
# 604 "project/radare2/shlr/java/dsojson.c" 3 4
          1
# 604 "project/radare2/shlr/java/dsojson.c"
              ;
...
# 623 "project/radare2/shlr/java/dsojson.c" 3 4
 if (
# 623 "project/radare2/shlr/java/dsojson.c"
 the_list
# 623 "project/radare2/shlr/java/dsojson.c" 3 4
 ) for (
# 623 "project/radare2/shlr/java/dsojson.c"
...
# 623 "project/radare2/shlr/java/dsojson.c"
   ...
   if (get_type (dso_obj) == DSO_JSON_DICT_ENTRY &&
    ...
    if (!cmpDsoStr_to_str (dso_json_get_str (dso_obj), key)) {
     return 
# 627 "project/radare2/shlr/java/dsojson.c" 3 4
           1
# 627 "project/radare2/shlr/java/dsojson.c"
               ;
    }
   }
  }
 ...
 return 
# 632 "project/radare2/shlr/java/dsojson.c" 3 4
       0
# 632 "project/radare2/shlr/java/dsojson.c"
            ;
}
...
DsoJsonObj * dso_json_num_new () {
 DsoJsonObj *x = dso_json_null_new ();
 if (!x) return 
# 639 "project/radare2/shlr/java/dsojson.c" 3 4
               ((void *)0)
# 639 "project/radare2/shlr/java/dsojson.c"
                   ;
...
char * dso_json_num_to_str (DsoJsonNum * num) {
 return r_str_newf ("%"
# 651 "project/radare2/shlr/java/dsojson.c" 3 4
                      "lld"
# 651 "project/radare2/shlr/java/dsojson.c"
                             , num->value);
}

DsoJsonObj * dso_json_num_new_from_num (
# 654 "project/radare2/shlr/java/dsojson.c" 3 4
                                       unsigned long long 
# 654 "project/radare2/shlr/java/dsojson.c"
                                            num) {
...
char * dso_json_convert_string (const char * bytes, 
# 660 "project/radare2/shlr/java/dsojson.c" 3 4
                                                   unsigned int 
# 660 "project/radare2/shlr/java/dsojson.c"
                                                        len) {
 
# 661 "project/radare2/shlr/java/dsojson.c" 3 4
unsigned int 
# 661 "project/radare2/shlr/java/dsojson.c"
     idx = 0, pos = 1;
 
# 662 "project/radare2/shlr/java/dsojson.c" 3 4
unsigned int 
# 662 "project/radare2/shlr/java/dsojson.c"
     str_sz = 4*len+1+2;
 char *cpy_buffer = len > 0 ? calloc (1, str_sz): 
# 663 "project/radare2/shlr/java/dsojson.c" 3 4
                                                 ((void *)0)
# 663 "project/radare2/shlr/java/dsojson.c"
                                                     ;
...
# 669 "project/radare2/shlr/java/dsojson.c" 3 4
  __builtin___sprintf_chk (
# 669 "project/radare2/shlr/java/dsojson.c"
  cpy_buffer+pos
# 669 "project/radare2/shlr/java/dsojson.c" 3 4
  , 0, __builtin_object_size (
# 669 "project/radare2/shlr/java/dsojson.c"
...
# 672 "project/radare2/shlr/java/dsojson.c" 3 4
  __builtin___sprintf_chk (
# 672 "project/radare2/shlr/java/dsojson.c"
  cpy_buffer+pos
# 672 "project/radare2/shlr/java/dsojson.c" 3 4
  , 0, __builtin_object_size (
# 672 "project/radare2/shlr/java/dsojson.c"
...
# 680 "project/radare2/shlr/java/dsojson.c" 3 4
__builtin___strcat_chk (
# 680 "project/radare2/shlr/java/dsojson.c"
cpy_buffer
# 680 "project/radare2/shlr/java/dsojson.c" 3 4
, 
# 680 "project/radare2/shlr/java/dsojson.c"
...
char * dso_json_str_to_str (DsoJsonStr *str) {
 ...
 return 
# 688 "project/radare2/shlr/java/dsojson.c" 3 4
       ((void *)0)
# 688 "project/radare2/shlr/java/dsojson.c"
           ;
}
...
DsoJsonObj * dso_json_str_new_from_str (const char *str) {
 ...
 if (!x) return 
# 693 "project/radare2/shlr/java/dsojson.c" 3 4
               ((void *)0)
# 693 "project/radare2/shlr/java/dsojson.c"
                   ;
 DsoJsonStr * dsoStr = x->val._str;
 allocDsoStr (dsoStr, strlen (str));
 if (dsoStr->data) 
# 696 "project/radare2/shlr/java/dsojson.c" 3 4
                  __builtin___memcpy_chk (
# 696 "project/radare2/shlr/java/dsojson.c"
                  dsoStr->data
# 696 "project/radare2/shlr/java/dsojson.c" 3 4
                  , 
# 696 "project/radare2/shlr/java/dsojson.c"
...
DsoJsonObj * dso_json_str_new_from_str_len (const char *str, unsigned int len) {
 DsoJsonObj *x = dso_json_str_new ();
 if (!x) return 
# 702 "project/radare2/shlr/java/dsojson.c" 3 4
               ((void *)0)
# 702 "project/radare2/shlr/java/dsojson.c"
                   ;
 DsoJsonStr * dsoStr = x->val._str;
 allocDsoStr (dsoStr, len);
 
# 705 "project/radare2/shlr/java/dsojson.c" 3 4
__builtin___memcpy_chk (
# 705 "project/radare2/shlr/java/dsojson.c"
dsoStr->data
# 705 "project/radare2/shlr/java/dsojson.c" 3 4
, 
# 705 "project/radare2/shlr/java/dsojson.c"
...
DsoJsonObj * dso_json_str_new_from_num (long num) {
 DsoJsonObj *x = dso_json_str_new ();
 if (!x) return 
# 711 "project/radare2/shlr/java/dsojson.c" 3 4
               ((void *)0)
# 711 "project/radare2/shlr/java/dsojson.c"
                   ;
 DsoJsonStr * dsoStr = x->val._str;
 int len = 
# 713 "project/radare2/shlr/java/dsojson.c" 3 4
          __builtin___snprintf_chk (((void *)0), 
# 713 "project/radare2/shlr/java/dsojson.c"
          0
# 713 "project/radare2/shlr/java/dsojson.c" 3 4
...
# 715 "project/radare2/shlr/java/dsojson.c" 3 4
__builtin___snprintf_chk (
# 715 "project/radare2/shlr/java/dsojson.c"
dsoStr->data
# 715 "project/radare2/shlr/java/dsojson.c" 3 4
, 
# 715 "project/radare2/shlr/java/dsojson.c"
