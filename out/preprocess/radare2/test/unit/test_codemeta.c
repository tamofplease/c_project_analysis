# 0 "project/radare2/test/unit/test_codemeta.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/test/unit/test_codemeta.c"
...
# 2 "project/radare2/test/unit/test_codemeta.c" 2
...
# 4 "project/radare2/test/unit/test_codemeta.c" 2
...
# 7 "project/radare2/test/unit/test_codemeta.c" 2

static RCodeMetaItem make_code_annotation(int st, int en, RCodeMetaItemType typec,
 
# 9 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long 
# 9 "project/radare2/test/unit/test_codemeta.c"
     offset, RSyntaxHighlightType types) {
...
# 34 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long 
# 34 "project/radare2/test/unit/test_codemeta.c"
...
# 43 "project/radare2/test/unit/test_codemeta.c" 3 4
                             ((void *)0)
# 43 "project/radare2/test/unit/test_codemeta.c"
                                 ;
 }
 return annotation;
}
...
static RVector *get_some_code_annotation_for_add(void) {
 RVector *test_annotations = r_vector_new (sizeof (RCodeMetaItem), 
# 49 "project/radare2/test/unit/test_codemeta.c" 3 4
                                                                  ((void *)0)
# 49 "project/radare2/test/unit/test_codemeta.c"
                                                                      , 
# 49 "project/radare2/test/unit/test_codemeta.c" 3 4
                                                                        ((void *)0)
# 49 "project/radare2/test/unit/test_codemeta.c"
 ...
 r_vector_init (test_annotations, sizeof (RCodeMetaItem), 
# 51 "project/radare2/test/unit/test_codemeta.c" 3 4
                                                         ((void *)0)
# 51 "project/radare2/test/unit/test_codemeta.c"
                                                             , 
# 51 "project/radare2/test/unit/test_codemeta.c" 3 4
                                                               ((void *)0)
# 51 "project/radare2/test/unit/test_codemeta.c"
...
static RVector *get_some_annotations_for_in(void) {
 RVector *test_annotations = r_vector_new (sizeof (RCodeMetaItem), 
# 60 "project/radare2/test/unit/test_codemeta.c" 3 4
                                                                  ((void *)0)
# 60 "project/radare2/test/unit/test_codemeta.c"
                                                                      , 
# 60 "project/radare2/test/unit/test_codemeta.c" 3 4
                                                                        ((void *)0)
# 60 "project/radare2/test/unit/test_codemeta.c"
...
static RVector *get_annotations_for_hello_world(void) {
 RVector *test_annotations = r_vector_new (sizeof (RCodeMetaItem), 
# 83 "project/radare2/test/unit/test_codemeta.c" 3 4
                                                                  ((void *)0)
# 83 "project/radare2/test/unit/test_codemeta.c"
                                                                      , 
# 83 "project/radare2/test/unit/test_codemeta.c" 3 4
                                                                        ((void *)0)
# 83 "project/radare2/test/unit/test_codemeta.c"
...
static RCodeMeta *get_hello_world(void) {
 ...
 RVector *test_annotations = get_annotations_for_hello_world ();
 RCodeMetaItem *annotation;
 
# 115 "project/radare2/test/unit/test_codemeta.c" 3 4
if (!r_vector_empty (
# 115 "project/radare2/test/unit/test_codemeta.c"
test_annotations
# 115 "project/radare2/test/unit/test_codemeta.c" 3 4
)) for (
# 115 "project/radare2/test/unit/test_codemeta.c"
...
static RCodeMeta *get_all_context_annotated_code(void) {
 ...
 RCodeMetaItem constant_variable = make_reference_annotation (10, 19, R_CODEMETA_TYPE_CONSTANT_VARIABLE, 12345, 
# 127 "project/radare2/test/unit/test_codemeta.c" 3 4
                                                                                                               ((void *)0)
# 127 "project/radare2/test/unit/test_codemeta.c"
                                                                                                                   );
 RCodeMetaItem global_variable = make_reference_annotation (23, 33, R_CODEMETA_TYPE_GLOBAL_VARIABLE, 123456, 
# 128 "project/radare2/test/unit/test_codemeta.c" 3 4
                                                                                                            ((void *)0)
# 128 "project/radare2/test/unit/test_codemeta.c"
                                                                                                                );
...
static 
# 139 "project/radare2/test/unit/test_codemeta.c" 3 4
      _Bool 
# 139 "project/radare2/test/unit/test_codemeta.c"
           test_r_codemeta_new(void) {

 char *test_string = strdup ("How are you?");
 RCodeMeta *code = r_codemeta_new (test_string);
 do { char _meqstr[5120]; const char *act__ = (code->code); const char *exp__ = (test_string); 
# 143 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 143 "project/radare2/test/unit/test_codemeta.c"
_meqstr
# 143 "project/radare2/test/unit/test_codemeta.c" 3 4
, 
# 143 "project/radare2/test/unit/test_codemeta.c"
...
, 2 > 1 ? 1 : 0), 
# 143 "project/radare2/test/unit/test_codemeta.c"
"%s: expected %s, got %s.", ("Code in RCodeMeta is not set as expected"), (exp__), (act__)
# 143 "project/radare2/test/unit/test_codemeta.c" 3 4
)
# 143 "project/radare2/test/unit/test_codemeta.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 143, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 143, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { 
# 146 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long 
# 146 "project/radare2/test/unit/test_codemeta.c"
act__ = (
# 146 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long
# 146 "project/radare2/test/unit/test_codemeta.c"
)(code->annotations.elem_size); 
# 146 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long 
# 146 "project/radare2/test/unit/test_codemeta.c"
exp__ = (
...
unsigned long long
# 146 "project/radare2/test/unit/test_codemeta.c"
)(sizeof (RCodeMetaItem)); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 146 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 146 "project/radare2/test/unit/test_codemeta.c"
_meqstr
...
"lld" 
# 146 "project/radare2/test/unit/test_codemeta.c"
".", ("Code Annotations are initialized is not properly"), (
# 146 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long
# 146 "project/radare2/test/unit/test_codemeta.c"
)(exp__), (
...
static 
# 152 "project/radare2/test/unit/test_codemeta.c" 3 4
      _Bool 
# 152 "project/radare2/test/unit/test_codemeta.c"
           test_r_codemeta_free(void) {
 char *test_string = strdup ("How are you?");
 RCodeMeta *code = r_codemeta_new (test_string);
...
static 
# 168 "project/radare2/test/unit/test_codemeta.c" 3 4
      _Bool 
# 168 "project/radare2/test/unit/test_codemeta.c"
           test_equal(RCodeMetaItem *first, RCodeMetaItem *second) {
 do { 
# 169 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long 
# 169 "project/radare2/test/unit/test_codemeta.c"
act__ = (
# 169 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long
# 169 "project/radare2/test/unit/test_codemeta.c"
...
unsigned long long
# 169 "project/radare2/test/unit/test_codemeta.c"
)(second->start); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 169 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 169 "project/radare2/test/unit/test_codemeta.c"
_meqstr
...
"lld" 
# 169 "project/radare2/test/unit/test_codemeta.c"
".", ("start of annotations doesn't match"), (
# 169 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long
# 169 "project/radare2/test/unit/test_codemeta.c"
)(exp__), (
...
# 169 "project/radare2/test/unit/test_codemeta.c"
 ...
 do { 
# 170 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long 
# 170 "project/radare2/test/unit/test_codemeta.c"
act__ = (
# 170 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long
# 170 "project/radare2/test/unit/test_codemeta.c"
...
unsigned long long
# 170 "project/radare2/test/unit/test_codemeta.c"
)(second->end); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 170 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 170 "project/radare2/test/unit/test_codemeta.c"
_meqstr
...
"lld" 
# 170 "project/radare2/test/unit/test_codemeta.c"
".", ("end of annotations doesn't match"), (
# 170 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long
# 170 "project/radare2/test/unit/test_codemeta.c"
)(exp__), (
...
# 170 "project/radare2/test/unit/test_codemeta.c"
 ...
 do { 
# 171 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long 
# 171 "project/radare2/test/unit/test_codemeta.c"
act__ = (
# 171 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long
# 171 "project/radare2/test/unit/test_codemeta.c"
...
unsigned long long
# 171 "project/radare2/test/unit/test_codemeta.c"
)(second->type); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 171 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 171 "project/radare2/test/unit/test_codemeta.c"
_meqstr
...
"lld" 
# 171 "project/radare2/test/unit/test_codemeta.c"
".", ("type of annotation doesn't match"), (
# 171 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long
# 171 "project/radare2/test/unit/test_codemeta.c"
)(exp__), (
...
# 171 "project/radare2/test/unit/test_codemeta.c"
 ...
 if (first->type == R_CODEMETA_TYPE_OFFSET) {
  do { 
# 173 "project/radare2/test/unit/test_codemeta.c" 3 4
 unsigned long long 
# 173 "project/radare2/test/unit/test_codemeta.c"
 act__ = (
# 173 "project/radare2/test/unit/test_codemeta.c" 3 4
 unsigned long long
# 173 "project/radare2/test/unit/test_codemeta.c"
...
# 173 "project/radare2/test/unit/test_codemeta.c" 3 4
 unsigned long long
# 173 "project/radare2/test/unit/test_codemeta.c"
 )(second->offset.offset); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 173 "project/radare2/test/unit/test_codemeta.c" 3 4
 __builtin___snprintf_chk (
# 173 "project/radare2/test/unit/test_codemeta.c"
 _meqstr
...
# 173 "project/radare2/test/unit/test_codemeta.c" 3 4
 "lld" 
# 173 "project/radare2/test/unit/test_codemeta.c"
 ".", ("offset of annotations doesn't match"), (
# 173 "project/radare2/test/unit/test_codemeta.c" 3 4
 unsigned long long
# 173 "project/radare2/test/unit/test_codemeta.c"
 )(exp__), (
...
# 173 "project/radare2/test/unit/test_codemeta.c"
  ...
  return 
# 174 "project/radare2/test/unit/test_codemeta.c" 3 4
        1
# 174 "project/radare2/test/unit/test_codemeta.c"
            ;
 }
 if (first->type == R_CODEMETA_TYPE_SYNTAX_HIGHLIGHT) {
  do { 
# 177 "project/radare2/test/unit/test_codemeta.c" 3 4
 unsigned long long 
# 177 "project/radare2/test/unit/test_codemeta.c"
 act__ = (
# 177 "project/radare2/test/unit/test_codemeta.c" 3 4
 unsigned long long
# 177 "project/radare2/test/unit/test_codemeta.c"
 )(first->syntax_highlight.type); 
# 177 "project/radare2/test/unit/test_codemeta.c" 3 4
 unsigned long long 
# 177 "project/radare2/test/unit/test_codemeta.c"
 exp__ = (
# 177 "project/radare2/test/unit/test_codemeta.c" 3 4
 unsigned long long
# 177 "project/radare2/test/unit/test_codemeta.c"
 )(second->syntax_highlight.type); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 177 "project/radare2/test/unit/test_codemeta.c" 3 4
 __builtin___snprintf_chk (
# 177 "project/radare2/test/unit/test_codemeta.c"
 _meqstr
...
# 177 "project/radare2/test/unit/test_codemeta.c" 3 4
 "lld" 
# 177 "project/radare2/test/unit/test_codemeta.c"
 ".", ("syntax highlight type of offset doesn't match"), (
# 177 "project/radare2/test/unit/test_codemeta.c" 3 4
 unsigned long long
# 177 "project/radare2/test/unit/test_codemeta.c"
 )(exp__), (
...
# 177 "project/radare2/test/unit/test_codemeta.c"
  ...
  return 
# 178 "project/radare2/test/unit/test_codemeta.c" 3 4
        1
# 178 "project/radare2/test/unit/test_codemeta.c"
            ;
 }
 return 
# 180 "project/radare2/test/unit/test_codemeta.c" 3 4
       0
# 180 "project/radare2/test/unit/test_codemeta.c"
            ;
}

static 
# 183 "project/radare2/test/unit/test_codemeta.c" 3 4
      _Bool 
# 183 "project/radare2/test/unit/test_codemeta.c"
           test_r_codemeta_add_item(void) {
...
# 189 "project/radare2/test/unit/test_codemeta.c" 3 4
if (!r_vector_empty (
# 189 "project/radare2/test/unit/test_codemeta.c"
test_annotations
# 189 "project/radare2/test/unit/test_codemeta.c" 3 4
)) for (
# 189 "project/radare2/test/unit/test_codemeta.c"
...
# 189 "project/radare2/test/unit/test_codemeta.c"
 ...
 if (!test_equal (r_vector_index_ptr (&code->annotations, 0), r_vector_index_ptr (test_annotations, 0))) {
  return 
# 195 "project/radare2/test/unit/test_codemeta.c" 3 4
        0
# 195 "project/radare2/test/unit/test_codemeta.c"
             ;
 }
 if (!test_equal (r_vector_index_ptr (&code->annotations, 1), r_vector_index_ptr (test_annotations, 1))) {
  return 
# 198 "project/radare2/test/unit/test_codemeta.c" 3 4
        0
# 198 "project/radare2/test/unit/test_codemeta.c"
             ;
 }
...
static 
# 206 "project/radare2/test/unit/test_codemeta.c" 3 4
      _Bool 
# 206 "project/radare2/test/unit/test_codemeta.c"
           test_r_codemeta_at(void) {
 char *test_string = strdup ("abcdefghijklmnopqrtstuvwxyz ABCDEFGHIJKLMNOPQRSTUVWXYZ");
 RCodeMeta *code = r_codemeta_new (test_string);
 RVector *test_annotations;
...
# 213 "project/radare2/test/unit/test_codemeta.c" 3 4
if (!r_vector_empty (
# 213 "project/radare2/test/unit/test_codemeta.c"
test_annotations
# 213 "project/radare2/test/unit/test_codemeta.c" 3 4
)) for (
# 213 "project/radare2/test/unit/test_codemeta.c"
...
# 213 "project/radare2/test/unit/test_codemeta.c"
 ...
 do { 
# 219 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long 
# 219 "project/radare2/test/unit/test_codemeta.c"
act__ = (
# 219 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long
# 219 "project/radare2/test/unit/test_codemeta.c"
...
"lld" 
# 219 "project/radare2/test/unit/test_codemeta.c"
".", ("Additional annotations found. Bad output."), (
# 219 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long
# 219 "project/radare2/test/unit/test_codemeta.c"
)(exp__), (
...
# 219 "project/radare2/test/unit/test_codemeta.c"
 ...
 if (!test_equal (*r_pvector_index_ptr (out, 0), r_vector_index_ptr (test_annotations, 3))) {
  return 
# 221 "project/radare2/test/unit/test_codemeta.c" 3 4
        0
# 221 "project/radare2/test/unit/test_codemeta.c"
             ;
 }
 if (!test_equal (*r_pvector_index_ptr (out, 1), r_vector_index_ptr (test_annotations, 4))) {
  return 
# 224 "project/radare2/test/unit/test_codemeta.c" 3 4
        0
# 224 "project/radare2/test/unit/test_codemeta.c"
             ;
 }
 if (!test_equal (*r_pvector_index_ptr (out, 2), r_vector_index_ptr (test_annotations, 5))) {
  return 
# 227 "project/radare2/test/unit/test_codemeta.c" 3 4
        0
# 227 "project/radare2/test/unit/test_codemeta.c"
             ;
 }
...
static 
# 236 "project/radare2/test/unit/test_codemeta.c" 3 4
      _Bool 
# 236 "project/radare2/test/unit/test_codemeta.c"
           test_r_codemeta_in(void) {
 char *test_string = strdup ("abcdefghijklmnopqrtstuvwxyz ABCDEFGHIJKLMNOPQRSTUVWXYZ");
 RCodeMeta *code = r_codemeta_new (test_string);
 RVector *test_annotations;
 test_annotations = get_some_annotations_for_in ();
...
# 242 "project/radare2/test/unit/test_codemeta.c" 3 4
if (!r_vector_empty (
# 242 "project/radare2/test/unit/test_codemeta.c"
test_annotations
# 242 "project/radare2/test/unit/test_codemeta.c" 3 4
)) for (
# 242 "project/radare2/test/unit/test_codemeta.c"
...
# 242 "project/radare2/test/unit/test_codemeta.c"
 ...
 do { 
# 248 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long 
# 248 "project/radare2/test/unit/test_codemeta.c"
act__ = (
# 248 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long
# 248 "project/radare2/test/unit/test_codemeta.c"
...
# 248 "project/radare2/test/unit/test_codemeta.c"
 ...
 if (!test_equal (*r_pvector_index_ptr (out, 0), r_vector_index_ptr (test_annotations, 2))) {
  return 
# 250 "project/radare2/test/unit/test_codemeta.c" 3 4
        0
# 250 "project/radare2/test/unit/test_codemeta.c"
             ;
 }
 if (!test_equal (*r_pvector_index_ptr (out, 1), r_vector_index_ptr (test_annotations, 3))) {
  return 
# 253 "project/radare2/test/unit/test_codemeta.c" 3 4
        0
# 253 "project/radare2/test/unit/test_codemeta.c"
             ;
 }
 if (!test_equal (*r_pvector_index_ptr (out, 2), r_vector_index_ptr (test_annotations, 4))) {
  return 
# 256 "project/radare2/test/unit/test_codemeta.c" 3 4
        0
# 256 "project/radare2/test/unit/test_codemeta.c"
             ;
 }
 if (!test_equal (*r_pvector_index_ptr (out, 3), r_vector_index_ptr (test_annotations, 5))) {
  return 
# 259 "project/radare2/test/unit/test_codemeta.c" 3 4
        0
# 259 "project/radare2/test/unit/test_codemeta.c"
             ;
 }
...
static 
# 268 "project/radare2/test/unit/test_codemeta.c" 3 4
      _Bool 
# 268 "project/radare2/test/unit/test_codemeta.c"
           test_r_codemeta_line_offsets(void) {

 RCodeMeta *code = get_hello_world ();
 RVector *offsets = r_codemeta_line_offsets (code);
 do { 
# 272 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long 
# 272 "project/radare2/test/unit/test_codemeta.c"
act__ = (
# 272 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long
# 272 "project/radare2/test/unit/test_codemeta.c"
...
"lld" 
# 272 "project/radare2/test/unit/test_codemeta.c"
".", ("Number of offsets not expected"), (
# 272 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long
# 272 "project/radare2/test/unit/test_codemeta.c"
)(exp__), (
...
0
# 272 "project/radare2/test/unit/test_codemeta.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 272, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 272, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 
# 274 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long 
# 274 "project/radare2/test/unit/test_codemeta.c"
     *off = r_vector_index_ptr (offsets, 0);
 do { 
# 275 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long 
# 275 "project/radare2/test/unit/test_codemeta.c"
act__ = (
# 275 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long
# 275 "project/radare2/test/unit/test_codemeta.c"
...
, 2 > 1 ? 1 : 0), 
# 275 "project/radare2/test/unit/test_codemeta.c"
"%s: expected ""%llu"", got ""%llu"".", ("Unexpected offset"), (exp__), (act__)
# 275 "project/radare2/test/unit/test_codemeta.c" 3 4
)
# 275 "project/radare2/test/unit/test_codemeta.c"
; do { if (!(
...
# 275 "project/radare2/test/unit/test_codemeta.c"
 ...
 do { 
# 277 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long 
# 277 "project/radare2/test/unit/test_codemeta.c"
act__ = (
# 277 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long
# 277 "project/radare2/test/unit/test_codemeta.c"
...
# 277 "project/radare2/test/unit/test_codemeta.c"
 ...
 do { 
# 279 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long 
# 279 "project/radare2/test/unit/test_codemeta.c"
act__ = (
# 279 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long
# 279 "project/radare2/test/unit/test_codemeta.c"
...
# 279 "project/radare2/test/unit/test_codemeta.c"
 ...
 do { 
# 281 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long 
# 281 "project/radare2/test/unit/test_codemeta.c"
act__ = (
# 281 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long
# 281 "project/radare2/test/unit/test_codemeta.c"
...
unsigned long long
# 281 "project/radare2/test/unit/test_codemeta.c"
)4440); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 281 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 281 "project/radare2/test/unit/test_codemeta.c"
_meqstr
...
# 281 "project/radare2/test/unit/test_codemeta.c"
 ...
 do { 
# 283 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long 
# 283 "project/radare2/test/unit/test_codemeta.c"
act__ = (
# 283 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long
# 283 "project/radare2/test/unit/test_codemeta.c"
...
unsigned long long
# 283 "project/radare2/test/unit/test_codemeta.c"
)4447); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 283 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 283 "project/radare2/test/unit/test_codemeta.c"
_meqstr
...
# 283 "project/radare2/test/unit/test_codemeta.c"
 ...
 do { 
# 285 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long 
# 285 "project/radare2/test/unit/test_codemeta.c"
act__ = (
# 285 "project/radare2/test/unit/test_codemeta.c" 3 4
unsigned long long
# 285 "project/radare2/test/unit/test_codemeta.c"
...
static 
# 292 "project/radare2/test/unit/test_codemeta.c" 3 4
      _Bool 
# 292 "project/radare2/test/unit/test_codemeta.c"
           test_r_codemeta_print_json(void) {
 RCodeMeta *code = get_hello_world ();
 char *actual;
 ...
 r_cons_pop ();
 do { char _meqstr[5120]; const char *act__ = (actual); const char *exp__ = (expected); 
# 301 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 301 "project/radare2/test/unit/test_codemeta.c"
_meqstr
# 301 "project/radare2/test/unit/test_codemeta.c" 3 4
, 
# 301 "project/radare2/test/unit/test_codemeta.c"
...
, 2 > 1 ? 1 : 0), 
# 301 "project/radare2/test/unit/test_codemeta.c"
"%s: expected %s, got %s.", ("pdgj OUTPUT DOES NOT MATCH"), (exp__), (act__)
# 301 "project/radare2/test/unit/test_codemeta.c" 3 4
)
# 301 "project/radare2/test/unit/test_codemeta.c"
...
static 
# 312 "project/radare2/test/unit/test_codemeta.c" 3 4
      _Bool 
# 312 "project/radare2/test/unit/test_codemeta.c"
           test_r_codemeta_print_json_context_annotations(void) {
 ...
 r_cons_pop ();
 do { char _meqstr[5120]; const char *act__ = (actual); const char *exp__ = (expected); 
# 320 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 320 "project/radare2/test/unit/test_codemeta.c"
_meqstr
# 320 "project/radare2/test/unit/test_codemeta.c" 3 4
, 
# 320 "project/radare2/test/unit/test_codemeta.c"
...
, 2 > 1 ? 1 : 0), 
# 320 "project/radare2/test/unit/test_codemeta.c"
"%s: expected %s, got %s.", ("r_codemeta_print_json() output doesn't match with the expected output"), (exp__), (act__)
# 320 "project/radare2/test/unit/test_codemeta.c" 3 4
)
# 320 "project/radare2/test/unit/test_codemeta.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 320, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 320, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (actual);
 r_codemeta_free (code);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}
...
static 
# 326 "project/radare2/test/unit/test_codemeta.c" 3 4
      _Bool 
# 326 "project/radare2/test/unit/test_codemeta.c"
           test_r_codemeta_print(void) {
 RCodeMeta *code = get_hello_world ();
 char *actual;
 ...
 r_cons_new ();
 r_cons_push ();
 r_codemeta_print (code, 
# 338 "project/radare2/test/unit/test_codemeta.c" 3 4
                        ((void *)0)
# 338 "project/radare2/test/unit/test_codemeta.c"
                            );
 actual = strdup (r_cons_get_buffer ());
 r_cons_pop ();
 do { char _meqstr[5120]; const char *act__ = (actual); const char *exp__ = (expected_first); 
# 341 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 341 "project/radare2/test/unit/test_codemeta.c"
_meqstr
# 341 "project/radare2/test/unit/test_codemeta.c" 3 4
, 
# 341 "project/radare2/test/unit/test_codemeta.c"
...
, 2 > 1 ? 1 : 0), 
# 341 "project/radare2/test/unit/test_codemeta.c"
"%s: expected %s, got %s.", ("pdg OUTPUT DOES NOT MATCH"), (exp__), (act__)
# 341 "project/radare2/test/unit/test_codemeta.c" 3 4
)
# 341 "project/radare2/test/unit/test_codemeta.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 341, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 341, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 r_cons_pop ();
 ...
 actual = strdup (r_cons_get_buffer ());
 r_cons_pop ();
 do { char _meqstr[5120]; const char *act__ = (actual); const char *exp__ = (expected_second); 
# 356 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 356 "project/radare2/test/unit/test_codemeta.c"
_meqstr
# 356 "project/radare2/test/unit/test_codemeta.c" 3 4
, 
# 356 "project/radare2/test/unit/test_codemeta.c"
...
, 2 > 1 ? 1 : 0), 
# 356 "project/radare2/test/unit/test_codemeta.c"
"%s: expected %s, got %s.", ("pdgo OUTPUT DOES NOT MATCH"), (exp__), (act__)
# 356 "project/radare2/test/unit/test_codemeta.c" 3 4
)
# 356 "project/radare2/test/unit/test_codemeta.c"
...
static 
# 366 "project/radare2/test/unit/test_codemeta.c" 3 4
      _Bool 
# 366 "project/radare2/test/unit/test_codemeta.c"
           test_r_codemeta_print_comment_cmds(void) {
 RCodeMeta *code = get_hello_world ();
 char *actual;
 ...
 r_cons_pop ();
 do { char _meqstr[5120]; const char *act__ = (actual); const char *exp__ = (expected); 
# 376 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 376 "project/radare2/test/unit/test_codemeta.c"
_meqstr
# 376 "project/radare2/test/unit/test_codemeta.c" 3 4
, 
# 376 "project/radare2/test/unit/test_codemeta.c"
...
# 376 "project/radare2/test/unit/test_codemeta.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 376, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 376, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
...
static 
# 387 "project/radare2/test/unit/test_codemeta.c" 3 4
      _Bool 
# 387 "project/radare2/test/unit/test_codemeta.c"
           test_r_codemeta_itemfree_and_is_annotation_type_functions(void) {
 ...
 RCodeMetaItem global_variable = make_reference_annotation (10, 12, R_CODEMETA_TYPE_GLOBAL_VARIABLE, 1234234, 
# 394 "project/radare2/test/unit/test_codemeta.c" 3 4
                                                                                                             ((void *)0)
# 394 "project/radare2/test/unit/test_codemeta.c"
                                                                                                                 );
 RCodeMetaItem constant_variable = make_reference_annotation (21, 200, R_CODEMETA_TYPE_CONSTANT_VARIABLE, 12342314, 
# 395 "project/radare2/test/unit/test_codemeta.c" 3 4
                                                                                                                   ((void *)0)
# 395 "project/radare2/test/unit/test_codemeta.c"
                                                                                                                       );

 char *error_message = "r_codemeta_item_is_variable() result doesn't match with the expected output";
 do { 
# 398 "project/radare2/test/unit/test_codemeta.c" 3 4
_Bool 
# 398 "project/radare2/test/unit/test_codemeta.c"
act__ = (r_codemeta_item_is_variable (&local_variable)); if (!(act__)) { char _meqstr[5120]; 
# 398 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 398 "project/radare2/test/unit/test_codemeta.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 398 "project/radare2/test/unit/test_codemeta.c"
"%s: expected true, got false", (error_message)
# 398 "project/radare2/test/unit/test_codemeta.c" 3 4
)
# 398 "project/radare2/test/unit/test_codemeta.c"
; do { if (!(
...
# 398 "project/radare2/test/unit/test_codemeta.c"
 ...
 do { 
# 399 "project/radare2/test/unit/test_codemeta.c" 3 4
_Bool 
# 399 "project/radare2/test/unit/test_codemeta.c"
act__ = (r_codemeta_item_is_variable (&function_parameter)); if (!(act__)) { char _meqstr[5120]; 
# 399 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 399 "project/radare2/test/unit/test_codemeta.c"
_meqstr
...
# 399 "project/radare2/test/unit/test_codemeta.c"
 ...
 do { 
# 400 "project/radare2/test/unit/test_codemeta.c" 3 4
_Bool 
# 400 "project/radare2/test/unit/test_codemeta.c"
act__ = (r_codemeta_item_is_variable (&function_name)); if ((act__)) { char _meqstr[5120]; 
# 400 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 400 "project/radare2/test/unit/test_codemeta.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 400 "project/radare2/test/unit/test_codemeta.c"
"%s: expected false, got true", (error_message)
# 400 "project/radare2/test/unit/test_codemeta.c" 3 4
)
# 400 "project/radare2/test/unit/test_codemeta.c"
; do { if (!(
...
# 400 "project/radare2/test/unit/test_codemeta.c"
 ...
 do { 
# 401 "project/radare2/test/unit/test_codemeta.c" 3 4
_Bool 
# 401 "project/radare2/test/unit/test_codemeta.c"
act__ = (r_codemeta_item_is_variable (&global_variable)); if ((act__)) { char _meqstr[5120]; 
# 401 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 401 "project/radare2/test/unit/test_codemeta.c"
_meqstr
...
# 401 "project/radare2/test/unit/test_codemeta.c"
 ...
 do { 
# 402 "project/radare2/test/unit/test_codemeta.c" 3 4
_Bool 
# 402 "project/radare2/test/unit/test_codemeta.c"
act__ = (r_codemeta_item_is_variable (&constant_variable)); if ((act__)) { char _meqstr[5120]; 
# 402 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 402 "project/radare2/test/unit/test_codemeta.c"
_meqstr
...
# 402 "project/radare2/test/unit/test_codemeta.c"
 ...
 do { 
# 403 "project/radare2/test/unit/test_codemeta.c" 3 4
_Bool 
# 403 "project/radare2/test/unit/test_codemeta.c"
act__ = (r_codemeta_item_is_variable (&offset)); if ((act__)) { char _meqstr[5120]; 
# 403 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 403 "project/radare2/test/unit/test_codemeta.c"
_meqstr
...
# 403 "project/radare2/test/unit/test_codemeta.c"
 ...
 do { 
# 404 "project/radare2/test/unit/test_codemeta.c" 3 4
_Bool 
# 404 "project/radare2/test/unit/test_codemeta.c"
act__ = (r_codemeta_item_is_variable (&syntax_highlight)); if ((act__)) { char _meqstr[5120]; 
# 404 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 404 "project/radare2/test/unit/test_codemeta.c"
_meqstr
...
# 404 "project/radare2/test/unit/test_codemeta.c"
 ...
 do { 
# 407 "project/radare2/test/unit/test_codemeta.c" 3 4
_Bool 
# 407 "project/radare2/test/unit/test_codemeta.c"
act__ = (r_codemeta_item_is_reference (&function_name)); if (!(act__)) { char _meqstr[5120]; 
# 407 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 407 "project/radare2/test/unit/test_codemeta.c"
_meqstr
...
# 407 "project/radare2/test/unit/test_codemeta.c"
 ...
 do { 
# 408 "project/radare2/test/unit/test_codemeta.c" 3 4
_Bool 
# 408 "project/radare2/test/unit/test_codemeta.c"
act__ = (r_codemeta_item_is_reference (&global_variable)); if (!(act__)) { char _meqstr[5120]; 
# 408 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 408 "project/radare2/test/unit/test_codemeta.c"
_meqstr
...
# 408 "project/radare2/test/unit/test_codemeta.c"
 ...
 do { 
# 409 "project/radare2/test/unit/test_codemeta.c" 3 4
_Bool 
# 409 "project/radare2/test/unit/test_codemeta.c"
act__ = (r_codemeta_item_is_reference (&constant_variable)); if (!(act__)) { char _meqstr[5120]; 
# 409 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 409 "project/radare2/test/unit/test_codemeta.c"
_meqstr
...
0
# 409 "project/radare2/test/unit/test_codemeta.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 409, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 409, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while (0);
 do { 
# 410 "project/radare2/test/unit/test_codemeta.c" 3 4
_Bool 
# 410 "project/radare2/test/unit/test_codemeta.c"
act__ = (r_codemeta_item_is_reference (&local_variable)); if ((act__)) { char _meqstr[5120]; 
# 410 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 410 "project/radare2/test/unit/test_codemeta.c"
_meqstr
...
# 410 "project/radare2/test/unit/test_codemeta.c"
 ...
 do { 
# 411 "project/radare2/test/unit/test_codemeta.c" 3 4
_Bool 
# 411 "project/radare2/test/unit/test_codemeta.c"
act__ = (r_codemeta_item_is_reference (&function_parameter)); if ((act__)) { char _meqstr[5120]; 
# 411 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 411 "project/radare2/test/unit/test_codemeta.c"
_meqstr
...
# 411 "project/radare2/test/unit/test_codemeta.c"
 ...
 do { 
# 412 "project/radare2/test/unit/test_codemeta.c" 3 4
_Bool 
# 412 "project/radare2/test/unit/test_codemeta.c"
act__ = (r_codemeta_item_is_reference (&offset)); if ((act__)) { char _meqstr[5120]; 
# 412 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 412 "project/radare2/test/unit/test_codemeta.c"
_meqstr
...
# 412 "project/radare2/test/unit/test_codemeta.c"
 ...
 do { 
# 413 "project/radare2/test/unit/test_codemeta.c" 3 4
_Bool 
# 413 "project/radare2/test/unit/test_codemeta.c"
act__ = (r_codemeta_item_is_reference (&syntax_highlight)); if ((act__)) { char _meqstr[5120]; 
# 413 "project/radare2/test/unit/test_codemeta.c" 3 4
__builtin___snprintf_chk (
# 413 "project/radare2/test/unit/test_codemeta.c"
_meqstr
...
static int all_tests(void) {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_codemeta_new"); result = test_r_codemeta_new(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_codemeta_free"); result = test_r_codemeta_free(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_codemeta_add_item"); result = test_r_codemeta_add_item(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_codemeta_at"); result = test_r_codemeta_at(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_codemeta_in"); result = test_r_codemeta_in(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_codemeta_line_offsets"); result = test_r_codemeta_line_offsets(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_codemeta_print_json"); result = test_r_codemeta_print_json(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_codemeta_print_json_context_annotations"); result = test_r_codemeta_print_json_context_annotations(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_codemeta_print"); result = test_r_codemeta_print(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_codemeta_print_comment_cmds"); result = test_r_codemeta_print_comment_cmds(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_codemeta_itemfree_and_is_annotation_type_functions"); result = test_r_codemeta_itemfree_and_is_annotation_type_functions(); tests_run++; tests_passed += result; } while (0);
