# 0 "project/radare2/test/unit/test_spaces.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/test/unit/test_spaces.c"
...
# 2 "project/radare2/test/unit/test_spaces.c" 2
...
# 3 "project/radare2/test/unit/test_spaces.c" 2


# 4 "project/radare2/test/unit/test_spaces.c" 3 4
_Bool 
# 4 "project/radare2/test/unit/test_spaces.c"
    test_space_basic(void) {
 RSpaces *sps = r_spaces_new ("spacename");
 do { char _meqstr[5120]; const char *act__ = (sps->name); const char *exp__ = ("spacename"); 
# 6 "project/radare2/test/unit/test_spaces.c" 3 4
__builtin___snprintf_chk (
# 6 "project/radare2/test/unit/test_spaces.c"
_meqstr
# 6 "project/radare2/test/unit/test_spaces.c" 3 4
, 
# 6 "project/radare2/test/unit/test_spaces.c"
...
, 2 > 1 ? 1 : 0), 
# 6 "project/radare2/test/unit/test_spaces.c"
"%s: expected %s, got %s.", ("spacename should be the name"), (exp__), (act__)
# 6 "project/radare2/test/unit/test_spaces.c" 3 4
)
# 6 "project/radare2/test/unit/test_spaces.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 6, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 6, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 RSpace *sp = r_spaces_get (sps, "notexisting");
 do { char _meqstr[5120]; const void *act__ = (sp); 
# 9 "project/radare2/test/unit/test_spaces.c" 3 4
__builtin___snprintf_chk (
# 9 "project/radare2/test/unit/test_spaces.c"
_meqstr
# 9 "project/radare2/test/unit/test_spaces.c" 3 4
, 
# 9 "project/radare2/test/unit/test_spaces.c"
...
, 2 > 1 ? 1 : 0), 
# 9 "project/radare2/test/unit/test_spaces.c"
"%s: expected to be NULL but it wasn't.", ("NULL should be returned if not existing")
# 9 "project/radare2/test/unit/test_spaces.c" 3 4
)
# 9 "project/radare2/test/unit/test_spaces.c"
; do { if (!((act__) == 
...
# 9 "project/radare2/test/unit/test_spaces.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (sp); 
# 11 "project/radare2/test/unit/test_spaces.c" 3 4
__builtin___snprintf_chk (
# 11 "project/radare2/test/unit/test_spaces.c"
_meqstr
# 11 "project/radare2/test/unit/test_spaces.c" 3 4
, 
# 11 "project/radare2/test/unit/test_spaces.c"
...
, 2 > 1 ? 1 : 0), 
# 11 "project/radare2/test/unit/test_spaces.c"
"%s: expected to be NULL but it wasn't.", ("the current flagspace should not exist")
# 11 "project/radare2/test/unit/test_spaces.c" 3 4
)
# 11 "project/radare2/test/unit/test_spaces.c"
; do { if (!((act__) == 
...
# 11 "project/radare2/test/unit/test_spaces.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (sp); 
# 14 "project/radare2/test/unit/test_spaces.c" 3 4
__builtin___snprintf_chk (
# 14 "project/radare2/test/unit/test_spaces.c"
_meqstr
# 14 "project/radare2/test/unit/test_spaces.c" 3 4
, 
# 14 "project/radare2/test/unit/test_spaces.c"
...
, 2 > 1 ? 1 : 0), 
# 14 "project/radare2/test/unit/test_spaces.c"
"%s: expected to not be NULL but it was.", ("a flagspace should be created")
# 14 "project/radare2/test/unit/test_spaces.c" 3 4
)
# 14 "project/radare2/test/unit/test_spaces.c"
; do { if (!((act__) != 
...
# 14 "project/radare2/test/unit/test_spaces.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (sp->name); const char *exp__ = ("firstspace"); 
# 15 "project/radare2/test/unit/test_spaces.c" 3 4
__builtin___snprintf_chk (
# 15 "project/radare2/test/unit/test_spaces.c"
_meqstr
# 15 "project/radare2/test/unit/test_spaces.c" 3 4
, 
# 15 "project/radare2/test/unit/test_spaces.c"
...
, 2 > 1 ? 1 : 0), 
# 15 "project/radare2/test/unit/test_spaces.c"
"%s: expected %s, got %s.", ("right flag space name"), (exp__), (act__)
# 15 "project/radare2/test/unit/test_spaces.c" 3 4
)
# 15 "project/radare2/test/unit/test_spaces.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 15, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 15, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 sp = r_spaces_current (sps);
 do { char _meqstr[5120]; const void *act__ = (sp); 
# 18 "project/radare2/test/unit/test_spaces.c" 3 4
__builtin___snprintf_chk (
# 18 "project/radare2/test/unit/test_spaces.c"
_meqstr
# 18 "project/radare2/test/unit/test_spaces.c" 3 4
, 
# 18 "project/radare2/test/unit/test_spaces.c"
...
, 2 > 1 ? 1 : 0), 
# 18 "project/radare2/test/unit/test_spaces.c"
"%s: expected to not be NULL but it was.", ("the current flagspace should exist")
# 18 "project/radare2/test/unit/test_spaces.c" 3 4
)
# 18 "project/radare2/test/unit/test_spaces.c"
; do { if (!((act__) != 
...
# 18 "project/radare2/test/unit/test_spaces.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (sp->name); const char *exp__ = ("firstspace"); 
# 19 "project/radare2/test/unit/test_spaces.c" 3 4
__builtin___snprintf_chk (
# 19 "project/radare2/test/unit/test_spaces.c"
_meqstr
# 19 "project/radare2/test/unit/test_spaces.c" 3 4
, 
# 19 "project/radare2/test/unit/test_spaces.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 19, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 19, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { char _meqstr[5120]; const void *act__ = (sp); 
# 22 "project/radare2/test/unit/test_spaces.c" 3 4
__builtin___snprintf_chk (
# 22 "project/radare2/test/unit/test_spaces.c"
_meqstr
# 22 "project/radare2/test/unit/test_spaces.c" 3 4
, 
# 22 "project/radare2/test/unit/test_spaces.c"
...
# 22 "project/radare2/test/unit/test_spaces.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (sp->name); const char *exp__ = ("firstspace"); 
# 23 "project/radare2/test/unit/test_spaces.c" 3 4
__builtin___snprintf_chk (
# 23 "project/radare2/test/unit/test_spaces.c"
_meqstr
# 23 "project/radare2/test/unit/test_spaces.c" 3 4
, 
# 23 "project/radare2/test/unit/test_spaces.c"
...
# 29 "project/radare2/test/unit/test_spaces.c" 3 4
_Bool 
# 29 "project/radare2/test/unit/test_spaces.c"
    test_space_stack(void) {
 RSpaces *sps = r_spaces_new ("spacename");
 ...
 r_spaces_set (sps, 
# 35 "project/radare2/test/unit/test_spaces.c" 3 4
                   ((void *)0)
# 35 "project/radare2/test/unit/test_spaces.c"
                       );
 ...
 do { char _meqstr[5120]; const void *act__ = (s); const void *exp__ = (third); 
# 42 "project/radare2/test/unit/test_spaces.c" 3 4
__builtin___snprintf_chk (
# 42 "project/radare2/test/unit/test_spaces.c"
_meqstr
# 42 "project/radare2/test/unit/test_spaces.c" 3 4
, 
# 42 "project/radare2/test/unit/test_spaces.c"
...
, 2 > 1 ? 1 : 0), 
# 42 "project/radare2/test/unit/test_spaces.c"
"%s: expected %p, got %p.", ("third now set"), (exp__), (act__)
# 42 "project/radare2/test/unit/test_spaces.c" 3 4
)
# 42 "project/radare2/test/unit/test_spaces.c"
...
# 45 "project/radare2/test/unit/test_spaces.c" 3 4
__builtin___snprintf_chk (
# 45 "project/radare2/test/unit/test_spaces.c"
_meqstr
# 45 "project/radare2/test/unit/test_spaces.c" 3 4
, 
# 45 "project/radare2/test/unit/test_spaces.c"
...
, 2 > 1 ? 1 : 0), 
# 45 "project/radare2/test/unit/test_spaces.c"
"%s: expected to be NULL but it wasn't.", ("all set")
# 45 "project/radare2/test/unit/test_spaces.c" 3 4
)
# 45 "project/radare2/test/unit/test_spaces.c"
; do { if (!((act__) == 
...
# 45 "project/radare2/test/unit/test_spaces.c"
 ...
 r_spaces_pop (sps);
 s = r_spaces_current (sps);
 do { char _meqstr[5120]; const void *act__ = (s); const void *exp__ = (first); 
# 48 "project/radare2/test/unit/test_spaces.c" 3 4
__builtin___snprintf_chk (
# 48 "project/radare2/test/unit/test_spaces.c"
_meqstr
# 48 "project/radare2/test/unit/test_spaces.c" 3 4
, 
# 48 "project/radare2/test/unit/test_spaces.c"
...
, 2 > 1 ? 1 : 0), 
# 48 "project/radare2/test/unit/test_spaces.c"
"%s: expected %p, got %p.", ("first now set"), (exp__), (act__)
# 48 "project/radare2/test/unit/test_spaces.c" 3 4
)
# 48 "project/radare2/test/unit/test_spaces.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 48, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 48, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 ...
 s = r_spaces_current (sps);
 do { char _meqstr[5120]; const void *act__ = (s); 
# 51 "project/radare2/test/unit/test_spaces.c" 3 4
__builtin___snprintf_chk (
# 51 "project/radare2/test/unit/test_spaces.c"
_meqstr
# 51 "project/radare2/test/unit/test_spaces.c" 3 4
, 
# 51 "project/radare2/test/unit/test_spaces.c"
...
, 2 > 1 ? 1 : 0), 
# 51 "project/radare2/test/unit/test_spaces.c"
"%s: expected to be NULL but it wasn't.", ("nothing set")
# 51 "project/radare2/test/unit/test_spaces.c" 3 4
)
# 51 "project/radare2/test/unit/test_spaces.c"
; do { if (!((act__) == 
...
# 51 "project/radare2/test/unit/test_spaces.c"
 ...
 s = r_spaces_current (sps);
 do { char _meqstr[5120]; const char *act__ = (s->name); const char *exp__ = ("fourthspace"); 
# 55 "project/radare2/test/unit/test_spaces.c" 3 4
__builtin___snprintf_chk (
# 55 "project/radare2/test/unit/test_spaces.c"
_meqstr
# 55 "project/radare2/test/unit/test_spaces.c" 3 4
, 
# 55 "project/radare2/test/unit/test_spaces.c"
...
, 2 > 1 ? 1 : 0), 
# 55 "project/radare2/test/unit/test_spaces.c"
"%s: expected %s, got %s.", ("fourth created"), (exp__), (act__)
# 55 "project/radare2/test/unit/test_spaces.c" 3 4
)
# 55 "project/radare2/test/unit/test_spaces.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 55, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 55, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { char _meqstr[5120]; const void *act__ = (s); 
# 58 "project/radare2/test/unit/test_spaces.c" 3 4
__builtin___snprintf_chk (
# 58 "project/radare2/test/unit/test_spaces.c"
_meqstr
# 58 "project/radare2/test/unit/test_spaces.c" 3 4
, 
# 58 "project/radare2/test/unit/test_spaces.c"
...
, 2 > 1 ? 1 : 0), 
# 58 "project/radare2/test/unit/test_spaces.c"
"%s: expected to not be NULL but it was.", ("fourth should exist")
# 58 "project/radare2/test/unit/test_spaces.c" 3 4
)
# 58 "project/radare2/test/unit/test_spaces.c"
; do { if (!((act__) != 
...
static 
# 76 "project/radare2/test/unit/test_spaces.c" 3 4
      _Bool 
# 76 "project/radare2/test/unit/test_spaces.c"
           test_event_called = 
# 76 "project/radare2/test/unit/test_spaces.c" 3 4
                               0
# 76 "project/radare2/test/unit/test_spaces.c"
...
static void test_event(REvent *ev, int type, void *user, void *data) {
 test_event_called = 
# 79 "project/radare2/test/unit/test_spaces.c" 3 4
                    1
# 79 "project/radare2/test/unit/test_spaces.c"
                        ;
}


# 82 "project/radare2/test/unit/test_spaces.c" 3 4
_Bool 
# 82 "project/radare2/test/unit/test_spaces.c"
    test_space_event(void) {
 RSpaces *sps = r_spaces_new ("spacename");
...
# 88 "project/radare2/test/unit/test_spaces.c" 3 4
                                                            ((void *)0)
# 88 "project/radare2/test/unit/test_spaces.c"
                                                                );
 r_event_hook (sps->event, R_SPACE_EVENT_UNSET, test_event, 
# 89 "project/radare2/test/unit/test_spaces.c" 3 4
                                                           ((void *)0)
# 89 "project/radare2/test/unit/test_spaces.c"
                                                               );
 r_event_hook (sps->event, R_SPACE_EVENT_RENAME, test_event, 
# 90 "project/radare2/test/unit/test_spaces.c" 3 4
                                                            ((void *)0)
# 90 "project/radare2/test/unit/test_spaces.c"
                                                                );

 int c = r_spaces_count (sps, "firstspace");
 do { 
# 93 "project/radare2/test/unit/test_spaces.c" 3 4
unsigned long long 
# 93 "project/radare2/test/unit/test_spaces.c"
act__ = (
# 93 "project/radare2/test/unit/test_spaces.c" 3 4
unsigned long long
# 93 "project/radare2/test/unit/test_spaces.c"
...
# 93 "project/radare2/test/unit/test_spaces.c"
 ...
 do { 
# 95 "project/radare2/test/unit/test_spaces.c" 3 4
unsigned long long 
# 95 "project/radare2/test/unit/test_spaces.c"
act__ = (
# 95 "project/radare2/test/unit/test_spaces.c" 3 4
unsigned long long
# 95 "project/radare2/test/unit/test_spaces.c"
...
# 95 "project/radare2/test/unit/test_spaces.c"
 ...
 test_event_called = 
# 97 "project/radare2/test/unit/test_spaces.c" 3 4
                    0
# 97 "project/radare2/test/unit/test_spaces.c"
                         ;
 r_spaces_rename (sps, "thirdspace", "mynewname");
 do { if (!(test_event_called)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 99, "rename_event has been called"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 99, "rename_event has been called"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);

 RSpace *s = r_spaces_get (sps, "thirdspace");
 do { char _meqstr[5120]; const void *act__ = (s); 
# 102 "project/radare2/test/unit/test_spaces.c" 3 4
__builtin___snprintf_chk (
# 102 "project/radare2/test/unit/test_spaces.c"
_meqstr
# 102 "project/radare2/test/unit/test_spaces.c" 3 4
, 
# 102 "project/radare2/test/unit/test_spaces.c"
...
, 2 > 1 ? 1 : 0), 
# 102 "project/radare2/test/unit/test_spaces.c"
"%s: expected to be NULL but it wasn't.", ("thirdspace should not exist anymore")
# 102 "project/radare2/test/unit/test_spaces.c" 3 4
)
# 102 "project/radare2/test/unit/test_spaces.c"
; do { if (!((act__) == 
...
# 102 "project/radare2/test/unit/test_spaces.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (s); 
# 104 "project/radare2/test/unit/test_spaces.c" 3 4
__builtin___snprintf_chk (
# 104 "project/radare2/test/unit/test_spaces.c"
_meqstr
# 104 "project/radare2/test/unit/test_spaces.c" 3 4
, 
# 104 "project/radare2/test/unit/test_spaces.c"
...
, 2 > 1 ? 1 : 0), 
# 104 "project/radare2/test/unit/test_spaces.c"
"%s: expected to not be NULL but it was.", ("mynewname should exist now")
# 104 "project/radare2/test/unit/test_spaces.c" 3 4
)
# 104 "project/radare2/test/unit/test_spaces.c"
; do { if (!((act__) != 
...
# 104 "project/radare2/test/unit/test_spaces.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (s); const void *exp__ = (third); 
# 105 "project/radare2/test/unit/test_spaces.c" 3 4
__builtin___snprintf_chk (
# 105 "project/radare2/test/unit/test_spaces.c"
_meqstr
# 105 "project/radare2/test/unit/test_spaces.c" 3 4
, 
# 105 "project/radare2/test/unit/test_spaces.c"
...
, 2 > 1 ? 1 : 0), 
# 105 "project/radare2/test/unit/test_spaces.c"
"%s: expected %p, got %p.", ("and it should be equal to thirdspace ptr"), (exp__), (act__)
# 105 "project/radare2/test/unit/test_spaces.c" 3 4
)
# 105 "project/radare2/test/unit/test_spaces.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 105, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 105, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 ...
 test_event_called = 
# 107 "project/radare2/test/unit/test_spaces.c" 3 4
                    0
# 107 "project/radare2/test/unit/test_spaces.c"
                         ;
 r_spaces_unset (sps, "mynewname");
 do { if (!(test_event_called)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 109, "unset_event has been called"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 109, "unset_event has been called"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
...
int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_space_basic"); result = test_space_basic(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_space_stack"); result = test_space_stack(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_space_event"); result = test_space_event(); tests_run++; tests_passed += result; } while (0);
