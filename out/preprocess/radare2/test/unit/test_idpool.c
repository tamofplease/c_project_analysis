# 0 "project/radare2/test/unit/test_idpool.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/test/unit/test_idpool.c"
...
# 2 "project/radare2/test/unit/test_idpool.c" 2
...
# 3 "project/radare2/test/unit/test_idpool.c" 2


static 
# 5 "project/radare2/test/unit/test_idpool.c" 3 4
      _Bool 
# 5 "project/radare2/test/unit/test_idpool.c"
           test_r_id_pool_broken_parameters(void) {
 do { char _meqstr[5120]; const void *act__ = (r_id_pool_new (42, 3)); const void *exp__ = (
# 6 "project/radare2/test/unit/test_idpool.c" 3 4
((void *)0)
# 6 "project/radare2/test/unit/test_idpool.c"
); 
# 6 "project/radare2/test/unit/test_idpool.c" 3 4
__builtin___snprintf_chk (
# 6 "project/radare2/test/unit/test_idpool.c"
...
, 2 > 1 ? 1 : 0), 
# 6 "project/radare2/test/unit/test_idpool.c"
"%s: expected %p, got %p.", ("broken parameters"), (exp__), (act__)
# 6 "project/radare2/test/unit/test_idpool.c" 3 4
)
# 6 "project/radare2/test/unit/test_idpool.c"
...
static 
# 10 "project/radare2/test/unit/test_idpool.c" 3 4
      _Bool 
# 10 "project/radare2/test/unit/test_idpool.c"
           test_r_id_pool_start_id(void) {
 RIDPool *pool = r_id_pool_new (3, 42);
 
# 12 "project/radare2/test/unit/test_idpool.c" 3 4
unsigned int 
# 12 "project/radare2/test/unit/test_idpool.c"
     grabbed;
 r_id_pool_grab_id (pool, &grabbed);
 r_id_pool_free (pool);
 do { 
# 15 "project/radare2/test/unit/test_idpool.c" 3 4
unsigned long long 
# 15 "project/radare2/test/unit/test_idpool.c"
act__ = (
# 15 "project/radare2/test/unit/test_idpool.c" 3 4
unsigned long long
# 15 "project/radare2/test/unit/test_idpool.c"
...
static 
# 19 "project/radare2/test/unit/test_idpool.c" 3 4
      _Bool 
# 19 "project/radare2/test/unit/test_idpool.c"
           test_r_id_pool_id_reuse0(void) {
 RIDPool *pool = r_id_pool_new (3, 42);
 
# 21 "project/radare2/test/unit/test_idpool.c" 3 4
unsigned int 
# 21 "project/radare2/test/unit/test_idpool.c"
     grabbed[3];
 ...
 r_id_pool_free (pool);
 do { 
# 27 "project/radare2/test/unit/test_idpool.c" 3 4
unsigned long long 
# 27 "project/radare2/test/unit/test_idpool.c"
act__ = (
# 27 "project/radare2/test/unit/test_idpool.c" 3 4
unsigned long long
# 27 "project/radare2/test/unit/test_idpool.c"
...
unsigned long long
# 27 "project/radare2/test/unit/test_idpool.c"
)(grabbed[2]); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 27 "project/radare2/test/unit/test_idpool.c" 3 4
__builtin___snprintf_chk (
# 27 "project/radare2/test/unit/test_idpool.c"
_meqstr
...
static 
# 31 "project/radare2/test/unit/test_idpool.c" 3 4
      _Bool 
# 31 "project/radare2/test/unit/test_idpool.c"
           test_r_id_pool_id_reuse1(void) {
 RIDPool *pool = r_id_pool_new (3, 42);
 
# 33 "project/radare2/test/unit/test_idpool.c" 3 4
unsigned int 
# 33 "project/radare2/test/unit/test_idpool.c"
     grabbed[3];
 r_id_pool_grab_id (pool, &grabbed[0]);
 r_id_pool_grab_id (pool, &grabbed[1]);
 ...
 r_id_pool_free (pool);
 do { 
# 39 "project/radare2/test/unit/test_idpool.c" 3 4
unsigned long long 
# 39 "project/radare2/test/unit/test_idpool.c"
act__ = (
# 39 "project/radare2/test/unit/test_idpool.c" 3 4
unsigned long long
# 39 "project/radare2/test/unit/test_idpool.c"
...
static 
# 43 "project/radare2/test/unit/test_idpool.c" 3 4
      _Bool 
# 43 "project/radare2/test/unit/test_idpool.c"
           test_r_id_pool_id_unique(void) {
 RIDPool *pool = r_id_pool_new (3, 42);
 
# 45 "project/radare2/test/unit/test_idpool.c" 3 4
unsigned int 
# 45 "project/radare2/test/unit/test_idpool.c"
     grabbed[2];
 r_id_pool_grab_id (pool, &grabbed[0]);
 r_id_pool_grab_id (pool, &grabbed[1]);
 r_id_pool_free (pool);
 do { char _meqstr[5120]; 
# 49 "project/radare2/test/unit/test_idpool.c" 3 4
unsigned long long 
# 49 "project/radare2/test/unit/test_idpool.c"
act__ = (
# 49 "project/radare2/test/unit/test_idpool.c" 3 4
unsigned long long
# 49 "project/radare2/test/unit/test_idpool.c"
...
static 
# 53 "project/radare2/test/unit/test_idpool.c" 3 4
      _Bool 
# 53 "project/radare2/test/unit/test_idpool.c"
           test_r_id_pool_id_end_of_pool(void) {
 RIDPool *pool = r_id_pool_new (0, 1);
 
# 55 "project/radare2/test/unit/test_idpool.c" 3 4
unsigned int 
# 55 "project/radare2/test/unit/test_idpool.c"
     grabbed;
 r_id_pool_grab_id (pool, &grabbed);
 r_id_pool_grab_id (pool, &grabbed);
 const 
# 58 "project/radare2/test/unit/test_idpool.c" 3 4
      _Bool 
# 58 "project/radare2/test/unit/test_idpool.c"
           result = r_id_pool_grab_id (pool, &grabbed);
 r_id_pool_free (pool);
 do { 
# 60 "project/radare2/test/unit/test_idpool.c" 3 4
_Bool 
# 60 "project/radare2/test/unit/test_idpool.c"
act__ = (result); if ((act__)) { char _meqstr[5120]; 
# 60 "project/radare2/test/unit/test_idpool.c" 3 4
__builtin___snprintf_chk (
# 60 "project/radare2/test/unit/test_idpool.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 60 "project/radare2/test/unit/test_idpool.c"
"%s: expected false, got true", ("id_end_of_pool")
# 60 "project/radare2/test/unit/test_idpool.c" 3 4
)
# 60 "project/radare2/test/unit/test_idpool.c"
; do { if (!(
...
static 
# 64 "project/radare2/test/unit/test_idpool.c" 3 4
      _Bool 
# 64 "project/radare2/test/unit/test_idpool.c"
           test_r_id_pool_initial_pattern(void) {
 RIDPool *pool = r_id_pool_new (3, 42);
 
# 66 "project/radare2/test/unit/test_idpool.c" 3 4
unsigned int 
# 66 "project/radare2/test/unit/test_idpool.c"
     grabbed[3];
 r_id_pool_grab_id (pool, &grabbed[0]);
 r_id_pool_grab_id (pool, &grabbed[1]);
 r_id_pool_grab_id (pool, &grabbed[2]);
 r_id_pool_free (pool);
 do { 
# 71 "project/radare2/test/unit/test_idpool.c" 3 4
_Bool 
# 71 "project/radare2/test/unit/test_idpool.c"
act__ = (grabbed[0] < grabbed[1] && grabbed[1] < grabbed[2]); if (!(act__)) { char _meqstr[5120]; 
# 71 "project/radare2/test/unit/test_idpool.c" 3 4
__builtin___snprintf_chk (
# 71 "project/radare2/test/unit/test_idpool.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 71 "project/radare2/test/unit/test_idpool.c"
"%s: expected true, got false", ("initial_pattern")
# 71 "project/radare2/test/unit/test_idpool.c" 3 4
)
# 71 "project/radare2/test/unit/test_idpool.c"
; do { if (!(
...
static int all_tests(void) {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_id_pool_broken_parameters"); result = test_r_id_pool_broken_parameters(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_id_pool_start_id"); result = test_r_id_pool_start_id(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_id_pool_id_reuse0"); result = test_r_id_pool_id_reuse0(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_id_pool_id_reuse1"); result = test_r_id_pool_id_reuse1(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_id_pool_id_unique"); result = test_r_id_pool_id_unique(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_id_pool_id_end_of_pool"); result = test_r_id_pool_id_end_of_pool(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_id_pool_initial_pattern"); result = test_r_id_pool_initial_pattern(); tests_run++; tests_passed += result; } while (0);
