# 0 "project/radare2/test/unit/test_dwarf_info.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/test/unit/test_dwarf_info.c"
...
# 2 "project/radare2/test/unit/test_dwarf_info.c" 2
...
# 3 "project/radare2/test/unit/test_dwarf_info.c" 2
...
# 4 "project/radare2/test/unit/test_dwarf_info.c" 2
# 54 "project/radare2/test/unit/test_dwarf_info.c"
_Bool 
# 54 "project/radare2/test/unit/test_dwarf_info.c"
    test_dwarf3_c(void) {
 RBin *bin = r_bin_new ();
...
# 60 "project/radare2/test/unit/test_dwarf_info.c" 3 4
_Bool 
# 60 "project/radare2/test/unit/test_dwarf_info.c"
     res = r_bin_open (bin, "bins/elf/dwarf3_c.elf", &opt);
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 61, "dwarf3_c.elf binary could not be opened"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 61, "dwarf3_c.elf binary could not be opened"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);

 RBinDwarfDebugAbbrev *da = r_bin_dwarf_parse_abbrev (bin, 2);
 do { 
# 64 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 64 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 64 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 64 "project/radare2/test/unit/test_dwarf_info.c"
...
"lld" 
# 64 "project/radare2/test/unit/test_dwarf_info.c"
".", ("Incorrect number of abbreviation"), (
# 64 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 64 "project/radare2/test/unit/test_dwarf_info.c"
)(exp__), (
...
# 64 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 RBinDwarfDebugInfo *info = r_bin_dwarf_parse_info (da, bin, 2);
 do { 
# 66 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 66 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 66 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 66 "project/radare2/test/unit/test_dwarf_info.c"
...
"lld" 
# 66 "project/radare2/test/unit/test_dwarf_info.c"
".", ("Incorrect number of info compilation units"), (
# 66 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 66 "project/radare2/test/unit/test_dwarf_info.c"
)(exp__), (
...
# 66 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { do { 
# 72 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 72 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 72 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 72 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 72 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 72, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 72, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0); do { 
# 72 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 72 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
...
unsigned long long
# 72 "project/radare2/test/unit/test_dwarf_info.c"
)(0xa9); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 72 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 72 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
"lld" 
# 72 "project/radare2/test/unit/test_dwarf_info.c"
".", ("Wrong header length information"), (
# 72 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 72 "project/radare2/test/unit/test_dwarf_info.c"
)(exp__), (
...
"lld" 
# 72 "project/radare2/test/unit/test_dwarf_info.c"
".", ("Wrong header is_64bit information"), (
# 72 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 72 "project/radare2/test/unit/test_dwarf_info.c"
)(exp__), (
...
"lld" 
# 72 "project/radare2/test/unit/test_dwarf_info.c"
".", ("Wrong header address_size information"), (
# 72 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 72 "project/radare2/test/unit/test_dwarf_info.c"
)(exp__), (
...
unsigned long long
# 72 "project/radare2/test/unit/test_dwarf_info.c"
)(0x0); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 72 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 72 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
"lld" 
# 72 "project/radare2/test/unit/test_dwarf_info.c"
".", ("Wrong header abbrev_offset information"), (
# 72 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 72 "project/radare2/test/unit/test_dwarf_info.c"
)(exp__), (
...
0
# 72 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 72, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 72, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0); } while (0);

 do { 
# 74 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 74 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 74 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 74 "project/radare2/test/unit/test_dwarf_info.c"
...
# 74 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 75 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 75 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 75 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 75 "project/radare2/test/unit/test_dwarf_info.c"
...
# 75 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 int i = 0;
 do { 
# 78 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 78 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 78 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 78 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].abbrev_code); 
# 78 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 78 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
# 78 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 80 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 80 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 80 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 80 "project/radare2/test/unit/test_dwarf_info.c"
...
# 80 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 81 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 81 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 81 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 81 "project/radare2/test/unit/test_dwarf_info.c"
...
# 81 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 83 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 83 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 83 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 83 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[0].attr_name); 
# 83 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 83 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
# 83 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (cu.dies[i].attr_values[2].string.content); const char *exp__ = ("main.c"); 
# 84 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 84 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
# 84 "project/radare2/test/unit/test_dwarf_info.c" 3 4
, 
# 84 "project/radare2/test/unit/test_dwarf_info.c"
...
, 2 > 1 ? 1 : 0), 
# 84 "project/radare2/test/unit/test_dwarf_info.c"
"%s: expected %s, got %s.", ("Wrong string attribute information"), (exp__), (act__)
# 84 "project/radare2/test/unit/test_dwarf_info.c" 3 4
)
# 84 "project/radare2/test/unit/test_dwarf_info.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 84, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 84, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 i++;
 do { 
# 86 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 86 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 86 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 86 "project/radare2/test/unit/test_dwarf_info.c"
...
# 86 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 88 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 88 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 88 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 88 "project/radare2/test/unit/test_dwarf_info.c"
...
# 88 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 90 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 90 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 90 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 90 "project/radare2/test/unit/test_dwarf_info.c"
...
# 90 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 92 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 92 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 92 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 92 "project/radare2/test/unit/test_dwarf_info.c"
...
# 92 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 94 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 94 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 94 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 94 "project/radare2/test/unit/test_dwarf_info.c"
...
# 94 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 96 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 96 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 96 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 96 "project/radare2/test/unit/test_dwarf_info.c"
...
# 96 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 98 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 98 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 98 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 98 "project/radare2/test/unit/test_dwarf_info.c"
...
# 98 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (cu.dies[i].attr_values[0].string.content); const char *exp__ = ("b"); 
# 100 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 100 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
# 100 "project/radare2/test/unit/test_dwarf_info.c" 3 4
, 
# 100 "project/radare2/test/unit/test_dwarf_info.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 100, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 100, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 101 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 101 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 101 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 101 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[3].uconstant); 
# 101 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 101 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
# 101 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 104 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 104 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 104 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 104 "project/radare2/test/unit/test_dwarf_info.c"
...
# 104 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 106 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 106 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 106 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 106 "project/radare2/test/unit/test_dwarf_info.c"
...
# 106 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 108 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 108 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 108 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 108 "project/radare2/test/unit/test_dwarf_info.c"
...
# 117 "project/radare2/test/unit/test_dwarf_info.c" 3 4
_Bool 
# 117 "project/radare2/test/unit/test_dwarf_info.c"
    test_dwarf4_cpp_multiple_modules(void) {
 RBin *bin = r_bin_new ();
 RIO *io = r_io_new ();
 r_io_bind (io, &bin->iob);
...
# 123 "project/radare2/test/unit/test_dwarf_info.c" 3 4
_Bool 
# 123 "project/radare2/test/unit/test_dwarf_info.c"
     res = r_bin_open (bin, "bins/elf/dwarf4_many_comp_units.elf", &opt);
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 124, "dwarf4_many_comp_units.elf binary could not be opened"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 124, "dwarf4_many_comp_units.elf binary could not be opened"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);

 RBinDwarfDebugAbbrev *da = r_bin_dwarf_parse_abbrev (bin, 2);
 do { 
# 127 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 127 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 127 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 127 "project/radare2/test/unit/test_dwarf_info.c"
...
# 129 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 129 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
# 129 "project/radare2/test/unit/test_dwarf_info.c" 3 4
, 
# 129 "project/radare2/test/unit/test_dwarf_info.c"
...
, 2 > 1 ? 1 : 0), 
# 129 "project/radare2/test/unit/test_dwarf_info.c"
"%s: expected to not be NULL but it was.", ("Failed parsing of debug_info")
# 129 "project/radare2/test/unit/test_dwarf_info.c" 3 4
)
# 129 "project/radare2/test/unit/test_dwarf_info.c"
; do { if (!((act__) != 
...
# 129 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 130 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 130 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 130 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 130 "project/radare2/test/unit/test_dwarf_info.c"
...
# 130 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 RBinDwarfCompUnitHdr hdr = cu.hdr;
 do { do { 
# 135 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 135 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 135 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 135 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 135 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 135, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 135, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0); do { 
# 135 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 135 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
...
unsigned long long
# 135 "project/radare2/test/unit/test_dwarf_info.c"
)(0x2c0); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 135 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 135 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
0
# 135 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 135, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 135, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0); } while (0);


 do { 
# 138 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 138 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 138 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 138 "project/radare2/test/unit/test_dwarf_info.c"
...
unsigned long long
# 138 "project/radare2/test/unit/test_dwarf_info.c"
)(73); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 138 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 138 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
# 138 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 139 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 139 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 139 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 139 "project/radare2/test/unit/test_dwarf_info.c"
...
# 139 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 int i = 0;
 do { 
# 142 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 142 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 142 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 142 "project/radare2/test/unit/test_dwarf_info.c"
...
# 142 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 143 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 143 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 143 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 143 "project/radare2/test/unit/test_dwarf_info.c"
...
# 143 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 144 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 144 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 144 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 144 "project/radare2/test/unit/test_dwarf_info.c"
...
# 144 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 146 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 146 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 146 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 146 "project/radare2/test/unit/test_dwarf_info.c"
...
# 146 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (cu.dies[i].attr_values[2].string.content); const char *exp__ = ("../main.cpp"); 
# 147 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 147 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
# 147 "project/radare2/test/unit/test_dwarf_info.c" 3 4
, 
# 147 "project/radare2/test/unit/test_dwarf_info.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 147, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 147, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 148 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 148 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 148 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 148 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[6].attr_name); 
# 148 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 148 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
# 148 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 149 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 149 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 149 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 149 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[6].reference); 
# 149 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 149 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
# 149 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 152 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 152 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 152 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 152 "project/radare2/test/unit/test_dwarf_info.c"
...
# 152 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 154 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 154 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 154 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 154 "project/radare2/test/unit/test_dwarf_info.c"
...
# 154 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 156 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 156 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 156 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 156 "project/radare2/test/unit/test_dwarf_info.c"
...
# 156 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 158 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 158 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 158 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 158 "project/radare2/test/unit/test_dwarf_info.c"
...
# 158 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 160 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 160 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 160 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 160 "project/radare2/test/unit/test_dwarf_info.c"
...
# 160 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 163 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 163 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 163 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 163 "project/radare2/test/unit/test_dwarf_info.c"
...
# 163 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 164 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 164 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 164 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 164 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[0].reference); 
# 164 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 164 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
unsigned long long
# 164 "project/radare2/test/unit/test_dwarf_info.c"
)(0x6e); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 164 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 164 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
# 164 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 165 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 165 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 165 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 165 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[1].uconstant); 
# 165 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 165 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
# 165 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (cu.dies[i].attr_values[2].string.content); const char *exp__ = ("Bird"); 
# 166 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 166 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
# 166 "project/radare2/test/unit/test_dwarf_info.c" 3 4
, 
# 166 "project/radare2/test/unit/test_dwarf_info.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 166, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 166, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 167 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 167 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 167 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 167 "project/radare2/test/unit/test_dwarf_info.c"
...
# 167 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 168 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 168 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 168 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 168 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[4].uconstant); 
# 168 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 168 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
0
# 168 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 168, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 168, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 169 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 169 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 169 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 169 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[5].uconstant); 
# 169 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 169 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
# 169 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 171 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 171 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 171 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 171 "project/radare2/test/unit/test_dwarf_info.c"
...
# 171 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 172 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 172 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 172 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 172 "project/radare2/test/unit/test_dwarf_info.c"
...
# 172 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (cu.dies[i].attr_values[0].string.content); const char *exp__ = ("_vptr$Bird"); 
# 173 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 173 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
# 173 "project/radare2/test/unit/test_dwarf_info.c" 3 4
, 
# 173 "project/radare2/test/unit/test_dwarf_info.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 173, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 173, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 174 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 174 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 174 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 174 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[1].reference); 
# 174 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 174 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
unsigned long long
# 174 "project/radare2/test/unit/test_dwarf_info.c"
)(0xc5); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 174 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 174 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
# 174 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 175 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 175 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 175 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 175 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[2].uconstant); 
# 175 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 175 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
# 175 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 176 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 176 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 176 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 176 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[3].flag); 
# 176 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 176 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
# 176 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 179 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 179 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 179 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 179 "project/radare2/test/unit/test_dwarf_info.c"
...
# 179 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 181 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 181 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 181 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 181 "project/radare2/test/unit/test_dwarf_info.c"
...
# 181 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 183 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 183 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 183 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 183 "project/radare2/test/unit/test_dwarf_info.c"
...
# 183 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 185 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 185 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 185 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 185 "project/radare2/test/unit/test_dwarf_info.c"
...
# 185 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 187 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 187 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 187 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 187 "project/radare2/test/unit/test_dwarf_info.c"
...
# 187 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 189 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 189 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 189 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 189 "project/radare2/test/unit/test_dwarf_info.c"
...
# 189 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 191 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 191 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 191 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 191 "project/radare2/test/unit/test_dwarf_info.c"
...
# 191 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 192 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 192 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 192 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 192 "project/radare2/test/unit/test_dwarf_info.c"
...
# 192 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 193 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 193 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 193 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 193 "project/radare2/test/unit/test_dwarf_info.c"
...
# 193 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (cu.dies[i].attr_values[0].string.content); const char *exp__ = ("_ZN4Bird3flyEv"); 
# 194 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 194 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
# 194 "project/radare2/test/unit/test_dwarf_info.c" 3 4
, 
# 194 "project/radare2/test/unit/test_dwarf_info.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 194, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 194, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (cu.dies[i].attr_values[1].string.content); const char *exp__ = ("fly"); 
# 195 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 195 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
# 195 "project/radare2/test/unit/test_dwarf_info.c" 3 4
, 
# 195 "project/radare2/test/unit/test_dwarf_info.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 195, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 195, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 196 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 196 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 196 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 196 "project/radare2/test/unit/test_dwarf_info.c"
...
# 196 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 197 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 197 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 197 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 197 "project/radare2/test/unit/test_dwarf_info.c"
...
# 197 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 198 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 198 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 198 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 198 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[4].reference); 
# 198 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 198 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
unsigned long long
# 198 "project/radare2/test/unit/test_dwarf_info.c"
)(0xd8); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 198 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 198 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
# 198 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 199 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 199 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 199 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 199 "project/radare2/test/unit/test_dwarf_info.c"
...
# 199 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 200 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 200 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 200 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 200 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[7].attr_form); 
# 200 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 200 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
# 200 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 201 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 201 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 201 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 201 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[7].flag); 
# 201 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 201 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
# 201 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 202 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 202 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 202 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 202 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[8].attr_name); 
# 202 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 202 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
# 202 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 203 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 203 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 203 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 203 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[8].flag); 
# 203 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 203 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
# 203 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 204 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 204 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 204 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 204 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[9].attr_name); 
# 204 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 204 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
# 204 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 205 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 205 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 205 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 205 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[9].reference); 
# 205 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 205 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
# 205 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 207 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 207 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 207 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 207 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 207 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 207, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 207, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 208 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 208 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 208 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 208 "project/radare2/test/unit/test_dwarf_info.c"
...
# 208 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 210 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 210 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 210 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 210 "project/radare2/test/unit/test_dwarf_info.c"
...
# 210 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 211 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 211 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 211 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 211 "project/radare2/test/unit/test_dwarf_info.c"
...
# 211 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 213 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 213 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 213 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 213 "project/radare2/test/unit/test_dwarf_info.c"
...
# 213 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 214 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 214 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 214 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 214 "project/radare2/test/unit/test_dwarf_info.c"
...
# 214 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 216 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 216 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 216 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 216 "project/radare2/test/unit/test_dwarf_info.c"
...
# 216 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 217 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 217 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 217 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 217 "project/radare2/test/unit/test_dwarf_info.c"
...
# 217 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 219 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 219 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 219 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 219 "project/radare2/test/unit/test_dwarf_info.c"
...
# 219 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 220 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 220 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 220 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 220 "project/radare2/test/unit/test_dwarf_info.c"
...
# 220 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 222 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 222 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 222 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 222 "project/radare2/test/unit/test_dwarf_info.c"
...
# 222 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 223 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 223 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 223 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 223 "project/radare2/test/unit/test_dwarf_info.c"
...
# 223 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 225 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 225 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 225 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 225 "project/radare2/test/unit/test_dwarf_info.c"
...
# 225 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 226 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 226 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 226 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 226 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 226 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 226, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 226, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 227 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 227 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 227 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 227 "project/radare2/test/unit/test_dwarf_info.c"
...
# 227 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 229 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 229 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 229 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 229 "project/radare2/test/unit/test_dwarf_info.c"
...
# 229 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 231 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 231 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 231 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 231 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 231 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 231, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 231, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 i++;
 do { 
# 233 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 233 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 233 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 233 "project/radare2/test/unit/test_dwarf_info.c"
...
# 233 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 235 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 235 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 235 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 235 "project/radare2/test/unit/test_dwarf_info.c"
...
# 235 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 237 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 237 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 237 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 237 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 237 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 237, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 237, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 i = 66;
 do { 
# 239 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 239 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 239 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 239 "project/radare2/test/unit/test_dwarf_info.c"
...
# 239 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 240 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 240 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 240 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 240 "project/radare2/test/unit/test_dwarf_info.c"
...
# 240 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 241 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 241 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 241 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 241 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[3].reference); 
# 241 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 241 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
unsigned long long
# 241 "project/radare2/test/unit/test_dwarf_info.c"
)(0x2a7); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 241 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 241 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
# 241 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 243 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 243 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 243 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 243 "project/radare2/test/unit/test_dwarf_info.c"
...
# 243 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 244 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 244 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 244 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 244 "project/radare2/test/unit/test_dwarf_info.c"
...
# 244 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 245 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 245 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 245 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 245 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[0].block.length); 
# 245 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 245 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
# 245 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 246 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 246 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 246 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 246 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[0].block.data[0]); 
# 246 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 246 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
unsigned long long
# 246 "project/radare2/test/unit/test_dwarf_info.c"
)(0x91); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 246 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 246 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
# 246 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 247 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 247 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 247 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 247 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[0].block.data[1]); 
# 247 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 247 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
unsigned long long
# 247 "project/radare2/test/unit/test_dwarf_info.c"
)(0x78); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 247 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 247 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
0
# 247 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 247, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 247, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { char _meqstr[5120]; const char *act__ = (cu.dies[i].attr_values[1].string.content); const char *exp__ = ("this"); 
# 248 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 248 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
# 248 "project/radare2/test/unit/test_dwarf_info.c" 3 4
, 
# 248 "project/radare2/test/unit/test_dwarf_info.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 248, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 248, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 249 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 249 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 249 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 249 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[2].reference); 
# 249 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 249 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
unsigned long long
# 249 "project/radare2/test/unit/test_dwarf_info.c"
)(0x2be); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 249 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 249 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
0
# 249 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 249, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 249, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 250 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 250 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 250 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 250 "project/radare2/test/unit/test_dwarf_info.c"
...
# 250 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 252 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 252 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 252 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 252 "project/radare2/test/unit/test_dwarf_info.c"
...
# 252 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 254 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 254 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 254 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 254 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 254 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 254, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 254, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 i++;
 do { 
# 256 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 256 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 256 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 256 "project/radare2/test/unit/test_dwarf_info.c"
...
# 256 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 257 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 257 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 257 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 257 "project/radare2/test/unit/test_dwarf_info.c"
...
# 257 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 259 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 259 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 259 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 259 "project/radare2/test/unit/test_dwarf_info.c"
...
# 259 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 261 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 261 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 261 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 261 "project/radare2/test/unit/test_dwarf_info.c"
...
# 261 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 hdr = cu.hdr;
 do { do { 
# 266 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 266 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 266 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 266 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 266 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 266, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 266, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0); do { 
# 266 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 266 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
...
unsigned long long
# 266 "project/radare2/test/unit/test_dwarf_info.c"
)(0x192); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 266 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 266 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
unsigned long long
# 266 "project/radare2/test/unit/test_dwarf_info.c"
)(0xfd); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 266 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 266 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
0
# 266 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 266, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 266, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0); } while (0);


 do { 
# 269 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 269 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 269 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 269 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 269 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 269, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 269, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 270 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 270 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 270 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 270 "project/radare2/test/unit/test_dwarf_info.c"
...
unsigned long long
# 270 "project/radare2/test/unit/test_dwarf_info.c"
)(0x2c4); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 270 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 270 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
# 270 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i = 0;
 do { 
# 273 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 273 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 273 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 273 "project/radare2/test/unit/test_dwarf_info.c"
...
# 273 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 274 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 274 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 274 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 274 "project/radare2/test/unit/test_dwarf_info.c"
...
# 274 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 275 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 275 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 275 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 275 "project/radare2/test/unit/test_dwarf_info.c"
...
# 275 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 276 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 276 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 276 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 276 "project/radare2/test/unit/test_dwarf_info.c"
...
# 276 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (cu.dies[i].attr_values[0].string.content); const char *exp__ = ("clang version 10.0.0-4ubuntu1 "); 
# 277 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 277 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
# 277 "project/radare2/test/unit/test_dwarf_info.c" 3 4
, 
# 277 "project/radare2/test/unit/test_dwarf_info.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 277, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 277, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 278 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 278 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 278 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 278 "project/radare2/test/unit/test_dwarf_info.c"
...
unsigned long long
# 278 "project/radare2/test/unit/test_dwarf_info.c"
)(33); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 278 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 278 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
0
# 278 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 278, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 278, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { char _meqstr[5120]; const char *act__ = (cu.dies[i].attr_values[2].string.content); const char *exp__ = ("../mammal.cpp"); 
# 279 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 279 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
# 279 "project/radare2/test/unit/test_dwarf_info.c" 3 4
, 
# 279 "project/radare2/test/unit/test_dwarf_info.c"
...
# 279 "project/radare2/test/unit/test_dwarf_info.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 279, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 279, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 280 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 280 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 280 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 280 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[5].address); 
# 280 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 280 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
# 280 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 281 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 281 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 281 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 281 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[5].attr_form); 
# 281 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 281 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
# 281 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 282 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 282 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 282 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 282 "project/radare2/test/unit/test_dwarf_info.c"
...
# 282 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 283 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 283 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 283 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 283 "project/radare2/test/unit/test_dwarf_info.c"
...
unsigned long long
# 283 "project/radare2/test/unit/test_dwarf_info.c"
)(0xb0); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 283 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 283 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
0
# 283 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 283, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 283, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 i++;
 do { 
# 285 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 285 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 285 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 285 "project/radare2/test/unit/test_dwarf_info.c"
...
# 285 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 287 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 287 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 287 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 287 "project/radare2/test/unit/test_dwarf_info.c"
...
# 287 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 289 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 289 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 289 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 289 "project/radare2/test/unit/test_dwarf_info.c"
...
# 289 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 291 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 291 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 291 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 291 "project/radare2/test/unit/test_dwarf_info.c"
...
# 291 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 293 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 293 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 293 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 293 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 293 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 293, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 293, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 i++;
 do { 
# 295 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 295 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 295 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 295 "project/radare2/test/unit/test_dwarf_info.c"
...
# 295 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 297 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 297 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 297 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 297 "project/radare2/test/unit/test_dwarf_info.c"
...
# 297 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 299 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 299 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 299 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 299 "project/radare2/test/unit/test_dwarf_info.c"
...
# 299 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i = 35;
 do { 
# 301 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 301 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 301 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 301 "project/radare2/test/unit/test_dwarf_info.c"
...
# 301 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 302 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 302 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 302 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 302 "project/radare2/test/unit/test_dwarf_info.c"
...
# 302 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 303 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 303 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 303 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 303 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 303 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 303, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 303, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 304 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 304 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 304 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 304 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[0].attr_form); 
# 304 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 304 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
# 304 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 305 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 305 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 305 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 305 "project/radare2/test/unit/test_dwarf_info.c"
...
unsigned long long
# 305 "project/radare2/test/unit/test_dwarf_info.c"
)(0x407); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 305 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 305 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
# 305 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++;
 do { 
# 307 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 307 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 307 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 307 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 307 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 307, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 307, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 308 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 308 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 308 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 308 "project/radare2/test/unit/test_dwarf_info.c"
...
# 308 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 309 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 309 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 309 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 309 "project/radare2/test/unit/test_dwarf_info.c"
...
# 309 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 310 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 310 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 310 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 310 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[2].attr_name); 
# 310 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 310 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
0
# 310 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 310, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 310, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 311 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 311 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 311 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 311 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[2].block.length); 
# 311 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 311 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
0
# 311 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 311, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 311, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 312 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 312 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 312 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 312 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[2].block.data[0]); 
# 312 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 312 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
unsigned long long
# 312 "project/radare2/test/unit/test_dwarf_info.c"
)(0x56); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 312 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 312 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
0
# 312 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 312, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 312, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 313 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 313 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 313 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 313 "project/radare2/test/unit/test_dwarf_info.c"
...
unsigned long long
# 313 "project/radare2/test/unit/test_dwarf_info.c"
)(0x442); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 313 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 313 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
0
# 313 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 313, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 313, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 314 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 314 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 314 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 314 "project/radare2/test/unit/test_dwarf_info.c"
...
unsigned long long
# 314 "project/radare2/test/unit/test_dwarf_info.c"
)(0x410); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 314 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 314 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
0
# 314 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 314, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 314, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 i=40;
 do { 
# 316 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 316 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 316 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 316 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 316 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 316, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 316, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 i++;
 do { 
# 318 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 318 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 318 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 318 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 318 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 318, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 318, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
...
# 327 "project/radare2/test/unit/test_dwarf_info.c" 3 4
_Bool 
# 327 "project/radare2/test/unit/test_dwarf_info.c"
    test_dwarf2_big_endian(void) {
 RBin *bin = r_bin_new ();
 RIO *io = r_io_new ();
 r_io_bind (io, &bin->iob);
...
# 333 "project/radare2/test/unit/test_dwarf_info.c" 3 4
_Bool 
# 333 "project/radare2/test/unit/test_dwarf_info.c"
     res = r_bin_open (bin, "bins/elf/ppc64_sudoku_dwarf", &opt);
 do { if (!(res)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 334, "dwarf4_many_comp_units.elf binary could not be opened"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 334, "dwarf4_many_comp_units.elf binary could not be opened"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);

 RBinDwarfDebugAbbrev *da = r_bin_dwarf_parse_abbrev (bin, 2);
 do { 
# 337 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 337 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 337 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 337 "project/radare2/test/unit/test_dwarf_info.c"
...
unsigned long long
# 337 "project/radare2/test/unit/test_dwarf_info.c"
)(108); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 337 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 337 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
# 337 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 RBinDwarfDebugInfo *info = r_bin_dwarf_parse_info (da, bin, 2);
 do { char _meqstr[5120]; const void *act__ = (info); 
# 339 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 339 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
# 339 "project/radare2/test/unit/test_dwarf_info.c" 3 4
, 
# 339 "project/radare2/test/unit/test_dwarf_info.c"
...
# 339 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 340 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 340 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 340 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 340 "project/radare2/test/unit/test_dwarf_info.c"
...
# 340 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 RBinDwarfCompUnitHdr hdr = cu.hdr;
 do { do { 
# 345 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 345 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 345 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 345 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 345 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 345, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 345, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0); do { 
# 345 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 345 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
...
unsigned long long
# 345 "project/radare2/test/unit/test_dwarf_info.c"
)(0x38b9); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 345 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 345 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
0
# 345 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 345, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 345, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0); } while (0);

 int i = 0;
 do { 
# 348 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 348 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 348 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 348 "project/radare2/test/unit/test_dwarf_info.c"
...
# 348 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 349 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 349 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 349 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 349 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 349 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 349, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 349, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 350 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 350 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 350 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 350 "project/radare2/test/unit/test_dwarf_info.c"
...
# 350 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 352 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 352 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 352 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 352 "project/radare2/test/unit/test_dwarf_info.c"
...
# 352 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (cu.dies[i].attr_values[0].string.content); const char *exp__ = ("GNU C++14 9.3.0 -msecure-plt -mabi=elfv2 -mcpu=970 -gdwarf-2 -gstrict-dwarf -O1"); 
# 353 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 353 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
# 353 "project/radare2/test/unit/test_dwarf_info.c" 3 4
, 
# 353 "project/radare2/test/unit/test_dwarf_info.c"
...
# 353 "project/radare2/test/unit/test_dwarf_info.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 353, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 353, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 354 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 354 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 354 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 354 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[1].attr_name); 
# 354 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 354 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
0
# 354 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 354, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 354, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 355 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 355 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 355 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 355 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 355 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 355, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 355, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 do { 
# 357 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 357 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 357 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 357 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[4].attr_name); 
# 357 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 357 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
# 357 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 358 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 358 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 358 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 358 "project/radare2/test/unit/test_dwarf_info.c"
...
unsigned long long
# 358 "project/radare2/test/unit/test_dwarf_info.c"
)(0x0000000010000ec4); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 358 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 358 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
# 358 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 359 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 359 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 359 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 359 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[5].attr_name); 
# 359 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 359 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
# 359 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 360 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 360 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 360 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 360 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[5].reference); 
# 360 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 360 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
unsigned long long
# 360 "project/radare2/test/unit/test_dwarf_info.c"
)(0x0000000010001c48); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 360 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 360 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
0
# 360 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 360, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 360, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 361 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 361 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 361 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 361 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 361 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 361, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 361, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 362 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 362 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 362 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 362 "project/radare2/test/unit/test_dwarf_info.c"
...
# 362 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i+=2;
 do { 
# 365 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 365 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 365 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 365 "project/radare2/test/unit/test_dwarf_info.c"
...
# 365 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 366 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 366 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 366 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 366 "project/radare2/test/unit/test_dwarf_info.c"
...
# 366 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 368 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 368 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 368 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 368 "project/radare2/test/unit/test_dwarf_info.c"
...
# 368 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 369 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 369 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 369 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 369 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[0].uconstant); 
# 369 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 369 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
unsigned long long
# 369 "project/radare2/test/unit/test_dwarf_info.c"
)(0x08); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 369 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 369 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
0
# 369 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 369, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 369, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 do { 
# 371 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 371 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 371 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 371 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 371 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 371, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 371, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 372 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 372 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 372 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 372 "project/radare2/test/unit/test_dwarf_info.c"
...
# 372 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 374 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 374 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 374 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 374 "project/radare2/test/unit/test_dwarf_info.c"
...
# 374 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (cu.dies[i].attr_values[2].string.content); const char *exp__ = ("long unsigned int"); 
# 375 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 375 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
# 375 "project/radare2/test/unit/test_dwarf_info.c" 3 4
, 
# 375 "project/radare2/test/unit/test_dwarf_info.c"
...
# 375 "project/radare2/test/unit/test_dwarf_info.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 375, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 375, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 i++; do { 
# 377 "project/radare2/test/unit/test_dwarf_info.c" 3 4
     unsigned long long 
# 377 "project/radare2/test/unit/test_dwarf_info.c"
     act__ = (
# 377 "project/radare2/test/unit/test_dwarf_info.c" 3 4
     unsigned long long
# 377 "project/radare2/test/unit/test_dwarf_info.c"
...
# 377 "project/radare2/test/unit/test_dwarf_info.c" 3 4
     0
# 377 "project/radare2/test/unit/test_dwarf_info.c"
     )) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 377, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 377, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 i++; do { 
# 378 "project/radare2/test/unit/test_dwarf_info.c" 3 4
     unsigned long long 
# 378 "project/radare2/test/unit/test_dwarf_info.c"
     act__ = (
# 378 "project/radare2/test/unit/test_dwarf_info.c" 3 4
     unsigned long long
# 378 "project/radare2/test/unit/test_dwarf_info.c"
...
# 378 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i++; do { 
# 379 "project/radare2/test/unit/test_dwarf_info.c" 3 4
     unsigned long long 
# 379 "project/radare2/test/unit/test_dwarf_info.c"
     act__ = (
# 379 "project/radare2/test/unit/test_dwarf_info.c" 3 4
     unsigned long long
# 379 "project/radare2/test/unit/test_dwarf_info.c"
...
# 379 "project/radare2/test/unit/test_dwarf_info.c" 3 4
     0
# 379 "project/radare2/test/unit/test_dwarf_info.c"
     )) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 379, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 379, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 i++; do { 
# 380 "project/radare2/test/unit/test_dwarf_info.c" 3 4
     unsigned long long 
# 380 "project/radare2/test/unit/test_dwarf_info.c"
     act__ = (
# 380 "project/radare2/test/unit/test_dwarf_info.c" 3 4
     unsigned long long
# 380 "project/radare2/test/unit/test_dwarf_info.c"
...
# 380 "project/radare2/test/unit/test_dwarf_info.c" 3 4
     0
# 380 "project/radare2/test/unit/test_dwarf_info.c"
     )) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 380, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 380, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 i++;

 do { 
# 383 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 383 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 383 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 383 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 383 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 383, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 383, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 384 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 384 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 384 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 384 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 384 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 384, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 384, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 do { 
# 386 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 386 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 386 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 386 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 386 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 386, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 386, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { char _meqstr[5120]; const char *act__ = (cu.dies[i].attr_values[0].string.content); const char *exp__ = ("_IO_FILE"); 
# 387 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 387 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
# 387 "project/radare2/test/unit/test_dwarf_info.c" 3 4
, 
# 387 "project/radare2/test/unit/test_dwarf_info.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 387, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 387, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { 
# 389 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 389 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 389 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 389 "project/radare2/test/unit/test_dwarf_info.c"
...
# 389 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 390 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 390 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 390 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 390 "project/radare2/test/unit/test_dwarf_info.c"
...
unsigned long long
# 390 "project/radare2/test/unit/test_dwarf_info.c"
)(0x01); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 390 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 390 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
# 390 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 392 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 392 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 392 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 392 "project/radare2/test/unit/test_dwarf_info.c"
...
# 392 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 393 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 393 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 393 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 393 "project/radare2/test/unit/test_dwarf_info.c"
)(cu.dies[i].attr_values[3].attr_name); 
# 393 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 393 "project/radare2/test/unit/test_dwarf_info.c"
exp__ = (
...
0
# 393 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 393, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 393, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 394 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 394 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 394 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 394 "project/radare2/test/unit/test_dwarf_info.c"
...
# 394 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 395 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 395 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 395 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 395 "project/radare2/test/unit/test_dwarf_info.c"
...
# 395 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 i = 1668 - 4;
 do { 
# 398 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 398 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 398 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 398 "project/radare2/test/unit/test_dwarf_info.c"
...
# 398 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 399 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 399 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 399 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 399 "project/radare2/test/unit/test_dwarf_info.c"
...
# 399 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 401 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 401 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 401 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 401 "project/radare2/test/unit/test_dwarf_info.c"
...
# 401 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 402 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 402 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 402 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 402 "project/radare2/test/unit/test_dwarf_info.c"
...
unsigned long long
# 402 "project/radare2/test/unit/test_dwarf_info.c"
)(0x2f32); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 402 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 402 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
# 402 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 404 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 404 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 404 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 404 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 404 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 404, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 404, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { char _meqstr[5120]; const char *act__ = (cu.dies[i].attr_values[1].string.content); const char *exp__ = ("_Z8isnumberc"); 
# 405 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 405 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
# 405 "project/radare2/test/unit/test_dwarf_info.c" 3 4
, 
# 405 "project/radare2/test/unit/test_dwarf_info.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 405, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 405, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { 
# 407 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 407 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 407 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 407 "project/radare2/test/unit/test_dwarf_info.c"
...
0
# 407 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 407, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 407, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { 
# 408 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 408 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 408 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 408 "project/radare2/test/unit/test_dwarf_info.c"
...
unsigned long long
# 408 "project/radare2/test/unit/test_dwarf_info.c"
)(0x0000000010001aa4); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 408 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 408 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
0
# 408 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 408, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 408, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 do { 
# 410 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 410 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 410 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 410 "project/radare2/test/unit/test_dwarf_info.c"
...
# 410 "project/radare2/test/unit/test_dwarf_info.c"
 ...
 do { 
# 411 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long 
# 411 "project/radare2/test/unit/test_dwarf_info.c"
act__ = (
# 411 "project/radare2/test/unit/test_dwarf_info.c" 3 4
unsigned long long
# 411 "project/radare2/test/unit/test_dwarf_info.c"
...
unsigned long long
# 411 "project/radare2/test/unit/test_dwarf_info.c"
)(0x0000000010001ac8); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 411 "project/radare2/test/unit/test_dwarf_info.c" 3 4
__builtin___snprintf_chk (
# 411 "project/radare2/test/unit/test_dwarf_info.c"
_meqstr
...
0
# 411 "project/radare2/test/unit/test_dwarf_info.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 411, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 411, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
...
# 420 "project/radare2/test/unit/test_dwarf_info.c" 3 4
_Bool 
# 420 "project/radare2/test/unit/test_dwarf_info.c"
    all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_dwarf3_c"); result = test_dwarf3_c(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_dwarf4_cpp_multiple_modules"); result = test_dwarf4_cpp_multiple_modules(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_dwarf2_big_endian"); result = test_dwarf2_big_endian(); tests_run++; tests_passed += result; } while (0);
