# 0 "project/radare2/test/unit/test_diff.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/test/unit/test_diff.c"
...
# 2 "project/radare2/test/unit/test_diff.c" 2
...
# 3 "project/radare2/test/unit/test_diff.c" 2
...
# 4 "project/radare2/test/unit/test_diff.c" 2


static struct {
 const 
# 7 "project/radare2/test/unit/test_diff.c" 3 4
      unsigned char 
# 7 "project/radare2/test/unit/test_diff.c"
          *a;
 const 
# 8 "project/radare2/test/unit/test_diff.c" 3 4
      unsigned char 
# 8 "project/radare2/test/unit/test_diff.c"
          *b;
 int di_distance;
 int dis_distance;
} tests[] = {
 {(const 
# 12 "project/radare2/test/unit/test_diff.c" 3 4
unsigned char
# 12 "project/radare2/test/unit/test_diff.c"
*)"", (const 
# 12 "project/radare2/test/unit/test_diff.c" 3 4
unsigned char
# 12 "project/radare2/test/unit/test_diff.c"
*)"zzz", (int)3, (int)3},
 {(const 
# 13 "project/radare2/test/unit/test_diff.c" 3 4
unsigned char
# 13 "project/radare2/test/unit/test_diff.c"
*)"meow", (const 
# 13 "project/radare2/test/unit/test_diff.c" 3 4
unsigned char
# 13 "project/radare2/test/unit/test_diff.c"
*)"", (int)4, (int)4},
 {(const 
# 14 "project/radare2/test/unit/test_diff.c" 3 4
unsigned char
# 14 "project/radare2/test/unit/test_diff.c"
*)"a", (const 
# 14 "project/radare2/test/unit/test_diff.c" 3 4
unsigned char
# 14 "project/radare2/test/unit/test_diff.c"
*)"b", (int)2, (int)1},
 {(const 
# 15 "project/radare2/test/unit/test_diff.c" 3 4
unsigned char
# 15 "project/radare2/test/unit/test_diff.c"
*)"aaa", (const 
# 15 "project/radare2/test/unit/test_diff.c" 3 4
unsigned char
# 15 "project/radare2/test/unit/test_diff.c"
*)"aaa", (int)0, (int)0},
 {(const 
# 16 "project/radare2/test/unit/test_diff.c" 3 4
unsigned char
# 16 "project/radare2/test/unit/test_diff.c"
*)"aaaaa", (const 
# 16 "project/radare2/test/unit/test_diff.c" 3 4
unsigned char
# 16 "project/radare2/test/unit/test_diff.c"
*)"aabaa", (int)2, (int)1},
 {(const 
# 17 "project/radare2/test/unit/test_diff.c" 3 4
unsigned char
# 17 "project/radare2/test/unit/test_diff.c"
*)"aaaa", (const 
# 17 "project/radare2/test/unit/test_diff.c" 3 4
unsigned char
# 17 "project/radare2/test/unit/test_diff.c"
*)"aabaa", (int)1, (int)1},
 {(const 
# 18 "project/radare2/test/unit/test_diff.c" 3 4
unsigned char
# 18 "project/radare2/test/unit/test_diff.c"
*)"aaba", (const 
# 18 "project/radare2/test/unit/test_diff.c" 3 4
unsigned char
# 18 "project/radare2/test/unit/test_diff.c"
*)"babca", (int)3, (int)2},
 {(const 
# 19 "project/radare2/test/unit/test_diff.c" 3 4
unsigned char
# 19 "project/radare2/test/unit/test_diff.c"
*)"foo", (const 
# 19 "project/radare2/test/unit/test_diff.c" 3 4
unsigned char
# 19 "project/radare2/test/unit/test_diff.c"
*)"foobar", (int)3, (int)3},
 {(const 
# 20 "project/radare2/test/unit/test_diff.c" 3 4
unsigned char
# 20 "project/radare2/test/unit/test_diff.c"
*)"wallaby", (const 
# 20 "project/radare2/test/unit/test_diff.c" 3 4
unsigned char
# 20 "project/radare2/test/unit/test_diff.c"
*)"wallet", (int)5, (int)3},
 {(const 
# 21 "project/radare2/test/unit/test_diff.c" 3 4
unsigned char
# 21 "project/radare2/test/unit/test_diff.c"
*)"identity", (const 
# 21 "project/radare2/test/unit/test_diff.c" 3 4
unsigned char
# 21 "project/radare2/test/unit/test_diff.c"
*)"identity", (int)0, (int)0},
 {
# 22 "project/radare2/test/unit/test_diff.c" 3 4
 ((void *)0)
# 22 "project/radare2/test/unit/test_diff.c"
     ,
# 22 "project/radare2/test/unit/test_diff.c" 3 4
      ((void *)0)
# 22 "project/radare2/test/unit/test_diff.c"
...
# 25 "project/radare2/test/unit/test_diff.c" 3 4
_Bool 
# 25 "project/radare2/test/unit/test_diff.c"
    test_r_diff_buffers_distance(void) {
 char msg[128];
 RDiff *diff = r_diff_new ();
 if (!diff) {
  return 
# 29 "project/radare2/test/unit/test_diff.c" 3 4
        0
# 29 "project/radare2/test/unit/test_diff.c"
             ;
 }
 ...
 for (i = 0; tests[i].a; i++) {
  ...
  r_diff_buffers_distance (diff, tests[i].a, la, tests[i].b, lb, &distance, 
# 38 "project/radare2/test/unit/test_diff.c" 3 4
                                                                           ((void *)0)
# 38 "project/radare2/test/unit/test_diff.c"
                                                                               );
  
# 39 "project/radare2/test/unit/test_diff.c" 3 4
 __builtin___snprintf_chk (
# 39 "project/radare2/test/unit/test_diff.c"
 msg
# 39 "project/radare2/test/unit/test_diff.c" 3 4
 , 
# 39 "project/radare2/test/unit/test_diff.c"
...
# 39 "project/radare2/test/unit/test_diff.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 39 "project/radare2/test/unit/test_diff.c"
 "levenshtein %s/%s distance", tests[i].a, tests[i].b
# 39 "project/radare2/test/unit/test_diff.c" 3 4
 )
# 39 "project/radare2/test/unit/test_diff.c"
                                                                                 ;
  do { 
# 40 "project/radare2/test/unit/test_diff.c" 3 4
 unsigned long long 
# 40 "project/radare2/test/unit/test_diff.c"
 act__ = (
# 40 "project/radare2/test/unit/test_diff.c" 3 4
 unsigned long long
# 40 "project/radare2/test/unit/test_diff.c"
...
# 40 "project/radare2/test/unit/test_diff.c" 3 4
 unsigned long long
# 40 "project/radare2/test/unit/test_diff.c"
 )(tests[i].dis_distance); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 40 "project/radare2/test/unit/test_diff.c" 3 4
 __builtin___snprintf_chk (
# 40 "project/radare2/test/unit/test_diff.c"
 _meqstr
...
# 40 "project/radare2/test/unit/test_diff.c"
 ...
 for (i = 0; tests[i].a; i++) {
  size_t la = strlen ((const char *)tests[i].a), lb = strlen ((const char *)tests[i].b);
  r_diff_buffers_distance (diff, tests[i].a, la, tests[i].b, lb, &distance, 
# 47 "project/radare2/test/unit/test_diff.c" 3 4
                                                                           ((void *)0)
# 47 "project/radare2/test/unit/test_diff.c"
                                                                               );
  
# 48 "project/radare2/test/unit/test_diff.c" 3 4
 __builtin___snprintf_chk (
# 48 "project/radare2/test/unit/test_diff.c"
 msg
# 48 "project/radare2/test/unit/test_diff.c" 3 4
 , 
# 48 "project/radare2/test/unit/test_diff.c"
...
# 48 "project/radare2/test/unit/test_diff.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 48 "project/radare2/test/unit/test_diff.c"
 "myers %s/%s distance", tests[i].a, tests[i].b
# 48 "project/radare2/test/unit/test_diff.c" 3 4
 )
# 48 "project/radare2/test/unit/test_diff.c"
                                                                           ;
  do { 
# 49 "project/radare2/test/unit/test_diff.c" 3 4
 unsigned long long 
# 49 "project/radare2/test/unit/test_diff.c"
 act__ = (
# 49 "project/radare2/test/unit/test_diff.c" 3 4
 unsigned long long
# 49 "project/radare2/test/unit/test_diff.c"
...
# 49 "project/radare2/test/unit/test_diff.c" 3 4
 unsigned long long
# 49 "project/radare2/test/unit/test_diff.c"
 )(tests[i].di_distance); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 49 "project/radare2/test/unit/test_diff.c" 3 4
 __builtin___snprintf_chk (
# 49 "project/radare2/test/unit/test_diff.c"
 _meqstr
...
int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_diff_buffers_distance"); result = test_r_diff_buffers_distance(); tests_run++; tests_passed += result; } while (0);
