# 0 "project/radare2/test/unit/legacy_unit/parse/parse.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
typedef int RRef;
# 7 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_parse.h" 2 3 4
...
# 2 "project/radare2/test/unit/legacy_unit/parse/parse.c" 2


# 3 "project/radare2/test/unit/legacy_unit/parse/parse.c"
int main(int argc, char **argv) {
 ...
 if (argc==1) {
  ...
  r_parse_use (p, "att2intel");
  while (!feof (
# 25 "project/radare2/test/unit/legacy_unit/parse/parse.c" 3 4
               __stdinp
# 25 "project/radare2/test/unit/legacy_unit/parse/parse.c"
                    )) {
   buf[0] = 0;
   fgets (buf, sizeof (buf)-1, 
# 27 "project/radare2/test/unit/legacy_unit/parse/parse.c" 3 4
                              __stdinp
# 27 "project/radare2/test/unit/legacy_unit/parse/parse.c"
                                   );
   if (feof (
# 28 "project/radare2/test/unit/legacy_unit/parse/parse.c" 3 4
            __stdinp
# 28 "project/radare2/test/unit/legacy_unit/parse/parse.c"
                 ))
    break;
   buf[strlen (buf)-1] = 0;
   if (*buf) {
