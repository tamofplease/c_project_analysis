# 0 "project/radare2/test/unit/legacy_unit/hash/test.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/test/unit/legacy_unit/hash/test.c"
...
# 2 "project/radare2/test/unit/legacy_unit/hash/test.c" 2


# 3 "project/radare2/test/unit/legacy_unit/hash/test.c"
void printmd5(const char *str, 
# 3 "project/radare2/test/unit/legacy_unit/hash/test.c" 3 4
                              struct r_hash_t 
# 3 "project/radare2/test/unit/legacy_unit/hash/test.c"
                                    *h) {
 int i;
 ...
 for (i=0; i<
# 6 "project/radare2/test/unit/legacy_unit/hash/test.c" 3 4
            16
# 6 "project/radare2/test/unit/legacy_unit/hash/test.c"
                           ; i++) {
...
main () {
 int HASH = 
# 13 "project/radare2/test/unit/legacy_unit/hash/test.c" 3 4
           (1ULL << R_HASH_IDX_MD5)
# 13 "project/radare2/test/unit/legacy_unit/hash/test.c"
                     ;
 
# 14 "project/radare2/test/unit/legacy_unit/hash/test.c" 3 4
struct r_hash_t 
# 14 "project/radare2/test/unit/legacy_unit/hash/test.c"
      *h = r_hash_new (1, HASH);
