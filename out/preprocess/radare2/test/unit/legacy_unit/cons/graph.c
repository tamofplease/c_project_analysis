# 0 "project/radare2/test/unit/legacy_unit/cons/graph.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 4 "project/radare2/test/unit/legacy_unit/cons/graph.c" 2


# 5 "project/radare2/test/unit/legacy_unit/cons/graph.c"
typedef struct {
 int x;
 int y;
 int w;
...
# 10 "project/radare2/test/unit/legacy_unit/cons/graph.c" 3 4
unsigned long long 
# 10 "project/radare2/test/unit/legacy_unit/cons/graph.c"
     addr;
 const char *text;
} Node;
...
static Node nodes[] = {
 ...
 {
# 26 "project/radare2/test/unit/legacy_unit/cons/graph.c" 3 4
 ((void *)0)
# 26 "project/radare2/test/unit/legacy_unit/cons/graph.c"
     }
};
...
static void Node_print(RConsCanvas *can, Node *n, int cur) {
 ...
 n->h += 4;
 n->w = 
# 47 "project/radare2/test/unit/legacy_unit/cons/graph.c" 3 4
       (((
# 47 "project/radare2/test/unit/legacy_unit/cons/graph.c"
       18
# 47 "project/radare2/test/unit/legacy_unit/cons/graph.c" 3 4
       )>(
# 47 "project/radare2/test/unit/legacy_unit/cons/graph.c"
...
# 50 "project/radare2/test/unit/legacy_unit/cons/graph.c" 3 4
 __builtin___snprintf_chk (
# 50 "project/radare2/test/unit/legacy_unit/cons/graph.c"
 title
# 50 "project/radare2/test/unit/legacy_unit/cons/graph.c" 3 4
 , 
# 50 "project/radare2/test/unit/legacy_unit/cons/graph.c"
...
# 51 "project/radare2/test/unit/legacy_unit/cons/graph.c"
                                  ;
 } else {
  
# 53 "project/radare2/test/unit/legacy_unit/cons/graph.c" 3 4
 __builtin___snprintf_chk (
# 53 "project/radare2/test/unit/legacy_unit/cons/graph.c"
 title
# 53 "project/radare2/test/unit/legacy_unit/cons/graph.c" 3 4
 , 
# 53 "project/radare2/test/unit/legacy_unit/cons/graph.c"
...
# 54 "project/radare2/test/unit/legacy_unit/cons/graph.c"
                                  ;
 }
 r_cons_canvas_gotoxy (can, n->x+1, n->y+1);
 r_cons_canvas_write (can, title);
 r_cons_canvas_gotoxy (can, n->x+2, n->y+2);
 r_cons_canvas_write (can, n->text);
 r_cons_canvas_gotoxy (can, n->x+1, n->y+1);
 r_cons_canvas_write (can, title);
 r_cons_canvas_box(can, n->x,n->y,n->w,n->h);
}
...
static void Edge_print(RConsCanvas *can, Node *a, Node *b, int nth) {
 ...
 x2 = b->x+xinc;
 y2 = b->y;
 r_cons_canvas_line(can, x,y,x2,y2,0);
}
...
repeat:
 ...
 case 9: curnode++;
  if (!nodes[curnode].text)
   curnode = 0;
  break;
 case 'j': nodes[curnode].y++; break;
 case 'k': nodes[curnode].y--; break;
 case 'h': nodes[curnode].x--; break;
 case 'l': nodes[curnode].x++; break;
 case 'J': nodes[curnode].y+=2; break;
 case 'K': nodes[curnode].y-=2; break;
 case 'H': nodes[curnode].x-=2; break;
 case 'L': nodes[curnode].x+=2; break;
 case 'q': exit(0);
 case 27:
...
# 124 "project/radare2/test/unit/legacy_unit/cons/graph.c" 3 4
 fprintf(__stderrp,
# 124 "project/radare2/test/unit/legacy_unit/cons/graph.c"
 "Key %d\n", key
# 124 "project/radare2/test/unit/legacy_unit/cons/graph.c" 3 4
 )
# 124 "project/radare2/test/unit/legacy_unit/cons/graph.c"
