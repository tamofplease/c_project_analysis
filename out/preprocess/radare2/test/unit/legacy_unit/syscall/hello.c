# 0 "project/radare2/test/unit/legacy_unit/syscall/hello.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/test/unit/legacy_unit/syscall/hello.c"
...
# 2 "project/radare2/test/unit/legacy_unit/syscall/hello.c" 2
...
# 3 "project/radare2/test/unit/legacy_unit/syscall/hello.c" 2


# 4 "project/radare2/test/unit/legacy_unit/syscall/hello.c"
int main() {
 int i, num = 3;
