# 0 "project/radare2/test/unit/legacy_unit/util/copy.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/test/unit/legacy_unit/util/copy.c"
...
# 2 "project/radare2/test/unit/legacy_unit/util/copy.c" 2




# 5 "project/radare2/test/unit/legacy_unit/util/copy.c"
int main () {
 size_t len;
 char *out= r_file_slurp ("/etc/services", &len);
 r_file_dump ("a", out, (int)len);
 system ("md5 ""/etc/services");
 system ("md5 a");
 return 0;
}
