# 0 "project/radare2/test/unit/legacy_unit/util/test_file_slurp_hexpairs.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/test/unit/legacy_unit/util/test_file_slurp_hexpairs.c"
...
# 2 "project/radare2/test/unit/legacy_unit/util/test_file_slurp_hexpairs.c" 2
...
# 3 "project/radare2/test/unit/legacy_unit/util/test_file_slurp_hexpairs.c" 2


# 4 "project/radare2/test/unit/legacy_unit/util/test_file_slurp_hexpairs.c"
int main(int argc, char *argv[]) {
 int i, size;
 
# 6 "project/radare2/test/unit/legacy_unit/util/test_file_slurp_hexpairs.c" 3 4
unsigned char 
# 6 "project/radare2/test/unit/legacy_unit/util/test_file_slurp_hexpairs.c"
    *ret = r_file_slurp_hexpairs("hexpairs.txt", &size);
