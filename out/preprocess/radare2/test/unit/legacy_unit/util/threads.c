# 0 "project/radare2/test/unit/legacy_unit/util/threads.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 2 "project/radare2/test/unit/legacy_unit/util/threads.c" 2
...
# 3 "project/radare2/test/unit/legacy_unit/util/threads.c" 2


# 4 "project/radare2/test/unit/legacy_unit/util/threads.c"
int looper(struct r_th_t *th) {
 ...
 for (i=0;i<9999;i++) {
  ...
  fflush (
# 12 "project/radare2/test/unit/legacy_unit/util/threads.c" 3 4
         __stdoutp
# 12 "project/radare2/test/unit/legacy_unit/util/threads.c"
               );
...
int test1() {
 ...
 while (r_th_wait_async (th)) {
  printf ("\nwaiting...\n");
  fflush (
# 34 "project/radare2/test/unit/legacy_unit/util/threads.c" 3 4
         __stdoutp
# 34 "project/radare2/test/unit/legacy_unit/util/threads.c"
               );
  r_sys_usleep (400);
