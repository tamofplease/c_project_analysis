# 0 "project/radare2/test/unit/legacy_unit/util/diff/test.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 2 "project/radare2/test/unit/legacy_unit/util/diff/test.c" 2


# 3 "project/radare2/test/unit/legacy_unit/util/diff/test.c"
int cb(struct r_diff_t *d, void *user, struct r_diff_op_t *op) {
 int i;

 printf(" 0x%08"
# 6 "project/radare2/test/unit/legacy_unit/util/diff/test.c" 3 4
               "llx"
# 6 "project/radare2/test/unit/legacy_unit/util/diff/test.c"
                      "  ", op->a_off);
 ...
 printf("  0x%08"
# 12 "project/radare2/test/unit/legacy_unit/util/diff/test.c" 3 4
                "llx"
# 12 "project/radare2/test/unit/legacy_unit/util/diff/test.c"
                       "\n", op->b_off);
 return 1;
}
...
int test_equal() {
 ...
 r_diff_set_callback(d, &cb, 
# 24 "project/radare2/test/unit/legacy_unit/util/diff/test.c" 3 4
                            ((void *)0)
# 24 "project/radare2/test/unit/legacy_unit/util/diff/test.c"
                                );
 r_diff_buffers(d, (
# 25 "project/radare2/test/unit/legacy_unit/util/diff/test.c" 3 4
                   unsigned char
# 25 "project/radare2/test/unit/legacy_unit/util/diff/test.c"
                      *)bufa, strlen(bufa), (
# 25 "project/radare2/test/unit/legacy_unit/util/diff/test.c" 3 4
                                             unsigned char
# 25 "project/radare2/test/unit/legacy_unit/util/diff/test.c"
                                                *)bufb, strlen((char*)bufb));
 return 1;
}
...
int test_diff() {
 ...
 r_diff_set_delta(d, 0);
 r_diff_set_callback(d, &cb, 
# 37 "project/radare2/test/unit/legacy_unit/util/diff/test.c" 3 4
                            ((void *)0)
# 37 "project/radare2/test/unit/legacy_unit/util/diff/test.c"
                                );
 r_diff_buffers(d, (
# 38 "project/radare2/test/unit/legacy_unit/util/diff/test.c" 3 4
                   unsigned char
# 38 "project/radare2/test/unit/legacy_unit/util/diff/test.c"
                      *)bufa, strlen(bufa), (
# 38 "project/radare2/test/unit/legacy_unit/util/diff/test.c" 3 4
                                             unsigned char
# 38 "project/radare2/test/unit/legacy_unit/util/diff/test.c"
...
int test_delta() {
 ...
 r_diff_set_callback(d, &cb, 
# 50 "project/radare2/test/unit/legacy_unit/util/diff/test.c" 3 4
                            ((void *)0)
# 50 "project/radare2/test/unit/legacy_unit/util/diff/test.c"
                                );
 r_diff_buffers(d, (
# 51 "project/radare2/test/unit/legacy_unit/util/diff/test.c" 3 4
                   unsigned char
# 51 "project/radare2/test/unit/legacy_unit/util/diff/test.c"
                      *)bufa, strlen(bufa), (
# 51 "project/radare2/test/unit/legacy_unit/util/diff/test.c" 3 4
                                             unsigned char
# 51 "project/radare2/test/unit/legacy_unit/util/diff/test.c"
...
# 58 "project/radare2/test/unit/legacy_unit/util/diff/test.c" 3 4
unsigned int 
# 58 "project/radare2/test/unit/legacy_unit/util/diff/test.c"
     distance = 0;
 double similarity = 0;

 printf("Similarity: '%s' vs '%s'\n", bufa, bufb);
 r_diff_buffers_distance(
# 62 "project/radare2/test/unit/legacy_unit/util/diff/test.c" 3 4
                        ((void *)0)
# 62 "project/radare2/test/unit/legacy_unit/util/diff/test.c"
                            , (
# 62 "project/radare2/test/unit/legacy_unit/util/diff/test.c" 3 4
                               unsigned char
# 62 "project/radare2/test/unit/legacy_unit/util/diff/test.c"
...
# 88 "project/radare2/test/unit/legacy_unit/util/diff/test.c"
int main() {
 test_equal();
 printf("--\n");
 test_equal();
