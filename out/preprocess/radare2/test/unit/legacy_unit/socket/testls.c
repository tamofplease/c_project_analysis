# 0 "project/radare2/test/unit/legacy_unit/socket/testls.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 2 "project/radare2/test/unit/legacy_unit/socket/testls.c" 2


# 3 "project/radare2/test/unit/legacy_unit/socket/testls.c"
int main() {
 int ret;
