# 0 "project/radare2/test/unit/legacy_unit/socket/testssl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/test/unit/legacy_unit/socket/testssl.c"
...
# 2 "project/radare2/test/unit/legacy_unit/socket/testssl.c" 2
...
# 7 "project/radare2/test/unit/legacy_unit/socket/testssl.c"
int main (int argc, char ** argv) {
 
# 8 "project/radare2/test/unit/legacy_unit/socket/testssl.c" 3 4
unsigned char 
# 8 "project/radare2/test/unit/legacy_unit/socket/testssl.c"
    buf [2048 +1];

 
# 10 "project/radare2/test/unit/legacy_unit/socket/testssl.c" 3 4
__builtin___memset_chk (
# 10 "project/radare2/test/unit/legacy_unit/socket/testssl.c"
buf
# 10 "project/radare2/test/unit/legacy_unit/socket/testssl.c" 3 4
, 
# 10 "project/radare2/test/unit/legacy_unit/socket/testssl.c"
...
# 11 "project/radare2/test/unit/legacy_unit/socket/testssl.c" 3 4
                           1
# 11 "project/radare2/test/unit/legacy_unit/socket/testssl.c"
                               );
 if (s == 
# 12 "project/radare2/test/unit/legacy_unit/socket/testssl.c" 3 4
         ((void *)0)
# 12 "project/radare2/test/unit/legacy_unit/socket/testssl.c"
             ) {
  fprintf (
# 13 "project/radare2/test/unit/legacy_unit/socket/testssl.c" 3 4
          __stderrp
# 13 "project/radare2/test/unit/legacy_unit/socket/testssl.c"
                , "Error, cannot create new socket \n");
  return 1;
 }
 if (!r_socket_connect_tcp) {
  fprintf (
# 17 "project/radare2/test/unit/legacy_unit/socket/testssl.c" 3 4
          __stderrp
# 17 "project/radare2/test/unit/legacy_unit/socket/testssl.c"
                , "Error, cannot connect to ""127.0.0.1""\n");
  return 1;
 }
 printf ("%i\n",r_socket_puts (s, "GET /\r\n\r\n"));
 while(r_socket_read (s, buf, 2048)>0)
  printf ("%s", buf);
 r_socket_free (s);
 return 0;
}
