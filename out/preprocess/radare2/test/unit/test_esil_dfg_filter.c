# 0 "project/radare2/test/unit/test_esil_dfg_filter.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/test/unit/test_esil_dfg_filter.c"
...
# 2 "project/radare2/test/unit/test_esil_dfg_filter.c" 2
...
# 5 "project/radare2/test/unit/test_esil_dfg_filter.c" 2


# 6 "project/radare2/test/unit/test_esil_dfg_filter.c" 3 4
_Bool 
# 6 "project/radare2/test/unit/test_esil_dfg_filter.c"
    test_filter_regs(void) {
 RAnal *anal = r_anal_new ();
 r_anal_use (anal, "x86");
 r_anal_set_bits (anal, 32);
 r_anal_set_reg_profile (anal, 
# 10 "project/radare2/test/unit/test_esil_dfg_filter.c" 3 4
                              ((void *)0)
# 10 "project/radare2/test/unit/test_esil_dfg_filter.c"
                                  );
 ...
 const 
# 16 "project/radare2/test/unit/test_esil_dfg_filter.c" 3 4
      unsigned long long 
# 16 "project/radare2/test/unit/test_esil_dfg_filter.c"
           ax = r_reg_getv (anal->reg, "ax");
 const 
# 17 "project/radare2/test/unit/test_esil_dfg_filter.c" 3 4
      unsigned long long 
# 17 "project/radare2/test/unit/test_esil_dfg_filter.c"
           ah = r_reg_getv (anal->reg, "ah");
 const 
# 18 "project/radare2/test/unit/test_esil_dfg_filter.c" 3 4
      unsigned long long 
# 18 "project/radare2/test/unit/test_esil_dfg_filter.c"
           al = r_reg_getv (anal->reg, "al");
 r_reg_setv (anal->reg, "eax", 0);

 RAnalEsilDFG *dfg = r_anal_esil_dfg_expr (anal, 
# 21 "project/radare2/test/unit/test_esil_dfg_filter.c" 3 4
                                                ((void *)0)
# 21 "project/radare2/test/unit/test_esil_dfg_filter.c"
                                                    , "0x9090,ax,:=,0xff,ah,:=");
 ...
 const 
# 26 "project/radare2/test/unit/test_esil_dfg_filter.c" 3 4
      unsigned long long 
# 26 "project/radare2/test/unit/test_esil_dfg_filter.c"
           filtered_ax = r_reg_getv (anal->reg, "ax");
 ...
 r_anal_esil_parse (esil, r_strbuf_get (filtered_expr));
 const 
# 33 "project/radare2/test/unit/test_esil_dfg_filter.c" 3 4
      unsigned long long 
# 33 "project/radare2/test/unit/test_esil_dfg_filter.c"
           filtered_ah = r_reg_getv (anal->reg, "ah");
 r_strbuf_free (filtered_expr);
 r_reg_setv (anal->reg, "eax", 0);
 ...
 r_anal_esil_parse (esil, r_strbuf_get (filtered_expr));
 const 
# 40 "project/radare2/test/unit/test_esil_dfg_filter.c" 3 4
      unsigned long long 
# 40 "project/radare2/test/unit/test_esil_dfg_filter.c"
           filtered_al = r_reg_getv (anal->reg, "al");
 r_strbuf_free (filtered_expr);
 ...
 do { if (!(ax == filtered_ax)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 47, "filtering for ax failed"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 47, "filtering for ax failed"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { if (!(ah == filtered_ah)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 48, "filtering for ah failed"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 48, "filtering for ah failed"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { if (!(al == filtered_al)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 49, "filtering for al failed"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 49, "filtering for al failed"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}


# 53 "project/radare2/test/unit/test_esil_dfg_filter.c" 3 4
_Bool 
# 53 "project/radare2/test/unit/test_esil_dfg_filter.c"
    test_lemon_const_folder(void) {
 RAnal *anal = r_anal_new ();
 r_anal_use (anal, "x86");
 r_anal_set_bits (anal, 32);
 r_anal_set_reg_profile (anal, 
# 57 "project/radare2/test/unit/test_esil_dfg_filter.c" 3 4
                              ((void *)0)
# 57 "project/radare2/test/unit/test_esil_dfg_filter.c"
                                  );

 RAnalEsilDFG *dfg = r_anal_esil_dfg_expr (anal, 
# 59 "project/radare2/test/unit/test_esil_dfg_filter.c" 3 4
                                                ((void *)0)
# 59 "project/radare2/test/unit/test_esil_dfg_filter.c"
                                                    , "4,!,3,ebx,:=,!,1,+,eax,:=");
 r_anal_esil_dfg_fold_const (anal, dfg);
 RStrBuf *filtered = r_anal_esil_dfg_filter (dfg, "eax");
 const 
# 62 "project/radare2/test/unit/test_esil_dfg_filter.c" 3 4
      _Bool 
# 62 "project/radare2/test/unit/test_esil_dfg_filter.c"
           cmp_result = !strcmp(r_strbuf_get(filtered), "0x2,eax,:=");
 r_strbuf_free (filtered);
 r_anal_esil_dfg_free (dfg);
 r_anal_free (anal);

 do { 
# 67 "project/radare2/test/unit/test_esil_dfg_filter.c" 3 4
_Bool 
# 67 "project/radare2/test/unit/test_esil_dfg_filter.c"
act__ = (cmp_result); if (!(act__)) { char _meqstr[5120]; 
# 67 "project/radare2/test/unit/test_esil_dfg_filter.c" 3 4
__builtin___snprintf_chk (
# 67 "project/radare2/test/unit/test_esil_dfg_filter.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 67 "project/radare2/test/unit/test_esil_dfg_filter.c"
"%s: expected true, got false", ("esil dfg const folding is broken")
# 67 "project/radare2/test/unit/test_esil_dfg_filter.c" 3 4
)
# 67 "project/radare2/test/unit/test_esil_dfg_filter.c"
; do { if (!(
...
int main(int argc, char **argv) {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_filter_regs"); result = test_filter_regs(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_lemon_const_folder"); result = test_lemon_const_folder(); tests_run++; tests_passed += result; } while (0);
