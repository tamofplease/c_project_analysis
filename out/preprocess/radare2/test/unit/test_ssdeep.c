# 0 "project/radare2/test/unit/test_ssdeep.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/test/unit/test_ssdeep.c"
...
# 2 "project/radare2/test/unit/test_ssdeep.c" 2
...
# 3 "project/radare2/test/unit/test_ssdeep.c" 2
...
# 4 "project/radare2/test/unit/test_ssdeep.c" 2
...
int test_ssdeep(void) {
 ...
 char *h0 = r_hash_ssdeep ((const 
# 15 "project/radare2/test/unit/test_ssdeep.c" 3 4
                                 unsigned char
# 15 "project/radare2/test/unit/test_ssdeep.c"
                                    *)input_0, strlen (input_0));
 char *h1 = r_hash_ssdeep ((const 
# 16 "project/radare2/test/unit/test_ssdeep.c" 3 4
                                 unsigned char
# 16 "project/radare2/test/unit/test_ssdeep.c"
                                    *)input_1, strlen (input_1));
 char *h2 = r_hash_ssdeep ((const 
# 17 "project/radare2/test/unit/test_ssdeep.c" 3 4
                                 unsigned char
# 17 "project/radare2/test/unit/test_ssdeep.c"
                                    *)input_2, strlen (input_2));
 do { char _meqstr[5120]; const char *act__ = (h0); const char *exp__ = (hash_0); 
# 18 "project/radare2/test/unit/test_ssdeep.c" 3 4
__builtin___snprintf_chk (
# 18 "project/radare2/test/unit/test_ssdeep.c"
_meqstr
# 18 "project/radare2/test/unit/test_ssdeep.c" 3 4
, 
# 18 "project/radare2/test/unit/test_ssdeep.c"
...
, 2 > 1 ? 1 : 0), 
# 18 "project/radare2/test/unit/test_ssdeep.c"
"%s: expected %s, got %s.", ("hash0 is fine"), (exp__), (act__)
# 18 "project/radare2/test/unit/test_ssdeep.c" 3 4
)
# 18 "project/radare2/test/unit/test_ssdeep.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 18, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 18, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (h1); const char *exp__ = (hash_1); 
# 19 "project/radare2/test/unit/test_ssdeep.c" 3 4
__builtin___snprintf_chk (
# 19 "project/radare2/test/unit/test_ssdeep.c"
_meqstr
# 19 "project/radare2/test/unit/test_ssdeep.c" 3 4
, 
# 19 "project/radare2/test/unit/test_ssdeep.c"
...
, 2 > 1 ? 1 : 0), 
# 19 "project/radare2/test/unit/test_ssdeep.c"
"%s: expected %s, got %s.", ("hash1 is fine"), (exp__), (act__)
# 19 "project/radare2/test/unit/test_ssdeep.c" 3 4
)
# 19 "project/radare2/test/unit/test_ssdeep.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 19, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 19, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const char *act__ = (h2); const char *exp__ = (hash_2); 
# 20 "project/radare2/test/unit/test_ssdeep.c" 3 4
__builtin___snprintf_chk (
# 20 "project/radare2/test/unit/test_ssdeep.c"
_meqstr
# 20 "project/radare2/test/unit/test_ssdeep.c" 3 4
, 
# 20 "project/radare2/test/unit/test_ssdeep.c"
...
, 2 > 1 ? 1 : 0), 
# 20 "project/radare2/test/unit/test_ssdeep.c"
"%s: expected %s, got %s.", ("hash2 is fine"), (exp__), (act__)
# 20 "project/radare2/test/unit/test_ssdeep.c" 3 4
)
# 20 "project/radare2/test/unit/test_ssdeep.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 20, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 20, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 21 "project/radare2/test/unit/test_ssdeep.c" 3 4
unsigned long long 
# 21 "project/radare2/test/unit/test_ssdeep.c"
act__ = (
# 21 "project/radare2/test/unit/test_ssdeep.c" 3 4
unsigned long long
# 21 "project/radare2/test/unit/test_ssdeep.c"
...
unsigned long long
# 21 "project/radare2/test/unit/test_ssdeep.c"
)(r_str_distance(h0, h0)); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 21 "project/radare2/test/unit/test_ssdeep.c" 3 4
__builtin___snprintf_chk (
# 21 "project/radare2/test/unit/test_ssdeep.c"
_meqstr
...
# 21 "project/radare2/test/unit/test_ssdeep.c"
 ...
 do { 
# 22 "project/radare2/test/unit/test_ssdeep.c" 3 4
unsigned long long 
# 22 "project/radare2/test/unit/test_ssdeep.c"
act__ = (
# 22 "project/radare2/test/unit/test_ssdeep.c" 3 4
unsigned long long
# 22 "project/radare2/test/unit/test_ssdeep.c"
...
unsigned long long
# 22 "project/radare2/test/unit/test_ssdeep.c"
)(r_str_distance(h0, h1)); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 22 "project/radare2/test/unit/test_ssdeep.c" 3 4
__builtin___snprintf_chk (
# 22 "project/radare2/test/unit/test_ssdeep.c"
_meqstr
...
# 22 "project/radare2/test/unit/test_ssdeep.c"
 ...
 do { 
# 23 "project/radare2/test/unit/test_ssdeep.c" 3 4
unsigned long long 
# 23 "project/radare2/test/unit/test_ssdeep.c"
act__ = (
# 23 "project/radare2/test/unit/test_ssdeep.c" 3 4
unsigned long long
# 23 "project/radare2/test/unit/test_ssdeep.c"
...
unsigned long long
# 23 "project/radare2/test/unit/test_ssdeep.c"
)(r_str_distance(h0, h2)); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 23 "project/radare2/test/unit/test_ssdeep.c" 3 4
__builtin___snprintf_chk (
# 23 "project/radare2/test/unit/test_ssdeep.c"
_meqstr
...
# 23 "project/radare2/test/unit/test_ssdeep.c"
 ...
 do { 
# 24 "project/radare2/test/unit/test_ssdeep.c" 3 4
unsigned long long 
# 24 "project/radare2/test/unit/test_ssdeep.c"
act__ = (
# 24 "project/radare2/test/unit/test_ssdeep.c" 3 4
unsigned long long
# 24 "project/radare2/test/unit/test_ssdeep.c"
...
unsigned long long
# 24 "project/radare2/test/unit/test_ssdeep.c"
)(r_str_distance(h1, h0)); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 24 "project/radare2/test/unit/test_ssdeep.c" 3 4
__builtin___snprintf_chk (
# 24 "project/radare2/test/unit/test_ssdeep.c"
_meqstr
...
# 24 "project/radare2/test/unit/test_ssdeep.c"
 ...
 do { 
# 25 "project/radare2/test/unit/test_ssdeep.c" 3 4
unsigned long long 
# 25 "project/radare2/test/unit/test_ssdeep.c"
act__ = (
# 25 "project/radare2/test/unit/test_ssdeep.c" 3 4
unsigned long long
# 25 "project/radare2/test/unit/test_ssdeep.c"
...
unsigned long long
# 25 "project/radare2/test/unit/test_ssdeep.c"
)(r_str_distance(h1, h1)); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 25 "project/radare2/test/unit/test_ssdeep.c" 3 4
__builtin___snprintf_chk (
# 25 "project/radare2/test/unit/test_ssdeep.c"
_meqstr
...
# 25 "project/radare2/test/unit/test_ssdeep.c"
 ...
 do { 
# 26 "project/radare2/test/unit/test_ssdeep.c" 3 4
unsigned long long 
# 26 "project/radare2/test/unit/test_ssdeep.c"
act__ = (
# 26 "project/radare2/test/unit/test_ssdeep.c" 3 4
unsigned long long
# 26 "project/radare2/test/unit/test_ssdeep.c"
...
unsigned long long
# 26 "project/radare2/test/unit/test_ssdeep.c"
)(r_str_distance(h1, h2)); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 26 "project/radare2/test/unit/test_ssdeep.c" 3 4
__builtin___snprintf_chk (
# 26 "project/radare2/test/unit/test_ssdeep.c"
_meqstr
...
# 26 "project/radare2/test/unit/test_ssdeep.c"
 ...
 do { 
# 27 "project/radare2/test/unit/test_ssdeep.c" 3 4
unsigned long long 
# 27 "project/radare2/test/unit/test_ssdeep.c"
act__ = (
# 27 "project/radare2/test/unit/test_ssdeep.c" 3 4
unsigned long long
# 27 "project/radare2/test/unit/test_ssdeep.c"
...
unsigned long long
# 27 "project/radare2/test/unit/test_ssdeep.c"
)(r_str_distance(h2, h1)); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 27 "project/radare2/test/unit/test_ssdeep.c" 3 4
__builtin___snprintf_chk (
# 27 "project/radare2/test/unit/test_ssdeep.c"
_meqstr
...
# 27 "project/radare2/test/unit/test_ssdeep.c"
 ...
 do { 
# 28 "project/radare2/test/unit/test_ssdeep.c" 3 4
unsigned long long 
# 28 "project/radare2/test/unit/test_ssdeep.c"
act__ = (
# 28 "project/radare2/test/unit/test_ssdeep.c" 3 4
unsigned long long
# 28 "project/radare2/test/unit/test_ssdeep.c"
...
unsigned long long
# 28 "project/radare2/test/unit/test_ssdeep.c"
)(r_str_distance(h0, "123")); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 28 "project/radare2/test/unit/test_ssdeep.c" 3 4
__builtin___snprintf_chk (
# 28 "project/radare2/test/unit/test_ssdeep.c"
_meqstr
...
int all_tests(void) {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_ssdeep"); result = test_ssdeep(); tests_run++; tests_passed += result; } while (0);
