# 0 "project/radare2/test/unit/test_anal_var.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/test/unit/test_anal_var.c"
...
# 2 "project/radare2/test/unit/test_anal_var.c" 2
...
# 3 "project/radare2/test/unit/test_anal_var.c" 2

static 
# 4 "project/radare2/test/unit/test_anal_var.c" 3 4
      _Bool 
# 4 "project/radare2/test/unit/test_anal_var.c"
           sanitize_instr_acc(void *user, const 
# 4 "project/radare2/test/unit/test_anal_var.c" 3 4
                                                unsigned long long 
# 4 "project/radare2/test/unit/test_anal_var.c"
                                                     k, const void *v) {
...
# 7 "project/radare2/test/unit/test_anal_var.c" 3 4
for (
# 7 "project/radare2/test/unit/test_anal_var.c"
it 
# 7 "project/radare2/test/unit/test_anal_var.c" 3 4
= (void **)(
# 7 "project/radare2/test/unit/test_anal_var.c"
...
# 10 "project/radare2/test/unit/test_anal_var.c" 3 4
 _Bool 
# 10 "project/radare2/test/unit/test_anal_var.c"
      found = 
# 10 "project/radare2/test/unit/test_anal_var.c" 3 4
              0
# 10 "project/radare2/test/unit/test_anal_var.c"
...
# 11 "project/radare2/test/unit/test_anal_var.c" 3 4
 if (!r_vector_empty (
# 11 "project/radare2/test/unit/test_anal_var.c"
 &var->accesses
# 11 "project/radare2/test/unit/test_anal_var.c" 3 4
 )) for (
# 11 "project/radare2/test/unit/test_anal_var.c"
...
# 11 "project/radare2/test/unit/test_anal_var.c"
                                        {
   if (acc->offset == (
# 12 "project/radare2/test/unit/test_anal_var.c" 3 4
                      long long
# 12 "project/radare2/test/unit/test_anal_var.c"
                          )k) {
    found = 
# 13 "project/radare2/test/unit/test_anal_var.c" 3 4
           1
# 13 "project/radare2/test/unit/test_anal_var.c"
               ;
    break;
   }
  }
  do { if (!(found)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 17, "instr refs var, but var does not ref instr"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 17, "instr refs var, but var does not ref instr"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 }
 return 
# 19 "project/radare2/test/unit/test_anal_var.c" 3 4
       1
# 19 "project/radare2/test/unit/test_anal_var.c"
           ;
}

static 
# 22 "project/radare2/test/unit/test_anal_var.c" 3 4
      _Bool 
# 22 "project/radare2/test/unit/test_anal_var.c"
           sanitize(RAnalFunction *fcn) {
 ht_up_foreach (fcn->inst_vars, sanitize_instr_acc, 
# 23 "project/radare2/test/unit/test_anal_var.c" 3 4
                                                   ((void *)0)
# 23 "project/radare2/test/unit/test_anal_var.c"
                                                       );

 void **it;
 
# 26 "project/radare2/test/unit/test_anal_var.c" 3 4
for (
# 26 "project/radare2/test/unit/test_anal_var.c"
it 
# 26 "project/radare2/test/unit/test_anal_var.c" 3 4
= (void **)(
# 26 "project/radare2/test/unit/test_anal_var.c"
...
# 29 "project/radare2/test/unit/test_anal_var.c" 3 4
 if (!r_vector_empty (
# 29 "project/radare2/test/unit/test_anal_var.c"
 &var->accesses
# 29 "project/radare2/test/unit/test_anal_var.c" 3 4
 )) for (
# 29 "project/radare2/test/unit/test_anal_var.c"
...
# 29 "project/radare2/test/unit/test_anal_var.c"
                                        {
   RPVector *iaccs = ht_up_find (fcn->inst_vars, acc->offset, 
# 30 "project/radare2/test/unit/test_anal_var.c" 3 4
                                                             ((void *)0)
# 30 "project/radare2/test/unit/test_anal_var.c"
                                                                 );
   do { if (!(r_pvector_contains (iaccs, var))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 31, "var refs instr but instr does not ref var"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 31, "var refs instr but instr does not ref var"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
  }
 }
 return 
# 34 "project/radare2/test/unit/test_anal_var.c" 3 4
       1
# 34 "project/radare2/test/unit/test_anal_var.c"
           ;
}
# 45 "project/radare2/test/unit/test_anal_var.c"

# 45 "project/radare2/test/unit/test_anal_var.c" 3 4
_Bool 
# 45 "project/radare2/test/unit/test_anal_var.c"
    test_r_anal_var() {
 ...
 RAnalFunction *fcn = r_anal_create_function (anal, "fcn", 0x100, R_ANAL_FCN_TYPE_FCN, 
# 50 "project/radare2/test/unit/test_anal_var.c" 3 4
                                                                                      ((void *)0)
# 50 "project/radare2/test/unit/test_anal_var.c"
                                                                                          );
 do { RListIter *ass_it; RAnalFunction *ass_fcn; 
# 51 "project/radare2/test/unit/test_anal_var.c" 3 4
if (
# 51 "project/radare2/test/unit/test_anal_var.c"
(anal)->fcns
# 51 "project/radare2/test/unit/test_anal_var.c" 3 4
) for (
# 51 "project/radare2/test/unit/test_anal_var.c"
...
; } } } while (0);;
 ...
 RAnalVar *a = r_anal_function_set_var (fcn, -8, R_ANAL_VAR_KIND_BPV, "char *", 8, 
# 55 "project/radare2/test/unit/test_anal_var.c" 3 4
                                                                                  0
# 55 "project/radare2/test/unit/test_anal_var.c"
                                                                                       , "random_name");
 do { char _meqstr[5120]; const void *act__ = (a); 
# 56 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 56 "project/radare2/test/unit/test_anal_var.c"
_meqstr
# 56 "project/radare2/test/unit/test_anal_var.c" 3 4
, 
# 56 "project/radare2/test/unit/test_anal_var.c"
...
, 2 > 1 ? 1 : 0), 
# 56 "project/radare2/test/unit/test_anal_var.c"
"%s: expected to not be NULL but it was.", ("create a var")
# 56 "project/radare2/test/unit/test_anal_var.c" 3 4
)
# 56 "project/radare2/test/unit/test_anal_var.c"
; do { if (!((act__) != 
...
# 56 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (a->name); const char *exp__ = ("random_name"); 
# 57 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 57 "project/radare2/test/unit/test_anal_var.c"
_meqstr
# 57 "project/radare2/test/unit/test_anal_var.c" 3 4
, 
# 57 "project/radare2/test/unit/test_anal_var.c"
...
, 2 > 1 ? 1 : 0), 
# 57 "project/radare2/test/unit/test_anal_var.c"
"%s: expected %s, got %s.", ("var name"), (exp__), (act__)
# 57 "project/radare2/test/unit/test_anal_var.c" 3 4
)
# 57 "project/radare2/test/unit/test_anal_var.c"
...
# 58 "project/radare2/test/unit/test_anal_var.c" 3 4
_Bool 
# 58 "project/radare2/test/unit/test_anal_var.c"
     succ = r_anal_var_rename (a, "var_a", 
# 58 "project/radare2/test/unit/test_anal_var.c" 3 4
                                           0
# 58 "project/radare2/test/unit/test_anal_var.c"
                                                );
 do { if (!(succ)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 59, "rename success"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 59, "rename success"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { char _meqstr[5120]; const char *act__ = (a->name); const char *exp__ = ("var_a"); 
# 60 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 60 "project/radare2/test/unit/test_anal_var.c"
_meqstr
# 60 "project/radare2/test/unit/test_anal_var.c" 3 4
, 
# 60 "project/radare2/test/unit/test_anal_var.c"
...
, 2 > 1 ? 1 : 0), 
# 60 "project/radare2/test/unit/test_anal_var.c"
"%s: expected %s, got %s.", ("var name after rename"), (exp__), (act__)
# 60 "project/radare2/test/unit/test_anal_var.c" 3 4
)
# 60 "project/radare2/test/unit/test_anal_var.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 60, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 60, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 RAnalVar *b = r_anal_function_set_var (fcn, -0x10, R_ANAL_VAR_KIND_SPV, "char *", 8, 
# 62 "project/radare2/test/unit/test_anal_var.c" 3 4
                                                                                     0
# 62 "project/radare2/test/unit/test_anal_var.c"
                                                                                          , "var_a");
 do { char _meqstr[5120]; const void *act__ = (b); 
# 63 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 63 "project/radare2/test/unit/test_anal_var.c"
_meqstr
# 63 "project/radare2/test/unit/test_anal_var.c" 3 4
, 
# 63 "project/radare2/test/unit/test_anal_var.c"
...
, 2 > 1 ? 1 : 0), 
# 63 "project/radare2/test/unit/test_anal_var.c"
"%s: expected to be NULL but it wasn't.", ("create a var with the same name")
# 63 "project/radare2/test/unit/test_anal_var.c" 3 4
)
# 63 "project/radare2/test/unit/test_anal_var.c"
; do { if (!((act__) == 
...
# 63 "project/radare2/test/unit/test_anal_var.c"
 ...
 b = r_anal_function_set_var (fcn, -0x10, R_ANAL_VAR_KIND_SPV, "char *", 8, 
# 64 "project/radare2/test/unit/test_anal_var.c" 3 4
                                                                           0
# 64 "project/radare2/test/unit/test_anal_var.c"
                                                                                , "new_var");
 do { char _meqstr[5120]; const void *act__ = (b); 
# 65 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 65 "project/radare2/test/unit/test_anal_var.c"
_meqstr
# 65 "project/radare2/test/unit/test_anal_var.c" 3 4
, 
# 65 "project/radare2/test/unit/test_anal_var.c"
...
, 2 > 1 ? 1 : 0), 
# 65 "project/radare2/test/unit/test_anal_var.c"
"%s: expected to not be NULL but it was.", ("create a var with another name")
# 65 "project/radare2/test/unit/test_anal_var.c" 3 4
)
# 65 "project/radare2/test/unit/test_anal_var.c"
; do { if (!((act__) != 
...
# 65 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { char _meqstr[5120]; const char *act__ = (b->name); const char *exp__ = ("new_var"); 
# 66 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 66 "project/radare2/test/unit/test_anal_var.c"
_meqstr
# 66 "project/radare2/test/unit/test_anal_var.c" 3 4
, 
# 66 "project/radare2/test/unit/test_anal_var.c"
...
# 66 "project/radare2/test/unit/test_anal_var.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 66, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 66, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 succ = r_anal_var_rename (b, "random_name", 
# 67 "project/radare2/test/unit/test_anal_var.c" 3 4
                                            0
# 67 "project/radare2/test/unit/test_anal_var.c"
                                                 );
 do { if (!(succ)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 68, "rename success"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 68, "rename success"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { char _meqstr[5120]; const char *act__ = (b->name); const char *exp__ = ("random_name"); 
# 69 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 69 "project/radare2/test/unit/test_anal_var.c"
_meqstr
# 69 "project/radare2/test/unit/test_anal_var.c" 3 4
, 
# 69 "project/radare2/test/unit/test_anal_var.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 69, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 69, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 succ = r_anal_var_rename (b, "var_a", 
# 70 "project/radare2/test/unit/test_anal_var.c" 3 4
                                      0
# 70 "project/radare2/test/unit/test_anal_var.c"
                                           );
 do { if (!(!succ)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 71, "rename failed"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 71, "rename failed"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { char _meqstr[5120]; const char *act__ = (b->name); const char *exp__ = ("random_name"); 
# 72 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 72 "project/radare2/test/unit/test_anal_var.c"
_meqstr
# 72 "project/radare2/test/unit/test_anal_var.c" 3 4
, 
# 72 "project/radare2/test/unit/test_anal_var.c"
...
, 2 > 1 ? 1 : 0), 
# 72 "project/radare2/test/unit/test_anal_var.c"
"%s: expected %s, got %s.", ("var name after failed rename"), (exp__), (act__)
# 72 "project/radare2/test/unit/test_anal_var.c" 3 4
)
# 72 "project/radare2/test/unit/test_anal_var.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 72, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 72, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 succ = r_anal_var_rename (b, "var_b", 
# 73 "project/radare2/test/unit/test_anal_var.c" 3 4
                                      0
# 73 "project/radare2/test/unit/test_anal_var.c"
                                           );
 do { if (!(succ)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 74, "rename success"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 74, "rename success"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { char _meqstr[5120]; const char *act__ = (b->name); const char *exp__ = ("var_b"); 
# 75 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 75 "project/radare2/test/unit/test_anal_var.c"
_meqstr
# 75 "project/radare2/test/unit/test_anal_var.c" 3 4
, 
# 75 "project/radare2/test/unit/test_anal_var.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 75, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 75, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 RAnalVar *c = r_anal_function_set_var (fcn, 0x30, R_ANAL_VAR_KIND_REG, "int64_t", 8, 
# 77 "project/radare2/test/unit/test_anal_var.c" 3 4
                                                                                     1
# 77 "project/radare2/test/unit/test_anal_var.c"
                                                                                         , "arg42");
 do { char _meqstr[5120]; const void *act__ = (c); 
# 78 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 78 "project/radare2/test/unit/test_anal_var.c"
_meqstr
# 78 "project/radare2/test/unit/test_anal_var.c" 3 4
, 
# 78 "project/radare2/test/unit/test_anal_var.c"
...
# 78 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (v); 
# 83 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 83 "project/radare2/test/unit/test_anal_var.c"
_meqstr
# 83 "project/radare2/test/unit/test_anal_var.c" 3 4
, 
# 83 "project/radare2/test/unit/test_anal_var.c"
...
, 2 > 1 ? 1 : 0), 
# 83 "project/radare2/test/unit/test_anal_var.c"
"%s: expected to be NULL but it wasn't.", ("get no var")
# 83 "project/radare2/test/unit/test_anal_var.c" 3 4
)
# 83 "project/radare2/test/unit/test_anal_var.c"
; do { if (!((act__) == 
...
# 83 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (v); const void *exp__ = (c); 
# 85 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 85 "project/radare2/test/unit/test_anal_var.c"
_meqstr
# 85 "project/radare2/test/unit/test_anal_var.c" 3 4
, 
# 85 "project/radare2/test/unit/test_anal_var.c"
...
, 2 > 1 ? 1 : 0), 
# 85 "project/radare2/test/unit/test_anal_var.c"
"%s: expected %p, got %p.", ("get var (reg)"), (exp__), (act__)
# 85 "project/radare2/test/unit/test_anal_var.c" 3 4
)
# 85 "project/radare2/test/unit/test_anal_var.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 85, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 85, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 ...
 do { char _meqstr[5120]; const void *act__ = (v); const void *exp__ = (b); 
# 87 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 87 "project/radare2/test/unit/test_anal_var.c"
_meqstr
# 87 "project/radare2/test/unit/test_anal_var.c" 3 4
, 
# 87 "project/radare2/test/unit/test_anal_var.c"
...
, 2 > 1 ? 1 : 0), 
# 87 "project/radare2/test/unit/test_anal_var.c"
"%s: expected %p, got %p.", ("get var (sp)"), (exp__), (act__)
# 87 "project/radare2/test/unit/test_anal_var.c" 3 4
)
# 87 "project/radare2/test/unit/test_anal_var.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 87, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 87, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 v = r_anal_function_get_var (fcn, R_ANAL_VAR_KIND_BPV, -8);
 do { char _meqstr[5120]; const void *act__ = (v); const void *exp__ = (a); 
# 89 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 89 "project/radare2/test/unit/test_anal_var.c"
_meqstr
# 89 "project/radare2/test/unit/test_anal_var.c" 3 4
, 
# 89 "project/radare2/test/unit/test_anal_var.c"
...
, 2 > 1 ? 1 : 0), 
# 89 "project/radare2/test/unit/test_anal_var.c"
"%s: expected %p, got %p.", ("get var (bp)"), (exp__), (act__)
# 89 "project/radare2/test/unit/test_anal_var.c" 3 4
)
# 89 "project/radare2/test/unit/test_anal_var.c"
; do { if (!((exp__) == (act__))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 89, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 89, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while (0);
 ...
 do { char _meqstr[5120]; const void *act__ = (v); 
# 92 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 92 "project/radare2/test/unit/test_anal_var.c"
_meqstr
# 92 "project/radare2/test/unit/test_anal_var.c" 3 4
, 
# 92 "project/radare2/test/unit/test_anal_var.c"
...
, 2 > 1 ? 1 : 0), 
# 92 "project/radare2/test/unit/test_anal_var.c"
"%s: expected to be NULL but it wasn't.", ("nonsense name")
# 92 "project/radare2/test/unit/test_anal_var.c" 3 4
)
# 92 "project/radare2/test/unit/test_anal_var.c"
; do { if (!((act__) == 
...
# 92 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (v); const void *exp__ = (a); 
# 94 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 94 "project/radare2/test/unit/test_anal_var.c"
_meqstr
# 94 "project/radare2/test/unit/test_anal_var.c" 3 4
, 
# 94 "project/radare2/test/unit/test_anal_var.c"
...
, 2 > 1 ? 1 : 0), 
# 94 "project/radare2/test/unit/test_anal_var.c"
"%s: expected %p, got %p.", ("get var by name"), (exp__), (act__)
# 94 "project/radare2/test/unit/test_anal_var.c" 3 4
)
# 94 "project/radare2/test/unit/test_anal_var.c"
...
# 103 "project/radare2/test/unit/test_anal_var.c" 3 4
long long 
# 103 "project/radare2/test/unit/test_anal_var.c"
     stackptr = r_anal_function_get_var_stackptr_at (fcn, -0x10, 0x12345);
 do { 
# 104 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 104 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 104 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 104 "project/radare2/test/unit/test_anal_var.c"
...
# 104 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { if (!(!used_vars || r_pvector_len (used_vars))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 107, "no used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 107, "no used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 used_vars = r_anal_function_get_vars_used_at (fcn, 0x130);
 do { 
# 109 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 109 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 109 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 109 "project/radare2/test/unit/test_anal_var.c"
)(r_pvector_len (used_vars)); 
# 109 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 109 "project/radare2/test/unit/test_anal_var.c"
exp__ = (
...
0
# 109 "project/radare2/test/unit/test_anal_var.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 109, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 109, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { if (!(r_pvector_contains (used_vars, a))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 110, "used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 110, "used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 stackptr = r_anal_function_get_var_stackptr_at (fcn, -8, 0x130);
 do { 
# 112 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 112 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 112 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 112 "project/radare2/test/unit/test_anal_var.c"
...
unsigned long long
# 112 "project/radare2/test/unit/test_anal_var.c"
)(13); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 112 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 112 "project/radare2/test/unit/test_anal_var.c"
_meqstr
...
# 112 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { 
# 114 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 114 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 114 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 114 "project/radare2/test/unit/test_anal_var.c"
...
# 114 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { 
# 116 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 116 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 116 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 116 "project/radare2/test/unit/test_anal_var.c"
...
# 116 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { if (!(r_pvector_contains (used_vars, a))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 117, "used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 117, "used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { if (!(r_pvector_contains (used_vars, b))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 118, "used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 118, "used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 stackptr = r_anal_function_get_var_stackptr_at (fcn, -0x10, 0x120);
 do { 
# 120 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 120 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 120 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 120 "project/radare2/test/unit/test_anal_var.c"
...
unsigned long long
# 120 "project/radare2/test/unit/test_anal_var.c"
)(123); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 120 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 120 "project/radare2/test/unit/test_anal_var.c"
_meqstr
...
# 120 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { 
# 122 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 122 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 122 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 122 "project/radare2/test/unit/test_anal_var.c"
...
unsigned long long
# 122 "project/radare2/test/unit/test_anal_var.c"
)(42); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 122 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 122 "project/radare2/test/unit/test_anal_var.c"
_meqstr
...
# 122 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { 
# 124 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 124 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 124 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 124 "project/radare2/test/unit/test_anal_var.c"
...
# 124 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { if (!(r_pvector_contains (used_vars, b))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 125, "used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 125, "used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 stackptr = r_anal_function_get_var_stackptr_at (fcn, -0x10, 0x10);
 do { 
# 127 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 127 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 127 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 127 "project/radare2/test/unit/test_anal_var.c"
...
unsigned long long
# 127 "project/radare2/test/unit/test_anal_var.c"
)(-100); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 127 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 127 "project/radare2/test/unit/test_anal_var.c"
_meqstr
...
0
# 127 "project/radare2/test/unit/test_anal_var.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 127, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 127, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 do { RListIter *ass_it; RAnalFunction *ass_fcn; 
# 129 "project/radare2/test/unit/test_anal_var.c" 3 4
if (
# 129 "project/radare2/test/unit/test_anal_var.c"
(anal)->fcns
# 129 "project/radare2/test/unit/test_anal_var.c" 3 4
) for (
# 129 "project/radare2/test/unit/test_anal_var.c"
...
; } } } while (0);;
 ...
 do { RListIter *ass_it; RAnalFunction *ass_fcn; 
# 134 "project/radare2/test/unit/test_anal_var.c" 3 4
if (
# 134 "project/radare2/test/unit/test_anal_var.c"
(anal)->fcns
# 134 "project/radare2/test/unit/test_anal_var.c" 3 4
) for (
# 134 "project/radare2/test/unit/test_anal_var.c"
...
; } } } while (0);;
 ...
 do { if (!(!used_vars || r_pvector_len (used_vars))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 137, "no used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 137, "no used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 r_anal_var_set_access (a, "rbp", 0xffffffffffff0130UL, R_ANAL_VAR_ACCESS_TYPE_READ, 42);
 used_vars = r_anal_function_get_vars_used_at (fcn, 0xffffffffffff0130UL);
 do { 
# 140 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 140 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 140 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 140 "project/radare2/test/unit/test_anal_var.c"
...
# 140 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { if (!(r_pvector_contains (used_vars, a))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 141, "used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 141, "used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);

 used_vars = r_anal_function_get_vars_used_at (fcn, 0x123);
 do { if (!(!used_vars || r_pvector_len (used_vars))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 144, "no used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 144, "no used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 r_anal_var_set_access (a, "rbp" , 0x123, R_ANAL_VAR_ACCESS_TYPE_READ, 42);
 used_vars = r_anal_function_get_vars_used_at (fcn, 0x123);
 do { 
# 147 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 147 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 147 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 147 "project/radare2/test/unit/test_anal_var.c"
...
# 147 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { if (!(r_pvector_contains (used_vars, a))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 148, "used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 148, "used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);

 used_vars = r_anal_function_get_vars_used_at (fcn, 0xffffffffffff0130);
 do { 
# 151 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 151 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 151 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 151 "project/radare2/test/unit/test_anal_var.c"
...
# 151 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { if (!(r_pvector_contains (used_vars, a))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 152, "used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 152, "used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 used_vars = r_anal_function_get_vars_used_at (fcn, 0xffffffffffff0120);
 do { 
# 154 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 154 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 154 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 154 "project/radare2/test/unit/test_anal_var.c"
...
# 154 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { if (!(r_pvector_contains (used_vars, a))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 155, "used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 155, "used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { if (!(r_pvector_contains (used_vars, b))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 156, "used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 156, "used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 stackptr = r_anal_function_get_var_stackptr_at (fcn, -0x10, 0xffffffffffff0120);
 do { 
# 158 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 158 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 158 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 158 "project/radare2/test/unit/test_anal_var.c"
...
0
# 158 "project/radare2/test/unit/test_anal_var.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 158, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 158, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 stackptr = r_anal_function_get_var_stackptr_at (fcn, -8, 0xffffffffffff0120);
 do { 
# 160 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 160 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 160 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 160 "project/radare2/test/unit/test_anal_var.c"
...
0
# 160 "project/radare2/test/unit/test_anal_var.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 160, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 160, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 used_vars = r_anal_function_get_vars_used_at (fcn, 0xffffffffffff0010);
 do { 
# 162 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 162 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 162 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 162 "project/radare2/test/unit/test_anal_var.c"
...
# 162 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { if (!(r_pvector_contains (used_vars, b))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 163, "used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 163, "used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);

 r_anal_function_relocate (fcn, 0x8000000000000010);
 do { RListIter *ass_it; RAnalFunction *ass_fcn; 
# 166 "project/radare2/test/unit/test_anal_var.c" 3 4
if (
# 166 "project/radare2/test/unit/test_anal_var.c"
(anal)->fcns
# 166 "project/radare2/test/unit/test_anal_var.c" 3 4
) for (
# 166 "project/radare2/test/unit/test_anal_var.c"
...
; } } } while (0);;
 ...
 do { if (!(!used_vars || r_pvector_len (used_vars))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 169, "no used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 169, "no used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 r_anal_var_set_access (a, "rbp", 0x8000000000000100, R_ANAL_VAR_ACCESS_TYPE_READ, 987321);
 used_vars = r_anal_function_get_vars_used_at (fcn, 0x8000000000000100);
 do { 
# 172 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 172 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 172 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 172 "project/radare2/test/unit/test_anal_var.c"
...
0
# 172 "project/radare2/test/unit/test_anal_var.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 172, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 172, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { if (!(r_pvector_contains (used_vars, a))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 173, "used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 173, "used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 stackptr = r_anal_function_get_var_stackptr_at (fcn, -8, 0x8000000000000100);
 do { 
# 175 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 175 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 175 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 175 "project/radare2/test/unit/test_anal_var.c"
...
unsigned long long
# 175 "project/radare2/test/unit/test_anal_var.c"
)(987321); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 175 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 175 "project/radare2/test/unit/test_anal_var.c"
_meqstr
...
0
# 175 "project/radare2/test/unit/test_anal_var.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 175, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 175, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 used_vars = r_anal_function_get_vars_used_at (fcn, 0x7ffffffffffffe00);
 do { if (!(!used_vars || r_pvector_len (used_vars))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 178, "no used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 178, "no used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 r_anal_var_set_access (a, "rbp", 0x7ffffffffffffe00, R_ANAL_VAR_ACCESS_TYPE_READ, 777);
 used_vars = r_anal_function_get_vars_used_at (fcn, 0x7ffffffffffffe00);
 do { 
# 181 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 181 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 181 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 181 "project/radare2/test/unit/test_anal_var.c"
...
# 181 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { if (!(r_pvector_contains (used_vars, a))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 182, "used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 182, "used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 stackptr = r_anal_function_get_var_stackptr_at (fcn, -8, 0x7ffffffffffffe00);
 do { 
# 184 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 184 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 184 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 184 "project/radare2/test/unit/test_anal_var.c"
...
unsigned long long
# 184 "project/radare2/test/unit/test_anal_var.c"
)(777); if ((exp__) != (act__)) { char _meqstr[5120]; 
# 184 "project/radare2/test/unit/test_anal_var.c" 3 4
__builtin___snprintf_chk (
# 184 "project/radare2/test/unit/test_anal_var.c"
_meqstr
...
# 184 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { 
# 187 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 187 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 187 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 187 "project/radare2/test/unit/test_anal_var.c"
...
0
# 187 "project/radare2/test/unit/test_anal_var.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 187, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 187, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { if (!(r_pvector_contains (used_vars, a))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 188, "used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 188, "used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 used_vars = r_anal_function_get_vars_used_at (fcn, 0x8000000000010033);
 do { 
# 190 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 190 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 190 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 190 "project/radare2/test/unit/test_anal_var.c"
...
0
# 190 "project/radare2/test/unit/test_anal_var.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 190, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 190, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 do { if (!(r_pvector_contains (used_vars, a))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 191, "used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 191, "used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 used_vars = r_anal_function_get_vars_used_at (fcn, 0x8000000000000040);
 do { 
# 193 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 193 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 193 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 193 "project/radare2/test/unit/test_anal_var.c"
...
# 193 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { if (!(r_pvector_contains (used_vars, a))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 194, "used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 194, "used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 used_vars = r_anal_function_get_vars_used_at (fcn, 0x8000000000000030);
 do { 
# 196 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 196 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 196 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 196 "project/radare2/test/unit/test_anal_var.c"
...
# 196 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { if (!(r_pvector_contains (used_vars, a))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 197, "used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 197, "used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { if (!(r_pvector_contains (used_vars, b))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 198, "used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 198, "used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 stackptr = r_anal_function_get_var_stackptr_at (fcn, -0x10, 0x8000000000000030);
 do { 
# 200 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 200 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 200 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 200 "project/radare2/test/unit/test_anal_var.c"
...
0
# 200 "project/radare2/test/unit/test_anal_var.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 200, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 200, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);
 stackptr = r_anal_function_get_var_stackptr_at (fcn, -8, 0x8000000000000030);
 do { 
# 202 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 202 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 202 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 202 "project/radare2/test/unit/test_anal_var.c"
...
0
# 202 "project/radare2/test/unit/test_anal_var.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 202, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 202, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while(0);

 do { RListIter *ass_it; RAnalFunction *ass_fcn; 
# 204 "project/radare2/test/unit/test_anal_var.c" 3 4
if (
# 204 "project/radare2/test/unit/test_anal_var.c"
(anal)->fcns
# 204 "project/radare2/test/unit/test_anal_var.c" 3 4
) for (
# 204 "project/radare2/test/unit/test_anal_var.c"
...
; } } } while (0);;
 ...
 r_anal_var_delete (a);
 do { RListIter *ass_it; RAnalFunction *ass_fcn; 
# 207 "project/radare2/test/unit/test_anal_var.c" 3 4
if (
# 207 "project/radare2/test/unit/test_anal_var.c"
(anal)->fcns
# 207 "project/radare2/test/unit/test_anal_var.c" 3 4
) for (
# 207 "project/radare2/test/unit/test_anal_var.c"
...
; } } } while (0);;
 ...
 used_vars = r_anal_function_get_vars_used_at (fcn, 0xffffffffffff0130UL);
 do { if (!(!used_vars || !r_pvector_len (used_vars))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 210, "used vars count"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 210, "used vars count"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 used_vars = r_anal_function_get_vars_used_at (fcn, 0x123);
 do { if (!(!used_vars || !r_pvector_len (used_vars))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 212, "used vars count"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 212, "used vars count"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 used_vars = r_anal_function_get_vars_used_at (fcn, 0x130);
 do { if (!(!used_vars || !r_pvector_len (used_vars))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 214, "used vars count"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 214, "used vars count"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 used_vars = r_anal_function_get_vars_used_at (fcn, 0x8000000000000030);
 do { 
# 216 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long 
# 216 "project/radare2/test/unit/test_anal_var.c"
act__ = (
# 216 "project/radare2/test/unit/test_anal_var.c" 3 4
unsigned long long
# 216 "project/radare2/test/unit/test_anal_var.c"
...
# 216 "project/radare2/test/unit/test_anal_var.c"
 ...
 do { if (!(r_pvector_contains (used_vars, b))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 217, "used vars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 217, "used vars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);


 RList *vps = r_anal_var_get_prots (fcn);
 do { if (!(vps && r_list_length (vps) == 2)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 221, "Failed r_anal_var_get_protos"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 221, "Failed r_anal_var_get_protos"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);

 char *serial = r_anal_var_prot_serialize (vps, 
# 223 "project/radare2/test/unit/test_anal_var.c" 3 4
                                               1
# 223 "project/radare2/test/unit/test_anal_var.c"
                                                   );
 do { if (!(!strcmp (serial, "fs-16:var_b:char *, tr48:arg42:int64_t"))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 224, "serial space"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 224, "serial space"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 free (serial);

 serial = r_anal_var_prot_serialize (vps, 
# 227 "project/radare2/test/unit/test_anal_var.c" 3 4
                                         0
# 227 "project/radare2/test/unit/test_anal_var.c"
                                              );
 do { if (!(!strcmp (serial, "fs-16:var_b:char *,tr48:arg42:int64_t"))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 228, "serial no space"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 228, "serial no space"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 free (serial);
 r_list_free (vps);

 vps = r_anal_var_deserialize ("ts-16:var_name:char **, tr48:var_name_b:size_t");
 do { if (!(vps && r_list_length (vps) == 2)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 233, "Failed r_anal_var_deserialize"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 233, "Failed r_anal_var_deserialize"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);

 RAnalVarProt *vp = (RAnalVarProt *)r_list_get_bottom (vps);
 do { if (!(!strcmp (vp->name, "var_name") && !strcmp (vp->type, "char **"))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 236, "Deserialize name[0]"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 236, "Deserialize name[0]"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 vp = (RAnalVarProt *)r_list_get_top (vps);
 do { if (!(!strcmp (vp->name, "var_name_b") && !strcmp (vp->type, "size_t"))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 238, "Deserialize name[1]"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 238, "Deserialize name[1]"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);

 do { if (!(r_anal_function_set_var_prot (fcn, vps))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 240, "r_anal_function_set_var_prot"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 240, "r_anal_function_set_var_prot"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { if (!(!strcmp (b->name, "var_name") && !strcmp (b->type, "char **"))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 241, "Setting first var from proto"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 241, "Setting first var from proto"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { if (!(!strcmp (c->name, "var_name_b") && !strcmp (c->type, "size_t"))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 242, "Setting second var from proto"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 242, "Setting second var from proto"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);

 r_list_purge (vps);
 vp = 
# 245 "project/radare2/test/unit/test_anal_var.c" 3 4
     (
# 245 "project/radare2/test/unit/test_anal_var.c"
     RAnalVarProt
# 245 "project/radare2/test/unit/test_anal_var.c" 3 4
     *)calloc(1,sizeof(
# 245 "project/radare2/test/unit/test_anal_var.c"
...
# 245 "project/radare2/test/unit/test_anal_var.c"
 ...
 vp->kind = 'z';
 serial = r_anal_var_prot_serialize (vps, 
# 250 "project/radare2/test/unit/test_anal_var.c" 3 4
                                         0
# 250 "project/radare2/test/unit/test_anal_var.c"
                                              );
 do { if (!(!serial)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 251, "Serializtion succeeded despite invalide kind"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 251, "Serializtion succeeded despite invalide kind"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 free (serial);

 vp->kind = R_ANAL_VAR_KIND_REG;
 serial = r_anal_var_prot_serialize (vps, 
# 255 "project/radare2/test/unit/test_anal_var.c" 3 4
                                         0
# 255 "project/radare2/test/unit/test_anal_var.c"
                                              );
 do { if (!(serial && !strcmp ("fr0:bad_name_____________:bad_type:____________", serial))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 256, "Serializtion filtered bad chars"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 256, "Serializtion filtered bad chars"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 r_list_free (vps);
 free (serial);

 vps = r_anal_var_deserialize ("ts-16:v,r_name:char **");
 do { if (!(!vps)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 261, "No ',' in serialized name"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 261, "No ',' in serialized name"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
...
int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_anal_var"); result = test_r_anal_var(); tests_run++; tests_passed += result; } while (0);
