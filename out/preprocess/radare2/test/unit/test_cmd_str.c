# 0 "project/radare2/test/unit/test_cmd_str.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 2 "project/radare2/test/unit/test_cmd_str.c" 2
# 1 "project/radare2/test/unit/minunit.h" 1
# 27 "project/radare2/test/unit/minunit.h"

# 27 "project/radare2/test/unit/minunit.h"
void snprint_mem(char *out, size_t out_size, const 
# 27 "project/radare2/test/unit/minunit.h" 3 4
                                                  unsigned char 
# 27 "project/radare2/test/unit/minunit.h"
                                                      *buf, size_t len) {
 size_t i;
...
# 34 "project/radare2/test/unit/minunit.h" 3 4
  __builtin___snprintf_chk (
# 34 "project/radare2/test/unit/minunit.h"
  out + out_len
# 34 "project/radare2/test/unit/minunit.h" 3 4
  , 
# 34 "project/radare2/test/unit/minunit.h"
...
# 37 "project/radare2/test/unit/minunit.h" 3 4
 __builtin___snprintf_chk (
# 37 "project/radare2/test/unit/minunit.h"
 out + out_len
# 37 "project/radare2/test/unit/minunit.h" 3 4
 , 
# 37 "project/radare2/test/unit/minunit.h"
...
# 3 "project/radare2/test/unit/test_cmd_str.c" 2


# 4 "project/radare2/test/unit/test_cmd_str.c" 3 4
_Bool 
# 4 "project/radare2/test/unit/test_cmd_str.c"
    test_cmd_str_issue_18799() {
 RCore *core = r_core_new ();
 char *output = r_core_cmd_str (core, "pd 1 @e:asm.hints=false");
 do { if (!(strlen (output) > 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 7, "command output leaked to stdout"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 7, "command output leaked to stdout"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 r_core_free (core);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}

int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_cmd_str_issue_18799"); result = test_cmd_str_issue_18799(); tests_run++; tests_passed += result; } while (0);
