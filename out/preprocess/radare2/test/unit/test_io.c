# 0 "project/radare2/test/unit/test_io.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/test/unit/test_io.c"
...
# 2 "project/radare2/test/unit/test_io.c" 2
...
# 3 "project/radare2/test/unit/test_io.c" 2


# 4 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 4 "project/radare2/test/unit/test_io.c"
    test_r_io_cache(void) {
 RIO *io = r_io_new ();
 r_io_open (io, "malloc://15", 
# 6 "project/radare2/test/unit/test_io.c" 3 4
                              (4|2)
# 6 "project/radare2/test/unit/test_io.c"
                                       , 0);
 r_io_write (io, (
# 7 "project/radare2/test/unit/test_io.c" 3 4
                 unsigned char 
# 7 "project/radare2/test/unit/test_io.c"
                     *)"ZZZZZZZZZZZZZZZ", 15);
 do { 
# 8 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 8 "project/radare2/test/unit/test_io.c"
act__ = (r_io_cache_at (io, 0)); if ((act__)) { char _meqstr[5120]; 
# 8 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 8 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 8 "project/radare2/test/unit/test_io.c"
"%s: expected false, got true", ("Cache shouldn't exist at 0")
# 8 "project/radare2/test/unit/test_io.c" 3 4
)
# 8 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
# 8 "project/radare2/test/unit/test_io.c"
 ...
 do { 
# 9 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 9 "project/radare2/test/unit/test_io.c"
act__ = (r_io_cache_at (io, 10)); if ((act__)) { char _meqstr[5120]; 
# 9 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 9 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 9 "project/radare2/test/unit/test_io.c"
"%s: expected false, got true", ("Cache shouldn't exist at 10")
# 9 "project/radare2/test/unit/test_io.c" 3 4
)
# 9 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
0
# 9 "project/radare2/test/unit/test_io.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 9, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 9, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while (0);
 do { 
# 10 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 10 "project/radare2/test/unit/test_io.c"
act__ = (r_io_cache_write (io, 0, (
# 10 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 10 "project/radare2/test/unit/test_io.c"
*)"AAAAA", 5)); if (!(act__)) { char _meqstr[5120]; 
# 10 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 10 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 10 "project/radare2/test/unit/test_io.c"
"%s: expected true, got false", ("Cache write at 0 failed")
# 10 "project/radare2/test/unit/test_io.c" 3 4
)
# 10 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
0
# 10 "project/radare2/test/unit/test_io.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 10, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 10, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while (0);
 do { 
# 11 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 11 "project/radare2/test/unit/test_io.c"
act__ = (r_io_cache_write (io, 10, (
# 11 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 11 "project/radare2/test/unit/test_io.c"
*)"BBBBB", 5)); if (!(act__)) { char _meqstr[5120]; 
# 11 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 11 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 11 "project/radare2/test/unit/test_io.c"
"%s: expected true, got false", ("Cache write at 10 failed")
# 11 "project/radare2/test/unit/test_io.c" 3 4
)
# 11 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
0
# 11 "project/radare2/test/unit/test_io.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 11, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 11, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while (0);
 do { 
# 12 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 12 "project/radare2/test/unit/test_io.c"
act__ = (r_io_cache_at (io, 0)); if (!(act__)) { char _meqstr[5120]; 
# 12 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 12 "project/radare2/test/unit/test_io.c"
...
, 2 > 1 ? 1 : 0), 
# 12 "project/radare2/test/unit/test_io.c"
"%s: expected true, got false", ("Cache should exist at 0 (beggining of cache)")
# 12 "project/radare2/test/unit/test_io.c" 3 4
)
# 12 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
0
# 12 "project/radare2/test/unit/test_io.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 12, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 12, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while (0);
 do { 
# 13 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 13 "project/radare2/test/unit/test_io.c"
act__ = (r_io_cache_at (io, 4)); if (!(act__)) { char _meqstr[5120]; 
# 13 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 13 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 13 "project/radare2/test/unit/test_io.c"
"%s: expected true, got false", ("Cache should exist at 4 (end of cache)")
# 13 "project/radare2/test/unit/test_io.c" 3 4
)
# 13 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
# 13 "project/radare2/test/unit/test_io.c"
 ...
 do { 
# 14 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 14 "project/radare2/test/unit/test_io.c"
act__ = (r_io_cache_at (io, 8)); if ((act__)) { char _meqstr[5120]; 
# 14 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 14 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 14 "project/radare2/test/unit/test_io.c"
"%s: expected false, got true", ("Cache shouldn't exist at 8 (between 2 caches)")
# 14 "project/radare2/test/unit/test_io.c" 3 4
)
# 14 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
0
# 14 "project/radare2/test/unit/test_io.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 14, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 14, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while (0);
 do { 
# 15 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 15 "project/radare2/test/unit/test_io.c"
act__ = (r_io_cache_at (io, 12)); if (!(act__)) { char _meqstr[5120]; 
# 15 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 15 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 15 "project/radare2/test/unit/test_io.c"
"%s: expected true, got false", ("Cache should exist at 12 (middle of cache)")
# 15 "project/radare2/test/unit/test_io.c" 3 4
)
# 15 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
# 16 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 16 "project/radare2/test/unit/test_io.c"
    buf[15];
 
# 17 "project/radare2/test/unit/test_io.c" 3 4
__builtin___memset_chk (
# 17 "project/radare2/test/unit/test_io.c"
buf
# 17 "project/radare2/test/unit/test_io.c" 3 4
, 
# 17 "project/radare2/test/unit/test_io.c"
...
# 17 "project/radare2/test/unit/test_io.c"
                               ;
 do { 
# 18 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 18 "project/radare2/test/unit/test_io.c"
act__ = (r_io_cache_read (io, 0, buf, sizeof (buf))); if (!(act__)) { char _meqstr[5120]; 
# 18 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 18 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 18 "project/radare2/test/unit/test_io.c"
"%s: expected true, got false", ("Cache read failed")
# 18 "project/radare2/test/unit/test_io.c" 3 4
)
# 18 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
# 19 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 19 "project/radare2/test/unit/test_io.c"
*act__ = (buf); const 
# 19 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 19 "project/radare2/test/unit/test_io.c"
...
, 2 > 1 ? 1 : 0), 
# 19 "project/radare2/test/unit/test_io.c"
"%s: expected ", "Cache read doesn't match expected output"
# 19 "project/radare2/test/unit/test_io.c" 3 4
)
# 19 "project/radare2/test/unit/test_io.c"
...
# 20 "project/radare2/test/unit/test_io.c" 3 4
__builtin___memset_chk (
# 20 "project/radare2/test/unit/test_io.c"
buf
# 20 "project/radare2/test/unit/test_io.c" 3 4
, 
# 20 "project/radare2/test/unit/test_io.c"
...
# 20 "project/radare2/test/unit/test_io.c"
                               ;
 do { 
# 21 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 21 "project/radare2/test/unit/test_io.c"
act__ = (r_io_cache_write (io, 0, (
# 21 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 21 "project/radare2/test/unit/test_io.c"
*)"CC", 2)); if (!(act__)) { char _meqstr[5120]; 
# 21 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 21 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 21 "project/radare2/test/unit/test_io.c"
"%s: expected true, got false", ("Overlapped cache write at 0 failed")
# 21 "project/radare2/test/unit/test_io.c" 3 4
)
# 21 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
# 21 "project/radare2/test/unit/test_io.c"
 ...
 do { 
# 22 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 22 "project/radare2/test/unit/test_io.c"
act__ = (r_io_cache_write (io, 4, (
# 22 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 22 "project/radare2/test/unit/test_io.c"
*)"DD", 2)); if (!(act__)) { char _meqstr[5120]; 
# 22 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 22 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 22 "project/radare2/test/unit/test_io.c"
"%s: expected true, got false", ("Overlapped cache write at 4 failed")
# 22 "project/radare2/test/unit/test_io.c" 3 4
)
# 22 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
# 22 "project/radare2/test/unit/test_io.c"
 ...
 do { 
# 23 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 23 "project/radare2/test/unit/test_io.c"
act__ = (r_io_cache_write (io, 8, (
# 23 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 23 "project/radare2/test/unit/test_io.c"
*)"EEE", 3)); if (!(act__)) { char _meqstr[5120]; 
# 23 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 23 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 23 "project/radare2/test/unit/test_io.c"
"%s: expected true, got false", ("Cache write at 4 failed")
# 23 "project/radare2/test/unit/test_io.c" 3 4
)
# 23 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
# 23 "project/radare2/test/unit/test_io.c"
 ...
 do { 
# 24 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 24 "project/radare2/test/unit/test_io.c"
act__ = (r_io_cache_read (io, 0, buf, 2)); if (!(act__)) { char _meqstr[5120]; 
# 24 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 24 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 24 "project/radare2/test/unit/test_io.c"
"%s: expected true, got false", ("Cache read at 0 failed")
# 24 "project/radare2/test/unit/test_io.c" 3 4
)
# 24 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
# 24 "project/radare2/test/unit/test_io.c"
 ...
 do { 
# 25 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 25 "project/radare2/test/unit/test_io.c"
act__ = (r_io_cache_read (io, 2, buf + 2, 2)); if (!(act__)) { char _meqstr[5120]; 
# 25 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 25 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 25 "project/radare2/test/unit/test_io.c"
"%s: expected true, got false", ("Cache read at 2 failed")
# 25 "project/radare2/test/unit/test_io.c" 3 4
)
# 25 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
# 25 "project/radare2/test/unit/test_io.c"
 ...
 do { 
# 26 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 26 "project/radare2/test/unit/test_io.c"
act__ = (r_io_cache_read (io, 4, buf + 4, 2)); if (!(act__)) { char _meqstr[5120]; 
# 26 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 26 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 26 "project/radare2/test/unit/test_io.c"
"%s: expected true, got false", ("Cache read at 4 failed")
# 26 "project/radare2/test/unit/test_io.c" 3 4
)
# 26 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
# 26 "project/radare2/test/unit/test_io.c"
 ...
 do { 
# 27 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 27 "project/radare2/test/unit/test_io.c"
act__ = (r_io_cache_read (io, 6, buf + 6, 2)); if (!(act__)) { char _meqstr[5120]; 
# 27 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 27 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 27 "project/radare2/test/unit/test_io.c"
"%s: expected true, got false", ("Cache read at 6 failed")
# 27 "project/radare2/test/unit/test_io.c" 3 4
)
# 27 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
# 27 "project/radare2/test/unit/test_io.c"
 ...
 do { 
# 28 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 28 "project/radare2/test/unit/test_io.c"
act__ = (r_io_cache_read (io, 8, buf + 8, 3)); if (!(act__)) { char _meqstr[5120]; 
# 28 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 28 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 28 "project/radare2/test/unit/test_io.c"
"%s: expected true, got false", ("Cache read at 8 failed")
# 28 "project/radare2/test/unit/test_io.c" 3 4
)
# 28 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
# 28 "project/radare2/test/unit/test_io.c"
 ...
 do { 
# 29 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 29 "project/radare2/test/unit/test_io.c"
act__ = (r_io_cache_read (io, 11, buf + 11, 4)); if (!(act__)) { char _meqstr[5120]; 
# 29 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 29 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 29 "project/radare2/test/unit/test_io.c"
"%s: expected true, got false", ("Cache read at 11 failed")
# 29 "project/radare2/test/unit/test_io.c" 3 4
)
# 29 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
# 29 "project/radare2/test/unit/test_io.c"
 ...
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 30 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 30 "project/radare2/test/unit/test_io.c"
*act__ = (buf); const 
# 30 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 30 "project/radare2/test/unit/test_io.c"
...
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (sizeof (buf))); do { if (!(memcmp((exp__), (act__), (sizeof (buf))) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 30, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 30, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { 
# 31 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 31 "project/radare2/test/unit/test_io.c"
act__ = (r_io_cache_write (io, 0, (
# 31 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 31 "project/radare2/test/unit/test_io.c"
*)"FFFFFFFFFFFFFFF", 15)); if (!(act__)) { char _meqstr[5120]; 
# 31 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 31 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 31 "project/radare2/test/unit/test_io.c"
"%s: expected true, got false", ("Cache write failed")
# 31 "project/radare2/test/unit/test_io.c" 3 4
)
# 31 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
# 31 "project/radare2/test/unit/test_io.c"
 ...
 do { 
# 32 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 32 "project/radare2/test/unit/test_io.c"
act__ = (r_io_cache_read (io, 0, buf, sizeof (buf))); if (!(act__)) { char _meqstr[5120]; 
# 32 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 32 "project/radare2/test/unit/test_io.c"
...
# 32 "project/radare2/test/unit/test_io.c"
 ...
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 33 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 33 "project/radare2/test/unit/test_io.c"
*act__ = (buf); const 
# 33 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 33 "project/radare2/test/unit/test_io.c"
...
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (sizeof (buf))); do { if (!(memcmp((exp__), (act__), (sizeof (buf))) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 33, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 33, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 35 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 35 "project/radare2/test/unit/test_io.c"
*act__ = (buf); const 
# 35 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 35 "project/radare2/test/unit/test_io.c"
...
, 2 > 1 ? 1 : 0), 
# 35 "project/radare2/test/unit/test_io.c"
"%s: expected ", "IO read without cache doesn't match expected output"
# 35 "project/radare2/test/unit/test_io.c" 3 4
)
# 35 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (sizeof (buf))); _meqstr_len = strlen (_meqstr); 
...
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (sizeof (buf))); do { if (!(memcmp((exp__), (act__), (sizeof (buf))) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 35, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 35, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 io->cached = 
# 36 "project/radare2/test/unit/test_io.c" 3 4
             4
# 36 "project/radare2/test/unit/test_io.c"
                     ;
 r_io_read_at (io, 0, buf, sizeof (buf));
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 38 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 38 "project/radare2/test/unit/test_io.c"
*act__ = (buf); const 
# 38 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 38 "project/radare2/test/unit/test_io.c"
...
, 2 > 1 ? 1 : 0), 
# 38 "project/radare2/test/unit/test_io.c"
"%s: expected ", "IO read with cache doesn't match expected output"
# 38 "project/radare2/test/unit/test_io.c" 3 4
)
# 38 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (sizeof (buf))); _meqstr_len = strlen (_meqstr); 
...
# 40 "project/radare2/test/unit/test_io.c" 3 4
__builtin___memset_chk (
# 40 "project/radare2/test/unit/test_io.c"
buf
# 40 "project/radare2/test/unit/test_io.c" 3 4
, 
# 40 "project/radare2/test/unit/test_io.c"
...
# 40 "project/radare2/test/unit/test_io.c"
 ...
 r_io_read_at (io, 0, buf, sizeof (buf));
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 42 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 42 "project/radare2/test/unit/test_io.c"
*act__ = (buf); const 
# 42 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 42 "project/radare2/test/unit/test_io.c"
...
, 2 > 1 ? 1 : 0), 
# 42 "project/radare2/test/unit/test_io.c"
"%s: expected ", "IO read after cache invalidate doesn't match expected output"
# 42 "project/radare2/test/unit/test_io.c" 3 4
)
# 42 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (sizeof (buf))); _meqstr_len = strlen (_meqstr); 
...
# 44 "project/radare2/test/unit/test_io.c" 3 4
__builtin___memset_chk (
# 44 "project/radare2/test/unit/test_io.c"
buf
# 44 "project/radare2/test/unit/test_io.c" 3 4
, 
# 44 "project/radare2/test/unit/test_io.c"
...
# 44 "project/radare2/test/unit/test_io.c"
 ...
 r_io_read_at (io, 0, buf, sizeof (buf));
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 47 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 47 "project/radare2/test/unit/test_io.c"
*act__ = (buf); const 
# 47 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 47 "project/radare2/test/unit/test_io.c"
...
, 2 > 1 ? 1 : 0), 
# 47 "project/radare2/test/unit/test_io.c"
"%s: expected ", "IO read after cache commit doesn't match expected output"
# 47 "project/radare2/test/unit/test_io.c" 3 4
)
# 47 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (sizeof (buf))); _meqstr_len = strlen (_meqstr); 
...
# 52 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 52 "project/radare2/test/unit/test_io.c"
    test_r_io_mapsplit (void) {
 RIO *io = r_io_new ();
 io->va = 
# 54 "project/radare2/test/unit/test_io.c" 3 4
         1
# 54 "project/radare2/test/unit/test_io.c"
             ;
 r_io_open_at (io, "null://2", 
# 55 "project/radare2/test/unit/test_io.c" 3 4
                              4
# 55 "project/radare2/test/unit/test_io.c"
                                      , 0LL, 
# 55 "project/radare2/test/unit/test_io.c" 3 4
...
# 55 "project/radare2/test/unit/test_io.c"
 ...
 do { 
# 56 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 56 "project/radare2/test/unit/test_io.c"
act__ = (r_io_map_is_mapped (io, 0x0)); if (!(act__)) { char _meqstr[5120]; 
# 56 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 56 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 56 "project/radare2/test/unit/test_io.c"
"%s: expected true, got false", ("0x0 not mapped")
# 56 "project/radare2/test/unit/test_io.c" 3 4
)
# 56 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
# 56 "project/radare2/test/unit/test_io.c"
 ...
 do { 
# 57 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 57 "project/radare2/test/unit/test_io.c"
act__ = (r_io_map_is_mapped (io, 
# 57 "project/radare2/test/unit/test_io.c" 3 4
0xFFFFFFFFFFFFFFFFULL
# 57 "project/radare2/test/unit/test_io.c"
)); if (!(act__)) { char _meqstr[5120]; 
# 57 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 57 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 57 "project/radare2/test/unit/test_io.c"
"%s: expected true, got false", ("UT64_MAX not mapped")
# 57 "project/radare2/test/unit/test_io.c" 3 4
)
# 57 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
# 57 "project/radare2/test/unit/test_io.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (r_io_map_get_at (io, 0x0)); 
# 58 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 58 "project/radare2/test/unit/test_io.c"
_meqstr
# 58 "project/radare2/test/unit/test_io.c" 3 4
, 
# 58 "project/radare2/test/unit/test_io.c"
...
, 2 > 1 ? 1 : 0), 
# 58 "project/radare2/test/unit/test_io.c"
"%s: expected to not be NULL but it was.", ("Found no map at 0x0")
# 58 "project/radare2/test/unit/test_io.c" 3 4
)
# 58 "project/radare2/test/unit/test_io.c"
; do { if (!((act__) != 
...
# 58 "project/radare2/test/unit/test_io.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (r_io_map_get_at (io, 
# 59 "project/radare2/test/unit/test_io.c" 3 4
0xFFFFFFFFFFFFFFFFULL
# 59 "project/radare2/test/unit/test_io.c"
)); 
# 59 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 59 "project/radare2/test/unit/test_io.c"
...
, 2 > 1 ? 1 : 0), 
# 59 "project/radare2/test/unit/test_io.c"
"%s: expected to not be NULL but it was.", ("Found no map at UT64_MAX")
# 59 "project/radare2/test/unit/test_io.c" 3 4
)
# 59 "project/radare2/test/unit/test_io.c"
; do { if (!((act__) != 
...
((void *)0)
# 59 "project/radare2/test/unit/test_io.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 59, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 59, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 r_io_free (io);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}


# 64 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 64 "project/radare2/test/unit/test_io.c"
    test_r_io_mapsplit2 (void) {
 RIO *io = r_io_new ();
 io->va = 
# 66 "project/radare2/test/unit/test_io.c" 3 4
         1
# 66 "project/radare2/test/unit/test_io.c"
             ;
 r_io_open_at (io, "null://2", 
# 67 "project/radare2/test/unit/test_io.c" 3 4
                              4
# 67 "project/radare2/test/unit/test_io.c"
                                      , 0LL, 0LL);
 do { 
# 68 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 68 "project/radare2/test/unit/test_io.c"
act__ = (r_io_map_is_mapped (io, 0x0)); if (!(act__)) { char _meqstr[5120]; 
# 68 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 68 "project/radare2/test/unit/test_io.c"
...
0
# 68 "project/radare2/test/unit/test_io.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 68, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 68, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while (0);
 do { 
# 69 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 69 "project/radare2/test/unit/test_io.c"
act__ = (r_io_map_is_mapped (io, 0x1)); if (!(act__)) { char _meqstr[5120]; 
# 69 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 69 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 69 "project/radare2/test/unit/test_io.c"
"%s: expected true, got false", ("0x1 not mapped")
# 69 "project/radare2/test/unit/test_io.c" 3 4
)
# 69 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
# 69 "project/radare2/test/unit/test_io.c"
 ...
 r_io_map_remap (io, r_io_map_get_at (io, 0LL)->id, 
# 70 "project/radare2/test/unit/test_io.c" 3 4
                                                   0xFFFFFFFFFFFFFFFFULL
# 70 "project/radare2/test/unit/test_io.c"
                                                           );
 do { 
# 71 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 71 "project/radare2/test/unit/test_io.c"
act__ = (r_io_map_is_mapped (io, 0x0)); if (!(act__)) { char _meqstr[5120]; 
# 71 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 71 "project/radare2/test/unit/test_io.c"
...
# 71 "project/radare2/test/unit/test_io.c"
 ...
 do { 
# 72 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 72 "project/radare2/test/unit/test_io.c"
act__ = (r_io_map_is_mapped (io, 
# 72 "project/radare2/test/unit/test_io.c" 3 4
0xFFFFFFFFFFFFFFFFULL
# 72 "project/radare2/test/unit/test_io.c"
...
# 72 "project/radare2/test/unit/test_io.c"
 ...
 do { 
# 73 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 73 "project/radare2/test/unit/test_io.c"
act__ = (r_io_map_is_mapped (io, 0x1)); if ((act__)) { char _meqstr[5120]; 
# 73 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 73 "project/radare2/test/unit/test_io.c"
...
, 2 > 1 ? 1 : 0), 
# 73 "project/radare2/test/unit/test_io.c"
"%s: expected false, got true", ("0x1 mapped")
# 73 "project/radare2/test/unit/test_io.c" 3 4
)
# 73 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
0
# 73 "project/radare2/test/unit/test_io.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 73, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 73, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while (0);
 do { char _meqstr[5120]; const void *act__ = (r_io_map_get_at (io, 0x0)); 
# 74 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 74 "project/radare2/test/unit/test_io.c"
_meqstr
# 74 "project/radare2/test/unit/test_io.c" 3 4
, 
# 74 "project/radare2/test/unit/test_io.c"
...
((void *)0)
# 74 "project/radare2/test/unit/test_io.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 74, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 74, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 do { char _meqstr[5120]; const void *act__ = (r_io_map_get_at (io, 
# 75 "project/radare2/test/unit/test_io.c" 3 4
0xFFFFFFFFFFFFFFFFULL
# 75 "project/radare2/test/unit/test_io.c"
)); 
# 75 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 75 "project/radare2/test/unit/test_io.c"
...
# 75 "project/radare2/test/unit/test_io.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (r_io_map_get_at (io, 0x1)); 
# 76 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 76 "project/radare2/test/unit/test_io.c"
_meqstr
# 76 "project/radare2/test/unit/test_io.c" 3 4
, 
# 76 "project/radare2/test/unit/test_io.c"
...
, 2 > 1 ? 1 : 0), 
# 76 "project/radare2/test/unit/test_io.c"
"%s: expected to be NULL but it wasn't.", ("Found map at 0x1")
# 76 "project/radare2/test/unit/test_io.c" 3 4
)
# 76 "project/radare2/test/unit/test_io.c"
; do { if (!((act__) == 
...
((void *)0)
# 76 "project/radare2/test/unit/test_io.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 76, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 76, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 r_io_free (io);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}


# 81 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 81 "project/radare2/test/unit/test_io.c"
    test_r_io_mapsplit3 (void) {
 RIO *io = r_io_new ();
 io->va = 
# 83 "project/radare2/test/unit/test_io.c" 3 4
         1
# 83 "project/radare2/test/unit/test_io.c"
             ;
 r_io_open_at (io, "null://2", 
# 84 "project/radare2/test/unit/test_io.c" 3 4
                              4
# 84 "project/radare2/test/unit/test_io.c"
                                      , 0LL, 
# 84 "project/radare2/test/unit/test_io.c" 3 4
                                             0xFFFFFFFFFFFFFFFFULL 
# 84 "project/radare2/test/unit/test_io.c"
                                                      - 1);
 do { 
# 85 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 85 "project/radare2/test/unit/test_io.c"
act__ = (r_io_map_is_mapped (io, 
# 85 "project/radare2/test/unit/test_io.c" 3 4
0xFFFFFFFFFFFFFFFFULL 
# 85 "project/radare2/test/unit/test_io.c"
- 1)); if (!(act__)) { char _meqstr[5120]; 
# 85 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 85 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 85 "project/radare2/test/unit/test_io.c"
"%s: expected true, got false", ("UT64_MAX - 1 not mapped")
# 85 "project/radare2/test/unit/test_io.c" 3 4
)
# 85 "project/radare2/test/unit/test_io.c"
; do { if (!(
...
0
# 85 "project/radare2/test/unit/test_io.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 85, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 85, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } } while (0);
 do { 
# 86 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 86 "project/radare2/test/unit/test_io.c"
act__ = (r_io_map_is_mapped (io, 
# 86 "project/radare2/test/unit/test_io.c" 3 4
0xFFFFFFFFFFFFFFFFULL
# 86 "project/radare2/test/unit/test_io.c"
...
# 86 "project/radare2/test/unit/test_io.c"
 ...
 r_io_map_resize (io, r_io_map_get_at (io, 
# 87 "project/radare2/test/unit/test_io.c" 3 4
                                          0xFFFFFFFFFFFFFFFFULL
# 87 "project/radare2/test/unit/test_io.c"
                                                  )->id, 3);
 do { 
# 88 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 88 "project/radare2/test/unit/test_io.c"
act__ = (r_io_map_is_mapped (io, 
# 88 "project/radare2/test/unit/test_io.c" 3 4
0xFFFFFFFFFFFFFFFFULL 
# 88 "project/radare2/test/unit/test_io.c"
...
# 88 "project/radare2/test/unit/test_io.c"
 ...
 do { 
# 89 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 89 "project/radare2/test/unit/test_io.c"
act__ = (r_io_map_is_mapped (io, 
# 89 "project/radare2/test/unit/test_io.c" 3 4
0xFFFFFFFFFFFFFFFFULL
# 89 "project/radare2/test/unit/test_io.c"
...
# 89 "project/radare2/test/unit/test_io.c"
 ...
 do { 
# 90 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 90 "project/radare2/test/unit/test_io.c"
act__ = (r_io_map_is_mapped (io, 0x0)); if (!(act__)) { char _meqstr[5120]; 
# 90 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 90 "project/radare2/test/unit/test_io.c"
...
# 90 "project/radare2/test/unit/test_io.c"
 ...
 do { 
# 91 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 91 "project/radare2/test/unit/test_io.c"
act__ = (r_io_map_is_mapped (io, 0x1)); if ((act__)) { char _meqstr[5120]; 
# 91 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 91 "project/radare2/test/unit/test_io.c"
...
# 91 "project/radare2/test/unit/test_io.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (r_io_map_get_at (io, 
# 92 "project/radare2/test/unit/test_io.c" 3 4
0xFFFFFFFFFFFFFFFFULL
# 92 "project/radare2/test/unit/test_io.c"
)); 
# 92 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 92 "project/radare2/test/unit/test_io.c"
...
# 92 "project/radare2/test/unit/test_io.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (r_io_map_get_at (io, 0x0)); 
# 93 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 93 "project/radare2/test/unit/test_io.c"
_meqstr
# 93 "project/radare2/test/unit/test_io.c" 3 4
, 
# 93 "project/radare2/test/unit/test_io.c"
...
# 98 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 98 "project/radare2/test/unit/test_io.c"
    test_r_io_pcache (void) {
 RIO *io = r_io_new ();
 io->ff = 1;
 
# 101 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 101 "project/radare2/test/unit/test_io.c"
    buf[8];
 int fd = r_io_fd_open (io, "malloc://3", 
# 102 "project/radare2/test/unit/test_io.c" 3 4
                                         (4|2)
# 102 "project/radare2/test/unit/test_io.c"
                                                  , 0);
 r_io_map_add (io, fd, 
# 103 "project/radare2/test/unit/test_io.c" 3 4
                      (4|2)
# 103 "project/radare2/test/unit/test_io.c"
                               , 0LL, 0LL, 1);
 r_io_map_add (io, fd, 
# 104 "project/radare2/test/unit/test_io.c" 3 4
                      (4|2)
# 104 "project/radare2/test/unit/test_io.c"
                               , 1, 1, 1);
 r_io_map_add (io, fd, 
# 105 "project/radare2/test/unit/test_io.c" 3 4
                      (4|2)
# 105 "project/radare2/test/unit/test_io.c"
                               , 1, 2, 1);
 r_io_map_add (io, fd, 
# 106 "project/radare2/test/unit/test_io.c" 3 4
                      (4|2)
# 106 "project/radare2/test/unit/test_io.c"
                               , 1, 3, 1);
 r_io_map_add (io, fd, 
# 107 "project/radare2/test/unit/test_io.c" 3 4
                      (4|2)
# 107 "project/radare2/test/unit/test_io.c"
                               , 1, 4, 1);
 r_io_map_add (io, fd, 
# 108 "project/radare2/test/unit/test_io.c" 3 4
                      (4|2)
# 108 "project/radare2/test/unit/test_io.c"
                               , 1, 5, 1);
 r_io_map_add (io, fd, 
# 109 "project/radare2/test/unit/test_io.c" 3 4
                      (4|2)
# 109 "project/radare2/test/unit/test_io.c"
                               , 2, 6, 1);
 io->p_cache = 2;
 io->va = 
# 111 "project/radare2/test/unit/test_io.c" 3 4
         1
# 111 "project/radare2/test/unit/test_io.c"
             ;
 r_io_fd_write_at (io, fd, 0, (const 
# 112 "project/radare2/test/unit/test_io.c" 3 4
                                    unsigned char
# 112 "project/radare2/test/unit/test_io.c"
                                       *)"8=D", 3);
 r_io_read_at (io, 0x0, buf, 8);
 do { char _meqstr[5120]; const char *act__ = ((const char *)buf); const char *exp__ = (""); 
# 114 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 114 "project/radare2/test/unit/test_io.c"
_meqstr
# 114 "project/radare2/test/unit/test_io.c" 3 4
, 
# 114 "project/radare2/test/unit/test_io.c"
...
, 2 > 1 ? 1 : 0), 
# 114 "project/radare2/test/unit/test_io.c"
"%s: expected %s, got %s.", ("pcache read happened, but it shouldn't"), (exp__), (act__)
# 114 "project/radare2/test/unit/test_io.c" 3 4
)
# 114 "project/radare2/test/unit/test_io.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 114, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 114, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 io->p_cache = 1;
 r_io_read_at (io, 0x0, buf, 8);
 do { char _meqstr[5120]; const char *act__ = ((const char *)buf); const char *exp__ = ("8=====D"); 
# 117 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 117 "project/radare2/test/unit/test_io.c"
_meqstr
# 117 "project/radare2/test/unit/test_io.c" 3 4
, 
# 117 "project/radare2/test/unit/test_io.c"
...
, 2 > 1 ? 1 : 0), 
# 117 "project/radare2/test/unit/test_io.c"
"%s: expected %s, got %s.", ("expected an ascii-pn from pcache"), (exp__), (act__)
# 117 "project/radare2/test/unit/test_io.c" 3 4
)
# 117 "project/radare2/test/unit/test_io.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 117, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 117, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 r_io_fd_write_at (io, fd, 0, (const 
# 118 "project/radare2/test/unit/test_io.c" 3 4
                                    unsigned char
# 118 "project/radare2/test/unit/test_io.c"
                                       *)"XXX", 3);
 r_io_read_at (io, 0x0, buf, 8);
 do { char _meqstr[5120]; const char *act__ = ((const char *)buf); const char *exp__ = ("8=====D"); 
# 120 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 120 "project/radare2/test/unit/test_io.c"
_meqstr
# 120 "project/radare2/test/unit/test_io.c" 3 4
, 
# 120 "project/radare2/test/unit/test_io.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 120, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 120, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 io->p_cache = 0;
 r_io_read_at (io, 0x0, buf, 8);
 do { char _meqstr[5120]; const char *act__ = ((const char *)buf); const char *exp__ = ("XXXXXXX"); 
# 123 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 123 "project/radare2/test/unit/test_io.c"
_meqstr
# 123 "project/radare2/test/unit/test_io.c" 3 4
, 
# 123 "project/radare2/test/unit/test_io.c"
...
, 2 > 1 ? 1 : 0), 
# 123 "project/radare2/test/unit/test_io.c"
"%s: expected %s, got %s.", ("expected censorship of the ascii-pn"), (exp__), (act__)
# 123 "project/radare2/test/unit/test_io.c" 3 4
)
# 123 "project/radare2/test/unit/test_io.c"
...
# 128 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 128 "project/radare2/test/unit/test_io.c"
    test_r_io_desc_exchange (void) {
 RIO *io = r_io_new ();
 int fd = r_io_fd_open (io, "malloc://3", 
# 130 "project/radare2/test/unit/test_io.c" 3 4
                                         4
# 130 "project/radare2/test/unit/test_io.c"
                                                 , 0),
     fdx = r_io_fd_open (io, "malloc://6", 
# 131 "project/radare2/test/unit/test_io.c" 3 4
                                          4
# 131 "project/radare2/test/unit/test_io.c"
                                                  , 0);
 r_io_desc_exchange (io, fd, fdx);
 do { if (!((r_io_fd_size (io, fd) == 6))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 133, "Desc-exchange is broken"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 133, "Desc-exchange is broken"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 r_io_free (io);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}


# 138 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 138 "project/radare2/test/unit/test_io.c"
    test_va_malloc_zero(void) {
 RIO *io;
 
# 140 "project/radare2/test/unit/test_io.c" 3 4
unsigned long long 
# 140 "project/radare2/test/unit/test_io.c"
     buf;
 
# 141 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 141 "project/radare2/test/unit/test_io.c"
     ret;

 io = r_io_new ();
 io->va = 
# 144 "project/radare2/test/unit/test_io.c" 3 4
         0
# 144 "project/radare2/test/unit/test_io.c"
              ;
 r_io_open_at (io, "malloc://8", 
# 145 "project/radare2/test/unit/test_io.c" 3 4
                                (4|2)
# 145 "project/radare2/test/unit/test_io.c"
                                         , 0644, 0x0);
 buf = 0xdeadbeefcafebabe;
 ret = r_io_read_at (io, 0, (
# 147 "project/radare2/test/unit/test_io.c" 3 4
                            unsigned char 
# 147 "project/radare2/test/unit/test_io.c"
                                *)&buf, 8);
 do { if (!(ret)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 148, "should be able to read"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 148, "should be able to read"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 149 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 149 "project/radare2/test/unit/test_io.c"
*act__ = ((
# 149 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 149 "project/radare2/test/unit/test_io.c"
...
, 2 > 1 ? 1 : 0), 
# 149 "project/radare2/test/unit/test_io.c"
"%s: expected ", "0 should be there initially"
# 149 "project/radare2/test/unit/test_io.c" 3 4
)
# 149 "project/radare2/test/unit/test_io.c"
...
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (8)); do { if (!(memcmp((exp__), (act__), (8)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 149, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 149, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 io = r_io_new ();
 io->va = 
# 153 "project/radare2/test/unit/test_io.c" 3 4
         1
# 153 "project/radare2/test/unit/test_io.c"
             ;
 r_io_open_at (io, "malloc://8", 
# 154 "project/radare2/test/unit/test_io.c" 3 4
                                (4|2)
# 154 "project/radare2/test/unit/test_io.c"
                                         , 0644, 0x0);
 buf = 0xdeadbeefcafebabe;
 ret = r_io_read_at (io, 0, (
# 156 "project/radare2/test/unit/test_io.c" 3 4
                            unsigned char 
# 156 "project/radare2/test/unit/test_io.c"
                                *)&buf, 8);
 do { if (!(ret)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 157, "should be able to read"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 157, "should be able to read"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 mu_test_status = 1;
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 159 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 159 "project/radare2/test/unit/test_io.c"
*act__ = ((
# 159 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 159 "project/radare2/test/unit/test_io.c"
...
# 165 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 165 "project/radare2/test/unit/test_io.c"
    test_r_io_priority(void) {
 RIO *io = r_io_new();
 
# 167 "project/radare2/test/unit/test_io.c" 3 4
unsigned int 
# 167 "project/radare2/test/unit/test_io.c"
     map0, map1, map_big;
 
# 168 "project/radare2/test/unit/test_io.c" 3 4
unsigned long long 
# 168 "project/radare2/test/unit/test_io.c"
     buf;
 
# 169 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 169 "project/radare2/test/unit/test_io.c"
     ret;

 io->va = 
# 171 "project/radare2/test/unit/test_io.c" 3 4
         1
# 171 "project/radare2/test/unit/test_io.c"
             ;
 r_io_open_at (io, "malloc://8", 
# 172 "project/radare2/test/unit/test_io.c" 3 4
                                (4|2)
# 172 "project/radare2/test/unit/test_io.c"
                                         , 0644, 0x0);
 map0 = r_io_map_get_at (io, 0)->id;
 ret = r_io_read_at (io, 0, (
# 174 "project/radare2/test/unit/test_io.c" 3 4
                            unsigned char 
# 174 "project/radare2/test/unit/test_io.c"
                                *)&buf, 8);
 do { if (!(ret)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 175, "should be able to read"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 175, "should be able to read"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 176 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 176 "project/radare2/test/unit/test_io.c"
*act__ = ((
# 176 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 176 "project/radare2/test/unit/test_io.c"
...
# 176 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (8)); do { if (!(memcmp((exp__), (act__), (8)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 176, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 176, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 buf = 0x9090909090909090;
 r_io_write_at (io, 0, (
# 178 "project/radare2/test/unit/test_io.c" 3 4
                       unsigned char 
# 178 "project/radare2/test/unit/test_io.c"
                           *)&buf, 8);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 179 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 179 "project/radare2/test/unit/test_io.c"
*act__ = ((
# 179 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 179 "project/radare2/test/unit/test_io.c"
...
, 2 > 1 ? 1 : 0), 
# 179 "project/radare2/test/unit/test_io.c"
"%s: expected ", "0x90 should have been written"
# 179 "project/radare2/test/unit/test_io.c" 3 4
)
# 179 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (8)); _meqstr_len = strlen (_meqstr); 
...
# 179 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (8)); do { if (!(memcmp((exp__), (act__), (8)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 179, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 179, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 r_io_open_at (io, "malloc://2", 
# 181 "project/radare2/test/unit/test_io.c" 3 4
                                (4|2)
# 181 "project/radare2/test/unit/test_io.c"
                                         , 0644, 0x4);
 map1 = r_io_map_get_at (io, 4)->id;
 r_io_read_at (io, 0, (
# 183 "project/radare2/test/unit/test_io.c" 3 4
                      unsigned char 
# 183 "project/radare2/test/unit/test_io.c"
                          *)&buf, 8);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 184 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 184 "project/radare2/test/unit/test_io.c"
*act__ = ((
# 184 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 184 "project/radare2/test/unit/test_io.c"
...
unsigned char 
# 184 "project/radare2/test/unit/test_io.c"
*)"\x90\x90\x90\x90\x00\x00\x90\x90"); 
# 184 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 184 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 184 "project/radare2/test/unit/test_io.c"
"%s: expected ", "0x00 from map1 should overlap"
# 184 "project/radare2/test/unit/test_io.c" 3 4
)
# 184 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (8)); _meqstr_len = strlen (_meqstr); 
...
# 184 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (8)); do { if (!(memcmp((exp__), (act__), (8)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 184, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 184, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 buf ^= 
# 186 "project/radare2/test/unit/test_io.c" 3 4
       0xFFFFFFFFFFFFFFFFULL
# 186 "project/radare2/test/unit/test_io.c"
               ;
 r_io_write_at (io, 0, (
# 187 "project/radare2/test/unit/test_io.c" 3 4
                       unsigned char 
# 187 "project/radare2/test/unit/test_io.c"
                           *)&buf, 8);
 r_io_read_at (io, 0, (
# 188 "project/radare2/test/unit/test_io.c" 3 4
                      unsigned char 
# 188 "project/radare2/test/unit/test_io.c"
                          *)&buf, 8);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 189 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 189 "project/radare2/test/unit/test_io.c"
*act__ = ((
# 189 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 189 "project/radare2/test/unit/test_io.c"
...
unsigned char 
# 189 "project/radare2/test/unit/test_io.c"
*)"\x6f\x6f\x6f\x6f\xff\xff\x6f\x6f"); 
# 189 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 189 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 189 "project/radare2/test/unit/test_io.c"
"%s: expected ", "memory has been xored"
# 189 "project/radare2/test/unit/test_io.c" 3 4
)
# 189 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (8)); _meqstr_len = strlen (_meqstr); 
...
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (8)); do { if (!(memcmp((exp__), (act__), (8)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 189, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 189, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r_io_read_at (io, 0, (
# 192 "project/radare2/test/unit/test_io.c" 3 4
                      unsigned char 
# 192 "project/radare2/test/unit/test_io.c"
                          *)&buf, 8);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 193 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 193 "project/radare2/test/unit/test_io.c"
*act__ = ((
# 193 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 193 "project/radare2/test/unit/test_io.c"
...
unsigned char 
# 193 "project/radare2/test/unit/test_io.c"
*)"\x6f\x6f\x6f\x6f\x90\x90\x6f\x6f"); 
# 193 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 193 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 193 "project/radare2/test/unit/test_io.c"
"%s: expected ", "map0 should have been prioritized"
# 193 "project/radare2/test/unit/test_io.c" 3 4
)
# 193 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (8)); _meqstr_len = strlen (_meqstr); 
...
# 193 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (8)); do { if (!(memcmp((exp__), (act__), (8)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 193, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 193, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 r_io_map_remap (io, map1, 0x2);
 r_io_read_at (io, 0, (
# 196 "project/radare2/test/unit/test_io.c" 3 4
                      unsigned char 
# 196 "project/radare2/test/unit/test_io.c"
                          *)&buf, 8);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 197 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 197 "project/radare2/test/unit/test_io.c"
*act__ = ((
# 197 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 197 "project/radare2/test/unit/test_io.c"
...
, 2 > 1 ? 1 : 0), 
# 197 "project/radare2/test/unit/test_io.c"
"%s: expected ", "map1 should have been remapped"
# 197 "project/radare2/test/unit/test_io.c" 3 4
)
# 197 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (8)); _meqstr_len = strlen (_meqstr); 
...
# 197 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (8)); do { if (!(memcmp((exp__), (act__), (8)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 197, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 197, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 r_io_map_priorize (io, map1);
 r_io_read_at (io, 0, (
# 200 "project/radare2/test/unit/test_io.c" 3 4
                      unsigned char 
# 200 "project/radare2/test/unit/test_io.c"
                          *)&buf, 8);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 201 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 201 "project/radare2/test/unit/test_io.c"
*act__ = ((
# 201 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 201 "project/radare2/test/unit/test_io.c"
...
unsigned char 
# 201 "project/radare2/test/unit/test_io.c"
*)"\x6f\x6f\xff\xff\x90\x90\x6f\x6f"); 
# 201 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 201 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 201 "project/radare2/test/unit/test_io.c"
"%s: expected ", "map1 should have been prioritized"
# 201 "project/radare2/test/unit/test_io.c" 3 4
)
# 201 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (8)); _meqstr_len = strlen (_meqstr); 
...
# 201 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (8)); do { if (!(memcmp((exp__), (act__), (8)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 201, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 201, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 r_io_open_at (io, "malloc://2", 
# 203 "project/radare2/test/unit/test_io.c" 3 4
                                (4|2)
# 203 "project/radare2/test/unit/test_io.c"
                                         , 0644, 0x0);
 r_io_read_at (io, 0, (
# 204 "project/radare2/test/unit/test_io.c" 3 4
                      unsigned char 
# 204 "project/radare2/test/unit/test_io.c"
                          *)&buf, 8);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 205 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 205 "project/radare2/test/unit/test_io.c"
*act__ = ((
# 205 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 205 "project/radare2/test/unit/test_io.c"
...
unsigned char 
# 205 "project/radare2/test/unit/test_io.c"
*)"\x00\x00\xff\xff\x90\x90\x6f\x6f"); 
# 205 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 205 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 205 "project/radare2/test/unit/test_io.c"
"%s: expected ", "0x00 from map2 at start should overlap"
# 205 "project/radare2/test/unit/test_io.c" 3 4
)
# 205 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (8)); _meqstr_len = strlen (_meqstr); 
...
# 205 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (8)); do { if (!(memcmp((exp__), (act__), (8)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 205, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 205, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 r_io_map_remap (io, map1, 0x1);
 r_io_read_at (io, 0, (
# 208 "project/radare2/test/unit/test_io.c" 3 4
                      unsigned char 
# 208 "project/radare2/test/unit/test_io.c"
                          *)&buf, 8);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 209 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 209 "project/radare2/test/unit/test_io.c"
*act__ = ((
# 209 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 209 "project/radare2/test/unit/test_io.c"
...
unsigned char 
# 209 "project/radare2/test/unit/test_io.c"
*)"\x00\x00\xff\x6f\x90\x90\x6f\x6f"); 
# 209 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 209 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 209 "project/radare2/test/unit/test_io.c"
"%s: expected ", "map1 should have been remapped and partialy hidden"
# 209 "project/radare2/test/unit/test_io.c" 3 4
)
# 209 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (8)); _meqstr_len = strlen (_meqstr); 
...
# 209 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (8)); do { if (!(memcmp((exp__), (act__), (8)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 209, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 209, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 r_io_open_at (io, "malloc://2", 
# 211 "project/radare2/test/unit/test_io.c" 3 4
                                (4|2)
# 211 "project/radare2/test/unit/test_io.c"
                                         , 0644, 0x4);
 r_io_open_at (io, "malloc://2", 
# 212 "project/radare2/test/unit/test_io.c" 3 4
                                (4|2)
# 212 "project/radare2/test/unit/test_io.c"
                                         , 0644, 0x6);
 r_io_read_at (io, 0, (
# 213 "project/radare2/test/unit/test_io.c" 3 4
                      unsigned char 
# 213 "project/radare2/test/unit/test_io.c"
                          *)&buf, 8);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 214 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 214 "project/radare2/test/unit/test_io.c"
*act__ = ((
# 214 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 214 "project/radare2/test/unit/test_io.c"
...
unsigned char 
# 214 "project/radare2/test/unit/test_io.c"
*)"\x00\x00\xff\x6f\x00\x00\x00\x00"); 
# 214 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 214 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 214 "project/radare2/test/unit/test_io.c"
"%s: expected ", "Multiple maps opened"
# 214 "project/radare2/test/unit/test_io.c" 3 4
)
# 214 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (8)); _meqstr_len = strlen (_meqstr); 
...
# 214 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (8)); do { if (!(memcmp((exp__), (act__), (8)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 214, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 214, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 buf = 0x9090909090909090;
 r_io_open_at (io, "malloc://8", 
# 217 "project/radare2/test/unit/test_io.c" 3 4
                                (4|2)
# 217 "project/radare2/test/unit/test_io.c"
                                         , 0644, 0x10);
 map_big = r_io_map_get_at (io, 0x10)->id;
 r_io_write_at (io, 0x10, (
# 219 "project/radare2/test/unit/test_io.c" 3 4
                          unsigned char 
# 219 "project/radare2/test/unit/test_io.c"
                              *)&buf, 8);
 r_io_map_remap (io, map_big, 0x1);
 r_io_read_at (io, 0, (
# 221 "project/radare2/test/unit/test_io.c" 3 4
                      unsigned char 
# 221 "project/radare2/test/unit/test_io.c"
                          *)&buf, 8);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 222 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 222 "project/radare2/test/unit/test_io.c"
*act__ = ((
# 222 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 222 "project/radare2/test/unit/test_io.c"
...
unsigned char 
# 222 "project/radare2/test/unit/test_io.c"
*)"\x00\x90\x90\x90\x90\x90\x90\x90"); 
# 222 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 222 "project/radare2/test/unit/test_io.c"
_meqstr
...
, 2 > 1 ? 1 : 0), 
# 222 "project/radare2/test/unit/test_io.c"
"%s: expected ", "map_big should cover everything from 0x1"
# 222 "project/radare2/test/unit/test_io.c" 3 4
)
# 222 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (8)); _meqstr_len = strlen (_meqstr); 
...
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (8)); do { if (!(memcmp((exp__), (act__), (8)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 222, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 222, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r_io_read_at (io, 0, (
# 226 "project/radare2/test/unit/test_io.c" 3 4
                      unsigned char 
# 226 "project/radare2/test/unit/test_io.c"
                          *)&buf, 8);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 227 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 227 "project/radare2/test/unit/test_io.c"
*act__ = ((
# 227 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 227 "project/radare2/test/unit/test_io.c"
...
, 2 > 1 ? 1 : 0), 
# 227 "project/radare2/test/unit/test_io.c"
"%s: expected ", "map_big should cover everything"
# 227 "project/radare2/test/unit/test_io.c" 3 4
)
# 227 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (8)); _meqstr_len = strlen (_meqstr); 
...
# 227 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (8)); do { if (!(memcmp((exp__), (act__), (8)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 227, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 227, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
...
# 233 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 233 "project/radare2/test/unit/test_io.c"
    test_r_io_priority2(void) {
 RIO *io = r_io_new();
 
# 235 "project/radare2/test/unit/test_io.c" 3 4
unsigned int 
# 235 "project/radare2/test/unit/test_io.c"
     map0;
 
# 236 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 236 "project/radare2/test/unit/test_io.c"
    buf[2];
 
# 237 "project/radare2/test/unit/test_io.c" 3 4
_Bool 
# 237 "project/radare2/test/unit/test_io.c"
     ret;

 io->va = 
# 239 "project/radare2/test/unit/test_io.c" 3 4
         1
# 239 "project/radare2/test/unit/test_io.c"
             ;
 RIODesc *desc0 = r_io_open_at (io, "malloc://1024", 
# 240 "project/radare2/test/unit/test_io.c" 3 4
                                                    (4|2)
# 240 "project/radare2/test/unit/test_io.c"
                                                             , 0644, 0x0);
 do { char _meqstr[5120]; const void *act__ = (desc0); 
# 241 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 241 "project/radare2/test/unit/test_io.c"
_meqstr
# 241 "project/radare2/test/unit/test_io.c" 3 4
, 
# 241 "project/radare2/test/unit/test_io.c"
...
, 2 > 1 ? 1 : 0), 
# 241 "project/radare2/test/unit/test_io.c"
"%s: expected to not be NULL but it was.", ("first malloc should be opened")
# 241 "project/radare2/test/unit/test_io.c" 3 4
)
# 241 "project/radare2/test/unit/test_io.c"
; do { if (!((act__) != 
...
((void *)0)
# 241 "project/radare2/test/unit/test_io.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 241, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 241, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 map0 = r_io_map_get_at (io, 0)->id;
 ret = r_io_read_at (io, 0, (
# 243 "project/radare2/test/unit/test_io.c" 3 4
                            unsigned char 
# 243 "project/radare2/test/unit/test_io.c"
                                *)&buf, 2);
 do { if (!(ret)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 244, "should be able to read"); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 244, "should be able to read"); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 245 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 245 "project/radare2/test/unit/test_io.c"
*act__ = (buf); const 
# 245 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 245 "project/radare2/test/unit/test_io.c"
...
# 245 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (2)); _meqstr_len = strlen (_meqstr); 
# 245 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 245 "project/radare2/test/unit/test_io.c"
_meqstr + _meqstr_len
...
# 245 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (2)); do { if (!(memcmp((exp__), (act__), (2)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 245, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 245, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 r_io_write_at (io, 0, (const 
# 246 "project/radare2/test/unit/test_io.c" 3 4
                             unsigned char 
# 246 "project/radare2/test/unit/test_io.c"
                                 *)"\x90\x90", 2);
 r_io_read_at (io, 0, buf, 2);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 248 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 248 "project/radare2/test/unit/test_io.c"
*act__ = (buf); const 
# 248 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 248 "project/radare2/test/unit/test_io.c"
...
# 248 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (2)); do { if (!(memcmp((exp__), (act__), (2)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 248, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 248, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);

 RIODesc *desc1 = r_io_open_at (io, "malloc://1024", 
# 250 "project/radare2/test/unit/test_io.c" 3 4
                                                    4
# 250 "project/radare2/test/unit/test_io.c"
                                                            , 0644, 0x0);
 do { char _meqstr[5120]; const void *act__ = (desc1); 
# 251 "project/radare2/test/unit/test_io.c" 3 4
__builtin___snprintf_chk (
# 251 "project/radare2/test/unit/test_io.c"
_meqstr
# 251 "project/radare2/test/unit/test_io.c" 3 4
, 
# 251 "project/radare2/test/unit/test_io.c"
...
, 2 > 1 ? 1 : 0), 
# 251 "project/radare2/test/unit/test_io.c"
"%s: expected to not be NULL but it was.", ("second malloc should be opened")
# 251 "project/radare2/test/unit/test_io.c" 3 4
)
# 251 "project/radare2/test/unit/test_io.c"
; do { if (!((act__) != 
...
((void *)0)
# 251 "project/radare2/test/unit/test_io.c"
)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 251, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 251, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 r_io_read_at (io, 0, buf, 2);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 253 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 253 "project/radare2/test/unit/test_io.c"
*act__ = (buf); const 
# 253 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 253 "project/radare2/test/unit/test_io.c"
...
, 2 > 1 ? 1 : 0), 
# 253 "project/radare2/test/unit/test_io.c"
"%s: expected ", "0x00 from map1 should be on top"
# 253 "project/radare2/test/unit/test_io.c" 3 4
)
# 253 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (2)); _meqstr_len = strlen (_meqstr); 
...
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (2)); do { if (!(memcmp((exp__), (act__), (2)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 253, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 253, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 r_io_read_at (io, 0, buf, 2);
 do { char _meqstr[5120]; size_t _meqstr_len; const 
# 257 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 257 "project/radare2/test/unit/test_io.c"
*act__ = (buf); const 
# 257 "project/radare2/test/unit/test_io.c" 3 4
unsigned char 
# 257 "project/radare2/test/unit/test_io.c"
...
, 2 > 1 ? 1 : 0), 
# 257 "project/radare2/test/unit/test_io.c"
"%s: expected ", "0x90 from map0 should be on top after prioritize"
# 257 "project/radare2/test/unit/test_io.c" 3 4
)
# 257 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (exp__), (2)); _meqstr_len = strlen (_meqstr); 
...
# 257 "project/radare2/test/unit/test_io.c"
; _meqstr_len = strlen (_meqstr); snprint_mem (_meqstr + _meqstr_len, 5120 - _meqstr_len, (act__), (2)); do { if (!(memcmp((exp__), (act__), (2)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 257, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 257, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
...
int all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_io_cache"); result = test_r_io_cache(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_io_mapsplit"); result = test_r_io_mapsplit(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_io_mapsplit2"); result = test_r_io_mapsplit2(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_io_mapsplit3"); result = test_r_io_mapsplit3(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_io_pcache"); result = test_r_io_pcache(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_io_desc_exchange"); result = test_r_io_desc_exchange(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_io_priority"); result = test_r_io_priority(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_io_priority2"); result = test_r_io_priority2(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_va_malloc_zero"); result = test_va_malloc_zero(); tests_run++; tests_passed += result; } while (0);
