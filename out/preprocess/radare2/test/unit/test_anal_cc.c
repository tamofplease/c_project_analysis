# 0 "project/radare2/test/unit/test_anal_cc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/radare2/test/unit/test_anal_cc.c"
...
# 2 "project/radare2/test/unit/test_anal_cc.c" 2
...
# 4 "project/radare2/test/unit/test_anal_cc.c" 2
# 1 "project/radare2/test/unit/test_sdb.h" 1
...
static inline void print_sdb(Sdb *sdb) {
 Sdb *e = sdb_new0 ();
 sdb_diff (e, sdb, diff_cb, 
# 14 "project/radare2/test/unit/test_sdb.h" 3 4
                           ((void *)0)
# 14 "project/radare2/test/unit/test_sdb.h"
                               );
 sdb_free (e);
}
# 5 "project/radare2/test/unit/test_anal_cc.c" 2
...
# 42 "project/radare2/test/unit/test_anal_cc.c" 3 4
_Bool 
# 42 "project/radare2/test/unit/test_anal_cc.c"
    test_r_anal_cc_set() {
 RAnal *anal = ref_anal ();

 Sdb *ref = ref_db ();
 do { if (!(sdb_diff (ref, anal->sdb_cc, diff_cb, 
# 46 "project/radare2/test/unit/test_anal_cc.c" 3 4
((void *)0)
# 46 "project/radare2/test/unit/test_anal_cc.c"
))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 46, ("set cc")); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 46, ("set cc")); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);;
 sdb_free (ref);
...
# 53 "project/radare2/test/unit/test_anal_cc.c" 3 4
_Bool 
# 53 "project/radare2/test/unit/test_anal_cc.c"
    test_r_anal_cc_set_self_err() {
 RAnal *anal = ref_anal_self_err ();

 Sdb *ref = ref_db_self_err ();
 do { if (!(sdb_diff (ref, anal->sdb_cc, diff_cb, 
# 57 "project/radare2/test/unit/test_anal_cc.c" 3 4
((void *)0)
# 57 "project/radare2/test/unit/test_anal_cc.c"
))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 57, ("set cc")); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 57, ("set cc")); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);;
 sdb_free (ref);
...
# 64 "project/radare2/test/unit/test_anal_cc.c" 3 4
_Bool 
# 64 "project/radare2/test/unit/test_anal_cc.c"
    test_r_anal_cc_get() {
 RAnal *anal = ref_anal ();
 char *v = r_anal_cc_get (anal, "sectarian");
 do { char _meqstr[5120]; const char *act__ = (v); const char *exp__ = ("rax sectarian (rdx, rcx, stack);"); 
# 67 "project/radare2/test/unit/test_anal_cc.c" 3 4
__builtin___snprintf_chk (
# 67 "project/radare2/test/unit/test_anal_cc.c"
_meqstr
# 67 "project/radare2/test/unit/test_anal_cc.c" 3 4
, 
# 67 "project/radare2/test/unit/test_anal_cc.c"
...
, 2 > 1 ? 1 : 0), 
# 67 "project/radare2/test/unit/test_anal_cc.c"
"%s: expected %s, got %s.", ("get cc"), (exp__), (act__)
# 67 "project/radare2/test/unit/test_anal_cc.c" 3 4
)
# 67 "project/radare2/test/unit/test_anal_cc.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 67, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 67, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 ...
 do { char _meqstr[5120]; const void *act__ = (vv); 
# 70 "project/radare2/test/unit/test_anal_cc.c" 3 4
__builtin___snprintf_chk (
# 70 "project/radare2/test/unit/test_anal_cc.c"
_meqstr
# 70 "project/radare2/test/unit/test_anal_cc.c" 3 4
, 
# 70 "project/radare2/test/unit/test_anal_cc.c"
...
, 2 > 1 ? 1 : 0), 
# 70 "project/radare2/test/unit/test_anal_cc.c"
"%s: expected to be NULL but it wasn't.", ("get self")
# 70 "project/radare2/test/unit/test_anal_cc.c" 3 4
)
# 70 "project/radare2/test/unit/test_anal_cc.c"
; do { if (!((act__) == 
...
# 70 "project/radare2/test/unit/test_anal_cc.c"
 ...
 do { char _meqstr[5120]; const void *act__ = (vv); 
# 72 "project/radare2/test/unit/test_anal_cc.c" 3 4
__builtin___snprintf_chk (
# 72 "project/radare2/test/unit/test_anal_cc.c"
_meqstr
# 72 "project/radare2/test/unit/test_anal_cc.c" 3 4
, 
# 72 "project/radare2/test/unit/test_anal_cc.c"
...
, 2 > 1 ? 1 : 0), 
# 72 "project/radare2/test/unit/test_anal_cc.c"
"%s: expected to be NULL but it wasn't.", ("get error")
# 72 "project/radare2/test/unit/test_anal_cc.c" 3 4
)
# 72 "project/radare2/test/unit/test_anal_cc.c"
; do { if (!((act__) == 
...
# 77 "project/radare2/test/unit/test_anal_cc.c" 3 4
_Bool 
# 77 "project/radare2/test/unit/test_anal_cc.c"
    test_r_anal_cc_get_self_err() {
 RAnal *anal = ref_anal_self_err ();
 char *v = r_anal_cc_get (anal, "sectarian");
 do { char _meqstr[5120]; const char *act__ = (v); const char *exp__ = ("rax rsi.sectarian (rdx, rcx, stack) rdi;"); 
# 80 "project/radare2/test/unit/test_anal_cc.c" 3 4
__builtin___snprintf_chk (
# 80 "project/radare2/test/unit/test_anal_cc.c"
_meqstr
# 80 "project/radare2/test/unit/test_anal_cc.c" 3 4
, 
# 80 "project/radare2/test/unit/test_anal_cc.c"
...
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 80, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 80, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 free (v);
 const char *vv = r_anal_cc_self (anal, "sectarian");
 do { char _meqstr[5120]; const char *act__ = (vv); const char *exp__ = ("rsi"); 
# 83 "project/radare2/test/unit/test_anal_cc.c" 3 4
__builtin___snprintf_chk (
# 83 "project/radare2/test/unit/test_anal_cc.c"
_meqstr
# 83 "project/radare2/test/unit/test_anal_cc.c" 3 4
, 
# 83 "project/radare2/test/unit/test_anal_cc.c"
...
, 2 > 1 ? 1 : 0), 
# 83 "project/radare2/test/unit/test_anal_cc.c"
"%s: expected %s, got %s.", ("get self"), (exp__), (act__)
# 83 "project/radare2/test/unit/test_anal_cc.c" 3 4
)
# 83 "project/radare2/test/unit/test_anal_cc.c"
; do { if (!(strcmp((exp__), (act__)) == 0)) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 83, _meqstr); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 83, _meqstr); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0); } while(0);
 vv = r_anal_cc_error (anal, "sectarian");
 do { char _meqstr[5120]; const char *act__ = (vv); const char *exp__ = ("rdi"); 
# 85 "project/radare2/test/unit/test_anal_cc.c" 3 4
__builtin___snprintf_chk (
# 85 "project/radare2/test/unit/test_anal_cc.c"
_meqstr
# 85 "project/radare2/test/unit/test_anal_cc.c" 3 4
, 
# 85 "project/radare2/test/unit/test_anal_cc.c"
...
, 2 > 1 ? 1 : 0), 
# 85 "project/radare2/test/unit/test_anal_cc.c"
"%s: expected %s, got %s.", ("get error"), (exp__), (act__)
# 85 "project/radare2/test/unit/test_anal_cc.c" 3 4
)
# 85 "project/radare2/test/unit/test_anal_cc.c"
...
# 90 "project/radare2/test/unit/test_anal_cc.c" 3 4
_Bool 
# 90 "project/radare2/test/unit/test_anal_cc.c"
    test_r_anal_cc_del() {
 RAnal *anal = ref_anal ();
 r_anal_cc_del (anal, "sectarian");
 Sdb *ref = sdb_new0 ();
 do { if (!(sdb_diff (ref, anal->sdb_cc, diff_cb, 
# 94 "project/radare2/test/unit/test_anal_cc.c" 3 4
((void *)0)
# 94 "project/radare2/test/unit/test_anal_cc.c"
))) { do { do { if (mu_test_status != 1) { printf("\x1b[1m" "\x1b[31m" "ERR\n[XX] Fail at line %d: " "\x1b[0m" "%s\n\n", 94, ("deleted")); } else { printf("\x1b[1m" "\x1b[33m" "Broken at line %d: " "\x1b[0m" "%s\n\n", 94, ("deleted")); } } while (0); if (mu_test_status != 1) return 0; } while(0); mu_test_status = 0; } } while (0);;
 sdb_free (ref);
 r_anal_free (anal);
 do { printf("\x1b[32m" "OK\n" "\x1b[0m"); return 1; } while(0);
}
...
# 100 "project/radare2/test/unit/test_anal_cc.c" 3 4
_Bool 
# 100 "project/radare2/test/unit/test_anal_cc.c"
    all_tests() {
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_anal_cc_set"); result = test_r_anal_cc_set(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_anal_cc_set_self_err"); result = test_r_anal_cc_set_self_err(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_anal_cc_get"); result = test_r_anal_cc_get(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_anal_cc_get_self_err"); result = test_r_anal_cc_get_self_err(); tests_run++; tests_passed += result; } while (0);
 do { int result; printf("\x1b[1m" "%s" "\x1b[0m" " ", "test_r_anal_cc_del"); result = test_r_anal_cc_del(); tests_run++; tests_passed += result; } while (0);
