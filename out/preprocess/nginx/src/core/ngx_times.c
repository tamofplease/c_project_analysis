# 0 "project/nginx/src/core/ngx_times.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/core/ngx_times.c"
...
# 9 "project/nginx/src/core/ngx_times.c" 2
...
# 10 "project/nginx/src/core/ngx_times.c" 2



# 12 "project/nginx/src/core/ngx_times.c"
static ngx_msec_t ngx_monotonic_time(time_t sec, ngx_uint_t msec);
# 26 "project/nginx/src/core/ngx_times.c"
...
# 45 "project/nginx/src/core/ngx_times.c"
static ngx_int_t cached_gmtoff;


static ngx_time_t cached_time[64];
static u_char cached_err_log_time[64]
                                    [sizeof("1970/09/28 12:00:00")];
static u_char cached_http_time[64]
                                    [sizeof("Mon, 28 Sep 1970 06:00:00 GMT")];
static u_char cached_http_log_time[64]
                                    [sizeof("28/Sep/1970:12:00:00 +0600")];
static u_char cached_http_log_iso8601[64]
                                    [sizeof("1970-09-28T12:00:00+06:00")];
static u_char cached_syslog_time[64]
...
ngx_time_update(void)
{
    ...
    if (!
# 90 "project/nginx/src/core/ngx_times.c" 3 4
        (*(
# 90 "project/nginx/src/core/ngx_times.c"
        &ngx_time_lock
# 90 "project/nginx/src/core/ngx_times.c" 3 4
...
# 94 "project/nginx/src/core/ngx_times.c" 3 4
   (void) gettimeofday(
# 94 "project/nginx/src/core/ngx_times.c"
   &tv
# 94 "project/nginx/src/core/ngx_times.c" 3 4
   , ((void *)0));
# 94 "project/nginx/src/core/ngx_times.c"
...
# 105 "project/nginx/src/core/ngx_times.c" 3 4
       *(
# 105 "project/nginx/src/core/ngx_times.c"
       &ngx_time_lock
# 105 "project/nginx/src/core/ngx_times.c" 3 4
       ) = 0
# 105 "project/nginx/src/core/ngx_times.c"
    ...
    (void) ngx_sprintf(p0, "%s, %02d %s %4d %02d:%02d:%02d GMT",
                       week[gmt.
# 126 "project/nginx/src/core/ngx_times.c" 3 4
                               tm_wday
# 126 "project/nginx/src/core/ngx_times.c"
                                          ], gmt.
# 126 "project/nginx/src/core/ngx_times.c" 3 4
                                                 tm_mday
# 126 "project/nginx/src/core/ngx_times.c"
                                                            ,
                       months[gmt.
# 127 "project/nginx/src/core/ngx_times.c" 3 4
                                 tm_mon 
# 127 "project/nginx/src/core/ngx_times.c"
                                            - 1], gmt.
# 127 "project/nginx/src/core/ngx_times.c" 3 4
                                                      tm_year
# 127 "project/nginx/src/core/ngx_times.c"
                                                                 ,
                       gmt.
# 128 "project/nginx/src/core/ngx_times.c" 3 4
                          tm_hour
# 128 "project/nginx/src/core/ngx_times.c"
                                     , gmt.
# 128 "project/nginx/src/core/ngx_times.c" 3 4
                                           tm_min
# 128 "project/nginx/src/core/ngx_times.c"
...
# 137 "project/nginx/src/core/ngx_times.c"
    ngx_localtime(sec, &tm);
    cached_gmtoff = (ngx_int_t) (tm.
# 138 "project/nginx/src/core/ngx_times.c" 3 4
                                   tm_gmtoff 
# 138 "project/nginx/src/core/ngx_times.c"
                                                 / 60);
    tp->gmtoff = cached_gmtoff;
# 150 "project/nginx/src/core/ngx_times.c"
    p1 = &cached_err_log_time[slot][0];

    (void) ngx_sprintf(p1, "%4d/%02d/%02d %02d:%02d:%02d",
                       tm.
# 153 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_year
# 153 "project/nginx/src/core/ngx_times.c"
                                    , tm.
# 153 "project/nginx/src/core/ngx_times.c" 3 4
                                         tm_mon
# 153 "project/nginx/src/core/ngx_times.c"
                                                   ,
                       tm.
# 154 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_mday
# 154 "project/nginx/src/core/ngx_times.c"
                                    , tm.
# 154 "project/nginx/src/core/ngx_times.c" 3 4
                                         tm_hour
# 154 "project/nginx/src/core/ngx_times.c"
                                                    ,
                       tm.
# 155 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_min
# 155 "project/nginx/src/core/ngx_times.c"
                                   , tm.
# 155 "project/nginx/src/core/ngx_times.c" 3 4
                                        tm_sec
# 155 "project/nginx/src/core/ngx_times.c"
    ...
    (void) ngx_sprintf(p2, "%02d/%s/%d:%02d:%02d:%02d %c%02i%02i",
                       tm.
# 161 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_mday
# 161 "project/nginx/src/core/ngx_times.c"
                                    , months[tm.
# 161 "project/nginx/src/core/ngx_times.c" 3 4
                                                tm_mon 
# 161 "project/nginx/src/core/ngx_times.c"
                                                           - 1],
                       tm.
# 162 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_year
# 162 "project/nginx/src/core/ngx_times.c"
                                    , tm.
# 162 "project/nginx/src/core/ngx_times.c" 3 4
                                         tm_hour
# 162 "project/nginx/src/core/ngx_times.c"
                                                    ,
                       tm.
# 163 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_min
# 163 "project/nginx/src/core/ngx_times.c"
                                   , tm.
# 163 "project/nginx/src/core/ngx_times.c" 3 4
                                        tm_sec
# 163 "project/nginx/src/core/ngx_times.c"
...
# 165 "project/nginx/src/core/ngx_times.c" 3 4
                      (((
# 165 "project/nginx/src/core/ngx_times.c"
                      tp->gmtoff / 60
# 165 "project/nginx/src/core/ngx_times.c" 3 4
                      ) >= 0) ? (
# 165 "project/nginx/src/core/ngx_times.c"
...
# 165 "project/nginx/src/core/ngx_times.c"
    ...
    (void) ngx_sprintf(p3, "%4d-%02d-%02dT%02d:%02d:%02d%c%02i:%02i",
                       tm.
# 170 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_year
# 170 "project/nginx/src/core/ngx_times.c"
                                    , tm.
# 170 "project/nginx/src/core/ngx_times.c" 3 4
                                         tm_mon
# 170 "project/nginx/src/core/ngx_times.c"
                                                   ,
                       tm.
# 171 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_mday
# 171 "project/nginx/src/core/ngx_times.c"
                                    , tm.
# 171 "project/nginx/src/core/ngx_times.c" 3 4
                                         tm_hour
# 171 "project/nginx/src/core/ngx_times.c"
                                                    ,
                       tm.
# 172 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_min
# 172 "project/nginx/src/core/ngx_times.c"
                                   , tm.
# 172 "project/nginx/src/core/ngx_times.c" 3 4
                                        tm_sec
# 172 "project/nginx/src/core/ngx_times.c"
...
# 174 "project/nginx/src/core/ngx_times.c" 3 4
                      (((
# 174 "project/nginx/src/core/ngx_times.c"
                      tp->gmtoff / 60
# 174 "project/nginx/src/core/ngx_times.c" 3 4
                      ) >= 0) ? (
# 174 "project/nginx/src/core/ngx_times.c"
...
# 174 "project/nginx/src/core/ngx_times.c"
    ...
    (void) ngx_sprintf(p4, "%s %2d %02d:%02d:%02d",
                       months[tm.
# 179 "project/nginx/src/core/ngx_times.c" 3 4
                                tm_mon 
# 179 "project/nginx/src/core/ngx_times.c"
                                           - 1], tm.
# 179 "project/nginx/src/core/ngx_times.c" 3 4
                                                    tm_mday
# 179 "project/nginx/src/core/ngx_times.c"
                                                               ,
                       tm.
# 180 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_hour
# 180 "project/nginx/src/core/ngx_times.c"
                                    , tm.
# 180 "project/nginx/src/core/ngx_times.c" 3 4
                                         tm_min
# 180 "project/nginx/src/core/ngx_times.c"
...
# 182 "project/nginx/src/core/ngx_times.c" 3 4
   __sync_synchronize()
# 182 "project/nginx/src/core/ngx_times.c"
                       ;
...
# 191 "project/nginx/src/core/ngx_times.c" 3 4
   *(
# 191 "project/nginx/src/core/ngx_times.c"
   &ngx_time_lock
# 191 "project/nginx/src/core/ngx_times.c" 3 4
   ) = 0
# 191 "project/nginx/src/core/ngx_times.c"
...
ngx_monotonic_time(time_t sec, ngx_uint_t msec)
{
    ...
    clock_gettime(
# 204 "project/nginx/src/core/ngx_times.c" 3 4
                 _CLOCK_MONOTONIC
# 204 "project/nginx/src/core/ngx_times.c"
                                , &ts);
...
ngx_time_sigsafe_update(void)
{
    ...
    if (!
# 227 "project/nginx/src/core/ngx_times.c" 3 4
        (*(
# 227 "project/nginx/src/core/ngx_times.c"
        &ngx_time_lock
# 227 "project/nginx/src/core/ngx_times.c" 3 4
        ) == 0 && __sync_bool_compare_and_swap(
# 227 "project/nginx/src/core/ngx_times.c"
...
# 231 "project/nginx/src/core/ngx_times.c" 3 4
   (void) gettimeofday(
# 231 "project/nginx/src/core/ngx_times.c"
   &tv
# 231 "project/nginx/src/core/ngx_times.c" 3 4
   , ((void *)0));
# 231 "project/nginx/src/core/ngx_times.c"
...
# 238 "project/nginx/src/core/ngx_times.c" 3 4
       *(
# 238 "project/nginx/src/core/ngx_times.c"
       &ngx_time_lock
# 238 "project/nginx/src/core/ngx_times.c" 3 4
       ) = 0
# 238 "project/nginx/src/core/ngx_times.c"
    ...
    (void) ngx_sprintf(p, "%4d/%02d/%02d %02d:%02d:%02d",
                       tm.
# 257 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_year
# 257 "project/nginx/src/core/ngx_times.c"
                                    , tm.
# 257 "project/nginx/src/core/ngx_times.c" 3 4
                                         tm_mon
# 257 "project/nginx/src/core/ngx_times.c"
                                                   ,
                       tm.
# 258 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_mday
# 258 "project/nginx/src/core/ngx_times.c"
                                    , tm.
# 258 "project/nginx/src/core/ngx_times.c" 3 4
                                         tm_hour
# 258 "project/nginx/src/core/ngx_times.c"
                                                    ,
                       tm.
# 259 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_min
# 259 "project/nginx/src/core/ngx_times.c"
                                   , tm.
# 259 "project/nginx/src/core/ngx_times.c" 3 4
                                        tm_sec
# 259 "project/nginx/src/core/ngx_times.c"
    ...
    (void) ngx_sprintf(p2, "%s %2d %02d:%02d:%02d",
                       months[tm.
# 264 "project/nginx/src/core/ngx_times.c" 3 4
                                tm_mon 
# 264 "project/nginx/src/core/ngx_times.c"
                                           - 1], tm.
# 264 "project/nginx/src/core/ngx_times.c" 3 4
                                                    tm_mday
# 264 "project/nginx/src/core/ngx_times.c"
                                                               ,
                       tm.
# 265 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_hour
# 265 "project/nginx/src/core/ngx_times.c"
                                    , tm.
# 265 "project/nginx/src/core/ngx_times.c" 3 4
                                         tm_min
# 265 "project/nginx/src/core/ngx_times.c"
...
# 267 "project/nginx/src/core/ngx_times.c" 3 4
   __sync_synchronize()
# 267 "project/nginx/src/core/ngx_times.c"
                       ;
...
# 272 "project/nginx/src/core/ngx_times.c" 3 4
   *(
# 272 "project/nginx/src/core/ngx_times.c"
   &ngx_time_lock
# 272 "project/nginx/src/core/ngx_times.c" 3 4
   ) = 0
# 272 "project/nginx/src/core/ngx_times.c"
...
ngx_http_time(u_char *buf, time_t t)
{
    ...
    return ngx_sprintf(buf, "%s, %02d %s %4d %02d:%02d:%02d GMT",
                       week[tm.
# 286 "project/nginx/src/core/ngx_times.c" 3 4
                              tm_wday
# 286 "project/nginx/src/core/ngx_times.c"
                                         ],
                       tm.
# 287 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_mday
# 287 "project/nginx/src/core/ngx_times.c"
                                    ,
                       months[tm.
# 288 "project/nginx/src/core/ngx_times.c" 3 4
                                tm_mon 
# 288 "project/nginx/src/core/ngx_times.c"
                                           - 1],
                       tm.
# 289 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_year
# 289 "project/nginx/src/core/ngx_times.c"
                                    ,
                       tm.
# 290 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_hour
# 290 "project/nginx/src/core/ngx_times.c"
                                    ,
                       tm.
# 291 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_min
# 291 "project/nginx/src/core/ngx_times.c"
                                   ,
                       tm.
# 292 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_sec
# 292 "project/nginx/src/core/ngx_times.c"
                                   );
}
...
ngx_http_cookie_time(u_char *buf, time_t t)
{
    ...
    return ngx_sprintf(buf,
                       (tm.
# 309 "project/nginx/src/core/ngx_times.c" 3 4
                          tm_year 
# 309 "project/nginx/src/core/ngx_times.c"
                                      > 2037) ?
                                         "%s, %02d-%s-%d %02d:%02d:%02d GMT":
                                         "%s, %02d-%s-%02d %02d:%02d:%02d GMT",
                       week[tm.
# 312 "project/nginx/src/core/ngx_times.c" 3 4
                              tm_wday
# 312 "project/nginx/src/core/ngx_times.c"
                                         ],
                       tm.
# 313 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_mday
# 313 "project/nginx/src/core/ngx_times.c"
                                    ,
                       months[tm.
# 314 "project/nginx/src/core/ngx_times.c" 3 4
                                tm_mon 
# 314 "project/nginx/src/core/ngx_times.c"
                                           - 1],
                       (tm.
# 315 "project/nginx/src/core/ngx_times.c" 3 4
                          tm_year 
# 315 "project/nginx/src/core/ngx_times.c"
                                      > 2037) ? tm.
# 315 "project/nginx/src/core/ngx_times.c" 3 4
                                                   tm_year
# 315 "project/nginx/src/core/ngx_times.c"
                                                              :
                                                 tm.
# 316 "project/nginx/src/core/ngx_times.c" 3 4
                                                   tm_year 
# 316 "project/nginx/src/core/ngx_times.c"
                                                               % 100,
                       tm.
# 317 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_hour
# 317 "project/nginx/src/core/ngx_times.c"
                                    ,
                       tm.
# 318 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_min
# 318 "project/nginx/src/core/ngx_times.c"
                                   ,
                       tm.
# 319 "project/nginx/src/core/ngx_times.c" 3 4
                         tm_sec
# 319 "project/nginx/src/core/ngx_times.c"
                                   );
}
...
# 372 "project/nginx/src/core/ngx_times.c"
...
# 390 "project/nginx/src/core/ngx_times.c"
    mon = (yday + 31) * 10 / 306;
    ...
    tp->
# 418 "project/nginx/src/core/ngx_times.c" 3 4
       tm_sec 
# 418 "project/nginx/src/core/ngx_times.c"
                  = (
# 418 "project/nginx/src/core/ngx_times.c" 3 4
                     int
# 418 "project/nginx/src/core/ngx_times.c"
    ...
    tp->
# 419 "project/nginx/src/core/ngx_times.c" 3 4
       tm_min 
# 419 "project/nginx/src/core/ngx_times.c"
                  = (
# 419 "project/nginx/src/core/ngx_times.c" 3 4
                     int
# 419 "project/nginx/src/core/ngx_times.c"
    ...
    tp->
# 420 "project/nginx/src/core/ngx_times.c" 3 4
       tm_hour 
# 420 "project/nginx/src/core/ngx_times.c"
                   = (
# 420 "project/nginx/src/core/ngx_times.c" 3 4
                      int
# 420 "project/nginx/src/core/ngx_times.c"
    ...
    tp->
# 421 "project/nginx/src/core/ngx_times.c" 3 4
       tm_mday 
# 421 "project/nginx/src/core/ngx_times.c"
                   = (
# 421 "project/nginx/src/core/ngx_times.c" 3 4
                      int
# 421 "project/nginx/src/core/ngx_times.c"
    ...
    tp->
# 422 "project/nginx/src/core/ngx_times.c" 3 4
       tm_mon 
# 422 "project/nginx/src/core/ngx_times.c"
                  = (
# 422 "project/nginx/src/core/ngx_times.c" 3 4
                     int
# 422 "project/nginx/src/core/ngx_times.c"
    ...
    tp->
# 423 "project/nginx/src/core/ngx_times.c" 3 4
       tm_year 
# 423 "project/nginx/src/core/ngx_times.c"
                   = (
# 423 "project/nginx/src/core/ngx_times.c" 3 4
                      int
# 423 "project/nginx/src/core/ngx_times.c"
    ...
    tp->
# 424 "project/nginx/src/core/ngx_times.c" 3 4
       tm_wday 
# 424 "project/nginx/src/core/ngx_times.c"
                   = (
# 424 "project/nginx/src/core/ngx_times.c" 3 4
                      int
# 424 "project/nginx/src/core/ngx_times.c"
...
ngx_next_time(time_t when)
{
    ...
    now = 
# 434 "project/nginx/src/core/ngx_times.c" 3 4
         ngx_cached_time->sec
# 434 "project/nginx/src/core/ngx_times.c"
                   ;
