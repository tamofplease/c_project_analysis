# 0 "project/nginx/src/core/ngx_rwlock.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/core/ngx_rwlock.c"
...
# 9 "project/nginx/src/core/ngx_rwlock.c" 2
...
# 10 "project/nginx/src/core/ngx_rwlock.c" 2
# 19 "project/nginx/src/core/ngx_rwlock.c"
...
ngx_rwlock_wlock(ngx_atomic_t *lock)
{
    ...
    for ( ;; ) {
        ...
        if (*lock == 0 && 
# 26 "project/nginx/src/core/ngx_rwlock.c" 3 4
                         __sync_bool_compare_and_swap(
# 26 "project/nginx/src/core/ngx_rwlock.c"
                         lock
# 26 "project/nginx/src/core/ngx_rwlock.c" 3 4
                         , 
# 26 "project/nginx/src/core/ngx_rwlock.c"
...
# 35 "project/nginx/src/core/ngx_rwlock.c" 3 4
                   __asm__ ("pause")
# 35 "project/nginx/src/core/ngx_rwlock.c"
                                  ;
                }

                if (*lock == 0
                    && 
# 39 "project/nginx/src/core/ngx_rwlock.c" 3 4
                      __sync_bool_compare_and_swap(
# 39 "project/nginx/src/core/ngx_rwlock.c"
                      lock
# 39 "project/nginx/src/core/ngx_rwlock.c" 3 4
                      , 
# 39 "project/nginx/src/core/ngx_rwlock.c"
...
# 46 "project/nginx/src/core/ngx_rwlock.c" 3 4
       sched_yield()
# 46 "project/nginx/src/core/ngx_rwlock.c"
                        ;
    }
}
...
ngx_rwlock_rlock(ngx_atomic_t *lock)
{
    ...
    for ( ;; ) {
        ...
        if (readers != ((ngx_atomic_uint_t) -1)
            && 
# 61 "project/nginx/src/core/ngx_rwlock.c" 3 4
              __sync_bool_compare_and_swap(
# 61 "project/nginx/src/core/ngx_rwlock.c"
              lock
# 61 "project/nginx/src/core/ngx_rwlock.c" 3 4
              , 
# 61 "project/nginx/src/core/ngx_rwlock.c"
...
# 71 "project/nginx/src/core/ngx_rwlock.c" 3 4
                   __asm__ ("pause")
# 71 "project/nginx/src/core/ngx_rwlock.c"
                                  ;
                }
                ...
                if (readers != ((ngx_atomic_uint_t) -1)
                    && 
# 77 "project/nginx/src/core/ngx_rwlock.c" 3 4
                      __sync_bool_compare_and_swap(
# 77 "project/nginx/src/core/ngx_rwlock.c"
                      lock
# 77 "project/nginx/src/core/ngx_rwlock.c" 3 4
                      , 
# 77 "project/nginx/src/core/ngx_rwlock.c"
...
# 84 "project/nginx/src/core/ngx_rwlock.c" 3 4
       sched_yield()
# 84 "project/nginx/src/core/ngx_rwlock.c"
                        ;
    }
}
...
ngx_rwlock_unlock(ngx_atomic_t *lock)
{
    ...
    if (readers == ((ngx_atomic_uint_t) -1)) {
        (void) 
# 97 "project/nginx/src/core/ngx_rwlock.c" 3 4
              __sync_bool_compare_and_swap(
# 97 "project/nginx/src/core/ngx_rwlock.c"
              lock
# 97 "project/nginx/src/core/ngx_rwlock.c" 3 4
              , 
# 97 "project/nginx/src/core/ngx_rwlock.c"
...
# 97 "project/nginx/src/core/ngx_rwlock.c"
    ...
    for ( ;; ) {
        ...
        if (
# 103 "project/nginx/src/core/ngx_rwlock.c" 3 4
           __sync_bool_compare_and_swap(
# 103 "project/nginx/src/core/ngx_rwlock.c"
           lock
# 103 "project/nginx/src/core/ngx_rwlock.c" 3 4
           , 
# 103 "project/nginx/src/core/ngx_rwlock.c"
