# 0 "project/nginx/src/core/ngx_cpuinfo.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 9 "project/nginx/src/core/ngx_cpuinfo.c" 2
...
# 10 "project/nginx/src/core/ngx_cpuinfo.c" 2
...
# 15 "project/nginx/src/core/ngx_cpuinfo.c"
static 
# 15 "project/nginx/src/core/ngx_cpuinfo.c" 3 4
      inline 
# 15 "project/nginx/src/core/ngx_cpuinfo.c"
                 void ngx_cpuid(uint32_t i, uint32_t *buf);
# 49 "project/nginx/src/core/ngx_cpuinfo.c"
static 
# 49 "project/nginx/src/core/ngx_cpuinfo.c" 3 4
      inline 
# 49 "project/nginx/src/core/ngx_cpuinfo.c"
                 void
...
ngx_cpuinfo(void)
{
    ...
    if (
# 94 "project/nginx/src/core/ngx_cpuinfo.c" 3 4
       strcmp((const char *) 
# 94 "project/nginx/src/core/ngx_cpuinfo.c"
       vendor
# 94 "project/nginx/src/core/ngx_cpuinfo.c" 3 4
       , (const char *) 
# 94 "project/nginx/src/core/ngx_cpuinfo.c"
...
# 125 "project/nginx/src/core/ngx_cpuinfo.c" 3 4
              strcmp((const char *) 
# 125 "project/nginx/src/core/ngx_cpuinfo.c"
              vendor
# 125 "project/nginx/src/core/ngx_cpuinfo.c" 3 4
              , (const char *) 
# 125 "project/nginx/src/core/ngx_cpuinfo.c"
