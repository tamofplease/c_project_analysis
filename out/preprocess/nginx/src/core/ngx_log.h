# 0 "project/nginx/src/core/ngx_log.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/core/ngx_log.h"
# 12 "project/nginx/src/core/ngx_log.h"
...
# 13 "project/nginx/src/core/ngx_log.h" 2
...
# 14 "project/nginx/src/core/ngx_log.h" 2
# 45 "project/nginx/src/core/ngx_log.h"
...
# 88 "project/nginx/src/core/ngx_log.h"
void ngx_log_error_core(ngx_uint_t level, ngx_log_t *log, ngx_err_t err,
    const char *fmt, ...);
# 231 "project/nginx/src/core/ngx_log.h"
...
static 
# 250 "project/nginx/src/core/ngx_log.h" 3 4
      inline 
# 250 "project/nginx/src/core/ngx_log.h"
                 void
...
{
    (void) ngx_write_fd(
# 253 "project/nginx/src/core/ngx_log.h" 3 4
                       2
# 253 "project/nginx/src/core/ngx_log.h"
                                 , text, 
# 253 "project/nginx/src/core/ngx_log.h" 3 4
                                         strlen((const char *) 
# 253 "project/nginx/src/core/ngx_log.h"
...
static 
# 257 "project/nginx/src/core/ngx_log.h" 3 4
      inline 
# 257 "project/nginx/src/core/ngx_log.h"
                 void
ngx_write_stdout(char *text)
{
    (void) ngx_write_fd(
# 260 "project/nginx/src/core/ngx_log.h" 3 4
                       1
# 260 "project/nginx/src/core/ngx_log.h"
                                 , text, 
# 260 "project/nginx/src/core/ngx_log.h" 3 4
                                         strlen((const char *) 
# 260 "project/nginx/src/core/ngx_log.h"
