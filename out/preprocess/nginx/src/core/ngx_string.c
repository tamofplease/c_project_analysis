# 0 "project/nginx/src/core/ngx_string.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/core/ngx_string.c"
...
# 9 "project/nginx/src/core/ngx_string.c" 2
...
# 10 "project/nginx/src/core/ngx_string.c" 2



# 12 "project/nginx/src/core/ngx_string.c"
...
ngx_strlow(u_char *dst, u_char *src, size_t n)
{
    while (n) {
        *dst = 
# 26 "project/nginx/src/core/ngx_string.c" 3 4
              (u_char) ((
# 26 "project/nginx/src/core/ngx_string.c"
              *src 
# 26 "project/nginx/src/core/ngx_string.c" 3 4
              >= 'A' && 
# 26 "project/nginx/src/core/ngx_string.c"
...
ngx_pstrdup(ngx_pool_t *pool, ngx_str_t *src)
{
    ...
    if (dst == 
# 80 "project/nginx/src/core/ngx_string.c" 3 4
              ((void *)0)
# 80 "project/nginx/src/core/ngx_string.c"
                  ) {
        return 
# 81 "project/nginx/src/core/ngx_string.c" 3 4
              ((void *)0)
# 81 "project/nginx/src/core/ngx_string.c"
                  ;
    }

    
# 84 "project/nginx/src/core/ngx_string.c" 3 4
   (void) __builtin___memcpy_chk (
# 84 "project/nginx/src/core/ngx_string.c"
   dst
# 84 "project/nginx/src/core/ngx_string.c" 3 4
   , 
# 84 "project/nginx/src/core/ngx_string.c"
...
# 122 "project/nginx/src/core/ngx_string.c"
u_char *
...
# 128 "project/nginx/src/core/ngx_string.c" 3 4
   __builtin_va_start(
# 128 "project/nginx/src/core/ngx_string.c"
   args
# 128 "project/nginx/src/core/ngx_string.c" 3 4
   ,
# 128 "project/nginx/src/core/ngx_string.c"
...
# 130 "project/nginx/src/core/ngx_string.c" 3 4
   __builtin_va_end(
# 130 "project/nginx/src/core/ngx_string.c"
   args
# 130 "project/nginx/src/core/ngx_string.c" 3 4
   )
# 130 "project/nginx/src/core/ngx_string.c"
...
# 142 "project/nginx/src/core/ngx_string.c" 3 4
   __builtin_va_start(
# 142 "project/nginx/src/core/ngx_string.c"
   args
# 142 "project/nginx/src/core/ngx_string.c" 3 4
   ,
# 142 "project/nginx/src/core/ngx_string.c"
...
# 144 "project/nginx/src/core/ngx_string.c" 3 4
   __builtin_va_end(
# 144 "project/nginx/src/core/ngx_string.c"
   args
# 144 "project/nginx/src/core/ngx_string.c" 3 4
   )
# 144 "project/nginx/src/core/ngx_string.c"
...
# 156 "project/nginx/src/core/ngx_string.c" 3 4
   __builtin_va_start(
# 156 "project/nginx/src/core/ngx_string.c"
   args
# 156 "project/nginx/src/core/ngx_string.c" 3 4
   ,
# 156 "project/nginx/src/core/ngx_string.c"
...
# 158 "project/nginx/src/core/ngx_string.c" 3 4
   __builtin_va_end(
# 158 "project/nginx/src/core/ngx_string.c"
   args
# 158 "project/nginx/src/core/ngx_string.c" 3 4
   )
# 158 "project/nginx/src/core/ngx_string.c"
    ...
    while (*fmt && buf < last) {
        ...
        if (*fmt == '%') {
            ...
            for ( ;; ) {
                ...
                case '*':
                    slen = 
# 238 "project/nginx/src/core/ngx_string.c" 3 4
                          __builtin_va_arg(
# 238 "project/nginx/src/core/ngx_string.c"
                          args
# 238 "project/nginx/src/core/ngx_string.c" 3 4
                          ,
# 238 "project/nginx/src/core/ngx_string.c"
...
# 238 "project/nginx/src/core/ngx_string.c"
            ...
            case 'V':
                v = 
# 253 "project/nginx/src/core/ngx_string.c" 3 4
                   __builtin_va_arg(
# 253 "project/nginx/src/core/ngx_string.c"
                   args
# 253 "project/nginx/src/core/ngx_string.c" 3 4
                   ,
# 253 "project/nginx/src/core/ngx_string.c"
...
# 253 "project/nginx/src/core/ngx_string.c"
            ...
            case 'v':
                vv = 
# 261 "project/nginx/src/core/ngx_string.c" 3 4
                    __builtin_va_arg(
# 261 "project/nginx/src/core/ngx_string.c"
                    args
# 261 "project/nginx/src/core/ngx_string.c" 3 4
                    ,
# 261 "project/nginx/src/core/ngx_string.c"
...
# 261 "project/nginx/src/core/ngx_string.c"
            ...
            case 's':
                p = 
# 269 "project/nginx/src/core/ngx_string.c" 3 4
                   __builtin_va_arg(
# 269 "project/nginx/src/core/ngx_string.c"
                   args
# 269 "project/nginx/src/core/ngx_string.c" 3 4
                   ,
# 269 "project/nginx/src/core/ngx_string.c"
...
# 269 "project/nginx/src/core/ngx_string.c"
            ...
            case 'O':
                i64 = (int64_t) 
# 277 "project/nginx/src/core/ngx_string.c" 3 4
                               __builtin_va_arg(
# 277 "project/nginx/src/core/ngx_string.c"
                               args
# 277 "project/nginx/src/core/ngx_string.c" 3 4
                               ,
# 277 "project/nginx/src/core/ngx_string.c"
...
# 277 "project/nginx/src/core/ngx_string.c"
            ...
            case 'P':
                i64 = (int64_t) 
# 282 "project/nginx/src/core/ngx_string.c" 3 4
                               __builtin_va_arg(
# 282 "project/nginx/src/core/ngx_string.c"
                               args
# 282 "project/nginx/src/core/ngx_string.c" 3 4
                               ,
# 282 "project/nginx/src/core/ngx_string.c"
...
# 282 "project/nginx/src/core/ngx_string.c"
            ...
            case 'T':
                i64 = (int64_t) 
# 287 "project/nginx/src/core/ngx_string.c" 3 4
                               __builtin_va_arg(
# 287 "project/nginx/src/core/ngx_string.c"
                               args
# 287 "project/nginx/src/core/ngx_string.c" 3 4
                               ,
# 287 "project/nginx/src/core/ngx_string.c"
...
# 287 "project/nginx/src/core/ngx_string.c"
            ...
            case 'M':
                ms = (ngx_msec_t) 
# 292 "project/nginx/src/core/ngx_string.c" 3 4
                                 __builtin_va_arg(
# 292 "project/nginx/src/core/ngx_string.c"
                                 args
# 292 "project/nginx/src/core/ngx_string.c" 3 4
                                 ,
# 292 "project/nginx/src/core/ngx_string.c"
...
# 292 "project/nginx/src/core/ngx_string.c"
            ...
            case 'z':
                if (sign) {
                    i64 = (int64_t) 
# 304 "project/nginx/src/core/ngx_string.c" 3 4
                                   __builtin_va_arg(
# 304 "project/nginx/src/core/ngx_string.c"
                                   args
# 304 "project/nginx/src/core/ngx_string.c" 3 4
                                   ,
# 304 "project/nginx/src/core/ngx_string.c"
...
# 304 "project/nginx/src/core/ngx_string.c"
                    ...
                    ui64 = (uint64_t) 
# 306 "project/nginx/src/core/ngx_string.c" 3 4
                                     __builtin_va_arg(
# 306 "project/nginx/src/core/ngx_string.c"
                                     args
# 306 "project/nginx/src/core/ngx_string.c" 3 4
                                     ,
# 306 "project/nginx/src/core/ngx_string.c"
...
# 306 "project/nginx/src/core/ngx_string.c"
            ...
            case 'i':
                if (sign) {
                    i64 = (int64_t) 
# 312 "project/nginx/src/core/ngx_string.c" 3 4
                                   __builtin_va_arg(
# 312 "project/nginx/src/core/ngx_string.c"
                                   args
# 312 "project/nginx/src/core/ngx_string.c" 3 4
                                   ,
# 312 "project/nginx/src/core/ngx_string.c"
...
# 312 "project/nginx/src/core/ngx_string.c"
                    ...
                    ui64 = (uint64_t) 
# 314 "project/nginx/src/core/ngx_string.c" 3 4
                                     __builtin_va_arg(
# 314 "project/nginx/src/core/ngx_string.c"
                                     args
# 314 "project/nginx/src/core/ngx_string.c" 3 4
                                     ,
# 314 "project/nginx/src/core/ngx_string.c"
...
# 314 "project/nginx/src/core/ngx_string.c"
                ...
                if (max_width) {
                    width = 
# 318 "project/nginx/src/core/ngx_string.c" 3 4
                           (sizeof("-9223372036854775808") - 1)
# 318 "project/nginx/src/core/ngx_string.c"
                                        ;
                }
            ...
            case 'd':
                if (sign) {
                    i64 = (int64_t) 
# 325 "project/nginx/src/core/ngx_string.c" 3 4
                                   __builtin_va_arg(
# 325 "project/nginx/src/core/ngx_string.c"
                                   args
# 325 "project/nginx/src/core/ngx_string.c" 3 4
                                   ,
# 325 "project/nginx/src/core/ngx_string.c"
...
# 325 "project/nginx/src/core/ngx_string.c"
                    ...
                    ui64 = (uint64_t) 
# 327 "project/nginx/src/core/ngx_string.c" 3 4
                                     __builtin_va_arg(
# 327 "project/nginx/src/core/ngx_string.c"
                                     args
# 327 "project/nginx/src/core/ngx_string.c" 3 4
                                     ,
# 327 "project/nginx/src/core/ngx_string.c"
...
# 327 "project/nginx/src/core/ngx_string.c"
            ...
            case 'l':
                if (sign) {
                    i64 = (int64_t) 
# 333 "project/nginx/src/core/ngx_string.c" 3 4
                                   __builtin_va_arg(
# 333 "project/nginx/src/core/ngx_string.c"
                                   args
# 333 "project/nginx/src/core/ngx_string.c" 3 4
                                   ,
# 333 "project/nginx/src/core/ngx_string.c"
...
# 333 "project/nginx/src/core/ngx_string.c"
                    ...
                    ui64 = (uint64_t) 
# 335 "project/nginx/src/core/ngx_string.c" 3 4
                                     __builtin_va_arg(
# 335 "project/nginx/src/core/ngx_string.c"
                                     args
# 335 "project/nginx/src/core/ngx_string.c" 3 4
                                     ,
# 335 "project/nginx/src/core/ngx_string.c"
...
# 335 "project/nginx/src/core/ngx_string.c"
            ...
            case 'D':
                if (sign) {
                    i64 = (int64_t) 
# 341 "project/nginx/src/core/ngx_string.c" 3 4
                                   __builtin_va_arg(
# 341 "project/nginx/src/core/ngx_string.c"
                                   args
# 341 "project/nginx/src/core/ngx_string.c" 3 4
                                   ,
# 341 "project/nginx/src/core/ngx_string.c"
...
# 341 "project/nginx/src/core/ngx_string.c"
                    ...
                    ui64 = (uint64_t) 
# 343 "project/nginx/src/core/ngx_string.c" 3 4
                                     __builtin_va_arg(
# 343 "project/nginx/src/core/ngx_string.c"
                                     args
# 343 "project/nginx/src/core/ngx_string.c" 3 4
                                     ,
# 343 "project/nginx/src/core/ngx_string.c"
...
# 343 "project/nginx/src/core/ngx_string.c"
            ...
            case 'L':
                if (sign) {
                    i64 = 
# 349 "project/nginx/src/core/ngx_string.c" 3 4
                         __builtin_va_arg(
# 349 "project/nginx/src/core/ngx_string.c"
                         args
# 349 "project/nginx/src/core/ngx_string.c" 3 4
                         ,
# 349 "project/nginx/src/core/ngx_string.c"
...
# 349 "project/nginx/src/core/ngx_string.c"
                    ...
                    ui64 = 
# 351 "project/nginx/src/core/ngx_string.c" 3 4
                          __builtin_va_arg(
# 351 "project/nginx/src/core/ngx_string.c"
                          args
# 351 "project/nginx/src/core/ngx_string.c" 3 4
                          ,
# 351 "project/nginx/src/core/ngx_string.c"
...
# 351 "project/nginx/src/core/ngx_string.c"
            ...
            case 'A':
                if (sign) {
                    i64 = (int64_t) 
# 357 "project/nginx/src/core/ngx_string.c" 3 4
                                   __builtin_va_arg(
# 357 "project/nginx/src/core/ngx_string.c"
                                   args
# 357 "project/nginx/src/core/ngx_string.c" 3 4
                                   ,
# 357 "project/nginx/src/core/ngx_string.c"
...
# 357 "project/nginx/src/core/ngx_string.c"
                    ...
                    ui64 = (uint64_t) 
# 359 "project/nginx/src/core/ngx_string.c" 3 4
                                     __builtin_va_arg(
# 359 "project/nginx/src/core/ngx_string.c"
                                     args
# 359 "project/nginx/src/core/ngx_string.c" 3 4
                                     ,
# 359 "project/nginx/src/core/ngx_string.c"
...
# 359 "project/nginx/src/core/ngx_string.c"
                ...
                if (max_width) {
                    width = 
# 363 "project/nginx/src/core/ngx_string.c" 3 4
                           (sizeof("-9223372036854775808") - 1)
# 363 "project/nginx/src/core/ngx_string.c"
                                           ;
                }
            ...
            case 'f':
                f = 
# 369 "project/nginx/src/core/ngx_string.c" 3 4
                   __builtin_va_arg(
# 369 "project/nginx/src/core/ngx_string.c"
                   args
# 369 "project/nginx/src/core/ngx_string.c" 3 4
                   ,
# 369 "project/nginx/src/core/ngx_string.c"
...
# 369 "project/nginx/src/core/ngx_string.c"
            ...
            case 'r':
                i64 = (int64_t) 
# 410 "project/nginx/src/core/ngx_string.c" 3 4
                               __builtin_va_arg(
# 410 "project/nginx/src/core/ngx_string.c"
                               args
# 410 "project/nginx/src/core/ngx_string.c" 3 4
                               ,
# 410 "project/nginx/src/core/ngx_string.c"
...
# 410 "project/nginx/src/core/ngx_string.c"
            ...
            case 'p':
                ui64 = (uintptr_t) 
# 416 "project/nginx/src/core/ngx_string.c" 3 4
                                  __builtin_va_arg(
# 416 "project/nginx/src/core/ngx_string.c"
                                  args
# 416 "project/nginx/src/core/ngx_string.c" 3 4
                                  ,
# 416 "project/nginx/src/core/ngx_string.c"
...
# 416 "project/nginx/src/core/ngx_string.c"
            ...
            case 'c':
                d = 
# 424 "project/nginx/src/core/ngx_string.c" 3 4
                   __builtin_va_arg(
# 424 "project/nginx/src/core/ngx_string.c"
                   args
# 424 "project/nginx/src/core/ngx_string.c" 3 4
                   ,
# 424 "project/nginx/src/core/ngx_string.c"
...
# 424 "project/nginx/src/core/ngx_string.c"
            ...
            case 'N':
                ...
                *buf++ = 
# 443 "project/nginx/src/core/ngx_string.c" 3 4
                        (u_char) '\n'
# 443 "project/nginx/src/core/ngx_string.c"
                          ;
...
{
    u_char *p, temp[
# 488 "project/nginx/src/core/ngx_string.c" 3 4
                           (sizeof("-9223372036854775808") - 1) 
# 488 "project/nginx/src/core/ngx_string.c"
                                         + 1];
    ...
    p = temp + 
# 498 "project/nginx/src/core/ngx_string.c" 3 4
              (sizeof("-9223372036854775808") - 1)
# 498 "project/nginx/src/core/ngx_string.c"
                           ;

    if (hexadecimal == 0) {

        if (ui64 <= (uint64_t) 
# 502 "project/nginx/src/core/ngx_string.c" 3 4
                              (uint32_t) 0xffffffff
# 502 "project/nginx/src/core/ngx_string.c"
                                                  ) {
# 519 "project/nginx/src/core/ngx_string.c"
            ui32 = (uint32_t) ui64;
    ...
    len = (temp + 
# 552 "project/nginx/src/core/ngx_string.c" 3 4
                 (sizeof("-9223372036854775808") - 1)
# 552 "project/nginx/src/core/ngx_string.c"
                              ) - p;
    ...
    len = (temp + 
# 560 "project/nginx/src/core/ngx_string.c" 3 4
                 (sizeof("-9223372036854775808") - 1)
# 560 "project/nginx/src/core/ngx_string.c"
                              ) - p;
    ...
    return 
# 566 "project/nginx/src/core/ngx_string.c" 3 4
          (((u_char *) __builtin___memcpy_chk (
# 566 "project/nginx/src/core/ngx_string.c"
          buf
# 566 "project/nginx/src/core/ngx_string.c" 3 4
          , 
# 566 "project/nginx/src/core/ngx_string.c"
    ...
    ngx_uint_t hexadecimal)
{
    ...
    if (hexadecimal == 0) {
        ...
        if (len == (size_t) -1) {
            ...
            len = 
# 585 "project/nginx/src/core/ngx_string.c" 3 4
                 ((
# 585 "project/nginx/src/core/ngx_string.c"
                 (size_t) (last - buf) 
# 585 "project/nginx/src/core/ngx_string.c" 3 4
                 > 
# 585 "project/nginx/src/core/ngx_string.c"
...
# 585 "project/nginx/src/core/ngx_string.c"
                                                    ;
            buf = 
# 586 "project/nginx/src/core/ngx_string.c" 3 4
                 (((u_char *) __builtin___memcpy_chk (
# 586 "project/nginx/src/core/ngx_string.c"
                 buf
# 586 "project/nginx/src/core/ngx_string.c" 3 4
                 , 
# 586 "project/nginx/src/core/ngx_string.c"
...
# 635 "project/nginx/src/core/ngx_string.c"
ngx_int_t
...
ngx_strnstr(u_char *s1, char *s2, size_t len)
{
    ...
    n = 
# 698 "project/nginx/src/core/ngx_string.c" 3 4
       strlen((const char *) 
# 698 "project/nginx/src/core/ngx_string.c"
       s2
# 698 "project/nginx/src/core/ngx_string.c" 3 4
       )
# 698 "project/nginx/src/core/ngx_string.c"
    ...
    do {
        do {
            if (len-- == 0) {
                return 
# 703 "project/nginx/src/core/ngx_string.c" 3 4
                      ((void *)0)
# 703 "project/nginx/src/core/ngx_string.c"
                          ;
            }
            ...
            if (c1 == 0) {
                return 
# 709 "project/nginx/src/core/ngx_string.c" 3 4
                      ((void *)0)
# 709 "project/nginx/src/core/ngx_string.c"
                          ;
            }
        ...
        if (n > len) {
            return 
# 715 "project/nginx/src/core/ngx_string.c" 3 4
                  ((void *)0)
# 715 "project/nginx/src/core/ngx_string.c"
                      ;
        }

    } while (
# 718 "project/nginx/src/core/ngx_string.c" 3 4
            strncmp((const char *) 
# 718 "project/nginx/src/core/ngx_string.c"
            s1
# 718 "project/nginx/src/core/ngx_string.c" 3 4
            , (const char *) 
# 718 "project/nginx/src/core/ngx_string.c"
...
# 730 "project/nginx/src/core/ngx_string.c"
u_char *
ngx_strstrn(u_char *s1, char *s2, size_t n)
{
    ...
    do {
        do {
            ...
            if (c1 == 0) {
                return 
# 742 "project/nginx/src/core/ngx_string.c" 3 4
                      ((void *)0)
# 742 "project/nginx/src/core/ngx_string.c"
                          ;
            }
...
# 747 "project/nginx/src/core/ngx_string.c" 3 4
            strncmp((const char *) 
# 747 "project/nginx/src/core/ngx_string.c"
            s1
# 747 "project/nginx/src/core/ngx_string.c" 3 4
            , (const char *) 
# 747 "project/nginx/src/core/ngx_string.c"
...
ngx_strcasestrn(u_char *s1, char *s2, size_t n)
{
    ...
    do {
        do {
            ...
            if (c1 == 0) {
                return 
# 766 "project/nginx/src/core/ngx_string.c" 3 4
                      ((void *)0)
# 766 "project/nginx/src/core/ngx_string.c"
                          ;
            }
...
# 785 "project/nginx/src/core/ngx_string.c"
u_char *
ngx_strlcasestrn(u_char *s1, u_char *last, u_char *s2, size_t n)
{
    ...
    do {
        do {
            if (s1 >= last) {
                return 
# 797 "project/nginx/src/core/ngx_string.c" 3 4
                      ((void *)0)
# 797 "project/nginx/src/core/ngx_string.c"
                          ;
            }
...
ngx_memn2cmp(u_char *s1, u_char *s2, size_t n1, size_t n2)
{
    ...
    m = 
# 885 "project/nginx/src/core/ngx_string.c" 3 4
       memcmp((const char *) 
# 885 "project/nginx/src/core/ngx_string.c"
       s1
# 885 "project/nginx/src/core/ngx_string.c" 3 4
       , (const char *) 
# 885 "project/nginx/src/core/ngx_string.c"
...
ngx_atoi(u_char *line, size_t n)
{
    ...
    if (n == 0) {
        return 
# 972 "project/nginx/src/core/ngx_string.c" 3 4
              -1
# 972 "project/nginx/src/core/ngx_string.c"
                       ;
    }

    cutoff = 
# 975 "project/nginx/src/core/ngx_string.c" 3 4
            9223372036854775807 
# 975 "project/nginx/src/core/ngx_string.c"
                                / 10;
    cutlim = 
# 976 "project/nginx/src/core/ngx_string.c" 3 4
            9223372036854775807 
# 976 "project/nginx/src/core/ngx_string.c"
                                % 10;

    for (value = 0; n--; line++) {
        if (*line < '0' || *line > '9') {
            return 
# 980 "project/nginx/src/core/ngx_string.c" 3 4
                  -1
# 980 "project/nginx/src/core/ngx_string.c"
                           ;
        }

        if (value >= cutoff && (value > cutoff || *line - '0' > cutlim)) {
            return 
# 984 "project/nginx/src/core/ngx_string.c" 3 4
                  -1
# 984 "project/nginx/src/core/ngx_string.c"
                           ;
        }
...
ngx_atofp(u_char *line, size_t n, size_t point)
{
    ...
    if (n == 0) {
        return 
# 1003 "project/nginx/src/core/ngx_string.c" 3 4
              -1
# 1003 "project/nginx/src/core/ngx_string.c"
                       ;
    }

    cutoff = 
# 1006 "project/nginx/src/core/ngx_string.c" 3 4
            9223372036854775807 
# 1006 "project/nginx/src/core/ngx_string.c"
                                / 10;
    cutlim = 
# 1007 "project/nginx/src/core/ngx_string.c" 3 4
            9223372036854775807 
# 1007 "project/nginx/src/core/ngx_string.c"
                                % 10;
    ...
    for (value = 0; n--; line++) {
        ...
        if (point == 0) {
            return 
# 1014 "project/nginx/src/core/ngx_string.c" 3 4
                  -1
# 1014 "project/nginx/src/core/ngx_string.c"
                           ;
        }
        ...
        if (*line == '.') {
            if (dot) {
                return 
# 1019 "project/nginx/src/core/ngx_string.c" 3 4
                      -1
# 1019 "project/nginx/src/core/ngx_string.c"
                               ;
            }
        ...
        if (*line < '0' || *line > '9') {
            return 
# 1027 "project/nginx/src/core/ngx_string.c" 3 4
                  -1
# 1027 "project/nginx/src/core/ngx_string.c"
                           ;
        }

        if (value >= cutoff && (value > cutoff || *line - '0' > cutlim)) {
            return 
# 1031 "project/nginx/src/core/ngx_string.c" 3 4
                  -1
# 1031 "project/nginx/src/core/ngx_string.c"
                           ;
        }
    ...
    while (point--) {
        if (value > cutoff) {
            return 
# 1040 "project/nginx/src/core/ngx_string.c" 3 4
                  -1
# 1040 "project/nginx/src/core/ngx_string.c"
                           ;
        }
...
ngx_atosz(u_char *line, size_t n)
{
    ...
    if (n == 0) {
        return 
# 1056 "project/nginx/src/core/ngx_string.c" 3 4
              -1
# 1056 "project/nginx/src/core/ngx_string.c"
                       ;
    }

    cutoff = 
# 1059 "project/nginx/src/core/ngx_string.c" 3 4
            9223372036854775807LL 
# 1059 "project/nginx/src/core/ngx_string.c"
                                 / 10;
    cutlim = 
# 1060 "project/nginx/src/core/ngx_string.c" 3 4
            9223372036854775807LL 
# 1060 "project/nginx/src/core/ngx_string.c"
                                 % 10;

    for (value = 0; n--; line++) {
        if (*line < '0' || *line > '9') {
            return 
# 1064 "project/nginx/src/core/ngx_string.c" 3 4
                  -1
# 1064 "project/nginx/src/core/ngx_string.c"
                           ;
        }

        if (value >= cutoff && (value > cutoff || *line - '0' > cutlim)) {
            return 
# 1068 "project/nginx/src/core/ngx_string.c" 3 4
                  -1
# 1068 "project/nginx/src/core/ngx_string.c"
                           ;
        }
...
ngx_atoof(u_char *line, size_t n)
{
    ...
    if (n == 0) {
        return 
# 1084 "project/nginx/src/core/ngx_string.c" 3 4
              -1
# 1084 "project/nginx/src/core/ngx_string.c"
                       ;
    }

    cutoff = 
# 1087 "project/nginx/src/core/ngx_string.c" 3 4
            9223372036854775807LL 
# 1087 "project/nginx/src/core/ngx_string.c"
                                / 10;
    cutlim = 
# 1088 "project/nginx/src/core/ngx_string.c" 3 4
            9223372036854775807LL 
# 1088 "project/nginx/src/core/ngx_string.c"
                                % 10;

    for (value = 0; n--; line++) {
        if (*line < '0' || *line > '9') {
            return 
# 1092 "project/nginx/src/core/ngx_string.c" 3 4
                  -1
# 1092 "project/nginx/src/core/ngx_string.c"
                           ;
        }

        if (value >= cutoff && (value > cutoff || *line - '0' > cutlim)) {
            return 
# 1096 "project/nginx/src/core/ngx_string.c" 3 4
                  -1
# 1096 "project/nginx/src/core/ngx_string.c"
                           ;
        }
...
ngx_atotm(u_char *line, size_t n)
{
    ...
    if (n == 0) {
        return 
# 1112 "project/nginx/src/core/ngx_string.c" 3 4
              -1
# 1112 "project/nginx/src/core/ngx_string.c"
                       ;
    }

    cutoff = 
# 1115 "project/nginx/src/core/ngx_string.c" 3 4
            9223372036854775807LL 
# 1115 "project/nginx/src/core/ngx_string.c"
                                 / 10;
    cutlim = 
# 1116 "project/nginx/src/core/ngx_string.c" 3 4
            9223372036854775807LL 
# 1116 "project/nginx/src/core/ngx_string.c"
                                 % 10;

    for (value = 0; n--; line++) {
        if (*line < '0' || *line > '9') {
            return 
# 1120 "project/nginx/src/core/ngx_string.c" 3 4
                  -1
# 1120 "project/nginx/src/core/ngx_string.c"
                           ;
        }

        if (value >= cutoff && (value > cutoff || *line - '0' > cutlim)) {
            return 
# 1124 "project/nginx/src/core/ngx_string.c" 3 4
                  -1
# 1124 "project/nginx/src/core/ngx_string.c"
                           ;
        }
...
ngx_hextoi(u_char *line, size_t n)
{
    ...
    if (n == 0) {
        return 
# 1141 "project/nginx/src/core/ngx_string.c" 3 4
              -1
# 1141 "project/nginx/src/core/ngx_string.c"
                       ;
    }

    cutoff = 
# 1144 "project/nginx/src/core/ngx_string.c" 3 4
            9223372036854775807 
# 1144 "project/nginx/src/core/ngx_string.c"
                                / 16;

    for (value = 0; n--; line++) {
        if (value > cutoff) {
            return 
# 1148 "project/nginx/src/core/ngx_string.c" 3 4
                  -1
# 1148 "project/nginx/src/core/ngx_string.c"
                           ;
        }
        ...
        return 
# 1165 "project/nginx/src/core/ngx_string.c" 3 4
              -1
# 1165 "project/nginx/src/core/ngx_string.c"
                       ;
    }
...
ngx_decode_base64_internal(ngx_str_t *dst, ngx_str_t *src, const u_char *basis)
{
    ...
    for (len = 0; len < src->len; len++) {
        ...
        if (basis[src->data[len]] == 77) {
            return 
# 1316 "project/nginx/src/core/ngx_string.c" 3 4
                  -1
# 1316 "project/nginx/src/core/ngx_string.c"
                           ;
        }
    }
    ...
    if (len % 4 == 1) {
        return 
# 1321 "project/nginx/src/core/ngx_string.c" 3 4
              -1
# 1321 "project/nginx/src/core/ngx_string.c"
                       ;
    }
    ...
    return 
# 1346 "project/nginx/src/core/ngx_string.c" 3 4
          0
# 1346 "project/nginx/src/core/ngx_string.c"
                ;
}
# 1359 "project/nginx/src/core/ngx_string.c"
uint32_t
...
ngx_escape_uri(u_char *dst, u_char *src, size_t size, ngx_uint_t type)
{
    ...
    uint32_t *escape;
    static u_char hex[] = "0123456789ABCDEF";
# 1511 "project/nginx/src/core/ngx_string.c"
    static uint32_t uri[] = {
        0xffffffff,
    ...
    if (dst == 
# 1637 "project/nginx/src/core/ngx_string.c" 3 4
              ((void *)0)
# 1637 "project/nginx/src/core/ngx_string.c"
                  ) {
...
ngx_unescape_uri(u_char **dst, u_char **src, size_t size, ngx_uint_t type)
{
    ...
    while (size--) {
        ...
        case sw_usual:
            if (ch == '?'
                && (type & (
# 1694 "project/nginx/src/core/ngx_string.c" 3 4
                           1
# 1694 "project/nginx/src/core/ngx_string.c"
                                           |
# 1694 "project/nginx/src/core/ngx_string.c" 3 4
                                            2
# 1694 "project/nginx/src/core/ngx_string.c"
        ...
        case sw_quoted_second:
            ...
            if (ch >= '0' && ch <= '9') {
                ...
                if (type & 
# 1738 "project/nginx/src/core/ngx_string.c" 3 4
                          2
# 1738 "project/nginx/src/core/ngx_string.c"
                                               ) {
                    if (ch > '%' && ch < 0x7f) {
                        *d++ = ch;
                        break;
            ...
            if (c >= 'a' && c <= 'f') {
                ...
                if (type & 
# 1758 "project/nginx/src/core/ngx_string.c" 3 4
                          1
# 1758 "project/nginx/src/core/ngx_string.c"
                                          ) {
                    if (ch == '?') {
                        *d++ = ch;
                        goto done;
                ...
                if (type & 
# 1768 "project/nginx/src/core/ngx_string.c" 3 4
                          2
# 1768 "project/nginx/src/core/ngx_string.c"
                                               ) {
                    if (ch == '?') {
                        *d++ = ch;
                        goto done;
...
ngx_escape_html(u_char *dst, u_char *src, size_t size)
{
    ...
    if (dst == 
# 1807 "project/nginx/src/core/ngx_string.c" 3 4
              ((void *)0)
# 1807 "project/nginx/src/core/ngx_string.c"
                  ) {
...
ngx_escape_json(u_char *dst, u_char *src, size_t size)
{
    ...
    if (dst == 
# 1879 "project/nginx/src/core/ngx_string.c" 3 4
              ((void *)0)
# 1879 "project/nginx/src/core/ngx_string.c"
                  ) {
        len = 0;
    ...
    ngx_rbtree_node_t *node, ngx_rbtree_node_t *sentinel)
{
    ...
    for ( ;; ) {
        ...
        if (node->key != temp->key) {
            ...
            p = (
# 1983 "project/nginx/src/core/ngx_string.c" 3 4
                memcmp((const char *) 
# 1983 "project/nginx/src/core/ngx_string.c"
                n->str.data
# 1983 "project/nginx/src/core/ngx_string.c" 3 4
                , (const char *) 
# 1983 "project/nginx/src/core/ngx_string.c"
...
# 1998 "project/nginx/src/core/ngx_string.c" 3 4
   ((
# 1998 "project/nginx/src/core/ngx_string.c"
   node
# 1998 "project/nginx/src/core/ngx_string.c" 3 4
   )->color = 1)
# 1998 "project/nginx/src/core/ngx_string.c"
...
ngx_str_rbtree_lookup(ngx_rbtree_t *rbtree, ngx_str_t *val, uint32_t hash)
{
    ...
    while (node != sentinel) {
        ...
        rc = 
# 2026 "project/nginx/src/core/ngx_string.c" 3 4
            memcmp((const char *) 
# 2026 "project/nginx/src/core/ngx_string.c"
            val->data
# 2026 "project/nginx/src/core/ngx_string.c" 3 4
            , (const char *) 
# 2026 "project/nginx/src/core/ngx_string.c"
...
# 2026 "project/nginx/src/core/ngx_string.c"
    ...
    return 
# 2041 "project/nginx/src/core/ngx_string.c" 3 4
          ((void *)0)
# 2041 "project/nginx/src/core/ngx_string.c"
              ;
}
    ...
    ngx_int_t (*cmp)(const void *, const void *))
{
    ...
    if (p == 
# 2054 "project/nginx/src/core/ngx_string.c" 3 4
            ((void *)0)
# 2054 "project/nginx/src/core/ngx_string.c"
                ) {
        return;
    }
...
# 2062 "project/nginx/src/core/ngx_string.c" 3 4
       (void) __builtin___memcpy_chk (
# 2062 "project/nginx/src/core/ngx_string.c"
       p
# 2062 "project/nginx/src/core/ngx_string.c" 3 4
       , 
# 2062 "project/nginx/src/core/ngx_string.c"
...
# 2068 "project/nginx/src/core/ngx_string.c" 3 4
           (void) __builtin___memcpy_chk (
# 2068 "project/nginx/src/core/ngx_string.c"
           p2
# 2068 "project/nginx/src/core/ngx_string.c" 3 4
           , 
# 2068 "project/nginx/src/core/ngx_string.c"
...
# 2071 "project/nginx/src/core/ngx_string.c" 3 4
       (void) __builtin___memcpy_chk (
# 2071 "project/nginx/src/core/ngx_string.c"
       p2
# 2071 "project/nginx/src/core/ngx_string.c" 3 4
       , 
# 2071 "project/nginx/src/core/ngx_string.c"
...
# 2074 "project/nginx/src/core/ngx_string.c" 3 4
   free
# 2074 "project/nginx/src/core/ngx_string.c"
           (p);
}
...
# 2081 "project/nginx/src/core/ngx_string.c" 3 4
   (void) __builtin___memset_chk (
# 2081 "project/nginx/src/core/ngx_string.c"
   buf
# 2081 "project/nginx/src/core/ngx_string.c" 3 4
   , 0, 
# 2081 "project/nginx/src/core/ngx_string.c"
...
# 2082 "project/nginx/src/core/ngx_string.c" 3 4
   __sync_synchronize()
# 2082 "project/nginx/src/core/ngx_string.c"
                       ;
}
