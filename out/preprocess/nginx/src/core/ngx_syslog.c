# 0 "project/nginx/src/core/ngx_syslog.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/core/ngx_syslog.c"
...
# 8 "project/nginx/src/core/ngx_syslog.c" 2
...
# 9 "project/nginx/src/core/ngx_syslog.c" 2
...
# 10 "project/nginx/src/core/ngx_syslog.c" 2
# 18 "project/nginx/src/core/ngx_syslog.c"
...
# 27 "project/nginx/src/core/ngx_syslog.c" 3 4
   ((void *)0)

# 28 "project/nginx/src/core/ngx_syslog.c"
};


static char *severities[] = {
    "emerg", "alert", "crit", "error", "warn", "notice", "info", "debug", 
# 32 "project/nginx/src/core/ngx_syslog.c" 3 4
                                                                         ((void *)0)

# 33 "project/nginx/src/core/ngx_syslog.c"
};
...
ngx_syslog_process_conf(ngx_conf_t *cf, ngx_syslog_peer_t *peer)
{
    ...
    peer->facility = 
# 44 "project/nginx/src/core/ngx_syslog.c" 3 4
                    (ngx_uint_t) -1
# 44 "project/nginx/src/core/ngx_syslog.c"
                                       ;
    peer->severity = 
# 45 "project/nginx/src/core/ngx_syslog.c" 3 4
                    (ngx_uint_t) -1
# 45 "project/nginx/src/core/ngx_syslog.c"
                                       ;

    if (ngx_syslog_parse_args(cf, peer) != 
# 47 "project/nginx/src/core/ngx_syslog.c" 3 4
                                          ((void *)0)
# 47 "project/nginx/src/core/ngx_syslog.c"
                                                     ) {
        return 
# 48 "project/nginx/src/core/ngx_syslog.c" 3 4
              (void *) -1
# 48 "project/nginx/src/core/ngx_syslog.c"
                            ;
    }

    if (peer->server.sockaddr == 
# 51 "project/nginx/src/core/ngx_syslog.c" 3 4
                                ((void *)0)
# 51 "project/nginx/src/core/ngx_syslog.c"
                                    ) {
        ngx_conf_log_error(
# 52 "project/nginx/src/core/ngx_syslog.c" 3 4
                          1
# 52 "project/nginx/src/core/ngx_syslog.c"
                                       , cf, 0,
                           "no syslog server specified");
        return 
# 54 "project/nginx/src/core/ngx_syslog.c" 3 4
              (void *) -1
# 54 "project/nginx/src/core/ngx_syslog.c"
                            ;
    }

    if (peer->facility == 
# 57 "project/nginx/src/core/ngx_syslog.c" 3 4
                         (ngx_uint_t) -1
# 57 "project/nginx/src/core/ngx_syslog.c"
                                            ) {
        peer->facility = 23;
    }

    if (peer->severity == 
# 61 "project/nginx/src/core/ngx_syslog.c" 3 4
                         (ngx_uint_t) -1
# 61 "project/nginx/src/core/ngx_syslog.c"
                                            ) {
        peer->severity = 6;
    }

    if (peer->tag.data == 
# 65 "project/nginx/src/core/ngx_syslog.c" 3 4
                         ((void *)0)
# 65 "project/nginx/src/core/ngx_syslog.c"
                             ) {
        
# 66 "project/nginx/src/core/ngx_syslog.c" 3 4
       (
# 66 "project/nginx/src/core/ngx_syslog.c"
       &peer->tag
# 66 "project/nginx/src/core/ngx_syslog.c" 3 4
       )->len = sizeof(
# 66 "project/nginx/src/core/ngx_syslog.c"
...
# 66 "project/nginx/src/core/ngx_syslog.c"
    ...
    if (cln == 
# 77 "project/nginx/src/core/ngx_syslog.c" 3 4
              ((void *)0)
# 77 "project/nginx/src/core/ngx_syslog.c"
                  ) {
        return 
# 78 "project/nginx/src/core/ngx_syslog.c" 3 4
              (void *) -1
# 78 "project/nginx/src/core/ngx_syslog.c"
                            ;
    }
    ...
    return 
# 84 "project/nginx/src/core/ngx_syslog.c" 3 4
          ((void *)0)
# 84 "project/nginx/src/core/ngx_syslog.c"
                     ;
}
...
ngx_syslog_parse_args(ngx_conf_t *cf, ngx_syslog_peer_t *peer)
{
    ...
    for ( ;; ) {
        comma = (u_char *) 
# 102 "project/nginx/src/core/ngx_syslog.c" 3 4
                          strchr((const char *) 
# 102 "project/nginx/src/core/ngx_syslog.c"
                          p
# 102 "project/nginx/src/core/ngx_syslog.c" 3 4
                          , (int) 
# 102 "project/nginx/src/core/ngx_syslog.c"
...
# 102 "project/nginx/src/core/ngx_syslog.c"
        ...
        if (comma != 
# 104 "project/nginx/src/core/ngx_syslog.c" 3 4
                    ((void *)0)
# 104 "project/nginx/src/core/ngx_syslog.c"
                        ) {
            len = comma - p;
            *comma = '\0';
        ...
        if (
# 112 "project/nginx/src/core/ngx_syslog.c" 3 4
           strncmp((const char *) 
# 112 "project/nginx/src/core/ngx_syslog.c"
           p
# 112 "project/nginx/src/core/ngx_syslog.c" 3 4
           , (const char *) 
# 112 "project/nginx/src/core/ngx_syslog.c"
...
# 112 "project/nginx/src/core/ngx_syslog.c"
            ...
            if (peer->server.sockaddr != 
# 114 "project/nginx/src/core/ngx_syslog.c" 3 4
                                        ((void *)0)
# 114 "project/nginx/src/core/ngx_syslog.c"
                                            ) {
                ngx_conf_log_error(
# 115 "project/nginx/src/core/ngx_syslog.c" 3 4
                                  1
# 115 "project/nginx/src/core/ngx_syslog.c"
                                               , cf, 0,
                                   "duplicate syslog \"server\"");
                return 
# 117 "project/nginx/src/core/ngx_syslog.c" 3 4
                      (void *) -1
# 117 "project/nginx/src/core/ngx_syslog.c"
                                    ;
            }

            
# 120 "project/nginx/src/core/ngx_syslog.c" 3 4
           (void) __builtin___memset_chk (
# 120 "project/nginx/src/core/ngx_syslog.c"
           &u
# 120 "project/nginx/src/core/ngx_syslog.c" 3 4
           , 0, 
# 120 "project/nginx/src/core/ngx_syslog.c"
...
# 126 "project/nginx/src/core/ngx_syslog.c" 3 4
                                              0
# 126 "project/nginx/src/core/ngx_syslog.c"
                                                    ) {
                if (u.err) {
                    ngx_conf_log_error(
# 128 "project/nginx/src/core/ngx_syslog.c" 3 4
                                      1
# 128 "project/nginx/src/core/ngx_syslog.c"
                                                   , cf, 0,
                ...
                return 
# 133 "project/nginx/src/core/ngx_syslog.c" 3 4
                      (void *) -1
# 133 "project/nginx/src/core/ngx_syslog.c"
                                    ;
            }
...
# 138 "project/nginx/src/core/ngx_syslog.c" 3 4
                  strncmp((const char *) 
# 138 "project/nginx/src/core/ngx_syslog.c"
                  p
# 138 "project/nginx/src/core/ngx_syslog.c" 3 4
                  , (const char *) 
# 138 "project/nginx/src/core/ngx_syslog.c"
...
# 138 "project/nginx/src/core/ngx_syslog.c"
            ...
            if (peer->facility != 
# 140 "project/nginx/src/core/ngx_syslog.c" 3 4
                                 (ngx_uint_t) -1
# 140 "project/nginx/src/core/ngx_syslog.c"
                                                    ) {
                ngx_conf_log_error(
# 141 "project/nginx/src/core/ngx_syslog.c" 3 4
                                  1
# 141 "project/nginx/src/core/ngx_syslog.c"
                                               , cf, 0,
                                   "duplicate syslog \"facility\"");
                return 
# 143 "project/nginx/src/core/ngx_syslog.c" 3 4
                      (void *) -1
# 143 "project/nginx/src/core/ngx_syslog.c"
                                    ;
            }

            for (i = 0; facilities[i] != 
# 146 "project/nginx/src/core/ngx_syslog.c" 3 4
                                        ((void *)0)
# 146 "project/nginx/src/core/ngx_syslog.c"
                                            ; i++) {

                if (
# 148 "project/nginx/src/core/ngx_syslog.c" 3 4
                   strcmp((const char *) 
# 148 "project/nginx/src/core/ngx_syslog.c"
                   p + 9
# 148 "project/nginx/src/core/ngx_syslog.c" 3 4
                   , (const char *) 
# 148 "project/nginx/src/core/ngx_syslog.c"
...
# 148 "project/nginx/src/core/ngx_syslog.c"
            ...
            ngx_conf_log_error(
# 154 "project/nginx/src/core/ngx_syslog.c" 3 4
                              1
# 154 "project/nginx/src/core/ngx_syslog.c"
                                           , cf, 0,
                               "unknown syslog facility \"%s\"", p + 9);
            return 
# 156 "project/nginx/src/core/ngx_syslog.c" 3 4
                  (void *) -1
# 156 "project/nginx/src/core/ngx_syslog.c"
                                ;

        } else if (
# 158 "project/nginx/src/core/ngx_syslog.c" 3 4
                  strncmp((const char *) 
# 158 "project/nginx/src/core/ngx_syslog.c"
                  p
# 158 "project/nginx/src/core/ngx_syslog.c" 3 4
                  , (const char *) 
# 158 "project/nginx/src/core/ngx_syslog.c"
...
# 158 "project/nginx/src/core/ngx_syslog.c"
            ...
            if (peer->severity != 
# 160 "project/nginx/src/core/ngx_syslog.c" 3 4
                                 (ngx_uint_t) -1
# 160 "project/nginx/src/core/ngx_syslog.c"
                                                    ) {
                ngx_conf_log_error(
# 161 "project/nginx/src/core/ngx_syslog.c" 3 4
                                  1
# 161 "project/nginx/src/core/ngx_syslog.c"
                                               , cf, 0,
                                   "duplicate syslog \"severity\"");
                return 
# 163 "project/nginx/src/core/ngx_syslog.c" 3 4
                      (void *) -1
# 163 "project/nginx/src/core/ngx_syslog.c"
                                    ;
            }

            for (i = 0; severities[i] != 
# 166 "project/nginx/src/core/ngx_syslog.c" 3 4
                                        ((void *)0)
# 166 "project/nginx/src/core/ngx_syslog.c"
                                            ; i++) {

                if (
# 168 "project/nginx/src/core/ngx_syslog.c" 3 4
                   strcmp((const char *) 
# 168 "project/nginx/src/core/ngx_syslog.c"
                   p + 9
# 168 "project/nginx/src/core/ngx_syslog.c" 3 4
                   , (const char *) 
# 168 "project/nginx/src/core/ngx_syslog.c"
...
# 168 "project/nginx/src/core/ngx_syslog.c"
            ...
            ngx_conf_log_error(
# 174 "project/nginx/src/core/ngx_syslog.c" 3 4
                              1
# 174 "project/nginx/src/core/ngx_syslog.c"
                                           , cf, 0,
                               "unknown syslog severity \"%s\"", p + 9);
            return 
# 176 "project/nginx/src/core/ngx_syslog.c" 3 4
                  (void *) -1
# 176 "project/nginx/src/core/ngx_syslog.c"
                                ;

        } else if (
# 178 "project/nginx/src/core/ngx_syslog.c" 3 4
                  strncmp((const char *) 
# 178 "project/nginx/src/core/ngx_syslog.c"
                  p
# 178 "project/nginx/src/core/ngx_syslog.c" 3 4
                  , (const char *) 
# 178 "project/nginx/src/core/ngx_syslog.c"
...
# 178 "project/nginx/src/core/ngx_syslog.c"
            ...
            if (peer->tag.data != 
# 180 "project/nginx/src/core/ngx_syslog.c" 3 4
                                 ((void *)0)
# 180 "project/nginx/src/core/ngx_syslog.c"
                                     ) {
                ngx_conf_log_error(
# 181 "project/nginx/src/core/ngx_syslog.c" 3 4
                                  1
# 181 "project/nginx/src/core/ngx_syslog.c"
                                               , cf, 0,
                                   "duplicate syslog \"tag\"");
                return 
# 183 "project/nginx/src/core/ngx_syslog.c" 3 4
                      (void *) -1
# 183 "project/nginx/src/core/ngx_syslog.c"
                                    ;
            }
            ...
            if (len - 4 > 32) {
                ngx_conf_log_error(
# 191 "project/nginx/src/core/ngx_syslog.c" 3 4
                                  1
# 191 "project/nginx/src/core/ngx_syslog.c"
                                               , cf, 0,
                                   "syslog tag length exceeds 32");
                return 
# 193 "project/nginx/src/core/ngx_syslog.c" 3 4
                      (void *) -1
# 193 "project/nginx/src/core/ngx_syslog.c"
                                    ;
            }

            for (i = 4; i < len; i++) {
                c = 
# 197 "project/nginx/src/core/ngx_syslog.c" 3 4
                   (u_char) ((
# 197 "project/nginx/src/core/ngx_syslog.c"
                   p[i] 
# 197 "project/nginx/src/core/ngx_syslog.c" 3 4
                   >= 'A' && 
# 197 "project/nginx/src/core/ngx_syslog.c"
...
# 197 "project/nginx/src/core/ngx_syslog.c"
                ...
                if (c < '0' || (c > '9' && c < 'a' && c != '_') || c > 'z') {
                    ngx_conf_log_error(
# 200 "project/nginx/src/core/ngx_syslog.c" 3 4
                                      1
# 200 "project/nginx/src/core/ngx_syslog.c"
                                                   , cf, 0,
                                       "syslog \"tag\" only allows "
                                       "alphanumeric characters "
                                       "and underscore");
                    return 
# 204 "project/nginx/src/core/ngx_syslog.c" 3 4
                          (void *) -1
# 204 "project/nginx/src/core/ngx_syslog.c"
                                        ;
                }
            }
...
# 211 "project/nginx/src/core/ngx_syslog.c" 3 4
                               strncmp((const char *) 
# 211 "project/nginx/src/core/ngx_syslog.c"
                               p
# 211 "project/nginx/src/core/ngx_syslog.c" 3 4
                               , (const char *) 
# 211 "project/nginx/src/core/ngx_syslog.c"
...
# 211 "project/nginx/src/core/ngx_syslog.c"
            ...
            ngx_conf_log_error(
# 215 "project/nginx/src/core/ngx_syslog.c" 3 4
                              1
# 215 "project/nginx/src/core/ngx_syslog.c"
                                           , cf, 0,
                               "unknown syslog parameter \"%s\"", p);
            return 
# 217 "project/nginx/src/core/ngx_syslog.c" 3 4
                  (void *) -1
# 217 "project/nginx/src/core/ngx_syslog.c"
                                ;
        }
    ...
    next:
        ...
        if (comma == 
# 222 "project/nginx/src/core/ngx_syslog.c" 3 4
                    ((void *)0)
# 222 "project/nginx/src/core/ngx_syslog.c"
                        ) {
            break;
        }
    ...
    return 
# 229 "project/nginx/src/core/ngx_syslog.c" 3 4
          ((void *)0)
# 229 "project/nginx/src/core/ngx_syslog.c"
                     ;
}
...
{
    u_char *p, msg[
# 254 "project/nginx/src/core/ngx_syslog.c" 3 4
                              2048 
# 254 "project/nginx/src/core/ngx_syslog.c"
                              + sizeof("<255>Jan 01 00:00:00 ") - 1 + (
# 254 "project/nginx/src/core/ngx_syslog.c" 3 4
                              256 
# 254 "project/nginx/src/core/ngx_syslog.c"
                              - 1) + 1 + 32 + 2];
    ...
    len -= 
# 270 "project/nginx/src/core/ngx_syslog.c" 3 4
          1
# 270 "project/nginx/src/core/ngx_syslog.c"
                           ;

    if (len > 
# 272 "project/nginx/src/core/ngx_syslog.c" 3 4
             2048 
# 272 "project/nginx/src/core/ngx_syslog.c"
             + sizeof("<255>Jan 01 00:00:00 ") - 1 + (
# 272 "project/nginx/src/core/ngx_syslog.c" 3 4
             256 
# 272 "project/nginx/src/core/ngx_syslog.c"
             - 1) + 1 + 32 + 2 - head_len) {
        len = 
# 273 "project/nginx/src/core/ngx_syslog.c" 3 4
             2048 
# 273 "project/nginx/src/core/ngx_syslog.c"
             + sizeof("<255>Jan 01 00:00:00 ") - 1 + (
# 273 "project/nginx/src/core/ngx_syslog.c" 3 4
             256 
# 273 "project/nginx/src/core/ngx_syslog.c"
...
ngx_syslog_send(ngx_syslog_peer_t *peer, u_char *buf, size_t len)
{
    ...
    if (peer->conn.fd == (ngx_socket_t) -1) {
        if (ngx_syslog_init_peer(peer) != 
# 290 "project/nginx/src/core/ngx_syslog.c" 3 4
                                         0
# 290 "project/nginx/src/core/ngx_syslog.c"
                                               ) {
            return 
# 291 "project/nginx/src/core/ngx_syslog.c" 3 4
                  -1
# 291 "project/nginx/src/core/ngx_syslog.c"
                           ;
        }
    }
    ...
    if (
# 298 "project/nginx/src/core/ngx_syslog.c" 3 4
       ngx_io.send
# 298 "project/nginx/src/core/ngx_syslog.c"
               ) {
        n = 
# 299 "project/nginx/src/core/ngx_syslog.c" 3 4
           ngx_io.send
# 299 "project/nginx/src/core/ngx_syslog.c"
                   (&peer->conn, buf, len);
    ...
    if (n == 
# 306 "project/nginx/src/core/ngx_syslog.c" 3 4
            -1
# 306 "project/nginx/src/core/ngx_syslog.c"
                     ) {

        if (
# 308 "project/nginx/src/core/ngx_syslog.c" 3 4
           close
# 308 "project/nginx/src/core/ngx_syslog.c"
                           (peer->conn.fd) == -1) {
            
# 309 "project/nginx/src/core/ngx_syslog.c" 3 4
           if ((
# 309 "project/nginx/src/core/ngx_syslog.c"
           ngx_cycle->log
# 309 "project/nginx/src/core/ngx_syslog.c" 3 4
...
# 310 "project/nginx/src/core/ngx_syslog.c"
                                                      ;
        }
...
ngx_syslog_init_peer(ngx_syslog_peer_t *peer)
{
    ...
    fd = 
# 325 "project/nginx/src/core/ngx_syslog.c" 3 4
        socket
# 325 "project/nginx/src/core/ngx_syslog.c"
                  (peer->server.sockaddr->sa_family, 
# 325 "project/nginx/src/core/ngx_syslog.c" 3 4
                                                     2
# 325 "project/nginx/src/core/ngx_syslog.c"
                                                               , 0);
...
# 327 "project/nginx/src/core/ngx_syslog.c" 3 4
       if ((
# 327 "project/nginx/src/core/ngx_syslog.c"
       ngx_cycle->log
# 327 "project/nginx/src/core/ngx_syslog.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 327 "project/nginx/src/core/ngx_syslog.c"
...
# 328 "project/nginx/src/core/ngx_syslog.c"
                                            ;
        return 
# 329 "project/nginx/src/core/ngx_syslog.c" 3 4
              -1
# 329 "project/nginx/src/core/ngx_syslog.c"
                       ;
    }

    if (ngx_nonblocking(fd) == -1) {
        
# 333 "project/nginx/src/core/ngx_syslog.c" 3 4
       if ((
# 333 "project/nginx/src/core/ngx_syslog.c"
       ngx_cycle->log
# 333 "project/nginx/src/core/ngx_syslog.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 333 "project/nginx/src/core/ngx_syslog.c"
...
# 334 "project/nginx/src/core/ngx_syslog.c"
                                                 ;
        goto failed;
    }
...
# 339 "project/nginx/src/core/ngx_syslog.c" 3 4
       if ((
# 339 "project/nginx/src/core/ngx_syslog.c"
       ngx_cycle->log
# 339 "project/nginx/src/core/ngx_syslog.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 339 "project/nginx/src/core/ngx_syslog.c"
...
# 340 "project/nginx/src/core/ngx_syslog.c"
                                        ;
        goto failed;
    }
    ...
    return 
# 349 "project/nginx/src/core/ngx_syslog.c" 3 4
          0
# 349 "project/nginx/src/core/ngx_syslog.c"
                ;

failed:

    if (
# 353 "project/nginx/src/core/ngx_syslog.c" 3 4
       close
# 353 "project/nginx/src/core/ngx_syslog.c"
                       (fd) == -1) {
        
# 354 "project/nginx/src/core/ngx_syslog.c" 3 4
       if ((
# 354 "project/nginx/src/core/ngx_syslog.c"
       ngx_cycle->log
# 354 "project/nginx/src/core/ngx_syslog.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 354 "project/nginx/src/core/ngx_syslog.c"
...
# 355 "project/nginx/src/core/ngx_syslog.c"
                                                  ;
    }

    return 
# 358 "project/nginx/src/core/ngx_syslog.c" 3 4
          -1
# 358 "project/nginx/src/core/ngx_syslog.c"
                   ;
}
...
ngx_syslog_cleanup(void *data)
{
    ...
    if (
# 374 "project/nginx/src/core/ngx_syslog.c" 3 4
       close
# 374 "project/nginx/src/core/ngx_syslog.c"
                       (peer->conn.fd) == -1) {
        
# 375 "project/nginx/src/core/ngx_syslog.c" 3 4
       if ((
# 375 "project/nginx/src/core/ngx_syslog.c"
       ngx_cycle->log
# 375 "project/nginx/src/core/ngx_syslog.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 375 "project/nginx/src/core/ngx_syslog.c"
...
# 376 "project/nginx/src/core/ngx_syslog.c"
                                                  ;
    }
}
