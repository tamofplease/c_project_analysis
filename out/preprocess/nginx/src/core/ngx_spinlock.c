# 0 "project/nginx/src/core/ngx_spinlock.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/core/ngx_spinlock.c"
...
# 9 "project/nginx/src/core/ngx_spinlock.c" 2
...
# 10 "project/nginx/src/core/ngx_spinlock.c" 2



# 12 "project/nginx/src/core/ngx_spinlock.c"
void
ngx_spinlock(ngx_atomic_t *lock, ngx_atomic_int_t value, ngx_uint_t spin)
{
    ...
    for ( ;; ) {
        ...
        if (*lock == 0 && 
# 22 "project/nginx/src/core/ngx_spinlock.c" 3 4
                         __sync_bool_compare_and_swap(
# 22 "project/nginx/src/core/ngx_spinlock.c"
                         lock
# 22 "project/nginx/src/core/ngx_spinlock.c" 3 4
                         , 
# 22 "project/nginx/src/core/ngx_spinlock.c"
...
# 31 "project/nginx/src/core/ngx_spinlock.c" 3 4
                   __asm__ ("pause")
# 31 "project/nginx/src/core/ngx_spinlock.c"
                                  ;
                }

                if (*lock == 0 && 
# 34 "project/nginx/src/core/ngx_spinlock.c" 3 4
                                 __sync_bool_compare_and_swap(
# 34 "project/nginx/src/core/ngx_spinlock.c"
                                 lock
# 34 "project/nginx/src/core/ngx_spinlock.c" 3 4
                                 , 
# 34 "project/nginx/src/core/ngx_spinlock.c"
...
# 40 "project/nginx/src/core/ngx_spinlock.c" 3 4
       sched_yield()
# 40 "project/nginx/src/core/ngx_spinlock.c"
                        ;
    }
# 53 "project/nginx/src/core/ngx_spinlock.c"
}
