# 0 "project/nginx/src/core/ngx_slab.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/core/ngx_slab.c"
...
# 8 "project/nginx/src/core/ngx_slab.c" 2
...
# 9 "project/nginx/src/core/ngx_slab.c" 2
# 72 "project/nginx/src/core/ngx_slab.c"
...
ngx_slab_init(ngx_slab_pool_t *pool)
{
    ...
    if (ngx_debug_malloc) 
# 114 "project/nginx/src/core/ngx_slab.c" 3 4
   (void) __builtin___memset_chk (
# 114 "project/nginx/src/core/ngx_slab.c"
   p
# 114 "project/nginx/src/core/ngx_slab.c" 3 4
   , 
# 114 "project/nginx/src/core/ngx_slab.c"
...
# 128 "project/nginx/src/core/ngx_slab.c" 3 4
   (void) __builtin___memset_chk (
# 128 "project/nginx/src/core/ngx_slab.c"
   pool->stats
# 128 "project/nginx/src/core/ngx_slab.c" 3 4
   , 0, 
# 128 "project/nginx/src/core/ngx_slab.c"
   n * sizeof(ngx_slab_stat_t)
# 128 "project/nginx/src/core/ngx_slab.c" 3 4
   , __builtin_object_size (
# 128 "project/nginx/src/core/ngx_slab.c"
   pool->stats
...
# 137 "project/nginx/src/core/ngx_slab.c" 3 4
   (void) __builtin___memset_chk (
# 137 "project/nginx/src/core/ngx_slab.c"
   pool->pages
# 137 "project/nginx/src/core/ngx_slab.c" 3 4
   , 0, 
# 137 "project/nginx/src/core/ngx_slab.c"
...
# 137 "project/nginx/src/core/ngx_slab.c"
    ...
    pool->start = 
# 150 "project/nginx/src/core/ngx_slab.c" 3 4
                 (u_char *) (((uintptr_t) (
# 150 "project/nginx/src/core/ngx_slab.c"
...
# 151 "project/nginx/src/core/ngx_slab.c"
                                            ;
...
ngx_slab_alloc_locked(ngx_slab_pool_t *pool, size_t size)
{
    ...
    if (size > ngx_slab_max_size) {
        ...
        if (page) {
            p = ((((page) - (pool)->pages) << ngx_pagesize_shift) + (uintptr_t) (pool)->start);
    ...
    if (page->next != page) {
        ...
        if (shift < ngx_slab_exact_shift) {
            ...
            bitmap = (uintptr_t *) ((((page) - (pool)->pages) << ngx_pagesize_shift) + (uintptr_t) (pool)->start);

            map = (ngx_pagesize >> shift) / (8 * sizeof(uintptr_t));

            for (n = 0; n < map; n++) {

                if (bitmap[n] != 0xffffffffffffffff) {
                    ...
                    for (m = 1, i = 0; m; m <<= 1, i++) {
                        ...
                        if (bitmap[n] == 0xffffffffffffffff) {
                            ...
                            prev = (ngx_slab_page_t *) ((page)->prev & ~3);
                            prev->next = page->next;
                            page->next->prev = page->prev;

                            page->next = 
# 262 "project/nginx/src/core/ngx_slab.c" 3 4
                                        ((void *)0)
# 262 "project/nginx/src/core/ngx_slab.c"
                                            ;
                            page->prev = 3;
                        }
            ...
            for (m = 1, i = 0; m; m <<= 1, i++) {
                ...
                if (page->slab == 0xffffffffffffffff) {
                    prev = (ngx_slab_page_t *) ((page)->prev & ~3);
                    prev->next = page->next;
                    page->next->prev = page->prev;

                    page->next = 
# 285 "project/nginx/src/core/ngx_slab.c" 3 4
                                ((void *)0)
# 285 "project/nginx/src/core/ngx_slab.c"
                                    ;
                    page->prev = 2;
                }

                p = ((((page) - (pool)->pages) << ngx_pagesize_shift) + (uintptr_t) (pool)->start) + (i << shift);
                 ...
                 m <<= 1, i++)
            {
                ...
                if ((page->slab & 0xffffffff00000000) == mask) {
                    prev = (ngx_slab_page_t *) ((page)->prev & ~3);
                    prev->next = page->next;
                    page->next->prev = page->prev;

                    page->next = 
# 316 "project/nginx/src/core/ngx_slab.c" 3 4
                                ((void *)0)
# 316 "project/nginx/src/core/ngx_slab.c"
                                    ;
                    page->prev = 1;
                }
        ...
        ngx_slab_error(pool, 
# 328 "project/nginx/src/core/ngx_slab.c" 3 4
                            2
# 328 "project/nginx/src/core/ngx_slab.c"
                                         , "ngx_slab_alloc(): page is busy");
        ngx_debug_point();
    }
    ...
    if (page) {
        if (shift < ngx_slab_exact_shift) {
            ...
            page->prev = (uintptr_t) &slots[slot] | 3;

            slots[slot].next = page;

            pool->stats[slot].total += (ngx_pagesize >> shift) - n;

            p = ((((page) - (pool)->pages) << ngx_pagesize_shift) + (uintptr_t) (pool)->start) + (n << shift);
            ...
            page->slab = 1;
            page->next = &slots[slot];
            page->prev = (uintptr_t) &slots[slot] | 2;
            ...
            page->slab = ((uintptr_t) 1 << 32) | shift;
            page->next = &slots[slot];
            page->prev = (uintptr_t) &slots[slot] | 1;
...
# 442 "project/nginx/src/core/ngx_slab.c" 3 4
       (void) __builtin___memset_chk (
# 442 "project/nginx/src/core/ngx_slab.c"
       p
# 442 "project/nginx/src/core/ngx_slab.c" 3 4
       , 0, 
# 442 "project/nginx/src/core/ngx_slab.c"
...
ngx_slab_free_locked(ngx_slab_pool_t *pool, void *p)
{
    ...
    if ((u_char *) p < pool->start || (u_char *) p > pool->end) {
        ngx_slab_error(pool, 
# 471 "project/nginx/src/core/ngx_slab.c" 3 4
                            2
# 471 "project/nginx/src/core/ngx_slab.c"
    ...
    case 3:
        ...
        if (bitmap[n] & m) {
            ...
            if (page->next == 
# 500 "project/nginx/src/core/ngx_slab.c" 3 4
                             ((void *)0)
# 500 "project/nginx/src/core/ngx_slab.c"
                                 ) {
                slots = (ngx_slab_page_t *) ((u_char *) (pool) + sizeof(ngx_slab_pool_t));
                ...
                page->prev = (uintptr_t) &slots[slot] | 3;
                page->next->prev = (uintptr_t) page | 3;
            }
    ...
    case 2:
        ...
        if (slab & m) {
            ...
            if (slab == 0xffffffffffffffff) {
                ...
                page->prev = (uintptr_t) &slots[slot] | 2;
                page->next->prev = (uintptr_t) page | 2;
            }
    ...
    case 1:
        ...
        if (slab & m) {
            ...
            if (page->next == 
# 595 "project/nginx/src/core/ngx_slab.c" 3 4
                             ((void *)0)
# 595 "project/nginx/src/core/ngx_slab.c"
                                 ) {
                slots = (ngx_slab_page_t *) ((u_char *) (pool) + sizeof(ngx_slab_pool_t));
                ...
                page->prev = (uintptr_t) &slots[slot] | 1;
                page->next->prev = (uintptr_t) page | 1;
            }

            page->slab &= ~m;

            if (page->slab & 0xffffffff00000000) {
                goto done;
            }
    ...
    case 0:
        ...
        if (!(slab & 0x8000000000000000)) {
            ngx_slab_error(pool, 
# 627 "project/nginx/src/core/ngx_slab.c" 3 4
                                2
# 627 "project/nginx/src/core/ngx_slab.c"
                                             ,
        ...
        if (slab == 0xffffffffffffffff) {
            ngx_slab_error(pool, 
# 633 "project/nginx/src/core/ngx_slab.c" 3 4
                                2
# 633 "project/nginx/src/core/ngx_slab.c"
                                             ,
                           "ngx_slab_free(): pointer to wrong page");
            goto fail;
        }

        size = slab & ~0x8000000000000000;

        ngx_slab_free_pages(pool, page, size);

        if (ngx_debug_malloc) 
# 642 "project/nginx/src/core/ngx_slab.c" 3 4
       (void) __builtin___memset_chk (
# 642 "project/nginx/src/core/ngx_slab.c"
       p
# 642 "project/nginx/src/core/ngx_slab.c" 3 4
       , 
# 642 "project/nginx/src/core/ngx_slab.c"
...
# 642 "project/nginx/src/core/ngx_slab.c"
    ...
    if (ngx_debug_malloc) 
# 655 "project/nginx/src/core/ngx_slab.c" 3 4
   (void) __builtin___memset_chk (
# 655 "project/nginx/src/core/ngx_slab.c"
   p
# 655 "project/nginx/src/core/ngx_slab.c" 3 4
   , 
# 655 "project/nginx/src/core/ngx_slab.c"
...
wrong_chunk:
    ...
    ngx_slab_error(pool, 
# 661 "project/nginx/src/core/ngx_slab.c" 3 4
                        2
# 661 "project/nginx/src/core/ngx_slab.c"
                                     ,
...
chunk_already_free:
    ...
    ngx_slab_error(pool, 
# 668 "project/nginx/src/core/ngx_slab.c" 3 4
                        2
# 668 "project/nginx/src/core/ngx_slab.c"
                                     ,
...
ngx_slab_alloc_pages(ngx_slab_pool_t *pool, ngx_uint_t pages)
{
    ...
    for (page = pool->free.next; page != &pool->free; page = page->next) {
        ...
        if (page->slab >= pages) {
            ...
            page->slab = pages | 0x8000000000000000;
            page->next = 
# 704 "project/nginx/src/core/ngx_slab.c" 3 4
                        ((void *)0)
# 704 "project/nginx/src/core/ngx_slab.c"
                            ;
            page->prev = 0;
            ...
            for (p = page + 1; pages; pages--) {
                p->slab = 0xffffffffffffffff;
                p->next = 
# 715 "project/nginx/src/core/ngx_slab.c" 3 4
                         ((void *)0)
# 715 "project/nginx/src/core/ngx_slab.c"
                             ;
                p->prev = 0;
                p++;
            }
    ...
    if (pool->log_nomem) {
        ngx_slab_error(pool, 
# 725 "project/nginx/src/core/ngx_slab.c" 3 4
                            3
# 725 "project/nginx/src/core/ngx_slab.c"
                                        ,
                       "ngx_slab_alloc() failed: no memory");
    }

    return 
# 729 "project/nginx/src/core/ngx_slab.c" 3 4
          ((void *)0)
# 729 "project/nginx/src/core/ngx_slab.c"
              ;
}
...
# 744 "project/nginx/src/core/ngx_slab.c" 3 4
       (void) __builtin___memset_chk (
# 744 "project/nginx/src/core/ngx_slab.c"
       &page[1]
# 744 "project/nginx/src/core/ngx_slab.c" 3 4
       , 0, 
# 744 "project/nginx/src/core/ngx_slab.c"
...
# 744 "project/nginx/src/core/ngx_slab.c"
    ...
    if (join < pool->last) {
        ...
        if (((join)->prev & 3) == 0) {
            ...
            if (join->next != 
# 759 "project/nginx/src/core/ngx_slab.c" 3 4
                             ((void *)0)
# 759 "project/nginx/src/core/ngx_slab.c"
                                 ) {
                pages += join->slab;
                page->slab += join->slab;

                prev = (ngx_slab_page_t *) ((join)->prev & ~3);
                prev->next = join->next;
                join->next->prev = join->prev;

                join->slab = 0;
                join->next = 
# 768 "project/nginx/src/core/ngx_slab.c" 3 4
                            ((void *)0)
# 768 "project/nginx/src/core/ngx_slab.c"
                                ;
                join->prev = 0;
            }
        }
    ...
    if (page > pool->pages) {
        ...
        if (((join)->prev & 3) == 0) {
            ...
            if (join->slab == 0) {
                join = (ngx_slab_page_t *) ((join)->prev & ~3);
            }

            if (join->next != 
# 783 "project/nginx/src/core/ngx_slab.c" 3 4
                             ((void *)0)
# 783 "project/nginx/src/core/ngx_slab.c"
                                 ) {
                pages += join->slab;
                join->slab += page->slab;
                ...
                page->slab = 0;
                page->next = 
# 792 "project/nginx/src/core/ngx_slab.c" 3 4
                            ((void *)0)
# 792 "project/nginx/src/core/ngx_slab.c"
                                ;
                page->prev = 0;
...
# 816 "project/nginx/src/core/ngx_slab.c" 3 4
   if ((
# 816 "project/nginx/src/core/ngx_slab.c"
   ngx_cycle->log
# 816 "project/nginx/src/core/ngx_slab.c" 3 4
   )->log_level >= 
# 816 "project/nginx/src/core/ngx_slab.c"
