# 0 "project/nginx/src/core/ngx_hash.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/core/ngx_hash.c"
...
# 9 "project/nginx/src/core/ngx_hash.c" 2
...
# 10 "project/nginx/src/core/ngx_hash.c" 2



# 12 "project/nginx/src/core/ngx_hash.c"
void *
ngx_hash_find(ngx_hash_t *hash, ngx_uint_t key, u_char *name, size_t len)
{
    ...
    if (elt == 
# 24 "project/nginx/src/core/ngx_hash.c" 3 4
              ((void *)0)
# 24 "project/nginx/src/core/ngx_hash.c"
                  ) {
        return 
# 25 "project/nginx/src/core/ngx_hash.c" 3 4
              ((void *)0)
# 25 "project/nginx/src/core/ngx_hash.c"
                  ;
    }
    ...
    next:
        ...
        elt = (ngx_hash_elt_t *) 
# 43 "project/nginx/src/core/ngx_hash.c" 3 4
                                (u_char *) (((uintptr_t) (
# 43 "project/nginx/src/core/ngx_hash.c"
                                &elt->name[0] + elt->len
# 43 "project/nginx/src/core/ngx_hash.c" 3 4
                                ) + ((uintptr_t) 
# 43 "project/nginx/src/core/ngx_hash.c"
...
# 44 "project/nginx/src/core/ngx_hash.c"
                                                             ;
        continue;
    }

    return 
# 48 "project/nginx/src/core/ngx_hash.c" 3 4
          ((void *)0)
# 48 "project/nginx/src/core/ngx_hash.c"
              ;
}
...
ngx_hash_find_wc_head(ngx_hash_wildcard_t *hwc, u_char *name, size_t len)
{
    ...
    for (i = n; i < len; i++) {
        key = 
# 75 "project/nginx/src/core/ngx_hash.c" 3 4
             ((ngx_uint_t) 
# 75 "project/nginx/src/core/ngx_hash.c"
             key 
# 75 "project/nginx/src/core/ngx_hash.c" 3 4
             * 31 + 
# 75 "project/nginx/src/core/ngx_hash.c"
...
# 75 "project/nginx/src/core/ngx_hash.c"
    ...
    if (value) {
# 101 "project/nginx/src/core/ngx_hash.c"
        if ((uintptr_t) value & 2) {
            ...
            if (n == 0) {
                ...
                if ((uintptr_t) value & 1) {
                    return 
# 108 "project/nginx/src/core/ngx_hash.c" 3 4
                          ((void *)0)
# 108 "project/nginx/src/core/ngx_hash.c"
                              ;
                }
        ...
        if ((uintptr_t) value & 1) {
            ...
            if (n == 0) {
                ...
                return 
# 133 "project/nginx/src/core/ngx_hash.c" 3 4
                      ((void *)0)
# 133 "project/nginx/src/core/ngx_hash.c"
                          ;
            }
...
ngx_hash_find_wc_tail(ngx_hash_wildcard_t *hwc, u_char *name, size_t len)
{
    ...
    for (i = 0; i < len; i++) {
        ...
        key = 
# 163 "project/nginx/src/core/ngx_hash.c" 3 4
             ((ngx_uint_t) 
# 163 "project/nginx/src/core/ngx_hash.c"
             key 
# 163 "project/nginx/src/core/ngx_hash.c" 3 4
             * 31 + 
# 163 "project/nginx/src/core/ngx_hash.c"
...
# 163 "project/nginx/src/core/ngx_hash.c"
    ...
    if (i == len) {
        return 
# 167 "project/nginx/src/core/ngx_hash.c" 3 4
              ((void *)0)
# 167 "project/nginx/src/core/ngx_hash.c"
                  ;
    }
    ...
    size_t len)
{
    ...
    if (len == 0) {
        return 
# 225 "project/nginx/src/core/ngx_hash.c" 3 4
              ((void *)0)
# 225 "project/nginx/src/core/ngx_hash.c"
                  ;
    }
    ...
    return 
# 244 "project/nginx/src/core/ngx_hash.c" 3 4
          ((void *)0)
# 244 "project/nginx/src/core/ngx_hash.c"
              ;
}
...
# 261 "project/nginx/src/core/ngx_hash.c" 3 4
       if ((
# 261 "project/nginx/src/core/ngx_hash.c"
       hinit->pool->log
# 261 "project/nginx/src/core/ngx_hash.c" 3 4
...
# 261 "project/nginx/src/core/ngx_hash.c" 3 4
       , 
# 261 "project/nginx/src/core/ngx_hash.c"
       0, "could not build %s, you should " "increase %s_max_size: %i", hinit->name, hinit->name, hinit->max_size
# 261 "project/nginx/src/core/ngx_hash.c" 3 4
       )


                                                                
# 264 "project/nginx/src/core/ngx_hash.c"
                                                               ;
        return 
# 265 "project/nginx/src/core/ngx_hash.c" 3 4
              -1
# 265 "project/nginx/src/core/ngx_hash.c"
                       ;
    }

    if (hinit->bucket_size > 65536 - ngx_cacheline_size) {
        
# 269 "project/nginx/src/core/ngx_hash.c" 3 4
       if ((
# 269 "project/nginx/src/core/ngx_hash.c"
       hinit->pool->log
# 269 "project/nginx/src/core/ngx_hash.c" 3 4
       )->log_level >= 1) ngx_log_error_core(1, 
# 269 "project/nginx/src/core/ngx_hash.c"
...
# 269 "project/nginx/src/core/ngx_hash.c" 3 4
       , 
# 269 "project/nginx/src/core/ngx_hash.c"
       0, "could not build %s, too large " "%s_bucket_size: %i", hinit->name, hinit->name, hinit->bucket_size
# 269 "project/nginx/src/core/ngx_hash.c" 3 4
       )


                                                                   
# 272 "project/nginx/src/core/ngx_hash.c"
                                                                  ;
        return 
# 273 "project/nginx/src/core/ngx_hash.c" 3 4
              -1
# 273 "project/nginx/src/core/ngx_hash.c"
                       ;
    }

    for (n = 0; n < nelts; n++) {
        if (names[n].key.data == 
# 277 "project/nginx/src/core/ngx_hash.c" 3 4
                                ((void *)0)
# 277 "project/nginx/src/core/ngx_hash.c"
                                    ) {
            continue;
        }

        if (hinit->bucket_size < (sizeof(void *) + 
# 281 "project/nginx/src/core/ngx_hash.c" 3 4
                                (((
# 281 "project/nginx/src/core/ngx_hash.c"
                                (&names[n])->key.len + 2
# 281 "project/nginx/src/core/ngx_hash.c" 3 4
                                ) + (
# 281 "project/nginx/src/core/ngx_hash.c"
...
# 283 "project/nginx/src/core/ngx_hash.c" 3 4
           if ((
# 283 "project/nginx/src/core/ngx_hash.c"
           hinit->pool->log
# 283 "project/nginx/src/core/ngx_hash.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 283 "project/nginx/src/core/ngx_hash.c"
...
# 283 "project/nginx/src/core/ngx_hash.c" 3 4
           , 
# 283 "project/nginx/src/core/ngx_hash.c"
           0, "could not build %s, you should " "increase %s_bucket_size: %i", hinit->name, hinit->name, hinit->bucket_size
# 283 "project/nginx/src/core/ngx_hash.c" 3 4
           )


                                                                       
# 286 "project/nginx/src/core/ngx_hash.c"
                                                                      ;
            return 
# 287 "project/nginx/src/core/ngx_hash.c" 3 4
                  -1
# 287 "project/nginx/src/core/ngx_hash.c"
                           ;
        }
    }
    ...
    if (test == 
# 292 "project/nginx/src/core/ngx_hash.c" 3 4
               ((void *)0)
# 292 "project/nginx/src/core/ngx_hash.c"
                   ) {
        return 
# 293 "project/nginx/src/core/ngx_hash.c" 3 4
              -1
# 293 "project/nginx/src/core/ngx_hash.c"
                       ;
    }
...
# 307 "project/nginx/src/core/ngx_hash.c" 3 4
       (void) __builtin___memset_chk (
# 307 "project/nginx/src/core/ngx_hash.c"
       test
# 307 "project/nginx/src/core/ngx_hash.c" 3 4
       , 0, 
# 307 "project/nginx/src/core/ngx_hash.c"
...
# 307 "project/nginx/src/core/ngx_hash.c"
        ...
        for (n = 0; n < nelts; n++) {
            if (names[n].key.data == 
# 310 "project/nginx/src/core/ngx_hash.c" 3 4
                                    ((void *)0)
# 310 "project/nginx/src/core/ngx_hash.c"
                                        ) {
                continue;
            }

            key = names[n].key_hash % size;
            len = test[key] + (sizeof(void *) + 
# 315 "project/nginx/src/core/ngx_hash.c" 3 4
                             (((
# 315 "project/nginx/src/core/ngx_hash.c"
                             (&names[n])->key.len + 2
# 315 "project/nginx/src/core/ngx_hash.c" 3 4
                             ) + (
# 315 "project/nginx/src/core/ngx_hash.c"
...
# 339 "project/nginx/src/core/ngx_hash.c" 3 4
   if ((
# 339 "project/nginx/src/core/ngx_hash.c"
   hinit->pool->log
# 339 "project/nginx/src/core/ngx_hash.c" 3 4
...
# 339 "project/nginx/src/core/ngx_hash.c" 3 4
   , 
# 339 "project/nginx/src/core/ngx_hash.c"
   0, "could not build optimal %s, you should increase " "either %s_max_size: %i or %s_bucket_size: %i; " "ignoring %s_bucket_size", hinit->name, hinit->name, hinit->max_size, hinit->name, hinit->bucket_size, hinit->name
# 339 "project/nginx/src/core/ngx_hash.c" 3 4
   )
...
# 344 "project/nginx/src/core/ngx_hash.c"
                                                              ;
...
found:
    ...
    for (n = 0; n < nelts; n++) {
        if (names[n].key.data == 
# 353 "project/nginx/src/core/ngx_hash.c" 3 4
                                ((void *)0)
# 353 "project/nginx/src/core/ngx_hash.c"
                                    ) {
            continue;
        }
        ...
        key = names[n].key_hash % size;
        len = test[key] + (sizeof(void *) + 
# 358 "project/nginx/src/core/ngx_hash.c" 3 4
                         (((
# 358 "project/nginx/src/core/ngx_hash.c"
                         (&names[n])->key.len + 2
# 358 "project/nginx/src/core/ngx_hash.c" 3 4
                         ) + (
# 358 "project/nginx/src/core/ngx_hash.c"
...
# 361 "project/nginx/src/core/ngx_hash.c" 3 4
           if ((
# 361 "project/nginx/src/core/ngx_hash.c"
           hinit->pool->log
# 361 "project/nginx/src/core/ngx_hash.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 361 "project/nginx/src/core/ngx_hash.c"
...
# 364 "project/nginx/src/core/ngx_hash.c"
                                                                   ;
            
# 365 "project/nginx/src/core/ngx_hash.c" 3 4
           free
# 365 "project/nginx/src/core/ngx_hash.c"
                   (test);
            return 
# 366 "project/nginx/src/core/ngx_hash.c" 3 4
                  -1
# 366 "project/nginx/src/core/ngx_hash.c"
                           ;
        }
    ...
    for (i = 0; i < size; i++) {
        ...
        test[i] = (u_short) (
# 379 "project/nginx/src/core/ngx_hash.c" 3 4
                            (((
# 379 "project/nginx/src/core/ngx_hash.c"
                            test[i]
# 379 "project/nginx/src/core/ngx_hash.c" 3 4
                            ) + (
# 379 "project/nginx/src/core/ngx_hash.c"
...
# 379 "project/nginx/src/core/ngx_hash.c"
    ...
    if (hinit->hash == 
# 384 "project/nginx/src/core/ngx_hash.c" 3 4
                      ((void *)0)
# 384 "project/nginx/src/core/ngx_hash.c"
                          ) {
        hinit->hash = ngx_pcalloc(hinit->pool, sizeof(ngx_hash_wildcard_t)
                                             + size * sizeof(ngx_hash_elt_t *));
        if (hinit->hash == 
# 387 "project/nginx/src/core/ngx_hash.c" 3 4
                          ((void *)0)
# 387 "project/nginx/src/core/ngx_hash.c"
                              ) {
            
# 388 "project/nginx/src/core/ngx_hash.c" 3 4
           free
# 388 "project/nginx/src/core/ngx_hash.c"
                   (test);
            return 
# 389 "project/nginx/src/core/ngx_hash.c" 3 4
                  -1
# 389 "project/nginx/src/core/ngx_hash.c"
                           ;
        }
        ...
        if (buckets == 
# 397 "project/nginx/src/core/ngx_hash.c" 3 4
                      ((void *)0)
# 397 "project/nginx/src/core/ngx_hash.c"
                          ) {
            
# 398 "project/nginx/src/core/ngx_hash.c" 3 4
           free
# 398 "project/nginx/src/core/ngx_hash.c"
                   (test);
            return 
# 399 "project/nginx/src/core/ngx_hash.c" 3 4
                  -1
# 399 "project/nginx/src/core/ngx_hash.c"
                           ;
        }
    }
    ...
    if (elts == 
# 404 "project/nginx/src/core/ngx_hash.c" 3 4
               ((void *)0)
# 404 "project/nginx/src/core/ngx_hash.c"
                   ) {
        
# 405 "project/nginx/src/core/ngx_hash.c" 3 4
       free
# 405 "project/nginx/src/core/ngx_hash.c"
               (test);
        return 
# 406 "project/nginx/src/core/ngx_hash.c" 3 4
              -1
# 406 "project/nginx/src/core/ngx_hash.c"
                       ;
    }

    elts = 
# 409 "project/nginx/src/core/ngx_hash.c" 3 4
          (u_char *) (((uintptr_t) (
# 409 "project/nginx/src/core/ngx_hash.c"
          elts
# 409 "project/nginx/src/core/ngx_hash.c" 3 4
          ) + ((uintptr_t) 
# 409 "project/nginx/src/core/ngx_hash.c"
...
# 409 "project/nginx/src/core/ngx_hash.c"
    ...
    for (n = 0; n < nelts; n++) {
        if (names[n].key.data == 
# 425 "project/nginx/src/core/ngx_hash.c" 3 4
                                ((void *)0)
# 425 "project/nginx/src/core/ngx_hash.c"
                                    ) {
            continue;
        }
        ...
        test[key] = (u_short) (test[key] + (sizeof(void *) + 
# 437 "project/nginx/src/core/ngx_hash.c" 3 4
                                          (((
# 437 "project/nginx/src/core/ngx_hash.c"
                                          (&names[n])->key.len + 2
# 437 "project/nginx/src/core/ngx_hash.c" 3 4
                                          ) + (
# 437 "project/nginx/src/core/ngx_hash.c"
...
# 437 "project/nginx/src/core/ngx_hash.c"
    ...
    for (i = 0; i < size; i++) {
        if (buckets[i] == 
# 441 "project/nginx/src/core/ngx_hash.c" 3 4
                         ((void *)0)
# 441 "project/nginx/src/core/ngx_hash.c"
                             ) {
            continue;
        }
        ...
        elt->value = 
# 447 "project/nginx/src/core/ngx_hash.c" 3 4
                    ((void *)0)
# 447 "project/nginx/src/core/ngx_hash.c"
                        ;
    }

    
# 450 "project/nginx/src/core/ngx_hash.c" 3 4
   free
# 450 "project/nginx/src/core/ngx_hash.c"
           (test);

    hinit->hash->buckets = buckets;
    hinit->hash->size = size;
# 485 "project/nginx/src/core/ngx_hash.c"
    return 
# 485 "project/nginx/src/core/ngx_hash.c" 3 4
          0
# 485 "project/nginx/src/core/ngx_hash.c"
                ;
}
    ...
    ngx_uint_t nelts)
{
    ...
    if (ngx_array_init(&curr_names, hinit->temp_pool, nelts,
        ...
        != 
# 502 "project/nginx/src/core/ngx_hash.c" 3 4
          0
# 502 "project/nginx/src/core/ngx_hash.c"
                )
    {
        return 
# 504 "project/nginx/src/core/ngx_hash.c" 3 4
              -1
# 504 "project/nginx/src/core/ngx_hash.c"
                       ;
    }
    ...
    if (ngx_array_init(&next_names, hinit->temp_pool, nelts,
                       sizeof(ngx_hash_key_t))
        != 
# 509 "project/nginx/src/core/ngx_hash.c" 3 4
          0
# 509 "project/nginx/src/core/ngx_hash.c"
                )
    {
        return 
# 511 "project/nginx/src/core/ngx_hash.c" 3 4
              -1
# 511 "project/nginx/src/core/ngx_hash.c"
                       ;
    }
    ...
    for (n = 0; n < nelts; n = i) {
        ...
        if (name == 
# 531 "project/nginx/src/core/ngx_hash.c" 3 4
                   ((void *)0)
# 531 "project/nginx/src/core/ngx_hash.c"
                       ) {
            return 
# 532 "project/nginx/src/core/ngx_hash.c" 3 4
                  -1
# 532 "project/nginx/src/core/ngx_hash.c"
                           ;
        }
        ...
        if (names[n].key.len != len) {
            ...
            if (next_name == 
# 555 "project/nginx/src/core/ngx_hash.c" 3 4
                            ((void *)0)
# 555 "project/nginx/src/core/ngx_hash.c"
                                ) {
                return 
# 556 "project/nginx/src/core/ngx_hash.c" 3 4
                      -1
# 556 "project/nginx/src/core/ngx_hash.c"
                               ;
            }
        ...
        for (i = n + 1; i < nelts; i++) {
            if (
# 571 "project/nginx/src/core/ngx_hash.c" 3 4
               strncmp((const char *) 
# 571 "project/nginx/src/core/ngx_hash.c"
               names[n].key.data
# 571 "project/nginx/src/core/ngx_hash.c" 3 4
               , (const char *) 
# 571 "project/nginx/src/core/ngx_hash.c"
...
# 571 "project/nginx/src/core/ngx_hash.c"
            ...
            next_name = ngx_array_push(&next_names);
            if (next_name == 
# 583 "project/nginx/src/core/ngx_hash.c" 3 4
                            ((void *)0)
# 583 "project/nginx/src/core/ngx_hash.c"
                                ) {
                return 
# 584 "project/nginx/src/core/ngx_hash.c" 3 4
                      -1
# 584 "project/nginx/src/core/ngx_hash.c"
                               ;
            }
        ...
        if (next_names.nelts) {
            ...
            h = *hinit;
            h.hash = 
# 601 "project/nginx/src/core/ngx_hash.c" 3 4
                    ((void *)0)
# 601 "project/nginx/src/core/ngx_hash.c"
                        ;

            if (ngx_hash_wildcard_init(&h, (ngx_hash_key_t *) next_names.elts,
                                       next_names.nelts)
                != 
# 605 "project/nginx/src/core/ngx_hash.c" 3 4
                  0
# 605 "project/nginx/src/core/ngx_hash.c"
                        )
            {
                return 
# 607 "project/nginx/src/core/ngx_hash.c" 3 4
                      -1
# 607 "project/nginx/src/core/ngx_hash.c"
                               ;
            }
    ...
    if (ngx_hash_init(hinit, (ngx_hash_key_t *) curr_names.elts,
                      curr_names.nelts)
        != 
# 625 "project/nginx/src/core/ngx_hash.c" 3 4
          0
# 625 "project/nginx/src/core/ngx_hash.c"
                )
    {
        return 
# 627 "project/nginx/src/core/ngx_hash.c" 3 4
              -1
# 627 "project/nginx/src/core/ngx_hash.c"
                       ;
    }

    return 
# 630 "project/nginx/src/core/ngx_hash.c" 3 4
          0
# 630 "project/nginx/src/core/ngx_hash.c"
                ;
}
...
ngx_hash_key(u_char *data, size_t len)
{
    ...
    for (i = 0; i < len; i++) {
        key = 
# 642 "project/nginx/src/core/ngx_hash.c" 3 4
             ((ngx_uint_t) 
# 642 "project/nginx/src/core/ngx_hash.c"
             key 
# 642 "project/nginx/src/core/ngx_hash.c" 3 4
             * 31 + 
# 642 "project/nginx/src/core/ngx_hash.c"
...
ngx_hash_key_lc(u_char *data, size_t len)
{
    ...
    for (i = 0; i < len; i++) {
        key = 
# 657 "project/nginx/src/core/ngx_hash.c" 3 4
             ((ngx_uint_t) 
# 657 "project/nginx/src/core/ngx_hash.c"
             key 
# 657 "project/nginx/src/core/ngx_hash.c" 3 4
             * 31 + (u_char) ((
# 657 "project/nginx/src/core/ngx_hash.c"
...
ngx_hash_strlow(u_char *dst, u_char *src, size_t n)
{
    ...
    while (n--) {
        *dst = 
# 672 "project/nginx/src/core/ngx_hash.c" 3 4
              (u_char) ((
# 672 "project/nginx/src/core/ngx_hash.c"
              *src 
# 672 "project/nginx/src/core/ngx_hash.c" 3 4
              >= 'A' && 
# 672 "project/nginx/src/core/ngx_hash.c"
...
# 672 "project/nginx/src/core/ngx_hash.c"
                               ;
        key = 
# 673 "project/nginx/src/core/ngx_hash.c" 3 4
             ((ngx_uint_t) 
# 673 "project/nginx/src/core/ngx_hash.c"
             key 
# 673 "project/nginx/src/core/ngx_hash.c" 3 4
             * 31 + 
# 673 "project/nginx/src/core/ngx_hash.c"
...
ngx_hash_keys_array_init(ngx_hash_keys_arrays_t *ha, ngx_uint_t type)
{
    ...
    if (type == 
# 687 "project/nginx/src/core/ngx_hash.c" 3 4
               1
# 687 "project/nginx/src/core/ngx_hash.c"
                             ) {
        asize = 4;
        ha->hsize = 107;
        ...
        asize = 
# 692 "project/nginx/src/core/ngx_hash.c" 3 4
               16384
# 692 "project/nginx/src/core/ngx_hash.c"
                                   ;
        ha->hsize = 
# 693 "project/nginx/src/core/ngx_hash.c" 3 4
                   10007
# 693 "project/nginx/src/core/ngx_hash.c"
                                       ;
    }

    if (ngx_array_init(&ha->keys, ha->temp_pool, asize, sizeof(ngx_hash_key_t))
        != 
# 697 "project/nginx/src/core/ngx_hash.c" 3 4
          0
# 697 "project/nginx/src/core/ngx_hash.c"
                )
    {
        return 
# 699 "project/nginx/src/core/ngx_hash.c" 3 4
              -1
# 699 "project/nginx/src/core/ngx_hash.c"
                       ;
    }
    ...
    if (ngx_array_init(&ha->dns_wc_head, ha->temp_pool, asize,
                       sizeof(ngx_hash_key_t))
        != 
# 704 "project/nginx/src/core/ngx_hash.c" 3 4
          0
# 704 "project/nginx/src/core/ngx_hash.c"
                )
    {
        return 
# 706 "project/nginx/src/core/ngx_hash.c" 3 4
              -1
# 706 "project/nginx/src/core/ngx_hash.c"
                       ;
    }
    ...
    if (ngx_array_init(&ha->dns_wc_tail, ha->temp_pool, asize,
                       sizeof(ngx_hash_key_t))
        != 
# 711 "project/nginx/src/core/ngx_hash.c" 3 4
          0
# 711 "project/nginx/src/core/ngx_hash.c"
                )
    {
        return 
# 713 "project/nginx/src/core/ngx_hash.c" 3 4
              -1
# 713 "project/nginx/src/core/ngx_hash.c"
                       ;
    }

    ha->keys_hash = ngx_pcalloc(ha->temp_pool, sizeof(ngx_array_t) * ha->hsize);
    if (ha->keys_hash == 
# 717 "project/nginx/src/core/ngx_hash.c" 3 4
                        ((void *)0)
# 717 "project/nginx/src/core/ngx_hash.c"
                            ) {
        return 
# 718 "project/nginx/src/core/ngx_hash.c" 3 4
              -1
# 718 "project/nginx/src/core/ngx_hash.c"
                       ;
    }
...
# 723 "project/nginx/src/core/ngx_hash.c" 3 4
                               ((void *)0)
# 723 "project/nginx/src/core/ngx_hash.c"
                                   ) {
        return 
# 724 "project/nginx/src/core/ngx_hash.c" 3 4
              -1
# 724 "project/nginx/src/core/ngx_hash.c"
                       ;
    }
...
# 729 "project/nginx/src/core/ngx_hash.c" 3 4
                               ((void *)0)
# 729 "project/nginx/src/core/ngx_hash.c"
                                   ) {
        return 
# 730 "project/nginx/src/core/ngx_hash.c" 3 4
              -1
# 730 "project/nginx/src/core/ngx_hash.c"
                       ;
    }

    return 
# 733 "project/nginx/src/core/ngx_hash.c" 3 4
          0
# 733 "project/nginx/src/core/ngx_hash.c"
                ;
}
    ...
    ngx_uint_t flags)
{
    ...
    if (flags & 
# 750 "project/nginx/src/core/ngx_hash.c" 3 4
               1
# 750 "project/nginx/src/core/ngx_hash.c"
                                    ) {
        ...
        for (i = 0; i < key->len; i++) {
            ...
            if (key->data[i] == '*') {
                if (++n > 1) {
                    return 
# 763 "project/nginx/src/core/ngx_hash.c" 3 4
                          -5
# 763 "project/nginx/src/core/ngx_hash.c"
                                      ;
                }
            }
            ...
            if (key->data[i] == '.' && key->data[i + 1] == '.') {
                return 
# 768 "project/nginx/src/core/ngx_hash.c" 3 4
                      -5
# 768 "project/nginx/src/core/ngx_hash.c"
                                  ;
            }

            if (key->data[i] == '\0') {
                return 
# 772 "project/nginx/src/core/ngx_hash.c" 3 4
                      -5
# 772 "project/nginx/src/core/ngx_hash.c"
                                  ;
            }
        }
        ...
        if (n) {
            return 
# 796 "project/nginx/src/core/ngx_hash.c" 3 4
                  -5
# 796 "project/nginx/src/core/ngx_hash.c"
                              ;
        }
    }
    ...
    for (i = 0; i < last; i++) {
        if (!(flags & 
# 805 "project/nginx/src/core/ngx_hash.c" 3 4
                     2
# 805 "project/nginx/src/core/ngx_hash.c"
                                          )) {
            key->data[i] = 
# 806 "project/nginx/src/core/ngx_hash.c" 3 4
                          (u_char) ((
# 806 "project/nginx/src/core/ngx_hash.c"
                          key->data[i] 
# 806 "project/nginx/src/core/ngx_hash.c" 3 4
                          >= 'A' && 
# 806 "project/nginx/src/core/ngx_hash.c"
...
# 806 "project/nginx/src/core/ngx_hash.c"
        ...
        k = 
# 808 "project/nginx/src/core/ngx_hash.c" 3 4
           ((ngx_uint_t) 
# 808 "project/nginx/src/core/ngx_hash.c"
           k 
# 808 "project/nginx/src/core/ngx_hash.c" 3 4
           * 31 + 
# 808 "project/nginx/src/core/ngx_hash.c"
...
# 808 "project/nginx/src/core/ngx_hash.c"
    ...
    if (name) {
        for (i = 0; i < ha->keys_hash[k].nelts; i++) {
            ...
            if (
# 823 "project/nginx/src/core/ngx_hash.c" 3 4
               strncmp((const char *) 
# 823 "project/nginx/src/core/ngx_hash.c"
               key->data
# 823 "project/nginx/src/core/ngx_hash.c" 3 4
               , (const char *) 
# 823 "project/nginx/src/core/ngx_hash.c"
...
# 823 "project/nginx/src/core/ngx_hash.c"
                                                          == 0) {
                return 
# 824 "project/nginx/src/core/ngx_hash.c" 3 4
                      -3
# 824 "project/nginx/src/core/ngx_hash.c"
                              ;
            }
        }
        ...
        if (ngx_array_init(&ha->keys_hash[k], ha->temp_pool, 4,
                           sizeof(ngx_str_t))
            != 
# 831 "project/nginx/src/core/ngx_hash.c" 3 4
              0
# 831 "project/nginx/src/core/ngx_hash.c"
                    )
        {
            return 
# 833 "project/nginx/src/core/ngx_hash.c" 3 4
                  -1
# 833 "project/nginx/src/core/ngx_hash.c"
                           ;
        }
    }
    ...
    if (name == 
# 838 "project/nginx/src/core/ngx_hash.c" 3 4
               ((void *)0)
# 838 "project/nginx/src/core/ngx_hash.c"
                   ) {
        return 
# 839 "project/nginx/src/core/ngx_hash.c" 3 4
              -1
# 839 "project/nginx/src/core/ngx_hash.c"
                       ;
    }
    ...
    *name = *key;
    ...
    if (hk == 
# 845 "project/nginx/src/core/ngx_hash.c" 3 4
             ((void *)0)
# 845 "project/nginx/src/core/ngx_hash.c"
                 ) {
        return 
# 846 "project/nginx/src/core/ngx_hash.c" 3 4
              -1
# 846 "project/nginx/src/core/ngx_hash.c"
                       ;
    }
    ...
    return 
# 853 "project/nginx/src/core/ngx_hash.c" 3 4
          0
# 853 "project/nginx/src/core/ngx_hash.c"
                ;
    ...
    if (skip == 1) {
        ...
        if (name) {
            ...
            for (i = 0; i < ha->keys_hash[k].nelts; i++) {
                ...
                if (
# 878 "project/nginx/src/core/ngx_hash.c" 3 4
                   strncmp((const char *) 
# 878 "project/nginx/src/core/ngx_hash.c"
                   &key->data[1]
# 878 "project/nginx/src/core/ngx_hash.c" 3 4
                   , (const char *) 
# 878 "project/nginx/src/core/ngx_hash.c"
...
# 878 "project/nginx/src/core/ngx_hash.c"
                                                                 == 0) {
                    return 
# 879 "project/nginx/src/core/ngx_hash.c" 3 4
                          -3
# 879 "project/nginx/src/core/ngx_hash.c"
                                  ;
                }
            }
            ...
            if (ngx_array_init(&ha->keys_hash[k], ha->temp_pool, 4,
                               sizeof(ngx_str_t))
                != 
# 886 "project/nginx/src/core/ngx_hash.c" 3 4
                  0
# 886 "project/nginx/src/core/ngx_hash.c"
                        )
            {
                return 
# 888 "project/nginx/src/core/ngx_hash.c" 3 4
                      -1
# 888 "project/nginx/src/core/ngx_hash.c"
                               ;
            }
        }
        ...
        name = ngx_array_push(&ha->keys_hash[k]);
        if (name == 
# 893 "project/nginx/src/core/ngx_hash.c" 3 4
                   ((void *)0)
# 893 "project/nginx/src/core/ngx_hash.c"
                       ) {
            return 
# 894 "project/nginx/src/core/ngx_hash.c" 3 4
                  -1
# 894 "project/nginx/src/core/ngx_hash.c"
                           ;
        }
        ...
        if (name->data == 
# 899 "project/nginx/src/core/ngx_hash.c" 3 4
                         ((void *)0)
# 899 "project/nginx/src/core/ngx_hash.c"
                             ) {
            return 
# 900 "project/nginx/src/core/ngx_hash.c" 3 4
                  -1
# 900 "project/nginx/src/core/ngx_hash.c"
                           ;
        }

        
# 903 "project/nginx/src/core/ngx_hash.c" 3 4
       (void) __builtin___memcpy_chk (
# 903 "project/nginx/src/core/ngx_hash.c"
       name->data
# 903 "project/nginx/src/core/ngx_hash.c" 3 4
       , 
# 903 "project/nginx/src/core/ngx_hash.c"
...
# 903 "project/nginx/src/core/ngx_hash.c"
    ...
    if (skip) {
        ...
        if (p == 
# 915 "project/nginx/src/core/ngx_hash.c" 3 4
                ((void *)0)
# 915 "project/nginx/src/core/ngx_hash.c"
                    ) {
            return 
# 916 "project/nginx/src/core/ngx_hash.c" 3 4
                  -1
# 916 "project/nginx/src/core/ngx_hash.c"
                           ;
        }
...
# 924 "project/nginx/src/core/ngx_hash.c" 3 4
               (void) __builtin___memcpy_chk (
# 924 "project/nginx/src/core/ngx_hash.c"
               &p[n]
# 924 "project/nginx/src/core/ngx_hash.c" 3 4
               , 
# 924 "project/nginx/src/core/ngx_hash.c"
...
# 935 "project/nginx/src/core/ngx_hash.c" 3 4
           (void) __builtin___memcpy_chk (
# 935 "project/nginx/src/core/ngx_hash.c"
           &p[n]
# 935 "project/nginx/src/core/ngx_hash.c" 3 4
           , 
# 935 "project/nginx/src/core/ngx_hash.c"
...
# 935 "project/nginx/src/core/ngx_hash.c"
        ...
        p = ngx_pnalloc(ha->temp_pool, last);
        if (p == 
# 951 "project/nginx/src/core/ngx_hash.c" 3 4
                ((void *)0)
# 951 "project/nginx/src/core/ngx_hash.c"
                    ) {
            return 
# 952 "project/nginx/src/core/ngx_hash.c" 3 4
                  -1
# 952 "project/nginx/src/core/ngx_hash.c"
                           ;
        }
    ...
    if (name) {
        ...
        for (i = 0; i < keys->nelts; i++) {
            ...
            if (
# 974 "project/nginx/src/core/ngx_hash.c" 3 4
               strncmp((const char *) 
# 974 "project/nginx/src/core/ngx_hash.c"
               key->data + skip
# 974 "project/nginx/src/core/ngx_hash.c" 3 4
               , (const char *) 
# 974 "project/nginx/src/core/ngx_hash.c"
...
# 974 "project/nginx/src/core/ngx_hash.c"
                                                                == 0) {
                return 
# 975 "project/nginx/src/core/ngx_hash.c" 3 4
                      -3
# 975 "project/nginx/src/core/ngx_hash.c"
                              ;
            }
        }

    } else {
        if (ngx_array_init(keys, ha->temp_pool, 4, sizeof(ngx_str_t)) != 
# 980 "project/nginx/src/core/ngx_hash.c" 3 4
                                                                        0
# 980 "project/nginx/src/core/ngx_hash.c"
                                                                              )
        {
            return 
# 982 "project/nginx/src/core/ngx_hash.c" 3 4
                  -1
# 982 "project/nginx/src/core/ngx_hash.c"
                           ;
        }
    }
    ...
    if (name == 
# 987 "project/nginx/src/core/ngx_hash.c" 3 4
               ((void *)0)
# 987 "project/nginx/src/core/ngx_hash.c"
                   ) {
        return 
# 988 "project/nginx/src/core/ngx_hash.c" 3 4
              -1
# 988 "project/nginx/src/core/ngx_hash.c"
                       ;
    }
    ...
    name->data = ngx_pnalloc(ha->temp_pool, name->len);
    if (name->data == 
# 993 "project/nginx/src/core/ngx_hash.c" 3 4
                     ((void *)0)
# 993 "project/nginx/src/core/ngx_hash.c"
                         ) {
        return 
# 994 "project/nginx/src/core/ngx_hash.c" 3 4
              -1
# 994 "project/nginx/src/core/ngx_hash.c"
                       ;
    }

    
# 997 "project/nginx/src/core/ngx_hash.c" 3 4
   (void) __builtin___memcpy_chk (
# 997 "project/nginx/src/core/ngx_hash.c"
   name->data
# 997 "project/nginx/src/core/ngx_hash.c" 3 4
   , 
# 997 "project/nginx/src/core/ngx_hash.c"
...
# 997 "project/nginx/src/core/ngx_hash.c"
    ...
    if (hk == 
# 1003 "project/nginx/src/core/ngx_hash.c" 3 4
             ((void *)0)
# 1003 "project/nginx/src/core/ngx_hash.c"
                 ) {
        return 
# 1004 "project/nginx/src/core/ngx_hash.c" 3 4
              -1
# 1004 "project/nginx/src/core/ngx_hash.c"
                       ;
    }
    ...
    return 
# 1012 "project/nginx/src/core/ngx_hash.c" 3 4
          0
# 1012 "project/nginx/src/core/ngx_hash.c"
                ;
}
