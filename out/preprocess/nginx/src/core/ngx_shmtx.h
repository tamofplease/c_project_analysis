# 0 "project/nginx/src/core/ngx_shmtx.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/core/ngx_shmtx.h"
# 12 "project/nginx/src/core/ngx_shmtx.h"
...
# 13 "project/nginx/src/core/ngx_shmtx.h" 2
...
# 14 "project/nginx/src/core/ngx_shmtx.h" 2



# 16 "project/nginx/src/core/ngx_shmtx.h"
typedef struct {
    ngx_atomic_t lock;
...
typedef struct {
    ...
    ngx_atomic_t *lock;
# 36 "project/nginx/src/core/ngx_shmtx.h"
    ngx_uint_t spin;
} ngx_shmtx_t;
