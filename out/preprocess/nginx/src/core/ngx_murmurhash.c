# 0 "project/nginx/src/core/ngx_murmurhash.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/core/ngx_murmurhash.c"
...
# 8 "project/nginx/src/core/ngx_murmurhash.c" 2
...
# 9 "project/nginx/src/core/ngx_murmurhash.c" 2



# 11 "project/nginx/src/core/ngx_murmurhash.c"
uint32_t
