# 0 "project/nginx/src/core/ngx_list.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/core/ngx_list.h"
# 12 "project/nginx/src/core/ngx_list.h"
...
# 13 "project/nginx/src/core/ngx_list.h" 2
...
# 14 "project/nginx/src/core/ngx_list.h" 2



# 16 "project/nginx/src/core/ngx_list.h"
...
static 
# 36 "project/nginx/src/core/ngx_list.h" 3 4
      inline 
# 36 "project/nginx/src/core/ngx_list.h"
                 ngx_int_t
ngx_list_init(ngx_list_t *list, ngx_pool_t *pool, ngx_uint_t n, size_t size)
{
    list->part.elts = ngx_palloc(pool, n * size);
    if (list->part.elts == 
# 40 "project/nginx/src/core/ngx_list.h" 3 4
                          ((void *)0)
# 40 "project/nginx/src/core/ngx_list.h"
                              ) {
        return 
# 41 "project/nginx/src/core/ngx_list.h" 3 4
              -1
# 41 "project/nginx/src/core/ngx_list.h"
                       ;
    }

    list->part.nelts = 0;
    list->part.next = 
# 45 "project/nginx/src/core/ngx_list.h" 3 4
                     ((void *)0)
# 45 "project/nginx/src/core/ngx_list.h"
                         ;
    list->last = &list->part;
    list->size = size;
    list->nalloc = n;
    ...
    return 
# 51 "project/nginx/src/core/ngx_list.h" 3 4
          0
# 51 "project/nginx/src/core/ngx_list.h"
                ;
}
# 80 "project/nginx/src/core/ngx_list.h"
