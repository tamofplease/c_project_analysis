# 0 "project/nginx/src/core/ngx_shmtx.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/core/ngx_shmtx.c"
...
# 9 "project/nginx/src/core/ngx_shmtx.c" 2
...
# 10 "project/nginx/src/core/ngx_shmtx.c" 2
...
# 15 "project/nginx/src/core/ngx_shmtx.c"
...
ngx_shmtx_create(ngx_shmtx_t *mtx, ngx_shmtx_sh_t *addr, u_char *name)
{
    ...
    if (mtx->spin == (ngx_uint_t) -1) {
        return 
# 24 "project/nginx/src/core/ngx_shmtx.c" 3 4
              0
# 24 "project/nginx/src/core/ngx_shmtx.c"
                    ;
    }

    mtx->spin = 2048;
# 42 "project/nginx/src/core/ngx_shmtx.c"
    return 
# 42 "project/nginx/src/core/ngx_shmtx.c" 3 4
          0
# 42 "project/nginx/src/core/ngx_shmtx.c"
                ;
}
...
{
# 59 "project/nginx/src/core/ngx_shmtx.c"
}
...
{
    return (*mtx->lock == 0 && 
# 65 "project/nginx/src/core/ngx_shmtx.c" 3 4
                              __sync_bool_compare_and_swap(
# 65 "project/nginx/src/core/ngx_shmtx.c"
                              mtx->lock
# 65 "project/nginx/src/core/ngx_shmtx.c" 3 4
                              , 
# 65 "project/nginx/src/core/ngx_shmtx.c"
...
ngx_shmtx_lock(ngx_shmtx_t *mtx)
{
    ...
    for ( ;; ) {
        ...
        if (*mtx->lock == 0 && 
# 78 "project/nginx/src/core/ngx_shmtx.c" 3 4
                              __sync_bool_compare_and_swap(
# 78 "project/nginx/src/core/ngx_shmtx.c"
                              mtx->lock
# 78 "project/nginx/src/core/ngx_shmtx.c" 3 4
                              , 
# 78 "project/nginx/src/core/ngx_shmtx.c"
...
# 87 "project/nginx/src/core/ngx_shmtx.c" 3 4
                   __asm__ ("pause")
# 87 "project/nginx/src/core/ngx_shmtx.c"
                                  ;
                }

                if (*mtx->lock == 0
                    && 
# 91 "project/nginx/src/core/ngx_shmtx.c" 3 4
                      __sync_bool_compare_and_swap(
# 91 "project/nginx/src/core/ngx_shmtx.c"
                      mtx->lock
# 91 "project/nginx/src/core/ngx_shmtx.c" 3 4
                      , 
# 91 "project/nginx/src/core/ngx_shmtx.c"
...
# 131 "project/nginx/src/core/ngx_shmtx.c"
        
# 131 "project/nginx/src/core/ngx_shmtx.c" 3 4
       sched_yield()
# 131 "project/nginx/src/core/ngx_shmtx.c"
                        ;
    }
...
ngx_shmtx_unlock(ngx_shmtx_t *mtx)
{
    ...
    if (
# 143 "project/nginx/src/core/ngx_shmtx.c" 3 4
       __sync_bool_compare_and_swap(
# 143 "project/nginx/src/core/ngx_shmtx.c"
       mtx->lock
# 143 "project/nginx/src/core/ngx_shmtx.c" 3 4
       , 
# 143 "project/nginx/src/core/ngx_shmtx.c"
...
ngx_shmtx_force_unlock(ngx_shmtx_t *mtx, ngx_pid_t pid)
{
    ...
    if (
# 155 "project/nginx/src/core/ngx_shmtx.c" 3 4
       __sync_bool_compare_and_swap(
# 155 "project/nginx/src/core/ngx_shmtx.c"
       mtx->lock
# 155 "project/nginx/src/core/ngx_shmtx.c" 3 4
       , 
# 155 "project/nginx/src/core/ngx_shmtx.c"
...
{
# 196 "project/nginx/src/core/ngx_shmtx.c"
}
