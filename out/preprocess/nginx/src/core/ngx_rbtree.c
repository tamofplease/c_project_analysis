# 0 "project/nginx/src/core/ngx_rbtree.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/core/ngx_rbtree.c"
...
# 9 "project/nginx/src/core/ngx_rbtree.c" 2
...
# 10 "project/nginx/src/core/ngx_rbtree.c" 2
# 18 "project/nginx/src/core/ngx_rbtree.c"

# 18 "project/nginx/src/core/ngx_rbtree.c"
static 
# 18 "project/nginx/src/core/ngx_rbtree.c" 3 4
      inline 
# 18 "project/nginx/src/core/ngx_rbtree.c"
                 void ngx_rbtree_left_rotate(ngx_rbtree_node_t **root,
    ngx_rbtree_node_t *sentinel, ngx_rbtree_node_t *node);
static 
# 20 "project/nginx/src/core/ngx_rbtree.c" 3 4
      inline 
# 20 "project/nginx/src/core/ngx_rbtree.c"
...
ngx_rbtree_insert(ngx_rbtree_t *tree, ngx_rbtree_node_t *node)
{
    ...
    if (*root == sentinel) {
        node->parent = 
# 35 "project/nginx/src/core/ngx_rbtree.c" 3 4
                      ((void *)0)
# 35 "project/nginx/src/core/ngx_rbtree.c"
                          ;
        node->left = sentinel;
        node->right = sentinel;
        
# 38 "project/nginx/src/core/ngx_rbtree.c" 3 4
       ((
# 38 "project/nginx/src/core/ngx_rbtree.c"
       node
# 38 "project/nginx/src/core/ngx_rbtree.c" 3 4
       )->color = 0)
# 38 "project/nginx/src/core/ngx_rbtree.c"
    ...
    while (node != *root && 
# 48 "project/nginx/src/core/ngx_rbtree.c" 3 4
                           ((
# 48 "project/nginx/src/core/ngx_rbtree.c"
                           node->parent
# 48 "project/nginx/src/core/ngx_rbtree.c" 3 4
                           )->color)
# 48 "project/nginx/src/core/ngx_rbtree.c"
        ...
        if (node->parent == node->parent->parent->left) {
            ...
            if (
# 53 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 53 "project/nginx/src/core/ngx_rbtree.c"
               temp
# 53 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color)
# 53 "project/nginx/src/core/ngx_rbtree.c"
...
# 54 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 54 "project/nginx/src/core/ngx_rbtree.c"
               node->parent
# 54 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color = 0)
# 54 "project/nginx/src/core/ngx_rbtree.c"
...
# 55 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 55 "project/nginx/src/core/ngx_rbtree.c"
               temp
# 55 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color = 0)
# 55 "project/nginx/src/core/ngx_rbtree.c"
...
# 56 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 56 "project/nginx/src/core/ngx_rbtree.c"
               node->parent->parent
# 56 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color = 1)
# 56 "project/nginx/src/core/ngx_rbtree.c"
...
# 65 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 65 "project/nginx/src/core/ngx_rbtree.c"
               node->parent
# 65 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color = 0)
# 65 "project/nginx/src/core/ngx_rbtree.c"
...
# 66 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 66 "project/nginx/src/core/ngx_rbtree.c"
               node->parent->parent
# 66 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color = 1)
# 66 "project/nginx/src/core/ngx_rbtree.c"
            ...
            if (
# 73 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 73 "project/nginx/src/core/ngx_rbtree.c"
               temp
# 73 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color)
# 73 "project/nginx/src/core/ngx_rbtree.c"
...
# 74 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 74 "project/nginx/src/core/ngx_rbtree.c"
               node->parent
# 74 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color = 0)
# 74 "project/nginx/src/core/ngx_rbtree.c"
...
# 75 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 75 "project/nginx/src/core/ngx_rbtree.c"
               temp
# 75 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color = 0)
# 75 "project/nginx/src/core/ngx_rbtree.c"
...
# 76 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 76 "project/nginx/src/core/ngx_rbtree.c"
               node->parent->parent
# 76 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color = 1)
# 76 "project/nginx/src/core/ngx_rbtree.c"
...
# 85 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 85 "project/nginx/src/core/ngx_rbtree.c"
               node->parent
# 85 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color = 0)
# 85 "project/nginx/src/core/ngx_rbtree.c"
...
# 86 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 86 "project/nginx/src/core/ngx_rbtree.c"
               node->parent->parent
# 86 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color = 1)
# 86 "project/nginx/src/core/ngx_rbtree.c"
...
# 92 "project/nginx/src/core/ngx_rbtree.c" 3 4
   ((
# 92 "project/nginx/src/core/ngx_rbtree.c"
   *root
# 92 "project/nginx/src/core/ngx_rbtree.c" 3 4
   )->color = 0)
# 92 "project/nginx/src/core/ngx_rbtree.c"
...
# 117 "project/nginx/src/core/ngx_rbtree.c" 3 4
   ((
# 117 "project/nginx/src/core/ngx_rbtree.c"
   node
# 117 "project/nginx/src/core/ngx_rbtree.c" 3 4
   )->color = 1)
# 117 "project/nginx/src/core/ngx_rbtree.c"
    ...
    ngx_rbtree_node_t *sentinel)
{
    ...
    for ( ;; ) {
# 138 "project/nginx/src/core/ngx_rbtree.c"
...
# 152 "project/nginx/src/core/ngx_rbtree.c" 3 4
   ((
# 152 "project/nginx/src/core/ngx_rbtree.c"
   node
# 152 "project/nginx/src/core/ngx_rbtree.c" 3 4
   )->color = 1)
# 152 "project/nginx/src/core/ngx_rbtree.c"
...
# 182 "project/nginx/src/core/ngx_rbtree.c" 3 4
       ((
# 182 "project/nginx/src/core/ngx_rbtree.c"
       temp
# 182 "project/nginx/src/core/ngx_rbtree.c" 3 4
       )->color = 0)
# 182 "project/nginx/src/core/ngx_rbtree.c"
        ...
        node->left = 
# 185 "project/nginx/src/core/ngx_rbtree.c" 3 4
                    ((void *)0)
# 185 "project/nginx/src/core/ngx_rbtree.c"
                        ;
        node->right = 
# 186 "project/nginx/src/core/ngx_rbtree.c" 3 4
                     ((void *)0)
# 186 "project/nginx/src/core/ngx_rbtree.c"
                         ;
        node->parent = 
# 187 "project/nginx/src/core/ngx_rbtree.c" 3 4
                      ((void *)0)
# 187 "project/nginx/src/core/ngx_rbtree.c"
                          ;
        node->key = 0;
    ...
    red = 
# 193 "project/nginx/src/core/ngx_rbtree.c" 3 4
         ((
# 193 "project/nginx/src/core/ngx_rbtree.c"
         subst
# 193 "project/nginx/src/core/ngx_rbtree.c" 3 4
         )->color)
# 193 "project/nginx/src/core/ngx_rbtree.c"
...
# 218 "project/nginx/src/core/ngx_rbtree.c" 3 4
       (
# 218 "project/nginx/src/core/ngx_rbtree.c"
       subst
# 218 "project/nginx/src/core/ngx_rbtree.c" 3 4
       ->color = 
# 218 "project/nginx/src/core/ngx_rbtree.c"
...
# 218 "project/nginx/src/core/ngx_rbtree.c"
    ...
    node->left = 
# 241 "project/nginx/src/core/ngx_rbtree.c" 3 4
                ((void *)0)
# 241 "project/nginx/src/core/ngx_rbtree.c"
                    ;
    node->right = 
# 242 "project/nginx/src/core/ngx_rbtree.c" 3 4
                 ((void *)0)
# 242 "project/nginx/src/core/ngx_rbtree.c"
                     ;
    node->parent = 
# 243 "project/nginx/src/core/ngx_rbtree.c" 3 4
                  ((void *)0)
# 243 "project/nginx/src/core/ngx_rbtree.c"
                      ;
    node->key = 0;
    ...
    while (temp != *root && 
# 252 "project/nginx/src/core/ngx_rbtree.c" 3 4
                           (!((
# 252 "project/nginx/src/core/ngx_rbtree.c"
                           temp
# 252 "project/nginx/src/core/ngx_rbtree.c" 3 4
                           )->color))
# 252 "project/nginx/src/core/ngx_rbtree.c"
        ...
        if (temp == temp->parent->left) {
            ...
            if (
# 257 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 257 "project/nginx/src/core/ngx_rbtree.c"
               w
# 257 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color)
# 257 "project/nginx/src/core/ngx_rbtree.c"
...
# 258 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 258 "project/nginx/src/core/ngx_rbtree.c"
               w
# 258 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color = 0)
# 258 "project/nginx/src/core/ngx_rbtree.c"
...
# 259 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 259 "project/nginx/src/core/ngx_rbtree.c"
               temp->parent
# 259 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color = 1)
# 259 "project/nginx/src/core/ngx_rbtree.c"
            ...
            if (
# 264 "project/nginx/src/core/ngx_rbtree.c" 3 4
               (!((
# 264 "project/nginx/src/core/ngx_rbtree.c"
               w->left
# 264 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color)) 
# 264 "project/nginx/src/core/ngx_rbtree.c"
...
# 265 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 265 "project/nginx/src/core/ngx_rbtree.c"
               w
# 265 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color = 1)
# 265 "project/nginx/src/core/ngx_rbtree.c"
                ...
                if (
# 269 "project/nginx/src/core/ngx_rbtree.c" 3 4
                   (!((
# 269 "project/nginx/src/core/ngx_rbtree.c"
                   w->right
# 269 "project/nginx/src/core/ngx_rbtree.c" 3 4
                   )->color))
# 269 "project/nginx/src/core/ngx_rbtree.c"
...
# 270 "project/nginx/src/core/ngx_rbtree.c" 3 4
                   ((
# 270 "project/nginx/src/core/ngx_rbtree.c"
                   w->left
# 270 "project/nginx/src/core/ngx_rbtree.c" 3 4
                   )->color = 0)
# 270 "project/nginx/src/core/ngx_rbtree.c"
...
# 271 "project/nginx/src/core/ngx_rbtree.c" 3 4
                   ((
# 271 "project/nginx/src/core/ngx_rbtree.c"
                   w
# 271 "project/nginx/src/core/ngx_rbtree.c" 3 4
                   )->color = 1)
# 271 "project/nginx/src/core/ngx_rbtree.c"
...
# 276 "project/nginx/src/core/ngx_rbtree.c" 3 4
               (
# 276 "project/nginx/src/core/ngx_rbtree.c"
               w
# 276 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ->color = 
# 276 "project/nginx/src/core/ngx_rbtree.c"
...
# 277 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 277 "project/nginx/src/core/ngx_rbtree.c"
               temp->parent
# 277 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color = 0)
# 277 "project/nginx/src/core/ngx_rbtree.c"
...
# 278 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 278 "project/nginx/src/core/ngx_rbtree.c"
               w->right
# 278 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color = 0)
# 278 "project/nginx/src/core/ngx_rbtree.c"
            ...
            if (
# 286 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 286 "project/nginx/src/core/ngx_rbtree.c"
               w
# 286 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color)
# 286 "project/nginx/src/core/ngx_rbtree.c"
...
# 287 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 287 "project/nginx/src/core/ngx_rbtree.c"
               w
# 287 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color = 0)
# 287 "project/nginx/src/core/ngx_rbtree.c"
...
# 288 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 288 "project/nginx/src/core/ngx_rbtree.c"
               temp->parent
# 288 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color = 1)
# 288 "project/nginx/src/core/ngx_rbtree.c"
            ...
            if (
# 293 "project/nginx/src/core/ngx_rbtree.c" 3 4
               (!((
# 293 "project/nginx/src/core/ngx_rbtree.c"
               w->left
# 293 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color)) 
# 293 "project/nginx/src/core/ngx_rbtree.c"
...
# 294 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 294 "project/nginx/src/core/ngx_rbtree.c"
               w
# 294 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color = 1)
# 294 "project/nginx/src/core/ngx_rbtree.c"
                ...
                if (
# 298 "project/nginx/src/core/ngx_rbtree.c" 3 4
                   (!((
# 298 "project/nginx/src/core/ngx_rbtree.c"
                   w->left
# 298 "project/nginx/src/core/ngx_rbtree.c" 3 4
                   )->color))
# 298 "project/nginx/src/core/ngx_rbtree.c"
...
# 299 "project/nginx/src/core/ngx_rbtree.c" 3 4
                   ((
# 299 "project/nginx/src/core/ngx_rbtree.c"
                   w->right
# 299 "project/nginx/src/core/ngx_rbtree.c" 3 4
                   )->color = 0)
# 299 "project/nginx/src/core/ngx_rbtree.c"
...
# 300 "project/nginx/src/core/ngx_rbtree.c" 3 4
                   ((
# 300 "project/nginx/src/core/ngx_rbtree.c"
                   w
# 300 "project/nginx/src/core/ngx_rbtree.c" 3 4
                   )->color = 1)
# 300 "project/nginx/src/core/ngx_rbtree.c"
...
# 305 "project/nginx/src/core/ngx_rbtree.c" 3 4
               (
# 305 "project/nginx/src/core/ngx_rbtree.c"
               w
# 305 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ->color = 
# 305 "project/nginx/src/core/ngx_rbtree.c"
...
# 306 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 306 "project/nginx/src/core/ngx_rbtree.c"
               temp->parent
# 306 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color = 0)
# 306 "project/nginx/src/core/ngx_rbtree.c"
...
# 307 "project/nginx/src/core/ngx_rbtree.c" 3 4
               ((
# 307 "project/nginx/src/core/ngx_rbtree.c"
               w->left
# 307 "project/nginx/src/core/ngx_rbtree.c" 3 4
               )->color = 0)
# 307 "project/nginx/src/core/ngx_rbtree.c"
...
# 314 "project/nginx/src/core/ngx_rbtree.c" 3 4
   ((
# 314 "project/nginx/src/core/ngx_rbtree.c"
   temp
# 314 "project/nginx/src/core/ngx_rbtree.c" 3 4
   )->color = 0)
# 314 "project/nginx/src/core/ngx_rbtree.c"
...
static 
# 318 "project/nginx/src/core/ngx_rbtree.c" 3 4
      inline 
# 318 "project/nginx/src/core/ngx_rbtree.c"
                 void
...
static 
# 348 "project/nginx/src/core/ngx_rbtree.c" 3 4
      inline 
# 348 "project/nginx/src/core/ngx_rbtree.c"
                 void
...
ngx_rbtree_next(ngx_rbtree_t *tree, ngx_rbtree_node_t *node)
{
    ...
    for ( ;; ) {
        ...
        if (node == root) {
            return 
# 395 "project/nginx/src/core/ngx_rbtree.c" 3 4
                  ((void *)0)
# 395 "project/nginx/src/core/ngx_rbtree.c"
                      ;
        }
