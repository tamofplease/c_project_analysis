# 0 "project/nginx/src/core/ngx_crypt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/core/ngx_crypt.c"
...
# 8 "project/nginx/src/core/ngx_crypt.c" 2
...
# 9 "project/nginx/src/core/ngx_crypt.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/core/ngx_crypt.h" 1 3 4
# 16 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/core/ngx_crypt.h" 3 4
ngx_int_t ngx_crypt(ngx_pool_t *pool, u_char *key, u_char *salt,
    u_char **encrypted);
# 10 "project/nginx/src/core/ngx_crypt.c" 2
...
# 11 "project/nginx/src/core/ngx_crypt.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/core/ngx_sha1.h" 1 3 4
# 16 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/core/ngx_sha1.h" 3 4
typedef struct {
    uint64_t bytes;
...
# 12 "project/nginx/src/core/ngx_crypt.c" 2





# 16 "project/nginx/src/core/ngx_crypt.c"
...
{
    if (
# 32 "project/nginx/src/core/ngx_crypt.c" 3 4
       strncmp((const char *) 
# 32 "project/nginx/src/core/ngx_crypt.c"
       salt
# 32 "project/nginx/src/core/ngx_crypt.c" 3 4
       , (const char *) 
# 32 "project/nginx/src/core/ngx_crypt.c"
...
# 35 "project/nginx/src/core/ngx_crypt.c" 3 4
              strncmp((const char *) 
# 35 "project/nginx/src/core/ngx_crypt.c"
              salt
# 35 "project/nginx/src/core/ngx_crypt.c" 3 4
              , (const char *) 
# 35 "project/nginx/src/core/ngx_crypt.c"
...
# 38 "project/nginx/src/core/ngx_crypt.c" 3 4
              strncmp((const char *) 
# 38 "project/nginx/src/core/ngx_crypt.c"
              salt
# 38 "project/nginx/src/core/ngx_crypt.c" 3 4
              , (const char *) 
# 38 "project/nginx/src/core/ngx_crypt.c"
...
# 41 "project/nginx/src/core/ngx_crypt.c" 3 4
              strncmp((const char *) 
# 41 "project/nginx/src/core/ngx_crypt.c"
              salt
# 41 "project/nginx/src/core/ngx_crypt.c" 3 4
              , (const char *) 
# 41 "project/nginx/src/core/ngx_crypt.c"
...
ngx_crypt_apr1(ngx_pool_t *pool, u_char *key, u_char *salt, u_char **encrypted)
{
    ...
    keylen = 
# 62 "project/nginx/src/core/ngx_crypt.c" 3 4
            strlen((const char *) 
# 62 "project/nginx/src/core/ngx_crypt.c"
            key
# 62 "project/nginx/src/core/ngx_crypt.c" 3 4
            )
# 62 "project/nginx/src/core/ngx_crypt.c"
...
# 88 "project/nginx/src/core/ngx_crypt.c" 3 4
   (void) __builtin___memset_chk (
# 88 "project/nginx/src/core/ngx_crypt.c"
   final
# 88 "project/nginx/src/core/ngx_crypt.c" 3 4
   , 0, 
# 88 "project/nginx/src/core/ngx_crypt.c"
...
# 88 "project/nginx/src/core/ngx_crypt.c"
    ...
    *encrypted = ngx_pnalloc(pool, sizeof("$apr1$") - 1 + saltlen + 1 + 22 + 1);
    if (*encrypted == 
# 132 "project/nginx/src/core/ngx_crypt.c" 3 4
                     ((void *)0)
# 132 "project/nginx/src/core/ngx_crypt.c"
                         ) {
        return 
# 133 "project/nginx/src/core/ngx_crypt.c" 3 4
              -1
# 133 "project/nginx/src/core/ngx_crypt.c"
                       ;
    }

    p = 
# 136 "project/nginx/src/core/ngx_crypt.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 136 "project/nginx/src/core/ngx_crypt.c"
       *encrypted
# 136 "project/nginx/src/core/ngx_crypt.c" 3 4
       , 
# 136 "project/nginx/src/core/ngx_crypt.c"
...
# 136 "project/nginx/src/core/ngx_crypt.c"
                                                             ;
    p = 
# 137 "project/nginx/src/core/ngx_crypt.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 137 "project/nginx/src/core/ngx_crypt.c"
       p
# 137 "project/nginx/src/core/ngx_crypt.c" 3 4
       , 
# 137 "project/nginx/src/core/ngx_crypt.c"
...
# 137 "project/nginx/src/core/ngx_crypt.c"
    ...
    *p = '\0';
    ...
    return 
# 148 "project/nginx/src/core/ngx_crypt.c" 3 4
          0
# 148 "project/nginx/src/core/ngx_crypt.c"
                ;
}
...
ngx_crypt_plain(ngx_pool_t *pool, u_char *key, u_char *salt, u_char **encrypted)
{
    ...
    len = 
# 173 "project/nginx/src/core/ngx_crypt.c" 3 4
         strlen((const char *) 
# 173 "project/nginx/src/core/ngx_crypt.c"
         key
# 173 "project/nginx/src/core/ngx_crypt.c" 3 4
         )
# 173 "project/nginx/src/core/ngx_crypt.c"
    ...
    *encrypted = ngx_pnalloc(pool, sizeof("{PLAIN}") - 1 + len + 1);
    if (*encrypted == 
# 176 "project/nginx/src/core/ngx_crypt.c" 3 4
                     ((void *)0)
# 176 "project/nginx/src/core/ngx_crypt.c"
                         ) {
        return 
# 177 "project/nginx/src/core/ngx_crypt.c" 3 4
              -1
# 177 "project/nginx/src/core/ngx_crypt.c"
                       ;
    }

    p = 
# 180 "project/nginx/src/core/ngx_crypt.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 180 "project/nginx/src/core/ngx_crypt.c"
       *encrypted
# 180 "project/nginx/src/core/ngx_crypt.c" 3 4
       , 
# 180 "project/nginx/src/core/ngx_crypt.c"
...
# 181 "project/nginx/src/core/ngx_crypt.c" 3 4
   (void) __builtin___memcpy_chk (
# 181 "project/nginx/src/core/ngx_crypt.c"
   p
# 181 "project/nginx/src/core/ngx_crypt.c" 3 4
   , 
# 181 "project/nginx/src/core/ngx_crypt.c"
...
# 181 "project/nginx/src/core/ngx_crypt.c"
    ...
    return 
# 183 "project/nginx/src/core/ngx_crypt.c" 3 4
          0
# 183 "project/nginx/src/core/ngx_crypt.c"
                ;
}
...
ngx_crypt_ssha(ngx_pool_t *pool, u_char *key, u_char *salt, u_char **encrypted)
{
    ...
    encoded.len = 
# 200 "project/nginx/src/core/ngx_crypt.c" 3 4
                 strlen((const char *) 
# 200 "project/nginx/src/core/ngx_crypt.c"
                 encoded.data
# 200 "project/nginx/src/core/ngx_crypt.c" 3 4
                 )
# 200 "project/nginx/src/core/ngx_crypt.c"
    ...
    len = 
# 202 "project/nginx/src/core/ngx_crypt.c" 3 4
         (((((
# 202 "project/nginx/src/core/ngx_crypt.c"
         encoded.len 
# 202 "project/nginx/src/core/ngx_crypt.c" 3 4
         + 3) / 4) * 3) < 
# 202 "project/nginx/src/core/ngx_crypt.c"
...
# 202 "project/nginx/src/core/ngx_crypt.c"
    ...
    if (decoded.data == 
# 205 "project/nginx/src/core/ngx_crypt.c" 3 4
                       ((void *)0)
# 205 "project/nginx/src/core/ngx_crypt.c"
                           ) {
        return 
# 206 "project/nginx/src/core/ngx_crypt.c" 3 4
              -1
# 206 "project/nginx/src/core/ngx_crypt.c"
                       ;
    }
    ...
    if (rc != 
# 211 "project/nginx/src/core/ngx_crypt.c" 3 4
             0 
# 211 "project/nginx/src/core/ngx_crypt.c"
                    || decoded.len < 20) {
        decoded.len = 20;
    }
    ...
    ngx_sha1_init(&sha1);
    ngx_sha1_update(&sha1, key, 
# 218 "project/nginx/src/core/ngx_crypt.c" 3 4
                               strlen((const char *) 
# 218 "project/nginx/src/core/ngx_crypt.c"
                               key
# 218 "project/nginx/src/core/ngx_crypt.c" 3 4
                               )
# 218 "project/nginx/src/core/ngx_crypt.c"
    ...
    len = sizeof("{SSHA}") - 1 + 
# 224 "project/nginx/src/core/ngx_crypt.c" 3 4
                                (((
# 224 "project/nginx/src/core/ngx_crypt.c"
                                decoded.len 
# 224 "project/nginx/src/core/ngx_crypt.c" 3 4
                                + 2) / 3) * 4) 
# 224 "project/nginx/src/core/ngx_crypt.c"
    ...
    *encrypted = ngx_pnalloc(pool, len);
    if (*encrypted == 
# 227 "project/nginx/src/core/ngx_crypt.c" 3 4
                     ((void *)0)
# 227 "project/nginx/src/core/ngx_crypt.c"
                         ) {
        return 
# 228 "project/nginx/src/core/ngx_crypt.c" 3 4
              -1
# 228 "project/nginx/src/core/ngx_crypt.c"
                       ;
    }

    encoded.data = 
# 231 "project/nginx/src/core/ngx_crypt.c" 3 4
                  (((u_char *) __builtin___memcpy_chk (
# 231 "project/nginx/src/core/ngx_crypt.c"
                  *encrypted
# 231 "project/nginx/src/core/ngx_crypt.c" 3 4
                  , 
# 231 "project/nginx/src/core/ngx_crypt.c"
...
# 231 "project/nginx/src/core/ngx_crypt.c"
    ...
    return 
# 235 "project/nginx/src/core/ngx_crypt.c" 3 4
          0
# 235 "project/nginx/src/core/ngx_crypt.c"
                ;
}
...
ngx_crypt_sha(ngx_pool_t *pool, u_char *key, u_char *salt, u_char **encrypted)
{
    ...
    ngx_sha1_init(&sha1);
    ngx_sha1_update(&sha1, key, 
# 253 "project/nginx/src/core/ngx_crypt.c" 3 4
                               strlen((const char *) 
# 253 "project/nginx/src/core/ngx_crypt.c"
                               key
# 253 "project/nginx/src/core/ngx_crypt.c" 3 4
                               )
# 253 "project/nginx/src/core/ngx_crypt.c"
    ...
    len = sizeof("{SHA}") - 1 + 
# 256 "project/nginx/src/core/ngx_crypt.c" 3 4
                               (((
# 256 "project/nginx/src/core/ngx_crypt.c"
                               decoded.len 
# 256 "project/nginx/src/core/ngx_crypt.c" 3 4
                               + 2) / 3) * 4) 
# 256 "project/nginx/src/core/ngx_crypt.c"
    ...
    *encrypted = ngx_pnalloc(pool, len);
    if (*encrypted == 
# 259 "project/nginx/src/core/ngx_crypt.c" 3 4
                     ((void *)0)
# 259 "project/nginx/src/core/ngx_crypt.c"
                         ) {
        return 
# 260 "project/nginx/src/core/ngx_crypt.c" 3 4
              -1
# 260 "project/nginx/src/core/ngx_crypt.c"
                       ;
    }

    encoded.data = 
# 263 "project/nginx/src/core/ngx_crypt.c" 3 4
                  (((u_char *) __builtin___memcpy_chk (
# 263 "project/nginx/src/core/ngx_crypt.c"
                  *encrypted
# 263 "project/nginx/src/core/ngx_crypt.c" 3 4
                  , 
# 263 "project/nginx/src/core/ngx_crypt.c"
...
# 263 "project/nginx/src/core/ngx_crypt.c"
    ...
    return 
# 267 "project/nginx/src/core/ngx_crypt.c" 3 4
          0
# 267 "project/nginx/src/core/ngx_crypt.c"
                ;
}
