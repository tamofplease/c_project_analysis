# 0 "project/nginx/src/core/ngx_log.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/core/ngx_log.c"
...
# 9 "project/nginx/src/core/ngx_log.c" 2
...
# 10 "project/nginx/src/core/ngx_log.c" 2



# 12 "project/nginx/src/core/ngx_log.c"
static char *ngx_error_log(ngx_conf_t *cf, ngx_command_t *cmd, void *conf);
static char *ngx_log_set_levels(ngx_conf_t *cf, ngx_log_t *log);
static void ngx_log_insert(ngx_log_t *log, ngx_log_t *new_log);
# 34 "project/nginx/src/core/ngx_log.c"
static ngx_command_t ngx_errlog_commands[] = {

    { 
# 36 "project/nginx/src/core/ngx_log.c" 3 4
     { sizeof(
# 36 "project/nginx/src/core/ngx_log.c"
     "error_log"
# 36 "project/nginx/src/core/ngx_log.c" 3 4
     ) - 1, (u_char *) 
# 36 "project/nginx/src/core/ngx_log.c"
...
# 37 "project/nginx/src/core/ngx_log.c" 3 4
     0x01000000
# 37 "project/nginx/src/core/ngx_log.c"
                  |
# 37 "project/nginx/src/core/ngx_log.c" 3 4
                   0x00000800
# 37 "project/nginx/src/core/ngx_log.c"
...
# 41 "project/nginx/src/core/ngx_log.c" 3 4
     ((void *)0) 
# 41 "project/nginx/src/core/ngx_log.c"
          },

      
# 43 "project/nginx/src/core/ngx_log.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 44 "project/nginx/src/core/ngx_log.c"
};


static ngx_core_module_t ngx_errlog_module_ctx = {
    
# 48 "project/nginx/src/core/ngx_log.c" 3 4
   { sizeof(
# 48 "project/nginx/src/core/ngx_log.c"
   "errlog"
# 48 "project/nginx/src/core/ngx_log.c" 3 4
   ) - 1, (u_char *) 
# 48 "project/nginx/src/core/ngx_log.c"
...
# 49 "project/nginx/src/core/ngx_log.c" 3 4
   ((void *)0)
# 49 "project/nginx/src/core/ngx_log.c"
       ,
    
# 50 "project/nginx/src/core/ngx_log.c" 3 4
   ((void *)0)

# 51 "project/nginx/src/core/ngx_log.c"
};


ngx_module_t ngx_errlog_module = {
    
# 55 "project/nginx/src/core/ngx_log.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 55 "project/nginx/src/core/ngx_log.c"
   "8" 
# 55 "project/nginx/src/core/ngx_log.c" 3 4
   "," 
# 55 "project/nginx/src/core/ngx_log.c"
...
# 58 "project/nginx/src/core/ngx_log.c" 3 4
   0x45524F43
# 58 "project/nginx/src/core/ngx_log.c"
                  ,
    
# 59 "project/nginx/src/core/ngx_log.c" 3 4
   ((void *)0)
# 59 "project/nginx/src/core/ngx_log.c"
       ,
    
# 60 "project/nginx/src/core/ngx_log.c" 3 4
   ((void *)0)
# 60 "project/nginx/src/core/ngx_log.c"
       ,
    
# 61 "project/nginx/src/core/ngx_log.c" 3 4
   ((void *)0)
# 61 "project/nginx/src/core/ngx_log.c"
       ,
    
# 62 "project/nginx/src/core/ngx_log.c" 3 4
   ((void *)0)
# 62 "project/nginx/src/core/ngx_log.c"
       ,
    
# 63 "project/nginx/src/core/ngx_log.c" 3 4
   ((void *)0)
# 63 "project/nginx/src/core/ngx_log.c"
       ,
    
# 64 "project/nginx/src/core/ngx_log.c" 3 4
   ((void *)0)
# 64 "project/nginx/src/core/ngx_log.c"
       ,
    
# 65 "project/nginx/src/core/ngx_log.c" 3 4
   ((void *)0)
# 65 "project/nginx/src/core/ngx_log.c"
       ,
    
# 66 "project/nginx/src/core/ngx_log.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 67 "project/nginx/src/core/ngx_log.c"
};
...
# 76 "project/nginx/src/core/ngx_log.c" 3 4
   { 0, ((void *)0) }
# 76 "project/nginx/src/core/ngx_log.c"
                  ,
    
# 77 "project/nginx/src/core/ngx_log.c" 3 4
   { sizeof(
# 77 "project/nginx/src/core/ngx_log.c"
   "emerg"
# 77 "project/nginx/src/core/ngx_log.c" 3 4
   ) - 1, (u_char *) 
# 77 "project/nginx/src/core/ngx_log.c"
...
# 78 "project/nginx/src/core/ngx_log.c" 3 4
   { sizeof(
# 78 "project/nginx/src/core/ngx_log.c"
   "alert"
# 78 "project/nginx/src/core/ngx_log.c" 3 4
   ) - 1, (u_char *) 
# 78 "project/nginx/src/core/ngx_log.c"
...
# 79 "project/nginx/src/core/ngx_log.c" 3 4
   { sizeof(
# 79 "project/nginx/src/core/ngx_log.c"
   "crit"
# 79 "project/nginx/src/core/ngx_log.c" 3 4
   ) - 1, (u_char *) 
# 79 "project/nginx/src/core/ngx_log.c"
...
# 80 "project/nginx/src/core/ngx_log.c" 3 4
   { sizeof(
# 80 "project/nginx/src/core/ngx_log.c"
   "error"
# 80 "project/nginx/src/core/ngx_log.c" 3 4
   ) - 1, (u_char *) 
# 80 "project/nginx/src/core/ngx_log.c"
...
# 81 "project/nginx/src/core/ngx_log.c" 3 4
   { sizeof(
# 81 "project/nginx/src/core/ngx_log.c"
   "warn"
# 81 "project/nginx/src/core/ngx_log.c" 3 4
   ) - 1, (u_char *) 
# 81 "project/nginx/src/core/ngx_log.c"
...
# 82 "project/nginx/src/core/ngx_log.c" 3 4
   { sizeof(
# 82 "project/nginx/src/core/ngx_log.c"
   "notice"
# 82 "project/nginx/src/core/ngx_log.c" 3 4
   ) - 1, (u_char *) 
# 82 "project/nginx/src/core/ngx_log.c"
...
# 83 "project/nginx/src/core/ngx_log.c" 3 4
   { sizeof(
# 83 "project/nginx/src/core/ngx_log.c"
   "info"
# 83 "project/nginx/src/core/ngx_log.c" 3 4
   ) - 1, (u_char *) 
# 83 "project/nginx/src/core/ngx_log.c"
...
# 84 "project/nginx/src/core/ngx_log.c" 3 4
   { sizeof(
# 84 "project/nginx/src/core/ngx_log.c"
   "debug"
# 84 "project/nginx/src/core/ngx_log.c" 3 4
   ) - 1, (u_char *) 
# 84 "project/nginx/src/core/ngx_log.c"
...
# 85 "project/nginx/src/core/ngx_log.c"
};
...
ngx_log_error_core(ngx_uint_t level, ngx_log_t *log, ngx_err_t err,
    const char *fmt, ...)
# 106 "project/nginx/src/core/ngx_log.c"
{
    ...
    u_char errstr[
# 113 "project/nginx/src/core/ngx_log.c" 3 4
                       2048
# 113 "project/nginx/src/core/ngx_log.c"
                                        ];

    last = errstr + 
# 115 "project/nginx/src/core/ngx_log.c" 3 4
                   2048
# 115 "project/nginx/src/core/ngx_log.c"
                                    ;

    p = 
# 117 "project/nginx/src/core/ngx_log.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 117 "project/nginx/src/core/ngx_log.c"
       errstr
# 117 "project/nginx/src/core/ngx_log.c" 3 4
       , 
# 117 "project/nginx/src/core/ngx_log.c"
...
# 118 "project/nginx/src/core/ngx_log.c"
                                              ;

    p = ngx_slprintf(p, last, " [%V] ", &err_levels[level]);


    p = ngx_slprintf(p, last, "%P#" 
# 123 "project/nginx/src/core/ngx_log.c" 3 4
                                   "%d" 
# 123 "project/nginx/src/core/ngx_log.c"
                                                 ": ",
                    
# 124 "project/nginx/src/core/ngx_log.c" 3 4
                   ngx_pid
# 124 "project/nginx/src/core/ngx_log.c"
                              , 
# 124 "project/nginx/src/core/ngx_log.c" 3 4
                                0
# 124 "project/nginx/src/core/ngx_log.c"
...
# 134 "project/nginx/src/core/ngx_log.c" 3 4
   __builtin_va_start(
# 134 "project/nginx/src/core/ngx_log.c"
   args
# 134 "project/nginx/src/core/ngx_log.c" 3 4
   ,
# 134 "project/nginx/src/core/ngx_log.c"
...
# 136 "project/nginx/src/core/ngx_log.c" 3 4
   __builtin_va_end(
# 136 "project/nginx/src/core/ngx_log.c"
   args
# 136 "project/nginx/src/core/ngx_log.c" 3 4
   )
# 136 "project/nginx/src/core/ngx_log.c"
    ...
    if (level != 
# 148 "project/nginx/src/core/ngx_log.c" 3 4
                8 
# 148 "project/nginx/src/core/ngx_log.c"
                              && log->handler) {
        p = log->handler(log, p, last - p);
    }

    if (p > last - 
# 152 "project/nginx/src/core/ngx_log.c" 3 4
                  1
# 152 "project/nginx/src/core/ngx_log.c"
                                   ) {
        p = last - 
# 153 "project/nginx/src/core/ngx_log.c" 3 4
                  1
# 153 "project/nginx/src/core/ngx_log.c"
                                   ;
    }

    
# 156 "project/nginx/src/core/ngx_log.c" 3 4
   *
# 156 "project/nginx/src/core/ngx_log.c"
   p
# 156 "project/nginx/src/core/ngx_log.c" 3 4
   ++ = (u_char) '\n';
# 156 "project/nginx/src/core/ngx_log.c"
    ...
    wrote_stderr = 0;
    debug_connection = (log->log_level & 
# 159 "project/nginx/src/core/ngx_log.c" 3 4
                                        0x80000000
# 159 "project/nginx/src/core/ngx_log.c"
                                                                ) != 0;
    ...
    while (log) {
        ...
        if (
# 172 "project/nginx/src/core/ngx_log.c" 3 4
           ngx_cached_time->sec 
# 172 "project/nginx/src/core/ngx_log.c"
                      == log->disk_full_time) {
        ...
        if (n == -1 && 
# 185 "project/nginx/src/core/ngx_log.c" 3 4
                      (*__error()) 
# 185 "project/nginx/src/core/ngx_log.c"
                                == 
# 185 "project/nginx/src/core/ngx_log.c" 3 4
                                   28
# 185 "project/nginx/src/core/ngx_log.c"
            ...
            log->disk_full_time = 
# 186 "project/nginx/src/core/ngx_log.c" 3 4
                                 ngx_cached_time->sec
# 186 "project/nginx/src/core/ngx_log.c"
                                           ;
        }

        if (log->file->fd == 
# 189 "project/nginx/src/core/ngx_log.c" 3 4
                            2
# 189 "project/nginx/src/core/ngx_log.c"
                                      ) {
            wrote_stderr = 1;
        }
    ...
    if (!ngx_use_stderr
        || level > 
# 199 "project/nginx/src/core/ngx_log.c" 3 4
                  5
        
# 200 "project/nginx/src/core/ngx_log.c"
       || wrote_stderr)
    {
        return;
    }
    ...
    (void) 
# 209 "project/nginx/src/core/ngx_log.c" 3 4
          ngx_write_fd
# 209 "project/nginx/src/core/ngx_log.c"
                           (
# 209 "project/nginx/src/core/ngx_log.c" 3 4
                            2
# 209 "project/nginx/src/core/ngx_log.c"
...
# 242 "project/nginx/src/core/ngx_log.c"
void
ngx_log_abort(ngx_err_t err, const char *fmt, ...)
{
    ...
    va_list args;
    u_char errstr[
# 247 "project/nginx/src/core/ngx_log.c" 3 4
                    1024
# 247 "project/nginx/src/core/ngx_log.c"
                                       ];

    
# 249 "project/nginx/src/core/ngx_log.c" 3 4
   __builtin_va_start(
# 249 "project/nginx/src/core/ngx_log.c"
   args
# 249 "project/nginx/src/core/ngx_log.c" 3 4
   ,
# 249 "project/nginx/src/core/ngx_log.c"
...
# 249 "project/nginx/src/core/ngx_log.c"
                      ;
    p = 
# 250 "project/nginx/src/core/ngx_log.c" 3 4
       ngx_vslprintf(
# 250 "project/nginx/src/core/ngx_log.c"
       errstr
# 250 "project/nginx/src/core/ngx_log.c" 3 4
       , 
# 250 "project/nginx/src/core/ngx_log.c"
...
# 251 "project/nginx/src/core/ngx_log.c" 3 4
   __builtin_va_end(
# 251 "project/nginx/src/core/ngx_log.c"
   args
# 251 "project/nginx/src/core/ngx_log.c" 3 4
   )
# 251 "project/nginx/src/core/ngx_log.c"
...
# 253 "project/nginx/src/core/ngx_log.c" 3 4
   if ((
# 253 "project/nginx/src/core/ngx_log.c"
   ngx_cycle->log
# 253 "project/nginx/src/core/ngx_log.c" 3 4
...
# 254 "project/nginx/src/core/ngx_log.c"
                                           ;
}
...
ngx_log_stderr(ngx_err_t err, const char *fmt, ...)
{
    ...
    va_list args;
    u_char errstr[
# 263 "project/nginx/src/core/ngx_log.c" 3 4
                    2048
# 263 "project/nginx/src/core/ngx_log.c"
                                     ];

    last = errstr + 
# 265 "project/nginx/src/core/ngx_log.c" 3 4
                   2048
# 265 "project/nginx/src/core/ngx_log.c"
                                    ;

    p = 
# 267 "project/nginx/src/core/ngx_log.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 267 "project/nginx/src/core/ngx_log.c"
       errstr
# 267 "project/nginx/src/core/ngx_log.c" 3 4
       , 
# 267 "project/nginx/src/core/ngx_log.c"
...
# 269 "project/nginx/src/core/ngx_log.c" 3 4
   __builtin_va_start(
# 269 "project/nginx/src/core/ngx_log.c"
   args
# 269 "project/nginx/src/core/ngx_log.c" 3 4
   ,
# 269 "project/nginx/src/core/ngx_log.c"
...
# 271 "project/nginx/src/core/ngx_log.c" 3 4
   __builtin_va_end(
# 271 "project/nginx/src/core/ngx_log.c"
   args
# 271 "project/nginx/src/core/ngx_log.c" 3 4
   )
# 271 "project/nginx/src/core/ngx_log.c"
    ...
    if (p > last - 
# 277 "project/nginx/src/core/ngx_log.c" 3 4
                  1
# 277 "project/nginx/src/core/ngx_log.c"
                                   ) {
        p = last - 
# 278 "project/nginx/src/core/ngx_log.c" 3 4
                  1
# 278 "project/nginx/src/core/ngx_log.c"
                                   ;
    }

    
# 281 "project/nginx/src/core/ngx_log.c" 3 4
   *
# 281 "project/nginx/src/core/ngx_log.c"
   p
# 281 "project/nginx/src/core/ngx_log.c" 3 4
   ++ = (u_char) '\n';
# 281 "project/nginx/src/core/ngx_log.c"
    ...
    (void) 
# 283 "project/nginx/src/core/ngx_log.c" 3 4
          ngx_write_fd
# 283 "project/nginx/src/core/ngx_log.c"
                           (
# 283 "project/nginx/src/core/ngx_log.c" 3 4
                            2
# 283 "project/nginx/src/core/ngx_log.c"
...
ngx_log_init(u_char *prefix, u_char *error_log)
{
    ...
    ngx_log.log_level = 
# 324 "project/nginx/src/core/ngx_log.c" 3 4
                       6
# 324 "project/nginx/src/core/ngx_log.c"
                                     ;

    if (error_log == 
# 326 "project/nginx/src/core/ngx_log.c" 3 4
                    ((void *)0)
# 326 "project/nginx/src/core/ngx_log.c"
                        ) {
        error_log = (u_char *) 
# 327 "project/nginx/src/core/ngx_log.c" 3 4
                              "logs/error.log"
# 327 "project/nginx/src/core/ngx_log.c"
                                                ;
    }

    name = error_log;
    nlen = 
# 331 "project/nginx/src/core/ngx_log.c" 3 4
          strlen((const char *) 
# 331 "project/nginx/src/core/ngx_log.c"
          name
# 331 "project/nginx/src/core/ngx_log.c" 3 4
          )
# 331 "project/nginx/src/core/ngx_log.c"
    ...
    if (nlen == 0) {
        ngx_log_file.fd = 
# 334 "project/nginx/src/core/ngx_log.c" 3 4
                         2
# 334 "project/nginx/src/core/ngx_log.c"
                                   ;
        return &ngx_log;
    }

    p = 
# 338 "project/nginx/src/core/ngx_log.c" 3 4
       ((void *)0)
# 338 "project/nginx/src/core/ngx_log.c"
           ;
    ...
    if (name[0] != '/') {
        ...
        if (prefix) {
            plen = 
# 347 "project/nginx/src/core/ngx_log.c" 3 4
                  strlen((const char *) 
# 347 "project/nginx/src/core/ngx_log.c"
                  prefix
# 347 "project/nginx/src/core/ngx_log.c" 3 4
                  )
# 347 "project/nginx/src/core/ngx_log.c"
            ...
            prefix = (u_char *) 
# 351 "project/nginx/src/core/ngx_log.c" 3 4
                               "/usr/local/nginx/"
# 351 "project/nginx/src/core/ngx_log.c"
                                         ;
            plen = 
# 352 "project/nginx/src/core/ngx_log.c" 3 4
                  strlen((const char *) 
# 352 "project/nginx/src/core/ngx_log.c"
                  prefix
# 352 "project/nginx/src/core/ngx_log.c" 3 4
                  )
# 352 "project/nginx/src/core/ngx_log.c"
        ...
        if (plen) {
            ...
            if (name == 
# 360 "project/nginx/src/core/ngx_log.c" 3 4
                       ((void *)0)
# 360 "project/nginx/src/core/ngx_log.c"
                           ) {
                return 
# 361 "project/nginx/src/core/ngx_log.c" 3 4
                      ((void *)0)
# 361 "project/nginx/src/core/ngx_log.c"
                          ;
            }

            p = 
# 364 "project/nginx/src/core/ngx_log.c" 3 4
               (((u_char *) __builtin___memcpy_chk (
# 364 "project/nginx/src/core/ngx_log.c"
               name
# 364 "project/nginx/src/core/ngx_log.c" 3 4
               , 
# 364 "project/nginx/src/core/ngx_log.c"
...
# 364 "project/nginx/src/core/ngx_log.c"
            ...
            if (!
# 366 "project/nginx/src/core/ngx_log.c" 3 4
                ((
# 366 "project/nginx/src/core/ngx_log.c"
                *(p - 1)
# 366 "project/nginx/src/core/ngx_log.c" 3 4
                ) == '/')
# 366 "project/nginx/src/core/ngx_log.c"
    ...
    ngx_log_file.fd = 
# 376 "project/nginx/src/core/ngx_log.c" 3 4
                     open((const char *) 
# 376 "project/nginx/src/core/ngx_log.c"
                     name
# 376 "project/nginx/src/core/ngx_log.c" 3 4
                     , (0x0001|0x00000008)|0x00000200, 0644)

                                                            
# 378 "project/nginx/src/core/ngx_log.c"
                                                           ;

    if (ngx_log_file.fd == 
# 380 "project/nginx/src/core/ngx_log.c" 3 4
                          -1
# 380 "project/nginx/src/core/ngx_log.c"
                                          ) {
        ngx_log_stderr(
# 381 "project/nginx/src/core/ngx_log.c" 3 4
                      (*__error())
# 381 "project/nginx/src/core/ngx_log.c"
                               ,
                       "[alert] could not open error log file: "
                       
# 383 "project/nginx/src/core/ngx_log.c" 3 4
                      "open()" 
# 383 "project/nginx/src/core/ngx_log.c"
                                      " \"%s\" failed", name);
        ...
        ngx_log_file.fd = 
# 390 "project/nginx/src/core/ngx_log.c" 3 4
                         2
# 390 "project/nginx/src/core/ngx_log.c"
                                   ;
    }

    if (p) {
        
# 394 "project/nginx/src/core/ngx_log.c" 3 4
       free
# 394 "project/nginx/src/core/ngx_log.c"
               (p);
    }
...
# 406 "project/nginx/src/core/ngx_log.c" 3 4
                                                ((void *)0)
# 406 "project/nginx/src/core/ngx_log.c"
                                                    ) {
        return 
# 407 "project/nginx/src/core/ngx_log.c" 3 4
              0
# 407 "project/nginx/src/core/ngx_log.c"
                    ;
    }
    ...
    if (cycle->new_log.log_level != 0) {
        ...
        if (log == 
# 414 "project/nginx/src/core/ngx_log.c" 3 4
                  ((void *)0)
# 414 "project/nginx/src/core/ngx_log.c"
                      ) {
            return 
# 415 "project/nginx/src/core/ngx_log.c" 3 4
                  -1
# 415 "project/nginx/src/core/ngx_log.c"
                           ;
        }
    ...
    log->log_level = 
# 423 "project/nginx/src/core/ngx_log.c" 3 4
                    4
# 423 "project/nginx/src/core/ngx_log.c"
                               ;

    log->file = ngx_conf_open_file(cycle, &cycle->error_log);
    if (log->file == 
# 426 "project/nginx/src/core/ngx_log.c" 3 4
                    ((void *)0)
# 426 "project/nginx/src/core/ngx_log.c"
                        ) {
        return 
# 427 "project/nginx/src/core/ngx_log.c" 3 4
              -1
# 427 "project/nginx/src/core/ngx_log.c"
                       ;
    }
    ...
    return 
# 434 "project/nginx/src/core/ngx_log.c" 3 4
          0
# 434 "project/nginx/src/core/ngx_log.c"
                ;
}
...
ngx_log_redirect_stderr(ngx_cycle_t *cycle)
{
    ...
    if (cycle->log_use_stderr) {
        return 
# 444 "project/nginx/src/core/ngx_log.c" 3 4
              0
# 444 "project/nginx/src/core/ngx_log.c"
                    ;
    }
    ...
    if (fd != 
# 450 "project/nginx/src/core/ngx_log.c" 3 4
             2
# 450 "project/nginx/src/core/ngx_log.c"
                       ) {
        if (
# 451 "project/nginx/src/core/ngx_log.c" 3 4
           dup2(
# 451 "project/nginx/src/core/ngx_log.c"
           fd
# 451 "project/nginx/src/core/ngx_log.c" 3 4
           , 2) 
# 451 "project/nginx/src/core/ngx_log.c"
...
# 452 "project/nginx/src/core/ngx_log.c" 3 4
           if ((
# 452 "project/nginx/src/core/ngx_log.c"
           cycle->log
# 452 "project/nginx/src/core/ngx_log.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 452 "project/nginx/src/core/ngx_log.c"
...
# 453 "project/nginx/src/core/ngx_log.c"
                                                    ;

            return 
# 455 "project/nginx/src/core/ngx_log.c" 3 4
                  -1
# 455 "project/nginx/src/core/ngx_log.c"
                           ;
        }
    }

    return 
# 459 "project/nginx/src/core/ngx_log.c" 3 4
          0
# 459 "project/nginx/src/core/ngx_log.c"
                ;
}
...
ngx_log_get_file_log(ngx_log_t *head)
{
    ...
    for (log = head; log; log = log->next) {
        if (log->file != 
# 469 "project/nginx/src/core/ngx_log.c" 3 4
                        ((void *)0)
# 469 "project/nginx/src/core/ngx_log.c"
                            ) {
            return log;
        }
    }
    ...
    return 
# 474 "project/nginx/src/core/ngx_log.c" 3 4
          ((void *)0)
# 474 "project/nginx/src/core/ngx_log.c"
              ;
}
...
ngx_log_set_levels(ngx_conf_t *cf, ngx_log_t *log)
{
    ...
    if (cf->args->nelts == 2) {
        log->log_level = 
# 485 "project/nginx/src/core/ngx_log.c" 3 4
                        4
# 485 "project/nginx/src/core/ngx_log.c"
                                   ;
        return 
# 486 "project/nginx/src/core/ngx_log.c" 3 4
              ((void *)0)
# 486 "project/nginx/src/core/ngx_log.c"
                         ;
    }
    ...
    for (i = 2; i < cf->args->nelts; i++) {
        ...
        for (n = 1; n <= 
# 494 "project/nginx/src/core/ngx_log.c" 3 4
                        8
# 494 "project/nginx/src/core/ngx_log.c"
                                     ; n++) {
            if (
# 495 "project/nginx/src/core/ngx_log.c" 3 4
               strcmp((const char *) 
# 495 "project/nginx/src/core/ngx_log.c"
               value[i].data
# 495 "project/nginx/src/core/ngx_log.c" 3 4
               , (const char *) 
# 495 "project/nginx/src/core/ngx_log.c"
...
# 495 "project/nginx/src/core/ngx_log.c"
                ...
                if (log->log_level != 0) {
                    ngx_conf_log_error(
# 498 "project/nginx/src/core/ngx_log.c" 3 4
                                      1
# 498 "project/nginx/src/core/ngx_log.c"
                                                   , cf, 0,
                                       "duplicate log level \"%V\"",
                                       &value[i]);
                    return 
# 501 "project/nginx/src/core/ngx_log.c" 3 4
                          (void *) -1
# 501 "project/nginx/src/core/ngx_log.c"
                                        ;
                }
        ...
        for (n = 0, d = 
# 510 "project/nginx/src/core/ngx_log.c" 3 4
                       0x010
# 510 "project/nginx/src/core/ngx_log.c"
                                          ; d <= 
# 510 "project/nginx/src/core/ngx_log.c" 3 4
                                                 0x400
# 510 "project/nginx/src/core/ngx_log.c"
                                                                   ; d <<= 1) {
            if (
# 511 "project/nginx/src/core/ngx_log.c" 3 4
               strcmp((const char *) 
# 511 "project/nginx/src/core/ngx_log.c"
               value[i].data
# 511 "project/nginx/src/core/ngx_log.c" 3 4
               , (const char *) 
# 511 "project/nginx/src/core/ngx_log.c"
...
# 511 "project/nginx/src/core/ngx_log.c"
                                                            == 0) {
                if (log->log_level & ~
# 512 "project/nginx/src/core/ngx_log.c" 3 4
                                     0x7ffffff0
# 512 "project/nginx/src/core/ngx_log.c"
                                                      ) {
                    ngx_conf_log_error(
# 513 "project/nginx/src/core/ngx_log.c" 3 4
                                      1
# 513 "project/nginx/src/core/ngx_log.c"
                                                   , cf, 0,
                                       "invalid log level \"%V\"",
                                       &value[i]);
                    return 
# 516 "project/nginx/src/core/ngx_log.c" 3 4
                          (void *) -1
# 516 "project/nginx/src/core/ngx_log.c"
                                        ;
                }
        ...
        if (!found) {
            ngx_conf_log_error(
# 527 "project/nginx/src/core/ngx_log.c" 3 4
                              1
# 527 "project/nginx/src/core/ngx_log.c"
                                           , cf, 0,
                               "invalid log level \"%V\"", &value[i]);
            return 
# 529 "project/nginx/src/core/ngx_log.c" 3 4
                  (void *) -1
# 529 "project/nginx/src/core/ngx_log.c"
                                ;
        }
    }

    if (log->log_level == 
# 533 "project/nginx/src/core/ngx_log.c" 3 4
                         8
# 533 "project/nginx/src/core/ngx_log.c"
                                      ) {
        log->log_level = 
# 534 "project/nginx/src/core/ngx_log.c" 3 4
                        0x7ffffff0
# 534 "project/nginx/src/core/ngx_log.c"
                                         ;
    }

    return 
# 537 "project/nginx/src/core/ngx_log.c" 3 4
          ((void *)0)
# 537 "project/nginx/src/core/ngx_log.c"
                     ;
}
...
ngx_log_set_log(ngx_conf_t *cf, ngx_log_t **head)
{
    ...
    if (*head != 
# 559 "project/nginx/src/core/ngx_log.c" 3 4
                ((void *)0) 
# 559 "project/nginx/src/core/ngx_log.c"
                     && (*head)->log_level == 0) {
        new_log = *head;
        ...
        if (new_log == 
# 565 "project/nginx/src/core/ngx_log.c" 3 4
                      ((void *)0)
# 565 "project/nginx/src/core/ngx_log.c"
                          ) {
            return 
# 566 "project/nginx/src/core/ngx_log.c" 3 4
                  (void *) -1
# 566 "project/nginx/src/core/ngx_log.c"
                                ;
        }

        if (*head == 
# 569 "project/nginx/src/core/ngx_log.c" 3 4
                    ((void *)0)
# 569 "project/nginx/src/core/ngx_log.c"
                        ) {
            *head = new_log;
        }
    }
    ...
    if (
# 576 "project/nginx/src/core/ngx_log.c" 3 4
       strcmp((const char *) 
# 576 "project/nginx/src/core/ngx_log.c"
       value[1].data
# 576 "project/nginx/src/core/ngx_log.c" 3 4
       , (const char *) 
# 576 "project/nginx/src/core/ngx_log.c"
...
# 577 "project/nginx/src/core/ngx_log.c" 3 4
       (
# 577 "project/nginx/src/core/ngx_log.c"
       &name
# 577 "project/nginx/src/core/ngx_log.c" 3 4
       )->len = 0; (
# 577 "project/nginx/src/core/ngx_log.c"
...
# 577 "project/nginx/src/core/ngx_log.c"
        ...
        if (new_log->file == 
# 581 "project/nginx/src/core/ngx_log.c" 3 4
                            ((void *)0)
# 581 "project/nginx/src/core/ngx_log.c"
                                ) {
            return 
# 582 "project/nginx/src/core/ngx_log.c" 3 4
                  (void *) -1
# 582 "project/nginx/src/core/ngx_log.c"
                                ;
        }

    } else if (
# 585 "project/nginx/src/core/ngx_log.c" 3 4
              strncmp((const char *) 
# 585 "project/nginx/src/core/ngx_log.c"
              value[1].data
# 585 "project/nginx/src/core/ngx_log.c" 3 4
              , (const char *) 
# 585 "project/nginx/src/core/ngx_log.c"
...
# 585 "project/nginx/src/core/ngx_log.c"
                                                       == 0) {
# 639 "project/nginx/src/core/ngx_log.c"
        ngx_conf_log_error(
# 639 "project/nginx/src/core/ngx_log.c" 3 4
                          1
# 639 "project/nginx/src/core/ngx_log.c"
                                       , cf, 0,
                           "nginx was built without debug support");
        return 
# 641 "project/nginx/src/core/ngx_log.c" 3 4
              (void *) -1
# 641 "project/nginx/src/core/ngx_log.c"
                            ;


    } else if (
# 644 "project/nginx/src/core/ngx_log.c" 3 4
              strncmp((const char *) 
# 644 "project/nginx/src/core/ngx_log.c"
              value[1].data
# 644 "project/nginx/src/core/ngx_log.c" 3 4
              , (const char *) 
# 644 "project/nginx/src/core/ngx_log.c"
...
# 644 "project/nginx/src/core/ngx_log.c"
        ...
        if (peer == 
# 646 "project/nginx/src/core/ngx_log.c" 3 4
                   ((void *)0)
# 646 "project/nginx/src/core/ngx_log.c"
                       ) {
            return 
# 647 "project/nginx/src/core/ngx_log.c" 3 4
                  (void *) -1
# 647 "project/nginx/src/core/ngx_log.c"
                                ;
        }

        if (ngx_syslog_process_conf(cf, peer) != 
# 650 "project/nginx/src/core/ngx_log.c" 3 4
                                                ((void *)0)
# 650 "project/nginx/src/core/ngx_log.c"
                                                           ) {
            return 
# 651 "project/nginx/src/core/ngx_log.c" 3 4
                  (void *) -1
# 651 "project/nginx/src/core/ngx_log.c"
                                ;
        }
        ...
        if (new_log->file == 
# 659 "project/nginx/src/core/ngx_log.c" 3 4
                            ((void *)0)
# 659 "project/nginx/src/core/ngx_log.c"
                                ) {
            return 
# 660 "project/nginx/src/core/ngx_log.c" 3 4
                  (void *) -1
# 660 "project/nginx/src/core/ngx_log.c"
                                ;
        }
    }

    if (ngx_log_set_levels(cf, new_log) != 
# 664 "project/nginx/src/core/ngx_log.c" 3 4
                                          ((void *)0)
# 664 "project/nginx/src/core/ngx_log.c"
                                                     ) {
        return 
# 665 "project/nginx/src/core/ngx_log.c" 3 4
              (void *) -1
# 665 "project/nginx/src/core/ngx_log.c"
                            ;
    }
    ...
    return 
# 672 "project/nginx/src/core/ngx_log.c" 3 4
          ((void *)0)
# 672 "project/nginx/src/core/ngx_log.c"
                     ;
}
