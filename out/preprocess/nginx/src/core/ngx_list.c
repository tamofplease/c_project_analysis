# 0 "project/nginx/src/core/ngx_list.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/core/ngx_list.c"
...
# 9 "project/nginx/src/core/ngx_list.c" 2
...
# 10 "project/nginx/src/core/ngx_list.c" 2



# 12 "project/nginx/src/core/ngx_list.c"
ngx_list_t *
ngx_list_create(ngx_pool_t *pool, ngx_uint_t n, size_t size)
{
    ...
    if (list == 
# 18 "project/nginx/src/core/ngx_list.c" 3 4
               ((void *)0)
# 18 "project/nginx/src/core/ngx_list.c"
                   ) {
        return 
# 19 "project/nginx/src/core/ngx_list.c" 3 4
              ((void *)0)
# 19 "project/nginx/src/core/ngx_list.c"
                  ;
    }

    if (ngx_list_init(list, pool, n, size) != 
# 22 "project/nginx/src/core/ngx_list.c" 3 4
                                             0
# 22 "project/nginx/src/core/ngx_list.c"
                                                   ) {
        return 
# 23 "project/nginx/src/core/ngx_list.c" 3 4
              ((void *)0)
# 23 "project/nginx/src/core/ngx_list.c"
                  ;
    }
...
ngx_list_push(ngx_list_t *l)
{
    ...
    if (last->nelts == l->nalloc) {
        ...
        if (last == 
# 43 "project/nginx/src/core/ngx_list.c" 3 4
                   ((void *)0)
# 43 "project/nginx/src/core/ngx_list.c"
                       ) {
            return 
# 44 "project/nginx/src/core/ngx_list.c" 3 4
                  ((void *)0)
# 44 "project/nginx/src/core/ngx_list.c"
                      ;
        }

        last->elts = ngx_palloc(l->pool, l->nalloc * l->size);
        if (last->elts == 
# 48 "project/nginx/src/core/ngx_list.c" 3 4
                         ((void *)0)
# 48 "project/nginx/src/core/ngx_list.c"
                             ) {
            return 
# 49 "project/nginx/src/core/ngx_list.c" 3 4
                  ((void *)0)
# 49 "project/nginx/src/core/ngx_list.c"
                      ;
        }

        last->nelts = 0;
        last->next = 
# 53 "project/nginx/src/core/ngx_list.c" 3 4
                    ((void *)0)
# 53 "project/nginx/src/core/ngx_list.c"
                        ;
