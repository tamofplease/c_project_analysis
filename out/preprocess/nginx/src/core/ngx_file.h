# 0 "project/nginx/src/core/ngx_file.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/core/ngx_file.h"
# 12 "project/nginx/src/core/ngx_file.h"
...
# 13 "project/nginx/src/core/ngx_file.h" 2
...
# 14 "project/nginx/src/core/ngx_file.h" 2



# 16 "project/nginx/src/core/ngx_file.h"
struct ngx_file_s {
    ngx_fd_t fd;
    ngx_str_t name;
    ...
    ngx_log_t *log;
# 37 "project/nginx/src/core/ngx_file.h"
    unsigned valid_info:1;
    unsigned directio:1;
};
