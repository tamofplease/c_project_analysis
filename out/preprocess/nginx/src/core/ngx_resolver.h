# 0 "project/nginx/src/core/ngx_resolver.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/core/ngx_resolver.h"
...
# 9 "project/nginx/src/core/ngx_resolver.h" 2
...
# 10 "project/nginx/src/core/ngx_resolver.h" 2
