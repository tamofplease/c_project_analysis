# 0 "project/nginx/src/core/ngx_parse.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 9 "project/nginx/src/core/ngx_parse.c" 2
...
# 10 "project/nginx/src/core/ngx_parse.c" 2



# 12 "project/nginx/src/core/ngx_parse.c"
ssize_t
ngx_parse_size(ngx_str_t *line)
{
    ...
    if (len == 0) {
        return 
# 22 "project/nginx/src/core/ngx_parse.c" 3 4
              -1
# 22 "project/nginx/src/core/ngx_parse.c"
                       ;
    }
    ...
    case 'k':
        len--;
        max = 
# 31 "project/nginx/src/core/ngx_parse.c" 3 4
             9223372036854775807LL 
# 31 "project/nginx/src/core/ngx_parse.c"
                                  / 1024;
        scale = 1024;
        break;
    ...
    case 'm':
        len--;
        max = 
# 38 "project/nginx/src/core/ngx_parse.c" 3 4
             9223372036854775807LL 
# 38 "project/nginx/src/core/ngx_parse.c"
                                  / (1024 * 1024);
        scale = 1024 * 1024;
        break;
    ...
    default:
        max = 
# 43 "project/nginx/src/core/ngx_parse.c" 3 4
             9223372036854775807LL
# 43 "project/nginx/src/core/ngx_parse.c"
                                 ;
        scale = 1;
    }
    ...
    if (size == 
# 48 "project/nginx/src/core/ngx_parse.c" 3 4
               -1 
# 48 "project/nginx/src/core/ngx_parse.c"
                         || size > max) {
        return 
# 49 "project/nginx/src/core/ngx_parse.c" 3 4
              -1
# 49 "project/nginx/src/core/ngx_parse.c"
                       ;
    }
...
ngx_parse_offset(ngx_str_t *line)
{
    ...
    if (len == 0) {
        return 
# 68 "project/nginx/src/core/ngx_parse.c" 3 4
              -1
# 68 "project/nginx/src/core/ngx_parse.c"
                       ;
    }
    ...
    case 'k':
        len--;
        max = 
# 77 "project/nginx/src/core/ngx_parse.c" 3 4
             9223372036854775807LL 
# 77 "project/nginx/src/core/ngx_parse.c"
                                 / 1024;
        scale = 1024;
        break;
    ...
    case 'm':
        len--;
        max = 
# 84 "project/nginx/src/core/ngx_parse.c" 3 4
             9223372036854775807LL 
# 84 "project/nginx/src/core/ngx_parse.c"
                                 / (1024 * 1024);
        scale = 1024 * 1024;
        break;
    ...
    case 'g':
        len--;
        max = 
# 91 "project/nginx/src/core/ngx_parse.c" 3 4
             9223372036854775807LL 
# 91 "project/nginx/src/core/ngx_parse.c"
                                 / (1024 * 1024 * 1024);
    ...
    default:
        max = 
# 96 "project/nginx/src/core/ngx_parse.c" 3 4
             9223372036854775807LL
# 96 "project/nginx/src/core/ngx_parse.c"
                                ;
        scale = 1;
    }
    ...
    if (offset == 
# 101 "project/nginx/src/core/ngx_parse.c" 3 4
                 -1 
# 101 "project/nginx/src/core/ngx_parse.c"
                           || offset > max) {
        return 
# 102 "project/nginx/src/core/ngx_parse.c" 3 4
              -1
# 102 "project/nginx/src/core/ngx_parse.c"
                       ;
    }
...
ngx_parse_time(ngx_str_t *line, ngx_uint_t is_sec)
{
    ...
    total = 0;
    cutoff = 
# 134 "project/nginx/src/core/ngx_parse.c" 3 4
            9223372036854775807 
# 134 "project/nginx/src/core/ngx_parse.c"
                                / 10;
    cutlim = 
# 135 "project/nginx/src/core/ngx_parse.c" 3 4
            9223372036854775807 
# 135 "project/nginx/src/core/ngx_parse.c"
                                % 10;
    ...
    while (p < last) {
        ...
        if (*p >= '0' && *p <= '9') {
            if (value >= cutoff && (value > cutoff || *p - '0' > cutlim)) {
                return 
# 145 "project/nginx/src/core/ngx_parse.c" 3 4
                      -1
# 145 "project/nginx/src/core/ngx_parse.c"
                               ;
            }
        ...
        case 'y':
            if (step > st_start) {
                return 
# 157 "project/nginx/src/core/ngx_parse.c" 3 4
                      -1
# 157 "project/nginx/src/core/ngx_parse.c"
                               ;
            }
            step = st_year;
            max = 
# 160 "project/nginx/src/core/ngx_parse.c" 3 4
                 9223372036854775807 
# 160 "project/nginx/src/core/ngx_parse.c"
                                     / (60 * 60 * 24 * 365);
            scale = 60 * 60 * 24 * 365;
            break;
        ...
        case 'M':
            if (step >= st_month) {
                return 
# 166 "project/nginx/src/core/ngx_parse.c" 3 4
                      -1
# 166 "project/nginx/src/core/ngx_parse.c"
                               ;
            }
            step = st_month;
            max = 
# 169 "project/nginx/src/core/ngx_parse.c" 3 4
                 9223372036854775807 
# 169 "project/nginx/src/core/ngx_parse.c"
                                     / (60 * 60 * 24 * 30);
            scale = 60 * 60 * 24 * 30;
            break;
        ...
        case 'w':
            if (step >= st_week) {
                return 
# 175 "project/nginx/src/core/ngx_parse.c" 3 4
                      -1
# 175 "project/nginx/src/core/ngx_parse.c"
                               ;
            }
            step = st_week;
            max = 
# 178 "project/nginx/src/core/ngx_parse.c" 3 4
                 9223372036854775807 
# 178 "project/nginx/src/core/ngx_parse.c"
                                     / (60 * 60 * 24 * 7);
            scale = 60 * 60 * 24 * 7;
            break;
        ...
        case 'd':
            if (step >= st_day) {
                return 
# 184 "project/nginx/src/core/ngx_parse.c" 3 4
                      -1
# 184 "project/nginx/src/core/ngx_parse.c"
                               ;
            }
            step = st_day;
            max = 
# 187 "project/nginx/src/core/ngx_parse.c" 3 4
                 9223372036854775807 
# 187 "project/nginx/src/core/ngx_parse.c"
                                     / (60 * 60 * 24);
            scale = 60 * 60 * 24;
            break;
        ...
        case 'h':
            if (step >= st_hour) {
                return 
# 193 "project/nginx/src/core/ngx_parse.c" 3 4
                      -1
# 193 "project/nginx/src/core/ngx_parse.c"
                               ;
            }
            step = st_hour;
            max = 
# 196 "project/nginx/src/core/ngx_parse.c" 3 4
                 9223372036854775807 
# 196 "project/nginx/src/core/ngx_parse.c"
                                     / (60 * 60);
            scale = 60 * 60;
            break;
        ...
        case 'm':
            if (p < last && *p == 's') {
                if (is_sec || step >= st_msec) {
                    return 
# 203 "project/nginx/src/core/ngx_parse.c" 3 4
                          -1
# 203 "project/nginx/src/core/ngx_parse.c"
                                   ;
                }
                p++;
                step = st_msec;
                max = 
# 207 "project/nginx/src/core/ngx_parse.c" 3 4
                     9223372036854775807
# 207 "project/nginx/src/core/ngx_parse.c"
                                        ;
                scale = 1;
                break;
            }
            ...
            if (step >= st_min) {
                return 
# 213 "project/nginx/src/core/ngx_parse.c" 3 4
                      -1
# 213 "project/nginx/src/core/ngx_parse.c"
                               ;
            }
            step = st_min;
            max = 
# 216 "project/nginx/src/core/ngx_parse.c" 3 4
                 9223372036854775807 
# 216 "project/nginx/src/core/ngx_parse.c"
                                     / 60;
            scale = 60;
            break;
        ...
        case 's':
            if (step >= st_sec) {
                return 
# 222 "project/nginx/src/core/ngx_parse.c" 3 4
                      -1
# 222 "project/nginx/src/core/ngx_parse.c"
                               ;
            }
            step = st_sec;
            max = 
# 225 "project/nginx/src/core/ngx_parse.c" 3 4
                 9223372036854775807
# 225 "project/nginx/src/core/ngx_parse.c"
                                    ;
            scale = 1;
            break;
        ...
        case ' ':
            if (step >= st_sec) {
                return 
# 231 "project/nginx/src/core/ngx_parse.c" 3 4
                      -1
# 231 "project/nginx/src/core/ngx_parse.c"
                               ;
            }
            step = st_last;
            max = 
# 234 "project/nginx/src/core/ngx_parse.c" 3 4
                 9223372036854775807
# 234 "project/nginx/src/core/ngx_parse.c"
                                    ;
            scale = 1;
            break;
        ...
        default:
            return 
# 239 "project/nginx/src/core/ngx_parse.c" 3 4
                  -1
# 239 "project/nginx/src/core/ngx_parse.c"
                           ;
        }
        ...
        if (value > max) {
            return 
# 248 "project/nginx/src/core/ngx_parse.c" 3 4
                  -1
# 248 "project/nginx/src/core/ngx_parse.c"
                           ;
        }
        ...
        if (total > 
# 253 "project/nginx/src/core/ngx_parse.c" 3 4
                   9223372036854775807 
# 253 "project/nginx/src/core/ngx_parse.c"
                                       - value) {
            return 
# 254 "project/nginx/src/core/ngx_parse.c" 3 4
                  -1
# 254 "project/nginx/src/core/ngx_parse.c"
                           ;
        }
    ...
    if (!valid) {
        return 
# 267 "project/nginx/src/core/ngx_parse.c" 3 4
              -1
# 267 "project/nginx/src/core/ngx_parse.c"
                       ;
    }

    if (!is_sec) {
        if (value > 
# 271 "project/nginx/src/core/ngx_parse.c" 3 4
                   9223372036854775807 
# 271 "project/nginx/src/core/ngx_parse.c"
                                       / 1000) {
            return 
# 272 "project/nginx/src/core/ngx_parse.c" 3 4
                  -1
# 272 "project/nginx/src/core/ngx_parse.c"
                           ;
        }
    ...
    if (total > 
# 278 "project/nginx/src/core/ngx_parse.c" 3 4
               9223372036854775807 
# 278 "project/nginx/src/core/ngx_parse.c"
                                   - value) {
        return 
# 279 "project/nginx/src/core/ngx_parse.c" 3 4
              -1
# 279 "project/nginx/src/core/ngx_parse.c"
                       ;
    }
