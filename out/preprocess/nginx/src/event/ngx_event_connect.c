# 0 "project/nginx/src/event/ngx_event_connect.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/event/ngx_event_connect.c"
...
# 9 "project/nginx/src/event/ngx_event_connect.c" 2
...
# 10 "project/nginx/src/event/ngx_event_connect.c" 2
...
# 11 "project/nginx/src/event/ngx_event_connect.c" 2
...
# 12 "project/nginx/src/event/ngx_event_connect.c" 2
# 20 "project/nginx/src/event/ngx_event_connect.c"
...
ngx_event_connect_peer(ngx_peer_connection_t *pc)
{
    ...
    if (rc != 
# 35 "project/nginx/src/event/ngx_event_connect.c" 3 4
             0
# 35 "project/nginx/src/event/ngx_event_connect.c"
                   ) {
        return rc;
    }

    type = (pc->type ? pc->type : 
# 39 "project/nginx/src/event/ngx_event_connect.c" 3 4
                                 1
# 39 "project/nginx/src/event/ngx_event_connect.c"
                                            );

    s = 
# 41 "project/nginx/src/event/ngx_event_connect.c" 3 4
       socket
# 41 "project/nginx/src/event/ngx_event_connect.c"
                 (pc->sockaddr->sa_family, type, 0);
...
# 47 "project/nginx/src/event/ngx_event_connect.c" 3 4
       if ((
# 47 "project/nginx/src/event/ngx_event_connect.c"
       pc->log
# 47 "project/nginx/src/event/ngx_event_connect.c" 3 4
...
# 48 "project/nginx/src/event/ngx_event_connect.c"
                                            ;
        return 
# 49 "project/nginx/src/event/ngx_event_connect.c" 3 4
              -1
# 49 "project/nginx/src/event/ngx_event_connect.c"
                       ;
    }
    ...
    if (c == 
# 55 "project/nginx/src/event/ngx_event_connect.c" 3 4
            ((void *)0)
# 55 "project/nginx/src/event/ngx_event_connect.c"
                ) {
        if (
# 56 "project/nginx/src/event/ngx_event_connect.c" 3 4
           close
# 56 "project/nginx/src/event/ngx_event_connect.c"
                           (s) == -1) {
            
# 57 "project/nginx/src/event/ngx_event_connect.c" 3 4
           if ((
# 57 "project/nginx/src/event/ngx_event_connect.c"
           pc->log
# 57 "project/nginx/src/event/ngx_event_connect.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 57 "project/nginx/src/event/ngx_event_connect.c"
...
# 58 "project/nginx/src/event/ngx_event_connect.c"
                                                      ;
        }

        return 
# 61 "project/nginx/src/event/ngx_event_connect.c" 3 4
              -1
# 61 "project/nginx/src/event/ngx_event_connect.c"
                       ;
    }
    ...
    if (pc->rcvbuf) {
        if (setsockopt(s, 
# 67 "project/nginx/src/event/ngx_event_connect.c" 3 4
                         0xffff
# 67 "project/nginx/src/event/ngx_event_connect.c"
                                   , 
# 67 "project/nginx/src/event/ngx_event_connect.c" 3 4
                                     0x1002
# 67 "project/nginx/src/event/ngx_event_connect.c"
...
# 70 "project/nginx/src/event/ngx_event_connect.c" 3 4
           if ((
# 70 "project/nginx/src/event/ngx_event_connect.c"
           pc->log
# 70 "project/nginx/src/event/ngx_event_connect.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 70 "project/nginx/src/event/ngx_event_connect.c"
...
# 71 "project/nginx/src/event/ngx_event_connect.c"
                                                        ;
            goto failed;
        }
    }
    ...
    if (pc->so_keepalive) {
        ...
        if (setsockopt(s, 
# 79 "project/nginx/src/event/ngx_event_connect.c" 3 4
                         0xffff
# 79 "project/nginx/src/event/ngx_event_connect.c"
                                   , 
# 79 "project/nginx/src/event/ngx_event_connect.c" 3 4
                                     0x0008
# 79 "project/nginx/src/event/ngx_event_connect.c"
...
# 83 "project/nginx/src/event/ngx_event_connect.c" 3 4
           if ((
# 83 "project/nginx/src/event/ngx_event_connect.c"
           pc->log
# 83 "project/nginx/src/event/ngx_event_connect.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 83 "project/nginx/src/event/ngx_event_connect.c"
...
# 84 "project/nginx/src/event/ngx_event_connect.c"
                                                                    ;
        }
    }
...
# 89 "project/nginx/src/event/ngx_event_connect.c" 3 4
       if ((
# 89 "project/nginx/src/event/ngx_event_connect.c"
       pc->log
# 89 "project/nginx/src/event/ngx_event_connect.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 89 "project/nginx/src/event/ngx_event_connect.c"
...
# 90 "project/nginx/src/event/ngx_event_connect.c"
                                                 ;
    ...
    if (pc->local) {
# 152 "project/nginx/src/event/ngx_event_connect.c"
        if (bind(s, pc->local->sockaddr, pc->local->socklen) == -1) {
            
# 153 "project/nginx/src/event/ngx_event_connect.c" 3 4
           if ((
# 153 "project/nginx/src/event/ngx_event_connect.c"
           pc->log
# 153 "project/nginx/src/event/ngx_event_connect.c" 3 4
...
# 154 "project/nginx/src/event/ngx_event_connect.c"
                                                             ;
    ...
    if (type == 
# 160 "project/nginx/src/event/ngx_event_connect.c" 3 4
               1
# 160 "project/nginx/src/event/ngx_event_connect.c"
                          ) {
        c->recv = 
# 161 "project/nginx/src/event/ngx_event_connect.c" 3 4
                 ngx_io.recv
# 161 "project/nginx/src/event/ngx_event_connect.c"
                         ;
        c->send = 
# 162 "project/nginx/src/event/ngx_event_connect.c" 3 4
                 ngx_io.send
# 162 "project/nginx/src/event/ngx_event_connect.c"
                         ;
        c->recv_chain = 
# 163 "project/nginx/src/event/ngx_event_connect.c" 3 4
                       ngx_io.recv_chain
# 163 "project/nginx/src/event/ngx_event_connect.c"
                                     ;
        c->send_chain = 
# 164 "project/nginx/src/event/ngx_event_connect.c" 3 4
                       ngx_io.send_chain
# 164 "project/nginx/src/event/ngx_event_connect.c"
                                     ;

        c->sendfile = 1;

        if (pc->sockaddr->sa_family == 
# 168 "project/nginx/src/event/ngx_event_connect.c" 3 4
                                      1
# 168 "project/nginx/src/event/ngx_event_connect.c"
                                             ) {
        ...
        c->recv = 
# 179 "project/nginx/src/event/ngx_event_connect.c" 3 4
                 ngx_io.udp_recv
# 179 "project/nginx/src/event/ngx_event_connect.c"
                             ;
        c->send = 
# 180 "project/nginx/src/event/ngx_event_connect.c" 3 4
                 ngx_io.send
# 180 "project/nginx/src/event/ngx_event_connect.c"
                         ;
        c->send_chain = 
# 181 "project/nginx/src/event/ngx_event_connect.c" 3 4
                       ngx_io.udp_send_chain
# 181 "project/nginx/src/event/ngx_event_connect.c"
                                         ;
    }
    ...
    c->number = 
# 194 "project/nginx/src/event/ngx_event_connect.c" 3 4
               __sync_fetch_and_add(
# 194 "project/nginx/src/event/ngx_event_connect.c"
...
# 194 "project/nginx/src/event/ngx_event_connect.c"
    ...
    if (
# 198 "project/nginx/src/event/ngx_event_connect.c" 3 4
       ngx_event_actions.add_conn
# 198 "project/nginx/src/event/ngx_event_connect.c"
                   ) {
        if (
# 199 "project/nginx/src/event/ngx_event_connect.c" 3 4
           ngx_event_actions.add_conn
# 199 "project/nginx/src/event/ngx_event_connect.c"
                       (c) == 
# 199 "project/nginx/src/event/ngx_event_connect.c" 3 4
                              -1
# 199 "project/nginx/src/event/ngx_event_connect.c"
    ...
    if (rc == -1) {
        err = 
# 210 "project/nginx/src/event/ngx_event_connect.c" 3 4
             (*__error())
# 210 "project/nginx/src/event/ngx_event_connect.c"
                             ;


        if (err != 
# 213 "project/nginx/src/event/ngx_event_connect.c" 3 4
                  36
...
# 218 "project/nginx/src/event/ngx_event_connect.c"
           )
        {
            if (err == 
# 220 "project/nginx/src/event/ngx_event_connect.c" 3 4
                      61
...
# 228 "project/nginx/src/event/ngx_event_connect.c"
               || err == 
# 228 "project/nginx/src/event/ngx_event_connect.c" 3 4
                         54
                
# 229 "project/nginx/src/event/ngx_event_connect.c"
               || err == 
# 229 "project/nginx/src/event/ngx_event_connect.c" 3 4
                         50
                
# 230 "project/nginx/src/event/ngx_event_connect.c"
               || err == 
# 230 "project/nginx/src/event/ngx_event_connect.c" 3 4
                         51
                
# 231 "project/nginx/src/event/ngx_event_connect.c"
               || err == 
# 231 "project/nginx/src/event/ngx_event_connect.c" 3 4
                         64
                
# 232 "project/nginx/src/event/ngx_event_connect.c"
               || err == 
# 232 "project/nginx/src/event/ngx_event_connect.c" 3 4
                         65
# 232 "project/nginx/src/event/ngx_event_connect.c"
                                         )
            {
                level = 
# 234 "project/nginx/src/event/ngx_event_connect.c" 3 4
                       4
# 234 "project/nginx/src/event/ngx_event_connect.c"
                                  ;

            } else {
                level = 
# 237 "project/nginx/src/event/ngx_event_connect.c" 3 4
                       3
# 237 "project/nginx/src/event/ngx_event_connect.c"
                                   ;
            }

            
# 240 "project/nginx/src/event/ngx_event_connect.c" 3 4
           if ((
# 240 "project/nginx/src/event/ngx_event_connect.c"
           c->log
# 240 "project/nginx/src/event/ngx_event_connect.c" 3 4
           )->log_level >= 
# 240 "project/nginx/src/event/ngx_event_connect.c"
...
# 240 "project/nginx/src/event/ngx_event_connect.c" 3 4
           , 
# 240 "project/nginx/src/event/ngx_event_connect.c"
           err, "connect() to %V failed", pc->name
# 240 "project/nginx/src/event/ngx_event_connect.c" 3 4
           )
                                   
# 241 "project/nginx/src/event/ngx_event_connect.c"
                                  ;

            ngx_close_connection(c);
            pc->connection = 
# 244 "project/nginx/src/event/ngx_event_connect.c" 3 4
                            ((void *)0)
# 244 "project/nginx/src/event/ngx_event_connect.c"
                                ;

            return 
# 246 "project/nginx/src/event/ngx_event_connect.c" 3 4
                  -5
# 246 "project/nginx/src/event/ngx_event_connect.c"
                              ;
        }
    }

    if (
# 250 "project/nginx/src/event/ngx_event_connect.c" 3 4
       ngx_event_actions.add_conn
# 250 "project/nginx/src/event/ngx_event_connect.c"
                   ) {
        if (rc == -1) {
            ...
            return 
# 255 "project/nginx/src/event/ngx_event_connect.c" 3 4
                  -2
# 255 "project/nginx/src/event/ngx_event_connect.c"
                           ;
        }
        ...
        return 
# 262 "project/nginx/src/event/ngx_event_connect.c" 3 4
              0
# 262 "project/nginx/src/event/ngx_event_connect.c"
                    ;
    }

    if (ngx_event_flags & 
# 265 "project/nginx/src/event/ngx_event_connect.c" 3 4
                         0x00000200
# 265 "project/nginx/src/event/ngx_event_connect.c"
                                           ) {
...
# 271 "project/nginx/src/event/ngx_event_connect.c" 3 4
           if ((
# 271 "project/nginx/src/event/ngx_event_connect.c"
           pc->log
# 271 "project/nginx/src/event/ngx_event_connect.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 271 "project/nginx/src/event/ngx_event_connect.c"
...
# 272 "project/nginx/src/event/ngx_event_connect.c"
                                                  ;
            goto failed;
        }
# 283 "project/nginx/src/event/ngx_event_connect.c"
        rev->ready = 1;
        wev->ready = 1;

        return 
# 286 "project/nginx/src/event/ngx_event_connect.c" 3 4
              0
# 286 "project/nginx/src/event/ngx_event_connect.c"
                    ;
    }

    if (ngx_event_flags & 
# 289 "project/nginx/src/event/ngx_event_connect.c" 3 4
                         0x00000004
# 289 "project/nginx/src/event/ngx_event_connect.c"
                                            ) {



        event = 
# 293 "project/nginx/src/event/ngx_event_connect.c" 3 4
               0x0020
# 293 "project/nginx/src/event/ngx_event_connect.c"
                              ;
        ...
        event = 
# 299 "project/nginx/src/event/ngx_event_connect.c" 3 4
               0
# 299 "project/nginx/src/event/ngx_event_connect.c"
                              ;
    }

    if (
# 302 "project/nginx/src/event/ngx_event_connect.c" 3 4
       ngx_event_actions.add
# 302 "project/nginx/src/event/ngx_event_connect.c"
                    (rev, 
# 302 "project/nginx/src/event/ngx_event_connect.c" 3 4
                          (-1)
# 302 "project/nginx/src/event/ngx_event_connect.c"
...
# 302 "project/nginx/src/event/ngx_event_connect.c"
    ...
    if (rc == -1) {
        ...
        if (
# 310 "project/nginx/src/event/ngx_event_connect.c" 3 4
           ngx_event_actions.add
# 310 "project/nginx/src/event/ngx_event_connect.c"
                        (wev, 
# 310 "project/nginx/src/event/ngx_event_connect.c" 3 4
                              (-2)
# 310 "project/nginx/src/event/ngx_event_connect.c"
...
# 310 "project/nginx/src/event/ngx_event_connect.c"
        ...
        return 
# 314 "project/nginx/src/event/ngx_event_connect.c" 3 4
              -2
# 314 "project/nginx/src/event/ngx_event_connect.c"
                       ;
    }
    ...
    return 
# 321 "project/nginx/src/event/ngx_event_connect.c" 3 4
          0
# 321 "project/nginx/src/event/ngx_event_connect.c"
                ;
...
failed:
    ...
    ngx_close_connection(c);
    pc->connection = 
# 326 "project/nginx/src/event/ngx_event_connect.c" 3 4
                    ((void *)0)
# 326 "project/nginx/src/event/ngx_event_connect.c"
                        ;

    return 
# 328 "project/nginx/src/event/ngx_event_connect.c" 3 4
          -1
# 328 "project/nginx/src/event/ngx_event_connect.c"
                   ;
}
# 429 "project/nginx/src/event/ngx_event_connect.c"
ngx_int_t
ngx_event_get_peer(ngx_peer_connection_t *pc, void *data)
{
    return 
# 432 "project/nginx/src/event/ngx_event_connect.c" 3 4
          0
# 432 "project/nginx/src/event/ngx_event_connect.c"
                ;
}
