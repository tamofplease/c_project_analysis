# 0 "project/nginx/src/event/modules/ngx_poll_module.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 9 "project/nginx/src/event/modules/ngx_poll_module.c" 2
...
# 10 "project/nginx/src/event/modules/ngx_poll_module.c" 2
...
# 11 "project/nginx/src/event/modules/ngx_poll_module.c" 2



# 13 "project/nginx/src/event/modules/ngx_poll_module.c"
...
# 28 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                                      { sizeof(
# 28 "project/nginx/src/event/modules/ngx_poll_module.c"
                                      "poll"
# 28 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                                      ) - 1, (u_char *) 
# 28 "project/nginx/src/event/modules/ngx_poll_module.c"
...
# 32 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
   ((void *)0)
# 32 "project/nginx/src/event/modules/ngx_poll_module.c"
       ,
    ngx_poll_init_conf,
...
# 40 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
       ((void *)0)
# 40 "project/nginx/src/event/modules/ngx_poll_module.c"
           ,
        
# 41 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
       ((void *)0)
# 41 "project/nginx/src/event/modules/ngx_poll_module.c"
           ,
        
# 42 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
       ((void *)0)
# 42 "project/nginx/src/event/modules/ngx_poll_module.c"
           ,
...
# 51 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 51 "project/nginx/src/event/modules/ngx_poll_module.c"
   "8" 
# 51 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
   "," 
# 51 "project/nginx/src/event/modules/ngx_poll_module.c"
...
# 53 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
   ((void *)0)
# 53 "project/nginx/src/event/modules/ngx_poll_module.c"
       ,
    
# 54 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
   0x544E5645
# 54 "project/nginx/src/event/modules/ngx_poll_module.c"
                   ,
    
# 55 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
   ((void *)0)
# 55 "project/nginx/src/event/modules/ngx_poll_module.c"
       ,
    
# 56 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
   ((void *)0)
# 56 "project/nginx/src/event/modules/ngx_poll_module.c"
       ,
    
# 57 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
   ((void *)0)
# 57 "project/nginx/src/event/modules/ngx_poll_module.c"
       ,
    
# 58 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
   ((void *)0)
# 58 "project/nginx/src/event/modules/ngx_poll_module.c"
       ,
    
# 59 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
   ((void *)0)
# 59 "project/nginx/src/event/modules/ngx_poll_module.c"
       ,
    
# 60 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
   ((void *)0)
# 60 "project/nginx/src/event/modules/ngx_poll_module.c"
       ,
    
# 61 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
   ((void *)0)
# 61 "project/nginx/src/event/modules/ngx_poll_module.c"
       ,
    
# 62 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 63 "project/nginx/src/event/modules/ngx_poll_module.c"
};
...
ngx_poll_init(ngx_cycle_t *cycle, ngx_msec_t timer)
{
    ...
    if (event_list == 
# 72 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                     ((void *)0)
# 72 "project/nginx/src/event/modules/ngx_poll_module.c"
                         ) {
        nevents = 0;
    }

    if (ngx_process >= 
# 76 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                      3
        
# 77 "project/nginx/src/event/modules/ngx_poll_module.c"
       || cycle->old_cycle == 
# 77 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                              ((void *)0)
        
# 78 "project/nginx/src/event/modules/ngx_poll_module.c"
       || cycle->old_cycle->connection_n < cycle->connection_n)
    {
        list = ngx_alloc(sizeof(struct pollfd) * cycle->connection_n,
                         cycle->log);
        if (list == 
# 82 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                   ((void *)0)
# 82 "project/nginx/src/event/modules/ngx_poll_module.c"
                       ) {
            return 
# 83 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                  -1
# 83 "project/nginx/src/event/modules/ngx_poll_module.c"
                           ;
        }

        if (event_list) {
            
# 87 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
           (void) __builtin___memcpy_chk (
# 87 "project/nginx/src/event/modules/ngx_poll_module.c"
           list
# 87 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
           , 
# 87 "project/nginx/src/event/modules/ngx_poll_module.c"
...
# 88 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
           free
# 88 "project/nginx/src/event/modules/ngx_poll_module.c"
                   (event_list);
        }
    ...
    ngx_event_flags = 
# 98 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                     0x00000001
# 98 "project/nginx/src/event/modules/ngx_poll_module.c"
                                        |
# 98 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                                         0x00000400
# 98 "project/nginx/src/event/modules/ngx_poll_module.c"
    ...
    return 
# 100 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
          0
# 100 "project/nginx/src/event/modules/ngx_poll_module.c"
                ;
}
...
# 107 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
   free
# 107 "project/nginx/src/event/modules/ngx_poll_module.c"
           (event_list);

    event_list = 
# 109 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                ((void *)0)
# 109 "project/nginx/src/event/modules/ngx_poll_module.c"
                    ;
}
...
ngx_poll_add_event(ngx_event_t *ev, ngx_int_t event, ngx_uint_t flags)
{
    ...
    if (ev->index != 
# 123 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                    0xd0d0d0d0
# 123 "project/nginx/src/event/modules/ngx_poll_module.c"
                                     ) {
        
# 124 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
       if ((
# 124 "project/nginx/src/event/modules/ngx_poll_module.c"
       ev->log
# 124 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
...
# 125 "project/nginx/src/event/modules/ngx_poll_module.c"
                                                                           ;
        return 
# 126 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
              0
# 126 "project/nginx/src/event/modules/ngx_poll_module.c"
                    ;
    }

    if (event == 
# 129 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                (-1)
# 129 "project/nginx/src/event/modules/ngx_poll_module.c"
                              ) {
        e = c->write;
    ...
    if (e == 
# 145 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
            ((void *)0) 
# 145 "project/nginx/src/event/modules/ngx_poll_module.c"
                 || e->index == 
# 145 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                                0xd0d0d0d0
# 145 "project/nginx/src/event/modules/ngx_poll_module.c"
    ...
    return 
# 161 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
          0
# 161 "project/nginx/src/event/modules/ngx_poll_module.c"
                ;
}
...
ngx_poll_del_event(ngx_event_t *ev, ngx_int_t event, ngx_uint_t flags)
{
    ...
    if (ev->index == 
# 175 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                    0xd0d0d0d0
# 175 "project/nginx/src/event/modules/ngx_poll_module.c"
                                     ) {
        
# 176 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
       if ((
# 176 "project/nginx/src/event/modules/ngx_poll_module.c"
       ev->log
# 176 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 176 "project/nginx/src/event/modules/ngx_poll_module.c"
...
# 178 "project/nginx/src/event/modules/ngx_poll_module.c"
                                  ;
        return 
# 179 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
              0
# 179 "project/nginx/src/event/modules/ngx_poll_module.c"
                    ;
    }

    if (event == 
# 182 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                (-1)
# 182 "project/nginx/src/event/modules/ngx_poll_module.c"
                              ) {
        e = c->write;
    ...
    if (e == 
# 198 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
            ((void *)0) 
# 198 "project/nginx/src/event/modules/ngx_poll_module.c"
                 || e->index == 
# 198 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                                0xd0d0d0d0
# 198 "project/nginx/src/event/modules/ngx_poll_module.c"
...
# 211 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
               if ((
# 211 "project/nginx/src/event/modules/ngx_poll_module.c"
               ev->log
# 211 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 211 "project/nginx/src/event/modules/ngx_poll_module.c"
...
# 212 "project/nginx/src/event/modules/ngx_poll_module.c"
                                                     ;
    ...
    ev->index = 
# 232 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
               0xd0d0d0d0
# 232 "project/nginx/src/event/modules/ngx_poll_module.c"
                                ;

    return 
# 234 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
          0
# 234 "project/nginx/src/event/modules/ngx_poll_module.c"
                ;
}
...
ngx_poll_process_events(ngx_cycle_t *cycle, ngx_msec_t timer, ngx_uint_t flags)
{
    ...
    ngx_queue_t *queue;
    ngx_connection_t *c;
# 260 "project/nginx/src/event/modules/ngx_poll_module.c"
    ;

    ready = poll(event_list, (u_int) nevents, (int) timer);

    err = (ready == -1) ? 
# 264 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                         (*__error()) 
# 264 "project/nginx/src/event/modules/ngx_poll_module.c"
                                   : 0;

    if (flags & 
# 266 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
               1 
# 266 "project/nginx/src/event/modules/ngx_poll_module.c"
    ...
    if (err) {
        if (err == 
# 274 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                  4
# 274 "project/nginx/src/event/modules/ngx_poll_module.c"
                           ) {

            if (ngx_event_timer_alarm) {
                ngx_event_timer_alarm = 0;
                return 
# 278 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                      0
# 278 "project/nginx/src/event/modules/ngx_poll_module.c"
                            ;
            }

            level = 
# 281 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                   7
# 281 "project/nginx/src/event/modules/ngx_poll_module.c"
                               ;

        } else {
            level = 
# 284 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                   2
# 284 "project/nginx/src/event/modules/ngx_poll_module.c"
                                ;
        }

        
# 287 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
       if ((
# 287 "project/nginx/src/event/modules/ngx_poll_module.c"
       cycle->log
# 287 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
       )->log_level >= 
# 287 "project/nginx/src/event/modules/ngx_poll_module.c"
...
# 287 "project/nginx/src/event/modules/ngx_poll_module.c"
                                                             ;
        return 
# 288 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
              -1
# 288 "project/nginx/src/event/modules/ngx_poll_module.c"
                       ;
    }

    if (ready == 0) {
        if (timer != 
# 292 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                    (ngx_msec_t) -1
# 292 "project/nginx/src/event/modules/ngx_poll_module.c"
                                      ) {
            return 
# 293 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
                  0
# 293 "project/nginx/src/event/modules/ngx_poll_module.c"
                        ;
        }

        
# 296 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
       if ((
# 296 "project/nginx/src/event/modules/ngx_poll_module.c"
       cycle->log
# 296 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 296 "project/nginx/src/event/modules/ngx_poll_module.c"
...
# 296 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
       , 
# 296 "project/nginx/src/event/modules/ngx_poll_module.c"
       0, "poll() returned no events without timeout"
# 296 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
       )
                                                                  
# 297 "project/nginx/src/event/modules/ngx_poll_module.c"
                                                                 ;
        return 
# 298 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
              -1
# 298 "project/nginx/src/event/modules/ngx_poll_module.c"
                       ;
    }
    ...
    for (i = 0; i < nevents && ready; i++) {
        ...
        revents = event_list[i].revents;
                                                                          ...
                                                                          ;
# 317 "project/nginx/src/event/modules/ngx_poll_module.c"
        if (revents & POLLNVAL) {
            
# 318 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
           if ((
# 318 "project/nginx/src/event/modules/ngx_poll_module.c"
           cycle->log
# 318 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 318 "project/nginx/src/event/modules/ngx_poll_module.c"
...
# 320 "project/nginx/src/event/modules/ngx_poll_module.c"
                                                                         ;
        }

        if (revents & ~(POLLIN|POLLOUT|POLLERR|POLLHUP|POLLNVAL)) {
            
# 324 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
           if ((
# 324 "project/nginx/src/event/modules/ngx_poll_module.c"
           cycle->log
# 324 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 324 "project/nginx/src/event/modules/ngx_poll_module.c"
...
# 326 "project/nginx/src/event/modules/ngx_poll_module.c"
                                                                         ;
        }
...
# 340 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
           if ((
# 340 "project/nginx/src/event/modules/ngx_poll_module.c"
           cycle->log
# 340 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 340 "project/nginx/src/event/modules/ngx_poll_module.c"
...
# 378 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
           if (!(
# 378 "project/nginx/src/event/modules/ngx_poll_module.c"
           ev
# 378 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
           )->posted) { (
# 378 "project/nginx/src/event/modules/ngx_poll_module.c"
...
# 387 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
           if (!(
# 387 "project/nginx/src/event/modules/ngx_poll_module.c"
           ev
# 387 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
           )->posted) { (
# 387 "project/nginx/src/event/modules/ngx_poll_module.c"
...
# 397 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
       if ((
# 397 "project/nginx/src/event/modules/ngx_poll_module.c"
       cycle->log
# 397 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 397 "project/nginx/src/event/modules/ngx_poll_module.c"
...
# 397 "project/nginx/src/event/modules/ngx_poll_module.c"
    ...
    return 
# 400 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
          0
# 400 "project/nginx/src/event/modules/ngx_poll_module.c"
                ;
}
...
ngx_poll_init_conf(ngx_cycle_t *cycle, void *conf)
{
    ...
    ecf = 
# 409 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
         (*(
# 409 "project/nginx/src/event/modules/ngx_poll_module.c"
         cycle->conf_ctx
# 409 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
...
# 409 "project/nginx/src/event/modules/ngx_poll_module.c"
    ...
    if (ecf->use != ngx_poll_module.ctx_index) {
        return 
# 412 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
              ((void *)0)
# 412 "project/nginx/src/event/modules/ngx_poll_module.c"
                         ;
    }

    return 
# 415 "project/nginx/src/event/modules/ngx_poll_module.c" 3 4
          ((void *)0)
# 415 "project/nginx/src/event/modules/ngx_poll_module.c"
                     ;
}
