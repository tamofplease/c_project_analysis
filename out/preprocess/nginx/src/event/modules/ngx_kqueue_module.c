# 0 "project/nginx/src/event/modules/ngx_kqueue_module.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 9 "project/nginx/src/event/modules/ngx_kqueue_module.c" 2
...
# 10 "project/nginx/src/event/modules/ngx_kqueue_module.c" 2
...
# 11 "project/nginx/src/event/modules/ngx_kqueue_module.c" 2



# 13 "project/nginx/src/event/modules/ngx_kqueue_module.c"
typedef struct {
    ngx_uint_t changes;
    ngx_uint_t events;
} ngx_kqueue_conf_t;
...
static ngx_int_t ngx_kqueue_process_events(ngx_cycle_t *cycle, ngx_msec_t timer,
    ngx_uint_t flags);
static 
# 35 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
      inline 
# 35 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                 void ngx_kqueue_dump_event(ngx_log_t *log,
    struct kevent *kev);
...
static ngx_str_t kqueue_name = 
# 54 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                                   { sizeof(
# 54 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                   "kqueue"
# 54 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                                   ) - 1, (u_char *) 
# 54 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
static ngx_command_t ngx_kqueue_commands[] = {
    ...
    { 
# 58 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
     { sizeof(
# 58 "project/nginx/src/event/modules/ngx_kqueue_module.c"
     "kqueue_changes"
# 58 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
     ) - 1, (u_char *) 
# 58 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 59 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
     0x02000000
# 59 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                   |
# 59 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                    0x00000002
# 59 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 62 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
     __builtin_offsetof (
# 62 "project/nginx/src/event/modules/ngx_kqueue_module.c"
     ngx_kqueue_conf_t
# 62 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
     , 
# 62 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 63 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
     ((void *)0) 
# 63 "project/nginx/src/event/modules/ngx_kqueue_module.c"
          },

    { 
# 65 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
     { sizeof(
# 65 "project/nginx/src/event/modules/ngx_kqueue_module.c"
     "kqueue_events"
# 65 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
     ) - 1, (u_char *) 
# 65 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 66 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
     0x02000000
# 66 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                   |
# 66 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                    0x00000002
# 66 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 69 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
     __builtin_offsetof (
# 69 "project/nginx/src/event/modules/ngx_kqueue_module.c"
     ngx_kqueue_conf_t
# 69 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
     , 
# 69 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 70 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
     ((void *)0) 
# 70 "project/nginx/src/event/modules/ngx_kqueue_module.c"
          },

      
# 72 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 73 "project/nginx/src/event/modules/ngx_kqueue_module.c"
};
...
# 86 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
       ((void *)0)
# 86 "project/nginx/src/event/modules/ngx_kqueue_module.c"
           ,
        
# 87 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
       ((void *)0)
# 87 "project/nginx/src/event/modules/ngx_kqueue_module.c"
           ,
...
# 101 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 101 "project/nginx/src/event/modules/ngx_kqueue_module.c"
   "8" 
# 101 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
   "," 
# 101 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 104 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
   0x544E5645
# 104 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                   ,
    
# 105 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
   ((void *)0)
# 105 "project/nginx/src/event/modules/ngx_kqueue_module.c"
       ,
    
# 106 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
   ((void *)0)
# 106 "project/nginx/src/event/modules/ngx_kqueue_module.c"
       ,
    
# 107 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
   ((void *)0)
# 107 "project/nginx/src/event/modules/ngx_kqueue_module.c"
       ,
    
# 108 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
   ((void *)0)
# 108 "project/nginx/src/event/modules/ngx_kqueue_module.c"
       ,
    
# 109 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
   ((void *)0)
# 109 "project/nginx/src/event/modules/ngx_kqueue_module.c"
       ,
    
# 110 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
   ((void *)0)
# 110 "project/nginx/src/event/modules/ngx_kqueue_module.c"
       ,
    
# 111 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
   ((void *)0)
# 111 "project/nginx/src/event/modules/ngx_kqueue_module.c"
       ,
    
# 112 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 113 "project/nginx/src/event/modules/ngx_kqueue_module.c"
};
...
ngx_kqueue_init(ngx_cycle_t *cycle, ngx_msec_t timer)
{
    ...
    kcf = 
# 125 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
         (*(
# 125 "project/nginx/src/event/modules/ngx_kqueue_module.c"
         cycle->conf_ctx
# 125 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
...
# 131 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
           if ((
# 131 "project/nginx/src/event/modules/ngx_kqueue_module.c"
           cycle->log
# 131 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
...
# 132 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                           ;
            return 
# 133 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                  -1
# 133 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                           ;
        }


        if (ngx_kqueue_notify_init(cycle->log) != 
# 137 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                                                 0
# 137 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                                       ) {
            return 
# 138 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                  -1
# 138 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                           ;
        }
    ...
    if (max_changes < kcf->changes) {
        if (nchanges) {
            ...
            if (kevent(ngx_kqueue, change_list, (int) nchanges, 
# 148 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                                                               ((void *)0)
# 148 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                                                   , 0, &ts)
                == -1)
            {
                
# 151 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
               if ((
# 151 "project/nginx/src/event/modules/ngx_kqueue_module.c"
               cycle->log
# 151 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
...
# 152 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                               ;
                return 
# 153 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                      -1
# 153 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                               ;
            }
            nchanges = 0;
        }
...
# 159 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
           free
# 159 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                   (change_list);
        }
        ...
        change_list = ngx_alloc(kcf->changes * sizeof(struct kevent),
                                cycle->log);
        if (change_list == 
# 164 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                          ((void *)0)
# 164 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                              ) {
            return 
# 165 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                  -1
# 165 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                           ;
        }
    }
...
# 173 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
           free
# 173 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                   (event_list);
        }

        event_list = ngx_alloc(kcf->events * sizeof(struct kevent), cycle->log);
        if (event_list == 
# 177 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                         ((void *)0)
# 177 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                             ) {
            return 
# 178 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                  -1
# 178 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                           ;
        }
    }

    ngx_event_flags = 
# 182 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                     0x00000002
                      
# 183 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                     |
# 183 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                      0x00000008
                      
# 184 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                     |
# 184 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                      0x00002000
# 184 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                         ;
    ...
    if (timer) {
        kev.ident = 0;
        kev.filter = 
# 190 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                    (-7)
# 190 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                ;
        kev.flags = 
# 191 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                   0x0001
# 191 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                         |
# 191 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                          0x0004
# 191 "project/nginx/src/event/modules/ngx_kqueue_module.c"
        ...
        if (kevent(ngx_kqueue, &kev, 1, 
# 199 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                                       ((void *)0)
# 199 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                           , 0, &ts) == -1) {
            
# 200 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
           if ((
# 200 "project/nginx/src/event/modules/ngx_kqueue_module.c"
           cycle->log
# 200 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 200 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 201 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                                       ;
            return 
# 202 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                  -1
# 202 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                           ;
        }

        ngx_event_flags |= 
# 205 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                          0x00000800
# 205 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                             ;
    }
    ...
    ngx_event_flags |= 
# 211 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                      0x00000004
# 211 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                         ;
# 220 "project/nginx/src/event/modules/ngx_kqueue_module.c"
    nevents = kcf->events;
    ...
    return 
# 226 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
          0
# 226 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                ;
}
...
ngx_kqueue_notify_init(ngx_log_t *log)
{
    notify_kev.ident = 0;
    notify_kev.filter = 
# 236 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                       (-10)
# 236 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                  ;
    notify_kev.data = 0;
    notify_kev.flags = 
# 238 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                      0x0001
# 238 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                            |
# 238 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                             0x0020
# 238 "project/nginx/src/event/modules/ngx_kqueue_module.c"
    ...
    if (kevent(ngx_kqueue, &notify_kev, 1, 
# 242 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                                          ((void *)0)
# 242 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                              , 0, 
# 242 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                                                   ((void *)0)
# 242 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 243 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
       if ((
# 243 "project/nginx/src/event/modules/ngx_kqueue_module.c"
       log
# 243 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 243 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 244 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                                          ;
        return 
# 245 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
              -1
# 245 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                       ;
    }
    ...
    notify_kev.flags = 0;
    notify_kev.fflags = 
# 252 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                       0x01000000
# 252 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                   ;
    notify_kev.udata = 
# 253 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                      (void *) 
# 253 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                         ((uintptr_t) &notify_event);

    return 
# 255 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
          0
# 255 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                ;
}
...
# 265 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
       if ((
# 265 "project/nginx/src/event/modules/ngx_kqueue_module.c"
       cycle->log
# 265 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 265 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 266 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                             ;
    }
...
# 271 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
   free
# 271 "project/nginx/src/event/modules/ngx_kqueue_module.c"
           (change_list);
    
# 272 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
   free
# 272 "project/nginx/src/event/modules/ngx_kqueue_module.c"
           (event_list);

    change_list = 
# 274 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                 ((void *)0)
# 274 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                     ;
    event_list = 
# 275 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                ((void *)0)
# 275 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                    ;
    max_changes = 0;
    nchanges = 0;
    nevents = 0;
...
ngx_kqueue_add_event(ngx_event_t *ev, ngx_int_t event, ngx_uint_t flags)
{
    ...
    ev->disabled = 0;
    ev->oneshot = (flags & 
# 293 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                          0x0010
# 293 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                           ) ? 1 : 0;
# 332 "project/nginx/src/event/modules/ngx_kqueue_module.c"
    rc = ngx_kqueue_set_event(ev, event, 
# 332 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                                        0x0001
# 332 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                              |
# 332 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
...
ngx_kqueue_del_event(ngx_event_t *ev, ngx_int_t event, ngx_uint_t flags)
{
            ...
            == (uintptr_t) ev)
    {
        ...
        return 
# 366 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
              0
# 366 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                    ;
    }
    ...
    if (flags & 
# 375 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
               0x8000
# 375 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                              ) {
        return 
# 376 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
              0
# 376 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                    ;
    }

    if (flags & 
# 379 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
               0x0008
# 379 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                ) {
        ev->disabled = 1;

    } else {
        flags |= 
# 383 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                0x0002
# 383 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                         ;
    }
...
# 406 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
       if ((
# 406 "project/nginx/src/event/modules/ngx_kqueue_module.c"
       ev->log
# 406 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
...
# 406 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
       , 
# 406 "project/nginx/src/event/modules/ngx_kqueue_module.c"
       0, "kqueue change list is filled up"
# 406 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
       )
                                                        
# 407 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                                       ;
        ...
        if (kevent(ngx_kqueue, change_list, (int) nchanges, 
# 412 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                                                           ((void *)0)
# 412 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                                               , 0, &ts)
            == -1)
        {
            
# 415 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
           if ((
# 415 "project/nginx/src/event/modules/ngx_kqueue_module.c"
           ev->log
# 415 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 415 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 415 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                                                              ;
            return 
# 416 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                  -1
# 416 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                           ;
        }
    ...
    kev->udata = 
# 427 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                (void *) 
# 427 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                   ((uintptr_t) ev | ev->instance);

    if (filter == 
# 429 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                 (-4)
# 429 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                             ) {
        kev->fflags = 
# 430 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                     0x00000001
# 430 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                |
# 430 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                                 0x00000002
# 430 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 431 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                |
# 431 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                                 0x00000008
# 431 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                            |
# 431 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
...
# 436 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                     ;
        kev->data = 0;

    } else {
# 450 "project/nginx/src/event/modules/ngx_kqueue_module.c"
        kev->fflags = 0;
        kev->data = 0;
    ...
    if (flags & 
# 458 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
               0x4000
# 458 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                              ) {
        ts.tv_sec = 0;
        ts.tv_nsec = 0;
        ...
        if (kevent(ngx_kqueue, change_list, (int) nchanges, 
# 464 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                                                           ((void *)0)
# 464 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                                               , 0, &ts)
            == -1)
        {
            
# 467 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
           if ((
# 467 "project/nginx/src/event/modules/ngx_kqueue_module.c"
           ev->log
# 467 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 467 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 467 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                                                              ;
            return 
# 468 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                  -1
# 468 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                           ;
        }
    ...
    return 
# 474 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
          0
# 474 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                ;
}
...
ngx_kqueue_notify(ngx_event_handler_pt handler)
{
    ...
    if (kevent(ngx_kqueue, &notify_kev, 1, 
# 485 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                                          ((void *)0)
# 485 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                              , 0, 
# 485 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                                                   ((void *)0)
# 485 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 486 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
       if ((
# 486 "project/nginx/src/event/modules/ngx_kqueue_module.c"
       notify_event.log
# 486 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 486 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 487 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                                                ;
        return 
# 488 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
              -1
# 488 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                       ;
    }

    return 
# 491 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
          0
# 491 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                ;
}
    ...
    ngx_uint_t flags)
{
    ...
    if (timer == 
# 512 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                (ngx_msec_t) -1
# 512 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                  ) {
        tp = 
# 513 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
            ((void *)0)
# 513 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                ;
...
# 530 "project/nginx/src/event/modules/ngx_kqueue_module.c"
        tp = &ts;
    }
    ...
    err = (events == -1) ? 
# 538 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                          (*__error()) 
# 538 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                    : 0;

    if (flags & 
# 540 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
               1 
# 540 "project/nginx/src/event/modules/ngx_kqueue_module.c"
    ...
    if (err) {
        if (err == 
# 548 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                  4
# 548 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                           ) {

            if (ngx_event_timer_alarm) {
                ngx_event_timer_alarm = 0;
                return 
# 552 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                      0
# 552 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                            ;
            }

            level = 
# 555 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                   7
# 555 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                               ;

        } else {
            level = 
# 558 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                   2
# 558 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                ;
        }

        
# 561 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
       if ((
# 561 "project/nginx/src/event/modules/ngx_kqueue_module.c"
       cycle->log
# 561 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
       )->log_level >= 
# 561 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 561 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                                               ;
        return 
# 562 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
              -1
# 562 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                       ;
    }

    if (events == 0) {
        if (timer != 
# 566 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                    (ngx_msec_t) -1
# 566 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                      ) {
            return 
# 567 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                  0
# 567 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                        ;
        }

        
# 570 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
       if ((
# 570 "project/nginx/src/event/modules/ngx_kqueue_module.c"
       cycle->log
# 570 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 570 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 570 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
       , 
# 570 "project/nginx/src/event/modules/ngx_kqueue_module.c"
       0, "kevent() returned no events without timeout"
# 570 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
       )
                                                                    
# 571 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                                                   ;
        return 
# 572 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
              -1
# 572 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                       ;
    }
    ...
    for (i = 0; i < events; i++) {
        ...
        if (event_list[i].flags & 
# 579 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                                 0x4000
# 579 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                         ) {
            
# 580 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
           if ((
# 580 "project/nginx/src/event/modules/ngx_kqueue_module.c"
           cycle->log
# 580 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 580 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 580 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
           , 
# 580 "project/nginx/src/event/modules/ngx_kqueue_module.c"
           event_list[i].data, "kevent() error on %d filter:%d flags:%04Xd", (int) event_list[i].ident, event_list[i].filter, event_list[i].flags
# 580 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
           )


                                              
# 583 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                             ;
            continue;
        }
...
# 589 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                                   (-7)
# 589 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                               ) {
            ngx_time_update();
            continue;
        }
        ...
        case 
# 600 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
            (-1)
# 600 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                       :
        case 
# 601 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
            (-2)
# 601 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                        :
            ...
            if (ev->log && (ev->log->log_level & 
# 618 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                                                0x80000000
# 618 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                                                        )) {
            ...
            if (event_list[i].flags & 
# 628 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                                     0x8000
# 628 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                           ) {
                ev->pending_eof = 1;
        ...
        case 
# 637 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
            (-4)
# 637 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                        :
            ev->kq_vnode = 1;
        ...
        case 
# 642 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
            (-3)
# 642 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                      :
            ev->complete = 1;
            ev->ready = 1;
        ...
        case 
# 649 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
            (-10)
# 649 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                       :
            break;
...
# 654 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
           if ((
# 654 "project/nginx/src/event/modules/ngx_kqueue_module.c"
           cycle->log
# 654 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 654 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 654 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
           , 
# 654 "project/nginx/src/event/modules/ngx_kqueue_module.c"
           0, "unexpected kevent() filter %d", event_list[i].filter
# 654 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
           )

                                               
# 656 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                              ;
            continue;
        }

        if (flags & 
# 660 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                   2
# 660 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                  ) {
            queue = ev->accept ? &ngx_posted_accept_events
                               : &ngx_posted_events;

            
# 664 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
           if (!(
# 664 "project/nginx/src/event/modules/ngx_kqueue_module.c"
           ev
# 664 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
           )->posted) { (
# 664 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 664 "project/nginx/src/event/modules/ngx_kqueue_module.c"
    ...
    return 
# 672 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
          0
# 672 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                ;
}


static 
# 676 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
      inline 
# 676 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                 void
...
ngx_kqueue_create_conf(ngx_cycle_t *cycle)
{
    ...
    if (kcf == 
# 702 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
              ((void *)0)
# 702 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                  ) {
        return 
# 703 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
              ((void *)0)
# 703 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                  ;
    }

    kcf->changes = 
# 706 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                  -1
# 706 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                                ;
    kcf->events = 
# 707 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
                 -1
# 707 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                               ;
...
# 718 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
   if (
# 718 "project/nginx/src/event/modules/ngx_kqueue_module.c"
   kcf->changes 
# 718 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
   == (ngx_uint_t) -1) { 
# 718 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 719 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
   if (
# 719 "project/nginx/src/event/modules/ngx_kqueue_module.c"
   kcf->events 
# 719 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
   == (ngx_uint_t) -1) { 
# 719 "project/nginx/src/event/modules/ngx_kqueue_module.c"
...
# 719 "project/nginx/src/event/modules/ngx_kqueue_module.c"
    ...
    return 
# 721 "project/nginx/src/event/modules/ngx_kqueue_module.c" 3 4
          ((void *)0)
# 721 "project/nginx/src/event/modules/ngx_kqueue_module.c"
                     ;
}
