# 0 "project/nginx/src/event/ngx_event_pipe.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/event/ngx_event_pipe.h"
# 12 "project/nginx/src/event/ngx_event_pipe.h"
...
# 13 "project/nginx/src/event/ngx_event_pipe.h" 2
...
# 14 "project/nginx/src/event/ngx_event_pipe.h" 2
...
# 15 "project/nginx/src/event/ngx_event_pipe.h" 2



# 17 "project/nginx/src/event/ngx_event_pipe.h"
...
struct ngx_event_pipe_s {
    ...
    void *output_ctx;
# 57 "project/nginx/src/event/ngx_event_pipe.h"
    unsigned read:1;
