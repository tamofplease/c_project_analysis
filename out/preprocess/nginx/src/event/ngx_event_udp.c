# 0 "project/nginx/src/event/ngx_event_udp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/event/ngx_event_udp.c"
...
# 9 "project/nginx/src/event/ngx_event_udp.c" 2
...
# 10 "project/nginx/src/event/ngx_event_udp.c" 2
...
# 11 "project/nginx/src/event/ngx_event_udp.c" 2





# 15 "project/nginx/src/event/ngx_event_udp.c"
...
ngx_event_recvmsg(ngx_event_t *ev)
{
    ...
    u_char msg_control[
# 52 "project/nginx/src/event/ngx_event_udp.c" 3 4
...
# 52 "project/nginx/src/event/ngx_event_udp.c"
...
# 52 "project/nginx/src/event/ngx_event_udp.c"
    ...
    u_char msg_control6[
# 58 "project/nginx/src/event/ngx_event_udp.c" 3 4
                                   (((__darwin_size_t)((__darwin_size_t)(sizeof(struct cmsghdr)) + (sizeof(__uint32_t) - 1)) &~ (sizeof(__uint32_t) - 1)) + ((__darwin_size_t)((__darwin_size_t)(
# 58 "project/nginx/src/event/ngx_event_udp.c"
...
# 64 "project/nginx/src/event/ngx_event_udp.c" 3 4
                                                                  0
# 64 "project/nginx/src/event/ngx_event_udp.c"
                                                                        ) {
            return;
        }
    ...
    ecf = 
# 71 "project/nginx/src/event/ngx_event_udp.c" 3 4
         (*(
# 71 "project/nginx/src/event/ngx_event_udp.c"
         ngx_cycle->conf_ctx
# 71 "project/nginx/src/event/ngx_event_udp.c" 3 4
...
# 71 "project/nginx/src/event/ngx_event_udp.c"
    ...
    if (!(ngx_event_flags & 
# 73 "project/nginx/src/event/ngx_event_udp.c" 3 4
                           0x00000008
# 73 "project/nginx/src/event/ngx_event_udp.c"
                                               )) {
...
# 85 "project/nginx/src/event/ngx_event_udp.c" 3 4
       (void) __builtin___memset_chk (
# 85 "project/nginx/src/event/ngx_event_udp.c"
       &msg
# 85 "project/nginx/src/event/ngx_event_udp.c" 3 4
       , 0, 
# 85 "project/nginx/src/event/ngx_event_udp.c"
...
# 85 "project/nginx/src/event/ngx_event_udp.c"
        ...
        if (ls->wildcard) {
            ...
            if (ls->sockaddr->sa_family == 
# 100 "project/nginx/src/event/ngx_event_udp.c" 3 4
                                          2
# 100 "project/nginx/src/event/ngx_event_udp.c"
                                                 ) {
            ...
            if (ls->sockaddr->sa_family == 
# 107 "project/nginx/src/event/ngx_event_udp.c" 3 4
                                          30
# 107 "project/nginx/src/event/ngx_event_udp.c"
                                                  ) {
        ...
        if (n == -1) {
            err = 
# 119 "project/nginx/src/event/ngx_event_udp.c" 3 4
                 (*__error())
# 119 "project/nginx/src/event/ngx_event_udp.c"
                                 ;

            if (err == 
# 121 "project/nginx/src/event/ngx_event_udp.c" 3 4
                      35
# 121 "project/nginx/src/event/ngx_event_udp.c"
                                ) {
...
# 127 "project/nginx/src/event/ngx_event_udp.c" 3 4
           if ((
# 127 "project/nginx/src/event/ngx_event_udp.c"
           ev->log
# 127 "project/nginx/src/event/ngx_event_udp.c" 3 4
...
# 127 "project/nginx/src/event/ngx_event_udp.c"
        ...
        if (msg.msg_flags & (
# 133 "project/nginx/src/event/ngx_event_udp.c" 3 4
                            0x10
# 133 "project/nginx/src/event/ngx_event_udp.c"
                                     |
# 133 "project/nginx/src/event/ngx_event_udp.c" 3 4
                                      0x20
# 133 "project/nginx/src/event/ngx_event_udp.c"
...
# 134 "project/nginx/src/event/ngx_event_udp.c" 3 4
           if ((
# 134 "project/nginx/src/event/ngx_event_udp.c"
           ev->log
# 134 "project/nginx/src/event/ngx_event_udp.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 134 "project/nginx/src/event/ngx_event_udp.c"
...
# 135 "project/nginx/src/event/ngx_event_udp.c"
                                                    ;
            continue;
        }
...
# 155 "project/nginx/src/event/ngx_event_udp.c" 3 4
           (void) __builtin___memset_chk (
# 155 "project/nginx/src/event/ngx_event_udp.c"
           &sa
# 155 "project/nginx/src/event/ngx_event_udp.c" 3 4
           , 0, 
# 155 "project/nginx/src/event/ngx_event_udp.c"
...
# 167 "project/nginx/src/event/ngx_event_udp.c" 3 4
           (void) __builtin___memcpy_chk (
# 167 "project/nginx/src/event/ngx_event_udp.c"
           &lsa
# 167 "project/nginx/src/event/ngx_event_udp.c" 3 4
           , 
# 167 "project/nginx/src/event/ngx_event_udp.c"
...
# 167 "project/nginx/src/event/ngx_event_udp.c"
            ...
            for (cmsg = 
# 170 "project/nginx/src/event/ngx_event_udp.c" 3 4
                       ((
# 170 "project/nginx/src/event/ngx_event_udp.c"
                       &msg
# 170 "project/nginx/src/event/ngx_event_udp.c" 3 4
...
# 170 "project/nginx/src/event/ngx_event_udp.c"
                                          ;
                 cmsg != 
# 171 "project/nginx/src/event/ngx_event_udp.c" 3 4
                        ((void *)0)
# 171 "project/nginx/src/event/ngx_event_udp.c"
                            ;
                 cmsg = 
# 172 "project/nginx/src/event/ngx_event_udp.c" 3 4
                       ((char *)(
# 172 "project/nginx/src/event/ngx_event_udp.c"
                       cmsg
# 172 "project/nginx/src/event/ngx_event_udp.c" 3 4
                       ) == (char *)0L ? ((
# 172 "project/nginx/src/event/ngx_event_udp.c"
...
# 172 "project/nginx/src/event/ngx_event_udp.c"
                       &msg
# 172 "project/nginx/src/event/ngx_event_udp.c" 3 4
                       )->msg_control : (struct cmsghdr *)0L) : ((((unsigned char *)(
# 172 "project/nginx/src/event/ngx_event_udp.c"
                       cmsg
# 172 "project/nginx/src/event/ngx_event_udp.c" 3 4
                       ) + ((__darwin_size_t)((__darwin_size_t)((__uint32_t)(
# 172 "project/nginx/src/event/ngx_event_udp.c"
                       cmsg
# 172 "project/nginx/src/event/ngx_event_udp.c" 3 4
                       )->cmsg_len) + (sizeof(__uint32_t) - 1)) &~ (sizeof(__uint32_t) - 1)) + ((__darwin_size_t)((__darwin_size_t)(sizeof(struct cmsghdr)) + (sizeof(__uint32_t) - 1)) &~ (sizeof(__uint32_t) - 1))) > ((unsigned char *)(
# 172 "project/nginx/src/event/ngx_event_udp.c"
                       &msg
# 172 "project/nginx/src/event/ngx_event_udp.c" 3 4
                       )->msg_control + (
# 172 "project/nginx/src/event/ngx_event_udp.c"
                       &msg
# 172 "project/nginx/src/event/ngx_event_udp.c" 3 4
                       )->msg_controllen)) ? (struct cmsghdr *)0L : (struct cmsghdr *)(void *)((unsigned char *)(
# 172 "project/nginx/src/event/ngx_event_udp.c"
                       cmsg
# 172 "project/nginx/src/event/ngx_event_udp.c" 3 4
                       ) + ((__darwin_size_t)((__darwin_size_t)((__uint32_t)(
# 172 "project/nginx/src/event/ngx_event_udp.c"
                       cmsg
# 172 "project/nginx/src/event/ngx_event_udp.c" 3 4
                       )->cmsg_len) + (sizeof(__uint32_t) - 1)) &~ (sizeof(__uint32_t) - 1)))))
# 172 "project/nginx/src/event/ngx_event_udp.c"
                                              )
            {
                ...
                if (cmsg->cmsg_level == 
# 177 "project/nginx/src/event/ngx_event_udp.c" 3 4
                                       0
                    
# 178 "project/nginx/src/event/ngx_event_udp.c"
                   && cmsg->cmsg_type == 
# 178 "project/nginx/src/event/ngx_event_udp.c" 3 4
                                         7
                    
# 179 "project/nginx/src/event/ngx_event_udp.c"
                   && local_sockaddr->sa_family == 
# 179 "project/nginx/src/event/ngx_event_udp.c" 3 4
                                                   2
# 179 "project/nginx/src/event/ngx_event_udp.c"
                                                          )
                {
                    ...
                    addr = (struct in_addr *) 
# 184 "project/nginx/src/event/ngx_event_udp.c" 3 4
                                             ((unsigned char *)(
# 184 "project/nginx/src/event/ngx_event_udp.c"
                                             cmsg
# 184 "project/nginx/src/event/ngx_event_udp.c" 3 4
...
# 211 "project/nginx/src/event/ngx_event_udp.c"
                if (cmsg->cmsg_level == 
# 211 "project/nginx/src/event/ngx_event_udp.c" 3 4
                                       41
                    
# 212 "project/nginx/src/event/ngx_event_udp.c"
                   && cmsg->cmsg_type == 
# 212 "project/nginx/src/event/ngx_event_udp.c" 3 4
                                         46
                    
# 213 "project/nginx/src/event/ngx_event_udp.c"
                   && local_sockaddr->sa_family == 
# 213 "project/nginx/src/event/ngx_event_udp.c" 3 4
                                                   30
# 213 "project/nginx/src/event/ngx_event_udp.c"
                                                           )
                {
...
# 218 "project/nginx/src/event/ngx_event_udp.c" 3 4
                                                 ((unsigned char *)(
# 218 "project/nginx/src/event/ngx_event_udp.c"
                                                 cmsg
# 218 "project/nginx/src/event/ngx_event_udp.c" 3 4
                                                 ) + ((__darwin_size_t)((__darwin_size_t)(sizeof(struct cmsghdr)) + (sizeof(__uint32_t) - 1)) &~ (sizeof(__uint32_t) - 1)))
# 218 "project/nginx/src/event/ngx_event_udp.c"
        ...
        if (c) {
# 251 "project/nginx/src/event/ngx_event_udp.c"
            
# 251 "project/nginx/src/event/ngx_event_udp.c" 3 4
           (void) __builtin___memset_chk (
# 251 "project/nginx/src/event/ngx_event_udp.c"
           &buf
# 251 "project/nginx/src/event/ngx_event_udp.c" 3 4
...
# 251 "project/nginx/src/event/ngx_event_udp.c"
            ...
            if (c->udp) {
                c->udp->buffer = 
# 266 "project/nginx/src/event/ngx_event_udp.c" 3 4
                                ((void *)0)
# 266 "project/nginx/src/event/ngx_event_udp.c"
                                    ;
            }
        ...
        if (c == 
# 283 "project/nginx/src/event/ngx_event_udp.c" 3 4
                ((void *)0)
# 283 "project/nginx/src/event/ngx_event_udp.c"
                    ) {
            return;
        }
        ...
        c->shared = 1;
        c->type = 
# 288 "project/nginx/src/event/ngx_event_udp.c" 3 4
                 2
# 288 "project/nginx/src/event/ngx_event_udp.c"
                           ;
        c->socklen = socklen;
        ...
        if (c->pool == 
# 296 "project/nginx/src/event/ngx_event_udp.c" 3 4
                      ((void *)0)
# 296 "project/nginx/src/event/ngx_event_udp.c"
                          ) {
        ...
        if (c->sockaddr == 
# 302 "project/nginx/src/event/ngx_event_udp.c" 3 4
                          ((void *)0)
# 302 "project/nginx/src/event/ngx_event_udp.c"
                              ) {
            ngx_close_accepted_udp_connection(c);
            return;
        }
...
# 307 "project/nginx/src/event/ngx_event_udp.c" 3 4
       (void) __builtin___memcpy_chk (
# 307 "project/nginx/src/event/ngx_event_udp.c"
       c->sockaddr
# 307 "project/nginx/src/event/ngx_event_udp.c" 3 4
       , 
# 307 "project/nginx/src/event/ngx_event_udp.c"
...
# 307 "project/nginx/src/event/ngx_event_udp.c"
        ...
        if (log == 
# 310 "project/nginx/src/event/ngx_event_udp.c" 3 4
                  ((void *)0)
# 310 "project/nginx/src/event/ngx_event_udp.c"
                      ) {
            ngx_close_accepted_udp_connection(c);
            return;
        }
        ...
        *log = ls->log;
        ...
        c->send = 
# 318 "project/nginx/src/event/ngx_event_udp.c" 3 4
                 ngx_io.udp_send
# 318 "project/nginx/src/event/ngx_event_udp.c"
                             ;
        c->send_chain = 
# 319 "project/nginx/src/event/ngx_event_udp.c" 3 4
                       ngx_io.udp_send_chain
# 319 "project/nginx/src/event/ngx_event_udp.c"
                                         ;
        ...
        if (local_sockaddr == &lsa.sockaddr) {
            ...
            if (local_sockaddr == 
# 327 "project/nginx/src/event/ngx_event_udp.c" 3 4
                                 ((void *)0)
# 327 "project/nginx/src/event/ngx_event_udp.c"
                                     ) {
                ngx_close_accepted_udp_connection(c);
                return;
            }
...
# 332 "project/nginx/src/event/ngx_event_udp.c" 3 4
           (void) __builtin___memcpy_chk (
# 332 "project/nginx/src/event/ngx_event_udp.c"
           local_sockaddr
# 332 "project/nginx/src/event/ngx_event_udp.c" 3 4
           , 
# 332 "project/nginx/src/event/ngx_event_udp.c"
...
# 332 "project/nginx/src/event/ngx_event_udp.c"
        ...
        if (c->buffer == 
# 339 "project/nginx/src/event/ngx_event_udp.c" 3 4
                        ((void *)0)
# 339 "project/nginx/src/event/ngx_event_udp.c"
                            ) {
            ngx_close_accepted_udp_connection(c);
            return;
        }
        ...
        c->buffer->last = 
# 344 "project/nginx/src/event/ngx_event_udp.c" 3 4
                         (((u_char *) __builtin___memcpy_chk (
# 344 "project/nginx/src/event/ngx_event_udp.c"
                         c->buffer->last
# 344 "project/nginx/src/event/ngx_event_udp.c" 3 4
                         , 
# 344 "project/nginx/src/event/ngx_event_udp.c"
...
# 344 "project/nginx/src/event/ngx_event_udp.c"
        ...
        rev->log = log;
        wev->log = log;
# 364 "project/nginx/src/event/ngx_event_udp.c"
        c->number = 
# 364 "project/nginx/src/event/ngx_event_udp.c" 3 4
...
# 364 "project/nginx/src/event/ngx_event_udp.c"
        ...
        if (ls->addr_ntop) {
            ...
            if (c->addr_text.data == 
# 374 "project/nginx/src/event/ngx_event_udp.c" 3 4
                                    ((void *)0)
# 374 "project/nginx/src/event/ngx_event_udp.c"
                                        ) {
                ngx_close_accepted_udp_connection(c);
                return;
            }
...
# 408 "project/nginx/src/event/ngx_event_udp.c"
        if (ngx_insert_udp_connection(c) != 
# 408 "project/nginx/src/event/ngx_event_udp.c" 3 4
                                           0
# 408 "project/nginx/src/event/ngx_event_udp.c"
                                                 ) {
            ngx_close_accepted_udp_connection(c);
        ...
        log->data = 
# 413 "project/nginx/src/event/ngx_event_udp.c" 3 4
                   ((void *)0)
# 413 "project/nginx/src/event/ngx_event_udp.c"
                       ;
        log->handler = 
# 414 "project/nginx/src/event/ngx_event_udp.c" 3 4
                      ((void *)0)
# 414 "project/nginx/src/event/ngx_event_udp.c"
                          ;
    ...
    next:
        ...
        if (ngx_event_flags & 
# 420 "project/nginx/src/event/ngx_event_udp.c" 3 4
                             0x00000008
# 420 "project/nginx/src/event/ngx_event_udp.c"
                                                 ) {
            ev->available -= n;
        }
...
ngx_udp_shared_recv(ngx_connection_t *c, u_char *buf, size_t size)
{
    ...
    if (c->udp == 
# 451 "project/nginx/src/event/ngx_event_udp.c" 3 4
                 ((void *)0) 
# 451 "project/nginx/src/event/ngx_event_udp.c"
                      || c->udp->buffer == 
# 451 "project/nginx/src/event/ngx_event_udp.c" 3 4
                                           ((void *)0)
# 451 "project/nginx/src/event/ngx_event_udp.c"
        ...
        return 
# 452 "project/nginx/src/event/ngx_event_udp.c" 3 4
              -2
# 452 "project/nginx/src/event/ngx_event_udp.c"
                       ;
    }
    ...
    n = 
# 457 "project/nginx/src/event/ngx_event_udp.c" 3 4
       ((
# 457 "project/nginx/src/event/ngx_event_udp.c"
       b->last - b->pos 
# 457 "project/nginx/src/event/ngx_event_udp.c" 3 4
       > 
# 457 "project/nginx/src/event/ngx_event_udp.c"
...
# 459 "project/nginx/src/event/ngx_event_udp.c" 3 4
   (void) __builtin___memcpy_chk (
# 459 "project/nginx/src/event/ngx_event_udp.c"
   buf
# 459 "project/nginx/src/event/ngx_event_udp.c" 3 4
   , 
# 459 "project/nginx/src/event/ngx_event_udp.c"
...
# 459 "project/nginx/src/event/ngx_event_udp.c"
    ...
    c->udp->buffer = 
# 461 "project/nginx/src/event/ngx_event_udp.c" 3 4
                    ((void *)0)
# 461 "project/nginx/src/event/ngx_event_udp.c"
                        ;
...
# 519 "project/nginx/src/event/ngx_event_udp.c" 3 4
   ((
# 519 "project/nginx/src/event/ngx_event_udp.c"
   node
# 519 "project/nginx/src/event/ngx_event_udp.c" 3 4
   )->color = 1)
# 519 "project/nginx/src/event/ngx_event_udp.c"
...
ngx_insert_udp_connection(ngx_connection_t *c)
{
    ...
    if (c->udp) {
        return 
# 531 "project/nginx/src/event/ngx_event_udp.c" 3 4
              0
# 531 "project/nginx/src/event/ngx_event_udp.c"
                    ;
    }

    udp = ngx_pcalloc(c->pool, sizeof(ngx_udp_connection_t));
    if (udp == 
# 535 "project/nginx/src/event/ngx_event_udp.c" 3 4
              ((void *)0)
# 535 "project/nginx/src/event/ngx_event_udp.c"
                  ) {
        return 
# 536 "project/nginx/src/event/ngx_event_udp.c" 3 4
              -1
# 536 "project/nginx/src/event/ngx_event_udp.c"
                       ;
    }
    ...
    hash 
# 541 "project/nginx/src/event/ngx_event_udp.c" 3 4
   = 0xffffffff
# 541 "project/nginx/src/event/ngx_event_udp.c"
                       ;
    ...
    hash 
# 548 "project/nginx/src/event/ngx_event_udp.c" 3 4
   ^= 0xffffffff
# 548 "project/nginx/src/event/ngx_event_udp.c"
                        ;
    ...
    if (cln == 
# 553 "project/nginx/src/event/ngx_event_udp.c" 3 4
              ((void *)0)
# 553 "project/nginx/src/event/ngx_event_udp.c"
                  ) {
        return 
# 554 "project/nginx/src/event/ngx_event_udp.c" 3 4
              -1
# 554 "project/nginx/src/event/ngx_event_udp.c"
                       ;
    }
    ...
    return 
# 564 "project/nginx/src/event/ngx_event_udp.c" 3 4
          0
# 564 "project/nginx/src/event/ngx_event_udp.c"
                ;
}
...
ngx_delete_udp_connection(void *data)
{
    ...
    if (c->udp == 
# 573 "project/nginx/src/event/ngx_event_udp.c" 3 4
                 ((void *)0)
# 573 "project/nginx/src/event/ngx_event_udp.c"
                     ) {
        return;
    }
    ...
    c->udp = 
# 579 "project/nginx/src/event/ngx_event_udp.c" 3 4
            ((void *)0)
# 579 "project/nginx/src/event/ngx_event_udp.c"
                ;
}
    ...
    socklen_t socklen, struct sockaddr *local_sockaddr, socklen_t local_socklen)
{
    ...
    if (sockaddr->sa_family == 
# 595 "project/nginx/src/event/ngx_event_udp.c" 3 4
                              1
# 595 "project/nginx/src/event/ngx_event_udp.c"
                                     ) {
        struct sockaddr_un *saun = (struct sockaddr_un *) sockaddr;

        if (socklen <= (socklen_t) 
# 598 "project/nginx/src/event/ngx_event_udp.c" 3 4
                                  __builtin_offsetof (
# 598 "project/nginx/src/event/ngx_event_udp.c"
                                  struct sockaddr_un
# 598 "project/nginx/src/event/ngx_event_udp.c" 3 4
                                  , 
# 598 "project/nginx/src/event/ngx_event_udp.c"
...
# 599 "project/nginx/src/event/ngx_event_udp.c"
           || saun->sun_path[0] == '\0')
        {
           
                                                 ;
            return 
# 603 "project/nginx/src/event/ngx_event_udp.c" 3 4
                  ((void *)0)
# 603 "project/nginx/src/event/ngx_event_udp.c"
                      ;
        }
    }
    ...
    hash 
# 612 "project/nginx/src/event/ngx_event_udp.c" 3 4
   = 0xffffffff
# 612 "project/nginx/src/event/ngx_event_udp.c"
                       ;
    ...
    hash 
# 619 "project/nginx/src/event/ngx_event_udp.c" 3 4
   ^= 0xffffffff
# 619 "project/nginx/src/event/ngx_event_udp.c"
                        ;
    ...
    return 
# 654 "project/nginx/src/event/ngx_event_udp.c" 3 4
          ((void *)0)
# 654 "project/nginx/src/event/ngx_event_udp.c"
              ;
}
