# 0 "project/nginx/src/stream/ngx_stream_upstream_round_robin.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/stream/ngx_stream_upstream_round_robin.h"
# 12 "project/nginx/src/stream/ngx_stream_upstream_round_robin.h"
...
# 13 "project/nginx/src/stream/ngx_stream_upstream_round_robin.h" 2
...
# 14 "project/nginx/src/stream/ngx_stream_upstream_round_robin.h" 2
...
# 15 "project/nginx/src/stream/ngx_stream_upstream_round_robin.h" 2



# 17 "project/nginx/src/stream/ngx_stream_upstream_round_robin.h"
...
# 126 "project/nginx/src/stream/ngx_stream_upstream_round_robin.h"
typedef struct {
    ngx_uint_t config;
