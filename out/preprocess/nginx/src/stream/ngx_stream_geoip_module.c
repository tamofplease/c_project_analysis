# 0 "project/nginx/src/stream/ngx_stream_geoip_module.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 9 "project/nginx/src/stream/ngx_stream_geoip_module.c" 2
...
# 10 "project/nginx/src/stream/ngx_stream_geoip_module.c" 2
...
# 11 "project/nginx/src/stream/ngx_stream_geoip_module.c" 2

# 1 "/usr/local/include/GeoIP.h" 1 3 4
# 54 "/usr/local/include/GeoIP.h" 3 4
...
# 170 "/usr/local/include/GeoIP.h" 3 4
...
# 13 "project/nginx/src/stream/ngx_stream_geoip_module.c" 2
# 1 "/usr/local/include/GeoIPCity.h" 1 3 4
# 24 "/usr/local/include/GeoIPCity.h" 3 4
# 1 "/usr/local/include/GeoIP.h" 1 3 4
...
# 14 "project/nginx/src/stream/ngx_stream_geoip_module.c" 2
...
# 21 "project/nginx/src/stream/ngx_stream_geoip_module.c"
typedef struct {
    GeoIP *country;
    GeoIP *org;
    GeoIP *city;
...
# 67 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
static ngx_command_t ngx_stream_geoip_commands[] = {
    ...
    { 
# 94 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     { sizeof(
# 94 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     "geoip_country"
# 94 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 94 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 95 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     0x02000000
# 95 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                         |
# 95 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
...
# 97 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     __builtin_offsetof (ngx_stream_conf_ctx_t, main_conf)
# 97 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                                ,
      0,
      
# 99 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     ((void *)0) 
# 99 "project/nginx/src/stream/ngx_stream_geoip_module.c"
          },

    { 
# 101 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     { sizeof(
# 101 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     "geoip_org"
# 101 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 101 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 102 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     0x02000000
# 102 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                         |
# 102 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                          (0x00000002|0x00000004)
# 102 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 104 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     __builtin_offsetof (ngx_stream_conf_ctx_t, main_conf)
# 104 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                                ,
      0,
      
# 106 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     ((void *)0) 
# 106 "project/nginx/src/stream/ngx_stream_geoip_module.c"
          },

    { 
# 108 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     { sizeof(
# 108 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     "geoip_city"
# 108 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 108 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 109 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     0x02000000
# 109 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                         |
# 109 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                          (0x00000002|0x00000004)
# 109 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 111 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     __builtin_offsetof (ngx_stream_conf_ctx_t, main_conf)
# 111 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                                ,
      0,
      
# 113 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     ((void *)0) 
# 113 "project/nginx/src/stream/ngx_stream_geoip_module.c"
          },

      
# 115 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 116 "project/nginx/src/stream/ngx_stream_geoip_module.c"
};
...
# 121 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   ((void *)0)
# 121 "project/nginx/src/stream/ngx_stream_geoip_module.c"
       ,

    ngx_stream_geoip_create_conf,
    
# 124 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   ((void *)0)
# 124 "project/nginx/src/stream/ngx_stream_geoip_module.c"
       ,

    
# 126 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   ((void *)0)
# 126 "project/nginx/src/stream/ngx_stream_geoip_module.c"
       ,
    
# 127 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   ((void *)0)

# 128 "project/nginx/src/stream/ngx_stream_geoip_module.c"
};


ngx_module_t ngx_stream_geoip_module = {
    
# 132 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 132 "project/nginx/src/stream/ngx_stream_geoip_module.c"
   "8" 
# 132 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   "," 
# 132 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 132 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                ,
    &ngx_stream_geoip_module_ctx,
    ngx_stream_geoip_commands,
    
# 135 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   0x4d525453
# 135 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                    ,
    
# 136 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   ((void *)0)
# 136 "project/nginx/src/stream/ngx_stream_geoip_module.c"
       ,
    
# 137 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   ((void *)0)
# 137 "project/nginx/src/stream/ngx_stream_geoip_module.c"
       ,
    
# 138 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   ((void *)0)
# 138 "project/nginx/src/stream/ngx_stream_geoip_module.c"
       ,
    
# 139 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   ((void *)0)
# 139 "project/nginx/src/stream/ngx_stream_geoip_module.c"
       ,
    
# 140 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   ((void *)0)
# 140 "project/nginx/src/stream/ngx_stream_geoip_module.c"
       ,
    
# 141 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   ((void *)0)
# 141 "project/nginx/src/stream/ngx_stream_geoip_module.c"
       ,
    
# 142 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   ((void *)0)
# 142 "project/nginx/src/stream/ngx_stream_geoip_module.c"
       ,
    
# 143 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 144 "project/nginx/src/stream/ngx_stream_geoip_module.c"
};
...
static ngx_stream_variable_t ngx_stream_geoip_vars[] = {
    ...
    { 
# 149 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     { sizeof(
# 149 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     "geoip_country_code"
# 149 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 149 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 149 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    { 
# 153 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     { sizeof(
# 153 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     "geoip_country_code3"
# 153 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 153 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 153 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    { 
# 157 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     { sizeof(
# 157 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     "geoip_country_name"
# 157 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 157 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 157 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    { 
# 161 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     { sizeof(
# 161 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     "geoip_org"
# 161 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 161 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 161 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    { 
# 165 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     { sizeof(
# 165 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 167 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     __builtin_offsetof (
# 167 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     GeoIPRecord
# 167 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     , 
# 167 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 167 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    { 
# 169 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     { sizeof(
# 169 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 171 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     __builtin_offsetof (
# 171 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     GeoIPRecord
# 171 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     , 
# 171 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 171 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    { 
# 173 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     { sizeof(
# 173 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 175 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     __builtin_offsetof (
# 175 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     GeoIPRecord
# 175 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     , 
# 175 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 175 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    { 
# 177 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     { sizeof(
# 177 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 179 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     __builtin_offsetof (
# 179 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     GeoIPRecord
# 179 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     , 
# 179 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 179 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    { 
# 181 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     { sizeof(
# 181 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     "geoip_region"
# 181 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 181 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 183 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     __builtin_offsetof (
# 183 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     GeoIPRecord
# 183 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     , 
# 183 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 183 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    { 
# 185 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     { sizeof(
# 185 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     "geoip_region_name"
# 185 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 185 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 185 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    { 
# 189 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     { sizeof(
# 189 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     "geoip_city"
# 189 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 189 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 191 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     __builtin_offsetof (
# 191 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     GeoIPRecord
# 191 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     , 
# 191 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 191 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    { 
# 193 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     { sizeof(
# 193 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     "geoip_postal_code"
# 193 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 193 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 195 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     __builtin_offsetof (
# 195 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     GeoIPRecord
# 195 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     , 
# 195 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 195 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    { 
# 197 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     { sizeof(
# 197 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     "geoip_latitude"
# 197 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 197 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 199 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     __builtin_offsetof (
# 199 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     GeoIPRecord
# 199 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     , 
# 199 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 199 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    { 
# 201 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     { sizeof(
# 201 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     "geoip_longitude"
# 201 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 201 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 203 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     __builtin_offsetof (
# 203 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     GeoIPRecord
# 203 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     , 
# 203 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 203 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    { 
# 205 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     { sizeof(
# 205 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     "geoip_dma_code"
# 205 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 205 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 207 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     __builtin_offsetof (
# 207 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     GeoIPRecord
# 207 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     , 
# 207 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 207 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    { 
# 209 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     { sizeof(
# 209 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     "geoip_area_code"
# 209 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     ) - 1, (u_char *) 
# 209 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 211 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     __builtin_offsetof (
# 211 "project/nginx/src/stream/ngx_stream_geoip_module.c"
     GeoIPRecord
# 211 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     , 
# 211 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 213 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
     { { 0, ((void *)0) }, ((void *)0), ((void *)0), 0, 0, 0 }

# 214 "project/nginx/src/stream/ngx_stream_geoip_module.c"
};
...
# 229 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                                   30
# 229 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                                           ) {
        u_char *p;
        in_addr_t inaddr;
        ...
        if (
# 236 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
           ((*(const __uint32_t *)(const void *)(&(
# 236 "project/nginx/src/stream/ngx_stream_geoip_module.c"
           inaddr6
# 236 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
...
# 236 "project/nginx/src/stream/ngx_stream_geoip_module.c"
            ...
            p = inaddr6->
# 237 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                        __u6_addr.__u6_addr8
# 237 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                               ;
    ...
    if (addr.sockaddr->sa_family != 
# 250 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                                   2
# 250 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                                          ) {
        return 
# 251 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              0xffffffff
# 251 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                         ;
    }

    sin = (struct sockaddr_in *) addr.sockaddr;
    return 
# 255 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
          (__builtin_constant_p(
# 255 "project/nginx/src/stream/ngx_stream_geoip_module.c"
          sin->sin_addr.s_addr
# 255 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
...
# 302 "project/nginx/src/stream/ngx_stream_geoip_module.c"
static ngx_int_t
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    gcf = 
# 316 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
         (
# 316 "project/nginx/src/stream/ngx_stream_geoip_module.c"
         s
# 316 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
         )->main_conf[
# 316 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 316 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    if (gcf->country == 
# 318 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                       ((void *)0)
# 318 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                           ) {
        goto not_found;
    }
    ...
    if (val == 
# 330 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              ((void *)0)
# 330 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                  ) {
        goto not_found;
    }

    v->len = 
# 334 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
            strlen((const char *) 
# 334 "project/nginx/src/stream/ngx_stream_geoip_module.c"
            val
# 334 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
            )
# 334 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    return 
# 340 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
          0
# 340 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                ;
...
not_found:
    ...
    return 
# 346 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
          0
# 346 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    gcf = 
# 358 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
         (
# 358 "project/nginx/src/stream/ngx_stream_geoip_module.c"
         s
# 358 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
         )->main_conf[
# 358 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 358 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    if (gcf->org == 
# 360 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                   ((void *)0)
# 360 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                       ) {
        goto not_found;
    }
# 371 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    val = GeoIP_name_by_ipnum(gcf->org, ngx_stream_geoip_addr(s, gcf));


    if (val == 
# 374 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              ((void *)0)
# 374 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                  ) {
        goto not_found;
    }

    len = 
# 378 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
         strlen((const char *) 
# 378 "project/nginx/src/stream/ngx_stream_geoip_module.c"
         val
# 378 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
         )
# 378 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    if (v->data == 
# 380 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                  ((void *)0)
# 380 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                      ) {
        
# 381 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
       free
# 381 "project/nginx/src/stream/ngx_stream_geoip_module.c"
               (val);
        return 
# 382 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              -1
# 382 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                       ;
    }

    
# 385 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   (void) __builtin___memcpy_chk (
# 385 "project/nginx/src/stream/ngx_stream_geoip_module.c"
   v->data
# 385 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   , 
# 385 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 392 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   free
# 392 "project/nginx/src/stream/ngx_stream_geoip_module.c"
           (val);

    return 
# 394 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
          0
# 394 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                ;
...
not_found:
    ...
    return 
# 400 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
          0
# 400 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    if (gr == 
# 413 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
             ((void *)0)
# 413 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                 ) {
        goto not_found;
    }
    ...
    if (val == 
# 418 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              ((void *)0)
# 418 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                  ) {
        goto no_value;
    }

    len = 
# 422 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
         strlen((const char *) 
# 422 "project/nginx/src/stream/ngx_stream_geoip_module.c"
         val
# 422 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
         )
# 422 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    v->data = ngx_pnalloc(s->connection->pool, len);
    if (v->data == 
# 424 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                  ((void *)0)
# 424 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                      ) {
        GeoIPRecord_delete(gr);
        return 
# 426 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              -1
# 426 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                       ;
    }

    
# 429 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   (void) __builtin___memcpy_chk (
# 429 "project/nginx/src/stream/ngx_stream_geoip_module.c"
   v->data
# 429 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   , 
# 429 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 429 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    return 
# 438 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
          0
# 438 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                ;
...
not_found:
    ...
    return 
# 448 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
          0
# 448 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    gr = ngx_stream_geoip_get_city_record(s);
    if (gr == 
# 461 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
             ((void *)0)
# 461 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                 ) {
        goto not_found;
    }
    ...
    if (val == 
# 469 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              ((void *)0)
# 469 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                  ) {
        goto not_found;
    }

    len = 
# 473 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
         strlen((const char *) 
# 473 "project/nginx/src/stream/ngx_stream_geoip_module.c"
         val
# 473 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
         )
# 473 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    v->data = ngx_pnalloc(s->connection->pool, len);
    if (v->data == 
# 475 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                  ((void *)0)
# 475 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                      ) {
        return 
# 476 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              -1
# 476 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                       ;
    }

    
# 479 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   (void) __builtin___memcpy_chk (
# 479 "project/nginx/src/stream/ngx_stream_geoip_module.c"
   v->data
# 479 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
   , 
# 479 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 479 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    return 
# 486 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
          0
# 486 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                ;
...
not_found:
    ...
    return 
# 492 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
          0
# 492 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    gr = ngx_stream_geoip_get_city_record(s);
    if (gr == 
# 504 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
             ((void *)0)
# 504 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                 ) {
        v->not_found = 1;
        return 
# 506 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              0
# 506 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                    ;
    }

    v->data = ngx_pnalloc(s->connection->pool, 
# 509 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                                              (sizeof("-9223372036854775808") - 1) 
# 509 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                                                            + 5);
    if (v->data == 
# 510 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                  ((void *)0)
# 510 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                      ) {
        GeoIPRecord_delete(gr);
        return 
# 512 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              -1
# 512 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                       ;
    }
    ...
    return 
# 524 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
          0
# 524 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                ;
}
    ...
    ngx_stream_variable_value_t *v, uintptr_t data)
{
    ...
    gr = ngx_stream_geoip_get_city_record(s);
    if (gr == 
# 536 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
             ((void *)0)
# 536 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                 ) {
        v->not_found = 1;
        return 
# 538 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              0
# 538 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                    ;
    }

    v->data = ngx_pnalloc(s->connection->pool, 
# 541 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                                              (sizeof("-9223372036854775808") - 1)
# 541 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                                                           );
    if (v->data == 
# 542 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                  ((void *)0)
# 542 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                      ) {
        GeoIPRecord_delete(gr);
        return 
# 544 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              -1
# 544 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                       ;
    }
    ...
    return 
# 556 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
          0
# 556 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                ;
}
...
ngx_stream_geoip_get_city_record(ngx_stream_session_t *s)
{
    ...
    gcf = 
# 565 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
         (
# 565 "project/nginx/src/stream/ngx_stream_geoip_module.c"
         s
# 565 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
         )->main_conf[
# 565 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 565 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    ...
    return 
# 579 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
          ((void *)0)
# 579 "project/nginx/src/stream/ngx_stream_geoip_module.c"
              ;
}
...
ngx_stream_geoip_add_variables(ngx_conf_t *cf)
{
    ...
    for (v = ngx_stream_geoip_vars; v->name.len; v++) {
        ...
        if (var == 
# 590 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                  ((void *)0)
# 590 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                      ) {
            return 
# 591 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                  -1
# 591 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                           ;
        }
    ...
    return 
# 598 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
          0
# 598 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                ;
}
...
ngx_stream_geoip_create_conf(ngx_conf_t *cf)
{
    ...
    if (conf == 
# 609 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
               ((void *)0)
# 609 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                   ) {
        return 
# 610 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              ((void *)0)
# 610 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                  ;
    }

    cln = ngx_pool_cleanup_add(cf->pool, 0);
    if (cln == 
# 614 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              ((void *)0)
# 614 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                  ) {
        return 
# 615 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              ((void *)0)
# 615 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                  ;
    }
...
ngx_stream_geoip_country(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (gcf->country == 
# 640 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                       ((void *)0)
# 640 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                           ) {
        ngx_conf_log_error(
# 641 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                          1
# 641 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                                       , cf, 0,
                           "GeoIP_open(\"%V\") failed", &value[1]);

        return 
# 644 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              (void *) -1
# 644 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                            ;
    }

    if (cf->args->nelts == 3) {
        if (
# 648 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
           strcmp((const char *) 
# 648 "project/nginx/src/stream/ngx_stream_geoip_module.c"
           value[2].data
# 648 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
           , (const char *) 
# 648 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 648 "project/nginx/src/stream/ngx_stream_geoip_module.c"
            ...
            ngx_conf_log_error(
# 652 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                              1
# 652 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                                           , cf, 0,
                               "invalid parameter \"%V\"", &value[2]);
            return 
# 654 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                  (void *) -1
# 654 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                                ;
        }
    }
    ...
    case GEOIP_COUNTRY_EDITION:
        ...
        return 
# 662 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              ((void *)0)
# 662 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                         ;
# 671 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    default:
        ngx_conf_log_error(
# 672 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                          1
# 672 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                                       , cf, 0,
                           "invalid GeoIP database \"%V\" type:%d",
                           &value[1], gcf->country->databaseType);
        return 
# 675 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              (void *) -1
# 675 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                            ;
    }
}
...
ngx_stream_geoip_org(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (gcf->org == 
# 695 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                   ((void *)0)
# 695 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                       ) {
        ngx_conf_log_error(
# 696 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                          1
# 696 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                                       , cf, 0,
                           "GeoIP_open(\"%V\") failed", &value[1]);

        return 
# 699 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              (void *) -1
# 699 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                            ;
    }

    if (cf->args->nelts == 3) {
        if (
# 703 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
           strcmp((const char *) 
# 703 "project/nginx/src/stream/ngx_stream_geoip_module.c"
           value[2].data
# 703 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
           , (const char *) 
# 703 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 703 "project/nginx/src/stream/ngx_stream_geoip_module.c"
            ...
            ngx_conf_log_error(
# 707 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                              1
# 707 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                                           , cf, 0,
                               "invalid parameter \"%V\"", &value[2]);
            return 
# 709 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                  (void *) -1
# 709 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                                ;
        }
    }
    ...
    case GEOIP_ASNUM_EDITION:
        ...
        return 
# 720 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              ((void *)0)
# 720 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                         ;
# 732 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    default:
        ngx_conf_log_error(
# 733 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                          1
# 733 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                                       , cf, 0,
                           "invalid GeoIP database \"%V\" type:%d",
                           &value[1], gcf->org->databaseType);
        return 
# 736 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              (void *) -1
# 736 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                            ;
    }
}
...
ngx_stream_geoip_city(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (gcf->city == 
# 756 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                    ((void *)0)
# 756 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                        ) {
        ngx_conf_log_error(
# 757 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                          1
# 757 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                                       , cf, 0,
                           "GeoIP_open(\"%V\") failed", &value[1]);

        return 
# 760 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              (void *) -1
# 760 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                            ;
    }

    if (cf->args->nelts == 3) {
        if (
# 764 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
           strcmp((const char *) 
# 764 "project/nginx/src/stream/ngx_stream_geoip_module.c"
           value[2].data
# 764 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
           , (const char *) 
# 764 "project/nginx/src/stream/ngx_stream_geoip_module.c"
...
# 764 "project/nginx/src/stream/ngx_stream_geoip_module.c"
            ...
            ngx_conf_log_error(
# 768 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                              1
# 768 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                                           , cf, 0,
                               "invalid parameter \"%V\"", &value[2]);
            return 
# 770 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                  (void *) -1
# 770 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                                ;
        }
    }
    ...
    case GEOIP_CITY_EDITION_REV1:
        ...
        return 
# 779 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              ((void *)0)
# 779 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                         ;
# 789 "project/nginx/src/stream/ngx_stream_geoip_module.c"
    default:
        ngx_conf_log_error(
# 790 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
                          1
# 790 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                                       , cf, 0,
                           "invalid GeoIP City database \"%V\" type:%d",
                           &value[1], gcf->city->databaseType);
        return 
# 793 "project/nginx/src/stream/ngx_stream_geoip_module.c" 3 4
              (void *) -1
# 793 "project/nginx/src/stream/ngx_stream_geoip_module.c"
                            ;
    }
}
