# 0 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
...
# 9 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 2
...
# 10 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 2
...
# 11 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 2
...
# 17 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
...
# 36 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
ngx_int_t
...
# 69 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
           if ((
# 69 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
           cf->log
# 69 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
...
# 69 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
           , 
# 69 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
           0, "no servers in upstream \"%V\" in %s:%ui", &us->host, us->file_name, us->line
# 69 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
           )

                                                             
# 71 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                                                            ;
            return 
# 72 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                  -1
# 72 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                           ;
        }

        peers = ngx_pcalloc(cf->pool, sizeof(ngx_stream_upstream_rr_peers_t));
        if (peers == 
# 76 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                    ((void *)0)
# 76 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                        ) {
            return 
# 77 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                  -1
# 77 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                           ;
        }

        peer = ngx_pcalloc(cf->pool, sizeof(ngx_stream_upstream_rr_peer_t) * n);
        if (peer == 
# 81 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                   ((void *)0)
# 81 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                       ) {
            return 
# 82 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                  -1
# 82 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                           ;
        }
        ...
        if (n == 0) {
            return 
# 141 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                  0
# 141 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                        ;
        }

        backup = ngx_pcalloc(cf->pool, sizeof(ngx_stream_upstream_rr_peers_t));
        if (backup == 
# 145 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                     ((void *)0)
# 145 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                         ) {
            return 
# 146 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                  -1
# 146 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                           ;
        }

        peer = ngx_pcalloc(cf->pool, sizeof(ngx_stream_upstream_rr_peer_t) * n);
        if (peer == 
# 150 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                   ((void *)0)
# 150 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                       ) {
            return 
# 151 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                  -1
# 151 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                           ;
        }
        ...
        return 
# 191 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
              0
# 191 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                    ;
    }
...
# 198 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
       if ((
# 198 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
       cf->log
# 198 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
       )->log_level >= 1) ngx_log_error_core(1, 
# 198 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
...
# 198 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
       , 
# 198 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
       0, "no port in upstream \"%V\" in %s:%ui", &us->host, us->file_name, us->line
# 198 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
       )

                                                         
# 200 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                                                        ;
        return 
# 201 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
              -1
# 201 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                       ;
    }

    
# 204 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
   (void) __builtin___memset_chk (
# 204 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
   &u
# 204 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
   , 0, 
# 204 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
...
# 209 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                                              0
# 209 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                                                    ) {
        if (u.err) {
            
# 211 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
           if ((
# 211 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
           cf->log
# 211 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 211 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
...
# 211 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
           , 
# 211 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
           0, "%s in upstream \"%V\" in %s:%ui", u.err, &us->host, us->file_name, us->line
# 211 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
           )

                                                                    
# 213 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                                                                   ;
        }

        return 
# 216 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
              -1
# 216 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                       ;
    }
    ...
    peers = ngx_pcalloc(cf->pool, sizeof(ngx_stream_upstream_rr_peers_t));
    if (peers == 
# 222 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                ((void *)0)
# 222 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                    ) {
        return 
# 223 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
              -1
# 223 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                       ;
    }

    peer = ngx_pcalloc(cf->pool, sizeof(ngx_stream_upstream_rr_peer_t) * n);
    if (peer == 
# 227 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
               ((void *)0)
# 227 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                   ) {
        return 
# 228 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
              -1
# 228 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                       ;
    }
    ...
    return 
# 258 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
          0
# 258 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                ;
}
    ...
    ngx_stream_upstream_srv_conf_t *us)
{
    ...
    if (rrp == 
# 271 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
              ((void *)0)
# 271 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                  ) {
        rrp = ngx_palloc(s->connection->pool,
                         sizeof(ngx_stream_upstream_rr_peer_data_t));
        if (rrp == 
# 274 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                  ((void *)0)
# 274 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                      ) {
            return 
# 275 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                  -1
# 275 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                           ;
        }
    ...
    rrp->current = 
# 282 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                  ((void *)0)
# 282 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                      ;
    rrp->config = 0;
    ...
    if (n <= 8 * sizeof(uintptr_t)) {
        ...
        if (rrp->tried == 
# 299 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                         ((void *)0)
# 299 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                             ) {
            return 
# 300 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                  -1
# 300 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                           ;
        }
    }
    ...
    s->upstream->peer.tries = ((rrp->peers)->tries + ((rrp->peers)->next ? (rrp->peers)->next->tries : 0));
    ...
    return 
# 315 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
          0
# 315 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                ;
}
    ...
    ngx_stream_upstream_resolved_t *ur)
{
    ...
    if (rrp == 
# 334 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
              ((void *)0)
# 334 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                  ) {
        rrp = ngx_palloc(s->connection->pool,
                         sizeof(ngx_stream_upstream_rr_peer_data_t));
        if (rrp == 
# 337 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                  ((void *)0)
# 337 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                      ) {
            return 
# 338 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                  -1
# 338 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                           ;
        }
    ...
    if (peers == 
# 346 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                ((void *)0)
# 346 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                    ) {
        return 
# 347 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
              -1
# 347 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                       ;
    }
    ...
    if (peer == 
# 352 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
               ((void *)0)
# 352 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                   ) {
        return 
# 353 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
              -1
# 353 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                       ;
    }
    ...
    if (ur->sockaddr) {
        ...
        for (i = 0; i < ur->naddrs; i++) {
            ...
            if (sockaddr == 
# 381 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                           ((void *)0)
# 381 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                               ) {
                return 
# 382 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                      -1
# 382 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                               ;
            }

            
# 385 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
           (void) __builtin___memcpy_chk (
# 385 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
           sockaddr
# 385 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
           , 
# 385 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
...
# 388 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                                                (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 388 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                                                                   );
            if (p == 
# 389 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                    ((void *)0)
# 389 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                        ) {
                return 
# 390 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                      -1
# 390 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                               ;
            }

            len = ngx_sock_ntop(sockaddr, socklen, p, 
# 393 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                                                     (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 393 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                                                                        , 1);
    ...
    rrp->peers = peers;
    rrp->current = 
# 411 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                  ((void *)0)
# 411 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                      ;
    rrp->config = 0;
    ...
    if (rrp->peers->number <= 8 * sizeof(uintptr_t)) {
        ...
        rrp->tried = ngx_pcalloc(s->connection->pool, n * sizeof(uintptr_t));
        if (rrp->tried == 
# 423 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                         ((void *)0)
# 423 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                             ) {
            return 
# 424 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                  -1
# 424 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                           ;
        }
    }
    ...
    return 
# 436 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
          0
# 436 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                ;
}
...
ngx_stream_upstream_get_round_robin_peer(ngx_peer_connection_t *pc, void *data)
{
    ...
    pc->connection = 
# 453 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                    ((void *)0)
# 453 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                        ;
    ...
    if (peers->single) {
        ...
        if (peer == 
# 477 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                   ((void *)0)
# 477 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                       ) {
            goto failed;
        }
    ...
    return 
# 494 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
          0
# 494 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                ;
...
failed:
    ...
    if (peers->next) {
        ...
        if (rc != 
# 515 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                 -3
# 515 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                         ) {
            return rc;
        }
    ...
    return 
# 526 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
          -3
# 526 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                  ;
}
...
ngx_stream_upstream_get_peer(ngx_stream_upstream_rr_peer_data_t *rrp)
{
    ...
    now = 
# 539 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
         ngx_cached_time->sec
# 539 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                   ;

    best = 
# 541 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
          ((void *)0)
# 541 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
              ;
    total = 0;
         ...
         peer = peer->next, i++)
    {
        ...
        if (best == 
# 581 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                   ((void *)0) 
# 581 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
    ...
    if (best == 
# 587 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
               ((void *)0)
# 587 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                   ) {
        return 
# 588 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
              ((void *)0)
# 588 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                  ;
    }
    ...
    ngx_uint_t state)
{
    ...
    if (state & 
# 635 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
               4
# 635 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                              ) {
        now = 
# 636 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
             ngx_cached_time->sec
# 636 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                       ;
...
# 646 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
               if ((
# 646 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
               pc->log
# 646 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
...
# 646 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
               , 
# 646 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
               0, "upstream server temporarily disabled"
# 646 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
               )
                                                                     
# 647 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                                                                    ;
            }
        }
    ...
    void *data, ngx_uint_t type)
{
    ...
    if (type == 
# 689 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
               0x1
        
# 690 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
       && pc->connection->type == 
# 690 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c" 3 4
                                  1
# 690 "project/nginx/src/stream/ngx_stream_upstream_round_robin.c"
                                             )
    {
