# 0 "project/nginx/src/stream/ngx_stream_script.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/stream/ngx_stream_script.c"
...
# 9 "project/nginx/src/stream/ngx_stream_script.c" 2
...
# 10 "project/nginx/src/stream/ngx_stream_script.c" 2
...
# 11 "project/nginx/src/stream/ngx_stream_script.c" 2



# 13 "project/nginx/src/stream/ngx_stream_script.c"
...
static uintptr_t ngx_stream_script_exit_code = (uintptr_t) 
# 33 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                                          ((void *)0)
# 33 "project/nginx/src/stream/ngx_stream_script.c"
                                                              ;
    ...
    ngx_stream_complex_value_t *val, ngx_str_t *value)
{
    ...
    if (val->lengths == 
# 67 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                       ((void *)0)
# 67 "project/nginx/src/stream/ngx_stream_script.c"
                           ) {
        *value = val->value;
        return 
# 69 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              0
# 69 "project/nginx/src/stream/ngx_stream_script.c"
                    ;
    }
...
# 74 "project/nginx/src/stream/ngx_stream_script.c" 3 4
   (void) __builtin___memset_chk (
# 74 "project/nginx/src/stream/ngx_stream_script.c"
   &e
# 74 "project/nginx/src/stream/ngx_stream_script.c" 3 4
   , 0, 
# 74 "project/nginx/src/stream/ngx_stream_script.c"
   sizeof(ngx_stream_script_engine_t)
# 74 "project/nginx/src/stream/ngx_stream_script.c" 3 4
...
# 74 "project/nginx/src/stream/ngx_stream_script.c"
    ...
    if (value->data == 
# 89 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                      ((void *)0)
# 89 "project/nginx/src/stream/ngx_stream_script.c"
                          ) {
        return 
# 90 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              -1
# 90 "project/nginx/src/stream/ngx_stream_script.c"
                       ;
    }
    ...
    *value = e.buf;
    ...
    return 
# 104 "project/nginx/src/stream/ngx_stream_script.c" 3 4
          0
# 104 "project/nginx/src/stream/ngx_stream_script.c"
                ;
}
    ...
    ngx_stream_complex_value_t *val, size_t default_value)
{
    ...
    if (val == 
# 115 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              ((void *)0)
# 115 "project/nginx/src/stream/ngx_stream_script.c"
                  ) {
        return default_value;
    }

    if (val->lengths == 
# 119 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                       ((void *)0)
# 119 "project/nginx/src/stream/ngx_stream_script.c"
                           ) {
        return val->u.size;
    }

    if (ngx_stream_complex_value(s, val, &value) != 
# 123 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                                   0
# 123 "project/nginx/src/stream/ngx_stream_script.c"
                                                         ) {
        return default_value;
    }
    ...
    if (size == (size_t) 
# 129 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                        -1
# 129 "project/nginx/src/stream/ngx_stream_script.c"
                                 ) {
        
# 130 "project/nginx/src/stream/ngx_stream_script.c" 3 4
       if ((
# 130 "project/nginx/src/stream/ngx_stream_script.c"
       s->connection->log
# 130 "project/nginx/src/stream/ngx_stream_script.c" 3 4
...
# 131 "project/nginx/src/stream/ngx_stream_script.c"
                                                   ;
        return default_value;
    }
...
# 166 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                                                      0
# 166 "project/nginx/src/stream/ngx_stream_script.c"
                                                                            ) {
            return 
# 167 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                  -1
# 167 "project/nginx/src/stream/ngx_stream_script.c"
                           ;
        }
...
# 175 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                 ((void *)0)
# 175 "project/nginx/src/stream/ngx_stream_script.c"
                                     ;
    ccv->complex_value->lengths = 
# 176 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                 ((void *)0)
# 176 "project/nginx/src/stream/ngx_stream_script.c"
                                     ;
    ccv->complex_value->values = 
# 177 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                ((void *)0)
# 177 "project/nginx/src/stream/ngx_stream_script.c"
                                    ;

    if (nv == 0 && nc == 0) {
        return 
# 180 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              0
# 180 "project/nginx/src/stream/ngx_stream_script.c"
                    ;
    }
    ...
    if (ngx_array_init(&flushes, ccv->cf->pool, n, sizeof(ngx_uint_t))
        != 
# 186 "project/nginx/src/stream/ngx_stream_script.c" 3 4
          0
# 186 "project/nginx/src/stream/ngx_stream_script.c"
                )
    {
        return 
# 188 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              -1
# 188 "project/nginx/src/stream/ngx_stream_script.c"
                       ;
    }
...
# 195 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                                        0
# 195 "project/nginx/src/stream/ngx_stream_script.c"
                                                              ) {
        return 
# 196 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              -1
# 196 "project/nginx/src/stream/ngx_stream_script.c"
                       ;
    }
...
# 206 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                                       0
# 206 "project/nginx/src/stream/ngx_stream_script.c"
                                                             ) {
        return 
# 207 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              -1
# 207 "project/nginx/src/stream/ngx_stream_script.c"
                       ;
    }
...
# 214 "project/nginx/src/stream/ngx_stream_script.c" 3 4
   (void) __builtin___memset_chk (
# 214 "project/nginx/src/stream/ngx_stream_script.c"
   &sc
# 214 "project/nginx/src/stream/ngx_stream_script.c" 3 4
   , 0, 
# 214 "project/nginx/src/stream/ngx_stream_script.c"
...
# 227 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                         0
# 227 "project/nginx/src/stream/ngx_stream_script.c"
                                               ) {
        return 
# 228 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              -1
# 228 "project/nginx/src/stream/ngx_stream_script.c"
                       ;
    }
    ...
    return 
# 239 "project/nginx/src/stream/ngx_stream_script.c" 3 4
          0
# 239 "project/nginx/src/stream/ngx_stream_script.c"
                ;
}
    ...
    void *conf)
{
    ...
    if (*cv != 
# 255 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              (void *) -1 
# 255 "project/nginx/src/stream/ngx_stream_script.c"
                                 && *cv != 
# 255 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                           ((void *)0)
# 255 "project/nginx/src/stream/ngx_stream_script.c"
    ...
    *cv = ngx_palloc(cf->pool, sizeof(ngx_stream_complex_value_t));
    if (*cv == 
# 260 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              ((void *)0)
# 260 "project/nginx/src/stream/ngx_stream_script.c"
                  ) {
        return 
# 261 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              (void *) -1
# 261 "project/nginx/src/stream/ngx_stream_script.c"
                            ;
    }
...
# 266 "project/nginx/src/stream/ngx_stream_script.c" 3 4
   (void) __builtin___memset_chk (
# 266 "project/nginx/src/stream/ngx_stream_script.c"
   &ccv
# 266 "project/nginx/src/stream/ngx_stream_script.c" 3 4
   , 0, 
# 266 "project/nginx/src/stream/ngx_stream_script.c"
...
# 272 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                                 0
# 272 "project/nginx/src/stream/ngx_stream_script.c"
                                                       ) {
        return 
# 273 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              (void *) -1
# 273 "project/nginx/src/stream/ngx_stream_script.c"
                            ;
    }

    return 
# 276 "project/nginx/src/stream/ngx_stream_script.c" 3 4
          ((void *)0)
# 276 "project/nginx/src/stream/ngx_stream_script.c"
                     ;
}
    ...
    void *conf)
{
    ...
    if (*cv != 
# 292 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              (void *) -1
# 292 "project/nginx/src/stream/ngx_stream_script.c"
                                ) {
        return "is duplicate";
    }
    ...
    *cv = ngx_palloc(cf->pool, sizeof(ngx_stream_complex_value_t));
    if (*cv == 
# 297 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              ((void *)0)
# 297 "project/nginx/src/stream/ngx_stream_script.c"
                  ) {
        return 
# 298 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              (void *) -1
# 298 "project/nginx/src/stream/ngx_stream_script.c"
                            ;
    }
...
# 303 "project/nginx/src/stream/ngx_stream_script.c" 3 4
   (void) __builtin___memset_chk (
# 303 "project/nginx/src/stream/ngx_stream_script.c"
   &ccv
# 303 "project/nginx/src/stream/ngx_stream_script.c" 3 4
   , 0, 
# 303 "project/nginx/src/stream/ngx_stream_script.c"
...
# 303 "project/nginx/src/stream/ngx_stream_script.c"
    ...
    if (ngx_stream_compile_complex_value(&ccv) != 
# 310 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                                 0
# 310 "project/nginx/src/stream/ngx_stream_script.c"
                                                       ) {
        return 
# 311 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              (void *) -1
# 311 "project/nginx/src/stream/ngx_stream_script.c"
                            ;
    }

    return 
# 314 "project/nginx/src/stream/ngx_stream_script.c" 3 4
          ((void *)0)
# 314 "project/nginx/src/stream/ngx_stream_script.c"
                     ;
}
    ...
    void *conf)
{
    ...
    if (rv != 
# 329 "project/nginx/src/stream/ngx_stream_script.c" 3 4
             ((void *)0)
# 329 "project/nginx/src/stream/ngx_stream_script.c"
                        ) {
        return rv;
    }
    ...
    if (cv->lengths) {
        return 
# 336 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              ((void *)0)
# 336 "project/nginx/src/stream/ngx_stream_script.c"
                         ;
    }

    cv->u.size = ngx_parse_size(&cv->value);
    if (cv->u.size == (size_t) 
# 340 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                              -1
# 340 "project/nginx/src/stream/ngx_stream_script.c"
                                       ) {
        return "invalid value";
    }

    return 
# 344 "project/nginx/src/stream/ngx_stream_script.c" 3 4
          ((void *)0)
# 344 "project/nginx/src/stream/ngx_stream_script.c"
                     ;
}
...
ngx_stream_script_compile(ngx_stream_script_compile_t *sc)
{
    ...
    if (ngx_stream_script_init_arrays(sc) != 
# 370 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                            0
# 370 "project/nginx/src/stream/ngx_stream_script.c"
                                                  ) {
        return 
# 371 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              -1
# 371 "project/nginx/src/stream/ngx_stream_script.c"
                       ;
    }
    ...
    for (i = 0; i < sc->source->len; ) {
        ...
        if (sc->source->data[i] == '$') {
            ...
            if (sc->source->data[i] >= '1' && sc->source->data[i] <= '9') {
                ...
                if (ngx_stream_script_add_capture_code(sc, n) != 
# 390 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                                                0
# 390 "project/nginx/src/stream/ngx_stream_script.c"
                                                                      ) {
                    return 
# 391 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                          -1
# 391 "project/nginx/src/stream/ngx_stream_script.c"
                                   ;
                }
            ...
            if (bracket) {
                ngx_conf_log_error(
# 440 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                  1
# 440 "project/nginx/src/stream/ngx_stream_script.c"
                                               , sc->cf, 0,
                                   "the closing bracket in \"%V\" "
                                   "variable is missing", &name);
                return 
# 443 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                      -1
# 443 "project/nginx/src/stream/ngx_stream_script.c"
                               ;
            }
            ...
            if (ngx_stream_script_add_var_code(sc, &name) != 
# 452 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                                            0
# 452 "project/nginx/src/stream/ngx_stream_script.c"
                                                                  ) {
                return 
# 453 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                      -1
# 453 "project/nginx/src/stream/ngx_stream_script.c"
                               ;
            }
        ...
        if (ngx_stream_script_add_copy_code(sc, &name, (i == sc->source->len))
            != 
# 474 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              0
# 474 "project/nginx/src/stream/ngx_stream_script.c"
                    )
        {
            return 
# 476 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                  -1
# 476 "project/nginx/src/stream/ngx_stream_script.c"
                           ;
        }
    }
...
invalid_variable:
    ...
    ngx_conf_log_error(
# 484 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                      1
# 484 "project/nginx/src/stream/ngx_stream_script.c"
                                   , sc->cf, 0, "invalid variable name");

    return 
# 486 "project/nginx/src/stream/ngx_stream_script.c" 3 4
          -1
# 486 "project/nginx/src/stream/ngx_stream_script.c"
                   ;
}
    ...
    void *code_lengths, size_t len, void *code_values)
{
    ...
    cmcf = 
# 500 "project/nginx/src/stream/ngx_stream_script.c" 3 4
          (
# 500 "project/nginx/src/stream/ngx_stream_script.c"
          s
# 500 "project/nginx/src/stream/ngx_stream_script.c" 3 4
          )->main_conf[
# 500 "project/nginx/src/stream/ngx_stream_script.c"
...
# 509 "project/nginx/src/stream/ngx_stream_script.c" 3 4
   (void) __builtin___memset_chk (
# 509 "project/nginx/src/stream/ngx_stream_script.c"
   &e
# 509 "project/nginx/src/stream/ngx_stream_script.c" 3 4
   , 0, 
# 509 "project/nginx/src/stream/ngx_stream_script.c"
...
# 509 "project/nginx/src/stream/ngx_stream_script.c"
    ...
    value->data = ngx_pnalloc(s->connection->pool, len);
    if (value->data == 
# 523 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                      ((void *)0)
# 523 "project/nginx/src/stream/ngx_stream_script.c"
                          ) {
        return 
# 524 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              ((void *)0)
# 524 "project/nginx/src/stream/ngx_stream_script.c"
                  ;
    }
...
# 562 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                      ((void *)0)
# 562 "project/nginx/src/stream/ngx_stream_script.c"
                                          ) {
        n = sc->variables ? sc->variables : 1;
        *sc->flushes = ngx_array_create(sc->cf->pool, n, sizeof(ngx_uint_t));
        if (*sc->flushes == 
# 565 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                           ((void *)0)
# 565 "project/nginx/src/stream/ngx_stream_script.c"
                               ) {
            return 
# 566 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                  -1
# 566 "project/nginx/src/stream/ngx_stream_script.c"
                           ;
        }
    }

    if (*sc->lengths == 
# 570 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                       ((void *)0)
# 570 "project/nginx/src/stream/ngx_stream_script.c"
                           ) {
        ...
        *sc->lengths = ngx_array_create(sc->cf->pool, n, 1);
        if (*sc->lengths == 
# 576 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                           ((void *)0)
# 576 "project/nginx/src/stream/ngx_stream_script.c"
                               ) {
            return 
# 577 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                  -1
# 577 "project/nginx/src/stream/ngx_stream_script.c"
                           ;
        }
    }

    if (*sc->values == 
# 581 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                      ((void *)0)
# 581 "project/nginx/src/stream/ngx_stream_script.c"
                          ) {
        n = (sc->variables * (2 * sizeof(ngx_stream_script_copy_code_t)
                              + sizeof(ngx_stream_script_var_code_t))
                + sizeof(uintptr_t)
        ...
        *sc->values = ngx_array_create(sc->cf->pool, n, 1);
        if (*sc->values == 
# 590 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                          ((void *)0)
# 590 "project/nginx/src/stream/ngx_stream_script.c"
                              ) {
            return 
# 591 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                  -1
# 591 "project/nginx/src/stream/ngx_stream_script.c"
                           ;
        }
    }
    ...
    return 
# 597 "project/nginx/src/stream/ngx_stream_script.c" 3 4
          0
# 597 "project/nginx/src/stream/ngx_stream_script.c"
                ;
}
...
ngx_stream_script_done(ngx_stream_script_compile_t *sc)
{
    ...
    if (sc->zero) {
        ...
        if (ngx_stream_script_add_copy_code(sc, &zero, 0) != 
# 612 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                                            0
# 612 "project/nginx/src/stream/ngx_stream_script.c"
                                                                  ) {
            return 
# 613 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                  -1
# 613 "project/nginx/src/stream/ngx_stream_script.c"
                           ;
        }
    }

    if (sc->conf_prefix || sc->root_prefix) {
        if (ngx_stream_script_add_full_name_code(sc) != 
# 618 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                                       0
# 618 "project/nginx/src/stream/ngx_stream_script.c"
                                                             ) {
            return 
# 619 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                  -1
# 619 "project/nginx/src/stream/ngx_stream_script.c"
                           ;
        }
    }
...
# 625 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                         ((void *)0)
# 625 "project/nginx/src/stream/ngx_stream_script.c"
                                             );
        if (code == 
# 626 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                   ((void *)0)
# 626 "project/nginx/src/stream/ngx_stream_script.c"
                       ) {
            return 
# 627 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                  -1
# 627 "project/nginx/src/stream/ngx_stream_script.c"
                           ;
        }

        *code = (uintptr_t) 
# 630 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                           ((void *)0)
# 630 "project/nginx/src/stream/ngx_stream_script.c"
                               ;
    }
    ...
    if (sc->complete_values) {
        code = ngx_stream_script_add_code(*sc->values, sizeof(uintptr_t),
                                          &sc->main);
        if (code == 
# 636 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                   ((void *)0)
# 636 "project/nginx/src/stream/ngx_stream_script.c"
                       ) {
            return 
# 637 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                  -1
# 637 "project/nginx/src/stream/ngx_stream_script.c"
                           ;
        }

        *code = (uintptr_t) 
# 640 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                           ((void *)0)
# 640 "project/nginx/src/stream/ngx_stream_script.c"
                               ;
    }

    return 
# 643 "project/nginx/src/stream/ngx_stream_script.c" 3 4
          0
# 643 "project/nginx/src/stream/ngx_stream_script.c"
                ;
}
...
ngx_stream_script_add_code(ngx_array_t *codes, size_t size, void *code)
{
    ...
    if (new == 
# 656 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              ((void *)0)
# 656 "project/nginx/src/stream/ngx_stream_script.c"
                  ) {
        return 
# 657 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              ((void *)0)
# 657 "project/nginx/src/stream/ngx_stream_script.c"
                  ;
    }
...
# 684 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                     ((void *)0)
# 684 "project/nginx/src/stream/ngx_stream_script.c"
                                         );
    if (code == 
# 685 "project/nginx/src/stream/ngx_stream_script.c" 3 4
               ((void *)0)
# 685 "project/nginx/src/stream/ngx_stream_script.c"
                   ) {
        return 
# 686 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              -1
# 686 "project/nginx/src/stream/ngx_stream_script.c"
                       ;
    }
    ...
    if (code == 
# 697 "project/nginx/src/stream/ngx_stream_script.c" 3 4
               ((void *)0)
# 697 "project/nginx/src/stream/ngx_stream_script.c"
                   ) {
        return 
# 698 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              -1
# 698 "project/nginx/src/stream/ngx_stream_script.c"
                       ;
    }
    ...
    p = 
# 704 "project/nginx/src/stream/ngx_stream_script.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 704 "project/nginx/src/stream/ngx_stream_script.c"
       (u_char *) code + sizeof(ngx_stream_script_copy_code_t)
# 704 "project/nginx/src/stream/ngx_stream_script.c" 3 4
       , 
# 704 "project/nginx/src/stream/ngx_stream_script.c"
       value->data
...
# 705 "project/nginx/src/stream/ngx_stream_script.c"
                                          ;
    ...
    return 
# 712 "project/nginx/src/stream/ngx_stream_script.c" 3 4
          0
# 712 "project/nginx/src/stream/ngx_stream_script.c"
                ;
}
...
ngx_stream_script_copy_code(ngx_stream_script_engine_t *e)
{
    ...
    if (!e->skip) {
        e->pos = 
# 740 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                (((u_char *) __builtin___memcpy_chk (
# 740 "project/nginx/src/stream/ngx_stream_script.c"
                p
# 740 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                , 
# 740 "project/nginx/src/stream/ngx_stream_script.c"
...
# 741 "project/nginx/src/stream/ngx_stream_script.c"
                                   ;
    }
...
ngx_stream_script_add_var_code(ngx_stream_script_compile_t *sc, ngx_str_t *name)
{
    ...
    if (index == 
# 760 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                -1
# 760 "project/nginx/src/stream/ngx_stream_script.c"
                         ) {
        return 
# 761 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              -1
# 761 "project/nginx/src/stream/ngx_stream_script.c"
                       ;
    }
    ...
    if (sc->flushes) {
        ...
        if (p == 
# 766 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                ((void *)0)
# 766 "project/nginx/src/stream/ngx_stream_script.c"
                    ) {
            return 
# 767 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                  -1
# 767 "project/nginx/src/stream/ngx_stream_script.c"
                           ;
        }
...
# 775 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                     ((void *)0)
# 775 "project/nginx/src/stream/ngx_stream_script.c"
                                         );
    if (code == 
# 776 "project/nginx/src/stream/ngx_stream_script.c" 3 4
               ((void *)0)
# 776 "project/nginx/src/stream/ngx_stream_script.c"
                   ) {
        return 
# 777 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              -1
# 777 "project/nginx/src/stream/ngx_stream_script.c"
                       ;
    }
    ...
    code = ngx_stream_script_add_code(*sc->values,
                                      ...
                                      &sc->main);
    if (code == 
# 787 "project/nginx/src/stream/ngx_stream_script.c" 3 4
               ((void *)0)
# 787 "project/nginx/src/stream/ngx_stream_script.c"
                   ) {
        return 
# 788 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              -1
# 788 "project/nginx/src/stream/ngx_stream_script.c"
                       ;
    }
    ...
    return 
# 794 "project/nginx/src/stream/ngx_stream_script.c" 3 4
          0
# 794 "project/nginx/src/stream/ngx_stream_script.c"
                ;
}
...
ngx_stream_script_copy_var_code(ngx_stream_script_engine_t *e)
{
    ...
    if (!e->skip) {
        ...
        if (value && !value->not_found) {
            p = e->pos;
            e->pos = 
# 845 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                    (((u_char *) __builtin___memcpy_chk (
# 845 "project/nginx/src/stream/ngx_stream_script.c"
                    p
# 845 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                    , 
# 845 "project/nginx/src/stream/ngx_stream_script.c"
...
# 865 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                 ((void *)0)
# 865 "project/nginx/src/stream/ngx_stream_script.c"
                                     );
    if (code == 
# 866 "project/nginx/src/stream/ngx_stream_script.c" 3 4
               ((void *)0)
# 866 "project/nginx/src/stream/ngx_stream_script.c"
                   ) {
        return 
# 867 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              -1
# 867 "project/nginx/src/stream/ngx_stream_script.c"
                       ;
    }
    ...
    code = ngx_stream_script_add_code(*sc->values,
                                  ...
                                  &sc->main);
    if (code == 
# 878 "project/nginx/src/stream/ngx_stream_script.c" 3 4
               ((void *)0)
# 878 "project/nginx/src/stream/ngx_stream_script.c"
                   ) {
        return 
# 879 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              -1
# 879 "project/nginx/src/stream/ngx_stream_script.c"
                       ;
    }
    ...
    return 
# 889 "project/nginx/src/stream/ngx_stream_script.c" 3 4
          0
# 889 "project/nginx/src/stream/ngx_stream_script.c"
                ;
}
...
ngx_stream_script_copy_capture_code(ngx_stream_script_engine_t *e)
{
    ...
    if (n < s->ncaptures) {
        ...
        p = s->captures_data;
        e->pos = 
# 940 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                (((u_char *) __builtin___memcpy_chk (
# 940 "project/nginx/src/stream/ngx_stream_script.c"
                pos
# 940 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                , 
# 940 "project/nginx/src/stream/ngx_stream_script.c"
...
# 957 "project/nginx/src/stream/ngx_stream_script.c" 3 4
                                   ((void *)0)
# 957 "project/nginx/src/stream/ngx_stream_script.c"
                                       );
    if (code == 
# 958 "project/nginx/src/stream/ngx_stream_script.c" 3 4
               ((void *)0)
# 958 "project/nginx/src/stream/ngx_stream_script.c"
                   ) {
        return 
# 959 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              -1
# 959 "project/nginx/src/stream/ngx_stream_script.c"
                       ;
    }
    ...
    if (code == 
# 968 "project/nginx/src/stream/ngx_stream_script.c" 3 4
               ((void *)0)
# 968 "project/nginx/src/stream/ngx_stream_script.c"
                   ) {
        return 
# 969 "project/nginx/src/stream/ngx_stream_script.c" 3 4
              -1
# 969 "project/nginx/src/stream/ngx_stream_script.c"
                       ;
    }
    ...
    return 
# 975 "project/nginx/src/stream/ngx_stream_script.c" 3 4
          0
# 975 "project/nginx/src/stream/ngx_stream_script.c"
                ;
}
...
ngx_stream_script_full_name_code(ngx_stream_script_engine_t *e)
{
    ...
    if (ngx_get_full_name(e->session->connection->pool, prefix, &value)
        != 
# 1009 "project/nginx/src/stream/ngx_stream_script.c" 3 4
          0
# 1009 "project/nginx/src/stream/ngx_stream_script.c"
                )
    {
        e->ip = (u_char *) &ngx_stream_script_exit_code;
        return;
    }
