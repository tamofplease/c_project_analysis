# 0 "project/nginx/src/stream/ngx_stream.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/stream/ngx_stream.c"
...
# 9 "project/nginx/src/stream/ngx_stream.c" 2
...
# 10 "project/nginx/src/stream/ngx_stream.c" 2
...
# 11 "project/nginx/src/stream/ngx_stream.c" 2
...
# 12 "project/nginx/src/stream/ngx_stream.c" 2



# 14 "project/nginx/src/stream/ngx_stream.c"
...
static ngx_command_t ngx_stream_commands[] = {
    ...
    { 
# 39 "project/nginx/src/stream/ngx_stream.c" 3 4
     { sizeof(
# 39 "project/nginx/src/stream/ngx_stream.c"
     "stream"
# 39 "project/nginx/src/stream/ngx_stream.c" 3 4
     ) - 1, (u_char *) 
# 39 "project/nginx/src/stream/ngx_stream.c"
...
# 40 "project/nginx/src/stream/ngx_stream.c" 3 4
     0x01000000
# 40 "project/nginx/src/stream/ngx_stream.c"
                  |
# 40 "project/nginx/src/stream/ngx_stream.c" 3 4
                   0x00000100
# 40 "project/nginx/src/stream/ngx_stream.c"
...
# 44 "project/nginx/src/stream/ngx_stream.c" 3 4
     ((void *)0) 
# 44 "project/nginx/src/stream/ngx_stream.c"
          },

      
# 46 "project/nginx/src/stream/ngx_stream.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 47 "project/nginx/src/stream/ngx_stream.c"
};


static ngx_core_module_t ngx_stream_module_ctx = {
    
# 51 "project/nginx/src/stream/ngx_stream.c" 3 4
   { sizeof(
# 51 "project/nginx/src/stream/ngx_stream.c"
   "stream"
# 51 "project/nginx/src/stream/ngx_stream.c" 3 4
   ) - 1, (u_char *) 
# 51 "project/nginx/src/stream/ngx_stream.c"
...
# 52 "project/nginx/src/stream/ngx_stream.c" 3 4
   ((void *)0)
# 52 "project/nginx/src/stream/ngx_stream.c"
       ,
    
# 53 "project/nginx/src/stream/ngx_stream.c" 3 4
   ((void *)0)

# 54 "project/nginx/src/stream/ngx_stream.c"
};


ngx_module_t ngx_stream_module = {
    
# 58 "project/nginx/src/stream/ngx_stream.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 58 "project/nginx/src/stream/ngx_stream.c"
   "8" 
# 58 "project/nginx/src/stream/ngx_stream.c" 3 4
   "," 
# 58 "project/nginx/src/stream/ngx_stream.c"
...
# 58 "project/nginx/src/stream/ngx_stream.c"
                ,
    &ngx_stream_module_ctx,
    ngx_stream_commands,
    
# 61 "project/nginx/src/stream/ngx_stream.c" 3 4
   0x45524F43
# 61 "project/nginx/src/stream/ngx_stream.c"
                  ,
    
# 62 "project/nginx/src/stream/ngx_stream.c" 3 4
   ((void *)0)
# 62 "project/nginx/src/stream/ngx_stream.c"
       ,
    
# 63 "project/nginx/src/stream/ngx_stream.c" 3 4
   ((void *)0)
# 63 "project/nginx/src/stream/ngx_stream.c"
       ,
    
# 64 "project/nginx/src/stream/ngx_stream.c" 3 4
   ((void *)0)
# 64 "project/nginx/src/stream/ngx_stream.c"
       ,
    
# 65 "project/nginx/src/stream/ngx_stream.c" 3 4
   ((void *)0)
# 65 "project/nginx/src/stream/ngx_stream.c"
       ,
    
# 66 "project/nginx/src/stream/ngx_stream.c" 3 4
   ((void *)0)
# 66 "project/nginx/src/stream/ngx_stream.c"
       ,
    
# 67 "project/nginx/src/stream/ngx_stream.c" 3 4
   ((void *)0)
# 67 "project/nginx/src/stream/ngx_stream.c"
       ,
    
# 68 "project/nginx/src/stream/ngx_stream.c" 3 4
   ((void *)0)
# 68 "project/nginx/src/stream/ngx_stream.c"
       ,
    
# 69 "project/nginx/src/stream/ngx_stream.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 70 "project/nginx/src/stream/ngx_stream.c"
};
...
ngx_stream_block(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (ctx == 
# 93 "project/nginx/src/stream/ngx_stream.c" 3 4
              ((void *)0)
# 93 "project/nginx/src/stream/ngx_stream.c"
                  ) {
        return 
# 94 "project/nginx/src/stream/ngx_stream.c" 3 4
              (void *) -1
# 94 "project/nginx/src/stream/ngx_stream.c"
                            ;
    }
    ...
    *(ngx_stream_conf_ctx_t **) conf = ctx;
    ...
    ngx_stream_max_module = ngx_count_modules(cf->cycle, 
# 101 "project/nginx/src/stream/ngx_stream.c" 3 4
                                                        0x4d525453
# 101 "project/nginx/src/stream/ngx_stream.c"
                                                                         );
    ...
    if (ctx->main_conf == 
# 108 "project/nginx/src/stream/ngx_stream.c" 3 4
                         ((void *)0)
# 108 "project/nginx/src/stream/ngx_stream.c"
                             ) {
        return 
# 109 "project/nginx/src/stream/ngx_stream.c" 3 4
              (void *) -1
# 109 "project/nginx/src/stream/ngx_stream.c"
                            ;
    }
    ...
    ctx->srv_conf = ngx_pcalloc(cf->pool,
                                sizeof(void *) * ngx_stream_max_module);
    if (ctx->srv_conf == 
# 120 "project/nginx/src/stream/ngx_stream.c" 3 4
                        ((void *)0)
# 120 "project/nginx/src/stream/ngx_stream.c"
                            ) {
        return 
# 121 "project/nginx/src/stream/ngx_stream.c" 3 4
              (void *) -1
# 121 "project/nginx/src/stream/ngx_stream.c"
                            ;
    }
...
# 130 "project/nginx/src/stream/ngx_stream.c" 3 4
                                          0x4d525453
# 130 "project/nginx/src/stream/ngx_stream.c"
                                                           ) {
            continue;
        }
        ...
        if (module->create_main_conf) {
            ...
            if (ctx->main_conf[mi] == 
# 139 "project/nginx/src/stream/ngx_stream.c" 3 4
                                     ((void *)0)
# 139 "project/nginx/src/stream/ngx_stream.c"
                                         ) {
                return 
# 140 "project/nginx/src/stream/ngx_stream.c" 3 4
                      (void *) -1
# 140 "project/nginx/src/stream/ngx_stream.c"
                                    ;
            }
        }
        ...
        if (module->create_srv_conf) {
            ...
            if (ctx->srv_conf[mi] == 
# 146 "project/nginx/src/stream/ngx_stream.c" 3 4
                                    ((void *)0)
# 146 "project/nginx/src/stream/ngx_stream.c"
                                        ) {
                return 
# 147 "project/nginx/src/stream/ngx_stream.c" 3 4
                      (void *) -1
# 147 "project/nginx/src/stream/ngx_stream.c"
                                    ;
            }
        }
    }
    ...
    for (m = 0; cf->cycle->modules[m]; m++) {
        if (cf->cycle->modules[m]->type != 
# 157 "project/nginx/src/stream/ngx_stream.c" 3 4
                                          0x4d525453
# 157 "project/nginx/src/stream/ngx_stream.c"
                                                           ) {
            continue;
        }
...
# 164 "project/nginx/src/stream/ngx_stream.c" 3 4
                                               0
# 164 "project/nginx/src/stream/ngx_stream.c"
                                                     ) {
                return 
# 165 "project/nginx/src/stream/ngx_stream.c" 3 4
                      (void *) -1
# 165 "project/nginx/src/stream/ngx_stream.c"
                                    ;
            }
        }
    }
    ...
    cf->module_type = 
# 173 "project/nginx/src/stream/ngx_stream.c" 3 4
                     0x4d525453
# 173 "project/nginx/src/stream/ngx_stream.c"
                                      ;
    cf->cmd_type = 
# 174 "project/nginx/src/stream/ngx_stream.c" 3 4
                  0x02000000
# 174 "project/nginx/src/stream/ngx_stream.c"
                                      ;
    rv = ngx_conf_parse(cf, 
# 175 "project/nginx/src/stream/ngx_stream.c" 3 4
                           ((void *)0)
# 175 "project/nginx/src/stream/ngx_stream.c"
                               );

    if (rv != 
# 177 "project/nginx/src/stream/ngx_stream.c" 3 4
             ((void *)0)
# 177 "project/nginx/src/stream/ngx_stream.c"
                        ) {
        *cf = pcf;
        return rv;
    }
    ...
    for (m = 0; cf->cycle->modules[m]; m++) {
        if (cf->cycle->modules[m]->type != 
# 189 "project/nginx/src/stream/ngx_stream.c" 3 4
                                          0x4d525453
# 189 "project/nginx/src/stream/ngx_stream.c"
                                                           ) {
            continue;
        }
        ...
        if (module->init_main_conf) {
            ...
            if (rv != 
# 202 "project/nginx/src/stream/ngx_stream.c" 3 4
                     ((void *)0)
# 202 "project/nginx/src/stream/ngx_stream.c"
                                ) {
                *cf = pcf;
                return rv;
            }
        ...
        for (s = 0; s < cmcf->servers.nelts; s++) {
            ...
            if (module->merge_srv_conf) {
                ...
                if (rv != 
# 218 "project/nginx/src/stream/ngx_stream.c" 3 4
                         ((void *)0)
# 218 "project/nginx/src/stream/ngx_stream.c"
                                    ) {
                    *cf = pcf;
                    return rv;
                }
    ...
    if (ngx_stream_init_phases(cf, cmcf) != 
# 226 "project/nginx/src/stream/ngx_stream.c" 3 4
                                           0
# 226 "project/nginx/src/stream/ngx_stream.c"
                                                 ) {
        return 
# 227 "project/nginx/src/stream/ngx_stream.c" 3 4
              (void *) -1
# 227 "project/nginx/src/stream/ngx_stream.c"
                            ;
    }

    for (m = 0; cf->cycle->modules[m]; m++) {
        if (cf->cycle->modules[m]->type != 
# 231 "project/nginx/src/stream/ngx_stream.c" 3 4
                                          0x4d525453
# 231 "project/nginx/src/stream/ngx_stream.c"
                                                           ) {
            continue;
        }
...
# 238 "project/nginx/src/stream/ngx_stream.c" 3 4
                                                0
# 238 "project/nginx/src/stream/ngx_stream.c"
                                                      ) {
                return 
# 239 "project/nginx/src/stream/ngx_stream.c" 3 4
                      (void *) -1
# 239 "project/nginx/src/stream/ngx_stream.c"
                                    ;
            }
        }
    }

    if (ngx_stream_variables_init_vars(cf) != 
# 244 "project/nginx/src/stream/ngx_stream.c" 3 4
                                             0
# 244 "project/nginx/src/stream/ngx_stream.c"
                                                   ) {
        return 
# 245 "project/nginx/src/stream/ngx_stream.c" 3 4
              (void *) -1
# 245 "project/nginx/src/stream/ngx_stream.c"
                            ;
    }

    *cf = pcf;

    if (ngx_stream_init_phase_handlers(cf, cmcf) != 
# 250 "project/nginx/src/stream/ngx_stream.c" 3 4
                                                   0
# 250 "project/nginx/src/stream/ngx_stream.c"
                                                         ) {
        return 
# 251 "project/nginx/src/stream/ngx_stream.c" 3 4
              (void *) -1
# 251 "project/nginx/src/stream/ngx_stream.c"
                            ;
    }

    if (ngx_array_init(&ports, cf->temp_pool, 4, sizeof(ngx_stream_conf_port_t))
        != 
# 255 "project/nginx/src/stream/ngx_stream.c" 3 4
          0
# 255 "project/nginx/src/stream/ngx_stream.c"
                )
    {
        return 
# 257 "project/nginx/src/stream/ngx_stream.c" 3 4
              (void *) -1
# 257 "project/nginx/src/stream/ngx_stream.c"
                            ;
    }
    ...
    for (i = 0; i < cmcf->listen.nelts; i++) {
        if (ngx_stream_add_ports(cf, &ports, &listen[i]) != 
# 263 "project/nginx/src/stream/ngx_stream.c" 3 4
                                                           0
# 263 "project/nginx/src/stream/ngx_stream.c"
                                                                 ) {
            return 
# 264 "project/nginx/src/stream/ngx_stream.c" 3 4
                  (void *) -1
# 264 "project/nginx/src/stream/ngx_stream.c"
                                ;
        }
    }
...
ngx_stream_init_phases(ngx_conf_t *cf, ngx_stream_core_main_conf_t *cmcf)
{
    if (ngx_array_init(&cmcf->phases[NGX_STREAM_POST_ACCEPT_PHASE].handlers,
        ...
        != 
# 277 "project/nginx/src/stream/ngx_stream.c" 3 4
          0
# 277 "project/nginx/src/stream/ngx_stream.c"
                )
    {
        return 
# 279 "project/nginx/src/stream/ngx_stream.c" 3 4
              -1
# 279 "project/nginx/src/stream/ngx_stream.c"
                       ;
    }
    ...
    if (ngx_array_init(&cmcf->phases[NGX_STREAM_PREACCESS_PHASE].handlers,
                       cf->pool, 1, sizeof(ngx_stream_handler_pt))
        != 
# 284 "project/nginx/src/stream/ngx_stream.c" 3 4
          0
# 284 "project/nginx/src/stream/ngx_stream.c"
                )
    {
        return 
# 286 "project/nginx/src/stream/ngx_stream.c" 3 4
              -1
# 286 "project/nginx/src/stream/ngx_stream.c"
                       ;
    }
    ...
    if (ngx_array_init(&cmcf->phases[NGX_STREAM_ACCESS_PHASE].handlers,
                       cf->pool, 1, sizeof(ngx_stream_handler_pt))
        != 
# 291 "project/nginx/src/stream/ngx_stream.c" 3 4
          0
# 291 "project/nginx/src/stream/ngx_stream.c"
                )
    {
        return 
# 293 "project/nginx/src/stream/ngx_stream.c" 3 4
              -1
# 293 "project/nginx/src/stream/ngx_stream.c"
                       ;
    }
    ...
    if (ngx_array_init(&cmcf->phases[NGX_STREAM_SSL_PHASE].handlers,
                       cf->pool, 1, sizeof(ngx_stream_handler_pt))
        != 
# 298 "project/nginx/src/stream/ngx_stream.c" 3 4
          0
# 298 "project/nginx/src/stream/ngx_stream.c"
                )
    {
        return 
# 300 "project/nginx/src/stream/ngx_stream.c" 3 4
              -1
# 300 "project/nginx/src/stream/ngx_stream.c"
                       ;
    }
    ...
    if (ngx_array_init(&cmcf->phases[NGX_STREAM_PREREAD_PHASE].handlers,
                       cf->pool, 1, sizeof(ngx_stream_handler_pt))
        != 
# 305 "project/nginx/src/stream/ngx_stream.c" 3 4
          0
# 305 "project/nginx/src/stream/ngx_stream.c"
                )
    {
        return 
# 307 "project/nginx/src/stream/ngx_stream.c" 3 4
              -1
# 307 "project/nginx/src/stream/ngx_stream.c"
                       ;
    }
    ...
    if (ngx_array_init(&cmcf->phases[NGX_STREAM_LOG_PHASE].handlers,
                       cf->pool, 1, sizeof(ngx_stream_handler_pt))
        != 
# 312 "project/nginx/src/stream/ngx_stream.c" 3 4
          0
# 312 "project/nginx/src/stream/ngx_stream.c"
                )
    {
        return 
# 314 "project/nginx/src/stream/ngx_stream.c" 3 4
              -1
# 314 "project/nginx/src/stream/ngx_stream.c"
                       ;
    }

    return 
# 317 "project/nginx/src/stream/ngx_stream.c" 3 4
          0
# 317 "project/nginx/src/stream/ngx_stream.c"
                ;
}
    ...
    ngx_stream_core_main_conf_t *cmcf)
{
    ...
    if (ph == 
# 339 "project/nginx/src/stream/ngx_stream.c" 3 4
             ((void *)0)
# 339 "project/nginx/src/stream/ngx_stream.c"
                 ) {
        return 
# 340 "project/nginx/src/stream/ngx_stream.c" 3 4
              -1
# 340 "project/nginx/src/stream/ngx_stream.c"
                       ;
    }
    ...
    return 
# 376 "project/nginx/src/stream/ngx_stream.c" 3 4
          0
# 376 "project/nginx/src/stream/ngx_stream.c"
                ;
}
    ...
    ngx_stream_listen_t *listen)
{
    ...
    if (port == 
# 410 "project/nginx/src/stream/ngx_stream.c" 3 4
               ((void *)0)
# 410 "project/nginx/src/stream/ngx_stream.c"
                   ) {
        return 
# 411 "project/nginx/src/stream/ngx_stream.c" 3 4
              -1
# 411 "project/nginx/src/stream/ngx_stream.c"
                       ;
    }
    ...
    if (ngx_array_init(&port->addrs, cf->temp_pool, 2,
        ...
        != 
# 420 "project/nginx/src/stream/ngx_stream.c" 3 4
          0
# 420 "project/nginx/src/stream/ngx_stream.c"
                )
    {
        return 
# 422 "project/nginx/src/stream/ngx_stream.c" 3 4
              -1
# 422 "project/nginx/src/stream/ngx_stream.c"
                       ;
    }
...
found:
    ...
    if (addr == 
# 428 "project/nginx/src/stream/ngx_stream.c" 3 4
               ((void *)0)
# 428 "project/nginx/src/stream/ngx_stream.c"
                   ) {
        return 
# 429 "project/nginx/src/stream/ngx_stream.c" 3 4
              -1
# 429 "project/nginx/src/stream/ngx_stream.c"
                       ;
    }
    ...
    return 
# 434 "project/nginx/src/stream/ngx_stream.c" 3 4
          0
# 434 "project/nginx/src/stream/ngx_stream.c"
                ;
}
    ...
    for (p = 0; p < ports->nelts; p++) {
        ...
        while (i < last) {
            ...
            ls = ngx_create_listening(cf, addr[i].opt.sockaddr,
                                      addr[i].opt.socklen);
            if (ls == 
# 481 "project/nginx/src/stream/ngx_stream.c" 3 4
                     ((void *)0)
# 481 "project/nginx/src/stream/ngx_stream.c"
                         ) {
                return 
# 482 "project/nginx/src/stream/ngx_stream.c" 3 4
                      (void *) -1
# 482 "project/nginx/src/stream/ngx_stream.c"
                                    ;
            }
            ...
            if (stport == 
# 522 "project/nginx/src/stream/ngx_stream.c" 3 4
                         ((void *)0)
# 522 "project/nginx/src/stream/ngx_stream.c"
                             ) {
                return 
# 523 "project/nginx/src/stream/ngx_stream.c" 3 4
                      (void *) -1
# 523 "project/nginx/src/stream/ngx_stream.c"
                                    ;
            }
            ...
            case 
# 532 "project/nginx/src/stream/ngx_stream.c" 3 4
                30
# 532 "project/nginx/src/stream/ngx_stream.c"
                        :
                if (ngx_stream_add_addrs6(cf, stport, addr) != 
# 533 "project/nginx/src/stream/ngx_stream.c" 3 4
                                                              0
# 533 "project/nginx/src/stream/ngx_stream.c"
                                                                    ) {
                    return 
# 534 "project/nginx/src/stream/ngx_stream.c" 3 4
                          (void *) -1
# 534 "project/nginx/src/stream/ngx_stream.c"
                                        ;
                }
                break;

            default:
                if (ngx_stream_add_addrs(cf, stport, addr) != 
# 539 "project/nginx/src/stream/ngx_stream.c" 3 4
                                                             0
# 539 "project/nginx/src/stream/ngx_stream.c"
                                                                   ) {
                    return 
# 540 "project/nginx/src/stream/ngx_stream.c" 3 4
                          (void *) -1
# 540 "project/nginx/src/stream/ngx_stream.c"
                                        ;
                }
                break;
            }
    ...
    return 
# 550 "project/nginx/src/stream/ngx_stream.c" 3 4
          ((void *)0)
# 550 "project/nginx/src/stream/ngx_stream.c"
                     ;
}
    ...
    ngx_stream_conf_addr_t *addr)
{
    ...
    if (stport->addrs == 
# 564 "project/nginx/src/stream/ngx_stream.c" 3 4
                        ((void *)0)
# 564 "project/nginx/src/stream/ngx_stream.c"
                            ) {
        return 
# 565 "project/nginx/src/stream/ngx_stream.c" 3 4
              -1
# 565 "project/nginx/src/stream/ngx_stream.c"
                       ;
    }
    ...
    return 
# 583 "project/nginx/src/stream/ngx_stream.c" 3 4
          0
# 583 "project/nginx/src/stream/ngx_stream.c"
                ;
}
    ...
    ngx_stream_conf_addr_t *addr)
{
    ...
    if (stport->addrs == 
# 599 "project/nginx/src/stream/ngx_stream.c" 3 4
                        ((void *)0)
# 599 "project/nginx/src/stream/ngx_stream.c"
                            ) {
        return 
# 600 "project/nginx/src/stream/ngx_stream.c" 3 4
              -1
# 600 "project/nginx/src/stream/ngx_stream.c"
                       ;
    }
    ...
    return 
# 618 "project/nginx/src/stream/ngx_stream.c" 3 4
          0
# 618 "project/nginx/src/stream/ngx_stream.c"
                ;
}
