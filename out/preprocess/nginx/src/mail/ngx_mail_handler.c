# 0 "project/nginx/src/mail/ngx_mail_handler.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 9 "project/nginx/src/mail/ngx_mail_handler.c" 2
...
# 10 "project/nginx/src/mail/ngx_mail_handler.c" 2
...
# 11 "project/nginx/src/mail/ngx_mail_handler.c" 2
...
# 12 "project/nginx/src/mail/ngx_mail_handler.c" 2



# 14 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 26 "project/nginx/src/mail/ngx_mail_handler.c"
void
ngx_mail_init_connection(ngx_connection_t *c)
{
    ...
    ngx_mail_core_srv_conf_t *cscf;
    u_char text[
# 40 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                   (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 40 "project/nginx/src/mail/ngx_mail_handler.c"
                                                      ];
    ...
    if (port->naddrs > 1) {
# 61 "project/nginx/src/mail/ngx_mail_handler.c"
        if (ngx_connection_local_sockaddr(c, 
# 61 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                            ((void *)0)
# 61 "project/nginx/src/mail/ngx_mail_handler.c"
                                                , 0) != 
# 61 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
...
# 61 "project/nginx/src/mail/ngx_mail_handler.c"
        ...
        case 
# 71 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
            30
# 71 "project/nginx/src/mail/ngx_mail_handler.c"
                    :
            ...
            for (i = 0; i < port->naddrs - 1; i++) {
                if (
# 79 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                   memcmp((const char *) 
# 79 "project/nginx/src/mail/ngx_mail_handler.c"
                   &addr6[i].addr6
# 79 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                   , (const char *) 
# 79 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 79 "project/nginx/src/mail/ngx_mail_handler.c"
        ...
        case 
# 111 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
            30
# 111 "project/nginx/src/mail/ngx_mail_handler.c"
                    :
            addr6 = port->addrs;
    ...
    if (s == 
# 125 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
            ((void *)0)
# 125 "project/nginx/src/mail/ngx_mail_handler.c"
                ) {
        ngx_mail_close_connection(c);
        return;
    }
    ...
    s->signature = 
# 130 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                  0x4C49414D
# 130 "project/nginx/src/mail/ngx_mail_handler.c"
                                 ;
    ...
    cscf = 
# 144 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
          (
# 144 "project/nginx/src/mail/ngx_mail_handler.c"
          s
# 144 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
          )->srv_conf[
# 144 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 144 "project/nginx/src/mail/ngx_mail_handler.c"
    ...
    c
# 146 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
   ->log->file = 
# 146 "project/nginx/src/mail/ngx_mail_handler.c"
   cscf->error_log
# 146 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
   ->file; 
# 146 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 146 "project/nginx/src/mail/ngx_mail_handler.c"
    ...
    len = ngx_sock_ntop(c->sockaddr, c->socklen, text, 
# 148 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                                      (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 148 "project/nginx/src/mail/ngx_mail_handler.c"
                                                                         , 1);

    
# 150 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
   if ((
# 150 "project/nginx/src/mail/ngx_mail_handler.c"
   c->log
# 150 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
...
# 150 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
   , 
# 150 "project/nginx/src/mail/ngx_mail_handler.c"
   0, "*%uA client %*s connected to %V", c->number, len, text, s->addr_text
# 150 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
   )
                                                     
# 151 "project/nginx/src/mail/ngx_mail_handler.c"
                                                    ;

    ctx = ngx_palloc(c->pool, sizeof(ngx_mail_log_ctx_t));
    if (ctx == 
# 154 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
              ((void *)0)
# 154 "project/nginx/src/mail/ngx_mail_handler.c"
                  ) {
        ngx_mail_close_connection(c);
        return;
    }
...
# 178 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
           ngx_event_add_timer
# 178 "project/nginx/src/mail/ngx_mail_handler.c"
                        (rev, cscf->timeout);

            if (ngx_handle_read_event(rev, 0) != 
# 180 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                                0
# 180 "project/nginx/src/mail/ngx_mail_handler.c"
                                                      ) {
                ngx_mail_close_connection(c);
            }
...
# 189 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       if (!(
# 189 "project/nginx/src/mail/ngx_mail_handler.c"
       rev
# 189 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       )->posted) { (
# 189 "project/nginx/src/mail/ngx_mail_handler.c"
...
{
    u_char *p, buf[
# 200 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                     107
# 200 "project/nginx/src/mail/ngx_mail_handler.c"
                                                                  ];
    size_t size;
    ssize_t n;
    ngx_err_t err;
...
# 215 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       if ((
# 215 "project/nginx/src/mail/ngx_mail_handler.c"
       c->log
# 215 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 215 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 215 "project/nginx/src/mail/ngx_mail_handler.c"
    ...
    n = recv(c->fd, (char *) buf, sizeof(buf), 
# 221 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                              0x2
# 221 "project/nginx/src/mail/ngx_mail_handler.c"
                                                      );

    err = 
# 223 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
         (*__error())
# 223 "project/nginx/src/mail/ngx_mail_handler.c"
                         ;
    ...
    if (n == -1) {
        if (err == 
# 228 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                  35
# 228 "project/nginx/src/mail/ngx_mail_handler.c"
                            ) {
            rev->ready = 0;

            if (!rev->timer_set) {
                cscf = 
# 232 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                      (
# 232 "project/nginx/src/mail/ngx_mail_handler.c"
                      s
# 232 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                      )->srv_conf[
# 232 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 233 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
               ngx_event_add_timer
# 233 "project/nginx/src/mail/ngx_mail_handler.c"
                            (rev, cscf->timeout);
            }

            if (ngx_handle_read_event(rev, 0) != 
# 236 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                                0
# 236 "project/nginx/src/mail/ngx_mail_handler.c"
                                                      ) {
                ngx_mail_close_connection(c);
            }
    ...
    if (p == 
# 251 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
            ((void *)0)
# 251 "project/nginx/src/mail/ngx_mail_handler.c"
                ) {
        ngx_mail_close_connection(c);
        return;
    }
    ...
    if (ngx_mail_realip_handler(s) != 
# 263 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                     0
# 263 "project/nginx/src/mail/ngx_mail_handler.c"
                                           ) {
        ngx_mail_close_connection(c);
        return;
    }
...
ngx_mail_init_session_handler(ngx_event_t *rev)
{
    ...
    c = rev->data;
# 298 "project/nginx/src/mail/ngx_mail_handler.c"
    ngx_mail_init_session(c);
}
# 454 "project/nginx/src/mail/ngx_mail_handler.c"
static void
ngx_mail_init_session(ngx_connection_t *c)
{
    ...
    cscf = 
# 464 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
          (
# 464 "project/nginx/src/mail/ngx_mail_handler.c"
          s
# 464 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
          )->srv_conf[
# 464 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 464 "project/nginx/src/mail/ngx_mail_handler.c"
    ...
    if (s->ctx == 
# 469 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                 ((void *)0)
# 469 "project/nginx/src/mail/ngx_mail_handler.c"
                     ) {
...
# 485 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                                                 "\r\n"
# 485 "project/nginx/src/mail/ngx_mail_handler.c"
                                                                     ) - 1
                               + 
# 486 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                (sizeof("-9223372036854775808") - 1)
                               
# 487 "project/nginx/src/mail/ngx_mail_handler.c"
                              + cscf->server_name.len);
    if (s->salt.data == 
# 488 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                       ((void *)0)
# 488 "project/nginx/src/mail/ngx_mail_handler.c"
                           ) {
        return 
# 489 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
              -1
# 489 "project/nginx/src/mail/ngx_mail_handler.c"
                       ;
    }

    s->salt.len = ngx_sprintf(s->salt.data, "<%ul.%T@%V>" 
# 492 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                                         "\r\n"
# 492 "project/nginx/src/mail/ngx_mail_handler.c"
                                                             ,
                              
# 493 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                             random
# 493 "project/nginx/src/mail/ngx_mail_handler.c"
                                       (), 
# 493 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                           ngx_cached_time->sec
# 493 "project/nginx/src/mail/ngx_mail_handler.c"
    ...
    return 
# 496 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
          0
# 496 "project/nginx/src/mail/ngx_mail_handler.c"
                ;
}
# 523 "project/nginx/src/mail/ngx_mail_handler.c"
ngx_int_t
ngx_mail_auth_plain(ngx_mail_session_t *s, ngx_connection_t *c, ngx_uint_t n)
{
    ...
    plain.data = ngx_pnalloc(c->pool, 
# 536 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                     (((
# 536 "project/nginx/src/mail/ngx_mail_handler.c"
                                     arg[n].len 
# 536 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                     + 3) / 4) * 3)
# 536 "project/nginx/src/mail/ngx_mail_handler.c"
    ...
    if (plain.data == 
# 537 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                     ((void *)0)
# 537 "project/nginx/src/mail/ngx_mail_handler.c"
                         ) {
        return 
# 538 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
              -1
# 538 "project/nginx/src/mail/ngx_mail_handler.c"
                       ;
    }

    if (ngx_decode_base64(&plain, &arg[n]) != 
# 541 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                             0
# 541 "project/nginx/src/mail/ngx_mail_handler.c"
                                                   ) {
        
# 542 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       if ((
# 542 "project/nginx/src/mail/ngx_mail_handler.c"
       c->log
# 542 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 542 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 542 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       , 
# 542 "project/nginx/src/mail/ngx_mail_handler.c"
       0, "client sent invalid base64 encoding in AUTH PLAIN command"
# 542 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       )
                                                                        
# 543 "project/nginx/src/mail/ngx_mail_handler.c"
                                                                       ;
        return 
# 544 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
              20
# 544 "project/nginx/src/mail/ngx_mail_handler.c"
                                            ;
    }
...
# 553 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       if ((
# 553 "project/nginx/src/mail/ngx_mail_handler.c"
       c->log
# 553 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 553 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 553 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       , 
# 553 "project/nginx/src/mail/ngx_mail_handler.c"
       0, "client sent invalid login in AUTH PLAIN command"
# 553 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       )
                                                                        
# 554 "project/nginx/src/mail/ngx_mail_handler.c"
                                                                       ;
        return 
# 555 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
              20
# 555 "project/nginx/src/mail/ngx_mail_handler.c"
                                            ;
    }
...
# 563 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       if ((
# 563 "project/nginx/src/mail/ngx_mail_handler.c"
       c->log
# 563 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 563 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 563 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       , 
# 563 "project/nginx/src/mail/ngx_mail_handler.c"
       0, "client sent invalid password in AUTH PLAIN command"
# 563 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       )
                                                                           
# 564 "project/nginx/src/mail/ngx_mail_handler.c"
                                                                          ;
        return 
# 565 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
              20
# 565 "project/nginx/src/mail/ngx_mail_handler.c"
                                            ;
    }
    ...
    return 
# 578 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
          -4
# 578 "project/nginx/src/mail/ngx_mail_handler.c"
                  ;
}
...
# 593 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                        (((
# 593 "project/nginx/src/mail/ngx_mail_handler.c"
                                        arg[n].len 
# 593 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                        + 3) / 4) * 3)
# 593 "project/nginx/src/mail/ngx_mail_handler.c"
    ...
    if (s->login.data == 
# 594 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                        ((void *)0)
# 594 "project/nginx/src/mail/ngx_mail_handler.c"
                            ) {
        return 
# 595 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
              -1
# 595 "project/nginx/src/mail/ngx_mail_handler.c"
                       ;
    }

    if (ngx_decode_base64(&s->login, &arg[n]) != 
# 598 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                                0
# 598 "project/nginx/src/mail/ngx_mail_handler.c"
                                                      ) {
        
# 599 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       if ((
# 599 "project/nginx/src/mail/ngx_mail_handler.c"
       c->log
# 599 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 599 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 599 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       , 
# 599 "project/nginx/src/mail/ngx_mail_handler.c"
       0, "client sent invalid base64 encoding in AUTH LOGIN command"
# 599 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       )
                                                                        
# 600 "project/nginx/src/mail/ngx_mail_handler.c"
                                                                       ;
        return 
# 601 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
              20
# 601 "project/nginx/src/mail/ngx_mail_handler.c"
                                            ;
    }
    ...
    return 
# 607 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
          0
# 607 "project/nginx/src/mail/ngx_mail_handler.c"
                ;
}
...
# 624 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                (((
# 624 "project/nginx/src/mail/ngx_mail_handler.c"
                                arg[0].len 
# 624 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                + 3) / 4) * 3)
# 624 "project/nginx/src/mail/ngx_mail_handler.c"
    ...
    if (s->passwd.data == 
# 625 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                         ((void *)0)
# 625 "project/nginx/src/mail/ngx_mail_handler.c"
                             ) {
        return 
# 626 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
              -1
# 626 "project/nginx/src/mail/ngx_mail_handler.c"
                       ;
    }

    if (ngx_decode_base64(&s->passwd, &arg[0]) != 
# 629 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                                 0
# 629 "project/nginx/src/mail/ngx_mail_handler.c"
                                                       ) {
        
# 630 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       if ((
# 630 "project/nginx/src/mail/ngx_mail_handler.c"
       c->log
# 630 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 630 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 631 "project/nginx/src/mail/ngx_mail_handler.c"
                                                                       ;
        return 
# 632 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
              20
# 632 "project/nginx/src/mail/ngx_mail_handler.c"
                                            ;
    }
    ...
    return 
# 640 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
          -4
# 640 "project/nginx/src/mail/ngx_mail_handler.c"
                  ;
}
...
# 652 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                  (((
# 652 "project/nginx/src/mail/ngx_mail_handler.c"
                                  s->salt.len 
# 652 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                  + 2) / 3) * 4) 
# 652 "project/nginx/src/mail/ngx_mail_handler.c"
                                                                         + 2);
    if (p == 
# 653 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
            ((void *)0)
# 653 "project/nginx/src/mail/ngx_mail_handler.c"
                ) {
        return 
# 654 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
              -1
# 654 "project/nginx/src/mail/ngx_mail_handler.c"
                       ;
    }

    salt.data = 
# 657 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
               (((u_char *) __builtin___memcpy_chk (
# 657 "project/nginx/src/mail/ngx_mail_handler.c"
               p
# 657 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
               , 
# 657 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 657 "project/nginx/src/mail/ngx_mail_handler.c"
    ...
    n = len + salt.len;
    p[n++] = 
# 664 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
            (u_char) '\r'
# 664 "project/nginx/src/mail/ngx_mail_handler.c"
              ; p[n++] = 
# 664 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                         (u_char) '\n'
# 664 "project/nginx/src/mail/ngx_mail_handler.c"
    ...
    return 
# 669 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
          0
# 669 "project/nginx/src/mail/ngx_mail_handler.c"
                ;
}
...
ngx_mail_auth_cram_md5(ngx_mail_session_t *s, ngx_connection_t *c)
{
    ...
    s->login.data = ngx_pnalloc(c->pool, 
# 684 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                        (((
# 684 "project/nginx/src/mail/ngx_mail_handler.c"
                                        arg[0].len 
# 684 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                        + 3) / 4) * 3)
# 684 "project/nginx/src/mail/ngx_mail_handler.c"
    ...
    if (s->login.data == 
# 685 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                        ((void *)0)
# 685 "project/nginx/src/mail/ngx_mail_handler.c"
                            ) {
        return 
# 686 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
              -1
# 686 "project/nginx/src/mail/ngx_mail_handler.c"
                       ;
    }

    if (ngx_decode_base64(&s->login, &arg[0]) != 
# 689 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                                0
# 689 "project/nginx/src/mail/ngx_mail_handler.c"
                                                      ) {
        
# 690 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       if ((
# 690 "project/nginx/src/mail/ngx_mail_handler.c"
       c->log
# 690 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 690 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 690 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       , 
# 690 "project/nginx/src/mail/ngx_mail_handler.c"
       0, "client sent invalid base64 encoding in AUTH CRAM-MD5 command"
# 690 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       )
                                                                           
# 691 "project/nginx/src/mail/ngx_mail_handler.c"
                                                                          ;
        return 
# 692 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
              20
# 692 "project/nginx/src/mail/ngx_mail_handler.c"
                                            ;
    }
...
# 708 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       if ((
# 708 "project/nginx/src/mail/ngx_mail_handler.c"
       c->log
# 708 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 708 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 708 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       , 
# 708 "project/nginx/src/mail/ngx_mail_handler.c"
       0, "client sent invalid CRAM-MD5 hash in AUTH CRAM-MD5 command"
# 708 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       )
                                                                         
# 709 "project/nginx/src/mail/ngx_mail_handler.c"
                                                                        ;
        return 
# 710 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
              20
# 710 "project/nginx/src/mail/ngx_mail_handler.c"
                                            ;
    }
    ...
    s->auth_method = 
# 716 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                    4
# 716 "project/nginx/src/mail/ngx_mail_handler.c"
                                          ;

    return 
# 718 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
          -4
# 718 "project/nginx/src/mail/ngx_mail_handler.c"
                  ;
}
...
# 733 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                        (((
# 733 "project/nginx/src/mail/ngx_mail_handler.c"
                                        arg[n].len 
# 733 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                        + 3) / 4) * 3)
# 733 "project/nginx/src/mail/ngx_mail_handler.c"
    ...
    if (external.data == 
# 734 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                        ((void *)0)
# 734 "project/nginx/src/mail/ngx_mail_handler.c"
                            ) {
        return 
# 735 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
              -1
# 735 "project/nginx/src/mail/ngx_mail_handler.c"
                       ;
    }

    if (ngx_decode_base64(&external, &arg[n]) != 
# 738 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                                0
# 738 "project/nginx/src/mail/ngx_mail_handler.c"
                                                      ) {
        
# 739 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       if ((
# 739 "project/nginx/src/mail/ngx_mail_handler.c"
       c->log
# 739 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 739 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 739 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       , 
# 739 "project/nginx/src/mail/ngx_mail_handler.c"
       0, "client sent invalid base64 encoding in AUTH EXTERNAL command"
# 739 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       )
                                                                           
# 740 "project/nginx/src/mail/ngx_mail_handler.c"
                                                                          ;
        return 
# 741 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
              20
# 741 "project/nginx/src/mail/ngx_mail_handler.c"
                                            ;
    }
    ...
    s->auth_method = 
# 750 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                    5
# 750 "project/nginx/src/mail/ngx_mail_handler.c"
                                          ;

    return 
# 752 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
          -4
# 752 "project/nginx/src/mail/ngx_mail_handler.c"
                  ;
}
...
# 768 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       if ((
# 768 "project/nginx/src/mail/ngx_mail_handler.c"
       c->log
# 768 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 768 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 775 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                                  0
# 775 "project/nginx/src/mail/ngx_mail_handler.c"
                                                        ) {
            ngx_mail_close_connection(c);
        }
...
# 793 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
           ngx_event_del_timer
# 793 "project/nginx/src/mail/ngx_mail_handler.c"
                        (wev);
        }
    ...
    if (n == 
# 808 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
            -1
# 808 "project/nginx/src/mail/ngx_mail_handler.c"
                     ) {
        ngx_mail_close_connection(c);
        return;
    }
...
again:
    ...
    cscf = 
# 817 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
          (
# 817 "project/nginx/src/mail/ngx_mail_handler.c"
          s
# 817 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
          )->srv_conf[
# 817 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 819 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
   ngx_event_add_timer
# 819 "project/nginx/src/mail/ngx_mail_handler.c"
                (c->write, cscf->timeout);

    if (ngx_handle_write_event(c->write, 0) != 
# 821 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                                              0
# 821 "project/nginx/src/mail/ngx_mail_handler.c"
                                                    ) {
        ngx_mail_close_connection(c);
        return;
    }
...
ngx_mail_read_command(ngx_mail_session_t *s, ngx_connection_t *c)
{
    ...
    if (s->buffer->last < s->buffer->end) {
        ...
        if (n == 
# 840 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                -1 
# 840 "project/nginx/src/mail/ngx_mail_handler.c"
                          || n == 0) {
            ngx_mail_close_connection(c);
            return 
# 842 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                  -1
# 842 "project/nginx/src/mail/ngx_mail_handler.c"
                           ;
        }
        ...
        if (n == 
# 849 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                -2
# 849 "project/nginx/src/mail/ngx_mail_handler.c"
                         ) {
            if (s->buffer->pos == s->buffer->last) {
                return 
# 851 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                      -2
# 851 "project/nginx/src/mail/ngx_mail_handler.c"
                               ;
            }
        }
    }
    ...
    cscf = 
# 856 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
          (
# 856 "project/nginx/src/mail/ngx_mail_handler.c"
          s
# 856 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
          )->srv_conf[
# 856 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 856 "project/nginx/src/mail/ngx_mail_handler.c"
    ...
    if (rc == 
# 860 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
             -2
# 860 "project/nginx/src/mail/ngx_mail_handler.c"
                      ) {
...
# 869 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       if ((
# 869 "project/nginx/src/mail/ngx_mail_handler.c"
       c->log
# 869 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 869 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 869 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       , 
# 869 "project/nginx/src/mail/ngx_mail_handler.c"
       0, "client sent too long command \"%V\"", &l
# 869 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       )
                                                                
# 870 "project/nginx/src/mail/ngx_mail_handler.c"
                                                               ;

        s->quit = 1;

        return 
# 874 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
              20
# 874 "project/nginx/src/mail/ngx_mail_handler.c"
                                            ;
    }

    if (rc == 
# 877 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
             20
# 877 "project/nginx/src/mail/ngx_mail_handler.c"
                                           ) {
...
# 882 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
           if ((
# 882 "project/nginx/src/mail/ngx_mail_handler.c"
           c->log
# 882 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
           )->log_level >= 7) ngx_log_error_core(7, 
# 882 "project/nginx/src/mail/ngx_mail_handler.c"
...
# 882 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
           , 
# 882 "project/nginx/src/mail/ngx_mail_handler.c"
           0, "client sent too many invalid commands"
# 882 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
           )
                                                                  
# 883 "project/nginx/src/mail/ngx_mail_handler.c"
                                                                 ;
            s->quit = 1;
        }
    ...
    if (rc == 
# 890 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
             6
# 890 "project/nginx/src/mail/ngx_mail_handler.c"
                          ) {
        return rc;
    }

    if (rc == 
# 894 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
             -1
# 894 "project/nginx/src/mail/ngx_mail_handler.c"
                      ) {
        ngx_mail_close_connection(c);
        return 
# 896 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
              -1
# 896 "project/nginx/src/mail/ngx_mail_handler.c"
                       ;
    }

    return 
# 899 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
          0
# 899 "project/nginx/src/mail/ngx_mail_handler.c"
                ;
}
...
# 916 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
       ngx_event_del_timer
# 916 "project/nginx/src/mail/ngx_mail_handler.c"
                    (c->read);
    }
...
ngx_mail_session_internal_server_error(ngx_mail_session_t *s)
{
    ...
    cscf = 
# 930 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
          (
# 930 "project/nginx/src/mail/ngx_mail_handler.c"
          s
# 930 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
          )->srv_conf[
# 930 "project/nginx/src/mail/ngx_mail_handler.c"
...
ngx_mail_close_connection(ngx_connection_t *c)
{
    ngx_pool_t *pool;
                                                      ...
                                                      ;
# 962 "project/nginx/src/mail/ngx_mail_handler.c"
    c->destroyed = 1;
...
ngx_mail_log_error(ngx_log_t *log, u_char *buf, size_t len)
{
    ...
    if (s == 
# 993 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
            ((void *)0)
# 993 "project/nginx/src/mail/ngx_mail_handler.c"
                ) {
        return p;
    }
    ...
    if (s->proxy == 
# 1011 "project/nginx/src/mail/ngx_mail_handler.c" 3 4
                   ((void *)0)
# 1011 "project/nginx/src/mail/ngx_mail_handler.c"
                       ) {
        return p;
    }
