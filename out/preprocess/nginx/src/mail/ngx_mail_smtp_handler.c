# 0 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 9 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 2
...
# 10 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 2
...
# 11 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/mail/ngx_mail.h" 1 3 4
# 15 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/mail/ngx_mail.h" 3 4
...
# 12 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/mail/ngx_mail_smtp_module.h" 1 3 4
# 15 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/mail/ngx_mail_smtp_module.h" 3 4
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/mail/ngx_mail_smtp_module.h" 1 3 4
# 16 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/mail/ngx_mail_smtp_module.h" 2 3 4
...
# 13 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 2



# 15 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
static u_char smtp_ok[] = "250 2.0.0 OK" 
# 38 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                         "\r\n"
# 38 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                             ;
static u_char smtp_bye[] = "221 2.0.0 Bye" 
# 39 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                           "\r\n"
# 39 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                               ;
static u_char smtp_starttls[] = "220 2.0.0 Start TLS" 
# 40 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                                      "\r\n"
# 40 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                          ;
static u_char smtp_next[] = "334 " 
# 41 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                   "\r\n"
# 41 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                       ;
static u_char smtp_username[] = "334 VXNlcm5hbWU6" 
# 42 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                                   "\r\n"
# 42 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                       ;
static u_char smtp_password[] = "334 UGFzc3dvcmQ6" 
# 43 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                                   "\r\n"
# 43 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                       ;
static u_char smtp_invalid_command[] = "500 5.5.1 Invalid command" 
# 44 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                                                   "\r\n"
# 44 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                                       ;
static u_char smtp_invalid_pipelining[] =
    "503 5.5.0 Improper use of SMTP command pipelining" 
# 46 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                                       "\r\n"
# 46 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                           ;
static u_char smtp_invalid_argument[] = "501 5.5.4 Invalid argument" 
# 47 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                                                     "\r\n"
# 47 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                                         ;
static u_char smtp_auth_required[] = "530 5.7.1 Authentication required" 
# 48 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                                                         "\r\n"
# 48 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                                             ;
static u_char smtp_bad_sequence[] = "503 5.5.1 Bad sequence of commands" 
# 49 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                                                         "\r\n"
# 49 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                                             ;


static ngx_str_t smtp_unavailable = 
# 52 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                    { sizeof(
# 52 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                    "[UNAVAILABLE]"
# 52 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                    ) - 1, (u_char *) 
# 52 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 52 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                               ;
static ngx_str_t smtp_tempunavail = 
# 53 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                    { sizeof(
# 53 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                    "[TEMPUNAVAIL]"
# 53 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                    ) - 1, (u_char *) 
# 53 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
ngx_mail_smtp_init_session(ngx_mail_session_t *s, ngx_connection_t *c)
{
    ...
    cscf = 
# 62 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          (
# 62 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
          s
# 62 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          )->srv_conf[
# 62 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 62 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
    ...
    if (cscf->resolver == 
# 64 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                         ((void *)0)
# 64 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                             ) {
    ...
    if (c->sockaddr->sa_family == 
# 71 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                 1
# 71 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                        ) {
    ...
    ctx = ngx_resolve_start(cscf->resolver, 
# 80 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                           ((void *)0)
# 80 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                               );
    if (ctx == 
# 81 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              ((void *)0)
# 81 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                  ) {
    ...
    if (ngx_resolve_addr(ctx) != 
# 95 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                0
# 95 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                      ) {
        ngx_mail_close_connection(c);
    }
}
...
# 111 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       if ((
# 111 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       c->log
# 111 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
...
# 111 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       , 
# 111 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       0, "%V could not be resolved (%i: %s)", &c->addr_text, ctx->state, ngx_resolver_strerror(ctx->state)
# 111 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       )


                                                        
# 114 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                       ;

        if (ctx->state == 
# 116 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                         3
# 116 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                             ) {
            s->host = smtp_unavailable;
    ...
    if (s->host.data == 
# 133 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                       ((void *)0)
# 133 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                           ) {
        ngx_resolve_addr_done(ctx);
        ngx_mail_close_connection(c);
        return;
...
# 148 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   if (!(
# 148 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
   c->read
# 148 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   )->posted) { (
# 148 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
ngx_mail_smtp_resolve_name(ngx_event_t *rev)
{
    ...
    cscf = 
# 163 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          (
# 163 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
          s
# 163 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          )->srv_conf[
# 163 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 163 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
    ...
    ctx = ngx_resolve_start(cscf->resolver, 
# 165 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                           ((void *)0)
# 165 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                               );
    if (ctx == 
# 166 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              ((void *)0)
# 166 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                  ) {
        ngx_mail_close_connection(c);
        return;
    }
...
# 179 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                0
# 179 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                      ) {
        ngx_mail_close_connection(c);
    }
}
...
# 196 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       if ((
# 196 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       c->log
# 196 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       )->log_level >= 4) ngx_log_error_core(4, 
# 196 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 199 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                       ;

        if (ctx->state == 
# 201 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                         3
# 201 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                             ) {
            s->host = smtp_unavailable;
...
# 228 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
        for (i = 0; i < ctx->naddrs; i++) {
            if (ngx_cmp_sockaddr(ctx->addrs[i].sockaddr, ctx->addrs[i].socklen,
                                 c->sockaddr, c->socklen, 0)
                == 
# 231 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                  0
# 231 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                        )
            {
                goto found;
            }
...
# 260 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                        0
# 260 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                              ) {
        ...
        if (s->resolver_ctx) {
            ...
            s->resolver_ctx = 
# 272 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                             ((void *)0)
# 272 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                 ;
        }
...
ngx_mail_smtp_greeting(ngx_mail_session_t *s, ngx_connection_t *c)
{
    ...
    cscf = 
# 290 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          (
# 290 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
          s
# 290 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          )->srv_conf[
# 290 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 290 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                               ;
    sscf = 
# 291 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          (
# 291 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
          s
# 291 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          )->srv_conf[
# 291 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 294 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   ngx_event_add_timer
# 294 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                (c->read, timeout);

    if (ngx_handle_read_event(c->read, 0) != 
# 296 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                            0
# 296 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                  ) {
        ngx_mail_close_connection(c);
    }
...
# 301 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       if (!(
# 301 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       c->read
# 301 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       )->posted) { (
# 301 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
ngx_mail_smtp_invalid_pipelining(ngx_event_t *rev)
{
    ...
    if (rev->timedout) {
        ...
        cscf = 
# 336 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              (
# 336 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
              s
# 336 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              )->srv_conf[
# 336 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 340 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       ngx_event_add_timer
# 340 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                    (c->read, cscf->timeout);

        if (ngx_handle_read_event(c->read, 0) != 
# 342 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                                0
# 342 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                      ) {
            ngx_mail_close_connection(c);
            return;
        }
        ...
        sscf = 
# 347 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              (
# 347 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
              s
# 347 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              )->srv_conf[
# 347 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 347 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
        ...
        if (s->buffer == 
# 355 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                        ((void *)0)
# 355 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                            ) {
            if (ngx_mail_smtp_create_buffer(s, c) != 
# 356 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                                    0
# 356 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                          ) {
                return;
            }
        }
        ...
        if (ngx_mail_smtp_discard_command(s, c,
            ...
            != 
# 363 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              0
# 363 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                    )
        {
            return;
        }
...
# 368 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       (
# 368 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       &s->out
# 368 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       )->len = sizeof(
# 368 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 387 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       if ((
# 387 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       c->log
# 387 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
...
# 387 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
    ...
    if (s->buffer == 
# 395 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                    ((void *)0)
# 395 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                        ) {
        if (ngx_mail_smtp_create_buffer(s, c) != 
# 396 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                                0
# 396 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                      ) {
            return;
        }
    }
...
# 413 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                                                  -1
# 413 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                                           ) {
        ngx_mail_session_internal_server_error(s);
        return 
# 415 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              -1
# 415 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                       ;
    }

    sscf = 
# 418 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          (
# 418 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
          s
# 418 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          )->srv_conf[
# 418 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 418 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
    ...
    if (s->buffer == 
# 421 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                    ((void *)0)
# 421 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                        ) {
        ngx_mail_session_internal_server_error(s);
        return 
# 423 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              -1
# 423 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                       ;
    }

    return 
# 426 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          0
# 426 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                ;
}
...
# 443 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       if ((
# 443 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       c->log
# 443 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 443 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 443 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
    ...
    if (s->out.len) {
        ...
        if (ngx_handle_read_event(c->read, 0) != 
# 453 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                                0
# 453 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                      ) {
            ngx_mail_close_connection(c);
            return;
        }
    ...
    if (rc == 
# 465 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
             -2
# 465 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                      ) {
        if (ngx_handle_read_event(c->read, 0) != 
# 466 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                                0
# 466 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                      ) {
            ngx_mail_session_internal_server_error(s);
            return;
        }
    ...
    if (rc == 
# 474 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
             -1
# 474 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                      ) {
        return;
    }

    
# 478 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   (
# 478 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
   &s->out
# 478 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   )->len = sizeof(
# 478 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 478 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
   smtp_ok;
    ...
    if (rc == 
# 480 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
             0
# 480 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                   ) {
        switch (s->mail_state) {
        ...
        case ngx_smtp_start:
            ...
            case 
# 487 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                1
# 487 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                             :
            case 
# 488 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                2
# 488 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                             :
                rc = ngx_mail_smtp_helo(s, c);
                break;

            case 
# 492 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                3
# 492 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                             :
                rc = ngx_mail_smtp_auth(s, c);
                break;

            case 
# 496 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                4
# 496 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                             :
                s->quit = 1;
                
# 498 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
               (
# 498 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
               &s->out
# 498 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
               )->len = sizeof(
# 498 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 498 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
            ...
            case 
# 501 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                6
# 501 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                             :
                rc = ngx_mail_smtp_mail(s, c);
                break;

            case 
# 505 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                8
# 505 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                             :
                rc = ngx_mail_smtp_rcpt(s, c);
                break;

            case 
# 509 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                7
# 509 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                             :
                rc = ngx_mail_smtp_rset(s, c);
                break;

            case 
# 513 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                5
# 513 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                             :
                break;

            case 
# 516 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                13
# 516 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                 :
                rc = ngx_mail_smtp_starttls(s, c);
                
# 518 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
               (
# 518 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
               &s->out
# 518 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
               )->len = sizeof(
# 518 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 518 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
            ...
            default:
                rc = 
# 522 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                    20
# 522 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                  ;
                break;
            }
...
# 531 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
           (
# 531 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
           &s->out
# 531 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
           )->len = sizeof(
# 531 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 531 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
    ...
    case 
# 559 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
        -4
# 559 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                :
        ngx_mail_auth(s, c);
        return;

    case 
# 563 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
        -1
# 563 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                 :
        ngx_mail_session_internal_server_error(s);
        return;

    case 
# 567 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
        20
# 567 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                      :
        s->mail_state = ngx_smtp_start;
        s->state = 0;
        
# 570 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       (
# 570 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       &s->out
# 570 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       )->len = sizeof(
# 570 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 570 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
    ...
    case 
# 574 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
        0
# 574 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
              :
        s->args.nelts = 0;
        ...
        if (ngx_handle_read_event(c->read, 0) != 
# 586 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                                0
# 586 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                      ) {
            ngx_mail_session_internal_server_error(s);
            return;
        }
...
# 603 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       (
# 603 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       &s->out
# 603 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       )->len = sizeof(
# 603 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 603 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       smtp_invalid_argument;
        s->state = 0;
        return 
# 605 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              0
# 605 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                    ;
    }
    ...
    if (s->smtp_helo.data == 
# 613 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                            ((void *)0)
# 613 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                ) {
        return 
# 614 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              -1
# 614 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                       ;
    }

    
# 617 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   (void) __builtin___memcpy_chk (
# 617 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
   s->smtp_helo.data
# 617 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   , 
# 617 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 619 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   (
# 619 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
   &s->smtp_from
# 619 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   )->len = 0; (
# 619 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 620 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   (
# 620 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
   &s->smtp_to
# 620 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   )->len = 0; (
# 620 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 620 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
    ...
    sscf = 
# 622 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          (
# 622 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
          s
# 622 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          )->srv_conf[
# 622 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 622 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
    ...
    if (s->command == 
# 624 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                     1
# 624 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                  ) {
        s->out = sscf->server_name;

    } else {
        s->esmtp = 1;
# 649 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
        s->out = sscf->capability;
    }

    return 
# 652 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          0
# 652 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                ;
}
...
# 670 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       (
# 670 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       &s->out
# 670 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       )->len = sizeof(
# 670 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 670 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       smtp_invalid_argument;
        s->state = 0;
        return 
# 672 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              0
# 672 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                    ;
    }

    sscf = 
# 675 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          (
# 675 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
          s
# 675 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          )->srv_conf[
# 675 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 675 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
    ...
    case 
# 681 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
        1
# 681 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                           :

        
# 683 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       (
# 683 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       &s->out
# 683 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       )->len = sizeof(
# 683 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 683 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       smtp_username;
        ...
        return 
# 686 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              0
# 686 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                    ;

    case 
# 688 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
        2
# 688 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                    :

        
# 690 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       (
# 690 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       &s->out
# 690 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       )->len = sizeof(
# 690 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 690 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
    ...
    case 
# 695 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
        0
# 695 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                           :

        
# 697 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       (
# 697 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       &s->out
# 697 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       )->len = sizeof(
# 697 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 697 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       smtp_next;
        ...
        return 
# 700 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              0
# 700 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                    ;

    case 
# 702 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
        4
# 702 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                              :

        if (!(sscf->auth_methods & 
# 704 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                  0x0010
# 704 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                                )) {
            return 
# 705 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                  20
# 705 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                ;
        }

        if (s->salt.data == 
# 708 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                           ((void *)0)
# 708 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                               ) {
            cscf = 
# 709 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                  (
# 709 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                  s
# 709 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                  )->srv_conf[
# 709 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 709 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
            ...
            if (ngx_mail_salt(s, c, cscf) != 
# 711 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                            0
# 711 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                  ) {
                return 
# 712 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                      -1
# 712 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                               ;
            }
        }

        if (ngx_mail_auth_cram_md5_salt(s, c, "334 ", 4) == 
# 716 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                                           0
# 716 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                                 ) {
            s->mail_state = ngx_smtp_auth_cram_md5;
            return 
# 718 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                  0
# 718 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                        ;
        }

        return 
# 721 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              -1
# 721 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                       ;

    case 
# 723 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
        5
# 723 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                              :

        if (!(sscf->auth_methods & 
# 725 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                  0x0020
# 725 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                                )) {
            return 
# 726 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                  20
# 726 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                ;
        }

        
# 729 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       (
# 729 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       &s->out
# 729 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       )->len = sizeof(
# 729 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 729 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       smtp_username;
        ...
        return 
# 732 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              0
# 732 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                    ;
    }
...
ngx_mail_smtp_mail(ngx_mail_session_t *s, ngx_connection_t *c)
{
    ...
    sscf = 
# 745 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          (
# 745 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
          s
# 745 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          )->srv_conf[
# 745 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 745 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
    ...
    if (!(sscf->auth_methods & 
# 747 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                              0x0040
# 747 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                        )) {
        ngx_mail_smtp_log_rejected_command(s, c, "client was rejected: \"%V\"");
        
# 749 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       (
# 749 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       &s->out
# 749 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       )->len = sizeof(
# 749 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 749 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       smtp_auth_required;
        return 
# 750 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              0
# 750 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                    ;
    }
...
# 756 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       (
# 756 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       &s->out
# 756 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       )->len = sizeof(
# 756 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 756 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       smtp_bad_sequence;
        return 
# 757 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              0
# 757 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                    ;
    }

    if (s->args.nelts == 0) {
        
# 761 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       (
# 761 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       &s->out
# 761 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       )->len = sizeof(
# 761 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 761 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       smtp_invalid_argument;
        return 
# 762 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              0
# 762 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                    ;
    }
    ...
    if (s->smtp_from.data == 
# 774 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                            ((void *)0)
# 774 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                ) {
        return 
# 775 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              -1
# 775 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                       ;
    }

    
# 778 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   (void) __builtin___memcpy_chk (
# 778 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
   s->smtp_from.data
# 778 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   , 
# 778 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 783 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   (
# 783 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
   &s->out
# 783 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   )->len = sizeof(
# 783 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 783 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
   smtp_ok;
    ...
    return 
# 785 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          0
# 785 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                ;
}
...
# 795 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       (
# 795 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       &s->out
# 795 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       )->len = sizeof(
# 795 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 795 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       smtp_bad_sequence;
        return 
# 796 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              0
# 796 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                    ;
    }

    if (s->args.nelts == 0) {
        
# 800 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       (
# 800 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       &s->out
# 800 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
       )->len = sizeof(
# 800 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 800 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
       smtp_invalid_argument;
        return 
# 801 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              0
# 801 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                    ;
    }
    ...
    if (s->smtp_to.data == 
# 813 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                          ((void *)0)
# 813 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                              ) {
        return 
# 814 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              -1
# 814 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                       ;
    }

    
# 817 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   (void) __builtin___memcpy_chk (
# 817 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
   s->smtp_to.data
# 817 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   , 
# 817 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 817 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
    ...
    s->auth_method = 
# 822 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                    6
# 822 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                      ;

    return 
# 824 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          -4
# 824 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                  ;
}
...
# 831 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   (
# 831 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
   &s->smtp_from
# 831 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   )->len = 0; (
# 831 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 832 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   (
# 832 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
   &s->smtp_to
# 832 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   )->len = 0; (
# 832 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 833 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   (
# 833 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
   &s->out
# 833 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   )->len = sizeof(
# 833 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 833 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
   smtp_ok;
    ...
    return 
# 835 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          0
# 835 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                ;
}
...
{
# 868 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
    return 
# 868 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          20
# 868 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                        ;
}
    ...
    char *err)
{
    ...
    if (n == 
# 880 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
            -1 
# 880 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                      || n == 0) {
        ngx_mail_close_connection(c);
        return 
# 882 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              -1
# 882 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                       ;
    }
    ...
    if (n == 
# 889 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
            -2
# 889 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                     ) {
        if (ngx_handle_read_event(c->read, 0) != 
# 890 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                                                0
# 890 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                                      ) {
            ngx_mail_session_internal_server_error(s);
            return 
# 892 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                  -1
# 892 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                           ;
        }

        return 
# 895 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
              -2
# 895 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                       ;
    }
    ...
    return 
# 903 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
          0
# 903 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                ;
}
    ...
    char *err)
{
    ...
    if (c->log->log_level < 
# 915 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                           7
# 915 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                                       ) {
        return;
    }
    ...
    for (i = 0; i < cmd.len; i++) {
        ...
        if (ch != 
# 925 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                 (u_char) '\r' 
# 925 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
                    && ch != 
# 925 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
                             (u_char) '\n'
# 925 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
...
# 934 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   if ((
# 934 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
   c->log
# 934 "project/nginx/src/mail/ngx_mail_smtp_handler.c" 3 4
   )->log_level >= 7) ngx_log_error_core(7, 
# 934 "project/nginx/src/mail/ngx_mail_smtp_handler.c"
