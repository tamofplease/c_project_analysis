# 0 "project/nginx/src/mail/ngx_mail_imap_handler.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 9 "project/nginx/src/mail/ngx_mail_imap_handler.c" 2
...
# 10 "project/nginx/src/mail/ngx_mail_imap_handler.c" 2
...
# 11 "project/nginx/src/mail/ngx_mail_imap_handler.c" 2
...
# 12 "project/nginx/src/mail/ngx_mail_imap_handler.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/mail/ngx_mail_imap_module.h" 1 3 4
# 17 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/mail/ngx_mail_imap_module.h" 3 4
typedef struct {
...
# 13 "project/nginx/src/mail/ngx_mail_imap_handler.c" 2



# 15 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
static u_char imap_greeting[] = "* OK IMAP4 ready" 
# 25 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                                                   "\r\n"
# 25 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                                       ;
static u_char imap_star[] = "* ";
static u_char imap_ok[] = "OK completed" 
# 27 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                                         "\r\n"
# 27 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                             ;
static u_char imap_next[] = "+ OK" 
# 28 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                                   "\r\n"
# 28 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                       ;
static u_char imap_plain_next[] = "+ " 
# 29 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                                       "\r\n"
# 29 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                           ;
static u_char imap_username[] = "+ VXNlcm5hbWU6" 
# 30 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                                                 "\r\n"
# 30 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                                     ;
static u_char imap_password[] = "+ UGFzc3dvcmQ6" 
# 31 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                                                 "\r\n"
# 31 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                                     ;
static u_char imap_bye[] = "* BYE" 
# 32 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                                   "\r\n"
# 32 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                       ;
static u_char imap_invalid_command[] = "BAD invalid command" 
# 33 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                                                             "\r\n"
# 33 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                                                 ;
...
ngx_mail_imap_init_session(ngx_mail_session_t *s, ngx_connection_t *c)
{
    ...
    cscf = 
# 41 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
          (
# 41 "project/nginx/src/mail/ngx_mail_imap_handler.c"
          s
# 41 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
          )->srv_conf[
# 41 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 43 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
   (
# 43 "project/nginx/src/mail/ngx_mail_imap_handler.c"
   &s->out
# 43 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
   )->len = sizeof(
# 43 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 47 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
   ngx_event_add_timer
# 47 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                (c->read, cscf->timeout);

    if (ngx_handle_read_event(c->read, 0) != 
# 49 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                                            0
# 49 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                                  ) {
...
# 69 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
       if ((
# 69 "project/nginx/src/mail/ngx_mail_imap_handler.c"
       c->log
# 69 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
...
# 69 "project/nginx/src/mail/ngx_mail_imap_handler.c"
    ...
    if (s->buffer == 
# 77 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                    ((void *)0)
# 77 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                        ) {
        if (ngx_array_init(&s->args, c->pool, 2, sizeof(ngx_str_t))
            == 
# 79 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
              -1
# 79 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                       )
        {
        ...
        iscf = 
# 85 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
              (
# 85 "project/nginx/src/mail/ngx_mail_imap_handler.c"
              s
# 85 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
              )->srv_conf[
# 85 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 85 "project/nginx/src/mail/ngx_mail_imap_handler.c"
        ...
        if (s->buffer == 
# 88 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                        ((void *)0)
# 88 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                            ) {
            ngx_mail_session_internal_server_error(s);
            return;
        }
...
# 116 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
       if ((
# 116 "project/nginx/src/mail/ngx_mail_imap_handler.c"
       c->log
# 116 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 116 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 116 "project/nginx/src/mail/ngx_mail_imap_handler.c"
    ...
    if (s->out.len) {
        ...
        if (ngx_handle_read_event(c->read, 0) != 
# 126 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                                                0
# 126 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                                      ) {
            ngx_mail_close_connection(c);
            return;
        }
    ...
    if (rc == 
# 138 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
             -2
# 138 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                      ) {
        if (ngx_handle_read_event(c->read, 0) != 
# 139 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                                                0
# 139 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                                      ) {
            ngx_mail_session_internal_server_error(s);
            return;
        }
    ...
    if (rc == 
# 147 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
             -1
# 147 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                      ) {
        return;
    }
...
# 153 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
   (
# 153 "project/nginx/src/mail/ngx_mail_imap_handler.c"
   &s->out
# 153 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
   )->len = sizeof(
# 153 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 153 "project/nginx/src/mail/ngx_mail_imap_handler.c"
   imap_ok;
    ...
    if (rc == 
# 155 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
             0
# 155 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                   ) {
        ...
        case ngx_imap_start:
            ...
            case 
# 166 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                1
# 166 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                              :
                rc = ngx_mail_imap_login(s, c);
                break;

            case 
# 170 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                7
# 170 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                     :
                rc = ngx_mail_imap_authenticate(s, c);
                tag = (rc != 
# 172 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                            0
# 172 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                  );
                break;

            case 
# 175 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                3
# 175 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                   :
                rc = ngx_mail_imap_capability(s, c);
                break;

            case 
# 179 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                2
# 179 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                               :
                s->quit = 1;
                
# 181 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
               (
# 181 "project/nginx/src/mail/ngx_mail_imap_handler.c"
               &s->text
# 181 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
               )->len = sizeof(
# 181 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 181 "project/nginx/src/mail/ngx_mail_imap_handler.c"
            ...
            case 
# 184 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                4
# 184 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                             :
                break;

            case 
# 187 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                5
# 187 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                 :
            ...
            default:
                rc = 
# 192 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                    20
# 192 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                                  ;
                break;
            }
...
# 202 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
           (
# 202 "project/nginx/src/mail/ngx_mail_imap_handler.c"
           &s->out
# 202 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
           )->len = sizeof(
# 202 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 224 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                    6
# 224 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                 ) {
        tag = 0;
        
# 226 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
       (
# 226 "project/nginx/src/mail/ngx_mail_imap_handler.c"
       &s->out
# 226 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
       )->len = sizeof(
# 226 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 226 "project/nginx/src/mail/ngx_mail_imap_handler.c"
    ...
    case 
# 235 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
        -4
# 235 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                :
        ngx_mail_auth(s, c);
        return;

    case 
# 239 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
        -1
# 239 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                 :
        ngx_mail_session_internal_server_error(s);
        return;

    case 
# 243 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
        20
# 243 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                      :
        s->state = 0;
        
# 245 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
       (
# 245 "project/nginx/src/mail/ngx_mail_imap_handler.c"
       &s->out
# 245 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
       )->len = sizeof(
# 245 "project/nginx/src/mail/ngx_mail_imap_handler.c"
       imap_invalid_command
# 245 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
       ) - 1; (
# 245 "project/nginx/src/mail/ngx_mail_imap_handler.c"
       &s->out
...
# 252 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
           (
# 252 "project/nginx/src/mail/ngx_mail_imap_handler.c"
           &s->tag
# 252 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
           )->len = sizeof(
# 252 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 252 "project/nginx/src/mail/ngx_mail_imap_handler.c"
        ...
        if (s->tagged_line.len < s->tag.len + s->text.len + s->out.len) {
            ...
            if (s->tagged_line.data == 
# 258 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                                      ((void *)0)
# 258 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                          ) {
                ngx_mail_close_connection(c);
                return;
            }
        ...
        if (s->text.len) {
            p = 
# 267 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
               (((u_char *) __builtin___memcpy_chk (
# 267 "project/nginx/src/mail/ngx_mail_imap_handler.c"
               p
# 267 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
               , 
# 267 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 267 "project/nginx/src/mail/ngx_mail_imap_handler.c"
        ...
        p = 
# 270 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
           (((u_char *) __builtin___memcpy_chk (
# 270 "project/nginx/src/mail/ngx_mail_imap_handler.c"
           p
# 270 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
           , 
# 270 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 271 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
       (void) __builtin___memcpy_chk (
# 271 "project/nginx/src/mail/ngx_mail_imap_handler.c"
       p
# 271 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
       , 
# 271 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 271 "project/nginx/src/mail/ngx_mail_imap_handler.c"
    ...
    if (rc != 
# 277 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
             6
# 277 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                          ) {
        s->args.nelts = 0;
    ...
    if (ngx_handle_read_event(c->read, 0) != 
# 294 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                                            0
# 294 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                                  ) {
        ngx_mail_session_internal_server_error(s);
        return;
    }
...
ngx_mail_imap_login(ngx_mail_session_t *s, ngx_connection_t *c)
{
    ...
    if (s->args.nelts != 2 || arg[0].len == 0) {
        return 
# 317 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
              20
# 317 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                            ;
    }
    ...
    if (s->login.data == 
# 322 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                        ((void *)0)
# 322 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                            ) {
        return 
# 323 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
              -1
# 323 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                       ;
    }

    
# 326 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
   (void) __builtin___memcpy_chk (
# 326 "project/nginx/src/mail/ngx_mail_imap_handler.c"
   s->login.data
# 326 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
   , 
# 326 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 326 "project/nginx/src/mail/ngx_mail_imap_handler.c"
    ...
    if (s->passwd.data == 
# 330 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                         ((void *)0)
# 330 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                             ) {
        return 
# 331 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
              -1
# 331 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                       ;
    }

    
# 334 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
   (void) __builtin___memcpy_chk (
# 334 "project/nginx/src/mail/ngx_mail_imap_handler.c"
   s->passwd.data
# 334 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
   , 
# 334 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 334 "project/nginx/src/mail/ngx_mail_imap_handler.c"
    ...
    return 
# 345 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
          -4
# 345 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                  ;
}
...
ngx_mail_imap_authenticate(ngx_mail_session_t *s, ngx_connection_t *c)
{
    ...
    iscf = 
# 362 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
          (
# 362 "project/nginx/src/mail/ngx_mail_imap_handler.c"
          s
# 362 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
          )->srv_conf[
# 362 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 362 "project/nginx/src/mail/ngx_mail_imap_handler.c"
    ...
    case 
# 368 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
        1
# 368 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                           :

        
# 370 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
       (
# 370 "project/nginx/src/mail/ngx_mail_imap_handler.c"
       &s->out
# 370 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
       )->len = sizeof(
# 370 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 370 "project/nginx/src/mail/ngx_mail_imap_handler.c"
       imap_username;
        ...
        return 
# 373 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
              0
# 373 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                    ;

    case 
# 375 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
        2
# 375 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                    :

        
# 377 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
       (
# 377 "project/nginx/src/mail/ngx_mail_imap_handler.c"
       &s->out
# 377 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
       )->len = sizeof(
# 377 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 377 "project/nginx/src/mail/ngx_mail_imap_handler.c"
    ...
    case 
# 382 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
        0
# 382 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                           :

        
# 384 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
       (
# 384 "project/nginx/src/mail/ngx_mail_imap_handler.c"
       &s->out
# 384 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
       )->len = sizeof(
# 384 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 384 "project/nginx/src/mail/ngx_mail_imap_handler.c"
       imap_plain_next;
        ...
        return 
# 387 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
              0
# 387 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                    ;

    case 
# 389 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
        4
# 389 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                              :

        if (!(iscf->auth_methods & 
# 391 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                                  0x0010
# 391 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                                                )) {
            return 
# 392 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                  20
# 392 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                                ;
        }

        if (s->salt.data == 
# 395 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                           ((void *)0)
# 395 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                               ) {
            cscf = 
# 396 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                  (
# 396 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                  s
# 396 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                  )->srv_conf[
# 396 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 398 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                                            0
# 398 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                                  ) {
                return 
# 399 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                      -1
# 399 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                               ;
            }
        }

        if (ngx_mail_auth_cram_md5_salt(s, c, "+ ", 2) == 
# 403 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                                                         0
# 403 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                                               ) {
            s->mail_state = ngx_imap_auth_cram_md5;
            return 
# 405 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                  0
# 405 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                        ;
        }

        return 
# 408 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
              -1
# 408 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                       ;

    case 
# 410 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
        5
# 410 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                              :

        if (!(iscf->auth_methods & 
# 412 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                                  0x0020
# 412 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                                                )) {
            return 
# 413 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
                  20
# 413 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                                ;
        }

        
# 416 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
       (
# 416 "project/nginx/src/mail/ngx_mail_imap_handler.c"
       &s->out
# 416 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
       )->len = sizeof(
# 416 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 416 "project/nginx/src/mail/ngx_mail_imap_handler.c"
       imap_username;
        ...
        return 
# 419 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
              0
# 419 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                    ;
    }
...
ngx_mail_imap_capability(ngx_mail_session_t *s, ngx_connection_t *c)
{
    ...
    iscf = 
# 431 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
          (
# 431 "project/nginx/src/mail/ngx_mail_imap_handler.c"
          s
# 431 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
          )->srv_conf[
# 431 "project/nginx/src/mail/ngx_mail_imap_handler.c"
...
# 431 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                                               ;
# 452 "project/nginx/src/mail/ngx_mail_imap_handler.c"
    s->text = iscf->capability;

    return 
# 454 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
          0
# 454 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                ;
}
...
{
# 476 "project/nginx/src/mail/ngx_mail_imap_handler.c"
    return 
# 476 "project/nginx/src/mail/ngx_mail_imap_handler.c" 3 4
          20
# 476 "project/nginx/src/mail/ngx_mail_imap_handler.c"
                                        ;
}
