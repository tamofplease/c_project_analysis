# 0 "project/nginx/src/os/unix/ngx_channel.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/unix/ngx_channel.h"
# 12 "project/nginx/src/os/unix/ngx_channel.h"
...
# 13 "project/nginx/src/os/unix/ngx_channel.h" 2
...
# 14 "project/nginx/src/os/unix/ngx_channel.h" 2
...
# 15 "project/nginx/src/os/unix/ngx_channel.h" 2



# 17 "project/nginx/src/os/unix/ngx_channel.h"
typedef struct {
    ngx_uint_t command;
    ngx_pid_t pid;
    ngx_int_t slot;
