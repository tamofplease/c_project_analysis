# 0 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
...
# 9 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 2
...
# 11 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 2



# 13 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
static ssize_t ngx_linux_sendfile(ngx_connection_t *c, ngx_buf_t *file,
    size_t size);
# 49 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
ngx_chain_t *
ngx_linux_sendfile_chain(ngx_connection_t *c, ngx_chain_t *in, off_t limit)
{
    ...
    ngx_iovec_t header;
    struct iovec headers[
# 61 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                          64
# 61 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                                              ];
    ...
    if (limit == 0 || limit > (off_t) (2147483647L - ngx_pagesize)) {
        limit = 2147483647L - ngx_pagesize;
    }
    ...
    header.iovs = headers;
    header.nalloc = 
# 80 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                   64
# 80 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                                       ;
    ...
    for ( ;; ) {
        ...
        if (cl == 
# 89 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                 (ngx_chain_t *) -1
# 89 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                                ) {
            return 
# 90 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                  (ngx_chain_t *) -1
# 90 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                                 ;
        }
            ...
            && cl->buf->in_file)
        {
            ...
            if (c->tcp_nodelay == NGX_TCP_NODELAY_SET) {
                ...
                if (setsockopt(c->fd, 
# 108 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                                     6
# 108 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                                                , 
# 108 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                                                  0x01
# 108 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                ...
                {
                    err = 
# 111 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                         (*__error())
# 111 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                                         ;
                    ...
                    if (err != 
# 119 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                              4
# 119 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                                       ) {
                        wev->error = 1;
                        ngx_connection_error(c, err,
                                             "setsockopt(TCP_NODELAY) failed");
                        return 
# 123 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                              (ngx_chain_t *) -1
# 123 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                                             ;
                    }
            ...
            if (c->tcp_nodelay == NGX_TCP_NODELAY_UNSET) {
                ...
                if (ngx_tcp_nopush(c->fd) == -1) {
                    err = 
# 137 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                         (*__error())
# 137 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                                         ;
                    ...
                    if (err != 
# 144 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                              4
# 144 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                                       ) {
                        wev->error = 1;
                        ngx_connection_error(c, err,
                                             
# 147 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                                            "setsockopt(TCP_NOPUSH)" 
# 147 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                                                             " failed");
                        return 
# 148 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                              (ngx_chain_t *) -1
# 148 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                                             ;
                    }
        ...
        if (header.count == 0 && cl && cl->buf->in_file && send < limit) {
            ...
            if (file_size == 0) {
                ngx_debug_point();
                return 
# 173 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                      (ngx_chain_t *) -1
# 173 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                                     ;
            }
            ...
            if (n == 
# 179 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                    -1
# 179 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                             ) {
                return 
# 180 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                      (ngx_chain_t *) -1
# 180 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                                     ;
            }

            if (n == 
# 183 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                    -4
# 183 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                            ) {
            ...
            sent = (n == 
# 188 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                        -2
# 188 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                                 ) ? 0 : n;
            ...
            if (n == 
# 193 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                    -1
# 193 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                             ) {
                return 
# 194 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                      (ngx_chain_t *) -1
# 194 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                                     ;
            }

            sent = (n == 
# 197 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                        -2
# 197 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                                 ) ? 0 : n;
        }
        ...
        if (n == 
# 204 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                -2
# 204 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                         ) {
            wev->ready = 0;
            return in;
        }
...
# 221 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
            send = prev_send + sent;
        }

        if (send >= limit || in == 
# 224 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                                  ((void *)0)
# 224 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                                      ) {
            return in;
        }
    }
...
ngx_linux_sendfile(ngx_connection_t *c, ngx_buf_t *file, size_t size)
{
    ...
    ssize_t n;
    ngx_err_t err;
# 253 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
...
eintr:
    ...
    if (n == -1) {
        err = 
# 264 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
             (*__error())
# 264 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                      ;

        switch (err) {
        case 
# 267 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
            35
# 267 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                      :
           
                                                     ;
            return 
# 270 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                  -2
# 270 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                           ;

        case 
# 272 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
            4
# 272 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                     :
        ...
        default:
            ...
            return 
# 280 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
                  -1
# 280 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                           ;
        }
    }
...
# 290 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
       if ((
# 290 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
       c->log
# 290 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
...
# 290 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
       , 
# 290 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
       0, "sendfile() reported that \"%s\" was truncated at %O", file->file->name.data, file->file_pos
# 290 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
       )

                                                            
# 292 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                                                           ;

        return 
# 294 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c" 3 4
              -1
# 294 "project/nginx/src/os/unix/ngx_linux_sendfile_chain.c"
                       ;
    }
