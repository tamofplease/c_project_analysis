# 0 "project/nginx/src/os/unix/ngx_time.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/unix/ngx_time.h"
# 12 "project/nginx/src/os/unix/ngx_time.h"
...
# 13 "project/nginx/src/os/unix/ngx_time.h" 2
...
# 14 "project/nginx/src/os/unix/ngx_time.h" 2



# 16 "project/nginx/src/os/unix/ngx_time.h"
typedef ngx_rbtree_key_t ngx_msec_t;
typedef ngx_rbtree_key_int_t ngx_msec_int_t;

typedef struct tm ngx_tm_t;
# 56 "project/nginx/src/os/unix/ngx_time.h"
