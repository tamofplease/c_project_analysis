# 0 "project/nginx/src/os/unix/ngx_process_cycle.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 9 "project/nginx/src/os/unix/ngx_process_cycle.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_process_cycle.c" 2
...
# 11 "project/nginx/src/os/unix/ngx_process_cycle.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/os/unix/ngx_channel.h" 1 3 4
# 17 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/os/unix/ngx_channel.h" 3 4
typedef struct {
    ngx_uint_t command;
    ngx_pid_t pid;
    ngx_int_t slot;
...
# 12 "project/nginx/src/os/unix/ngx_process_cycle.c" 2



# 14 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 87 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   (*(
# 87 "project/nginx/src/os/unix/ngx_process_cycle.c"
   &set
# 87 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   ) = 0, 0)
# 87 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 88 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   (*(
# 88 "project/nginx/src/os/unix/ngx_process_cycle.c"
   &set
# 88 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   ) |= __sigbits(20), 0)
# 88 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 89 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   (*(
# 89 "project/nginx/src/os/unix/ngx_process_cycle.c"
   &set
# 89 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   ) |= __sigbits(14), 0)
# 89 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 90 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   (*(
# 90 "project/nginx/src/os/unix/ngx_process_cycle.c"
   &set
# 90 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   ) |= __sigbits(23), 0)
# 90 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 91 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   (*(
# 91 "project/nginx/src/os/unix/ngx_process_cycle.c"
   &set
# 91 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   ) |= __sigbits(2), 0)
# 91 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 92 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   (*(
# 92 "project/nginx/src/os/unix/ngx_process_cycle.c"
   &set
# 92 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   ) |= __sigbits(1), 0)
# 92 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 93 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   (*(
# 93 "project/nginx/src/os/unix/ngx_process_cycle.c"
   &set
# 93 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   ) |= __sigbits(30), 0)
# 93 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 94 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   (*(
# 94 "project/nginx/src/os/unix/ngx_process_cycle.c"
   &set
# 94 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   ) |= __sigbits(28), 0)
# 94 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 95 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   (*(
# 95 "project/nginx/src/os/unix/ngx_process_cycle.c"
   &set
# 95 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   ) |= __sigbits(15), 0)
# 95 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 96 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   (*(
# 96 "project/nginx/src/os/unix/ngx_process_cycle.c"
   &set
# 96 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   ) |= __sigbits(3), 0)
# 96 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 97 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   (*(
# 97 "project/nginx/src/os/unix/ngx_process_cycle.c"
   &set
# 97 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   ) |= __sigbits(31), 0)
# 97 "project/nginx/src/os/unix/ngx_process_cycle.c"
    ...
    if (sigprocmask(
# 99 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                   1
# 99 "project/nginx/src/os/unix/ngx_process_cycle.c"
                            , &set, 
# 99 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                    ((void *)0)
# 99 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 100 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
       if ((
# 100 "project/nginx/src/os/unix/ngx_process_cycle.c"
       cycle->log
# 100 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
...
# 101 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                            ;
    }

    
# 104 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   (*(
# 104 "project/nginx/src/os/unix/ngx_process_cycle.c"
   &set
# 104 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   ) = 0, 0)
# 104 "project/nginx/src/os/unix/ngx_process_cycle.c"
    ...
    for (i = 0; i < ngx_argc; i++) {
        size += 
# 110 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
               strlen((const char *) 
# 110 "project/nginx/src/os/unix/ngx_process_cycle.c"
               ngx_argv[i]
# 110 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
               ) 
# 110 "project/nginx/src/os/unix/ngx_process_cycle.c"
    ...
    if (title == 
# 114 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                ((void *)0)
# 114 "project/nginx/src/os/unix/ngx_process_cycle.c"
                    ) {
    ...
    p = 
# 119 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 119 "project/nginx/src/os/unix/ngx_process_cycle.c"
       title
# 119 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
       , 
# 119 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 128 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                             [
# 128 "project/nginx/src/os/unix/ngx_process_cycle.c"
                             ngx_core_module
# 128 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                             .index]
# 128 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 131 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                              -3
# 131 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                 );
    ...
    for ( ;; ) {
        if (delay) {
            ...
            if (setitimer(
# 155 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                         0
# 155 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                    , &itv, 
# 155 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                            ((void *)0)
# 155 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 156 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
               if ((
# 156 "project/nginx/src/os/unix/ngx_process_cycle.c"
               cycle->log
# 156 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 156 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 157 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                  ;
            }
        }
...
# 194 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                                  9
# 194 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                         );
            } else {
                ngx_signal_worker_processes(cycle,
                                       
# 197 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                      15
# 197 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                                            );
            }
...
# 205 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                       3
# 205 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                                            );
...
# 216 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                          -3
# 216 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                             );
                ngx_start_cache_manager_processes(cycle, 0);
                ngx_noaccepting = 0;
...
# 223 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           if ((
# 223 "project/nginx/src/os/unix/ngx_process_cycle.c"
           cycle->log
# 223 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
...
# 223 "project/nginx/src/os/unix/ngx_process_cycle.c"
            ...
            if (cycle == 
# 226 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                        ((void *)0)
# 226 "project/nginx/src/os/unix/ngx_process_cycle.c"
                            ) {
            ...
            ngx_cycle = cycle;
            ccf = (ngx_core_conf_t *) cycle->conf_ctx
# 232 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                     [
# 232 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                     ngx_core_module
# 232 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                     .index]
                                                                   
# 233 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                                  ;
            ngx_start_worker_processes(cycle, ccf->worker_processes,
                                       
# 235 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                      -4
# 235 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                              );
            ngx_start_cache_manager_processes(cycle, 1);


            
# 239 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           (void) usleep(
# 239 "project/nginx/src/os/unix/ngx_process_cycle.c"
           100 
# 239 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           * 1000)
# 239 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 243 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                       3
# 243 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                                            );
        }
...
# 249 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                      -3
# 249 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                         );
            ngx_start_cache_manager_processes(cycle, 0);
            live = 1;
        }
...
# 256 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           if ((
# 256 "project/nginx/src/os/unix/ngx_process_cycle.c"
           cycle->log
# 256 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           )->log_level >= 6) ngx_log_error_core(6, 
# 256 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 259 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                       30
# 259 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                                          );
        }
...
# 264 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           if ((
# 264 "project/nginx/src/os/unix/ngx_process_cycle.c"
           cycle->log
# 264 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           )->log_level >= 6) ngx_log_error_core(6, 
# 264 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 272 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                       3
# 272 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                                            );
        }
    }
}
...
ngx_single_process_cycle(ngx_cycle_t *cycle)
{
    ...
    if (ngx_set_environment(cycle, 
# 283 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                  ((void *)0)
# 283 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                      ) == 
# 283 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                           ((void *)0)
# 283 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 290 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                                         -1
# 290 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                                  ) {
...
# 315 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           if ((
# 315 "project/nginx/src/os/unix/ngx_process_cycle.c"
           cycle->log
# 315 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           )->log_level >= 6) ngx_log_error_core(6, 
# 315 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 315 "project/nginx/src/os/unix/ngx_process_cycle.c"
            ...
            cycle = ngx_init_cycle(cycle);
            if (cycle == 
# 318 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                        ((void *)0)
# 318 "project/nginx/src/os/unix/ngx_process_cycle.c"
                            ) {
                cycle = (ngx_cycle_t *) ngx_cycle;
                continue;
            }
...
# 328 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           if ((
# 328 "project/nginx/src/os/unix/ngx_process_cycle.c"
           cycle->log
# 328 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           )->log_level >= 6) ngx_log_error_core(6, 
# 328 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 340 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   if ((
# 340 "project/nginx/src/os/unix/ngx_process_cycle.c"
   cycle->log
# 340 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   )->log_level >= 6) ngx_log_error_core(6, 
# 340 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
ngx_start_cache_manager_processes(ngx_cycle_t *cycle, ngx_uint_t respawn)
{
    ...
    ngx_spawn_process(cycle, ngx_cache_manager_process_cycle,
                      ...
                      respawn ? 
# 379 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                               -4 
# 379 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                        : 
# 379 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                                          -3
# 379 "project/nginx/src/os/unix/ngx_process_cycle.c"
    ...
    ngx_spawn_process(cycle, ngx_cache_manager_process_cycle,
                      ...
                      respawn ? 
# 389 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                               -2 
# 389 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                      : 
# 389 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                                        -1
# 389 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 401 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   (void) __builtin___memset_chk (
# 401 "project/nginx/src/os/unix/ngx_process_cycle.c"
   &ch
# 401 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   , 0, 
# 401 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 401 "project/nginx/src/os/unix/ngx_process_cycle.c"
    ...
    ch.command = 
# 403 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                1
# 403 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                    ;
...
# 438 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   (void) __builtin___memset_chk (
# 438 "project/nginx/src/os/unix/ngx_process_cycle.c"
   &ch
# 438 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   , 0, 
# 438 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 438 "project/nginx/src/os/unix/ngx_process_cycle.c"
    ...
    case 
# 448 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
        3
# 448 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                             :
        ch.command = 
# 449 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                    3
# 449 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                ;
        break;

    case 
# 452 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
        15
# 452 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                              :
        ch.command = 
# 453 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                    4
# 453 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                     ;
        break;

    case 
# 456 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
        30
# 456 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                           :
        ch.command = 
# 457 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                    5
# 457 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                  ;
        break;
    ...
    for (i = 0; i < ngx_last_process; i++) {
        ...
        if (ngx_processes[i].exiting
            && signo == 
# 491 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                       3
# 491 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                            )
        {
            continue;
        }
        ...
        if (ch.command) {
            if (ngx_write_channel(ngx_processes[i].channel[0],
                                  &ch, sizeof(ngx_channel_t), cycle->log)
                == 
# 499 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                  0
# 499 "project/nginx/src/os/unix/ngx_process_cycle.c"
                        )
            {
                if (signo != 
# 501 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                            30
# 501 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                               ) {
        ...
        if (kill(ngx_processes[i].pid, signo) == -1) {
            err = 
# 513 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                 (*__error())
# 513 "project/nginx/src/os/unix/ngx_process_cycle.c"
                          ;
            
# 514 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           if ((
# 514 "project/nginx/src/os/unix/ngx_process_cycle.c"
           cycle->log
# 514 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 514 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 514 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           , 
# 514 "project/nginx/src/os/unix/ngx_process_cycle.c"
           err, "kill(%P, %d) failed", ngx_processes[i].pid, signo
# 514 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           )
                                                                             
# 515 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                                            ;

            if (err == 
# 517 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                      3
# 517 "project/nginx/src/os/unix/ngx_process_cycle.c"
                               ) {
        ...
        if (signo != 
# 526 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                    30
# 526 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                       ) {
            ngx_processes[i].exiting = 1;
        }
    }
...
# 541 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   (void) __builtin___memset_chk (
# 541 "project/nginx/src/os/unix/ngx_process_cycle.c"
   &ch
# 541 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   , 0, 
# 541 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 541 "project/nginx/src/os/unix/ngx_process_cycle.c"
    ...
    ch.command = 
# 543 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                2
# 543 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                     ;
    ch.fd = -1;
        ...
        if (ngx_processes[i].exited) {
                ...
                && !ngx_quit)
            {
                if (ngx_spawn_process(cycle, ngx_processes[i].proc,
                    ...
                    == 
# 601 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                      -1
# 601 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                     )
                {
                    
# 603 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                   if ((
# 603 "project/nginx/src/os/unix/ngx_process_cycle.c"
                   cycle->log
# 603 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                   )->log_level >= 2) ngx_log_error_core(2, 
# 603 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 603 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                   , 
# 603 "project/nginx/src/os/unix/ngx_process_cycle.c"
                   0, "could not respawn %s", ngx_processes[i].name
# 603 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                   )

                                                        
# 605 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                       ;
                    continue;
                }
            ...
            if (ngx_processes[i].pid == ngx_new_binary) {
                ...
                ccf = (ngx_core_conf_t *) cycle->conf_ctx
# 619 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                         [
# 619 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                         ngx_core_module
# 619 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                         .index]
                                                                       
# 620 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                                      ;

                if (
# 622 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                   rename((const char *) 
# 622 "project/nginx/src/os/unix/ngx_process_cycle.c"
                   (char *) ccf->oldpid.data
# 622 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                   , (const char *) 
# 622 "project/nginx/src/os/unix/ngx_process_cycle.c"
                   (char *) ccf->pid.data
...
# 624 "project/nginx/src/os/unix/ngx_process_cycle.c"
                   == 
# 624 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                      -1
# 624 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                    )
                {
                    
# 626 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                   if ((
# 626 "project/nginx/src/os/unix/ngx_process_cycle.c"
                   cycle->log
# 626 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                   )->log_level >= 2) ngx_log_error_core(2, 
# 626 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 626 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                   "rename()" 
# 626 "project/nginx/src/os/unix/ngx_process_cycle.c"
                   " %s back to %s failed " "after the new binary process \"%s\" exited", ccf->oldpid.data, ccf->pid.data, ngx_argv[0]
# 626 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                   )


                                                                               
# 629 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                                              ;
                }
...
# 662 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   if ((
# 662 "project/nginx/src/os/unix/ngx_process_cycle.c"
   cycle->log
# 662 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   )->log_level >= 6) ngx_log_error_core(6, 
# 662 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 662 "project/nginx/src/os/unix/ngx_process_cycle.c"
    ...
    ngx_close_listening_sockets(cycle);
# 680 "project/nginx/src/os/unix/ngx_process_cycle.c"
    ngx_exit_log = *ngx_log_get_file_log(ngx_cycle->log);

    ngx_exit_log_file.fd = ngx_exit_log.file->fd;
    ngx_exit_log.file = &ngx_exit_log_file;
    ngx_exit_log.next = 
# 684 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                       ((void *)0)
# 684 "project/nginx/src/os/unix/ngx_process_cycle.c"
                           ;
    ngx_exit_log.writer = 
# 685 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                         ((void *)0)
# 685 "project/nginx/src/os/unix/ngx_process_cycle.c"
                             ;
...
ngx_worker_process_cycle(ngx_cycle_t *cycle, void *data)
{
    ...
    ngx_process = 
# 703 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                 3
# 703 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                   ;
    ngx_worker = worker;
...
# 713 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                             0
# 713 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                   ) {
                
# 714 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
               if ((
# 714 "project/nginx/src/os/unix/ngx_process_cycle.c"
               cycle->log
# 714 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
               )->log_level >= 6) ngx_log_error_core(6, 
# 714 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 724 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           if ((
# 724 "project/nginx/src/os/unix/ngx_process_cycle.c"
           cycle->log
# 724 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           )->log_level >= 6) ngx_log_error_core(6, 
# 724 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 730 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           if ((
# 730 "project/nginx/src/os/unix/ngx_process_cycle.c"
           cycle->log
# 730 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           )->log_level >= 6) ngx_log_error_core(6, 
# 730 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 731 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                    ;
...
# 744 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           if ((
# 744 "project/nginx/src/os/unix/ngx_process_cycle.c"
           cycle->log
# 744 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           )->log_level >= 6) ngx_log_error_core(6, 
# 744 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
ngx_worker_process_init(ngx_cycle_t *cycle, ngx_int_t worker)
{
    ...
    if (ngx_set_environment(cycle, 
# 763 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                  ((void *)0)
# 763 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                      ) == 
# 763 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                           ((void *)0)
# 763 "project/nginx/src/os/unix/ngx_process_cycle.c"
    ...
    ccf = (ngx_core_conf_t *) cycle->conf_ctx
# 768 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                             [
# 768 "project/nginx/src/os/unix/ngx_process_cycle.c"
                             ngx_core_module
# 768 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                             .index]
# 768 "project/nginx/src/os/unix/ngx_process_cycle.c"
    ...
    if (worker >= 0 && ccf->priority != 0) {
        if (setpriority(
# 771 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                       0
# 771 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                   , 0, ccf->priority) == -1) {
            
# 772 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           if ((
# 772 "project/nginx/src/os/unix/ngx_process_cycle.c"
           cycle->log
# 772 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 772 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 773 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                                 ;
        }
    }

    if (ccf->rlimit_nofile != 
# 777 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                             -1
# 777 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                           ) {
        rlmt.rlim_cur = (rlim_t) ccf->rlimit_nofile;
        rlmt.rlim_max = (rlim_t) ccf->rlimit_nofile;

        if (setrlimit(
# 781 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                     8
# 781 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                  , &rlmt) == -1) {
            
# 782 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           if ((
# 782 "project/nginx/src/os/unix/ngx_process_cycle.c"
           cycle->log
# 782 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 782 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 784 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                            ;
        }
    }

    if (ccf->rlimit_core != 
# 788 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                           -1
# 788 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                         ) {
        rlmt.rlim_cur = (rlim_t) ccf->rlimit_core;
        rlmt.rlim_max = (rlim_t) ccf->rlimit_core;

        if (setrlimit(
# 792 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                     4
# 792 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                , &rlmt) == -1) {
            
# 793 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           if ((
# 793 "project/nginx/src/os/unix/ngx_process_cycle.c"
           cycle->log
# 793 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 793 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 795 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                          ;
        }
    }
...
# 801 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           if ((
# 801 "project/nginx/src/os/unix/ngx_process_cycle.c"
           cycle->log
# 801 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
...
# 802 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                         ;
...
# 808 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           if ((
# 808 "project/nginx/src/os/unix/ngx_process_cycle.c"
           cycle->log
# 808 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 808 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 810 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                   ;
        }
# 824 "project/nginx/src/os/unix/ngx_process_cycle.c"
        if (setuid(ccf->user) == -1) {
            
# 825 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           if ((
# 825 "project/nginx/src/os/unix/ngx_process_cycle.c"
           cycle->log
# 825 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 825 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 826 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                        ;

            exit(2);
        }
# 851 "project/nginx/src/os/unix/ngx_process_cycle.c"
    }
...
# 872 "project/nginx/src/os/unix/ngx_process_cycle.c"
    if (ccf->working_directory.len) {
        if (chdir((char *) ccf->working_directory.data) == -1) {
            
# 874 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           if ((
# 874 "project/nginx/src/os/unix/ngx_process_cycle.c"
           cycle->log
# 874 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 874 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 875 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                                             ;
...
# 881 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   (*(
# 881 "project/nginx/src/os/unix/ngx_process_cycle.c"
   &set
# 881 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   ) = 0, 0)
# 881 "project/nginx/src/os/unix/ngx_process_cycle.c"
    ...
    if (sigprocmask(
# 883 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                   3
# 883 "project/nginx/src/os/unix/ngx_process_cycle.c"
                              , &set, 
# 883 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                      ((void *)0)
# 883 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 884 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
       if ((
# 884 "project/nginx/src/os/unix/ngx_process_cycle.c"
       cycle->log
# 884 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 884 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 885 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                            ;
    }

    tp = 
# 888 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
        (ngx_time_t *) ngx_cached_time
# 888 "project/nginx/src/os/unix/ngx_process_cycle.c"
                       ;
    ...
    for (i = 0; i < cycle->listening.nelts; i++) {
        ls[i].previous = 
# 897 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                        ((void *)0)
# 897 "project/nginx/src/os/unix/ngx_process_cycle.c"
                            ;
    }
    ...
    for (i = 0; cycle->modules[i]; i++) {
        if (cycle->modules[i]->init_process) {
            if (cycle->modules[i]->init_process(cycle) == 
# 902 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                                         -1
# 902 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                                  ) {
...
# 924 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           if ((
# 924 "project/nginx/src/os/unix/ngx_process_cycle.c"
           cycle->log
# 924 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 924 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 925 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                  ;
        }
    }
...
# 930 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
       if ((
# 930 "project/nginx/src/os/unix/ngx_process_cycle.c"
       cycle->log
# 930 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 930 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 931 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                              ;
    }
...
# 938 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                                 (-1)
# 938 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                               ,
                              ngx_channel_handler)
        == 
# 940 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
          -1
# 940 "project/nginx/src/os/unix/ngx_process_cycle.c"
                   )
    {
...
# 969 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
               if ((
# 969 "project/nginx/src/os/unix/ngx_process_cycle.c"
               cycle->log
# 969 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 969 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 971 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                     ;
                ngx_debug_quit = 1;
            }
        }
...
# 977 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           if ((
# 977 "project/nginx/src/os/unix/ngx_process_cycle.c"
           cycle->log
# 977 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 977 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 989 "project/nginx/src/os/unix/ngx_process_cycle.c"
    ngx_exit_log = *ngx_log_get_file_log(ngx_cycle->log);

    ngx_exit_log_file.fd = ngx_exit_log.file->fd;
    ngx_exit_log.file = &ngx_exit_log_file;
    ngx_exit_log.next = 
# 993 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                       ((void *)0)
# 993 "project/nginx/src/os/unix/ngx_process_cycle.c"
                           ;
    ngx_exit_log.writer = 
# 994 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                         ((void *)0)
# 994 "project/nginx/src/os/unix/ngx_process_cycle.c"
                             ;
...
# 1003 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   if ((
# 1003 "project/nginx/src/os/unix/ngx_process_cycle.c"
   ngx_cycle->log
# 1003 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   )->log_level >= 6) ngx_log_error_core(6, 
# 1003 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
ngx_channel_handler(ngx_event_t *ev)
{
    ...
    for ( ;; ) {
        ...
        if (n == 
# 1031 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                -1
# 1031 "project/nginx/src/os/unix/ngx_process_cycle.c"
                         ) {

            if (ngx_event_flags & 
# 1033 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                 0x00000040
# 1033 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                    ) {
                
# 1034 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
               ngx_event_actions.del_conn
# 1034 "project/nginx/src/os/unix/ngx_process_cycle.c"
                           (c, 0);
            }
        ...
        if (ngx_event_flags & 
# 1041 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                             0x00001000
# 1041 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                    ) {
            if (
# 1042 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
               ngx_event_actions.add
# 1042 "project/nginx/src/os/unix/ngx_process_cycle.c"
                            (ev, 
# 1042 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                                 (-1)
# 1042 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 1042 "project/nginx/src/os/unix/ngx_process_cycle.c"
        ...
        if (n == 
# 1047 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                -2
# 1047 "project/nginx/src/os/unix/ngx_process_cycle.c"
                         ) {
            return;
        }
        ...
        case 
# 1056 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
            3
# 1056 "project/nginx/src/os/unix/ngx_process_cycle.c"
                        :
            ngx_quit = 1;
            break;

        case 
# 1060 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
            4
# 1060 "project/nginx/src/os/unix/ngx_process_cycle.c"
                             :
            ngx_terminate = 1;
            break;

        case 
# 1064 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
            5
# 1064 "project/nginx/src/os/unix/ngx_process_cycle.c"
                          :
            ngx_reopen = 1;
            break;

        case 
# 1068 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
            1
# 1068 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                :
        ...
        case 
# 1078 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
            2
# 1078 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                 :
...
# 1086 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
               if ((
# 1086 "project/nginx/src/os/unix/ngx_process_cycle.c"
               ev->log
# 1086 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 1086 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 1087 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                                      ;
            }
...
ngx_cache_manager_process_cycle(ngx_cycle_t *cycle, void *data)
{
    ...
    ngx_process = 
# 1109 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
                 4
# 1109 "project/nginx/src/os/unix/ngx_process_cycle.c"
                                   ;
...
# 1118 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   (void) __builtin___memset_chk (
# 1118 "project/nginx/src/os/unix/ngx_process_cycle.c"
   &ev
# 1118 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   , 0, 
# 1118 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 1128 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   ngx_event_add_timer
# 1128 "project/nginx/src/os/unix/ngx_process_cycle.c"
                (&ev, ctx->delay);
...
# 1133 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           if ((
# 1133 "project/nginx/src/os/unix/ngx_process_cycle.c"
           cycle->log
# 1133 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           )->log_level >= 6) ngx_log_error_core(6, 
# 1133 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 1139 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           if ((
# 1139 "project/nginx/src/os/unix/ngx_process_cycle.c"
           cycle->log
# 1139 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
           )->log_level >= 6) ngx_log_error_core(6, 
# 1139 "project/nginx/src/os/unix/ngx_process_cycle.c"
...
# 1173 "project/nginx/src/os/unix/ngx_process_cycle.c" 3 4
   ngx_event_add_timer
# 1173 "project/nginx/src/os/unix/ngx_process_cycle.c"
                (ev, next);
}
