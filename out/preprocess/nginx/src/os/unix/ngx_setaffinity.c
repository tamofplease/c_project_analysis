# 0 "project/nginx/src/os/unix/ngx_setaffinity.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/unix/ngx_setaffinity.c"
...
# 8 "project/nginx/src/os/unix/ngx_setaffinity.c" 2
...
# 9 "project/nginx/src/os/unix/ngx_setaffinity.c" 2
