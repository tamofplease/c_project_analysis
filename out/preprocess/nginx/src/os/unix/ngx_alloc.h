# 0 "project/nginx/src/os/unix/ngx_alloc.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/unix/ngx_alloc.h"
# 12 "project/nginx/src/os/unix/ngx_alloc.h"
...
# 13 "project/nginx/src/os/unix/ngx_alloc.h" 2
...
# 14 "project/nginx/src/os/unix/ngx_alloc.h" 2



# 16 "project/nginx/src/os/unix/ngx_alloc.h"
void *ngx_alloc(size_t size, ngx_log_t *log);
void *ngx_calloc(size_t size, ngx_log_t *log);
# 31 "project/nginx/src/os/unix/ngx_alloc.h"
void *ngx_memalign(size_t alignment, size_t size, ngx_log_t *log);
# 40 "project/nginx/src/os/unix/ngx_alloc.h"
