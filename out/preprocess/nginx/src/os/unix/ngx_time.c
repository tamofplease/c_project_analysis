# 0 "project/nginx/src/os/unix/ngx_time.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 9 "project/nginx/src/os/unix/ngx_time.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_time.c" 2
...
{
# 53 "project/nginx/src/os/unix/ngx_time.c"
}
...
# 70 "project/nginx/src/os/unix/ngx_time.c"
    tm->
# 70 "project/nginx/src/os/unix/ngx_time.c" 3 4
       tm_mon
# 70 "project/nginx/src/os/unix/ngx_time.c"
                 ++;
    tm->
# 71 "project/nginx/src/os/unix/ngx_time.c" 3 4
       tm_year 
# 71 "project/nginx/src/os/unix/ngx_time.c"
                   += 1900;
}
...
ngx_libc_localtime(time_t s, struct tm *tm)
{
    ...
    (void) localtime_r(&s, tm);
# 88 "project/nginx/src/os/unix/ngx_time.c"
}
...
ngx_libc_gmtime(time_t s, struct tm *tm)
{
    ...
    (void) gmtime_r(&s, tm);
# 104 "project/nginx/src/os/unix/ngx_time.c"
}
