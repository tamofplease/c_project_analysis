# 0 "project/nginx/src/os/unix/ngx_daemon.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/unix/ngx_daemon.c"
...
# 9 "project/nginx/src/os/unix/ngx_daemon.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_daemon.c" 2



# 12 "project/nginx/src/os/unix/ngx_daemon.c"
ngx_int_t
...
# 19 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
       if ((
# 19 "project/nginx/src/os/unix/ngx_daemon.c"
       log
# 19 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
...
# 19 "project/nginx/src/os/unix/ngx_daemon.c"
                                                                    ;
        return 
# 20 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
              -1
# 20 "project/nginx/src/os/unix/ngx_daemon.c"
                       ;
    ...
    ngx_parent = ngx_pid;
    ngx_pid = 
# 30 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
             getpid
# 30 "project/nginx/src/os/unix/ngx_daemon.c"
                       ();

    if (setsid() == -1) {
        
# 33 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
       if ((
# 33 "project/nginx/src/os/unix/ngx_daemon.c"
       log
# 33 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
       )->log_level >= 1) ngx_log_error_core(1, 
# 33 "project/nginx/src/os/unix/ngx_daemon.c"
...
# 33 "project/nginx/src/os/unix/ngx_daemon.c"
                                                                      ;
        return 
# 34 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
              -1
# 34 "project/nginx/src/os/unix/ngx_daemon.c"
                       ;
    }
    ...
    fd = open("/dev/null", 
# 39 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
                          0x0002
# 39 "project/nginx/src/os/unix/ngx_daemon.c"
                                );
    if (fd == -1) {
        
# 41 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
       if ((
# 41 "project/nginx/src/os/unix/ngx_daemon.c"
       log
# 41 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
       )->log_level >= 1) ngx_log_error_core(1, 
# 41 "project/nginx/src/os/unix/ngx_daemon.c"
...
# 42 "project/nginx/src/os/unix/ngx_daemon.c"
                                                  ;
        return 
# 43 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
              -1
# 43 "project/nginx/src/os/unix/ngx_daemon.c"
                       ;
    }

    if (dup2(fd, 
# 46 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
                0
# 46 "project/nginx/src/os/unix/ngx_daemon.c"
                            ) == -1) {
        
# 47 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
       if ((
# 47 "project/nginx/src/os/unix/ngx_daemon.c"
       log
# 47 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
       )->log_level >= 1) ngx_log_error_core(1, 
# 47 "project/nginx/src/os/unix/ngx_daemon.c"
...
# 47 "project/nginx/src/os/unix/ngx_daemon.c"
                                                                         ;
        return 
# 48 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
              -1
# 48 "project/nginx/src/os/unix/ngx_daemon.c"
                       ;
    }

    if (dup2(fd, 
# 51 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
                1
# 51 "project/nginx/src/os/unix/ngx_daemon.c"
                             ) == -1) {
        
# 52 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
       if ((
# 52 "project/nginx/src/os/unix/ngx_daemon.c"
       log
# 52 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
       )->log_level >= 1) ngx_log_error_core(1, 
# 52 "project/nginx/src/os/unix/ngx_daemon.c"
...
# 52 "project/nginx/src/os/unix/ngx_daemon.c"
                                                                          ;
        return 
# 53 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
              -1
# 53 "project/nginx/src/os/unix/ngx_daemon.c"
                       ;
    }
# 63 "project/nginx/src/os/unix/ngx_daemon.c"
    if (fd > 
# 63 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
            2
# 63 "project/nginx/src/os/unix/ngx_daemon.c"
                         ) {
        if (close(fd) == -1) {
            
# 65 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
           if ((
# 65 "project/nginx/src/os/unix/ngx_daemon.c"
           log
# 65 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 65 "project/nginx/src/os/unix/ngx_daemon.c"
...
# 65 "project/nginx/src/os/unix/ngx_daemon.c"
                                                                         ;
            return 
# 66 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
                  -1
# 66 "project/nginx/src/os/unix/ngx_daemon.c"
                           ;
        }
    }

    return 
# 70 "project/nginx/src/os/unix/ngx_daemon.c" 3 4
          0
# 70 "project/nginx/src/os/unix/ngx_daemon.c"
                ;
}
