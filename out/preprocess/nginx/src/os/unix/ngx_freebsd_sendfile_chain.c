# 0 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 9 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 2
...
# 11 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 2
...
ngx_freebsd_sendfile_chain(ngx_connection_t *c, ngx_chain_t *in, off_t limit)
{
    ...
    struct sf_hdtr hdtr;
    struct iovec headers[
# 49 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                            64
# 49 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                                ];
    struct iovec trailers[
# 50 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                             64
# 50 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                                 ];
    ...
    if ((ngx_event_flags & 
# 60 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                          0x00000008
# 60 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                              ) && wev->pending_eof) {
        (void) ngx_connection_error(c, wev->kq_errno,
                               "kevent() reported about an closed connection");
        wev->error = 1;
        return 
# 64 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
              (ngx_chain_t *) -1
# 64 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                             ;
    }
...
# 71 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                                      9223372036854775807LL 
# 71 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                                           - ngx_pagesize)) {
        limit = 
# 72 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
               9223372036854775807LL 
# 72 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                    - ngx_pagesize;
    }
    ...
    header.iovs = headers;
    header.nalloc = 
# 80 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                   64
# 80 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                       ;

    trailer.iovs = trailers;
    trailer.nalloc = 
# 83 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                    64
# 83 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                        ;
    ...
    for ( ;; ) {
        ...
        if (cl == 
# 96 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                 (ngx_chain_t *) -1
# 96 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                ) {
            return 
# 97 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                  (ngx_chain_t *) -1
# 97 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                 ;
        }
        ...
        if (cl && cl->buf->in_file && send < limit) {
            ...
            if (send < limit) {
                ...
                cl = ngx_output_chain_to_iovec(&trailer, cl, limit - send,
                                               c->log);
                if (cl == 
# 119 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                         (ngx_chain_t *) -1
# 119 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                        ) {
                    return 
# 120 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                          (ngx_chain_t *) -1
# 120 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                         ;
                }
                ...
                && c->tcp_nopush == NGX_TCP_NOPUSH_UNSET)
            {
                if (ngx_tcp_nopush(c->fd) == -1) {
                    err = 
# 133 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                         (*__error())
# 133 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                         ;
                    ...
                    if (err != 
# 140 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                              4
# 140 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                       ) {
                        wev->error = 1;
                        (void) ngx_connection_error(c, err,
                                                    
# 143 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                                                   "setsockopt(TCP_NOPUSH)" 
# 143 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                                                    " failed");
                        return 
# 144 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                              (ngx_chain_t *) -1
# 144 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                             ;
                    }
            ...
            hdtr.headers = header.count ? header.iovs : 
# 160 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                                                       ((void *)0)
# 160 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                                           ;
            hdtr.hdr_cnt = header.count;
            hdtr.trailers = trailer.count ? trailer.iovs : 
# 162 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                                                          ((void *)0)
# 162 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                                              ;
            ...
            sent = 0;
# 186 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
            rc = sendfile(file->file->fd, c->fd, file->file_pos,
                          file_size + header.size, &hdtr, &sent, flags);

            if (rc == -1) {
                err = 
# 190 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                     (*__error())
# 190 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                              ;

                switch (err) {
                case 
# 193 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                    35
# 193 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                              :
                    eagain = 1;
                    break;

                case 
# 197 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                    4
# 197 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                             :
                    eintr = 1;
                    break;
                ...
                default:
                    ...
                    return 
# 210 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                          (ngx_chain_t *) -1
# 210 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                         ;
                }
...
# 229 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
               if ((
# 229 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
               c->log
# 229 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
...
# 231 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                                              ;

                return 
# 233 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                      (ngx_chain_t *) -1
# 233 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                     ;
            }
            ...
            if (n == 
# 243 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                    -1
# 243 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                             ) {
                return 
# 244 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                      (ngx_chain_t *) -1
# 244 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                     ;
            }

            sent = (n == 
# 247 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                        -2
# 247 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                 ) ? 0 : n;
        }
...
# 281 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
        if (eagain) {
# 290 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
        ...
        if (send >= limit || in == 
# 304 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c" 3 4
                                  ((void *)0)
# 304 "project/nginx/src/os/unix/ngx_freebsd_sendfile_chain.c"
                                      ) {
            return in;
        }
    }
