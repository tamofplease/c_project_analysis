# 0 "project/nginx/src/os/unix/ngx_darwin_init.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/unix/ngx_darwin_init.c"
...
# 9 "project/nginx/src/os/unix/ngx_darwin_init.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_darwin_init.c" 2



# 12 "project/nginx/src/os/unix/ngx_darwin_init.c"
...
# 30 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
   1
...
# 35 "project/nginx/src/os/unix/ngx_darwin_init.c"
};
...
sysctl_t sysctls[] = {
    ...
    { 
# 59 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
     ((void *)0)
# 59 "project/nginx/src/os/unix/ngx_darwin_init.c"
         , 
# 59 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
           ((void *)0)
# 59 "project/nginx/src/os/unix/ngx_darwin_init.c"
...
ngx_debug_init(void)
{
# 83 "project/nginx/src/os/unix/ngx_darwin_init.c"
...
ngx_os_specific_init(ngx_log_t *log)
{
    ...
    if (sysctlbyname("kern.ostype", ngx_darwin_kern_ostype, &size, 
# 99 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
                                                                  ((void *)0)
# 99 "project/nginx/src/os/unix/ngx_darwin_init.c"
                                                                      , 0)
        == -1)
    {
        err = 
# 102 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
             (*__error())
# 102 "project/nginx/src/os/unix/ngx_darwin_init.c"
                      ;

        if (err != 
# 104 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
                  2
# 104 "project/nginx/src/os/unix/ngx_darwin_init.c"
                            ) {

            
# 106 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
           if ((
# 106 "project/nginx/src/os/unix/ngx_darwin_init.c"
           log
# 106 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
...
# 106 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
           , 
# 106 "project/nginx/src/os/unix/ngx_darwin_init.c"
           err, "sysctlbyname(kern.ostype) failed"
# 106 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
           )
                                                             
# 107 "project/nginx/src/os/unix/ngx_darwin_init.c"
                                                            ;

            if (err != 
# 109 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
                      12
# 109 "project/nginx/src/os/unix/ngx_darwin_init.c"
                                ) {
                return 
# 110 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
                      -1
# 110 "project/nginx/src/os/unix/ngx_darwin_init.c"
                               ;
            }
...
# 119 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
                    ((void *)0)
# 119 "project/nginx/src/os/unix/ngx_darwin_init.c"
                        , 0)
        == -1)
    {
        err = 
# 122 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
             (*__error())
# 122 "project/nginx/src/os/unix/ngx_darwin_init.c"
                      ;

        if (err != 
# 124 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
                  2
# 124 "project/nginx/src/os/unix/ngx_darwin_init.c"
                            ) {

            
# 126 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
           if ((
# 126 "project/nginx/src/os/unix/ngx_darwin_init.c"
           log
# 126 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 126 "project/nginx/src/os/unix/ngx_darwin_init.c"
...
# 126 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
           , 
# 126 "project/nginx/src/os/unix/ngx_darwin_init.c"
           err, "sysctlbyname(kern.osrelease) failed"
# 126 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
           )
                                                                
# 127 "project/nginx/src/os/unix/ngx_darwin_init.c"
                                                               ;

            if (err != 
# 129 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
                      12
# 129 "project/nginx/src/os/unix/ngx_darwin_init.c"
                                ) {
                return 
# 130 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
                      -1
# 130 "project/nginx/src/os/unix/ngx_darwin_init.c"
                               ;
            }
    ...
    for (i = 0; sysctls[i].name; i++) {
        ...
        if (sysctlbyname(sysctls[i].name, sysctls[i].value, &size, 
# 140 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
                                                                  ((void *)0)
# 140 "project/nginx/src/os/unix/ngx_darwin_init.c"
                                                                      , 0)
            == 0)
        {
            sysctls[i].exists = 1;
        ...
        err = 
# 147 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
             (*__error())
# 147 "project/nginx/src/os/unix/ngx_darwin_init.c"
                      ;

        if (err == 
# 149 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
                  2
# 149 "project/nginx/src/os/unix/ngx_darwin_init.c"
                            ) {
            continue;
        }

        
# 153 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
       if ((
# 153 "project/nginx/src/os/unix/ngx_darwin_init.c"
       log
# 153 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 153 "project/nginx/src/os/unix/ngx_darwin_init.c"
...
# 153 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
       , 
# 153 "project/nginx/src/os/unix/ngx_darwin_init.c"
       err, "sysctlbyname(%s) failed", sysctls[i].name
# 153 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
       )
                                                                 
# 154 "project/nginx/src/os/unix/ngx_darwin_init.c"
                                                                ;
        return 
# 155 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
              -1
# 155 "project/nginx/src/os/unix/ngx_darwin_init.c"
                       ;
    }
...
# 161 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
       if ((
# 161 "project/nginx/src/os/unix/ngx_darwin_init.c"
       log
# 161 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 161 "project/nginx/src/os/unix/ngx_darwin_init.c"
...
# 161 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
       , 
# 161 "project/nginx/src/os/unix/ngx_darwin_init.c"
       0, "sysctl kern.ipc.somaxconn must be less than 32768"
# 161 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
       )
                                                                          
# 162 "project/nginx/src/os/unix/ngx_darwin_init.c"
                                                                         ;
        return 
# 163 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
              -1
# 163 "project/nginx/src/os/unix/ngx_darwin_init.c"
                       ;
    }
    ...
    return 
# 170 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
          0
# 170 "project/nginx/src/os/unix/ngx_darwin_init.c"
                ;
}
...
# 181 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
       if ((
# 181 "project/nginx/src/os/unix/ngx_darwin_init.c"
       log
# 181 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
...
# 181 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
       , 
# 181 "project/nginx/src/os/unix/ngx_darwin_init.c"
       0, "OS: %s %s", ngx_darwin_kern_ostype, ngx_darwin_kern_osrelease
# 181 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
       )
                                                                        
# 182 "project/nginx/src/os/unix/ngx_darwin_init.c"
                                                                       ;
    }
...
# 194 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
           if ((
# 194 "project/nginx/src/os/unix/ngx_darwin_init.c"
           log
# 194 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
           )->log_level >= 6) ngx_log_error_core(6, 
# 194 "project/nginx/src/os/unix/ngx_darwin_init.c"
...
# 194 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
           , 
# 194 "project/nginx/src/os/unix/ngx_darwin_init.c"
           0, "%s: %l", sysctls[i].name, value
# 194 "project/nginx/src/os/unix/ngx_darwin_init.c" 3 4
           )
                                                 
# 195 "project/nginx/src/os/unix/ngx_darwin_init.c"
                                                ;
        }
    }
}
