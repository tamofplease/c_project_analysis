# 0 "project/nginx/src/os/unix/ngx_atomic.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/unix/ngx_atomic.h"
# 12 "project/nginx/src/os/unix/ngx_atomic.h"
...
# 13 "project/nginx/src/os/unix/ngx_atomic.h" 2
...
typedef struct {
# 33 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/core/ngx_shmtx.h" 3 4
    ngx_fd_t fd;
    u_char *name;
...
# 14 "project/nginx/src/os/unix/ngx_atomic.h" 2
# 47 "project/nginx/src/os/unix/ngx_atomic.h"
...
# 307 "project/nginx/src/os/unix/ngx_atomic.h"
