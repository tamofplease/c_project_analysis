# 0 "project/nginx/src/os/unix/ngx_socket.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 9 "project/nginx/src/os/unix/ngx_socket.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_socket.c" 2
# 26 "project/nginx/src/os/unix/ngx_socket.c"
...
ngx_nonblocking(ngx_socket_t s)
{
    ...
    return ioctl(s, 
# 33 "project/nginx/src/os/unix/ngx_socket.c" 3 4
                   ((__uint32_t)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('f')) << 8) | ((126)))
# 33 "project/nginx/src/os/unix/ngx_socket.c"
                          , &nb);
}
...
ngx_blocking(ngx_socket_t s)
{
    ...
    return ioctl(s, 
# 44 "project/nginx/src/os/unix/ngx_socket.c" 3 4
                   ((__uint32_t)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('f')) << 8) | ((126)))
# 44 "project/nginx/src/os/unix/ngx_socket.c"
                          , &nb);
}
# 103 "project/nginx/src/os/unix/ngx_socket.c"
int
