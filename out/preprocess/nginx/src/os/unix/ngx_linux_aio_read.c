# 0 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
...
# 9 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 2
...
# 11 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 2



# 13 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
...
ngx_file_aio_init(ngx_file_t *file, ngx_pool_t *pool)
{
    ...
    if (aio == 
# 33 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
              ((void *)0)
# 33 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
                  ) {
        return 
# 34 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
              -1
# 34 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
                       ;
    }
    ...
    return 
# 45 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
          0
# 45 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
                ;
}
    ...
    ngx_pool_t *pool)
{
    ...
    if (file->aio == 
# 62 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
                    ((void *)0) 
# 62 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
...
# 62 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
        ...
        return 
# 63 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
              -1
# 63 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
                       ;
    }
...
# 70 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
       if ((
# 70 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
       file->log
# 70 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
...
# 71 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
                                                               ;
        return 
# 72 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
              -2
# 72 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
                       ;
    }
...
# 84 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
           (*__error()) = 
# 84 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
           0;
            return aio->res;
        }

        
# 88 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
       (*__error()) = 
# 88 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
       -aio->res;

        
# 90 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
       if ((
# 90 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
       file->log
# 90 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
...
# 91 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
                                                               ;

        return 
# 93 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
              -1
# 93 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
                       ;
    }

    
# 96 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
   (void) __builtin___memset_chk (
# 96 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
   &aio->aiocb
# 96 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
   , 0, 
# 96 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
...
# 96 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
    ...
    if (io_submit(ngx_aio_ctx, 1, piocb) == 1) {
        ...
        return 
# 116 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
              -2
# 116 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
                       ;
    }

    err = 
# 119 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
         (*__error())
# 119 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
                  ;

    if (err == 
# 121 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
              35
# 121 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
                        ) {
        return ngx_read_file(file, buf, size, offset);
    }

    
# 125 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
   if ((
# 125 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
   file->log
# 125 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
   )->log_level >= 3) ngx_log_error_core(3, 
# 125 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
...
# 125 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
   , 
# 125 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
   err, "io_submit(\"%V\") failed", &file->name
# 125 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
   )
                                                          
# 126 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
                                                         ;

    if (err == 
# 128 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
              78
# 128 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
                        ) {
        ngx_file_aio = 0;
        return ngx_read_file(file, buf, size, offset);
    }
    ...
    return 
# 133 "project/nginx/src/os/unix/ngx_linux_aio_read.c" 3 4
          -1
# 133 "project/nginx/src/os/unix/ngx_linux_aio_read.c"
                   ;
}
