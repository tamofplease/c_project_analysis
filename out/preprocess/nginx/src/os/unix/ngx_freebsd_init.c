# 0 "project/nginx/src/os/unix/ngx_freebsd_init.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 9 "project/nginx/src/os/unix/ngx_freebsd_init.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_freebsd_init.c" 2




# 13 "project/nginx/src/os/unix/ngx_freebsd_init.c"
...
# 39 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
   1
...
# 44 "project/nginx/src/os/unix/ngx_freebsd_init.c"
};
...
sysctl_t sysctls[] = {
    ...
    { 
# 72 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
     ((void *)0)
# 72 "project/nginx/src/os/unix/ngx_freebsd_init.c"
         , 
# 72 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
           ((void *)0)
# 72 "project/nginx/src/os/unix/ngx_freebsd_init.c"
...
ngx_debug_init(void)
{
# 90 "project/nginx/src/os/unix/ngx_freebsd_init.c"
    char *mo;

    mo = getenv("MALLOC_OPTIONS");

    if (mo && 
# 94 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
             strchr((const char *) 
# 94 "project/nginx/src/os/unix/ngx_freebsd_init.c"
             mo
# 94 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
             , (int) 
# 94 "project/nginx/src/os/unix/ngx_freebsd_init.c"
...
ngx_os_specific_init(ngx_log_t *log)
{
    ...
    if (sysctlbyname("kern.ostype",
                     ngx_freebsd_kern_ostype, &size, 
# 111 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
                                                    ((void *)0)
# 111 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                                                        , 0) == -1) {
        
# 112 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
       if ((
# 112 "project/nginx/src/os/unix/ngx_freebsd_init.c"
       log
# 112 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
...
# 113 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                                                        ;

        if (
# 115 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
           (*__error()) 
# 115 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                     != 
# 115 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
                        12
# 115 "project/nginx/src/os/unix/ngx_freebsd_init.c"
            ...
            return 
# 116 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
                  -1
# 116 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                           ;
        }
    ...
    if (sysctlbyname("kern.osrelease",
                     ngx_freebsd_kern_osrelease, &size, 
# 124 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
                                                       ((void *)0)
# 124 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                                                           , 0) == -1) {
        
# 125 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
       if ((
# 125 "project/nginx/src/os/unix/ngx_freebsd_init.c"
       log
# 125 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 125 "project/nginx/src/os/unix/ngx_freebsd_init.c"
...
# 126 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                                                           ;

        if (
# 128 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
           (*__error()) 
# 128 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                     != 
# 128 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
                        12
# 128 "project/nginx/src/os/unix/ngx_freebsd_init.c"
            ...
            return 
# 129 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
                  -1
# 129 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                           ;
        }
    ...
    if (sysctlbyname("kern.osreldate",
                     &ngx_freebsd_kern_osreldate, &size, 
# 138 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
                                                        ((void *)0)
# 138 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                                                            , 0) == -1) {
        
# 139 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
       if ((
# 139 "project/nginx/src/os/unix/ngx_freebsd_init.c"
       log
# 139 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 139 "project/nginx/src/os/unix/ngx_freebsd_init.c"
...
# 140 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                                                           ;
        return 
# 141 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
              -1
# 141 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                       ;
    }

    version = ngx_freebsd_kern_osreldate;
# 176 "project/nginx/src/os/unix/ngx_freebsd_init.c"
...
# 191 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
                                                                  ((void *)0)
# 191 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                                                                      , 0)
            == 0)
        {
            sysctls[i].exists = 1;
        ...
        err = 
# 198 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
             (*__error())
# 198 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                      ;

        if (err == 
# 200 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
                  2
# 200 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                            ) {
            continue;
        }

        
# 204 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
       if ((
# 204 "project/nginx/src/os/unix/ngx_freebsd_init.c"
       log
# 204 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 204 "project/nginx/src/os/unix/ngx_freebsd_init.c"
...
# 205 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                                                                ;
        return 
# 206 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
              -1
# 206 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                       ;
    }
...
# 217 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
       if ((
# 217 "project/nginx/src/os/unix/ngx_freebsd_init.c"
       log
# 217 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 217 "project/nginx/src/os/unix/ngx_freebsd_init.c"
...
# 218 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                                                                         ;
        return 
# 219 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
              -1
# 219 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                       ;
    }
    ...
    return 
# 226 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
          0
# 226 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                ;
}
...
# 236 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
   if ((
# 236 "project/nginx/src/os/unix/ngx_freebsd_init.c"
   log
# 236 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
...
# 236 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
   , 
# 236 "project/nginx/src/os/unix/ngx_freebsd_init.c"
   0, "OS: %s %s", ngx_freebsd_kern_ostype, ngx_freebsd_kern_osrelease
# 236 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
   )
                                                                      
# 237 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                                                                     ;
...
# 244 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
   if ((
# 244 "project/nginx/src/os/unix/ngx_freebsd_init.c"
   log
# 244 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
   )->log_level >= 6) ngx_log_error_core(6, 
# 244 "project/nginx/src/os/unix/ngx_freebsd_init.c"
...
# 244 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
   , 
# 244 "project/nginx/src/os/unix/ngx_freebsd_init.c"
   0, "kern.osreldate: %d, built on %d", ngx_freebsd_kern_osreldate, __FreeBSD_version
# 244 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
   )

                                                                
# 246 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                                                               ;
...
# 258 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
           if ((
# 258 "project/nginx/src/os/unix/ngx_freebsd_init.c"
           log
# 258 "project/nginx/src/os/unix/ngx_freebsd_init.c" 3 4
           )->log_level >= 6) ngx_log_error_core(6, 
# 258 "project/nginx/src/os/unix/ngx_freebsd_init.c"
...
# 259 "project/nginx/src/os/unix/ngx_freebsd_init.c"
                                                ;
        }
    }
}
