# 0 "project/nginx/src/os/unix/ngx_shmem.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/unix/ngx_shmem.h"
# 12 "project/nginx/src/os/unix/ngx_shmem.h"
...
# 13 "project/nginx/src/os/unix/ngx_shmem.h" 2
...
# 14 "project/nginx/src/os/unix/ngx_shmem.h" 2



# 16 "project/nginx/src/os/unix/ngx_shmem.h"
typedef struct {
    u_char *addr;
    size_t size;
    ngx_str_t name;
