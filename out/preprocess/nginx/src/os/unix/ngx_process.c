# 0 "project/nginx/src/os/unix/ngx_process.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/unix/ngx_process.c"
...
# 9 "project/nginx/src/os/unix/ngx_process.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_process.c" 2
...
# 11 "project/nginx/src/os/unix/ngx_process.c" 2
...
# 12 "project/nginx/src/os/unix/ngx_process.c" 2



# 14 "project/nginx/src/os/unix/ngx_process.c"
typedef struct {
    int signo;
    char *signame;
    char *name;
...
ngx_process_t ngx_processes[
# 36 "project/nginx/src/os/unix/ngx_process.c" 3 4
                              1024
# 36 "project/nginx/src/os/unix/ngx_process.c"
                                               ];


ngx_signal_t signals[] = {
    { 
# 40 "project/nginx/src/os/unix/ngx_process.c" 3 4
     1
# 40 "project/nginx/src/os/unix/ngx_process.c"
                                             ,
      "SIG" "HUP",
      "reload",
      ngx_signal_handler },
    ...
    { 
# 45 "project/nginx/src/os/unix/ngx_process.c" 3 4
     30
# 45 "project/nginx/src/os/unix/ngx_process.c"
                                        ,
      "SIG" "USR1",
      "reopen",
      ngx_signal_handler },
    ...
    { 
# 50 "project/nginx/src/os/unix/ngx_process.c" 3 4
     28
# 50 "project/nginx/src/os/unix/ngx_process.c"
                                          ,
      "SIG" "WINCH",
      "",
      ngx_signal_handler },
    ...
    { 
# 55 "project/nginx/src/os/unix/ngx_process.c" 3 4
     15
# 55 "project/nginx/src/os/unix/ngx_process.c"
                                           ,
      "SIG" "TERM",
      "stop",
      ngx_signal_handler },
    ...
    { 
# 60 "project/nginx/src/os/unix/ngx_process.c" 3 4
     3
# 60 "project/nginx/src/os/unix/ngx_process.c"
                                          ,
      "SIG" "QUIT",
      "quit",
      ngx_signal_handler },
    ...
    { 
# 65 "project/nginx/src/os/unix/ngx_process.c" 3 4
     31
# 65 "project/nginx/src/os/unix/ngx_process.c"
                                           ,
      "SIG" "USR2",
      "",
      ngx_signal_handler },
    ...
    { 
# 70 "project/nginx/src/os/unix/ngx_process.c" 3 4
     14
# 70 "project/nginx/src/os/unix/ngx_process.c"
            , "SIGALRM", "", ngx_signal_handler },

    { 
# 72 "project/nginx/src/os/unix/ngx_process.c" 3 4
     2
# 72 "project/nginx/src/os/unix/ngx_process.c"
           , "SIGINT", "", ngx_signal_handler },

    { 
# 74 "project/nginx/src/os/unix/ngx_process.c" 3 4
     23
# 74 "project/nginx/src/os/unix/ngx_process.c"
          , "SIGIO", "", ngx_signal_handler },

    { 
# 76 "project/nginx/src/os/unix/ngx_process.c" 3 4
     20
# 76 "project/nginx/src/os/unix/ngx_process.c"
            , "SIGCHLD", "", ngx_signal_handler },

    { 
# 78 "project/nginx/src/os/unix/ngx_process.c" 3 4
     12
# 78 "project/nginx/src/os/unix/ngx_process.c"
           , "SIGSYS, SIG_IGN", "", 
# 78 "project/nginx/src/os/unix/ngx_process.c" 3 4
                                    ((void *)0) 
# 78 "project/nginx/src/os/unix/ngx_process.c"
    ...
    { 
# 80 "project/nginx/src/os/unix/ngx_process.c" 3 4
     13
# 80 "project/nginx/src/os/unix/ngx_process.c"
            , "SIGPIPE, SIG_IGN", "", 
# 80 "project/nginx/src/os/unix/ngx_process.c" 3 4
                                      ((void *)0) 
# 80 "project/nginx/src/os/unix/ngx_process.c"
    ...
    { 0, 
# 82 "project/nginx/src/os/unix/ngx_process.c" 3 4
        ((void *)0)
# 82 "project/nginx/src/os/unix/ngx_process.c"
            , "", 
# 82 "project/nginx/src/os/unix/ngx_process.c" 3 4
                  ((void *)0) 
# 82 "project/nginx/src/os/unix/ngx_process.c"
    ...
    char *name, ngx_int_t respawn)
{
    ...
    if (respawn >= 0) {
        ...
        if (s == 
# 104 "project/nginx/src/os/unix/ngx_process.c" 3 4
                1024
# 104 "project/nginx/src/os/unix/ngx_process.c"
                                 ) {
            
# 105 "project/nginx/src/os/unix/ngx_process.c" 3 4
           if ((
# 105 "project/nginx/src/os/unix/ngx_process.c"
           cycle->log
# 105 "project/nginx/src/os/unix/ngx_process.c" 3 4
...
# 105 "project/nginx/src/os/unix/ngx_process.c" 3 4
           , 
# 105 "project/nginx/src/os/unix/ngx_process.c"
           0, "no more than %d processes can be spawned", 
# 105 "project/nginx/src/os/unix/ngx_process.c" 3 4
           1024)

                                            
# 107 "project/nginx/src/os/unix/ngx_process.c"
                                           ;
            return 
# 108 "project/nginx/src/os/unix/ngx_process.c" 3 4
                  -1
# 108 "project/nginx/src/os/unix/ngx_process.c"
                                 ;
        }
    }
    ...
    if (respawn != 
# 113 "project/nginx/src/os/unix/ngx_process.c" 3 4
                  -5
# 113 "project/nginx/src/os/unix/ngx_process.c"
                                      ) {



        if (socketpair(
# 117 "project/nginx/src/os/unix/ngx_process.c" 3 4
                      1
# 117 "project/nginx/src/os/unix/ngx_process.c"
                             , 
# 117 "project/nginx/src/os/unix/ngx_process.c" 3 4
                               1
# 117 "project/nginx/src/os/unix/ngx_process.c"
                                          , 0, ngx_processes[s].channel) == -1)
        {
            
# 119 "project/nginx/src/os/unix/ngx_process.c" 3 4
           if ((
# 119 "project/nginx/src/os/unix/ngx_process.c"
           cycle->log
# 119 "project/nginx/src/os/unix/ngx_process.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 119 "project/nginx/src/os/unix/ngx_process.c"
...
# 120 "project/nginx/src/os/unix/ngx_process.c"
                                                                           ;
            return 
# 121 "project/nginx/src/os/unix/ngx_process.c" 3 4
                  -1
# 121 "project/nginx/src/os/unix/ngx_process.c"
                                 ;
        }
...
# 130 "project/nginx/src/os/unix/ngx_process.c" 3 4
           if ((
# 130 "project/nginx/src/os/unix/ngx_process.c"
           cycle->log
# 130 "project/nginx/src/os/unix/ngx_process.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 130 "project/nginx/src/os/unix/ngx_process.c"
...
# 132 "project/nginx/src/os/unix/ngx_process.c"
                              ;
            ngx_close_channel(ngx_processes[s].channel, cycle->log);
            return 
# 134 "project/nginx/src/os/unix/ngx_process.c" 3 4
                  -1
# 134 "project/nginx/src/os/unix/ngx_process.c"
                                 ;
        }

        if (ngx_nonblocking(ngx_processes[s].channel[1]) == -1) {
            
# 138 "project/nginx/src/os/unix/ngx_process.c" 3 4
           if ((
# 138 "project/nginx/src/os/unix/ngx_process.c"
           cycle->log
# 138 "project/nginx/src/os/unix/ngx_process.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 138 "project/nginx/src/os/unix/ngx_process.c"
...
# 140 "project/nginx/src/os/unix/ngx_process.c"
                              ;
            ngx_close_channel(ngx_processes[s].channel, cycle->log);
            return 
# 142 "project/nginx/src/os/unix/ngx_process.c" 3 4
                  -1
# 142 "project/nginx/src/os/unix/ngx_process.c"
                                 ;
        }

        on = 1;
        if (ioctl(ngx_processes[s].channel[0], 
# 146 "project/nginx/src/os/unix/ngx_process.c" 3 4
                                              ((__uint32_t)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('f')) << 8) | ((125)))
# 146 "project/nginx/src/os/unix/ngx_process.c"
                                                      , &on) == -1) {
            
# 147 "project/nginx/src/os/unix/ngx_process.c" 3 4
           if ((
# 147 "project/nginx/src/os/unix/ngx_process.c"
           cycle->log
# 147 "project/nginx/src/os/unix/ngx_process.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 147 "project/nginx/src/os/unix/ngx_process.c"
...
# 148 "project/nginx/src/os/unix/ngx_process.c"
                                                                              ;
            ngx_close_channel(ngx_processes[s].channel, cycle->log);
            return 
# 150 "project/nginx/src/os/unix/ngx_process.c" 3 4
                  -1
# 150 "project/nginx/src/os/unix/ngx_process.c"
                                 ;
        }

        if (fcntl(ngx_processes[s].channel[0], 
# 153 "project/nginx/src/os/unix/ngx_process.c" 3 4
                                              6
# 153 "project/nginx/src/os/unix/ngx_process.c"
                                                      , ngx_pid) == -1) {
            
# 154 "project/nginx/src/os/unix/ngx_process.c" 3 4
           if ((
# 154 "project/nginx/src/os/unix/ngx_process.c"
           cycle->log
# 154 "project/nginx/src/os/unix/ngx_process.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 154 "project/nginx/src/os/unix/ngx_process.c"
...
# 155 "project/nginx/src/os/unix/ngx_process.c"
                                                                              ;
            ngx_close_channel(ngx_processes[s].channel, cycle->log);
            return 
# 157 "project/nginx/src/os/unix/ngx_process.c" 3 4
                  -1
# 157 "project/nginx/src/os/unix/ngx_process.c"
                                 ;
        }

        if (fcntl(ngx_processes[s].channel[0], 
# 160 "project/nginx/src/os/unix/ngx_process.c" 3 4
                                              2
# 160 "project/nginx/src/os/unix/ngx_process.c"
                                                     , 
# 160 "project/nginx/src/os/unix/ngx_process.c" 3 4
                                                       1
# 160 "project/nginx/src/os/unix/ngx_process.c"
...
# 161 "project/nginx/src/os/unix/ngx_process.c" 3 4
           if ((
# 161 "project/nginx/src/os/unix/ngx_process.c"
           cycle->log
# 161 "project/nginx/src/os/unix/ngx_process.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 161 "project/nginx/src/os/unix/ngx_process.c"
...
# 163 "project/nginx/src/os/unix/ngx_process.c"
                               ;
            ngx_close_channel(ngx_processes[s].channel, cycle->log);
            return 
# 165 "project/nginx/src/os/unix/ngx_process.c" 3 4
                  -1
# 165 "project/nginx/src/os/unix/ngx_process.c"
                                 ;
        }

        if (fcntl(ngx_processes[s].channel[1], 
# 168 "project/nginx/src/os/unix/ngx_process.c" 3 4
                                              2
# 168 "project/nginx/src/os/unix/ngx_process.c"
                                                     , 
# 168 "project/nginx/src/os/unix/ngx_process.c" 3 4
                                                       1
# 168 "project/nginx/src/os/unix/ngx_process.c"
...
# 169 "project/nginx/src/os/unix/ngx_process.c" 3 4
           if ((
# 169 "project/nginx/src/os/unix/ngx_process.c"
           cycle->log
# 169 "project/nginx/src/os/unix/ngx_process.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 169 "project/nginx/src/os/unix/ngx_process.c"
...
# 171 "project/nginx/src/os/unix/ngx_process.c"
                               ;
            ngx_close_channel(ngx_processes[s].channel, cycle->log);
            return 
# 173 "project/nginx/src/os/unix/ngx_process.c" 3 4
                  -1
# 173 "project/nginx/src/os/unix/ngx_process.c"
                                 ;
        }
...
# 191 "project/nginx/src/os/unix/ngx_process.c" 3 4
       if ((
# 191 "project/nginx/src/os/unix/ngx_process.c"
       cycle->log
# 191 "project/nginx/src/os/unix/ngx_process.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 191 "project/nginx/src/os/unix/ngx_process.c"
...
# 192 "project/nginx/src/os/unix/ngx_process.c"
                                                                 ;
        ngx_close_channel(ngx_processes[s].channel, cycle->log);
        return 
# 194 "project/nginx/src/os/unix/ngx_process.c" 3 4
              -1
# 194 "project/nginx/src/os/unix/ngx_process.c"
                             ;

    case 0:
        ngx_parent = ngx_pid;
        ngx_pid = 
# 198 "project/nginx/src/os/unix/ngx_process.c" 3 4
                 getpid
# 198 "project/nginx/src/os/unix/ngx_process.c"
                           ();
        proc(cycle, data);
        break;
...
# 206 "project/nginx/src/os/unix/ngx_process.c" 3 4
   if ((
# 206 "project/nginx/src/os/unix/ngx_process.c"
   cycle->log
# 206 "project/nginx/src/os/unix/ngx_process.c" 3 4
...
# 206 "project/nginx/src/os/unix/ngx_process.c"
    ...
    case 
# 222 "project/nginx/src/os/unix/ngx_process.c" 3 4
        -1
# 222 "project/nginx/src/os/unix/ngx_process.c"
                             :
    ...
    case 
# 228 "project/nginx/src/os/unix/ngx_process.c" 3 4
        -2
# 228 "project/nginx/src/os/unix/ngx_process.c"
                              :
        ngx_processes[s].respawn = 0;
    ...
    case 
# 234 "project/nginx/src/os/unix/ngx_process.c" 3 4
        -3
# 234 "project/nginx/src/os/unix/ngx_process.c"
                           :
    ...
    case 
# 240 "project/nginx/src/os/unix/ngx_process.c" 3 4
        -4
# 240 "project/nginx/src/os/unix/ngx_process.c"
                                :
        ngx_processes[s].respawn = 1;
        ngx_processes[s].just_spawn = 1;
        ngx_processes[s].detached = 0;
    ...
    case 
# 246 "project/nginx/src/os/unix/ngx_process.c" 3 4
        -5
# 246 "project/nginx/src/os/unix/ngx_process.c"
                            :
        ngx_processes[s].respawn = 0;
        ngx_processes[s].just_spawn = 0;
...
# 265 "project/nginx/src/os/unix/ngx_process.c" 3 4
                            -5
# 265 "project/nginx/src/os/unix/ngx_process.c"
                                                );
}
...
# 275 "project/nginx/src/os/unix/ngx_process.c" 3 4
       if ((
# 275 "project/nginx/src/os/unix/ngx_process.c"
       cycle->log
# 275 "project/nginx/src/os/unix/ngx_process.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 275 "project/nginx/src/os/unix/ngx_process.c"
...
# 275 "project/nginx/src/os/unix/ngx_process.c" 3 4
       , (*__error())
# 275 "project/nginx/src/os/unix/ngx_process.c"
       , "execve() failed while executing %s \"%s\"", ctx->name, ctx->path
# 275 "project/nginx/src/os/unix/ngx_process.c" 3 4
       )

                                           
# 277 "project/nginx/src/os/unix/ngx_process.c"
                                          ;
    }
...
# 291 "project/nginx/src/os/unix/ngx_process.c" 3 4
       (void) __builtin___memset_chk (
# 291 "project/nginx/src/os/unix/ngx_process.c"
       &sa
# 291 "project/nginx/src/os/unix/ngx_process.c" 3 4
       , 0, 
# 291 "project/nginx/src/os/unix/ngx_process.c"
...
# 291 "project/nginx/src/os/unix/ngx_process.c"
        ...
        if (sig->handler) {
            sa.
# 294 "project/nginx/src/os/unix/ngx_process.c" 3 4
              __sigaction_u.__sa_sigaction 
# 294 "project/nginx/src/os/unix/ngx_process.c"
                           = sig->handler;
            sa.sa_flags = 
# 295 "project/nginx/src/os/unix/ngx_process.c" 3 4
                         0x0040
# 295 "project/nginx/src/os/unix/ngx_process.c"
                                   ;

        } else {
            sa.
# 298 "project/nginx/src/os/unix/ngx_process.c" 3 4
              __sigaction_u.__sa_handler 
# 298 "project/nginx/src/os/unix/ngx_process.c"
                         = 
# 298 "project/nginx/src/os/unix/ngx_process.c" 3 4
                           (void (*)(int))1
# 298 "project/nginx/src/os/unix/ngx_process.c"
...
# 301 "project/nginx/src/os/unix/ngx_process.c" 3 4
       (*(
# 301 "project/nginx/src/os/unix/ngx_process.c"
       &sa.sa_mask
# 301 "project/nginx/src/os/unix/ngx_process.c" 3 4
       ) = 0, 0)
# 301 "project/nginx/src/os/unix/ngx_process.c"
                               ;
        if (sigaction(sig->signo, &sa, 
# 302 "project/nginx/src/os/unix/ngx_process.c" 3 4
                                      ((void *)0)
# 302 "project/nginx/src/os/unix/ngx_process.c"
                                          ) == -1) {
...
# 307 "project/nginx/src/os/unix/ngx_process.c" 3 4
           if ((
# 307 "project/nginx/src/os/unix/ngx_process.c"
           log
# 307 "project/nginx/src/os/unix/ngx_process.c" 3 4
...
# 308 "project/nginx/src/os/unix/ngx_process.c"
                                                              ;
            return 
# 309 "project/nginx/src/os/unix/ngx_process.c" 3 4
                  -1
# 309 "project/nginx/src/os/unix/ngx_process.c"
                           ;
    ...
    return 
# 314 "project/nginx/src/os/unix/ngx_process.c" 3 4
          0
# 314 "project/nginx/src/os/unix/ngx_process.c"
                ;
}
...
ngx_signal_handler(int signo, siginfo_t *siginfo, void *ucontext)
{
    ...
    err = 
# 328 "project/nginx/src/os/unix/ngx_process.c" 3 4
         (*__error())
# 328 "project/nginx/src/os/unix/ngx_process.c"
                  ;
    ...
    case 
# 342 "project/nginx/src/os/unix/ngx_process.c" 3 4
        1
# 342 "project/nginx/src/os/unix/ngx_process.c"
                          :
    case 
# 343 "project/nginx/src/os/unix/ngx_process.c" 3 4
        0
# 343 "project/nginx/src/os/unix/ngx_process.c"
                          :
        switch (signo) {

        case 
# 346 "project/nginx/src/os/unix/ngx_process.c" 3 4
            3
# 346 "project/nginx/src/os/unix/ngx_process.c"
                                                 :
            ngx_quit = 1;
        ...
        case 
# 351 "project/nginx/src/os/unix/ngx_process.c" 3 4
            15
# 351 "project/nginx/src/os/unix/ngx_process.c"
                                                  :
        case 
# 352 "project/nginx/src/os/unix/ngx_process.c" 3 4
            2
# 352 "project/nginx/src/os/unix/ngx_process.c"
                  :
            ngx_terminate = 1;
            action = ", exiting";
            break;
        ...
        case 
# 357 "project/nginx/src/os/unix/ngx_process.c" 3 4
            28
# 357 "project/nginx/src/os/unix/ngx_process.c"
                                                 :
            if (ngx_daemonized) {
                ngx_noaccept = 1;
        ...
        case 
# 364 "project/nginx/src/os/unix/ngx_process.c" 3 4
            1
# 364 "project/nginx/src/os/unix/ngx_process.c"
                                                    :
            ngx_reconfigure = 1;
        ...
        case 
# 369 "project/nginx/src/os/unix/ngx_process.c" 3 4
            30
# 369 "project/nginx/src/os/unix/ngx_process.c"
                                               :
            ngx_reopen = 1;
        ...
        case 
# 374 "project/nginx/src/os/unix/ngx_process.c" 3 4
            31
# 374 "project/nginx/src/os/unix/ngx_process.c"
                                                  :
            if (
# 375 "project/nginx/src/os/unix/ngx_process.c" 3 4
               getppid
# 375 "project/nginx/src/os/unix/ngx_process.c"
                          () == ngx_parent || ngx_new_binary > 0) {
# 384 "project/nginx/src/os/unix/ngx_process.c"
                action = ", ignoring";
                ignore = 1;
                break;
            }
        ...
        case 
# 393 "project/nginx/src/os/unix/ngx_process.c" 3 4
            14
# 393 "project/nginx/src/os/unix/ngx_process.c"
                   :
            ngx_sigalrm = 1;
            break;

        case 
# 397 "project/nginx/src/os/unix/ngx_process.c" 3 4
            23
# 397 "project/nginx/src/os/unix/ngx_process.c"
                 :
            ngx_sigio = 1;
            break;

        case 
# 401 "project/nginx/src/os/unix/ngx_process.c" 3 4
            20
# 401 "project/nginx/src/os/unix/ngx_process.c"
                   :
            ngx_reap = 1;
            break;
        }
    ...
    case 
# 408 "project/nginx/src/os/unix/ngx_process.c" 3 4
        3
# 408 "project/nginx/src/os/unix/ngx_process.c"
                          :
    case 
# 409 "project/nginx/src/os/unix/ngx_process.c" 3 4
        4
# 409 "project/nginx/src/os/unix/ngx_process.c"
                          :
        switch (signo) {

        case 
# 412 "project/nginx/src/os/unix/ngx_process.c" 3 4
            28
# 412 "project/nginx/src/os/unix/ngx_process.c"
                                                 :
            if (!ngx_daemonized) {
                break;
            }
        ...
        case 
# 418 "project/nginx/src/os/unix/ngx_process.c" 3 4
            3
# 418 "project/nginx/src/os/unix/ngx_process.c"
                                                 :
            ngx_quit = 1;
            action = ", shutting down";
            break;
        ...
        case 
# 423 "project/nginx/src/os/unix/ngx_process.c" 3 4
            15
# 423 "project/nginx/src/os/unix/ngx_process.c"
                                                  :
        case 
# 424 "project/nginx/src/os/unix/ngx_process.c" 3 4
            2
# 424 "project/nginx/src/os/unix/ngx_process.c"
                  :
            ngx_terminate = 1;
            action = ", exiting";
            break;
        ...
        case 
# 429 "project/nginx/src/os/unix/ngx_process.c" 3 4
            30
# 429 "project/nginx/src/os/unix/ngx_process.c"
                                               :
            ngx_reopen = 1;
            action = ", reopening logs";
            break;
        ...
        case 
# 434 "project/nginx/src/os/unix/ngx_process.c" 3 4
            1
# 434 "project/nginx/src/os/unix/ngx_process.c"
                                                    :
        case 
# 435 "project/nginx/src/os/unix/ngx_process.c" 3 4
            31
# 435 "project/nginx/src/os/unix/ngx_process.c"
                                                  :
        case 
# 436 "project/nginx/src/os/unix/ngx_process.c" 3 4
            23
# 436 "project/nginx/src/os/unix/ngx_process.c"
                 :
            action = ", ignoring";
            break;
        }
...
# 445 "project/nginx/src/os/unix/ngx_process.c" 3 4
       if ((
# 445 "project/nginx/src/os/unix/ngx_process.c"
       ngx_cycle->log
# 445 "project/nginx/src/os/unix/ngx_process.c" 3 4
       )->log_level >= 6) ngx_log_error_core(6, 
# 445 "project/nginx/src/os/unix/ngx_process.c"
...
# 445 "project/nginx/src/os/unix/ngx_process.c" 3 4
       , 
# 445 "project/nginx/src/os/unix/ngx_process.c"
       0, "signal %d (%s) received from %P%s", signo, sig->signame, siginfo->si_pid, action
# 445 "project/nginx/src/os/unix/ngx_process.c" 3 4
       )

                                                                   
# 447 "project/nginx/src/os/unix/ngx_process.c"
                                                                  ;

    } else {
        
# 450 "project/nginx/src/os/unix/ngx_process.c" 3 4
       if ((
# 450 "project/nginx/src/os/unix/ngx_process.c"
       ngx_cycle->log
# 450 "project/nginx/src/os/unix/ngx_process.c" 3 4
       )->log_level >= 6) ngx_log_error_core(6, 
# 450 "project/nginx/src/os/unix/ngx_process.c"
...
# 450 "project/nginx/src/os/unix/ngx_process.c" 3 4
       , 
# 450 "project/nginx/src/os/unix/ngx_process.c"
       0, "signal %d (%s) received%s", signo, sig->signame, action
# 450 "project/nginx/src/os/unix/ngx_process.c" 3 4
       )

                                                  
# 452 "project/nginx/src/os/unix/ngx_process.c"
                                                 ;
    }

    if (ignore) {
        
# 456 "project/nginx/src/os/unix/ngx_process.c" 3 4
       if ((
# 456 "project/nginx/src/os/unix/ngx_process.c"
       ngx_cycle->log
# 456 "project/nginx/src/os/unix/ngx_process.c" 3 4
...
# 456 "project/nginx/src/os/unix/ngx_process.c" 3 4
       , 
# 456 "project/nginx/src/os/unix/ngx_process.c"
       0, "the changing binary signal is ignored: " "you should shutdown or terminate " "before either old or new binary's process"
# 456 "project/nginx/src/os/unix/ngx_process.c" 3 4
       )


                                                                  
# 459 "project/nginx/src/os/unix/ngx_process.c"
                                                                 ;
    }

    if (signo == 
# 462 "project/nginx/src/os/unix/ngx_process.c" 3 4
                20
# 462 "project/nginx/src/os/unix/ngx_process.c"
                       ) {
        ngx_process_get_status();
    }

    
# 466 "project/nginx/src/os/unix/ngx_process.c" 3 4
   (*__error()) = 
# 466 "project/nginx/src/os/unix/ngx_process.c"
   err;
}
...
# 483 "project/nginx/src/os/unix/ngx_process.c" 3 4
                                  0x00000001
# 483 "project/nginx/src/os/unix/ngx_process.c"
                                         );
        ...
        if (pid == -1) {
            err = 
# 490 "project/nginx/src/os/unix/ngx_process.c" 3 4
                 (*__error())
# 490 "project/nginx/src/os/unix/ngx_process.c"
                          ;

            if (err == 
# 492 "project/nginx/src/os/unix/ngx_process.c" 3 4
                      4
# 492 "project/nginx/src/os/unix/ngx_process.c"
                               ) {
                continue;
            }

            if (err == 
# 496 "project/nginx/src/os/unix/ngx_process.c" 3 4
                      10 
# 496 "project/nginx/src/os/unix/ngx_process.c"
                                 && one) {
                return;
            }
# 509 "project/nginx/src/os/unix/ngx_process.c"
            if (err == 
# 509 "project/nginx/src/os/unix/ngx_process.c" 3 4
                      10
# 509 "project/nginx/src/os/unix/ngx_process.c"
                                ) {
                
# 510 "project/nginx/src/os/unix/ngx_process.c" 3 4
               if ((
# 510 "project/nginx/src/os/unix/ngx_process.c"
               ngx_cycle->log
# 510 "project/nginx/src/os/unix/ngx_process.c" 3 4
...
# 511 "project/nginx/src/os/unix/ngx_process.c"
                                                ;
                return;
            }

            
# 515 "project/nginx/src/os/unix/ngx_process.c" 3 4
           if ((
# 515 "project/nginx/src/os/unix/ngx_process.c"
           ngx_cycle->log
# 515 "project/nginx/src/os/unix/ngx_process.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 515 "project/nginx/src/os/unix/ngx_process.c"
...
# 516 "project/nginx/src/os/unix/ngx_process.c"
                                            ;
            return;
        }
        ...
        if (
# 533 "project/nginx/src/os/unix/ngx_process.c" 3 4
           (((*(int *)&(
# 533 "project/nginx/src/os/unix/ngx_process.c"
           status
# 533 "project/nginx/src/os/unix/ngx_process.c" 3 4
           )) & 0177))
# 533 "project/nginx/src/os/unix/ngx_process.c"
...
# 535 "project/nginx/src/os/unix/ngx_process.c" 3 4
           if ((
# 535 "project/nginx/src/os/unix/ngx_process.c"
           ngx_cycle->log
# 535 "project/nginx/src/os/unix/ngx_process.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 535 "project/nginx/src/os/unix/ngx_process.c"
...
# 535 "project/nginx/src/os/unix/ngx_process.c" 3 4
           , 
# 535 "project/nginx/src/os/unix/ngx_process.c"
           0, "%s %P exited on signal %d%s", process, pid, 
# 535 "project/nginx/src/os/unix/ngx_process.c" 3 4
           (((*(int *)&(
# 535 "project/nginx/src/os/unix/ngx_process.c"
           status
...
# 538 "project/nginx/src/os/unix/ngx_process.c"
                                                                   ;
...
# 546 "project/nginx/src/os/unix/ngx_process.c" 3 4
           if ((
# 546 "project/nginx/src/os/unix/ngx_process.c"
           ngx_cycle->log
# 546 "project/nginx/src/os/unix/ngx_process.c" 3 4
           )->log_level >= 6) ngx_log_error_core(6, 
# 546 "project/nginx/src/os/unix/ngx_process.c"
...
# 546 "project/nginx/src/os/unix/ngx_process.c" 3 4
           , 
# 546 "project/nginx/src/os/unix/ngx_process.c"
           0, "%s %P exited with code %d", process, pid, 
# 546 "project/nginx/src/os/unix/ngx_process.c" 3 4
           (((*(int *)&(
# 546 "project/nginx/src/os/unix/ngx_process.c"
           status
...
# 548 "project/nginx/src/os/unix/ngx_process.c"
                                                           ;
        }

        if (
# 551 "project/nginx/src/os/unix/ngx_process.c" 3 4
           (((*(int *)&(
# 551 "project/nginx/src/os/unix/ngx_process.c"
           status
# 551 "project/nginx/src/os/unix/ngx_process.c" 3 4
           )) >> 8) & 0x000000ff) 
# 551 "project/nginx/src/os/unix/ngx_process.c"
                               == 2 && ngx_processes[i].respawn) {
            
# 552 "project/nginx/src/os/unix/ngx_process.c" 3 4
           if ((
# 552 "project/nginx/src/os/unix/ngx_process.c"
           ngx_cycle->log
# 552 "project/nginx/src/os/unix/ngx_process.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 552 "project/nginx/src/os/unix/ngx_process.c"
...
# 552 "project/nginx/src/os/unix/ngx_process.c" 3 4
           , 
# 552 "project/nginx/src/os/unix/ngx_process.c"
           0, "%s %P exited with fatal code %d " "and cannot be respawned", process, pid, 
# 552 "project/nginx/src/os/unix/ngx_process.c" 3 4
           (((*(int *)&(
# 552 "project/nginx/src/os/unix/ngx_process.c"
           status
...
# 555 "project/nginx/src/os/unix/ngx_process.c"
                                                           ;
...
ngx_unlock_mutexes(ngx_pid_t pid)
{
    ...
    for (i = 0; ; i++) {
        ...
        if (i >= part->nelts) {
            if (part->next == 
# 592 "project/nginx/src/os/unix/ngx_process.c" 3 4
                             ((void *)0)
# 592 "project/nginx/src/os/unix/ngx_process.c"
                                 ) {
                break;
            }
            part = part->next;
...
# 603 "project/nginx/src/os/unix/ngx_process.c" 3 4
           if ((
# 603 "project/nginx/src/os/unix/ngx_process.c"
           ngx_cycle->log
# 603 "project/nginx/src/os/unix/ngx_process.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 603 "project/nginx/src/os/unix/ngx_process.c"
...
# 603 "project/nginx/src/os/unix/ngx_process.c" 3 4
           , 
# 603 "project/nginx/src/os/unix/ngx_process.c"
           0, "shared memory zone \"%V\" was locked by %P", &shm_zone[i].shm.name, pid
# 603 "project/nginx/src/os/unix/ngx_process.c" 3 4
           )

                                                     
# 605 "project/nginx/src/os/unix/ngx_process.c"
                                                    ;
        }
    }
}
...
ngx_debug_point(void)
{
    ...
    ccf = (ngx_core_conf_t *) ngx_cycle->conf_ctx
# 616 "project/nginx/src/os/unix/ngx_process.c" 3 4
                             [
# 616 "project/nginx/src/os/unix/ngx_process.c"
                             ngx_core_module
# 616 "project/nginx/src/os/unix/ngx_process.c" 3 4
                             .index]
                                                           
# 617 "project/nginx/src/os/unix/ngx_process.c"
                                                          ;

    switch (ccf->debug_points) {

    case 
# 621 "project/nginx/src/os/unix/ngx_process.c" 3 4
        1
# 621 "project/nginx/src/os/unix/ngx_process.c"
                             :
        raise(
# 622 "project/nginx/src/os/unix/ngx_process.c" 3 4
             17
# 622 "project/nginx/src/os/unix/ngx_process.c"
                    );
        break;

    case 
# 625 "project/nginx/src/os/unix/ngx_process.c" 3 4
        2
# 625 "project/nginx/src/os/unix/ngx_process.c"
                              :
        
# 626 "project/nginx/src/os/unix/ngx_process.c" 3 4
       abort
# 626 "project/nginx/src/os/unix/ngx_process.c"
                ();
    }
}
...
ngx_os_signal_process(ngx_cycle_t *cycle, char *name, ngx_pid_t pid)
{
    ...
    for (sig = signals; sig->signo != 0; sig++) {
        if (
# 637 "project/nginx/src/os/unix/ngx_process.c" 3 4
           strcmp((const char *) 
# 637 "project/nginx/src/os/unix/ngx_process.c"
           name
# 637 "project/nginx/src/os/unix/ngx_process.c" 3 4
           , (const char *) 
# 637 "project/nginx/src/os/unix/ngx_process.c"
...
# 642 "project/nginx/src/os/unix/ngx_process.c" 3 4
           if ((
# 642 "project/nginx/src/os/unix/ngx_process.c"
           cycle->log
# 642 "project/nginx/src/os/unix/ngx_process.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 642 "project/nginx/src/os/unix/ngx_process.c"
...
# 643 "project/nginx/src/os/unix/ngx_process.c"
                                                                ;
        }
    }
