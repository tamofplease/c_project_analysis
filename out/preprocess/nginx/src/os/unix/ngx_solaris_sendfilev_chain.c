# 0 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
...
# 9 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 2
...
# 11 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 2
# 41 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
...
ngx_solaris_sendfilev_chain(ngx_connection_t *c, ngx_chain_t *in, off_t limit)
{
    ...
    ngx_buf_t *file;
    ngx_uint_t nsfv;
    sendfilevec_t *sfv, sfvs[
# 53 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
                             64
# 53 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
                                             ];
    ngx_event_t *wev;
    ngx_chain_t *cl;
...
# 70 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
                                      9223372036854775807LL 
# 70 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
                                                           - ngx_pagesize)) {
        limit = 
# 71 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
               9223372036854775807LL 
# 71 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
                                    - ngx_pagesize;
    }
    ...
    for ( ;; ) {
        fd = SFV_FD_SELF;
        prev = 
# 79 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
              ((void *)0)
# 79 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
                  ;
        fprev = 0;
        file = 
# 81 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
              ((void *)0)
# 81 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
                  ;
        sfv = 
# 82 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
             ((void *)0)
# 82 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
                 ;
        eintr = 0;
        sent = 0;
        prev_send = send;
        ...
        for (cl = in; cl && send < limit; cl = cl->next) {
            ...
            if (
# 93 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
               (((
# 93 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
               cl->buf
# 93 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
               )->flush || (
# 93 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
...
# 93 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
            ...
            if (
# 97 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
               (((
# 97 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
               cl->buf
# 97 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
               )->temporary || (
# 97 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
...
# 97 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
                ...
                if (prev == cl->buf->pos) {
                    ...
                    if (nsfv == 
# 110 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
                               64
# 110 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
                                               ) {
                        break;
                    }
                ...
                prev = 
# 126 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
                      ((void *)0)
# 126 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
                          ;
                ...
                if (fd == cl->buf->file->fd && fprev == cl->buf->file_pos) {
                    ...
                    if (nsfv == 
# 145 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
                               64
# 145 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
                                               ) {
                        break;
                    }
        ...
        if (n == -1) {
            err = 
# 167 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
                 (*__error())
# 167 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
                          ;

            switch (err) {
            case 
# 170 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
                35
# 170 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
                          :
                break;

            case 
# 173 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
                4
# 173 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
                         :
                eintr = 1;
                break;
            ...
            default:
                ...
                return 
# 180 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
                      (ngx_chain_t *) -1
# 180 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
                                     ;
            }
...
# 195 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
               if ((
# 195 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
               c->log
# 195 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
...
# 195 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
               , 
# 195 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
               0, "sendfilev() reported that \"%s\" was truncated at %O", file->file->name.data, file->file_pos
# 195 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
               )

                                                              
# 197 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
                                                             ;

            } else {
                
# 200 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
               if ((
# 200 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
               c->log
# 200 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 200 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
...
# 200 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
               , 
# 200 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
               0, "sendfilev() returned 0 with memory buffers"
# 200 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
               )
                                                                           
# 201 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
                                                                          ;
            }

            return 
# 204 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
                  (ngx_chain_t *) -1
# 204 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
                                 ;
        }
        ...
        if (send >= limit || in == 
# 224 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c" 3 4
                                  ((void *)0)
# 224 "project/nginx/src/os/unix/ngx_solaris_sendfilev_chain.c"
                                      ) {
            return in;
        }
    }
