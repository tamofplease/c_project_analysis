# 0 "project/nginx/src/os/unix/ngx_posix_init.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/unix/ngx_posix_init.c"
...
# 9 "project/nginx/src/os/unix/ngx_posix_init.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_posix_init.c" 2




# 13 "project/nginx/src/os/unix/ngx_posix_init.c"
ngx_int_t ngx_ncpu;
...
# 44 "project/nginx/src/os/unix/ngx_posix_init.c" 3 4
                                    0
# 44 "project/nginx/src/os/unix/ngx_posix_init.c"
                                          ) {
        return 
# 45 "project/nginx/src/os/unix/ngx_posix_init.c" 3 4
              -1
# 45 "project/nginx/src/os/unix/ngx_posix_init.c"
                       ;
    }


    if (ngx_init_setproctitle(log) != 
# 49 "project/nginx/src/os/unix/ngx_posix_init.c" 3 4
                                     0
# 49 "project/nginx/src/os/unix/ngx_posix_init.c"
                                           ) {
        return 
# 50 "project/nginx/src/os/unix/ngx_posix_init.c" 3 4
              -1
# 50 "project/nginx/src/os/unix/ngx_posix_init.c"
                       ;
    }

    ngx_pagesize = getpagesize();
    ngx_cacheline_size = 
# 54 "project/nginx/src/os/unix/ngx_posix_init.c" 3 4
                        64
# 54 "project/nginx/src/os/unix/ngx_posix_init.c"
                                          ;
    ...
    if (ngx_ncpu == 0) {
        ngx_ncpu = sysconf(
# 60 "project/nginx/src/os/unix/ngx_posix_init.c" 3 4
                          58
# 60 "project/nginx/src/os/unix/ngx_posix_init.c"
                                              );
    }
...
# 75 "project/nginx/src/os/unix/ngx_posix_init.c"
    ngx_cpuinfo();

    if (getrlimit(
# 77 "project/nginx/src/os/unix/ngx_posix_init.c" 3 4
                 8
# 77 "project/nginx/src/os/unix/ngx_posix_init.c"
                              , &rlmt) == -1) {
        
# 78 "project/nginx/src/os/unix/ngx_posix_init.c" 3 4
       if ((
# 78 "project/nginx/src/os/unix/ngx_posix_init.c"
       log
# 78 "project/nginx/src/os/unix/ngx_posix_init.c" 3 4
...
# 79 "project/nginx/src/os/unix/ngx_posix_init.c"
                                                       ;
        return 
# 80 "project/nginx/src/os/unix/ngx_posix_init.c" 3 4
              -1
# 80 "project/nginx/src/os/unix/ngx_posix_init.c"
                       ;
    }
    ...
    tp = 
# 91 "project/nginx/src/os/unix/ngx_posix_init.c" 3 4
        (ngx_time_t *) ngx_cached_time
# 91 "project/nginx/src/os/unix/ngx_posix_init.c"
                       ;
    srandom(((unsigned) ngx_pid << 16) ^ tp->sec ^ tp->msec);

    return 
# 94 "project/nginx/src/os/unix/ngx_posix_init.c" 3 4
          0
# 94 "project/nginx/src/os/unix/ngx_posix_init.c"
                ;
}
...
# 101 "project/nginx/src/os/unix/ngx_posix_init.c" 3 4
   if ((
# 101 "project/nginx/src/os/unix/ngx_posix_init.c"
   log
# 101 "project/nginx/src/os/unix/ngx_posix_init.c" 3 4
...
# 104 "project/nginx/src/os/unix/ngx_posix_init.c" 3 4
   if ((
# 104 "project/nginx/src/os/unix/ngx_posix_init.c"
   log
# 104 "project/nginx/src/os/unix/ngx_posix_init.c" 3 4
   )->log_level >= 6) ngx_log_error_core(6, 
# 104 "project/nginx/src/os/unix/ngx_posix_init.c"
...
# 111 "project/nginx/src/os/unix/ngx_posix_init.c" 3 4
   if ((
# 111 "project/nginx/src/os/unix/ngx_posix_init.c"
   log
# 111 "project/nginx/src/os/unix/ngx_posix_init.c" 3 4
   )->log_level >= 6) ngx_log_error_core(6, 
# 111 "project/nginx/src/os/unix/ngx_posix_init.c"
...
# 111 "project/nginx/src/os/unix/ngx_posix_init.c" 3 4
   , 
# 111 "project/nginx/src/os/unix/ngx_posix_init.c"
   0, "getrlimit(RLIMIT_NOFILE): %r:%r", rlmt.rlim_cur, rlmt.rlim_max
# 111 "project/nginx/src/os/unix/ngx_posix_init.c" 3 4
   )

                                               
# 113 "project/nginx/src/os/unix/ngx_posix_init.c"
                                              ;
}
