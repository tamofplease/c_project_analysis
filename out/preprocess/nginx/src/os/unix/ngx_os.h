# 0 "project/nginx/src/os/unix/ngx_os.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/unix/ngx_os.h"
# 12 "project/nginx/src/os/unix/ngx_os.h"
...
# 13 "project/nginx/src/os/unix/ngx_os.h" 2
...
# 14 "project/nginx/src/os/unix/ngx_os.h" 2
...
# 19 "project/nginx/src/os/unix/ngx_os.h"
...
ngx_chain_t *ngx_udp_unix_sendmsg_chain(ngx_connection_t *c, ngx_chain_t *in,
    off_t limit);
# 64 "project/nginx/src/os/unix/ngx_os.h"
typedef struct {
    struct iovec *iovs;
    ngx_uint_t count;
    size_t size;
...
# 98 "project/nginx/src/os/unix/ngx_os.h"
...
# 99 "project/nginx/src/os/unix/ngx_os.h" 2
