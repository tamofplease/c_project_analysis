# 0 "project/nginx/src/os/unix/ngx_udp_recv.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/unix/ngx_udp_recv.c"
...
# 9 "project/nginx/src/os/unix/ngx_udp_recv.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_udp_recv.c" 2
...
# 11 "project/nginx/src/os/unix/ngx_udp_recv.c" 2



# 13 "project/nginx/src/os/unix/ngx_udp_recv.c"
ssize_t
ngx_udp_unix_recv(ngx_connection_t *c, u_char *buf, size_t size)
{
    ...
    do {
        ...
        if (n >= 0) {
            ...
            if (ngx_event_flags & 
# 32 "project/nginx/src/os/unix/ngx_udp_recv.c" 3 4
                                 0x00000008
# 32 "project/nginx/src/os/unix/ngx_udp_recv.c"
                                                     ) {
                rev->available -= n;
        ...
        err = 
# 51 "project/nginx/src/os/unix/ngx_udp_recv.c" 3 4
             (*__error())
# 51 "project/nginx/src/os/unix/ngx_udp_recv.c"
                             ;

        if (err == 
# 53 "project/nginx/src/os/unix/ngx_udp_recv.c" 3 4
                  35 
# 53 "project/nginx/src/os/unix/ngx_udp_recv.c"
                             || err == 
# 53 "project/nginx/src/os/unix/ngx_udp_recv.c" 3 4
                                       4
# 53 "project/nginx/src/os/unix/ngx_udp_recv.c"
                                              ...
                                              ;
            n = 
# 56 "project/nginx/src/os/unix/ngx_udp_recv.c" 3 4
               -2
# 56 "project/nginx/src/os/unix/ngx_udp_recv.c"
                        ;
...
# 63 "project/nginx/src/os/unix/ngx_udp_recv.c" 3 4
                   4
# 63 "project/nginx/src/os/unix/ngx_udp_recv.c"
                            );

    rev->ready = 0;

    if (n == 
# 67 "project/nginx/src/os/unix/ngx_udp_recv.c" 3 4
            -1
# 67 "project/nginx/src/os/unix/ngx_udp_recv.c"
                     ) {
        rev->error = 1;
    }
