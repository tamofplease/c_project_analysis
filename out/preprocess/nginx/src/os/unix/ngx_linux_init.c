# 0 "project/nginx/src/os/unix/ngx_linux_init.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/unix/ngx_linux_init.c"
...
# 9 "project/nginx/src/os/unix/ngx_linux_init.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_linux_init.c" 2



# 12 "project/nginx/src/os/unix/ngx_linux_init.c"
...
# 25 "project/nginx/src/os/unix/ngx_linux_init.c" 3 4
   1
...
# 30 "project/nginx/src/os/unix/ngx_linux_init.c"
};
...
# 39 "project/nginx/src/os/unix/ngx_linux_init.c" 3 4
       if ((
# 39 "project/nginx/src/os/unix/ngx_linux_init.c"
       log
# 39 "project/nginx/src/os/unix/ngx_linux_init.c" 3 4
...
# 39 "project/nginx/src/os/unix/ngx_linux_init.c"
                                                                     ;
        return 
# 40 "project/nginx/src/os/unix/ngx_linux_init.c" 3 4
              -1
# 40 "project/nginx/src/os/unix/ngx_linux_init.c"
                       ;
    }
    ...
    return 
# 51 "project/nginx/src/os/unix/ngx_linux_init.c" 3 4
          0
# 51 "project/nginx/src/os/unix/ngx_linux_init.c"
                ;
}
...
# 58 "project/nginx/src/os/unix/ngx_linux_init.c" 3 4
   if ((
# 58 "project/nginx/src/os/unix/ngx_linux_init.c"
   log
# 58 "project/nginx/src/os/unix/ngx_linux_init.c" 3 4
...
# 58 "project/nginx/src/os/unix/ngx_linux_init.c" 3 4
   , 
# 58 "project/nginx/src/os/unix/ngx_linux_init.c"
   0, "OS: %s %s", ngx_linux_kern_ostype, ngx_linux_kern_osrelease
# 58 "project/nginx/src/os/unix/ngx_linux_init.c" 3 4
   )
                                                                  
# 59 "project/nginx/src/os/unix/ngx_linux_init.c"
                                                                 ;
}
