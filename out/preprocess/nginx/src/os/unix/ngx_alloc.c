# 0 "project/nginx/src/os/unix/ngx_alloc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/unix/ngx_alloc.c"
...
# 9 "project/nginx/src/os/unix/ngx_alloc.c" 2
...
# 10 "project/nginx/src/os/unix/ngx_alloc.c" 2



# 12 "project/nginx/src/os/unix/ngx_alloc.c"
...
ngx_alloc(size_t size, ngx_log_t *log)
{
    ...
    p = malloc(size);
    if (p == 
# 23 "project/nginx/src/os/unix/ngx_alloc.c" 3 4
            ((void *)0)
# 23 "project/nginx/src/os/unix/ngx_alloc.c"
                ) {
        
# 24 "project/nginx/src/os/unix/ngx_alloc.c" 3 4
       if ((
# 24 "project/nginx/src/os/unix/ngx_alloc.c"
       log
# 24 "project/nginx/src/os/unix/ngx_alloc.c" 3 4
...
# 25 "project/nginx/src/os/unix/ngx_alloc.c"
                                                ;
    }
...
# 42 "project/nginx/src/os/unix/ngx_alloc.c" 3 4
       (void) __builtin___memset_chk (
# 42 "project/nginx/src/os/unix/ngx_alloc.c"
       p
# 42 "project/nginx/src/os/unix/ngx_alloc.c" 3 4
       , 0, 
# 42 "project/nginx/src/os/unix/ngx_alloc.c"
...
# 60 "project/nginx/src/os/unix/ngx_alloc.c" 3 4
       if ((
# 60 "project/nginx/src/os/unix/ngx_alloc.c"
       log
# 60 "project/nginx/src/os/unix/ngx_alloc.c" 3 4
       )->log_level >= 1) ngx_log_error_core(1, 
# 60 "project/nginx/src/os/unix/ngx_alloc.c"
...
# 60 "project/nginx/src/os/unix/ngx_alloc.c" 3 4
       , 
# 60 "project/nginx/src/os/unix/ngx_alloc.c"
       err, "posix_memalign(%uz, %uz) failed", alignment, size
# 60 "project/nginx/src/os/unix/ngx_alloc.c" 3 4
       )
                                                                         
# 61 "project/nginx/src/os/unix/ngx_alloc.c"
                                                                        ;
        p = 
# 62 "project/nginx/src/os/unix/ngx_alloc.c" 3 4
           ((void *)0)
# 62 "project/nginx/src/os/unix/ngx_alloc.c"
               ;
    }
