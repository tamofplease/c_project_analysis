# 0 "project/nginx/src/os/win32/ngx_files.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/win32/ngx_files.h"
# 12 "project/nginx/src/os/win32/ngx_files.h"
...
# 13 "project/nginx/src/os/win32/ngx_files.h" 2
...
# 14 "project/nginx/src/os/win32/ngx_files.h" 2



# 16 "project/nginx/src/os/win32/ngx_files.h"
...
# 72 "project/nginx/src/os/win32/ngx_files.h"
ngx_fd_t ngx_open_file(u_char *name, u_long mode, u_long create, u_long access);
# 106 "project/nginx/src/os/win32/ngx_files.h"
...
# 128 "project/nginx/src/os/win32/ngx_files.h"
...
# 171 "project/nginx/src/os/win32/ngx_files.h"
ngx_int_t ngx_create_file_mapping(ngx_file_mapping_t *fm);
void ngx_close_file_mapping(ngx_file_mapping_t *fm);


u_char *ngx_realpath(u_char *path, u_char *resolved);
# 185 "project/nginx/src/os/win32/ngx_files.h"
