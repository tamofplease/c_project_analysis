# 0 "project/nginx/src/os/win32/ngx_wsarecv.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/win32/ngx_wsarecv.c"
...
# 9 "project/nginx/src/os/win32/ngx_wsarecv.c" 2
...
# 10 "project/nginx/src/os/win32/ngx_wsarecv.c" 2
...
# 11 "project/nginx/src/os/win32/ngx_wsarecv.c" 2



# 13 "project/nginx/src/os/win32/ngx_wsarecv.c"
ssize_t
...
# 28 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
                                                  ((void *)0)
# 28 "project/nginx/src/os/win32/ngx_wsarecv.c"
                                                      , 
# 28 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
                                                        ((void *)0)
# 28 "project/nginx/src/os/win32/ngx_wsarecv.c"
    ...
    if (rc == -1) {
        rev->ready = 0;
        err = 
# 37 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
             (*__error())
# 37 "project/nginx/src/os/win32/ngx_wsarecv.c"
                             ;
        ...
        if (err == WSAEWOULDBLOCK) {
                                                 ...
                                                 ;
            return 
# 42 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
                  -2
# 42 "project/nginx/src/os/win32/ngx_wsarecv.c"
                           ;
        }
        ...
        if (n == 
# 47 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
                -1
# 47 "project/nginx/src/os/win32/ngx_wsarecv.c"
                         ) {
            rev->error = 1;
        }
    ...
    if (rev->available >= 0 && bytes > 0) {
        rev->available -= bytes;
# 66 "project/nginx/src/os/win32/ngx_wsarecv.c"
        if (rev->available < 0) {
            rev->available = 0;
            rev->ready = 0;
        }
        ...
        if (
# 76 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
           ioctl(
# 76 "project/nginx/src/os/win32/ngx_wsarecv.c"
           c->fd
# 76 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
...
# 77 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
                                       (*__error())
# 77 "project/nginx/src/os/win32/ngx_wsarecv.c"
                                                       ,
                                     
# 78 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
                                    "ioctl(FIONREAD)" 
# 78 "project/nginx/src/os/win32/ngx_wsarecv.c"
                                                       " failed");

            if (n == 
# 80 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
                    -1
# 80 "project/nginx/src/os/win32/ngx_wsarecv.c"
                             ) {
                rev->error = 1;
            }
...
# 119 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
       if ((
# 119 "project/nginx/src/os/win32/ngx_wsarecv.c"
       c->log
# 119 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
...
# 119 "project/nginx/src/os/win32/ngx_wsarecv.c"
                                                                 ;
        return 
# 120 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
              -2
# 120 "project/nginx/src/os/win32/ngx_wsarecv.c"
                       ;
    }
    ...
    if (rev->complete) {
        ...
        if (ngx_event_flags & 
# 129 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
                             0x00000200
# 129 "project/nginx/src/os/win32/ngx_wsarecv.c"
                                               ) {
            if (rev->ovlp.error) {
                ngx_connection_error(c, rev->ovlp.error, "WSARecv() failed");
                return 
# 132 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
                      -1
# 132 "project/nginx/src/os/win32/ngx_wsarecv.c"
                               ;
            }
        ...
        if (WSAGetOverlappedResult(c->fd, (LPWSAOVERLAPPED) &rev->ovlp,
                                   &bytes, 0, 
# 143 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
                                             ((void *)0)
# 143 "project/nginx/src/os/win32/ngx_wsarecv.c"
                                                 )
            == 0)
        {
            ngx_connection_error(c, 
# 146 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
                                   (*__error())
# 146 "project/nginx/src/os/win32/ngx_wsarecv.c"
                                                   ,
                               "WSARecv() or WSAGetOverlappedResult() failed");
            return 
# 148 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
                  -1
# 148 "project/nginx/src/os/win32/ngx_wsarecv.c"
                           ;
        }
...
# 158 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
   (void) __builtin___memset_chk (
# 158 "project/nginx/src/os/win32/ngx_wsarecv.c"
   ovlp
# 158 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
   , 0, 
# 158 "project/nginx/src/os/win32/ngx_wsarecv.c"
...
# 158 "project/nginx/src/os/win32/ngx_wsarecv.c"
    ...
    rc = WSARecv(c->fd, wsabuf, 1, &bytes, &flags, ovlp, 
# 164 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
                                                        ((void *)0)
# 164 "project/nginx/src/os/win32/ngx_wsarecv.c"
                                                            );
    ...
    if (rc == -1) {
        err = 
# 173 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
             (*__error())
# 173 "project/nginx/src/os/win32/ngx_wsarecv.c"
                             ;
        if (err == WSA_IO_PENDING) {
            rev->active = 1;
                                              ...
                                              ;
            return 
# 178 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
                  -2
# 178 "project/nginx/src/os/win32/ngx_wsarecv.c"
                           ;
        }
        ...
        if (n == 
# 183 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
                -1
# 183 "project/nginx/src/os/win32/ngx_wsarecv.c"
                         ) {
            rev->error = 1;
        }
    ...
    if (ngx_event_flags & 
# 190 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
                         0x00000200
# 190 "project/nginx/src/os/win32/ngx_wsarecv.c"
                                           ) {
        ...
        rev->active = 1;
        return 
# 199 "project/nginx/src/os/win32/ngx_wsarecv.c" 3 4
              -2
# 199 "project/nginx/src/os/win32/ngx_wsarecv.c"
                       ;
    }
