# 0 "project/nginx/src/os/win32/ngx_user.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 8 "project/nginx/src/os/win32/ngx_user.c" 2
...
# 9 "project/nginx/src/os/win32/ngx_user.c" 2





# 13 "project/nginx/src/os/win32/ngx_user.c"
ngx_int_t
ngx_libc_crypt(ngx_pool_t *pool, u_char *key, u_char *salt, u_char **encrypted)
{
    ...
    *encrypted = key;
    ...
    return 
# 20 "project/nginx/src/os/win32/ngx_user.c" 3 4
          0
# 20 "project/nginx/src/os/win32/ngx_user.c"
                ;
}
