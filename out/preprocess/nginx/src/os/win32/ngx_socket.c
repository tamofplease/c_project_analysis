# 0 "project/nginx/src/os/win32/ngx_socket.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/win32/ngx_socket.c"
...
# 9 "project/nginx/src/os/win32/ngx_socket.c" 2
...
# 10 "project/nginx/src/os/win32/ngx_socket.c" 2



# 12 "project/nginx/src/os/win32/ngx_socket.c"
int
ngx_nonblocking(ngx_socket_t s)
{
    unsigned long nb = 1;

    return ioctlsocket(s, 
# 17 "project/nginx/src/os/win32/ngx_socket.c" 3 4
                         ((__uint32_t)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('f')) << 8) | ((126)))
# 17 "project/nginx/src/os/win32/ngx_socket.c"
                                , &nb);
}
...
ngx_blocking(ngx_socket_t s)
{
    ...
    return ioctlsocket(s, 
# 26 "project/nginx/src/os/win32/ngx_socket.c" 3 4
                         ((__uint32_t)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('f')) << 8) | ((126)))
# 26 "project/nginx/src/os/win32/ngx_socket.c"
                                , &nb);
}
...
# 31 "project/nginx/src/os/win32/ngx_socket.c" 3 4
ioctl(
# 31 "project/nginx/src/os/win32/ngx_socket.c"
ngx_socket_t s
# 31 "project/nginx/src/os/win32/ngx_socket.c" 3 4
...
# 32 "project/nginx/src/os/win32/ngx_socket.c"
{
    unsigned long nread;

    if (ioctlsocket(s, 
# 35 "project/nginx/src/os/win32/ngx_socket.c" 3 4
                      ((__uint32_t)0x40000000 | ((sizeof(int) & 0x1fff) << 16) | ((('f')) << 8) | ((127)))
# 35 "project/nginx/src/os/win32/ngx_socket.c"
                              , &nread) == -1) {
        return -1;
    }
