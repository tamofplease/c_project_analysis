# 0 "project/nginx/src/os/win32/ngx_time.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 9 "project/nginx/src/os/win32/ngx_time.c" 2
...
# 10 "project/nginx/src/os/win32/ngx_time.c" 2



# 12 "project/nginx/src/os/win32/ngx_time.c"
void

# 13 "project/nginx/src/os/win32/ngx_time.c" 3 4
(void) gettimeofday(
# 13 "project/nginx/src/os/win32/ngx_time.c"
struct timeval *tp
# 13 "project/nginx/src/os/win32/ngx_time.c" 3 4
, ((void *)0));

# 14 "project/nginx/src/os/win32/ngx_time.c"
{
    uint64_t intervals;
    FILETIME ft;
