# 0 "project/nginx/src/os/win32/ngx_wsasend.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/win32/ngx_wsasend.c"
...
# 9 "project/nginx/src/os/win32/ngx_wsasend.c" 2
...
# 10 "project/nginx/src/os/win32/ngx_wsasend.c" 2
...
# 11 "project/nginx/src/os/win32/ngx_wsasend.c" 2



# 13 "project/nginx/src/os/win32/ngx_wsasend.c"
ssize_t
ngx_wsasend(ngx_connection_t *c, u_char *buf, size_t size)
{
    ...
    if (!wev->ready) {
        return 
# 25 "project/nginx/src/os/win32/ngx_wsasend.c" 3 4
              -2
# 25 "project/nginx/src/os/win32/ngx_wsasend.c"
                       ;
    }
    ...
    n = WSASend(c->fd, &wsabuf, 1, &sent, 0, 
# 38 "project/nginx/src/os/win32/ngx_wsasend.c" 3 4
                                            ((void *)0)
# 38 "project/nginx/src/os/win32/ngx_wsasend.c"
                                                , 
# 38 "project/nginx/src/os/win32/ngx_wsasend.c" 3 4
                                                  ((void *)0)
# 38 "project/nginx/src/os/win32/ngx_wsasend.c"
    ...
    err = 
# 53 "project/nginx/src/os/win32/ngx_wsasend.c" 3 4
         (*__error())
# 53 "project/nginx/src/os/win32/ngx_wsasend.c"
                         ;
    ...
    if (err == WSAEWOULDBLOCK) {
        ...
        wev->ready = 0;
        return 
# 58 "project/nginx/src/os/win32/ngx_wsasend.c" 3 4
              -2
# 58 "project/nginx/src/os/win32/ngx_wsasend.c"
                       ;
    }
    ...
    return 
# 64 "project/nginx/src/os/win32/ngx_wsasend.c" 3 4
          -1
# 64 "project/nginx/src/os/win32/ngx_wsasend.c"
                   ;
}
...
ngx_overlapped_wsasend(ngx_connection_t *c, u_char *buf, size_t size)
{
    ...
    if (!wev->ready) {
        return 
# 81 "project/nginx/src/os/win32/ngx_wsasend.c" 3 4
              -2
# 81 "project/nginx/src/os/win32/ngx_wsasend.c"
                       ;
    }
    ...
    if (!wev->complete) {
# 96 "project/nginx/src/os/win32/ngx_wsasend.c"
        wsabuf.buf = (char *) buf;
        wsabuf.len = size;
...
# 102 "project/nginx/src/os/win32/ngx_wsasend.c" 3 4
       (void) __builtin___memset_chk (
# 102 "project/nginx/src/os/win32/ngx_wsasend.c"
       ovlp
# 102 "project/nginx/src/os/win32/ngx_wsasend.c" 3 4
       , 0, 
# 102 "project/nginx/src/os/win32/ngx_wsasend.c"
...
# 102 "project/nginx/src/os/win32/ngx_wsasend.c"
        ...
        n = WSASend(c->fd, &wsabuf, 1, &sent, 0, ovlp, 
# 104 "project/nginx/src/os/win32/ngx_wsasend.c" 3 4
                                                      ((void *)0)
# 104 "project/nginx/src/os/win32/ngx_wsasend.c"
                                                          );
        ...
        if (n == 0) {
            if (ngx_event_flags & 
# 112 "project/nginx/src/os/win32/ngx_wsasend.c" 3 4
                                 0x00000200
# 112 "project/nginx/src/os/win32/ngx_wsasend.c"
                                                   ) {
                ...
                wev->active = 1;
                return 
# 121 "project/nginx/src/os/win32/ngx_wsasend.c" 3 4
                      -2
# 121 "project/nginx/src/os/win32/ngx_wsasend.c"
                               ;
            }
        ...
        err = 
# 133 "project/nginx/src/os/win32/ngx_wsasend.c" 3 4
             (*__error())
# 133 "project/nginx/src/os/win32/ngx_wsasend.c"
                             ;
        ...
        if (err == WSA_IO_PENDING) {
            ...
            wev->active = 1;
            return 
# 139 "project/nginx/src/os/win32/ngx_wsasend.c" 3 4
                  -2
# 139 "project/nginx/src/os/win32/ngx_wsasend.c"
                           ;
        }
        ...
        return 
# 145 "project/nginx/src/os/win32/ngx_wsasend.c" 3 4
              -1
# 145 "project/nginx/src/os/win32/ngx_wsasend.c"
                       ;
    }
    ...
    if (ngx_event_flags & 
# 153 "project/nginx/src/os/win32/ngx_wsasend.c" 3 4
                         0x00000200
# 153 "project/nginx/src/os/win32/ngx_wsasend.c"
                                           ) {

        if (wev->ovlp.error) {
            ngx_connection_error(c, wev->ovlp.error, "WSASend() failed");
            return 
# 157 "project/nginx/src/os/win32/ngx_wsasend.c" 3 4
                  -1
# 157 "project/nginx/src/os/win32/ngx_wsasend.c"
                           ;
        }
        ...
        if (WSAGetOverlappedResult(c->fd, (LPWSAOVERLAPPED) &wev->ovlp,
                                   &sent, 0, 
# 164 "project/nginx/src/os/win32/ngx_wsasend.c" 3 4
                                            ((void *)0)
# 164 "project/nginx/src/os/win32/ngx_wsasend.c"
                                                )
            == 0)
        {
            ngx_connection_error(c, 
# 167 "project/nginx/src/os/win32/ngx_wsasend.c" 3 4
                                   (*__error())
# 167 "project/nginx/src/os/win32/ngx_wsasend.c"
                                                   ,
                           "WSASend() or WSAGetOverlappedResult() failed");

            return 
# 170 "project/nginx/src/os/win32/ngx_wsasend.c" 3 4
                  -1
# 170 "project/nginx/src/os/win32/ngx_wsasend.c"
                           ;
        }
    }
