# 0 "project/nginx/src/os/win32/ngx_files.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/win32/ngx_files.c"
...
# 9 "project/nginx/src/os/win32/ngx_files.c" 2
...
# 10 "project/nginx/src/os/win32/ngx_files.c" 2





# 14 "project/nginx/src/os/win32/ngx_files.c"
...
# 22 "project/nginx/src/os/win32/ngx_files.c" 3 4
open((const char *) 
# 22 "project/nginx/src/os/win32/ngx_files.c"
u_char *name
# 22 "project/nginx/src/os/win32/ngx_files.c" 3 4
, 
# 22 "project/nginx/src/os/win32/ngx_files.c"
...
# 23 "project/nginx/src/os/win32/ngx_files.c"
{
    size_t len;
    u_short *u;
    ngx_fd_t fd;
    ...
    if (u == 
# 33 "project/nginx/src/os/win32/ngx_files.c" 3 4
            ((void *)0)
# 33 "project/nginx/src/os/win32/ngx_files.c"
                ) {
    ...
    if (create == 
# 39 "project/nginx/src/os/win32/ngx_files.c" 3 4
                 0
        
# 40 "project/nginx/src/os/win32/ngx_files.c"
       && ngx_win32_check_filename(name, u, len) != 
# 40 "project/nginx/src/os/win32/ngx_files.c" 3 4
                                                    0
# 40 "project/nginx/src/os/win32/ngx_files.c"
                                                          )
    {
...
# 47 "project/nginx/src/os/win32/ngx_files.c" 3 4
                    ((void *)0)
# 47 "project/nginx/src/os/win32/ngx_files.c"
                        , create, FILE_FLAG_BACKUP_SEMANTICS, 
# 47 "project/nginx/src/os/win32/ngx_files.c" 3 4
                                                              ((void *)0)
# 47 "project/nginx/src/os/win32/ngx_files.c"
                                                                  );
...
failed:
    ...
    if (u != utf16) {
        err = 
# 52 "project/nginx/src/os/win32/ngx_files.c" 3 4
             (*__error())
# 52 "project/nginx/src/os/win32/ngx_files.c"
                      ;
        
# 53 "project/nginx/src/os/win32/ngx_files.c" 3 4
       free
# 53 "project/nginx/src/os/win32/ngx_files.c"
               (u);
        
# 54 "project/nginx/src/os/win32/ngx_files.c" 3 4
       (*__error()) = 
# 54 "project/nginx/src/os/win32/ngx_files.c"
       err;
    }
...
ngx_read_file(ngx_file_t *file, u_char *buf, size_t size, off_t offset)
{
    ...
    ovlp.hEvent = 
# 72 "project/nginx/src/os/win32/ngx_files.c" 3 4
                 ((void *)0)
# 72 "project/nginx/src/os/win32/ngx_files.c"
                     ;
    ...
    if (ReadFile(file->fd, buf, size, &n, povlp) == 0) {
        err = 
# 77 "project/nginx/src/os/win32/ngx_files.c" 3 4
             (*__error())
# 77 "project/nginx/src/os/win32/ngx_files.c"
                      ;
...
# 83 "project/nginx/src/os/win32/ngx_files.c" 3 4
       if ((
# 83 "project/nginx/src/os/win32/ngx_files.c"
       file->log
# 83 "project/nginx/src/os/win32/ngx_files.c" 3 4
...
# 83 "project/nginx/src/os/win32/ngx_files.c" 3 4
       , 
# 83 "project/nginx/src/os/win32/ngx_files.c"
       err, "ReadFile() \"%s\" failed", file->name.data
# 83 "project/nginx/src/os/win32/ngx_files.c" 3 4
       )
                                                                  
# 84 "project/nginx/src/os/win32/ngx_files.c"
                                                                 ;
        return 
# 85 "project/nginx/src/os/win32/ngx_files.c" 3 4
              -1
# 85 "project/nginx/src/os/win32/ngx_files.c"
                       ;
    }
...
ngx_write_file(ngx_file_t *file, u_char *buf, size_t size, off_t offset)
{
    ...
    ovlp.OffsetHigh = (u_long) (offset >> 32);
    ovlp.hEvent = 
# 104 "project/nginx/src/os/win32/ngx_files.c" 3 4
                 ((void *)0)
# 104 "project/nginx/src/os/win32/ngx_files.c"
                     ;
...
# 109 "project/nginx/src/os/win32/ngx_files.c" 3 4
       if ((
# 109 "project/nginx/src/os/win32/ngx_files.c"
       file->log
# 109 "project/nginx/src/os/win32/ngx_files.c" 3 4
       )->log_level >= 4) ngx_log_error_core(4, 
# 109 "project/nginx/src/os/win32/ngx_files.c"
...
# 110 "project/nginx/src/os/win32/ngx_files.c"
                                                                  ;
        return 
# 111 "project/nginx/src/os/win32/ngx_files.c" 3 4
              -1
# 111 "project/nginx/src/os/win32/ngx_files.c"
                       ;
    }

    if (n != size) {
        
# 115 "project/nginx/src/os/win32/ngx_files.c" 3 4
       if ((
# 115 "project/nginx/src/os/win32/ngx_files.c"
       file->log
# 115 "project/nginx/src/os/win32/ngx_files.c" 3 4
...
# 115 "project/nginx/src/os/win32/ngx_files.c" 3 4
       , 
# 115 "project/nginx/src/os/win32/ngx_files.c"
       0, "WriteFile() \"%s\" has written only %ul of %uz", file->name.data, n, size
# 115 "project/nginx/src/os/win32/ngx_files.c" 3 4
       )

                                               
# 117 "project/nginx/src/os/win32/ngx_files.c"
                                              ;
        return 
# 118 "project/nginx/src/os/win32/ngx_files.c" 3 4
              -1
# 118 "project/nginx/src/os/win32/ngx_files.c"
                       ;
    }
    ...
    ngx_pool_t *pool)
{
    ...
    while (cl) {
        ...
        if (n == 
# 152 "project/nginx/src/os/win32/ngx_files.c" 3 4
                -1
# 152 "project/nginx/src/os/win32/ngx_files.c"
                         ) {
            return 
# 153 "project/nginx/src/os/win32/ngx_files.c" 3 4
                  -1
# 153 "project/nginx/src/os/win32/ngx_files.c"
                           ;
        }
...
# 165 "project/nginx/src/os/win32/ngx_files.c" 3 4
read
# 165 "project/nginx/src/os/win32/ngx_files.c"
          (ngx_fd_t fd, void *buf, size_t size)
{
    u_long n;

    if (ReadFile(fd, buf, size, &n, 
# 169 "project/nginx/src/os/win32/ngx_files.c" 3 4
                                   ((void *)0)
# 169 "project/nginx/src/os/win32/ngx_files.c"
                                       ) != 0) {
        return (size_t) n;
    }
...
ngx_write_fd(ngx_fd_t fd, void *buf, size_t size)
{
    ...
    if (WriteFile(fd, buf, size, &n, 
# 182 "project/nginx/src/os/win32/ngx_files.c" 3 4
                                    ((void *)0)
# 182 "project/nginx/src/os/win32/ngx_files.c"
                                        ) != 0) {
        return (size_t) n;
    }
...
# 191 "project/nginx/src/os/win32/ngx_files.c" 3 4
ngx_write_fd
# 191 "project/nginx/src/os/win32/ngx_files.c"
                (ngx_fd_t fd, void *buf, size_t size)
{
    u_long n;
    ...
    if (WriteFile(fd, buf, size, &n, 
# 197 "project/nginx/src/os/win32/ngx_files.c" 3 4
                                    ((void *)0)
# 197 "project/nginx/src/os/win32/ngx_files.c"
                                        ) != 0) {
        return (size_t) n;
    }
...
# 213 "project/nginx/src/os/win32/ngx_files.c" 3 4
                                  (sizeof("-9223372036854775808") - 1) 
# 213 "project/nginx/src/os/win32/ngx_files.c"
                                                   + 1 + sizeof("DELETE"),
                     log);
    if (name == 
# 215 "project/nginx/src/os/win32/ngx_files.c" 3 4
               ((void *)0)
# 215 "project/nginx/src/os/win32/ngx_files.c"
                   ) {
        return 
# 216 "project/nginx/src/os/win32/ngx_files.c" 3 4
              12
# 216 "project/nginx/src/os/win32/ngx_files.c"
                        ;
    }

    
# 219 "project/nginx/src/os/win32/ngx_files.c" 3 4
   (void) __builtin___memcpy_chk (
# 219 "project/nginx/src/os/win32/ngx_files.c"
   name
# 219 "project/nginx/src/os/win32/ngx_files.c" 3 4
   , 
# 219 "project/nginx/src/os/win32/ngx_files.c"
...
# 236 "project/nginx/src/os/win32/ngx_files.c" 3 4
       if ((
# 236 "project/nginx/src/os/win32/ngx_files.c"
       log
# 236 "project/nginx/src/os/win32/ngx_files.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 236 "project/nginx/src/os/win32/ngx_files.c"
...
# 237 "project/nginx/src/os/win32/ngx_files.c"
                                                                          ;
    }

    if (MoveFile((const char *) from->data, (const char *) to->data) == 0) {
        err = 
# 241 "project/nginx/src/os/win32/ngx_files.c" 3 4
             (*__error())
# 241 "project/nginx/src/os/win32/ngx_files.c"
                      ;
...
# 248 "project/nginx/src/os/win32/ngx_files.c" 3 4
       if ((
# 248 "project/nginx/src/os/win32/ngx_files.c"
       log
# 248 "project/nginx/src/os/win32/ngx_files.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 248 "project/nginx/src/os/win32/ngx_files.c"
...
# 249 "project/nginx/src/os/win32/ngx_files.c"
                                                        ;
    }
...
# 254 "project/nginx/src/os/win32/ngx_files.c" 3 4
   free
# 254 "project/nginx/src/os/win32/ngx_files.c"
           (name);
...
# 261 "project/nginx/src/os/win32/ngx_files.c" 3 4
stat((const char *) 
# 261 "project/nginx/src/os/win32/ngx_files.c"
u_char *file
# 261 "project/nginx/src/os/win32/ngx_files.c" 3 4
, 
# 261 "project/nginx/src/os/win32/ngx_files.c"
...
# 262 "project/nginx/src/os/win32/ngx_files.c"
{
    size_t len;
    long rc;
    u_short *u;
    ...
    if (u == 
# 274 "project/nginx/src/os/win32/ngx_files.c" 3 4
            ((void *)0)
# 274 "project/nginx/src/os/win32/ngx_files.c"
                ) {
        return 
# 275 "project/nginx/src/os/win32/ngx_files.c" 3 4
              -1
# 275 "project/nginx/src/os/win32/ngx_files.c"
                            ;
    }

    rc = 
# 278 "project/nginx/src/os/win32/ngx_files.c" 3 4
        -1
# 278 "project/nginx/src/os/win32/ngx_files.c"
                      ;

    if (ngx_win32_check_filename(file, u, len) != 
# 280 "project/nginx/src/os/win32/ngx_files.c" 3 4
                                                 0
# 280 "project/nginx/src/os/win32/ngx_files.c"
                                                       ) {
        goto failed;
    }
...
failed:
    ...
    if (u != utf16) {
        err = 
# 296 "project/nginx/src/os/win32/ngx_files.c" 3 4
             (*__error())
# 296 "project/nginx/src/os/win32/ngx_files.c"
                      ;
        
# 297 "project/nginx/src/os/win32/ngx_files.c" 3 4
       free
# 297 "project/nginx/src/os/win32/ngx_files.c"
               (u);
        
# 298 "project/nginx/src/os/win32/ngx_files.c" 3 4
       (*__error()) = 
# 298 "project/nginx/src/os/win32/ngx_files.c"
       err;
    }
...
ngx_set_file_time(u_char *name, ngx_fd_t fd, time_t s)
{
    ...
    if (SetFileTime(fd, 
# 318 "project/nginx/src/os/win32/ngx_files.c" 3 4
                       ((void *)0)
# 318 "project/nginx/src/os/win32/ngx_files.c"
                           , 
# 318 "project/nginx/src/os/win32/ngx_files.c" 3 4
                             ((void *)0)
# 318 "project/nginx/src/os/win32/ngx_files.c"
                                 , &ft) != 0) {
        return 
# 319 "project/nginx/src/os/win32/ngx_files.c" 3 4
              0
# 319 "project/nginx/src/os/win32/ngx_files.c"
                    ;
    }

    return 
# 322 "project/nginx/src/os/win32/ngx_files.c" 3 4
          -1
# 322 "project/nginx/src/os/win32/ngx_files.c"
                   ;
}
...
ngx_create_file_mapping(ngx_file_mapping_t *fm)
{
    ...
    fm->fd = 
# 331 "project/nginx/src/os/win32/ngx_files.c" 3 4
            open((const char *) 
# 331 "project/nginx/src/os/win32/ngx_files.c"
            fm->name
# 331 "project/nginx/src/os/win32/ngx_files.c" 3 4
            , 0x0002|(0x00000200|0x00000400), 0644)
                                                   
# 332 "project/nginx/src/os/win32/ngx_files.c"
                                                  ;

    if (fm->fd == 
# 334 "project/nginx/src/os/win32/ngx_files.c" 3 4
                 -1
# 334 "project/nginx/src/os/win32/ngx_files.c"
                                 ) {
        
# 335 "project/nginx/src/os/win32/ngx_files.c" 3 4
       if ((
# 335 "project/nginx/src/os/win32/ngx_files.c"
       fm->log
# 335 "project/nginx/src/os/win32/ngx_files.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 335 "project/nginx/src/os/win32/ngx_files.c"
...
# 336 "project/nginx/src/os/win32/ngx_files.c"
                                                                ;
        return 
# 337 "project/nginx/src/os/win32/ngx_files.c" 3 4
              -1
# 337 "project/nginx/src/os/win32/ngx_files.c"
                       ;
    }

    fm->handle = 
# 340 "project/nginx/src/os/win32/ngx_files.c" 3 4
                ((void *)0)
# 340 "project/nginx/src/os/win32/ngx_files.c"
                    ;

    size.QuadPart = fm->size;

    if (SetFilePointerEx(fm->fd, size, 
# 344 "project/nginx/src/os/win32/ngx_files.c" 3 4
                                      ((void *)0)
# 344 "project/nginx/src/os/win32/ngx_files.c"
                                          , FILE_BEGIN) == 0) {
        
# 345 "project/nginx/src/os/win32/ngx_files.c" 3 4
       if ((
# 345 "project/nginx/src/os/win32/ngx_files.c"
       fm->log
# 345 "project/nginx/src/os/win32/ngx_files.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 345 "project/nginx/src/os/win32/ngx_files.c"
...
# 345 "project/nginx/src/os/win32/ngx_files.c" 3 4
       , (*__error())
# 345 "project/nginx/src/os/win32/ngx_files.c"
       , "SetFilePointerEx(\"%s\", %uz) failed", fm->name, fm->size
# 345 "project/nginx/src/os/win32/ngx_files.c" 3 4
       )

                                         
# 347 "project/nginx/src/os/win32/ngx_files.c"
                                        ;
        goto failed;
    }
...
# 352 "project/nginx/src/os/win32/ngx_files.c" 3 4
       if ((
# 352 "project/nginx/src/os/win32/ngx_files.c"
       fm->log
# 352 "project/nginx/src/os/win32/ngx_files.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 352 "project/nginx/src/os/win32/ngx_files.c"
...
# 353 "project/nginx/src/os/win32/ngx_files.c"
                                                              ;
        goto failed;
    }

    fm->handle = CreateFileMapping(fm->fd, 
# 357 "project/nginx/src/os/win32/ngx_files.c" 3 4
                                          ((void *)0)
# 357 "project/nginx/src/os/win32/ngx_files.c"
                                              , PAGE_READWRITE,
                                   (u_long) ((off_t) fm->size >> 32),
                                   (u_long) ((off_t) fm->size & 0xffffffff),
                                   
# 360 "project/nginx/src/os/win32/ngx_files.c" 3 4
                                  ((void *)0)
# 360 "project/nginx/src/os/win32/ngx_files.c"
                                      );
    if (fm->handle == 
# 361 "project/nginx/src/os/win32/ngx_files.c" 3 4
                     ((void *)0)
# 361 "project/nginx/src/os/win32/ngx_files.c"
                         ) {
        
# 362 "project/nginx/src/os/win32/ngx_files.c" 3 4
       if ((
# 362 "project/nginx/src/os/win32/ngx_files.c"
       fm->log
# 362 "project/nginx/src/os/win32/ngx_files.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 362 "project/nginx/src/os/win32/ngx_files.c"
...
# 362 "project/nginx/src/os/win32/ngx_files.c" 3 4
       , (*__error())
# 362 "project/nginx/src/os/win32/ngx_files.c"
       , "CreateFileMapping(%s, %uz) failed", fm->name, fm->size
# 362 "project/nginx/src/os/win32/ngx_files.c" 3 4
       )

                                         
# 364 "project/nginx/src/os/win32/ngx_files.c"
                                        ;
        goto failed;
    }
    ...
    if (fm->addr != 
# 370 "project/nginx/src/os/win32/ngx_files.c" 3 4
                   ((void *)0)
# 370 "project/nginx/src/os/win32/ngx_files.c"
                       ) {
        return 
# 371 "project/nginx/src/os/win32/ngx_files.c" 3 4
              0
# 371 "project/nginx/src/os/win32/ngx_files.c"
                    ;
    }

    
# 374 "project/nginx/src/os/win32/ngx_files.c" 3 4
   if ((
# 374 "project/nginx/src/os/win32/ngx_files.c"
   fm->log
# 374 "project/nginx/src/os/win32/ngx_files.c" 3 4
   )->log_level >= 3) ngx_log_error_core(3, 
# 374 "project/nginx/src/os/win32/ngx_files.c"
...
# 374 "project/nginx/src/os/win32/ngx_files.c" 3 4
   , (*__error())
# 374 "project/nginx/src/os/win32/ngx_files.c"
   , "MapViewOfFile(%uz) of file mapping \"%s\" failed", fm->size, fm->name
# 374 "project/nginx/src/os/win32/ngx_files.c" 3 4
   )

                                     
# 376 "project/nginx/src/os/win32/ngx_files.c"
                                    ;
...
# 382 "project/nginx/src/os/win32/ngx_files.c" 3 4
           if ((
# 382 "project/nginx/src/os/win32/ngx_files.c"
           fm->log
# 382 "project/nginx/src/os/win32/ngx_files.c" 3 4
...
# 382 "project/nginx/src/os/win32/ngx_files.c" 3 4
           , (*__error())
# 382 "project/nginx/src/os/win32/ngx_files.c"
           , "CloseHandle() of file mapping \"%s\" failed", fm->name
# 382 "project/nginx/src/os/win32/ngx_files.c" 3 4
           )

                                   
# 384 "project/nginx/src/os/win32/ngx_files.c"
                                  ;
        }
    }

    if (
# 388 "project/nginx/src/os/win32/ngx_files.c" 3 4
       close
# 388 "project/nginx/src/os/win32/ngx_files.c"
                     (fm->fd) == 
# 388 "project/nginx/src/os/win32/ngx_files.c" 3 4
                                 -1
# 388 "project/nginx/src/os/win32/ngx_files.c"
...
# 389 "project/nginx/src/os/win32/ngx_files.c" 3 4
       if ((
# 389 "project/nginx/src/os/win32/ngx_files.c"
       fm->log
# 389 "project/nginx/src/os/win32/ngx_files.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 389 "project/nginx/src/os/win32/ngx_files.c"
...
# 390 "project/nginx/src/os/win32/ngx_files.c"
                                                                 ;
    }

    return 
# 393 "project/nginx/src/os/win32/ngx_files.c" 3 4
          -1
# 393 "project/nginx/src/os/win32/ngx_files.c"
                   ;
}
...
# 401 "project/nginx/src/os/win32/ngx_files.c" 3 4
       if ((
# 401 "project/nginx/src/os/win32/ngx_files.c"
       fm->log
# 401 "project/nginx/src/os/win32/ngx_files.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 401 "project/nginx/src/os/win32/ngx_files.c"
...
# 401 "project/nginx/src/os/win32/ngx_files.c" 3 4
       , (*__error())
# 401 "project/nginx/src/os/win32/ngx_files.c"
       , "UnmapViewOfFile(%p) of file mapping \"%s\" failed", fm->addr, &fm->name
# 401 "project/nginx/src/os/win32/ngx_files.c" 3 4
       )

                                          
# 403 "project/nginx/src/os/win32/ngx_files.c"
                                         ;
    }

    if (CloseHandle(fm->handle) == 0) {
        
# 407 "project/nginx/src/os/win32/ngx_files.c" 3 4
       if ((
# 407 "project/nginx/src/os/win32/ngx_files.c"
       fm->log
# 407 "project/nginx/src/os/win32/ngx_files.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 407 "project/nginx/src/os/win32/ngx_files.c"
...
# 409 "project/nginx/src/os/win32/ngx_files.c"
                               ;
    }

    if (
# 412 "project/nginx/src/os/win32/ngx_files.c" 3 4
       close
# 412 "project/nginx/src/os/win32/ngx_files.c"
                     (fm->fd) == 
# 412 "project/nginx/src/os/win32/ngx_files.c" 3 4
                                 -1
# 412 "project/nginx/src/os/win32/ngx_files.c"
...
# 413 "project/nginx/src/os/win32/ngx_files.c" 3 4
       if ((
# 413 "project/nginx/src/os/win32/ngx_files.c"
       fm->log
# 413 "project/nginx/src/os/win32/ngx_files.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 413 "project/nginx/src/os/win32/ngx_files.c"
...
# 414 "project/nginx/src/os/win32/ngx_files.c"
                                                                 ;
    }
}
...
# 420 "project/nginx/src/os/win32/ngx_files.c" 3 4
(u_char *) realpath((char *) 
# 420 "project/nginx/src/os/win32/ngx_files.c"
u_char *path
# 420 "project/nginx/src/os/win32/ngx_files.c" 3 4
, (char *) 
# 420 "project/nginx/src/os/win32/ngx_files.c"
...
# 421 "project/nginx/src/os/win32/ngx_files.c"
{
...
ngx_open_dir(ngx_str_t *name, ngx_dir_t *dir)
{
    ...
    if (pattern == 
# 434 "project/nginx/src/os/win32/ngx_files.c" 3 4
                  ((void *)0)
# 434 "project/nginx/src/os/win32/ngx_files.c"
                      ) {
        return 
# 435 "project/nginx/src/os/win32/ngx_files.c" 3 4
              -1
# 435 "project/nginx/src/os/win32/ngx_files.c"
                       ;
    }

    p = 
# 438 "project/nginx/src/os/win32/ngx_files.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 438 "project/nginx/src/os/win32/ngx_files.c"
       pattern
# 438 "project/nginx/src/os/win32/ngx_files.c" 3 4
       , 
# 438 "project/nginx/src/os/win32/ngx_files.c"
...
# 438 "project/nginx/src/os/win32/ngx_files.c"
    ...
    *p = '\0';
    ...
    if (dir->dir == INVALID_HANDLE_VALUE) {
        err = 
# 447 "project/nginx/src/os/win32/ngx_files.c" 3 4
             (*__error())
# 447 "project/nginx/src/os/win32/ngx_files.c"
                      ;
        
# 448 "project/nginx/src/os/win32/ngx_files.c" 3 4
       free
# 448 "project/nginx/src/os/win32/ngx_files.c"
               (pattern);
        
# 449 "project/nginx/src/os/win32/ngx_files.c" 3 4
       (*__error()) = 
# 449 "project/nginx/src/os/win32/ngx_files.c"
       err;
        return 
# 450 "project/nginx/src/os/win32/ngx_files.c" 3 4
              -1
# 450 "project/nginx/src/os/win32/ngx_files.c"
                       ;
    }

    
# 453 "project/nginx/src/os/win32/ngx_files.c" 3 4
   free
# 453 "project/nginx/src/os/win32/ngx_files.c"
           (pattern);
    ...
    return 
# 458 "project/nginx/src/os/win32/ngx_files.c" 3 4
          0
# 458 "project/nginx/src/os/win32/ngx_files.c"
                ;
}
...
ngx_read_dir(ngx_dir_t *dir)
{
    if (dir->ready) {
        dir->ready = 0;
        return 
# 467 "project/nginx/src/os/win32/ngx_files.c" 3 4
              0
# 467 "project/nginx/src/os/win32/ngx_files.c"
                    ;
    }
    ...
    if (FindNextFile(dir->dir, &dir->finddata) != 0) {
        dir->type = 1;
        return 
# 472 "project/nginx/src/os/win32/ngx_files.c" 3 4
              0
# 472 "project/nginx/src/os/win32/ngx_files.c"
                    ;
    }

    return 
# 475 "project/nginx/src/os/win32/ngx_files.c" 3 4
          -1
# 475 "project/nginx/src/os/win32/ngx_files.c"
                   ;
}
...
# 480 "project/nginx/src/os/win32/ngx_files.c" 3 4
closedir((
# 480 "project/nginx/src/os/win32/ngx_files.c"
ngx_dir_t *dir
# 480 "project/nginx/src/os/win32/ngx_files.c" 3 4
)->dir)

# 481 "project/nginx/src/os/win32/ngx_files.c"
{
    if (FindClose(dir->dir) == 0) {
        return 
# 483 "project/nginx/src/os/win32/ngx_files.c" 3 4
              -1
# 483 "project/nginx/src/os/win32/ngx_files.c"
                       ;
    }

    return 
# 486 "project/nginx/src/os/win32/ngx_files.c" 3 4
          0
# 486 "project/nginx/src/os/win32/ngx_files.c"
                ;
}
...
ngx_open_glob(ngx_glob_t *gl)
{
    ...
    if (gl->dir == INVALID_HANDLE_VALUE) {
        ...
        err = 
# 501 "project/nginx/src/os/win32/ngx_files.c" 3 4
             (*__error())
# 501 "project/nginx/src/os/win32/ngx_files.c"
                      ;
             ...
             && gl->test)
        {
            gl->no_match = 1;
            return 
# 507 "project/nginx/src/os/win32/ngx_files.c" 3 4
                  0
# 507 "project/nginx/src/os/win32/ngx_files.c"
                        ;
        }

        return 
# 510 "project/nginx/src/os/win32/ngx_files.c" 3 4
              -1
# 510 "project/nginx/src/os/win32/ngx_files.c"
                       ;
    }
    ...
    len = 
# 519 "project/nginx/src/os/win32/ngx_files.c" 3 4
         strlen((const char *) 
# 519 "project/nginx/src/os/win32/ngx_files.c"
         gl->finddata.cFileName
# 519 "project/nginx/src/os/win32/ngx_files.c" 3 4
         )
# 519 "project/nginx/src/os/win32/ngx_files.c"
                                           ;
    ...
    if (gl->name.data == 
# 523 "project/nginx/src/os/win32/ngx_files.c" 3 4
                        ((void *)0)
# 523 "project/nginx/src/os/win32/ngx_files.c"
                            ) {
        return 
# 524 "project/nginx/src/os/win32/ngx_files.c" 3 4
              -1
# 524 "project/nginx/src/os/win32/ngx_files.c"
                       ;
    }

    
# 527 "project/nginx/src/os/win32/ngx_files.c" 3 4
   (void) __builtin___memcpy_chk (
# 527 "project/nginx/src/os/win32/ngx_files.c"
   gl->name.data
# 527 "project/nginx/src/os/win32/ngx_files.c" 3 4
   , 
# 527 "project/nginx/src/os/win32/ngx_files.c"
...
# 527 "project/nginx/src/os/win32/ngx_files.c"
    ...
    return 
# 533 "project/nginx/src/os/win32/ngx_files.c" 3 4
          0
# 533 "project/nginx/src/os/win32/ngx_files.c"
                ;
}
...
ngx_read_glob(ngx_glob_t *gl, ngx_str_t *name)
{
    ...
    if (gl->no_match) {
        return 
# 544 "project/nginx/src/os/win32/ngx_files.c" 3 4
              -4
# 544 "project/nginx/src/os/win32/ngx_files.c"
                      ;
    }
    ...
    if (gl->ready) {
        *name = gl->name;
        ...
        gl->ready = 0;
        return 
# 551 "project/nginx/src/os/win32/ngx_files.c" 3 4
              0
# 551 "project/nginx/src/os/win32/ngx_files.c"
                    ;
    }

    
# 554 "project/nginx/src/os/win32/ngx_files.c" 3 4
   free
# 554 "project/nginx/src/os/win32/ngx_files.c"
           (gl->name.data);
    gl->name.data = 
# 555 "project/nginx/src/os/win32/ngx_files.c" 3 4
                   ((void *)0)
# 555 "project/nginx/src/os/win32/ngx_files.c"
                       ;

    if (FindNextFile(gl->dir, &gl->finddata) != 0) {

        len = 
# 559 "project/nginx/src/os/win32/ngx_files.c" 3 4
             strlen((const char *) 
# 559 "project/nginx/src/os/win32/ngx_files.c"
             gl->finddata.cFileName
# 559 "project/nginx/src/os/win32/ngx_files.c" 3 4
             )
# 559 "project/nginx/src/os/win32/ngx_files.c"
        ...
        gl->name.data = ngx_alloc(gl->name.len + 1, gl->log);
        if (gl->name.data == 
# 563 "project/nginx/src/os/win32/ngx_files.c" 3 4
                            ((void *)0)
# 563 "project/nginx/src/os/win32/ngx_files.c"
                                ) {
            return 
# 564 "project/nginx/src/os/win32/ngx_files.c" 3 4
                  -1
# 564 "project/nginx/src/os/win32/ngx_files.c"
                           ;
        }

        
# 567 "project/nginx/src/os/win32/ngx_files.c" 3 4
       (void) __builtin___memcpy_chk (
# 567 "project/nginx/src/os/win32/ngx_files.c"
       gl->name.data
# 567 "project/nginx/src/os/win32/ngx_files.c" 3 4
       , 
# 567 "project/nginx/src/os/win32/ngx_files.c"
...
# 567 "project/nginx/src/os/win32/ngx_files.c"
        ...
        *name = gl->name;
        ...
        return 
# 573 "project/nginx/src/os/win32/ngx_files.c" 3 4
              0
# 573 "project/nginx/src/os/win32/ngx_files.c"
                    ;
    }

    err = 
# 576 "project/nginx/src/os/win32/ngx_files.c" 3 4
         (*__error())
# 576 "project/nginx/src/os/win32/ngx_files.c"
                  ;

    if (err == 
# 578 "project/nginx/src/os/win32/ngx_files.c" 3 4
              0
# 578 "project/nginx/src/os/win32/ngx_files.c"
                              ) {
        return 
# 579 "project/nginx/src/os/win32/ngx_files.c" 3 4
              -4
# 579 "project/nginx/src/os/win32/ngx_files.c"
                      ;
    }

    
# 582 "project/nginx/src/os/win32/ngx_files.c" 3 4
   if ((
# 582 "project/nginx/src/os/win32/ngx_files.c"
   gl->log
# 582 "project/nginx/src/os/win32/ngx_files.c" 3 4
   )->log_level >= 2) ngx_log_error_core(2, 
# 582 "project/nginx/src/os/win32/ngx_files.c"
...
# 582 "project/nginx/src/os/win32/ngx_files.c" 3 4
   , 
# 582 "project/nginx/src/os/win32/ngx_files.c"
   err, "FindNextFile(%s) failed", gl->pattern
# 582 "project/nginx/src/os/win32/ngx_files.c" 3 4
   )
                                                         
# 583 "project/nginx/src/os/win32/ngx_files.c"
                                                        ;

    return 
# 585 "project/nginx/src/os/win32/ngx_files.c" 3 4
          -1
# 585 "project/nginx/src/os/win32/ngx_files.c"
                   ;
}
...
# 593 "project/nginx/src/os/win32/ngx_files.c" 3 4
       free
# 593 "project/nginx/src/os/win32/ngx_files.c"
               (gl->name.data);
    }
...
# 601 "project/nginx/src/os/win32/ngx_files.c" 3 4
       if ((
# 601 "project/nginx/src/os/win32/ngx_files.c"
       gl->log
# 601 "project/nginx/src/os/win32/ngx_files.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 601 "project/nginx/src/os/win32/ngx_files.c"
...
# 602 "project/nginx/src/os/win32/ngx_files.c"
                                                         ;
    }
}
...
{
    return 
# 610 "project/nginx/src/os/win32/ngx_files.c" 3 4
          0
# 610 "project/nginx/src/os/win32/ngx_files.c"
                ;
}
...
# 615 "project/nginx/src/os/win32/ngx_files.c" 3 4
lstat((const char *) 
# 615 "project/nginx/src/os/win32/ngx_files.c"
u_char *name
# 615 "project/nginx/src/os/win32/ngx_files.c" 3 4
, &(
# 615 "project/nginx/src/os/win32/ngx_files.c"
...
# 616 "project/nginx/src/os/win32/ngx_files.c"
{
    return 
# 617 "project/nginx/src/os/win32/ngx_files.c" 3 4
          0
# 617 "project/nginx/src/os/win32/ngx_files.c"
                ;
}
...
# 622 "project/nginx/src/os/win32/ngx_files.c" 3 4
0

# 623 "project/nginx/src/os/win32/ngx_files.c"
{
    return ~
# 624 "project/nginx/src/os/win32/ngx_files.c" 3 4
           -1
# 624 "project/nginx/src/os/win32/ngx_files.c"
                         ;
}
...
# 629 "project/nginx/src/os/win32/ngx_files.c" 3 4
fcntl(
# 629 "project/nginx/src/os/win32/ngx_files.c"
ngx_fd_t fd
# 629 "project/nginx/src/os/win32/ngx_files.c" 3 4
, 48, 1)

# 630 "project/nginx/src/os/win32/ngx_files.c"
{
    return ~
# 631 "project/nginx/src/os/win32/ngx_files.c" 3 4
           -1
# 631 "project/nginx/src/os/win32/ngx_files.c"
                         ;
}
...
{
    return ~
# 638 "project/nginx/src/os/win32/ngx_files.c" 3 4
           -1
# 638 "project/nginx/src/os/win32/ngx_files.c"
                         ;
}
...
ngx_fs_available(u_char *name)
{
    ...
    if (GetDiskFreeSpaceEx((const char *) name, &navail, 
# 666 "project/nginx/src/os/win32/ngx_files.c" 3 4
                                                        ((void *)0)
# 666 "project/nginx/src/os/win32/ngx_files.c"
                                                            , 
# 666 "project/nginx/src/os/win32/ngx_files.c" 3 4
                                                              ((void *)0)
# 666 "project/nginx/src/os/win32/ngx_files.c"
        ...
        return 
# 667 "project/nginx/src/os/win32/ngx_files.c" 3 4
              9223372036854775807LL
# 667 "project/nginx/src/os/win32/ngx_files.c"
                                 ;
    }
...
ngx_win32_check_filename(u_char *name, u_short *u, size_t len)
{
    ...
    lu = 
# 691 "project/nginx/src/os/win32/ngx_files.c" 3 4
        ((void *)0)
# 691 "project/nginx/src/os/win32/ngx_files.c"
            ;
    state = sw_start;
    ...
    lu = malloc(len * 2);
    if (lu == 
# 784 "project/nginx/src/os/win32/ngx_files.c" 3 4
             ((void *)0)
# 784 "project/nginx/src/os/win32/ngx_files.c"
                 ) {
        return 
# 785 "project/nginx/src/os/win32/ngx_files.c" 3 4
              -1
# 785 "project/nginx/src/os/win32/ngx_files.c"
                       ;
    }
...
# 798 "project/nginx/src/os/win32/ngx_files.c" 3 4
   free
# 798 "project/nginx/src/os/win32/ngx_files.c"
           (lu);

    return 
# 800 "project/nginx/src/os/win32/ngx_files.c" 3 4
          0
# 800 "project/nginx/src/os/win32/ngx_files.c"
                ;

invalid:

    
# 804 "project/nginx/src/os/win32/ngx_files.c" 3 4
   (*__error()) = 2
# 804 "project/nginx/src/os/win32/ngx_files.c"
                            ;
...
failed:
    ...
    if (lu) {
        err = 
# 809 "project/nginx/src/os/win32/ngx_files.c" 3 4
             (*__error())
# 809 "project/nginx/src/os/win32/ngx_files.c"
                      ;
        
# 810 "project/nginx/src/os/win32/ngx_files.c" 3 4
       free
# 810 "project/nginx/src/os/win32/ngx_files.c"
               (lu);
        
# 811 "project/nginx/src/os/win32/ngx_files.c" 3 4
       (*__error()) = 
# 811 "project/nginx/src/os/win32/ngx_files.c"
       err;
    }

    return 
# 814 "project/nginx/src/os/win32/ngx_files.c" 3 4
          -1
# 814 "project/nginx/src/os/win32/ngx_files.c"
                   ;
}
...
# 852 "project/nginx/src/os/win32/ngx_files.c" 3 4
           (*__error()) = 92
# 852 "project/nginx/src/os/win32/ngx_files.c"
                                    ;
            return 
# 853 "project/nginx/src/os/win32/ngx_files.c" 3 4
                  ((void *)0)
# 853 "project/nginx/src/os/win32/ngx_files.c"
                      ;
        }
    ...
    u = malloc(((p - utf8) + 
# 868 "project/nginx/src/os/win32/ngx_files.c" 3 4
                            strlen((const char *) 
# 868 "project/nginx/src/os/win32/ngx_files.c"
                            p
# 868 "project/nginx/src/os/win32/ngx_files.c" 3 4
                            ) 
# 868 "project/nginx/src/os/win32/ngx_files.c"
                                          + 1) * sizeof(u_short));
    if (u == 
# 869 "project/nginx/src/os/win32/ngx_files.c" 3 4
            ((void *)0)
# 869 "project/nginx/src/os/win32/ngx_files.c"
                ) {
        return 
# 870 "project/nginx/src/os/win32/ngx_files.c" 3 4
              ((void *)0)
# 870 "project/nginx/src/os/win32/ngx_files.c"
                  ;
    }

    
# 873 "project/nginx/src/os/win32/ngx_files.c" 3 4
   (void) __builtin___memcpy_chk (
# 873 "project/nginx/src/os/win32/ngx_files.c"
   u
# 873 "project/nginx/src/os/win32/ngx_files.c" 3 4
   , 
# 873 "project/nginx/src/os/win32/ngx_files.c"
...
# 896 "project/nginx/src/os/win32/ngx_files.c" 3 4
           free
# 896 "project/nginx/src/os/win32/ngx_files.c"
                   (utf16);
            
# 897 "project/nginx/src/os/win32/ngx_files.c" 3 4
           (*__error()) = 92
# 897 "project/nginx/src/os/win32/ngx_files.c"
                                    ;
            return 
# 898 "project/nginx/src/os/win32/ngx_files.c" 3 4
                  ((void *)0)
# 898 "project/nginx/src/os/win32/ngx_files.c"
                      ;
        }
