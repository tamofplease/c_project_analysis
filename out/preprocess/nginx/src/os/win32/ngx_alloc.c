# 0 "project/nginx/src/os/win32/ngx_alloc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/win32/ngx_alloc.c"
...
# 9 "project/nginx/src/os/win32/ngx_alloc.c" 2
...
# 10 "project/nginx/src/os/win32/ngx_alloc.c" 2



# 12 "project/nginx/src/os/win32/ngx_alloc.c"
...
void *ngx_alloc(size_t size, ngx_log_t *log)
{
    ...
    p = malloc(size);
    if (p == 
# 22 "project/nginx/src/os/win32/ngx_alloc.c" 3 4
            ((void *)0)
# 22 "project/nginx/src/os/win32/ngx_alloc.c"
                ) {
        
# 23 "project/nginx/src/os/win32/ngx_alloc.c" 3 4
       if ((
# 23 "project/nginx/src/os/win32/ngx_alloc.c"
       log
# 23 "project/nginx/src/os/win32/ngx_alloc.c" 3 4
...
# 24 "project/nginx/src/os/win32/ngx_alloc.c"
                                                ;
    }
...
# 40 "project/nginx/src/os/win32/ngx_alloc.c" 3 4
       (void) __builtin___memset_chk (
# 40 "project/nginx/src/os/win32/ngx_alloc.c"
       p
# 40 "project/nginx/src/os/win32/ngx_alloc.c" 3 4
       , 0, 
# 40 "project/nginx/src/os/win32/ngx_alloc.c"
