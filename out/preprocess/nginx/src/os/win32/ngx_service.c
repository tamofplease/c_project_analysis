# 0 "project/nginx/src/os/win32/ngx_service.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/win32/ngx_service.c"
# 13 "project/nginx/src/os/win32/ngx_service.c"
...
# 87 "project/nginx/src/os/win32/ngx_service.c"
}
