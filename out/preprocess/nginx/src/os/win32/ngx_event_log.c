# 0 "project/nginx/src/os/win32/ngx_event_log.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/os/win32/ngx_event_log.c"
...
# 8 "project/nginx/src/os/win32/ngx_event_log.c" 2
...
# 9 "project/nginx/src/os/win32/ngx_event_log.c" 2
...
# 14 "project/nginx/src/os/win32/ngx_event_log.c"
void
ngx_event_log(ngx_err_t err, const char *fmt, ...)
{
    ...
    last = text + 2048;
    p = text + GetModuleFileName(
# 27 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
                                ((void *)0)
# 27 "project/nginx/src/os/win32/ngx_event_log.c"
                                    , (char *) text, 2048 - 50);

    *p++ = ':';
    
# 30 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
   *
# 30 "project/nginx/src/os/win32/ngx_event_log.c"
   p
# 30 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
   ++ = (u_char) '\n';
# 30 "project/nginx/src/os/win32/ngx_event_log.c"
...
# 32 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
   __builtin_va_start(
# 32 "project/nginx/src/os/win32/ngx_event_log.c"
   args
# 32 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
   ,
# 32 "project/nginx/src/os/win32/ngx_event_log.c"
...
# 34 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
   __builtin_va_end(
# 34 "project/nginx/src/os/win32/ngx_event_log.c"
   args
# 34 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
   )
# 34 "project/nginx/src/os/win32/ngx_event_log.c"
    ...
    if (p > last - 
# 40 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
                  1 
# 40 "project/nginx/src/os/win32/ngx_event_log.c"
                                    - 1) {
        p = last - 
# 41 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
                  1 
# 41 "project/nginx/src/os/win32/ngx_event_log.c"
                                    - 1;
    }

    
# 44 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
   *
# 44 "project/nginx/src/os/win32/ngx_event_log.c"
   p
# 44 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
   ++ = (u_char) '\n';
# 44 "project/nginx/src/os/win32/ngx_event_log.c"
    ...
    *p = '\0';
    ...
    if (RegCreateKeyEx(HKEY_LOCAL_MACHINE,
           ...
           0, 
# 55 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
             ((void *)0)
# 55 "project/nginx/src/os/win32/ngx_event_log.c"
...
# 55 "project/nginx/src/os/win32/ngx_event_log.c"
    ...
    ev = RegisterEventSource(
# 79 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
                            ((void *)0)
# 79 "project/nginx/src/os/win32/ngx_event_log.c"
                                , "nginx");

    msgarg[0] = (char *) text;
    msgarg[1] = 
# 82 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
               ((void *)0)
# 82 "project/nginx/src/os/win32/ngx_event_log.c"
                   ;
    msgarg[2] = 
# 83 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
               ((void *)0)
# 83 "project/nginx/src/os/win32/ngx_event_log.c"
                   ;
    msgarg[3] = 
# 84 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
               ((void *)0)
# 84 "project/nginx/src/os/win32/ngx_event_log.c"
                   ;
    msgarg[4] = 
# 85 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
               ((void *)0)
# 85 "project/nginx/src/os/win32/ngx_event_log.c"
                   ;
    msgarg[5] = 
# 86 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
               ((void *)0)
# 86 "project/nginx/src/os/win32/ngx_event_log.c"
                   ;
    msgarg[6] = 
# 87 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
               ((void *)0)
# 87 "project/nginx/src/os/win32/ngx_event_log.c"
                   ;
    msgarg[7] = 
# 88 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
               ((void *)0)
# 88 "project/nginx/src/os/win32/ngx_event_log.c"
                   ;
    msgarg[8] = 
# 89 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
               ((void *)0)
# 89 "project/nginx/src/os/win32/ngx_event_log.c"
                   ;
    ...
    ReportEvent(ev, EVENTLOG_ERROR_TYPE, 0, 3299, 
# 96 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
                                                 ((void *)0)
# 96 "project/nginx/src/os/win32/ngx_event_log.c"
                                                     , 9, 0, msgarg, 
# 96 "project/nginx/src/os/win32/ngx_event_log.c" 3 4
                                                                     ((void *)0)
# 96 "project/nginx/src/os/win32/ngx_event_log.c"
