# 0 "project/nginx/src/http/ngx_http_huff_decode.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/http/ngx_http_huff_decode.c"
...
# 9 "project/nginx/src/http/ngx_http_huff_decode.c" 2
...
# 10 "project/nginx/src/http/ngx_http_huff_decode.c" 2
...
# 11 "project/nginx/src/http/ngx_http_huff_decode.c" 2



# 13 "project/nginx/src/http/ngx_http_huff_decode.c"
typedef struct {
    u_char next;
    u_char emit;
    u_char sym;
...
static 
# 21 "project/nginx/src/http/ngx_http_huff_decode.c" 3 4
      inline 
# 21 "project/nginx/src/http/ngx_http_huff_decode.c"
                 ngx_int_t ngx_http_huff_decode_bits(u_char *state,
    ...
    ngx_uint_t last, ngx_log_t *log)
{
    ...
    while (src != end) {
        ...
        if (ngx_http_huff_decode_bits(state, &ending, ch >> 4, dst)
            != 
# 2657 "project/nginx/src/http/ngx_http_huff_decode.c" 3 4
              0
# 2657 "project/nginx/src/http/ngx_http_huff_decode.c"
                    )
        {
            ...
            return 
# 2663 "project/nginx/src/http/ngx_http_huff_decode.c" 3 4
                  -1
# 2663 "project/nginx/src/http/ngx_http_huff_decode.c"
                           ;
        }

        if (ngx_http_huff_decode_bits(state, &ending, ch & 0xf, dst)
            != 
# 2667 "project/nginx/src/http/ngx_http_huff_decode.c" 3 4
              0
# 2667 "project/nginx/src/http/ngx_http_huff_decode.c"
                    )
        {
            ...
            return 
# 2673 "project/nginx/src/http/ngx_http_huff_decode.c" 3 4
                  -1
# 2673 "project/nginx/src/http/ngx_http_huff_decode.c"
                           ;
        }
    }
    ...
    if (last) {
        if (!ending) {
            ...
            return 
# 2683 "project/nginx/src/http/ngx_http_huff_decode.c" 3 4
                  -1
# 2683 "project/nginx/src/http/ngx_http_huff_decode.c"
                           ;
        }
    ...
    return 
# 2689 "project/nginx/src/http/ngx_http_huff_decode.c" 3 4
          0
# 2689 "project/nginx/src/http/ngx_http_huff_decode.c"
                ;
}
...
static 
# 2694 "project/nginx/src/http/ngx_http_huff_decode.c" 3 4
      inline 
# 2694 "project/nginx/src/http/ngx_http_huff_decode.c"
                 ngx_int_t
    ...
    u_char **dst)
{
    ...
    if (code.next == *state) {
        return 
# 2703 "project/nginx/src/http/ngx_http_huff_decode.c" 3 4
              -1
# 2703 "project/nginx/src/http/ngx_http_huff_decode.c"
                       ;
    }
    ...
    *state = code.next;
    ...
    return 
# 2713 "project/nginx/src/http/ngx_http_huff_decode.c" 3 4
          0
# 2713 "project/nginx/src/http/ngx_http_huff_decode.c"
                ;
}
