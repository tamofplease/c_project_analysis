# 0 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
...
# 9 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 2
...
# 10 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 2
...
# 11 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 2
...
# 17 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
static ngx_http_upstream_rr_peer_t *ngx_http_upstream_get_peer(
    ngx_http_upstream_rr_peer_data_t *rrp);
# 30 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
ngx_int_t
...
# 63 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
           if ((
# 63 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
           cf->log
# 63 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
...
# 65 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                                                            ;
            return 
# 66 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                  -1
# 66 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                           ;
        }

        peers = ngx_pcalloc(cf->pool, sizeof(ngx_http_upstream_rr_peers_t));
        if (peers == 
# 70 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                    ((void *)0)
# 70 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                        ) {
            return 
# 71 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                  -1
# 71 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                           ;
        }

        peer = ngx_pcalloc(cf->pool, sizeof(ngx_http_upstream_rr_peer_t) * n);
        if (peer == 
# 75 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                   ((void *)0)
# 75 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                       ) {
            return 
# 76 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                  -1
# 76 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                           ;
        }
        ...
        if (n == 0) {
            return 
# 135 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                  0
# 135 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                        ;
        }

        backup = ngx_pcalloc(cf->pool, sizeof(ngx_http_upstream_rr_peers_t));
        if (backup == 
# 139 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                     ((void *)0)
# 139 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                         ) {
            return 
# 140 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                  -1
# 140 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                           ;
        }

        peer = ngx_pcalloc(cf->pool, sizeof(ngx_http_upstream_rr_peer_t) * n);
        if (peer == 
# 144 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                   ((void *)0)
# 144 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                       ) {
            return 
# 145 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                  -1
# 145 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                           ;
        }
        ...
        return 
# 185 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
              0
# 185 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                    ;
    }
...
# 192 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
       if ((
# 192 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
       cf->log
# 192 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
       )->log_level >= 1) ngx_log_error_core(1, 
# 192 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
...
# 194 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                                                        ;
        return 
# 195 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
              -1
# 195 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                       ;
    }

    
# 198 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
   (void) __builtin___memset_chk (
# 198 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
   &u
# 198 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
   , 0, 
# 198 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
...
# 203 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                                              0
# 203 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                                                    ) {
        if (u.err) {
            
# 205 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
           if ((
# 205 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
           cf->log
# 205 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
           )->log_level >= 1) ngx_log_error_core(1, 
# 205 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
...
# 207 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                                                                   ;
        }

        return 
# 210 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
              -1
# 210 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                       ;
    }
    ...
    peers = ngx_pcalloc(cf->pool, sizeof(ngx_http_upstream_rr_peers_t));
    if (peers == 
# 216 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                ((void *)0)
# 216 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                    ) {
        return 
# 217 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
              -1
# 217 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                       ;
    }

    peer = ngx_pcalloc(cf->pool, sizeof(ngx_http_upstream_rr_peer_t) * n);
    if (peer == 
# 221 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
               ((void *)0)
# 221 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                   ) {
        return 
# 222 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
              -1
# 222 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                       ;
    }
    ...
    return 
# 252 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
          0
# 252 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                ;
}
    ...
    ngx_http_upstream_srv_conf_t *us)
{
    ...
    if (rrp == 
# 265 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
              ((void *)0)
# 265 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                  ) {
        rrp = ngx_palloc(r->pool, sizeof(ngx_http_upstream_rr_peer_data_t));
        if (rrp == 
# 267 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                  ((void *)0)
# 267 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                      ) {
            return 
# 268 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                  -1
# 268 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                           ;
        }
    ...
    rrp->current = 
# 275 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                  ((void *)0)
# 275 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                      ;
    rrp->config = 0;
    ...
    if (n <= 8 * sizeof(uintptr_t)) {
        ...
        if (rrp->tried == 
# 292 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                         ((void *)0)
# 292 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                             ) {
            return 
# 293 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                  -1
# 293 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                           ;
        }
    }
    ...
    r->upstream->peer.tries = ((rrp->peers)->tries + ((rrp->peers)->next ? (rrp->peers)->next->tries : 0));
    ...
    return 
# 307 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
          0
# 307 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                ;
}
    ...
    ngx_http_upstream_resolved_t *ur)
{
    ...
    if (rrp == 
# 326 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
              ((void *)0)
# 326 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                  ) {
        rrp = ngx_palloc(r->pool, sizeof(ngx_http_upstream_rr_peer_data_t));
        if (rrp == 
# 328 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                  ((void *)0)
# 328 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                      ) {
            return 
# 329 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                  -1
# 329 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                           ;
        }
    ...
    if (peers == 
# 336 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                ((void *)0)
# 336 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                    ) {
        return 
# 337 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
              -1
# 337 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                       ;
    }
    ...
    peer = ngx_pcalloc(r->pool, sizeof(ngx_http_upstream_rr_peer_t)
                                * ur->naddrs);
    if (peer == 
# 342 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
               ((void *)0)
# 342 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                   ) {
        return 
# 343 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
              -1
# 343 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                       ;
    }
    ...
    if (ur->sockaddr) {
        ...
        for (i = 0; i < ur->naddrs; i++) {
            ...
            if (sockaddr == 
# 371 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                           ((void *)0)
# 371 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                               ) {
                return 
# 372 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                      -1
# 372 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                               ;
            }

            
# 375 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
           (void) __builtin___memcpy_chk (
# 375 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
           sockaddr
# 375 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
           , 
# 375 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
...
# 378 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                                    (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 378 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                                                       );
            if (p == 
# 379 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                    ((void *)0)
# 379 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                        ) {
                return 
# 380 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                      -1
# 380 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                               ;
            }

            len = ngx_sock_ntop(sockaddr, socklen, p, 
# 383 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                                                     (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - __builtin_offsetof (struct sockaddr_un, sun_path))
# 383 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                                                                        , 1);
    ...
    rrp->peers = peers;
    rrp->current = 
# 401 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                  ((void *)0)
# 401 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                      ;
    rrp->config = 0;
    ...
    if (rrp->peers->number <= 8 * sizeof(uintptr_t)) {
        ...
        rrp->tried = ngx_pcalloc(r->pool, n * sizeof(uintptr_t));
        if (rrp->tried == 
# 413 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                         ((void *)0)
# 413 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                             ) {
            return 
# 414 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                  -1
# 414 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                           ;
        }
    }
    ...
    return 
# 426 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
          0
# 426 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                ;
}
...
ngx_http_upstream_get_round_robin_peer(ngx_peer_connection_t *pc, void *data)
{
    ...
    pc->cached = 0;
    pc->connection = 
# 444 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                    ((void *)0)
# 444 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                        ;

    peers = rrp->peers;
    
# 447 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
   if (
# 447 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
   peers
# 447 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
...
# 447 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
    ...
    if (peers->single) {
        ...
        if (peer == 
# 468 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                   ((void *)0)
# 468 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                       ) {
            goto failed;
        }
...
# 483 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
   if (
# 483 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
   peers
# 483 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
...
# 483 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
    ...
    return 
# 485 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
          0
# 485 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                ;
...
# 502 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
       if (
# 502 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
       peers
# 502 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
       ->shpool) { ngx_rwlock_unlock(&
# 502 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
...
# 502 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
        ...
        if (rc != 
# 506 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                 -3
# 506 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                         ) {
            return rc;
        }

        
# 510 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
       if (
# 510 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
       peers
# 510 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
       ->shpool) { ngx_rwlock_wlock(&
# 510 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
...
# 513 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
   if (
# 513 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
   peers
# 513 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
   ->shpool) { ngx_rwlock_unlock(&
# 513 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
...
# 513 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
    ...
    return 
# 517 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
          -3
# 517 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                  ;
}
...
ngx_http_upstream_get_peer(ngx_http_upstream_rr_peer_data_t *rrp)
{
    ...
    now = 
# 530 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
         ngx_cached_time->sec
# 530 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                   ;

    best = 
# 532 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
          ((void *)0)
# 532 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
              ;
    total = 0;
         ...
         peer = peer->next, i++)
    {
        ...
        if (best == 
# 572 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
                   ((void *)0) 
# 572 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
    ...
    if (best == 
# 578 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
               ((void *)0)
# 578 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                   ) {
        return 
# 579 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
              ((void *)0)
# 579 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                  ;
    }
...
# 615 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
   if (
# 615 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
   rrp->peers
# 615 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
...
# 616 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
   if (
# 616 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
   rrp->peers
# 616 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
   ->shpool) { ngx_rwlock_wlock(&
# 616 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
...
# 622 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
       if (
# 622 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
       rrp->peers
# 622 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
       ->shpool) { ngx_rwlock_unlock(&
# 622 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
...
# 623 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
       if (
# 623 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
       rrp->peers
# 623 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
       ->shpool) { ngx_rwlock_unlock(&
# 623 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
...
# 623 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
    ...
    if (state & 
# 629 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
               4
# 629 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                              ) {
        now = 
# 630 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
             ngx_cached_time->sec
# 630 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                       ;
...
# 640 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
               if ((
# 640 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
               pc->log
# 640 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
...
# 641 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
                                                                    ;
            }
        }
...
# 664 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
   if (
# 664 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
   rrp->peers
# 664 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
   ->shpool) { ngx_rwlock_unlock(&
# 664 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
...
# 665 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
   if (
# 665 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
   rrp->peers
# 665 "project/nginx/src/http/ngx_http_upstream_round_robin.c" 3 4
   ->shpool) { ngx_rwlock_unlock(&
# 665 "project/nginx/src/http/ngx_http_upstream_round_robin.c"
