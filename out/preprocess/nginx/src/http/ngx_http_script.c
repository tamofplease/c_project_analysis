# 0 "project/nginx/src/http/ngx_http_script.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/http/ngx_http_script.c"
...
# 9 "project/nginx/src/http/ngx_http_script.c" 2
...
# 10 "project/nginx/src/http/ngx_http_script.c" 2
...
# 11 "project/nginx/src/http/ngx_http_script.c" 2



# 13 "project/nginx/src/http/ngx_http_script.c"
...
static uintptr_t ngx_http_script_exit_code = (uintptr_t) 
# 32 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                        ((void *)0)
# 32 "project/nginx/src/http/ngx_http_script.c"
                                                            ;
    ...
    ngx_str_t *value)
{
    ...
    if (val->lengths == 
# 66 "project/nginx/src/http/ngx_http_script.c" 3 4
                       ((void *)0)
# 66 "project/nginx/src/http/ngx_http_script.c"
                           ) {
        *value = val->value;
        return 
# 68 "project/nginx/src/http/ngx_http_script.c" 3 4
              0
# 68 "project/nginx/src/http/ngx_http_script.c"
                    ;
    }
...
# 73 "project/nginx/src/http/ngx_http_script.c" 3 4
   (void) __builtin___memset_chk (
# 73 "project/nginx/src/http/ngx_http_script.c"
   &e
# 73 "project/nginx/src/http/ngx_http_script.c" 3 4
   , 0, 
# 73 "project/nginx/src/http/ngx_http_script.c"
...
# 73 "project/nginx/src/http/ngx_http_script.c"
    ...
    if (value->data == 
# 88 "project/nginx/src/http/ngx_http_script.c" 3 4
                      ((void *)0)
# 88 "project/nginx/src/http/ngx_http_script.c"
                          ) {
        return 
# 89 "project/nginx/src/http/ngx_http_script.c" 3 4
              -1
# 89 "project/nginx/src/http/ngx_http_script.c"
                       ;
    }
    ...
    *value = e.buf;
    ...
    return 
# 103 "project/nginx/src/http/ngx_http_script.c" 3 4
          0
# 103 "project/nginx/src/http/ngx_http_script.c"
                ;
}
    ...
    ngx_http_complex_value_t *val, size_t default_value)
{
    ...
    if (val == 
# 114 "project/nginx/src/http/ngx_http_script.c" 3 4
              ((void *)0)
# 114 "project/nginx/src/http/ngx_http_script.c"
                  ) {
        return default_value;
    }

    if (val->lengths == 
# 118 "project/nginx/src/http/ngx_http_script.c" 3 4
                       ((void *)0)
# 118 "project/nginx/src/http/ngx_http_script.c"
                           ) {
        return val->u.size;
    }

    if (ngx_http_complex_value(r, val, &value) != 
# 122 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                 0
# 122 "project/nginx/src/http/ngx_http_script.c"
                                                       ) {
        return default_value;
    }
    ...
    if (size == (size_t) 
# 128 "project/nginx/src/http/ngx_http_script.c" 3 4
                        -1
# 128 "project/nginx/src/http/ngx_http_script.c"
                                 ) {
        
# 129 "project/nginx/src/http/ngx_http_script.c" 3 4
       if ((
# 129 "project/nginx/src/http/ngx_http_script.c"
       r->connection->log
# 129 "project/nginx/src/http/ngx_http_script.c" 3 4
...
# 129 "project/nginx/src/http/ngx_http_script.c" 3 4
       , 
# 129 "project/nginx/src/http/ngx_http_script.c"
       0, "invalid size \"%V\"", &value
# 129 "project/nginx/src/http/ngx_http_script.c" 3 4
       )
                                                    
# 130 "project/nginx/src/http/ngx_http_script.c"
                                                   ;
        return default_value;
    }
...
ngx_http_compile_complex_value(ngx_http_compile_complex_value_t *ccv)
{
    ...
    {
        if (ngx_conf_full_name(ccv->cf->cycle, v, ccv->conf_prefix) != 
# 165 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                                      0
# 165 "project/nginx/src/http/ngx_http_script.c"
                                                                            ) {
            return 
# 166 "project/nginx/src/http/ngx_http_script.c" 3 4
                  -1
# 166 "project/nginx/src/http/ngx_http_script.c"
                           ;
        }
    ...
    ccv->complex_value->flushes = 
# 174 "project/nginx/src/http/ngx_http_script.c" 3 4
                                 ((void *)0)
# 174 "project/nginx/src/http/ngx_http_script.c"
                                     ;
    ccv->complex_value->lengths = 
# 175 "project/nginx/src/http/ngx_http_script.c" 3 4
                                 ((void *)0)
# 175 "project/nginx/src/http/ngx_http_script.c"
                                     ;
    ccv->complex_value->values = 
# 176 "project/nginx/src/http/ngx_http_script.c" 3 4
                                ((void *)0)
# 176 "project/nginx/src/http/ngx_http_script.c"
                                    ;

    if (nv == 0 && nc == 0) {
        return 
# 179 "project/nginx/src/http/ngx_http_script.c" 3 4
              0
# 179 "project/nginx/src/http/ngx_http_script.c"
                    ;
    }
    ...
    if (ngx_array_init(&flushes, ccv->cf->pool, n, sizeof(ngx_uint_t))
        != 
# 185 "project/nginx/src/http/ngx_http_script.c" 3 4
          0
# 185 "project/nginx/src/http/ngx_http_script.c"
                )
    {
        return 
# 187 "project/nginx/src/http/ngx_http_script.c" 3 4
              -1
# 187 "project/nginx/src/http/ngx_http_script.c"
                       ;
    }
    ...
    if (ngx_array_init(&lengths, ccv->cf->pool, n, 1) != 
# 194 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                        0
# 194 "project/nginx/src/http/ngx_http_script.c"
                                                              ) {
        return 
# 195 "project/nginx/src/http/ngx_http_script.c" 3 4
              -1
# 195 "project/nginx/src/http/ngx_http_script.c"
                       ;
    }
    ...
    if (ngx_array_init(&values, ccv->cf->pool, n, 1) != 
# 205 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                       0
# 205 "project/nginx/src/http/ngx_http_script.c"
                                                             ) {
        return 
# 206 "project/nginx/src/http/ngx_http_script.c" 3 4
              -1
# 206 "project/nginx/src/http/ngx_http_script.c"
                       ;
    }
...
# 213 "project/nginx/src/http/ngx_http_script.c" 3 4
   (void) __builtin___memset_chk (
# 213 "project/nginx/src/http/ngx_http_script.c"
   &sc
# 213 "project/nginx/src/http/ngx_http_script.c" 3 4
   , 0, 
# 213 "project/nginx/src/http/ngx_http_script.c"
...
# 226 "project/nginx/src/http/ngx_http_script.c" 3 4
                                       0
# 226 "project/nginx/src/http/ngx_http_script.c"
                                             ) {
        return 
# 227 "project/nginx/src/http/ngx_http_script.c" 3 4
              -1
# 227 "project/nginx/src/http/ngx_http_script.c"
                       ;
    }
    ...
    return 
# 238 "project/nginx/src/http/ngx_http_script.c" 3 4
          0
# 238 "project/nginx/src/http/ngx_http_script.c"
                ;
}
...
ngx_http_set_complex_value_slot(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (*cv != 
# 253 "project/nginx/src/http/ngx_http_script.c" 3 4
              (void *) -1 
# 253 "project/nginx/src/http/ngx_http_script.c"
                                 && *cv != 
# 253 "project/nginx/src/http/ngx_http_script.c" 3 4
                                           ((void *)0)
# 253 "project/nginx/src/http/ngx_http_script.c"
    ...
    *cv = ngx_palloc(cf->pool, sizeof(ngx_http_complex_value_t));
    if (*cv == 
# 258 "project/nginx/src/http/ngx_http_script.c" 3 4
              ((void *)0)
# 258 "project/nginx/src/http/ngx_http_script.c"
                  ) {
        return 
# 259 "project/nginx/src/http/ngx_http_script.c" 3 4
              (void *) -1
# 259 "project/nginx/src/http/ngx_http_script.c"
                            ;
    }
...
# 264 "project/nginx/src/http/ngx_http_script.c" 3 4
   (void) __builtin___memset_chk (
# 264 "project/nginx/src/http/ngx_http_script.c"
   &ccv
# 264 "project/nginx/src/http/ngx_http_script.c" 3 4
   , 0, 
# 264 "project/nginx/src/http/ngx_http_script.c"
...
# 270 "project/nginx/src/http/ngx_http_script.c" 3 4
                                               0
# 270 "project/nginx/src/http/ngx_http_script.c"
                                                     ) {
        return 
# 271 "project/nginx/src/http/ngx_http_script.c" 3 4
              (void *) -1
# 271 "project/nginx/src/http/ngx_http_script.c"
                            ;
    }

    return 
# 274 "project/nginx/src/http/ngx_http_script.c" 3 4
          ((void *)0)
# 274 "project/nginx/src/http/ngx_http_script.c"
                     ;
}
    ...
    void *conf)
{
    ...
    if (*cv != 
# 290 "project/nginx/src/http/ngx_http_script.c" 3 4
              (void *) -1
# 290 "project/nginx/src/http/ngx_http_script.c"
                                ) {
        return "is duplicate";
    }
    ...
    *cv = ngx_palloc(cf->pool, sizeof(ngx_http_complex_value_t));
    if (*cv == 
# 295 "project/nginx/src/http/ngx_http_script.c" 3 4
              ((void *)0)
# 295 "project/nginx/src/http/ngx_http_script.c"
                  ) {
        return 
# 296 "project/nginx/src/http/ngx_http_script.c" 3 4
              (void *) -1
# 296 "project/nginx/src/http/ngx_http_script.c"
                            ;
    }
...
# 301 "project/nginx/src/http/ngx_http_script.c" 3 4
   (void) __builtin___memset_chk (
# 301 "project/nginx/src/http/ngx_http_script.c"
   &ccv
# 301 "project/nginx/src/http/ngx_http_script.c" 3 4
   , 0, 
# 301 "project/nginx/src/http/ngx_http_script.c"
...
# 301 "project/nginx/src/http/ngx_http_script.c"
    ...
    if (ngx_http_compile_complex_value(&ccv) != 
# 308 "project/nginx/src/http/ngx_http_script.c" 3 4
                                               0
# 308 "project/nginx/src/http/ngx_http_script.c"
                                                     ) {
        return 
# 309 "project/nginx/src/http/ngx_http_script.c" 3 4
              (void *) -1
# 309 "project/nginx/src/http/ngx_http_script.c"
                            ;
    }

    return 
# 312 "project/nginx/src/http/ngx_http_script.c" 3 4
          ((void *)0)
# 312 "project/nginx/src/http/ngx_http_script.c"
                     ;
}
    ...
    void *conf)
{
    ...
    if (rv != 
# 327 "project/nginx/src/http/ngx_http_script.c" 3 4
             ((void *)0)
# 327 "project/nginx/src/http/ngx_http_script.c"
                        ) {
        return rv;
    }
    ...
    if (cv->lengths) {
        return 
# 334 "project/nginx/src/http/ngx_http_script.c" 3 4
              ((void *)0)
# 334 "project/nginx/src/http/ngx_http_script.c"
                         ;
    }

    cv->u.size = ngx_parse_size(&cv->value);
    if (cv->u.size == (size_t) 
# 338 "project/nginx/src/http/ngx_http_script.c" 3 4
                              -1
# 338 "project/nginx/src/http/ngx_http_script.c"
                                       ) {
        return "invalid value";
    }

    return 
# 342 "project/nginx/src/http/ngx_http_script.c" 3 4
          ((void *)0)
# 342 "project/nginx/src/http/ngx_http_script.c"
                     ;
}
...
ngx_http_test_predicates(ngx_http_request_t *r, ngx_array_t *predicates)
{
    ...
    if (predicates == 
# 353 "project/nginx/src/http/ngx_http_script.c" 3 4
                     ((void *)0)
# 353 "project/nginx/src/http/ngx_http_script.c"
                         ) {
        return 
# 354 "project/nginx/src/http/ngx_http_script.c" 3 4
              0
# 354 "project/nginx/src/http/ngx_http_script.c"
                    ;
    }
    ...
    for (i = 0; i < predicates->nelts; i++) {
        if (ngx_http_complex_value(r, &cv[i], &val) != 
# 360 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                      0
# 360 "project/nginx/src/http/ngx_http_script.c"
                                                            ) {
            return 
# 361 "project/nginx/src/http/ngx_http_script.c" 3 4
                  -1
# 361 "project/nginx/src/http/ngx_http_script.c"
                           ;
        }

        if (val.len && (val.len != 1 || val.data[0] != '0')) {
            return 
# 365 "project/nginx/src/http/ngx_http_script.c" 3 4
                  -5
# 365 "project/nginx/src/http/ngx_http_script.c"
                              ;
        }
    }

    return 
# 369 "project/nginx/src/http/ngx_http_script.c" 3 4
          0
# 369 "project/nginx/src/http/ngx_http_script.c"
                ;
}
    ...
    ngx_array_t *predicates)
{
    ...
    if (predicates == 
# 381 "project/nginx/src/http/ngx_http_script.c" 3 4
                     ((void *)0)
# 381 "project/nginx/src/http/ngx_http_script.c"
                         ) {
        return 
# 382 "project/nginx/src/http/ngx_http_script.c" 3 4
              0
# 382 "project/nginx/src/http/ngx_http_script.c"
                    ;
    }
    ...
    for (i = 0; i < predicates->nelts; i++) {
        if (ngx_http_complex_value(r, &cv[i], &val) != 
# 388 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                      0
# 388 "project/nginx/src/http/ngx_http_script.c"
                                                            ) {
            return 
# 389 "project/nginx/src/http/ngx_http_script.c" 3 4
                  -1
# 389 "project/nginx/src/http/ngx_http_script.c"
                           ;
        }

        if (val.len == 0 || (val.len == 1 && val.data[0] == '0')) {
            return 
# 393 "project/nginx/src/http/ngx_http_script.c" 3 4
                  -5
# 393 "project/nginx/src/http/ngx_http_script.c"
                              ;
        }
    }

    return 
# 397 "project/nginx/src/http/ngx_http_script.c" 3 4
          0
# 397 "project/nginx/src/http/ngx_http_script.c"
                ;
}
...
ngx_http_set_predicate_slot(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (*a == 
# 414 "project/nginx/src/http/ngx_http_script.c" 3 4
             (void *) -1
# 414 "project/nginx/src/http/ngx_http_script.c"
                               ) {
        *a = ngx_array_create(cf->pool, 1, sizeof(ngx_http_complex_value_t));
        if (*a == 
# 416 "project/nginx/src/http/ngx_http_script.c" 3 4
                 ((void *)0)
# 416 "project/nginx/src/http/ngx_http_script.c"
                     ) {
            return 
# 417 "project/nginx/src/http/ngx_http_script.c" 3 4
                  (void *) -1
# 417 "project/nginx/src/http/ngx_http_script.c"
                                ;
        }
    }
    ...
    for (i = 1; i < cf->args->nelts; i++) {
        cv = ngx_array_push(*a);
        if (cv == 
# 425 "project/nginx/src/http/ngx_http_script.c" 3 4
                 ((void *)0)
# 425 "project/nginx/src/http/ngx_http_script.c"
                     ) {
            return 
# 426 "project/nginx/src/http/ngx_http_script.c" 3 4
                  (void *) -1
# 426 "project/nginx/src/http/ngx_http_script.c"
                                ;
        }

        
# 429 "project/nginx/src/http/ngx_http_script.c" 3 4
       (void) __builtin___memset_chk (
# 429 "project/nginx/src/http/ngx_http_script.c"
       &ccv
# 429 "project/nginx/src/http/ngx_http_script.c" 3 4
       , 0, 
# 429 "project/nginx/src/http/ngx_http_script.c"
...
# 429 "project/nginx/src/http/ngx_http_script.c"
        ...
        if (ngx_http_compile_complex_value(&ccv) != 
# 435 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                   0
# 435 "project/nginx/src/http/ngx_http_script.c"
                                                         ) {
            return 
# 436 "project/nginx/src/http/ngx_http_script.c" 3 4
                  (void *) -1
# 436 "project/nginx/src/http/ngx_http_script.c"
                                ;
        }
    }

    return 
# 440 "project/nginx/src/http/ngx_http_script.c" 3 4
          ((void *)0)
# 440 "project/nginx/src/http/ngx_http_script.c"
                     ;
}
...
ngx_http_script_compile(ngx_http_script_compile_t *sc)
{
    ...
    if (ngx_http_script_init_arrays(sc) != 
# 466 "project/nginx/src/http/ngx_http_script.c" 3 4
                                          0
# 466 "project/nginx/src/http/ngx_http_script.c"
                                                ) {
        return 
# 467 "project/nginx/src/http/ngx_http_script.c" 3 4
              -1
# 467 "project/nginx/src/http/ngx_http_script.c"
                       ;
    }
    ...
    for (i = 0; i < sc->source->len; ) {
        ...
        if (sc->source->data[i] == '$') {
            ...
            if (sc->source->data[i] >= '1' && sc->source->data[i] <= '9') {
                ...
                if (ngx_http_script_add_capture_code(sc, n) != 
# 492 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                              0
# 492 "project/nginx/src/http/ngx_http_script.c"
                                                                    ) {
                    return 
# 493 "project/nginx/src/http/ngx_http_script.c" 3 4
                          -1
# 493 "project/nginx/src/http/ngx_http_script.c"
                                   ;
                }
            ...
            if (bracket) {
                ngx_conf_log_error(
# 542 "project/nginx/src/http/ngx_http_script.c" 3 4
                                  1
# 542 "project/nginx/src/http/ngx_http_script.c"
                                               , sc->cf, 0,
                                   "the closing bracket in \"%V\" "
                                   "variable is missing", &name);
                return 
# 545 "project/nginx/src/http/ngx_http_script.c" 3 4
                      -1
# 545 "project/nginx/src/http/ngx_http_script.c"
                               ;
            }
            ...
            if (ngx_http_script_add_var_code(sc, &name) != 
# 554 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                          0
# 554 "project/nginx/src/http/ngx_http_script.c"
                                                                ) {
                return 
# 555 "project/nginx/src/http/ngx_http_script.c" 3 4
                      -1
# 555 "project/nginx/src/http/ngx_http_script.c"
                               ;
            }
        ...
        if (sc->source->data[i] == '?' && sc->compile_args) {
            ...
            if (ngx_http_script_add_args_code(sc) != 
# 565 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                    0
# 565 "project/nginx/src/http/ngx_http_script.c"
                                                          ) {
                return 
# 566 "project/nginx/src/http/ngx_http_script.c" 3 4
                      -1
# 566 "project/nginx/src/http/ngx_http_script.c"
                               ;
            }
        ...
        if (ngx_http_script_add_copy_code(sc, &name, (i == sc->source->len))
            != 
# 598 "project/nginx/src/http/ngx_http_script.c" 3 4
              0
# 598 "project/nginx/src/http/ngx_http_script.c"
                    )
        {
            return 
# 600 "project/nginx/src/http/ngx_http_script.c" 3 4
                  -1
# 600 "project/nginx/src/http/ngx_http_script.c"
                           ;
        }
    }
...
invalid_variable:
    ...
    ngx_conf_log_error(
# 608 "project/nginx/src/http/ngx_http_script.c" 3 4
                      1
# 608 "project/nginx/src/http/ngx_http_script.c"
                                   , sc->cf, 0, "invalid variable name");

    return 
# 610 "project/nginx/src/http/ngx_http_script.c" 3 4
          -1
# 610 "project/nginx/src/http/ngx_http_script.c"
                   ;
}
    ...
    void *code_lengths, size_t len, void *code_values)
{
    ...
    cmcf = 
# 624 "project/nginx/src/http/ngx_http_script.c" 3 4
          (
# 624 "project/nginx/src/http/ngx_http_script.c"
          r
# 624 "project/nginx/src/http/ngx_http_script.c" 3 4
          )->main_conf[
# 624 "project/nginx/src/http/ngx_http_script.c"
...
# 633 "project/nginx/src/http/ngx_http_script.c" 3 4
   (void) __builtin___memset_chk (
# 633 "project/nginx/src/http/ngx_http_script.c"
   &e
# 633 "project/nginx/src/http/ngx_http_script.c" 3 4
   , 0, 
# 633 "project/nginx/src/http/ngx_http_script.c"
...
# 633 "project/nginx/src/http/ngx_http_script.c"
    ...
    value->data = ngx_pnalloc(r->pool, len);
    if (value->data == 
# 647 "project/nginx/src/http/ngx_http_script.c" 3 4
                      ((void *)0)
# 647 "project/nginx/src/http/ngx_http_script.c"
                          ) {
        return 
# 648 "project/nginx/src/http/ngx_http_script.c" 3 4
              ((void *)0)
# 648 "project/nginx/src/http/ngx_http_script.c"
                  ;
    }
...
ngx_http_script_init_arrays(ngx_http_script_compile_t *sc)
{
    ...
    if (sc->flushes && *sc->flushes == 
# 686 "project/nginx/src/http/ngx_http_script.c" 3 4
                                      ((void *)0)
# 686 "project/nginx/src/http/ngx_http_script.c"
                                          ) {
        n = sc->variables ? sc->variables : 1;
        *sc->flushes = ngx_array_create(sc->cf->pool, n, sizeof(ngx_uint_t));
        if (*sc->flushes == 
# 689 "project/nginx/src/http/ngx_http_script.c" 3 4
                           ((void *)0)
# 689 "project/nginx/src/http/ngx_http_script.c"
                               ) {
            return 
# 690 "project/nginx/src/http/ngx_http_script.c" 3 4
                  -1
# 690 "project/nginx/src/http/ngx_http_script.c"
                           ;
        }
    }

    if (*sc->lengths == 
# 694 "project/nginx/src/http/ngx_http_script.c" 3 4
                       ((void *)0)
# 694 "project/nginx/src/http/ngx_http_script.c"
                           ) {
        ...
        *sc->lengths = ngx_array_create(sc->cf->pool, n, 1);
        if (*sc->lengths == 
# 700 "project/nginx/src/http/ngx_http_script.c" 3 4
                           ((void *)0)
# 700 "project/nginx/src/http/ngx_http_script.c"
                               ) {
            return 
# 701 "project/nginx/src/http/ngx_http_script.c" 3 4
                  -1
# 701 "project/nginx/src/http/ngx_http_script.c"
                           ;
        }
    }

    if (*sc->values == 
# 705 "project/nginx/src/http/ngx_http_script.c" 3 4
                      ((void *)0)
# 705 "project/nginx/src/http/ngx_http_script.c"
                          ) {
        n = (sc->variables * (2 * sizeof(ngx_http_script_copy_code_t)
                              + sizeof(ngx_http_script_var_code_t))
                + sizeof(uintptr_t)
        ...
        *sc->values = ngx_array_create(sc->cf->pool, n, 1);
        if (*sc->values == 
# 714 "project/nginx/src/http/ngx_http_script.c" 3 4
                          ((void *)0)
# 714 "project/nginx/src/http/ngx_http_script.c"
                              ) {
            return 
# 715 "project/nginx/src/http/ngx_http_script.c" 3 4
                  -1
# 715 "project/nginx/src/http/ngx_http_script.c"
                           ;
        }
    }
    ...
    return 
# 721 "project/nginx/src/http/ngx_http_script.c" 3 4
          0
# 721 "project/nginx/src/http/ngx_http_script.c"
                ;
}
...
ngx_http_script_done(ngx_http_script_compile_t *sc)
{
    ...
    if (sc->zero) {
        ...
        if (ngx_http_script_add_copy_code(sc, &zero, 0) != 
# 736 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                          0
# 736 "project/nginx/src/http/ngx_http_script.c"
                                                                ) {
            return 
# 737 "project/nginx/src/http/ngx_http_script.c" 3 4
                  -1
# 737 "project/nginx/src/http/ngx_http_script.c"
                           ;
        }
    }

    if (sc->conf_prefix || sc->root_prefix) {
        if (ngx_http_script_add_full_name_code(sc) != 
# 742 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                     0
# 742 "project/nginx/src/http/ngx_http_script.c"
                                                           ) {
            return 
# 743 "project/nginx/src/http/ngx_http_script.c" 3 4
                  -1
# 743 "project/nginx/src/http/ngx_http_script.c"
                           ;
        }
    }
...
# 748 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                                        ((void *)0)
# 748 "project/nginx/src/http/ngx_http_script.c"
                                                                            );
        if (code == 
# 749 "project/nginx/src/http/ngx_http_script.c" 3 4
                   ((void *)0)
# 749 "project/nginx/src/http/ngx_http_script.c"
                       ) {
            return 
# 750 "project/nginx/src/http/ngx_http_script.c" 3 4
                  -1
# 750 "project/nginx/src/http/ngx_http_script.c"
                           ;
        }

        *code = (uintptr_t) 
# 753 "project/nginx/src/http/ngx_http_script.c" 3 4
                           ((void *)0)
# 753 "project/nginx/src/http/ngx_http_script.c"
                               ;
    }
    ...
    if (sc->complete_values) {
        code = ngx_http_script_add_code(*sc->values, sizeof(uintptr_t),
                                        &sc->main);
        if (code == 
# 759 "project/nginx/src/http/ngx_http_script.c" 3 4
                   ((void *)0)
# 759 "project/nginx/src/http/ngx_http_script.c"
                       ) {
            return 
# 760 "project/nginx/src/http/ngx_http_script.c" 3 4
                  -1
# 760 "project/nginx/src/http/ngx_http_script.c"
                           ;
        }

        *code = (uintptr_t) 
# 763 "project/nginx/src/http/ngx_http_script.c" 3 4
                           ((void *)0)
# 763 "project/nginx/src/http/ngx_http_script.c"
                               ;
    }

    return 
# 766 "project/nginx/src/http/ngx_http_script.c" 3 4
          0
# 766 "project/nginx/src/http/ngx_http_script.c"
                ;
}
...
{
    if (*codes == 
# 773 "project/nginx/src/http/ngx_http_script.c" 3 4
                 ((void *)0)
# 773 "project/nginx/src/http/ngx_http_script.c"
                     ) {
        *codes = ngx_array_create(pool, 256, 1);
        if (*codes == 
# 775 "project/nginx/src/http/ngx_http_script.c" 3 4
                     ((void *)0)
# 775 "project/nginx/src/http/ngx_http_script.c"
                         ) {
            return 
# 776 "project/nginx/src/http/ngx_http_script.c" 3 4
                  ((void *)0)
# 776 "project/nginx/src/http/ngx_http_script.c"
                      ;
        }
    }
...
ngx_http_script_add_code(ngx_array_t *codes, size_t size, void *code)
{
    ...
    if (new == 
# 793 "project/nginx/src/http/ngx_http_script.c" 3 4
              ((void *)0)
# 793 "project/nginx/src/http/ngx_http_script.c"
                  ) {
        return 
# 794 "project/nginx/src/http/ngx_http_script.c" 3 4
              ((void *)0)
# 794 "project/nginx/src/http/ngx_http_script.c"
                  ;
    }
...
# 820 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                                        ((void *)0)
# 820 "project/nginx/src/http/ngx_http_script.c"
                                                                            );
    if (code == 
# 821 "project/nginx/src/http/ngx_http_script.c" 3 4
               ((void *)0)
# 821 "project/nginx/src/http/ngx_http_script.c"
                   ) {
        return 
# 822 "project/nginx/src/http/ngx_http_script.c" 3 4
              -1
# 822 "project/nginx/src/http/ngx_http_script.c"
                       ;
    }
    ...
    if (code == 
# 833 "project/nginx/src/http/ngx_http_script.c" 3 4
               ((void *)0)
# 833 "project/nginx/src/http/ngx_http_script.c"
                   ) {
        return 
# 834 "project/nginx/src/http/ngx_http_script.c" 3 4
              -1
# 834 "project/nginx/src/http/ngx_http_script.c"
                       ;
    }
    ...
    p = 
# 840 "project/nginx/src/http/ngx_http_script.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 840 "project/nginx/src/http/ngx_http_script.c"
       (u_char *) code + sizeof(ngx_http_script_copy_code_t)
# 840 "project/nginx/src/http/ngx_http_script.c" 3 4
       , 
# 840 "project/nginx/src/http/ngx_http_script.c"
       value->data
...
# 841 "project/nginx/src/http/ngx_http_script.c"
                                          ;
    ...
    return 
# 848 "project/nginx/src/http/ngx_http_script.c" 3 4
          0
# 848 "project/nginx/src/http/ngx_http_script.c"
                ;
}
...
ngx_http_script_copy_code(ngx_http_script_engine_t *e)
{
    ...
    if (!e->skip) {
        e->pos = 
# 876 "project/nginx/src/http/ngx_http_script.c" 3 4
                (((u_char *) __builtin___memcpy_chk (
# 876 "project/nginx/src/http/ngx_http_script.c"
                p
# 876 "project/nginx/src/http/ngx_http_script.c" 3 4
                , 
# 876 "project/nginx/src/http/ngx_http_script.c"
...
# 877 "project/nginx/src/http/ngx_http_script.c"
                                   ;
    }
...
ngx_http_script_add_var_code(ngx_http_script_compile_t *sc, ngx_str_t *name)
{
    ...
    if (index == 
# 896 "project/nginx/src/http/ngx_http_script.c" 3 4
                -1
# 896 "project/nginx/src/http/ngx_http_script.c"
                         ) {
        return 
# 897 "project/nginx/src/http/ngx_http_script.c" 3 4
              -1
# 897 "project/nginx/src/http/ngx_http_script.c"
                       ;
    }
    ...
    if (sc->flushes) {
        ...
        if (p == 
# 902 "project/nginx/src/http/ngx_http_script.c" 3 4
                ((void *)0)
# 902 "project/nginx/src/http/ngx_http_script.c"
                    ) {
            return 
# 903 "project/nginx/src/http/ngx_http_script.c" 3 4
                  -1
# 903 "project/nginx/src/http/ngx_http_script.c"
                           ;
        }
    ...
    code = ngx_http_script_add_code(*sc->lengths,
                                    sizeof(ngx_http_script_var_code_t), 
# 910 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                                       ((void *)0)
# 910 "project/nginx/src/http/ngx_http_script.c"
                                                                           );
    if (code == 
# 911 "project/nginx/src/http/ngx_http_script.c" 3 4
               ((void *)0)
# 911 "project/nginx/src/http/ngx_http_script.c"
                   ) {
        return 
# 912 "project/nginx/src/http/ngx_http_script.c" 3 4
              -1
# 912 "project/nginx/src/http/ngx_http_script.c"
                       ;
    }
    ...
    code = ngx_http_script_add_code(*sc->values,
                                    ...
                                    &sc->main);
    if (code == 
# 922 "project/nginx/src/http/ngx_http_script.c" 3 4
               ((void *)0)
# 922 "project/nginx/src/http/ngx_http_script.c"
                   ) {
        return 
# 923 "project/nginx/src/http/ngx_http_script.c" 3 4
              -1
# 923 "project/nginx/src/http/ngx_http_script.c"
                       ;
    }
    ...
    return 
# 929 "project/nginx/src/http/ngx_http_script.c" 3 4
          0
# 929 "project/nginx/src/http/ngx_http_script.c"
                ;
}
...
ngx_http_script_copy_var_code(ngx_http_script_engine_t *e)
{
    ...
    if (!e->skip) {
        ...
        if (value && !value->not_found) {
            p = e->pos;
            e->pos = 
# 980 "project/nginx/src/http/ngx_http_script.c" 3 4
                    (((u_char *) __builtin___memcpy_chk (
# 980 "project/nginx/src/http/ngx_http_script.c"
                    p
# 980 "project/nginx/src/http/ngx_http_script.c" 3 4
                    , 
# 980 "project/nginx/src/http/ngx_http_script.c"
...
ngx_http_script_add_args_code(ngx_http_script_compile_t *sc)
{
    ...
    code = ngx_http_script_add_code(*sc->lengths, sizeof(uintptr_t), 
# 995 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                                    ((void *)0)
# 995 "project/nginx/src/http/ngx_http_script.c"
                                                                        );
    if (code == 
# 996 "project/nginx/src/http/ngx_http_script.c" 3 4
               ((void *)0)
# 996 "project/nginx/src/http/ngx_http_script.c"
                   ) {
        return 
# 997 "project/nginx/src/http/ngx_http_script.c" 3 4
              -1
# 997 "project/nginx/src/http/ngx_http_script.c"
                       ;
    }
    ...
    *code = (uintptr_t) ngx_http_script_mark_args_code;
    ...
    if (code == 
# 1003 "project/nginx/src/http/ngx_http_script.c" 3 4
               ((void *)0)
# 1003 "project/nginx/src/http/ngx_http_script.c"
                   ) {
        return 
# 1004 "project/nginx/src/http/ngx_http_script.c" 3 4
              -1
# 1004 "project/nginx/src/http/ngx_http_script.c"
                       ;
    }
    ...
    *code = (uintptr_t) ngx_http_script_start_args_code;
    ...
    return 
# 1009 "project/nginx/src/http/ngx_http_script.c" 3 4
          0
# 1009 "project/nginx/src/http/ngx_http_script.c"
                ;
}
...
ngx_http_script_regex_start_code(ngx_http_script_engine_t *e)
{
    ...
    if (rc == 
# 1065 "project/nginx/src/http/ngx_http_script.c" 3 4
             -5
# 1065 "project/nginx/src/http/ngx_http_script.c"
                         ) {
        if (e->log || (r->connection->log->log_level & 
# 1066 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                      0x100
# 1066 "project/nginx/src/http/ngx_http_script.c"
                                                                        )) {
            
# 1067 "project/nginx/src/http/ngx_http_script.c" 3 4
           if ((
# 1067 "project/nginx/src/http/ngx_http_script.c"
           r->connection->log
# 1067 "project/nginx/src/http/ngx_http_script.c" 3 4
...
# 1067 "project/nginx/src/http/ngx_http_script.c" 3 4
           , 
# 1067 "project/nginx/src/http/ngx_http_script.c"
           0, "\"%V\" does not match \"%V\"", &code->name, &e->line
# 1067 "project/nginx/src/http/ngx_http_script.c" 3 4
           )

                                                
# 1069 "project/nginx/src/http/ngx_http_script.c"
                                               ;
        }
    ...
    if (rc == 
# 1094 "project/nginx/src/http/ngx_http_script.c" 3 4
             -1
# 1094 "project/nginx/src/http/ngx_http_script.c"
                      ) {
        e->ip = (u_char *) &ngx_http_script_exit_code;
        e->status = 
# 1096 "project/nginx/src/http/ngx_http_script.c" 3 4
                   500
# 1096 "project/nginx/src/http/ngx_http_script.c"
                                                 ;
        return;
    }

    if (e->log || (r->connection->log->log_level & 
# 1100 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                  0x100
# 1100 "project/nginx/src/http/ngx_http_script.c"
                                                                    )) {
        
# 1101 "project/nginx/src/http/ngx_http_script.c" 3 4
       if ((
# 1101 "project/nginx/src/http/ngx_http_script.c"
       r->connection->log
# 1101 "project/nginx/src/http/ngx_http_script.c" 3 4
       )->log_level >= 6) ngx_log_error_core(6, 
# 1101 "project/nginx/src/http/ngx_http_script.c"
...
# 1101 "project/nginx/src/http/ngx_http_script.c" 3 4
       , 
# 1101 "project/nginx/src/http/ngx_http_script.c"
       0, "\"%V\" matches \"%V\"", &code->name, &e->line
# 1101 "project/nginx/src/http/ngx_http_script.c" 3 4
       )
                                                                     
# 1102 "project/nginx/src/http/ngx_http_script.c"
                                                                    ;
    }
    ...
    if (code->lengths == 
# 1143 "project/nginx/src/http/ngx_http_script.c" 3 4
                        ((void *)0)
# 1143 "project/nginx/src/http/ngx_http_script.c"
                            ) {
        e->buf.len = code->size;

        if (code->uri) {
            if (r->ncaptures && (r->quoted_uri || r->plus_in_uri)) {
                e->buf.len += 2 * ngx_escape_uri(
# 1148 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                ((void *)0)
# 1148 "project/nginx/src/http/ngx_http_script.c"
                                                    , r->uri.data, r->uri.len,
                                                 
# 1149 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                1
# 1149 "project/nginx/src/http/ngx_http_script.c"
                                                               );
            }
        }
...
# 1158 "project/nginx/src/http/ngx_http_script.c" 3 4
       (void) __builtin___memset_chk (
# 1158 "project/nginx/src/http/ngx_http_script.c"
       &le
# 1158 "project/nginx/src/http/ngx_http_script.c" 3 4
       , 0, 
# 1158 "project/nginx/src/http/ngx_http_script.c"
...
# 1158 "project/nginx/src/http/ngx_http_script.c"
    ...
    if (e->buf.data == 
# 1180 "project/nginx/src/http/ngx_http_script.c" 3 4
                      ((void *)0)
# 1180 "project/nginx/src/http/ngx_http_script.c"
                          ) {
        e->ip = (u_char *) &ngx_http_script_exit_code;
        e->status = 
# 1182 "project/nginx/src/http/ngx_http_script.c" 3 4
                   500
# 1182 "project/nginx/src/http/ngx_http_script.c"
                                                 ;
        return;
    }
...
# 1216 "project/nginx/src/http/ngx_http_script.c" 3 4
                        2
# 1216 "project/nginx/src/http/ngx_http_script.c"
                                             );

        if (src < e->pos) {
            dst = 
# 1219 "project/nginx/src/http/ngx_http_script.c" 3 4
                 (((u_char *) __builtin___memmove_chk (
# 1219 "project/nginx/src/http/ngx_http_script.c"
                 dst
# 1219 "project/nginx/src/http/ngx_http_script.c" 3 4
                 , 
# 1219 "project/nginx/src/http/ngx_http_script.c"
...
# 1219 "project/nginx/src/http/ngx_http_script.c"
        ...
        if (code->add_args && r->args.len) {
            *e->pos++ = (u_char) (code->args ? '&' : '?');
            e->pos = 
# 1226 "project/nginx/src/http/ngx_http_script.c" 3 4
                    (((u_char *) __builtin___memcpy_chk (
# 1226 "project/nginx/src/http/ngx_http_script.c"
                    e->pos
# 1226 "project/nginx/src/http/ngx_http_script.c" 3 4
                    , 
# 1226 "project/nginx/src/http/ngx_http_script.c"
...
# 1226 "project/nginx/src/http/ngx_http_script.c"
        ...
        if (e->log || (r->connection->log->log_level & 
# 1231 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                      0x100
# 1231 "project/nginx/src/http/ngx_http_script.c"
                                                                        )) {
            
# 1232 "project/nginx/src/http/ngx_http_script.c" 3 4
           if ((
# 1232 "project/nginx/src/http/ngx_http_script.c"
           r->connection->log
# 1232 "project/nginx/src/http/ngx_http_script.c" 3 4
           )->log_level >= 6) ngx_log_error_core(6, 
# 1232 "project/nginx/src/http/ngx_http_script.c"
...
# 1232 "project/nginx/src/http/ngx_http_script.c" 3 4
           , 
# 1232 "project/nginx/src/http/ngx_http_script.c"
           0, "rewritten redirect: \"%V\"", &e->buf
# 1232 "project/nginx/src/http/ngx_http_script.c" 3 4
           )
                                                                
# 1233 "project/nginx/src/http/ngx_http_script.c"
                                                               ;
        }

        
# 1236 "project/nginx/src/http/ngx_http_script.c" 3 4
       if (
# 1236 "project/nginx/src/http/ngx_http_script.c"
       r
# 1236 "project/nginx/src/http/ngx_http_script.c" 3 4
...
# 1239 "project/nginx/src/http/ngx_http_script.c" 3 4
                                      ((void *)0)
# 1239 "project/nginx/src/http/ngx_http_script.c"
                                          ) {
            e->ip = (u_char *) &ngx_http_script_exit_code;
            e->status = 
# 1241 "project/nginx/src/http/ngx_http_script.c" 3 4
                       500
# 1241 "project/nginx/src/http/ngx_http_script.c"
                                                     ;
            return;
        }
...
# 1246 "project/nginx/src/http/ngx_http_script.c" 3 4
       (
# 1246 "project/nginx/src/http/ngx_http_script.c"
...
# 1246 "project/nginx/src/http/ngx_http_script.c"
    ...
    if (e->args) {
        ...
        if (code->add_args && r->args.len) {
            *e->pos++ = '&';
            e->pos = 
# 1258 "project/nginx/src/http/ngx_http_script.c" 3 4
                    (((u_char *) __builtin___memcpy_chk (
# 1258 "project/nginx/src/http/ngx_http_script.c"
                    e->pos
# 1258 "project/nginx/src/http/ngx_http_script.c" 3 4
                    , 
# 1258 "project/nginx/src/http/ngx_http_script.c"
...
# 1258 "project/nginx/src/http/ngx_http_script.c"
        ...
        e->args = 
# 1264 "project/nginx/src/http/ngx_http_script.c" 3 4
                 ((void *)0)
# 1264 "project/nginx/src/http/ngx_http_script.c"
                     ;
    ...
    if (e->log || (r->connection->log->log_level & 
# 1274 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                  0x100
# 1274 "project/nginx/src/http/ngx_http_script.c"
                                                                    )) {
        
# 1275 "project/nginx/src/http/ngx_http_script.c" 3 4
       if ((
# 1275 "project/nginx/src/http/ngx_http_script.c"
       r->connection->log
# 1275 "project/nginx/src/http/ngx_http_script.c" 3 4
       )->log_level >= 6) ngx_log_error_core(6, 
# 1275 "project/nginx/src/http/ngx_http_script.c"
...
# 1275 "project/nginx/src/http/ngx_http_script.c" 3 4
       , 
# 1275 "project/nginx/src/http/ngx_http_script.c"
       0, "rewritten data: \"%V\", args: \"%V\"", &e->buf, &r->args
# 1275 "project/nginx/src/http/ngx_http_script.c" 3 4
       )

                                        
# 1277 "project/nginx/src/http/ngx_http_script.c"
                                       ;
    }
...
# 1284 "project/nginx/src/http/ngx_http_script.c" 3 4
           if ((
# 1284 "project/nginx/src/http/ngx_http_script.c"
           r->connection->log
# 1284 "project/nginx/src/http/ngx_http_script.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 1284 "project/nginx/src/http/ngx_http_script.c"
...
# 1284 "project/nginx/src/http/ngx_http_script.c" 3 4
           , 
# 1284 "project/nginx/src/http/ngx_http_script.c"
           0, "the rewritten URI has a zero length"
# 1284 "project/nginx/src/http/ngx_http_script.c" 3 4
           )
                                                                
# 1285 "project/nginx/src/http/ngx_http_script.c"
                                                               ;
            e->ip = (u_char *) &ngx_http_script_exit_code;
            e->status = 
# 1287 "project/nginx/src/http/ngx_http_script.c" 3 4
                       500
# 1287 "project/nginx/src/http/ngx_http_script.c"
                                                     ;
            return;
        }
...
# 1305 "project/nginx/src/http/ngx_http_script.c" 3 4
                                   ((void *)0)
# 1305 "project/nginx/src/http/ngx_http_script.c"
                                       );
    if (code == 
# 1306 "project/nginx/src/http/ngx_http_script.c" 3 4
               ((void *)0)
# 1306 "project/nginx/src/http/ngx_http_script.c"
                   ) {
        return 
# 1307 "project/nginx/src/http/ngx_http_script.c" 3 4
              -1
# 1307 "project/nginx/src/http/ngx_http_script.c"
                       ;
    }
    ...
    code = ngx_http_script_add_code(*sc->values,
                                    ...
                                    &sc->main);
    if (code == 
# 1318 "project/nginx/src/http/ngx_http_script.c" 3 4
               ((void *)0)
# 1318 "project/nginx/src/http/ngx_http_script.c"
                   ) {
        return 
# 1319 "project/nginx/src/http/ngx_http_script.c" 3 4
              -1
# 1319 "project/nginx/src/http/ngx_http_script.c"
                       ;
    }
    ...
    return 
# 1329 "project/nginx/src/http/ngx_http_script.c" 3 4
          0
# 1329 "project/nginx/src/http/ngx_http_script.c"
                ;
}
    ...
    if (n < r->ncaptures) {
            ...
            && (e->request->quoted_uri || e->request->plus_in_uri))
        {
            ...
            return cap[n + 1] - cap[n]
                   + 2 * ngx_escape_uri(
# 1360 "project/nginx/src/http/ngx_http_script.c" 3 4
                                       ((void *)0)
# 1360 "project/nginx/src/http/ngx_http_script.c"
                                           , &p[cap[n]], cap[n + 1] - cap[n],
                                        
# 1361 "project/nginx/src/http/ngx_http_script.c" 3 4
                                       1
# 1361 "project/nginx/src/http/ngx_http_script.c"
                                                      );
        } else {
            return cap[n + 1] - cap[n];
        }
...
# 1400 "project/nginx/src/http/ngx_http_script.c" 3 4
                                              1
# 1400 "project/nginx/src/http/ngx_http_script.c"
                                                             );
        } else {
            e->pos = 
# 1402 "project/nginx/src/http/ngx_http_script.c" 3 4
                    (((u_char *) __builtin___memcpy_chk (
# 1402 "project/nginx/src/http/ngx_http_script.c"
                    pos
# 1402 "project/nginx/src/http/ngx_http_script.c" 3 4
                    , 
# 1402 "project/nginx/src/http/ngx_http_script.c"
...
# 1420 "project/nginx/src/http/ngx_http_script.c" 3 4
                                   ((void *)0)
# 1420 "project/nginx/src/http/ngx_http_script.c"
                                       );
    if (code == 
# 1421 "project/nginx/src/http/ngx_http_script.c" 3 4
               ((void *)0)
# 1421 "project/nginx/src/http/ngx_http_script.c"
                   ) {
        return 
# 1422 "project/nginx/src/http/ngx_http_script.c" 3 4
              -1
# 1422 "project/nginx/src/http/ngx_http_script.c"
                       ;
    }
    ...
    code = ngx_http_script_add_code(*sc->values,
                                    ...
                                    &sc->main);
    if (code == 
# 1432 "project/nginx/src/http/ngx_http_script.c" 3 4
               ((void *)0)
# 1432 "project/nginx/src/http/ngx_http_script.c"
                   ) {
        return 
# 1433 "project/nginx/src/http/ngx_http_script.c" 3 4
              -1
# 1433 "project/nginx/src/http/ngx_http_script.c"
                       ;
    }
    ...
    return 
# 1439 "project/nginx/src/http/ngx_http_script.c" 3 4
          0
# 1439 "project/nginx/src/http/ngx_http_script.c"
                ;
}
...
ngx_http_script_full_name_code(ngx_http_script_engine_t *e)
{
    ...
    if (ngx_get_full_name(e->request->pool, prefix, &value) != 
# 1472 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                              0
# 1472 "project/nginx/src/http/ngx_http_script.c"
                                                                    ) {
        e->ip = (u_char *) &ngx_http_script_exit_code;
        e->status = 
# 1474 "project/nginx/src/http/ngx_http_script.c" 3 4
                   500
# 1474 "project/nginx/src/http/ngx_http_script.c"
                                                 ;
        return;
    }
...
ngx_http_script_return_code(ngx_http_script_engine_t *e)
{
    ...
    if (code->status < 
# 1494 "project/nginx/src/http/ngx_http_script.c" 3 4
                      400
        
# 1495 "project/nginx/src/http/ngx_http_script.c"
       || code->text.value.len
        || code->text.lengths)
    {
        e->status = ngx_http_send_response(e->request, code->status, 
# 1498 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                                    ((void *)0)
# 1498 "project/nginx/src/http/ngx_http_script.c"
                                                                        ,
                                           &code->text);
    } else {
        e->status = code->status;
...
ngx_http_script_equal_code(ngx_http_script_engine_t *e)
{
    ...
    if (val->len == res->len
        && 
# 1568 "project/nginx/src/http/ngx_http_script.c" 3 4
          strncmp((const char *) 
# 1568 "project/nginx/src/http/ngx_http_script.c"
          val->data
# 1568 "project/nginx/src/http/ngx_http_script.c" 3 4
          , (const char *) 
# 1568 "project/nginx/src/http/ngx_http_script.c"
...
ngx_http_script_not_equal_code(ngx_http_script_engine_t *e)
{
    ...
    if (val->len == res->len
        && 
# 1596 "project/nginx/src/http/ngx_http_script.c" 3 4
          strncmp((const char *) 
# 1596 "project/nginx/src/http/ngx_http_script.c"
          val->data
# 1596 "project/nginx/src/http/ngx_http_script.c" 3 4
          , (const char *) 
# 1596 "project/nginx/src/http/ngx_http_script.c"
...
ngx_http_script_file_code(ngx_http_script_engine_t *e)
{
    ...
    clcf = 
# 1632 "project/nginx/src/http/ngx_http_script.c" 3 4
          (
# 1632 "project/nginx/src/http/ngx_http_script.c"
          r
# 1632 "project/nginx/src/http/ngx_http_script.c" 3 4
          )->loc_conf[
# 1632 "project/nginx/src/http/ngx_http_script.c"
...
# 1634 "project/nginx/src/http/ngx_http_script.c" 3 4
   (void) __builtin___memset_chk (
# 1634 "project/nginx/src/http/ngx_http_script.c"
   &of
# 1634 "project/nginx/src/http/ngx_http_script.c" 3 4
   , 0, 
# 1634 "project/nginx/src/http/ngx_http_script.c"
...
# 1644 "project/nginx/src/http/ngx_http_script.c" 3 4
                                                             0
# 1644 "project/nginx/src/http/ngx_http_script.c"
                                                                   ) {
        e->ip = (u_char *) &ngx_http_script_exit_code;
        e->status = 
# 1646 "project/nginx/src/http/ngx_http_script.c" 3 4
                   500
# 1646 "project/nginx/src/http/ngx_http_script.c"
                                                 ;
        return;
    }
    ...
    if (ngx_open_cached_file(clcf->open_file_cache, &path, &of, r->pool)
        != 
# 1651 "project/nginx/src/http/ngx_http_script.c" 3 4
          0
# 1651 "project/nginx/src/http/ngx_http_script.c"
                )
    {
        if (of.err == 0) {
            e->ip = (u_char *) &ngx_http_script_exit_code;
            e->status = 
# 1655 "project/nginx/src/http/ngx_http_script.c" 3 4
                       500
# 1655 "project/nginx/src/http/ngx_http_script.c"
                                                     ;
            return;
        }

        if (of.err != 
# 1659 "project/nginx/src/http/ngx_http_script.c" 3 4
                     2
            
# 1660 "project/nginx/src/http/ngx_http_script.c"
           && of.err != 
# 1660 "project/nginx/src/http/ngx_http_script.c" 3 4
                        20
            
# 1661 "project/nginx/src/http/ngx_http_script.c"
           && of.err != 
# 1661 "project/nginx/src/http/ngx_http_script.c" 3 4
                        63
# 1661 "project/nginx/src/http/ngx_http_script.c"
                                        )
        {
            
# 1663 "project/nginx/src/http/ngx_http_script.c" 3 4
           if ((
# 1663 "project/nginx/src/http/ngx_http_script.c"
           r->connection->log
# 1663 "project/nginx/src/http/ngx_http_script.c" 3 4
...
# 1663 "project/nginx/src/http/ngx_http_script.c" 3 4
           , 
# 1663 "project/nginx/src/http/ngx_http_script.c"
           of.err, "%s \"%s\" failed", of.failed, value->data
# 1663 "project/nginx/src/http/ngx_http_script.c" 3 4
           )
                                                                     
# 1664 "project/nginx/src/http/ngx_http_script.c"
                                                                    ;
        }
...
# 1765 "project/nginx/src/http/ngx_http_script.c" 3 4
   (void) __builtin___memset_chk (
# 1765 "project/nginx/src/http/ngx_http_script.c"
   &le
# 1765 "project/nginx/src/http/ngx_http_script.c" 3 4
   , 0, 
# 1765 "project/nginx/src/http/ngx_http_script.c"
...
# 1765 "project/nginx/src/http/ngx_http_script.c"
    ...
    if (e->buf.data == 
# 1778 "project/nginx/src/http/ngx_http_script.c" 3 4
                      ((void *)0)
# 1778 "project/nginx/src/http/ngx_http_script.c"
                          ) {
        e->ip = (u_char *) &ngx_http_script_exit_code;
        e->status = 
# 1780 "project/nginx/src/http/ngx_http_script.c" 3 4
                   500
# 1780 "project/nginx/src/http/ngx_http_script.c"
                                                 ;
        return;
    }
...
# 1844 "project/nginx/src/http/ngx_http_script.c"
}
