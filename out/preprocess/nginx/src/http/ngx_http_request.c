# 0 "project/nginx/src/http/ngx_http_request.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/http/ngx_http_request.c"
...
# 9 "project/nginx/src/http/ngx_http_request.c" 2
...
# 10 "project/nginx/src/http/ngx_http_request.c" 2
...
# 11 "project/nginx/src/http/ngx_http_request.c" 2



# 13 "project/nginx/src/http/ngx_http_request.c"
...
ngx_http_header_t ngx_http_headers_in[] = {
    { 
# 85 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 85 "project/nginx/src/http/ngx_http_request.c"
     "Host"
# 85 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 85 "project/nginx/src/http/ngx_http_request.c"
...
# 85 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 88 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 88 "project/nginx/src/http/ngx_http_request.c"
     "Connection"
# 88 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 88 "project/nginx/src/http/ngx_http_request.c"
...
# 88 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 91 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 91 "project/nginx/src/http/ngx_http_request.c"
     "If-Modified-Since"
# 91 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 91 "project/nginx/src/http/ngx_http_request.c"
...
# 92 "project/nginx/src/http/ngx_http_request.c" 3 4
                __builtin_offsetof (
# 92 "project/nginx/src/http/ngx_http_request.c"
                ngx_http_headers_in_t
# 92 "project/nginx/src/http/ngx_http_request.c" 3 4
                , 
# 92 "project/nginx/src/http/ngx_http_request.c"
...
# 92 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 95 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 95 "project/nginx/src/http/ngx_http_request.c"
     "If-Unmodified-Since"
# 95 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 95 "project/nginx/src/http/ngx_http_request.c"
...
# 96 "project/nginx/src/http/ngx_http_request.c" 3 4
                __builtin_offsetof (
# 96 "project/nginx/src/http/ngx_http_request.c"
                ngx_http_headers_in_t
# 96 "project/nginx/src/http/ngx_http_request.c" 3 4
                , 
# 96 "project/nginx/src/http/ngx_http_request.c"
...
# 96 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 99 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 99 "project/nginx/src/http/ngx_http_request.c"
     "If-Match"
# 99 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 99 "project/nginx/src/http/ngx_http_request.c"
...
# 100 "project/nginx/src/http/ngx_http_request.c" 3 4
                __builtin_offsetof (
# 100 "project/nginx/src/http/ngx_http_request.c"
                ngx_http_headers_in_t
# 100 "project/nginx/src/http/ngx_http_request.c" 3 4
                , 
# 100 "project/nginx/src/http/ngx_http_request.c"
...
# 100 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 103 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 103 "project/nginx/src/http/ngx_http_request.c"
     "If-None-Match"
# 103 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 103 "project/nginx/src/http/ngx_http_request.c"
...
# 104 "project/nginx/src/http/ngx_http_request.c" 3 4
                __builtin_offsetof (
# 104 "project/nginx/src/http/ngx_http_request.c"
                ngx_http_headers_in_t
# 104 "project/nginx/src/http/ngx_http_request.c" 3 4
                , 
# 104 "project/nginx/src/http/ngx_http_request.c"
...
# 104 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 107 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 107 "project/nginx/src/http/ngx_http_request.c"
     "User-Agent"
# 107 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 107 "project/nginx/src/http/ngx_http_request.c"
...
# 107 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 110 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 110 "project/nginx/src/http/ngx_http_request.c"
     "Referer"
# 110 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 110 "project/nginx/src/http/ngx_http_request.c"
...
# 110 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 113 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 113 "project/nginx/src/http/ngx_http_request.c"
     "Content-Length"
# 113 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 113 "project/nginx/src/http/ngx_http_request.c"
...
# 114 "project/nginx/src/http/ngx_http_request.c" 3 4
                __builtin_offsetof (
# 114 "project/nginx/src/http/ngx_http_request.c"
                ngx_http_headers_in_t
# 114 "project/nginx/src/http/ngx_http_request.c" 3 4
                , 
# 114 "project/nginx/src/http/ngx_http_request.c"
...
# 114 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 117 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 117 "project/nginx/src/http/ngx_http_request.c"
     "Content-Range"
# 117 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 117 "project/nginx/src/http/ngx_http_request.c"
...
# 118 "project/nginx/src/http/ngx_http_request.c" 3 4
                __builtin_offsetof (
# 118 "project/nginx/src/http/ngx_http_request.c"
                ngx_http_headers_in_t
# 118 "project/nginx/src/http/ngx_http_request.c" 3 4
                , 
# 118 "project/nginx/src/http/ngx_http_request.c"
...
# 118 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 121 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 121 "project/nginx/src/http/ngx_http_request.c"
     "Content-Type"
# 121 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 121 "project/nginx/src/http/ngx_http_request.c"
...
# 122 "project/nginx/src/http/ngx_http_request.c" 3 4
                __builtin_offsetof (
# 122 "project/nginx/src/http/ngx_http_request.c"
                ngx_http_headers_in_t
# 122 "project/nginx/src/http/ngx_http_request.c" 3 4
                , 
# 122 "project/nginx/src/http/ngx_http_request.c"
...
# 122 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 125 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 125 "project/nginx/src/http/ngx_http_request.c"
     "Range"
# 125 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 125 "project/nginx/src/http/ngx_http_request.c"
...
# 125 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 128 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 128 "project/nginx/src/http/ngx_http_request.c"
     "If-Range"
# 128 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 128 "project/nginx/src/http/ngx_http_request.c"
...
# 129 "project/nginx/src/http/ngx_http_request.c" 3 4
                __builtin_offsetof (
# 129 "project/nginx/src/http/ngx_http_request.c"
                ngx_http_headers_in_t
# 129 "project/nginx/src/http/ngx_http_request.c" 3 4
                , 
# 129 "project/nginx/src/http/ngx_http_request.c"
...
# 129 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 132 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 132 "project/nginx/src/http/ngx_http_request.c"
     "Transfer-Encoding"
# 132 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 132 "project/nginx/src/http/ngx_http_request.c"
...
# 133 "project/nginx/src/http/ngx_http_request.c" 3 4
                __builtin_offsetof (
# 133 "project/nginx/src/http/ngx_http_request.c"
                ngx_http_headers_in_t
# 133 "project/nginx/src/http/ngx_http_request.c" 3 4
                , 
# 133 "project/nginx/src/http/ngx_http_request.c"
...
# 133 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 136 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 136 "project/nginx/src/http/ngx_http_request.c"
     "TE"
# 136 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 136 "project/nginx/src/http/ngx_http_request.c"
...
# 137 "project/nginx/src/http/ngx_http_request.c" 3 4
                __builtin_offsetof (
# 137 "project/nginx/src/http/ngx_http_request.c"
                ngx_http_headers_in_t
# 137 "project/nginx/src/http/ngx_http_request.c" 3 4
                , 
# 137 "project/nginx/src/http/ngx_http_request.c"
...
# 137 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 140 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 140 "project/nginx/src/http/ngx_http_request.c"
     "Expect"
# 140 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 140 "project/nginx/src/http/ngx_http_request.c"
...
# 141 "project/nginx/src/http/ngx_http_request.c" 3 4
                __builtin_offsetof (
# 141 "project/nginx/src/http/ngx_http_request.c"
                ngx_http_headers_in_t
# 141 "project/nginx/src/http/ngx_http_request.c" 3 4
                , 
# 141 "project/nginx/src/http/ngx_http_request.c"
...
# 141 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 144 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 144 "project/nginx/src/http/ngx_http_request.c"
     "Upgrade"
# 144 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 144 "project/nginx/src/http/ngx_http_request.c"
...
# 145 "project/nginx/src/http/ngx_http_request.c" 3 4
                __builtin_offsetof (
# 145 "project/nginx/src/http/ngx_http_request.c"
                ngx_http_headers_in_t
# 145 "project/nginx/src/http/ngx_http_request.c" 3 4
                , 
# 145 "project/nginx/src/http/ngx_http_request.c"
...
# 145 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 149 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 149 "project/nginx/src/http/ngx_http_request.c"
     "Accept-Encoding"
# 149 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 149 "project/nginx/src/http/ngx_http_request.c"
...
# 150 "project/nginx/src/http/ngx_http_request.c" 3 4
                __builtin_offsetof (
# 150 "project/nginx/src/http/ngx_http_request.c"
                ngx_http_headers_in_t
# 150 "project/nginx/src/http/ngx_http_request.c" 3 4
                , 
# 150 "project/nginx/src/http/ngx_http_request.c"
...
# 150 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 153 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 153 "project/nginx/src/http/ngx_http_request.c"
     "Via"
# 153 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 153 "project/nginx/src/http/ngx_http_request.c"
...
# 153 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 157 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 157 "project/nginx/src/http/ngx_http_request.c"
     "Authorization"
# 157 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 157 "project/nginx/src/http/ngx_http_request.c"
...
# 158 "project/nginx/src/http/ngx_http_request.c" 3 4
                __builtin_offsetof (
# 158 "project/nginx/src/http/ngx_http_request.c"
                ngx_http_headers_in_t
# 158 "project/nginx/src/http/ngx_http_request.c" 3 4
                , 
# 158 "project/nginx/src/http/ngx_http_request.c"
...
# 158 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 161 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 161 "project/nginx/src/http/ngx_http_request.c"
     "Keep-Alive"
# 161 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 161 "project/nginx/src/http/ngx_http_request.c"
...
# 161 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 165 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 165 "project/nginx/src/http/ngx_http_request.c"
     "X-Forwarded-For"
# 165 "project/nginx/src/http/ngx_http_request.c" 3 4
     ) - 1, (u_char *) 
# 165 "project/nginx/src/http/ngx_http_request.c"
...
# 166 "project/nginx/src/http/ngx_http_request.c" 3 4
                __builtin_offsetof (
# 166 "project/nginx/src/http/ngx_http_request.c"
                ngx_http_headers_in_t
# 166 "project/nginx/src/http/ngx_http_request.c" 3 4
                , 
# 166 "project/nginx/src/http/ngx_http_request.c"
...
# 199 "project/nginx/src/http/ngx_http_request.c"
    { 
# 199 "project/nginx/src/http/ngx_http_request.c" 3 4
     { sizeof(
# 199 "project/nginx/src/http/ngx_http_request.c"
     "Cookie"
# 199 "project/nginx/src/http/ngx_http_request.c" 3 4
...
# 199 "project/nginx/src/http/ngx_http_request.c"
    ...
    { 
# 202 "project/nginx/src/http/ngx_http_request.c" 3 4
     { 0, ((void *)0) }
# 202 "project/nginx/src/http/ngx_http_request.c"
                    , 0, 
# 202 "project/nginx/src/http/ngx_http_request.c" 3 4
                         ((void *)0) 
# 202 "project/nginx/src/http/ngx_http_request.c"
...
ngx_http_init_connection(ngx_connection_t *c)
{
    ...
    if (hc == 
# 223 "project/nginx/src/http/ngx_http_request.c" 3 4
             ((void *)0)
# 223 "project/nginx/src/http/ngx_http_request.c"
                 ) {
...
# 242 "project/nginx/src/http/ngx_http_request.c" 3 4
                                            ((void *)0)
# 242 "project/nginx/src/http/ngx_http_request.c"
                                                , 0) != 
# 242 "project/nginx/src/http/ngx_http_request.c" 3 4
                                                        0
# 242 "project/nginx/src/http/ngx_http_request.c"
        ...
        case 
# 250 "project/nginx/src/http/ngx_http_request.c" 3 4
            30
# 250 "project/nginx/src/http/ngx_http_request.c"
                    :
            ...
            for (i = 0; i < port->naddrs - 1; i++) {
                if (
# 258 "project/nginx/src/http/ngx_http_request.c" 3 4
                   memcmp((const char *) 
# 258 "project/nginx/src/http/ngx_http_request.c"
                   &addr6[i].addr6
# 258 "project/nginx/src/http/ngx_http_request.c" 3 4
                   , (const char *) 
# 258 "project/nginx/src/http/ngx_http_request.c"
...
# 258 "project/nginx/src/http/ngx_http_request.c"
        ...
        case 
# 291 "project/nginx/src/http/ngx_http_request.c" 3 4
            30
# 291 "project/nginx/src/http/ngx_http_request.c"
                    :
            addr6 = port->addrs;
    ...
    if (ctx == 
# 308 "project/nginx/src/http/ngx_http_request.c" 3 4
              ((void *)0)
# 308 "project/nginx/src/http/ngx_http_request.c"
                  ) {
        ngx_http_close_connection(c);
        return;
    }
    ...
    ctx->connection = c;
    ctx->request = 
# 314 "project/nginx/src/http/ngx_http_request.c" 3 4
                  ((void *)0)
# 314 "project/nginx/src/http/ngx_http_request.c"
                      ;
    ctx->current_request = 
# 315 "project/nginx/src/http/ngx_http_request.c" 3 4
                          ((void *)0)
# 315 "project/nginx/src/http/ngx_http_request.c"
                              ;
...
# 348 "project/nginx/src/http/ngx_http_request.c"
...
# 357 "project/nginx/src/http/ngx_http_request.c" 3 4
           if (!(
# 357 "project/nginx/src/http/ngx_http_request.c"
           rev
# 357 "project/nginx/src/http/ngx_http_request.c" 3 4
           )->posted) { (
# 357 "project/nginx/src/http/ngx_http_request.c"
...
# 357 "project/nginx/src/http/ngx_http_request.c"
    ...
    cscf = 
# 365 "project/nginx/src/http/ngx_http_request.c" 3 4
          (
# 365 "project/nginx/src/http/ngx_http_request.c"
          hc->conf_ctx
# 365 "project/nginx/src/http/ngx_http_request.c" 3 4
          )->srv_conf[
# 365 "project/nginx/src/http/ngx_http_request.c"
...
# 367 "project/nginx/src/http/ngx_http_request.c" 3 4
   ngx_event_add_timer
# 367 "project/nginx/src/http/ngx_http_request.c"
                (rev, cscf->client_header_timeout);
    ngx_reusable_connection(c, 1);

    if (ngx_handle_read_event(rev, 0) != 
# 370 "project/nginx/src/http/ngx_http_request.c" 3 4
                                        0
# 370 "project/nginx/src/http/ngx_http_request.c"
                                              ) {
        ngx_http_close_connection(c);
        return;
    }
...
# 393 "project/nginx/src/http/ngx_http_request.c" 3 4
       if ((
# 393 "project/nginx/src/http/ngx_http_request.c"
       c->log
# 393 "project/nginx/src/http/ngx_http_request.c" 3 4
...
# 393 "project/nginx/src/http/ngx_http_request.c"
    ...
    hc = c->data;
    cscf = 
# 404 "project/nginx/src/http/ngx_http_request.c" 3 4
          (
# 404 "project/nginx/src/http/ngx_http_request.c"
          hc->conf_ctx
# 404 "project/nginx/src/http/ngx_http_request.c" 3 4
          )->srv_conf[
# 404 "project/nginx/src/http/ngx_http_request.c"
...
# 404 "project/nginx/src/http/ngx_http_request.c"
    ...
    if (b == 
# 410 "project/nginx/src/http/ngx_http_request.c" 3 4
            ((void *)0)
# 410 "project/nginx/src/http/ngx_http_request.c"
                ) {
        b = ngx_create_temp_buf(c->pool, size);
        if (b == 
# 412 "project/nginx/src/http/ngx_http_request.c" 3 4
                ((void *)0)
# 412 "project/nginx/src/http/ngx_http_request.c"
                    ) {
            ngx_http_close_connection(c);
            return;
        }
...
# 419 "project/nginx/src/http/ngx_http_request.c" 3 4
                          ((void *)0)
# 419 "project/nginx/src/http/ngx_http_request.c"
                              ) {

        b->start = ngx_palloc(c->pool, size);
        if (b->start == 
# 422 "project/nginx/src/http/ngx_http_request.c" 3 4
                       ((void *)0)
# 422 "project/nginx/src/http/ngx_http_request.c"
                           ) {
            ngx_http_close_connection(c);
            return;
        }
    ...
    if (n == 
# 434 "project/nginx/src/http/ngx_http_request.c" 3 4
            -2
# 434 "project/nginx/src/http/ngx_http_request.c"
                     ) {

        if (!rev->timer_set) {
            
# 437 "project/nginx/src/http/ngx_http_request.c" 3 4
           ngx_event_add_timer
# 437 "project/nginx/src/http/ngx_http_request.c"
                        (rev, cscf->client_header_timeout);
            ngx_reusable_connection(c, 1);
        }

        if (ngx_handle_read_event(rev, 0) != 
# 441 "project/nginx/src/http/ngx_http_request.c" 3 4
                                            0
# 441 "project/nginx/src/http/ngx_http_request.c"
                                                  ) {
            ngx_http_close_connection(c);
            return;
        }
        ...
        if (ngx_pfree(c->pool, b->start) == 
# 450 "project/nginx/src/http/ngx_http_request.c" 3 4
                                           0
# 450 "project/nginx/src/http/ngx_http_request.c"
                                                 ) {
            b->start = 
# 451 "project/nginx/src/http/ngx_http_request.c" 3 4
                      ((void *)0)
# 451 "project/nginx/src/http/ngx_http_request.c"
                          ;
        }
    ...
    if (n == 
# 457 "project/nginx/src/http/ngx_http_request.c" 3 4
            -1
# 457 "project/nginx/src/http/ngx_http_request.c"
                     ) {
        ngx_http_close_connection(c);
        return;
    }
...
# 463 "project/nginx/src/http/ngx_http_request.c" 3 4
       if ((
# 463 "project/nginx/src/http/ngx_http_request.c"
       c->log
# 463 "project/nginx/src/http/ngx_http_request.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 463 "project/nginx/src/http/ngx_http_request.c"
...
# 464 "project/nginx/src/http/ngx_http_request.c"
                                                ;
        ngx_http_close_connection(c);
        return;
    }
    ...
    if (hc->proxy_protocol) {
        ...
        if (p == 
# 476 "project/nginx/src/http/ngx_http_request.c" 3 4
                ((void *)0)
# 476 "project/nginx/src/http/ngx_http_request.c"
                    ) {
            ngx_http_close_connection(c);
            return;
        }
...
# 487 "project/nginx/src/http/ngx_http_request.c" 3 4
           if (!(
# 487 "project/nginx/src/http/ngx_http_request.c"
           rev
# 487 "project/nginx/src/http/ngx_http_request.c" 3 4
           )->posted) { (
# 487 "project/nginx/src/http/ngx_http_request.c"
...
# 487 "project/nginx/src/http/ngx_http_request.c"
    ...
    if (c->data == 
# 497 "project/nginx/src/http/ngx_http_request.c" 3 4
                  ((void *)0)
# 497 "project/nginx/src/http/ngx_http_request.c"
                      ) {
        ngx_http_close_connection(c);
        return;
    }
...
ngx_http_create_request(ngx_connection_t *c)
{
    ...
    if (r == 
# 515 "project/nginx/src/http/ngx_http_request.c" 3 4
            ((void *)0)
# 515 "project/nginx/src/http/ngx_http_request.c"
                ) {
        return 
# 516 "project/nginx/src/http/ngx_http_request.c" 3 4
              ((void *)0)
# 516 "project/nginx/src/http/ngx_http_request.c"
                  ;
    }
    ...
    clcf = 
# 521 "project/nginx/src/http/ngx_http_request.c" 3 4
          (
# 521 "project/nginx/src/http/ngx_http_request.c"
          r
# 521 "project/nginx/src/http/ngx_http_request.c" 3 4
          )->loc_conf[
# 521 "project/nginx/src/http/ngx_http_request.c"
...
# 521 "project/nginx/src/http/ngx_http_request.c"
    ...
    c
# 523 "project/nginx/src/http/ngx_http_request.c" 3 4
   ->log->file = 
# 523 "project/nginx/src/http/ngx_http_request.c"
   clcf->error_log
# 523 "project/nginx/src/http/ngx_http_request.c" 3 4
   ->file; 
# 523 "project/nginx/src/http/ngx_http_request.c"
...
ngx_http_alloc_request(ngx_connection_t *c)
{
    ...
    cscf = 
# 551 "project/nginx/src/http/ngx_http_request.c" 3 4
          (
# 551 "project/nginx/src/http/ngx_http_request.c"
          hc->conf_ctx
# 551 "project/nginx/src/http/ngx_http_request.c" 3 4
          )->srv_conf[
# 551 "project/nginx/src/http/ngx_http_request.c"
...
# 551 "project/nginx/src/http/ngx_http_request.c"
    ...
    if (pool == 
# 554 "project/nginx/src/http/ngx_http_request.c" 3 4
               ((void *)0)
# 554 "project/nginx/src/http/ngx_http_request.c"
                   ) {
        return 
# 555 "project/nginx/src/http/ngx_http_request.c" 3 4
              ((void *)0)
# 555 "project/nginx/src/http/ngx_http_request.c"
                  ;
    }

    r = ngx_pcalloc(pool, sizeof(ngx_http_request_t));
    if (r == 
# 559 "project/nginx/src/http/ngx_http_request.c" 3 4
            ((void *)0)
# 559 "project/nginx/src/http/ngx_http_request.c"
                ) {
        ngx_destroy_pool(pool);
        return 
# 561 "project/nginx/src/http/ngx_http_request.c" 3 4
              ((void *)0)
# 561 "project/nginx/src/http/ngx_http_request.c"
                  ;
    }
    ...
    r->signature = 
# 567 "project/nginx/src/http/ngx_http_request.c" 3 4
                  0x50545448
# 567 "project/nginx/src/http/ngx_http_request.c"
                                 ;
    r->connection = c;
    ...
    if (ngx_list_init(&r->headers_out.headers, r->pool, 20,
        ...
        != 
# 580 "project/nginx/src/http/ngx_http_request.c" 3 4
          0
# 580 "project/nginx/src/http/ngx_http_request.c"
                )
    {
        ngx_destroy_pool(r->pool);
        return 
# 583 "project/nginx/src/http/ngx_http_request.c" 3 4
              ((void *)0)
# 583 "project/nginx/src/http/ngx_http_request.c"
                  ;
    }
    ...
    if (ngx_list_init(&r->headers_out.trailers, r->pool, 4,
                      sizeof(ngx_table_elt_t))
        != 
# 588 "project/nginx/src/http/ngx_http_request.c" 3 4
          0
# 588 "project/nginx/src/http/ngx_http_request.c"
                )
    {
        ngx_destroy_pool(r->pool);
        return 
# 591 "project/nginx/src/http/ngx_http_request.c" 3 4
              ((void *)0)
# 591 "project/nginx/src/http/ngx_http_request.c"
                  ;
    }

    r->ctx = ngx_pcalloc(r->pool, sizeof(void *) * ngx_http_max_module);
    if (r->ctx == 
# 595 "project/nginx/src/http/ngx_http_request.c" 3 4
                 ((void *)0)
# 595 "project/nginx/src/http/ngx_http_request.c"
                     ) {
        ngx_destroy_pool(r->pool);
        return 
# 597 "project/nginx/src/http/ngx_http_request.c" 3 4
              ((void *)0)
# 597 "project/nginx/src/http/ngx_http_request.c"
                  ;
    }

    cmcf = 
# 600 "project/nginx/src/http/ngx_http_request.c" 3 4
          (
# 600 "project/nginx/src/http/ngx_http_request.c"
          r
# 600 "project/nginx/src/http/ngx_http_request.c" 3 4
          )->main_conf[
# 600 "project/nginx/src/http/ngx_http_request.c"
...
# 600 "project/nginx/src/http/ngx_http_request.c"
    ...
    if (r->variables == 
# 604 "project/nginx/src/http/ngx_http_request.c" 3 4
                       ((void *)0)
# 604 "project/nginx/src/http/ngx_http_request.c"
                           ) {
        ngx_destroy_pool(r->pool);
        return 
# 606 "project/nginx/src/http/ngx_http_request.c" 3 4
              ((void *)0)
# 606 "project/nginx/src/http/ngx_http_request.c"
                  ;
    }
    ...
    tp = 
# 618 "project/nginx/src/http/ngx_http_request.c" 3 4
        (ngx_time_t *) ngx_cached_time
# 618 "project/nginx/src/http/ngx_http_request.c"
                       ;
    r->start_sec = tp->sec;
    r->start_msec = tp->msec;

    r->method = 
# 622 "project/nginx/src/http/ngx_http_request.c" 3 4
               0x00000001
# 622 "project/nginx/src/http/ngx_http_request.c"
                               ;
    r->http_version = 
# 623 "project/nginx/src/http/ngx_http_request.c" 3 4
                     1000
# 623 "project/nginx/src/http/ngx_http_request.c"
                                        ;
    ...
    r->uri_changes = 
# 630 "project/nginx/src/http/ngx_http_request.c" 3 4
                    10 
# 630 "project/nginx/src/http/ngx_http_request.c"
                                             + 1;
    r->subrequests = 
# 631 "project/nginx/src/http/ngx_http_request.c" 3 4
                    50 
# 631 "project/nginx/src/http/ngx_http_request.c"
                                             + 1;
...
# 1051 "project/nginx/src/http/ngx_http_request.c"
static void
...
# 1067 "project/nginx/src/http/ngx_http_request.c" 3 4
       if ((
# 1067 "project/nginx/src/http/ngx_http_request.c"
       c->log
# 1067 "project/nginx/src/http/ngx_http_request.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 1067 "project/nginx/src/http/ngx_http_request.c"
...
# 1069 "project/nginx/src/http/ngx_http_request.c" 3 4
                                 408
# 1069 "project/nginx/src/http/ngx_http_request.c"
                                                          );
        return;
    }

    rc = 
# 1073 "project/nginx/src/http/ngx_http_request.c" 3 4
        -2
# 1073 "project/nginx/src/http/ngx_http_request.c"
                 ;

    for ( ;; ) {

        if (rc == 
# 1077 "project/nginx/src/http/ngx_http_request.c" 3 4
                 -2
# 1077 "project/nginx/src/http/ngx_http_request.c"
                          ) {
            n = ngx_http_read_request_header(r);

            if (n == 
# 1080 "project/nginx/src/http/ngx_http_request.c" 3 4
                    -2 
# 1080 "project/nginx/src/http/ngx_http_request.c"
                              || n == 
# 1080 "project/nginx/src/http/ngx_http_request.c" 3 4
                                      -1
# 1080 "project/nginx/src/http/ngx_http_request.c"
        ...
        if (rc == 
# 1087 "project/nginx/src/http/ngx_http_request.c" 3 4
                 0
# 1087 "project/nginx/src/http/ngx_http_request.c"
                       ) {
...
# 1105 "project/nginx/src/http/ngx_http_request.c" 3 4
                                                  0
# 1105 "project/nginx/src/http/ngx_http_request.c"
                                                        ) {
                break;
            }
            ...
            if (r->host_end) {
                ...
                if (rc == 
# 1121 "project/nginx/src/http/ngx_http_request.c" 3 4
                         -5
# 1121 "project/nginx/src/http/ngx_http_request.c"
                                     ) {
                    
# 1122 "project/nginx/src/http/ngx_http_request.c" 3 4
                   if ((
# 1122 "project/nginx/src/http/ngx_http_request.c"
                   c->log
# 1122 "project/nginx/src/http/ngx_http_request.c" 3 4
                   )->log_level >= 7) ngx_log_error_core(7, 
# 1122 "project/nginx/src/http/ngx_http_request.c"
...
# 1122 "project/nginx/src/http/ngx_http_request.c" 3 4
                   , 
# 1122 "project/nginx/src/http/ngx_http_request.c"
                   0, "client sent invalid host in request line"
# 1122 "project/nginx/src/http/ngx_http_request.c" 3 4
                   )
                                                                             
# 1123 "project/nginx/src/http/ngx_http_request.c"
                                                                            ;
                    ngx_http_finalize_request(r, 
# 1124 "project/nginx/src/http/ngx_http_request.c" 3 4
                                                400
# 1124 "project/nginx/src/http/ngx_http_request.c"
                                                                    );
                    break;
                }

                if (rc == 
# 1128 "project/nginx/src/http/ngx_http_request.c" 3 4
                         -1
# 1128 "project/nginx/src/http/ngx_http_request.c"
                                  ) {
                    ngx_http_close_request(r, 
# 1129 "project/nginx/src/http/ngx_http_request.c" 3 4
                                             500
# 1129 "project/nginx/src/http/ngx_http_request.c"
                                                                           );
                    break;
                }

                if (ngx_http_set_virtual_server(r, &host) == 
# 1133 "project/nginx/src/http/ngx_http_request.c" 3 4
                                                            -1
# 1133 "project/nginx/src/http/ngx_http_request.c"
                                                                     ) {
                    break;
                }
            ...
            if (r->http_version < 
# 1140 "project/nginx/src/http/ngx_http_request.c" 3 4
                                 1000
# 1140 "project/nginx/src/http/ngx_http_request.c"
                                                    ) {

                if (r->headers_in.server.len == 0
                    && ngx_http_set_virtual_server(r, &r->headers_in.server)
                       == 
# 1144 "project/nginx/src/http/ngx_http_request.c" 3 4
                         -1
# 1144 "project/nginx/src/http/ngx_http_request.c"
                                  )
                {
                    break;
                }
            ...
            if (ngx_list_init(&r->headers_in.headers, r->pool, 20,
                              sizeof(ngx_table_elt_t))
                != 
# 1156 "project/nginx/src/http/ngx_http_request.c" 3 4
                  0
# 1156 "project/nginx/src/http/ngx_http_request.c"
                        )
            {
                ngx_http_close_request(r, 
# 1158 "project/nginx/src/http/ngx_http_request.c" 3 4
                                         500
# 1158 "project/nginx/src/http/ngx_http_request.c"
                                                                       );
                break;
            }
        ...
        if (rc != 
# 1170 "project/nginx/src/http/ngx_http_request.c" 3 4
                 -2
# 1170 "project/nginx/src/http/ngx_http_request.c"
                          ) {



            
# 1174 "project/nginx/src/http/ngx_http_request.c" 3 4
           if ((
# 1174 "project/nginx/src/http/ngx_http_request.c"
           c->log
# 1174 "project/nginx/src/http/ngx_http_request.c" 3 4
           )->log_level >= 7) ngx_log_error_core(7, 
# 1174 "project/nginx/src/http/ngx_http_request.c"
...
# 1175 "project/nginx/src/http/ngx_http_request.c"
                                                                            ;

            if (rc == 
# 1177 "project/nginx/src/http/ngx_http_request.c" 3 4
                     12
# 1177 "project/nginx/src/http/ngx_http_request.c"
                                                   ) {
                ngx_http_finalize_request(r, 
# 1178 "project/nginx/src/http/ngx_http_request.c" 3 4
                                            505
# 1178 "project/nginx/src/http/ngx_http_request.c"
                                                                          );

            } else {
                ngx_http_finalize_request(r, 
# 1181 "project/nginx/src/http/ngx_http_request.c" 3 4
                                            400
# 1181 "project/nginx/src/http/ngx_http_request.c"
                                                                );
            }
        ...
        if (r->header_in->pos == r->header_in->end) {
            ...
            if (rv == 
# 1193 "project/nginx/src/http/ngx_http_request.c" 3 4
                     -1
# 1193 "project/nginx/src/http/ngx_http_request.c"
                              ) {
                ngx_http_close_request(r, 
# 1194 "project/nginx/src/http/ngx_http_request.c" 3 4
                                         500
# 1194 "project/nginx/src/http/ngx_http_request.c"
                                                                       );
                break;
            }

            if (rv == 
# 1198 "project/nginx/src/http/ngx_http_request.c" 3 4
                     -5
# 1198 "project/nginx/src/http/ngx_http_request.c"
                                 ) {
                r->request_line.len = r->header_in->end - r->request_start;
                r->request_line.data = r->request_start;

                
# 1202 "project/nginx/src/http/ngx_http_request.c" 3 4
               if ((
# 1202 "project/nginx/src/http/ngx_http_request.c"
               c->log
# 1202 "project/nginx/src/http/ngx_http_request.c" 3 4
               )->log_level >= 7) ngx_log_error_core(7, 
# 1202 "project/nginx/src/http/ngx_http_request.c"
...
# 1202 "project/nginx/src/http/ngx_http_request.c" 3 4
               , 
# 1202 "project/nginx/src/http/ngx_http_request.c"
               0, "client sent too long URI"
# 1202 "project/nginx/src/http/ngx_http_request.c" 3 4
               )
                                                         
# 1203 "project/nginx/src/http/ngx_http_request.c"
                                                        ;
                ngx_http_finalize_request(r, 
# 1204 "project/nginx/src/http/ngx_http_request.c" 3 4
                                            414
# 1204 "project/nginx/src/http/ngx_http_request.c"
                                                                          );
                break;
            }
        }
...
ngx_http_process_request_uri(ngx_http_request_t *r)
{
    ...
    if (r->complex_uri || r->quoted_uri || r->empty_path_in_uri) {
        ...
        if (r->uri.data == 
# 1232 "project/nginx/src/http/ngx_http_request.c" 3 4
                          ((void *)0)
# 1232 "project/nginx/src/http/ngx_http_request.c"
                              ) {
            ngx_http_close_request(r, 
# 1233 "project/nginx/src/http/ngx_http_request.c" 3 4
                                     500
# 1233 "project/nginx/src/http/ngx_http_request.c"
                                                                   );
            return 
# 1234 "project/nginx/src/http/ngx_http_request.c" 3 4
                  -1
# 1234 "project/nginx/src/http/ngx_http_request.c"
                           ;
        }

        cscf = 
# 1237 "project/nginx/src/http/ngx_http_request.c" 3 4
              (
# 1237 "project/nginx/src/http/ngx_http_request.c"
              r
# 1237 "project/nginx/src/http/ngx_http_request.c" 3 4
              )->srv_conf[
# 1237 "project/nginx/src/http/ngx_http_request.c"
...
# 1239 "project/nginx/src/http/ngx_http_request.c" 3 4
                                                                 0
# 1239 "project/nginx/src/http/ngx_http_request.c"
                                                                       ) {
            r->uri.len = 0;

            
# 1242 "project/nginx/src/http/ngx_http_request.c" 3 4
           if ((
# 1242 "project/nginx/src/http/ngx_http_request.c"
           r->connection->log
# 1242 "project/nginx/src/http/ngx_http_request.c" 3 4
           )->log_level >= 7) ngx_log_error_core(7, 
# 1242 "project/nginx/src/http/ngx_http_request.c"
...
# 1242 "project/nginx/src/http/ngx_http_request.c" 3 4
           , 
# 1242 "project/nginx/src/http/ngx_http_request.c"
           0, "client sent invalid request"
# 1242 "project/nginx/src/http/ngx_http_request.c" 3 4
           )
                                                        
# 1243 "project/nginx/src/http/ngx_http_request.c"
                                                       ;
            ngx_http_finalize_request(r, 
# 1244 "project/nginx/src/http/ngx_http_request.c" 3 4
                                        400
# 1244 "project/nginx/src/http/ngx_http_request.c"
                                                            );
            return 
# 1245 "project/nginx/src/http/ngx_http_request.c" 3 4
                  -1
# 1245 "project/nginx/src/http/ngx_http_request.c"
                           ;
        }
...
# 1322 "project/nginx/src/http/ngx_http_request.c"
    ...
    return 
# 1331 "project/nginx/src/http/ngx_http_request.c" 3 4
          0
# 1331 "project/nginx/src/http/ngx_http_request.c"
                ;
}
...
# 1356 "project/nginx/src/http/ngx_http_request.c" 3 4
       if ((
# 1356 "project/nginx/src/http/ngx_http_request.c"
       c->log
# 1356 "project/nginx/src/http/ngx_http_request.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 1356 "project/nginx/src/http/ngx_http_request.c"
...
# 1356 "project/nginx/src/http/ngx_http_request.c"
        ...
        c->timedout = 1;
        ngx_http_close_request(r, 
# 1358 "project/nginx/src/http/ngx_http_request.c" 3 4
                                 408
# 1358 "project/nginx/src/http/ngx_http_request.c"
                                                          );
        return;
    }

    cmcf = 
# 1362 "project/nginx/src/http/ngx_http_request.c" 3 4
          (
# 1362 "project/nginx/src/http/ngx_http_request.c"
          r
# 1362 "project/nginx/src/http/ngx_http_request.c" 3 4
          )->main_conf[
# 1362 "project/nginx/src/http/ngx_http_request.c"
...
# 1362 "project/nginx/src/http/ngx_http_request.c"
    ...
    rc = 
# 1364 "project/nginx/src/http/ngx_http_request.c" 3 4
        -2
# 1364 "project/nginx/src/http/ngx_http_request.c"
                 ;

    for ( ;; ) {

        if (rc == 
# 1368 "project/nginx/src/http/ngx_http_request.c" 3 4
                 -2
# 1368 "project/nginx/src/http/ngx_http_request.c"
                          ) {
            ...
            if (r->header_in->pos == r->header_in->end) {
                ...
                if (rv == 
# 1374 "project/nginx/src/http/ngx_http_request.c" 3 4
                         -1
# 1374 "project/nginx/src/http/ngx_http_request.c"
                                  ) {
                    ngx_http_close_request(r, 
# 1375 "project/nginx/src/http/ngx_http_request.c" 3 4
                                             500
# 1375 "project/nginx/src/http/ngx_http_request.c"
                                                                           );
                    break;
                }

                if (rv == 
# 1379 "project/nginx/src/http/ngx_http_request.c" 3 4
                         -5
# 1379 "project/nginx/src/http/ngx_http_request.c"
                                     ) {
                    ...
                    if (p == 
# 1384 "project/nginx/src/http/ngx_http_request.c" 3 4
                            ((void *)0)
# 1384 "project/nginx/src/http/ngx_http_request.c"
                                ) {
                        
# 1385 "project/nginx/src/http/ngx_http_request.c" 3 4
                       if ((
# 1385 "project/nginx/src/http/ngx_http_request.c"
                       c->log
# 1385 "project/nginx/src/http/ngx_http_request.c" 3 4
                       )->log_level >= 7) ngx_log_error_core(7, 
# 1385 "project/nginx/src/http/ngx_http_request.c"
...
# 1385 "project/nginx/src/http/ngx_http_request.c" 3 4
                       , 
# 1385 "project/nginx/src/http/ngx_http_request.c"
                       0, "client sent too large request"
# 1385 "project/nginx/src/http/ngx_http_request.c" 3 4
                       )
                                                                      
# 1386 "project/nginx/src/http/ngx_http_request.c"
                                                                     ;
                        ngx_http_finalize_request(r,
                                            
# 1388 "project/nginx/src/http/ngx_http_request.c" 3 4
                                           494
# 1388 "project/nginx/src/http/ngx_http_request.c"
                                                                            );
                        break;
                    }
                    ...
                    if (len > 
# 1394 "project/nginx/src/http/ngx_http_request.c" 3 4
                             2048 
# 1394 "project/nginx/src/http/ngx_http_request.c"
                                               - 300) {
                        len = 
# 1395 "project/nginx/src/http/ngx_http_request.c" 3 4
                             2048 
# 1395 "project/nginx/src/http/ngx_http_request.c"
                                               - 300;
                    }

                    
# 1398 "project/nginx/src/http/ngx_http_request.c" 3 4
                   if ((
# 1398 "project/nginx/src/http/ngx_http_request.c"
                   c->log
# 1398 "project/nginx/src/http/ngx_http_request.c" 3 4
                   )->log_level >= 7) ngx_log_error_core(7, 
# 1398 "project/nginx/src/http/ngx_http_request.c"
...
# 1398 "project/nginx/src/http/ngx_http_request.c" 3 4
                   , 
# 1398 "project/nginx/src/http/ngx_http_request.c"
                   0, "client sent too long header line: \"%*s...\"", len, r->header_name_start
# 1398 "project/nginx/src/http/ngx_http_request.c" 3 4
                   )

                                                          
# 1400 "project/nginx/src/http/ngx_http_request.c"
                                                         ;

                    ngx_http_finalize_request(r,
                                            
# 1403 "project/nginx/src/http/ngx_http_request.c" 3 4
                                           494
# 1403 "project/nginx/src/http/ngx_http_request.c"
                                                                            );
                    break;
                }
            }
            ...
            if (n == 
# 1410 "project/nginx/src/http/ngx_http_request.c" 3 4
                    -2 
# 1410 "project/nginx/src/http/ngx_http_request.c"
                              || n == 
# 1410 "project/nginx/src/http/ngx_http_request.c" 3 4
                                      -1
# 1410 "project/nginx/src/http/ngx_http_request.c"
        ...
        cscf = 
# 1416 "project/nginx/src/http/ngx_http_request.c" 3 4
              (
# 1416 "project/nginx/src/http/ngx_http_request.c"
              r
# 1416 "project/nginx/src/http/ngx_http_request.c" 3 4
              )->srv_conf[
# 1416 "project/nginx/src/http/ngx_http_request.c"
...
# 1416 "project/nginx/src/http/ngx_http_request.c"
        ...
        if (rc == 
# 1421 "project/nginx/src/http/ngx_http_request.c" 3 4
                 0
# 1421 "project/nginx/src/http/ngx_http_request.c"
                       ) {
...
# 1429 "project/nginx/src/http/ngx_http_request.c" 3 4
               if ((
# 1429 "project/nginx/src/http/ngx_http_request.c"
               c->log
# 1429 "project/nginx/src/http/ngx_http_request.c" 3 4
               )->log_level >= 7) ngx_log_error_core(7, 
# 1429 "project/nginx/src/http/ngx_http_request.c"
...
# 1429 "project/nginx/src/http/ngx_http_request.c" 3 4
               , 
# 1429 "project/nginx/src/http/ngx_http_request.c"
               0, "client sent invalid header line: \"%*s\"", r->header_end - r->header_name_start, r->header_name_start
# 1429 "project/nginx/src/http/ngx_http_request.c" 3 4
               )


                                                   
# 1432 "project/nginx/src/http/ngx_http_request.c"
                                                  ;
                continue;
            }
            ...
            if (h == 
# 1439 "project/nginx/src/http/ngx_http_request.c" 3 4
                    ((void *)0)
# 1439 "project/nginx/src/http/ngx_http_request.c"
                        ) {
                ngx_http_close_request(r, 
# 1440 "project/nginx/src/http/ngx_http_request.c" 3 4
                                         500
# 1440 "project/nginx/src/http/ngx_http_request.c"
                                                                       );
                break;
            }
            ...
            if (h->lowcase_key == 
# 1455 "project/nginx/src/http/ngx_http_request.c" 3 4
                                 ((void *)0)
# 1455 "project/nginx/src/http/ngx_http_request.c"
                                     ) {
                ngx_http_close_request(r, 
# 1456 "project/nginx/src/http/ngx_http_request.c" 3 4
                                         500
# 1456 "project/nginx/src/http/ngx_http_request.c"
                                                                       );
                break;
            }
...
# 1461 "project/nginx/src/http/ngx_http_request.c" 3 4
               (void) __builtin___memcpy_chk (
# 1461 "project/nginx/src/http/ngx_http_request.c"
               h->lowcase_key
# 1461 "project/nginx/src/http/ngx_http_request.c" 3 4
               , 
# 1461 "project/nginx/src/http/ngx_http_request.c"
...
# 1470 "project/nginx/src/http/ngx_http_request.c" 3 4
                                                      0
# 1470 "project/nginx/src/http/ngx_http_request.c"
                                                            ) {
                break;
            }
        ...
        if (rc == 
# 1481 "project/nginx/src/http/ngx_http_request.c" 3 4
                 1
# 1481 "project/nginx/src/http/ngx_http_request.c"
                                           ) {
            ...
            if (rc != 
# 1494 "project/nginx/src/http/ngx_http_request.c" 3 4
                     0
# 1494 "project/nginx/src/http/ngx_http_request.c"
                           ) {
                break;
            }
        ...
        if (rc == 
# 1503 "project/nginx/src/http/ngx_http_request.c" 3 4
                 -2
# 1503 "project/nginx/src/http/ngx_http_request.c"
                          ) {
...
# 1512 "project/nginx/src/http/ngx_http_request.c" 3 4
       if ((
# 1512 "project/nginx/src/http/ngx_http_request.c"
       c->log
# 1512 "project/nginx/src/http/ngx_http_request.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 1512 "project/nginx/src/http/ngx_http_request.c"
...
# 1512 "project/nginx/src/http/ngx_http_request.c" 3 4
       , 
# 1512 "project/nginx/src/http/ngx_http_request.c"
       0, "client sent invalid header line: \"%*s\\x%02xd...\"", r->header_end - r->header_name_start, r->header_name_start, *r->header_end
# 1512 "project/nginx/src/http/ngx_http_request.c" 3 4
       )


                                                           
# 1515 "project/nginx/src/http/ngx_http_request.c"
                                                          ;

        ngx_http_finalize_request(r, 
# 1517 "project/nginx/src/http/ngx_http_request.c" 3 4
                                    400
# 1517 "project/nginx/src/http/ngx_http_request.c"
                                                        );
        break;
    }
...
ngx_http_read_request_header(ngx_http_request_t *r)
{
    ...
    if (rev->ready) {
        ...
        n = 
# 1546 "project/nginx/src/http/ngx_http_request.c" 3 4
           -2
# 1546 "project/nginx/src/http/ngx_http_request.c"
                    ;
    }

    if (n == 
# 1549 "project/nginx/src/http/ngx_http_request.c" 3 4
            -2
# 1549 "project/nginx/src/http/ngx_http_request.c"
                     ) {
        if (!rev->timer_set) {
            cscf = 
# 1551 "project/nginx/src/http/ngx_http_request.c" 3 4
                  (
# 1551 "project/nginx/src/http/ngx_http_request.c"
                  r
# 1551 "project/nginx/src/http/ngx_http_request.c" 3 4
                  )->srv_conf[
# 1551 "project/nginx/src/http/ngx_http_request.c"
...
# 1552 "project/nginx/src/http/ngx_http_request.c" 3 4
           ngx_event_add_timer
# 1552 "project/nginx/src/http/ngx_http_request.c"
                        (rev, cscf->client_header_timeout);
        }

        if (ngx_handle_read_event(rev, 0) != 
# 1555 "project/nginx/src/http/ngx_http_request.c" 3 4
                                            0
# 1555 "project/nginx/src/http/ngx_http_request.c"
                                                  ) {
            ngx_http_close_request(r, 
# 1556 "project/nginx/src/http/ngx_http_request.c" 3 4
                                     500
# 1556 "project/nginx/src/http/ngx_http_request.c"
                                                                   );
            return 
# 1557 "project/nginx/src/http/ngx_http_request.c" 3 4
                  -1
# 1557 "project/nginx/src/http/ngx_http_request.c"
                           ;
        }

        return 
# 1560 "project/nginx/src/http/ngx_http_request.c" 3 4
              -2
# 1560 "project/nginx/src/http/ngx_http_request.c"
                       ;
    }

    if (n == 0) {
        
# 1564 "project/nginx/src/http/ngx_http_request.c" 3 4
       if ((
# 1564 "project/nginx/src/http/ngx_http_request.c"
       c->log
# 1564 "project/nginx/src/http/ngx_http_request.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 1564 "project/nginx/src/http/ngx_http_request.c"
...
# 1565 "project/nginx/src/http/ngx_http_request.c"
                                                            ;
    }

    if (n == 0 || n == 
# 1568 "project/nginx/src/http/ngx_http_request.c" 3 4
                      -1
# 1568 "project/nginx/src/http/ngx_http_request.c"
                               ) {
        c->error = 1;
        c->log->action = "reading client request headers";

        ngx_http_finalize_request(r, 
# 1572 "project/nginx/src/http/ngx_http_request.c" 3 4
                                    400
# 1572 "project/nginx/src/http/ngx_http_request.c"
                                                        );
        return 
# 1573 "project/nginx/src/http/ngx_http_request.c" 3 4
              -1
# 1573 "project/nginx/src/http/ngx_http_request.c"
                       ;
    }
    ...
    ngx_uint_t request_line)
{
    ...
    if (request_line && r->state == 0) {
        ...
        return 
# 1602 "project/nginx/src/http/ngx_http_request.c" 3 4
              0
# 1602 "project/nginx/src/http/ngx_http_request.c"
                    ;
    }
    ...
    cscf = 
# 1607 "project/nginx/src/http/ngx_http_request.c" 3 4
          (
# 1607 "project/nginx/src/http/ngx_http_request.c"
          r
# 1607 "project/nginx/src/http/ngx_http_request.c" 3 4
          )->srv_conf[
# 1607 "project/nginx/src/http/ngx_http_request.c"
...
# 1607 "project/nginx/src/http/ngx_http_request.c"
    ...
    {
        return 
# 1613 "project/nginx/src/http/ngx_http_request.c" 3 4
              -5
# 1613 "project/nginx/src/http/ngx_http_request.c"
                          ;
    }
    ...
    if (hc->free) {
        ...
        b = ngx_create_temp_buf(r->connection->pool,
                                cscf->large_client_header_buffers.size);
        if (b == 
# 1632 "project/nginx/src/http/ngx_http_request.c" 3 4
                ((void *)0)
# 1632 "project/nginx/src/http/ngx_http_request.c"
                    ) {
            return 
# 1633 "project/nginx/src/http/ngx_http_request.c" 3 4
                  -1
# 1633 "project/nginx/src/http/ngx_http_request.c"
                           ;
        }

        cl = ngx_alloc_chain_link(r->connection->pool);
        if (cl == 
# 1637 "project/nginx/src/http/ngx_http_request.c" 3 4
                 ((void *)0)
# 1637 "project/nginx/src/http/ngx_http_request.c"
                     ) {
            return 
# 1638 "project/nginx/src/http/ngx_http_request.c" 3 4
                  -1
# 1638 "project/nginx/src/http/ngx_http_request.c"
                           ;
        }
        ...
        return 
# 1648 "project/nginx/src/http/ngx_http_request.c" 3 4
              -5
# 1648 "project/nginx/src/http/ngx_http_request.c"
                          ;
    }
    ...
    if (r->state == 0) {
        ...
        return 
# 1664 "project/nginx/src/http/ngx_http_request.c" 3 4
              0
# 1664 "project/nginx/src/http/ngx_http_request.c"
                    ;
    }
...
# 1671 "project/nginx/src/http/ngx_http_request.c" 3 4
       if ((
# 1671 "project/nginx/src/http/ngx_http_request.c"
       r->connection->log
# 1671 "project/nginx/src/http/ngx_http_request.c" 3 4
...
# 1671 "project/nginx/src/http/ngx_http_request.c" 3 4
       , 
# 1671 "project/nginx/src/http/ngx_http_request.c"
       0, "too large header to copy"
# 1671 "project/nginx/src/http/ngx_http_request.c" 3 4
       )
                                                 
# 1672 "project/nginx/src/http/ngx_http_request.c"
                                                ;
        return 
# 1673 "project/nginx/src/http/ngx_http_request.c" 3 4
              -1
# 1673 "project/nginx/src/http/ngx_http_request.c"
                       ;
    }
...
# 1678 "project/nginx/src/http/ngx_http_request.c" 3 4
   (void) __builtin___memcpy_chk (
# 1678 "project/nginx/src/http/ngx_http_request.c"
   new
# 1678 "project/nginx/src/http/ngx_http_request.c" 3 4
   , 
# 1678 "project/nginx/src/http/ngx_http_request.c"
...
# 1678 "project/nginx/src/http/ngx_http_request.c"
    ...
    return 
# 1733 "project/nginx/src/http/ngx_http_request.c" 3 4
          0
# 1733 "project/nginx/src/http/ngx_http_request.c"
                ;
}
    ...
    ngx_uint_t offset)
{
    ...
    if (*ph == 
# 1745 "project/nginx/src/http/ngx_http_request.c" 3 4
              ((void *)0)
# 1745 "project/nginx/src/http/ngx_http_request.c"
                  ) {
        *ph = h;
    }

    return 
# 1749 "project/nginx/src/http/ngx_http_request.c" 3 4
          0
# 1749 "project/nginx/src/http/ngx_http_request.c"
                ;
}
    ...
    ngx_uint_t offset)
{
    ...
    if (*ph == 
# 1761 "project/nginx/src/http/ngx_http_request.c" 3 4
              ((void *)0)
# 1761 "project/nginx/src/http/ngx_http_request.c"
                  ) {
        *ph = h;
        return 
# 1763 "project/nginx/src/http/ngx_http_request.c" 3 4
              0
# 1763 "project/nginx/src/http/ngx_http_request.c"
                    ;
    }

    
# 1766 "project/nginx/src/http/ngx_http_request.c" 3 4
   if ((
# 1766 "project/nginx/src/http/ngx_http_request.c"
   r->connection->log
# 1766 "project/nginx/src/http/ngx_http_request.c" 3 4
   )->log_level >= 7) ngx_log_error_core(7, 
# 1766 "project/nginx/src/http/ngx_http_request.c"
...
# 1766 "project/nginx/src/http/ngx_http_request.c" 3 4
   , 
# 1766 "project/nginx/src/http/ngx_http_request.c"
   0, "client sent duplicate header line: \"%V: %V\", " "previous value: \"%V: %V\"", &h->key, &h->value, &(*ph)->key, &(*ph)->value
# 1766 "project/nginx/src/http/ngx_http_request.c" 3 4
   )


                                                                 
# 1769 "project/nginx/src/http/ngx_http_request.c"
                                                                ;

    ngx_http_finalize_request(r, 
# 1771 "project/nginx/src/http/ngx_http_request.c" 3 4
                                400
# 1771 "project/nginx/src/http/ngx_http_request.c"
                                                    );

    return 
# 1773 "project/nginx/src/http/ngx_http_request.c" 3 4
          -1
# 1773 "project/nginx/src/http/ngx_http_request.c"
                   ;
}
...
# 1785 "project/nginx/src/http/ngx_http_request.c" 3 4
       if ((
# 1785 "project/nginx/src/http/ngx_http_request.c"
       r->connection->log
# 1785 "project/nginx/src/http/ngx_http_request.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 1785 "project/nginx/src/http/ngx_http_request.c"
...
# 1785 "project/nginx/src/http/ngx_http_request.c" 3 4
       , 
# 1785 "project/nginx/src/http/ngx_http_request.c"
       0, "client sent duplicate host header: \"%V: %V\", " "previous value: \"%V: %V\"", &h->key, &h->value, &r->headers_in.host->key, &r->headers_in.host->value
# 1785 "project/nginx/src/http/ngx_http_request.c" 3 4
       )
...
# 1789 "project/nginx/src/http/ngx_http_request.c"
                                                ;
        ngx_http_finalize_request(r, 
# 1790 "project/nginx/src/http/ngx_http_request.c" 3 4
                                    400
# 1790 "project/nginx/src/http/ngx_http_request.c"
                                                        );
        return 
# 1791 "project/nginx/src/http/ngx_http_request.c" 3 4
              -1
# 1791 "project/nginx/src/http/ngx_http_request.c"
                       ;
    }
    ...
    if (rc == 
# 1800 "project/nginx/src/http/ngx_http_request.c" 3 4
             -5
# 1800 "project/nginx/src/http/ngx_http_request.c"
                         ) {
        
# 1801 "project/nginx/src/http/ngx_http_request.c" 3 4
       if ((
# 1801 "project/nginx/src/http/ngx_http_request.c"
       r->connection->log
# 1801 "project/nginx/src/http/ngx_http_request.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 1801 "project/nginx/src/http/ngx_http_request.c"
...
# 1801 "project/nginx/src/http/ngx_http_request.c" 3 4
       , 
# 1801 "project/nginx/src/http/ngx_http_request.c"
       0, "client sent invalid host header"
# 1801 "project/nginx/src/http/ngx_http_request.c" 3 4
       )
                                                        
# 1802 "project/nginx/src/http/ngx_http_request.c"
                                                       ;
        ngx_http_finalize_request(r, 
# 1803 "project/nginx/src/http/ngx_http_request.c" 3 4
                                    400
# 1803 "project/nginx/src/http/ngx_http_request.c"
                                                        );
        return 
# 1804 "project/nginx/src/http/ngx_http_request.c" 3 4
              -1
# 1804 "project/nginx/src/http/ngx_http_request.c"
                       ;
    }

    if (rc == 
# 1807 "project/nginx/src/http/ngx_http_request.c" 3 4
             -1
# 1807 "project/nginx/src/http/ngx_http_request.c"
                      ) {
        ngx_http_close_request(r, 
# 1808 "project/nginx/src/http/ngx_http_request.c" 3 4
                                 500
# 1808 "project/nginx/src/http/ngx_http_request.c"
                                                               );
        return 
# 1809 "project/nginx/src/http/ngx_http_request.c" 3 4
              -1
# 1809 "project/nginx/src/http/ngx_http_request.c"
                       ;
    }

    if (r->headers_in.server.len) {
        return 
# 1813 "project/nginx/src/http/ngx_http_request.c" 3 4
              0
# 1813 "project/nginx/src/http/ngx_http_request.c"
                    ;
    }

    if (ngx_http_set_virtual_server(r, &host) == 
# 1816 "project/nginx/src/http/ngx_http_request.c" 3 4
                                                -1
# 1816 "project/nginx/src/http/ngx_http_request.c"
                                                         ) {
        return 
# 1817 "project/nginx/src/http/ngx_http_request.c" 3 4
              -1
# 1817 "project/nginx/src/http/ngx_http_request.c"
                       ;
    }
    ...
    return 
# 1822 "project/nginx/src/http/ngx_http_request.c" 3 4
          0
# 1822 "project/nginx/src/http/ngx_http_request.c"
                ;
}
...
# 1831 "project/nginx/src/http/ngx_http_request.c" 3 4
                                       1
# 1831 "project/nginx/src/http/ngx_http_request.c"
                                                                ;

    } else if (ngx_strcasestrn(h->value.data, "keep-alive", 10 - 1)) {
        r->headers_in.connection_type = 
# 1834 "project/nginx/src/http/ngx_http_request.c" 3 4
                                       2
# 1834 "project/nginx/src/http/ngx_http_request.c"
                                                                     ;
    }

    return 
# 1837 "project/nginx/src/http/ngx_http_request.c" 3 4
          0
# 1837 "project/nginx/src/http/ngx_http_request.c"
                ;
}
    ...
    ngx_uint_t offset)
{
    ...
    if (r->headers_in.user_agent) {
        return 
# 1848 "project/nginx/src/http/ngx_http_request.c" 3 4
              0
# 1848 "project/nginx/src/http/ngx_http_request.c"
                    ;
    }
    ...
    if (msie && msie + 7 < user_agent + h->value.len) {
        ...
        if (msie[6] == '.') {
            ...
            case '5':
                ...
                break;
            case '6':
                if (ngx_strstrn(msie + 8, "SV1", 3 - 1) == 
# 1871 "project/nginx/src/http/ngx_http_request.c" 3 4
                                                          ((void *)0)
# 1871 "project/nginx/src/http/ngx_http_request.c"
                                                              ) {
                    r->headers_in.msie6 = 1;
                }
                break;
    ...
    return 
# 1910 "project/nginx/src/http/ngx_http_request.c" 3 4
          0
# 1910 "project/nginx/src/http/ngx_http_request.c"
                ;
}
    ...
    ngx_uint_t offset)
{
    ...
    if (headers->elts == 
# 1923 "project/nginx/src/http/ngx_http_request.c" 3 4
                        ((void *)0)
# 1923 "project/nginx/src/http/ngx_http_request.c"
                            ) {
        if (ngx_array_init(headers, r->pool, 1, sizeof(ngx_table_elt_t *))
            != 
# 1925 "project/nginx/src/http/ngx_http_request.c" 3 4
              0
# 1925 "project/nginx/src/http/ngx_http_request.c"
                    )
        {
            ngx_http_close_request(r, 
# 1927 "project/nginx/src/http/ngx_http_request.c" 3 4
                                     500
# 1927 "project/nginx/src/http/ngx_http_request.c"
                                                                   );
            return 
# 1928 "project/nginx/src/http/ngx_http_request.c" 3 4
                  -1
# 1928 "project/nginx/src/http/ngx_http_request.c"
                           ;
        }
    }
    ...
    if (ph == 
# 1933 "project/nginx/src/http/ngx_http_request.c" 3 4
             ((void *)0)
# 1933 "project/nginx/src/http/ngx_http_request.c"
                 ) {
        ngx_http_close_request(r, 
# 1934 "project/nginx/src/http/ngx_http_request.c" 3 4
                                 500
# 1934 "project/nginx/src/http/ngx_http_request.c"
                                                               );
        return 
# 1935 "project/nginx/src/http/ngx_http_request.c" 3 4
              -1
# 1935 "project/nginx/src/http/ngx_http_request.c"
                       ;
    }

    *ph = h;
    return 
# 1939 "project/nginx/src/http/ngx_http_request.c" 3 4
          0
# 1939 "project/nginx/src/http/ngx_http_request.c"
                ;
}
...
ngx_http_process_request_header(ngx_http_request_t *r)
{
    if (r->headers_in.server.len == 0
        && ngx_http_set_virtual_server(r, &r->headers_in.server)
           == 
# 1948 "project/nginx/src/http/ngx_http_request.c" 3 4
             -1
# 1948 "project/nginx/src/http/ngx_http_request.c"
                      )
    {
        return 
# 1950 "project/nginx/src/http/ngx_http_request.c" 3 4
              -1
# 1950 "project/nginx/src/http/ngx_http_request.c"
                       ;
    }

    if (r->headers_in.host == 
# 1953 "project/nginx/src/http/ngx_http_request.c" 3 4
                             ((void *)0) 
# 1953 "project/nginx/src/http/ngx_http_request.c"
                                  && r->http_version > 
# 1953 "project/nginx/src/http/ngx_http_request.c" 3 4
                                                       1000
# 1953 "project/nginx/src/http/ngx_http_request.c"
...
# 1954 "project/nginx/src/http/ngx_http_request.c" 3 4
       if ((
# 1954 "project/nginx/src/http/ngx_http_request.c"
       r->connection->log
# 1954 "project/nginx/src/http/ngx_http_request.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 1954 "project/nginx/src/http/ngx_http_request.c"
...
# 1954 "project/nginx/src/http/ngx_http_request.c" 3 4
       , 
# 1954 "project/nginx/src/http/ngx_http_request.c"
       0, "client sent HTTP/1.1 request without \"Host\" header"
# 1954 "project/nginx/src/http/ngx_http_request.c" 3 4
       )
                                                                          
# 1955 "project/nginx/src/http/ngx_http_request.c"
                                                                         ;
        ngx_http_finalize_request(r, 
# 1956 "project/nginx/src/http/ngx_http_request.c" 3 4
                                    400
# 1956 "project/nginx/src/http/ngx_http_request.c"
                                                        );
        return 
# 1957 "project/nginx/src/http/ngx_http_request.c" 3 4
              -1
# 1957 "project/nginx/src/http/ngx_http_request.c"
                       ;
    }
...
# 1965 "project/nginx/src/http/ngx_http_request.c" 3 4
                                             -1
# 1965 "project/nginx/src/http/ngx_http_request.c"
                                                      ) {
            
# 1966 "project/nginx/src/http/ngx_http_request.c" 3 4
           if ((
# 1966 "project/nginx/src/http/ngx_http_request.c"
           r->connection->log
# 1966 "project/nginx/src/http/ngx_http_request.c" 3 4
           )->log_level >= 7) ngx_log_error_core(7, 
# 1966 "project/nginx/src/http/ngx_http_request.c"
...
# 1966 "project/nginx/src/http/ngx_http_request.c" 3 4
           , 
# 1966 "project/nginx/src/http/ngx_http_request.c"
           0, "client sent invalid \"Content-Length\" header"
# 1966 "project/nginx/src/http/ngx_http_request.c" 3 4
           )
                                                                          
# 1967 "project/nginx/src/http/ngx_http_request.c"
                                                                         ;
            ngx_http_finalize_request(r, 
# 1968 "project/nginx/src/http/ngx_http_request.c" 3 4
                                        400
# 1968 "project/nginx/src/http/ngx_http_request.c"
                                                            );
            return 
# 1969 "project/nginx/src/http/ngx_http_request.c" 3 4
                  -1
# 1969 "project/nginx/src/http/ngx_http_request.c"
                           ;
        }
    }
    ...
    if (r->headers_in.transfer_encoding) {
        if (r->http_version < 
# 1974 "project/nginx/src/http/ngx_http_request.c" 3 4
                             1001
# 1974 "project/nginx/src/http/ngx_http_request.c"
                                                ) {
            
# 1975 "project/nginx/src/http/ngx_http_request.c" 3 4
           if ((
# 1975 "project/nginx/src/http/ngx_http_request.c"
           r->connection->log
# 1975 "project/nginx/src/http/ngx_http_request.c" 3 4
           )->log_level >= 7) ngx_log_error_core(7, 
# 1975 "project/nginx/src/http/ngx_http_request.c"
...
# 1975 "project/nginx/src/http/ngx_http_request.c" 3 4
           , 
# 1975 "project/nginx/src/http/ngx_http_request.c"
           0, "client sent HTTP/1.0 request with " "\"Transfer-Encoding\" header"
# 1975 "project/nginx/src/http/ngx_http_request.c" 3 4
           )

                                                         
# 1977 "project/nginx/src/http/ngx_http_request.c"
                                                        ;
            ngx_http_finalize_request(r, 
# 1978 "project/nginx/src/http/ngx_http_request.c" 3 4
                                        400
# 1978 "project/nginx/src/http/ngx_http_request.c"
                                                            );
            return 
# 1979 "project/nginx/src/http/ngx_http_request.c" 3 4
                  -1
# 1979 "project/nginx/src/http/ngx_http_request.c"
                           ;
        }
...
# 1987 "project/nginx/src/http/ngx_http_request.c" 3 4
               if ((
# 1987 "project/nginx/src/http/ngx_http_request.c"
               r->connection->log
# 1987 "project/nginx/src/http/ngx_http_request.c" 3 4
               )->log_level >= 7) ngx_log_error_core(7, 
# 1987 "project/nginx/src/http/ngx_http_request.c"
...
# 1987 "project/nginx/src/http/ngx_http_request.c" 3 4
               , 
# 1987 "project/nginx/src/http/ngx_http_request.c"
               0, "client sent \"Content-Length\" and " "\"Transfer-Encoding\" headers " "at the same time"
# 1987 "project/nginx/src/http/ngx_http_request.c" 3 4
               )


                                                 
# 1990 "project/nginx/src/http/ngx_http_request.c"
                                                ;
                ngx_http_finalize_request(r, 
# 1991 "project/nginx/src/http/ngx_http_request.c" 3 4
                                            400
# 1991 "project/nginx/src/http/ngx_http_request.c"
                                                                );
                return 
# 1992 "project/nginx/src/http/ngx_http_request.c" 3 4
                      -1
# 1992 "project/nginx/src/http/ngx_http_request.c"
                               ;
            }
...
# 1998 "project/nginx/src/http/ngx_http_request.c" 3 4
           if ((
# 1998 "project/nginx/src/http/ngx_http_request.c"
           r->connection->log
# 1998 "project/nginx/src/http/ngx_http_request.c" 3 4
           )->log_level >= 7) ngx_log_error_core(7, 
# 1998 "project/nginx/src/http/ngx_http_request.c"
...
# 1998 "project/nginx/src/http/ngx_http_request.c" 3 4
           , 
# 1998 "project/nginx/src/http/ngx_http_request.c"
           0, "client sent unknown \"Transfer-Encoding\": \"%V\"", &r->headers_in.transfer_encoding->value
# 1998 "project/nginx/src/http/ngx_http_request.c" 3 4
           )

                                                                  
# 2000 "project/nginx/src/http/ngx_http_request.c"
                                                                 ;
            ngx_http_finalize_request(r, 
# 2001 "project/nginx/src/http/ngx_http_request.c" 3 4
                                        501
# 2001 "project/nginx/src/http/ngx_http_request.c"
                                                                );
            return 
# 2002 "project/nginx/src/http/ngx_http_request.c" 3 4
                  -1
# 2002 "project/nginx/src/http/ngx_http_request.c"
                           ;
        }
    }

    if (r->headers_in.connection_type == 
# 2006 "project/nginx/src/http/ngx_http_request.c" 3 4
                                        2
# 2006 "project/nginx/src/http/ngx_http_request.c"
                                                                      ) {
    ...
    if (r->method == 
# 2014 "project/nginx/src/http/ngx_http_request.c" 3 4
                    0x00010000
# 2014 "project/nginx/src/http/ngx_http_request.c"
                                    ) {
        
# 2015 "project/nginx/src/http/ngx_http_request.c" 3 4
       if ((
# 2015 "project/nginx/src/http/ngx_http_request.c"
       r->connection->log
# 2015 "project/nginx/src/http/ngx_http_request.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 2015 "project/nginx/src/http/ngx_http_request.c"
...
# 2015 "project/nginx/src/http/ngx_http_request.c" 3 4
       , 
# 2015 "project/nginx/src/http/ngx_http_request.c"
       0, "client sent CONNECT method"
# 2015 "project/nginx/src/http/ngx_http_request.c" 3 4
       )
                                                   
# 2016 "project/nginx/src/http/ngx_http_request.c"
                                                  ;
        ngx_http_finalize_request(r, 
# 2017 "project/nginx/src/http/ngx_http_request.c" 3 4
                                    405
# 2017 "project/nginx/src/http/ngx_http_request.c"
                                                        );
        return 
# 2018 "project/nginx/src/http/ngx_http_request.c" 3 4
              -1
# 2018 "project/nginx/src/http/ngx_http_request.c"
                       ;
    }

    if (r->method == 
# 2021 "project/nginx/src/http/ngx_http_request.c" 3 4
                    0x00008000
# 2021 "project/nginx/src/http/ngx_http_request.c"
                                  ) {
        
# 2022 "project/nginx/src/http/ngx_http_request.c" 3 4
       if ((
# 2022 "project/nginx/src/http/ngx_http_request.c"
       r->connection->log
# 2022 "project/nginx/src/http/ngx_http_request.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 2022 "project/nginx/src/http/ngx_http_request.c"
...
# 2022 "project/nginx/src/http/ngx_http_request.c" 3 4
       , 
# 2022 "project/nginx/src/http/ngx_http_request.c"
       0, "client sent TRACE method"
# 2022 "project/nginx/src/http/ngx_http_request.c" 3 4
       )
                                                 
# 2023 "project/nginx/src/http/ngx_http_request.c"
                                                ;
        ngx_http_finalize_request(r, 
# 2024 "project/nginx/src/http/ngx_http_request.c" 3 4
                                    405
# 2024 "project/nginx/src/http/ngx_http_request.c"
                                                        );
        return 
# 2025 "project/nginx/src/http/ngx_http_request.c" 3 4
              -1
# 2025 "project/nginx/src/http/ngx_http_request.c"
                       ;
    }

    return 
# 2028 "project/nginx/src/http/ngx_http_request.c" 3 4
          0
# 2028 "project/nginx/src/http/ngx_http_request.c"
                ;
}
...
ngx_http_process_request(ngx_http_request_t *r)
{
    ...
    c = r->connection;
# 2105 "project/nginx/src/http/ngx_http_request.c"
    if (c->read->timer_set) {
        
# 2106 "project/nginx/src/http/ngx_http_request.c" 3 4
       ngx_event_del_timer
# 2106 "project/nginx/src/http/ngx_http_request.c"
                    (c->read);
    }
# 2116 "project/nginx/src/http/ngx_http_request.c"
...
ngx_http_validate_host(ngx_str_t *host, ngx_pool_t *pool, ngx_uint_t alloc)
{
    ...
    for (i = 0; i < host->len; i++) {
        ...
        case '.':
            if (dot_pos == i - 1) {
                return 
# 2150 "project/nginx/src/http/ngx_http_request.c" 3 4
                      -5
# 2150 "project/nginx/src/http/ngx_http_request.c"
                                  ;
            }
            dot_pos = i;
            break;
        ...
        default:
            ...
            if (
# 2177 "project/nginx/src/http/ngx_http_request.c" 3 4
               ((
# 2177 "project/nginx/src/http/ngx_http_request.c"
               ch
# 2177 "project/nginx/src/http/ngx_http_request.c" 3 4
               ) == '/')
# 2177 "project/nginx/src/http/ngx_http_request.c"
                ...
                return 
# 2178 "project/nginx/src/http/ngx_http_request.c" 3 4
                      -5
# 2178 "project/nginx/src/http/ngx_http_request.c"
                                  ;
            }

            if (ch <= 0x20 || ch == 0x7f) {
                return 
# 2182 "project/nginx/src/http/ngx_http_request.c" 3 4
                      -5
# 2182 "project/nginx/src/http/ngx_http_request.c"
                                  ;
            }
    ...
    if (host_len == 0) {
        return 
# 2198 "project/nginx/src/http/ngx_http_request.c" 3 4
              -5
# 2198 "project/nginx/src/http/ngx_http_request.c"
                          ;
    }
    ...
    if (alloc) {
        ...
        if (host->data == 
# 2203 "project/nginx/src/http/ngx_http_request.c" 3 4
                         ((void *)0)
# 2203 "project/nginx/src/http/ngx_http_request.c"
                             ) {
            return 
# 2204 "project/nginx/src/http/ngx_http_request.c" 3 4
                  -1
# 2204 "project/nginx/src/http/ngx_http_request.c"
                           ;
        }
    ...
    return 
# 2212 "project/nginx/src/http/ngx_http_request.c" 3 4
          0
# 2212 "project/nginx/src/http/ngx_http_request.c"
                ;
}
...
ngx_http_set_virtual_server(ngx_http_request_t *r, ngx_str_t *host)
{
    ...
    cscf = 
# 2225 "project/nginx/src/http/ngx_http_request.c" 3 4
          ((void *)0)
# 2225 "project/nginx/src/http/ngx_http_request.c"
              ;


    hc = r->http_connection;
# 2252 "project/nginx/src/http/ngx_http_request.c"
    rc = ngx_http_find_virtual_server(r->connection,
                                      hc->addr_conf->virtual_names,
                                      host, r, &cscf);

    if (rc == 
# 2256 "project/nginx/src/http/ngx_http_request.c" 3 4
             -1
# 2256 "project/nginx/src/http/ngx_http_request.c"
                      ) {
        ngx_http_close_request(r, 
# 2257 "project/nginx/src/http/ngx_http_request.c" 3 4
                                 500
# 2257 "project/nginx/src/http/ngx_http_request.c"
                                                               );
        return 
# 2258 "project/nginx/src/http/ngx_http_request.c" 3 4
              -1
# 2258 "project/nginx/src/http/ngx_http_request.c"
                       ;
    }
# 2284 "project/nginx/src/http/ngx_http_request.c"
    if (rc == 
# 2284 "project/nginx/src/http/ngx_http_request.c" 3 4
             -5
# 2284 "project/nginx/src/http/ngx_http_request.c"
                         ) {
        return 
# 2285 "project/nginx/src/http/ngx_http_request.c" 3 4
              0
# 2285 "project/nginx/src/http/ngx_http_request.c"
                    ;
    }
    ...
    clcf = 
# 2291 "project/nginx/src/http/ngx_http_request.c" 3 4
          (
# 2291 "project/nginx/src/http/ngx_http_request.c"
          r
# 2291 "project/nginx/src/http/ngx_http_request.c" 3 4
          )->loc_conf[
# 2291 "project/nginx/src/http/ngx_http_request.c"
...
# 2291 "project/nginx/src/http/ngx_http_request.c"
    ...
    r->connection
# 2293 "project/nginx/src/http/ngx_http_request.c" 3 4
   ->log->file = 
# 2293 "project/nginx/src/http/ngx_http_request.c"
   clcf->error_log
# 2293 "project/nginx/src/http/ngx_http_request.c" 3 4
   ->file; 
# 2293 "project/nginx/src/http/ngx_http_request.c"
...
# 2293 "project/nginx/src/http/ngx_http_request.c"
    ...
    return 
# 2295 "project/nginx/src/http/ngx_http_request.c" 3 4
          0
# 2295 "project/nginx/src/http/ngx_http_request.c"
                ;
}
    ...
    ngx_http_request_t *r, ngx_http_core_srv_conf_t **cscfp)
{
    ...
    if (virtual_names == 
# 2306 "project/nginx/src/http/ngx_http_request.c" 3 4
                        ((void *)0)
# 2306 "project/nginx/src/http/ngx_http_request.c"
                            ) {
        return 
# 2307 "project/nginx/src/http/ngx_http_request.c" 3 4
              -5
# 2307 "project/nginx/src/http/ngx_http_request.c"
                          ;
    }
    ...
    if (cscf) {
        *cscfp = cscf;
        return 
# 2316 "project/nginx/src/http/ngx_http_request.c" 3 4
              0
# 2316 "project/nginx/src/http/ngx_http_request.c"
                    ;
    }
...
# 2362 "project/nginx/src/http/ngx_http_request.c"
        for (i = 0; i < virtual_names->nregex; i++) {

            n = ngx_http_regex_exec(r, sn[i].regex, host);

            if (n == 
# 2366 "project/nginx/src/http/ngx_http_request.c" 3 4
                    -5
# 2366 "project/nginx/src/http/ngx_http_request.c"
                                ) {
                continue;
            }

            if (n == 
# 2370 "project/nginx/src/http/ngx_http_request.c" 3 4
                    0
# 2370 "project/nginx/src/http/ngx_http_request.c"
                          ) {
                *cscfp = sn[i].server;
                return 
# 2372 "project/nginx/src/http/ngx_http_request.c" 3 4
                      0
# 2372 "project/nginx/src/http/ngx_http_request.c"
                            ;
            }

            return 
# 2375 "project/nginx/src/http/ngx_http_request.c" 3 4
                  -1
# 2375 "project/nginx/src/http/ngx_http_request.c"
                           ;
        }
    }
    ...
    return 
# 2381 "project/nginx/src/http/ngx_http_request.c" 3 4
          -5
# 2381 "project/nginx/src/http/ngx_http_request.c"
                      ;
}
...
# 2394 "project/nginx/src/http/ngx_http_request.c" 3 4
   ((ngx_http_log_ctx_t *) 
# 2394 "project/nginx/src/http/ngx_http_request.c"
   c->log
# 2394 "project/nginx/src/http/ngx_http_request.c" 3 4
...
ngx_http_run_posted_requests(ngx_connection_t *c)
{
    ...
    for ( ;; ) {
        ...
        if (pr == 
# 2437 "project/nginx/src/http/ngx_http_request.c" 3 4
                 ((void *)0)
# 2437 "project/nginx/src/http/ngx_http_request.c"
                     ) {
            return;
        }
...
# 2445 "project/nginx/src/http/ngx_http_request.c" 3 4
       ((ngx_http_log_ctx_t *) 
# 2445 "project/nginx/src/http/ngx_http_request.c"
       c->log
# 2445 "project/nginx/src/http/ngx_http_request.c" 3 4
       ->data)->current_request = 
# 2445 "project/nginx/src/http/ngx_http_request.c"
...
ngx_http_post_request(ngx_http_request_t *r, ngx_http_posted_request_t *pr)
{
    ...
    if (pr == 
# 2460 "project/nginx/src/http/ngx_http_request.c" 3 4
             ((void *)0)
# 2460 "project/nginx/src/http/ngx_http_request.c"
                 ) {
        pr = ngx_palloc(r->pool, sizeof(ngx_http_posted_request_t));
        if (pr == 
# 2462 "project/nginx/src/http/ngx_http_request.c" 3 4
                 ((void *)0)
# 2462 "project/nginx/src/http/ngx_http_request.c"
                     ) {
            return 
# 2463 "project/nginx/src/http/ngx_http_request.c" 3 4
                  -1
# 2463 "project/nginx/src/http/ngx_http_request.c"
                           ;
        }
    }
    ...
    pr->request = r;
    pr->next = 
# 2468 "project/nginx/src/http/ngx_http_request.c" 3 4
              ((void *)0)
# 2468 "project/nginx/src/http/ngx_http_request.c"
                  ;
    ...
    *p = pr;
    ...
    return 
# 2474 "project/nginx/src/http/ngx_http_request.c" 3 4
          0
# 2474 "project/nginx/src/http/ngx_http_request.c"
                ;
}
...
ngx_http_finalize_request(ngx_http_request_t *r, ngx_int_t rc)
{
    ...
    if (rc == 
# 2491 "project/nginx/src/http/ngx_http_request.c" 3 4
             -4
# 2491 "project/nginx/src/http/ngx_http_request.c"
                     ) {
    ...
    if (rc == 
# 2496 "project/nginx/src/http/ngx_http_request.c" 3 4
             0 
# 2496 "project/nginx/src/http/ngx_http_request.c"
                    && r->filter_finalize) {
        c->error = 1;
    }

    if (rc == 
# 2500 "project/nginx/src/http/ngx_http_request.c" 3 4
             -5
# 2500 "project/nginx/src/http/ngx_http_request.c"
                         ) {
        r->content_handler = 
# 2501 "project/nginx/src/http/ngx_http_request.c" 3 4
                            ((void *)0)
# 2501 "project/nginx/src/http/ngx_http_request.c"
                                ;
    ...
    if (rc == 
# 2511 "project/nginx/src/http/ngx_http_request.c" 3 4
             -1
        
# 2512 "project/nginx/src/http/ngx_http_request.c"
       || rc == 
# 2512 "project/nginx/src/http/ngx_http_request.c" 3 4
                408
        
# 2513 "project/nginx/src/http/ngx_http_request.c"
       || rc == 
# 2513 "project/nginx/src/http/ngx_http_request.c" 3 4
                499
        
# 2514 "project/nginx/src/http/ngx_http_request.c"
       || c->error)
    {
        if (ngx_http_post_action(r) == 
# 2516 "project/nginx/src/http/ngx_http_request.c" 3 4
                                      0
# 2516 "project/nginx/src/http/ngx_http_request.c"
                                            ) {
            return;
        }
    ...
    if (rc >= 
# 2524 "project/nginx/src/http/ngx_http_request.c" 3 4
             300
        
# 2525 "project/nginx/src/http/ngx_http_request.c"
       || rc == 
# 2525 "project/nginx/src/http/ngx_http_request.c" 3 4
                201
        
# 2526 "project/nginx/src/http/ngx_http_request.c"
       || rc == 
# 2526 "project/nginx/src/http/ngx_http_request.c" 3 4
                204
# 2526 "project/nginx/src/http/ngx_http_request.c"
                                   )
    {
        if (rc == 
# 2528 "project/nginx/src/http/ngx_http_request.c" 3 4
                 444
# 2528 "project/nginx/src/http/ngx_http_request.c"
                               ) {
            c->timedout = 1;
            ngx_http_terminate_request(r, rc);
            return;
...
# 2536 "project/nginx/src/http/ngx_http_request.c" 3 4
               ngx_event_del_timer
# 2536 "project/nginx/src/http/ngx_http_request.c"
                            (c->read);
            }

            if (c->write->timer_set) {
                
# 2540 "project/nginx/src/http/ngx_http_request.c" 3 4
               ngx_event_del_timer
# 2540 "project/nginx/src/http/ngx_http_request.c"
                            (c->write);
            }
        }
    ...
    if (r != r->main) {
        ...
        if (r->buffered || r->postponed) {
            ...
            if (ngx_http_set_write_handler(r) != 
# 2555 "project/nginx/src/http/ngx_http_request.c" 3 4
                                                0
# 2555 "project/nginx/src/http/ngx_http_request.c"
                                                      ) {
                ngx_http_terminate_request(r, 0);
            }
        ...
        if (r == c->data || r->background) {
            ...
            if (!r->logged) {
                ...
                clcf = 
# 2568 "project/nginx/src/http/ngx_http_request.c" 3 4
                      (
# 2568 "project/nginx/src/http/ngx_http_request.c"
                      r
# 2568 "project/nginx/src/http/ngx_http_request.c" 3 4
                      )->loc_conf[
# 2568 "project/nginx/src/http/ngx_http_request.c"
...
# 2577 "project/nginx/src/http/ngx_http_request.c" 3 4
               if ((
# 2577 "project/nginx/src/http/ngx_http_request.c"
               c->log
# 2577 "project/nginx/src/http/ngx_http_request.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 2577 "project/nginx/src/http/ngx_http_request.c"
...
# 2577 "project/nginx/src/http/ngx_http_request.c" 3 4
               , 
# 2577 "project/nginx/src/http/ngx_http_request.c"
               0, "subrequest: \"%V?%V\" logged again", &r->uri, &r->args
# 2577 "project/nginx/src/http/ngx_http_request.c" 3 4
               )

                                                
# 2579 "project/nginx/src/http/ngx_http_request.c"
                                               ;
            }
        ...
        if (ngx_http_post_request(pr, 
# 2610 "project/nginx/src/http/ngx_http_request.c" 3 4
                                     ((void *)0)
# 2610 "project/nginx/src/http/ngx_http_request.c"
                                         ) != 
# 2610 "project/nginx/src/http/ngx_http_request.c" 3 4
                                              0
# 2610 "project/nginx/src/http/ngx_http_request.c"
    ...
    if (r->buffered || c->buffered || r->postponed) {
        ...
        if (ngx_http_set_write_handler(r) != 
# 2625 "project/nginx/src/http/ngx_http_request.c" 3 4
                                            0
# 2625 "project/nginx/src/http/ngx_http_request.c"
                                                  ) {
            ngx_http_terminate_request(r, 0);
        }
...
# 2633 "project/nginx/src/http/ngx_http_request.c" 3 4
       if ((
# 2633 "project/nginx/src/http/ngx_http_request.c"
       c->log
# 2633 "project/nginx/src/http/ngx_http_request.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 2633 "project/nginx/src/http/ngx_http_request.c"
...
# 2633 "project/nginx/src/http/ngx_http_request.c" 3 4
       , 
# 2633 "project/nginx/src/http/ngx_http_request.c"
       0, "http finalize non-active request: \"%V?%V\"", &r->uri, &r->args
# 2633 "project/nginx/src/http/ngx_http_request.c" 3 4
       )

                                        
# 2635 "project/nginx/src/http/ngx_http_request.c"
                                       ;
        return;
    }
    ...
    if (ngx_http_post_action(r) == 
# 2648 "project/nginx/src/http/ngx_http_request.c" 3 4
                                  0
# 2648 "project/nginx/src/http/ngx_http_request.c"
                                        ) {
        return;
    }
...
# 2653 "project/nginx/src/http/ngx_http_request.c" 3 4
       ngx_event_del_timer
# 2653 "project/nginx/src/http/ngx_http_request.c"
                    (c->read);
    }
...
# 2658 "project/nginx/src/http/ngx_http_request.c" 3 4
       ngx_event_del_timer
# 2658 "project/nginx/src/http/ngx_http_request.c"
                    (c->write);
    }
...
ngx_http_terminate_request(ngx_http_request_t *r, ngx_int_t rc)
{
    ...
    cln = mr->cleanup;
    mr->cleanup = 
# 2682 "project/nginx/src/http/ngx_http_request.c" 3 4
                 ((void *)0)
# 2682 "project/nginx/src/http/ngx_http_request.c"
                     ;
    ...
    if (mr->write_event_handler) {
        ...
        e = 
# 2704 "project/nginx/src/http/ngx_http_request.c" 3 4
           (void *) (&
# 2704 "project/nginx/src/http/ngx_http_request.c"
           mr
# 2704 "project/nginx/src/http/ngx_http_request.c" 3 4
           ->uri_start)
# 2704 "project/nginx/src/http/ngx_http_request.c"
                                 ;
        mr->posted_requests = 
# 2705 "project/nginx/src/http/ngx_http_request.c" 3 4
                             ((void *)0)
# 2705 "project/nginx/src/http/ngx_http_request.c"
                                 ;
...
{
    ngx_http_core_loc_conf_t *clcf;
# 2739 "project/nginx/src/http/ngx_http_request.c"
    clcf = 
# 2739 "project/nginx/src/http/ngx_http_request.c" 3 4
          (
# 2739 "project/nginx/src/http/ngx_http_request.c"
          r
# 2739 "project/nginx/src/http/ngx_http_request.c" 3 4
...
# 2745 "project/nginx/src/http/ngx_http_request.c" 3 4
           ngx_event_add_timer
# 2745 "project/nginx/src/http/ngx_http_request.c"
                        (r->connection->read, clcf->lingering_timeout);

            if (r->lingering_time == 0) {
                r->lingering_time = 
# 2748 "project/nginx/src/http/ngx_http_request.c" 3 4
                                   ngx_cached_time->sec
                                      
# 2749 "project/nginx/src/http/ngx_http_request.c"
...
# 2778 "project/nginx/src/http/ngx_http_request.c" 3 4
                                2
        
# 2779 "project/nginx/src/http/ngx_http_request.c"
       || (clcf->lingering_close == 
# 2779 "project/nginx/src/http/ngx_http_request.c" 3 4
                                    1
            
# 2780 "project/nginx/src/http/ngx_http_request.c"
           && (r->lingering_close
...
ngx_http_set_write_handler(ngx_http_request_t *r)
{
    ...
    if (wev->ready && wev->delayed) {
        return 
# 2808 "project/nginx/src/http/ngx_http_request.c" 3 4
              0
# 2808 "project/nginx/src/http/ngx_http_request.c"
                    ;
    }

    clcf = 
# 2811 "project/nginx/src/http/ngx_http_request.c" 3 4
          (
# 2811 "project/nginx/src/http/ngx_http_request.c"
          r
# 2811 "project/nginx/src/http/ngx_http_request.c" 3 4
          )->loc_conf[
# 2811 "project/nginx/src/http/ngx_http_request.c"
...
# 2813 "project/nginx/src/http/ngx_http_request.c" 3 4
       ngx_event_add_timer
# 2813 "project/nginx/src/http/ngx_http_request.c"
                    (wev, clcf->send_timeout);
    }

    if (ngx_handle_write_event(wev, clcf->send_lowat) != 
# 2816 "project/nginx/src/http/ngx_http_request.c" 3 4
                                                        0
# 2816 "project/nginx/src/http/ngx_http_request.c"
                                                              ) {
        ngx_http_close_request(r, 0);
        return 
# 2818 "project/nginx/src/http/ngx_http_request.c" 3 4
              -1
# 2818 "project/nginx/src/http/ngx_http_request.c"
                       ;
    }

    return 
# 2821 "project/nginx/src/http/ngx_http_request.c" 3 4
          0
# 2821 "project/nginx/src/http/ngx_http_request.c"
                ;
}
...
ngx_http_writer(ngx_http_request_t *r)
{
    ...
    clcf = 
# 2839 "project/nginx/src/http/ngx_http_request.c" 3 4
          (
# 2839 "project/nginx/src/http/ngx_http_request.c"
          r->main
# 2839 "project/nginx/src/http/ngx_http_request.c" 3 4
          )->loc_conf[
# 2839 "project/nginx/src/http/ngx_http_request.c"
...
# 2842 "project/nginx/src/http/ngx_http_request.c" 3 4
       if ((
# 2842 "project/nginx/src/http/ngx_http_request.c"
       c->log
# 2842 "project/nginx/src/http/ngx_http_request.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 2842 "project/nginx/src/http/ngx_http_request.c"
...
# 2843 "project/nginx/src/http/ngx_http_request.c"
                                        ;
        c->timedout = 1;

        ngx_http_finalize_request(r, 
# 2846 "project/nginx/src/http/ngx_http_request.c" 3 4
                                    408
# 2846 "project/nginx/src/http/ngx_http_request.c"
                                                             );
        return;
    }
...
# 2855 "project/nginx/src/http/ngx_http_request.c" 3 4
           ngx_event_add_timer
# 2855 "project/nginx/src/http/ngx_http_request.c"
                        (wev, clcf->send_timeout);
        }

        if (ngx_handle_write_event(wev, clcf->send_lowat) != 
# 2858 "project/nginx/src/http/ngx_http_request.c" 3 4
                                                            0
# 2858 "project/nginx/src/http/ngx_http_request.c"
                                                                  ) {
            ngx_http_close_request(r, 0);
        }
    ...
    rc = ngx_http_output_filter(r, 
# 2865 "project/nginx/src/http/ngx_http_request.c" 3 4
                                  ((void *)0)
# 2865 "project/nginx/src/http/ngx_http_request.c"
                                      );
    ...
    if (rc == 
# 2871 "project/nginx/src/http/ngx_http_request.c" 3 4
             -1
# 2871 "project/nginx/src/http/ngx_http_request.c"
                      ) {
...
# 2879 "project/nginx/src/http/ngx_http_request.c" 3 4
           ngx_event_add_timer
# 2879 "project/nginx/src/http/ngx_http_request.c"
                        (wev, clcf->send_timeout);
        }

        if (ngx_handle_write_event(wev, clcf->send_lowat) != 
# 2882 "project/nginx/src/http/ngx_http_request.c" 3 4
                                                            0
# 2882 "project/nginx/src/http/ngx_http_request.c"
                                                                  ) {
            ngx_http_close_request(r, 0);
        }
...
ngx_http_block_reading(ngx_http_request_t *r)
{
    ...
    if ((ngx_event_flags & 
# 2916 "project/nginx/src/http/ngx_http_request.c" 3 4
                          0x00000001
# 2916 "project/nginx/src/http/ngx_http_request.c"
                                             )
        && r->connection->read->active)
    {
        if (
# 2919 "project/nginx/src/http/ngx_http_request.c" 3 4
           ngx_event_actions.del
# 2919 "project/nginx/src/http/ngx_http_request.c"
                        (r->connection->read, 
# 2919 "project/nginx/src/http/ngx_http_request.c" 3 4
                                              (-1)
# 2919 "project/nginx/src/http/ngx_http_request.c"
...
ngx_http_test_reading(ngx_http_request_t *r)
{
    ...
    ;
# 2955 "project/nginx/src/http/ngx_http_request.c"
    if (ngx_event_flags & 
# 2955 "project/nginx/src/http/ngx_http_request.c" 3 4
                         0x00000008
# 2955 "project/nginx/src/http/ngx_http_request.c"
                                             ) {
...
# 3001 "project/nginx/src/http/ngx_http_request.c"
    n = recv(c->fd, buf, 1, 
# 3001 "project/nginx/src/http/ngx_http_request.c" 3 4
                           0x2
# 3001 "project/nginx/src/http/ngx_http_request.c"
                                   );
    ...
    if (n == 0) {
        ...
        err = 
# 3011 "project/nginx/src/http/ngx_http_request.c" 3 4
             (*__error())
# 3011 "project/nginx/src/http/ngx_http_request.c"
                             ;

        if (err != 
# 3013 "project/nginx/src/http/ngx_http_request.c" 3 4
                  35
# 3013 "project/nginx/src/http/ngx_http_request.c"
                            ) {
            rev->eof = 1;
            c->error = 1;
    ...
    if ((ngx_event_flags & 
# 3023 "project/nginx/src/http/ngx_http_request.c" 3 4
                          0x00000001
# 3023 "project/nginx/src/http/ngx_http_request.c"
                                             ) && rev->active) {

        if (
# 3025 "project/nginx/src/http/ngx_http_request.c" 3 4
           ngx_event_actions.del
# 3025 "project/nginx/src/http/ngx_http_request.c"
                        (rev, 
# 3025 "project/nginx/src/http/ngx_http_request.c" 3 4
                              (-1)
# 3025 "project/nginx/src/http/ngx_http_request.c"
...
# 3044 "project/nginx/src/http/ngx_http_request.c" 3 4
   if ((
# 3044 "project/nginx/src/http/ngx_http_request.c"
   c->log
# 3044 "project/nginx/src/http/ngx_http_request.c" 3 4
   )->log_level >= 7) ngx_log_error_core(7, 
# 3044 "project/nginx/src/http/ngx_http_request.c"
...
# 3045 "project/nginx/src/http/ngx_http_request.c"
                                                        ;

    ngx_http_finalize_request(r, 
# 3047 "project/nginx/src/http/ngx_http_request.c" 3 4
                                499
# 3047 "project/nginx/src/http/ngx_http_request.c"
                                                              );
}
...
ngx_http_set_keepalive(ngx_http_request_t *r)
{
    ...
    clcf = 
# 3065 "project/nginx/src/http/ngx_http_request.c" 3 4
          (
# 3065 "project/nginx/src/http/ngx_http_request.c"
          r
# 3065 "project/nginx/src/http/ngx_http_request.c" 3 4
          )->loc_conf[
# 3065 "project/nginx/src/http/ngx_http_request.c"
...
# 3065 "project/nginx/src/http/ngx_http_request.c"
    ...
    if (b->pos < b->last) {
        ...
        if (b != c->buffer) {
# 3088 "project/nginx/src/http/ngx_http_request.c"
            for (cl = hc->busy; cl; ) {
                ln = cl;
                cl = cl->next;
...
# 3093 "project/nginx/src/http/ngx_http_request.c" 3 4
                   (
# 3093 "project/nginx/src/http/ngx_http_request.c"
                   ln
# 3093 "project/nginx/src/http/ngx_http_request.c" 3 4
                   )->next = (
# 3093 "project/nginx/src/http/ngx_http_request.c"
...
# 3093 "project/nginx/src/http/ngx_http_request.c"
            ...
            if (cl == 
# 3106 "project/nginx/src/http/ngx_http_request.c" 3 4
                     ((void *)0)
# 3106 "project/nginx/src/http/ngx_http_request.c"
                         ) {
                ngx_http_close_request(r, 0);
                return;
            }
            ...
            cl->buf = b;
            cl->next = 
# 3112 "project/nginx/src/http/ngx_http_request.c" 3 4
                      ((void *)0)
# 3112 "project/nginx/src/http/ngx_http_request.c"
                          ;
    ...
    if (ngx_handle_read_event(rev, 0) != 
# 3126 "project/nginx/src/http/ngx_http_request.c" 3 4
                                        0
# 3126 "project/nginx/src/http/ngx_http_request.c"
                                              ) {
        ngx_http_close_connection(c);
        return;
    }
    ...
    if (b->pos < b->last) {
        ...
        if (r == 
# 3141 "project/nginx/src/http/ngx_http_request.c" 3 4
                ((void *)0)
# 3141 "project/nginx/src/http/ngx_http_request.c"
                    ) {
            ngx_http_close_connection(c);
            return;
        }
...
# 3154 "project/nginx/src/http/ngx_http_request.c" 3 4
           ngx_event_del_timer
# 3154 "project/nginx/src/http/ngx_http_request.c"
                        (rev);
        }

        rev->handler = ngx_http_process_request_line;
        
# 3158 "project/nginx/src/http/ngx_http_request.c" 3 4
       if (!(
# 3158 "project/nginx/src/http/ngx_http_request.c"
       rev
# 3158 "project/nginx/src/http/ngx_http_request.c" 3 4
       )->posted) { (
# 3158 "project/nginx/src/http/ngx_http_request.c"
...
# 3169 "project/nginx/src/http/ngx_http_request.c"
    b = c->buffer;

    if (ngx_pfree(c->pool, b->start) == 
# 3171 "project/nginx/src/http/ngx_http_request.c" 3 4
                                       0
# 3171 "project/nginx/src/http/ngx_http_request.c"
                                             ) {
        ...
        b->pos = 
# 3178 "project/nginx/src/http/ngx_http_request.c" 3 4
                ((void *)0)
# 3178 "project/nginx/src/http/ngx_http_request.c"
                    ;
...
# 3193 "project/nginx/src/http/ngx_http_request.c" 3 4
           (
# 3193 "project/nginx/src/http/ngx_http_request.c"
           ln
# 3193 "project/nginx/src/http/ngx_http_request.c" 3 4
           )->next = (
# 3193 "project/nginx/src/http/ngx_http_request.c"
...
# 3193 "project/nginx/src/http/ngx_http_request.c"
        ...
        hc->free = 
# 3196 "project/nginx/src/http/ngx_http_request.c" 3 4
                  ((void *)0)
# 3196 "project/nginx/src/http/ngx_http_request.c"
                      ;
    }
...
# 3207 "project/nginx/src/http/ngx_http_request.c" 3 4
           (
# 3207 "project/nginx/src/http/ngx_http_request.c"
           ln
# 3207 "project/nginx/src/http/ngx_http_request.c" 3 4
           )->next = (
# 3207 "project/nginx/src/http/ngx_http_request.c"
...
# 3207 "project/nginx/src/http/ngx_http_request.c"
        ...
        hc->busy = 
# 3210 "project/nginx/src/http/ngx_http_request.c" 3 4
                  ((void *)0)
# 3210 "project/nginx/src/http/ngx_http_request.c"
                      ;
        hc->nbusy = 0;
    }
...
# 3222 "project/nginx/src/http/ngx_http_request.c" 3 4
                                         0x00000001
# 3222 "project/nginx/src/http/ngx_http_request.c"
                                                            )) {
        if (
# 3223 "project/nginx/src/http/ngx_http_request.c" 3 4
           ngx_event_actions.del
# 3223 "project/nginx/src/http/ngx_http_request.c"
                        (wev, 
# 3223 "project/nginx/src/http/ngx_http_request.c" 3 4
                              (-2)
# 3223 "project/nginx/src/http/ngx_http_request.c"
...
# 3233 "project/nginx/src/http/ngx_http_request.c" 3 4
                                   (*__error())
# 3233 "project/nginx/src/http/ngx_http_request.c"
                                                   , 
# 3233 "project/nginx/src/http/ngx_http_request.c" 3 4
...
# 3245 "project/nginx/src/http/ngx_http_request.c" 3 4
                                                                 0
# 3245 "project/nginx/src/http/ngx_http_request.c"
                                                                       ) {
        ngx_http_close_connection(c);
        return;
    }
...
# 3258 "project/nginx/src/http/ngx_http_request.c" 3 4
   ngx_event_add_timer
# 3258 "project/nginx/src/http/ngx_http_request.c"
                (rev, clcf->keepalive_timeout);

    if (rev->ready) {
        
# 3261 "project/nginx/src/http/ngx_http_request.c" 3 4
       if (!(
# 3261 "project/nginx/src/http/ngx_http_request.c"
       rev
# 3261 "project/nginx/src/http/ngx_http_request.c" 3 4
       )->posted) { (
# 3261 "project/nginx/src/http/ngx_http_request.c"
...
ngx_http_keepalive_handler(ngx_event_t *rev)
{
    ...
    if (ngx_event_flags & 
# 3285 "project/nginx/src/http/ngx_http_request.c" 3 4
                         0x00000008
# 3285 "project/nginx/src/http/ngx_http_request.c"
                                             ) {
        if (rev->pending_eof) {
            c->log->handler = 
# 3287 "project/nginx/src/http/ngx_http_request.c" 3 4
                             ((void *)0)
# 3287 "project/nginx/src/http/ngx_http_request.c"
                                 ;
            
# 3288 "project/nginx/src/http/ngx_http_request.c" 3 4
           if ((
# 3288 "project/nginx/src/http/ngx_http_request.c"
           c->log
# 3288 "project/nginx/src/http/ngx_http_request.c" 3 4
           )->log_level >= 7) ngx_log_error_core(7, 
# 3288 "project/nginx/src/http/ngx_http_request.c"
...
# 3288 "project/nginx/src/http/ngx_http_request.c" 3 4
           , 
# 3288 "project/nginx/src/http/ngx_http_request.c"
           rev->kq_errno, "kevent() reported that client %V closed " "keepalive connection", &c->addr_text
# 3288 "project/nginx/src/http/ngx_http_request.c" 3 4
           )

                                                                
# 3290 "project/nginx/src/http/ngx_http_request.c"
                                                               ;
    ...
    if (b->pos == 
# 3306 "project/nginx/src/http/ngx_http_request.c" 3 4
                 ((void *)0)
# 3306 "project/nginx/src/http/ngx_http_request.c"
                     ) {
        ...
        if (b->pos == 
# 3315 "project/nginx/src/http/ngx_http_request.c" 3 4
                     ((void *)0)
# 3315 "project/nginx/src/http/ngx_http_request.c"
                         ) {
            ngx_http_close_connection(c);
            return;
        }
...
# 3331 "project/nginx/src/http/ngx_http_request.c" 3 4
   (*__error()) = 
# 3331 "project/nginx/src/http/ngx_http_request.c"
   0;
    ...
    if (n == 
# 3336 "project/nginx/src/http/ngx_http_request.c" 3 4
            -2
# 3336 "project/nginx/src/http/ngx_http_request.c"
                     ) {
        if (ngx_handle_read_event(rev, 0) != 
# 3337 "project/nginx/src/http/ngx_http_request.c" 3 4
                                            0
# 3337 "project/nginx/src/http/ngx_http_request.c"
                                                  ) {
            ngx_http_close_connection(c);
            return;
        }
        ...
        if (ngx_pfree(c->pool, b->start) == 
# 3347 "project/nginx/src/http/ngx_http_request.c" 3 4
                                           0
# 3347 "project/nginx/src/http/ngx_http_request.c"
                                                 ) {
            ...
            b->pos = 
# 3353 "project/nginx/src/http/ngx_http_request.c" 3 4
                    ((void *)0)
# 3353 "project/nginx/src/http/ngx_http_request.c"
                        ;
        }
    ...
    if (n == 
# 3359 "project/nginx/src/http/ngx_http_request.c" 3 4
            -1
# 3359 "project/nginx/src/http/ngx_http_request.c"
                     ) {
        ngx_http_close_connection(c);
        return;
    }
    ...
    c->log->handler = 
# 3364 "project/nginx/src/http/ngx_http_request.c" 3 4
                     ((void *)0)
# 3364 "project/nginx/src/http/ngx_http_request.c"
                         ;

    if (n == 0) {
        
# 3367 "project/nginx/src/http/ngx_http_request.c" 3 4
       if ((
# 3367 "project/nginx/src/http/ngx_http_request.c"
       c->log
# 3367 "project/nginx/src/http/ngx_http_request.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 3367 "project/nginx/src/http/ngx_http_request.c"
...
# 3368 "project/nginx/src/http/ngx_http_request.c"
                                                                            ;
        ngx_http_close_connection(c);
        return;
    }
    ...
    c->data = ngx_http_create_request(c);
    if (c->data == 
# 3382 "project/nginx/src/http/ngx_http_request.c" 3 4
                  ((void *)0)
# 3382 "project/nginx/src/http/ngx_http_request.c"
                      ) {
        ngx_http_close_connection(c);
        return;
    }
...
# 3390 "project/nginx/src/http/ngx_http_request.c" 3 4
   ngx_event_del_timer
# 3390 "project/nginx/src/http/ngx_http_request.c"
                (rev);
...
ngx_http_set_lingering_close(ngx_connection_t *c)
{
    ...
    clcf = 
# 3406 "project/nginx/src/http/ngx_http_request.c" 3 4
          (
# 3406 "project/nginx/src/http/ngx_http_request.c"
          r
# 3406 "project/nginx/src/http/ngx_http_request.c" 3 4
          )->loc_conf[
# 3406 "project/nginx/src/http/ngx_http_request.c"
...
# 3406 "project/nginx/src/http/ngx_http_request.c"
    ...
    if (r->lingering_time == 0) {
        r->lingering_time = 
# 3409 "project/nginx/src/http/ngx_http_request.c" 3 4
                           ngx_cached_time->sec 
# 3409 "project/nginx/src/http/ngx_http_request.c"
                                      + (time_t) (clcf->lingering_time / 1000);
    }
# 3432 "project/nginx/src/http/ngx_http_request.c"
    rev = c->read;
    rev->handler = ngx_http_lingering_close_handler;

    if (ngx_handle_read_event(rev, 0) != 
# 3435 "project/nginx/src/http/ngx_http_request.c" 3 4
                                        0
# 3435 "project/nginx/src/http/ngx_http_request.c"
                                              ) {
        ngx_http_close_request(r, 0);
        return;
    }
    ...
    if (wev->active && (ngx_event_flags & 
# 3443 "project/nginx/src/http/ngx_http_request.c" 3 4
                                         0x00000001
# 3443 "project/nginx/src/http/ngx_http_request.c"
                                                            )) {
        if (
# 3444 "project/nginx/src/http/ngx_http_request.c" 3 4
           ngx_event_actions.del
# 3444 "project/nginx/src/http/ngx_http_request.c"
                        (wev, 
# 3444 "project/nginx/src/http/ngx_http_request.c" 3 4
                              (-2)
# 3444 "project/nginx/src/http/ngx_http_request.c"
...
# 3444 "project/nginx/src/http/ngx_http_request.c"
    ...
    if (
# 3450 "project/nginx/src/http/ngx_http_request.c" 3 4
       shutdown
# 3450 "project/nginx/src/http/ngx_http_request.c"
                          (c->fd, 
# 3450 "project/nginx/src/http/ngx_http_request.c" 3 4
                                  1
# 3450 "project/nginx/src/http/ngx_http_request.c"
        ...
        ngx_connection_error(c, 
# 3451 "project/nginx/src/http/ngx_http_request.c" 3 4
                               (*__error())
# 3451 "project/nginx/src/http/ngx_http_request.c"
                                               ,
                             
# 3452 "project/nginx/src/http/ngx_http_request.c" 3 4
                            "shutdown()" 
# 3452 "project/nginx/src/http/ngx_http_request.c"
                                                  " failed");
        ngx_http_close_request(r, 0);
        return;
    }
...
# 3460 "project/nginx/src/http/ngx_http_request.c" 3 4
   ngx_event_add_timer
# 3460 "project/nginx/src/http/ngx_http_request.c"
...
ngx_http_lingering_close_handler(ngx_event_t *rev)
{
    ...
    ngx_http_core_loc_conf_t *clcf;
    u_char buffer[
# 3476 "project/nginx/src/http/ngx_http_request.c" 3 4
                                     4096
# 3476 "project/nginx/src/http/ngx_http_request.c"
                                                                   ];
...
# 3489 "project/nginx/src/http/ngx_http_request.c" 3 4
                                                         ngx_cached_time->sec
# 3489 "project/nginx/src/http/ngx_http_request.c"
                                                                   ;
    ...
    do {
        n = c->recv(c, buffer, 
# 3496 "project/nginx/src/http/ngx_http_request.c" 3 4
                              4096
# 3496 "project/nginx/src/http/ngx_http_request.c"
                                                            );

        ;

        if (n == 
# 3500 "project/nginx/src/http/ngx_http_request.c" 3 4
                -2
# 3500 "project/nginx/src/http/ngx_http_request.c"
                         ) {
            break;
        }

        if (n == 
# 3504 "project/nginx/src/http/ngx_http_request.c" 3 4
                -1 
# 3504 "project/nginx/src/http/ngx_http_request.c"
                          || n == 0) {
            ngx_http_close_request(r, 0);
            return;
        }
    ...
    if (ngx_handle_read_event(rev, 0) != 
# 3511 "project/nginx/src/http/ngx_http_request.c" 3 4
                                        0
# 3511 "project/nginx/src/http/ngx_http_request.c"
                                              ) {
        ngx_http_close_request(r, 0);
        return;
    }
    ...
    clcf = 
# 3516 "project/nginx/src/http/ngx_http_request.c" 3 4
          (
# 3516 "project/nginx/src/http/ngx_http_request.c"
          r
# 3516 "project/nginx/src/http/ngx_http_request.c" 3 4
          )->loc_conf[
# 3516 "project/nginx/src/http/ngx_http_request.c"
...
# 3524 "project/nginx/src/http/ngx_http_request.c" 3 4
   ngx_event_add_timer
# 3524 "project/nginx/src/http/ngx_http_request.c"
                (rev, timer);
}
...
ngx_http_send_special(ngx_http_request_t *r, ngx_uint_t flags)
{
    ...
    b = 
# 3553 "project/nginx/src/http/ngx_http_request.c" 3 4
       ngx_pcalloc(
# 3553 "project/nginx/src/http/ngx_http_request.c"
       r->pool
# 3553 "project/nginx/src/http/ngx_http_request.c" 3 4
       , sizeof(ngx_buf_t))
# 3553 "project/nginx/src/http/ngx_http_request.c"
                              ;
    if (b == 
# 3554 "project/nginx/src/http/ngx_http_request.c" 3 4
            ((void *)0)
# 3554 "project/nginx/src/http/ngx_http_request.c"
                ) {
        return 
# 3555 "project/nginx/src/http/ngx_http_request.c" 3 4
              -1
# 3555 "project/nginx/src/http/ngx_http_request.c"
                       ;
    }

    if (flags & 
# 3558 "project/nginx/src/http/ngx_http_request.c" 3 4
               1
# 3558 "project/nginx/src/http/ngx_http_request.c"
                            ) {
    ...
    if (flags & 
# 3569 "project/nginx/src/http/ngx_http_request.c" 3 4
               2
# 3569 "project/nginx/src/http/ngx_http_request.c"
                             ) {
        b->flush = 1;
    }
    ...
    out.buf = b;
    out.next = 
# 3574 "project/nginx/src/http/ngx_http_request.c" 3 4
              ((void *)0)
# 3574 "project/nginx/src/http/ngx_http_request.c"
                  ;
...
ngx_http_post_action(ngx_http_request_t *r)
{
    ...
    clcf = 
# 3585 "project/nginx/src/http/ngx_http_request.c" 3 4
          (
# 3585 "project/nginx/src/http/ngx_http_request.c"
          r
# 3585 "project/nginx/src/http/ngx_http_request.c" 3 4
          )->loc_conf[
# 3585 "project/nginx/src/http/ngx_http_request.c"
...
# 3587 "project/nginx/src/http/ngx_http_request.c" 3 4
                                 ((void *)0)
# 3587 "project/nginx/src/http/ngx_http_request.c"
                                     ) {
        return 
# 3588 "project/nginx/src/http/ngx_http_request.c" 3 4
              -5
# 3588 "project/nginx/src/http/ngx_http_request.c"
                          ;
    }

    if (r->post_action && r->uri_changes == 0) {
        return 
# 3592 "project/nginx/src/http/ngx_http_request.c" 3 4
              -5
# 3592 "project/nginx/src/http/ngx_http_request.c"
                          ;
    }
    ...
    r->http_version = 
# 3600 "project/nginx/src/http/ngx_http_request.c" 3 4
                     9
# 3600 "project/nginx/src/http/ngx_http_request.c"
                                       ;
    r->header_only = 1;
    r->post_action = 1;
    ...
    if (clcf->post_action.data[0] == '/') {
        ngx_http_internal_redirect(r, &clcf->post_action, 
# 3607 "project/nginx/src/http/ngx_http_request.c" 3 4
                                                         ((void *)0)
# 3607 "project/nginx/src/http/ngx_http_request.c"
                                                             );
    ...
    return 
# 3613 "project/nginx/src/http/ngx_http_request.c" 3 4
          0
# 3613 "project/nginx/src/http/ngx_http_request.c"
                ;
}
...
# 3629 "project/nginx/src/http/ngx_http_request.c" 3 4
       if ((
# 3629 "project/nginx/src/http/ngx_http_request.c"
       c->log
# 3629 "project/nginx/src/http/ngx_http_request.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 3629 "project/nginx/src/http/ngx_http_request.c"
...
# 3645 "project/nginx/src/http/ngx_http_request.c"
...
ngx_http_free_request(ngx_http_request_t *r, ngx_int_t rc)
{
    ...
    if (r->pool == 
# 3664 "project/nginx/src/http/ngx_http_request.c" 3 4
                  ((void *)0)
# 3664 "project/nginx/src/http/ngx_http_request.c"
                      ) {
        
# 3665 "project/nginx/src/http/ngx_http_request.c" 3 4
       if ((
# 3665 "project/nginx/src/http/ngx_http_request.c"
       log
# 3665 "project/nginx/src/http/ngx_http_request.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 3665 "project/nginx/src/http/ngx_http_request.c"
...
# 3665 "project/nginx/src/http/ngx_http_request.c"
    ...
    cln = r->cleanup;
    r->cleanup = 
# 3670 "project/nginx/src/http/ngx_http_request.c" 3 4
                ((void *)0)
# 3670 "project/nginx/src/http/ngx_http_request.c"
                    ;
...
# 3692 "project/nginx/src/http/ngx_http_request.c"
    ...
    if (r->connection->timedout) {
        clcf = 
# 3705 "project/nginx/src/http/ngx_http_request.c" 3 4
              (
# 3705 "project/nginx/src/http/ngx_http_request.c"
              r
# 3705 "project/nginx/src/http/ngx_http_request.c" 3 4
              )->loc_conf[
# 3705 "project/nginx/src/http/ngx_http_request.c"
...
# 3705 "project/nginx/src/http/ngx_http_request.c"
        ...
        if (clcf->reset_timedout_connection) {
            ...
            if (setsockopt(r->connection->fd, 
# 3711 "project/nginx/src/http/ngx_http_request.c" 3 4
                                             0xffff
# 3711 "project/nginx/src/http/ngx_http_request.c"
                                                       , 
# 3711 "project/nginx/src/http/ngx_http_request.c" 3 4
                                                         0x0080
# 3711 "project/nginx/src/http/ngx_http_request.c"
...
# 3714 "project/nginx/src/http/ngx_http_request.c" 3 4
               if ((
# 3714 "project/nginx/src/http/ngx_http_request.c"
               log
# 3714 "project/nginx/src/http/ngx_http_request.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 3714 "project/nginx/src/http/ngx_http_request.c"
...
# 3715 "project/nginx/src/http/ngx_http_request.c"
                                                            ;
            }
        }
    }
    ...
    ctx = log->data;
    ctx->request = 
# 3722 "project/nginx/src/http/ngx_http_request.c" 3 4
                  ((void *)0)
# 3722 "project/nginx/src/http/ngx_http_request.c"
                      ;
    ...
    pool = r->pool;
    r->pool = 
# 3734 "project/nginx/src/http/ngx_http_request.c" 3 4
             ((void *)0)
# 3734 "project/nginx/src/http/ngx_http_request.c"
                 ;
...
ngx_http_log_request(ngx_http_request_t *r)
{
    ...
    cmcf = 
# 3747 "project/nginx/src/http/ngx_http_request.c" 3 4
          (
# 3747 "project/nginx/src/http/ngx_http_request.c"
          r
# 3747 "project/nginx/src/http/ngx_http_request.c" 3 4
          )->main_conf[
# 3747 "project/nginx/src/http/ngx_http_request.c"
...
ngx_http_close_connection(ngx_connection_t *c)
{
    ngx_pool_t *pool;
                                                      ...
                                                      ;
# 3781 "project/nginx/src/http/ngx_http_request.c"
    c->destroyed = 1;
    ...
    u_char *buf, size_t len)
{
    ...
    cscf = 
# 3832 "project/nginx/src/http/ngx_http_request.c" 3 4
          (
# 3832 "project/nginx/src/http/ngx_http_request.c"
          r
# 3832 "project/nginx/src/http/ngx_http_request.c" 3 4
          )->srv_conf[
# 3832 "project/nginx/src/http/ngx_http_request.c"
...
# 3838 "project/nginx/src/http/ngx_http_request.c" 3 4
                               ((void *)0) 
# 3838 "project/nginx/src/http/ngx_http_request.c"
                                    && r->request_start) {
        for (p = r->request_start; p < r->header_in->last; p++) {
            if (*p == 
# 3840 "project/nginx/src/http/ngx_http_request.c" 3 4
                     (u_char) '\r' 
# 3840 "project/nginx/src/http/ngx_http_request.c"
                        || *p == 
# 3840 "project/nginx/src/http/ngx_http_request.c" 3 4
                                 (u_char) '\n'
# 3840 "project/nginx/src/http/ngx_http_request.c"
    ...
    if (u && u->peer.name) {
        ...
        if (u->peer.sockaddr && u->peer.sockaddr->sa_family == 
# 3868 "project/nginx/src/http/ngx_http_request.c" 3 4
                                                              1
# 3868 "project/nginx/src/http/ngx_http_request.c"
                                                                     ) {
            uri_separator = ":";
        }
