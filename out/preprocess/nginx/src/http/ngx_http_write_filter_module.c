# 0 "project/nginx/src/http/ngx_http_write_filter_module.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 9 "project/nginx/src/http/ngx_http_write_filter_module.c" 2
...
# 10 "project/nginx/src/http/ngx_http_write_filter_module.c" 2
...
# 11 "project/nginx/src/http/ngx_http_write_filter_module.c" 2



# 13 "project/nginx/src/http/ngx_http_write_filter_module.c"
static ngx_int_t ngx_http_write_filter_init(ngx_conf_t *cf);


static ngx_http_module_t ngx_http_write_filter_module_ctx = {
    
# 17 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
   ((void *)0)
# 17 "project/nginx/src/http/ngx_http_write_filter_module.c"
       ,
    ngx_http_write_filter_init,

    
# 20 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
   ((void *)0)
# 20 "project/nginx/src/http/ngx_http_write_filter_module.c"
       ,
    
# 21 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
   ((void *)0)
# 21 "project/nginx/src/http/ngx_http_write_filter_module.c"
       ,

    
# 23 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
   ((void *)0)
# 23 "project/nginx/src/http/ngx_http_write_filter_module.c"
       ,
    
# 24 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
   ((void *)0)
# 24 "project/nginx/src/http/ngx_http_write_filter_module.c"
       ,

    
# 26 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
   ((void *)0)
# 26 "project/nginx/src/http/ngx_http_write_filter_module.c"
       ,
    
# 27 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
   ((void *)0)
# 27 "project/nginx/src/http/ngx_http_write_filter_module.c"
       ,
};
...
# 32 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 32 "project/nginx/src/http/ngx_http_write_filter_module.c"
   "8" 
# 32 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
   "," 
# 32 "project/nginx/src/http/ngx_http_write_filter_module.c"
...
# 34 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
   ((void *)0)
# 34 "project/nginx/src/http/ngx_http_write_filter_module.c"
       ,
    
# 35 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
   0x50545448
# 35 "project/nginx/src/http/ngx_http_write_filter_module.c"
                  ,
    
# 36 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
   ((void *)0)
# 36 "project/nginx/src/http/ngx_http_write_filter_module.c"
       ,
    
# 37 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
   ((void *)0)
# 37 "project/nginx/src/http/ngx_http_write_filter_module.c"
       ,
    
# 38 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
   ((void *)0)
# 38 "project/nginx/src/http/ngx_http_write_filter_module.c"
       ,
    
# 39 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
   ((void *)0)
# 39 "project/nginx/src/http/ngx_http_write_filter_module.c"
       ,
    
# 40 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
   ((void *)0)
# 40 "project/nginx/src/http/ngx_http_write_filter_module.c"
       ,
    
# 41 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
   ((void *)0)
# 41 "project/nginx/src/http/ngx_http_write_filter_module.c"
       ,
    
# 42 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
   ((void *)0)
# 42 "project/nginx/src/http/ngx_http_write_filter_module.c"
       ,
    
# 43 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 44 "project/nginx/src/http/ngx_http_write_filter_module.c"
};
...
ngx_http_write_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    if (c->error) {
        return 
# 60 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
              -1
# 60 "project/nginx/src/http/ngx_http_write_filter_module.c"
                       ;
    }
    ...
    for (cl = r->out; cl; cl = cl->next) {
        ...
        if (
# 83 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
           (((
# 83 "project/nginx/src/http/ngx_http_write_filter_module.c"
           cl->buf
# 83 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
           )->temporary || (
# 83 "project/nginx/src/http/ngx_http_write_filter_module.c"
...
# 84 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
           if ((
# 84 "project/nginx/src/http/ngx_http_write_filter_module.c"
           c->log
# 84 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
...
# 95 "project/nginx/src/http/ngx_http_write_filter_module.c"
                                             ;

            
# 97 "project/nginx/src/http/ngx_http_write_filter_module.c"
           ngx_debug_point();
            return 
# 98 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
                  -1
# 98 "project/nginx/src/http/ngx_http_write_filter_module.c"
                           ;
        }

        if (
# 101 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
           (((
# 101 "project/nginx/src/http/ngx_http_write_filter_module.c"
           cl->buf
# 101 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
           )->temporary || (
# 101 "project/nginx/src/http/ngx_http_write_filter_module.c"
...
# 102 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
           if ((
# 102 "project/nginx/src/http/ngx_http_write_filter_module.c"
           c->log
# 102 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 102 "project/nginx/src/http/ngx_http_write_filter_module.c"
...
# 113 "project/nginx/src/http/ngx_http_write_filter_module.c"
                                             ;

            
# 115 "project/nginx/src/http/ngx_http_write_filter_module.c"
           ngx_debug_point();
            return 
# 116 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
                  -1
# 116 "project/nginx/src/http/ngx_http_write_filter_module.c"
                           ;
        }

        size += 
# 119 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
               (((
# 119 "project/nginx/src/http/ngx_http_write_filter_module.c"
               cl->buf
# 119 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
               )->temporary || (
# 119 "project/nginx/src/http/ngx_http_write_filter_module.c"
...
# 119 "project/nginx/src/http/ngx_http_write_filter_module.c"
    ...
    for (ln = in; ln; ln = ln->next) {
        ...
        if (cl == 
# 138 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
                 ((void *)0)
# 138 "project/nginx/src/http/ngx_http_write_filter_module.c"
                     ) {
            return 
# 139 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
                  -1
# 139 "project/nginx/src/http/ngx_http_write_filter_module.c"
                           ;
        }
        ...
        *ll = cl;
        ...
        if (
# 155 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
           (((
# 155 "project/nginx/src/http/ngx_http_write_filter_module.c"
           cl->buf
# 155 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
           )->temporary || (
# 155 "project/nginx/src/http/ngx_http_write_filter_module.c"
...
# 156 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
           if ((
# 156 "project/nginx/src/http/ngx_http_write_filter_module.c"
           c->log
# 156 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 156 "project/nginx/src/http/ngx_http_write_filter_module.c"
...
# 167 "project/nginx/src/http/ngx_http_write_filter_module.c"
                                             ;

            
# 169 "project/nginx/src/http/ngx_http_write_filter_module.c"
           ngx_debug_point();
            return 
# 170 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
                  -1
# 170 "project/nginx/src/http/ngx_http_write_filter_module.c"
                           ;
        }

        if (
# 173 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
           (((
# 173 "project/nginx/src/http/ngx_http_write_filter_module.c"
           cl->buf
# 173 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
           )->temporary || (
# 173 "project/nginx/src/http/ngx_http_write_filter_module.c"
...
# 174 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
           if ((
# 174 "project/nginx/src/http/ngx_http_write_filter_module.c"
           c->log
# 174 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
           )->log_level >= 2) ngx_log_error_core(2, 
# 174 "project/nginx/src/http/ngx_http_write_filter_module.c"
...
# 185 "project/nginx/src/http/ngx_http_write_filter_module.c"
                                             ;

            
# 187 "project/nginx/src/http/ngx_http_write_filter_module.c"
           ngx_debug_point();
            return 
# 188 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
                  -1
# 188 "project/nginx/src/http/ngx_http_write_filter_module.c"
                           ;
        }

        size += 
# 191 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
               (((
# 191 "project/nginx/src/http/ngx_http_write_filter_module.c"
               cl->buf
# 191 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
               )->temporary || (
# 191 "project/nginx/src/http/ngx_http_write_filter_module.c"
...
# 191 "project/nginx/src/http/ngx_http_write_filter_module.c"
    ...
    *ll = 
# 206 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
         ((void *)0)
# 206 "project/nginx/src/http/ngx_http_write_filter_module.c"
             ;
    ...
    clcf = 
# 211 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
          (
# 211 "project/nginx/src/http/ngx_http_write_filter_module.c"
          r
# 211 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
          )->loc_conf[
# 211 "project/nginx/src/http/ngx_http_write_filter_module.c"
...
# 211 "project/nginx/src/http/ngx_http_write_filter_module.c"
    ...
    if (!last && !flush && in && size < (off_t) clcf->postpone_output) {
        return 
# 220 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
              0
# 220 "project/nginx/src/http/ngx_http_write_filter_module.c"
                    ;
    }

    if (c->write->delayed) {
        c->buffered |= 
# 224 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
                      0x10
# 224 "project/nginx/src/http/ngx_http_write_filter_module.c"
                                             ;
        return 
# 225 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
              -2
# 225 "project/nginx/src/http/ngx_http_write_filter_module.c"
                       ;
    }

    if (size == 0
        && !(c->buffered & 
# 229 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
                          0x0f
# 229 "project/nginx/src/http/ngx_http_write_filter_module.c"
                                               )
...
# 236 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
               (
# 236 "project/nginx/src/http/ngx_http_write_filter_module.c"
               ln
# 236 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
               )->next = (
# 236 "project/nginx/src/http/ngx_http_write_filter_module.c"
...
# 236 "project/nginx/src/http/ngx_http_write_filter_module.c"
            ...
            r->out = 
# 239 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
                    ((void *)0)
# 239 "project/nginx/src/http/ngx_http_write_filter_module.c"
                        ;
            c->buffered &= ~
# 240 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
                           0x10
# 240 "project/nginx/src/http/ngx_http_write_filter_module.c"
                                                  ;

            return 
# 242 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
                  0
# 242 "project/nginx/src/http/ngx_http_write_filter_module.c"
                        ;
        }

        
# 245 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
       if ((
# 245 "project/nginx/src/http/ngx_http_write_filter_module.c"
       c->log
# 245 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 245 "project/nginx/src/http/ngx_http_write_filter_module.c"
...
# 245 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
       , 
# 245 "project/nginx/src/http/ngx_http_write_filter_module.c"
       0, "the http output chain is empty"
# 245 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
       )
                                                       
# 246 "project/nginx/src/http/ngx_http_write_filter_module.c"
                                                      ;

        ngx_debug_point();

        return 
# 250 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
              -1
# 250 "project/nginx/src/http/ngx_http_write_filter_module.c"
                       ;
    }
...
# 266 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
                                        ngx_cached_time->sec 
# 266 "project/nginx/src/http/ngx_http_write_filter_module.c"
                                                   - r->start_sec + 1)
...
# 272 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
           ngx_event_add_timer
# 272 "project/nginx/src/http/ngx_http_write_filter_module.c"
                        (c->write, delay);

            c->buffered |= 
# 274 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
                          0x10
# 274 "project/nginx/src/http/ngx_http_write_filter_module.c"
                                                 ;

            return 
# 276 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
                  -2
# 276 "project/nginx/src/http/ngx_http_write_filter_module.c"
                           ;
        }
    ...
    if (chain == 
# 299 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
                (ngx_chain_t *) -1
# 299 "project/nginx/src/http/ngx_http_write_filter_module.c"
                               ) {
        c->error = 1;
        return 
# 301 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
              -1
# 301 "project/nginx/src/http/ngx_http_write_filter_module.c"
                       ;
    }
...
# 325 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
           ngx_event_add_timer
# 325 "project/nginx/src/http/ngx_http_write_filter_module.c"
                        (c->write, delay);
        }
    }
...
# 330 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
       if (!(
# 330 "project/nginx/src/http/ngx_http_write_filter_module.c"
       c->write
# 330 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
       )->posted) { (
# 330 "project/nginx/src/http/ngx_http_write_filter_module.c"
...
# 336 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
       (
# 336 "project/nginx/src/http/ngx_http_write_filter_module.c"
       ln
# 336 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
       )->next = (
# 336 "project/nginx/src/http/ngx_http_write_filter_module.c"
...
# 336 "project/nginx/src/http/ngx_http_write_filter_module.c"
    ...
    if (chain) {
        c->buffered |= 
# 342 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
                      0x10
# 342 "project/nginx/src/http/ngx_http_write_filter_module.c"
                                             ;
        return 
# 343 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
              -2
# 343 "project/nginx/src/http/ngx_http_write_filter_module.c"
                       ;
    }

    c->buffered &= ~
# 346 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
                   0x10
# 346 "project/nginx/src/http/ngx_http_write_filter_module.c"
                                          ;

    if ((c->buffered & 
# 348 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
                      0x0f
# 348 "project/nginx/src/http/ngx_http_write_filter_module.c"
                                           ) && r->postponed == 
# 348 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
                                                                ((void *)0)
# 348 "project/nginx/src/http/ngx_http_write_filter_module.c"
        ...
        return 
# 349 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
              -2
# 349 "project/nginx/src/http/ngx_http_write_filter_module.c"
                       ;
    }

    return 
# 352 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
          0
# 352 "project/nginx/src/http/ngx_http_write_filter_module.c"
                ;
}
...
ngx_http_write_filter_init(ngx_conf_t *cf)
{
    ...
    return 
# 361 "project/nginx/src/http/ngx_http_write_filter_module.c" 3 4
          0
# 361 "project/nginx/src/http/ngx_http_write_filter_module.c"
                ;
}
