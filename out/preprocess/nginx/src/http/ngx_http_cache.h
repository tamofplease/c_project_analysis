# 0 "project/nginx/src/http/ngx_http_cache.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/http/ngx_http_cache.h"
# 12 "project/nginx/src/http/ngx_http_cache.h"
...
# 13 "project/nginx/src/http/ngx_http_cache.h" 2
...
# 14 "project/nginx/src/http/ngx_http_cache.h" 2
...
# 15 "project/nginx/src/http/ngx_http_cache.h" 2
# 33 "project/nginx/src/http/ngx_http_cache.h"
