# 0 "project/nginx/src/http/ngx_http_script.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/http/ngx_http_script.h"
# 12 "project/nginx/src/http/ngx_http_script.h"
...
# 13 "project/nginx/src/http/ngx_http_script.h" 2
...
# 14 "project/nginx/src/http/ngx_http_script.h" 2
...
# 15 "project/nginx/src/http/ngx_http_script.h" 2



# 17 "project/nginx/src/http/ngx_http_script.h"
typedef struct {
    u_char *ip;
    u_char *pos;
