# 0 "project/nginx/src/http/ngx_http_file_cache.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 9 "project/nginx/src/http/ngx_http_file_cache.c" 2
...
# 10 "project/nginx/src/http/ngx_http_file_cache.c" 2
...
# 11 "project/nginx/src/http/ngx_http_file_cache.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/core/ngx_md5.h" 1 3 4
# 16 "/Users/washi38/University/Labo/c_project_analysis/project/nginx/src/core/ngx_md5.h" 3 4
typedef struct {
    uint64_t bytes;
    uint32_t a, b, c, d;
    u_char buffer[64];
...
# 12 "project/nginx/src/http/ngx_http_file_cache.c" 2



# 14 "project/nginx/src/http/ngx_http_file_cache.c"
...
static ssize_t ngx_http_file_cache_aio_read(ngx_http_request_t *r,
    ngx_http_cache_t *c);
# 31 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 69 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   { sizeof(
# 69 "project/nginx/src/http/ngx_http_file_cache.c"
   "MISS"
# 69 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   ) - 1, (u_char *) 
# 69 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 70 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   { sizeof(
# 70 "project/nginx/src/http/ngx_http_file_cache.c"
   "BYPASS"
# 70 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   ) - 1, (u_char *) 
# 70 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 71 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   { sizeof(
# 71 "project/nginx/src/http/ngx_http_file_cache.c"
   "EXPIRED"
# 71 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   ) - 1, (u_char *) 
# 71 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 72 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   { sizeof(
# 72 "project/nginx/src/http/ngx_http_file_cache.c"
   "STALE"
# 72 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   ) - 1, (u_char *) 
# 72 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 73 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   { sizeof(
# 73 "project/nginx/src/http/ngx_http_file_cache.c"
   "UPDATING"
# 73 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   ) - 1, (u_char *) 
# 73 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 74 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   { sizeof(
# 74 "project/nginx/src/http/ngx_http_file_cache.c"
   "REVALIDATED"
# 74 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   ) - 1, (u_char *) 
# 74 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 75 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   { sizeof(
# 75 "project/nginx/src/http/ngx_http_file_cache.c"
   "HIT"
# 75 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   ) - 1, (u_char *) 
# 75 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 76 "project/nginx/src/http/ngx_http_file_cache.c"
};


static u_char ngx_http_file_cache_key[] = { 
# 79 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                            (u_char) '\n'
# 79 "project/nginx/src/http/ngx_http_file_cache.c"
                                              , 'K', 'E', 'Y', ':', ' ' };
...
ngx_http_file_cache_init(ngx_shm_zone_t *shm_zone, void *data)
{
    ...
    if (ocache) {
        if (
# 94 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           strcmp((const char *) 
# 94 "project/nginx/src/http/ngx_http_file_cache.c"
           cache->path->name.data
# 94 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           , (const char *) 
# 94 "project/nginx/src/http/ngx_http_file_cache.c"
           ocache->path->name.data
# 94 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           ) 
# 94 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                       != 0) {
            
# 95 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           if ((
# 95 "project/nginx/src/http/ngx_http_file_cache.c"
           shm_zone->shm.log
# 95 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
...
# 95 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           , 
# 95 "project/nginx/src/http/ngx_http_file_cache.c"
           0, "cache \"%V\" uses the \"%V\" cache path " "while previously it used the \"%V\" cache path", &shm_zone->shm.name, &cache->path->name, &ocache->path->name
# 95 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           )
...
# 99 "project/nginx/src/http/ngx_http_file_cache.c"
                                             ;

            return 
# 101 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                  -1
# 101 "project/nginx/src/http/ngx_http_file_cache.c"
                           ;
        }

        for (n = 0; n < 
# 104 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                       3
# 104 "project/nginx/src/http/ngx_http_file_cache.c"
                                         ; n++) {
            if (cache->path->level[n] != ocache->path->level[n]) {
                
# 106 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
               if ((
# 106 "project/nginx/src/http/ngx_http_file_cache.c"
               shm_zone->shm.log
# 106 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
               )->log_level >= 1) ngx_log_error_core(1, 
# 106 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 106 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
               , 
# 106 "project/nginx/src/http/ngx_http_file_cache.c"
               0, "cache \"%V\" had previously different levels", &shm_zone->shm.name
# 106 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
               )

                                                  
# 108 "project/nginx/src/http/ngx_http_file_cache.c"
                                                 ;
                return 
# 109 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      -1
# 109 "project/nginx/src/http/ngx_http_file_cache.c"
                               ;
            }
        }
        ...
        if (!cache->sh->cold || cache->sh->loading) {
            cache->path->loader = 
# 121 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                 ((void *)0)
# 121 "project/nginx/src/http/ngx_http_file_cache.c"
                                     ;
        }

        return 
# 124 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              0
# 124 "project/nginx/src/http/ngx_http_file_cache.c"
                    ;
    }
    ...
    if (shm_zone->shm.exists) {
        ...
        return 
# 134 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              0
# 134 "project/nginx/src/http/ngx_http_file_cache.c"
                    ;
    }

    cache->sh = ngx_slab_alloc(cache->shpool, sizeof(ngx_http_file_cache_sh_t));
    if (cache->sh == 
# 138 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                    ((void *)0)
# 138 "project/nginx/src/http/ngx_http_file_cache.c"
                        ) {
        return 
# 139 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -1
# 139 "project/nginx/src/http/ngx_http_file_cache.c"
                       ;
    }
...
# 144 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   ((
# 144 "project/nginx/src/http/ngx_http_file_cache.c"
   &cache->sh->sentinel
# 144 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   )->color = 0); (
# 144 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 147 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   (
# 147 "project/nginx/src/http/ngx_http_file_cache.c"
   &cache->sh->queue
# 147 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   )->prev = 
# 147 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 147 "project/nginx/src/http/ngx_http_file_cache.c"
   &cache->sh->queue;
    ...
    if (cache->shpool->log_ctx == 
# 162 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                 ((void *)0)
# 162 "project/nginx/src/http/ngx_http_file_cache.c"
                                     ) {
        return 
# 163 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -1
# 163 "project/nginx/src/http/ngx_http_file_cache.c"
                       ;
    }
    ...
    return 
# 171 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          0
# 171 "project/nginx/src/http/ngx_http_file_cache.c"
                ;
}
...
ngx_http_file_cache_new(ngx_http_request_t *r)
{
    ...
    if (c == 
# 181 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
            ((void *)0)
# 181 "project/nginx/src/http/ngx_http_file_cache.c"
                ) {
        return 
# 182 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -1
# 182 "project/nginx/src/http/ngx_http_file_cache.c"
                       ;
    }

    if (ngx_array_init(&c->keys, r->pool, 4, sizeof(ngx_str_t)) != 
# 185 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                                                  0
# 185 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                        ) {
        return 
# 186 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -1
# 186 "project/nginx/src/http/ngx_http_file_cache.c"
                       ;
    }
    ...
    c->file.fd = 
# 191 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                -1
# 191 "project/nginx/src/http/ngx_http_file_cache.c"
                                ;

    return 
# 193 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          0
# 193 "project/nginx/src/http/ngx_http_file_cache.c"
                ;
}
...
ngx_http_file_cache_create(ngx_http_request_t *r)
{
    ...
    if (cln == 
# 208 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              ((void *)0)
# 208 "project/nginx/src/http/ngx_http_file_cache.c"
                  ) {
        return 
# 209 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -1
# 209 "project/nginx/src/http/ngx_http_file_cache.c"
                       ;
    }
    ...
    if (ngx_http_file_cache_exists(cache, c) == 
# 215 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                               -1
# 215 "project/nginx/src/http/ngx_http_file_cache.c"
                                                        ) {
        return 
# 216 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -1
# 216 "project/nginx/src/http/ngx_http_file_cache.c"
                       ;
    }

    if (ngx_http_file_cache_name(r, cache->path) != 
# 219 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                                   0
# 219 "project/nginx/src/http/ngx_http_file_cache.c"
                                                         ) {
        return 
# 220 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -1
# 220 "project/nginx/src/http/ngx_http_file_cache.c"
                       ;
    }

    return 
# 223 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          0
# 223 "project/nginx/src/http/ngx_http_file_cache.c"
                ;
}
...
ngx_http_file_cache_create_key(ngx_http_request_t *r)
{
    ...
    c->crc32 
# 240 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   = 0xffffffff
# 240 "project/nginx/src/http/ngx_http_file_cache.c"
                           ;
    ngx_md5_init(&md5);
    ...
    c->crc32 
# 257 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   ^= 0xffffffff
# 257 "project/nginx/src/http/ngx_http_file_cache.c"
                            ;
    ngx_md5_final(c->key, &md5);

    
# 260 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   (void) __builtin___memcpy_chk (
# 260 "project/nginx/src/http/ngx_http_file_cache.c"
   c->main
# 260 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   , 
# 260 "project/nginx/src/http/ngx_http_file_cache.c"
...
ngx_http_file_cache_open(ngx_http_request_t *r)
{
    ...
    if (c->waiting) {
        return 
# 278 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -2
# 278 "project/nginx/src/http/ngx_http_file_cache.c"
                       ;
    }
    ...
    if (c->node == 
# 287 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                  ((void *)0)
# 287 "project/nginx/src/http/ngx_http_file_cache.c"
                      ) {
        cln = ngx_pool_cleanup_add(r->pool, 0);
        if (cln == 
# 289 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                  ((void *)0)
# 289 "project/nginx/src/http/ngx_http_file_cache.c"
                      ) {
            return 
# 290 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                  -1
# 290 "project/nginx/src/http/ngx_http_file_cache.c"
                           ;
        }
    ...
    if (rc == 
# 304 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             -1
# 304 "project/nginx/src/http/ngx_http_file_cache.c"
                      ) {
        return rc;
    }

    if (rc == 
# 308 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             -2
# 308 "project/nginx/src/http/ngx_http_file_cache.c"
                      ) {
        return 
# 309 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              8
# 309 "project/nginx/src/http/ngx_http_file_cache.c"
                                   ;
    }

    if (rc == 
# 312 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             0
# 312 "project/nginx/src/http/ngx_http_file_cache.c"
                   ) {
        ...
        test = c->exists ? 1 : 0;
        rv = 
# 320 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
            -5
# 320 "project/nginx/src/http/ngx_http_file_cache.c"
                        ;
        ...
        if (c->min_uses > 1) {
            ...
            if (!test) {
                return 
# 329 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      8
# 329 "project/nginx/src/http/ngx_http_file_cache.c"
                                           ;
            }

            rv = 
# 332 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                8
# 332 "project/nginx/src/http/ngx_http_file_cache.c"
                                     ;

        } else {
            c->temp_file = 1;
            rv = 
# 336 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                -5
# 336 "project/nginx/src/http/ngx_http_file_cache.c"
                            ;
        }
    }

    if (ngx_http_file_cache_name(r, cache->path) != 
# 340 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                                   0
# 340 "project/nginx/src/http/ngx_http_file_cache.c"
                                                         ) {
        return 
# 341 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -1
# 341 "project/nginx/src/http/ngx_http_file_cache.c"
                       ;
    }
    ...
    clcf = 
# 348 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          (
# 348 "project/nginx/src/http/ngx_http_file_cache.c"
          r
# 348 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          )->loc_conf[
# 348 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 350 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   (void) __builtin___memset_chk (
# 350 "project/nginx/src/http/ngx_http_file_cache.c"
   &of
# 350 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   , 0, 
# 350 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 350 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    of.directio = 
# 356 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                 9223372036854775807LL
# 356 "project/nginx/src/http/ngx_http_file_cache.c"
                                           ;
    of.read_ahead = clcf->read_ahead;

    if (ngx_open_cached_file(clcf->open_file_cache, &c->file.name, &of, r->pool)
        != 
# 360 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          0
# 360 "project/nginx/src/http/ngx_http_file_cache.c"
                )
    {
        switch (of.err) {
        ...
        case 0:
            return 
# 365 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                  -1
# 365 "project/nginx/src/http/ngx_http_file_cache.c"
                           ;

        case 
# 367 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
            2
# 367 "project/nginx/src/http/ngx_http_file_cache.c"
                      :
        case 
# 368 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
            20
# 368 "project/nginx/src/http/ngx_http_file_cache.c"
                       :
            goto done;

        default:
            
# 372 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           if ((
# 372 "project/nginx/src/http/ngx_http_file_cache.c"
           r->connection->log
# 372 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
...
# 373 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                             ;
            return 
# 374 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                  -1
# 374 "project/nginx/src/http/ngx_http_file_cache.c"
                           ;
        }
    }
    ...
    if (c->buf == 
# 388 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                 ((void *)0)
# 388 "project/nginx/src/http/ngx_http_file_cache.c"
                     ) {
        return 
# 389 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -1
# 389 "project/nginx/src/http/ngx_http_file_cache.c"
                       ;
    }
    ...
    if (rv == 
# 396 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             -5
# 396 "project/nginx/src/http/ngx_http_file_cache.c"
                         ) {
...
ngx_http_file_cache_lock(ngx_http_request_t *r, ngx_http_cache_t *c)
{
    ...
    if (!c->lock) {
        return 
# 411 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -5
# 411 "project/nginx/src/http/ngx_http_file_cache.c"
                          ;
    }
    ...
    if (c->updating) {
        return 
# 436 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -5
# 436 "project/nginx/src/http/ngx_http_file_cache.c"
                          ;
    }

    if (c->lock_timeout == 0) {
        return 
# 440 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              8
# 440 "project/nginx/src/http/ngx_http_file_cache.c"
                                   ;
    }
...
# 455 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   ngx_event_add_timer
# 455 "project/nginx/src/http/ngx_http_file_cache.c"
                (&c->wait_event, (timer > 500) ? 500 : timer);

    r->main->blocked++;

    return 
# 459 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          -2
# 459 "project/nginx/src/http/ngx_http_file_cache.c"
                   ;
}
...
# 472 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   ((ngx_http_log_ctx_t *) 
# 472 "project/nginx/src/http/ngx_http_file_cache.c"
   c->log
# 472 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
...
# 495 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       if ((
# 495 "project/nginx/src/http/ngx_http_file_cache.c"
       r->connection->log
# 495 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
...
# 495 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       , 
# 495 "project/nginx/src/http/ngx_http_file_cache.c"
       0, "cache lock timeout"
# 495 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )
                                           
# 496 "project/nginx/src/http/ngx_http_file_cache.c"
                                          ;
        c->lock_timeout = 0;
        goto wakeup;
    }
...
# 515 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       ngx_event_add_timer
# 515 "project/nginx/src/http/ngx_http_file_cache.c"
                    (&c->wait_event, (timer > 500) ? 500 : timer);
        return;
    }
...
# 546 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       if ((
# 546 "project/nginx/src/http/ngx_http_file_cache.c"
       r->connection->log
# 546 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 546 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 546 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       , 
# 546 "project/nginx/src/http/ngx_http_file_cache.c"
       0, "cache file \"%s\" is too small", c->file.name.data
# 546 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )
                                                                          
# 547 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                         ;
        return 
# 548 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -5
# 548 "project/nginx/src/http/ngx_http_file_cache.c"
                          ;
    }
    ...
    if (h->version != 
# 553 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                     5
# 553 "project/nginx/src/http/ngx_http_file_cache.c"
                                           ) {
        
# 554 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       if ((
# 554 "project/nginx/src/http/ngx_http_file_cache.c"
       r->connection->log
# 554 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->log_level >= 7) ngx_log_error_core(7, 
# 554 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 554 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       , 
# 554 "project/nginx/src/http/ngx_http_file_cache.c"
       0, "cache file \"%s\" version mismatch", c->file.name.data
# 554 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )
                                                                              
# 555 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                             ;
        return 
# 556 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -5
# 556 "project/nginx/src/http/ngx_http_file_cache.c"
                          ;
    }

    if (h->crc32 != c->crc32 || (size_t) h->header_start != c->header_start) {
        
# 560 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       if ((
# 560 "project/nginx/src/http/ngx_http_file_cache.c"
       r->connection->log
# 560 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 560 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 560 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       , 
# 560 "project/nginx/src/http/ngx_http_file_cache.c"
       0, "cache file \"%s\" has md5 collision", c->file.name.data
# 560 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )
                                                                               
# 561 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                              ;
        return 
# 562 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -5
# 562 "project/nginx/src/http/ngx_http_file_cache.c"
                          ;
    }
    ...
    for (i = 0; i < c->keys.nelts; i++) {
        if (
# 570 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           memcmp((const char *) 
# 570 "project/nginx/src/http/ngx_http_file_cache.c"
           p
# 570 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           , (const char *) 
# 570 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 571 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           if ((
# 571 "project/nginx/src/http/ngx_http_file_cache.c"
           r->connection->log
# 571 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           )->log_level >= 3) ngx_log_error_core(3, 
# 571 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 573 "project/nginx/src/http/ngx_http_file_cache.c"
                                           ;
            return 
# 574 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                  -5
# 574 "project/nginx/src/http/ngx_http_file_cache.c"
                              ;
        }
...
# 581 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       if ((
# 581 "project/nginx/src/http/ngx_http_file_cache.c"
       r->connection->log
# 581 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 581 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 581 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       , 
# 581 "project/nginx/src/http/ngx_http_file_cache.c"
       0, "cache file \"%s\" has too long header", c->file.name.data
# 581 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )

                                        
# 583 "project/nginx/src/http/ngx_http_file_cache.c"
                                       ;
        return 
# 584 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -5
# 584 "project/nginx/src/http/ngx_http_file_cache.c"
                          ;
    }

    if (h->vary_len > 
# 587 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                     128
# 587 "project/nginx/src/http/ngx_http_file_cache.c"
                                            ) {
        
# 588 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       if ((
# 588 "project/nginx/src/http/ngx_http_file_cache.c"
       r->connection->log
# 588 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 588 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 588 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       , 
# 588 "project/nginx/src/http/ngx_http_file_cache.c"
       0, "cache file \"%s\" has incorrect vary length", c->file.name.data
# 588 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )

                                        
# 590 "project/nginx/src/http/ngx_http_file_cache.c"
                                       ;
        return 
# 591 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -5
# 591 "project/nginx/src/http/ngx_http_file_cache.c"
                          ;
    }
    ...
    if (h->vary_len) {
        ...
        if (
# 597 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           memcmp((const char *) 
# 597 "project/nginx/src/http/ngx_http_file_cache.c"
           c->variant
# 597 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           , (const char *) 
# 597 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 597 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    now = 
# 637 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
         ngx_cached_time->sec
# 637 "project/nginx/src/http/ngx_http_file_cache.c"
                   ;
    ...
    if (c->valid_sec < now) {
        ...
        if (c->node->updating) {
            rc = 
# 646 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                5
# 646 "project/nginx/src/http/ngx_http_file_cache.c"
                                       ;
            ...
            c->lock_time = c->node->lock_time;
            rc = 
# 652 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                4
# 652 "project/nginx/src/http/ngx_http_file_cache.c"
                                    ;
        }
    ...
    return 
# 664 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          0
# 664 "project/nginx/src/http/ngx_http_file_cache.c"
                ;
}
...
{
# 718 "project/nginx/src/http/ngx_http_file_cache.c"
    return ngx_read_file(&c->file, c->buf->pos, c->body_start, 0);
}
# 821 "project/nginx/src/http/ngx_http_file_cache.c"
static ngx_int_t
ngx_http_file_cache_exists(ngx_http_file_cache_t *cache, ngx_http_cache_t *c)
{
    ...
    if (fcn == 
# 831 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              ((void *)0)
# 831 "project/nginx/src/http/ngx_http_file_cache.c"
                  ) {
...
# 836 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       (
# 836 "project/nginx/src/http/ngx_http_file_cache.c"
       &fcn->queue
# 836 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->next->prev = (
# 836 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 836 "project/nginx/src/http/ngx_http_file_cache.c"
        ...
        if (c->node == 
# 838 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      ((void *)0)
# 838 "project/nginx/src/http/ngx_http_file_cache.c"
                          ) {
            fcn->uses++;
            fcn->count++;
        }
        ...
        if (fcn->error) {
            ...
            if (fcn->valid_sec < 
# 845 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                ngx_cached_time->sec
# 845 "project/nginx/src/http/ngx_http_file_cache.c"
                                          ) {
                goto renew;
            }

            rc = 
# 849 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                0
# 849 "project/nginx/src/http/ngx_http_file_cache.c"
                      ;
        ...
        if (fcn->exists || fcn->uses >= c->min_uses) {
            ...
            rc = 
# 861 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                0
# 861 "project/nginx/src/http/ngx_http_file_cache.c"
                      ;
        ...
        rc = 
# 866 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
            -2
# 866 "project/nginx/src/http/ngx_http_file_cache.c"
                     ;
    ...
    if (fcn == 
# 873 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              ((void *)0)
# 873 "project/nginx/src/http/ngx_http_file_cache.c"
                  ) {
        ...
        fcn = ngx_slab_calloc_locked(cache->shpool,
                                     sizeof(ngx_http_file_cache_node_t));
        if (fcn == 
# 884 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                  ((void *)0)
# 884 "project/nginx/src/http/ngx_http_file_cache.c"
                      ) {
            
# 885 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           if ((
# 885 "project/nginx/src/http/ngx_http_file_cache.c"
           ngx_cycle->log
# 885 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
...
# 885 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           , 
# 885 "project/nginx/src/http/ngx_http_file_cache.c"
           0, "could not allocate node%s", cache->shpool->log_ctx
# 885 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           )
                                                                              
# 886 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                             ;
            rc = 
# 887 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                -1
# 887 "project/nginx/src/http/ngx_http_file_cache.c"
                         ;
            goto failed;
        }
    }
...
# 894 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   (void) __builtin___memcpy_chk (
# 894 "project/nginx/src/http/ngx_http_file_cache.c"
   (u_char *) &fcn->node.key
# 894 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   , 
# 894 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 896 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   (void) __builtin___memcpy_chk (
# 896 "project/nginx/src/http/ngx_http_file_cache.c"
   fcn->key
# 896 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   , 
# 896 "project/nginx/src/http/ngx_http_file_cache.c"
   &c->key[sizeof(ngx_rbtree_key_t)]
# 896 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   , 16 
# 896 "project/nginx/src/http/ngx_http_file_cache.c"
   - sizeof(ngx_rbtree_key_t)
...
# 897 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                ;
...
renew:
    ...
    rc = 
# 906 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
        -5
# 906 "project/nginx/src/http/ngx_http_file_cache.c"
                    ;
    ...
    fcn->expire = 
# 918 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                 ngx_cached_time->sec 
# 918 "project/nginx/src/http/ngx_http_file_cache.c"
                            + cache->inactive;

    
# 920 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   (
# 920 "project/nginx/src/http/ngx_http_file_cache.c"
   &fcn->queue
# 920 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   )->next = (
# 920 "project/nginx/src/http/ngx_http_file_cache.c"
...
ngx_http_file_cache_name(ngx_http_request_t *r, ngx_path_t *path)
{
    ...
    if (c->file.name.len) {
        return 
# 943 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              0
# 943 "project/nginx/src/http/ngx_http_file_cache.c"
                    ;
    }

    c->file.name.len = path->name.len + 1 + path->len
                       + 2 * 
# 947 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                            16
# 947 "project/nginx/src/http/ngx_http_file_cache.c"
                                                  ;

    c->file.name.data = ngx_pnalloc(r->pool, c->file.name.len + 1);
    if (c->file.name.data == 
# 950 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                            ((void *)0)
# 950 "project/nginx/src/http/ngx_http_file_cache.c"
                                ) {
        return 
# 951 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -1
# 951 "project/nginx/src/http/ngx_http_file_cache.c"
                       ;
    }

    
# 954 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   (void) __builtin___memcpy_chk (
# 954 "project/nginx/src/http/ngx_http_file_cache.c"
   c->file.name.data
# 954 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   , 
# 954 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 954 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    p = ngx_hex_dump(p, c->key, 
# 957 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                               16
# 957 "project/nginx/src/http/ngx_http_file_cache.c"
                                                     );
    *p = '\0';
    ...
    return 
# 965 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          0
# 965 "project/nginx/src/http/ngx_http_file_cache.c"
                ;
}
...
# 977 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   (void) __builtin___memcpy_chk (
# 977 "project/nginx/src/http/ngx_http_file_cache.c"
   (u_char *) &node_key
# 977 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   , 
# 977 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 977 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    while (node != sentinel) {
        ...
        rc = 
# 998 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
            memcmp((const char *) 
# 998 "project/nginx/src/http/ngx_http_file_cache.c"
            &key[sizeof(ngx_rbtree_key_t)]
# 998 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
            , (const char *) 
# 998 "project/nginx/src/http/ngx_http_file_cache.c"
            fcn->key
...
# 999 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                         ;
    ...
    return 
# 1010 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          ((void *)0)
# 1010 "project/nginx/src/http/ngx_http_file_cache.c"
              ;
}
    ...
    ngx_rbtree_node_t *node, ngx_rbtree_node_t *sentinel)
{
    ...
    for ( ;; ) {
        ...
        if (node->key < temp->key) {
            ...
            p = (
# 1036 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                memcmp((const char *) 
# 1036 "project/nginx/src/http/ngx_http_file_cache.c"
                cn->key
# 1036 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                , (const char *) 
# 1036 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1038 "project/nginx/src/http/ngx_http_file_cache.c"
                < 0)
...
# 1053 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   ((
# 1053 "project/nginx/src/http/ngx_http_file_cache.c"
   node
# 1053 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   )->color = 1)
# 1053 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    u_char *hash)
{
    ...
    ngx_md5_t md5;
    u_char buf[
# 1064 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                   128
# 1064 "project/nginx/src/http/ngx_http_file_cache.c"
                                          ];
    ...
    ngx_md5_init(&md5);
    ngx_md5_update(&md5, r->cache->main, 
# 1070 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                        16
# 1070 "project/nginx/src/http/ngx_http_file_cache.c"
                                                              );
    ...
    while (p < last) {
        ...
        ngx_md5_update(&md5, (u_char *) 
# 1099 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                       "\r\n"
# 1099 "project/nginx/src/http/ngx_http_file_cache.c"
                                           , sizeof(
# 1099 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                                    "\r\n"
# 1099 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    ngx_str_t *name)
{
    ...
    for (i = 0; ; i++) {
        ...
        if (i >= part->nelts) {
            if (part->next == 
# 1144 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                             ((void *)0)
# 1144 "project/nginx/src/http/ngx_http_file_cache.c"
                                 ) {
                break;
            }
...
# 1218 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       if ((
# 1218 "project/nginx/src/http/ngx_http_file_cache.c"
       r->connection->log
# 1218 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 1218 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1218 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       , 
# 1218 "project/nginx/src/http/ngx_http_file_cache.c"
       0, "cache file \"%s\" has incorrect vary hash", c->file.name.data
# 1218 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )

                                        
# 1220 "project/nginx/src/http/ngx_http_file_cache.c"
                                       ;
        return 
# 1221 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -5
# 1221 "project/nginx/src/http/ngx_http_file_cache.c"
                          ;
    }
    ...
    c->node->count--;
    c->node = 
# 1229 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             ((void *)0)
# 1229 "project/nginx/src/http/ngx_http_file_cache.c"
                 ;
...
# 1237 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   (void) __builtin___memcpy_chk (
# 1237 "project/nginx/src/http/ngx_http_file_cache.c"
   c->key
# 1237 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   , 
# 1237 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1258 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   (void) __builtin___memset_chk (
# 1258 "project/nginx/src/http/ngx_http_file_cache.c"
   h
# 1258 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   , 0, 
# 1258 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1258 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    h->version = 
# 1260 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                5
# 1260 "project/nginx/src/http/ngx_http_file_cache.c"
                                      ;
    ...
    if (c->etag.len <= 
# 1271 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      128
# 1271 "project/nginx/src/http/ngx_http_file_cache.c"
                                             ) {
        h->etag_len = (u_char) c->etag.len;
        
# 1273 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       (void) __builtin___memcpy_chk (
# 1273 "project/nginx/src/http/ngx_http_file_cache.c"
       h->etag
# 1273 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       , 
# 1273 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1273 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    if (c->vary.len) {
        if (c->vary.len > 
# 1277 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                         128
# 1277 "project/nginx/src/http/ngx_http_file_cache.c"
                                                ) {

            c->vary.len = 
# 1279 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                         128
# 1279 "project/nginx/src/http/ngx_http_file_cache.c"
                                                ;
        }

        h->vary_len = (u_char) c->vary.len;
        
# 1283 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       (void) __builtin___memcpy_chk (
# 1283 "project/nginx/src/http/ngx_http_file_cache.c"
       h->vary
# 1283 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       , 
# 1283 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1286 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       (void) __builtin___memcpy_chk (
# 1286 "project/nginx/src/http/ngx_http_file_cache.c"
       h->variant
# 1286 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       , 
# 1286 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1286 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    if (ngx_http_file_cache_update_variant(r, c) != 
# 1289 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                                   0
# 1289 "project/nginx/src/http/ngx_http_file_cache.c"
                                                         ) {
        return 
# 1290 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -1
# 1290 "project/nginx/src/http/ngx_http_file_cache.c"
                       ;
    }
    ...
    p = 
# 1295 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       (((u_char *) __builtin___memcpy_chk (
# 1295 "project/nginx/src/http/ngx_http_file_cache.c"
       p
# 1295 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       , 
# 1295 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1295 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    for (i = 0; i < c->keys.nelts; i++) {
        p = 
# 1299 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           (((u_char *) __builtin___memcpy_chk (
# 1299 "project/nginx/src/http/ngx_http_file_cache.c"
           p
# 1299 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           , 
# 1299 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1299 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    *p = 
# 1302 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
        (u_char) '\n'
# 1302 "project/nginx/src/http/ngx_http_file_cache.c"
          ;

    return 
# 1304 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          0
# 1304 "project/nginx/src/http/ngx_http_file_cache.c"
                ;
}
...
ngx_http_file_cache_update_variant(ngx_http_request_t *r, ngx_http_cache_t *c)
{
    ...
    if (!c->secondary) {
        return 
# 1314 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              0
# 1314 "project/nginx/src/http/ngx_http_file_cache.c"
                    ;
    }

    if (c->vary.len
        && 
# 1318 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          memcmp((const char *) 
# 1318 "project/nginx/src/http/ngx_http_file_cache.c"
          c->variant
# 1318 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          , (const char *) 
# 1318 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1318 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    {
        return 
# 1320 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              0
# 1320 "project/nginx/src/http/ngx_http_file_cache.c"
                    ;
    }
    ...
    c->node->updating = 0;
    c->node = 
# 1337 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             ((void *)0)
# 1337 "project/nginx/src/http/ngx_http_file_cache.c"
                 ;
...
# 1344 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   (void) __builtin___memcpy_chk (
# 1344 "project/nginx/src/http/ngx_http_file_cache.c"
   c->key
# 1344 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   , 
# 1344 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1344 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    if (ngx_http_file_cache_exists(cache, c) == 
# 1346 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                               -1
# 1346 "project/nginx/src/http/ngx_http_file_cache.c"
                                                        ) {
        return 
# 1347 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -1
# 1347 "project/nginx/src/http/ngx_http_file_cache.c"
                       ;
    }

    if (ngx_http_file_cache_name(r, cache->path) != 
# 1350 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                                   0
# 1350 "project/nginx/src/http/ngx_http_file_cache.c"
                                                         ) {
        return 
# 1351 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -1
# 1351 "project/nginx/src/http/ngx_http_file_cache.c"
                       ;
    }

    return 
# 1354 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          0
# 1354 "project/nginx/src/http/ngx_http_file_cache.c"
                ;
}
...
ngx_http_file_cache_update(ngx_http_request_t *r, ngx_temp_file_t *tf)
{
    ...
    ext.access = 
# 1390 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                0600
# 1390 "project/nginx/src/http/ngx_http_file_cache.c"
                                     ;
    ext.path_access = 
# 1391 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                     0600
# 1391 "project/nginx/src/http/ngx_http_file_cache.c"
                                          ;
    ext.time = -1;
    ext.create_path = 1;
    ext.delete_file = 1;
    ...
    if (rc == 
# 1399 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             0
# 1399 "project/nginx/src/http/ngx_http_file_cache.c"
                   ) {

        if (
# 1401 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           fstat(
# 1401 "project/nginx/src/http/ngx_http_file_cache.c"
           tf->file.fd
# 1401 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           , 
# 1401 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1402 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           if ((
# 1402 "project/nginx/src/http/ngx_http_file_cache.c"
           r->connection->log
# 1402 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           )->log_level >= 3) ngx_log_error_core(3, 
# 1402 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1403 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                            ;

            rc = 
# 1405 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                -1
# 1405 "project/nginx/src/http/ngx_http_file_cache.c"
                         ;

        } else {
            uniq = 
# 1408 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                  (
# 1408 "project/nginx/src/http/ngx_http_file_cache.c"
                  &fi
# 1408 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                  )->st_ino
# 1408 "project/nginx/src/http/ngx_http_file_cache.c"
                                    ;
            fs_size = (
# 1409 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      (((
# 1409 "project/nginx/src/http/ngx_http_file_cache.c"
                      &fi
# 1409 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      )->st_blocks * 512 > (
# 1409 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1409 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    if (rc == 
# 1423 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             0
# 1423 "project/nginx/src/http/ngx_http_file_cache.c"
                   ) {
        c->node->exists = 1;
    }
...
# 1448 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   (void) __builtin___memset_chk (
# 1448 "project/nginx/src/http/ngx_http_file_cache.c"
   &file
# 1448 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   , 0, 
# 1448 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1448 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    file.fd = 
# 1452 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             open((const char *) 
# 1452 "project/nginx/src/http/ngx_http_file_cache.c"
             file.name.data
# 1452 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             , 0x0002|0, 
# 1452 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1452 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    if (file.fd == 
# 1454 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                  -1
# 1454 "project/nginx/src/http/ngx_http_file_cache.c"
                                  ) {
        err = 
# 1455 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             (*__error())
# 1455 "project/nginx/src/http/ngx_http_file_cache.c"
                      ;



        if (err == 
# 1459 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                  2
# 1459 "project/nginx/src/http/ngx_http_file_cache.c"
                            ) {
...
# 1466 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       if ((
# 1466 "project/nginx/src/http/ngx_http_file_cache.c"
       r->connection->log
# 1466 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 1466 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1467 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                      ;
        return;
    }
    ...
    if (
# 1476 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       fstat(
# 1476 "project/nginx/src/http/ngx_http_file_cache.c"
       file.fd
# 1476 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       , 
# 1476 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1477 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       if ((
# 1477 "project/nginx/src/http/ngx_http_file_cache.c"
       r->connection->log
# 1477 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 1477 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1478 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                    ;
        goto done;
    }

    if (c->uniq != 
# 1482 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                  (
# 1482 "project/nginx/src/http/ngx_http_file_cache.c"
                  &fi
# 1482 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                  )->st_ino
        
# 1483 "project/nginx/src/http/ngx_http_file_cache.c"
       || c->length != 
# 1483 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                       (
# 1483 "project/nginx/src/http/ngx_http_file_cache.c"
                       &fi
# 1483 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
...
# 1483 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    if (n == 
# 1494 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
            -1
# 1494 "project/nginx/src/http/ngx_http_file_cache.c"
                     ) {
        goto done;
    }
...
# 1499 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       if ((
# 1499 "project/nginx/src/http/ngx_http_file_cache.c"
       r->connection->log
# 1499 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 1499 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1501 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                             ;
        goto done;
    }

    if (h.version != 
# 1505 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                    5
        
# 1506 "project/nginx/src/http/ngx_http_file_cache.c"
       || h.last_modified != c->last_modified
        || h.crc32 != c->crc32
...
# 1522 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   (void) __builtin___memset_chk (
# 1522 "project/nginx/src/http/ngx_http_file_cache.c"
   &h
# 1522 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   , 0, 
# 1522 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1522 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    h.version = 
# 1524 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
               5
# 1524 "project/nginx/src/http/ngx_http_file_cache.c"
                                     ;
    h.valid_sec = c->valid_sec;
    h.updating_sec = c->updating_sec;
    h.error_sec = c->error_sec;
    ...
    if (c->etag.len <= 
# 1535 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      128
# 1535 "project/nginx/src/http/ngx_http_file_cache.c"
                                             ) {
        h.etag_len = (u_char) c->etag.len;
        
# 1537 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       (void) __builtin___memcpy_chk (
# 1537 "project/nginx/src/http/ngx_http_file_cache.c"
       h.etag
# 1537 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       , 
# 1537 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1537 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    if (c->vary.len) {
        if (c->vary.len > 
# 1541 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                         128
# 1541 "project/nginx/src/http/ngx_http_file_cache.c"
                                                ) {

            c->vary.len = 
# 1543 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                         128
# 1543 "project/nginx/src/http/ngx_http_file_cache.c"
                                                ;
        }

        h.vary_len = (u_char) c->vary.len;
        
# 1547 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       (void) __builtin___memcpy_chk (
# 1547 "project/nginx/src/http/ngx_http_file_cache.c"
       h.vary
# 1547 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       , 
# 1547 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1550 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       (void) __builtin___memcpy_chk (
# 1550 "project/nginx/src/http/ngx_http_file_cache.c"
       h.variant
# 1550 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       , 
# 1550 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1550 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    if (
# 1558 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       close
# 1558 "project/nginx/src/http/ngx_http_file_cache.c"
                     (file.fd) == 
# 1558 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                  -1
# 1558 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1559 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       if ((
# 1559 "project/nginx/src/http/ngx_http_file_cache.c"
       r->connection->log
# 1559 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 1559 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1560 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                       ;
    }
}
...
ngx_http_cache_send(ngx_http_request_t *r)
{
    ...
    b = 
# 1584 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       ngx_pcalloc(
# 1584 "project/nginx/src/http/ngx_http_file_cache.c"
       r->pool
# 1584 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       , sizeof(ngx_buf_t))
# 1584 "project/nginx/src/http/ngx_http_file_cache.c"
                              ;
    if (b == 
# 1585 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
            ((void *)0)
# 1585 "project/nginx/src/http/ngx_http_file_cache.c"
                ) {
        return 
# 1586 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              500
# 1586 "project/nginx/src/http/ngx_http_file_cache.c"
                                            ;
    }

    b->file = ngx_pcalloc(r->pool, sizeof(ngx_file_t));
    if (b->file == 
# 1590 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                  ((void *)0)
# 1590 "project/nginx/src/http/ngx_http_file_cache.c"
                      ) {
        return 
# 1591 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              500
# 1591 "project/nginx/src/http/ngx_http_file_cache.c"
                                            ;
    }
    ...
    if (rc == 
# 1596 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             -1 
# 1596 "project/nginx/src/http/ngx_http_file_cache.c"
                       || rc > 
# 1596 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                               0 
# 1596 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    out.buf = b;
    out.next = 
# 1612 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              ((void *)0)
# 1612 "project/nginx/src/http/ngx_http_file_cache.c"
                  ;
...
ngx_http_file_cache_free(ngx_http_cache_t *c, ngx_temp_file_t *tf)
{
    ...
    if (c->updated || c->node == 
# 1624 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                ((void *)0)
# 1624 "project/nginx/src/http/ngx_http_file_cache.c"
                                    ) {
        return;
    }
...
# 1651 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       (
# 1651 "project/nginx/src/http/ngx_http_file_cache.c"
       &fcn->queue
# 1651 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->next->prev = (
# 1651 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1651 "project/nginx/src/http/ngx_http_file_cache.c"
        ...
        cache->sh->count--;
        c->node = 
# 1655 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                 ((void *)0)
# 1655 "project/nginx/src/http/ngx_http_file_cache.c"
                     ;
    }
    ...
    if (c->temp_file) {
        if (tf && tf->file.fd != 
# 1664 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                -1
# 1664 "project/nginx/src/http/ngx_http_file_cache.c"
                                                ) {
            ...
            if (
# 1669 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
               unlink((const char *) 
# 1669 "project/nginx/src/http/ngx_http_file_cache.c"
               tf->file.name.data
# 1669 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
               ) 
# 1669 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1670 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
               if ((
# 1670 "project/nginx/src/http/ngx_http_file_cache.c"
               c->file.log
# 1670 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
               )->log_level >= 3) ngx_log_error_core(3, 
# 1670 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1672 "project/nginx/src/http/ngx_http_file_cache.c"
                                                ;
            }
        }
    }
...
# 1678 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       ngx_event_del_timer
# 1678 "project/nginx/src/http/ngx_http_file_cache.c"
                    (&c->wait_event);
    }
}
...
# 1696 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       if ((
# 1696 "project/nginx/src/http/ngx_http_file_cache.c"
       c->file.log
# 1696 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 1696 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1696 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       , 
# 1696 "project/nginx/src/http/ngx_http_file_cache.c"
       0, "stalled cache updating, error:%ui", c->error
# 1696 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )
                                                                    
# 1697 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                   ;
    }

    ngx_http_file_cache_free(c, 
# 1700 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                               ((void *)0)
# 1700 "project/nginx/src/http/ngx_http_file_cache.c"
                                   );
}
...
ngx_http_file_cache_forced_expire(ngx_http_file_cache_t *cache)
{
    ...
    ngx_http_file_cache_node_t *fcn;
    u_char key[2 * 
# 1714 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                        16
# 1714 "project/nginx/src/http/ngx_http_file_cache.c"
                                                              ];
    ...
    path = cache->path;
    len = path->name.len + 1 + path->len + 2 * 
# 1720 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                              16
# 1720 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                    ;

    name = ngx_alloc(len + 1, ngx_cycle->log);
    if (name == 
# 1723 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
               ((void *)0)
# 1723 "project/nginx/src/http/ngx_http_file_cache.c"
                   ) {
        return 10;
    }

    
# 1727 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   (void) __builtin___memcpy_chk (
# 1727 "project/nginx/src/http/ngx_http_file_cache.c"
   name
# 1727 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   , 
# 1727 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1727 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    tries = 20;
    sentinel = 
# 1731 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              ((void *)0)
# 1731 "project/nginx/src/http/ngx_http_file_cache.c"
                  ;
    ...
    for ( ;; ) {
        if (
# 1736 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           (
# 1736 "project/nginx/src/http/ngx_http_file_cache.c"
           &cache->sh->queue 
# 1736 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           == (
# 1736 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1736 "project/nginx/src/http/ngx_http_file_cache.c"
        ...
        q = 
# 1740 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           (
# 1740 "project/nginx/src/http/ngx_http_file_cache.c"
           &cache->sh->queue
# 1740 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           )->prev
# 1740 "project/nginx/src/http/ngx_http_file_cache.c"
        ...
        fcn = 
# 1746 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             (
# 1746 "project/nginx/src/http/ngx_http_file_cache.c"
             ngx_http_file_cache_node_t 
# 1746 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             *) ((u_char *) 
# 1746 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1746 "project/nginx/src/http/ngx_http_file_cache.c"
        ...
        p = ngx_hex_dump(key, (u_char *) &fcn->node.key,
                         sizeof(ngx_rbtree_key_t));
        len = 
# 1761 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             16 
# 1761 "project/nginx/src/http/ngx_http_file_cache.c"
                                    - sizeof(ngx_rbtree_key_t);
...
# 1770 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       (
# 1770 "project/nginx/src/http/ngx_http_file_cache.c"
       q
# 1770 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->next->prev = (
# 1770 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1770 "project/nginx/src/http/ngx_http_file_cache.c"
                          ;
        fcn->expire = 
# 1771 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                     ngx_cached_time->sec 
# 1771 "project/nginx/src/http/ngx_http_file_cache.c"
                                + cache->inactive;
        
# 1772 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       (
# 1772 "project/nginx/src/http/ngx_http_file_cache.c"
       &fcn->queue
# 1772 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->next = (
# 1772 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1774 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       if ((
# 1774 "project/nginx/src/http/ngx_http_file_cache.c"
       ngx_cycle->log
# 1774 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 1774 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1774 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       , 
# 1774 "project/nginx/src/http/ngx_http_file_cache.c"
       0, "ignore long locked inactive cache entry %*s, count:%d", (size_t) 2 * 
# 1774 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       16
# 1774 "project/nginx/src/http/ngx_http_file_cache.c"
       , key, fcn->count
...
# 1776 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                          ;

        if (sentinel == 
# 1778 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                       ((void *)0)
# 1778 "project/nginx/src/http/ngx_http_file_cache.c"
                           ) {
            sentinel = q;
        }
...
# 1792 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   free
# 1792 "project/nginx/src/http/ngx_http_file_cache.c"
           (name);
...
ngx_http_file_cache_expire(ngx_http_file_cache_t *cache)
{
    ...
    ngx_http_file_cache_node_t *fcn;
    u_char key[2 * 
# 1808 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                        16
# 1808 "project/nginx/src/http/ngx_http_file_cache.c"
                                                              ];
    ...
    path = cache->path;
    len = path->name.len + 1 + path->len + 2 * 
# 1814 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                              16
# 1814 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                    ;

    name = ngx_alloc(len + 1, ngx_cycle->log);
    if (name == 
# 1817 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
               ((void *)0)
# 1817 "project/nginx/src/http/ngx_http_file_cache.c"
                   ) {
        return 10;
    }

    
# 1821 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   (void) __builtin___memcpy_chk (
# 1821 "project/nginx/src/http/ngx_http_file_cache.c"
   name
# 1821 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   , 
# 1821 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1821 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    now = 
# 1823 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
         ngx_cached_time->sec
# 1823 "project/nginx/src/http/ngx_http_file_cache.c"
                   ;
    ...
    for ( ;; ) {
        ...
        if (
# 1834 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           (
# 1834 "project/nginx/src/http/ngx_http_file_cache.c"
           &cache->sh->queue 
# 1834 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           == (
# 1834 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1834 "project/nginx/src/http/ngx_http_file_cache.c"
        ...
        q = 
# 1839 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           (
# 1839 "project/nginx/src/http/ngx_http_file_cache.c"
           &cache->sh->queue
# 1839 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           )->prev
# 1839 "project/nginx/src/http/ngx_http_file_cache.c"
        ...
        fcn = 
# 1841 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             (
# 1841 "project/nginx/src/http/ngx_http_file_cache.c"
             ngx_http_file_cache_node_t 
# 1841 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             *) ((u_char *) 
# 1841 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1841 "project/nginx/src/http/ngx_http_file_cache.c"
        ...
        p = ngx_hex_dump(key, (u_char *) &fcn->node.key,
                         sizeof(ngx_rbtree_key_t));
        len = 
# 1867 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             16 
# 1867 "project/nginx/src/http/ngx_http_file_cache.c"
                                    - sizeof(ngx_rbtree_key_t);
        (void) ngx_hex_dump(p, fcn->key, len);
...
# 1876 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       (
# 1876 "project/nginx/src/http/ngx_http_file_cache.c"
       q
# 1876 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->next->prev = (
# 1876 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1876 "project/nginx/src/http/ngx_http_file_cache.c"
                          ;
        fcn->expire = 
# 1877 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                     ngx_cached_time->sec 
# 1877 "project/nginx/src/http/ngx_http_file_cache.c"
                                + cache->inactive;
        
# 1878 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       (
# 1878 "project/nginx/src/http/ngx_http_file_cache.c"
       &fcn->queue
# 1878 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->next = (
# 1878 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1880 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       if ((
# 1880 "project/nginx/src/http/ngx_http_file_cache.c"
       ngx_cycle->log
# 1880 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->log_level >= 2) ngx_log_error_core(2, 
# 1880 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1882 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                          ;
...
next:
        ...
        elapsed = 
# 1893 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                 (((
# 1893 "project/nginx/src/http/ngx_http_file_cache.c"
                 (ngx_msec_int_t) (ngx_current_msec - cache->last)
# 1893 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                 ) >= 0) ? (
# 1893 "project/nginx/src/http/ngx_http_file_cache.c"
                 (ngx_msec_int_t) (ngx_current_msec - cache->last)
...
# 1903 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   free
# 1903 "project/nginx/src/http/ngx_http_file_cache.c"
           (name);
    ...
    u_char *name)
{
    ...
    fcn = 
# 1918 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
         (
# 1918 "project/nginx/src/http/ngx_http_file_cache.c"
         ngx_http_file_cache_node_t 
# 1918 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
         *) ((u_char *) 
# 1918 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1918 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    if (fcn->exists) {
        ...
        p = ngx_hex_dump(p, (u_char *) &fcn->node.key,
                         sizeof(ngx_rbtree_key_t));
        len = 
# 1927 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             16 
# 1927 "project/nginx/src/http/ngx_http_file_cache.c"
                                    - sizeof(ngx_rbtree_key_t);
        ...
        *p = '\0';
        ...
        len = path->name.len + 1 + path->len + 2 * 
# 1935 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                                  16
# 1935 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                        ;
        ...
        if (
# 1941 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           unlink((const char *) 
# 1941 "project/nginx/src/http/ngx_http_file_cache.c"
           name
# 1941 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           ) 
# 1941 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1942 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           if ((
# 1942 "project/nginx/src/http/ngx_http_file_cache.c"
           ngx_cycle->log
# 1942 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           )->log_level >= 3) ngx_log_error_core(3, 
# 1942 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 1943 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                  ;
        }
...
# 1952 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       (
# 1952 "project/nginx/src/http/ngx_http_file_cache.c"
       q
# 1952 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->next->prev = (
# 1952 "project/nginx/src/http/ngx_http_file_cache.c"
...
ngx_http_file_cache_manager(void *data)
{
    ...
    for ( ;; ) {
        ...
        elapsed = 
# 2027 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                 (((
# 2027 "project/nginx/src/http/ngx_http_file_cache.c"
                 (ngx_msec_int_t) (ngx_current_msec - cache->last)
# 2027 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                 ) >= 0) ? (
# 2027 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2027 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    elapsed = 
# 2037 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             (((
# 2037 "project/nginx/src/http/ngx_http_file_cache.c"
             (ngx_msec_int_t) (ngx_current_msec - cache->last)
# 2037 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             ) >= 0) ? (
# 2037 "project/nginx/src/http/ngx_http_file_cache.c"
...
ngx_http_file_cache_loader(void *data)
{
    ...
    if (!
# 2058 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
        __sync_bool_compare_and_swap(
# 2058 "project/nginx/src/http/ngx_http_file_cache.c"
        &cache->sh->loading
# 2058 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
        , 
# 2058 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2058 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    tree.init_handler = 
# 2065 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                       ((void *)0)
# 2065 "project/nginx/src/http/ngx_http_file_cache.c"
                           ;
    ...
    if (ngx_walk_tree(&tree, &cache->path->name) == 
# 2077 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                                   -6
# 2077 "project/nginx/src/http/ngx_http_file_cache.c"
                                                            ) {
        cache->sh->loading = 0;
        return;
    }
...
# 2085 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   if ((
# 2085 "project/nginx/src/http/ngx_http_file_cache.c"
   ngx_cycle->log
# 2085 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
...
# 2085 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   , 
# 2085 "project/nginx/src/http/ngx_http_file_cache.c"
   0, "http file cache: %V %.3fM, bsize: %uz", &cache->path->name, ((double) cache->sh->size * cache->bsize) / (1024 * 1024), cache->bsize
# 2085 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   )
...
# 2089 "project/nginx/src/http/ngx_http_file_cache.c"
                              ;
}
...
{
    return 
# 2096 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          0
# 2096 "project/nginx/src/http/ngx_http_file_cache.c"
                ;
}
...
ngx_http_file_cache_manage_file(ngx_tree_ctx_t *ctx, ngx_str_t *path)
{
    ...
    if (ngx_http_file_cache_add_file(ctx, path) != 
# 2108 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                                  0
# 2108 "project/nginx/src/http/ngx_http_file_cache.c"
                                                        ) {
    ...
    if (++cache->files >= cache->loader_files) {
        ...
        elapsed = 
# 2118 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                 (((
# 2118 "project/nginx/src/http/ngx_http_file_cache.c"
                 (ngx_msec_int_t) (ngx_current_msec - cache->last)
# 2118 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                 ) >= 0) ? (
# 2118 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2118 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    return (ngx_quit || ngx_terminate) ? 
# 2128 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                        -6 
# 2128 "project/nginx/src/http/ngx_http_file_cache.c"
                                                  : 
# 2128 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                                    0
# 2128 "project/nginx/src/http/ngx_http_file_cache.c"
...
ngx_http_file_cache_manage_directory(ngx_tree_ctx_t *ctx, ngx_str_t *path)
{
    if (path->len >= 5
        && 
# 2136 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          strncmp((const char *) 
# 2136 "project/nginx/src/http/ngx_http_file_cache.c"
          path->data + path->len - 5
# 2136 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          , (const char *) 
# 2136 "project/nginx/src/http/ngx_http_file_cache.c"
          "/temp"
...
# 2136 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    {
        return 
# 2138 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -5
# 2138 "project/nginx/src/http/ngx_http_file_cache.c"
                          ;
    }

    return 
# 2141 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          0
# 2141 "project/nginx/src/http/ngx_http_file_cache.c"
                ;
}
...
# 2148 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   (void) usleep(
# 2148 "project/nginx/src/http/ngx_http_file_cache.c"
   cache->loader_sleep 
# 2148 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   * 1000)
# 2148 "project/nginx/src/http/ngx_http_file_cache.c"
...
ngx_http_file_cache_add_file(ngx_tree_ctx_t *ctx, ngx_str_t *name)
{
    ...
    if (name->len < 2 * 
# 2166 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                       16
# 2166 "project/nginx/src/http/ngx_http_file_cache.c"
                                             ) {
        return 
# 2167 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -1
# 2167 "project/nginx/src/http/ngx_http_file_cache.c"
                       ;
    }
    ...
    if (name->len >= 2 * 
# 2175 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                        16 
# 2175 "project/nginx/src/http/ngx_http_file_cache.c"
                                               + 1 + 10
        && name->data[name->len - 10 - 1] == '.')
    {
        return 
# 2178 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              0
# 2178 "project/nginx/src/http/ngx_http_file_cache.c"
                    ;
    }

    if (ctx->size < (off_t) sizeof(ngx_http_file_cache_header_t)) {
        
# 2182 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       if ((
# 2182 "project/nginx/src/http/ngx_http_file_cache.c"
       ctx->log
# 2182 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 2182 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2182 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       , 
# 2182 "project/nginx/src/http/ngx_http_file_cache.c"
       0, "cache file \"%s\" is too small", name->data
# 2182 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )
                                                                   
# 2183 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                  ;
        return 
# 2184 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              -1
# 2184 "project/nginx/src/http/ngx_http_file_cache.c"
                       ;
    }

    
# 2187 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   (void) __builtin___memset_chk (
# 2187 "project/nginx/src/http/ngx_http_file_cache.c"
   &c
# 2187 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   , 0, 
# 2187 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2187 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    p = &name->data[name->len - 2 * 
# 2193 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                   16
# 2193 "project/nginx/src/http/ngx_http_file_cache.c"
                                                         ];

    for (i = 0; i < 
# 2195 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                   16
# 2195 "project/nginx/src/http/ngx_http_file_cache.c"
                                         ; i++) {
        n = ngx_hextoi(p, 2);

        if (n == 
# 2198 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                -1
# 2198 "project/nginx/src/http/ngx_http_file_cache.c"
                         ) {
            return 
# 2199 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                  -1
# 2199 "project/nginx/src/http/ngx_http_file_cache.c"
                           ;
        }
...
ngx_http_file_cache_add(ngx_http_file_cache_t *cache, ngx_http_cache_t *c)
{
    ...
    if (fcn == 
# 2220 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              ((void *)0)
# 2220 "project/nginx/src/http/ngx_http_file_cache.c"
                  ) {

        fcn = ngx_slab_calloc_locked(cache->shpool,
                                     sizeof(ngx_http_file_cache_node_t));
        if (fcn == 
# 2224 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                  ((void *)0)
# 2224 "project/nginx/src/http/ngx_http_file_cache.c"
                      ) {
            ngx_http_file_cache_set_watermark(cache);

            if (cache->fail_time != 
# 2227 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                   ngx_cached_time->sec
# 2227 "project/nginx/src/http/ngx_http_file_cache.c"
                                             ) {
                cache->fail_time = 
# 2228 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                  ngx_cached_time->sec
# 2228 "project/nginx/src/http/ngx_http_file_cache.c"
                                            ;
                
# 2229 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
               if ((
# 2229 "project/nginx/src/http/ngx_http_file_cache.c"
               ngx_cycle->log
# 2229 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
               )->log_level >= 2) ngx_log_error_core(2, 
# 2229 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2230 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                              ;
            }

            ngx_shmtx_unlock(&cache->shpool->mutex);
            return 
# 2234 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                  -1
# 2234 "project/nginx/src/http/ngx_http_file_cache.c"
                           ;
        }
...
# 2239 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       (void) __builtin___memcpy_chk (
# 2239 "project/nginx/src/http/ngx_http_file_cache.c"
       (u_char *) &fcn->node.key
# 2239 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       , 
# 2239 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2241 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       (void) __builtin___memcpy_chk (
# 2241 "project/nginx/src/http/ngx_http_file_cache.c"
       fcn->key
# 2241 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       , 
# 2241 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2242 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                    ;
...
# 2253 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       (
# 2253 "project/nginx/src/http/ngx_http_file_cache.c"
       &fcn->queue
# 2253 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->next->prev = (
# 2253 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2253 "project/nginx/src/http/ngx_http_file_cache.c"
    ...
    fcn->expire = 
# 2256 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                 ngx_cached_time->sec 
# 2256 "project/nginx/src/http/ngx_http_file_cache.c"
                            + cache->inactive;

    
# 2258 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   (
# 2258 "project/nginx/src/http/ngx_http_file_cache.c"
   &fcn->queue
# 2258 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
   )->next = (
# 2258 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2258 "project/nginx/src/http/ngx_http_file_cache.c"
   &fcn->queue;
    ...
    return 
# 2262 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          0
# 2262 "project/nginx/src/http/ngx_http_file_cache.c"
                ;
}
...
ngx_http_file_cache_delete_file(ngx_tree_ctx_t *ctx, ngx_str_t *path)
{
    ...
    if (
# 2272 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       unlink((const char *) 
# 2272 "project/nginx/src/http/ngx_http_file_cache.c"
       path->data
# 2272 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       ) 
# 2272 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2273 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       if ((
# 2273 "project/nginx/src/http/ngx_http_file_cache.c"
       ctx->log
# 2273 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
       )->log_level >= 3) ngx_log_error_core(3, 
# 2273 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2274 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                    ;
    }

    return 
# 2277 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          0
# 2277 "project/nginx/src/http/ngx_http_file_cache.c"
                ;
}
...
ngx_http_file_cache_valid(ngx_array_t *cache_valid, ngx_uint_t status)
{
    ...
    if (cache_valid == 
# 2297 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      ((void *)0)
# 2297 "project/nginx/src/http/ngx_http_file_cache.c"
                          ) {
        return 0;
    }
...
ngx_http_file_cache_set_slot(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (cache == 
# 2335 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                ((void *)0)
# 2335 "project/nginx/src/http/ngx_http_file_cache.c"
                    ) {
        return 
# 2336 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              (void *) -1
# 2336 "project/nginx/src/http/ngx_http_file_cache.c"
                            ;
    }

    cache->path = ngx_pcalloc(cf->pool, sizeof(ngx_path_t));
    if (cache->path == 
# 2340 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      ((void *)0)
# 2340 "project/nginx/src/http/ngx_http_file_cache.c"
                          ) {
        return 
# 2341 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              (void *) -1
# 2341 "project/nginx/src/http/ngx_http_file_cache.c"
                            ;
    }
    ...
    size = 0;
    max_size = 
# 2358 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              9223372036854775807LL
# 2358 "project/nginx/src/http/ngx_http_file_cache.c"
                                 ;
    min_free = 0;
    ...
    if (ngx_conf_full_name(cf->cycle, &cache->path->name, 0) != 
# 2369 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                                               0
# 2369 "project/nginx/src/http/ngx_http_file_cache.c"
                                                                     ) {
        return 
# 2370 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              (void *) -1
# 2370 "project/nginx/src/http/ngx_http_file_cache.c"
                            ;
    }
    ...
    for (i = 2; i < cf->args->nelts; i++) {
        ...
        if (
# 2375 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           strncmp((const char *) 
# 2375 "project/nginx/src/http/ngx_http_file_cache.c"
           value[i].data
# 2375 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           , (const char *) 
# 2375 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2375 "project/nginx/src/http/ngx_http_file_cache.c"
            ...
            for (n = 0; n < 
# 2380 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                           3 
# 2380 "project/nginx/src/http/ngx_http_file_cache.c"
                                              && p < last; n++) {
                ...
                if (*p > '0' && *p < '3') {
                    ...
                    if (*p++ == ':' && n < 
# 2391 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                          3 
# 2391 "project/nginx/src/http/ngx_http_file_cache.c"
                                                             - 1 && p < last) {
                        continue;
                    }
            ...
            if (cache->path->len < 10 + 
# 2401 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                       3
# 2401 "project/nginx/src/http/ngx_http_file_cache.c"
                                                         ) {
                continue;
            }
        ...
        invalid_levels:
            ...
            ngx_conf_log_error(
# 2407 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                              1
# 2407 "project/nginx/src/http/ngx_http_file_cache.c"
                                           , cf, 0,
                               "invalid \"levels\" \"%V\"", &value[i]);
            return 
# 2409 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                  (void *) -1
# 2409 "project/nginx/src/http/ngx_http_file_cache.c"
                                ;
        }

        if (
# 2412 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           strncmp((const char *) 
# 2412 "project/nginx/src/http/ngx_http_file_cache.c"
           value[i].data
# 2412 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           , (const char *) 
# 2412 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2412 "project/nginx/src/http/ngx_http_file_cache.c"
            ...
            if (
# 2414 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
               strcmp((const char *) 
# 2414 "project/nginx/src/http/ngx_http_file_cache.c"
               &value[i].data[14]
# 2414 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
               , (const char *) 
# 2414 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2417 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      strcmp((const char *) 
# 2417 "project/nginx/src/http/ngx_http_file_cache.c"
                      &value[i].data[14]
# 2417 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      , (const char *) 
# 2417 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2417 "project/nginx/src/http/ngx_http_file_cache.c"
                ...
                ngx_conf_log_error(
# 2421 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                  1
# 2421 "project/nginx/src/http/ngx_http_file_cache.c"
                                               , cf, 0,
                                   "invalid use_temp_path value \"%V\", "
                                   "it must be \"on\" or \"off\"",
                                   &value[i]);
                return 
# 2425 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      (void *) -1
# 2425 "project/nginx/src/http/ngx_http_file_cache.c"
                                    ;
            }
        ...
        if (
# 2431 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           strncmp((const char *) 
# 2431 "project/nginx/src/http/ngx_http_file_cache.c"
           value[i].data
# 2431 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           , (const char *) 
# 2431 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2431 "project/nginx/src/http/ngx_http_file_cache.c"
            ...
            p = (u_char *) 
# 2435 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                          strchr((const char *) 
# 2435 "project/nginx/src/http/ngx_http_file_cache.c"
                          name.data
# 2435 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                          , (int) 
# 2435 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2435 "project/nginx/src/http/ngx_http_file_cache.c"
            ...
            if (p == 
# 2437 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                    ((void *)0)
# 2437 "project/nginx/src/http/ngx_http_file_cache.c"
                        ) {
                ngx_conf_log_error(
# 2438 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                  1
# 2438 "project/nginx/src/http/ngx_http_file_cache.c"
                                               , cf, 0,
                                   "invalid keys zone size \"%V\"", &value[i]);
                return 
# 2440 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      (void *) -1
# 2440 "project/nginx/src/http/ngx_http_file_cache.c"
                                    ;
            }
            ...
            if (size == 
# 2450 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                       -1
# 2450 "project/nginx/src/http/ngx_http_file_cache.c"
                                ) {
                ngx_conf_log_error(
# 2451 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                  1
# 2451 "project/nginx/src/http/ngx_http_file_cache.c"
                                               , cf, 0,
                                   "invalid keys zone size \"%V\"", &value[i]);
                return 
# 2453 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      (void *) -1
# 2453 "project/nginx/src/http/ngx_http_file_cache.c"
                                    ;
            }

            if (size < (ssize_t) (2 * ngx_pagesize)) {
                ngx_conf_log_error(
# 2457 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                  1
# 2457 "project/nginx/src/http/ngx_http_file_cache.c"
                                               , cf, 0,
                                   "keys zone \"%V\" is too small", &value[i]);
                return 
# 2459 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      (void *) -1
# 2459 "project/nginx/src/http/ngx_http_file_cache.c"
                                    ;
            }
        ...
        if (
# 2465 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           strncmp((const char *) 
# 2465 "project/nginx/src/http/ngx_http_file_cache.c"
           value[i].data
# 2465 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           , (const char *) 
# 2465 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2465 "project/nginx/src/http/ngx_http_file_cache.c"
            ...
            if (inactive == (time_t) 
# 2471 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                    -1
# 2471 "project/nginx/src/http/ngx_http_file_cache.c"
                                             ) {
                ngx_conf_log_error(
# 2472 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                  1
# 2472 "project/nginx/src/http/ngx_http_file_cache.c"
                                               , cf, 0,
                                   "invalid inactive value \"%V\"", &value[i]);
                return 
# 2474 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      (void *) -1
# 2474 "project/nginx/src/http/ngx_http_file_cache.c"
                                    ;
            }
        ...
        if (
# 2480 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           strncmp((const char *) 
# 2480 "project/nginx/src/http/ngx_http_file_cache.c"
           value[i].data
# 2480 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           , (const char *) 
# 2480 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2480 "project/nginx/src/http/ngx_http_file_cache.c"
            ...
            if (max_size < 0) {
                ngx_conf_log_error(
# 2487 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                  1
# 2487 "project/nginx/src/http/ngx_http_file_cache.c"
                                               , cf, 0,
                                   "invalid max_size value \"%V\"", &value[i]);
                return 
# 2489 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      (void *) -1
# 2489 "project/nginx/src/http/ngx_http_file_cache.c"
                                    ;
            }
        ...
        if (
# 2495 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           strncmp((const char *) 
# 2495 "project/nginx/src/http/ngx_http_file_cache.c"
           value[i].data
# 2495 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           , (const char *) 
# 2495 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2495 "project/nginx/src/http/ngx_http_file_cache.c"
            ...
            if (min_free < 0) {
                ngx_conf_log_error(
# 2504 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                  1
# 2504 "project/nginx/src/http/ngx_http_file_cache.c"
                                               , cf, 0,
                                   "invalid min_free value \"%V\"", &value[i]);
                return 
# 2506 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      (void *) -1
# 2506 "project/nginx/src/http/ngx_http_file_cache.c"
                                    ;
            }
        ...
        if (
# 2518 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           strncmp((const char *) 
# 2518 "project/nginx/src/http/ngx_http_file_cache.c"
           value[i].data
# 2518 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           , (const char *) 
# 2518 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2518 "project/nginx/src/http/ngx_http_file_cache.c"
            ...
            if (loader_files == 
# 2521 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                               -1
# 2521 "project/nginx/src/http/ngx_http_file_cache.c"
                                        ) {
                ngx_conf_log_error(
# 2522 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                  1
# 2522 "project/nginx/src/http/ngx_http_file_cache.c"
                                               , cf, 0,
                           "invalid loader_files value \"%V\"", &value[i]);
                return 
# 2524 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      (void *) -1
# 2524 "project/nginx/src/http/ngx_http_file_cache.c"
                                    ;
            }
        ...
        if (
# 2530 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           strncmp((const char *) 
# 2530 "project/nginx/src/http/ngx_http_file_cache.c"
           value[i].data
# 2530 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           , (const char *) 
# 2530 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2530 "project/nginx/src/http/ngx_http_file_cache.c"
            ...
            if (loader_sleep == (ngx_msec_t) 
# 2536 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                            -1
# 2536 "project/nginx/src/http/ngx_http_file_cache.c"
                                                     ) {
                ngx_conf_log_error(
# 2537 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                  1
# 2537 "project/nginx/src/http/ngx_http_file_cache.c"
                                               , cf, 0,
                           "invalid loader_sleep value \"%V\"", &value[i]);
                return 
# 2539 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      (void *) -1
# 2539 "project/nginx/src/http/ngx_http_file_cache.c"
                                    ;
            }
        ...
        if (
# 2545 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           strncmp((const char *) 
# 2545 "project/nginx/src/http/ngx_http_file_cache.c"
           value[i].data
# 2545 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           , (const char *) 
# 2545 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2545 "project/nginx/src/http/ngx_http_file_cache.c"
            ...
            if (loader_threshold == (ngx_msec_t) 
# 2551 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                                -1
# 2551 "project/nginx/src/http/ngx_http_file_cache.c"
                                                         ) {
                ngx_conf_log_error(
# 2552 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                  1
# 2552 "project/nginx/src/http/ngx_http_file_cache.c"
                                               , cf, 0,
                           "invalid loader_threshold value \"%V\"", &value[i]);
                return 
# 2554 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      (void *) -1
# 2554 "project/nginx/src/http/ngx_http_file_cache.c"
                                    ;
            }
        ...
        if (
# 2560 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           strncmp((const char *) 
# 2560 "project/nginx/src/http/ngx_http_file_cache.c"
           value[i].data
# 2560 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           , (const char *) 
# 2560 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2560 "project/nginx/src/http/ngx_http_file_cache.c"
            ...
            if (manager_files == 
# 2563 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                -1
# 2563 "project/nginx/src/http/ngx_http_file_cache.c"
                                         ) {
                ngx_conf_log_error(
# 2564 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                  1
# 2564 "project/nginx/src/http/ngx_http_file_cache.c"
                                               , cf, 0,
                           "invalid manager_files value \"%V\"", &value[i]);
                return 
# 2566 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      (void *) -1
# 2566 "project/nginx/src/http/ngx_http_file_cache.c"
                                    ;
            }
        ...
        if (
# 2572 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           strncmp((const char *) 
# 2572 "project/nginx/src/http/ngx_http_file_cache.c"
           value[i].data
# 2572 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           , (const char *) 
# 2572 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2572 "project/nginx/src/http/ngx_http_file_cache.c"
            ...
            if (manager_sleep == (ngx_msec_t) 
# 2578 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                             -1
# 2578 "project/nginx/src/http/ngx_http_file_cache.c"
                                                      ) {
                ngx_conf_log_error(
# 2579 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                  1
# 2579 "project/nginx/src/http/ngx_http_file_cache.c"
                                               , cf, 0,
                           "invalid manager_sleep value \"%V\"", &value[i]);
                return 
# 2581 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      (void *) -1
# 2581 "project/nginx/src/http/ngx_http_file_cache.c"
                                    ;
            }
        ...
        if (
# 2587 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           strncmp((const char *) 
# 2587 "project/nginx/src/http/ngx_http_file_cache.c"
           value[i].data
# 2587 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           , (const char *) 
# 2587 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2587 "project/nginx/src/http/ngx_http_file_cache.c"
            ...
            if (manager_threshold == (ngx_msec_t) 
# 2593 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                                 -1
# 2593 "project/nginx/src/http/ngx_http_file_cache.c"
                                                          ) {
                ngx_conf_log_error(
# 2594 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                  1
# 2594 "project/nginx/src/http/ngx_http_file_cache.c"
                                               , cf, 0,
                           "invalid manager_threshold value \"%V\"", &value[i]);
                return 
# 2596 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      (void *) -1
# 2596 "project/nginx/src/http/ngx_http_file_cache.c"
                                    ;
            }
        ...
        ngx_conf_log_error(
# 2602 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                          1
# 2602 "project/nginx/src/http/ngx_http_file_cache.c"
                                       , cf, 0,
                           "invalid parameter \"%V\"", &value[i]);
        return 
# 2604 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              (void *) -1
# 2604 "project/nginx/src/http/ngx_http_file_cache.c"
                            ;
    }

    if (name.len == 0 || size == 0) {
        ngx_conf_log_error(
# 2608 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                          1
# 2608 "project/nginx/src/http/ngx_http_file_cache.c"
                                       , cf, 0,
                           "\"%V\" must have \"keys_zone\" parameter",
                           &cmd->name);
        return 
# 2611 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              (void *) -1
# 2611 "project/nginx/src/http/ngx_http_file_cache.c"
                            ;
    }
    ...
    if (ngx_add_path(cf, &cache->path) != 
# 2626 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                         0
# 2626 "project/nginx/src/http/ngx_http_file_cache.c"
                                               ) {
        return 
# 2627 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              (void *) -1
# 2627 "project/nginx/src/http/ngx_http_file_cache.c"
                            ;
    }

    cache->shm_zone = ngx_shared_memory_add(cf, &name, size, cmd->post);
    if (cache->shm_zone == 
# 2631 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                          ((void *)0)
# 2631 "project/nginx/src/http/ngx_http_file_cache.c"
                              ) {
        return 
# 2632 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              (void *) -1
# 2632 "project/nginx/src/http/ngx_http_file_cache.c"
                            ;
    }

    if (cache->shm_zone->data) {
        ngx_conf_log_error(
# 2636 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                          1
# 2636 "project/nginx/src/http/ngx_http_file_cache.c"
                                       , cf, 0,
                           "duplicate zone \"%V\"", &name);
        return 
# 2638 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              (void *) -1
# 2638 "project/nginx/src/http/ngx_http_file_cache.c"
                            ;
    }
    ...
    if (ce == 
# 2654 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             ((void *)0)
# 2654 "project/nginx/src/http/ngx_http_file_cache.c"
                 ) {
        return 
# 2655 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              (void *) -1
# 2655 "project/nginx/src/http/ngx_http_file_cache.c"
                            ;
    }
    ...
    *ce = cache;
    ...
    return 
# 2660 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          ((void *)0)
# 2660 "project/nginx/src/http/ngx_http_file_cache.c"
                     ;
}
    ...
    void *conf)
{
    ...
    if (*a == 
# 2680 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
             (void *) -1
# 2680 "project/nginx/src/http/ngx_http_file_cache.c"
                               ) {
        *a = ngx_array_create(cf->pool, 1, sizeof(ngx_http_cache_valid_t));
        if (*a == 
# 2682 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                 ((void *)0)
# 2682 "project/nginx/src/http/ngx_http_file_cache.c"
                     ) {
            return 
# 2683 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                  (void *) -1
# 2683 "project/nginx/src/http/ngx_http_file_cache.c"
                                ;
        }
    }
    ...
    if (valid == (time_t) 
# 2691 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                         -1
# 2691 "project/nginx/src/http/ngx_http_file_cache.c"
                                  ) {
        ngx_conf_log_error(
# 2692 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                          1
# 2692 "project/nginx/src/http/ngx_http_file_cache.c"
                                       , cf, 0,
                           "invalid time value \"%V\"", &value[n]);
        return 
# 2694 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              (void *) -1
# 2694 "project/nginx/src/http/ngx_http_file_cache.c"
                            ;
    }
    ...
    if (n == 1) {
        ...
        for (i = 0; i < 3; i++) {
            v = ngx_array_push(*a);
            if (v == 
# 2701 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                    ((void *)0)
# 2701 "project/nginx/src/http/ngx_http_file_cache.c"
                        ) {
                return 
# 2702 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      (void *) -1
# 2702 "project/nginx/src/http/ngx_http_file_cache.c"
                                    ;
            }
        ...
        return 
# 2709 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
              ((void *)0)
# 2709 "project/nginx/src/http/ngx_http_file_cache.c"
                         ;
    }
    ...
    for (i = 1; i < n; i++) {
        ...
        if (
# 2714 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           strcmp((const char *) 
# 2714 "project/nginx/src/http/ngx_http_file_cache.c"
           value[i].data
# 2714 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
           , (const char *) 
# 2714 "project/nginx/src/http/ngx_http_file_cache.c"
...
# 2714 "project/nginx/src/http/ngx_http_file_cache.c"
            ...
            if (status < 100 || status > 599) {
                ngx_conf_log_error(
# 2722 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                                  1
# 2722 "project/nginx/src/http/ngx_http_file_cache.c"
                                               , cf, 0,
                                   "invalid status \"%V\"", &value[i]);
                return 
# 2724 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                      (void *) -1
# 2724 "project/nginx/src/http/ngx_http_file_cache.c"
                                    ;
            }
        }
        ...
        v = ngx_array_push(*a);
        if (v == 
# 2729 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                ((void *)0)
# 2729 "project/nginx/src/http/ngx_http_file_cache.c"
                    ) {
            return 
# 2730 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
                  (void *) -1
# 2730 "project/nginx/src/http/ngx_http_file_cache.c"
                                ;
        }
    ...
    return 
# 2737 "project/nginx/src/http/ngx_http_file_cache.c" 3 4
          ((void *)0)
# 2737 "project/nginx/src/http/ngx_http_file_cache.c"
                     ;
}
