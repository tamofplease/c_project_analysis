# 0 "project/nginx/src/http/ngx_http_core_module.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/http/ngx_http_core_module.h"
# 12 "project/nginx/src/http/ngx_http_core_module.h"
...
# 13 "project/nginx/src/http/ngx_http_core_module.h" 2
...
# 14 "project/nginx/src/http/ngx_http_core_module.h" 2
...
# 15 "project/nginx/src/http/ngx_http_core_module.h" 2
# 63 "project/nginx/src/http/ngx_http_core_module.h"
...
typedef struct {
    ...
    int fastopen;
# 104 "project/nginx/src/http/ngx_http_core_module.h"
...
# 420 "project/nginx/src/http/ngx_http_core_module.h"
