# 0 "project/nginx/src/http/v2/ngx_http_v2.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/http/v2/ngx_http_v2.h"
# 11 "project/nginx/src/http/v2/ngx_http_v2.h"
...
# 12 "project/nginx/src/http/v2/ngx_http_v2.h" 2
...
# 13 "project/nginx/src/http/v2/ngx_http_v2.h" 2
...
# 14 "project/nginx/src/http/v2/ngx_http_v2.h" 2
# 57 "project/nginx/src/http/v2/ngx_http_v2.h"
...
static 
# 238 "project/nginx/src/http/v2/ngx_http_v2.h" 3 4
      inline 
# 238 "project/nginx/src/http/v2/ngx_http_v2.h"
                 void
    ...
    ngx_http_v2_out_frame_t *frame)
{
    ...
    for (out = &h2c->last_out; *out; out = &(*out)->next) {
        ...
        if ((*out)->blocked || (*out)->stream == 
# 246 "project/nginx/src/http/v2/ngx_http_v2.h" 3 4
                                                ((void *)0)
# 246 "project/nginx/src/http/v2/ngx_http_v2.h"
                                                    ) {
            break;
        }
...
static 
# 264 "project/nginx/src/http/v2/ngx_http_v2.h" 3 4
      inline 
# 264 "project/nginx/src/http/v2/ngx_http_v2.h"
                 void
    ...
    ngx_http_v2_out_frame_t *frame)
{
    ...
    for (out = &h2c->last_out; *out; out = &(*out)->next) {
        ...
        if ((*out)->blocked || (*out)->stream == 
# 272 "project/nginx/src/http/v2/ngx_http_v2.h" 3 4
                                                ((void *)0)
# 272 "project/nginx/src/http/v2/ngx_http_v2.h"
                                                    ) {
            break;
        }
    }
...
static 
# 282 "project/nginx/src/http/v2/ngx_http_v2.h" 3 4
      inline 
# 282 "project/nginx/src/http/v2/ngx_http_v2.h"
                 void
...
# 412 "project/nginx/src/http/v2/ngx_http_v2.h"
