# 0 "project/nginx/src/http/v2/ngx_http_v2_encode.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/http/v2/ngx_http_v2_encode.c"
...
# 9 "project/nginx/src/http/v2/ngx_http_v2_encode.c" 2
...
# 10 "project/nginx/src/http/v2/ngx_http_v2_encode.c" 2
...
# 11 "project/nginx/src/http/v2/ngx_http_v2_encode.c" 2



# 13 "project/nginx/src/http/v2/ngx_http_v2_encode.c"
    ...
    ngx_uint_t lower)
{
    ...
    if (hlen > 0) {
        *dst = NGX_HTTP_V2_ENCODE_HUFF;
        ...
        return 
# 28 "project/nginx/src/http/v2/ngx_http_v2_encode.c" 3 4
              (((u_char *) __builtin___memcpy_chk (
# 28 "project/nginx/src/http/v2/ngx_http_v2_encode.c"
              dst
# 28 "project/nginx/src/http/v2/ngx_http_v2_encode.c" 3 4
              , 
# 28 "project/nginx/src/http/v2/ngx_http_v2_encode.c"
...
# 28 "project/nginx/src/http/v2/ngx_http_v2_encode.c"
    ...
    *dst = NGX_HTTP_V2_ENCODE_RAW;
    ...
    return 
# 39 "project/nginx/src/http/v2/ngx_http_v2_encode.c" 3 4
          (((u_char *) __builtin___memcpy_chk (
# 39 "project/nginx/src/http/v2/ngx_http_v2_encode.c"
          dst
# 39 "project/nginx/src/http/v2/ngx_http_v2_encode.c" 3 4
          , 
# 39 "project/nginx/src/http/v2/ngx_http_v2_encode.c"
