# 0 "project/nginx/src/http/ngx_http_config.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/http/ngx_http_config.h"
# 12 "project/nginx/src/http/ngx_http_config.h"
...
# 13 "project/nginx/src/http/ngx_http_config.h" 2
...
# 14 "project/nginx/src/http/ngx_http_config.h" 2
...
# 15 "project/nginx/src/http/ngx_http_config.h" 2



# 17 "project/nginx/src/http/ngx_http_config.h"
typedef struct {
    void **main_conf;
    void **srv_conf;
    void **loc_conf;
