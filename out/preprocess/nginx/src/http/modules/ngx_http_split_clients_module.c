# 0 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
...
# 9 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 2
...
# 10 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 2
...
# 11 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 2



# 13 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
typedef struct {
    uint32_t percent;
...
static ngx_command_t ngx_http_split_clients_commands[] = {
    ...
    { 
# 32 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
     { sizeof(
# 32 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
     "split_clients"
# 32 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
     ) - 1, (u_char *) 
# 32 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
...
# 33 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
     0x02000000
# 33 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                       |
# 33 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
                        0x00000100
# 33 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
...
# 35 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, main_conf)
# 35 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                              ,
      0,
      
# 37 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
     ((void *)0) 
# 37 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
          },

      
# 39 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 40 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
};


static ngx_http_module_t ngx_http_split_clients_module_ctx = {
    
# 44 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
   ((void *)0)
# 44 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
       ,
    
# 45 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
   ((void *)0)
# 45 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
       ,

    
# 47 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
   ((void *)0)
# 47 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
       ,
    
# 48 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
   ((void *)0)
# 48 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
       ,

    
# 50 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
   ((void *)0)
# 50 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
       ,
    
# 51 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
   ((void *)0)
# 51 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
       ,

    
# 53 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
   ((void *)0)
# 53 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
       ,
    
# 54 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
   ((void *)0)

# 55 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
};


ngx_module_t ngx_http_split_clients_module = {
    
# 59 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 59 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
   "8" 
# 59 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
   "," 
# 59 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
...
# 59 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                ,
    &ngx_http_split_clients_module_ctx,
    ngx_http_split_clients_commands,
    
# 62 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
   0x50545448
# 62 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                  ,
    
# 63 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
   ((void *)0)
# 63 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
       ,
    
# 64 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
   ((void *)0)
# 64 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
       ,
    
# 65 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
   ((void *)0)
# 65 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
       ,
    
# 66 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
   ((void *)0)
# 66 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
       ,
    
# 67 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
   ((void *)0)
# 67 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
       ,
    
# 68 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
   ((void *)0)
# 68 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
       ,
    
# 69 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
   ((void *)0)
# 69 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
       ,
    
# 70 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 71 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
};
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    *v = ngx_http_variable_null_value;
    ...
    if (ngx_http_complex_value(r, &ctx->value, &val) != 
# 87 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
                                                       0
# 87 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                                                             ) {
        return 
# 88 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
              0
# 88 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                    ;
    }
    ...
    for (i = 0; i < ctx->parts.nelts; i++) {
        ...
        if (hash < part[i].percent || part[i].percent == 0) {
            *v = part[i].value;
            return 
# 102 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
                  0
# 102 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                        ;
        }
    }

    return 
# 106 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
          0
# 106 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                ;
}
...
ngx_conf_split_clients_block(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (ctx == 
# 124 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
              ((void *)0)
# 124 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                  ) {
        return 
# 125 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
              (void *) -1
# 125 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                            ;
    }
...
# 130 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
   (void) __builtin___memset_chk (
# 130 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
   &ccv
# 130 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
   , 0, 
# 130 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
...
# 136 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
                                               0
# 136 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                                                     ) {
        return 
# 137 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
              (void *) -1
# 137 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                            ;
    }
    ...
    if (name.data[0] != '$') {
        ngx_conf_log_error(
# 143 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
                          1
# 143 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                                       , cf, 0,
                           "invalid variable name \"%V\"", &name);
        return 
# 145 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
              (void *) -1
# 145 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                            ;
    }
...
# 151 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
                                          1
# 151 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                                                                 );
    if (var == 
# 152 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
              ((void *)0)
# 152 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                  ) {
        return 
# 153 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
              (void *) -1
# 153 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                            ;
    }
    ...
    if (ngx_array_init(&ctx->parts, cf->pool, 2,
        ...
        != 
# 161 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
          0
# 161 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                )
    {
        return 
# 163 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
              (void *) -1
# 163 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                            ;
    }
...
# 171 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
                           ((void *)0)
# 171 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                               );

    *cf = save;

    if (rv != 
# 175 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
             ((void *)0)
# 175 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                        ) {
        return rv;
    }
    ...
    for (i = 0; i < ctx->parts.nelts; i++) {
        ...
        if (sum > 10000) {
            ngx_conf_log_error(
# 186 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
                              1
# 186 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                                           , cf, 0,
                               "percent total is greater than 100%%");
            return 
# 188 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
                  (void *) -1
# 188 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                                ;
        }
...
ngx_http_split_clients(ngx_conf_t *cf, ngx_command_t *dummy, void *conf)
{
    ...
    if (part == 
# 213 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
               ((void *)0)
# 213 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                   ) {
        return 
# 214 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
              (void *) -1
# 214 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                            ;
    }
    ...
    if (value[0].len == 1 && value[0].data[0] == '*') {
        ...
        if (n == 
# 226 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
                -1 
# 226 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                          || n == 0) {
            goto invalid;
        }
    ...
    return 
# 239 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
          ((void *)0)
# 239 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                     ;

invalid:

    ngx_conf_log_error(
# 243 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
                      1
# 243 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                                   , cf, 0,
                       "invalid percent value \"%V\"", &value[0]);
    return 
# 245 "project/nginx/src/http/modules/ngx_http_split_clients_module.c" 3 4
          (void *) -1
# 245 "project/nginx/src/http/modules/ngx_http_split_clients_module.c"
                        ;
}
