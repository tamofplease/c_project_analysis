# 0 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
# 10 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 11 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 2
...
# 12 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 2
...
# 13 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 2



# 15 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
typedef struct {
    ngx_array_t caches;
...
# 59 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
static char *ngx_http_uwsgi_cache_key(ngx_conf_t *cf, ngx_command_t *cmd,
    void *conf);
# 104 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
static ngx_conf_bitmask_t ngx_http_uwsgi_next_upstream_masks[] = {
    { 
# 110 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 110 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "error"
# 110 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 110 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 110 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 111 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 111 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "timeout"
# 111 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 111 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 111 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 112 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 112 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "invalid_header"
# 112 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 112 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 112 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 113 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 113 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "non_idempotent"
# 113 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 113 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 113 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 114 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 114 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "http_500"
# 114 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 114 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 114 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 115 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 115 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "http_503"
# 115 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 115 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 115 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 116 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 116 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "http_403"
# 116 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 116 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 116 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 117 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 117 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "http_404"
# 117 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 117 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 117 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 118 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 118 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "http_429"
# 118 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 118 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 118 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 119 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 119 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "updating"
# 119 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 119 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 119 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 120 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 120 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "off"
# 120 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 120 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 120 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 121 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { 0, ((void *)0) }
# 121 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                    , 0 }
};
# 143 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
static ngx_command_t ngx_http_uwsgi_commands[] = {
    ...
    { 
# 148 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 148 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_pass"
# 148 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 148 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 149 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x08000000
# 149 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                      |
# 149 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                       0x40000000
# 149 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 151 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 151 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      0,
      
# 153 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 153 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 155 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 155 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_modifier1"
# 155 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 155 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 156 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 156 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 156 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 156 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 158 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 158 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 159 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 159 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 159 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 159 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 159 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 162 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 162 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_modifier2"
# 162 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 162 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 163 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 163 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 163 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 163 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 165 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 165 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 166 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 166 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 166 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 166 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 166 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 169 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 169 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_store"
# 169 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 169 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 170 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 170 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 170 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 170 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 172 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 172 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      0,
      
# 174 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 174 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 176 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 176 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_store_access"
# 176 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 176 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 177 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 177 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 177 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 177 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 179 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 179 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 180 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 180 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 180 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 180 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 181 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 181 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 183 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 183 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_buffering"
# 183 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 183 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 184 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 184 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 184 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 184 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 186 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 186 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 187 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 187 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 187 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 187 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 188 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 188 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 190 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 190 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 191 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 191 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 191 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 191 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 193 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 193 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 194 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 194 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 194 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 194 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 195 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 195 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 197 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 197 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 198 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 198 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 198 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 198 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 200 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 200 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 201 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 201 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 201 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 201 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 202 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 202 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 204 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 204 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_bind"
# 204 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 204 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 205 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 205 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 205 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 205 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 207 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 207 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 208 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 208 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 208 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 208 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 209 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 209 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 211 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 211 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 212 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 212 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 212 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 212 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 214 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 214 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 215 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 215 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 215 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 215 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 216 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 216 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 218 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 218 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 219 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 219 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 219 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 219 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 221 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 221 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 222 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 222 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 222 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 222 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 223 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 223 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 225 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 225 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_send_timeout"
# 225 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 225 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 226 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 226 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 226 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 226 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 228 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 228 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 229 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 229 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 229 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 229 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 230 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 230 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 232 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 232 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_buffer_size"
# 232 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 232 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 233 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 233 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 233 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 233 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 235 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 235 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 236 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 236 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 236 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 236 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 237 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 237 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 239 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 239 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 240 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 240 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 240 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 240 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 242 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 242 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 243 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 243 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 243 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 243 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 244 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 244 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 246 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 246 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 247 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 247 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 247 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 247 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 249 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 249 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 250 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 250 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 250 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 250 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 251 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 251 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 253 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 253 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 254 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 254 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 254 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 254 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 256 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 256 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 257 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 257 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 257 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 257 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 258 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 258 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 260 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 260 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_read_timeout"
# 260 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 260 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 261 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 261 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 261 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 261 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 263 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 263 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 264 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 264 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 264 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 264 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 265 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 265 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 267 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 267 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_buffers"
# 267 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 267 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 268 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 268 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 268 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 268 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 270 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 270 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 271 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 271 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 271 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 271 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 272 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 272 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 274 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 274 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 275 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 275 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 275 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 275 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 277 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 277 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 278 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 278 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 278 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 278 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 279 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 279 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 281 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 281 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_force_ranges"
# 281 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 281 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 282 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 282 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 282 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 282 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 284 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 284 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 285 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 285 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 285 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 285 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 286 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 286 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 288 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 288 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_limit_rate"
# 288 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 288 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 289 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 289 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 289 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 289 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 291 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 291 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 292 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 292 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 292 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 292 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 293 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 293 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },



    { 
# 297 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 297 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_cache"
# 297 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 297 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 298 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 298 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 298 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 298 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 300 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 300 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      0,
      
# 302 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 302 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 304 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 304 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_cache_key"
# 304 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 304 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 305 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 305 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 305 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 305 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 307 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 307 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      0,
      
# 309 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 309 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 311 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 311 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_cache_path"
# 311 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 311 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 312 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 312 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 312 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x00001000
# 312 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 314 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, main_conf)
# 314 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                              ,
      
# 315 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 315 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_main_conf_t
# 315 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 315 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 315 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 318 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 318 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_cache_bypass"
# 318 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 318 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 319 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 319 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 319 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 319 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 321 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 321 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 322 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 322 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 322 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 322 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 323 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 323 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 325 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 325 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_no_cache"
# 325 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 325 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 326 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 326 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 326 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 326 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 328 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 328 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 329 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 329 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 329 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 329 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 330 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 330 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 332 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 332 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_cache_valid"
# 332 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 332 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 333 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 333 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 333 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 333 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 335 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 335 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 336 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 336 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 336 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 336 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 337 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 337 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 339 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 339 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 340 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 340 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 340 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 340 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 342 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 342 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 343 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 343 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 343 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 343 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 344 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 344 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 346 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 346 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 347 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 347 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 347 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 347 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 349 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 349 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 350 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 350 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 350 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 350 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 351 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 351 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 353 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 353 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 354 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 354 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 354 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 354 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 356 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 356 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 357 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 357 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 357 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 357 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 357 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 360 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 360 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_cache_methods"
# 360 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 360 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 361 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 361 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 361 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 361 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 363 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 363 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 364 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 364 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 364 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 364 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 364 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 367 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 367 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_cache_lock"
# 367 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 367 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 368 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 368 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 368 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 368 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 370 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 370 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 371 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 371 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 371 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 371 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 372 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 372 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 374 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 374 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 375 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 375 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 375 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 375 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 377 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 377 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 378 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 378 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 378 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 378 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 379 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 379 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 381 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 381 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 382 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 382 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 382 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 382 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 384 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 384 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 385 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 385 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 385 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 385 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 386 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 386 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 388 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 388 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 389 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 389 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 389 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 389 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 391 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 391 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 392 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 392 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 392 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 392 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 393 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 393 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 395 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 395 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 396 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 396 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 396 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 396 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 398 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 398 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 399 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 399 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 399 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 399 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 400 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 400 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },



    { 
# 404 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 404 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_temp_path"
# 404 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 404 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 405 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 405 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 405 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 405 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 407 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 407 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 408 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 408 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 408 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 408 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 409 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 409 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 411 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 411 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 412 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 412 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 412 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 412 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 414 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 414 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 415 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 415 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 415 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 415 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 416 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 416 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 418 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 418 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 419 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 419 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 419 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 419 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 421 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 421 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 422 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 422 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 422 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 422 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 423 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 423 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 425 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 425 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_next_upstream"
# 425 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 425 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 426 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 426 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 426 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 426 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 428 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 428 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 429 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 429 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 429 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 429 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 429 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 432 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 432 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 433 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 433 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 433 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 433 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 435 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 435 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 436 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 436 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 436 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 436 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 437 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 437 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 439 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 439 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 440 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 440 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 440 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 440 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 442 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 442 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 443 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 443 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 443 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 443 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 444 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 444 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 446 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 446 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_param"
# 446 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 446 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 447 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 447 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 447 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 447 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 449 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 449 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 450 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 450 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 450 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 450 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 451 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 451 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 453 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 453 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_string"
# 453 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 453 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 454 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 454 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 454 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 454 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 456 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 456 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 457 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 457 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 457 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 457 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 458 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 458 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 460 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 460 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_pass_header"
# 460 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 460 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 461 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 461 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 461 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 461 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 463 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 463 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 464 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 464 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 464 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 464 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 465 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 465 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 467 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 467 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "uwsgi_hide_header"
# 467 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 467 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 468 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 468 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 468 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 468 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 470 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 470 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 471 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 471 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 471 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 471 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 472 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ((void *)0) 
# 472 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          },

    { 
# 474 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 474 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 475 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0x02000000
# 475 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       |
# 475 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                        0x04000000
# 475 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 477 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 477 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 478 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     __builtin_offsetof (
# 478 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     ngx_http_uwsgi_loc_conf_t
# 478 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     , 
# 478 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 576 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
      
# 576 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 577 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
};


static ngx_http_module_t ngx_http_uwsgi_module_ctx = {
    
# 581 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   ((void *)0)
# 581 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       ,
    
# 582 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   ((void *)0)
# 582 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       ,

    ngx_http_uwsgi_create_main_conf,
    
# 585 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   ((void *)0)
# 585 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       ,

    
# 587 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   ((void *)0)
# 587 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       ,
    
# 588 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   ((void *)0)
# 588 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       ,
...
# 596 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 596 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   "8" 
# 596 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   "," 
# 596 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 599 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   0x50545448
# 599 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                  ,
    
# 600 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   ((void *)0)
# 600 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       ,
    
# 601 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   ((void *)0)
# 601 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       ,
    
# 602 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   ((void *)0)
# 602 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       ,
    
# 603 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   ((void *)0)
# 603 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       ,
    
# 604 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   ((void *)0)
# 604 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       ,
    
# 605 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   ((void *)0)
# 605 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       ,
    
# 606 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   ((void *)0)
# 606 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       ,
    
# 607 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 608 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
};


static ngx_str_t ngx_http_uwsgi_hide_headers[] = {
    
# 612 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   { sizeof(
# 612 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   "X-Accel-Expires"
# 612 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   ) - 1, (u_char *) 
# 612 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 613 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   { sizeof(
# 613 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   "X-Accel-Redirect"
# 613 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   ) - 1, (u_char *) 
# 613 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 614 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   { sizeof(
# 614 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   "X-Accel-Limit-Rate"
# 614 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   ) - 1, (u_char *) 
# 614 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 615 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   { sizeof(
# 615 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   "X-Accel-Buffering"
# 615 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   ) - 1, (u_char *) 
# 615 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 616 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   { sizeof(
# 616 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   "X-Accel-Charset"
# 616 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   ) - 1, (u_char *) 
# 616 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 617 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   { 0, ((void *)0) }

# 618 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
};
...
static ngx_keyval_t ngx_http_uwsgi_cache_headers[] = {
    { 
# 624 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 624 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 625 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 625 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 625 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 626 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 626 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 626 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 627 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 627 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "HTTP_IF_NONE_MATCH"
# 627 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 627 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 627 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 628 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 628 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "HTTP_IF_MATCH"
# 628 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 628 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 628 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 629 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 629 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "HTTP_RANGE"
# 629 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 629 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 629 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 630 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { sizeof(
# 630 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
     "HTTP_IF_RANGE"
# 630 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     ) - 1, (u_char *) 
# 630 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 630 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    { 
# 631 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
     { 0, ((void *)0) }
# 631 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                    , 
# 631 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                      { 0, ((void *)0) } 
# 631 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 638 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   { sizeof("uwsgi_temp") - 1, (u_char *) "uwsgi_temp" }
# 638 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                       , { 1, 2, 0 }
};
...
# 653 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                      0
# 653 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                            ) {
        return 
# 654 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              500
# 654 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                            ;
    }

    status = ngx_pcalloc(r->pool, sizeof(ngx_http_status_t));
    if (status == 
# 658 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                 ((void *)0)
# 658 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                     ) {
        return 
# 659 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              500
# 659 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                            ;
    }

    r
# 662 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   ->ctx[
# 662 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   ngx_http_uwsgi_module
# 662 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   .ctx_index] = 
# 662 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 662 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    uwcf = 
# 664 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          (
# 664 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          r
# 664 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          )->loc_conf[
# 664 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 668 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                              ((void *)0)
# 668 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                  ) {
# 680 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
        
# 680 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       (
# 680 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       &u->schema
# 680 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
...
# 680 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       "uwsgi://";
        ...
        if (ngx_http_uwsgi_eval(r, uwcf) != 
# 684 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                           0
# 684 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                 ) {
            return 
# 685 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                  500
# 685 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                ;
        }
    }
    ...
    uwmcf = 
# 694 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
           (
# 694 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
           r
# 694 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
           )->main_conf[
# 694 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 694 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    if (u->pipe == 
# 710 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                  ((void *)0)
# 710 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                      ) {
        return 
# 711 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              500
# 711 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                            ;
    }
    ...
    if (rc >= 
# 730 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
             300
# 730 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                      ) {
        return rc;
    }

    return 
# 734 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          -4
# 734 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                  ;
}
...
# 745 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   (void) __builtin___memset_chk (
# 745 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   &url
# 745 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   , 0, 
# 745 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 745 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    if (ngx_http_script_run(r, &url.url, uwcf->uwsgi_lengths->elts, 0,
        ...
        == 
# 749 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          ((void *)0)
# 749 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
              )
    {
        return 
# 751 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              -1
# 751 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ;
    }
...
# 767 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       if ((
# 767 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       r->connection->log
# 767 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
...
# 767 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       , 
# 767 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       0, "suwsgi protocol requires SSL support"
# 767 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       )
                                                             
# 768 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                            ;
        return 
# 769 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              -1
# 769 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ;
...
# 786 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       (
# 786 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       &u->schema
# 786 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       )->len = sizeof(
# 786 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 791 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                       0
# 791 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                             ) {
        if (url.err) {
            
# 793 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
           if ((
# 793 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
           r->connection->log
# 793 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
           )->log_level >= 4) ngx_log_error_core(4, 
# 793 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 794 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                    ;
        }

        return 
# 797 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              -1
# 797 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ;
    }

    u->resolved = ngx_pcalloc(r->pool, sizeof(ngx_http_upstream_resolved_t));
    if (u->resolved == 
# 801 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                      ((void *)0)
# 801 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                          ) {
        return 
# 802 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              -1
# 802 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ;
    }
    ...
    return 
# 816 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          0
# 816 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                ;
}
...
ngx_http_uwsgi_create_key(ngx_http_request_t *r)
{
    ...
    if (key == 
# 829 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              ((void *)0)
# 829 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                  ) {
        return 
# 830 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              -1
# 830 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ;
    }

    uwcf = 
# 833 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          (
# 833 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          r
# 833 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          )->loc_conf[
# 833 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 833 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    if (ngx_http_complex_value(r, &uwcf->cache_key, key) != 
# 835 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                                           0
# 835 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                 ) {
        return 
# 836 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              -1
# 836 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ;
    }

    return 
# 839 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          0
# 839 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                ;
}
...
ngx_http_uwsgi_create_request(ngx_http_request_t *r)
{
    ...
    header_params = 0;
    ignored = 
# 863 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
             ((void *)0)
# 863 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                 ;

    uwcf = 
# 865 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          (
# 865 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          r
# 865 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          )->loc_conf[
# 865 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 874 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       (void) __builtin___memset_chk (
# 874 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       &le
# 874 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       , 0, 
# 874 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 874 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    if (uwcf->upstream.pass_request_headers) {
        ...
        allocated = 0;
        lowcase_key = 
# 906 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                     ((void *)0)
# 906 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                         ;
        ...
        if (params->number) {
            ...
            if (ignored == 
# 918 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                          ((void *)0)
# 918 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                              ) {
                return 
# 919 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                      -1
# 919 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                               ;
            }
        }
        ...
        for (i = 0; ; i++) {
            ...
            if (i >= part->nelts) {
                if (part->next == 
# 929 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                 ((void *)0)
# 929 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                     ) {
                    break;
                }
            ...
            if (params->number) {
                if (allocated < header[i].key.len) {
                    ...
                    if (lowcase_key == 
# 942 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                      ((void *)0)
# 942 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                          ) {
                        return 
# 943 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                              -1
# 943 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                       ;
                    }
                }
                ...
                for (n = 0; n < header[i].key.len; n++) {
                    ...
                    hash = 
# 959 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                          ((ngx_uint_t) 
# 959 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                          hash 
# 959 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                          * 31 + 
# 959 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 985 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    if (len > 65535) {
        
# 986 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       if ((
# 986 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       r->connection->log
# 986 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
...
# 986 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       , 
# 986 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       0, "uwsgi request is too big: %uz", len
# 986 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       )
                                                           
# 987 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                          ;
        return 
# 988 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              -1
# 988 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ;
    }

    b = ngx_create_temp_buf(r->pool, len + 4);
    if (b == 
# 992 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
            ((void *)0)
# 992 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                ) {
        return 
# 993 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              -1
# 993 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ;
    }

    cl = ngx_alloc_chain_link(r->pool);
    if (cl == 
# 997 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
             ((void *)0)
# 997 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                 ) {
        return 
# 998 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              -1
# 998 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ;
    }
...
# 1009 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       (void) __builtin___memset_chk (
# 1009 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       &e
# 1009 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       , 0, 
# 1009 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1009 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    if (uwcf->upstream.pass_request_headers) {
        ...
        for (i = 0; ; i++) {
            ...
            if (i >= part->nelts) {
                if (part->next == 
# 1078 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                 ((void *)0)
# 1078 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                     ) {
                    break;
                }
            ...
            *b->last++ = (u_char) ((key_len >> 8) & 0xff);
            ...
            b->last = 
# 1097 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                     (((u_char *) __builtin___memcpy_chk (
# 1097 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                     b->last
# 1097 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                     , 
# 1097 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1097 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
            ...
            *b->last++ = (u_char) ((val_len >> 8) & 0xff);
            b->last = 
# 1114 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                     (((u_char *) __builtin___memcpy_chk (
# 1114 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                     b->last
# 1114 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                     , 
# 1114 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1114 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    b->last = 
# 1126 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
             (((u_char *) __builtin___memcpy_chk (
# 1126 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
             b->last
# 1126 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
             , 
# 1126 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
             uwcf->uwsgi_string.data
# 1126 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
             , 
# 1126 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1127 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                             ;
    ...
    if (r->request_body_no_buffering) {
        ...
        while (body) {
            b = 
# 1137 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
               ngx_palloc(
# 1137 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
               r->pool
# 1137 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
               , sizeof(ngx_buf_t))
# 1137 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                     ;
            if (b == 
# 1138 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                    ((void *)0)
# 1138 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                        ) {
                return 
# 1139 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                      -1
# 1139 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                               ;
            }

            
# 1142 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
           (void) __builtin___memcpy_chk (
# 1142 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
           b
# 1142 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
           , 
# 1142 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1142 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
            ...
            if (cl->next == 
# 1145 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                           ((void *)0)
# 1145 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                               ) {
                return 
# 1146 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                      -1
# 1146 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                               ;
            }
    ...
    b->flush = 1;
    cl->next = 
# 1160 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              ((void *)0)
# 1160 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                  ;

    return 
# 1162 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          0
# 1162 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                ;
}
...
ngx_http_uwsgi_reinit_request(ngx_http_request_t *r)
{
    ...
    status = 
# 1171 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
            (
# 1171 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
            r
# 1171 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
            )->ctx[
# 1171 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1171 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    if (status == 
# 1173 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                 ((void *)0)
# 1173 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                     ) {
        return 
# 1174 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              0
# 1174 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                    ;
    }
    ...
    status->count = 0;
    status->start = 
# 1179 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                   ((void *)0)
# 1179 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ;
    status->end = 
# 1180 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                 ((void *)0)
# 1180 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                     ;
    ...
    return 
# 1185 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          0
# 1185 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                ;
}
...
ngx_http_uwsgi_process_status_line(ngx_http_request_t *r)
{
    ...
    status = 
# 1197 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
            (
# 1197 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
            r
# 1197 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
            )->ctx[
# 1197 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1197 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    if (status == 
# 1199 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                 ((void *)0)
# 1199 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                     ) {
        return 
# 1200 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              -1
# 1200 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ;
    }
    ...
    if (rc == 
# 1207 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
             -2
# 1207 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                      ) {
        return rc;
    }

    if (rc == 
# 1211 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
             -1
# 1211 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                      ) {
...
# 1226 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                         ((void *)0)
# 1226 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                             ) {
        return 
# 1227 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              -1
# 1227 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ;
    }

    
# 1230 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   (void) __builtin___memcpy_chk (
# 1230 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
ngx_http_uwsgi_process_header(ngx_http_request_t *r)
{
    ...
    umcf = 
# 1252 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          (
# 1252 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          r
# 1252 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          )->main_conf[
# 1252 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1252 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    for ( ;; ) {
        ...
        if (rc == 
# 1258 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                 0
# 1258 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ) {
            ...
            if (h == 
# 1263 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                    ((void *)0)
# 1263 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                        ) {
                return 
# 1264 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                      -1
# 1264 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                               ;
            }
            ...
            h->key.data = ngx_pnalloc(r->pool,
                                      ...
                                      + h->key.len);
            if (h->key.data == 
# 1275 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                              ((void *)0)
# 1275 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                  ) {
                h->hash = 0;
                return 
# 1277 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                      -1
# 1277 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                               ;
            }
...
# 1283 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
           (void) __builtin___memcpy_chk (
# 1283 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
           h->key.data
# 1283 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
           , 
# 1283 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1285 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
           (void) __builtin___memcpy_chk (
# 1285 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
           h->value.data
# 1285 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
           , 
# 1285 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1289 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
               (void) __builtin___memcpy_chk (
# 1289 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
               h->lowcase_key
# 1289 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
               , 
# 1289 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1298 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                                      0
# 1298 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                            ) {
                return 
# 1299 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                      -1
# 1299 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                               ;
            }
        ...
        if (rc == 
# 1308 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                 1
# 1308 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                           ) {
            ...
            if (u->headers_in.status) {
                ...
                if (status == 
# 1325 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                             -1
# 1325 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                      ) {
                    
# 1326 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                   if ((
# 1326 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                   r->connection->log
# 1326 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                   )->log_level >= 4) ngx_log_error_core(4, 
# 1326 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1328 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                             ;
                    return 
# 1329 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                          40
# 1329 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                          ;
                }
...
# 1337 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
               (
# 1337 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1342 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
               (
# 1342 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
               &u->headers_in.status_line
# 1342 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
               )->len = sizeof(
# 1342 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1342 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
            ...
            if (u->headers_in.status_n == 
# 1351 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                         101
                
# 1352 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
            ...
            return 
# 1357 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                  0
# 1357 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                        ;
        }

        if (rc == 
# 1360 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                 -2
# 1360 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                          ) {
            return 
# 1361 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                  -2
# 1361 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                           ;
        }
...
# 1366 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       if ((
# 1366 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       r->connection->log
# 1366 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       )->log_level >= 4) ngx_log_error_core(4, 
# 1366 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1366 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       , 
# 1366 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       0, "upstream sent invalid header: \"%*s\\x%02xd...\"", r->header_end - r->header_name_start, r->header_name_start, *r->header_end
# 1366 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       )


                                                           
# 1369 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                          ;

        return 
# 1371 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              40
# 1371 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                              ;
    }
}
...
ngx_http_uwsgi_input_filter_init(void *data)
{
    ...
    if (u->headers_in.status_n == 
# 1388 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                 204
        
# 1389 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       || u->headers_in.status_n == 
# 1389 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                    304
# 1389 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                         )
    {
...
# 1394 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                           0x00000004
# 1394 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                        ) {
        u->pipe->length = -1;
        u->length = -1;
    ...
    return 
# 1403 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          0
# 1403 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                ;
}
...
ngx_http_uwsgi_create_main_conf(ngx_conf_t *cf)
{
    ...
    if (conf == 
# 1433 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
               ((void *)0)
# 1433 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                   ) {
        return 
# 1434 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              ((void *)0)
# 1434 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                  ;
    }
    ...
    if (ngx_array_init(&conf->caches, cf->pool, 4,
        ...
        != 
# 1440 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          0
# 1440 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                )
    {
        return 
# 1442 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              ((void *)0)
# 1442 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                  ;
    }
...
ngx_http_uwsgi_create_loc_conf(ngx_conf_t *cf)
{
    ...
    if (conf == 
# 1456 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
               ((void *)0)
# 1456 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                   ) {
        return 
# 1457 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              ((void *)0)
# 1457 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                  ;
    }

    conf->modifier1 = 
# 1460 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                     (ngx_uint_t) -1
# 1460 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                        ;
    conf->modifier2 = 
# 1461 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                     (ngx_uint_t) -1
# 1461 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                        ;

    conf->upstream.store = 
# 1463 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                          -1
# 1463 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                        ;
    conf->upstream.store_access = 
# 1464 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                 (ngx_uint_t) -1
# 1464 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                    ;
    conf->upstream.next_upstream_tries = 
# 1465 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                        (ngx_uint_t) -1
# 1465 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                           ;
    conf->upstream.buffering = 
# 1466 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                              -1
# 1466 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                            ;
    conf->upstream.request_buffering = 
# 1467 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                      -1
# 1467 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                    ;
    conf->upstream.ignore_client_abort = 
# 1468 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                        -1
# 1468 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                      ;
    conf->upstream.force_ranges = 
# 1469 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                 -1
# 1469 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                               ;

    conf->upstream.local = 
# 1471 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                          (void *) -1
# 1471 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                            ;
    conf->upstream.socket_keepalive = 
# 1472 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                     -1
# 1472 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                   ;

    conf->upstream.connect_timeout = 
# 1474 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                    (ngx_msec_t) -1
# 1474 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                       ;
    conf->upstream.send_timeout = 
# 1475 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                 (ngx_msec_t) -1
# 1475 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                    ;
    conf->upstream.read_timeout = 
# 1476 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                 (ngx_msec_t) -1
# 1476 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                    ;
    conf->upstream.next_upstream_timeout = 
# 1477 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                          (ngx_msec_t) -1
# 1477 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                             ;

    conf->upstream.send_lowat = 
# 1479 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                               (size_t) -1
# 1479 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                  ;
    conf->upstream.buffer_size = 
# 1480 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                (size_t) -1
# 1480 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                   ;
    conf->upstream.limit_rate = 
# 1481 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                               (size_t) -1
# 1481 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                  ;

    conf->upstream.busy_buffers_size_conf = 
# 1483 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                           (size_t) -1
# 1483 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                              ;
    conf->upstream.max_temp_file_size_conf = 
# 1484 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                            (size_t) -1
# 1484 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                               ;
    conf->upstream.temp_file_write_size_conf = 
# 1485 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                              (size_t) -1
# 1485 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                 ;

    conf->upstream.pass_request_headers = 
# 1487 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                         -1
# 1487 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                       ;
    conf->upstream.pass_request_body = 
# 1488 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                      -1
# 1488 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                    ;


    conf->upstream.cache = 
# 1491 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                          -1
# 1491 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                        ;
    conf->upstream.cache_min_uses = 
# 1492 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                   (ngx_uint_t) -1
# 1492 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                      ;
    conf->upstream.cache_max_range_offset = 
# 1493 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                           -1
# 1493 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                         ;
    conf->upstream.cache_bypass = 
# 1494 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                 (void *) -1
# 1494 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                   ;
    conf->upstream.no_cache = 
# 1495 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                             (void *) -1
# 1495 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                               ;
    conf->upstream.cache_valid = 
# 1496 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                (void *) -1
# 1496 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                  ;
    conf->upstream.cache_lock = 
# 1497 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                               -1
# 1497 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                             ;
    conf->upstream.cache_lock_timeout = 
# 1498 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                       (ngx_msec_t) -1
# 1498 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                          ;
    conf->upstream.cache_lock_age = 
# 1499 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                   (ngx_msec_t) -1
# 1499 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                      ;
    conf->upstream.cache_revalidate = 
# 1500 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                     -1
# 1500 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                   ;
    conf->upstream.cache_background_update = 
# 1501 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                            -1
# 1501 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                          ;


    conf->upstream.hide_headers = 
# 1504 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                 (void *) -1
# 1504 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                   ;
    conf->upstream.pass_headers = 
# 1505 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                 (void *) -1
# 1505 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                   ;

    conf->upstream.intercept_errors = 
# 1507 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                     -1
# 1507 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                   ;
# 1522 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    conf->upstream.cyclic_temp_file = 0;

    conf->upstream.change_buffering = 1;

    
# 1526 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   (
# 1526 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
ngx_http_uwsgi_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->upstream.store == 
# 1555 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                               -1
# 1555 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                             ) {
        
# 1556 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       if (
# 1556 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       conf->upstream.store 
# 1556 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       == -1) { 
# 1556 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1562 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1562 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.store_access 
# 1562 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (ngx_uint_t) -1) { 
# 1562 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1563 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                               ;

    
# 1565 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1565 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.next_upstream_tries 
# 1565 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (ngx_uint_t) -1) { 
# 1565 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1566 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                   ;

    
# 1568 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1568 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.buffering 
# 1568 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == -1) { 
# 1568 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1569 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                         ;

    
# 1571 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1571 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.request_buffering 
# 1571 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == -1) { 
# 1571 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1571 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   = (
# 1571 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   prev->upstream.request_buffering 
# 1571 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == -1) ? 
# 1571 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   1 
...
# 1572 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                 ;

    
# 1574 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1574 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.ignore_client_abort 
# 1574 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == -1) { 
# 1574 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1574 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   = (
# 1574 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   prev->upstream.ignore_client_abort 
# 1574 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == -1) ? 
# 1574 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   0 
...
# 1575 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                   ;

    
# 1577 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1577 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.force_ranges 
# 1577 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == -1) { 
# 1577 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1578 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                            ;

    
# 1580 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1580 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.local 
# 1580 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (void *) -1) { 
# 1580 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1581 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                        ;

    
# 1583 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1583 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.socket_keepalive 
# 1583 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == -1) { 
# 1583 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1584 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                ;

    
# 1586 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1586 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.connect_timeout 
# 1586 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (ngx_msec_t) -1) { 
# 1586 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1587 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                   ;

    
# 1589 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1589 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.send_timeout 
# 1589 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (ngx_msec_t) -1) { 
# 1589 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1590 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                ;

    
# 1592 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1592 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.read_timeout 
# 1592 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (ngx_msec_t) -1) { 
# 1592 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1593 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                ;

    
# 1595 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1595 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.next_upstream_timeout 
# 1595 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (ngx_msec_t) -1) { 
# 1595 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1596 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                     ;

    
# 1598 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1598 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.send_lowat 
# 1598 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (size_t) -1) { 
# 1598 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1599 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                          ;

    
# 1601 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1601 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.buffer_size 
# 1601 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (size_t) -1) { 
# 1601 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1603 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                   ;

    
# 1605 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1605 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.limit_rate 
# 1605 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (size_t) -1) { 
# 1605 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1606 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                          ;


    
# 1609 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1609 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.bufs
# 1609 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   .num == 0) { if (
# 1609 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1610 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                             ;

    if (conf->upstream.bufs.num < 2) {
        ngx_conf_log_error(
# 1613 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                          1
# 1613 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                       , cf, 0,
                           "there must be at least 2 \"uwsgi_buffers\"");
        return 
# 1615 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              (void *) -1
# 1615 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                            ;
    }
...
# 1625 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1625 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.busy_buffers_size_conf 
# 1625 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (size_t) -1) { 
# 1625 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1627 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                 ;

    if (conf->upstream.busy_buffers_size_conf == 
# 1629 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                                (size_t) -1
# 1629 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                   ) {
    ...
    if (conf->upstream.busy_buffers_size < size) {
        ngx_conf_log_error(
# 1637 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                          1
# 1637 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                       , cf, 0,
        ...
        return 
# 1642 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              (void *) -1
# 1642 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                            ;
    }
    ...
    {
        ngx_conf_log_error(
# 1648 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                          1
# 1648 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                       , cf, 0,
            "\"uwsgi_busy_buffers_size\" must be less than "
            "the size of all \"uwsgi_buffers\" minus one buffer");

        return 
# 1652 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              (void *) -1
# 1652 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                            ;
    }


    
# 1656 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1656 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.temp_file_write_size_conf 
# 1656 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (size_t) -1) { 
# 1656 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1658 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                 ;

    if (conf->upstream.temp_file_write_size_conf == 
# 1660 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                                   (size_t) -1
# 1660 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                      ) {
    ...
    if (conf->upstream.temp_file_write_size < size) {
        ngx_conf_log_error(
# 1668 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                          1
# 1668 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                       , cf, 0,
        ...
        return 
# 1673 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              (void *) -1
# 1673 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                            ;
    }


    
# 1677 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1677 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.max_temp_file_size_conf 
# 1677 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (size_t) -1) { 
# 1677 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1679 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                 ;

    if (conf->upstream.max_temp_file_size_conf == 
# 1681 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                                 (size_t) -1
# 1681 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                    ) {
    ...
    {
        ngx_conf_log_error(
# 1691 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                          1
# 1691 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                       , cf, 0,
        ...
        return 
# 1697 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              (void *) -1
# 1697 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                            ;
    }


    
# 1701 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1701 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1703 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                     ;


    
# 1706 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1706 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1710 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                ;

    if (conf->upstream.next_upstream & 
# 1712 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                      0x80000000
# 1712 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                              ) {
        conf->upstream.next_upstream = 
# 1713 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                      1
                                       
# 1714 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                      |
# 1714 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                       0x80000000
# 1714 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                               ;
    }
    ...
    if (ngx_conf_merge_path_value(cf, &conf->upstream.temp_path,
        ...
        != 
# 1720 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          0
# 1720 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                )
    {
        return 
# 1722 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              (void *) -1
# 1722 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                            ;
    }
...
# 1727 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                               -1
# 1727 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                             ) {
        
# 1728 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       if (
# 1728 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       conf->upstream.cache 
# 1728 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       == -1) { 
# 1728 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1729 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                     ;
...
# 1735 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                                                       ((void *)0)
# 1735 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                           ) {
        ngx_shm_zone_t *shm_zone;
        ...
        ngx_conf_log_error(
# 1740 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                          1
# 1740 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                       , cf, 0,
                           "\"uwsgi_cache\" zone \"%V\" is unknown",
                           &shm_zone->shm.name);

        return 
# 1744 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              (void *) -1
# 1744 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                            ;
    }

    
# 1747 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1747 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.cache_min_uses 
# 1747 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (ngx_uint_t) -1) { 
# 1747 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1748 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                              ;

    
# 1750 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1750 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.cache_max_range_offset 
# 1750 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == -1) { 
# 1750 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1752 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                 ;

    
# 1754 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1754 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.cache_use_stale 
# 1754 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == 0) { 
# 1754 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.cache_use_stale 
...
# 1757 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                         ;

    if (conf->upstream.cache_use_stale & 
# 1759 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                        0x80000000
# 1759 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                ) {
        conf->upstream.cache_use_stale = 
# 1760 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                        1
                                         
# 1761 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                        |
# 1761 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                         0x80000000
# 1761 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                 ;
    }
    ...
    if (conf->upstream.cache_use_stale & 
# 1764 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                        0x00000002
# 1764 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                  ) {
        conf->upstream.cache_use_stale |= 
# 1765 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                         0x40000000
# 1765 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                    ;
    }
    ...
    conf->upstream.cache_methods |= 
# 1772 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                   0x00000002
# 1772 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                               |
# 1772 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                                0x00000004
# 1772 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1774 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1774 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.cache_bypass 
# 1774 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (void *) -1) { 
# 1774 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1775 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                              ;

    
# 1777 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1777 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.no_cache 
# 1777 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (void *) -1) { 
# 1777 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1778 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                          ;

    
# 1780 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1780 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.cache_valid 
# 1780 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (void *) -1) { 
# 1780 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1781 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                             ;

    if (conf->cache_key.value.data == 
# 1783 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                     ((void *)0)
# 1783 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                         ) {
        conf->cache_key = prev->cache_key;
    }

    if (conf->upstream.cache && conf->cache_key.value.data == 
# 1787 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                                             ((void *)0)
# 1787 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                 ) {
        ngx_conf_log_error(
# 1788 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                          5
# 1788 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                      , cf, 0,
                           "no \"uwsgi_cache_key\" for \"uwsgi_cache\"");
    }

    
# 1792 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1792 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.cache_lock 
# 1792 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == -1) { 
# 1792 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1793 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                          ;

    
# 1795 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1795 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.cache_lock_timeout 
# 1795 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (ngx_msec_t) -1) { 
# 1795 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1795 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   = (
# 1795 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   prev->upstream.cache_lock_timeout 
# 1795 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (ngx_msec_t) -1) ? 
# 1795 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   5000 
...
# 1796 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                     ;

    
# 1798 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1798 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.cache_lock_age 
# 1798 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (ngx_msec_t) -1) { 
# 1798 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1799 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                 ;

    
# 1801 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1801 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.cache_revalidate 
# 1801 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == -1) { 
# 1801 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1802 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                ;

    
# 1804 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1804 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.cache_background_update 
# 1804 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == -1) { 
# 1804 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1804 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   = (
# 1804 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   prev->upstream.cache_background_update 
# 1804 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == -1) ? 
# 1804 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   0 
...
# 1805 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                       ;



    
# 1809 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1809 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.pass_request_headers 
# 1809 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == -1) { 
# 1809 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1809 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   = (
# 1809 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   prev->upstream.pass_request_headers 
# 1809 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == -1) ? 
# 1809 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   1 
...
# 1810 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                               ;
    
# 1811 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1811 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.pass_request_body 
# 1811 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == -1) { 
# 1811 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1811 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   = (
# 1811 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   prev->upstream.pass_request_body 
# 1811 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == -1) ? 
# 1811 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   1 
...
# 1812 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                            ;

    
# 1814 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1814 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->upstream.intercept_errors 
# 1814 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == -1) { 
# 1814 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1815 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                           ;
# 1857 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    
# 1857 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1857 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->uwsgi_string
# 1857 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
...
# 1857 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    hash.max_size = 512;
    hash.bucket_size = 
# 1860 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                      (((
# 1860 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                      64
# 1860 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                      ) + (
# 1860 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1860 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    if (ngx_http_upstream_hide_headers_hash(cf, &conf->upstream,
        ...
        != 
# 1865 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          0
# 1865 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                )
    {
        return 
# 1867 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              (void *) -1
# 1867 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                            ;
    }

    clcf = 
# 1870 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          ((ngx_http_conf_ctx_t *) 
# 1870 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          cf
# 1870 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          ->ctx)->loc_conf[
# 1870 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1873 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                     ((void *)0) 
# 1873 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                          && conf->uwsgi_lengths == 
# 1873 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                                                    ((void *)0)
# 1873 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1885 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                           ((void *)0)
        
# 1886 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1891 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1891 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->modifier1 
# 1891 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (ngx_uint_t) -1) { 
# 1891 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1892 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   if (
# 1892 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   conf->modifier2 
# 1892 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   == (ngx_uint_t) -1) { 
# 1892 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 1894 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                              ((void *)0)
# 1894 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                  ) {
...
# 1902 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                                            ((void *)0)
# 1902 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                );
    if (rc != 
# 1903 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
             0
# 1903 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                   ) {
        return 
# 1904 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              (void *) -1
# 1904 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                            ;
    }
    ...
    if (conf->upstream.cache) {
        ...
        if (rc != 
# 1912 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                 0
# 1912 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ) {
            return 
# 1913 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                  (void *) -1
# 1913 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                ;
        }
    }
# 1924 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    if (prev->params.hash.buckets == 
# 1924 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                    ((void *)0)
        
# 1925 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       && conf->params_source == prev->params_source)
    {
    ...
    return 
# 1933 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          ((void *)0)
# 1933 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                     ;
}
    ...
    ngx_http_uwsgi_params_t *params, ngx_keyval_t *default_params)
{
    ...
    if (params->hash.buckets) {
        return 
# 1954 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              0
# 1954 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                    ;
    }

    if (conf->params_source == 
# 1957 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                              ((void *)0) 
# 1957 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                   && default_params == 
# 1957 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                                        ((void *)0)
# 1957 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
        ...
        return 
# 1959 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              0
# 1959 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                    ;
    }

    params->lengths = ngx_array_create(cf->pool, 64, 1);
    if (params->lengths == 
# 1963 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                          ((void *)0)
# 1963 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                              ) {
        return 
# 1964 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              -1
# 1964 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ;
    }

    params->values = ngx_array_create(cf->pool, 512, 1);
    if (params->values == 
# 1968 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                         ((void *)0)
# 1968 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                             ) {
        return 
# 1969 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              -1
# 1969 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ;
    }

    if (ngx_array_init(&headers_names, cf->temp_pool, 4, sizeof(ngx_hash_key_t))
        != 
# 1973 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          0
# 1973 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                )
    {
        return 
# 1975 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              -1
# 1975 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ;
    }
    ...
    if (conf->params_source) {
        ...
        src = 
# 1983 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
             ((void *)0)
# 1983 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                 ;
        nsrc = 0;
    }
    ...
    if (default_params) {
        if (ngx_array_init(&params_merged, cf->temp_pool, 4,
            ...
            != 
# 1990 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              0
# 1990 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                    )
        {
            return 
# 1992 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                  -1
# 1992 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                           ;
        }
        ...
        for (i = 0; i < nsrc; i++) {
            ...
            if (s == 
# 1998 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                    ((void *)0)
# 1998 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                        ) {
                return 
# 1999 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                      -1
# 1999 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                               ;
            }
        ...
        while (h->key.len) {
            ...
            s = ngx_array_push(&params_merged);
            if (s == 
# 2019 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                    ((void *)0)
# 2019 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                        ) {
                return 
# 2020 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                      -1
# 2020 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                               ;
            }
    ...
    for (i = 0; i < nsrc; i++) {
        ...
        if (src[i].key.len > sizeof("HTTP_") - 1
            && 
# 2039 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              strncmp((const char *) 
# 2039 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
              src[i].key.data
# 2039 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              , (const char *) 
# 2039 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 2039 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                                         == 0)
        {
            ...
            if (hk == 
# 2042 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                     ((void *)0)
# 2042 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                         ) {
                return 
# 2043 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                      -1
# 2043 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                               ;
            }
        ...
        if (copy == 
# 2058 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                   ((void *)0)
# 2058 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ) {
            return 
# 2059 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                  -1
# 2059 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                           ;
        }
        ...
        copy = ngx_array_push_n(params->lengths,
                                sizeof(ngx_http_script_copy_code_t));
        if (copy == 
# 2068 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                   ((void *)0)
# 2068 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ) {
            return 
# 2069 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                  -1
# 2069 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                           ;
        }
        ...
        if (copy == 
# 2082 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                   ((void *)0)
# 2082 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ) {
            return 
# 2083 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                  -1
# 2083 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                           ;
        }
...
# 2090 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       (void) __builtin___memcpy_chk (
# 2090 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       p
# 2090 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       , 
# 2090 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 2093 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       (void) __builtin___memset_chk (
# 2093 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       &sc
# 2093 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       , 0, 
# 2093 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 2101 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                           0
# 2101 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                 ) {
            return 
# 2102 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                  -1
# 2102 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                           ;
        }

        code = ngx_array_push_n(params->lengths, sizeof(uintptr_t));
        if (code == 
# 2106 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                   ((void *)0)
# 2106 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ) {
            return 
# 2107 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                  -1
# 2107 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                           ;
        }

        *code = (uintptr_t) 
# 2110 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                           ((void *)0)
# 2110 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                               ;


        code = ngx_array_push_n(params->values, sizeof(uintptr_t));
        if (code == 
# 2114 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                   ((void *)0)
# 2114 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ) {
            return 
# 2115 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                  -1
# 2115 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                           ;
        }

        *code = (uintptr_t) 
# 2118 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                           ((void *)0)
# 2118 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                               ;
    }

    code = ngx_array_push_n(params->lengths, sizeof(uintptr_t));
    if (code == 
# 2122 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
               ((void *)0)
# 2122 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                   ) {
        return 
# 2123 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              -1
# 2123 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                       ;
    }

    *code = (uintptr_t) 
# 2126 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                       ((void *)0)
# 2126 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                           ;
    ...
    hash.pool = cf->pool;
    hash.temp_pool = 
# 2136 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                    ((void *)0)
# 2136 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                        ;
...
ngx_http_uwsgi_pass(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    clcf = 
# 2158 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          ((ngx_http_conf_ctx_t *) 
# 2158 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
          cf
# 2158 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          ->ctx)->loc_conf[
# 2158 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 2169 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       (void) __builtin___memset_chk (
# 2169 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       &sc
# 2169 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       , 0, 
# 2169 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 2169 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
        ...
        if (ngx_http_script_compile(&sc) != 
# 2179 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                           0
# 2179 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                 ) {
            return 
# 2180 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                  (void *) -1
# 2180 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                ;
        }
        ...
        return 
# 2187 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              ((void *)0)
# 2187 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                         ;
    }
    ...
    if (ngx_strncasecmp(url->data, (u_char *) "uwsgi://", 8) == 0) {
        ...
        ngx_conf_log_error(
# 2199 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                          1
# 2199 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                       , cf, 0,
                           "suwsgi protocol requires SSL support");
        return 
# 2201 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              (void *) -1
# 2201 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                            ;
...
# 2208 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   (void) __builtin___memset_chk (
# 2208 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   &u
# 2208 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   , 0, 
# 2208 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 2215 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                  ((void *)0)
# 2215 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                      ) {
        return 
# 2216 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              (void *) -1
# 2216 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                            ;
    }
    ...
    return 
# 2223 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          ((void *)0)
# 2223 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                     ;
}
...
ngx_http_uwsgi_store(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (uwcf->upstream.store != 
# 2235 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                               -1
# 2235 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                             ) {
        return "is duplicate";
    }
    ...
    if (
# 2241 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       strcmp((const char *) 
# 2241 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       value[1].data
# 2241 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       , (const char *) 
# 2241 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 2241 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
        ...
        return 
# 2243 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              ((void *)0)
# 2243 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                         ;
    }
    ...
    if (
# 2256 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       strcmp((const char *) 
# 2256 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       value[1].data
# 2256 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       , (const char *) 
# 2256 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 2256 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                       == 0) {
        return 
# 2257 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              ((void *)0)
# 2257 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                         ;
    }
...
# 2263 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   (void) __builtin___memset_chk (
# 2263 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   &sc
# 2263 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   , 0, 
# 2263 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 2263 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    if (ngx_http_script_compile(&sc) != 
# 2273 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                       0
# 2273 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                             ) {
        return 
# 2274 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              (void *) -1
# 2274 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                            ;
    }

    return 
# 2277 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          ((void *)0)
# 2277 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                     ;
}
...
ngx_http_uwsgi_cache(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (uwcf->upstream.cache != 
# 2294 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                               -1
# 2294 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                             ) {
        return "is duplicate";
    }

    if (
# 2298 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       strcmp((const char *) 
# 2298 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
       value[1].data
# 2298 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
       , (const char *) 
# 2298 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 2298 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
        ...
        return 
# 2300 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              ((void *)0)
# 2300 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                         ;
    }
...
# 2309 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   (void) __builtin___memset_chk (
# 2309 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   &ccv
# 2309 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   , 0, 
# 2309 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 2315 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                               0
# 2315 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                     ) {
        return 
# 2316 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              (void *) -1
# 2316 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                            ;
    }

    if (cv.lengths != 
# 2319 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                     ((void *)0)
# 2319 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                         ) {

        uwcf->upstream.cache_value = ngx_palloc(cf->pool,
                                             sizeof(ngx_http_complex_value_t));
        if (uwcf->upstream.cache_value == 
# 2323 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                         ((void *)0)
# 2323 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                             ) {
            return 
# 2324 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                  (void *) -1
# 2324 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                ;
        }
        ...
        *uwcf->upstream.cache_value = cv;
        ...
        return 
# 2329 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              ((void *)0)
# 2329 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                         ;
    }

    uwcf->upstream.cache_zone = ngx_shared_memory_add(cf, &value[1], 0,
                                                      &ngx_http_uwsgi_module);
    if (uwcf->upstream.cache_zone == 
# 2334 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                    ((void *)0)
# 2334 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                        ) {
        return 
# 2335 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              (void *) -1
# 2335 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                            ;
    }

    return 
# 2338 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          ((void *)0)
# 2338 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                     ;
}
...
# 2356 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   (void) __builtin___memset_chk (
# 2356 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
   &ccv
# 2356 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
   , 0, 
# 2356 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
...
# 2356 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
    ...
    if (ngx_http_compile_complex_value(&ccv) != 
# 2362 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
                                               0
# 2362 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                                                     ) {
        return 
# 2363 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
              (void *) -1
# 2363 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                            ;
    }

    return 
# 2366 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c" 3 4
          ((void *)0)
# 2366 "project/nginx/src/http/modules/ngx_http_uwsgi_module.c"
                     ;
}
