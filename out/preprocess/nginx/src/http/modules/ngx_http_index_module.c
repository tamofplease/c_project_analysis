# 0 "project/nginx/src/http/modules/ngx_http_index_module.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/http/modules/ngx_http_index_module.c"
...
# 9 "project/nginx/src/http/modules/ngx_http_index_module.c" 2
...
# 10 "project/nginx/src/http/modules/ngx_http_index_module.c" 2
...
# 11 "project/nginx/src/http/modules/ngx_http_index_module.c" 2



# 13 "project/nginx/src/http/modules/ngx_http_index_module.c"
typedef struct {
    ngx_str_t name;
    ngx_array_t *lengths;
    ngx_array_t *values;
...
static ngx_command_t ngx_http_index_commands[] = {
    ...
    { 
# 44 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
     { sizeof(
# 44 "project/nginx/src/http/modules/ngx_http_index_module.c"
     "index"
# 44 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
     ) - 1, (u_char *) 
# 44 "project/nginx/src/http/modules/ngx_http_index_module.c"
...
# 45 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
     0x02000000
# 45 "project/nginx/src/http/modules/ngx_http_index_module.c"
                       |
# 45 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                        0x04000000
# 45 "project/nginx/src/http/modules/ngx_http_index_module.c"
...
# 47 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
     __builtin_offsetof (ngx_http_conf_ctx_t, loc_conf)
# 47 "project/nginx/src/http/modules/ngx_http_index_module.c"
                             ,
      0,
      
# 49 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
     ((void *)0) 
# 49 "project/nginx/src/http/modules/ngx_http_index_module.c"
          },

      
# 51 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
     { { 0, ((void *)0) }, 0, ((void *)0), 0, 0, ((void *)0) }

# 52 "project/nginx/src/http/modules/ngx_http_index_module.c"
};


static ngx_http_module_t ngx_http_index_module_ctx = {
    
# 56 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
   ((void *)0)
# 56 "project/nginx/src/http/modules/ngx_http_index_module.c"
       ,
    ngx_http_index_init,

    
# 59 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
   ((void *)0)
# 59 "project/nginx/src/http/modules/ngx_http_index_module.c"
       ,
    
# 60 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
   ((void *)0)
# 60 "project/nginx/src/http/modules/ngx_http_index_module.c"
       ,

    
# 62 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
   ((void *)0)
# 62 "project/nginx/src/http/modules/ngx_http_index_module.c"
       ,
    
# 63 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
   ((void *)0)
# 63 "project/nginx/src/http/modules/ngx_http_index_module.c"
       ,
...
# 71 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
   (ngx_uint_t) -1, (ngx_uint_t) -1, ((void *)0), 0, 0, 1021005, 
# 71 "project/nginx/src/http/modules/ngx_http_index_module.c"
   "8" 
# 71 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
   "," 
# 71 "project/nginx/src/http/modules/ngx_http_index_module.c"
...
# 74 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
   0x50545448
# 74 "project/nginx/src/http/modules/ngx_http_index_module.c"
                  ,
    
# 75 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
   ((void *)0)
# 75 "project/nginx/src/http/modules/ngx_http_index_module.c"
       ,
    
# 76 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
   ((void *)0)
# 76 "project/nginx/src/http/modules/ngx_http_index_module.c"
       ,
    
# 77 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
   ((void *)0)
# 77 "project/nginx/src/http/modules/ngx_http_index_module.c"
       ,
    
# 78 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
   ((void *)0)
# 78 "project/nginx/src/http/modules/ngx_http_index_module.c"
       ,
    
# 79 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
   ((void *)0)
# 79 "project/nginx/src/http/modules/ngx_http_index_module.c"
       ,
    
# 80 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
   ((void *)0)
# 80 "project/nginx/src/http/modules/ngx_http_index_module.c"
       ,
    
# 81 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
   ((void *)0)
# 81 "project/nginx/src/http/modules/ngx_http_index_module.c"
       ,
    
# 82 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
   0, 0, 0, 0, 0, 0, 0, 0

# 83 "project/nginx/src/http/modules/ngx_http_index_module.c"
};
# 96 "project/nginx/src/http/modules/ngx_http_index_module.c"
static ngx_int_t
ngx_http_index_handler(ngx_http_request_t *r)
{
    ...
    if (r->uri.data[r->uri.len - 1] != '/') {
        return 
# 113 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
              -5
# 113 "project/nginx/src/http/modules/ngx_http_index_module.c"
                          ;
    }

    if (!(r->method & (
# 116 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                      0x00000002
# 116 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                  |
# 116 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                                   0x00000004
# 116 "project/nginx/src/http/modules/ngx_http_index_module.c"
...
# 116 "project/nginx/src/http/modules/ngx_http_index_module.c"
        ...
        return 
# 117 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
              -5
# 117 "project/nginx/src/http/modules/ngx_http_index_module.c"
                          ;
    }

    ilcf = 
# 120 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
          (
# 120 "project/nginx/src/http/modules/ngx_http_index_module.c"
          r
# 120 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
          )->loc_conf[
# 120 "project/nginx/src/http/modules/ngx_http_index_module.c"
...
# 120 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                                                ;
    clcf = 
# 121 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
          (
# 121 "project/nginx/src/http/modules/ngx_http_index_module.c"
          r
# 121 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
          )->loc_conf[
# 121 "project/nginx/src/http/modules/ngx_http_index_module.c"
...
# 121 "project/nginx/src/http/modules/ngx_http_index_module.c"
    ...
    dir_tested = 0;
    name = 
# 126 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
          ((void *)0)
# 126 "project/nginx/src/http/modules/ngx_http_index_module.c"
              ;

    path.data = 
# 128 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
               ((void *)0)
# 128 "project/nginx/src/http/modules/ngx_http_index_module.c"
                   ;
    ...
    for (i = 0; i < ilcf->indices->nelts; i++) {
        ...
        if (index[i].lengths == 
# 133 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                               ((void *)0)
# 133 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                   ) {
...
# 143 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
           (void) __builtin___memset_chk (
# 143 "project/nginx/src/http/modules/ngx_http_index_module.c"
           &e
# 143 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
           , 0, 
# 143 "project/nginx/src/http/modules/ngx_http_index_module.c"
...
# 143 "project/nginx/src/http/modules/ngx_http_index_module.c"
        ...
        if (reserve > allocated) {
            ...
            if (name == 
# 165 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                       ((void *)0)
# 165 "project/nginx/src/http/modules/ngx_http_index_module.c"
                           ) {
                return 
# 166 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                      500
# 166 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                                    ;
            }
        ...
        if (index[i].values == 
# 172 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                              ((void *)0)
# 172 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                  ) {



            
# 176 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
           (void) __builtin___memcpy_chk (
# 176 "project/nginx/src/http/modules/ngx_http_index_module.c"
           name
# 176 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
           , 
# 176 "project/nginx/src/http/modules/ngx_http_index_module.c"
...
# 203 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
       (void) __builtin___memset_chk (
# 203 "project/nginx/src/http/modules/ngx_http_index_module.c"
       &of
# 203 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
       , 0, 
# 203 "project/nginx/src/http/modules/ngx_http_index_module.c"
...
# 213 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                                                                 0
# 213 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                                                       ) {
            return 
# 214 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                  500
# 214 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                                ;
        }

        if (ngx_open_cached_file(clcf->open_file_cache, &path, &of, r->pool)
            != 
# 218 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
              0
# 218 "project/nginx/src/http/modules/ngx_http_index_module.c"
                    )
        {
            if (of.err == 0) {
                return 
# 221 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                      500
# 221 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                                    ;
            }
            ...
            if (of.err == 
# 228 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                         31
                
# 229 "project/nginx/src/http/modules/ngx_http_index_module.c"
               || of.err == 
# 229 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                            62
# 229 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                     )
            {
                return 
# 231 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                      403
# 231 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                        ;
            }


            if (of.err == 
# 235 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                         20
                
# 236 "project/nginx/src/http/modules/ngx_http_index_module.c"
               || of.err == 
# 236 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                            63
                
# 237 "project/nginx/src/http/modules/ngx_http_index_module.c"
               || of.err == 
# 237 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                            13
# 237 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                      )
            {
            ...
            if (!dir_tested) {
                ...
                if (rc != 
# 245 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                         0
# 245 "project/nginx/src/http/modules/ngx_http_index_module.c"
                               ) {
                    return rc;
                }
            ...
            if (of.err == 
# 252 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                         2
# 252 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                   ) {
                continue;
            }

            
# 256 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
           if ((
# 256 "project/nginx/src/http/modules/ngx_http_index_module.c"
           r->connection->log
# 256 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
...
# 257 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                                                  ;

            return 
# 259 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                  500
# 259 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                                ;
        }
        ...
        if (!clcf->alias) {
            ...
            if (uri.data == 
# 269 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                           ((void *)0)
# 269 "project/nginx/src/http/modules/ngx_http_index_module.c"
                               ) {
                return 
# 270 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                      500
# 270 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                                    ;
            }

            p = 
# 273 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
               (((u_char *) __builtin___memcpy_chk (
# 273 "project/nginx/src/http/modules/ngx_http_index_module.c"
               uri.data
# 273 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
               , 
# 273 "project/nginx/src/http/modules/ngx_http_index_module.c"
...
# 274 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
           (void) __builtin___memcpy_chk (
# 274 "project/nginx/src/http/modules/ngx_http_index_module.c"
           p
# 274 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
           , 
# 274 "project/nginx/src/http/modules/ngx_http_index_module.c"
...
# 274 "project/nginx/src/http/modules/ngx_http_index_module.c"
    ...
    return 
# 280 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
          -5
# 280 "project/nginx/src/http/modules/ngx_http_index_module.c"
                      ;
}
...
# 305 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
   (void) __builtin___memset_chk (
# 305 "project/nginx/src/http/modules/ngx_http_index_module.c"
   &of
# 305 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
   , 0, 
# 305 "project/nginx/src/http/modules/ngx_http_index_module.c"
...
# 305 "project/nginx/src/http/modules/ngx_http_index_module.c"
    ...
    if (ngx_http_set_disable_symlinks(r, clcf, &dir, &of) != 
# 312 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                                                            0
# 312 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                                                  ) {
        return 
# 313 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
              500
# 313 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                            ;
    }

    if (ngx_open_cached_file(clcf->open_file_cache, &dir, &of, r->pool)
        != 
# 317 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
          0
# 317 "project/nginx/src/http/modules/ngx_http_index_module.c"
                )
    {
        if (of.err) {
            ...
            if (of.err == 
# 322 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                         31
                
# 323 "project/nginx/src/http/modules/ngx_http_index_module.c"
               || of.err == 
# 323 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                            62
# 323 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                     )
            {
                return 
# 325 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                      403
# 325 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                        ;
            }


            if (of.err == 
# 329 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                         2
# 329 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                   ) {
                *last = c;
                return ngx_http_index_error(r, clcf, dir.data, 
# 331 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                                                              2
# 331 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                                                        );
            }

            if (of.err == 
# 334 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                         13
# 334 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                   ) {
                ...
                *last = c;
                ...
                return 
# 344 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                      0
# 344 "project/nginx/src/http/modules/ngx_http_index_module.c"
                            ;
            }

            
# 347 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
           if ((
# 347 "project/nginx/src/http/modules/ngx_http_index_module.c"
           r->connection->log
# 347 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
           )->log_level >= 3) ngx_log_error_core(3, 
# 347 "project/nginx/src/http/modules/ngx_http_index_module.c"
...
# 347 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
           , 
# 347 "project/nginx/src/http/modules/ngx_http_index_module.c"
           of.err, "%s \"%s\" failed", of.failed, dir.data
# 347 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
           )
                                                                  
# 348 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                                                 ;
        }

        return 
# 351 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
              500
# 351 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                            ;
    }
    ...
    *last = c;
    ...
    if (of.is_dir) {
        return 
# 357 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
              0
# 357 "project/nginx/src/http/modules/ngx_http_index_module.c"
                    ;
    }

    
# 360 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
   if ((
# 360 "project/nginx/src/http/modules/ngx_http_index_module.c"
   r->connection->log
# 360 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
...
# 360 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
   , 
# 360 "project/nginx/src/http/modules/ngx_http_index_module.c"
   0, "\"%s\" is not a directory", dir.data
# 360 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
   )
                                                        
# 361 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                                       ;

    return 
# 363 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
          500
# 363 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                        ;
}
...
{
    if (err == 
# 371 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
              13
# 371 "project/nginx/src/http/modules/ngx_http_index_module.c"
                        ) {
        
# 372 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
       if ((
# 372 "project/nginx/src/http/modules/ngx_http_index_module.c"
       r->connection->log
# 372 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
...
# 372 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
       , 
# 372 "project/nginx/src/http/modules/ngx_http_index_module.c"
       err, "\"%s\" is forbidden", file
# 372 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
       )
                                                  
# 373 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                                 ;

        return 
# 375 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
              403
# 375 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                ;
    }

    if (clcf->log_not_found) {
        
# 379 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
       if ((
# 379 "project/nginx/src/http/modules/ngx_http_index_module.c"
       r->connection->log
# 379 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
       )->log_level >= 4) ngx_log_error_core(4, 
# 379 "project/nginx/src/http/modules/ngx_http_index_module.c"
...
# 379 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
       , 
# 379 "project/nginx/src/http/modules/ngx_http_index_module.c"
       err, "\"%s\" is not found", file
# 379 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
       )
                                                  
# 380 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                                 ;
    }

    return 
# 383 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
          404
# 383 "project/nginx/src/http/modules/ngx_http_index_module.c"
                            ;
}
...
ngx_http_index_create_loc_conf(ngx_conf_t *cf)
{
    ...
    if (conf == 
# 393 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
               ((void *)0)
# 393 "project/nginx/src/http/modules/ngx_http_index_module.c"
                   ) {
        return 
# 394 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
              ((void *)0)
# 394 "project/nginx/src/http/modules/ngx_http_index_module.c"
                  ;
    }

    conf->indices = 
# 397 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                   ((void *)0)
# 397 "project/nginx/src/http/modules/ngx_http_index_module.c"
                       ;
...
ngx_http_index_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->indices == 
# 412 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                        ((void *)0)
# 412 "project/nginx/src/http/modules/ngx_http_index_module.c"
                            ) {
    ...
    if (conf->indices == 
# 417 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                        ((void *)0)
# 417 "project/nginx/src/http/modules/ngx_http_index_module.c"
                            ) {
        conf->indices = ngx_array_create(cf->pool, 1, sizeof(ngx_http_index_t));
        if (conf->indices == 
# 419 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                            ((void *)0)
# 419 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                ) {
            return 
# 420 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                  (void *) -1
# 420 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                ;
        }

        index = ngx_array_push(conf->indices);
        if (index == 
# 424 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                    ((void *)0)
# 424 "project/nginx/src/http/modules/ngx_http_index_module.c"
                        ) {
            return 
# 425 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                  (void *) -1
# 425 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                ;
        }
        ...
        index->lengths = 
# 430 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                        ((void *)0)
# 430 "project/nginx/src/http/modules/ngx_http_index_module.c"
                            ;
        index->values = 
# 431 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                       ((void *)0)
# 431 "project/nginx/src/http/modules/ngx_http_index_module.c"
                           ;

        conf->max_index_len = sizeof("index.html");

        return 
# 435 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
              ((void *)0)
# 435 "project/nginx/src/http/modules/ngx_http_index_module.c"
                         ;
    }

    return 
# 438 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
          ((void *)0)
# 438 "project/nginx/src/http/modules/ngx_http_index_module.c"
                     ;
}
...
ngx_http_index_init(ngx_conf_t *cf)
{
    ...
    cmcf = 
# 448 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
          ((ngx_http_conf_ctx_t *) 
# 448 "project/nginx/src/http/modules/ngx_http_index_module.c"
          cf
# 448 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
          ->ctx)->main_conf[
# 448 "project/nginx/src/http/modules/ngx_http_index_module.c"
...
# 448 "project/nginx/src/http/modules/ngx_http_index_module.c"
    ...
    if (h == 
# 451 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
            ((void *)0)
# 451 "project/nginx/src/http/modules/ngx_http_index_module.c"
                ) {
        return 
# 452 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
              -1
# 452 "project/nginx/src/http/modules/ngx_http_index_module.c"
                       ;
    }
    ...
    *h = ngx_http_index_handler;
    ...
    return 
# 457 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
          0
# 457 "project/nginx/src/http/modules/ngx_http_index_module.c"
                ;
}
...
ngx_http_index_set_index(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (ilcf->indices == 
# 473 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                        ((void *)0)
# 473 "project/nginx/src/http/modules/ngx_http_index_module.c"
                            ) {
        ilcf->indices = ngx_array_create(cf->pool, 2, sizeof(ngx_http_index_t));
        if (ilcf->indices == 
# 475 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                            ((void *)0)
# 475 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                ) {
            return 
# 476 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                  (void *) -1
# 476 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                ;
        }
    }
    ...
    for (i = 1; i < cf->args->nelts; i++) {
        ...
        if (value[i].data[0] == '/' && i != cf->args->nelts - 1) {
            ngx_conf_log_error(
# 485 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                              5
# 485 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                          , cf, 0,
        ...
        if (value[i].len == 0) {
            ngx_conf_log_error(
# 491 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                              1
# 491 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                           , cf, 0,
                               "index \"%V\" in \"index\" directive is invalid",
                               &value[1]);
            return 
# 494 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                  (void *) -1
# 494 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                ;
        }

        index = ngx_array_push(ilcf->indices);
        if (index == 
# 498 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                    ((void *)0)
# 498 "project/nginx/src/http/modules/ngx_http_index_module.c"
                        ) {
            return 
# 499 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                  (void *) -1
# 499 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                ;
        }
        ...
        index->lengths = 
# 504 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                        ((void *)0)
# 504 "project/nginx/src/http/modules/ngx_http_index_module.c"
                            ;
        index->values = 
# 505 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                       ((void *)0)
# 505 "project/nginx/src/http/modules/ngx_http_index_module.c"
                           ;
...
# 524 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
       (void) __builtin___memset_chk (
# 524 "project/nginx/src/http/modules/ngx_http_index_module.c"
       &sc
# 524 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
       , 0, 
# 524 "project/nginx/src/http/modules/ngx_http_index_module.c"
...
# 534 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                                           0
# 534 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                                 ) {
            return 
# 535 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
                  (void *) -1
# 535 "project/nginx/src/http/modules/ngx_http_index_module.c"
                                ;
        }
    }

    return 
# 539 "project/nginx/src/http/modules/ngx_http_index_module.c" 3 4
          ((void *)0)
# 539 "project/nginx/src/http/modules/ngx_http_index_module.c"
                     ;
}
