# 0 "project/nginx/src/http/ngx_http_upstream_round_robin.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/src/http/ngx_http_upstream_round_robin.h"
# 12 "project/nginx/src/http/ngx_http_upstream_round_robin.h"
...
# 13 "project/nginx/src/http/ngx_http_upstream_round_robin.h" 2
...
# 14 "project/nginx/src/http/ngx_http_upstream_round_robin.h" 2
...
# 15 "project/nginx/src/http/ngx_http_upstream_round_robin.h" 2



# 17 "project/nginx/src/http/ngx_http_upstream_round_robin.h"
...
# 128 "project/nginx/src/http/ngx_http_upstream_round_robin.h"
typedef struct {
    ngx_uint_t config;
