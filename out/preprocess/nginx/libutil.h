# 0 "project/nginx/libutil.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "project/nginx/libutil.h"
# 42 "project/nginx/libutil.h"
...
int realhostname_sa(char *host, size_t hsize, struct sockaddr *addr,
        int addrlen);
# 73 "project/nginx/libutil.h"
int reexec_to_match_kernel(void);
int reexec_to_match_lp64ness(
# 74 "project/nginx/libutil.h" 3 4
                            _Bool 
# 74 "project/nginx/libutil.h"
                                 isLP64);
