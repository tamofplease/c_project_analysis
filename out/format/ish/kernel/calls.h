...
struct uname {
    char system[UNAME_LENGTH];
    char hostname[UNAME_LENGTH];
    char release[UNAME_LENGTH];
    char version[UNAME_LENGTH];
    char arch[UNAME_LENGTH];
    char domain[UNAME_LENGTH];
};
