# 1 "project/radare2/shlr/capstone/arch/AArch64/AArch64InstPrinter.c"
# 17 "project/radare2/shlr/capstone/arch/AArch64/AArch64InstPrinter.c"
...
{
 while (Stride--) {
  if (Reg >= AArch64_Q0 && Reg <= AArch64_Q30)
   Reg += 1;
  else if (Reg == AArch64_Q31)
   Reg = AArch64_Q0;
  else if (Reg >= AArch64_Z0 && Reg <= AArch64_Z30)
   Reg += 1;
