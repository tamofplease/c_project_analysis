# 1 "project/radare2/libr/debug/p/debug_native.c"
...
R_API RList *r_w32_dbg_modules(RDebug *);
...
#elif __linux__ && !defined(WAIT_ON_ALL_CHILDREN)
static RDebugReasonType r_debug_native_wait(RDebug *dbg, int pid) {
 RDebugReasonType reason = R_DEBUG_REASON_UNKNOWN;
...
static bool ll_arm64_hwbp_set(pid_t pid, ut64 _addr, int size, int wp, ut32 type) {
 const volatile uint8_t *addr = (void*)(size_t)_addr;
...
# 1638 "project/radare2/libr/debug/p/debug_native.c"
