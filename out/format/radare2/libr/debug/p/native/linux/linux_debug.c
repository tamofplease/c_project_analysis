# 1 "project/radare2/libr/debug/p/native/linux/linux_debug.c"
...
# 210 "project/radare2/libr/debug/p/native/linux/linux_debug.c"
...
#endif
# 301 "project/radare2/libr/debug/p/native/linux/linux_debug.c"
static RDebugReasonType linux_handle_new_task(RDebug *dbg, int tid) {
 int ret, status;
 if (dbg->threads) {
  RDebugPid *th;
