...
# 559 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
...
{
# 1302 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
...
# 1547 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
static bfd_boolean
      ...
      struct bfd_link_info *info)
{
        ...
        && strcmp (name, ".got.loc") != 0)
 {
   ...
   continue;
      ...
      if (s->size == 0)
 {
# 1822 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
   s->flags |= SEC_EXCLUDE;
 }
...
# 2248 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
static bfd_reloc_status_type
...
# 2279 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
...
# 2726 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
   if (relaxing_section)
     {
...
#endif
# 3204 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
static int
...
# 4321 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
...
# 4375 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
struct string_pair
{
  const char *wide;
  const char *narrow;
...
# 4416 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
...
# 4580 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
static xtensa_insnbuf
...
# 4963 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
...
# 4980 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
static bfd_boolean
...
#endif
# 5109 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
...
# 5180 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
  if ((!a->is_null) - (!b->is_null))
    return ((!a->is_null) - (!b->is_null));
  return internal_reloc_compare (&a->r_rel.rela, &b->r_rel.rela);
}
# 5199 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
...
# 5443 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
...
# 5688 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
static int
...
#endif
# 5936 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
...
# 6200 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
...
# 6421 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
...
# 6470 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
...
# 6562 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
...
# 6780 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
...
# 7016 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
static bfd_boolean
...
# 7089 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
static bfd_boolean
...
# 7343 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
bfd_boolean
        ...
        bfd_boolean *is_reachable_p)
{
  ...
  *is_reachable_p = FALSE;
  ...
  if (target_sec->output_section != sec->output_section)
    {
# 7421 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
...
# 7720 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
bfd_boolean
...
# 8072 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
bfd_boolean
...
# 8089 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
...
# 8747 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
static bfd_boolean
...
# 9066 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
  value = 0;
  r_reloc_init (&r_rel, abfd, irel, contents, sec_size);
  if (!irel)
    {
...
# 9146 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
static bfd_boolean
...
# 9546 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
  ...
  (&relax_info->action_list, irel->r_offset);
   ...
   if (! elf_xtensa_ignore_discarded_relocs (sec)
     ...
     {
# 9585 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
...
# 10097 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
...
# 10135 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
static void
...
# 10237 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
static bfd_boolean
      ...
      for (i = 0; i < sec->reloc_count; i++)
 {
  ...
  removed_by_actions_map (&target_relax_info->action_list,
     old_offset, FALSE);
       ...
       if (old_size == 0)
  {
# 10459 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
...
# 10932 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
static asection *
...
# 11124 "project/radare2/libr/asm/arch/xtensa/gnu/elf32-xtensa.c"
