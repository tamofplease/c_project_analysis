# 1 "project/radare2/libr/asm/arch/ppc/gnu/ppc-opc.c"
# 23 "project/radare2/libr/asm/arch/ppc/gnu/ppc-opc.c"
#include <stdio.h>
#include "sysdep.h"
#include "opcode/ppc.h"
#include "opintl.h"
# 41 "project/radare2/libr/asm/arch/ppc/gnu/ppc-opc.c"
...
# 96 "project/radare2/libr/asm/arch/ppc/gnu/ppc-opc.c"
...
# 646 "project/radare2/libr/asm/arch/ppc/gnu/ppc-opc.c"
...
# 709 "project/radare2/libr/asm/arch/ppc/gnu/ppc-opc.c"
static unsigned long
...
valid_bo (long value, ppc_cpu_t dialect, int extract)
{
  if ((dialect & PPC_OPCODE_POWER4) == 0)
    {
      int valid;
# 817 "project/radare2/libr/asm/arch/ppc/gnu/ppc-opc.c"
      switch (value & 0x14)
 {
 default:
 case 0:
...
# 851 "project/radare2/libr/asm/arch/ppc/gnu/ppc-opc.c"
    if ((value & 0x14) == 0) {
     return (value & 0x1) == 0;
...
# 1317 "project/radare2/libr/asm/arch/ppc/gnu/ppc-opc.c"
#define TB (268)
...
# 1897 "project/radare2/libr/asm/arch/ppc/gnu/ppc-opc.c"
...
# 5162 "project/radare2/libr/asm/arch/ppc/gnu/ppc-opc.c"
