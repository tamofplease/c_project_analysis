# 1 "project/radare2/libr/asm/arch/tricore/gnu/tricore-dis.c"
# 19 "project/radare2/libr/asm/arch/tricore/gnu/tricore-dis.c"
#include <stdio.h>
#include <string.h>
#include <sys/types.h>
#include <stdbool.h>
...
# 1204 "project/radare2/libr/asm/arch/tricore/gnu/tricore-dis.c"
     ...
     struct disassemble_info *info;
{
  ...
  {
    "uc", "z", "nz", "v", "c/ult", "ugt", "slt", "sgt",
    "n", "nn", "nv", "nc/uge", "sge", "sle", "cnz", "cnn"
  };
#define DPRINT (*info->fprintf_func)
#define DFILE info->stream
...
# 1883 "project/radare2/libr/asm/arch/tricore/gnu/tricore-dis.c"
int
