...
#endif
 thisplay("ldrh r1, [r2, 8]");
 thisplay("ldrh r1, [r3, 8]");
 thisplay("ldrh r1, [r4, 16]");
 thisplay("ldrh r1, [r2, 32]");
 thisplay("ldrb r1, [r2, 20]");
 thisplay("strh r1, [r2, 20]");
 thisplay("strb r1, [r2, 20]");
 thisplay("str r1, [sp, 20]");
 thisplay("str r1, [r2, 12]");
