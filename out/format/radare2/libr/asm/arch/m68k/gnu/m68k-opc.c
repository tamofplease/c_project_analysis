# 1 "project/radare2/libr/asm/arch/m68k/gnu/m68k-opc.c"
# 21 "project/radare2/libr/asm/arch/m68k/gnu/m68k-opc.c"
#include "sysdep.h"
#include "opcode/m68k.h"

#define one(x) ((unsigned int) (x) << 16)
#define two(x,y) (((unsigned int) (x) << 16) + (y))
# 35 "project/radare2/libr/asm/arch/m68k/gnu/m68k-opc.c"
...
{"macw", 4, two(0xa000, 0x0000), two(0xf100, 0x0900), "uNuoiI4/RneG", mcfemac },
{"macw", 4, two(0xa000, 0x0200), two(0xf100, 0x0900), "uNuoMh4/RneG", mcfemac },
{"macw", 4, two(0xa000, 0x0000), two(0xf100, 0x0f00), "uNuo4/RneG", mcfemac },
{"macw", 4, two(0xa000, 0x0000), two(0xf130, 0x0900), "uMumiIeH", mcfemac },
{"macw", 4, two(0xa000, 0x0200), two(0xf130, 0x0900), "uMumMheH", mcfemac },
{"macw", 4, two(0xa000, 0x0000), two(0xf130, 0x0f00), "uMumeH", mcfemac },
...
# 1554 "project/radare2/libr/asm/arch/m68k/gnu/m68k-opc.c"
...
{"movel", 2, one(0xa180), one(0xf9f0), "eFRs", mcfemac },
{"movel", 2, one(0xab80), one(0xfbf0), "g]Rs", mcfemac },
{"movel", 2, one(0xa980), one(0xfff0), "G-Rs", mcfemac },
{"movel", 2, one(0xad80), one(0xfff0), "H-Rs", mcfemac },
{"movel", 2, one(0xa110), one(0xf9fc), "efeF", mcfemac },
{"movel", 2, one(0xa9c0), one(0xffff), "G-C-", mcfemac },
{"movel", 2, one(0xa100), one(0xf9f0), "RseF", mcfemac },
{"movel", 6, one(0xa13c), one(0xf9ff), "#leF", mcfemac },
{"movel", 2, one(0xab00), one(0xfbc0), "Rsg]", mcfemac },
{"movel", 6, one(0xab3c), one(0xfbff), "#lg]", mcfemac },
{"movel", 2, one(0xa900), one(0xffc0), "RsG-", mcfemac },
{"movel", 6, one(0xa93c), one(0xffff), "#lG-", mcfemac },
{"movel", 2, one(0xad00), one(0xffc0), "RsH-", mcfemac },
{"movel", 6, one(0xad3c), one(0xffff), "#lH-", mcfemac },
...
{"msacw", 4, two(0xa000, 0x0100), two(0xf100, 0x0900), "uNuoiI4/RneG", mcfemac },
{"msacw", 4, two(0xa000, 0x0300), two(0xf100, 0x0900), "uNuoMh4/RneG", mcfemac },
{"msacw", 4, two(0xa000, 0x0100), two(0xf100, 0x0f00), "uNuo4/RneG", mcfemac },
{"msacw", 4, two(0xa000, 0x0100), two(0xf130, 0x0900), "uMumiIeH", mcfemac },
{"msacw", 4, two(0xa000, 0x0300), two(0xf130, 0x0900), "uMumMheH", mcfemac },
{"msacw", 4, two(0xa000, 0x0100), two(0xf130, 0x0f00), "uMumeH", mcfemac },
...
# 2237 "project/radare2/libr/asm/arch/m68k/gnu/m68k-opc.c"
