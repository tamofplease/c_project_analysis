...
pyc_opcodes *opcode_14(void) {
 ...
 varargs_op (.op_obj = ret->opcodes, .op_name = "UNPACK_ARG", .op_code = 94);
 varargs_op (.op_obj = ret->opcodes, .op_name = "UNPACK_VARARG", .op_code = 99);
 name_op (.op_obj = ret->opcodes, .op_name = "LOAD_LOCAL", .op_code = 115);
 varargs_op (.op_obj = ret->opcodes, .op_name = "SET_FUNC_ARGS", .op_code = 117);
 varargs_op (.op_obj = ret->opcodes, .op_name = "RESERVE_FAST", .op_code = 123);
