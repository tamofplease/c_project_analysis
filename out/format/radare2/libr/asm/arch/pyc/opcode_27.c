...
pyc_opcodes *opcode_27(void) {
 ...
 def_op (.op_obj = ret->opcodes, .op_name = "LIST_APPEND", .op_code = 94, .pop = 2, .push = 1);

 def_op (.op_obj = ret->opcodes, .op_name = "BUILD_SET", .op_code = 104);
 ...
 name_op (.op_obj = ret->opcodes, .op_name = "IMPORT_NAME", .op_code = 108, .pop = 2, .push = 1);
