...
static const struct arc_operand_value arc_reg_names_a700[] =
{
  ...
  { "eret", 0x400, AUXREG_AC, 0 },
  { "erbta", 0x401, AUXREG_AC, 0},
  { "erstatus", 0x402,AUXREG_AC, 0},
  { "ecr" , 0x403, AUXREG_AC, 0 } ,
  { "efa" , 0x404, AUXREG_AC, 0 } ,

  { "icause1", 0x40A, AUXREG_AC, ARC_REGISTER_READONLY } ,

  { "icause2", 0x40B, AUXREG_AC, ARC_REGISTER_READONLY } ,

  { "auxienable",0x40C, AUXREG_AC, 0 } ,
  { "auxitrigger",0x40D, AUXREG_AC, 0} ,
  { "xpu" , 0x410, AUXREG_AC, 0 } ,
  { "xpk" , 0x411, AUXREG_AC, 0 } ,
  { "bta_l1" , 0x413, AUXREG_AC, 0} ,
  { "bta_l2" ,0x414, AUXREG_AC, 0 } ,
