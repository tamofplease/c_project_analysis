# 1 "project/radare2/libr/core/core.c"
...
R_API bool r_core_init(RCore *core) {
 ...
 core->rasm->syscall = r_syscall_ref (core->anal->syscall);
...
static void set_prompt(RCore *r) {
 ...
 if (r_config_get_i (r->config, "asm.segoff")) {
  ut32 sb = r_config_get_i (r->config, "anal.cs");
  ut32 sg = r_config_get_i (r->config, "asm.seggrn");
  ut32 a, b;
