# 1 "project/radare2/libr/core/p/core_java.c"
...
#define SET_ACC_FLAGS_ARGS " [addr cmf <value>]"
...
#define REPLACE_CLASS_NAME_DESC "rename class name"
...
#define INSERT_MREF_ARGS " C M S"
#define INSERT_MREF_DESC "add Method to Class with given method signature"
