# 1 "project/radare2/libr/anal/p/anal_x86_cs.c"
...
# 232 "project/radare2/libr/anal/p/anal_x86_cs.c"
...
static void anop_esil(RAnal *a, RAnalOp *op, ut64 addr, const ut8 *buf, int len, csh *handle, cs_insn *insn) {
 ...
 case X86_INS_PEXTRB:
  ...
  break;
# 727 "project/radare2/libr/anal/p/anal_x86_cs.c"
 case X86_INS_MOVSD:
...
static char *get_reg_profile(RAnal *anal) {
 ...
 case 64:
 {
  ...
  char *prof = r_str_newf ("%s%s", args_prof,
   ...
   "drx	dr6	.64	48	0\n"
   "drx	dr7	.64	56	0\n"
# 3770 "project/radare2/libr/anal/p/anal_x86_cs.c"
   "fpu    cwd .16 0   0\n"
   "fpu    swd .16 2   0\n"
   "fpu    ftw .16 4   0\n"
   "fpu    fop .16 6   0\n"
...
#define KW(d,ds,m,ms) r_list_append (l, r_search_keyword_new((const ut8*)d,ds,(const ut8*)m, ms, NULL))
 ...
 case 32:
  ...
  KW ("\xf3\x0f\x1e\xfb", 4, NULL, 0);
  break;
 case 64:
  KW ("\x55\x48\x89\xe5", 4, NULL, 0);
  KW ("\x55\x48\x8b\xec", 4, NULL, 0);
  KW ("\xf3\x0f\x1e\xfa", 4, NULL, 0);
  break;
 default:
  r_list_free (l);
  l = NULL;
