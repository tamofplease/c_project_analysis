# 1 "project/radare2/libr/anal/p/anal_arm_v35.c"
...
#define HASMEMINDEX64(x) (insn->operands[x].reg[1])
...
static const char *shift_type_name(ShiftType type) {
 ...
 case ShiftType_ROR:
  return "ror";
# 188 "project/radare2/libr/anal/p/anal_arm_v35.c"
 default:
  return "";
 }
}
...
static void opex64(RStrBuf *buf, Instruction *insn) {
 ...
 for (i = 0; i < OPCOUNT64 (); i++) {
  ...
  case FIMM32:
   ...
   break;
# 328 "project/radare2/libr/anal/p/anal_arm_v35.c"
  case SYS_REG:
  ...
  if (op->shiftType != ShiftType_NONE) {
   ...
   case ShiftType_ROR:
    ...
    break;
# 354 "project/radare2/libr/anal/p/anal_arm_v35.c"
   default:
    break;
   }
   pj_end (pj);
...
# 500 "project/radare2/libr/anal/p/anal_arm_v35.c"
...
static void anop64(RAnal *a, RAnalOp *op, Instruction *insn) {
 ut64 addr = op->addr;
# 773 "project/radare2/libr/anal/p/anal_arm_v35.c"
...
static int analop_esil(RAnal *a, RAnalOp *op, ut64 addr, const ut8 *buf, int len, Instruction *insn) {
 ...
 case ARM64_CLZ:
 {
# 1695 "project/radare2/libr/anal/p/anal_arm_v35.c"
...
# 1828 "project/radare2/libr/anal/p/anal_arm_v35.c"
     if (ISREG64 (2)) {
...
# 1918 "project/radare2/libr/anal/p/anal_arm_v35.c"
     if (ISREG64 (2)) {
...
# 2099 "project/radare2/libr/anal/p/anal_arm_v35.c"
     if (ISREG64 (2)) {
 ...
 case ARM64_ADRP:
  ...
  break;
 case ARM64_EXTR:
# 2244 "project/radare2/libr/anal/p/anal_arm_v35.c"
