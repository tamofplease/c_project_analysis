# 1 "project/radare2/libr/anal/p/anal_arm_cs.c"
...
static int analop64_esil(RAnal *a, RAnalOp *op, ut64 addr, const ut8 *buf, int len, csh *handle, cs_insn *insn) {
 ...
 case ARM64_INS_CLZ:
 {
# 1667 "project/radare2/libr/anal/p/anal_arm_cs.c"
...
# 1792 "project/radare2/libr/anal/p/anal_arm_cs.c"
     if (ISREG64 (2)) {
...
# 1885 "project/radare2/libr/anal/p/anal_arm_cs.c"
     if (ISREG64 (2)) {
...
# 2013 "project/radare2/libr/anal/p/anal_arm_cs.c"
     if (ISREG64 (2)) {
 ...
 case ARM64_INS_ADRP:
  ...
  break;
 case ARM64_INS_EXTR:
# 2157 "project/radare2/libr/anal/p/anal_arm_cs.c"
