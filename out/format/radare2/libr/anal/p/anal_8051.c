...
static void analop_esil(RAnal *a, RAnalOp *op, ut64 addr, const ut8 *buf) {
 ...
 case 0x23:
  ...
  break;
 template_alu4 (0x20, "+", flag_c flag_ac flag_ov flag_p)
 case 0x33:
  e ("c,1,&,a,a,+=,7,$c,c,:=,a,+=," flag_p);
  break;
 template_alu4_c (0x30, "+", flag_c flag_ac flag_ov flag_p)
 template_alu2 (0x40, "|")
 template_alu4 (0x40, "|", flag_p)
 template_alu2 (0x50, "&")
 template_alu4 (0x50, "&", flag_p)
 template_alu2 (0x60, "^")
 template_alu4 (0x60, "^", flag_p)
 case 0x72:
  bit_r; xi (c, "|");
  break;
 case 0x73:
 ...
 case 0x93:
  e ("a,dptr,+,[1],a,=," flag_p);
  break;
 template_alu4_c (0x90, "-", flag_b flag_ab flag_ob flag_p)
 case 0xA0:
  bit_r; e ("!,"); xi (c, "|");
  break;
 case 0xA2:
