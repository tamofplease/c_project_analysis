...
R_API char *r_graph_drawable_to_dot(RGraph *graph, const char *node_properties, const char *edge_properties) {
...
R_API void r_graph_drawable_to_json(RGraph *graph, PJ *pj, bool use_offset) {
