...
# 485 "project/nginx/src/event/ngx_event_openssl.c"
...
# 1410 "project/nginx/src/event/ngx_event_openssl.c"
#if (defined SSL_CTX_set1_curves_list || defined SSL_CTRL_SET_CURVES_LIST)
# 1424 "project/nginx/src/event/ngx_event_openssl.c"
    ...
    char *text)
{
    ...
    if (sslerr == SSL_ERROR_SYSCALL) {
        ...
        if (n == SSL_R_BAD_CHANGE_CIPHER_SPEC
            ...
            || n == SSL_R_NO_SUITABLE_SIGNATURE_ALGORITHM
#endif
            ...
            || n == SSL_R_CLIENTHELLO_TLSEXT
#endif
#ifdef SSL_R_PARSE_TLSEXT
            || n == SSL_R_PARSE_TLSEXT
#endif
#ifdef SSL_R_CALLBACK_FAILED
            || n == SSL_R_CALLBACK_FAILED
#endif
#ifdef SSL_R_NO_APPLICATION_PROTOCOL
            || n == SSL_R_NO_APPLICATION_PROTOCOL
#endif
            ...
            || n == SSL_R_NO_COMMON_SIGNATURE_ALGORITHMS
#endif
            ...
            || n == SSL_R_CERT_CB_ERROR
#endif
#ifdef SSL_R_VERSION_TOO_LOW
            || n == SSL_R_VERSION_TOO_LOW
#endif
            || n == 1000
