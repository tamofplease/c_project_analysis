# 1 "project/nginx/src/stream/ngx_stream_upstream_random_module.c"
...
static ngx_stream_module_t ngx_stream_upstream_random_module_ctx = {
    ...
    ngx_stream_upstream_random_create_conf,
    NULL
};
...
ngx_module_t ngx_stream_upstream_random_module = {
    NGX_MODULE_V1,
    &ngx_stream_upstream_random_module_ctx,
    ngx_stream_upstream_random_commands,
    NGX_STREAM_MODULE,
    NULL,
    NULL,
    NULL,
