# 1 "project/nginx/src/http/modules/ngx_http_realip_module.c"
...
ngx_module_t ngx_http_realip_module = {
    NGX_MODULE_V1,
    &ngx_http_realip_module_ctx,
    ngx_http_realip_commands,
    NGX_HTTP_MODULE,
    NULL,
    NULL,
    NULL,
...
# 471 "project/nginx/src/http/modules/ngx_http_realip_module.c"
