# 1 "project/nginx/src/http/modules/ngx_http_headers_filter_module.c"
...
ngx_module_t ngx_http_headers_filter_module = {
    NGX_MODULE_V1,
    &ngx_http_headers_filter_module_ctx,
...
# 674 "project/nginx/src/http/modules/ngx_http_headers_filter_module.c"
