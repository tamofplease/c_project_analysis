# 1 "project/nginx/src/http/modules/ngx_http_browser_module.c"
...
#include <ngx_core.h>
#include <ngx_http.h>
# 20 "project/nginx/src/http/modules/ngx_http_browser_module.c"
...
ngx_module_t ngx_http_browser_module = {
    NGX_MODULE_V1,
    &ngx_http_browser_module_ctx,
    ngx_http_browser_commands,
    NGX_HTTP_MODULE,
    NULL,
    NULL,
    NULL,
...
# 153 "project/nginx/src/http/modules/ngx_http_browser_module.c"
    { "opera",
      0,
      sizeof("Opera ") - 1,
      "Opera"},
    ...
    { "msie",
      ...
      sizeof("MSIE ") - 1,
      "MSIE "},
# 176 "project/nginx/src/http/modules/ngx_http_browser_module.c"
    { "gecko",
      sizeof("Mozilla/5.0 (") - 1,
      sizeof("rv:") - 1,
      "rv:"},
# 192 "project/nginx/src/http/modules/ngx_http_browser_module.c"
    { "safari",
      sizeof("Mozilla/5.0 (") - 1,
      sizeof("Safari/") - 1,
      "Safari/"},
# 204 "project/nginx/src/http/modules/ngx_http_browser_module.c"
    { "konqueror",
...
# 439 "project/nginx/src/http/modules/ngx_http_browser_module.c"
    return conf;
}
