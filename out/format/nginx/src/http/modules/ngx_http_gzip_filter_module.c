# 1 "project/nginx/src/http/modules/ngx_http_gzip_filter_module.c"
...
ngx_http_gzip_body_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    if (ctx->buffering) {
# 325 "project/nginx/src/http/modules/ngx_http_gzip_filter_module.c"
        if (in) {
...
# 509 "project/nginx/src/http/modules/ngx_http_gzip_filter_module.c"
...
# 1069 "project/nginx/src/http/modules/ngx_http_gzip_filter_module.c"
