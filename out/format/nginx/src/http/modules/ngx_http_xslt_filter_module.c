# 1 "project/nginx/src/http/modules/ngx_http_xslt_filter_module.c"
...
typedef struct {
    ngx_array_t dtd_files;
    ngx_array_t sheet_files;
...
# 1088 "project/nginx/src/http/modules/ngx_http_xslt_filter_module.c"
