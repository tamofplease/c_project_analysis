# 1 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
# 9 "project/nginx/src/http/modules/ngx_http_gunzip_filter_module.c"
...
ngx_module_t ngx_http_gunzip_filter_module = {
    NGX_MODULE_V1,
    &ngx_http_gunzip_filter_module_ctx,
    ngx_http_gunzip_filter_commands,
    NGX_HTTP_MODULE,
    NULL,
    NULL,
    NULL,
