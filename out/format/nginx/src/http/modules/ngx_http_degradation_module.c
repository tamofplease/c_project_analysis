# 1 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
...
ngx_module_t ngx_http_degradation_module = {
    NGX_MODULE_V1,
    &ngx_http_degradation_module_ctx,
    ngx_http_degradation_commands,
    NGX_HTTP_MODULE,
    NULL,
    NULL,
    NULL,
...
ngx_http_degraded(ngx_http_request_t *r)
{
    ...
    if (dmcf->sbrk_size) {
        ...
        if (now != sbrk_time) {
# 132 "project/nginx/src/http/modules/ngx_http_degradation_module.c"
