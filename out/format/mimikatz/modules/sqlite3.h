...
# 33 "project/mimikatz/modules/sqlite3.h"
#ifndef SQLITE3_H
#define SQLITE3_H 
#include <stdarg.h>
...
#endif
# 83 "project/mimikatz/modules/sqlite3.h"
...
#endif
# 126 "project/mimikatz/modules/sqlite3.h"
...
# 189 "project/mimikatz/modules/sqlite3.h"
...
# 267 "project/mimikatz/modules/sqlite3.h"
...
# 425 "project/mimikatz/modules/sqlite3.h"
#define SQLITE_OK 0
...
# 476 "project/mimikatz/modules/sqlite3.h"
...
# 551 "project/mimikatz/modules/sqlite3.h"
...
# 607 "project/mimikatz/modules/sqlite3.h"
...
# 630 "project/mimikatz/modules/sqlite3.h"
#define SQLITE_LOCK_NONE 0
#define SQLITE_LOCK_SHARED 1
#define SQLITE_LOCK_RESERVED 2
#define SQLITE_LOCK_PENDING 3
#define SQLITE_LOCK_EXCLUSIVE 4
# 662 "project/mimikatz/modules/sqlite3.h"
...
# 1112 "project/mimikatz/modules/sqlite3.h"
...
# 1406 "project/mimikatz/modules/sqlite3.h"
#define SQLITE_ACCESS_EXISTS 0
#define SQLITE_ACCESS_READWRITE 1
#define SQLITE_ACCESS_READ 2
# 1432 "project/mimikatz/modules/sqlite3.h"
#define SQLITE_SHM_UNLOCK 1
#define SQLITE_SHM_LOCK 2
#define SQLITE_SHM_SHARED 4
#define SQLITE_SHM_EXCLUSIVE 8
# 1445 "project/mimikatz/modules/sqlite3.h"
...
# 2007 "project/mimikatz/modules/sqlite3.h"
...
# 2264 "project/mimikatz/modules/sqlite3.h"
...
# 2995 "project/mimikatz/modules/sqlite3.h"
#define SQLITE_DENY 1
#define SQLITE_IGNORE 2
# 3018 "project/mimikatz/modules/sqlite3.h"
...
# 3142 "project/mimikatz/modules/sqlite3.h"
...
# 3687 "project/mimikatz/modules/sqlite3.h"
...
# 3735 "project/mimikatz/modules/sqlite3.h"
...
# 4520 "project/mimikatz/modules/sqlite3.h"
...
# 5007 "project/mimikatz/modules/sqlite3.h"
#define SQLITE_DETERMINISTIC 0x000000800
#define SQLITE_DIRECTONLY 0x000080000
#define SQLITE_SUBTYPE 0x000100000
# 5021 "project/mimikatz/modules/sqlite3.h"
...
# 5686 "project/mimikatz/modules/sqlite3.h"
...
# 6604 "project/mimikatz/modules/sqlite3.h"
#define SQLITE_INDEX_SCAN_UNIQUE 1
# 6614 "project/mimikatz/modules/sqlite3.h"
...
# 7281 "project/mimikatz/modules/sqlite3.h"
#ifndef NDEBUG
SQLITE_API int sqlite3_mutex_held(sqlite3_mutex*);
SQLITE_API int sqlite3_mutex_notheld(sqlite3_mutex*);
#endif
# 7296 "project/mimikatz/modules/sqlite3.h"
...
# 7398 "project/mimikatz/modules/sqlite3.h"
...
# 7713 "project/mimikatz/modules/sqlite3.h"
...
# 7860 "project/mimikatz/modules/sqlite3.h"
...
# 7957 "project/mimikatz/modules/sqlite3.h"
...
# 8799 "project/mimikatz/modules/sqlite3.h"
...
# 8860 "project/mimikatz/modules/sqlite3.h"
...
# 8920 "project/mimikatz/modules/sqlite3.h"
#define SQLITE_ROLLBACK 1

#define SQLITE_FAIL 3

#define SQLITE_REPLACE 5
# 8973 "project/mimikatz/modules/sqlite3.h"
...
# 9143 "project/mimikatz/modules/sqlite3.h"
...
# 9422 "project/mimikatz/modules/sqlite3.h"
...
# 9483 "project/mimikatz/modules/sqlite3.h"
...
#endif
#endif
# 9514 "project/mimikatz/modules/sqlite3.h"
...
extern "C" {
#endif
# 9638 "project/mimikatz/modules/sqlite3.h"
...
# 9679 "project/mimikatz/modules/sqlite3.h"
SQLITE_API int sqlite3session_create(
  sqlite3 *db,
  const char *zDb,
  sqlite3_session **ppSession
);
# 9698 "project/mimikatz/modules/sqlite3.h"
SQLITE_API void sqlite3session_delete(sqlite3_session *pSession);
# 9719 "project/mimikatz/modules/sqlite3.h"
SQLITE_API int sqlite3session_enable(sqlite3_session *pSession, int bEnable);
# 9749 "project/mimikatz/modules/sqlite3.h"
SQLITE_API int sqlite3session_indirect(sqlite3_session *pSession, int bIndirect);
# 9809 "project/mimikatz/modules/sqlite3.h"
SQLITE_API int sqlite3session_attach(
  sqlite3_session *pSession,
  const char *zTab
);
# 9824 "project/mimikatz/modules/sqlite3.h"
...
# 9938 "project/mimikatz/modules/sqlite3.h"
SQLITE_API int sqlite3session_changeset(
  sqlite3_session *pSession,
  int *pnChangeset,
  void **ppChangeset
);
# 10001 "project/mimikatz/modules/sqlite3.h"
...
# 10038 "project/mimikatz/modules/sqlite3.h"
SQLITE_API int sqlite3session_patchset(
  sqlite3_session *pSession,
  int *pnPatchset,
  void **ppPatchset
);
# 10059 "project/mimikatz/modules/sqlite3.h"
SQLITE_API int sqlite3session_isempty(sqlite3_session *pSession);
# 10102 "project/mimikatz/modules/sqlite3.h"
...
# 10125 "project/mimikatz/modules/sqlite3.h"
#define SQLITE_CHANGESETSTART_INVERT 0x0002
# 10151 "project/mimikatz/modules/sqlite3.h"
SQLITE_API int sqlite3changeset_next(sqlite3_changeset_iter *pIter);
# 10180 "project/mimikatz/modules/sqlite3.h"
...
# 10214 "project/mimikatz/modules/sqlite3.h"
SQLITE_API int sqlite3changeset_pk(
  sqlite3_changeset_iter *pIter,
  unsigned char **pabPK,
  int *pnCol
);
# 10245 "project/mimikatz/modules/sqlite3.h"
SQLITE_API int sqlite3changeset_old(
  sqlite3_changeset_iter *pIter,
  int iVal,
  sqlite3_value **ppValue
);
# 10279 "project/mimikatz/modules/sqlite3.h"
SQLITE_API int sqlite3changeset_new(
  sqlite3_changeset_iter *pIter,
  int iVal,
  sqlite3_value **ppValue
);
# 10307 "project/mimikatz/modules/sqlite3.h"
SQLITE_API int sqlite3changeset_conflict(
  sqlite3_changeset_iter *pIter,
  int iVal,
  sqlite3_value **ppValue
);
# 10324 "project/mimikatz/modules/sqlite3.h"
SQLITE_API int sqlite3changeset_fk_conflicts(
  sqlite3_changeset_iter *pIter,
  int *pnOut
);
# 10360 "project/mimikatz/modules/sqlite3.h"
SQLITE_API int sqlite3changeset_finalize(sqlite3_changeset_iter *pIter);
# 10390 "project/mimikatz/modules/sqlite3.h"
SQLITE_API int sqlite3changeset_invert(
  int nIn, const void *pIn,
  int *pnOut, void **ppOut
);
# 10421 "project/mimikatz/modules/sqlite3.h"
...
# 10437 "project/mimikatz/modules/sqlite3.h"
typedef struct sqlite3_changegroup sqlite3_changegroup;
# 10475 "project/mimikatz/modules/sqlite3.h"
SQLITE_API int sqlite3changegroup_new(sqlite3_changegroup **pp);
# 10553 "project/mimikatz/modules/sqlite3.h"
SQLITE_API int sqlite3changegroup_add(sqlite3_changegroup*, int nData, void *pData);
# 10580 "project/mimikatz/modules/sqlite3.h"
...
# 10750 "project/mimikatz/modules/sqlite3.h"
...
# 10804 "project/mimikatz/modules/sqlite3.h"
#define SQLITE_CHANGESETAPPLY_NOSAVEPOINT 0x0001
#define SQLITE_CHANGESETAPPLY_INVERT 0x0002
# 10862 "project/mimikatz/modules/sqlite3.h"
#define SQLITE_CHANGESET_DATA 1
#define SQLITE_CHANGESET_NOTFOUND 2
#define SQLITE_CHANGESET_CONFLICT 3
#define SQLITE_CHANGESET_CONSTRAINT 4
#define SQLITE_CHANGESET_FOREIGN_KEY 5
# 10899 "project/mimikatz/modules/sqlite3.h"
#define SQLITE_CHANGESET_OMIT 0
#define SQLITE_CHANGESET_REPLACE 1
#define SQLITE_CHANGESET_ABORT 2
# 11001 "project/mimikatz/modules/sqlite3.h"
typedef struct sqlite3_rebaser sqlite3_rebaser;
# 11012 "project/mimikatz/modules/sqlite3.h"
SQLITE_API int sqlite3rebaser_create(sqlite3_rebaser **ppNew);
# 11023 "project/mimikatz/modules/sqlite3.h"
SQLITE_API int sqlite3rebaser_configure(
  sqlite3_rebaser*,
  int nRebase, const void *pRebase
);
# 11042 "project/mimikatz/modules/sqlite3.h"
SQLITE_API int sqlite3rebaser_rebase(
  sqlite3_rebaser*,
  int nIn, const void *pIn,
  int *pnOut, void **ppOut
);
# 11056 "project/mimikatz/modules/sqlite3.h"
SQLITE_API void sqlite3rebaser_delete(sqlite3_rebaser *p);
# 11148 "project/mimikatz/modules/sqlite3.h"
...
# 11264 "project/mimikatz/modules/sqlite3.h"
...
#endif
# 11302 "project/mimikatz/modules/sqlite3.h"
#ifndef _FTS5_H
#define _FTS5_H 
