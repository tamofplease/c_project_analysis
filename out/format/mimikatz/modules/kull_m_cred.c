...
PKULL_M_CRED_ATTRIBUTE kull_m_cred_attribute_create(PVOID data )
{
...
PKULL_M_CRED_LEGACY_CREDS_BLOB kull_m_cred_legacy_creds_create(PVOID data )
{
...
PKULL_M_CRED_LEGACY_CRED_BLOB kull_m_cred_legacy_cred_create(PVOID data )
{
...
PKULL_M_CRED_VAULT_POLICY kull_m_cred_vault_policy_create(PVOID data )
{
...
PKULL_M_CRED_VAULT_POLICY_KEY kull_m_cred_vault_policy_key_create(PVOID data )
{
...
PKULL_M_CRED_VAULT_CREDENTIAL kull_m_cred_vault_credential_create(PVOID data )
{
