...
const KIWI_DATETIME_FORMATS STRING_TO_FILETIME_FORMATS[] = {
 {L"%hu/%hu/%hu %hu:%hu:%hu", 4, 1, 2, 3, 4, 5, 6},
 {L"%hu/%hu/%hu %hu:%hu:%hu", 4, 3, 2, 1, 4, 5, 6},
 {L"%hu-%hu-%hu %hu:%hu:%hu", 4, 1, 2, 3, 4, 5, 6},

 {L"%hu/%hu %hu:%hu:%hu", 3, 0, 2, 1, 3, 4, 5},
 {L"%hu-%hu %hu:%hu:%hu", 3, 0, 1, 2, 3, 4, 5},
 {L"%hu %hu:%hu:%hu", 2, 0, 0, 1, 2, 3, 4},

 {L"%hu:%hu:%hu", 2, 0, 0, 0, 1, 2, 3},

 {L"%hu/%hu/%hu", 2, 1, 2, 3, 0, 0, 0},
 {L"%hu/%hu/%hu", 2, 3, 2, 1, 0, 0, 0},
 {L"%hu-%hu-%hu", 2, 1, 2, 3, 0, 0, 0},

 {L"%hu/%hu", 2, 2, 1, 0, 0, 0, 0},
 {L"%hu-%hu", 2, 0, 1, 2, 0, 0, 0},
};
