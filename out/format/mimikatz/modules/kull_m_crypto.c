# 1 "/Users/tamofplease/Workspace/research/docker-exp/workspace/mimikatz/modules/kull_m_crypto.c"
...
BOOL kull_m_crypto_hkey_session(ALG_ID calgid, LPCVOID key, DWORD keyLen, DWORD flags, HCRYPTKEY *hSessionKey, HCRYPTPROV *hSessionProv)
{
 ...
 if(container = kull_m_string_getRandomGUID())
 {
  ...
  {
   hPrivateKey = 0;
   if(CryptGenKey(*hSessionProv, AT_KEYEXCHANGE, CRYPT_EXPORTABLE | (RSA1024BIT_KEY / 2), &hPrivateKey))
   {
    if(CryptExportKey(hPrivateKey, 0, PRIVATEKEYBLOB, 0, NULL, &dwkeyblob))
    {
     if(keyblob = (LPBYTE)LocalAlloc(LPTR, dwkeyblob))
     {
       ...
       *ptr = 1;
       ...
       {
        dwkeyblob = (1024 / 2 / 8) + sizeof(ALG_ID) + sizeof(BLOBHEADER);
...
const KULL_M_CRYPTO_DUAL_STRING_DWORD kull_m_crypto_cert_prop_id[] = {
 ...
 {L"CERT_SMART_CARD_READER_PROP_ID", 101},
 {L"CERT_SEND_AS_TRUSTED_ISSUER_PROP_ID", 102},
 {L"CERT_KEY_REPAIR_ATTEMPTED_PROP_ID", 103},
 {L"CERT_DISALLOWED_FILETIME_PROP_ID", 104},
 {L"CERT_ROOT_PROGRAM_CHAIN_POLICIES_PROP_ID", 105},
 {L"CERT_SMART_CARD_READER_NON_REMOVABLE_PROP_ID", 106},
 {L"CERT_SHA256_HASH_PROP_ID", 107},
 {L"CERT_SCEP_SERVER_CERTS_PROP_ID", 108},
 {L"CERT_SCEP_RA_SIGNATURE_CERT_PROP_ID", 109},
 {L"CERT_SCEP_RA_ENCRYPTION_CERT_PROP_ID", 110},
 {L"CERT_SCEP_CA_CERT_PROP_ID", 111},
 {L"CERT_SCEP_SIGNER_CERT_PROP_ID", 112},
 {L"CERT_SCEP_NONCE_PROP_ID", 113},
 {L"CERT_SCEP_ENCRYPT_HASH_CNG_ALG_PROP_ID", 114},
 {L"CERT_SCEP_FLAGS_PROP_ID", 115},
 {L"CERT_SCEP_GUID_PROP_ID", 116},
 {L"CERT_SERIALIZABLE_KEY_CONTEXT_PROP_ID", 117},
 {L"CERT_ISOLATED_KEY_PROP_ID", 118},
 {L"CERT_SERIAL_CHAIN_PROP_ID", 119},
 {L"CERT_KEY_CLASSIFICATION_PROP_ID", 120},
 {L"CERT_OCSP_MUST_STAPLE_PROP_ID", 121},
 {L"CERT_DISALLOWED_ENHKEY_USAGE_PROP_ID", 122},
 {L"CERT_NONCOMPLIANT_ROOT_URL_PROP_ID", 123},
};
...
const PCWCHAR BCRYPT_MODE_DESCR[] = {BCRYPT_CHAIN_MODE_NA, BCRYPT_CHAIN_MODE_CBC, BCRYPT_CHAIN_MODE_ECB, BCRYPT_CHAIN_MODE_CFB, L"ChainingModeCCM", L"ChainingModeGCM"};
