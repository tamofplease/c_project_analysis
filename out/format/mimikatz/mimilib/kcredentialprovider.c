...
HRESULT STDMETHODCALLTYPE GetSerializationNew(IUnknown* This, PVOID pcpgsr, CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION* pcpcs, LPWSTR* ppszOptionalStatusText, PVOID pcpsiOptionalStatusIcon)
{
...
HRESULT(STDMETHODCALLTYPE GetCredentialAt)(IUnknown* This, DWORD dwIndex, ICredentialProviderCredential** ppcpc)
{
 ...
 VirtualProtect(&((*ppcpc)->lpVtbl->GetSerialization), sizeof(LONG_PTR), dwOld, &dwOld);
...
HRESULT CEIDProvider_CreateInstance(REFIID riid, void** ppv)
{
 ...
 VirtualProtect(&(object->lpVtbl->GetCredentialAt), sizeof(LONG_PTR), dwOld, &dwOld);
...
HRESULT STDMETHODCALLTYPE CClassFactoryQueryInterface(IClassFactory* This, REFIID riid, void** ppvObject)
{
 HRESULT hr;
 if (ppvObject != NULL)
 {
...
HRESULT STDMETHODCALLTYPE CClassFactoryCreateInstance(IClassFactory* This, IUnknown* pUnkOuter, REFIID riid, void** ppvObject)
{
 HRESULT hr;
 if (!pUnkOuter)
 {
...
HRESULT STDMETHODCALLTYPE CClassFactoryLockServer(IClassFactory* This, BOOL fLock)
{
 if (fLock)
 {
