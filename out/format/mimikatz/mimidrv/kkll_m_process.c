# 1 "/Users/tamofplease/Workspace/research/docker-exp/workspace/mimikatz/mimidrv/kkll_m_process.c"
...
const ULONG EPROCESS_OffSetTable[KiwiOsIndex_MAX][Eprocess_MAX] =
{
         ...
         {0x0088},
          {0x0098},
           {0x00a0, 0x0224, 0x0040},
        {0x00b8, 0x026c, 0x0040},
        {0x00b8, 0x00c0, 0x0040, 0x02d4},
           {0x00b8, 0x00c0, 0x0040, 0x02cc},
            {0x00b8, 0x00c0, 0x0040, 0x02dc},
            {0x00b8, 0x00c0, 0x0040, 0x02dc},
            {0x00b8, 0x00c0, 0x0040, 0x02ec},
            {0x00b8, 0x00c0, 0x0040, 0x02ec},
            {0x00b8, 0x00c0, 0x0040, 0x02ec},
            {0x00b8, 0x00c0, 0x0040, 0x02ec},
            {0x00b8, 0x00c8, 0x0040, 0x02f4},
            {0x00b8, 0x00c8, 0x0040, 0x0364},
            {0x00b8, 0x00c8, 0x0040, 0x0364},
            {0x00e8, 0x00f8, 0x0040, 0x03a4},
#else
          {0},
         {0},
          {0x00e0},
           {0x00e8, 0x036c, 0x0040},
        {0x0188, 0x043c, 0x0040},
        {0x02e8, 0x02f8, 0x0040, 0x0648},
           {0x02e8, 0x02f8, 0x0040, 0x0678},
            {0x02f0, 0x0300, 0x0040, 0x06a8},
            {0x02f0, 0x0300, 0x0040, 0x06b0},
            {0x02f0, 0x0300, 0x0040, 0x06c8},
            {0x02e8, 0x0300, 0x0040, 0x06c8},
            {0x02e8, 0x0300, 0x0040, 0x06c8},
            {0x02e8, 0x0300, 0x0040, 0x06c8},
            {0x02e8, 0x0300, 0x0040, 0x06c8},
            {0x02f0, 0x0308, 0x0040, 0x06f8},
            {0x02f0, 0x0308, 0x0040, 0x06f8},
            {0x0448, 0x0460, 0x0040, 0x0878},
#endif
};
