 ...
 if(pIoStackIrp)
 {
  ...
  switch(pIoStackIrp->Parameters.DeviceIoControl.IoControlCode)
  {
   ...
   case IOCTL_MIMIDRV_PROCESS_LIST:
    status = kkll_m_process_enum(szBufferIn, bufferIn, &kOutputBuffer, kkll_m_process_list_callback, NULL);
    break;
   ...
   case IOCTL_MIMIDRV_MODULE_LIST:
    status = kkll_m_modules_enum(szBufferIn, bufferIn, &kOutputBuffer, kkll_m_modules_list_callback, NULL);
    break;
