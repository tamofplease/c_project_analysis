# 1 "/Users/tamofplease/Workspace/research/docker-exp/workspace/mimikatz/mimidrv/kkll_m_filters.c"
...
#if defined(_M_IX86)
          {0},
         {0x007c, 0x000c, 0x0010, 0x002c},
          {0x007c, 0x000c, 0x0010, 0x002c},
           {0x004c, 0x000c, 0x0010, 0x0030},
        {0x004c, 0x000c, 0x0010, 0x0030},
        {0x004c, 0x000c, 0x0010, 0x0030},
           {0x004c, 0x000c, 0x0010, 0x0030},
            {0x004c, 0x000c, 0x0010, 0x0040},
            {0x004c, 0x000c, 0x0010, 0x0040},
            {0x004c, 0x000c, 0x0010, 0x0040},
            {0x004c, 0x000c, 0x0010, 0x0040},
            {0x004c, 0x000c, 0x0010, 0x0040},
          ...
          {0},
         {0},
          {0x00e8, 0x0018, 0x0020, 0x0048},
           {0x0090, 0x0018, 0x0020, 0x0050},
        {0x0090, 0x0018, 0x0020, 0x0050},
        {0x0090, 0x0018, 0x0020, 0x0050},
           {0x0090, 0x0018, 0x0020, 0x0050},
            {0x0090, 0x0018, 0x0020, 0x0060},
            {0x0090, 0x0018, 0x0020, 0x0060},
            {0x0090, 0x0018, 0x0020, 0x0060},
            {0x0090, 0x0018, 0x0020, 0x0060},
            {0x0090, 0x0018, 0x0020, 0x0060},
