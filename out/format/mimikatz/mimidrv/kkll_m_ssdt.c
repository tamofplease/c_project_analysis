# 1 "/Users/tamofplease/Workspace/research/docker-exp/workspace/mimikatz/mimidrv/kkll_m_ssdt.c"
...
#if defined(_M_X64)
const UCHAR PTRN_WALL_Ke[] = { 0xd3, 0x42, 0x3b, 0x44, 0x17, 0x10, 0x0f, 0x83};
const UCHAR PTRN_W1803_Ke[] = {0xd3, 0x41, 0x3b, 0x44, 0x3a, 0x10, 0x0f, 0x83};
const LONG OFFS_WNO8_Ke = -24;
const LONG OFFS_WIN8_Ke = -21;
const LONG OFFS_WIN10A_Ke = -38;
