...
WINLDAPAPI ULONG LDAPAPI ldap_parse_resultW (
        ...
        __deref_opt_out_opt PWCHAR *MatchedDNs OPTIONAL,
        __deref_opt_out_opt PWCHAR *ErrorMessage OPTIONAL,
        __deref_opt_out_opt PWCHAR **Referrals OPTIONAL,
...
WINLDAPAPI ULONG LDAPAPI ldap_parse_resultA (
        ...
        LDAPMessage *ResultMessage,
        ULONG *ReturnCode OPTIONAL,
        __deref_opt_out_opt PCHAR *MatchedDNs OPTIONAL,
        __deref_opt_out_opt PCHAR *ErrorMessage OPTIONAL,
        __deref_opt_out_opt PCHAR **Referrals OPTIONAL,
...
WINLDAPAPI ULONG LDAPAPI ldap_parse_extended_resultA (
        LDAP *Connection,
        LDAPMessage *ResultMessage,
        __deref_opt_out_opt PCHAR *ResultOID,
...
WINLDAPAPI ULONG LDAPAPI ldap_parse_extended_resultW (
        LDAP *Connection,
        LDAPMessage *ResultMessage,
        __deref_opt_out_opt PWCHAR *ResultOID,
        struct berval **ResultData,
        BOOLEAN Freeit
        );
...
WINLDAPAPI ULONG LDAPAPI ldap_parse_referenceW (
        LDAP *Connection,
        LDAPMessage *ResultMessage,
        __deref_out PWCHAR **Referrals
        );

WINLDAPAPI ULONG LDAPAPI ldap_parse_referenceA (
        LDAP *Connection,
        LDAPMessage *ResultMessage,
        __deref_out PCHAR **Referrals
        );
