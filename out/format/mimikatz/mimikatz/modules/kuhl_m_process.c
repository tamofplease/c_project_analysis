# 1 "/Users/tamofplease/Workspace/research/docker-exp/workspace/mimikatz/mimikatz/modules/kuhl_m_process.c"
...
#pragma warning(pop)
 ...
 if(kull_m_string_copy(&szDupRun, szRun))
 {
  ...
  {
   pInit = (PINITIALIZEPROCTHREADATTRIBUTELIST) GetProcAddress(hModule, "InitializeProcThreadAttributeList");
