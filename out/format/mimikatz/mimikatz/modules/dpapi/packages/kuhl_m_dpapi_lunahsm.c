# 1 "/Users/tamofplease/Workspace/research/docker-exp/workspace/mimikatz/mimikatz/modules/dpapi/packages/kuhl_m_dpapi_lunahsm.c"
...
NTSTATUS kuhl_m_dpapi_lunahsm(int argc, wchar_t * argv[])
{
 ...
 if(kull_m_string_args_byName(argc, argv, L"client", &szArg, NULL))
 {
