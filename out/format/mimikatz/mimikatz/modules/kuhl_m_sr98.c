# 1 "/Users/tamofplease/Workspace/research/docker-exp/workspace/mimikatz/mimikatz/modules/kuhl_m_sr98.c"
...
void kuhl_m_sr98_nedap_blocks(ULONG blocks[5], BOOLEAN isLong, UCHAR SubType, USHORT CustomerCode, ULONG CardNumber)
{
 ...
 for(i = 0, tmp = 1; i < ((sizeof(ULONGLONG) - 1) * 8); i++)
  tmp ^= (uBuffer >> i) & 1;
 uBuffer <<= 1;
