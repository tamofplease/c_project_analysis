# 1 "/Users/tamofplease/Workspace/research/docker-exp/workspace/mimikatz/mimikatz/modules/crypto/kuhl_m_crypto_pki.c"
...
BOOL generateCertificate(PKIWI_KEY_INFO ki, PKIWI_CERT_INFO ci, PCCERT_CONTEXT signer, PKIWI_SIGNER dSigner, PBYTE *Certificate, DWORD *cbCertificate, PKIWI_SIGNER oSigner)
{
 ...
 CERT_BASIC_CONSTRAINTS2_INFO bc2 = {ci->isAC, FALSE, 0};
 CERT_EXTENSION Extensions[7] = {0}, *pAki = NULL;
