# 1 "/Users/tamofplease/Workspace/research/docker-exp/workspace/mimikatz/mimikatz/modules/kuhl_m_acr.c"
...
NTSTATUS kuhl_m_acr_info(int argc, wchar_t * argv[])
{
 ...
 if(kull_m_pn532_InListPassiveTarget(&kuhl_m_acr_pn532Comm, 2, 0 , NULL, 0, &NbTg, &pTargets))
 {
  for(i = 0; i < NbTg; i++)
  {
