# 0 "project/ish/tests/e2e/hello/test_c.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/ish/tests/e2e/hello/test_c.c"
...
# 2 "project/ish/tests/e2e/hello/test_c.c" 2


# 3 "project/ish/tests/e2e/hello/test_c.c"
int main(void) {
    printf("Hello, C!\n");
    return 0;
}
