# 0 "project/ish/tests/e2e/sse2/xorps.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 2 "project/ish/tests/e2e/sse2/xorps.c" 2
...
# 3 "project/ish/tests/e2e/sse2/xorps.c" 2

#define printout() printf("%05.2E %05.2E %05.2E %05.2E\n", out[0], out[1], out[2], out[3])


# 6 "project/ish/tests/e2e/sse2/xorps.c"
void main(void) {
 float out[4] = { 0, 0, 0, 0 };
 ...
 printf("%05.2E %05.2E %05.2E %05.2E\n", out[0], out[1], out[2], out[3]);
