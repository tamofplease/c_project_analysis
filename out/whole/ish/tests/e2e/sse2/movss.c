# 0 "project/ish/tests/e2e/sse2/movss.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/ish/tests/e2e/sse2/movss.c"
...
# 2 "project/ish/tests/e2e/sse2/movss.c" 2
...
# 3 "project/ish/tests/e2e/sse2/movss.c" 2

#define NOINLINE __attribute__ ((noinline))
#define printout() printf("%05.2f %05.2f %05.2f %05.2f\n", out[0], out[1], out[2], out[3])


# 7 "project/ish/tests/e2e/sse2/movss.c"
...
void __attribute__ ((noinline)) move5(__m128 *xmm1, __m128 *xmm2) {
...
void __attribute__ ((noinline)) move1612(__m128 *xmm1, float fa) {
...
void __attribute__ ((noinline)) store1612(__m128 *xmm1, float *fa) {
