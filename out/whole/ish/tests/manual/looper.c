# 0 "project/ish/tests/manual/looper.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/ish/tests/manual/looper.c"
...
# 2 "project/ish/tests/manual/looper.c" 2
...
# 3 "project/ish/tests/manual/looper.c" 2

#define nop() __asm__ volatile("")


# 6 "project/ish/tests/manual/looper.c"
int main() {
    int loops = 100000000;
