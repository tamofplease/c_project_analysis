...
static 
# 20 "project/ish/util/sync.c" 3 4
      _Bool 
# 20 "project/ish/util/sync.c"
           is_signal_pending(lock_t *lock) {
    if (!current)
        return 
# 22 "project/ish/util/sync.c" 3 4
              0
# 22 "project/ish/util/sync.c"
                   ;
    if (lock != &current->sighand->lock)
        __lock(&current->sighand->lock, "project/ish/util/sync.c", 24);
    
# 25 "project/ish/util/sync.c" 3 4
   _Bool 
# 25 "project/ish/util/sync.c"
        pending = !!(current->pending & ~current->blocked);
    if (lock != &current->sighand->lock)
...
int wait_for_ignore_signals(cond_t *cond, lock_t *lock, struct timespec *timeout) {
    if (current) {
        __lock(&current->waiting_cond_lock, "project/ish/util/sync.c", 44);
...
# 68 "project/ish/util/sync.c"
    ...
    if (current) {
        __lock(&current->waiting_cond_lock, "project/ish/util/sync.c", 78);
        current->waiting_cond = 
# 79 "project/ish/util/sync.c" 3 4
                               ((void *)0)
# 79 "project/ish/util/sync.c"
                                   ;
        current->waiting_lock = 
# 80 "project/ish/util/sync.c" 3 4
                               ((void *)0)
# 80 "project/ish/util/sync.c"
                                   ;
        unlock(&current->waiting_cond_lock);
    }
    if (rc == 
# 83 "project/ish/util/sync.c" 3 4
             60
# 83 "project/ish/util/sync.c"
                      )
        return -110;
    return 0;
}
...
__thread 
# 96 "project/ish/util/sync.c" 3 4
        _Bool 
# 96 "project/ish/util/sync.c"
             should_unwind = 
# 96 "project/ish/util/sync.c" 3 4
                             0
# 96 "project/ish/util/sync.c"
...
void sigusr1_handler() {
    if (should_unwind) {
        should_unwind = 
# 100 "project/ish/util/sync.c" 3 4
                       0
# 100 "project/ish/util/sync.c"
                            ;
