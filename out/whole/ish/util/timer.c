...
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/ish/util/timer.h" 2
...
# 7 "/Users/washi38/University/Labo/c_project_analysis/project/ish/util/timer.h" 2
...
# 9 "/Users/washi38/University/Labo/c_project_analysis/project/ish/util/timer.h" 2
...
struct timer *timer_new(clockid_t clockid, timer_callback_t callback, void *data) {
    ...
    timer->data = data;
    timer->active = 
# 13 "project/ish/util/timer.c" 3 4
                   0
# 13 "project/ish/util/timer.c"
                        ;
    timer->thread_running = 
# 14 "project/ish/util/timer.c" 3 4
                           0
# 14 "project/ish/util/timer.c"
                                ;
    lock_init(&timer->lock);
    timer->dead = 
# 16 "project/ish/util/timer.c" 3 4
                 0
# 16 "project/ish/util/timer.c"
                      ;
    return timer;
}

void timer_free(struct timer *timer) {
    __lock(&timer->lock, "project/ish/util/timer.c", 21);
    timer->active = 
# 22 "project/ish/util/timer.c" 3 4
                   0
# 22 "project/ish/util/timer.c"
                        ;
    if (timer->thread_running) {
        timer->dead = 
# 24 "project/ish/util/timer.c" 3 4
                     1
# 24 "project/ish/util/timer.c"
                         ;
        pthread_kill(timer->thread, 
# 25 "project/ish/util/timer.c" 3 4
                                   30
# 25 "project/ish/util/timer.c"
                                          );
        unlock(&timer->lock);
    } else {
        unlock(&timer->lock);
...
static void *timer_thread(void *param) {
    ...
    __lock(&timer->lock, "project/ish/util/timer.c", 35);
    while (
# 36 "project/ish/util/timer.c" 3 4
          1
# 36 "project/ish/util/timer.c"
              ) {
        ...
        while (timer->active && timespec_positive(remaining)) {
            unlock(&timer->lock);
            nanosleep(&remaining, 
# 40 "project/ish/util/timer.c" 3 4
                                 ((void *)0)
# 40 "project/ish/util/timer.c"
                                     );
            __lock(&timer->lock, "project/ish/util/timer.c", 41);
    ...
    timer->thread_running = 
# 53 "project/ish/util/timer.c" 3 4
                           0
# 53 "project/ish/util/timer.c"
                                ;
    if (timer->dead)
        free(timer);
    else
        unlock(&timer->lock);
    return 
# 58 "project/ish/util/timer.c" 3 4
          ((void *)0)
# 58 "project/ish/util/timer.c"
              ;
}

int timer_set(struct timer *timer, struct timer_spec spec, struct timer_spec *oldspec) {
    __lock(&timer->lock, "project/ish/util/timer.c", 62);
    struct timespec now = timespec_now(timer->clockid);
    if (oldspec != 
# 64 "project/ish/util/timer.c" 3 4
                  ((void *)0)
# 64 "project/ish/util/timer.c"
                      ) {
    ...
    if (timer->thread_running) {
        pthread_kill(timer->thread, 
# 74 "project/ish/util/timer.c" 3 4
                                   30
# 74 "project/ish/util/timer.c"
                                          );
    } else if (timer->active) {
        timer->thread_running = 
# 76 "project/ish/util/timer.c" 3 4
                               1
# 76 "project/ish/util/timer.c"
                                   ;
        pthread_create(&timer->thread, 
# 77 "project/ish/util/timer.c" 3 4
                                      ((void *)0)
# 77 "project/ish/util/timer.c"
                                          , timer_thread, timer);
