...
# 4 "/Users/washi38/University/Labo/c_project_analysis/project/ish/util/fifo.h" 2


# 5 "/Users/washi38/University/Labo/c_project_analysis/project/ish/util/fifo.h"
struct fifo {
    char *buf;
    size_t capacity;
    size_t size;
...
# 38 "project/ish/util/fifo.c" 3 4
   __builtin___memcpy_chk (
# 38 "project/ish/util/fifo.c"
   &fifo->buf[tail]
# 38 "project/ish/util/fifo.c" 3 4
   , 
# 38 "project/ish/util/fifo.c"
...
# 39 "project/ish/util/fifo.c" 3 4
   __builtin___memcpy_chk (
# 39 "project/ish/util/fifo.c"
   &fifo->buf[0]
# 39 "project/ish/util/fifo.c" 3 4
   , 
# 39 "project/ish/util/fifo.c"
   (char *) data + first_copy_size, size - first_copy_size
# 39 "project/ish/util/fifo.c" 3 4
   , __builtin_object_size (
# 39 "project/ish/util/fifo.c"
   &fifo->buf[0]
...
# 55 "project/ish/util/fifo.c" 3 4
   __builtin___memcpy_chk (
# 55 "project/ish/util/fifo.c"
   buf
# 55 "project/ish/util/fifo.c" 3 4
   , 
# 55 "project/ish/util/fifo.c"
   &fifo->buf[start], first_copy_size
# 55 "project/ish/util/fifo.c" 3 4
   , __builtin_object_size (
# 55 "project/ish/util/fifo.c"
   buf
...
# 56 "project/ish/util/fifo.c" 3 4
   __builtin___memcpy_chk (
# 56 "project/ish/util/fifo.c"
   (char *) buf + first_copy_size
# 56 "project/ish/util/fifo.c" 3 4
   , 
# 56 "project/ish/util/fifo.c"
   &fifo->buf[0], size - first_copy_size
# 56 "project/ish/util/fifo.c" 3 4
   , __builtin_object_size (
# 56 "project/ish/util/fifo.c"
   (char *) buf + first_copy_size
