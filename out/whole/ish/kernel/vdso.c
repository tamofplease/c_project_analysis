...
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/ish/kernel/elf.h" 2
...
# 6 "project/ish/kernel/vdso.c" 2

__asm__(".data\n"
        ".global vdso_data\n"
        "vdso_data:\n"
        ".incbin \"vdso/libvdso.so.elf\"\n"
        ".skip ""2"" * (1 << 12) - (. - vdso_data)\n");
...
int vdso_symbol(const char *name) {
    ...
    struct dyn_ent *dyn = 
# 18 "project/ish/kernel/vdso.c" 3 4
                         ((void *)0)
# 18 "project/ish/kernel/vdso.c"
                             ;
    ...
    if (dyn == 
# 25 "project/ish/kernel/vdso.c" 3 4
              ((void *)0)
# 25 "project/ish/kernel/vdso.c"
                  )
        goto fail;


    char *strings = 
# 29 "project/ish/kernel/vdso.c" 3 4
                   ((void *)0)
# 29 "project/ish/kernel/vdso.c"
                       ;
    struct elf_sym *syms = 
# 30 "project/ish/kernel/vdso.c" 3 4
                          ((void *)0)
# 30 "project/ish/kernel/vdso.c"
                              ;
    uint32_t *hash = 
# 31 "project/ish/kernel/vdso.c" 3 4
                    ((void *)0)
# 31 "project/ish/kernel/vdso.c"
                        ;
    for (; dyn->tag != 0; dyn++) {
    ...
    if (strings == 
# 41 "project/ish/kernel/vdso.c" 3 4
                  ((void *)0) 
# 41 "project/ish/kernel/vdso.c"
                       || syms == 
# 41 "project/ish/kernel/vdso.c" 3 4
                                  ((void *)0) 
# 41 "project/ish/kernel/vdso.c"
...
fail:
    ...
    fflush(
# 56 "project/ish/kernel/vdso.c" 3 4
          __stdoutp
# 56 "project/ish/kernel/vdso.c"
                );
    fprintf(
# 57 "project/ish/kernel/vdso.c" 3 4
           __stderrp
# 57 "project/ish/kernel/vdso.c"
                 , "invalid vdso. this should never happen.\n");
    fflush(
# 58 "project/ish/kernel/vdso.c" 3 4
          __stderrp
# 58 "project/ish/kernel/vdso.c"
                );
    abort();
}
