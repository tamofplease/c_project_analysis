...
# 9 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/fd.h" 2
...
#define DEV_H 
# 14 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/dev.h"
...
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/real.h" 2
...
# 10 "project/ish/kernel/init.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/ish/kernel/personality.h" 1

#define KERNEL_PERSONALITY_H 

#define ADDR_NO_RANDOMIZE_ 0x0040000
# 11 "project/ish/kernel/init.c" 2

int mount_root(const struct fs_ops *fs, const char *source) {
    char source_realpath[4096 + 1];
    if (realpath(source, source_realpath) == 
# 14 "project/ish/kernel/init.c" 3 4
                                            ((void *)0)
# 14 "project/ish/kernel/init.c"
                                                )
        return errno_map();
...
static void establish_signal_handlers() {
    ...
    sigact.
# 25 "project/ish/kernel/init.c" 3 4
          __sigaction_u.__sa_handler 
# 25 "project/ish/kernel/init.c"
                     = sigusr1_handler;
    sigact.sa_flags = 0;
    
# 27 "project/ish/kernel/init.c" 3 4
   (*(
# 27 "project/ish/kernel/init.c"
   &sigact.sa_mask
# 27 "project/ish/kernel/init.c" 3 4
   ) = 0, 0)
# 27 "project/ish/kernel/init.c"
...
# 28 "project/ish/kernel/init.c" 3 4
   (*(
# 28 "project/ish/kernel/init.c"
   &sigact.sa_mask
# 28 "project/ish/kernel/init.c" 3 4
   ) |= __sigbits(30), 0)
# 28 "project/ish/kernel/init.c"
                                      ;
    sigaction(
# 29 "project/ish/kernel/init.c" 3 4
             30
# 29 "project/ish/kernel/init.c"
                    , &sigact, 
# 29 "project/ish/kernel/init.c" 3 4
                               ((void *)0)
# 29 "project/ish/kernel/init.c"
    ...
    signal(
# 30 "project/ish/kernel/init.c" 3 4
          13
# 30 "project/ish/kernel/init.c"
                 , 
# 30 "project/ish/kernel/init.c" 3 4
                   (void (*)(int))1
# 30 "project/ish/kernel/init.c"
...
static struct rlimit_ init_rlimits[16] = {
    [0] = {((rlim_t_) -1), ((rlim_t_) -1)},
    [1] = {((rlim_t_) -1), ((rlim_t_) -1)},
    [2] = {((rlim_t_) -1), ((rlim_t_) -1)},
    [3] = {8*1024*1024, ((rlim_t_) -1)},
    [4] = {0, ((rlim_t_) -1)},
    [5] = {((rlim_t_) -1), ((rlim_t_) -1)},
    [6] = {1024, 1024},
    [7] = {1024, 4096},
    [8] = {64*1024, 64*1024},
    [9] = {((rlim_t_) -1), ((rlim_t_) -1)},
    [10] = {((rlim_t_) -1), ((rlim_t_) -1)},
    [11] = {1024, 1024},
    [12] = {819200, 819200},
    [13] = {0, 0},
    [14] = {0, 0},
    [15] = {((rlim_t_) -1), ((rlim_t_) -1)},
};
...
# 63 "project/ish/kernel/init.c" 3 4
   __builtin___memcpy_chk (
# 63 "project/ish/kernel/init.c"
   group->limits
# 63 "project/ish/kernel/init.c" 3 4
   , 
# 63 "project/ish/kernel/init.c"
   init_rlimits, sizeof(init_rlimits)
# 63 "project/ish/kernel/init.c" 3 4
...
# 63 "project/ish/kernel/init.c"
    ...
    current = task;
    task->fs->root = generic_open("/", 0, 0);
    if (((uintptr_t) (task->fs->root) > (uintptr_t) -0xfff))
        return (void *) (intptr_t) (task->fs->root);
...
int become_first_process() {
    ...
    struct task *task = construct_task(
# 93 "project/ish/kernel/init.c" 3 4
                                      ((void *)0)
# 93 "project/ish/kernel/init.c"
                                          );
    if (((uintptr_t) (task) > (uintptr_t) -0xfff))
        return (intptr_t) (task);
...
# 104 "project/ish/kernel/init.c" 3 4
   (__builtin_expect(!(
# 104 "project/ish/kernel/init.c"
   init != 
# 104 "project/ish/kernel/init.c" 3 4
   ((void *)0)), 0) ? __assert_rtn(__func__, "project/ish/kernel/init.c", 104, 
# 104 "project/ish/kernel/init.c"
   "init != NULL"
# 104 "project/ish/kernel/init.c" 3 4
   ) : (void)0)
# 104 "project/ish/kernel/init.c"
    ...
    task->clear_tid = 0;
    task->vfork = 
# 112 "project/ish/kernel/init.c" 3 4
                 ((void *)0)
# 112 "project/ish/kernel/init.c"
                     ;
...
int create_stdio(const char *file, int major, int minor) {
    struct fd *fd = generic_open(file, (1 << 1), 0);
    if (((uintptr_t) (fd) > (uintptr_t) -0xfff)) {

        fd = adhoc_fd_create(
# 132 "project/ish/kernel/init.c" 3 4
                            ((void *)0)
# 132 "project/ish/kernel/init.c"
                                );
        fd->stat.rdev = dev_make(major, minor);
        fd->stat.mode = 
# 134 "project/ish/kernel/init.c" 3 4
                       0020000 
# 134 "project/ish/kernel/init.c"
                               | 
# 134 "project/ish/kernel/init.c" 3 4
                                 0000400
# 134 "project/ish/kernel/init.c"
                                        ;
        fd->flags = (1 << 1);
        int err = dev_open(major, minor, 1, fd);
        if (err < 0)
            return err;
    }
...
static struct fd *open_fd_from_actual_fd(int fd_no) {
    ...
    if (fd == 
# 150 "project/ish/kernel/init.c" 3 4
             ((void *)0)
# 150 "project/ish/kernel/init.c"
                 ) {
        return 
# 151 "project/ish/kernel/init.c" 3 4
              ((void *)0)
# 151 "project/ish/kernel/init.c"
                  ;
    }
    fd->real_fd = fd_no;
    fd->dir = 
# 154 "project/ish/kernel/init.c" 3 4
             ((void *)0)
# 154 "project/ish/kernel/init.c"
                 ;
    return fd;
}

int create_piped_stdio() {
    if (!(current->files->files[0] = open_fd_from_actual_fd(
# 159 "project/ish/kernel/init.c" 3 4
                                                           0
# 159 "project/ish/kernel/init.c"
                                                                       ))) {
        return -1;
    }
    if (!(current->files->files[1] = open_fd_from_actual_fd(
# 162 "project/ish/kernel/init.c" 3 4
                                                           1
# 162 "project/ish/kernel/init.c"
                                                                        ))) {
        return -1;
    }
    if (!(current->files->files[2] = open_fd_from_actual_fd(
# 165 "project/ish/kernel/init.c" 3 4
                                                           2
# 165 "project/ish/kernel/init.c"
                                                                        ))) {
        return -1;
    }
    return 0;
