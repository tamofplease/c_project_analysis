...
static void apply_umask(mode_t_ *mode) {
    ...
    __lock(&fs->lock, "project/ish/kernel/fs.c", 20);
    *mode &= ~fs->umask;
    unlock(&fs->lock);
}
...
int access_check(struct statbuf *stat, int check) {
    if ((current != 
# 26 "project/ish/kernel/fs.c" 3 4
       ((void *)0) 
# 26 "project/ish/kernel/fs.c"
...
dword_t sys_faccessat(fd_t at_f, addr_t path_addr, mode_t_ mode, dword_t flags) {
    ...
    if (at == 
# 50 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 50 "project/ish/kernel/fs.c"
                 )
        return -9;
...
fd_t sys_openat(fd_t at_f, addr_t path_addr, dword_t flags, mode_t_ mode) {
    ...
    struct fd *at = at_fd(at_f);
    if (at == 
# 77 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 77 "project/ish/kernel/fs.c"
                 )
        return -9;
...
dword_t sys_readlinkat(fd_t at_f, addr_t path_addr, addr_t buf_addr, dword_t bufsize) {
    ...
    struct fd *at = at_fd(at_f);
    if (at == 
# 95 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 95 "project/ish/kernel/fs.c"
                 )
        return -9;
    char buf[bufsize];
...
dword_t sys_linkat(fd_t src_at_f, addr_t src_addr, fd_t dst_at_f, addr_t dst_addr) {
    ...
    if (src_at == 
# 120 "project/ish/kernel/fs.c" 3 4
                 ((void *)0)
# 120 "project/ish/kernel/fs.c"
                     )
        return -9;
    struct fd *dst_at = at_fd(dst_at_f);
    if (dst_at == 
# 123 "project/ish/kernel/fs.c" 3 4
                 ((void *)0)
# 123 "project/ish/kernel/fs.c"
                     )
        return -9;
...
dword_t sys_unlinkat(fd_t at_f, addr_t path_addr, int_t flags) {
    ...
    struct fd *at = at_fd(at_f);
    if (at == 
# 139 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 139 "project/ish/kernel/fs.c"
                 )
        return -9;
    if (flags & 0x200)
...
dword_t sys_renameat2(fd_t src_at_f, addr_t src_addr, fd_t dst_at_f, addr_t dst_addr, int_t flags) {
    ...
    struct fd *src_at = at_fd(src_at_f);
    if (src_at == 
# 162 "project/ish/kernel/fs.c" 3 4
                 ((void *)0)
# 162 "project/ish/kernel/fs.c"
                     )
        return -9;
    struct fd *dst_at = at_fd(dst_at_f);
    if (dst_at == 
# 165 "project/ish/kernel/fs.c" 3 4
                 ((void *)0)
# 165 "project/ish/kernel/fs.c"
                     )
        return -9;
...
dword_t sys_symlinkat(addr_t target_addr, fd_t at_f, addr_t link_addr) {
    ...
    struct fd *at = at_fd(at_f);
    if (at == 
# 187 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 187 "project/ish/kernel/fs.c"
                 )
        return -9;
...
dword_t sys_mknodat(fd_t at_f, addr_t path_addr, mode_t_ mode, dev_t_ dev) {
    ...
    struct fd *at = at_fd(at_f);
    if (at == 
# 203 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 203 "project/ish/kernel/fs.c"
                 )
        return -9;
...
static ssize_t sys_read_buf(fd_t fd_no, void *buf, size_t size) {
    ...
    if (fd == 
# 214 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 214 "project/ish/kernel/fs.c"
                 )
        return -9;
    if (
# 216 "project/ish/kernel/fs.c" 3 4
       (((
# 216 "project/ish/kernel/fs.c"
       fd->type
# 216 "project/ish/kernel/fs.c" 3 4
       ) & 0170000) == 0040000)
# 216 "project/ish/kernel/fs.c"
...
dword_t sys_read(fd_t fd_no, addr_t buf_addr, dword_t size) {
    ...
    if (buf == 
# 242 "project/ish/kernel/fs.c" 3 4
              ((void *)0)
# 242 "project/ish/kernel/fs.c"
                  )
        return -12;
...
static ssize_t sys_write_buf(fd_t fd_no, void *buf, size_t size) {
    struct fd *fd = f_get(fd_no);
    if (fd == 
# 255 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 255 "project/ish/kernel/fs.c"
                 )
        return -9;
...
dword_t sys_write(fd_t fd_no, addr_t buf_addr, dword_t size) {
    ...
    if (buf == 
# 275 "project/ish/kernel/fs.c" 3 4
              ((void *)0)
# 275 "project/ish/kernel/fs.c"
                  )
        return -12;
    dword_t res = -14;
...
static struct iovec_ *read_iovec(addr_t iovec_addr, unsigned iovec_count) {
    ...
    if (iovec == 
# 301 "project/ish/kernel/fs.c" 3 4
                ((void *)0)
# 301 "project/ish/kernel/fs.c"
                    )
...
dword_t sys_readv(fd_t fd_no, addr_t iovec_addr, dword_t iovec_count) {
    ...
    if (buf == 
# 324 "project/ish/kernel/fs.c" 3 4
              ((void *)0)
# 324 "project/ish/kernel/fs.c"
                  ) {
        free(iovec);
        return -12;
    }
...
dword_t sys_writev(fd_t fd_no, addr_t iovec_addr, dword_t iovec_count) {
    ...
    char *buf = malloc(io_size);
    if (buf == 
# 358 "project/ish/kernel/fs.c" 3 4
              ((void *)0)
# 358 "project/ish/kernel/fs.c"
                  ) {
        free(iovec);
        return -12;
    }
...
dword_t sys__llseek(fd_t f, dword_t off_high, dword_t off_low, addr_t res_addr, dword_t whence) {
    ...
    if (fd == 
# 386 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 386 "project/ish/kernel/fs.c"
                 )
        return -9;
    if (!fd->ops->lseek)
        return -29;
    __lock(&fd->lock, "project/ish/kernel/fs.c", 390);
...
dword_t sys_lseek(fd_t f, dword_t off, dword_t whence) {
    struct fd *fd = f_get(f);
    if (fd == 
# 405 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 405 "project/ish/kernel/fs.c"
                 )
        return -9;
    if (!fd->ops->lseek)
        return -29;
    __lock(&fd->lock, "project/ish/kernel/fs.c", 409);
...
dword_t sys_pread(fd_t f, addr_t buf_addr, dword_t size, off_t_ off) {
    ...
    struct fd *fd = f_get(f);
    if (fd == 
# 420 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 420 "project/ish/kernel/fs.c"
                 )
        return -9;
    char *buf = malloc(size+1);
    if (buf == 
# 423 "project/ish/kernel/fs.c" 3 4
              ((void *)0)
# 423 "project/ish/kernel/fs.c"
                  )
        return -12;
    __lock(&fd->lock, "project/ish/kernel/fs.c", 425);
    ssize_t res;
    if (fd->ops->pread) {
...
# 440 "project/ish/kernel/fs.c" 3 4
       (__builtin_expect(!(
# 440 "project/ish/kernel/fs.c"
       lseek_res >= 0
# 440 "project/ish/kernel/fs.c" 3 4
       ), 0) ? __assert_rtn(__func__, "project/ish/kernel/fs.c", 440, 
# 440 "project/ish/kernel/fs.c"
       "lseek_res >= 0"
# 440 "project/ish/kernel/fs.c" 3 4
       ) : (void)0)
...
dword_t sys_pwrite(fd_t f, addr_t buf_addr, dword_t size, off_t_ off) {
    ...
    struct fd *fd = f_get(f);
    if (fd == 
# 457 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 457 "project/ish/kernel/fs.c"
                 )
        return -9;
    char *buf = malloc(size+1);
    if (buf == 
# 460 "project/ish/kernel/fs.c" 3 4
              ((void *)0)
# 460 "project/ish/kernel/fs.c"
                  )
        return -12;
    if (user_read(buf_addr, buf, size))
        return -14;
    __lock(&fd->lock, "project/ish/kernel/fs.c", 464);
    ssize_t res;
    if (fd->ops->pwrite) {
...
# 477 "project/ish/kernel/fs.c" 3 4
           (__builtin_expect(!(
# 477 "project/ish/kernel/fs.c"
           lseek_res >= 0
# 477 "project/ish/kernel/fs.c" 3 4
           ), 0) ? __assert_rtn(__func__, "project/ish/kernel/fs.c", 477, 
# 477 "project/ish/kernel/fs.c"
           "lseek_res >= 0"
# 477 "project/ish/kernel/fs.c" 3 4
           ) : (void)0)
...
dword_t sys_ioctl(fd_t f, dword_t cmd, dword_t arg) {
    ...
    struct fd *fd = f_get(f);
    if (fd == 
# 521 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 521 "project/ish/kernel/fs.c"
                 )
        return -9;
...
dword_t sys_getcwd(addr_t buf_addr, dword_t size) {
    ...
    __lock(&current->fs->lock, "project/ish/kernel/fs.c", 539);
    ...
    char *buf = malloc(size);
    if (buf == 
# 551 "project/ish/kernel/fs.c" 3 4
              ((void *)0)
# 551 "project/ish/kernel/fs.c"
                  )
        return -12;
    
# 553 "project/ish/kernel/fs.c" 3 4
   __builtin___strcpy_chk (
# 553 "project/ish/kernel/fs.c"
   buf
# 553 "project/ish/kernel/fs.c" 3 4
   , 
# 553 "project/ish/kernel/fs.c"
...
# 564 "project/ish/kernel/fs.c" 3 4
                                                 1
# 564 "project/ish/kernel/fs.c"
                                                     );
    if (err < 0)
        return (void *) (intptr_t) (err);
    if (!(stat.mode & 
# 567 "project/ish/kernel/fs.c" 3 4
                     0040000
# 567 "project/ish/kernel/fs.c"
                            ))
...
void fs_chdir(struct fs_info *fs, struct fd *fd) {
    __lock(&fs->lock, "project/ish/kernel/fs.c", 574);
    fd_close(fs->pwd);
    fs->pwd = fd;
    unlock(&fs->lock);
}
...
dword_t sys_fchdir(fd_t f) {
    ...
    if (dir == 
# 596 "project/ish/kernel/fs.c" 3 4
              ((void *)0)
# 596 "project/ish/kernel/fs.c"
                  )
        return -9;
    dir->refcount++;
    fs_chdir(current->fs, dir);
...
dword_t sys_chroot(addr_t path_addr) {
    ...
    if (((uintptr_t) (dir) > (uintptr_t) -0xfff))
        return (intptr_t) (dir);
    __lock(&current->fs->lock, "project/ish/kernel/fs.c", 612);
...
dword_t sys_umask(dword_t mask) {
    __use(0, mask);
    struct fs_info *fs = current->fs;
    __lock(&fs->lock, "project/ish/kernel/fs.c", 622);
...
dword_t sys_flock(fd_t f, dword_t operation) {
    struct fd *fd = f_get(f);
    if (fd == 
# 726 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 726 "project/ish/kernel/fs.c"
                 )
        return -9;


    if (fd->mount->fs->flock == 
# 730 "project/ish/kernel/fs.c" 3 4
                               ((void *)0)
# 730 "project/ish/kernel/fs.c"
                                   )
        return -9;
...
static dword_t sys_utime_common(fd_t at_f, addr_t path_addr, struct timespec atime, struct timespec mtime, dword_t flags) {
    ...
    struct fd *at = at_fd(at_f);
    if (at == 
# 757 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 757 "project/ish/kernel/fs.c"
                 )
        return -9;

    
# 760 "project/ish/kernel/fs.c" 3 4
   _Bool 
# 760 "project/ish/kernel/fs.c"
...
# 768 "project/ish/kernel/fs.c" 3 4
                                    _CLOCK_REALTIME
# 768 "project/ish/kernel/fs.c"
                                                  );
    } else {
...
dword_t sys_utimes(addr_t path_addr, addr_t times_addr) {
    ...
    if (times_addr == 0) {
        atime = mtime = timespec_now(
# 783 "project/ish/kernel/fs.c" 3 4
                                    _CLOCK_REALTIME
# 783 "project/ish/kernel/fs.c"
                                                  );
    } else {
...
dword_t sys_utime(addr_t path_addr, addr_t times_addr) {
    ...
    if (times_addr == 0) {
        atime = mtime = timespec_now(
# 798 "project/ish/kernel/fs.c" 3 4
                                    _CLOCK_REALTIME
# 798 "project/ish/kernel/fs.c"
                                                  );
    } else {
        struct utimbuf_ {
            time_t_ actime;
...
# 815 "project/ish/kernel/fs.c" 3 4
                                  ((void *)0)
# 815 "project/ish/kernel/fs.c"
                                      )
        return -1;
...
dword_t sys_fchmod(fd_t f, dword_t mode) {
    ...
    struct fd *fd = f_get(f);
    if (fd == 
# 823 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 823 "project/ish/kernel/fs.c"
                 )
        return -9;
    mode &= ~
# 825 "project/ish/kernel/fs.c" 3 4
            0170000
# 825 "project/ish/kernel/fs.c"
                  ;
...
dword_t sys_fchmodat(fd_t at_f, addr_t path_addr, dword_t mode) {
    ...
    struct fd *at = at_fd(at_f);
    if (at == 
# 835 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 835 "project/ish/kernel/fs.c"
                 )
        return -9;
    mode &= ~
# 837 "project/ish/kernel/fs.c" 3 4
            0170000
# 837 "project/ish/kernel/fs.c"
                  ;
    return generic_setattrat(at, path, ((struct attr) {.type = attr_mode, .mode = mode}), 
# 838 "project/ish/kernel/fs.c" 3 4
                                                             1
# 838 "project/ish/kernel/fs.c"
                                                                 );
}
...
dword_t sys_fchown32(fd_t f, uid_t_ owner, uid_t_ group) {
    ...
    struct fd *fd = f_get(f);
    if (fd == 
# 848 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 848 "project/ish/kernel/fs.c"
                 )
        return -9;
    int err;
    if (owner != (uid_t) -1) {
...
dword_t sys_fchownat(fd_t at_f, addr_t path_addr, dword_t owner, dword_t group, int flags) {
    ...
    struct fd *at = at_fd(at_f);
    if (at == 
# 870 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 870 "project/ish/kernel/fs.c"
                 )
        return -9;
    int err;
    
# 873 "project/ish/kernel/fs.c" 3 4
   _Bool 
# 873 "project/ish/kernel/fs.c"
        follow_links = flags & 0x100 ? 
# 873 "project/ish/kernel/fs.c" 3 4
                                                      0 
# 873 "project/ish/kernel/fs.c"
...
# 900 "project/ish/kernel/fs.c" 3 4
                            ((void *)0)
# 900 "project/ish/kernel/fs.c"
...
dword_t sys_ftruncate64(fd_t f, dword_t size_low, dword_t size_high) {
    ...
    struct fd *fd = f_get(f);
    if (fd == 
# 906 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 906 "project/ish/kernel/fs.c"
                 )
        return -9;
...
dword_t sys_fallocate(fd_t f, dword_t UNUSED_mode __attribute__((unused)), dword_t offset_low, dword_t offset_high, dword_t len_low, dword_t len_high) {
    ...
    struct fd *fd = f_get(f);
    if (fd == 
# 915 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 915 "project/ish/kernel/fs.c"
                 )
        return -9;
...
dword_t sys_mkdirat(fd_t at_f, addr_t path_addr, mode_t_ mode) {
    ...
    struct fd *at = at_fd(at_f);
    if (at == 
# 932 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 932 "project/ish/kernel/fs.c"
                 )
        return -9;
    apply_umask(&mode);
    mode &= 0777;
...
dword_t sys_fsync(fd_t f) {
    struct fd *fd = f_get(f);
    if (fd == 
# 953 "project/ish/kernel/fs.c" 3 4
             ((void *)0)
# 953 "project/ish/kernel/fs.c"
                 )
        return -9;
    int err = 0;
    if (fd->ops->fsync)
