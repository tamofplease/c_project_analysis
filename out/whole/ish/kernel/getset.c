...
# 2 "project/ish/kernel/getset.c" 2
...
# 4 "project/ish/kernel/getset.c" 2
...
pid_t_ sys_getppid() {
    __use(0);
    pid_t_ ppid;
    __lock(&pids_lock, "project/ish/kernel/getset.c", 16);
    if (current->parent != 
# 17 "project/ish/kernel/getset.c" 3 4
                          ((void *)0)
# 17 "project/ish/kernel/getset.c"
                              )
...
int_t sys_setuid(uid_t_ uid) {
    __use(0, uid);
    if ((current != 
# 45 "project/ish/kernel/getset.c" 3 4
       ((void *)0) 
# 45 "project/ish/kernel/getset.c"
       && current->euid == 0)) {
...
dword_t sys_setresuid(uid_t_ ruid, uid_t_ euid, uid_t_ suid) {
    ...
    if (!(current != 
# 57 "project/ish/kernel/getset.c" 3 4
        ((void *)0) 
# 57 "project/ish/kernel/getset.c"
        && current->euid == 0)) {
...
int_t sys_setgid(uid_t_ gid) {
    __use(0, gid);
    if ((current != 
# 110 "project/ish/kernel/getset.c" 3 4
       ((void *)0) 
# 110 "project/ish/kernel/getset.c"
       && current->euid == 0)) {
...
dword_t sys_setresgid(uid_t_ rgid, uid_t_ egid, uid_t_ sgid) {
    ...
    if (!(current != 
# 122 "project/ish/kernel/getset.c" 3 4
        ((void *)0) 
# 122 "project/ish/kernel/getset.c"
        && current->euid == 0)) {
