...
# 10 "project/ish/kernel/log.c" 2

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/ish/util/fifo.h" 1
...
# 12 "project/ish/kernel/log.c" 2



#define LOG_BUF_SHIFT 20
static char log_buffer[1 << 20];
static struct fifo log_buf = ((struct fifo) {.buf = log_buffer, .capacity = sizeof(log_buffer)});
static size_t log_max_since_clear = 0;
static lock_t log_lock = {
# 19 "project/ish/kernel/log.c" 3 4
                        {0x32AAABA7, {0}}
# 19 "project/ish/kernel/log.c"
                        , 0};
...
static int do_syslog(int type, addr_t buf_addr, int_t len) {
    ...
    switch (type) {
        ...
        case 3:
            return syslog_read(buf_addr, len, 2 | 1);

        case 4:
            res = syslog_read(buf_addr, len, 2 | 1);
            if (res < 0)
                return res;
...
int_t sys_syslog(int_t type, addr_t buf_addr, int_t len) {
    __lock(&log_lock, "project/ish/kernel/log.c", 85);
...
static void log_buf_append(const char *msg) {
    fifo_write(&log_buf, msg, strlen(msg), 1);
...
void ish_vprintk(const char *msg, va_list args) {
    ...
    buf_size += 
# 111 "project/ish/kernel/log.c" 3 4
               __builtin___vsprintf_chk (
# 111 "project/ish/kernel/log.c"
               buf + buf_size
# 111 "project/ish/kernel/log.c" 3 4
...
# 111 "project/ish/kernel/log.c"
    ...
    __lock(&log_lock, "project/ish/kernel/log.c", 114);
    char *b = buf;
    char *p;
    while ((p = strchr(b, '\n')) != 
# 117 "project/ish/kernel/log.c" 3 4
                                   ((void *)0)
# 117 "project/ish/kernel/log.c"
                                       ) {
        *p = '\0';
        output_line(b);
        *p = '\n';
...
# 125 "project/ish/kernel/log.c" 3 4
   __builtin___memmove_chk (
# 125 "project/ish/kernel/log.c"
   buf
# 125 "project/ish/kernel/log.c" 3 4
   , 
# 125 "project/ish/kernel/log.c"
...
# 129 "project/ish/kernel/log.c" 3 4
   __builtin_va_start(
# 129 "project/ish/kernel/log.c"
   args
# 129 "project/ish/kernel/log.c" 3 4
   ,
# 129 "project/ish/kernel/log.c"
...
# 131 "project/ish/kernel/log.c" 3 4
   __builtin_va_end(
# 131 "project/ish/kernel/log.c"
   args
# 131 "project/ish/kernel/log.c" 3 4
   )
# 131 "project/ish/kernel/log.c"
...
# 154 "project/ish/kernel/log.c" 3 4
   __builtin_va_start(
# 154 "project/ish/kernel/log.c"
   args
# 154 "project/ish/kernel/log.c" 3 4
   ,
# 154 "project/ish/kernel/log.c"
...
# 156 "project/ish/kernel/log.c" 3 4
   __builtin___vsprintf_chk (
# 156 "project/ish/kernel/log.c"
   buf
# 156 "project/ish/kernel/log.c" 3 4
   , 0, __builtin_object_size (
# 156 "project/ish/kernel/log.c"
...
# 159 "project/ish/kernel/log.c" 3 4
   __builtin_va_end(
# 159 "project/ish/kernel/log.c"
   args
# 159 "project/ish/kernel/log.c" 3 4
   )
# 159 "project/ish/kernel/log.c"
