...
# 71 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/utsname.h" 2 3 4
...
# 2 "project/ish/kernel/uname.c" 2
...
# 3 "project/ish/kernel/uname.c" 2
...
# 4 "project/ish/kernel/uname.c" 2
...
# 5 "project/ish/kernel/uname.c" 2
...
# 8 "project/ish/kernel/uname.c" 2





# 12 "project/ish/kernel/uname.c"
const char *uname_version = "SUPER AWESOME";
const char *uname_hostname_override = 
# 13 "project/ish/kernel/uname.c" 3 4
                                     ((void *)0)
# 13 "project/ish/kernel/uname.c"
                                         ;
...
# 22 "project/ish/kernel/uname.c" 3 4
   __builtin___memset_chk (
# 22 "project/ish/kernel/uname.c"
   uts
# 22 "project/ish/kernel/uname.c" 3 4
   , 
# 22 "project/ish/kernel/uname.c"
   0, sizeof(struct uname)
# 22 "project/ish/kernel/uname.c" 3 4
...
# 23 "project/ish/kernel/uname.c" 3 4
   __builtin___strcpy_chk (
# 23 "project/ish/kernel/uname.c"
   uts->system
# 23 "project/ish/kernel/uname.c" 3 4
   , 
# 23 "project/ish/kernel/uname.c"
...
# 24 "project/ish/kernel/uname.c" 3 4
   __builtin___strcpy_chk (
# 24 "project/ish/kernel/uname.c"
   uts->hostname
# 24 "project/ish/kernel/uname.c" 3 4
   , 
# 24 "project/ish/kernel/uname.c"
...
# 25 "project/ish/kernel/uname.c" 3 4
   __builtin___strcpy_chk (
# 25 "project/ish/kernel/uname.c"
   uts->release
# 25 "project/ish/kernel/uname.c" 3 4
   , 
# 25 "project/ish/kernel/uname.c"
...
# 26 "project/ish/kernel/uname.c" 3 4
   __builtin___snprintf_chk (
# 26 "project/ish/kernel/uname.c"
   uts->version
# 26 "project/ish/kernel/uname.c" 3 4
   , 
# 26 "project/ish/kernel/uname.c"
...
# 26 "project/ish/kernel/uname.c" 3 4
   , 2 > 1 ? 1 : 0), 
# 26 "project/ish/kernel/uname.c"
   "%s %s %s", uname_version, "May 12 2022", "15:29:07"
# 26 "project/ish/kernel/uname.c" 3 4
   )
# 26 "project/ish/kernel/uname.c"
                                                                                              ;
    
# 27 "project/ish/kernel/uname.c" 3 4
   __builtin___strcpy_chk (
# 27 "project/ish/kernel/uname.c"
   uts->arch
# 27 "project/ish/kernel/uname.c" 3 4
   , 
# 27 "project/ish/kernel/uname.c"
...
# 28 "project/ish/kernel/uname.c" 3 4
   __builtin___strcpy_chk (
# 28 "project/ish/kernel/uname.c"
   uts->domain
# 28 "project/ish/kernel/uname.c" 3 4
   , 
# 28 "project/ish/kernel/uname.c"
...
dword_t sys_uname(addr_t uts_addr) {
    struct uname uts;
    do_uname(&uts);
    if (user_write(uts_addr, &(uts), sizeof(uts)))
        return -14;
    return 0;
}

dword_t sys_sethostname(addr_t UNUSED_hostname_addr __attribute__((unused)), dword_t UNUSED_hostname_len __attribute__((unused))) {
    return -1;
}
...
static uint64_t get_total_ram() {
    uint64_t total_ram;
    sysctl((int []) {
# 46 "project/ish/kernel/uname.c" 3 4
                    5
# 46 "project/ish/kernel/uname.c"
                             , 
# 46 "project/ish/kernel/uname.c" 3 4
                               5
# 46 "project/ish/kernel/uname.c"
...
dword_t sys_sysinfo(addr_t info_addr) {
    ...
    if (user_write(info_addr, &(info), sizeof(info)))
        return -14;
    return 0;
}
