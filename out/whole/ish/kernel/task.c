...
# 9 "project/ish/kernel/task.c" 2

__thread struct task *current;

static struct pid pids[(1 << 15) + 1] = {};
lock_t pids_lock = {
# 13 "project/ish/kernel/task.c" 3 4
                  {0x32AAABA7, {0}}
# 13 "project/ish/kernel/task.c"
                  , 0};

static 
# 15 "project/ish/kernel/task.c" 3 4
      _Bool 
# 15 "project/ish/kernel/task.c"
           pid_empty(struct pid *pid) {
    return pid->task == 
# 16 "project/ish/kernel/task.c" 3 4
                       ((void *)0) 
# 16 "project/ish/kernel/task.c"
...
struct pid *pid_get(dword_t id) {
    if (id > sizeof(pids)/sizeof(pids[0]))
        return 
# 21 "project/ish/kernel/task.c" 3 4
              ((void *)0)
# 21 "project/ish/kernel/task.c"
                  ;
    struct pid *pid = &pids[id];
    if (pid_empty(pid))
        return 
# 24 "project/ish/kernel/task.c" 3 4
              ((void *)0)
# 24 "project/ish/kernel/task.c"
                  ;
    return pid;
}
...
struct task *pid_get_task_zombie(dword_t id) {
    ...
    if (pid == 
# 30 "project/ish/kernel/task.c" 3 4
              ((void *)0)
# 30 "project/ish/kernel/task.c"
                  )
        return 
# 31 "project/ish/kernel/task.c" 3 4
              ((void *)0)
# 31 "project/ish/kernel/task.c"
                  ;
...
struct task *pid_get_task(dword_t id) {
    ...
    if (task != 
# 38 "project/ish/kernel/task.c" 3 4
               ((void *)0) 
# 38 "project/ish/kernel/task.c"
                    && task->zombie)
        return 
# 39 "project/ish/kernel/task.c" 3 4
              ((void *)0)
# 39 "project/ish/kernel/task.c"
                  ;
    return task;
}

struct task *task_create_(struct task *parent) {
    __lock(&pids_lock, "project/ish/kernel/task.c", 44);
    static int cur_pid = 0;
    do {
        cur_pid++;
        if (cur_pid > (1 << 15)) cur_pid = 1;
    ...
    if (task == 
# 56 "project/ish/kernel/task.c" 3 4
               ((void *)0)
# 56 "project/ish/kernel/task.c"
                   )
        return 
# 57 "project/ish/kernel/task.c" 3 4
              ((void *)0)
# 57 "project/ish/kernel/task.c"
                  ;
    *task = (struct task) {};
    if (parent != 
# 59 "project/ish/kernel/task.c" 3 4
                 ((void *)0)
# 59 "project/ish/kernel/task.c"
                     )
        *task = *parent;
    task->pid = pid->id;
    pid->task = task;
    ...
    if (parent != 
# 66 "project/ish/kernel/task.c" 3 4
                 ((void *)0)
# 66 "project/ish/kernel/task.c"
                     ) {
        task->parent = parent;
    ...
    task->robust_list = 0;
    task->did_exec = 
# 76 "project/ish/kernel/task.c" 3 4
                    0
# 76 "project/ish/kernel/task.c"
                         ;
    ...
    task->waiting_cond = 
# 82 "project/ish/kernel/task.c" 3 4
                        ((void *)0)
# 82 "project/ish/kernel/task.c"
                            ;
    task->waiting_lock = 
# 83 "project/ish/kernel/task.c" 3 4
                        ((void *)0)
# 83 "project/ish/kernel/task.c"
                            ;
...
void task_destroy(struct task *task) {
    ...
    pid_get(task->pid)->task = 
# 94 "project/ish/kernel/task.c" 3 4
                              ((void *)0)
# 94 "project/ish/kernel/task.c"
                                  ;
    free(task);
}
...
void task_run_current() {
    ...
    while (
# 102 "project/ish/kernel/task.c" 3 4
          1
# 102 "project/ish/kernel/task.c"
              ) {
...
__attribute__((constructor)) static void create_attr() {
    ...
    pthread_attr_setdetachstate(&task_thread_attr, 
# 120 "project/ish/kernel/task.c" 3 4
                                                  2
# 120 "project/ish/kernel/task.c"
                                                                         );
}
...
# 136 "project/ish/kernel/task.c" 3 4
   __builtin___snprintf_chk (
# 136 "project/ish/kernel/task.c"
   name
# 136 "project/ish/kernel/task.c" 3 4
   , 
# 136 "project/ish/kernel/task.c"
...
# 136 "project/ish/kernel/task.c"
    ...
    size_t name_width = 
# 138 "project/ish/kernel/task.c" 3 4
                       __builtin___snprintf_chk (
# 138 "project/ish/kernel/task.c"
                       name
# 138 "project/ish/kernel/task.c" 3 4
                       , 
# 138 "project/ish/kernel/task.c"
...
# 139 "project/ish/kernel/task.c" 3 4
   __builtin___sprintf_chk (
# 139 "project/ish/kernel/task.c"
   name + (name_width < sizeof(name) - 1 - pid_width ? name_width : sizeof(name) - 1 - pid_width)
# 139 "project/ish/kernel/task.c" 3 4
   , 0, __builtin_object_size (
# 139 "project/ish/kernel/task.c"
   name + (name_width < sizeof(name) - 1 - pid_width ? name_width : sizeof(name) - 1 - pid_width)
