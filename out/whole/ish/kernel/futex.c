...
# 2 "project/ish/kernel/futex.c" 2
...
static lock_t futex_lock = {
# 25 "project/ish/kernel/futex.c" 3 4
                          {0x32AAABA7, {0}}
# 25 "project/ish/kernel/futex.c"
                          , 0};
static struct list futex_hash[(1 << 12)];
...
static struct futex *futex_get_unlocked(addr_t addr) {
    int hash = (addr ^ (unsigned long) current->mem) % (1 << 12);
    struct list *bucket = &futex_hash[hash];
    struct futex *futex;
    for (futex = ((typeof(*futex) *) ((char *) ((bucket)->next) - 
# 37 "project/ish/kernel/futex.c" 3 4
   __builtin_offsetof (
# 37 "project/ish/kernel/futex.c"
   typeof(*futex)
# 37 "project/ish/kernel/futex.c" 3 4
   , 
# 37 "project/ish/kernel/futex.c"
...
# 37 "project/ish/kernel/futex.c"
   )); &futex->chain != (bucket); futex = ((typeof(*futex) *) ((char *) (futex->chain.next) - 
# 37 "project/ish/kernel/futex.c" 3 4
   __builtin_offsetof (
# 37 "project/ish/kernel/futex.c"
   typeof(*futex)
...
# 37 "project/ish/kernel/futex.c"
    ...
    if (futex == 
# 45 "project/ish/kernel/futex.c" 3 4
                ((void *)0)
# 45 "project/ish/kernel/futex.c"
                    ) {
        unlock(&futex_lock);
        return 
# 47 "project/ish/kernel/futex.c" 3 4
              ((void *)0)
# 47 "project/ish/kernel/futex.c"
                  ;
    }
    futex->refcount = 1;
...
static struct futex *futex_get(addr_t addr) {
    __lock(&futex_lock, "project/ish/kernel/futex.c", 60);
    struct futex *futex = futex_get_unlocked(addr);
    if (futex == 
# 62 "project/ish/kernel/futex.c" 3 4
                ((void *)0)
# 62 "project/ish/kernel/futex.c"
                    )
        unlock(&futex_lock);
    return futex;
}
...
# 69 "project/ish/kernel/futex.c" 3 4
       (__builtin_expect(!(
# 69 "project/ish/kernel/futex.c"
       list_empty(&futex->queue)
# 69 "project/ish/kernel/futex.c" 3 4
       ), 0) ? __assert_rtn(__func__, "project/ish/kernel/futex.c", 69, 
# 69 "project/ish/kernel/futex.c"
       "list_empty(&futex->queue)"
# 69 "project/ish/kernel/futex.c" 3 4
       ) : (void)0)
...
# 83 "project/ish/kernel/futex.c" 3 4
   (__builtin_expect(!(
# 83 "project/ish/kernel/futex.c"
   futex->mem == current->mem
# 83 "project/ish/kernel/futex.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/kernel/futex.c", 83, 
# 83 "project/ish/kernel/futex.c"
   "futex->mem == current->mem"
# 83 "project/ish/kernel/futex.c" 3 4
   ) : (void)0)
# 83 "project/ish/kernel/futex.c"
    ...
    dword_t *ptr = mem_ptr(current->mem, futex->addr, 0);
    read_wrunlock(&current->mem->lock);
    if (ptr == 
# 87 "project/ish/kernel/futex.c" 3 4
              ((void *)0)
# 87 "project/ish/kernel/futex.c"
                  )
        return 1;
    *out = *ptr;
    return 0;
...
static int futex_wait(addr_t uaddr, dword_t val, struct timespec *timeout) {
    ...
    if (futex_load(futex, &tmp))
        ...
        wait.cond = ((cond_t) {
# 103 "project/ish/kernel/futex.c" 3 4
                   {0x3CB0B1BB, {0}}
# 103 "project/ish/kernel/futex.c"
                   });
        wait.futex = futex;
...
static int futex_wakelike(int op, addr_t uaddr, dword_t wake_max, dword_t requeue_max, addr_t requeue_addr) {
    ...
    unsigned woken = 0;
    for (wait = ((typeof(*(wait)) *) ((char *) ((&futex->queue)->next) - 
# 120 "project/ish/kernel/futex.c" 3 4
   __builtin_offsetof (
# 120 "project/ish/kernel/futex.c"
   typeof(*(wait))
# 120 "project/ish/kernel/futex.c" 3 4
   , 
# 120 "project/ish/kernel/futex.c"
...
# 120 "project/ish/kernel/futex.c"
   )), tmp = ((typeof(*(wait)) *) ((char *) ((wait)->queue.next) - 
# 120 "project/ish/kernel/futex.c" 3 4
   __builtin_offsetof (
# 120 "project/ish/kernel/futex.c"
   typeof(*(wait))
...
# 120 "project/ish/kernel/futex.c"
   )); &wait->queue != (&futex->queue); wait = tmp, tmp = ((typeof(*(wait)) *) ((char *) ((wait)->queue.next) - 
# 120 "project/ish/kernel/futex.c" 3 4
   __builtin_offsetof (
# 120 "project/ish/kernel/futex.c"
   typeof(*(wait))
...
# 120 "project/ish/kernel/futex.c"
    ...
    if (op == 3) {
        ...
        unsigned requeued = 0;
        for (wait = ((typeof(*(wait)) *) ((char *) ((&futex->queue)->next) - 
# 131 "project/ish/kernel/futex.c" 3 4
       __builtin_offsetof (
# 131 "project/ish/kernel/futex.c"
       typeof(*(wait))
# 131 "project/ish/kernel/futex.c" 3 4
       , 
# 131 "project/ish/kernel/futex.c"
...
# 137 "project/ish/kernel/futex.c" 3 4
           (__builtin_expect(!(
# 137 "project/ish/kernel/futex.c"
           futex->refcount > 1
# 137 "project/ish/kernel/futex.c" 3 4
           ), 0) ? __assert_rtn(__func__, "project/ish/kernel/futex.c", 137, 
# 137 "project/ish/kernel/futex.c"
           "futex->refcount > 1"
# 137 "project/ish/kernel/futex.c" 3 4
           ) : (void)0)
...
int futex_wake(addr_t uaddr, dword_t wake_max) {
    return futex_wakelike(1, uaddr, wake_max, 0, 0);
}
...
dword_t sys_futex(addr_t uaddr, dword_t op, dword_t val, addr_t timeout_or_val2, addr_t uaddr2, dword_t val3) {
    ...
    if ((op & ~(128)) == 0 && timeout_or_val2) {
        struct timespec_ timeout_;
        if (user_read(timeout_or_val2, &(timeout_), sizeof(timeout_)))
            return -14;
    ...
    switch (op & ~(128)) {
        case 0:
            __use(0, uaddr, val, timeout_or_val2, timeout.tv_sec, timeout.tv_nsec);
            return futex_wait(uaddr, val, timeout_or_val2 ? &timeout : 
# 170 "project/ish/kernel/futex.c" 3 4
                                                                      ((void *)0)
# 170 "project/ish/kernel/futex.c"
                                                                          );
        case 1:
            __use(0, uaddr, val);
            return futex_wakelike(op & ~(128), uaddr, val, 0, 0);
        case 3:
            __use(0, uaddr, val, uaddr2);
            return futex_wakelike(op & ~(128), uaddr, val, timeout_or_val2, uaddr2);
    }
    __use(0, uaddr, op, val, timeout_or_val2, uaddr2, val3);
    ish_printk("FIXME " "unsupported futex operation %d" "\n", op);
    return -38;
}
...
int_t sys_get_robust_list(pid_t_ pid, addr_t robust_list_ptr, addr_t len_ptr) {
    __use(0, pid, robust_list_ptr, len_ptr);

    __lock(&pids_lock, "project/ish/kernel/futex.c", 200);
    struct task *task = pid_get_task(pid);
    unlock(&pids_lock);
    if (task != current)
        return -1;

    if (user_write(robust_list_ptr, &(current->robust_list), sizeof(current->robust_list)))
        return -14;
    if (user_write(len_ptr, &((int[]) {sizeof(struct robust_list_head_)}), sizeof((int[]) {sizeof(struct robust_list_head_)})))
        return -14;
    return 0;
}
