...
# 2 "project/ish/kernel/errno.c" 2
...
# 3 "project/ish/kernel/errno.c" 2
...
int err_map(int err);
int errno_map(void);
# 5 "project/ish/kernel/errno.c" 2

int err_map(int err) {
#define ERRCASE(err) case err: return _ ##err;

    switch (err) {
        case 
# 10 "project/ish/kernel/errno.c" 3 4
       1
# 10 "project/ish/kernel/errno.c"
       : return -1;
        case 
# 11 "project/ish/kernel/errno.c" 3 4
       2
# 11 "project/ish/kernel/errno.c"
       : return -2;
        case 
# 12 "project/ish/kernel/errno.c" 3 4
       3
# 12 "project/ish/kernel/errno.c"
       : return -3;
        case 
# 13 "project/ish/kernel/errno.c" 3 4
       4
# 13 "project/ish/kernel/errno.c"
       : return -4;
        case 
# 14 "project/ish/kernel/errno.c" 3 4
       5
# 14 "project/ish/kernel/errno.c"
       : return -5;
        case 
# 15 "project/ish/kernel/errno.c" 3 4
       6
# 15 "project/ish/kernel/errno.c"
       : return -6;
        case 
# 16 "project/ish/kernel/errno.c" 3 4
       7
# 16 "project/ish/kernel/errno.c"
       : return -7;
        case 
# 17 "project/ish/kernel/errno.c" 3 4
       8
# 17 "project/ish/kernel/errno.c"
       : return -8;
        case 
# 18 "project/ish/kernel/errno.c" 3 4
       9
# 18 "project/ish/kernel/errno.c"
       : return -9;
        case 
# 19 "project/ish/kernel/errno.c" 3 4
       10
# 19 "project/ish/kernel/errno.c"
       : return -10;
        case 
# 20 "project/ish/kernel/errno.c" 3 4
       35
# 20 "project/ish/kernel/errno.c"
       : return -11;
        case 
# 21 "project/ish/kernel/errno.c" 3 4
       12
# 21 "project/ish/kernel/errno.c"
       : return -12;
        case 
# 22 "project/ish/kernel/errno.c" 3 4
       13
# 22 "project/ish/kernel/errno.c"
       : return -13;
        case 
# 23 "project/ish/kernel/errno.c" 3 4
       14
# 23 "project/ish/kernel/errno.c"
       : return -14;
        case 
# 24 "project/ish/kernel/errno.c" 3 4
       15
# 24 "project/ish/kernel/errno.c"
       : return -15;
        case 
# 25 "project/ish/kernel/errno.c" 3 4
       16
# 25 "project/ish/kernel/errno.c"
       : return -16;
        case 
# 26 "project/ish/kernel/errno.c" 3 4
       17
# 26 "project/ish/kernel/errno.c"
       : return -17;
        case 
# 27 "project/ish/kernel/errno.c" 3 4
       18
# 27 "project/ish/kernel/errno.c"
       : return -18;
        case 
# 28 "project/ish/kernel/errno.c" 3 4
       19
# 28 "project/ish/kernel/errno.c"
       : return -19;
        case 
# 29 "project/ish/kernel/errno.c" 3 4
       20
# 29 "project/ish/kernel/errno.c"
       : return -20;
        case 
# 30 "project/ish/kernel/errno.c" 3 4
       21
# 30 "project/ish/kernel/errno.c"
       : return -21;
        case 
# 31 "project/ish/kernel/errno.c" 3 4
       22
# 31 "project/ish/kernel/errno.c"
       : return -22;
        case 
# 32 "project/ish/kernel/errno.c" 3 4
       23
# 32 "project/ish/kernel/errno.c"
       : return -23;
        case 
# 33 "project/ish/kernel/errno.c" 3 4
       24
# 33 "project/ish/kernel/errno.c"
       : return -24;
        case 
# 34 "project/ish/kernel/errno.c" 3 4
       25
# 34 "project/ish/kernel/errno.c"
       : return -25;
        case 
# 35 "project/ish/kernel/errno.c" 3 4
       26
# 35 "project/ish/kernel/errno.c"
       : return -26;
        case 
# 36 "project/ish/kernel/errno.c" 3 4
       27
# 36 "project/ish/kernel/errno.c"
       : return -27;
        case 
# 37 "project/ish/kernel/errno.c" 3 4
       28
# 37 "project/ish/kernel/errno.c"
       : return -28;
        case 
# 38 "project/ish/kernel/errno.c" 3 4
       29
# 38 "project/ish/kernel/errno.c"
       : return -29;
        case 
# 39 "project/ish/kernel/errno.c" 3 4
       30
# 39 "project/ish/kernel/errno.c"
       : return -30;
        case 
# 40 "project/ish/kernel/errno.c" 3 4
       31
# 40 "project/ish/kernel/errno.c"
       : return -31;
        case 
# 41 "project/ish/kernel/errno.c" 3 4
       32
# 41 "project/ish/kernel/errno.c"
       : return -32;
        case 
# 42 "project/ish/kernel/errno.c" 3 4
       33
# 42 "project/ish/kernel/errno.c"
       : return -33;
        case 
# 43 "project/ish/kernel/errno.c" 3 4
       34
# 43 "project/ish/kernel/errno.c"
       : return -34;
        case 
# 44 "project/ish/kernel/errno.c" 3 4
       11
# 44 "project/ish/kernel/errno.c"
       : return -35;
        case 
# 45 "project/ish/kernel/errno.c" 3 4
       63
# 45 "project/ish/kernel/errno.c"
       : return -36;
        case 
# 46 "project/ish/kernel/errno.c" 3 4
       77
# 46 "project/ish/kernel/errno.c"
       : return -37;
        case 
# 47 "project/ish/kernel/errno.c" 3 4
       78
# 47 "project/ish/kernel/errno.c"
       : return -38;
        case 
# 48 "project/ish/kernel/errno.c" 3 4
       66
# 48 "project/ish/kernel/errno.c"
       : return -39;
        case 
# 49 "project/ish/kernel/errno.c" 3 4
       62
# 49 "project/ish/kernel/errno.c"
       : return -40;
        case 
# 50 "project/ish/kernel/errno.c" 3 4
       99
# 50 "project/ish/kernel/errno.c"
       : return -60;
        case 
# 51 "project/ish/kernel/errno.c" 3 4
       96
# 51 "project/ish/kernel/errno.c"
       : return -61;
        case 
# 52 "project/ish/kernel/errno.c" 3 4
       101
# 52 "project/ish/kernel/errno.c"
       : return -62;
        case 
# 53 "project/ish/kernel/errno.c" 3 4
       98
# 53 "project/ish/kernel/errno.c"
       : return -63;
        case 
# 54 "project/ish/kernel/errno.c" 3 4
       71
# 54 "project/ish/kernel/errno.c"
       : return -66;
        case 
# 55 "project/ish/kernel/errno.c" 3 4
       97
# 55 "project/ish/kernel/errno.c"
       : return -67;
        case 
# 56 "project/ish/kernel/errno.c" 3 4
       100
# 56 "project/ish/kernel/errno.c"
       : return -71;
        case 
# 57 "project/ish/kernel/errno.c" 3 4
       95
# 57 "project/ish/kernel/errno.c"
       : return -72;
        case 
# 58 "project/ish/kernel/errno.c" 3 4
       94
# 58 "project/ish/kernel/errno.c"
       : return -74;
        case 
# 59 "project/ish/kernel/errno.c" 3 4
       84
# 59 "project/ish/kernel/errno.c"
       : return -75;
        case 
# 60 "project/ish/kernel/errno.c" 3 4
       92
# 60 "project/ish/kernel/errno.c"
       : return -84;
        case 
# 61 "project/ish/kernel/errno.c" 3 4
       68
# 61 "project/ish/kernel/errno.c"
       : return -87;
        case 
# 62 "project/ish/kernel/errno.c" 3 4
       38
# 62 "project/ish/kernel/errno.c"
       : return -88;
        case 
# 63 "project/ish/kernel/errno.c" 3 4
       39
# 63 "project/ish/kernel/errno.c"
       : return -89;
        case 
# 64 "project/ish/kernel/errno.c" 3 4
       40
# 64 "project/ish/kernel/errno.c"
       : return -90;
        case 
# 65 "project/ish/kernel/errno.c" 3 4
       41
# 65 "project/ish/kernel/errno.c"
       : return -91;
        case 
# 66 "project/ish/kernel/errno.c" 3 4
       42
# 66 "project/ish/kernel/errno.c"
       : return -92;
        case 
# 67 "project/ish/kernel/errno.c" 3 4
       43
# 67 "project/ish/kernel/errno.c"
       : return -93;
        case 
# 68 "project/ish/kernel/errno.c" 3 4
       44
# 68 "project/ish/kernel/errno.c"
       : return -94;
        case 
# 69 "project/ish/kernel/errno.c" 3 4
       102
# 69 "project/ish/kernel/errno.c"
       : return -95;

        case 
# 71 "project/ish/kernel/errno.c" 3 4
       45
# 71 "project/ish/kernel/errno.c"
       : return -95;

        case 
# 73 "project/ish/kernel/errno.c" 3 4
       46
# 73 "project/ish/kernel/errno.c"
       : return -96;
        case 
# 74 "project/ish/kernel/errno.c" 3 4
       47
# 74 "project/ish/kernel/errno.c"
       : return -97;
        case 
# 75 "project/ish/kernel/errno.c" 3 4
       48
# 75 "project/ish/kernel/errno.c"
       : return -98;
        case 
# 76 "project/ish/kernel/errno.c" 3 4
       49
# 76 "project/ish/kernel/errno.c"
       : return -99;
        case 
# 77 "project/ish/kernel/errno.c" 3 4
       50
# 77 "project/ish/kernel/errno.c"
       : return -100;
        case 
# 78 "project/ish/kernel/errno.c" 3 4
       51
# 78 "project/ish/kernel/errno.c"
       : return -101;
        case 
# 79 "project/ish/kernel/errno.c" 3 4
       52
# 79 "project/ish/kernel/errno.c"
       : return -102;
        case 
# 80 "project/ish/kernel/errno.c" 3 4
       53
# 80 "project/ish/kernel/errno.c"
       : return -103;
        case 
# 81 "project/ish/kernel/errno.c" 3 4
       54
# 81 "project/ish/kernel/errno.c"
       : return -104;
        case 
# 82 "project/ish/kernel/errno.c" 3 4
       55
# 82 "project/ish/kernel/errno.c"
       : return -105;
        case 
# 83 "project/ish/kernel/errno.c" 3 4
       56
# 83 "project/ish/kernel/errno.c"
       : return -106;
        case 
# 84 "project/ish/kernel/errno.c" 3 4
       57
# 84 "project/ish/kernel/errno.c"
       : return -107;
        case 
# 85 "project/ish/kernel/errno.c" 3 4
       58
# 85 "project/ish/kernel/errno.c"
       : return -108;
        case 
# 86 "project/ish/kernel/errno.c" 3 4
       59
# 86 "project/ish/kernel/errno.c"
       : return -109;
        case 
# 87 "project/ish/kernel/errno.c" 3 4
       60
# 87 "project/ish/kernel/errno.c"
       : return -110;
        case 
# 88 "project/ish/kernel/errno.c" 3 4
       61
# 88 "project/ish/kernel/errno.c"
       : return -111;
        case 
# 89 "project/ish/kernel/errno.c" 3 4
       64
# 89 "project/ish/kernel/errno.c"
       : return -112;
        case 
# 90 "project/ish/kernel/errno.c" 3 4
       65
# 90 "project/ish/kernel/errno.c"
       : return -113;
        case 
# 91 "project/ish/kernel/errno.c" 3 4
       37
# 91 "project/ish/kernel/errno.c"
       : return -114;
        case 
# 92 "project/ish/kernel/errno.c" 3 4
       36
# 92 "project/ish/kernel/errno.c"
       : return -115;
        case 
# 93 "project/ish/kernel/errno.c" 3 4
       70
# 93 "project/ish/kernel/errno.c"
       : return -116;
        case 
# 94 "project/ish/kernel/errno.c" 3 4
       69
# 94 "project/ish/kernel/errno.c"
       : return -122;
    }
#undef ERRCASE
    ish_printk("unknown error %d\n", err);
    return -(err | 0x1000);
}

int errno_map() {
    if (
# 102 "project/ish/kernel/errno.c" 3 4
       (*__error()) 
# 102 "project/ish/kernel/errno.c"
             == 
# 102 "project/ish/kernel/errno.c" 3 4
                32
# 102 "project/ish/kernel/errno.c"
                     )
        send_signal(current, 13, SIGINFO_NIL);
    return err_map(
# 104 "project/ish/kernel/errno.c" 3 4
                  (*__error())
# 104 "project/ish/kernel/errno.c"
                       );
}
