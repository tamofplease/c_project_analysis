# 0 "project/ish/tools/undefined-flags.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 6 "/Users/washi38/University/Labo/c_project_analysis/project/ish/emu/modrm.h" 2
...
# 7 "/Users/washi38/University/Labo/c_project_analysis/project/ish/emu/modrm.h" 2
...
#define READ(thing) *ip += sizeof(thing); if (!tlb_read(tlb, *ip - sizeof(thing), &(thing), sizeof(thing))) return false
...
# 2 "project/ish/tools/undefined-flags.c" 2
# 1 "project/ish/tools/undefined-flags.h" 1



int undefined_flags_mask(struct cpu_state *cpu, struct tlb *tlb);
# 3 "project/ish/tools/undefined-flags.c" 2
# 1 "project/ish/tools/ptutil.h" 1
# 1 "project/ish/tools/../misc.h" 1
# 2 "project/ish/tools/ptutil.h" 2
...
# 4 "project/ish/tools/undefined-flags.c" 2
    ...
    switch (opcode) {
        ...
        case 0x0f:
            ...
            switch(opcode) {
                ...
                case 0xaf: return (1 << 7)|(1 << 6)|(1 << 4)|(1 << 2);
                case 0xbd: case 0xbc: return (1 << 11)|(1 << 7)|(1 << 4)|(1 << 2)|(1 << 0);
            }
            break;

        case 0x69:
        case 0x6b: return (1 << 7)|(1 << 6)|(1 << 4)|(1 << 2);
        ...
        case 0xf6: case 0xf7: {
            ...
            switch (((modrm & 0b00111000) >> 3)) {
                case 4: return (1 << 7)|(1 << 6)|(1 << 4)|(1 << 2);
                case 5: return (1 << 7)|(1 << 6)|(1 << 4)|(1 << 2);
            }
            break;
        }
        case 0x66: goto skip;
