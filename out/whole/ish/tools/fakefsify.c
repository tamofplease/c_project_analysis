# 0 "project/ish/tools/fakefsify.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/ish/tools/fakefsify.c"
...
# 2 "project/ish/tools/fakefsify.c" 2
...
# 3 "project/ish/tools/fakefsify.c" 2
...
# 4 "project/ish/tools/fakefsify.c" 2
...
# 9 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/fake.h" 2



struct fd *fakefs_open_inode(struct mount *mount, ino_t inode);
# 7 "project/ish/tools/fakefsify.c" 2
...
# 8 "project/ish/tools/fakefsify.c" 2
...
int main(int argc, const char *argv[]) {
    ...
    if (argc != 3) {
        fprintf(
# 21 "project/ish/tools/fakefsify.c" 3 4
               __stderrp
# 21 "project/ish/tools/fakefsify.c"
                     , "wrong number of arguments\n");
        switch (cmd) {
            case cmd_import:
                fprintf(
# 24 "project/ish/tools/fakefsify.c" 3 4
                       __stderrp
# 24 "project/ish/tools/fakefsify.c"
                             , "usage: %s <rootfs.tar.gz> <fakefs>\n", argv[0]);
                break;
            case cmd_export:
                fprintf(
# 27 "project/ish/tools/fakefsify.c" 3 4
                       __stderrp
# 27 "project/ish/tools/fakefsify.c"
...
# 34 "project/ish/tools/fakefsify.c" 3 4
   _Bool 
# 34 "project/ish/tools/fakefsify.c"
...
# 34 "project/ish/tools/fakefsify.c"
    ...
    if (!(*func)(argv[1], argv[2], &err, (struct progress) {})) {
        fprintf(
# 40 "project/ish/tools/fakefsify.c" 3 4
               __stderrp
# 40 "project/ish/tools/fakefsify.c"
