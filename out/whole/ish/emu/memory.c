...
# 72 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/unistd.h" 2 3 4
...
# 200 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/unistd.h" 2 3 4
...
# 85 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/unistd.h" 2 3 4
...
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/ish/kernel/signal.h" 2
...
# 6 "/Users/washi38/University/Labo/c_project_analysis/project/ish/kernel/signal.h" 2
...
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/ish/util/sync.h" 2
...
# 7 "/Users/washi38/University/Labo/c_project_analysis/project/ish/kernel/signal.h" 2
struct task;
...
# 14 "project/ish/emu/memory.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/ish/jit/jit.h" 1

#define JIT_H 
# 15 "project/ish/emu/memory.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/ish/kernel/vdso.h" 1

#define KERNEL_VDSO_H 
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/ish/tools/ptraceomatic-config.h" 1
#define VVAR_PAGES 4
#define VDSO_PAGES 2
# 4 "/Users/washi38/University/Labo/c_project_analysis/project/ish/kernel/vdso.h" 2

extern const char vdso_data[2 * (1 << 12)] __asm__("vdso_data");
int vdso_symbol(const char *name);
# 16 "project/ish/emu/memory.c" 2
...
void mem_init(struct mem *mem) {
    mem->pgdir = calloc((1 << 10), sizeof(struct pt_entry *));
    mem->pgdir_used = 0;
...
void mem_destroy(struct mem *mem) {
    __write_wrlock(&mem->lock, "project/ish/emu/memory.c", 35);
    pt_unmap_always(mem, 0, (1 << 20));



    for (int i = 0; i < (1 << 10); i++) {
        if (mem->pgdir[i] != 
# 41 "project/ish/emu/memory.c" 3 4
                            ((void *)0)
# 41 "project/ish/emu/memory.c"
                                )
            free(mem->pgdir[i]);
    }
    free(mem->pgdir);
...
static struct pt_entry *mem_pt_new(struct mem *mem, page_t page) {
    struct pt_entry *pgdir = mem->pgdir[((page) >> 10)];
    if (pgdir == 
# 54 "project/ish/emu/memory.c" 3 4
                ((void *)0)
# 54 "project/ish/emu/memory.c"
                    ) {
        pgdir = mem->pgdir[((page) >> 10)] = calloc((1 << 10), sizeof(struct pt_entry));
        mem->pgdir_used++;
    }
    return &pgdir[((page) & ((1 << 10) - 1))];
}

struct pt_entry *mem_pt(struct mem *mem, page_t page) {
    struct pt_entry *pgdir = mem->pgdir[((page) >> 10)];
    if (pgdir == 
# 63 "project/ish/emu/memory.c" 3 4
                ((void *)0)
# 63 "project/ish/emu/memory.c"
                    )
        return 
# 64 "project/ish/emu/memory.c" 3 4
              ((void *)0)
# 64 "project/ish/emu/memory.c"
                  ;
    struct pt_entry *entry = &pgdir[((page) & ((1 << 10) - 1))];
    if (entry->data == 
# 66 "project/ish/emu/memory.c" 3 4
                      ((void *)0)
# 66 "project/ish/emu/memory.c"
                          )
        return 
# 67 "project/ish/emu/memory.c" 3 4
              ((void *)0)
# 67 "project/ish/emu/memory.c"
                  ;
    return entry;
}
...
static void mem_pt_del(struct mem *mem, page_t page) {
    ...
    if (entry != 
# 73 "project/ish/emu/memory.c" 3 4
                ((void *)0)
# 73 "project/ish/emu/memory.c"
                    )
        entry->data = 
# 74 "project/ish/emu/memory.c" 3 4
                     ((void *)0)
# 74 "project/ish/emu/memory.c"
                         ;
}
...
void mem_next_page(struct mem *mem, page_t *page) {
    ...
    if (*page >= (1 << 20))
        return;
    while (*page < (1 << 20) && mem->pgdir[((*page) >> 10)] == 
# 81 "project/ish/emu/memory.c" 3 4
                                                               ((void *)0)
# 81 "project/ish/emu/memory.c"
                                                                   )
        *page = (*page - ((*page) & ((1 << 10) - 1))) + (1 << 10);
}

page_t pt_find_hole(struct mem *mem, pages_t size) {
    page_t hole_end = 0;
    
# 87 "project/ish/emu/memory.c" 3 4
   _Bool 
# 87 "project/ish/emu/memory.c"
        in_hole = 
# 87 "project/ish/emu/memory.c" 3 4
                  0
# 87 "project/ish/emu/memory.c"
    ...
    for (page_t page = 0xf7ffd; page > 0x40000; page--) {
        ...
        if (!in_hole && mem_pt(mem, page) == 
# 90 "project/ish/emu/memory.c" 3 4
                                            ((void *)0)
# 90 "project/ish/emu/memory.c"
                                                ) {
            in_hole = 
# 91 "project/ish/emu/memory.c" 3 4
                     1
# 91 "project/ish/emu/memory.c"
                         ;
            hole_end = page + 1;
        }
        if (mem_pt(mem, page) != 
# 94 "project/ish/emu/memory.c" 3 4
                                ((void *)0)
# 94 "project/ish/emu/memory.c"
                                    )
            in_hole = 
# 95 "project/ish/emu/memory.c" 3 4
                     0
# 95 "project/ish/emu/memory.c"
                          ;
...
# 102 "project/ish/emu/memory.c" 3 4
_Bool 
# 102 "project/ish/emu/memory.c"
    pt_is_hole(struct mem *mem, page_t start, pages_t pages) {
    for (page_t page = start; page < start + pages; page++) {
        if (mem_pt(mem, page) != 
# 104 "project/ish/emu/memory.c" 3 4
                                ((void *)0)
# 104 "project/ish/emu/memory.c"
                                    )
            return 
# 105 "project/ish/emu/memory.c" 3 4
                  0
# 105 "project/ish/emu/memory.c"
                       ;
    }
    return 
# 107 "project/ish/emu/memory.c" 3 4
          1
# 107 "project/ish/emu/memory.c"
              ;
}

int pt_map(struct mem *mem, page_t start, pages_t pages, void *memory, size_t offset, unsigned flags) {
    if (memory == 
# 111 "project/ish/emu/memory.c" 3 4
                 ((void *)-1)
# 111 "project/ish/emu/memory.c"
                           )
        return errno_map();


    
# 115 "project/ish/emu/memory.c" 3 4
   (__builtin_expect(!(
# 115 "project/ish/emu/memory.c"
   (uintptr_t) memory % real_page_size == 0 || memory == vdso_data
# 115 "project/ish/emu/memory.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/emu/memory.c", 115, 
# 115 "project/ish/emu/memory.c"
   "(uintptr_t) memory % real_page_size == 0 || memory == vdso_data"
# 115 "project/ish/emu/memory.c" 3 4
   ) : (void)0)
# 115 "project/ish/emu/memory.c"
    ...
    if (data == 
# 118 "project/ish/emu/memory.c" 3 4
               ((void *)0)
# 118 "project/ish/emu/memory.c"
                   )
        return -12;
    *data = (struct data) {
        .data = memory,
        .size = pages * (1 << 12) + offset,
    ...
    for (page_t page = start; page < start + pages; page++) {
        if (mem_pt(mem, page) != 
# 131 "project/ish/emu/memory.c" 3 4
                                ((void *)0)
# 131 "project/ish/emu/memory.c"
                                    )
            pt_unmap(mem, page, 1);
        data->refcount++;
        struct pt_entry *pt = mem_pt_new(mem, page);
        pt->data = data;
        pt->offset = ((page - start) << 12) + offset;
        pt->flags = flags;
    }
    return 0;
}
...
int pt_unmap(struct mem *mem, page_t start, pages_t pages) {
    for (page_t page = start; page < start + pages; page++)
        if (mem_pt(mem, page) == 
# 144 "project/ish/emu/memory.c" 3 4
                                ((void *)0)
# 144 "project/ish/emu/memory.c"
                                    )
            return -1;
...
int pt_unmap_always(struct mem *mem, page_t start, pages_t pages) {
    for (page_t page = start; page < start + pages; mem_next_page(mem, &page)) {
        ...
        if (pt == 
# 152 "project/ish/emu/memory.c" 3 4
                 ((void *)0)
# 152 "project/ish/emu/memory.c"
                     )
            continue;
        ...
        if (--data->refcount == 0) {
            ...
            if (data->data != vdso_data) {
                ...
                if (err != 0)
                    die("munmap(%p, %lu) failed: %s", data->data, data->size, strerror(
# 164 "project/ish/emu/memory.c" 3 4
                                                                                      (*__error())
# 164 "project/ish/emu/memory.c"
                                                                                           ));
            }
            if (data->fd != 
# 166 "project/ish/emu/memory.c" 3 4
                           ((void *)0)
# 166 "project/ish/emu/memory.c"
                               ) {
                fd_close(data->fd);
            }
            free(data);
...
int pt_map_nothing(struct mem *mem, page_t start, pages_t pages, unsigned flags) {
    if (pages == 0) return 0;
    void *memory = mmap(
# 178 "project/ish/emu/memory.c" 3 4
                       ((void *)0)
# 178 "project/ish/emu/memory.c"
                           , pages * (1 << 12),
            
# 179 "project/ish/emu/memory.c" 3 4
           0x01 
# 179 "project/ish/emu/memory.c"
                     | 
# 179 "project/ish/emu/memory.c" 3 4
                       0x02
# 179 "project/ish/emu/memory.c"
...
# 179 "project/ish/emu/memory.c"
                                                              , 0, 0);
    return pt_map(mem, start, pages, memory, 0, flags | (1 << 6));
}

int pt_set_flags(struct mem *mem, page_t start, pages_t pages, int flags) {
    for (page_t page = start; page < start + pages; page++)
        if (mem_pt(mem, page) == 
# 185 "project/ish/emu/memory.c" 3 4
                                ((void *)0)
# 185 "project/ish/emu/memory.c"
                                    )
            return -12;
    for (page_t page = start; page < start + pages; page++) {
        struct pt_entry *entry = mem_pt(mem, page);
        ...
        if ((flags & ~old_flags) & ((1 << 0)|(1 << 1))) {
            void *data = (char *) entry->data->data + entry->offset;

            data = (void *) ((uintptr_t) data & ~(real_page_size - 1));
            int prot = 
# 196 "project/ish/emu/memory.c" 3 4
                      0x01
# 196 "project/ish/emu/memory.c"
                               ;
            if (flags & (1 << 1)) prot |= 
# 197 "project/ish/emu/memory.c" 3 4
                                        0x02
# 197 "project/ish/emu/memory.c"
                                                  ;
...
int pt_copy_on_write(struct mem *src, struct mem *dst, page_t start, page_t pages) {
    for (page_t page = start; page < start + pages; mem_next_page(src, &page)) {
        ...
        if (entry == 
# 209 "project/ish/emu/memory.c" 3 4
                    ((void *)0)
# 209 "project/ish/emu/memory.c"
                        )
            continue;
...
void *mem_ptr(struct mem *mem, addr_t addr, int type) {
    ...
    if (entry == 
# 234 "project/ish/emu/memory.c" 3 4
                ((void *)0)
# 234 "project/ish/emu/memory.c"
                    ) {


        page_t p = page + 1;
        while (p < (1 << 20) && mem_pt(mem, p) == 
# 238 "project/ish/emu/memory.c" 3 4
                                                 ((void *)0)
# 238 "project/ish/emu/memory.c"
                                                     )
            p++;
        if (p >= (1 << 20))
            return 
# 241 "project/ish/emu/memory.c" 3 4
                  ((void *)0)
# 241 "project/ish/emu/memory.c"
                      ;
        if (!(mem_pt(mem, p)->flags & (1 << 3)))
            return 
# 243 "project/ish/emu/memory.c" 3 4
                  ((void *)0)
# 243 "project/ish/emu/memory.c"
                      ;
        ...
        __write_wrlock(&mem->lock, "project/ish/emu/memory.c", 252);
        pt_map_nothing(mem, page, 1, (1 << 1) | (1 << 3));
        write_wrunlock(&mem->lock);
    ...
    if (entry != 
# 260 "project/ish/emu/memory.c" 3 4
                ((void *)0) 
# 260 "project/ish/emu/memory.c"
                     && (type == 1 || type == 2)) {

        if (type != 2 && !(entry->flags & (1 << 1)))
            return 
# 263 "project/ish/emu/memory.c" 3 4
                  ((void *)0)
# 263 "project/ish/emu/memory.c"
                      ;
        if (type == 2) {
        ...
        if (entry->flags & (1 << 4)) {
            void *data = (char *) entry->data->data + entry->offset;
            void *copy = mmap(
# 275 "project/ish/emu/memory.c" 3 4
                             ((void *)0)
# 275 "project/ish/emu/memory.c"
                                 , (1 << 12), 
# 275 "project/ish/emu/memory.c" 3 4
                                              0x01 
# 275 "project/ish/emu/memory.c"
...
# 276 "project/ish/emu/memory.c" 3 4
                   0x0002 
# 276 "project/ish/emu/memory.c"
                               | 
# 276 "project/ish/emu/memory.c" 3 4
                                 0x1000
# 276 "project/ish/emu/memory.c"
            ...
            read_wrunlock(&mem->lock);
            __write_wrlock(&mem->lock, "project/ish/emu/memory.c", 280);
            
# 281 "project/ish/emu/memory.c" 3 4
           __builtin___memcpy_chk (
# 281 "project/ish/emu/memory.c"
           copy
# 281 "project/ish/emu/memory.c" 3 4
           , 
# 281 "project/ish/emu/memory.c"
...
# 281 "project/ish/emu/memory.c"
                                        ;
            pt_map(mem, page, 1, copy, 0, entry->flags &~ (1 << 4));
            write_wrunlock(&mem->lock);
            read_wrlock(&mem->lock);
        }
    }
    ...
    if (entry == 
# 288 "project/ish/emu/memory.c" 3 4
                ((void *)0)
# 288 "project/ish/emu/memory.c"
                    )
        return 
# 289 "project/ish/emu/memory.c" 3 4
              ((void *)0)
# 289 "project/ish/emu/memory.c"
                  ;
    return entry->data->data + entry->offset + ((addr) & ((1 << 12) - 1));
}

static void *mem_mmu_translate(struct mmu *mmu, addr_t addr, int type) {
    return mem_ptr(((struct mem *) ((char *) (mmu) - 
# 294 "project/ish/emu/memory.c" 3 4
                  __builtin_offsetof (
# 294 "project/ish/emu/memory.c"
                  struct mem
# 294 "project/ish/emu/memory.c" 3 4
                  , 
# 294 "project/ish/emu/memory.c"
...
int mem_segv_reason(struct mem *mem, addr_t addr) {
    struct pt_entry *pt = mem_pt(mem, ((addr) >> 12));
    if (pt == 
# 303 "project/ish/emu/memory.c" 3 4
             ((void *)0)
# 303 "project/ish/emu/memory.c"
                 )
        return 1;
    return 2;
}
...
__attribute__((constructor)) static void get_real_page_size() {
    real_page_size = sysconf(
# 310 "project/ish/emu/memory.c" 3 4
                            29
# 310 "project/ish/emu/memory.c"
                                        );
}

void mem_coredump(struct mem *mem, const char *file) {
    int fd = open(file, 
# 314 "project/ish/emu/memory.c" 3 4
                       0x00000200 
# 314 "project/ish/emu/memory.c"
                               | 
# 314 "project/ish/emu/memory.c" 3 4
                                 0x0002 
# 314 "project/ish/emu/memory.c"
...
# 314 "project/ish/emu/memory.c"
    ...
    for (page_t page = 0; page < (1 << 20); page++) {
        struct pt_entry *entry = mem_pt(mem, page);
        if (entry == 
# 327 "project/ish/emu/memory.c" 3 4
                    ((void *)0)
# 327 "project/ish/emu/memory.c"
                        )
            continue;
        pages++;
        if (lseek(fd, page << 12, 
# 330 "project/ish/emu/memory.c" 3 4
                                        0
# 330 "project/ish/emu/memory.c"
                                                ) < 0) {
            perror("lseek");
            return;
        }
        if (write(fd, entry->data->data, (1 << 12)) < 0) {
            perror("write");
            return;
        }
    }
    ish_printk("dumped %d pages\n", pages);
    close(fd);
}
