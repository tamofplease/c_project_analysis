...
static inline 
# 41 "project/ish/emu/modrm.h" 3 4
             _Bool 
# 41 "project/ish/emu/modrm.h"
...
# 48 "project/ish/emu/modrm.h" 3 4
   0
# 48 "project/ish/emu/modrm.h"
                   ;
...
# 66 "project/ish/emu/modrm.h" 3 4
       0
# 66 "project/ish/emu/modrm.h"
                     ;
...
# 87 "project/ish/emu/modrm.h" 3 4
       0
# 87 "project/ish/emu/modrm.h"
                   ;
        modrm->offset = offset;
    } else if (mode == mode_disp32) {
        int32_t offset;
        *ip += sizeof(offset); if (!tlb_read(tlb, *ip - sizeof(offset), &(offset), sizeof(offset))) return 
# 91 "project/ish/emu/modrm.h" 3 4
       0
# 91 "project/ish/emu/modrm.h"
                   ;
        modrm->offset = offset;
    }
#undef READ
    ...
    return 
# 103 "project/ish/emu/modrm.h" 3 4
          1
# 103 "project/ish/emu/modrm.h"
              ;
}
