...
void fpu_xch(struct cpu_state *cpu, int i) {
    float80 tmp = cpu->fp[(cpu->top + 0) % 8];
    cpu->fp[(cpu->top + 0) % 8] = cpu->fp[(cpu->top + i) % 8];
    cpu->fp[(cpu->top + i) % 8] = tmp;
}
...
void fpu_ld(struct cpu_state *cpu, int i) {
    fpu_push(cpu, cpu->fp[(cpu->top + i) % 8]);
}

void fpu_ldc(struct cpu_state *cpu, enum fpu_const c) {
    fpu_push(cpu, fpu_consts[c]);
}

void fpu_ild16(struct cpu_state *cpu, int16_t *i) {
    fpu_push(cpu, f80_from_int(*i));
}
void fpu_ild32(struct cpu_state *cpu, int32_t *i) {
    fpu_push(cpu, f80_from_int(*i));
}
...
void fpu_ldm32(struct cpu_state *cpu, float32 *f) {
    fpu_push(cpu, f80_from_double(*f));
}
...
void fpu_st(struct cpu_state *cpu, int i) {
    cpu->fp[(cpu->top + i) % 8] = cpu->fp[(cpu->top + 0) % 8];
}

void fpu_ist16(struct cpu_state *cpu, int16_t *i) {
    int64_t res = f80_to_int(cpu->fp[(cpu->top + 0) % 8]);
    if (res < 
# 70 "project/ish/emu/fpu.c" 3 4
             -32768 
# 70 "project/ish/emu/fpu.c"
                       || res > 
# 70 "project/ish/emu/fpu.c" 3 4
                                32767
# 70 "project/ish/emu/fpu.c"
        ...
        res = 
# 71 "project/ish/emu/fpu.c" 3 4
             -32768
# 71 "project/ish/emu/fpu.c"
                      ;
    *i = (int16_t) res;
}
void fpu_ist32(struct cpu_state *cpu, int32_t *i) {
    int64_t res = f80_to_int(cpu->fp[(cpu->top + 0) % 8]);
    if (res < 
# 76 "project/ish/emu/fpu.c" 3 4
             (-2147483647 -1) 
# 76 "project/ish/emu/fpu.c"
                       || res > 
# 76 "project/ish/emu/fpu.c" 3 4
                                2147483647
# 76 "project/ish/emu/fpu.c"
        ...
        res = 
# 77 "project/ish/emu/fpu.c" 3 4
             (-2147483647 -1)
# 77 "project/ish/emu/fpu.c"
                      ;
    *i = (int32_t) res;
}
void fpu_ist64(struct cpu_state *cpu, int64_t *i) {
    *i = f80_to_int(cpu->fp[(cpu->top + 0) % 8]);
}

void fpu_stm32(struct cpu_state *cpu, float32 *f) {
    *f = f80_to_double(cpu->fp[(cpu->top + 0) % 8]);
}
...
# 92 "project/ish/emu/fpu.c" 3 4
   __builtin___memcpy_chk (
# 92 "project/ish/emu/fpu.c"
   f
# 92 "project/ish/emu/fpu.c" 3 4
   , 
# 92 "project/ish/emu/fpu.c"
   &cpu->fp[(cpu->top + 0) % 8], 10
# 92 "project/ish/emu/fpu.c" 3 4
...
void fpu_prem(struct cpu_state *cpu) {
    cpu->fp[(cpu->top + 0) % 8] = f80_mod(cpu->fp[(cpu->top + 0) % 8], cpu->fp[(cpu->top + 1) % 8]);
    cpu->c2 = 0;
}
...
void fpu_scale(struct cpu_state *cpu) {
    ...
    int scale = f80_to_int(cpu->fp[(cpu->top + 1) % 8]);
    f80_rounding_mode = old_mode;
    cpu->fp[(cpu->top + 0) % 8] = f80_scale(cpu->fp[(cpu->top + 0) % 8], scale);
}

void fpu_rndint(struct cpu_state *cpu) {
    if (f80_isinf(cpu->fp[(cpu->top + 0) % 8]) || f80_isnan(cpu->fp[(cpu->top + 0) % 8]))
        return;
    cpu->fp[(cpu->top + 0) % 8] = f80_round(cpu->fp[(cpu->top + 0) % 8]);
}

void fpu_sqrt(struct cpu_state *cpu) {
    cpu->fp[(cpu->top + 0) % 8] = f80_sqrt(cpu->fp[(cpu->top + 0) % 8]);
}

void fpu_yl2x(struct cpu_state *cpu) {
    cpu->fp[(cpu->top + 1) % 8] = f80_mul(cpu->fp[(cpu->top + 1) % 8], f80_log2(cpu->fp[(cpu->top + 0) % 8]));
    fpu_pop(cpu);
}

void fpu_2xm1(struct cpu_state *cpu) {

    cpu->fp[(cpu->top + 0) % 8] = f80_from_double(pow(2, f80_to_double(cpu->fp[(cpu->top + 0) % 8])) - 1);
}

static void fpu_comparei(struct cpu_state *cpu, float80 x) {
    cpu->zf_res = cpu->pf_res = 0;
    cpu->zf = cpu->pf = cpu->cf = 0;
    cpu->cf = f80_lt(cpu->fp[(cpu->top + 0) % 8], x);
    cpu->zf = f80_eq(cpu->fp[(cpu->top + 0) % 8], x);
    if (f80_uncomparable(cpu->fp[(cpu->top + 0) % 8], x))
        cpu->zf = cpu->pf = cpu->cf = 1;
}
static void fpu_compare(struct cpu_state *cpu, float80 x) {
    cpu->c2 = cpu->c1 = 0;
    cpu->c0 = f80_lt(cpu->fp[(cpu->top + 0) % 8], x);
    cpu->c3 = f80_eq(cpu->fp[(cpu->top + 0) % 8], x);
    if (f80_uncomparable(cpu->fp[(cpu->top + 0) % 8], x))
        cpu->c0 = cpu->c2 = cpu->c3 = 1;
}
void fpu_com(struct cpu_state *cpu, int i) {
    fpu_compare(cpu, cpu->fp[(cpu->top + i) % 8]);
}
void fpu_comi(struct cpu_state *cpu, int i) {
    fpu_comparei(cpu, cpu->fp[(cpu->top + i) % 8]);
}
void fpu_comm32(struct cpu_state *cpu, float *f) {
...
void fpu_abs(struct cpu_state *cpu) {
    cpu->fp[(cpu->top + 0) % 8] = f80_abs(cpu->fp[(cpu->top + 0) % 8]);
}

void fpu_chs(struct cpu_state *cpu) {
    cpu->fp[(cpu->top + 0) % 8] = f80_neg(cpu->fp[(cpu->top + 0) % 8]);
}

void fpu_add(struct cpu_state *cpu, int srci, int dsti) {
    cpu->fp[(cpu->top + dsti) % 8] = f80_add(cpu->fp[(cpu->top + dsti) % 8], cpu->fp[(cpu->top + srci) % 8]);
}
void fpu_sub(struct cpu_state *cpu, int srci, int dsti) {
    cpu->fp[(cpu->top + dsti) % 8] = f80_sub(cpu->fp[(cpu->top + dsti) % 8], cpu->fp[(cpu->top + srci) % 8]);
}
void fpu_subr(struct cpu_state *cpu, int srci, int dsti) {
    cpu->fp[(cpu->top + dsti) % 8] = f80_sub(cpu->fp[(cpu->top + srci) % 8], cpu->fp[(cpu->top + dsti) % 8]);
}
void fpu_mul(struct cpu_state *cpu, int srci, int dsti) {
    cpu->fp[(cpu->top + dsti) % 8] = f80_mul(cpu->fp[(cpu->top + dsti) % 8], cpu->fp[(cpu->top + srci) % 8]);
}
void fpu_div(struct cpu_state *cpu, int srci, int dsti) {
    cpu->fp[(cpu->top + dsti) % 8] = f80_div(cpu->fp[(cpu->top + dsti) % 8], cpu->fp[(cpu->top + srci) % 8]);
}
void fpu_divr(struct cpu_state *cpu, int srci, int dsti) {
    cpu->fp[(cpu->top + dsti) % 8] = f80_div(cpu->fp[(cpu->top + srci) % 8], cpu->fp[(cpu->top + dsti) % 8]);
}

void fpu_iadd16(struct cpu_state *cpu, int16_t *i) {
    cpu->fp[(cpu->top + 0) % 8] = f80_add(cpu->fp[(cpu->top + 0) % 8], f80_from_int(*i));
}
void fpu_isub16(struct cpu_state *cpu, int16_t *i) {
    cpu->fp[(cpu->top + 0) % 8] = f80_sub(cpu->fp[(cpu->top + 0) % 8], f80_from_int(*i));
}
void fpu_isubr16(struct cpu_state *cpu, int16_t *i) {
    cpu->fp[(cpu->top + 0) % 8] = f80_sub(f80_from_int(*i), cpu->fp[(cpu->top + 0) % 8]);
}
void fpu_imul16(struct cpu_state *cpu, int16_t *i) {
    cpu->fp[(cpu->top + 0) % 8] = f80_mul(cpu->fp[(cpu->top + 0) % 8], f80_from_int(*i));
}
void fpu_idiv16(struct cpu_state *cpu, int16_t *i) {
    cpu->fp[(cpu->top + 0) % 8] = f80_div(cpu->fp[(cpu->top + 0) % 8], f80_from_int(*i));
}
void fpu_idivr16(struct cpu_state *cpu, int16_t *i) {
    cpu->fp[(cpu->top + 0) % 8] = f80_div(f80_from_int(*i), cpu->fp[(cpu->top + 0) % 8]);
}
...
void fpu_addm32(struct cpu_state *cpu, float32 *f) {
    cpu->fp[(cpu->top + 0) % 8] = f80_add(cpu->fp[(cpu->top + 0) % 8], f80_from_double(*f));
}
void fpu_subm32(struct cpu_state *cpu, float32 *f) {
    cpu->fp[(cpu->top + 0) % 8] = f80_sub(cpu->fp[(cpu->top + 0) % 8], f80_from_double(*f));
}
void fpu_subrm32(struct cpu_state *cpu, float32 *f) {
    cpu->fp[(cpu->top + 0) % 8] = f80_sub(f80_from_double(*f), cpu->fp[(cpu->top + 0) % 8]);
}
void fpu_mulm32(struct cpu_state *cpu, float32 *f) {
    cpu->fp[(cpu->top + 0) % 8] = f80_mul(cpu->fp[(cpu->top + 0) % 8], f80_from_double(*f));
}
void fpu_divm32(struct cpu_state *cpu, float32 *f) {
    cpu->fp[(cpu->top + 0) % 8] = f80_div(cpu->fp[(cpu->top + 0) % 8], f80_from_double(*f));
}
void fpu_divrm32(struct cpu_state *cpu, float32 *f) {
    cpu->fp[(cpu->top + 0) % 8] = f80_div(f80_from_double(*f), cpu->fp[(cpu->top + 0) % 8]);
}
...
void fpu_patan(struct cpu_state *cpu) {
    ...
    cpu->fp[(cpu->top + 1) % 8] = f80_from_double(atan2(f80_to_double(cpu->fp[(cpu->top + 1) % 8]), f80_to_double(cpu->fp[(cpu->top + 0) % 8])));
    fpu_pop(cpu);
}

void fpu_sin(struct cpu_state *cpu) {
    cpu->fp[(cpu->top + 0) % 8] = f80_from_double(sin(f80_to_double(cpu->fp[(cpu->top + 0) % 8])));
}
void fpu_cos(struct cpu_state *cpu) {
    cpu->fp[(cpu->top + 0) % 8] = f80_from_double(cos(f80_to_double(cpu->fp[(cpu->top + 0) % 8])));
}

void fpu_xtract(struct cpu_state *cpu) {
    int exp;
    float80 signif;
    f80_xtract(cpu->fp[(cpu->top + 0) % 8], &exp, &signif);
    cpu->fp[(cpu->top + 0) % 8] = f80_from_int(exp);
    fpu_push(cpu, signif);
}

void fpu_xam(struct cpu_state *cpu) {
    float80 f = cpu->fp[(cpu->top + 0) % 8];
    int outflags = 0;
...
# 356 "project/ish/emu/fpu.c" 3 4
       __builtin___memcpy_chk (
# 356 "project/ish/emu/fpu.c"
       state->regs[i]
# 356 "project/ish/emu/fpu.c" 3 4
       , 
# 356 "project/ish/emu/fpu.c"
       &cpu->fp[(cpu->top + i) % 8], 10
# 356 "project/ish/emu/fpu.c" 3 4
       , __builtin_object_size (
# 356 "project/ish/emu/fpu.c"
       state->regs[i]
...
# 362 "project/ish/emu/fpu.c" 3 4
       __builtin___memcpy_chk (
# 362 "project/ish/emu/fpu.c"
       &cpu->fp[(cpu->top + i) % 8]
# 362 "project/ish/emu/fpu.c" 3 4
       , 
# 362 "project/ish/emu/fpu.c"
