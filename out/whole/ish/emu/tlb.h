...
# 37 "project/ish/emu/tlb.h" 3 4
       (__builtin_expect(!(
# 37 "project/ish/emu/tlb.h"
       address != 
# 37 "project/ish/emu/tlb.h" 3 4
       ((void *)0)), 0) ? __assert_rtn(__func__, "project/ish/emu/tlb.h", 37, 
# 37 "project/ish/emu/tlb.h"
       "address != NULL"
# 37 "project/ish/emu/tlb.h" 3 4
       ) : (void)0)
...
# 42 "project/ish/emu/tlb.h" 3 4
_Bool 
# 42 "project/ish/emu/tlb.h"
...
# 43 "project/ish/emu/tlb.h" 3 4
                           _Bool 
# 43 "project/ish/emu/tlb.h"
    ...
    if (ptr == 
# 47 "project/ish/emu/tlb.h" 3 4
              ((void *)0)
# 47 "project/ish/emu/tlb.h"
                  )
        return 
# 48 "project/ish/emu/tlb.h" 3 4
              0
# 48 "project/ish/emu/tlb.h"
                   ;
    
# 49 "project/ish/emu/tlb.h" 3 4
   __builtin___memcpy_chk (
# 49 "project/ish/emu/tlb.h"
   out
# 49 "project/ish/emu/tlb.h" 3 4
   , 
# 49 "project/ish/emu/tlb.h"
...
# 49 "project/ish/emu/tlb.h"
                         ;
    return 
# 50 "project/ish/emu/tlb.h" 3 4
          1
# 50 "project/ish/emu/tlb.h"
              ;
}
...
# 58 "project/ish/emu/tlb.h" 3 4
       (__builtin_expect(!(
# 58 "project/ish/emu/tlb.h"
       address != 
# 58 "project/ish/emu/tlb.h" 3 4
       ((void *)0)), 0) ? __assert_rtn(__func__, "project/ish/emu/tlb.h", 58, 
# 58 "project/ish/emu/tlb.h"
       "address != NULL"
# 58 "project/ish/emu/tlb.h" 3 4
       ) : (void)0)
...
# 63 "project/ish/emu/tlb.h" 3 4
_Bool 
# 63 "project/ish/emu/tlb.h"
    __tlb_write_cross_page(struct tlb *tlb, addr_t addr, const char *value, unsigned size);
inline __attribute__((always_inline)) __attribute__((no_sanitize("address", "thread", "undefined", "leak"))) 
# 64 "project/ish/emu/tlb.h" 3 4
                           _Bool 
# 64 "project/ish/emu/tlb.h"
    ...
    if (ptr == 
# 68 "project/ish/emu/tlb.h" 3 4
              ((void *)0)
# 68 "project/ish/emu/tlb.h"
                  )
        return 
# 69 "project/ish/emu/tlb.h" 3 4
              0
# 69 "project/ish/emu/tlb.h"
                   ;
    
# 70 "project/ish/emu/tlb.h" 3 4
   __builtin___memcpy_chk (
# 70 "project/ish/emu/tlb.h"
   ptr
# 70 "project/ish/emu/tlb.h" 3 4
   , 
# 70 "project/ish/emu/tlb.h"
...
# 70 "project/ish/emu/tlb.h"
                           ;
    return 
# 71 "project/ish/emu/tlb.h" 3 4
          1
# 71 "project/ish/emu/tlb.h"
              ;
}
