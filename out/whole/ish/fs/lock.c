...
# 5 "project/ish/fs/lock.c" 2

static 
# 6 "project/ish/fs/lock.c" 3 4
      _Bool 
# 6 "project/ish/fs/lock.c"
           file_locks_overlap(struct file_lock *a, struct file_lock *b) {
    return a->end >= b->start && b->end >= a->start;
}

static 
# 10 "project/ish/fs/lock.c" 3 4
      _Bool 
# 10 "project/ish/fs/lock.c"
           file_locks_conflict(struct file_lock *a, struct file_lock *b) {
    if (a->owner == b->owner)
        return 
# 12 "project/ish/fs/lock.c" 3 4
              0
# 12 "project/ish/fs/lock.c"
                   ;
    if (!file_locks_overlap(a, b))
        return 
# 14 "project/ish/fs/lock.c" 3 4
              0
# 14 "project/ish/fs/lock.c"
                   ;

    if (a->type == 1 || b->type == 1)
        return 
# 17 "project/ish/fs/lock.c" 3 4
              1
# 17 "project/ish/fs/lock.c"
                  ;
    return 
# 18 "project/ish/fs/lock.c" 3 4
          0
# 18 "project/ish/fs/lock.c"
               ;
}

static 
# 21 "project/ish/fs/lock.c" 3 4
      _Bool 
# 21 "project/ish/fs/lock.c"
           file_locks_adjacent(struct file_lock *a, struct file_lock *b) {
...
static struct file_lock *file_lock_test(struct inode_data *inode, struct file_lock *request) {
    ...
    for (lock = ((typeof(*lock) *) ((char *) ((&inode->posix_locks)->next) - 
# 27 "project/ish/fs/lock.c" 3 4
   __builtin_offsetof (
# 27 "project/ish/fs/lock.c"
   typeof(*lock)
# 27 "project/ish/fs/lock.c" 3 4
   , 
# 27 "project/ish/fs/lock.c"
...
# 27 "project/ish/fs/lock.c"
   )); &lock->locks != (&inode->posix_locks); lock = ((typeof(*lock) *) ((char *) (lock->locks.next) - 
# 27 "project/ish/fs/lock.c" 3 4
   __builtin_offsetof (
# 27 "project/ish/fs/lock.c"
   typeof(*lock)
...
# 27 "project/ish/fs/lock.c"
    ...
    return 
# 31 "project/ish/fs/lock.c" 3 4
          ((void *)0)
# 31 "project/ish/fs/lock.c"
              ;
}
...
static int file_lock_acquire(struct inode_data *inode, struct file_lock *request) {
    ...
    if (request->type != 2) {
        for (lock = ((typeof(*lock) *) ((char *) ((&inode->posix_locks)->next) - 
# 54 "project/ish/fs/lock.c" 3 4
       __builtin_offsetof (
# 54 "project/ish/fs/lock.c"
       typeof(*lock)
# 54 "project/ish/fs/lock.c" 3 4
       , 
# 54 "project/ish/fs/lock.c"
...
# 69 "project/ish/fs/lock.c"
    ...
    for (lock = ((typeof(*(lock)) *) ((char *) ((&inode->posix_locks)->next) - 
# 71 "project/ish/fs/lock.c" 3 4
   __builtin_offsetof (
# 71 "project/ish/fs/lock.c"
   typeof(*(lock))
# 71 "project/ish/fs/lock.c" 3 4
   , 
# 71 "project/ish/fs/lock.c"
...
# 71 "project/ish/fs/lock.c"
   )), tmp = ((typeof(*(lock)) *) ((char *) ((lock)->locks.next) - 
# 71 "project/ish/fs/lock.c" 3 4
   __builtin_offsetof (
# 71 "project/ish/fs/lock.c"
   typeof(*(lock))
...
# 71 "project/ish/fs/lock.c"
   )); &lock->locks != (&inode->posix_locks); lock = tmp, tmp = ((typeof(*(lock)) *) ((char *) ((lock)->locks.next) - 
# 71 "project/ish/fs/lock.c" 3 4
   __builtin_offsetof (
# 71 "project/ish/fs/lock.c"
   typeof(*(lock))
...
# 71 "project/ish/fs/lock.c"
        ...
        if (!found_our_locks) {
            if (lock->owner != request->owner)
                continue;
            found_our_locks = 
# 76 "project/ish/fs/lock.c" 3 4
                             1
# 76 "project/ish/fs/lock.c"
                                 ;
        } else {
            if (lock->owner != request->owner)
                break;
...
# 81 "project/ish/fs/lock.c" 3 4
       (__builtin_expect(!(
# 81 "project/ish/fs/lock.c"
       lock->owner == request->owner
# 81 "project/ish/fs/lock.c" 3 4
       ), 0) ? __assert_rtn(__func__, "project/ish/fs/lock.c", 81, 
# 81 "project/ish/fs/lock.c"
       "lock->owner == request->owner"
# 81 "project/ish/fs/lock.c" 3 4
       ) : (void)0)
...
# 119 "project/ish/fs/lock.c" 3 4
               (__builtin_expect(!(
# 119 "project/ish/fs/lock.c"
               lock->end >= request->start
# 119 "project/ish/fs/lock.c" 3 4
               ), 0) ? __assert_rtn(__func__, "project/ish/fs/lock.c", 119, 
# 119 "project/ish/fs/lock.c"
               "lock->end >= request->start"
# 119 "project/ish/fs/lock.c" 3 4
               ) : (void)0)
...
# 124 "project/ish/fs/lock.c" 3 4
               (__builtin_expect(!(
# 124 "project/ish/fs/lock.c"
               lock->start <= request->end
# 124 "project/ish/fs/lock.c" 3 4
               ), 0) ? __assert_rtn(__func__, "project/ish/fs/lock.c", 124, 
# 124 "project/ish/fs/lock.c"
               "lock->start <= request->end"
# 124 "project/ish/fs/lock.c" 3 4
               ) : (void)0)
...
static int file_lock_from_flock(struct fd *fd, struct flock_ *flock, struct file_lock *lock) {
    ...
    switch (flock->whence) {
        case 0:
            ...
            break;
        case 1:
            __lock(&fd->lock, "project/ish/fs/lock.c", 147);
            offset = fd->ops->lseek(fd, 0, 1);
            unlock(&fd->lock);
            if (offset < 0)
                return offset;
            break;
...
static int flock_from_file_lock(struct file_lock *lock, struct flock_ *flock) {
    ...
    if (lock->end != ~(1l << (sizeof(off_t) * 8 - 1)))
...
int fcntl_getlk(struct fd *fd, struct flock_ *flock) {
    if (flock->type != 0 && flock->type != 1)
        return -22;
    struct inode_data *inode = fd->inode;
    __lock(&inode->lock, "project/ish/fs/lock.c", 196);
    ...
    err = 0;
    if (lock != 
# 204 "project/ish/fs/lock.c" 3 4
               ((void *)0)
# 204 "project/ish/fs/lock.c"
                   )
...
int fcntl_setlk(struct fd *fd, struct flock_ *flock, 
# 213 "project/ish/fs/lock.c" 3 4
                                                    _Bool 
# 213 "project/ish/fs/lock.c"
                                                         blocking) {
    if (flock->type != 0 && flock->type != 1 && flock->type != 2)
        return -22;
    int fd_mode = fd_getflags(fd) & 3;
    if (flock->type == 0 && fd_mode == (1 << 0))
        return -9;
    if (flock->type == 1 && fd_mode == 0)
        return -9;

    struct inode_data *inode = fd->inode;
    __lock(&inode->lock, "project/ish/fs/lock.c", 223);

    struct file_lock request;
    int err = file_lock_from_flock(fd, flock, &request);
    if (err < 0)
        goto out;
    while ((err = file_lock_acquire(inode, &request)) == -11) {
        if (!blocking)
            break;
        err = wait_for(&inode->posix_unlock, &inode->lock, 
# 232 "project/ish/fs/lock.c" 3 4
                                                          ((void *)0)
# 232 "project/ish/fs/lock.c"
                                                              );
        if (err < 0)
            break;
    }
...
void file_lock_remove_owned_by(struct fd *fd, void *owner) {
    struct inode_data *inode = fd->inode;
    __lock(&inode->lock, "project/ish/fs/lock.c", 243);
    struct file_lock *lock, *tmp;
    for (lock = ((typeof(*(lock)) *) ((char *) ((&inode->posix_locks)->next) - 
# 245 "project/ish/fs/lock.c" 3 4
   __builtin_offsetof (
# 245 "project/ish/fs/lock.c"
   typeof(*(lock))
# 245 "project/ish/fs/lock.c" 3 4
   , 
# 245 "project/ish/fs/lock.c"
