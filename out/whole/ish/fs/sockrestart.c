# 0 "project/ish/fs/sockrestart.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/ish/fs/sockrestart.c"
...
# 2 "project/ish/fs/sockrestart.c" 2
...
# 3 "project/ish/fs/sockrestart.c" 2
...
# 4 "project/ish/fs/sockrestart.c" 2
...
# 16 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/sockrestart.h" 2
...
# 17 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/sockrestart.h" 2
struct fd;
...
# 5 "project/ish/fs/sockrestart.c" 2
...
int f_close(fd_t f);
# 6 "project/ish/fs/sockrestart.c" 2
...
int err_map(int err);
int errno_map(void);
# 8 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/sock.h" 2
...
# 7 "project/ish/fs/sockrestart.c" 2
...
# 8 "project/ish/fs/sockrestart.c" 2

extern const struct fd_ops socket_fdops;

static lock_t sockrestart_lock = {
# 11 "project/ish/fs/sockrestart.c" 3 4
                                {0x32AAABA7, {0}}
# 11 "project/ish/fs/sockrestart.c"
                                , 0};
static struct list listen_fds = {.prev = &listen_fds, .next = &listen_fds};

void sockrestart_begin_listen(struct fd *sock) {
    if (sock->ops != &socket_fdops)
        return;
    __lock(&sockrestart_lock, "project/ish/fs/sockrestart.c", 17);
...
void sockrestart_end_listen(struct fd *sock) {
    if (sock->ops != &socket_fdops)
        return;
    __lock(&sockrestart_lock, "project/ish/fs/sockrestart.c", 25);
    list_remove_safe(&sock->sockrestart.listen);
    unlock(&sockrestart_lock);
}

static struct list listen_tasks = {.prev = &listen_tasks, .next = &listen_tasks};

void sockrestart_begin_listen_wait(struct fd *sock) {
    if (sock->ops != &socket_fdops)
        return;
    __lock(&sockrestart_lock, "project/ish/fs/sockrestart.c", 35);
...
void sockrestart_end_listen_wait(struct fd *sock) {
    if (sock->ops != &socket_fdops)
        return;
    __lock(&sockrestart_lock, "project/ish/fs/sockrestart.c", 45);
    current->sockrestart.count--;
    if (current->sockrestart.count == 0)
...
# 52 "project/ish/fs/sockrestart.c" 3 4
_Bool 
# 52 "project/ish/fs/sockrestart.c"
    sockrestart_should_restart_listen_wait() {
    __lock(&sockrestart_lock, "project/ish/fs/sockrestart.c", 53);
    
# 54 "project/ish/fs/sockrestart.c" 3 4
   _Bool 
# 54 "project/ish/fs/sockrestart.c"
        punt = current->sockrestart.punt;
    current->sockrestart.punt = 
# 55 "project/ish/fs/sockrestart.c" 3 4
                               0
# 55 "project/ish/fs/sockrestart.c"
                                    ;
    unlock(&sockrestart_lock);
    return punt;
}
...
static struct list saved_sockets = {.prev = &saved_sockets, .next = &saved_sockets};



void sockrestart_on_suspend() {
    __lock(&sockrestart_lock, "project/ish/fs/sockrestart.c", 77);
    
# 78 "project/ish/fs/sockrestart.c" 3 4
   (__builtin_expect(!(
# 78 "project/ish/fs/sockrestart.c"
   list_empty(&saved_sockets)
# 78 "project/ish/fs/sockrestart.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/fs/sockrestart.c", 78, 
# 78 "project/ish/fs/sockrestart.c"
   "list_empty(&saved_sockets)"
# 78 "project/ish/fs/sockrestart.c" 3 4
   ) : (void)0)
# 78 "project/ish/fs/sockrestart.c"
                                     ;
    struct fd *sock;
    for (sock = ((typeof(*sock) *) ((char *) ((&listen_fds)->next) - 
# 80 "project/ish/fs/sockrestart.c" 3 4
   __builtin_offsetof (
# 80 "project/ish/fs/sockrestart.c"
   typeof(*sock)
# 80 "project/ish/fs/sockrestart.c" 3 4
   , 
# 80 "project/ish/fs/sockrestart.c"
...
# 80 "project/ish/fs/sockrestart.c"
   )); &sock->sockrestart.listen != (&listen_fds); sock = ((typeof(*sock) *) ((char *) (sock->sockrestart.listen.next) - 
# 80 "project/ish/fs/sockrestart.c" 3 4
   __builtin_offsetof (
# 80 "project/ish/fs/sockrestart.c"
   typeof(*sock)
...
# 80 "project/ish/fs/sockrestart.c"
        ...
        if (saved == 
# 82 "project/ish/fs/sockrestart.c" 3 4
                    ((void *)0)
# 82 "project/ish/fs/sockrestart.c"
                        )
            continue;
        saved->sock = fd_retain(sock);
        saved->proto = sock->socket.protocol;
        unsigned size = sizeof(saved->type);
        getsockopt(sock->real_fd, 
# 87 "project/ish/fs/sockrestart.c" 3 4
                                 0xffff
# 87 "project/ish/fs/sockrestart.c"
                                           , 
# 87 "project/ish/fs/sockrestart.c" 3 4
                                             0x1008
# 87 "project/ish/fs/sockrestart.c"
...
# 88 "project/ish/fs/sockrestart.c" 3 4
       (__builtin_expect(!(
# 88 "project/ish/fs/sockrestart.c"
       size == sizeof(saved->type)
# 88 "project/ish/fs/sockrestart.c" 3 4
       ), 0) ? __assert_rtn(__func__, "project/ish/fs/sockrestart.c", 88, 
# 88 "project/ish/fs/sockrestart.c"
       "size == sizeof(saved->type)"
# 88 "project/ish/fs/sockrestart.c" 3 4
       ) : (void)0)
...
void sockrestart_on_resume() {
    __lock(&sockrestart_lock, "project/ish/fs/sockrestart.c", 97);
    struct saved_socket *saved, *tmp;
    for (saved = ((typeof(*(saved)) *) ((char *) ((&saved_sockets)->next) - 
# 99 "project/ish/fs/sockrestart.c" 3 4
   __builtin_offsetof (
# 99 "project/ish/fs/sockrestart.c"
   typeof(*(saved))
# 99 "project/ish/fs/sockrestart.c" 3 4
   , 
# 99 "project/ish/fs/sockrestart.c"
...
# 99 "project/ish/fs/sockrestart.c"
   )), tmp = ((typeof(*(saved)) *) ((char *) ((saved)->saved.next) - 
# 99 "project/ish/fs/sockrestart.c" 3 4
   __builtin_offsetof (
# 99 "project/ish/fs/sockrestart.c"
   typeof(*(saved))
...
# 99 "project/ish/fs/sockrestart.c"
   )); &saved->saved != (&saved_sockets); saved = tmp, tmp = ((typeof(*(saved)) *) ((char *) ((saved)->saved.next) - 
# 99 "project/ish/fs/sockrestart.c" 3 4
   __builtin_offsetof (
# 99 "project/ish/fs/sockrestart.c"
   typeof(*(saved))
...
# 99 "project/ish/fs/sockrestart.c"
        ...
        if (new_sock < 0) {
            ish_printk("restarting socket(%d, %d, %d) failed: %s\n",
                    saved->name_addr.sa_family, saved->type, saved->proto, strerror(
# 104 "project/ish/fs/sockrestart.c" 3 4
                                                                                   (*__error())
# 104 "project/ish/fs/sockrestart.c"
                                                                                        ));
            goto thank_u_next;
        }
        if (bind(new_sock, (struct sockaddr *) &saved->name, saved->name_len) < 0) {
            ish_printk("rebinding socket failed: %s\n", strerror(
# 108 "project/ish/fs/sockrestart.c" 3 4
                                                            (*__error())
# 108 "project/ish/fs/sockrestart.c"
                                                                 ));
            goto thank_u_next;
        }
...
thank_u_next:
    ...
    struct task *task;
    for (task = ((typeof(*task) *) ((char *) ((&listen_tasks)->next) - 
# 117 "project/ish/fs/sockrestart.c" 3 4
   __builtin_offsetof (
# 117 "project/ish/fs/sockrestart.c"
   typeof(*task)
# 117 "project/ish/fs/sockrestart.c" 3 4
   , 
# 117 "project/ish/fs/sockrestart.c"
...
# 117 "project/ish/fs/sockrestart.c"
   )); &task->sockrestart.listen != (&listen_tasks); task = ((typeof(*task) *) ((char *) (task->sockrestart.listen.next) - 
# 117 "project/ish/fs/sockrestart.c" 3 4
   __builtin_offsetof (
# 117 "project/ish/fs/sockrestart.c"
   typeof(*task)
...
# 117 "project/ish/fs/sockrestart.c"
        ...
        task->sockrestart.punt = 
# 118 "project/ish/fs/sockrestart.c" 3 4
                                1
# 118 "project/ish/fs/sockrestart.c"
                                    ;
        pthread_kill(task->thread, 
# 119 "project/ish/fs/sockrestart.c" 3 4
                                  30
# 119 "project/ish/fs/sockrestart.c"
                                         );
    }
    unlock(&sockrestart_lock);
}
