...
# 5 "project/ish/fs/inode.c" 2


lock_t inodes_lock = {
# 7 "project/ish/fs/inode.c" 3 4
                    {0x32AAABA7, {0}}
# 7 "project/ish/fs/inode.c"
                    , 0};
...
# 18 "project/ish/fs/inode.c" 3 4
   __builtin_offsetof (
# 18 "project/ish/fs/inode.c"
   typeof(*inode)
# 18 "project/ish/fs/inode.c" 3 4
   , 
# 18 "project/ish/fs/inode.c"
...
# 18 "project/ish/fs/inode.c"
    ...
    return 
# 22 "project/ish/fs/inode.c" 3 4
          ((void *)0)
# 22 "project/ish/fs/inode.c"
              ;
}
...
struct inode_data *inode_get_unlocked(struct mount *mount, ino_t ino) {
    ...
    if (inode == 
# 27 "project/ish/fs/inode.c" 3 4
                ((void *)0)
# 27 "project/ish/fs/inode.c"
                    ) {
    ...
    __lock(&inode->lock, "project/ish/fs/inode.c", 41);
    inode->refcount++;
    unlock(&inode->lock);
    return inode;
}
...
struct inode_data *inode_get(struct mount *mount, ino_t ino) {
    __lock(&inodes_lock, "project/ish/fs/inode.c", 48);
...
void inode_check_orphaned(struct mount *mount, ino_t ino) {
    __lock(&inodes_lock, "project/ish/fs/inode.c", 55);
    struct inode_data *inode = inode_get_data(mount, ino);
    if (inode == 
# 57 "project/ish/fs/inode.c" 3 4
                ((void *)0)
# 57 "project/ish/fs/inode.c"
                    )
...
void inode_retain(struct inode_data *inode) {
    __lock(&inode->lock, "project/ish/fs/inode.c", 63);
    inode->refcount++;
    unlock(&inode->lock);
}

void inode_release(struct inode_data *inode) {
    __lock(&inodes_lock, "project/ish/fs/inode.c", 69);
    __lock(&inode->lock, "project/ish/fs/inode.c", 70);
    if (--inode->refcount == 0) {
        unlock(&inode->lock);
