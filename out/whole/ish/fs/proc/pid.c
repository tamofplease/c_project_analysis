...
# 7 "/Users/washi38/University/Labo/c_project_analysis/project/ish/emu/memory.h" 2
...
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/ish/emu/mmu.h" 2
...
# 10 "project/ish/fs/proc/pid.c" 2


static void proc_pid_getname(struct proc_entry *entry, char *buf) {
    
# 13 "project/ish/fs/proc/pid.c" 3 4
   __builtin___sprintf_chk (
# 13 "project/ish/fs/proc/pid.c"
   buf
# 13 "project/ish/fs/proc/pid.c" 3 4
...
static struct task *proc_get_task(struct proc_entry *entry) {
    __lock(&pids_lock, "project/ish/fs/proc/pid.c", 17);
    struct task *task = pid_get_task(entry->pid);
    if (task == 
# 19 "project/ish/fs/proc/pid.c" 3 4
               ((void *)0)
# 19 "project/ish/fs/proc/pid.c"
                   )
        unlock(&pids_lock);
    return task;
}
static void proc_put_task(struct task *UNUSED_task __attribute__((unused))) {
    unlock(&pids_lock);
}
...
static int proc_pid_stat_show(struct proc_entry *entry, struct proc_data *buf) {
    ...
    if (task == 
# 29 "project/ish/fs/proc/pid.c" 3 4
               ((void *)0)
# 29 "project/ish/fs/proc/pid.c"
                   )
        return -3;
    __lock(&task->general_lock, "project/ish/fs/proc/pid.c", 31);
    __lock(&task->group->lock, "project/ish/fs/proc/pid.c", 32);
    __lock(&task->sighand->lock, "project/ish/fs/proc/pid.c", 33);
    ...
    uint32_t caught = 0;
    for (int i = 0; i < 32; i++) {
        if (task->sighand->action[i].handler == 1)
            ignored |= 1l << i;
        else if (task->sighand->action[i].handler != 0)
            caught |= 1l << i;
    }
...
static int proc_pid_auxv_show(struct proc_entry *entry, struct proc_data *buf) {
    struct task *task = proc_get_task(entry);
    if (task == 
# 108 "project/ish/fs/proc/pid.c" 3 4
               ((void *)0)
# 108 "project/ish/fs/proc/pid.c"
                   )
        return -3;
    int err = 0;
    __lock(&task->general_lock, "project/ish/fs/proc/pid.c", 111);
    if (task->mm == 
# 112 "project/ish/fs/proc/pid.c" 3 4
                   ((void *)0)
# 112 "project/ish/fs/proc/pid.c"
                       )
        goto out_free_task;
    ...
    if (data == 
# 117 "project/ish/fs/proc/pid.c" 3 4
               ((void *)0)
# 117 "project/ish/fs/proc/pid.c"
                   ) {
        err = -12;
        goto out_free_task;
    }
...
static int proc_pid_cmdline_show(struct proc_entry *entry, struct proc_data *buf) {
    struct task *task = proc_get_task(entry);
    if (task == 
# 133 "project/ish/fs/proc/pid.c" 3 4
               ((void *)0)
# 133 "project/ish/fs/proc/pid.c"
                   )
        return -3;
    int err = 0;
    __lock(&task->general_lock, "project/ish/fs/proc/pid.c", 136);
    if (task->mm == 
# 137 "project/ish/fs/proc/pid.c" 3 4
                   ((void *)0)
# 137 "project/ish/fs/proc/pid.c"
                       )
        goto out_free_task;
    ...
    char *data = malloc(size);
    if (data == 
# 142 "project/ish/fs/proc/pid.c" 3 4
               ((void *)0)
# 142 "project/ish/fs/proc/pid.c"
                   ) {
        err = -12;
        goto out_free_task;
    }
...
void proc_maps_dump(struct task *task, struct proc_data *buf) {
    ...
    if (mem == 
# 158 "project/ish/fs/proc/pid.c" 3 4
              ((void *)0)
# 158 "project/ish/fs/proc/pid.c"
                  )
        return;
    ...
    while (page < (1 << 20)) {
        ...
        while (page < (1 << 20) && mem_pt(mem, page) == 
# 165 "project/ish/fs/proc/pid.c" 3 4
                                                       ((void *)0)
# 165 "project/ish/fs/proc/pid.c"
                                                           ) {
        ...
        while (page < (1 << 20)) {
            ...
            if (pt == 
# 177 "project/ish/fs/proc/pid.c" 3 4
                     ((void *)0)
# 177 "project/ish/fs/proc/pid.c"
                         )
                break;
            if ((pt->flags & ((1 << 0) | (1 << 1) | (1 << 2))) != (start_pt->flags & ((1 << 0) | (1 << 1) | (1 << 2))))
                break;

            if (!(pt->data == data || (pt->flags & (1 << 6) && start_pt->flags & (1 << 6))))
                break;
            mem_next_page(mem, &page);
        }
        page_t end = page;
        ...
        char path[4096] = "";
        if (start_pt->flags & (1 << 3)) {
            
# 191 "project/ish/fs/proc/pid.c" 3 4
           __builtin___strcpy_chk (
# 191 "project/ish/fs/proc/pid.c"
           path
# 191 "project/ish/fs/proc/pid.c" 3 4
           , 
# 191 "project/ish/fs/proc/pid.c"
...
# 192 "project/ish/fs/proc/pid.c" 3 4
                                ((void *)0)
# 192 "project/ish/fs/proc/pid.c"
                                    ) {
            
# 193 "project/ish/fs/proc/pid.c" 3 4
           __builtin___strcpy_chk (
# 193 "project/ish/fs/proc/pid.c"
           path
# 193 "project/ish/fs/proc/pid.c" 3 4
           , 
# 193 "project/ish/fs/proc/pid.c"
...
# 194 "project/ish/fs/proc/pid.c" 3 4
                              ((void *)0)
# 194 "project/ish/fs/proc/pid.c"
                                  ) {
            generic_getpath(start_pt->data->fd, path);
        }
        proc_printf(buf, "%08x-%08x %c%c%c%c %08lx 00:00 %-10d %s\n",
                start << 12, end << 12,
                start_pt->flags & (1 << 0) ? 'r' : '-',
                start_pt->flags & (1 << 1) ? 'w' : '-',
                start_pt->flags & (1 << 2) ? 'x' : '-',
                start_pt->flags & (1 << 7) ? '-' : 'p',
...
static int proc_pid_maps_show(struct proc_entry *entry, struct proc_data *buf) {
    struct task *task = proc_get_task(entry);
    if (task == 
# 212 "project/ish/fs/proc/pid.c" 3 4
               ((void *)0)
# 212 "project/ish/fs/proc/pid.c"
                   )
        return -3;
...
static 
# 221 "project/ish/fs/proc/pid.c" 3 4
      _Bool 
# 221 "project/ish/fs/proc/pid.c"
           proc_pid_fd_readdir(struct proc_entry *entry, unsigned long *index, struct proc_entry *next_entry) {
    struct task *task = proc_get_task(entry);
    if (task == 
# 223 "project/ish/fs/proc/pid.c" 3 4
               ((void *)0)
# 223 "project/ish/fs/proc/pid.c"
                   )
        return -3;
    __lock(&task->files->lock, "project/ish/fs/proc/pid.c", 225);
    while (*index < task->files->size && task->files->files[*index] == 
# 226 "project/ish/fs/proc/pid.c" 3 4
                                                                      ((void *)0)
# 226 "project/ish/fs/proc/pid.c"
                                                                          )
        (*index)++;
    fd_t f = (*index)++;
    
# 229 "project/ish/fs/proc/pid.c" 3 4
   _Bool 
# 229 "project/ish/fs/proc/pid.c"
        any_left = (unsigned) f < task->files->size;
...
# 237 "project/ish/fs/proc/pid.c" 3 4
   __builtin___sprintf_chk (
# 237 "project/ish/fs/proc/pid.c"
   buf
# 237 "project/ish/fs/proc/pid.c" 3 4
   , 0, __builtin_object_size (
# 237 "project/ish/fs/proc/pid.c"
...
static int proc_pid_fd_readlink(struct proc_entry *entry, char *buf) {
    struct task *task = proc_get_task(entry);
    if (task == 
# 242 "project/ish/fs/proc/pid.c" 3 4
               ((void *)0)
# 242 "project/ish/fs/proc/pid.c"
                   )
        return -3;
    __lock(&task->files->lock, "project/ish/fs/proc/pid.c", 244);
...
static int proc_pid_exe_readlink(struct proc_entry *entry, char *buf) {
    struct task *task = proc_get_task(entry);
    if (task == 
# 254 "project/ish/fs/proc/pid.c" 3 4
               ((void *)0)
# 254 "project/ish/fs/proc/pid.c"
                   )
        return -3;
    __lock(&task->general_lock, "project/ish/fs/proc/pid.c", 256);
...
struct proc_dir_entry proc_pid_entries[] = {
    ...
    {"exe", 
# 266 "project/ish/fs/proc/pid.c" 3 4
           0120000
# 266 "project/ish/fs/proc/pid.c"
                  , .readlink = proc_pid_exe_readlink},
    {"fd", 
# 267 "project/ish/fs/proc/pid.c" 3 4
          0040000
# 267 "project/ish/fs/proc/pid.c"
...
# 272 "project/ish/fs/proc/pid.c" 3 4
                                 ((void *)0)
# 272 "project/ish/fs/proc/pid.c"
                                     , 
# 272 "project/ish/fs/proc/pid.c" 3 4
                                       0040000
# 272 "project/ish/fs/proc/pid.c"
...
static struct proc_dir_entry proc_pid_fd = {
# 276 "project/ish/fs/proc/pid.c" 3 4
                                           ((void *)0)
# 276 "project/ish/fs/proc/pid.c"
                                               , 
# 276 "project/ish/fs/proc/pid.c" 3 4
                                                 0120000
# 276 "project/ish/fs/proc/pid.c"
