...
static inline dev_t dev_real_from_fake(dev_t_ dev) {
    return 
# 27 "project/ish/fs/dev.h" 3 4
          ((dev_t)(((
# 27 "project/ish/fs/dev.h"
          dev_major(dev)
# 27 "project/ish/fs/dev.h" 3 4
          ) << 24) | (
# 27 "project/ish/fs/dev.h"
...
static inline dev_t_ dev_fake_from_real(dev_t dev) {
    return dev_make(
# 30 "project/ish/fs/dev.h" 3 4
                   ((int32_t)(((u_int32_t)(
# 30 "project/ish/fs/dev.h"
                   dev
# 30 "project/ish/fs/dev.h" 3 4
                   ) >> 24) & 0xff))
# 30 "project/ish/fs/dev.h"
