# 0 "project/ish/fs/fake-migrate.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 65 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/dirent.h" 2 3 4
...
# 84 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/unistd.h" 3 4
...
# 2 "project/ish/fs/fake-migrate.c" 2
...
int err_map(int err);
int errno_map(void);
# 4 "project/ish/fs/fake-migrate.c" 2
...
#define HANDLE_ERR(db) die("sqlite error while rebuilding: %s\n", sqlite3_errmsg(db))
...
# 6 "project/ish/fs/fake-migrate.c" 2
...
int fakefs_migrate(struct fakefs_db *fs, int UNUSED_root_fd __attribute__((unused))) {
    sqlite3 *db = fs->db;
    int err;
    sqlite3_stmt *user_version = ({ sqlite3_stmt *stmt; err = sqlite3_prepare_v2(db, "pragma user_version", -1, &stmt, 
# 40 "project/ish/fs/fake-migrate.c" 3 4
                                ((void *)0)
# 40 "project/ish/fs/fake-migrate.c"
                                ); if (err != 
# 40 "project/ish/fs/fake-migrate.c" 3 4
                                0 
# 40 "project/ish/fs/fake-migrate.c"
...
# 40 "project/ish/fs/fake-migrate.c" 3 4
                                101
# 40 "project/ish/fs/fake-migrate.c"
                                ) die("sqlite error while rebuilding: %s\n", sqlite3_errmsg(db)); stmt; });
    ({ err = sqlite3_step(user_version); if (err != 
# 41 "project/ish/fs/fake-migrate.c" 3 4
   0 
# 41 "project/ish/fs/fake-migrate.c"
   && err != 
# 41 "project/ish/fs/fake-migrate.c" 3 4
   100 
# 41 "project/ish/fs/fake-migrate.c"
...
# 41 "project/ish/fs/fake-migrate.c"
   ; });
    ...
    err = sqlite3_finalize(user_version); if (err != 
# 43 "project/ish/fs/fake-migrate.c" 3 4
   0 
# 43 "project/ish/fs/fake-migrate.c"
   && err != 
# 43 "project/ish/fs/fake-migrate.c" 3 4
   100 
# 43 "project/ish/fs/fake-migrate.c"
...
# 45 "project/ish/fs/fake-migrate.c" 3 4
   ((void *)0)
# 45 "project/ish/fs/fake-migrate.c"
   , 
# 45 "project/ish/fs/fake-migrate.c" 3 4
   ((void *)0)
# 45 "project/ish/fs/fake-migrate.c"
...
# 45 "project/ish/fs/fake-migrate.c"
    ...
    while (version < versions) {
        ...
        if (m.sql != 
# 49 "project/ish/fs/fake-migrate.c" 3 4
                    ((void *)0)
# 49 "project/ish/fs/fake-migrate.c"
                        )
            err = sqlite3_exec(db, m.sql, 
# 50 "project/ish/fs/fake-migrate.c" 3 4
           ((void *)0)
# 50 "project/ish/fs/fake-migrate.c"
           , 
# 50 "project/ish/fs/fake-migrate.c" 3 4
           ((void *)0)
# 50 "project/ish/fs/fake-migrate.c"
...
# 50 "project/ish/fs/fake-migrate.c"
        ...
        if (m.migrate != 
# 51 "project/ish/fs/fake-migrate.c" 3 4
                        ((void *)0)
# 51 "project/ish/fs/fake-migrate.c"
                            )
            m.migrate(fs);
        version++;
    }
    ...
    err = sqlite3_exec(db, pragma_user_version, 
# 57 "project/ish/fs/fake-migrate.c" 3 4
   ((void *)0)
# 57 "project/ish/fs/fake-migrate.c"
   , 
# 57 "project/ish/fs/fake-migrate.c" 3 4
   ((void *)0)
# 57 "project/ish/fs/fake-migrate.c"
...
# 59 "project/ish/fs/fake-migrate.c" 3 4
   ((void *)0)
# 59 "project/ish/fs/fake-migrate.c"
   , 
# 59 "project/ish/fs/fake-migrate.c" 3 4
   ((void *)0)
# 59 "project/ish/fs/fake-migrate.c"
