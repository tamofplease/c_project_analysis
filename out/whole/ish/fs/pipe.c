...
# 181 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/unistd.h" 2 3 4
...
# 6 "project/ish/fs/pipe.c" 2


static fd_t pipe_f_create(int pipe_fd, int flags) {
    struct fd *fd = adhoc_fd_create(&realfs_fdops);
    if (fd == 
# 10 "project/ish/fs/pipe.c" 3 4
             ((void *)0)
# 10 "project/ish/fs/pipe.c"
                 )
        return -12;
    fd->real_fd = pipe_fd;
    fd->stat.mode = 
# 13 "project/ish/fs/pipe.c" 3 4
                   0010000 
# 13 "project/ish/fs/pipe.c"
                           | 0660;
...
int_t sys_pipe2(addr_t pipe_addr, int_t flags) {
    __use(0, pipe_addr, flags);
    if (flags & ~((1 << 19)|(1 << 11))) {
        ish_printk("FIXME " "unsupported pipe2 flags" "\n");
        return -22;
    }
    ...
    err = -14;
    if (user_write(pipe_addr, &(fp), sizeof(fp)))
        goto close_fake_1;
    __use(0, fp[0], fp[1]);
    return 0;
