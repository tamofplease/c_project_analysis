...
# 5 "project/ish/fs/path.c" 2

static int __path_normalize(const char *at_path, const char *path, char *out, int flags, int levels) {

    if (flags & 1)
        
# 9 "project/ish/fs/path.c" 3 4
       (__builtin_expect(!(
# 9 "project/ish/fs/path.c"
       !(flags & 2)
# 9 "project/ish/fs/path.c" 3 4
       ), 0) ? __assert_rtn(__func__, "project/ish/fs/path.c", 9, 
# 9 "project/ish/fs/path.c"
       "!(flags & N_SYMLINK_NOFOLLOW)"
# 9 "project/ish/fs/path.c" 3 4
       ) : (void)0)
# 9 "project/ish/fs/path.c"
                                            ;
...
# 11 "project/ish/fs/path.c" 3 4
       (__builtin_expect(!(
# 11 "project/ish/fs/path.c"
       flags & 2
# 11 "project/ish/fs/path.c" 3 4
       ), 0) ? __assert_rtn(__func__, "project/ish/fs/path.c", 11, 
# 11 "project/ish/fs/path.c"
       "flags & N_SYMLINK_NOFOLLOW"
# 11 "project/ish/fs/path.c" 3 4
       ) : (void)0)
# 11 "project/ish/fs/path.c"
    ...
    *o = '\0';
    ...
    if (at_path != 
# 21 "project/ish/fs/path.c" 3 4
                  ((void *)0) 
# 21 "project/ish/fs/path.c"
                       && strcmp(at_path, "/") != 0) {
        
# 22 "project/ish/fs/path.c" 3 4
       __builtin___strcpy_chk (
# 22 "project/ish/fs/path.c"
       o
# 22 "project/ish/fs/path.c" 3 4
       , 
# 22 "project/ish/fs/path.c"
    ...
    while (*p != '\0') {
        ...
        *o++ = '/'; n--;
        ...
        if ((flags & 1) || *p != '\0') {
            ...
            char possible_symlink[4096];
            *o = '\0';
            
# 72 "project/ish/fs/path.c" 3 4
           __builtin___strcpy_chk (
# 72 "project/ish/fs/path.c"
           possible_symlink
# 72 "project/ish/fs/path.c" 3 4
           , 
# 72 "project/ish/fs/path.c"
...
# 74 "project/ish/fs/path.c" 3 4
           (__builtin_expect(!(
# 74 "project/ish/fs/path.c"
           path_is_normalized(possible_symlink)
# 74 "project/ish/fs/path.c" 3 4
           ), 0) ? __assert_rtn(__func__, "project/ish/fs/path.c", 74, 
# 74 "project/ish/fs/path.c"
           "path_is_normalized(possible_symlink)"
# 74 "project/ish/fs/path.c" 3 4
           ) : (void)0)
# 74 "project/ish/fs/path.c"
            ...
            if (mount->fs->readlink)
                res = mount->fs->readlink(mount, possible_symlink, c, 4096 - (c - out));
            if (res >= 0) {
                mount_release(mount);
                if (levels >= 5)
                    return -40;
...
# 86 "project/ish/fs/path.c" 3 4
                   __builtin___memmove_chk (
# 86 "project/ish/fs/path.c"
                   out
# 86 "project/ish/fs/path.c" 3 4
                   , 
# 86 "project/ish/fs/path.c"
...
# 88 "project/ish/fs/path.c" 3 4
               __builtin___strcpy_chk (
# 88 "project/ish/fs/path.c"
               expanded_path
# 88 "project/ish/fs/path.c" 3 4
               , 
# 88 "project/ish/fs/path.c"
...
# 90 "project/ish/fs/path.c" 3 4
                   __builtin___strcat_chk (
# 90 "project/ish/fs/path.c"
                   expanded_path
# 90 "project/ish/fs/path.c" 3 4
                   , 
# 90 "project/ish/fs/path.c"
...
# 91 "project/ish/fs/path.c" 3 4
                   __builtin___strcat_chk (
# 91 "project/ish/fs/path.c"
                   expanded_path
# 91 "project/ish/fs/path.c" 3 4
                   , 
# 91 "project/ish/fs/path.c"
...
# 91 "project/ish/fs/path.c"
                ...
                return __path_normalize(
# 93 "project/ish/fs/path.c" 3 4
                                       ((void *)0)
# 93 "project/ish/fs/path.c"
                                           , expanded_path, out, flags, levels + 1);
            }
            ...
            if (*(p - 1) == '/') {
                ...
                if (err >= 0) {
                    if (!
# 103 "project/ish/fs/path.c" 3 4
                        (((
# 103 "project/ish/fs/path.c"
                        stat.mode
# 103 "project/ish/fs/path.c" 3 4
                        ) & 0170000) == 0040000)
# 103 "project/ish/fs/path.c"
...
# 116 "project/ish/fs/path.c" 3 4
   (__builtin_expect(!(
# 116 "project/ish/fs/path.c"
   path_is_normalized(out)
# 116 "project/ish/fs/path.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/fs/path.c", 116, 
# 116 "project/ish/fs/path.c"
   "path_is_normalized(out)"
# 116 "project/ish/fs/path.c" 3 4
   ) : (void)0)
...
# 122 "project/ish/fs/path.c" 3 4
   (__builtin_expect(!(
# 122 "project/ish/fs/path.c"
   at != 
# 122 "project/ish/fs/path.c" 3 4
   ((void *)0)), 0) ? __assert_rtn(__func__, "project/ish/fs/path.c", 122, 
# 122 "project/ish/fs/path.c"
   "at != NULL"
# 122 "project/ish/fs/path.c" 3 4
   ) : (void)0)
# 122 "project/ish/fs/path.c"
    ...
    __lock(&current->fs->lock, "project/ish/fs/path.c", 127);
    if (path[0] == '/')
        at = current->fs->root;
    else if (at == (struct fd *) -2)
        at = current->fs->pwd;
    unlock(&current->fs->lock);
    char at_path[4096];
    if (at != 
# 134 "project/ish/fs/path.c" 3 4
             ((void *)0)
# 134 "project/ish/fs/path.c"
                 ) {
        int err = generic_getpath(at, at_path);
        if (err < 0)
            return err;
        
# 138 "project/ish/fs/path.c" 3 4
       (__builtin_expect(!(
# 138 "project/ish/fs/path.c"
       path_is_normalized(at_path)
# 138 "project/ish/fs/path.c" 3 4
       ), 0) ? __assert_rtn(__func__, "project/ish/fs/path.c", 138, 
# 138 "project/ish/fs/path.c"
       "path_is_normalized(at_path)"
# 138 "project/ish/fs/path.c" 3 4
       ) : (void)0)
# 138 "project/ish/fs/path.c"
    ...
    return __path_normalize(at != 
# 141 "project/ish/fs/path.c" 3 4
                                 ((void *)0) 
# 141 "project/ish/fs/path.c"
                                      ? at_path : 
# 141 "project/ish/fs/path.c" 3 4
                                                  ((void *)0)
# 141 "project/ish/fs/path.c"
...
# 145 "project/ish/fs/path.c" 3 4
_Bool 
# 145 "project/ish/fs/path.c"
    path_is_normalized(const char *path) {
    while (*path != '\0') {
        if (*path != '/')
            return 
# 148 "project/ish/fs/path.c" 3 4
                  0
# 148 "project/ish/fs/path.c"
                       ;
        path++;
        if (*path == '/')
            return 
# 151 "project/ish/fs/path.c" 3 4
                  0
# 151 "project/ish/fs/path.c"
                       ;
        while (*path != '/' && *path != '\0')
            path++;
    }
    return 
# 155 "project/ish/fs/path.c" 3 4
          1
# 155 "project/ish/fs/path.c"
              ;
}


# 158 "project/ish/fs/path.c" 3 4
_Bool 
# 158 "project/ish/fs/path.c"
    path_next_component(const char **path, char *component, int *err) {
    const char *p = *path;
    if (*p == '\0')
        return 
# 161 "project/ish/fs/path.c" 3 4
              0
# 161 "project/ish/fs/path.c"
                   ;

    
# 163 "project/ish/fs/path.c" 3 4
   (__builtin_expect(!(
# 163 "project/ish/fs/path.c"
   *p == '/'
# 163 "project/ish/fs/path.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/fs/path.c", 163, 
# 163 "project/ish/fs/path.c"
   "*p == '/'"
# 163 "project/ish/fs/path.c" 3 4
   ) : (void)0)
    ...
    while (*p != '/' && *p != '\0') {
        *c++ = *p++;
        if (c - component >= 256) {
            *err = -36;
            return 
# 170 "project/ish/fs/path.c" 3 4
                  0
# 170 "project/ish/fs/path.c"
                       ;
        }
    }
    *c = '\0';
    *path = p;
    return 
# 175 "project/ish/fs/path.c" 3 4
          1
# 175 "project/ish/fs/path.c"
              ;
}
