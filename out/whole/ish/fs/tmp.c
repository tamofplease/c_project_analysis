...
int err_map(int err);
int errno_map(void);
# 5 "project/ish/fs/tmp.c" 2

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/path.h" 1
...
# 26 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/path.h"
int path_normalize(struct fd *at, const char *path, char *out, int flags);

# 27 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/path.h" 3 4
_Bool 
# 27 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/path.h"
    path_is_normalized(const char *path);
# 38 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/path.h"

# 38 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/path.h" 3 4
_Bool 
# 38 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/path.h"
    path_next_component(const char **path, char *component, int *err);
# 7 "project/ish/fs/tmp.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/ish/util/refcount.h" 1
...
#define DECLARE_REFCOUNT(type) void type ##_retain(struct type *obj); void type ##_release(struct type *obj)



#define __DEFINE_REFCOUNT(type,qualifiers) qualifiers struct type *type ##_retain(struct type *obj) { obj->refcount.rc++; return obj; } static void type ##_cleanup(struct type *obj); qualifiers void type ##_release(struct type *obj) { if (--obj->refcount.rc == 0) type ##_cleanup(obj); }
# 39 "/Users/washi38/University/Labo/c_project_analysis/project/ish/util/refcount.h"
#define DEFINE_REFCOUNT(type) __DEFINE_REFCOUNT(type, )
#define DEFINE_REFCOUNT_STATIC(type) __DEFINE_REFCOUNT(type, static)
# 8 "project/ish/fs/tmp.c" 2
...
static struct tmp_inode *tmp_inode_new(mode_t_ mode) {
    ...
    if (node == 
# 27 "project/ish/fs/tmp.c" 3 4
               ((void *)0)
# 27 "project/ish/fs/tmp.c"
                   )
        return 
# 28 "project/ish/fs/tmp.c" 3 4
              ((void *)0)
# 28 "project/ish/fs/tmp.c"
                  ;
    __refcount_init(&(node)->refcount);
    lock_init(&node->lock);
    ...
    if (
# 39 "project/ish/fs/tmp.c" 3 4
       (((
# 39 "project/ish/fs/tmp.c"
       mode
# 39 "project/ish/fs/tmp.c" 3 4
       ) & 0170000) == 0100000)
# 39 "project/ish/fs/tmp.c"
        ...
        if (node->file_data == 
# 41 "project/ish/fs/tmp.c" 3 4
                              ((void *)0)
# 41 "project/ish/fs/tmp.c"
                                  ) {
            free(node);
            return 
# 43 "project/ish/fs/tmp.c" 3 4
                  ((void *)0)
# 43 "project/ish/fs/tmp.c"
                      ;
        }
    }
    return node;
...
static struct tmp_inode *tmp_inode_retain(struct tmp_inode *obj) { obj->refcount.rc++; return obj; } static void tmp_inode_cleanup(struct tmp_inode *obj); static void tmp_inode_release(struct tmp_inode *obj) { if (--obj->refcount.rc == 0) tmp_inode_cleanup(obj); }

static void tmp_inode_cleanup(struct tmp_inode *inode) {
    if (
# 52 "project/ish/fs/tmp.c" 3 4
       (((
# 52 "project/ish/fs/tmp.c"
       inode->stat.mode
# 52 "project/ish/fs/tmp.c" 3 4
       ) & 0170000) == 0100000)
# 52 "project/ish/fs/tmp.c"
...
static struct tmp_dirent *tmp_dirent_retain(struct tmp_dirent *obj) { obj->refcount.rc++; return obj; } static void tmp_dirent_cleanup(struct tmp_dirent *obj); static void tmp_dirent_release(struct tmp_dirent *obj) { if (--obj->refcount.rc == 0) tmp_dirent_cleanup(obj); }
...
static void tmp_dirent_init(struct tmp_dirent *dirent) {
    __refcount_init(&(dirent)->refcount);
...
static int tmpfs_dir_link(struct tmp_dirent *dir, const char *name, struct tmp_inode *child, struct tmp_dirent **dirent_out) {
    if (!
# 94 "project/ish/fs/tmp.c" 3 4
        (((
# 94 "project/ish/fs/tmp.c"
        dir->inode->stat.mode
# 94 "project/ish/fs/tmp.c" 3 4
        ) & 0170000) == 0040000)
# 94 "project/ish/fs/tmp.c"
    ...
    if (new_dirent == 
# 99 "project/ish/fs/tmp.c" 3 4
                     ((void *)0)
# 99 "project/ish/fs/tmp.c"
                         ) {
        tmp_inode_release(child);
        return -12;
    }
...
# 105 "project/ish/fs/tmp.c" 3 4
   __builtin___strcpy_chk (
# 105 "project/ish/fs/tmp.c"
   new_dirent->name
# 105 "project/ish/fs/tmp.c" 3 4
   , 
# 105 "project/ish/fs/tmp.c"
...
static void tmpfs_fd_seekdir(struct fd *fd, struct tmp_dirent *dirent) {
    if (dirent != 
# 117 "project/ish/fs/tmp.c" 3 4
                 ((void *)0)
# 117 "project/ish/fs/tmp.c"
                     )
        tmp_dirent_retain(dirent);
    if (fd->tmpfs.dir_pos != 
# 119 "project/ish/fs/tmp.c" 3 4
                            ((void *)0)
# 119 "project/ish/fs/tmp.c"
                                )
...
static struct tmp_dirent *tmpfs_dir_lookup(struct tmp_dirent *dir, const char *name) {
    if (!
# 125 "project/ish/fs/tmp.c" 3 4
        (((
# 125 "project/ish/fs/tmp.c"
        dir->inode->stat.mode
# 125 "project/ish/fs/tmp.c" 3 4
        ) & 0170000) == 0040000)
# 125 "project/ish/fs/tmp.c"
                                      )
        return (void *) (intptr_t) (-20);
    struct tmp_dirent *dirent = 
# 127 "project/ish/fs/tmp.c" 3 4
                               ((void *)0)
# 127 "project/ish/fs/tmp.c"
                                   ;
    struct tmp_dirent *d;
    for (d = ((typeof(*d) *) ((char *) ((&dir->children)->next) - 
# 129 "project/ish/fs/tmp.c" 3 4
   __builtin_offsetof (
# 129 "project/ish/fs/tmp.c"
   typeof(*d)
# 129 "project/ish/fs/tmp.c" 3 4
   , 
# 129 "project/ish/fs/tmp.c"
...
# 129 "project/ish/fs/tmp.c"
   )); &d->dir != (&dir->children); d = ((typeof(*d) *) ((char *) (d->dir.next) - 
# 129 "project/ish/fs/tmp.c" 3 4
   __builtin_offsetof (
# 129 "project/ish/fs/tmp.c"
   typeof(*d)
...
# 129 "project/ish/fs/tmp.c"
        ...
        if (d->inode == 
# 130 "project/ish/fs/tmp.c" 3 4
                       ((void *)0)
# 130 "project/ish/fs/tmp.c"
                           )
            continue;
    ...
    if (dirent == 
# 137 "project/ish/fs/tmp.c" 3 4
                 ((void *)0)
# 137 "project/ish/fs/tmp.c"
                     )
...
static int tmpfs_dir_lookup_existence(struct tmp_dirent *dir, const char *name) {
    ...
    if (dirent == (void *) (intptr_t) (-2))
        return 0;
    if (((uintptr_t) (dirent) > (uintptr_t) -0xfff))
        return (intptr_t) (dirent);
    tmp_dirent_release(dirent);
    return -17;
}

static struct tmp_dirent *__tmpfs_lookup(struct mount *mount, const char *path, 
# 153 "project/ish/fs/tmp.c" 3 4
                                                                               _Bool 
# 153 "project/ish/fs/tmp.c"
                                                                                    parent, const char **filename_out) {
    struct tmp_dirent *root = mount->data;
    struct tmp_dirent *dirent = tmp_dirent_retain(root);

    char component[256 + 1] = {};
    int err = 0;
    while (path_next_component(&path, component, &err)) {
        if (parent && *path == '\0')
            break;

        __lock(&dirent->lock, "project/ish/fs/tmp.c", 163);
        struct tmp_dirent *child = tmpfs_dir_lookup(dirent, component);
        unlock(&dirent->lock);

        tmp_dirent_release(dirent);
        if (((uintptr_t) (child) > (uintptr_t) -0xfff))
            return child;
        dirent = child;
    }
...
static struct tmp_dirent *tmpfs_lookup(struct mount *mount, const char *path) {
    return __tmpfs_lookup(mount, path, 
# 181 "project/ish/fs/tmp.c" 3 4
                                      0
# 181 "project/ish/fs/tmp.c"
                                           , 
# 181 "project/ish/fs/tmp.c" 3 4
                                             ((void *)0)
# 181 "project/ish/fs/tmp.c"
...
static struct tmp_dirent *tmpfs_lookup_parent(struct mount *mount, const char *path, const char **filename_out) {
    if (strcmp(path, "/") == 0)
        return 
# 185 "project/ish/fs/tmp.c" 3 4
              ((void *)0)
# 185 "project/ish/fs/tmp.c"
                  ;
    return __tmpfs_lookup(mount, path, 
# 186 "project/ish/fs/tmp.c" 3 4
                                      1
# 186 "project/ish/fs/tmp.c"
                                          , filename_out);
}

static int tmpfs_file_resize(struct tmp_inode *file, size_t size) {
    
# 190 "project/ish/fs/tmp.c" 3 4
   (__builtin_expect(!((((
# 190 "project/ish/fs/tmp.c"
   file->stat.mode
# 190 "project/ish/fs/tmp.c" 3 4
   ) & 0170000) == 0100000)), 0) ? __assert_rtn(__func__, "project/ish/fs/tmp.c", 190, 
# 190 "project/ish/fs/tmp.c"
   "S_ISREG(file->stat.mode)"
# 190 "project/ish/fs/tmp.c" 3 4
   ) : (void)0)
# 190 "project/ish/fs/tmp.c"
                                   ;
    ...
    if (new_data == 
# 193 "project/ish/fs/tmp.c" 3 4
                   ((void *)0)
# 193 "project/ish/fs/tmp.c"
                       )
        return -12;
    file->file_data = new_data;
    file->stat.size = size;
    
# 197 "project/ish/fs/tmp.c" 3 4
   __builtin___memset_chk (
# 197 "project/ish/fs/tmp.c"
   (char *) file->file_data + old_size
# 197 "project/ish/fs/tmp.c" 3 4
   , 
# 197 "project/ish/fs/tmp.c"
   0, file->stat.size - old_size
# 197 "project/ish/fs/tmp.c" 3 4
   , __builtin_object_size (
# 197 "project/ish/fs/tmp.c"
   (char *) file->file_data + old_size
...
static int tmpfs_mount(struct mount *mount) {
    struct tmp_inode *root_inode = tmp_inode_new(
# 208 "project/ish/fs/tmp.c" 3 4
                                                0040000 
# 208 "project/ish/fs/tmp.c"
                                                        | 0777);
    if (root_inode == 
# 209 "project/ish/fs/tmp.c" 3 4
                     ((void *)0)
# 209 "project/ish/fs/tmp.c"
                         )
        return -12;

    struct tmp_dirent *root = malloc(sizeof(struct tmp_dirent));
    if (root == 
# 213 "project/ish/fs/tmp.c" 3 4
               ((void *)0)
# 213 "project/ish/fs/tmp.c"
                   ) {
        free(root_inode);
        return -12;
    }
...
# 219 "project/ish/fs/tmp.c" 3 4
   __builtin___strcpy_chk (
# 219 "project/ish/fs/tmp.c"
   root->name
# 219 "project/ish/fs/tmp.c" 3 4
   , 
# 219 "project/ish/fs/tmp.c"
...
# 219 "project/ish/fs/tmp.c"
    ...
    root->parent = 
# 221 "project/ish/fs/tmp.c" 3 4
                  ((void *)0)
# 221 "project/ish/fs/tmp.c"
                      ;

    mount->data = root;
    return 0;
}
# 243 "project/ish/fs/tmp.c"
static int tmpfs_umount(struct mount *UNUSED_mount __attribute__((unused))) {



    die("TODO: " "tmpfs umount");
    return 0;
}
...
static struct fd *tmpfs_open(struct mount *mount, const char *path, int flags, int mode) {
    ...
    if (flags & (1 << 6)) {
        ...
        if (((uintptr_t) (parent) > (uintptr_t) -0xfff))
            return (void *) (intptr_t) ((intptr_t) (parent));
        __lock(&parent->lock, "project/ish/fs/tmp.c", 259);
        int err = 0;

        dirent = tmpfs_dir_lookup(parent, filename);
        if (flags & (1 << 7) && !((uintptr_t) (dirent) > (uintptr_t) -0xfff)) {
            err = -17;
            goto out_creat;
        }

        if (dirent == (void *) (intptr_t) (-2)) {
            struct tmp_inode *inode = tmp_inode_new(
# 269 "project/ish/fs/tmp.c" 3 4
                                                   0100000 
# 269 "project/ish/fs/tmp.c"
                                                           | mode);
            if (inode == 
# 270 "project/ish/fs/tmp.c" 3 4
                        ((void *)0)
# 270 "project/ish/fs/tmp.c"
                            ) {
                err = -12;
                goto out_creat;
            }
...
out_creat:
    ...
    if (((uintptr_t) (dirent) > (uintptr_t) -0xfff))
        return (void *) (intptr_t) ((intptr_t) (dirent));

    struct fd *fd = fd_create(&tmpfs_fdops);
    if (fd == 
# 295 "project/ish/fs/tmp.c" 3 4
             ((void *)0)
# 295 "project/ish/fs/tmp.c"
                 ) {
        tmp_dirent_release(dirent);
    ...
    fd->tmpfs.dir_pos = 
# 301 "project/ish/fs/tmp.c" 3 4
                       ((void *)0)
# 301 "project/ish/fs/tmp.c"
                           ;
    __lock(&dirent->lock, "project/ish/fs/tmp.c", 302);
    if (!list_empty(&dirent->children)) {
        tmpfs_fd_seekdir(fd, ((struct tmp_dirent *) ((char *) ((&dirent->children)->next) - 
# 304 "project/ish/fs/tmp.c" 3 4
                            __builtin_offsetof (
# 304 "project/ish/fs/tmp.c"
                            struct tmp_dirent
# 304 "project/ish/fs/tmp.c" 3 4
                            , 
# 304 "project/ish/fs/tmp.c"
...
static int tmpfs_stat(struct mount *mount, const char *path, struct statbuf *stat) {
    ...
    __lock(&inode->lock, "project/ish/fs/tmp.c", 315);
...
static int tmpfs_close(struct fd *fd) {
    ...
    fd->tmpfs.dirent = 
# 325 "project/ish/fs/tmp.c" 3 4
                      ((void *)0)
# 325 "project/ish/fs/tmp.c"
                          ;
    return 0;
}
...
static int tmpfs_mkdir(struct mount *mount, const char *path, mode_t_ mode) {
    ...
    __lock(&parent->lock, "project/ish/fs/tmp.c", 334);
    ...
    struct tmp_inode *inode = tmp_inode_new(
# 340 "project/ish/fs/tmp.c" 3 4
                                           0040000 
# 340 "project/ish/fs/tmp.c"
                                                   | mode);
    err = -12;
    if (inode == 
# 342 "project/ish/fs/tmp.c" 3 4
                ((void *)0)
# 342 "project/ish/fs/tmp.c"
                    )
        goto out;

    err = tmpfs_dir_link(parent, filename, inode, 
# 345 "project/ish/fs/tmp.c" 3 4
                                                 ((void *)0)
# 345 "project/ish/fs/tmp.c"
                                                     );
out:
    unlock(&parent->lock);
    tmp_dirent_release(parent);
...
# 370 "project/ish/fs/tmp.c" 3 4
       __builtin___memcpy_chk (
# 370 "project/ish/fs/tmp.c"
       &p[1]
# 370 "project/ish/fs/tmp.c" 3 4
       , 
# 370 "project/ish/fs/tmp.c"
...
# 372 "project/ish/fs/tmp.c" 3 4
   __builtin___memmove_chk (
# 372 "project/ish/fs/tmp.c"
   buf
# 372 "project/ish/fs/tmp.c" 3 4
   , 
# 372 "project/ish/fs/tmp.c"
...
static int tmpfs_fstat(struct fd *fd, struct statbuf *stat) {
    ...
    __lock(&inode->lock, "project/ish/fs/tmp.c", 378);
    *stat = inode->stat;
    unlock(&inode->lock);
    return 0;
}
...
static ssize_t tmpfs_read(struct fd *fd, void *buf, size_t bufsize) {
    ssize_t res;
    struct tmp_inode *inode = tmpfs_fd_inode(fd);
    __lock(&inode->lock, "project/ish/fs/tmp.c", 387);
    res = -21;
    if (
# 389 "project/ish/fs/tmp.c" 3 4
       (((
# 389 "project/ish/fs/tmp.c"
       inode->stat.mode
# 389 "project/ish/fs/tmp.c" 3 4
       ) & 0170000) == 0040000)
# 389 "project/ish/fs/tmp.c"
...
# 391 "project/ish/fs/tmp.c" 3 4
   (__builtin_expect(!((((
# 391 "project/ish/fs/tmp.c"
   inode->stat.mode
# 391 "project/ish/fs/tmp.c" 3 4
   ) & 0170000) == 0100000)), 0) ? __assert_rtn(__func__, "project/ish/fs/tmp.c", 391, 
# 391 "project/ish/fs/tmp.c"
   "S_ISREG(inode->stat.mode)"
# 391 "project/ish/fs/tmp.c" 3 4
   ) : (void)0)
# 391 "project/ish/fs/tmp.c"
                                    ;
...
# 398 "project/ish/fs/tmp.c" 3 4
   __builtin___memcpy_chk (
# 398 "project/ish/fs/tmp.c"
   buf
# 398 "project/ish/fs/tmp.c" 3 4
   , 
# 398 "project/ish/fs/tmp.c"
   inode->file_data + fd->offset, bufsize
# 398 "project/ish/fs/tmp.c" 3 4
   , __builtin_object_size (
# 398 "project/ish/fs/tmp.c"
   buf
...
static ssize_t tmpfs_write(struct fd *fd, const void *buf, size_t bufsize) {
    ssize_t res;
    struct tmp_inode *inode = tmpfs_fd_inode(fd);
    __lock(&inode->lock, "project/ish/fs/tmp.c", 410);
    res = -21;
    if (
# 412 "project/ish/fs/tmp.c" 3 4
       (((
# 412 "project/ish/fs/tmp.c"
       inode->stat.mode
# 412 "project/ish/fs/tmp.c" 3 4
       ) & 0170000) == 0040000)
# 412 "project/ish/fs/tmp.c"
...
# 414 "project/ish/fs/tmp.c" 3 4
   (__builtin_expect(!((((
# 414 "project/ish/fs/tmp.c"
   inode->stat.mode
# 414 "project/ish/fs/tmp.c" 3 4
   ) & 0170000) == 0100000)), 0) ? __assert_rtn(__func__, "project/ish/fs/tmp.c", 414, 
# 414 "project/ish/fs/tmp.c"
   "S_ISREG(inode->stat.mode)"
# 414 "project/ish/fs/tmp.c" 3 4
   ) : (void)0)
...
# 421 "project/ish/fs/tmp.c" 3 4
   __builtin___memcpy_chk (
# 421 "project/ish/fs/tmp.c"
   inode->file_data + fd->offset
# 421 "project/ish/fs/tmp.c" 3 4
   , 
# 421 "project/ish/fs/tmp.c"
   buf, bufsize
...
static off_t_ tmpfs_lseek(struct fd *fd, off_t_ off, int whence) {
    ...
    if (whence == 2) {
        struct tmp_inode *inode = tmpfs_fd_inode(fd);
        __lock(&inode->lock, "project/ish/fs/tmp.c", 434);
...
static int tmpfs_readdir(struct fd *fd, struct dir_entry *entry) {
    ...
    int res = -20;
    if (!
# 449 "project/ish/fs/tmp.c" 3 4
        (((
# 449 "project/ish/fs/tmp.c"
        parent->inode->stat.mode
# 449 "project/ish/fs/tmp.c" 3 4
        ) & 0170000) == 0040000)
# 449 "project/ish/fs/tmp.c"
                                         )
    ...
    __lock(&fd->lock, "project/ish/fs/tmp.c", 452);
    __lock(&parent->lock, "project/ish/fs/tmp.c", 453);
    struct tmp_dirent *dirent = fd->tmpfs.dir_pos;
    if (dirent == 
# 455 "project/ish/fs/tmp.c" 3 4
                 ((void *)0)
# 455 "project/ish/fs/tmp.c"
                     ) {
        res = 0;
        goto out;
    }
    struct tmp_dirent *next_dirent = ((typeof(*(dirent)) *) ((char *) ((dirent)->dir.next) - 
# 459 "project/ish/fs/tmp.c" 3 4
                                    __builtin_offsetof (
# 459 "project/ish/fs/tmp.c"
                                    typeof(*(dirent))
# 459 "project/ish/fs/tmp.c" 3 4
                                    , 
# 459 "project/ish/fs/tmp.c"
...
# 459 "project/ish/fs/tmp.c"
    ...
    if (&next_dirent->dir == &parent->children)
        next_dirent = 
# 461 "project/ish/fs/tmp.c" 3 4
                     ((void *)0)
# 461 "project/ish/fs/tmp.c"
                         ;
    tmpfs_fd_seekdir(fd, next_dirent);

    entry->inode = dirent->inode->stat.inode;
    
# 465 "project/ish/fs/tmp.c" 3 4
   __builtin___strcpy_chk (
# 465 "project/ish/fs/tmp.c"
   entry->name
# 465 "project/ish/fs/tmp.c" 3 4
   , 
# 465 "project/ish/fs/tmp.c"
...
static unsigned long tmpfs_telldir(struct fd *fd) {
    if (fd->tmpfs.dir_pos == 
# 475 "project/ish/fs/tmp.c" 3 4
                            ((void *)0)
# 475 "project/ish/fs/tmp.c"
                                )
...
static void tmpfs_seekdir(struct fd *fd, unsigned long ptr) {
    ...
    __lock(&dir->lock, "project/ish/fs/tmp.c", 482);
    
# 483 "project/ish/fs/tmp.c" 3 4
   (__builtin_expect(!((((
# 483 "project/ish/fs/tmp.c"
   dir->inode->stat.mode
# 483 "project/ish/fs/tmp.c" 3 4
   ) & 0170000) == 0040000)), 0) ? __assert_rtn(__func__, "project/ish/fs/tmp.c", 483, 
# 483 "project/ish/fs/tmp.c"
   "S_ISDIR(dir->inode->stat.mode)"
# 483 "project/ish/fs/tmp.c" 3 4
   ) : (void)0)
# 483 "project/ish/fs/tmp.c"
                                         ;
    struct tmp_dirent *child;
    for (child = ((typeof(*child) *) ((char *) ((&dir->children)->next) - 
# 485 "project/ish/fs/tmp.c" 3 4
   __builtin_offsetof (
# 485 "project/ish/fs/tmp.c"
   typeof(*child)
# 485 "project/ish/fs/tmp.c" 3 4
   , 
# 485 "project/ish/fs/tmp.c"
...
# 485 "project/ish/fs/tmp.c"
   )); &child->dir != (&dir->children); child = ((typeof(*child) *) ((char *) (child->dir.next) - 
# 485 "project/ish/fs/tmp.c" 3 4
   __builtin_offsetof (
# 485 "project/ish/fs/tmp.c"
   typeof(*child)
...
# 485 "project/ish/fs/tmp.c"
    ...
    if (&child->dir == &dir->children)
        child = 
# 490 "project/ish/fs/tmp.c" 3 4
               ((void *)0)
# 490 "project/ish/fs/tmp.c"
                   ;
