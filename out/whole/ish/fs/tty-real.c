...
# 10 "project/ish/fs/tty-real.c" 2
...
# 11 "project/ish/fs/tty-real.c" 2
...
# 12 "project/ish/fs/tty-real.c" 2
...
static void *real_tty_read_thread(void *_tty) {
    ...
    for (;;) {
        int err = read(
# 22 "project/ish/fs/tty-real.c" 3 4
                      0
# 22 "project/ish/fs/tty-real.c"
                                  , &ch, 1);
        if (err != 1) {
            ish_printk("tty read returned %d\n", err);
            if (err < 0)
                ish_printk("error: %s\n", strerror(
# 26 "project/ish/fs/tty-real.c" 3 4
                                              (*__error())
# 26 "project/ish/fs/tty-real.c"
                                                   ));
            continue;
        }
        if (ch == '\x1c') {
            ...
            real_tty_reset_term();
            raise(
# 32 "project/ish/fs/tty-real.c" 3 4
                 2
# 32 "project/ish/fs/tty-real.c"
                       );
        }
        tty_input(tty, &ch, 1, 0);
    }
    return 
# 36 "project/ish/fs/tty-real.c" 3 4
          ((void *)0)
# 36 "project/ish/fs/tty-real.c"
              ;
}

static struct termios_ termios_from_real(struct termios real) {
    struct termios_ fake = {};
#define FLAG(t,x) if (real.c_ ##t ##flag & x) fake.t ##flags |= x ##_


    if (real.c_oflag & 
# 44 "project/ish/fs/tty-real.c" 3 4
   0x00000001
# 44 "project/ish/fs/tty-real.c"
   ) fake.oflags |= (1 << 0);
    if (real.c_oflag & 
# 45 "project/ish/fs/tty-real.c" 3 4
   0x00000002
# 45 "project/ish/fs/tty-real.c"
   ) fake.oflags |= (1 << 2);
    if (real.c_oflag & 
# 46 "project/ish/fs/tty-real.c" 3 4
   0x00000010
# 46 "project/ish/fs/tty-real.c"
   ) fake.oflags |= (1 << 3);
    if (real.c_oflag & 
# 47 "project/ish/fs/tty-real.c" 3 4
   0x00000020
# 47 "project/ish/fs/tty-real.c"
   ) fake.oflags |= (1 << 4);
    if (real.c_oflag & 
# 48 "project/ish/fs/tty-real.c" 3 4
   0x00000040
# 48 "project/ish/fs/tty-real.c"
   ) fake.oflags |= (1 << 5);
    if (real.c_iflag & 
# 49 "project/ish/fs/tty-real.c" 3 4
   0x00000040
# 49 "project/ish/fs/tty-real.c"
   ) fake.iflags |= (1 << 6);
    if (real.c_iflag & 
# 50 "project/ish/fs/tty-real.c" 3 4
   0x00000080
# 50 "project/ish/fs/tty-real.c"
   ) fake.iflags |= (1 << 7);
    if (real.c_iflag & 
# 51 "project/ish/fs/tty-real.c" 3 4
   0x00000100
# 51 "project/ish/fs/tty-real.c"
   ) fake.iflags |= (1 << 8);
    if (real.c_lflag & 
# 52 "project/ish/fs/tty-real.c" 3 4
   0x00000080
# 52 "project/ish/fs/tty-real.c"
   ) fake.lflags |= (1 << 0);
    if (real.c_lflag & 
# 53 "project/ish/fs/tty-real.c" 3 4
   0x00000100
# 53 "project/ish/fs/tty-real.c"
   ) fake.lflags |= (1 << 1);
    if (real.c_lflag & 
# 54 "project/ish/fs/tty-real.c" 3 4
   0x00000008
# 54 "project/ish/fs/tty-real.c"
   ) fake.lflags |= (1 << 3);
    if (real.c_lflag & 
# 55 "project/ish/fs/tty-real.c" 3 4
   0x00000002
# 55 "project/ish/fs/tty-real.c"
   ) fake.lflags |= (1 << 4);
    if (real.c_lflag & 
# 56 "project/ish/fs/tty-real.c" 3 4
   0x00000004
# 56 "project/ish/fs/tty-real.c"
   ) fake.lflags |= (1 << 5);
    if (real.c_lflag & 
# 57 "project/ish/fs/tty-real.c" 3 4
   0x80000000
# 57 "project/ish/fs/tty-real.c"
   ) fake.lflags |= (1 << 7);
    if (real.c_lflag & 
# 58 "project/ish/fs/tty-real.c" 3 4
   0x00000040
# 58 "project/ish/fs/tty-real.c"
   ) fake.lflags |= (1 << 9);
#undef FLAG
...
#define CC(x) fake.cc[V ##x ##_] = real.c_cc[V ##x]
    ...
    fake.cc[0] = real.c_cc[
# 63 "project/ish/fs/tty-real.c" 3 4
   8
# 63 "project/ish/fs/tty-real.c"
   ];
    fake.cc[1] = real.c_cc[
# 64 "project/ish/fs/tty-real.c" 3 4
   9
# 64 "project/ish/fs/tty-real.c"
   ];
    fake.cc[2] = real.c_cc[
# 65 "project/ish/fs/tty-real.c" 3 4
   3
# 65 "project/ish/fs/tty-real.c"
   ];
    fake.cc[3] = real.c_cc[
# 66 "project/ish/fs/tty-real.c" 3 4
   5
# 66 "project/ish/fs/tty-real.c"
   ];
    fake.cc[4] = real.c_cc[
# 67 "project/ish/fs/tty-real.c" 3 4
   0
# 67 "project/ish/fs/tty-real.c"
   ];
    fake.cc[5] = real.c_cc[
# 68 "project/ish/fs/tty-real.c" 3 4
   17
# 68 "project/ish/fs/tty-real.c"
   ];
    fake.cc[6] = real.c_cc[
# 69 "project/ish/fs/tty-real.c" 3 4
   16
# 69 "project/ish/fs/tty-real.c"
   ];
    fake.cc[8] = real.c_cc[
# 70 "project/ish/fs/tty-real.c" 3 4
   12
# 70 "project/ish/fs/tty-real.c"
   ];
    fake.cc[9] = real.c_cc[
# 71 "project/ish/fs/tty-real.c" 3 4
   13
# 71 "project/ish/fs/tty-real.c"
   ];
    fake.cc[10] = real.c_cc[
# 72 "project/ish/fs/tty-real.c" 3 4
   10
# 72 "project/ish/fs/tty-real.c"
   ];
    fake.cc[11] = real.c_cc[
# 73 "project/ish/fs/tty-real.c" 3 4
   1
# 73 "project/ish/fs/tty-real.c"
   ];
    fake.cc[12] = real.c_cc[
# 74 "project/ish/fs/tty-real.c" 3 4
   6
# 74 "project/ish/fs/tty-real.c"
   ];
    fake.cc[13] = real.c_cc[
# 75 "project/ish/fs/tty-real.c" 3 4
   15
# 75 "project/ish/fs/tty-real.c"
   ];
    fake.cc[14] = real.c_cc[
# 76 "project/ish/fs/tty-real.c" 3 4
   4
# 76 "project/ish/fs/tty-real.c"
   ];
    fake.cc[15] = real.c_cc[
# 77 "project/ish/fs/tty-real.c" 3 4
   14
# 77 "project/ish/fs/tty-real.c"
   ];
    fake.cc[16] = real.c_cc[
# 78 "project/ish/fs/tty-real.c" 3 4
   2
# 78 "project/ish/fs/tty-real.c"
   ];
#undef CC
    return fake;
}
...
static 
# 84 "project/ish/fs/tty-real.c" 3 4
      _Bool 
# 84 "project/ish/fs/tty-real.c"
           real_tty_is_open;
static int real_tty_init(struct tty *tty) {
    ...
    if (ioctl(
# 90 "project/ish/fs/tty-real.c" 3 4
             0
# 90 "project/ish/fs/tty-real.c"
                         , 
# 90 "project/ish/fs/tty-real.c" 3 4
...
# 90 "project/ish/fs/tty-real.c"
                                     , &winsz) < 0) {
        if (
# 91 "project/ish/fs/tty-real.c" 3 4
           (*__error()) 
# 91 "project/ish/fs/tty-real.c"
                 == 
# 91 "project/ish/fs/tty-real.c" 3 4
                    25
# 91 "project/ish/fs/tty-real.c"
    ...
    if (tcgetattr(
# 101 "project/ish/fs/tty-real.c" 3 4
                 0
# 101 "project/ish/fs/tty-real.c"
                             , &termios) < 0)
        return errno_map();
    ...
    if (tcsetattr(
# 110 "project/ish/fs/tty-real.c" 3 4
                 0
# 110 "project/ish/fs/tty-real.c"
                             , 
# 110 "project/ish/fs/tty-real.c" 3 4
                               0
# 110 "project/ish/fs/tty-real.c"
                                      , &termios) < 0)
        { perror("failed to set terminal to raw mode"); abort(); };
notty:

    if (pthread_create(&tty->thread, 
# 114 "project/ish/fs/tty-real.c" 3 4
                                    ((void *)0)
# 114 "project/ish/fs/tty-real.c"
                                        , real_tty_read_thread, tty) < 0)

        return -5;
    pthread_detach(tty->thread);
    real_tty_is_open = 
# 118 "project/ish/fs/tty-real.c" 3 4
                      1
# 118 "project/ish/fs/tty-real.c"
                          ;
    return 0;
}

static int real_tty_write(struct tty *tty, const void *buf, size_t len, 
# 122 "project/ish/fs/tty-real.c" 3 4
                                                                       _Bool 
# 122 "project/ish/fs/tty-real.c"
                                                                            UNUSED_blocking __attribute__((unused))) {
    if (tty->num != 1)
        return len;
    return write(
# 125 "project/ish/fs/tty-real.c" 3 4
                1
# 125 "project/ish/fs/tty-real.c"
                             , buf, len);
}
...
void real_tty_reset_term() {
    ...
    if (tcsetattr(
# 130 "project/ish/fs/tty-real.c" 3 4
                 0
# 130 "project/ish/fs/tty-real.c"
                             , 
# 130 "project/ish/fs/tty-real.c" 3 4
                               0
# 130 "project/ish/fs/tty-real.c"
...
# 130 "project/ish/fs/tty-real.c"
        ...
        ish_printk("failed to reset terminal: %s\n", strerror(
# 131 "project/ish/fs/tty-real.c" 3 4
                                                         (*__error())
# 131 "project/ish/fs/tty-real.c"
                                                              ));
        abort();
    }
}
...
static struct tty *real_tty_driver_ttys[64]; struct tty_driver real_tty_driver = {.ops = &real_tty_ops, .major = 4, .ttys = real_tty_driver_ttys, .limit = 64};
