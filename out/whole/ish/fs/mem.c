...
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/ish/kernel/random.h" 2


# 6 "/Users/washi38/University/Labo/c_project_analysis/project/ish/kernel/random.h"
int get_random(char *buf, size_t len);
# 4 "project/ish/fs/mem.c" 2
...
# 4 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/poll.h" 2
...
# 5 "project/ish/fs/mem.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/mem.h" 1
...
static int mem_open(int major, int minor, struct fd *fd) {
    ...
    if (dev == 
# 33 "project/ish/fs/mem.c" 3 4
              ((void *)0)
# 33 "project/ish/fs/mem.c"
                  ) {
        return -6;
    }
    fd->ops = &dev->fd;
...
static int ready_poll(struct fd *UNUSED_fd __attribute__((unused))) {
    return 1 | 4;
}


static int null_open(int UNUSED_major __attribute__((unused)), int UNUSED_minor __attribute__((unused)), struct fd *UNUSED_fd __attribute__((unused))) {
    return 0;
}
static ssize_t null_read(struct fd *UNUSED_fd __attribute__((unused)), void *UNUSED_buf __attribute__((unused)), size_t UNUSED_bufsize __attribute__((unused))) {
    return 0;
}
static ssize_t null_write(struct fd *UNUSED_fd __attribute__((unused)), const void *UNUSED_buf __attribute__((unused)), size_t bufsize) {
    return bufsize;
}
static off_t_ null_lseek(struct fd *UNUSED_fd __attribute__((unused)), off_t_ UNUSED_off __attribute__((unused)), int UNUSED_whence __attribute__((unused))) {
    return 0;
}
...
static ssize_t zero_read(struct fd *UNUSED_fd __attribute__((unused)), void *buf, size_t bufsize) {
    
# 72 "project/ish/fs/mem.c" 3 4
   __builtin___memset_chk (
# 72 "project/ish/fs/mem.c"
   buf
# 72 "project/ish/fs/mem.c" 3 4
   , 
# 72 "project/ish/fs/mem.c"
...
static ssize_t zero_write(struct fd *UNUSED_fd __attribute__((unused)), const void *UNUSED_buf __attribute__((unused)), size_t bufsize) {
    return bufsize;
}
...
static ssize_t full_write(struct fd *UNUSED_fd __attribute__((unused)), const void *UNUSED_buf __attribute__((unused)), size_t UNUSED_bufsize __attribute__((unused))) {
    return -28;
}
...
static ssize_t random_read(struct fd *UNUSED_fd __attribute__((unused)), void *buf, size_t bufsize) {
