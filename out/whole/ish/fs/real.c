...
# 77 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/unistd.h" 2 3 4
...
# 67 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/select.h" 2 3 4
...
# 639 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/unistd.h" 2 3 4
...
# 82 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/dirent.h" 2 3 4
...
# 9 "project/ish/fs/real.c" 2
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/xattr.h" 1 3 4
# 30 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/xattr.h" 3 4
...
# 33 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/xattr.h" 2 3 4
...
# 72 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/file.h" 2 3 4
...
# 37 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/statvfs.h" 3 4
struct statvfs {
...
# 21 "project/ish/fs/real.c" 2

static int getpath(int fd, char *buf) {
# 31 "project/ish/fs/real.c"
    return fcntl(fd, 
# 31 "project/ish/fs/real.c" 3 4
                    50
# 31 "project/ish/fs/real.c"
                             , buf);
...
static void lock_fchdir(int dirfd) {
    __lock(&fchdir_lock, "project/ish/fs/real.c", 39);
    fchdir(dirfd);
}
...
static int open_flags_real_from_fake(int flags) {
    int real_flags = 0;
    if (flags & 0) real_flags |= 
# 48 "project/ish/fs/real.c" 3 4
                                        0x0000
# 48 "project/ish/fs/real.c"
                                                ;
    if (flags & (1 << 0)) real_flags |= 
# 49 "project/ish/fs/real.c" 3 4
                                        0x0001
# 49 "project/ish/fs/real.c"
                                                ;
    if (flags & (1 << 1)) real_flags |= 
# 50 "project/ish/fs/real.c" 3 4
                                      0x0002
# 50 "project/ish/fs/real.c"
                                            ;
    if (flags & (1 << 6)) real_flags |= 
# 51 "project/ish/fs/real.c" 3 4
                                       0x00000200
# 51 "project/ish/fs/real.c"
                                              ;
    if (flags & (1 << 9)) real_flags |= 
# 52 "project/ish/fs/real.c" 3 4
                                       0x00000400
# 52 "project/ish/fs/real.c"
                                              ;
    if (flags & (1 << 10)) real_flags |= 
# 53 "project/ish/fs/real.c" 3 4
                                        0x00000008
# 53 "project/ish/fs/real.c"
                                                ;
    if (flags & (1 << 11)) real_flags |= 
# 54 "project/ish/fs/real.c" 3 4
                                          0x00000004
# 54 "project/ish/fs/real.c"
                                                    ;
    return real_flags;
}
...
static int open_flags_fake_from_real(int flags) {
    int fake_flags = 0;
    if (flags & 
# 60 "project/ish/fs/real.c" 3 4
               0x0000
# 60 "project/ish/fs/real.c"
                       ) fake_flags |= 0;
    if (flags & 
# 61 "project/ish/fs/real.c" 3 4
               0x0001
# 61 "project/ish/fs/real.c"
                       ) fake_flags |= (1 << 0);
    if (flags & 
# 62 "project/ish/fs/real.c" 3 4
               0x0002
# 62 "project/ish/fs/real.c"
                     ) fake_flags |= (1 << 1);
    if (flags & 
# 63 "project/ish/fs/real.c" 3 4
               0x00000200
# 63 "project/ish/fs/real.c"
                      ) fake_flags |= (1 << 6);
    if (flags & 
# 64 "project/ish/fs/real.c" 3 4
               0x00000400
# 64 "project/ish/fs/real.c"
                      ) fake_flags |= (1 << 9);
    if (flags & 
# 65 "project/ish/fs/real.c" 3 4
               0x00000008
# 65 "project/ish/fs/real.c"
                       ) fake_flags |= (1 << 10);
    if (flags & 
# 66 "project/ish/fs/real.c" 3 4
               0x00000004
# 66 "project/ish/fs/real.c"
                         ) fake_flags |= (1 << 11);
    return fake_flags;
}
...
struct fd *realfs_open(struct mount *mount, const char *path, int flags, int mode) {
    ...
    if (fd_no < 0)
        return (void *) (intptr_t) (errno_map());
    struct fd *fd = fd_create(&realfs_fdops);
    fd->real_fd = fd_no;
    fd->dir = 
# 77 "project/ish/fs/real.c" 3 4
             ((void *)0)
# 77 "project/ish/fs/real.c"
                 ;
    return fd;
}
...
int realfs_close(struct fd *fd) {
    if (fd->dir != 
# 82 "project/ish/fs/real.c" 3 4
                  ((void *)0)
# 82 "project/ish/fs/real.c"
                      )
        closedir(fd->dir);
...
static void copy_stat(struct statbuf *fake_stat, struct stat *real_stat) {
    ...
    fake_stat->atime = real_stat->
# 101 "project/ish/fs/real.c" 3 4
                                 st_atimespec.tv_sec
# 101 "project/ish/fs/real.c"
                                         ;
    fake_stat->mtime = real_stat->
# 102 "project/ish/fs/real.c" 3 4
                                 st_mtimespec.tv_sec
# 102 "project/ish/fs/real.c"
                                         ;
    fake_stat->ctime = real_stat->
# 103 "project/ish/fs/real.c" 3 4
                                 st_ctimespec.tv_sec
# 103 "project/ish/fs/real.c"
                                         ;
...
int realfs_stat(struct mount *mount, const char *path, struct statbuf *fake_stat) {
    ...
    if (fstatat(mount->root_fd, fix_path(path), &real_stat, 
# 117 "project/ish/fs/real.c" 3 4
                                                           0x0020
# 117 "project/ish/fs/real.c"
                                                                              ) < 0)
        return errno_map();
...
void realfs_opendir(struct fd *fd) {
    if (fd->dir == 
# 160 "project/ish/fs/real.c" 3 4
                  ((void *)0)
# 160 "project/ish/fs/real.c"
                      ) {
        int dirfd = dup(fd->real_fd);
        fd->dir = fdopendir(dirfd);

        
# 164 "project/ish/fs/real.c" 3 4
       (__builtin_expect(!(
# 164 "project/ish/fs/real.c"
       fd->dir != 
# 164 "project/ish/fs/real.c" 3 4
       ((void *)0)), 0) ? __assert_rtn(__func__, "project/ish/fs/real.c", 164, 
# 164 "project/ish/fs/real.c"
       "fd->dir != NULL"
# 164 "project/ish/fs/real.c" 3 4
       ) : (void)0)
...
# 170 "project/ish/fs/real.c" 3 4
   (*__error()) 
# 170 "project/ish/fs/real.c"
         = 0;
    struct dirent *dirent = readdir(fd->dir);
    if (dirent == 
# 172 "project/ish/fs/real.c" 3 4
                 ((void *)0)
# 172 "project/ish/fs/real.c"
                     ) {
        if (
# 173 "project/ish/fs/real.c" 3 4
           (*__error()) 
# 173 "project/ish/fs/real.c"
                 != 0)
            return errno_map();
        else
            return 0;
...
# 179 "project/ish/fs/real.c" 3 4
   __builtin___strcpy_chk (
# 179 "project/ish/fs/real.c"
   entry->name
# 179 "project/ish/fs/real.c" 3 4
   , 
# 179 "project/ish/fs/real.c"
...
off_t realfs_lseek(struct fd *fd, off_t offset, int whence) {
    if (fd->dir != 
# 194 "project/ish/fs/real.c" 3 4
                  ((void *)0) 
# 194 "project/ish/fs/real.c"
                       && whence == 0) {
    ...
    if (whence == 0)
        whence = 
# 200 "project/ish/fs/real.c" 3 4
                0
# 200 "project/ish/fs/real.c"
                        ;
    else if (whence == 1)
        whence = 
# 202 "project/ish/fs/real.c" 3 4
                1
# 202 "project/ish/fs/real.c"
                        ;
    else if (whence == 2)
        whence = 
# 204 "project/ish/fs/real.c" 3 4
                2
# 204 "project/ish/fs/real.c"
                        ;
    else
        return -22;
...
int realfs_poll(struct fd *fd) {
    struct pollfd p = {.fd = fd->real_fd, .events = 
# 214 "project/ish/fs/real.c" 3 4
                                                   0x0002
# 214 "project/ish/fs/real.c"
                                                          };

    int flags = fcntl(fd->real_fd, 
# 216 "project/ish/fs/real.c" 3 4
                                  3
# 216 "project/ish/fs/real.c"
                                         , 0);
    if ((flags & 
# 217 "project/ish/fs/real.c" 3 4
                0x0003
# 217 "project/ish/fs/real.c"
                         ) != 
# 217 "project/ish/fs/real.c" 3 4
                              0x0001
# 217 "project/ish/fs/real.c"
        ...
        p.events |= 
# 218 "project/ish/fs/real.c" 3 4
                   0x0001
# 218 "project/ish/fs/real.c"
                         ;
    if ((flags & 
# 219 "project/ish/fs/real.c" 3 4
                0x0003
# 219 "project/ish/fs/real.c"
                         ) != 
# 219 "project/ish/fs/real.c" 3 4
                              0x0000
# 219 "project/ish/fs/real.c"
        ...
        p.events |= 
# 220 "project/ish/fs/real.c" 3 4
                   0x0004
# 220 "project/ish/fs/real.c"
                          ;
    if (poll(&p, 1, 0) <= 0)
        return 0;
    ...
    if (p.revents & 
# 228 "project/ish/fs/real.c" 3 4
                   0x0010
# 228 "project/ish/fs/real.c"
                          )
        p.revents |= 
# 229 "project/ish/fs/real.c" 3 4
                    0x0004
# 229 "project/ish/fs/real.c"
                           ;

    if (is_adhoc_fd(fd) && 
# 231 "project/ish/fs/real.c" 3 4
                          (((
# 231 "project/ish/fs/real.c"
                          fd->stat.mode
# 231 "project/ish/fs/real.c" 3 4
                          ) & 0170000) == 0010000)
# 231 "project/ish/fs/real.c"
        ...
        p.revents &= ~
# 232 "project/ish/fs/real.c" 3 4
                     0x0002
# 232 "project/ish/fs/real.c"
                            ;

    if (p.revents & 
# 234 "project/ish/fs/real.c" 3 4
                   0x0020
# 234 "project/ish/fs/real.c"
                           ) {
        ish_printk("pollnval %d flags %d events %d revents %d\n", fd->real_fd, flags, p.events, p.revents);
        ...
        int events = 0;
        static const int pollbits[] = {
# 242 "project/ish/fs/real.c" 3 4
                                      0x0001
# 242 "project/ish/fs/real.c"
                                            , 
# 242 "project/ish/fs/real.c" 3 4
                                              0x0004
# 242 "project/ish/fs/real.c"
...
# 245 "project/ish/fs/real.c" 3 4
                                                   0x0020
# 245 "project/ish/fs/real.c"
                                                           ))
                events |= p.revents;
        }
        
# 248 "project/ish/fs/real.c" 3 4
       (__builtin_expect(!(
# 248 "project/ish/fs/real.c"
       !(events & 
# 248 "project/ish/fs/real.c" 3 4
       0x0020
# 248 "project/ish/fs/real.c"
...
# 248 "project/ish/fs/real.c" 3 4
       ), 0) ? __assert_rtn(__func__, "project/ish/fs/real.c", 248, 
# 248 "project/ish/fs/real.c"
       "!(events & POLLNVAL)"
# 248 "project/ish/fs/real.c" 3 4
       ) : (void)0)
...
# 253 "project/ish/fs/real.c" 3 4
   (__builtin_expect(!(
# 253 "project/ish/fs/real.c"
   !(p.revents & 
# 253 "project/ish/fs/real.c" 3 4
   0x0020
# 253 "project/ish/fs/real.c"
...
# 253 "project/ish/fs/real.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/fs/real.c", 253, 
# 253 "project/ish/fs/real.c"
   "!(p.revents & POLLNVAL)"
# 253 "project/ish/fs/real.c" 3 4
   ) : (void)0)
...
int realfs_mmap(struct fd *fd, struct mem *mem, page_t start, pages_t pages, off_t offset, int prot, int flags) {
    int mmap_flags = 0;
    if (flags & 0x2) mmap_flags |= 
# 259 "project/ish/fs/real.c" 3 4
                                           0x0002
# 259 "project/ish/fs/real.c"
                                                      ;
    if (flags & 0x1) mmap_flags |= 
# 260 "project/ish/fs/real.c" 3 4
                                          0x0001
# 260 "project/ish/fs/real.c"
                                                    ;
    int mmap_prot = 
# 261 "project/ish/fs/real.c" 3 4
                   0x01
# 261 "project/ish/fs/real.c"
                            ;
    if (prot & (1 << 1)) mmap_prot |= 
# 262 "project/ish/fs/real.c" 3 4
                                    0x02
# 262 "project/ish/fs/real.c"
                                              ;

    off_t real_offset = (offset / real_page_size) * real_page_size;
    off_t correction = offset - real_offset;
    char *memory = mmap(
# 266 "project/ish/fs/real.c" 3 4
                       ((void *)0)
# 266 "project/ish/fs/real.c"
                           , (pages * (1 << 12)) + correction,
...
# 284 "project/ish/fs/real.c" 3 4
       __builtin___memmove_chk (
# 284 "project/ish/fs/real.c"
       buf
# 284 "project/ish/fs/real.c" 3 4
       , 
# 284 "project/ish/fs/real.c"
       buf + source_len, 4096 - source_len
# 284 "project/ish/fs/real.c" 3 4
       , __builtin_object_size (
# 284 "project/ish/fs/real.c"
       buf
...
int realfs_rmdir(struct mount *mount, const char *path) {
    int err = unlinkat(mount->root_fd, fix_path(path), 
# 304 "project/ish/fs/real.c" 3 4
                                                      0x0080
# 304 "project/ish/fs/real.c"
                                                                  );
    if (err < 0)
        return errno_map();
    return 0;
...
int realfs_mknod(struct mount *mount, const char *path, mode_t_ mode, dev_t_ UNUSED_dev __attribute__((unused))) {
    int err;
    if (
# 326 "project/ish/fs/real.c" 3 4
       (((
# 326 "project/ish/fs/real.c"
       mode
# 326 "project/ish/fs/real.c" 3 4
       ) & 0170000) == 0010000)
# 326 "project/ish/fs/real.c"
...
# 328 "project/ish/fs/real.c" 3 4
                                            0170000
# 328 "project/ish/fs/real.c"
                                                  );
        unlock_fchdir();
    } else if (
# 330 "project/ish/fs/real.c" 3 4
              (((
# 330 "project/ish/fs/real.c"
              mode
# 330 "project/ish/fs/real.c" 3 4
              ) & 0170000) == 0100000)
# 330 "project/ish/fs/real.c"
                           ) {
        err = openat(mount->root_fd, fix_path(path), 
# 331 "project/ish/fs/real.c" 3 4
                                                    0x00000200
# 331 "project/ish/fs/real.c"
                                                           |
# 331 "project/ish/fs/real.c" 3 4
                                                            0x00000800
# 331 "project/ish/fs/real.c"
...
int realfs_truncate(struct mount *mount, const char *path, off_t_ size) {
    int fd = openat(mount->root_fd, fix_path(path), 
# 343 "project/ish/fs/real.c" 3 4
                                                   0x0002
# 343 "project/ish/fs/real.c"
                                                         );
    if (fd < 0)
        return errno_map();
    int err = 0;
...
int realfs_flock(struct fd *fd, int operation) {
    int real_op = 0;
    if (operation & 1) real_op |= 
# 417 "project/ish/fs/real.c" 3 4
                                        0x01
# 417 "project/ish/fs/real.c"
                                               ;
    if (operation & 2) real_op |= 
# 418 "project/ish/fs/real.c" 3 4
                                        0x02
# 418 "project/ish/fs/real.c"
                                               ;
    if (operation & 8) real_op |= 
# 419 "project/ish/fs/real.c" 3 4
                                        0x08
# 419 "project/ish/fs/real.c"
                                               ;
    if (operation & 4) real_op |= 
# 420 "project/ish/fs/real.c" 3 4
                                        0x04
# 420 "project/ish/fs/real.c"
                                               ;
...
int realfs_mount(struct mount *mount) {
    mount->root_fd = open(mount->source, 
# 439 "project/ish/fs/real.c" 3 4
                                        0x00100000
# 439 "project/ish/fs/real.c"
                                                   );
    if (mount->root_fd < 0)
        return errno_map();
    return 0;
...
int realfs_getflags(struct fd *fd) {
    int flags = fcntl(fd->real_fd, 
# 453 "project/ish/fs/real.c" 3 4
                                  3
# 453 "project/ish/fs/real.c"
                                         );
    if (flags < 0)
        return errno_map();
...
int realfs_setflags(struct fd *fd, dword_t flags) {
    int ret = fcntl(fd->real_fd, 
# 460 "project/ish/fs/real.c" 3 4
                                4
# 460 "project/ish/fs/real.c"
                                       , open_flags_real_from_fake(flags));
    if (ret < 0)
        return errno_map();
    return 0;
}
...
int realfs_ioctl(struct fd *fd, int cmd, void *arg) {
    ...
    switch (cmd) {
        case 0x541b:
            err = ioctl(fd->real_fd, 
# 477 "project/ish/fs/real.c" 3 4
                                    ((__uint32_t)0x40000000 | ((sizeof(int) & 0x1fff) << 16) | ((('f')) << 8) | ((127)))
# 477 "project/ish/fs/real.c"
                                            , &nread);
            if (err < 0)
                return errno_map();
            *(dword_t *) arg = nread;
