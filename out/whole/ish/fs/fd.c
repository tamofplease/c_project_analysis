...
# 8 "project/ish/fs/fd.c" 2

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/inode.h" 1
...
# 35 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/inode.h"
...
# 73 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/inode.h" 3 4
                                                    _Bool 
# 73 "/Users/washi38/University/Labo/c_project_analysis/project/ish/fs/inode.h"
                                                         block);


void file_lock_remove_owned_by(struct fd *fd, void *owner);
# 10 "project/ish/fs/fd.c" 2

struct fd *fd_create(const struct fd_ops *ops) {
    struct fd *fd = malloc(sizeof(struct fd));
    if (fd == 
# 13 "project/ish/fs/fd.c" 3 4
             ((void *)0)
# 13 "project/ish/fs/fd.c"
                 )
        return 
# 14 "project/ish/fs/fd.c" 3 4
              ((void *)0)
# 14 "project/ish/fs/fd.c"
                  ;
    *fd = (struct fd) {};
    fd->ops = ops;
    fd->refcount = 1;
    fd->flags = 0;
    fd->mount = 
# 19 "project/ish/fs/fd.c" 3 4
               ((void *)0)
# 19 "project/ish/fs/fd.c"
                   ;
    fd->offset = 0;
...
struct fdtable *fdtable_new(int size) {
    ...
    if (fdt == 
# 59 "project/ish/fs/fd.c" 3 4
              ((void *)0)
# 59 "project/ish/fs/fd.c"
                  )
        return (void *) (intptr_t) (-12);
    fdt->refcount = 1;
    fdt->size = 0;
    fdt->files = 
# 63 "project/ish/fs/fd.c" 3 4
                ((void *)0)
# 63 "project/ish/fs/fd.c"
                    ;
    fdt->cloexec = 
# 64 "project/ish/fs/fd.c" 3 4
                  ((void *)0)
# 64 "project/ish/fs/fd.c"
                      ;
    lock_init(&fdt->lock);
...
void fdtable_release(struct fdtable *table) {
    __lock(&table->lock, "project/ish/fs/fd.c", 78);
    if (--table->refcount == 0) {
...
# 93 "project/ish/fs/fd.c" 3 4
   (__builtin_expect(!(
# 93 "project/ish/fs/fd.c"
   size > table->size
# 93 "project/ish/fs/fd.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/fs/fd.c", 93, 
# 93 "project/ish/fs/fd.c"
   "size > table->size"
# 93 "project/ish/fs/fd.c" 3 4
   ) : (void)0)
# 93 "project/ish/fs/fd.c"
    ...
    if (files == 
# 96 "project/ish/fs/fd.c" 3 4
                ((void *)0)
# 96 "project/ish/fs/fd.c"
                    )
        return -12;
    
# 98 "project/ish/fs/fd.c" 3 4
   __builtin___memset_chk (
# 98 "project/ish/fs/fd.c"
   files
# 98 "project/ish/fs/fd.c" 3 4
   , 
# 98 "project/ish/fs/fd.c"
   0, sizeof(struct fd *) * size
# 98 "project/ish/fs/fd.c" 3 4
...
# 100 "project/ish/fs/fd.c" 3 4
       __builtin___memcpy_chk (
# 100 "project/ish/fs/fd.c"
       files
# 100 "project/ish/fs/fd.c" 3 4
       , 
# 100 "project/ish/fs/fd.c"
       table->files, sizeof(struct fd *) * table->size
# 100 "project/ish/fs/fd.c" 3 4
       , __builtin_object_size (
# 100 "project/ish/fs/fd.c"
       files
...
# 100 "project/ish/fs/fd.c"
    ...
    bits_t *cloexec = malloc(((((size) - 1) / 8) + 1));
    if (cloexec == 
# 103 "project/ish/fs/fd.c" 3 4
                  ((void *)0)
# 103 "project/ish/fs/fd.c"
                      ) {
        free(files);
        return -12;
    }
    
# 107 "project/ish/fs/fd.c" 3 4
   __builtin___memset_chk (
# 107 "project/ish/fs/fd.c"
   cloexec
# 107 "project/ish/fs/fd.c" 3 4
   , 
# 107 "project/ish/fs/fd.c"
...
# 109 "project/ish/fs/fd.c" 3 4
       __builtin___memcpy_chk (
# 109 "project/ish/fs/fd.c"
       cloexec
# 109 "project/ish/fs/fd.c" 3 4
       , 
# 109 "project/ish/fs/fd.c"
       table->cloexec, ((((table->size) - 1) / 8) + 1)
# 109 "project/ish/fs/fd.c" 3 4
       , __builtin_object_size (
# 109 "project/ish/fs/fd.c"
       cloexec
...
struct fdtable *fdtable_copy(struct fdtable *table) {
    __lock(&table->lock, "project/ish/fs/fd.c", 120);
    int size = table->size;
    struct fdtable *new_table = fdtable_new(size);
    if (((uintptr_t) (new_table) > (uintptr_t) -0xfff)) {
        unlock(&table->lock);
        return new_table;
    }
    
# 127 "project/ish/fs/fd.c" 3 4
   __builtin___memcpy_chk (
# 127 "project/ish/fs/fd.c"
   new_table->files
# 127 "project/ish/fs/fd.c" 3 4
   , 
# 127 "project/ish/fs/fd.c"
   table->files, sizeof(struct fd *) * size
# 127 "project/ish/fs/fd.c" 3 4
   , __builtin_object_size (
# 127 "project/ish/fs/fd.c"
   new_table->files
...
# 131 "project/ish/fs/fd.c" 3 4
   __builtin___memcpy_chk (
# 131 "project/ish/fs/fd.c"
   new_table->cloexec
# 131 "project/ish/fs/fd.c" 3 4
   , 
# 131 "project/ish/fs/fd.c"
   table->cloexec, ((((size) - 1) / 8) + 1)
# 131 "project/ish/fs/fd.c" 3 4
   , __builtin_object_size (
# 131 "project/ish/fs/fd.c"
   new_table->cloexec
...
struct fd *fdtable_get(struct fdtable *table, fd_t f) {
    if (f < 0 || (unsigned) f >= current->files->size)
        return 
# 147 "project/ish/fs/fd.c" 3 4
              ((void *)0)
# 147 "project/ish/fs/fd.c"
                  ;
    return table->files[f];
}

struct fd *f_get(fd_t f) {
    __lock(&current->files->lock, "project/ish/fs/fd.c", 152);
...
# 159 "project/ish/fs/fd.c" 3 4
   (__builtin_expect(!(
# 159 "project/ish/fs/fd.c"
   start >= 0
# 159 "project/ish/fs/fd.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/fs/fd.c", 159, 
# 159 "project/ish/fs/fd.c"
   "start >= 0"
# 159 "project/ish/fs/fd.c" 3 4
   ) : (void)0)
# 159 "project/ish/fs/fd.c"
    ...
    for (f = start; (unsigned) f < size; f++)
        if (table->files[f] == 
# 167 "project/ish/fs/fd.c" 3 4
                              ((void *)0)
# 167 "project/ish/fs/fd.c"
                                  )
            break;
    if ((unsigned) f >= size) {
...
fd_t f_install(struct fd *fd, int flags) {
    __lock(&current->files->lock, "project/ish/fs/fd.c", 185);
...
static int fdtable_close(struct fdtable *table, fd_t f) {
    ...
    if (fd == 
# 199 "project/ish/fs/fd.c" 3 4
             ((void *)0)
# 199 "project/ish/fs/fd.c"
                 )
        return -9;
    if (fd->inode != 
# 201 "project/ish/fs/fd.c" 3 4
                    ((void *)0)
# 201 "project/ish/fs/fd.c"
                        )
        file_lock_remove_owned_by(fd, table);
    int err = fd_close(fd);
    table->files[f] = 
# 204 "project/ish/fs/fd.c" 3 4
                     ((void *)0)
# 204 "project/ish/fs/fd.c"
                         ;
    bit_clear(f, table->cloexec);
    return err;
}
...
int f_close(fd_t f) {
    __lock(&current->files->lock, "project/ish/fs/fd.c", 210);
...
void fdtable_do_cloexec(struct fdtable *table) {
    __lock(&table->lock, "project/ish/fs/fd.c", 222);
    for (fd_t f = 0; (unsigned) f < table->size; f++)
...
dword_t sys_dup(fd_t f) {
    ...
    if (fd == 
# 247 "project/ish/fs/fd.c" 3 4
             ((void *)0)
# 247 "project/ish/fs/fd.c"
                 )
        return -9;
    fd->refcount++;
...
dword_t sys_dup3(fd_t f, fd_t new_f, int_t flags) {
    __use(0, f, new_f, flags);
    struct fdtable *table = current->files;
    struct fd *fd = f_get(f);
    if (fd == 
# 257 "project/ish/fs/fd.c" 3 4
             ((void *)0)
# 257 "project/ish/fs/fd.c"
                 )
        return -9;
...
int fd_setflags(struct fd *fd, int flags) {
    ...
    fd->flags = (fd->flags & ~((1 << 10) | (1 << 11))) | (flags & ((1 << 10) | (1 << 11)));
    return 0;
}
...
dword_t sys_fcntl(fd_t f, dword_t cmd, dword_t arg) {
    ...
    struct fd *fd = f_get(f);
    if (fd == 
# 291 "project/ish/fs/fd.c" 3 4
             ((void *)0)
# 291 "project/ish/fs/fd.c"
                 )
        return -9;
    ...
    switch (cmd) {
        ...
        case 7:
            ...
            flock.len = flock32.len;
            flock.pid = flock32.pid;
            return fcntl_setlk(fd, &flock, cmd == 14);
        ...
        case 14:
            ...
            if (user_read(arg, &flock, sizeof(flock)))
                return -14;
            return fcntl_setlk(fd, &flock, cmd == 7);
