...
void helper_rdtsc(struct cpu_state *cpu) {
    struct timespec now;
    clock_gettime(
# 11 "project/ish/jit/helpers.c" 3 4
                 _CLOCK_MONOTONIC
# 11 "project/ish/jit/helpers.c"
                                , &now);
