...
# 4 "/Users/washi38/University/Labo/c_project_analysis/project/ish/jit/jit.h" 2
...
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/ish/jit/jit.h" 2
...
# 6 "/Users/washi38/University/Labo/c_project_analysis/project/ish/jit/jit.h" 2
...
# 7 "/Users/washi38/University/Labo/c_project_analysis/project/ish/jit/jit.h" 2
# 4 "project/ish/jit/jit.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/ish/jit/gen.h" 1
...
# 6 "/Users/washi38/University/Labo/c_project_analysis/project/ish/jit/gen.h" 2
...
# 5 "project/ish/jit/jit.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/ish/jit/frame.h" 1
...
# 2 "/Users/washi38/University/Labo/c_project_analysis/project/ish/jit/frame.h" 2
...
void jit_free(struct jit *jit) {
    for (size_t i = 0; i < jit->hash_size; i++) {
        ...
        if (list_null(&jit->hash[i]))
            continue;
        for (block = ((typeof(*(block)) *) ((char *) ((&jit->hash[i])->next) - 
# 34 "project/ish/jit/jit.c" 3 4
       __builtin_offsetof (
# 34 "project/ish/jit/jit.c"
       typeof(*(block))
# 34 "project/ish/jit/jit.c" 3 4
       , 
# 34 "project/ish/jit/jit.c"
...
# 34 "project/ish/jit/jit.c"
       )), tmp = ((typeof(*(block)) *) ((char *) ((block)->chain.next) - 
# 34 "project/ish/jit/jit.c" 3 4
       __builtin_offsetof (
# 34 "project/ish/jit/jit.c"
       typeof(*(block))
...
# 34 "project/ish/jit/jit.c"
       )); &block->chain != (&jit->hash[i]); block = tmp, tmp = ((typeof(*(block)) *) ((char *) ((block)->chain.next) - 
# 34 "project/ish/jit/jit.c" 3 4
       __builtin_offsetof (
# 34 "project/ish/jit/jit.c"
       typeof(*(block))
...
void jit_invalidate_range(struct jit *jit, page_t start, page_t end) {
    __lock(&jit->lock, "project/ish/jit/jit.c", 49);
    struct jit_block *block, *tmp;
    for (page_t page = start; page < end; page++) {
        for (int i = 0; i <= 1; i++) {
            ...
            if (list_null(blocks))
                continue;
            for (block = ((typeof(*(block)) *) ((char *) ((blocks)->next) - 
# 56 "project/ish/jit/jit.c" 3 4
           __builtin_offsetof (
# 56 "project/ish/jit/jit.c"
           typeof(*(block))
# 56 "project/ish/jit/jit.c" 3 4
           , 
# 56 "project/ish/jit/jit.c"
...
# 56 "project/ish/jit/jit.c"
           )), tmp = ((typeof(*(block)) *) ((char *) ((block)->page[i].next) - 
# 56 "project/ish/jit/jit.c" 3 4
           __builtin_offsetof (
# 56 "project/ish/jit/jit.c"
           typeof(*(block))
...
# 56 "project/ish/jit/jit.c"
           )); &block->page[i] != (blocks); block = tmp, tmp = ((typeof(*(block)) *) ((char *) ((block)->page[i].next) - 
# 56 "project/ish/jit/jit.c" 3 4
           __builtin_offsetof (
# 56 "project/ish/jit/jit.c"
           typeof(*(block))
...
# 56 "project/ish/jit/jit.c"
                ...
                block->is_jetsam = 
# 58 "project/ish/jit/jit.c" 3 4
                                  1
# 58 "project/ish/jit/jit.c"
                                      ;
...
void jit_invalidate_all(struct jit *jit) {
    jit_invalidate_range(jit, 0, (1 << 20));
}

static void jit_resize_hash(struct jit *jit, size_t new_size) {
    __use(0, current_pid(), new_size, jit->mem_used);
    ...
    for (size_t i = 0; i < jit->hash_size; i++) {
        ...
        struct jit_block *block, *tmp;
        for (block = ((typeof(*(block)) *) ((char *) ((&jit->hash[i])->next) - 
# 80 "project/ish/jit/jit.c" 3 4
       __builtin_offsetof (
# 80 "project/ish/jit/jit.c"
       typeof(*(block))
# 80 "project/ish/jit/jit.c" 3 4
       , 
# 80 "project/ish/jit/jit.c"
...
static void jit_insert(struct jit *jit, struct jit_block *block) {
    ...
    list_init_add(blocks_list(jit, ((block->addr) >> 12), 0), &block->page[0]);
    if (((block->addr) >> 12) != ((block->end_addr) >> 12))
        list_init_add(blocks_list(jit, ((block->end_addr) >> 12), 1), &block->page[1]);
}
...
static struct jit_block *jit_lookup(struct jit *jit, addr_t addr) {
    ...
    if (list_null(bucket))
        return 
# 106 "project/ish/jit/jit.c" 3 4
              ((void *)0)
# 106 "project/ish/jit/jit.c"
                  ;
    struct jit_block *block;
    for (block = ((typeof(*block) *) ((char *) ((bucket)->next) - 
# 108 "project/ish/jit/jit.c" 3 4
   __builtin_offsetof (
# 108 "project/ish/jit/jit.c"
   typeof(*block)
# 108 "project/ish/jit/jit.c" 3 4
   , 
# 108 "project/ish/jit/jit.c"
...
# 108 "project/ish/jit/jit.c"
   )); &block->chain != (bucket); block = ((typeof(*block) *) ((char *) (block->chain.next) - 
# 108 "project/ish/jit/jit.c" 3 4
   __builtin_offsetof (
# 108 "project/ish/jit/jit.c"
   typeof(*block)
...
# 108 "project/ish/jit/jit.c"
    ...
    return 
# 112 "project/ish/jit/jit.c" 3 4
          ((void *)0)
# 112 "project/ish/jit/jit.c"
              ;
}

static struct jit_block *jit_block_compile(addr_t ip, struct tlb *tlb) {
    struct gen_state state;
    __use(0, current_pid(), ip);
    gen_start(ip, &state);
    while (
# 119 "project/ish/jit/jit.c" 3 4
          1
# 119 "project/ish/jit/jit.c"
              ) {
...
# 133 "project/ish/jit/jit.c" 3 4
   (__builtin_expect(!(
# 133 "project/ish/jit/jit.c"
   state.ip - ip <= (1 << 12)
# 133 "project/ish/jit/jit.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/jit/jit.c", 133, 
# 133 "project/ish/jit/jit.c"
   "state.ip - ip <= PAGE_SIZE"
# 133 "project/ish/jit/jit.c" 3 4
   ) : (void)0)
# 133 "project/ish/jit/jit.c"
                                     ;
...
static void jit_block_disconnect(struct jit *jit, struct jit_block *block) {
    if (jit != 
# 141 "project/ish/jit/jit.c" 3 4
              ((void *)0)
# 141 "project/ish/jit/jit.c"
                  ) {
        jit->mem_used -= block->used;
        jit->num_blocks--;
    }
    ...
    for (int i = 0; i <= 1; i++) {
        ...
        for (prev_block = ((typeof(*(prev_block)) *) ((char *) ((&block->jumps_from[i])->next) - 
# 151 "project/ish/jit/jit.c" 3 4
       __builtin_offsetof (
# 151 "project/ish/jit/jit.c"
       typeof(*(prev_block))
# 151 "project/ish/jit/jit.c" 3 4
       , 
# 151 "project/ish/jit/jit.c"
...
# 151 "project/ish/jit/jit.c"
       )), tmp = ((typeof(*(prev_block)) *) ((char *) ((prev_block)->jumps_from_links[i].next) - 
# 151 "project/ish/jit/jit.c" 3 4
       __builtin_offsetof (
# 151 "project/ish/jit/jit.c"
       typeof(*(prev_block))
...
# 151 "project/ish/jit/jit.c"
       )); &prev_block->jumps_from_links[i] != (&block->jumps_from[i]); prev_block = tmp, tmp = ((typeof(*(prev_block)) *) ((char *) ((prev_block)->jumps_from_links[i].next) - 
# 151 "project/ish/jit/jit.c" 3 4
       __builtin_offsetof (
# 151 "project/ish/jit/jit.c"
       typeof(*(prev_block))
...
# 151 "project/ish/jit/jit.c"
            ...
            if (prev_block->jump_ip[i] != 
# 152 "project/ish/jit/jit.c" 3 4
                                         ((void *)0)
# 152 "project/ish/jit/jit.c"
                                             )
...
static void jit_free_jetsam(struct jit *jit) {
    struct jit_block *block, *tmp;
    for (block = ((typeof(*(block)) *) ((char *) ((&jit->jetsam)->next) - 
# 166 "project/ish/jit/jit.c" 3 4
   __builtin_offsetof (
# 166 "project/ish/jit/jit.c"
   typeof(*(block))
# 166 "project/ish/jit/jit.c" 3 4
   , 
# 166 "project/ish/jit/jit.c"
...
# 166 "project/ish/jit/jit.c"
   )), tmp = ((typeof(*(block)) *) ((char *) ((block)->jetsam.next) - 
# 166 "project/ish/jit/jit.c" 3 4
   __builtin_offsetof (
# 166 "project/ish/jit/jit.c"
   typeof(*(block))
...
# 166 "project/ish/jit/jit.c"
   )); &block->jetsam != (&jit->jetsam); block = tmp, tmp = ((typeof(*(block)) *) ((char *) ((block)->jetsam.next) - 
# 166 "project/ish/jit/jit.c" 3 4
   __builtin_offsetof (
# 166 "project/ish/jit/jit.c"
   typeof(*(block))
...
# 184 "project/ish/jit/jit.c" 3 4
   __builtin___memset_chk (
# 184 "project/ish/jit/jit.c"
   frame
# 184 "project/ish/jit/jit.c" 3 4
   , 
# 184 "project/ish/jit/jit.c"
...
# 186 "project/ish/jit/jit.c" 3 4
   (__builtin_expect(!(
# 186 "project/ish/jit/jit.c"
   jit->mmu == cpu->mmu
# 186 "project/ish/jit/jit.c" 3 4
   ), 0) ? __assert_rtn(__func__, "project/ish/jit/jit.c", 186, 
# 186 "project/ish/jit/jit.c"
   "jit->mmu == cpu->mmu"
# 186 "project/ish/jit/jit.c" 3 4
   ) : (void)0)
# 186 "project/ish/jit/jit.c"
    ...
    while (interrupt == -1) {
        ...
        if (block == 
# 193 "project/ish/jit/jit.c" 3 4
                    ((void *)0) 
# 193 "project/ish/jit/jit.c"
                         || block->addr != ip) {
            __lock(&jit->lock, "project/ish/jit/jit.c", 194);
            block = jit_lookup(jit, ip);
            if (block == 
# 196 "project/ish/jit/jit.c" 3 4
                        ((void *)0)
# 196 "project/ish/jit/jit.c"
                            ) {
        ...
        if (last_block != 
# 206 "project/ish/jit/jit.c" 3 4
                         ((void *)0) 
# 206 "project/ish/jit/jit.c"
                              &&
                (last_block->jump_ip[0] != 
# 207 "project/ish/jit/jit.c" 3 4
                                          ((void *)0) 
# 207 "project/ish/jit/jit.c"
                                               ||
                 last_block->jump_ip[1] != 
# 208 "project/ish/jit/jit.c" 3 4
                                          ((void *)0)
# 208 "project/ish/jit/jit.c"
                                              )) {
            __lock(&jit->lock, "project/ish/jit/jit.c", 209);


            if (!last_block->is_jetsam && !block->is_jetsam) {
                for (int i = 0; i <= 1; i++) {
                    if (last_block->jump_ip[i] != 
# 214 "project/ish/jit/jit.c" 3 4
                                                 ((void *)0) 
# 214 "project/ish/jit/jit.c"
                                                      &&
        ...
        __use(0, current_pid(), ip, frame->cpu.cycle);

        interrupt = jit_enter(block, frame, tlb);
        if (interrupt == -1 && ++frame->cpu.cycle % (1 << 10) == 0)
            interrupt = 32;
        *cpu = frame->cpu;
    }
...
static int cpu_single_step(struct cpu_state *cpu, struct tlb *tlb) {
    ...
    *cpu = frame.cpu;
    jit_block_free(
# 254 "project/ish/jit/jit.c" 3 4
                  ((void *)0)
# 254 "project/ish/jit/jit.c"
                      , block);
    if (interrupt == -1)
        interrupt = 1;
    return interrupt;
...
int cpu_run_to_interrupt(struct cpu_state *cpu, struct tlb *tlb) {
    ...
    struct jit *jit = cpu->mmu->jit;
    __lock(&jit->lock, "project/ish/jit/jit.c", 266);
    if (!list_empty(&jit->jetsam)) {



        unlock(&jit->lock);
        __write_wrlock(&jit->jetsam_lock, "project/ish/jit/jit.c", 272);
        __lock(&jit->lock, "project/ish/jit/jit.c", 273);
        jit_free_jetsam(jit);
