# 0 "project/goaccess/src/geoip1.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 40 "project/goaccess/src/geoip1.c"
# 1 "project/goaccess/src/geoip1.h" 1
# 35 "project/goaccess/src/geoip1.h"
...
# 38 "project/goaccess/src/geoip1.h" 2
...
# 41 "project/goaccess/src/geoip1.c" 2
...
# 43 "project/goaccess/src/geoip1.c" 2
...
# 44 "project/goaccess/src/geoip1.c" 2
...
# 53 "project/goaccess/src/geoip1.c" 3 4
                             ((void *)0) 
# 53 "project/goaccess/src/geoip1.c"
                                  ? 1 : 0;
}
...
geoip_open_db (const char *db) {
  ...
  if (geoip == 
# 75 "project/goaccess/src/geoip1.c" 3 4
              ((void *)0)
# 75 "project/goaccess/src/geoip1.c"
                  )
    do { (void) endwin (); fprintf (stderr, "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "15:28:50"); fprintf (stderr, "Config file: %s\n", conf.iconfigfile ?: "No config file used"); fprintf (stderr, "\nFatal error has occurred"); fprintf (stderr, "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/geoip1.c", __FUNCTION__, 76); fprintf (stderr, "Unable to open GeoIP database: %s\n", db); fprintf (stderr, "\n\n"); do { dbg_fprintf ("Unable to open GeoIP database: %s\n", db); } while (0); exit(EXIT_FAILURE); } while (0);

  GeoIP_set_charset (geoip, GEOIP_CHARSET_UTF8);
  do { dbg_fprintf ("Opened GeoIP City database: %s\n", db); } while (0);
...
# 88 "project/goaccess/src/geoip1.c" 3 4
                            ((void *)0)
# 88 "project/goaccess/src/geoip1.c"
                                )
...
ip4to6 (const char *ipv4) {
  ...
  return 
# 105 "project/goaccess/src/geoip1.c" 3 4
        ((void *)0)
# 105 "project/goaccess/src/geoip1.c"
            ;
}
...
geoip_set_country (const char *country, const char *code, char *loc) {
  if (country && code)
    snprintf (loc, 48 + 3, "%s %s", code, country);
  else
    snprintf (loc, 48 + 3, "%s", "Unknown");
}
...
geoip_set_city (const char *city, const char *region, char *loc) {
  snprintf (loc, 47 + 1, "%s, %s", city ? city : "N/A City", region ? region : "N/A Region");
}
...
geoip_set_continent (const char *continent, char *loc) {
  if (continent)
    snprintf (loc, 47 + 1, "%s", get_continent_name_and_code (continent));
  else
    snprintf (loc, 47 + 1, "%s", "Unknown");
}
...
get_geoip_record (const char *addr, GTypeIP type_ip) {
  GeoIPRecord *rec = 
# 166 "project/goaccess/src/geoip1.c" 3 4
                    ((void *)0)
# 166 "project/goaccess/src/geoip1.c"
                        ;
...
geoip_set_country_by_record (const char *ip, char *location, GTypeIP type_ip) {
  GeoIPRecord *rec = 
# 180 "project/goaccess/src/geoip1.c" 3 4
                    ((void *)0)
# 180 "project/goaccess/src/geoip1.c"
                        ;
  const char *country = 
# 181 "project/goaccess/src/geoip1.c" 3 4
                       ((void *)0)
# 181 "project/goaccess/src/geoip1.c"
                           , *code = 
# 181 "project/goaccess/src/geoip1.c" 3 4
                                     ((void *)0)
# 181 "project/goaccess/src/geoip1.c"
  ...
  if (conf.geoip_database == 
# 183 "project/goaccess/src/geoip1.c" 3 4
                            ((void *)0) 
# 183 "project/goaccess/src/geoip1.c"
                                 || geo_location_data == 
# 183 "project/goaccess/src/geoip1.c" 3 4
                                                         ((void *)0)
# 183 "project/goaccess/src/geoip1.c"
  ...
  if (rec != 
# 193 "project/goaccess/src/geoip1.c" 3 4
            ((void *)0)
# 193 "project/goaccess/src/geoip1.c"
                ) {
...
geoip_get_country_by_geoid (const char *addr, GTypeIP type_ip) {
  const char *country = 
# 220 "project/goaccess/src/geoip1.c" 3 4
                       ((void *)0)
# 220 "project/goaccess/src/geoip1.c"
                           ;
...
geoip_set_country_by_geoid (const char *ip, char *location, GTypeIP type_ip) {
  const char *country = 
# 234 "project/goaccess/src/geoip1.c" 3 4
                       ((void *)0)
# 234 "project/goaccess/src/geoip1.c"
                           , *code = 
# 234 "project/goaccess/src/geoip1.c" 3 4
                                     ((void *)0)
# 234 "project/goaccess/src/geoip1.c"
...
geoip_get_country (const char *ip, char *location, GTypeIP type_ip) {
  ...
  case GEOIP_COUNTRY_EDITION:
    if (TYPE_IPV4 == type_ip)
      ...
      geoip_set_country (
# 263 "project/goaccess/src/geoip1.c" 3 4
                        ((void *)0)
# 263 "project/goaccess/src/geoip1.c"
                            , 
# 263 "project/goaccess/src/geoip1.c" 3 4
                              ((void *)0)
# 263 "project/goaccess/src/geoip1.c"
  ...
  case GEOIP_COUNTRY_EDITION_V6:
    if (TYPE_IPV6 == type_ip)
      ...
      if (ipv6)
        ...
        geoip_set_country (
# 273 "project/goaccess/src/geoip1.c" 3 4
                          ((void *)0)
# 273 "project/goaccess/src/geoip1.c"
                              , 
# 273 "project/goaccess/src/geoip1.c" 3 4
                                ((void *)0)
# 273 "project/goaccess/src/geoip1.c"
  ...
  case GEOIP_CITY_EDITION_REV1:
    if (TYPE_IPV4 == type_ip)
      ...
      geoip_set_country (
# 281 "project/goaccess/src/geoip1.c" 3 4
                        ((void *)0)
# 281 "project/goaccess/src/geoip1.c"
                            , 
# 281 "project/goaccess/src/geoip1.c" 3 4
                              ((void *)0)
# 281 "project/goaccess/src/geoip1.c"
  ...
  case GEOIP_CITY_EDITION_REV1_V6:
    if (TYPE_IPV6 == type_ip)
      ...
      if (ipv6)
        ...
        geoip_set_country (
# 292 "project/goaccess/src/geoip1.c" 3 4
                          ((void *)0)
# 292 "project/goaccess/src/geoip1.c"
                              , 
# 292 "project/goaccess/src/geoip1.c" 3 4
                                ((void *)0)
# 292 "project/goaccess/src/geoip1.c"
...
geoip_set_continent_by_record (const char *ip, char *location, GTypeIP type_ip) {
  GeoIPRecord *rec = 
# 302 "project/goaccess/src/geoip1.c" 3 4
                    ((void *)0)
# 302 "project/goaccess/src/geoip1.c"
                        ;
  const char *continent = 
# 303 "project/goaccess/src/geoip1.c" 3 4
                         ((void *)0)
# 303 "project/goaccess/src/geoip1.c"
                             , *addr = ip;

  if (conf.geoip_database == 
# 305 "project/goaccess/src/geoip1.c" 3 4
                            ((void *)0) 
# 305 "project/goaccess/src/geoip1.c"
                                 || geo_location_data == 
# 305 "project/goaccess/src/geoip1.c" 3 4
                                                         ((void *)0)
# 305 "project/goaccess/src/geoip1.c"
  ...
  if (rec != 
# 313 "project/goaccess/src/geoip1.c" 3 4
            ((void *)0)
# 313 "project/goaccess/src/geoip1.c"
                ) {
    GeoIPRecord_delete (rec);
  }
}
...
geoip_set_continent_by_geoid (const char *ip, char *location, GTypeIP type_ip) {
  const char *continent = 
# 322 "project/goaccess/src/geoip1.c" 3 4
                         ((void *)0)
# 322 "project/goaccess/src/geoip1.c"
                             , *addr = ip;
  int geoid = 0;
...
geoip_get_continent (const char *ip, char *location, GTypeIP type_ip) {
  ...
  case GEOIP_COUNTRY_EDITION:
    if (TYPE_IPV4 == type_ip)
      ...
      geoip_set_continent (
# 347 "project/goaccess/src/geoip1.c" 3 4
                          ((void *)0)
# 347 "project/goaccess/src/geoip1.c"
                              , location);
    break;
  case GEOIP_COUNTRY_EDITION_V6:
    if (TYPE_IPV6 == type_ip)
      ...
      if (ipv6)
        ...
        geoip_set_continent (
# 357 "project/goaccess/src/geoip1.c" 3 4
                            ((void *)0)
# 357 "project/goaccess/src/geoip1.c"
                                , location);
    }
    break;
  case GEOIP_CITY_EDITION_REV0:
  case GEOIP_CITY_EDITION_REV1:
    if (TYPE_IPV4 == type_ip)
      ...
      geoip_set_continent (
# 365 "project/goaccess/src/geoip1.c" 3 4
                          ((void *)0)
# 365 "project/goaccess/src/geoip1.c"
                              , location);
    break;
  case GEOIP_CITY_EDITION_REV0_V6:
  case GEOIP_CITY_EDITION_REV1_V6:
    if (TYPE_IPV6 == type_ip)
      ...
      if (ipv6)
        ...
        geoip_set_continent (
# 376 "project/goaccess/src/geoip1.c" 3 4
                            ((void *)0)
# 376 "project/goaccess/src/geoip1.c"
                                , location);
    }
    break;
  }
...
geoip_set_city_by_record (const char *ip, char *location, GTypeIP type_ip) {
  GeoIPRecord *rec = 
# 386 "project/goaccess/src/geoip1.c" 3 4
                    ((void *)0)
# 386 "project/goaccess/src/geoip1.c"
                        ;
  const char *city = 
# 387 "project/goaccess/src/geoip1.c" 3 4
                    ((void *)0)
# 387 "project/goaccess/src/geoip1.c"
                        , *region = 
# 387 "project/goaccess/src/geoip1.c" 3 4
                                    ((void *)0)
# 387 "project/goaccess/src/geoip1.c"
  ...
  if (rec != 
# 396 "project/goaccess/src/geoip1.c" 3 4
            ((void *)0)
# 396 "project/goaccess/src/geoip1.c"
                ) {
    GeoIPRecord_delete (rec);
  }
}
...
geoip_get_city (const char *ip, char *location, GTypeIP type_ip) {
  ...
  if (conf.geoip_database == 
# 408 "project/goaccess/src/geoip1.c" 3 4
                            ((void *)0) 
# 408 "project/goaccess/src/geoip1.c"
                                 || geo_location_data == 
# 408 "project/goaccess/src/geoip1.c" 3 4
                                                         ((void *)0)
# 408 "project/goaccess/src/geoip1.c"
  ...
  case GEOIP_CITY_EDITION_REV1:
    if (TYPE_IPV4 == type_ip)
      ...
      geoip_set_city (
# 417 "project/goaccess/src/geoip1.c" 3 4
                     ((void *)0)
# 417 "project/goaccess/src/geoip1.c"
                         , 
# 417 "project/goaccess/src/geoip1.c" 3 4
                           ((void *)0)
# 417 "project/goaccess/src/geoip1.c"
  ...
  case GEOIP_CITY_EDITION_REV1_V6:
    if (TYPE_IPV6 == type_ip)
      ...
      if (ipv6)
        ...
        geoip_set_city (
# 428 "project/goaccess/src/geoip1.c" 3 4
                       ((void *)0)
# 428 "project/goaccess/src/geoip1.c"
                           , 
# 428 "project/goaccess/src/geoip1.c" 3 4
                             ((void *)0)
# 428 "project/goaccess/src/geoip1.c"
