# 0 "project/goaccess/src/bin2c.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/goaccess/src/bin2c.c"
# 12 "project/goaccess/src/bin2c.c"
...
# 13 "project/goaccess/src/bin2c.c" 2
...
# 14 "project/goaccess/src/bin2c.c" 2
...
# 15 "project/goaccess/src/bin2c.c" 2
...
# 16 "project/goaccess/src/bin2c.c" 2
...
# 21 "project/goaccess/src/bin2c.c"
int
main (int argc, char *argv[]) {
  ...
  if (argc < 4) {
    fprintf (
# 37 "project/goaccess/src/bin2c.c" 3 4
            __stderrp
# 37 "project/goaccess/src/bin2c.c"
                  , "Usage: %s binary_file output_file array_name\n", argv[0]);
    return -1;
  }

  f_input = fopen (argv[1], "rb");
  if (f_input == 
# 42 "project/goaccess/src/bin2c.c" 3 4
                ((void *)0)
# 42 "project/goaccess/src/bin2c.c"
                    ) {
    fprintf (
# 43 "project/goaccess/src/bin2c.c" 3 4
            __stderrp
# 43 "project/goaccess/src/bin2c.c"
                  , "%s: can't open %s for reading\n", argv[0], argv[1]);
    return -1;
  }

  fseek (f_input, 0, 
# 47 "project/goaccess/src/bin2c.c" 3 4
                    2
# 47 "project/goaccess/src/bin2c.c"
                            );
  file_size_orig = ftell (f_input);
  if (file_size_orig < 0) {
    fprintf (
# 50 "project/goaccess/src/bin2c.c" 3 4
            __stderrp
# 50 "project/goaccess/src/bin2c.c"
                  , "%s: can't get size of file %s\n", argv[0], argv[1]);
    fclose (f_input);
    return -1;
  }
  file_size = (size_t) file_size_orig;
  fseek (f_input, 0, 
# 55 "project/goaccess/src/bin2c.c" 3 4
                    0
# 55 "project/goaccess/src/bin2c.c"
                            );

  if ((buf = malloc (file_size)) == 
# 57 "project/goaccess/src/bin2c.c" 3 4
                                   ((void *)0)
# 57 "project/goaccess/src/bin2c.c"
                                       ) {
    fprintf (
# 58 "project/goaccess/src/bin2c.c" 3 4
            __stderrp
# 58 "project/goaccess/src/bin2c.c"
                  , "Unable to malloc bin2c.c buffer\n");
    fclose (f_input);
    return -1;
  }
  ...
  if (fread (buf, file_size, 1, f_input) != 1) {
    fprintf (
# 64 "project/goaccess/src/bin2c.c" 3 4
            __stderrp
# 64 "project/goaccess/src/bin2c.c"
                  , "%s: can't read from %s\n", argv[0], argv[1]);
    free (buf);
    fclose (f_input);
    return -1;
  ...
  if (fgetc (f_input) != 
# 70 "project/goaccess/src/bin2c.c" 3 4
                        (-1)
# 70 "project/goaccess/src/bin2c.c"
                           ) {
    fprintf (
# 71 "project/goaccess/src/bin2c.c" 3 4
            __stderrp
# 71 "project/goaccess/src/bin2c.c"
                  , "%s: can't read complete file %s\n", argv[0], argv[1]);
    free (buf);
    fclose (f_input);
    return -1;
  }
  ...
  if (ferror (f_input)) {
    fprintf (
# 78 "project/goaccess/src/bin2c.c" 3 4
            __stderrp
# 78 "project/goaccess/src/bin2c.c"
                  , "%s: error while reading from %s\n", argv[0], argv[1]);
    free (buf);
    fclose (f_input);
    return -1;
  }
  ...
  fclose (f_input);
# 110 "project/goaccess/src/bin2c.c"
  f_output = fopen (argv[2], "w");
  if (f_output == 
# 111 "project/goaccess/src/bin2c.c" 3 4
                 ((void *)0)
# 111 "project/goaccess/src/bin2c.c"
                     ) {
    fprintf (
# 112 "project/goaccess/src/bin2c.c" 3 4
            __stderrp
# 112 "project/goaccess/src/bin2c.c"
  ...
  for (i = 0; i < file_size; ++i) {
    if (buf[i] == '\0') {
      fprintf (
# 123 "project/goaccess/src/bin2c.c" 3 4
              __stderrp
# 123 "project/goaccess/src/bin2c.c"
                    ,
  ...
  if (ferror (f_output)) {
    fprintf (
# 145 "project/goaccess/src/bin2c.c" 3 4
            __stderrp
# 145 "project/goaccess/src/bin2c.c"
