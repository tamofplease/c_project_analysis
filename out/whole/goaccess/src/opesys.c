# 0 "project/goaccess/src/opesys.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 32 "project/goaccess/src/opesys.c" 2
...
# 33 "project/goaccess/src/opesys.c" 2
...
# 34 "project/goaccess/src/opesys.c" 2
...
# 35 "project/goaccess/src/opesys.c" 2
...
# 36 "project/goaccess/src/opesys.c" 2
...
# 37 "project/goaccess/src/opesys.c" 2

# 1 "project/goaccess/src/opesys.h" 1
# 31 "project/goaccess/src/opesys.h"
...
# 36 "project/goaccess/src/opesys.h"
...
# 39 "project/goaccess/src/opesys.c" 2
...
# 41 "project/goaccess/src/opesys.c" 2
...
# 43 "project/goaccess/src/opesys.c" 2
...
# 44 "project/goaccess/src/opesys.c" 2
...
get_real_win (const char *win) {
  ...
  return 
# 206 "project/goaccess/src/opesys.c" 3 4
        ((void *)0)
# 206 "project/goaccess/src/opesys.c"
            ;
}
...
parse_ios (char *agent, int tlen) {
  char *p = 
# 283 "project/goaccess/src/opesys.c" 3 4
           ((void *)0)
# 283 "project/goaccess/src/opesys.c"
               , *q = 
# 283 "project/goaccess/src/opesys.c" 3 4
                      ((void *)0)
# 283 "project/goaccess/src/opesys.c"
  ...
  if ((p = strstr (agent, " OS ")) == 
# 286 "project/goaccess/src/opesys.c" 3 4
                                     ((void *)0)
# 286 "project/goaccess/src/opesys.c"
                                         )
    goto out;
  ...
  if ((q = strstr (p, " like Mac")) == 
# 292 "project/goaccess/src/opesys.c" 3 4
                                      ((void *)0)
# 292 "project/goaccess/src/opesys.c"
                                          )
    goto out;

  *q = 0;
  
# 296 "project/goaccess/src/opesys.c" 3 4
 __builtin___memmove_chk (
# 296 "project/goaccess/src/opesys.c"
 agent + tlen
# 296 "project/goaccess/src/opesys.c" 3 4
 , 
# 296 "project/goaccess/src/opesys.c"
...
parse_os (const char *str, char *tkn, char *os_type, int idx) {
  ...
  xstrncpy (os_type, os[idx][1], 10);

  if ((strstr (str, "Windows")) != 
# 355 "project/goaccess/src/opesys.c" 3 4
                                  ((void *)0)
# 355 "project/goaccess/src/opesys.c"
                                      )
    return conf.real_os && (b = get_real_win (tkn)) ? b : xstrdup (os[idx][0]);

  if ((strstr (tkn, "Android")) != 
# 358 "project/goaccess/src/opesys.c" 3 4
                                  ((void *)0)
# 358 "project/goaccess/src/opesys.c"
                                      ) {
    tkn = parse_android (tkn);
    return conf.real_os ? get_real_android (tkn) : xstrdup (tkn);
  }

  if ((strstr (tkn, "CFNetwork")) != 
# 363 "project/goaccess/src/opesys.c" 3 4
                                    ((void *)0)
# 363 "project/goaccess/src/opesys.c"
                                        ) {
    if ((b = strchr (str, ' ')))
      *b = 0;
    return xstrdup (str);
  ...
  if ((strstr (tkn, "OS X")) != 
# 373 "project/goaccess/src/opesys.c" 3 4
                               ((void *)0)
# 373 "project/goaccess/src/opesys.c"
                                   ) {
    tkn = parse_osx (tkn);
  ...
  if ((strstr (tkn, "Darwin")) != 
# 379 "project/goaccess/src/opesys.c" 3 4
                                 ((void *)0)
# 379 "project/goaccess/src/opesys.c"
                                     ) {
    if ((b = strchr (str, ' ')))
      *b = 0;
    return xstrdup (str);
...
verify_os (const char *str, char *os_type) {
  ...
  if (str == 
# 402 "project/goaccess/src/opesys.c" 3 4
            ((void *)0) 
# 402 "project/goaccess/src/opesys.c"
                 || *str == '\0')
    return 
# 403 "project/goaccess/src/opesys.c" 3 4
          ((void *)0)
# 403 "project/goaccess/src/opesys.c"
              ;

  for (i = 0; i < (sizeof(os) / sizeof(os[0])); i++) {
    if ((a = strstr (str, os[i][0])) != 
# 406 "project/goaccess/src/opesys.c" 3 4
                                       ((void *)0)
# 406 "project/goaccess/src/opesys.c"
                                           )
      return parse_os (str, a, os_type, i);
  }
  xstrncpy (os_type, "Unknown", 10);
