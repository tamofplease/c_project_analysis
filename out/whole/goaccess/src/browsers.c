# 0 "project/goaccess/src/browsers.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 32 "project/goaccess/src/browsers.c" 2
...
# 33 "project/goaccess/src/browsers.c" 2
...
# 34 "project/goaccess/src/browsers.c" 2
...
# 35 "project/goaccess/src/browsers.c" 2
...
# 36 "project/goaccess/src/browsers.c" 2

# 1 "project/goaccess/src/browsers.h" 1
# 31 "project/goaccess/src/browsers.h"
...
# 38 "project/goaccess/src/browsers.c" 2
...
# 40 "project/goaccess/src/browsers.c" 2
...
# 42 "project/goaccess/src/browsers.c" 2
...
# 43 "project/goaccess/src/browsers.c" 2




static char ***browsers_hash = 
# 47 "project/goaccess/src/browsers.c" 3 4
                              ((void *)0)
# 47 "project/goaccess/src/browsers.c"
                                  ;
...
# 338 "project/goaccess/src/browsers.c" 3 4
   __stderrp
# 338 "project/goaccess/src/browsers.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "15:28:50"); fprintf (
# 338 "project/goaccess/src/browsers.c" 3 4
   __stderrp
# 338 "project/goaccess/src/browsers.c"
...
# 338 "project/goaccess/src/browsers.c" 3 4
   __stderrp
# 338 "project/goaccess/src/browsers.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/browsers.c", __FUNCTION__, 338); fprintf (
# 338 "project/goaccess/src/browsers.c" 3 4
   __stderrp
# 338 "project/goaccess/src/browsers.c"
   , "Malformed browser name at line: %d", n); fprintf (
# 338 "project/goaccess/src/browsers.c" 3 4
   __stderrp
# 338 "project/goaccess/src/browsers.c"
   , "\n\n"); do { dbg_fprintf ("Malformed browser name at line: %d", n); } while (0); exit(
# 338 "project/goaccess/src/browsers.c" 3 4
   1
# 338 "project/goaccess/src/browsers.c"
   ); } while (0);
  ...
  if (strlen (val) == idx)
    do { (void) endwin (); fprintf (
# 346 "project/goaccess/src/browsers.c" 3 4
   __stderrp
# 346 "project/goaccess/src/browsers.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "15:28:50"); fprintf (
# 346 "project/goaccess/src/browsers.c" 3 4
   __stderrp
# 346 "project/goaccess/src/browsers.c"
...
# 346 "project/goaccess/src/browsers.c" 3 4
   __stderrp
# 346 "project/goaccess/src/browsers.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/browsers.c", __FUNCTION__, 346); fprintf (
# 346 "project/goaccess/src/browsers.c" 3 4
   __stderrp
# 346 "project/goaccess/src/browsers.c"
   , "Malformed browser category at line: %d", n); fprintf (
# 346 "project/goaccess/src/browsers.c" 3 4
   __stderrp
# 346 "project/goaccess/src/browsers.c"
   , "\n\n"); do { dbg_fprintf ("Malformed browser category at line: %d", n); } while (0); exit(
# 346 "project/goaccess/src/browsers.c" 3 4
   1
# 346 "project/goaccess/src/browsers.c"
   ); } while (0);
  ...
  if (is_dup (list, conf.browsers_hash_idx, line)) {
    do { invalid_fprintf ("Duplicate browser entry: %s", line); } while (0);
    return;
  }
...
parse_browsers_file (void) {
  ...
  FILE *file;
  int n = 0;
  size_t i, len = (sizeof(browsers) / sizeof(browsers[0]));

  browsers_hash = xmalloc ((sizeof(browsers) / sizeof(browsers[0])) * sizeof (char **));
  ...
  if ((file = fopen (conf.browsers_file, "r")) == 
# 381 "project/goaccess/src/browsers.c" 3 4
                                                 ((void *)0)
# 381 "project/goaccess/src/browsers.c"
                                                     )
    do { (void) endwin (); fprintf (
# 382 "project/goaccess/src/browsers.c" 3 4
   __stderrp
# 382 "project/goaccess/src/browsers.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "15:28:50"); fprintf (
# 382 "project/goaccess/src/browsers.c" 3 4
   __stderrp
# 382 "project/goaccess/src/browsers.c"
...
# 382 "project/goaccess/src/browsers.c" 3 4
   __stderrp
# 382 "project/goaccess/src/browsers.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/browsers.c", __FUNCTION__, 382); fprintf (
# 382 "project/goaccess/src/browsers.c" 3 4
   __stderrp
# 382 "project/goaccess/src/browsers.c"
   , "Unable to open browser's file: %s", strerror (
# 382 "project/goaccess/src/browsers.c" 3 4
   (*__error())
# 382 "project/goaccess/src/browsers.c"
   )); fprintf (
# 382 "project/goaccess/src/browsers.c" 3 4
   __stderrp
# 382 "project/goaccess/src/browsers.c"
   , "\n\n"); do { dbg_fprintf ("Unable to open browser's file: %s", strerror (
# 382 "project/goaccess/src/browsers.c" 3 4
   (*__error())
# 382 "project/goaccess/src/browsers.c"
   )); } while (0); exit(
...
# 382 "project/goaccess/src/browsers.c"
  ...
  conf.user_browsers_hash = xmalloc (256 * sizeof (char **));

  while (fgets (line, sizeof line, file) != 
# 386 "project/goaccess/src/browsers.c" 3 4
                                           ((void *)0)
# 386 "project/goaccess/src/browsers.c"
                                               ) {
    while (line[0] == ' ' || line[0] == '\t')
      
# 388 "project/goaccess/src/browsers.c" 3 4
     __builtin___memmove_chk (
# 388 "project/goaccess/src/browsers.c"
     line
# 388 "project/goaccess/src/browsers.c" 3 4
     , 
# 388 "project/goaccess/src/browsers.c"
...
# 388 "project/goaccess/src/browsers.c"
    ...
    if (line[0] == '\n' || line[0] == '\r' || line[0] == '#')
      continue;
    if (conf.browsers_hash_idx >= 256)
      do { (void) endwin (); fprintf (
# 394 "project/goaccess/src/browsers.c" 3 4
     __stderrp
# 394 "project/goaccess/src/browsers.c"
     , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "15:28:50"); fprintf (
# 394 "project/goaccess/src/browsers.c" 3 4
     __stderrp
# 394 "project/goaccess/src/browsers.c"
...
# 394 "project/goaccess/src/browsers.c" 3 4
     __stderrp
# 394 "project/goaccess/src/browsers.c"
     , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/browsers.c", __FUNCTION__, 394); fprintf (
# 394 "project/goaccess/src/browsers.c" 3 4
     __stderrp
# 394 "project/goaccess/src/browsers.c"
     , "Maximum number of custom browsers has been reached"); fprintf (
# 394 "project/goaccess/src/browsers.c" 3 4
     __stderrp
# 394 "project/goaccess/src/browsers.c"
     , "\n\n"); do { dbg_fprintf ("Maximum number of custom browsers has been reached"); } while (0); exit(
# 394 "project/goaccess/src/browsers.c" 3 4
     1
# 394 "project/goaccess/src/browsers.c"
     ); } while (0);
...
is_crawler (const char *agent) {
  ...
  if (agent == 
# 409 "project/goaccess/src/browsers.c" 3 4
              ((void *)0) 
# 409 "project/goaccess/src/browsers.c"
                   || *agent == '\0')
    return 0;

  if ((a = xstrdup (agent), browser = verify_browser (a, type)) != 
# 412 "project/goaccess/src/browsers.c" 3 4
                                                                  ((void *)0)
# 412 "project/goaccess/src/browsers.c"
                                                                      )
    free (browser);
  free (a);
...
parse_opera (char *token) {
  char *val = xmalloc (
# 424 "project/goaccess/src/browsers.c" 3 4
                      __builtin___snprintf_chk (((void *)0), 
# 424 "project/goaccess/src/browsers.c"
                      0
# 424 "project/goaccess/src/browsers.c" 3 4
...
# 425 "project/goaccess/src/browsers.c" 3 4
 __builtin___sprintf_chk (
# 425 "project/goaccess/src/browsers.c"
 val
# 425 "project/goaccess/src/browsers.c" 3 4
...
parse_crawler (char *str, char *match, char *type) {
  char *ptr = 
# 437 "project/goaccess/src/browsers.c" 3 4
             ((void *)0)
# 437 "project/goaccess/src/browsers.c"
                 ;
  int found = 0;
  ...
  if (match == str)
    return 
# 450 "project/goaccess/src/browsers.c" 3 4
          ((void *)0)
# 450 "project/goaccess/src/browsers.c"
              ;
  ...
  if (*match == '\0')
    return 
# 460 "project/goaccess/src/browsers.c" 3 4
          ((void *)0)
# 460 "project/goaccess/src/browsers.c"
              ;

  xstrncpy (type, "Crawlers", 13);
...
check_http_crawler (const char *str) {
  char *match = 
# 475 "project/goaccess/src/browsers.c" 3 4
               ((void *)0)
# 475 "project/goaccess/src/browsers.c"
                   ;
  ...
  if ((match = strstr (str, ";++http")))
    return match;
  return 
# 492 "project/goaccess/src/browsers.c" 3 4
        ((void *)0)
# 492 "project/goaccess/src/browsers.c"
            ;
}
...
parse_browser (char *match, char *type, int i, char ***hash) {
  char *b = 
# 501 "project/goaccess/src/browsers.c" 3 4
           ((void *)0)
# 501 "project/goaccess/src/browsers.c"
               , *ptr = 
# 501 "project/goaccess/src/browsers.c" 3 4
                        ((void *)0)
# 501 "project/goaccess/src/browsers.c"
...
# 501 "project/goaccess/src/browsers.c"
  ...
  if (strstr (match, "OPR") != 
# 518 "project/goaccess/src/browsers.c" 3 4
                              ((void *)0) 
# 518 "project/goaccess/src/browsers.c"
                                   && (slh = strrchr (match, '/'))) {
...
# 523 "project/goaccess/src/browsers.c" 3 4
   __builtin___memmove_chk (
# 523 "project/goaccess/src/browsers.c"
   match + 5
# 523 "project/goaccess/src/browsers.c" 3 4
   , 
# 523 "project/goaccess/src/browsers.c"
...
# 523 "project/goaccess/src/browsers.c"
  ...
  if (strstr (match, "MSIE") != 
# 526 "project/goaccess/src/browsers.c" 3 4
                               ((void *)0)
# 526 "project/goaccess/src/browsers.c"
                                   ) {
    if ((ptr = strpbrk (match, ";)-")) != 
# 527 "project/goaccess/src/browsers.c" 3 4
                                         ((void *)0)
# 527 "project/goaccess/src/browsers.c"
                                             )
      *ptr = '\0';
    match = char_replace (match, ' ', '/');
  }

  else if ((ptr = strpbrk (b ? b : match, ";) ")) != 
# 532 "project/goaccess/src/browsers.c" 3 4
                                                    ((void *)0)
# 532 "project/goaccess/src/browsers.c"
                                                        ) {
    *ptr = '\0';
  }
...
verify_browser (char *str, char *type) {
  char *match = 
# 548 "project/goaccess/src/browsers.c" 3 4
               ((void *)0)
# 548 "project/goaccess/src/browsers.c"
                   , *token = 
# 548 "project/goaccess/src/browsers.c" 3 4
                              ((void *)0)
# 548 "project/goaccess/src/browsers.c"
  ...
  if (str == 
# 552 "project/goaccess/src/browsers.c" 3 4
            ((void *)0) 
# 552 "project/goaccess/src/browsers.c"
                 || *str == '\0')
    return 
# 553 "project/goaccess/src/browsers.c" 3 4
          ((void *)0)
# 553 "project/goaccess/src/browsers.c"
              ;


  for (i = 0; i < conf.browsers_hash_idx; ++i) {
    if ((match = strstr (str, conf.user_browsers_hash[i][0])) == 
# 557 "project/goaccess/src/browsers.c" 3 4
                                                                ((void *)0)
# 557 "project/goaccess/src/browsers.c"
                                                                    )
      continue;
  ...
  for (j = 0; j < (sizeof(browsers) / sizeof(browsers[0])); ++j) {
    if ((match = strstr (str, browsers_hash[j][0])) == 
# 567 "project/goaccess/src/browsers.c" 3 4
                                                      ((void *)0)
# 567 "project/goaccess/src/browsers.c"
                                                          )
      continue;
  ...
  if (conf.unknowns_log)
    do { unknowns_fprintf ("%-7s%s\n", "[BR]", str); } while (0);

  xstrncpy (type, "Unknown", 13);
