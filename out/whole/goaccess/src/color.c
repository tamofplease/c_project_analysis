# 0 "project/goaccess/src/color.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/goaccess/src/color.c"
# 35 "project/goaccess/src/color.c"
...
# 36 "project/goaccess/src/color.c" 2
...
# 37 "project/goaccess/src/color.c" 2
...
# 38 "project/goaccess/src/color.c" 2
...
# 39 "project/goaccess/src/color.c" 2
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/strings.h" 1 3 4
# 40 "project/goaccess/src/color.c" 2
...
# 42 "project/goaccess/src/color.c" 2
...
# 44 "project/goaccess/src/color.c" 2
...
# 46 "project/goaccess/src/color.c" 2
...
# 47 "project/goaccess/src/color.c" 2

static GSLList *color_list = 
# 48 "project/goaccess/src/color.c" 3 4
                            ((void *)0)
# 48 "project/goaccess/src/color.c"
                                ;
static GSLList *pair_list = 
# 49 "project/goaccess/src/color.c" 3 4
                           ((void *)0)
# 49 "project/goaccess/src/color.c"
                               ;
...
free_color_lists (void) {
  ...
  color_list = 
# 331 "project/goaccess/src/color.c" 3 4
              ((void *)0)
# 331 "project/goaccess/src/color.c"
                  ;
  pair_list = 
# 332 "project/goaccess/src/color.c" 3 4
             ((void *)0)
# 332 "project/goaccess/src/color.c"
                 ;
}
...
get_color_item_enum (const char *str) {
  return str2enum (CSTM_COLORS, (sizeof(CSTM_COLORS) / sizeof(CSTM_COLORS[0])), str);
}
...
extract_color (char *color) {
  ...
  if (color == sEnd || *sEnd != '\0' || 
# 438 "project/goaccess/src/color.c" 3 4
                                       (*__error()) 
# 438 "project/goaccess/src/color.c"
                                             == 
# 438 "project/goaccess/src/color.c" 3 4
                                                34
# 438 "project/goaccess/src/color.c"
...
# 442 "project/goaccess/src/color.c" 3 4
   __stderrp
# 442 "project/goaccess/src/color.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "15:28:53"); fprintf (
# 442 "project/goaccess/src/color.c" 3 4
   __stderrp
# 442 "project/goaccess/src/color.c"
...
# 442 "project/goaccess/src/color.c" 3 4
   __stderrp
# 442 "project/goaccess/src/color.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/color.c", __FUNCTION__, 442); fprintf (
# 442 "project/goaccess/src/color.c" 3 4
   __stderrp
# 442 "project/goaccess/src/color.c"
   , "Terminal doesn't support color: %d - max colors: %d", col, COLORS); fprintf (
# 442 "project/goaccess/src/color.c" 3 4
   __stderrp
# 442 "project/goaccess/src/color.c"
   , "\n\n"); do { dbg_fprintf ("Terminal doesn't support color: %d - max colors: %d", col, COLORS); } while (0); exit(
# 442 "project/goaccess/src/color.c" 3 4
   1
# 442 "project/goaccess/src/color.c"
   ); } while (0);
...
parse_attr_color (GColors * color, const char *value) {
  ...
  start = strchr (line, ' ');
  if ((!start) || (!*(start + 1))) {
    do { dbg_fprintf ("attempted to parse color attr: %s\n", value); } while (0);
    goto clean;
  }
...
# 505 "project/goaccess/src/color.c" 3 4
                                        ((void *)0)
# 505 "project/goaccess/src/color.c"
                                            )
      *ptr = 0;
    locate_attr_color (color, start);
    if (ptr == 
# 508 "project/goaccess/src/color.c" 3 4
              ((void *)0)
# 508 "project/goaccess/src/color.c"
                  )
      break;
    start = ptr + 1;
  }
...
parse_module_color (GColors * color, const char *value) {
  ...
  p = strrchr (line, ' ');
  if (!p || !*(p + 1)) {
    do { dbg_fprintf ("attempted to parse color module: %s\n", value); } while (0);
    goto clean;
  }
...
get_color (GColorItem item) {
  ...
  GSLList *match = 
# 609 "project/goaccess/src/color.c" 3 4
                  ((void *)0)
# 609 "project/goaccess/src/color.c"
                      ;
  ...
  do { (void) endwin (); fprintf (
# 618 "project/goaccess/src/color.c" 3 4
 __stderrp
# 618 "project/goaccess/src/color.c"
 , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "15:28:53"); fprintf (
# 618 "project/goaccess/src/color.c" 3 4
 __stderrp
# 618 "project/goaccess/src/color.c"
...
# 618 "project/goaccess/src/color.c" 3 4
 __stderrp
# 618 "project/goaccess/src/color.c"
 , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/color.c", __FUNCTION__, 618); fprintf (
# 618 "project/goaccess/src/color.c" 3 4
 __stderrp
# 618 "project/goaccess/src/color.c"
 , "Unable to find color item %d", item); fprintf (
# 618 "project/goaccess/src/color.c" 3 4
 __stderrp
# 618 "project/goaccess/src/color.c"
 , "\n\n"); do { dbg_fprintf ("Unable to find color item %d", item); } while (0); exit(
# 618 "project/goaccess/src/color.c" 3 4
 1
# 618 "project/goaccess/src/color.c"
 ); } while (0);
...
get_color_by_item_module (GColorItem item, GModule module) {
  GColors *needle = new_gcolors (), *color = 
# 628 "project/goaccess/src/color.c" 3 4
                                            ((void *)0)
# 628 "project/goaccess/src/color.c"
                                                ;
  GSLList *match = 
# 629 "project/goaccess/src/color.c" 3 4
                  ((void *)0)
# 629 "project/goaccess/src/color.c"
                      ;
...
parse_color_line (GColorPair * pair, GColors * color, char *line) {
  ...
  if (strlen (line) == idx)
    do { (void) endwin (); fprintf (
# 659 "project/goaccess/src/color.c" 3 4
   __stderrp
# 659 "project/goaccess/src/color.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "15:28:53"); fprintf (
# 659 "project/goaccess/src/color.c" 3 4
   __stderrp
# 659 "project/goaccess/src/color.c"
...
# 659 "project/goaccess/src/color.c" 3 4
   __stderrp
# 659 "project/goaccess/src/color.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/color.c", __FUNCTION__, 659); fprintf (
# 659 "project/goaccess/src/color.c" 3 4
   __stderrp
# 659 "project/goaccess/src/color.c"
   , "Malformed color key at line: %s", line); fprintf (
# 659 "project/goaccess/src/color.c" 3 4
   __stderrp
# 659 "project/goaccess/src/color.c"
   , "\n\n"); do { dbg_fprintf ("Malformed color key at line: %s", line); } while (0); exit(
# 659 "project/goaccess/src/color.c" 3 4
   1
# 659 "project/goaccess/src/color.c"
   ); } while (0);
  ...
  if ((item = get_color_item_enum (line)) == -1)
    do { (void) endwin (); fprintf (
# 663 "project/goaccess/src/color.c" 3 4
   __stderrp
# 663 "project/goaccess/src/color.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "15:28:53"); fprintf (
# 663 "project/goaccess/src/color.c" 3 4
   __stderrp
# 663 "project/goaccess/src/color.c"
...
# 663 "project/goaccess/src/color.c" 3 4
   __stderrp
# 663 "project/goaccess/src/color.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/color.c", __FUNCTION__, 663); fprintf (
# 663 "project/goaccess/src/color.c" 3 4
   __stderrp
# 663 "project/goaccess/src/color.c"
   , "Unable to find color key: %s", line); fprintf (
# 663 "project/goaccess/src/color.c" 3 4
   __stderrp
# 663 "project/goaccess/src/color.c"
   , "\n\n"); do { dbg_fprintf ("Unable to find color key: %s", line); } while (0); exit(
# 663 "project/goaccess/src/color.c" 3 4
   1
# 663 "project/goaccess/src/color.c"
   ); } while (0);
  ...
  if (strlen (val) == idx)
    do { (void) endwin (); fprintf (
# 669 "project/goaccess/src/color.c" 3 4
   __stderrp
# 669 "project/goaccess/src/color.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "15:28:53"); fprintf (
# 669 "project/goaccess/src/color.c" 3 4
   __stderrp
# 669 "project/goaccess/src/color.c"
...
# 669 "project/goaccess/src/color.c" 3 4
   __stderrp
# 669 "project/goaccess/src/color.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/color.c", __FUNCTION__, 669); fprintf (
# 669 "project/goaccess/src/color.c" 3 4
   __stderrp
# 669 "project/goaccess/src/color.c"
   , "Malformed color value at line: %s", line); fprintf (
# 669 "project/goaccess/src/color.c" 3 4
   __stderrp
# 669 "project/goaccess/src/color.c"
   , "\n\n"); do { dbg_fprintf ("Malformed color value at line: %s", line); } while (0); exit(
# 669 "project/goaccess/src/color.c" 3 4
   1
# 669 "project/goaccess/src/color.c"
   ); } while (0);
  ...
  if (parse_bg_fg_color (pair, val) == 1)
    do { (void) endwin (); fprintf (
# 674 "project/goaccess/src/color.c" 3 4
   __stderrp
# 674 "project/goaccess/src/color.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "15:28:53"); fprintf (
# 674 "project/goaccess/src/color.c" 3 4
   __stderrp
# 674 "project/goaccess/src/color.c"
...
# 674 "project/goaccess/src/color.c" 3 4
   __stderrp
# 674 "project/goaccess/src/color.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/color.c", __FUNCTION__, 674); fprintf (
# 674 "project/goaccess/src/color.c" 3 4
   __stderrp
# 674 "project/goaccess/src/color.c"
   , "Invalid bg/fg color pairs at: %s %s", line, val); fprintf (
# 674 "project/goaccess/src/color.c" 3 4
   __stderrp
# 674 "project/goaccess/src/color.c"
   , "\n\n"); do { dbg_fprintf ("Invalid bg/fg color pairs at: %s %s", line, val); } while (0); exit(
# 674 "project/goaccess/src/color.c" 3 4
   1
# 674 "project/goaccess/src/color.c"
   ); } while (0);
  ...
  if (parse_attr_color (color, val) == 1)
    do { (void) endwin (); fprintf (
# 677 "project/goaccess/src/color.c" 3 4
   __stderrp
# 677 "project/goaccess/src/color.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "15:28:53"); fprintf (
# 677 "project/goaccess/src/color.c" 3 4
   __stderrp
# 677 "project/goaccess/src/color.c"
...
# 677 "project/goaccess/src/color.c" 3 4
   __stderrp
# 677 "project/goaccess/src/color.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/color.c", __FUNCTION__, 677); fprintf (
# 677 "project/goaccess/src/color.c" 3 4
   __stderrp
# 677 "project/goaccess/src/color.c"
   , "Invalid color attrs at: %s %s", line, val); fprintf (
# 677 "project/goaccess/src/color.c" 3 4
   __stderrp
# 677 "project/goaccess/src/color.c"
   , "\n\n"); do { dbg_fprintf ("Invalid color attrs at: %s %s", line, val); } while (0); exit(
# 677 "project/goaccess/src/color.c" 3 4
   1
# 677 "project/goaccess/src/color.c"
   ); } while (0);
  ...
  if (parse_module_color (color, val) == 1)
    do { (void) endwin (); fprintf (
# 680 "project/goaccess/src/color.c" 3 4
   __stderrp
# 680 "project/goaccess/src/color.c"
   , "\nGoAccess - version %s - %s %s\n", "1.5.4", "May 12 2022", "15:28:53"); fprintf (
# 680 "project/goaccess/src/color.c" 3 4
   __stderrp
# 680 "project/goaccess/src/color.c"
...
# 680 "project/goaccess/src/color.c" 3 4
   __stderrp
# 680 "project/goaccess/src/color.c"
   , "\nError occurred at: %s - %s - %d\n", "project/goaccess/src/color.c", __FUNCTION__, 680); fprintf (
# 680 "project/goaccess/src/color.c" 3 4
   __stderrp
# 680 "project/goaccess/src/color.c"
   , "Invalid color module at: %s %s", line, val); fprintf (
# 680 "project/goaccess/src/color.c" 3 4
   __stderrp
# 680 "project/goaccess/src/color.c"
   , "\n\n"); do { dbg_fprintf ("Invalid color module at: %s %s", line, val); } while (0); exit(
# 680 "project/goaccess/src/color.c" 3 4
   1
# 680 "project/goaccess/src/color.c"
   ); } while (0);
...
prepend_color (GColors ** color) {
  ...
  if (color_list == 
# 692 "project/goaccess/src/color.c" 3 4
                   ((void *)0)
# 692 "project/goaccess/src/color.c"
                       ) {
    color_list = list_create (*color);
  }
    ...
    free (*color);
    *color = 
# 701 "project/goaccess/src/color.c" 3 4
            ((void *)0)
# 701 "project/goaccess/src/color.c"
                ;
  } else {
...
parse_color (char *line) {
  GSLList *match = 
# 715 "project/goaccess/src/color.c" 3 4
                  ((void *)0)
# 715 "project/goaccess/src/color.c"
                      ;
  GColors *color = 
# 716 "project/goaccess/src/color.c" 3 4
                  ((void *)0)
# 716 "project/goaccess/src/color.c"
                      ;
  GColorPair *pair = 
# 717 "project/goaccess/src/color.c" 3 4
                    ((void *)0)
# 717 "project/goaccess/src/color.c"
                        ;
  ...
  if (pair_list == 
# 726 "project/goaccess/src/color.c" 3 4
                  ((void *)0)
# 726 "project/goaccess/src/color.c"
                      ) {
    pair_list = list_create (pair);
  }
...
parse_colors (const char *colors[], size_t n) {
  ...
  for (i = 0; i < n; ++i) {
    ...
    if (strchr (line, ':') == 
# 763 "project/goaccess/src/color.c" 3 4
                             ((void *)0)
# 763 "project/goaccess/src/color.c"
                                 ) {
      free (line);
      continue;
    }
...
add_default_colors (void) {
  ...
  if (COLORS < 8)
    parse_colors (nocolors, (sizeof(nocolors) / sizeof(nocolors[0])));


  if (COLORS == 256 && (!conf.color_scheme || conf.color_scheme == MONOKAI))
    parse_colors (colors256_monokai, (sizeof(colors256_monokai) / sizeof(colors256_monokai[0])));

  else if (COLORS > 16) {
    if (conf.color_scheme == STD_GREEN)
      parse_colors (colors256_green, (sizeof(colors256_green) / sizeof(colors256_green[0])));
    else
      parse_colors (colors256_mono, (sizeof(colors256_mono) / sizeof(colors256_mono[0])));
  }


  if (COLORS >= 8 && COLORS <= 16) {
    if (conf.color_scheme == STD_GREEN)
      parse_colors (colors8_green, (sizeof(colors8_green) / sizeof(colors8_green[0])));
    else
      parse_colors (colors8_mono, (sizeof(colors8_mono) / sizeof(colors8_mono[0])));
  }
}
...
# 801 "project/goaccess/src/color.c" 3 4
 (*__error()) 
# 801 "project/goaccess/src/color.c"
       = 0;
