...
# 35 "project/goaccess/src/sort.c"
...
# 36 "project/goaccess/src/sort.c" 2
...
# 37 "project/goaccess/src/sort.c" 2
...
# 38 "project/goaccess/src/sort.c" 2
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/getopt.h" 1 3 4
# 41 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/getopt.h" 3 4
#define _GETOPT_H_ 
...
# 45 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/getopt.h" 2 3 4
...
# 39 "project/goaccess/src/sort.c" 2
...
# 40 "project/goaccess/src/sort.c" 2
...
# 42 "project/goaccess/src/sort.c" 2
...
# 44 "project/goaccess/src/sort.c" 2
...
# 46 "project/goaccess/src/sort.c" 2


const int sort_choices[][11] = {
...
get_sort_field_enum (const char *str) {
  return str2enum (FIELD, (sizeof(FIELD) / sizeof(FIELD[0])), str);
}
...
get_sort_order_enum (const char *str) {
  return str2enum (ORDER, (sizeof(ORDER) / sizeof(ORDER[0])), str);
}
...
parse_initial_sort (void) {
  int i;
  char module[15 + 1], field[11 + 1], order[4 + 1];
