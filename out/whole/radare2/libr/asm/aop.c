# 0 "project/radare2/libr/asm/aop.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/aop.c"
...
# 4 "project/radare2/libr/asm/aop.c" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/asm/aop.c"
     RAsmOp *r_asm_op_new(void) {
 return 
# 6 "project/radare2/libr/asm/aop.c" 3 4
       (
# 6 "project/radare2/libr/asm/aop.c"
       RAsmOp
# 6 "project/radare2/libr/asm/aop.c" 3 4
       *)calloc(1,sizeof(
# 6 "project/radare2/libr/asm/aop.c"
...
# 9 "project/radare2/libr/asm/aop.c" 3 4
__attribute__((visibility("default"))) 
# 9 "project/radare2/libr/asm/aop.c"
...
# 16 "project/radare2/libr/asm/aop.c" 3 4
__attribute__((visibility("default"))) 
# 16 "project/radare2/libr/asm/aop.c"
     void r_asm_op_init(RAsmOp *op) {
 if (op) {
  
# 18 "project/radare2/libr/asm/aop.c" 3 4
 __builtin___memset_chk (
# 18 "project/radare2/libr/asm/aop.c"
 op
# 18 "project/radare2/libr/asm/aop.c" 3 4
 , 
# 18 "project/radare2/libr/asm/aop.c"
...
# 22 "project/radare2/libr/asm/aop.c" 3 4
__attribute__((visibility("default"))) 
# 22 "project/radare2/libr/asm/aop.c"
     void r_asm_op_fini(RAsmOp *op) {
 
# 23 "project/radare2/libr/asm/aop.c" 3 4
do { if (!(
# 23 "project/radare2/libr/asm/aop.c"
op
# 23 "project/radare2/libr/asm/aop.c" 3 4
...
# 30 "project/radare2/libr/asm/aop.c" 3 4
__attribute__((visibility("default"))) 
# 30 "project/radare2/libr/asm/aop.c"
     char *r_asm_op_get_hex(RAsmOp *op) {
 
# 31 "project/radare2/libr/asm/aop.c" 3 4
do { if (!(
# 31 "project/radare2/libr/asm/aop.c"
op
# 31 "project/radare2/libr/asm/aop.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 31 "project/radare2/libr/asm/aop.c"
"op"
# 31 "project/radare2/libr/asm/aop.c" 3 4
, 31); return (((void *)0)); } } while (0)
# 31 "project/radare2/libr/asm/aop.c"
                               ;
 int size = r_strbuf_length (&op->buf);
 char* str = calloc (size + 1, 2);
 
# 34 "project/radare2/libr/asm/aop.c" 3 4
do { if (!(
# 34 "project/radare2/libr/asm/aop.c"
str
# 34 "project/radare2/libr/asm/aop.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 34 "project/radare2/libr/asm/aop.c"
...
# 34 "project/radare2/libr/asm/aop.c"
                                ;
 r_hex_bin2str ((const 
# 35 "project/radare2/libr/asm/aop.c" 3 4
                      unsigned char
# 35 "project/radare2/libr/asm/aop.c"
                         *) r_strbuf_get (&op->buf), size, str);
 return str;
}


# 39 "project/radare2/libr/asm/aop.c" 3 4
__attribute__((visibility("default"))) 
# 39 "project/radare2/libr/asm/aop.c"
     char *r_asm_op_get_asm(RAsmOp *op) {
 
# 40 "project/radare2/libr/asm/aop.c" 3 4
do { if (!(
# 40 "project/radare2/libr/asm/aop.c"
op
# 40 "project/radare2/libr/asm/aop.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 40 "project/radare2/libr/asm/aop.c"
...
# 44 "project/radare2/libr/asm/aop.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 44 "project/radare2/libr/asm/aop.c"
         *r_asm_op_get_buf(RAsmOp *op) {
 
# 45 "project/radare2/libr/asm/aop.c" 3 4
do { if (!(
# 45 "project/radare2/libr/asm/aop.c"
op
# 45 "project/radare2/libr/asm/aop.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 45 "project/radare2/libr/asm/aop.c"
"op"
# 45 "project/radare2/libr/asm/aop.c" 3 4
, 45); return (((void *)0)); } } while (0)
# 45 "project/radare2/libr/asm/aop.c"
                               ;
 return (
# 46 "project/radare2/libr/asm/aop.c" 3 4
        unsigned char
# 46 "project/radare2/libr/asm/aop.c"
           *)r_strbuf_get (&op->buf);
}


# 49 "project/radare2/libr/asm/aop.c" 3 4
__attribute__((visibility("default"))) 
# 49 "project/radare2/libr/asm/aop.c"
     int r_asm_op_get_size(RAsmOp *op) {
 
# 50 "project/radare2/libr/asm/aop.c" 3 4
do { if (!(
# 50 "project/radare2/libr/asm/aop.c"
op
# 50 "project/radare2/libr/asm/aop.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 50 "project/radare2/libr/asm/aop.c"
...
# 50 "project/radare2/libr/asm/aop.c"
 ...
 return 
# 52 "project/radare2/libr/asm/aop.c" 3 4
       (((
# 52 "project/radare2/libr/asm/aop.c"
       1
# 52 "project/radare2/libr/asm/aop.c" 3 4
       )>(
# 52 "project/radare2/libr/asm/aop.c"
...
# 55 "project/radare2/libr/asm/aop.c" 3 4
__attribute__((visibility("default"))) 
# 55 "project/radare2/libr/asm/aop.c"
     void r_asm_op_set_asm(RAsmOp *op, const char *str) {
 
# 56 "project/radare2/libr/asm/aop.c" 3 4
do { if (!(
# 56 "project/radare2/libr/asm/aop.c"
op && str
# 56 "project/radare2/libr/asm/aop.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 56 "project/radare2/libr/asm/aop.c"
...
# 60 "project/radare2/libr/asm/aop.c" 3 4
__attribute__((visibility("default"))) 
# 60 "project/radare2/libr/asm/aop.c"
     int r_asm_op_set_hex(RAsmOp *op, const char *str) {
 
# 61 "project/radare2/libr/asm/aop.c" 3 4
do { if (!(
# 61 "project/radare2/libr/asm/aop.c"
op && str
# 61 "project/radare2/libr/asm/aop.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 61 "project/radare2/libr/asm/aop.c"
...
# 62 "project/radare2/libr/asm/aop.c" 3 4
unsigned char 
# 62 "project/radare2/libr/asm/aop.c"
    *bin = (
# 62 "project/radare2/libr/asm/aop.c" 3 4
            unsigned char
# 62 "project/radare2/libr/asm/aop.c"
...
# 74 "project/radare2/libr/asm/aop.c" 3 4
__attribute__((visibility("default"))) 
# 74 "project/radare2/libr/asm/aop.c"
     int r_asm_op_set_hexbuf(RAsmOp *op, const 
# 74 "project/radare2/libr/asm/aop.c" 3 4
                                               unsigned char 
# 74 "project/radare2/libr/asm/aop.c"
                                                   *buf, int len) {
 
# 75 "project/radare2/libr/asm/aop.c" 3 4
do { if (!(
# 75 "project/radare2/libr/asm/aop.c"
op && buf && len >= 0
# 75 "project/radare2/libr/asm/aop.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 75 "project/radare2/libr/asm/aop.c"
...
# 86 "project/radare2/libr/asm/aop.c" 3 4
__attribute__((visibility("default"))) 
# 86 "project/radare2/libr/asm/aop.c"
     void r_asm_op_set_buf(RAsmOp *op, const 
# 86 "project/radare2/libr/asm/aop.c" 3 4
                                             unsigned char 
# 86 "project/radare2/libr/asm/aop.c"
                                                 *buf, int len) {
 
# 87 "project/radare2/libr/asm/aop.c" 3 4
do { if (!(
# 87 "project/radare2/libr/asm/aop.c"
op && buf && len >= 0
# 87 "project/radare2/libr/asm/aop.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 87 "project/radare2/libr/asm/aop.c"
