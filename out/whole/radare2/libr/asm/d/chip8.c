# 0 "project/radare2/libr/asm/d/chip8.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/asm/d/chip8.c" 2
...
# 5 "project/radare2/libr/asm/d/chip8.c" 2
...
# 6 "project/radare2/libr/asm/d/chip8.c" 2


# 7 "project/radare2/libr/asm/d/chip8.c"
...
static struct kv kvs[] = {
  ...
  {"cls","clear display"},
  {
# 34 "project/radare2/libr/asm/d/chip8.c" 3 4
  ((void *)0)
# 34 "project/radare2/libr/asm/d/chip8.c"
      , 
# 34 "project/radare2/libr/asm/d/chip8.c" 3 4
        ((void *)0)
# 34 "project/radare2/libr/asm/d/chip8.c"
...
const char *gperf_chip8_get(const char *s) {
  ...
  i++;}
  return 
# 49 "project/radare2/libr/asm/d/chip8.c" 3 4
        ((void *)0)
# 49 "project/radare2/libr/asm/d/chip8.c"
            ;
}
