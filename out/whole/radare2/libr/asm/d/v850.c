# 0 "project/radare2/libr/asm/d/v850.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/asm/d/v850.c" 2
...
# 5 "project/radare2/libr/asm/d/v850.c" 2
...
# 6 "project/radare2/libr/asm/d/v850.c" 2


# 7 "project/radare2/libr/asm/d/v850.c"
...
static struct kv kvs[] = {
  ...
  {
# 146 "project/radare2/libr/asm/d/v850.c" 3 4
  ((void *)0)
# 146 "project/radare2/libr/asm/d/v850.c"
      , 
# 146 "project/radare2/libr/asm/d/v850.c" 3 4
        ((void *)0)
# 146 "project/radare2/libr/asm/d/v850.c"
...
const char *gperf_v850_get(const char *s) {
  ...
  i++;}
  return 
# 161 "project/radare2/libr/asm/d/v850.c" 3 4
        ((void *)0)
# 161 "project/radare2/libr/asm/d/v850.c"
            ;
}
