# 0 "project/radare2/libr/asm/p/asm_amd29k.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/asm/p/asm_amd29k.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_amd29k.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_amd29k.c" 2
...
# 7 "project/radare2/libr/asm/p/asm_amd29k.c" 2
...
# 8 "project/radare2/libr/asm/p/asm_amd29k.c" 2
# 1 "project/radare2/libr/asm/p/../arch/amd29k/amd29k.h" 1

#define ASM_AMD_29K_H 
# 11 "project/radare2/libr/asm/p/../arch/amd29k/amd29k.h"
#define CPU_29000 "29000"
#define CPU_29050 "29050"


# 14 "project/radare2/libr/asm/p/../arch/amd29k/amd29k.h"
typedef struct amd29k_instr_s {
 const char* mnemonic;
 
# 16 "project/radare2/libr/asm/p/../arch/amd29k/amd29k.h" 3 4
unsigned long long 
# 16 "project/radare2/libr/asm/p/../arch/amd29k/amd29k.h"
            op_type;
 
# 17 "project/radare2/libr/asm/p/../arch/amd29k/amd29k.h" 3 4
unsigned int 
# 17 "project/radare2/libr/asm/p/../arch/amd29k/amd29k.h"
            operands[6];
 char type[6];
} amd29k_instr_t;


# 21 "project/radare2/libr/asm/p/../arch/amd29k/amd29k.h" 3 4
_Bool 
# 21 "project/radare2/libr/asm/p/../arch/amd29k/amd29k.h"
...
# 22 "project/radare2/libr/asm/p/../arch/amd29k/amd29k.h" 3 4
                                                      unsigned long long 
# 22 "project/radare2/libr/asm/p/../arch/amd29k/amd29k.h"
                                                           address, amd29k_instr_t* instruction);


# 24 "project/radare2/libr/asm/p/../arch/amd29k/amd29k.h" 3 4
_Bool 
# 24 "project/radare2/libr/asm/p/../arch/amd29k/amd29k.h"
    amd29k_instr_is_ret(amd29k_instr_t* instruction);

# 25 "project/radare2/libr/asm/p/../arch/amd29k/amd29k.h" 3 4
unsigned long long 
# 25 "project/radare2/libr/asm/p/../arch/amd29k/amd29k.h"
    amd29k_instr_jump(
# 25 "project/radare2/libr/asm/p/../arch/amd29k/amd29k.h" 3 4
                      unsigned long long 
# 25 "project/radare2/libr/asm/p/../arch/amd29k/amd29k.h"
                           address, amd29k_instr_t* instruction);
# 9 "project/radare2/libr/asm/p/asm_amd29k.c" 2

static int disassemble(RAsm *a, RAsmOp *op, const 
# 10 "project/radare2/libr/asm/p/asm_amd29k.c" 3 4
                                                 unsigned char 
# 10 "project/radare2/libr/asm/p/asm_amd29k.c"
                                                     *buf, int len) {
 if (!a || !op || !buf || len < 4) {
  return -1;
 }
...
# 15 "project/radare2/libr/asm/p/asm_amd29k.c" 3 4
unsigned long long 
# 15 "project/radare2/libr/asm/p/asm_amd29k.c"
     offset = a->pc;
...
RAsmPlugin r_asm_plugin_amd29k = {
 ...
 .bits = 32,
 .endian = 
# 35 "project/radare2/libr/asm/p/asm_amd29k.c" 3 4
          1
# 35 "project/radare2/libr/asm/p/asm_amd29k.c"
                             ,
...
# 40 "project/radare2/libr/asm/p/asm_amd29k.c" 3 4
__attribute__((visibility("default"))) 
# 40 "project/radare2/libr/asm/p/asm_amd29k.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_amd29k,
 .version = 
# 43 "project/radare2/libr/asm/p/asm_amd29k.c" 3 4
           "5.5.4"

# 44 "project/radare2/libr/asm/p/asm_amd29k.c"
};
