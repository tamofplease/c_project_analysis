# 0 "project/radare2/libr/asm/p/asm_mcore.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/asm/p/asm_mcore.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_mcore.c" 2
# 1 "project/radare2/libr/asm/p/../arch/mcore/mcore.h" 1

#define MCORE_H 
# 11 "project/radare2/libr/asm/p/../arch/mcore/mcore.h"
#define ARGS_SIZE 5
...
# 26 "project/radare2/libr/asm/p/../arch/mcore/mcore.h"
typedef struct {
 const 
# 27 "project/radare2/libr/asm/p/../arch/mcore/mcore.h" 3 4
      unsigned char
# 27 "project/radare2/libr/asm/p/../arch/mcore/mcore.h"
         * end;
 const 
# 28 "project/radare2/libr/asm/p/../arch/mcore/mcore.h" 3 4
      unsigned char
# 28 "project/radare2/libr/asm/p/../arch/mcore/mcore.h"
         * pos;
 
# 29 "project/radare2/libr/asm/p/../arch/mcore/mcore.h" 3 4
unsigned short 
# 29 "project/radare2/libr/asm/p/../arch/mcore/mcore.h"
     inc;
} mcore_handle;

typedef struct {
 
# 33 "project/radare2/libr/asm/p/../arch/mcore/mcore.h" 3 4
unsigned int 
# 33 "project/radare2/libr/asm/p/../arch/mcore/mcore.h"
     value;
 
# 34 "project/radare2/libr/asm/p/../arch/mcore/mcore.h" 3 4
unsigned short 
# 34 "project/radare2/libr/asm/p/../arch/mcore/mcore.h"
     type;
} mcore_field_t;
...
# 40 "project/radare2/libr/asm/p/../arch/mcore/mcore.h" 3 4
unsigned long long 
# 40 "project/radare2/libr/asm/p/../arch/mcore/mcore.h"
     type;
 
# 41 "project/radare2/libr/asm/p/../arch/mcore/mcore.h" 3 4
unsigned short 
# 41 "project/radare2/libr/asm/p/../arch/mcore/mcore.h"
     n_args;
 
# 42 "project/radare2/libr/asm/p/../arch/mcore/mcore.h" 3 4
unsigned short 
# 42 "project/radare2/libr/asm/p/../arch/mcore/mcore.h"
     bytes;
 
# 43 "project/radare2/libr/asm/p/../arch/mcore/mcore.h" 3 4
unsigned short 
# 43 "project/radare2/libr/asm/p/../arch/mcore/mcore.h"
     size;
} mcore_t;

int mcore_init(mcore_handle* handle, const 
# 46 "project/radare2/libr/asm/p/../arch/mcore/mcore.h" 3 4
                                          unsigned char
# 46 "project/radare2/libr/asm/p/../arch/mcore/mcore.h"
                                             * buffer, const 
# 46 "project/radare2/libr/asm/p/../arch/mcore/mcore.h" 3 4
                                                             unsigned int 
# 46 "project/radare2/libr/asm/p/../arch/mcore/mcore.h"
...
# 49 "project/radare2/libr/asm/p/../arch/mcore/mcore.h" 3 4
                                       unsigned long long 
# 49 "project/radare2/libr/asm/p/../arch/mcore/mcore.h"
                                            addr, mcore_t* instr);
# 6 "project/radare2/libr/asm/p/asm_mcore.c" 2

static mcore_handle handle = {0};

static int disassemble(RAsm *a, RAsmOp *op, const 
# 9 "project/radare2/libr/asm/p/asm_mcore.c" 3 4
                                                 unsigned char 
# 9 "project/radare2/libr/asm/p/asm_mcore.c"
                                                     *buf, int len) {
 mcore_t* instr = 
# 10 "project/radare2/libr/asm/p/asm_mcore.c" 3 4
                 ((void *)0)
# 10 "project/radare2/libr/asm/p/asm_mcore.c"
                     ;
 char tmp[256];
...
RAsmPlugin r_asm_plugin_mcore = {
 ...
 .bits = 32,
 .endian = 
# 33 "project/radare2/libr/asm/p/asm_mcore.c" 3 4
          2
# 33 "project/radare2/libr/asm/p/asm_mcore.c"
                          ,
...
# 38 "project/radare2/libr/asm/p/asm_mcore.c" 3 4
__attribute__((visibility("default"))) 
# 38 "project/radare2/libr/asm/p/asm_mcore.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_mcore,
 .version = 
# 41 "project/radare2/libr/asm/p/asm_mcore.c" 3 4
           "5.5.4"

# 42 "project/radare2/libr/asm/p/asm_mcore.c"
};
