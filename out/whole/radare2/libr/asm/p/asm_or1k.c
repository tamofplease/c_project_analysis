# 0 "project/radare2/libr/asm/p/asm_or1k.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/p/asm_or1k.c"
...
# 4 "project/radare2/libr/asm/p/asm_or1k.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_or1k.c" 2
# 1 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h" 1
...
# 51 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h"
...
# 94 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h" 3 4
unsigned int 
# 94 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h"
     mask;
 
# 95 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h" 3 4
unsigned int 
# 95 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h"
     shift;
} insn_oper_descr_t;
...
# 105 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h" 3 4
unsigned int 
# 105 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h"
     opcode;
 char *name;
 int type;
 int opcode_mask;
...
# 113 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h" 3 4
unsigned int 
# 113 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h"
     opcode;
 char *name;
 int type;
 int insn_type;
...
# 136 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h" 3 4
                                                              unsigned int 
# 136 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h"
                                                                   insn);
# 149 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h"

# 149 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h" 3 4
unsigned int 
# 149 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h"
    sign_extend(
# 149 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h" 3 4
...
static inline 
# 151 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h" 3 4
             unsigned int 
# 151 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h"
                  get_operand_mask(insn_type_descr_t *type_descr, insn_oper_t operand) {
 return type_descr->operands[operand].mask;
}

static inline 
# 155 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h" 3 4
             unsigned int 
# 155 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h"
                  get_operand_shift(insn_type_descr_t *type_descr, insn_oper_t operand) {
 return type_descr->operands[operand].shift;
}

static inline 
# 159 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h" 3 4
             unsigned int 
# 159 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h"
                  get_operand_value(
# 159 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h" 3 4
                                    unsigned int 
# 159 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h"
...
# 172 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h" 3 4
do { if (!(
# 172 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h"
descr
# 172 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h" 3 4
...
# 172 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h"
 ...
 if (extra_descr == 
# 174 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h" 3 4
                   ((void *)0)
# 174 "project/radare2/libr/asm/p/../arch/or1k/or1k_disas.h"
                       ) {
  return descr->type;
 } else {
...
# 6 "project/radare2/libr/asm/p/asm_or1k.c" 2

struct operands {
 
# 8 "project/radare2/libr/asm/p/asm_or1k.c" 3 4
unsigned int 
# 8 "project/radare2/libr/asm/p/asm_or1k.c"
     rd;
 
# 9 "project/radare2/libr/asm/p/asm_or1k.c" 3 4
unsigned int 
# 9 "project/radare2/libr/asm/p/asm_or1k.c"
     ra;
 
# 10 "project/radare2/libr/asm/p/asm_or1k.c" 3 4
unsigned int 
# 10 "project/radare2/libr/asm/p/asm_or1k.c"
     rb;
 
# 11 "project/radare2/libr/asm/p/asm_or1k.c" 3 4
unsigned int 
# 11 "project/radare2/libr/asm/p/asm_or1k.c"
     n;
 
# 12 "project/radare2/libr/asm/p/asm_or1k.c" 3 4
unsigned int 
# 12 "project/radare2/libr/asm/p/asm_or1k.c"
     k1;
 
# 13 "project/radare2/libr/asm/p/asm_or1k.c" 3 4
unsigned int 
# 13 "project/radare2/libr/asm/p/asm_or1k.c"
     k2;
 
# 14 "project/radare2/libr/asm/p/asm_or1k.c" 3 4
unsigned int 
# 14 "project/radare2/libr/asm/p/asm_or1k.c"
     k;
 
# 15 "project/radare2/libr/asm/p/asm_or1k.c" 3 4
unsigned int 
# 15 "project/radare2/libr/asm/p/asm_or1k.c"
     i;
 
# 16 "project/radare2/libr/asm/p/asm_or1k.c" 3 4
unsigned int 
# 16 "project/radare2/libr/asm/p/asm_or1k.c"
     l;
};

static int insn_to_str(RAsm *a, char **line, insn_t *descr, insn_extra_t *extra, 
# 19 "project/radare2/libr/asm/p/asm_or1k.c" 3 4
                                                                                unsigned int 
# 19 "project/radare2/libr/asm/p/asm_or1k.c"
                                                                                     insn) {
 struct operands o = {0};
 char *name;
...
# 107 "project/radare2/libr/asm/p/asm_or1k.c" 3 4
                                                 unsigned char 
# 107 "project/radare2/libr/asm/p/asm_or1k.c"
                                                     *buf, int len) {
 
# 108 "project/radare2/libr/asm/p/asm_or1k.c" 3 4
unsigned int 
# 108 "project/radare2/libr/asm/p/asm_or1k.c"
     insn, opcode;
 
# 109 "project/radare2/libr/asm/p/asm_or1k.c" 3 4
unsigned char 
# 109 "project/radare2/libr/asm/p/asm_or1k.c"
    opcode_idx;
 char *line = 
# 110 "project/radare2/libr/asm/p/asm_or1k.c" 3 4
             ((void *)0)
# 110 "project/radare2/libr/asm/p/asm_or1k.c"
                 ;
 insn_t *insn_descr;
 ...
 op->size = 4;
 opcode = (insn & (0x3fULL * 0x4000000));
 opcode_idx = opcode >> 26;
...
# 146 "project/radare2/libr/asm/p/asm_or1k.c" 3 4
                                                                       ((void *)0)
# 146 "project/radare2/libr/asm/p/asm_or1k.c"
                                                                           ) {
  ...
  insn_to_str(a, &line, insn_descr, 
# 154 "project/radare2/libr/asm/p/asm_or1k.c" 3 4
                                   ((void *)0)
# 154 "project/radare2/libr/asm/p/asm_or1k.c"
                                       , insn);
  r_strbuf_set (&op->buf_asm, line);
 }
 return op->size;
...
RAsmPlugin r_asm_plugin_or1k = {
 ...
 .bits = 32,
 .endian = 
# 166 "project/radare2/libr/asm/p/asm_or1k.c" 3 4
          2
# 166 "project/radare2/libr/asm/p/asm_or1k.c"
                          ,
...
# 171 "project/radare2/libr/asm/p/asm_or1k.c" 3 4
__attribute__((visibility("default"))) 
# 171 "project/radare2/libr/asm/p/asm_or1k.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM, .data = &r_asm_plugin_or1k, .version = 
# 172 "project/radare2/libr/asm/p/asm_or1k.c" 3 4
                                                               "5.5.4"
# 172 "project/radare2/libr/asm/p/asm_or1k.c"
                                                                         };
