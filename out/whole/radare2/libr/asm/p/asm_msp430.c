# 0 "project/radare2/libr/asm/p/asm_msp430.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/p/asm_msp430.c"
...
# 4 "project/radare2/libr/asm/p/asm_msp430.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_msp430.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_msp430.c" 2
...
# 7 "project/radare2/libr/asm/p/asm_msp430.c" 2
...
# 8 "project/radare2/libr/asm/p/asm_msp430.c" 2

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/msp430/msp430_disas.h" 1 3 4
...
int msp430_decode_command(const unsigned char *instr, int len, struct msp430_cmd *cmd);
# 10 "project/radare2/libr/asm/p/asm_msp430.c" 2


# 11 "project/radare2/libr/asm/p/asm_msp430.c"
static int disassemble(RAsm *a, RAsmOp *op, const 
# 11 "project/radare2/libr/asm/p/asm_msp430.c" 3 4
                                                 unsigned char 
# 11 "project/radare2/libr/asm/p/asm_msp430.c"
                                                     *buf, int len) {
...
RAsmPlugin r_asm_plugin_msp430 = {
 ...
 .bits = 16,
 .endian = 
# 38 "project/radare2/libr/asm/p/asm_msp430.c" 3 4
          1
# 38 "project/radare2/libr/asm/p/asm_msp430.c"
                             ,
...
# 43 "project/radare2/libr/asm/p/asm_msp430.c" 3 4
__attribute__((visibility("default"))) 
# 43 "project/radare2/libr/asm/p/asm_msp430.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_msp430,
 .version = 
# 46 "project/radare2/libr/asm/p/asm_msp430.c" 3 4
           "5.5.4"

# 47 "project/radare2/libr/asm/p/asm_msp430.c"
};
