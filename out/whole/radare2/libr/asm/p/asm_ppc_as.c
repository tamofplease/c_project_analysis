# 0 "project/radare2/libr/asm/p/asm_ppc_as.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/p/asm_ppc_as.c"
...
# 4 "project/radare2/libr/asm/p/asm_ppc_as.c" 2
# 1 "project/radare2/libr/asm/p/../binutils_as.h" 1
...
# 6 "project/radare2/libr/asm/p/../binutils_as.h" 2


# 7 "project/radare2/libr/asm/p/../binutils_as.h"
int binutils_assemble(RAsm *a, RAsmOp *op, const char *buf, const char *as, const char *env, const char *header, const char *cmd_opt);
# 5 "project/radare2/libr/asm/p/asm_ppc_as.c" 2
...
# 15 "project/radare2/libr/asm/p/asm_ppc_as.c" 3 4
__builtin___snprintf_chk (
# 15 "project/radare2/libr/asm/p/asm_ppc_as.c"
cmd_opt
# 15 "project/radare2/libr/asm/p/asm_ppc_as.c" 3 4
, 
# 15 "project/radare2/libr/asm/p/asm_ppc_as.c"
...
, 2 > 1 ? 1 : 0), 
# 15 "project/radare2/libr/asm/p/asm_ppc_as.c"
"-mregnames -a%d %s", a->bits, a->big_endian ? "-be" : "-le"
# 15 "project/radare2/libr/asm/p/asm_ppc_as.c" 3 4
)
                                         
# 16 "project/radare2/libr/asm/p/asm_ppc_as.c"
                                        ;
 return binutils_assemble (a, op, buf,
  as, "R2_PPC_AS", "", cmd_opt);
}

RAsmPlugin r_asm_plugin_ppc_as = {
 .name = "ppc.as",
 .desc = "as PPC Assembler (use ""R2_PPC_AS"" environment)",
 .arch = "ppc",
 .author = "eagleoflqj",
 .license = "LGPL3",
 .bits = 32 | 64,
 .endian = 
# 28 "project/radare2/libr/asm/p/asm_ppc_as.c" 3 4
          1 
# 28 "project/radare2/libr/asm/p/asm_ppc_as.c"
                              | 
# 28 "project/radare2/libr/asm/p/asm_ppc_as.c" 3 4
                                2
# 28 "project/radare2/libr/asm/p/asm_ppc_as.c"
...
# 33 "project/radare2/libr/asm/p/asm_ppc_as.c" 3 4
__attribute__((visibility("default"))) 
# 33 "project/radare2/libr/asm/p/asm_ppc_as.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_ppc_as,
 .version = 
# 36 "project/radare2/libr/asm/p/asm_ppc_as.c" 3 4
           "5.5.4"

# 37 "project/radare2/libr/asm/p/asm_ppc_as.c"
};
