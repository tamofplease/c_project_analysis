# 0 "project/radare2/libr/asm/p/asm_snes.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/p/asm_snes.c"
...
# 4 "project/radare2/libr/asm/p/asm_snes.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_snes.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_snes.c" 2
...
# 7 "project/radare2/libr/asm/p/asm_snes.c" 2
# 1 "project/radare2/libr/asm/p/../arch/snes/snesdis.c" 1
...
# 1 "project/radare2/libr/asm/p/../arch/snes/snes_op_table.h" 1
...
# 8 "project/radare2/libr/asm/p/../arch/snes/snes_op_table.h"
enum {
 SNES_OP_8BIT = 1,
 SNES_OP_16BIT,
 SNES_OP_24BIT,
...
# 19 "project/radare2/libr/asm/p/../arch/snes/snes_op_table.h" 3 4
unsigned char 
# 19 "project/radare2/libr/asm/p/../arch/snes/snes_op_table.h"
    len;
 
# 20 "project/radare2/libr/asm/p/../arch/snes/snes_op_table.h" 3 4
unsigned char 
# 20 "project/radare2/libr/asm/p/../arch/snes/snes_op_table.h"
    flags;
} snes_op_t;
...
# 9 "project/radare2/libr/asm/p/../arch/snes/snesdis.c" 2

static int snesDisass(int M_flag, int X_flag, 
# 10 "project/radare2/libr/asm/p/../arch/snes/snesdis.c" 3 4
                                             unsigned long long 
# 10 "project/radare2/libr/asm/p/../arch/snes/snesdis.c"
                                                  pc, RAsmOp *op, const 
# 10 "project/radare2/libr/asm/p/../arch/snes/snesdis.c" 3 4
                                                                        unsigned char 
# 10 "project/radare2/libr/asm/p/../arch/snes/snesdis.c"
 ...
 case SNES_OP_8BIT:
  ...
  break;
 case SNES_OP_16BIT:
  if (*buf % 0x20 == 0x10 || *buf == 0x80) {
   buf_asm = sdb_fmt (s_op->name, (
# 23 "project/radare2/libr/asm/p/../arch/snes/snesdis.c" 3 4
                                  unsigned int
# 23 "project/radare2/libr/asm/p/../arch/snes/snesdis.c"
                                      )(pc + 2 + (
# 23 "project/radare2/libr/asm/p/../arch/snes/snesdis.c" 3 4
                                                  signed char
# 23 "project/radare2/libr/asm/p/../arch/snes/snesdis.c"
 ...
 case SNES_OP_24BIT:
  if (*buf == 0x44 || *buf == 0x54) {
   ...
   buf_asm = sdb_fmt (s_op->name, pc + 3 + (
# 32 "project/radare2/libr/asm/p/../arch/snes/snesdis.c" 3 4
                                           short
# 32 "project/radare2/libr/asm/p/../arch/snes/snesdis.c"
                                               )
# 32 "project/radare2/libr/asm/p/../arch/snes/snesdis.c" 3 4
                                                ((
# 32 "project/radare2/libr/asm/p/../arch/snes/snesdis.c"
...
# 32 "project/radare2/libr/asm/p/../arch/snes/snesdis.c"
   ...
   buf_asm = sdb_fmt (s_op->name, 
# 34 "project/radare2/libr/asm/p/../arch/snes/snesdis.c" 3 4
                                 ((
# 34 "project/radare2/libr/asm/p/../arch/snes/snesdis.c"
                                 buf + 1
# 34 "project/radare2/libr/asm/p/../arch/snes/snesdis.c" 3 4
                                 )[0]|((
# 34 "project/radare2/libr/asm/p/../arch/snes/snesdis.c"
...
# 34 "project/radare2/libr/asm/p/../arch/snes/snesdis.c"
 ...
 case SNES_OP_IMM_M:
  if (M_flag) {
   ...
   buf_asm = sdb_fmt ("%s #0x%04x", s_op->name, 
# 44 "project/radare2/libr/asm/p/../arch/snes/snesdis.c" 3 4
                                               ((
# 44 "project/radare2/libr/asm/p/../arch/snes/snesdis.c"
                                               buf + 1
# 44 "project/radare2/libr/asm/p/../arch/snes/snesdis.c" 3 4
                                               )[0]|((
# 44 "project/radare2/libr/asm/p/../arch/snes/snesdis.c"
...
# 44 "project/radare2/libr/asm/p/../arch/snes/snesdis.c"
 ...
 case SNES_OP_IMM_X:
  if (X_flag) {
   ...
   buf_asm = sdb_fmt ("%s #0x%04x", s_op->name, 
# 51 "project/radare2/libr/asm/p/../arch/snes/snesdis.c" 3 4
                                               ((
# 51 "project/radare2/libr/asm/p/../arch/snes/snesdis.c"
                                               buf + 1
# 51 "project/radare2/libr/asm/p/../arch/snes/snesdis.c" 3 4
                                               )[0]|((
# 51 "project/radare2/libr/asm/p/../arch/snes/snesdis.c"
...
# 8 "project/radare2/libr/asm/p/asm_snes.c" 2
# 1 "project/radare2/libr/asm/p/asm_snes.h" 1
...
# 9 "project/radare2/libr/asm/p/asm_snes.c" 2

static struct snes_asm_flags* snesflags = 
# 10 "project/radare2/libr/asm/p/asm_snes.c" 3 4
                                         ((void *)0)
# 10 "project/radare2/libr/asm/p/asm_snes.c"
                                             ;

static 
# 12 "project/radare2/libr/asm/p/asm_snes.c" 3 4
      _Bool 
# 12 "project/radare2/libr/asm/p/asm_snes.c"
           snes_asm_init (void* user) {
 if (!snesflags) {
  snesflags = malloc (sizeof (struct snes_asm_flags));
 }
 
# 16 "project/radare2/libr/asm/p/asm_snes.c" 3 4
__builtin___memset_chk (
# 16 "project/radare2/libr/asm/p/asm_snes.c"
snesflags
# 16 "project/radare2/libr/asm/p/asm_snes.c" 3 4
, 
# 16 "project/radare2/libr/asm/p/asm_snes.c"
0,sizeof (struct snes_asm_flags)
# 16 "project/radare2/libr/asm/p/asm_snes.c" 3 4
...
static 
# 20 "project/radare2/libr/asm/p/asm_snes.c" 3 4
      _Bool 
# 20 "project/radare2/libr/asm/p/asm_snes.c"
           snes_asm_fini (void* user) {
 free(snesflags);
 snesflags = 
# 22 "project/radare2/libr/asm/p/asm_snes.c" 3 4
            ((void *)0)
# 22 "project/radare2/libr/asm/p/asm_snes.c"
                ;
 return 0;
}

static int dis(RAsm *a, RAsmOp *op, const 
# 26 "project/radare2/libr/asm/p/asm_snes.c" 3 4
                                         unsigned char 
# 26 "project/radare2/libr/asm/p/asm_snes.c"
                                             *buf, int len) {
...
RAsmPlugin r_asm_plugin_snes = {
 ...
 .fini = snes_asm_fini,
 .endian = 
# 57 "project/radare2/libr/asm/p/asm_snes.c" 3 4
          1
# 57 "project/radare2/libr/asm/p/asm_snes.c"
                             ,
 .license = "LGPL3",
 .disassemble = &dis
};
...
# 63 "project/radare2/libr/asm/p/asm_snes.c" 3 4
__attribute__((visibility("default"))) 
# 63 "project/radare2/libr/asm/p/asm_snes.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_snes,
 .version = 
# 66 "project/radare2/libr/asm/p/asm_snes.c" 3 4
           "5.5.4"

# 67 "project/radare2/libr/asm/p/asm_snes.c"
};
