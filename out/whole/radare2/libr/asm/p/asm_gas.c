# 0 "project/radare2/libr/asm/p/asm_gas.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/p/asm_gas.c"
...
# 4 "project/radare2/libr/asm/p/asm_gas.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_gas.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_gas.c" 2
...
# 7 "project/radare2/libr/asm/p/asm_gas.c" 2


# 8 "project/radare2/libr/asm/p/asm_gas.c"
static int assemble(RAsm *a, RAsmOp *op, const char *buf) {
 int len = 0;
 
# 10 "project/radare2/libr/asm/p/asm_gas.c" 3 4
unsigned char 
# 10 "project/radare2/libr/asm/p/asm_gas.c"
    *out;
 char *cmd = r_str_newf (
  "gas /dev/stdin -o /dev/stdout <<__\n"
  "BITS %i\nORG 0x%"
# 13 "project/radare2/libr/asm/p/asm_gas.c" 3 4
                   "llx"
# 13 "project/radare2/libr/asm/p/asm_gas.c"
                          "\n%s\n__",
  a->bits, a->pc, buf);
 
# 15 "project/radare2/libr/asm/p/asm_gas.c" 3 4
unsigned char 
# 15 "project/radare2/libr/asm/p/asm_gas.c"
    *out = (
# 15 "project/radare2/libr/asm/p/asm_gas.c" 3 4
            unsigned char 
# 15 "project/radare2/libr/asm/p/asm_gas.c"
                *)r_sys_cmd_str (cmd, "", &len);
 if (out) {
...
RAsmPlugin r_asm_plugin_x86_gas = {
 ...
 .bits = 16|32|64,
 .endian = 
# 30 "project/radare2/libr/asm/p/asm_gas.c" 3 4
          1
# 30 "project/radare2/libr/asm/p/asm_gas.c"
                             ,
 .assemble = &assemble
};
...
# 35 "project/radare2/libr/asm/p/asm_gas.c" 3 4
__attribute__((visibility("default"))) 
# 35 "project/radare2/libr/asm/p/asm_gas.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_x86_gas,
 .version = 
# 38 "project/radare2/libr/asm/p/asm_gas.c" 3 4
           "5.5.4"

# 39 "project/radare2/libr/asm/p/asm_gas.c"
};
