# 0 "project/radare2/libr/asm/p/asm_dcpu16.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/asm/p/asm_dcpu16.c" 2
# 1 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include/stdarg.h" 1 3 4
...
#define __va_list__ 
# 5 "project/radare2/libr/asm/p/asm_dcpu16.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_dcpu16.c" 2
...
# 7 "project/radare2/libr/asm/p/asm_dcpu16.c" 2
...
# 8 "project/radare2/libr/asm/p/asm_dcpu16.c" 2
...
# 9 "project/radare2/libr/asm/p/asm_dcpu16.c" 2
...
# 10 "project/radare2/libr/asm/p/asm_dcpu16.c" 2
# 1 "project/radare2/libr/asm/p/../arch/dcpu16/dcpu16.h" 1
...
# 9 "project/radare2/libr/asm/p/../arch/dcpu16/dcpu16.h"
int dcpu16_disasm(char *out, size_t size_out, const 
# 9 "project/radare2/libr/asm/p/../arch/dcpu16/dcpu16.h" 3 4
                                                   unsigned short 
# 9 "project/radare2/libr/asm/p/../arch/dcpu16/dcpu16.h"
                                                        *inp, int len, int *cost);
int dcpu16_assemble(
# 10 "project/radare2/libr/asm/p/../arch/dcpu16/dcpu16.h" 3 4
                   unsigned char
# 10 "project/radare2/libr/asm/p/../arch/dcpu16/dcpu16.h"
                      * out, const char* unoline);
# 11 "project/radare2/libr/asm/p/asm_dcpu16.c" 2
# 1 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 1
...
# 1 "project/radare2/libr/asm/p/../arch/dcpu16/dcpu16.h" 1
# 8 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 2


struct op_code {
 
# 11 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
unsigned char 
# 11 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
    opcode;
};

struct op_basic {
 
# 15 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
unsigned char 
# 15 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
    opcode;
 
# 16 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
unsigned char 
# 16 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
    a_type;
 
# 17 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
unsigned char 
# 17 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
    b_type;

 
# 19 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
unsigned short 
# 19 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
     a;
 
# 20 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
unsigned short 
# 20 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
     b;
};

struct op_nbasic {
 
# 24 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
unsigned char 
# 24 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
    __empty;
 
# 25 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
unsigned char 
# 25 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
    a_type;
 
# 26 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
unsigned char 
# 26 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
    opcode;
 
# 27 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
unsigned short 
# 27 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
     a;
};
...
static inline int needWord(
# 55 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                          unsigned char 
# 55 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
                              type) {
 return ((type <= 0x17) && (type > 0x0f))
  || (type == 0x1e) || (type == 0x1f);
}

static int valPrint(char *out, size_t len, 
# 60 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                                          unsigned char 
# 60 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
                                              type, 
# 60 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                                                    unsigned short 
# 60 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
                                                         value) {
 if (type <= 0x07) return 
# 61 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                         __builtin___snprintf_chk (
# 61 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
                         out
# 61 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                         , 
# 61 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
...
# 61 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
                                                              ;
 if (type <= 0x0f) return 
# 62 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                         __builtin___snprintf_chk (
# 62 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
                         out
# 62 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                         , 
# 62 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
...
# 62 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
                                                                       ;
 if (type <= 0x17) return 
# 63 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                         __builtin___snprintf_chk (
# 63 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
                         out
# 63 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                         , 
# 63 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
...
# 63 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                         , 2 > 1 ? 1 : 0), 
# 63 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
                         "[%s + %#hx]", regs[type - 0x10], value
# 63 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                         )
# 63 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
                                                                                     ;
 if (type <= 0x1d) return 
# 64 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                         __builtin___snprintf_chk (
# 64 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
                         out
# 64 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                         , 
# 64 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
...
# 64 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                         , 2 > 1 ? 1 : 0), 
# 64 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
                         "%s", regs[type - 0x18 + 0x08]
# 64 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                         )
# 64 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
                                                                            ;
 if (type == 0x1e) return 
# 65 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                         __builtin___snprintf_chk (
# 65 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
                         out
# 65 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                         , 
# 65 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
...
# 65 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
                                                             ;
 if (type == 0x1f) return 
# 66 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                         __builtin___snprintf_chk (
# 66 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
                         out
# 66 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                         , 
# 66 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
...
# 66 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
                                                           ;
 return 
# 67 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
       __builtin___snprintf_chk (
# 67 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
       out
# 67 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
       , 
# 67 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
...
# 75 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
  __builtin___strcpy_chk (
# 75 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
  out
# 75 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
  , 
# 75 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
...
# 75 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
  ...
  return 
# 78 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
        __builtin___sprintf_chk (
# 78 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
        out
# 78 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
        , 0, __builtin_object_size (
# 78 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
...
# 78 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
        , 2 > 1 ? 1 : 0), 
# 78 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
        "%s %s", opNameB[o->n.opcode], arg
# 78 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
        )
                             
# 79 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
                            ;
 }
 valPrint (arg, sizeof (arg), o->b.a_type, o->b.a);
 valPrint (arg2, sizeof (arg2), o->b.b_type, o->b.b);
 return 
# 83 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
       __builtin___sprintf_chk (
# 83 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
       out
# 83 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
       , 0, __builtin_object_size (
# 83 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
...
# 83 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
       , 2 > 1 ? 1 : 0), 
# 83 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
       "%s %s, %s", opName[o->b.opcode], arg, arg2
# 83 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
       )
# 83 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
                                                                ;
...
static int instrGet(
# 86 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                   unsigned short 
# 86 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
                        in, op* o, 
# 86 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                                   unsigned short 
# 86 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
...
int dcpu16_disasm(char *out, size_t size_out, const 
# 124 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c" 3 4
                                                   unsigned short
# 124 "project/radare2/libr/asm/p/../arch/dcpu16/dis.c"
                                                       * inp, int len, int *cost) {
 op o = {{0}};
...
# 12 "project/radare2/libr/asm/p/asm_dcpu16.c" 2
# 1 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 1
# 36 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
#define NOTEND 1

static 
# 38 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
      unsigned char 
# 38 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
          get_register_id(char reg) {
...
static 
# 67 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
      unsigned char 
# 67 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
          decode_parameter(char* param, int* extra_word_needed, 
# 67 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
                                                                unsigned short
# 67 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
                                                                    * extra_word_value) {
 ...
 if (first_sqbracket == 1) {
  ...
  if (last_sqbracket != 1) {
   fprintf (
# 84 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
           __stderrp
# 84 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
  ...
  if (last_sqbracket == 1) {
   fprintf (
# 89 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
           __stderrp
# 89 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
...
# 97 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
 unsigned short 
# 97 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
      value = 0;
  param = param + 2;
  ...
  for (digit_num = 0; digit_num < digit_count; digit_num++) {
   ...
   if (current_digit == '+' && square_brackets == 1) {
    ...
    if (digit_val == -1) {
     fprintf (
# 117 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
             __stderrp
# 117 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
                   , "invalid literal\n");
     return 0;
    }
...
# 143 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
 unsigned short 
# 143 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
      value = 0;
  int digit_count = strlen(param);
  int digit_num = 0;
  int reg = -1;
  for (digit_num = 0; digit_num < digit_count; digit_num++) {
   ...
   if (current_digit == '+' && square_brackets == 1) {
    ...
    if (digit_val == -1) {
     fprintf (
# 160 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
             __stderrp
# 160 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
                   , "invalid literal\n");
     return 0;
    }
...
# 184 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
 unsigned char 
# 184 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
     reg = get_register_id (param[0]);
  if (square_brackets == 1)
   reg += 0x08;
  return reg;
 }
...
int dcpu16_assemble (
# 206 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
                    unsigned char
# 206 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
                       * out, const char* unoline) {
 
# 207 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
unsigned short 
# 207 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
     wordA = 0, wordB = 0;
 int basic_opcode = 0;
 ...
 if (basic_opcode == 0) {
  if (!strncmp ("JSR", line, 3)) {
   ...
   fprintf (
# 242 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
           __stderrp
# 242 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
                 , "Unknown instruction\n");
   return -1;
  }
 }
...
# 249 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
 unsigned char 
# 249 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
     paramA = 0, paramB = 0;
...
# 260 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
  unsigned short 
# 260 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
       first_word;
   int extraA = 0;
   int extraB = 0;
   char *pa, *pb;
...
# 285 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
  __builtin___memcpy_chk (
# 285 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
  out
# 285 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
  , 
# 285 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
...
# 287 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
   __builtin___memcpy_chk (
# 287 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
   out+2
# 287 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
   , 
# 287 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
...
# 291 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
   __builtin___memcpy_chk (
# 291 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
   out+off
# 291 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
   , 
# 291 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
...
# 308 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
  } else {
   fprintf (
# 309 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
           __stderrp
# 309 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
                 , "Missing comma\n");
   return -1;
  }
 }
...
# 317 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
 unsigned short 
# 317 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
      first_word, wordX = 0;
  
# 318 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
 unsigned char 
# 318 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
     p = decode_parameter (param, &extraX, &wordX);
...
# 324 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
 __builtin___memcpy_chk (
# 324 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
 out
# 324 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
 , 
# 324 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
...
# 326 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
  __builtin___memcpy_chk (
# 326 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
  out+2
# 326 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c" 3 4
  , 
# 326 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
...
# 338 "project/radare2/libr/asm/p/../arch/dcpu16/asm.c"
 }
 return off;
}
# 13 "project/radare2/libr/asm/p/asm_dcpu16.c" 2

static int disassemble(RAsm *a, RAsmOp *op, const 
# 14 "project/radare2/libr/asm/p/asm_dcpu16.c" 3 4
                                                 unsigned char 
# 14 "project/radare2/libr/asm/p/asm_dcpu16.c"
                                                     *buf, int len) {
 char buf_asm[96];
 if (len < 2) {
  return -1;
 }
 op->size = dcpu16_disasm (buf_asm, sizeof (buf_asm), (const 
# 19 "project/radare2/libr/asm/p/asm_dcpu16.c" 3 4
                                                            unsigned short
# 19 "project/radare2/libr/asm/p/asm_dcpu16.c"
                                                                *)buf, len, 
# 19 "project/radare2/libr/asm/p/asm_dcpu16.c" 3 4
                                                                            ((void *)0)
# 19 "project/radare2/libr/asm/p/asm_dcpu16.c"
...
static int assemble(RAsm *a, RAsmOp *op, const char *buf) {
 int len = dcpu16_assemble ((
# 25 "project/radare2/libr/asm/p/asm_dcpu16.c" 3 4
                            unsigned char
# 25 "project/radare2/libr/asm/p/asm_dcpu16.c"
...
RAsmPlugin r_asm_plugin_dcpu16 = {
 ...
 .bits = 16,
 .endian = 
# 34 "project/radare2/libr/asm/p/asm_dcpu16.c" 3 4
          1
# 34 "project/radare2/libr/asm/p/asm_dcpu16.c"
                             ,
...
# 42 "project/radare2/libr/asm/p/asm_dcpu16.c" 3 4
__attribute__((visibility("default"))) 
# 42 "project/radare2/libr/asm/p/asm_dcpu16.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_dcpu16,
 .version = 
# 45 "project/radare2/libr/asm/p/asm_dcpu16.c" 3 4
           "5.5.4"

# 46 "project/radare2/libr/asm/p/asm_dcpu16.c"
};
