# 0 "project/radare2/libr/asm/p/asm_chip8.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/p/asm_chip8.c"
...
# 4 "project/radare2/libr/asm/p/asm_chip8.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_chip8.c" 2


# 6 "project/radare2/libr/asm/p/asm_chip8.c"
static int disassemble(RAsm *a, RAsmOp *op, const 
# 6 "project/radare2/libr/asm/p/asm_chip8.c" 3 4
                                                 unsigned char 
# 6 "project/radare2/libr/asm/p/asm_chip8.c"
                                                     *b, int l) {
 
# 7 "project/radare2/libr/asm/p/asm_chip8.c" 3 4
unsigned short 
# 7 "project/radare2/libr/asm/p/asm_chip8.c"
     opcode = r_read_be16 (b);
...
# 101 "project/radare2/libr/asm/p/asm_chip8.c" 3 4
__attribute__((visibility("default"))) 
# 101 "project/radare2/libr/asm/p/asm_chip8.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_chip8,
 .version = 
# 104 "project/radare2/libr/asm/p/asm_chip8.c" 3 4
           "5.5.4"

# 105 "project/radare2/libr/asm/p/asm_chip8.c"
};
