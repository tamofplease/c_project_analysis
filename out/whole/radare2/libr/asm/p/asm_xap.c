# 0 "project/radare2/libr/asm/p/asm_xap.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/p/asm_xap.c"
...
# 4 "project/radare2/libr/asm/p/asm_xap.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_xap.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_xap.c" 2
...
# 7 "project/radare2/libr/asm/p/asm_xap.c" 2
...
# 8 "project/radare2/libr/asm/p/asm_xap.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/xap/dis.c" 1 3 4




# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/fcntl.h" 1 3 4
# 6 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/xap/dis.c" 2 3 4



# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/xap/dis.h" 1 3 4
...
# 10 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/xap/dis.c" 2 3 4
...
static inline struct state *get_state(void) {
 __builtin___memset_chk (&_state, 0, sizeof (struct state), __builtin_object_size (&_state, 0));
 return &_state;
}
...
# 37 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/xap/dis.c" 3 4
static void decode_unknown(struct state *s, struct directive *d) {




 __builtin___sprintf_chk (d->d_asm, 0, __builtin_object_size (d->d_asm, 2 > 1 ? 1 : 0), "DC 0x%4x", i2u16(&d->d_inst));
}
 ...
 *d->d_asm = '\0';
 ...
 case 0x0000:
  ...
  s->s_nop++;
  __builtin___strcpy_chk (d->d_asm, "nop", __builtin_object_size (d->d_asm, 2 > 1 ? 1 : 0));
  break;
 case 0x0004: __builtin___strcpy_chk (d->d_asm, "brk", __builtin_object_size (d->d_asm, 2 > 1 ? 1 : 0)); break;
 case 0x0008: __builtin___strcpy_chk (d->d_asm, "sleep", __builtin_object_size (d->d_asm, 2 > 1 ? 1 : 0)); break;
 case 0x000C: __builtin___strcpy_chk (d->d_asm, "sif", __builtin_object_size (d->d_asm, 2 > 1 ? 1 : 0)); break;
 case 0xff09: __builtin___strcpy_chk (d->d_asm, "bc", __builtin_object_size (d->d_asm, 2 > 1 ? 1 : 0)); break;
 case 0xfe09: __builtin___strcpy_chk (d->d_asm, "brxl", __builtin_object_size (d->d_asm, 2 > 1 ? 1 : 0)); break;
 case 0x0009: __builtin___strcpy_chk (d->d_asm, "", __builtin_object_size (d->d_asm, 2 > 1 ? 1 : 0)); s->s_u = 1; break;
 case 0x00E2: __builtin___strcpy_chk (d->d_asm, "rts", __builtin_object_size (d->d_asm, 2 > 1 ? 1 : 0)); break;
 }
 return d->d_asm[0]!=0;
}
...
static int decode_known(struct state *s, struct directive *d) {
 ...
 case 0:
  if (in->in_reg == 0 && in->in_mode == 0) {
   ...
   __builtin___strcpy_chk (d->d_asm, "", __builtin_object_size (d->d_asm, 2 > 1 ? 1 : 0));
   return 1;
  }
 ...
 __builtin___sprintf_chk (d->d_asm, 0, __builtin_object_size (d->d_asm, 2 > 1 ? 1 : 0), "%s ", op);
 if (reg) {
  char *r = regn;
  if (!r) {
   r = regname (in->in_reg);
  ...
  if (r && !rti) {
   if ((strlen (r) + 4 + strlen (d->d_asm)) < sizeof (d->d_asm)) {
    __builtin___strcat_chk (d->d_asm, r, __builtin_object_size (d->d_asm, 2 > 1 ? 1 : 0));
    __builtin___strcat_chk (d->d_asm, ", ", __builtin_object_size (d->d_asm, 2 > 1 ? 1 : 0));
   }
  }
 }
 if (ptr) {
 ...
 __builtin___snprintf_chk (fmt, sizeof (fmt), 0, __builtin_object_size (fmt, 2 > 1 ? 1 : 0), "%s0x%%.%dX", sign, fmtsz);
 __builtin___snprintf_chk (tmp, sizeof (tmp), 0, __builtin_object_size (tmp, 2 > 1 ? 1 : 0), fmt, d->d_operand);
 __builtin___strcat_chk (d->d_asm, tmp, __builtin_object_size (d->d_asm, 2 > 1 ? 1 : 0));

 if (idx) {
  char *r = in->in_mode == 2 ? "X" : "Y";
  if (regn) r = "Y";
  __builtin___snprintf_chk (tmp, sizeof(tmp), 0, __builtin_object_size (tmp, 2 > 1 ? 1 : 0), ", %s", r);
  __builtin___strcat_chk (d->d_asm, tmp, __builtin_object_size (d->d_asm, 2 > 1 ? 1 : 0));
  if (ptr)
   __builtin___strcat_chk (d->d_asm, ")", __builtin_object_size (d->d_asm, 2 > 1 ? 1 : 0));
 }
# 445 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/xap/dis.c" 3 4
 return 1;
}
...
static int read_bin(struct state *s, struct directive *d) {
 __builtin___memcpy_chk (&d->d_inst, s->s_buf, sizeof(d->d_inst), __builtin_object_size (&d->d_inst, 0));
 d->d_off = s->s_off++;
 return 1;
}
...
static inline struct directive *next_inst(struct state *s) {
 ...
 __builtin___memset_chk (d, 0, sizeof (*d), __builtin_object_size (d, 0));
...
# 9 "project/radare2/libr/asm/p/asm_xap.c" 2


# 10 "project/radare2/libr/asm/p/asm_xap.c"
static int arch_xap_disasm(char *str, const unsigned char *buf, 
# 10 "project/radare2/libr/asm/p/asm_xap.c" 3 4
                                                               unsigned long long 
# 10 "project/radare2/libr/asm/p/asm_xap.c"
                                                                    seek) {
...
# 13 "project/radare2/libr/asm/p/asm_xap.c" 3 4
__builtin___memset_chk (
# 13 "project/radare2/libr/asm/p/asm_xap.c"
s
# 13 "project/radare2/libr/asm/p/asm_xap.c" 3 4
, 
# 13 "project/radare2/libr/asm/p/asm_xap.c"
...
# 13 "project/radare2/libr/asm/p/asm_xap.c"
 ...
 s->s_off = seek;
 s->s_out = 
# 16 "project/radare2/libr/asm/p/asm_xap.c" 3 4
           ((void *)0)
# 16 "project/radare2/libr/asm/p/asm_xap.c"
               ;
 d = next_inst(s);
 if (d != 
# 18 "project/radare2/libr/asm/p/asm_xap.c" 3 4
         ((void *)0)
# 18 "project/radare2/libr/asm/p/asm_xap.c"
             ) {
  xap_decode (s, d);
  
# 20 "project/radare2/libr/asm/p/asm_xap.c" 3 4
 __builtin___strcpy_chk (
# 20 "project/radare2/libr/asm/p/asm_xap.c"
 str
# 20 "project/radare2/libr/asm/p/asm_xap.c" 3 4
 , 
# 20 "project/radare2/libr/asm/p/asm_xap.c"
...
static int disassemble(RAsm *a, struct r_asm_op_t *op, const 
# 33 "project/radare2/libr/asm/p/asm_xap.c" 3 4
                                                            unsigned char 
# 33 "project/radare2/libr/asm/p/asm_xap.c"
                                                                *buf, int len) {
...
RAsmPlugin r_asm_plugin_xap = {
 ...
 .bits = 16,
 .endian = 
# 44 "project/radare2/libr/asm/p/asm_xap.c" 3 4
          1
# 44 "project/radare2/libr/asm/p/asm_xap.c"
                             ,
 .desc = "XAP4 RISC (CSR)",
...
# 50 "project/radare2/libr/asm/p/asm_xap.c" 3 4
__attribute__((visibility("default"))) 
# 50 "project/radare2/libr/asm/p/asm_xap.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_xap,
 .version = 
# 53 "project/radare2/libr/asm/p/asm_xap.c" 3 4
           "5.5.4"

# 54 "project/radare2/libr/asm/p/asm_xap.c"
};
