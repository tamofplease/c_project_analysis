# 0 "project/radare2/libr/asm/p/asm_malbolge.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/p/asm_malbolge.c"
...
# 4 "project/radare2/libr/asm/p/asm_malbolge.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_malbolge.c" 2



# 8 "project/radare2/libr/asm/p/asm_malbolge.c"
static const char *mal_dis(
# 8 "project/radare2/libr/asm/p/asm_malbolge.c" 3 4
                          unsigned long long 
# 8 "project/radare2/libr/asm/p/asm_malbolge.c"
                               c, const 
# 8 "project/radare2/libr/asm/p/asm_malbolge.c" 3 4
...
# 8 "project/radare2/libr/asm/p/asm_malbolge.c"
 ...
 return 
# 21 "project/radare2/libr/asm/p/asm_malbolge.c" 3 4
       ((void *)0)
# 21 "project/radare2/libr/asm/p/asm_malbolge.c"
           ;
}

static int __disassemble(RAsm *a, RAsmOp *op, const 
# 24 "project/radare2/libr/asm/p/asm_malbolge.c" 3 4
                                                   unsigned char 
# 24 "project/radare2/libr/asm/p/asm_malbolge.c"
                                                       *buf, int len) {
...
RAsmPlugin r_asm_plugin_malbolge = {
 ...
 .bits = 32,
 .endian = 
# 36 "project/radare2/libr/asm/p/asm_malbolge.c" 3 4
          0
# 36 "project/radare2/libr/asm/p/asm_malbolge.c"
                           ,
...
# 41 "project/radare2/libr/asm/p/asm_malbolge.c" 3 4
__attribute__((visibility("default"))) 
# 41 "project/radare2/libr/asm/p/asm_malbolge.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_malbolge,
 .version = 
# 44 "project/radare2/libr/asm/p/asm_malbolge.c" 3 4
           "5.5.4"

# 45 "project/radare2/libr/asm/p/asm_malbolge.c"
};
