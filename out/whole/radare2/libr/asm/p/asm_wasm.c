# 0 "project/radare2/libr/asm/p/asm_wasm.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 6 "project/radare2/libr/asm/p/asm_wasm.c" 2
...
# 7 "project/radare2/libr/asm/p/asm_wasm.c" 2
...
# 8 "project/radare2/libr/asm/p/asm_wasm.c" 2
...
# 9 "project/radare2/libr/asm/p/asm_wasm.c" 2
...
# 10 "project/radare2/libr/asm/p/asm_wasm.c" 2

# 1 "project/radare2/libr/asm/p/../arch/wasm/wasm.h" 1
...
# 8 "project/radare2/libr/asm/p/../arch/wasm/wasm.h"
typedef enum {
...
# 12 "project/radare2/libr/asm/p/asm_wasm.c" 2

static int disassemble(RAsm *a, RAsmOp *op, const 
# 13 "project/radare2/libr/asm/p/asm_wasm.c" 3 4
                                                 unsigned char 
# 13 "project/radare2/libr/asm/p/asm_wasm.c"
                                                     *buf, int len) {
 WasmOp wop = {{0}};
...
# 23 "project/radare2/libr/asm/p/asm_wasm.c" 3 4
unsigned char 
# 23 "project/radare2/libr/asm/p/asm_wasm.c"
    *opbuf = (
# 23 "project/radare2/libr/asm/p/asm_wasm.c" 3 4
              unsigned char
# 23 "project/radare2/libr/asm/p/asm_wasm.c"
...
RAsmPlugin r_asm_plugin_wasm = {
 ...
 .bits = 32,
 .endian = 
# 35 "project/radare2/libr/asm/p/asm_wasm.c" 3 4
          1
# 35 "project/radare2/libr/asm/p/asm_wasm.c"
                             ,
 .desc = "WebAssembly",
...
# 42 "project/radare2/libr/asm/p/asm_wasm.c" 3 4
__attribute__((visibility("default"))) 
# 42 "project/radare2/libr/asm/p/asm_wasm.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_wasm,
 .version = 
# 45 "project/radare2/libr/asm/p/asm_wasm.c" 3 4
           "5.5.4"

# 46 "project/radare2/libr/asm/p/asm_wasm.c"
};
