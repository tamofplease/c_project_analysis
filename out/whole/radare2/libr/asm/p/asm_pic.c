# 0 "project/radare2/libr/asm/p/asm_pic.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/p/asm_pic.c"
...
# 4 "project/radare2/libr/asm/p/asm_pic.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_pic.c" 2

# 1 "project/radare2/libr/asm/p/../arch/pic/pic_baseline.h" 1
...
# 9 "project/radare2/libr/asm/p/../arch/pic/pic_baseline.h"
typedef enum {
...
PicBaselineOpcode pic_baseline_get_opcode(
# 77 "project/radare2/libr/asm/p/../arch/pic/pic_baseline.h" 3 4
                                         unsigned short 
# 77 "project/radare2/libr/asm/p/../arch/pic/pic_baseline.h"
                                              instr);
const PicBaselineOpInfo *pic_baseline_get_op_info(PicBaselineOpcode opcode);
int pic_baseline_disassemble(RAsmOp *op, char *opbuf, const 
# 79 "project/radare2/libr/asm/p/../arch/pic/pic_baseline.h" 3 4
                                                           unsigned char 
# 79 "project/radare2/libr/asm/p/../arch/pic/pic_baseline.h"
                                                               *b, int l);
# 7 "project/radare2/libr/asm/p/asm_pic.c" 2
# 1 "project/radare2/libr/asm/p/../arch/pic/pic_pic18.h" 1
...
# 8 "project/radare2/libr/asm/p/../arch/pic/pic_pic18.h" 3 4
                                                        unsigned char 
# 8 "project/radare2/libr/asm/p/../arch/pic/pic_pic18.h"
                                                            *b, int l);
# 8 "project/radare2/libr/asm/p/asm_pic.c" 2
# 1 "project/radare2/libr/asm/p/../arch/pic/pic_midrange.h" 1
...
# 99 "project/radare2/libr/asm/p/../arch/pic/pic_midrange.h" 3 4
                                          unsigned short 
# 99 "project/radare2/libr/asm/p/../arch/pic/pic_midrange.h"
                                               instr);
...
# 101 "project/radare2/libr/asm/p/../arch/pic/pic_midrange.h" 3 4
                                                            unsigned char 
# 101 "project/radare2/libr/asm/p/../arch/pic/pic_midrange.h"
                                                                *b, int l);
# 9 "project/radare2/libr/asm/p/asm_pic.c" 2

static int asm_pic_disassemble(RAsm *a, RAsmOp *op, const 
# 10 "project/radare2/libr/asm/p/asm_pic.c" 3 4
                                                         unsigned char 
# 10 "project/radare2/libr/asm/p/asm_pic.c"
                                                             *b, int l) {
 int res = -1;
 char opbuf[128];
 const char *opstr = opbuf;
 
# 14 "project/radare2/libr/asm/p/asm_pic.c" 3 4
__builtin___strcpy_chk (
# 14 "project/radare2/libr/asm/p/asm_pic.c"
opbuf
# 14 "project/radare2/libr/asm/p/asm_pic.c" 3 4
, 
# 14 "project/radare2/libr/asm/p/asm_pic.c"
...
# 37 "project/radare2/libr/asm/p/asm_pic.c" 3 4
__attribute__((visibility("default"))) 
# 37 "project/radare2/libr/asm/p/asm_pic.c"
