# 0 "project/radare2/libr/asm/p/asm_avr.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/p/asm_avr.c"
...
# 6 "project/radare2/libr/asm/p/asm_avr.c" 2
# 1 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include/stdarg.h" 1 3 4
...
#define __va_list__ 
# 7 "project/radare2/libr/asm/p/asm_avr.c" 2
...
# 8 "project/radare2/libr/asm/p/asm_avr.c" 2
...
# 10 "project/radare2/libr/asm/p/asm_avr.c" 2
...
# 11 "project/radare2/libr/asm/p/asm_avr.c" 2
...
# 12 "project/radare2/libr/asm/p/asm_avr.c" 2
...
# 13 "project/radare2/libr/asm/p/asm_avr.c" 2



# 1 "project/radare2/libr/asm/p/../arch/avr/avr_disasm.h" 1
# 27 "project/radare2/libr/asm/p/../arch/avr/avr_disasm.h"
#define AVR_DISASM_H 


# 1 "project/radare2/libr/asm/p/../arch/avr/avr_instructionset.h" 1
...
# 11 "project/radare2/libr/asm/p/../arch/avr/avr_instructionset.h"
...
# 31 "project/radare2/libr/asm/p/../arch/avr/avr_disasm.h" 2
# 42 "project/radare2/libr/asm/p/../arch/avr/avr_disasm.h"
...
# 17 "project/radare2/libr/asm/p/asm_avr.c" 2
# 1 "project/radare2/libr/asm/p/../arch/avr/avr_instructionset.h" 1
# 18 "project/radare2/libr/asm/p/asm_avr.c" 2
# 1 "project/radare2/libr/asm/p/../arch/avr/disasm.h" 1

#define AVR_DISASSEMBLER_H 

int avr_decode(RAsm *a, char *out, int out_size, 
# 4 "project/radare2/libr/asm/p/../arch/avr/disasm.h" 3 4
                                                unsigned long long 
# 4 "project/radare2/libr/asm/p/../arch/avr/disasm.h"
                                                     addr, 
# 4 "project/radare2/libr/asm/p/../arch/avr/disasm.h" 3 4
                                                           const unsigned char 
# 4 "project/radare2/libr/asm/p/../arch/avr/disasm.h"
...
# 5 "project/radare2/libr/asm/p/../arch/avr/disasm.h" 3 4
                                               unsigned long long 
# 5 "project/radare2/libr/asm/p/../arch/avr/disasm.h"
                                                    addr, 
# 5 "project/radare2/libr/asm/p/../arch/avr/disasm.h" 3 4
                                                          const unsigned char 
# 5 "project/radare2/libr/asm/p/../arch/avr/disasm.h"
                                                               *buf, int len);
# 19 "project/radare2/libr/asm/p/asm_avr.c" 2
# 1 "project/radare2/libr/asm/p/../arch/avr/assemble.h" 1
# 9 "project/radare2/libr/asm/p/../arch/avr/assemble.h"
...
int search_instruction(RAsm *a, char instr[3][32], int args);
int parse_specialreg(const char *reg);
# 20 "project/radare2/libr/asm/p/asm_avr.c" 2
# 1 "project/radare2/libr/asm/p/../arch/avr/format.h" 1
# 26 "project/radare2/libr/asm/p/../arch/avr/format.h"
# 1 "project/radare2/libr/asm/p/../arch/avr/avr_disasm.h" 1
# 27 "project/radare2/libr/asm/p/../arch/avr/format.h" 2
# 1 "project/radare2/libr/asm/p/../arch/avr/errorcodes.h" 1
# 27 "project/radare2/libr/asm/p/../arch/avr/errorcodes.h"
#define ERRORCODES_DISASM_H 
# 36 "project/radare2/libr/asm/p/../arch/avr/errorcodes.h"
...
# 28 "project/radare2/libr/asm/p/../arch/avr/format.h" 2
...
# 54 "project/radare2/libr/asm/p/../arch/avr/format.h"
...
# 21 "project/radare2/libr/asm/p/asm_avr.c" 2


static int disassemble(RAsm *a, RAsmOp *op, const 
# 23 "project/radare2/libr/asm/p/asm_avr.c" 3 4
                                                 unsigned char 
# 23 "project/radare2/libr/asm/p/asm_avr.c"
                                                     *buf, int len) {
 char buf_asm[32] = {0};
 ...
 return 
# 36 "project/radare2/libr/asm/p/asm_avr.c" 3 4
       (((
# 36 "project/radare2/libr/asm/p/asm_avr.c"
       2
# 36 "project/radare2/libr/asm/p/asm_avr.c" 3 4
       )>(
# 36 "project/radare2/libr/asm/p/asm_avr.c"
...
RAsmPlugin r_asm_plugin_avr = {
 ...
 .bits = 8|16,
 .endian = 
# 49 "project/radare2/libr/asm/p/asm_avr.c" 3 4
          1 
# 49 "project/radare2/libr/asm/p/asm_avr.c"
                              | 
# 49 "project/radare2/libr/asm/p/asm_avr.c" 3 4
                                2
# 49 "project/radare2/libr/asm/p/asm_avr.c"
...
# 69 "project/radare2/libr/asm/p/asm_avr.c" 3 4
__attribute__((visibility("default"))) 
# 69 "project/radare2/libr/asm/p/asm_avr.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_avr,
 .version = 
# 72 "project/radare2/libr/asm/p/asm_avr.c" 3 4
           "5.5.4"

# 73 "project/radare2/libr/asm/p/asm_avr.c"
};
