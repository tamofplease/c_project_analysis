# 0 "project/radare2/libr/asm/p/asm_pyc.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/p/asm_pyc.c"
...
# 4 "project/radare2/libr/asm/p/asm_pyc.c" 2
...
# 5 "project/radare2/libr/asm/p/asm_pyc.c" 2
...
# 6 "project/radare2/libr/asm/p/asm_pyc.c" 2
...
# 7 "project/radare2/libr/asm/p/asm_pyc.c" 2

# 1 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h" 1
...
# 1 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 1
...
# 13 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
typedef enum {
 HASCOMPARE = 0x1,
 HASCONDITION = 0x2,
 HASCONST = 0x4,
...
# 37 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
unsigned short 
# 37 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
     type;
 
# 38 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
unsigned char 
# 38 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
    op_code;
 
# 39 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
signed char 
# 39 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
    op_push;
 
# 40 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
signed char 
# 40 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
    op_pop;
} pyc_opcode_object;

typedef struct {
 
# 44 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
unsigned char 
# 44 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
    extended_arg;
 
# 45 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
unsigned char 
# 45 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
    have_argument;
 
# 46 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
unsigned char 
# 46 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
    bits;
 void *(*version_sig)();
...
typedef struct {
 char *op_name;
 char *(*formatter)(
# 54 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
                   unsigned int 
# 54 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
                        oparg);
} pyc_arg_fmt;
...
# 64 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
                                                     unsigned int 
# 64 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
                                                          oparg);
} op_anal_func;

void anal_pyc_op(RAnalOp *op, pyc_opcode_object *op_obj, 
# 67 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
                                                        unsigned int 
# 67 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
                                                             oparg);
...
# 101 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
_Bool 
# 101 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
    pyc_opcodes_equal(pyc_opcodes *op, const char *version);

void add_arg_fmt(pyc_opcodes *ret, char *op_name, char *(*formatter) (
# 103 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
                                                                     unsigned int 
# 103 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
                                                                          oparg));

char *format_MAKE_FUNCTION_arg_3x(
# 105 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
                                 unsigned int 
# 105 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
                                      oparg);
char *format_extended_arg(
# 106 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
                         unsigned int 
# 106 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
                              oparg);
char *format_CALL_FUNCTION_pos_name_encoded(
# 107 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
                                           unsigned int 
# 107 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
                                                oparg);
char *format_CALL_FUNCTION_KW_36(
# 108 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
                                unsigned int 
# 108 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
                                     oparg);
char *format_CALL_FUNCTION_EX_36(
# 109 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
                                unsigned int 
# 109 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
                                     oparg);
char *format_MAKE_FUNCTION_arg_36(
# 110 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
                                 unsigned int 
# 110 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
                                      oparg);
char *format_value_flags_36(
# 111 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
                           unsigned int 
# 111 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
                                oparg);
char *format_extended_arg_36(
# 112 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
                            unsigned int 
# 112 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
                                 oparg);
...
# 117 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
unsigned char 
# 117 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
    op_code;
 
# 118 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
signed char 
# 118 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
    pop;
 
# 119 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
signed char 
# 119 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
    push;
 pyc_store_op_func func;
 
# 121 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
_Bool 
# 121 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
     conditional;
 
# 122 "project/radare2/libr/asm/p/../arch/pyc/opcode.h" 3 4
_Bool 
# 122 "project/radare2/libr/asm/p/../arch/pyc/opcode.h"
     fallthrough;
};
...
# 12 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h" 2
...
# 57 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h" 3 4
unsigned int 
# 57 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h"
     argcount;
 
# 58 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h" 3 4
unsigned int 
# 58 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h"
     posonlyargcount;
 
# 59 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h" 3 4
unsigned int 
# 59 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h"
     kwonlyargcount;
 
# 60 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h" 3 4
unsigned int 
# 60 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h"
     nlocals;
 
# 61 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h" 3 4
unsigned int 
# 61 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h"
     stacksize;
 
# 62 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h" 3 4
unsigned int 
# 62 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h"
     flags;
 pyc_object *code;
 pyc_object *consts;
 pyc_object *names;
...
# 71 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h" 3 4
unsigned int 
# 71 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h"
     firstlineno;
 pyc_object *lnotab;
 
# 73 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h" 3 4
long long 
# 73 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h"
     start_offset;
 
# 74 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h" 3 4
long long 
# 74 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h"
     end_offset;
} pyc_code_object;

int r_pyc_disasm(RAsmOp *op, const 
# 77 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h" 3 4
                                  unsigned char 
# 77 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h"
                                      *buf, RList *cobjs, RList *interned_table, 
# 77 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h" 3 4
                                                                                 unsigned long long 
# 77 "project/radare2/libr/asm/p/../arch/pyc/pyc_dis.h"
                                                                                      pc, pyc_opcodes *opcodes);
# 9 "project/radare2/libr/asm/p/asm_pyc.c" 2

static pyc_opcodes *opcodes_cache = 
# 10 "project/radare2/libr/asm/p/asm_pyc.c" 3 4
                                   ((void *)0)
# 10 "project/radare2/libr/asm/p/asm_pyc.c"
                                       ;

static int disassemble(RAsm *a, RAsmOp *opstruct, const 
# 12 "project/radare2/libr/asm/p/asm_pyc.c" 3 4
                                                       unsigned char 
# 12 "project/radare2/libr/asm/p/asm_pyc.c"
                                                           *buf, int len) {
 RList *shared = 
# 13 "project/radare2/libr/asm/p/asm_pyc.c" 3 4
                ((void *)0)
# 13 "project/radare2/libr/asm/p/asm_pyc.c"
                    ;

 RBin *bin = a->binb.bin;
 
# 16 "project/radare2/libr/asm/p/asm_pyc.c" 3 4
unsigned long long 
# 16 "project/radare2/libr/asm/p/asm_pyc.c"
     pc = a->pc;

 RBinPlugin *plugin = bin && bin->cur && bin->cur->o? bin->cur->o->plugin: 
# 18 "project/radare2/libr/asm/p/asm_pyc.c" 3 4
                                                                          ((void *)0)
# 18 "project/radare2/libr/asm/p/asm_pyc.c"
                                                                              ;
 ...
 RList *cobjs = 
# 25 "project/radare2/libr/asm/p/asm_pyc.c" 3 4
               ((void *)0)
# 25 "project/radare2/libr/asm/p/asm_pyc.c"
                   ;
 RList *interned_table = 
# 26 "project/radare2/libr/asm/p/asm_pyc.c" 3 4
                        ((void *)0)
# 26 "project/radare2/libr/asm/p/asm_pyc.c"
                            ;
 if (shared) {
...
static 
# 47 "project/radare2/libr/asm/p/asm_pyc.c" 3 4
      _Bool 
# 47 "project/radare2/libr/asm/p/asm_pyc.c"
           finish(void *user) {
 if (opcodes_cache) {
  free_opcode (opcodes_cache);
  opcodes_cache = 
# 50 "project/radare2/libr/asm/p/asm_pyc.c" 3 4
                 ((void *)0)
# 50 "project/radare2/libr/asm/p/asm_pyc.c"
                     ;
 }
 return 
# 52 "project/radare2/libr/asm/p/asm_pyc.c" 3 4
       1
# 52 "project/radare2/libr/asm/p/asm_pyc.c"
           ;
}
...
# 66 "project/radare2/libr/asm/p/asm_pyc.c" 3 4
__attribute__((visibility("default"))) 
# 66 "project/radare2/libr/asm/p/asm_pyc.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ASM,
 .data = &r_asm_plugin_pyc,
 .version = 
# 69 "project/radare2/libr/asm/p/asm_pyc.c" 3 4
           "5.5.4"

# 70 "project/radare2/libr/asm/p/asm_pyc.c"
};
