# 0 "project/radare2/libr/asm/arch/dcpu16/asm.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 32 "project/radare2/libr/asm/arch/dcpu16/asm.c" 2
...
# 33 "project/radare2/libr/asm/arch/dcpu16/asm.c" 2
...
# 34 "project/radare2/libr/asm/arch/dcpu16/asm.c" 2
# 1 "project/radare2/libr/asm/arch/dcpu16/dcpu16.h" 1
...
# 35 "project/radare2/libr/asm/arch/dcpu16/asm.c" 2

#define NOTEND 1

static unsigned char get_register_id(char reg) {
...
static unsigned char decode_parameter(char* param, int* extra_word_needed, unsigned short* extra_word_value) {
 ...
 if (first_sqbracket == 1) {
  ...
  if (last_sqbracket != 1) {
   fprintf (
# 84 "project/radare2/libr/asm/arch/dcpu16/asm.c" 3 4
           __stderrp
# 84 "project/radare2/libr/asm/arch/dcpu16/asm.c"
  ...
  if (last_sqbracket == 1) {
   fprintf (
# 89 "project/radare2/libr/asm/arch/dcpu16/asm.c" 3 4
           __stderrp
# 89 "project/radare2/libr/asm/arch/dcpu16/asm.c"
 ...
 if (param[0] == '0' && param[1] == 'X') {
  ...
  for (digit_num = 0; digit_num < digit_count; digit_num++) {
   ...
   if (current_digit == '+' && square_brackets == 1) {
    ...
    if (digit_val == -1) {
     fprintf (
# 117 "project/radare2/libr/asm/arch/dcpu16/asm.c" 3 4
             __stderrp
# 117 "project/radare2/libr/asm/arch/dcpu16/asm.c"
                   , "invalid literal\n");
     return 0;
    }
 ...
 if (param[0] >= '0' && param[0] <= '9') {
  ...
  for (digit_num = 0; digit_num < digit_count; digit_num++) {
   ...
   if (current_digit == '+' && square_brackets == 1) {
    ...
    if (digit_val == -1) {
     fprintf (
# 160 "project/radare2/libr/asm/arch/dcpu16/asm.c" 3 4
             __stderrp
# 160 "project/radare2/libr/asm/arch/dcpu16/asm.c"
                   , "invalid literal\n");
     return 0;
    }
...
int dcpu16_assemble (unsigned char* out, const char* unoline) {
 unsigned short wordA = 0, wordB = 0;
 int basic_opcode = 0;
 ...
 if (basic_opcode == 0) {
  if (!strncmp ("JSR", line, 3)) {
   ...
   fprintf (
# 242 "project/radare2/libr/asm/arch/dcpu16/asm.c" 3 4
           __stderrp
# 242 "project/radare2/libr/asm/arch/dcpu16/asm.c"
                 , "Unknown instruction\n");
   return -1;
  }
 }
 ...
 if (basic_opcode != 0) {
  unsigned char paramA = 0, paramB = 0;
...
# 285 "project/radare2/libr/asm/arch/dcpu16/asm.c" 3 4
  __builtin___memcpy_chk (
# 285 "project/radare2/libr/asm/arch/dcpu16/asm.c"
  out
# 285 "project/radare2/libr/asm/arch/dcpu16/asm.c" 3 4
  , 
# 285 "project/radare2/libr/asm/arch/dcpu16/asm.c"
...
# 287 "project/radare2/libr/asm/arch/dcpu16/asm.c" 3 4
   __builtin___memcpy_chk (
# 287 "project/radare2/libr/asm/arch/dcpu16/asm.c"
   out+2
# 287 "project/radare2/libr/asm/arch/dcpu16/asm.c" 3 4
   , 
# 287 "project/radare2/libr/asm/arch/dcpu16/asm.c"
...
# 291 "project/radare2/libr/asm/arch/dcpu16/asm.c" 3 4
   __builtin___memcpy_chk (
# 291 "project/radare2/libr/asm/arch/dcpu16/asm.c"
   out+off
# 291 "project/radare2/libr/asm/arch/dcpu16/asm.c" 3 4
   , 
# 291 "project/radare2/libr/asm/arch/dcpu16/asm.c"
...
# 308 "project/radare2/libr/asm/arch/dcpu16/asm.c"
  } else {
   fprintf (
# 309 "project/radare2/libr/asm/arch/dcpu16/asm.c" 3 4
           __stderrp
# 309 "project/radare2/libr/asm/arch/dcpu16/asm.c"
                 , "Missing comma\n");
   return -1;
  }
 }
 ...
 if (non_basic_opcode == 0x1) {
  int extraX = 0;
  unsigned short first_word, wordX = 0;
  unsigned char p = decode_parameter (param, &extraX, &wordX);
...
# 324 "project/radare2/libr/asm/arch/dcpu16/asm.c" 3 4
 __builtin___memcpy_chk (
# 324 "project/radare2/libr/asm/arch/dcpu16/asm.c"
 out
# 324 "project/radare2/libr/asm/arch/dcpu16/asm.c" 3 4
 , 
# 324 "project/radare2/libr/asm/arch/dcpu16/asm.c"
...
# 326 "project/radare2/libr/asm/arch/dcpu16/asm.c" 3 4
  __builtin___memcpy_chk (
# 326 "project/radare2/libr/asm/arch/dcpu16/asm.c"
  out+2
# 326 "project/radare2/libr/asm/arch/dcpu16/asm.c" 3 4
  , 
# 326 "project/radare2/libr/asm/arch/dcpu16/asm.c"
...
# 338 "project/radare2/libr/asm/arch/dcpu16/asm.c"
 }
 return off;
}
