# 0 "project/radare2/libr/asm/arch/dcpu16/main.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/arch/dcpu16/main.c"
...
# 4 "project/radare2/libr/asm/arch/dcpu16/main.c" 2
...
# 5 "project/radare2/libr/asm/arch/dcpu16/main.c" 2
...
int main(int argc, char **argv) {
 if (argc>1) {
  ...
  do {
   int ret = dcpu16_disasm (out, p, len, 
# 20 "project/radare2/libr/asm/arch/dcpu16/main.c" 3 4
                                        ((void *)0)
# 20 "project/radare2/libr/asm/arch/dcpu16/main.c"
                                            );
   len -= ret;
   p += (ret/2);
   printf (" %d  %s\n", ret, out);
