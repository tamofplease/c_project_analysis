# 0 "project/radare2/libr/asm/arch/snes/snesdis.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/arch/snes/snesdis.c"
...
# 4 "project/radare2/libr/asm/arch/snes/snesdis.c" 2
...
# 5 "project/radare2/libr/asm/arch/snes/snesdis.c" 2
...
# 6 "project/radare2/libr/asm/arch/snes/snesdis.c" 2
...
# 7 "project/radare2/libr/asm/arch/snes/snesdis.c" 2

# 1 "project/radare2/libr/asm/arch/snes/snes_op_table.h" 1
...
# 8 "project/radare2/libr/asm/arch/snes/snes_op_table.h"
enum {
 SNES_OP_8BIT = 1,
 SNES_OP_16BIT,
 SNES_OP_24BIT,
...
# 19 "project/radare2/libr/asm/arch/snes/snes_op_table.h" 3 4
unsigned char 
# 19 "project/radare2/libr/asm/arch/snes/snes_op_table.h"
    len;
 
# 20 "project/radare2/libr/asm/arch/snes/snes_op_table.h" 3 4
unsigned char 
# 20 "project/radare2/libr/asm/arch/snes/snes_op_table.h"
    flags;
} snes_op_t;
...
# 9 "project/radare2/libr/asm/arch/snes/snesdis.c" 2

static int snesDisass(int M_flag, int X_flag, 
# 10 "project/radare2/libr/asm/arch/snes/snesdis.c" 3 4
                                             unsigned long long 
# 10 "project/radare2/libr/asm/arch/snes/snesdis.c"
                                                  pc, RAsmOp *op, const 
# 10 "project/radare2/libr/asm/arch/snes/snesdis.c" 3 4
                                                                        unsigned char 
# 10 "project/radare2/libr/asm/arch/snes/snesdis.c"
...
# 23 "project/radare2/libr/asm/arch/snes/snesdis.c" 3 4
                                  unsigned int
# 23 "project/radare2/libr/asm/arch/snes/snesdis.c"
                                      )(pc + 2 + (
# 23 "project/radare2/libr/asm/arch/snes/snesdis.c" 3 4
                                                  signed char
# 23 "project/radare2/libr/asm/arch/snes/snesdis.c"
...
# 32 "project/radare2/libr/asm/arch/snes/snesdis.c" 3 4
                                           short
# 32 "project/radare2/libr/asm/arch/snes/snesdis.c"
                                               )
# 32 "project/radare2/libr/asm/arch/snes/snesdis.c" 3 4
                                                ((
# 32 "project/radare2/libr/asm/arch/snes/snesdis.c"
...
# 32 "project/radare2/libr/asm/arch/snes/snesdis.c"
   ...
   buf_asm = sdb_fmt (s_op->name, 
# 34 "project/radare2/libr/asm/arch/snes/snesdis.c" 3 4
                                 ((
# 34 "project/radare2/libr/asm/arch/snes/snesdis.c"
                                 buf + 1
# 34 "project/radare2/libr/asm/arch/snes/snesdis.c" 3 4
                                 )[0]|((
# 34 "project/radare2/libr/asm/arch/snes/snesdis.c"
...
# 44 "project/radare2/libr/asm/arch/snes/snesdis.c" 3 4
                                               ((
# 44 "project/radare2/libr/asm/arch/snes/snesdis.c"
                                               buf + 1
# 44 "project/radare2/libr/asm/arch/snes/snesdis.c" 3 4
                                               )[0]|((
# 44 "project/radare2/libr/asm/arch/snes/snesdis.c"
...
# 44 "project/radare2/libr/asm/arch/snes/snesdis.c"
 ...
 case SNES_OP_IMM_X:
  if (X_flag) {
   ...
   buf_asm = sdb_fmt ("%s #0x%04x", s_op->name, 
# 51 "project/radare2/libr/asm/arch/snes/snesdis.c" 3 4
                                               ((
# 51 "project/radare2/libr/asm/arch/snes/snesdis.c"
                                               buf + 1
# 51 "project/radare2/libr/asm/arch/snes/snesdis.c" 3 4
                                               )[0]|((
# 51 "project/radare2/libr/asm/arch/snes/snesdis.c"
