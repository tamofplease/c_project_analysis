# 0 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
size_t get_register_size(enum Register);
# 2 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode.c" 2
