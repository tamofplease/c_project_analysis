# 0 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode0.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 3 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode0.c" 2
...
# 4 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode0.c" 2
...
# 6 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode.h" 2
...
size_t get_register_size(enum Register);
# 6 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode0.c" 2
# 1 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode1.h" 1
...
# 7 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode0.c" 2
...
# 8 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode0.c" 2
...
int decode_spec(context *ctx, Instruction *dec)
{
 ...
 op0 = ((ctx->insword)>>25)&15;
 if(!op0) {

  op0 = (ctx->insword)>>29;
  op1 = ((ctx->insword)>>16)&0x1ff;
  if(!op0 && !op1)
   return decode_iclass_perm_undef(ctx, dec);
  if(op1)
   {dec->encoding = (ENC_UNKNOWN); return -3; };
  if(op0)
   {dec->encoding = (ENC_UNKNOWN); return -3; };
  { return -1; };
 }
 ...
 if(op0==2) {
  ...
  op0 = (ctx->insword)>>29;
  op1 = ((ctx->insword)>>23)&3;
  op2 = ((ctx->insword)>>17)&0x1f;
  op3 = ((ctx->insword)>>10)&0x3f;
  if(!op0 && !(op1&2) && !(op2&0x10) && (op3&0x10)==0x10) {

   op0 = ((ctx->insword)>>15)&1;
   if(!op0)
  ...
  if(!op0 && !(op1&2) && (op2&0x10)==0x10 && (op3&0x3c)==0x14) {
   ...
   op0 = ((ctx->insword)>>23)&1;
   op1 = ((ctx->insword)>>11)&1;
   if(!op0 && !op1)
  ...
  if(!op0 && !(op1&2) && (op2&0x10)==0x10 && (op3&0x30)==0x30) {
   ...
   op0 = ((ctx->insword)>>20)&1;
   op1 = ((ctx->insword)>>11)&7;
   if(!op0 && !(op1&6))
  ...
  if(!op0 && (op1&2)==2 && !(op2&0x18)) {
   ...
   op0 = ((ctx->insword)>>22)&3;
   op1 = ((ctx->insword)>>18)&3;
   if(op0==3 && !op1)
  ...
  if(!op0 && (op1&2)==2 && (op2&0x10)==0x10 && (op3&0x38)==0x10) {
   ...
   op0 = ((ctx->insword)>>22)&3;
   op1 = ((ctx->insword)>>16)&0x1f;
   op2 = ((ctx->insword)>>9)&15;
   op3 = ((ctx->insword)>>4)&1;
  ...
  if(!op0 && (op1&2)==2 && (op2&0x10)==0x10 && (op3&0x30)==0x20) {
   ...
   op0 = ((ctx->insword)>>20)&1;
   op1 = ((ctx->insword)>>17)&7;
   op2 = ((ctx->insword)>>16)&1;
   op3 = ((ctx->insword)>>13)&1;
   if(!op0 && !op1 && !op2 && !op3)
  ...
  if(op0==1 && (op1&2)==2 && (op2&0x18)==8 && (op3&0x30)==0x30) {
   ...
   op0 = ((ctx->insword)>>16)&15;
   op1 = ((ctx->insword)>>11)&7;
   op2 = ((ctx->insword)>>9)&3;
   op3 = ((ctx->insword)>>5)&15;
   op4 = ((ctx->insword)>>4)&1;
   if(!op0 && !(op2&1) && !op4)
  ...
  if(op0==1 && (op1&2)==2 && (op2&0x10)==0x10 && !(op3&0x30)) {
   ...
   op0 = ((ctx->insword)>>12)&3;
   op1 = ((ctx->insword)>>10)&3;
   op2 = (ctx->insword)&15;
   if(!(op0&2))
  ...
  if(op0==1 && (op1&2)==2 && (op2&0x1c)==0x14 && (op3&0x3c)==0x24) {
   ...
   op0 = ((ctx->insword)>>18)&1;
   op1 = ((ctx->insword)>>16)&3;
   op2 = ((ctx->insword)>>9)&7;
   op3 = ((ctx->insword)>>5)&15;
   op4 = (ctx->insword)&0x1f;
   if(!op0 && !op1 && !op2 && !op4)
  ...
  if(op0==2 && !(op1&2) && !(op2&0x10) && (op3&0x30)==0x20) {
   ...
   op0 = ((ctx->insword)>>17)&15;
   op1 = ((ctx->insword)>>13)&1;
   if(op0==2 && op1)
  ...
  if(op0==2 && (op1&2)==2 && (op2&0x10)==0x10 && (op3&0x38)==0x38) {
   ...
   op0 = ((ctx->insword)>>18)&7;
   op1 = ((ctx->insword)>>16)&3;
   op2 = ((ctx->insword)>>11)&3;
   op3 = ((ctx->insword)>>5)&0x1f;
   if(!op0 && !op1 && !op2 && !op3)
  ...
  if(op0==3 && (op1&2)==2 && !(op2&0x10) && (op3&0x38)==0x20) {
   ...
   op0 = ((ctx->insword)>>19)&3;
   op1 = ((ctx->insword)>>10)&7;
   op2 = ((ctx->insword)>>6)&15;
   if(!(op0&2))
  ...
  if(op0==4) {
   ...
   op0 = ((ctx->insword)>>23)&3;
   op1 = ((ctx->insword)>>21)&3;
   op2 = ((ctx->insword)>>13)&7;
   op3 = ((ctx->insword)>>4)&1;
  ...
  if(op0==5) {
   ...
   op0 = ((ctx->insword)>>21)&3;
   op1 = ((ctx->insword)>>20)&1;
   op2 = ((ctx->insword)>>13)&7;
   if(!op0 && !op1 && op2==7)
  ...
  if(op0==7 && !(op3&0x28)) {
   ...
   op0 = ((ctx->insword)>>22)&7;
   op1 = ((ctx->insword)>>14)&1;
   op2 = ((ctx->insword)>>4)&1;
   if(!(op0&4) && !op1)
    {dec->encoding = (ENC_UNKNOWN); return -3; };
   if((op0&6)==4 && !op1)
 ...
 if((op0&14)==10) {
  ...
  op0 = (ctx->insword)>>29;
  op1 = ((ctx->insword)>>12)&0x3fff;
  op2 = (ctx->insword)&0x1f;
  if(op0==2 && !(op1&0x2000))
 ...
 if((op0&5)==4) {
  ...
  op0 = (ctx->insword)>>28;
  op1 = ((ctx->insword)>>26)&1;
  op2 = ((ctx->insword)>>23)&3;
  op3 = ((ctx->insword)>>16)&0x3f;
  op4 = ((ctx->insword)>>10)&3;
 ...
 if((op0&7)==5) {
  ...
  op0 = ((ctx->insword)>>30)&1;
  op1 = ((ctx->insword)>>28)&1;
  op2 = ((ctx->insword)>>21)&15;
  op3 = ((ctx->insword)>>10)&0x3f;
  if(!op0 && op1 && op2==6)
 ...
 if((op0&7)==7) {
  ...
  op0 = (ctx->insword)>>28;
  op1 = ((ctx->insword)>>23)&3;
  op2 = ((ctx->insword)>>19)&15;
  op3 = ((ctx->insword)>>10)&0x1ff;
