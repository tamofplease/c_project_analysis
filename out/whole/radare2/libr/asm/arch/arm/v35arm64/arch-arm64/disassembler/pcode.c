# 0 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 2 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 2
...
# 3 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 2
...
# 4 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 2
...
size_t get_register_size(enum Register);
# 6 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 2
...
# 7 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 2
...
# 18 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
_Bool 
# 18 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
    BFXPreferred(uint32_t sf, uint32_t uns, uint32_t imms, uint32_t immr)
{

 if(imms < immr)
  return 
# 22 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
        0
# 22 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
             ;


 if(imms == ((sf<<5)|0x1F))
  return 
# 26 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
        0
# 26 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
             ;
 ...
 if(immr == 0) {
  ...
  if(sf==0 && (imms==7 || imms==15))
   return 
# 32 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
         0
# 32 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
              ;


  if((sf==1 && uns==0) && (imms==7 || imms==15 || imms==31))
   return 
# 36 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
         0
# 36 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
              ;
 }


 return 
# 40 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
       1
# 40 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
           ;
}
...
# 85 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
_Bool 
# 85 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
    MoveWidePreferred(uint32_t sf, uint32_t immN, uint32_t immS, uint32_t immR)
{
 ...
 if (((imm & 0xffffffffffff0000) == 0) ||
  ...
  return 
# 96 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
        1
# 96 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
            ;
 ...
 if (((imm & 0xffffffffffff0000) == 0) ||
  ...
  ((imm & 0x0000ffffffffffff) == 0))
  return 
# 105 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
        1
# 105 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
            ;

 return 
# 107 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
       0
# 107 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
            ;
}
...
# 132 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
_Bool 
# 132 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
    SVEMoveMaskPreferred(uint32_t imm13)
{

 return 
# 135 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
       1
# 135 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
           ;
}
...
# 242 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
_Bool 
# 242 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
    IsZero(uint64_t foo)
{
 return foo==0;
}
...
# 247 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
_Bool 
# 247 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
    IsOnes(uint64_t foo, int width)
{
  ...
  case 0b111:
   switch(((cmode & 0b1) << 1) | op)
   {
    case 0b00:
     ...
     break;
    case 0b01:
# 341 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
...
# 358 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
_Bool 
# 358 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
    BTypeCompatible_BTI(uint8_t hintcode, uint8_t pstate_btype)
{
 switch(hintcode & 3) {
  case 0b00: return 
# 361 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
                   0
# 361 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
                        ;
  case 0b01: return pstate_btype != 0b11;
  case 0b10: return pstate_btype != 0b10;
  case 0b11: return 
# 364 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
                   1
# 364 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
                       ;
 }

 return 
# 367 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
       0
# 367 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
            ;
}


# 370 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
_Bool 
# 370 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
    BTypeCompatible_PACIXSP()
{

 return 
# 373 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
       1
# 373 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
           ;
}
...
enum FPRounding FPRoundingMode(uint64_t fpcr)
{
 return FPDecodeRounding((((fpcr)>>(22)) & (((uint64_t)1<<((23)-(22)+1))-1)));
}


# 393 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
_Bool 
# 393 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
    HaltingAllowed(void)
{

 return 
# 396 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
       1
# 396 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
           ;
}
...
uint64_t VFPExpandImm(unsigned char byte, unsigned N)
{
 ...
 uint64_t Result;
 unsigned bit6 = (((byte)>>(6)) & (((uint64_t)1<<((6)-(6)+1))-1));
 if (N == 32) {
  Result = (((byte)>>(7)) & (((uint64_t)1<<((7)-(7)+1))-1)) << 31 | (((byte)>>(0)) & (((uint64_t)1<<((5)-(0)+1))-1)) << 19;
 if (bit6)
  Result |= 0x1f << 25;
 else
  Result |= 0x1 << 30;
  ...
  Result = (uint64_t)(((byte)>>(7)) & (((uint64_t)1<<((7)-(7)+1))-1)) << 63 |
  (uint64_t)(((byte)>>(0)) & (((uint64_t)1<<((5)-(0)+1))-1)) << 48;
  if (bit6)
   Result |= 0xffULL << 54;
  else
   Result |= 0x1ULL << 62;
...
# 440 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
_Bool 
# 440 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
    EL2Enabled(void)
{

 return 
# 443 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
       1
# 443 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
           ;
}


# 446 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
_Bool 
# 446 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
    ELUsingAArch32(uint8_t x)
{

 return 
# 449 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
       1
# 449 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
           ;
}

uint64_t FPOne(
# 452 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
              _Bool 
# 452 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
                   sign, int N)
{
 ...
 F = N - (E+1);
 exp = (((uint64_t)1<<(E-1))-1) << 1;
 return (sign<<(E-1 + F)) | (exp<<F);
}

uint64_t FPTwo(
# 468 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
              _Bool 
# 468 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
                   sign, int N)
{
...
uint64_t FPPointFive(
# 486 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c" 3 4
                    _Bool 
# 486 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/pcode.c"
                         sign, int N)
{
