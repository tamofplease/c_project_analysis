# 0 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/unpack_lookup.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/unpack_lookup.c"
...
# 2 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/unpack_lookup.c" 2

# 1 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/arm64dis.h" 1
...
# 4 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode.h" 2
# 1 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include/stddef.h" 1 3 4
...
size_t get_register_size(enum Register);
# 4 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/arm64dis.h" 2
...
# 5 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/arm64dis.h" 2
# 4 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/unpack_lookup.c" 2

Register* v_unpack_lookup[15][32] =
{
 {
  (Register []){REG_NONE}, (Register []){REG_NONE}, (Register []){REG_NONE}, (Register []){REG_NONE},
  (Register []){REG_NONE}, (Register []){REG_NONE}, (Register []){REG_NONE}, (Register []){REG_NONE},
  (Register []){REG_NONE}, (Register []){REG_NONE}, (Register []){REG_NONE}, (Register []){REG_NONE},
  (Register []){REG_NONE}, (Register []){REG_NONE}, (Register []){REG_NONE}, (Register []){REG_NONE},
  (Register []){REG_NONE}, (Register []){REG_NONE}, (Register []){REG_NONE}, (Register []){REG_NONE},
