# 0 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 2 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 2
...
# 3 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 2
...
# 4 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 2
...
size_t get_register_size(enum Register);
# 6 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 2
...
# 7 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 2
...
# 272 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
ArrangementSpec arr_spec_method0(uint32_t imm5, uint32_t Q)
{
 if(Q==0) {
  if(imm5 & 1) return ARRSPEC_8BYTES;
  if(imm5 & 2) return ARRSPEC_4HALVES;
  if(imm5 & 4) return ARRSPEC_2SINGLES;
 }
 else {
  if(imm5 & 1) return ARRSPEC_16BYTES;
  if(imm5 & 2) return ARRSPEC_8HALVES;
  if(imm5 & 4) return ARRSPEC_4SINGLES;
  if(imm5 & 8) return ARRSPEC_2DOUBLES;
 }
 return ARRSPEC_NONE;
}
...
ArrangementSpec arr_spec_method1(unsigned key)
{
 ...
 if((key & 0b00001) == 0b00001) return ARRSPEC_1BYTE;
 if((key & 0b00011) == 0b00010) return ARRSPEC_1HALF;
 if((key & 0b00111) == 0b00100) return ARRSPEC_1SINGLE;
 if((key & 0b01111) == 0b01000) return ARRSPEC_1DOUBLE;
 if((key & 0b11111) == 0b10000) return ARRSPEC_FULL;
 return ARRSPEC_NONE;
}
...
ArrangementSpec arr_spec_method2(unsigned immh)
{
 ...
 if(immh==1) return ARRSPEC_8HALVES;
 if((immh & 0b1110) == 0b0010) return ARRSPEC_4SINGLES;
 if((immh & 0b1100) == 0b0100) return ARRSPEC_2DOUBLES;
 return ARRSPEC_NONE;
}
...
ArrangementSpec arr_spec_method3(unsigned immh, unsigned q)
{
 switch((immh<<1)|q) {
  ...
  case 0b00010: return ARRSPEC_8BYTES;
  case 0b00011: return ARRSPEC_16BYTES;
  case 0b00100:
  case 0b00110: return ARRSPEC_4HALVES;
  case 0b00101:
  case 0b00111: return ARRSPEC_8HALVES;
  case 0b01000:
  case 0b01010:
  case 0b01100:
  case 0b01110: return ARRSPEC_2SINGLES;
  case 0b01001:
  case 0b01011:
  case 0b01101:
  case 0b01111: return ARRSPEC_4SINGLES;
  case 0b10001:
  case 0b10011:
  case 0b10101:
  case 0b10111:
  ...
  case 0b11011:
  case 0b11101:
  case 0b11111: return ARRSPEC_2DOUBLES;
  default: break;
 }
 return ARRSPEC_NONE;
}
...
ArrangementSpec arr_spec_method4(unsigned imm5, unsigned q)
{
 ...
 if((key & 0b000011) == 0b000010) return ARRSPEC_8BYTES;
 if((key & 0b000011) == 0b000011) return ARRSPEC_16BYTES;
 if((key & 0b000111) == 0b000100) return ARRSPEC_4HALVES;
 if((key & 0b000111) == 0b000101) return ARRSPEC_8HALVES;
 if((key & 0b001111) == 0b001000) return ARRSPEC_2SINGLES;
 if((key & 0b001111) == 0b001001) return ARRSPEC_4SINGLES;

 if((key & 0b011111) == 0b010001) return ARRSPEC_2DOUBLES;
 return ARRSPEC_NONE;
}

ArrangementSpec table_1s_1d[2] = {ARRSPEC_1SINGLE, ARRSPEC_1DOUBLE};
ArrangementSpec table_2s_4s[2] = {ARRSPEC_2SINGLES, ARRSPEC_4SINGLES};
ArrangementSpec table_2s_2d[2] = {ARRSPEC_2SINGLES, ARRSPEC_2DOUBLES};
ArrangementSpec table_2h_4h[2] = {ARRSPEC_2HALVES, ARRSPEC_4HALVES};
ArrangementSpec table_4h_8h[2] = {ARRSPEC_4HALVES, ARRSPEC_8HALVES};
ArrangementSpec table_4s_2d[2] = {ARRSPEC_4SINGLES, ARRSPEC_2DOUBLES};
ArrangementSpec table_8b_16b[2] = {ARRSPEC_8BYTES, ARRSPEC_16BYTES};
ArrangementSpec table_2s_r_4s_2d[4] = {ARRSPEC_2SINGLES, ARRSPEC_NONE, ARRSPEC_4SINGLES, ARRSPEC_2DOUBLES};
ArrangementSpec table_2s_4s_r_2d[4] = {ARRSPEC_2SINGLES, ARRSPEC_4SINGLES, ARRSPEC_NONE, ARRSPEC_2DOUBLES};
ArrangementSpec table_8h_4s_2d_1q[4] = {ARRSPEC_8HALVES, ARRSPEC_4SINGLES, ARRSPEC_2DOUBLES, ARRSPEC_FULL};
ArrangementSpec table_4h_8h_2s_4s_1d_2d_r_r[8] = {ARRSPEC_4HALVES, ARRSPEC_8HALVES, ARRSPEC_2SINGLES, ARRSPEC_4SINGLES, ARRSPEC_1DOUBLE, ARRSPEC_2DOUBLES, ARRSPEC_NONE, ARRSPEC_NONE};
ArrangementSpec table_8b_16b_4h_8h_2s_4s_1d_2d[8] = {ARRSPEC_8BYTES, ARRSPEC_16BYTES, ARRSPEC_4HALVES, ARRSPEC_8HALVES, ARRSPEC_2SINGLES, ARRSPEC_4SINGLES, ARRSPEC_1DOUBLE, ARRSPEC_2DOUBLES};
ArrangementSpec table_r_b_h_r_r_s_r_r[8] = {ARRSPEC_NONE, ARRSPEC_1BYTE, ARRSPEC_1HALF, ARRSPEC_NONE, ARRSPEC_NONE, ARRSPEC_1SINGLE, ARRSPEC_NONE, ARRSPEC_NONE};
ArrangementSpec table_r_h_s_r_r_d_r_r[8] = {ARRSPEC_NONE, ARRSPEC_1HALF, ARRSPEC_1SINGLE, ARRSPEC_NONE, ARRSPEC_NONE, ARRSPEC_1DOUBLE, ARRSPEC_NONE, ARRSPEC_NONE};
ArrangementSpec table16_r_b_h_s_d[16] = {ARRSPEC_NONE, ARRSPEC_1BYTE, ARRSPEC_1HALF, ARRSPEC_1HALF, ARRSPEC_1SINGLE, ARRSPEC_1SINGLE, ARRSPEC_1SINGLE, ARRSPEC_1SINGLE, ARRSPEC_1DOUBLE, ARRSPEC_1DOUBLE, ARRSPEC_1DOUBLE, ARRSPEC_1DOUBLE, ARRSPEC_1DOUBLE, ARRSPEC_1DOUBLE, ARRSPEC_1DOUBLE, ARRSPEC_1DOUBLE};





ArrangementSpec size_spec_method0(uint8_t a, uint8_t b)
{
 if(a == 0) {
  if((b & 0x20) == 0) return ARRSPEC_1SINGLE;
  if((b & 0x30) == 0x20) return ARRSPEC_1HALF;
  if((b & 0x38) == 0x30) return ARRSPEC_1BYTE;
  if((b & 0x3C) == 0x38) return ARRSPEC_1BYTE;
  if((b & 0x3E) == 0x3C) return ARRSPEC_1BYTE;
  return 0;
 }
 else {
  return ARRSPEC_1DOUBLE;
 }
}
...
ArrangementSpec size_spec_method1(unsigned imm13)
{
 ...
 if((key & 0b1100000) == 0b0000000) return ARRSPEC_1SINGLE;
 if((key & 0b1110000) == 0b0100000) return ARRSPEC_1HALF;
 if((key & 0b1111000) == 0b0110000) return ARRSPEC_1BYTE;
 if((key & 0b1111100) == 0b0111000) return ARRSPEC_1BYTE;
 if((key & 0b1111110) == 0b0111100) return ARRSPEC_1BYTE;


 if((key & 0b1000000) == 0b1000000) return ARRSPEC_1DOUBLE;
 return 0;
}

ArrangementSpec size_spec_method3(int x)
{
 if((x & 0b01111) == 0b00000) return ARRSPEC_NONE;
 if((x & 0b00001) == 0b00001) return ARRSPEC_1BYTE;
 if((x & 0b00011) == 0b00010) return ARRSPEC_1HALF;
 if((x & 0b00111) == 0b00100) return ARRSPEC_1SINGLE;
 if((x & 0b01111) == 0b01000) return ARRSPEC_1DOUBLE;
 return 0;
}

ArrangementSpec table_b_h[2] = {ARRSPEC_1BYTE, ARRSPEC_1HALF};
ArrangementSpec table_s_d[2] = {ARRSPEC_1SINGLE, ARRSPEC_1DOUBLE};
ArrangementSpec table_b_d_h_s[4] = {ARRSPEC_1BYTE, ARRSPEC_1DOUBLE, ARRSPEC_1HALF, ARRSPEC_1SINGLE};
ArrangementSpec table_b_h_s_d[4] = {ARRSPEC_1BYTE, ARRSPEC_1HALF, ARRSPEC_1SINGLE, ARRSPEC_1DOUBLE};
ArrangementSpec table_d_b_h_s[4] = {ARRSPEC_1DOUBLE, ARRSPEC_1BYTE, ARRSPEC_1HALF, ARRSPEC_1SINGLE};
ArrangementSpec table_q_h_s_d[4] = {ARRSPEC_FULL, ARRSPEC_1HALF, ARRSPEC_1SINGLE, ARRSPEC_1DOUBLE};
ArrangementSpec table_r_h_s_d[4] = {ARRSPEC_NONE, ARRSPEC_1HALF, ARRSPEC_1SINGLE, ARRSPEC_1DOUBLE};
ArrangementSpec table_r_b_h_s[4] = {ARRSPEC_NONE, ARRSPEC_1BYTE, ARRSPEC_1HALF, ARRSPEC_1SINGLE};
ArrangementSpec table_r_s_d_r[4] = {ARRSPEC_NONE, ARRSPEC_1SINGLE, ARRSPEC_1DOUBLE, ARRSPEC_NONE};
...
# 630 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 659 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 692 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 769 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 838 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 855 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 867 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
unsigned rwwwx_0123x_reg(int x, int r)
{
 if((x & 0b01111) == 0b00000) return 0;
 if((x & 0b00001) == 0b00001) return 0;
 if((x & 0b00011) == 0b00010) return 0;
 if((x & 0b00111) == 0b00100) return 0;
 if((x & 0b01111) == 0b01000) return 1;
 return 0;
}
...
unsigned rbhsdq_5bit_reg(unsigned key)
{
 ...
 if(key == 0) return 0;
 if((key & 0b00001) == 0b00001) return 3;
 if((key & 0b00011) == 0b00010) return 4;
 if((key & 0b00111) == 0b00100) return 5;
 if((key & 0b01111) == 0b01000) return 6;
 if((key & 0b11111) == 0b10000) return 7;
 return 0;
}

unsigned wwwx_0123_reg(unsigned size)
{
 if(size == 0b11) return 1;
 return 0;
}
...
{
 if(v == 1) return 3;
 if((v & 0b1110) == 0b0010) return 4;
 if((v & 0b1100) == 0b0100) return 5;
 if((v & 0b1000) == 0b1000) return 6;
 return 0;
}
...
{
 if(v == 1) return 4;
 if((v & 0b1110) == 0b0010) return 5;
 if((v & 0b1100) == 0b0100) return 6;
 return 0;
}
...
# 978 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 993 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 1007 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 1020 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 1036 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 1052 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 1071 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
{
 ArrangementSpec arr_spec = ARRSPEC_1BYTE;
 ...
 switch(instr->encoding) {
  ...
  case ENC_WFIT_ONLY_SYSTEMINSTRSWITHREG:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][(ctx->d)]; i++;;;
   break;
  }
...
# 1143 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 1143 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 1143 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 1143 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  "csync"
...
# 1143 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ...
  case ENC_STR_B_LDST_IMMPRE:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(3)][(ctx->t)]; i++;;;
   instr->operands[i].operandClass = MEM_PRE_IDX; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = ctx->offset; instr->operands[i].signedImm = 1;;
   break;
  }
  ...
  case ENC_STR_B_LDST_REGOFF:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(3)][(ctx->t)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(reg_base)][(ctx->m)]; i++;;
   if(ctx->option & 1) {
    ShiftType st = DecodeRegExtend(ctx->option); if(st == ShiftType_UXTW) { if(3==31 && ctx->imm3 != 0) { st = ShiftType_LSL; } } instr->operands[i-1].shiftType = st; instr->operands[i-1].shiftValue = ctx->shift; if(ctx->shift) { instr->operands[i-1].shiftValueUsed = 1; };
   }
   else {
    ShiftType st = DecodeRegExtend(ctx->option); if((ctx->Rd==31 || ctx->Rn==31) && ctx->option == 3) { st = ShiftType_LSL; if(ctx->imm3 == 0) st = ShiftType_NONE; } if(st != ShiftType_NONE) { instr->operands[i-1].shiftType = st; instr->operands[i-1].shiftValue = ctx->shift; instr->operands[i-1].shiftValueUsed = 1; } if(!ctx->shift) { instr->operands[i-1].shiftValueUsed = 0; };
   }
   if(ctx->S) {
    instr->operands[i-1].shiftType = ctx->extend_type; instr->operands[i-1].shiftValue = 0; instr->operands[i-1].shiftValueUsed = ctx->S ? 1 : 0;
   }
   break;
  }
  ...
  case ENC_STR_BL_LDST_REGOFF:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(3)][(ctx->t)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; i++;;
   if(ctx->S) { instr->operands[i-1].shiftType = ShiftType_LSL; instr->operands[i-1].shiftValue = 0; instr->operands[i-1].shiftValueUsed = 1; } else instr->operands[i-1].shiftType = ShiftType_NONE;;
   break;
  }
  ...
  case ENC_STR_B_LDST_IMMPOST:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(3)][(ctx->t)]; i++;;;
   instr->operands[i].operandClass = MEM_POST_IDX; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = ctx->offset; instr->operands[i].signedImm = 1;;
   break;
  }
  ...
  case ENC_STR_B_LDST_POS:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(3)][(ctx->t)]; i++;;;
   instr->operands[i].operandClass = MEM_OFFSET; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = ctx->offset; instr->operands[i].signedImm = 1; i++;;
   break;
  }
  ...
  case ENC_MOVI_ASIMDIMM_D_DS:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->rd)]; i++;;
   instr->operands[i].operandClass = IMM64; instr->operands[i].signedImm = 0; instr->operands[i].immediate = imm; i++;;
   break;
  }
  case ENC_FMOV_D_FLOATIMM:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->d)]; i++;;
   instr->operands[i].operandClass = FIMM32; ImmFloatUnion *ifu = (ImmFloatUnion *)&(instr->operands[i].immediate); ifu->ui = fimm; i++;;
   break;
  }
  ...
  case ENC_FSQRT_D_FLOATDP1:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->d)]; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->n)]; i++;;;
   break;
  }
  ...
  case ENC_FSUB_D_FLOATDP2:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->d)]; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->m)]; i++;;;
   break;
  }
  ...
  case ENC_FNMSUB_D_FLOATDP3:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->m)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->a)]; i++;;;
   break;
  }
  case ENC_FCSEL_D_FLOATSEL:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->m)]; i++;;;
   instr->operands[i].operandClass = CONDITION; instr->operands[i].cond = table_cond[ctx->condition]; i++;;
   break;
  }
  case ENC_FCVT_DH_FLOATDP1:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->d)]; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(4)][(ctx->n)]; i++;;;
   break;
  }
  ...
  case ENC_UADDV_R_P_Z_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->d)]; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec; i++;
   break;
  }
  case ENC_FCVT_DS_FLOATDP1:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->d)]; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(5)][(ctx->n)]; i++;;;
   break;
  }
  ...
  case ENC_UCVTF_D32_FLOAT2INT:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->d)]; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->n)]; i++;;;
   break;
  }
  ...
  case ENC_UCVTF_D32_FLOAT2FIX:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->d)]; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = fbits; i++;;
   break;
  }
  ...
  case ENC_UCVTF_D64_FLOAT2INT:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->d)]; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][(ctx->n)]; i++;;;
   break;
  }
  ...
  case ENC_FCMP_DZ_FLOATCMP:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = FIMM32; ImmFloatUnion *ifu = (ImmFloatUnion *)&(instr->operands[i].immediate); ifu->ui = 0; i++;;
   break;
  }
  ...
  case ENC_FCCMP_D_FLOATCCMP:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->m)]; i++;;;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = ctx->nzcv; i++;;
   instr->operands[i].operandClass = CONDITION; instr->operands[i].cond = table_cond[ctx->condition]; i++;;
   break;
  }
  ...
  case ENC_STP_D_LDSTPAIR_PRE:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->t)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->t2)]; i++;;;
   instr->operands[i].operandClass = MEM_PRE_IDX; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = ctx->offset; instr->operands[i].signedImm = 1;;
   break;
  }
  ...
  case ENC_STP_D_LDSTPAIR_POST:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->t)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->t2)]; i++;;;
   instr->operands[i].operandClass = MEM_POST_IDX; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = imm; instr->operands[i].signedImm = 1;;
   break;
  }
  ...
  case ENC_STP_D_LDSTPAIR_OFF:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->t)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->t2)]; i++;;;
   instr->operands[i].operandClass = MEM_OFFSET; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = imm; instr->operands[i].signedImm = 1; i++;;
   break;
  }
  ...
  case ENC_STR_D_LDST_REGOFF:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->t)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(reg_base)][(ctx->m)]; i++;;
   instr->operands[i-1].shiftType = ctx->extend_type; instr->operands[i-1].shiftValue = ctx->shift; if(ctx->option == 3) { if(ctx->shift) { instr->operands[i-1].shiftType = ShiftType_LSL; instr->operands[i-1].shiftValueUsed = 1; } else instr->operands[i-1].shiftType = ShiftType_NONE; } else { instr->operands[i-1].shiftValueUsed = ctx->shift ? 1 : 0; };
   break;
  }
  ...
  case ENC_LDR_D_LOADLIT:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(6)][(ctx->t)]; i++;;;
   instr->operands[i].operandClass = LABEL; instr->operands[i].immediate = eaddr; i++;;
   break;
  }
  case ENC_FMOV_H_FLOATIMM:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(4)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = FIMM32; ImmFloatUnion *ifu = (ImmFloatUnion *)&(instr->operands[i].immediate); ifu->ui = fimm; i++;;
   break;
  }
  ...
  case ENC_FSUB_H_FLOATDP2:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(4)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(4)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(4)][(ctx->m)]; i++;;;
   break;
  }
  ...
  case ENC_FNMSUB_H_FLOATDP3:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(4)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(4)][(ctx->m)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(4)][(ctx->a)]; i++;;;
   break;
  }
  ...
  case ENC_FMUL_ASISDELEM_RH_H:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(4)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(4)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++; instr->operands[i-1].lane = ctx->index; instr->operands[i-1].laneUsed = 1;;
   break;
  }
  ...
  case ENC_BFCVTNT_Z_P_Z_S2BF:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->d)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;; instr->operands[i-1].pred_qual = 'm';;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;
   break;
  }
  ...
  case ENC_URSQRTE_Z_P_Z_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->d)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;; instr->operands[i-1].pred_qual = 'm';;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;
   break;
  }
  ...
  case ENC_STR_H_LDST_IMMPRE:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(4)][(ctx->t)]; i++;;;
   instr->operands[i].operandClass = MEM_PRE_IDX; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = ctx->offset; instr->operands[i].signedImm = 1;;
   break;
  }
  ...
  case ENC_FCMLT_FCMGT_P_P_ZZ_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->d)]; i++;;; instr->operands[i-1].arrSpec = arr_spec;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;; instr->operands[i-1].pred_qual = 'z';;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec; i++;
   break;
  }
  ...
  case ENC_CMPNE_P_P_ZI_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;; instr->operands[i-1].pred_qual = 'z';;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = imm; i++;;
   break;
  }
  ...
  case ENC_CMPNE_P_P_ZW_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;; instr->operands[i-1].pred_qual = 'z';;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;
   break;
  }
  case ENC_REV_P_P_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->d)]; i++;;; instr->operands[i-1].arrSpec = arr_spec;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->n)]; i++;;; instr->operands[i-1].arrSpec = arr_spec;;
   break;
  }
  case ENC_TRN1_P_PP_:
  case ENC_TRN2_P_PP_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->d)]; i++;;; instr->operands[i-1].arrSpec = arr_spec;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->n)]; i++;;; instr->operands[i-1].arrSpec = arr_spec;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->m)]; i++;;; instr->operands[i-1].arrSpec = arr_spec;;
   break;
  }
  case ENC_UZP1_P_PP_:
  case ENC_UZP2_P_PP_:
  ...
  {
   ArrangementSpec arr_spec = table_b_h_s_d[ctx->size];
   unsigned rn_base = ctx->sf ? 1 : 0;
   unsigned rm_base = rn_base;

   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->d)]; i++;;; instr->operands[i-1].arrSpec = arr_spec;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(rn_base)][(ctx->n)]; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(rm_base)][(ctx->m)]; i++;;
   break;
  }
  case ENC_PTRUE_P_S_:
  case ENC_PTRUES_P_S_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->d)]; i++;;; instr->operands[i-1].arrSpec = arr_spec;;
   if(ctx->pattern != 0x1f) { if(ctx->pattern>0b1101 && ctx->pattern<0b11101) { instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = ctx->pattern; i++;; } else { instr->operands[i].operandClass = NAME; 
# 1842 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 1842 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 1842 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 1842 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  pattern_lookup(ctx->pattern, ctx->imm)
# 1842 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , __builtin_object_size (
# 1842 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
...
# 1842 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ...
  case ENC_RDFFR_P_F_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->d)]; i++;;; instr->operands[i-1].arrSpec = ARRSPEC_1BYTE;;
   break;
  }
  case ENC_SEL_P_P_PP_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->d)]; i++;;; instr->operands[i-1].arrSpec = ARRSPEC_1BYTE;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->n)]; i++;;; instr->operands[i-1].arrSpec = ARRSPEC_1BYTE;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->m)]; i++;;; instr->operands[i-1].arrSpec = ARRSPEC_1BYTE;;
   break;
  }
  ...
  case ENC_BRKB_P_P_P_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->d)]; i++;;; instr->operands[i-1].arrSpec = ARRSPEC_1BYTE;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;; instr->operands[i-1].pred_qual = pred_qual;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->n)]; i++;;; instr->operands[i-1].arrSpec = ARRSPEC_1BYTE;;
   break;
  }
  ...
  case ENC_NMATCH_P_P_ZZ_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->d)]; i++;;; instr->operands[i-1].arrSpec = T;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;; instr->operands[i-1].pred_qual = 'z';;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->n)]; i++;;; instr->operands[i-1].arrSpec = T;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->m)]; i++;;; instr->operands[i-1].arrSpec = T;;
   break;
  }
  ...
  case ENC_PUNPKLO_P_P_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->d)]; i++;;; instr->operands[i-1].arrSpec = ARRSPEC_1HALF;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->n)]; i++;;; instr->operands[i-1].arrSpec = ARRSPEC_1BYTE;;
   break;
  }
  ...
  case ENC_BRKNS_P_P_PP_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->Pdm)]; i++;;; instr->operands[i-1].arrSpec = ARRSPEC_1BYTE;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;; instr->operands[i-1].pred_qual = 'z';;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->n)]; i++;;; instr->operands[i-1].arrSpec = ARRSPEC_1BYTE;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->Pdm)]; i++;;; instr->operands[i-1].arrSpec = ARRSPEC_1BYTE;;
   break;
  ...
  case ENC_PNEXT_P_P_P_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->Pdn)]; i++;;; instr->operands[i-1].arrSpec = arr_spec;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->Pdn)]; i++;;; instr->operands[i-1].arrSpec = arr_spec;;
   break;
  }
  case ENC_PFIRST_P_P_P_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->Pdn)]; i++;;; instr->operands[i-1].arrSpec = ARRSPEC_1BYTE;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->Pdn)]; i++;;; instr->operands[i-1].arrSpec = ARRSPEC_1BYTE;;
   break;
  }
  ...
  case ENC_STR_P_BI_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->t)]; i++;;;
   instr->operands[i].operandClass = MEM_OFFSET; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = imm; instr->operands[i].signedImm = 1; i++;; instr->operands[i-1].mul_vl = 1;;
   break;
  }
  case ENC_SHA512H2_QQV_CRYPTOSHA512_3:
  case ENC_SHA512H_QQV_CRYPTOSHA512_3:
  {
   ArrangementSpec arr_spec_2d = ARRSPEC_2DOUBLES;

   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(7)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(7)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec_2d; i++;
   break;
  }
  case ENC_SHA256H2_QQV_CRYPTOSHA3:
  case ENC_SHA256H_QQV_CRYPTOSHA3:
  {
   ArrangementSpec arr_spec_4s = ARRSPEC_4SINGLES;

   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(7)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(7)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec_4s; i++;
   break;
  }
  ...
  case ENC_STP_Q_LDSTPAIR_PRE:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(7)][(ctx->t)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(7)][(ctx->t2)]; i++;;;
   instr->operands[i].operandClass = MEM_PRE_IDX; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = ctx->offset; instr->operands[i].signedImm = 1;;
   break;
  }
  ...
  case ENC_LASTB_R_P_Z_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(rd_base)][(ctx->d)]; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec; i++;
   break;
  }
  ...
  case ENC_CLASTB_R_P_Z_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(rdn_base)][(ctx->Rdn)]; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(rdn_base)][(ctx->Rdn)]; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec; i++;
   break;
  ...
  case ENC_TBZ_ONLY_TESTBRANCH:
  {
   ...
   unsigned rt_base = ctx->datasize == 32 ? 0 : 1;
   uint64_t eaddr = ctx->address + ctx->offset;

   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(rt_base)][(ctx->Rt)]; i++;;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = imm; i++;;
   instr->operands[i].operandClass = LABEL; instr->operands[i].immediate = eaddr; i++;;
   break;
  }
  case ENC_FMOV_S_FLOATIMM:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(5)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = FIMM32; ImmFloatUnion *ifu = (ImmFloatUnion *)&(instr->operands[i].immediate); ifu->ui = fimm; i++;;
   break;
  }
  ...
  case ENC_FSUB_S_FLOATDP2:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(5)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(5)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(5)][(ctx->m)]; i++;;;
   break;
  }
  ...
  case ENC_FNMSUB_S_FLOATDP3:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(5)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(5)][(ctx->m)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(5)][(ctx->a)]; i++;;;
   break;
  }
  ...
  case ENC_STP_S_LDSTPAIR_PRE:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(5)][(ctx->t)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(5)][(ctx->t2)]; i++;;;
   instr->operands[i].operandClass = MEM_PRE_IDX; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = ctx->offset; instr->operands[i].signedImm = 1;;
   break;
  }
  ...
  case ENC_CMLT_ASISDMISC_Z:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(rd_base)][(ctx->d)]; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(rn_base)][(ctx->n)]; i++;;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = 0; i++;;
   break;
  }
  ...
  case ENC_USRA_ASISDSHF_R:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(rd_base)][(ctx->d)]; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(rn_base)][(ctx->n)]; i++;;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = shift; i++;;
   break;
  }
  ...
  case ENC_FMUL_ASISDELEM_R_SD:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(rd_base)][(ctx->d)]; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(rn_base)][(ctx->n)]; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec; i++; instr->operands[i-1].lane = ctx->index; instr->operands[i-1].laneUsed = 1;;
   break;
  }
  ...
  {
   unsigned rd_base = 6;
   ArrangementSpec arr_spec = ARRSPEC_2DOUBLES;

   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(rd_base)][(ctx->d)]; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec; i++;
   break;
  }
  case ENC_FADDP_ASISDPAIR_ONLY_SD:
  {
   unsigned rd_base = ctx->sz ? 6 : 5;
  ...
  {
   unsigned rd_base = 5;
   ArrangementSpec arr_spec = ARRSPEC_4SINGLES;
  ...
  case ENC_MOV_DUP_ASISDONE_ONLY:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(rd_base)][(ctx->d)]; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec; i++; instr->operands[i-1].lane = ctx->index; instr->operands[i-1].laneUsed = 1;;
   break;
  }
  ...
  case ENC_FADDA_V_P_Z_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(rdn_base)][(ctx->Vdn)]; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(rdn_base)][(ctx->Vdn)]; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec; i++;
   break;
  ...
  {
   ArrangementSpec arr_spec_16b = ARRSPEC_16BYTES;

   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = arr_spec_16b; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec_16b; i++;
   break;
  }
  ...
  case ENC_EOR3_VVV16_CRYPTO4:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = arr_spec_16b; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec_16b; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec_16b; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->a)]; instr->operands[i].arrSpec = arr_spec_16b; i++;
   break;
  }
  case ENC_MOVI_ASIMDIMM_D2_D:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->rd)]; instr->operands[i].arrSpec = arr_spec_2d; i++;
   instr->operands[i].operandClass = IMM64; instr->operands[i].signedImm = 0; instr->operands[i].immediate = imm; i++;;
   break;
  }
  case ENC_FMOV_ASIMDIMM_D2_D:
  {
   float fimm = table_imm8_to_float[((ctx->a<<7)|(ctx->b<<6)|(ctx->c<<5)|(ctx->d<<4)|(ctx->e<<3)|(ctx->f<<2)|(ctx->g<<1)|ctx->h)];
   ArrangementSpec arr_spec_2d = ARRSPEC_2DOUBLES;
  ...
  case ENC_SHA512SU0_VV2_CRYPTOSHA512_2:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = arr_spec_2d; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec_2d; i++;
   break;
  }
  ...
  case ENC_XAR_VVV2_CRYPTO3_IMM6:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec_2d; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec_2d; i++;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = imm6; i++;;
   break;
  }
  ...
  case ENC_USMMLA_ASIMDSAME2_G:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = arr_spec_4s; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec_16b; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec_16b; i++;
   break;
  }
  ...
  case ENC_SM4E_VV4_CRYPTOSHA512_2:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = arr_spec_4s; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec_4s; i++;
   break;
  }
  ...
  case ENC_SM3SS1_VVV4_CRYPTO4:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec_4s; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec_4s; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->a)]; instr->operands[i].arrSpec = arr_spec_4s; i++;
   break;
  }
  ...
  case ENC_SM3TT2B_VVV_CRYPTO3_IMM2:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = arr_spec_4s; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec_4s; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++; instr->operands[i-1].lane = ctx->imm2; instr->operands[i-1].laneUsed = 1;;
   break;
  }
  case ENC_MOVI_ASIMDIMM_M_SM:
  case ENC_MVNI_ASIMDIMM_M_SM:
  {
   uint64_t imm8 = ((ctx->a<<7)|(ctx->b<<6)|(ctx->c<<5)|(ctx->d<<4)|(ctx->e<<3)|(ctx->f<<2)|(ctx->g<<1)|ctx->h);
   ArrangementSpec arr_spec = table_2s_4s[ctx->Q];

   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->rd)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = imm8; i++;;
  ...
  case ENC_ORR_ASIMDIMM_L_SL:
  {
   ...
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = imm8; i++;;
   if(AMOUNT) {
    instr->operands[i-1].shiftType = ShiftType_LSL; instr->operands[i-1].shiftValue = AMOUNT; instr->operands[i-1].shiftValueUsed = 1;;
   }
   break;
  }
  ...
  case ENC_DUP_ASIMDINS_DR_R:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(rn_base)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_FSUB_ASIMDSAMEFP16_ONLY:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec; i++;
   break;
  }
  ...
  case ENC_EXT_ASIMDEXT_ONLY:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = IMM64; instr->operands[i].signedImm = 0; instr->operands[i].immediate = const_; i++;;
   break;
  }
  ...
  case ENC_FCMLA_ASIMDSAME2_C:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = rotate; i++;;
   break;
  }
  ...
  case ENC_FMUL_ASIMDELEM_R_SD:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = arr_spec0; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec0; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec1; i++; instr->operands[i-1].lane = ctx->index; instr->operands[i-1].laneUsed = 1;;
   break;
  }
  ...
  case ENC_DUP_ASIMDINS_DV_V:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = arr_spec0; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec1; i++; instr->operands[i-1].lane = ctx->index; instr->operands[i-1].laneUsed = 1;;
   break;
  }
  ...
  case ENC_UADDLP_ASIMDMISC_P:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = Ta; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = Tb; i++;;
   break;
  }
  ...
  {
   ArrangementSpec arr_spec_4b = ARRSPEC_4BYTES;
   ArrangementSpec Ta = table_2s_4s[ctx->Q];
   ArrangementSpec Tb = table_8b_16b[ctx->Q];

   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = Ta; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = Tb; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec_4b; i++; instr->operands[i-1].lane = ctx->index; instr->operands[i-1].laneUsed = 1;;
   break;
  }
  ...
  case ENC_FMLAL2_ASIMDSAME_F:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = Ta; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = Tb; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->m)]; instr->operands[i].arrSpec = Tb; i++;;
   break;
  }
  ...
  case ENC_PMUL_Z_ZZ_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->da)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++;
   break;
  }
  ...
  case ENC_USMMLA_Z_ZZZ_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->da)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++;
   break;
  }
  case ENC_FMMLA_Z_ZZZ_S:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->da)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;
   break;
  }
  case ENC_SM4E_Z_ZZ_:
  {

   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->dn)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->dn)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;
   break;
  }
  ...
  case ENC_FMLSLT_Z_ZZZ_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->da)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++;
   break;
  }
  ...
  case ENC_SUDOT_Z_ZZZI_S:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->da)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++; instr->operands[i-1].lane = ctx->index; instr->operands[i-1].laneUsed = 1;;
   break;
  }
  ...
  case ENC_UMLSLT_Z_ZZZI_S:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->da)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++; instr->operands[i-1].lane = ctx->index; instr->operands[i-1].laneUsed = 1;;
   break;
  }
  ...
  case ENC_UMULLT_Z_ZZI_D:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->d)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++; instr->operands[i-1].lane = ctx->index; instr->operands[i-1].laneUsed = 1;;
   break;
  }
  ...
  case ENC_UMLSLT_Z_ZZZI_D:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->da)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++; instr->operands[i-1].lane = ctx->index; instr->operands[i-1].laneUsed = 1;;
   break;
  }
  ...
  case ENC_ZIP2_Z_ZZ_Q:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->d)]; instr->operands[i].arrSpec = ARRSPEC_FULL; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_FULL; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_FULL; i++;
   break;
  }
  ...
  case ENC_TBX_ASIMDTBL_L4_4:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = Ta; i++;;
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->n+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(2)][((ctx->n+2)%32)]; instr->operands[i].reg[3] = regMap[(1)][(2)][((ctx->n+3)%32)]; instr->operands[i].arrSpec = ARRSPEC_16BYTES; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->m)]; instr->operands[i].arrSpec = Ta; i++;;
   break;
  }
  ...
  case ENC_TBX_ASIMDTBL_L3_3:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = Ta; i++;;
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->n+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(2)][((ctx->n+2)%32)]; instr->operands[i].arrSpec = ARRSPEC_16BYTES; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->m)]; instr->operands[i].arrSpec = Ta; i++;;
   break;
  }
  ...
  case ENC_TBX_ASIMDTBL_L2_2:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = Ta; i++;;
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->n+1)%32)]; instr->operands[i].arrSpec = ARRSPEC_16BYTES; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->m)]; instr->operands[i].arrSpec = Ta; i++;;
   break;
  }
  ...
  case ENC_TBX_ASIMDTBL_L1_1:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = Ta; i++;;
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_16BYTES; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->m)]; instr->operands[i].arrSpec = Ta; i++;;
   break;
  }
...
# 3766 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = arr_spec; i++; instr->operands[i-1].lane = ctx->dst_index; instr->operands[i-1].laneUsed = 1;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec; i++; instr->operands[i-1].lane = ctx->src_index; instr->operands[i-1].laneUsed = 1;;
   break;
  }
  ...
  case ENC_MOV_INS_ASIMDINS_IR_R:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = arr_spec; i++; instr->operands[i-1].lane = ctx->index; instr->operands[i-1].laneUsed = 1;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(rn_base)][(ctx->n)]; i++;;
   break;
  }
  case ENC_FMOV_V64I_FLOAT2INT:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++; instr->operands[i-1].lane = 1; instr->operands[i-1].laneUsed = 1;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][(ctx->n)]; i++;;;
   break;
  }
  ...
  case ENC_MOV_MOVZ_32_MOVEWIDE:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = imm; i++;;
   break;
  }
  ...
  {
   unsigned lsb = 32 - ctx->immr;
   unsigned width = ctx->imms+1;

   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = lsb; i++;;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = width; i++;;
   break;
  }
  ...
  {
   ArrangementSpec arr_spec = ctx->esize == 16 ? ARRSPEC_1HALF : ARRSPEC_1BYTE;
  ...
  case ENC_MOV_UMOV_ASIMDINS_W_W:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++; instr->operands[i-1].lane = ctx->index; instr->operands[i-1].laneUsed = 1;;
   break;
  }
  ...
  case ENC_NGC_SBC_32_ADDSUB_CARRY:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->m)]; i++;;;
   break;
  }
  ...
  case ENC_NEG_SUB_32_ADDSUB_SHIFT:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->m)]; i++;;;
   if(!(ctx->shift_type==1 && ctx->shift_amount==0)) { instr->operands[i-1].shiftType = ctx->shift_type; instr->operands[i-1].shiftValue = ctx->shift_amount; instr->operands[i-1].shiftValueUsed = 1; } else { instr->operands[i-1].shiftValueUsed = 0; };
   break;
  }
  ...
  {
   unsigned lsb = ctx->immr;
   unsigned width = ctx->imms-ctx->immr+1;
  ...
  {
   unsigned const_ = (instr->encoding == ENC_LSL_UBFM_32M_BITFIELD) ?
    31 - ctx->imms : ctx->immr;
  ...
  case ENC_MSUB_32A_DP_3SRC:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->m)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->a)]; i++;;;
   break;
  }
  ...
  case ENC_CRC32X_64C_DP_2SRC:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][(ctx->m)]; i++;;;
   break;
  }
  ...
  case ENC_CNEG_CSNEG_32_CONDSEL:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = CONDITION; instr->operands[i].cond = table_cond_neg[ctx->condition]; i++;;
   break;
  }
  ...
  case ENC_SUBS_32S_ADDSUB_IMM:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(0)][(0)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = imm; i++;;
   if(ctx->sh) {
    instr->operands[i-1].shiftType = ShiftType_LSL; instr->operands[i-1].shiftValue = 12; instr->operands[i-1].shiftValueUsed = 1;;
   }
   break;
  }
  ...
  case ENC_SUBS_32S_ADDSUB_EXT:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(0)][(0)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->m)]; i++;;;
   ShiftType st = DecodeRegExtend(ctx->option); if(st == ShiftType_UXTW) { if(ctx->n==31 && ctx->imm3 != 0) { st = ShiftType_LSL; } } instr->operands[i-1].shiftType = st; instr->operands[i-1].shiftValue = ctx->shift; if(ctx->shift) { instr->operands[i-1].shiftValueUsed = 1; };
   break;
  }
  case ENC_ROR_EXTR_32_EXTRACT:
  {
   unsigned shift = ctx->imms;
  ...
  case ENC_UQINCP_R_P_R_UW:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->dn)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->m)]; i++;;; instr->operands[i-1].arrSpec = arr_spec;;
   break;
  }
  ...
  case ENC_UQINCW_R_RS_UW:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->dn)]; i++;;;
   { 
# 4173 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  _Bool 
# 4173 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  print_mul = ctx->imm != 1; 
# 4173 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  _Bool 
# 4173 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  print_pattern = print_mul || ctx->pattern != 0x1f; if(print_pattern) { if(ctx->pattern>0b1101 && ctx->pattern<0b11101) { instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = ctx->pattern; i++;; } else { instr->operands[i].operandClass = NAME; 
# 4173 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 4173 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
...
# 4173 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 2 > 1 ? 1 : 0))
# 4173 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;; }; } if(print_mul) { instr->operands[i].operandClass = STR_IMM; instr->operands[i].immediate = ctx->imm; instr->operands[i].signedImm = 0; 
# 4173 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 4173 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
...
# 4173 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ...
  case ENC_MOV_ORR_32_LOG_IMM:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(0)][(0)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = imm; i++;;
   break;
  }
  ...
  case ENC_STUMIN_LDUMIN_32_MEMOP:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->s)]; i++;;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_CASP_CP32_COMSWAPPR:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->s)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][((ctx->s+1)%32)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->t)]; i++;;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][((ctx->t+1)%32)]; i++;;;
   instr->operands[i].operandClass = MEM_OFFSET; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = 0; instr->operands[i].signedImm = 1; i++;;
   break;
  }
  ...
  case ENC_STXP_SP32_LDSTEXCLP:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->s)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->t)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->t2)]; i++;;;
   instr->operands[i].operandClass = MEM_OFFSET; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = 0; instr->operands[i].signedImm = 1; i++;;
   break;
  }
  ...
  case ENC_STXP_SP64_LDSTEXCLP:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->s)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][(ctx->t)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][(ctx->t2)]; i++;;;
   instr->operands[i].operandClass = MEM_OFFSET; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = 0; instr->operands[i].signedImm = 1; i++;;
   break;
  }
  ...
  case ENC_ST64BV0_64_MEMOP:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][(ctx->s)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][(ctx->t)]; i++;;;
   instr->operands[i].operandClass = MEM_OFFSET; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = 0; instr->operands[i].signedImm = 1; i++;;
   break;
  }
  ...
  {
   unsigned lsb = ctx->immr ? 64 - ctx->immr : 0;
   unsigned width = ctx->imms+1;
  ...
  case ENC_FMOV_64VX_FLOAT2INT:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++; instr->operands[i-1].lane = 1; instr->operands[i-1].laneUsed = 1;;
   break;
  }
  case ENC_MOV_UMOV_ASIMDINS_X_X:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++; instr->operands[i-1].lane = ctx->index; instr->operands[i-1].laneUsed = 1;;
   break;
  }
  ...
  case ENC_UMSUBL_64WA_DP_3SRC:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->m)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][(ctx->a)]; i++;;;
   break;
  }
  ...
  {
   unsigned const_ = (instr->encoding == ENC_LSL_UBFM_64M_BITFIELD) ?
    64 - ctx->immr : ctx->immr;
  ...
  case ENC_PACGA_64P_DP_2SRC:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->m)]; i++;;;
   break;
  }
  ...
  case ENC_PACIB_64P_DP_1SRC:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;;
   break;
  }
  ...
  {
   unsigned rm_base = (ctx->option & 0x3) == 3 ? 1 : 0;
  ...
  {
   uint64_t eaddr = ctx->page ?
    (ctx->address & 0xFFFFFFFFFFFFF000) + ctx->imm : ctx->address + ctx->imm;
  ...
  case ENC_CNTW_R_S_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][(ctx->d)]; i++;;;
   { 
# 5194 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  _Bool 
# 5194 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  print_mul = ctx->imm != 1; 
# 5194 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  _Bool 
# 5194 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 5194 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ...
  case ENC_UQINCP_R_P_R_X:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][(ctx->Rdn)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->m)]; i++;;; instr->operands[i-1].arrSpec = arr_spec;;
   break;
  }
  ...
  case ENC_SQINCW_R_RS_SX:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(0)][(ctx->dn)]; i++;;;
   { 
# 5232 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  _Bool 
# 5232 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  print_mul = ctx->imm != 1; 
# 5232 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  _Bool 
# 5232 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 5263 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  _Bool 
# 5263 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
       print_mul = ctx->imm != 1;
   
# 5264 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  _Bool 
# 5264 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
       print_pattern = print_mul || ctx->pattern != 0x1f;

   if(print_pattern) {
    if(ctx->pattern>0b1101 && ctx->pattern<0b11101) { instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = ctx->pattern; i++;; } else { instr->operands[i].operandClass = NAME; 
# 5267 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
   __builtin___strcpy_chk (
# 5267 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
   instr->operands[i].name
# 5267 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
   , 
# 5267 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 5267 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
   ...
   if(print_mul) {
    instr->operands[i].operandClass = STR_IMM; instr->operands[i].immediate = ctx->imm; instr->operands[i].signedImm = 0; 
# 5271 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
   __builtin___strcpy_chk (
# 5271 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
   instr->operands[i].name
# 5271 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
   , 
# 5271 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 5271 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ...
  case ENC_MOV_ORR_64_LOG_IMM:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = IMM64; instr->operands[i].signedImm = 0; instr->operands[i].immediate = imm; i++;;
   break;
  }
  ...
  case ENC_SUBG_64_ADDSUB_IMMTAGS:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = uimm6; i++;;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = uimm4; i++;;
   break;
  }
  ...
  case ENC_RMIF_ONLY_RMIF:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = shift; i++;;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = mask; i++;;
   break;
  }
  ...
  case ENC_CMP_SUBS_64S_ADDSUB_EXT:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(rm_base)][(ctx->m)]; i++;;
   ShiftType st = DecodeRegExtend(ctx->option); if(ctx->Rn==31 && ctx->option == 3) { st = ShiftType_LSL; if(ctx->imm3 == 0) st = ShiftType_NONE; } if(st != ShiftType_NONE) { instr->operands[i-1].shiftType = st; instr->operands[i-1].shiftValue = ctx->shift; instr->operands[i-1].shiftValueUsed = 1; } if(!ctx->shift) { instr->operands[i-1].shiftValueUsed = 0; };
   break;
  }
  ...
  case ENC_CASP_CP64_COMSWAPPR:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][(ctx->s)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][((ctx->s+1)%32)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][(ctx->t)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][((ctx->t+1)%32)]; i++;;;
   instr->operands[i].operandClass = MEM_OFFSET; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = 0; instr->operands[i].signedImm = 1; i++;;
   break;
  }
  ...
  {
   instr->operands[i].operandClass = NAME; 
# 5618 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 5618 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 5618 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 5618 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 5618 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ...
  case ENC_SYSL_RC_SYSTEMINSTRS:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][(ctx->t)]; i++;;;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = ctx->op1; i++;;
   instr->operands[i].operandClass = NAME; 
# 5628 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 5628 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 5628 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 5628 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  reg_lookup_c[ctx->sys_crn & 0xF]
# 5628 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , __builtin_object_size (
# 5628 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
...
# 5628 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;;
   instr->operands[i].operandClass = NAME; 
# 5629 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 5629 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 5629 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 5629 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  reg_lookup_c[ctx->sys_crm & 0xF]
# 5629 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , __builtin_object_size (
# 5629 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
...
# 5629 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = ctx->op2; i++;;
   break;
  }
  case ENC_MRS_RS_SYSTEMMOVE:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(1)][(ctx->t)]; i++;;;
   { SystemReg sr = ((ctx->sys_op0<<14)|(ctx->sys_op1<<11)|(ctx->sys_crn<<7)|(ctx->sys_crm<<3)|ctx->sys_op2); const char *name = get_system_register_name(sr); if(name[0]) { instr->operands[i].operandClass = SYS_REG; instr->operands[i].sysreg = (sr); i++;; } else { instr->operands[i].operandClass = IMPLEMENTATION_SPECIFIC; instr->operands[i].implspec[0] = ctx->sys_op0; instr->operands[i].implspec[1] = ctx->sys_op1; instr->operands[i].implspec[2] = ctx->sys_crn; instr->operands[i].implspec[3] = ctx->sys_crm; instr->operands[i].implspec[4] = ctx->sys_op2; i++;; } };
   break;
  }
  ...
  case ENC_STZG_64SPRE_LDSTTAGS:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->t)]; i++;;;
   instr->operands[i].operandClass = MEM_PRE_IDX; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = ctx->offset; instr->operands[i].signedImm = 1;;
   break;
  }
  ...
  case ENC_MOVPRFX_Z_Z_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->d)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; i++;;;
   break;
  }
  case ENC_FMOV_DUP_Z_I_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->d)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = FIMM32; ImmFloatUnion *ifu = (ImmFloatUnion *)&(instr->operands[i].immediate); ifu->ui = 0; i++;;
   break;
  }
  ...
  case ENC_DUPM_Z_I_:
  {
   ...
   if(arr_spec==ARRSPEC_1BYTE) const_ &= 0xFF;
   if(arr_spec==ARRSPEC_1HALF) const_ &= 0xFFFF;
   if(arr_spec==ARRSPEC_1SINGLE) const_ &= 0xFFFFFFFF;
  ...
  case ENC_INDEX_Z_II_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->d)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = imm1; i++;;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = imm2; i++;;
   break;
  }
  ...
  {
   ArrangementSpec arr_spec = ctx->sz ? ARRSPEC_1DOUBLE : ARRSPEC_1SINGLE;

   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->d)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(8)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec; i++;;
   if(ctx->msz) {
    instr->operands[i-1].shiftType = ShiftType_LSL; instr->operands[i-1].shiftValue = ctx->msz; instr->operands[i-1].shiftValueUsed = 1;
   }
   break;
  }
  case ENC_COMPACT_Z_P_Z_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->d)]; instr->operands[i].arrSpec = arr_spec0; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec0; i++;
   break;
  }
  ...
  case ENC_HISTCNT_Z_P_ZZ_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->d)]; instr->operands[i].arrSpec = T; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;; instr->operands[i-1].pred_qual = 'z';;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = T; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = T; i++;
   break;
  }
  ...
  case ENC_UADALP_Z_P_Z_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->da)]; instr->operands[i].arrSpec = T; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;; instr->operands[i-1].pred_qual = 'm';;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = Tb; i++;
   break;
  }
  ...
  {
   ArrangementSpec arr_spec = table_b_h_s_d[ctx->size];
   unsigned rn_base = ctx->size==3 ? 1 : 0;

   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->d)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;; instr->operands[i-1].pred_qual = 'm';;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(0)][(rn_base)][(ctx->n)]; i++;;
   break;
  }
  ...
  {
   ArrangementSpec arr_spec = table_b_h_s_d[ctx->size];
   unsigned rn_base = (ctx->size & 0x3) == 3 ? 1 : 0;
   unsigned rm_base = (ctx->size & 0x3) == 3 ? 1 : 0;
  ...
  case ENC_MOV_DUP_Z_ZI_2:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->d)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec; i++; instr->operands[i-1].lane = ctx->index; instr->operands[i-1].laneUsed = 1;;
   break;
  }
  ...
  case ENC_TBL_Z_ZZ_1:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->d)]; instr->operands[i].arrSpec = arr_spec; i++;
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec; i++;
   break;
  }
  case ENC_ADR_Z_AZ_D_S32_SCALED:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->d)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(8)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;;
   if(ctx->msz) {
    instr->operands[i-1].shiftType = ShiftType_SXTW; instr->operands[i-1].shiftValue = ctx->msz; instr->operands[i-1].shiftValueUsed = 1;
   }
   break;
  }
  case ENC_ADR_Z_AZ_D_U32_SCALED:
  {
   ...
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(8)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;;
   if(ctx->msz) {
    instr->operands[i-1].shiftType = ShiftType_UXTW; instr->operands[i-1].shiftValue = ctx->msz; instr->operands[i-1].shiftValueUsed = 1;
   }
   break;
  }
  ...
  case ENC_UXTW_Z_P_Z_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->d)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;; instr->operands[i-1].pred_qual = 'm';;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;
   break;
  }
  ...
  case ENC_FMUL_Z_ZZI_D:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->d)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++; instr->operands[i-1].lane = ctx->index; instr->operands[i-1].laneUsed = 1;;
   break;
  }
  ...
  case ENC_MLS_Z_P_ZZZ_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->Zda)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;; instr->operands[i-1].pred_qual = 'm';;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec; i++;
   break;
  ...
  case ENC_FMLS_Z_ZZZI_D:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->Zda)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++; instr->operands[i-1].lane = ctx->index; instr->operands[i-1].laneUsed = 1;;
   break;
  }
  ...
  case ENC_FMLS_Z_ZZZI_H:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->Zda)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++; instr->operands[i-1].lane = ctx->index; instr->operands[i-1].laneUsed = 1;;
   break;
  }
  ...
  case ENC_UDOT_Z_ZZZI_S:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->Zda)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++; instr->operands[i-1].lane = ctx->index; instr->operands[i-1].laneUsed = 1;;
   break;
  }
  ...
  case ENC_SPLICE_Z_P_ZZ_DES:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->Zdn)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->Zdn)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->Zm)]; instr->operands[i].arrSpec = arr_spec; i++;
   break;
  }
  ...
  case ENC_USQADD_Z_P_ZZ_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->dn)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;; instr->operands[i-1].pred_qual = 'm';;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->dn)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec; i++;
   break;
  ...
  case ENC_URSHR_Z_P_ZI_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->dn)]; instr->operands[i].arrSpec = T; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;; instr->operands[i-1].pred_qual = 'm';;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->dn)]; instr->operands[i].arrSpec = T; i++;
   instr->operands[i].operandClass = IMM64; instr->operands[i].signedImm = 0; instr->operands[i].immediate = const_; i++;;
   break;
  ...
  case ENC_FSUBR_Z_P_ZS_:
  {
   ArrangementSpec arr_spec = table_b_h_s_d[ctx->size];
   float fimm;
   if(instr->encoding == ENC_FADD_Z_P_ZS_ || instr->encoding == ENC_FSUB_Z_P_ZS_ || instr->encoding == ENC_FSUBR_Z_P_ZS_)
    fimm = ctx->i1 ? 1.0 : 0.5;
  ...
  case ENC_MSB_Z_P_ZZZ_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;; instr->operands[i-1].pred_qual = 'm';;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->a)]; instr->operands[i].arrSpec = arr_spec; i++;
   break;
  }
  ...
  case ENC_UQINCP_Z_P_Z_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->Zdn)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->m)]; i++;;;
   break;
  }
  case ENC_INSR_Z_R_:
  {
  ...
  case ENC_ORR_Z_ZI_:
  {
   ...
   uint64_t const_ = ctx->imm;
   switch(arr_spec) {
    case ARRSPEC_1BYTE: const_ &= 0xFF; break;
    case ARRSPEC_1HALF: const_ &= 0xFFFF; break;
    case ARRSPEC_1SINGLE: const_ &= 0xFFFFFFFF; break;
    default: break;
   }
  ...
  case ENC_UQADD_Z_ZI_:
  {
   ...
   if(instr->encoding == ENC_UQADD_Z_ZI_ && ctx->sh && !imm) {
    instr->operands[i-1].shiftType = ShiftType_LSL; instr->operands[i-1].shiftValue = 8; instr->operands[i-1].shiftValueUsed = 1;;
   }
  ...
  case ENC_XAR_Z_ZZI_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->Zdn)]; instr->operands[i].arrSpec = T; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->Zdn)]; instr->operands[i].arrSpec = T; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = T; i++;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = ctx->rot; i++;
   break;
  }
  case ENC_EXT_Z_ZI_DES:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->Zdn)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->Zdn)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->Zm)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = imm; i++;;
   break;
  }
  case ENC_AESD_Z_ZZ_:
  ...
  case ENC_UQINCD_Z_ZS_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->Zdn)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;
   { 
# 6796 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  _Bool 
# 6796 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  print_mul = ctx->imm != 1; 
# 6796 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  _Bool 
# 6796 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 6796 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ...
  case ENC_UQINCH_Z_ZS_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->Zdn)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++;
   { 
# 6808 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  _Bool 
# 6808 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  print_mul = ctx->imm != 1; 
# 6808 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  _Bool 
# 6808 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 6808 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ...
  case ENC_UQINCW_Z_ZS_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->Zdn)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;
   { 
# 6820 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  _Bool 
# 6820 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  print_mul = ctx->imm != 1; 
# 6820 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  _Bool 
# 6820 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 6820 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ...
  case ENC_STR_Z_BI_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->t)]; i++;;;
   instr->operands[i].operandClass = MEM_OFFSET; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = imm; instr->operands[i].signedImm = 1; i++;; instr->operands[i-1].mul_vl = 1;;
   break;
  }
  case ENC_AT_SYS_CR_SYSTEMINSTRS:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 6852 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 6852 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 6852 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 6852 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 6852 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ...
  case ENC_DC_SYS_CR_SYSTEMINSTRS:
  {
   ...
   else if(op1==0b000 && CRm==0b0110 && op2==0b011 && (ctx->features0 & ((uint64_t)1<<18))) dc_op = "igvac";
   else if(op1==0b000 && CRm==0b0110 && op2==0b100 && (ctx->features0 & ((uint64_t)1<<18))) dc_op = "igsw";
   else if(op1==0b000 && CRm==0b0110 && op2==0b101 && (ctx->features0 & ((uint64_t)1<<18))) dc_op = "igdvac";
   else if(op1==0b000 && CRm==0b0110 && op2==0b110 && (ctx->features0 & ((uint64_t)1<<18))) dc_op = "igdsw";
   else if(op1==0b000 && CRm==0b1010 && op2==0b010) dc_op = "csw";
   else if(op1==0b000 && CRm==0b1010 && op2==0b100 && (ctx->features0 & ((uint64_t)1<<18))) dc_op = "cgsw";
   else if(op1==0b000 && CRm==0b1010 && op2==0b010 && (ctx->features0 & ((uint64_t)1<<18))) dc_op = "cgdsw";
   else if(op1==0b000 && CRm==0b1110 && op2==0b010) dc_op = "cisw";
   else if(op1==0b000 && CRm==0b1110 && op2==0b100 && (ctx->features0 & ((uint64_t)1<<18))) dc_op = "cigsw";
   else if(op1==0b000 && CRm==0b1110 && op2==0b110 && (ctx->features0 & ((uint64_t)1<<18))) dc_op = "cigdsw";
   else if(op1==0b011 && CRm==0b0100 && op2==0b001) dc_op = "zva";
   else if(op1==0b011 && CRm==0b0100 && op2==0b011 && (ctx->features0 & ((uint64_t)1<<18))) dc_op = "gva";
   else if(op1==0b011 && CRm==0b0100 && op2==0b100 && (ctx->features0 & ((uint64_t)1<<18))) dc_op = "gzva";
   else if(op1==0b011 && CRm==0b1010 && op2==0b001) dc_op = "cvac";
   else if(op1==0b011 && CRm==0b1010 && op2==0b011 && (ctx->features0 & ((uint64_t)1<<18))) dc_op = "cgvac";
   else if(op1==0b011 && CRm==0b1010 && op2==0b101 && (ctx->features0 & ((uint64_t)1<<18))) dc_op = "cgdvac";
   else if(op1==0b011 && CRm==0b1011 && op2==0b001) dc_op = "cvau";
   else if(op1==0b011 && CRm==0b1100 && op2==0b001 && (1)) dc_op = "cvap";
   else if(op1==0b011 && CRm==0b1100 && op2==0b011 && (ctx->features0 & ((uint64_t)1<<18))) dc_op = "cgvap";
   else if(op1==0b011 && CRm==0b1100 && op2==0b101 && (ctx->features0 & ((uint64_t)1<<18))) dc_op = "cgdvap";
   else if(op1==0b011 && CRm==0b1101 && op2==0b001 && (1)) dc_op = "cvadp";
   else if(op1==0b011 && CRm==0b1101 && op2==0b011 && (ctx->features0 & ((uint64_t)1<<18))) dc_op = "cgvadp";
   else if(op1==0b011 && CRm==0b1101 && op2==0b101 && (ctx->features0 & ((uint64_t)1<<18))) dc_op = "cgdvadp";
   else if(op1==0b011 && CRm==0b1110 && op2==0b001) dc_op = "civac";
   else if(op1==0b011 && CRm==0b1110 && op2==0b011 && (ctx->features0 & ((uint64_t)1<<18))) dc_op = "cigvac";
   else if(op1==0b011 && CRm==0b1110 && op2==0b101 && (ctx->features0 & ((uint64_t)1<<18))) dc_op = "cgdvac";


   instr->operands[i].operandClass = NAME; 
# 6909 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 6909 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 6909 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 6909 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 6917 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  _Bool 
# 6917 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
       include_reg = 
# 6917 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
                     0
# 6917 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
   ...
   uint64_t op2 = ctx->op2;
   uint64_t CRm = ctx->CRm;
        if(op1==0b000 && CRm==0b0001 && op2==0b000) ic_op = "ialluis";
   else if(op1==0b000 && CRm==0b0101 && op2==0b000) ic_op = "iallu";
   else if(op1==0b011 && CRm==0b0101 && op2==0b001) {
    ic_op = "ivau";
    include_reg = 
# 6925 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
                 1
# 6925 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
                     ;
   }


   instr->operands[i].operandClass = NAME; 
# 6929 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 6929 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 6929 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 6929 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 6929 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ...
  case ENC_SYS_CR_SYSTEMINSTRS:
  {
   ...
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = ctx->op1; i++;;
   instr->operands[i].operandClass = NAME; 
# 6963 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 6963 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 6963 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 6963 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 6963 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;;
   instr->operands[i].operandClass = NAME; 
# 6964 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 6964 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 6964 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 6964 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 6964 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ...
  case ENC_DSB_BO_BARRIERS:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 6981 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 6981 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 6981 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 6981 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  table_barrier_limitations[ctx->CRm & 0xF]
# 6981 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , __builtin_object_size (
# 6981 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
...
# 6981 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ...
  case ENC_DSB_BON_BARRIERS:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 6988 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 6988 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 6988 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 6988 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  table_barrier_limitations[ctx->imm2]
# 6988 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , __builtin_object_size (
# 6988 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
...
# 6988 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ...
  case ENC_PRFH_I_P_BR_S:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 6995 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 6995 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 6995 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 6995 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 6995 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; instr->operands[i].arrSpec = 0; instr->operands[i].shiftType = ShiftType_LSL; instr->operands[i].shiftValue = 1; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  case ENC_PRFW_I_P_BR_S:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7004 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7004 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7004 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7004 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7004 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; instr->operands[i].arrSpec = 0; instr->operands[i].shiftType = ShiftType_LSL; instr->operands[i].shiftValue = 2; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  case ENC_PRFD_I_P_BR_S:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7013 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7013 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7013 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7013 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7013 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; instr->operands[i].arrSpec = 0; instr->operands[i].shiftType = ShiftType_LSL; instr->operands[i].shiftValue = 3; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  case ENC_PRFB_I_P_BR_S:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7022 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7022 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7022 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7022 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7022 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ...
  case ENC_PRFH_I_P_BZ_D_64_SCALED:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7031 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7031 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7031 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7031 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7031 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; instr->operands[i].shiftType = ShiftType_LSL; instr->operands[i].shiftValue = 1; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  case ENC_PRFW_I_P_BZ_D_64_SCALED:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7040 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7040 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7040 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7040 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7040 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; instr->operands[i].shiftType = ShiftType_LSL; instr->operands[i].shiftValue = 2; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  case ENC_PRFD_I_P_BZ_D_64_SCALED:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7049 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7049 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7049 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7049 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7049 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; instr->operands[i].shiftType = ShiftType_LSL; instr->operands[i].shiftValue = 3; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  case ENC_PRFH_I_P_BZ_D_X32_SCALED:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7059 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7059 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7059 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7059 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7059 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; instr->operands[i].shiftType = mod; instr->operands[i].shiftValue = 1; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  case ENC_PRFW_I_P_BZ_D_X32_SCALED:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7069 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7069 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7069 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7069 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7069 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; instr->operands[i].shiftType = mod; instr->operands[i].shiftValue = 2; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  case ENC_PRFD_I_P_BZ_D_X32_SCALED:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7079 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7079 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7079 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7079 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7079 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; instr->operands[i].shiftType = mod; instr->operands[i].shiftValue = 3; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  case ENC_PRFB_I_P_BZ_D_X32_SCALED:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7089 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7089 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7089 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7089 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7089 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; instr->operands[i].shiftType = mod; instr->operands[i].shiftValue = 0; instr->operands[i].shiftValueUsed = 0; i += 1;;
   break;
  }
  case ENC_PRFB_I_P_BZ_D_64_SCALED:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7098 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7098 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7098 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7098 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7098 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;;
   break;
  }
  case ENC_PRFH_I_P_BZ_S_X32_SCALED:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7108 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7108 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7108 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7108 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7108 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; instr->operands[i].shiftType = mod; instr->operands[i].shiftValue = 1; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  case ENC_PRFW_I_P_BZ_S_X32_SCALED:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7118 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7118 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7118 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7118 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7118 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; instr->operands[i].shiftType = mod; instr->operands[i].shiftValue = 2; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  case ENC_PRFD_I_P_BZ_S_X32_SCALED:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7128 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7128 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7128 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7128 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7128 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; instr->operands[i].shiftType = mod; instr->operands[i].shiftValue = 3; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  case ENC_PRFB_I_P_BZ_S_X32_SCALED:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7138 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7138 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7138 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7138 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7138 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; instr->operands[i].shiftType = mod; instr->operands[i].shiftValue = 0; instr->operands[i].shiftValueUsed = 0; i += 1;;
   break;
  }
  ...
  case ENC_PRFW_I_P_BI_S:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7151 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7151 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7151 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7151 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7151 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_OFFSET; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = imm; instr->operands[i].signedImm = 1; i++;; instr->operands[i-1].mul_vl = 1;;
# 7163 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
   break;
  }
  ...
  case ENC_PRFW_I_P_AI_D:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7179 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7179 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7179 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7179 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7179 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_OFFSET; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; instr->operands[i].immediate = imm; instr->operands[i].signedImm = 1; i++;;
   break;
  }
  ...
  case ENC_PRFW_I_P_AI_S:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7198 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7198 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7198 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7198 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7198 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_OFFSET; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; instr->operands[i].immediate = imm; instr->operands[i].signedImm = 1; i++;;
   break;
  }
  case ENC_PRFM_P_LDST_REGOFF:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7207 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7207 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7207 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7207 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7207 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ...
  case ENC_PRFM_P_LDST_POS:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7215 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7215 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7215 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7215 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7215 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ...
  case ENC_PRFUM_P_LDST_UNSCALED:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7223 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7223 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7223 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7223 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7223 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ...
  case ENC_PRFM_P_LOADLIT:
  {
   ...
   instr->operands[i].operandClass = NAME; 
# 7231 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7231 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7231 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7231 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7231 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ...
  case ENC_MSR_SI_PSTATE:
  {
   ...
   if(ctx->op1==0 && ctx->op2==3 && (ctx->features1 & ((uint64_t)1<<47))) sr = REG_UAO;
   else if(ctx->op1==0 && ctx->op2==4 && (ctx->features1 & ((uint64_t)1<<24))) sr = REG_PAN;
   else if(ctx->op1==0 && ctx->op2==5) sr = REG_PSTATE_SPSEL;
   else if(ctx->op1==3 && ctx->op2==1 && (ctx->features1 & ((uint64_t)1<<34))) sr = REG_SSBS;
   else if(ctx->op1==3 && ctx->op2==2 && (ctx->features1 & ((uint64_t)1<<7))) sr = REG_DIT;
   else if(ctx->op1==3 && ctx->op2==4 && (ctx->features0 & ((uint64_t)1<<18))) sr = REG_TCO;
   else if(ctx->op1==3 && ctx->op2==6 && (ctx->features0 & ((uint64_t)1<<18))) sr = REG_DAIFSET;
   else if(ctx->op1==3 && ctx->op2==7 && (ctx->features0 & ((uint64_t)1<<18))) sr = REG_DAIFCLR;

   if(sr == SYSREG_NONE) {
    instr->operands[i].operandClass = IMPLEMENTATION_SPECIFIC; instr->operands[i].implspec[0] = ctx->sys_op0; instr->operands[i].implspec[1] = ctx->sys_op1; instr->operands[i].implspec[2] = ctx->sys_crn; instr->operands[i].implspec[3] = ctx->sys_crm; instr->operands[i].implspec[4] = ctx->sys_op2; i++;;
   }
   else
   {
    instr->operands[i].operandClass = SYS_REG; instr->operands[i].sysreg = (sr); i++;;
   }
  ...
  case ENC_TLBI_SYS_CR_SYSTEMINSTRS:
  {
   ...
   if(op1==0b000 && crm==0b0001 && op2==0b000 && (1)) tlbi_op="vmalle1os";
   else if(op1==0b000 && crm==0b0001 && op2==0b001 && (1)) tlbi_op="vae1os";
   else if(op1==0b000 && crm==0b0001 && op2==0b010 && (1)) tlbi_op="aside1os";
   else if(op1==0b000 && crm==0b0001 && op2==0b011 && (1)) tlbi_op="vaae1os";
   else if(op1==0b000 && crm==0b0001 && op2==0b101 && (1)) tlbi_op="vale1os";
   else if(op1==0b000 && crm==0b0001 && op2==0b111 && (1)) tlbi_op="vaale1os";
   else if(op1==0b000 && crm==0b0010 && op2==0b001 && (1)) tlbi_op="rvae1is";
   else if(op1==0b000 && crm==0b0010 && op2==0b011 && (1)) tlbi_op="rvaae1is";
   else if(op1==0b000 && crm==0b0010 && op2==0b101 && (1)) tlbi_op="rvale1is";
   else if(op1==0b000 && crm==0b0010 && op2==0b111 && (1)) tlbi_op="rvaale1is";
   ...
   else if(op1==0b000 && crm==0b0101 && op2==0b001 && (1)) tlbi_op="rvae1os";
   else if(op1==0b000 && crm==0b0101 && op2==0b011 && (1)) tlbi_op="rvaae1os";
   else if(op1==0b000 && crm==0b0101 && op2==0b101 && (1)) tlbi_op="rvale1os";
   else if(op1==0b000 && crm==0b0101 && op2==0b111 && (1)) tlbi_op="rvaale1os";
   else if(op1==0b000 && crm==0b0110 && op2==0b001 && (1)) tlbi_op="rvae1";
   else if(op1==0b000 && crm==0b0110 && op2==0b011 && (1)) tlbi_op="rvaae1";
   else if(op1==0b000 && crm==0b0110 && op2==0b101 && (1)) tlbi_op="rvale1";
   else if(op1==0b000 && crm==0b0110 && op2==0b111 && (1)) tlbi_op="rvaale1";
   ...
   else if(op1==0b100 && crm==0b0000 && op2==0b010 && (1)) tlbi_op="ripas2e1is";
   else if(op1==0b100 && crm==0b0000 && op2==0b101) tlbi_op="ipas2le1is";
   else if(op1==0b100 && crm==0b0000 && op2==0b110 && (1)) tlbi_op="ripas2le1is";
   else if(op1==0b100 && crm==0b0001 && op2==0b000 && (1)) tlbi_op="alle2os";
   else if(op1==0b100 && crm==0b0001 && op2==0b001 && (1)) tlbi_op="vae2os";
   else if(op1==0b100 && crm==0b0001 && op2==0b100 && (1)) tlbi_op="alle1os";
   else if(op1==0b100 && crm==0b0001 && op2==0b101 && (1)) tlbi_op="vale2os";
   else if(op1==0b100 && crm==0b0001 && op2==0b110 && (1)) tlbi_op="vmalls12e1os";
   else if(op1==0b100 && crm==0b0010 && op2==0b001 && (1)) tlbi_op="rvae2is";
   else if(op1==0b100 && crm==0b0010 && op2==0b101 && (1)) tlbi_op="rvale2is";
   ...
   else if(op1==0b100 && crm==0b0100 && op2==0b000 && (1)) tlbi_op="ipas2e1os";
   else if(op1==0b100 && crm==0b0100 && op2==0b001) tlbi_op="ipas2e1";
   else if(op1==0b100 && crm==0b0100 && op2==0b010 && (1)) tlbi_op="ripas2e1";
   else if(op1==0b100 && crm==0b0100 && op2==0b011 && (1)) tlbi_op="ripas2e1os";
   else if(op1==0b100 && crm==0b0100 && op2==0b100 && (1)) tlbi_op="ipas2le1os";
   else if(op1==0b100 && crm==0b0100 && op2==0b101) tlbi_op="ipas2le1";
   else if(op1==0b100 && crm==0b0100 && op2==0b110 && (1)) tlbi_op="ripas2le1";
   else if(op1==0b100 && crm==0b0100 && op2==0b111 && (1)) tlbi_op="ripas2le1os";
   else if(op1==0b100 && crm==0b0101 && op2==0b001 && (1)) tlbi_op="rvae2os";
   else if(op1==0b100 && crm==0b0101 && op2==0b101 && (1)) tlbi_op="rvale2os";
   else if(op1==0b100 && crm==0b0110 && op2==0b001 && (1)) tlbi_op="rvae2";
   else if(op1==0b100 && crm==0b0110 && op2==0b101 && (1)) tlbi_op="rvale2";
   ...
   else if(op1==0b110 && crm==0b0001 && op2==0b000 && (1)) tlbi_op="alle3os";
   else if(op1==0b110 && crm==0b0001 && op2==0b001 && (1)) tlbi_op="vae3os";
   else if(op1==0b110 && crm==0b0001 && op2==0b101 && (1)) tlbi_op="vale3os";
   else if(op1==0b110 && crm==0b0010 && op2==0b001 && (1)) tlbi_op="rvae3is";
   else if(op1==0b110 && crm==0b0010 && op2==0b101 && (1)) tlbi_op="rvale3is";
   ...
   else if(op1==0b110 && crm==0b0101 && op2==0b001 && (1)) tlbi_op="rvae3os";
   else if(op1==0b110 && crm==0b0101 && op2==0b101 && (1)) tlbi_op="rvale3os";
   else if(op1==0b110 && crm==0b0110 && op2==0b001 && (1)) tlbi_op="rvae3";
   else if(op1==0b110 && crm==0b0110 && op2==0b101 && (1)) tlbi_op="rvale3";
   ...
   instr->operands[i].operandClass = NAME; 
# 7364 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  __builtin___strcpy_chk (
# 7364 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  instr->operands[i].name
# 7364 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
  , 
# 7364 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 7364 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ...
  {
   if(ctx->Q) instr->operation = enc_to_oper2(instr->encoding);
  ...
  case ENC_USUBW_ASIMDDIFF_W:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = Ta; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = Ta; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->m)]; instr->operands[i].arrSpec = Tb; i++;;
   break;
  }
  ...
  case ENC_FCVTXN_ASIMDMISC_N:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->d)]; instr->operands[i].arrSpec = Tb; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->n)]; instr->operands[i].arrSpec = Ta; i++;;
   break;
  }
  ...
  case ENC_ST4_ASISDLSE_R4:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(2)][((ctx->t+2)%32)]; instr->operands[i].reg[3] = regMap[(1)][(2)][((ctx->t+3)%32)]; instr->operands[i].arrSpec = arr_spec; i++;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_ST4_ASISDLSEP_R4_R:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(2)][((ctx->t+2)%32)]; instr->operands[i].reg[3] = regMap[(1)][(2)][((ctx->t+3)%32)]; instr->operands[i].arrSpec = arr_spec; i++;;
   instr->operands[i].operandClass = MEM_POST_IDX; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)];;
   break;
  }
  ...
  case ENC_ST3_ASISDLSE_R3:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(2)][((ctx->t+2)%32)]; instr->operands[i].arrSpec = arr_spec; i++;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_ST2_ASISDLSE_R2:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].arrSpec = arr_spec; i++;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_ST1_ASISDLSE_R1_1V:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].arrSpec = arr_spec; i++;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_ST4_ASISDLSO_B4_4B:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(2)][((ctx->t+2)%32)]; instr->operands[i].reg[3] = regMap[(1)][(2)][((ctx->t+3)%32)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_ST4_ASISDLSOP_B4_I4B:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(2)][((ctx->t+2)%32)]; instr->operands[i].reg[3] = regMap[(1)][(2)][((ctx->t+3)%32)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_POST_IDX; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = 4; instr->operands[i].signedImm = 1;;
   break;
  }
  ...
  case ENC_ST3_ASISDLSO_B3_3B:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(2)][((ctx->t+2)%32)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_ST3_ASISDLSOP_B3_I3B:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(2)][((ctx->t+2)%32)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_POST_IDX; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = 3; instr->operands[i].signedImm = 1;;
   break;
  }
  ...
  case ENC_ST2_ASISDLSO_B2_2B:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++;; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_ST2_ASISDLSOP_B2_I2B:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++;; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_POST_IDX; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = 2; instr->operands[i].signedImm = 1;;
   break;
  }
  ...
  case ENC_ST1_ASISDLSO_B1_1B:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++;; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_ST1_ASISDLSOP_B1_I1B:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++;; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_POST_IDX; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = 1; instr->operands[i].signedImm = 1;;
   break;
  }
  ...
  case ENC_ST4_ASISDLSO_D4_4D:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(2)][((ctx->t+2)%32)]; instr->operands[i].reg[3] = regMap[(1)][(2)][((ctx->t+3)%32)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_ST4_ASISDLSOP_D4_I4D:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(2)][((ctx->t+2)%32)]; instr->operands[i].reg[3] = regMap[(1)][(2)][((ctx->t+3)%32)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_POST_IDX; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = 32; instr->operands[i].signedImm = 1;;
   break;
  }
  ...
  case ENC_ST3_ASISDLSO_D3_3D:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(2)][((ctx->t+2)%32)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_ST3_ASISDLSOP_D3_I3D:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(2)][((ctx->t+2)%32)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_POST_IDX; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = 24; instr->operands[i].signedImm = 1;;
   break;
  }
  ...
  case ENC_ST2_ASISDLSO_D2_2D:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_ST2_ASISDLSOP_D2_I2D:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_POST_IDX; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = 16; instr->operands[i].signedImm = 1;;
   break;
  }
  ...
  case ENC_ST1_ASISDLSO_D1_1D:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_ST1_ASISDLSOP_D1_I1D:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_POST_IDX; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = 8; instr->operands[i].signedImm = 1;;
   break;
  }
  ...
  case ENC_ST4_ASISDLSO_H4_4H:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(2)][((ctx->t+2)%32)]; instr->operands[i].reg[3] = regMap[(1)][(2)][((ctx->t+3)%32)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_ST3_ASISDLSO_H3_3H:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(2)][((ctx->t+2)%32)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_ST3_ASISDLSOP_H3_I3H:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(2)][((ctx->t+2)%32)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = 6; i++;;
   break;
  }
  ...
  case ENC_ST2_ASISDLSO_H2_2H:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++;; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_ST1_ASISDLSO_H1_1H:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++;; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_ST4_ASISDLSO_S4_4S:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(2)][((ctx->t+2)%32)]; instr->operands[i].reg[3] = regMap[(1)][(2)][((ctx->t+3)%32)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_ST3_ASISDLSO_S3_3S:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(2)][((ctx->t+2)%32)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_ST3_ASISDLSOP_S3_I3S:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(2)][((ctx->t+2)%32)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_POST_IDX; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].immediate = 12; instr->operands[i].signedImm = 1;;
   break;
  }
  ...
  case ENC_ST2_ASISDLSO_S2_2S:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(2)][((ctx->t+1)%32)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_ST1_ASISDLSO_S1_1S:
  {
   ...
   ; ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(2)][(ctx->t)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;; instr->operands[i-1].laneUsed = 1; instr->operands[i-1].lane = ctx->index;;
   instr->operands[i].operandClass = MEM_REG; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; i++;;
   break;
  }
  ...
  case ENC_ST4B_Z_P_BR_CONTIGUOUS:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(8)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(8)][((ctx->t+2)%32)]; instr->operands[i].reg[3] = regMap[(1)][(8)][((ctx->t+3)%32)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; i++;;
   break;
  }
  ...
  case ENC_ST3B_Z_P_BR_CONTIGUOUS:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(8)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(8)][((ctx->t+2)%32)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; i++;;
   break;
  }
  ...
  case ENC_ST2B_Z_P_BR_CONTIGUOUS:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(8)][((ctx->t+1)%32)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; i++;;
   break;
  }
  ...
  case ENC_ST4D_Z_P_BR_CONTIGUOUS:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(8)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(8)][((ctx->t+2)%32)]; instr->operands[i].reg[3] = regMap[(1)][(8)][((ctx->t+3)%32)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_FULL; instr->operands[i].shiftType = ShiftType_LSL; instr->operands[i].shiftValue = 3; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  ...
  case ENC_ST3D_Z_P_BR_CONTIGUOUS:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(8)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(8)][((ctx->t+2)%32)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; instr->operands[i].arrSpec = 0; instr->operands[i].shiftType = ShiftType_LSL; instr->operands[i].shiftValue = 3; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  ...
  case ENC_ST2D_Z_P_BR_CONTIGUOUS:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(8)][((ctx->t+1)%32)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; instr->operands[i].arrSpec = 0; instr->operands[i].shiftType = ShiftType_LSL; instr->operands[i].shiftValue = 3; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  ...
  case ENC_ST4H_Z_P_BR_CONTIGUOUS:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(8)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(8)][((ctx->t+2)%32)]; instr->operands[i].reg[3] = regMap[(1)][(8)][((ctx->t+3)%32)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; instr->operands[i].arrSpec = 0; instr->operands[i].shiftType = ShiftType_LSL; instr->operands[i].shiftValue = 1; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  ...
  case ENC_ST3H_Z_P_BR_CONTIGUOUS:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(8)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(8)][((ctx->t+2)%32)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; instr->operands[i].arrSpec = 0; instr->operands[i].shiftType = ShiftType_LSL; instr->operands[i].shiftValue = 1; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  ...
  case ENC_ST2H_Z_P_BR_CONTIGUOUS:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(8)][((ctx->t+1)%32)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; instr->operands[i].arrSpec = 0; instr->operands[i].shiftType = ShiftType_LSL; instr->operands[i].shiftValue = 1; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  ...
  case ENC_ST4W_Z_P_BR_CONTIGUOUS:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(8)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(8)][((ctx->t+2)%32)]; instr->operands[i].reg[3] = regMap[(1)][(8)][((ctx->t+3)%32)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; instr->operands[i].arrSpec = 0; instr->operands[i].shiftType = ShiftType_LSL; instr->operands[i].shiftValue = 2; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  ...
  case ENC_ST3W_Z_P_BR_CONTIGUOUS:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(8)][((ctx->t+1)%32)]; instr->operands[i].reg[2] = regMap[(1)][(8)][((ctx->t+2)%32)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; instr->operands[i].arrSpec = 0; instr->operands[i].shiftType = ShiftType_LSL; instr->operands[i].shiftValue = 2; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  ...
  case ENC_ST2W_Z_P_BR_CONTIGUOUS:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->t)]; instr->operands[i].reg[1] = regMap[(1)][(8)][((ctx->t+1)%32)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; instr->operands[i].arrSpec = 0; instr->operands[i].shiftType = ShiftType_LSL; instr->operands[i].shiftValue = 2; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  ...
  case ENC_ST1H_Z_P_BR_:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->t)]; instr->operands[i].arrSpec = arr_spec; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; instr->operands[i].arrSpec = 0; instr->operands[i].shiftType = ShiftType_LSL; instr->operands[i].shiftValue = 1; instr->operands[i].shiftValueUsed = 1; i += 1;;
   break;
  }
  ...
  case ENC_STNT1B_Z_P_BR_CONTIGUOUS:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->t)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; i++;;
   break;
  }
  ...
  case ENC_LDFF1SB_Z_P_BR_S16:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->t)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;; instr->operands[i-1].pred_qual = 'z';;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; i++;;
   break;
  }
  ...
  case ENC_LDFF1SB_Z_P_BR_S32:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->t)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;; instr->operands[i-1].pred_qual = 'z';;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; i++;;
   break;
  }
  ...
  case ENC_LDFF1SB_Z_P_BR_S64:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->t)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;; instr->operands[i-1].pred_qual = 'z';;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(1)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; i++;;
   break;
  }
  ...
  case ENC_LDNT1W_Z_P_AR_S_X32_UNSCALED:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->t)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;; instr->operands[i-1].pred_qual = 'z';;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(8)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1SINGLE; i++;;
   break;
  }
  ...
  case ENC_LDNT1W_Z_P_AR_D_64_UNSCALED:
  {
   ...
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->t)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;; instr->operands[i-1].pred_qual = 'z';;
   instr->operands[i].operandClass = MEM_EXTENDED; instr->operands[i].reg[0] = regMap[(0)][(8)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(1)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;;
   break;
  }
...
break;
  ...
  case ENC_LD1ROD_Z_P_BI_U64:
  {
   ...
   switch(instr->encoding) {
    ...
    case ENC_LD1RSW_Z_P_BI_S64:
    case ENC_LD1RW_Z_P_BI_U64:
     imm = 4*ctx->offset; break;
    case ENC_LD1RD_Z_P_BI_U64:
     imm = 8*ctx->offset; break;
    default:
  ...
  case ENC_BTI_HB_HINTS:
  {
   ...
   const char *table_indirection[4] = {
# 9403 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
                                      ((void *)0)
# 9403 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
                                          , "c", "j", "jc"};
   const char *TARGETS = table_indirection[(ctx->op2 >> 1) & 3];
   if(TARGETS) {
    instr->operands[i].operandClass = NAME; 
# 9406 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
   __builtin___strcpy_chk (
# 9406 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
   instr->operands[i].name
# 9406 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c" 3 4
   , 
# 9406 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
...
# 9406 "project/radare2/libr/asm/arch/arm/v35arm64/arch-arm64/disassembler/decode_scratchpad.c"
  ...
  case ENC_SBCLT_Z_ZZZ_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->da)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec; i++;
   break;
  }
  ...
  case ENC_USRA_Z_ZI_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->da)]; instr->operands[i].arrSpec = T; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = T; i++;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = ctx->shift; i++;;
   break;
  }
  case ENC_BDEP_Z_ZZ_:
  case ENC_BEXT_Z_ZZ_:
  ...
  case ENC_USUBWT_Z_ZZ_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->d)]; instr->operands[i].arrSpec = T; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = T; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = Tb; i++;
   break;
  }
  ...
  case ENC_NBSL_Z_ZZZ_:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->dn)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->dn)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->k)]; instr->operands[i].arrSpec = ARRSPEC_1DOUBLE; i++;
   break;
  }
  case ENC_CADD_Z_ZZ_:
  ...
  case ENC_SQRDCMLAH_Z_ZZZI_H:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->da)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = ARRSPEC_1HALF; i++; instr->operands[i-1].lane = ctx->index; instr->operands[i-1].laneUsed = 1;;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = rotate; i++;;
   break;
  ...
  case ENC_EXT_Z_ZI_CON:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->Zd)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++;
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->Zn)]; instr->operands[i].reg[1] = regMap[(1)][(8)][((ctx->Zn+1)%32)]; instr->operands[i].arrSpec = ARRSPEC_1BYTE; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = arr_spec; i++;
   instr->operands[i].operandClass = IMM32; instr->operands[i].signedImm = 0; instr->operands[i].immediate = imm; i++;;
   break;
  }
  case ENC_SPLICE_Z_P_ZZ_CON:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->dst)]; instr->operands[i].arrSpec = T; i++;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(9)][(ctx->g)]; i++;;;
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->s1)]; instr->operands[i].reg[1] = regMap[(1)][(8)][((ctx->s1+1)%32)]; instr->operands[i].arrSpec = T; i++;;
   break;
  }
  case ENC_TBL_Z_ZZ_2:
  {
   ...
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->d)]; instr->operands[i].arrSpec = T; i++;
   ; instr->operands[i].operandClass = MULTI_REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->n)]; instr->operands[i].reg[1] = regMap[(1)][(8)][((ctx->n+1)%32)]; instr->operands[i].arrSpec = T; i++;;
   instr->operands[i].operandClass = REG; instr->operands[i].reg[0] = regMap[(1)][(8)][(ctx->m)]; instr->operands[i].arrSpec = T; i++;
   break;
  }
