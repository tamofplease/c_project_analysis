# 0 "project/radare2/libr/asm/arch/avr/assemble.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 2 "project/radare2/libr/asm/arch/avr/assemble.c" 2
...
# 3 "project/radare2/libr/asm/arch/avr/assemble.c" 2
# 1 "project/radare2/libr/asm/arch/avr/assemble.h" 1
# 9 "project/radare2/libr/asm/arch/avr/assemble.h"
...
# 4 "project/radare2/libr/asm/arch/avr/assemble.c" 2

extern instructionInfo instructionSet[145];
...
int avr_encode(RAsm *a, RAsmOp *ao, const char *str) {
 ...
 while (token != 
# 51 "project/radare2/libr/asm/arch/avr/assemble.c" 3 4
                ((void *)0) 
# 51 "project/radare2/libr/asm/arch/avr/assemble.c"
                     && tokens_cnt < 3) {
  
# 52 "project/radare2/libr/asm/arch/avr/assemble.c" 3 4
 __builtin___memset_chk (
# 52 "project/radare2/libr/asm/arch/avr/assemble.c"
 tokens[tokens_cnt]
# 52 "project/radare2/libr/asm/arch/avr/assemble.c" 3 4
 , 
# 52 "project/radare2/libr/asm/arch/avr/assemble.c"
...
# 53 "project/radare2/libr/asm/arch/avr/assemble.c" 3 4
 __builtin___strncpy_chk (
# 53 "project/radare2/libr/asm/arch/avr/assemble.c"
 tokens[tokens_cnt]
# 53 "project/radare2/libr/asm/arch/avr/assemble.c" 3 4
 , 
# 53 "project/radare2/libr/asm/arch/avr/assemble.c"
...
# 53 "project/radare2/libr/asm/arch/avr/assemble.c"
                                                      ;
  token = strtok (
# 54 "project/radare2/libr/asm/arch/avr/assemble.c" 3 4
                 ((void *)0)
# 54 "project/radare2/libr/asm/arch/avr/assemble.c"
                     , " ,\t");
  tokens_cnt += 1;
 }
 ...
 if (len > 0) {
  r_strbuf_setbin (&ao->buf, (const 
# 126 "project/radare2/libr/asm/arch/avr/assemble.c" 3 4
                                   unsigned char
# 126 "project/radare2/libr/asm/arch/avr/assemble.c"
                                      *)&coded, len);
 }
 return len;
}
...
int search_instruction(RAsm *a, char instr[3][32], int args) {
 ...
 for (i = 0; i < 145 - 1; i++) {
  ...
  if (!strncmp (instr[0], instructionSet[i].mnemonic, 32)) {
