# 0 "project/radare2/libr/asm/arch/jdh8/jdh8dis.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/arch/jdh8/jdh8dis.c"
...
# 4 "project/radare2/libr/asm/arch/jdh8/jdh8dis.c" 2
...
# 5 "project/radare2/libr/asm/arch/jdh8/jdh8dis.c" 2
...
# 6 "project/radare2/libr/asm/arch/jdh8/jdh8dis.c" 2


# 7 "project/radare2/libr/asm/arch/jdh8/jdh8dis.c"
...
static int jdh_get_ins_len(
# 13 "project/radare2/libr/asm/arch/jdh8/jdh8dis.c" 3 4
                          unsigned char 
# 13 "project/radare2/libr/asm/arch/jdh8/jdh8dis.c"
                              hex) {
 
# 14 "project/radare2/libr/asm/arch/jdh8/jdh8dis.c" 3 4
unsigned char 
# 14 "project/radare2/libr/asm/arch/jdh8/jdh8dis.c"
    high = (hex & 0xf0) >> 4;
...
static int jdh8Disass(RAsmOp *op, const 
# 25 "project/radare2/libr/asm/arch/jdh8/jdh8dis.c" 3 4
                                       unsigned char 
# 25 "project/radare2/libr/asm/arch/jdh8/jdh8dis.c"
                                           *buf, int len) {
 int ilen = jdh_get_ins_len (*buf);
 const 
# 27 "project/radare2/libr/asm/arch/jdh8/jdh8dis.c" 3 4
      unsigned char 
# 27 "project/radare2/libr/asm/arch/jdh8/jdh8dis.c"
          high = (*buf & 0xf0) >> 4;
 const 
# 28 "project/radare2/libr/asm/arch/jdh8/jdh8dis.c" 3 4
      unsigned char 
# 28 "project/radare2/libr/asm/arch/jdh8/jdh8dis.c"
          low = (*buf & 0xf);
 if (ilen > len) {
  return op->size = 0;
 }
 ...
 case 2:
  if (ilen == 2) {
   ...
   r_strbuf_setf (&op->buf_asm, "sw 0x%04x, %c", ((
# 51 "project/radare2/libr/asm/arch/jdh8/jdh8dis.c" 3 4
                                                  unsigned short
# 51 "project/radare2/libr/asm/arch/jdh8/jdh8dis.c"
                                                      )(buf[1] << 8) | buf[2]), reg[low & 7]);
  }
  break;
 case 3:
  if (ilen == 1) {
 ...
 case 4:
  ...
  break;
 case 5:
  r_strbuf_setf (&op->buf_asm, "lda 0x%03x", ((
# 65 "project/radare2/libr/asm/arch/jdh8/jdh8dis.c" 3 4
                                              unsigned short
# 65 "project/radare2/libr/asm/arch/jdh8/jdh8dis.c"
                                                  )(buf[1] << 8) | buf[2]));
  break;
 case 6:
  if (ilen == 1) {
