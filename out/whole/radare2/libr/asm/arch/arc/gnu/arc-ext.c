# 0 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 26 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c" 2
...
# 27 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c" 2
...
# 28 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c" 2
...
# 30 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c" 2
...
# 31 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c" 2
...
# 37 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/include/sysdep.h" 1 3 4
# 38 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c" 2
...
struct arcExtMap
{
  ...
  struct ExtInstruction* instructions[(1 << 6)];
  struct ExtCoreRegister coreRegisters[(59 - 32 + 1)];
  char* condCodes[(0x1f - 0x10 + 1)];
};
...
# 280 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c"
...
# 316 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c"
      ...
      else
 {
   ...
   if (I != 0x2f)
     {
# 369 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c"
       minor = I;
  ...
  temp = arc_extension_map.instructions[((((opcode) << 3) ^ (minor)) & ((1 << 6) - 1))];
  while (temp)
    {
      if ((temp->major == opcode) && (temp->minor == minor))
 {
  ...
  return 
# 396 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c" 3 4
        ((void *)0)
# 396 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c"
            ;
}
...
{
 if (regnum < 32 || regnum > 59) {
  return 
# 405 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c" 3 4
        ((void *)0)
# 405 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c"
            ;
 }
 return arc_extension_map.coreRegisters[regnum - 32].name;
}
...
arcExtMap_coreReadWrite (int regnum)
{
 ...
 return arc_extension_map.coreRegisters[regnum - 32].rw;
}
...
arcExtMap_condCodeName (int code)
{
 if (code < 0x10 || code > 0x1f) {
  return 
# 427 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c" 3 4
        ((void *)0)
# 427 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c"
            ;
 }
 return arc_extension_map.condCodes[code - 0x10];
}
...
arcExtMap_auxRegName (long address)
{
  ...
  return 
# 446 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c" 3 4
        ((void *)0)
# 446 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c"
            ;
}
...
{
# 480 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c"
}
...
void dump_ARC_extmap (void)
{
 ...
 for (insn = arc_extension_map.instructions[i]; insn != 
# 500 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c" 3 4
                                                       ((void *)0)
# 500 "project/radare2/libr/asm/arch/arc/gnu/arc-ext.c"
                                                           ; insn = insn->next) {
