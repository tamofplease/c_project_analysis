# 0 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
...
# 4 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 2

# 1 "project/radare2/libr/asm/arch/pic/pic_pic18.h" 1
...
# 7 "project/radare2/libr/asm/arch/pic/pic_pic18.h" 2


# 8 "project/radare2/libr/asm/arch/pic/pic_pic18.h"
int pic_pic18_disassemble(RAsmOp *op, char *opbuf, const 
# 8 "project/radare2/libr/asm/arch/pic/pic_pic18.h" 3 4
                                                        unsigned char 
# 8 "project/radare2/libr/asm/arch/pic/pic_pic18.h"
                                                            *b, int l);
# 6 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 2
...
# 27 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
unsigned short 
# 27 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
     opmin;
 
# 28 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
unsigned short 
# 28 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
     opmax;
 char *name;
 
# 30 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
unsigned char 
# 30 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
    optype;

} ops[] = {
 {0xf000, 0xffff, "nop", 0},
 {0xef00, 0xefff, "goto", 9},
 {0xee00, 0xee3f, "lfsr", 12},
 {0xec00, 0xedff, "call", 6},
 {0xe700, 0xe7ff, "bnn", 5},
 {0xe600, 0xe6ff, "bn", 5},
 {0xe500, 0xe5ff, "bnov", 5},
 {0xe400, 0xe4ff, "bov", 5},
 {0xe300, 0xe3ff, "bnc", 5},
 {0xe200, 0xe2ff, "bc", 5},
 {0xe100, 0xe1ff, "bnz", 5},
 {0xe000, 0xe0ff, "bz", 5},
 {0xd800, 0xdfff, "rcall", 7},
 {0xd000, 0xd7ff, "bra", 7},
 {0xc000, 0xcfff, "movff", 2},
 {0xb000, 0xbfff, "btfsc", 3},
 {0xa000, 0xafff, "btfss", 3},
 {0x9000, 0x9fff, "bcf", 3},
 {0x8000, 0x8fff, "bsf", 3},
 {0x7000, 0x7fff, "btg", 3},
 {0x6e00, 0x6fff, "movwf", 8},
 {0x6c00, 0x6dff, "negf", 8},
 {0x6a00, 0x6bff, "clrf", 8},
 {0x6800, 0x69ff, "setf", 8},
 {0x6600, 0x67ff, "tstfsz", 8},
 {0x6400, 0x65ff, "cpfsgt", 8},
 {0x6200, 0x63ff, "cpfseq", 8},
 {0x6000, 0x61ff, "cpfslt", 8},
 {0x5c00, 0x5fff, "subwf", 1},
 {0x5800, 0x5bff, "subwfb", 1},
 {0x5400, 0x57ff, "subfwb", 1},
 {0x5000, 0x53ff, "movf", 1},
 {0x4c00, 0x4fff, "dcfsnz", 1},
 {0x4800, 0x4bff, "infsnz", 1},
 {0x4400, 0x47ff, "rlncf", 1},
 {0x4000, 0x43ff, "rrncf", 1},
 {0x3c00, 0x3fff, "incfsz", 1},
 {0x3800, 0x3bff, "swapf", 1},
 {0x3400, 0x37ff, "rlcf", 1},
 {0x3000, 0x33ff, "rrcf", 1},
 {0x2c00, 0x2fff, "decfsz", 1},
 {0x2800, 0x2bff, "incf", 1},
 {0x2400, 0x27ff, "addwf", 1},
 {0x2000, 0x23ff, "addwfc", 1},
 {0x1c00, 0x1fff, "comf", 1},
 {0x1800, 0x1bff, "xorwf", 1},
 {0x1400, 0x17ff, "andwf", 1},
 {0x1000, 0x13ff, "iorwf", 1},
 {0xf00, 0xfff, "addlw", 4},
 {0xe00, 0xeff, "movlw", 4},
 {0xd00, 0xdff, "mullw", 4},
 {0xc00, 0xcff, "retlw", 4},
 ...
 {0x3, 0x3, "sleep", 0},
 {0x0, 0x0, "nop", 0},
 {0x0, 0xffff, "invalid", 0},
};

int pic_pic18_disassemble(RAsmOp *op, char *opbuf, const 
# 112 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
                                                        unsigned char 
# 112 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
                                                            *b, int blen) {
 int i;
 if (blen < 2) {
  
# 115 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
 __builtin___strcpy_chk (
# 115 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
 opbuf
# 115 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
 , 
# 115 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
...
# 119 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
unsigned short 
# 119 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
     instr = 0 ;
 
# 120 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
__builtin___memcpy_chk (
# 120 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
&instr
# 120 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
, 
# 120 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
...
# 123 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
__builtin___strcpy_chk (
# 123 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
opbuf
# 123 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
, 
# 123 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
...
# 129 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
 __builtin___strcpy_chk (
# 129 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
 opbuf
# 129 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
 , 
# 129 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
...
# 160 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
 unsigned int 
# 160 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
      dword_instr = *(
# 160 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
                      unsigned int 
# 160 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
...
# 176 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
 unsigned int 
# 176 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
      dword_instr = *(
# 176 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
                      unsigned int 
# 176 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
...
# 190 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
 unsigned int 
# 190 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
      dword_instr = *(
# 190 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
                      unsigned int 
# 190 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
...
# 206 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
 unsigned int 
# 206 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
      dword_instr = *(
# 206 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
                      unsigned int 
# 206 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
...
# 210 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
 unsigned char 
# 210 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
     reg_n = (dword_instr >> 4) & 0x3;
...
# 218 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
__builtin___strcpy_chk (
# 218 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
opbuf
# 218 "project/radare2/libr/asm/arch/pic/pic_pic18.c" 3 4
, 
# 218 "project/radare2/libr/asm/arch/pic/pic_pic18.c"
