# 0 "project/radare2/libr/asm/arch/pic/pic_midrange.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/arch/pic/pic_midrange.c"


# 1 "project/radare2/libr/asm/arch/pic/pic_midrange.h" 1
...
# 7 "project/radare2/libr/asm/arch/pic/pic_midrange.h" 2



# 9 "project/radare2/libr/asm/arch/pic/pic_midrange.h"
typedef enum {
...
# 99 "project/radare2/libr/asm/arch/pic/pic_midrange.h" 3 4
                                          unsigned short 
# 99 "project/radare2/libr/asm/arch/pic/pic_midrange.h"
                                               instr);
...
# 101 "project/radare2/libr/asm/arch/pic/pic_midrange.h" 3 4
                                                            unsigned char 
# 101 "project/radare2/libr/asm/arch/pic/pic_midrange.h"
                                                                *b, int l);
# 4 "project/radare2/libr/asm/arch/pic/pic_midrange.c" 2
...
PicMidrangeOpcode pic_midrange_get_opcode (
# 63 "project/radare2/libr/asm/arch/pic/pic_midrange.c" 3 4
                                          unsigned short 
# 63 "project/radare2/libr/asm/arch/pic/pic_midrange.c"
                                               instr) {
 if (instr & (1 << 14)) {
...
const PicMidrangeOpInfo *pic_midrange_get_op_info (PicMidrangeOpcode opcode) {
 if (opcode >= PIC_MIDRANGE_OPCODE_INVALID) {
  return 
# 152 "project/radare2/libr/asm/arch/pic/pic_midrange.c" 3 4
        ((void *)0)
# 152 "project/radare2/libr/asm/arch/pic/pic_midrange.c"
            ;
 }
...
int pic_midrange_disassemble (RAsmOp *op, char *opbuf, const 
# 157 "project/radare2/libr/asm/arch/pic/pic_midrange.c" 3 4
                                                            unsigned char 
# 157 "project/radare2/libr/asm/arch/pic/pic_midrange.c"
                                                                *b, int l) {
 char fsr_op[6];
 
# 159 "project/radare2/libr/asm/arch/pic/pic_midrange.c" 3 4
short 
# 159 "project/radare2/libr/asm/arch/pic/pic_midrange.c"
     branch;

#define EMIT_INVALID { op->size = 2; strcpy (opbuf, "invalid"); return 1; }
 ...
 if (!b || l < 2) {
  { op->size = 2; 
# 167 "project/radare2/libr/asm/arch/pic/pic_midrange.c" 3 4
 __builtin___strcpy_chk (
# 167 "project/radare2/libr/asm/arch/pic/pic_midrange.c"
 opbuf
# 167 "project/radare2/libr/asm/arch/pic/pic_midrange.c" 3 4
 , 
# 167 "project/radare2/libr/asm/arch/pic/pic_midrange.c"
...
# 170 "project/radare2/libr/asm/arch/pic/pic_midrange.c" 3 4
unsigned short 
# 170 "project/radare2/libr/asm/arch/pic/pic_midrange.c"
     instr = r_read_le16 (b);
 PicMidrangeOpcode opcode = pic_midrange_get_opcode (instr);
 if (opcode == PIC_MIDRANGE_OPCODE_INVALID) {
  { op->size = 2; 
# 173 "project/radare2/libr/asm/arch/pic/pic_midrange.c" 3 4
 __builtin___strcpy_chk (
# 173 "project/radare2/libr/asm/arch/pic/pic_midrange.c"
 opbuf
# 173 "project/radare2/libr/asm/arch/pic/pic_midrange.c" 3 4
 , 
# 173 "project/radare2/libr/asm/arch/pic/pic_midrange.c"
...
# 173 "project/radare2/libr/asm/arch/pic/pic_midrange.c"
 ...
 if (!op_info) {
  { op->size = 2; 
# 178 "project/radare2/libr/asm/arch/pic/pic_midrange.c" 3 4
 __builtin___strcpy_chk (
# 178 "project/radare2/libr/asm/arch/pic/pic_midrange.c"
 opbuf
# 178 "project/radare2/libr/asm/arch/pic/pic_midrange.c" 3 4
 , 
# 178 "project/radare2/libr/asm/arch/pic/pic_midrange.c"
...
#undef EMIT_INVALID
 ...
 const char *buf_asm = 
# 185 "project/radare2/libr/asm/arch/pic/pic_midrange.c" 3 4
                      ((void *)0)
# 185 "project/radare2/libr/asm/arch/pic/pic_midrange.c"
                          ;
 switch (op_info->args) {
 ...
 case PIC_MIDRANGE_OP_ARGS_2F:
  buf_asm = sdb_fmt ("%s 0x%x", op_info->mnemonic, instr & 0x3);
  break;
 case PIC_MIDRANGE_OP_ARGS_7F:
  buf_asm = sdb_fmt ("%s 0x%x", op_info->mnemonic, instr & 0x7f);
  break;
 ...
 case PIC_MIDRANGE_OP_ARGS_3B_7F:
  buf_asm = sdb_fmt ("%s 0x%x, %d", op_info->mnemonic, instr & 0x7f,
     (instr & (0x7 << 7)) >> 7);
  break;
 case PIC_MIDRANGE_OP_ARGS_4K:
  buf_asm = sdb_fmt ("%s 0x%x", op_info->mnemonic, instr & 0xf);
  break;
 case PIC_MIDRANGE_OP_ARGS_8K:
  buf_asm = sdb_fmt ("%s 0x%x", op_info->mnemonic, instr & 0xff);
  break;
 ...
 case PIC_MIDRANGE_OP_ARGS_11K:
  buf_asm = sdb_fmt ("%s 0x%x", op_info->mnemonic, instr & 0x7ff);
  break;
 case PIC_MIDRANGE_OP_ARGS_1N_2M:
  
# 233 "project/radare2/libr/asm/arch/pic/pic_midrange.c" 3 4
 __builtin___snprintf_chk (
# 233 "project/radare2/libr/asm/arch/pic/pic_midrange.c"
 fsr_op
# 233 "project/radare2/libr/asm/arch/pic/pic_midrange.c" 3 4
 , 
# 233 "project/radare2/libr/asm/arch/pic/pic_midrange.c"
...
# 233 "project/radare2/libr/asm/arch/pic/pic_midrange.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 233 "project/radare2/libr/asm/arch/pic/pic_midrange.c"
 PicMidrangeFsrOps[instr & 0x3], (instr & (1 << 2)) >> 2
# 233 "project/radare2/libr/asm/arch/pic/pic_midrange.c" 3 4
 )
...
# 237 "project/radare2/libr/asm/arch/pic/pic_midrange.c"
                                                   ;
...
# 242 "project/radare2/libr/asm/arch/pic/pic_midrange.c" 3 4
 __builtin___strcpy_chk (
# 242 "project/radare2/libr/asm/arch/pic/pic_midrange.c"
 opbuf
# 242 "project/radare2/libr/asm/arch/pic/pic_midrange.c" 3 4
 , 
# 242 "project/radare2/libr/asm/arch/pic/pic_midrange.c"
