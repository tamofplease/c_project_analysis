# 0 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/arch/lh5801/lh5801.h" 1
# 11 "project/radare2/libr/asm/arch/lh5801/lh5801.h"
...
# 12 "project/radare2/libr/asm/arch/lh5801/lh5801.h" 2
...
# 13 "project/radare2/libr/asm/arch/lh5801/lh5801.h" 2

# 13 "project/radare2/libr/asm/arch/lh5801/lh5801.h"
typedef uint8_t ut8;
...
# 15 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 2
...
# 16 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 2
...
# 17 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 2
...
# 18 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 2

#define ARRAY_LENGTH(a) (sizeof(a)/sizeof((a)[0]))


# 21 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
const struct lh5801_insn_class_desc
  lh5801_insn_class_descs[LH5801_INSNC_NUMBER] = {
...
static 
# 139 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
      _Bool 
# 139 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
...
# 143 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
                                1
# 143 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
                                    ;
 default: return 
# 144 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
                  0
# 144 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
                       ;
 }
}
...
# 150 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
unsigned char 
# 150 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
    iclass;


 
# 153 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
unsigned char 
# 153 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
    opcode;

 
# 155 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
unsigned short 
# 155 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
     format;
};
...
# 742 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
                                                 unsigned char 
# 742 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
                                                     *buf, int len) {
 int fd = (buf[0] == 0xfd);
 int type = -1;
 unsigned i;
...
# 758 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
 unsigned char 
# 758 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
     byte = *buf;
  unsigned fmt;
  unsigned ifmt_reg;
...
static char *print_reg(char *buf, const struct lh5801_insn *insn) {
 ...
 case LH5801_IFMT_RMEM:
  if (desc.format & LH5801_IFMT_FD_MOD) {
   ...
   return 
# 850 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
         ((void *)0)
# 850 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
             ;
  }
  break;
 default:
  return 
# 854 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
        ((void *)0)
# 854 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
            ;
 }
 return saved_buf;
}
...
# 894 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
 __builtin___snprintf_chk (
# 894 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
 out
# 894 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
 , 
# 894 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
...
# 897 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
 __builtin___snprintf_chk (
# 897 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
 out
# 897 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
 , 
# 897 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
...
# 903 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
 __builtin___snprintf_chk (
# 903 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
 out
# 903 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
 , 
# 903 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
...
# 906 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
 __builtin___snprintf_chk (
# 906 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
 out
# 906 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
 , 
# 906 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
...
# 912 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
 __builtin___snprintf_chk (
# 912 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
 out
# 912 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
 , 
# 912 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
...
# 913 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
                                        ;
  break;
 case LH5801_IFMT_IMM1|LH5801_IFMT_BCH:
  
# 916 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
 __builtin___snprintf_chk (
# 916 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
 out
# 916 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
 , 
# 916 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
...
# 917 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
                                               ;
  break;
 case LH5801_IFMT_IMM2:
  if (desc.format & LH5801_IFMT_FD_MOD) {
   
# 921 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
  __builtin___snprintf_chk (
# 921 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
  out
# 921 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
  , 
# 921 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
...
# 923 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
                              ;
  } else {
   
# 925 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
  __builtin___snprintf_chk (
# 925 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
  out
# 925 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
  , 
# 925 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
...
# 926 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
                              ;
  }
  break;
...
# 931 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
  __builtin___snprintf_chk (
# 931 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
  out
# 931 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
  , 
# 931 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
...
# 933 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
                                            ;
  } else {
   
# 935 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
  __builtin___snprintf_chk (
# 935 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
  out
# 935 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
  , 
# 935 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
...
# 939 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
 __builtin___snprintf_chk (
# 939 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
 out
# 939 "project/radare2/libr/asm/arch/lh5801/lh5801.c" 3 4
 , 
# 939 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
...
# 942 "project/radare2/libr/asm/arch/lh5801/lh5801.c"
                                           ;
 }
}
