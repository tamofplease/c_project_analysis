# 0 "project/radare2/libr/asm/arch/z80/z80.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/arch/z80/z80.c"
...
# 6 "project/radare2/libr/asm/arch/z80/z80.c" 2



# 1 "project/radare2/libr/asm/arch/z80/z80_tab.h" 1
...
static 
# 28 "project/radare2/libr/asm/arch/z80/z80_tab.h" 3 4
      unsigned char 
# 28 "project/radare2/libr/asm/arch/z80/z80_tab.h"
...
static 
# 147 "project/radare2/libr/asm/arch/z80/z80_tab.h" 3 4
      unsigned char 
# 147 "project/radare2/libr/asm/arch/z80/z80_tab.h"
...
# 10 "project/radare2/libr/asm/arch/z80/z80.c" 2

static 
# 11 "project/radare2/libr/asm/arch/z80/z80.c" 3 4
      unsigned char 
# 11 "project/radare2/libr/asm/arch/z80/z80.c"
...
# 28 "project/radare2/libr/asm/arch/z80/z80.c" 3 4
                             unsigned char 
# 28 "project/radare2/libr/asm/arch/z80/z80.c"
                                 *buf, int len) {
 const z80_opcode *op;
 int type = 0, ret = 0;
 if (len < 1) {
...
# 71 "project/radare2/libr/asm/arch/z80/z80.c" 3 4
__attribute__((used)) 
# 71 "project/radare2/libr/asm/arch/z80/z80.c"
...
# 75 "project/radare2/libr/asm/arch/z80/z80.c" 3 4
unsigned char 
# 75 "project/radare2/libr/asm/arch/z80/z80.c"
    res;
 if (!ret) {
  return ret;
 }
