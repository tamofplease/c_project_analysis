# 0 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c"
...
# 4 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c" 2
...
# 5 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c" 2
...
# 6 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c" 2
...
# 5 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.h" 2
...
# 8 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.h"
                      hex_num);
# 7 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c" 2

static char hex_str[] = "01234567890abcdef";


char *strcat_dup(char *s1, char *s2, 
# 11 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c" 3 4
                                    int 
# 11 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c"
                                         n_free) {
 char *res;
 
# 13 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c" 3 4
unsigned int 
# 13 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c"
     len_s1 = s1? strlen (s1) : 0;
 
# 14 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c" 3 4
unsigned int 
# 14 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c"
     len_s2 = s2? strlen (s2) : 0;

 if (!(res = (char *)malloc (len_s1 + len_s2 + 1))) {
  return 
# 17 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c" 3 4
        ((void *)0)
# 17 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c"
            ;
 }
 if (len_s1 > 0) {
  
# 20 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c" 3 4
 __builtin___memcpy_chk (
# 20 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c"
 res
# 20 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c" 3 4
 , 
# 20 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c"
...
# 23 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c" 3 4
 __builtin___memcpy_chk (
# 23 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c"
 res + len_s1
# 23 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c" 3 4
 , 
# 23 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c"
...
# 27 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c" 3 4
 { free((void *)
# 27 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c"
 s1
# 27 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c" 3 4
 ); 
# 27 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c"
...
# 29 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c" 3 4
 { free((void *)
# 29 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c"
 s2
# 29 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c" 3 4
 ); 
# 29 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c"
...
# 31 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c" 3 4
 { free((void *)
# 31 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c"
 s1
# 31 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c" 3 4
 ); 
# 31 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c"
...
# 32 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c" 3 4
 { free((void *)
# 32 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c"
 s2
# 32 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c" 3 4
 ); 
# 32 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c"
...
char *get_hex_str(
# 37 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c" 3 4
                 unsigned int 
# 37 "project/radare2/libr/asm/arch/tms320/c55x_plus/utils.c"
                      hex_num) {
    char aux[3];
