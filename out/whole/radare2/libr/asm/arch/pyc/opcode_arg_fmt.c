# 0 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c"
...
# 2 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c" 2

char *format_extended_arg(
# 3 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c" 3 4
                         unsigned int 
# 3 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c"
                              oparg) {
 return r_str_newf ("%u", oparg * (1 << 16));
}

char *format_CALL_FUNCTION_pos_name_encoded(
# 7 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c" 3 4
                                           unsigned int 
# 7 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c"
                                                oparg) {
 
# 8 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c" 3 4
unsigned int 
# 8 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c"
     pos_args = oparg & 0xFF;
 
# 9 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c" 3 4
unsigned int 
# 9 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c"
     name = (oparg >> 8) & 0xFF;
 return r_str_newf ("%u positional, %u named", pos_args, name);
}

char *format_MAKE_FUNCTION_arg_3x(
# 13 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c" 3 4
                                 unsigned int 
# 13 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c"
                                      oparg) {
 
# 14 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c" 3 4
unsigned int 
# 14 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c"
     pos_args = oparg & 0xFF;
 
# 15 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c" 3 4
unsigned int 
# 15 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c"
     name_default = (oparg >> 8) & 0xFF;
 
# 16 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c" 3 4
unsigned int 
# 16 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c"
     annotate_args = (oparg >> 16) & 0x7FFF;
 return r_str_newf ("%u positional, %u name and default, %u annotations", pos_args, name_default, annotate_args);
}

char *format_CALL_FUNCTION_KW_36(
# 20 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c" 3 4
                                unsigned int 
# 20 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c"
                                     oparg) {
 return r_str_newf ("%u total positional and keyword args", oparg);
}

char *format_CALL_FUNCTION_EX_36(
# 24 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c" 3 4
                                unsigned int 
# 24 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c"
                                     oparg) {
...
char *format_MAKE_FUNCTION_arg_36(
# 30 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c" 3 4
                                 unsigned int 
# 30 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c"
                                      oparg) {
 size_t i;
 char *ret = r_str_new (" ");
...
char *format_value_flags_36(
# 45 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c" 3 4
                           unsigned int 
# 45 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c"
                                oparg) {
 const char *ret = "";
 switch (oparg & 0x3) {
 case 1:
...
char *format_extended_arg_36(
# 66 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c" 3 4
                            unsigned int 
# 66 "project/radare2/libr/asm/arch/pyc/opcode_arg_fmt.c"
                                 oparg) {
