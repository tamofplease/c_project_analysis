# 0 "project/radare2/libr/asm/arch/pyc/opcode.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/arch/pyc/opcode.c"
...
# 2 "project/radare2/libr/asm/arch/pyc/opcode.c" 2
...
static version_opcode version_op[] = {
 ...
 { "v3.9.0", opcode_39 },
 { 
# 124 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
  ((void *)0)
# 124 "project/radare2/libr/asm/arch/pyc/opcode.c"
      , 
# 124 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
        ((void *)0) 
# 124 "project/radare2/libr/asm/arch/pyc/opcode.c"
...
# 127 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
_Bool 
# 127 "project/radare2/libr/asm/arch/pyc/opcode.c"
    pyc_opcodes_equal(pyc_opcodes *op, const char *version) {
 ...
 while (vop->version) {
  if (!strcmp (vop->version, version)) {
   if (vop->opcode_func == (pyc_opcodes * (*)()) (op->version_sig)) {
    return 
# 133 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
          1
# 133 "project/radare2/libr/asm/arch/pyc/opcode.c"
              ;
   }
  }
  vop++;
 ...
 return 
# 139 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
       0
# 139 "project/radare2/libr/asm/arch/pyc/opcode.c"
            ;
}
...
pyc_opcodes *get_opcode_by_version(char *version) {
 ...
 return 
# 152 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
       ((void *)0)
# 152 "project/radare2/libr/asm/arch/pyc/opcode.c"
           ;
}
...
pyc_opcodes *new_pyc_opcodes() {
 size_t i, j;
 pyc_opcodes *ret = 
# 157 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
                   (
# 157 "project/radare2/libr/asm/arch/pyc/opcode.c"
                   pyc_opcodes
# 157 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
                   *)calloc(1,sizeof(
# 157 "project/radare2/libr/asm/arch/pyc/opcode.c"
...
# 157 "project/radare2/libr/asm/arch/pyc/opcode.c"
 ...
 if (!ret) {
  return 
# 159 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
        ((void *)0)
# 159 "project/radare2/libr/asm/arch/pyc/opcode.c"
            ;
 }
 ...
 if (!ret->opcodes) {
  free (ret);
  return 
# 165 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
        ((void *)0)
# 165 "project/radare2/libr/asm/arch/pyc/opcode.c"
            ;
 }
 for (i = 0; i < 256; i++) {
...
# 174 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
  { free((void *)
# 174 "project/radare2/libr/asm/arch/pyc/opcode.c"
  ret
# 174 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
  ); 
# 174 "project/radare2/libr/asm/arch/pyc/opcode.c"
...
# 174 "project/radare2/libr/asm/arch/pyc/opcode.c"
              ;
   return 
# 175 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
         ((void *)0)
# 175 "project/radare2/libr/asm/arch/pyc/opcode.c"
             ;
  }
...
void add_arg_fmt(pyc_opcodes *ret, char *op_name, char *(*formatter) (
# 197 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
                                                                     unsigned int 
# 197 "project/radare2/libr/asm/arch/pyc/opcode.c"
                                                                          oparg)) {
 pyc_arg_fmt *fmt = 
# 198 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
                   (
# 198 "project/radare2/libr/asm/arch/pyc/opcode.c"
                   pyc_arg_fmt
# 198 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
                   *)calloc(1,sizeof(
# 198 "project/radare2/libr/asm/arch/pyc/opcode.c"
...
# 219 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
1
# 219 "project/radare2/libr/asm/arch/pyc/opcode.c"
, .op_obj = par.op_obj, .op_name = par.op_name, .op_code = par.op_code, .pop = par.pop, .push = par.push });
 par.op_obj[par.op_code].type |= HASNAME;
}

void (local_opN)(struct op_parameter par) {
 def_opN((struct op_parameter){ .fallthrough = 
# 224 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
1
# 224 "project/radare2/libr/asm/arch/pyc/opcode.c"
, .op_obj = par.op_obj, .op_name = par.op_name, .op_code = par.op_code, .pop = par.pop, .push = par.push });
...
void (free_opN)(struct op_parameter par) {
 def_opN((struct op_parameter){ .fallthrough = 
# 229 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
1
# 229 "project/radare2/libr/asm/arch/pyc/opcode.c"
, .op_obj = par.op_obj, .op_name = par.op_name, .op_code = par.op_code, .pop = par.pop, .push = par.push });
...
void (store_opN)(struct op_parameter par) {
 switch (par.func) {
 case NAME_OP:
  name_opN((struct op_parameter){ .op_obj = par.op_obj, .op_name = par.op_name, .op_code = par.op_code, .pop = par.pop, .push = par.push });
  break;
 case LOCAL_OP:
  local_opN((struct op_parameter){ .op_obj = par.op_obj, .op_name = par.op_name, .op_code = par.op_code, .pop = par.pop, .push = par.push });
  break;
 case FREE_OP:
  free_opN((struct op_parameter){ .op_obj = par.op_obj, .op_name = par.op_name, .op_code = par.op_code, .pop = par.pop, .push = par.push });
  break;
 case DEF_OP:
  def_opN((struct op_parameter){ .fallthrough = 
# 245 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
 1
# 245 "project/radare2/libr/asm/arch/pyc/opcode.c"
 , .op_obj = par.op_obj, .op_name = par.op_name, .op_code = par.op_code, .pop = par.pop, .push = par.push });
  break;
 default:
  
# 248 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
 fprintf(__stderrp,
# 248 "project/radare2/libr/asm/arch/pyc/opcode.c"
 "Error in store_op in opcode.c, call function %u.\n", par.func
# 248 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
 )
# 248 "project/radare2/libr/asm/arch/pyc/opcode.c"
                                                                         ;
...
void (varargs_op)(struct op_parameter par) {
 def_opN((struct op_parameter){ .fallthrough = 
# 255 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
1
# 255 "project/radare2/libr/asm/arch/pyc/opcode.c"
, .op_obj = par.op_obj, .op_name = par.op_name, .op_code = par.op_code, .pop = par.pop, .push = par.push });
...
void (const_opN)(struct op_parameter par) {
 def_opN((struct op_parameter){ .fallthrough = 
# 260 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
1
# 260 "project/radare2/libr/asm/arch/pyc/opcode.c"
, .op_obj = par.op_obj, .op_name = par.op_name, .op_code = par.op_code, .pop = par.pop, .push = par.push });
...
void (compare_op)(struct op_parameter par) {
 def_opN((struct op_parameter){ .fallthrough = 
# 265 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
1
# 265 "project/radare2/libr/asm/arch/pyc/opcode.c"
, .op_obj = par.op_obj, .op_name = par.op_name, .op_code = par.op_code, .pop = par.pop, .push = par.push });
 par.op_obj[par.op_code].type |= HASCOMPARE;
}

void (jabs_opN)(struct op_parameter par) {
 def_opN((struct op_parameter){ .op_obj = par.op_obj, .op_name = par.op_name, .op_code = par.op_code, .pop = par.pop, .push = par.push, .fallthrough = par.fallthrough });
...
void (nargs_op)(struct op_parameter par) {
 def_opN((struct op_parameter){ .fallthrough = 
# 286 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
1
# 286 "project/radare2/libr/asm/arch/pyc/opcode.c"
, .op_obj = par.op_obj, .op_name = par.op_name, .op_code = par.op_code, .pop = par.pop, .push = par.push });
...
# 297 "project/radare2/libr/asm/arch/pyc/opcode.c" 3 4
 fprintf(__stderrp,
# 297 "project/radare2/libr/asm/arch/pyc/opcode.c"
