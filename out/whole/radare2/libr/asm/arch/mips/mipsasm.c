# 0 "project/radare2/libr/asm/arch/mips/mipsasm.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/arch/mips/mipsasm.c"
...
# 4 "project/radare2/libr/asm/arch/mips/mipsasm.c" 2
...
# 5 "project/radare2/libr/asm/arch/mips/mipsasm.c" 2


# 6 "project/radare2/libr/asm/arch/mips/mipsasm.c"
...
# 11 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
((void *)0)

# 12 "project/radare2/libr/asm/arch/mips/mipsasm.c"
};
...
static struct {
 ...
 { "j", 'J', 1, 2, 0 },
 { 
# 76 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
  ((void *)0) 
# 76 "project/radare2/libr/asm/arch/mips/mipsasm.c"
       }
};

static int mips_r(
# 79 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
                 unsigned char 
# 79 "project/radare2/libr/asm/arch/mips/mipsasm.c"
                     *b, int op, int rs, int rt, int rd, int sa, int fun) {
...
static int mips_i(
# 93 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
                 unsigned char 
# 93 "project/radare2/libr/asm/arch/mips/mipsasm.c"
                     *b, int op, int rs, int rt, int imm, int is_branch) {
 if (rs < 0 || rt < 0) {
  return -1;
 }
 if (is_branch) {
...
static int mips_j(
# 112 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
                 unsigned char 
# 112 "project/radare2/libr/asm/arch/mips/mipsasm.c"
                     *b, int op, int addr) {
 addr /= 4;
...
# 124 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
 fprintf(__stderrp,
# 124 "project/radare2/libr/asm/arch/mips/mipsasm.c"
 "Missing argument\n"
# 124 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
 )
# 124 "project/radare2/libr/asm/arch/mips/mipsasm.c"
 ...
 if (p[0] == '-') {
  n = (int) r_num_get (
# 135 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
                      ((void *)0)
# 135 "project/radare2/libr/asm/arch/mips/mipsasm.c"
                          , &p[1]);
  n = -n;
 } else {
  n = (int) r_num_get (
# 138 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
                      ((void *)0)
# 138 "project/radare2/libr/asm/arch/mips/mipsasm.c"
                          , p);
 }
 if (n != 0 || p[0] == '0') {
  return n;
...
# 143 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
fprintf(__stderrp,
# 143 "project/radare2/libr/asm/arch/mips/mipsasm.c"
...
# 147 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
                                        unsigned long long 
# 147 "project/radare2/libr/asm/arch/mips/mipsasm.c"
                                             pc, 
# 147 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
                                                 unsigned char 
# 147 "project/radare2/libr/asm/arch/mips/mipsasm.c"
...
# 169 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
  __builtin___snprintf_chk (
# 169 "project/radare2/libr/asm/arch/mips/mipsasm.c"
  opstr
# 169 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
  , 
# 169 "project/radare2/libr/asm/arch/mips/mipsasm.c"
...
# 193 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
    __builtin___strcpy_chk (
# 193 "project/radare2/libr/asm/arch/mips/mipsasm.c"
    tmp
# 193 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
    , 
# 193 "project/radare2/libr/asm/arch/mips/mipsasm.c"
...
# 194 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
    __builtin___strcpy_chk (
# 194 "project/radare2/libr/asm/arch/mips/mipsasm.c"
    w2
# 194 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
    , 
# 194 "project/radare2/libr/asm/arch/mips/mipsasm.c"
...
# 195 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
    __builtin___strcpy_chk (
# 195 "project/radare2/libr/asm/arch/mips/mipsasm.c"
    w3
# 195 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
    , 
# 195 "project/radare2/libr/asm/arch/mips/mipsasm.c"
...
# 201 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
    _Bool 
# 201 "project/radare2/libr/asm/arch/mips/mipsasm.c"
         invalid = 
# 201 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
                   0
# 201 "project/radare2/libr/asm/arch/mips/mipsasm.c"
     ...
     default:
      invalid = 
# 244 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
               1
# 244 "project/radare2/libr/asm/arch/mips/mipsasm.c"
                   ;
      break;
     }
     if (!invalid) {
...
# 255 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
    _Bool 
# 255 "project/radare2/libr/asm/arch/mips/mipsasm.c"
         invalid = 
# 255 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
                   0
# 255 "project/radare2/libr/asm/arch/mips/mipsasm.c"
     ...
     default:
      invalid = 
# 292 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
               1
# 292 "project/radare2/libr/asm/arch/mips/mipsasm.c"
                   ;
      break;
     }
     if (!invalid) {
...
# 308 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
    __builtin___memset_chk (
# 308 "project/radare2/libr/asm/arch/mips/mipsasm.c"
    out
# 308 "project/radare2/libr/asm/arch/mips/mipsasm.c" 3 4
    , 
# 308 "project/radare2/libr/asm/arch/mips/mipsasm.c"
