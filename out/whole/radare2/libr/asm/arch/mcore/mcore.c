# 0 "project/radare2/libr/asm/arch/mcore/mcore.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/arch/mcore/mcore.h" 1
...
# 5 "project/radare2/libr/asm/arch/mcore/mcore.h" 2
...
# 6 "project/radare2/libr/asm/arch/mcore/mcore.h" 2
...
# 26 "project/radare2/libr/asm/arch/mcore/mcore.h"
typedef struct {
 const 
# 27 "project/radare2/libr/asm/arch/mcore/mcore.h" 3 4
      unsigned char
# 27 "project/radare2/libr/asm/arch/mcore/mcore.h"
         * end;
 const 
# 28 "project/radare2/libr/asm/arch/mcore/mcore.h" 3 4
      unsigned char
# 28 "project/radare2/libr/asm/arch/mcore/mcore.h"
         * pos;
 
# 29 "project/radare2/libr/asm/arch/mcore/mcore.h" 3 4
unsigned short 
# 29 "project/radare2/libr/asm/arch/mcore/mcore.h"
     inc;
} mcore_handle;

typedef struct {
 
# 33 "project/radare2/libr/asm/arch/mcore/mcore.h" 3 4
unsigned int 
# 33 "project/radare2/libr/asm/arch/mcore/mcore.h"
     value;
 
# 34 "project/radare2/libr/asm/arch/mcore/mcore.h" 3 4
unsigned short 
# 34 "project/radare2/libr/asm/arch/mcore/mcore.h"
     type;
} mcore_field_t;

typedef struct {
 const char* name;
 mcore_field_t args[5];
 
# 40 "project/radare2/libr/asm/arch/mcore/mcore.h" 3 4
unsigned long long 
# 40 "project/radare2/libr/asm/arch/mcore/mcore.h"
     type;
 
# 41 "project/radare2/libr/asm/arch/mcore/mcore.h" 3 4
unsigned short 
# 41 "project/radare2/libr/asm/arch/mcore/mcore.h"
     n_args;
 
# 42 "project/radare2/libr/asm/arch/mcore/mcore.h" 3 4
unsigned short 
# 42 "project/radare2/libr/asm/arch/mcore/mcore.h"
     bytes;
 
# 43 "project/radare2/libr/asm/arch/mcore/mcore.h" 3 4
unsigned short 
# 43 "project/radare2/libr/asm/arch/mcore/mcore.h"
     size;
} mcore_t;

int mcore_init(mcore_handle* handle, const 
# 46 "project/radare2/libr/asm/arch/mcore/mcore.h" 3 4
                                          unsigned char
# 46 "project/radare2/libr/asm/arch/mcore/mcore.h"
                                             * buffer, const 
# 46 "project/radare2/libr/asm/arch/mcore/mcore.h" 3 4
                                                             unsigned int 
# 46 "project/radare2/libr/asm/arch/mcore/mcore.h"
...
void mcore_snprint(char* str, int size, 
# 49 "project/radare2/libr/asm/arch/mcore/mcore.h" 3 4
                                       unsigned long long 
# 49 "project/radare2/libr/asm/arch/mcore/mcore.h"
                                            addr, mcore_t* instr);
# 2 "project/radare2/libr/asm/arch/mcore/mcore.c" 2
...
# 4 "project/radare2/libr/asm/arch/mcore/mcore.c" 2
...
# 12 "project/radare2/libr/asm/arch/mcore/mcore.c"
...
# 74 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
unsigned short 
# 74 "project/radare2/libr/asm/arch/mcore/mcore.c"
     mask;
 
# 75 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
unsigned short 
# 75 "project/radare2/libr/asm/arch/mcore/mcore.c"
     shift;
 
# 76 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
unsigned short 
# 76 "project/radare2/libr/asm/arch/mcore/mcore.c"
     type;
} mcore_mask_t;
...
# 81 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
unsigned short 
# 81 "project/radare2/libr/asm/arch/mcore/mcore.c"
     cpu;
 
# 82 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
unsigned short 
# 82 "project/radare2/libr/asm/arch/mcore/mcore.c"
     mask;
 
# 83 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
unsigned long long 
# 83 "project/radare2/libr/asm/arch/mcore/mcore.c"
     type;
 
# 84 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
unsigned short 
# 84 "project/radare2/libr/asm/arch/mcore/mcore.c"
     n_args;
 mcore_mask_t args[5];
} mcore_ops_t;


# 88 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
unsigned short 
# 88 "project/radare2/libr/asm/arch/mcore/mcore.c"
    load_shift[4] = { 2, 0, 1, 0 };

#define MCORE_INSTRS 265
mcore_ops_t mcore_instructions[265] = {
 { "bkpt" , 0, 0x0, R_ANAL_OP_TYPE_ILL , 0, {{0},{0},{0},{0},{0}} },
 { "sync" , 0, 0x1, R_ANAL_OP_TYPE_SYNC , 0, {{0},{0},{0},{0},{0}} },
 { "rte" , 0, 0x2, R_ANAL_OP_TYPE_RET , 0, {{0},{0},{0},{0},{0}} },
 { "rfi" , 0, 0x3, R_ANAL_OP_TYPE_RET , 0, {{0},{0},{0},{0},{0}} },
 { "stop" , 0, 0x4, R_ANAL_OP_TYPE_NULL , 0, {{0},{0},{0},{0},{0}} },
 { "wait" , 0, 0x5, R_ANAL_OP_TYPE_NULL , 0, {{0},{0},{0},{0},{0}} },
 { "doze" , 0, 0x6, R_ANAL_OP_TYPE_NULL , 0, {{0},{0},{0},{0},{0}} },
 { "idly4" , 0, 0x7, R_ANAL_OP_TYPE_NULL , 0, {{0},{0},{0},{0},{0}} },

 { "trap" , 0, 0xb, R_ANAL_OP_TYPE_NULL , 1, {{ 0x3, 0, 2 },{0},{0},{0},{0}} },

 { "mvtc" , 1, 0xc, R_ANAL_OP_TYPE_NULL , 0, {{0},{0},{0},{0},{0}} },

 { "cprc" , 0, 0xd, R_ANAL_OP_TYPE_NULL , 0, {{0},{0},{0},{0},{0}} },


 { "cpseti" , 0, 0x1f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 2 },{0},{0},{0},{0}} },

 { "mvc" , 0, 0x2f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "mvcv" , 0, 0x3f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "ldq" , 0, 0x4f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "stq" , 0, 0x5f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "ldm" , 0, 0x6f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "stm" , 0, 0x7f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "dect" , 0, 0x8f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "decf" , 0, 0x9f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "inct" , 0, 0xaf, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "incf" , 0, 0xbf, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "jmp" , 0, 0xcf, R_ANAL_OP_TYPE_CALL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "jsr" , 0, 0xdf, R_ANAL_OP_TYPE_RET , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "ff1" , 0, 0xef, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "brev" , 0, 0xff, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "xtrb3" , 0, 0x10f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "xtrb2" , 0, 0x11f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "xtrb1" , 0, 0x12f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "xtrb0" , 0, 0x13f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "zextb" , 0, 0x14f, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf, 0, 1 },{0},{0},{0}} },

 { "sextb" , 0, 0x15f, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf, 0, 1 },{0},{0},{0}} },

 { "zexth" , 0, 0x16f, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf, 0, 1 },{0},{0},{0}} },

 { "sexth" , 0, 0x17f, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf, 0, 1 },{0},{0},{0}} },

 { "declt" , 0, 0x18f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "declt" , 0, 0x19f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "decgt" , 0, 0x1af, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "decne" , 0, 0x1bf, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "clrt" , 0, 0x1cf, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "clrf" , 0, 0x1df, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "abs" , 0, 0x1ef, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "not" , 0, 0x1ff, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "movt" , 0, 0x2ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "mult" , 0, 0x3ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "subu" , 0, 0x5ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "addc" , 0, 0x6ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "subc" , 0, 0x7ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "cprgr" , 0, 0x9ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0x1f0, 4, 1 },{0},{0},{0}} },

 { "movf" , 0, 0xaff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "lsr" , 0, 0xbff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "cmphs" , 0, 0xbff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "cmplt" , 0, 0xdff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "tst" , 0, 0xeff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "cmpne" , 0, 0xfff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "mfcr" , 0, 0x11ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0x1f0, 4, 6},{0},{0},{0}} },

 { "psrclr" , 0, 0x11f7, R_ANAL_OP_TYPE_NULL , 1, {{ 0x7, 0, 1 },{0},{0},{0},{0}} },

 { "psrset" , 0, 0x11ff, R_ANAL_OP_TYPE_NULL , 1, {{ 0x7, 0, 1 },{0},{0},{0},{0}} },

 { "mov" , 0, 0x12ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "bgenr" , 0, 0x13ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "rsub" , 0, 0x14ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "lxw" , 0, 0x15ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "and" , 0, 0x16ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "xor" , 0, 0x17ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "mtcr" , 0, 0x11ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0x1f0, 4, 6},{0},{0},{0}} },

 { "asr" , 0, 0x1aff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "lsl" , 0, 0x1bff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "addu" , 0, 0x1cff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "lxh" , 0, 0x1dff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "or" , 0, 0x1eff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "andn" , 0, 0x1fff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 1 },{0},{0},{0}} },

 { "addi" , 0, 0x21ff, R_ANAL_OP_TYPE_NULL , 3, {{ 0xf, 0, 1 },{ 0xf, 0, 1 },{ 0x1f0, 4, 2 },{0},{0}} },

 { "cmplti" , 0, 0x23ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0x1f0, 4, 2 },{0},{0},{0}} },

 { "subi" , 0, 0x25ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0x1f0, 4, 2 },{0},{0},{0}} },

 { "cpwgr" , 0, 0x27ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0x1f0, 4, 6},{0},{0},{0}} },

 { "rsubi" , 0, 0x29ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0x1f0, 4, 2 },{0},{0},{0}} },

 { "cmpnei" , 0, 0x2bff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0x1f0, 4, 2 },{0},{0},{0}} },

 { "bmaski" , 0, 0x2c0f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "divu" , 0, 0x2c1f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "mflos" , 2, 0x2c2f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "mfhis" , 2, 0x2c2f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "mtlo" , 3 , 0x2c4f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "mthi" , 3 , 0x2c5f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "mtlo" , 3 , 0x2c6f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "mthi" , 3 , 0x2c7f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "bmaski" , 0, 0x2cff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0x70, 4, 2 },{0},{0},{0}} },

 { "bmaski" , 0, 0x2dff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 2 },{0},{0},{0}} },

 { "andi" , 0, 0x2fff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0x1f0, 4, 2 },{0},{0},{0}} },

 { "bclri" , 0, 0x31ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0x1f0, 4, 2 },{0},{0},{0}} },

 { "cpwir" , 0, 0x320f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "divs" , 0, 0x321f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "cprsr" , 0, 0x322f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "cpwsr" , 0, 0x323f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },




 { "bgeni" , 0, 0x327f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "bgeni" , 0, 0x32ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0x70, 4, 2 },{0},{0},{0}} },

 { "bgeni" , 0, 0x33ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0xf0, 4, 2 },{0},{0},{0}} },

 { "bgeni" , 0, 0x35ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0x1f0, 4, 2 },{0},{0},{0}} },

 { "btsti" , 0, 0x37ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0x1f0, 4, 2 },{0},{0},{0}} },

 { "xsr" , 0, 0x380f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "rotli" , 0, 0x39ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0x1f0, 4, 2 },{0},{0},{0}} },

 { "asrc" , 0, 0x3a0f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "asri" , 0, 0x3bff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0x1f0, 4, 2 },{0},{0},{0}} },

 { "lslc" , 0, 0x3c0f, R_ANAL_OP_TYPE_NULL , 1, {{ 0xf, 0, 1 },{0},{0},{0},{0}} },

 { "lsli" , 0, 0x3dff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0x1f0, 4, 2 },{0},{0},{0}} },
# 320 "project/radare2/libr/asm/arch/mcore/mcore.c"
 { "movi" , 0, 0x67ff, R_ANAL_OP_TYPE_NULL , 2, {{ 0xf, 0, 1 },{ 0x7f0, 4, 2 },{0},{0},{0}} },
# 329 "project/radare2/libr/asm/arch/mcore/mcore.c"
 { "cpwcr" , 0, 0x6fff, R_ANAL_OP_TYPE_NULL , 2, {{ 0x7, 0, 1 },{ 0xf8, 4, 2 },{0},{0},{0}} },

 { "jmpi" , 0, 0x70ff, R_ANAL_OP_TYPE_JMP , 2, {{ 0xff, 0, 4 },{0},{0},{0},{0}} },

 { "lrw" , 0, 0x7fff, R_ANAL_OP_TYPE_LOAD , 2, {{ 0xff, 0, 3 },{ 0xf00, 8, 1 },{0},{0},{0}} },

 { "jsri" , 0, 0x7fff, R_ANAL_OP_TYPE_CALL , 1, {{ 0xff, 0, 5},{0},{0},{0},{0}} },

 { "ld.w" , 0, 0x8fff, R_ANAL_OP_TYPE_LOAD , 4, {{ 0xf, 0, 0},{ 0xf0, 4, 0},{ 0xf00, 8, 0},{ 0x6000, 13, 0},{0}} },

 { "st.w" , 0, 0x9fff, R_ANAL_OP_TYPE_STORE, 4, {{ 0xf, 0, 0},{ 0xf0, 4, 0},{ 0xf00, 8, 0},{ 0x6000, 13, 0},{0}} },

 { "ld.b" , 0, 0xafff, R_ANAL_OP_TYPE_LOAD , 4, {{ 0xf, 0, 0},{ 0xf0, 4, 0},{ 0xf00, 8, 0},{ 0x6000, 13, 0},{0}} },

 { "st.b" , 0, 0xbfff, R_ANAL_OP_TYPE_STORE, 4, {{ 0xf, 0, 0},{ 0xf0, 4, 0},{ 0xf00, 8, 0},{ 0x6000, 13, 0},{0}} },

 { "ld.h" , 0, 0xcfff, R_ANAL_OP_TYPE_LOAD , 4, {{ 0xf, 0, 0},{ 0xf0, 4, 0},{ 0xf00, 8, 0},{ 0x6000, 13, 0},{0}} },

 { "st.h" , 0, 0xdfff, R_ANAL_OP_TYPE_STORE, 4, {{ 0xf, 0, 0},{ 0xf0, 4, 0},{ 0xf00, 8, 0},{ 0x6000, 13, 0},{0}} },

 { "bt" , 0, 0xe7ff, R_ANAL_OP_TYPE_CJMP , 1, {{ 0x7ff, 0, 4},{0},{0},{0},{0}} },

 { "bf" , 0, 0xefff, R_ANAL_OP_TYPE_CJMP , 1, {{ 0x7ff, 0, 4},{0},{0},{0},{0}} },

 { "br" , 0, 0xf7ff, R_ANAL_OP_TYPE_CJMP , 1, {{ 0x7ff, 0, 4},{0},{0},{0},{0}} },

 { "bsr" , 0, 0xffff, R_ANAL_OP_TYPE_CALL , 1, {{ 0x7ff, 0, 4},{0},{0},{0},{0}} },
};

static mcore_t *find_instruction(const 
# 358 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
                                      unsigned char
# 358 "project/radare2/libr/asm/arch/mcore/mcore.c"
                                         * buffer) {
 
# 359 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
unsigned int 
# 359 "project/radare2/libr/asm/arch/mcore/mcore.c"
     i = 0;
 mcore_ops_t *op_ptr = 
# 360 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
                      ((void *)0)
# 360 "project/radare2/libr/asm/arch/mcore/mcore.c"
                          ;
 mcore_t *op = 
# 361 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
              ((void *)0)
# 361 "project/radare2/libr/asm/arch/mcore/mcore.c"
                  ;
 if (!buffer || !(op = malloc (sizeof (mcore_t)))) {
  return 
# 363 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
        ((void *)0)
# 363 "project/radare2/libr/asm/arch/mcore/mcore.c"
            ;
 }
 
# 365 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
__builtin___memset_chk (
# 365 "project/radare2/libr/asm/arch/mcore/mcore.c"
op
# 365 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
, 
# 365 "project/radare2/libr/asm/arch/mcore/mcore.c"
...
# 366 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
unsigned int 
# 366 "project/radare2/libr/asm/arch/mcore/mcore.c"
     count = sizeof (mcore_instructions) / sizeof (mcore_ops_t);
 
# 367 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
unsigned short 
# 367 "project/radare2/libr/asm/arch/mcore/mcore.c"
     data = buffer[1] << 8;
 data |= buffer[0];
 op->bytes = data;
 op->size = (2);
...
# 376 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
  unsigned short 
# 376 "project/radare2/libr/asm/arch/mcore/mcore.c"
       masked = data & op_ptr->mask;
...
int mcore_init(mcore_handle* handle, const 
# 404 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
                                          unsigned char
# 404 "project/radare2/libr/asm/arch/mcore/mcore.c"
                                             * buffer, const 
# 404 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
                                                             unsigned int 
# 404 "project/radare2/libr/asm/arch/mcore/mcore.c"
...
mcore_t* mcore_next(mcore_handle* handle) {
 mcore_t *op = 
# 414 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
              ((void *)0)
# 414 "project/radare2/libr/asm/arch/mcore/mcore.c"
                  ;
 if (!handle || handle->pos + (2) > handle->end) {
  return 
# 416 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
        ((void *)0)
# 416 "project/radare2/libr/asm/arch/mcore/mcore.c"
            ;
 }
...
void print_loop(char* str, int size, 
# 431 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
                                    unsigned long long 
# 431 "project/radare2/libr/asm/arch/mcore/mcore.c"
                                         addr, mcore_t* instr) {
 
# 432 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
unsigned int 
# 432 "project/radare2/libr/asm/arch/mcore/mcore.c"
     i;
 int bufsize = size;
 int add = 
# 434 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
          __builtin___snprintf_chk (
# 434 "project/radare2/libr/asm/arch/mcore/mcore.c"
          str
# 434 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
          , 
# 434 "project/radare2/libr/asm/arch/mcore/mcore.c"
...
# 434 "project/radare2/libr/asm/arch/mcore/mcore.c"
 ...
 for (i = 0; add > 0 && i < instr->n_args && add < bufsize; i++) {
  if (instr->args[i].type == 1) {
   add += 
# 437 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
         __builtin___snprintf_chk (
# 437 "project/radare2/libr/asm/arch/mcore/mcore.c"
         str + add
# 437 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
         , 
# 437 "project/radare2/libr/asm/arch/mcore/mcore.c"
...
# 437 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
         , 2 > 1 ? 1 : 0), 
# 437 "project/radare2/libr/asm/arch/mcore/mcore.c"
         " r%u,", instr->args[i].value
# 437 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
         )
# 437 "project/radare2/libr/asm/arch/mcore/mcore.c"
                                                                           ;
  } else if (instr->args[i].type == 2) {
   add += 
# 439 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
         __builtin___snprintf_chk (
# 439 "project/radare2/libr/asm/arch/mcore/mcore.c"
         str + add
# 439 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
         , 
# 439 "project/radare2/libr/asm/arch/mcore/mcore.c"
...
# 439 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
         , 2 > 1 ? 1 : 0), 
# 439 "project/radare2/libr/asm/arch/mcore/mcore.c"
         " 0x%x,", instr->args[i].value
# 439 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
         )
# 439 "project/radare2/libr/asm/arch/mcore/mcore.c"
                                                                            ;
  } else if (instr->args[i].type == 3) {
   add += 
# 441 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
         __builtin___snprintf_chk (
# 441 "project/radare2/libr/asm/arch/mcore/mcore.c"
         str + add
# 441 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
         , 
# 441 "project/radare2/libr/asm/arch/mcore/mcore.c"
...
# 441 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
         , 2 > 1 ? 1 : 0), 
# 441 "project/radare2/libr/asm/arch/mcore/mcore.c"
         " 0x%x(r%d),", instr->args[i + 1].value, instr->args[i].value
# 441 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
         )
                                                   
# 442 "project/radare2/libr/asm/arch/mcore/mcore.c"
                                                  ;
   i++;
  } else if (instr->args[i].type == 5) {
   
# 445 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
  unsigned long long 
# 445 "project/radare2/libr/asm/arch/mcore/mcore.c"
       jump = addr + ((instr->args[i].value << 2) & 0xfffffffc);
   add += 
# 446 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
         __builtin___snprintf_chk (
# 446 "project/radare2/libr/asm/arch/mcore/mcore.c"
         str + add
# 446 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
         , 
# 446 "project/radare2/libr/asm/arch/mcore/mcore.c"
...
# 446 "project/radare2/libr/asm/arch/mcore/mcore.c"
                                                                       ;
  } else if (instr->args[i].type == 4) {
   
# 448 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
  unsigned long long 
# 448 "project/radare2/libr/asm/arch/mcore/mcore.c"
       jump = addr + instr->args[i].value + 1;
   add += 
# 449 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
         __builtin___snprintf_chk (
# 449 "project/radare2/libr/asm/arch/mcore/mcore.c"
         str + add
# 449 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
         , 
# 449 "project/radare2/libr/asm/arch/mcore/mcore.c"
...
# 449 "project/radare2/libr/asm/arch/mcore/mcore.c"
                                                                      ;
  } else if (instr->args[i].type == 6) {
   
# 451 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
  unsigned int 
# 451 "project/radare2/libr/asm/arch/mcore/mcore.c"
       pos = instr->args[i].value;
   if (pos >= 32) {
    pos = 32;
   }
   add += 
# 455 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
         __builtin___snprintf_chk (
# 455 "project/radare2/libr/asm/arch/mcore/mcore.c"
         str + add
# 455 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
         , 
# 455 "project/radare2/libr/asm/arch/mcore/mcore.c"
...
void mcore_snprint(char* str, int size, 
# 464 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
                                       unsigned long long 
# 464 "project/radare2/libr/asm/arch/mcore/mcore.c"
                                            addr, mcore_t* instr) {
 
# 465 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
unsigned int 
# 465 "project/radare2/libr/asm/arch/mcore/mcore.c"
     imm;
 if (!instr || !str) {
  return;
 }
...
# 473 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
 __builtin___snprintf_chk (
# 473 "project/radare2/libr/asm/arch/mcore/mcore.c"
 str
# 473 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
 , 
# 473 "project/radare2/libr/asm/arch/mcore/mcore.c"
...
# 473 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 473 "project/radare2/libr/asm/arch/mcore/mcore.c"
 "%s r%u, (r%u, 0x%x)", instr->name, instr->args[2].value, instr->args[0].value, imm
# 473 "project/radare2/libr/asm/arch/mcore/mcore.c" 3 4
 )
                                                                
# 474 "project/radare2/libr/asm/arch/mcore/mcore.c"
                                                               ;
  break;
 default:
