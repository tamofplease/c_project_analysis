# 0 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
# 2 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 2
...
# 3 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 2

# 1 "project/radare2/libr/asm/arch/propeller/propeller_disas.h" 1
...
# 6 "project/radare2/libr/asm/arch/propeller/propeller_disas.h"
...
# 112 "project/radare2/libr/asm/arch/propeller/propeller_disas.h" 3 4
unsigned short 
# 112 "project/radare2/libr/asm/arch/propeller/propeller_disas.h"
     src;
 
# 113 "project/radare2/libr/asm/arch/propeller/propeller_disas.h" 3 4
unsigned short 
# 113 "project/radare2/libr/asm/arch/propeller/propeller_disas.h"
     dst;
 
# 114 "project/radare2/libr/asm/arch/propeller/propeller_disas.h" 3 4
unsigned short 
# 114 "project/radare2/libr/asm/arch/propeller/propeller_disas.h"
     opcode;
 
# 115 "project/radare2/libr/asm/arch/propeller/propeller_disas.h" 3 4
unsigned char 
# 115 "project/radare2/libr/asm/arch/propeller/propeller_disas.h"
     immed;
 char prefix[16];
 char instr[32];
 char operands[32];
...
int propeller_decode_command (const 
# 121 "project/radare2/libr/asm/arch/propeller/propeller_disas.h" 3 4
                                   unsigned char
# 121 "project/radare2/libr/asm/arch/propeller/propeller_disas.h"
                                      * instr, struct propeller_cmd *cmd);
# 5 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 2
...
static 
# 96 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
      unsigned short 
# 96 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
           get_opcode (
# 96 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
                       unsigned int 
# 96 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
static 
# 100 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
      unsigned short 
# 100 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
           get_opcode_ext (
# 100 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
                           unsigned int 
# 100 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
static 
# 104 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
      unsigned short 
# 104 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
           get_src (
# 104 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
                    unsigned int 
# 104 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
static 
# 108 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
      unsigned short 
# 108 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
           get_dst (
# 108 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
                    unsigned int 
# 108 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
static int is_immediate (
# 112 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
                        unsigned int 
# 112 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
                             instr) {
 return instr & 0x00400000;
}

static int decode_ext_cmd (struct propeller_cmd *cmd, 
# 116 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
                                                     unsigned int 
# 116 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
                                                          instr) {
 
# 117 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
unsigned short 
# 117 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
     opcode;
...
# 130 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
  __builtin___snprintf_chk (
# 130 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
  cmd->instr
# 130 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
  , 
# 130 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
# 131 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
                                  ;
   
# 132 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
  __builtin___snprintf_chk (
# 132 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
  cmd->operands
# 132 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
  , 
# 132 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
# 133 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
                          ;
   return 4;
   break;
 }
...
static 
# 141 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
      unsigned char 
# 141 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
          get_zcri (
# 141 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
                    unsigned int 
# 141 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
static 
# 145 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
      unsigned char 
# 145 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
          get_con (
# 145 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
                   unsigned int 
# 145 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
# 149 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
                                                     unsigned int 
# 149 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
                                                          instr) {
 
# 150 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
unsigned char 
# 150 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
    prefix = (instr >> 18) & 0xF;

 
# 152 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
__builtin___snprintf_chk (
# 152 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
cmd->prefix
# 152 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
, 
# 152 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
# 156 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
                                                 unsigned int 
# 156 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
                                                      instr) {
 
# 157 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
unsigned short 
# 157 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
     opcode;
 
# 158 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
unsigned char 
# 158 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
    zcri;
 int ret = 1;
...
# 165 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
   __builtin___snprintf_chk (
# 165 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
   cmd->instr
# 165 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
   , 
# 165 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
# 166 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
                    ;
    if (zcri & 1) {
...
# 171 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
    __builtin___snprintf_chk (
# 171 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
    cmd->operands
# 171 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
    , 
# 171 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
# 172 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
                                                           ;
    } else {
     cmd->src = get_src (instr) << 2;
     cmd->dst = get_dst (instr) << 2;
     
# 176 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
    __builtin___snprintf_chk (
# 176 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
    cmd->operands
# 176 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
    , 
# 176 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
# 177 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
                                                          ;
    }
   } else {
    
# 180 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
   __builtin___snprintf_chk (
# 180 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
   cmd->instr
# 180 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
   , 
# 180 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
# 181 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
                 ;
    if (zcri & 1) {
     cmd->src = get_src (instr) << 2;
     cmd->immed = 1;
     
# 185 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
    __builtin___snprintf_chk (
# 185 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
    cmd->operands
# 185 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
    , 
# 185 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
# 186 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
                                    ;
    } else {
     cmd->immed = 0;
     cmd->src = get_src (instr) << 2;
     
# 190 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
    __builtin___snprintf_chk (
# 190 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
    cmd->operands
# 190 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
    , 
# 190 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
# 191 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
                                   ;
    }
   }
...
int propeller_decode_command(const 
# 203 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
                                  unsigned char 
# 203 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
                                      *instr, struct propeller_cmd *cmd)
{
 int ret = -1;
 
# 206 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
unsigned int 
# 206 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
     in;
 
# 207 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
unsigned short 
# 207 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
     opcode;
...
# 214 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
 __builtin___snprintf_chk (
# 214 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
 cmd->instr
# 214 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
 , 
# 214 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
# 280 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
  __builtin___snprintf_chk (
# 280 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
  cmd->instr
# 280 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
  , 
# 280 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
# 289 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
   __builtin___snprintf_chk (
# 289 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
   cmd->instr
# 289 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
   , 
# 289 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
# 291 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
   __builtin___snprintf_chk (
# 291 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
   cmd->instr
# 291 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
   , 
# 291 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
# 297 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
   __builtin___snprintf_chk (
# 297 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
   cmd->operands
# 297 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
   , 
# 297 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
# 297 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
   , 2 > 1 ? 1 : 0), 
# 297 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
   "0x%x, #%d", get_dst (in), get_src (in)
# 297 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
   )
                                 
# 298 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
                                ;
   } else {
    cmd->src = get_src (in) << 2;
    cmd->dst = get_dst (in);
    
# 302 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
   __builtin___snprintf_chk (
# 302 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
   cmd->operands
# 302 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
   , 
# 302 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
# 302 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
   , 2 > 1 ? 1 : 0), 
# 302 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
   "0x%x, 0x%x", get_dst (in), get_src (in) << 2
# 302 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
   )
                                      
# 303 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
                                     ;
   }
...
# 311 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
   __builtin___snprintf_chk (
# 311 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
   cmd->instr
# 311 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
   , 
# 311 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
# 312 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
                    ;
...
# 318 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
    __builtin___snprintf_chk (
# 318 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
    cmd->operands
# 318 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
    , 
# 318 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
# 318 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
    , 2 > 1 ? 1 : 0), 
# 318 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
    "0x%x, #%d", get_dst (in) << 2, get_src (in)
# 318 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
    )
                                       
# 319 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
                                      ;
    } else {
     cmd->src = get_src (in);
     cmd->dst = get_dst (in);
...
# 324 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
    __builtin___snprintf_chk (
# 324 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
    cmd->operands
# 324 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
    , 
# 324 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
...
# 324 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
    , 2 > 1 ? 1 : 0), 
# 324 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
    "0x%x, 0x%x", get_dst (in), get_src (in)
# 324 "project/radare2/libr/asm/arch/propeller/propeller_disas.c" 3 4
    )
                                  
# 325 "project/radare2/libr/asm/arch/propeller/propeller_disas.c"
                                 ;
    }
