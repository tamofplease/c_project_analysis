# 0 "project/radare2/libr/asm/arch/whitespace/wsdis.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/arch/whitespace/wsdis.c"
...
# 4 "project/radare2/libr/asm/arch/whitespace/wsdis.c" 2
...
# 5 "project/radare2/libr/asm/arch/whitespace/wsdis.c" 2
...
# 11 "project/radare2/libr/asm/arch/whitespace/wsdis.c"
enum {
 WS_OP_UNK = 0,
 WS_OP_NOP,
 WS_OP_PREF,
...
# 22 "project/radare2/libr/asm/arch/whitespace/wsdis.c" 3 4
                                   unsigned char 
# 22 "project/radare2/libr/asm/arch/whitespace/wsdis.c"
                                       *buf, int len) {
 if (len < 1) {
  return WS_OP_UNK;
 }
...
# 34 "project/radare2/libr/asm/arch/whitespace/wsdis.c" 3 4
                                  unsigned char 
# 34 "project/radare2/libr/asm/arch/whitespace/wsdis.c"
                                      *buf, int len) {
 if (len < 1) {
  return WS_OP_UNK;
 }
 ...
 int get_ws_optype(const 
# 46 "project/radare2/libr/asm/arch/whitespace/wsdis.c" 3 4
                              unsigned char 
# 46 "project/radare2/libr/asm/arch/whitespace/wsdis.c"
                                  *buf, int len) {
 const 
# 47 "project/radare2/libr/asm/arch/whitespace/wsdis.c" 3 4
      unsigned char 
# 47 "project/radare2/libr/asm/arch/whitespace/wsdis.c"
          *ptr;
 ...
 const 
# 58 "project/radare2/libr/asm/arch/whitespace/wsdis.c" 3 4
            unsigned char 
# 58 "project/radare2/libr/asm/arch/whitespace/wsdis.c"
...
# 58 "project/radare2/libr/asm/arch/whitespace/wsdis.c"
                                             *buf, int len) {
 const 
# 59 "project/radare2/libr/asm/arch/whitespace/wsdis.c" 3 4
      unsigned char 
# 59 "project/radare2/libr/asm/arch/whitespace/wsdis.c"
          *ret;
 ret = buf;
 while (len - (ret - buf)) {
  switch (*ret) {
 ...
 return 
# 70 "project/radare2/libr/asm/arch/whitespace/wsdis.c" 3 4
       ((void *)0)
# 70 "project/radare2/libr/asm/arch/whitespace/wsdis.c"
           ;
}

static 
# 73 "project/radare2/libr/asm/arch/whitespace/wsdis.c" 3 4
      int 
# 73 "project/radare2/libr/asm/arch/whitespace/wsdis.c"
           get_ws_val(const 
# 73 "project/radare2/libr/asm/arch/whitespace/wsdis.c" 3 4
                            unsigned char 
# 73 "project/radare2/libr/asm/arch/whitespace/wsdis.c"
...
# 74 "project/radare2/libr/asm/arch/whitespace/wsdis.c" 3 4
unsigned char 
# 74 "project/radare2/libr/asm/arch/whitespace/wsdis.c"
    sig;
 int i, ret = 0;
 const 
# 76 "project/radare2/libr/asm/arch/whitespace/wsdis.c" 3 4
      unsigned char 
# 76 "project/radare2/libr/asm/arch/whitespace/wsdis.c"
 ...
 int test_ws_token_exist(const 
# 95 "project/radare2/libr/asm/arch/whitespace/wsdis.c" 3 4
                                    unsigned char 
# 95 "project/radare2/libr/asm/arch/whitespace/wsdis.c"
                                        *buf, 
# 95 "project/radare2/libr/asm/arch/whitespace/wsdis.c" 3 4
                                              unsigned char 
# 95 "project/radare2/libr/asm/arch/whitespace/wsdis.c"
                                                  token, int len) {
 const 
# 96 "project/radare2/libr/asm/arch/whitespace/wsdis.c" 3 4
      unsigned char 
# 96 "project/radare2/libr/asm/arch/whitespace/wsdis.c"
 ...
 int wsdis(RAsmOp *op, const 
# 106 "project/radare2/libr/asm/arch/whitespace/wsdis.c" 3 4
                                  unsigned char 
# 106 "project/radare2/libr/asm/arch/whitespace/wsdis.c"
                                      *buf, int len) {
 const char *buf_asm = 
# 107 "project/radare2/libr/asm/arch/whitespace/wsdis.c" 3 4
                      ((void *)0)
# 107 "project/radare2/libr/asm/arch/whitespace/wsdis.c"
                          ;
 const 
# 108 "project/radare2/libr/asm/arch/whitespace/wsdis.c" 3 4
      unsigned char 
# 108 "project/radare2/libr/asm/arch/whitespace/wsdis.c"
          *ptr = buf;
