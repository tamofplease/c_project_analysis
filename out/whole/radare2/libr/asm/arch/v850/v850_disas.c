# 0 "project/radare2/libr/asm/arch/v850/v850_disas.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 4 "project/radare2/libr/asm/arch/v850/v850_disas.c" 2
...
# 5 "project/radare2/libr/asm/arch/v850/v850_disas.c" 2


# 1 "project/radare2/libr/asm/arch/v850/v850_disas.h" 1
...
# 10 "project/radare2/libr/asm/arch/v850/v850_disas.h"
...
# 170 "project/radare2/libr/asm/arch/v850/v850_disas.h" 3 4
unsigned long long 
# 170 "project/radare2/libr/asm/arch/v850/v850_disas.h"
     addr;
 unsigned type;
 char instr[24];
 char operands[24];
...
static inline 
# 176 "project/radare2/libr/asm/arch/v850/v850_disas.h" 3 4
             unsigned char 
# 176 "project/radare2/libr/asm/arch/v850/v850_disas.h"
                 get_opcode(const 
# 176 "project/radare2/libr/asm/arch/v850/v850_disas.h" 3 4
                                  unsigned short 
# 176 "project/radare2/libr/asm/arch/v850/v850_disas.h"
...
static inline 
# 181 "project/radare2/libr/asm/arch/v850/v850_disas.h" 3 4
             unsigned char 
# 181 "project/radare2/libr/asm/arch/v850/v850_disas.h"
                 get_subopcode(const 
# 181 "project/radare2/libr/asm/arch/v850/v850_disas.h" 3 4
                                     unsigned short 
# 181 "project/radare2/libr/asm/arch/v850/v850_disas.h"
...
static inline 
# 185 "project/radare2/libr/asm/arch/v850/v850_disas.h" 3 4
             unsigned char 
# 185 "project/radare2/libr/asm/arch/v850/v850_disas.h"
                 get_reg1(const 
# 185 "project/radare2/libr/asm/arch/v850/v850_disas.h" 3 4
                                unsigned short 
# 185 "project/radare2/libr/asm/arch/v850/v850_disas.h"
...
static inline 
# 189 "project/radare2/libr/asm/arch/v850/v850_disas.h" 3 4
             unsigned char 
# 189 "project/radare2/libr/asm/arch/v850/v850_disas.h"
                 get_reg2(const 
# 189 "project/radare2/libr/asm/arch/v850/v850_disas.h" 3 4
                                unsigned short 
# 189 "project/radare2/libr/asm/arch/v850/v850_disas.h"
...
int v850_decode_command (const 
# 193 "project/radare2/libr/asm/arch/v850/v850_disas.h" 3 4
                              unsigned char 
# 193 "project/radare2/libr/asm/arch/v850/v850_disas.h"
                                  *instr, int len, struct v850_cmd *cmd);
# 8 "project/radare2/libr/asm/arch/v850/v850_disas.c" 2
...
static int decode_reg_reg(const 
# 103 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
                               unsigned short 
# 103 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                    instr, struct v850_cmd *cmd) {
 
# 104 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
unsigned char 
# 104 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 110 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
__builtin___snprintf_chk (
# 110 "project/radare2/libr/asm/arch/v850/v850_disas.c"
cmd->instr
# 110 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
, 
# 110 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 113 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 __builtin___snprintf_chk (
# 113 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 cmd->operands
# 113 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 
# 113 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 114 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                    ;
 } else {
  
# 116 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 __builtin___snprintf_chk (
# 116 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 cmd->operands
# 116 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 
# 116 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 116 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 116 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 "r%u, r%u", get_reg1 (instr), get_reg2 (instr)
# 116 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 )
                                      
# 117 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                     ;
 }
...
static int decode_imm_reg(const 
# 123 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
                               unsigned short 
# 123 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                    instr, struct v850_cmd *cmd) {
 
# 124 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
unsigned char 
# 124 "project/radare2/libr/asm/arch/v850/v850_disas.c"
    opcode = get_opcode (instr);
 if (opcode >= sizeof (instrs) / sizeof (char *)) {
  return -1;
 }
...
# 129 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
__builtin___snprintf_chk (
# 129 "project/radare2/libr/asm/arch/v850/v850_disas.c"
cmd->instr
# 129 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
, 
# 129 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 131 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
signed char 
# 131 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 138 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 __builtin___snprintf_chk (
# 138 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 cmd->operands
# 138 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 
# 138 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 138 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 138 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 "%d, r%u", immed, get_reg2 (instr)
# 138 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 )
                            
# 139 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                           ;
 } else {
  if (immed >= 0) {
   
# 142 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
  __builtin___snprintf_chk (
# 142 "project/radare2/libr/asm/arch/v850/v850_disas.c"
  cmd->operands
# 142 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
  , 
# 142 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 143 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                         ;
  } else {
   
# 145 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
  __builtin___snprintf_chk (
# 145 "project/radare2/libr/asm/arch/v850/v850_disas.c"
  cmd->operands
# 145 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
  , 
# 145 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 146 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                               ;
  }
 }
...
static int decode_bcond(const 
# 153 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
                             unsigned short 
# 153 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                  instr, int len, struct v850_cmd *cmd) {
...
# 160 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
unsigned long long 
# 160 "project/radare2/libr/asm/arch/v850/v850_disas.c"
     delta = ((((instr >> 4) & 0x7) | ((instr >> 11) << 3)) << 1);
 if (delta & 0x100) {
  delta |= 0xFE00;
 }
 
# 164 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
__builtin___snprintf_chk (
# 164 "project/radare2/libr/asm/arch/v850/v850_disas.c"
cmd->instr
# 164 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
, 
# 164 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 165 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
__builtin___snprintf_chk (
# 165 "project/radare2/libr/asm/arch/v850/v850_disas.c"
cmd->operands
# 165 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
, 
# 165 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
static int decode_jarl(const 
# 170 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
                            unsigned char 
# 170 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                *instr, int len, struct v850_cmd *cmd) {
 if (len < 4) {
  return -1;
 }
...
# 175 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
unsigned short 
# 175 "project/radare2/libr/asm/arch/v850/v850_disas.c"
     word1 = r_read_le16 (instr);
 
# 176 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
unsigned short 
# 176 "project/radare2/libr/asm/arch/v850/v850_disas.c"
     word2 = r_read_at_le16 (instr, 2);

 
# 178 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
unsigned char 
# 178 "project/radare2/libr/asm/arch/v850/v850_disas.c"
    reg = get_reg2 (word1);
 
# 179 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
unsigned int 
# 179 "project/radare2/libr/asm/arch/v850/v850_disas.c"
     disp = (word2 << 6) | get_reg1 (word1);

 
# 181 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
__builtin___snprintf_chk (
# 181 "project/radare2/libr/asm/arch/v850/v850_disas.c"
cmd->instr
# 181 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
, 
# 181 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 181 "project/radare2/libr/asm/arch/v850/v850_disas.c"
"%s", instrs[get_opcode (word1)]
# 181 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
)
# 181 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                                                              ;
 
# 182 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
__builtin___snprintf_chk (
# 182 "project/radare2/libr/asm/arch/v850/v850_disas.c"
cmd->operands
# 182 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
, 
# 182 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 182 "project/radare2/libr/asm/arch/v850/v850_disas.c"
"0x%08x, r%d", disp << 1, reg
# 182 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
)
                  
# 183 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                 ;

 return 4;
}

static int decode_3operands(const 
# 188 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
                                 unsigned char 
# 188 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                     *instr, int len, struct v850_cmd *cmd) {
 if (len < 4) {
  return -1;
 }
 
# 192 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
unsigned short 
# 192 "project/radare2/libr/asm/arch/v850/v850_disas.c"
     word1 = r_read_le16 (instr);
 
# 193 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
unsigned short 
# 193 "project/radare2/libr/asm/arch/v850/v850_disas.c"
     word2 = r_read_at_le16 (instr, 2);
 
# 194 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
__builtin___snprintf_chk (
# 194 "project/radare2/libr/asm/arch/v850/v850_disas.c"
cmd->instr
# 194 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
, 
# 194 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 195 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
__builtin___snprintf_chk (
# 195 "project/radare2/libr/asm/arch/v850/v850_disas.c"
cmd->operands
# 195 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
, 
# 195 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 195 "project/radare2/libr/asm/arch/v850/v850_disas.c"
"0x%x, r%d, r%d", word2, get_reg1 (word1), get_reg2 (word1)
# 195 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
)
                                             
# 196 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                            ;
 return 4;
}

static int decode_load_store(const 
# 200 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
                                  unsigned char 
# 200 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                      *instr, int len, struct v850_cmd *cmd) {
 if (len < 4) {
  return -1;
 }
...
# 205 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
unsigned short 
# 205 "project/radare2/libr/asm/arch/v850/v850_disas.c"
     word1 = r_read_le16 (instr);
 
# 206 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
unsigned short 
# 206 "project/radare2/libr/asm/arch/v850/v850_disas.c"
     word2 = r_read_at_le16 (instr, 2);

 switch (get_opcode (word1)) {
 case V850_STB:
  
# 210 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 __builtin___snprintf_chk (
# 210 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 cmd->instr
# 210 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 
# 210 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 210 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 210 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 "%s.b", instrs[get_opcode (word1)]
# 210 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 )
# 210 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                                                                 ;
  
# 211 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 __builtin___snprintf_chk (
# 211 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 cmd->operands
# 211 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 
# 211 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 211 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 211 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 "r%d, 0x%x[r%d]", get_reg2 (word1), word2, get_reg1 (word1)
# 211 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 )
                                                    
# 212 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                                   ;
  break;
 case V850_LDB:
  
# 215 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 __builtin___snprintf_chk (
# 215 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 cmd->instr
# 215 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 
# 215 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 216 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 __builtin___snprintf_chk (
# 216 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 cmd->operands
# 216 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 
# 216 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 216 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 216 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 "0x%x[r%d], r%d", get_reg1 (word1), word2, get_reg2 (word1)
# 216 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 )
                                                    
# 217 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                                   ;
  break;
 case V850_LDHW:
  
# 220 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 __builtin___snprintf_chk (
# 220 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 cmd->instr
# 220 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 
# 220 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 220 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 220 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 "%s.%c", instrs[get_opcode (word1)], word2 & 1 ? 'w' : 'h'
# 220 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 )
                                                      
# 221 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                                     ;
  
# 222 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 __builtin___snprintf_chk (
# 222 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 cmd->operands
# 222 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 
# 222 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 222 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 222 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 "0x%x[r%d], r%d", word2 & 0xFFFE, get_reg1 (word1), get_reg2 (word1)
# 222 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 )
                                                       
# 223 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                                      ;
  break;
 case V850_STHW:
  
# 226 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 __builtin___snprintf_chk (
# 226 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 cmd->instr
# 226 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 
# 226 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 227 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                                     ;
  
# 228 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 __builtin___snprintf_chk (
# 228 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 cmd->operands
# 228 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 
# 228 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 228 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 228 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 "r%d, 0x%x[r%d]", get_reg2 (word1), word2 & 0xFFFE, get_reg1 (word1)
# 228 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 )
                                                             
# 229 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                                            ;
  break;
 }
...
static int decode_bit_op(const 
# 236 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
                              unsigned char 
# 236 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                  *instr, int len, struct v850_cmd *cmd) {
 if (len < 4) {
  return -1;
 }
...
# 241 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
unsigned short 
# 241 "project/radare2/libr/asm/arch/v850/v850_disas.c"
     word1 = r_read_le16 (instr);
 
# 242 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
unsigned short 
# 242 "project/radare2/libr/asm/arch/v850/v850_disas.c"
     word2 = r_read_at_le16 (instr, 2);
 
# 243 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
__builtin___snprintf_chk (
# 243 "project/radare2/libr/asm/arch/v850/v850_disas.c"
cmd->instr
# 243 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
, 
# 243 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 243 "project/radare2/libr/asm/arch/v850/v850_disas.c"
"%s", bit_instrs[word1 >> 14]
# 243 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
)
# 243 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                                                           ;
 
# 244 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
unsigned char 
# 244 "project/radare2/libr/asm/arch/v850/v850_disas.c"
    reg1 = get_reg1 (word1);
 
# 245 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
__builtin___snprintf_chk (
# 245 "project/radare2/libr/asm/arch/v850/v850_disas.c"
cmd->operands
# 245 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
, 
# 245 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 245 "project/radare2/libr/asm/arch/v850/v850_disas.c"
"%u, 0x%x[r%d]", (word1 >> 11) & 0x7, word2, reg1
# 245 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
)
                                    
# 246 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                   ;
 return 4;
}

static int decode_extended(const 
# 250 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
                                unsigned char 
# 250 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                    *instr, int len, struct v850_cmd *cmd) {
 if (len < 4) {
  return -1;
 }
...
# 255 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
unsigned short 
# 255 "project/radare2/libr/asm/arch/v850/v850_disas.c"
     word1 = r_read_le16 (instr);
 
# 256 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
unsigned short 
# 256 "project/radare2/libr/asm/arch/v850/v850_disas.c"
     word2 = r_read_at_le16 (instr, 2);

 
# 258 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
__builtin___snprintf_chk (
# 258 "project/radare2/libr/asm/arch/v850/v850_disas.c"
cmd->instr
# 258 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
, 
# 258 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 258 "project/radare2/libr/asm/arch/v850/v850_disas.c"
"%s", ext_instrs1[get_subopcode (word1)]
# 258 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
)
                                      
# 259 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                     ;

 switch (get_subopcode (word1)) {
 case V850_EXT_SETF:
  
# 263 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 __builtin___snprintf_chk (
# 263 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 cmd->operands
# 263 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 
# 263 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 263 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 263 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 "%s, r%d", conds[word1 & 0xF], get_reg2 (word1)
# 263 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 )
                                         
# 264 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                        ;
  break;
 case V850_EXT_LDSR:
  
# 267 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 __builtin___snprintf_chk (
# 267 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 cmd->operands
# 267 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 
# 267 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 267 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 267 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 "r%d, r%d", get_reg2 (word1), get_reg1(word1)
# 267 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 )
                                      
# 268 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                     ;
  break;
 case V850_EXT_STSR:
  
# 271 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 __builtin___snprintf_chk (
# 271 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 cmd->operands
# 271 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 
# 271 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 271 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 271 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 "r%d, r%d", get_reg1 (word1), get_reg2 (word1)
# 271 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 )
                                       
# 272 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                      ;
  break;
 case V850_EXT_SHR:
 case V850_EXT_SAR:
...
# 277 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 __builtin___snprintf_chk (
# 277 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 cmd->operands
# 277 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 
# 277 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 277 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 277 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 "r%d, r%d", get_reg1 (word1), get_reg2 (word2)
# 277 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 )
                                       
# 278 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                      ;
  break;
 case V850_EXT_TRAP:
  
# 281 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 __builtin___snprintf_chk (
# 281 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 cmd->operands
# 281 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 
# 281 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 282 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                    ;
  break;
 case V850_EXT_HALT:
 case V850_EXT_RETI:
...
# 290 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 __builtin___snprintf_chk (
# 290 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 cmd->instr
# 290 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 
# 290 "project/radare2/libr/asm/arch/v850/v850_disas.c"
...
# 290 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 290 "project/radare2/libr/asm/arch/v850/v850_disas.c"
 "%s", ext_instrs2[(word2 >> 13) & 1]
# 290 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
 )
                                   
# 291 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                  ;
  break;
 default:
  return -1;
...
int v850_decode_command (const 
# 300 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
                              unsigned char 
# 300 "project/radare2/libr/asm/arch/v850/v850_disas.c"
                                  *instr, int len, struct v850_cmd *cmd) {
 int ret;
...
# 306 "project/radare2/libr/asm/arch/v850/v850_disas.c" 3 4
unsigned short 
# 306 "project/radare2/libr/asm/arch/v850/v850_disas.c"
