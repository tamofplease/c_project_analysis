# 0 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"


# 1 "project/radare2/libr/asm/arch/ebc/ebc_disas.h" 1
...
# 5 "project/radare2/libr/asm/arch/ebc/ebc_disas.h" 2
...
# 26 "project/radare2/libr/asm/arch/ebc/ebc_disas.h"
enum ebc_opcodes {
 EBC_BREAK = 0x00,
 EBC_JMP = 0x01,
 EBC_JMP8 = 0x02,
...
# 4 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 2
...
# 5 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 2

#define CHK_SNPRINTF(dst,sz,fmt,...) do { int len_chk_snprintf_ = snprintf (dst, sz, fmt, __VA_ARGS__); if (len_chk_snprintf_ >= sz) { return -1; } } while (0)
...
# 13 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
typedef int (*decode)(const 
# 86 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                           unsigned char 
# 86 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                               *, ebc_command_t *cmd);
...
# 91 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
unsigned char 
# 91 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
    a_width;
 
# 92 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
unsigned int 
# 92 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
     c;
 
# 93 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
unsigned int 
# 93 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
     n;
} ebc_index_t;

static int decode_index16(const 
# 96 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                               unsigned char 
# 96 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                   *data, ebc_index_t *index) {
 
# 97 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
unsigned short 
# 97 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
     tmp = *(
# 97 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
             unsigned short
# 97 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
 ...
 index->a_width = ((tmp >> 12) & (~(~0U << (2)))) * 2;
 index->n = tmp & (~(~0U << (index->a_width)));
 index->c = (tmp >> index->a_width) & (~(~0U << (12 - index->a_width)));
 return 0;
}

static int decode_index32(const 
# 106 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                               unsigned char 
# 106 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                   *data, ebc_index_t *index) {
 
# 107 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
unsigned int 
# 107 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
     tmp = *(
# 107 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
             unsigned int
# 107 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
 ...
 index->sign = tmp & (1ULL << 31) ? EBC_INDEX_PLUS : EBC_INDEX_MINUS;
 index->a_width = ((tmp >> 28) & (~(~0U << (2)))) * 4;
 index->n = tmp & (~(~0U << (index->a_width)));
 index->c = (tmp >> index->a_width) & (~(~0U << (28 - index->a_width)));
 return 0;
}

static int decode_index64(const 
# 116 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                               unsigned char 
# 116 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                   *data, ebc_index_t *index) {
 
# 117 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
unsigned long long 
# 117 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
     tmp = *(
# 117 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
             unsigned long long
# 117 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
 ...
 index->sign = tmp & (1ULL << 63) ? EBC_INDEX_PLUS : EBC_INDEX_MINUS;
 index->a_width = ((tmp >> 60) & (~(~0U << (2)))) * 8;
 index->n = tmp & (~(~0U << (index->a_width)));
 index->c = (tmp >> index->a_width) & (~(~0U << (60- index->a_width)));
 return 0;
}

static int decode_break(const 
# 126 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                             unsigned char 
# 126 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                 *bytes, ebc_command_t *cmd) {
 
# 127 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 127 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 127 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 127 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 127 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s", instr_names[EBC_BREAK]
# 127 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
# 127 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                                                    ;
 
# 128 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 128 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->operands
# 128 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 128 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
static int decode_jmp(const 
# 133 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                           unsigned char 
# 133 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                               *bytes, ebc_command_t *cmd) {
 int ret;
 int bits = 32;
 char op1[32] = {0};
...
# 142 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 142 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 142 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 142 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 142 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s%d%s", instr_names[EBC_JMP], bits, (bytes[1] & (1 << 7)) ? (bytes[1] & (1 << 6)) ? "cs" : "cc" : ""
# 142 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
                                                                    
# 143 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                                                   ;

 if ((bytes[0] & (1 << 6))){
  immed = *(
# 146 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
           unsigned long long
# 146 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
               *)(bytes + 2);
  bits = 64;
  ret = 10;
  
# 149 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 __builtin___snprintf_chk (
# 149 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
 cmd->operands
# 149 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 , 
# 149 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 153 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
   __builtin___snprintf_chk (
# 153 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
   op1
# 153 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
   , 
# 153 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 153 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
   , 2 > 1 ? 1 : 0), 
# 153 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
   "%sr%u ", (bytes[1] & (1 << 3)) ? "@" : "", bytes[1] & 0x7
# 153 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
   )
                                                       
# 154 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                                      ;
   }
  }
  if ((bytes[0] & (1 << 7))) {
   if ((bytes[1] & (1 << 3))) {
    ...
    do { int len_chk_snprintf_ = 
# 162 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
   __builtin___snprintf_chk (
# 162 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
   cmd->operands
# 162 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
   , 
# 162 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 162 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
   , 2 > 1 ? 1 : 0), 
# 162 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
   "%s(%c%u, %c%u)", op1, sign, idx32.n, sign, idx32.c
# 162 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
   )
# 162 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
   ; if (len_chk_snprintf_ >= 32) { return -1; } } while (0)

                                       ;
   } else {
    immed32 = *(int32_t *)(bytes + 2);
    do { int len_chk_snprintf_ = 
# 167 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
   __builtin___snprintf_chk (
# 167 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
   cmd->operands
# 167 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
   , 
# 167 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 172 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  __builtin___snprintf_chk (
# 172 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  cmd->operands
# 172 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 
# 172 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
static int decode_jmp8(const 
# 180 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                            unsigned char 
# 180 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                *bytes, ebc_command_t *cmd) {
 char suff[3] = {0};
 if ((bytes[0] & (1 << 7))) {
  const char *str = ((bytes[0] & (1 << 6)))? "cs": "cc";
  
# 184 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 __builtin___snprintf_chk (
# 184 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
 suff
# 184 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 , 
# 184 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 186 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 186 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 186 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 186 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 186 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s%s", instr_names[bytes[0] & 0x3F], suff
# 186 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
                                                 
# 187 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                                ;
 
# 188 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 188 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->operands
# 188 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 188 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
static int decode_call(const 
# 192 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                            unsigned char 
# 192 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                *bytes, ebc_command_t *cmd) {
 int ret;
 short bits = 32;
 
# 195 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
unsigned char 
# 195 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
    op1 = bytes[1] & 0x7;
 
# 196 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
unsigned int 
# 196 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
     i1;
 unsigned long i2;
 ebc_index_t idx32;
 char sign;
 ...
 if (!(bytes[0] & (1 << 6))) {
  ...
  if ((bytes[1] & (1 << 3))) {
   ...
   if ((bytes[0] & (1 << 7))) {
    ...
    do { int len_chk_snprintf_ = 
# 212 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
   __builtin___snprintf_chk (
# 212 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
   cmd->operands
# 212 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
   , 
# 212 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 212 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
   , 2 > 1 ? 1 : 0), 
# 212 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
   "@r%d(%c%u, %c%u)", op1, sign, idx32.n, sign, idx32.c
# 212 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
   )
# 212 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
   ; if (len_chk_snprintf_ >= 32) { return -1; } } while (0)
...
# 217 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
   __builtin___snprintf_chk (
# 217 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
   cmd->operands
# 217 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
   , 
# 217 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 218 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                ;
   }
  } else {
   ...
   if ((bytes[0] & (1 << 7))) {
    ...
    i1 = *(
# 224 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
          unsigned int 
# 224 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
               *)(bytes + 2);
    do { int len_chk_snprintf_ = 
# 225 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
   __builtin___snprintf_chk (
# 225 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
   cmd->operands
# 225 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
   , 
# 225 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 225 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
   ; if (len_chk_snprintf_ >= 32) { return -1; } } while (0)
    ...
    do { int len_chk_snprintf_ = 
# 230 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
   __builtin___snprintf_chk (
# 230 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
   cmd->operands
# 230 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
   , 
# 230 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 230 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  ...
  ret = 10;
  i2 = *(
# 237 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
        unsigned long long 
# 237 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
             *)&bytes[2];
  do { int len_chk_snprintf_ = 
# 238 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 __builtin___snprintf_chk (
# 238 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
 cmd->operands
# 238 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 , 
# 238 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 238 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
 ...
 do { int len_chk_snprintf_ = 
# 240 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 240 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 240 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 240 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 240 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s%d%s%s", instr_names[EBC_CALL], bits, (bytes[1] & (1 << 5)) ? "ex" : "", (bytes[1] & (1 << 4)) ? "" : "a"
# 240 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
# 240 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
; if (len_chk_snprintf_ >= 32) { return -1; } } while (0)
...
static int decode_ret(const 
# 247 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                           unsigned char 
# 247 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                               *bytes, ebc_command_t *cmd) {
 int ret = 2;
 
# 249 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 249 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 249 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 249 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
static int decode_cmp(const 
# 254 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                           unsigned char 
# 254 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                               *bytes, ebc_command_t *cmd) {
 int ret = 2;
 int op1, op2;
 char sign;
 
# 258 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
unsigned short 
# 258 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
     immed;
 ebc_index_t idx;
 ...
 if ((bytes[0] & (1 << 7))) {
  ...
  if ((bytes[1] & (1 << 7))) {
   ...
   sign = idx.sign ? '+' : '-';
   do { int len_chk_snprintf_ = 
# 269 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  __builtin___snprintf_chk (
# 269 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  cmd->operands
# 269 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 
# 269 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 269 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 2 > 1 ? 1 : 0), 
# 269 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  "r%d, @r%d (%c%d, %c%d)", op1, op2, sign, idx.n, sign, idx.c
# 269 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  )
# 269 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  ; if (len_chk_snprintf_ >= 32) { return -1; } } while (0)
   ...
   immed = *(
# 273 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
            unsigned short 
# 273 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                 *)&bytes[2];
   do { int len_chk_snprintf_ = 
# 274 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  __builtin___snprintf_chk (
# 274 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  cmd->operands
# 274 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 
# 274 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 274 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  ...
  do { int len_chk_snprintf_ = 
# 278 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 __builtin___snprintf_chk (
# 278 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
 cmd->operands
# 278 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 , 
# 278 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
static int decode_cmpeq(const 
# 285 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                             unsigned char 
# 285 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                 *bytes, ebc_command_t *cmd) {
 unsigned bits = (bytes[0] & (1 << 6))? 64: 32;
 
# 287 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 287 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 287 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 287 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 287 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s%deq", instr_names[EBC_CMPLTE], bits
# 287 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
                                 
# 288 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                ;
 return decode_cmp(bytes, cmd);
}

static int decode_cmplte(const 
# 292 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                              unsigned char 
# 292 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                  *bytes, ebc_command_t *cmd) {
 unsigned bits = (bytes[0] & (1 << 6))? 64: 32;
 
# 294 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 294 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 294 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 294 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 294 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s%dlte", instr_names[EBC_CMPLTE], bits
# 294 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
                                 
# 295 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                ;
 return decode_cmp(bytes, cmd);
}

static int decode_cmpgte(const 
# 299 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                              unsigned char 
# 299 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                  *bytes, ebc_command_t *cmd) {
 unsigned bits = (bytes[0] & (1 << 6))? 64: 32;
 
# 301 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 301 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 301 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 301 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 301 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s%dgte", instr_names[EBC_CMPGTE], bits
# 301 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
                                 
# 302 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                ;
 return decode_cmp(bytes, cmd);
}

static int decode_cmpulte(const 
# 306 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                               unsigned char 
# 306 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                   *bytes, ebc_command_t *cmd) {
 unsigned bits = (bytes[0] & (1 << 6))? 64: 32;
 
# 308 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 308 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 308 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 308 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 308 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s%dulte", instr_names[EBC_CMPULTE], bits
# 308 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
                                  
# 309 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                 ;
 return decode_cmp(bytes, cmd);
}

static int decode_cmpugte(const 
# 313 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                               unsigned char 
# 313 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                   *bytes, ebc_command_t *cmd) {
 unsigned bits = (bytes[0] & (1 << 6))? 64: 32;
 
# 315 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 315 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 315 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 315 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 315 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s%dugte", instr_names[EBC_CMPUGTE], bits
# 315 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
                                  
# 316 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                 ;
 return decode_cmp(bytes, cmd);
}

static int decode_not(const 
# 320 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                           unsigned char 
# 320 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                               *bytes, ebc_command_t *cmd) {
 int ret = 2;
 unsigned bits = (bytes[0] & (1 << 6))? 64: 32;
 unsigned op1, op2;
...
# 325 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
unsigned short 
# 325 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
     immed;

 
# 327 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 327 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 327 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 327 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 327 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s%u", instr_names[EBC_NOT], bits
# 327 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
        
# 328 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
       ;
...
# 339 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  __builtin___snprintf_chk (
# 339 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  index
# 339 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 
# 339 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 339 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 2 > 1 ? 1 : 0), 
# 339 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  " (%c%d, %c%d)", idx.sign ? '+' : '-', idx.n, idx.sign ? '+' : '-', idx.c
# 339 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  )

                                 
# 341 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                ;
  } else {
   immed = *(
# 343 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
            unsigned short
# 343 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                *)&bytes[2];
   
# 344 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  __builtin___snprintf_chk (
# 344 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  index
# 344 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 
# 344 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 344 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
 ...
 do { int len_chk_snprintf_ = 
# 348 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 348 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->operands
# 348 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 348 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 348 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%sr%d, %sr%d%s", (bytes[1] & (1 << 3)) ? "@" : "", op1, (bytes[1] & (1 << 7)) ? "@" : "", op2, index
# 348 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
# 348 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
; if (len_chk_snprintf_ >= 32) { return -1; } } while (0)
...
static int decode_neg(const 
# 354 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                           unsigned char 
# 354 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                               *bytes, ebc_command_t *cmd) {
...
static int decode_add(const 
# 361 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                           unsigned char 
# 361 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                               *bytes, ebc_command_t *cmd) {
 char sign;
 int ret = 2;
 unsigned bits = (bytes[0] & (1 << 6))? 64: 32;
...
# 367 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
unsigned short 
# 367 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
     immed;

 
# 369 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 369 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 369 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 369 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 369 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s%u", instr_names[EBC_ADD], bits
# 369 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
        
# 370 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
       ;
...
# 381 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  __builtin___snprintf_chk (
# 381 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  index
# 381 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 
# 381 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 382 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                             ;
  } else {
   immed = *(
# 384 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
            unsigned short
# 384 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                *)&bytes[2];
   
# 385 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  __builtin___snprintf_chk (
# 385 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  index
# 385 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 
# 385 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 385 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
 ...
 do { int len_chk_snprintf_ = 
# 389 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 389 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->operands
# 389 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 389 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
static int decode_sub(const 
# 395 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                           unsigned char 
# 395 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                               *bytes, ebc_command_t *cmd) {
 int ret = decode_add(bytes, cmd);
 unsigned bits = (bytes[0] & (1 << 6))? 64: 32;
 
# 398 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 398 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 398 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 398 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 398 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s%u", instr_names[EBC_SUB], bits
# 398 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
                              
# 399 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                             ;
 return ret;
}

static int decode_mul(const 
# 403 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                           unsigned char 
# 403 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                               *bytes, ebc_command_t *cmd) {
 int ret = decode_add(bytes, cmd);
 unsigned bits = (bytes[0] & (1 << 6))? 64: 32;
 
# 406 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 406 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 406 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 406 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 406 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s%u", instr_names[EBC_MUL], bits
# 406 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
                              
# 407 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                             ;
 return ret;
}

static int decode_mulu(const 
# 411 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                            unsigned char 
# 411 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                *bytes, ebc_command_t *cmd) {
 int ret = decode_add(bytes, cmd);
 unsigned bits = (bytes[0] & (1 << 6))? 64: 32;

 
# 415 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 415 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 415 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 415 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 415 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s%u", instr_names[EBC_MULU], bits
# 415 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
                               
# 416 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                              ;
 return ret;
}

static int decode_div(const 
# 420 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                           unsigned char 
# 420 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                               *bytes, ebc_command_t *cmd) {
 int ret = decode_add(bytes, cmd);
 unsigned bits = (bytes[0] & (1 << 6))? 64: 32;
 
# 423 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 423 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 423 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 423 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 423 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s%u", instr_names[EBC_DIV], bits
# 423 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
                              
# 424 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                             ;
 return ret;
}

static int decode_divu(const 
# 428 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                            unsigned char 
# 428 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                *bytes, ebc_command_t *cmd) {
 int ret = decode_add(bytes, cmd);
 unsigned bits = (bytes[0] & (1 << 6))? 64: 32;
 
# 431 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 431 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 431 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 431 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 431 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s%u", instr_names[EBC_DIVU], bits
# 431 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
                               
# 432 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                              ;
 return ret;
}

static int decode_arith(const 
# 436 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                             unsigned char 
# 436 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                 *bytes, ebc_command_t *cmd) {
 int ret = decode_add(bytes, cmd);
 unsigned bits = (bytes[0] & (1 << 6))? 64: 32;
 
# 439 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 439 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 439 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 439 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 439 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s%u", instr_names[bytes[0] & 0x3F], bits
# 439 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
                                                 
# 440 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                                ;
 return ret;
}

static int decode_mov_args(const 
# 444 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                                unsigned char 
# 444 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                    *bytes, ebc_command_t *cmd) {
 int ret = 2;
 unsigned op1, op2;
...
# 455 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 455 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
op1c
# 455 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 455 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 455 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%sr%u", (bytes[1] & (1 << 3)) ? "@" : "", op1
# 455 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
# 455 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                                                  ;
 
# 456 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 456 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
op2c
# 456 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 456 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 466 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  __builtin___snprintf_chk (
# 466 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  ind1
# 466 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 
# 466 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 466 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 2 > 1 ? 1 : 0), 
# 466 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  "(%c%u, %c%u)", sign, idx.n, sign, idx.c
# 466 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  )
                        
# 467 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                       ;
   ret += 2;
  }
  if ((bytes[0] & (1 << 6))) {
...
# 473 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  __builtin___snprintf_chk (
# 473 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  ind2
# 473 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 
# 473 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 474 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                       ;
   ret += 2;
  }
  break;
...
# 485 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  __builtin___snprintf_chk (
# 485 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  ind1
# 485 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 
# 485 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 486 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                       ;
   ret += 4;
  }
  if ((bytes[0] & (1 << 6))) {
...
# 492 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  __builtin___snprintf_chk (
# 492 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  ind2
# 492 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 
# 492 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 493 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                       ;
   ret += 4;
  }
  break;
...
# 501 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  __builtin___snprintf_chk (
# 501 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  ind1
# 501 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 
# 501 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 502 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                       ;
   ret += 8;
  }
  if ((bytes[0] & (1 << 6))) {
...
# 508 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  __builtin___snprintf_chk (
# 508 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  ind1
# 508 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 
# 508 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 509 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                       ;
   ret += 8;
  }
  break;
 ...
 do { int len_chk_snprintf_ = 
# 515 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 515 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->operands
# 515 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 515 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
static int decode_mov(const 
# 521 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                           unsigned char 
# 521 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                               *bytes, ebc_command_t *cmd) {
 
# 522 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 522 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 522 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 522 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 522 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s", instr_names[bytes[0] & 0x3F]
# 522 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
                                           
# 523 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                          ;
 return decode_mov_args(bytes, cmd);
}

static int decode_movsn_args(const 
# 527 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                                  unsigned char 
# 527 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                      *bytes, ebc_command_t *cmd) {
 int ret = 2;
 unsigned op1, op2;
...
# 536 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 536 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
op1c
# 536 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 536 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 537 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 537 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
op2c
# 537 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 537 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 546 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  __builtin___snprintf_chk (
# 546 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  ind1
# 546 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 
# 546 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 547 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                            ;
  }
  if ((bytes[0] & (1 << 6))) {
   ebc_index_t idx;
...
# 553 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  __builtin___snprintf_chk (
# 553 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  ind2
# 553 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 
# 553 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 554 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                            ;
   ret += 2;
  }
  break;
 ...
 do { int len_chk_snprintf_ = 
# 561 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 561 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->operands
# 561 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 561 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
static int decode_movsn(const 
# 566 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                             unsigned char 
# 566 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                 *bytes, ebc_command_t *cmd) {
 
# 567 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 567 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 567 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 567 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 568 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                          ;
 return decode_movsn_args(bytes, cmd);
}

static int decode_loadsp(const 
# 572 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                              unsigned char 
# 572 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                  *bytes, ebc_command_t *cmd) {
 int ret = 2;
 
# 574 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 574 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 574 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 574 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 575 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                          ;
 
# 576 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 576 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->operands
# 576 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 576 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 576 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s, r%u", dedic_regs[bytes[1] & 0x7], (bytes[1] >> 4) & 0x7
# 576 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)

                         
# 578 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                        ;
 return ret;
}

static int decode_storesp(const 
# 582 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                               unsigned char 
# 582 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                   *bytes, ebc_command_t *cmd) {
 int ret = 2;
 unsigned op2 = (bytes[1] >> 4) & 0x07;
 
# 585 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 585 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 585 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 585 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 586 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                         ;
 do { int len_chk_snprintf_ = 
# 587 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 587 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->operands
# 587 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 587 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 587 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"r%u, %s", bytes[1] & 0x7, op2 < 2 ? dedic_regs[op2] : "RESERVED_DEDICATED_REG"
# 587 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
# 587 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
; if (len_chk_snprintf_ >= 32) { return -1; } } while (0)
...
static int decode_push_pop(const 
# 593 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                                unsigned char 
# 593 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                    *bytes, ebc_command_t *cmd) {
 int ret = 2;
...
# 598 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 598 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 598 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 598 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 598 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s%u", instr_names[bytes[0] & 0x3F], (bytes[0] & (1 << 6)) ? 64 : 32
# 598 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)

                                   
# 600 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                  ;

 
# 602 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 602 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
op1c
# 602 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 602 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 602 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%sr%d", (bytes[1] & (1 << 3)) ? "@" : "", op1
# 602 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
                                        
# 603 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                       ;
 ...
 if ((bytes[0] & (1 << 7))) {
  ...
  if ((bytes[1] & (1 << 3))) {
   ...
   do { int len_chk_snprintf_ = 
# 614 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  __builtin___snprintf_chk (
# 614 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  cmd->operands
# 614 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 
# 614 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 614 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 2 > 1 ? 1 : 0), 
# 614 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  "%s (%c%d, %c%d)", op1c, sign, idx.n, sign, idx.c
# 614 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  )
# 614 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  ; if (len_chk_snprintf_ >= 32) { return -1; } } while (0)
...
# 617 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  unsigned short 
# 617 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
       immed = *(
# 617 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                 unsigned short 
# 617 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
   ...
   do { int len_chk_snprintf_ = 
# 619 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  __builtin___snprintf_chk (
# 619 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  cmd->operands
# 619 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 
# 619 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 619 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  ...
  do { int len_chk_snprintf_ = 
# 623 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 __builtin___snprintf_chk (
# 623 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
 cmd->operands
# 623 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 , 
# 623 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
static int decode_cmpi(const 
# 629 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                            unsigned char 
# 629 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                *bytes, ebc_command_t *cmd) {
 int ret = 2;
 unsigned op1 = bytes[1] & 0x07;
 char op1c[32];
...
# 637 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 637 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
op1c
# 637 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 637 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 638 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                       ;

 
# 640 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 640 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 640 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 640 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 640 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s%u%c%s", instr_names[bytes[0] & 0x3F], (bytes[0] & (1 << 6)) ? 64 : 32, (bytes[0] & (1 << 7)) ? 'd' : 'w', suff[(bytes[0] & 0x3F) - EBC_CMPIEQ]
# 640 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
...
# 645 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
   ;
...
# 655 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 __builtin___snprintf_chk (
# 655 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
 indx
# 655 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 , 
# 655 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 661 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 unsigned int 
# 661 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
      im = *(
# 661 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
             unsigned int
# 661 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 662 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 __builtin___snprintf_chk (
# 662 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
 immed
# 662 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 , 
# 662 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 665 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 unsigned short 
# 665 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
      im = *(
# 665 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
             unsigned short
# 665 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 666 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 __builtin___snprintf_chk (
# 666 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
 immed
# 666 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 , 
# 666 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 666 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
 ...
 do { int len_chk_snprintf_ = 
# 670 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 670 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->operands
# 670 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 670 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
static int decode_movn(const 
# 674 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                            unsigned char 
# 674 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                *bytes, ebc_command_t *cmd) {
 int ret = 2;
 unsigned op1 = bytes[1] & 0x07;
 unsigned op2 = (bytes[1] >> 4) & 0x07;
...
# 684 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 684 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 684 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 684 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 685 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                          ;

 
# 687 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 687 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
op1c
# 687 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 687 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 688 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 688 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
op2c
# 688 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 688 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 688 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
 ...
 if ((bytes[0] & 0x3F) == EBC_MOVNW) {
  if ((bytes[0] & (1 << 7))) {
   decode_index16(bytes + ret, &idx);
   sign = idx.sign ? '+' : '-';
   
# 694 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  __builtin___snprintf_chk (
# 694 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  indx1
# 694 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 
# 694 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 700 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  __builtin___snprintf_chk (
# 700 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  indx2
# 700 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 
# 700 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 707 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  __builtin___snprintf_chk (
# 707 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  indx1
# 707 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 
# 707 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 713 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  __builtin___snprintf_chk (
# 713 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
  indx2
# 713 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
  , 
# 713 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 713 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
 ...
 do { int len_chk_snprintf_ = 
# 718 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 718 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->operands
# 718 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 718 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
static int decode_movi(const 
# 722 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                            unsigned char 
# 722 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                *bytes, ebc_command_t *cmd) {
 int ret = 2;
 char p1 = 0, p2 = 0;
 char indx[32] = {0};
...
# 747 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 747 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 747 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 747 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 747 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s%c%c", instr_names[bytes[0] & 0x3F], p1, p2
# 747 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
                                                   
# 748 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                                  ;
...
# 757 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 __builtin___snprintf_chk (
# 757 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
 indx
# 757 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 , 
# 757 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 763 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
unsigned short 
# 763 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
     i1;
 
# 764 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
unsigned int 
# 764 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
     i2;
 
# 765 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
unsigned long long 
# 765 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
     i3;
 case 'w':
  i1 = *(
# 767 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
        unsigned short
# 767 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
            *)(bytes + ret);
 ...
 case 'd':
  i2 = *(
# 772 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
        unsigned int
# 772 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
            *)(bytes + ret);
 ...
 case 'q':
  i3 = *(
# 777 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
        unsigned long long
# 777 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
            *)(bytes + ret);
  immed = i3;
  ret += 8;
  break;
...
# 783 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 783 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
op1
# 783 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 783 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 783 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                                                              ;
 do { int len_chk_snprintf_ = 
# 784 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 784 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->operands
# 784 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 784 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
static int decode_movin(const 
# 788 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                             unsigned char 
# 788 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                 *bytes, ebc_command_t *cmd) {
 int ret = 2;
 char p1 = 0;
 char indx1[32] = {0};
...
# 808 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 808 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 808 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 808 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 808 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s%c", instr_names[bytes[0] & 0x3F], p1
# 808 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
                                               
# 809 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                              ;
...
# 816 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 __builtin___snprintf_chk (
# 816 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
 indx1
# 816 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 , 
# 816 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 817 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                      ;
...
# 839 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 839 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
indx2
# 839 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 839 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 841 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 841 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
op1
# 841 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 841 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 841 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                                                              ;
 do { int len_chk_snprintf_ = 
# 842 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 842 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->operands
# 842 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 842 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
static int decode_movrel(const 
# 846 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                              unsigned char 
# 846 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                  *bytes, ebc_command_t *cmd) {
 int ret = 2;
 char p1 = 0;
 char op1[32];
...
# 876 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 876 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->instr
# 876 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 876 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 877 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                              ;
 
# 878 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 878 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
op1
# 878 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 878 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 887 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 __builtin___snprintf_chk (
# 887 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
 indx
# 887 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
 , 
# 887 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
# 892 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
unsigned short 
# 892 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
     v16;
 
# 893 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
unsigned int 
# 893 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
     v32;
 
# 894 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
unsigned long long 
# 894 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
     v64;
 switch (p1) {
 case 'w':
  v16 = *(
# 897 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
         unsigned short 
# 897 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
              *)(bytes + 2);
  immed = v16;
  ret += 2;
  break;
 case 'd':
  v32 = *(
# 902 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
         unsigned int 
# 902 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
              *)(bytes + 2);
  immed = v32;
  ret += 4;
  break;
 case 'q':
  v64 = *(
# 907 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
         unsigned long long 
# 907 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
              *)(bytes + 2);
  immed = v64;
  ret += 8;
  break;
 ...
 do { int len_chk_snprintf_ = 
# 913 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
__builtin___snprintf_chk (
# 913 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
cmd->operands
# 913 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
, 
# 913 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
...
, 2 > 1 ? 1 : 0), 
# 913 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
"%s%s, 0x%0*lx", op1, indx, formathex, immed
# 913 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
)
# 913 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
; if (len_chk_snprintf_ >= 32) { return -1; } } while (0)
...
static int decode_invalid(const 
# 918 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                               unsigned char 
# 918 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                   *bytes, ebc_command_t *cmd) {
 return -1;
}
...
int ebc_decode_command(const 
# 983 "project/radare2/libr/asm/arch/ebc/ebc_disas.c" 3 4
                            unsigned char 
# 983 "project/radare2/libr/asm/arch/ebc/ebc_disas.c"
                                *instr, ebc_command_t *cmd) {
 if ((instr[0] & 0x3F) > 0x39) {
  {
   return -1;
  }
 }
 return decodes[instr[0] & 0x3F](instr, cmd);
}
