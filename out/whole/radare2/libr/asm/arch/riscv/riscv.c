# 0 "project/radare2/libr/asm/arch/riscv/riscv.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/arch/riscv/riscv.c"
# 21 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 22 "project/radare2/libr/asm/arch/riscv/riscv.c" 2
...
# 23 "project/radare2/libr/asm/arch/riscv/riscv.c" 2
...
# 25 "project/radare2/libr/asm/arch/riscv/riscv.c" 2
# 1 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include/stdarg.h" 1 3 4
...
#define __va_list__ 
# 26 "project/radare2/libr/asm/arch/riscv/riscv.c" 2
...
# 27 "project/radare2/libr/asm/arch/riscv/riscv.c" 2
...
# 28 "project/radare2/libr/asm/arch/riscv/riscv.c" 2
...
# 31 "project/radare2/libr/asm/arch/riscv/riscv.c" 2
# 1 "project/radare2/libr/asm/arch/riscv/riscv.h" 1
# 22 "project/radare2/libr/asm/arch/riscv/riscv.h"
#define _RISCV_H_ 
...
#define EXTRACT_RVC_IMM(x) (RV_X(x, 2, 5) | (-(long long)RV_X(x, 12, 1) << 5))

#define EXTRACT_RVC_LUI_IMM(x) (EXTRACT_RVC_IMM (x) << RISCV_IMM_BITS)

#define EXTRACT_RVC_SIMM3(x) (RV_X(x, 10, 2) | (-(long long)RV_X(x, 12, 1) << 2))

#define EXTRACT_RVC_ADDI4SPN_IMM(x) ((RV_X(x, 6, 1) << 2) | (RV_X(x, 5, 1) << 3) | (RV_X(x, 11, 2) << 4) | (RV_X(x, 7, 4) << 6))

#define EXTRACT_RVC_ADDI16SP_IMM(x) ((RV_X(x, 6, 1) << 4) | (RV_X(x, 2, 1) << 5) | (RV_X(x, 5, 1) << 6) | (RV_X(x, 3, 2) << 7) | (-(long long)RV_X(x, 12, 1) << 9))
...
#define EXTRACT_RVC_B_IMM(x) ((RV_X(x, 3, 2) << 1) | (RV_X(x, 10, 2) << 3) | (RV_X(x, 2, 1) << 5) | (RV_X(x, 5, 2) << 6) | (-(long long)RV_X(x, 12, 1) << 8))

#define EXTRACT_RVC_J_IMM(x) ((RV_X(x, 3, 3) << 1) | (RV_X(x, 11, 1) << 4) | (RV_X(x, 2, 1) << 5) | (RV_X(x, 7, 1) << 6) | (RV_X(x, 6, 1) << 7) | (RV_X(x, 9, 2) << 8) | (RV_X(x, 8, 1) << 10) | (-(long long)RV_X(x, 12, 1) << 11))
...
#define INSERT_BITS(STRUCT,VALUE,MASK,SHIFT) (STRUCT) = (((STRUCT) & ~((insn_t)(MASK) << (SHIFT))) | ((insn_t)((VALUE) & (MASK)) << (SHIFT)))
...
# 348 "project/radare2/libr/asm/arch/riscv/riscv.h"
#define NUMOPCODES bfd_riscv_num_opcodes
# 32 "project/radare2/libr/asm/arch/riscv/riscv.c" 2
...
# 42 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
__builtin___sprintf_chk (
# 42 "project/radare2/libr/asm/arch/riscv/riscv.c"
buf+strlen (buf)
# 42 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
...
# 52 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
 __builtin___sprintf_chk (
# 52 "project/radare2/libr/asm/arch/riscv/riscv.c"
 buf+strlen (buf)
# 52 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
 , 0, __builtin_object_size (
# 52 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 61 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 61 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 61 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 61 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 64 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 64 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 64 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 64 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 67 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 67 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 67 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 67 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 70 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 70 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 70 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 70 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 79 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 79 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 79 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 79 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 80 "project/radare2/libr/asm/arch/riscv/riscv.c"
                                                     ;
    break;
   case 't':
   case 'x':
    
# 84 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 84 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 84 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 84 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 85 "project/radare2/libr/asm/arch/riscv/riscv.c"
                                                     ;
    break;
   case 'U':
    
# 88 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 88 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 88 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 88 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 91 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 91 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 91 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 91 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 94 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 94 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 94 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 94 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 95 "project/radare2/libr/asm/arch/riscv/riscv.c"
                                                ;
    break;
   case 'i':
    
# 98 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 98 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 98 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 98 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 101 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 101 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 101 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 101 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 104 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 104 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 104 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 104 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 107 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 107 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 107 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 107 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 110 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 110 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 110 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 110 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 113 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 113 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 113 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 113 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 116 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 116 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 116 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 116 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 119 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 119 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 119 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 119 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 122 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 122 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 122 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 122 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 125 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 125 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 125 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 125 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 129 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 129 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 129 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 129 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 133 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 133 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 133 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 133 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 136 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 136 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 136 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 136 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 137 "project/radare2/libr/asm/arch/riscv/riscv.c"
                                                          ;
    break;
   case '>':
    
# 140 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 140 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 140 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 140 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 143 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 143 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 143 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 143 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 146 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 146 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 146 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 146 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 147 "project/radare2/libr/asm/arch/riscv/riscv.c"
                                                ;
    break;
   case 'D':
    
# 150 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 150 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 150 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 150 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 151 "project/radare2/libr/asm/arch/riscv/riscv.c"
                                                     ;
    break;
   }
   break;
...
# 157 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  __builtin___sprintf_chk (
# 157 "project/radare2/libr/asm/arch/riscv/riscv.c"
  buf+strlen (buf)
# 157 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  , 0, __builtin_object_size (
# 157 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 163 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  __builtin___sprintf_chk (
# 163 "project/radare2/libr/asm/arch/riscv/riscv.c"
  buf+strlen (buf)
# 163 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  , 0, __builtin_object_size (
# 163 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 168 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   __builtin___sprintf_chk (
# 168 "project/radare2/libr/asm/arch/riscv/riscv.c"
   buf+strlen (buf)
# 168 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
   , 0, __builtin_object_size (
# 168 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 174 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  __builtin___sprintf_chk (
# 174 "project/radare2/libr/asm/arch/riscv/riscv.c"
  buf+strlen (buf)
# 174 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  , 0, __builtin_object_size (
# 174 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 178 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  __builtin___sprintf_chk (
# 178 "project/radare2/libr/asm/arch/riscv/riscv.c"
  buf+strlen (buf)
# 178 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  , 0, __builtin_object_size (
# 178 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 179 "project/radare2/libr/asm/arch/riscv/riscv.c"
                                              ;
   break;

  case 'u':
   
# 183 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  __builtin___sprintf_chk (
# 183 "project/radare2/libr/asm/arch/riscv/riscv.c"
  buf+strlen (buf)
# 183 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  , 0, __builtin_object_size (
# 183 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 184 "project/radare2/libr/asm/arch/riscv/riscv.c"
                                                       ;
   break;
...
# 203 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  __builtin___sprintf_chk (
# 203 "project/radare2/libr/asm/arch/riscv/riscv.c"
  buf+strlen (buf)
# 203 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  , 0, __builtin_object_size (
# 203 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 206 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  __builtin___sprintf_chk (
# 206 "project/radare2/libr/asm/arch/riscv/riscv.c"
  buf+strlen (buf)
# 206 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  , 0, __builtin_object_size (
# 206 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 210 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  __builtin___sprintf_chk (
# 210 "project/radare2/libr/asm/arch/riscv/riscv.c"
  buf+strlen (buf)
# 210 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  , 0, __builtin_object_size (
# 210 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 214 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  __builtin___sprintf_chk (
# 214 "project/radare2/libr/asm/arch/riscv/riscv.c"
  buf+strlen (buf)
# 214 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  , 0, __builtin_object_size (
# 214 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 217 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  __builtin___sprintf_chk (
# 217 "project/radare2/libr/asm/arch/riscv/riscv.c"
  buf+strlen (buf)
# 217 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  , 0, __builtin_object_size (
# 217 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 220 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  __builtin___sprintf_chk (
# 220 "project/radare2/libr/asm/arch/riscv/riscv.c"
  buf+strlen (buf)
# 220 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  , 0, __builtin_object_size (
# 220 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 223 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  __builtin___sprintf_chk (
# 223 "project/radare2/libr/asm/arch/riscv/riscv.c"
  buf+strlen (buf)
# 223 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  , 0, __builtin_object_size (
# 223 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 226 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  __builtin___sprintf_chk (
# 226 "project/radare2/libr/asm/arch/riscv/riscv.c"
  buf+strlen (buf)
# 226 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  , 0, __builtin_object_size (
# 226 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 230 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  __builtin___sprintf_chk (
# 230 "project/radare2/libr/asm/arch/riscv/riscv.c"
  buf+strlen (buf)
# 230 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  , 0, __builtin_object_size (
# 230 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 233 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  __builtin___sprintf_chk (
# 233 "project/radare2/libr/asm/arch/riscv/riscv.c"
  buf+strlen (buf)
# 233 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  , 0, __builtin_object_size (
# 233 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 236 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  __builtin___sprintf_chk (
# 236 "project/radare2/libr/asm/arch/riscv/riscv.c"
  buf+strlen (buf)
# 236 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  , 0, __builtin_object_size (
# 236 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 239 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  __builtin___sprintf_chk (
# 239 "project/radare2/libr/asm/arch/riscv/riscv.c"
  buf+strlen (buf)
# 239 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  , 0, __builtin_object_size (
# 239 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 239 "project/radare2/libr/asm/arch/riscv/riscv.c"
  ...
  case 'E':
   {
    const char* csr_name = 
# 243 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
                          ((void *)0)
# 243 "project/radare2/libr/asm/arch/riscv/riscv.c"
                              ;
...
# 1 "project/radare2/libr/asm/arch/riscv/riscv-opc.h" 1
# 1057 "project/radare2/libr/asm/arch/riscv/riscv-opc.h"
...
# 249 "project/radare2/libr/asm/arch/riscv/riscv.c" 2
#undef DECLARE_CSR
     }
    if (csr_name) {
     
# 252 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
    __builtin___sprintf_chk (
# 252 "project/radare2/libr/asm/arch/riscv/riscv.c"
    buf+strlen (buf)
# 252 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
    , 0, __builtin_object_size (
# 252 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 254 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
    __builtin___sprintf_chk (
# 254 "project/radare2/libr/asm/arch/riscv/riscv.c"
    buf+strlen (buf)
# 254 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
    , 0, __builtin_object_size (
# 254 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 259 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  __builtin___sprintf_chk (
# 259 "project/radare2/libr/asm/arch/riscv/riscv.c"
  buf+strlen (buf)
# 259 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  , 0, __builtin_object_size (
# 259 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 263 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  __builtin___sprintf_chk (
# 263 "project/radare2/libr/asm/arch/riscv/riscv.c"
  buf+strlen (buf)
# 263 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
  , 0, __builtin_object_size (
# 263 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 264 "project/radare2/libr/asm/arch/riscv/riscv.c"
       ;
   return;
  }
 }
...
#define OP_HASH_IDX(i) ((i) & (riscv_insn_length (i) == 2 ? 3 : OP_MASK_OP))
 ...
 if (!init) {
  for (op=riscv_opcodes; op < &riscv_opcodes[bfd_riscv_num_opcodes]; op++) {
...
static int riscv_disassemble(RAsm *a, RAsmOp *rop, insn_t word, int xlen, int len) {
 const 
# 289 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
      _Bool 
# 289 "project/radare2/libr/asm/arch/riscv/riscv.c"
           no_alias = 
# 289 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
                      0
# 289 "project/radare2/libr/asm/arch/riscv/riscv.c"
 ...
 for (; op < &riscv_opcodes[bfd_riscv_num_opcodes]; op++) {
  if ( !(op->match_func)(op, word) ) {
   continue;
  }
  if (no_alias && (op->pinfo & 0x00000001)) {
   continue;
  }
  if (isdigit ((
# 301 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
               unsigned char
# 301 "project/radare2/libr/asm/arch/riscv/riscv.c"
                  )op->subset[0]) && atoi (op->subset) != xlen ) {
   continue;
  }
  if (op->name && op->args) {
  ...
  r_asm_op_set_asm (rop, sdb_fmt ("invalid word(%"
# 309 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
                                                 "llx"
# 309 "project/radare2/libr/asm/arch/riscv/riscv.c"
                                                        ")", (
# 309 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
                                                              unsigned long long
# 309 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
static int riscv_dis(RAsm *a, RAsmOp *rop, const 
# 315 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
                                                unsigned char 
# 315 "project/radare2/libr/asm/arch/riscv/riscv.c"
                                                    *buf, 
# 315 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
                                                          unsigned long long 
# 315 "project/radare2/libr/asm/arch/riscv/riscv.c"
...
# 320 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
__builtin___memcpy_chk (
# 320 "project/radare2/libr/asm/arch/riscv/riscv.c"
&insn
# 320 "project/radare2/libr/asm/arch/riscv/riscv.c" 3 4
, 
# 320 "project/radare2/libr/asm/arch/riscv/riscv.c"
