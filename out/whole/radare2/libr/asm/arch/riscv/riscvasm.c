# 0 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
...
# 5 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 2
...
# 6 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 2


# 7 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
...
# 40 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
((void *)0)

# 41 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
};
...
# 77 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
((void *)0)

# 78 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
};
static struct {
 
# 80 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
unsigned int 
# 80 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
     op;
 const char *name;
 char type;
 int args;
...
static int riscv_ri(
# 105 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
                   unsigned char 
# 105 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
                       *b, int op, int rt, int imm) {
 
# 106 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
unsigned int 
# 106 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
     *insn = (
# 106 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
              unsigned int
# 106 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
 ...
 *insn |= (rt << 7);
 *insn |= ((
# 109 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
           unsigned int
# 109 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
               )(imm & 0xfffff) << 12);
 return 4;
}

static int riscv_rri(
# 113 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
                    unsigned char 
# 113 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
                        *b, int op, int rs, int rt, int imm) {
 
# 114 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
unsigned int 
# 114 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
     *insn = (
# 114 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
              unsigned int
# 114 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
...
# 125 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
 fprintf(__stderrp,
# 125 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
 "Missing argument\n"
# 125 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
 )
# 125 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
 ...
 if (p[0] == '-') {
  n = (int) r_num_get (
# 142 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
                      ((void *)0)
# 142 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
                          , &p[1]);
  n = -n;
 } else {
  n = (int) r_num_get (
# 145 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
                      ((void *)0)
# 145 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
                          , p);
 }
 if (n != 0 || p[0] == '0') {
  return n;
...
# 150 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
fprintf(__stderrp,
# 150 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
...
# 154 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
                                         unsigned long long 
# 154 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
                                              pc, 
# 154 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
                                                  unsigned char 
# 154 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
...
# 184 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
    __builtin___strcpy_chk (
# 184 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
    tmp
# 184 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
    , 
# 184 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
...
# 185 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
    __builtin___strcpy_chk (
# 185 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
    w2
# 185 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
    , 
# 185 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
...
# 186 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
    __builtin___strcpy_chk (
# 186 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
    w3
# 186 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
    , 
# 186 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
...
# 190 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
    _Bool 
# 190 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
         invalid = 
# 190 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
                   0
# 190 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
     ...
     default:
      invalid = 
# 205 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
               1
# 205 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
                   ;
      break;
     }
     if (invalid) {
...
# 216 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
    __builtin___memset_chk (
# 216 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
    out
# 216 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
    , 
# 216 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
...
# 221 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
    fprintf(__stderrp,
# 221 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
    "Unknown type\n"
# 221 "project/radare2/libr/asm/arch/riscv/riscvasm.c" 3 4
    )
# 221 "project/radare2/libr/asm/arch/riscv/riscvasm.c"
