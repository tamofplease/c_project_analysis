# 0 "project/radare2/libr/asm/acode.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/asm/acode.c"
...
# 4 "project/radare2/libr/asm/acode.c" 2
...
# 5 "project/radare2/libr/asm/acode.c" 2

__attribute__((visibility("default"))) 
# 6 "project/radare2/libr/asm/acode.c"
     RAsmCode *r_asm_code_new(void) {
 return 
# 7 "project/radare2/libr/asm/acode.c" 3 4
       (
# 7 "project/radare2/libr/asm/acode.c"
       RAsmCode
# 7 "project/radare2/libr/asm/acode.c" 3 4
       *)calloc(1,sizeof(
# 7 "project/radare2/libr/asm/acode.c"
...
# 10 "project/radare2/libr/asm/acode.c" 3 4
__attribute__((visibility("default"))) 
# 10 "project/radare2/libr/asm/acode.c"
     void* r_asm_code_free(RAsmCode *acode) {
 if (acode) {
 ...
 return 
# 17 "project/radare2/libr/asm/acode.c" 3 4
       ((void *)0)
# 17 "project/radare2/libr/asm/acode.c"
           ;
}


# 20 "project/radare2/libr/asm/acode.c" 3 4
__attribute__((visibility("default"))) 
# 20 "project/radare2/libr/asm/acode.c"
     void r_asm_equ_item_free(RAsmEqu *equ) {
 if (equ) {
  free (equ->key);
  free (equ->value);
  free (equ);
...
# 29 "project/radare2/libr/asm/acode.c" 3 4
do { if (!(
# 29 "project/radare2/libr/asm/acode.c"
key && value
# 29 "project/radare2/libr/asm/acode.c" 3 4
...
"key && value"
# 29 "project/radare2/libr/asm/acode.c" 3 4
, 29); return (((void *)0)); } } while (0)
# 29 "project/radare2/libr/asm/acode.c"
                                         ;
 RAsmEqu *equ = 
# 30 "project/radare2/libr/asm/acode.c" 3 4
               (
# 30 "project/radare2/libr/asm/acode.c"
               RAsmEqu
# 30 "project/radare2/libr/asm/acode.c" 3 4
               *)calloc(1,sizeof(
# 30 "project/radare2/libr/asm/acode.c"
...
# 38 "project/radare2/libr/asm/acode.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 38 "project/radare2/libr/asm/acode.c"
          r_asm_code_set_equ(RAsmCode *code, const char *key, const char *value) {
 
# 39 "project/radare2/libr/asm/acode.c" 3 4
do { if (!(
# 39 "project/radare2/libr/asm/acode.c"
code && key && value
# 39 "project/radare2/libr/asm/acode.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 39 "project/radare2/libr/asm/acode.c"
...
# 44 "project/radare2/libr/asm/acode.c" 3 4
 if (
# 44 "project/radare2/libr/asm/acode.c"
 code->equs
# 44 "project/radare2/libr/asm/acode.c" 3 4
 ) for (
# 44 "project/radare2/libr/asm/acode.c"
...
# 44 "project/radare2/libr/asm/acode.c"
   ...
   if (!strcmp (equ->key, key)) {
    ...
    equ->value = strdup (value);
    return 
# 48 "project/radare2/libr/asm/acode.c" 3 4
          1
# 48 "project/radare2/libr/asm/acode.c"
              ;
   }
  }
 } else {
 ...
 return 
# 55 "project/radare2/libr/asm/acode.c" 3 4
       1
# 55 "project/radare2/libr/asm/acode.c"
           ;
}


# 58 "project/radare2/libr/asm/acode.c" 3 4
__attribute__((visibility("default"))) 
# 58 "project/radare2/libr/asm/acode.c"
     char *r_asm_code_equ_replace(RAsmCode *code, char *str) {
 
# 59 "project/radare2/libr/asm/acode.c" 3 4
do { if (!(
# 59 "project/radare2/libr/asm/acode.c"
code && str
# 59 "project/radare2/libr/asm/acode.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 59 "project/radare2/libr/asm/acode.c"
"code && str"
# 59 "project/radare2/libr/asm/acode.c" 3 4
, 59); return (((void *)0)); } } while (0)
# 59 "project/radare2/libr/asm/acode.c"
                                        ;
 RAsmEqu *equ;
 RListIter *iter;
 
# 62 "project/radare2/libr/asm/acode.c" 3 4
if (
# 62 "project/radare2/libr/asm/acode.c"
code->equs
# 62 "project/radare2/libr/asm/acode.c" 3 4
) for (
# 62 "project/radare2/libr/asm/acode.c"
...
# 62 "project/radare2/libr/asm/acode.c"
                                       {
  str = r_str_replace (str, equ->key, equ->value, 
# 63 "project/radare2/libr/asm/acode.c" 3 4
                                                 1
# 63 "project/radare2/libr/asm/acode.c"
                                                     );
 }
 return str;
}
...
# 68 "project/radare2/libr/asm/acode.c" 3 4
__attribute__((visibility("default"))) 
# 68 "project/radare2/libr/asm/acode.c"
     char* r_asm_code_get_hex(RAsmCode *acode) {
 
# 69 "project/radare2/libr/asm/acode.c" 3 4
do { if (!(
# 69 "project/radare2/libr/asm/acode.c"
acode
# 69 "project/radare2/libr/asm/acode.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 69 "project/radare2/libr/asm/acode.c"
