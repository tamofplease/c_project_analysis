# 0 "project/radare2/libr/fs/p/fs_posix.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/fs/p/fs_posix.c"
...
# 4 "project/radare2/libr/fs/p/fs_posix.c" 2
...
# 5 "project/radare2/libr/fs/p/fs_posix.c" 2
...
# 11 "project/radare2/libr/fs/p/fs_posix.c"
static RFSFile* fs_posix_open(RFSRoot *root, const char *path, 
# 11 "project/radare2/libr/fs/p/fs_posix.c" 3 4
                                                              _Bool 
# 11 "project/radare2/libr/fs/p/fs_posix.c"
                                                                   create) {
 FILE *fd;
 ...
 if (!file) {
  return 
# 15 "project/radare2/libr/fs/p/fs_posix.c" 3 4
        ((void *)0)
# 15 "project/radare2/libr/fs/p/fs_posix.c"
            ;
 }
 file->ptr = 
# 17 "project/radare2/libr/fs/p/fs_posix.c" 3 4
            ((void *)0)
# 17 "project/radare2/libr/fs/p/fs_posix.c"
                ;
 file->p = root->p;
 fd = r_sandbox_fopen (path, create? "wb": "rb");
 if (fd) {
  fseek (fd, 0, 
# 21 "project/radare2/libr/fs/p/fs_posix.c" 3 4
               2
# 21 "project/radare2/libr/fs/p/fs_posix.c"
                       );
  file->size = ftell (fd);
  fclose (fd);
 } else {
  r_fs_file_free (file);
  file = 
# 26 "project/radare2/libr/fs/p/fs_posix.c" 3 4
        ((void *)0)
# 26 "project/radare2/libr/fs/p/fs_posix.c"
            ;
 }
 return file;
}

static int fs_posix_read(RFSFile *file, 
# 31 "project/radare2/libr/fs/p/fs_posix.c" 3 4
                                       unsigned long long 
# 31 "project/radare2/libr/fs/p/fs_posix.c"
                                            addr, int len) {
 
# 32 "project/radare2/libr/fs/p/fs_posix.c" 3 4
{ free((void *)
# 32 "project/radare2/libr/fs/p/fs_posix.c"
file->data
# 32 "project/radare2/libr/fs/p/fs_posix.c" 3 4
); 
# 32 "project/radare2/libr/fs/p/fs_posix.c"
...
# 32 "project/radare2/libr/fs/p/fs_posix.c"
 ...
 if (abspath) {
  file->data = (void*)r_file_slurp_range (abspath, 0, len, 
# 35 "project/radare2/libr/fs/p/fs_posix.c" 3 4
                                                          ((void *)0)
# 35 "project/radare2/libr/fs/p/fs_posix.c"
                                                              );
  free (abspath);
  return len;
 }
...
static RList *fs_posix_dir(RFSRoot *root, const char *path, int view ) {
 RListIter *iter;
 struct stat st;
 char *file;
...
# 52 "project/radare2/libr/fs/p/fs_posix.c" 3 4
if (
# 52 "project/radare2/libr/fs/p/fs_posix.c"
files
# 52 "project/radare2/libr/fs/p/fs_posix.c" 3 4
) for (
# 52 "project/radare2/libr/fs/p/fs_posix.c"
...
# 53 "project/radare2/libr/fs/p/fs_posix.c" 3 4
                               ((void *)0)
# 53 "project/radare2/libr/fs/p/fs_posix.c"
                                   , file);
  if (!fsf) {
   r_list_free (list);
   r_list_free (files);
   return 
# 57 "project/radare2/libr/fs/p/fs_posix.c" 3 4
         ((void *)0)
# 57 "project/radare2/libr/fs/p/fs_posix.c"
             ;
  }
  ...
  if (!stat (fp, &st)) {
   fsf->type = 
# 63 "project/radare2/libr/fs/p/fs_posix.c" 3 4
              (((
# 63 "project/radare2/libr/fs/p/fs_posix.c"
              st.st_mode
# 63 "project/radare2/libr/fs/p/fs_posix.c" 3 4
              ) & 0170000) == 0040000)
# 63 "project/radare2/libr/fs/p/fs_posix.c"
                                  ?'d':'f';
   fsf->time = st.
# 64 "project/radare2/libr/fs/p/fs_posix.c" 3 4
                 st_atimespec.tv_sec
# 64 "project/radare2/libr/fs/p/fs_posix.c"
                         ;
  } else {
   fsf->type = 'f';
   fsf->time = 0;
...
static int fs_posix_mount(RFSRoot *root) {
 root->ptr = 
# 76 "project/radare2/libr/fs/p/fs_posix.c" 3 4
            ((void *)0)
# 76 "project/radare2/libr/fs/p/fs_posix.c"
                ;
 return 
# 77 "project/radare2/libr/fs/p/fs_posix.c" 3 4
       1
# 77 "project/radare2/libr/fs/p/fs_posix.c"
           ;
}

static void fs_posix_umount(RFSRoot *root) {
 root->ptr = 
# 81 "project/radare2/libr/fs/p/fs_posix.c" 3 4
            ((void *)0)
# 81 "project/radare2/libr/fs/p/fs_posix.c"
                ;
}
...
# 97 "project/radare2/libr/fs/p/fs_posix.c" 3 4
__attribute__((visibility("default"))) 
# 97 "project/radare2/libr/fs/p/fs_posix.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_FS,
 .data = &r_fs_plugin_posix,
 .version = 
# 100 "project/radare2/libr/fs/p/fs_posix.c" 3 4
           "5.5.4"

# 101 "project/radare2/libr/fs/p/fs_posix.c"
};
