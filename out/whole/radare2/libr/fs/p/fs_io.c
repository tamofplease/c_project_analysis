# 0 "project/radare2/libr/fs/p/fs_io.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/fs/p/fs_io.c"
...
# 4 "project/radare2/libr/fs/p/fs_io.c" 2
...
# 5 "project/radare2/libr/fs/p/fs_io.c" 2



# 7 "project/radare2/libr/fs/p/fs_io.c"
...
# 14 "project/radare2/libr/fs/p/fs_io.c" 3 4
                                                           _Bool 
# 14 "project/radare2/libr/fs/p/fs_io.c"
                                                                create) {
...
# 19 "project/radare2/libr/fs/p/fs_io.c" 3 4
{ free((void *)
# 19 "project/radare2/libr/fs/p/fs_io.c"
cmd
# 19 "project/radare2/libr/fs/p/fs_io.c" 3 4
); 
# 19 "project/radare2/libr/fs/p/fs_io.c"
...
# 21 "project/radare2/libr/fs/p/fs_io.c" 3 4
 unsigned int 
# 21 "project/radare2/libr/fs/p/fs_io.c"
      size = 0;
  if (sscanf (res, "%u", &size) != 1) {
   size = 0;
  }
  
# 25 "project/radare2/libr/fs/p/fs_io.c" 3 4
 { free((void *)
# 25 "project/radare2/libr/fs/p/fs_io.c"
 res
# 25 "project/radare2/libr/fs/p/fs_io.c" 3 4
 ); 
# 25 "project/radare2/libr/fs/p/fs_io.c"
...
# 25 "project/radare2/libr/fs/p/fs_io.c"
  ...
  if (size == 0) {
   return 
# 27 "project/radare2/libr/fs/p/fs_io.c" 3 4
         ((void *)0)
# 27 "project/radare2/libr/fs/p/fs_io.c"
             ;
  }
  RFSFile *file = r_fs_file_new (root, path);
  if (!file) {
   return 
# 31 "project/radare2/libr/fs/p/fs_io.c" 3 4
         ((void *)0)
# 31 "project/radare2/libr/fs/p/fs_io.c"
             ;
  }
  file->ptr = 
# 33 "project/radare2/libr/fs/p/fs_io.c" 3 4
             ((void *)0)
# 33 "project/radare2/libr/fs/p/fs_io.c"
                 ;
  file->p = root->p;
  file->size = size;
  return file;
 ...
 return 
# 38 "project/radare2/libr/fs/p/fs_io.c" 3 4
       ((void *)0)
# 38 "project/radare2/libr/fs/p/fs_io.c"
           ;
}

static int fs_io_read(RFSFile *file, 
# 41 "project/radare2/libr/fs/p/fs_io.c" 3 4
                                    unsigned long long 
# 41 "project/radare2/libr/fs/p/fs_io.c"
                                         addr, int len) {
 ...
 free (abs_path);
 char *cmd = r_str_newf ("mg %s 0x%08"
# 50 "project/radare2/libr/fs/p/fs_io.c" 3 4
                                     "llx"
# 50 "project/radare2/libr/fs/p/fs_io.c"
                                            " %d", enc_uri, addr, len);
 free (enc_uri);
 if (!cmd) {
  return -1;
...
# 56 "project/radare2/libr/fs/p/fs_io.c" 3 4
{ free((void *)
# 56 "project/radare2/libr/fs/p/fs_io.c"
cmd
# 56 "project/radare2/libr/fs/p/fs_io.c" 3 4
); 
# 56 "project/radare2/libr/fs/p/fs_io.c"
...
# 60 "project/radare2/libr/fs/p/fs_io.c" 3 4
  fprintf(__stderrp,
# 60 "project/radare2/libr/fs/p/fs_io.c"
  "Unexpected size (%d vs %d)\n", encoded_size, len*2
# 60 "project/radare2/libr/fs/p/fs_io.c" 3 4
  )
# 60 "project/radare2/libr/fs/p/fs_io.c"
                                                               ;
   
# 61 "project/radare2/libr/fs/p/fs_io.c" 3 4
  { free((void *)
# 61 "project/radare2/libr/fs/p/fs_io.c"
  res
# 61 "project/radare2/libr/fs/p/fs_io.c" 3 4
  ); 
# 61 "project/radare2/libr/fs/p/fs_io.c"
...
# 61 "project/radare2/libr/fs/p/fs_io.c"
  ...
  file->data = (
# 64 "project/radare2/libr/fs/p/fs_io.c" 3 4
               unsigned char 
# 64 "project/radare2/libr/fs/p/fs_io.c"
                   *) calloc (1, len);
  if (!file->data) {
   
# 66 "project/radare2/libr/fs/p/fs_io.c" 3 4
  { free((void *)
# 66 "project/radare2/libr/fs/p/fs_io.c"
  res
# 66 "project/radare2/libr/fs/p/fs_io.c" 3 4
  ); 
# 66 "project/radare2/libr/fs/p/fs_io.c"
...
# 71 "project/radare2/libr/fs/p/fs_io.c" 3 4
  fprintf(__stderrp,
# 71 "project/radare2/libr/fs/p/fs_io.c"
  "Inconsistent read\n"
# 71 "project/radare2/libr/fs/p/fs_io.c" 3 4
  )
# 71 "project/radare2/libr/fs/p/fs_io.c"
...
# 72 "project/radare2/libr/fs/p/fs_io.c" 3 4
  { free((void *)
# 72 "project/radare2/libr/fs/p/fs_io.c"
  file->data
# 72 "project/radare2/libr/fs/p/fs_io.c" 3 4
  ); 
# 72 "project/radare2/libr/fs/p/fs_io.c"
...
# 74 "project/radare2/libr/fs/p/fs_io.c" 3 4
 { free((void *)
# 74 "project/radare2/libr/fs/p/fs_io.c"
 res
# 74 "project/radare2/libr/fs/p/fs_io.c" 3 4
 ); 
# 74 "project/radare2/libr/fs/p/fs_io.c"
...
static void append_file(RList *list, const char *name, int type, int time, 
# 84 "project/radare2/libr/fs/p/fs_io.c" 3 4
                                                                          unsigned long long 
# 84 "project/radare2/libr/fs/p/fs_io.c"
                                                                               size) {
 RFSFile *fsf = r_fs_file_new (
# 85 "project/radare2/libr/fs/p/fs_io.c" 3 4
                              ((void *)0)
# 85 "project/radare2/libr/fs/p/fs_io.c"
                                  , name);
 if (!fsf) {
  return;
 }
...
static RList *fs_io_dir(RFSRoot *root, const char *path, int view ) {
 RList *list = r_list_new ();
 if (!list) {
  return 
# 98 "project/radare2/libr/fs/p/fs_io.c" 3 4
        ((void *)0)
# 98 "project/radare2/libr/fs/p/fs_io.c"
            ;
 }
...
# 120 "project/radare2/libr/fs/p/fs_io.c" 3 4
  { free((void *)
# 120 "project/radare2/libr/fs/p/fs_io.c"
  res
# 120 "project/radare2/libr/fs/p/fs_io.c" 3 4
  ); 
# 120 "project/radare2/libr/fs/p/fs_io.c"
...
# 121 "project/radare2/libr/fs/p/fs_io.c" 3 4
  { free((void *)
# 121 "project/radare2/libr/fs/p/fs_io.c"
  lines
# 121 "project/radare2/libr/fs/p/fs_io.c" 3 4
  ); 
# 121 "project/radare2/libr/fs/p/fs_io.c"
...
# 124 "project/radare2/libr/fs/p/fs_io.c" 3 4
{ free((void *)
# 124 "project/radare2/libr/fs/p/fs_io.c"
cmd
# 124 "project/radare2/libr/fs/p/fs_io.c" 3 4
); 
# 124 "project/radare2/libr/fs/p/fs_io.c"
...
static int fs_io_mount(RFSRoot *root) {
 root->ptr = 
# 129 "project/radare2/libr/fs/p/fs_io.c" 3 4
            ((void *)0)
# 129 "project/radare2/libr/fs/p/fs_io.c"
                ;
 return 
# 130 "project/radare2/libr/fs/p/fs_io.c" 3 4
       1
# 130 "project/radare2/libr/fs/p/fs_io.c"
           ;
}

static void fs_io_umount(RFSRoot *root) {
 root->ptr = 
# 134 "project/radare2/libr/fs/p/fs_io.c" 3 4
            ((void *)0)
# 134 "project/radare2/libr/fs/p/fs_io.c"
                ;
}
...
# 150 "project/radare2/libr/fs/p/fs_io.c" 3 4
__attribute__((visibility("default"))) 
# 150 "project/radare2/libr/fs/p/fs_io.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_FS,
 .data = &r_fs_plugin_io,
 .version = 
# 153 "project/radare2/libr/fs/p/fs_io.c" 3 4
           "5.5.4"

# 154 "project/radare2/libr/fs/p/fs_io.c"
};
