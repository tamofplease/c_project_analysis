# 0 "project/radare2/libr/fs/p/fs_hfsplus.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/fs/p/fs_grub_base.c" 1
...
# 4 "project/radare2/libr/fs/p/fs_grub_base.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grubfs.h" 1 3 4
...
grub_ssize_t grub_file_pb_read (grub_file_t file, void *buf, grub_size_t len,
    int total);
# 7 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grubfs.h" 2 3 4
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 8 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grubfs.h" 2 3 4
...
# 9 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grubfs.h" 2 3 4
...
void grubfs_bind_io (RIOBind *iob, unsigned long long _delta);
...
# 5 "project/radare2/libr/fs/p/fs_grub_base.c" 2




# 8 "project/radare2/libr/fs/p/fs_grub_base.c"
static RFSFile* hfsplus__open(RFSRoot *root, const char *path, 
# 8 "project/radare2/libr/fs/p/fs_grub_base.c" 3 4
                                                           _Bool 
# 8 "project/radare2/libr/fs/p/fs_grub_base.c"
                                                                create) {
 RFSFile *file = r_fs_file_new (root, path);
 GrubFS *gfs = grubfs_new (&grub_hfsplus_fs, &root->iob);
 file->ptr = gfs;
 file->p = root->p;
 grubfs_bind_io (
# 13 "project/radare2/libr/fs/p/fs_grub_base.c" 3 4
                ((void *)0)
# 13 "project/radare2/libr/fs/p/fs_grub_base.c"
                    , file->root->delta);
 if (gfs->file->fs->open (gfs->file, path)) {
  r_fs_file_free (file);
  grubfs_free (gfs);
  file = 
# 17 "project/radare2/libr/fs/p/fs_grub_base.c" 3 4
        ((void *)0)
# 17 "project/radare2/libr/fs/p/fs_grub_base.c"
            ;
 } else {
...
static int hfsplus__read(RFSFile *file, 
# 25 "project/radare2/libr/fs/p/fs_grub_base.c" 3 4
                                    unsigned long long 
# 25 "project/radare2/libr/fs/p/fs_grub_base.c"
                                         addr, int len) {
 GrubFS *gfs = file->ptr;
 grubfs_bind_io (
# 27 "project/radare2/libr/fs/p/fs_grub_base.c" 3 4
                ((void *)0)
# 27 "project/radare2/libr/fs/p/fs_grub_base.c"
                    , file->root->delta);
...
static void hfsplus__close(RFSFile *file) {
 GrubFS *gfs = file->ptr;
 gfs->file->fs->close (gfs->file);
}

static RList *list = 
# 38 "project/radare2/libr/fs/p/fs_grub_base.c" 3 4
                    ((void *)0)
# 38 "project/radare2/libr/fs/p/fs_grub_base.c"
                        ;

static int dirhook (const char *filename, const struct grub_dirhook_info *info, void *closure) {
 RFSFile *fsf = r_fs_file_new (
# 41 "project/radare2/libr/fs/p/fs_grub_base.c" 3 4
                              ((void *)0)
# 41 "project/radare2/libr/fs/p/fs_grub_base.c"
                                  , filename);
...
static RList *hfsplus__dir(RFSRoot *root, const char *path, int view) {
 GrubFS *gfs;

 if (!root)
  return 
# 55 "project/radare2/libr/fs/p/fs_grub_base.c" 3 4
        ((void *)0)
# 55 "project/radare2/libr/fs/p/fs_grub_base.c"
            ;
 ...
 grubfs_bind_io (
# 63 "project/radare2/libr/fs/p/fs_grub_base.c" 3 4
                ((void *)0)
# 63 "project/radare2/libr/fs/p/fs_grub_base.c"
                    , root->delta);
 return list;
}
...
static int hfsplus__mount(RFSRoot *root) {
 int ret;
 GrubFS *gfs = grubfs_new (&grub_hfsplus_fs, &root->iob);
 root->ptr = gfs;
 grubfs_bind_io (&root->iob, root->delta);
 ...
 ret = gfs->file->fs->dir (gfs->file->device, "/", do_nothing, 0)? 
# 76 "project/radare2/libr/fs/p/fs_grub_base.c" 3 4
                                                                  0
# 76 "project/radare2/libr/fs/p/fs_grub_base.c"
                                                                       :
# 76 "project/radare2/libr/fs/p/fs_grub_base.c" 3 4
                                                                        1
# 76 "project/radare2/libr/fs/p/fs_grub_base.c"
                                                                            ;
 grubfs_bind_io (
# 77 "project/radare2/libr/fs/p/fs_grub_base.c" 3 4
                ((void *)0)
# 77 "project/radare2/libr/fs/p/fs_grub_base.c"
                    , root->delta);
 return ret;
}

static void hfsplus__umount(RFSRoot *root) {
 grubfs_free (root->ptr);
 root->ptr = 
# 83 "project/radare2/libr/fs/p/fs_grub_base.c" 3 4
            ((void *)0)
# 83 "project/radare2/libr/fs/p/fs_grub_base.c"
                ;
}

RFSPlugin r_fs_plugin_hfsplus = {
 .name = "hfsplus",
 .desc = "HFSPLUS filesystem",
 .license = "GPL2",
 .open = hfsplus__open,
 .read = hfsplus__read,
 .close = hfsplus__close,
 .dir = hfsplus__dir,
 .mount = hfsplus__mount,
 .umount = hfsplus__umount,
};
# 11 "project/radare2/libr/fs/p/fs_hfsplus.c" 2
