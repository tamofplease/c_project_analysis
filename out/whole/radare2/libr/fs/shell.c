# 0 "project/radare2/libr/fs/shell.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/fs/shell.c"
...
# 4 "project/radare2/libr/fs/shell.c" 2

#define PROMPT_PATH_BUFSIZE 1024


# 7 "project/radare2/libr/fs/shell.c"
static 
# 7 "project/radare2/libr/fs/shell.c" 3 4
      _Bool 
# 7 "project/radare2/libr/fs/shell.c"
           handlePipes(RFS *fs, char *msg, const 
# 7 "project/radare2/libr/fs/shell.c" 3 4
                                                 unsigned char 
# 7 "project/radare2/libr/fs/shell.c"
                                                     *data, const char *cwd) {
 ...
 if (!red) {
  return 
# 10 "project/radare2/libr/fs/shell.c" 3 4
        0
# 10 "project/radare2/libr/fs/shell.c"
             ;
 }
 *red++ = 0;
 r_str_trim (msg);
...
# 20 "project/radare2/libr/fs/shell.c" 3 4
                                 1
# 20 "project/radare2/libr/fs/shell.c"
                                     );
 if (!f) {
  
# 22 "project/radare2/libr/fs/shell.c" 3 4
 fprintf(__stderrp,
# 22 "project/radare2/libr/fs/shell.c"
...
# 22 "project/radare2/libr/fs/shell.c"
  ...
  free (red);
  return 
# 24 "project/radare2/libr/fs/shell.c" 3 4
        1
# 24 "project/radare2/libr/fs/shell.c"
            ;
 }
 r_fs_write (fs, f, 0, data ? data : (
# 26 "project/radare2/libr/fs/shell.c" 3 4
                                     unsigned char
# 26 "project/radare2/libr/fs/shell.c"
                                        *)msg, strlen (data ? (char*)data : msg));
 free (red);
 r_fs_close (fs, f);
 r_fs_file_free (f);
 return 
# 30 "project/radare2/libr/fs/shell.c" 3 4
       1
# 30 "project/radare2/libr/fs/shell.c"
           ;
}


# 33 "project/radare2/libr/fs/shell.c" 3 4
__attribute__((visibility("default"))) 
# 33 "project/radare2/libr/fs/shell.c"
     int r_fs_shell_prompt(RFSShell* shell, RFS* fs, const char* root) {
 char buf[1024];
 char path[1024];
 char prompt[1024];
 char str[2048];
 ...
 const char* ptr;
 RList* list = 
# 40 "project/radare2/libr/fs/shell.c" 3 4
              ((void *)0)
# 40 "project/radare2/libr/fs/shell.c"
                  ;
 RListIter* iter;
 RFSFile* file = 
# 42 "project/radare2/libr/fs/shell.c" 3 4
                ((void *)0)
# 42 "project/radare2/libr/fs/shell.c"
                    ;

 if (root && *root) {
  
# 45 "project/radare2/libr/fs/shell.c" 3 4
 __builtin___strncpy_chk (
# 45 "project/radare2/libr/fs/shell.c"
 buf
# 45 "project/radare2/libr/fs/shell.c" 3 4
 , 
# 45 "project/radare2/libr/fs/shell.c"
...
# 45 "project/radare2/libr/fs/shell.c"
  ...
  if (
# 48 "project/radare2/libr/fs/shell.c" 3 4
     (!(
# 48 "project/radare2/libr/fs/shell.c"
     list
# 48 "project/radare2/libr/fs/shell.c" 3 4
     ) || !(
# 48 "project/radare2/libr/fs/shell.c"
...
# 48 "project/radare2/libr/fs/shell.c"
   ...
   r_list_free (list);
   return 
# 51 "project/radare2/libr/fs/shell.c" 3 4
         0
# 51 "project/radare2/libr/fs/shell.c"
              ;
  }
  r_str_ncpy (path, buf, sizeof (path) - 1);
 } else {
  
# 55 "project/radare2/libr/fs/shell.c" 3 4
 __builtin___strcpy_chk (
# 55 "project/radare2/libr/fs/shell.c"
 path
# 55 "project/radare2/libr/fs/shell.c" 3 4
 , 
# 55 "project/radare2/libr/fs/shell.c"
...
# 60 "project/radare2/libr/fs/shell.c" 3 4
 __builtin___snprintf_chk (
# 60 "project/radare2/libr/fs/shell.c"
 prompt
# 60 "project/radare2/libr/fs/shell.c" 3 4
 , 
# 60 "project/radare2/libr/fs/shell.c"
...
# 60 "project/radare2/libr/fs/shell.c"
   ...
   *shell->cwd = strdup (path);
   ...
   if (shell->readline) {
    if ((ptr = shell->readline ()) == 
# 68 "project/radare2/libr/fs/shell.c" 3 4
                                     ((void *)0)
# 68 "project/radare2/libr/fs/shell.c"
                                         ) {
     break;
    }
...
# 76 "project/radare2/libr/fs/shell.c" 3 4
                                 __stdinp
# 76 "project/radare2/libr/fs/shell.c"
                                      )) {
    break;
   }
   if (feof (
# 79 "project/radare2/libr/fs/shell.c" 3 4
            __stdinp
# 79 "project/radare2/libr/fs/shell.c"
                 )) {
    break;
   }
  }
  ...
  if (!strcmp (buf, "q") || !strcmp (buf, "exit")) {
   r_list_free (list);
   return 
# 96 "project/radare2/libr/fs/shell.c" 3 4
         1
# 96 "project/radare2/libr/fs/shell.c"
             ;
  }
  if (buf[0] == '#') {
   ...
   if (!handlePipes (fs, msg, 
# 109 "project/radare2/libr/fs/shell.c" 3 4
                             ((void *)0)
# 109 "project/radare2/libr/fs/shell.c"
                                 , path)) {
    cb_printf ("%s\n", msg);
   }
   free (msg);
...
# 118 "project/radare2/libr/fs/shell.c" 3 4
    __builtin___snprintf_chk (
# 118 "project/radare2/libr/fs/shell.c"
    str
# 118 "project/radare2/libr/fs/shell.c" 3 4
    , 
# 118 "project/radare2/libr/fs/shell.c"
...
# 129 "project/radare2/libr/fs/shell.c" 3 4
   if (
# 129 "project/radare2/libr/fs/shell.c"
   list
# 129 "project/radare2/libr/fs/shell.c" 3 4
   ) for (
# 129 "project/radare2/libr/fs/shell.c"
...
# 136 "project/radare2/libr/fs/shell.c" 3 4
  if (
# 136 "project/radare2/libr/fs/shell.c"
  fs->roots
# 136 "project/radare2/libr/fs/shell.c" 3 4
  ) for (
# 136 "project/radare2/libr/fs/shell.c"
...
# 151 "project/radare2/libr/fs/shell.c" 3 4
  fprintf(__stderrp,
# 151 "project/radare2/libr/fs/shell.c"
  "%s\n", path
# 151 "project/radare2/libr/fs/shell.c" 3 4
  )
# 151 "project/radare2/libr/fs/shell.c"
...
# 165 "project/radare2/libr/fs/shell.c" 3 4
   __builtin___strcat_chk (
# 165 "project/radare2/libr/fs/shell.c"
   path
# 165 "project/radare2/libr/fs/shell.c" 3 4
   , 
# 165 "project/radare2/libr/fs/shell.c"
...
# 167 "project/radare2/libr/fs/shell.c" 3 4
    __builtin___strncpy_chk (
# 167 "project/radare2/libr/fs/shell.c"
    path
# 167 "project/radare2/libr/fs/shell.c" 3 4
    , 
# 167 "project/radare2/libr/fs/shell.c"
    input, sizeof (opath) - 1
# 167 "project/radare2/libr/fs/shell.c" 3 4
    , __builtin_object_size (
# 167 "project/radare2/libr/fs/shell.c"
    path
...
# 173 "project/radare2/libr/fs/shell.c" 3 4
     __builtin___strcat_chk (
# 173 "project/radare2/libr/fs/shell.c"
     path
# 173 "project/radare2/libr/fs/shell.c" 3 4
     , 
# 173 "project/radare2/libr/fs/shell.c"
...
# 173 "project/radare2/libr/fs/shell.c"
   ...
   list = r_fs_dir (fs, path);
   if (
# 181 "project/radare2/libr/fs/shell.c" 3 4
      (!(
# 181 "project/radare2/libr/fs/shell.c"
      list
# 181 "project/radare2/libr/fs/shell.c" 3 4
      ) || !(
# 181 "project/radare2/libr/fs/shell.c"
...
# 184 "project/radare2/libr/fs/shell.c" 3 4
   if (
# 184 "project/radare2/libr/fs/shell.c"
   fs->roots
# 184 "project/radare2/libr/fs/shell.c" 3 4
   ) for (
# 184 "project/radare2/libr/fs/shell.c"
...
# 197 "project/radare2/libr/fs/shell.c" 3 4
    __builtin___strncpy_chk (
# 197 "project/radare2/libr/fs/shell.c"
    str
# 197 "project/radare2/libr/fs/shell.c" 3 4
    , 
# 197 "project/radare2/libr/fs/shell.c"
...
# 202 "project/radare2/libr/fs/shell.c" 3 4
   __builtin___strncpy_chk (
# 202 "project/radare2/libr/fs/shell.c"
   str
# 202 "project/radare2/libr/fs/shell.c" 3 4
   , 
# 202 "project/radare2/libr/fs/shell.c"
...
# 205 "project/radare2/libr/fs/shell.c" 3 4
  __builtin___snprintf_chk (
# 205 "project/radare2/libr/fs/shell.c"
  str + n
# 205 "project/radare2/libr/fs/shell.c" 3 4
  , 
# 205 "project/radare2/libr/fs/shell.c"
...
# 210 "project/radare2/libr/fs/shell.c" 3 4
                             0
# 210 "project/radare2/libr/fs/shell.c"
                                  );
   if (file) {
    if (p) {
     *p = '>';
...
# 224 "project/radare2/libr/fs/shell.c" 3 4
   fprintf(__stderrp,
# 224 "project/radare2/libr/fs/shell.c"
   "Cannot open file\n"
# 224 "project/radare2/libr/fs/shell.c" 3 4
   )
# 224 "project/radare2/libr/fs/shell.c"
...
# 228 "project/radare2/libr/fs/shell.c" 3 4
  if (
# 228 "project/radare2/libr/fs/shell.c"
  fs->roots
# 228 "project/radare2/libr/fs/shell.c" 3 4
  ) for (
# 228 "project/radare2/libr/fs/shell.c"
...
# 243 "project/radare2/libr/fs/shell.c" 3 4
    __builtin___strcpy_chk (
# 243 "project/radare2/libr/fs/shell.c"
    s
# 243 "project/radare2/libr/fs/shell.c" 3 4
    , 
# 243 "project/radare2/libr/fs/shell.c"
...
# 250 "project/radare2/libr/fs/shell.c" 3 4
   __builtin___strcpy_chk (
# 250 "project/radare2/libr/fs/shell.c"
   s
# 250 "project/radare2/libr/fs/shell.c" 3 4
   , 
# 250 "project/radare2/libr/fs/shell.c"
...
# 258 "project/radare2/libr/fs/shell.c" 3 4
  __builtin___strcat_chk (
# 258 "project/radare2/libr/fs/shell.c"
  s
# 258 "project/radare2/libr/fs/shell.c" 3 4
  , 
# 258 "project/radare2/libr/fs/shell.c"
...
# 259 "project/radare2/libr/fs/shell.c" 3 4
  __builtin___strcat_chk (
# 259 "project/radare2/libr/fs/shell.c"
  s
# 259 "project/radare2/libr/fs/shell.c" 3 4
  , 
# 259 "project/radare2/libr/fs/shell.c"
...
# 259 "project/radare2/libr/fs/shell.c"
                   ;
   file = r_fs_open (fs, s, 
# 260 "project/radare2/libr/fs/shell.c" 3 4
                           0
# 260 "project/radare2/libr/fs/shell.c"
                                );
   if (file) {
    r_fs_read (fs, file, 0, file->size);
...
# 268 "project/radare2/libr/fs/shell.c" 3 4
    fprintf(__stderrp,
# 268 "project/radare2/libr/fs/shell.c"
    "Cannot open file\n"
# 268 "project/radare2/libr/fs/shell.c" 3 4
    )
# 268 "project/radare2/libr/fs/shell.c"
...
# 287 "project/radare2/libr/fs/shell.c" 3 4
   fprintf(__stderrp,
# 287 "project/radare2/libr/fs/shell.c"
   "Unknown command %s\n", buf
# 287 "project/radare2/libr/fs/shell.c" 3 4
   )
# 287 "project/radare2/libr/fs/shell.c"
...
beach:
 clearerr (
# 296 "project/radare2/libr/fs/shell.c" 3 4
          __stdinp
# 296 "project/radare2/libr/fs/shell.c"
               );
 printf ("\n");
 r_list_free (list);
 return 
# 299 "project/radare2/libr/fs/shell.c" 3 4
       1
# 299 "project/radare2/libr/fs/shell.c"
           ;
}
