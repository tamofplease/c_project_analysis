# 0 "project/radare2/libr/fs/fs_file.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/fs/fs_file.c"
...
# 4 "project/radare2/libr/fs/fs_file.c" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/fs/fs_file.c"
     RFSFile* r_fs_file_new(RFSRoot* root, const char* path) {
 RFSFile* file = 
# 6 "project/radare2/libr/fs/fs_file.c" 3 4
                (
# 6 "project/radare2/libr/fs/fs_file.c"
                RFSFile
# 6 "project/radare2/libr/fs/fs_file.c" 3 4
                *)calloc(1,sizeof(
# 6 "project/radare2/libr/fs/fs_file.c"
...
# 6 "project/radare2/libr/fs/fs_file.c"
 ...
 if (!file) {
  return 
# 8 "project/radare2/libr/fs/fs_file.c" 3 4
        ((void *)0)
# 8 "project/radare2/libr/fs/fs_file.c"
            ;
 }
 file->root = root;
 if (root) {
 ...
 char *last = (char *)r_str_rchr (file->path, 
# 15 "project/radare2/libr/fs/fs_file.c" 3 4
                                             ((void *)0)
# 15 "project/radare2/libr/fs/fs_file.c"
                                                 , '/');
 if (last) {
  *last++ = 0;
...
# 25 "project/radare2/libr/fs/fs_file.c" 3 4
__attribute__((visibility("default"))) 
# 25 "project/radare2/libr/fs/fs_file.c"
     void r_fs_file_free(RFSFile* file) {
 if (file) {
  free (file->path);
  free (file->name);
  free (file->data);
...
# 34 "project/radare2/libr/fs/fs_file.c" 3 4
__attribute__((visibility("default"))) 
# 34 "project/radare2/libr/fs/fs_file.c"
     char* r_fs_file_copy_abs_path(RFSFile* file) {
 if (!file) {
  return 
# 36 "project/radare2/libr/fs/fs_file.c" 3 4
        ((void *)0)
# 36 "project/radare2/libr/fs/fs_file.c"
            ;
 }
...
# 45 "project/radare2/libr/fs/fs_file.c" 3 4
__attribute__((visibility("default"))) 
# 45 "project/radare2/libr/fs/fs_file.c"
     RFSRoot* r_fs_root_new(const char* path, 
# 45 "project/radare2/libr/fs/fs_file.c" 3 4
                                              unsigned long long 
# 45 "project/radare2/libr/fs/fs_file.c"
                                                   delta) {
 char* p;
 RFSRoot* root = 
# 47 "project/radare2/libr/fs/fs_file.c" 3 4
                (
# 47 "project/radare2/libr/fs/fs_file.c"
                RFSRoot
# 47 "project/radare2/libr/fs/fs_file.c" 3 4
                *)calloc(1,sizeof(
# 47 "project/radare2/libr/fs/fs_file.c"
...
# 47 "project/radare2/libr/fs/fs_file.c"
 ...
 if (!root) {
  return 
# 49 "project/radare2/libr/fs/fs_file.c" 3 4
        ((void *)0)
# 49 "project/radare2/libr/fs/fs_file.c"
            ;
 }
 root->path = strdup (path);
 if (!root->path) {
  
# 53 "project/radare2/libr/fs/fs_file.c" 3 4
 { free((void *)
# 53 "project/radare2/libr/fs/fs_file.c"
 root
# 53 "project/radare2/libr/fs/fs_file.c" 3 4
 ); 
# 53 "project/radare2/libr/fs/fs_file.c"
...
# 53 "project/radare2/libr/fs/fs_file.c"
              ;
  return 
# 54 "project/radare2/libr/fs/fs_file.c" 3 4
        ((void *)0)
# 54 "project/radare2/libr/fs/fs_file.c"
            ;
 }
...
# 64 "project/radare2/libr/fs/fs_file.c" 3 4
__attribute__((visibility("default"))) 
# 64 "project/radare2/libr/fs/fs_file.c"
     void r_fs_root_free(RFSRoot* root) {
 if (root) {
...
# 74 "project/radare2/libr/fs/fs_file.c" 3 4
__attribute__((visibility("default"))) 
# 74 "project/radare2/libr/fs/fs_file.c"
     RFSPartition* r_fs_partition_new(int num, 
# 74 "project/radare2/libr/fs/fs_file.c" 3 4
                                               unsigned long long 
# 74 "project/radare2/libr/fs/fs_file.c"
                                                    start, 
...
# 74 "project/radare2/libr/fs/fs_file.c"
                                                                length) {
 RFSPartition* p = 
# 75 "project/radare2/libr/fs/fs_file.c" 3 4
                  (
# 75 "project/radare2/libr/fs/fs_file.c"
                  RFSPartition
# 75 "project/radare2/libr/fs/fs_file.c" 3 4
                  *)calloc(1,sizeof(
# 75 "project/radare2/libr/fs/fs_file.c"
...
# 75 "project/radare2/libr/fs/fs_file.c"
 ...
 if (!p) {
  return 
# 77 "project/radare2/libr/fs/fs_file.c" 3 4
        ((void *)0)
# 77 "project/radare2/libr/fs/fs_file.c"
            ;
 }
 p->number = num;
 p->type = 0;
...
# 86 "project/radare2/libr/fs/fs_file.c" 3 4
__attribute__((visibility("default"))) 
# 86 "project/radare2/libr/fs/fs_file.c"
     void r_fs_partition_free(RFSPartition* p) {
 free (p);
}
