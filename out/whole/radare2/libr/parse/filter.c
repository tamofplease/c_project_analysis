# 0 "project/radare2/libr/parse/filter.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/parse/filter.c"
...
# 4 "project/radare2/libr/parse/filter.c" 2
...
# 6 "project/radare2/libr/parse/filter.c" 2
...
# 7 "project/radare2/libr/parse/filter.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/sdb/src/config.h" 1 3 4
# 8 "project/radare2/libr/parse/filter.c" 2

#define isx86separator(x) ( (x)==' '||(x)=='\t'||(x)=='\n'|| (x)=='\r'||(x)==' '|| (x)==','||(x)==';'||(x)=='['||(x)==']'|| (x)=='('||(x)==')'||(x)=='{'||(x)=='}'||(x)=='\x1b')





# 14 "project/radare2/libr/parse/filter.c"
static 
# 14 "project/radare2/libr/parse/filter.c" 3 4
      _Bool 
# 14 "project/radare2/libr/parse/filter.c"
           isvalidflag(RFlagItem *flag) {
 if (flag) {
  if (flag->space) {
   if (!strcmp (flag->space->name, "format")) {
    return 
# 18 "project/radare2/libr/parse/filter.c" 3 4
          0
# 18 "project/radare2/libr/parse/filter.c"
               ;
   }
  }
  if (strstr (flag->name, "main") || strstr (flag->name, "entry")) {
   return 
# 22 "project/radare2/libr/parse/filter.c" 3 4
         1
# 22 "project/radare2/libr/parse/filter.c"
             ;
  }
  if (strchr (flag->name, '.')) {
   return 
# 25 "project/radare2/libr/parse/filter.c" 3 4
         1
# 25 "project/radare2/libr/parse/filter.c"
             ;
  }
 }
 return 
# 28 "project/radare2/libr/parse/filter.c" 3 4
       0
# 28 "project/radare2/libr/parse/filter.c"
            ;
}

static char *findEnd(const char *s) {
 while (*s == 'x' || 
# 32 "project/radare2/libr/parse/filter.c" 3 4
                    (((
# 32 "project/radare2/libr/parse/filter.c"
                    *s
# 32 "project/radare2/libr/parse/filter.c" 3 4
                    ) >= '0' && (
# 32 "project/radare2/libr/parse/filter.c"
...
# 41 "project/radare2/libr/parse/filter.c" 3 4
__builtin___strcpy_chk (
# 41 "project/radare2/libr/parse/filter.c"
dst
# 41 "project/radare2/libr/parse/filter.c" 3 4
, 
# 41 "project/radare2/libr/parse/filter.c"
...
# 42 "project/radare2/libr/parse/filter.c" 3 4
__builtin___strcpy_chk (
# 42 "project/radare2/libr/parse/filter.c"
dst + strlen (src)
# 42 "project/radare2/libr/parse/filter.c" 3 4
, 
# 42 "project/radare2/libr/parse/filter.c"
...
# 55 "project/radare2/libr/parse/filter.c" 3 4
 __builtin___memmove_chk (
# 55 "project/radare2/libr/parse/filter.c"
 d
# 55 "project/radare2/libr/parse/filter.c" 3 4
 , 
# 55 "project/radare2/libr/parse/filter.c"
...
# 56 "project/radare2/libr/parse/filter.c" 3 4
 __builtin___memmove_chk (
# 56 "project/radare2/libr/parse/filter.c"
 p
# 56 "project/radare2/libr/parse/filter.c" 3 4
 , 
# 56 "project/radare2/libr/parse/filter.c"
...
static char *findNextNumber(char *op) {
 if (!op) {
  return 
# 63 "project/radare2/libr/parse/filter.c" 3 4
        ((void *)0)
# 63 "project/radare2/libr/parse/filter.c"
            ;
 }
 
# 65 "project/radare2/libr/parse/filter.c" 3 4
_Bool 
# 65 "project/radare2/libr/parse/filter.c"
     ansi_found = 
# 65 "project/radare2/libr/parse/filter.c" 3 4
                  0
# 65 "project/radare2/libr/parse/filter.c"
 ...
 char *p = op;
 const char *o = 
# 67 "project/radare2/libr/parse/filter.c" 3 4
                ((void *)0)
# 67 "project/radare2/libr/parse/filter.c"
                    ;
 while (*p) {
  if (p[0] == 0x1b && p[1] == '[') {
   ansi_found = 
# 70 "project/radare2/libr/parse/filter.c" 3 4
               1
# 70 "project/radare2/libr/parse/filter.c"
                   ;
   p += 2;
   for (; *p && *p != 'J' && *p != 'm' && *p != 'H'; p++) {
    ;
...
# 83 "project/radare2/libr/parse/filter.c" 3 4
  _Bool 
# 83 "project/radare2/libr/parse/filter.c"
       isSpace = ansi_found;
   ansi_found = 
# 84 "project/radare2/libr/parse/filter.c" 3 4
               0
# 84 "project/radare2/libr/parse/filter.c"
                    ;
   if (!isSpace) {
    isSpace = p == op;
    if (!isSpace && o) {
   ...
   if (*p == '[') {
    ...
    if (!
# 96 "project/radare2/libr/parse/filter.c" 3 4
        ((
# 96 "project/radare2/libr/parse/filter.c"
        *p
# 96 "project/radare2/libr/parse/filter.c" 3 4
        ) >= '0' && (
# 96 "project/radare2/libr/parse/filter.c"
...
# 96 "project/radare2/libr/parse/filter.c"
   ...
   if (isSpace) {
    if (
# 111 "project/radare2/libr/parse/filter.c" 3 4
       ((
# 111 "project/radare2/libr/parse/filter.c"
       *p
# 111 "project/radare2/libr/parse/filter.c" 3 4
       ) >= '0' && (
# 111 "project/radare2/libr/parse/filter.c"
...
# 111 "project/radare2/libr/parse/filter.c"
    ...
    if ((*p == '-') && 
# 114 "project/radare2/libr/parse/filter.c" 3 4
                      ((
# 114 "project/radare2/libr/parse/filter.c"
                      p[1]
# 114 "project/radare2/libr/parse/filter.c" 3 4
                      ) >= '0' && (
# 114 "project/radare2/libr/parse/filter.c"
...
# 114 "project/radare2/libr/parse/filter.c"
 ...
 return 
# 121 "project/radare2/libr/parse/filter.c" 3 4
       ((void *)0)
# 121 "project/radare2/libr/parse/filter.c"
           ;
}

static void __replaceRegisters(RReg *reg, char *s, 
# 124 "project/radare2/libr/parse/filter.c" 3 4
                                                  _Bool 
# 124 "project/radare2/libr/parse/filter.c"
                                                       x86) {
 int i;
 for (i = 0; i < 64; i++) {
...
static 
# 146 "project/radare2/libr/parse/filter.c" 3 4
      _Bool 
# 146 "project/radare2/libr/parse/filter.c"
           filter(RParse *p, 
# 146 "project/radare2/libr/parse/filter.c" 3 4
                             unsigned long long 
# 146 "project/radare2/libr/parse/filter.c"
                                  addr, RFlag *f, RAnalHint *hint, char *data, char *str, int len, 
# 146 "project/radare2/libr/parse/filter.c" 3 4
                                                                                                   _Bool 
# 146 "project/radare2/libr/parse/filter.c"
                                                                                                        big_endian) {
...
# 150 "project/radare2/libr/parse/filter.c" 3 4
unsigned long long 
# 150 "project/radare2/libr/parse/filter.c"
     off;
 
# 151 "project/radare2/libr/parse/filter.c" 3 4
_Bool 
# 151 "project/radare2/libr/parse/filter.c"
     x86 = 
# 151 "project/radare2/libr/parse/filter.c" 3 4
           0
# 151 "project/radare2/libr/parse/filter.c"
...
# 152 "project/radare2/libr/parse/filter.c" 3 4
_Bool 
# 152 "project/radare2/libr/parse/filter.c"
     arm = 
# 152 "project/radare2/libr/parse/filter.c" 3 4
           0
# 152 "project/radare2/libr/parse/filter.c"
 ...
 if (p && p->cur && p->cur->name) {
  if (strstr (p->cur->name, "x86")) {
   x86 = 
# 155 "project/radare2/libr/parse/filter.c" 3 4
        1
# 155 "project/radare2/libr/parse/filter.c"
            ;
  }
  if (strstr (p->cur->name, "m68k")) {
   x86 = 
# 158 "project/radare2/libr/parse/filter.c" 3 4
        1
# 158 "project/radare2/libr/parse/filter.c"
            ;
  }
  if (strstr (p->cur->name, "arm")) {
   arm = 
# 161 "project/radare2/libr/parse/filter.c" 3 4
        1
# 161 "project/radare2/libr/parse/filter.c"
            ;
  }
 }
 if (!data || !p) {
 ...
 if (p->subreg) {
  __replaceRegisters (p->analb.anal->reg, ptr, 
# 172 "project/radare2/libr/parse/filter.c" 3 4
                                              0
# 172 "project/radare2/libr/parse/filter.c"
                                                   );
  if (x86) {
   __replaceRegisters (p->analb.anal->reg, ptr, 
# 174 "project/radare2/libr/parse/filter.c" 3 4
                                               1
# 174 "project/radare2/libr/parse/filter.c"
                                                   );
  }
 }
 ptr2 = 
# 177 "project/radare2/libr/parse/filter.c" 3 4
       ((void *)0)
# 177 "project/radare2/libr/parse/filter.c"
           ;
 ...
 for (count = 0; (nptr = findNextNumber (ptr)) ; count++) {
  ptr = nptr;
  if (x86) {
   for (ptr2 = ptr; *ptr2 && !( (*ptr2)==' '||(*ptr2)=='\t'||(*ptr2)=='\n'|| (*ptr2)=='\r'||(*ptr2)==' '|| (*ptr2)==','||(*ptr2)==';'||(*ptr2)=='['||(*ptr2)==']'|| (*ptr2)=='('||(*ptr2)==')'||(*ptr2)=='{'||(*ptr2)=='}'||(*ptr2)=='\x1b'); ptr2++) {
    ;
   }
  } else {
   for (ptr2 = ptr; *ptr2 && (*ptr2 != ']' && (*ptr2 != '\x1b') && !
# 188 "project/radare2/libr/parse/filter.c" 3 4
                                                                   ((
# 188 "project/radare2/libr/parse/filter.c"
                                                                   *ptr2
# 188 "project/radare2/libr/parse/filter.c" 3 4
                                                                   ) == ' ' || (
# 188 "project/radare2/libr/parse/filter.c"
...
# 188 "project/radare2/libr/parse/filter.c"
  ...
  off = r_num_math (
# 192 "project/radare2/libr/parse/filter.c" 3 4
                   ((void *)0)
# 192 "project/radare2/libr/parse/filter.c"
                       , ptr);
  if (off >= p->minval) {
...
# 210 "project/radare2/libr/parse/filter.c" 3 4
   __builtin___snprintf_chk (
# 210 "project/radare2/libr/parse/filter.c"
   str
# 210 "project/radare2/libr/parse/filter.c" 3 4
   , 
# 210 "project/radare2/libr/parse/filter.c"
...
# 210 "project/radare2/libr/parse/filter.c" 3 4
   , 2 > 1 ? 1 : 0), 
# 210 "project/radare2/libr/parse/filter.c"
   "%s%s%s", data, name, (ptr != ptr2)? ptr2: ""
# 210 "project/radare2/libr/parse/filter.c" 3 4
   )
                             
# 211 "project/radare2/libr/parse/filter.c"
                            ;
    return 
# 212 "project/radare2/libr/parse/filter.c" 3 4
          1
# 212 "project/radare2/libr/parse/filter.c"
              ;
   }
   if (f) {
    RFlagItem *flag2;
    
# 216 "project/radare2/libr/parse/filter.c" 3 4
   _Bool 
# 216 "project/radare2/libr/parse/filter.c"
        lea = x86 && r_str_startswith (data, "lea")
      && (data[3] == ' ' || data[3] == 0x1b);
    
# 218 "project/radare2/libr/parse/filter.c" 3 4
   _Bool 
# 218 "project/radare2/libr/parse/filter.c"
        remove_brackets = 
# 218 "project/radare2/libr/parse/filter.c" 3 4
                          0
# 218 "project/radare2/libr/parse/filter.c"
    ...
    const char *label = fcn? p->label_get (fcn, off): 
# 230 "project/radare2/libr/parse/filter.c" 3 4
                                                     ((void *)0)
# 230 "project/radare2/libr/parse/filter.c"
                                                         ;
     ...
     *ptr = 0;
     ...
     if (maxflagname > 0 && strlen (flagname) > maxflagname) {
      ...
      char *token = 
# 268 "project/radare2/libr/parse/filter.c" 3 4
                   ((void *)0)
# 268 "project/radare2/libr/parse/filter.c"
                       ;
      if (doublelower && doublecolon) {
       token = 
# 270 "project/radare2/libr/parse/filter.c" 3 4
              (((
# 270 "project/radare2/libr/parse/filter.c"
              doublelower
# 270 "project/radare2/libr/parse/filter.c" 3 4
              )>(
# 270 "project/radare2/libr/parse/filter.c"
...
# 291 "project/radare2/libr/parse/filter.c" 3 4
    __builtin___snprintf_chk (
# 291 "project/radare2/libr/parse/filter.c"
    str
# 291 "project/radare2/libr/parse/filter.c" 3 4
    , 
# 291 "project/radare2/libr/parse/filter.c"
...
# 293 "project/radare2/libr/parse/filter.c" 3 4
    _Bool 
# 293 "project/radare2/libr/parse/filter.c"
         banned = 
# 293 "project/radare2/libr/parse/filter.c" 3 4
                  0
# 293 "project/radare2/libr/parse/filter.c"
                       ;
     {
      ...
      if (p && (a || m)) {
       banned = 
# 299 "project/radare2/libr/parse/filter.c" 3 4
               1
# 299 "project/radare2/libr/parse/filter.c"
                   ;
      }
     }
     if (p->subrel_addr && !banned && lea) {
      int flag_len = strlen (flag->name);
      char *ptr_end = str + strlen (data) + flag_len - 1;
      char *ptr_right = ptr_end + 1, *ptr_left, *ptr_esc;
      
# 306 "project/radare2/libr/parse/filter.c" 3 4
     _Bool 
# 306 "project/radare2/libr/parse/filter.c"
          ansi_found = 
# 306 "project/radare2/libr/parse/filter.c" 3 4
                       0
# 306 "project/radare2/libr/parse/filter.c"
      ...
      if (!*ptr_end) {
       return 
# 308 "project/radare2/libr/parse/filter.c" 3 4
             1
# 308 "project/radare2/libr/parse/filter.c"
                 ;
      }
      while (*ptr_right) {
       if (*ptr_right == 0x1b) {
        ...
        ansi_found = 
# 318 "project/radare2/libr/parse/filter.c" 3 4
                    1
# 318 "project/radare2/libr/parse/filter.c"
                        ;
        continue;
       }
       if (*ptr_right == ']') {
...
# 343 "project/radare2/libr/parse/filter.c" 3 4
       __builtin___memmove_chk (
# 343 "project/radare2/libr/parse/filter.c"
       ptr_left
# 343 "project/radare2/libr/parse/filter.c" 3 4
       , 
# 343 "project/radare2/libr/parse/filter.c"
...
# 343 "project/radare2/libr/parse/filter.c"
                                              ;
        char *dptr_left = 
# 344 "project/radare2/libr/parse/filter.c" 3 4
                         __builtin___strcpy_chk (
# 344 "project/radare2/libr/parse/filter.c"
                         ptr_left + copied_len
# 344 "project/radare2/libr/parse/filter.c" 3 4
                         , 
# 344 "project/radare2/libr/parse/filter.c"
                         (ansi_found && ptr_right - ptr_end + 1 >= 4) ? 
# 344 "project/radare2/libr/parse/filter.c" 3 4
                         "\x1b[0m" 
# 344 "project/radare2/libr/parse/filter.c"
                         : ""
...
# 345 "project/radare2/libr/parse/filter.c"
                                                                         ;
...
# 353 "project/radare2/libr/parse/filter.c" 3 4
       __builtin___memmove_chk (
# 353 "project/radare2/libr/parse/filter.c"
       dptr_left
# 353 "project/radare2/libr/parse/filter.c" 3 4
       , 
# 353 "project/radare2/libr/parse/filter.c"
...
# 353 "project/radare2/libr/parse/filter.c"
     ...
     return 
# 359 "project/radare2/libr/parse/filter.c" 3 4
           1
# 359 "project/radare2/libr/parse/filter.c"
               ;
    }
    if (p->subtail) {
     if (off != 
# 362 "project/radare2/libr/parse/filter.c" 3 4
               0xFFFFFFFFFFFFFFFFULL
# 362 "project/radare2/libr/parse/filter.c"
                       ) {
      if (off == addr) {
       insert (ptr, "$$");
      } else {
       
# 366 "project/radare2/libr/parse/filter.c" 3 4
      unsigned long long 
# 366 "project/radare2/libr/parse/filter.c"
           tail = r_num_tail_base (
# 366 "project/radare2/libr/parse/filter.c" 3 4
                                   ((void *)0)
# 366 "project/radare2/libr/parse/filter.c"
                                       , addr, off);
       if (tail != 
# 367 "project/radare2/libr/parse/filter.c" 3 4
                  0xFFFFFFFFFFFFFFFFULL
# 367 "project/radare2/libr/parse/filter.c"
                          ) {
        char str[128];
        
# 369 "project/radare2/libr/parse/filter.c" 3 4
       __builtin___snprintf_chk (
# 369 "project/radare2/libr/parse/filter.c"
       str
# 369 "project/radare2/libr/parse/filter.c" 3 4
       , 
# 369 "project/radare2/libr/parse/filter.c"
...
# 385 "project/radare2/libr/parse/filter.c" 3 4
  _Bool 
# 385 "project/radare2/libr/parse/filter.c"
       is_hex = 
# 385 "project/radare2/libr/parse/filter.c" 3 4
                0
# 385 "project/radare2/libr/parse/filter.c"
...
# 389 "project/radare2/libr/parse/filter.c" 3 4
   __builtin___snprintf_chk (
# 389 "project/radare2/libr/parse/filter.c"
   str
# 389 "project/radare2/libr/parse/filter.c" 3 4
   , 
# 389 "project/radare2/libr/parse/filter.c"
...
# 389 "project/radare2/libr/parse/filter.c" 3 4
   , 2 > 1 ? 1 : 0), 
# 389 "project/radare2/libr/parse/filter.c"
   "%s%s%s", data, hint->offset, (ptr != ptr2)? ptr2: ""
# 389 "project/radare2/libr/parse/filter.c" 3 4
   )
# 389 "project/radare2/libr/parse/filter.c"
                                                                             ;
    return 
# 390 "project/radare2/libr/parse/filter.c" 3 4
          1
# 390 "project/radare2/libr/parse/filter.c"
              ;
   }
   
# 392 "project/radare2/libr/parse/filter.c" 3 4
  __builtin___strncpy_chk (
# 392 "project/radare2/libr/parse/filter.c"
  num
# 392 "project/radare2/libr/parse/filter.c" 3 4
  , 
# 392 "project/radare2/libr/parse/filter.c"
...
# 392 "project/radare2/libr/parse/filter.c"
   ...
   if (!strncmp (pnum, "0x", 2)) {
    is_hex = 
# 395 "project/radare2/libr/parse/filter.c" 3 4
            1
# 395 "project/radare2/libr/parse/filter.c"
                ;
    pnum += 2;
   }
   for (; *pnum; pnum++) {
    if ((is_hex && 
# 399 "project/radare2/libr/parse/filter.c" 3 4
                  (((
# 399 "project/radare2/libr/parse/filter.c"
                  *pnum
# 399 "project/radare2/libr/parse/filter.c" 3 4
                  ) >= '0' && (
# 399 "project/radare2/libr/parse/filter.c"
...
# 427 "project/radare2/libr/parse/filter.c" 3 4
   __builtin___memset_chk (
# 427 "project/radare2/libr/parse/filter.c"
   num
# 427 "project/radare2/libr/parse/filter.c" 3 4
   , 
# 427 "project/radare2/libr/parse/filter.c"
...
# 435 "project/radare2/libr/parse/filter.c" 3 4
    unsigned char 
# 435 "project/radare2/libr/parse/filter.c"
        ch;
     if (big_endian) {
      ch = off & 0xff;
      off >>= 8;
     ...
     if (
# 448 "project/radare2/libr/parse/filter.c" 3 4
        ((
# 448 "project/radare2/libr/parse/filter.c"
        ch
# 448 "project/radare2/libr/parse/filter.c" 3 4
        ) >=' ' && (
# 448 "project/radare2/libr/parse/filter.c"
...
# 448 "project/radare2/libr/parse/filter.c"
      ...
      *pnum++ = ch;
      ...
      int sz = 
# 452 "project/radare2/libr/parse/filter.c" 3 4
              __builtin___snprintf_chk (
# 452 "project/radare2/libr/parse/filter.c"
              pnum
# 452 "project/radare2/libr/parse/filter.c" 3 4
              , 
# 452 "project/radare2/libr/parse/filter.c"
...
# 465 "project/radare2/libr/parse/filter.c" 3 4
   __builtin___strcat_chk (
# 465 "project/radare2/libr/parse/filter.c"
   num
# 465 "project/radare2/libr/parse/filter.c" 3 4
   , 
# 465 "project/radare2/libr/parse/filter.c"
...
# 469 "project/radare2/libr/parse/filter.c" 3 4
    unsigned long long 
# 469 "project/radare2/libr/parse/filter.c"
         swap = 0;
     if (big_endian) {
      swap = off & 0xffff;
     } else {
      if (off >> 32) {
       r_mem_swapendian ((
# 474 "project/radare2/libr/parse/filter.c" 3 4
                         unsigned char
# 474 "project/radare2/libr/parse/filter.c"
                            *)&swap, (const 
# 474 "project/radare2/libr/parse/filter.c" 3 4
                                            unsigned char
# 474 "project/radare2/libr/parse/filter.c"
...
# 476 "project/radare2/libr/parse/filter.c" 3 4
      unsigned int 
# 476 "project/radare2/libr/parse/filter.c"
           port = 0;
       r_mem_swapendian ((
# 477 "project/radare2/libr/parse/filter.c" 3 4
                         unsigned char
# 477 "project/radare2/libr/parse/filter.c"
                            *)&port, (const 
# 477 "project/radare2/libr/parse/filter.c" 3 4
                                            unsigned char
# 477 "project/radare2/libr/parse/filter.c"
...
# 480 "project/radare2/libr/parse/filter.c" 3 4
      unsigned short 
# 480 "project/radare2/libr/parse/filter.c"
           port = 0;
       r_mem_swapendian ((
# 481 "project/radare2/libr/parse/filter.c" 3 4
                         unsigned char
# 481 "project/radare2/libr/parse/filter.c"
                            *)&port, (const 
# 481 "project/radare2/libr/parse/filter.c" 3 4
                                            unsigned char
# 481 "project/radare2/libr/parse/filter.c"
...
# 485 "project/radare2/libr/parse/filter.c" 3 4
    __builtin___snprintf_chk (
# 485 "project/radare2/libr/parse/filter.c"
    num
# 485 "project/radare2/libr/parse/filter.c" 3 4
    , 
# 485 "project/radare2/libr/parse/filter.c"
...
# 489 "project/radare2/libr/parse/filter.c" 3 4
   __builtin___snprintf_chk (
# 489 "project/radare2/libr/parse/filter.c"
   num
# 489 "project/radare2/libr/parse/filter.c" 3 4
   , 
# 489 "project/radare2/libr/parse/filter.c"
...
# 496 "project/radare2/libr/parse/filter.c" 3 4
    _Bool 
# 496 "project/radare2/libr/parse/filter.c"
         imm32 = 
# 496 "project/radare2/libr/parse/filter.c" 3 4
                 0
# 496 "project/radare2/libr/parse/filter.c"
...
# 497 "project/radare2/libr/parse/filter.c" 3 4
    if (
# 497 "project/radare2/libr/parse/filter.c"
    regs
# 497 "project/radare2/libr/parse/filter.c" 3 4
    ) for (
# 497 "project/radare2/libr/parse/filter.c"
...
# 497 "project/radare2/libr/parse/filter.c"
      ...
      if (reg->size == 32 && r_str_casestr (data, reg->name)) {
       imm32 = 
# 499 "project/radare2/libr/parse/filter.c" 3 4
              1
# 499 "project/radare2/libr/parse/filter.c"
                  ;
       break;
      }
     }
...
# 504 "project/radare2/libr/parse/filter.c" 3 4
     __builtin___snprintf_chk (
# 504 "project/radare2/libr/parse/filter.c"
     num
# 504 "project/radare2/libr/parse/filter.c" 3 4
     , 
# 504 "project/radare2/libr/parse/filter.c"
...
# 507 "project/radare2/libr/parse/filter.c" 3 4
    __builtin___snprintf_chk (
# 507 "project/radare2/libr/parse/filter.c"
    num
# 507 "project/radare2/libr/parse/filter.c" 3 4
    , 
# 507 "project/radare2/libr/parse/filter.c"
...
# 511 "project/radare2/libr/parse/filter.c" 3 4
   __builtin___snprintf_chk (
# 511 "project/radare2/libr/parse/filter.c"
   num
# 511 "project/radare2/libr/parse/filter.c" 3 4
   , 
# 511 "project/radare2/libr/parse/filter.c"
...
# 515 "project/radare2/libr/parse/filter.c" 3 4
    unsigned int 
# 515 "project/radare2/libr/parse/filter.c"
         ip32 = off;
     
# 516 "project/radare2/libr/parse/filter.c" 3 4
    unsigned char 
# 516 "project/radare2/libr/parse/filter.c"
        *ip = (
# 516 "project/radare2/libr/parse/filter.c" 3 4
               unsigned char
# 516 "project/radare2/libr/parse/filter.c"
...
# 517 "project/radare2/libr/parse/filter.c" 3 4
    __builtin___snprintf_chk (
# 517 "project/radare2/libr/parse/filter.c"
    num
# 517 "project/radare2/libr/parse/filter.c" 3 4
    , 
# 517 "project/radare2/libr/parse/filter.c"
...
# 524 "project/radare2/libr/parse/filter.c" 3 4
     __builtin___snprintf_chk (
# 524 "project/radare2/libr/parse/filter.c"
     num
# 524 "project/radare2/libr/parse/filter.c" 3 4
     , 
# 524 "project/radare2/libr/parse/filter.c"
...
# 526 "project/radare2/libr/parse/filter.c" 3 4
     __builtin___snprintf_chk (
# 526 "project/radare2/libr/parse/filter.c"
     num
# 526 "project/radare2/libr/parse/filter.c" 3 4
     , 
# 526 "project/radare2/libr/parse/filter.c"
...
# 534 "project/radare2/libr/parse/filter.c" 3 4
   __builtin___snprintf_chk (
# 534 "project/radare2/libr/parse/filter.c"
   num
# 534 "project/radare2/libr/parse/filter.c" 3 4
   , 
# 534 "project/radare2/libr/parse/filter.c"
...
# 538 "project/radare2/libr/parse/filter.c" 3 4
  __builtin___snprintf_chk (
# 538 "project/radare2/libr/parse/filter.c"
  str
# 538 "project/radare2/libr/parse/filter.c" 3 4
  , 
# 538 "project/radare2/libr/parse/filter.c"
...
# 538 "project/radare2/libr/parse/filter.c" 3 4
  , 2 > 1 ? 1 : 0), 
# 538 "project/radare2/libr/parse/filter.c"
  "%s%s%s", data, num, (ptr != ptr2)? ptr2: ""
# 538 "project/radare2/libr/parse/filter.c" 3 4
  )
# 538 "project/radare2/libr/parse/filter.c"
                                                                   ;
   return 
# 539 "project/radare2/libr/parse/filter.c" 3 4
         1
# 539 "project/radare2/libr/parse/filter.c"
             ;
  }
  ptr = ptr2;
 }
...
# 544 "project/radare2/libr/parse/filter.c" 3 4
 __builtin___strncpy_chk (
# 544 "project/radare2/libr/parse/filter.c"
 str
# 544 "project/radare2/libr/parse/filter.c" 3 4
 , 
# 544 "project/radare2/libr/parse/filter.c"
...
# 546 "project/radare2/libr/parse/filter.c" 3 4
 fprintf(__stderrp,
# 546 "project/radare2/libr/parse/filter.c"
...
# 546 "project/radare2/libr/parse/filter.c"
 ...
 return 
# 548 "project/radare2/libr/parse/filter.c" 3 4
       0
# 548 "project/radare2/libr/parse/filter.c"
            ;
}
...
# 557 "project/radare2/libr/parse/filter.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 557 "project/radare2/libr/parse/filter.c"
          r_parse_filter(RParse *p, 
# 557 "project/radare2/libr/parse/filter.c" 3 4
                                    unsigned long long 
# 557 "project/radare2/libr/parse/filter.c"
                                         addr, RFlag *f, RAnalHint *hint, char *data, char *str, int len, 
...
# 557 "project/radare2/libr/parse/filter.c"
 ...
 return 
# 562 "project/radare2/libr/parse/filter.c" 3 4
       0
# 562 "project/radare2/libr/parse/filter.c"
            ;
}



# 566 "project/radare2/libr/parse/filter.c" 3 4
__attribute__((visibility("default"))) 
# 566 "project/radare2/libr/parse/filter.c"
     char *r_parse_filter_dup(RParse *p, 
# 566 "project/radare2/libr/parse/filter.c" 3 4
                                         unsigned long long 
# 566 "project/radare2/libr/parse/filter.c"
                                              addr, const char *opstr) {
 const size_t out_len = 256;
 char *in = strdup (opstr);
 char *out = calloc (out_len, 1);
 if (!r_parse_filter (p, addr, 
# 570 "project/radare2/libr/parse/filter.c" 3 4
                              ((void *)0)
# 570 "project/radare2/libr/parse/filter.c"
                                  , 
# 570 "project/radare2/libr/parse/filter.c" 3 4
                                    ((void *)0)
# 570 "project/radare2/libr/parse/filter.c"
...
# 570 "project/radare2/libr/parse/filter.c"
  ...
  free (out);
  return 
# 572 "project/radare2/libr/parse/filter.c" 3 4
        ((void *)0)
# 572 "project/radare2/libr/parse/filter.c"
            ;
 }
 return out;
}
