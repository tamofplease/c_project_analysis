# 0 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
...
# 4 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 2
...
# 5 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 2
...
# 6 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 2
...
# 8 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 2
...
# 9 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 2
...
# 10 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 2
...
# 11 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 2
...
# 12 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 2


# 13 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
static int replace(int argc, const char *argv[], char *newstr) {
 ...
 struct {
  ...
  { "xor.b", "B ^= A"},
  { 
# 124 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
   ((void *)0) 
# 124 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
        }
 };

 for (i = 0; ops[i].op != 
# 127 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
                         ((void *)0)
# 127 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
                             ; i++) {
  if (!strcmp (ops[i].op, argv[0])) {
   if (newstr != 
# 129 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
                ((void *)0)
# 129 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
                    ) {
    for (j = k = 0; ops[i].str[j] != '\0'; j++, k++) {
     if (ops[i].str[j] >= 'A' && ops[i].str[j] <= 'J') {
      const char *w = argv[ops[i].str[j] - '@'];
      if (w != 
# 133 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
              ((void *)0)
# 133 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
                  ) {
       
# 134 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
      __builtin___strcpy_chk (
# 134 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
      newstr + k
# 134 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
      , 
# 134 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
...
# 134 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
   ...
   return 
# 143 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
         1
# 143 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
             ;
  }
 }
 ...
 if (newstr != 
# 148 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
              ((void *)0)
# 148 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
                  ) {
  newstr[0] = '\0';
  for (i = 0; i < argc; i++) {
   
# 151 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
  __builtin___strcat_chk (
# 151 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
  newstr
# 151 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
  , 
# 151 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
...
# 152 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
  __builtin___strcat_chk (
# 152 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
  newstr
# 152 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
  , 
# 152 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
...
# 152 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
 ...
 return 
# 156 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
       0
# 156 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
            ;
}
...
static int parse(RParse *p, const char *data, char *str) {
 ...
 if (!(buf = malloc (len + 1))) {
  return 
# 171 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
        0
# 171 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
             ;
 }
 
# 173 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
__builtin___memcpy_chk (
# 173 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
buf
# 173 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
, 
# 173 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
...
# 191 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
  __builtin___strncpy_chk (
# 191 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
  w0
# 191 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
  , 
# 191 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
...
# 192 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
  __builtin___strncpy_chk (
# 192 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
  w1
# 192 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
  , 
# 192 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
...
# 209 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
   __builtin___strncpy_chk (
# 209 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
   w1
# 209 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
   , 
# 209 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
...
# 210 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
   __builtin___strncpy_chk (
# 210 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
   w2
# 210 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
   , 
# 210 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
...
# 226 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
    __builtin___strncpy_chk (
# 226 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
    w2
# 226 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
    , 
# 226 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
...
# 227 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
    __builtin___strncpy_chk (
# 227 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
    w3
# 227 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
    , 
# 227 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
...
# 244 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
     __builtin___strncpy_chk (
# 244 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
     w3
# 244 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
     , 
# 244 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
...
# 245 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
     __builtin___strncpy_chk (
# 245 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
     w4
# 245 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
     , 
# 245 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
...
# 250 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
  __builtin___strncpy_chk (
# 250 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
  w0
# 250 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
  , 
# 250 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
...
# 250 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
 ...
 free (buf);
 return 
# 264 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
       1
# 264 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
           ;
}
...
# 274 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
__attribute__((visibility("default"))) 
# 274 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_PARSE,
 .data = &r_parse_plugin_sh_pseudo,
 .version = 
# 277 "project/radare2/libr/parse/p/parse_sh_pseudo.c" 3 4
           "5.5.4"

# 278 "project/radare2/libr/parse/p/parse_sh_pseudo.c"
};
