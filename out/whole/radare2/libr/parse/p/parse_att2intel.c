# 0 "project/radare2/libr/parse/p/parse_att2intel.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/parse/p/parse_att2intel.c"
...
# 4 "project/radare2/libr/parse/p/parse_att2intel.c" 2
...
# 5 "project/radare2/libr/parse/p/parse_att2intel.c" 2
...
# 6 "project/radare2/libr/parse/p/parse_att2intel.c" 2
...
# 8 "project/radare2/libr/parse/p/parse_att2intel.c" 2
...
# 9 "project/radare2/libr/parse/p/parse_att2intel.c" 2
...
# 10 "project/radare2/libr/parse/p/parse_att2intel.c" 2
...
# 11 "project/radare2/libr/parse/p/parse_att2intel.c" 2
...
# 12 "project/radare2/libr/parse/p/parse_att2intel.c" 2


# 13 "project/radare2/libr/parse/p/parse_att2intel.c"
static int replace(int argc, const char *argv[], char *newstr) {
 ...
 struct {
  ...
  { "ret", "ret"},
  { 
# 35 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
   ((void *)0) 
# 35 "project/radare2/libr/parse/p/parse_att2intel.c"
        }
 };

 for (i = 0; ops[i].op != 
# 38 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
                         ((void *)0)
# 38 "project/radare2/libr/parse/p/parse_att2intel.c"
                             ; i++) {
  if (!strcmp (ops[i].op, argv[0])) {
   if (newstr != 
# 40 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
                ((void *)0)
# 40 "project/radare2/libr/parse/p/parse_att2intel.c"
                    ) {
    for (j = k = 0; ops[i].str[j] != '\0'; j++, k++) {
     if (ops[i].str[j] >= '0' && ops[i].str[j] <= '9') {
      const char *w = argv[ops[i].str[j] - '0'];
      if (w != 
# 44 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
              ((void *)0)
# 44 "project/radare2/libr/parse/p/parse_att2intel.c"
                  ) {
       
# 45 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
      __builtin___strcpy_chk (
# 45 "project/radare2/libr/parse/p/parse_att2intel.c"
      newstr + k
# 45 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
      , 
# 45 "project/radare2/libr/parse/p/parse_att2intel.c"
...
# 45 "project/radare2/libr/parse/p/parse_att2intel.c"
   ...
   return 
# 54 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
         1
# 54 "project/radare2/libr/parse/p/parse_att2intel.c"
             ;
  }
 }
 ...
 if (newstr != 
# 59 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
              ((void *)0)
# 59 "project/radare2/libr/parse/p/parse_att2intel.c"
                  ) {
  newstr[0] = '\0';
  for (i=0; i<argc; i++) {
   
# 62 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
  __builtin___strcat_chk (
# 62 "project/radare2/libr/parse/p/parse_att2intel.c"
  newstr
# 62 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
  , 
# 62 "project/radare2/libr/parse/p/parse_att2intel.c"
...
# 63 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
  __builtin___strcat_chk (
# 63 "project/radare2/libr/parse/p/parse_att2intel.c"
  newstr
# 63 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
  , 
# 63 "project/radare2/libr/parse/p/parse_att2intel.c"
...
# 63 "project/radare2/libr/parse/p/parse_att2intel.c"
 ...
 return 
# 67 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
       0
# 67 "project/radare2/libr/parse/p/parse_att2intel.c"
            ;
}
...
static int parse(RParse *p, const char *data, char *str) {
 ...
 if (!buf) {
  return 
# 81 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
        0
# 81 "project/radare2/libr/parse/p/parse_att2intel.c"
             ;
 }
 r_str_trim_head (buf);
...
# 92 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
 __builtin___strcpy_chk (
# 92 "project/radare2/libr/parse/p/parse_att2intel.c"
 str
# 92 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
 , 
# 92 "project/radare2/libr/parse/p/parse_att2intel.c"
...
# 92 "project/radare2/libr/parse/p/parse_att2intel.c"
                   ;
  return 
# 93 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
        1
# 93 "project/radare2/libr/parse/p/parse_att2intel.c"
            ;
 }
...
# 110 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
  __builtin___memmove_chk ((
# 110 "project/radare2/libr/parse/p/parse_att2intel.c"
  num + 1
# 110 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
  ), (
# 110 "project/radare2/libr/parse/p/parse_att2intel.c"
...
# 115 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
   __builtin___snprintf_chk (
# 115 "project/radare2/libr/parse/p/parse_att2intel.c"
   ptr
# 115 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
   , 
# 115 "project/radare2/libr/parse/p/parse_att2intel.c"
...
# 134 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
  __builtin___strncpy_chk (
# 134 "project/radare2/libr/parse/p/parse_att2intel.c"
  w0
# 134 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
  , 
# 134 "project/radare2/libr/parse/p/parse_att2intel.c"
...
# 135 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
  __builtin___strncpy_chk (
# 135 "project/radare2/libr/parse/p/parse_att2intel.c"
  w1
# 135 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
  , 
# 135 "project/radare2/libr/parse/p/parse_att2intel.c"
...
# 144 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
   __builtin___strncpy_chk (
# 144 "project/radare2/libr/parse/p/parse_att2intel.c"
   w1
# 144 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
   , 
# 144 "project/radare2/libr/parse/p/parse_att2intel.c"
...
# 145 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
   __builtin___strncpy_chk (
# 145 "project/radare2/libr/parse/p/parse_att2intel.c"
   w2
# 145 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
   , 
# 145 "project/radare2/libr/parse/p/parse_att2intel.c"
...
# 152 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
    __builtin___strncpy_chk (
# 152 "project/radare2/libr/parse/p/parse_att2intel.c"
    w2
# 152 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
    , 
# 152 "project/radare2/libr/parse/p/parse_att2intel.c"
...
# 153 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
    __builtin___strncpy_chk (
# 153 "project/radare2/libr/parse/p/parse_att2intel.c"
    w3
# 153 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
    , 
# 153 "project/radare2/libr/parse/p/parse_att2intel.c"
...
# 153 "project/radare2/libr/parse/p/parse_att2intel.c"
 ...
 free (buf);
 return 
# 169 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
       1
# 169 "project/radare2/libr/parse/p/parse_att2intel.c"
           ;
}
...
RParsePlugin r_parse_plugin_att2intel = {
 ...
 .init = 
# 175 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
        ((void *)0)
# 175 "project/radare2/libr/parse/p/parse_att2intel.c"
            ,
 .fini = 
# 176 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
        ((void *)0)
# 176 "project/radare2/libr/parse/p/parse_att2intel.c"
            ,
 .parse = &parse,
};
...
# 181 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
__attribute__((visibility("default"))) 
# 181 "project/radare2/libr/parse/p/parse_att2intel.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_PARSE,
 .data = &r_parse_plugin_att2intel,
 .version = 
# 184 "project/radare2/libr/parse/p/parse_att2intel.c" 3 4
           "5.5.4"

# 185 "project/radare2/libr/parse/p/parse_att2intel.c"
};
