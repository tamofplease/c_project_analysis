# 0 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
...
# 4 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 2
...
# 5 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 2
...
# 6 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 2
...
# 8 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 2
...
# 9 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 2
...
# 10 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 2
...
# 11 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 2
...
# 12 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 2


# 13 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
static 
# 13 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
      _Bool 
# 13 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
           can_replace(const char *str, int idx, int max_operands) {
 if (str[idx] > '9' || str[idx] < '1') {
  return 
# 15 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
        0
# 15 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
             ;
 }
 if (str[idx + 1] != '\x00' && str[idx + 1] <= '9' && str[idx + 1] >= '1') {
  return 
# 18 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
        0
# 18 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
             ;
 }
 if ((int)((int)str[idx] - 0x30) > max_operands) {
  return 
# 21 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
        0
# 21 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
             ;
 }
 return 
# 23 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
       1
# 23 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
           ;
}
...
static int replace(int argc, const char *argv[], char *newstr) {
 ...
 struct {
  ...
  { 
# 66 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
   ((void *)0) 
# 66 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
        }
 };

 for (i=0; ops[i].op != 
# 69 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
                       ((void *)0)
# 69 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
                           ; i++) {
  if (!strcmp (ops[i].op, argv[0])) {
   if (newstr != 
# 71 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
                ((void *)0)
# 71 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
                    ) {
    for (j=k=0;ops[i].str[j]!='\0';j++,k++) {
     if (can_replace(ops[i].str, j, ops[i].max_operands)) {
      const char *w = argv[ ops[i].str[j]-'0' ];
      if (w != 
# 75 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
              ((void *)0)
# 75 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
                  ) {
       
# 76 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
      __builtin___strcpy_chk (
# 76 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
      newstr+k
# 76 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
      , 
# 76 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
...
# 76 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
   ...
   return 
# 85 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
         1
# 85 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
             ;
  }
 }
 ...
 if (newstr != 
# 90 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
              ((void *)0)
# 90 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
                  ) {
  newstr[0] = '\0';
  for (i=0; i<argc; i++) {
   
# 93 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
  __builtin___strcat_chk (
# 93 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
  newstr
# 93 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
  , 
# 93 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
...
# 94 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
  __builtin___strcat_chk (
# 94 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
  newstr
# 94 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
  , 
# 94 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
...
# 94 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
 ...
 return 
# 98 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
       0
# 98 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
            ;
}
...
# 112 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
 __builtin___strcpy_chk (
# 112 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
 str
# 112 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
 , 
# 112 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
...
# 112 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
                    ;
  return 
# 113 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
        1
# 113 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
            ;
 }
 ...
 if (!(buf = malloc (len + 1))) {
  return 
# 118 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
        0
# 118 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
             ;
 }
 
# 120 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
__builtin___memcpy_chk (
# 120 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
buf
# 120 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
, 
# 120 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
...
# 143 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
  __builtin___strncpy_chk (
# 143 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
  w0
# 143 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
  , 
# 143 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
...
# 144 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
  __builtin___strncpy_chk (
# 144 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
  w1
# 144 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
  , 
# 144 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
...
# 153 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
   __builtin___strncpy_chk (
# 153 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
   w1
# 153 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
   , 
# 153 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
...
# 154 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
   __builtin___strncpy_chk (
# 154 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
   w2
# 154 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
   , 
# 154 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
...
# 162 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
    __builtin___strncpy_chk (
# 162 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
    w2
# 162 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
    , 
# 162 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
...
# 163 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
    __builtin___strncpy_chk (
# 163 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
    w3
# 163 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
    , 
# 163 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
...
# 172 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
     __builtin___strncpy_chk (
# 172 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
     w3
# 172 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
     , 
# 172 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
...
# 173 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
     __builtin___strncpy_chk (
# 173 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
     w4
# 173 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
     , 
# 173 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
...
# 190 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
    __builtin___memcpy_chk (
# 190 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
    pluseq
# 190 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
    , 
# 190 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
...
# 190 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
 ...
 free (buf);
 return 
# 196 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
       1
# 196 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
           ;
}
...
# 206 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
__attribute__((visibility("default"))) 
# 206 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_PARSE,
 .data = &r_parse_plugin_m68k_pseudo,
 .version = 
# 209 "project/radare2/libr/parse/p/parse_m68k_pseudo.c" 3 4
           "5.5.4"

# 210 "project/radare2/libr/parse/p/parse_m68k_pseudo.c"
};
