# 0 "project/radare2/libr/parse/p/parse_wasm_pseudo.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/parse/p/parse_wasm_pseudo.c"
...
# 4 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 2
...
# 5 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 2
...
# 6 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 2
...
# 7 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 2
...
# 8 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 2
...
# 9 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 2
...
# 10 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 2
...
# 11 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 2


# 12 "project/radare2/libr/parse/p/parse_wasm_pseudo.c"
static char* get_fcn_name(RAnal *anal, 
# 12 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 3 4
                                      unsigned int 
# 12 "project/radare2/libr/parse/p/parse_wasm_pseudo.c"
                                           fcn_id) {
 const char *s = anal->binb.get_name (anal->binb.bin, 'f', fcn_id, 
# 13 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 3 4
                                                                  0
# 13 "project/radare2/libr/parse/p/parse_wasm_pseudo.c"
                                                                       );
 return s? strdup (s): 
# 14 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 3 4
                      ((void *)0)
# 14 "project/radare2/libr/parse/p/parse_wasm_pseudo.c"
                          ;
}

static 
# 17 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 3 4
      _Bool 
# 17 "project/radare2/libr/parse/p/parse_wasm_pseudo.c"
...
# 17 "project/radare2/libr/parse/p/parse_wasm_pseudo.c"
 ...
 char *fcn_name = 
# 18 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 3 4
                 ((void *)0)
# 18 "project/radare2/libr/parse/p/parse_wasm_pseudo.c"
                     ;
 str[0] = 0;
 if (!strncmp (data, "call ", 5)) {
  
# 21 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 3 4
 unsigned int 
# 21 "project/radare2/libr/parse/p/parse_wasm_pseudo.c"
      fcn_id = (
# 21 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 3 4
                unsigned int
# 21 "project/radare2/libr/parse/p/parse_wasm_pseudo.c"
...
# 21 "project/radare2/libr/parse/p/parse_wasm_pseudo.c"
  ...
  if (!(fcn_name = get_fcn_name (p->analb.anal, fcn_id))) {
   return 
# 23 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 3 4
         0
# 23 "project/radare2/libr/parse/p/parse_wasm_pseudo.c"
              ;
  }
  
# 25 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 3 4
 __builtin___snprintf_chk (
# 25 "project/radare2/libr/parse/p/parse_wasm_pseudo.c"
 str
# 25 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 3 4
 , 
# 25 "project/radare2/libr/parse/p/parse_wasm_pseudo.c"
...
# 25 "project/radare2/libr/parse/p/parse_wasm_pseudo.c"
  ...
  free (fcn_name);
  return 
# 27 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 3 4
        1
# 27 "project/radare2/libr/parse/p/parse_wasm_pseudo.c"
            ;
 }
 return 
# 29 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 3 4
       0
# 29 "project/radare2/libr/parse/p/parse_wasm_pseudo.c"
            ;
}
...
# 39 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 3 4
__attribute__((visibility("default"))) 
# 39 "project/radare2/libr/parse/p/parse_wasm_pseudo.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_PARSE,
 .data = &r_parse_plugin_wasm_pseudo,
 .version = 
# 42 "project/radare2/libr/parse/p/parse_wasm_pseudo.c" 3 4
           "5.5.4"

# 43 "project/radare2/libr/parse/p/parse_wasm_pseudo.c"
};
