# 0 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
...
# 4 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 2
...
# 5 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 2
...
# 6 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 2
...
# 8 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 2
...
# 9 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 2
...
# 10 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 2
...
# 11 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 2
...
# 12 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 2


# 13 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
static 
# 13 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
      _Bool 
# 13 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
           replace(int argc, const char *argv[], char *newstr) {
 int i,j,k;
 struct {
  const char *op;
  const char *str;
  ...
  { "sts", "*(A) = B"},
  { 
# 100 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
   ((void *)0) 
# 100 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
        }
 };

 for (i = 0; ops[i].op != 
# 103 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
                         ((void *)0)
# 103 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
                             ; i++) {
  if (!strcmp (ops[i].op, argv[0])) {
   if (newstr != 
# 105 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
                ((void *)0)
# 105 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
                    ) {
    for (j = k = 0; ops[i].str[j] != '\0'; j++, k++) {
     if (ops[i].str[j] >= 'A' && ops[i].str[j] <= 'J') {
      const char *w = argv[ops[i].str[j] - '@'];
      if (w != 
# 109 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
              ((void *)0)
# 109 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
                  ) {
       
# 110 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
      __builtin___strcpy_chk (
# 110 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
      newstr + k
# 110 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
      , 
# 110 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
...
# 110 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
   ...
   return 
# 119 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
         1
# 119 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
             ;
  }
 }
 ...
 if (newstr != 
# 124 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
              ((void *)0)
# 124 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
                  ) {
  newstr[0] = '\0';
  for (i = 0; i < argc; i++) {
   
# 127 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
  __builtin___strcat_chk (
# 127 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
  newstr
# 127 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
  , 
# 127 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
...
# 128 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
  __builtin___strcat_chk (
# 128 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
  newstr
# 128 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
  , 
# 128 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
...
# 128 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
 ...
 return 
# 132 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
       0
# 132 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
            ;
}
...
static int parse(RParse *p, const char *data, char *str) {
 ...
 if (!(buf = malloc (len + 1))) {
  return 
# 147 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
        0
# 147 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
             ;
 }
 
# 149 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
__builtin___memcpy_chk (
# 149 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
buf
# 149 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
, 
# 149 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
...
# 167 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
  __builtin___strncpy_chk (
# 167 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
  w0
# 167 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
  , 
# 167 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
...
# 168 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
  __builtin___strncpy_chk (
# 168 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
  w1
# 168 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
  , 
# 168 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
...
# 177 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
   __builtin___strncpy_chk (
# 177 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
   w1
# 177 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
   , 
# 177 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
...
# 178 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
   __builtin___strncpy_chk (
# 178 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
   w2
# 178 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
   , 
# 178 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
...
# 186 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
    __builtin___strncpy_chk (
# 186 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
    w2
# 186 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
    , 
# 186 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
...
# 187 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
    __builtin___strncpy_chk (
# 187 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
    w3
# 187 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
    , 
# 187 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
...
# 196 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
     __builtin___strncpy_chk (
# 196 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
     w3
# 196 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
     , 
# 196 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
...
# 197 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
     __builtin___strncpy_chk (
# 197 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
     w4
# 197 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
     , 
# 197 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
...
# 202 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
  __builtin___strncpy_chk (
# 202 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
  w0
# 202 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
  , 
# 202 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
...
# 202 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
 ...
 free (buf);
 return 
# 216 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
       1
# 216 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
           ;
}
...
# 226 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
__attribute__((visibility("default"))) 
# 226 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_PARSE,
 .data = &r_parse_plugin_avr_pseudo,
 .version = 
# 229 "project/radare2/libr/parse/p/parse_avr_pseudo.c" 3 4
           "5.5.4"

# 230 "project/radare2/libr/parse/p/parse_avr_pseudo.c"
};
