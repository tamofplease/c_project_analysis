# 0 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 4 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 2
...
# 5 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 2
...
# 6 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 2
...
# 8 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 2
...
# 9 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 2
...
# 10 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 2
...
# 11 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 2
...
# 18 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
#define MAXPSEUDOOPS 10
 ...
 struct {
  ...
  { "xor", "# ^= #", {1, 2}},
  { 
# 118 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
   ((void *)0) 
# 118 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
        }
 };
...
# 148 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
      __builtin___strcpy_chk (
# 148 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
      newstr + k
# 148 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
      , 
# 148 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 148 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
   ...
   return 
# 157 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
         1
# 157 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
             ;
  }
 }
...
# 165 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  __builtin___strcat_chk (
# 165 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
  newstr
# 165 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  , 
# 165 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 166 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  __builtin___strcat_chk (
# 166 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
  newstr
# 166 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  , 
# 166 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 166 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
 ...
 return 
# 169 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
       0
# 169 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
            ;
}
...
static int parse(RParse *p, const char *data, char *str) {
 ...
 if (len >= sizeof (w0) || sz >= sizeof (w0)) {
  return 
# 179 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
        0
# 179 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
             ;
 }

 if (!(buf = strdup (data))) {
  return 
# 183 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
        0
# 183 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
             ;
 }
 *w0 = *w1 = *w2 = *w3 = '\0';
 if (*buf) {
...
# 199 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
 _Bool 
# 199 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
      par = (ptr != buf && *ptr == '(');
  for (; ptr < end; ptr++) {
   if (*ptr != ' ') {
    if (*ptr == ')') {
  ...
  if (par) ptr++;
  r_str_ncpy (w0, buf, 
# 209 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                      (((
# 209 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                      ptr - buf
# 209 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                      )>(
# 209 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 209 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
  ...
  if (par) ptr--;
  r_str_ncpy (w1, ptr, 
# 211 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                      (((
# 211 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                      end-ptr+1
# 211 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                      )>(
# 211 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 211 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
 ...
 if (strstr (w0, "mul")) {
  ...
  if (!(p->retleave_asm = (char *) malloc (sz))) {
   return 
# 283 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
         0
# 283 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
              ;
  }
...
# 295 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
 { free((void *)
# 295 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
 p->retleave_asm
# 295 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
 ); 
# 295 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 297 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
 { free((void *)
# 297 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
 p->retleave_asm
# 297 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
 ); 
# 297 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 297 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
 ...
 free (buf);
 return 
# 303 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
       1
# 303 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
           ;
}

static void parse_localvar(RParse *p, char *newstr, size_t newstr_len, const char *var, const char *reg, char sign, char *ireg, 
# 306 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                                                                                                                               _Bool 
# 306 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                                                                                                                                    att) {
...
# 313 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  __builtin___snprintf_chk (
# 313 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
  newstr
# 313 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  , 
# 313 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 318 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  __builtin___snprintf_chk (
# 318 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
  newstr
# 318 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  , 
# 318 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 325 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  __builtin___snprintf_chk (
# 325 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
  newstr
# 325 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  , 
# 325 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 327 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  __builtin___snprintf_chk (
# 327 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
  newstr
# 327 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  , 
# 327 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 327 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  , 2 > 1 ? 1 : 0), 
# 327 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
  "%s%s %c %s", reg, r_strbuf_get (sb), sign, var
# 327 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  )
# 327 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                                                                                    ;
...
static void mk_reg_str(const char *regname, int delta, 
# 333 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                                                      _Bool 
# 333 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                                                           sign, 
# 333 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                                                                 _Bool 
# 333 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                                                                      att, char *ireg, char *dest, int len) {
 RStrBuf *sb = r_strbuf_new ("");
 if (att) {
  if (ireg) {
   r_strbuf_setf (sb, ", %%%s", ireg);
...
# 340 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  __builtin___snprintf_chk (
# 340 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
  dest
# 340 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  , 
# 340 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 342 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  __builtin___snprintf_chk (
# 342 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
  dest
# 342 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  , 
# 342 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 342 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  , 2 > 1 ? 1 : 0), 
# 342 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
  "%s%d(%%%s%s)", sign ? "" : "-", delta, regname, r_strbuf_get (sb)
# 342 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  )
# 342 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                                                                                              ;
...
# 344 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  __builtin___snprintf_chk (
# 344 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
  dest
# 344 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  , 
# 344 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 344 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  , 2 > 1 ? 1 : 0), 
# 344 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
  "%s0x%x(%%%s%s)", sign ? "" : "-", delta, regname, r_strbuf_get (sb)
# 344 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  )
# 344 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                                                                                                ;
...
# 351 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  __builtin___snprintf_chk (
# 351 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
  dest
# 351 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  , 
# 351 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 353 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  __builtin___snprintf_chk (
# 353 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
  dest
# 353 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  , 
# 353 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 353 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  , 2 > 1 ? 1 : 0), 
# 353 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
  "%s%s %c %d", regname, r_strbuf_get (sb), sign ? '+':'-', delta
# 353 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  )
# 353 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                                                                                           ;
...
# 355 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  __builtin___snprintf_chk (
# 355 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
  dest
# 355 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  , 
# 355 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 355 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  , 2 > 1 ? 1 : 0), 
# 355 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
  "%s%s %c 0x%x", regname, r_strbuf_get (sb), sign ? '+':'-', delta
# 355 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
  )
# 355 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                                                                                             ;
...
static 
# 361 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
      _Bool 
# 361 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
           subvar(RParse *p, RAnalFunction *f, 
# 361 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                                               unsigned long long 
# 361 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                                                    addr, int oplen, char *data, char *str, int len) {
 RList *bpargs, *spargs;
 ...
 if (!tstr) {
  return 
# 368 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
        0
# 368 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
             ;
 }

 
# 371 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
_Bool 
# 371 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
     att = strchr (data, '%');
...
# 388 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
    long long 
# 388 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
         n = r_num_math (
# 388 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                         ((void *)0)
# 388 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 389 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
    unsigned long long 
# 389 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
         repl_num = oplen + addr + n;
     char *tstr_new = r_str_newf ("%s 0x%08"
# 390 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                                           "llx"
# 390 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                                                  "%s", pre, repl_num, pos);
     *rip = '(';
     free (tstr);
     tstr = tstr_new;
...
# 403 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
   unsigned long long 
# 403 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
        repl_num = oplen + addr;
    ...
    if (plus) {
     repl_num += r_num_get (
# 409 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                           ((void *)0)
# 409 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                               , plus + 1);
    }
    if (neg) {
     repl_num -= r_num_get (
# 412 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                           ((void *)0)
# 412 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                               , neg + 1);
    }

    rip[1] = '\0';
    tstr_new = r_str_newf ("%s0x%08"
# 416 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                                   "llx"
# 416 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                                          "%s", tstr, repl_num, ripend);
    free (tstr);
    tstr = tstr_new;
   }
  }
 ...
 if (!p->varlist) {
  free (tstr);
  return 
# 425 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
        0
# 425 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
             ;
 }
...
# 430 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
_Bool 
# 430 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
     ucase = *tstr >= 'A' && *tstr <= 'Z';
 if (ucase && tstr[1]) {
  ucase = tstr[1] >= 'A' && tstr[1] <= 'Z';
 }
 char *ireg = 
# 434 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
             ((void *)0)
# 434 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                 ;
 if (p->get_op_ireg) {
...
# 439 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
if (
# 439 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
spargs
# 439 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
) for (
# 439 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 441 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
 long long 
# 441 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
      delta = p->get_ptr_at
   ? p->get_ptr_at (f, sparg->delta, addr)
   : 
# 443 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
    ((long long)0x7FFFFFFFFFFFFFFFULL)
# 443 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
            ;
  if (delta == 
# 444 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
              ((long long)0x7FFFFFFFFFFFFFFFULL) 
# 444 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                       && sparg->field) {
   delta = sparg->delta;
  } else if (delta == 
# 446 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                     ((long long)0x7FFFFFFFFFFFFFFFULL)
# 446 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                             ) {
   continue;
  }
  if (delta < 0) {
  ...
  const char *reg = 
# 453 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                   ((void *)0)
# 453 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                       ;
  if (p->get_reg_at) {
  ...
  if (ucase) {
   r_str_case (oldstr, 
# 463 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                      1
# 463 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                          );
  }
  ...
  if (ptr && (!att || *(ptr - 1) == ' ')) {
   ...
   r_str_case (oldstr, 
# 477 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                      0
# 477 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                           );
...
# 486 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
if (
# 486 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
bpargs
# 486 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
) for (
# 486 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 488 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
 long long 
# 488 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
      delta = p->get_ptr_at
   ? p->get_ptr_at (f, bparg->delta, addr)
   : 
# 490 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
    ((long long)0x7FFFFFFFFFFFFFFFULL)
# 490 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
            ;
  if (delta == 
# 491 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
              ((long long)0x7FFFFFFFFFFFFFFFULL) 
# 491 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                       && bparg->field) {
   delta = bparg->delta + f->bp_off;
  } else if (delta == 
# 493 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                     ((long long)0x7FFFFFFFFFFFFFFFULL)
# 493 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                             ) {
   continue;
  }
  if (delta < 0) {
  ...
  const char *reg = 
# 500 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                   ((void *)0)
# 500 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                       ;
  if (p->get_reg_at) {
  ...
  if (ucase) {
   r_str_case (oldstr, 
# 509 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                      1
# 509 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                          );
  }
  ...
  if (ptr && (!att || *(ptr - 1) == ' ')) {
   ...
   r_str_case (oldstr, 
# 523 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                      0
# 523 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                           );
   ptr = strstr (tstr, oldstr);
   if (ptr && (!att || *(ptr - 1) == ' ')) {
    tstr = r_str_replace (tstr, oldstr, newstr, 1);
...
# 531 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
 __builtin___snprintf_chk (
# 531 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
 oldstr
# 531 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
 , 
# 531 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 540 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
 __builtin___strncpy_chk (
# 540 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
 bp
# 540 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
 , 
# 540 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
 anal->reg->name[R_REG_NAME_BP], sizeof (bp) - 1
# 540 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
 , __builtin_object_size (
# 540 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
 bp
...
# 540 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                                                              ;
  if (isupper ((
# 541 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
               unsigned char
# 541 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                  )*str)) {
   r_str_case (bp, 
# 542 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
                  1
# 542 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
                      );
  }
  bp[sizeof (bp) - 1] = 0;
 } else {
...
# 549 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
_Bool 
# 549 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
     ret = 
# 549 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
           1
# 549 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 551 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
 __builtin___strcpy_chk (
# 551 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
 str
# 551 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
 , 
# 551 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
...
# 551 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
  ...
  ret = 
# 554 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
       0
# 554 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
            ;
 }
 free (tstr);
 free (ireg);
...
# 571 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
__attribute__((visibility("default"))) 
# 571 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_PARSE,
 .data = &r_parse_plugin_x86_pseudo,
 .version = 
# 574 "project/radare2/libr/parse/p/parse_x86_pseudo.c" 3 4
           "5.5.4"

# 575 "project/radare2/libr/parse/p/parse_x86_pseudo.c"
};
