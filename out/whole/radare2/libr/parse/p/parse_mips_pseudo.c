# 0 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 4 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 2
...
# 5 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 2
...
# 6 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 2
...
# 8 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 2
...
# 9 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 2
...
# 10 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 2
...
# 11 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 2
...
# 12 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 2


# 13 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
static int can_replace(const char *str, int idx, int max_operands) {
 if (str[idx] > '9' || str[idx] < '1') {
  return 
# 15 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
        0
# 15 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
             ;
 }
 if (str[idx + 1] != '\x00' && str[idx + 1] <= '9' && str[idx + 1] >= '1') {
  return 
# 18 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
        0
# 18 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
             ;
 }
 if ((int)((int)str[idx] - 0x30) > max_operands) {
  return 
# 21 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
        0
# 21 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
             ;
 }
 return 
# 23 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
       1
# 23 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
           ;
}
...
static int replace(int argc, const char *argv[], char *newstr) {
 ...
 struct {
  ...
  { "xori", "1 = 2 ^ 3", 3},
  { 
# 94 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
   ((void *)0) 
# 94 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
        }
 };

 for (i=0; ops[i].op != 
# 97 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
                       ((void *)0)
# 97 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
                           ; i++) {
  if (!strcmp (ops[i].op, argv[0])) {
   if (newstr != 
# 99 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
                ((void *)0)
# 99 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
                    ) {
    for (j=k=0;ops[i].str[j]!='\0';j++,k++) {
     if (can_replace (ops[i].str, j, ops[i].max_operands)) {
      const char *w = argv[ ops[i].str[j]-'0' ];
      if (w != 
# 103 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
              ((void *)0)
# 103 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
                  ) {
       
# 104 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
      __builtin___strcpy_chk (
# 104 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
      newstr+k
# 104 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
      , 
# 104 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 104 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
   ...
   return 
# 113 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
         1
# 113 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
             ;
  }
 }
 ...
 if (newstr != 
# 118 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
              ((void *)0)
# 118 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
                  ) {
  newstr[0] = '\0';
  for (i=0; i<argc; i++) {
   
# 121 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
  __builtin___strcat_chk (
# 121 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
  newstr
# 121 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
  , 
# 121 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 122 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
  __builtin___strcat_chk (
# 122 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
  newstr
# 122 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
  , 
# 122 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 122 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
 ...
 return 
# 126 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
       0
# 126 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
            ;
}
...
# 140 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
 __builtin___strcpy_chk (
# 140 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
 str
# 140 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
 , 
# 140 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 140 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
                    ;
  return 
# 141 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
        1
# 141 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
            ;
 }
 ...
 if (!(buf = malloc (len + 1))) {
  return 
# 146 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
        0
# 146 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
             ;
 }
 
# 148 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
__builtin___memcpy_chk (
# 148 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
buf
# 148 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
, 
# 148 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 169 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
  __builtin___strncpy_chk (
# 169 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
  w0
# 169 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
  , 
# 169 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 170 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
  __builtin___strncpy_chk (
# 170 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
  w1
# 170 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
  , 
# 170 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 179 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
   __builtin___strncpy_chk (
# 179 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
   w1
# 179 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
   , 
# 179 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 180 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
   __builtin___strncpy_chk (
# 180 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
   w2
# 180 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
   , 
# 180 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 188 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
    __builtin___strncpy_chk (
# 188 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
    w2
# 188 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
    , 
# 188 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 189 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
    __builtin___strncpy_chk (
# 189 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
    w3
# 189 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
    , 
# 189 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 198 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
     __builtin___strncpy_chk (
# 198 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
     w3
# 198 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
     , 
# 198 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 199 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
     __builtin___strncpy_chk (
# 199 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
     w4
# 199 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
     , 
# 199 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 204 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
  __builtin___strncpy_chk (
# 204 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
  w0
# 204 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
  , 
# 204 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
   ...
   replace (nw, wa, str);
{
 ...
 if (!strcmp (w1, w2)) {
  char a[32], b[32];
#define REPLACE(x,y) do { int snprintf_len1_ = snprintf (a, 32, x, w1, w1); int snprintf_len2_ = snprintf (b, 32, y, w1); if (snprintf_len1_ < 32 && snprintf_len2_ < 32) { p = r_str_replace (p, a, b, 0); } } while (0)
# 235 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
  do { int snprintf_len1_ = 
# 235 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
...
# 235 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
 ; if (snprintf_len1_ < 32 && snprintf_len2_ < 32) { p = r_str_replace (p, a, b, 0); } } while (0);
  do { int snprintf_len1_ = 
# 236 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
 __builtin___snprintf_chk (
# 236 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
 a
# 236 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
 , 
# 236 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 236 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
 ; if (snprintf_len1_ < 32 && snprintf_len2_ < 32) { p = r_str_replace (p, a, b, 0); } } while (0);
  do { int snprintf_len1_ = 
# 237 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
 __builtin___snprintf_chk (
# 237 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
 a
# 237 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
 , 
# 237 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 237 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
 ; if (snprintf_len1_ < 32 && snprintf_len2_ < 32) { p = r_str_replace (p, a, b, 0); } } while (0);
  do { int snprintf_len1_ = 
# 238 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
 __builtin___snprintf_chk (
# 238 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
 a
# 238 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
 , 
# 238 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 238 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
 ; if (snprintf_len1_ < 32 && snprintf_len2_ < 32) { p = r_str_replace (p, a, b, 0); } } while (0);
  do { int snprintf_len1_ = 
# 239 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
 __builtin___snprintf_chk (
# 239 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
 a
# 239 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
 , 
# 239 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 239 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
 ; if (snprintf_len1_ < 32 && snprintf_len2_ < 32) { p = r_str_replace (p, a, b, 0); } } while (0);
  do { int snprintf_len1_ = 
# 240 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
 __builtin___snprintf_chk (
# 240 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
 a
# 240 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
 , 
# 240 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 240 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
 ; if (snprintf_len1_ < 32 && snprintf_len2_ < 32) { p = r_str_replace (p, a, b, 0); } } while (0);
  do { int snprintf_len1_ = 
# 241 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
 __builtin___snprintf_chk (
# 241 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
 a
# 241 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
 , 
# 241 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 244 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
__builtin___strcpy_chk (
# 244 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
str
# 244 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
, 
# 244 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 244 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
 ...
 free (buf);
 return 
# 250 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
       1
# 250 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
           ;
}

static 
# 253 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
      _Bool 
# 253 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 253 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
 ...
 if (!p->varlist) {
  free (tstr);
  return 
# 261 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
        0
# 261 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
             ;
 }
 RList *bpargs = p->varlist (f, 'b');
 RList *spargs = p->varlist (f, 's');
 const 
# 265 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
      _Bool 
# 265 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
           ucase = 
# 265 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
                   ((
# 265 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 267 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
if (
# 267 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
spargs
# 267 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
) for (
# 267 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 268 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
 long long 
# 268 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
      delta = p->get_ptr_at
   ? p->get_ptr_at (f, var->delta, addr)
   : 
# 270 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
    ((long long)0x7FFFFFFFFFFFFFFFULL)
# 270 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
            ;
  if (delta == 
# 271 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
              ((long long)0x7FFFFFFFFFFFFFFFULL) 
# 271 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
                       && var->field) {
   delta = var->delta;
  } else if (delta == 
# 273 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
                     ((long long)0x7FFFFFFFFFFFFFFFULL)
# 273 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
                             ) {
   continue;
  }
  const char *reg = 
# 276 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
                   ((void *)0)
# 276 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
                       ;
  if (p->get_reg_at) {
  ...
  if (
# 285 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
     (((
# 285 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
     delta
# 285 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
     )<0)?-(
# 285 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 285 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
  ...
  oldstr = r_str_newf (tmpf, 
# 292 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
                            (((
# 292 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
                            delta
# 292 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
                            )<0)?-(
# 292 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 292 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
  ...
  if (ucase) {
    ...
    *comma = 0;
    r_str_case (oldstr, 
# 297 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
                       1
# 297 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
                           );
    *comma = ',';
   }
  }
...
# 312 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
if (
# 312 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
bpargs
# 312 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
) for (
# 312 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 312 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
                                   {
  char *tmpf = 
# 313 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
              ((void *)0)
# 313 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
                  ;
  
# 314 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
 long long 
# 314 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
      delta = p->get_ptr_at
   ? p->get_ptr_at (f, var->delta, addr)
   : 
# 316 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
    ((long long)0x7FFFFFFFFFFFFFFFULL)
# 316 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
            ;
  if (delta == 
# 317 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
              ((long long)0x7FFFFFFFFFFFFFFFULL) 
# 317 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
                       && var->field) {
   delta = var->delta + f->bp_off;
  } else if (delta == 
# 319 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
                     ((long long)0x7FFFFFFFFFFFFFFFULL)
# 319 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
                             ) {
   continue;
  }
  const char *reg = 
# 322 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
                   ((void *)0)
# 322 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
                       ;
  if (p->get_reg_at) {
   reg = p->get_reg_at (f, var->delta, addr);
  }
  ...
  if (
# 329 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
     (((
# 329 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
     delta
# 329 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
     )<0)?-(
# 329 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 329 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
  ...
  oldstr = r_str_newf (tmpf, 
# 336 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
                            (((
# 336 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
                            delta
# 336 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
                            )<0)?-(
# 336 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 336 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
  ...
  if (ucase) {
    ...
    *comma = 0;
    r_str_case (oldstr, 
# 341 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
                       1
# 341 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
                           );
    *comma = ',';
   }
  }
...
# 356 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
_Bool 
# 356 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
     ret = 
# 356 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
           1
# 356 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 358 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
 __builtin___strcpy_chk (
# 358 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
 str
# 358 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
 , 
# 358 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
...
# 358 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
  ...
  ret = 
# 361 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
       0
# 361 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
            ;
 }
 free (tstr);
 r_list_free (bpargs);
...
RParsePlugin r_parse_plugin_mips_pseudo = {
 ...
 .init = 
# 372 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
        ((void *)0)
# 372 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
            ,
 .fini = 
# 373 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
        ((void *)0)
# 373 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
            ,
 .parse = parse,
 .subvar = subvar,
};
...
# 379 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
__attribute__((visibility("default"))) 
# 379 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_PARSE,
 .data = &r_parse_plugin_mips_pseudo,
 .version = 
# 382 "project/radare2/libr/parse/p/parse_mips_pseudo.c" 3 4
           "5.5.4"

# 383 "project/radare2/libr/parse/p/parse_mips_pseudo.c"
};
