# 0 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
...
# 4 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 2
...
# 5 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 2
...
# 6 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 2
...
# 8 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 2
...
# 9 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 2
...
# 10 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 2
...
# 11 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 2
...
# 12 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 2


# 13 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
static int replace(int argc, const char *argv[], char *newstr) {
 ...
 struct {
  ...
  { "xor", "1 = 1 ^ 2"},
  { 
# 42 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 3 4
   ((void *)0) 
# 42 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
        }
 };

 for (i=0; ops[i].op != 
# 45 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 3 4
                       ((void *)0)
# 45 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
                           ; i++) {
  if (!strcmp (ops[i].op, argv[0])) {
   if (newstr != 
# 47 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 3 4
                ((void *)0)
# 47 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
                    ) {
    for (j=k=0;ops[i].str[j]!='\0';j++,k++) {
     if (ops[i].str[j]>='1' && ops[i].str[j]<='9') {
      const char *w = argv[ ops[i].str[j]-'0' ];
      if (w != 
# 51 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 3 4
              ((void *)0)
# 51 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
                  ) {
       
# 52 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 3 4
      __builtin___strcpy_chk (
# 52 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
      newstr+k
# 52 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 3 4
      , 
# 52 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
...
# 52 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
   ...
   return 
# 61 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 3 4
         1
# 61 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
             ;
  }
 }
 ...
 if (newstr != 
# 66 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 3 4
              ((void *)0)
# 66 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
                  ) {
  newstr[0] = '\0';
  for (i=0; i<argc; i++) {
   
# 69 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 3 4
  __builtin___strcat_chk (
# 69 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
  newstr
# 69 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 3 4
  , 
# 69 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
...
# 70 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 3 4
  __builtin___strcat_chk (
# 70 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
  newstr
# 70 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 3 4
  , 
# 70 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
...
# 70 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
 ...
 return 
# 74 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 3 4
       0
# 74 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
            ;
}
...
RParsePlugin r_parse_plugin_z80_pseudo = {
 ...
 .init = 
# 80 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 3 4
        ((void *)0)
# 80 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
            ,
 .fini = 
# 81 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 3 4
        ((void *)0)
# 81 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
            ,
 .replace = replace,
};
...
# 86 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 3 4
__attribute__((visibility("default"))) 
# 86 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_PARSE,
 .data = &r_parse_plugin_z80_pseudo,
 .version = 
# 89 "project/radare2/libr/parse/p/parse_z80_pseudo.c" 3 4
           "5.5.4"

# 90 "project/radare2/libr/parse/p/parse_z80_pseudo.c"
};
