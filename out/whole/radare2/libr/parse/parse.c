# 0 "project/radare2/libr/parse/parse.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/parse/parse.c"
...
# 4 "project/radare2/libr/parse/parse.c" 2
...
# 5 "project/radare2/libr/parse/parse.c" 2
...
# 6 "project/radare2/libr/parse/parse.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/sdb/src/config.h" 1 3 4
# 7 "project/radare2/libr/parse/parse.c" 2

__attribute__((visibility("default"))) const char *
# 8 "project/radare2/libr/parse/parse.c"
r_parse_version
# 8 "project/radare2/libr/parse/parse.c" 3 4
(void) { return "" "5.5.4"; }
# 8 "project/radare2/libr/parse/parse.c"
                      ;
...
# 13 "project/radare2/libr/parse/parse.c" 3 4
__attribute__((visibility("default"))) 
# 13 "project/radare2/libr/parse/parse.c"
     RParse *r_parse_new(void) {
 RParse *p = 
# 14 "project/radare2/libr/parse/parse.c" 3 4
            (
# 14 "project/radare2/libr/parse/parse.c"
            RParse
# 14 "project/radare2/libr/parse/parse.c" 3 4
            *)calloc(1,sizeof(
# 14 "project/radare2/libr/parse/parse.c"
...
# 14 "project/radare2/libr/parse/parse.c"
 ...
 if (!p) {
  return 
# 16 "project/radare2/libr/parse/parse.c" 3 4
        ((void *)0)
# 16 "project/radare2/libr/parse/parse.c"
            ;
 }
 p->parsers = r_list_newf (
# 18 "project/radare2/libr/parse/parse.c" 3 4
                          ((void *)0)
# 18 "project/radare2/libr/parse/parse.c"
                              );
 if (!p->parsers) {
  r_parse_free (p);
  return 
# 21 "project/radare2/libr/parse/parse.c" 3 4
        ((void *)0)
# 21 "project/radare2/libr/parse/parse.c"
            ;
 }
 p->notin_flagspace = 
# 23 "project/radare2/libr/parse/parse.c" 3 4
                     ((void *)0)
# 23 "project/radare2/libr/parse/parse.c"
                         ;
 p->flagspace = 
# 24 "project/radare2/libr/parse/parse.c" 3 4
               ((void *)0)
# 24 "project/radare2/libr/parse/parse.c"
                   ;
 p->pseudo = 
# 25 "project/radare2/libr/parse/parse.c" 3 4
            0
# 25 "project/radare2/libr/parse/parse.c"
                 ;
 p->subrel = 
# 26 "project/radare2/libr/parse/parse.c" 3 4
            0
# 26 "project/radare2/libr/parse/parse.c"
                 ;
 p->subtail = 
# 27 "project/radare2/libr/parse/parse.c" 3 4
             0
# 27 "project/radare2/libr/parse/parse.c"
                  ;
 p->minval = 0x100;
 p->localvar_only = 
# 29 "project/radare2/libr/parse/parse.c" 3 4
                   0
# 29 "project/radare2/libr/parse/parse.c"
                        ;
 size_t i;
...
# 37 "project/radare2/libr/parse/parse.c" 3 4
__attribute__((visibility("default"))) 
# 37 "project/radare2/libr/parse/parse.c"
...
# 42 "project/radare2/libr/parse/parse.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 42 "project/radare2/libr/parse/parse.c"
          r_parse_add(RParse *p, RParsePlugin *foo) {
 
# 43 "project/radare2/libr/parse/parse.c" 3 4
_Bool 
# 43 "project/radare2/libr/parse/parse.c"
     itsFine = 
# 43 "project/radare2/libr/parse/parse.c" 3 4
               1
# 43 "project/radare2/libr/parse/parse.c"
 ...
 return 
# 50 "project/radare2/libr/parse/parse.c" 3 4
       1
# 50 "project/radare2/libr/parse/parse.c"
           ;
}
...
# 62 "project/radare2/libr/parse/parse.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 62 "project/radare2/libr/parse/parse.c"
          r_parse_use(RParse *p, const char *name) {
 RListIter *iter;
 RParsePlugin *h;
 
# 65 "project/radare2/libr/parse/parse.c" 3 4
do { if (!(
# 65 "project/radare2/libr/parse/parse.c"
p && name
# 65 "project/radare2/libr/parse/parse.c" 3 4
...
# 66 "project/radare2/libr/parse/parse.c" 3 4
if (
# 66 "project/radare2/libr/parse/parse.c"
p->parsers
# 66 "project/radare2/libr/parse/parse.c" 3 4
) for (
# 66 "project/radare2/libr/parse/parse.c"
...
# 66 "project/radare2/libr/parse/parse.c"
  ...
  if (!strcmp (h->name, name)) {
   p->cur = h;
   return 
# 69 "project/radare2/libr/parse/parse.c" 3 4
         1
# 69 "project/radare2/libr/parse/parse.c"
             ;
  }
 }
 char *sname = predotname (name);
 
# 73 "project/radare2/libr/parse/parse.c" 3 4
_Bool 
# 73 "project/radare2/libr/parse/parse.c"
     found = 
# 73 "project/radare2/libr/parse/parse.c" 3 4
             0
# 73 "project/radare2/libr/parse/parse.c"
...
# 74 "project/radare2/libr/parse/parse.c" 3 4
if (
# 74 "project/radare2/libr/parse/parse.c"
p->parsers
# 74 "project/radare2/libr/parse/parse.c" 3 4
) for (
# 74 "project/radare2/libr/parse/parse.c"
...
# 74 "project/radare2/libr/parse/parse.c"
 ...
 free (sname);
 return 
# 84 "project/radare2/libr/parse/parse.c" 3 4
       0
# 84 "project/radare2/libr/parse/parse.c"
            ;
}
...
# 89 "project/radare2/libr/parse/parse.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 89 "project/radare2/libr/parse/parse.c"
          r_parse_assemble(RParse *p, char *data, char *str) {
 char *in = strdup (str);
 
# 91 "project/radare2/libr/parse/parse.c" 3 4
_Bool 
# 91 "project/radare2/libr/parse/parse.c"
     ret = 
# 91 "project/radare2/libr/parse/parse.c" 3 4
           0
# 91 "project/radare2/libr/parse/parse.c"
...
# 121 "project/radare2/libr/parse/parse.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 121 "project/radare2/libr/parse/parse.c"
          r_parse_parse(RParse *p, const char *data, char *str) {
 
# 122 "project/radare2/libr/parse/parse.c" 3 4
do { if (!(
# 122 "project/radare2/libr/parse/parse.c"
p && data && str
# 122 "project/radare2/libr/parse/parse.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 122 "project/radare2/libr/parse/parse.c"
"p && data && str"
# 122 "project/radare2/libr/parse/parse.c" 3 4
, 122); return (0); } } while (0)
# 122 "project/radare2/libr/parse/parse.c"
                                              ;
 return (p && data && *data && p->cur && p->cur->parse)
  ? p->cur->parse (p, data, str) : 
# 124 "project/radare2/libr/parse/parse.c" 3 4
                                  0
# 124 "project/radare2/libr/parse/parse.c"
                                       ;
}


# 127 "project/radare2/libr/parse/parse.c" 3 4
__attribute__((visibility("default"))) 
# 127 "project/radare2/libr/parse/parse.c"
     char *r_parse_immtrim(char *opstr) {
 if (
# 128 "project/radare2/libr/parse/parse.c" 3 4
    (!(
# 128 "project/radare2/libr/parse/parse.c"
    opstr
# 128 "project/radare2/libr/parse/parse.c" 3 4
    ) || !*(
# 128 "project/radare2/libr/parse/parse.c"
...
# 128 "project/radare2/libr/parse/parse.c"
  ...
  return 
# 129 "project/radare2/libr/parse/parse.c" 3 4
        ((void *)0)
# 129 "project/radare2/libr/parse/parse.c"
            ;
 }
 ...
 if (n) {
  char *p = n + 2;
  while (
# 134 "project/radare2/libr/parse/parse.c" 3 4
        (((
# 134 "project/radare2/libr/parse/parse.c"
        *p
# 134 "project/radare2/libr/parse/parse.c" 3 4
        ) >= '0' && (
# 134 "project/radare2/libr/parse/parse.c"
...
# 137 "project/radare2/libr/parse/parse.c" 3 4
 __builtin___memmove_chk (
# 137 "project/radare2/libr/parse/parse.c"
 n
# 137 "project/radare2/libr/parse/parse.c" 3 4
 , 
# 137 "project/radare2/libr/parse/parse.c"
...
# 157 "project/radare2/libr/parse/parse.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 157 "project/radare2/libr/parse/parse.c"
          r_parse_subvar(RParse *p, RAnalFunction *f, 
# 157 "project/radare2/libr/parse/parse.c" 3 4
                                                      unsigned long long 
# 157 "project/radare2/libr/parse/parse.c"
 ...
 return 
# 161 "project/radare2/libr/parse/parse.c" 3 4
       0
# 161 "project/radare2/libr/parse/parse.c"
            ;
}



# 165 "project/radare2/libr/parse/parse.c" 3 4
__attribute__((visibility("default"))) 
# 165 "project/radare2/libr/parse/parse.c"
     void r_parse_set_user_ptr(RParse *p, void *user) {
 p->user = user;
}
