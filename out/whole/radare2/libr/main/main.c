# 0 "project/radare2/libr/main/main.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/main/main.c"
...
# 4 "project/radare2/libr/main/main.c" 2
...
# 5 "project/radare2/libr/main/main.c" 2
...
# 6 "project/radare2/libr/main/main.c" 2


__attribute__((visibility("default"))) const char *
# 8 "project/radare2/libr/main/main.c"
r_main_version
# 8 "project/radare2/libr/main/main.c" 3 4
(void) { return "" "5.5.4"; }
# 8 "project/radare2/libr/main/main.c"
                    ;
...
static RMain foo[] = {
 ...
 { 
# 20 "project/radare2/libr/main/main.c" 3 4
  ((void *)0)
# 20 "project/radare2/libr/main/main.c"
      , 
# 20 "project/radare2/libr/main/main.c" 3 4
        ((void *)0) 
# 20 "project/radare2/libr/main/main.c"
...
# 23 "project/radare2/libr/main/main.c" 3 4
__attribute__((visibility("default"))) 
# 23 "project/radare2/libr/main/main.c"
     RMain *r_main_new (const char *name) {
 int i = 0;
 while (foo[i].name) {
  if (!strcmp (name, foo[i].name)) {
   RMain *m = 
# 27 "project/radare2/libr/main/main.c" 3 4
             (
# 27 "project/radare2/libr/main/main.c"
             RMain
# 27 "project/radare2/libr/main/main.c" 3 4
             *)calloc(1,sizeof(
# 27 "project/radare2/libr/main/main.c"
...
# 27 "project/radare2/libr/main/main.c"
 ...
 return 
# 36 "project/radare2/libr/main/main.c" 3 4
       ((void *)0)
# 36 "project/radare2/libr/main/main.c"
           ;
}


# 39 "project/radare2/libr/main/main.c" 3 4
__attribute__((visibility("default"))) 
# 39 "project/radare2/libr/main/main.c"
     void r_main_free(RMain *m) {
 free (m);
}


# 43 "project/radare2/libr/main/main.c" 3 4
__attribute__((visibility("default"))) 
# 43 "project/radare2/libr/main/main.c"
     int r_main_run(RMain *m, int argc, const char **argv) {
 
# 44 "project/radare2/libr/main/main.c" 3 4
do { if (!(
# 44 "project/radare2/libr/main/main.c"
m && m->main
# 44 "project/radare2/libr/main/main.c" 3 4
...
# 48 "project/radare2/libr/main/main.c" 3 4
__attribute__((visibility("default"))) 
# 48 "project/radare2/libr/main/main.c"
     int r_main_version_print(const char *progname) {
