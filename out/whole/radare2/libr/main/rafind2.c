# 0 "project/radare2/libr/main/rafind2.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/main/rafind2.c"
...
# 4 "project/radare2/libr/main/rafind2.c" 2
...
# 5 "project/radare2/libr/main/rafind2.c" 2
...
# 7 "project/radare2/libr/main/rafind2.c" 2
...
# 8 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_search.h" 2 3 4
...
# 9 "project/radare2/libr/main/rafind2.c" 2
...
# 11 "project/radare2/libr/main/rafind2.c" 2
...
# 13 "project/radare2/libr/main/rafind2.c" 2




# 16 "project/radare2/libr/main/rafind2.c"
typedef struct {
 RIO *io;
 
# 18 "project/radare2/libr/main/rafind2.c" 3 4
_Bool 
# 18 "project/radare2/libr/main/rafind2.c"
     showstr;
 
# 19 "project/radare2/libr/main/rafind2.c" 3 4
_Bool 
# 19 "project/radare2/libr/main/rafind2.c"
     rad;
 
# 20 "project/radare2/libr/main/rafind2.c" 3 4
_Bool 
# 20 "project/radare2/libr/main/rafind2.c"
     color;
 
# 21 "project/radare2/libr/main/rafind2.c" 3 4
_Bool 
# 21 "project/radare2/libr/main/rafind2.c"
     identify;
 
# 22 "project/radare2/libr/main/rafind2.c" 3 4
_Bool 
# 22 "project/radare2/libr/main/rafind2.c"
     quiet;
 
# 23 "project/radare2/libr/main/rafind2.c" 3 4
_Bool 
# 23 "project/radare2/libr/main/rafind2.c"
     hexstr;
 
# 24 "project/radare2/libr/main/rafind2.c" 3 4
_Bool 
# 24 "project/radare2/libr/main/rafind2.c"
     widestr;
 
# 25 "project/radare2/libr/main/rafind2.c" 3 4
_Bool 
# 25 "project/radare2/libr/main/rafind2.c"
     nonstop;
 
# 26 "project/radare2/libr/main/rafind2.c" 3 4
_Bool 
# 26 "project/radare2/libr/main/rafind2.c"
     pluglist;
 
# 27 "project/radare2/libr/main/rafind2.c" 3 4
_Bool 
# 27 "project/radare2/libr/main/rafind2.c"
     json;
 int mode;
 int align;
 
# 30 "project/radare2/libr/main/rafind2.c" 3 4
unsigned char 
# 30 "project/radare2/libr/main/rafind2.c"
    *buf;
 
# 31 "project/radare2/libr/main/rafind2.c" 3 4
unsigned long long 
# 31 "project/radare2/libr/main/rafind2.c"
     bsize;
 
# 32 "project/radare2/libr/main/rafind2.c" 3 4
unsigned long long 
# 32 "project/radare2/libr/main/rafind2.c"
     from;
 
# 33 "project/radare2/libr/main/rafind2.c" 3 4
unsigned long long 
# 33 "project/radare2/libr/main/rafind2.c"
     to;
 
# 34 "project/radare2/libr/main/rafind2.c" 3 4
unsigned long long 
# 34 "project/radare2/libr/main/rafind2.c"
     cur;
 RPrint *pr;
 RList *keywords;
 const char *mask;
...
static void rafind_options_fini(RafindOptions *ro) {
 if (ro) {
  ...
  ro->io = 
# 45 "project/radare2/libr/main/rafind2.c" 3 4
          ((void *)0)
# 45 "project/radare2/libr/main/rafind2.c"
              ;
  free (ro->buf);
  ro->cur = 0;
 }
...
# 52 "project/radare2/libr/main/rafind2.c" 3 4
__builtin___memset_chk (
# 52 "project/radare2/libr/main/rafind2.c"
ro
# 52 "project/radare2/libr/main/rafind2.c" 3 4
, 
# 52 "project/radare2/libr/main/rafind2.c"
0, sizeof (RafindOptions)
# 52 "project/radare2/libr/main/rafind2.c" 3 4
...
# 52 "project/radare2/libr/main/rafind2.c"
 ...
 ro->bsize = 4096;
 ro->to = 
# 55 "project/radare2/libr/main/rafind2.c" 3 4
         0xFFFFFFFFFFFFFFFFULL
# 55 "project/radare2/libr/main/rafind2.c"
                 ;
 ro->color = 
# 56 "project/radare2/libr/main/rafind2.c" 3 4
            1
# 56 "project/radare2/libr/main/rafind2.c"
                ;
 ro->keywords = r_list_newf (
# 57 "project/radare2/libr/main/rafind2.c" 3 4
                            ((void *)0)
# 57 "project/radare2/libr/main/rafind2.c"
                                );
 ro->pj = 
# 58 "project/radare2/libr/main/rafind2.c" 3 4
         ((void *)0)
# 58 "project/radare2/libr/main/rafind2.c"
             ;
 r_cons_new ();
}
...
static int hit(RSearchKeyword *kw, void *user, 
# 64 "project/radare2/libr/main/rafind2.c" 3 4
                                              unsigned long long 
# 64 "project/radare2/libr/main/rafind2.c"
                                                   addr) {
 RafindOptions *ro = (RafindOptions*)user;
 
# 66 "project/radare2/libr/main/rafind2.c" 3 4
unsigned char 
# 66 "project/radare2/libr/main/rafind2.c"
    *buf = ro->buf;
...
# 73 "project/radare2/libr/main/rafind2.c" 3 4
 fprintf(__stderrp,
# 73 "project/radare2/libr/main/rafind2.c"
 "Invalid delta %d from 0x%08"
# 73 "project/radare2/libr/main/rafind2.c" 3 4
 "llx"
# 73 "project/radare2/libr/main/rafind2.c"
 "\n", delta, addr
 ...
 if (ro->showstr) {
  if (ro->widestr) {
   ...
   for (i = delta; buf[i] && i < sizeof (_str) - 1; i++) {
    ...
    if (!
# 94 "project/radare2/libr/main/rafind2.c" 3 4
        ((
# 94 "project/radare2/libr/main/rafind2.c"
        ch
# 94 "project/radare2/libr/main/rafind2.c" 3 4
        ) >=' ' && (
# 94 "project/radare2/libr/main/rafind2.c"
...
# 100 "project/radare2/libr/main/rafind2.c" 3 4
    __builtin___strcpy_chk (
# 100 "project/radare2/libr/main/rafind2.c"
    str + j
# 100 "project/radare2/libr/main/rafind2.c" 3 4
    , 
# 100 "project/radare2/libr/main/rafind2.c"
...
# 100 "project/radare2/libr/main/rafind2.c"
   ...
   for (i = 0; i < sizeof (_str) - 1; i++) {
    ...
    if (!ch || !
# 116 "project/radare2/libr/main/rafind2.c" 3 4
               ((
# 116 "project/radare2/libr/main/rafind2.c"
               ch
# 116 "project/radare2/libr/main/rafind2.c" 3 4
               ) >=' ' && (
# 116 "project/radare2/libr/main/rafind2.c"
...
# 116 "project/radare2/libr/main/rafind2.c"
  ...
  for (i = 0; i < sizeof (_str) - 1; i++) {
   ...
   if (!ch || !
# 130 "project/radare2/libr/main/rafind2.c" 3 4
              ((
# 130 "project/radare2/libr/main/rafind2.c"
              ch
# 130 "project/radare2/libr/main/rafind2.c" 3 4
              ) >=' ' && (
# 130 "project/radare2/libr/main/rafind2.c"
...
# 130 "project/radare2/libr/main/rafind2.c"
 ...
 if (ro->json) {
  ...
  printf ("f hit%d_%d = 0x%08"
# 145 "project/radare2/libr/main/rafind2.c" 3 4
                             "llx"
# 145 "project/radare2/libr/main/rafind2.c"
  ...
  if (ro->showstr) {
   printf ("0x%"
# 151 "project/radare2/libr/main/rafind2.c" 3 4
               "llx"
# 151 "project/radare2/libr/main/rafind2.c"
                      " %s\n", addr, str);
  } else {
   printf ("0x%"
# 153 "project/radare2/libr/main/rafind2.c" 3 4
               "llx"
# 153 "project/radare2/libr/main/rafind2.c"
                      "\n", addr);
   if (ro->pr) {
    int bs = 
# 155 "project/radare2/libr/main/rafind2.c" 3 4
            (((
# 155 "project/radare2/libr/main/rafind2.c"
            ro->bsize
# 155 "project/radare2/libr/main/rafind2.c" 3 4
            )>(
# 155 "project/radare2/libr/main/rafind2.c"
...
# 155 "project/radare2/libr/main/rafind2.c"
                                 ;
    r_print_hexdump (ro->pr, addr, (
# 156 "project/radare2/libr/main/rafind2.c" 3 4
                                   unsigned char
# 156 "project/radare2/libr/main/rafind2.c"
                                      *)buf + delta, bs, 16, 1, 1);
    r_cons_flush ();
   }
  }
...
static int rafind_open_file(RafindOptions *ro, const char *file, const 
# 200 "project/radare2/libr/main/rafind2.c" 3 4
                                                                      unsigned char 
# 200 "project/radare2/libr/main/rafind2.c"
                                                                          *data, int datalen) {
 RListIter *iter;
 RSearch *rs = 
# 202 "project/radare2/libr/main/rafind2.c" 3 4
              ((void *)0)
# 202 "project/radare2/libr/main/rafind2.c"
                  ;
 const char *kw;
 
# 204 "project/radare2/libr/main/rafind2.c" 3 4
_Bool 
# 204 "project/radare2/libr/main/rafind2.c"
     last = 
# 204 "project/radare2/libr/main/rafind2.c" 3 4
            0
# 204 "project/radare2/libr/main/rafind2.c"
 ...
 ro->buf = 
# 207 "project/radare2/libr/main/rafind2.c" 3 4
          ((void *)0)
# 207 "project/radare2/libr/main/rafind2.c"
              ;
 ...
 RIO *io = r_io_new ();
 ro->io = io;
 if (!r_io_open_nomap (io, file, 
# 220 "project/radare2/libr/main/rafind2.c" 3 4
                                4
# 220 "project/radare2/libr/main/rafind2.c"
                                        , 0)) {
  
# 221 "project/radare2/libr/main/rafind2.c" 3 4
 fprintf(__stderrp,
# 221 "project/radare2/libr/main/rafind2.c"
 "Cannot open file '%s'\n", file
# 221 "project/radare2/libr/main/rafind2.c" 3 4
 )
# 221 "project/radare2/libr/main/rafind2.c"
...
# 238 "project/radare2/libr/main/rafind2.c" 3 4
 fprintf(__stderrp,
# 238 "project/radare2/libr/main/rafind2.c"
 "Cannot allocate %"
# 238 "project/radare2/libr/main/rafind2.c" 3 4
 "lld"
# 238 "project/radare2/libr/main/rafind2.c"
...
# 244 "project/radare2/libr/main/rafind2.c" 3 4
unsigned long long 
# 244 "project/radare2/libr/main/rafind2.c"
     to = ro->to;
 if (to == -1) {
  to = r_io_size (io);
 }
 ...
 if (ro->mode == R_SEARCH_MAGIC) {
  ...
  char *tostr = (to && to != 
# 261 "project/radare2/libr/main/rafind2.c" 3 4
                            0xFFFFFFFFFFFFFFFFULL
# 261 "project/radare2/libr/main/rafind2.c"
                                    )? r_str_newf ("-e search.to=%"
# 261 "project/radare2/libr/main/rafind2.c" 3 4
                                                                    "lld"
# 261 "project/radare2/libr/main/rafind2.c"
                                                                           , to): strdup ("");
  r_sys_cmdf ("r2"
       ...
       " -e search.align=%d"
       " -e search.from=%" 
# 266 "project/radare2/libr/main/rafind2.c" 3 4
                          "lld"
       
# 267 "project/radare2/libr/main/rafind2.c"
      " %s -qnc/m%s \"%s\"",
       r_str_bool (ro->color),
...
# 275 "project/radare2/libr/main/rafind2.c" 3 4
 if (
# 275 "project/radare2/libr/main/rafind2.c"
 ro->keywords
# 275 "project/radare2/libr/main/rafind2.c" 3 4
 ) for (
# 275 "project/radare2/libr/main/rafind2.c"
...
# 281 "project/radare2/libr/main/rafind2.c" 3 4
 if (
# 281 "project/radare2/libr/main/rafind2.c"
 ro->keywords
# 281 "project/radare2/libr/main/rafind2.c" 3 4
 ) for (
# 281 "project/radare2/libr/main/rafind2.c"
...
# 281 "project/radare2/libr/main/rafind2.c"
   ...
   if (ro->hexstr) {
    if (ro->mask) {
     r_search_kw_add (rs, r_search_keyword_new_hex (kw, ro->mask, 
# 284 "project/radare2/libr/main/rafind2.c" 3 4
                                                                 ((void *)0)
# 284 "project/radare2/libr/main/rafind2.c"
                                                                     ));
    } else {
     r_search_kw_add (rs, r_search_keyword_new_hexmask (kw, 
# 286 "project/radare2/libr/main/rafind2.c" 3 4
                                                           ((void *)0)
# 286 "project/radare2/libr/main/rafind2.c"
                                                               ));
    }
   } else if (ro->widestr) {
    r_search_kw_add (rs, r_search_keyword_new_wide (kw, ro->mask, 
# 289 "project/radare2/libr/main/rafind2.c" 3 4
                                                                 ((void *)0)
# 289 "project/radare2/libr/main/rafind2.c"
                                                                     , 0));
   } else {
    r_search_kw_add (rs, r_search_keyword_new_str (kw, ro->mask, 
# 291 "project/radare2/libr/main/rafind2.c" 3 4
                                                                ((void *)0)
# 291 "project/radare2/libr/main/rafind2.c"
                                                                    , 0));
   }
  }
 }
...
# 296 "project/radare2/libr/main/rafind2.c" 3 4
 if (
# 296 "project/radare2/libr/main/rafind2.c"
 ro->keywords
# 296 "project/radare2/libr/main/rafind2.c" 3 4
 ) for (
# 296 "project/radare2/libr/main/rafind2.c"
...
# 296 "project/radare2/libr/main/rafind2.c"
                                         {
   r_search_kw_add (rs, r_search_keyword_new_regexp (kw, 
# 297 "project/radare2/libr/main/rafind2.c" 3 4
                                                        ((void *)0)
# 297 "project/radare2/libr/main/rafind2.c"
                                                            ));
  }
 }
 ...
 ro->curfile = file;
 r_search_begin (rs);
 (void)r_io_seek (io, ro->from, 
# 303 "project/radare2/libr/main/rafind2.c" 3 4
                               0
# 303 "project/radare2/libr/main/rafind2.c"
                                            );
 result = 0;
 
# 305 "project/radare2/libr/main/rafind2.c" 3 4
unsigned long long 
# 305 "project/radare2/libr/main/rafind2.c"
     bsize = ro->bsize;
 for (ro->cur = ro->from; !last && ro->cur < to; ro->cur += bsize) {
  if ((ro->cur + bsize) > to) {
   bsize = to - ro->cur;
   last = 
# 309 "project/radare2/libr/main/rafind2.c" 3 4
         1
# 309 "project/radare2/libr/main/rafind2.c"
             ;
  }
...
# 323 "project/radare2/libr/main/rafind2.c" 3 4
  fprintf(__stderrp,
# 323 "project/radare2/libr/main/rafind2.c"
  "search: update read error at 0x%08"
# 323 "project/radare2/libr/main/rafind2.c" 3 4
  "llx"
# 323 "project/radare2/libr/main/rafind2.c"
  "\n", ro->cur
...
static int rafind_open_dir(RafindOptions *ro, const char *dir) {
 ...
 char *fullpath;
 char *fname = 
# 340 "project/radare2/libr/main/rafind2.c" 3 4
              ((void *)0)
# 340 "project/radare2/libr/main/rafind2.c"
                  ;
...
# 345 "project/radare2/libr/main/rafind2.c" 3 4
 if (
# 345 "project/radare2/libr/main/rafind2.c"
 files
# 345 "project/radare2/libr/main/rafind2.c" 3 4
 ) for (
# 345 "project/radare2/libr/main/rafind2.c"
...
# 345 "project/radare2/libr/main/rafind2.c"
   ...
   fullpath = r_str_newf ("%s"
# 350 "project/radare2/libr/main/rafind2.c" 3 4
                             "/"
# 350 "project/radare2/libr/main/rafind2.c"
                                      "%s", dir, fname);
...
# 362 "project/radare2/libr/main/rafind2.c" 3 4
 unsigned char 
# 362 "project/radare2/libr/main/rafind2.c"
     *buf = (
# 362 "project/radare2/libr/main/rafind2.c" 3 4
             unsigned char 
# 362 "project/radare2/libr/main/rafind2.c"
 ...
 return r_file_is_directory (file)
  ...
  : rafind_open_file (ro, file, 
# 374 "project/radare2/libr/main/rafind2.c" 3 4
                               ((void *)0)
# 374 "project/radare2/libr/main/rafind2.c"
                                   , -1);
}


# 377 "project/radare2/libr/main/rafind2.c" 3 4
__attribute__((visibility("default"))) 
# 377 "project/radare2/libr/main/rafind2.c"
 ...
 int c;
 const char *file = 
# 382 "project/radare2/libr/main/rafind2.c" 3 4
                   ((void *)0)
# 382 "project/radare2/libr/main/rafind2.c"
                       ;
 ...
 while ((c = r_getopt_next (&opt)) != -1) {
  ...
  case 'a':
   ro.align = r_num_math (
# 389 "project/radare2/libr/main/rafind2.c" 3 4
                         ((void *)0)
# 389 "project/radare2/libr/main/rafind2.c"
                             , opt.arg);
   break;
  case 'c':
   ro.color = 
# 392 "project/radare2/libr/main/rafind2.c" 3 4
             0
# 392 "project/radare2/libr/main/rafind2.c"
                  ;
   break;
  case 'r':
   ro.rad = 
# 395 "project/radare2/libr/main/rafind2.c" 3 4
           1
# 395 "project/radare2/libr/main/rafind2.c"
               ;
   break;
  case 'i':
   ro.identify = 
# 398 "project/radare2/libr/main/rafind2.c" 3 4
                1
# 398 "project/radare2/libr/main/rafind2.c"
                    ;
   break;
  case 'L':
   ro.pluglist = 
# 401 "project/radare2/libr/main/rafind2.c" 3 4
                1
# 401 "project/radare2/libr/main/rafind2.c"
                    ;
   break;
  case 'j':
   ro.json = 
# 404 "project/radare2/libr/main/rafind2.c" 3 4
            1
# 404 "project/radare2/libr/main/rafind2.c"
                ;
   break;
  case 'n':
   ro.nonstop = 1;
  ...
  case 's':
   ...
   ro.hexstr = 
# 423 "project/radare2/libr/main/rafind2.c" 3 4
              0
# 423 "project/radare2/libr/main/rafind2.c"
                   ;
   ro.widestr = 
# 424 "project/radare2/libr/main/rafind2.c" 3 4
               0
# 424 "project/radare2/libr/main/rafind2.c"
                    ;
   r_list_append (ro.keywords, (void*)opt.arg);
   break;
  case 'S':
   ro.mode = R_SEARCH_KEYWORD;
   ro.hexstr = 
# 429 "project/radare2/libr/main/rafind2.c" 3 4
              0
# 429 "project/radare2/libr/main/rafind2.c"
                   ;
   ro.widestr = 
# 430 "project/radare2/libr/main/rafind2.c" 3 4
               1
# 430 "project/radare2/libr/main/rafind2.c"
                   ;
   r_list_append (ro.keywords, (void*)opt.arg);
   break;
  case 'b':
   {
   int bs = (int)r_num_math (
# 435 "project/radare2/libr/main/rafind2.c" 3 4
                            ((void *)0)
# 435 "project/radare2/libr/main/rafind2.c"
                                , opt.arg);
   if (bs < 2) {
    
# 437 "project/radare2/libr/main/rafind2.c" 3 4
   fprintf(__stderrp,
# 437 "project/radare2/libr/main/rafind2.c"
   "Invalid blocksize <= 1\n"
# 437 "project/radare2/libr/main/rafind2.c" 3 4
   )
# 437 "project/radare2/libr/main/rafind2.c"
  ...
  case 'f':
   ro.from = r_num_math (
# 448 "project/radare2/libr/main/rafind2.c" 3 4
                        ((void *)0)
# 448 "project/radare2/libr/main/rafind2.c"
                            , opt.arg);
   break;
  case 'F':
   {
...
# 455 "project/radare2/libr/main/rafind2.c" 3 4
    fprintf(__stderrp,
# 455 "project/radare2/libr/main/rafind2.c"
    "Cannot slurp '%s'\n", opt.arg
# 455 "project/radare2/libr/main/rafind2.c" 3 4
    )
# 455 "project/radare2/libr/main/rafind2.c"
    ...
    char *hexdata = r_hex_bin2strdup ((
# 458 "project/radare2/libr/main/rafind2.c" 3 4
                                      unsigned char
# 458 "project/radare2/libr/main/rafind2.c"
                                         *)data, data_size);
    if (hexdata) {
     ro.mode = R_SEARCH_KEYWORD;
     ro.hexstr = 
# 461 "project/radare2/libr/main/rafind2.c" 3 4
                1
# 461 "project/radare2/libr/main/rafind2.c"
                    ;
     ro.widestr = 
# 462 "project/radare2/libr/main/rafind2.c" 3 4
                 0
# 462 "project/radare2/libr/main/rafind2.c"
                      ;
  ...
  case 't':
   ro.to = r_num_math (
# 469 "project/radare2/libr/main/rafind2.c" 3 4
                      ((void *)0)
# 469 "project/radare2/libr/main/rafind2.c"
                          , opt.arg);
   break;
  case 'x':
   ro.mode = R_SEARCH_KEYWORD;
  ...
  case 'q':
   ro.quiet = 
# 481 "project/radare2/libr/main/rafind2.c" 3 4
             1
# 481 "project/radare2/libr/main/rafind2.c"
                 ;
   break;
  case 'v':
  ...
  case 'Z':
   ro.showstr = 
# 491 "project/radare2/libr/main/rafind2.c" 3 4
               1
# 491 "project/radare2/libr/main/rafind2.c"
                   ;
   break;
  default:
 ...
 if (ro.pr) {
  if (ro.color) {
   ro.pr->flags |= 
# 499 "project/radare2/libr/main/rafind2.c" 3 4
                  0x00000001
# 499 "project/radare2/libr/main/rafind2.c"
                                     ;
  } else {
   ro.pr->flags &= ~
# 501 "project/radare2/libr/main/rafind2.c" 3 4
                   0x00000001
# 501 "project/radare2/libr/main/rafind2.c"
                                      ;
  }
 }
 if (ro.pluglist) {
 ...
 if (opt.ind + 1 == argc && argv[opt.ind] && argv[opt.ind][0] && !r_file_is_directory (argv[opt.ind])) {
  ro.quiet = 
# 518 "project/radare2/libr/main/rafind2.c" 3 4
            1
# 518 "project/radare2/libr/main/rafind2.c"
                ;
 }
...
# 528 "project/radare2/libr/main/rafind2.c" 3 4
  fprintf(__stderrp,
# 528 "project/radare2/libr/main/rafind2.c"
