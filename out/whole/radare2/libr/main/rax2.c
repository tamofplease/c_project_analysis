# 0 "project/radare2/libr/main/rax2.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/main/rax2.c"
...
# 4 "project/radare2/libr/main/rax2.c" 2
...
# 6 "project/radare2/libr/main/rax2.c" 2


#define STDIN_BUFFER_SIZE 354096

# 9 "project/radare2/libr/main/rax2.c"
static int rax(RNum *num, char *str, int len, int last, 
# 9 "project/radare2/libr/main/rax2.c" 3 4
                                                       unsigned long long 
# 9 "project/radare2/libr/main/rax2.c"
                                                            *flags, int *fm);

static int use_stdin(RNum *num, 
# 11 "project/radare2/libr/main/rax2.c" 3 4
                               unsigned long long 
# 11 "project/radare2/libr/main/rax2.c"
                                    *flags, int *fm) {
 if (!flags) {
  return 0;
 }
 char *buf = calloc (1, 354096 + 1);
 int l;
 if (!buf) {
  return 0;
 }
 if (!(*flags & (1<<14))) {
  for (l = 0; l >= 0 && l < 354096; l++) {

   int n = read (0, buf + l, 354096 - l);
   if (n < 1) {
    break;
   }
   l += n;
...
static int format_output(RNum *num, char mode, const char *s, int force_mode, 
# 50 "project/radare2/libr/main/rax2.c" 3 4
                                                                             unsigned long long 
# 50 "project/radare2/libr/main/rax2.c"
                                                                                  flags) {
 
# 51 "project/radare2/libr/main/rax2.c" 3 4
unsigned long long 
# 51 "project/radare2/libr/main/rax2.c"
     n = r_num_math (num, s);
 char strbits[65];
 if (force_mode) {
  mode = force_mode;
...
# 57 "project/radare2/libr/main/rax2.c" 3 4
 unsigned long long 
# 57 "project/radare2/libr/main/rax2.c"
      n2 = n;
  r_mem_swapendian ((
# 58 "project/radare2/libr/main/rax2.c" 3 4
                    unsigned char 
# 58 "project/radare2/libr/main/rax2.c"
                        *) &n, (
# 58 "project/radare2/libr/main/rax2.c" 3 4
                                unsigned char 
# 58 "project/radare2/libr/main/rax2.c"
 ...
 case 'I':
  printf ("%" 
# 65 "project/radare2/libr/main/rax2.c" 3 4
             "lld" 
# 65 "project/radare2/libr/main/rax2.c"
                     "\n", n);
  break;
 case '0':
  printf ("0x%" 
# 68 "project/radare2/libr/main/rax2.c" 3 4
               "llx" 
# 68 "project/radare2/libr/main/rax2.c"
                       "\n", n);
  break;
 case 'F': {
  int n2 = (int) n;
...
# 77 "project/radare2/libr/main/rax2.c" 3 4
 switch (0) { case 0: case (
# 77 "project/radare2/libr/main/rax2.c"
 sizeof (float) == 4
# 77 "project/radare2/libr/main/rax2.c" 3 4
 ):; }
# 77 "project/radare2/libr/main/rax2.c"
...
# 79 "project/radare2/libr/main/rax2.c" 3 4
 unsigned int 
# 79 "project/radare2/libr/main/rax2.c"
      *p = (
# 79 "project/radare2/libr/main/rax2.c" 3 4
            unsigned int 
# 79 "project/radare2/libr/main/rax2.c"
  ...
  break;
 case 'O': printf ("0%" 
# 82 "project/radare2/libr/main/rax2.c" 3 4
                       "llo" 
# 82 "project/radare2/libr/main/rax2.c"
                               "\n", n); break;
 case 'B':
  if (n) {
...
# 100 "project/radare2/libr/main/rax2.c" 3 4
 fprintf(__stderrp,
# 100 "project/radare2/libr/main/rax2.c"
...
# 100 "project/radare2/libr/main/rax2.c"
 ...
 return 
# 103 "project/radare2/libr/main/rax2.c" 3 4
       1
# 103 "project/radare2/libr/main/rax2.c"
           ;
}
...
static int help(void) {
 printf (
  ...
  "  -v      version              ;  rax2 -v\n");
 return 
# 158 "project/radare2/libr/main/rax2.c" 3 4
       1
# 158 "project/radare2/libr/main/rax2.c"
           ;
}

static int rax(RNum *num, char *str, int len, int last, 
# 161 "project/radare2/libr/main/rax2.c" 3 4
                                                       unsigned long long 
# 161 "project/radare2/libr/main/rax2.c"
                                                            *_flags, int *fm) {
 
# 162 "project/radare2/libr/main/rax2.c" 3 4
unsigned long long 
# 162 "project/radare2/libr/main/rax2.c"
     flags = *_flags;
 const char *nl = "";
 
# 164 "project/radare2/libr/main/rax2.c" 3 4
unsigned char 
# 164 "project/radare2/libr/main/rax2.c"
    *buf;
  ...
  *fm = force_mode;
  return 
# 184 "project/radare2/libr/main/rax2.c" 3 4
        1
# 184 "project/radare2/libr/main/rax2.c"
            ;
 }
 if (*str == '-') {
  while (str[1] && str[1] != ' ') {
  ...
  *_flags = flags;
  ...
  return 
# 238 "project/radare2/libr/main/rax2.c" 3 4
        1
# 238 "project/radare2/libr/main/rax2.c"
            ;
 }
 *_flags = flags;
 if (!flags && r_str_nlen (str, 2) == 1) {
  if (*str == 'q') {
   return 
# 243 "project/radare2/libr/main/rax2.c" 3 4
         0
# 243 "project/radare2/libr/main/rax2.c"
              ;
  }
  if (*str == 'h' || *str == '?') {
   help ();
   return 
# 247 "project/radare2/libr/main/rax2.c" 3 4
         0
# 247 "project/radare2/libr/main/rax2.c"
              ;
  }
 }
dotherax:
...
# 255 "project/radare2/libr/main/rax2.c" 3 4
  __builtin___memset_chk (
# 255 "project/radare2/libr/main/rax2.c"
  buf
# 255 "project/radare2/libr/main/rax2.c" 3 4
  , 
# 255 "project/radare2/libr/main/rax2.c"
...
# 255 "project/radare2/libr/main/rax2.c"
                       ;
   n = r_hex_str2bin (str, (
# 256 "project/radare2/libr/main/rax2.c" 3 4
                           unsigned char 
# 256 "project/radare2/libr/main/rax2.c"
                               *) buf);
   if (n > 0) {
    fwrite (buf, n, 1, 
# 258 "project/radare2/libr/main/rax2.c" 3 4
                      __stdoutp
# 258 "project/radare2/libr/main/rax2.c"
                            );
   }
   ...
   fflush (
# 267 "project/radare2/libr/main/rax2.c" 3 4
          __stdoutp
# 267 "project/radare2/libr/main/rax2.c"
                );
   free (buf);
  }
  return 
# 270 "project/radare2/libr/main/rax2.c" 3 4
        1
# 270 "project/radare2/libr/main/rax2.c"
            ;
 }
 if (flags & (1 << 2)) {
  for (i = 0; i < len; i++) {
   printf ("%02x", (
# 274 "project/radare2/libr/main/rax2.c" 3 4
                   unsigned char
# 274 "project/radare2/libr/main/rax2.c"
                      ) str[i]);
  }
  printf ("\n");
  return 
# 277 "project/radare2/libr/main/rax2.c" 3 4
        1
# 277 "project/radare2/libr/main/rax2.c"
            ;
 } else if (flags & (1 << 3)) {
  int i;
  
# 280 "project/radare2/libr/main/rax2.c" 3 4
 unsigned char 
# 280 "project/radare2/libr/main/rax2.c"
     buf[4096];
  ...
  return 
# 285 "project/radare2/libr/main/rax2.c" 3 4
        1
# 285 "project/radare2/libr/main/rax2.c"
            ;
 } else if (flags & (1 << 4)) {
  int h = r_str_hash (str);
  printf ("0x%x\n", h);
  return 
# 289 "project/radare2/libr/main/rax2.c" 3 4
        1
# 289 "project/radare2/libr/main/rax2.c"
            ;
 } else if (flags & (1 << 5)) {
  out_mode = 'I';
 } else if (flags & (1 << 6)) {
  ...
  int n = ((strlen (str)) >> 1) + 1;
  char *s = 
# 296 "project/radare2/libr/main/rax2.c" 3 4
           ((void *)0)
# 296 "project/radare2/libr/main/rax2.c"
               ;
  buf = (
# 297 "project/radare2/libr/main/rax2.c" 3 4
        unsigned char 
# 297 "project/radare2/libr/main/rax2.c"
            *) malloc (n);
  if (!buf) {
   return 
# 299 "project/radare2/libr/main/rax2.c" 3 4
         0
# 299 "project/radare2/libr/main/rax2.c"
              ;
  }
  
# 301 "project/radare2/libr/main/rax2.c" 3 4
 unsigned int 
# 301 "project/radare2/libr/main/rax2.c"
      *m = (
# 301 "project/radare2/libr/main/rax2.c" 3 4
            unsigned int 
# 301 "project/radare2/libr/main/rax2.c"
...
# 302 "project/radare2/libr/main/rax2.c" 3 4
 __builtin___memset_chk (
# 302 "project/radare2/libr/main/rax2.c"
 buf
# 302 "project/radare2/libr/main/rax2.c" 3 4
 , 
# 302 "project/radare2/libr/main/rax2.c"
...
# 302 "project/radare2/libr/main/rax2.c"
                      ;
  n = r_hex_str2bin (str, (
# 303 "project/radare2/libr/main/rax2.c" 3 4
                          unsigned char 
# 303 "project/radare2/libr/main/rax2.c"
                              *) buf);
  if (n < 1 || !memcmp (str, "0x", 2)) {
   
# 305 "project/radare2/libr/main/rax2.c" 3 4
  unsigned long long 
# 305 "project/radare2/libr/main/rax2.c"
       q = r_num_math (num, str);
   s = r_print_randomart ((
# 306 "project/radare2/libr/main/rax2.c" 3 4
                          unsigned char 
# 306 "project/radare2/libr/main/rax2.c"
                              *) &q, sizeof (q), q);
   printf ("%s\n", s);
   free (s);
  } else {
   s = r_print_randomart ((
# 310 "project/radare2/libr/main/rax2.c" 3 4
                          unsigned char 
# 310 "project/radare2/libr/main/rax2.c"
                              *) buf, n, *m);
   printf ("%s\n", s);
   free (s);
  }
  free (m);
  return 
# 315 "project/radare2/libr/main/rax2.c" 3 4
        1
# 315 "project/radare2/libr/main/rax2.c"
            ;
 } else if (flags & (1 << 9)) {
  
# 317 "project/radare2/libr/main/rax2.c" 3 4
 unsigned long long 
# 317 "project/radare2/libr/main/rax2.c"
      n = r_num_math (num, str);
  if (n >> 32) {

   if (flags & 1) {
    fwrite (&n, sizeof (n), 1, 
# 321 "project/radare2/libr/main/rax2.c" 3 4
                              __stdoutp
# 321 "project/radare2/libr/main/rax2.c"
                                    );
   } else {
    int i;
    for (i = 0; i < 8; i++) {
...
# 332 "project/radare2/libr/main/rax2.c" 3 4
  unsigned int 
# 332 "project/radare2/libr/main/rax2.c"
       n32 = (
# 332 "project/radare2/libr/main/rax2.c" 3 4
              unsigned int
# 332 "project/radare2/libr/main/rax2.c"
   ...
   if (flags & 1) {
    fwrite (&n32, sizeof (n32), 1, 
# 334 "project/radare2/libr/main/rax2.c" 3 4
                                  __stdoutp
# 334 "project/radare2/libr/main/rax2.c"
                                        );
   } else {
    int i;
    for (i = 0; i < 4; i++) {
  ...
  return 
# 344 "project/radare2/libr/main/rax2.c" 3 4
        1
# 344 "project/radare2/libr/main/rax2.c"
            ;
 } else if (flags & (1 << 17)) {
  int i = 0;
...
# 349 "project/radare2/libr/main/rax2.c" 3 4
  unsigned char 
# 349 "project/radare2/libr/main/rax2.c"
      ch = str[i];
   printf ("%d%d%d%d"
    "%d%d%d%d",
    ch & 128? 1: 0,
  ...
  return 
# 361 "project/radare2/libr/main/rax2.c" 3 4
        1
# 361 "project/radare2/libr/main/rax2.c"
            ;
 } else if (flags & (1 << 16)) {
  
# 363 "project/radare2/libr/main/rax2.c" 3 4
 unsigned long long 
# 363 "project/radare2/libr/main/rax2.c"
      n = r_num_math (num, str);
  if (n >> 31) {

   n = (
# 366 "project/radare2/libr/main/rax2.c" 3 4
       long long
# 366 "project/radare2/libr/main/rax2.c"
           ) (
# 366 "project/radare2/libr/main/rax2.c" 3 4
              int
# 366 "project/radare2/libr/main/rax2.c"
   ...
   n = (
# 368 "project/radare2/libr/main/rax2.c" 3 4
       long long
# 368 "project/radare2/libr/main/rax2.c"
           ) (
# 368 "project/radare2/libr/main/rax2.c" 3 4
              short
# 368 "project/radare2/libr/main/rax2.c"
   ...
   n = (
# 370 "project/radare2/libr/main/rax2.c" 3 4
       long long
# 370 "project/radare2/libr/main/rax2.c"
           ) (
# 370 "project/radare2/libr/main/rax2.c" 3 4
              signed char
# 370 "project/radare2/libr/main/rax2.c"
  ...
  printf ("%" 
# 372 "project/radare2/libr/main/rax2.c" 3 4
             "lld" 
# 372 "project/radare2/libr/main/rax2.c"
                     "\n", n);
  return 
# 373 "project/radare2/libr/main/rax2.c" 3 4
        1
# 373 "project/radare2/libr/main/rax2.c"
            ;
 } else if (flags & (1 << 15)) {
  
# 375 "project/radare2/libr/main/rax2.c" 3 4
 unsigned long long 
# 375 "project/radare2/libr/main/rax2.c"
      n = r_num_math (num, str);
  if (n >> 32) {

   if (flags & 1) {
    fwrite (&n, sizeof (n), 1, 
# 379 "project/radare2/libr/main/rax2.c" 3 4
                              __stdoutp
# 379 "project/radare2/libr/main/rax2.c"
                                    );
   } else {
    int i;
    for (i = 0; i < 8; i++) {
...
# 390 "project/radare2/libr/main/rax2.c" 3 4
  unsigned int 
# 390 "project/radare2/libr/main/rax2.c"
       n32 = (
# 390 "project/radare2/libr/main/rax2.c" 3 4
              unsigned int
# 390 "project/radare2/libr/main/rax2.c"
   ...
   if (flags & 1) {
    fwrite (&n32, sizeof (n32), 1, 
# 392 "project/radare2/libr/main/rax2.c" 3 4
                                  __stdoutp
# 392 "project/radare2/libr/main/rax2.c"
                                        );
   } else {
    int i;
    for (i = 0; i < 4; i++) {
  ...
  return 
# 402 "project/radare2/libr/main/rax2.c" 3 4
        1
# 402 "project/radare2/libr/main/rax2.c"
            ;
 } else if (flags & (1 << 10)) {
  char buf[8];
  r_num_units (buf, sizeof (buf), r_num_math (
# 405 "project/radare2/libr/main/rax2.c" 3 4
                                             ((void *)0)
# 405 "project/radare2/libr/main/rax2.c"
                                                 , str));
  printf ("%s\n", buf);
  return 
# 407 "project/radare2/libr/main/rax2.c" 3 4
        1
# 407 "project/radare2/libr/main/rax2.c"
            ;
 } else if (flags & (1 << 11)) {
  RList *split = r_str_split_list (str, "GMT", 0);
  char *ts = 
# 410 "project/radare2/libr/main/rax2.c" 3 4
            ((
# 410 "project/radare2/libr/main/rax2.c"
            split
# 410 "project/radare2/libr/main/rax2.c" 3 4
            )? (
# 410 "project/radare2/libr/main/rax2.c"
...
# 410 "project/radare2/libr/main/rax2.c"
                               ->data;
  const char *gmt = 
# 411 "project/radare2/libr/main/rax2.c" 3 4
                   ((void *)0)
# 411 "project/radare2/libr/main/rax2.c"
                       ;
  if (r_list_length (split) >= 2 && strlen (
# 412 "project/radare2/libr/main/rax2.c" 3 4
                                           ((
# 412 "project/radare2/libr/main/rax2.c"
                                           split
# 412 "project/radare2/libr/main/rax2.c" 3 4
                                           )? (
# 412 "project/radare2/libr/main/rax2.c"
...
# 412 "project/radare2/libr/main/rax2.c"
                                                              ->n->data) > 2) {
   gmt = (const char*) 
# 413 "project/radare2/libr/main/rax2.c" 3 4
                      ((
# 413 "project/radare2/libr/main/rax2.c"
                      split
# 413 "project/radare2/libr/main/rax2.c" 3 4
                      )? (
# 413 "project/radare2/libr/main/rax2.c"
...
# 415 "project/radare2/libr/main/rax2.c" 3 4
 unsigned int 
# 415 "project/radare2/libr/main/rax2.c"
      n = r_num_math (num, ts);
  RPrint *p = r_print_new ();
  p->big_endian = 
# 417 "project/radare2/libr/main/rax2.c" 3 4
                 0
# 417 "project/radare2/libr/main/rax2.c"
                             ;
  if (gmt) {
   p->datezone = r_num_math (num, gmt);
  }
  r_print_date_unix (p, (const 
# 421 "project/radare2/libr/main/rax2.c" 3 4
                              unsigned char 
# 421 "project/radare2/libr/main/rax2.c"
                                  *) &n, sizeof (
# 421 "project/radare2/libr/main/rax2.c" 3 4
                                                 unsigned int
# 421 "project/radare2/libr/main/rax2.c"
  ...
  r_list_free (split);
  return 
# 424 "project/radare2/libr/main/rax2.c" 3 4
        1
# 424 "project/radare2/libr/main/rax2.c"
            ;
 } else if (flags & (1 << 12)) {
  const int n = strlen (str);

  char *out = calloc (1, (n + 2) / 3 * 4 + 1);
  if (out) {
   r_base64_encode (out, (const 
# 430 "project/radare2/libr/main/rax2.c" 3 4
                               unsigned char 
# 430 "project/radare2/libr/main/rax2.c"
                                   *) str, n);
   printf ("%s%s", out, nl);
   fflush (
# 432 "project/radare2/libr/main/rax2.c" 3 4
          __stdoutp
# 432 "project/radare2/libr/main/rax2.c"
                );
   free (out);
  }
  return 
# 435 "project/radare2/libr/main/rax2.c" 3 4
        1
# 435 "project/radare2/libr/main/rax2.c"
            ;
 } else if (flags & (1 << 13)) {
  const int n = strlen (str);
  
# 438 "project/radare2/libr/main/rax2.c" 3 4
 unsigned char 
# 438 "project/radare2/libr/main/rax2.c"
     *out = calloc (1, n / 4 * 3 + 1);
  if (out) {
   r_base64_decode (out, str, n);
   printf ("%s%s", out, nl);
   fflush (
# 442 "project/radare2/libr/main/rax2.c" 3 4
          __stdoutp
# 442 "project/radare2/libr/main/rax2.c"
                );
   free (out);
  }
  return 
# 445 "project/radare2/libr/main/rax2.c" 3 4
        1
# 445 "project/radare2/libr/main/rax2.c"
            ;
 } else if (flags & 1 << 14) {
  char *s = r_stdin_slurp (
# 447 "project/radare2/libr/main/rax2.c" 3 4
                          ((void *)0)
# 447 "project/radare2/libr/main/rax2.c"
                              );
  if (s) {
   ...
   if (res) {
    printf ("%s\n", res);
    fflush (
# 452 "project/radare2/libr/main/rax2.c" 3 4
           __stdoutp
# 452 "project/radare2/libr/main/rax2.c"
                 );
    free (res);
   } else {
    
# 455 "project/radare2/libr/main/rax2.c" 3 4
   fprintf(__stderrp,
# 455 "project/radare2/libr/main/rax2.c"
   "Invalid input.\n"
# 455 "project/radare2/libr/main/rax2.c" 3 4
   )
# 455 "project/radare2/libr/main/rax2.c"
  ...
  return 
# 459 "project/radare2/libr/main/rax2.c" 3 4
        0
# 459 "project/radare2/libr/main/rax2.c"
             ;
 } else if (flags & (1 << 18)) {
  char *asnum, unit[8];
  char out[128];
  
# 463 "project/radare2/libr/main/rax2.c" 3 4
 unsigned int 
# 463 "project/radare2/libr/main/rax2.c"
      n32, s, a;
  double d;
  float f;
  
# 466 "project/radare2/libr/main/rax2.c" 3 4
 unsigned long long 
# 466 "project/radare2/libr/main/rax2.c"
      n = r_num_math (num, str);

  if (num->dbz) {
   
# 469 "project/radare2/libr/main/rax2.c" 3 4
  fprintf(__stderrp,
# 469 "project/radare2/libr/main/rax2.c"
...
# 469 "project/radare2/libr/main/rax2.c"
                                            ;
   return 
# 470 "project/radare2/libr/main/rax2.c" 3 4
         0
# 470 "project/radare2/libr/main/rax2.c"
              ;
  }
  n32 = (
# 472 "project/radare2/libr/main/rax2.c" 3 4
        unsigned int
# 472 "project/radare2/libr/main/rax2.c"
            ) (n & 
# 472 "project/radare2/libr/main/rax2.c" 3 4
                   0xFFFFFFFFU
# 472 "project/radare2/libr/main/rax2.c"
                           );
  asnum = r_num_as_string (
# 473 "project/radare2/libr/main/rax2.c" 3 4
                          ((void *)0)
# 473 "project/radare2/libr/main/rax2.c"
                              , n, 
# 473 "project/radare2/libr/main/rax2.c" 3 4
                                   0
# 473 "project/radare2/libr/main/rax2.c"
...
# 474 "project/radare2/libr/main/rax2.c" 3 4
 __builtin___memcpy_chk (
# 474 "project/radare2/libr/main/rax2.c"
 &f
# 474 "project/radare2/libr/main/rax2.c" 3 4
 , 
# 474 "project/radare2/libr/main/rax2.c"
...
# 475 "project/radare2/libr/main/rax2.c" 3 4
 __builtin___memcpy_chk (
# 475 "project/radare2/libr/main/rax2.c"
 &d
# 475 "project/radare2/libr/main/rax2.c" 3 4
 , 
# 475 "project/radare2/libr/main/rax2.c"
...
# 500 "project/radare2/libr/main/rax2.c"
    printf ("hex     0x%"
# 500 "project/radare2/libr/main/rax2.c" 3 4
                        "llx"
# 500 "project/radare2/libr/main/rax2.c"
                               "\n", n);
    printf ("octal   0%"
# 501 "project/radare2/libr/main/rax2.c" 3 4
                       "llo"
# 501 "project/radare2/libr/main/rax2.c"
                              "\n", n);
    printf ("unit    %s\n", unit);
    printf ("segment %04x:%04x\n", s, a);
    if (n >> 32) {
     printf ("int64   %"
# 505 "project/radare2/libr/main/rax2.c" 3 4
                       "lld"
# 505 "project/radare2/libr/main/rax2.c"
                              "\n", (
# 505 "project/radare2/libr/main/rax2.c" 3 4
                                     long long
# 505 "project/radare2/libr/main/rax2.c"
     ...
     printf ("int32   %d\n", (
# 507 "project/radare2/libr/main/rax2.c" 3 4
                             int
# 507 "project/radare2/libr/main/rax2.c"
                                 )n);
    }
    if (asnum) {
     printf ("string  \"%s\"\n", asnum);
...
# 515 "project/radare2/libr/main/rax2.c" 3 4
   __builtin___memcpy_chk (
# 515 "project/radare2/libr/main/rax2.c"
   &f
# 515 "project/radare2/libr/main/rax2.c" 3 4
   , 
# 515 "project/radare2/libr/main/rax2.c"
...
# 516 "project/radare2/libr/main/rax2.c" 3 4
   __builtin___memcpy_chk (
# 516 "project/radare2/libr/main/rax2.c"
   &d
# 516 "project/radare2/libr/main/rax2.c" 3 4
   , 
# 516 "project/radare2/libr/main/rax2.c"
...
# 516 "project/radare2/libr/main/rax2.c"
  ...
  return 
# 525 "project/radare2/libr/main/rax2.c" 3 4
        1
# 525 "project/radare2/libr/main/rax2.c"
            ;
 } else if (flags & (1 << 19)) {
  r_print_hex_from_bin (
# 527 "project/radare2/libr/main/rax2.c" 3 4
                       ((void *)0)
# 527 "project/radare2/libr/main/rax2.c"
                           , str);
  return 
# 528 "project/radare2/libr/main/rax2.c" 3 4
        1
# 528 "project/radare2/libr/main/rax2.c"
            ;
 } else if (flags & (1 << 21)) {
  ...
  for (i = 0; i < len-1; i++) {
   ...
   printf ("0x%02x, ", (
# 539 "project/radare2/libr/main/rax2.c" 3 4
                       unsigned char
# 539 "project/radare2/libr/main/rax2.c"
                          ) str[i]);
  }
  ...
  printf ("0x%02x\n", (
# 545 "project/radare2/libr/main/rax2.c" 3 4
                      unsigned char
# 545 "project/radare2/libr/main/rax2.c"
                         ) str[len - 1]);
  printf ("};\n");
  printf ("unsigned int buf_len = %d;\n", len);
  return 
# 548 "project/radare2/libr/main/rax2.c" 3 4
        1
# 548 "project/radare2/libr/main/rax2.c"
            ;
 } else if (flags & (1 << 22)) {
...
# 561 "project/radare2/libr/main/rax2.c" 3 4
 unsigned long long 
# 561 "project/radare2/libr/main/rax2.c"
      n = r_num_math (num, modified_str);
  free (modified_str);
  if (num->dbz) {
   
# 564 "project/radare2/libr/main/rax2.c" 3 4
  fprintf(__stderrp,
# 564 "project/radare2/libr/main/rax2.c"
  "RNum ERROR: Division by Zero\n"
# 564 "project/radare2/libr/main/rax2.c" 3 4
  )
# 564 "project/radare2/libr/main/rax2.c"
                                            ;
   return 
# 565 "project/radare2/libr/main/rax2.c" 3 4
         0
# 565 "project/radare2/libr/main/rax2.c"
              ;
  }

  char *asnum = r_num_as_string (
# 568 "project/radare2/libr/main/rax2.c" 3 4
                                ((void *)0)
# 568 "project/radare2/libr/main/rax2.c"
                                    , n, 
# 568 "project/radare2/libr/main/rax2.c" 3 4
                                         0
# 568 "project/radare2/libr/main/rax2.c"
...
# 573 "project/radare2/libr/main/rax2.c" 3 4
  fprintf(__stderrp,
# 573 "project/radare2/libr/main/rax2.c"
  "No String Possible\n"
# 573 "project/radare2/libr/main/rax2.c" 3 4
  )
# 573 "project/radare2/libr/main/rax2.c"
                                  ;
   return 
# 574 "project/radare2/libr/main/rax2.c" 3 4
         0
# 574 "project/radare2/libr/main/rax2.c"
              ;
  }
  return 
# 576 "project/radare2/libr/main/rax2.c" 3 4
        1
# 576 "project/radare2/libr/main/rax2.c"
            ;
 } else if (flags & (1 << 23)) {
  if (strchr (str, '.')) {
   
# 579 "project/radare2/libr/main/rax2.c" 3 4
  unsigned char 
# 579 "project/radare2/libr/main/rax2.c"
      ip[4];
   sscanf (str, "%hhd.%hhd.%hhd.%hhd", ip, ip + 1, ip + 2, ip + 3);
   
# 581 "project/radare2/libr/main/rax2.c" 3 4
  unsigned int 
# 581 "project/radare2/libr/main/rax2.c"
       ip32 = ip[0] | (ip[1] << 8) | (ip[2] << 16) | (ip[3] << 24);
   printf ("0x%08x\n", ip32);
  } else {
   
# 584 "project/radare2/libr/main/rax2.c" 3 4
  unsigned int 
# 584 "project/radare2/libr/main/rax2.c"
       ip32 = (
# 584 "project/radare2/libr/main/rax2.c" 3 4
               unsigned int
# 584 "project/radare2/libr/main/rax2.c"
...
# 585 "project/radare2/libr/main/rax2.c" 3 4
  unsigned char 
# 585 "project/radare2/libr/main/rax2.c"
      ip[4] = { ip32 & 0xff, (ip32 >> 8) & 0xff, (ip32 >> 16) & 0xff, ip32 >> 24 };
   printf ("%d.%d.%d.%d\n", ip[0], ip[1], ip[2], ip[3]);
  }
  return 
# 588 "project/radare2/libr/main/rax2.c" 3 4
        1
# 588 "project/radare2/libr/main/rax2.c"
            ;
 }
 ...
 return 
# 630 "project/radare2/libr/main/rax2.c" 3 4
       1
# 630 "project/radare2/libr/main/rax2.c"
           ;
}


# 633 "project/radare2/libr/main/rax2.c" 3 4
__attribute__((visibility("default"))) 
# 633 "project/radare2/libr/main/rax2.c"
     int r_main_rax2(int argc, const char **argv) {
 int i, fm = 0;
 RNum *num = r_num_new (
# 635 "project/radare2/libr/main/rax2.c" 3 4
                       ((void *)0)
# 635 "project/radare2/libr/main/rax2.c"
                           , 
# 635 "project/radare2/libr/main/rax2.c" 3 4
                             ((void *)0)
# 635 "project/radare2/libr/main/rax2.c"
...
# 639 "project/radare2/libr/main/rax2.c" 3 4
 unsigned long long 
# 639 "project/radare2/libr/main/rax2.c"
      flags = 0;
  for (i = 1; i < argc; i++) {
 ...
 r_num_free (num);
 num = 
# 648 "project/radare2/libr/main/rax2.c" 3 4
      ((void *)0)
# 648 "project/radare2/libr/main/rax2.c"
          ;
 return 0;
}
