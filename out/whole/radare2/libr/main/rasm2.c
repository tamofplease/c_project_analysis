# 0 "project/radare2/libr/main/rasm2.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/main/rasm2.c"
...
# 4 "project/radare2/libr/main/rasm2.c" 2
...
# 5 "project/radare2/libr/main/rasm2.c" 2
...
# 6 "project/radare2/libr/main/rasm2.c" 2
...
# 11 "project/radare2/libr/main/rasm2.c" 2


# 12 "project/radare2/libr/main/rasm2.c"
typedef struct {
 RLib *l;
 RAsm *a;
 RAnal *anal;
 
# 16 "project/radare2/libr/main/rasm2.c" 3 4
_Bool 
# 16 "project/radare2/libr/main/rasm2.c"
     oneliner;
 
# 17 "project/radare2/libr/main/rasm2.c" 3 4
_Bool 
# 17 "project/radare2/libr/main/rasm2.c"
     coutput;
 
# 18 "project/radare2/libr/main/rasm2.c" 3 4
_Bool 
# 18 "project/radare2/libr/main/rasm2.c"
     json;
 
# 19 "project/radare2/libr/main/rasm2.c" 3 4
_Bool 
# 19 "project/radare2/libr/main/rasm2.c"
     quiet;
} RAsmState;
...
static void __as_set_archbits(RAsmState *as) {
 r_asm_use (as->a, 
# 25 "project/radare2/libr/main/rasm2.c" 3 4
                  "x86"
# 25 "project/radare2/libr/main/rasm2.c"
                            );
 r_anal_use (as->anal, 
# 26 "project/radare2/libr/main/rasm2.c" 3 4
                      "x86"
# 26 "project/radare2/libr/main/rasm2.c"
                                );
 int sysbits = (
# 27 "project/radare2/libr/main/rasm2.c" 3 4
               (4 | 8) 
# 27 "project/radare2/libr/main/rasm2.c"
                          & 
# 27 "project/radare2/libr/main/rasm2.c" 3 4
                            8
# 27 "project/radare2/libr/main/rasm2.c"
...
static RAsmState *__as_new(void) {
 RAsmState *as = 
# 33 "project/radare2/libr/main/rasm2.c" 3 4
                (
# 33 "project/radare2/libr/main/rasm2.c"
                RAsmState
# 33 "project/radare2/libr/main/rasm2.c" 3 4
                *)calloc(1,sizeof(
# 33 "project/radare2/libr/main/rasm2.c"
...
# 33 "project/radare2/libr/main/rasm2.c"
 ...
 if (as) {
  as->l = r_lib_new (
# 35 "project/radare2/libr/main/rasm2.c" 3 4
                    ((void *)0)
# 35 "project/radare2/libr/main/rasm2.c"
                        , 
# 35 "project/radare2/libr/main/rasm2.c" 3 4
                          ((void *)0)
# 35 "project/radare2/libr/main/rasm2.c"
  ...
  if (as->a) {
   as->a->num = r_num_new (
# 38 "project/radare2/libr/main/rasm2.c" 3 4
                          ((void *)0)
# 38 "project/radare2/libr/main/rasm2.c"
                              , 
# 38 "project/radare2/libr/main/rasm2.c" 3 4
                                ((void *)0)
# 38 "project/radare2/libr/main/rasm2.c"
...
static int showanal(RAsmState *as, RAnalOp *op, 
# 69 "project/radare2/libr/main/rasm2.c" 3 4
                                               unsigned long long 
# 69 "project/radare2/libr/main/rasm2.c"
                                                    offset, 
# 69 "project/radare2/libr/main/rasm2.c" 3 4
                                                            unsigned char 
# 69 "project/radare2/libr/main/rasm2.c"
 ...
 if (as->json) {
  ...
  if (op->jump != 
# 82 "project/radare2/libr/main/rasm2.c" 3 4
                 0xFFFFFFFFFFFFFFFFULL
# 82 "project/radare2/libr/main/rasm2.c"
                         ) {
   pj_kn (pj, "jump", op->jump);
  }
  if (op->fail != 
# 85 "project/radare2/libr/main/rasm2.c" 3 4
                 0xFFFFFFFFFFFFFFFFULL
# 85 "project/radare2/libr/main/rasm2.c"
                         ) {
   pj_kn (pj, "fail", op->fail);
  }
  if (op->val != 
# 88 "project/radare2/libr/main/rasm2.c" 3 4
                0xFFFFFFFFFFFFFFFFULL
# 88 "project/radare2/libr/main/rasm2.c"
                        ) {
   pj_kn (pj, "val", op->val);
  }
  if (op->ptr != 
# 91 "project/radare2/libr/main/rasm2.c" 3 4
                0xFFFFFFFFFFFFFFFFULL
# 91 "project/radare2/libr/main/rasm2.c"
                        ) {
   pj_kn (pj, "ptr", op->ptr);
  }
  ...
  printf ("offset:   0x%08" 
# 99 "project/radare2/libr/main/rasm2.c" 3 4
                           "llx" 
# 99 "project/radare2/libr/main/rasm2.c"
                                   "\n", offset);
  printf ("bytes:    %s\n", bytes);
  printf ("type:     %s\n", optype);
  if (op->jump != -1LL) {
   printf ("jump:     0x%08" 
# 103 "project/radare2/libr/main/rasm2.c" 3 4
                            "llx" 
# 103 "project/radare2/libr/main/rasm2.c"
                                    "\n", op->jump);
  }
  if (op->fail != -1LL) {
   printf ("fail:     0x%08" 
# 106 "project/radare2/libr/main/rasm2.c" 3 4
                            "llx" 
# 106 "project/radare2/libr/main/rasm2.c"
                                    "\n", op->fail);
  }
  ...
  if (op->val != -1LL) {
   printf ("value:    0x%08" 
# 111 "project/radare2/libr/main/rasm2.c" 3 4
                            "llx" 
# 111 "project/radare2/libr/main/rasm2.c"
                                    "\n", op->val);
  }
  printf ("stackop:  %s\n", stackop);
  printf ("esil:     %s\n", r_strbuf_get (&op->esil));
  printf ("stackptr: %" 
# 115 "project/radare2/libr/main/rasm2.c" 3 4
                       "lld" 
# 115 "project/radare2/libr/main/rasm2.c"
                               "\n", op->stackptr);
...
static int show_analinfo(RAsmState *as, const char *arg, 
# 125 "project/radare2/libr/main/rasm2.c" 3 4
                                                        unsigned long long 
# 125 "project/radare2/libr/main/rasm2.c"
                                                             offset) {
 
# 126 "project/radare2/libr/main/rasm2.c" 3 4
unsigned char 
# 126 "project/radare2/libr/main/rasm2.c"
    *buf = (
# 126 "project/radare2/libr/main/rasm2.c" 3 4
            unsigned char 
# 126 "project/radare2/libr/main/rasm2.c"
                *)strdup ((const char *)arg);
...
# 142 "project/radare2/libr/main/rasm2.c" 3 4
  fprintf(__stderrp,
# 142 "project/radare2/libr/main/rasm2.c"
  "Error analyzing instruction at 0x%08"
# 142 "project/radare2/libr/main/rasm2.c" 3 4
  "llx"
# 142 "project/radare2/libr/main/rasm2.c"
  "\n", offset
...
# 152 "project/radare2/libr/main/rasm2.c" 3 4
   fprintf(__stderrp,
# 152 "project/radare2/libr/main/rasm2.c"
   "Invalid\n"
# 152 "project/radare2/libr/main/rasm2.c" 3 4
   )
# 152 "project/radare2/libr/main/rasm2.c"
...
# 173 "project/radare2/libr/main/rasm2.c" 3 4
 if (
# 173 "project/radare2/libr/main/rasm2.c"
 as->anal->plugins
# 173 "project/radare2/libr/main/rasm2.c" 3 4
 ) for (
# 173 "project/radare2/libr/main/rasm2.c"
...
static void ranal2_list(RAsmState *as, const char *arch) {
 ...
 RListIter *iter;
 PJ *pj = 
# 186 "project/radare2/libr/main/rasm2.c" 3 4
         ((void *)0)
# 186 "project/radare2/libr/main/rasm2.c"
             ;
 if (as->json) {
  pj = pj_new ();
  pj_a (pj);
...
# 191 "project/radare2/libr/main/rasm2.c" 3 4
if (
# 191 "project/radare2/libr/main/rasm2.c"
as->anal->plugins
# 191 "project/radare2/libr/main/rasm2.c" 3 4
) for (
# 191 "project/radare2/libr/main/rasm2.c"
...
# 194 "project/radare2/libr/main/rasm2.c" 3 4
  __builtin___strcat_chk (
# 194 "project/radare2/libr/main/rasm2.c"
  bits
# 194 "project/radare2/libr/main/rasm2.c" 3 4
  , 
# 194 "project/radare2/libr/main/rasm2.c"
...
# 196 "project/radare2/libr/main/rasm2.c" 3 4
  __builtin___strcat_chk (
# 196 "project/radare2/libr/main/rasm2.c"
  bits
# 196 "project/radare2/libr/main/rasm2.c" 3 4
  , 
# 196 "project/radare2/libr/main/rasm2.c"
...
# 199 "project/radare2/libr/main/rasm2.c" 3 4
   __builtin___strcat_chk (
# 199 "project/radare2/libr/main/rasm2.c"
   bits
# 199 "project/radare2/libr/main/rasm2.c" 3 4
   , 
# 199 "project/radare2/libr/main/rasm2.c"
...
# 202 "project/radare2/libr/main/rasm2.c" 3 4
   __builtin___strcat_chk (
# 202 "project/radare2/libr/main/rasm2.c"
   bits
# 202 "project/radare2/libr/main/rasm2.c" 3 4
   , 
# 202 "project/radare2/libr/main/rasm2.c"
...
# 205 "project/radare2/libr/main/rasm2.c" 3 4
   __builtin___strcat_chk (
# 205 "project/radare2/libr/main/rasm2.c"
   bits
# 205 "project/radare2/libr/main/rasm2.c" 3 4
   , 
# 205 "project/radare2/libr/main/rasm2.c"
...
# 208 "project/radare2/libr/main/rasm2.c" 3 4
   __builtin___strcat_chk (
# 208 "project/radare2/libr/main/rasm2.c"
   bits
# 208 "project/radare2/libr/main/rasm2.c" 3 4
   , 
# 208 "project/radare2/libr/main/rasm2.c"
...
# 211 "project/radare2/libr/main/rasm2.c" 3 4
   __builtin___strcat_chk (
# 211 "project/radare2/libr/main/rasm2.c"
   bits
# 211 "project/radare2/libr/main/rasm2.c" 3 4
   , 
# 211 "project/radare2/libr/main/rasm2.c"
...
# 263 "project/radare2/libr/main/rasm2.c" 3 4
if (
# 263 "project/radare2/libr/main/rasm2.c"
as->a->plugins
# 263 "project/radare2/libr/main/rasm2.c" 3 4
) for (
# 263 "project/radare2/libr/main/rasm2.c"
...
# 277 "project/radare2/libr/main/rasm2.c" 3 4
   __builtin___strcat_chk (
# 277 "project/radare2/libr/main/rasm2.c"
   bits
# 277 "project/radare2/libr/main/rasm2.c" 3 4
   , 
# 277 "project/radare2/libr/main/rasm2.c"
...
# 279 "project/radare2/libr/main/rasm2.c" 3 4
   __builtin___strcat_chk (
# 279 "project/radare2/libr/main/rasm2.c"
   bits
# 279 "project/radare2/libr/main/rasm2.c" 3 4
   , 
# 279 "project/radare2/libr/main/rasm2.c"
...
# 282 "project/radare2/libr/main/rasm2.c" 3 4
    __builtin___strcat_chk (
# 282 "project/radare2/libr/main/rasm2.c"
    bits
# 282 "project/radare2/libr/main/rasm2.c" 3 4
    , 
# 282 "project/radare2/libr/main/rasm2.c"
...
# 285 "project/radare2/libr/main/rasm2.c" 3 4
    __builtin___strcat_chk (
# 285 "project/radare2/libr/main/rasm2.c"
    bits
# 285 "project/radare2/libr/main/rasm2.c" 3 4
    , 
# 285 "project/radare2/libr/main/rasm2.c"
...
# 288 "project/radare2/libr/main/rasm2.c" 3 4
    __builtin___strcat_chk (
# 288 "project/radare2/libr/main/rasm2.c"
    bits
# 288 "project/radare2/libr/main/rasm2.c" 3 4
    , 
# 288 "project/radare2/libr/main/rasm2.c"
...
# 291 "project/radare2/libr/main/rasm2.c" 3 4
    __builtin___strcat_chk (
# 291 "project/radare2/libr/main/rasm2.c"
    bits
# 291 "project/radare2/libr/main/rasm2.c" 3 4
    , 
# 291 "project/radare2/libr/main/rasm2.c"
...
# 294 "project/radare2/libr/main/rasm2.c" 3 4
    __builtin___strcat_chk (
# 294 "project/radare2/libr/main/rasm2.c"
    bits
# 294 "project/radare2/libr/main/rasm2.c" 3 4
    , 
# 294 "project/radare2/libr/main/rasm2.c"
...
static int rasm_disasm(RAsmState *as, 
# 425 "project/radare2/libr/main/rasm2.c" 3 4
                                     unsigned long long 
# 425 "project/radare2/libr/main/rasm2.c"
                                          addr, const char *buf, int len, int bits, int bin, int hex) {
 RAsmCode *acode;
 
# 427 "project/radare2/libr/main/rasm2.c" 3 4
unsigned char 
# 427 "project/radare2/libr/main/rasm2.c"
    *data = 
# 427 "project/radare2/libr/main/rasm2.c" 3 4
            ((void *)0)
# 427 "project/radare2/libr/main/rasm2.c"
...
# 429 "project/radare2/libr/main/rasm2.c" 3 4
unsigned long long 
# 429 "project/radare2/libr/main/rasm2.c"
     clen = 0;
 if (bits == 1) {
  len /= 8;
 }
 if (bin) {
  if (len < 0) {
   return 
# 435 "project/radare2/libr/main/rasm2.c" 3 4
         0
# 435 "project/radare2/libr/main/rasm2.c"
              ;
  }
  clen = len;
  data = (
# 438 "project/radare2/libr/main/rasm2.c" 3 4
         unsigned char 
# 438 "project/radare2/libr/main/rasm2.c"
             *)buf;
 } else {
  clen = r_hex_str2bin (buf, 
# 440 "project/radare2/libr/main/rasm2.c" 3 4
                            ((void *)0)
# 440 "project/radare2/libr/main/rasm2.c"
                                );
 ...
 if (hex == 2) {
  ...
  while (ret < len) {
   ...
   if (r_anal_op (as->anal, &aop, addr, data + ret, len - ret, R_ANAL_OP_MASK_ESIL) > 0) {
    printf ("%s\n", 
# 458 "project/radare2/libr/main/rasm2.c" 3 4
                   (r_strbuf_get (
# 458 "project/radare2/libr/main/rasm2.c"
                   &aop.esil
# 458 "project/radare2/libr/main/rasm2.c" 3 4
                   ) ? r_strbuf_get (
# 458 "project/radare2/libr/main/rasm2.c"
...
# 461 "project/radare2/libr/main/rasm2.c" 3 4
   fprintf(__stderrp,
# 461 "project/radare2/libr/main/rasm2.c"
   "Invalid\n"
# 461 "project/radare2/libr/main/rasm2.c" 3 4
   )
# 461 "project/radare2/libr/main/rasm2.c"
  ...
  while ((len - ret) > 0) {
   ...
   printf ("0x%08" 
# 477 "project/radare2/libr/main/rasm2.c" 3 4
                  "llx" 
# 477 "project/radare2/libr/main/rasm2.c"
                          "  %2d %24s  %s\n",
...
beach:
 if (data && data != (
# 499 "project/radare2/libr/main/rasm2.c" 3 4
                     unsigned char 
# 499 "project/radare2/libr/main/rasm2.c"
                         *)buf) {
  free (data);
 }
 return ret;
...
static 
# 522 "project/radare2/libr/main/rasm2.c" 3 4
      _Bool 
# 522 "project/radare2/libr/main/rasm2.c"
           print_label(void *user, const void *k, const void *v) {
 printf ("f label.%s = %s\n", (const char *)k, (const char *)v);
 return 
# 524 "project/radare2/libr/main/rasm2.c" 3 4
       1
# 524 "project/radare2/libr/main/rasm2.c"
           ;
}

static int rasm_asm(RAsmState *as, const char *buf, 
# 527 "project/radare2/libr/main/rasm2.c" 3 4
                                                   unsigned long long 
# 527 "project/radare2/libr/main/rasm2.c"
                                                        offset, 
# 527 "project/radare2/libr/main/rasm2.c" 3 4
                                                                unsigned long long 
# 527 "project/radare2/libr/main/rasm2.c"
                                                                     len, int bits, int bin, 
# 527 "project/radare2/libr/main/rasm2.c" 3 4
                                                                                             _Bool 
# 527 "project/radare2/libr/main/rasm2.c"
                                                                                                  use_spp, 
...
# 538 "project/radare2/libr/main/rasm2.c" 3 4
   fprintf(__stderrp,
# 538 "project/radare2/libr/main/rasm2.c"
...
# 538 "project/radare2/libr/main/rasm2.c"
   ...
   if (bits == 1) {
    ...
    if (hexwords) {
     size_t i = 0;
     for (i = 0; i < acode->len; i += sizeof (
# 555 "project/radare2/libr/main/rasm2.c" 3 4
                                             unsigned int
# 555 "project/radare2/libr/main/rasm2.c"
                                                 )) {
      
# 556 "project/radare2/libr/main/rasm2.c" 3 4
     unsigned int 
# 556 "project/radare2/libr/main/rasm2.c"
          dword = r_read_ble32 (acode->bytes + i, 
# 556 "project/radare2/libr/main/rasm2.c" 3 4
                                                  0
# 556 "project/radare2/libr/main/rasm2.c"
                                                              );
...
static int __lib_asm_cb(RLibPlugin *pl, void *user, void *data) {
 ...
 r_asm_add (as->a, hand);
 return 
# 582 "project/radare2/libr/main/rasm2.c" 3 4
       1
# 582 "project/radare2/libr/main/rasm2.c"
           ;
}
...
static int __lib_anal_cb(RLibPlugin *pl, void *user, void *data) {
 ...
 return 
# 590 "project/radare2/libr/main/rasm2.c" 3 4
       1
# 590 "project/radare2/libr/main/rasm2.c"
           ;
}

static int print_assembly_output(RAsmState *as, const char *buf, 
# 593 "project/radare2/libr/main/rasm2.c" 3 4
                                                                unsigned long long 
# 593 "project/radare2/libr/main/rasm2.c"
                                                                     offset, 
# 593 "project/radare2/libr/main/rasm2.c" 3 4
                                                                             unsigned long long 
# 593 "project/radare2/libr/main/rasm2.c"
...
# 593 "project/radare2/libr/main/rasm2.c" 3 4
                                                                                                                                  _Bool 
# 593 "project/radare2/libr/main/rasm2.c"
                                                                                                                                       hexwords, const char *arch) {
 if (rad) {
  printf ("e asm.arch=%s\n", arch? arch: 
# 595 "project/radare2/libr/main/rasm2.c" 3 4
                                        "x86"
# 595 "project/radare2/libr/main/rasm2.c"
                                                  );
  printf ("e asm.bits=%d\n", bits? bits: 
# 596 "project/radare2/libr/main/rasm2.c" 3 4
                                        (4 | 8)
# 596 "project/radare2/libr/main/rasm2.c"
                                                  );
  if (offset) {
   printf ("s 0x%"
# 598 "project/radare2/libr/main/rasm2.c" 3 4
                 "llx"
# 598 "project/radare2/libr/main/rasm2.c"
                        "\n", offset);
  }
  printf ("wx ");
 }
 ...
 if (rad) {
  ...
  ht_pp_foreach (as->a->flags, print_label, 
# 606 "project/radare2/libr/main/rasm2.c" 3 4
                                           ((void *)0)
# 606 "project/radare2/libr/main/rasm2.c"
                                               );
 }
 return ret;
}
...
static void __load_plugins(RAsmState *as) {
 ...
 r_lib_add_handler (as->l, R_LIB_TYPE_ASM, "(dis)assembly plugins", &__lib_asm_cb, 
# 617 "project/radare2/libr/main/rasm2.c" 3 4
                                                                                  ((void *)0)
# 617 "project/radare2/libr/main/rasm2.c"
                                                                                      , as);
 r_lib_add_handler (as->l, R_LIB_TYPE_ANAL, "analysis/emulation plugins", &__lib_anal_cb, 
# 618 "project/radare2/libr/main/rasm2.c" 3 4
                                                                                         ((void *)0)
# 618 "project/radare2/libr/main/rasm2.c"
                                                                                             , as);

 char *path = r_sys_getenv (
# 620 "project/radare2/libr/main/rasm2.c" 3 4
                           "R2_LIBR_PLUGINS"
# 620 "project/radare2/libr/main/rasm2.c"
                                    );
 if (path && *path) {
...
# 626 "project/radare2/libr/main/rasm2.c" 3 4
                                  ".local" "/" "share" "/" "radare2" "/" "plugins"
# 626 "project/radare2/libr/main/rasm2.c"
                                                 );
 r_lib_opendir (as->l, homeplugindir);
 free (homeplugindir);


 char *plugindir = r_str_r2_prefix (
# 631 "project/radare2/libr/main/rasm2.c" 3 4
                                   "lib/radare2/" "5.5.4"
# 631 "project/radare2/libr/main/rasm2.c"
                                             );
 char *extrasdir = r_str_r2_prefix (
# 632 "project/radare2/libr/main/rasm2.c" 3 4
                                   "lib/radare2-extras/" "5.5.4"
# 632 "project/radare2/libr/main/rasm2.c"
                                            );
 char *bindingsdir = r_str_r2_prefix (
# 633 "project/radare2/libr/main/rasm2.c" 3 4
                                     "lib/radare2-bindings/" "5.5.4"
# 633 "project/radare2/libr/main/rasm2.c"
                                                );
...
# 645 "project/radare2/libr/main/rasm2.c" 3 4
__attribute__((visibility("default"))) 
# 645 "project/radare2/libr/main/rasm2.c"
 ...
 const char *arch = 
# 648 "project/radare2/libr/main/rasm2.c" 3 4
                   "x86"
# 648 "project/radare2/libr/main/rasm2.c"
                             ;
 const char *cpu = 
# 649 "project/radare2/libr/main/rasm2.c" 3 4
                  ((void *)0)
# 649 "project/radare2/libr/main/rasm2.c"
                      ;
 const char *kernel = 
# 650 "project/radare2/libr/main/rasm2.c" 3 4
                     ((void *)0)
# 650 "project/radare2/libr/main/rasm2.c"
                         ;
 const char *filters = 
# 651 "project/radare2/libr/main/rasm2.c" 3 4
                      ((void *)0)
# 651 "project/radare2/libr/main/rasm2.c"
                          ;
 const char *file = 
# 652 "project/radare2/libr/main/rasm2.c" 3 4
                   ((void *)0)
# 652 "project/radare2/libr/main/rasm2.c"
                       ;
 
# 653 "project/radare2/libr/main/rasm2.c" 3 4
_Bool 
# 653 "project/radare2/libr/main/rasm2.c"
     list_plugins = 
# 653 "project/radare2/libr/main/rasm2.c" 3 4
                    0
# 653 "project/radare2/libr/main/rasm2.c"
...
# 654 "project/radare2/libr/main/rasm2.c" 3 4
_Bool 
# 654 "project/radare2/libr/main/rasm2.c"
     list_anal_plugins = 
# 654 "project/radare2/libr/main/rasm2.c" 3 4
                         0
# 654 "project/radare2/libr/main/rasm2.c"
...
# 655 "project/radare2/libr/main/rasm2.c" 3 4
_Bool 
# 655 "project/radare2/libr/main/rasm2.c"
     isbig = 
# 655 "project/radare2/libr/main/rasm2.c" 3 4
             0
# 655 "project/radare2/libr/main/rasm2.c"
...
# 656 "project/radare2/libr/main/rasm2.c" 3 4
_Bool 
# 656 "project/radare2/libr/main/rasm2.c"
     rad = 
# 656 "project/radare2/libr/main/rasm2.c" 3 4
           0
# 656 "project/radare2/libr/main/rasm2.c"
...
# 657 "project/radare2/libr/main/rasm2.c" 3 4
_Bool 
# 657 "project/radare2/libr/main/rasm2.c"
     use_spp = 
# 657 "project/radare2/libr/main/rasm2.c" 3 4
               0
# 657 "project/radare2/libr/main/rasm2.c"
...
# 658 "project/radare2/libr/main/rasm2.c" 3 4
_Bool 
# 658 "project/radare2/libr/main/rasm2.c"
     hexwords = 
# 658 "project/radare2/libr/main/rasm2.c" 3 4
                0
# 658 "project/radare2/libr/main/rasm2.c"
...
# 659 "project/radare2/libr/main/rasm2.c" 3 4
unsigned long long 
# 659 "project/radare2/libr/main/rasm2.c"
     offset = 0;
 int fd = -1, dis = 0, bin = 0, ret = 0, bits = 32, c, whatsop = 0;
 int help = 0;
 
# 662 "project/radare2/libr/main/rasm2.c" 3 4
unsigned long long 
# 662 "project/radare2/libr/main/rasm2.c"
     len = 0, idx = 0, skip = 0;
 
# 663 "project/radare2/libr/main/rasm2.c" 3 4
_Bool 
# 663 "project/radare2/libr/main/rasm2.c"
     analinfo = 
# 663 "project/radare2/libr/main/rasm2.c" 3 4
                0
# 663 "project/radare2/libr/main/rasm2.c"
 ...
 if (r2bits) {
  bits = r_num_math (
# 679 "project/radare2/libr/main/rasm2.c" 3 4
                    ((void *)0)
# 679 "project/radare2/libr/main/rasm2.c"
                        , r2bits);
  free (r2bits);
 }
 ...
 while ((c = r_getopt_next (&opt)) != -1) {
  ...
  case 'A':
   analinfo = 
# 691 "project/radare2/libr/main/rasm2.c" 3 4
             1
# 691 "project/radare2/libr/main/rasm2.c"
                 ;
   break;
  case 'b':
   bits = r_num_math (
# 694 "project/radare2/libr/main/rasm2.c" 3 4
                     ((void *)0)
# 694 "project/radare2/libr/main/rasm2.c"
                         , opt.arg);
   break;
  case 'B':
   bin = 1;
  ...
  case 'C':
   as->coutput = 
# 703 "project/radare2/libr/main/rasm2.c" 3 4
                1
# 703 "project/radare2/libr/main/rasm2.c"
                    ;
   break;
  case 'd':
   dis = 1;
  ...
  case 'e':
   isbig = 
# 712 "project/radare2/libr/main/rasm2.c" 3 4
          1
# 712 "project/radare2/libr/main/rasm2.c"
              ;
   break;
  case 'E':
   dis = 3;
  ...
  case 'i':
   skip = r_num_math (
# 726 "project/radare2/libr/main/rasm2.c" 3 4
                     ((void *)0)
# 726 "project/radare2/libr/main/rasm2.c"
                         , opt.arg);
   break;
  case 'j':
   as->json = 
# 729 "project/radare2/libr/main/rasm2.c" 3 4
             1
# 729 "project/radare2/libr/main/rasm2.c"
                 ;
   break;
  case 'k':
   kernel = opt.arg;
  ...
  case 'l':
   len = r_num_math (
# 735 "project/radare2/libr/main/rasm2.c" 3 4
                    ((void *)0)
# 735 "project/radare2/libr/main/rasm2.c"
                        , opt.arg);
   break;
  case 'L':
   if (list_plugins) {
    list_anal_plugins = 
# 739 "project/radare2/libr/main/rasm2.c" 3 4
                       1
# 739 "project/radare2/libr/main/rasm2.c"
                           ;
   } else {
    list_plugins = 
# 741 "project/radare2/libr/main/rasm2.c" 3 4
                  1
# 741 "project/radare2/libr/main/rasm2.c"
                      ;
   }
   break;
  case '@':
  case 'o':
   offset = r_num_math (
# 746 "project/radare2/libr/main/rasm2.c" 3 4
                       ((void *)0)
# 746 "project/radare2/libr/main/rasm2.c"
                           , opt.arg);
   break;
  case 'O':
   fd = open (opt.arg, 
# 749 "project/radare2/libr/main/rasm2.c" 3 4
                      0x00000400 
# 749 "project/radare2/libr/main/rasm2.c"
                              | 
# 749 "project/radare2/libr/main/rasm2.c" 3 4
                                0x0002 
# 749 "project/radare2/libr/main/rasm2.c"
...
# 749 "project/radare2/libr/main/rasm2.c"
  ...
  case 'p':
   use_spp = 
# 757 "project/radare2/libr/main/rasm2.c" 3 4
            1
# 757 "project/radare2/libr/main/rasm2.c"
                ;
   break;
  case 'q':
   as->quiet = 
# 760 "project/radare2/libr/main/rasm2.c" 3 4
              1
# 760 "project/radare2/libr/main/rasm2.c"
                  ;
   break;
  case 'r':
   rad = 
# 763 "project/radare2/libr/main/rasm2.c" 3 4
        1
# 763 "project/radare2/libr/main/rasm2.c"
            ;
   break;
  case 's':
   if (*opt.arg == '?') {
  ...
  case 'v':
   if (as->quiet) {
    printf ("%s\n", 
# 781 "project/radare2/libr/main/rasm2.c" 3 4
                   "5.5.4"
# 781 "project/radare2/libr/main/rasm2.c"
                             );
   } else {
  ...
  case 'w':
   whatsop = 
# 787 "project/radare2/libr/main/rasm2.c" 3 4
            1
# 787 "project/radare2/libr/main/rasm2.c"
                ;
   break;
  case 'x':
   hexwords = 
# 790 "project/radare2/libr/main/rasm2.c" 3 4
             1
# 790 "project/radare2/libr/main/rasm2.c"
                 ;
   break;
  default:
...
# 815 "project/radare2/libr/main/rasm2.c" 3 4
  fprintf(__stderrp,
# 815 "project/radare2/libr/main/rasm2.c"
  "rasm2: Unknown asm plugin '%s'\n", arch
# 815 "project/radare2/libr/main/rasm2.c" 3 4
  )
# 815 "project/radare2/libr/main/rasm2.c"
                                                    ;
...
# 822 "project/radare2/libr/main/rasm2.c" 3 4
  fprintf(__stderrp,
# 822 "project/radare2/libr/main/rasm2.c"
  "rasm2: Unknown asm plugin '%s'\n", env_arch
# 822 "project/radare2/libr/main/rasm2.c" 3 4
  )
# 822 "project/radare2/libr/main/rasm2.c"
 ...
 } else if (!r_asm_use (as->a, 
# 826 "project/radare2/libr/main/rasm2.c" 3 4
                              "x86"
# 826 "project/radare2/libr/main/rasm2.c"
                                        )) {
  
# 827 "project/radare2/libr/main/rasm2.c" 3 4
 fprintf(__stderrp,
# 827 "project/radare2/libr/main/rasm2.c"
 "rasm2: Cannot find asm.x86 plugin\n"
# 827 "project/radare2/libr/main/rasm2.c" 3 4
 )
# 827 "project/radare2/libr/main/rasm2.c"
                                                ;
...
# 839 "project/radare2/libr/main/rasm2.c" 3 4
 _Bool 
# 839 "project/radare2/libr/main/rasm2.c"
      canbebig = r_asm_set_big_endian (as->a, isbig);
  if (isbig && !canbebig) {
   
# 841 "project/radare2/libr/main/rasm2.c" 3 4
  fprintf(__stderrp,
# 841 "project/radare2/libr/main/rasm2.c"
...
# 879 "project/radare2/libr/main/rasm2.c" 3 4
  unsigned char 
# 879 "project/radare2/libr/main/rasm2.c"
      *buf = (
# 879 "project/radare2/libr/main/rasm2.c" 3 4
              unsigned char 
# 879 "project/radare2/libr/main/rasm2.c"
...
# 881 "project/radare2/libr/main/rasm2.c" 3 4
   fprintf(__stderrp,
# 881 "project/radare2/libr/main/rasm2.c"
   "Nothing to do.\n"
# 881 "project/radare2/libr/main/rasm2.c" 3 4
   )
# 881 "project/radare2/libr/main/rasm2.c"
   ...
   len = (
# 884 "project/radare2/libr/main/rasm2.c" 3 4
         unsigned long long
# 884 "project/radare2/libr/main/rasm2.c"
             )sz;
   if (dis) {
    if (skip && length > skip) {
     if (bin) {
      
# 888 "project/radare2/libr/main/rasm2.c" 3 4
     __builtin___memmove_chk (
# 888 "project/radare2/libr/main/rasm2.c"
     buf
# 888 "project/radare2/libr/main/rasm2.c" 3 4
     , 
# 888 "project/radare2/libr/main/rasm2.c"
     buf + skip, length - skip
# 888 "project/radare2/libr/main/rasm2.c" 3 4
     , __builtin_object_size (
# 888 "project/radare2/libr/main/rasm2.c"
     buf
...
# 888 "project/radare2/libr/main/rasm2.c"
   ...
   if (content) {
    if (length > 
# 904 "project/radare2/libr/main/rasm2.c" 3 4
                0x7FFFFFFF
# 904 "project/radare2/libr/main/rasm2.c"
                        ) {
     
# 905 "project/radare2/libr/main/rasm2.c" 3 4
    fprintf(__stderrp,
# 905 "project/radare2/libr/main/rasm2.c"
    "rasm2: File %s is too big\n", file
# 905 "project/radare2/libr/main/rasm2.c" 3 4
    )
# 905 "project/radare2/libr/main/rasm2.c"
                                                 ;
...
# 914 "project/radare2/libr/main/rasm2.c" 3 4
      __builtin___memmove_chk (
# 914 "project/radare2/libr/main/rasm2.c"
      content
# 914 "project/radare2/libr/main/rasm2.c" 3 4
      , 
# 914 "project/radare2/libr/main/rasm2.c"
      content + skip, length - skip
# 914 "project/radare2/libr/main/rasm2.c" 3 4
      , __builtin_object_size (
# 914 "project/radare2/libr/main/rasm2.c"
      content
...
# 931 "project/radare2/libr/main/rasm2.c" 3 4
   fprintf(__stderrp,
# 931 "project/radare2/libr/main/rasm2.c"
   "rasm2: Cannot open file %s\n", file
# 931 "project/radare2/libr/main/rasm2.c" 3 4
   )
# 931 "project/radare2/libr/main/rasm2.c"
                                                 ;
  ...
  if (!strcmp (opt.argv[opt.ind], "-")) {
   ...
   do {
    ...
    buf[length] = 0;
    if ((!bin || !dis) && feof (
# 948 "project/radare2/libr/main/rasm2.c" 3 4
                               __stdinp
# 948 "project/radare2/libr/main/rasm2.c"
                                    )) {
     break;
    }
    if (skip && length > skip) {
...
# 953 "project/radare2/libr/main/rasm2.c" 3 4
     __builtin___memmove_chk (
# 953 "project/radare2/libr/main/rasm2.c"
     buf
# 953 "project/radare2/libr/main/rasm2.c" 3 4
     , 
# 953 "project/radare2/libr/main/rasm2.c"
     buf + skip, length - skip + 1
# 953 "project/radare2/libr/main/rasm2.c" 3 4
     , __builtin_object_size (
# 953 "project/radare2/libr/main/rasm2.c"
     buf
...
# 985 "project/radare2/libr/main/rasm2.c" 3 4
   __builtin___memmove_chk (
# 985 "project/radare2/libr/main/rasm2.c"
   usrstr
# 985 "project/radare2/libr/main/rasm2.c" 3 4
   , 
# 985 "project/radare2/libr/main/rasm2.c"
   usrstr + skip, len - skip
# 985 "project/radare2/libr/main/rasm2.c" 3 4
   , __builtin_object_size (
# 985 "project/radare2/libr/main/rasm2.c"
   usrstr
...
# 991 "project/radare2/libr/main/rasm2.c" 3 4
   __builtin___memmove_chk (
# 991 "project/radare2/libr/main/rasm2.c"
   usrstr
# 991 "project/radare2/libr/main/rasm2.c" 3 4
   , 
# 991 "project/radare2/libr/main/rasm2.c"
...
# 991 "project/radare2/libr/main/rasm2.c"
   ...
   if (rad) {
    as->oneliner = 
# 994 "project/radare2/libr/main/rasm2.c" 3 4
                  1
# 994 "project/radare2/libr/main/rasm2.c"
                      ;
    printf ("e asm.arch=%s\n", arch? arch: 
# 995 "project/radare2/libr/main/rasm2.c" 3 4
                                          "x86"
# 995 "project/radare2/libr/main/rasm2.c"
                                                    );
    printf ("e asm.bits=%d\n", bits);
    printf ("\"wa ");
   }
...
# 1009 "project/radare2/libr/main/rasm2.c" 3 4
  fprintf(__stderrp,
# 1009 "project/radare2/libr/main/rasm2.c"
  "invalid\n"
# 1009 "project/radare2/libr/main/rasm2.c" 3 4
  )
# 1009 "project/radare2/libr/main/rasm2.c"
