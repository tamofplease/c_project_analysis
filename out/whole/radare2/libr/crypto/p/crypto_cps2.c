# 0 "project/radare2/libr/crypto/p/crypto_cps2.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/crypto/p/crypto_cps2.c"
...
# 13 "project/radare2/libr/crypto/p/crypto_cps2.c" 2
...
# 14 "project/radare2/libr/crypto/p/crypto_cps2.c" 2
# 130 "project/radare2/libr/crypto/p/crypto_cps2.c"
...
struct sbox {
 const 
# 143 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
      unsigned char 
# 143 "project/radare2/libr/crypto/p/crypto_cps2.c"
          table[64];
 const int inputs[6];
 const int outputs[2];
};
...
# 152 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
unsigned char 
# 152 "project/radare2/libr/crypto/p/crypto_cps2.c"
    input_lookup[256];
 
# 153 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
unsigned char 
# 153 "project/radare2/libr/crypto/p/crypto_cps2.c"
    output[64];
};
...
static 
# 440 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
      unsigned char 
# 440 "project/radare2/libr/crypto/p/crypto_cps2.c"
          fn(
# 440 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
             unsigned char 
# 440 "project/radare2/libr/crypto/p/crypto_cps2.c"
                 in, const struct optimised_sbox *sboxes, 
# 440 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
                                                          unsigned int 
# 440 "project/radare2/libr/crypto/p/crypto_cps2.c"
                                                               key) {
...
static void expand_1st_key(
# 455 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
                          unsigned int 
# 455 "project/radare2/libr/crypto/p/crypto_cps2.c"
                               *dstkey, const 
# 455 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
                                              unsigned int 
# 455 "project/radare2/libr/crypto/p/crypto_cps2.c"
 ...
 for (i = 0; i < 96; i++) {
  dstkey[i / 24] |= (((srckey[bits[i] / 32])>>(bits[i] % 32))&1) << (i % 24);
 }
}



static void expand_2nd_key(
# 488 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
                          unsigned int 
# 488 "project/radare2/libr/crypto/p/crypto_cps2.c"
                               *dstkey, const 
# 488 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
                                              unsigned int 
# 488 "project/radare2/libr/crypto/p/crypto_cps2.c"
...
static void expand_subkey(
# 522 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
                         unsigned int
# 522 "project/radare2/libr/crypto/p/crypto_cps2.c"
                             * subkey, 
# 522 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
                                       unsigned short 
# 522 "project/radare2/libr/crypto/p/crypto_cps2.c"
 ...
 for (i = 0; i < 64; i++) {
  subkey[i / 32] |= (((seed)>>(bits[i]))&1) << (i % 32);
 }
}

static inline 
# 540 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
             unsigned short 
# 540 "project/radare2/libr/crypto/p/crypto_cps2.c"
                  feistel(
# 540 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
                          unsigned short 
# 540 "project/radare2/libr/crypto/p/crypto_cps2.c"
                               val, const int *bitsA, const int *bitsB,
...
# 543 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
 unsigned int 
# 543 "project/radare2/libr/crypto/p/crypto_cps2.c"
      key1, 
# 543 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
            unsigned int 
# 543 "project/radare2/libr/crypto/p/crypto_cps2.c"
...
# 545 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
unsigned char 
# 545 "project/radare2/libr/crypto/p/crypto_cps2.c"
    l = (((((val)>>(bitsB[7]))&1) << 7) | ((((val)>>(bitsB[6]))&1) << 6) | ((((val)>>(bitsB[5]))&1) << 5) | ((((val)>>(bitsB[4]))&1) << 4) | ((((val)>>(bitsB[3]))&1) << 3) | ((((val)>>(bitsB[2]))&1) << 2) | ((((val)>>(bitsB[1]))&1) << 1) | ((((val)>>(bitsB[0]))&1) << 0));
 
# 546 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
unsigned char 
# 546 "project/radare2/libr/crypto/p/crypto_cps2.c"
    r = (((((val)>>(bitsA[7]))&1) << 7) | ((((val)>>(bitsA[6]))&1) << 6) | ((((val)>>(bitsA[5]))&1) << 5) | ((((val)>>(bitsA[4]))&1) << 4) | ((((val)>>(bitsA[3]))&1) << 3) | ((((val)>>(bitsA[2]))&1) << 2) | ((((val)>>(bitsA[1]))&1) << 1) | ((((val)>>(bitsA[0]))&1) << 0));
...
static int extract_inputs(
# 572 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
                         unsigned int 
# 572 "project/radare2/libr/crypto/p/crypto_cps2.c"
                              val, const int *inputs) {
 int i, res = 0;
 for (i = 0; i < 6; i++) {
  if (inputs[i] != -1) {
   res |= (((val)>>(inputs[i]))&1) << i;
  }
 }
 return res;
}
...
static void cps2_crypt(int dir, const 
# 604 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
                                     unsigned short 
# 604 "project/radare2/libr/crypto/p/crypto_cps2.c"
                                          *rom, 
# 604 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
                                                unsigned short 
# 604 "project/radare2/libr/crypto/p/crypto_cps2.c"
                                                     *dec, int length, const 
# 604 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
                                                                             unsigned int 
# 604 "project/radare2/libr/crypto/p/crypto_cps2.c"
                                                                                  *master_key, 
...
# 606 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
unsigned int 
# 606 "project/radare2/libr/crypto/p/crypto_cps2.c"
     key1[4];
 ...
 key1[0] ^= (((key1[0])>>(1))&1) << 4;
 key1[0] ^= (((key1[0])>>(2))&1) << 5;
 key1[0] ^= (((key1[0])>>(8))&1) << 11;
 key1[1] ^= (((key1[1])>>(0))&1) << 5;
 key1[1] ^= (((key1[1])>>(8))&1) << 11;
 key1[2] ^= (((key1[2])>>(1))&1) << 5;
 key1[2] ^= (((key1[2])>>(8))&1) << 11;

 for (i = 0; i < 0x10000; i++) {
  int a;
  
# 634 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
 unsigned short 
# 634 "project/radare2/libr/crypto/p/crypto_cps2.c"
      seed;
  
# 635 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
 unsigned int 
# 635 "project/radare2/libr/crypto/p/crypto_cps2.c"
      subkey[2];
  
# 636 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
 unsigned int 
# 636 "project/radare2/libr/crypto/p/crypto_cps2.c"
      key2[4];

  if ((i & 0xff) == 0) {
   
# 639 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
  fprintf(__stderrp,
# 639 "project/radare2/libr/crypto/p/crypto_cps2.c"
  "Crypting %d%%\r", i*100/0x10000
# 639 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
  )
# 639 "project/radare2/libr/crypto/p/crypto_cps2.c"
                                            ;
  ...
  key2[0] ^= (((key2[0])>>(0))&1) << 5;
  key2[0] ^= (((key2[0])>>(6))&1) << 11;
  key2[1] ^= (((key2[1])>>(0))&1) << 5;
  key2[1] ^= (((key2[1])>>(1))&1) << 4;
  key2[2] ^= (((key2[2])>>(2))&1) << 5;
  key2[2] ^= (((key2[2])>>(3))&1) << 4;
  key2[2] ^= (((key2[2])>>(7))&1) << 11;
  key2[3] ^= (((key2[3])>>(1))&1) << 5;
...
# 716 "project/radare2/libr/crypto/p/crypto_cps2.c"
static 
# 716 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
      unsigned int 
# 716 "project/radare2/libr/crypto/p/crypto_cps2.c"
           cps2key[2] = {0};

static 
# 718 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
      _Bool 
# 718 "project/radare2/libr/crypto/p/crypto_cps2.c"
           set_key(RCrypto *cry, const 
# 718 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
                                       unsigned char 
# 718 "project/radare2/libr/crypto/p/crypto_cps2.c"
 ...
 if (keylen == 8) {
  ...
  const 
# 722 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
       unsigned int
# 722 "project/radare2/libr/crypto/p/crypto_cps2.c"
           * key32 = (const 
# 722 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
                            unsigned int
# 722 "project/radare2/libr/crypto/p/crypto_cps2.c"
  ...
  return 
# 725 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
        1
# 725 "project/radare2/libr/crypto/p/crypto_cps2.c"
            ;
 } else if (keylen == 20) {
  const 
# 727 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
       unsigned char
# 727 "project/radare2/libr/crypto/p/crypto_cps2.c"
          * key8 = (const 
# 727 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
                          unsigned char
# 727 "project/radare2/libr/crypto/p/crypto_cps2.c"
  ...
  return 
# 738 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
        1
# 738 "project/radare2/libr/crypto/p/crypto_cps2.c"
            ;
 }
 return 
# 740 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
       0
# 740 "project/radare2/libr/crypto/p/crypto_cps2.c"
            ;
}
...
static 
# 748 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
      _Bool 
# 748 "project/radare2/libr/crypto/p/crypto_cps2.c"
           cps2_use(const char *algo) {
 return !strcmp (algo, "cps2");
}

static 
# 752 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
      _Bool 
# 752 "project/radare2/libr/crypto/p/crypto_cps2.c"
...
# 753 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
unsigned char 
# 753 "project/radare2/libr/crypto/p/crypto_cps2.c"
    *output = calloc (1, len);

 cps2_crypt (cry->dir, (const 
# 755 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
                             unsigned short 
# 755 "project/radare2/libr/crypto/p/crypto_cps2.c"
                                  *)buf, (
# 755 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
                                          unsigned short
# 755 "project/radare2/libr/crypto/p/crypto_cps2.c"
                                              *)output, len, cps2key, 0x400000);
 r_crypto_append (cry, output, len);
 free (output);
 return 
# 758 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
       1
# 758 "project/radare2/libr/crypto/p/crypto_cps2.c"
           ;
}
...
# 770 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
__attribute__((visibility("default"))) 
# 770 "project/radare2/libr/crypto/p/crypto_cps2.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_CRYPTO,
 .data = &r_crypto_plugin_rol,
 .version = 
# 773 "project/radare2/libr/crypto/p/crypto_cps2.c" 3 4
           "5.5.4"

# 774 "project/radare2/libr/crypto/p/crypto_cps2.c"
};
