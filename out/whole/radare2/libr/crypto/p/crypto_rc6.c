# 0 "project/radare2/libr/crypto/p/crypto_rc6.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/crypto/p/crypto_rc6.c"
...
# 5 "project/radare2/libr/crypto/p/crypto_rc6.c" 2
...
# 6 "project/radare2/libr/crypto/p/crypto_rc6.c" 2
...
# 15 "project/radare2/libr/crypto/p/crypto_rc6.c"
struct rc6_state{
 
# 16 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
unsigned int 
# 16 "project/radare2/libr/crypto/p/crypto_rc6.c"
     S[2*20 +4];
 int key_size;
};

static 
# 20 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
      _Bool 
# 20 "project/radare2/libr/crypto/p/crypto_rc6.c"
           flag;

static 
# 22 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
      _Bool 
# 22 "project/radare2/libr/crypto/p/crypto_rc6.c"
           rc6_init(struct rc6_state *const state, const 
# 22 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
                                                         unsigned char 
# 22 "project/radare2/libr/crypto/p/crypto_rc6.c"
                                                             *key, int keylen, int direction) {
 if (keylen != 128/8 && keylen != 192/8 && keylen != 256/8) {
  return 
# 24 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
        0
# 24 "project/radare2/libr/crypto/p/crypto_rc6.c"
             ;
 }
...
# 35 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
unsigned int 
# 35 "project/radare2/libr/crypto/p/crypto_rc6.c"
     L[c];

 
# 37 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
unsigned int 
# 37 "project/radare2/libr/crypto/p/crypto_rc6.c"
     A = 0, B = 0, k = 0, j = 0;
 
# 38 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
unsigned int 
# 38 "project/radare2/libr/crypto/p/crypto_rc6.c"
     v = 3 * t;
 ...
 (state->S)[0] = 0xb7e15163;
 for (i = 1; i < t; i++) {
  (state->S)[i] = (state->S)[i-1] + 0x9e3779b9;
 }

 for (i = 0; i < v; i++) {
  A = (state->S)[k] = (((((state->S)[k] + A + B))<<((3)&(32 -1))) | ((((state->S)[k] + A + B))>>(32 -((3)&(32 -1)))));
  B = L[j] = ((((L[j] + A + B))<<(((A + B))&(32 -1))) | (((L[j] + A + B))>>(32 -(((A + B))&(32 -1)))));
  k = (k + 1) % t;
  j = (j + 1) % c;
 }
 ...
 return 
# 65 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
       1
# 65 "project/radare2/libr/crypto/p/crypto_rc6.c"
           ;
}

static void rc6_encrypt(struct rc6_state *const state, const 
# 68 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
                                                            unsigned char 
# 68 "project/radare2/libr/crypto/p/crypto_rc6.c"
                                                                *inbuf, 
# 68 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
                                                                        unsigned char 
# 68 "project/radare2/libr/crypto/p/crypto_rc6.c"
...
# 69 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
unsigned int 
# 69 "project/radare2/libr/crypto/p/crypto_rc6.c"
     t, u;
 
# 70 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
unsigned int 
# 70 "project/radare2/libr/crypto/p/crypto_rc6.c"
     aux;
 
# 71 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
unsigned int 
# 71 "project/radare2/libr/crypto/p/crypto_rc6.c"
     data[16 / 4];
 int i;
 int off = 0;
 for (i = 0; i < 16 / 4; i++) {
...
# 81 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
unsigned int 
# 81 "project/radare2/libr/crypto/p/crypto_rc6.c"
 ...
 for (i = 1; i <= 20; i++) {
  t = (((B * (2 * B + 1))<<((5)&(32 -1))) | ((B * (2 * B + 1))>>(32 -((5)&(32 -1)))));
  u = (((D * (2 * D + 1))<<((5)&(32 -1))) | ((D * (2 * D + 1))>>(32 -((5)&(32 -1)))));
  A = (((A ^ t)<<((u)&(32 -1))) | ((A ^ t)>>(32 -((u)&(32 -1))))) + (state->S)[2 * i];
  C = (((C ^ u)<<((t)&(32 -1))) | ((C ^ u)>>(32 -((t)&(32 -1))))) + (state->S)[2 * i + 1];
 ...
 for (i = 0; i < 16; i++) {
  outbuf[i] = (
# 108 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
              unsigned char
# 108 "project/radare2/libr/crypto/p/crypto_rc6.c"
                 )((data[i / 4] >> (i % 4) * 8) & 0xff);
 }
}

static void rc6_decrypt(struct rc6_state *const state, const 
# 112 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
                                                            unsigned char 
# 112 "project/radare2/libr/crypto/p/crypto_rc6.c"
                                                                *inbuf, 
# 112 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
                                                                        unsigned char 
# 112 "project/radare2/libr/crypto/p/crypto_rc6.c"
...
# 113 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
unsigned int 
# 113 "project/radare2/libr/crypto/p/crypto_rc6.c"
     t, u;
 
# 114 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
unsigned int 
# 114 "project/radare2/libr/crypto/p/crypto_rc6.c"
     aux;
 
# 115 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
unsigned int 
# 115 "project/radare2/libr/crypto/p/crypto_rc6.c"
     data[16 / 4];
 int i;
 int off = 0;
...
# 126 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
unsigned int 
# 126 "project/radare2/libr/crypto/p/crypto_rc6.c"
     A = data[0], B = data[1], C = data[2], D = data[3];
 ...
 for (i = 20; i >= 1; i--) {
  ...
  u = (((D * (2 * D + 1))<<((5)&(32 -1))) | ((D * (2 * D + 1))>>(32 -((5)&(32 -1)))));
  t = (((B * (2 * B + 1))<<((5)&(32 -1))) | ((B * (2 * B + 1))>>(32 -((5)&(32 -1)))));
  C = (((C - (state->S)[2 * i + 1])>>((t)&(32 -1))) | ((C - (state->S)[2 * i + 1])<<(32 -((t)&(32 -1))))) ^ u;
  A = (((A - (state->S)[2 * i])>>((u)&(32 -1))) | ((A - (state->S)[2 * i])<<(32 -((u)&(32 -1))))) ^ t;
 }
 ...
 for (i = 0; i < 16; i++) {
  outbuf[i] = (
# 153 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
              unsigned char
# 153 "project/radare2/libr/crypto/p/crypto_rc6.c"
                 )((data[i / 4] >> (i % 4) * 8) & 0xff);
 }
}
...
static 
# 159 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
      _Bool 
# 159 "project/radare2/libr/crypto/p/crypto_rc6.c"
           rc6_set_key(RCrypto *cry, const 
# 159 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
                                           unsigned char 
# 159 "project/radare2/libr/crypto/p/crypto_rc6.c"
...
static 
# 167 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
      _Bool 
# 167 "project/radare2/libr/crypto/p/crypto_rc6.c"
           rc6_use(const char *algo) {
 return !strcmp (algo, "rc6");
}

static 
# 171 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
      _Bool 
# 171 "project/radare2/libr/crypto/p/crypto_rc6.c"
...
# 173 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
 fprintf(__stderrp,
# 173 "project/radare2/libr/crypto/p/crypto_rc6.c"
...
# 173 "project/radare2/libr/crypto/p/crypto_rc6.c"
                                                  ;
  return 
# 174 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
        0
# 174 "project/radare2/libr/crypto/p/crypto_rc6.c"
             ;
 }
...
# 179 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
unsigned char 
# 179 "project/radare2/libr/crypto/p/crypto_rc6.c"
    *obuf = calloc (1, len);
 if (!obuf) {
  return 
# 181 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
        0
# 181 "project/radare2/libr/crypto/p/crypto_rc6.c"
             ;
 }
 ...
 if (flag) {
  for (i = 0; i < blocks; i++) {
   rc6_decrypt (&st, buf + 16 * i, obuf + 16 * i);
  }
 } else {
  for (i = 0; i < blocks; i++) {
   rc6_encrypt (&st, buf + 16 * i, obuf + 16 * i);
  }
 }
 ...
 free (obuf);
 return 
# 197 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
       1
# 197 "project/radare2/libr/crypto/p/crypto_rc6.c"
           ;
}

static 
# 200 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
      _Bool 
# 200 "project/radare2/libr/crypto/p/crypto_rc6.c"
...
# 214 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
__attribute__((visibility("default"))) 
# 214 "project/radare2/libr/crypto/p/crypto_rc6.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_CRYPTO,
 .data = &r_crypto_plugin_rc6,
 .version = 
# 217 "project/radare2/libr/crypto/p/crypto_rc6.c" 3 4
           "5.5.4"

# 218 "project/radare2/libr/crypto/p/crypto_rc6.c"
};
