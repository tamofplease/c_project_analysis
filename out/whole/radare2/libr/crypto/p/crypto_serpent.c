# 0 "project/radare2/libr/crypto/p/crypto_serpent.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/crypto/p/crypto_serpent.c"
...
# 2 "project/radare2/libr/crypto/p/crypto_serpent.c" 2
...
# 3 "project/radare2/libr/crypto/p/crypto_serpent.c" 2
...
# 30 "project/radare2/libr/crypto/p/crypto_serpent_algo.h"
                                                                         out[4]);
# 4 "project/radare2/libr/crypto/p/crypto_serpent.c" 2

static struct serpent_state st = {{0}};

static 
# 7 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
      _Bool 
# 7 "project/radare2/libr/crypto/p/crypto_serpent.c"
           serpent_set_key(RCrypto *cry, const 
# 7 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
                                               unsigned char 
# 7 "project/radare2/libr/crypto/p/crypto_serpent.c"
                                                   *key, int keylen, int mode, int direction) {
 
# 8 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
fprintf(__stderrp,
# 8 "project/radare2/libr/crypto/p/crypto_serpent.c"
"key_size: %d\n", keylen
# 8 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
)
# 8 "project/radare2/libr/crypto/p/crypto_serpent.c"
 ...
 if ((keylen != 128 / 8) && (keylen != 192 / 8) && (keylen != 256 / 8)) {
  return 
# 10 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
        0
# 10 "project/radare2/libr/crypto/p/crypto_serpent.c"
             ;
 }
 st.key_size = keylen * 8;
 
# 13 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
fprintf(__stderrp,
# 13 "project/radare2/libr/crypto/p/crypto_serpent.c"
"key_size: %d\n", st.key_size
# 13 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
)
# 13 "project/radare2/libr/crypto/p/crypto_serpent.c"
...
# 14 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
__builtin___memcpy_chk (
# 14 "project/radare2/libr/crypto/p/crypto_serpent.c"
st.key
# 14 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
, 
# 14 "project/radare2/libr/crypto/p/crypto_serpent.c"
...
# 14 "project/radare2/libr/crypto/p/crypto_serpent.c"
 ...
 cry->dir = direction;
 return 
# 16 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
       1
# 16 "project/radare2/libr/crypto/p/crypto_serpent.c"
           ;
}
...
static 
# 23 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
      _Bool 
# 23 "project/radare2/libr/crypto/p/crypto_serpent.c"
           serpent_use(const char *algo) {
...
static 
# 29 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
      _Bool 
# 29 "project/radare2/libr/crypto/p/crypto_serpent.c"
...
# 36 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
unsigned char 
# 36 "project/radare2/libr/crypto/p/crypto_serpent.c"
    *const obuf = calloc (4, size / 4);
 if (!obuf) {
  return 
# 38 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
        0
# 38 "project/radare2/libr/crypto/p/crypto_serpent.c"
             ;
 }
 
# 40 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
unsigned int 
# 40 "project/radare2/libr/crypto/p/crypto_serpent.c"
     *const ibuf = calloc (4, size / 4);
 if (!ibuf) {
  free (obuf);
  return 
# 43 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
        0
# 43 "project/radare2/libr/crypto/p/crypto_serpent.c"
             ;
 }
 
# 45 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
unsigned int 
# 45 "project/radare2/libr/crypto/p/crypto_serpent.c"
     *const tmp = calloc (4, size / 4);
 if (!tmp) {
  free (obuf);
  free (ibuf);
  return 
# 49 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
        0
# 49 "project/radare2/libr/crypto/p/crypto_serpent.c"
             ;
 }
...
# 57 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
 unsigned char 
# 57 "project/radare2/libr/crypto/p/crypto_serpent.c"
     tail[4] = {0};
  
# 58 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
 __builtin___memcpy_chk (
# 58 "project/radare2/libr/crypto/p/crypto_serpent.c"
 tail
# 58 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
 , 
# 58 "project/radare2/libr/crypto/p/crypto_serpent.c"
...
# 58 "project/radare2/libr/crypto/p/crypto_serpent.c"
 ...
 free (tmp);
 return 
# 90 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
       1
# 90 "project/radare2/libr/crypto/p/crypto_serpent.c"
           ;
}

static 
# 93 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
      _Bool 
# 93 "project/radare2/libr/crypto/p/crypto_serpent.c"
...
# 107 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
__attribute__((visibility("default"))) 
# 107 "project/radare2/libr/crypto/p/crypto_serpent.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_CRYPTO,
 .data = &r_crypto_plugin_serpent,
 .version = 
# 110 "project/radare2/libr/crypto/p/crypto_serpent.c" 3 4
           "5.5.4"

# 111 "project/radare2/libr/crypto/p/crypto_serpent.c"
};
