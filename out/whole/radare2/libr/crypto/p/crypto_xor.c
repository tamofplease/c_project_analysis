# 0 "project/radare2/libr/crypto/p/crypto_xor.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/crypto/p/crypto_xor.c"
...
# 4 "project/radare2/libr/crypto/p/crypto_xor.c" 2
...
# 5 "project/radare2/libr/crypto/p/crypto_xor.c" 2

#define MAX_xor_KEY_SIZE 32768


# 8 "project/radare2/libr/crypto/p/crypto_xor.c"
struct xor_state {
 
# 9 "project/radare2/libr/crypto/p/crypto_xor.c" 3 4
unsigned char 
# 9 "project/radare2/libr/crypto/p/crypto_xor.c"
    *key;
 int key_size;
};
...
static 
# 15 "project/radare2/libr/crypto/p/crypto_xor.c" 3 4
      _Bool 
# 15 "project/radare2/libr/crypto/p/crypto_xor.c"
           xor_init(struct xor_state *const state, const 
# 15 "project/radare2/libr/crypto/p/crypto_xor.c" 3 4
                                                         unsigned char 
# 15 "project/radare2/libr/crypto/p/crypto_xor.c"
                                                             *key, int keylen) {
 if (!state || !key || keylen < 1) {
  return 
# 17 "project/radare2/libr/crypto/p/crypto_xor.c" 3 4
        0
# 17 "project/radare2/libr/crypto/p/crypto_xor.c"
             ;
 }
 state->key_size = keylen;
 state->key = malloc (keylen);
 
# 21 "project/radare2/libr/crypto/p/crypto_xor.c" 3 4
__builtin___memcpy_chk (
# 21 "project/radare2/libr/crypto/p/crypto_xor.c"
state->key
# 21 "project/radare2/libr/crypto/p/crypto_xor.c" 3 4
, 
# 21 "project/radare2/libr/crypto/p/crypto_xor.c"
...
# 21 "project/radare2/libr/crypto/p/crypto_xor.c"
                                ;
 return 
# 22 "project/radare2/libr/crypto/p/crypto_xor.c" 3 4
       1
# 22 "project/radare2/libr/crypto/p/crypto_xor.c"
           ;
}
...
static void xor_crypt(struct xor_state *const state, const 
# 29 "project/radare2/libr/crypto/p/crypto_xor.c" 3 4
                                                          unsigned char 
# 29 "project/radare2/libr/crypto/p/crypto_xor.c"
                                                              *inbuf, 
# 29 "project/radare2/libr/crypto/p/crypto_xor.c" 3 4
                                                                      unsigned char 
# 29 "project/radare2/libr/crypto/p/crypto_xor.c"
...
static 
# 35 "project/radare2/libr/crypto/p/crypto_xor.c" 3 4
      _Bool 
# 35 "project/radare2/libr/crypto/p/crypto_xor.c"
           xor_set_key(RCrypto *cry, const 
# 35 "project/radare2/libr/crypto/p/crypto_xor.c" 3 4
                                           unsigned char 
# 35 "project/radare2/libr/crypto/p/crypto_xor.c"
...
static 
# 43 "project/radare2/libr/crypto/p/crypto_xor.c" 3 4
      _Bool 
# 43 "project/radare2/libr/crypto/p/crypto_xor.c"
           xor_use(const char *algo) {
 return !strcmp (algo, "xor");
}

static 
# 47 "project/radare2/libr/crypto/p/crypto_xor.c" 3 4
      _Bool 
# 47 "project/radare2/libr/crypto/p/crypto_xor.c"
...
# 48 "project/radare2/libr/crypto/p/crypto_xor.c" 3 4
unsigned char 
# 48 "project/radare2/libr/crypto/p/crypto_xor.c"
    *obuf = calloc (1, len);
 if (!obuf) {
  return 
# 50 "project/radare2/libr/crypto/p/crypto_xor.c" 3 4
        0
# 50 "project/radare2/libr/crypto/p/crypto_xor.c"
             ;
 }
 ...
 free (obuf);
 return 
# 55 "project/radare2/libr/crypto/p/crypto_xor.c" 3 4
       1
# 55 "project/radare2/libr/crypto/p/crypto_xor.c"
           ;
}

static 
# 58 "project/radare2/libr/crypto/p/crypto_xor.c" 3 4
      _Bool 
# 58 "project/radare2/libr/crypto/p/crypto_xor.c"
...
# 72 "project/radare2/libr/crypto/p/crypto_xor.c" 3 4
__attribute__((visibility("default"))) 
# 72 "project/radare2/libr/crypto/p/crypto_xor.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_CRYPTO,
 .data = &r_crypto_plugin_xor,
 .version = 
# 75 "project/radare2/libr/crypto/p/crypto_xor.c" 3 4
           "5.5.4"

# 76 "project/radare2/libr/crypto/p/crypto_xor.c"
};
