# 0 "project/radare2/libr/crypto/p/crypto_blowfish.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/crypto/p/crypto_blowfish.c"
...
# 7 "project/radare2/libr/crypto/p/crypto_blowfish.c" 2
...
# 8 "project/radare2/libr/crypto/p/crypto_blowfish.c" 2
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/memory.h" 1 3 4
# 9 "project/radare2/libr/crypto/p/crypto_blowfish.c" 2

#define BLOCK_SIZE 8


# 12 "project/radare2/libr/crypto/p/crypto_blowfish.c"
static const 
# 12 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
            unsigned int 
# 12 "project/radare2/libr/crypto/p/crypto_blowfish.c"
                 p[18] = {
...
static const 
# 18 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
            unsigned int 
# 18 "project/radare2/libr/crypto/p/crypto_blowfish.c"
                 s[4][256] = { {
...
# 153 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
unsigned int 
# 153 "project/radare2/libr/crypto/p/crypto_blowfish.c"
     p[18];
 
# 154 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
unsigned int 
# 154 "project/radare2/libr/crypto/p/crypto_blowfish.c"
     s[4][256];
 int key_size;
};

static void swap(
# 158 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
                unsigned int 
# 158 "project/radare2/libr/crypto/p/crypto_blowfish.c"
                     *left, 
# 158 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
                            unsigned int 
# 158 "project/radare2/libr/crypto/p/crypto_blowfish.c"
...
# 159 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
unsigned int 
# 159 "project/radare2/libr/crypto/p/crypto_blowfish.c"
     temp;
...
static 
# 166 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
      unsigned int 
# 166 "project/radare2/libr/crypto/p/crypto_blowfish.c"
           F(struct blowfish_state *const state, const 
# 166 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
                                                       unsigned int 
# 166 "project/radare2/libr/crypto/p/crypto_blowfish.c"
                                                            inbuf) {
 
# 167 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
unsigned char 
# 167 "project/radare2/libr/crypto/p/crypto_blowfish.c"
    a = (inbuf >> 24) & 0xff;
 
# 168 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
unsigned char 
# 168 "project/radare2/libr/crypto/p/crypto_blowfish.c"
    b = (inbuf >> 16) & 0xff;
 
# 169 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
unsigned char 
# 169 "project/radare2/libr/crypto/p/crypto_blowfish.c"
    c = (inbuf >> 8) & 0xff;
 
# 170 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
unsigned char 
# 170 "project/radare2/libr/crypto/p/crypto_blowfish.c"
    d = (inbuf) & 0xff;
 return ((state->s[0][a] + state->s[1][b]) ^ state->s[2][c]) + state->s[3][d];
}

static void blowfish_crypt(struct blowfish_state *const state, const 
# 174 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
                                                                    unsigned char 
# 174 "project/radare2/libr/crypto/p/crypto_blowfish.c"
                                                                        *inbuf, 
# 174 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
                                                                                unsigned char 
# 174 "project/radare2/libr/crypto/p/crypto_blowfish.c"
...
# 175 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
unsigned int 
# 175 "project/radare2/libr/crypto/p/crypto_blowfish.c"
     left, right;
 int index1, index2;
...
# 181 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
  fprintf(__stderrp,
# 181 "project/radare2/libr/crypto/p/crypto_blowfish.c"
  "Invalid input length %d. Expected length is multiple of 8 bytes.\n", buflen
# 181 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
  )
# 181 "project/radare2/libr/crypto/p/crypto_blowfish.c"
                                                                                        ;
...
static void blowfish_decrypt(struct blowfish_state *const state, const 
# 211 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
                                                                      unsigned char 
# 211 "project/radare2/libr/crypto/p/crypto_blowfish.c"
                                                                          *inbuf, 
# 211 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
                                                                                  unsigned char 
# 211 "project/radare2/libr/crypto/p/crypto_blowfish.c"
...
# 212 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
unsigned int 
# 212 "project/radare2/libr/crypto/p/crypto_blowfish.c"
     left, right;
 int index1, index2;
...
# 218 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
  fprintf(__stderrp,
# 218 "project/radare2/libr/crypto/p/crypto_blowfish.c"
  "Invalid input length %d. Expected length is multiple of 8 bytes.\n", buflen
# 218 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
  )
# 218 "project/radare2/libr/crypto/p/crypto_blowfish.c"
...
static 
# 248 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
      _Bool 
# 248 "project/radare2/libr/crypto/p/crypto_blowfish.c"
           blowfish_init(struct blowfish_state *const state, const 
# 248 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
                                                                   unsigned char 
# 248 "project/radare2/libr/crypto/p/crypto_blowfish.c"
                                                                       *key, int keylen) {
 if (!state || !key || keylen > 56) {
  return 
# 250 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
        0
# 250 "project/radare2/libr/crypto/p/crypto_blowfish.c"
             ;
 }

 
# 253 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
unsigned char 
# 253 "project/radare2/libr/crypto/p/crypto_blowfish.c"
    block[8];
 int index1, index2;

 
# 256 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
__builtin___memset_chk (
# 256 "project/radare2/libr/crypto/p/crypto_blowfish.c"
block
# 256 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
, 
# 256 "project/radare2/libr/crypto/p/crypto_blowfish.c"
...
# 257 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
__builtin___memcpy_chk (
# 257 "project/radare2/libr/crypto/p/crypto_blowfish.c"
state->p
# 257 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
, 
# 257 "project/radare2/libr/crypto/p/crypto_blowfish.c"
...
# 258 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
__builtin___memcpy_chk (
# 258 "project/radare2/libr/crypto/p/crypto_blowfish.c"
state->s
# 258 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
, 
# 258 "project/radare2/libr/crypto/p/crypto_blowfish.c"
...
# 258 "project/radare2/libr/crypto/p/crypto_blowfish.c"
 ...
 return 
# 288 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
       1
# 288 "project/radare2/libr/crypto/p/crypto_blowfish.c"
           ;
}
...
static 
# 293 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
      _Bool 
# 293 "project/radare2/libr/crypto/p/crypto_blowfish.c"
           blowfish_set_key(RCrypto *cry, const 
# 293 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
                                                unsigned char 
# 293 "project/radare2/libr/crypto/p/crypto_blowfish.c"
...
static 
# 302 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
      _Bool 
# 302 "project/radare2/libr/crypto/p/crypto_blowfish.c"
           blowfish_use(const char *algo) {
 return !strcmp (algo, "blowfish");
}

static 
# 306 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
      _Bool 
# 306 "project/radare2/libr/crypto/p/crypto_blowfish.c"
...
# 306 "project/radare2/libr/crypto/p/crypto_blowfish.c"
 ...
 if (!cry || !buf) {
  return 
# 308 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
        0
# 308 "project/radare2/libr/crypto/p/crypto_blowfish.c"
             ;
 }
 
# 310 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
unsigned char 
# 310 "project/radare2/libr/crypto/p/crypto_blowfish.c"
    *obuf = calloc (1, len);
 if (!obuf) {
  return 
# 312 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
        0
# 312 "project/radare2/libr/crypto/p/crypto_blowfish.c"
             ;
 }
 if (cry->dir == 0) {
 ...
 free (obuf);
 return 
# 321 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
       1
# 321 "project/radare2/libr/crypto/p/crypto_blowfish.c"
           ;
}

static 
# 324 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
      _Bool 
# 324 "project/radare2/libr/crypto/p/crypto_blowfish.c"
...
# 339 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
__attribute__((visibility("default"))) 
# 339 "project/radare2/libr/crypto/p/crypto_blowfish.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_CRYPTO,
 .data = &r_crypto_plugin_blowfish,
 .version = 
# 342 "project/radare2/libr/crypto/p/crypto_blowfish.c" 3 4
           "5.5.4"

# 343 "project/radare2/libr/crypto/p/crypto_blowfish.c"
};
