# 0 "project/radare2/libr/crypto/p/crypto_aes.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/crypto/p/crypto_aes.c"
...
# 4 "project/radare2/libr/crypto/p/crypto_aes.c" 2
...
# 5 "project/radare2/libr/crypto/p/crypto_aes.c" 2
...
# 271 "project/radare2/libr/crypto/p/crypto_aes_algo.h"
                                             *);
# 6 "project/radare2/libr/crypto/p/crypto_aes.c" 2

#define BLOCK_SIZE 16

static 
# 9 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
      _Bool 
# 9 "project/radare2/libr/crypto/p/crypto_aes.c"
           aes_set_key(RCrypto *cry, const 
# 9 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
                                           unsigned char 
# 9 "project/radare2/libr/crypto/p/crypto_aes.c"
 ...
 if (!(keylen == 128 / 8 || keylen == 192 / 8 || keylen == 256 / 8)) {
  return 
# 11 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
        0
# 11 "project/radare2/libr/crypto/p/crypto_aes.c"
             ;
 }
 cry->key_len = keylen;
 
# 14 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
__builtin___memcpy_chk (
# 14 "project/radare2/libr/crypto/p/crypto_aes.c"
cry->key
# 14 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
, 
# 14 "project/radare2/libr/crypto/p/crypto_aes.c"
...
# 14 "project/radare2/libr/crypto/p/crypto_aes.c"
 ...
 cry->dir = direction;
 return 
# 16 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
       1
# 16 "project/radare2/libr/crypto/p/crypto_aes.c"
           ;
}
...
static 
# 23 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
      _Bool 
# 23 "project/radare2/libr/crypto/p/crypto_aes.c"
           aes_use(const char *algo) {
 return !strcmp (algo, "aes-ecb");
}

static 
# 27 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
      _Bool 
# 27 "project/radare2/libr/crypto/p/crypto_aes.c"
...
# 27 "project/radare2/libr/crypto/p/crypto_aes.c"
 ...
 const int diff = (16 - (len % 16)) % 16;
 const int size = len + diff;
 const int blocks = size / 16;
 int i;

 
# 35 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
unsigned char 
# 35 "project/radare2/libr/crypto/p/crypto_aes.c"
    *const obuf = calloc (1, size);
 if (!obuf) {
  return 
# 37 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
        0
# 37 "project/radare2/libr/crypto/p/crypto_aes.c"
             ;
 }
 
# 39 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
unsigned char 
# 39 "project/radare2/libr/crypto/p/crypto_aes.c"
    *const ibuf = calloc (1, size);
 if (!ibuf) {
  free (obuf);
  return 
# 42 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
        0
# 42 "project/radare2/libr/crypto/p/crypto_aes.c"
             ;
 }

 
# 45 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
__builtin___memset_chk (
# 45 "project/radare2/libr/crypto/p/crypto_aes.c"
ibuf
# 45 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
, 
# 45 "project/radare2/libr/crypto/p/crypto_aes.c"
...
# 46 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
__builtin___memcpy_chk (
# 46 "project/radare2/libr/crypto/p/crypto_aes.c"
ibuf
# 46 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
, 
# 46 "project/radare2/libr/crypto/p/crypto_aes.c"
...
# 55 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
__builtin___memcpy_chk (
# 55 "project/radare2/libr/crypto/p/crypto_aes.c"
st.key
# 55 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
, 
# 55 "project/radare2/libr/crypto/p/crypto_aes.c"
...
# 55 "project/radare2/libr/crypto/p/crypto_aes.c"
 ...
 free (ibuf);
 return 
# 72 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
       1
# 72 "project/radare2/libr/crypto/p/crypto_aes.c"
           ;
}

static 
# 75 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
      _Bool 
# 75 "project/radare2/libr/crypto/p/crypto_aes.c"
...
# 89 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
__attribute__((visibility("default"))) 
# 89 "project/radare2/libr/crypto/p/crypto_aes.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_CRYPTO,
 .data = &r_crypto_plugin_aes,
 .version = 
# 92 "project/radare2/libr/crypto/p/crypto_aes.c" 3 4
           "5.5.4"

# 93 "project/radare2/libr/crypto/p/crypto_aes.c"
};
