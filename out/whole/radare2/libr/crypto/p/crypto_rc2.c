# 0 "project/radare2/libr/crypto/p/crypto_rc2.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/crypto/p/crypto_rc2.c"
...
# 2 "project/radare2/libr/crypto/p/crypto_rc2.c" 2
...
# 3 "project/radare2/libr/crypto/p/crypto_rc2.c" 2
...
# 8 "project/radare2/libr/crypto/p/crypto_rc2.c"
static const 
# 8 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
            unsigned char 
# 8 "project/radare2/libr/crypto/p/crypto_rc2.c"
                PITABLE[256] = {
...
# 28 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
unsigned short 
# 28 "project/radare2/libr/crypto/p/crypto_rc2.c"
     ekey[64];
 int key_size;
};
...
static 
# 34 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
      _Bool 
# 34 "project/radare2/libr/crypto/p/crypto_rc2.c"
           rc2_expandKey(struct rc2_state *state, const 
# 34 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                                                        unsigned char 
# 34 "project/radare2/libr/crypto/p/crypto_rc2.c"
                                                            *key, int key_len) {
 ...
 if (key_len < 1 || key_len > 128) {
  return 
# 38 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
        0
# 38 "project/radare2/libr/crypto/p/crypto_rc2.c"
             ;
 }
 
# 40 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
__builtin___memcpy_chk (
# 40 "project/radare2/libr/crypto/p/crypto_rc2.c"
state->ekey
# 40 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
, 
# 40 "project/radare2/libr/crypto/p/crypto_rc2.c"
...
# 40 "project/radare2/libr/crypto/p/crypto_rc2.c"
  ...
  for (i = key_len; i < 128; i++) {
   ((
# 44 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
    unsigned char 
# 44 "project/radare2/libr/crypto/p/crypto_rc2.c"
        *)state->ekey)[i] = PITABLE[(((
# 44 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                                       unsigned char 
# 44 "project/radare2/libr/crypto/p/crypto_rc2.c"
                                           *)state->ekey)[i - key_len] + ((
# 44 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                                                                           unsigned char 
# 44 "project/radare2/libr/crypto/p/crypto_rc2.c"
                                                                               *)state->ekey)[i - 1]) & 255];
 ...
 int ekey_len = (1024 + 7) >> 3;
 i = 128 - ekey_len;
  ((
# 49 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
   unsigned char 
# 49 "project/radare2/libr/crypto/p/crypto_rc2.c"
       *)state->ekey)[i] = PITABLE[((
# 49 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                                     unsigned char 
# 49 "project/radare2/libr/crypto/p/crypto_rc2.c"
                                         *)state->ekey)[i] & (255 >> (7 & -1024))];


  while (i--) {
   ((
# 53 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
    unsigned char 
# 53 "project/radare2/libr/crypto/p/crypto_rc2.c"
        *)state->ekey)[i] = PITABLE[((
# 53 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                                      unsigned char 
# 53 "project/radare2/libr/crypto/p/crypto_rc2.c"
...
# 53 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                                                                    unsigned char 
# 53 "project/radare2/libr/crypto/p/crypto_rc2.c"
                                                                        *)state->ekey)[i + ekey_len]];
  }


  for (i = 64 - 1; i >= 0; i--) {
   state->ekey[i] = ((
# 58 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                     unsigned char 
# 58 "project/radare2/libr/crypto/p/crypto_rc2.c"
                         *)state->ekey)[i * 2] + (((
# 58 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                                                    unsigned char 
# 58 "project/radare2/libr/crypto/p/crypto_rc2.c"
  ...
  return 
# 61 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
        1
# 61 "project/radare2/libr/crypto/p/crypto_rc2.c"
            ;
}

static void rc2_crypt8(struct rc2_state *state, const 
# 64 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                                                     unsigned char 
# 64 "project/radare2/libr/crypto/p/crypto_rc2.c"
                                                         *inbuf, 
# 64 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                                                                 unsigned char 
# 64 "project/radare2/libr/crypto/p/crypto_rc2.c"
...
# 66 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
unsigned short 
# 66 "project/radare2/libr/crypto/p/crypto_rc2.c"
     x76, x54, x32, x10;
 ...
 outbuf[0] = (
# 94 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
             unsigned char
# 94 "project/radare2/libr/crypto/p/crypto_rc2.c"
                ) x10;
 outbuf[1] = (
# 95 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
             unsigned char
# 95 "project/radare2/libr/crypto/p/crypto_rc2.c"
                ) (x10 >> 8);
 outbuf[2] = (
# 96 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
             unsigned char
# 96 "project/radare2/libr/crypto/p/crypto_rc2.c"
                ) x32;
 outbuf[3] = (
# 97 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
             unsigned char
# 97 "project/radare2/libr/crypto/p/crypto_rc2.c"
                ) (x32 >> 8);
 outbuf[4] = (
# 98 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
             unsigned char
# 98 "project/radare2/libr/crypto/p/crypto_rc2.c"
                ) x54;
 outbuf[5] = (
# 99 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
             unsigned char
# 99 "project/radare2/libr/crypto/p/crypto_rc2.c"
                ) (x54 >> 8);
 outbuf[6] = (
# 100 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
             unsigned char
# 100 "project/radare2/libr/crypto/p/crypto_rc2.c"
                ) x76;
 outbuf[7] = (
# 101 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
             unsigned char
# 101 "project/radare2/libr/crypto/p/crypto_rc2.c"
                ) (x76 >> 8);
}


static void rc2_dcrypt8(struct rc2_state *state, const 
# 105 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                                                      unsigned char 
# 105 "project/radare2/libr/crypto/p/crypto_rc2.c"
                                                          *inbuf, 
# 105 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                                                                  unsigned char 
# 105 "project/radare2/libr/crypto/p/crypto_rc2.c"
...
# 107 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
unsigned short 
# 107 "project/radare2/libr/crypto/p/crypto_rc2.c"
     x76, x54, x32, x10;
 ...
 outbuf[0] = (
# 139 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
             unsigned char
# 139 "project/radare2/libr/crypto/p/crypto_rc2.c"
                ) x10;
 outbuf[1] = (
# 140 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
             unsigned char
# 140 "project/radare2/libr/crypto/p/crypto_rc2.c"
                ) (x10 >> 8);
 outbuf[2] = (
# 141 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
             unsigned char
# 141 "project/radare2/libr/crypto/p/crypto_rc2.c"
                ) x32;
 outbuf[3] = (
# 142 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
             unsigned char
# 142 "project/radare2/libr/crypto/p/crypto_rc2.c"
                ) (x32 >> 8);
 outbuf[4] = (
# 143 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
             unsigned char
# 143 "project/radare2/libr/crypto/p/crypto_rc2.c"
                ) x54;
 outbuf[5] = (
# 144 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
             unsigned char
# 144 "project/radare2/libr/crypto/p/crypto_rc2.c"
                ) (x54 >> 8);
 outbuf[6] = (
# 145 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
             unsigned char
# 145 "project/radare2/libr/crypto/p/crypto_rc2.c"
                ) x76;
 outbuf[7] = (
# 146 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
             unsigned char
# 146 "project/radare2/libr/crypto/p/crypto_rc2.c"
                ) (x76 >> 8);
}

static void rc2_dcrypt(struct rc2_state *state, const 
# 149 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                                                     unsigned char 
# 149 "project/radare2/libr/crypto/p/crypto_rc2.c"
                                                         *inbuf, 
# 149 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                                                                 unsigned char 
# 149 "project/radare2/libr/crypto/p/crypto_rc2.c"
                                                                     *outbuf, int buflen) {
 int i;
 char data_block[8 + 1] = {0};
 int idx = 0;
 char dcrypted_block[8 + 1] = {0};
 ...
 for (i = 0; i < buflen; i++) {
  ...
  idx += 1;
  if (idx % 8 == 0) {
   rc2_dcrypt8 (state, (const 
# 160 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                             unsigned char 
# 160 "project/radare2/libr/crypto/p/crypto_rc2.c"
                                 *) data_block, (
# 160 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                                                 unsigned char 
# 160 "project/radare2/libr/crypto/p/crypto_rc2.c"
...
# 161 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
  __builtin___memcpy_chk (
# 161 "project/radare2/libr/crypto/p/crypto_rc2.c"
  ptr
# 161 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
  , 
# 161 "project/radare2/libr/crypto/p/crypto_rc2.c"
...
static void rc2_crypt(struct rc2_state *state, const 
# 168 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                                                    unsigned char 
# 168 "project/radare2/libr/crypto/p/crypto_rc2.c"
                                                        *inbuf, 
# 168 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                                                                unsigned char 
# 168 "project/radare2/libr/crypto/p/crypto_rc2.c"
 ...
 for (i = 0; i < buflen; i++) {
  ...
  idx += 1;
  if (idx % 8 == 0) {
   rc2_crypt8(state, (const 
# 181 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                           unsigned char 
# 181 "project/radare2/libr/crypto/p/crypto_rc2.c"
                               *) data_block, (
# 181 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                                               unsigned char 
# 181 "project/radare2/libr/crypto/p/crypto_rc2.c"
...
# 182 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
  __builtin___strncpy_chk (
# 182 "project/radare2/libr/crypto/p/crypto_rc2.c"
  ptr
# 182 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
  , 
# 182 "project/radare2/libr/crypto/p/crypto_rc2.c"
...
# 182 "project/radare2/libr/crypto/p/crypto_rc2.c"
 ...
 if (idx % 8) {
  ...
  rc2_crypt8(state, (const 
# 192 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                          unsigned char 
# 192 "project/radare2/libr/crypto/p/crypto_rc2.c"
                              *) data_block, (
# 192 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                                              unsigned char 
# 192 "project/radare2/libr/crypto/p/crypto_rc2.c"
...
# 193 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
 __builtin___strncpy_chk (
# 193 "project/radare2/libr/crypto/p/crypto_rc2.c"
 ptr
# 193 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
 , 
# 193 "project/radare2/libr/crypto/p/crypto_rc2.c"
...
static 
# 202 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
      _Bool 
# 202 "project/radare2/libr/crypto/p/crypto_rc2.c"
           rc2_set_key(RCrypto *cry, const 
# 202 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
                                           unsigned char 
# 202 "project/radare2/libr/crypto/p/crypto_rc2.c"
...
static 
# 212 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
      _Bool 
# 212 "project/radare2/libr/crypto/p/crypto_rc2.c"
           rc2_use(const char *algo) {
 return !strcmp (algo, "rc2");
}

static 
# 216 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
      _Bool 
# 216 "project/radare2/libr/crypto/p/crypto_rc2.c"
...
# 217 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
unsigned char 
# 217 "project/radare2/libr/crypto/p/crypto_rc2.c"
    *obuf = calloc (1, len);
 if (!obuf) {
  return 
# 219 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
        0
# 219 "project/radare2/libr/crypto/p/crypto_rc2.c"
             ;
 }
 if (flag == 0) {
 ...
 free (obuf);
 return 
# 228 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
       1
# 228 "project/radare2/libr/crypto/p/crypto_rc2.c"
           ;
}

static 
# 231 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
      _Bool 
# 231 "project/radare2/libr/crypto/p/crypto_rc2.c"
...
# 245 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
__attribute__((visibility("default"))) 
# 245 "project/radare2/libr/crypto/p/crypto_rc2.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_CRYPTO,
 .data = &r_crypto_plugin_rc2,
 .version = 
# 248 "project/radare2/libr/crypto/p/crypto_rc2.c" 3 4
           "5.5.4"

# 249 "project/radare2/libr/crypto/p/crypto_rc2.c"
};
