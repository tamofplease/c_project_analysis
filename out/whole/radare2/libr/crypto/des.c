# 0 "project/radare2/libr/crypto/des.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/crypto/des.c"
...
# 2 "project/radare2/libr/crypto/des.c" 2
...
# 3 "project/radare2/libr/crypto/des.c" 2
...
# 9 "project/radare2/libr/crypto/des.c"
static const 
# 9 "project/radare2/libr/crypto/des.c" 3 4
            unsigned int 
# 9 "project/radare2/libr/crypto/des.c"
                 sbox1[64] = {
...
static const 
# 20 "project/radare2/libr/crypto/des.c" 3 4
            unsigned int 
# 20 "project/radare2/libr/crypto/des.c"
                 sbox2[64] = {
...
static const 
# 31 "project/radare2/libr/crypto/des.c" 3 4
            unsigned int 
# 31 "project/radare2/libr/crypto/des.c"
                 sbox3[64] = {
...
static const 
# 42 "project/radare2/libr/crypto/des.c" 3 4
            unsigned int 
# 42 "project/radare2/libr/crypto/des.c"
                 sbox4[64] = {
...
static const 
# 53 "project/radare2/libr/crypto/des.c" 3 4
            unsigned int 
# 53 "project/radare2/libr/crypto/des.c"
                 sbox5[64] = {
...
static const 
# 64 "project/radare2/libr/crypto/des.c" 3 4
            unsigned int 
# 64 "project/radare2/libr/crypto/des.c"
                 sbox6[64] = {
...
static const 
# 75 "project/radare2/libr/crypto/des.c" 3 4
            unsigned int 
# 75 "project/radare2/libr/crypto/des.c"
                 sbox7[64] = {
...
static const 
# 86 "project/radare2/libr/crypto/des.c" 3 4
            unsigned int 
# 86 "project/radare2/libr/crypto/des.c"
                 sbox8[64] = {
...
# 97 "project/radare2/libr/crypto/des.c" 3 4
__attribute__((visibility("default"))) 
# 97 "project/radare2/libr/crypto/des.c"
     void r_des_permute_key (
# 97 "project/radare2/libr/crypto/des.c" 3 4
                             unsigned int 
# 97 "project/radare2/libr/crypto/des.c"
                                  *keylo, 
...
# 101 "project/radare2/libr/crypto/des.c" 3 4
unsigned int 
# 101 "project/radare2/libr/crypto/des.c"
...
# 124 "project/radare2/libr/crypto/des.c" 3 4
__attribute__((visibility("default"))) 
# 124 "project/radare2/libr/crypto/des.c"
     void r_des_permute_block0 (
# 124 "project/radare2/libr/crypto/des.c" 3 4
                                 unsigned int 
# 124 "project/radare2/libr/crypto/des.c"
                                      *blocklo, 
...
# 128 "project/radare2/libr/crypto/des.c" 3 4
unsigned int 
# 128 "project/radare2/libr/crypto/des.c"
     lo = *blocklo;
 
# 129 "project/radare2/libr/crypto/des.c" 3 4
unsigned int 
# 129 "project/radare2/libr/crypto/des.c"
     hi = *blockhi;
 
# 130 "project/radare2/libr/crypto/des.c" 3 4
unsigned int 
# 130 "project/radare2/libr/crypto/des.c"
 ...
 hi ^= perm; lo ^= perm << 1;
 *blocklo = (((lo) << (1)) | ((lo) >> (32 - (1))));
 *blockhi = (((hi) << (1)) | ((hi) >> (32 - (1))));
}



# 145 "project/radare2/libr/crypto/des.c" 3 4
__attribute__((visibility("default"))) 
# 145 "project/radare2/libr/crypto/des.c"
     void r_des_permute_block1 (
# 145 "project/radare2/libr/crypto/des.c" 3 4
                                unsigned int 
# 145 "project/radare2/libr/crypto/des.c"
                                     *blocklo, 
...
# 149 "project/radare2/libr/crypto/des.c" 3 4
unsigned int 
# 149 "project/radare2/libr/crypto/des.c"
     lo = *blocklo;
 
# 150 "project/radare2/libr/crypto/des.c" 3 4
unsigned int 
# 150 "project/radare2/libr/crypto/des.c"
     hi = *blockhi;
 lo = (((lo) >> (1)) | ((lo) << (32 - (1))));
 hi = (((hi) >> (1)) | ((hi) << (32 - (1))));
 
# 153 "project/radare2/libr/crypto/des.c" 3 4
unsigned int 
# 153 "project/radare2/libr/crypto/des.c"
     perm = ((lo >> 1) ^ hi) & 0x55555555;
 hi ^= perm; lo ^= perm << 1;
 perm = ((hi >> 8) ^ lo) & 0x00FF00FF;
 lo ^= perm; hi ^= perm << 8;
...
# 169 "project/radare2/libr/crypto/des.c" 3 4
__attribute__((visibility("default"))) 
# 169 "project/radare2/libr/crypto/des.c"
     void r_des_round_key (int i, 
# 169 "project/radare2/libr/crypto/des.c" 3 4
                                  unsigned int 
# 169 "project/radare2/libr/crypto/des.c"
                                       *keylo, 
...
# 169 "project/radare2/libr/crypto/des.c"
 ...
 if (i == 0 || i == 1 || i == 8 || i == 15) {
  *deskeylo = ((((*deskeylo) << (1)) | ((*deskeylo) >> (28 - (1)))) & 0x0FFFFFFF);
  *deskeyhi = ((((*deskeyhi) << (1)) | ((*deskeyhi) >> (28 - (1)))) & 0x0FFFFFFF);
 } else {
  *deskeylo = ((((*deskeylo) << (2)) | ((*deskeylo) >> (28 - (2)))) & 0x0FFFFFFF);
  *deskeyhi = ((((*deskeyhi) << (2)) | ((*deskeyhi) >> (28 - (2)))) & 0x0FFFFFFF);
 }

 
# 181 "project/radare2/libr/crypto/des.c" 3 4
unsigned int 
# 181 "project/radare2/libr/crypto/des.c"
     deslo = *deskeylo;
 
# 182 "project/radare2/libr/crypto/des.c" 3 4
unsigned int 
# 182 "project/radare2/libr/crypto/des.c"
     deshi = *deskeyhi;
...
# 209 "project/radare2/libr/crypto/des.c" 3 4
__attribute__((visibility("default"))) 
# 209 "project/radare2/libr/crypto/des.c"
     void r_des_round (
# 209 "project/radare2/libr/crypto/des.c" 3 4
                       unsigned int 
# 209 "project/radare2/libr/crypto/des.c"
...
# 213 "project/radare2/libr/crypto/des.c" 3 4
unsigned int 
# 213 "project/radare2/libr/crypto/des.c"
     lo = *buflo;
 
# 214 "project/radare2/libr/crypto/des.c" 3 4
unsigned int 
# 214 "project/radare2/libr/crypto/des.c"
     hi = *bufhi;
 
# 215 "project/radare2/libr/crypto/des.c" 3 4
unsigned int 
# 215 "project/radare2/libr/crypto/des.c"
     perm = hi ^ (*roundkeylo);
 lo ^= sbox2[(perm >> 24) & 0x3F];
 lo ^= sbox4[(perm >> 16) & 0x3F];
 lo ^= sbox6[(perm >> 8) & 0x3F];
 lo ^= sbox8[perm & 0x3F];
 perm = (((hi) >> (4)) | ((hi) << (32 - (4)))) ^ (*roundkeyhi);
