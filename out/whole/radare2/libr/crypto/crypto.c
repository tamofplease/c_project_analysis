# 0 "project/radare2/libr/crypto/crypto.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/crypto/crypto.c"
...
# 4 "project/radare2/libr/crypto/crypto.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/sdb/src/config.h" 1 3 4
# 5 "project/radare2/libr/crypto/crypto.c" 2

__attribute__((visibility("default"))) const char *
# 6 "project/radare2/libr/crypto/crypto.c"
r_crypto_version
# 6 "project/radare2/libr/crypto/crypto.c" 3 4
(void) { return "" "5.5.4"; }
# 6 "project/radare2/libr/crypto/crypto.c"
                       ;
...
static const struct {
 ...
 { "all", 
# 12 "project/radare2/libr/crypto/crypto.c" 3 4
         0xFFFFFFFFFFFFFFFFULL 
# 12 "project/radare2/libr/crypto/crypto.c"
                  },
 { "rc2", 
# 13 "project/radare2/libr/crypto/crypto.c" 3 4
         1ULL 
# 13 "project/radare2/libr/crypto/crypto.c"
                      },
 { "rc4", 
# 14 "project/radare2/libr/crypto/crypto.c" 3 4
         1ULL<<1 
# 14 "project/radare2/libr/crypto/crypto.c"
                      },
 { "rc6", 
# 15 "project/radare2/libr/crypto/crypto.c" 3 4
         1ULL<<2 
# 15 "project/radare2/libr/crypto/crypto.c"
                      },
 { "aes-ecb", 
# 16 "project/radare2/libr/crypto/crypto.c" 3 4
             1ULL<<3 
# 16 "project/radare2/libr/crypto/crypto.c"
                              },
 { "aes-cbc", 
# 17 "project/radare2/libr/crypto/crypto.c" 3 4
             1ULL<<4 
# 17 "project/radare2/libr/crypto/crypto.c"
                              },
 { "aes-wrap", 
# 18 "project/radare2/libr/crypto/crypto.c" 3 4
              1ULL<<5 
# 18 "project/radare2/libr/crypto/crypto.c"
                                },
 { "ror", 
# 19 "project/radare2/libr/crypto/crypto.c" 3 4
         1ULL<<6 
# 19 "project/radare2/libr/crypto/crypto.c"
                      },
 { "rol", 
# 20 "project/radare2/libr/crypto/crypto.c" 3 4
         1ULL<<7 
# 20 "project/radare2/libr/crypto/crypto.c"
                      },
 { "rot", 
# 21 "project/radare2/libr/crypto/crypto.c" 3 4
         1ULL<<8 
# 21 "project/radare2/libr/crypto/crypto.c"
                      },
 { "blowfish", 
# 22 "project/radare2/libr/crypto/crypto.c" 3 4
              1ULL<<9 
# 22 "project/radare2/libr/crypto/crypto.c"
                                },
 { "cps2", 
# 23 "project/radare2/libr/crypto/crypto.c" 3 4
          1ULL<<10 
# 23 "project/radare2/libr/crypto/crypto.c"
                        },
 { "des-ecb", 
# 24 "project/radare2/libr/crypto/crypto.c" 3 4
             1ULL<<11 
# 24 "project/radare2/libr/crypto/crypto.c"
                              },
 { "xor", 
# 25 "project/radare2/libr/crypto/crypto.c" 3 4
         1ULL<<12 
# 25 "project/radare2/libr/crypto/crypto.c"
                      },
 { "serpent-ecb", 
# 26 "project/radare2/libr/crypto/crypto.c" 3 4
                 1ULL<<13 
# 26 "project/radare2/libr/crypto/crypto.c"
                                  },
 { 
# 27 "project/radare2/libr/crypto/crypto.c" 3 4
  ((void *)0)
# 27 "project/radare2/libr/crypto/crypto.c"
      , 0 }
};
...
static const struct {
 ...
 { "all", 
# 34 "project/radare2/libr/crypto/crypto.c" 3 4
         0xFFFFFFFFFFFFFFFFULL 
# 34 "project/radare2/libr/crypto/crypto.c"
                  },
 { "base64", 
# 35 "project/radare2/libr/crypto/crypto.c" 3 4
            1ULL 
# 35 "project/radare2/libr/crypto/crypto.c"
                        },
 { "base91", 
# 36 "project/radare2/libr/crypto/crypto.c" 3 4
            1ULL<<1 
# 36 "project/radare2/libr/crypto/crypto.c"
                        },
 { "punycode", 
# 37 "project/radare2/libr/crypto/crypto.c" 3 4
              1ULL<<2 
# 37 "project/radare2/libr/crypto/crypto.c"
                               },
 { 
# 38 "project/radare2/libr/crypto/crypto.c" 3 4
  ((void *)0)
# 38 "project/radare2/libr/crypto/crypto.c"
      , 0 }
};


# 41 "project/radare2/libr/crypto/crypto.c" 3 4
__attribute__((visibility("default"))) 
# 41 "project/radare2/libr/crypto/crypto.c"
     const char *r_crypto_name(const RCryptoSelector bit) {
 size_t i;
...
# 51 "project/radare2/libr/crypto/crypto.c" 3 4
__attribute__((visibility("default"))) 
# 51 "project/radare2/libr/crypto/crypto.c"
     const char *r_crypto_codec_name(const RCryptoSelector bit) {
 size_t i;
...
# 65 "project/radare2/libr/crypto/crypto.c" 3 4
__attribute__((visibility("default"))) 
# 65 "project/radare2/libr/crypto/crypto.c"
     RCrypto *r_crypto_init(RCrypto *cry, int hard) {
 int i;
 if (cry) {
  cry->iv = 
# 68 "project/radare2/libr/crypto/crypto.c" 3 4
           ((void *)0)
# 68 "project/radare2/libr/crypto/crypto.c"
               ;
  cry->key = 
# 69 "project/radare2/libr/crypto/crypto.c" 3 4
            ((void *)0)
# 69 "project/radare2/libr/crypto/crypto.c"
                ;
  cry->key_len = 0;
  cry->user = 
# 71 "project/radare2/libr/crypto/crypto.c" 3 4
             ((void *)0)
# 71 "project/radare2/libr/crypto/crypto.c"
                 ;
  if (hard) {

   r_crypto_get_output (cry, 
# 74 "project/radare2/libr/crypto/crypto.c" 3 4
                            ((void *)0)
# 74 "project/radare2/libr/crypto/crypto.c"
                                );
   cry->plugins = r_list_newf (
# 75 "project/radare2/libr/crypto/crypto.c" 3 4
                              ((void *)0)
# 75 "project/radare2/libr/crypto/crypto.c"
                                  );
   for (i = 0; crypto_static_plugins[i]; i++) {
    RCryptoPlugin *p = 
# 77 "project/radare2/libr/crypto/crypto.c" 3 4
                      (
# 77 "project/radare2/libr/crypto/crypto.c"
                      RCryptoPlugin
# 77 "project/radare2/libr/crypto/crypto.c" 3 4
                      *)calloc(1,sizeof(
# 77 "project/radare2/libr/crypto/crypto.c"
...
# 77 "project/radare2/libr/crypto/crypto.c"
    ...
    if (!p) {
     free (cry);
     return 
# 80 "project/radare2/libr/crypto/crypto.c" 3 4
           ((void *)0)
# 80 "project/radare2/libr/crypto/crypto.c"
               ;
    }
    
# 82 "project/radare2/libr/crypto/crypto.c" 3 4
   __builtin___memcpy_chk (
# 82 "project/radare2/libr/crypto/crypto.c"
   p
# 82 "project/radare2/libr/crypto/crypto.c" 3 4
   , 
# 82 "project/radare2/libr/crypto/crypto.c"
   crypto_static_plugins[i], sizeof (RCryptoPlugin)
# 82 "project/radare2/libr/crypto/crypto.c" 3 4
...
# 90 "project/radare2/libr/crypto/crypto.c" 3 4
__attribute__((visibility("default"))) 
# 90 "project/radare2/libr/crypto/crypto.c"
     int r_crypto_add(RCrypto *cry, RCryptoPlugin *h) {

 r_list_append (cry->plugins, h);
 return 
# 93 "project/radare2/libr/crypto/crypto.c" 3 4
       1
# 93 "project/radare2/libr/crypto/crypto.c"
           ;
}


# 96 "project/radare2/libr/crypto/crypto.c" 3 4
__attribute__((visibility("default"))) 
# 96 "project/radare2/libr/crypto/crypto.c"
     int r_crypto_del(RCrypto *cry, RCryptoPlugin *h) {
 r_list_delete_data (cry->plugins, h);
 return 
# 98 "project/radare2/libr/crypto/crypto.c" 3 4
       1
# 98 "project/radare2/libr/crypto/crypto.c"
           ;
}


# 101 "project/radare2/libr/crypto/crypto.c" 3 4
__attribute__((visibility("default"))) 
# 101 "project/radare2/libr/crypto/crypto.c"
     struct r_crypto_t *r_crypto_new(void) {
 RCrypto *cry = 
# 102 "project/radare2/libr/crypto/crypto.c" 3 4
               (
# 102 "project/radare2/libr/crypto/crypto.c"
               RCrypto
# 102 "project/radare2/libr/crypto/crypto.c" 3 4
               *)calloc(1,sizeof(
# 102 "project/radare2/libr/crypto/crypto.c"
...
# 103 "project/radare2/libr/crypto/crypto.c" 3 4
                           1
# 103 "project/radare2/libr/crypto/crypto.c"
                               );
}


# 106 "project/radare2/libr/crypto/crypto.c" 3 4
__attribute__((visibility("default"))) 
# 106 "project/radare2/libr/crypto/crypto.c"
     struct r_crypto_t *r_crypto_as_new(struct r_crypto_t *cry) {
 RCrypto *c = 
# 107 "project/radare2/libr/crypto/crypto.c" 3 4
             (
# 107 "project/radare2/libr/crypto/crypto.c"
             RCrypto
# 107 "project/radare2/libr/crypto/crypto.c" 3 4
             *)calloc(1,sizeof(
# 107 "project/radare2/libr/crypto/crypto.c"
...
# 107 "project/radare2/libr/crypto/crypto.c"
 ...
 if (c) {
  r_crypto_init (c, 
# 109 "project/radare2/libr/crypto/crypto.c" 3 4
                   0
# 109 "project/radare2/libr/crypto/crypto.c"
                        );
  
# 110 "project/radare2/libr/crypto/crypto.c" 3 4
 __builtin___memcpy_chk (
# 110 "project/radare2/libr/crypto/crypto.c"
 &c->plugins
# 110 "project/radare2/libr/crypto/crypto.c" 3 4
 , 
# 110 "project/radare2/libr/crypto/crypto.c"
 &cry->plugins, sizeof (cry->plugins)
# 110 "project/radare2/libr/crypto/crypto.c" 3 4
 , __builtin_object_size (
# 110 "project/radare2/libr/crypto/crypto.c"
 &c->plugins
...
# 115 "project/radare2/libr/crypto/crypto.c" 3 4
__attribute__((visibility("default"))) 
# 115 "project/radare2/libr/crypto/crypto.c"
     struct r_crypto_t *r_crypto_free(RCrypto *cry) {
 ...
 free (cry);
 return 
# 122 "project/radare2/libr/crypto/crypto.c" 3 4
       ((void *)0)
# 122 "project/radare2/libr/crypto/crypto.c"
           ;
}


# 125 "project/radare2/libr/crypto/crypto.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 125 "project/radare2/libr/crypto/crypto.c"
          r_crypto_use(RCrypto *cry, const char *algo) {
 RListIter *iter;
 RCryptoPlugin *h;
 
# 128 "project/radare2/libr/crypto/crypto.c" 3 4
if (
# 128 "project/radare2/libr/crypto/crypto.c"
cry->plugins
# 128 "project/radare2/libr/crypto/crypto.c" 3 4
) for (
# 128 "project/radare2/libr/crypto/crypto.c"
...
# 128 "project/radare2/libr/crypto/crypto.c"
  ...
  if (h && h->use && h->use (algo)) {
   cry->h = h;
   return cry->h != 
# 131 "project/radare2/libr/crypto/crypto.c" 3 4
                   ((void *)0)
# 131 "project/radare2/libr/crypto/crypto.c"
                       ;
  }
 }
 return 
# 134 "project/radare2/libr/crypto/crypto.c" 3 4
       0
# 134 "project/radare2/libr/crypto/crypto.c"
            ;
}


# 137 "project/radare2/libr/crypto/crypto.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 137 "project/radare2/libr/crypto/crypto.c"
          r_crypto_set_key(RCrypto *cry, const 
# 137 "project/radare2/libr/crypto/crypto.c" 3 4
                                               unsigned char
# 137 "project/radare2/libr/crypto/crypto.c"
 ...
 if (!cry || !cry->h || !cry->h->set_key) {
  return 
# 142 "project/radare2/libr/crypto/crypto.c" 3 4
        0
# 142 "project/radare2/libr/crypto/crypto.c"
             ;
 }
 cry->key_len = keylen;
...
# 149 "project/radare2/libr/crypto/crypto.c" 3 4
__attribute__((visibility("default"))) 
# 149 "project/radare2/libr/crypto/crypto.c"
     int r_crypto_get_key_size(RCrypto *cry) {
 return (cry && cry->h && cry->h->get_key_size)?
  cry->h->get_key_size (cry): 0;
}


# 154 "project/radare2/libr/crypto/crypto.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 154 "project/radare2/libr/crypto/crypto.c"
          r_crypto_set_iv(RCrypto *cry, const 
# 154 "project/radare2/libr/crypto/crypto.c" 3 4
                                              unsigned char 
# 154 "project/radare2/libr/crypto/crypto.c"
                                                  *iv, int ivlen) {
...
# 160 "project/radare2/libr/crypto/crypto.c" 3 4
__attribute__((visibility("default"))) 
# 160 "project/radare2/libr/crypto/crypto.c"
     int r_crypto_update(RCrypto *cry, const 
# 160 "project/radare2/libr/crypto/crypto.c" 3 4
                                             unsigned char 
# 160 "project/radare2/libr/crypto/crypto.c"
                                                 *buf, int len) {
...
# 165 "project/radare2/libr/crypto/crypto.c" 3 4
__attribute__((visibility("default"))) 
# 165 "project/radare2/libr/crypto/crypto.c"
     int r_crypto_final(RCrypto *cry, const 
# 165 "project/radare2/libr/crypto/crypto.c" 3 4
                                            unsigned char 
# 165 "project/radare2/libr/crypto/crypto.c"
                                                *buf, int len) {
...
# 171 "project/radare2/libr/crypto/crypto.c" 3 4
__attribute__((visibility("default"))) 
# 171 "project/radare2/libr/crypto/crypto.c"
     int r_crypto_append(RCrypto *cry, const 
# 171 "project/radare2/libr/crypto/crypto.c" 3 4
                                             unsigned char 
# 171 "project/radare2/libr/crypto/crypto.c"
                                                 *buf, int len) {
...
# 179 "project/radare2/libr/crypto/crypto.c" 3 4
__builtin___memcpy_chk (
# 179 "project/radare2/libr/crypto/crypto.c"
cry->output + cry->output_len
# 179 "project/radare2/libr/crypto/crypto.c" 3 4
, 
# 179 "project/radare2/libr/crypto/crypto.c"
buf, len
...
# 184 "project/radare2/libr/crypto/crypto.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 184 "project/radare2/libr/crypto/crypto.c"
         *r_crypto_get_output(RCrypto *cry, int *size) {
 if (cry->output_size < 1) {
  return 
# 186 "project/radare2/libr/crypto/crypto.c" 3 4
        ((void *)0)
# 186 "project/radare2/libr/crypto/crypto.c"
            ;
 }
 
# 188 "project/radare2/libr/crypto/crypto.c" 3 4
unsigned char 
# 188 "project/radare2/libr/crypto/crypto.c"
    *buf = calloc (1, cry->output_size);
 if (!buf) {
  return 
# 190 "project/radare2/libr/crypto/crypto.c" 3 4
        ((void *)0)
# 190 "project/radare2/libr/crypto/crypto.c"
            ;
 }
 if (size) {
  *size = cry->output_len;
  
# 194 "project/radare2/libr/crypto/crypto.c" 3 4
 __builtin___memcpy_chk (
# 194 "project/radare2/libr/crypto/crypto.c"
 buf
# 194 "project/radare2/libr/crypto/crypto.c" 3 4
 , 
# 194 "project/radare2/libr/crypto/crypto.c"
...
# 194 "project/radare2/libr/crypto/crypto.c"
  ...
  if (!cry->output) {
   free (buf);
   return 
# 201 "project/radare2/libr/crypto/crypto.c" 3 4
         ((void *)0)
# 201 "project/radare2/libr/crypto/crypto.c"
             ;
  }
  cry->output_len = 0;
  ...
  return 
# 206 "project/radare2/libr/crypto/crypto.c" 3 4
        ((void *)0)
# 206 "project/radare2/libr/crypto/crypto.c"
            ;
 }
 return buf;
}
