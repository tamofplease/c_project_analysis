# 0 "project/radare2/libr/bp/bp_traptrace.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_bp.h" 2 3 4
...
# 6 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_bp.h" 2 3 4
...
# 7 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_bp.h" 2 3 4
...
# 5 "project/radare2/libr/bp/bp_traptrace.c" 2


__attribute__((visibility("default"))) 
# 7 "project/radare2/libr/bp/bp_traptrace.c"
     void r_bp_traptrace_free(void *ptr) {
...
# 15 "project/radare2/libr/bp/bp_traptrace.c" 3 4
__attribute__((visibility("default"))) 
# 15 "project/radare2/libr/bp/bp_traptrace.c"
     RList *r_bp_traptrace_new(void) {
 RList *list = r_list_new ();
 if (!list) {
  return 
# 18 "project/radare2/libr/bp/bp_traptrace.c" 3 4
        ((void *)0)
# 18 "project/radare2/libr/bp/bp_traptrace.c"
            ;
 }
...
# 24 "project/radare2/libr/bp/bp_traptrace.c" 3 4
__attribute__((visibility("default"))) 
# 24 "project/radare2/libr/bp/bp_traptrace.c"
     void r_bp_traptrace_enable(RBreakpoint *bp, int enable) {
 RListIter *iter;
 RBreakpointTrace *trace;
 
# 27 "project/radare2/libr/bp/bp_traptrace.c" 3 4
if (
# 27 "project/radare2/libr/bp/bp_traptrace.c"
bp->traces
# 27 "project/radare2/libr/bp/bp_traptrace.c" 3 4
) for (
# 27 "project/radare2/libr/bp/bp_traptrace.c"
...
# 28 "project/radare2/libr/bp/bp_traptrace.c" 3 4
 unsigned char 
# 28 "project/radare2/libr/bp/bp_traptrace.c"
     *buf = (enable)?trace->traps:trace->buffer;
  bp->iob.write_at (bp->iob.io, trace->addr, buf, trace->length);
 }
}


# 33 "project/radare2/libr/bp/bp_traptrace.c" 3 4
__attribute__((visibility("default"))) 
# 33 "project/radare2/libr/bp/bp_traptrace.c"
     void r_bp_traptrace_reset(RBreakpoint *bp, int hard) {
 RListIter *iter;
 RBreakpointTrace *trace;
 
# 36 "project/radare2/libr/bp/bp_traptrace.c" 3 4
if (
# 36 "project/radare2/libr/bp/bp_traptrace.c"
bp->traces
# 36 "project/radare2/libr/bp/bp_traptrace.c" 3 4
) for (
# 36 "project/radare2/libr/bp/bp_traptrace.c"
...
# 42 "project/radare2/libr/bp/bp_traptrace.c" 3 4
  __builtin___memset_chk (
# 42 "project/radare2/libr/bp/bp_traptrace.c"
  trace->bits
# 42 "project/radare2/libr/bp/bp_traptrace.c" 3 4
  , 
# 42 "project/radare2/libr/bp/bp_traptrace.c"
...
# 53 "project/radare2/libr/bp/bp_traptrace.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 53 "project/radare2/libr/bp/bp_traptrace.c"
          r_bp_traptrace_next(RBreakpoint *bp, 
# 53 "project/radare2/libr/bp/bp_traptrace.c" 3 4
                                               unsigned long long 
# 53 "project/radare2/libr/bp/bp_traptrace.c"
                                                    addr) {
...
# 57 "project/radare2/libr/bp/bp_traptrace.c" 3 4
if (
# 57 "project/radare2/libr/bp/bp_traptrace.c"
bp->traces
# 57 "project/radare2/libr/bp/bp_traptrace.c" 3 4
) for (
# 57 "project/radare2/libr/bp/bp_traptrace.c"
...
# 57 "project/radare2/libr/bp/bp_traptrace.c"
  ...
  if (addr>=trace->addr && addr<=trace->addr_end) {
   ...
   for (i=delta; i<trace->length; i++) {
    if (
# 61 "project/radare2/libr/bp/bp_traptrace.c" 3 4
       (*(
# 61 "project/radare2/libr/bp/bp_traptrace.c"
       trace->bits
# 61 "project/radare2/libr/bp/bp_traptrace.c" 3 4
       ) & (1<<(
# 61 "project/radare2/libr/bp/bp_traptrace.c"
...
# 70 "project/radare2/libr/bp/bp_traptrace.c" 3 4
__attribute__((visibility("default"))) 
# 70 "project/radare2/libr/bp/bp_traptrace.c"
     int r_bp_traptrace_add(RBreakpoint *bp, 
# 70 "project/radare2/libr/bp/bp_traptrace.c" 3 4
                                             unsigned long long 
# 70 "project/radare2/libr/bp/bp_traptrace.c"
                                                  from, 
...
# 72 "project/radare2/libr/bp/bp_traptrace.c" 3 4
unsigned char 
# 72 "project/radare2/libr/bp/bp_traptrace.c"
    *buf, *trap, *bits;
 
# 73 "project/radare2/libr/bp/bp_traptrace.c" 3 4
unsigned long long 
# 73 "project/radare2/libr/bp/bp_traptrace.c"
     len;
 int bitlen;

 if (from == 0LL) {
  return 
# 77 "project/radare2/libr/bp/bp_traptrace.c" 3 4
        0
# 77 "project/radare2/libr/bp/bp_traptrace.c"
             ;
 }
 if (from > to) {
  return 
# 80 "project/radare2/libr/bp/bp_traptrace.c" 3 4
        0
# 80 "project/radare2/libr/bp/bp_traptrace.c"
             ;
 }
 len = to-from;
 if (len >= 
# 83 "project/radare2/libr/bp/bp_traptrace.c" 3 4
           0x7FFFFFFF
# 83 "project/radare2/libr/bp/bp_traptrace.c"
                   ) {
  return 
# 84 "project/radare2/libr/bp/bp_traptrace.c" 3 4
        0
# 84 "project/radare2/libr/bp/bp_traptrace.c"
             ;
 }
 buf = (
# 86 "project/radare2/libr/bp/bp_traptrace.c" 3 4
       unsigned char
# 86 "project/radare2/libr/bp/bp_traptrace.c"
          *) malloc ((int)len);
 if (!buf) {
  return 
# 88 "project/radare2/libr/bp/bp_traptrace.c" 3 4
        0
# 88 "project/radare2/libr/bp/bp_traptrace.c"
             ;
 }
 trap = (
# 90 "project/radare2/libr/bp/bp_traptrace.c" 3 4
        unsigned char
# 90 "project/radare2/libr/bp/bp_traptrace.c"
           *) malloc ((int)len+4);
 if (!trap) {
  free (buf);
  return 
# 93 "project/radare2/libr/bp/bp_traptrace.c" 3 4
        0
# 93 "project/radare2/libr/bp/bp_traptrace.c"
             ;
 }
 bitlen = (len>>4)+1;
 bits = malloc (bitlen);
 if (!bits) {
  ...
  free (trap);
  return 
# 100 "project/radare2/libr/bp/bp_traptrace.c" 3 4
        0
# 100 "project/radare2/libr/bp/bp_traptrace.c"
             ;
 }

 bp->iob.read_at (bp->iob.io, from, buf, len);
 
# 104 "project/radare2/libr/bp/bp_traptrace.c" 3 4
__builtin___memset_chk (
# 104 "project/radare2/libr/bp/bp_traptrace.c"
bits
# 104 "project/radare2/libr/bp/bp_traptrace.c" 3 4
, 
# 104 "project/radare2/libr/bp/bp_traptrace.c"
...
# 104 "project/radare2/libr/bp/bp_traptrace.c"
 ...
 trace = 
# 107 "project/radare2/libr/bp/bp_traptrace.c" 3 4
        (
# 107 "project/radare2/libr/bp/bp_traptrace.c"
        RBreakpointTrace
# 107 "project/radare2/libr/bp/bp_traptrace.c" 3 4
        *)malloc(sizeof(
# 107 "project/radare2/libr/bp/bp_traptrace.c"
...
# 107 "project/radare2/libr/bp/bp_traptrace.c"
 ...
 if (!trace) {
  ...
  free (bits);
  return 
# 112 "project/radare2/libr/bp/bp_traptrace.c" 3 4
        0
# 112 "project/radare2/libr/bp/bp_traptrace.c"
             ;
 }
 trace->addr = from;
 trace->addr_end = to;
 ...
 if (!r_list_append (bp->traces, trace)){
  ...
  free (trace);
  return 
# 124 "project/radare2/libr/bp/bp_traptrace.c" 3 4
        0
# 124 "project/radare2/libr/bp/bp_traptrace.c"
             ;
 }


 return 
# 128 "project/radare2/libr/bp/bp_traptrace.c" 3 4
       1
# 128 "project/radare2/libr/bp/bp_traptrace.c"
           ;
}


# 131 "project/radare2/libr/bp/bp_traptrace.c" 3 4
__attribute__((visibility("default"))) 
# 131 "project/radare2/libr/bp/bp_traptrace.c"
     int r_bp_traptrace_free_at(RBreakpoint *bp, 
# 131 "project/radare2/libr/bp/bp_traptrace.c" 3 4
                                                 unsigned long long 
# 131 "project/radare2/libr/bp/bp_traptrace.c"
                                                      from) {
 int ret = 
# 132 "project/radare2/libr/bp/bp_traptrace.c" 3 4
          0
# 132 "project/radare2/libr/bp/bp_traptrace.c"
               ;
 RListIter *iter, *iter_tmp;
 RBreakpointTrace *trace;
 
# 135 "project/radare2/libr/bp/bp_traptrace.c" 3 4
if (
# 135 "project/radare2/libr/bp/bp_traptrace.c"
bp->traces
# 135 "project/radare2/libr/bp/bp_traptrace.c" 3 4
) for (
# 135 "project/radare2/libr/bp/bp_traptrace.c"
...
# 135 "project/radare2/libr/bp/bp_traptrace.c"
  ...
  if (from>=trace->addr && from<=trace->addr_end) {
   ...
   ret = 
# 141 "project/radare2/libr/bp/bp_traptrace.c" 3 4
        1
# 141 "project/radare2/libr/bp/bp_traptrace.c"
            ;
  }
 }
 return ret;
...
# 147 "project/radare2/libr/bp/bp_traptrace.c" 3 4
__attribute__((visibility("default"))) 
# 147 "project/radare2/libr/bp/bp_traptrace.c"
     void r_bp_traptrace_list(RBreakpoint *bp) {
 int i;
 RListIter *iter;
 RBreakpointTrace *trace;
 
# 151 "project/radare2/libr/bp/bp_traptrace.c" 3 4
if (
# 151 "project/radare2/libr/bp/bp_traptrace.c"
bp->traces
# 151 "project/radare2/libr/bp/bp_traptrace.c" 3 4
) for (
# 151 "project/radare2/libr/bp/bp_traptrace.c"
...
# 151 "project/radare2/libr/bp/bp_traptrace.c"
  ...
  for (i = 0; i < trace->bitlen; i++) {
   if (
# 153 "project/radare2/libr/bp/bp_traptrace.c" 3 4
      (*(
# 153 "project/radare2/libr/bp/bp_traptrace.c"
      trace->bits
# 153 "project/radare2/libr/bp/bp_traptrace.c" 3 4
      ) & (1<<(
# 153 "project/radare2/libr/bp/bp_traptrace.c"
...
# 154 "project/radare2/libr/bp/bp_traptrace.c" 3 4
   fprintf(__stderrp,
# 154 "project/radare2/libr/bp/bp_traptrace.c"
   "  - 0x%08" 
# 154 "project/radare2/libr/bp/bp_traptrace.c" 3 4
   "llx" 
# 154 "project/radare2/libr/bp/bp_traptrace.c"
...
# 160 "project/radare2/libr/bp/bp_traptrace.c" 3 4
__attribute__((visibility("default"))) 
# 160 "project/radare2/libr/bp/bp_traptrace.c"
     int r_bp_traptrace_at(RBreakpoint *bp, 
# 160 "project/radare2/libr/bp/bp_traptrace.c" 3 4
                                            unsigned long long 
# 160 "project/radare2/libr/bp/bp_traptrace.c"
                                                 from, int len) {
...
# 164 "project/radare2/libr/bp/bp_traptrace.c" 3 4
if (
# 164 "project/radare2/libr/bp/bp_traptrace.c"
bp->traces
# 164 "project/radare2/libr/bp/bp_traptrace.c" 3 4
) for (
# 164 "project/radare2/libr/bp/bp_traptrace.c"
...
# 164 "project/radare2/libr/bp/bp_traptrace.c"
  ...
  if (from>=trace->addr && from+len<=trace->addr_end) {
   ...
   if (
# 168 "project/radare2/libr/bp/bp_traptrace.c" 3 4
      (*(
# 168 "project/radare2/libr/bp/bp_traptrace.c"
      trace->bits
# 168 "project/radare2/libr/bp/bp_traptrace.c" 3 4
      ) & (1<<(
# 168 "project/radare2/libr/bp/bp_traptrace.c"
...
# 168 "project/radare2/libr/bp/bp_traptrace.c"
    ...
    if (trace->traps[delta] == 0x00) {
     return 
# 170 "project/radare2/libr/bp/bp_traptrace.c" 3 4
           0
# 170 "project/radare2/libr/bp/bp_traptrace.c"
                ;
    }
   }
   
# 173 "project/radare2/libr/bp/bp_traptrace.c" 3 4
  (((unsigned char*)
# 173 "project/radare2/libr/bp/bp_traptrace.c"
  trace->bits
# 173 "project/radare2/libr/bp/bp_traptrace.c" 3 4
  )[
# 173 "project/radare2/libr/bp/bp_traptrace.c"
...
# 173 "project/radare2/libr/bp/bp_traptrace.c"
                                ;
   return 
# 174 "project/radare2/libr/bp/bp_traptrace.c" 3 4
         1
# 174 "project/radare2/libr/bp/bp_traptrace.c"
             ;
  }
 }
 return 
# 177 "project/radare2/libr/bp/bp_traptrace.c" 3 4
       0
# 177 "project/radare2/libr/bp/bp_traptrace.c"
            ;
}
