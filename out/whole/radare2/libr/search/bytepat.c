# 0 "project/radare2/libr/search/bytepat.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/search/bytepat.c"
...
# 4 "project/radare2/libr/search/bytepat.c" 2
...
# 6 "project/radare2/libr/search/bytepat.c" 2
...
# 11 "project/radare2/libr/search/bytepat.c"
...
static fnditem* init_fi(void) {
 ...
 if (!n) {
  return 
# 20 "project/radare2/libr/search/bytepat.c" 3 4
        ((void *)0)
# 20 "project/radare2/libr/search/bytepat.c"
            ;
 }
 n->next = 
# 22 "project/radare2/libr/search/bytepat.c" 3 4
          ((void *)0)
# 22 "project/radare2/libr/search/bytepat.c"
              ;
 return n;
}
...
static void fini_fi(fnditem* fi) {
 ...
 while (fi->next) {
  ...
  free (fu);
  fu = 
# 33 "project/radare2/libr/search/bytepat.c" 3 4
      ((void *)0)
# 33 "project/radare2/libr/search/bytepat.c"
          ;
 }
 free (fu);
}
...
static void add_fi (fnditem* n, unsigned char* blk, int patlen) {
 fnditem* p;
 for (p = n; p->next != 
# 40 "project/radare2/libr/search/bytepat.c" 3 4
                       ((void *)0)
# 40 "project/radare2/libr/search/bytepat.c"
                           ; p = p->next) {
  ;
 }
...
# 45 "project/radare2/libr/search/bytepat.c" 3 4
__builtin___memcpy_chk (
# 45 "project/radare2/libr/search/bytepat.c"
p->str
# 45 "project/radare2/libr/search/bytepat.c" 3 4
, 
# 45 "project/radare2/libr/search/bytepat.c"
...
# 45 "project/radare2/libr/search/bytepat.c"
                            ;
 p->next = 
# 46 "project/radare2/libr/search/bytepat.c" 3 4
          ((void *)0)
# 46 "project/radare2/libr/search/bytepat.c"
              ;
}
...
static int is_fi_present(fnditem* n, unsigned char* blk , int patlen) {
 fnditem* p;
 for (p = n; p->next != 
# 51 "project/radare2/libr/search/bytepat.c" 3 4
                       ((void *)0)
# 51 "project/radare2/libr/search/bytepat.c"
                           ; p = p->next) {
  if (!memcmp (blk, p->str, patlen)) {
   return 
# 53 "project/radare2/libr/search/bytepat.c" 3 4
         1
# 53 "project/radare2/libr/search/bytepat.c"
             ;
  }
 }
 return 
# 56 "project/radare2/libr/search/bytepat.c" 3 4
       0
# 56 "project/radare2/libr/search/bytepat.c"
            ;
}


# 59 "project/radare2/libr/search/bytepat.c" 3 4
__attribute__((visibility("default"))) 
# 59 "project/radare2/libr/search/bytepat.c"
     int r_search_pattern(RSearch *s, 
# 59 "project/radare2/libr/search/bytepat.c" 3 4
                                      unsigned long long 
# 59 "project/radare2/libr/search/bytepat.c"
                                           from, 
...
# 60 "project/radare2/libr/search/bytepat.c" 3 4
unsigned char 
# 60 "project/radare2/libr/search/bytepat.c"
    block[(1024*1024)+1024], sblk[(1024*1024)+1024 +1];
 
# 61 "project/radare2/libr/search/bytepat.c" 3 4
unsigned long long 
# 61 "project/radare2/libr/search/bytepat.c"
     addr, bact, bytes, intaddr, rb, bproc = 0;
 int nr,i, moar=0, pcnt, cnt = 0, k = 0;
 int patlen = s->pattern_size;
 fnditem* root;

 
# 66 "project/radare2/libr/search/bytepat.c" 3 4
fprintf(__stderrp,
# 66 "project/radare2/libr/search/bytepat.c"
"Searching patterns between 0x%08"
# 66 "project/radare2/libr/search/bytepat.c" 3 4
"llx"
# 66 "project/radare2/libr/search/bytepat.c"
" and 0x%08"
...
# 66 "project/radare2/libr/search/bytepat.c"
                                                                                    ;
 if (patlen < 1 || patlen > 1024) {
  
# 68 "project/radare2/libr/search/bytepat.c" 3 4
 fprintf(__stderrp,
# 68 "project/radare2/libr/search/bytepat.c"
 "Invalid pattern length (must be > 1 and < %d)\n", 1024
# 68 "project/radare2/libr/search/bytepat.c" 3 4
 )
# 68 "project/radare2/libr/search/bytepat.c"
                                                                        ;
  return 
# 69 "project/radare2/libr/search/bytepat.c" 3 4
        0
# 69 "project/radare2/libr/search/bytepat.c"
             ;
 }
 bact = from;
 bytes = to;
 ...
 while (bact < bytes) {
  ...
  nr = ((bytes - bproc) < (1024*1024))?(bytes - bproc):(1024*1024);
...
# 112 "project/radare2/libr/search/bytepat.c" 3 4
     fprintf(__stderrp,
# 112 "project/radare2/libr/search/bytepat.c"
     "\nbytes: %d: ", pcnt
# 112 "project/radare2/libr/search/bytepat.c" 3 4
     )
# 112 "project/radare2/libr/search/bytepat.c"
...
# 114 "project/radare2/libr/search/bytepat.c" 3 4
      fprintf(__stderrp,
# 114 "project/radare2/libr/search/bytepat.c"
      "%02x", sblk[k]
# 114 "project/radare2/libr/search/bytepat.c" 3 4
      )
# 114 "project/radare2/libr/search/bytepat.c"
...
# 116 "project/radare2/libr/search/bytepat.c" 3 4
     fprintf(__stderrp,
# 116 "project/radare2/libr/search/bytepat.c"
     "\nfound: %d: 0x%08"
# 116 "project/radare2/libr/search/bytepat.c" 3 4
     "llx"
# 116 "project/radare2/libr/search/bytepat.c"
...
# 120 "project/radare2/libr/search/bytepat.c" 3 4
    fprintf(__stderrp,
# 120 "project/radare2/libr/search/bytepat.c"
    "0x%08"
# 120 "project/radare2/libr/search/bytepat.c" 3 4
    "llx"
# 120 "project/radare2/libr/search/bytepat.c"
...
# 124 "project/radare2/libr/search/bytepat.c" 3 4
   fprintf(__stderrp,
# 124 "project/radare2/libr/search/bytepat.c"
   "\ncount: %d: %d\n", pcnt, moar + 1
# 124 "project/radare2/libr/search/bytepat.c" 3 4
   )
# 124 "project/radare2/libr/search/bytepat.c"
...
# 130 "project/radare2/libr/search/bytepat.c" 3 4
fprintf(__stderrp,
# 130 "project/radare2/libr/search/bytepat.c"
"\n"
# 130 "project/radare2/libr/search/bytepat.c" 3 4
)
# 130 "project/radare2/libr/search/bytepat.c"
