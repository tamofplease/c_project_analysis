# 0 "project/radare2/libr/search/keyword.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/search/keyword.c"
...
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_search.h" 2 3 4
...
# 6 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_search.h" 2 3 4
...
# 4 "project/radare2/libr/search/keyword.c" 2


# 5 "project/radare2/libr/search/keyword.c"
static int ignoreMask(const 
# 5 "project/radare2/libr/search/keyword.c" 3 4
                           unsigned char 
# 5 "project/radare2/libr/search/keyword.c"
                               *bm, int len) {
 int i;
...
# 15 "project/radare2/libr/search/keyword.c" 3 4
__attribute__((visibility("default"))) 
# 15 "project/radare2/libr/search/keyword.c"
     RSearchKeyword* r_search_keyword_new(const 
# 15 "project/radare2/libr/search/keyword.c" 3 4
                                                unsigned char 
# 15 "project/radare2/libr/search/keyword.c"
                                                    *kwbuf, int kwlen, const 
# 15 "project/radare2/libr/search/keyword.c" 3 4
                                                                             unsigned char 
# 15 "project/radare2/libr/search/keyword.c"
                                                                                 *bmbuf, int bmlen, const char *data) {
 RSearchKeyword *kw;
 if (kwlen < 1 || bmlen < 0) {
  return 
# 18 "project/radare2/libr/search/keyword.c" 3 4
        ((void *)0)
# 18 "project/radare2/libr/search/keyword.c"
            ;
 }
 kw = 
# 20 "project/radare2/libr/search/keyword.c" 3 4
     (
# 20 "project/radare2/libr/search/keyword.c"
     RSearchKeyword
# 20 "project/radare2/libr/search/keyword.c" 3 4
     *)calloc(1,sizeof(
# 20 "project/radare2/libr/search/keyword.c"
...
# 20 "project/radare2/libr/search/keyword.c"
 ...
 if (!kw) {
  return 
# 22 "project/radare2/libr/search/keyword.c" 3 4
        ((void *)0)
# 22 "project/radare2/libr/search/keyword.c"
            ;
 }
 kw->type = 
# 24 "project/radare2/libr/search/keyword.c" 3 4
           'i'
# 24 "project/radare2/libr/search/keyword.c"
                                       ;
 kw->data = (void *) data;
 ...
 if (!kw->bin_keyword) {
  ...
  return 
# 30 "project/radare2/libr/search/keyword.c" 3 4
        ((void *)0)
# 30 "project/radare2/libr/search/keyword.c"
            ;
 }
 
# 32 "project/radare2/libr/search/keyword.c" 3 4
__builtin___memcpy_chk (
# 32 "project/radare2/libr/search/keyword.c"
kw->bin_keyword
# 32 "project/radare2/libr/search/keyword.c" 3 4
, 
# 32 "project/radare2/libr/search/keyword.c"
...
# 32 "project/radare2/libr/search/keyword.c"
 ...
 if (bmbuf && bmlen > 0 && !ignoreMask (bmbuf, bmlen)) {
  ...
  if (!kw->bin_binmask) {
   r_search_keyword_free (kw);
   return 
# 37 "project/radare2/libr/search/keyword.c" 3 4
         ((void *)0)
# 37 "project/radare2/libr/search/keyword.c"
             ;
  }
  
# 39 "project/radare2/libr/search/keyword.c" 3 4
 __builtin___memcpy_chk (
# 39 "project/radare2/libr/search/keyword.c"
 kw->bin_binmask
# 39 "project/radare2/libr/search/keyword.c" 3 4
 , 
# 39 "project/radare2/libr/search/keyword.c"
...
# 39 "project/radare2/libr/search/keyword.c"
  ...
  kw->bin_binmask = 
# 42 "project/radare2/libr/search/keyword.c" 3 4
                   ((void *)0)
# 42 "project/radare2/libr/search/keyword.c"
                       ;
  kw->binmask_length = 0;
 }
 return kw;
...
# 48 "project/radare2/libr/search/keyword.c" 3 4
__attribute__((visibility("default"))) 
# 48 "project/radare2/libr/search/keyword.c"
     void r_search_keyword_free (RSearchKeyword *kw) {
 if (!kw) {
  return;
 }
 free (kw->bin_binmask);
...
# 57 "project/radare2/libr/search/keyword.c" 3 4
__attribute__((visibility("default"))) 
# 57 "project/radare2/libr/search/keyword.c"
     RSearchKeyword* r_search_keyword_new_str(const char *kwbuf, const char *bmstr, const char *data, int ignore_case) {
 RSearchKeyword *kw;
 
# 59 "project/radare2/libr/search/keyword.c" 3 4
unsigned char 
# 59 "project/radare2/libr/search/keyword.c"
    *bmbuf = 
# 59 "project/radare2/libr/search/keyword.c" 3 4
             ((void *)0)
# 59 "project/radare2/libr/search/keyword.c"
 ...
 if (bmstr) {
  ...
  if (!bmbuf) {
   return 
# 65 "project/radare2/libr/search/keyword.c" 3 4
         ((void *)0)
# 65 "project/radare2/libr/search/keyword.c"
             ;
  }
  bmlen = r_hex_str2bin (bmstr, bmbuf);
  if (bmlen < 1) {
   
# 69 "project/radare2/libr/search/keyword.c" 3 4
  { free((void *)
# 69 "project/radare2/libr/search/keyword.c"
  bmbuf
# 69 "project/radare2/libr/search/keyword.c" 3 4
  ); 
# 69 "project/radare2/libr/search/keyword.c"
...
# 69 "project/radare2/libr/search/keyword.c"
 ...
 kw = r_search_keyword_new ((
# 72 "project/radare2/libr/search/keyword.c" 3 4
                            unsigned char 
# 72 "project/radare2/libr/search/keyword.c"
                                *)kwbuf, strlen (kwbuf), bmbuf, bmlen, data);
 if (kw) {
  kw->icase = ignore_case;
  kw->type = 
# 75 "project/radare2/libr/search/keyword.c" 3 4
            's'
# 75 "project/radare2/libr/search/keyword.c"
                                        ;
 }
 free (bmbuf);
 return kw;
...
# 81 "project/radare2/libr/search/keyword.c" 3 4
__attribute__((visibility("default"))) 
# 81 "project/radare2/libr/search/keyword.c"
     RSearchKeyword* r_search_keyword_new_wide(const char *kwbuf, const char *bmstr, const char *data, int ignore_case) {
 RSearchKeyword *kw;
 int len;
 const char *p2;
 char *p, *str;
 
# 86 "project/radare2/libr/search/keyword.c" 3 4
unsigned char 
# 86 "project/radare2/libr/search/keyword.c"
    *bmbuf = 
# 86 "project/radare2/libr/search/keyword.c" 3 4
             ((void *)0)
# 86 "project/radare2/libr/search/keyword.c"
 ...
 if (bmstr) {
  ...
  if (!bmbuf) {
   return 
# 92 "project/radare2/libr/search/keyword.c" 3 4
         ((void *)0)
# 92 "project/radare2/libr/search/keyword.c"
             ;
  }
  bmlen = r_hex_str2bin (bmstr, bmbuf);
  if (bmlen < 1) {
   
# 96 "project/radare2/libr/search/keyword.c" 3 4
  { free((void *)
# 96 "project/radare2/libr/search/keyword.c"
  bmbuf
# 96 "project/radare2/libr/search/keyword.c" 3 4
  ); 
# 96 "project/radare2/libr/search/keyword.c"
...
# 96 "project/radare2/libr/search/keyword.c"
 ...
 for (p2=kwbuf, p=str; *p2; ) {
  RRune ch;
  int num_utf8_bytes = r_utf8_decode ((const 
# 104 "project/radare2/libr/search/keyword.c" 3 4
                                            unsigned char 
# 104 "project/radare2/libr/search/keyword.c"
                                                *)p2, kwbuf + len - p2, &ch);
  if (num_utf8_bytes < 1) {
   
# 106 "project/radare2/libr/search/keyword.c" 3 4
  fprintf(__stderrp,
# 106 "project/radare2/libr/search/keyword.c"
...
# 106 "project/radare2/libr/search/keyword.c"
  ...
  int num_wide_bytes = r_utf16le_encode ((
# 116 "project/radare2/libr/search/keyword.c" 3 4
                                         unsigned char 
# 116 "project/radare2/libr/search/keyword.c"
                                             *)p, ch);
  
# 117 "project/radare2/libr/search/keyword.c" 3 4
 do { if (!(
# 117 "project/radare2/libr/search/keyword.c"
 num_wide_bytes != 0
# 117 "project/radare2/libr/search/keyword.c" 3 4
 )) { r_assert_log (R_LOGLVL_WARN, "WARNING (%s:%d):%s%s runtime check failed: (%s)\n", "project/radare2/libr/search/keyword.c", 117, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : "", 
# 117 "project/radare2/libr/search/keyword.c"
 "num_wide_bytes != 0"
# 117 "project/radare2/libr/search/keyword.c" 3 4
 ); } } while (0)
# 117 "project/radare2/libr/search/keyword.c"
 ...
 kw = r_search_keyword_new ((
# 122 "project/radare2/libr/search/keyword.c" 3 4
                            unsigned char 
# 122 "project/radare2/libr/search/keyword.c"
                                *)str, p - str, bmbuf, bmlen, data);
 free(str);
 if (kw) {
  kw->icase = ignore_case;
 }
...
# 131 "project/radare2/libr/search/keyword.c" 3 4
__attribute__((visibility("default"))) 
# 131 "project/radare2/libr/search/keyword.c"
     RSearchKeyword* r_search_keyword_new_hex(const char *kwstr, const char *bmstr, const char *data) {
 RSearchKeyword *kw;
 
# 133 "project/radare2/libr/search/keyword.c" 3 4
unsigned char 
# 133 "project/radare2/libr/search/keyword.c"
    *kwbuf, *bmbuf;
 int kwlen, bmlen = 0;

 if (!kwstr) {
  return 
# 137 "project/radare2/libr/search/keyword.c" 3 4
        ((void *)0)
# 137 "project/radare2/libr/search/keyword.c"
            ;
 }
 ...
 if (!kwbuf) {
  return 
# 142 "project/radare2/libr/search/keyword.c" 3 4
        ((void *)0)
# 142 "project/radare2/libr/search/keyword.c"
            ;
 }
 ...
 if (kwlen < 1) {
  free (kwbuf);
  return 
# 148 "project/radare2/libr/search/keyword.c" 3 4
        ((void *)0)
# 148 "project/radare2/libr/search/keyword.c"
            ;
 }

 bmbuf = 
# 151 "project/radare2/libr/search/keyword.c" 3 4
        ((void *)0)
# 151 "project/radare2/libr/search/keyword.c"
            ;
 if (bmstr && *bmstr) {
  bmbuf = malloc (strlen (bmstr)+1);
  if (!bmbuf) {
   free (kwbuf);
   return 
# 156 "project/radare2/libr/search/keyword.c" 3 4
         ((void *)0)
# 156 "project/radare2/libr/search/keyword.c"
             ;
  }
  bmlen = r_hex_str2bin (bmstr, bmbuf);
  if (bmlen < 1) {
   ...
   free (kwbuf);
   return 
# 162 "project/radare2/libr/search/keyword.c" 3 4
         ((void *)0)
# 162 "project/radare2/libr/search/keyword.c"
             ;
  }
 }
...
# 172 "project/radare2/libr/search/keyword.c" 3 4
__attribute__((visibility("default"))) 
# 172 "project/radare2/libr/search/keyword.c"
     RSearchKeyword* r_search_keyword_new_hexmask(const char *kwstr, const char *data) {
 RSearchKeyword *ks = 
# 173 "project/radare2/libr/search/keyword.c" 3 4
                     ((void *)0)
# 173 "project/radare2/libr/search/keyword.c"
                         ;
 
# 174 "project/radare2/libr/search/keyword.c" 3 4
unsigned char 
# 174 "project/radare2/libr/search/keyword.c"
    *kw, *bm;
 if (kwstr != 
# 175 "project/radare2/libr/search/keyword.c" 3 4
             ((void *)0)
# 175 "project/radare2/libr/search/keyword.c"
                 ) {
  int len = strlen (kwstr);
  kw = malloc (len + 4);
  bm = malloc (len + 4);
  if (kw != 
# 179 "project/radare2/libr/search/keyword.c" 3 4
           ((void *)0) 
# 179 "project/radare2/libr/search/keyword.c"
                && bm != 
# 179 "project/radare2/libr/search/keyword.c" 3 4
                         ((void *)0)
# 179 "project/radare2/libr/search/keyword.c"
                             ) {
   len = r_hex_str2binmask (kwstr, (
# 180 "project/radare2/libr/search/keyword.c" 3 4
                                   unsigned char
# 180 "project/radare2/libr/search/keyword.c"
                                      *)kw, (
# 180 "project/radare2/libr/search/keyword.c" 3 4
                                             unsigned char
# 180 "project/radare2/libr/search/keyword.c"
...
# 195 "project/radare2/libr/search/keyword.c" 3 4
__attribute__((visibility("default"))) 
# 195 "project/radare2/libr/search/keyword.c"
     RSearchKeyword *r_search_keyword_new_regexp (const char *str, const char *data) {
 RSearchKeyword *kw;
 ...
 if (str[i++] != '/') {
  return 
# 204 "project/radare2/libr/search/keyword.c" 3 4
        ((void *)0)
# 204 "project/radare2/libr/search/keyword.c"
            ;
 }
 ...
 if (str[i++] != '/') {
  return 
# 218 "project/radare2/libr/search/keyword.c" 3 4
        ((void *)0)
# 218 "project/radare2/libr/search/keyword.c"
            ;
 }
 ...
 if ((length > 128) || (length < 1)) {
  return 
# 223 "project/radare2/libr/search/keyword.c" 3 4
        ((void *)0)
# 223 "project/radare2/libr/search/keyword.c"
            ;
 }

 kw = 
# 226 "project/radare2/libr/search/keyword.c" 3 4
     (
# 226 "project/radare2/libr/search/keyword.c"
     RSearchKeyword
# 226 "project/radare2/libr/search/keyword.c" 3 4
     *)calloc(1,sizeof(
# 226 "project/radare2/libr/search/keyword.c"
...
# 226 "project/radare2/libr/search/keyword.c"
 ...
 if (!kw) {
  return 
# 228 "project/radare2/libr/search/keyword.c" 3 4
        ((void *)0)
# 228 "project/radare2/libr/search/keyword.c"
            ;
 }
 ...
 if (!kw->bin_keyword) {
  r_search_keyword_free (kw);
  return 
# 234 "project/radare2/libr/search/keyword.c" 3 4
        ((void *)0)
# 234 "project/radare2/libr/search/keyword.c"
            ;
 }

 kw->bin_keyword[length]=0;
 
# 238 "project/radare2/libr/search/keyword.c" 3 4
__builtin___memcpy_chk (
# 238 "project/radare2/libr/search/keyword.c"
kw->bin_keyword
# 238 "project/radare2/libr/search/keyword.c" 3 4
, 
# 238 "project/radare2/libr/search/keyword.c"
...
# 238 "project/radare2/libr/search/keyword.c"
 ...
 kw->type = 
# 240 "project/radare2/libr/search/keyword.c" 3 4
           's'
# 240 "project/radare2/libr/search/keyword.c"
                                       ;
 kw->data = (void *) data;
 ...
 for (; str[i]; i++) {
  switch (str[i]) {
   case 'i':
    kw->icase = 
# 247 "project/radare2/libr/search/keyword.c" 3 4
               1
# 247 "project/radare2/libr/search/keyword.c"
                   ;
    break;
   default:
    r_search_keyword_free (kw);
    return 
# 251 "project/radare2/libr/search/keyword.c" 3 4
          ((void *)0)
# 251 "project/radare2/libr/search/keyword.c"
              ;
  }
 }
