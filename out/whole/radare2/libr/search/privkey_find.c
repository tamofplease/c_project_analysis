# 0 "project/radare2/libr/search/privkey_find.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 7 "project/radare2/libr/search/privkey_find.c" 2
...
# 22 "project/radare2/libr/search/privkey_find.c"
static const 
# 22 "project/radare2/libr/search/privkey_find.c" 3 4
            unsigned char 
# 22 "project/radare2/libr/search/privkey_find.c"
                *parse_next_field(const 
# 22 "project/radare2/libr/search/privkey_find.c" 3 4
                                        unsigned char 
# 22 "project/radare2/libr/search/privkey_find.c"
                                            *start, 
 ...
 *len = 0;
 if (!(start[1] & 0x80)) {
  *len = (
# 25 "project/radare2/libr/search/privkey_find.c" 3 4
         unsigned int
# 25 "project/radare2/libr/search/privkey_find.c"
             )start[1];
  return start + 2;
 } else {
  int i;
...
static int check_fields(const 
# 40 "project/radare2/libr/search/privkey_find.c" 3 4
                             unsigned char 
# 40 "project/radare2/libr/search/privkey_find.c"
                                 *start) {
#define KEY_MAX_LEN 26000
 
# 42 "project/radare2/libr/search/privkey_find.c" 3 4
unsigned int 
# 42 "project/radare2/libr/search/privkey_find.c"
     field_len = 0;

 const 
# 44 "project/radare2/libr/search/privkey_find.c" 3 4
      unsigned char 
# 44 "project/radare2/libr/search/privkey_find.c"
          *ptr = parse_next_field (start, &field_len);
 if (!field_len || field_len > 26000) {
  return 
# 46 "project/radare2/libr/search/privkey_find.c" 3 4
        0
# 46 "project/radare2/libr/search/privkey_find.c"
             ;
 }
 ...
 if (field_len != 1) {
  return 
# 52 "project/radare2/libr/search/privkey_find.c" 3 4
        0
# 52 "project/radare2/libr/search/privkey_find.c"
             ;
 }
 ptr = ptr + field_len;
 ptr = parse_next_field (ptr, &field_len);
 ...
 if (!field_len || field_len > 26000) {
  return 
# 58 "project/radare2/libr/search/privkey_find.c" 3 4
        0
# 58 "project/radare2/libr/search/privkey_find.c"
             ;
 }

 return 
# 61 "project/radare2/libr/search/privkey_find.c" 3 4
       1
# 61 "project/radare2/libr/search/privkey_find.c"
           ;
}
...
# 67 "project/radare2/libr/search/privkey_find.c" 3 4
                                           unsigned long long 
# 67 "project/radare2/libr/search/privkey_find.c"
                                                from, const 
# 67 "project/radare2/libr/search/privkey_find.c" 3 4
                                                            unsigned char 
# 67 "project/radare2/libr/search/privkey_find.c"
 ...
 const 
# 72 "project/radare2/libr/search/privkey_find.c" 3 4
      unsigned char 
# 72 "project/radare2/libr/search/privkey_find.c"
          rsa_versionmarker[] = { 0x02, 0x01, 0x00, 0x02 };
 const 
# 73 "project/radare2/libr/search/privkey_find.c" 3 4
      unsigned char 
# 73 "project/radare2/libr/search/privkey_find.c"
          ecc_versionmarker[] = { 0x02, 0x01, 0x01, 0x04 };
 const 
# 74 "project/radare2/libr/search/privkey_find.c" 3 4
      unsigned char 
# 74 "project/radare2/libr/search/privkey_find.c"
          safecurves_versionmarker[] = { 0x02, 0x01, 0x00, 0x30 };
...
# 80 "project/radare2/libr/search/privkey_find.c" 3 4
if (
# 80 "project/radare2/libr/search/privkey_find.c"
s->kws
# 80 "project/radare2/libr/search/privkey_find.c" 3 4
) for (
# 80 "project/radare2/libr/search/privkey_find.c"
