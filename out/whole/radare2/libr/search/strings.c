# 0 "project/radare2/libr/search/strings.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/search/strings.c" 2



# 6 "project/radare2/libr/search/strings.c"
enum {
 ENCODING_ASCII = 0,
 ENCODING_CP850 = 1
};

static char *encodings[3] = { "ascii", "cp850", 
# 11 "project/radare2/libr/search/strings.c" 3 4
                                               ((void *)0) 
# 11 "project/radare2/libr/search/strings.c"
                                                    };




# 15 "project/radare2/libr/search/strings.c" 3 4
__attribute__((visibility("default"))) 
# 15 "project/radare2/libr/search/strings.c"
...
# 20 "project/radare2/libr/search/strings.c" 3 4
unsigned int 
# 20 "project/radare2/libr/search/strings.c"
     lename = strlen (name);
 for (i = 0; encodings[i]; i++) {
  
# 22 "project/radare2/libr/search/strings.c" 3 4
 unsigned int 
# 22 "project/radare2/libr/search/strings.c"
      sz = 
# 22 "project/radare2/libr/search/strings.c" 3 4
           (((
# 22 "project/radare2/libr/search/strings.c"
...
static 
# 30 "project/radare2/libr/search/strings.c" 3 4
      _Bool 
# 30 "project/radare2/libr/search/strings.c"
           is_encoded(int encoding, unsigned char c) {
 switch (encoding) {
 case ENCODING_ASCII:
  break;
 case ENCODING_CP850:
  ...
  case 233:
   return 
# 54 "project/radare2/libr/search/strings.c" 3 4
         1
# 54 "project/radare2/libr/search/strings.c"
             ;
  }
  break;
 }
 return 
# 58 "project/radare2/libr/search/strings.c" 3 4
       0
# 58 "project/radare2/libr/search/strings.c"
            ;
}

 int search_strings_update(RSearch *s, 
# 61 "project/radare2/libr/search/strings.c" 3 4
                                           unsigned long long 
# 61 "project/radare2/libr/search/strings.c"
                                                from, const 
# 61 "project/radare2/libr/search/strings.c" 3 4
                                                            unsigned char 
# 61 "project/radare2/libr/search/strings.c"
 ...
 int i = 0;
 int widechar = 
# 63 "project/radare2/libr/search/strings.c" 3 4
               0
# 63 "project/radare2/libr/search/strings.c"
                    ;
 int matches = 0;
 char str[4096];
 RListIter *iter;
...
# 69 "project/radare2/libr/search/strings.c" 3 4
if (
# 69 "project/radare2/libr/search/strings.c"
s->kws
# 69 "project/radare2/libr/search/strings.c" 3 4
) for (
# 69 "project/radare2/libr/search/strings.c"
...
# 69 "project/radare2/libr/search/strings.c"
  ...
  for (i = 0; i < len; i++) {
   ...
   if (
# 73 "project/radare2/libr/search/strings.c" 3 4
      ((
# 73 "project/radare2/libr/search/strings.c"
      ch
# 73 "project/radare2/libr/search/strings.c" 3 4
      ) >=' ' && (
# 73 "project/radare2/libr/search/strings.c"
...
# 78 "project/radare2/libr/search/strings.c" 3 4
    fprintf(__stderrp,
# 78 "project/radare2/libr/search/strings.c"
    "Truncated match, keyword is too large\n"
# 78 "project/radare2/libr/search/strings.c" 3 4
    )
# 78 "project/radare2/libr/search/strings.c"
                                                       ;
    ...
    if (matches && i + 2 < len && buf[i+2]=='\0' && buf[i]=='\0' && buf[i+1]!='\0') {
     widechar = 
# 83 "project/radare2/libr/search/strings.c" 3 4
               1
# 83 "project/radare2/libr/search/strings.c"
                   ;
...
# 92 "project/radare2/libr/search/strings.c" 3 4
      unsigned long long 
# 92 "project/radare2/libr/search/strings.c"
           off = (
# 92 "project/radare2/libr/search/strings.c" 3 4
                  unsigned long long
# 92 "project/radare2/libr/search/strings.c"
...
# 95 "project/radare2/libr/search/strings.c" 3 4
      unsigned long long 
# 95 "project/radare2/libr/search/strings.c"
           off = (
# 95 "project/radare2/libr/search/strings.c" 3 4
                  unsigned long long
# 95 "project/radare2/libr/search/strings.c"
     ...
     fflush (
# 99 "project/radare2/libr/search/strings.c" 3 4
            __stdoutp
# 99 "project/radare2/libr/search/strings.c"
                  );
    }
    matches = 0;
    widechar = 
# 102 "project/radare2/libr/search/strings.c" 3 4
              0
# 102 "project/radare2/libr/search/strings.c"
                   ;
   }
  }
 }
