# 0 "project/radare2/libr/search/regexp.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/search/regexp.c"
...
# 4 "project/radare2/libr/search/regexp.c" 2


 
# 6 "project/radare2/libr/search/regexp.c"
     int search_regexp_update(RSearch *s, 
# 6 "project/radare2/libr/search/regexp.c" 3 4
                                          unsigned long long 
# 6 "project/radare2/libr/search/regexp.c"
                                               from, const 
# 6 "project/radare2/libr/search/regexp.c" 3 4
...
# 14 "project/radare2/libr/search/regexp.c" 3 4
if (
# 14 "project/radare2/libr/search/regexp.c"
s->kws
# 14 "project/radare2/libr/search/regexp.c" 3 4
) for (
# 14 "project/radare2/libr/search/regexp.c"
...
# 14 "project/radare2/libr/search/regexp.c"
                                  {
  int reflags = 
# 15 "project/radare2/libr/search/regexp.c" 3 4
               0001
# 15 "project/radare2/libr/search/regexp.c"
                               ;

  if (kw->icase) {
   reflags |= 
# 18 "project/radare2/libr/search/regexp.c" 3 4
             0002
# 18 "project/radare2/libr/search/regexp.c"
                          ;
  }

  if (r_regex_init (&rx, (char *)kw->bin_keyword, reflags)) {
   
# 22 "project/radare2/libr/search/regexp.c" 3 4
  fprintf(__stderrp,
# 22 "project/radare2/libr/search/regexp.c"
...
# 22 "project/radare2/libr/search/regexp.c"
  ...
  while (!r_regex_exec (&rx, (char *)buf, 1, &match, 
# 29 "project/radare2/libr/search/regexp.c" 3 4
                                                    00004
# 29 "project/radare2/libr/search/regexp.c"
                                                                    )) {
