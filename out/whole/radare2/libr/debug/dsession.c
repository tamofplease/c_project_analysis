# 0 "project/radare2/libr/debug/dsession.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/debug/dsession.c"
...
# 4 "project/radare2/libr/debug/dsession.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_json.h" 1 3 4



#define R_JSON_H 
# 25 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_json.h" 3 4
...
__attribute__((visibility("default"))) RJson *r_json_parse(char *text);

__attribute__((visibility("default"))) void r_json_free(RJson *js);

__attribute__((visibility("default"))) const RJson *r_json_get(const RJson *json, const char *key);
__attribute__((visibility("default"))) const RJson *r_json_item(const RJson *json, size_t idx);
# 5 "project/radare2/libr/debug/dsession.c" 2
...
# 10 "project/radare2/libr/debug/dsession.c"
     void r_debug_session_free(RDebugSession *session) {
 if (session) {
  r_vector_free (session->checkpoints);
  ht_up_free (session->registers);
  ht_up_free (session->memory);
  
# 15 "project/radare2/libr/debug/dsession.c" 3 4
 { free((void *)
# 15 "project/radare2/libr/debug/dsession.c"
 session
# 15 "project/radare2/libr/debug/dsession.c" 3 4
 ); 
# 15 "project/radare2/libr/debug/dsession.c"
...
# 32 "project/radare2/libr/debug/dsession.c" 3 4
__attribute__((visibility("default"))) 
# 32 "project/radare2/libr/debug/dsession.c"
     RDebugSession *r_debug_session_new(void) {
 RDebugSession *session = 
# 33 "project/radare2/libr/debug/dsession.c" 3 4
                         (
# 33 "project/radare2/libr/debug/dsession.c"
                         RDebugSession
# 33 "project/radare2/libr/debug/dsession.c" 3 4
                         *)calloc(1,sizeof(
# 33 "project/radare2/libr/debug/dsession.c"
...
# 33 "project/radare2/libr/debug/dsession.c"
 ...
 if (!session) {
  return 
# 35 "project/radare2/libr/debug/dsession.c" 3 4
        ((void *)0)
# 35 "project/radare2/libr/debug/dsession.c"
            ;
 }

 session->checkpoints = r_vector_new (sizeof (RDebugCheckpoint), r_debug_checkpoint_fini, 
# 38 "project/radare2/libr/debug/dsession.c" 3 4
                                                                                         ((void *)0)
# 38 "project/radare2/libr/debug/dsession.c"
                                                                                             );
 if (!session->checkpoints) {
  r_debug_session_free (session);
  return 
# 41 "project/radare2/libr/debug/dsession.c" 3 4
        ((void *)0)
# 41 "project/radare2/libr/debug/dsession.c"
            ;
 }
 session->registers = ht_up_new (
# 43 "project/radare2/libr/debug/dsession.c" 3 4
                                ((void *)0)
# 43 "project/radare2/libr/debug/dsession.c"
                                    , htup_vector_free, 
# 43 "project/radare2/libr/debug/dsession.c" 3 4
                                                        ((void *)0)
# 43 "project/radare2/libr/debug/dsession.c"
 ...
 if (!session->registers) {
  r_debug_session_free (session);
  return 
# 46 "project/radare2/libr/debug/dsession.c" 3 4
        ((void *)0)
# 46 "project/radare2/libr/debug/dsession.c"
            ;
 }
 session->memory = ht_up_new (
# 48 "project/radare2/libr/debug/dsession.c" 3 4
                             ((void *)0)
# 48 "project/radare2/libr/debug/dsession.c"
                                 , htup_vector_free, 
# 48 "project/radare2/libr/debug/dsession.c" 3 4
                                                     ((void *)0)
# 48 "project/radare2/libr/debug/dsession.c"
 ...
 if (!session->memory) {
  r_debug_session_free (session);
  return 
# 51 "project/radare2/libr/debug/dsession.c" 3 4
        ((void *)0)
# 51 "project/radare2/libr/debug/dsession.c"
            ;
 }
...
# 57 "project/radare2/libr/debug/dsession.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 57 "project/radare2/libr/debug/dsession.c"
          r_debug_add_checkpoint(RDebug *dbg) {
 
# 58 "project/radare2/libr/debug/dsession.c" 3 4
do { if (!(
# 58 "project/radare2/libr/debug/dsession.c"
dbg->session
# 58 "project/radare2/libr/debug/dsession.c" 3 4
...
# 68 "project/radare2/libr/debug/dsession.c" 3 4
  __builtin___memcpy_chk (
# 68 "project/radare2/libr/debug/dsession.c"
  b->bytes
# 68 "project/radare2/libr/debug/dsession.c" 3 4
  , 
# 68 "project/radare2/libr/debug/dsession.c"
...
# 68 "project/radare2/libr/debug/dsession.c"
 ...
 if (!checkpoint.snaps) {
  return 
# 76 "project/radare2/libr/debug/dsession.c" 3 4
        0
# 76 "project/radare2/libr/debug/dsession.c"
             ;
 }
 RListIter *iter;
 RDebugMap *map;
...
# 81 "project/radare2/libr/debug/dsession.c" 3 4
if (
# 81 "project/radare2/libr/debug/dsession.c"
dbg->maps
# 81 "project/radare2/libr/debug/dsession.c" 3 4
) for (
# 81 "project/radare2/libr/debug/dsession.c"
...
# 81 "project/radare2/libr/debug/dsession.c"
                                      {
  if ((map->perm & 
# 82 "project/radare2/libr/debug/dsession.c" 3 4
                  (4|2)
# 82 "project/radare2/libr/debug/dsession.c"
                           ) == 
# 82 "project/radare2/libr/debug/dsession.c" 3 4
                                (4|2)
# 82 "project/radare2/libr/debug/dsession.c"
...
# 95 "project/radare2/libr/debug/dsession.c" 3 4
unsigned long long 
# 95 "project/radare2/libr/debug/dsession.c"
     data = r_reg_get_value (dbg->reg, ripc);
 r_debug_session_add_reg_change (dbg->session, ripc->arena, ripc->offset, data);

 return 
# 98 "project/radare2/libr/debug/dsession.c" 3 4
       1
# 98 "project/radare2/libr/debug/dsession.c"
           ;
}
...
# 107 "project/radare2/libr/debug/dsession.c" 3 4
  __builtin___memcpy_chk (
# 107 "project/radare2/libr/debug/dsession.c"
  b->bytes
# 107 "project/radare2/libr/debug/dsession.c" 3 4
  , 
# 107 "project/radare2/libr/debug/dsession.c"
...
static void _set_register(RDebug *dbg, RRegItem *ri, 
# 112 "project/radare2/libr/debug/dsession.c" 3 4
                                                    unsigned int 
# 112 "project/radare2/libr/debug/dsession.c"
                                                         cnum) {
 RVector *vreg = ht_up_find (dbg->session->registers, ri->offset | (ri->arena << 16), 
# 113 "project/radare2/libr/debug/dsession.c" 3 4
                                                                                     ((void *)0)
# 113 "project/radare2/libr/debug/dsession.c"
                                                                                         );
 if (!vreg) {
  return;
 }
...
# 118 "project/radare2/libr/debug/dsession.c" 3 4
do { size_t h = (
# 118 "project/radare2/libr/debug/dsession.c"
vreg
# 118 "project/radare2/libr/debug/dsession.c" 3 4
)->len, m; for (
# 118 "project/radare2/libr/debug/dsession.c"
...
# 127 "project/radare2/libr/debug/dsession.c" 3 4
__attribute__((visibility("default"))) 
# 127 "project/radare2/libr/debug/dsession.c"
     void _restore_registers(RDebug *dbg, 
# 127 "project/radare2/libr/debug/dsession.c" 3 4
                                          unsigned int 
# 127 "project/radare2/libr/debug/dsession.c"
                                               cnum) {
...
# 131 "project/radare2/libr/debug/dsession.c" 3 4
if (
# 131 "project/radare2/libr/debug/dsession.c"
dbg->reg->allregs
# 131 "project/radare2/libr/debug/dsession.c" 3 4
) for (
# 131 "project/radare2/libr/debug/dsession.c"
...
# 139 "project/radare2/libr/debug/dsession.c" 3 4
if (
# 139 "project/radare2/libr/debug/dsession.c"
dbg->session->cur_chkpt->snaps
# 139 "project/radare2/libr/debug/dsession.c" 3 4
) for (
# 139 "project/radare2/libr/debug/dsession.c"
iter 
...
static 
# 144 "project/radare2/libr/debug/dsession.c" 3 4
      _Bool 
# 144 "project/radare2/libr/debug/dsession.c"
           _restore_memory_cb(void *user, const 
# 144 "project/radare2/libr/debug/dsession.c" 3 4
                                                unsigned long long 
# 144 "project/radare2/libr/debug/dsession.c"
...
# 149 "project/radare2/libr/debug/dsession.c" 3 4
do { size_t h = (
# 149 "project/radare2/libr/debug/dsession.c"
vmem
# 149 "project/radare2/libr/debug/dsession.c" 3 4
)->len, m; for (
# 149 "project/radare2/libr/debug/dsession.c"
...
# 149 "project/radare2/libr/debug/dsession.c"
((dbg->session->cnum) >= ((RDebugChangeMem *)
# 149 "project/radare2/libr/debug/dsession.c" 3 4
((char *)(
# 149 "project/radare2/libr/debug/dsession.c"
vmem
...
# 149 "project/radare2/libr/debug/dsession.c"
 ...
 return 
# 156 "project/radare2/libr/debug/dsession.c" 3 4
       1
# 156 "project/radare2/libr/debug/dsession.c"
           ;
}

static void _restore_memory(RDebug *dbg, 
# 159 "project/radare2/libr/debug/dsession.c" 3 4
                                        unsigned int 
# 159 "project/radare2/libr/debug/dsession.c"
                                             cnum) {
 _set_initial_memory (dbg);
 ht_up_foreach (dbg->session->memory, _restore_memory_cb, dbg);
}

static RDebugCheckpoint *_get_checkpoint_before(RDebugSession *session, 
# 164 "project/radare2/libr/debug/dsession.c" 3 4
                                                                       unsigned int 
# 164 "project/radare2/libr/debug/dsession.c"
                                                                            cnum) {
 RDebugCheckpoint *checkpoint = 
# 165 "project/radare2/libr/debug/dsession.c" 3 4
                               ((void *)0)
# 165 "project/radare2/libr/debug/dsession.c"
                                   ;
 size_t index;
 
# 167 "project/radare2/libr/debug/dsession.c" 3 4
do { size_t h = (
# 167 "project/radare2/libr/debug/dsession.c"
session->checkpoints
# 167 "project/radare2/libr/debug/dsession.c" 3 4
)->len, m; for (
# 167 "project/radare2/libr/debug/dsession.c"
...
# 174 "project/radare2/libr/debug/dsession.c" 3 4
__attribute__((visibility("default"))) 
# 174 "project/radare2/libr/debug/dsession.c"
     void r_debug_session_restore_reg_mem(RDebug *dbg, 
# 174 "project/radare2/libr/debug/dsession.c" 3 4
                                                       unsigned int 
# 174 "project/radare2/libr/debug/dsession.c"
                                                            cnum) {
 ...
 r_debug_reg_sync (dbg, R_REG_TYPE_ALL, 
# 180 "project/radare2/libr/debug/dsession.c" 3 4
                                       1
# 180 "project/radare2/libr/debug/dsession.c"
                                           );
...
# 186 "project/radare2/libr/debug/dsession.c" 3 4
__attribute__((visibility("default"))) 
# 186 "project/radare2/libr/debug/dsession.c"
     void r_debug_session_list_memory(RDebug *dbg) {
 RListIter *iter;
 RDebugMap *map;
 r_debug_map_sync (dbg);
 
# 190 "project/radare2/libr/debug/dsession.c" 3 4
if (
# 190 "project/radare2/libr/debug/dsession.c"
dbg->maps
# 190 "project/radare2/libr/debug/dsession.c" 3 4
) for (
# 190 "project/radare2/libr/debug/dsession.c"
...
# 190 "project/radare2/libr/debug/dsession.c"
                                      {
  if ((map->perm & 
# 191 "project/radare2/libr/debug/dsession.c" 3 4
                  (4|2)
# 191 "project/radare2/libr/debug/dsession.c"
                           ) == 
# 191 "project/radare2/libr/debug/dsession.c" 3 4
                                (4|2)
# 191 "project/radare2/libr/debug/dsession.c"
...
# 197 "project/radare2/libr/debug/dsession.c" 3 4
  unsigned char 
# 197 "project/radare2/libr/debug/dsession.c"
      *hash = r_debug_snap_get_hash (snap);
   if (!hash) {
    r_debug_snap_free (snap);
    return;
   }

   char *hexstr = r_hex_bin2strdup (hash, 
# 203 "project/radare2/libr/debug/dsession.c" 3 4
                                         32
# 203 "project/radare2/libr/debug/dsession.c"
                                                           );
   if (!hexstr) {
    free (hash);
    r_debug_snap_free (snap);
...
# 218 "project/radare2/libr/debug/dsession.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 218 "project/radare2/libr/debug/dsession.c"
          r_debug_session_add_reg_change(RDebugSession *session, int arena, 
# 218 "project/radare2/libr/debug/dsession.c" 3 4
                                                                            unsigned long long 
# 218 "project/radare2/libr/debug/dsession.c"
                                                                                 offset, 
...
# 218 "project/radare2/libr/debug/dsession.c"
                                                                                              data) {
 RVector *vreg = ht_up_find (session->registers, offset | (arena << 16), 
# 219 "project/radare2/libr/debug/dsession.c" 3 4
                                                                        ((void *)0)
# 219 "project/radare2/libr/debug/dsession.c"
                                                                            );
 if (!vreg) {
  vreg = r_vector_new (sizeof (RDebugChangeReg), 
# 221 "project/radare2/libr/debug/dsession.c" 3 4
                                                ((void *)0)
# 221 "project/radare2/libr/debug/dsession.c"
                                                    , 
# 221 "project/radare2/libr/debug/dsession.c" 3 4
                                                      ((void *)0)
# 221 "project/radare2/libr/debug/dsession.c"
...
# 223 "project/radare2/libr/debug/dsession.c" 3 4
  fprintf(__stderrp,
# 223 "project/radare2/libr/debug/dsession.c"
...
# 223 "project/radare2/libr/debug/dsession.c"
                                                  ;
   return 
# 224 "project/radare2/libr/debug/dsession.c" 3 4
         0
# 224 "project/radare2/libr/debug/dsession.c"
              ;
  }
 ...
 return 
# 230 "project/radare2/libr/debug/dsession.c" 3 4
       1
# 230 "project/radare2/libr/debug/dsession.c"
           ;
}


# 233 "project/radare2/libr/debug/dsession.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 233 "project/radare2/libr/debug/dsession.c"
          r_debug_session_add_mem_change(RDebugSession *session, 
# 233 "project/radare2/libr/debug/dsession.c" 3 4
                                                                 unsigned long long 
# 233 "project/radare2/libr/debug/dsession.c"
                                                                      addr, 
...
# 233 "project/radare2/libr/debug/dsession.c"
                                                                                data) {
 RVector *vmem = ht_up_find (session->memory, addr, 
# 234 "project/radare2/libr/debug/dsession.c" 3 4
                                                   ((void *)0)
# 234 "project/radare2/libr/debug/dsession.c"
                                                       );
 if (!vmem) {
  vmem = r_vector_new (sizeof (RDebugChangeMem), 
# 236 "project/radare2/libr/debug/dsession.c" 3 4
                                                ((void *)0)
# 236 "project/radare2/libr/debug/dsession.c"
                                                    , 
# 236 "project/radare2/libr/debug/dsession.c" 3 4
                                                      ((void *)0)
# 236 "project/radare2/libr/debug/dsession.c"
...
# 238 "project/radare2/libr/debug/dsession.c" 3 4
  fprintf(__stderrp,
# 238 "project/radare2/libr/debug/dsession.c"
...
# 238 "project/radare2/libr/debug/dsession.c"
                                                ;
   return 
# 239 "project/radare2/libr/debug/dsession.c" 3 4
         0
# 239 "project/radare2/libr/debug/dsession.c"
              ;
  }
 ...
 return 
# 245 "project/radare2/libr/debug/dsession.c" 3 4
       1
# 245 "project/radare2/libr/debug/dsession.c"
           ;
}
...
static 
# 251 "project/radare2/libr/debug/dsession.c" 3 4
      _Bool 
# 251 "project/radare2/libr/debug/dsession.c"
           serialize_register_cb(void *db, const 
# 251 "project/radare2/libr/debug/dsession.c" 3 4
                                                 unsigned long long 
# 251 "project/radare2/libr/debug/dsession.c"
                                                      k, const void *v) {
 ...
 if (!j) {
  return 
# 256 "project/radare2/libr/debug/dsession.c" 3 4
        0
# 256 "project/radare2/libr/debug/dsession.c"
             ;
 }
 pj_a (j);

 
# 260 "project/radare2/libr/debug/dsession.c" 3 4
if (!r_vector_empty (
# 260 "project/radare2/libr/debug/dsession.c"
vreg
# 260 "project/radare2/libr/debug/dsession.c" 3 4
)) for (
# 260 "project/radare2/libr/debug/dsession.c"
...
# 260 "project/radare2/libr/debug/dsession.c"
 ...
 pj_end (j);
 sdb_set (db, sdb_fmt ("0x%"
# 268 "project/radare2/libr/debug/dsession.c" 3 4
                           "llx"
# 268 "project/radare2/libr/debug/dsession.c"
                                  , k), pj_string (j), 0);
 pj_free (j);
 return 
# 270 "project/radare2/libr/debug/dsession.c" 3 4
       1
# 270 "project/radare2/libr/debug/dsession.c"
           ;
}
...
static 
# 278 "project/radare2/libr/debug/dsession.c" 3 4
      _Bool 
# 278 "project/radare2/libr/debug/dsession.c"
           serialize_memory_cb(void *db, const 
# 278 "project/radare2/libr/debug/dsession.c" 3 4
                                               unsigned long long 
# 278 "project/radare2/libr/debug/dsession.c"
                                                    k, const void *v) {
 ...
 if (!j) {
  return 
# 283 "project/radare2/libr/debug/dsession.c" 3 4
        0
# 283 "project/radare2/libr/debug/dsession.c"
             ;
 }
 pj_a (j);

 
# 287 "project/radare2/libr/debug/dsession.c" 3 4
if (!r_vector_empty (
# 287 "project/radare2/libr/debug/dsession.c"
vmem
# 287 "project/radare2/libr/debug/dsession.c" 3 4
)) for (
# 287 "project/radare2/libr/debug/dsession.c"
...
# 287 "project/radare2/libr/debug/dsession.c"
 ...
 pj_end (j);
 sdb_set (db, sdb_fmt ("0x%"
# 295 "project/radare2/libr/debug/dsession.c" 3 4
                           "llx"
# 295 "project/radare2/libr/debug/dsession.c"
                                  , k), pj_string (j), 0);
 pj_free (j);
 return 
# 297 "project/radare2/libr/debug/dsession.c" 3 4
       1
# 297 "project/radare2/libr/debug/dsession.c"
           ;
}
...
# 310 "project/radare2/libr/debug/dsession.c" 3 4
if (!r_vector_empty (
# 310 "project/radare2/libr/debug/dsession.c"
checkpoints
# 310 "project/radare2/libr/debug/dsession.c" 3 4
)) for (
# 310 "project/radare2/libr/debug/dsession.c"
...
# 342 "project/radare2/libr/debug/dsession.c" 3 4
 if (
# 342 "project/radare2/libr/debug/dsession.c"
 chkpt->snaps
# 342 "project/radare2/libr/debug/dsession.c" 3 4
 ) for (
# 342 "project/radare2/libr/debug/dsession.c"
...
# 402 "project/radare2/libr/debug/dsession.c"

# 402 "project/radare2/libr/debug/dsession.c" 3 4
__attribute__((visibility("default"))) 
# 402 "project/radare2/libr/debug/dsession.c"
     void r_debug_session_serialize(RDebugSession *session, Sdb *db) {
 sdb_num_set (db, "maxcnum", session->maxcnum, 0);
 serialize_registers (sdb_ns (db, "registers", 
# 404 "project/radare2/libr/debug/dsession.c" 3 4
                                              1
# 404 "project/radare2/libr/debug/dsession.c"
                                                  ), session->registers);
 serialize_memory (sdb_ns (db, "memory", 
# 405 "project/radare2/libr/debug/dsession.c" 3 4
                                        1
# 405 "project/radare2/libr/debug/dsession.c"
                                            ), session->memory);
 serialize_checkpoints (sdb_ns (db, "checkpoints", 
# 406 "project/radare2/libr/debug/dsession.c" 3 4
                                                  1
# 406 "project/radare2/libr/debug/dsession.c"
                                                      ), session->checkpoints);
}

static 
# 409 "project/radare2/libr/debug/dsession.c" 3 4
      _Bool 
# 409 "project/radare2/libr/debug/dsession.c"
           session_sdb_save(Sdb *db, const char *path) {
 char *filename;
 if (!r_file_is_directory (path)) {
  
# 412 "project/radare2/libr/debug/dsession.c" 3 4
 fprintf(__stderrp,
# 412 "project/radare2/libr/debug/dsession.c"
...
# 412 "project/radare2/libr/debug/dsession.c"
                                                 ;
  return 
# 413 "project/radare2/libr/debug/dsession.c" 3 4
        0
# 413 "project/radare2/libr/debug/dsession.c"
             ;
 }

 filename = r_str_newf ("%s%ssession.sdb", path, 
# 416 "project/radare2/libr/debug/dsession.c" 3 4
                                                "/"
# 416 "project/radare2/libr/debug/dsession.c"
                                                         );
 sdb_file (db, filename);
 if (!sdb_sync (db)) {
  
# 419 "project/radare2/libr/debug/dsession.c" 3 4
 fprintf(__stderrp,
# 419 "project/radare2/libr/debug/dsession.c"
 "Failed to sync session to %s\n", filename
# 419 "project/radare2/libr/debug/dsession.c" 3 4
 )
# 419 "project/radare2/libr/debug/dsession.c"
                                                     ;
  ...
  sdb_close (db);
  return 
# 422 "project/radare2/libr/debug/dsession.c" 3 4
        0
# 422 "project/radare2/libr/debug/dsession.c"
             ;
 }
 free (filename);
 sdb_close (db);
...
# 429 "project/radare2/libr/debug/dsession.c" 3 4
if ((
# 429 "project/radare2/libr/debug/dsession.c"
db->ns
# 429 "project/radare2/libr/debug/dsession.c" 3 4
)) for (
# 429 "project/radare2/libr/debug/dsession.c"
...
# 429 "project/radare2/libr/debug/dsession.c"
                            {
  char *filename = r_str_newf ("%s%s%s.sdb", path, 
# 430 "project/radare2/libr/debug/dsession.c" 3 4
                                                  "/"
# 430 "project/radare2/libr/debug/dsession.c"
                                                           , ns->name);
  sdb_file (ns->sdb, filename);
  if (!sdb_sync (ns->sdb)) {
   
# 433 "project/radare2/libr/debug/dsession.c" 3 4
  fprintf(__stderrp,
# 433 "project/radare2/libr/debug/dsession.c"
...
# 433 "project/radare2/libr/debug/dsession.c"
   ...
   sdb_close (ns->sdb);
   return 
# 436 "project/radare2/libr/debug/dsession.c" 3 4
         0
# 436 "project/radare2/libr/debug/dsession.c"
              ;
  }
  free (filename);
  sdb_close (ns->sdb);
 ...
 return 
# 442 "project/radare2/libr/debug/dsession.c" 3 4
       1
# 442 "project/radare2/libr/debug/dsession.c"
           ;
}


# 445 "project/radare2/libr/debug/dsession.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 445 "project/radare2/libr/debug/dsession.c"
          r_debug_session_save(RDebugSession *session, const char *path) {
 Sdb *db = sdb_new0 ();
 if (!db) {
  return 
# 448 "project/radare2/libr/debug/dsession.c" 3 4
        0
# 448 "project/radare2/libr/debug/dsession.c"
             ;
 }
 ...
 if (!session_sdb_save (db, path)) {
  sdb_free (db);
  return 
# 454 "project/radare2/libr/debug/dsession.c" 3 4
        0
# 454 "project/radare2/libr/debug/dsession.c"
             ;
 }
 sdb_free (db);
 return 
# 457 "project/radare2/libr/debug/dsession.c" 3 4
       1
# 457 "project/radare2/libr/debug/dsession.c"
           ;
}


#define CHECK_TYPE(v,t) if (!v || v->type != t) continue



static 
# 465 "project/radare2/libr/debug/dsession.c" 3 4
      _Bool 
# 465 "project/radare2/libr/debug/dsession.c"
           deserialize_memory_cb(void *user, const char *addr, const char *v) {
 RJson *child;
 char *json_str = strdup (v);
 if (!json_str) {
  return 
# 469 "project/radare2/libr/debug/dsession.c" 3 4
        1
# 469 "project/radare2/libr/debug/dsession.c"
            ;
 }
 ...
 if (!reg_json || reg_json->type != R_JSON_ARRAY) {
  free (json_str);
  return 
# 474 "project/radare2/libr/debug/dsession.c" 3 4
        1
# 474 "project/radare2/libr/debug/dsession.c"
            ;
 }

 HtUP *memory = user;

 RVector *vmem = r_vector_new (sizeof (RDebugChangeMem), 
# 479 "project/radare2/libr/debug/dsession.c" 3 4
                                                        ((void *)0)
# 479 "project/radare2/libr/debug/dsession.c"
                                                            , 
# 479 "project/radare2/libr/debug/dsession.c" 3 4
                                                              ((void *)0)
# 479 "project/radare2/libr/debug/dsession.c"
...
# 481 "project/radare2/libr/debug/dsession.c" 3 4
 fprintf(__stderrp,
# 481 "project/radare2/libr/debug/dsession.c"
 "Error: failed to allocate RVector vmem.\n"
# 481 "project/radare2/libr/debug/dsession.c" 3 4
 )
# 481 "project/radare2/libr/debug/dsession.c"
                                                      ;
  ...
  return 
# 484 "project/radare2/libr/debug/dsession.c" 3 4
        0
# 484 "project/radare2/libr/debug/dsession.c"
             ;
 }
 ...
 for (child = reg_json->children.first; child; child = child->next) {
  ...
  if (!baby || baby->type != R_JSON_INTEGER) continue;
  int cnum = baby->num.s_value;

  baby = r_json_get (child, "data");
  if (!baby || baby->type != R_JSON_INTEGER) continue;
  
# 499 "project/radare2/libr/debug/dsession.c" 3 4
 unsigned long long 
# 499 "project/radare2/libr/debug/dsession.c"
      data = baby->num.u_value;
 ...
 r_json_free (reg_json);
 return 
# 507 "project/radare2/libr/debug/dsession.c" 3 4
       1
# 507 "project/radare2/libr/debug/dsession.c"
           ;
}
...
static 
# 514 "project/radare2/libr/debug/dsession.c" 3 4
      _Bool 
# 514 "project/radare2/libr/debug/dsession.c"
           deserialize_registers_cb(void *user, const char *addr, const char *v) {
 RJson *child;
 char *json_str = strdup (v);
 if (!json_str) {
  return 
# 518 "project/radare2/libr/debug/dsession.c" 3 4
        1
# 518 "project/radare2/libr/debug/dsession.c"
            ;
 }
 RJson *reg_json = r_json_parse (json_str);
 if (!reg_json || reg_json->type != R_JSON_ARRAY) {
  free (json_str);
  return 
# 523 "project/radare2/libr/debug/dsession.c" 3 4
        1
# 523 "project/radare2/libr/debug/dsession.c"
            ;
 }


 HtUP *registers = user;
 RVector *vreg = r_vector_new (sizeof (RDebugChangeReg), 
# 528 "project/radare2/libr/debug/dsession.c" 3 4
                                                        ((void *)0)
# 528 "project/radare2/libr/debug/dsession.c"
                                                            , 
# 528 "project/radare2/libr/debug/dsession.c" 3 4
                                                              ((void *)0)
# 528 "project/radare2/libr/debug/dsession.c"
...
# 530 "project/radare2/libr/debug/dsession.c" 3 4
 fprintf(__stderrp,
# 530 "project/radare2/libr/debug/dsession.c"
 "Error: failed to allocate RVector vreg.\n"
# 530 "project/radare2/libr/debug/dsession.c" 3 4
 )
# 530 "project/radare2/libr/debug/dsession.c"
                                                      ;
  ...
  free (json_str);
  return 
# 533 "project/radare2/libr/debug/dsession.c" 3 4
        1
# 533 "project/radare2/libr/debug/dsession.c"
            ;
 }
...
# 548 "project/radare2/libr/debug/dsession.c" 3 4
 unsigned long long 
# 548 "project/radare2/libr/debug/dsession.c"
      data = baby->num.u_value;
 ...
 free (json_str);
 return 
# 556 "project/radare2/libr/debug/dsession.c" 3 4
       1
# 556 "project/radare2/libr/debug/dsession.c"
           ;
}
...
static 
# 566 "project/radare2/libr/debug/dsession.c" 3 4
      _Bool 
# 566 "project/radare2/libr/debug/dsession.c"
           deserialize_checkpoints_cb(void *user, const char *cnum, const char *v) {
 const RJson *child;
 char *json_str = strdup (v);
 if (!json_str) {
  return 
# 570 "project/radare2/libr/debug/dsession.c" 3 4
        1
# 570 "project/radare2/libr/debug/dsession.c"
            ;
 }
 ...
 if (!chkpt_json || chkpt_json->type != R_JSON_OBJECT) {
  free (json_str);
  return 
# 575 "project/radare2/libr/debug/dsession.c" 3 4
        1
# 575 "project/radare2/libr/debug/dsession.c"
            ;
 }
 ...
 if (!regs_json || regs_json->type != R_JSON_ARRAY) {
  free (json_str);
  return 
# 586 "project/radare2/libr/debug/dsession.c" 3 4
        1
# 586 "project/radare2/libr/debug/dsession.c"
            ;
 }
 for (child = regs_json->children.first; child; child = child->next) {
  ...
  if (!baby || baby->type != R_JSON_STRING) continue;
  
# 604 "project/radare2/libr/debug/dsession.c" 3 4
 unsigned char 
# 604 "project/radare2/libr/debug/dsession.c"
     *bytes = sdb_decode (baby->str_value, 
# 604 "project/radare2/libr/debug/dsession.c" 3 4
                                           ((void *)0)
# 604 "project/radare2/libr/debug/dsession.c"
                                               );
...
# 611 "project/radare2/libr/debug/dsession.c" 3 4
 __builtin___memcpy_chk (
# 611 "project/radare2/libr/debug/dsession.c"
 a->bytes
# 611 "project/radare2/libr/debug/dsession.c" 3 4
 , 
# 611 "project/radare2/libr/debug/dsession.c"
...
# 611 "project/radare2/libr/debug/dsession.c"
 ...
 for (child = snaps_json->children.first; child; child = child->next) {
  ...
  if (!namej || namej->type != R_JSON_STRING) continue;
  const RJson *dataj = r_json_get (child, "data");
  if (!dataj || dataj->type != R_JSON_STRING) continue;
  const RJson *sizej = r_json_get (child, "size");
  if (!sizej || sizej->type != R_JSON_INTEGER) continue;
  const RJson *addrj = r_json_get (child, "addr");
  if (!addrj || addrj->type != R_JSON_INTEGER) continue;
  const RJson *addr_endj = r_json_get (child, "addr_end");
  if (!addr_endj || addr_endj->type != R_JSON_INTEGER) continue;
  const RJson *permj = r_json_get (child, "perm");
  if (!permj || permj->type != R_JSON_INTEGER) continue;
  const RJson *userj = r_json_get (child, "user");
  if (!userj || userj->type != R_JSON_INTEGER) continue;
  const RJson *sharedj = r_json_get (child, "shared");
  if (!sharedj || sharedj->type != R_JSON_BOOLEAN) continue;

  RDebugSnap *snap = 
# 640 "project/radare2/libr/debug/dsession.c" 3 4
                    (
# 640 "project/radare2/libr/debug/dsession.c"
                    RDebugSnap
# 640 "project/radare2/libr/debug/dsession.c" 3 4
                    *)calloc(1,sizeof(
# 640 "project/radare2/libr/debug/dsession.c"
...
# 642 "project/radare2/libr/debug/dsession.c" 3 4
  fprintf(__stderrp,
# 642 "project/radare2/libr/debug/dsession.c"
  "Error: failed to allocate RDebugSnap snap"
# 642 "project/radare2/libr/debug/dsession.c" 3 4
  )
# 642 "project/radare2/libr/debug/dsession.c"
                                                       ;
  ...
  snap->data = sdb_decode (dataj->str_value, 
# 649 "project/radare2/libr/debug/dsession.c" 3 4
                                            ((void *)0)
# 649 "project/radare2/libr/debug/dsession.c"
                                                );
 ...
 return 
# 660 "project/radare2/libr/debug/dsession.c" 3 4
       1
# 660 "project/radare2/libr/debug/dsession.c"
           ;
}
...
static 
# 667 "project/radare2/libr/debug/dsession.c" 3 4
      _Bool 
# 667 "project/radare2/libr/debug/dsession.c"
           session_sdb_load_ns(Sdb *db, const char *nspath, const char *filename) {
 Sdb *tmpdb = sdb_new0 ();
 if (sdb_open (tmpdb, filename) == -1) {
  
# 670 "project/radare2/libr/debug/dsession.c" 3 4
 fprintf(__stderrp,
# 670 "project/radare2/libr/debug/dsession.c"
 "Error: failed to load %s into sdb\n", filename
# 670 "project/radare2/libr/debug/dsession.c" 3 4
 )
# 670 "project/radare2/libr/debug/dsession.c"
                                                          ;
  sdb_free (tmpdb);
  return 
# 672 "project/radare2/libr/debug/dsession.c" 3 4
        0
# 672 "project/radare2/libr/debug/dsession.c"
             ;
 }
 Sdb *ns = sdb_ns_path (db, nspath, 
# 674 "project/radare2/libr/debug/dsession.c" 3 4
                                   1
# 674 "project/radare2/libr/debug/dsession.c"
                                       );
 sdb_copy (tmpdb, ns);
 sdb_free (tmpdb);
 return 
# 677 "project/radare2/libr/debug/dsession.c" 3 4
       1
# 677 "project/radare2/libr/debug/dsession.c"
           ;
}
...
static Sdb *session_sdb_load(const char *path) {
 ...
 if (!db) {
  return 
# 684 "project/radare2/libr/debug/dsession.c" 3 4
        ((void *)0)
# 684 "project/radare2/libr/debug/dsession.c"
            ;
 }

#define SDB_LOAD(fn,ns) do { filename = r_str_newf ("%s%s" fn ".sdb", path, R_SYS_DIR); if (!session_sdb_load_ns (db, ns, filename)) { free (filename); goto error; } free (filename); } while (0)
# 696 "project/radare2/libr/debug/dsession.c"
 do { filename = r_str_newf ("%s%s" "session" ".sdb", path, 
# 696 "project/radare2/libr/debug/dsession.c" 3 4
"/"
# 696 "project/radare2/libr/debug/dsession.c"
); if (!session_sdb_load_ns (db, "", filename)) { free (filename); goto error; } free (filename); } while (0);
 do { filename = r_str_newf ("%s%s" "registers" ".sdb", path, 
# 697 "project/radare2/libr/debug/dsession.c" 3 4
"/"
# 697 "project/radare2/libr/debug/dsession.c"
); if (!session_sdb_load_ns (db, "registers", filename)) { free (filename); goto error; } free (filename); } while (0);
 do { filename = r_str_newf ("%s%s" "memory" ".sdb", path, 
# 698 "project/radare2/libr/debug/dsession.c" 3 4
"/"
# 698 "project/radare2/libr/debug/dsession.c"
); if (!session_sdb_load_ns (db, "memory", filename)) { free (filename); goto error; } free (filename); } while (0);
 do { filename = r_str_newf ("%s%s" "checkpoints" ".sdb", path, 
# 699 "project/radare2/libr/debug/dsession.c" 3 4
"/"
# 699 "project/radare2/libr/debug/dsession.c"
); if (!session_sdb_load_ns (db, "checkpoints", filename)) { free (filename); goto error; } free (filename); } while (0);
 return db;
error:
 sdb_free (db);
 return 
# 703 "project/radare2/libr/debug/dsession.c" 3 4
       ((void *)0)
# 703 "project/radare2/libr/debug/dsession.c"
           ;
}


# 706 "project/radare2/libr/debug/dsession.c" 3 4
__attribute__((visibility("default"))) 
# 706 "project/radare2/libr/debug/dsession.c"
     void r_debug_session_deserialize(RDebugSession *session, Sdb *db) {
 Sdb *subdb;

 session->maxcnum = sdb_num_get (db, "maxcnum", 0);

#define DESERIALIZE(ns,func) do { subdb = sdb_ns (db, ns, false); if (!subdb) { eprintf ("Error: missing " ns " namespace\n"); return; } func; } while (0)
# 720 "project/radare2/libr/debug/dsession.c"
 do { subdb = sdb_ns (db, "memory", 
# 720 "project/radare2/libr/debug/dsession.c" 3 4
0
# 720 "project/radare2/libr/debug/dsession.c"
); if (!subdb) { 
# 720 "project/radare2/libr/debug/dsession.c" 3 4
fprintf(__stderrp,
# 720 "project/radare2/libr/debug/dsession.c"
"Error: missing " "memory" " namespace\n"
# 720 "project/radare2/libr/debug/dsession.c" 3 4
)
# 720 "project/radare2/libr/debug/dsession.c"
; return; } deserialize_memory (subdb, session->memory); } while (0);
 do { subdb = sdb_ns (db, "registers", 
# 721 "project/radare2/libr/debug/dsession.c" 3 4
0
# 721 "project/radare2/libr/debug/dsession.c"
); if (!subdb) { 
# 721 "project/radare2/libr/debug/dsession.c" 3 4
fprintf(__stderrp,
# 721 "project/radare2/libr/debug/dsession.c"
"Error: missing " "registers" " namespace\n"
# 721 "project/radare2/libr/debug/dsession.c" 3 4
)
# 721 "project/radare2/libr/debug/dsession.c"
; return; } deserialize_registers (subdb, session->registers); } while (0);
 do { subdb = sdb_ns (db, "checkpoints", 
# 722 "project/radare2/libr/debug/dsession.c" 3 4
0
# 722 "project/radare2/libr/debug/dsession.c"
); if (!subdb) { 
# 722 "project/radare2/libr/debug/dsession.c" 3 4
fprintf(__stderrp,
# 722 "project/radare2/libr/debug/dsession.c"
"Error: missing " "checkpoints" " namespace\n"
# 722 "project/radare2/libr/debug/dsession.c" 3 4
)
# 722 "project/radare2/libr/debug/dsession.c"
; return; } deserialize_checkpoints (subdb, session->checkpoints); } while (0);
}


# 725 "project/radare2/libr/debug/dsession.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 725 "project/radare2/libr/debug/dsession.c"
          r_debug_session_load(RDebug *dbg, const char *path) {
 Sdb *db = session_sdb_load (path);
 if (!db) {
  return 
# 728 "project/radare2/libr/debug/dsession.c" 3 4
        0
# 728 "project/radare2/libr/debug/dsession.c"
             ;
 }
 ...
 sdb_free (db);
 return 
# 734 "project/radare2/libr/debug/dsession.c" 3 4
       1
# 734 "project/radare2/libr/debug/dsession.c"
           ;
}
