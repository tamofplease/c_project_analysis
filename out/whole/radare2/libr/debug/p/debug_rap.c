# 0 "project/radare2/libr/debug/p/debug_rap.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/debug/p/debug_rap.c"
...
# 4 "project/radare2/libr/debug/p/debug_rap.c" 2
...
# 6 "project/radare2/libr/debug/p/debug_rap.c" 2


# 7 "project/radare2/libr/debug/p/debug_rap.c"
static 
# 7 "project/radare2/libr/debug/p/debug_rap.c" 3 4
      _Bool 
# 7 "project/radare2/libr/debug/p/debug_rap.c"
           __rap_step(RDebug *dbg) {
 r_io_system (dbg->iob.io, "ds");
 return 
# 9 "project/radare2/libr/debug/p/debug_rap.c" 3 4
       1
# 9 "project/radare2/libr/debug/p/debug_rap.c"
           ;
}

static int __rap_reg_read(RDebug *dbg, int type, 
# 12 "project/radare2/libr/debug/p/debug_rap.c" 3 4
                                                unsigned char 
# 12 "project/radare2/libr/debug/p/debug_rap.c"
                                                    *buf, int size) {
 r_io_system (dbg->iob.io, "dr");
 return 0;
}

static int __rap_reg_write(RDebug *dbg, int type, const 
# 17 "project/radare2/libr/debug/p/debug_rap.c" 3 4
                                                       unsigned char 
# 17 "project/radare2/libr/debug/p/debug_rap.c"
                                                           *buf, int size) {
 return 
# 18 "project/radare2/libr/debug/p/debug_rap.c" 3 4
       0
# 18 "project/radare2/libr/debug/p/debug_rap.c"
            ;
}

static 
# 21 "project/radare2/libr/debug/p/debug_rap.c" 3 4
      _Bool 
# 21 "project/radare2/libr/debug/p/debug_rap.c"
           __rap_continue(RDebug *dbg, int pid, int tid, int sig) {
 r_io_system (dbg->iob.io, "dc");
 return 
# 23 "project/radare2/libr/debug/p/debug_rap.c" 3 4
       1
# 23 "project/radare2/libr/debug/p/debug_rap.c"
           ;
}
...
static RDebugReasonType __rap_wait(RDebug *dbg, int pid) {
 ...
 return 
# 28 "project/radare2/libr/debug/p/debug_rap.c" 3 4
       1
# 28 "project/radare2/libr/debug/p/debug_rap.c"
           ;
}

static 
# 31 "project/radare2/libr/debug/p/debug_rap.c" 3 4
      _Bool 
# 31 "project/radare2/libr/debug/p/debug_rap.c"
           __rap_attach(RDebug *dbg, int pid) {

 RIODesc *d = dbg->iob.io->desc;
 if (d && d->plugin && d->plugin->name) {
  if (!strcmp ("rap", d->plugin->name)) {
   
# 36 "project/radare2/libr/debug/p/debug_rap.c" 3 4
  fprintf(__stderrp,
# 36 "project/radare2/libr/debug/p/debug_rap.c"
  "SUCCESS: rap attach with inferior rap rio worked\n"
# 36 "project/radare2/libr/debug/p/debug_rap.c" 3 4
  )
# 36 "project/radare2/libr/debug/p/debug_rap.c"
                                                                ;
...
# 38 "project/radare2/libr/debug/p/debug_rap.c" 3 4
  fprintf(__stderrp,
# 38 "project/radare2/libr/debug/p/debug_rap.c"
  "ERROR: Underlying IO descriptor is not a rap one..\n"
# 38 "project/radare2/libr/debug/p/debug_rap.c" 3 4
  )
# 38 "project/radare2/libr/debug/p/debug_rap.c"
                                                                  ;
 ...
 return 
# 41 "project/radare2/libr/debug/p/debug_rap.c" 3 4
       1
# 41 "project/radare2/libr/debug/p/debug_rap.c"
           ;
}

static 
# 44 "project/radare2/libr/debug/p/debug_rap.c" 3 4
      _Bool 
# 44 "project/radare2/libr/debug/p/debug_rap.c"
           __rap_detach(RDebug *dbg, int pid) {



 return 
# 48 "project/radare2/libr/debug/p/debug_rap.c" 3 4
       1
# 48 "project/radare2/libr/debug/p/debug_rap.c"
           ;
}
...
static char *__rap_reg_profile(RDebug *dbg) {
 ...
 out = r_file_slurp (tf, 
# 57 "project/radare2/libr/debug/p/debug_rap.c" 3 4
                        ((void *)0)
# 57 "project/radare2/libr/debug/p/debug_rap.c"
                            );
 r_file_rm (tf);
 free (tf);
 return out;
...
static int __rap_breakpoint (RBreakpoint *bp, RBreakpointItem *b, 
# 63 "project/radare2/libr/debug/p/debug_rap.c" 3 4
                                                                 _Bool 
# 63 "project/radare2/libr/debug/p/debug_rap.c"
                                                                      set) {

 return 
# 65 "project/radare2/libr/debug/p/debug_rap.c" 3 4
       0
# 65 "project/radare2/libr/debug/p/debug_rap.c"
            ;
}
...
RDebugPlugin r_debug_plugin_rap = {
 ...
 .arch = "any",
 .bits = 
# 72 "project/radare2/libr/debug/p/debug_rap.c" 3 4
        4
# 72 "project/radare2/libr/debug/p/debug_rap.c"
                     ,
 .step = __rap_step,
 .cont = __rap_continue,
 .attach = &__rap_attach,
...
# 87 "project/radare2/libr/debug/p/debug_rap.c" 3 4
__attribute__((visibility("default"))) 
# 87 "project/radare2/libr/debug/p/debug_rap.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_DBG,
 .data = &r_debug_plugin_rap,
 .version = 
# 90 "project/radare2/libr/debug/p/debug_rap.c" 3 4
           "5.5.4"

# 91 "project/radare2/libr/debug/p/debug_rap.c"
};
