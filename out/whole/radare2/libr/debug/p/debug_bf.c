# 0 "project/radare2/libr/debug/p/debug_bf.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/debug/p/debug_bf.c"
...
# 4 "project/radare2/libr/debug/p/debug_bf.c" 2
...
# 5 "project/radare2/libr/debug/p/debug_bf.c" 2
#undef R_API
#define R_API static inline
# 1 "project/radare2/libr/debug/p/bfvm.c" 1





# 1 "project/radare2/libr/debug/p/bfvm.h" 1
...
# 16 "project/radare2/libr/debug/p/bfvm.h"
typedef struct bfvm_cpu_t {
 
# 17 "project/radare2/libr/debug/p/bfvm.h" 3 4
unsigned long long 
# 17 "project/radare2/libr/debug/p/bfvm.h"
     eip;
 
# 18 "project/radare2/libr/debug/p/bfvm.h" 3 4
unsigned long long 
# 18 "project/radare2/libr/debug/p/bfvm.h"
     esp;
 int ptr;
 int trace;
 int breaked;
 
# 22 "project/radare2/libr/debug/p/bfvm.h" 3 4
unsigned long long 
# 22 "project/radare2/libr/debug/p/bfvm.h"
     base;
 
# 23 "project/radare2/libr/debug/p/bfvm.h" 3 4
unsigned char 
# 23 "project/radare2/libr/debug/p/bfvm.h"
    *mem;
 
# 24 "project/radare2/libr/debug/p/bfvm.h" 3 4
unsigned int 
# 24 "project/radare2/libr/debug/p/bfvm.h"
     size;
 
# 25 "project/radare2/libr/debug/p/bfvm.h" 3 4
unsigned long long 
# 25 "project/radare2/libr/debug/p/bfvm.h"
     screen;
 int screen_idx;
 int screen_size;
 
# 28 "project/radare2/libr/debug/p/bfvm.h" 3 4
unsigned char 
# 28 "project/radare2/libr/debug/p/bfvm.h"
    *screen_buf;
 
# 29 "project/radare2/libr/debug/p/bfvm.h" 3 4
unsigned long long 
# 29 "project/radare2/libr/debug/p/bfvm.h"
     input;
 int input_idx;
 int input_size;
 
# 32 "project/radare2/libr/debug/p/bfvm.h" 3 4
unsigned char 
# 32 "project/radare2/libr/debug/p/bfvm.h"
    *input_buf;
 int circular;
 RIOBind iob;
} BfvmCPU;
...
static inline BfvmCPU *bfvm_new(RIOBind *iob);
static inline BfvmCPU *bfvm_free(BfvmCPU *c);
static inline int bfvm_step(BfvmCPU *c, int over);
# 7 "project/radare2/libr/debug/p/bfvm.c" 2

static 
# 8 "project/radare2/libr/debug/p/bfvm.c" 3 4
      unsigned char 
# 8 "project/radare2/libr/debug/p/bfvm.c"
          bfvm_op(BfvmCPU *c) {

 
# 10 "project/radare2/libr/debug/p/bfvm.c" 3 4
unsigned char 
# 10 "project/radare2/libr/debug/p/bfvm.c"
    buf[4] = {0};
...
static inline int bfvm_in_trap(BfvmCPU *c) {
 switch (bfvm_op (c)) {
 case 0x00:
 case 0xcc:
 case 0xff:
...
static inline void bfvm_reset(BfvmCPU *c) {
 
# 28 "project/radare2/libr/debug/p/bfvm.c" 3 4
__builtin___memset_chk (
# 28 "project/radare2/libr/debug/p/bfvm.c"
c->mem
# 28 "project/radare2/libr/debug/p/bfvm.c" 3 4
, 
# 28 "project/radare2/libr/debug/p/bfvm.c"
...
# 29 "project/radare2/libr/debug/p/bfvm.c" 3 4
__builtin___memset_chk (
# 29 "project/radare2/libr/debug/p/bfvm.c"
c->input_buf
# 29 "project/radare2/libr/debug/p/bfvm.c" 3 4
, 
# 29 "project/radare2/libr/debug/p/bfvm.c"
...
# 30 "project/radare2/libr/debug/p/bfvm.c" 3 4
__builtin___memset_chk (
# 30 "project/radare2/libr/debug/p/bfvm.c"
c->screen_buf
# 30 "project/radare2/libr/debug/p/bfvm.c" 3 4
, 
# 30 "project/radare2/libr/debug/p/bfvm.c"
...
static inline int bfvm_init(BfvmCPU *c, 
# 41 "project/radare2/libr/debug/p/bfvm.c" 3 4
                               unsigned int 
# 41 "project/radare2/libr/debug/p/bfvm.c"
                                    size, int circular) {
 
# 42 "project/radare2/libr/debug/p/bfvm.c" 3 4
__builtin___memset_chk (
# 42 "project/radare2/libr/debug/p/bfvm.c"
c
# 42 "project/radare2/libr/debug/p/bfvm.c" 3 4
, 
# 42 "project/radare2/libr/debug/p/bfvm.c"
...
# 42 "project/radare2/libr/debug/p/bfvm.c"
 ...
 c->mem = (
# 45 "project/radare2/libr/debug/p/bfvm.c" 3 4
          unsigned char 
# 45 "project/radare2/libr/debug/p/bfvm.c"
              *)malloc (size);
 if (!c->mem) {
  return 0;
 }
 
# 49 "project/radare2/libr/debug/p/bfvm.c" 3 4
__builtin___memset_chk (
# 49 "project/radare2/libr/debug/p/bfvm.c"
c->mem
# 49 "project/radare2/libr/debug/p/bfvm.c" 3 4
, 
# 49 "project/radare2/libr/debug/p/bfvm.c"
...
# 49 "project/radare2/libr/debug/p/bfvm.c"
 ...
 c->screen_size = 4096;
 c->screen_buf = (
# 59 "project/radare2/libr/debug/p/bfvm.c" 3 4
                 unsigned char
# 59 "project/radare2/libr/debug/p/bfvm.c"
                    *)malloc (c->screen_size);
 
# 60 "project/radare2/libr/debug/p/bfvm.c" 3 4
__builtin___memset_chk (
# 60 "project/radare2/libr/debug/p/bfvm.c"
c->screen_buf
# 60 "project/radare2/libr/debug/p/bfvm.c" 3 4
, 
# 60 "project/radare2/libr/debug/p/bfvm.c"
...
# 60 "project/radare2/libr/debug/p/bfvm.c"
 ...
 c->input_size = 4096;
 c->input_buf = (
# 64 "project/radare2/libr/debug/p/bfvm.c" 3 4
                unsigned char
# 64 "project/radare2/libr/debug/p/bfvm.c"
                   *)malloc (c->input_size);
 bfvm_reset (c);
 return 1;
}
...
static inline BfvmCPU *bfvm_new(RIOBind *iob) {
 BfvmCPU *c = 
# 70 "project/radare2/libr/debug/p/bfvm.c" 3 4
             (
# 70 "project/radare2/libr/debug/p/bfvm.c"
             BfvmCPU
# 70 "project/radare2/libr/debug/p/bfvm.c" 3 4
             *)calloc(1,sizeof(
# 70 "project/radare2/libr/debug/p/bfvm.c"
...
# 72 "project/radare2/libr/debug/p/bfvm.c" 3 4
__builtin___memcpy_chk (
# 72 "project/radare2/libr/debug/p/bfvm.c"
&c->iob
# 72 "project/radare2/libr/debug/p/bfvm.c" 3 4
, 
# 72 "project/radare2/libr/debug/p/bfvm.c"
...
static inline BfvmCPU *bfvm_free(BfvmCPU *c) {
 ...
 free (c);
 return 
# 82 "project/radare2/libr/debug/p/bfvm.c" 3 4
       ((void *)0)
# 82 "project/radare2/libr/debug/p/bfvm.c"
           ;
}

static inline 
# 85 "project/radare2/libr/debug/p/bfvm.c" 3 4
     unsigned char 
# 85 "project/radare2/libr/debug/p/bfvm.c"
         *bfvm_get_ptr_at(BfvmCPU *c, 
# 85 "project/radare2/libr/debug/p/bfvm.c" 3 4
                                      unsigned long long 
# 85 "project/radare2/libr/debug/p/bfvm.c"
                                           at) {
...
static inline 
# 94 "project/radare2/libr/debug/p/bfvm.c" 3 4
     unsigned char 
# 94 "project/radare2/libr/debug/p/bfvm.c"
         *bfvm_get_ptr(BfvmCPU *c) {

 return bfvm_get_ptr_at (c, c->ptr);
}

static inline 
# 99 "project/radare2/libr/debug/p/bfvm.c" 3 4
     unsigned char 
# 99 "project/radare2/libr/debug/p/bfvm.c"
         bfvm_get(BfvmCPU *c) {
 
# 100 "project/radare2/libr/debug/p/bfvm.c" 3 4
unsigned char 
# 100 "project/radare2/libr/debug/p/bfvm.c"
    *ptr = bfvm_get_ptr (c);
 return ptr? *ptr: 0;
}

static inline void bfvm_inc(BfvmCPU *c) {
 
# 105 "project/radare2/libr/debug/p/bfvm.c" 3 4
unsigned char 
# 105 "project/radare2/libr/debug/p/bfvm.c"
    *mem = bfvm_get_ptr (c);
 if (mem != 
# 106 "project/radare2/libr/debug/p/bfvm.c" 3 4
           ((void *)0)
# 106 "project/radare2/libr/debug/p/bfvm.c"
               ) {
  mem[0]++;
 }
}

static inline void bfvm_dec(BfvmCPU *c) {
 
# 112 "project/radare2/libr/debug/p/bfvm.c" 3 4
unsigned char 
# 112 "project/radare2/libr/debug/p/bfvm.c"
    *mem = bfvm_get_ptr (c);
 if (mem != 
# 113 "project/radare2/libr/debug/p/bfvm.c" 3 4
           ((void *)0)
# 113 "project/radare2/libr/debug/p/bfvm.c"
               ) {
  mem[0]--;
 }
}

static inline int bfvm_reg_set(BfvmCPU *c, const char *str) {
 char *ptr = strchr (str, ' ');
 if (!ptr) {
  return 0;
 }
 if (strstr (str, "eip")) {
  c->eip = r_num_math (
# 124 "project/radare2/libr/debug/p/bfvm.c" 3 4
                      ((void *)0)
# 124 "project/radare2/libr/debug/p/bfvm.c"
                          , ptr+1);
 } else if (strstr (str, "esp")) {
  c->esp = r_num_math (
# 126 "project/radare2/libr/debug/p/bfvm.c" 3 4
                      ((void *)0)
# 126 "project/radare2/libr/debug/p/bfvm.c"
                          , ptr+1);
 } else if (strstr (str, "ptr")) {
  c->ptr = r_num_math (
# 128 "project/radare2/libr/debug/p/bfvm.c" 3 4
                      ((void *)0)
# 128 "project/radare2/libr/debug/p/bfvm.c"
                          , ptr + 1);
 }
 return 1;
}
...
static inline void bfvm_peek(BfvmCPU *c) {
 int idx = c->input_idx;
 
# 136 "project/radare2/libr/debug/p/bfvm.c" 3 4
unsigned char 
# 136 "project/radare2/libr/debug/p/bfvm.c"
    *ptr = bfvm_get_ptr (c);
...
static inline void bfvm_poke(BfvmCPU *c) {
 int idx = c->screen_idx;
 c->screen_buf[idx] = bfvm_get (c);
 c->screen_idx = idx+1;
}

static inline int bfvm_trace_op(BfvmCPU *c, 
# 154 "project/radare2/libr/debug/p/bfvm.c" 3 4
                                   unsigned char 
# 154 "project/radare2/libr/debug/p/bfvm.c"
                                       op) {
 
# 155 "project/radare2/libr/debug/p/bfvm.c" 3 4
unsigned char 
# 155 "project/radare2/libr/debug/p/bfvm.c"
    g;
 switch (op) {
 case '\0':
  
# 158 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 158 "project/radare2/libr/debug/p/bfvm.c"
 " ; trap (%02x)\n", op
# 158 "project/radare2/libr/debug/p/bfvm.c" 3 4
 )
# 158 "project/radare2/libr/debug/p/bfvm.c"
...
# 165 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 165 "project/radare2/libr/debug/p/bfvm.c"
 "%c", op
# 165 "project/radare2/libr/debug/p/bfvm.c" 3 4
 )
# 165 "project/radare2/libr/debug/p/bfvm.c"
...
# 170 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 170 "project/radare2/libr/debug/p/bfvm.c"
 "%c  ; [ptr] = %d\n", op, g
# 170 "project/radare2/libr/debug/p/bfvm.c" 3 4
 )
# 170 "project/radare2/libr/debug/p/bfvm.c"
...
# 172 "project/radare2/libr/debug/p/bfvm.c" 3 4
  fprintf(__stderrp,
# 172 "project/radare2/libr/debug/p/bfvm.c"
  "["
# 172 "project/radare2/libr/debug/p/bfvm.c" 3 4
  )
# 172 "project/radare2/libr/debug/p/bfvm.c"
...
# 182 "project/radare2/libr/debug/p/bfvm.c" 3 4
unsigned char 
# 182 "project/radare2/libr/debug/p/bfvm.c"
    op2, op = bfvm_op (c);

 do {
  if (c->trace) bfvm_trace_op (c, op);
  switch (op) {
  case '\0':
...
static inline int bfvm_contsc(BfvmCPU *c) {
 c->breaked = 0;
 while (!c->breaked) {
  bfvm_step (c, 0);
  if (bfvm_in_trap (c)) {
   
# 239 "project/radare2/libr/debug/p/bfvm.c" 3 4
  fprintf(__stderrp,
# 239 "project/radare2/libr/debug/p/bfvm.c"
  "Trap instruction at 0x%08"
# 239 "project/radare2/libr/debug/p/bfvm.c" 3 4
  "llx"
# 239 "project/radare2/libr/debug/p/bfvm.c"
  "\n", c->eip
...
# 244 "project/radare2/libr/debug/p/bfvm.c" 3 4
  fprintf(__stderrp,
# 244 "project/radare2/libr/debug/p/bfvm.c"
...
# 248 "project/radare2/libr/debug/p/bfvm.c" 3 4
  fprintf(__stderrp,
# 248 "project/radare2/libr/debug/p/bfvm.c"
...
static inline int bfvm_cont(BfvmCPU *c, 
# 256 "project/radare2/libr/debug/p/bfvm.c" 3 4
                               unsigned long long 
# 256 "project/radare2/libr/debug/p/bfvm.c"
                                    until) {
 c->breaked = 0;
...
# 261 "project/radare2/libr/debug/p/bfvm.c" 3 4
  fprintf(__stderrp,
# 261 "project/radare2/libr/debug/p/bfvm.c"
  "Trap instruction at 0x%"
# 261 "project/radare2/libr/debug/p/bfvm.c" 3 4
  "llx"
# 261 "project/radare2/libr/debug/p/bfvm.c"
  "\n", c->eip
...
static inline int bfvm_trace(BfvmCPU *c, 
# 268 "project/radare2/libr/debug/p/bfvm.c" 3 4
                                unsigned long long 
# 268 "project/radare2/libr/debug/p/bfvm.c"
                                     until) {
 c->trace=1;
 bfvm_cont (c, until);
 c->trace=0;
...
static inline void bfvm_show_regs(BfvmCPU *c, int rad) {
 if (rad) {
  
# 277 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 277 "project/radare2/libr/debug/p/bfvm.c"
 "fs regs\n"
# 277 "project/radare2/libr/debug/p/bfvm.c" 3 4
 )
# 277 "project/radare2/libr/debug/p/bfvm.c"
...
# 278 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 278 "project/radare2/libr/debug/p/bfvm.c"
 "f eip @ 0x%08"
# 278 "project/radare2/libr/debug/p/bfvm.c" 3 4
 "llx"
# 278 "project/radare2/libr/debug/p/bfvm.c"
...
# 279 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 279 "project/radare2/libr/debug/p/bfvm.c"
 "f esp @ 0x%08"
# 279 "project/radare2/libr/debug/p/bfvm.c" 3 4
 "llx"
# 279 "project/radare2/libr/debug/p/bfvm.c"
...
# 280 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 280 "project/radare2/libr/debug/p/bfvm.c"
 "f ptr @ 0x%08"
# 280 "project/radare2/libr/debug/p/bfvm.c" 3 4
 "llx"
# 280 "project/radare2/libr/debug/p/bfvm.c"
...
# 281 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 281 "project/radare2/libr/debug/p/bfvm.c"
 "fs *\n"
# 281 "project/radare2/libr/debug/p/bfvm.c" 3 4
 )
# 281 "project/radare2/libr/debug/p/bfvm.c"
...
# 283 "project/radare2/libr/debug/p/bfvm.c" 3 4
 unsigned char 
# 283 "project/radare2/libr/debug/p/bfvm.c"
     ch = bfvm_get (c);
  
# 284 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 284 "project/radare2/libr/debug/p/bfvm.c"
 "  eip  0x%08"
# 284 "project/radare2/libr/debug/p/bfvm.c" 3 4
 "llx"
# 284 "project/radare2/libr/debug/p/bfvm.c"
...
# 285 "project/radare2/libr/debug/p/bfvm.c"
                             ;
  
# 286 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 286 "project/radare2/libr/debug/p/bfvm.c"
...
# 287 "project/radare2/libr/debug/p/bfvm.c"
                                                  ;
 }
}

static inline void bfvm_maps(BfvmCPU *c, int rad) {
 if (rad) {
  
# 293 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 293 "project/radare2/libr/debug/p/bfvm.c"
 "fs sections\n"
# 293 "project/radare2/libr/debug/p/bfvm.c" 3 4
 )
# 293 "project/radare2/libr/debug/p/bfvm.c"
...
# 294 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 294 "project/radare2/libr/debug/p/bfvm.c"
...
# 295 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 295 "project/radare2/libr/debug/p/bfvm.c"
 "f section_code @ 0x%08"
# 295 "project/radare2/libr/debug/p/bfvm.c" 3 4
 "llx"
# 295 "project/radare2/libr/debug/p/bfvm.c"
 "\n", (
...
# 296 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 296 "project/radare2/libr/debug/p/bfvm.c"
 "f section_code_end @ 0x%08"
# 296 "project/radare2/libr/debug/p/bfvm.c" 3 4
 "llx"
# 296 "project/radare2/libr/debug/p/bfvm.c"
 "\n", (
...
# 297 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 297 "project/radare2/libr/debug/p/bfvm.c"
 "f section_data @ 0x%08"
# 297 "project/radare2/libr/debug/p/bfvm.c" 3 4
 "llx"
# 297 "project/radare2/libr/debug/p/bfvm.c"
 "\n", (
...
# 298 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 298 "project/radare2/libr/debug/p/bfvm.c"
 "f section_data_end @ 0x%08"
# 298 "project/radare2/libr/debug/p/bfvm.c" 3 4
 "llx"
# 298 "project/radare2/libr/debug/p/bfvm.c"
 "\n", (
...
# 299 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 299 "project/radare2/libr/debug/p/bfvm.c"
 "f screen @ 0x%08"
# 299 "project/radare2/libr/debug/p/bfvm.c" 3 4
 "llx"
# 299 "project/radare2/libr/debug/p/bfvm.c"
...
# 300 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 300 "project/radare2/libr/debug/p/bfvm.c"
 "f section_screen @ 0x%08"
# 300 "project/radare2/libr/debug/p/bfvm.c" 3 4
 "llx"
# 300 "project/radare2/libr/debug/p/bfvm.c"
 "\n", (
...
# 301 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 301 "project/radare2/libr/debug/p/bfvm.c"
 "f section_screen_end @ 0x%08"
# 301 "project/radare2/libr/debug/p/bfvm.c" 3 4
 "llx"
# 301 "project/radare2/libr/debug/p/bfvm.c"
 "\n", (
# 301 "project/radare2/libr/debug/p/bfvm.c" 3 4
 unsigned long long
# 301 "project/radare2/libr/debug/p/bfvm.c"
 )c->screen+c->screen_size
# 301 "project/radare2/libr/debug/p/bfvm.c" 3 4
 )
# 301 "project/radare2/libr/debug/p/bfvm.c"
                                                                                    ;
  
# 302 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 302 "project/radare2/libr/debug/p/bfvm.c"
 "f input @ 0x%08"
# 302 "project/radare2/libr/debug/p/bfvm.c" 3 4
 "llx"
# 302 "project/radare2/libr/debug/p/bfvm.c"
...
# 303 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 303 "project/radare2/libr/debug/p/bfvm.c"
 "f section_input @ 0x%08"
# 303 "project/radare2/libr/debug/p/bfvm.c" 3 4
 "llx"
# 303 "project/radare2/libr/debug/p/bfvm.c"
 "\n", (
...
# 304 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 304 "project/radare2/libr/debug/p/bfvm.c"
 "f section_input_end @ 0x%08"
# 304 "project/radare2/libr/debug/p/bfvm.c" 3 4
 "llx"
# 304 "project/radare2/libr/debug/p/bfvm.c"
 "\n", (
# 304 "project/radare2/libr/debug/p/bfvm.c" 3 4
 unsigned long long
# 304 "project/radare2/libr/debug/p/bfvm.c"
 )c->input+c->input_size
# 304 "project/radare2/libr/debug/p/bfvm.c" 3 4
 )
# 304 "project/radare2/libr/debug/p/bfvm.c"
                                                                                 ;
  
# 305 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 305 "project/radare2/libr/debug/p/bfvm.c"
 "fs *\n"
# 305 "project/radare2/libr/debug/p/bfvm.c" 3 4
 )
# 305 "project/radare2/libr/debug/p/bfvm.c"
...
# 307 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 307 "project/radare2/libr/debug/p/bfvm.c"
 "0x%08"
# 307 "project/radare2/libr/debug/p/bfvm.c" 3 4
 "llx"
# 307 "project/radare2/libr/debug/p/bfvm.c"
...
# 308 "project/radare2/libr/debug/p/bfvm.c"
                                        ;
  
# 309 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 309 "project/radare2/libr/debug/p/bfvm.c"
 "0x%08"
# 309 "project/radare2/libr/debug/p/bfvm.c" 3 4
 "llx"
# 309 "project/radare2/libr/debug/p/bfvm.c"
...
# 310 "project/radare2/libr/debug/p/bfvm.c"
                                                        ;
  
# 311 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 311 "project/radare2/libr/debug/p/bfvm.c"
 "0x%08"
# 311 "project/radare2/libr/debug/p/bfvm.c" 3 4
 "llx"
# 311 "project/radare2/libr/debug/p/bfvm.c"
...
# 312 "project/radare2/libr/debug/p/bfvm.c"
                                                                          ;
  
# 313 "project/radare2/libr/debug/p/bfvm.c" 3 4
 fprintf(__stderrp,
# 313 "project/radare2/libr/debug/p/bfvm.c"
 "0x%08"
# 313 "project/radare2/libr/debug/p/bfvm.c" 3 4
 "llx"
# 313 "project/radare2/libr/debug/p/bfvm.c"
...
# 314 "project/radare2/libr/debug/p/bfvm.c"
                                                                      ;
 }
}
# 8 "project/radare2/libr/debug/p/debug_bf.c" 2

typedef struct {
 int desc;
 
# 11 "project/radare2/libr/debug/p/debug_bf.c" 3 4
unsigned char 
# 11 "project/radare2/libr/debug/p/debug_bf.c"
    *buf;
 
# 12 "project/radare2/libr/debug/p/debug_bf.c" 3 4
unsigned int 
# 12 "project/radare2/libr/debug/p/debug_bf.c"
     size;
 BfvmCPU *bfvm;
} RIOBdescbg;
...
# 17 "project/radare2/libr/debug/p/debug_bf.c" 3 4
unsigned int 
# 17 "project/radare2/libr/debug/p/debug_bf.c"
     pc;
 
# 18 "project/radare2/libr/debug/p/debug_bf.c" 3 4
unsigned int 
# 18 "project/radare2/libr/debug/p/debug_bf.c"
     ptr;
 
# 19 "project/radare2/libr/debug/p/debug_bf.c" 3 4
unsigned int 
# 19 "project/radare2/libr/debug/p/debug_bf.c"
     sp;
 
# 20 "project/radare2/libr/debug/p/debug_bf.c" 3 4
unsigned int 
# 20 "project/radare2/libr/debug/p/debug_bf.c"
     scr;
 
# 21 "project/radare2/libr/debug/p/debug_bf.c" 3 4
unsigned int 
# 21 "project/radare2/libr/debug/p/debug_bf.c"
     scri;
 
# 22 "project/radare2/libr/debug/p/debug_bf.c" 3 4
unsigned int 
# 22 "project/radare2/libr/debug/p/debug_bf.c"
     inp;
 
# 23 "project/radare2/libr/debug/p/debug_bf.c" 3 4
unsigned int 
# 23 "project/radare2/libr/debug/p/debug_bf.c"
     inpi;
 
# 24 "project/radare2/libr/debug/p/debug_bf.c" 3 4
unsigned int 
# 24 "project/radare2/libr/debug/p/debug_bf.c"
     mem;
 
# 25 "project/radare2/libr/debug/p/debug_bf.c" 3 4
unsigned int 
# 25 "project/radare2/libr/debug/p/debug_bf.c"
     memi;
};
...
static 
# 30 "project/radare2/libr/debug/p/debug_bf.c" 3 4
      _Bool 
# 30 "project/radare2/libr/debug/p/debug_bf.c"
           is_io_bf(RDebug *dbg) {
 RIODesc *d = dbg->iob.io->desc;
 if (d && d->plugin && d->plugin->name) {
  if (!strcmp ("bfdbg", d->plugin->name)) {
   return 
# 34 "project/radare2/libr/debug/p/debug_bf.c" 3 4
         1
# 34 "project/radare2/libr/debug/p/debug_bf.c"
             ;
  }
 }
 
# 37 "project/radare2/libr/debug/p/debug_bf.c" 3 4
fprintf(__stderrp,
# 37 "project/radare2/libr/debug/p/debug_bf.c"
...
# 37 "project/radare2/libr/debug/p/debug_bf.c"
                                                              ;
 return 
# 38 "project/radare2/libr/debug/p/debug_bf.c" 3 4
       0
# 38 "project/radare2/libr/debug/p/debug_bf.c"
            ;
}

static 
# 41 "project/radare2/libr/debug/p/debug_bf.c" 3 4
      _Bool 
# 41 "project/radare2/libr/debug/p/debug_bf.c"
           r_debug_bf_step_over(RDebug *dbg) {
 ...
 return 
# 55 "project/radare2/libr/debug/p/debug_bf.c" 3 4
       1
# 55 "project/radare2/libr/debug/p/debug_bf.c"
           ;
}

static 
# 58 "project/radare2/libr/debug/p/debug_bf.c" 3 4
      _Bool 
# 58 "project/radare2/libr/debug/p/debug_bf.c"
           r_debug_bf_step(RDebug *dbg) {
 RIOBdescbg *o = dbg->iob.io->desc->data;
 bfvm_step (o->bfvm, 0);
 return 
# 61 "project/radare2/libr/debug/p/debug_bf.c" 3 4
       1
# 61 "project/radare2/libr/debug/p/debug_bf.c"
           ;
}

static int r_debug_bf_reg_read(RDebug *dbg, int type, 
# 64 "project/radare2/libr/debug/p/debug_bf.c" 3 4
                                                     unsigned char 
# 64 "project/radare2/libr/debug/p/debug_bf.c"
                                                         *buf, int size) {
 
# 65 "project/radare2/libr/debug/p/debug_bf.c" 3 4
do { if (!(
# 65 "project/radare2/libr/debug/p/debug_bf.c"
dbg && buf && size > 0
# 65 "project/radare2/libr/debug/p/debug_bf.c" 3 4
...
# 82 "project/radare2/libr/debug/p/debug_bf.c" 3 4
__builtin___memcpy_chk (
# 82 "project/radare2/libr/debug/p/debug_bf.c"
buf
# 82 "project/radare2/libr/debug/p/debug_bf.c" 3 4
, 
# 82 "project/radare2/libr/debug/p/debug_bf.c"
...
static int r_debug_bf_reg_write(RDebug *dbg, int type, const 
# 87 "project/radare2/libr/debug/p/debug_bf.c" 3 4
                                                            unsigned char 
# 87 "project/radare2/libr/debug/p/debug_bf.c"
                                                                *buf, int size) {
 if (!dbg) {
  return 
# 89 "project/radare2/libr/debug/p/debug_bf.c" 3 4
        0
# 89 "project/radare2/libr/debug/p/debug_bf.c"
             ;
 }
 if (!is_io_bf (dbg)) {
  return 0;
...
# 98 "project/radare2/libr/debug/p/debug_bf.c" 3 4
__builtin___memcpy_chk (
# 98 "project/radare2/libr/debug/p/debug_bf.c"
&r
# 98 "project/radare2/libr/debug/p/debug_bf.c" 3 4
, 
# 98 "project/radare2/libr/debug/p/debug_bf.c"
...
# 98 "project/radare2/libr/debug/p/debug_bf.c"
 ...
 o->bfvm->ptr = r.memi;
 return 
# 108 "project/radare2/libr/debug/p/debug_bf.c" 3 4
       1
# 108 "project/radare2/libr/debug/p/debug_bf.c"
           ;
}

static 
# 111 "project/radare2/libr/debug/p/debug_bf.c" 3 4
      _Bool 
# 111 "project/radare2/libr/debug/p/debug_bf.c"
           r_debug_bf_continue(RDebug *dbg, int pid, int tid, int sig) {
 RIOBdescbg *o = dbg->iob.io->desc->data;
 bfvm_cont (o->bfvm, 
# 113 "project/radare2/libr/debug/p/debug_bf.c" 3 4
                    0xFFFFFFFFFFFFFFFFULL
# 113 "project/radare2/libr/debug/p/debug_bf.c"
                            );
 return 
# 114 "project/radare2/libr/debug/p/debug_bf.c" 3 4
       1
# 114 "project/radare2/libr/debug/p/debug_bf.c"
           ;
}

static 
# 117 "project/radare2/libr/debug/p/debug_bf.c" 3 4
      _Bool 
# 117 "project/radare2/libr/debug/p/debug_bf.c"
           r_debug_bf_continue_syscall(RDebug *dbg, int pid, int num) {
 RIOBdescbg *o = dbg->iob.io->desc->data;
 bfvm_contsc (o->bfvm);
 return 
# 120 "project/radare2/libr/debug/p/debug_bf.c" 3 4
       1
# 120 "project/radare2/libr/debug/p/debug_bf.c"
           ;
}
...
static 
# 127 "project/radare2/libr/debug/p/debug_bf.c" 3 4
      _Bool 
# 127 "project/radare2/libr/debug/p/debug_bf.c"
           r_debug_bf_attach(RDebug *dbg, int pid) {
 if (!is_io_bf (dbg)) {
  return 
# 129 "project/radare2/libr/debug/p/debug_bf.c" 3 4
        0
# 129 "project/radare2/libr/debug/p/debug_bf.c"
             ;
 }
 return 
# 131 "project/radare2/libr/debug/p/debug_bf.c" 3 4
       1
# 131 "project/radare2/libr/debug/p/debug_bf.c"
           ;
}

static 
# 134 "project/radare2/libr/debug/p/debug_bf.c" 3 4
      _Bool 
# 134 "project/radare2/libr/debug/p/debug_bf.c"
           r_debug_bf_detach(RDebug *dbg, int pid) {

 return 
# 136 "project/radare2/libr/debug/p/debug_bf.c" 3 4
       1
# 136 "project/radare2/libr/debug/p/debug_bf.c"
           ;
}
...
static int r_debug_bf_breakpoint (struct r_bp_t *bp, RBreakpointItem *b, 
# 157 "project/radare2/libr/debug/p/debug_bf.c" 3 4
                                                                        _Bool 
# 157 "project/radare2/libr/debug/p/debug_bf.c"
                                                                             set) {

 return 
# 159 "project/radare2/libr/debug/p/debug_bf.c" 3 4
       0
# 159 "project/radare2/libr/debug/p/debug_bf.c"
            ;
}

static 
# 162 "project/radare2/libr/debug/p/debug_bf.c" 3 4
      _Bool 
# 162 "project/radare2/libr/debug/p/debug_bf.c"
           r_debug_bf_kill(RDebug *dbg, int pid, int tid, int sig) {
 if (!is_io_bf (dbg)) {
  return 
# 164 "project/radare2/libr/debug/p/debug_bf.c" 3 4
        0
# 164 "project/radare2/libr/debug/p/debug_bf.c"
             ;
 }
 RIOBdescbg *o = dbg->iob.io->desc->data;
 if (o) {
 ...
 return 
# 170 "project/radare2/libr/debug/p/debug_bf.c" 3 4
       1
# 170 "project/radare2/libr/debug/p/debug_bf.c"
           ;
}
...
static RList *r_debug_native_map_get(RDebug *dbg) {
 if (!is_io_bf (dbg)) {
  return 
# 175 "project/radare2/libr/debug/p/debug_bf.c" 3 4
        0
# 175 "project/radare2/libr/debug/p/debug_bf.c"
             ;
 }
 RIOBdescbg *o = dbg->iob.io->desc->data;
 BfvmCPU *c = o->bfvm;
 ...
 if (!list) {
  return 
# 181 "project/radare2/libr/debug/p/debug_bf.c" 3 4
        ((void *)0)
# 181 "project/radare2/libr/debug/p/debug_bf.c"
            ;
 }
...
static int r_debug_bf_stop(RDebug *dbg) {
 if (!is_io_bf (dbg)) {
  return 
# 196 "project/radare2/libr/debug/p/debug_bf.c" 3 4
        0
# 196 "project/radare2/libr/debug/p/debug_bf.c"
             ;
 }
 RIOBdescbg *o = dbg->iob.io->desc->data;
 BfvmCPU *c = o->bfvm;
 c->breaked = 
# 200 "project/radare2/libr/debug/p/debug_bf.c" 3 4
             1
# 200 "project/radare2/libr/debug/p/debug_bf.c"
                 ;
 return 
# 201 "project/radare2/libr/debug/p/debug_bf.c" 3 4
       1
# 201 "project/radare2/libr/debug/p/debug_bf.c"
           ;
}
...
RDebugPlugin r_debug_plugin_bf = {
 ...
 .license = "LGPL3",
 .bits = 
# 208 "project/radare2/libr/debug/p/debug_bf.c" 3 4
        4 
# 208 "project/radare2/libr/debug/p/debug_bf.c"
                      | 
# 208 "project/radare2/libr/debug/p/debug_bf.c" 3 4
                        8
# 208 "project/radare2/libr/debug/p/debug_bf.c"
...
static inline RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_DBG,
 .data = &r_debug_plugin_bf,
 .version = 
# 229 "project/radare2/libr/debug/p/debug_bf.c" 3 4
           "5.5.4"

# 230 "project/radare2/libr/debug/p/debug_bf.c"
};
