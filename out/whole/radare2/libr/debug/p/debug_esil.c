# 0 "project/radare2/libr/debug/p/debug_esil.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/debug/p/debug_esil.c"
...
# 5 "project/radare2/libr/debug/p/debug_esil.c" 2
...
# 6 "project/radare2/libr/debug/p/debug_esil.c" 2
# 17 "project/radare2/libr/debug/p/debug_esil.c"

# 17 "project/radare2/libr/debug/p/debug_esil.c"
static 
# 17 "project/radare2/libr/debug/p/debug_esil.c" 3 4
      _Bool 
# 17 "project/radare2/libr/debug/p/debug_esil.c"
           __esil_step_over(RDebug *dbg) {
 
# 18 "project/radare2/libr/debug/p/debug_esil.c" 3 4
fprintf(__stderrp,
# 18 "project/radare2/libr/debug/p/debug_esil.c"
"TODO: ESIL STEP OVER\n"
# 18 "project/radare2/libr/debug/p/debug_esil.c" 3 4
)
# 18 "project/radare2/libr/debug/p/debug_esil.c"
                                  ;
 return 
# 19 "project/radare2/libr/debug/p/debug_esil.c" 3 4
       1
# 19 "project/radare2/libr/debug/p/debug_esil.c"
           ;
}

static 
# 22 "project/radare2/libr/debug/p/debug_esil.c" 3 4
      _Bool 
# 22 "project/radare2/libr/debug/p/debug_esil.c"
           __esil_step(RDebug *dbg) {
 int oplen;
 
# 24 "project/radare2/libr/debug/p/debug_esil.c" 3 4
unsigned char 
# 24 "project/radare2/libr/debug/p/debug_esil.c"
    buf[64];
 
# 25 "project/radare2/libr/debug/p/debug_esil.c" 3 4
unsigned long long 
# 25 "project/radare2/libr/debug/p/debug_esil.c"
     pc = 0LL;
 RAnalOp op = {0};

 r_debug_reg_sync(dbg, R_REG_TYPE_GPR, 
# 28 "project/radare2/libr/debug/p/debug_esil.c" 3 4
                                      0
# 28 "project/radare2/libr/debug/p/debug_esil.c"
                                           );
 pc = r_debug_reg_get (dbg, "PC");
 
# 30 "project/radare2/libr/debug/p/debug_esil.c" 3 4
fprintf(__stderrp,
# 30 "project/radare2/libr/debug/p/debug_esil.c"
"PC = 0x%" 
# 30 "project/radare2/libr/debug/p/debug_esil.c" 3 4
"llx" 
# 30 "project/radare2/libr/debug/p/debug_esil.c"
...
# 35 "project/radare2/libr/debug/p/debug_esil.c" 3 4
fprintf(__stderrp,
# 35 "project/radare2/libr/debug/p/debug_esil.c"
"READ 0x%08"
# 35 "project/radare2/libr/debug/p/debug_esil.c" 3 4
"llx"
# 35 "project/radare2/libr/debug/p/debug_esil.c"
...
# 35 "project/radare2/libr/debug/p/debug_esil.c"
 ...
 if (oplen > 0) {
  if (*
# 38 "project/radare2/libr/debug/p/debug_esil.c" 3 4
      (r_strbuf_get (
# 38 "project/radare2/libr/debug/p/debug_esil.c"
      &op.esil
# 38 "project/radare2/libr/debug/p/debug_esil.c" 3 4
      ) ? r_strbuf_get (
# 38 "project/radare2/libr/debug/p/debug_esil.c"
...
# 39 "project/radare2/libr/debug/p/debug_esil.c" 3 4
  fprintf(__stderrp,
# 39 "project/radare2/libr/debug/p/debug_esil.c"
  "ESIL: %s\n", 
# 39 "project/radare2/libr/debug/p/debug_esil.c" 3 4
  (r_strbuf_get (
# 39 "project/radare2/libr/debug/p/debug_esil.c"
...
# 39 "project/radare2/libr/debug/p/debug_esil.c"
                                                     ;
   r_anal_esil_parse (dbg->anal->esil, 
# 40 "project/radare2/libr/debug/p/debug_esil.c" 3 4
                                      (r_strbuf_get (
# 40 "project/radare2/libr/debug/p/debug_esil.c"
                                      &op.esil
# 40 "project/radare2/libr/debug/p/debug_esil.c" 3 4
                                      ) ? r_strbuf_get (
# 40 "project/radare2/libr/debug/p/debug_esil.c"
...
# 44 "project/radare2/libr/debug/p/debug_esil.c" 3 4
fprintf(__stderrp,
# 44 "project/radare2/libr/debug/p/debug_esil.c"
"TODO: ESIL STEP\n"
# 44 "project/radare2/libr/debug/p/debug_esil.c" 3 4
)
# 44 "project/radare2/libr/debug/p/debug_esil.c"
                             ;
 return 
# 45 "project/radare2/libr/debug/p/debug_esil.c" 3 4
       1
# 45 "project/radare2/libr/debug/p/debug_esil.c"
           ;
}

static 
# 48 "project/radare2/libr/debug/p/debug_esil.c" 3 4
      _Bool 
# 48 "project/radare2/libr/debug/p/debug_esil.c"
           __esil_init(RDebug *dbg) {
 dbg->tid = dbg->pid = 1;


 return 
# 52 "project/radare2/libr/debug/p/debug_esil.c" 3 4
       1
# 52 "project/radare2/libr/debug/p/debug_esil.c"
           ;
}

static 
# 55 "project/radare2/libr/debug/p/debug_esil.c" 3 4
      _Bool 
# 55 "project/radare2/libr/debug/p/debug_esil.c"
           __esil_continue(RDebug *dbg, int pid, int tid, int sig) {
 
# 56 "project/radare2/libr/debug/p/debug_esil.c" 3 4
fprintf(__stderrp,
# 56 "project/radare2/libr/debug/p/debug_esil.c"
"TODO continue\n"
# 56 "project/radare2/libr/debug/p/debug_esil.c" 3 4
)
# 56 "project/radare2/libr/debug/p/debug_esil.c"
                           ;
 return 
# 57 "project/radare2/libr/debug/p/debug_esil.c" 3 4
       1
# 57 "project/radare2/libr/debug/p/debug_esil.c"
           ;
}

static 
# 60 "project/radare2/libr/debug/p/debug_esil.c" 3 4
      _Bool 
# 60 "project/radare2/libr/debug/p/debug_esil.c"
           __esil_continue_syscall(RDebug *dbg, int pid, int num) {
 
# 61 "project/radare2/libr/debug/p/debug_esil.c" 3 4
fprintf(__stderrp,
# 61 "project/radare2/libr/debug/p/debug_esil.c"
...
# 61 "project/radare2/libr/debug/p/debug_esil.c"
                                               ;
 return 
# 62 "project/radare2/libr/debug/p/debug_esil.c" 3 4
       1
# 62 "project/radare2/libr/debug/p/debug_esil.c"
           ;
}
...
static 
# 70 "project/radare2/libr/debug/p/debug_esil.c" 3 4
      _Bool 
# 70 "project/radare2/libr/debug/p/debug_esil.c"
           __esil_attach(RDebug *dbg, int pid) {
 
# 71 "project/radare2/libr/debug/p/debug_esil.c" 3 4
fprintf(__stderrp,
# 71 "project/radare2/libr/debug/p/debug_esil.c"
"OK attach\n"
# 71 "project/radare2/libr/debug/p/debug_esil.c" 3 4
)
# 71 "project/radare2/libr/debug/p/debug_esil.c"
                       ;
 return 
# 72 "project/radare2/libr/debug/p/debug_esil.c" 3 4
       1
# 72 "project/radare2/libr/debug/p/debug_esil.c"
           ;
# 84 "project/radare2/libr/debug/p/debug_esil.c"
 return 
# 84 "project/radare2/libr/debug/p/debug_esil.c" 3 4
       1
# 84 "project/radare2/libr/debug/p/debug_esil.c"
           ;
}
...
static 
# 87 "project/radare2/libr/debug/p/debug_esil.c" 3 4
      _Bool 
# 87 "project/radare2/libr/debug/p/debug_esil.c"
           __esil_detach(RDebug *dbg, int pid) {

 return 
# 89 "project/radare2/libr/debug/p/debug_esil.c" 3 4
       1
# 89 "project/radare2/libr/debug/p/debug_esil.c"
           ;
}
...
static int __esil_breakpoint (RBreakpoint *bp, RBreakpointItem *b, 
# 114 "project/radare2/libr/debug/p/debug_esil.c" 3 4
                                                                  _Bool 
# 114 "project/radare2/libr/debug/p/debug_esil.c"
                                                                       set) {

 return 
# 116 "project/radare2/libr/debug/p/debug_esil.c" 3 4
       0
# 116 "project/radare2/libr/debug/p/debug_esil.c"
            ;
}

static 
# 119 "project/radare2/libr/debug/p/debug_esil.c" 3 4
      _Bool 
# 119 "project/radare2/libr/debug/p/debug_esil.c"
           __esil_kill(RDebug *dbg, int pid, int tid, int sig) {

 return 
# 121 "project/radare2/libr/debug/p/debug_esil.c" 3 4
       1
# 121 "project/radare2/libr/debug/p/debug_esil.c"
           ;
}

static int __esil_stop(RDebug *dbg) {
 
# 125 "project/radare2/libr/debug/p/debug_esil.c" 3 4
fprintf(__stderrp,
# 125 "project/radare2/libr/debug/p/debug_esil.c"
"ESIL: stop\n"
# 125 "project/radare2/libr/debug/p/debug_esil.c" 3 4
)
# 125 "project/radare2/libr/debug/p/debug_esil.c"
                        ;
 return 
# 126 "project/radare2/libr/debug/p/debug_esil.c" 3 4
       1
# 126 "project/radare2/libr/debug/p/debug_esil.c"
           ;
}

static int __reg_read (RDebug *dbg, int type, 
# 129 "project/radare2/libr/debug/p/debug_esil.c" 3 4
                                             unsigned char 
# 129 "project/radare2/libr/debug/p/debug_esil.c"
                                                 *buf, int size) {
 int sz;

 
# 132 "project/radare2/libr/debug/p/debug_esil.c" 3 4
unsigned char 
# 132 "project/radare2/libr/debug/p/debug_esil.c"
    *bytes = r_reg_get_bytes (dbg->reg, type, &sz);
 
# 133 "project/radare2/libr/debug/p/debug_esil.c" 3 4
__builtin___memcpy_chk (
# 133 "project/radare2/libr/debug/p/debug_esil.c"
buf
# 133 "project/radare2/libr/debug/p/debug_esil.c" 3 4
, 
# 133 "project/radare2/libr/debug/p/debug_esil.c"
...
RDebugPlugin r_debug_plugin_esil = {
 ...
 .arch = "any",
 .bits = 
# 142 "project/radare2/libr/debug/p/debug_esil.c" 3 4
        4 
# 142 "project/radare2/libr/debug/p/debug_esil.c"
                      | 
# 142 "project/radare2/libr/debug/p/debug_esil.c" 3 4
                        8
# 142 "project/radare2/libr/debug/p/debug_esil.c"
...
# 159 "project/radare2/libr/debug/p/debug_esil.c" 3 4
__attribute__((visibility("default"))) 
# 159 "project/radare2/libr/debug/p/debug_esil.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_DBG,
 .data = &r_debug_plugin_esil,
 .version = 
# 162 "project/radare2/libr/debug/p/debug_esil.c" 3 4
           "5.5.4"

# 163 "project/radare2/libr/debug/p/debug_esil.c"
};
