# 0 "project/radare2/libr/debug/p/native/windows/windows_message.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/debug/p/native/windows/windows_message.c"
...
# 3 "project/radare2/libr/debug/p/native/windows/windows_message.c" 2
# 1 "project/radare2/libr/debug/p/native/windows/windows_message.h" 1



# 3 "project/radare2/libr/debug/p/native/windows/windows_message.h"
...
# 8 "project/radare2/libr/debug/p/native/windows/windows_message.h" 3 4
unsigned long long 
# 8 "project/radare2/libr/debug/p/native/windows/windows_message.h"
     proc;
} window;


# 11 "project/radare2/libr/debug/p/native/windows/windows_message.h" 3 4
__attribute__((visibility("default"))) _Bool 
# 11 "project/radare2/libr/debug/p/native/windows/windows_message.h"
          r_w32_add_winmsg_breakpoint(RDebug *dbg, const char *input);

# 12 "project/radare2/libr/debug/p/native/windows/windows_message.h" 3 4
__attribute__((visibility("default"))) 
# 12 "project/radare2/libr/debug/p/native/windows/windows_message.h"
     void r_w32_identify_window(void);

# 13 "project/radare2/libr/debug/p/native/windows/windows_message.h" 3 4
__attribute__((visibility("default"))) 
# 13 "project/radare2/libr/debug/p/native/windows/windows_message.h"
     void r_w32_print_windows(RDebug *dbg);
# 4 "project/radare2/libr/debug/p/native/windows/windows_message.c" 2
...
# 246 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
((void *)0)

# 247 "project/radare2/libr/debug/p/native/windows/windows_message.c"
};
...
# 256 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
do { if (!(
# 256 "project/radare2/libr/debug/p/native/windows/windows_message.c"
hwnd
# 256 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
...
"hwnd"
# 256 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
, 256); return (((void *)0)); } } while (0)
# 256 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                                 ;
 window *win = 
# 257 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
              (
# 257 "project/radare2/libr/debug/p/native/windows/windows_message.c"
              window
# 257 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
              *)calloc(1,sizeof(
# 257 "project/radare2/libr/debug/p/native/windows/windows_message.c"
...
# 257 "project/radare2/libr/debug/p/native/windows/windows_message.c"
 ...
 if (!win) {
  return 
# 259 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
        ((void *)0)
# 259 "project/radare2/libr/debug/p/native/windows/windows_message.c"
            ;
 }
 win->h = hwnd;
 ...
 if (!tmp) {
  free (win);
  return 
# 268 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
        ((void *)0)
# 268 "project/radare2/libr/debug/p/native/windows/windows_message.c"
            ;
 }
 GetClassNameW (hwnd, tmp, MAX_CLASS_NAME);
 win->name = 
# 271 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
            r_utf16_to_utf8_l ((wchar_t *)
# 271 "project/radare2/libr/debug/p/native/windows/windows_message.c"
            tmp
# 271 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
            , -1)
# 271 "project/radare2/libr/debug/p/native/windows/windows_message.c"
...
static RTable *__create_window_table(void) {
 ...
 if (!tbl) {
  return 
# 282 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
        ((void *)0)
# 282 "project/radare2/libr/debug/p/native/windows/windows_message.c"
            ;
 }
 r_table_add_column (tbl, r_table_type ("number"), "Handle", 
# 284 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
                                                            0x7FFFFFFF
# 284 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                                                                    );
 r_table_add_column (tbl, r_table_type ("number"), "PID", 
# 285 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
                                                         0x7FFFFFFF
# 285 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                                                                 );
 r_table_add_column (tbl, r_table_type ("number"), "TID", 
# 286 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
                                                         0x7FFFFFFF
# 286 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                                                                 );
 r_table_add_column (tbl, r_table_type ("string"), "Class Name", 
# 287 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
                                                                0x7FFFFFFF
# 287 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                                                                        );
 return tbl;
}
...
# 292 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
do { if (!(
# 292 "project/radare2/libr/debug/p/native/windows/windows_message.c"
tbl && win
# 292 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 292 "project/radare2/libr/debug/p/native/windows/windows_message.c"
...
# 292 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                             ;
 char *handle = r_str_newf ("0x%08"
# 293 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
                                  "llx"
# 293 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                                         "", (
# 293 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
                                              unsigned long long
# 293 "project/radare2/libr/debug/p/native/windows/windows_message.c"
 ...
 r_table_add_row (tbl, handle, pid, tid, win->name, 
# 296 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
                                                   ((void *)0)
# 296 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                                                       );
 free (handle);
 free (tid);
 free (pid);
...
# 302 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
__attribute__((visibility("default"))) 
# 302 "project/radare2/libr/debug/p/native/windows/windows_message.c"
     void r_w32_identify_window(void) {
 ...
 window *win = 
# 307 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
              ((void *)0)
# 307 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                  ;
 if (hwnd) {
...
# 315 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
 fprintf(__stderrp,
# 315 "project/radare2/libr/debug/p/native/windows/windows_message.c"
 "No window found\n"
# 315 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
 )
# 315 "project/radare2/libr/debug/p/native/windows/windows_message.c"
...
# 319 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
 fprintf(__stderrp,
# 319 "project/radare2/libr/debug/p/native/windows/windows_message.c"
 "Error trying to get information from 0x%08"
# 319 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
 "llx"
# 319 "project/radare2/libr/debug/p/native/windows/windows_message.c"
 "\n", (
...
# 328 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
r_cons_strcat (
# 328 "project/radare2/libr/debug/p/native/windows/windows_message.c"
tbl_str
# 328 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
)
# 328 "project/radare2/libr/debug/p/native/windows/windows_message.c"
...
static BOOL CALLBACK __enum_childs(
 ...
 if (!win) {
  return 
# 340 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
        0
# 340 "project/radare2/libr/debug/p/native/windows/windows_message.c"
             ;
 }
 
# 342 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
r_list_append ((
# 342 "project/radare2/libr/debug/p/native/windows/windows_message.c"
windows
# 342 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
), (
# 342 "project/radare2/libr/debug/p/native/windows/windows_message.c"
...
# 342 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                          ;
 return 
# 343 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
       1
# 343 "project/radare2/libr/debug/p/native/windows/windows_message.c"
           ;
}
...
static RList *__get_windows(RDebug *dbg) {
 ...
 HWND hCurWnd = 
# 348 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
               ((void *)0)
# 348 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                   ;
 do {
  hCurWnd = FindWindowEx (
# 350 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
                         ((void *)0)
# 350 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                             , hCurWnd, 
# 350 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
                                        ((void *)0)
# 350 "project/radare2/libr/debug/p/native/windows/windows_message.c"
...
# 350 "project/radare2/libr/debug/p/native/windows/windows_message.c"
  ...
  if (dbg->pid == dwProcessID) {
   ...
   if (!win) {
    r_list_free (windows);
    return 
# 358 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
          ((void *)0)
# 358 "project/radare2/libr/debug/p/native/windows/windows_message.c"
              ;
   }
   
# 360 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
  r_list_append ((
# 360 "project/radare2/libr/debug/p/native/windows/windows_message.c"
  windows
# 360 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
  ), (
# 360 "project/radare2/libr/debug/p/native/windows/windows_message.c"
...
# 362 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
                    ((void *)0)
# 362 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                        );
 return windows;
}

static 
# 366 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
      unsigned long long 
# 366 "project/radare2/libr/debug/p/native/windows/windows_message.c"
           __get_dispatchmessage_offset(RDebug *dbg) {
 RList *modlist = r_debug_modules_list (dbg);
 RListIter *it;
 RDebugMap *mod;
 
# 370 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
_Bool 
# 370 "project/radare2/libr/debug/p/native/windows/windows_message.c"
     found = 
# 370 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
             0
# 370 "project/radare2/libr/debug/p/native/windows/windows_message.c"
...
# 371 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
if (
# 371 "project/radare2/libr/debug/p/native/windows/windows_message.c"
modlist
# 371 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
) for (
# 371 "project/radare2/libr/debug/p/native/windows/windows_message.c"
...
# 371 "project/radare2/libr/debug/p/native/windows/windows_message.c"
  ...
  if (!strnicmp (mod->name, "user32.dll", sizeof ("user32.dll"))) {
   found = 
# 373 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
          1
# 373 "project/radare2/libr/debug/p/native/windows/windows_message.c"
              ;
   break;
  }
 }
...
# 386 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
unsigned long long 
# 386 "project/radare2/libr/debug/p/native/windows/windows_message.c"
     offset = 0;
 do {
  char *sym = strrchr (line, ' ');
  if (sym && r_str_startswith (sym + 1, "sym.imp")) {
   offset = r_num_math (
# 390 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
                       ((void *)0)
# 390 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                           , line);
   dbg->iob.read_at (dbg->iob.io, offset, (
# 391 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
                                          unsigned char 
# 391 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                                              *)&offset, sizeof (offset));
   break;
  }
 } while ((line = strtok (
# 394 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
                         ((void *)0)
# 394 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                             , "\n")));
 free (res);
 return offset;
}
...
static DWORD __get_msg_type(char *name) {
 static Sdb *msg_types = 
# 409 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
                        ((void *)0)
# 409 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                            ;
 if (!msg_types) {
  __init_msg_types (&msg_types);
 }
 
# 413 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
unsigned int 
# 413 "project/radare2/libr/debug/p/native/windows/windows_message.c"
     found;
 const char *type_str = sdb_const_get (msg_types, name, &found);
 if (found) {
  int type = r_num_math (
# 416 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
                        ((void *)0)
# 416 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                            , type_str);
  return type;
 }
 return 0;
...
# 429 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
if (
# 429 "project/radare2/libr/debug/p/native/windows/windows_message.c"
windows
# 429 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
) for (
# 429 "project/radare2/libr/debug/p/native/windows/windows_message.c"
...
# 438 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
__attribute__((visibility("default"))) 
# 438 "project/radare2/libr/debug/p/native/windows/windows_message.c"
     void r_w32_print_windows(RDebug *dbg) {
...
# 450 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 450 "project/radare2/libr/debug/p/native/windows/windows_message.c"
          r_w32_add_winmsg_breakpoint(RDebug *dbg, const char *input) {
 
# 451 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
do { if (!(
# 451 "project/radare2/libr/debug/p/native/windows/windows_message.c"
dbg && input
# 451 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 451 "project/radare2/libr/debug/p/native/windows/windows_message.c"
...
# 451 "project/radare2/libr/debug/p/native/windows/windows_message.c"
 ...
 if (!type) {
  free (name);
  return 
# 462 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
        0
# 462 "project/radare2/libr/debug/p/native/windows/windows_message.c"
             ;
 }
 
# 464 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
unsigned long long 
# 464 "project/radare2/libr/debug/p/native/windows/windows_message.c"
     offset = 0;
 if (window_id) {
  RList *windows = __get_windows (dbg);
...
# 470 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
 unsigned long long 
# 470 "project/radare2/libr/debug/p/native/windows/windows_message.c"
      win_h = r_num_math (
# 470 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
                          ((void *)0)
# 470 "project/radare2/libr/debug/p/native/windows/windows_message.c"
...
# 473 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
 if (
# 473 "project/radare2/libr/debug/p/native/windows/windows_message.c"
 windows
# 473 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
 ) for (
# 473 "project/radare2/libr/debug/p/native/windows/windows_message.c"
...
# 473 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                                   {
   if ((
# 474 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
       unsigned long long
# 474 "project/radare2/libr/debug/p/native/windows/windows_message.c"
           )win->h == win_h || !strnicmp (win->name, window_id, strlen (window_id))) {
    offset = win->proc;
    break;
   }
  }
 ...
 if (!offset) {
  free (name);
  return 
# 489 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
        0
# 489 "project/radare2/libr/debug/p/native/windows/windows_message.c"
             ;
 }
 r_debug_bp_add (dbg, offset, 0, 0, 0, 
# 491 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
                                      ((void *)0)
# 491 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                                          , 0);
 char *cond;
 if (window_id) {
  ...
  char *reg;
  if (dbg->bits == 
# 497 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
                  8
# 497 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                               ) {
   reg = "rcx";
  } else {
   reg = "ecx";
 ...
 dbg->corebind.cmdf (dbg->corebind.core, "\"dbC 0x%"
# 504 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
                                                   "llx"
# 504 "project/radare2/libr/debug/p/native/windows/windows_message.c"
                                                          " %s\"", offset, cond);
 free (name);
 return 
# 506 "project/radare2/libr/debug/p/native/windows/windows_message.c" 3 4
       1
# 506 "project/radare2/libr/debug/p/native/windows/windows_message.c"
           ;
}
