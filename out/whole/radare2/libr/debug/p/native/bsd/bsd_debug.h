# 0 "project/radare2/libr/debug/p/native/bsd/bsd_debug.h"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 6 "project/radare2/libr/debug/p/native/bsd/bsd_debug.h" 2

#define R_DEBUG_REG_T struct reg


# 9 "project/radare2/libr/debug/p/native/bsd/bsd_debug.h"
int bsd_handle_signals(RDebug *dbg);
int bsd_reg_write(RDebug *dbg, int type, const 
# 10 "project/radare2/libr/debug/p/native/bsd/bsd_debug.h" 3 4
                                              unsigned char 
# 10 "project/radare2/libr/debug/p/native/bsd/bsd_debug.h"
                                                  *buf, int size);
