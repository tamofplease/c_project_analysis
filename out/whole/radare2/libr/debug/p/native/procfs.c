# 0 "project/radare2/libr/debug/p/native/procfs.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/debug/p/native/procfs.c"
...
# 4 "project/radare2/libr/debug/p/native/procfs.c" 2
...
# 5 "project/radare2/libr/debug/p/native/procfs.c" 2


# 6 "project/radare2/libr/debug/p/native/procfs.c"
int procfs_pid_slurp(int pid, char *prop, char *out, size_t len) {
 ...
 fd = r_sandbox_open (filename, 
# 14 "project/radare2/libr/debug/p/native/procfs.c" 3 4
                               0x0000
# 14 "project/radare2/libr/debug/p/native/procfs.c"
                                       , 0);
 if (fd == -1) {
  free (filename);
  return -1;
...
# 25 "project/radare2/libr/debug/p/native/procfs.c" 3 4
 r_sys_perror_str(
# 25 "project/radare2/libr/debug/p/native/procfs.c"
 "read"
# 25 "project/radare2/libr/debug/p/native/procfs.c" 3 4
 );
# 25 "project/radare2/libr/debug/p/native/procfs.c"
