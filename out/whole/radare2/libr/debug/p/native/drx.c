# 0 "project/radare2/libr/debug/p/native/drx.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 2 "project/radare2/libr/debug/p/native/drx.c" 2
...
# 80 "project/radare2/libr/debug/p/native/drx.c"
int drx_set(size_t *drx, int n, 
# 80 "project/radare2/libr/debug/p/native/drx.c" 3 4
                             unsigned long long 
# 80 "project/radare2/libr/debug/p/native/drx.c"
                                  addr, int len, int rwx, int global) {
 
# 81 "project/radare2/libr/debug/p/native/drx.c" 3 4
unsigned int 
# 81 "project/radare2/libr/debug/p/native/drx.c"
     control = drx[7];
 if (n < 0 || n >= 4) {
  
# 83 "project/radare2/libr/debug/p/native/drx.c" 3 4
 fprintf(__stderrp,
# 83 "project/radare2/libr/debug/p/native/drx.c"
 "Invalid DRX index (0-%d)\n", 4 - 1
# 83 "project/radare2/libr/debug/p/native/drx.c" 3 4
 )
# 83 "project/radare2/libr/debug/p/native/drx.c"
                                                     ;
  return 
# 84 "project/radare2/libr/debug/p/native/drx.c" 3 4
        0
# 84 "project/radare2/libr/debug/p/native/drx.c"
             ;
 }
 switch (rwx) {
 case 1: rwx = 0; break;
 ...
 case -1:
 {
  ...
  drx[n] = 0;
  return 
# 104 "project/radare2/libr/debug/p/native/drx.c" 3 4
        1
# 104 "project/radare2/libr/debug/p/native/drx.c"
            ;
 }
 default:
  
# 107 "project/radare2/libr/debug/p/native/drx.c" 3 4
 fprintf(__stderrp,
# 107 "project/radare2/libr/debug/p/native/drx.c"
...
# 107 "project/radare2/libr/debug/p/native/drx.c"
                                                                    ;
  return 
# 108 "project/radare2/libr/debug/p/native/drx.c" 3 4
        0
# 108 "project/radare2/libr/debug/p/native/drx.c"
             ;
 }
 do { control &= ~(0x0f << (16 + 4 * (n))); control |= ((len | rwx) << (16 + 4 * (n))); } while (0);
 if (global) {
  control |= (1 << (1 + 2 * (n)));
 ...
 return 
# 123 "project/radare2/libr/debug/p/native/drx.c" 3 4
       1
# 123 "project/radare2/libr/debug/p/native/drx.c"
           ;
}


# 126 "project/radare2/libr/debug/p/native/drx.c" 3 4
unsigned long long 
# 126 "project/radare2/libr/debug/p/native/drx.c"
    drx_get(size_t *drx, int n, int *rwx, int *len, int *global, int *enabled) {
 int ret = ((drx[7] >> (16 + 4 * (n))) & 0x0f);
 if (global) {
  *global = (drx[7] & (1 << (0 + 2 * (n))));
 }
 if (len) {
  switch (ret & 0xC) {
  case (0 << 2): *len = 1; break;
  case (1 << 2): *len = 2; break;
  case (3 << 2): *len = 4; break;
  case (2 << 2): *len = 8; break;
  default: *len = 0; break;
  }
 }
 if (enabled) {
 ...
 return (
# 146 "project/radare2/libr/debug/p/native/drx.c" 3 4
        unsigned long long
# 146 "project/radare2/libr/debug/p/native/drx.c"
            ) drx[n];
}

int drx_next(size_t *drx) {
 int i;
 for (i = 0; i < 4; i++) {
  if (!drx[i]) {
   return i;
...
int drx_get_at(size_t *drx, 
# 159 "project/radare2/libr/debug/p/native/drx.c" 3 4
                         unsigned long long 
# 159 "project/radare2/libr/debug/p/native/drx.c"
                              at_addr) {
 
# 160 "project/radare2/libr/debug/p/native/drx.c" 3 4
unsigned long long 
# 160 "project/radare2/libr/debug/p/native/drx.c"
     addr;
 int i, rwx, len, g, en;
...
void drx_list(size_t *drx) {
 
# 177 "project/radare2/libr/debug/p/native/drx.c" 3 4
unsigned long long 
# 177 "project/radare2/libr/debug/p/native/drx.c"
     addr;
 int i, rwx, len, g, en;
 for (i = 0; i < 8; i++) {
  if (i == 4 || i == 5) {
  ...
  rwx = len = g = en = 0;
  addr = drx_get (drx, i, &rwx, &len, &g, &en);
  printf ("%c dr%d %c%c 0x%08"
# 185 "project/radare2/libr/debug/p/native/drx.c" 3 4
                             "llx" 
# 185 "project/radare2/libr/debug/p/native/drx.c"
                                     " %d\n",
   en? '*': '-', i, g? 'G': 'L',
   (rwx == (0x3))? 'r':
   (rwx == (0x1))? 'w':
...
void drx_init(size_t *r) {
 
# 196 "project/radare2/libr/debug/p/native/drx.c" 3 4
__builtin___memset_chk (
# 196 "project/radare2/libr/debug/p/native/drx.c"
r
# 196 "project/radare2/libr/debug/p/native/drx.c" 3 4
, 
# 196 "project/radare2/libr/debug/p/native/drx.c"
...
void drx_enable(size_t *r, int n, int enabled) {
 if (enabled) {
  r[7] |= (3 << (2 * (n)));
 } else {
  r[7] &= ~(3 << (2 * (n)));
...
# 207 "project/radare2/libr/debug/p/native/drx.c" 3 4
_Bool 
# 207 "project/radare2/libr/debug/p/native/drx.c"
    drx_add(RDebug *dbg, RBreakpoint *bp, RBreakpointItem *b) {
 if (bp->nhwbps < 4) {
  r_debug_reg_sync (dbg, R_REG_TYPE_DRX, 
# 209 "project/radare2/libr/debug/p/native/drx.c" 3 4
                                        0
# 209 "project/radare2/libr/debug/p/native/drx.c"
                                             );
  r_debug_drx_set (dbg, bp->nhwbps, b->addr, b->size, b->perm, 0);
  r_debug_reg_sync (dbg, R_REG_TYPE_DRX, 
# 211 "project/radare2/libr/debug/p/native/drx.c" 3 4
                                        1
# 211 "project/radare2/libr/debug/p/native/drx.c"
                                            );
  bp->nhwbps++;
  return 
# 213 "project/radare2/libr/debug/p/native/drx.c" 3 4
        1
# 213 "project/radare2/libr/debug/p/native/drx.c"
            ;
 }
 return 
# 215 "project/radare2/libr/debug/p/native/drx.c" 3 4
       0
# 215 "project/radare2/libr/debug/p/native/drx.c"
            ;
}


# 218 "project/radare2/libr/debug/p/native/drx.c" 3 4
_Bool 
# 218 "project/radare2/libr/debug/p/native/drx.c"
    drx_del(RDebug *dbg, RBreakpoint *bp, RBreakpointItem *b) {
 if (bp->nhwbps > 0) {
  r_debug_reg_sync (dbg, R_REG_TYPE_DRX, 
# 220 "project/radare2/libr/debug/p/native/drx.c" 3 4
                                        0
# 220 "project/radare2/libr/debug/p/native/drx.c"
                                             );
  r_debug_drx_unset (dbg, bp->nhwbps - 1);
  r_debug_reg_sync (dbg, R_REG_TYPE_DRX, 
# 222 "project/radare2/libr/debug/p/native/drx.c" 3 4
                                        1
# 222 "project/radare2/libr/debug/p/native/drx.c"
                                            );
  bp->nhwbps--;
 }
 return 
# 225 "project/radare2/libr/debug/p/native/drx.c" 3 4
       1
# 225 "project/radare2/libr/debug/p/native/drx.c"
           ;
}
