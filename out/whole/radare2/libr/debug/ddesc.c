# 0 "project/radare2/libr/debug/ddesc.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/debug/ddesc.c"
...
# 4 "project/radare2/libr/debug/ddesc.c" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/debug/ddesc.c"
     RDebugDesc *r_debug_desc_new(int fd, const char* path, int perm, int type, int off) {
 RDebugDesc *desc = 
# 6 "project/radare2/libr/debug/ddesc.c" 3 4
                   (
# 6 "project/radare2/libr/debug/ddesc.c"
                   RDebugDesc
# 6 "project/radare2/libr/debug/ddesc.c" 3 4
                   *)malloc(sizeof(
# 6 "project/radare2/libr/debug/ddesc.c"
...
# 17 "project/radare2/libr/debug/ddesc.c" 3 4
__attribute__((visibility("default"))) 
# 17 "project/radare2/libr/debug/ddesc.c"
     void r_debug_desc_free(RDebugDesc *p) {
 if (p) {
  free (p->path);
  free (p);
 }
...
# 24 "project/radare2/libr/debug/ddesc.c" 3 4
__attribute__((visibility("default"))) 
# 24 "project/radare2/libr/debug/ddesc.c"
     int r_debug_desc_open(RDebug *dbg, const char *path) {
 
# 25 "project/radare2/libr/debug/ddesc.c" 3 4
do { if (!(
# 25 "project/radare2/libr/debug/ddesc.c"
dbg && dbg->h
# 25 "project/radare2/libr/debug/ddesc.c" 3 4
...
# 32 "project/radare2/libr/debug/ddesc.c" 3 4
__attribute__((visibility("default"))) 
# 32 "project/radare2/libr/debug/ddesc.c"
     int r_debug_desc_close(RDebug *dbg, int fd) {
 if (dbg && dbg->h && dbg->h->desc.close) {
  return dbg->h->desc.close (fd);
 }
 return 
# 36 "project/radare2/libr/debug/ddesc.c" 3 4
       0
# 36 "project/radare2/libr/debug/ddesc.c"
            ;
}


# 39 "project/radare2/libr/debug/ddesc.c" 3 4
__attribute__((visibility("default"))) 
# 39 "project/radare2/libr/debug/ddesc.c"
     int r_debug_desc_dup(RDebug *dbg, int fd, int newfd) {
 if (dbg && dbg->h && dbg->h->desc.dup) {
  return dbg->h->desc.dup (fd, newfd);
 }
 return 
# 43 "project/radare2/libr/debug/ddesc.c" 3 4
       0
# 43 "project/radare2/libr/debug/ddesc.c"
            ;
}


# 46 "project/radare2/libr/debug/ddesc.c" 3 4
__attribute__((visibility("default"))) 
# 46 "project/radare2/libr/debug/ddesc.c"
     int r_debug_desc_read(RDebug *dbg, int fd, 
# 46 "project/radare2/libr/debug/ddesc.c" 3 4
                                                unsigned long long 
# 46 "project/radare2/libr/debug/ddesc.c"
                                                     addr, int len) {
 ...
 return 
# 50 "project/radare2/libr/debug/ddesc.c" 3 4
       0
# 50 "project/radare2/libr/debug/ddesc.c"
            ;
}


# 53 "project/radare2/libr/debug/ddesc.c" 3 4
__attribute__((visibility("default"))) 
# 53 "project/radare2/libr/debug/ddesc.c"
     int r_debug_desc_seek(RDebug *dbg, int fd, 
# 53 "project/radare2/libr/debug/ddesc.c" 3 4
                                                unsigned long long 
# 53 "project/radare2/libr/debug/ddesc.c"
                                                     addr) {
 ...
 return 
# 57 "project/radare2/libr/debug/ddesc.c" 3 4
       0
# 57 "project/radare2/libr/debug/ddesc.c"
            ;
}


# 60 "project/radare2/libr/debug/ddesc.c" 3 4
__attribute__((visibility("default"))) 
# 60 "project/radare2/libr/debug/ddesc.c"
     int r_debug_desc_write(RDebug *dbg, int fd, 
# 60 "project/radare2/libr/debug/ddesc.c" 3 4
                                                 unsigned long long 
# 60 "project/radare2/libr/debug/ddesc.c"
                                                      addr, int len) {
 ...
 return 
# 64 "project/radare2/libr/debug/ddesc.c" 3 4
       0
# 64 "project/radare2/libr/debug/ddesc.c"
            ;
}


# 67 "project/radare2/libr/debug/ddesc.c" 3 4
__attribute__((visibility("default"))) 
# 67 "project/radare2/libr/debug/ddesc.c"
     int r_debug_desc_list(RDebug *dbg, int rad) {
 int count = 0;
...
# 79 "project/radare2/libr/debug/ddesc.c" 3 4
  if (
# 79 "project/radare2/libr/debug/ddesc.c"
  list
# 79 "project/radare2/libr/debug/ddesc.c" 3 4
  ) for (
# 79 "project/radare2/libr/debug/ddesc.c"
...
# 79 "project/radare2/libr/debug/ddesc.c"
                                 {
    dbg->cb_printf ("%i 0x%"
# 80 "project/radare2/libr/debug/ddesc.c" 3 4
                           "llx"
# 80 "project/radare2/libr/debug/ddesc.c"
                                  " %c%c%c %s\n", p->fd, p->off,
      (p->perm & 
# 81 "project/radare2/libr/debug/ddesc.c" 3 4
                4
# 81 "project/radare2/libr/debug/ddesc.c"
                        )?'r':'-',
      (p->perm & 
# 82 "project/radare2/libr/debug/ddesc.c" 3 4
                2
# 82 "project/radare2/libr/debug/ddesc.c"
                        )?'w':'-',
      p->type, p->path);
   }
   r_list_purge (list);
