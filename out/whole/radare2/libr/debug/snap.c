# 0 "project/radare2/libr/debug/snap.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/debug/snap.c"
...
# 4 "project/radare2/libr/debug/snap.c" 2


__attribute__((visibility("default"))) 
# 6 "project/radare2/libr/debug/snap.c"
     void r_debug_snap_free(RDebugSnap *snap) {
 if (snap) {
  free (snap->name);
  free (snap->data);
  
# 10 "project/radare2/libr/debug/snap.c" 3 4
 { free((void *)
# 10 "project/radare2/libr/debug/snap.c"
 snap
# 10 "project/radare2/libr/debug/snap.c" 3 4
 ); 
# 10 "project/radare2/libr/debug/snap.c"
...
# 14 "project/radare2/libr/debug/snap.c" 3 4
__attribute__((visibility("default"))) 
# 14 "project/radare2/libr/debug/snap.c"
     RDebugSnap *r_debug_snap_map(RDebug *dbg, RDebugMap *map) {
 
# 15 "project/radare2/libr/debug/snap.c" 3 4
do { if (!(
# 15 "project/radare2/libr/debug/snap.c"
dbg && map
# 15 "project/radare2/libr/debug/snap.c" 3 4
...
"dbg && map"
# 15 "project/radare2/libr/debug/snap.c" 3 4
, 15); return (((void *)0)); } } while (0)
# 15 "project/radare2/libr/debug/snap.c"
                                       ;
 if (map->size < 1) {
  
# 17 "project/radare2/libr/debug/snap.c" 3 4
 fprintf(__stderrp,
# 17 "project/radare2/libr/debug/snap.c"
 "Invalid map size\n"
# 17 "project/radare2/libr/debug/snap.c" 3 4
 )
# 17 "project/radare2/libr/debug/snap.c"
                               ;
  return 
# 18 "project/radare2/libr/debug/snap.c" 3 4
        ((void *)0)
# 18 "project/radare2/libr/debug/snap.c"
            ;
 }

 if (map->size > dbg->maxsnapsize) {
  char *us = r_num_units (
# 22 "project/radare2/libr/debug/snap.c" 3 4
                         ((void *)0)
# 22 "project/radare2/libr/debug/snap.c"
                             , 0, map->size);
  const char *name = r_str_get (map->name);
  
# 24 "project/radare2/libr/debug/snap.c" 3 4
 fprintf(__stderrp,
# 24 "project/radare2/libr/debug/snap.c"
 "Not snapping map %s (%s > dbg.maxsnapsize)\n", name, us
# 24 "project/radare2/libr/debug/snap.c" 3 4
 )
# 24 "project/radare2/libr/debug/snap.c"
                                                                   ;
  free (us);
  return 
# 26 "project/radare2/libr/debug/snap.c" 3 4
        ((void *)0)
# 26 "project/radare2/libr/debug/snap.c"
            ;
 }

 RDebugSnap *snap = 
# 29 "project/radare2/libr/debug/snap.c" 3 4
                   (
# 29 "project/radare2/libr/debug/snap.c"
                   RDebugSnap
# 29 "project/radare2/libr/debug/snap.c" 3 4
                   *)calloc(1,sizeof(
# 29 "project/radare2/libr/debug/snap.c"
...
# 29 "project/radare2/libr/debug/snap.c"
 ...
 if (!snap) {
  return 
# 31 "project/radare2/libr/debug/snap.c" 3 4
        ((void *)0)
# 31 "project/radare2/libr/debug/snap.c"
            ;
 }
 ...
 if (!snap->data) {
  ...
  return 
# 45 "project/radare2/libr/debug/snap.c" 3 4
        ((void *)0)
# 45 "project/radare2/libr/debug/snap.c"
            ;
 }
 
# 47 "project/radare2/libr/debug/snap.c" 3 4
fprintf(__stderrp,
# 47 "project/radare2/libr/debug/snap.c"
"Reading %d byte(s) from 0x%08"
# 47 "project/radare2/libr/debug/snap.c" 3 4
"llx" 
# 47 "project/radare2/libr/debug/snap.c"
"...\n", snap->size, snap->addr
...
# 53 "project/radare2/libr/debug/snap.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 53 "project/radare2/libr/debug/snap.c"
          r_debug_snap_contains(RDebugSnap *snap, 
# 53 "project/radare2/libr/debug/snap.c" 3 4
                                                  unsigned long long 
# 53 "project/radare2/libr/debug/snap.c"
                                                       addr) {
...
# 57 "project/radare2/libr/debug/snap.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 57 "project/radare2/libr/debug/snap.c"
         *r_debug_snap_get_hash(RDebugSnap *snap) {
 
# 58 "project/radare2/libr/debug/snap.c" 3 4
unsigned long long 
# 58 "project/radare2/libr/debug/snap.c"
     algobit = r_hash_name_to_bits ("sha256");
 
# 59 "project/radare2/libr/debug/snap.c" 3 4
struct r_hash_t 
# 59 "project/radare2/libr/debug/snap.c"
      *ctx = r_hash_new (
# 59 "project/radare2/libr/debug/snap.c" 3 4
                         1
# 59 "project/radare2/libr/debug/snap.c"
 ...
 if (!ctx) {
  return 
# 61 "project/radare2/libr/debug/snap.c" 3 4
        ((void *)0)
# 61 "project/radare2/libr/debug/snap.c"
            ;
 }
...
# 68 "project/radare2/libr/debug/snap.c" 3 4
unsigned char 
# 68 "project/radare2/libr/debug/snap.c"
    *ret = malloc (
# 68 "project/radare2/libr/debug/snap.c" 3 4
                   32
# 68 "project/radare2/libr/debug/snap.c"
 ...
 if (!ret) {
  r_hash_free (ctx);
  return 
# 71 "project/radare2/libr/debug/snap.c" 3 4
        ((void *)0)
# 71 "project/radare2/libr/debug/snap.c"
            ;
 }
 
# 73 "project/radare2/libr/debug/snap.c" 3 4
__builtin___memcpy_chk (
# 73 "project/radare2/libr/debug/snap.c"
ret
# 73 "project/radare2/libr/debug/snap.c" 3 4
, 
# 73 "project/radare2/libr/debug/snap.c"
...
# 79 "project/radare2/libr/debug/snap.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 79 "project/radare2/libr/debug/snap.c"
          r_debug_snap_is_equal(RDebugSnap *a, RDebugSnap *b) {
 
# 80 "project/radare2/libr/debug/snap.c" 3 4
_Bool 
# 80 "project/radare2/libr/debug/snap.c"
     ret = 
# 80 "project/radare2/libr/debug/snap.c" 3 4
           0
# 80 "project/radare2/libr/debug/snap.c"
...
# 81 "project/radare2/libr/debug/snap.c" 3 4
unsigned long long 
# 81 "project/radare2/libr/debug/snap.c"
     algobit = r_hash_name_to_bits ("sha256");
 
# 82 "project/radare2/libr/debug/snap.c" 3 4
struct r_hash_t 
# 82 "project/radare2/libr/debug/snap.c"
      *ctx = r_hash_new (
# 82 "project/radare2/libr/debug/snap.c" 3 4
                         1
# 82 "project/radare2/libr/debug/snap.c"
...
# 91 "project/radare2/libr/debug/snap.c" 3 4
unsigned char 
# 91 "project/radare2/libr/debug/snap.c"
    *temp = malloc (
# 91 "project/radare2/libr/debug/snap.c" 3 4
                    32
# 91 "project/radare2/libr/debug/snap.c"
...
# 96 "project/radare2/libr/debug/snap.c" 3 4
__builtin___memcpy_chk (
# 96 "project/radare2/libr/debug/snap.c"
temp
# 96 "project/radare2/libr/debug/snap.c" 3 4
, 
# 96 "project/radare2/libr/debug/snap.c"
...
# 96 "project/radare2/libr/debug/snap.c"
 ...
 ret = memcmp (temp, ctx->digest, 
# 102 "project/radare2/libr/debug/snap.c" 3 4
                                 32
# 102 "project/radare2/libr/debug/snap.c"
                                                   ) == 0;
 free (temp);
 r_hash_free (ctx);
 return ret;
