# 0 "project/radare2/libr/debug/plugin.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/debug/plugin.c"
...
# 4 "project/radare2/libr/debug/plugin.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/sdb/src/config.h" 1 3 4
# 5 "project/radare2/libr/debug/plugin.c" 2


# 6 "project/radare2/libr/debug/plugin.c"
static RDebugPlugin *debug_static_plugins[] = {
 R_DEBUG_STATIC_PLUGINS
};


# 10 "project/radare2/libr/debug/plugin.c" 3 4
__attribute__((visibility("default"))) 
# 10 "project/radare2/libr/debug/plugin.c"
     void r_debug_plugin_init(RDebug *dbg) {
 int i;
...
# 18 "project/radare2/libr/debug/plugin.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 18 "project/radare2/libr/debug/plugin.c"
          r_debug_use(RDebug *dbg, const char *str) {
 if (dbg && str) {
  RDebugPlugin *h;
  RListIter *iter;
  
# 22 "project/radare2/libr/debug/plugin.c" 3 4
 if (
# 22 "project/radare2/libr/debug/plugin.c"
 dbg->plugins
# 22 "project/radare2/libr/debug/plugin.c" 3 4
 ) for (
# 22 "project/radare2/libr/debug/plugin.c"
...
# 47 "project/radare2/libr/debug/plugin.c" 3 4
  fprintf(__stderrp,
# 47 "project/radare2/libr/debug/plugin.c"
  "Cannot retrieve reg profile from debug plugin (%s)\n", dbg->h->name
# 47 "project/radare2/libr/debug/plugin.c" 3 4
  )
# 47 "project/radare2/libr/debug/plugin.c"
                                                                                ;
...
# 53 "project/radare2/libr/debug/plugin.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 53 "project/radare2/libr/debug/plugin.c"
          r_debug_plugin_list(RDebug *dbg, int mode) {
 char spaces[16];
 int count = 0;
 
# 56 "project/radare2/libr/debug/plugin.c" 3 4
__builtin___memset_chk (
# 56 "project/radare2/libr/debug/plugin.c"
spaces
# 56 "project/radare2/libr/debug/plugin.c" 3 4
, 
# 56 "project/radare2/libr/debug/plugin.c"
...
# 56 "project/radare2/libr/debug/plugin.c"
 ...
 RListIter *iter;
 PJ *pj = 
# 60 "project/radare2/libr/debug/plugin.c" 3 4
         ((void *)0)
# 60 "project/radare2/libr/debug/plugin.c"
             ;
 if (mode == 'j') {
  pj = dbg->pj;
  if (!pj) {
   return 
# 64 "project/radare2/libr/debug/plugin.c" 3 4
         0
# 64 "project/radare2/libr/debug/plugin.c"
              ;
  }
  pj_a (pj);
 }
 
# 68 "project/radare2/libr/debug/plugin.c" 3 4
if (
# 68 "project/radare2/libr/debug/plugin.c"
dbg->plugins
# 68 "project/radare2/libr/debug/plugin.c" 3 4
) for (
# 68 "project/radare2/libr/debug/plugin.c"
...
# 68 "project/radare2/libr/debug/plugin.c"
 ...
 return 
# 90 "project/radare2/libr/debug/plugin.c" 3 4
       1
# 90 "project/radare2/libr/debug/plugin.c"
           ;
}


# 93 "project/radare2/libr/debug/plugin.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 93 "project/radare2/libr/debug/plugin.c"
          r_debug_plugin_add(RDebug *dbg, RDebugPlugin *foo) {
 if (!dbg || !foo || !foo->name) {
  return 
# 95 "project/radare2/libr/debug/plugin.c" 3 4
        0
# 95 "project/radare2/libr/debug/plugin.c"
             ;
 }
 RDebugPlugin *dp = 
# 97 "project/radare2/libr/debug/plugin.c" 3 4
                   (
# 97 "project/radare2/libr/debug/plugin.c"
                   RDebugPlugin
# 97 "project/radare2/libr/debug/plugin.c" 3 4
                   *)malloc(sizeof(
# 97 "project/radare2/libr/debug/plugin.c"
...
# 98 "project/radare2/libr/debug/plugin.c" 3 4
__builtin___memcpy_chk (
# 98 "project/radare2/libr/debug/plugin.c"
dp
# 98 "project/radare2/libr/debug/plugin.c" 3 4
, 
# 98 "project/radare2/libr/debug/plugin.c"
foo, sizeof (RDebugPlugin)
# 98 "project/radare2/libr/debug/plugin.c" 3 4
, __builtin_object_size (
# 98 "project/radare2/libr/debug/plugin.c"
dp
...
# 98 "project/radare2/libr/debug/plugin.c"
 ...
 return 
# 100 "project/radare2/libr/debug/plugin.c" 3 4
       1
# 100 "project/radare2/libr/debug/plugin.c"
           ;
}


# 103 "project/radare2/libr/debug/plugin.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 103 "project/radare2/libr/debug/plugin.c"
          r_debug_plugin_set_reg_profile(RDebug *dbg, const char *profile) {
 char *str = r_file_slurp (profile, 
# 104 "project/radare2/libr/debug/plugin.c" 3 4
                                   ((void *)0)
# 104 "project/radare2/libr/debug/plugin.c"
                                       );
 if (!str) {
  
# 106 "project/radare2/libr/debug/plugin.c" 3 4
 fprintf(__stderrp,
# 106 "project/radare2/libr/debug/plugin.c"
 "r_debug_plugin_set_reg_profile: Cannot find '%s'\n", profile
# 106 "project/radare2/libr/debug/plugin.c" 3 4
 )
# 106 "project/radare2/libr/debug/plugin.c"
                                                                        ;
  return 
# 107 "project/radare2/libr/debug/plugin.c" 3 4
        0
# 107 "project/radare2/libr/debug/plugin.c"
             ;
 }
 ...
 free (str);
 return 
# 113 "project/radare2/libr/debug/plugin.c" 3 4
       0
# 113 "project/radare2/libr/debug/plugin.c"
            ;
}
