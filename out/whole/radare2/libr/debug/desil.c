# 0 "project/radare2/libr/debug/desil.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/debug/desil.c"
...
# 4 "project/radare2/libr/debug/desil.c" 2
# 22 "project/radare2/libr/debug/desil.c"
...
RDebug *dbg = 
# 29 "project/radare2/libr/debug/desil.c" 3 4
             ((void *)0)
# 29 "project/radare2/libr/debug/desil.c"
                 ;
static 
# 30 "project/radare2/libr/debug/desil.c" 3 4
      _Bool 
# 30 "project/radare2/libr/debug/desil.c"
           has_match = 
# 30 "project/radare2/libr/debug/desil.c" 3 4
                       0
# 30 "project/radare2/libr/debug/desil.c"
...
static 
# 32 "project/radare2/libr/debug/desil.c" 3 4
      unsigned long long 
# 32 "project/radare2/libr/debug/desil.c"
           opc = 0;
RList *esil_watchpoints = 
# 33 "project/radare2/libr/debug/desil.c" 3 4
                         ((void *)0)
# 33 "project/radare2/libr/debug/desil.c"
                             ;
#define EWPS esil_watchpoints
#define ESIL dbg->anal->esil

static int exprmatch(RDebug *dbg, 
# 37 "project/radare2/libr/debug/desil.c" 3 4
                                 unsigned long long 
# 37 "project/radare2/libr/debug/desil.c"
                                      addr, const char *expr) {
 char *e = strdup (expr);
 if (!e) {
  return 0;
 }
...
# 43 "project/radare2/libr/debug/desil.c" 3 4
unsigned long long 
# 43 "project/radare2/libr/debug/desil.c"
     a,b;
 int ret = 0;
 if (p) {
  *p = 0;
...
static 
# 70 "project/radare2/libr/debug/desil.c" 3 4
      _Bool 
# 70 "project/radare2/libr/debug/desil.c"
           esilbreak_check_pc(RDebug *dbg, 
# 70 "project/radare2/libr/debug/desil.c" 3 4
                                           unsigned long long 
# 70 "project/radare2/libr/debug/desil.c"
                                                pc) {
...
# 76 "project/radare2/libr/debug/desil.c" 3 4
if (
# 76 "project/radare2/libr/debug/desil.c"
esil_watchpoints
# 76 "project/radare2/libr/debug/desil.c" 3 4
) for (
# 76 "project/radare2/libr/debug/desil.c"
...
# 76 "project/radare2/libr/debug/desil.c"
                                {
  if (ew->rwx & 
# 77 "project/radare2/libr/debug/desil.c" 3 4
               1
# 77 "project/radare2/libr/debug/desil.c"
                       ) {
   if (exprmatch (dbg, pc, ew->expr)) {
    return 
# 79 "project/radare2/libr/debug/desil.c" 3 4
          1
# 79 "project/radare2/libr/debug/desil.c"
              ;
   }
  }
 }
 return 
# 83 "project/radare2/libr/debug/desil.c" 3 4
       0
# 83 "project/radare2/libr/debug/desil.c"
            ;
}

static 
# 86 "project/radare2/libr/debug/desil.c" 3 4
      _Bool 
# 86 "project/radare2/libr/debug/desil.c"
           esilbreak_mem_read(RAnalEsil *esil, 
# 86 "project/radare2/libr/debug/desil.c" 3 4
                                               unsigned long long 
# 86 "project/radare2/libr/debug/desil.c"
                                                    addr, 
...
# 89 "project/radare2/libr/debug/desil.c" 3 4
fprintf(__stderrp,"\x1b[32m"
# 89 "project/radare2/libr/debug/desil.c"
"MEM READ 0x%"
# 89 "project/radare2/libr/debug/desil.c" 3 4
"llx"
# 89 "project/radare2/libr/debug/desil.c"
...
# 90 "project/radare2/libr/debug/desil.c" 3 4
if (
# 90 "project/radare2/libr/debug/desil.c"
esil_watchpoints
# 90 "project/radare2/libr/debug/desil.c" 3 4
) for (
# 90 "project/radare2/libr/debug/desil.c"
...
# 90 "project/radare2/libr/debug/desil.c"
                                {
  if (ew->rwx & 
# 91 "project/radare2/libr/debug/desil.c" 3 4
               4 
# 91 "project/radare2/libr/debug/desil.c"
                        && ew->dev == 'm') {
   if (exprmatch (dbg, addr, ew->expr)) {
    has_match = 
# 93 "project/radare2/libr/debug/desil.c" 3 4
               1
# 93 "project/radare2/libr/debug/desil.c"
                   ;
    return 
# 94 "project/radare2/libr/debug/desil.c" 3 4
          1
# 94 "project/radare2/libr/debug/desil.c"
              ;
   }
  }
 }
 return 
# 98 "project/radare2/libr/debug/desil.c" 3 4
       0
# 98 "project/radare2/libr/debug/desil.c"
            ;
}

static 
# 101 "project/radare2/libr/debug/desil.c" 3 4
      _Bool 
# 101 "project/radare2/libr/debug/desil.c"
           esilbreak_mem_write(RAnalEsil *esil, 
# 101 "project/radare2/libr/debug/desil.c" 3 4
                                                unsigned long long 
# 101 "project/radare2/libr/debug/desil.c"
                                                     addr, const 
...
# 104 "project/radare2/libr/debug/desil.c" 3 4
fprintf(__stderrp,"\x1b[31m"
# 104 "project/radare2/libr/debug/desil.c"
"MEM WRTE 0x%"
# 104 "project/radare2/libr/debug/desil.c" 3 4
"llx"
# 104 "project/radare2/libr/debug/desil.c"
...
# 105 "project/radare2/libr/debug/desil.c" 3 4
if (
# 105 "project/radare2/libr/debug/desil.c"
esil_watchpoints
# 105 "project/radare2/libr/debug/desil.c" 3 4
) for (
# 105 "project/radare2/libr/debug/desil.c"
...
# 105 "project/radare2/libr/debug/desil.c"
                                {
  if (ew->rwx & 
# 106 "project/radare2/libr/debug/desil.c" 3 4
               2 
# 106 "project/radare2/libr/debug/desil.c"
                        && ew->dev == 'm') {
   if (exprmatch (dbg, addr, ew->expr)) {
    has_match = 
# 108 "project/radare2/libr/debug/desil.c" 3 4
               1
# 108 "project/radare2/libr/debug/desil.c"
                   ;
    return 
# 109 "project/radare2/libr/debug/desil.c" 3 4
          1
# 109 "project/radare2/libr/debug/desil.c"
              ;
   }
  }
 }
 return 
# 113 "project/radare2/libr/debug/desil.c" 3 4
       0
# 113 "project/radare2/libr/debug/desil.c"
            ;
}

static 
# 116 "project/radare2/libr/debug/desil.c" 3 4
      _Bool 
# 116 "project/radare2/libr/debug/desil.c"
           esilbreak_reg_read(RAnalEsil *esil, const char *regname, 
# 116 "project/radare2/libr/debug/desil.c" 3 4
                                                                    unsigned long long 
# 116 "project/radare2/libr/debug/desil.c"
                                                                         *num, int *size) {
 ...
 if (regname[0]>='0' && regname[0]<='9') {
  ...
  return 
# 121 "project/radare2/libr/debug/desil.c" 3 4
        0
# 121 "project/radare2/libr/debug/desil.c"
             ;
 }
 
# 123 "project/radare2/libr/debug/desil.c" 3 4
fprintf(__stderrp,"\x1b[33m"
# 123 "project/radare2/libr/debug/desil.c"
"REG READ %s\n"
# 123 "project/radare2/libr/debug/desil.c" 3 4
"\x1b[0m"
# 123 "project/radare2/libr/debug/desil.c"
...
# 124 "project/radare2/libr/debug/desil.c" 3 4
if (
# 124 "project/radare2/libr/debug/desil.c"
esil_watchpoints
# 124 "project/radare2/libr/debug/desil.c" 3 4
) for (
# 124 "project/radare2/libr/debug/desil.c"
...
# 124 "project/radare2/libr/debug/desil.c"
                                {
  if (ew->rwx & 
# 125 "project/radare2/libr/debug/desil.c" 3 4
               4 
# 125 "project/radare2/libr/debug/desil.c"
                        && ew->dev == 'r') {

   if (!strcmp (regname, ew->expr)) {
    has_match = 
# 128 "project/radare2/libr/debug/desil.c" 3 4
               1
# 128 "project/radare2/libr/debug/desil.c"
                   ;
    return 
# 129 "project/radare2/libr/debug/desil.c" 3 4
          1
# 129 "project/radare2/libr/debug/desil.c"
              ;
   }
  }
 }
 return 
# 133 "project/radare2/libr/debug/desil.c" 3 4
       0
# 133 "project/radare2/libr/debug/desil.c"
            ;
}
 ...
 *o = 
# 144 "project/radare2/libr/debug/desil.c" 3 4
     ((void *)0)
# 144 "project/radare2/libr/debug/desil.c"
         ;
 return 0;
}
...
# 159 "project/radare2/libr/debug/desil.c" 3 4
 unsigned long long 
# 159 "project/radare2/libr/debug/desil.c"
      regval = r_debug_reg_get_err (dbg, regname, 
# 159 "project/radare2/libr/debug/desil.c" 3 4
                                                  ((void *)0)
# 159 "project/radare2/libr/debug/desil.c"
                                                      , 
...
# 159 "project/radare2/libr/debug/desil.c"
  ...
  if (exprtoken (dbg, s, ">=", &p)) {
   if (0){}r_str_trim (s);if (!strcmp(regname,s) && regval >= r_num_math (dbg->num, p))
    ret = 1;
...
# 178 "project/radare2/libr/debug/desil.c" 3 4
   unsigned long long 
# 178 "project/radare2/libr/debug/desil.c"
        num = r_num_math (dbg->num, p);
...
static 
# 191 "project/radare2/libr/debug/desil.c" 3 4
      _Bool 
# 191 "project/radare2/libr/debug/desil.c"
           esilbreak_reg_write(RAnalEsil *esil, const char *regname, 
# 191 "project/radare2/libr/debug/desil.c" 3 4
                                                                     unsigned long long 
# 191 "project/radare2/libr/debug/desil.c"
                                                                          *num) {
 ...
 if (regname[0] >= '0' && regname[0] <= '9') {
  ...
  return 
# 197 "project/radare2/libr/debug/desil.c" 3 4
        0
# 197 "project/radare2/libr/debug/desil.c"
             ;
 }
 
# 199 "project/radare2/libr/debug/desil.c" 3 4
fprintf(__stderrp,"\x1b[35m"
# 199 "project/radare2/libr/debug/desil.c"
"REG WRTE %s 0x%"
# 199 "project/radare2/libr/debug/desil.c" 3 4
"llx"
# 199 "project/radare2/libr/debug/desil.c"
...
# 200 "project/radare2/libr/debug/desil.c" 3 4
if (
# 200 "project/radare2/libr/debug/desil.c"
esil_watchpoints
# 200 "project/radare2/libr/debug/desil.c" 3 4
) for (
# 200 "project/radare2/libr/debug/desil.c"
...
# 200 "project/radare2/libr/debug/desil.c"
                                {
  if ((ew->rwx & 
# 201 "project/radare2/libr/debug/desil.c" 3 4
                2
# 201 "project/radare2/libr/debug/desil.c"
                        ) && (ew->dev == 'r')) {

   if (exprmatchreg (dbg, regname, ew->expr)) {
    has_match = 
# 204 "project/radare2/libr/debug/desil.c" 3 4
               1
# 204 "project/radare2/libr/debug/desil.c"
                   ;
    return 
# 205 "project/radare2/libr/debug/desil.c" 3 4
          1
# 205 "project/radare2/libr/debug/desil.c"
              ;
   }
  }
 }
 return 
# 209 "project/radare2/libr/debug/desil.c" 3 4
       1
# 209 "project/radare2/libr/debug/desil.c"
           ;
}


# 212 "project/radare2/libr/debug/desil.c" 3 4
__attribute__((visibility("default"))) 
# 212 "project/radare2/libr/debug/desil.c"
     void r_debug_esil_prestep(RDebug *d, int p) {
 prestep = p;
}


# 216 "project/radare2/libr/debug/desil.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 216 "project/radare2/libr/debug/desil.c"
          r_debug_esil_stepi(RDebug *d) {
 
# 217 "project/radare2/libr/debug/desil.c" 3 4
do { if (!(
# 217 "project/radare2/libr/debug/desil.c"
d
# 217 "project/radare2/libr/debug/desil.c" 3 4
...
"d"
# 217 "project/radare2/libr/debug/desil.c" 3 4
, 217); return (0); } } while (0)
# 217 "project/radare2/libr/debug/desil.c"
                               ;
 RAnalOp op;
 
# 219 "project/radare2/libr/debug/desil.c" 3 4
unsigned char 
# 219 "project/radare2/libr/debug/desil.c"
    obuf[64];
 int ret = 1;
 dbg = d;
 if (!dbg->anal->esil) {
  dbg->anal->esil = r_anal_esil_new (32, 
# 223 "project/radare2/libr/debug/desil.c" 3 4
                             1
# 223 "project/radare2/libr/debug/desil.c"
                                 , 64);

  if (!dbg->anal->esil) {
   return 
# 226 "project/radare2/libr/debug/desil.c" 3 4
         0
# 226 "project/radare2/libr/debug/desil.c"
              ;
  }
 }

 r_debug_reg_sync (dbg, R_REG_TYPE_GPR, 
# 230 "project/radare2/libr/debug/desil.c" 3 4
                                       0
# 230 "project/radare2/libr/debug/desil.c"
                                            );
 ...
 dbg->anal->esil->cb.hook_mem_read = &esilbreak_mem_read;
 dbg->anal->esil->cb.hook_mem_write = &esilbreak_mem_write;
 dbg->anal->esil->cb.hook_reg_read = &esilbreak_reg_read;
 dbg->anal->esil->cb.hook_reg_write = &esilbreak_reg_write;
...
# 246 "project/radare2/libr/debug/desil.c" 3 4
  fprintf(__stderrp,
# 246 "project/radare2/libr/debug/desil.c"
  "Step failed\n"
# 246 "project/radare2/libr/debug/desil.c" 3 4
  )
# 246 "project/radare2/libr/debug/desil.c"
                           ;
   return 
# 247 "project/radare2/libr/debug/desil.c" 3 4
         0
# 247 "project/radare2/libr/debug/desil.c"
              ;
  }
  r_debug_reg_sync (dbg, R_REG_TYPE_GPR, 
# 249 "project/radare2/libr/debug/desil.c" 3 4
                                        0
# 249 "project/radare2/libr/debug/desil.c"
                                             );
...
# 255 "project/radare2/libr/debug/desil.c" 3 4
  fprintf(__stderrp,
# 255 "project/radare2/libr/debug/desil.c"
  "STOP AT 0x%08"
# 255 "project/radare2/libr/debug/desil.c" 3 4
  "llx"
# 255 "project/radare2/libr/debug/desil.c"
...
# 255 "project/radare2/libr/debug/desil.c"
   ...
   r_anal_esil_set_pc (dbg->anal->esil, opc);
   
# 259 "project/radare2/libr/debug/desil.c" 3 4
  fprintf(__stderrp,
# 259 "project/radare2/libr/debug/desil.c"
  "0x%08"
# 259 "project/radare2/libr/debug/desil.c" 3 4
  "llx"
# 259 "project/radare2/libr/debug/desil.c"
...
# 259 "project/radare2/libr/debug/desil.c"
                                                                    ;
   (void)r_anal_esil_parse (dbg->anal->esil, 
# 260 "project/radare2/libr/debug/desil.c" 3 4
                                 (r_strbuf_get (
# 260 "project/radare2/libr/debug/desil.c"
                                 &op.esil
# 260 "project/radare2/libr/debug/desil.c" 3 4
                                 ) ? r_strbuf_get (
# 260 "project/radare2/libr/debug/desil.c"
...
# 260 "project/radare2/libr/debug/desil.c"
   ...
   r_anal_esil_stack_free (dbg->anal->esil);
   ret = 1;
  }
 }
 if (!prestep) {
...
# 269 "project/radare2/libr/debug/desil.c" 3 4
   fprintf(__stderrp,
# 269 "project/radare2/libr/debug/desil.c"
   "Step failed\n"
# 269 "project/radare2/libr/debug/desil.c" 3 4
   )
# 269 "project/radare2/libr/debug/desil.c"
   ...
   r_debug_reg_sync (dbg, R_REG_TYPE_GPR, 
# 272 "project/radare2/libr/debug/desil.c" 3 4
                                         0
# 272 "project/radare2/libr/debug/desil.c"
                                              );
...
# 279 "project/radare2/libr/debug/desil.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 279 "project/radare2/libr/debug/desil.c"
          r_debug_esil_step(RDebug *dbg, 
# 279 "project/radare2/libr/debug/desil.c" 3 4
                                         unsigned int 
# 279 "project/radare2/libr/debug/desil.c"
                                              count) {
 count++;
 has_match = 
# 281 "project/radare2/libr/debug/desil.c" 3 4
            0
# 281 "project/radare2/libr/debug/desil.c"
                 ;
 r_cons_break_push (
# 282 "project/radare2/libr/debug/desil.c" 3 4
                   ((void *)0)
# 282 "project/radare2/libr/debug/desil.c"
                       , 
# 282 "project/radare2/libr/debug/desil.c" 3 4
                         ((void *)0)
# 282 "project/radare2/libr/debug/desil.c"
...
# 288 "project/radare2/libr/debug/desil.c" 3 4
  fprintf(__stderrp,
# 288 "project/radare2/libr/debug/desil.c"
  "EsilBreak match at 0x%08"
# 288 "project/radare2/libr/debug/desil.c" 3 4
  "llx"
# 288 "project/radare2/libr/debug/desil.c"
  "\n", opc
...
# 303 "project/radare2/libr/debug/desil.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 303 "project/radare2/libr/debug/desil.c"
          r_debug_esil_continue (RDebug *dbg) {
 return r_debug_esil_step (dbg, 
# 304 "project/radare2/libr/debug/desil.c" 3 4
                               0xFFFFFFFFU
# 304 "project/radare2/libr/debug/desil.c"
                                       );
}

static void ewps_free(EsilBreak *ew) {
 
# 308 "project/radare2/libr/debug/desil.c" 3 4
{ free((void *)
# 308 "project/radare2/libr/debug/desil.c"
ew->expr
# 308 "project/radare2/libr/debug/desil.c" 3 4
); 
# 308 "project/radare2/libr/debug/desil.c"
...
# 312 "project/radare2/libr/debug/desil.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 312 "project/radare2/libr/debug/desil.c"
          r_debug_esil_watch_empty(RDebug *dbg) {
 return 
# 313 "project/radare2/libr/debug/desil.c" 3 4
       (!(
# 313 "project/radare2/libr/debug/desil.c"
       esil_watchpoints
# 313 "project/radare2/libr/debug/desil.c" 3 4
       ) || !(
# 313 "project/radare2/libr/debug/desil.c"
...
# 316 "project/radare2/libr/debug/desil.c" 3 4
__attribute__((visibility("default"))) 
# 316 "project/radare2/libr/debug/desil.c"
     void r_debug_esil_watch(RDebug *dbg, int rwx, int dev, const char *expr) {
 if (!esil_watchpoints) {
  esil_watchpoints = r_list_new ();
  if (!esil_watchpoints) {
   return;
  }
  esil_watchpoints->free = (RListFree)ewps_free;
 }
 EsilBreak *ew = 
# 324 "project/radare2/libr/debug/desil.c" 3 4
                (
# 324 "project/radare2/libr/debug/desil.c"
                EsilBreak
# 324 "project/radare2/libr/debug/desil.c" 3 4
                *)calloc(1,sizeof(
# 324 "project/radare2/libr/debug/desil.c"
...
# 326 "project/radare2/libr/debug/desil.c" 3 4
 { free((void *)
# 326 "project/radare2/libr/debug/desil.c"
 esil_watchpoints
# 326 "project/radare2/libr/debug/desil.c" 3 4
 ); 
# 326 "project/radare2/libr/debug/desil.c"
...
# 326 "project/radare2/libr/debug/desil.c"
 ...
 ew->dev = dev;
 ew->expr = strdup (expr);
 r_list_append (esil_watchpoints, ew);
}


# 335 "project/radare2/libr/debug/desil.c" 3 4
__attribute__((visibility("default"))) 
# 335 "project/radare2/libr/debug/desil.c"
     void r_debug_esil_watch_reset(RDebug *dbg) {
 r_list_free (esil_watchpoints);
 esil_watchpoints = 
# 337 "project/radare2/libr/debug/desil.c" 3 4
       ((void *)0)
# 337 "project/radare2/libr/debug/desil.c"
           ;
}


# 340 "project/radare2/libr/debug/desil.c" 3 4
__attribute__((visibility("default"))) 
# 340 "project/radare2/libr/debug/desil.c"
     void r_debug_esil_watch_list(RDebug *dbg) {
 EsilBreak *ew;
 RListIter *iter;
 
# 343 "project/radare2/libr/debug/desil.c" 3 4
if (
# 343 "project/radare2/libr/debug/desil.c"
esil_watchpoints
# 343 "project/radare2/libr/debug/desil.c" 3 4
) for (
# 343 "project/radare2/libr/debug/desil.c"
