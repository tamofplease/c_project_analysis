# 0 "project/radare2/libr/magic/is_tar.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 41 "project/radare2/libr/magic/is_tar.c" 2
...
# 45 "project/radare2/libr/magic/is_tar.c" 2



# 1 "project/radare2/libr/magic/tar.h" 1
...
# 49 "project/radare2/libr/magic/is_tar.c" 2
...
static int from_oct(int digs, const char *where) {
 int value = 0;
 while (isspace ((
# 64 "project/radare2/libr/magic/is_tar.c" 3 4
                 unsigned char
# 64 "project/radare2/libr/magic/is_tar.c"
                    )*where)) {
  where++;
  if (--digs <= 0) {
   return -1;
 ...
 if (digs > 0 && *where && !isspace ((
# 74 "project/radare2/libr/magic/is_tar.c" 3 4
                                     unsigned char
# 74 "project/radare2/libr/magic/is_tar.c"
                                        )*where)) {
  return -1;
 }
 return value;
...
static int is_tar(const 
# 87 "project/radare2/libr/magic/is_tar.c" 3 4
                       unsigned char 
# 87 "project/radare2/libr/magic/is_tar.c"
                           *buf, size_t nbytes) {
...
int file_is_tar(RMagic *ms, const 
# 125 "project/radare2/libr/magic/is_tar.c" 3 4
                                 unsigned char 
# 125 "project/radare2/libr/magic/is_tar.c"
                                     *buf, size_t nbytes) {
 ...
 int mime = ms->flags & 
# 131 "project/radare2/libr/magic/is_tar.c" 3 4
                       (0x000010|0x000400)
# 131 "project/radare2/libr/magic/is_tar.c"
                                   ;
 ...
 if (mime == 
# 136 "project/radare2/libr/magic/is_tar.c" 3 4
            0x000400
# 136 "project/radare2/libr/magic/is_tar.c"
                                 ) {
  return 0;
 }
