# 0 "project/radare2/libr/util/bdiff.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 15 "project/radare2/libr/util/bdiff.c" 2


# 1 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include-fixed/limits.h" 1 3 4
# 18 "project/radare2/libr/util/bdiff.c" 2


# 19 "project/radare2/libr/util/bdiff.c"
struct line {
 int h, len, n, e;
 const char *l;
};
...
# 43 "project/radare2/libr/util/bdiff.c" 3 4
 fprintf(__stderrp,
# 43 "project/radare2/libr/util/bdiff.c"
...
static int equatelines(struct line *a, int an, struct line *b, int bn) {
 ...
 struct pos *h = 
# 90 "project/radare2/libr/util/bdiff.c" 3 4
                ((void *)0)
# 90 "project/radare2/libr/util/bdiff.c"
                    ;
 ...
 for (i = bn - 1; i >= 0; i--) {
  ...
  for (j = b[i].h & buckets; h[j].pos != 0x7fffffff;
   j = (j + 1) & buckets) {
 ...
 for (i = 0; i < an; i++) {
  ...
  for (j = a[i].h & buckets; h[j].pos != 0x7fffffff;
   j = (j + 1) & buckets) {
...
# 289 "project/radare2/libr/util/bdiff.c" 3 4
__attribute__((visibility("default"))) 
# 289 "project/radare2/libr/util/bdiff.c"
     int r_diff_buffers_delta(RDiff *d, const 
# 289 "project/radare2/libr/util/bdiff.c" 3 4
                                              unsigned char 
# 289 "project/radare2/libr/util/bdiff.c"
                                                  *sa, int la, const 
...
# 289 "project/radare2/libr/util/bdiff.c"
 ...
 RDiffOp dop;
 struct line *al = 
# 291 "project/radare2/libr/util/bdiff.c" 3 4
                  ((void *)0)
# 291 "project/radare2/libr/util/bdiff.c"
                      ;
 struct line *bl = 
# 292 "project/radare2/libr/util/bdiff.c" 3 4
                  ((void *)0)
# 292 "project/radare2/libr/util/bdiff.c"
                      ;
 struct hunklist l = { 
# 293 "project/radare2/libr/util/bdiff.c" 3 4
                      ((void *)0)
# 293 "project/radare2/libr/util/bdiff.c"
                          , 
# 293 "project/radare2/libr/util/bdiff.c" 3 4
                            ((void *)0) 
# 293 "project/radare2/libr/util/bdiff.c"
...
# 310 "project/radare2/libr/util/bdiff.c" 3 4
 fprintf(__stderrp,
# 310 "project/radare2/libr/util/bdiff.c"
 "bindiff_buffers: Out of memory.\n"
# 310 "project/radare2/libr/util/bdiff.c" 3 4
 )
# 310 "project/radare2/libr/util/bdiff.c"
                                              ;
...
# 316 "project/radare2/libr/util/bdiff.c" 3 4
 fprintf(__stderrp,
# 316 "project/radare2/libr/util/bdiff.c"
 "bindiff_buffers: Out of memory.\n"
# 316 "project/radare2/libr/util/bdiff.c" 3 4
 )
# 316 "project/radare2/libr/util/bdiff.c"
 ...
 for (h = l.base; h != l.head; h++) {
  if (h->a1 != la || h->b1 != lb) {
   ...
   if (d->callback) {
    ...
    dop.a_off = offa;
    dop.a_buf = (
# 331 "project/radare2/libr/util/bdiff.c" 3 4
                unsigned char 
# 331 "project/radare2/libr/util/bdiff.c"
                    *)al[la].l;
    dop.a_len = rlen;
    ...
    dop.b_off = offa;
    dop.b_buf = (
# 336 "project/radare2/libr/util/bdiff.c" 3 4
                unsigned char 
# 336 "project/radare2/libr/util/bdiff.c"
                    *)bl[lb].l;
    dop.b_len = len;
...
# 354 "project/radare2/libr/util/bdiff.c"
  }
  la = h->a2;
  lb = h->b2;
 }
