# 0 "project/radare2/libr/util/hex.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/hex.c"
...
# 4 "project/radare2/libr/util/hex.c" 2
...
# 5 "project/radare2/libr/util/hex.c" 2




__attribute__((visibility("default"))) _Bool 
# 9 "project/radare2/libr/util/hex.c"
          r_hex_to_byte(
# 9 "project/radare2/libr/util/hex.c" 3 4
                        unsigned char 
# 9 "project/radare2/libr/util/hex.c"
                            *val, 
# 9 "project/radare2/libr/util/hex.c" 3 4
...
# 9 "project/radare2/libr/util/hex.c"
                                      c) {
 if (
# 10 "project/radare2/libr/util/hex.c" 3 4
    ((
# 10 "project/radare2/libr/util/hex.c"
    c
# 10 "project/radare2/libr/util/hex.c" 3 4
    ) >= '0' && (
# 10 "project/radare2/libr/util/hex.c"
...
# 10 "project/radare2/libr/util/hex.c"
  ...
  *val = (
# 11 "project/radare2/libr/util/hex.c" 3 4
         unsigned char
# 11 "project/radare2/libr/util/hex.c"
            )(*val) * 16 + (c - '0');
 } else if (c >= 'A' && c <= 'F') {
  *val = (
# 13 "project/radare2/libr/util/hex.c" 3 4
         unsigned char
# 13 "project/radare2/libr/util/hex.c"
            )(*val) * 16 + (c - 'A' + 10);
 } else if (c >= 'a' && c <= 'f') {
  *val = (
# 15 "project/radare2/libr/util/hex.c" 3 4
         unsigned char
# 15 "project/radare2/libr/util/hex.c"
            )(*val) * 16 + (c - 'a' + 10);
 } else {
  return 
# 17 "project/radare2/libr/util/hex.c" 3 4
        1
# 17 "project/radare2/libr/util/hex.c"
            ;
 }
 return 
# 19 "project/radare2/libr/util/hex.c" 3 4
       0
# 19 "project/radare2/libr/util/hex.c"
            ;
}


# 22 "project/radare2/libr/util/hex.c" 3 4
__attribute__((visibility("default"))) 
# 22 "project/radare2/libr/util/hex.c"
     char *r_hex_from_py_str(char *out, const char *code) {
 if (!strncmp (code, "'''", 3)) {
  const char *s = code + 2;
...
# 41 "project/radare2/libr/util/hex.c" 3 4
__attribute__((visibility("default"))) 
# 41 "project/radare2/libr/util/hex.c"
     char *r_hex_from_py_array(char *out, const char *code) {
 const char abc[] = "0123456789abcdef";
 if (*code != '[' || !strchr (code, ']')) {
  return 
# 44 "project/radare2/libr/util/hex.c" 3 4
        ((void *)0)
# 44 "project/radare2/libr/util/hex.c"
            ;
 }
 code++;
 for (; *code; code++) {
  ...
  if (
# 61 "project/radare2/libr/util/hex.c" 3 4
     ((
# 61 "project/radare2/libr/util/hex.c"
     *word
# 61 "project/radare2/libr/util/hex.c" 3 4
     ) >= '0' && (
# 61 "project/radare2/libr/util/hex.c"
...
# 62 "project/radare2/libr/util/hex.c" 3 4
  unsigned char 
# 62 "project/radare2/libr/util/hex.c"
      n = (
# 62 "project/radare2/libr/util/hex.c" 3 4
           unsigned char
# 62 "project/radare2/libr/util/hex.c"
...
# 75 "project/radare2/libr/util/hex.c" 3 4
__attribute__((visibility("default"))) 
# 75 "project/radare2/libr/util/hex.c"
     char* r_hex_from_py(const char *code) {
 if (!code) {
  return 
# 77 "project/radare2/libr/util/hex.c" 3 4
        ((void *)0)
# 77 "project/radare2/libr/util/hex.c"
            ;
 }
 char * const ret = malloc (strlen (code) * 3);
 if (!ret) {
  return 
# 81 "project/radare2/libr/util/hex.c" 3 4
        ((void *)0)
# 81 "project/radare2/libr/util/hex.c"
            ;
 }
 *ret = '\0';
 char *out = ret;
 ...
 if (!out) {
  free (ret);
  return 
# 100 "project/radare2/libr/util/hex.c" 3 4
        ((void *)0)
# 100 "project/radare2/libr/util/hex.c"
            ;
 }
 *out = '\0';
 return ret;
...
# 106 "project/radare2/libr/util/hex.c" 3 4
__attribute__((visibility("default"))) 
# 106 "project/radare2/libr/util/hex.c"
     char *r_hex_from_c_str(char *out, const char **code) {
 const char abc[] = "0123456789abcdefABCDEF";
 const char *iter = *code;
 if (*iter != '\'' && *iter != '"') {
  return 
# 110 "project/radare2/libr/util/hex.c" 3 4
        ((void *)0)
# 110 "project/radare2/libr/util/hex.c"
            ;
 }
...
# 122 "project/radare2/libr/util/hex.c" 3 4
   unsigned char 
# 122 "project/radare2/libr/util/hex.c"
       c1 = iter[1];
    
# 123 "project/radare2/libr/util/hex.c" 3 4
   unsigned char 
# 123 "project/radare2/libr/util/hex.c"
       c2 = iter[2];
    iter += 2;
    if (c1 == '\0' || c2 == '\0') {
     return 
# 126 "project/radare2/libr/util/hex.c" 3 4
           ((void *)0)
# 126 "project/radare2/libr/util/hex.c"
               ;
     ...
     *out++ = tolower (c2);
     ...
     return 
# 131 "project/radare2/libr/util/hex.c" 3 4
           ((void *)0)
# 131 "project/radare2/libr/util/hex.c"
               ;
    }
    break;
     }
   default:
    ...
    return 
# 140 "project/radare2/libr/util/hex.c" 3 4
          ((void *)0)
# 140 "project/radare2/libr/util/hex.c"
              ;
   }
  } else {
   *out++ = abc[*iter >> 4];
...
# 157 "project/radare2/libr/util/hex.c" 3 4
  fprintf(__stderrp,
# 157 "project/radare2/libr/util/hex.c"
...
# 168 "project/radare2/libr/util/hex.c" 3 4
__attribute__((visibility("default"))) 
# 168 "project/radare2/libr/util/hex.c"
     char *r_hex_from_c_array(char *out, const char *code) {
 const char abc[] = "0123456789abcdef";
 if (*code != '{' || !strchr(code, '}')) {
  return 
# 171 "project/radare2/libr/util/hex.c" 3 4
        ((void *)0)
# 171 "project/radare2/libr/util/hex.c"
            ;
 }
 code++;
 for (; *code; code++) {
  ...
  if (
# 186 "project/radare2/libr/util/hex.c" 3 4
     ((
# 186 "project/radare2/libr/util/hex.c"
     *word
# 186 "project/radare2/libr/util/hex.c" 3 4
     ) >= '0' && (
# 186 "project/radare2/libr/util/hex.c"
...
# 187 "project/radare2/libr/util/hex.c" 3 4
  unsigned char 
# 187 "project/radare2/libr/util/hex.c"
      n = (
# 187 "project/radare2/libr/util/hex.c" 3 4
           unsigned char
# 187 "project/radare2/libr/util/hex.c"
...
# 205 "project/radare2/libr/util/hex.c" 3 4
__attribute__((visibility("default"))) 
# 205 "project/radare2/libr/util/hex.c"
     char *r_hex_from_c(const char *code) {
 if (!code) {
  return 
# 207 "project/radare2/libr/util/hex.c" 3 4
        ((void *)0)
# 207 "project/radare2/libr/util/hex.c"
            ;
 }
 char * const ret = malloc (strlen (code) * 3);
 if (!ret) {
  return 
# 211 "project/radare2/libr/util/hex.c" 3 4
        ((void *)0)
# 211 "project/radare2/libr/util/hex.c"
            ;
 }
 *ret = '\0';
 char *out = ret;
 ...
 if (!out) {
  free (ret);
  return 
# 239 "project/radare2/libr/util/hex.c" 3 4
        ((void *)0)
# 239 "project/radare2/libr/util/hex.c"
            ;
 }
 *out = '\0';
 return ret;
...
# 246 "project/radare2/libr/util/hex.c" 3 4
__attribute__((visibility("default"))) 
# 246 "project/radare2/libr/util/hex.c"
 ...
 if (!(s1 || s2)) {
  return 
# 252 "project/radare2/libr/util/hex.c" 3 4
        ((void *)0)
# 252 "project/radare2/libr/util/hex.c"
            ;
 }
 ...
 if (!end) {
  return 
# 266 "project/radare2/libr/util/hex.c" 3 4
        ((void *)0)
# 266 "project/radare2/libr/util/hex.c"
            ;
 }
...
# 272 "project/radare2/libr/util/hex.c" 3 4
unsigned char 
# 272 "project/radare2/libr/util/hex.c"
    *b64d = malloc (end - start);
 if (!b64d) {
  free (str);
  return 
# 275 "project/radare2/libr/util/hex.c" 3 4
        ((void *)0)
# 275 "project/radare2/libr/util/hex.c"
            ;
 }
 ...
 if (!b64d) {
  ...
  free (b64d);
  return 
# 282 "project/radare2/libr/util/hex.c" 3 4
        ((void *)0)
# 282 "project/radare2/libr/util/hex.c"
            ;
 }
 ...
 if (!out) {
  ...
  free (b64d);
  return 
# 291 "project/radare2/libr/util/hex.c" 3 4
        ((void *)0)
# 291 "project/radare2/libr/util/hex.c"
            ;
 }
 for (i = 0; i < len; i++) {
  
# 294 "project/radare2/libr/util/hex.c" 3 4
 __builtin___sprintf_chk (
# 294 "project/radare2/libr/util/hex.c"
 &out[i * 2]
# 294 "project/radare2/libr/util/hex.c" 3 4
...
# 309 "project/radare2/libr/util/hex.c" 3 4
__attribute__((visibility("default"))) 
# 309 "project/radare2/libr/util/hex.c"
     char *r_hex_no_code(const char *code) {
 if (!code) {
  return 
# 311 "project/radare2/libr/util/hex.c" 3 4
        ((void *)0)
# 311 "project/radare2/libr/util/hex.c"
            ;
 }
 char * const ret = calloc (1, strlen (code) * 3);
 if (!ret) {
  return 
# 315 "project/radare2/libr/util/hex.c" 3 4
        ((void *)0)
# 315 "project/radare2/libr/util/hex.c"
            ;
 }
 *ret = '\0';
 char *out = ret;
 ...
 if (!out) {
  free (ret);
  return 
# 323 "project/radare2/libr/util/hex.c" 3 4
        ((void *)0)
# 323 "project/radare2/libr/util/hex.c"
            ;
 }
 *out = '\0';
 while (out && code) {
...
# 334 "project/radare2/libr/util/hex.c" 3 4
__attribute__((visibility("default"))) 
# 334 "project/radare2/libr/util/hex.c"
     char *r_hex_from_code(const char *code) {
 if (!strchr (code, '=')) {
...
# 352 "project/radare2/libr/util/hex.c" 3 4
__attribute__((visibility("default"))) 
# 352 "project/radare2/libr/util/hex.c"
     int r_hex_pair2bin(const char *arg) {
 
# 353 "project/radare2/libr/util/hex.c" 3 4
unsigned char 
# 353 "project/radare2/libr/util/hex.c"
    *ptr, c = 0, d = 0;
 
# 354 "project/radare2/libr/util/hex.c" 3 4
unsigned int 
# 354 "project/radare2/libr/util/hex.c"
     j = 0;

 for (ptr = (
# 356 "project/radare2/libr/util/hex.c" 3 4
            unsigned char
# 356 "project/radare2/libr/util/hex.c"
               *)arg; ;ptr = ptr + 1) {
  if (!*ptr || *ptr==' ' || j==2) {
   break;
  }
...
# 362 "project/radare2/libr/util/hex.c" 3 4
  fprintf(__stderrp,
# 362 "project/radare2/libr/util/hex.c"
  "Invalid hexa string at char '%c' (%s).\n", *ptr, arg
# 362 "project/radare2/libr/util/hex.c" 3 4
  )
              
# 363 "project/radare2/libr/util/hex.c"
             ;
   return -1;
  }
  c |= d;
...
# 374 "project/radare2/libr/util/hex.c" 3 4
__attribute__((visibility("default"))) 
# 374 "project/radare2/libr/util/hex.c"
     int r_hex_bin2str(const 
# 374 "project/radare2/libr/util/hex.c" 3 4
                             unsigned char 
# 374 "project/radare2/libr/util/hex.c"
                                 *in, int len, char *out) {
...
# 381 "project/radare2/libr/util/hex.c" 3 4
 __builtin___snprintf_chk (
# 381 "project/radare2/libr/util/hex.c"
 tmp
# 381 "project/radare2/libr/util/hex.c" 3 4
 , 
# 381 "project/radare2/libr/util/hex.c"
...
# 382 "project/radare2/libr/util/hex.c" 3 4
 __builtin___memcpy_chk (
# 382 "project/radare2/libr/util/hex.c"
 out + idx
# 382 "project/radare2/libr/util/hex.c" 3 4
 , 
# 382 "project/radare2/libr/util/hex.c"
...
# 388 "project/radare2/libr/util/hex.c" 3 4
__attribute__((visibility("default"))) 
# 388 "project/radare2/libr/util/hex.c"
     char *r_hex_bin2strdup(const 
# 388 "project/radare2/libr/util/hex.c" 3 4
                                  unsigned char 
# 388 "project/radare2/libr/util/hex.c"
                                      *in, int len) {
 ...
 if ((len + 1) * 2 < len) {
  return 
# 393 "project/radare2/libr/util/hex.c" 3 4
        ((void *)0)
# 393 "project/radare2/libr/util/hex.c"
            ;
 }
 out = malloc ((len + 1) * 2);
 if (!out) {
  return 
# 397 "project/radare2/libr/util/hex.c" 3 4
        ((void *)0)
# 397 "project/radare2/libr/util/hex.c"
            ;
 }
 for (i = idx = 0; i < len; i++, idx += 2) {
  
# 400 "project/radare2/libr/util/hex.c" 3 4
 __builtin___snprintf_chk (
# 400 "project/radare2/libr/util/hex.c"
 tmp
# 400 "project/radare2/libr/util/hex.c" 3 4
 , 
# 400 "project/radare2/libr/util/hex.c"
...
# 401 "project/radare2/libr/util/hex.c" 3 4
 __builtin___memcpy_chk (
# 401 "project/radare2/libr/util/hex.c"
 out+idx
# 401 "project/radare2/libr/util/hex.c" 3 4
 , 
# 401 "project/radare2/libr/util/hex.c"
...
# 407 "project/radare2/libr/util/hex.c" 3 4
__attribute__((visibility("default"))) 
# 407 "project/radare2/libr/util/hex.c"
     int r_hex_str2bin(const char *in, 
# 407 "project/radare2/libr/util/hex.c" 3 4
                                       unsigned char 
# 407 "project/radare2/libr/util/hex.c"
                                           *out) {
...
# 411 "project/radare2/libr/util/hex.c" 3 4
 unsigned char 
# 411 "project/radare2/libr/util/hex.c"
     tmp;
...
# 435 "project/radare2/libr/util/hex.c" 3 4
             ((
# 435 "project/radare2/libr/util/hex.c"
             *in
# 435 "project/radare2/libr/util/hex.c" 3 4
             ) == ' ' || (
# 435 "project/radare2/libr/util/hex.c"
...
# 455 "project/radare2/libr/util/hex.c" 3 4
__attribute__((visibility("default"))) 
# 455 "project/radare2/libr/util/hex.c"
     int r_hex_str2bin_until_new(const char *in, 
# 455 "project/radare2/libr/util/hex.c" 3 4
                                                 unsigned char 
# 455 "project/radare2/libr/util/hex.c"
                                                     **out) {
...
# 468 "project/radare2/libr/util/hex.c" 3 4
unsigned char 
# 468 "project/radare2/libr/util/hex.c"
    *buf = malloc (len);
 if (buf) {
...
# 492 "project/radare2/libr/util/hex.c" 3 4
__attribute__((visibility("default"))) 
# 492 "project/radare2/libr/util/hex.c"
     int r_hex_str2binmask(const char *in, 
# 492 "project/radare2/libr/util/hex.c" 3 4
                                           unsigned char 
# 492 "project/radare2/libr/util/hex.c"
                                               *out, 
...
# 493 "project/radare2/libr/util/hex.c" 3 4
unsigned char 
# 493 "project/radare2/libr/util/hex.c"
    *ptr;
 int len, ilen = strlen (in)+1;
 int has_nibble = 0;
 
# 496 "project/radare2/libr/util/hex.c" 3 4
__builtin___memcpy_chk (
# 496 "project/radare2/libr/util/hex.c"
out
# 496 "project/radare2/libr/util/hex.c" 3 4
, 
# 496 "project/radare2/libr/util/hex.c"
...
# 505 "project/radare2/libr/util/hex.c" 3 4
 __builtin___memcpy_chk (
# 505 "project/radare2/libr/util/hex.c"
 mask
# 505 "project/radare2/libr/util/hex.c" 3 4
 , 
# 505 "project/radare2/libr/util/hex.c"
...
# 507 "project/radare2/libr/util/hex.c" 3 4
  __builtin___memcpy_chk (
# 507 "project/radare2/libr/util/hex.c"
  mask + ilen
# 507 "project/radare2/libr/util/hex.c" 3 4
  , 
# 507 "project/radare2/libr/util/hex.c"
...
# 507 "project/radare2/libr/util/hex.c"
  ...
  for (ptr = mask; *ptr; ptr++) {
   if (
# 510 "project/radare2/libr/util/hex.c" 3 4
      (((
# 510 "project/radare2/libr/util/hex.c"
      *ptr
# 510 "project/radare2/libr/util/hex.c" 3 4
      ) >= '0' && (
# 510 "project/radare2/libr/util/hex.c"
...
# 524 "project/radare2/libr/util/hex.c" 3 4
__attribute__((visibility("default"))) long long 
# 524 "project/radare2/libr/util/hex.c"
          r_hex_bin_truncate(
# 524 "project/radare2/libr/util/hex.c" 3 4
                             unsigned long long 
# 524 "project/radare2/libr/util/hex.c"
 ...
 case 1:
  if ((in & 
# 527 "project/radare2/libr/util/hex.c" 3 4
           0x80U
# 527 "project/radare2/libr/util/hex.c"
                  )) {
   return 
# 528 "project/radare2/libr/util/hex.c" 3 4
         0xFFFFFFFFFFFFFF00ULL 
# 528 "project/radare2/libr/util/hex.c"
                 | in;
  }
  return in&
# 530 "project/radare2/libr/util/hex.c" 3 4
           0xFFU
# 530 "project/radare2/libr/util/hex.c"
                  ;
 case 2:
  if ((in & 
# 532 "project/radare2/libr/util/hex.c" 3 4
           0x8000U
# 532 "project/radare2/libr/util/hex.c"
                   )) {
   return 
# 533 "project/radare2/libr/util/hex.c" 3 4
         0xFFFFFFFFFFFF0000ULL 
# 533 "project/radare2/libr/util/hex.c"
                  | in;
  }
  return in&
# 535 "project/radare2/libr/util/hex.c" 3 4
           0xFFFFU
# 535 "project/radare2/libr/util/hex.c"
                   ;
 case 4:
  if ((in & 
# 537 "project/radare2/libr/util/hex.c" 3 4
           0x80000000U
# 537 "project/radare2/libr/util/hex.c"
                   )) {
   return 
# 538 "project/radare2/libr/util/hex.c" 3 4
         0xFFFFFFFF00000000ULL 
# 538 "project/radare2/libr/util/hex.c"
                  | in;
  }
  return in&
# 540 "project/radare2/libr/util/hex.c" 3 4
           0xFFFFFFFFU
# 540 "project/radare2/libr/util/hex.c"
                   ;
 case 8:
  return in&
# 542 "project/radare2/libr/util/hex.c" 3 4
           0xFFFFFFFFFFFFFFFFULL
# 542 "project/radare2/libr/util/hex.c"
                   ;
 }
 return in;
}
...
# 548 "project/radare2/libr/util/hex.c" 3 4
__attribute__((visibility("default"))) 
# 548 "project/radare2/libr/util/hex.c"
     int r_hex_str_is_valid(const char* str) {
 int i;
 int len = 0;
 if (!strncmp (str, "0x", 2)) {
  str += 2;
 ...
 for (i = 0; str[i] != '\0'; i++) {
  if (
# 555 "project/radare2/libr/util/hex.c" 3 4
     (((
# 555 "project/radare2/libr/util/hex.c"
     str[i]
# 555 "project/radare2/libr/util/hex.c" 3 4
     ) >= '0' && (
# 555 "project/radare2/libr/util/hex.c"
...
# 555 "project/radare2/libr/util/hex.c"
  ...
  if (
# 558 "project/radare2/libr/util/hex.c" 3 4
     (((
# 558 "project/radare2/libr/util/hex.c"
     str[i]
# 558 "project/radare2/libr/util/hex.c" 3 4
     ) >= '0' && (
# 558 "project/radare2/libr/util/hex.c"
