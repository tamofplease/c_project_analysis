# 0 "project/radare2/libr/util/buf_file.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/buf_file.c"
...
# 4 "project/radare2/libr/util/buf_file.c" 2
...
# 5 "project/radare2/libr/util/buf_file.c" 2


# 6 "project/radare2/libr/util/buf_file.c"
...
# 14 "project/radare2/libr/util/buf_file.c" 3 4
unsigned char 
# 14 "project/radare2/libr/util/buf_file.c"
    tmp[8];
};
...
# 19 "project/radare2/libr/util/buf_file.c" 3 4
do { if (!(
# 19 "project/radare2/libr/util/buf_file.c"
priv
# 19 "project/radare2/libr/util/buf_file.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "WARNING (%s:%d):%s%s runtime check failed: (%s)\n", "project/radare2/libr/util/buf_file.c", 19, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : "", 
# 19 "project/radare2/libr/util/buf_file.c"
"priv"
# 19 "project/radare2/libr/util/buf_file.c" 3 4
); } } while (0)
...
static 
# 23 "project/radare2/libr/util/buf_file.c" 3 4
      _Bool 
# 23 "project/radare2/libr/util/buf_file.c"
           buf_file_init(RBuffer *b, const void *user) {
 const struct buf_file_user *u = (const struct buf_file_user *)user;
 struct buf_file_priv *priv = 
# 25 "project/radare2/libr/util/buf_file.c" 3 4
                             (
# 25 "project/radare2/libr/util/buf_file.c"
                             struct buf_file_priv
# 25 "project/radare2/libr/util/buf_file.c" 3 4
                             *)calloc(1,sizeof(
# 25 "project/radare2/libr/util/buf_file.c"
...
# 25 "project/radare2/libr/util/buf_file.c"
 ...
 if (!priv) {
  return 
# 27 "project/radare2/libr/util/buf_file.c" 3 4
        0
# 27 "project/radare2/libr/util/buf_file.c"
             ;
 }
 ...
 if (fd == -1) {
  free (priv);
  return 
# 32 "project/radare2/libr/util/buf_file.c" 3 4
        0
# 32 "project/radare2/libr/util/buf_file.c"
             ;
 }
 priv->fd = fd;
 b->priv = priv;
 return 
# 36 "project/radare2/libr/util/buf_file.c" 3 4
       1
# 36 "project/radare2/libr/util/buf_file.c"
           ;
}

static 
# 39 "project/radare2/libr/util/buf_file.c" 3 4
      _Bool 
# 39 "project/radare2/libr/util/buf_file.c"
           buf_file_fini(RBuffer *b) {
 struct buf_file_priv *priv = get_priv_file (b);
 r_sandbox_close (priv->fd);
 
# 42 "project/radare2/libr/util/buf_file.c" 3 4
{ free((void *)
# 42 "project/radare2/libr/util/buf_file.c"
b->priv
# 42 "project/radare2/libr/util/buf_file.c" 3 4
); 
# 42 "project/radare2/libr/util/buf_file.c"
...
# 42 "project/radare2/libr/util/buf_file.c"
                ;
 return 
# 43 "project/radare2/libr/util/buf_file.c" 3 4
       1
# 43 "project/radare2/libr/util/buf_file.c"
           ;
}

static 
# 46 "project/radare2/libr/util/buf_file.c" 3 4
      unsigned long long 
# 46 "project/radare2/libr/util/buf_file.c"
           buf_file_get_size(RBuffer *b) {
 struct buf_file_priv *priv = get_priv_file (b);
 int pos = r_sandbox_lseek (priv->fd, 0, 
# 48 "project/radare2/libr/util/buf_file.c" 3 4
                                        1
# 48 "project/radare2/libr/util/buf_file.c"
                                                );
 int res = r_sandbox_lseek (priv->fd, 0, 
# 49 "project/radare2/libr/util/buf_file.c" 3 4
                                        2
# 49 "project/radare2/libr/util/buf_file.c"
                                                );
 r_sandbox_lseek (priv->fd, pos, 
# 50 "project/radare2/libr/util/buf_file.c" 3 4
                                0
# 50 "project/radare2/libr/util/buf_file.c"
                                        );
 return (
# 51 "project/radare2/libr/util/buf_file.c" 3 4
        unsigned long long
# 51 "project/radare2/libr/util/buf_file.c"
            )res;
}

static 
# 54 "project/radare2/libr/util/buf_file.c" 3 4
      long long 
# 54 "project/radare2/libr/util/buf_file.c"
           buf_file_read(RBuffer *b, 
# 54 "project/radare2/libr/util/buf_file.c" 3 4
                                     unsigned char 
# 54 "project/radare2/libr/util/buf_file.c"
                                         *buf, 
...
static 
# 59 "project/radare2/libr/util/buf_file.c" 3 4
      long long 
# 59 "project/radare2/libr/util/buf_file.c"
           buf_file_write(RBuffer *b, const 
# 59 "project/radare2/libr/util/buf_file.c" 3 4
                                            unsigned char 
# 59 "project/radare2/libr/util/buf_file.c"
                                                *buf, 
...
static 
# 64 "project/radare2/libr/util/buf_file.c" 3 4
      long long 
# 64 "project/radare2/libr/util/buf_file.c"
           buf_file_seek(RBuffer *b, 
# 64 "project/radare2/libr/util/buf_file.c" 3 4
                                     long long 
# 64 "project/radare2/libr/util/buf_file.c"
                                          addr, int whence) {
 ...
 switch (whence) {
 case 
# 67 "project/radare2/libr/util/buf_file.c" 3 4
     1
# 67 "project/radare2/libr/util/buf_file.c"
              : whence = 
# 67 "project/radare2/libr/util/buf_file.c" 3 4
                         1
# 67 "project/radare2/libr/util/buf_file.c"
                                 ; break;
 case 
# 68 "project/radare2/libr/util/buf_file.c" 3 4
     0
# 68 "project/radare2/libr/util/buf_file.c"
              : whence = 
# 68 "project/radare2/libr/util/buf_file.c" 3 4
                         0
# 68 "project/radare2/libr/util/buf_file.c"
                                 ; break;
 case 
# 69 "project/radare2/libr/util/buf_file.c" 3 4
     2
# 69 "project/radare2/libr/util/buf_file.c"
              : whence = 
# 69 "project/radare2/libr/util/buf_file.c" 3 4
                         2
# 69 "project/radare2/libr/util/buf_file.c"
...
static 
# 74 "project/radare2/libr/util/buf_file.c" 3 4
      _Bool 
# 74 "project/radare2/libr/util/buf_file.c"
           buf_file_resize(RBuffer *b, 
# 74 "project/radare2/libr/util/buf_file.c" 3 4
                                       unsigned long long 
# 74 "project/radare2/libr/util/buf_file.c"
                                            newsize) {
