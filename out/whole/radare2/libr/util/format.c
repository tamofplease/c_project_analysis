# 0 "project/radare2/libr/util/format.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/format.c"
...
# 4 "project/radare2/libr/util/format.c" 2
...
#define R_BUF_H 
# 11 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_buf.h" 3 4
#define R_BUF_SET 0
#define R_BUF_CUR 1
#define R_BUF_END 2
...
# 5 "project/radare2/libr/util/format.c" 2
...
# 8 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_print.h" 2 3 4
...
# 9 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_print.h" 2 3 4
...
# 46 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_print.h" 3 4
#define $00 1
#define $01 8
#define $10 2
#define $11 16
...
# 6 "project/radare2/libr/util/format.c" 2
...
# 42 "project/radare2/libr/util/format.c"
#define THRESHOLD (-4444)


# 44 "project/radare2/libr/util/format.c"
static float updateAddr(const 
# 44 "project/radare2/libr/util/format.c" 3 4
                             unsigned char 
# 44 "project/radare2/libr/util/format.c"
                                 *buf, int len, int endian, 
# 44 "project/radare2/libr/util/format.c" 3 4
                                                            unsigned long long 
# 44 "project/radare2/libr/util/format.c"
                                                                 *addr, 
...
# 44 "project/radare2/libr/util/format.c"
 ...
 if (len >= sizeof (float)) {
  r_mem_swaporcopy ((
# 57 "project/radare2/libr/util/format.c" 3 4
                    unsigned char
# 57 "project/radare2/libr/util/format.c"
                       *)&f, buf, sizeof (float), endian);
 }
 if (addr && len > 3) {
  
# 60 "project/radare2/libr/util/format.c" 3 4
 unsigned int 
# 60 "project/radare2/libr/util/format.c"
      tmpaddr = r_read_ble32 (buf, endian);
  *addr = (
# 61 "project/radare2/libr/util/format.c" 3 4
          unsigned long long
# 61 "project/radare2/libr/util/format.c"
              )tmpaddr;
 }
 if (addr64 && len > 7) {
...
static int r_get_size(RNum *num, 
# 69 "project/radare2/libr/util/format.c" 3 4
                                unsigned char 
# 69 "project/radare2/libr/util/format.c"
                                    *buf, int endian, const char *s) {
 size_t len = strlen (s);
 if (s[0] == '*' && len >= 4) {
  
# 72 "project/radare2/libr/util/format.c" 3 4
 unsigned long long 
# 72 "project/radare2/libr/util/format.c"
      addr;
  int offset = (int)r_num_math (num, s + 1);
  (void)updateAddr (buf + offset, 999, endian, &addr, 
# 74 "project/radare2/libr/util/format.c" 3 4
                                                     ((void *)0)
# 74 "project/radare2/libr/util/format.c"
                                                         );
  return addr;
 }
...
static void r_print_format_u128(const RPrint* p, int endian, int mode,
  const char *setval, 
# 82 "project/radare2/libr/util/format.c" 3 4
                     unsigned long long 
# 82 "project/radare2/libr/util/format.c"
                          seeki, 
# 82 "project/radare2/libr/util/format.c" 3 4
                                 unsigned char
# 82 "project/radare2/libr/util/format.c"
...
# 83 "project/radare2/libr/util/format.c" 3 4
unsigned long long 
# 83 "project/radare2/libr/util/format.c"
     low = r_read_ble64 (buf, endian);
 
# 84 "project/radare2/libr/util/format.c" 3 4
unsigned long long 
# 84 "project/radare2/libr/util/format.c"
     hig = r_read_ble64 (buf + 8, endian);
 if ((mode & 
# 85 "project/radare2/libr/util/format.c" 3 4
    (1 << 3) 
# 85 "project/radare2/libr/util/format.c"
    && mode & 
# 85 "project/radare2/libr/util/format.c" 3 4
    (1 << 1)
# 85 "project/radare2/libr/util/format.c"
...
# 87 "project/radare2/libr/util/format.c" 3 4
            (1 << 6)
# 87 "project/radare2/libr/util/format.c"
            ) && !(mode & 
# 87 "project/radare2/libr/util/format.c" 3 4
                         (1 << 8)
# 87 "project/radare2/libr/util/format.c"
  ...
  p->cb_printf ("0x%08"
# 88 "project/radare2/libr/util/format.c" 3 4
                      "llx"
# 88 "project/radare2/libr/util/format.c"
                             " = (uint128_t)", seeki);
 }
 if (endian) {
  p->cb_printf ("0x%016"
# 91 "project/radare2/libr/util/format.c" 3 4
                       "llx"
# 91 "project/radare2/libr/util/format.c"
                              "", low);
  p->cb_printf ("%016"
# 92 "project/radare2/libr/util/format.c" 3 4
                     "llx"
# 92 "project/radare2/libr/util/format.c"
                            , hig);
 } else {
  p->cb_printf ("0x%016"
# 94 "project/radare2/libr/util/format.c" 3 4
                       "llx"
# 94 "project/radare2/libr/util/format.c"
                              "", hig);
  p->cb_printf ("%016"
# 95 "project/radare2/libr/util/format.c" 3 4
                     "llx"
# 95 "project/radare2/libr/util/format.c"
                            , low);
 }
 if ((mode & 
# 97 "project/radare2/libr/util/format.c" 3 4
    (1 << 3) 
# 97 "project/radare2/libr/util/format.c"
    && mode & 
# 97 "project/radare2/libr/util/format.c" 3 4
    (1 << 1)
# 97 "project/radare2/libr/util/format.c"
...
static void r_print_format_quadword(const RPrint* p, int endian, int mode,
  const char *setval, 
# 104 "project/radare2/libr/util/format.c" 3 4
                     unsigned long long 
# 104 "project/radare2/libr/util/format.c"
                          seeki, 
# 104 "project/radare2/libr/util/format.c" 3 4
                                 unsigned char
# 104 "project/radare2/libr/util/format.c"
...
# 105 "project/radare2/libr/util/format.c" 3 4
unsigned long long 
# 105 "project/radare2/libr/util/format.c"
     addr64;
 int elem = -1;
 if (size >= 10000) {
  elem = size / 10000 - 1;
 ...
 updateAddr (buf + i, size - i, endian, 
# 111 "project/radare2/libr/util/format.c" 3 4
                                       ((void *)0)
# 111 "project/radare2/libr/util/format.c"
                                           , &addr64);
 if ((mode & 
# 112 "project/radare2/libr/util/format.c" 3 4
    (1 << 4) 
# 112 "project/radare2/libr/util/format.c"
    && mode & 
# 112 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 112 "project/radare2/libr/util/format.c"
    && setval)) {
  p->cb_printf ("wv8 %s @ 0x%08"
# 113 "project/radare2/libr/util/format.c" 3 4
                               "llx"
# 113 "project/radare2/libr/util/format.c"
                                      "\n", setval, seeki+((elem>=0)?elem*8:0));
 } else if ((mode & 
# 114 "project/radare2/libr/util/format.c" 3 4
           (1) 
# 114 "project/radare2/libr/util/format.c"
           && mode & 
# 114 "project/radare2/libr/util/format.c" 3 4
           (1 << 1) 
# 114 "project/radare2/libr/util/format.c"
...
# 114 "project/radare2/libr/util/format.c"
  ...
  if (!(mode & 
# 115 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 115 "project/radare2/libr/util/format.c"
      ) && !(mode & 
# 115 "project/radare2/libr/util/format.c" 3 4
                   (1 << 8)
# 115 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("0x%08"
# 116 "project/radare2/libr/util/format.c" 3 4
                       "llx"
# 116 "project/radare2/libr/util/format.c"
                              " = (qword)",
    seeki + ((elem >= 0)? elem * 8: 0));
  }
  if (size == -1) {
   if (addr64 == 
# 120 "project/radare2/libr/util/format.c" 3 4
                0xFFFFFFFFU 
# 120 "project/radare2/libr/util/format.c"
                         || ((
# 120 "project/radare2/libr/util/format.c" 3 4
                              long long
# 120 "project/radare2/libr/util/format.c"
...
# 120 "project/radare2/libr/util/format.c"
    ...
    p->cb_printf ("0x%016"
# 123 "project/radare2/libr/util/format.c" 3 4
                         "llx"
# 123 "project/radare2/libr/util/format.c"
                                , addr64);
   }
  } else {
   if (!(mode & 
# 126 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 126 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf ("[ ");
   }
   while (size--) {
    updateAddr (buf + i, size - i, endian, 
# 130 "project/radare2/libr/util/format.c" 3 4
                                          ((void *)0)
# 130 "project/radare2/libr/util/format.c"
                                              , &addr64);
    if (elem == -1 || elem == 0) {
     p->cb_printf ("0x%016"
# 132 "project/radare2/libr/util/format.c" 3 4
                          "llx"
# 132 "project/radare2/libr/util/format.c"
                                 , addr64);
     if (elem == 0) {
      elem = -2;
     }
   ...
   if (!(mode & 
# 145 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 145 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf (" ]");
   }
  }
 } else if ((mode & 
# 149 "project/radare2/libr/util/format.c" 3 4
           (1 << 3) 
# 149 "project/radare2/libr/util/format.c"
           && mode & 
# 149 "project/radare2/libr/util/format.c" 3 4
           (1 << 1)
# 149 "project/radare2/libr/util/format.c"
...
# 149 "project/radare2/libr/util/format.c"
  ...
  if (size == -1) {
   p->cb_printf ("%"
# 151 "project/radare2/libr/util/format.c" 3 4
                   "lld"
# 151 "project/radare2/libr/util/format.c"
                          , addr64);
  } else {
   p->cb_printf ("[ ");
   while (size--) {
    updateAddr (buf + i, size - i, endian, 
# 155 "project/radare2/libr/util/format.c" 3 4
                                          ((void *)0)
# 155 "project/radare2/libr/util/format.c"
                                              , &addr64);
    if (elem == -1 || elem == 0) {
     p->cb_printf ("%"
# 157 "project/radare2/libr/util/format.c" 3 4
                     "lld"
# 157 "project/radare2/libr/util/format.c"
                            , addr64);
     if (elem == 0) {
      elem = -2;
     }
  ...
  if ((mode & 
# 172 "project/radare2/libr/util/format.c" 3 4
     (1 << 3) 
# 172 "project/radare2/libr/util/format.c"
     && mode & 
# 172 "project/radare2/libr/util/format.c" 3 4
     (1 << 1)
# 172 "project/radare2/libr/util/format.c"
...
static void r_print_format_byte(const RPrint* p, int endian, int mode,
  const char *setval, 
# 179 "project/radare2/libr/util/format.c" 3 4
                     unsigned long long 
# 179 "project/radare2/libr/util/format.c"
                          seeki, 
# 179 "project/radare2/libr/util/format.c" 3 4
                                 unsigned char
# 179 "project/radare2/libr/util/format.c"
 ...
 if ((mode & 
# 185 "project/radare2/libr/util/format.c" 3 4
    (1 << 4) 
# 185 "project/radare2/libr/util/format.c"
    && mode & 
# 185 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 185 "project/radare2/libr/util/format.c"
    && setval)) {
  p->cb_printf ("\"w %s\" @ 0x%08"
# 186 "project/radare2/libr/util/format.c" 3 4
                                 "llx"
# 186 "project/radare2/libr/util/format.c"
                                        "\n", setval, seeki + ((elem >= 0) ? elem : 0));
 } else if ((mode & 
# 187 "project/radare2/libr/util/format.c" 3 4
           (1) 
# 187 "project/radare2/libr/util/format.c"
           && mode & 
# 187 "project/radare2/libr/util/format.c" 3 4
           (1 << 1) 
# 187 "project/radare2/libr/util/format.c"
...
# 187 "project/radare2/libr/util/format.c"
  ...
  if (!(mode & 
# 188 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 188 "project/radare2/libr/util/format.c"
      ) && !(mode & 
# 188 "project/radare2/libr/util/format.c" 3 4
                   (1 << 8)
# 188 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("0x%08"
# 189 "project/radare2/libr/util/format.c" 3 4
                       "llx"
# 189 "project/radare2/libr/util/format.c"
                              " = ", seeki + ((elem >= 0) ? elem : 0));
  }
  if (size == -1) {
   ...
   if (!(mode & 
# 194 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 194 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf ("[ ");
   }
   while (size--) {
   ...
   if (!(mode & 
# 212 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 212 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf (" ]");
   }
  }
 } else if ((mode & 
# 216 "project/radare2/libr/util/format.c" 3 4
           (1 << 3) 
# 216 "project/radare2/libr/util/format.c"
           && mode & 
# 216 "project/radare2/libr/util/format.c" 3 4
           (1 << 1)
# 216 "project/radare2/libr/util/format.c"
...
# 216 "project/radare2/libr/util/format.c"
  ...
  if ((mode & 
# 237 "project/radare2/libr/util/format.c" 3 4
     (1 << 3) 
# 237 "project/radare2/libr/util/format.c"
     && mode & 
# 237 "project/radare2/libr/util/format.c" 3 4
     (1 << 1)
# 237 "project/radare2/libr/util/format.c"
...
static int r_print_format_uleb(const RPrint* p, int endian, int mode,
  const char *setval, 
# 245 "project/radare2/libr/util/format.c" 3 4
                     unsigned long long 
# 245 "project/radare2/libr/util/format.c"
                          seeki, 
# 245 "project/radare2/libr/util/format.c" 3 4
                                 unsigned char
# 245 "project/radare2/libr/util/format.c"
...
# 248 "project/radare2/libr/util/format.c" 3 4
unsigned long long 
# 248 "project/radare2/libr/util/format.c"
     value = 0;
 if (size >= 10000) {
  elem = size / 10000 - 1;
  size %= 10000;
 ...
 if ((mode & 
# 253 "project/radare2/libr/util/format.c" 3 4
    (1 << 4) 
# 253 "project/radare2/libr/util/format.c"
    && mode & 
# 253 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 253 "project/radare2/libr/util/format.c"
...
# 254 "project/radare2/libr/util/format.c" 3 4
 unsigned char 
# 254 "project/radare2/libr/util/format.c"
     *tmp;
  char *nbr;
  do {
  ...
  tmp = (
# 261 "project/radare2/libr/util/format.c" 3 4
        unsigned char
# 261 "project/radare2/libr/util/format.c"
           *) r_uleb128_encode (r_num_math (
# 261 "project/radare2/libr/util/format.c" 3 4
                                            ((void *)0)
# 261 "project/radare2/libr/util/format.c"
                                                , setval), &s);
  nbr = r_hex_bin2strdup (tmp, s);
  p->cb_printf ("\"wx %s\" @ 0x%08"
# 263 "project/radare2/libr/util/format.c" 3 4
                                  "llx"
# 263 "project/radare2/libr/util/format.c"
                                         "\n", nbr, seeki+offset-s);
  free (tmp);
  free (nbr);
 } else if ((mode & 
# 266 "project/radare2/libr/util/format.c" 3 4
           (1) 
# 266 "project/radare2/libr/util/format.c"
           && mode & 
# 266 "project/radare2/libr/util/format.c" 3 4
           (1 << 1) 
# 266 "project/radare2/libr/util/format.c"
...
# 266 "project/radare2/libr/util/format.c"
  ...
  if (!(mode & 
# 267 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 267 "project/radare2/libr/util/format.c"
      ) && !(mode & 
# 267 "project/radare2/libr/util/format.c" 3 4
                   (1 << 8)
# 267 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("0x%08" 
# 268 "project/radare2/libr/util/format.c" 3 4
                        "llx" 
# 268 "project/radare2/libr/util/format.c"
                                " = ", seeki);
  }
  if (size==-1) {
   r_uleb128_decode (buf+i, &offset, &value);
   p->cb_printf ("%"
# 272 "project/radare2/libr/util/format.c" 3 4
                   "lld"
# 272 "project/radare2/libr/util/format.c"
                          , value);
  } else {
   if (!(mode & 
# 274 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 274 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf ("[ ");
   }
   while (size--) {
    if (elem == -1 || elem == 0) {
     ...
     offset += s;
     p->cb_printf ("%"
# 282 "project/radare2/libr/util/format.c" 3 4
                     "lld"
# 282 "project/radare2/libr/util/format.c"
                            , value);
     if (elem == 0) {
      elem = -2;
     }
   ...
   if (!(mode & 
# 294 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 294 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf (" ]");
   }
  }
 } else if ((mode & 
# 298 "project/radare2/libr/util/format.c" 3 4
           (1 << 3) 
# 298 "project/radare2/libr/util/format.c"
           && mode & 
# 298 "project/radare2/libr/util/format.c" 3 4
           (1 << 1)
# 298 "project/radare2/libr/util/format.c"
...
# 298 "project/radare2/libr/util/format.c"
  ...
  if (size==-1) {
   r_uleb128_decode (buf+i, &offset, &value);
   p->cb_printf ("\"%"
# 301 "project/radare2/libr/util/format.c" 3 4
                     "lld"
# 301 "project/radare2/libr/util/format.c"
                            "\"", value);
  } else {
   p->cb_printf ("[ ");
   while (size--) {
    if (elem == -1 || elem == 0) {
     ...
     offset += s;
     p->cb_printf ("\"%"
# 309 "project/radare2/libr/util/format.c" 3 4
                       "lld"
# 309 "project/radare2/libr/util/format.c"
                              "\"", value);
     if (elem == 0) {
      elem = -2;
     }
  ...
  if ((mode & 
# 323 "project/radare2/libr/util/format.c" 3 4
     (1 << 3) 
# 323 "project/radare2/libr/util/format.c"
     && mode & 
# 323 "project/radare2/libr/util/format.c" 3 4
     (1 << 1)
# 323 "project/radare2/libr/util/format.c"
...
static void r_print_format_char(const RPrint* p, int endian, int mode,
  const char *setval, 
# 331 "project/radare2/libr/util/format.c" 3 4
                     unsigned long long 
# 331 "project/radare2/libr/util/format.c"
                          seeki, 
# 331 "project/radare2/libr/util/format.c" 3 4
                                 unsigned char
# 331 "project/radare2/libr/util/format.c"
 ...
 if ((mode & 
# 337 "project/radare2/libr/util/format.c" 3 4
    (1 << 4) 
# 337 "project/radare2/libr/util/format.c"
    && mode & 
# 337 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 337 "project/radare2/libr/util/format.c"
    && setval)) {
  p->cb_printf ("\"w %s\" @ 0x%08"
# 338 "project/radare2/libr/util/format.c" 3 4
                                 "llx"
# 338 "project/radare2/libr/util/format.c"
                                        "\n", setval, seeki+((elem>=0)?elem:0));
 } else if ((mode & 
# 339 "project/radare2/libr/util/format.c" 3 4
           (1) 
# 339 "project/radare2/libr/util/format.c"
           && mode & 
# 339 "project/radare2/libr/util/format.c" 3 4
           (1 << 1) 
# 339 "project/radare2/libr/util/format.c"
...
# 339 "project/radare2/libr/util/format.c"
  ...
  if (!(mode & 
# 340 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 340 "project/radare2/libr/util/format.c"
      ) && !(mode & 
# 340 "project/radare2/libr/util/format.c" 3 4
                   (1 << 8)
# 340 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("0x%08" 
# 341 "project/radare2/libr/util/format.c" 3 4
                        "llx" 
# 341 "project/radare2/libr/util/format.c"
                                " = ", seeki + ((elem >= 0) ? elem * 2 : 0));
  }
  if (size == -1) {
   p->cb_printf ("'%c'", 
# 344 "project/radare2/libr/util/format.c" 3 4
                        ((
# 344 "project/radare2/libr/util/format.c"
                        buf[i]
# 344 "project/radare2/libr/util/format.c" 3 4
                        ) >=' ' && (
# 344 "project/radare2/libr/util/format.c"
...
# 344 "project/radare2/libr/util/format.c"
   ...
   if (!(mode & 
# 346 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 346 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf ("[ ");
   }
   while (size--) {
    if (elem == -1 || elem == 0) {
     p->cb_printf ("'%c'", 
# 351 "project/radare2/libr/util/format.c" 3 4
                          ((
# 351 "project/radare2/libr/util/format.c"
                          buf[i]
# 351 "project/radare2/libr/util/format.c" 3 4
                          ) >=' ' && (
# 351 "project/radare2/libr/util/format.c"
...
# 351 "project/radare2/libr/util/format.c"
   ...
   if (!(mode & 
# 364 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 364 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf (" ]");
   }
  }
 } else if ((mode & 
# 368 "project/radare2/libr/util/format.c" 3 4
           (1 << 3) 
# 368 "project/radare2/libr/util/format.c"
           && mode & 
# 368 "project/radare2/libr/util/format.c" 3 4
           (1 << 1)
# 368 "project/radare2/libr/util/format.c"
...
# 368 "project/radare2/libr/util/format.c"
  ...
  if (size == -1) {
   p->cb_printf ("\"%c\"", 
# 370 "project/radare2/libr/util/format.c" 3 4
                          ((
# 370 "project/radare2/libr/util/format.c"
                          buf[i]
# 370 "project/radare2/libr/util/format.c" 3 4
                          ) >=' ' && (
# 370 "project/radare2/libr/util/format.c"
...
# 370 "project/radare2/libr/util/format.c"
   ...
   while (size--) {
    if (elem == -1 || elem == 0) {
     p->cb_printf ("\"%c\"", 
# 375 "project/radare2/libr/util/format.c" 3 4
                            ((
# 375 "project/radare2/libr/util/format.c"
                            buf[i]
# 375 "project/radare2/libr/util/format.c" 3 4
                            ) >=' ' && (
# 375 "project/radare2/libr/util/format.c"
...
# 375 "project/radare2/libr/util/format.c"
  ...
  if ((mode & 
# 390 "project/radare2/libr/util/format.c" 3 4
     (1 << 3) 
# 390 "project/radare2/libr/util/format.c"
     && mode & 
# 390 "project/radare2/libr/util/format.c" 3 4
     (1 << 1)
# 390 "project/radare2/libr/util/format.c"
...
static void r_print_format_decchar(const RPrint* p, int endian, int mode, const char *setval, 
# 396 "project/radare2/libr/util/format.c" 3 4
                                                                                             unsigned long long 
# 396 "project/radare2/libr/util/format.c"
                                                                                                  seeki, 
# 396 "project/radare2/libr/util/format.c" 3 4
                                                                                                         unsigned char
# 396 "project/radare2/libr/util/format.c"
 ...
 if ((mode & 
# 402 "project/radare2/libr/util/format.c" 3 4
    (1 << 4) 
# 402 "project/radare2/libr/util/format.c"
    && mode & 
# 402 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 402 "project/radare2/libr/util/format.c"
    && setval)) {
  p->cb_printf ("\"w %s\" @ 0x%08"
# 403 "project/radare2/libr/util/format.c" 3 4
                                 "llx"
# 403 "project/radare2/libr/util/format.c"
                                        "\n", setval, seeki+((elem>=0)?elem:0));
 } else if ((mode & 
# 404 "project/radare2/libr/util/format.c" 3 4
           (1) 
# 404 "project/radare2/libr/util/format.c"
           && mode & 
# 404 "project/radare2/libr/util/format.c" 3 4
           (1 << 1) 
# 404 "project/radare2/libr/util/format.c"
...
# 404 "project/radare2/libr/util/format.c"
  ...
  if (!(mode & 
# 405 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 405 "project/radare2/libr/util/format.c"
      ) && !(mode & 
# 405 "project/radare2/libr/util/format.c" 3 4
                   (1 << 8)
# 405 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("0x%08" 
# 406 "project/radare2/libr/util/format.c" 3 4
                        "llx" 
# 406 "project/radare2/libr/util/format.c"
                                " = ", seeki + ((elem >= 0) ? elem : 0));
  }
  if (size == -1) {
   p->cb_printf ("%d", buf[i]);
   ...
   if (!(mode & 
# 411 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 411 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf ("[ ");
   }
   while (size--) {
   ...
   if (!(mode & 
# 429 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 429 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf (" ]");
   }
  }
 } else if ((mode & 
# 433 "project/radare2/libr/util/format.c" 3 4
           (1 << 3) 
# 433 "project/radare2/libr/util/format.c"
           && mode & 
# 433 "project/radare2/libr/util/format.c" 3 4
           (1 << 1)
# 433 "project/radare2/libr/util/format.c"
...
# 433 "project/radare2/libr/util/format.c"
  ...
  if ((mode & 
# 455 "project/radare2/libr/util/format.c" 3 4
     (1 << 3) 
# 455 "project/radare2/libr/util/format.c"
     && mode & 
# 455 "project/radare2/libr/util/format.c" 3 4
     (1 << 1)
# 455 "project/radare2/libr/util/format.c"
...
static int r_print_format_string(const RPrint* p, 
# 461 "project/radare2/libr/util/format.c" 3 4
                                                 unsigned long long 
# 461 "project/radare2/libr/util/format.c"
                                                      seeki, 
# 461 "project/radare2/libr/util/format.c" 3 4
                                                             unsigned long long 
# 461 "project/radare2/libr/util/format.c"
...
# 461 "project/radare2/libr/util/format.c" 3 4
                                                                          unsigned long long 
# 461 "project/radare2/libr/util/format.c"
                                                                               addr, int is64, int mode) {
 
# 462 "project/radare2/libr/util/format.c" 3 4
unsigned char 
# 462 "project/radare2/libr/util/format.c"
    buffer[255];
 buffer[0] = 0;
 if (!p->iob.read_at) {
  
# 465 "project/radare2/libr/util/format.c" 3 4
 fprintf(__stderrp,
# 465 "project/radare2/libr/util/format.c"
 "(cannot read memory)\n"
# 465 "project/radare2/libr/util/format.c" 3 4
 )
# 465 "project/radare2/libr/util/format.c"
 ...
 const 
# 468 "project/radare2/libr/util/format.c" 3 4
      unsigned long long 
# 468 "project/radare2/libr/util/format.c"
           at = (is64 == 1)? addr64: (
# 468 "project/radare2/libr/util/format.c" 3 4
                                      unsigned long long
# 468 "project/radare2/libr/util/format.c"
 ...
 if ((mode & 
# 470 "project/radare2/libr/util/format.c" 3 4
    (1 << 3) 
# 470 "project/radare2/libr/util/format.c"
    && mode & 
# 470 "project/radare2/libr/util/format.c" 3 4
    (1 << 1)
# 470 "project/radare2/libr/util/format.c"
  ...
  if (encstr) {
   p->cb_printf ("%"
# 473 "project/radare2/libr/util/format.c" 3 4
                   "lld"
# 473 "project/radare2/libr/util/format.c"
                          ",\"string\":\"%s\"}", seeki, encstr);
   free (encstr);
  }
 } else if ((mode & 
# 476 "project/radare2/libr/util/format.c" 3 4
           (1 << 9)
# 476 "project/radare2/libr/util/format.c"
           )) {
  char *encstr = r_str_utf16_encode ((const char *)buffer, -1);
  if (encstr) {
...
# 482 "project/radare2/libr/util/format.c" 3 4
           (1) 
# 482 "project/radare2/libr/util/format.c"
           && mode & 
# 482 "project/radare2/libr/util/format.c" 3 4
           (1 << 1) 
# 482 "project/radare2/libr/util/format.c"
...
# 482 "project/radare2/libr/util/format.c"
  ...
  if (!(mode & 
# 483 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 483 "project/radare2/libr/util/format.c"
      ) && !(mode & 
# 483 "project/radare2/libr/util/format.c" 3 4
                   (1 << 8)
# 483 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("0x%08" 
# 484 "project/radare2/libr/util/format.c" 3 4
                        "llx" 
# 484 "project/radare2/libr/util/format.c"
                                " = ", seeki);
  }
  if (!(mode & 
# 486 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 486 "project/radare2/libr/util/format.c"
      )) {
   if ((mode & 
# 487 "project/radare2/libr/util/format.c" 3 4
      (1 << 8)
# 487 "project/radare2/libr/util/format.c"
      )) {
    if (addr == 0LL) {
     p->cb_printf ("NULL");
    } else if (addr == 
# 490 "project/radare2/libr/util/format.c" 3 4
                      0xFFFFFFFFU 
# 490 "project/radare2/libr/util/format.c"
                               || addr == 
# 490 "project/radare2/libr/util/format.c" 3 4
...
# 490 "project/radare2/libr/util/format.c"
     ...
     p->cb_printf ("0x%08" 
# 493 "project/radare2/libr/util/format.c" 3 4
                          "llx" 
# 493 "project/radare2/libr/util/format.c"
                                  " ", addr);
    }
   } else {
    p->cb_printf ("0x%08" 
# 496 "project/radare2/libr/util/format.c" 3 4
                         "llx" 
# 496 "project/radare2/libr/util/format.c"
                                 " -> 0x%08" 
# 496 "project/radare2/libr/util/format.c" 3 4
                                             "llx" 
# 496 "project/radare2/libr/util/format.c"
...
static void r_print_format_time(const RPrint* p, int endian, int mode,
  const char *setval, 
# 507 "project/radare2/libr/util/format.c" 3 4
                     unsigned long long 
# 507 "project/radare2/libr/util/format.c"
                          seeki, 
# 507 "project/radare2/libr/util/format.c" 3 4
                                 unsigned char
# 507 "project/radare2/libr/util/format.c"
...
# 508 "project/radare2/libr/util/format.c" 3 4
unsigned long long 
# 508 "project/radare2/libr/util/format.c"
     addr;
 ...
 updateAddr (buf + i, size - i, endian, &addr, 
# 515 "project/radare2/libr/util/format.c" 3 4
                                              ((void *)0)
# 515 "project/radare2/libr/util/format.c"
                                                  );
 if ((mode & 
# 516 "project/radare2/libr/util/format.c" 3 4
    (1 << 4) 
# 516 "project/radare2/libr/util/format.c"
    && mode & 
# 516 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 516 "project/radare2/libr/util/format.c"
    && setval)) {
  p->cb_printf ("wv4 %s @ 0x%08"
# 517 "project/radare2/libr/util/format.c" 3 4
                               "llx"
# 517 "project/radare2/libr/util/format.c"
                                      "\n", setval, seeki+((elem>=0)?elem*4:0));
 } else if ((mode & 
# 518 "project/radare2/libr/util/format.c" 3 4
           (1) 
# 518 "project/radare2/libr/util/format.c"
           && mode & 
# 518 "project/radare2/libr/util/format.c" 3 4
           (1 << 1) 
# 518 "project/radare2/libr/util/format.c"
...
# 518 "project/radare2/libr/util/format.c"
  ...
  char *timestr = malloc (
# 519 "project/radare2/libr/util/format.c" 3 4
                         (26)
# 519 "project/radare2/libr/util/format.c"
                                           );
  if (!timestr) {
   return;
  }
  ...
  *(timestr+24) = '\0';
  if (!(mode & 
# 525 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 525 "project/radare2/libr/util/format.c"
      ) && !(mode & 
# 525 "project/radare2/libr/util/format.c" 3 4
                   (1 << 8)
# 525 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("0x%08" 
# 526 "project/radare2/libr/util/format.c" 3 4
                        "llx" 
# 526 "project/radare2/libr/util/format.c"
  ...
  if (size==-1) {
   ...
   if (!(mode & 
# 531 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 531 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf ("[ ");
   }
   while (size--) {
    updateAddr (buf + i, size - i, endian, &addr, 
# 535 "project/radare2/libr/util/format.c" 3 4
                                                 ((void *)0)
# 535 "project/radare2/libr/util/format.c"
                                                     );
    r_asctime_r (gmtime_r ((time_t*)&addr, &timestruct), timestr);
    *(timestr+24) = '\0';
    if (elem == -1 || elem == 0) {
   ...
   if (!(mode & 
# 552 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 552 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf (" ]");
   }
  }
...
# 557 "project/radare2/libr/util/format.c" 3 4
           (1 << 3) 
# 557 "project/radare2/libr/util/format.c"
           && mode & 
# 557 "project/radare2/libr/util/format.c" 3 4
           (1 << 1)
# 557 "project/radare2/libr/util/format.c"
...
# 557 "project/radare2/libr/util/format.c"
  ...
  char *timestr = malloc (
# 558 "project/radare2/libr/util/format.c" 3 4
                         (26)
# 558 "project/radare2/libr/util/format.c"
                                           );
  if (!timestr) {
   return;
  }
  ...
  *(timestr+24) = '\0';
  if (size==-1) {
   ...
   while (size--) {
    updateAddr (buf + i, size - i, endian, &addr, 
# 569 "project/radare2/libr/util/format.c" 3 4
                                                 ((void *)0)
# 569 "project/radare2/libr/util/format.c"
                                                     );
    r_asctime_r (gmtime_r ((time_t*)&addr, &timestruct), timestr);
    *(timestr+24) = '\0';
    if (elem == -1 || elem == 0) {
  ...
  free (timestr);
  if ((mode & 
# 589 "project/radare2/libr/util/format.c" 3 4
     (1 << 3) 
# 589 "project/radare2/libr/util/format.c"
     && mode & 
# 589 "project/radare2/libr/util/format.c" 3 4
     (1 << 1)
# 589 "project/radare2/libr/util/format.c"
...
static void r_print_format_hex(const RPrint* p, int endian, int mode,
  const char *setval, 
# 597 "project/radare2/libr/util/format.c" 3 4
                     unsigned long long 
# 597 "project/radare2/libr/util/format.c"
                          seeki, 
# 597 "project/radare2/libr/util/format.c" 3 4
                                 unsigned char
# 597 "project/radare2/libr/util/format.c"
...
# 598 "project/radare2/libr/util/format.c" 3 4
unsigned long long 
# 598 "project/radare2/libr/util/format.c"
     addr;
 int elem = -1;
 if (size >= 10000) {
  elem = size/10000 -1;
 ...
 updateAddr (buf + i, size - i, endian, &addr, 
# 604 "project/radare2/libr/util/format.c" 3 4
                                              ((void *)0)
# 604 "project/radare2/libr/util/format.c"
                                                  );
 if ((mode & 
# 605 "project/radare2/libr/util/format.c" 3 4
    (1 << 4) 
# 605 "project/radare2/libr/util/format.c"
    && mode & 
# 605 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 605 "project/radare2/libr/util/format.c"
    && setval)) {
  p->cb_printf ("wv4 %s @ 0x%08"
# 606 "project/radare2/libr/util/format.c" 3 4
                               "llx"
# 606 "project/radare2/libr/util/format.c"
                                      "\n", setval, seeki+((elem>=0)?elem*4:0));
 } else if ((mode & 
# 607 "project/radare2/libr/util/format.c" 3 4
                   (1 << 7)
# 607 "project/radare2/libr/util/format.c"
                              ) || (mode & 
# 607 "project/radare2/libr/util/format.c" 3 4
                                   (1 << 9)
# 607 "project/radare2/libr/util/format.c"
  ...
  p->cb_printf ("%"
# 608 "project/radare2/libr/util/format.c" 3 4
                  "lld"
# 608 "project/radare2/libr/util/format.c"
                         , addr);
 } else if ((mode & 
# 609 "project/radare2/libr/util/format.c" 3 4
           (1) 
# 609 "project/radare2/libr/util/format.c"
           && mode & 
# 609 "project/radare2/libr/util/format.c" 3 4
           (1 << 1) 
# 609 "project/radare2/libr/util/format.c"
...
# 609 "project/radare2/libr/util/format.c"
  ...
  if (!(mode & 
# 610 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 610 "project/radare2/libr/util/format.c"
      ) && !(mode & 
# 610 "project/radare2/libr/util/format.c" 3 4
                   (1 << 8)
# 610 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("0x%08" 
# 611 "project/radare2/libr/util/format.c" 3 4
                        "llx" 
# 611 "project/radare2/libr/util/format.c"
                                " = ", seeki + ((elem >= 0) ? elem * 4 : 0));
  }
  if (size == -1) {
   if (addr == 
# 614 "project/radare2/libr/util/format.c" 3 4
              0xFFFFFFFFFFFFFFFFULL 
# 614 "project/radare2/libr/util/format.c"
                       || addr == 
# 614 "project/radare2/libr/util/format.c" 3 4
                                  0xFFFFFFFFU
# 614 "project/radare2/libr/util/format.c"
    ...
    p->cb_printf ("%"
# 617 "project/radare2/libr/util/format.c" 3 4
                    "lld"
# 617 "project/radare2/libr/util/format.c"
                           , addr);
   }
  } else {
   if (!(mode & 
# 620 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 620 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf ("[ ");
   }
   while (size--) {
    updateAddr (buf + i, size - i, endian, &addr, 
# 624 "project/radare2/libr/util/format.c" 3 4
                                                 ((void *)0)
# 624 "project/radare2/libr/util/format.c"
                                                     );
    if (elem == -1 || elem == 0) {
     if ((mode & 
# 626 "project/radare2/libr/util/format.c" 3 4
        (1 << 8)
# 626 "project/radare2/libr/util/format.c"
        )) {
      if (addr == 
# 627 "project/radare2/libr/util/format.c" 3 4
                 0xFFFFFFFFFFFFFFFFULL 
# 627 "project/radare2/libr/util/format.c"
                          || addr == 
# 627 "project/radare2/libr/util/format.c" 3 4
                                     0xFFFFFFFFU
# 627 "project/radare2/libr/util/format.c"
       ...
       p->cb_printf ("%"
# 630 "project/radare2/libr/util/format.c" 3 4
                       "lld"
# 630 "project/radare2/libr/util/format.c"
                              , addr);
      }
     } else {
      p->cb_printf ("%"
# 633 "project/radare2/libr/util/format.c" 3 4
                      "lld"
# 633 "project/radare2/libr/util/format.c"
                             , addr);
     }
     if (elem == 0) {
      elem = -2;
   ...
   if (!(mode & 
# 647 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 647 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf (" ]");
   }
  }
 } else if ((mode & 
# 651 "project/radare2/libr/util/format.c" 3 4
           (1 << 3) 
# 651 "project/radare2/libr/util/format.c"
           && mode & 
# 651 "project/radare2/libr/util/format.c" 3 4
           (1 << 1)
# 651 "project/radare2/libr/util/format.c"
  ...
  if (size == -1) {
   p->cb_printf ("%"
# 653 "project/radare2/libr/util/format.c" 3 4
                   "lld"
# 653 "project/radare2/libr/util/format.c"
                          , addr);
  } else {
   p->cb_printf ("[ ");
   while (size--) {
    updateAddr (buf + i, size - i, endian, &addr, 
# 657 "project/radare2/libr/util/format.c" 3 4
                                                 ((void *)0)
# 657 "project/radare2/libr/util/format.c"
                                                     );
    if (elem == -1 || elem == 0) {
     p->cb_printf ("%"
# 659 "project/radare2/libr/util/format.c" 3 4
                     "lld"
# 659 "project/radare2/libr/util/format.c"
                            , addr);
     if (elem == 0) {
      elem = -2;
     }
...
static void r_print_format_int(const RPrint* p, int endian, int mode,
  const char *setval, 
# 679 "project/radare2/libr/util/format.c" 3 4
                     unsigned long long 
# 679 "project/radare2/libr/util/format.c"
                          seeki, 
# 679 "project/radare2/libr/util/format.c" 3 4
                                 unsigned char
# 679 "project/radare2/libr/util/format.c"
...
# 680 "project/radare2/libr/util/format.c" 3 4
unsigned long long 
# 680 "project/radare2/libr/util/format.c"
     addr;
 int elem = -1;
 if (size >= 10000) {
  elem = size/10000 -1;
 ...
 updateAddr (buf + i, size - i, endian, &addr, 
# 686 "project/radare2/libr/util/format.c" 3 4
                                              ((void *)0)
# 686 "project/radare2/libr/util/format.c"
                                                  );
 if ((mode & 
# 687 "project/radare2/libr/util/format.c" 3 4
    (1 << 4) 
# 687 "project/radare2/libr/util/format.c"
    && mode & 
# 687 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 687 "project/radare2/libr/util/format.c"
    && setval)) {
  p->cb_printf ("wv4 %s @ %"
# 688 "project/radare2/libr/util/format.c" 3 4
                           "lld"
# 688 "project/radare2/libr/util/format.c"
                                  "\n", setval, seeki+((elem>=0)?elem*4:0));
 } else if ((mode & 
# 689 "project/radare2/libr/util/format.c" 3 4
                   (1 << 7)
# 689 "project/radare2/libr/util/format.c"
                              ) || (mode & 
# 689 "project/radare2/libr/util/format.c" 3 4
                                   (1 << 9)
# 689 "project/radare2/libr/util/format.c"
  ...
  p->cb_printf ("0x%08"
# 690 "project/radare2/libr/util/format.c" 3 4
                      "llx"
# 690 "project/radare2/libr/util/format.c"
                             , addr);
 } else if ((mode & 
# 691 "project/radare2/libr/util/format.c" 3 4
           (1) 
# 691 "project/radare2/libr/util/format.c"
           && mode & 
# 691 "project/radare2/libr/util/format.c" 3 4
           (1 << 1) 
# 691 "project/radare2/libr/util/format.c"
...
# 691 "project/radare2/libr/util/format.c"
  ...
  if (!(mode & 
# 692 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 692 "project/radare2/libr/util/format.c"
      ) && !(mode & 
# 692 "project/radare2/libr/util/format.c" 3 4
                   (1 << 8)
# 692 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("0x%08"
# 693 "project/radare2/libr/util/format.c" 3 4
                       "llx"
# 693 "project/radare2/libr/util/format.c"
                              " = ", seeki+((elem>=0)?elem*4:0));
  }
  if (size == -1) {
   p->cb_printf ("%"
# 696 "project/radare2/libr/util/format.c" 3 4
                   "lld"
# 696 "project/radare2/libr/util/format.c"
                          , (
# 696 "project/radare2/libr/util/format.c" 3 4
                             long long
# 696 "project/radare2/libr/util/format.c"
...
# 696 "project/radare2/libr/util/format.c"
   ...
   if (!(mode & 
# 698 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 698 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf ("[ ");
   }
   while (size--) {
    updateAddr (buf + i, size - i, endian, &addr, 
# 702 "project/radare2/libr/util/format.c" 3 4
                                                 ((void *)0)
# 702 "project/radare2/libr/util/format.c"
                                                     );
    if (elem == -1 || elem == 0) {
     p->cb_printf ("%"
# 704 "project/radare2/libr/util/format.c" 3 4
                     "lld"
# 704 "project/radare2/libr/util/format.c"
                            , (
# 704 "project/radare2/libr/util/format.c" 3 4
                               long long
# 704 "project/radare2/libr/util/format.c"
...
# 704 "project/radare2/libr/util/format.c"
   ...
   if (!(mode & 
# 717 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 717 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf (" ]");
   }
  }
 } else if ((mode & 
# 721 "project/radare2/libr/util/format.c" 3 4
           (1 << 3) 
# 721 "project/radare2/libr/util/format.c"
           && mode & 
# 721 "project/radare2/libr/util/format.c" 3 4
           (1 << 1)
# 721 "project/radare2/libr/util/format.c"
  ...
  if (size == -1) {
   p->cb_printf ("%"
# 723 "project/radare2/libr/util/format.c" 3 4
                   "lld"
# 723 "project/radare2/libr/util/format.c"
                          , addr);
  } else {
   p->cb_printf ("[ ");
   while (size--) {
    updateAddr (buf + i, size - i, endian, &addr, 
# 727 "project/radare2/libr/util/format.c" 3 4
                                                 ((void *)0)
# 727 "project/radare2/libr/util/format.c"
                                                     );
    if (elem == -1 || elem == 0) {
     p->cb_printf ("%"
# 729 "project/radare2/libr/util/format.c" 3 4
                     "lld"
# 729 "project/radare2/libr/util/format.c"
                            , addr);
     if (elem == 0) {
      elem = -2;
     }
...
static int r_print_format_disasm(const RPrint* p, 
# 748 "project/radare2/libr/util/format.c" 3 4
                                                 unsigned long long 
# 748 "project/radare2/libr/util/format.c"
                                                      seeki, int size) {
 
# 749 "project/radare2/libr/util/format.c" 3 4
unsigned long long 
# 749 "project/radare2/libr/util/format.c"
     prevseeki = seeki;
 ...
 size = 
# 755 "project/radare2/libr/util/format.c" 3 4
       (((
# 755 "project/radare2/libr/util/format.c"
       1
# 755 "project/radare2/libr/util/format.c" 3 4
       )>(
# 755 "project/radare2/libr/util/format.c"
...
static void r_print_format_octal(const RPrint* p, int endian, int mode,
  const char *setval, 
# 765 "project/radare2/libr/util/format.c" 3 4
                     unsigned long long 
# 765 "project/radare2/libr/util/format.c"
                          seeki, 
# 765 "project/radare2/libr/util/format.c" 3 4
                                 unsigned char
# 765 "project/radare2/libr/util/format.c"
...
# 766 "project/radare2/libr/util/format.c" 3 4
unsigned long long 
# 766 "project/radare2/libr/util/format.c"
     addr;
 int elem = -1;
 if (size >= 10000) {
  elem = size/10000 -1;
 ...
 updateAddr (buf + i, size - i, endian, &addr, 
# 772 "project/radare2/libr/util/format.c" 3 4
                                              ((void *)0)
# 772 "project/radare2/libr/util/format.c"
                                                  );
 if ((mode & 
# 773 "project/radare2/libr/util/format.c" 3 4
    (1 << 4) 
# 773 "project/radare2/libr/util/format.c"
    && mode & 
# 773 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 773 "project/radare2/libr/util/format.c"
    && setval)) {
  p->cb_printf ("wv4 %s @ 0x%08"
# 774 "project/radare2/libr/util/format.c" 3 4
                               "llx"
# 774 "project/radare2/libr/util/format.c"
                                      "\n", setval, seeki+((elem>=0)?elem*4:0));
 } else if ((mode & 
# 775 "project/radare2/libr/util/format.c" 3 4
                   (1 << 7)
# 775 "project/radare2/libr/util/format.c"
                              ) || (mode & 
# 775 "project/radare2/libr/util/format.c" 3 4
                                   (1 << 9)
# 775 "project/radare2/libr/util/format.c"
  ...
  p->cb_printf ("0%"
# 776 "project/radare2/libr/util/format.c" 3 4
                   "llo"
# 776 "project/radare2/libr/util/format.c"
                          , addr);
 } else if ((mode & 
# 777 "project/radare2/libr/util/format.c" 3 4
           (1) 
# 777 "project/radare2/libr/util/format.c"
           && mode & 
# 777 "project/radare2/libr/util/format.c" 3 4
           (1 << 1) 
# 777 "project/radare2/libr/util/format.c"
...
# 777 "project/radare2/libr/util/format.c"
  ...
  if (!(mode & 
# 778 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 778 "project/radare2/libr/util/format.c"
      ) && !(mode & 
# 778 "project/radare2/libr/util/format.c" 3 4
                   (1 << 8)
# 778 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("0x%08" 
# 779 "project/radare2/libr/util/format.c" 3 4
                        "llx" 
# 779 "project/radare2/libr/util/format.c"
                                " = ", seeki + ((elem >= 0) ? elem * 4 : 0));
  }
  if (!(mode & 
# 781 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 781 "project/radare2/libr/util/format.c"
      )) {
   p->cb_printf ("(octal) ");
  }
  if (size == -1) {
   p->cb_printf (" 0%08"
# 785 "project/radare2/libr/util/format.c" 3 4
                       "llo"
# 785 "project/radare2/libr/util/format.c"
                              , addr);
  } else {
   if (!(mode & 
# 787 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 787 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf ("[ ");
   }
   while (size--) {
    updateAddr (buf + i, size - i, endian, &addr, 
# 791 "project/radare2/libr/util/format.c" 3 4
                                                 ((void *)0)
# 791 "project/radare2/libr/util/format.c"
                                                     );
    if (elem == -1 || elem == 0) {
     p->cb_printf ("0%08"
# 793 "project/radare2/libr/util/format.c" 3 4
                        "llo"
# 793 "project/radare2/libr/util/format.c"
                               , addr);
     if (elem == 0) {
      elem = -2;
     }
   ...
   if (!(mode & 
# 806 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 806 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf (" ]");
   }
  }
 } else if ((mode & 
# 810 "project/radare2/libr/util/format.c" 3 4
           (1 << 3) 
# 810 "project/radare2/libr/util/format.c"
           && mode & 
# 810 "project/radare2/libr/util/format.c" 3 4
           (1 << 1)
# 810 "project/radare2/libr/util/format.c"
  ...
  if (size == -1) {
   p->cb_printf ("%"
# 812 "project/radare2/libr/util/format.c" 3 4
                   "lld"
# 812 "project/radare2/libr/util/format.c"
                          , addr);
  } else {
   p->cb_printf ("[ ");
   while (size--) {
    updateAddr (buf, i, endian, &addr, 
# 816 "project/radare2/libr/util/format.c" 3 4
                                      ((void *)0)
# 816 "project/radare2/libr/util/format.c"
                                          );
    if (elem == -1 || elem == 0) {
     p->cb_printf ("%"
# 818 "project/radare2/libr/util/format.c" 3 4
                     "lld"
# 818 "project/radare2/libr/util/format.c"
                            , addr);
     if (elem == 0) {
      elem = -2;
     }
...
static void r_print_format_hexflag(const RPrint* p, int endian, int mode,
  const char *setval, 
# 838 "project/radare2/libr/util/format.c" 3 4
                     unsigned long long 
# 838 "project/radare2/libr/util/format.c"
                          seeki, 
# 838 "project/radare2/libr/util/format.c" 3 4
                                 unsigned char
# 838 "project/radare2/libr/util/format.c"
...
# 839 "project/radare2/libr/util/format.c" 3 4
unsigned long long 
# 839 "project/radare2/libr/util/format.c"
     addr = 0;
 int elem = -1;
 if (size >= 10000) {
  elem = size/10000 -1;
 ...
 updateAddr (buf + i, size - i, endian, &addr, 
# 845 "project/radare2/libr/util/format.c" 3 4
                                              ((void *)0)
# 845 "project/radare2/libr/util/format.c"
                                                  );
 if ((mode & 
# 846 "project/radare2/libr/util/format.c" 3 4
    (1 << 4) 
# 846 "project/radare2/libr/util/format.c"
    && mode & 
# 846 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 846 "project/radare2/libr/util/format.c"
    && setval)) {
  p->cb_printf ("wv4 %s @ 0x%08"
# 847 "project/radare2/libr/util/format.c" 3 4
                               "llx"
# 847 "project/radare2/libr/util/format.c"
                                      "\n", setval, seeki+((elem>=0)?elem*4:0));
 } else if ((mode & 
# 848 "project/radare2/libr/util/format.c" 3 4
                   (1 << 7)
# 848 "project/radare2/libr/util/format.c"
                              ) || (mode & 
# 848 "project/radare2/libr/util/format.c" 3 4
                                   (1 << 9)
# 848 "project/radare2/libr/util/format.c"
  ...
  p->cb_printf ("0x%08"
# 849 "project/radare2/libr/util/format.c" 3 4
                      "llx"
# 849 "project/radare2/libr/util/format.c"
                             , addr & 
# 849 "project/radare2/libr/util/format.c" 3 4
                                      0xFFFFFFFFU
# 849 "project/radare2/libr/util/format.c"
...
# 850 "project/radare2/libr/util/format.c" 3 4
           (1) 
# 850 "project/radare2/libr/util/format.c"
           && mode & 
# 850 "project/radare2/libr/util/format.c" 3 4
           (1 << 1) 
# 850 "project/radare2/libr/util/format.c"
...
# 851 "project/radare2/libr/util/format.c" 3 4
 unsigned int 
# 851 "project/radare2/libr/util/format.c"
      addr32 = (
# 851 "project/radare2/libr/util/format.c" 3 4
                unsigned int
# 851 "project/radare2/libr/util/format.c"
  ...
  if (!(mode & 
# 852 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 852 "project/radare2/libr/util/format.c"
      ) && !(mode & 
# 852 "project/radare2/libr/util/format.c" 3 4
                   (1 << 8)
# 852 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("0x%08" 
# 853 "project/radare2/libr/util/format.c" 3 4
                        "llx" 
# 853 "project/radare2/libr/util/format.c"
                                " = ", seeki + ((elem >= 0) ? elem * 4 : 0));
  }
  if (size == -1) {
   if ((mode & 
# 856 "project/radare2/libr/util/format.c" 3 4
      (1 << 8)
# 856 "project/radare2/libr/util/format.c"
      ) && (addr32 == 
# 856 "project/radare2/libr/util/format.c" 3 4
                            0xFFFFFFFFU
# 856 "project/radare2/libr/util/format.c"
    ...
    p->cb_printf ("0x%08"
# 859 "project/radare2/libr/util/format.c" 3 4
                        "llx"
# 859 "project/radare2/libr/util/format.c"
                               , (
# 859 "project/radare2/libr/util/format.c" 3 4
                                  unsigned long long
# 859 "project/radare2/libr/util/format.c"
   ...
   if (!(mode & 
# 862 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 862 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf ("[ ");
   }
   while (size--) {
    updateAddr (buf + i, size - i, endian, &addr, 
# 866 "project/radare2/libr/util/format.c" 3 4
                                                 ((void *)0)
# 866 "project/radare2/libr/util/format.c"
                                                     );
    if (elem == -1 || elem == 0) {
     p->cb_printf ("0x%08"
# 868 "project/radare2/libr/util/format.c" 3 4
                         "llx"
# 868 "project/radare2/libr/util/format.c"
                                , addr);
     if (elem == 0) {
      elem = -2;
     }
   ...
   if (!(mode & 
# 881 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 881 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf (" ]");
   }
  }
 } else if ((mode & 
# 885 "project/radare2/libr/util/format.c" 3 4
           (1 << 3) 
# 885 "project/radare2/libr/util/format.c"
           && mode & 
# 885 "project/radare2/libr/util/format.c" 3 4
           (1 << 1)
# 885 "project/radare2/libr/util/format.c"
  ...
  if (size == -1) {
   p->cb_printf ("%"
# 887 "project/radare2/libr/util/format.c" 3 4
                   "lld"
# 887 "project/radare2/libr/util/format.c"
                          , addr);
  } else {
   p->cb_printf ("[ ");
   while (size--) {
    updateAddr (buf + i, size - i, endian, &addr, 
# 891 "project/radare2/libr/util/format.c" 3 4
                                                 ((void *)0)
# 891 "project/radare2/libr/util/format.c"
                                                     );
    if (elem == -1 || elem == 0) {
     p->cb_printf ("%"
# 893 "project/radare2/libr/util/format.c" 3 4
                     "lld"
# 893 "project/radare2/libr/util/format.c"
                            , addr);
     if (elem == 0) {
      elem = -2;
     }
...
# 913 "project/radare2/libr/util/format.c" 3 4
 unsigned long long 
# 913 "project/radare2/libr/util/format.c"
      seeki, 
# 913 "project/radare2/libr/util/format.c" 3 4
             unsigned long long 
# 913 "project/radare2/libr/util/format.c"
...
# 914 "project/radare2/libr/util/format.c" 3 4
unsigned char 
# 914 "project/radare2/libr/util/format.c"
    buffer[255];
 int j;
 if ((mode & 
# 916 "project/radare2/libr/util/format.c" 3 4
    (1 << 4) 
# 916 "project/radare2/libr/util/format.c"
    && mode & 
# 916 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 916 "project/radare2/libr/util/format.c"
...
# 918 "project/radare2/libr/util/format.c" 3 4
                  (1 << 7)
# 918 "project/radare2/libr/util/format.c"
                             ) {
  for (j = 0; j<10; j++) {
   p->cb_printf ("%02x ", buf[j]);
  }
 } else if ((mode & 
# 922 "project/radare2/libr/util/format.c" 3 4
           (1) 
# 922 "project/radare2/libr/util/format.c"
           && mode & 
# 922 "project/radare2/libr/util/format.c" 3 4
           (1 << 1) 
# 922 "project/radare2/libr/util/format.c"
...
# 922 "project/radare2/libr/util/format.c"
  ...
  p->iob.read_at (p->iob.io, (
# 927 "project/radare2/libr/util/format.c" 3 4
                             unsigned long long
# 927 "project/radare2/libr/util/format.c"
                                 )addr, buffer, 248);
  if (!(mode & 
# 928 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 928 "project/radare2/libr/util/format.c"
      ) && !(mode & 
# 928 "project/radare2/libr/util/format.c" 3 4
                   (1 << 8)
# 928 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("0x%08" 
# 929 "project/radare2/libr/util/format.c" 3 4
                        "llx" 
# 929 "project/radare2/libr/util/format.c"
                                " = ", seeki);
  }
  for (j=0; j<10; j++) {
   p->cb_printf ("%02x ", buf[j]);
  ...
  if (!(mode & 
# 934 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 934 "project/radare2/libr/util/format.c"
      )) {
   p->cb_printf (" ... (");
  }
  for (j = 0; j < 10; j++) {
   if (!(mode & 
# 938 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 938 "project/radare2/libr/util/format.c"
       )) {
    if (
# 939 "project/radare2/libr/util/format.c" 3 4
       ((
# 939 "project/radare2/libr/util/format.c"
       buf[j]
# 939 "project/radare2/libr/util/format.c" 3 4
       ) >=' ' && (
# 939 "project/radare2/libr/util/format.c"
...
# 939 "project/radare2/libr/util/format.c"
  ...
  if (!(mode & 
# 946 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 946 "project/radare2/libr/util/format.c"
      )) {
   p->cb_printf (")");
  }
 } else if ((mode & 
# 949 "project/radare2/libr/util/format.c" 3 4
           (1 << 3) 
# 949 "project/radare2/libr/util/format.c"
           && mode & 
# 949 "project/radare2/libr/util/format.c" 3 4
           (1 << 1)
# 949 "project/radare2/libr/util/format.c"
  ...
  if (!p->iob.read_at) {
   ...
   p->iob.read_at (p->iob.io, (
# 954 "project/radare2/libr/util/format.c" 3 4
                              unsigned long long
# 954 "project/radare2/libr/util/format.c"
                                  )addr, buffer, 248);
  }
  p->cb_printf ("[ %d", buf[0]);
  j = 1;
...
static int r_print_format_hexpairs(const RPrint* p, int endian, int mode,
  const char *setval, 
# 968 "project/radare2/libr/util/format.c" 3 4
                     unsigned long long 
# 968 "project/radare2/libr/util/format.c"
                          seeki, 
# 968 "project/radare2/libr/util/format.c" 3 4
                                 unsigned char
# 968 "project/radare2/libr/util/format.c"
 ...
 size = (size == -1) ? 1 : size;
 if ((mode & 
# 971 "project/radare2/libr/util/format.c" 3 4
    (1 << 4) 
# 971 "project/radare2/libr/util/format.c"
    && mode & 
# 971 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 971 "project/radare2/libr/util/format.c"
...
# 973 "project/radare2/libr/util/format.c" 3 4
                  (1 << 7)
# 973 "project/radare2/libr/util/format.c"
                             ) {
  for (j = 0; j < size; j++) {
   p->cb_printf ("%02x", buf[i + j]);
  }
 } else if ((mode & 
# 977 "project/radare2/libr/util/format.c" 3 4
           (1) 
# 977 "project/radare2/libr/util/format.c"
           && mode & 
# 977 "project/radare2/libr/util/format.c" 3 4
           (1 << 1) 
# 977 "project/radare2/libr/util/format.c"
...
# 977 "project/radare2/libr/util/format.c"
  ...
  size = (size < 1) ? 1 : size;
  if (!(mode & 
# 979 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 979 "project/radare2/libr/util/format.c"
      ) && !(mode & 
# 979 "project/radare2/libr/util/format.c" 3 4
                   (1 << 8)
# 979 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("0x%08" 
# 980 "project/radare2/libr/util/format.c" 3 4
                        "llx" 
# 980 "project/radare2/libr/util/format.c"
                                " = ", seeki);
  }
  for (j = 0; j < size; j++) {
   p->cb_printf ("%02x ", buf[i + j]);
  ...
  if (!(mode & 
# 985 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 985 "project/radare2/libr/util/format.c"
      )) {
   p->cb_printf (" ... (");
  }
  for (j=0; j<size; j++) {
   if (!(mode & 
# 989 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 989 "project/radare2/libr/util/format.c"
       )) {
    if (
# 990 "project/radare2/libr/util/format.c" 3 4
       ((
# 990 "project/radare2/libr/util/format.c"
       buf[j]
# 990 "project/radare2/libr/util/format.c" 3 4
       ) >=' ' && (
# 990 "project/radare2/libr/util/format.c"
...
# 998 "project/radare2/libr/util/format.c" 3 4
           (1 << 3) 
# 998 "project/radare2/libr/util/format.c"
           && mode & 
# 998 "project/radare2/libr/util/format.c" 3 4
           (1 << 1)
# 998 "project/radare2/libr/util/format.c"
...
# 998 "project/radare2/libr/util/format.c"
  ...
  p->cb_printf ("]");
  if ((mode & 
# 1006 "project/radare2/libr/util/format.c" 3 4
     (1 << 3) 
# 1006 "project/radare2/libr/util/format.c"
     && mode & 
# 1006 "project/radare2/libr/util/format.c" 3 4
     (1 << 1)
# 1006 "project/radare2/libr/util/format.c"
...
static void r_print_format_float(const RPrint* p, int endian, int mode,
  const char *setval, 
# 1015 "project/radare2/libr/util/format.c" 3 4
                     unsigned long long 
# 1015 "project/radare2/libr/util/format.c"
                          seeki, const 
# 1015 "project/radare2/libr/util/format.c" 3 4
                                       unsigned char
# 1015 "project/radare2/libr/util/format.c"
...
# 1016 "project/radare2/libr/util/format.c" 3 4
unsigned long long 
# 1016 "project/radare2/libr/util/format.c"
     addr = 0;
 int elem = -1;
 if (size >= 10000) {
  elem = size / 10000 - 1;
 ...
 float val_f = updateAddr (buf + i, 999, endian, &addr, 
# 1022 "project/radare2/libr/util/format.c" 3 4
                                                       ((void *)0)
# 1022 "project/radare2/libr/util/format.c"
                                                           );
 if ((mode & 
# 1023 "project/radare2/libr/util/format.c" 3 4
    (1 << 4) 
# 1023 "project/radare2/libr/util/format.c"
    && mode & 
# 1023 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 1023 "project/radare2/libr/util/format.c"
    && setval)) {
  p->cb_printf ("wv4 %s @ 0x%08"
# 1024 "project/radare2/libr/util/format.c" 3 4
                               "llx"
# 1024 "project/radare2/libr/util/format.c"
                                      "\n", setval,
   seeki + ((elem >= 0) ? elem * 4 : 0));
 } else if ((mode & 
# 1026 "project/radare2/libr/util/format.c" 3 4
                   (1 << 7)
# 1026 "project/radare2/libr/util/format.c"
                              ) || (mode & 
# 1026 "project/radare2/libr/util/format.c" 3 4
                                   (1 << 9)
# 1026 "project/radare2/libr/util/format.c"
  ...
  if ((mode & 
# 1029 "project/radare2/libr/util/format.c" 3 4
     (1) 
# 1029 "project/radare2/libr/util/format.c"
     && mode & 
# 1029 "project/radare2/libr/util/format.c" 3 4
     (1 << 1) 
# 1029 "project/radare2/libr/util/format.c"
...
# 1029 "project/radare2/libr/util/format.c"
   ...
   if (!(mode & 
# 1030 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 1030 "project/radare2/libr/util/format.c"
       ) && !(mode & 
# 1030 "project/radare2/libr/util/format.c" 3 4
                    (1 << 8)
# 1030 "project/radare2/libr/util/format.c"
    ...
    p->cb_printf ("0x%08"
# 1031 "project/radare2/libr/util/format.c" 3 4
                        "llx"
# 1031 "project/radare2/libr/util/format.c"
                               " = ",
     seeki + ((elem >= 0) ? elem * 4 : 0));
   }
  }
  if (size == -1) {
   ...
   if (!(mode & 
# 1038 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 1038 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf ("[ ");
   }
   while (size--) {
    val_f = updateAddr (buf + i, 9999, endian, &addr, 
# 1042 "project/radare2/libr/util/format.c" 3 4
                                                     ((void *)0)
# 1042 "project/radare2/libr/util/format.c"
                                                         );
    if (elem == -1 || elem == 0) {
     p->cb_printf ("%.9g", val_f);
     if (elem == 0) {
   ...
   if (!(mode & 
# 1057 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 1057 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf (" ]");
   }
  }
  if ((mode & 
# 1061 "project/radare2/libr/util/format.c" 3 4
     (1 << 3) 
# 1061 "project/radare2/libr/util/format.c"
     && mode & 
# 1061 "project/radare2/libr/util/format.c" 3 4
     (1 << 1)
# 1061 "project/radare2/libr/util/format.c"
...
static void r_print_format_long_double(const RPrint* p, int endian, int mode,
  const char *setval, 
# 1068 "project/radare2/libr/util/format.c" 3 4
                     unsigned long long 
# 1068 "project/radare2/libr/util/format.c"
                          seeki, 
# 1068 "project/radare2/libr/util/format.c" 3 4
                                 unsigned char
# 1068 "project/radare2/libr/util/format.c"
...
# 1070 "project/radare2/libr/util/format.c" 3 4
unsigned long long 
# 1070 "project/radare2/libr/util/format.c"
     addr = 0;
 int elem = -1;
 if (size >= 10000) {
  elem = size/10000 - 1;
 ...
 updateAddr (buf + i, 999, endian, &addr, 
# 1076 "project/radare2/libr/util/format.c" 3 4
                                         ((void *)0)
# 1076 "project/radare2/libr/util/format.c"
                                             );
 r_mem_swaporcopy ((
# 1077 "project/radare2/libr/util/format.c" 3 4
                   unsigned char
# 1077 "project/radare2/libr/util/format.c"
                      *)&val_f, buf + i, sizeof (long double), endian);
 if ((mode & 
# 1078 "project/radare2/libr/util/format.c" 3 4
    (1 << 4) 
# 1078 "project/radare2/libr/util/format.c"
    && mode & 
# 1078 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 1078 "project/radare2/libr/util/format.c"
    && setval)) {
  p->cb_printf ("wv8 %s @ 0x%08"
# 1079 "project/radare2/libr/util/format.c" 3 4
                               "llx"
# 1079 "project/radare2/libr/util/format.c"
                                      "\n", setval,
   seeki + ((elem >= 0) ? elem * 8 : 0));
 } else if ((mode & 
# 1081 "project/radare2/libr/util/format.c" 3 4
                   (1 << 7)
# 1081 "project/radare2/libr/util/format.c"
                              ) || (mode & 
# 1081 "project/radare2/libr/util/format.c" 3 4
                                   (1 << 9)
# 1081 "project/radare2/libr/util/format.c"
  ...
  if ((mode & 
# 1084 "project/radare2/libr/util/format.c" 3 4
     (1) 
# 1084 "project/radare2/libr/util/format.c"
     && mode & 
# 1084 "project/radare2/libr/util/format.c" 3 4
     (1 << 1) 
# 1084 "project/radare2/libr/util/format.c"
...
# 1084 "project/radare2/libr/util/format.c"
   ...
   if (!(mode & 
# 1085 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 1085 "project/radare2/libr/util/format.c"
       ) && !(mode & 
# 1085 "project/radare2/libr/util/format.c" 3 4
                    (1 << 8)
# 1085 "project/radare2/libr/util/format.c"
    ...
    p->cb_printf ("0x%08"
# 1086 "project/radare2/libr/util/format.c" 3 4
                        "llx"
# 1086 "project/radare2/libr/util/format.c"
                               " = ",
     seeki + ((elem >= 0) ? elem * 8 : 0));
   }
  }
  if (size == -1) {
   ...
   if (!(mode & 
# 1093 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 1093 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf ("[ ");
   }
   while (size--) {

    updateAddr (buf + i, 9999, endian, &addr, 
# 1098 "project/radare2/libr/util/format.c" 3 4
                                             ((void *)0)
# 1098 "project/radare2/libr/util/format.c"
                                                 );
    r_mem_swaporcopy ((
# 1099 "project/radare2/libr/util/format.c" 3 4
                      unsigned char
# 1099 "project/radare2/libr/util/format.c"
                         *)&val_f, buf + i, sizeof (double), endian);
    if (elem == -1 || elem == 0) {
     p->cb_printf ("%.17Lg", val_f);
     if (elem == 0) {
      elem = -2;
   ...
   if (!(mode & 
# 1114 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 1114 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf (" ]");
   }
  }
  if ((mode & 
# 1118 "project/radare2/libr/util/format.c" 3 4
     (1 << 3) 
# 1118 "project/radare2/libr/util/format.c"
     && mode & 
# 1118 "project/radare2/libr/util/format.c" 3 4
     (1 << 1)
# 1118 "project/radare2/libr/util/format.c"
...
static void r_print_format_double(const RPrint* p, int endian, int mode,
  const char *setval, 
# 1125 "project/radare2/libr/util/format.c" 3 4
                     unsigned long long 
# 1125 "project/radare2/libr/util/format.c"
                          seeki, 
# 1125 "project/radare2/libr/util/format.c" 3 4
                                 unsigned char
# 1125 "project/radare2/libr/util/format.c"
...
# 1127 "project/radare2/libr/util/format.c" 3 4
unsigned long long 
# 1127 "project/radare2/libr/util/format.c"
     addr = 0;
 int elem = -1;
 if (size >= 10000) {
  elem = size/10000 - 1;
 ...
 updateAddr (buf + i, 999, endian, &addr, 
# 1133 "project/radare2/libr/util/format.c" 3 4
                                         ((void *)0)
# 1133 "project/radare2/libr/util/format.c"
                                             );
 r_mem_swaporcopy ((
# 1134 "project/radare2/libr/util/format.c" 3 4
                   unsigned char
# 1134 "project/radare2/libr/util/format.c"
                      *)&val_f, buf + i, sizeof (double), endian);
 if ((mode & 
# 1135 "project/radare2/libr/util/format.c" 3 4
    (1 << 4) 
# 1135 "project/radare2/libr/util/format.c"
    && mode & 
# 1135 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 1135 "project/radare2/libr/util/format.c"
    && setval)) {
  p->cb_printf ("wv8 %s @ 0x%08"
# 1136 "project/radare2/libr/util/format.c" 3 4
                               "llx"
# 1136 "project/radare2/libr/util/format.c"
                                      "\n", setval,
   seeki + ((elem >= 0) ? elem * 8 : 0));
 } else if ((mode & 
# 1138 "project/radare2/libr/util/format.c" 3 4
                   (1 << 7)
# 1138 "project/radare2/libr/util/format.c"
                              ) || (mode & 
# 1138 "project/radare2/libr/util/format.c" 3 4
                                   (1 << 9)
# 1138 "project/radare2/libr/util/format.c"
  ...
  if ((mode & 
# 1141 "project/radare2/libr/util/format.c" 3 4
     (1) 
# 1141 "project/radare2/libr/util/format.c"
     && mode & 
# 1141 "project/radare2/libr/util/format.c" 3 4
     (1 << 1) 
# 1141 "project/radare2/libr/util/format.c"
...
# 1141 "project/radare2/libr/util/format.c"
   ...
   if (!(mode & 
# 1142 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 1142 "project/radare2/libr/util/format.c"
       ) && !(mode & 
# 1142 "project/radare2/libr/util/format.c" 3 4
                    (1 << 8)
# 1142 "project/radare2/libr/util/format.c"
    ...
    p->cb_printf ("0x%08"
# 1143 "project/radare2/libr/util/format.c" 3 4
                        "llx"
# 1143 "project/radare2/libr/util/format.c"
                               " = ",
     seeki + ((elem >= 0) ? elem * 8 : 0));
   }
  }
  if (size == -1) {
   ...
   if (!(mode & 
# 1150 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 1150 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf ("[ ");
   }
   while (size--) {
    ...
    updateAddr (buf + i, 9999, endian, &addr, 
# 1155 "project/radare2/libr/util/format.c" 3 4
                                             ((void *)0)
# 1155 "project/radare2/libr/util/format.c"
                                                 );
    r_mem_swaporcopy ((
# 1156 "project/radare2/libr/util/format.c" 3 4
                      unsigned char
# 1156 "project/radare2/libr/util/format.c"
                         *)&val_f, buf + i, sizeof (double), endian);
    if (elem == -1 || elem == 0) {
     p->cb_printf ("%.17lg", val_f);
     if (elem == 0) {
   ...
   if (!(mode & 
# 1171 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 1171 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf (" ]");
   }
  }
  if ((mode & 
# 1175 "project/radare2/libr/util/format.c" 3 4
     (1 << 3) 
# 1175 "project/radare2/libr/util/format.c"
     && mode & 
# 1175 "project/radare2/libr/util/format.c" 3 4
     (1 << 1)
# 1175 "project/radare2/libr/util/format.c"
...
static void r_print_format_word(const RPrint* p, int endian, int mode,
  const char *setval, 
# 1182 "project/radare2/libr/util/format.c" 3 4
                     unsigned long long 
# 1182 "project/radare2/libr/util/format.c"
                          seeki, 
# 1182 "project/radare2/libr/util/format.c" 3 4
                                 unsigned char
# 1182 "project/radare2/libr/util/format.c"
...
# 1183 "project/radare2/libr/util/format.c" 3 4
unsigned long long 
# 1183 "project/radare2/libr/util/format.c"
     addr;
 int elem = -1;
 if (size >= 10000) {
  elem = size/10000 -1;
 ...
 addr = endian
  ...
  : (*(buf + i + 1)) << 8 | (*(buf + i));
 if ((mode & 
# 1192 "project/radare2/libr/util/format.c" 3 4
    (1 << 4) 
# 1192 "project/radare2/libr/util/format.c"
    && mode & 
# 1192 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 1192 "project/radare2/libr/util/format.c"
    && setval)) {
  p->cb_printf ("wv2 %s @ 0x%08"
# 1193 "project/radare2/libr/util/format.c" 3 4
                               "llx"
# 1193 "project/radare2/libr/util/format.c"
                                      "\n", setval, seeki+((elem>=0)?elem*2:0));
 } else if ((mode & 
# 1194 "project/radare2/libr/util/format.c" 3 4
                   (1 << 7)
# 1194 "project/radare2/libr/util/format.c"
                              ) || (mode & 
# 1194 "project/radare2/libr/util/format.c" 3 4
                                   (1 << 9)
# 1194 "project/radare2/libr/util/format.c"
  ...
  if (size == -1) {
   p->cb_printf ("0x%04"
# 1196 "project/radare2/libr/util/format.c" 3 4
                       "llx"
# 1196 "project/radare2/libr/util/format.c"
                              , addr);
  }
  while ((size -= 2) > 0) {
   addr = endian
   ...
   if (elem == -1 || elem == 0) {
    p->cb_printf ("%"
# 1203 "project/radare2/libr/util/format.c" 3 4
                    "lld"
# 1203 "project/radare2/libr/util/format.c"
                           , addr);
    if (elem == 0) {
     elem = -2;
    }
...
# 1216 "project/radare2/libr/util/format.c" 3 4
           (1) 
# 1216 "project/radare2/libr/util/format.c"
           && mode & 
# 1216 "project/radare2/libr/util/format.c" 3 4
           (1 << 1) 
# 1216 "project/radare2/libr/util/format.c"
...
# 1216 "project/radare2/libr/util/format.c"
  ...
  if (!(mode & 
# 1217 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 1217 "project/radare2/libr/util/format.c"
      ) && !(mode & 
# 1217 "project/radare2/libr/util/format.c" 3 4
                   (1 << 8)
# 1217 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("0x%08"
# 1218 "project/radare2/libr/util/format.c" 3 4
                       "llx"
# 1218 "project/radare2/libr/util/format.c"
                              " = ", seeki+((elem>=0)?elem*2:0));
  }
  if (size==-1) {
   p->cb_printf ("0x%04"
# 1221 "project/radare2/libr/util/format.c" 3 4
                       "llx"
# 1221 "project/radare2/libr/util/format.c"
                              , addr);
  } else {
   if (!(mode & 
# 1223 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 1223 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf ("[ ");
   }
   while (size--) {
    ...
    if (elem == -1 || elem == 0) {
     p->cb_printf ("0x%04"
# 1231 "project/radare2/libr/util/format.c" 3 4
                         "llx"
# 1231 "project/radare2/libr/util/format.c"
                                , addr);
     if (elem == 0) {
      elem = -2;
     }
   ...
   if (!(mode & 
# 1244 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 1244 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf (" ]");
   }
  }
 } else if ((mode & 
# 1248 "project/radare2/libr/util/format.c" 3 4
           (1 << 3) 
# 1248 "project/radare2/libr/util/format.c"
           && mode & 
# 1248 "project/radare2/libr/util/format.c" 3 4
           (1 << 1)
# 1248 "project/radare2/libr/util/format.c"
  ...
  if (size==-1) {
   p->cb_printf ("%"
# 1250 "project/radare2/libr/util/format.c" 3 4
                   "lld"
# 1250 "project/radare2/libr/util/format.c"
                          , addr);
  } else {
   p->cb_printf ("[ ");
   while ( (size -= 2) >0) {
    ...
    if (elem == -1 || elem == 0) {
     p->cb_printf ("%"
# 1258 "project/radare2/libr/util/format.c" 3 4
                     "lld"
# 1258 "project/radare2/libr/util/format.c"
                            , addr);
     if (elem == 0) {
      elem = -2;
     }
...
# 1278 "project/radare2/libr/util/format.c" 3 4
do { if (!(
# 1278 "project/radare2/libr/util/format.c"
p->strconv_mode
# 1278 "project/radare2/libr/util/format.c" 3 4
...
static void r_print_format_nulltermstring(const RPrint* p, int len, int endian, int mode,
  const char *setval, 
# 1283 "project/radare2/libr/util/format.c" 3 4
                     unsigned long long 
# 1283 "project/radare2/libr/util/format.c"
                          seeki, 
# 1283 "project/radare2/libr/util/format.c" 3 4
                                 unsigned char
# 1283 "project/radare2/libr/util/format.c"
...
# 1285 "project/radare2/libr/util/format.c" 3 4
 unsigned char 
# 1285 "project/radare2/libr/util/format.c"
     ch = 0xff;
 ...
 if (p->flags & 
# 1292 "project/radare2/libr/util/format.c" 3 4
               0x00080000 
# 1292 "project/radare2/libr/util/format.c"
                                     && !(p->iob.io->cached & 
# 1292 "project/radare2/libr/util/format.c" 3 4
                                                              4
# 1292 "project/radare2/libr/util/format.c"
...
# 1293 "project/radare2/libr/util/format.c" 3 4
 unsigned long long 
# 1293 "project/radare2/libr/util/format.c"
      total_map_left = 0;
  
# 1294 "project/radare2/libr/util/format.c" 3 4
 unsigned long long 
# 1294 "project/radare2/libr/util/format.c"
      addr = seeki;
  RIOMap *map;
  while (total_map_left < len
    ...
    && map->perm & 
# 1300 "project/radare2/libr/util/format.c" 3 4
                  4
# 1300 "project/radare2/libr/util/format.c"
                          ) {
   if (!
# 1301 "project/radare2/libr/util/format.c" 3 4
       r_itv_size (
# 1301 "project/radare2/libr/util/format.c"
       map
# 1301 "project/radare2/libr/util/format.c" 3 4
       ->itv)
# 1301 "project/radare2/libr/util/format.c"
    ...
    total_map_left = addr == 0
     ? 
# 1303 "project/radare2/libr/util/format.c" 3 4
      0xFFFFFFFFFFFFFFFFULL
     
# 1304 "project/radare2/libr/util/format.c"
    : 
# 1304 "project/radare2/libr/util/format.c" 3 4
      0xFFFFFFFFFFFFFFFFULL 
# 1304 "project/radare2/libr/util/format.c"
               - addr + 1;
    break;
   ...
   total_map_left += 
# 1307 "project/radare2/libr/util/format.c" 3 4
                    r_itv_size (
# 1307 "project/radare2/libr/util/format.c"
                    map
# 1307 "project/radare2/libr/util/format.c" 3 4
                    ->itv) 
# 1307 "project/radare2/libr/util/format.c"
                                        - (addr
    - (p->iob.io->va ? 
# 1308 "project/radare2/libr/util/format.c" 3 4
                      r_itv_begin (
# 1308 "project/radare2/libr/util/format.c"
                      map
# 1308 "project/radare2/libr/util/format.c" 3 4
                      ->itv) 
# 1308 "project/radare2/libr/util/format.c"
...
# 1316 "project/radare2/libr/util/format.c" 3 4
_Bool 
# 1316 "project/radare2/libr/util/format.c"
     overflow = (size == -1 || size > len - i) && str_len == len - i;
 if ((mode & 
# 1317 "project/radare2/libr/util/format.c" 3 4
    (1 << 4) 
# 1317 "project/radare2/libr/util/format.c"
    && mode & 
# 1317 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 1317 "project/radare2/libr/util/format.c"
...
# 1328 "project/radare2/libr/util/format.c" 3 4
  fprintf(__stderrp,
# 1328 "project/radare2/libr/util/format.c"
...
# 1328 "project/radare2/libr/util/format.c"
  ...
  p->cb_printf (" @ 0x%08"
# 1339 "project/radare2/libr/util/format.c" 3 4
                         "llx"
# 1339 "project/radare2/libr/util/format.c"
                                "\n", seeki);
  free (ons);
 } else if ((mode & 
# 1341 "project/radare2/libr/util/format.c" 3 4
                   (1 << 7)
# 1341 "project/radare2/libr/util/format.c"
                              ) || (mode & 
# 1341 "project/radare2/libr/util/format.c" 3 4
                                   (1 << 9)
# 1341 "project/radare2/libr/util/format.c"
  ...
  int j = i;
  ((mode & 
# 1343 "project/radare2/libr/util/format.c" 3 4
  (1 << 9)
# 1343 "project/radare2/libr/util/format.c"
  )) ?
   p->cb_printf ("\"") :
   p->cb_printf ("\\\"");
...
# 1350 "project/radare2/libr/util/format.c" 3 4
             ((
# 1350 "project/radare2/libr/util/format.c"
             ch
# 1350 "project/radare2/libr/util/format.c" 3 4
             ) >=' ' && (
# 1350 "project/radare2/libr/util/format.c"
...
# 1350 "project/radare2/libr/util/format.c"
  ...
  ((mode & 
# 1356 "project/radare2/libr/util/format.c" 3 4
  (1 << 9)
# 1356 "project/radare2/libr/util/format.c"
  )) ?
   p->cb_printf ("\"") :
   p->cb_printf ("\\\"");
 } else if ((mode & 
# 1359 "project/radare2/libr/util/format.c" 3 4
           (1) 
# 1359 "project/radare2/libr/util/format.c"
           && mode & 
# 1359 "project/radare2/libr/util/format.c" 3 4
           (1 << 1) 
# 1359 "project/radare2/libr/util/format.c"
...
# 1359 "project/radare2/libr/util/format.c"
  ...
  int j = i;
  if (!(mode & 
# 1361 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 1361 "project/radare2/libr/util/format.c"
      ) && !(mode & 
# 1361 "project/radare2/libr/util/format.c" 3 4
                   (1 << 8)
# 1361 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("0x%08" 
# 1362 "project/radare2/libr/util/format.c" 3 4
                        "llx" 
# 1362 "project/radare2/libr/util/format.c"
                                " = %s", seeki, overflow ? "ovf " : "");
  }
  p->cb_printf ("\"");
  for (; j < len && ((size == -1 || size-- > 0) && buf[j]) ; j++) {
   char esc_str[5] = { 0 };
   char *ptr = esc_str;
   r_print_byte_escape (p, (char *)&buf[j], &ptr, 
# 1368 "project/radare2/libr/util/format.c" 3 4
                                                 0
# 1368 "project/radare2/libr/util/format.c"
                                                      );
   p->cb_printf ("%s", esc_str);
  }
  p->cb_printf ("\"");
 } else if ((mode & 
# 1372 "project/radare2/libr/util/format.c" 3 4
           (1 << 3) 
# 1372 "project/radare2/libr/util/format.c"
           && mode & 
# 1372 "project/radare2/libr/util/format.c" 3 4
           (1 << 1)
# 1372 "project/radare2/libr/util/format.c"
           )) {
  char *utf_encoded_buf = 
# 1373 "project/radare2/libr/util/format.c" 3 4
                         ((void *)0)
# 1373 "project/radare2/libr/util/format.c"
                             ;
  p->cb_printf ("\"");
  utf_encoded_buf = r_str_escape_utf8_for_json (
      (char *)buf + i, size == -1 ? str_len : 
# 1376 "project/radare2/libr/util/format.c" 3 4
                                             (((
# 1376 "project/radare2/libr/util/format.c"
                                             size
# 1376 "project/radare2/libr/util/format.c" 3 4
                                             )>(
# 1376 "project/radare2/libr/util/format.c"
...
static void r_print_format_nulltermwidestring(const RPrint* p, const int len, int endian, int mode,
  const char *setval, 
# 1390 "project/radare2/libr/util/format.c" 3 4
                     unsigned long long 
# 1390 "project/radare2/libr/util/format.c"
                          seeki, 
# 1390 "project/radare2/libr/util/format.c" 3 4
                                 unsigned char
# 1390 "project/radare2/libr/util/format.c"
                                    * buf, int i, int size) {
 if ((mode & 
# 1391 "project/radare2/libr/util/format.c" 3 4
    (1 << 4) 
# 1391 "project/radare2/libr/util/format.c"
    && mode & 
# 1391 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 1391 "project/radare2/libr/util/format.c"
...
# 1402 "project/radare2/libr/util/format.c" 3 4
  fprintf(__stderrp,
# 1402 "project/radare2/libr/util/format.c"
  "Warning: new string is longer than previous one\n"
# 1402 "project/radare2/libr/util/format.c" 3 4
  )
# 1402 "project/radare2/libr/util/format.c"
  ...
  p->cb_printf ("ww %s @ 0x%08"
# 1404 "project/radare2/libr/util/format.c" 3 4
                              "llx"
# 1404 "project/radare2/libr/util/format.c"
                                     "\n", newstring, seeki);
  free(ons);
 } else if ((mode & 
# 1406 "project/radare2/libr/util/format.c" 3 4
           (1) 
# 1406 "project/radare2/libr/util/format.c"
           && mode & 
# 1406 "project/radare2/libr/util/format.c" 3 4
           (1 << 1) 
# 1406 "project/radare2/libr/util/format.c"
...
# 1406 "project/radare2/libr/util/format.c"
  ...
  int j = i;
  if (!(mode & 
# 1408 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 1408 "project/radare2/libr/util/format.c"
      ) && !(mode & 
# 1408 "project/radare2/libr/util/format.c" 3 4
                   (1 << 8)
# 1408 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("0x%08"
# 1409 "project/radare2/libr/util/format.c" 3 4
                       "llx"
# 1409 "project/radare2/libr/util/format.c"
                              " = ", seeki);
  }
  for (; j<len && ((size==-1 || size-->0) && buf[j]) ; j+=2) {
   if (
# 1412 "project/radare2/libr/util/format.c" 3 4
      ((
# 1412 "project/radare2/libr/util/format.c"
      buf[j]
# 1412 "project/radare2/libr/util/format.c" 3 4
      ) >=' ' && (
# 1412 "project/radare2/libr/util/format.c"
...
# 1418 "project/radare2/libr/util/format.c" 3 4
           (1 << 3) 
# 1418 "project/radare2/libr/util/format.c"
           && mode & 
# 1418 "project/radare2/libr/util/format.c" 3 4
           (1 << 1)
# 1418 "project/radare2/libr/util/format.c"
  ...
  int j = i;
  p->cb_printf ("%"
# 1420 "project/radare2/libr/util/format.c" 3 4
                  "lld"
# 1420 "project/radare2/libr/util/format.c"
                         ",\"string\":\"", seeki);
  for (; j < len && ((size == -1 || size-- > 0) && buf[j]); j += 2) {
   if (
# 1422 "project/radare2/libr/util/format.c" 3 4
      ((
# 1422 "project/radare2/libr/util/format.c"
      buf[j]
# 1422 "project/radare2/libr/util/format.c" 3 4
      ) >=' ' && (
# 1422 "project/radare2/libr/util/format.c"
...
static void r_print_format_bitfield(const RPrint* p, 
# 1432 "project/radare2/libr/util/format.c" 3 4
                                                    unsigned long long 
# 1432 "project/radare2/libr/util/format.c"
                                                         seeki, char *fmtname,
  char *fieldname, 
# 1433 "project/radare2/libr/util/format.c" 3 4
                  unsigned long long 
# 1433 "project/radare2/libr/util/format.c"
                       addr, int mode, int size) {
 char *bitfield = 
# 1434 "project/radare2/libr/util/format.c" 3 4
                 ((void *)0)
# 1434 "project/radare2/libr/util/format.c"
                     ;
 addr &= (1ULL << (size * 8)) - 1;
 if ((mode & 
# 1436 "project/radare2/libr/util/format.c" 3 4
    (1) 
# 1436 "project/radare2/libr/util/format.c"
    && mode & 
# 1436 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 1436 "project/radare2/libr/util/format.c"
...
# 1436 "project/radare2/libr/util/format.c"
  ...
  p->cb_printf ("0x%08"
# 1437 "project/radare2/libr/util/format.c" 3 4
                      "llx"
# 1437 "project/radare2/libr/util/format.c"
                             " = ", seeki);
 }
 bitfield = r_type_enum_getbitfield (p->sdb_types, fmtname, addr);
 if (bitfield && *bitfield) {
  if ((mode & 
# 1441 "project/radare2/libr/util/format.c" 3 4
     (1 << 3) 
# 1441 "project/radare2/libr/util/format.c"
     && mode & 
# 1441 "project/radare2/libr/util/format.c" 3 4
     (1 << 1)
# 1441 "project/radare2/libr/util/format.c"
...
# 1443 "project/radare2/libr/util/format.c" 3 4
            (1) 
# 1443 "project/radare2/libr/util/format.c"
            && mode & 
# 1443 "project/radare2/libr/util/format.c" 3 4
            (1 << 1) 
# 1443 "project/radare2/libr/util/format.c"
...
# 1443 "project/radare2/libr/util/format.c"
  ...
  if ((mode & 
# 1447 "project/radare2/libr/util/format.c" 3 4
     (1 << 3) 
# 1447 "project/radare2/libr/util/format.c"
     && mode & 
# 1447 "project/radare2/libr/util/format.c" 3 4
     (1 << 1)
# 1447 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("\"`tb %s 0x%"
# 1448 "project/radare2/libr/util/format.c" 3 4
                              "llx"
# 1448 "project/radare2/libr/util/format.c"
                                     "`\"}", fmtname, addr);
  } else if ((mode & 
# 1449 "project/radare2/libr/util/format.c" 3 4
            (1) 
# 1449 "project/radare2/libr/util/format.c"
            && mode & 
# 1449 "project/radare2/libr/util/format.c" 3 4
            (1 << 1) 
# 1449 "project/radare2/libr/util/format.c"
...
# 1449 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("%s (bitfield) = `tb %s 0x%"
# 1450 "project/radare2/libr/util/format.c" 3 4
                                            "llx"
# 1450 "project/radare2/libr/util/format.c"
                                                   "`\n",
...
static void r_print_format_enum(const RPrint* p, 
# 1457 "project/radare2/libr/util/format.c" 3 4
                                                unsigned long long 
# 1457 "project/radare2/libr/util/format.c"
                                                     seeki, char *fmtname,
  char *fieldname, 
# 1458 "project/radare2/libr/util/format.c" 3 4
                  unsigned long long 
# 1458 "project/radare2/libr/util/format.c"
                       addr, int mode, int size) {
 char *enumvalue = 
# 1459 "project/radare2/libr/util/format.c" 3 4
                  ((void *)0)
# 1459 "project/radare2/libr/util/format.c"
                      ;
 if (size >= 8) {
 ...
 if ((mode & 
# 1465 "project/radare2/libr/util/format.c" 3 4
    (1) 
# 1465 "project/radare2/libr/util/format.c"
    && mode & 
# 1465 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 1465 "project/radare2/libr/util/format.c"
...
# 1465 "project/radare2/libr/util/format.c"
  ...
  p->cb_printf ("0x%08"
# 1466 "project/radare2/libr/util/format.c" 3 4
                      "llx"
# 1466 "project/radare2/libr/util/format.c"
                             " = ", seeki);
 }
 enumvalue = r_type_enum_member (p->sdb_types, fmtname, 
# 1468 "project/radare2/libr/util/format.c" 3 4
                                                       ((void *)0)
# 1468 "project/radare2/libr/util/format.c"
                                                           , addr);
 if (enumvalue && *enumvalue) {
  if (mode & 
# 1470 "project/radare2/libr/util/format.c" 3 4
            (1 << 7)
# 1470 "project/radare2/libr/util/format.c"
                       ) {
   p->cb_printf ("%s.%s", fmtname, enumvalue);
  } else if ((mode & 
# 1472 "project/radare2/libr/util/format.c" 3 4
            (1 << 3) 
# 1472 "project/radare2/libr/util/format.c"
            && mode & 
# 1472 "project/radare2/libr/util/format.c" 3 4
            (1 << 1)
# 1472 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("%"
# 1473 "project/radare2/libr/util/format.c" 3 4
                   "lld"
# 1473 "project/radare2/libr/util/format.c"
                          ",\"label\":\"%s\",\"enum\":\"%s\"}",
    addr, enumvalue, fmtname);
  } else if ((mode & 
# 1475 "project/radare2/libr/util/format.c" 3 4
            (1) 
# 1475 "project/radare2/libr/util/format.c"
            && mode & 
# 1475 "project/radare2/libr/util/format.c" 3 4
            (1 << 1) 
# 1475 "project/radare2/libr/util/format.c"
...
# 1475 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("%s (enum %s) = 0x%"
# 1476 "project/radare2/libr/util/format.c" 3 4
                                    "llx"
# 1476 "project/radare2/libr/util/format.c"
                                           " ; %s\n",
    fieldname, fmtname, addr, enumvalue);
  } else if ((mode & 
# 1478 "project/radare2/libr/util/format.c" 3 4
            (1 << 9)
# 1478 "project/radare2/libr/util/format.c"
            )) {
   p->cb_printf ("%s", enumvalue);
  }
 } else {
  if ((mode & 
# 1482 "project/radare2/libr/util/format.c" 3 4
     (1 << 3) 
# 1482 "project/radare2/libr/util/format.c"
     && mode & 
# 1482 "project/radare2/libr/util/format.c" 3 4
     (1 << 1)
# 1482 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("%"
# 1483 "project/radare2/libr/util/format.c" 3 4
                   "lld"
# 1483 "project/radare2/libr/util/format.c"
                          ",\"enum\":\"%s\"}", addr, fmtname);
  } else if ((mode & 
# 1484 "project/radare2/libr/util/format.c" 3 4
            (1) 
# 1484 "project/radare2/libr/util/format.c"
            && mode & 
# 1484 "project/radare2/libr/util/format.c" 3 4
            (1 << 1) 
# 1484 "project/radare2/libr/util/format.c"
...
# 1484 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("%s (enum %s) = 0x%"
# 1485 "project/radare2/libr/util/format.c" 3 4
                                    "llx"
# 1485 "project/radare2/libr/util/format.c"
                                           "\n",
    fieldname, fmtname, addr);
  }
 }
...
static void r_print_format_register(const RPrint* p, int mode,
 ...
 if (ri) {
  if ((mode & 
# 1499 "project/radare2/libr/util/format.c" 3 4
     (1 << 4) 
# 1499 "project/radare2/libr/util/format.c"
     && mode & 
# 1499 "project/radare2/libr/util/format.c" 3 4
     (1 << 1) 
# 1499 "project/radare2/libr/util/format.c"
...
# 1501 "project/radare2/libr/util/format.c" 3 4
            (1) 
# 1501 "project/radare2/libr/util/format.c"
            && mode & 
# 1501 "project/radare2/libr/util/format.c" 3 4
            (1 << 1) 
# 1501 "project/radare2/libr/util/format.c"
...
# 1501 "project/radare2/libr/util/format.c"
   ...
   if (!(mode & 
# 1502 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 1502 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf ("%s : 0x%08" 
# 1503 "project/radare2/libr/util/format.c" 3 4
                              "llx" 
# 1503 "project/radare2/libr/util/format.c"
                                      "\n", ri->name, p->get_register_value (p->reg, ri));
   } else {
    p->cb_printf ("0x%08" 
# 1505 "project/radare2/libr/util/format.c" 3 4
                         "llx" 
# 1505 "project/radare2/libr/util/format.c"
                                 "\n", p->get_register_value (p->reg, ri));
   }
  } else if ((mode & 
# 1507 "project/radare2/libr/util/format.c" 3 4
            (1 << 3) 
# 1507 "project/radare2/libr/util/format.c"
            && mode & 
# 1507 "project/radare2/libr/util/format.c" 3 4
            (1 << 1)
# 1507 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("%"
# 1508 "project/radare2/libr/util/format.c" 3 4
                   "lld"
# 1508 "project/radare2/libr/util/format.c"
                          "}", p->get_register_value (p->reg, ri));
  }
 } else {
...
static void r_print_format_num_specifier(const RPrint *p, 
# 1515 "project/radare2/libr/util/format.c" 3 4
                                                         unsigned long long 
# 1515 "project/radare2/libr/util/format.c"
                                                              addr, int bytes, int sign) {
#define EXT(T) (sign ? (signed T)(addr) : (unsigned T)(addr) )
 const char *fs64 = sign ? "%"
# 1517 "project/radare2/libr/util/format.c" 3 4
                             "lld" 
# 1517 "project/radare2/libr/util/format.c"
                                     : "%"
# 1517 "project/radare2/libr/util/format.c" 3 4
                                          "llu"
# 1517 "project/radare2/libr/util/format.c"
 ...
 if (bytes == 1) {
  p->cb_printf (fs, (sign ? (signed char)(addr) : (unsigned char)(addr) ));
 } else if (bytes == 2) {
  p->cb_printf (fs, (sign ? (signed short)(addr) : (unsigned short)(addr) ));
 } else if (bytes == 4) {
  p->cb_printf (fs, (sign ? (signed int)(addr) : (unsigned int)(addr) ));
 } else if (bytes == 8) {
...
static void r_print_format_num(const RPrint *p, int endian, int mode, const char *setval, 
# 1531 "project/radare2/libr/util/format.c" 3 4
                                                                                         unsigned long long 
# 1531 "project/radare2/libr/util/format.c"
                                                                                              seeki, 
# 1531 "project/radare2/libr/util/format.c" 3 4
                                                                                                     unsigned char 
# 1531 "project/radare2/libr/util/format.c"
                                                                                                         *buf, int i, int bytes, int sign, int size) {
 
# 1532 "project/radare2/libr/util/format.c" 3 4
unsigned long long 
# 1532 "project/radare2/libr/util/format.c"
     addr = 0LL;
 int elem = -1;
 if (size >= 10000) {
  elem = size / 10000 - 1;
 ...
 if (bytes == 8) {
  updateAddr (buf + i, size - i, endian, 
# 1539 "project/radare2/libr/util/format.c" 3 4
                                        ((void *)0)
# 1539 "project/radare2/libr/util/format.c"
                                            , &addr);
 } else {
  updateAddr (buf + i, size - i, endian, &addr, 
# 1541 "project/radare2/libr/util/format.c" 3 4
                                               ((void *)0)
# 1541 "project/radare2/libr/util/format.c"
                                                   );
 }
 if ((mode & 
# 1543 "project/radare2/libr/util/format.c" 3 4
    (1 << 4) 
# 1543 "project/radare2/libr/util/format.c"
    && mode & 
# 1543 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 1543 "project/radare2/libr/util/format.c"
    && setval)) {
  p->cb_printf ("wv%d %s @ 0x%08"
# 1544 "project/radare2/libr/util/format.c" 3 4
                                "llx"
# 1544 "project/radare2/libr/util/format.c"
                                       "\n", bytes, setval, seeki+((elem>=0)?elem*(bytes):0));
 } else if ((mode & 
# 1545 "project/radare2/libr/util/format.c" 3 4
                   (1 << 7)
# 1545 "project/radare2/libr/util/format.c"
                              ) || (mode & 
# 1545 "project/radare2/libr/util/format.c" 3 4
                                   (1 << 9)
# 1545 "project/radare2/libr/util/format.c"
...
# 1547 "project/radare2/libr/util/format.c" 3 4
           (1) 
# 1547 "project/radare2/libr/util/format.c"
           && mode & 
# 1547 "project/radare2/libr/util/format.c" 3 4
           (1 << 1) 
# 1547 "project/radare2/libr/util/format.c"
...
# 1547 "project/radare2/libr/util/format.c"
  ...
  if (!(mode & 
# 1548 "project/radare2/libr/util/format.c" 3 4
      (1 << 6)
# 1548 "project/radare2/libr/util/format.c"
      ) && !(mode & 
# 1548 "project/radare2/libr/util/format.c" 3 4
                   (1 << 8)
# 1548 "project/radare2/libr/util/format.c"
   ...
   p->cb_printf ("0x%08"
# 1549 "project/radare2/libr/util/format.c" 3 4
                       "llx"
# 1549 "project/radare2/libr/util/format.c"
                              " = ", seeki + ((elem >= 0)? elem * bytes: 0));
  }
  if (size == -1) {
   r_print_format_num_specifier (p, addr, bytes, sign);
  } else {
   if (!(mode & 
# 1554 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 1554 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf ("[ ");
   }
   while (size--) {
    if (bytes == 8) {
     updateAddr (buf + i, size - i, endian, 
# 1559 "project/radare2/libr/util/format.c" 3 4
                                           ((void *)0)
# 1559 "project/radare2/libr/util/format.c"
                                               , &addr);
    } else {
     updateAddr (buf + i, size - i, endian, &addr, 
# 1561 "project/radare2/libr/util/format.c" 3 4
                                                  ((void *)0)
# 1561 "project/radare2/libr/util/format.c"
                                                      );
    }
    if (elem == -1 || elem == 0) {
     r_print_format_num_specifier (p, addr, bytes, sign);
   ...
   if (!(mode & 
# 1577 "project/radare2/libr/util/format.c" 3 4
       (1 << 6)
# 1577 "project/radare2/libr/util/format.c"
       )) {
    p->cb_printf (" ]");
   }
  }
 } else if ((mode & 
# 1581 "project/radare2/libr/util/format.c" 3 4
           (1 << 3) 
# 1581 "project/radare2/libr/util/format.c"
           && mode & 
# 1581 "project/radare2/libr/util/format.c" 3 4
           (1 << 1)
# 1581 "project/radare2/libr/util/format.c"
  ...
  if (size == -1) {
   ...
   while (size--) {
    if (bytes == 8) {
     updateAddr (buf + i, size, endian, 
# 1588 "project/radare2/libr/util/format.c" 3 4
                                       ((void *)0)
# 1588 "project/radare2/libr/util/format.c"
                                           , &addr);
    } else {
     updateAddr (buf + i, size, endian, &addr, 
# 1590 "project/radare2/libr/util/format.c" 3 4
                                              ((void *)0)
# 1590 "project/radare2/libr/util/format.c"
                                                  );
    }
    if (elem == -1 || elem == 0) {
     r_print_format_num_specifier (p, addr, bytes, sign);
...
# 1612 "project/radare2/libr/util/format.c" 3 4
__attribute__((visibility("default"))) 
# 1612 "project/radare2/libr/util/format.c"
     const char *r_print_format_byname(RPrint *p, const char *name) {
 return sdb_const_get (p->formats, name, 
# 1613 "project/radare2/libr/util/format.c" 3 4
                                        ((void *)0)
# 1613 "project/radare2/libr/util/format.c"
                                            );
}



# 1617 "project/radare2/libr/util/format.c" 3 4
__attribute__((visibility("default"))) 
# 1617 "project/radare2/libr/util/format.c"
     int r_print_format_struct_size(RPrint *p, const char *f, int mode, int n) {
 char *end, *args, *fmt;
 int size = 0, tabsize = 0, i, idx = 0, biggest = 0, fmt_len = 0, times = 1;
 
# 1620 "project/radare2/libr/util/format.c" 3 4
_Bool 
# 1620 "project/radare2/libr/util/format.c"
     tabsize_set = 
# 1620 "project/radare2/libr/util/format.c" 3 4
                   0
# 1620 "project/radare2/libr/util/format.c"
 ...
 const char *fmt2 = p? sdb_get (p->formats, f, 
# 1627 "project/radare2/libr/util/format.c" 3 4
                                              ((void *)0)
# 1627 "project/radare2/libr/util/format.c"
                                                  ): 
# 1627 "project/radare2/libr/util/format.c" 3 4
                                                     ((void *)0)
# 1627 "project/radare2/libr/util/format.c"
...
# 1652 "project/radare2/libr/util/format.c" 3 4
  fprintf(__stderrp,
# 1652 "project/radare2/libr/util/format.c"
  "No end curly bracket.\n"
# 1652 "project/radare2/libr/util/format.c" 3 4
  )
# 1652 "project/radare2/libr/util/format.c"
                                     ;
  ...
  *end = '\0';
  times = r_num_math (
# 1658 "project/radare2/libr/util/format.c" 3 4
                     ((void *)0)
# 1658 "project/radare2/libr/util/format.c"
                         , fmt + i + 1);
  fmt = end + 1;
 }
 if (fmt[0] == '0') {
  mode |= 
# 1662 "project/radare2/libr/util/format.c" 3 4
         (1 << 5)
# 1662 "project/radare2/libr/util/format.c"
                          ;
  fmt++;
 } else {
  mode &= ~
# 1665 "project/radare2/libr/util/format.c" 3 4
          (1 << 5)
# 1665 "project/radare2/libr/util/format.c"
                           ;
 }
...
# 1675 "project/radare2/libr/util/format.c" 3 4
   fprintf(__stderrp,
# 1675 "project/radare2/libr/util/format.c"
   "No end bracket.\n"
# 1675 "project/radare2/libr/util/format.c" 3 4
   )
# 1675 "project/radare2/libr/util/format.c"
   ...
   *end = '\0';
   tabsize_set = 
# 1679 "project/radare2/libr/util/format.c" 3 4
                1
# 1679 "project/radare2/libr/util/format.c"
                    ;
   tabsize = r_num_math (
# 1680 "project/radare2/libr/util/format.c" 3 4
                        ((void *)0)
# 1680 "project/radare2/libr/util/format.c"
                            , fmt + i + 1);
   *end = ']';
   while (fmt[i++] != ']') {
    ;
...
# 1733 "project/radare2/libr/util/format.c" 3 4
    fprintf(__stderrp,
# 1733 "project/radare2/libr/util/format.c"
...
# 1743 "project/radare2/libr/util/format.c" 3 4
                            ((void *)0)
# 1743 "project/radare2/libr/util/format.c"
                                ;
   const char *format = 
# 1744 "project/radare2/libr/util/format.c" 3 4
                       ((void *)0)
# 1744 "project/radare2/libr/util/format.c"
                           ;
   char *endname = 
# 1745 "project/radare2/libr/util/format.c" 3 4
                  ((void *)0)
# 1745 "project/radare2/libr/util/format.c"
                      , *structname = 
# 1745 "project/radare2/libr/util/format.c" 3 4
                                      ((void *)0)
# 1745 "project/radare2/libr/util/format.c"
...
# 1748 "project/radare2/libr/util/format.c" 3 4
   fprintf(__stderrp,
# 1748 "project/radare2/libr/util/format.c"
   "Index out of bounds\n"
# 1748 "project/radare2/libr/util/format.c" 3 4
   )
# 1748 "project/radare2/libr/util/format.c"
   ...
   if (*structname == '(') {
    endname = (char*)r_str_rchr (structname, 
# 1757 "project/radare2/libr/util/format.c" 3 4
                                            ((void *)0)
# 1757 "project/radare2/libr/util/format.c"
                                                , ')');
   } else {
    free (structname);
    break;
   ...
   if (format) {
    ...
    format = p? sdb_get (p->formats, structname + 1, 
# 1773 "project/radare2/libr/util/format.c" 3 4
                                                    ((void *)0)
# 1773 "project/radare2/libr/util/format.c"
                                                        ): 
# 1773 "project/radare2/libr/util/format.c" 3 4
                                                           ((void *)0)
# 1773 "project/radare2/libr/util/format.c"
...
# 1784 "project/radare2/libr/util/format.c" 3 4
   fprintf(__stderrp,
# 1784 "project/radare2/libr/util/format.c"
...
# 1791 "project/radare2/libr/util/format.c" 3 4
   fprintf(__stderrp,
# 1791 "project/radare2/libr/util/format.c"
   "Cannot find size for `%s'\n", format
# 1791 "project/radare2/libr/util/format.c" 3 4
   )
# 1791 "project/radare2/libr/util/format.c"
                                                  ;
...
# 1848 "project/radare2/libr/util/format.c" 3 4
   fprintf(__stderrp,
# 1848 "project/radare2/libr/util/format.c"
   "Invalid n format in (%s)\n", fmt
# 1848 "project/radare2/libr/util/format.c" 3 4
   )
# 1848 "project/radare2/libr/util/format.c"
                                              ;
  ...
  idx++;
  if (mode & 
# 1864 "project/radare2/libr/util/format.c" 3 4
            (1 << 5)
# 1864 "project/radare2/libr/util/format.c"
                             ) {
   if (size > biggest) {
    biggest = size;
   }
 ...
 free (args);
 return (mode & 
# 1874 "project/radare2/libr/util/format.c" 3 4
               (1 << 5)
# 1874 "project/radare2/libr/util/format.c"
                                )? biggest : size;
}

static int r_print_format_struct(RPrint* p, 
# 1877 "project/radare2/libr/util/format.c" 3 4
                                           unsigned long long 
# 1877 "project/radare2/libr/util/format.c"
                                                seek, const 
# 1877 "project/radare2/libr/util/format.c" 3 4
                                                            unsigned char
# 1877 "project/radare2/libr/util/format.c"
                                                               * b, int len, const char *name,
  int slide, int mode, const char *setval, char *field, int anon) {
 const char *fmt;
 char namefmt[128];
 slide++;
 if ((slide % 100) > 14 || (slide % 10000)/100 > 14) {
  
# 1883 "project/radare2/libr/util/format.c" 3 4
 fprintf(__stderrp,
# 1883 "project/radare2/libr/util/format.c"
...
# 1883 "project/radare2/libr/util/format.c"
 ...
 if (anon) {
  ...
  fmt = sdb_get (p->formats, name, 
# 1889 "project/radare2/libr/util/format.c" 3 4
                                  ((void *)0)
# 1889 "project/radare2/libr/util/format.c"
                                      );
  if (!fmt) {
...
# 1895 "project/radare2/libr/util/format.c" 3 4
 fprintf(__stderrp,
# 1895 "project/radare2/libr/util/format.c"
 "Undefined struct '%s'.\n", name
# 1895 "project/radare2/libr/util/format.c" 3 4
 )
# 1895 "project/radare2/libr/util/format.c"
 ...
 if ((mode & 
# 1898 "project/radare2/libr/util/format.c" 3 4
    (1) 
# 1898 "project/radare2/libr/util/format.c"
    && mode & 
# 1898 "project/radare2/libr/util/format.c" 3 4
    (1 << 1) 
# 1898 "project/radare2/libr/util/format.c"
...
# 1899 "project/radare2/libr/util/format.c" 3 4
 __builtin___snprintf_chk (
# 1899 "project/radare2/libr/util/format.c"
 namefmt
# 1899 "project/radare2/libr/util/format.c" 3 4
 , 
# 1899 "project/radare2/libr/util/format.c"
...
static char *get_format_type(const char fmt, const char arg) {
 char *type = 
# 1925 "project/radare2/libr/util/format.c" 3 4
             ((void *)0)
# 1925 "project/radare2/libr/util/format.c"
                 ;
 switch (fmt) {
 case 'b':
 case 'C':
...
# 1999 "project/radare2/libr/util/format.c" 3 4
__attribute__((visibility("default"))) 
# 1999 "project/radare2/libr/util/format.c"
     int r_print_format(RPrint *p, 
# 1999 "project/radare2/libr/util/format.c" 3 4
                                   unsigned long long 
# 1999 "project/radare2/libr/util/format.c"
                                        seek, const 
...
# 1999 "project/radare2/libr/util/format.c"
 ...
 char *args = 
# 2003 "project/radare2/libr/util/format.c" 3 4
             ((void *)0)
# 2003 "project/radare2/libr/util/format.c"
                 , *bracket, tmp, last = 0;
 
# 2004 "project/radare2/libr/util/format.c" 3 4
unsigned long long 
# 2004 "project/radare2/libr/util/format.c"
     addr = 0, addr64 = 0, seeki = 0;
 static int slide = 0, oldslide = 0, ident = 4;
 char namefmt[32], *field = 
# 2006 "project/radare2/libr/util/format.c" 3 4
                           ((void *)0)
# 2006 "project/radare2/libr/util/format.c"
                               ;
 const char *arg = 
# 2007 "project/radare2/libr/util/format.c" 3 4
                  ((void *)0)
# 2007 "project/radare2/libr/util/format.c"
                      ;
 const char *fmt = 
# 2008 "project/radare2/libr/util/format.c" 3 4
                  ((void *)0)
# 2008 "project/radare2/libr/util/format.c"
                      ;
 const char *argend;
 int viewflags = 0;
 char *oarg = 
# 2011 "project/radare2/libr/util/format.c" 3 4
             ((void *)0)
# 2011 "project/radare2/libr/util/format.c"
                 ;
 char *internal_format = 
# 2012 "project/radare2/libr/util/format.c" 3 4
                        ((void *)0)
# 2012 "project/radare2/libr/util/format.c"
                            ;
 ...
 fmt = sdb_get (p->formats, formatname, 
# 2018 "project/radare2/libr/util/format.c" 3 4
                                       ((void *)0)
# 2018 "project/radare2/libr/util/format.c"
                                           );
 if (!fmt) {
  fmt = formatname;
 }
 ...
 fmt = internal_format;
 while (*fmt && 
# 2024 "project/radare2/libr/util/format.c" 3 4
               ((
# 2024 "project/radare2/libr/util/format.c"
               *fmt
# 2024 "project/radare2/libr/util/format.c" 3 4
               ) == ' ' || (
# 2024 "project/radare2/libr/util/format.c"
...
# 2037 "project/radare2/libr/util/format.c" 3 4
unsigned char 
# 2037 "project/radare2/libr/util/format.c"
    *buf = calloc (1, len + 2);
 if (!buf) {
  free (internal_format);
  return 0;
...
# 2042 "project/radare2/libr/util/format.c" 3 4
__builtin___memcpy_chk (
# 2042 "project/radare2/libr/util/format.c"
buf
# 2042 "project/radare2/libr/util/format.c" 3 4
, 
# 2042 "project/radare2/libr/util/format.c"
...
# 2042 "project/radare2/libr/util/format.c"
 ...
 if (ofield && ofield != ((void*)(size_t)-1)) {
  field = strdup (ofield);
 }
 ...
 if (times > 0) {
  while (
# 2051 "project/radare2/libr/util/format.c" 3 4
        ((
# 2051 "project/radare2/libr/util/format.c"
        *arg
# 2051 "project/radare2/libr/util/format.c" 3 4
        ) >= '0' && (
# 2051 "project/radare2/libr/util/format.c"
...
# 2060 "project/radare2/libr/util/format.c" 3 4
  fprintf(__stderrp,
# 2060 "project/radare2/libr/util/format.c"
...
# 2060 "project/radare2/libr/util/format.c"
  ...
  *end = '\0';
  times = r_num_math (
# 2064 "project/radare2/libr/util/format.c" 3 4
                     ((void *)0)
# 2064 "project/radare2/libr/util/format.c"
                         , bracket + 1);
  arg = end + 1;
 }
...
# 2085 "project/radare2/libr/util/format.c" 3 4
  { free((void *)
# 2085 "project/radare2/libr/util/format.c"
  args
# 2085 "project/radare2/libr/util/format.c" 3 4
  ); 
# 2085 "project/radare2/libr/util/format.c"
...
# 2085 "project/radare2/libr/util/format.c"
  ...
  for (i = 0; i < nargs; i++) {
   ...
   const char *nm = r_str_rchr (tmp, 
# 2089 "project/radare2/libr/util/format.c" 3 4
                                    ((void *)0)
# 2089 "project/radare2/libr/util/format.c"
                                        , ')');
...
# 2097 "project/radare2/libr/util/format.c" 3 4
 __builtin___snprintf_chk (
# 2097 "project/radare2/libr/util/format.c"
 namefmt
# 2097 "project/radare2/libr/util/format.c" 3 4
 , 
# 2097 "project/radare2/libr/util/format.c"
...
# 2097 "project/radare2/libr/util/format.c" 3 4
 , 2 > 1 ? 1 : 0), 
# 2097 "project/radare2/libr/util/format.c"
 "%%%ds :%s", ((maxl + 1) * (1 + slide)) % 100, ends
# 2097 "project/radare2/libr/util/format.c" 3 4
 )
                                                
# 2098 "project/radare2/libr/util/format.c"
                                               ;
 }
...
#define ISNESTED ((slide%STRUCTPTR)<=(oldslide%STRUCTPTR))
 if (mode == 
# 2102 "project/radare2/libr/util/format.c" 3 4
            (1 << 3) 
# 2102 "project/radare2/libr/util/format.c"
                         && slide == 0) {
  p->cb_printf ("[");
 }
 if (mode == 
# 2105 "project/radare2/libr/util/format.c" 3 4
            (1 << 9)
# 2105 "project/radare2/libr/util/format.c"
                          ) {
 ...
 if (mode && arg[0] == '0') {
  mode |= 
# 2117 "project/radare2/libr/util/format.c" 3 4
         (1 << 5)
# 2117 "project/radare2/libr/util/format.c"
                          ;
  arg++;
 } else {
  mode &= ~
# 2120 "project/radare2/libr/util/format.c" 3 4
          (1 << 5)
# 2120 "project/radare2/libr/util/format.c"
                           ;
 }
 if (mode & 
# 2122 "project/radare2/libr/util/format.c" 3 4
           (1 << 7)
# 2122 "project/radare2/libr/util/format.c"
                      ) {
  char *fmtname;
  if (formatname && *formatname) {
   if (strchr (formatname, ' ')) {
    fmtname = r_str_newf ("0x%"
# 2126 "project/radare2/libr/util/format.c" 3 4
                              "llx"
# 2126 "project/radare2/libr/util/format.c"
                                     , seek);
   } else {
   ...
   fmtname = r_str_newf ("0x%"
# 2131 "project/radare2/libr/util/format.c" 3 4
                             "llx"
# 2131 "project/radare2/libr/util/format.c"
                                    , seek);
  }
 ...
 for (; times; times--) {
  ...
  if (otimes > 1) {
   if (mode & 
# 2146 "project/radare2/libr/util/format.c" 3 4
             (1 << 3)
# 2146 "project/radare2/libr/util/format.c"
                         ) {
    if (otimes > times) {
     p->cb_printf (",");
    }
    p->cb_printf ("[{\"index\":%d,\"offset\":%"
# 2150 "project/radare2/libr/util/format.c" 3 4
                                              "lld"
# 2150 "project/radare2/libr/util/format.c"
                                                     "},", otimes-times, seek+i);
   } else if (mode) {
    p->cb_printf ("0x%08"
# 2152 "project/radare2/libr/util/format.c" 3 4
                        "llx"
# 2152 "project/radare2/libr/util/format.c"
                               " [%d] {\n", seek + i, otimes-times);
   }
  }
  arg = orig;
  for (idx = 0; i < len && arg < argend && *arg; arg++) {
   int size = 0, elem = 0;
   char *fieldname = 
# 2158 "project/radare2/libr/util/format.c" 3 4
                    ((void *)0)
# 2158 "project/radare2/libr/util/format.c"
                        , *fmtname = 
# 2158 "project/radare2/libr/util/format.c" 3 4
                                     ((void *)0)
# 2158 "project/radare2/libr/util/format.c"
                                         ;
   if (mode & 
# 2159 "project/radare2/libr/util/format.c" 3 4
             (1 << 5)
# 2159 "project/radare2/libr/util/format.c"
                              ) {
    i = 0;
   }
   seeki = seek + i;
...
# 2169 "project/radare2/libr/util/format.c" 3 4
    fprintf(__stderrp,
# 2169 "project/radare2/libr/util/format.c"
    "No end bracket.\n"
# 2169 "project/radare2/libr/util/format.c" 3 4
    )
# 2169 "project/radare2/libr/util/format.c"
   ...
   if (i + fs - 1 < len) {
    ...
    if (len - i < 7) {
     updateAddr (buf + i, (-4444) - (len - i), endian, &addr, &addr64);
    } else {
   ...
   if (mode && !args) {
    mode |= 
# 2205 "project/radare2/libr/util/format.c" 3 4
           (1 << 1)
# 2205 "project/radare2/libr/util/format.c"
                          ;
   }
   if (!(mode & 
# 2207 "project/radare2/libr/util/format.c" 3 4
               (1 << 8)
# 2207 "project/radare2/libr/util/format.c"
                            )) {
    if (mode & 
# 2208 "project/radare2/libr/util/format.c" 3 4
              (1) 
# 2208 "project/radare2/libr/util/format.c"
                              && otimes > 1) {
     p->cb_printf ("  ");
    }
   }
   if (idx < nargs && tmp != 'e' && isptr == 0) {
    char *dot = 
# 2213 "project/radare2/libr/util/format.c" 3 4
               ((void *)0)
# 2213 "project/radare2/libr/util/format.c"
                   , *bracket = 
# 2213 "project/radare2/libr/util/format.c" 3 4
                                ((void *)0)
# 2213 "project/radare2/libr/util/format.c"
    ...
    if ((tmp == '?' || (tmp == '*' && *(arg+1) == '?')) || tmp=='E' || tmp=='B' || tmp=='r') {
     if (*fieldname == '(') {
      fmtname = fieldname + 1;
      fieldname = (char*)r_str_rchr (fieldname, 
# 2225 "project/radare2/libr/util/format.c" 3 4
                                               ((void *)0)
# 2225 "project/radare2/libr/util/format.c"
                                                   , ')');
      if (fieldname) {
       *fieldname++ = '\0';
      } else {
       
# 2229 "project/radare2/libr/util/format.c" 3 4
      fprintf(__stderrp,
# 2229 "project/radare2/libr/util/format.c"
...
# 2233 "project/radare2/libr/util/format.c" 3 4
     fprintf(__stderrp,
# 2233 "project/radare2/libr/util/format.c"
     "Missing name (%s)\n", fieldname
# 2233 "project/radare2/libr/util/format.c" 3 4
     )
# 2233 "project/radare2/libr/util/format.c"
    ...
    if (mode && (!args || (!field && ofield != ((void*)(size_t)-1))
      || (field && !strncmp (field, fieldname,
       strchr (field, '[')
      ? strchr (field, '[') - field
      : strlen (field) + 1)))) {
     mode |= 
# 2242 "project/radare2/libr/util/format.c" 3 4
            (1 << 1)
# 2242 "project/radare2/libr/util/format.c"
                           ;
    } else {
     mode &= ~
# 2244 "project/radare2/libr/util/format.c" 3 4
             (1 << 1)
# 2244 "project/radare2/libr/util/format.c"
                            ;
    }


    if (field && (bracket = strchr (field, '[')) && mode & 
# 2248 "project/radare2/libr/util/format.c" 3 4
                                                          (1 << 1)
# 2248 "project/radare2/libr/util/format.c"
                                                                         ) {
     char *end = strchr (field, ']');
     if (!end) {
      
# 2251 "project/radare2/libr/util/format.c" 3 4
     fprintf(__stderrp,
# 2251 "project/radare2/libr/util/format.c"
...
# 2251 "project/radare2/libr/util/format.c"
     ...
     *end = '\0';
     elem = r_num_math (
# 2255 "project/radare2/libr/util/format.c" 3 4
                       ((void *)0)
# 2255 "project/radare2/libr/util/format.c"
                           , bracket + 1) + 1;
    ...
    if (tmp != '.' && tmp != ':') {
     idx++;
     if ((mode & 
# 2265 "project/radare2/libr/util/format.c" 3 4
        (1) 
# 2265 "project/radare2/libr/util/format.c"
        && mode & 
# 2265 "project/radare2/libr/util/format.c" 3 4
        (1 << 1) 
# 2265 "project/radare2/libr/util/format.c"
...
# 2265 "project/radare2/libr/util/format.c"
      ...
      if (!(mode & 
# 2266 "project/radare2/libr/util/format.c" 3 4
          (1 << 8)
# 2266 "project/radare2/libr/util/format.c"
          )) {
...
# 2281 "project/radare2/libr/util/format.c" 3 4
   __builtin___memset_chk (
# 2281 "project/radare2/libr/util/format.c"
   buf
# 2281 "project/radare2/libr/util/format.c" 3 4
   , 
# 2281 "project/radare2/libr/util/format.c"
...
# 2281 "project/radare2/libr/util/format.c"
                          ;
    if ((mode & 
# 2282 "project/radare2/libr/util/format.c" 3 4
       (1) 
# 2282 "project/radare2/libr/util/format.c"
       && mode & 
# 2282 "project/radare2/libr/util/format.c" 3 4
       (1 << 1) 
# 2282 "project/radare2/libr/util/format.c"
...
# 2282 "project/radare2/libr/util/format.c"
     ...
     p->cb_printf ("(*0x%"
# 2283 "project/radare2/libr/util/format.c" 3 4
                         "llx"
# 2283 "project/radare2/libr/util/format.c"
                                ")", addr);
    }
    isptr = (addr)? 2: 3;
    if (p->iob.read_at) {
     p->iob.read_at (p->iob.io, (
# 2287 "project/radare2/libr/util/format.c" 3 4
                                unsigned long long
# 2287 "project/radare2/libr/util/format.c"
                                    )addr, buf, len - 4);
     if (((i + 3) < len) || ((i + 7) < len)) {
...
# 2294 "project/radare2/libr/util/format.c" 3 4
     fprintf(__stderrp,
# 2294 "project/radare2/libr/util/format.c"
     "Likely a heap buffer overflow.\n"
# 2294 "project/radare2/libr/util/format.c" 3 4
     )
# 2294 "project/radare2/libr/util/format.c"
                                                 ;
...
# 2298 "project/radare2/libr/util/format.c" 3 4
    fprintf(__stderrp,
# 2298 "project/radare2/libr/util/format.c"
    "(cannot read at 0x%08"
# 2298 "project/radare2/libr/util/format.c" 3 4
    "llx"
# 2298 "project/radare2/libr/util/format.c"
    ", block: %s, blocksize: 0x%x)\n", addr, b, len
# 2298 "project/radare2/libr/util/format.c" 3 4
    )
                    
# 2299 "project/radare2/libr/util/format.c"
                   ;
     p->cb_printf ("\n");
     goto beach;
    }
...
# 2308 "project/radare2/libr/util/format.c" 3 4
   __builtin___memcpy_chk (
# 2308 "project/radare2/libr/util/format.c"
   buf
# 2308 "project/radare2/libr/util/format.c" 3 4
   , 
# 2308 "project/radare2/libr/util/format.c"
...
# 2308 "project/radare2/libr/util/format.c"
   ...
   if (mode & 
# 2363 "project/radare2/libr/util/format.c" 3 4
             (1 << 2) 
# 2363 "project/radare2/libr/util/format.c"
                              && isptr != 3) {
    char *newname = 
# 2364 "project/radare2/libr/util/format.c" 3 4
                   ((void *)0)
# 2364 "project/radare2/libr/util/format.c"
                       ;
    if (!fieldname) {
     newname = fieldname = r_str_newf ("pf.%"
# 2366 "project/radare2/libr/util/format.c" 3 4
                                            "llu"
# 2366 "project/radare2/libr/util/format.c"
                                                   , seeki);
    }
    if (mode & 
# 2368 "project/radare2/libr/util/format.c" 3 4
              (1 << 5)
# 2368 "project/radare2/libr/util/format.c"
                               ) {
     p->cb_printf ("f %s=0x%08"
# 2369 "project/radare2/libr/util/format.c" 3 4
                              "llx"
# 2369 "project/radare2/libr/util/format.c"
                                     "\n", formatname, seeki);
     goto beach;
    } else if (tmp == '?') {
     ...
     p->cb_printf ("f %s=0x%08"
# 2374 "project/radare2/libr/util/format.c" 3 4
                              "llx"
# 2374 "project/radare2/libr/util/format.c"
                                     "\n", fieldname, seeki);
    } else if (slide/10000>0 && idx==1) {
     p->cb_printf ("%s=0x%08"
# 2376 "project/radare2/libr/util/format.c" 3 4
                            "llx"
# 2376 "project/radare2/libr/util/format.c"
                                   "\n", fieldname, seeki);
    } else {
     p->cb_printf ("f %s=0x%08" 
# 2378 "project/radare2/libr/util/format.c" 3 4
                               "llx" 
# 2378 "project/radare2/libr/util/format.c"
                                       "\n", fieldname, seeki);
    }
    if (newname) {
     
# 2381 "project/radare2/libr/util/format.c" 3 4
    { free((void *)
# 2381 "project/radare2/libr/util/format.c"
    newname
# 2381 "project/radare2/libr/util/format.c" 3 4
    ); 
# 2381 "project/radare2/libr/util/format.c"
...
# 2381 "project/radare2/libr/util/format.c"
                    ;
     fieldname = 
# 2382 "project/radare2/libr/util/format.c" 3 4
                ((void *)0)
# 2382 "project/radare2/libr/util/format.c"
                    ;
    }
   }
   ...
   if (mode & 
# 2387 "project/radare2/libr/util/format.c" 3 4
             (1 << 7)
# 2387 "project/radare2/libr/util/format.c"
                        ) {
    if (fieldname) {
     p->cb_printf ("|{0x%"
# 2389 "project/radare2/libr/util/format.c" 3 4
                         "llx"
# 2389 "project/radare2/libr/util/format.c"
                                "|%c|%s|<%s>",
      seeki, tmp, fieldname, fieldname);
    } else {
     p->cb_printf ("|{0x%"
# 2392 "project/radare2/libr/util/format.c" 3 4
                         "llx"
# 2392 "project/radare2/libr/util/format.c"
                                "|%c|",
      seeki, tmp);
    }
   }
   ...
   if ((mode & 
# 2398 "project/radare2/libr/util/format.c" 3 4
      (1 << 3) 
# 2398 "project/radare2/libr/util/format.c"
      && mode & 
# 2398 "project/radare2/libr/util/format.c" 3 4
      (1 << 1)
# 2398 "project/radare2/libr/util/format.c"
...
# 2398 "project/radare2/libr/util/format.c"
    ...
    p->cb_printf ("\",\"offset\":%"
# 2426 "project/radare2/libr/util/format.c" 3 4
                                  "lld"
# 2426 "project/radare2/libr/util/format.c"
                                         ",\"value\":",
   ...
   if ((mode & 
# 2431 "project/radare2/libr/util/format.c" 3 4
      (1 << 9)
# 2431 "project/radare2/libr/util/format.c"
      )) {
...
# 2440 "project/radare2/libr/util/format.c" 3 4
  _Bool 
# 2440 "project/radare2/libr/util/format.c"
       noline = 
# 2440 "project/radare2/libr/util/format.c" 3 4
                0
# 2440 "project/radare2/libr/util/format.c"
   ...
   if (isptr == 3) {
    if ((mode & 
# 2444 "project/radare2/libr/util/format.c" 3 4
       (1 << 3) 
# 2444 "project/radare2/libr/util/format.c"
       && mode & 
# 2444 "project/radare2/libr/util/format.c" 3 4
       (1 << 1)
# 2444 "project/radare2/libr/util/format.c"
...
# 2446 "project/radare2/libr/util/format.c" 3 4
              (1) 
# 2446 "project/radare2/libr/util/format.c"
              && mode & 
# 2446 "project/radare2/libr/util/format.c" 3 4
              (1 << 1) 
# 2446 "project/radare2/libr/util/format.c"
...
# 2446 "project/radare2/libr/util/format.c"
    ...
    case 'D':
     if ((mode & 
# 2513 "project/radare2/libr/util/format.c" 3 4
        (1 << 4) 
# 2513 "project/radare2/libr/util/format.c"
        && mode & 
# 2513 "project/radare2/libr/util/format.c" 3 4
        (1 << 1) 
# 2513 "project/radare2/libr/util/format.c"
...
# 2514 "project/radare2/libr/util/format.c" 3 4
     fprintf(__stderrp,
# 2514 "project/radare2/libr/util/format.c"
     "Set val not implemented yet for disassembler!\n"
# 2514 "project/radare2/libr/util/format.c" 3 4
     )
# 2514 "project/radare2/libr/util/format.c"
                                                                ;
    ...
    case ';':
     noline = 
# 2531 "project/radare2/libr/util/format.c" 3 4
             1
# 2531 "project/radare2/libr/util/format.c"
                 ;
     i -= (size == -1)? 4: 4 * size;
     if (i < 0) {
      i = 0;
    ...
    case ',':
     noline = 
# 2538 "project/radare2/libr/util/format.c" 3 4
             1
# 2538 "project/radare2/libr/util/format.c"
                 ;
     i -= (size == -1)? 1: size;
     if (i < 0) {
      i = 0;
    ...
    case 's':
     if ((mode & 
# 2573 "project/radare2/libr/util/format.c" 3 4
        (1 << 4) 
# 2573 "project/radare2/libr/util/format.c"
        && mode & 
# 2573 "project/radare2/libr/util/format.c" 3 4
        (1 << 1) 
# 2573 "project/radare2/libr/util/format.c"
...
# 2574 "project/radare2/libr/util/format.c" 3 4
     fprintf(__stderrp,
# 2574 "project/radare2/libr/util/format.c"
     "Set val not implemented yet for strings!\n"
# 2574 "project/radare2/libr/util/format.c" 3 4
     )
# 2574 "project/radare2/libr/util/format.c"
                                                           ;
    ...
    case 'S':
     if ((mode & 
# 2581 "project/radare2/libr/util/format.c" 3 4
        (1 << 4) 
# 2581 "project/radare2/libr/util/format.c"
        && mode & 
# 2581 "project/radare2/libr/util/format.c" 3 4
        (1 << 1) 
# 2581 "project/radare2/libr/util/format.c"
...
# 2582 "project/radare2/libr/util/format.c" 3 4
     fprintf(__stderrp,
# 2582 "project/radare2/libr/util/format.c"
     "Set val not implemented yet for strings!\n"
# 2582 "project/radare2/libr/util/format.c" 3 4
     )
# 2582 "project/radare2/libr/util/format.c"
    ...
    case 'B':
     ...
     if ((mode & 
# 2592 "project/radare2/libr/util/format.c" 3 4
        (1 << 4) 
# 2592 "project/radare2/libr/util/format.c"
        && mode & 
# 2592 "project/radare2/libr/util/format.c" 3 4
        (1 << 1) 
# 2592 "project/radare2/libr/util/format.c"
        && setval)) {
      p->cb_printf ("wv4 %s @ 0x%08"
# 2593 "project/radare2/libr/util/format.c" 3 4
                                   "llx"
# 2593 "project/radare2/libr/util/format.c"
                                          "\n", setval, seeki+((elem>=0)?elem*4:0));
    ...
    case 'E':
     if ((mode & 
# 2600 "project/radare2/libr/util/format.c" 3 4
        (1 << 4) 
# 2600 "project/radare2/libr/util/format.c"
        && mode & 
# 2600 "project/radare2/libr/util/format.c" 3 4
        (1 << 1) 
# 2600 "project/radare2/libr/util/format.c"
      ...
      p->cb_printf ("wv4 %s @ 0x%08"
# 2602 "project/radare2/libr/util/format.c" 3 4
                                   "llx"
# 2602 "project/radare2/libr/util/format.c"
                                          "\n", setval, seeki+((elem>=0)?elem*4:0));
     }
     if (size >= 10000) {
      size %= 10000;
...
# 2614 "project/radare2/libr/util/format.c" 3 4
     fprintf(__stderrp,
# 2614 "project/radare2/libr/util/format.c"
     "Unknown register\n"
# 2614 "project/radare2/libr/util/format.c" 3 4
     )
# 2614 "project/radare2/libr/util/format.c"
    ...
    case '?':
     ...
     int s = 0;
     char *nxtfield = 
# 2620 "project/radare2/libr/util/format.c" 3 4
                     ((void *)0)
# 2620 "project/radare2/libr/util/format.c"
                         ;
     char *format = 
# 2621 "project/radare2/libr/util/format.c" 3 4
                   ((void *)0)
# 2621 "project/radare2/libr/util/format.c"
                       ;
     int anon = 0;
     if (size >= 10000) {
      elem = size / 10000 - 1;
     ...
     if (!(mode & 
# 2627 "project/radare2/libr/util/format.c" 3 4
                 (1 << 1)
# 2627 "project/radare2/libr/util/format.c"
                                )) {
      nxtfield = ((void*)(size_t)-1);
     } else if (field) {
      nxtfield = strchr (ofield, '.');
     }
     if (nxtfield != ((void*)(size_t)-1) && nxtfield) {
      nxtfield++;
     }

     if ((mode & 
# 2636 "project/radare2/libr/util/format.c" 3 4
        (1) 
# 2636 "project/radare2/libr/util/format.c"
        && mode & 
# 2636 "project/radare2/libr/util/format.c" 3 4
        (1 << 1) 
# 2636 "project/radare2/libr/util/format.c"
...
# 2636 "project/radare2/libr/util/format.c"
      ...
      if (!(mode & 
# 2637 "project/radare2/libr/util/format.c" 3 4
          (1 << 6)
# 2637 "project/radare2/libr/util/format.c"
          )) {
       p->cb_printf ("\n");
      }
     }
     if ((mode & 
# 2641 "project/radare2/libr/util/format.c" 3 4
        (1 << 3) 
# 2641 "project/radare2/libr/util/format.c"
        && mode & 
# 2641 "project/radare2/libr/util/format.c" 3 4
        (1 << 1)
# 2641 "project/radare2/libr/util/format.c"
      ...
      if (isptr) {
       p->cb_printf ("%"
# 2643 "project/radare2/libr/util/format.c" 3 4
                       "lld"
# 2643 "project/radare2/libr/util/format.c"
                              "},", seeki);
      } else {
       p->cb_printf ("[");
      }
     ...
     if ((mode & 
# 2648 "project/radare2/libr/util/format.c" 3 4
        (1 << 9)
# 2648 "project/radare2/libr/util/format.c"
        )) {
      if (isptr) {
       p->cb_printf ("%"
# 2650 "project/radare2/libr/util/format.c" 3 4
                       "lld"
# 2650 "project/radare2/libr/util/format.c"
                              , seeki);
      } else {
       ident += 4;
       p->cb_printf ("\n");
     ...
     if (mode & 
# 2656 "project/radare2/libr/util/format.c" 3 4
               (1 << 2)
# 2656 "project/radare2/libr/util/format.c"
                               ) {
      slide += 10000;
     }
     if (!fmtname) {
     ...
     if (size == -1) {
      ...
      i += (isptr) ? (p->bits / 8) : s;
      if ((mode & 
# 2678 "project/radare2/libr/util/format.c" 3 4
         (1 << 3) 
# 2678 "project/radare2/libr/util/format.c"
         && mode & 
# 2678 "project/radare2/libr/util/format.c" 3 4
         (1 << 1)
# 2678 "project/radare2/libr/util/format.c"
      ...
      if (mode & 
# 2684 "project/radare2/libr/util/format.c" 3 4
                (1 << 1)
# 2684 "project/radare2/libr/util/format.c"
                               ) {
       if (!(mode & 
# 2685 "project/radare2/libr/util/format.c" 3 4
           (1 << 6)
# 2685 "project/radare2/libr/util/format.c"
           )) {
        p->cb_printf ("[\n");
       }
      }
      while (size--) {
       if (mode && (elem == -1 || elem == 0)) {
        mode |= 
# 2691 "project/radare2/libr/util/format.c" 3 4
               (1)
# 2691 "project/radare2/libr/util/format.c"
                              ;
        if (elem == 0) {
         elem = -2;
        }
        ...
        mode &= ~
# 2696 "project/radare2/libr/util/format.c" 3 4
                (1)
# 2696 "project/radare2/libr/util/format.c"
                               ;
       }
       s = r_print_format_struct (p, seek + i,
         buf+i, len-i, fmtname, slide, mode, setval, nxtfield, anon);
       if (((mode & 
# 2700 "project/radare2/libr/util/format.c" 3 4
           (1) 
# 2700 "project/radare2/libr/util/format.c"
           && mode & 
# 2700 "project/radare2/libr/util/format.c" 3 4
           (1 << 1) 
# 2700 "project/radare2/libr/util/format.c"
...
# 2700 "project/radare2/libr/util/format.c"
        ...
        if ((mode & 
# 2701 "project/radare2/libr/util/format.c" 3 4
           (1 << 3) 
# 2701 "project/radare2/libr/util/format.c"
           && mode & 
# 2701 "project/radare2/libr/util/format.c" 3 4
           (1 << 1)
# 2701 "project/radare2/libr/util/format.c"
...
# 2703 "project/radare2/libr/util/format.c" 3 4
                  (1) 
# 2703 "project/radare2/libr/util/format.c"
                  && mode & 
# 2703 "project/radare2/libr/util/format.c" 3 4
                  (1 << 1) 
# 2703 "project/radare2/libr/util/format.c"
...
# 2703 "project/radare2/libr/util/format.c"
      ...
      if (mode & 
# 2712 "project/radare2/libr/util/format.c" 3 4
                (1 << 1)
# 2712 "project/radare2/libr/util/format.c"
                               ) {
       if (!(mode & 
# 2713 "project/radare2/libr/util/format.c" 3 4
           (1 << 6)
# 2713 "project/radare2/libr/util/format.c"
           )) {
        p->cb_printf ("]\n");
       }
      }
      if ((mode & 
# 2717 "project/radare2/libr/util/format.c" 3 4
         (1 << 3) 
# 2717 "project/radare2/libr/util/format.c"
         && mode & 
# 2717 "project/radare2/libr/util/format.c" 3 4
         (1 << 1)
# 2717 "project/radare2/libr/util/format.c"
     ...
     slide -= 1;
     if (mode & 
# 2724 "project/radare2/libr/util/format.c" 3 4
               (1 << 2)
# 2724 "project/radare2/libr/util/format.c"
                               ) {
      oldslide = slide;
      slide -= 10000;
     }
   ...
   if ((mode & 
# 2759 "project/radare2/libr/util/format.c" 3 4
      (1 << 9)
# 2759 "project/radare2/libr/util/format.c"
      )) {
    if (oldslide) {
     ident -= 4;
     p->cb_printf ("%*c}", ident, ' ');
   ...
   if (mode & 
# 2767 "project/radare2/libr/util/format.c" 3 4
             (1 << 7)
# 2767 "project/radare2/libr/util/format.c"
                        ) {
    p->cb_printf ("}");
   }
   if (mode & 
# 2770 "project/radare2/libr/util/format.c" 3 4
             (1 << 2) 
# 2770 "project/radare2/libr/util/format.c"
                              && isptr != 3) {
    int sz = i - oi;
    if (sz > 1) {
     p->cb_printf ("fl %d @ 0x%08"
# 2773 "project/radare2/libr/util/format.c" 3 4
                                 "llx"
# 2773 "project/radare2/libr/util/format.c"
                                        "\n", sz, seeki);
     p->cb_printf ("Cd %d @ 0x%08"
# 2774 "project/radare2/libr/util/format.c" 3 4
                                 "llx"
# 2774 "project/radare2/libr/util/format.c"
                                        "\n", sz, seeki);
    }
   }
   ...
   if (!noline && tmp != 'D' && !invalid && !fmtname && (mode & 
# 2787 "project/radare2/libr/util/format.c" 3 4
                                                       (1) 
# 2787 "project/radare2/libr/util/format.c"
                                                       && mode & 
# 2787 "project/radare2/libr/util/format.c" 3 4
                                                       (1 << 1) 
# 2787 "project/radare2/libr/util/format.c"
...
# 2787 "project/radare2/libr/util/format.c"
  ...
  if (otimes > 1) {
   if ((mode & 
# 2810 "project/radare2/libr/util/format.c" 3 4
      (1 << 3) 
# 2810 "project/radare2/libr/util/format.c"
      && mode & 
# 2810 "project/radare2/libr/util/format.c" 3 4
      (1 << 1)
# 2810 "project/radare2/libr/util/format.c"
 ...
 if (mode & 
# 2819 "project/radare2/libr/util/format.c" 3 4
           (1 << 3) 
# 2819 "project/radare2/libr/util/format.c"
                        && slide == 0) {
  p->cb_printf("]\n");
 }
 if ((mode & 
# 2822 "project/radare2/libr/util/format.c" 3 4
    (1 << 9)
# 2822 "project/radare2/libr/util/format.c"
    ) && slide == 0) {
  p->cb_printf ("}\n");
 }
 if (mode & 
# 2825 "project/radare2/libr/util/format.c" 3 4
           (1 << 7)
# 2825 "project/radare2/libr/util/format.c"
                      ) {
  p->cb_printf ("\"];\n}\n");
