# 0 "project/radare2/libr/util/protobuf.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/util/protobuf.c" 2



# 6 "project/radare2/libr/util/protobuf.c"
typedef float ft32;
typedef double ft64;
...
static const char* s_wire(const 
# 16 "project/radare2/libr/util/protobuf.c" 3 4
                               unsigned char 
# 16 "project/radare2/libr/util/protobuf.c"
                                   byte) {
 switch (byte) {
 case 0:
  return "[VARINT]";
...
static void pad(RStrBuf *sb, 
# 35 "project/radare2/libr/util/protobuf.c" 3 4
                            unsigned int 
# 35 "project/radare2/libr/util/protobuf.c"
                                 count) {
 
# 36 "project/radare2/libr/util/protobuf.c" 3 4
unsigned int 
# 36 "project/radare2/libr/util/protobuf.c"
     i;
 for (i = 0; i < count; i++) {
  r_strbuf_appendf (sb, "    ");
 }
...
static 
# 42 "project/radare2/libr/util/protobuf.c" 3 4
      _Bool 
# 42 "project/radare2/libr/util/protobuf.c"
           is_string(const 
# 42 "project/radare2/libr/util/protobuf.c" 3 4
                           unsigned char
# 42 "project/radare2/libr/util/protobuf.c"
...
# 42 "project/radare2/libr/util/protobuf.c"
 ...
 while (start < end) {
  ...
  if (!
# 45 "project/radare2/libr/util/protobuf.c" 3 4
      ((
# 45 "project/radare2/libr/util/protobuf.c"
      *start
# 45 "project/radare2/libr/util/protobuf.c" 3 4
      ) >=' ' && (
# 45 "project/radare2/libr/util/protobuf.c"
...
# 45 "project/radare2/libr/util/protobuf.c"
   ...
   return 
# 46 "project/radare2/libr/util/protobuf.c" 3 4
         0
# 46 "project/radare2/libr/util/protobuf.c"
              ;
  }
  start++;
 }
 return 
# 50 "project/radare2/libr/util/protobuf.c" 3 4
       1
# 50 "project/radare2/libr/util/protobuf.c"
           ;
}

static void decode_array(RStrBuf *sb, const 
# 53 "project/radare2/libr/util/protobuf.c" 3 4
                                           unsigned char
# 53 "project/radare2/libr/util/protobuf.c"
                                              * start, const 
# 53 "project/radare2/libr/util/protobuf.c" 3 4
                                                             unsigned char
# 53 "project/radare2/libr/util/protobuf.c"
...
static void decode_buffer(RStrBuf *sb, const 
# 61 "project/radare2/libr/util/protobuf.c" 3 4
                                            unsigned char
# 61 "project/radare2/libr/util/protobuf.c"
                                               * start, const 
# 61 "project/radare2/libr/util/protobuf.c" 3 4
                                                              unsigned char
# 61 "project/radare2/libr/util/protobuf.c"
...
# 63 "project/radare2/libr/util/protobuf.c" 3 4
unsigned int 
# 63 "project/radare2/libr/util/protobuf.c"
     var32 = 0;
 
# 64 "project/radare2/libr/util/protobuf.c" 3 4
unsigned long long 
# 64 "project/radare2/libr/util/protobuf.c"
     var64 = 0;
 const 
# 65 "project/radare2/libr/util/protobuf.c" 3 4
      unsigned char
# 65 "project/radare2/libr/util/protobuf.c"
         * buffer = start;
...
# 71 "project/radare2/libr/util/protobuf.c" 3 4
 unsigned char 
# 71 "project/radare2/libr/util/protobuf.c"
     number = buffer[0] >> 3;
  
# 72 "project/radare2/libr/util/protobuf.c" 3 4
 unsigned char 
# 72 "project/radare2/libr/util/protobuf.c"
     wire = buffer[0] & 0x3;
  buffer++;
  if (buffer < start || buffer >= end) {
   
# 75 "project/radare2/libr/util/protobuf.c" 3 4
  fprintf(__stderrp,
# 75 "project/radare2/libr/util/protobuf.c"
...
# 78 "project/radare2/libr/util/protobuf.c" 3 4
  fprintf(__stderrp,
# 78 "project/radare2/libr/util/protobuf.c"
  "\nunknown wire id (%u).\n", wire
# 78 "project/radare2/libr/util/protobuf.c" 3 4
  )
# 78 "project/radare2/libr/util/protobuf.c"
...
# 92 "project/radare2/libr/util/protobuf.c" 3 4
   long long
# 92 "project/radare2/libr/util/protobuf.c"
       * i = (
# 92 "project/radare2/libr/util/protobuf.c" 3 4
              long long
# 92 "project/radare2/libr/util/protobuf.c"
    ...
    r_strbuf_appendf (sb, ": %"
# 94 "project/radare2/libr/util/protobuf.c" 3 4
                              "llu"
# 94 "project/radare2/libr/util/protobuf.c"
                                     " | %"
# 94 "project/radare2/libr/util/protobuf.c" 3 4
                                           "lld"
# 94 "project/radare2/libr/util/protobuf.c"
...
# 100 "project/radare2/libr/util/protobuf.c" 3 4
   long long
# 100 "project/radare2/libr/util/protobuf.c"
       * i = (
# 100 "project/radare2/libr/util/protobuf.c" 3 4
              long long
# 100 "project/radare2/libr/util/protobuf.c"
    ...
    bytes_read = read_u64_leb128 (buffer, end, &var64);
    r_strbuf_appendf (sb, ": %"
# 102 "project/radare2/libr/util/protobuf.c" 3 4
                              "llu"
# 102 "project/radare2/libr/util/protobuf.c"
                                     " | %"
# 102 "project/radare2/libr/util/protobuf.c" 3 4
                                           "lld"
# 102 "project/radare2/libr/util/protobuf.c"
  ...
  case 2:
   {
    bytes_read = read_u64_leb128 (buffer, end, &var64);
    const 
# 108 "project/radare2/libr/util/protobuf.c" 3 4
         unsigned char
# 108 "project/radare2/libr/util/protobuf.c"
            * ps = buffer + bytes_read;
    const 
# 109 "project/radare2/libr/util/protobuf.c" 3 4
         unsigned char
# 109 "project/radare2/libr/util/protobuf.c"
            * pe = ps + var64;
    if (ps > buffer && pe <= end) {
     if (is_string (ps, pe)) {
...
# 121 "project/radare2/libr/util/protobuf.c" 3 4
    fprintf(__stderrp,
# 121 "project/radare2/libr/util/protobuf.c"
    "\ninvalid delimited length (%"
# 121 "project/radare2/libr/util/protobuf.c" 3 4
    "llu"
# 121 "project/radare2/libr/util/protobuf.c"
    ").\n", var64
...
# 140 "project/radare2/libr/util/protobuf.c" 3 4
   int
# 140 "project/radare2/libr/util/protobuf.c"
       * i = (
# 140 "project/radare2/libr/util/protobuf.c" 3 4
              int
# 140 "project/radare2/libr/util/protobuf.c"
...
# 153 "project/radare2/libr/util/protobuf.c" 3 4
__attribute__((visibility("default"))) 
# 153 "project/radare2/libr/util/protobuf.c"
     char *r_protobuf_decode(const 
# 153 "project/radare2/libr/util/protobuf.c" 3 4
                                   unsigned char
# 153 "project/radare2/libr/util/protobuf.c"
                                      * start, const 
...
# 155 "project/radare2/libr/util/protobuf.c" 3 4
 fprintf(__stderrp,
# 155 "project/radare2/libr/util/protobuf.c"
...
# 155 "project/radare2/libr/util/protobuf.c"
                                              ;
  return 
# 156 "project/radare2/libr/util/protobuf.c" 3 4
        ((void *)0)
# 156 "project/radare2/libr/util/protobuf.c"
            ;
 }
 const 
# 158 "project/radare2/libr/util/protobuf.c" 3 4
      unsigned char
# 158 "project/radare2/libr/util/protobuf.c"
         * end = start + size;
