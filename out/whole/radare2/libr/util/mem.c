# 0 "project/radare2/libr/util/mem.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/util/mem.c" 2
...
# 6 "project/radare2/libr/util/mem.c" 2
...
# 12 "project/radare2/libr/util/mem.c"
     int r_mem_count(const 
# 12 "project/radare2/libr/util/mem.c" 3 4
                           unsigned char 
# 12 "project/radare2/libr/util/mem.c"
                               **addr) {
 int i = 0;
...
# 20 "project/radare2/libr/util/mem.c" 3 4
__attribute__((visibility("default"))) 
# 20 "project/radare2/libr/util/mem.c"
     int r_mem_eq(
# 20 "project/radare2/libr/util/mem.c" 3 4
                  unsigned char 
# 20 "project/radare2/libr/util/mem.c"
...
# 20 "project/radare2/libr/util/mem.c"
 ...
 for (i = 0; i < len; i++) {
  if (a[i] != b[i]) {
   return 
# 24 "project/radare2/libr/util/mem.c" 3 4
         0
# 24 "project/radare2/libr/util/mem.c"
              ;
  }
 }
 return 
# 27 "project/radare2/libr/util/mem.c" 3 4
       1
# 27 "project/radare2/libr/util/mem.c"
           ;
}


# 30 "project/radare2/libr/util/mem.c" 3 4
__attribute__((visibility("default"))) 
# 30 "project/radare2/libr/util/mem.c"
     void r_mem_copyloop(
# 30 "project/radare2/libr/util/mem.c" 3 4
                         unsigned char 
# 30 "project/radare2/libr/util/mem.c"
...
# 39 "project/radare2/libr/util/mem.c" 3 4
__attribute__((visibility("default"))) 
# 39 "project/radare2/libr/util/mem.c"
     int r_mem_cmp_mask(const 
# 39 "project/radare2/libr/util/mem.c" 3 4
                              unsigned char 
# 39 "project/radare2/libr/util/mem.c"
                                  *dest, const 
...
# 40 "project/radare2/libr/util/mem.c" 3 4
unsigned char 
# 40 "project/radare2/libr/util/mem.c"
    *mdest = malloc (len);
 if (!mdest) {
  return -1;
 }
 
# 44 "project/radare2/libr/util/mem.c" 3 4
unsigned char 
# 44 "project/radare2/libr/util/mem.c"
    *morig = malloc (len);
 if (!morig) {
  free (mdest);
  return -1;
...
# 60 "project/radare2/libr/util/mem.c" 3 4
__attribute__((visibility("default"))) 
# 60 "project/radare2/libr/util/mem.c"
     void r_mem_copybits(
# 60 "project/radare2/libr/util/mem.c" 3 4
                         unsigned char 
# 60 "project/radare2/libr/util/mem.c"
...
# 61 "project/radare2/libr/util/mem.c" 3 4
unsigned char 
# 61 "project/radare2/libr/util/mem.c"
    srcmask, dstmask;
 int bytes = (int) (bits / 8);
 bits = bits % 8;
 
# 64 "project/radare2/libr/util/mem.c" 3 4
__builtin___memcpy_chk (
# 64 "project/radare2/libr/util/mem.c"
dst
# 64 "project/radare2/libr/util/mem.c" 3 4
, 
# 64 "project/radare2/libr/util/mem.c"
...
static inline char readbit(const 
# 80 "project/radare2/libr/util/mem.c" 3 4
                                unsigned char 
# 80 "project/radare2/libr/util/mem.c"
                                    *src, int bitoffset) {
...
# 87 "project/radare2/libr/util/mem.c" 3 4
                            unsigned char 
# 87 "project/radare2/libr/util/mem.c"
                                *dst, int i, 
# 87 "project/radare2/libr/util/mem.c" 3 4
                                             _Bool 
# 87 "project/radare2/libr/util/mem.c"
...
# 94 "project/radare2/libr/util/mem.c" 3 4
 (((unsigned char*)
# 94 "project/radare2/libr/util/mem.c"
 dst
# 94 "project/radare2/libr/util/mem.c" 3 4
 )[
# 94 "project/radare2/libr/util/mem.c"
...
# 97 "project/radare2/libr/util/mem.c" 3 4
 (((unsigned char*)
# 97 "project/radare2/libr/util/mem.c"
 dst
# 97 "project/radare2/libr/util/mem.c" 3 4
 )[
# 97 "project/radare2/libr/util/mem.c"
...
# 101 "project/radare2/libr/util/mem.c" 3 4
__attribute__((visibility("default"))) 
# 101 "project/radare2/libr/util/mem.c"
     void r_mem_copybits_delta(
# 101 "project/radare2/libr/util/mem.c" 3 4
                               unsigned char 
# 101 "project/radare2/libr/util/mem.c"
                                   *dst, int doff, const 
...
# 107 "project/radare2/libr/util/mem.c" 3 4
 _Bool 
# 107 "project/radare2/libr/util/mem.c"
      c = readbit (src, i + soff);
  writebit (dst, i + doff, c);
 }
}


# 112 "project/radare2/libr/util/mem.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 112 "project/radare2/libr/util/mem.c"
          r_mem_get_num(const 
# 112 "project/radare2/libr/util/mem.c" 3 4
                              unsigned char 
# 112 "project/radare2/libr/util/mem.c"
...
# 128 "project/radare2/libr/util/mem.c" 3 4
__attribute__((visibility("default"))) 
# 128 "project/radare2/libr/util/mem.c"
     int r_mem_set_num(
# 128 "project/radare2/libr/util/mem.c" 3 4
                       unsigned char 
# 128 "project/radare2/libr/util/mem.c"
...
# 128 "project/radare2/libr/util/mem.c"
 ...
 case 1:
  r_write_le8 (dest, (
# 132 "project/radare2/libr/util/mem.c" 3 4
                     unsigned char
# 132 "project/radare2/libr/util/mem.c"
                        ) (num & 
# 132 "project/radare2/libr/util/mem.c" 3 4
                                 0xFFU
# 132 "project/radare2/libr/util/mem.c"
 ...
 case 2:
  r_write_le16 (dest, (
# 135 "project/radare2/libr/util/mem.c" 3 4
                      unsigned short
# 135 "project/radare2/libr/util/mem.c"
                          ) (num & 
# 135 "project/radare2/libr/util/mem.c" 3 4
                                   0xFFFFU
# 135 "project/radare2/libr/util/mem.c"
 ...
 case 4:
  r_write_le32 (dest, (
# 138 "project/radare2/libr/util/mem.c" 3 4
                      unsigned int
# 138 "project/radare2/libr/util/mem.c"
                          ) (num & 
# 138 "project/radare2/libr/util/mem.c" 3 4
                                   0xFFFFFFFFU
# 138 "project/radare2/libr/util/mem.c"
 ...
 default:
  return 
# 144 "project/radare2/libr/util/mem.c" 3 4
        0
# 144 "project/radare2/libr/util/mem.c"
             ;
 }
 return 
# 146 "project/radare2/libr/util/mem.c" 3 4
       1
# 146 "project/radare2/libr/util/mem.c"
           ;
}
...
# 152 "project/radare2/libr/util/mem.c" 3 4
__attribute__((visibility("default"))) 
# 152 "project/radare2/libr/util/mem.c"
     void r_mem_swaporcopy(
# 152 "project/radare2/libr/util/mem.c" 3 4
                           unsigned char 
# 152 "project/radare2/libr/util/mem.c"
                               *dest, const 
...
# 152 "project/radare2/libr/util/mem.c"
                                                                    big_endian) {
# 162 "project/radare2/libr/util/mem.c"
 if (big_endian) {
  r_mem_swapendian (dest, src, len);
 } else {
  
# 165 "project/radare2/libr/util/mem.c" 3 4
 __builtin___memcpy_chk (
# 165 "project/radare2/libr/util/mem.c"
 dest
# 165 "project/radare2/libr/util/mem.c" 3 4
 , 
# 165 "project/radare2/libr/util/mem.c"
...
# 172 "project/radare2/libr/util/mem.c" 3 4
__attribute__((visibility("default"))) 
# 172 "project/radare2/libr/util/mem.c"
     void r_mem_swapendian(
# 172 "project/radare2/libr/util/mem.c" 3 4
                           unsigned char 
# 172 "project/radare2/libr/util/mem.c"
                               *dest, const 
...
# 173 "project/radare2/libr/util/mem.c" 3 4
unsigned char 
# 173 "project/radare2/libr/util/mem.c"
    buffer[8];
 switch (size) {
 case 1:
  *dest = *orig;
...
# 190 "project/radare2/libr/util/mem.c" 3 4
 __builtin___memcpy_chk (
# 190 "project/radare2/libr/util/mem.c"
 buffer
# 190 "project/radare2/libr/util/mem.c" 3 4
 , 
# 190 "project/radare2/libr/util/mem.c"
...
# 197 "project/radare2/libr/util/mem.c" 3 4
 __builtin___memcpy_chk (
# 197 "project/radare2/libr/util/mem.c"
 buffer
# 197 "project/radare2/libr/util/mem.c" 3 4
 , 
# 197 "project/radare2/libr/util/mem.c"
...
# 209 "project/radare2/libr/util/mem.c" 3 4
  __builtin___memmove_chk (
# 209 "project/radare2/libr/util/mem.c"
  dest
# 209 "project/radare2/libr/util/mem.c" 3 4
  , 
# 209 "project/radare2/libr/util/mem.c"
...
# 214 "project/radare2/libr/util/mem.c" 3 4
__attribute__((visibility("default"))) 
# 214 "project/radare2/libr/util/mem.c"
     void r_mem_swap(
# 214 "project/radare2/libr/util/mem.c" 3 4
                     unsigned char 
# 214 "project/radare2/libr/util/mem.c"
...
# 228 "project/radare2/libr/util/mem.c" 3 4
__attribute__((visibility("default"))) 
# 228 "project/radare2/libr/util/mem.c"
     const 
# 228 "project/radare2/libr/util/mem.c" 3 4
           unsigned char 
# 228 "project/radare2/libr/util/mem.c"
...
# 228 "project/radare2/libr/util/mem.c"
 ...
 if (hlen < 1 || nlen < 1) {
  return 
# 231 "project/radare2/libr/util/mem.c" 3 4
        ((void *)0)
# 231 "project/radare2/libr/util/mem.c"
            ;
 }
 for (i = 0; i < until; i++) {
 ...
 return 
# 238 "project/radare2/libr/util/mem.c" 3 4
       ((void *)0)
# 238 "project/radare2/libr/util/mem.c"
           ;
}



# 242 "project/radare2/libr/util/mem.c" 3 4
__attribute__((visibility("default"))) 
# 242 "project/radare2/libr/util/mem.c"
     const 
# 242 "project/radare2/libr/util/mem.c" 3 4
           unsigned char 
# 242 "project/radare2/libr/util/mem.c"
               *r_mem_mem_aligned(const 
# 242 "project/radare2/libr/util/mem.c" 3 4
                                        unsigned char 
# 242 "project/radare2/libr/util/mem.c"
                                            *haystack, int hlen, const 
...
# 242 "project/radare2/libr/util/mem.c"
 ...
 if (hlen < 1 || nlen < 1) {
  return 
# 248 "project/radare2/libr/util/mem.c" 3 4
        ((void *)0)
# 248 "project/radare2/libr/util/mem.c"
            ;
 }
 if (align > 1) {
  until -= (until % align);
 ...
 return 
# 258 "project/radare2/libr/util/mem.c" 3 4
       ((void *)0)
# 258 "project/radare2/libr/util/mem.c"
           ;
}


# 261 "project/radare2/libr/util/mem.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 261 "project/radare2/libr/util/mem.c"
          r_mem_protect(void *ptr, int size, const char *prot) {
 ...
 if (strchr (prot, 'x')) {
  p |= 
# 267 "project/radare2/libr/util/mem.c" 3 4
      0x04
# 267 "project/radare2/libr/util/mem.c"
               ;
 }
 if (strchr (prot, 'r')) {
  p |= 
# 270 "project/radare2/libr/util/mem.c" 3 4
      0x01
# 270 "project/radare2/libr/util/mem.c"
               ;
 }
 if (strchr (prot, 'w')) {
  p |= 
# 273 "project/radare2/libr/util/mem.c" 3 4
      0x02
# 273 "project/radare2/libr/util/mem.c"
                ;
 }
 if (mprotect (ptr, size, p) == -1) {
  return 
# 276 "project/radare2/libr/util/mem.c" 3 4
        0
# 276 "project/radare2/libr/util/mem.c"
             ;
 }
# 300 "project/radare2/libr/util/mem.c"
 return 
# 300 "project/radare2/libr/util/mem.c" 3 4
       1
# 300 "project/radare2/libr/util/mem.c"
           ;
}
...
# 303 "project/radare2/libr/util/mem.c" 3 4
__attribute__((visibility("default"))) 
# 303 "project/radare2/libr/util/mem.c"
     void *r_mem_dup(const void *s, int l) {
 void *d = malloc (l);
 if (d) {
  
# 306 "project/radare2/libr/util/mem.c" 3 4
 __builtin___memcpy_chk (
# 306 "project/radare2/libr/util/mem.c"
 d
# 306 "project/radare2/libr/util/mem.c" 3 4
 , 
# 306 "project/radare2/libr/util/mem.c"
...
# 311 "project/radare2/libr/util/mem.c" 3 4
__attribute__((visibility("default"))) 
# 311 "project/radare2/libr/util/mem.c"
     void r_mem_reverse(
# 311 "project/radare2/libr/util/mem.c" 3 4
                        unsigned char 
# 311 "project/radare2/libr/util/mem.c"
...
# 312 "project/radare2/libr/util/mem.c" 3 4
unsigned char 
# 312 "project/radare2/libr/util/mem.c"
    tmp;
 int i, end = l / 2;
 for (i = 0; i < end; i++) {
  tmp = b[i];
...
# 321 "project/radare2/libr/util/mem.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 321 "project/radare2/libr/util/mem.c"
          r_mem_is_printable(const 
# 321 "project/radare2/libr/util/mem.c" 3 4
                                   unsigned char 
# 321 "project/radare2/libr/util/mem.c"
                                       *a, int la) {
 ...
 for (i = 0; i < la; i++) {
  if (a[i] != '\n' && a[i] != '\t' && !
# 324 "project/radare2/libr/util/mem.c" 3 4
                                      ((
# 324 "project/radare2/libr/util/mem.c"
                                      a[i]
# 324 "project/radare2/libr/util/mem.c" 3 4
                                      ) >=' ' && (
# 324 "project/radare2/libr/util/mem.c"
...
# 324 "project/radare2/libr/util/mem.c"
   ...
   return 
# 325 "project/radare2/libr/util/mem.c" 3 4
         0
# 325 "project/radare2/libr/util/mem.c"
              ;
  }
 }
 return 
# 328 "project/radare2/libr/util/mem.c" 3 4
       1
# 328 "project/radare2/libr/util/mem.c"
           ;
}


# 331 "project/radare2/libr/util/mem.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 331 "project/radare2/libr/util/mem.c"
          r_mem_is_zero(const 
# 331 "project/radare2/libr/util/mem.c" 3 4
                              unsigned char 
# 331 "project/radare2/libr/util/mem.c"
 ...
 for (i = 0; i < l; i++) {
  if (b[i]) {
   return 
# 335 "project/radare2/libr/util/mem.c" 3 4
         0
# 335 "project/radare2/libr/util/mem.c"
              ;
  }
 }
 return 
# 338 "project/radare2/libr/util/mem.c" 3 4
       1
# 338 "project/radare2/libr/util/mem.c"
           ;
}


# 341 "project/radare2/libr/util/mem.c" 3 4
__attribute__((visibility("default"))) 
# 341 "project/radare2/libr/util/mem.c"
     void *r_mem_alloc(int sz) {
 return calloc (sz, 1);
}


# 345 "project/radare2/libr/util/mem.c" 3 4
__attribute__((visibility("default"))) 
# 345 "project/radare2/libr/util/mem.c"
     void r_mem_free(void *p) {
 free (p);
}


# 349 "project/radare2/libr/util/mem.c" 3 4
__attribute__((visibility("default"))) 
# 349 "project/radare2/libr/util/mem.c"
     void r_mem_memzero(void *dst, size_t l) {
# 359 "project/radare2/libr/util/mem.c"
 
# 359 "project/radare2/libr/util/mem.c" 3 4
...
# 364 "project/radare2/libr/util/mem.c" 3 4
__attribute__((visibility("default"))) 
# 364 "project/radare2/libr/util/mem.c"
     void *r_mem_mmap_resize(RMmap *m, 
# 364 "project/radare2/libr/util/mem.c" 3 4
                                       unsigned long long 
# 364 "project/radare2/libr/util/mem.c"
                                            newsize) {
# 376 "project/radare2/libr/util/mem.c"
 if (munmap (m->buf, m->len) != 0) {
  return 
# 377 "project/radare2/libr/util/mem.c" 3 4
        ((void *)0)
# 377 "project/radare2/libr/util/mem.c"
            ;
 }

 if (!r_sys_truncate (m->filename, newsize)) {
  return 
# 381 "project/radare2/libr/util/mem.c" 3 4
        ((void *)0)
# 381 "project/radare2/libr/util/mem.c"
            ;
 }
 m->len = newsize;
