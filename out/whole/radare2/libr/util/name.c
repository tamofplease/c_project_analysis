# 0 "project/radare2/libr/util/name.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/util/name.c" 2

#define FAST_FILTER 1


__attribute__((visibility("default"))) _Bool 
# 8 "project/radare2/libr/util/name.c"
          r_name_validate_print(const char ch) {

 if ((ch >= 'a' && ch <= 'z') || (ch >= 'A' && ch <= 'Z') || 
# 10 "project/radare2/libr/util/name.c" 3 4
                                                            ((
# 10 "project/radare2/libr/util/name.c"
                                                            ch
# 10 "project/radare2/libr/util/name.c" 3 4
                                                            ) >= '0' && (
# 10 "project/radare2/libr/util/name.c"
...
# 10 "project/radare2/libr/util/name.c"
  ...
  return 
# 11 "project/radare2/libr/util/name.c" 3 4
        1
# 11 "project/radare2/libr/util/name.c"
            ;
 }
 switch (ch) {
 case '(':
 ...
 case '_':
  return 
# 30 "project/radare2/libr/util/name.c" 3 4
        1
# 30 "project/radare2/libr/util/name.c"
            ;
 case '\b':
 case '\t':
 case '\n':
 case '\r':
  ...
  return 
# 36 "project/radare2/libr/util/name.c" 3 4
        0
# 36 "project/radare2/libr/util/name.c"
             ;
 }
 return 
# 38 "project/radare2/libr/util/name.c" 3 4
       0
# 38 "project/radare2/libr/util/name.c"
            ;
}



# 42 "project/radare2/libr/util/name.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 42 "project/radare2/libr/util/name.c"
          r_name_validate_dash(const char ch) {
 switch (ch) {
 case ' ':
 case '-':
 case '_':
 ...
 case '"':
  return 
# 64 "project/radare2/libr/util/name.c" 3 4
        1
# 64 "project/radare2/libr/util/name.c"
            ;
 }
 return 
# 66 "project/radare2/libr/util/name.c" 3 4
       0
# 66 "project/radare2/libr/util/name.c"
            ;
}
# 84 "project/radare2/libr/util/name.c"

# 84 "project/radare2/libr/util/name.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 84 "project/radare2/libr/util/name.c"
          r_name_validate_first(const char ch) {
 if ((ch >= 'a' && ch <= 'z') || (ch >= 'A' && ch <= 'Z')) {
  return 
# 86 "project/radare2/libr/util/name.c" 3 4
        1
# 86 "project/radare2/libr/util/name.c"
            ;
 }
 switch (ch) {
 case '_':
 case ':':
  return 
# 91 "project/radare2/libr/util/name.c" 3 4
        1
# 91 "project/radare2/libr/util/name.c"
            ;
 }
 return 
# 93 "project/radare2/libr/util/name.c" 3 4
       0
# 93 "project/radare2/libr/util/name.c"
            ;
}


# 96 "project/radare2/libr/util/name.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 96 "project/radare2/libr/util/name.c"
          r_name_check(const char *s) {
 if (!r_name_validate_first (*s)) {
  return 
# 98 "project/radare2/libr/util/name.c" 3 4
        0
# 98 "project/radare2/libr/util/name.c"
             ;
 }
 for (s++; *s; s++) {
  if (!r_name_validate_char (*s)) {
   return 
# 102 "project/radare2/libr/util/name.c" 3 4
         0
# 102 "project/radare2/libr/util/name.c"
              ;
  }
 }
 return 
# 105 "project/radare2/libr/util/name.c" 3 4
       1
# 105 "project/radare2/libr/util/name.c"
           ;
}

static inline 
# 108 "project/radare2/libr/util/name.c" 3 4
             _Bool 
# 108 "project/radare2/libr/util/name.c"
                  is_special_char(char n) {
 return (n == 'b' || n == 'f' || n == 'n' || n == 'r' || n == 't' || n == 'v' || n == 'a');
}


# 112 "project/radare2/libr/util/name.c" 3 4
__attribute__((visibility("default"))) 
# 112 "project/radare2/libr/util/name.c"
     const char *r_name_filter_ro(const char *a) {
 while (*a++ == '_');
 return a - 1;
}
...
# 118 "project/radare2/libr/util/name.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 118 "project/radare2/libr/util/name.c"
          r_name_filter_print(char *s) {
 char *es = s + strlen (s);
 char *os = s;
 while (*s && s < es) {
  int us = r_utf8_size ((const 
# 122 "project/radare2/libr/util/name.c" 3 4
                              unsigned char
# 122 "project/radare2/libr/util/name.c"
                                 *)s);
  if (us > 1) {
   s += us;
   continue;
...
# 128 "project/radare2/libr/util/name.c" 3 4
  __builtin___memmove_chk ((
# 128 "project/radare2/libr/util/name.c"
  s
# 128 "project/radare2/libr/util/name.c" 3 4
  ), (
# 128 "project/radare2/libr/util/name.c"
...
# 135 "project/radare2/libr/util/name.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 135 "project/radare2/libr/util/name.c"
          r_name_filter(char *s, int maxlen) {
...
# 161 "project/radare2/libr/util/name.c"
 for (s++; *s; s++) {
...
# 170 "project/radare2/libr/util/name.c" 3 4
   __builtin___memmove_chk ((
# 170 "project/radare2/libr/util/name.c"
   s
# 170 "project/radare2/libr/util/name.c" 3 4
   ), (
# 170 "project/radare2/libr/util/name.c"
...
# 178 "project/radare2/libr/util/name.c" 3 4
   __builtin___memmove_chk ((
# 178 "project/radare2/libr/util/name.c"
   s
# 178 "project/radare2/libr/util/name.c" 3 4
   ), (
# 178 "project/radare2/libr/util/name.c"
...
# 178 "project/radare2/libr/util/name.c"
 ...
 return 
# 187 "project/radare2/libr/util/name.c" 3 4
       1
# 187 "project/radare2/libr/util/name.c"
           ;
...
# 194 "project/radare2/libr/util/name.c" 3 4
__attribute__((visibility("default"))) 
# 194 "project/radare2/libr/util/name.c"
     char *r_name_filter2(const char *name) {
 char *s = strdup (name);
 r_name_filter (s, -1);
 return s;
}
