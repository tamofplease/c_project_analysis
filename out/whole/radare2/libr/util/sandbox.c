# 0 "project/radare2/libr/util/sandbox.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/sandbox.c"
...
# 4 "project/radare2/libr/util/sandbox.c" 2
# 18 "project/radare2/libr/util/sandbox.c"

# 18 "project/radare2/libr/util/sandbox.c"
static 
# 18 "project/radare2/libr/util/sandbox.c" 3 4
      _Bool 
# 18 "project/radare2/libr/util/sandbox.c"
           enabled = 
# 18 "project/radare2/libr/util/sandbox.c" 3 4
...
# 18 "project/radare2/libr/util/sandbox.c"
                          ;
static 
# 19 "project/radare2/libr/util/sandbox.c" 3 4
      _Bool 
# 19 "project/radare2/libr/util/sandbox.c"
           disabled = 
# 19 "project/radare2/libr/util/sandbox.c" 3 4
                      0
# 19 "project/radare2/libr/util/sandbox.c"
...
static 
# 21 "project/radare2/libr/util/sandbox.c" 3 4
      _Bool 
# 21 "project/radare2/libr/util/sandbox.c"
           inHomeWww(const char *path) {
 
# 22 "project/radare2/libr/util/sandbox.c" 3 4
do { if (!(
# 22 "project/radare2/libr/util/sandbox.c"
path
# 22 "project/radare2/libr/util/sandbox.c" 3 4
...
# 23 "project/radare2/libr/util/sandbox.c" 3 4
_Bool 
# 23 "project/radare2/libr/util/sandbox.c"
     ret = 
# 23 "project/radare2/libr/util/sandbox.c" 3 4
           0
# 23 "project/radare2/libr/util/sandbox.c"
                ;
 char *homeWww = r_str_home (
# 24 "project/radare2/libr/util/sandbox.c" 3 4
                            ".local" "/" "share" "/" "radare2" "/" "www" "/"
# 24 "project/radare2/libr/util/sandbox.c"
                                                     );
 if (homeWww) {
  if (!strncmp (path, homeWww, strlen (homeWww))) {
   ret = 
# 27 "project/radare2/libr/util/sandbox.c" 3 4
        1
# 27 "project/radare2/libr/util/sandbox.c"
            ;
  }
  free (homeWww);
 }
...
# 40 "project/radare2/libr/util/sandbox.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 40 "project/radare2/libr/util/sandbox.c"
          r_sandbox_check_path (const char *path) {
 
# 41 "project/radare2/libr/util/sandbox.c" 3 4
do { if (!(
# 41 "project/radare2/libr/util/sandbox.c"
path
# 41 "project/radare2/libr/util/sandbox.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 41 "project/radare2/libr/util/sandbox.c"
...
# 41 "project/radare2/libr/util/sandbox.c"
 ...
 root_len = strlen (
# 45 "project/radare2/libr/util/sandbox.c" 3 4
                   "/usr/local/lib"
# 45 "project/radare2/libr/util/sandbox.c"
                            "/radare2");
 if (!strncmp (path, 
# 46 "project/radare2/libr/util/sandbox.c" 3 4
                    "/usr/local/lib"
# 46 "project/radare2/libr/util/sandbox.c"
                             "/radare2", root_len)) {
  return 
# 47 "project/radare2/libr/util/sandbox.c" 3 4
        1
# 47 "project/radare2/libr/util/sandbox.c"
            ;
 }
 root_len = strlen (
# 49 "project/radare2/libr/util/sandbox.c" 3 4
                   "/usr/local/share"
# 49 "project/radare2/libr/util/sandbox.c"
                            "/radare2");
 if (!strncmp (path, 
# 50 "project/radare2/libr/util/sandbox.c" 3 4
                    "/usr/local/share"
# 50 "project/radare2/libr/util/sandbox.c"
                             "/radare2", root_len)) {
  return 
# 51 "project/radare2/libr/util/sandbox.c" 3 4
        1
# 51 "project/radare2/libr/util/sandbox.c"
            ;
 }
 if (inHomeWww (path)) {
  return 
# 54 "project/radare2/libr/util/sandbox.c" 3 4
        1
# 54 "project/radare2/libr/util/sandbox.c"
            ;
 }

 root_len = strlen (
# 57 "project/radare2/libr/util/sandbox.c" 3 4
                   "/usr/local/share" "/radare2/" "5.5.4" "/www"
# 57 "project/radare2/libr/util/sandbox.c"
                             );
 if (
# 58 "project/radare2/libr/util/sandbox.c" 3 4
    "/usr/local/share" "/radare2/" "5.5.4" "/www"
# 58 "project/radare2/libr/util/sandbox.c"
              [0] && !strncmp (path, 
# 58 "project/radare2/libr/util/sandbox.c" 3 4
                                     "/usr/local/share" "/radare2/" "5.5.4" "/www"
# 58 "project/radare2/libr/util/sandbox.c"
...
# 59 "project/radare2/libr/util/sandbox.c" 3 4
  "/usr/local/share" "/radare2/" "5.5.4" "/www"
# 59 "project/radare2/libr/util/sandbox.c"
            [root_len-1] == '/' || path[root_len] == '/' || path[root_len] == '\0')) {
  path += strlen (
# 60 "project/radare2/libr/util/sandbox.c" 3 4
                 "/usr/local/share" "/radare2/" "5.5.4" "/www"
# 60 "project/radare2/libr/util/sandbox.c"
                           );
  while (*path == '/') {
   path++;
  }
        ...
        if (path[0]=='.' && path[1]=='/') {
  return 
# 68 "project/radare2/libr/util/sandbox.c" 3 4
        0
# 68 "project/radare2/libr/util/sandbox.c"
             ;
 }
 ...
 for (p = strstr (path, "/.."); p; p = strstr(p, "/..")) {
  if (p[3] == '\0' || p[3] == '/') {
   return 
# 78 "project/radare2/libr/util/sandbox.c" 3 4
         0
# 78 "project/radare2/libr/util/sandbox.c"
              ;
  }
 }
 ...
 if (*path == '/') {
  return 
# 83 "project/radare2/libr/util/sandbox.c" 3 4
        0
# 83 "project/radare2/libr/util/sandbox.c"
             ;
 }
 ...
 if (readlink (path, &ch, 1) != -1) {
  return 
# 88 "project/radare2/libr/util/sandbox.c" 3 4
        0
# 88 "project/radare2/libr/util/sandbox.c"
             ;
 }

 return 
# 91 "project/radare2/libr/util/sandbox.c" 3 4
       1
# 91 "project/radare2/libr/util/sandbox.c"
           ;
}


# 94 "project/radare2/libr/util/sandbox.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 94 "project/radare2/libr/util/sandbox.c"
          r_sandbox_disable (
# 94 "project/radare2/libr/util/sandbox.c" 3 4
                             _Bool 
# 94 "project/radare2/libr/util/sandbox.c"
                                  e) {
 if (e) {
# 114 "project/radare2/libr/util/sandbox.c"
  disabled = enabled;
  enabled = 
# 115 "project/radare2/libr/util/sandbox.c" 3 4
           0
# 115 "project/radare2/libr/util/sandbox.c"
                ;
 } else {
  enabled = disabled;
  disabled = 
# 118 "project/radare2/libr/util/sandbox.c" 3 4
            0
# 118 "project/radare2/libr/util/sandbox.c"
                 ;
 }
 return enabled;
}
...
# 123 "project/radare2/libr/util/sandbox.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 123 "project/radare2/libr/util/sandbox.c"
          r_sandbox_enable (
# 123 "project/radare2/libr/util/sandbox.c" 3 4
                            _Bool 
# 123 "project/radare2/libr/util/sandbox.c"
 ...
 if (enabled) {
  ...
  return 
# 128 "project/radare2/libr/util/sandbox.c" 3 4
        1
# 128 "project/radare2/libr/util/sandbox.c"
            ;
 }
 enabled = e;
# 204 "project/radare2/libr/util/sandbox.c"
 return enabled;
}


# 207 "project/radare2/libr/util/sandbox.c" 3 4
__attribute__((visibility("default"))) 
# 207 "project/radare2/libr/util/sandbox.c"
     int r_sandbox_system(const char *x, int n) {
 
# 208 "project/radare2/libr/util/sandbox.c" 3 4
do { if (!(
# 208 "project/radare2/libr/util/sandbox.c"
x
# 208 "project/radare2/libr/util/sandbox.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 208 "project/radare2/libr/util/sandbox.c"
...
# 210 "project/radare2/libr/util/sandbox.c" 3 4
 fprintf(__stderrp,
# 210 "project/radare2/libr/util/sandbox.c"
 "sandbox: system call disabled\n"
# 210 "project/radare2/libr/util/sandbox.c" 3 4
 )
# 210 "project/radare2/libr/util/sandbox.c"
                                            ;
 ...
 if (n) {
# 233 "project/radare2/libr/util/sandbox.c"
  return system (x);

 }
 char *bin_sh = r_file_binsh ();
 int rc = execl (bin_sh, "sh", "-c", x, (const char*)
# 237 "project/radare2/libr/util/sandbox.c" 3 4
                                                    ((void *)0)
# 237 "project/radare2/libr/util/sandbox.c"
                                                        );
 free (bin_sh);
 return rc;
# 287 "project/radare2/libr/util/sandbox.c"
 return -1;
}


# 290 "project/radare2/libr/util/sandbox.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 290 "project/radare2/libr/util/sandbox.c"
          r_sandbox_creat (const char *path, int mode) {
 if (enabled) {
  return 
# 292 "project/radare2/libr/util/sandbox.c" 3 4
        0
# 292 "project/radare2/libr/util/sandbox.c"
             ;
 ...
 int fd = open (path, 
# 300 "project/radare2/libr/util/sandbox.c" 3 4
                     0x00000200 
# 300 "project/radare2/libr/util/sandbox.c"
                             | 
# 300 "project/radare2/libr/util/sandbox.c" 3 4
                               0x00000400 
# 300 "project/radare2/libr/util/sandbox.c"
...
# 300 "project/radare2/libr/util/sandbox.c"
 ...
 if (fd != -1) {
  close (fd);
  return 
# 303 "project/radare2/libr/util/sandbox.c" 3 4
        1
# 303 "project/radare2/libr/util/sandbox.c"
            ;
 }
 return 
# 305 "project/radare2/libr/util/sandbox.c" 3 4
       0
# 305 "project/radare2/libr/util/sandbox.c"
            ;
}
...
# 312 "project/radare2/libr/util/sandbox.c" 3 4
__attribute__((visibility("default"))) 
# 312 "project/radare2/libr/util/sandbox.c"
     int r_sandbox_lseek(int fd, 
# 312 "project/radare2/libr/util/sandbox.c" 3 4
                                 unsigned long long 
# 312 "project/radare2/libr/util/sandbox.c"
                                      addr, int whence) {
...
# 319 "project/radare2/libr/util/sandbox.c" 3 4
__attribute__((visibility("default"))) 
# 319 "project/radare2/libr/util/sandbox.c"
     int r_sandbox_truncate(int fd, 
# 319 "project/radare2/libr/util/sandbox.c" 3 4
                                    unsigned long long 
# 319 "project/radare2/libr/util/sandbox.c"
                                         length) {
...
# 330 "project/radare2/libr/util/sandbox.c" 3 4
__attribute__((visibility("default"))) 
# 330 "project/radare2/libr/util/sandbox.c"
     int r_sandbox_read(int fd, 
# 330 "project/radare2/libr/util/sandbox.c" 3 4
                                unsigned char 
# 330 "project/radare2/libr/util/sandbox.c"
                                    *buf, int len) {
...
# 334 "project/radare2/libr/util/sandbox.c" 3 4
__attribute__((visibility("default"))) 
# 334 "project/radare2/libr/util/sandbox.c"
     int r_sandbox_write(int fd, const 
# 334 "project/radare2/libr/util/sandbox.c" 3 4
                                       unsigned char
# 334 "project/radare2/libr/util/sandbox.c"
                                          * buf, int len) {
...
# 338 "project/radare2/libr/util/sandbox.c" 3 4
__attribute__((visibility("default"))) 
# 338 "project/radare2/libr/util/sandbox.c"
     int r_sandbox_close(int fd) {
 return enabled? -1: close (fd);
}



# 343 "project/radare2/libr/util/sandbox.c" 3 4
__attribute__((visibility("default"))) 
# 343 "project/radare2/libr/util/sandbox.c"
     int r_sandbox_open(const char *path, int perm, int mode) {
 
# 344 "project/radare2/libr/util/sandbox.c" 3 4
do { if (!(
# 344 "project/radare2/libr/util/sandbox.c"
path
# 344 "project/radare2/libr/util/sandbox.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 344 "project/radare2/libr/util/sandbox.c"
...
# 344 "project/radare2/libr/util/sandbox.c"
 ...
 if (enabled) {
  if ((perm & 
# 353 "project/radare2/libr/util/sandbox.c" 3 4
             0x00000200
# 353 "project/radare2/libr/util/sandbox.c"
                    ) || (perm & 
# 353 "project/radare2/libr/util/sandbox.c" 3 4
                                 0x0002
# 353 "project/radare2/libr/util/sandbox.c"
...
# 416 "project/radare2/libr/util/sandbox.c"
...
# 422 "project/radare2/libr/util/sandbox.c" 3 4
__attribute__((visibility("default"))) 
# 422 "project/radare2/libr/util/sandbox.c"
     FILE *r_sandbox_fopen (const char *path, const char *mode) {
 
# 423 "project/radare2/libr/util/sandbox.c" 3 4
do { if (!(
# 423 "project/radare2/libr/util/sandbox.c"
path && mode
# 423 "project/radare2/libr/util/sandbox.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 423 "project/radare2/libr/util/sandbox.c"
"path && mode"
# 423 "project/radare2/libr/util/sandbox.c" 3 4
, 423); return (((void *)0)); } } while (0)
# 423 "project/radare2/libr/util/sandbox.c"
                                         ;
 FILE *ret = 
# 424 "project/radare2/libr/util/sandbox.c" 3 4
            ((void *)0)
# 424 "project/radare2/libr/util/sandbox.c"
                ;
 char *epath = 
# 425 "project/radare2/libr/util/sandbox.c" 3 4
              ((void *)0)
# 425 "project/radare2/libr/util/sandbox.c"
                  ;
 if (enabled) {
  if (strchr (mode, 'w') || strchr (mode, 'a') || strchr (mode, '+')) {
   return 
# 428 "project/radare2/libr/util/sandbox.c" 3 4
         ((void *)0)
# 428 "project/radare2/libr/util/sandbox.c"
             ;
  }
  ...
  if (!r_sandbox_check_path (epath)) {
   free (epath);
   return 
# 433 "project/radare2/libr/util/sandbox.c" 3 4
         ((void *)0)
# 433 "project/radare2/libr/util/sandbox.c"
             ;
  }
 }
 if (!epath) {
...
# 456 "project/radare2/libr/util/sandbox.c"
...
# 463 "project/radare2/libr/util/sandbox.c" 3 4
__attribute__((visibility("default"))) 
# 463 "project/radare2/libr/util/sandbox.c"
     int r_sandbox_chdir(const char *path) {
 
# 464 "project/radare2/libr/util/sandbox.c" 3 4
do { if (!(
# 464 "project/radare2/libr/util/sandbox.c"
path
# 464 "project/radare2/libr/util/sandbox.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 464 "project/radare2/libr/util/sandbox.c"
...
# 478 "project/radare2/libr/util/sandbox.c" 3 4
__attribute__((visibility("default"))) 
# 478 "project/radare2/libr/util/sandbox.c"
     int r_sandbox_kill(int pid, int sig) {
 
# 479 "project/radare2/libr/util/sandbox.c" 3 4
do { if (!(
# 479 "project/radare2/libr/util/sandbox.c"
pid != -1
# 479 "project/radare2/libr/util/sandbox.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 479 "project/radare2/libr/util/sandbox.c"
...
# 507 "project/radare2/libr/util/sandbox.c"

# 507 "project/radare2/libr/util/sandbox.c" 3 4
__attribute__((visibility("default"))) 
# 507 "project/radare2/libr/util/sandbox.c"
     DIR* r_sandbox_opendir (const char *path) {
 
# 508 "project/radare2/libr/util/sandbox.c" 3 4
do { if (!(
# 508 "project/radare2/libr/util/sandbox.c"
path
# 508 "project/radare2/libr/util/sandbox.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 508 "project/radare2/libr/util/sandbox.c"
"path"
# 508 "project/radare2/libr/util/sandbox.c" 3 4
, 508); return (((void *)0)); } } while (0)
# 508 "project/radare2/libr/util/sandbox.c"
                                 ;
 if (r_sandbox_enable (0)) {
  if (path && !r_sandbox_check_path (path)) {
   return 
# 511 "project/radare2/libr/util/sandbox.c" 3 4
         ((void *)0)
# 511 "project/radare2/libr/util/sandbox.c"
             ;
  }
 }
 return opendir (path);
...
# 517 "project/radare2/libr/util/sandbox.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 517 "project/radare2/libr/util/sandbox.c"
          r_sys_stop (void) {
 if (enabled) {
  return 
# 519 "project/radare2/libr/util/sandbox.c" 3 4
        0
# 519 "project/radare2/libr/util/sandbox.c"
             ;
 }

 return !r_sandbox_kill (0, 
# 522 "project/radare2/libr/util/sandbox.c" 3 4
                           18
# 522 "project/radare2/libr/util/sandbox.c"
                                  );
