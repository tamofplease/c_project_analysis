# 0 "project/radare2/libr/util/pkcs7.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/pkcs7.c"
...
# 4 "project/radare2/libr/util/pkcs7.c" 2
...
# 5 "project/radare2/libr/util/pkcs7.c" 2
...
# 6 "project/radare2/libr/util/pkcs7.c" 2
# 1 "project/radare2/libr/util/./x509.h" 1

#define R_X509_INTERNAL_H 

__attribute__((visibility("default"))) _Bool 
# 4 "project/radare2/libr/util/./x509.h"
          r_x509_parse_algorithmidentifier(RX509AlgorithmIdentifier *ai, RASN1Object * object);

# 5 "project/radare2/libr/util/./x509.h" 3 4
__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/util/./x509.h"
     void r_x509_free_algorithmidentifier(RX509AlgorithmIdentifier * ai);


# 7 "project/radare2/libr/util/./x509.h" 3 4
__attribute__((visibility("default"))) _Bool 
# 7 "project/radare2/libr/util/./x509.h"
          r_x509_parse_subjectpublickeyinfo(RX509SubjectPublicKeyInfo * spki, RASN1Object *object);

# 8 "project/radare2/libr/util/./x509.h" 3 4
__attribute__((visibility("default"))) 
# 8 "project/radare2/libr/util/./x509.h"
     void r_x509_free_subjectpublickeyinfo(RX509SubjectPublicKeyInfo * spki);


# 10 "project/radare2/libr/util/./x509.h" 3 4
__attribute__((visibility("default"))) _Bool 
# 10 "project/radare2/libr/util/./x509.h"
          r_x509_parse_name(RX509Name *name, RASN1Object * object);

# 11 "project/radare2/libr/util/./x509.h" 3 4
__attribute__((visibility("default"))) 
# 11 "project/radare2/libr/util/./x509.h"
     void r_x509_free_name(RX509Name * name);


# 13 "project/radare2/libr/util/./x509.h" 3 4
__attribute__((visibility("default"))) _Bool 
# 13 "project/radare2/libr/util/./x509.h"
          r_x509_parse_extension(RX509Extension *ext, RASN1Object * object);

# 14 "project/radare2/libr/util/./x509.h" 3 4
__attribute__((visibility("default"))) 
# 14 "project/radare2/libr/util/./x509.h"
     void r_x509_free_extension(RX509Extension * ex);


# 16 "project/radare2/libr/util/./x509.h" 3 4
__attribute__((visibility("default"))) _Bool 
# 16 "project/radare2/libr/util/./x509.h"
          r_x509_parse_extensions(RX509Extensions *ext, RASN1Object * object);

# 17 "project/radare2/libr/util/./x509.h" 3 4
__attribute__((visibility("default"))) 
# 17 "project/radare2/libr/util/./x509.h"
     void r_x509_free_extensions(RX509Extensions* ex);


# 19 "project/radare2/libr/util/./x509.h" 3 4
__attribute__((visibility("default"))) _Bool 
# 19 "project/radare2/libr/util/./x509.h"
          r_x509_parse_tbscertificate(RX509TBSCertificate *tbsc, RASN1Object * object);

# 20 "project/radare2/libr/util/./x509.h" 3 4
__attribute__((visibility("default"))) 
# 20 "project/radare2/libr/util/./x509.h"
     void r_x509_free_tbscertificate(RX509TBSCertificate * tbsc);


# 22 "project/radare2/libr/util/./x509.h" 3 4
__attribute__((visibility("default"))) 
# 22 "project/radare2/libr/util/./x509.h"
     RX509CRLEntry *r_x509_parse_crlentry(RASN1Object *object);

# 23 "project/radare2/libr/util/./x509.h" 3 4
__attribute__((visibility("default"))) 
# 23 "project/radare2/libr/util/./x509.h"
     void r_x509_name_dump(RX509Name* name, const char* pad, RStrBuf *sb);
# 7 "project/radare2/libr/util/pkcs7.c" 2
...
static 
# 11 "project/radare2/libr/util/pkcs7.c" 3 4
      _Bool 
# 11 "project/radare2/libr/util/pkcs7.c"
           r_pkcs7_parse_attributes(RPKCS7Attributes *attribute, RASN1Object *object);

static 
# 13 "project/radare2/libr/util/pkcs7.c" 3 4
      _Bool 
# 13 "project/radare2/libr/util/pkcs7.c"
           r_pkcs7_parse_contentinfo(RPKCS7ContentInfo *ci, RASN1Object *object) {
 if (!ci || !object || object->list.length < 1 || !object->list.objects[0]) {
  return 
# 15 "project/radare2/libr/util/pkcs7.c" 3 4
        0
# 15 "project/radare2/libr/util/pkcs7.c"
             ;
 }
 ...
 return 
# 24 "project/radare2/libr/util/pkcs7.c" 3 4
       1
# 24 "project/radare2/libr/util/pkcs7.c"
           ;
}

static 
# 27 "project/radare2/libr/util/pkcs7.c" 3 4
      _Bool 
# 27 "project/radare2/libr/util/pkcs7.c"
           r_pkcs7_parse_certificaterevocationlists(RPKCS7CertificateRevocationLists *crls, RASN1Object *object) {
 
# 28 "project/radare2/libr/util/pkcs7.c" 3 4
unsigned int 
# 28 "project/radare2/libr/util/pkcs7.c"
     i;
 if (!crls || !object) {
  return 
# 30 "project/radare2/libr/util/pkcs7.c" 3 4
        0
# 30 "project/radare2/libr/util/pkcs7.c"
             ;
 }
 if (object->list.length > 0) {
  ...
  if (!crls->elements) {
   return 
# 35 "project/radare2/libr/util/pkcs7.c" 3 4
         0
# 35 "project/radare2/libr/util/pkcs7.c"
              ;
  }
 ...
 return 
# 42 "project/radare2/libr/util/pkcs7.c" 3 4
       1
# 42 "project/radare2/libr/util/pkcs7.c"
           ;
}

static void r_pkcs7_free_certificaterevocationlists(RPKCS7CertificateRevocationLists *crls) {
 
# 46 "project/radare2/libr/util/pkcs7.c" 3 4
unsigned int 
# 46 "project/radare2/libr/util/pkcs7.c"
     i;
 if (crls) {
  for (i = 0; i < crls->length; i++) {
   r_x509_free_crl (crls->elements[i]);
   crls->elements[i] = 
# 50 "project/radare2/libr/util/pkcs7.c" 3 4
                      ((void *)0)
# 50 "project/radare2/libr/util/pkcs7.c"
                          ;
  }
  
# 52 "project/radare2/libr/util/pkcs7.c" 3 4
 { free((void *)
# 52 "project/radare2/libr/util/pkcs7.c"
 crls->elements
# 52 "project/radare2/libr/util/pkcs7.c" 3 4
 ); 
# 52 "project/radare2/libr/util/pkcs7.c"
...
static 
# 57 "project/radare2/libr/util/pkcs7.c" 3 4
      _Bool 
# 57 "project/radare2/libr/util/pkcs7.c"
           r_pkcs7_parse_extendedcertificatesandcertificates(RPKCS7ExtendedCertificatesAndCertificates *ecac, RASN1Object *object) {
 
# 58 "project/radare2/libr/util/pkcs7.c" 3 4
unsigned int 
# 58 "project/radare2/libr/util/pkcs7.c"
     i;
 if (!ecac || !object) {
  return 
# 60 "project/radare2/libr/util/pkcs7.c" 3 4
        0
# 60 "project/radare2/libr/util/pkcs7.c"
             ;
 }
 if (object->list.length > 0) {
  ...
  if (!ecac->elements) {
   return 
# 65 "project/radare2/libr/util/pkcs7.c" 3 4
         0
# 65 "project/radare2/libr/util/pkcs7.c"
              ;
  }
  ecac->length = object->list.length;
  for (i = 0; i < ecac->length; i++) {
   ecac->elements[i] = r_x509_parse_certificate (object->list.objects[i]);
   object->list.objects[i] = 
# 70 "project/radare2/libr/util/pkcs7.c" 3 4
                            ((void *)0)
# 70 "project/radare2/libr/util/pkcs7.c"
                                ;
  }
 }
 return 
# 73 "project/radare2/libr/util/pkcs7.c" 3 4
       1
# 73 "project/radare2/libr/util/pkcs7.c"
           ;
}

static void r_pkcs7_free_extendedcertificatesandcertificates(RPKCS7ExtendedCertificatesAndCertificates *ecac) {
 
# 77 "project/radare2/libr/util/pkcs7.c" 3 4
unsigned int 
# 77 "project/radare2/libr/util/pkcs7.c"
     i;
 if (ecac) {
  for (i = 0; i < ecac->length; i++) {
   r_x509_free_certificate (ecac->elements[i]);
   ecac->elements[i] = 
# 81 "project/radare2/libr/util/pkcs7.c" 3 4
                      ((void *)0)
# 81 "project/radare2/libr/util/pkcs7.c"
                          ;
  }
  
# 83 "project/radare2/libr/util/pkcs7.c" 3 4
 { free((void *)
# 83 "project/radare2/libr/util/pkcs7.c"
 ecac->elements
# 83 "project/radare2/libr/util/pkcs7.c" 3 4
 ); 
# 83 "project/radare2/libr/util/pkcs7.c"
...
static 
# 88 "project/radare2/libr/util/pkcs7.c" 3 4
      _Bool 
# 88 "project/radare2/libr/util/pkcs7.c"
           r_pkcs7_parse_digestalgorithmidentifier(RPKCS7DigestAlgorithmIdentifiers *dai, RASN1Object *object) {
 
# 89 "project/radare2/libr/util/pkcs7.c" 3 4
unsigned int 
# 89 "project/radare2/libr/util/pkcs7.c"
     i;
 if (!dai || !object) {
  return 
# 91 "project/radare2/libr/util/pkcs7.c" 3 4
        0
# 91 "project/radare2/libr/util/pkcs7.c"
             ;
 }
 if (object->list.length > 0) {
  ...
  if (!dai->elements) {
   return 
# 96 "project/radare2/libr/util/pkcs7.c" 3 4
         0
# 96 "project/radare2/libr/util/pkcs7.c"
              ;
  }
...
# 107 "project/radare2/libr/util/pkcs7.c" 3 4
   __builtin___memset_chk (
# 107 "project/radare2/libr/util/pkcs7.c"
   dai->elements[i]
# 107 "project/radare2/libr/util/pkcs7.c" 3 4
   , 
# 107 "project/radare2/libr/util/pkcs7.c"
   0, sizeof (RX509AlgorithmIdentifier)
# 107 "project/radare2/libr/util/pkcs7.c" 3 4
...
# 107 "project/radare2/libr/util/pkcs7.c"
 ...
 return 
# 112 "project/radare2/libr/util/pkcs7.c" 3 4
       1
# 112 "project/radare2/libr/util/pkcs7.c"
           ;
}

static void r_pkcs7_free_digestalgorithmidentifier(RPKCS7DigestAlgorithmIdentifiers *dai) {
 
# 116 "project/radare2/libr/util/pkcs7.c" 3 4
unsigned int 
# 116 "project/radare2/libr/util/pkcs7.c"
     i;
 if (dai) {
  for (i = 0; i < dai->length; i++) {
   if (dai->elements[i]) {
...
# 123 "project/radare2/libr/util/pkcs7.c" 3 4
   { free((void *)
# 123 "project/radare2/libr/util/pkcs7.c"
   dai->elements[i]
# 123 "project/radare2/libr/util/pkcs7.c" 3 4
   ); 
# 123 "project/radare2/libr/util/pkcs7.c"
...
# 126 "project/radare2/libr/util/pkcs7.c" 3 4
 { free((void *)
# 126 "project/radare2/libr/util/pkcs7.c"
 dai->elements
# 126 "project/radare2/libr/util/pkcs7.c" 3 4
 ); 
# 126 "project/radare2/libr/util/pkcs7.c"
...
static 
# 139 "project/radare2/libr/util/pkcs7.c" 3 4
      _Bool 
# 139 "project/radare2/libr/util/pkcs7.c"
           r_pkcs7_parse_issuerandserialnumber(RPKCS7IssuerAndSerialNumber *iasu, RASN1Object *object) {
 if (!iasu || !object || object->list.length < 2) {
  return 
# 141 "project/radare2/libr/util/pkcs7.c" 3 4
        0
# 141 "project/radare2/libr/util/pkcs7.c"
             ;
 }
 ...
 return 
# 148 "project/radare2/libr/util/pkcs7.c" 3 4
       1
# 148 "project/radare2/libr/util/pkcs7.c"
           ;
}
...
# 166 "project/radare2/libr/util/pkcs7.c"
static 
# 166 "project/radare2/libr/util/pkcs7.c" 3 4
      _Bool 
# 166 "project/radare2/libr/util/pkcs7.c"
           r_pkcs7_parse_signerinfo(RPKCS7SignerInfo *si, RASN1Object *object) {
 RASN1Object **elems;
 
# 168 "project/radare2/libr/util/pkcs7.c" 3 4
unsigned int 
# 168 "project/radare2/libr/util/pkcs7.c"
     shift = 3;
 if (!si || !object || object->list.length < 5) {
  return 
# 170 "project/radare2/libr/util/pkcs7.c" 3 4
        0
# 170 "project/radare2/libr/util/pkcs7.c"
             ;
 }
 elems = object->list.objects;

 si->version = (
# 174 "project/radare2/libr/util/pkcs7.c" 3 4
               unsigned int
# 174 "project/radare2/libr/util/pkcs7.c"
                   )elems[0]->sector[0];
 ...
 if (shift < object->list.length && elems[shift]->klass == 
# 177 "project/radare2/libr/util/pkcs7.c" 3 4
                                                          0x80 
# 177 "project/radare2/libr/util/pkcs7.c"
                                                                        && elems[shift]->tag == 0) {
 ...
 if (shift < object->list.length) {
  ...
  if (elem && elem->klass == 
# 194 "project/radare2/libr/util/pkcs7.c" 3 4
                            0x80 
# 194 "project/radare2/libr/util/pkcs7.c"
                                          && elem->tag == 1) {
   r_pkcs7_parse_attributes (&si->unauthenticatedAttributes, elems[shift]);
  }
 }
 return 
# 198 "project/radare2/libr/util/pkcs7.c" 3 4
       1
# 198 "project/radare2/libr/util/pkcs7.c"
           ;
}
...
# 210 "project/radare2/libr/util/pkcs7.c" 3 4
unsigned int 
# 210 "project/radare2/libr/util/pkcs7.c"
     i;
 if (attributes) {
...
# 215 "project/radare2/libr/util/pkcs7.c" 3 4
 { free((void *)
# 215 "project/radare2/libr/util/pkcs7.c"
 attributes->elements
# 215 "project/radare2/libr/util/pkcs7.c" 3 4
 ); 
# 215 "project/radare2/libr/util/pkcs7.c"
...
static 
# 232 "project/radare2/libr/util/pkcs7.c" 3 4
      _Bool 
# 232 "project/radare2/libr/util/pkcs7.c"
           r_pkcs7_parse_signerinfos(RPKCS7SignerInfos *ss, RASN1Object *object) {
 
# 233 "project/radare2/libr/util/pkcs7.c" 3 4
unsigned int 
# 233 "project/radare2/libr/util/pkcs7.c"
     i;
 if (!ss || !object) {
  return 
# 235 "project/radare2/libr/util/pkcs7.c" 3 4
        0
# 235 "project/radare2/libr/util/pkcs7.c"
             ;
 }
 if (object->list.length > 0) {
  ...
  if (!ss->elements) {
   return 
# 240 "project/radare2/libr/util/pkcs7.c" 3 4
         0
# 240 "project/radare2/libr/util/pkcs7.c"
              ;
  }
  ...
  for (i = 0; i < ss->length; i++) {
   ...
   ss->elements[i] = 
# 246 "project/radare2/libr/util/pkcs7.c" 3 4
                    (
# 246 "project/radare2/libr/util/pkcs7.c"
                    RPKCS7SignerInfo
# 246 "project/radare2/libr/util/pkcs7.c" 3 4
                    *)calloc(1,sizeof(
# 246 "project/radare2/libr/util/pkcs7.c"
...
# 246 "project/radare2/libr/util/pkcs7.c"
 ...
 return 
# 252 "project/radare2/libr/util/pkcs7.c" 3 4
       1
# 252 "project/radare2/libr/util/pkcs7.c"
           ;
}

static void r_pkcs7_free_signerinfos(RPKCS7SignerInfos *ss) {
 
# 256 "project/radare2/libr/util/pkcs7.c" 3 4
unsigned int 
# 256 "project/radare2/libr/util/pkcs7.c"
     i;
 if (ss) {
  for (i = 0; i < ss->length; i++) {
   r_pkcs7_free_signerinfo (ss->elements[i]);
   ss->elements[i] = 
# 260 "project/radare2/libr/util/pkcs7.c" 3 4
                    ((void *)0)
# 260 "project/radare2/libr/util/pkcs7.c"
                        ;
  }
  
# 262 "project/radare2/libr/util/pkcs7.c" 3 4
 { free((void *)
# 262 "project/radare2/libr/util/pkcs7.c"
 ss->elements
# 262 "project/radare2/libr/util/pkcs7.c" 3 4
 ); 
# 262 "project/radare2/libr/util/pkcs7.c"
...
static 
# 267 "project/radare2/libr/util/pkcs7.c" 3 4
      _Bool 
# 267 "project/radare2/libr/util/pkcs7.c"
           r_pkcs7_parse_signeddata(RPKCS7SignedData *sd, RASN1Object *object) {
 
# 268 "project/radare2/libr/util/pkcs7.c" 3 4
unsigned int 
# 268 "project/radare2/libr/util/pkcs7.c"
     shift = 3;
 if (!sd || !object || object->list.length < 4) {
  return 
# 270 "project/radare2/libr/util/pkcs7.c" 3 4
        0
# 270 "project/radare2/libr/util/pkcs7.c"
             ;
 }
 
# 272 "project/radare2/libr/util/pkcs7.c" 3 4
__builtin___memset_chk (
# 272 "project/radare2/libr/util/pkcs7.c"
sd
# 272 "project/radare2/libr/util/pkcs7.c" 3 4
, 
# 272 "project/radare2/libr/util/pkcs7.c"
0, sizeof (RPKCS7SignedData)
# 272 "project/radare2/libr/util/pkcs7.c" 3 4
, __builtin_object_size (
# 272 "project/radare2/libr/util/pkcs7.c"
sd
...
# 272 "project/radare2/libr/util/pkcs7.c"
 ...
 sd->version = (
# 275 "project/radare2/libr/util/pkcs7.c" 3 4
               unsigned int
# 275 "project/radare2/libr/util/pkcs7.c"
                   )elems[0]->sector[0];
 ...
 if (object->list.length > 3 && shift < object->list.length && elems[shift] &&
  elems[shift]->klass == 
# 280 "project/radare2/libr/util/pkcs7.c" 3 4
                        0x80 
# 280 "project/radare2/libr/util/pkcs7.c"
                                      && elems[shift]->tag == 0) {
 ...
 if (object->list.length > 3 && shift < object->list.length && elems[shift] &&
  elems[shift]->klass == 
# 286 "project/radare2/libr/util/pkcs7.c" 3 4
                        0x80 
# 286 "project/radare2/libr/util/pkcs7.c"
                                      && elems[shift]->tag == 1) {
 ...
 return 
# 293 "project/radare2/libr/util/pkcs7.c" 3 4
       1
# 293 "project/radare2/libr/util/pkcs7.c"
           ;
}
...
# 307 "project/radare2/libr/util/pkcs7.c" 3 4
__attribute__((visibility("default"))) 
# 307 "project/radare2/libr/util/pkcs7.c"
     RCMS *r_pkcs7_parse_cms(const 
# 307 "project/radare2/libr/util/pkcs7.c" 3 4
                                   unsigned char 
# 307 "project/radare2/libr/util/pkcs7.c"
                                       *buffer, 
...
# 307 "project/radare2/libr/util/pkcs7.c"
 ...
 if (!buffer || !length) {
  return 
# 311 "project/radare2/libr/util/pkcs7.c" 3 4
        ((void *)0)
# 311 "project/radare2/libr/util/pkcs7.c"
            ;
 }
 container = 
# 313 "project/radare2/libr/util/pkcs7.c" 3 4
            (
# 313 "project/radare2/libr/util/pkcs7.c"
            RCMS
# 313 "project/radare2/libr/util/pkcs7.c" 3 4
            *)calloc(1,sizeof(
# 313 "project/radare2/libr/util/pkcs7.c"
...
# 313 "project/radare2/libr/util/pkcs7.c"
 ...
 if (!container) {
  return 
# 315 "project/radare2/libr/util/pkcs7.c" 3 4
        ((void *)0)
# 315 "project/radare2/libr/util/pkcs7.c"
            ;
 }
 ...
 if (!object || object->list.length < 2 || !object->list.objects ||
  ...
  free (container);
  return 
# 323 "project/radare2/libr/util/pkcs7.c" 3 4
        ((void *)0)
# 323 "project/radare2/libr/util/pkcs7.c"
            ;
 }
 if (object->list.objects[0]) {
  ...
  if (!container->contentType) {
   ...
   free (container);
   return 
# 330 "project/radare2/libr/util/pkcs7.c" 3 4
         ((void *)0)
# 330 "project/radare2/libr/util/pkcs7.c"
             ;
  }
 }
...
# 340 "project/radare2/libr/util/pkcs7.c" 3 4
__attribute__((visibility("default"))) 
# 340 "project/radare2/libr/util/pkcs7.c"
...
static RPKCS7Attribute *r_pkcs7_parse_attribute(RASN1Object *object) {
 ...
 if (!object || object->list.length < 1) {
  return 
# 351 "project/radare2/libr/util/pkcs7.c" 3 4
        ((void *)0)
# 351 "project/radare2/libr/util/pkcs7.c"
            ;
 }
 attribute = 
# 353 "project/radare2/libr/util/pkcs7.c" 3 4
            (
# 353 "project/radare2/libr/util/pkcs7.c"
            RPKCS7Attribute
# 353 "project/radare2/libr/util/pkcs7.c" 3 4
            *)calloc(1,sizeof(
# 353 "project/radare2/libr/util/pkcs7.c"
...
# 353 "project/radare2/libr/util/pkcs7.c"
 ...
 if (!attribute) {
  return 
# 355 "project/radare2/libr/util/pkcs7.c" 3 4
        ((void *)0)
# 355 "project/radare2/libr/util/pkcs7.c"
            ;
 }
 if (object->list.objects[0]) {
...
static 
# 369 "project/radare2/libr/util/pkcs7.c" 3 4
      _Bool 
# 369 "project/radare2/libr/util/pkcs7.c"
           r_pkcs7_parse_attributes(RPKCS7Attributes *attributes, RASN1Object *object) {
 
# 370 "project/radare2/libr/util/pkcs7.c" 3 4
unsigned int 
# 370 "project/radare2/libr/util/pkcs7.c"
     i;
 if (!attributes || !object || !object->list.length) {
  return 
# 372 "project/radare2/libr/util/pkcs7.c" 3 4
        0
# 372 "project/radare2/libr/util/pkcs7.c"
             ;
 }
 ...
 if (attributes->length > 0) {
  attributes->elements = 
# 377 "project/radare2/libr/util/pkcs7.c" 3 4
                        (
# 377 "project/radare2/libr/util/pkcs7.c"
                        RPKCS7Attribute *
# 377 "project/radare2/libr/util/pkcs7.c" 3 4
                        *)calloc(
# 377 "project/radare2/libr/util/pkcs7.c"
...
# 377 "project/radare2/libr/util/pkcs7.c"
  ...
  if (!attributes->elements) {
   attributes->length = 0;
   return 
# 380 "project/radare2/libr/util/pkcs7.c" 3 4
         0
# 380 "project/radare2/libr/util/pkcs7.c"
              ;
  }
 ...
 return 
# 386 "project/radare2/libr/util/pkcs7.c" 3 4
       1
# 386 "project/radare2/libr/util/pkcs7.c"
           ;
}
# 420 "project/radare2/libr/util/pkcs7.c"
static void r_x509_signedinfo_dump(RPKCS7SignerInfo *si, const char *pad, RStrBuf *sb) {
 RASN1String *s = 
# 421 "project/radare2/libr/util/pkcs7.c" 3 4
                 ((void *)0)
# 421 "project/radare2/libr/util/pkcs7.c"
                     ;
 RASN1Binary *o = 
# 422 "project/radare2/libr/util/pkcs7.c" 3 4
                 ((void *)0)
# 422 "project/radare2/libr/util/pkcs7.c"
                     ;
 
# 423 "project/radare2/libr/util/pkcs7.c" 3 4
unsigned int 
# 423 "project/radare2/libr/util/pkcs7.c"
     i;
 char *pad2, *pad3;
 if (!si) {
  return;
...
# 472 "project/radare2/libr/util/pkcs7.c" 3 4
 fprintf(__stderrp,
# 472 "project/radare2/libr/util/pkcs7.c"
 "%s%s: %u bytes\n", pad3, attr->oid ? attr->oid->string : "Missing", o ? o->length : 0
# 472 "project/radare2/libr/util/pkcs7.c" 3 4
 )
                     
# 473 "project/radare2/libr/util/pkcs7.c"
                    ;
 }
 free (pad3);
}
...
# 478 "project/radare2/libr/util/pkcs7.c" 3 4
__attribute__((visibility("default"))) 
# 478 "project/radare2/libr/util/pkcs7.c"
     char *r_pkcs7_cms_to_string(RCMS *container) {
 
# 479 "project/radare2/libr/util/pkcs7.c" 3 4
unsigned int 
# 479 "project/radare2/libr/util/pkcs7.c"
     i;
 if (!container) {
  return 
# 481 "project/radare2/libr/util/pkcs7.c" 3 4
        ((void *)0)
# 481 "project/radare2/libr/util/pkcs7.c"
            ;
 }
...
# 519 "project/radare2/libr/util/pkcs7.c" 3 4
__attribute__((visibility("default"))) 
# 519 "project/radare2/libr/util/pkcs7.c"
     void r_x509_signedinfo_json(PJ *pj, RPKCS7SignerInfo *si) {
 
# 520 "project/radare2/libr/util/pkcs7.c" 3 4
unsigned int 
# 520 "project/radare2/libr/util/pkcs7.c"
     i;
 if (si) {
  pj_o (pj);
...
# 591 "project/radare2/libr/util/pkcs7.c" 3 4
__attribute__((visibility("default"))) 
# 591 "project/radare2/libr/util/pkcs7.c"
     PJ *r_pkcs7_cms_json (RCMS *container) {
 PJ *pj = 
# 592 "project/radare2/libr/util/pkcs7.c" 3 4
         ((void *)0)
# 592 "project/radare2/libr/util/pkcs7.c"
             ;
 if (container) {
  
# 594 "project/radare2/libr/util/pkcs7.c" 3 4
 unsigned int 
# 594 "project/radare2/libr/util/pkcs7.c"
      i;
...
static 
# 642 "project/radare2/libr/util/pkcs7.c" 3 4
      _Bool 
# 642 "project/radare2/libr/util/pkcs7.c"
           r_pkcs7_parse_spcdata(SpcAttributeTypeAndOptionalValue *data, RASN1Object *object) {
 if (!data || !object || object->list.length < 1 ||
  !object->list.objects[0]) {
  return 
# 645 "project/radare2/libr/util/pkcs7.c" 3 4
        0
# 645 "project/radare2/libr/util/pkcs7.c"
             ;
 }
 data->type = r_asn1_stringify_oid (object->list.objects[0]->sector, object->list.objects[0]->length);
 if (!data->type) {
  return 
# 649 "project/radare2/libr/util/pkcs7.c" 3 4
        0
# 649 "project/radare2/libr/util/pkcs7.c"
             ;
 }
 RASN1Object *obj1 = object->list.objects[1];
 if (object->list.length > 1) {
 ...
 return 
# 657 "project/radare2/libr/util/pkcs7.c" 3 4
       1
# 657 "project/radare2/libr/util/pkcs7.c"
           ;
}

static 
# 660 "project/radare2/libr/util/pkcs7.c" 3 4
      _Bool 
# 660 "project/radare2/libr/util/pkcs7.c"
           r_pkcs7_parse_spcmessagedigest(SpcDigestInfo *messageDigest, RASN1Object *object) {
 if (!messageDigest || !object || object->list.length < 2 ||
  !object->list.objects[0] || !object->list.objects[1]) {
  return 
# 663 "project/radare2/libr/util/pkcs7.c" 3 4
        0
# 663 "project/radare2/libr/util/pkcs7.c"
             ;
 }
 if (!r_x509_parse_algorithmidentifier (&messageDigest->digestAlgorithm, object->list.objects[0])) {
  return 
# 666 "project/radare2/libr/util/pkcs7.c" 3 4
        0
# 666 "project/radare2/libr/util/pkcs7.c"
             ;
 }
 RASN1Object *obj1 = object->list.objects[1];
 messageDigest->digest = r_asn1_create_binary (obj1->sector, obj1->length);
 return 
# 670 "project/radare2/libr/util/pkcs7.c" 3 4
       1
# 670 "project/radare2/libr/util/pkcs7.c"
           ;
}


# 673 "project/radare2/libr/util/pkcs7.c" 3 4
__attribute__((visibility("default"))) 
# 673 "project/radare2/libr/util/pkcs7.c"
     SpcIndirectDataContent *r_pkcs7_parse_spcinfo(RCMS *cms) {
 
# 674 "project/radare2/libr/util/pkcs7.c" 3 4
do { if (!(
# 674 "project/radare2/libr/util/pkcs7.c"
cms
# 674 "project/radare2/libr/util/pkcs7.c" 3 4
...
# 674 "project/radare2/libr/util/pkcs7.c"
 ...
 if (type && strcmp (type->string, "spcIndirectDataContext")) {
  return 
# 678 "project/radare2/libr/util/pkcs7.c" 3 4
        ((void *)0)
# 678 "project/radare2/libr/util/pkcs7.c"
            ;
 }

 SpcIndirectDataContent *spcinfo = 
# 681 "project/radare2/libr/util/pkcs7.c" 3 4
                                  (
# 681 "project/radare2/libr/util/pkcs7.c"
                                  SpcIndirectDataContent
# 681 "project/radare2/libr/util/pkcs7.c" 3 4
                                  *)calloc(1,sizeof(
# 681 "project/radare2/libr/util/pkcs7.c"
...
# 681 "project/radare2/libr/util/pkcs7.c"
 ...
 if (!spcinfo) {
  return 
# 683 "project/radare2/libr/util/pkcs7.c" 3 4
        ((void *)0)
# 683 "project/radare2/libr/util/pkcs7.c"
            ;
 }
 ...
 if (!content) {
  free (spcinfo);
  return 
# 689 "project/radare2/libr/util/pkcs7.c" 3 4
        ((void *)0)
# 689 "project/radare2/libr/util/pkcs7.c"
            ;
 }
...
# 694 "project/radare2/libr/util/pkcs7.c" 3 4
 { free((void *)
# 694 "project/radare2/libr/util/pkcs7.c"
 spcinfo
# 694 "project/radare2/libr/util/pkcs7.c" 3 4
 ); 
# 694 "project/radare2/libr/util/pkcs7.c"
...
# 699 "project/radare2/libr/util/pkcs7.c" 3 4
  { free((void *)
# 699 "project/radare2/libr/util/pkcs7.c"
  spcinfo
# 699 "project/radare2/libr/util/pkcs7.c" 3 4
  ); 
# 699 "project/radare2/libr/util/pkcs7.c"
...
# 705 "project/radare2/libr/util/pkcs7.c" 3 4
  { free((void *)
# 705 "project/radare2/libr/util/pkcs7.c"
  spcinfo
# 705 "project/radare2/libr/util/pkcs7.c" 3 4
  ); 
# 705 "project/radare2/libr/util/pkcs7.c"
...
# 728 "project/radare2/libr/util/pkcs7.c" 3 4
__attribute__((visibility("default"))) 
# 728 "project/radare2/libr/util/pkcs7.c"
     void r_pkcs7_free_spcinfo(SpcIndirectDataContent *spcinfo) {
 if (spcinfo) {
