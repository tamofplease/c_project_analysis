# 0 "project/radare2/libr/util/range.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/range.c"
...
# 4 "project/radare2/libr/util/range.c" 2
...
# 11 "project/radare2/libr/util/range.c"
     RRange *r_range_new(void) {
 RRange *r = 
# 12 "project/radare2/libr/util/range.c" 3 4
            (
# 12 "project/radare2/libr/util/range.c"
            RRange
# 12 "project/radare2/libr/util/range.c" 3 4
            *)calloc(1,sizeof(
# 12 "project/radare2/libr/util/range.c"
...
# 12 "project/radare2/libr/util/range.c"
 ...
 if (r) {
  ...
  if (!r->ranges) {
   r_range_free (r);
   return 
# 18 "project/radare2/libr/util/range.c" 3 4
         ((void *)0)
# 18 "project/radare2/libr/util/range.c"
             ;
  }
  r->ranges->free = free;
 }
...
# 25 "project/radare2/libr/util/range.c" 3 4
__attribute__((visibility("default"))) 
# 25 "project/radare2/libr/util/range.c"
     RRange *r_range_free(RRange *r) {
 r_list_purge (r->ranges);
 free (r);
 return 
# 28 "project/radare2/libr/util/range.c" 3 4
       ((void *)0)
# 28 "project/radare2/libr/util/range.c"
           ;
}



# 32 "project/radare2/libr/util/range.c" 3 4
__attribute__((visibility("default"))) 
# 32 "project/radare2/libr/util/range.c"
     int r_range_get_data(RRange *rgs, 
# 32 "project/radare2/libr/util/range.c" 3 4
                                       unsigned long long 
# 32 "project/radare2/libr/util/range.c"
                                            addr, 
...
# 40 "project/radare2/libr/util/range.c" 3 4
__builtin___memcpy_chk (
# 40 "project/radare2/libr/util/range.c"
buf
# 40 "project/radare2/libr/util/range.c" 3 4
, 
# 40 "project/radare2/libr/util/range.c"
...
# 44 "project/radare2/libr/util/range.c" 3 4
__attribute__((visibility("default"))) 
# 44 "project/radare2/libr/util/range.c"
     int r_range_set_data(RRange *rgs, 
# 44 "project/radare2/libr/util/range.c" 3 4
                                       unsigned long long 
# 44 "project/radare2/libr/util/range.c"
                                            addr, const 
...
# 44 "project/radare2/libr/util/range.c"
 ...
 r->data = (
# 49 "project/radare2/libr/util/range.c" 3 4
           unsigned char
# 49 "project/radare2/libr/util/range.c"
              *)malloc (len);
 if (!r->data) {
  return 0;
 }
...
# 54 "project/radare2/libr/util/range.c" 3 4
__builtin___memcpy_chk (
# 54 "project/radare2/libr/util/range.c"
r->data
# 54 "project/radare2/libr/util/range.c" 3 4
, 
# 54 "project/radare2/libr/util/range.c"
...
RRangeItem *r_range_item_get(RRange *rgs, 
# 58 "project/radare2/libr/util/range.c" 3 4
                                         unsigned long long 
# 58 "project/radare2/libr/util/range.c"
                                              addr) {
 RRangeItem *r;
 RListIter *iter;
 
# 61 "project/radare2/libr/util/range.c" 3 4
if (
# 61 "project/radare2/libr/util/range.c"
rgs->ranges
# 61 "project/radare2/libr/util/range.c" 3 4
) for (
# 61 "project/radare2/libr/util/range.c"
...
# 61 "project/radare2/libr/util/range.c"
 ...
 return 
# 66 "project/radare2/libr/util/range.c" 3 4
       ((void *)0)
# 66 "project/radare2/libr/util/range.c"
           ;
}
...
# 71 "project/radare2/libr/util/range.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 71 "project/radare2/libr/util/range.c"
          r_range_size(RRange *rgs) {
 
# 72 "project/radare2/libr/util/range.c" 3 4
unsigned long long 
# 72 "project/radare2/libr/util/range.c"
     sum = 0;
 RListIter *iter;
 RRangeItem *r;
 
# 75 "project/radare2/libr/util/range.c" 3 4
if (
# 75 "project/radare2/libr/util/range.c"
rgs->ranges
# 75 "project/radare2/libr/util/range.c" 3 4
) for (
# 75 "project/radare2/libr/util/range.c"
...
# 81 "project/radare2/libr/util/range.c" 3 4
__attribute__((visibility("default"))) 
# 81 "project/radare2/libr/util/range.c"
     RRange *r_range_new_from_string(const char *string) {
...
# 87 "project/radare2/libr/util/range.c" 3 4
__attribute__((visibility("default"))) 
# 87 "project/radare2/libr/util/range.c"
     int r_range_add_from_string(RRange *rgs, const char *string) {
 
# 88 "project/radare2/libr/util/range.c" 3 4
unsigned long long 
# 88 "project/radare2/libr/util/range.c"
     addr, addr2;
 ...
 char *p = str = ostr;
 char *p2 = 
# 95 "project/radare2/libr/util/range.c" 3 4
           ((void *)0)
# 95 "project/radare2/libr/util/range.c"
               ;

 
# 97 "project/radare2/libr/util/range.c" 3 4
__builtin___memcpy_chk (
# 97 "project/radare2/libr/util/range.c"
str
# 97 "project/radare2/libr/util/range.c" 3 4
, 
# 97 "project/radare2/libr/util/range.c"
...
# 97 "project/radare2/libr/util/range.c"
 ...
 for (i = 0; i < len; i++) {
  ...
  case ',':
   ...
   if (p2) {
    addr = r_num_get (
# 108 "project/radare2/libr/util/range.c" 3 4
                     ((void *)0)
# 108 "project/radare2/libr/util/range.c"
                         , p);
    addr2 = r_num_get (
# 109 "project/radare2/libr/util/range.c" 3 4
                      ((void *)0)
# 109 "project/radare2/libr/util/range.c"
                          , p2);
    r_range_add(rgs, addr, addr2, 1);
    p2 = 
# 111 "project/radare2/libr/util/range.c" 3 4
        ((void *)0)
# 111 "project/radare2/libr/util/range.c"
            ;
   } else {
    addr = r_num_get (
# 113 "project/radare2/libr/util/range.c" 3 4
                     ((void *)0)
# 113 "project/radare2/libr/util/range.c"
                         , p);
 ...
 if (p2) {
  addr = r_num_get (
# 122 "project/radare2/libr/util/range.c" 3 4
                   ((void *)0)
# 122 "project/radare2/libr/util/range.c"
                       , p);
  addr2 = r_num_get (
# 123 "project/radare2/libr/util/range.c" 3 4
                    ((void *)0)
# 123 "project/radare2/libr/util/range.c"
                        , p2);
  r_range_add (rgs, addr, addr2, 1);
 } else
 if (p) {
  addr = r_num_get (
# 127 "project/radare2/libr/util/range.c" 3 4
                   ((void *)0)
# 127 "project/radare2/libr/util/range.c"
                       , p);
  r_range_add (rgs, addr, addr + 1, 1);
 }
 free (ostr);
...
# 143 "project/radare2/libr/util/range.c"
RRangeItem *r_range_add(RRange *rgs, 
# 143 "project/radare2/libr/util/range.c" 3 4
                                    unsigned long long 
# 143 "project/radare2/libr/util/range.c"
                                         fr, 
# 143 "project/radare2/libr/util/range.c" 3 4
...
# 143 "project/radare2/libr/util/range.c"
 ...
 RListIter *iter;
 RRangeItem *r, *ret = 
# 145 "project/radare2/libr/util/range.c" 3 4
                      ((void *)0)
# 145 "project/radare2/libr/util/range.c"
                          ;
 int add = 1;

 r_num_minmax_swap (&fr, &to);
 
# 149 "project/radare2/libr/util/range.c" 3 4
if (
# 149 "project/radare2/libr/util/range.c"
rgs->ranges
# 149 "project/radare2/libr/util/range.c" 3 4
) for (
# 149 "project/radare2/libr/util/range.c"
...
# 149 "project/radare2/libr/util/range.c"
 ...
 if (rw && add) {
  ret = 
# 172 "project/radare2/libr/util/range.c" 3 4
       (
# 172 "project/radare2/libr/util/range.c"
       RRangeItem
# 172 "project/radare2/libr/util/range.c" 3 4
       *)malloc(sizeof(
# 172 "project/radare2/libr/util/range.c"
...
# 172 "project/radare2/libr/util/range.c"
  ...
  ret->datalen = 0;
  ret->data = 
# 176 "project/radare2/libr/util/range.c" 3 4
             ((void *)0)
# 176 "project/radare2/libr/util/range.c"
                 ;
...
# 193 "project/radare2/libr/util/range.c"

# 193 "project/radare2/libr/util/range.c" 3 4
__attribute__((visibility("default"))) 
# 193 "project/radare2/libr/util/range.c"
     int r_range_sub(RRange *rgs, 
# 193 "project/radare2/libr/util/range.c" 3 4
                                  unsigned long long 
# 193 "project/radare2/libr/util/range.c"
                                       fr, 
...
# 200 "project/radare2/libr/util/range.c" 3 4
if (
# 200 "project/radare2/libr/util/range.c"
rgs->ranges
# 200 "project/radare2/libr/util/range.c" 3 4
) for (
# 200 "project/radare2/libr/util/range.c"
...
# 237 "project/radare2/libr/util/range.c"

# 237 "project/radare2/libr/util/range.c" 3 4
__attribute__((visibility("default"))) 
# 237 "project/radare2/libr/util/range.c"
     int r_range_contains(RRange *rgs, 
# 237 "project/radare2/libr/util/range.c" 3 4
                                       unsigned long long 
# 237 "project/radare2/libr/util/range.c"
                                            addr) {
...
# 240 "project/radare2/libr/util/range.c" 3 4
if (
# 240 "project/radare2/libr/util/range.c"
rgs->ranges
# 240 "project/radare2/libr/util/range.c" 3 4
) for (
# 240 "project/radare2/libr/util/range.c"
...
# 240 "project/radare2/libr/util/range.c"
  ...
  if (addr >= r->fr && addr <= r->to) {
   return 
# 242 "project/radare2/libr/util/range.c" 3 4
         1
# 242 "project/radare2/libr/util/range.c"
             ;
  }
 }
 return 
# 245 "project/radare2/libr/util/range.c" 3 4
       0
# 245 "project/radare2/libr/util/range.c"
            ;
}
...
# 254 "project/radare2/libr/util/range.c" 3 4
__attribute__((visibility("default"))) 
# 254 "project/radare2/libr/util/range.c"
     int r_range_sort(RRange *rgs) {
 
# 255 "project/radare2/libr/util/range.c" 3 4
_Bool 
# 255 "project/radare2/libr/util/range.c"
     ch = rgs->ranges->sorted;
 if (!rgs->changed) {
  return 
# 257 "project/radare2/libr/util/range.c" 3 4
        0
# 257 "project/radare2/libr/util/range.c"
             ;
 }
 rgs->changed = 
# 259 "project/radare2/libr/util/range.c" 3 4
               0
# 259 "project/radare2/libr/util/range.c"
                    ;
 r_list_sort (rgs->ranges, (RListComparator)cmp_ranges);
 if (ch != rgs->ranges->sorted) {
  rgs->changed = 
# 262 "project/radare2/libr/util/range.c" 3 4
                1
# 262 "project/radare2/libr/util/range.c"
                    ;
 }
 return rgs->changed;
}
...
# 267 "project/radare2/libr/util/range.c" 3 4
__attribute__((visibility("default"))) 
# 267 "project/radare2/libr/util/range.c"
     void r_range_percent(RRange *rgs) {
 RListIter *iter;
 RRangeItem *r;
 int w, i;
 
# 271 "project/radare2/libr/util/range.c" 3 4
unsigned long long 
# 271 "project/radare2/libr/util/range.c"
     seek, step;
 
# 272 "project/radare2/libr/util/range.c" 3 4
unsigned long long 
# 272 "project/radare2/libr/util/range.c"
     dif, fr = -1, to = -1;

 
# 274 "project/radare2/libr/util/range.c" 3 4
if (
# 274 "project/radare2/libr/util/range.c"
rgs->ranges
# 274 "project/radare2/libr/util/range.c" 3 4
) for (
# 274 "project/radare2/libr/util/range.c"
...
# 274 "project/radare2/libr/util/range.c"
 ...
 printf ("0x%08"
# 301 "project/radare2/libr/util/range.c" 3 4
               "llx"
# 301 "project/radare2/libr/util/range.c"
                      " [", fr);
 for (i = 0; i < w; i++) {
 ...
 printf ("] 0x%08"
# 310 "project/radare2/libr/util/range.c" 3 4
                 "llx"
# 310 "project/radare2/libr/util/range.c"
                        "\n", to);
}
...
# 315 "project/radare2/libr/util/range.c" 3 4
unsigned long long 
# 315 "project/radare2/libr/util/range.c"
     total = 0;
 RRangeItem *r;
 RListIter *iter;
 r_range_sort (rgs);
 
# 319 "project/radare2/libr/util/range.c" 3 4
if (
# 319 "project/radare2/libr/util/range.c"
rgs->ranges
# 319 "project/radare2/libr/util/range.c" 3 4
) for (
# 319 "project/radare2/libr/util/range.c"
...
# 319 "project/radare2/libr/util/range.c"
  ...
  if (rad) {
   printf ("ar+ 0x%08"
# 321 "project/radare2/libr/util/range.c" 3 4
                     "llx"
# 321 "project/radare2/libr/util/range.c"
                            " 0x%08"
# 321 "project/radare2/libr/util/range.c" 3 4
                                    "llx"
# 321 "project/radare2/libr/util/range.c"
   ...
   printf ("0x%08"
# 323 "project/radare2/libr/util/range.c" 3 4
                 "llx"
# 323 "project/radare2/libr/util/range.c"
                        " 0x%08"
# 323 "project/radare2/libr/util/range.c" 3 4
                                "llx"
# 323 "project/radare2/libr/util/range.c"
...
# 327 "project/radare2/libr/util/range.c" 3 4
fprintf(__stderrp,
# 327 "project/radare2/libr/util/range.c"
"Total bytes: %"
# 327 "project/radare2/libr/util/range.c" 3 4
"lld"
# 327 "project/radare2/libr/util/range.c"
...
int r_range_get_n(RRange *rgs, int n, 
# 331 "project/radare2/libr/util/range.c" 3 4
                                     unsigned long long 
# 331 "project/radare2/libr/util/range.c"
                                          *fr, 
# 331 "project/radare2/libr/util/range.c" 3 4
                                               unsigned long long 
# 331 "project/radare2/libr/util/range.c"
...
# 336 "project/radare2/libr/util/range.c" 3 4
if (
# 336 "project/radare2/libr/util/range.c"
rgs->ranges
# 336 "project/radare2/libr/util/range.c" 3 4
) for (
# 336 "project/radare2/libr/util/range.c"
...
RRange *r_range_inverse(RRange *rgs, 
# 353 "project/radare2/libr/util/range.c" 3 4
                                    unsigned long long 
# 353 "project/radare2/libr/util/range.c"
                                         fr, 
# 353 "project/radare2/libr/util/range.c" 3 4
                                             unsigned long long 
# 353 "project/radare2/libr/util/range.c"
 ...
 RListIter *iter;
 RRangeItem *r = 
# 356 "project/radare2/libr/util/range.c" 3 4
                ((void *)0)
# 356 "project/radare2/libr/util/range.c"
                    ;
...
# 361 "project/radare2/libr/util/range.c" 3 4
if (
# 361 "project/radare2/libr/util/range.c"
rgs->ranges
# 361 "project/radare2/libr/util/range.c" 3 4
) for (
# 361 "project/radare2/libr/util/range.c"
...
# 384 "project/radare2/libr/util/range.c" 3 4
__attribute__((visibility("default"))) 
# 384 "project/radare2/libr/util/range.c"
     int r_range_overlap(
# 384 "project/radare2/libr/util/range.c" 3 4
                         unsigned long long 
# 384 "project/radare2/libr/util/range.c"
...
# 402 "project/radare2/libr/util/range.c"
}
