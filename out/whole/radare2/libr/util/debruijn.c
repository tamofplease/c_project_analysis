# 0 "project/radare2/libr/util/debruijn.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/util/debruijn.c" 2
...
# 11 "project/radare2/libr/util/debruijn.c"
...
static char* de_bruijn(const char* charset, int order, int maxlen) {
 if (!charset) {
  return 
# 48 "project/radare2/libr/util/debruijn.c" 3 4
        ((void *)0)
# 48 "project/radare2/libr/util/debruijn.c"
            ;
 }
 ...
 if (!prenecklace_a) {
  return 
# 53 "project/radare2/libr/util/debruijn.c" 3 4
        ((void *)0)
# 53 "project/radare2/libr/util/debruijn.c"
            ;
 }
 ...
 if (!sequence) {
  free (prenecklace_a);
  return 
# 58 "project/radare2/libr/util/debruijn.c" 3 4
        ((void *)0)
# 58 "project/radare2/libr/util/debruijn.c"
            ;
 }
...
# 69 "project/radare2/libr/util/debruijn.c" 3 4
__attribute__((visibility("default"))) 
# 69 "project/radare2/libr/util/debruijn.c"
     char* r_debruijn_pattern(int size, int start, const char* charset) {
 char *pat, *pat2;
 
# 71 "project/radare2/libr/util/debruijn.c" 3 4
unsigned long long 
# 71 "project/radare2/libr/util/debruijn.c"
     len;
 if (!charset) {
 ...
 if (start >= size) {
  return (char*)
# 76 "project/radare2/libr/util/debruijn.c" 3 4
               ((void *)0)
# 76 "project/radare2/libr/util/debruijn.c"
                   ;
 }
 pat = de_bruijn (charset, 3 , size);
 if (!pat) {
  return 
# 80 "project/radare2/libr/util/debruijn.c" 3 4
        ((void *)0)
# 80 "project/radare2/libr/util/debruijn.c"
            ;
 }
 if (start == 0) {
  len = strlen (pat);
...
# 85 "project/radare2/libr/util/debruijn.c" 3 4
  fprintf(__stderrp,
# 85 "project/radare2/libr/util/debruijn.c"
  "warning: requested pattern of length %d, " "generated length %"
# 85 "project/radare2/libr/util/debruijn.c" 3 4
  "lld"
# 85 "project/radare2/libr/util/debruijn.c"
  "\n", size, len
...
# 86 "project/radare2/libr/util/debruijn.c"
                                               ;
  }
  return pat;
 }
 ...
 if (!pat2) {
  free (pat);
  return 
# 93 "project/radare2/libr/util/debruijn.c" 3 4
        ((void *)0)
# 93 "project/radare2/libr/util/debruijn.c"
            ;
 }
 
# 95 "project/radare2/libr/util/debruijn.c" 3 4
__builtin___strncpy_chk (
# 95 "project/radare2/libr/util/debruijn.c"
pat2
# 95 "project/radare2/libr/util/debruijn.c" 3 4
, 
# 95 "project/radare2/libr/util/debruijn.c"
pat + start, size - start
# 95 "project/radare2/libr/util/debruijn.c" 3 4
...
# 100 "project/radare2/libr/util/debruijn.c" 3 4
 fprintf(__stderrp,
# 100 "project/radare2/libr/util/debruijn.c"
 "warning: requested pattern of length %d, " "generated length %"
# 100 "project/radare2/libr/util/debruijn.c" 3 4
 "lld"
# 100 "project/radare2/libr/util/debruijn.c"
...
# 102 "project/radare2/libr/util/debruijn.c"
              ;
 }
 return pat2;
}
...
# 108 "project/radare2/libr/util/debruijn.c" 3 4
__attribute__((visibility("default"))) 
# 108 "project/radare2/libr/util/debruijn.c"
     int r_debruijn_offset(
# 108 "project/radare2/libr/util/debruijn.c" 3 4
                           unsigned long long 
# 108 "project/radare2/libr/util/debruijn.c"
                                value, 
