# 0 "project/radare2/libr/util/asn1.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/asn1.c"
...
# 4 "project/radare2/libr/util/asn1.c" 2
...
# 9 "project/radare2/libr/util/asn1.c"
static int ASN1_STD_FORMAT = 1;


# 11 "project/radare2/libr/util/asn1.c" 3 4
__attribute__((visibility("default"))) 
# 11 "project/radare2/libr/util/asn1.c"
     void asn1_setformat (int fmt) {
 ASN1_STD_FORMAT = fmt;
}

static 
# 15 "project/radare2/libr/util/asn1.c" 3 4
      unsigned int 
# 15 "project/radare2/libr/util/asn1.c"
           asn1_ber_indefinite(const 
# 15 "project/radare2/libr/util/asn1.c" 3 4
                                     unsigned char 
# 15 "project/radare2/libr/util/asn1.c"
                                         *buffer, 
...
# 15 "project/radare2/libr/util/asn1.c"
 ...
 const 
# 19 "project/radare2/libr/util/asn1.c" 3 4
      unsigned char
# 19 "project/radare2/libr/util/asn1.c"
         * next = buffer + 2;
 const 
# 20 "project/radare2/libr/util/asn1.c" 3 4
      unsigned char
# 20 "project/radare2/libr/util/asn1.c"
         * end = buffer + length - 3;
 while (next + 1 < end) {
  if (!next[0] && !next[1]) {
   break;
  }
  if (next[0] == 0x80 && (next[-1] & 
# 25 "project/radare2/libr/util/asn1.c" 3 4
                                    0x20
# 25 "project/radare2/libr/util/asn1.c"
                                             ) == 
# 25 "project/radare2/libr/util/asn1.c" 3 4
                                                  0x20
# 25 "project/radare2/libr/util/asn1.c"
...
static RASN1Object *asn1_parse_header(const 
# 38 "project/radare2/libr/util/asn1.c" 3 4
                                           unsigned char 
# 38 "project/radare2/libr/util/asn1.c"
                                               *buffer, 
# 38 "project/radare2/libr/util/asn1.c" 3 4
                                                        unsigned int 
# 38 "project/radare2/libr/util/asn1.c"
...
# 39 "project/radare2/libr/util/asn1.c" 3 4
unsigned char 
# 39 "project/radare2/libr/util/asn1.c"
    head, length8, byte;
 
# 40 "project/radare2/libr/util/asn1.c" 3 4
unsigned long long 
# 40 "project/radare2/libr/util/asn1.c"
     length64;
 if (!buffer || length < 3) {
  return 
# 42 "project/radare2/libr/util/asn1.c" 3 4
        ((void *)0)
# 42 "project/radare2/libr/util/asn1.c"
            ;
 }

 RASN1Object *object = 
# 45 "project/radare2/libr/util/asn1.c" 3 4
                      (
# 45 "project/radare2/libr/util/asn1.c"
                      RASN1Object
# 45 "project/radare2/libr/util/asn1.c" 3 4
                      *)calloc(1,sizeof(
# 45 "project/radare2/libr/util/asn1.c"
...
# 45 "project/radare2/libr/util/asn1.c"
 ...
 if (!object) {
  return 
# 47 "project/radare2/libr/util/asn1.c" 3 4
        ((void *)0)
# 47 "project/radare2/libr/util/asn1.c"
            ;
 }
 head = buffer[0];
 object->offset = start_pointer ? (buffer - start_pointer) : 0;
 object->klass = head & 
# 51 "project/radare2/libr/util/asn1.c" 3 4
                       0xC0
# 51 "project/radare2/libr/util/asn1.c"
                                 ;
 object->form = head & 
# 52 "project/radare2/libr/util/asn1.c" 3 4
                      0x20
# 52 "project/radare2/libr/util/asn1.c"
                               ;
 object->tag = head & 
# 53 "project/radare2/libr/util/asn1.c" 3 4
                     0x1F
# 53 "project/radare2/libr/util/asn1.c"
                             ;
 length8 = buffer[1];
 if (length8 & 
# 55 "project/radare2/libr/util/asn1.c" 3 4
              0x80
# 55 "project/radare2/libr/util/asn1.c"
                          ) {
  length64 = 0;
  length8 &= 
# 57 "project/radare2/libr/util/asn1.c" 3 4
            0x7F
# 57 "project/radare2/libr/util/asn1.c"
                         ;
  object->sector = buffer + 2;
  if (length8 && length8 < length - 2) {
   
# 60 "project/radare2/libr/util/asn1.c" 3 4
  unsigned char 
# 60 "project/radare2/libr/util/asn1.c"
      i8;
  ...
  object->length = (
# 77 "project/radare2/libr/util/asn1.c" 3 4
                   unsigned int
# 77 "project/radare2/libr/util/asn1.c"
                       ) length64;
 } else {
  object->length = (
# 79 "project/radare2/libr/util/asn1.c" 3 4
                   unsigned int
# 79 "project/radare2/libr/util/asn1.c"
                       ) length8;
  object->sector = buffer + 2;
 }

 if (object->tag == 
# 83 "project/radare2/libr/util/asn1.c" 3 4
                   0x03 
# 83 "project/radare2/libr/util/asn1.c"
                                 && object->sector[0] == 0) {
  if (object->length > 0) {
   object->sector++;
   object->length--;
...
out_error:
 free (object);
 return 
# 96 "project/radare2/libr/util/asn1.c" 3 4
       ((void *)0)
# 96 "project/radare2/libr/util/asn1.c"
           ;
}

static 
# 99 "project/radare2/libr/util/asn1.c" 3 4
      unsigned int 
# 99 "project/radare2/libr/util/asn1.c"
           r_asn1_count_objects(const 
# 99 "project/radare2/libr/util/asn1.c" 3 4
                                      unsigned char 
# 99 "project/radare2/libr/util/asn1.c"
                                          *buffer, 
...
# 103 "project/radare2/libr/util/asn1.c" 3 4
unsigned int 
# 103 "project/radare2/libr/util/asn1.c"
     counter = 0;
 RASN1Object *object = 
# 104 "project/radare2/libr/util/asn1.c" 3 4
                      ((void *)0)
# 104 "project/radare2/libr/util/asn1.c"
                          ;
 const 
# 105 "project/radare2/libr/util/asn1.c" 3 4
      unsigned char 
# 105 "project/radare2/libr/util/asn1.c"
          *next = buffer;
 const 
# 106 "project/radare2/libr/util/asn1.c" 3 4
      unsigned char 
# 106 "project/radare2/libr/util/asn1.c"
          *end = buffer + length;
...
# 111 "project/radare2/libr/util/asn1.c" 3 4
  { free((void *)
# 111 "project/radare2/libr/util/asn1.c"
  object
# 111 "project/radare2/libr/util/asn1.c" 3 4
  ); 
# 111 "project/radare2/libr/util/asn1.c"
...
# 116 "project/radare2/libr/util/asn1.c" 3 4
 { free((void *)
# 116 "project/radare2/libr/util/asn1.c"
 object
# 116 "project/radare2/libr/util/asn1.c" 3 4
 ); 
# 116 "project/radare2/libr/util/asn1.c"
...
# 118 "project/radare2/libr/util/asn1.c" 3 4
{ free((void *)
# 118 "project/radare2/libr/util/asn1.c"
object
# 118 "project/radare2/libr/util/asn1.c" 3 4
); 
# 118 "project/radare2/libr/util/asn1.c"
...
# 122 "project/radare2/libr/util/asn1.c" 3 4
__attribute__((visibility("default"))) 
# 122 "project/radare2/libr/util/asn1.c"
     RASN1Object *r_asn1_create_object(const 
# 122 "project/radare2/libr/util/asn1.c" 3 4
                                             unsigned char 
# 122 "project/radare2/libr/util/asn1.c"
                                                 *buffer, 
...
# 122 "project/radare2/libr/util/asn1.c"
 ...
 if (object && (object->form == 
# 124 "project/radare2/libr/util/asn1.c" 3 4
                               0x20 
# 124 "project/radare2/libr/util/asn1.c"
                                                || object->tag == 
# 124 "project/radare2/libr/util/asn1.c" 3 4
                                                                  0x03 
# 124 "project/radare2/libr/util/asn1.c"
...
# 124 "project/radare2/libr/util/asn1.c"
  ...
  const 
# 125 "project/radare2/libr/util/asn1.c" 3 4
       unsigned char 
# 125 "project/radare2/libr/util/asn1.c"
           *next = object->sector;
  const 
# 126 "project/radare2/libr/util/asn1.c" 3 4
       unsigned char 
# 126 "project/radare2/libr/util/asn1.c"
           *end = next + object->length;
  if (end > buffer + length) {
   free (object);
   return 
# 129 "project/radare2/libr/util/asn1.c" 3 4
         ((void *)0)
# 129 "project/radare2/libr/util/asn1.c"
             ;
  }
  
# 131 "project/radare2/libr/util/asn1.c" 3 4
 unsigned int 
# 131 "project/radare2/libr/util/asn1.c"
      count = r_asn1_count_objects (object->sector, object->length);
  if (count > 0) {
   object->list.length = count;
   object->list.objects = 
# 134 "project/radare2/libr/util/asn1.c" 3 4
                         (
# 134 "project/radare2/libr/util/asn1.c"
                         RASN1Object*
# 134 "project/radare2/libr/util/asn1.c" 3 4
                         *)calloc(
# 134 "project/radare2/libr/util/asn1.c"
...
# 134 "project/radare2/libr/util/asn1.c"
   ...
   if (!object->list.objects) {
    ...
    return 
# 137 "project/radare2/libr/util/asn1.c" 3 4
          ((void *)0)
# 137 "project/radare2/libr/util/asn1.c"
              ;
   }
   
# 139 "project/radare2/libr/util/asn1.c" 3 4
  unsigned int 
# 139 "project/radare2/libr/util/asn1.c"
       i;
...
# 154 "project/radare2/libr/util/asn1.c" 3 4
__attribute__((visibility("default"))) 
# 154 "project/radare2/libr/util/asn1.c"
     RASN1Binary *r_asn1_create_binary (const 
# 154 "project/radare2/libr/util/asn1.c" 3 4
                                              unsigned char 
# 154 "project/radare2/libr/util/asn1.c"
                                                  *buffer, 
...
# 154 "project/radare2/libr/util/asn1.c"
 ...
 if (!buffer || !length) {
  return 
# 156 "project/radare2/libr/util/asn1.c" 3 4
        ((void *)0)
# 156 "project/radare2/libr/util/asn1.c"
            ;
 }
 
# 158 "project/radare2/libr/util/asn1.c" 3 4
unsigned char
# 158 "project/radare2/libr/util/asn1.c"
   * buf = (
# 158 "project/radare2/libr/util/asn1.c" 3 4
            unsigned char
# 158 "project/radare2/libr/util/asn1.c"
               *) calloc (sizeof (*buf), length);
 if (!buf) {
  return 
# 160 "project/radare2/libr/util/asn1.c" 3 4
        ((void *)0)
# 160 "project/radare2/libr/util/asn1.c"
            ;
 }
 RASN1Binary* bin = 
# 162 "project/radare2/libr/util/asn1.c" 3 4
                   (
# 162 "project/radare2/libr/util/asn1.c"
                   RASN1Binary
# 162 "project/radare2/libr/util/asn1.c" 3 4
                   *)calloc(1,sizeof(
# 162 "project/radare2/libr/util/asn1.c"
...
# 162 "project/radare2/libr/util/asn1.c"
 ...
 if (!bin) {
  free (buf);
  return 
# 165 "project/radare2/libr/util/asn1.c" 3 4
        ((void *)0)
# 165 "project/radare2/libr/util/asn1.c"
            ;
 }
 
# 167 "project/radare2/libr/util/asn1.c" 3 4
__builtin___memcpy_chk (
# 167 "project/radare2/libr/util/asn1.c"
buf
# 167 "project/radare2/libr/util/asn1.c" 3 4
, 
# 167 "project/radare2/libr/util/asn1.c"
...
# 173 "project/radare2/libr/util/asn1.c" 3 4
__attribute__((visibility("default"))) 
# 173 "project/radare2/libr/util/asn1.c"
     void r_asn1_print_hex (RASN1Object *object, char* buffer, 
# 173 "project/radare2/libr/util/asn1.c" 3 4
                                                               unsigned int 
# 173 "project/radare2/libr/util/asn1.c"
                                                                    size, 
...
# 174 "project/radare2/libr/util/asn1.c" 3 4
unsigned int 
# 174 "project/radare2/libr/util/asn1.c"
     i;
...
# 182 "project/radare2/libr/util/asn1.c" 3 4
 __builtin___snprintf_chk (
# 182 "project/radare2/libr/util/asn1.c"
 p
# 182 "project/radare2/libr/util/asn1.c" 3 4
 , 
# 182 "project/radare2/libr/util/asn1.c"
...
# 186 "project/radare2/libr/util/asn1.c" 3 4
 __builtin___snprintf_chk (
# 186 "project/radare2/libr/util/asn1.c"
 p
# 186 "project/radare2/libr/util/asn1.c" 3 4
 , 
# 186 "project/radare2/libr/util/asn1.c"
...
# 191 "project/radare2/libr/util/asn1.c" 3 4
 __builtin___snprintf_chk (
# 191 "project/radare2/libr/util/asn1.c"
 p
# 191 "project/radare2/libr/util/asn1.c" 3 4
 , 
# 191 "project/radare2/libr/util/asn1.c"
...
static void r_asn1_print_padded(RStrBuf *sb, RASN1Object *object, int depth, const char *k, const char *v) {
 ...
 switch (object->tag) {
 case 
# 202 "project/radare2/libr/util/asn1.c" 3 4
     0x05
# 202 "project/radare2/libr/util/asn1.c"
             :
 case 
# 203 "project/radare2/libr/util/asn1.c" 3 4
     0x00
# 203 "project/radare2/libr/util/asn1.c"
            :
  break;
 case 
# 205 "project/radare2/libr/util/asn1.c" 3 4
     0x02
# 205 "project/radare2/libr/util/asn1.c"
                :
 case 
# 206 "project/radare2/libr/util/asn1.c" 3 4
     0x09
# 206 "project/radare2/libr/util/asn1.c"
             :
  ...
  break;
 case 
# 211 "project/radare2/libr/util/asn1.c" 3 4
     0x03
# 211 "project/radare2/libr/util/asn1.c"
                  :
 default:
  if (*r_str_trim_head_ro (v)) {
   r_strbuf_appendf (sb, "%s%s\n", pad, v);
...
static RASN1String* r_asn1_print_hexdump_padded (RASN1Object *object, 
# 221 "project/radare2/libr/util/asn1.c" 3 4
                                                                     unsigned int 
# 221 "project/radare2/libr/util/asn1.c"
                                                                          depth) {
 const char *pad;
 
# 223 "project/radare2/libr/util/asn1.c" 3 4
unsigned int 
# 223 "project/radare2/libr/util/asn1.c"
     i, j;
 char readable[20] = {0};
 if (!object || !object->sector || object->length < 1) {
  return 
# 226 "project/radare2/libr/util/asn1.c" 3 4
        ((void *)0)
# 226 "project/radare2/libr/util/asn1.c"
            ;
 }
...
# 237 "project/radare2/libr/util/asn1.c" 3 4
 unsigned char 
# 237 "project/radare2/libr/util/asn1.c"
     c = object->sector[i];
  if (i > 0 && (i % 16) == 0) {
   r_strbuf_appendf (sb, "|%-16s|\n%s", readable, pad);
   
# 240 "project/radare2/libr/util/asn1.c" 3 4
  __builtin___memset_chk (
# 240 "project/radare2/libr/util/asn1.c"
  readable
# 240 "project/radare2/libr/util/asn1.c" 3 4
  , 
# 240 "project/radare2/libr/util/asn1.c"
...
# 240 "project/radare2/libr/util/asn1.c"
  ...
  readable[j] = 
# 244 "project/radare2/libr/util/asn1.c" 3 4
               ((
# 244 "project/radare2/libr/util/asn1.c"
               c
# 244 "project/radare2/libr/util/asn1.c" 3 4
               ) >=' ' && (
# 244 "project/radare2/libr/util/asn1.c"
...
# 244 "project/radare2/libr/util/asn1.c"
 ...
 RASN1String* asn1str = r_asn1_create_string (text, 
# 253 "project/radare2/libr/util/asn1.c" 3 4
                                                   1
# 253 "project/radare2/libr/util/asn1.c"
                                                       , strlen (text) + 1);
 if (!asn1str) {
...
# 261 "project/radare2/libr/util/asn1.c" 3 4
__attribute__((visibility("default"))) 
# 261 "project/radare2/libr/util/asn1.c"
     char *r_asn1_to_string (RASN1Object *object, 
# 261 "project/radare2/libr/util/asn1.c" 3 4
                                                  unsigned int 
# 261 "project/radare2/libr/util/asn1.c"
                                                       depth, RStrBuf *sb) {
 
# 262 "project/radare2/libr/util/asn1.c" 3 4
unsigned int 
# 262 "project/radare2/libr/util/asn1.c"
     i;
 
# 263 "project/radare2/libr/util/asn1.c" 3 4
_Bool 
# 263 "project/radare2/libr/util/asn1.c"
     root = 
# 263 "project/radare2/libr/util/asn1.c" 3 4
            0
# 263 "project/radare2/libr/util/asn1.c"
 ...
 if (!object) {
  return 
# 265 "project/radare2/libr/util/asn1.c" 3 4
        ((void *)0)
# 265 "project/radare2/libr/util/asn1.c"
            ;
 }
 if (!sb) {
  sb = r_strbuf_new ("");
  root = 
# 269 "project/radare2/libr/util/asn1.c" 3 4
        1
# 269 "project/radare2/libr/util/asn1.c"
            ;
 }

 RASN1String* asn1str = 
# 272 "project/radare2/libr/util/asn1.c" 3 4
                       ((void *)0)
# 272 "project/radare2/libr/util/asn1.c"
                           ;
 ...
 switch (object->klass) {
 case 
# 278 "project/radare2/libr/util/asn1.c" 3 4
     0x00
# 278 "project/radare2/libr/util/asn1.c"
                    :
  switch (object->tag) {
  case 
# 280 "project/radare2/libr/util/asn1.c" 3 4
      0x00
# 280 "project/radare2/libr/util/asn1.c"
             :
   name = "EOC";
   break;
  case 
# 283 "project/radare2/libr/util/asn1.c" 3 4
      0x01
# 283 "project/radare2/libr/util/asn1.c"
                 :
   name = "BOOLEAN";
   if (object->sector) {
   ...
   break;
  case 
# 289 "project/radare2/libr/util/asn1.c" 3 4
      0x02
# 289 "project/radare2/libr/util/asn1.c"
                 :
   name = "INTEGER";
   if (object->length < 16) {
   ...
   break;
  case 
# 298 "project/radare2/libr/util/asn1.c" 3 4
      0x03
# 298 "project/radare2/libr/util/asn1.c"
                   :
   name = "BIT_STRING";
   if (!object->list.objects) {
    if (object->length < 16) {
   ...
   break;
  case 
# 309 "project/radare2/libr/util/asn1.c" 3 4
      0x04
# 309 "project/radare2/libr/util/asn1.c"
                     :
   name = "OCTET_STRING";
   ...
   break;
  case 
# 322 "project/radare2/libr/util/asn1.c" 3 4
      0x05
# 322 "project/radare2/libr/util/asn1.c"
              :
   name = "NULL";
   break;
  case 
# 325 "project/radare2/libr/util/asn1.c" 3 4
      0x06
# 325 "project/radare2/libr/util/asn1.c"
             :
   name = "OBJECT_IDENTIFIER";
   asn1str = r_asn1_stringify_oid (object->sector, object->length);
   break;
  case 
# 329 "project/radare2/libr/util/asn1.c" 3 4
      0x07
# 329 "project/radare2/libr/util/asn1.c"
                       :
   name = "OBJECT_DESCRIPTOR";
   break;
  case 
# 332 "project/radare2/libr/util/asn1.c" 3 4
      0x08
# 332 "project/radare2/libr/util/asn1.c"
                  :
   name = "EXTERNAL";
   break;
  case 
# 335 "project/radare2/libr/util/asn1.c" 3 4
      0x09
# 335 "project/radare2/libr/util/asn1.c"
              :
   name = "REAL";
   asn1str = r_asn1_print_hexdump_padded (object, depth);
   break;
  case 
# 339 "project/radare2/libr/util/asn1.c" 3 4
      0x0A
# 339 "project/radare2/libr/util/asn1.c"
                    :
   name = "ENUMERATED";
   break;
  case 
# 342 "project/radare2/libr/util/asn1.c" 3 4
      0x0B
# 342 "project/radare2/libr/util/asn1.c"
                      :
   name = "EMBEDDED_PDV";
   break;
  case 
# 345 "project/radare2/libr/util/asn1.c" 3 4
      0x0C
# 345 "project/radare2/libr/util/asn1.c"
                    :
   name = "UTF8String";
   asn1str = r_asn1_stringify_string (object->sector, object->length);
   break;
  case 
# 349 "project/radare2/libr/util/asn1.c" 3 4
      0x10
# 349 "project/radare2/libr/util/asn1.c"
                  :
   name = "SEQUENCE";
   break;
  case 
# 352 "project/radare2/libr/util/asn1.c" 3 4
      0x11
# 352 "project/radare2/libr/util/asn1.c"
             :
   name = "SET";
   break;
  case 
# 355 "project/radare2/libr/util/asn1.c" 3 4
      0x12
# 355 "project/radare2/libr/util/asn1.c"
                       :
   name = "NumericString";
   asn1str = r_asn1_stringify_string (object->sector, object->length);
   break;
  case 
# 359 "project/radare2/libr/util/asn1.c" 3 4
      0x13
# 359 "project/radare2/libr/util/asn1.c"
                         :
   name = "PrintableString";
   asn1str = r_asn1_stringify_string (object->sector, object->length);
   break;
  case 
# 363 "project/radare2/libr/util/asn1.c" 3 4
      0x14
# 363 "project/radare2/libr/util/asn1.c"
                   :
   name = "TeletexString";
   asn1str = r_asn1_stringify_string (object->sector, object->length);
   break;
  case 
# 367 "project/radare2/libr/util/asn1.c" 3 4
      0x15
# 367 "project/radare2/libr/util/asn1.c"
                        :
   name = "VideotexString";
   asn1str = r_asn1_stringify_string (object->sector, object->length);
   break;
  case 
# 371 "project/radare2/libr/util/asn1.c" 3 4
      0x16
# 371 "project/radare2/libr/util/asn1.c"
                   :
   name = "IA5String";
   asn1str = r_asn1_stringify_string (object->sector, object->length);
   break;
  case 
# 375 "project/radare2/libr/util/asn1.c" 3 4
      0x17
# 375 "project/radare2/libr/util/asn1.c"
                 :
   name = "UTCTime";
   asn1str = r_asn1_stringify_utctime (object->sector, object->length);
   break;
  case 
# 379 "project/radare2/libr/util/asn1.c" 3 4
      0x18
# 379 "project/radare2/libr/util/asn1.c"
                         :
   name = "GeneralizedTime";
   asn1str = r_asn1_stringify_time (object->sector, object->length);
   break;
  case 
# 383 "project/radare2/libr/util/asn1.c" 3 4
      0x19
# 383 "project/radare2/libr/util/asn1.c"
                       :
   name = "GraphicString";
   asn1str = r_asn1_stringify_string (object->sector, object->length);
   break;
  case 
# 387 "project/radare2/libr/util/asn1.c" 3 4
      0x1A
# 387 "project/radare2/libr/util/asn1.c"
                       :
   name = "VisibleString";
   asn1str = r_asn1_stringify_string (object->sector, object->length);
   break;
  case 
# 391 "project/radare2/libr/util/asn1.c" 3 4
      0x1B
# 391 "project/radare2/libr/util/asn1.c"
                       :
   name = "GeneralString";
   break;
  case 
# 394 "project/radare2/libr/util/asn1.c" 3 4
      0x1C
# 394 "project/radare2/libr/util/asn1.c"
                         :
   name = "UniversalString";
   asn1str = r_asn1_stringify_string (object->sector, object->length);
   break;
  case 
# 398 "project/radare2/libr/util/asn1.c" 3 4
      0x1E
# 398 "project/radare2/libr/util/asn1.c"
                   :
   name = "BMPString";
   asn1str = r_asn1_stringify_string (object->sector, object->length);
   break;
...
# 403 "project/radare2/libr/util/asn1.c" 3 4
  __builtin___snprintf_chk (
# 403 "project/radare2/libr/util/asn1.c"
  temp_name
# 403 "project/radare2/libr/util/asn1.c" 3 4
  , 
# 403 "project/radare2/libr/util/asn1.c"
...
# 403 "project/radare2/libr/util/asn1.c"
  ...
  break;
 case 
# 408 "project/radare2/libr/util/asn1.c" 3 4
     0x40
# 408 "project/radare2/libr/util/asn1.c"
                      :
  
# 409 "project/radare2/libr/util/asn1.c" 3 4
 __builtin___snprintf_chk (
# 409 "project/radare2/libr/util/asn1.c"
 temp_name
# 409 "project/radare2/libr/util/asn1.c" 3 4
 , 
# 409 "project/radare2/libr/util/asn1.c"
...
# 409 "project/radare2/libr/util/asn1.c"
  ...
  break;
 case 
# 412 "project/radare2/libr/util/asn1.c" 3 4
     0x80
# 412 "project/radare2/libr/util/asn1.c"
                  :
  
# 413 "project/radare2/libr/util/asn1.c" 3 4
 __builtin___snprintf_chk (
# 413 "project/radare2/libr/util/asn1.c"
 temp_name
# 413 "project/radare2/libr/util/asn1.c" 3 4
 , 
# 413 "project/radare2/libr/util/asn1.c"
...
# 413 "project/radare2/libr/util/asn1.c"
  ...
  break;
 case 
# 416 "project/radare2/libr/util/asn1.c" 3 4
     0xC0
# 416 "project/radare2/libr/util/asn1.c"
                  :
  
# 417 "project/radare2/libr/util/asn1.c" 3 4
 __builtin___snprintf_chk (
# 417 "project/radare2/libr/util/asn1.c"
 temp_name
# 417 "project/radare2/libr/util/asn1.c" 3 4
 , 
# 417 "project/radare2/libr/util/asn1.c"
...
# 417 "project/radare2/libr/util/asn1.c"
 ...
 if (ASN1_STD_FORMAT) {
  r_strbuf_appendf (sb, "%4"
# 425 "project/radare2/libr/util/asn1.c" 3 4
                           "lld"
# 425 "project/radare2/libr/util/asn1.c"
                                  "  ", object->offset);
 ...
 return root? r_strbuf_drain (sb): 
# 444 "project/radare2/libr/util/asn1.c" 3 4
                                  ((void *)0)
# 444 "project/radare2/libr/util/asn1.c"
                                      ;
}


# 447 "project/radare2/libr/util/asn1.c" 3 4
__attribute__((visibility("default"))) 
# 447 "project/radare2/libr/util/asn1.c"
     void r_asn1_free_object (RASN1Object *object) {
 
# 448 "project/radare2/libr/util/asn1.c" 3 4
unsigned int 
# 448 "project/radare2/libr/util/asn1.c"
     i;
 if (!object) {
  return;
 }
 ...
 object->sector = 
# 453 "project/radare2/libr/util/asn1.c" 3 4
                 ((void *)0)
# 453 "project/radare2/libr/util/asn1.c"
                     ;
 if (object->list.objects) {
  for (i = 0; i < object->list.length; i++) {
...
# 458 "project/radare2/libr/util/asn1.c" 3 4
 { free((void *)
# 458 "project/radare2/libr/util/asn1.c"
 object->list.objects
# 458 "project/radare2/libr/util/asn1.c" 3 4
 ); 
# 458 "project/radare2/libr/util/asn1.c"
...
# 458 "project/radare2/libr/util/asn1.c"
 ...
 object->list.objects = 
# 460 "project/radare2/libr/util/asn1.c" 3 4
                       ((void *)0)
# 460 "project/radare2/libr/util/asn1.c"
                           ;
...
# 465 "project/radare2/libr/util/asn1.c" 3 4
__attribute__((visibility("default"))) 
# 465 "project/radare2/libr/util/asn1.c"
