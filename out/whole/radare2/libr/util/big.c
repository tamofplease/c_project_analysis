# 0 "project/radare2/libr/util/big.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/big.c"
...
# 6 "project/radare2/libr/util/big.c" 2



# 8 "project/radare2/libr/util/big.c"
...
# 14 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 14 "project/radare2/libr/util/big.c"
     RNumBig *r_big_new(void) {
 RNumBig *n = 
# 15 "project/radare2/libr/util/big.c" 3 4
             (
# 15 "project/radare2/libr/util/big.c"
             RNumBig
# 15 "project/radare2/libr/util/big.c" 3 4
             *)malloc(sizeof(
# 15 "project/radare2/libr/util/big.c"
...
# 22 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 22 "project/radare2/libr/util/big.c"
     void r_big_free(RNumBig *b) {
 free (b);
}


# 26 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 26 "project/radare2/libr/util/big.c"
     void r_big_init(RNumBig *b) {
 _r_big_zero_out (b);
}


# 30 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 30 "project/radare2/libr/util/big.c"
     void r_big_fini(RNumBig *b) {
 _r_big_zero_out (b);
}


# 34 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 34 "project/radare2/libr/util/big.c"
     void r_big_from_int(RNumBig *b, 
# 34 "project/radare2/libr/util/big.c" 3 4
                                     long long 
# 34 "project/radare2/libr/util/big.c"
                                          n) {
 
# 35 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 35 "project/radare2/libr/util/big.c"
b
# 35 "project/radare2/libr/util/big.c" 3 4
...
# 39 "project/radare2/libr/util/big.c" 3 4
unsigned long long 
# 39 "project/radare2/libr/util/big.c"
                v = n * b->sign;
# 52 "project/radare2/libr/util/big.c"
 b->array[0] = v;
 
# 53 "project/radare2/libr/util/big.c" 3 4
unsigned long long 
# 53 "project/radare2/libr/util/big.c"
                num_32 = 32;
 
# 54 "project/radare2/libr/util/big.c" 3 4
unsigned long long 
# 54 "project/radare2/libr/util/big.c"
                tmp = v >> num_32;
 b->array[1] = tmp;
...
static void r_big_from_unsigned(RNumBig *b, 
# 60 "project/radare2/libr/util/big.c" 3 4
                                           unsigned long long 
# 60 "project/radare2/libr/util/big.c"
                                                v) {
 
# 61 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 61 "project/radare2/libr/util/big.c"
b
# 61 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 61 "project/radare2/libr/util/big.c"
...
# 61 "project/radare2/libr/util/big.c"
 ...
 _r_big_zero_out (b);
# 76 "project/radare2/libr/util/big.c"
 b->array[0] = v;
 
# 77 "project/radare2/libr/util/big.c" 3 4
unsigned long long 
# 77 "project/radare2/libr/util/big.c"
                num_32 = 32;
 
# 78 "project/radare2/libr/util/big.c" 3 4
unsigned long long 
# 78 "project/radare2/libr/util/big.c"
                tmp = v >> num_32;
 b->array[1] = tmp;
...
# 84 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) long long 
# 84 "project/radare2/libr/util/big.c"
          r_big_to_int(RNumBig *b) {
 
# 85 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 85 "project/radare2/libr/util/big.c"
b
# 85 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 85 "project/radare2/libr/util/big.c"
...
# 87 "project/radare2/libr/util/big.c" 3 4
unsigned long long 
# 87 "project/radare2/libr/util/big.c"
                ret = 0;
# 99 "project/radare2/libr/util/big.c"
 ret += b->array[1];
 ret <<= 32;
 ret += b->array[0];
 ...
 if (b->sign < 0) {
  return -(
# 104 "project/radare2/libr/util/big.c" 3 4
          long long
# 104 "project/radare2/libr/util/big.c"
              )ret;
 }
 return ret;
}
...
# 109 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 109 "project/radare2/libr/util/big.c"
     void r_big_from_hexstr(RNumBig *n, const char *str) {
 
# 110 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 110 "project/radare2/libr/util/big.c"
n
# 110 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 110 "project/radare2/libr/util/big.c"
...
# 111 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 111 "project/radare2/libr/util/big.c"
str
# 111 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 111 "project/radare2/libr/util/big.c"
...
# 126 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 126 "project/radare2/libr/util/big.c"
nbytes > 0
# 126 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 126 "project/radare2/libr/util/big.c"
...
# 128 "project/radare2/libr/util/big.c" 3 4
unsigned int 
# 128 "project/radare2/libr/util/big.c"
            tmp;
 int i = nbytes - (2 * 
# 129 "project/radare2/libr/util/big.c" 3 4
                      4
# 129 "project/radare2/libr/util/big.c"
                                     );
 int j = 0;
 ...
 while (i >= 0) {
  tmp = 0;
  sscanf (&str[i], 
# 134 "project/radare2/libr/util/big.c" 3 4
                  "%8x"
# 134 "project/radare2/libr/util/big.c"
                                         , &tmp);
  n->array[j] = tmp;
  i -= (2 * 
# 136 "project/radare2/libr/util/big.c" 3 4
           4
# 136 "project/radare2/libr/util/big.c"
                          );
  j += 1;
 }

 if (-2 * 
# 140 "project/radare2/libr/util/big.c" 3 4
         4 
# 140 "project/radare2/libr/util/big.c"
                         < i) {
  char buffer[2 * 
# 141 "project/radare2/libr/util/big.c" 3 4
                 4
# 141 "project/radare2/libr/util/big.c"
                                ];
  
# 142 "project/radare2/libr/util/big.c" 3 4
 __builtin___memset_chk (
# 142 "project/radare2/libr/util/big.c"
 buffer
# 142 "project/radare2/libr/util/big.c" 3 4
 , 
# 142 "project/radare2/libr/util/big.c"
...
# 142 "project/radare2/libr/util/big.c"
                                    ;
  i += 2 * 
# 143 "project/radare2/libr/util/big.c" 3 4
          4 
# 143 "project/radare2/libr/util/big.c"
                          - 1;
  for (; i >= 0; i--) {
   buffer[i] = str[i];
  }
  tmp = 0;
  sscanf (buffer, 
# 148 "project/radare2/libr/util/big.c" 3 4
                 "%8x"
# 148 "project/radare2/libr/util/big.c"
                                        , &tmp);
  n->array[j] = tmp;
 }
}
...
# 153 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 153 "project/radare2/libr/util/big.c"
     char *r_big_to_hexstr(RNumBig *b) {
 
# 154 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 154 "project/radare2/libr/util/big.c"
b
# 154 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 154 "project/radare2/libr/util/big.c"
"b"
# 154 "project/radare2/libr/util/big.c" 3 4
, 154); return (((void *)0)); } } while (0)
# 154 "project/radare2/libr/util/big.c"
                              ;

 int j = 
# 156 "project/radare2/libr/util/big.c" 3 4
        (512 / 4) 
# 156 "project/radare2/libr/util/big.c"
                         - 1;
 size_t i = 0;
 size_t k = 0;
 size_t z, last_z = 2 * 
# 159 "project/radare2/libr/util/big.c" 3 4
                       4
# 159 "project/radare2/libr/util/big.c"
                                      ;
 ...
 size_t size = 3 + 2 * 
# 167 "project/radare2/libr/util/big.c" 3 4
                      4 
# 167 "project/radare2/libr/util/big.c"
                                      * (j + 1) + ((b->sign > 0)? 0: 1);
 char *ret_str = calloc (size, sizeof (char));
 if (!ret_str) {
  return 
# 170 "project/radare2/libr/util/big.c" 3 4
        ((void *)0)
# 170 "project/radare2/libr/util/big.c"
            ;
 }
 ...
 r_snprintf (ret_str + i, 
# 179 "project/radare2/libr/util/big.c" 3 4
                         9
# 179 "project/radare2/libr/util/big.c"
                                             , 
# 179 "project/radare2/libr/util/big.c" 3 4
                                               "%.08x"
# 179 "project/radare2/libr/util/big.c"
                                                                       , b->array[j--]);
 for (; ret_str[i + k] == '0' && k < 2 * 
# 180 "project/radare2/libr/util/big.c" 3 4
                                        4
# 180 "project/radare2/libr/util/big.c"
                                                       ; k++) {
 }
 ...
 for (; j >= 0; j--) {
  r_snprintf (ret_str + i, 
# 189 "project/radare2/libr/util/big.c" 3 4
                          9
# 189 "project/radare2/libr/util/big.c"
                                              , 
# 189 "project/radare2/libr/util/big.c" 3 4
                                                "%.08x"
# 189 "project/radare2/libr/util/big.c"
                                                                        , b->array[j]);
  i += 2 * 
# 190 "project/radare2/libr/util/big.c" 3 4
          4
# 190 "project/radare2/libr/util/big.c"
                         ;
 }
...
# 196 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 196 "project/radare2/libr/util/big.c"
     void r_big_assign(RNumBig *dst, RNumBig *src) {
 
# 197 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 197 "project/radare2/libr/util/big.c"
dst
# 197 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 197 "project/radare2/libr/util/big.c"
...
# 198 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 198 "project/radare2/libr/util/big.c"
src
# 198 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 198 "project/radare2/libr/util/big.c"
...
# 200 "project/radare2/libr/util/big.c" 3 4
__builtin___memcpy_chk (
# 200 "project/radare2/libr/util/big.c"
dst
# 200 "project/radare2/libr/util/big.c" 3 4
, 
# 200 "project/radare2/libr/util/big.c"
...
# 204 "project/radare2/libr/util/big.c" 3 4
unsigned long long 
# 204 "project/radare2/libr/util/big.c"
                tmp;
 int carry = 0;
 int i;
 for (i = 0; i < 
# 207 "project/radare2/libr/util/big.c" 3 4
                (512 / 4)
# 207 "project/radare2/libr/util/big.c"
                                ; i++) {
  tmp = (
# 208 "project/radare2/libr/util/big.c" 3 4
        unsigned long long
# 208 "project/radare2/libr/util/big.c"
                       )a->array[i] + b->array[i] + carry;
  carry = (tmp > 
# 209 "project/radare2/libr/util/big.c" 3 4
                (unsigned long long) 0xFFFFFFFFU
# 209 "project/radare2/libr/util/big.c"
                             );
  c->array[i] = (tmp & 
# 210 "project/radare2/libr/util/big.c" 3 4
                      (unsigned long long) 0xFFFFFFFFU
# 210 "project/radare2/libr/util/big.c"
                                   );
 }
}
...
# 215 "project/radare2/libr/util/big.c" 3 4
unsigned long long 
# 215 "project/radare2/libr/util/big.c"
                res;
 RNumBig *tmp;
 
# 217 "project/radare2/libr/util/big.c" 3 4
unsigned long long 
# 217 "project/radare2/libr/util/big.c"
                tmp1;
 
# 218 "project/radare2/libr/util/big.c" 3 4
unsigned long long 
# 218 "project/radare2/libr/util/big.c"
                tmp2;
 int borrow = 0;
 ...
 int i;
 for (i = 0; i < 
# 228 "project/radare2/libr/util/big.c" 3 4
                (512 / 4)
# 228 "project/radare2/libr/util/big.c"
                                ; i++) {
  tmp1 = (
# 229 "project/radare2/libr/util/big.c" 3 4
         unsigned long long
# 229 "project/radare2/libr/util/big.c"
                        )a->array[i] + (
# 229 "project/radare2/libr/util/big.c" 3 4
                                        (unsigned long long) 0xFFFFFFFFU 
# 229 "project/radare2/libr/util/big.c"
                                                      + 1);
  tmp2 = (
# 230 "project/radare2/libr/util/big.c" 3 4
         unsigned long long
# 230 "project/radare2/libr/util/big.c"
                        )b->array[i] + borrow;

  res = (tmp1 - tmp2);
  c->array[i] = (
# 233 "project/radare2/libr/util/big.c" 3 4
                unsigned int
# 233 "project/radare2/libr/util/big.c"
                           ) (res & 
# 233 "project/radare2/libr/util/big.c" 3 4
                                    (unsigned long long) 0xFFFFFFFFU
# 233 "project/radare2/libr/util/big.c"
  ...
  borrow = (res <= 
# 234 "project/radare2/libr/util/big.c" 3 4
                  (unsigned long long) 0xFFFFFFFFU
# 234 "project/radare2/libr/util/big.c"
                               );
 }
}


# 238 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 238 "project/radare2/libr/util/big.c"
     void r_big_add(RNumBig *c, RNumBig *a, RNumBig *b) {
 
# 239 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 239 "project/radare2/libr/util/big.c"
a
# 239 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 239 "project/radare2/libr/util/big.c"
...
# 240 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 240 "project/radare2/libr/util/big.c"
b
# 240 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 240 "project/radare2/libr/util/big.c"
...
# 241 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 241 "project/radare2/libr/util/big.c"
c
# 241 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 241 "project/radare2/libr/util/big.c"
...
# 263 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 263 "project/radare2/libr/util/big.c"
     void r_big_sub(RNumBig *c, RNumBig *a, RNumBig *b) {
 
# 264 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 264 "project/radare2/libr/util/big.c"
a
# 264 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 264 "project/radare2/libr/util/big.c"
...
# 265 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 265 "project/radare2/libr/util/big.c"
b
# 265 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 265 "project/radare2/libr/util/big.c"
...
# 266 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 266 "project/radare2/libr/util/big.c"
c
# 266 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 266 "project/radare2/libr/util/big.c"
...
# 288 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 288 "project/radare2/libr/util/big.c"
     void r_big_mul(RNumBig *c, RNumBig *a, RNumBig *b) {
 
# 289 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 289 "project/radare2/libr/util/big.c"
a
# 289 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 289 "project/radare2/libr/util/big.c"
...
# 290 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 290 "project/radare2/libr/util/big.c"
b
# 290 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 290 "project/radare2/libr/util/big.c"
...
# 291 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 291 "project/radare2/libr/util/big.c"
c
# 291 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 291 "project/radare2/libr/util/big.c"
...
# 291 "project/radare2/libr/util/big.c"
 ...
 for (i = 0; i < 
# 298 "project/radare2/libr/util/big.c" 3 4
                (512 / 4)
# 298 "project/radare2/libr/util/big.c"
                                ; i++) {
  _r_big_zero_out (row);

  for (j = 0; j < 
# 301 "project/radare2/libr/util/big.c" 3 4
                 (512 / 4)
# 301 "project/radare2/libr/util/big.c"
                                 ; j++) {
   if (i + j < 
# 302 "project/radare2/libr/util/big.c" 3 4
              (512 / 4)
# 302 "project/radare2/libr/util/big.c"
                              ) {
    _r_big_zero_out (tmp);
    
# 304 "project/radare2/libr/util/big.c" 3 4
   unsigned long long 
# 304 "project/radare2/libr/util/big.c"
                   intermediate = ((
# 304 "project/radare2/libr/util/big.c" 3 4
                                    unsigned long long
# 304 "project/radare2/libr/util/big.c"
...
# 324 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 324 "project/radare2/libr/util/big.c"
     void r_big_div(RNumBig *c, RNumBig *a, RNumBig *b) {
 
# 325 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 325 "project/radare2/libr/util/big.c"
a
# 325 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 325 "project/radare2/libr/util/big.c"
...
# 326 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 326 "project/radare2/libr/util/big.c"
b
# 326 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 326 "project/radare2/libr/util/big.c"
...
# 327 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 327 "project/radare2/libr/util/big.c"
c
# 327 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 327 "project/radare2/libr/util/big.c"
...
# 328 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 328 "project/radare2/libr/util/big.c"
!r_big_is_zero (b)
# 328 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 328 "project/radare2/libr/util/big.c"
...
# 328 "project/radare2/libr/util/big.c"
 ...
 while (r_big_cmp (tmp, a) != 1) {
  if ((denom->array[
# 343 "project/radare2/libr/util/big.c" 3 4
                   (512 / 4) 
# 343 "project/radare2/libr/util/big.c"
                                    - 1] >> (
# 343 "project/radare2/libr/util/big.c" 3 4
                                             4 
# 343 "project/radare2/libr/util/big.c"
...
# 375 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 375 "project/radare2/libr/util/big.c"
     void r_big_mod(RNumBig *c, RNumBig *a, RNumBig *b) {



 
# 379 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 379 "project/radare2/libr/util/big.c"
a
# 379 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 379 "project/radare2/libr/util/big.c"
...
# 380 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 380 "project/radare2/libr/util/big.c"
b
# 380 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 380 "project/radare2/libr/util/big.c"
...
# 381 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 381 "project/radare2/libr/util/big.c"
c
# 381 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 381 "project/radare2/libr/util/big.c"
...
# 382 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 382 "project/radare2/libr/util/big.c"
!r_big_is_zero (b)
# 382 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 382 "project/radare2/libr/util/big.c"
...
# 391 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 391 "project/radare2/libr/util/big.c"
     void r_big_divmod(RNumBig *c, RNumBig *d, RNumBig *a, RNumBig *b) {
# 401 "project/radare2/libr/util/big.c"
 
# 401 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 401 "project/radare2/libr/util/big.c"
a
# 401 "project/radare2/libr/util/big.c" 3 4
...
# 402 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 402 "project/radare2/libr/util/big.c"
b
# 402 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 402 "project/radare2/libr/util/big.c"
...
# 403 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 403 "project/radare2/libr/util/big.c"
c
# 403 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 403 "project/radare2/libr/util/big.c"
...
# 404 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 404 "project/radare2/libr/util/big.c"
!r_big_is_zero (b)
# 404 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 404 "project/radare2/libr/util/big.c"
...
# 420 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 420 "project/radare2/libr/util/big.c"
     void r_big_and(RNumBig *c, RNumBig *a, RNumBig *b) {
 
# 421 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 421 "project/radare2/libr/util/big.c"
a
# 421 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 421 "project/radare2/libr/util/big.c"
...
# 422 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 422 "project/radare2/libr/util/big.c"
b
# 422 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 422 "project/radare2/libr/util/big.c"
...
# 423 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 423 "project/radare2/libr/util/big.c"
c
# 423 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 423 "project/radare2/libr/util/big.c"
...
# 424 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 424 "project/radare2/libr/util/big.c"
a->sign > 0
# 424 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 424 "project/radare2/libr/util/big.c"
...
# 425 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 425 "project/radare2/libr/util/big.c"
b->sign > 0
# 425 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 425 "project/radare2/libr/util/big.c"
...
# 425 "project/radare2/libr/util/big.c"
 ...
 int i;
 for (i = 0; i < 
# 428 "project/radare2/libr/util/big.c" 3 4
                (512 / 4)
# 428 "project/radare2/libr/util/big.c"
                                ; i++) {
...
# 433 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 433 "project/radare2/libr/util/big.c"
     void r_big_or(RNumBig *c, RNumBig *a, RNumBig *b) {
 
# 434 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 434 "project/radare2/libr/util/big.c"
a
# 434 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 434 "project/radare2/libr/util/big.c"
...
# 435 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 435 "project/radare2/libr/util/big.c"
b
# 435 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 435 "project/radare2/libr/util/big.c"
...
# 436 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 436 "project/radare2/libr/util/big.c"
c
# 436 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 436 "project/radare2/libr/util/big.c"
...
# 437 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 437 "project/radare2/libr/util/big.c"
a->sign > 0
# 437 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 437 "project/radare2/libr/util/big.c"
...
# 438 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 438 "project/radare2/libr/util/big.c"
b->sign > 0
# 438 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 438 "project/radare2/libr/util/big.c"
...
# 438 "project/radare2/libr/util/big.c"
 ...
 int i;
 for (i = 0; i < 
# 441 "project/radare2/libr/util/big.c" 3 4
                (512 / 4)
# 441 "project/radare2/libr/util/big.c"
                                ; i++) {
  c->array[i] = (a->array[i] | b->array[i]);
 }
}
...
# 446 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 446 "project/radare2/libr/util/big.c"
     void r_big_xor(RNumBig *c, RNumBig *a, RNumBig *b) {
 
# 447 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 447 "project/radare2/libr/util/big.c"
a
# 447 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 447 "project/radare2/libr/util/big.c"
...
# 448 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 448 "project/radare2/libr/util/big.c"
b
# 448 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 448 "project/radare2/libr/util/big.c"
...
# 449 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 449 "project/radare2/libr/util/big.c"
c
# 449 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 449 "project/radare2/libr/util/big.c"
...
# 450 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 450 "project/radare2/libr/util/big.c"
a->sign > 0
# 450 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 450 "project/radare2/libr/util/big.c"
...
# 451 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 451 "project/radare2/libr/util/big.c"
b->sign > 0
# 451 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 451 "project/radare2/libr/util/big.c"
...
# 451 "project/radare2/libr/util/big.c"
 ...
 int i;
 for (i = 0; i < 
# 454 "project/radare2/libr/util/big.c" 3 4
                (512 / 4)
# 454 "project/radare2/libr/util/big.c"
                                ; i++) {
  c->array[i] = (a->array[i] ^ b->array[i]);
 }
}
...
# 459 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 459 "project/radare2/libr/util/big.c"
     void r_big_lshift(RNumBig *b, RNumBig *a, size_t nbits) {
 
# 460 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 460 "project/radare2/libr/util/big.c"
a
# 460 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 460 "project/radare2/libr/util/big.c"
...
# 461 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 461 "project/radare2/libr/util/big.c"
b
# 461 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 461 "project/radare2/libr/util/big.c"
...
# 462 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 462 "project/radare2/libr/util/big.c"
a->sign > 0
# 462 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 462 "project/radare2/libr/util/big.c"
...
# 463 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 463 "project/radare2/libr/util/big.c"
b->sign > 0
# 463 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 463 "project/radare2/libr/util/big.c"
...
# 463 "project/radare2/libr/util/big.c"
 ...
 const int nbits_pr_word = (
# 467 "project/radare2/libr/util/big.c" 3 4
                           4 
# 467 "project/radare2/libr/util/big.c"
                                           * 8);
 ...
 if (nbits != 0) {
  int i;
  for (i = (
# 476 "project/radare2/libr/util/big.c" 3 4
           (512 / 4) 
# 476 "project/radare2/libr/util/big.c"
                            - 1); i > 0; i--) {
   b->array[i] = (b->array[i] << nbits) | (b->array[i - 1] >> ((8 * 
# 477 "project/radare2/libr/util/big.c" 3 4
                                                                   4
# 477 "project/radare2/libr/util/big.c"
                                                                                  ) - nbits));
  }
  b->array[i] <<= nbits;
 }
...
# 483 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 483 "project/radare2/libr/util/big.c"
     void r_big_rshift(RNumBig *b, RNumBig *a, size_t nbits) {
 
# 484 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 484 "project/radare2/libr/util/big.c"
a
# 484 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 484 "project/radare2/libr/util/big.c"
...
# 485 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 485 "project/radare2/libr/util/big.c"
b
# 485 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 485 "project/radare2/libr/util/big.c"
...
# 486 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 486 "project/radare2/libr/util/big.c"
a->sign > 0
# 486 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 486 "project/radare2/libr/util/big.c"
...
# 487 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 487 "project/radare2/libr/util/big.c"
b->sign > 0
# 487 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 487 "project/radare2/libr/util/big.c"
...
# 487 "project/radare2/libr/util/big.c"
 ...
 const int nbits_pr_word = (
# 491 "project/radare2/libr/util/big.c" 3 4
                           4 
# 491 "project/radare2/libr/util/big.c"
                                           * 8);
 int nwords = nbits / nbits_pr_word;
 if (nwords != 0) {
 ...
 if (nbits != 0) {
  int i;
  for (i = 0; i < (
# 500 "project/radare2/libr/util/big.c" 3 4
                  (512 / 4) 
# 500 "project/radare2/libr/util/big.c"
                                   - 1); i++) {
   b->array[i] = (b->array[i] >> nbits) | (b->array[i + 1] << ((8 * 
# 501 "project/radare2/libr/util/big.c" 3 4
                                                                   4
# 501 "project/radare2/libr/util/big.c"
                                                                                  ) - nbits));
  }
  b->array[i] >>= nbits;
 }
...
# 507 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 507 "project/radare2/libr/util/big.c"
     int r_big_cmp(RNumBig *a, RNumBig *b) {
 
# 508 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 508 "project/radare2/libr/util/big.c"
a
# 508 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 508 "project/radare2/libr/util/big.c"
...
# 509 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 509 "project/radare2/libr/util/big.c"
b
# 509 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 509 "project/radare2/libr/util/big.c"
...
# 509 "project/radare2/libr/util/big.c"
 ...
 int i = 
# 514 "project/radare2/libr/util/big.c" 3 4
        (512 / 4)
# 514 "project/radare2/libr/util/big.c"
                        ;
 do {
  i -= 1;
...
# 528 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 528 "project/radare2/libr/util/big.c"
     int r_big_is_zero(RNumBig *a) {
 
# 529 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 529 "project/radare2/libr/util/big.c"
a
# 529 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 529 "project/radare2/libr/util/big.c"
...
# 529 "project/radare2/libr/util/big.c"
 ...
 int i;
 for (i = 0; i < 
# 532 "project/radare2/libr/util/big.c" 3 4
                (512 / 4)
# 532 "project/radare2/libr/util/big.c"
                                ; i++) {
  if (a->array[i]) {
   return 0;
  }
...
# 541 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 541 "project/radare2/libr/util/big.c"
     void r_big_inc(RNumBig *a) {
 
# 542 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 542 "project/radare2/libr/util/big.c"
a
# 542 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 542 "project/radare2/libr/util/big.c"
...
# 551 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 551 "project/radare2/libr/util/big.c"
     void r_big_dec(RNumBig *a) {
 
# 552 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 552 "project/radare2/libr/util/big.c"
a
# 552 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 552 "project/radare2/libr/util/big.c"
...
# 561 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 561 "project/radare2/libr/util/big.c"
     void r_big_powm(RNumBig *c, RNumBig *a, RNumBig *b, RNumBig *m) {
 
# 562 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 562 "project/radare2/libr/util/big.c"
a
# 562 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 562 "project/radare2/libr/util/big.c"
...
# 563 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 563 "project/radare2/libr/util/big.c"
b
# 563 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 563 "project/radare2/libr/util/big.c"
...
# 564 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 564 "project/radare2/libr/util/big.c"
c
# 564 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 564 "project/radare2/libr/util/big.c"
...
# 565 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 565 "project/radare2/libr/util/big.c"
m
# 565 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 565 "project/radare2/libr/util/big.c"
...
# 589 "project/radare2/libr/util/big.c" 3 4
__attribute__((visibility("default"))) 
# 589 "project/radare2/libr/util/big.c"
     void r_big_isqrt(RNumBig *b, RNumBig *a) {
 
# 590 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 590 "project/radare2/libr/util/big.c"
a
# 590 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 590 "project/radare2/libr/util/big.c"
...
# 591 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 591 "project/radare2/libr/util/big.c"
b
# 591 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 591 "project/radare2/libr/util/big.c"
...
# 626 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 626 "project/radare2/libr/util/big.c"
a
# 626 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 626 "project/radare2/libr/util/big.c"
...
# 627 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 627 "project/radare2/libr/util/big.c"
nwords >= 0
# 627 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 627 "project/radare2/libr/util/big.c"
...
# 627 "project/radare2/libr/util/big.c"
 ...
 size_t i;
 if (nwords >= 
# 630 "project/radare2/libr/util/big.c" 3 4
              (512 / 4)
# 630 "project/radare2/libr/util/big.c"
                              ) {
  for (i = 0; i < 
# 631 "project/radare2/libr/util/big.c" 3 4
                 (512 / 4)
# 631 "project/radare2/libr/util/big.c"
                                 ; i++) {
   a->array[i] = 0;
  }
  return;
 ...
 for (i = 0; i < 
# 637 "project/radare2/libr/util/big.c" 3 4
                (512 / 4) 
# 637 "project/radare2/libr/util/big.c"
                                 - nwords; i++) {
  a->array[i] = a->array[i + nwords];
 }
 for (; i < 
# 640 "project/radare2/libr/util/big.c" 3 4
           (512 / 4)
# 640 "project/radare2/libr/util/big.c"
                           ; i++) {
  a->array[i] = 0;
 }
}
...
# 646 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 646 "project/radare2/libr/util/big.c"
a
# 646 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 646 "project/radare2/libr/util/big.c"
...
# 647 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 647 "project/radare2/libr/util/big.c"
nwords >= 0
# 647 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 647 "project/radare2/libr/util/big.c"
...
# 647 "project/radare2/libr/util/big.c"
 ...
 for (i = (
# 651 "project/radare2/libr/util/big.c" 3 4
          (512 / 4) 
# 651 "project/radare2/libr/util/big.c"
                           - 1); i >= nwords; i--) {
  a->array[i] = a->array[i - nwords];
 }
...
# 661 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 661 "project/radare2/libr/util/big.c"
a
# 661 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 661 "project/radare2/libr/util/big.c"
...
# 661 "project/radare2/libr/util/big.c"
 ...
 int i;
 for (i = (
# 664 "project/radare2/libr/util/big.c" 3 4
          (512 / 4) 
# 664 "project/radare2/libr/util/big.c"
                           - 1); i > 0; i--) {
  a->array[i] = (a->array[i] << 1) | (a->array[i - 1] >> ((8 * 
# 665 "project/radare2/libr/util/big.c" 3 4
                                                              4
# 665 "project/radare2/libr/util/big.c"
                                                                             ) - 1));
 }
 a->array[0] <<= 1;
}
...
# 671 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 671 "project/radare2/libr/util/big.c"
a
# 671 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 671 "project/radare2/libr/util/big.c"
...
# 671 "project/radare2/libr/util/big.c"
 ...
 int i;
 for (i = 0; i < (
# 674 "project/radare2/libr/util/big.c" 3 4
                 (512 / 4) 
# 674 "project/radare2/libr/util/big.c"
                                  - 1); i++) {
  a->array[i] = (a->array[i] >> 1) | (a->array[i + 1] << ((8 * 
# 675 "project/radare2/libr/util/big.c" 3 4
                                                              4
# 675 "project/radare2/libr/util/big.c"
                                                                             ) - 1));
 }
 a->array[
# 677 "project/radare2/libr/util/big.c" 3 4
         (512 / 4) 
# 677 "project/radare2/libr/util/big.c"
                          - 1] >>= 1;
}

static void _r_big_zero_out(RNumBig *a) {
 
# 681 "project/radare2/libr/util/big.c" 3 4
do { if (!(
# 681 "project/radare2/libr/util/big.c"
a
# 681 "project/radare2/libr/util/big.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 681 "project/radare2/libr/util/big.c"
...
# 681 "project/radare2/libr/util/big.c"
 ...
 size_t i;
 for (i = 0; i < 
# 684 "project/radare2/libr/util/big.c" 3 4
                (512 / 4)
# 684 "project/radare2/libr/util/big.c"
                                ; i++) {
  a->array[i] = 0;
 }
 a->sign = 1;
