# 0 "project/radare2/libr/util/thread.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/thread.c"
...
# 4 "project/radare2/libr/util/thread.c" 2
...
# 5 "project/radare2/libr/util/thread.c" 2
...
# 33 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/ndr.h" 3 4
#define _MACH_NDR_H_ 
...
# 8 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/thread_act.h" 2 3 4
...
#define FALSE 0
# 9 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/thread_act.h" 2 3 4
...
# 10 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/thread_act.h" 2 3 4
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/notify.h" 1 3 4
# 65 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/notify.h" 3 4
...
# 68 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/notify.h" 2 3 4
...
# 69 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/notify.h" 2 3 4
...
# 11 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/thread_act.h" 2 3 4
...
# 12 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/thread_act.h" 2 3 4

# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/mig_errors.h" 1 3 4
# 64 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/mig_errors.h" 3 4
#define _MACH_MIG_ERRORS_H_ 

# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/mig.h" 1 3 4
# 37 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/mig.h" 3 4
#define _MACH_MIG_H_ 
# 63 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/mig.h" 3 4
#define __MigTypeCheck 1
# 73 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/mig.h" 3 4
...
# 151 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/mig.h" 3 4
...
# 82 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/mig_errors.h" 3 4
...
# 14 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/thread_act.h" 2 3 4
...
# 52 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/thread_act.h" 3 4
...
# 520 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/mach/thread_act.h" 3 4
...
# 9 "project/radare2/libr/util/thread.c" 2
# 23 "project/radare2/libr/util/thread.c"
...
static void *_r_th_launcher(void *_th) {
 ...
 RThread *th = _th;
 th->ready = 
# 27 "project/radare2/libr/util/thread.c" 3 4
            1
# 27 "project/radare2/libr/util/thread.c"
                ;
 if (th->delay > 0) {
 ...
 do {
  ...
  th->running = 
# 36 "project/radare2/libr/util/thread.c" 3 4
               1
# 36 "project/radare2/libr/util/thread.c"
                   ;
  ret = th->fun (th);
  if (ret < 0) {
  ...
  th->running = 
# 42 "project/radare2/libr/util/thread.c" 3 4
               0
# 42 "project/radare2/libr/util/thread.c"
                    ;
  r_th_lock_enter (th->lock);
 } while (ret);
 r_th_lock_leave (th->lock);
...
# 52 "project/radare2/libr/util/thread.c" 3 4
__attribute__((visibility("default"))) 
# 52 "project/radare2/libr/util/thread.c"
     int r_th_push_task(struct r_th_t *th, void *user) {
 int ret = 
# 53 "project/radare2/libr/util/thread.c" 3 4
          1
# 53 "project/radare2/libr/util/thread.c"
              ;
 th->user = user;
 r_th_lock_leave (th->lock);
 return ret;
...
# 59 "project/radare2/libr/util/thread.c" 3 4
__attribute__((visibility("default"))) pthread_t 
# 59 "project/radare2/libr/util/thread.c"
              r_th_self(void) {
...
# 70 "project/radare2/libr/util/thread.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 70 "project/radare2/libr/util/thread.c"
          r_th_setname(RThread *th, const char *name) {
...
# 79 "project/radare2/libr/util/thread.c" 3 4
 fprintf(__stderrp,
# 79 "project/radare2/libr/util/thread.c"
...
# 79 "project/radare2/libr/util/thread.c"
                                        ;
  return 
# 80 "project/radare2/libr/util/thread.c" 3 4
        0
# 80 "project/radare2/libr/util/thread.c"
             ;
 }
# 98 "project/radare2/libr/util/thread.c"
 return 
# 98 "project/radare2/libr/util/thread.c" 3 4
       1
# 98 "project/radare2/libr/util/thread.c"
           ;
}
...
# 101 "project/radare2/libr/util/thread.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 101 "project/radare2/libr/util/thread.c"
          r_th_getname(RThread *th, char *name, size_t len) {


 if (pthread_getname_np (th->tid, name, len) != 0) {
  
# 105 "project/radare2/libr/util/thread.c" 3 4
 fprintf(__stderrp,
# 105 "project/radare2/libr/util/thread.c"
...
# 105 "project/radare2/libr/util/thread.c"
                                        ;
  return 
# 106 "project/radare2/libr/util/thread.c" 3 4
        0
# 106 "project/radare2/libr/util/thread.c"
             ;
 }
# 124 "project/radare2/libr/util/thread.c"
 return 
# 124 "project/radare2/libr/util/thread.c" 3 4
       1
# 124 "project/radare2/libr/util/thread.c"
           ;
}
...
# 127 "project/radare2/libr/util/thread.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 127 "project/radare2/libr/util/thread.c"
          r_th_setaffinity(RThread *th, int cpuid) {
# 165 "project/radare2/libr/util/thread.c"
 thread_affinity_policy_data_t c = {cpuid};
 if (thread_policy_set (pthread_mach_thread_np (th->tid),
  
# 167 "project/radare2/libr/util/thread.c" 3 4
 4
# 167 "project/radare2/libr/util/thread.c"
                       , (thread_policy_t)&c, 1) != 
# 167 "project/radare2/libr/util/thread.c" 3 4
                                                    0
# 167 "project/radare2/libr/util/thread.c"
...
# 168 "project/radare2/libr/util/thread.c" 3 4
 fprintf(__stderrp,
# 168 "project/radare2/libr/util/thread.c"
...
# 168 "project/radare2/libr/util/thread.c"
                                         ;
  return 
# 169 "project/radare2/libr/util/thread.c" 3 4
        0
# 169 "project/radare2/libr/util/thread.c"
             ;
 }
# 192 "project/radare2/libr/util/thread.c"
 return 
# 192 "project/radare2/libr/util/thread.c" 3 4
       1
# 192 "project/radare2/libr/util/thread.c"
           ;
}
...
# 195 "project/radare2/libr/util/thread.c" 3 4
__attribute__((visibility("default"))) 
# 195 "project/radare2/libr/util/thread.c"
     RThread *r_th_new(
# 195 "project/radare2/libr/util/thread.c" 3 4
                       RThreadFunctionRet (*
# 195 "project/radare2/libr/util/thread.c"
...
# 195 "project/radare2/libr/util/thread.c"
                                         , void *user, int delay) {
 RThread *th = 
# 196 "project/radare2/libr/util/thread.c" 3 4
              (
# 196 "project/radare2/libr/util/thread.c"
              RThread
# 196 "project/radare2/libr/util/thread.c" 3 4
              *)calloc(1,sizeof(
# 196 "project/radare2/libr/util/thread.c"
...
# 198 "project/radare2/libr/util/thread.c" 3 4
                           0
# 198 "project/radare2/libr/util/thread.c"
                                );
  th->running = 
# 199 "project/radare2/libr/util/thread.c" 3 4
               0
# 199 "project/radare2/libr/util/thread.c"
                    ;
  th->fun = fun;
  th->user = user;
  th->delay = delay;
  th->breaked = 
# 203 "project/radare2/libr/util/thread.c" 3 4
               0
# 203 "project/radare2/libr/util/thread.c"
                    ;
  th->ready = 
# 204 "project/radare2/libr/util/thread.c" 3 4
             0
# 204 "project/radare2/libr/util/thread.c"
                  ;

  pthread_create (&th->tid, 
# 206 "project/radare2/libr/util/thread.c" 3 4
                           ((void *)0)
# 206 "project/radare2/libr/util/thread.c"
                               , _r_th_launcher, th);
...
# 214 "project/radare2/libr/util/thread.c" 3 4
__attribute__((visibility("default"))) 
# 214 "project/radare2/libr/util/thread.c"
     void r_th_break(RThread *th) {
 th->breaked = 
# 215 "project/radare2/libr/util/thread.c" 3 4
              1
# 215 "project/radare2/libr/util/thread.c"
                  ;
}


# 218 "project/radare2/libr/util/thread.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 218 "project/radare2/libr/util/thread.c"
          r_th_kill(RThread *th, 
# 218 "project/radare2/libr/util/thread.c" 3 4
                                 _Bool 
# 218 "project/radare2/libr/util/thread.c"
                                      force) {
 if (!th || !th->tid) {
  return 
# 220 "project/radare2/libr/util/thread.c" 3 4
        0
# 220 "project/radare2/libr/util/thread.c"
             ;
 }
 th->breaked = 
# 222 "project/radare2/libr/util/thread.c" 3 4
              1
# 222 "project/radare2/libr/util/thread.c"
                  ;
 r_th_break (th);
 r_th_wait (th);
...
# 237 "project/radare2/libr/util/thread.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 237 "project/radare2/libr/util/thread.c"
          r_th_start(RThread *th, int enable) {
 
# 238 "project/radare2/libr/util/thread.c" 3 4
_Bool 
# 238 "project/radare2/libr/util/thread.c"
     ret = 
# 238 "project/radare2/libr/util/thread.c" 3 4
           1
# 238 "project/radare2/libr/util/thread.c"
...
# 258 "project/radare2/libr/util/thread.c" 3 4
__attribute__((visibility("default"))) 
# 258 "project/radare2/libr/util/thread.c"
     int r_th_wait(struct r_th_t *th) {
 int ret = 
# 259 "project/radare2/libr/util/thread.c" 3 4
          0
# 259 "project/radare2/libr/util/thread.c"
               ;
 if (th) {
  ...
  th->running = 
# 267 "project/radare2/libr/util/thread.c" 3 4
               0
# 267 "project/radare2/libr/util/thread.c"
                    ;
 }
 return ret;
}
...
# 272 "project/radare2/libr/util/thread.c" 3 4
__attribute__((visibility("default"))) 
# 272 "project/radare2/libr/util/thread.c"
     int r_th_wait_async(struct r_th_t *th) {
 return th->running;
}


# 276 "project/radare2/libr/util/thread.c" 3 4
__attribute__((visibility("default"))) 
# 276 "project/radare2/libr/util/thread.c"
     void *r_th_free(struct r_th_t *th) {
 if (!th) {
  return 
# 278 "project/radare2/libr/util/thread.c" 3 4
        ((void *)0)
# 278 "project/radare2/libr/util/thread.c"
            ;
 }
 ...
 free (th);
 return 
# 285 "project/radare2/libr/util/thread.c" 3 4
       ((void *)0)
# 285 "project/radare2/libr/util/thread.c"
           ;
}


# 288 "project/radare2/libr/util/thread.c" 3 4
__attribute__((visibility("default"))) 
# 288 "project/radare2/libr/util/thread.c"
     void *r_th_kill_free(struct r_th_t *th) {
 if (!th) {
  return 
# 290 "project/radare2/libr/util/thread.c" 3 4
        ((void *)0)
# 290 "project/radare2/libr/util/thread.c"
            ;
 }
 r_th_kill (th, 
# 292 "project/radare2/libr/util/thread.c" 3 4
               1
# 292 "project/radare2/libr/util/thread.c"
                   );
 r_th_free (th);
 return 
# 294 "project/radare2/libr/util/thread.c" 3 4
       ((void *)0)
# 294 "project/radare2/libr/util/thread.c"
           ;
}
