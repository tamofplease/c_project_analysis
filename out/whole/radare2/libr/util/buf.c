# 0 "project/radare2/libr/util/buf.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/buf.c"
...
# 4 "project/radare2/libr/util/buf.c" 2
...
# 5 "project/radare2/libr/util/buf.c" 2
...
# 6 "project/radare2/libr/util/buf.c" 2


# 7 "project/radare2/libr/util/buf.c"
typedef enum {
 R_BUFFER_FILE,
 R_BUFFER_IO,
 R_BUFFER_BYTES,
...
# 1 "project/radare2/libr/util/buf_file.c" 1
...
# 17 "project/radare2/libr/util/buf.c" 2
# 1 "project/radare2/libr/util/buf_sparse.c" 1
...
# 18 "project/radare2/libr/util/buf.c" 2
# 1 "project/radare2/libr/util/buf_bytes.c" 1
...
# 19 "project/radare2/libr/util/buf.c" 2
# 1 "project/radare2/libr/util/buf_mmap.c" 1
...
# 20 "project/radare2/libr/util/buf.c" 2
# 1 "project/radare2/libr/util/buf_io.c" 1
...
# 21 "project/radare2/libr/util/buf.c" 2
# 1 "project/radare2/libr/util/buf_ref.c" 1
...
# 22 "project/radare2/libr/util/buf.c" 2

static 
# 23 "project/radare2/libr/util/buf.c" 3 4
      _Bool 
# 23 "project/radare2/libr/util/buf.c"
           buf_init(RBuffer *b, const void *user) {
 
# 24 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 24 "project/radare2/libr/util/buf.c"
b && b->methods
# 24 "project/radare2/libr/util/buf.c" 3 4
...
# 24 "project/radare2/libr/util/buf.c"
                                             ;
 return b->methods->init? b->methods->init (b, user): 
# 25 "project/radare2/libr/util/buf.c" 3 4
                                                     1
# 25 "project/radare2/libr/util/buf.c"
                                                         ;
}
...
# 30 "project/radare2/libr/util/buf.c" 3 4
 { free((void *)
# 30 "project/radare2/libr/util/buf.c"
 b->whole_buf
# 30 "project/radare2/libr/util/buf.c" 3 4
 ); 
# 30 "project/radare2/libr/util/buf.c"
...
static 
# 34 "project/radare2/libr/util/buf.c" 3 4
      _Bool 
# 34 "project/radare2/libr/util/buf.c"
           buf_fini(RBuffer *b) {
 
# 35 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 35 "project/radare2/libr/util/buf.c"
b && b->methods
# 35 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 35 "project/radare2/libr/util/buf.c"
...
# 35 "project/radare2/libr/util/buf.c"
                                             ;
 return b->methods->fini? b->methods->fini (b): 
# 36 "project/radare2/libr/util/buf.c" 3 4
                                               1
# 36 "project/radare2/libr/util/buf.c"
                                                   ;
}

static 
# 39 "project/radare2/libr/util/buf.c" 3 4
      unsigned long long 
# 39 "project/radare2/libr/util/buf.c"
           buf_get_size(RBuffer *b) {
 
# 40 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 40 "project/radare2/libr/util/buf.c"
b && b->methods
# 40 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 40 "project/radare2/libr/util/buf.c"
"b && b->methods"
# 40 "project/radare2/libr/util/buf.c" 3 4
, 40); return (0xFFFFFFFFFFFFFFFFULL); } } while (0)
# 40 "project/radare2/libr/util/buf.c"
                                                ;
 return b->methods->get_size? b->methods->get_size (b): 
# 41 "project/radare2/libr/util/buf.c" 3 4
                                                       0xFFFFFFFFFFFFFFFFULL
# 41 "project/radare2/libr/util/buf.c"
                                                               ;
}

static 
# 44 "project/radare2/libr/util/buf.c" 3 4
      long long 
# 44 "project/radare2/libr/util/buf.c"
           buf_read(RBuffer *b, 
# 44 "project/radare2/libr/util/buf.c" 3 4
                                unsigned char 
# 44 "project/radare2/libr/util/buf.c"
...
# 45 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 45 "project/radare2/libr/util/buf.c"
b && b->methods
# 45 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 45 "project/radare2/libr/util/buf.c"
...
static 
# 49 "project/radare2/libr/util/buf.c" 3 4
      long long 
# 49 "project/radare2/libr/util/buf.c"
           buf_write(RBuffer *b, const 
# 49 "project/radare2/libr/util/buf.c" 3 4
                                       unsigned char 
# 49 "project/radare2/libr/util/buf.c"
                                           *buf, size_t len) {
 
# 50 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 50 "project/radare2/libr/util/buf.c"
b && b->methods
# 50 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 50 "project/radare2/libr/util/buf.c"
...
static 
# 55 "project/radare2/libr/util/buf.c" 3 4
      long long 
# 55 "project/radare2/libr/util/buf.c"
           buf_seek(RBuffer *b, 
# 55 "project/radare2/libr/util/buf.c" 3 4
                                long long 
# 55 "project/radare2/libr/util/buf.c"
...
# 56 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 56 "project/radare2/libr/util/buf.c"
b && b->methods
# 56 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 56 "project/radare2/libr/util/buf.c"
...
static 
# 60 "project/radare2/libr/util/buf.c" 3 4
      _Bool 
# 60 "project/radare2/libr/util/buf.c"
           buf_resize(RBuffer *b, 
# 60 "project/radare2/libr/util/buf.c" 3 4
                                  unsigned long long 
# 60 "project/radare2/libr/util/buf.c"
                                       newsize) {
 
# 61 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 61 "project/radare2/libr/util/buf.c"
b && b->methods
# 61 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 61 "project/radare2/libr/util/buf.c"
...
# 61 "project/radare2/libr/util/buf.c"
                                          ;
 return b->methods->resize? b->methods->resize (b, newsize): 
# 62 "project/radare2/libr/util/buf.c" 3 4
                                                            0
# 62 "project/radare2/libr/util/buf.c"
                                                                 ;
}

static 
# 65 "project/radare2/libr/util/buf.c" 3 4
      unsigned char 
# 65 "project/radare2/libr/util/buf.c"
          *get_whole_buf(RBuffer *b, 
# 65 "project/radare2/libr/util/buf.c" 3 4
                                     unsigned long long 
# 65 "project/radare2/libr/util/buf.c"
                                          *sz) {
 
# 66 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 66 "project/radare2/libr/util/buf.c"
b && b->methods
# 66 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 66 "project/radare2/libr/util/buf.c"
...
# 70 "project/radare2/libr/util/buf.c" 3 4
unsigned long long 
# 70 "project/radare2/libr/util/buf.c"
     bsz = r_buf_size (b);

 if (bsz == 
# 72 "project/radare2/libr/util/buf.c" 3 4
           0xFFFFFFFFFFFFFFFFULL
# 72 "project/radare2/libr/util/buf.c"
                   ) {
  return 
# 73 "project/radare2/libr/util/buf.c" 3 4
        ((void *)0)
# 73 "project/radare2/libr/util/buf.c"
            ;
 }
 free (b->whole_buf);
 b->whole_buf = 
# 76 "project/radare2/libr/util/buf.c" 3 4
               (unsigned char*)malloc(sizeof(unsigned char)*(
# 76 "project/radare2/libr/util/buf.c"
               bsz
# 76 "project/radare2/libr/util/buf.c" 3 4
               ))
# 76 "project/radare2/libr/util/buf.c"
 ...
 if (!b->whole_buf) {
  return 
# 78 "project/radare2/libr/util/buf.c" 3 4
        ((void *)0)
# 78 "project/radare2/libr/util/buf.c"
            ;
 }
...
static RBuffer *new_buffer(RBufferType type, const void *user) {
 RBuffer *b = 
# 88 "project/radare2/libr/util/buf.c" 3 4
             (
# 88 "project/radare2/libr/util/buf.c"
             RBuffer
# 88 "project/radare2/libr/util/buf.c" 3 4
             *)calloc(1,sizeof(
# 88 "project/radare2/libr/util/buf.c"
...
# 88 "project/radare2/libr/util/buf.c"
 ...
 if (!b) {
  return 
# 90 "project/radare2/libr/util/buf.c" 3 4
        ((void *)0)
# 90 "project/radare2/libr/util/buf.c"
            ;
 }
 switch (type) {
 case R_BUFFER_BYTES:
...
# 112 "project/radare2/libr/util/buf.c" 3 4
 do { r_assert_log (R_LOGLVL_WARN, "(%s:%d):%s%s code should not be reached\n", "project/radare2/libr/util/buf.c", 112, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : ""); } while (0)
# 112 "project/radare2/libr/util/buf.c"
                     ;
  break;
 }
 if (!buf_init (b, user)) {
  free (b);
  return 
# 117 "project/radare2/libr/util/buf.c" 3 4
        ((void *)0)
# 117 "project/radare2/libr/util/buf.c"
            ;
 }
 return b;
}
...
# 127 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) 
# 127 "project/radare2/libr/util/buf.c"
     RBuffer *r_buf_new_with_io(void *iob, int fd) {
 
# 128 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 128 "project/radare2/libr/util/buf.c"
iob && fd >= 0
# 128 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 128 "project/radare2/libr/util/buf.c"
...
# 135 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) 
# 135 "project/radare2/libr/util/buf.c"
     RBuffer *r_buf_new_with_pointers(const 
# 135 "project/radare2/libr/util/buf.c" 3 4
                                            unsigned char 
# 135 "project/radare2/libr/util/buf.c"
                                                *bytes, 
...
# 143 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) 
# 143 "project/radare2/libr/util/buf.c"
     RBuffer *r_buf_new_empty(
# 143 "project/radare2/libr/util/buf.c" 3 4
                              unsigned long long 
# 143 "project/radare2/libr/util/buf.c"
                                   len) {
 
# 144 "project/radare2/libr/util/buf.c" 3 4
unsigned char 
# 144 "project/radare2/libr/util/buf.c"
    *buf = 
# 144 "project/radare2/libr/util/buf.c" 3 4
...
# 144 "project/radare2/libr/util/buf.c"
 ...
 if (!buf) {
  return 
# 146 "project/radare2/libr/util/buf.c" 3 4
        ((void *)0)
# 146 "project/radare2/libr/util/buf.c"
            ;
 }
 ...
 u.length = len;
 u.steal = 
# 152 "project/radare2/libr/util/buf.c" 3 4
          1
# 152 "project/radare2/libr/util/buf.c"
              ;
...
# 160 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) 
# 160 "project/radare2/libr/util/buf.c"
     RBuffer *r_buf_new_with_bytes(const 
# 160 "project/radare2/libr/util/buf.c" 3 4
                                         unsigned char 
# 160 "project/radare2/libr/util/buf.c"
                                             *bytes, 
...
# 167 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) 
# 167 "project/radare2/libr/util/buf.c"
     RBuffer *r_buf_new_slice(RBuffer *b, 
# 167 "project/radare2/libr/util/buf.c" 3 4
                                          unsigned long long 
# 167 "project/radare2/libr/util/buf.c"
                                               offset, 
...
# 175 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) 
# 175 "project/radare2/libr/util/buf.c"
     RBuffer *r_buf_new_with_string(const char *msg) {
 return r_buf_new_with_bytes ((const 
# 176 "project/radare2/libr/util/buf.c" 3 4
                                    unsigned char 
# 176 "project/radare2/libr/util/buf.c"
                                        *)msg, (
# 176 "project/radare2/libr/util/buf.c" 3 4
                                                unsigned long long
# 176 "project/radare2/libr/util/buf.c"
...
# 179 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) 
# 179 "project/radare2/libr/util/buf.c"
     RBuffer *r_buf_new_with_buf(RBuffer *b) {
 
# 180 "project/radare2/libr/util/buf.c" 3 4
unsigned long long 
# 180 "project/radare2/libr/util/buf.c"
     sz = 0;
 const 
# 181 "project/radare2/libr/util/buf.c" 3 4
      unsigned char 
# 181 "project/radare2/libr/util/buf.c"
          *tmp = r_buf_data (b, &sz);
 return r_buf_new_with_bytes (tmp, sz);
}


# 185 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) 
# 185 "project/radare2/libr/util/buf.c"
     RBuffer *r_buf_new_sparse(
# 185 "project/radare2/libr/util/buf.c" 3 4
                               unsigned char 
# 185 "project/radare2/libr/util/buf.c"
                                   Oxff) {
 RBuffer *b = new_buffer (R_BUFFER_SPARSE, 
# 186 "project/radare2/libr/util/buf.c" 3 4
                                          ((void *)0)
# 186 "project/radare2/libr/util/buf.c"
                                              );
 if (b) {
  b->Oxff_priv = Oxff;
 }
...
# 193 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) 
# 193 "project/radare2/libr/util/buf.c"
     RBuffer *r_buf_new(void) {
 struct buf_bytes_user u = { 0 };
 u.data = 
# 195 "project/radare2/libr/util/buf.c" 3 4
         ((void *)0)
# 195 "project/radare2/libr/util/buf.c"
             ;
 u.length = 0;
 return new_buffer (R_BUFFER_BYTES, &u);
}
...
# 200 "project/radare2/libr/util/buf.c" 3 4
           __attribute__((visibility("default"))) 
# 200 "project/radare2/libr/util/buf.c"
                 const 
# 200 "project/radare2/libr/util/buf.c" 3 4
                       unsigned char 
# 200 "project/radare2/libr/util/buf.c"
                           *r_buf_data(RBuffer *b, 
# 200 "project/radare2/libr/util/buf.c" 3 4
                                                   unsigned long long 
# 200 "project/radare2/libr/util/buf.c"
                                                        *size) {
 
# 201 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 201 "project/radare2/libr/util/buf.c"
b
# 201 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 201 "project/radare2/libr/util/buf.c"
...
# 206 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 206 "project/radare2/libr/util/buf.c"
          r_buf_size(RBuffer *b) {
 
# 207 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 207 "project/radare2/libr/util/buf.c"
b
# 207 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 207 "project/radare2/libr/util/buf.c"
...
# 212 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) 
# 212 "project/radare2/libr/util/buf.c"
     RBuffer *r_buf_new_mmap(const char *filename, int perm) {
 
# 213 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 213 "project/radare2/libr/util/buf.c"
filename
# 213 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 213 "project/radare2/libr/util/buf.c"
...
# 220 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) 
# 220 "project/radare2/libr/util/buf.c"
     RBuffer *r_buf_new_file(const char *file, int perm, int mode) {
...
# 229 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) 
# 229 "project/radare2/libr/util/buf.c"
     RBuffer *r_buf_new_slurp(const char *file) {
 size_t len;
 char *tmp = r_file_slurp (file, &len);
 if (!tmp) {
  return 
# 233 "project/radare2/libr/util/buf.c" 3 4
        ((void *)0)
# 233 "project/radare2/libr/util/buf.c"
            ;
 }

 struct buf_bytes_user u = { 0 };
 u.data_steal = (
# 237 "project/radare2/libr/util/buf.c" 3 4
                unsigned char 
# 237 "project/radare2/libr/util/buf.c"
                    *)tmp;
 u.length = (
# 238 "project/radare2/libr/util/buf.c" 3 4
            unsigned long long
# 238 "project/radare2/libr/util/buf.c"
                )len;
 u.steal = 
# 239 "project/radare2/libr/util/buf.c" 3 4
          1
# 239 "project/radare2/libr/util/buf.c"
              ;
 return new_buffer (R_BUFFER_BYTES, &u);
}


# 243 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 243 "project/radare2/libr/util/buf.c"
          r_buf_dump(RBuffer *b, const char *file) {

 if (!b || !file) {
  return 
# 246 "project/radare2/libr/util/buf.c" 3 4
        0
# 246 "project/radare2/libr/util/buf.c"
             ;
 }
 
# 248 "project/radare2/libr/util/buf.c" 3 4
unsigned long long 
# 248 "project/radare2/libr/util/buf.c"
     tmpsz = 0;
 const 
# 249 "project/radare2/libr/util/buf.c" 3 4
      unsigned char 
# 249 "project/radare2/libr/util/buf.c"
          *tmp = r_buf_data (b, &tmpsz);
 return r_file_dump (file, tmp, tmpsz, 0);
}


# 253 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) long long 
# 253 "project/radare2/libr/util/buf.c"
          r_buf_seek(RBuffer *b, 
# 253 "project/radare2/libr/util/buf.c" 3 4
                                 long long 
# 253 "project/radare2/libr/util/buf.c"
                                      addr, int whence) {
 
# 254 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 254 "project/radare2/libr/util/buf.c"
b
# 254 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 254 "project/radare2/libr/util/buf.c"
...
# 258 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 258 "project/radare2/libr/util/buf.c"
          r_buf_tell(RBuffer *b) {
 return r_buf_seek (b, 0, 
# 259 "project/radare2/libr/util/buf.c" 3 4
                         1
# 259 "project/radare2/libr/util/buf.c"
                                  );
}


# 262 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 262 "project/radare2/libr/util/buf.c"
          r_buf_set_bytes(RBuffer *b, const 
# 262 "project/radare2/libr/util/buf.c" 3 4
                                            unsigned char 
# 262 "project/radare2/libr/util/buf.c"
                                                *buf, 
...
# 263 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 263 "project/radare2/libr/util/buf.c"
b && buf && !b->readonly
# 263 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 263 "project/radare2/libr/util/buf.c"
"b && buf && !b->readonly"
# 263 "project/radare2/libr/util/buf.c" 3 4
, 263); return (0); } } while (0)
# 263 "project/radare2/libr/util/buf.c"
                                                      ;
 if (!r_buf_resize (b, 0)) {
  return 
# 265 "project/radare2/libr/util/buf.c" 3 4
        0
# 265 "project/radare2/libr/util/buf.c"
             ;
 }
 if (r_buf_seek (b, 0, 
# 267 "project/radare2/libr/util/buf.c" 3 4
                      0
# 267 "project/radare2/libr/util/buf.c"
                               ) < 0) {
  return 
# 268 "project/radare2/libr/util/buf.c" 3 4
        0
# 268 "project/radare2/libr/util/buf.c"
             ;
 }
 if (!r_buf_append_bytes (b, buf, length)) {
  return 
# 271 "project/radare2/libr/util/buf.c" 3 4
        0
# 271 "project/radare2/libr/util/buf.c"
             ;
 }
 return r_buf_seek (b, 0, 
# 273 "project/radare2/libr/util/buf.c" 3 4
                         0
# 273 "project/radare2/libr/util/buf.c"
                                  ) >= 0;
}


# 276 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 276 "project/radare2/libr/util/buf.c"
          r_buf_prepend_bytes(RBuffer *b, const 
# 276 "project/radare2/libr/util/buf.c" 3 4
                                                unsigned char 
# 276 "project/radare2/libr/util/buf.c"
                                                    *buf, 
...
# 277 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 277 "project/radare2/libr/util/buf.c"
b && buf && !b->readonly
# 277 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 277 "project/radare2/libr/util/buf.c"
...
# 281 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) 
# 281 "project/radare2/libr/util/buf.c"
     char *r_buf_to_string(RBuffer *b) {
 
# 282 "project/radare2/libr/util/buf.c" 3 4
unsigned long long 
# 282 "project/radare2/libr/util/buf.c"
     sz = r_buf_size (b);
 char *s = malloc (sz + 1);
 if (!s) {
  return 
# 285 "project/radare2/libr/util/buf.c" 3 4
        ((void *)0)
# 285 "project/radare2/libr/util/buf.c"
            ;
 }
 if (r_buf_read_at (b, 0, (
# 287 "project/radare2/libr/util/buf.c" 3 4
                          unsigned char 
# 287 "project/radare2/libr/util/buf.c"
                              *)s, sz) < 0) {
  free (s);
  return 
# 289 "project/radare2/libr/util/buf.c" 3 4
        ((void *)0)
# 289 "project/radare2/libr/util/buf.c"
            ;
 }
 s[sz] = '\0';
 return s;
...
# 295 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 295 "project/radare2/libr/util/buf.c"
          r_buf_append_bytes(RBuffer *b, const 
# 295 "project/radare2/libr/util/buf.c" 3 4
                                               unsigned char 
# 295 "project/radare2/libr/util/buf.c"
                                                   *buf, 
...
# 296 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 296 "project/radare2/libr/util/buf.c"
b && buf && !b->readonly
# 296 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 296 "project/radare2/libr/util/buf.c"
"b && buf && !b->readonly"
# 296 "project/radare2/libr/util/buf.c" 3 4
, 296); return (0); } } while (0)
# 296 "project/radare2/libr/util/buf.c"
                                                      ;

 if (r_buf_seek (b, 0, 
# 298 "project/radare2/libr/util/buf.c" 3 4
                      2
# 298 "project/radare2/libr/util/buf.c"
                               ) < 0) {
  return 
# 299 "project/radare2/libr/util/buf.c" 3 4
        0
# 299 "project/radare2/libr/util/buf.c"
             ;
 }
...
# 305 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 305 "project/radare2/libr/util/buf.c"
          r_buf_append_nbytes(RBuffer *b, 
# 305 "project/radare2/libr/util/buf.c" 3 4
                                          unsigned long long 
# 305 "project/radare2/libr/util/buf.c"
                                               length) {
 
# 306 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 306 "project/radare2/libr/util/buf.c"
b && !b->readonly
# 306 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 306 "project/radare2/libr/util/buf.c"
...
# 307 "project/radare2/libr/util/buf.c" 3 4
unsigned char 
# 307 "project/radare2/libr/util/buf.c"
    *buf = 
# 307 "project/radare2/libr/util/buf.c" 3 4
           (unsigned char*)calloc(
# 307 "project/radare2/libr/util/buf.c"
...
# 307 "project/radare2/libr/util/buf.c"
 ...
 if (!buf) {
  return 
# 309 "project/radare2/libr/util/buf.c" 3 4
        0
# 309 "project/radare2/libr/util/buf.c"
             ;
 }
 
# 311 "project/radare2/libr/util/buf.c" 3 4
_Bool 
# 311 "project/radare2/libr/util/buf.c"
     res = r_buf_append_bytes (b, buf, length);
 free (buf);
 return res;
}


# 316 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) long long 
# 316 "project/radare2/libr/util/buf.c"
          r_buf_insert_bytes(RBuffer *b, 
# 316 "project/radare2/libr/util/buf.c" 3 4
                                         unsigned long long 
# 316 "project/radare2/libr/util/buf.c"
                                              addr, const 
...
# 317 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 317 "project/radare2/libr/util/buf.c"
b && !b->readonly
# 317 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 317 "project/radare2/libr/util/buf.c"
...
# 318 "project/radare2/libr/util/buf.c" 3 4
long long 
# 318 "project/radare2/libr/util/buf.c"
     pos, r = r_buf_seek (b, 0, 
# 318 "project/radare2/libr/util/buf.c" 3 4
                                1
# 318 "project/radare2/libr/util/buf.c"
                                         );
 ...
 pos = r;
 r = r_buf_seek (b, addr, 
# 323 "project/radare2/libr/util/buf.c" 3 4
                         0
# 323 "project/radare2/libr/util/buf.c"
                                  );
 if (r < 0) {
  goto restore_pos;
 }
...
# 328 "project/radare2/libr/util/buf.c" 3 4
unsigned long long 
# 328 "project/radare2/libr/util/buf.c"
     sz = r_buf_size (b);
 
# 329 "project/radare2/libr/util/buf.c" 3 4
unsigned char 
# 329 "project/radare2/libr/util/buf.c"
    *tmp = 
# 329 "project/radare2/libr/util/buf.c" 3 4
           (unsigned char*)malloc(sizeof(unsigned char)*(
# 329 "project/radare2/libr/util/buf.c"
...
# 334 "project/radare2/libr/util/buf.c" 3 4
long long 
# 334 "project/radare2/libr/util/buf.c"
     tmp_length = r;
 if (!r_buf_resize (b, sz + length)) {
  goto free_tmp;
 }
 r = r_buf_seek (b, addr + length, 
# 338 "project/radare2/libr/util/buf.c" 3 4
                                  0
# 338 "project/radare2/libr/util/buf.c"
                                           );
 if (r < 0) {
  goto free_tmp;
 }
 ...
 r = r_buf_seek (b, addr, 
# 346 "project/radare2/libr/util/buf.c" 3 4
                         0
# 346 "project/radare2/libr/util/buf.c"
                                  );
 if (r < 0) {
  goto free_tmp;
 }
...
restore_pos:
 r_buf_seek (b, pos, 
# 354 "project/radare2/libr/util/buf.c" 3 4
                    0
# 354 "project/radare2/libr/util/buf.c"
                             );
 return r;
}


# 358 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 358 "project/radare2/libr/util/buf.c"
          r_buf_append_ut8(RBuffer *b, 
# 358 "project/radare2/libr/util/buf.c" 3 4
                                       unsigned char 
# 358 "project/radare2/libr/util/buf.c"
                                           n) {
 
# 359 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 359 "project/radare2/libr/util/buf.c"
b && !b->readonly
# 359 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 359 "project/radare2/libr/util/buf.c"
"b && !b->readonly"
# 359 "project/radare2/libr/util/buf.c" 3 4
, 359); return (0); } } while (0)
# 359 "project/radare2/libr/util/buf.c"
                                               ;
 return r_buf_append_bytes (b, (const 
# 360 "project/radare2/libr/util/buf.c" 3 4
                                     unsigned char 
# 360 "project/radare2/libr/util/buf.c"
                                         *)&n, sizeof (n));
}


# 363 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 363 "project/radare2/libr/util/buf.c"
          r_buf_append_ut16(RBuffer *b, 
# 363 "project/radare2/libr/util/buf.c" 3 4
                                        unsigned short 
# 363 "project/radare2/libr/util/buf.c"
                                             n) {
 
# 364 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 364 "project/radare2/libr/util/buf.c"
b && !b->readonly
# 364 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 364 "project/radare2/libr/util/buf.c"
"b && !b->readonly"
# 364 "project/radare2/libr/util/buf.c" 3 4
, 364); return (0); } } while (0)
# 364 "project/radare2/libr/util/buf.c"
                                               ;
 return r_buf_append_bytes (b, (const 
# 365 "project/radare2/libr/util/buf.c" 3 4
                                     unsigned char 
# 365 "project/radare2/libr/util/buf.c"
                                         *)&n, sizeof (n));
}


# 368 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 368 "project/radare2/libr/util/buf.c"
          r_buf_append_ut32(RBuffer *b, 
# 368 "project/radare2/libr/util/buf.c" 3 4
                                        unsigned int 
# 368 "project/radare2/libr/util/buf.c"
                                             n) {
 
# 369 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 369 "project/radare2/libr/util/buf.c"
b && !b->readonly
# 369 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 369 "project/radare2/libr/util/buf.c"
"b && !b->readonly"
# 369 "project/radare2/libr/util/buf.c" 3 4
, 369); return (0); } } while (0)
# 369 "project/radare2/libr/util/buf.c"
                                               ;
 return r_buf_append_bytes (b, (const 
# 370 "project/radare2/libr/util/buf.c" 3 4
                                     unsigned char 
# 370 "project/radare2/libr/util/buf.c"
                                         *)&n, sizeof (n));
}


# 373 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 373 "project/radare2/libr/util/buf.c"
          r_buf_append_ut64(RBuffer *b, 
# 373 "project/radare2/libr/util/buf.c" 3 4
                                        unsigned long long 
# 373 "project/radare2/libr/util/buf.c"
                                             n) {
 
# 374 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 374 "project/radare2/libr/util/buf.c"
b && !b->readonly
# 374 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 374 "project/radare2/libr/util/buf.c"
"b && !b->readonly"
# 374 "project/radare2/libr/util/buf.c" 3 4
, 374); return (0); } } while (0)
# 374 "project/radare2/libr/util/buf.c"
                                               ;
 return r_buf_append_bytes (b, (const 
# 375 "project/radare2/libr/util/buf.c" 3 4
                                     unsigned char 
# 375 "project/radare2/libr/util/buf.c"
                                         *)&n, sizeof (n));
}


# 378 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 378 "project/radare2/libr/util/buf.c"
          r_buf_append_buf(RBuffer *b, RBuffer *a) {
 
# 379 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 379 "project/radare2/libr/util/buf.c"
b && a && !b->readonly
# 379 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 379 "project/radare2/libr/util/buf.c"
"b && a && !b->readonly"
# 379 "project/radare2/libr/util/buf.c" 3 4
, 379); return (0); } } while (0)
# 379 "project/radare2/libr/util/buf.c"
                                                    ;
 
# 380 "project/radare2/libr/util/buf.c" 3 4
unsigned long long 
# 380 "project/radare2/libr/util/buf.c"
     sz = 0;
 const 
# 381 "project/radare2/libr/util/buf.c" 3 4
      unsigned char 
# 381 "project/radare2/libr/util/buf.c"
          *tmp = r_buf_data (a, &sz);
 return r_buf_append_bytes (b, tmp, sz);
}


# 385 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 385 "project/radare2/libr/util/buf.c"
          r_buf_append_buf_slice(RBuffer *b, RBuffer *a, 
# 385 "project/radare2/libr/util/buf.c" 3 4
                                                         unsigned long long 
# 385 "project/radare2/libr/util/buf.c"
                                                              offset, 
...
# 386 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 386 "project/radare2/libr/util/buf.c"
b && a && !b->readonly
# 386 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 386 "project/radare2/libr/util/buf.c"
"b && a && !b->readonly"
# 386 "project/radare2/libr/util/buf.c" 3 4
, 386); return (0); } } while (0)
# 386 "project/radare2/libr/util/buf.c"
                                                    ;
 
# 387 "project/radare2/libr/util/buf.c" 3 4
unsigned char 
# 387 "project/radare2/libr/util/buf.c"
    *tmp = 
# 387 "project/radare2/libr/util/buf.c" 3 4
           (unsigned char*)malloc(sizeof(unsigned char)*(
# 387 "project/radare2/libr/util/buf.c"
...
# 388 "project/radare2/libr/util/buf.c" 3 4
_Bool 
# 388 "project/radare2/libr/util/buf.c"
     res = 
# 388 "project/radare2/libr/util/buf.c" 3 4
           0
# 388 "project/radare2/libr/util/buf.c"
 ...
 if (!tmp) {
  return 
# 391 "project/radare2/libr/util/buf.c" 3 4
        0
# 391 "project/radare2/libr/util/buf.c"
             ;
 }
 
# 393 "project/radare2/libr/util/buf.c" 3 4
long long 
# 393 "project/radare2/libr/util/buf.c"
     r = r_buf_read_at (a, offset, tmp, size);
 if (r < 0) {
  goto err;
 }
...
# 406 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) 
# 406 "project/radare2/libr/util/buf.c"
     char *r_buf_get_string(RBuffer *b, 
# 406 "project/radare2/libr/util/buf.c" 3 4
                                        unsigned long long 
# 406 "project/radare2/libr/util/buf.c"
                                             addr) {
...
# 408 "project/radare2/libr/util/buf.c" 3 4
unsigned char 
# 408 "project/radare2/libr/util/buf.c"
    *res = 
# 408 "project/radare2/libr/util/buf.c" 3 4
           (unsigned char*)malloc(sizeof(unsigned char)*(
# 408 "project/radare2/libr/util/buf.c"
...
# 409 "project/radare2/libr/util/buf.c" 3 4
unsigned long long 
# 409 "project/radare2/libr/util/buf.c"
     sz = 0;
 
# 410 "project/radare2/libr/util/buf.c" 3 4
long long 
# 410 "project/radare2/libr/util/buf.c"
     r = r_buf_read_at (b, addr, res, MIN_RES_SZ);
 
# 411 "project/radare2/libr/util/buf.c" 3 4
_Bool 
# 411 "project/radare2/libr/util/buf.c"
     null_found = 
# 411 "project/radare2/libr/util/buf.c" 3 4
                  0
# 411 "project/radare2/libr/util/buf.c"
 ...
 while (r > 0) {
  const 
# 413 "project/radare2/libr/util/buf.c" 3 4
       unsigned char 
# 413 "project/radare2/libr/util/buf.c"
           *needle = r_mem_mem (res + sz, r, (
# 413 "project/radare2/libr/util/buf.c" 3 4
                                              unsigned char 
# 413 "project/radare2/libr/util/buf.c"
                                                  *)"\x00", 1);
  if (needle) {
   null_found = 
# 415 "project/radare2/libr/util/buf.c" 3 4
               1
# 415 "project/radare2/libr/util/buf.c"
                   ;
   break;
  }
  sz += r;
...
# 421 "project/radare2/libr/util/buf.c" 3 4
 unsigned char 
# 421 "project/radare2/libr/util/buf.c"
     *restmp = realloc (res, sz + MIN_RES_SZ + 1);
  if (!restmp) {
   free (res);
   return 
# 424 "project/radare2/libr/util/buf.c" 3 4
         ((void *)0)
# 424 "project/radare2/libr/util/buf.c"
             ;
  }
  res = restmp;
 ...
 if (r < 0 || !null_found) {
  free (res);
  return 
# 431 "project/radare2/libr/util/buf.c" 3 4
        ((void *)0)
# 431 "project/radare2/libr/util/buf.c"
            ;
 }
 return (char *)res;
}
...
# 436 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 436 "project/radare2/libr/util/buf.c"
         *r_buf_read_all(RBuffer *b, int *blen) {
 
# 437 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 437 "project/radare2/libr/util/buf.c"
b
# 437 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 437 "project/radare2/libr/util/buf.c"
"b"
# 437 "project/radare2/libr/util/buf.c" 3 4
, 437); return (((void *)0)); } } while (0)
# 437 "project/radare2/libr/util/buf.c"
                              ;
 int buflen = r_buf_size (b);
 if (buflen < 0) {
  return 
# 440 "project/radare2/libr/util/buf.c" 3 4
        ((void *)0)
# 440 "project/radare2/libr/util/buf.c"
            ;
 }
 
# 442 "project/radare2/libr/util/buf.c" 3 4
unsigned char 
# 442 "project/radare2/libr/util/buf.c"
    *buf = malloc (buflen + 1);
 buf_seek (b, 0, 
# 443 "project/radare2/libr/util/buf.c" 3 4
                0
# 443 "project/radare2/libr/util/buf.c"
                         );
...
# 451 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) long long 
# 451 "project/radare2/libr/util/buf.c"
          r_buf_read(RBuffer *b, 
# 451 "project/radare2/libr/util/buf.c" 3 4
                                 unsigned char 
# 451 "project/radare2/libr/util/buf.c"
                                     *buf, 
...
# 452 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 452 "project/radare2/libr/util/buf.c"
b && buf
# 452 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 452 "project/radare2/libr/util/buf.c"
...
# 453 "project/radare2/libr/util/buf.c" 3 4
long long 
# 453 "project/radare2/libr/util/buf.c"
     r = buf_read (b, buf, len);
 if (r >= 0 && r < len) {
  
# 455 "project/radare2/libr/util/buf.c" 3 4
 __builtin___memset_chk (
# 455 "project/radare2/libr/util/buf.c"
 buf + r
# 455 "project/radare2/libr/util/buf.c" 3 4
 , 
# 455 "project/radare2/libr/util/buf.c"
...
# 460 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) long long 
# 460 "project/radare2/libr/util/buf.c"
          r_buf_write(RBuffer *b, const 
# 460 "project/radare2/libr/util/buf.c" 3 4
                                        unsigned char 
# 460 "project/radare2/libr/util/buf.c"
                                            *buf, 
...
# 461 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 461 "project/radare2/libr/util/buf.c"
b && buf && !b->readonly
# 461 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 461 "project/radare2/libr/util/buf.c"
...
# 465 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 465 "project/radare2/libr/util/buf.c"
         r_buf_read8(RBuffer *b) {
 
# 466 "project/radare2/libr/util/buf.c" 3 4
unsigned char 
# 466 "project/radare2/libr/util/buf.c"
    res;
 
# 467 "project/radare2/libr/util/buf.c" 3 4
long long 
# 467 "project/radare2/libr/util/buf.c"
     r = r_buf_read (b, &res, sizeof (res));
 return r == sizeof (res)? res: b->Oxff_priv;
}


# 471 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 471 "project/radare2/libr/util/buf.c"
         r_buf_read8_at(RBuffer *b, 
# 471 "project/radare2/libr/util/buf.c" 3 4
                                    unsigned long long 
# 471 "project/radare2/libr/util/buf.c"
                                         addr) {
 
# 472 "project/radare2/libr/util/buf.c" 3 4
unsigned char 
# 472 "project/radare2/libr/util/buf.c"
    res;
 
# 473 "project/radare2/libr/util/buf.c" 3 4
long long 
# 473 "project/radare2/libr/util/buf.c"
     r = r_buf_read_at (b, addr, &res, sizeof (res));
 return r == sizeof (res)? res: b->Oxff_priv;
}

static 
# 477 "project/radare2/libr/util/buf.c" 3 4
      long long 
# 477 "project/radare2/libr/util/buf.c"
           buf_format(RBuffer *dst, RBuffer *src, const char *fmt, int n) {
 
# 478 "project/radare2/libr/util/buf.c" 3 4
long long 
# 478 "project/radare2/libr/util/buf.c"
     res = 0;
 int i;
 for (i = 0; i < n; i++) {
  int j;
...
# 484 "project/radare2/libr/util/buf.c" 3 4
 _Bool 
# 484 "project/radare2/libr/util/buf.c"
      bigendian = 
# 484 "project/radare2/libr/util/buf.c" 3 4
                  1
# 484 "project/radare2/libr/util/buf.c"
  ...
  for (j = 0; fmt[j]; j++) {
   ...
   case '9':
    if (m == 1) {
     m = r_num_get (
# 499 "project/radare2/libr/util/buf.c" 3 4
                   ((void *)0)
# 499 "project/radare2/libr/util/buf.c"
                       , &fmt[j]);
    }
    continue;
   case 's': tsize = 2; bigendian = 
# 502 "project/radare2/libr/util/buf.c" 3 4
                                   0
# 502 "project/radare2/libr/util/buf.c"
                                        ; break;
   case 'S': tsize = 2; bigendian = 
# 503 "project/radare2/libr/util/buf.c" 3 4
                                   1
# 503 "project/radare2/libr/util/buf.c"
                                       ; break;
   case 'i': tsize = 4; bigendian = 
# 504 "project/radare2/libr/util/buf.c" 3 4
                                   0
# 504 "project/radare2/libr/util/buf.c"
                                        ; break;
   case 'I': tsize = 4; bigendian = 
# 505 "project/radare2/libr/util/buf.c" 3 4
                                   1
# 505 "project/radare2/libr/util/buf.c"
                                       ; break;
   case 'l': tsize = 8; bigendian = 
# 506 "project/radare2/libr/util/buf.c" 3 4
                                   0
# 506 "project/radare2/libr/util/buf.c"
                                        ; break;
   case 'L': tsize = 8; bigendian = 
# 507 "project/radare2/libr/util/buf.c" 3 4
                                   1
# 507 "project/radare2/libr/util/buf.c"
                                       ; break;
   case 'c': tsize = 1; bigendian = 
# 508 "project/radare2/libr/util/buf.c" 3 4
                                   0
# 508 "project/radare2/libr/util/buf.c"
                                        ; break;
   default: return -1;
   }
...
# 514 "project/radare2/libr/util/buf.c" 3 4
   unsigned char 
# 514 "project/radare2/libr/util/buf.c"
       tmp[sizeof (
# 514 "project/radare2/libr/util/buf.c" 3 4
                   unsigned long long
# 514 "project/radare2/libr/util/buf.c"
...
# 515 "project/radare2/libr/util/buf.c" 3 4
   unsigned char 
# 515 "project/radare2/libr/util/buf.c"
       d1;
    
# 516 "project/radare2/libr/util/buf.c" 3 4
   unsigned short 
# 516 "project/radare2/libr/util/buf.c"
        d2;
    
# 517 "project/radare2/libr/util/buf.c" 3 4
   unsigned int 
# 517 "project/radare2/libr/util/buf.c"
        d3;
    
# 518 "project/radare2/libr/util/buf.c" 3 4
   unsigned long long 
# 518 "project/radare2/libr/util/buf.c"
        d4;
    
# 519 "project/radare2/libr/util/buf.c" 3 4
   long long 
# 519 "project/radare2/libr/util/buf.c"
    ...
    case 1:
     d1 = r_read_ble8 (tmp);
     r = r_buf_write (dst, (
# 527 "project/radare2/libr/util/buf.c" 3 4
                           unsigned char 
# 527 "project/radare2/libr/util/buf.c"
                               *)&d1, 1);
     break;
    case 2:
     d2 = r_read_ble16 (tmp, bigendian);
     r = r_buf_write (dst, (
# 531 "project/radare2/libr/util/buf.c" 3 4
                           unsigned char 
# 531 "project/radare2/libr/util/buf.c"
                               *)&d2, 2);
     break;
    case 4:
     d3 = r_read_ble32 (tmp, bigendian);
     r = r_buf_write (dst, (
# 535 "project/radare2/libr/util/buf.c" 3 4
                           unsigned char 
# 535 "project/radare2/libr/util/buf.c"
                               *)&d3, 4);
     break;
    case 8:
     d4 = r_read_ble64 (tmp, bigendian);
     r = r_buf_write (dst, (
# 539 "project/radare2/libr/util/buf.c" 3 4
                           unsigned char 
# 539 "project/radare2/libr/util/buf.c"
                               *)&d4, 8);
     break;
    }
    if (r < 0) {
...
# 553 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) long long 
# 553 "project/radare2/libr/util/buf.c"
          r_buf_fread(RBuffer *b, 
# 553 "project/radare2/libr/util/buf.c" 3 4
                                  unsigned char 
# 553 "project/radare2/libr/util/buf.c"
                                      *buf, const char *fmt, int n) {
 
# 554 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 554 "project/radare2/libr/util/buf.c"
b && buf && fmt
# 554 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 554 "project/radare2/libr/util/buf.c"
...
# 554 "project/radare2/libr/util/buf.c"
 ...
 RBuffer *dst = r_buf_new_with_pointers (buf, 
# 556 "project/radare2/libr/util/buf.c" 3 4
                                             0xFFFFFFFFFFFFFFFFULL
# 556 "project/radare2/libr/util/buf.c"
                                                     , 
# 556 "project/radare2/libr/util/buf.c" 3 4
                                                       0
# 556 "project/radare2/libr/util/buf.c"
...
# 557 "project/radare2/libr/util/buf.c" 3 4
long long 
# 557 "project/radare2/libr/util/buf.c"
     res = buf_format (dst, b, fmt, n);
 r_buf_free (dst);
 return res;
}


# 562 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) long long 
# 562 "project/radare2/libr/util/buf.c"
          r_buf_fread_at(RBuffer *b, 
# 562 "project/radare2/libr/util/buf.c" 3 4
                                     unsigned long long 
# 562 "project/radare2/libr/util/buf.c"
                                          addr, 
...
# 563 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 563 "project/radare2/libr/util/buf.c"
b && buf && fmt
# 563 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 563 "project/radare2/libr/util/buf.c"
...
# 564 "project/radare2/libr/util/buf.c" 3 4
long long 
# 564 "project/radare2/libr/util/buf.c"
     o_addr = r_buf_seek (b, 0, 
# 564 "project/radare2/libr/util/buf.c" 3 4
                                1
# 564 "project/radare2/libr/util/buf.c"
                                         );
 
# 565 "project/radare2/libr/util/buf.c" 3 4
long long 
# 565 "project/radare2/libr/util/buf.c"
     r = r_buf_seek (b, addr, 
# 565 "project/radare2/libr/util/buf.c" 3 4
                              0
# 565 "project/radare2/libr/util/buf.c"
 ...
 r_buf_seek (b, o_addr, 
# 570 "project/radare2/libr/util/buf.c" 3 4
                       0
# 570 "project/radare2/libr/util/buf.c"
                                );
 return r;
}


# 574 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) long long 
# 574 "project/radare2/libr/util/buf.c"
          r_buf_fwrite(RBuffer *b, const 
# 574 "project/radare2/libr/util/buf.c" 3 4
                                         unsigned char 
# 574 "project/radare2/libr/util/buf.c"
                                             *buf, const char *fmt, int n) {
 
# 575 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 575 "project/radare2/libr/util/buf.c"
b && buf && fmt && !b->readonly
# 575 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 575 "project/radare2/libr/util/buf.c"
"b && buf && fmt && !b->readonly"
...
# 575 "project/radare2/libr/util/buf.c"
 ...
 RBuffer *src = r_buf_new_with_pointers (buf, 
# 577 "project/radare2/libr/util/buf.c" 3 4
                                             0xFFFFFFFFFFFFFFFFULL
# 577 "project/radare2/libr/util/buf.c"
                                                     , 
# 577 "project/radare2/libr/util/buf.c" 3 4
                                                       0
# 577 "project/radare2/libr/util/buf.c"
...
# 578 "project/radare2/libr/util/buf.c" 3 4
long long 
# 578 "project/radare2/libr/util/buf.c"
     res = buf_format (b, src, fmt, n);
 r_buf_free (src);
 return res;
}


# 583 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) long long 
# 583 "project/radare2/libr/util/buf.c"
          r_buf_fwrite_at(RBuffer *b, 
# 583 "project/radare2/libr/util/buf.c" 3 4
                                      unsigned long long 
# 583 "project/radare2/libr/util/buf.c"
                                           addr, const 
...
# 584 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 584 "project/radare2/libr/util/buf.c"
b && buf && fmt && !b->readonly
# 584 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 584 "project/radare2/libr/util/buf.c"
...
# 585 "project/radare2/libr/util/buf.c" 3 4
long long 
# 585 "project/radare2/libr/util/buf.c"
     o_addr = r_buf_seek (b, 0, 
# 585 "project/radare2/libr/util/buf.c" 3 4
                                1
# 585 "project/radare2/libr/util/buf.c"
...
# 586 "project/radare2/libr/util/buf.c" 3 4
long long 
# 586 "project/radare2/libr/util/buf.c"
     r = r_buf_seek (b, addr, 
# 586 "project/radare2/libr/util/buf.c" 3 4
                              0
# 586 "project/radare2/libr/util/buf.c"
 ...
 r_buf_seek (b, o_addr, 
# 591 "project/radare2/libr/util/buf.c" 3 4
                       0
# 591 "project/radare2/libr/util/buf.c"
                                );
 return r;
}


# 595 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) long long 
# 595 "project/radare2/libr/util/buf.c"
          r_buf_read_at(RBuffer *b, 
# 595 "project/radare2/libr/util/buf.c" 3 4
                                    unsigned long long 
# 595 "project/radare2/libr/util/buf.c"
                                         addr, 
...
# 596 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 596 "project/radare2/libr/util/buf.c"
b && buf
# 596 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 596 "project/radare2/libr/util/buf.c"
...
# 597 "project/radare2/libr/util/buf.c" 3 4
long long 
# 597 "project/radare2/libr/util/buf.c"
     o_addr = r_buf_seek (b, 0, 
# 597 "project/radare2/libr/util/buf.c" 3 4
                                1
# 597 "project/radare2/libr/util/buf.c"
...
# 598 "project/radare2/libr/util/buf.c" 3 4
long long 
# 598 "project/radare2/libr/util/buf.c"
     r = r_buf_seek (b, addr, 
# 598 "project/radare2/libr/util/buf.c" 3 4
                              0
# 598 "project/radare2/libr/util/buf.c"
 ...
 r_buf_seek (b, o_addr, 
# 604 "project/radare2/libr/util/buf.c" 3 4
                       0
# 604 "project/radare2/libr/util/buf.c"
                                );
 return r;
}


# 608 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) long long 
# 608 "project/radare2/libr/util/buf.c"
          r_buf_write_at(RBuffer *b, 
# 608 "project/radare2/libr/util/buf.c" 3 4
                                     unsigned long long 
# 608 "project/radare2/libr/util/buf.c"
                                          addr, const 
...
# 609 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 609 "project/radare2/libr/util/buf.c"
b && buf && !b->readonly
# 609 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 609 "project/radare2/libr/util/buf.c"
...
# 610 "project/radare2/libr/util/buf.c" 3 4
long long 
# 610 "project/radare2/libr/util/buf.c"
     o_addr = r_buf_seek (b, 0, 
# 610 "project/radare2/libr/util/buf.c" 3 4
                                1
# 610 "project/radare2/libr/util/buf.c"
...
# 611 "project/radare2/libr/util/buf.c" 3 4
long long 
# 611 "project/radare2/libr/util/buf.c"
     r = r_buf_seek (b, addr, 
# 611 "project/radare2/libr/util/buf.c" 3 4
                              0
# 611 "project/radare2/libr/util/buf.c"
 ...
 r_buf_seek (b, o_addr, 
# 617 "project/radare2/libr/util/buf.c" 3 4
                       0
# 617 "project/radare2/libr/util/buf.c"
                                );
 return r;
}


# 621 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) 
# 621 "project/radare2/libr/util/buf.c"
     void r_buf_fini(RBuffer *b) {
 if (!b) {
  return;
 }
 if (b->refctr > 0) {
...
# 641 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) 
# 641 "project/radare2/libr/util/buf.c"
     void r_buf_free(RBuffer *b) {
 
# 642 "project/radare2/libr/util/buf.c" 3 4
_Bool 
# 642 "project/radare2/libr/util/buf.c"
     unreferenced = b && b->refctr == 0;
 r_buf_fini (b);
 if (unreferenced) {
  free (b);
 }
...
# 649 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) long long 
# 649 "project/radare2/libr/util/buf.c"
          r_buf_append_string(RBuffer *b, const char *str) {
 
# 650 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 650 "project/radare2/libr/util/buf.c"
b && str && !b->readonly
# 650 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 650 "project/radare2/libr/util/buf.c"
"b && str && !b->readonly"
# 650 "project/radare2/libr/util/buf.c" 3 4
, 650); return (0); } } while (0)
# 650 "project/radare2/libr/util/buf.c"
                                                      ;
 return r_buf_append_bytes (b, (const 
# 651 "project/radare2/libr/util/buf.c" 3 4
                                     unsigned char 
# 651 "project/radare2/libr/util/buf.c"
                                         *)str, strlen (str));
}


# 654 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 654 "project/radare2/libr/util/buf.c"
          r_buf_resize(RBuffer *b, 
# 654 "project/radare2/libr/util/buf.c" 3 4
                                   unsigned long long 
# 654 "project/radare2/libr/util/buf.c"
                                        newsize) {
 
# 655 "project/radare2/libr/util/buf.c" 3 4
do { if (!(
# 655 "project/radare2/libr/util/buf.c"
b
# 655 "project/radare2/libr/util/buf.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 655 "project/radare2/libr/util/buf.c"
...
# 659 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) 
# 659 "project/radare2/libr/util/buf.c"
     RBuffer *r_buf_ref(RBuffer *b) {
 if (b) {
  b->refctr++;
 }
 return b;
...
# 666 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) 
# 666 "project/radare2/libr/util/buf.c"
     RList *r_buf_nonempty_list(RBuffer *b) {
 return b->methods->nonempty_list? b->methods->nonempty_list (b): 
# 667 "project/radare2/libr/util/buf.c" 3 4
                                                                 ((void *)0)
# 667 "project/radare2/libr/util/buf.c"
                                                                     ;
}


# 670 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) long long 
# 670 "project/radare2/libr/util/buf.c"
          r_buf_uleb128(RBuffer *b, 
# 670 "project/radare2/libr/util/buf.c" 3 4
                                    unsigned long long 
# 670 "project/radare2/libr/util/buf.c"
                                         *v) {
 
# 671 "project/radare2/libr/util/buf.c" 3 4
unsigned char 
# 671 "project/radare2/libr/util/buf.c"
    c = 0xff;
 
# 672 "project/radare2/libr/util/buf.c" 3 4
unsigned long long 
# 672 "project/radare2/libr/util/buf.c"
     s = 0, sum = 0, l = 0;
 do {
  
# 674 "project/radare2/libr/util/buf.c" 3 4
 unsigned char 
# 674 "project/radare2/libr/util/buf.c"
     data;
  
# 675 "project/radare2/libr/util/buf.c" 3 4
 long long 
# 675 "project/radare2/libr/util/buf.c"
      r = r_buf_read (b, &data, sizeof (data));
  if (r < 1) {
   return -1;
  }
  c = data & 0xff;
  if (s < 64) {
   sum |= ((
# 681 "project/radare2/libr/util/buf.c" 3 4
           unsigned long long
# 681 "project/radare2/libr/util/buf.c"
               ) (c & 0x7f) << s);
   s += 7;
  } else {
   sum = 0;
...
# 694 "project/radare2/libr/util/buf.c" 3 4
__attribute__((visibility("default"))) long long 
# 694 "project/radare2/libr/util/buf.c"
          r_buf_sleb128(RBuffer *b, 
# 694 "project/radare2/libr/util/buf.c" 3 4
                                    long long 
# 694 "project/radare2/libr/util/buf.c"
                                         *v) {
 
# 695 "project/radare2/libr/util/buf.c" 3 4
long long 
# 695 "project/radare2/libr/util/buf.c"
     result = 0, offset = 0;
 
# 696 "project/radare2/libr/util/buf.c" 3 4
unsigned char 
# 696 "project/radare2/libr/util/buf.c"
    value;
 do {
  
# 698 "project/radare2/libr/util/buf.c" 3 4
 long long 
# 698 "project/radare2/libr/util/buf.c"
      chunk;
  
# 699 "project/radare2/libr/util/buf.c" 3 4
 long long 
# 699 "project/radare2/libr/util/buf.c"
      r = r_buf_read (b, &value, sizeof (value));
  if (r != sizeof (value)) {
   return -1;
  }
  chunk = value & 0x7f;
