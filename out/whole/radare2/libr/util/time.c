# 0 "project/radare2/libr/util/time.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/time.c"
...
# 4 "project/radare2/libr/util/time.c" 2
...
# 5 "project/radare2/libr/util/time.c" 2
...
# 12 "project/radare2/libr/util/time.c"
          r_time_now(void) {
 
# 13 "project/radare2/libr/util/time.c" 3 4
unsigned long long 
# 13 "project/radare2/libr/util/time.c"
     ret;
 struct timeval now;
 ...
 gettimeofday (&now, 
# 18 "project/radare2/libr/util/time.c" 3 4
                    ((void *)0)
# 18 "project/radare2/libr/util/time.c"
                        );

 ret = now.tv_sec * 
# 20 "project/radare2/libr/util/time.c" 3 4
                   1000000ULL
# 20 "project/radare2/libr/util/time.c"
                                 ;
 ret += now.tv_usec;
 return ret;
}
...
# 25 "project/radare2/libr/util/time.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 25 "project/radare2/libr/util/time.c"
          r_time_now_mono(void) {
# 49 "project/radare2/libr/util/time.c"
 return r_time_now ();

}


# 53 "project/radare2/libr/util/time.c" 3 4
__attribute__((visibility("default"))) 
# 53 "project/radare2/libr/util/time.c"
     char *r_time_stamp_to_str(
# 53 "project/radare2/libr/util/time.c" 3 4
                               unsigned int 
# 53 "project/radare2/libr/util/time.c"
                                    timeStamp) {
# 62 "project/radare2/libr/util/time.c"
 struct my_timezone {
  int tz_minuteswest;
  int tz_dsttime;
 } tz;
 ...
 ts += (time_t)gmtoff;
 char *res = malloc(
# 72 "project/radare2/libr/util/time.c" 3 4
                   (26)
# 72 "project/radare2/libr/util/time.c"
                                     );
 if (res) {
  ctime_r (&ts, res);
  r_str_trim (res);
...
# 81 "project/radare2/libr/util/time.c" 3 4
__attribute__((visibility("default"))) unsigned int 
# 81 "project/radare2/libr/util/time.c"
          r_time_dos_time_stamp_to_posix(
# 81 "project/radare2/libr/util/time.c" 3 4
                                         unsigned int 
# 81 "project/radare2/libr/util/time.c"
                                              timeStamp) {
 
# 82 "project/radare2/libr/util/time.c" 3 4
unsigned short 
# 82 "project/radare2/libr/util/time.c"
     date = timeStamp >> 16;
 
# 83 "project/radare2/libr/util/time.c" 3 4
unsigned short 
# 83 "project/radare2/libr/util/time.c"
     time = timeStamp & 0xFFFF;


 
# 86 "project/radare2/libr/util/time.c" 3 4
unsigned int 
# 86 "project/radare2/libr/util/time.c"
     year = ((date & 0xfe00) >> 9) + 1980;
 
# 87 "project/radare2/libr/util/time.c" 3 4
unsigned int 
# 87 "project/radare2/libr/util/time.c"
     month = (date & 0x01e0) >> 5;
 
# 88 "project/radare2/libr/util/time.c" 3 4
unsigned int 
# 88 "project/radare2/libr/util/time.c"
     day = date & 0x001f;


 
# 91 "project/radare2/libr/util/time.c" 3 4
unsigned int 
# 91 "project/radare2/libr/util/time.c"
     hour = (time & 0xf800) >> 11;
 
# 92 "project/radare2/libr/util/time.c" 3 4
unsigned int 
# 92 "project/radare2/libr/util/time.c"
     minutes = (time & 0x07e0) >> 5;
 
# 93 "project/radare2/libr/util/time.c" 3 4
unsigned int 
# 93 "project/radare2/libr/util/time.c"
 ...
 return (
# 106 "project/radare2/libr/util/time.c" 3 4
        unsigned int
# 106 "project/radare2/libr/util/time.c"
            ) epochTime;
}


# 109 "project/radare2/libr/util/time.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 109 "project/radare2/libr/util/time.c"
          r_time_stamp_is_dos_format(const 
# 109 "project/radare2/libr/util/time.c" 3 4
                                           unsigned int 
# 109 "project/radare2/libr/util/time.c"
                                                certainPosixTimeStamp, const 
# 109 "project/radare2/libr/util/time.c" 3 4
                                                                             unsigned int 
# 109 "project/radare2/libr/util/time.c"
                                                                                  possiblePosixOrDosTimeStamp) {

 if ((certainPosixTimeStamp >> 16) == (possiblePosixOrDosTimeStamp >> 16)) {
  return 
# 112 "project/radare2/libr/util/time.c" 3 4
        0
# 112 "project/radare2/libr/util/time.c"
             ;
 }
 return 
# 114 "project/radare2/libr/util/time.c" 3 4
       1
# 114 "project/radare2/libr/util/time.c"
           ;
}



# 118 "project/radare2/libr/util/time.c" 3 4
__attribute__((visibility("default"))) 
# 118 "project/radare2/libr/util/time.c"
     int r_print_date_dos(RPrint *p, const 
# 118 "project/radare2/libr/util/time.c" 3 4
                                           unsigned char 
# 118 "project/radare2/libr/util/time.c"
                                               *buf, int len) {
...
# 123 "project/radare2/libr/util/time.c" 3 4
unsigned int 
# 123 "project/radare2/libr/util/time.c"
     dt = buf[3] << 24 | buf[2] << 16 | buf[1] << 8 | buf[0];
...
# 133 "project/radare2/libr/util/time.c" 3 4
__attribute__((visibility("default"))) 
# 133 "project/radare2/libr/util/time.c"
     int r_print_date_hfs(RPrint *p, const 
# 133 "project/radare2/libr/util/time.c" 3 4
                                           unsigned char 
# 133 "project/radare2/libr/util/time.c"
                                               *buf, int len) {
 ...
 if (p && len >= sizeof (
# 138 "project/radare2/libr/util/time.c" 3 4
                        unsigned int
# 138 "project/radare2/libr/util/time.c"
                            )) {
...
# 151 "project/radare2/libr/util/time.c" 3 4
__attribute__((visibility("default"))) 
# 151 "project/radare2/libr/util/time.c"
     int r_print_date_unix(RPrint *p, const 
# 151 "project/radare2/libr/util/time.c" 3 4
                                            unsigned char 
# 151 "project/radare2/libr/util/time.c"
                                                *buf, int len) {
 ...
 if (p && len >= sizeof (
# 155 "project/radare2/libr/util/time.c" 3 4
                        unsigned int
# 155 "project/radare2/libr/util/time.c"
                            )) {
  t = r_read_ble32 (buf, p->big_endian);
  if (p->datefmt[0]) {
   t += p->datezone * (60*60);
...
# 170 "project/radare2/libr/util/time.c" 3 4
__attribute__((visibility("default"))) 
# 170 "project/radare2/libr/util/time.c"
     int r_print_date_get_now(RPrint *p, char *str) {
 int ret = 0;
 time_t l;
...
# 183 "project/radare2/libr/util/time.c" 3 4
__attribute__((visibility("default"))) 
# 183 "project/radare2/libr/util/time.c"
     int r_print_date_w32(RPrint *p, const 
# 183 "project/radare2/libr/util/time.c" 3 4
                                           unsigned char 
# 183 "project/radare2/libr/util/time.c"
                                               *buf, int len) {
 
# 184 "project/radare2/libr/util/time.c" 3 4
unsigned long long 
# 184 "project/radare2/libr/util/time.c"
     l, L = 0x2b6109100LL;
 time_t t;
 int ret = 0;

 if (p && len >= sizeof (
# 188 "project/radare2/libr/util/time.c" 3 4
                        unsigned long long
# 188 "project/radare2/libr/util/time.c"
                            )) {
...
# 202 "project/radare2/libr/util/time.c" 3 4
__attribute__((visibility("default"))) 
# 202 "project/radare2/libr/util/time.c"
     const char *r_time_to_string(
# 202 "project/radare2/libr/util/time.c" 3 4
                                  unsigned long long 
# 202 "project/radare2/libr/util/time.c"
                                       ts) {
...
# 207 "project/radare2/libr/util/time.c" 3 4
__attribute__((visibility("default"))) 
# 207 "project/radare2/libr/util/time.c"
     char *r_asctime_r(const struct tm *tm, char *buf) {
...
# 216 "project/radare2/libr/util/time.c" 3 4
__attribute__((visibility("default"))) 
# 216 "project/radare2/libr/util/time.c"
     char *r_ctime_r(const time_t *timer, char *buf) {
