# 0 "project/radare2/libr/util/astr.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/astr.c"
...
# 4 "project/radare2/libr/util/astr.c" 2
# 1 "project/radare2/libr/util/asn1_oids.h" 1
...
# 8 "project/radare2/libr/util/asn1_oids.h"
struct r_oid_list_t {
 const char* oid;
 const char* name;
} X509OIDList [] = {
...
# 5 "project/radare2/libr/util/astr.c" 2

static const char* _hex = "0123456789abcdef";


# 8 "project/radare2/libr/util/astr.c" 3 4
__attribute__((visibility("default"))) 
# 8 "project/radare2/libr/util/astr.c"
     RASN1String *r_asn1_create_string (const char *string, 
# 8 "project/radare2/libr/util/astr.c" 3 4
                                                            _Bool 
# 8 "project/radare2/libr/util/astr.c"
                                                                 allocated, 
...
# 8 "project/radare2/libr/util/astr.c"
 ...
 if (!string || !length) {
  return 
# 10 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 10 "project/radare2/libr/util/astr.c"
            ;
 }
 RASN1String *s = 
# 12 "project/radare2/libr/util/astr.c" 3 4
                 (
# 12 "project/radare2/libr/util/astr.c"
                 RASN1String
# 12 "project/radare2/libr/util/astr.c" 3 4
                 *)calloc(1,sizeof(
# 12 "project/radare2/libr/util/astr.c"
...
static RASN1String *newstr(const char *string) {
 return r_asn1_create_string (string, 
# 22 "project/radare2/libr/util/astr.c" 3 4
                                     0
# 22 "project/radare2/libr/util/astr.c"
                                          , strlen (string) + 1);
}


# 25 "project/radare2/libr/util/astr.c" 3 4
__attribute__((visibility("default"))) 
# 25 "project/radare2/libr/util/astr.c"
     RASN1String *r_asn1_concatenate_strings (RASN1String *s0, RASN1String *s1, 
# 25 "project/radare2/libr/util/astr.c" 3 4
                                                                                _Bool 
# 25 "project/radare2/libr/util/astr.c"
                                                                                     freestr) {
...
# 27 "project/radare2/libr/util/astr.c" 3 4
unsigned int 
# 27 "project/radare2/libr/util/astr.c"
     len;
 if (!s0 || !s1 || s0->length == 0 || s1->length == 0) {
  return 
# 29 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 29 "project/radare2/libr/util/astr.c"
            ;
 }
 ...
 if (!str) {
  ...
  return 
# 38 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 38 "project/radare2/libr/util/astr.c"
            ;
 }
 
# 40 "project/radare2/libr/util/astr.c" 3 4
__builtin___memcpy_chk (
# 40 "project/radare2/libr/util/astr.c"
str
# 40 "project/radare2/libr/util/astr.c" 3 4
, 
# 40 "project/radare2/libr/util/astr.c"
...
# 41 "project/radare2/libr/util/astr.c" 3 4
__builtin___memcpy_chk (
# 41 "project/radare2/libr/util/astr.c"
str + s0->length - 1
# 41 "project/radare2/libr/util/astr.c" 3 4
, 
# 41 "project/radare2/libr/util/astr.c"
...
# 41 "project/radare2/libr/util/astr.c"
 ...
 RASN1String *res = r_asn1_create_string (str, 
# 46 "project/radare2/libr/util/astr.c" 3 4
                                              1
# 46 "project/radare2/libr/util/astr.c"
                                                  , len);
 if (!res) {
  free (str);
 }
...
# 53 "project/radare2/libr/util/astr.c" 3 4
__attribute__((visibility("default"))) 
# 53 "project/radare2/libr/util/astr.c"
     RASN1String *r_asn1_stringify_string(const 
# 53 "project/radare2/libr/util/astr.c" 3 4
                                                unsigned char 
# 53 "project/radare2/libr/util/astr.c"
                                                    *buffer, 
...
# 53 "project/radare2/libr/util/astr.c"
 ...
 if (!buffer || length < 1) {
  return 
# 55 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 55 "project/radare2/libr/util/astr.c"
            ;
 }
 char *str = r_str_ndup ((const char *)buffer, length);
 if (!str) {
  return 
# 59 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 59 "project/radare2/libr/util/astr.c"
            ;
 }
 int str_len = strlen (str);
 r_str_filter (str, str_len);
 return r_asn1_create_string (str, 
# 63 "project/radare2/libr/util/astr.c" 3 4
                                  1
# 63 "project/radare2/libr/util/astr.c"
                                      , str_len);
}


# 66 "project/radare2/libr/util/astr.c" 3 4
__attribute__((visibility("default"))) 
# 66 "project/radare2/libr/util/astr.c"
     RASN1String *r_asn1_stringify_utctime (const 
# 66 "project/radare2/libr/util/astr.c" 3 4
                                                  unsigned char 
# 66 "project/radare2/libr/util/astr.c"
                                                      *buffer, 
...
# 66 "project/radare2/libr/util/astr.c"
 ...
 if (!buffer || length != 13 || buffer[12] != 'Z') {
  return 
# 68 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 68 "project/radare2/libr/util/astr.c"
            ;
 }
 const int str_sz = 24;
 ...
 if (!str) {
  return 
# 73 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 73 "project/radare2/libr/util/astr.c"
            ;
 }
 str[0] = buffer[4];
 str[1] = buffer[5];
 ...
 RASN1String* asn1str = r_asn1_create_string (str, 
# 100 "project/radare2/libr/util/astr.c" 3 4
                                                  1
# 100 "project/radare2/libr/util/astr.c"
                                                      , str_sz);
 if (!asn1str) {
  free (str);
 }
...
# 107 "project/radare2/libr/util/astr.c" 3 4
__attribute__((visibility("default"))) 
# 107 "project/radare2/libr/util/astr.c"
     RASN1String *r_asn1_stringify_time(const 
# 107 "project/radare2/libr/util/astr.c" 3 4
                                              unsigned char 
# 107 "project/radare2/libr/util/astr.c"
                                                  *buffer, 
...
# 107 "project/radare2/libr/util/astr.c"
 ...
 if (!buffer || length != 15 || buffer[14] != 'Z') {
  return 
# 109 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 109 "project/radare2/libr/util/astr.c"
            ;
 }
 const int str_sz = 24;
 char *str = malloc (str_sz);
 if (!str) {
  return 
# 114 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 114 "project/radare2/libr/util/astr.c"
            ;
 }
 ...
 RASN1String* asn1str = r_asn1_create_string (str, 
# 142 "project/radare2/libr/util/astr.c" 3 4
                                                  1
# 142 "project/radare2/libr/util/astr.c"
                                                      , str_sz);
 if (!asn1str) {
  free (str);
 }
...
# 149 "project/radare2/libr/util/astr.c" 3 4
__attribute__((visibility("default"))) 
# 149 "project/radare2/libr/util/astr.c"
     RASN1String *r_asn1_stringify_bits (const 
# 149 "project/radare2/libr/util/astr.c" 3 4
                                               unsigned char 
# 149 "project/radare2/libr/util/astr.c"
                                                   *buffer, 
...
# 150 "project/radare2/libr/util/astr.c" 3 4
unsigned int 
# 150 "project/radare2/libr/util/astr.c"
     i, j, k;
 
# 151 "project/radare2/libr/util/astr.c" 3 4
unsigned long long 
# 151 "project/radare2/libr/util/astr.c"
     size;
 
# 152 "project/radare2/libr/util/astr.c" 3 4
unsigned char 
# 152 "project/radare2/libr/util/astr.c"
    c;
 char *str;
 if (!buffer || !length) {
  return 
# 155 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 155 "project/radare2/libr/util/astr.c"
            ;
 }
 ...
 if (!str) {
  return 
# 160 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 160 "project/radare2/libr/util/astr.c"
            ;
 }
 ...
 str[size - 1] = '\0';
 RASN1String* asn1str = r_asn1_create_string (str, 
# 170 "project/radare2/libr/util/astr.c" 3 4
                                                  1
# 170 "project/radare2/libr/util/astr.c"
                                                      , size);
 if (!asn1str) {
  free (str);
 }
...
# 177 "project/radare2/libr/util/astr.c" 3 4
__attribute__((visibility("default"))) 
# 177 "project/radare2/libr/util/astr.c"
     RASN1String *r_asn1_stringify_boolean (const 
# 177 "project/radare2/libr/util/astr.c" 3 4
                                                  unsigned char 
# 177 "project/radare2/libr/util/astr.c"
                                                      *buffer, 
...
# 177 "project/radare2/libr/util/astr.c"
 ...
 if (!buffer || length != 1 || (buffer[0] != 0 && buffer[0] != 0xFF)) {
  return 
# 179 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 179 "project/radare2/libr/util/astr.c"
            ;
 }
...
# 184 "project/radare2/libr/util/astr.c" 3 4
__attribute__((visibility("default"))) 
# 184 "project/radare2/libr/util/astr.c"
     RASN1String *r_asn1_stringify_integer (const 
# 184 "project/radare2/libr/util/astr.c" 3 4
                                                  unsigned char 
# 184 "project/radare2/libr/util/astr.c"
                                                      *buffer, 
...
# 185 "project/radare2/libr/util/astr.c" 3 4
unsigned int 
# 185 "project/radare2/libr/util/astr.c"
     i, j;
 
# 186 "project/radare2/libr/util/astr.c" 3 4
unsigned long long 
# 186 "project/radare2/libr/util/astr.c"
     size;
 
# 187 "project/radare2/libr/util/astr.c" 3 4
unsigned char 
# 187 "project/radare2/libr/util/astr.c"
    c;
 char *str;
 if (!buffer || !length) {
  return 
# 190 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 190 "project/radare2/libr/util/astr.c"
            ;
 }
 size = 3 * length;
 str = (char*) malloc (size);
 if (!str) {
  return 
# 195 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 195 "project/radare2/libr/util/astr.c"
            ;
 }
 
# 197 "project/radare2/libr/util/astr.c" 3 4
__builtin___memset_chk (
# 197 "project/radare2/libr/util/astr.c"
str
# 197 "project/radare2/libr/util/astr.c" 3 4
, 
# 197 "project/radare2/libr/util/astr.c"
...
# 197 "project/radare2/libr/util/astr.c"
 ...
 str[size - 1] = '\0';
 RASN1String* asn1str = r_asn1_create_string (str, 
# 205 "project/radare2/libr/util/astr.c" 3 4
                                                  1
# 205 "project/radare2/libr/util/astr.c"
                                                      , size);
 if (!asn1str) {
  free (str);
 }
...
# 212 "project/radare2/libr/util/astr.c" 3 4
__attribute__((visibility("default"))) 
# 212 "project/radare2/libr/util/astr.c"
     RASN1String* r_asn1_stringify_bytes(const 
# 212 "project/radare2/libr/util/astr.c" 3 4
                                               unsigned char 
# 212 "project/radare2/libr/util/astr.c"
                                                   *buffer, 
...
# 213 "project/radare2/libr/util/astr.c" 3 4
unsigned int 
# 213 "project/radare2/libr/util/astr.c"
     i, j, k;
 
# 214 "project/radare2/libr/util/astr.c" 3 4
unsigned long long 
# 214 "project/radare2/libr/util/astr.c"
     size;
 
# 215 "project/radare2/libr/util/astr.c" 3 4
unsigned char 
# 215 "project/radare2/libr/util/astr.c"
    c;
 char *str;
 if (!buffer || !length) {
  return 
# 218 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 218 "project/radare2/libr/util/astr.c"
            ;
 }
 size = (4 * length);
 size += (64 - (size % 64));
 ...
 if (!str) {
  return 
# 224 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 224 "project/radare2/libr/util/astr.c"
            ;
 }
 
# 226 "project/radare2/libr/util/astr.c" 3 4
__builtin___memset_chk (
# 226 "project/radare2/libr/util/astr.c"
str
# 226 "project/radare2/libr/util/astr.c" 3 4
, 
# 226 "project/radare2/libr/util/astr.c"
...
# 226 "project/radare2/libr/util/astr.c"
 ...
 str[size - 1] = '\0';
 RASN1String* asn1str = r_asn1_create_string (str, 
# 241 "project/radare2/libr/util/astr.c" 3 4
                                                  1
# 241 "project/radare2/libr/util/astr.c"
                                                      , size);
 if (!asn1str) {
  free (str);
 }
...
# 248 "project/radare2/libr/util/astr.c" 3 4
__attribute__((visibility("default"))) 
# 248 "project/radare2/libr/util/astr.c"
     RASN1String *r_asn1_stringify_oid (const 
# 248 "project/radare2/libr/util/astr.c" 3 4
                                              unsigned char
# 248 "project/radare2/libr/util/astr.c"
                                                 * buffer, 
...
# 248 "project/radare2/libr/util/astr.c"
                                                                length) {
 const 
# 249 "project/radare2/libr/util/astr.c" 3 4
      unsigned char 
# 249 "project/radare2/libr/util/astr.c"
          *start, *end;
 char *str, *t;
 
# 251 "project/radare2/libr/util/astr.c" 3 4
unsigned int 
# 251 "project/radare2/libr/util/astr.c"
     i, slen, bits;
 
# 252 "project/radare2/libr/util/astr.c" 3 4
unsigned long long 
# 252 "project/radare2/libr/util/astr.c"
     oid;
 if (!buffer || !length) {
  return 
# 254 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 254 "project/radare2/libr/util/astr.c"
            ;
 }

 str = (char*) calloc (1, 
# 257 "project/radare2/libr/util/astr.c" 3 4
                         64
# 257 "project/radare2/libr/util/astr.c"
                                     );
 if (!str) {
  return 
# 259 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 259 "project/radare2/libr/util/astr.c"
            ;
 }
 ...
 for (start = buffer; start < end && slen < 
# 268 "project/radare2/libr/util/astr.c" 3 4
                                           64
# 268 "project/radare2/libr/util/astr.c"
                                                       ; start++) {
  
# 269 "project/radare2/libr/util/astr.c" 3 4
 unsigned char 
# 269 "project/radare2/libr/util/astr.c"
     c = *start;
  oid <<= 7;
  oid |= (c & 0x7F);
  bits += 7;
...
# 275 "project/radare2/libr/util/astr.c" 3 4
   unsigned int 
# 275 "project/radare2/libr/util/astr.c"
        m = oid / 40;
    
# 276 "project/radare2/libr/util/astr.c" 3 4
   unsigned int 
# 276 "project/radare2/libr/util/astr.c"
        n = oid % 40;
    
# 277 "project/radare2/libr/util/astr.c" 3 4
   __builtin___snprintf_chk (
# 277 "project/radare2/libr/util/astr.c"
   t
# 277 "project/radare2/libr/util/astr.c" 3 4
   , 64, 0, __builtin_object_size (
# 277 "project/radare2/libr/util/astr.c"
   t
# 277 "project/radare2/libr/util/astr.c" 3 4
   , 2 > 1 ? 1 : 0), 
...
# 281 "project/radare2/libr/util/astr.c" 3 4
   __builtin___snprintf_chk (
# 281 "project/radare2/libr/util/astr.c"
   t
# 281 "project/radare2/libr/util/astr.c" 3 4
   , 64 
# 281 "project/radare2/libr/util/astr.c"
...
# 281 "project/radare2/libr/util/astr.c"
 ...
 if (bits > 0) {
  free (str);
  return 
# 293 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 293 "project/radare2/libr/util/astr.c"
            ;
 }
 i = 0;
 do {
  if (X509OIDList[i].oid[0] == str[0]) {
   if (!strncmp (str, X509OIDList[i].oid, 
# 298 "project/radare2/libr/util/astr.c" 3 4
                                         64
# 298 "project/radare2/libr/util/astr.c"
                                                     )) {
    free (str);
 ...
 RASN1String* asn1str = r_asn1_create_string (str, 
# 305 "project/radare2/libr/util/astr.c" 3 4
                                                  1
# 305 "project/radare2/libr/util/astr.c"
                                                      , 
# 305 "project/radare2/libr/util/astr.c" 3 4
                                                        64
# 305 "project/radare2/libr/util/astr.c"
...
# 312 "project/radare2/libr/util/astr.c" 3 4
__attribute__((visibility("default"))) 
# 312 "project/radare2/libr/util/astr.c"
...
# 321 "project/radare2/libr/util/astr.c" 3 4
__attribute__((visibility("default"))) 
# 321 "project/radare2/libr/util/astr.c"
     RASN1String *asn1_stringify_tag(RASN1Object *object) {
 if (!object) {
  return 
# 323 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 323 "project/radare2/libr/util/astr.c"
            ;
 }
 ...
 switch (object->tag) {
 case 
# 328 "project/radare2/libr/util/astr.c" 3 4
     0x00
# 328 "project/radare2/libr/util/astr.c"
            : s = "EOC"; break;
 case 
# 329 "project/radare2/libr/util/astr.c" 3 4
     0x01
# 329 "project/radare2/libr/util/astr.c"
                : s = "BOOLEAN"; break;
 case 
# 330 "project/radare2/libr/util/astr.c" 3 4
     0x02
# 330 "project/radare2/libr/util/astr.c"
                : s = "INTEGER"; break;
 case 
# 331 "project/radare2/libr/util/astr.c" 3 4
     0x03
# 331 "project/radare2/libr/util/astr.c"
                  : s = "BIT STRING"; break;
 case 
# 332 "project/radare2/libr/util/astr.c" 3 4
     0x04
# 332 "project/radare2/libr/util/astr.c"
                    : s = "OCTET STRING"; break;
 case 
# 333 "project/radare2/libr/util/astr.c" 3 4
     0x05
# 333 "project/radare2/libr/util/astr.c"
             : s = "NULL"; break;
 case 
# 334 "project/radare2/libr/util/astr.c" 3 4
     0x06
# 334 "project/radare2/libr/util/astr.c"
            : s = "OBJECT IDENTIFIER"; break;
 case 
# 335 "project/radare2/libr/util/astr.c" 3 4
     0x07
# 335 "project/radare2/libr/util/astr.c"
                      : s = "ObjectDescriptor"; break;
 case 
# 336 "project/radare2/libr/util/astr.c" 3 4
     0x08
# 336 "project/radare2/libr/util/astr.c"
                 : s = "EXTERNAL"; break;
 case 
# 337 "project/radare2/libr/util/astr.c" 3 4
     0x09
# 337 "project/radare2/libr/util/astr.c"
             : s = "REAL"; break;
 case 
# 338 "project/radare2/libr/util/astr.c" 3 4
     0x0A
# 338 "project/radare2/libr/util/astr.c"
                   : s = "ENUMERATED"; break;
 case 
# 339 "project/radare2/libr/util/astr.c" 3 4
     0x0B
# 339 "project/radare2/libr/util/astr.c"
                     : s = "EMBEDDED PDV"; break;
 case 
# 340 "project/radare2/libr/util/astr.c" 3 4
     0x0C
# 340 "project/radare2/libr/util/astr.c"
                   : s = "UTF8String"; break;
 case 
# 341 "project/radare2/libr/util/astr.c" 3 4
     0x10
# 341 "project/radare2/libr/util/astr.c"
                 : s = "SEQUENCE"; break;
 case 
# 342 "project/radare2/libr/util/astr.c" 3 4
     0x11
# 342 "project/radare2/libr/util/astr.c"
            : s = "SET"; break;
 case 
# 343 "project/radare2/libr/util/astr.c" 3 4
     0x12
# 343 "project/radare2/libr/util/astr.c"
                      : s = "NumericString"; break;
 case 
# 344 "project/radare2/libr/util/astr.c" 3 4
     0x13
# 344 "project/radare2/libr/util/astr.c"
                        : s = "PrintableString"; break;
 case 
# 345 "project/radare2/libr/util/astr.c" 3 4
     0x14
# 345 "project/radare2/libr/util/astr.c"
                  : s = "TeletexString"; break;
 case 
# 346 "project/radare2/libr/util/astr.c" 3 4
     0x15
# 346 "project/radare2/libr/util/astr.c"
                       : s = "VideotexString"; break;
 case 
# 347 "project/radare2/libr/util/astr.c" 3 4
     0x16
# 347 "project/radare2/libr/util/astr.c"
                  : s = "IA5String"; break;
 case 
# 348 "project/radare2/libr/util/astr.c" 3 4
     0x17
# 348 "project/radare2/libr/util/astr.c"
                : s = "UTCTime"; break;
 case 
# 349 "project/radare2/libr/util/astr.c" 3 4
     0x18
# 349 "project/radare2/libr/util/astr.c"
                        : s = "GeneralizedTime"; break;
 case 
# 350 "project/radare2/libr/util/astr.c" 3 4
     0x19
# 350 "project/radare2/libr/util/astr.c"
                      : s = "GraphicString"; break;
 case 
# 351 "project/radare2/libr/util/astr.c" 3 4
     0x1A
# 351 "project/radare2/libr/util/astr.c"
                      : s = "VisibleString"; break;
 case 
# 352 "project/radare2/libr/util/astr.c" 3 4
     0x1B
# 352 "project/radare2/libr/util/astr.c"
                      : s = "GeneralString"; break;
 case 
# 353 "project/radare2/libr/util/astr.c" 3 4
     0x1C
# 353 "project/radare2/libr/util/astr.c"
                        : s = "UniversalString"; break;
 case 
# 354 "project/radare2/libr/util/astr.c" 3 4
     0x1E
# 354 "project/radare2/libr/util/astr.c"
                  : s = "BMPString"; break;
 }
 return newstr (s);
}
...
# 359 "project/radare2/libr/util/astr.c" 3 4
__attribute__((visibility("default"))) 
# 359 "project/radare2/libr/util/astr.c"
     RASN1String *asn1_stringify_sector(RASN1Object *object) {
 if (!object) {
  return 
# 361 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 361 "project/radare2/libr/util/astr.c"
            ;
 }
 switch (object->tag) {
 case 
# 364 "project/radare2/libr/util/astr.c" 3 4
     0x00
# 364 "project/radare2/libr/util/astr.c"
            :
  return 
# 365 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 365 "project/radare2/libr/util/astr.c"
            ;
 case 
# 366 "project/radare2/libr/util/astr.c" 3 4
     0x01
# 366 "project/radare2/libr/util/astr.c"
                :
  return newstr (r_str_bool (object->sector[0]));
 case 
# 368 "project/radare2/libr/util/astr.c" 3 4
     0x09
# 368 "project/radare2/libr/util/astr.c"
             :
 case 
# 369 "project/radare2/libr/util/astr.c" 3 4
     0x02
# 369 "project/radare2/libr/util/astr.c"
                :
  if (object->length < 16) {
 ...
 case 
# 375 "project/radare2/libr/util/astr.c" 3 4
     0x03
# 375 "project/radare2/libr/util/astr.c"
                  :
 ...
 case 
# 381 "project/radare2/libr/util/astr.c" 3 4
     0x04
# 381 "project/radare2/libr/util/astr.c"
                    :
  return r_asn1_stringify_bytes (object->sector, object->length);
 case 
# 383 "project/radare2/libr/util/astr.c" 3 4
     0x05
# 383 "project/radare2/libr/util/astr.c"
             :
  return 
# 384 "project/radare2/libr/util/astr.c" 3 4
        ((void *)0)
# 384 "project/radare2/libr/util/astr.c"
            ;
 case 
# 385 "project/radare2/libr/util/astr.c" 3 4
     0x06
# 385 "project/radare2/libr/util/astr.c"
            :
 ...
 case 
# 391 "project/radare2/libr/util/astr.c" 3 4
     0x0C
# 391 "project/radare2/libr/util/astr.c"
                   :


 case 
# 394 "project/radare2/libr/util/astr.c" 3 4
     0x12
# 394 "project/radare2/libr/util/astr.c"
                      :
 case 
# 395 "project/radare2/libr/util/astr.c" 3 4
     0x13
# 395 "project/radare2/libr/util/astr.c"
                        :


 case 
# 398 "project/radare2/libr/util/astr.c" 3 4
     0x16
# 398 "project/radare2/libr/util/astr.c"
                  :
 case 
# 399 "project/radare2/libr/util/astr.c" 3 4
     0x1A
# 399 "project/radare2/libr/util/astr.c"
                      :
  return r_asn1_stringify_string (object->sector, object->length);
 case 
# 401 "project/radare2/libr/util/astr.c" 3 4
     0x17
# 401 "project/radare2/libr/util/astr.c"
                :
  return r_asn1_stringify_utctime (object->sector, object->length);
 case 
# 403 "project/radare2/libr/util/astr.c" 3 4
     0x18
# 403 "project/radare2/libr/util/astr.c"
                        :
 ...
 return 
# 410 "project/radare2/libr/util/astr.c" 3 4
       ((void *)0)
# 410 "project/radare2/libr/util/astr.c"
           ;
}
