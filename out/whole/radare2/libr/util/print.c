# 0 "project/radare2/libr/util/print.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/print.c"
...
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_print.h" 2 3 4
...
# 6 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_print.h" 2 3 4
...
# 4 "project/radare2/libr/util/print.c" 2
...
# 5 "project/radare2/libr/util/print.c" 2

#define DFLT_ROWS 16


# 8 "project/radare2/libr/util/print.c"
...
# 16 "project/radare2/libr/util/print.c" 3 4
__builtin_va_start(
# 16 "project/radare2/libr/util/print.c"
ap
# 16 "project/radare2/libr/util/print.c" 3 4
,
# 16 "project/radare2/libr/util/print.c"
...
# 18 "project/radare2/libr/util/print.c" 3 4
__builtin_va_end(
# 18 "project/radare2/libr/util/print.c"
ap
# 18 "project/radare2/libr/util/print.c" 3 4
)
# 18 "project/radare2/libr/util/print.c"
...
# 24 "project/radare2/libr/util/print.c" 3 4
__builtin_va_start(
# 24 "project/radare2/libr/util/print.c"
ap
# 24 "project/radare2/libr/util/print.c" 3 4
,
# 24 "project/radare2/libr/util/print.c"
...
# 24 "project/radare2/libr/util/print.c"
                     ;
 vfprintf (
# 25 "project/radare2/libr/util/print.c" 3 4
          __stderrp
# 25 "project/radare2/libr/util/print.c"
                , format, ap);
 
# 26 "project/radare2/libr/util/print.c" 3 4
__builtin_va_end(
# 26 "project/radare2/libr/util/print.c"
ap
# 26 "project/radare2/libr/util/print.c" 3 4
)
# 26 "project/radare2/libr/util/print.c"
...
static RPrintIsInterruptedCallback is_interrupted_cb = 
# 30 "project/radare2/libr/util/print.c" 3 4
                                                      ((void *)0)
# 30 "project/radare2/libr/util/print.c"
                                                          ;


# 32 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 32 "project/radare2/libr/util/print.c"
     void r_print_portionbar(RPrint *p, const 
# 32 "project/radare2/libr/util/print.c" 3 4
                                              unsigned long long 
# 32 "project/radare2/libr/util/print.c"
                                                   *portions, int n_portions) {
 const int use_color = p->flags & 
# 33 "project/radare2/libr/util/print.c" 3 4
                                 0x00000001
# 33 "project/radare2/libr/util/print.c"
                                                    ;
 int i, j;
 
# 35 "project/radare2/libr/util/print.c" 3 4
unsigned long long 
# 35 "project/radare2/libr/util/print.c"
     total = 0LL;
 for (i = 0; i < n_portions; i++) {
  
# 37 "project/radare2/libr/util/print.c" 3 4
 unsigned long long 
# 37 "project/radare2/libr/util/print.c"
      sum = total + portions[i];
  if (total > sum) {
   
# 39 "project/radare2/libr/util/print.c" 3 4
  fprintf(__stderrp,
# 39 "project/radare2/libr/util/print.c"
  "portionbar overflow aborted\n"
# 39 "project/radare2/libr/util/print.c" 3 4
  )
# 39 "project/radare2/libr/util/print.c"
                                           ;
 ...
 for (i = 0; i < n_portions; i++) {
  ...
  if (use_color) {
   p->cb_printf (
# 62 "project/radare2/libr/util/print.c" 3 4
                "\x1b[0m"
# 62 "project/radare2/libr/util/print.c"
                           );
  }
 }
 p->cb_printf ("]\n");
...
# 68 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 68 "project/radare2/libr/util/print.c"
     void r_print_columns(RPrint *p, const 
# 68 "project/radare2/libr/util/print.c" 3 4
                                           unsigned char 
# 68 "project/radare2/libr/util/print.c"
                                               *buf, int len, int height) {
...
# 74 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 74 "project/radare2/libr/util/print.c"
     colors = p->flags & 
# 74 "project/radare2/libr/util/print.c" 3 4
                         0x00000001
# 74 "project/radare2/libr/util/print.c"
 ...
 const char *vline = p->cons->use_utf8 ? 
# 76 "project/radare2/libr/util/print.c" 3 4
                                        "│" 
# 76 "project/radare2/libr/util/print.c"
                                                       : "|";
 const char *block = p->cons->use_utf8 ? 
# 77 "project/radare2/libr/util/print.c" 3 4
                                        "\u2588" 
# 77 "project/radare2/libr/util/print.c"
                                                     : "#";
 const char *kol[5];
 kol[0] = pal->call;
 kol[1] = pal->jmp;
  ...
  for (i = 0; i < rows; i++) {
   ...
   for (j = 0; j < cols; j++) {
    int realJ = j * len / cols;
     ...
     if (p->histblock) {
      p->cb_printf ("%s%s%s", kol[koli], block, 
# 92 "project/radare2/libr/util/print.c" 3 4
                                               "\x1b[0m"
# 92 "project/radare2/libr/util/print.c"
                                                          );
     } else {
      p->cb_printf ("%s%s%s", kol[koli], vline, 
# 94 "project/radare2/libr/util/print.c" 3 4
                                               "\x1b[0m"
# 94 "project/radare2/libr/util/print.c"
                                                          );
     }
    } else {
     p->cb_printf("%s", " ");
 ...
 for (i = 0; i < rows; i++) {
  ...
  for (j = 0; j < cols; j++) {
   ...
   if (255 - buf[realJ] < threshold) {
    if (p->histblock) {
     p->cb_printf ("%s%s%s", 
# 111 "project/radare2/libr/util/print.c" 3 4
                            "\x1b[100m"
# 111 "project/radare2/libr/util/print.c"
                                        , block, 
# 111 "project/radare2/libr/util/print.c" 3 4
                                                 "\x1b[0m"
# 111 "project/radare2/libr/util/print.c"
...
# 125 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 125 "project/radare2/libr/util/print.c"
     int r_util_lines_getline(
# 125 "project/radare2/libr/util/print.c" 3 4
                              unsigned long long 
# 125 "project/radare2/libr/util/print.c"
                                   *lines_cache, int lines_cache_sz, 
# 125 "project/radare2/libr/util/print.c" 3 4
                                                                     unsigned long long 
# 125 "project/radare2/libr/util/print.c"
                                                                          off) {
...
# 144 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 144 "project/radare2/libr/util/print.c"
          r_print_is_interrupted(void) {
 if (is_interrupted_cb) {
  return is_interrupted_cb ();
 }
 return 
# 148 "project/radare2/libr/util/print.c" 3 4
       0
# 148 "project/radare2/libr/util/print.c"
            ;
}


# 151 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 151 "project/radare2/libr/util/print.c"
     void r_print_set_is_interrupted_cb(RPrintIsInterruptedCallback cb) {
 is_interrupted_cb = cb;
}


# 155 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 155 "project/radare2/libr/util/print.c"
          r_print_mute(RPrint *p, int x) {
 if (x) {
  if (p->cb_printf == &nullprinter) {
   return 
# 158 "project/radare2/libr/util/print.c" 3 4
         0
# 158 "project/radare2/libr/util/print.c"
              ;
  }
  p->oprintf = p->cb_printf;
  p->cb_printf = nullprinter;
  return 
# 162 "project/radare2/libr/util/print.c" 3 4
        1
# 162 "project/radare2/libr/util/print.c"
            ;
 }
 if (p->cb_printf == nullprinter) {
  p->cb_printf = p->oprintf;
  return 
# 166 "project/radare2/libr/util/print.c" 3 4
        1
# 166 "project/radare2/libr/util/print.c"
            ;
 }
 return 
# 168 "project/radare2/libr/util/print.c" 3 4
       0
# 168 "project/radare2/libr/util/print.c"
            ;
}
...
# 238 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 238 "project/radare2/libr/util/print.c"
     char* r_print_stereogram(const char *bump, int w, int h) {
 if (w < 1 || h < 1) {
  return 
# 240 "project/radare2/libr/util/print.c" 3 4
        ((void *)0)
# 240 "project/radare2/libr/util/print.c"
            ;
 }
 
# 242 "project/radare2/libr/util/print.c" 3 4
unsigned long long 
# 242 "project/radare2/libr/util/print.c"
     size = w * (
# 242 "project/radare2/libr/util/print.c" 3 4
                 unsigned long long
# 242 "project/radare2/libr/util/print.c"
 ...
 if (size > 
# 243 "project/radare2/libr/util/print.c" 3 4
           0xFFFFFFFFU
# 243 "project/radare2/libr/util/print.c"
                   ) {
  return 
# 244 "project/radare2/libr/util/print.c" 3 4
        ((void *)0)
# 244 "project/radare2/libr/util/print.c"
            ;
 }
 char *out = calloc (1, size * 2);
 if (!out) {
  return 
# 248 "project/radare2/libr/util/print.c" 3 4
        ((void *)0)
# 248 "project/radare2/libr/util/print.c"
            ;
 }
...
# 256 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 256 "project/radare2/libr/util/print.c"
     char* r_print_stereogram_bytes(const 
# 256 "project/radare2/libr/util/print.c" 3 4
                                          unsigned char 
# 256 "project/radare2/libr/util/print.c"
                                              *buf, int len) {
 ...
 if (!buf || len < 1) {
  return 
# 261 "project/radare2/libr/util/print.c" 3 4
        ((void *)0)
# 261 "project/radare2/libr/util/print.c"
            ;
 }
 ...
 char *bump = malloc (size + 1);
 if (!bump) {
  return 
# 270 "project/radare2/libr/util/print.c" 3 4
        ((void *)0)
# 270 "project/radare2/libr/util/print.c"
            ;
 }
...
# 285 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 285 "project/radare2/libr/util/print.c"
     void r_print_stereogram_print(RPrint *p, const char *ret) {
 int i;
 const int use_color = p->flags & 
# 287 "project/radare2/libr/util/print.c" 3 4
                                 0x00000001
# 287 "project/radare2/libr/util/print.c"
                                                    ;
 if (!ret) {
  return;
 }
...
# 301 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 301 "project/radare2/libr/util/print.c"
     RPrint* r_print_new(void) {
 RPrint *p = 
# 302 "project/radare2/libr/util/print.c" 3 4
            (
# 302 "project/radare2/libr/util/print.c"
            RPrint
# 302 "project/radare2/libr/util/print.c" 3 4
            *)calloc(1,sizeof(
# 302 "project/radare2/libr/util/print.c"
...
# 302 "project/radare2/libr/util/print.c"
 ...
 if (!p) {
  return 
# 304 "project/radare2/libr/util/print.c" 3 4
        ((void *)0)
# 304 "project/radare2/libr/util/print.c"
            ;
 }
 
# 306 "project/radare2/libr/util/print.c" 3 4
__builtin___strcpy_chk (
# 306 "project/radare2/libr/util/print.c"
p->datefmt
# 306 "project/radare2/libr/util/print.c" 3 4
, 
# 306 "project/radare2/libr/util/print.c"
...
# 307 "project/radare2/libr/util/print.c" 3 4
__builtin___memset_chk (&
# 307 "project/radare2/libr/util/print.c"
p->iob
# 307 "project/radare2/libr/util/print.c" 3 4
, 0,sizeof(
# 307 "project/radare2/libr/util/print.c"
...
# 307 "project/radare2/libr/util/print.c"
                       ;
 p->pairs = 
# 308 "project/radare2/libr/util/print.c" 3 4
           1
# 308 "project/radare2/libr/util/print.c"
               ;
 p->resetbg = 
# 309 "project/radare2/libr/util/print.c" 3 4
             1
# 309 "project/radare2/libr/util/print.c"
                 ;
 ...
 p->bytespace = 0;
 p->big_endian = 
# 316 "project/radare2/libr/util/print.c" 3 4
                0
# 316 "project/radare2/libr/util/print.c"
                     ;
 p->datezone = 0;
 p->col = 0;
 p->width = 78;
 p->cols = 16;
 p->cur_enabled = 
# 321 "project/radare2/libr/util/print.c" 3 4
                 0
# 321 "project/radare2/libr/util/print.c"
                      ;
 p->cur = p->ocur = -1;
 p->formats = sdb_new0 ();
 p->addrmod = 4;
...
# 326 "project/radare2/libr/util/print.c" 3 4
 0x00000001 
# 326 "project/radare2/libr/util/print.c"
                     |
  
# 327 "project/radare2/libr/util/print.c" 3 4
 0x00000040 
# 327 "project/radare2/libr/util/print.c"
                      |
  
# 328 "project/radare2/libr/util/print.c" 3 4
 0x00000008 
# 328 "project/radare2/libr/util/print.c"
                      |
  
# 329 "project/radare2/libr/util/print.c" 3 4
 0x00000002
# 329 "project/radare2/libr/util/print.c"
                      ;
 p->seggrn = 4;
 p->zoom = 
# 331 "project/radare2/libr/util/print.c" 3 4
          (
# 331 "project/radare2/libr/util/print.c"
          RPrintZoom
# 331 "project/radare2/libr/util/print.c" 3 4
          *)calloc(1,sizeof(
# 331 "project/radare2/libr/util/print.c"
...
# 331 "project/radare2/libr/util/print.c"
                             ;
 p->reg = 
# 332 "project/radare2/libr/util/print.c" 3 4
         ((void *)0)
# 332 "project/radare2/libr/util/print.c"
             ;
 p->get_register = 
# 333 "project/radare2/libr/util/print.c" 3 4
                  ((void *)0)
# 333 "project/radare2/libr/util/print.c"
                      ;
 p->get_register_value = 
# 334 "project/radare2/libr/util/print.c" 3 4
                        ((void *)0)
# 334 "project/radare2/libr/util/print.c"
                            ;
 p->lines_cache = 
# 335 "project/radare2/libr/util/print.c" 3 4
                 ((void *)0)
# 335 "project/radare2/libr/util/print.c"
                     ;
 p->calc_row_offsets = 
# 336 "project/radare2/libr/util/print.c" 3 4
                      1
# 336 "project/radare2/libr/util/print.c"
                          ;
 p->row_offsets_sz = 0;
 p->row_offsets = 
# 338 "project/radare2/libr/util/print.c" 3 4
                 ((void *)0)
# 338 "project/radare2/libr/util/print.c"
                     ;
 p->vflush = 
# 339 "project/radare2/libr/util/print.c" 3 4
            1
# 339 "project/radare2/libr/util/print.c"
                ;
 p->screen_bounds = 0;
 p->esc_bslash = 
# 341 "project/radare2/libr/util/print.c" 3 4
                0
# 341 "project/radare2/libr/util/print.c"
                     ;
 p->strconv_mode = 
# 342 "project/radare2/libr/util/print.c" 3 4
                  ((void *)0)
# 342 "project/radare2/libr/util/print.c"
                      ;
 
# 343 "project/radare2/libr/util/print.c" 3 4
__builtin___memset_chk (
# 343 "project/radare2/libr/util/print.c"
&p->consbind
# 343 "project/radare2/libr/util/print.c" 3 4
, 
# 343 "project/radare2/libr/util/print.c"
...
# 343 "project/radare2/libr/util/print.c"
                                              ;
 p->io_unalloc_ch = '.';
 p->enable_progressbar = 
# 345 "project/radare2/libr/util/print.c" 3 4
                        1
# 345 "project/radare2/libr/util/print.c"
                            ;
...
# 350 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 350 "project/radare2/libr/util/print.c"
     RPrint* r_print_free(RPrint *p) {
 if (!p) {
  return 
# 352 "project/radare2/libr/util/print.c" 3 4
        ((void *)0)
# 352 "project/radare2/libr/util/print.c"
            ;
 }
 sdb_free (p->formats);
 p->formats = 
# 355 "project/radare2/libr/util/print.c" 3 4
             ((void *)0)
# 355 "project/radare2/libr/util/print.c"
                 ;
 
# 356 "project/radare2/libr/util/print.c" 3 4
{ free((void *)
# 356 "project/radare2/libr/util/print.c"
p->strconv_mode
# 356 "project/radare2/libr/util/print.c" 3 4
); 
# 356 "project/radare2/libr/util/print.c"
...
# 356 "project/radare2/libr/util/print.c"
 ...
 if (p->zoom) {
  ...
  free (p->zoom);
  p->zoom = 
# 360 "project/radare2/libr/util/print.c" 3 4
           ((void *)0)
# 360 "project/radare2/libr/util/print.c"
               ;
 }
 
# 362 "project/radare2/libr/util/print.c" 3 4
{ free((void *)
# 362 "project/radare2/libr/util/print.c"
p->lines_cache
# 362 "project/radare2/libr/util/print.c" 3 4
); 
# 362 "project/radare2/libr/util/print.c"
...
# 363 "project/radare2/libr/util/print.c" 3 4
{ free((void *)
# 363 "project/radare2/libr/util/print.c"
p->row_offsets
# 363 "project/radare2/libr/util/print.c" 3 4
); 
# 363 "project/radare2/libr/util/print.c"
...
# 363 "project/radare2/libr/util/print.c"
 ...
 free (p);
 return 
# 366 "project/radare2/libr/util/print.c" 3 4
       ((void *)0)
# 366 "project/radare2/libr/util/print.c"
           ;
}



# 370 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 370 "project/radare2/libr/util/print.c"
     void r_print_set_flags(RPrint *p, int _flags) {
 p->flags = _flags;
}


# 374 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 374 "project/radare2/libr/util/print.c"
     void r_print_unset_flags(RPrint *p, int flags) {
 p->flags = p->flags & (p->flags ^ flags);
}


# 378 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 378 "project/radare2/libr/util/print.c"
     void r_print_set_cursor(RPrint *p, int enable, int ocursor, int cursor) {
 if (!p) {
  return;
 }
...
# 390 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 390 "project/radare2/libr/util/print.c"
          r_print_have_cursor(RPrint *p, int cur, int len) {
 if (!p || !p->cur_enabled) {
  return 
# 392 "project/radare2/libr/util/print.c" 3 4
        0
# 392 "project/radare2/libr/util/print.c"
             ;
 }
 if (p->ocur != -1) {
  int from = p->ocur;
  ...
  do {
   if (cur + len - 1 >= from && cur + len - 1 <= to) {
    return 
# 400 "project/radare2/libr/util/print.c" 3 4
          1
# 400 "project/radare2/libr/util/print.c"
              ;
   }
  } while (--len);
 } else if (p->cur >= cur && p->cur <= cur + len - 1) {
  return 
# 404 "project/radare2/libr/util/print.c" 3 4
        1
# 404 "project/radare2/libr/util/print.c"
            ;
 }
 return 
# 406 "project/radare2/libr/util/print.c" 3 4
       0
# 406 "project/radare2/libr/util/print.c"
            ;
}


# 409 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 409 "project/radare2/libr/util/print.c"
          r_print_cursor_pointer(RPrint *p, int cur, int len) {
 
# 410 "project/radare2/libr/util/print.c" 3 4
do { if (!(
# 410 "project/radare2/libr/util/print.c"
p
# 410 "project/radare2/libr/util/print.c" 3 4
...
"p"
# 410 "project/radare2/libr/util/print.c" 3 4
, 410); return (0); } } while (0)
# 410 "project/radare2/libr/util/print.c"
                               ;
 if (!p->cur_enabled) {
  return 
# 412 "project/radare2/libr/util/print.c" 3 4
        0
# 412 "project/radare2/libr/util/print.c"
             ;
 }
 int to = p->cur;
 do {
  if (cur + len - 1 == to) {
   return 
# 417 "project/radare2/libr/util/print.c" 3 4
         1
# 417 "project/radare2/libr/util/print.c"
             ;
  }
 } while (--len);
 return 
# 420 "project/radare2/libr/util/print.c" 3 4
       0
# 420 "project/radare2/libr/util/print.c"
            ;
}


# 423 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 423 "project/radare2/libr/util/print.c"
     void r_print_cursor(RPrint *p, int cur, int len, int set) {
 if (r_print_have_cursor (p, cur, len)) {
  p->cb_printf ("%s", 
# 425 "project/radare2/libr/util/print.c" 3 4
                     (
# 425 "project/radare2/libr/util/print.c"
                     1
# 425 "project/radare2/libr/util/print.c" 3 4
                     ? (
# 425 "project/radare2/libr/util/print.c"
...
# 429 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 429 "project/radare2/libr/util/print.c"
     void r_print_addr(RPrint *p, 
# 429 "project/radare2/libr/util/print.c" 3 4
                                  unsigned long long 
# 429 "project/radare2/libr/util/print.c"
                                       addr) {
...
# 437 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 437 "project/radare2/libr/util/print.c"
     use_segoff = p? (p->flags & 
# 437 "project/radare2/libr/util/print.c" 3 4
                                 0x00000020
# 437 "project/radare2/libr/util/print.c"
                                                     ): 
...
# 438 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 438 "project/radare2/libr/util/print.c"
     use_color = p? (p->flags & 
# 438 "project/radare2/libr/util/print.c" 3 4
                                0x00000001
# 438 "project/radare2/libr/util/print.c"
...
# 439 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 439 "project/radare2/libr/util/print.c"
     dec = p? (p->flags & 
# 439 "project/radare2/libr/util/print.c" 3 4
                          0x00000200
# 439 "project/radare2/libr/util/print.c"
...
# 440 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 440 "project/radare2/libr/util/print.c"
     mod = p? (p->flags & 
# 440 "project/radare2/libr/util/print.c" 3 4
                          0x00000002
# 440 "project/radare2/libr/util/print.c"
...
# 440 "project/radare2/libr/util/print.c"
 ...
 if (p && p->flags & 
# 442 "project/radare2/libr/util/print.c" 3 4
                    0x00000800 
# 442 "project/radare2/libr/util/print.c"
                                          && p->col == 1) {
  ch = '|';
 }
 if (p && p->pava) {
  
# 446 "project/radare2/libr/util/print.c" 3 4
 unsigned long long 
# 446 "project/radare2/libr/util/print.c"
      va = p->iob.p2v (p->iob.io, addr);
  if (va != 
# 447 "project/radare2/libr/util/print.c" 3 4
           0xFFFFFFFFFFFFFFFFULL
# 447 "project/radare2/libr/util/print.c"
                   ) {
   addr = va;
  }
 }
...
# 452 "project/radare2/libr/util/print.c" 3 4
 unsigned int 
# 452 "project/radare2/libr/util/print.c"
      s, a;
  a = addr & 0xffff;
  s = (addr - a) >> (p? p->seggrn: 0);
  if (dec) {
   
# 456 "project/radare2/libr/util/print.c" 3 4
  __builtin___snprintf_chk (
# 456 "project/radare2/libr/util/print.c"
  space
# 456 "project/radare2/libr/util/print.c" 3 4
  , 
# 456 "project/radare2/libr/util/print.c"
...
# 456 "project/radare2/libr/util/print.c"
  ...
  if (use_color) {
   const char *pre = (p && p->cons && p->cons->context && p->cons->context->pal.offset)? p->cons->context->pal.offset: 
# 460 "project/radare2/libr/util/print.c" 3 4
                                     "\x1b[32m"
# 460 "project/radare2/libr/util/print.c"
                                                ;
   const char *fin = 
# 461 "project/radare2/libr/util/print.c" 3 4
                    "\x1b[0m"
# 461 "project/radare2/libr/util/print.c"
                               ;
   if (dec) {
...
# 476 "project/radare2/libr/util/print.c" 3 4
  __builtin___snprintf_chk (
# 476 "project/radare2/libr/util/print.c"
  space
# 476 "project/radare2/libr/util/print.c" 3 4
  , 
# 476 "project/radare2/libr/util/print.c"
...
# 476 "project/radare2/libr/util/print.c"
                                                     ;
   int w = 
# 477 "project/radare2/libr/util/print.c" 3 4
          (((
# 477 "project/radare2/libr/util/print.c"
          10 - strlen (space)
# 477 "project/radare2/libr/util/print.c" 3 4
          )>(
# 477 "project/radare2/libr/util/print.c"
...
# 477 "project/radare2/libr/util/print.c"
  ...
  if (use_color) {
   const char *pre = (p && p->cons && p->cons->context && p->cons->context->pal.offset)? p->cons->context->pal.offset: 
# 481 "project/radare2/libr/util/print.c" 3 4
                                     "\x1b[32m"
# 481 "project/radare2/libr/util/print.c"
                                                ;
   const char *fin = 
# 482 "project/radare2/libr/util/print.c" 3 4
                    "\x1b[0m"
# 482 "project/radare2/libr/util/print.c"
                               ;
   if (p && p->flags & 
# 483 "project/radare2/libr/util/print.c" 3 4
                      0x00004000
# 483 "project/radare2/libr/util/print.c"
                                           ) {
   ...
   if (dec) {
    printfmt ("%s%s%" 
# 491 "project/radare2/libr/util/print.c" 3 4
                     "lld" 
# 491 "project/radare2/libr/util/print.c"
                             "%s%c", pre, white, addr, fin, ch);
   } else {
    if (p && p->wide_offsets) {

     printfmt ("%s0x%016" 
# 495 "project/radare2/libr/util/print.c" 3 4
                         "llx" 
# 495 "project/radare2/libr/util/print.c"
                                 "%s%c", pre, addr, fin, ch);
    } else {
     printfmt ("%s0x%08" 
# 497 "project/radare2/libr/util/print.c" 3 4
                        "llx" 
# 497 "project/radare2/libr/util/print.c"
                                "%s%c", pre, addr, fin, ch);
    }
   }
  } else {
   if (dec) {
    printfmt ("%s%" 
# 502 "project/radare2/libr/util/print.c" 3 4
                   "lld" 
# 502 "project/radare2/libr/util/print.c"
                           "%c", white, addr, ch);
   } else {
    if (p && p->wide_offsets) {

     printfmt ("0x%016" 
# 506 "project/radare2/libr/util/print.c" 3 4
                       "llx" 
# 506 "project/radare2/libr/util/print.c"
                               "%c", addr, ch);
    } else {
     printfmt ("0x%08" 
# 508 "project/radare2/libr/util/print.c" 3 4
                      "llx" 
# 508 "project/radare2/libr/util/print.c"
                              "%c", addr, ch);
    }
   }
  }
...
# 515 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 515 "project/radare2/libr/util/print.c"
     char* r_print_hexpair(RPrint *p, const char *str, int n) {
 const char *s, *lastcol = 
# 516 "project/radare2/libr/util/print.c" 3 4
                          "\x1b[37m"
# 516 "project/radare2/libr/util/print.c"
                                     ;
 char *d, *dst = (char *) calloc ((strlen (str) + 2), 32);
 int colors = p->flags & 
# 518 "project/radare2/libr/util/print.c" 3 4
                        0x00000001
# 518 "project/radare2/libr/util/print.c"
                                           ;
 ...
 int cur = 
# 527 "project/radare2/libr/util/print.c" 3 4
          (((
# 527 "project/radare2/libr/util/print.c"
          p->cur
# 527 "project/radare2/libr/util/print.c" 3 4
          )>(
# 527 "project/radare2/libr/util/print.c"
...
# 527 "project/radare2/libr/util/print.c"
                                 ;
 int ocur = 
# 528 "project/radare2/libr/util/print.c" 3 4
           (((
# 528 "project/radare2/libr/util/print.c"
           p->cur
# 528 "project/radare2/libr/util/print.c" 3 4
           )>(
# 528 "project/radare2/libr/util/print.c"
...
#define P(x) (p->cons && p->cons->context->pal.x)? p->cons->context->pal.x
  color_0x00 = (p->cons && p->cons->context->pal.b0x00)? p->cons->context->pal.b0x00: 
# 533 "project/radare2/libr/util/print.c" 3 4
                         "\x1b[32m"
# 533 "project/radare2/libr/util/print.c"
                                    ;
  color_0x7f = (p->cons && p->cons->context->pal.b0x7f)? p->cons->context->pal.b0x7f: 
# 534 "project/radare2/libr/util/print.c" 3 4
                         "\x1b[33m"
# 534 "project/radare2/libr/util/print.c"
                                     ;
  color_0xff = (p->cons && p->cons->context->pal.b0xff)? p->cons->context->pal.b0xff: 
# 535 "project/radare2/libr/util/print.c" 3 4
                         "\x1b[31m"
# 535 "project/radare2/libr/util/print.c"
                                  ;
  color_text = (p->cons && p->cons->context->pal.btext)? p->cons->context->pal.btext: 
# 536 "project/radare2/libr/util/print.c" 3 4
                         "\x1b[35m"
# 536 "project/radare2/libr/util/print.c"
                                      ;
  color_other = (p->cons && p->cons->context->pal.other)? p->cons->context->pal.other: "";
 }
...
#define memcat(x,y) { memcpy (x, y, strlen (y)); (x) += strlen (y); }
 ...
 for (s = str, i = 0; s[0]; i++) {
  ...
  if (p->cur_enabled) {
   if (i == ocur - n) {
    { 
# 555 "project/radare2/libr/util/print.c" 3 4
   __builtin___memcpy_chk (
# 555 "project/radare2/libr/util/print.c"
   d
# 555 "project/radare2/libr/util/print.c" 3 4
   , "\x1b[0m"
# 555 "project/radare2/libr/util/print.c"
...
# 555 "project/radare2/libr/util/print.c"
   ...
   if (colors) {
    { 
# 558 "project/radare2/libr/util/print.c" 3 4
   __builtin___memcpy_chk (
# 558 "project/radare2/libr/util/print.c"
   d
# 558 "project/radare2/libr/util/print.c" 3 4
   , 
# 558 "project/radare2/libr/util/print.c"
   lastcol, strlen (lastcol)
# 558 "project/radare2/libr/util/print.c" 3 4
   , __builtin_object_size (
# 558 "project/radare2/libr/util/print.c"
   d
...
# 558 "project/radare2/libr/util/print.c"
   ...
   if (i >= cur - n && i < ocur - n) {
    { 
# 561 "project/radare2/libr/util/print.c" 3 4
   __builtin___memcpy_chk (
# 561 "project/radare2/libr/util/print.c"
   d
# 561 "project/radare2/libr/util/print.c" 3 4
   , "\x1b[7m"
# 561 "project/radare2/libr/util/print.c"
...
# 561 "project/radare2/libr/util/print.c"
  ...
  if (colors) {
   if (s[0] == '0' && s[1] == '0') {
    ...
    if (
# 576 "project/radare2/libr/util/print.c" 3 4
       ((
# 576 "project/radare2/libr/util/print.c"
       ch
# 576 "project/radare2/libr/util/print.c" 3 4
       ) >=' ' && (
# 576 "project/radare2/libr/util/print.c"
...
# 576 "project/radare2/libr/util/print.c"
   ...
   { 
# 582 "project/radare2/libr/util/print.c" 3 4
  __builtin___memcpy_chk (
# 582 "project/radare2/libr/util/print.c"
  d
# 582 "project/radare2/libr/util/print.c" 3 4
  , 
# 582 "project/radare2/libr/util/print.c"
...
# 587 "project/radare2/libr/util/print.c" 3 4
 __builtin___memcpy_chk (
# 587 "project/radare2/libr/util/print.c"
 d
# 587 "project/radare2/libr/util/print.c" 3 4
 , 
# 587 "project/radare2/libr/util/print.c"
...
# 587 "project/radare2/libr/util/print.c"
  ...
  if (bs) {
   { 
# 591 "project/radare2/libr/util/print.c" 3 4
  __builtin___memcpy_chk (
# 591 "project/radare2/libr/util/print.c"
  d
# 591 "project/radare2/libr/util/print.c" 3 4
  , 
# 591 "project/radare2/libr/util/print.c"
...
# 591 "project/radare2/libr/util/print.c"
 ...
 if (colors || p->cur_enabled) {
  if (p->resetbg) {
   { 
# 596 "project/radare2/libr/util/print.c" 3 4
  __builtin___memcpy_chk (
# 596 "project/radare2/libr/util/print.c"
  d
# 596 "project/radare2/libr/util/print.c" 3 4
  , "\x1b[0m"
# 596 "project/radare2/libr/util/print.c"
...
# 596 "project/radare2/libr/util/print.c"
   ...
   { 
# 598 "project/radare2/libr/util/print.c" 3 4
  __builtin___memcpy_chk (
# 598 "project/radare2/libr/util/print.c"
  d
# 598 "project/radare2/libr/util/print.c" 3 4
  , "\x1b[27;22;24;25;28;39m"
# 598 "project/radare2/libr/util/print.c"
  , strlen (
# 598 "project/radare2/libr/util/print.c" 3 4
  "\x1b[27;22;24;25;28;39m"
...
# 607 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 607 "project/radare2/libr/util/print.c"
     const char *r_print_byte_color(RPrint *p, int ch) {
 if (p->flags & 
# 608 "project/radare2/libr/util/print.c" 3 4
               0x00004000
# 608 "project/radare2/libr/util/print.c"
                                    ) {

  int bg = (p->flags & 
# 610 "project/radare2/libr/util/print.c" 3 4
                      0x00001000
# 610 "project/radare2/libr/util/print.c"
                                          )? 48: 38;
  
# 611 "project/radare2/libr/util/print.c" 3 4
 __builtin___snprintf_chk (
# 611 "project/radare2/libr/util/print.c"
 colorbuffer
# 611 "project/radare2/libr/util/print.c" 3 4
 , 
# 611 "project/radare2/libr/util/print.c"
...
# 611 "project/radare2/libr/util/print.c"
 ...
 const 
# 614 "project/radare2/libr/util/print.c" 3 4
      _Bool 
# 614 "project/radare2/libr/util/print.c"
           use_color = p->flags & 
# 614 "project/radare2/libr/util/print.c" 3 4
                                  0x00000001
# 614 "project/radare2/libr/util/print.c"
 ...
 if (!use_color) {
  return 
# 616 "project/radare2/libr/util/print.c" 3 4
        ((void *)0)
# 616 "project/radare2/libr/util/print.c"
            ;
 }
 switch (ch) {
 case 0x00: return (p->cons && p->cons->context->pal.b0x00)? p->cons->context->pal.b0x00: 
# 619 "project/radare2/libr/util/print.c" 3 4
                             "\x1b[32m"
# 619 "project/radare2/libr/util/print.c"
                                        ;
 case 0x7F: return (p->cons && p->cons->context->pal.b0x7f)? p->cons->context->pal.b0x7f: 
# 620 "project/radare2/libr/util/print.c" 3 4
                             "\x1b[33m"
# 620 "project/radare2/libr/util/print.c"
                                         ;
 case 0xFF: return (p->cons && p->cons->context->pal.b0xff)? p->cons->context->pal.b0xff: 
# 621 "project/radare2/libr/util/print.c" 3 4
                             "\x1b[31m"
# 621 "project/radare2/libr/util/print.c"
                                      ;
 default: return 
# 622 "project/radare2/libr/util/print.c" 3 4
                ((
# 622 "project/radare2/libr/util/print.c"
                ch
# 622 "project/radare2/libr/util/print.c" 3 4
                ) >=' ' && (
# 622 "project/radare2/libr/util/print.c"
...
# 622 "project/radare2/libr/util/print.c"
                                 ? (p->cons && p->cons->context->pal.btext)? p->cons->context->pal.btext: 
# 622 "project/radare2/libr/util/print.c" 3 4
                                              "\x1b[35m"
# 622 "project/radare2/libr/util/print.c"
                                                           : (p->cons && p->cons->context->pal.other)? p->cons->context->pal.other: 
# 622 "project/radare2/libr/util/print.c" 3 4
                                                                        "\x1b[37m"
# 622 "project/radare2/libr/util/print.c"
                                                                                   ;
 ...
 return 
# 624 "project/radare2/libr/util/print.c" 3 4
       ((void *)0)
# 624 "project/radare2/libr/util/print.c"
           ;
}


# 627 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 627 "project/radare2/libr/util/print.c"
     void r_print_byte(RPrint *p, const char *fmt, int idx, 
# 627 "project/radare2/libr/util/print.c" 3 4
                                                            unsigned char 
# 627 "project/radare2/libr/util/print.c"
                                                                ch) {
...
# 630 "project/radare2/libr/util/print.c" 3 4
unsigned char 
# 630 "project/radare2/libr/util/print.c"
    rch = ch;
 if (!
# 631 "project/radare2/libr/util/print.c" 3 4
     ((
# 631 "project/radare2/libr/util/print.c"
     ch
# 631 "project/radare2/libr/util/print.c" 3 4
     ) >=' ' && (
# 631 "project/radare2/libr/util/print.c"
...
# 631 "project/radare2/libr/util/print.c"
 ...
 if (p && p->flags & 
# 635 "project/radare2/libr/util/print.c" 3 4
                    0x00000001
# 635 "project/radare2/libr/util/print.c"
                                       ) {
  ...
  if (bytecolor) {
   printfmt("%s", 
# 642 "project/radare2/libr/util/print.c" 3 4
  "\x1b[0m"
# 642 "project/radare2/libr/util/print.c"
  );
  }
 } else {
  printfmt (fmt, rch);
...
# 650 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 650 "project/radare2/libr/util/print.c"
     int r_print_string(RPrint *p, 
# 650 "project/radare2/libr/util/print.c" 3 4
                                   unsigned long long 
# 650 "project/radare2/libr/util/print.c"
                                        seek, const 
# 650 "project/radare2/libr/util/print.c" 3 4
                                                    unsigned char 
# 650 "project/radare2/libr/util/print.c"
                                                        *buf, int len, int options) {
 int i;
 
# 652 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 652 "project/radare2/libr/util/print.c"
     wide = (options & 
# 652 "project/radare2/libr/util/print.c" 3 4
                       1
# 652 "project/radare2/libr/util/print.c"
...
# 653 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 653 "project/radare2/libr/util/print.c"
     wide32 = (options & 
# 653 "project/radare2/libr/util/print.c" 3 4
                         16
# 653 "project/radare2/libr/util/print.c"
...
# 654 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 654 "project/radare2/libr/util/print.c"
     zeroend = (options & 
# 654 "project/radare2/libr/util/print.c" 3 4
                          2
# 654 "project/radare2/libr/util/print.c"
...
# 655 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 655 "project/radare2/libr/util/print.c"
     wrap = (options & 
# 655 "project/radare2/libr/util/print.c" 3 4
                       8
# 655 "project/radare2/libr/util/print.c"
...
# 656 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 656 "project/radare2/libr/util/print.c"
     urlencode = (options & 
# 656 "project/radare2/libr/util/print.c" 3 4
                            4
# 656 "project/radare2/libr/util/print.c"
...
# 657 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 657 "project/radare2/libr/util/print.c"
     esc_nl = (options & 
# 657 "project/radare2/libr/util/print.c" 3 4
                         32
# 657 "project/radare2/libr/util/print.c"
...
# 672 "project/radare2/libr/util/print.c" 3 4
 unsigned char 
# 672 "project/radare2/libr/util/print.c"
     b = buf[i];
  if (b == '\n') {
   col = 0;
  }
...
# 683 "project/radare2/libr/util/print.c" 3 4
                                       ((
# 683 "project/radare2/libr/util/print.c"
                                       b
# 683 "project/radare2/libr/util/print.c" 3 4
                                       ) >=' ' && (
# 683 "project/radare2/libr/util/print.c"
...
# 702 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 702 "project/radare2/libr/util/print.c"
     void r_print_hexpairs(RPrint *p, 
# 702 "project/radare2/libr/util/print.c" 3 4
                                      unsigned long long 
# 702 "project/radare2/libr/util/print.c"
                                           addr, const 
...
static 
# 709 "project/radare2/libr/util/print.c" 3 4
      _Bool 
# 709 "project/radare2/libr/util/print.c"
           checkSparse(const 
# 709 "project/radare2/libr/util/print.c" 3 4
                             unsigned char 
# 709 "project/radare2/libr/util/print.c"
...
# 711 "project/radare2/libr/util/print.c" 3 4
unsigned char 
# 711 "project/radare2/libr/util/print.c"
    q = *p;
 if (ch && ch != q) {
  return 
# 713 "project/radare2/libr/util/print.c" 3 4
        0
# 713 "project/radare2/libr/util/print.c"
             ;
 }
 for (i = 1; i < len; i++) {
  if (p[i] != q) {
   return 
# 717 "project/radare2/libr/util/print.c" 3 4
         0
# 717 "project/radare2/libr/util/print.c"
              ;
  }
 }
 return 
# 720 "project/radare2/libr/util/print.c" 3 4
       1
# 720 "project/radare2/libr/util/print.c"
           ;
}

static 
# 723 "project/radare2/libr/util/print.c" 3 4
      _Bool 
# 723 "project/radare2/libr/util/print.c"
           isAllZeros(const 
# 723 "project/radare2/libr/util/print.c" 3 4
                            unsigned char 
# 723 "project/radare2/libr/util/print.c"
 ...
 for (i = 0; i < len; i++) {
  if (buf[i] != 0) {
   return 
# 727 "project/radare2/libr/util/print.c" 3 4
         0
# 727 "project/radare2/libr/util/print.c"
              ;
  }
 }
 return 
# 730 "project/radare2/libr/util/print.c" 3 4
       1
# 730 "project/radare2/libr/util/print.c"
           ;
}

#define Pal(x,y) (x->cons && x->cons->context->pal.y)? x->cons->context->pal.y

# 734 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 734 "project/radare2/libr/util/print.c"
     void r_print_hexii(RPrint *rp, 
# 734 "project/radare2/libr/util/print.c" 3 4
                                    unsigned long long 
# 734 "project/radare2/libr/util/print.c"
                                         addr, const 
# 734 "project/radare2/libr/util/print.c" 3 4
                                                     unsigned char 
# 734 "project/radare2/libr/util/print.c"
                                                         *buf, int len, int step) {
 PrintfCallback p = (PrintfCallback) rp->cb_printf;
 
# 736 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 736 "project/radare2/libr/util/print.c"
     c = rp->flags & 
# 736 "project/radare2/libr/util/print.c" 3 4
                     0x00000001
# 736 "project/radare2/libr/util/print.c"
                                        ;
 const char *color_0xff = c? ((rp->cons && rp->cons->context->pal.b0xff)? rp->cons->context->pal.b0xff: 
# 737 "project/radare2/libr/util/print.c" 3 4
                                              "\x1b[31m"
# 737 "project/radare2/libr/util/print.c"
                                                       ): "";
 const char *color_text = c? ((rp->cons && rp->cons->context->pal.btext)? rp->cons->context->pal.btext: 
# 738 "project/radare2/libr/util/print.c" 3 4
                                              "\x1b[35m"
# 738 "project/radare2/libr/util/print.c"
                                                           ): "";
 const char *color_other = c? ((rp->cons && rp->cons->context->pal.other)? rp->cons->context->pal.other: 
# 739 "project/radare2/libr/util/print.c" 3 4
                                               "\x1b[37m"
# 739 "project/radare2/libr/util/print.c"
                                                          ): "";
 const char *color_reset = c? 
# 740 "project/radare2/libr/util/print.c" 3 4
                             "\x1b[0m"
# 740 "project/radare2/libr/util/print.c"
                                        : "";
 int i, j;
 
# 742 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 742 "project/radare2/libr/util/print.c"
     show_offset = rp->show_offset;

 if (rp->flags & 
# 744 "project/radare2/libr/util/print.c" 3 4
                0x00000008
# 744 "project/radare2/libr/util/print.c"
                                    ) {
  p ("         ");
  for (i = 0; i < step; i++) {
   p ("%3X", i);
 ...
 for (i = 0; i < len; i += step) {
  int inc = 
# 753 "project/radare2/libr/util/print.c" 3 4
           (((
# 753 "project/radare2/libr/util/print.c"
           step
# 753 "project/radare2/libr/util/print.c" 3 4
           )>(
# 753 "project/radare2/libr/util/print.c"
...
# 753 "project/radare2/libr/util/print.c"
  ...
  if (show_offset) {
   p ("%8"
# 758 "project/radare2/libr/util/print.c" 3 4
         "llx"
# 758 "project/radare2/libr/util/print.c"
                ":", addr + i);
  }
  for (j = 0; j < inc; j++) {
   
# 761 "project/radare2/libr/util/print.c" 3 4
  unsigned char 
# 761 "project/radare2/libr/util/print.c"
      ch = buf[i + j];
   if (ch == 0x00) {
    p ("   ");
   } else if (ch == 0xff) {
...
# 766 "project/radare2/libr/util/print.c" 3 4
             ((
# 766 "project/radare2/libr/util/print.c"
             ch
# 766 "project/radare2/libr/util/print.c" 3 4
             ) >=' ' && (
# 766 "project/radare2/libr/util/print.c"
...
# 766 "project/radare2/libr/util/print.c"
 ...
 p ("%8"
# 774 "project/radare2/libr/util/print.c" 3 4
       "llx"
# 774 "project/radare2/libr/util/print.c"
              " ]\n", addr + i);
}
...
# 779 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 779 "project/radare2/libr/util/print.c"
     void r_print_set_screenbounds(RPrint *p, 
# 779 "project/radare2/libr/util/print.c" 3 4
                                              unsigned long long 
# 779 "project/radare2/libr/util/print.c"
                                                   addr) {
...
# 782 "project/radare2/libr/util/print.c" 3 4
do { if (!(
# 782 "project/radare2/libr/util/print.c"
p
# 782 "project/radare2/libr/util/print.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 782 "project/radare2/libr/util/print.c"
...
# 804 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 804 "project/radare2/libr/util/print.c"
     void r_print_section(RPrint *p, 
# 804 "project/radare2/libr/util/print.c" 3 4
                                     unsigned long long 
# 804 "project/radare2/libr/util/print.c"
                                          at) {
 
# 805 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 805 "project/radare2/libr/util/print.c"
     use_section = p && p->flags & 
# 805 "project/radare2/libr/util/print.c" 3 4
                                   0x00200000
# 805 "project/radare2/libr/util/print.c"
                                                        ;
...
# 817 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 817 "project/radare2/libr/util/print.c"
     void r_print_hexdump(RPrint *p, 
# 817 "project/radare2/libr/util/print.c" 3 4
                                     unsigned long long 
# 817 "project/radare2/libr/util/print.c"
                                          addr, const 
# 817 "project/radare2/libr/util/print.c" 3 4
                                                      unsigned char 
# 817 "project/radare2/libr/util/print.c"
                                                          *buf, int len, int base, int step, size_t zoomsz) {
 
# 818 "project/radare2/libr/util/print.c" 3 4
do { if (!(
# 818 "project/radare2/libr/util/print.c"
buf && len > 0
# 818 "project/radare2/libr/util/print.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 818 "project/radare2/libr/util/print.c"
...
# 821 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 821 "project/radare2/libr/util/print.c"
     c = p? (p->flags & 
# 821 "project/radare2/libr/util/print.c" 3 4
                        0x00000001
# 821 "project/radare2/libr/util/print.c"
...
# 821 "project/radare2/libr/util/print.c"
                                                   ;
 const char *color_title = c? ((p->cons && p->cons->context->pal.offset)? p->cons->context->pal.offset: 
# 822 "project/radare2/libr/util/print.c" 3 4
                                               "\x1b[35m"
# 822 "project/radare2/libr/util/print.c"
                                                            ): "";
 int inc = p? p->cols : 16;
 size_t i, j, k;
 int sparse_char = 0;
...
# 829 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 829 "project/radare2/libr/util/print.c"
     use_header = 
# 829 "project/radare2/libr/util/print.c" 3 4
                  1
# 829 "project/radare2/libr/util/print.c"
...
# 830 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 830 "project/radare2/libr/util/print.c"
     use_hdroff = 
# 830 "project/radare2/libr/util/print.c" 3 4
                  1
# 830 "project/radare2/libr/util/print.c"
...
# 831 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 831 "project/radare2/libr/util/print.c"
     use_pair = 
# 831 "project/radare2/libr/util/print.c" 3 4
                1
# 831 "project/radare2/libr/util/print.c"
...
# 832 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 832 "project/radare2/libr/util/print.c"
     use_offset = 
# 832 "project/radare2/libr/util/print.c" 3 4
                  1
# 832 "project/radare2/libr/util/print.c"
...
# 833 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 833 "project/radare2/libr/util/print.c"
     compact = 
# 833 "project/radare2/libr/util/print.c" 3 4
               0
# 833 "project/radare2/libr/util/print.c"
...
# 834 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 834 "project/radare2/libr/util/print.c"
     use_segoff = 
# 834 "project/radare2/libr/util/print.c" 3 4
                  0
# 834 "project/radare2/libr/util/print.c"
...
# 835 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 835 "project/radare2/libr/util/print.c"
     pairs = 
# 835 "project/radare2/libr/util/print.c" 3 4
             0
# 835 "project/radare2/libr/util/print.c"
...
# 839 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 839 "project/radare2/libr/util/print.c"
     use_hexa = 
# 839 "project/radare2/libr/util/print.c" 3 4
                1
# 839 "project/radare2/libr/util/print.c"
...
# 840 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 840 "project/radare2/libr/util/print.c"
     use_align = 
# 840 "project/radare2/libr/util/print.c" 3 4
                 0
# 840 "project/radare2/libr/util/print.c"
...
# 841 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 841 "project/radare2/libr/util/print.c"
     use_unalloc = 
# 841 "project/radare2/libr/util/print.c" 3 4
                   0
# 841 "project/radare2/libr/util/print.c"
...
# 844 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 844 "project/radare2/libr/util/print.c"
     hex_style = 
# 844 "project/radare2/libr/util/print.c" 3 4
                 0
# 844 "project/radare2/libr/util/print.c"
 ...
 if (p) {
  pairs = p->pairs;
  use_sparse = p->flags & 
# 850 "project/radare2/libr/util/print.c" 3 4
                         0x00000010
# 850 "project/radare2/libr/util/print.c"
                                             ;
  use_header = p->flags & 
# 851 "project/radare2/libr/util/print.c" 3 4
                         0x00000008
# 851 "project/radare2/libr/util/print.c"
                                             ;
  use_hdroff = p->flags & 
# 852 "project/radare2/libr/util/print.c" 3 4
                         0x00008000
# 852 "project/radare2/libr/util/print.c"
                                             ;
  use_segoff = p->flags & 
# 853 "project/radare2/libr/util/print.c" 3 4
                         0x00000020
# 853 "project/radare2/libr/util/print.c"
                                             ;
  use_align = p->flags & 
# 854 "project/radare2/libr/util/print.c" 3 4
                        0x00040000
# 854 "project/radare2/libr/util/print.c"
                                           ;
  use_offset = p->flags & 
# 855 "project/radare2/libr/util/print.c" 3 4
                         0x00000040
# 855 "project/radare2/libr/util/print.c"
                                             ;
  hex_style = p->flags & 
# 856 "project/radare2/libr/util/print.c" 3 4
                        0x00010000
# 856 "project/radare2/libr/util/print.c"
                                           ;
  use_hexa = !(p->flags & 
# 857 "project/radare2/libr/util/print.c" 3 4
                         0x00001000
# 857 "project/radare2/libr/util/print.c"
                                             );
  use_unalloc = p->flags & 
# 858 "project/radare2/libr/util/print.c" 3 4
                          0x00080000
# 858 "project/radare2/libr/util/print.c"
                                               ;
  compact = p->flags & 
# 859 "project/radare2/libr/util/print.c" 3 4
                      0x00000800
# 859 "project/radare2/libr/util/print.c"
                                           ;
  inc = p->cols;
  col = p->col;
 ...
 case 16:
  if (inc < 2) {
   inc = 2;
   use_header = 
# 903 "project/radare2/libr/util/print.c" 3 4
               0
# 903 "project/radare2/libr/util/print.c"
                    ;
  }
  break;
 case 32:
 ...
 if (step == 1 && base < 0) {
  use_header = 
# 924 "project/radare2/libr/util/print.c" 3 4
              0
# 924 "project/radare2/libr/util/print.c"
                   ;
 }
 if (use_header) {
  if (c) {
...
# 944 "project/radare2/libr/util/print.c" 3 4
    unsigned int 
# 944 "project/radare2/libr/util/print.c"
         s, a;
     a = addr & 0xffff;
     s = ((addr - a) >> seggrn) & 0xffff;
     
# 947 "project/radare2/libr/util/print.c" 3 4
    __builtin___snprintf_chk (
# 947 "project/radare2/libr/util/print.c"
    soff
# 947 "project/radare2/libr/util/print.c" 3 4
    , 
# 947 "project/radare2/libr/util/print.c"
...
# 950 "project/radare2/libr/util/print.c" 3 4
    __builtin___snprintf_chk (
# 950 "project/radare2/libr/util/print.c"
    soff
# 950 "project/radare2/libr/util/print.c" 3 4
    , 
# 950 "project/radare2/libr/util/print.c"
...
# 950 "project/radare2/libr/util/print.c"
   ...
   if (use_hexa) {
    ...
    for (i = 0; i < inc; i++) {
     ...
     if (i & 1 || !pairs) {
      if (!compact) {
       printfmt("%s", col != 1? space: ((i + 1) < inc)? space: "|");
      }
     }
    }
   }
   ...
   if (compact) {
    printfmt("%s", col > 0? "|": space);
   } else {
    printfmt("%s", col == 2? "|": space);
   }
   if (!p || !(p->flags & 
# 1001 "project/radare2/libr/util/print.c" 3 4
                         0x00020000
# 1001 "project/radare2/libr/util/print.c"
                                               )) {
    for (i = 0; i < inc; i++) {
     printfmt ("%c", hex[(i + k) % 16]);
    }
  ...
  if (c) {
   printfmt("%s", 
# 1022 "project/radare2/libr/util/print.c" 3 4
  "\x1b[0m"
# 1022 "project/radare2/libr/util/print.c"
  );
  }
 }
...
# 1033 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 1033 "project/radare2/libr/util/print.c"
     printValue = 
# 1033 "project/radare2/libr/util/print.c" 3 4
                  1
# 1033 "project/radare2/libr/util/print.c"
...
# 1034 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 1034 "project/radare2/libr/util/print.c"
     oPrintValue = 
# 1034 "project/radare2/libr/util/print.c" 3 4
                   1
# 1034 "project/radare2/libr/util/print.c"
...
# 1035 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 1035 "project/radare2/libr/util/print.c"
     isPxr = (p && p->flags & 
# 1035 "project/radare2/libr/util/print.c" 3 4
                              0x00000080
# 1035 "project/radare2/libr/util/print.c"
...
# 1069 "project/radare2/libr/util/print.c" 3 4
 unsigned long long 
# 1069 "project/radare2/libr/util/print.c"
      at = addr + (j * zoomsz);
...
# 1075 "project/radare2/libr/util/print.c" 3 4
 unsigned long long 
# 1075 "project/radare2/libr/util/print.c"
      row_have_addr = 
# 1075 "project/radare2/libr/util/print.c" 3 4
                      0xFFFFFFFFFFFFFFFFULL
# 1075 "project/radare2/libr/util/print.c"
  ...
  if (use_hexa) {
   ...
   for (j = i; j < i + inc; j++) {
    ...
    const char *hl = (hex_style && p && p->offname (p->user, addr + j))? 
# 1111 "project/radare2/libr/util/print.c" 3 4
                                                                        "\x1b[7m"
# 1111 "project/radare2/libr/util/print.c"
                                                                                    : 
# 1111 "project/radare2/libr/util/print.c" 3 4
                                                                                      ((void *)0)
# 1111 "project/radare2/libr/util/print.c"
...
# 1119 "project/radare2/libr/util/print.c" 3 4
    unsigned long long 
# 1119 "project/radare2/libr/util/print.c"
         n = 0;
     size_t sz_n = (base == 64)
      ? sizeof (
# 1121 "project/radare2/libr/util/print.c" 3 4
               unsigned long long
# 1121 "project/radare2/libr/util/print.c"
                   ) : (step == 2)
      ? sizeof (
# 1122 "project/radare2/libr/util/print.c" 3 4
               unsigned short
# 1122 "project/radare2/libr/util/print.c"
                   ) : sizeof (
# 1122 "project/radare2/libr/util/print.c" 3 4
                               unsigned int
# 1122 "project/radare2/libr/util/print.c"
     ...
     sz_n = 
# 1123 "project/radare2/libr/util/print.c" 3 4
           (((
# 1123 "project/radare2/libr/util/print.c"
           left
# 1123 "project/radare2/libr/util/print.c" 3 4
           )>(
# 1123 "project/radare2/libr/util/print.c"
...
# 1123 "project/radare2/libr/util/print.c"
     ...
     r_mem_swaporcopy ((
# 1129 "project/radare2/libr/util/print.c" 3 4
                       unsigned char 
# 1129 "project/radare2/libr/util/print.c"
                           *) &n, buf + j, sz_n, p && p->big_endian);
...
# 1136 "project/radare2/libr/util/print.c" 3 4
                                   1
# 1136 "project/radare2/libr/util/print.c"
                                       );
      }
      if (a && *a) {
       b = 
# 1139 "project/radare2/libr/util/print.c" 3 4
          "\x1b[0m"
# 1139 "project/radare2/libr/util/print.c"
                     ;
      } else {
       a = b = "";
      }
     ...
     printValue = 
# 1146 "project/radare2/libr/util/print.c" 3 4
                 1
# 1146 "project/radare2/libr/util/print.c"
                     ;
     
# 1147 "project/radare2/libr/util/print.c" 3 4
    _Bool 
# 1147 "project/radare2/libr/util/print.c"
         hasNull = 
# 1147 "project/radare2/libr/util/print.c" 3 4
                   0
# 1147 "project/radare2/libr/util/print.c"
     ...
     if (isPxr) {
      if (n == 0) {
       if (oPrintValue) {
        hasNull = 
# 1151 "project/radare2/libr/util/print.c" 3 4
                 1
# 1151 "project/radare2/libr/util/print.c"
                     ;
       }
       printValue = 
# 1153 "project/radare2/libr/util/print.c" 3 4
                   0
# 1153 "project/radare2/libr/util/print.c"
                        ;
      }
     }
     if (printValue) {
      ...
      if (base == 64) {
       printfmt ("%s0x%016" 
# 1162 "project/radare2/libr/util/print.c" 3 4
                           "llx" 
# 1162 "project/radare2/libr/util/print.c"
                                   "%s  ", a, (
# 1162 "project/radare2/libr/util/print.c" 3 4
                                               unsigned long long
# 1162 "project/radare2/libr/util/print.c"
       ...
       printfmt ("%s0x%04x%s ", a, (
# 1164 "project/radare2/libr/util/print.c" 3 4
                                   unsigned short
# 1164 "project/radare2/libr/util/print.c"
                                       ) n, b);
      } else {
       printfmt ("%s0x%08x%s ", a, (
# 1166 "project/radare2/libr/util/print.c" 3 4
                                   unsigned int
# 1166 "project/radare2/libr/util/print.c"
                                       ) n, b);
      }
     } else {
      if (hasNull) {
       const char *n = p? p->offname (p->user, addr + j): 
# 1170 "project/radare2/libr/util/print.c" 3 4
                                                         ((void *)0)
# 1170 "project/radare2/libr/util/print.c"
                                                             ;
       r_print_section (p, at);
       r_print_addr (p, addr + j * zoomsz);
     ...
     printfmt ("%23" 
# 1182 "project/radare2/libr/util/print.c" 3 4
                    "lld" 
# 1182 "project/radare2/libr/util/print.c"
                            " ", w);
     r_print_cursor (p, j, 8, 0);
     j += 7;
    } else if (base == -1) {
     
# 1186 "project/radare2/libr/util/print.c" 3 4
    signed char 
# 1186 "project/radare2/libr/util/print.c"
        w = r_read_ble8 (buf + j);
...
# 1192 "project/radare2/libr/util/print.c" 3 4
     short 
# 1192 "project/radare2/libr/util/print.c"
          w = r_read_ble16 (buf + j, p && p->big_endian);
     ...
     if (p && use_unalloc && !p->iob.is_valid_offset (p->iob.io, addr + j, 
# 1210 "project/radare2/libr/util/print.c" 3 4
                                                                          0
# 1210 "project/radare2/libr/util/print.c"
                                                                               )) {
...
# 1218 "project/radare2/libr/util/print.c" 3 4
     _Bool 
# 1218 "project/radare2/libr/util/print.c"
    ...
    if (hl) {
     printfmt("%s", 
# 1239 "project/radare2/libr/util/print.c" 3 4
    "\x1b[0m"
# 1239 "project/radare2/libr/util/print.c"
    );
    }
    bytes++;
   }
  ...
  if (printValue) {
   ...
   if (!p || !(p->flags & 
# 1256 "project/radare2/libr/util/print.c" 3 4
                         0x00020000
# 1256 "project/radare2/libr/util/print.c"
                                               )) {
    bytes = 0;
    size_t end = i + inc;
    for (j = i; j < end; j++) {
...
# 1270 "project/radare2/libr/util/print.c" 3 4
    unsigned char 
# 1270 "project/radare2/libr/util/print.c"
        ch = (use_unalloc && p && !p->iob.is_valid_offset (p->iob.io, addr + j, 
# 1270 "project/radare2/libr/util/print.c" 3 4
                                                                                0
# 1270 "project/radare2/libr/util/print.c"
                                                                                     ))
...
# 1273 "project/radare2/libr/util/print.c" 3 4
     unsigned char 
# 1273 "project/radare2/libr/util/print.c"
         input[2] = {ch, 0};
      
# 1274 "project/radare2/libr/util/print.c" 3 4
     unsigned char 
# 1274 "project/radare2/libr/util/print.c"
         output[32];
...
# 1290 "project/radare2/libr/util/print.c" 3 4
  _Bool 
# 1290 "project/radare2/libr/util/print.c"
       eol = 
# 1290 "project/radare2/libr/util/print.c" 3 4
             0
# 1290 "project/radare2/libr/util/print.c"
                  ;
   if (!eol && p && p->flags & 
# 1291 "project/radare2/libr/util/print.c" 3 4
                              0x00000080
# 1291 "project/radare2/libr/util/print.c"
                                                ) {
    
# 1292 "project/radare2/libr/util/print.c" 3 4
   unsigned long long 
# 1292 "project/radare2/libr/util/print.c"
        off = 
# 1292 "project/radare2/libr/util/print.c" 3 4
              0xFFFFFFFFFFFFFFFFULL
# 1292 "project/radare2/libr/util/print.c"
    ...
    if (inc == 8) {
     if (i + sizeof (
# 1294 "project/radare2/libr/util/print.c" 3 4
                    unsigned long long
# 1294 "project/radare2/libr/util/print.c"
                        ) - 1 < len) {
      off = r_read_le64 (buf + i);
     }
    } else if (inc == 4) {
     if (i + sizeof (
# 1298 "project/radare2/libr/util/print.c" 3 4
                    unsigned int
# 1298 "project/radare2/libr/util/print.c"
                        ) - 1 < len) {
      off = r_read_le32 (buf + i);
     }
    } else if (inc == 2 && base == 16) {
     if (i + sizeof (
# 1302 "project/radare2/libr/util/print.c" 3 4
                    unsigned short
# 1302 "project/radare2/libr/util/print.c"
                        ) - 1 < len) {
      off = r_read_le16 (buf + i);
      if (off == 0) {
       off = 
# 1305 "project/radare2/libr/util/print.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 1305 "project/radare2/libr/util/print.c"
                    ;
      }
     }
    }
    if (p->hasrefs && off != 
# 1309 "project/radare2/libr/util/print.c" 3 4
                            0xFFFFFFFFFFFFFFFFULL
# 1309 "project/radare2/libr/util/print.c"
                                    ) {
     char *rstr = p->hasrefs (p->user, addr + i, 
# 1310 "project/radare2/libr/util/print.c" 3 4
                                                0
# 1310 "project/radare2/libr/util/print.c"
                                                     );
     if (rstr && *rstr) {
      printfmt (" @ %s", rstr);
     }
     free (rstr);
     rstr = p->hasrefs (p->user, off, 
# 1315 "project/radare2/libr/util/print.c" 3 4
                                     1
# 1315 "project/radare2/libr/util/print.c"
                                         );
     if (rstr && *rstr) {
      printfmt (" %s", rstr);
     }
...
# 1322 "project/radare2/libr/util/print.c" 3 4
  _Bool 
# 1322 "project/radare2/libr/util/print.c"
       first = 
# 1322 "project/radare2/libr/util/print.c" 3 4
               1
# 1322 "project/radare2/libr/util/print.c"
   ...
   if (!eol && p && p->use_comments) {
    ...
    for (j = i; j < i + inc; j++) {
     ...
     if (p && p->offname) {
      ...
      if (p->colorfor && a && *a) {
       const char *color = p->colorfor (p->user, addr + j, 
# 1334 "project/radare2/libr/util/print.c" 3 4
                                                          1
# 1334 "project/radare2/libr/util/print.c"
                                                              );
       printfmt ("%s  ; %s%s", r_str_get (color), a,
         color ? 
# 1336 "project/radare2/libr/util/print.c" 3 4
                "\x1b[0m" 
# 1336 "project/radare2/libr/util/print.c"
                            : "");
      }
     }
     ...
     if (comment) {
      if (p && p->colorfor) {
       a = p->colorfor (p->user, addr + j, 
# 1342 "project/radare2/libr/util/print.c" 3 4
                                          1
# 1342 "project/radare2/libr/util/print.c"
                                              );
       if (
# 1343 "project/radare2/libr/util/print.c" 3 4
          (!(
# 1343 "project/radare2/libr/util/print.c"
          a
# 1343 "project/radare2/libr/util/print.c" 3 4
          ) || !*(
# 1343 "project/radare2/libr/util/print.c"
...
# 1343 "project/radare2/libr/util/print.c"
      ...
      if (strchr (comment, '\n')) {
       ...
       char *q = s;
       while (
# 1352 "project/radare2/libr/util/print.c" 3 4
             1
# 1352 "project/radare2/libr/util/print.c"
                 ) {
        char *nl = strchr (q, '\n');
        if (nl) {
         *nl = 0;
        ...
        if (first) {
         printfmt ("%s 2; %s", a, q);
         first = 
# 1359 "project/radare2/libr/util/print.c" 3 4
                0
# 1359 "project/radare2/libr/util/print.c"
                     ;
        } else {
  ...
  if (p && p->cfmt && *p->cfmt) {
   if (row_have_cursor != -1) {
    ...
    p->coreb.cmdf (p->coreb.core,
      "%s @ 0x%08"
# 1404 "project/radare2/libr/util/print.c" 3 4
                 "llx"
# 1404 "project/radare2/libr/util/print.c"
...
# 1410 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 1410 "project/radare2/libr/util/print.c"
     void r_print_hexdump_simple(const 
# 1410 "project/radare2/libr/util/print.c" 3 4
                                       unsigned char 
# 1410 "project/radare2/libr/util/print.c"
                                           *buf, int len) {
 r_print_hexdump (
# 1411 "project/radare2/libr/util/print.c" 3 4
                 ((void *)0)
# 1411 "project/radare2/libr/util/print.c"
                     , 0, buf, len, 16, 16, 0);
}

static const char* getbytediff(RPrint *p, char *fmt, 
# 1414 "project/radare2/libr/util/print.c" 3 4
                                                    unsigned char 
# 1414 "project/radare2/libr/util/print.c"
                                                        a, 
# 1414 "project/radare2/libr/util/print.c" 3 4
                                                           unsigned char 
# 1414 "project/radare2/libr/util/print.c"
...
# 1417 "project/radare2/libr/util/print.c" 3 4
  __builtin___sprintf_chk (
# 1417 "project/radare2/libr/util/print.c"
  fmt
# 1417 "project/radare2/libr/util/print.c" 3 4
  , 0, __builtin_object_size (
# 1417 "project/radare2/libr/util/print.c"
...
# 1417 "project/radare2/libr/util/print.c" 3 4
  "\x1b[0m"
# 1417 "project/radare2/libr/util/print.c"
  , p->cons->context->pal.graph_true, a
# 1417 "project/radare2/libr/util/print.c" 3 4
  )
# 1417 "project/radare2/libr/util/print.c"
                                                                          ;
...
# 1419 "project/radare2/libr/util/print.c" 3 4
  __builtin___sprintf_chk (
# 1419 "project/radare2/libr/util/print.c"
  fmt
# 1419 "project/radare2/libr/util/print.c" 3 4
  , 0, __builtin_object_size (
# 1419 "project/radare2/libr/util/print.c"
...
# 1419 "project/radare2/libr/util/print.c" 3 4
  "\x1b[0m"
# 1419 "project/radare2/libr/util/print.c"
  , p->cons->context->pal.graph_false, a
# 1419 "project/radare2/libr/util/print.c" 3 4
  )
# 1419 "project/radare2/libr/util/print.c"
                                                                           ;
...
# 1422 "project/radare2/libr/util/print.c" 3 4
 __builtin___sprintf_chk (
# 1422 "project/radare2/libr/util/print.c"
 fmt
# 1422 "project/radare2/libr/util/print.c" 3 4
 , 0, __builtin_object_size (
# 1422 "project/radare2/libr/util/print.c"
...
static const char* getchardiff(RPrint *p, char *fmt, 
# 1427 "project/radare2/libr/util/print.c" 3 4
                                                    unsigned char 
# 1427 "project/radare2/libr/util/print.c"
                                                        a, 
# 1427 "project/radare2/libr/util/print.c" 3 4
                                                           unsigned char 
# 1427 "project/radare2/libr/util/print.c"
                                                               b) {
 char ch = 
# 1428 "project/radare2/libr/util/print.c" 3 4
          ((
# 1428 "project/radare2/libr/util/print.c"
          a
# 1428 "project/radare2/libr/util/print.c" 3 4
          ) >=' ' && (
# 1428 "project/radare2/libr/util/print.c"
...
# 1431 "project/radare2/libr/util/print.c" 3 4
  __builtin___sprintf_chk (
# 1431 "project/radare2/libr/util/print.c"
  fmt
# 1431 "project/radare2/libr/util/print.c" 3 4
  , 0, __builtin_object_size (
# 1431 "project/radare2/libr/util/print.c"
...
# 1431 "project/radare2/libr/util/print.c" 3 4
  "\x1b[0m"
# 1431 "project/radare2/libr/util/print.c"
  , p->cons->context->pal.graph_true, ch
# 1431 "project/radare2/libr/util/print.c" 3 4
  )
# 1431 "project/radare2/libr/util/print.c"
                                                                         ;
...
# 1433 "project/radare2/libr/util/print.c" 3 4
  __builtin___sprintf_chk (
# 1433 "project/radare2/libr/util/print.c"
  fmt
# 1433 "project/radare2/libr/util/print.c" 3 4
  , 0, __builtin_object_size (
# 1433 "project/radare2/libr/util/print.c"
...
# 1433 "project/radare2/libr/util/print.c" 3 4
  "\x1b[0m"
# 1433 "project/radare2/libr/util/print.c"
  , p->cons->context->pal.graph_false, ch
# 1433 "project/radare2/libr/util/print.c" 3 4
  )
# 1433 "project/radare2/libr/util/print.c"
                                                                          ;
...
# 1436 "project/radare2/libr/util/print.c" 3 4
 __builtin___sprintf_chk (
# 1436 "project/radare2/libr/util/print.c"
 fmt
# 1436 "project/radare2/libr/util/print.c" 3 4
 , 0, __builtin_object_size (
# 1436 "project/radare2/libr/util/print.c"
...
static 
# 1445 "project/radare2/libr/util/print.c" 3 4
      unsigned char
# 1445 "project/radare2/libr/util/print.c"
         * M(const 
# 1445 "project/radare2/libr/util/print.c" 3 4
                   unsigned char 
# 1445 "project/radare2/libr/util/print.c"
...
# 1446 "project/radare2/libr/util/print.c" 3 4
unsigned char 
# 1446 "project/radare2/libr/util/print.c"
    *r = malloc (len + 16);
 if (r) {
  
# 1448 "project/radare2/libr/util/print.c" 3 4
 __builtin___memset_chk (
# 1448 "project/radare2/libr/util/print.c"
 r
# 1448 "project/radare2/libr/util/print.c" 3 4
 , 
# 1448 "project/radare2/libr/util/print.c"
...
# 1449 "project/radare2/libr/util/print.c" 3 4
 __builtin___memcpy_chk (
# 1449 "project/radare2/libr/util/print.c"
 r
# 1449 "project/radare2/libr/util/print.c" 3 4
 , 
# 1449 "project/radare2/libr/util/print.c"
...
# 1455 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 1455 "project/radare2/libr/util/print.c"
     void r_print_hexdiff(RPrint *p, 
# 1455 "project/radare2/libr/util/print.c" 3 4
                                     unsigned long long 
# 1455 "project/radare2/libr/util/print.c"
                                          aa, const 
...
# 1455 "project/radare2/libr/util/print.c" 3 4
                                                                            unsigned char 
# 1455 "project/radare2/libr/util/print.c"
                                                                                *_b, int len, int scndcol) {
 
# 1456 "project/radare2/libr/util/print.c" 3 4
unsigned char 
# 1456 "project/radare2/libr/util/print.c"
    *a, *b;
 char linediff, fmt[64];
 int color = p->flags & 
# 1458 "project/radare2/libr/util/print.c" 3 4
                       0x00000001
# 1458 "project/radare2/libr/util/print.c"
                                          ;
 int diffskip = p->flags & 
# 1459 "project/radare2/libr/util/print.c" 3 4
                          0x00000100
# 1459 "project/radare2/libr/util/print.c"
                                               ;
 int i, j, min;
 if (!((a = M (_a, len)))) {
  return;
 ...
 for (i = 0; i < len; i += 16) {
  min = 
# 1469 "project/radare2/libr/util/print.c" 3 4
       (((
# 1469 "project/radare2/libr/util/print.c"
       16
# 1469 "project/radare2/libr/util/print.c" 3 4
       )>(
# 1469 "project/radare2/libr/util/print.c"
...
# 1469 "project/radare2/libr/util/print.c"
  ...
  p->cb_printf ("0x%08" 
# 1474 "project/radare2/libr/util/print.c" 3 4
                       "llx" 
# 1474 "project/radare2/libr/util/print.c"
                               " ", aa + i);
  for (j = 0; j < min; j++) {
   *fmt = color;
   r_print_cursor (p, i + j, 1, 1);
   p->cb_printf ("%s", getbytediff (p, fmt, (a)[i + j], (b)[i + j]));
   ...
   *fmt = color;
   r_print_cursor (p, i + j, 1, 1);
   p->cb_printf ("%s", getchardiff (p, fmt, (a)[i + j], (b)[i + j]));
   r_print_cursor (p, i + j, 1, 0);
  }
  if (scndcol) {
   p->cb_printf (" %c 0x%08" 
# 1489 "project/radare2/libr/util/print.c" 3 4
                            "llx" 
# 1489 "project/radare2/libr/util/print.c"
                                    " ", linediff, ba + i);
   for (j = 0; j < min; j++) {
    *fmt = color;
    r_print_cursor (p, i + j, 1, 1);
    p->cb_printf ("%s", getbytediff (p, fmt, (b)[i + j], (a)[i + j]));
    r_print_cursor (p, i + j, 1, 0);
   }
   p->cb_printf (" ");
   for (j = 0; j < min; j++) {
    *fmt = color;
    r_print_cursor (p, i + j, 1, 1);
    p->cb_printf ("%s", getchardiff (p, fmt, (b)[i + j], (a)[i + j]));
    r_print_cursor (p, i + j, 1, 0);
   }
   p->cb_printf ("\n");
  } else {
...
# 1512 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 1512 "project/radare2/libr/util/print.c"
     void r_print_bytes(RPrint *p, const 
# 1512 "project/radare2/libr/util/print.c" 3 4
                                         unsigned char 
# 1512 "project/radare2/libr/util/print.c"
                                             *buf, int len, const char *fmt) {
 int i;
 if (p) {
  for (i = 0; i < len; i++) {
...
# 1527 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 1527 "project/radare2/libr/util/print.c"
     void r_print_raw(RPrint *p, 
# 1527 "project/radare2/libr/util/print.c" 3 4
                                 unsigned long long 
# 1527 "project/radare2/libr/util/print.c"
                                      addr, const 
...
# 1527 "project/radare2/libr/util/print.c"
 ...
 case 2:
 {
  ...
  for (i = 0; i < len; i += cols) {
   p->cb_printf ("0x%08"
# 1537 "project/radare2/libr/util/print.c" 3 4
                       "llx"
# 1537 "project/radare2/libr/util/print.c"
                              "  ", addr + i);
   for (j = 0; j < cols; j++) {
    if ((i + j) >= len) {
     break;
    ...
    if (p->cur_enabled) {
     r_print_cursor (p, i + j, 1, 1);
     p->cb_printf ("%c", 
# 1545 "project/radare2/libr/util/print.c" 3 4
                        ((
# 1545 "project/radare2/libr/util/print.c"
                        ch
# 1545 "project/radare2/libr/util/print.c" 3 4
                        ) >=' ' && (
# 1545 "project/radare2/libr/util/print.c"
...
# 1545 "project/radare2/libr/util/print.c"
     ...
     p->cb_printf ("%c", 
# 1548 "project/radare2/libr/util/print.c" 3 4
                        ((
# 1548 "project/radare2/libr/util/print.c"
                        ch
# 1548 "project/radare2/libr/util/print.c" 3 4
                        ) >=' ' && (
# 1548 "project/radare2/libr/util/print.c"
...
# 1548 "project/radare2/libr/util/print.c"
 ...
 {
  const 
# 1557 "project/radare2/libr/util/print.c" 3 4
       unsigned char 
# 1557 "project/radare2/libr/util/print.c"
           *o, *q;
  
# 1558 "project/radare2/libr/util/print.c" 3 4
 unsigned long long 
# 1558 "project/radare2/libr/util/print.c"
      off;
  
# 1559 "project/radare2/libr/util/print.c" 3 4
 _Bool 
# 1559 "project/radare2/libr/util/print.c"
      mustbreak;
  ...
  do {
   ...
   if (p->lines_cache_sz > 0 && p->lines_abs) {
    p->cb_printf ("%d 0x%08" 
# 1567 "project/radare2/libr/util/print.c" 3 4
                            "llx" 
# 1567 "project/radare2/libr/util/print.c"
                                    " ", linenum_abs, off);
   } else {
    p->cb_printf ("+%d 0x%08" 
# 1569 "project/radare2/libr/util/print.c" 3 4
                             "llx" 
# 1569 "project/radare2/libr/util/print.c"
                                     " ", linenum, off);
   }
   for (; i < len && *q && *q != '\n'; q++, i++) {
...
# 1590 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 1590 "project/radare2/libr/util/print.c"
     void r_print_c(RPrint *p, const 
# 1590 "project/radare2/libr/util/print.c" 3 4
                                     unsigned char 
# 1590 "project/radare2/libr/util/print.c"
                                         *str, int len) {
...
# 1613 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 1613 "project/radare2/libr/util/print.c"
     void r_print_progressbar(RPrint *p, int pc, int _cols) {

 int i, cols = (_cols == -1)? 78: _cols;
 if (!p) {
  p = &staticp;
 }
 const char *h_line = p->cons->use_utf8 ? 
# 1619 "project/radare2/libr/util/print.c" 3 4
                                         "―" 
# 1619 "project/radare2/libr/util/print.c"
                                                              : "-";
 const char *block = p->cons->use_utf8 ? 
# 1620 "project/radare2/libr/util/print.c" 3 4
                                        "\u2588" 
# 1620 "project/radare2/libr/util/print.c"
                                                     : "#";

 pc = 
# 1622 "project/radare2/libr/util/print.c" 3 4
     (((
# 1622 "project/radare2/libr/util/print.c"
     0
# 1622 "project/radare2/libr/util/print.c" 3 4
     )>((((
# 1622 "project/radare2/libr/util/print.c"
...
# 1622 "project/radare2/libr/util/print.c"
                               ;
 if (p->flags & 
# 1623 "project/radare2/libr/util/print.c" 3 4
               0x00000008
# 1623 "project/radare2/libr/util/print.c"
                                   ) {
  p->cb_printf ("%4d%% ", pc);
 }
 cols -= 15;
...
# 1638 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 1638 "project/radare2/libr/util/print.c"
     void r_print_progressbar_with_count(RPrint *p, unsigned int pc, unsigned int total, int _cols, 
# 1638 "project/radare2/libr/util/print.c" 3 4
                                                                                                    _Bool 
# 1638 "project/radare2/libr/util/print.c"
                                                                                                         reset_line) {
 ...
 const 
# 1643 "project/radare2/libr/util/print.c" 3 4
      _Bool 
# 1643 "project/radare2/libr/util/print.c"
           enable_colors = p && (p->flags & 
# 1643 "project/radare2/libr/util/print.c" 3 4
                                            0x00000001
# 1643 "project/radare2/libr/util/print.c"
                                                               );
 const char *h_line = p->cons->use_utf8? 
# 1644 "project/radare2/libr/util/print.c" 3 4
                                        "―"
# 1644 "project/radare2/libr/util/print.c"
                                                            : "-";
 const char *block = p->cons->use_utf8? 
# 1645 "project/radare2/libr/util/print.c" 3 4
                                       "\u2588"
# 1645 "project/radare2/libr/util/print.c"
                                                   : "#";

 total = 
# 1647 "project/radare2/libr/util/print.c" 3 4
        (((
# 1647 "project/radare2/libr/util/print.c"
        1
# 1647 "project/radare2/libr/util/print.c" 3 4
        )>(
# 1647 "project/radare2/libr/util/print.c"
...
# 1647 "project/radare2/libr/util/print.c"
                        ;
 pc = 
# 1648 "project/radare2/libr/util/print.c" 3 4
     (((
# 1648 "project/radare2/libr/util/print.c"
     0
# 1648 "project/radare2/libr/util/print.c" 3 4
     )>((((
# 1648 "project/radare2/libr/util/print.c"
...
# 1648 "project/radare2/libr/util/print.c"
 ...
 if (p->flags & 
# 1652 "project/radare2/libr/util/print.c" 3 4
               0x00000008
# 1652 "project/radare2/libr/util/print.c"
                                   ) {
  if (enable_colors) {
   p->cb_printf ("%s%4d%s%% %s%6d%s/%6d%s ", 
# 1654 "project/radare2/libr/util/print.c" 3 4
                                            "\x1b[32m"
# 1654 "project/radare2/libr/util/print.c"
                                                       , pc * 100 / total, 
# 1654 "project/radare2/libr/util/print.c" 3 4
                                                                           "\x1b[0m"
# 1654 "project/radare2/libr/util/print.c"
...
# 1654 "project/radare2/libr/util/print.c"
 ...
 if (cols > 0) {
  if (enable_colors) {
   p->cb_printf ("[%s", 
# 1663 "project/radare2/libr/util/print.c" 3 4
                       "\x1b[33m"
# 1663 "project/radare2/libr/util/print.c"
                                   );
  } else {
   p->cb_printf ("[");
  }
  ...
  if (enable_colors) {
   p->cb_printf ("%s", 
# 1671 "project/radare2/libr/util/print.c" 3 4
                      "\x1b[0m"
# 1671 "project/radare2/libr/util/print.c"
                                 );
  }
  ...
  if (enable_colors) {
   p->cb_printf ("%s]", 
# 1677 "project/radare2/libr/util/print.c" 3 4
                       "\x1b[0m"
# 1677 "project/radare2/libr/util/print.c"
                                  );
  }
  else {
   p->cb_printf ("]");
...
# 1685 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 1685 "project/radare2/libr/util/print.c"
     void r_print_rangebar(RPrint *p, 
# 1685 "project/radare2/libr/util/print.c" 3 4
                                      unsigned long long 
# 1685 "project/radare2/libr/util/print.c"
                                           startA, 
...
# 1685 "project/radare2/libr/util/print.c"
                                                                             max, int cols) {
 const char *h_line = p->cons->use_utf8? 
# 1686 "project/radare2/libr/util/print.c" 3 4
                                        "―"
# 1686 "project/radare2/libr/util/print.c"
                                                            : "-";
 const char *block = p->cons->use_utf8? 
# 1687 "project/radare2/libr/util/print.c" 3 4
                                       "\u2588"
# 1687 "project/radare2/libr/util/print.c"
                                                   : "#";
 const 
# 1688 "project/radare2/libr/util/print.c" 3 4
      _Bool 
# 1688 "project/radare2/libr/util/print.c"
           show_colors = p->flags & 
# 1688 "project/radare2/libr/util/print.c" 3 4
                                    0x00000001
# 1688 "project/radare2/libr/util/print.c"
...
# 1695 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 1695 "project/radare2/libr/util/print.c"
     isFirst = 
# 1695 "project/radare2/libr/util/print.c" 3 4
               1
# 1695 "project/radare2/libr/util/print.c"
...
# 1697 "project/radare2/libr/util/print.c" 3 4
 unsigned long long 
# 1697 "project/radare2/libr/util/print.c"
      startB = min + (j * mul);
  
# 1698 "project/radare2/libr/util/print.c" 3 4
 unsigned long long 
# 1698 "project/radare2/libr/util/print.c"
      endB = min + ((j + 1) * mul);
  if (startA <= endB && endA >= startB) {
   if (show_colors & isFirst) {
    p->cb_printf (
# 1701 "project/radare2/libr/util/print.c" 3 4
                 "\x1b[32m"
# 1701 "project/radare2/libr/util/print.c"
                            );
    isFirst = 
# 1702 "project/radare2/libr/util/print.c" 3 4
             0
# 1702 "project/radare2/libr/util/print.c"
                  ;
   }
   p->cb_printf ("%s", block);
  } else {
   if (!isFirst) {
    p->cb_printf (
# 1707 "project/radare2/libr/util/print.c" 3 4
                 "\x1b[0m"
# 1707 "project/radare2/libr/util/print.c"
                            );
   }
   p->cb_printf ("%s", h_line);
  }
...
# 1715 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 1715 "project/radare2/libr/util/print.c"
     void r_print_zoom_buf(RPrint *p, void *user, RPrintZoomCallback cb, 
# 1715 "project/radare2/libr/util/print.c" 3 4
                                                                         unsigned long long 
# 1715 "project/radare2/libr/util/print.c"
                                                                              from, 
# 1715 "project/radare2/libr/util/print.c" 3 4
                                                                                    unsigned long long 
# 1715 "project/radare2/libr/util/print.c"
                                                                                         to, int len, int maxlen) {
 static int mode = -1;
 
# 1717 "project/radare2/libr/util/print.c" 3 4
unsigned char 
# 1717 "project/radare2/libr/util/print.c"
    *bufz = 
# 1717 "project/radare2/libr/util/print.c" 3 4
            ((void *)0)
# 1717 "project/radare2/libr/util/print.c"
...
# 1719 "project/radare2/libr/util/print.c" 3 4
unsigned long long 
# 1719 "project/radare2/libr/util/print.c"
     size = (to - from);
 size = len? size / len: 0;
 ...
 if (mode == p->zoom->mode && from == p->zoom->from && to == p->zoom->to && size == p->zoom->size) {
  ...
  mode = p->zoom->mode;
  bufz = (
# 1741 "project/radare2/libr/util/print.c" 3 4
         unsigned char 
# 1741 "project/radare2/libr/util/print.c"
             *) calloc (1, len);
  if (!bufz) {
   return;
  }
  bufz2 = (
# 1745 "project/radare2/libr/util/print.c" 3 4
          unsigned char 
# 1745 "project/radare2/libr/util/print.c"
              *) calloc (1, size);
  if (!bufz2) {
   free (bufz);
   return;
...
# 1770 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 1770 "project/radare2/libr/util/print.c"
     void r_print_zoom(RPrint *p, void *user, RPrintZoomCallback cb, 
# 1770 "project/radare2/libr/util/print.c" 3 4
                                                                     unsigned long long 
# 1770 "project/radare2/libr/util/print.c"
                                                                          from, 
...
# 1771 "project/radare2/libr/util/print.c" 3 4
unsigned long long 
# 1771 "project/radare2/libr/util/print.c"
     size = (to - from);
 r_print_zoom_buf (p, user, cb, from, to, len, maxlen);
 size = len? size / len: 0;
 p->flags &= ~
# 1774 "project/radare2/libr/util/print.c" 3 4
             0x00000008
# 1774 "project/radare2/libr/util/print.c"
                                 ;
 r_print_hexdump (p, from, p->zoom->buf, p->zoom->size, 16, 1, size);
 p->flags |= 
# 1776 "project/radare2/libr/util/print.c" 3 4
            0x00000008
# 1776 "project/radare2/libr/util/print.c"
                                ;
}
...
static inline void printHistBlock (RPrint *p, int k, int cols) {
 RConsPrintablePalette *pal = &p->cons->context->pal;
 const char *h_line = p->cons->use_utf8 ? 
# 1781 "project/radare2/libr/util/print.c" 3 4
                                         "―" 
# 1781 "project/radare2/libr/util/print.c"
                                                              : "-";
 const char *block = p->cons->use_utf8 ? 
# 1782 "project/radare2/libr/util/print.c" 3 4
                                        "\u2588" 
# 1782 "project/radare2/libr/util/print.c"
                                                     : "#";
 const char *kol[5];
 kol[0] = pal->nop;
 kol[1] = pal->mov;
 ...
 const 
# 1792 "project/radare2/libr/util/print.c" 3 4
      _Bool 
# 1792 "project/radare2/libr/util/print.c"
           show_colors = (p && (p->flags & 
# 1792 "project/radare2/libr/util/print.c" 3 4
                                           0x00000001
# 1792 "project/radare2/libr/util/print.c"
                                                              ));
 if (show_colors) {
  ...
  if (p->histblock) {
   p->cb_printf ("%s%s%s", str, block, 
# 1797 "project/radare2/libr/util/print.c" 3 4
                                      "\x1b[0m"
# 1797 "project/radare2/libr/util/print.c"
                                                 );
  } else {
   p->cb_printf ("%s%s%s", str, h_line, 
# 1799 "project/radare2/libr/util/print.c" 3 4
                                       "\x1b[0m"
# 1799 "project/radare2/libr/util/print.c"
                                                  );
  }
 } else {
  if (p->histblock) {
...
# 1810 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 1810 "project/radare2/libr/util/print.c"
     void r_print_fill(RPrint *p, const 
# 1810 "project/radare2/libr/util/print.c" 3 4
                                        unsigned char 
# 1810 "project/radare2/libr/util/print.c"
                                            *arr, int size, 
...
# 1811 "project/radare2/libr/util/print.c" 3 4
do { if (!(
# 1811 "project/radare2/libr/util/print.c"
p && arr
# 1811 "project/radare2/libr/util/print.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1811 "project/radare2/libr/util/print.c"
...
# 1811 "project/radare2/libr/util/print.c"
                           ;
 const 
# 1812 "project/radare2/libr/util/print.c" 3 4
      _Bool 
# 1812 "project/radare2/libr/util/print.c"
           show_colors = (p && (p->flags & 
# 1812 "project/radare2/libr/util/print.c" 3 4
                                           0x00000001
# 1812 "project/radare2/libr/util/print.c"
 ...
 const 
# 1813 "project/radare2/libr/util/print.c" 3 4
      _Bool 
# 1813 "project/radare2/libr/util/print.c"
           show_offset = (p && (p->flags & 
# 1813 "project/radare2/libr/util/print.c" 3 4
                                           0x00000040
# 1813 "project/radare2/libr/util/print.c"
                                                               ));
 
# 1814 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 1814 "project/radare2/libr/util/print.c"
     useUtf8 = p->cons->use_utf8;
 const char *v_line = useUtf8 ? 
# 1815 "project/radare2/libr/util/print.c" 3 4
                               "│" 
# 1815 "project/radare2/libr/util/print.c"
                                              : "|";
 int i = 0, j;

#define INC 5
# 1834 "project/radare2/libr/util/print.c"
 int cols = 0;
 for (i = 0; i < size; i++) {
...
# 1840 "project/radare2/libr/util/print.c" 3 4
 unsigned char 
# 1840 "project/radare2/libr/util/print.c"
     next = (i + 1 < size)? arr[i + 1]: 0;
  int base = 0, k = 0;
  if (addr != 
# 1842 "project/radare2/libr/util/print.c" 3 4
             0xFFFFFFFFFFFFFFFFULL 
# 1842 "project/radare2/libr/util/print.c"
                      && step > 0) {
   
# 1843 "project/radare2/libr/util/print.c" 3 4
  unsigned long long 
# 1843 "project/radare2/libr/util/print.c"
       at = addr + (i * step);
   if (show_offset) {
    if (p->cur_enabled) {
     if (i == p->cur) {
      p->cb_printf (
# 1847 "project/radare2/libr/util/print.c" 3 4
                   "\x1b[7m"
# 1847 "project/radare2/libr/util/print.c"
                               "> 0x%08" 
# 1847 "project/radare2/libr/util/print.c" 3 4
                                         "llx" 
# 1847 "project/radare2/libr/util/print.c"
...
# 1847 "project/radare2/libr/util/print.c"
      ...
      p->cb_printf ("  0x%08" 
# 1852 "project/radare2/libr/util/print.c" 3 4
                             "llx" 
# 1852 "project/radare2/libr/util/print.c"
                                     " ", at);
     }
    } else {
     p->cb_printf ("0x%08" 
# 1855 "project/radare2/libr/util/print.c" 3 4
                          "llx" 
# 1855 "project/radare2/libr/util/print.c"
                                  " ", at);
    }
   }
  ...
  if (next < arr[i]) {
   if (arr[i] > 5) {
    for (j = 0; j < next + base; j += 5) {
     printHistBlock (p, k, cols);
     k++;
    }
   }
   for (j = next + 5; j + base < arr[i]; j += 5) {
    printHistBlock (p, k, cols);
    k++;
   }
  } else {
  ...
  if (i + 1 == size) {
   for (j = arr[i] + 5 + base; j + base < next; j += 5) {
    printHistBlock (p, k, cols);
    k++;
   }
  ...
  if (show_colors) {
   p->cb_printf ("%s", 
# 1892 "project/radare2/libr/util/print.c" 3 4
                      "\x1b[0m"
# 1892 "project/radare2/libr/util/print.c"
                                 );
  }
  p->cb_printf ("\n");
 }
...
# 1898 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 1898 "project/radare2/libr/util/print.c"
     void r_print_2bpp_row(RPrint *p, 
# 1898 "project/radare2/libr/util/print.c" 3 4
                                      unsigned char 
# 1898 "project/radare2/libr/util/print.c"
                                          *buf, const char **colors) {
 const 
# 1899 "project/radare2/libr/util/print.c" 3 4
      _Bool 
# 1899 "project/radare2/libr/util/print.c"
           useColor = p? (p->flags & 
# 1899 "project/radare2/libr/util/print.c" 3 4
                                     0x00000001
# 1899 "project/radare2/libr/util/print.c"
...
# 1899 "project/radare2/libr/util/print.c"
 ...
 for (i = 0; i < 8; i++) {
  ...
  if (useColor) {
   ...
   if (p) {
    p->cb_printf ("%s%c%c"
# 1914 "project/radare2/libr/util/print.c" 3 4
                         "\x1b[0m"
# 1914 "project/radare2/libr/util/print.c"
                                    , color, ch, ch);
   } else {
    printf ("%s%c%c"
# 1916 "project/radare2/libr/util/print.c" 3 4
                   "\x1b[0m"
# 1916 "project/radare2/libr/util/print.c"
                              , color, ch, ch);
   }
  } else {
   if (p) {
...
static void r_print_2bpp_newline(RPrint *p, 
# 1929 "project/radare2/libr/util/print.c" 3 4
                                           _Bool 
# 1929 "project/radare2/libr/util/print.c"
                                                useColor) {
 if (p) {
  if (useColor) {
   p->cb_printf (
# 1932 "project/radare2/libr/util/print.c" 3 4
                "\x1b[0m" 
# 1932 "project/radare2/libr/util/print.c"
                            "\n");
  } else {
   p->cb_printf ("\n");
  }
...
# 1941 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 1941 "project/radare2/libr/util/print.c"
     void r_print_2bpp_tiles(RPrint *p, 
# 1941 "project/radare2/libr/util/print.c" 3 4
                                        unsigned char 
# 1941 "project/radare2/libr/util/print.c"
                                            *buf, size_t buflen, 
# 1941 "project/radare2/libr/util/print.c" 3 4
                                                                 unsigned int 
# 1941 "project/radare2/libr/util/print.c"
                                                                      tiles, const char **colors) {
 if (!colors) {
  colors = (const char *[]){
   
# 1944 "project/radare2/libr/util/print.c" 3 4
  "\x1b[47m"
# 1944 "project/radare2/libr/util/print.c"
               ,
   
# 1945 "project/radare2/libr/util/print.c" 3 4
  "\x1b[41m"
# 1945 "project/radare2/libr/util/print.c"
             ,
   
# 1946 "project/radare2/libr/util/print.c" 3 4
  "\x1b[44m"
# 1946 "project/radare2/libr/util/print.c"
              ,
   
# 1947 "project/radare2/libr/util/print.c" 3 4
  "\x1b[40m"
# 1947 "project/radare2/libr/util/print.c"
               ,
  };
 }
 int i, r;
 const 
# 1951 "project/radare2/libr/util/print.c" 3 4
      _Bool 
# 1951 "project/radare2/libr/util/print.c"
           useColor = p? (p->flags & 
# 1951 "project/radare2/libr/util/print.c" 3 4
                                     0x00000001
# 1951 "project/radare2/libr/util/print.c"
...
# 1956 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 1956 "project/radare2/libr/util/print.c"
     eof = 
# 1956 "project/radare2/libr/util/print.c" 3 4
           0
# 1956 "project/radare2/libr/util/print.c"
 ...
 for (row = 1; row < rows; row++) {
  for (i = 0; i < 8 && !eof; i++) {
   for (r = 0; r < tiles; r++) {
    ...
    if (off >= buflen) {
     eof = 
# 1963 "project/radare2/libr/util/print.c" 3 4
          1
# 1963 "project/radare2/libr/util/print.c"
              ;
     break;
    }
...
# 1975 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 1975 "project/radare2/libr/util/print.c"
     const char* r_print_color_op_type(RPrint *p, 
# 1975 "project/radare2/libr/util/print.c" 3 4
                                                  unsigned int 
# 1975 "project/radare2/libr/util/print.c"
                                                       anal_type) {
 RConsPrintablePalette *pal = &p->cons->context->pal;
 switch (anal_type & 
# 1977 "project/radare2/libr/util/print.c" 3 4
                    0x8000ffff
# 1977 "project/radare2/libr/util/print.c"
                                       ) {
...
static 
# 2061 "project/radare2/libr/util/print.c" 3 4
      _Bool 
# 2061 "project/radare2/libr/util/print.c"
           issymbol(char c) {
 switch (c) {
 case '$':
 case ':':
 ...
 case '}':
  return 
# 2080 "project/radare2/libr/util/print.c" 3 4
        1
# 2080 "project/radare2/libr/util/print.c"
            ;
 default:
  return 
# 2082 "project/radare2/libr/util/print.c" 3 4
        0
# 2082 "project/radare2/libr/util/print.c"
             ;
 }
}

static 
# 2086 "project/radare2/libr/util/print.c" 3 4
      _Bool 
# 2086 "project/radare2/libr/util/print.c"
           check_arg_name(RPrint *print, char *p, 
# 2086 "project/radare2/libr/util/print.c" 3 4
                                                  unsigned long long 
# 2086 "project/radare2/libr/util/print.c"
                                                       func_addr) {
...
# 2094 "project/radare2/libr/util/print.c" 3 4
 _Bool 
# 2094 "project/radare2/libr/util/print.c"
      ret = print->exists_var (print, func_addr, p);
  p[z] = tmp;
  return ret;
 }
 return 
# 2098 "project/radare2/libr/util/print.c" 3 4
       0
# 2098 "project/radare2/libr/util/print.c"
            ;
}

static 
# 2101 "project/radare2/libr/util/print.c" 3 4
      _Bool 
# 2101 "project/radare2/libr/util/print.c"
           ishexprefix(char *p) {
 return (p[0] == '0' && p[1] == 'x');
}


# 2105 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 2105 "project/radare2/libr/util/print.c"
     char* r_print_colorize_opcode(RPrint *print, char *p, const char *reg, const char *num, 
# 2105 "project/radare2/libr/util/print.c" 3 4
                                                                                             _Bool 
# 2105 "project/radare2/libr/util/print.c"
                                                                                                  partial_reset, 
...
# 2105 "project/radare2/libr/util/print.c"
 ...
 char *reset = partial_reset ? 
# 2107 "project/radare2/libr/util/print.c" 3 4
                              "\x1b[27;22;24;25;28;39m" 
# 2107 "project/radare2/libr/util/print.c"
                                               : 
# 2107 "project/radare2/libr/util/print.c" 3 4
                                                 "\x1b[0m"
# 2107 "project/radare2/libr/util/print.c"
...
# 2108 "project/radare2/libr/util/print.c" 3 4
unsigned int 
# 2108 "project/radare2/libr/util/print.c"
     c_reset = strlen (reset);
 int is_jmp = p && (*p == 'j' || ((*p == 'c') && (p[1] == 'a')))? 1: 0;
 
# 2110 "project/radare2/libr/util/print.c" 3 4
unsigned int 
# 2110 "project/radare2/libr/util/print.c"
     opcode_sz = p && *p? strlen (p) * 10 + 1: 0;
 char previous = '\0';
 const char *color_flag = print->cons->context->pal.flag;

 if (!p || !*p) {
  return 
# 2115 "project/radare2/libr/util/print.c" 3 4
        ((void *)0)
# 2115 "project/radare2/libr/util/print.c"
            ;
 }
 if (is_jmp) {
  return strdup (p);
...
# 2126 "project/radare2/libr/util/print.c" 3 4
__builtin___memset_chk (
# 2126 "project/radare2/libr/util/print.c"
o
# 2126 "project/radare2/libr/util/print.c" 3 4
, 
# 2126 "project/radare2/libr/util/print.c"
...
# 2126 "project/radare2/libr/util/print.c"
 ...
 for (i = j = 0; p[i]; i++, j++) {
  ...
  if ((ishexprefix (&p[i]) && previous != ':')
       || (isdigit ((
# 2130 "project/radare2/libr/util/print.c" 3 4
                    unsigned char
# 2130 "project/radare2/libr/util/print.c"
                       )p[i]) && issymbol (previous))) {
   const char *num2 = num;
   
# 2132 "project/radare2/libr/util/print.c" 3 4
  unsigned long long 
# 2132 "project/radare2/libr/util/print.c"
       n = r_num_get (
# 2132 "project/radare2/libr/util/print.c" 3 4
                      ((void *)0)
# 2132 "project/radare2/libr/util/print.c"
                          , p + i);
   const char *name = print->offname (print->user, n)? color_flag: 
# 2133 "project/radare2/libr/util/print.c" 3 4
                                                                  ((void *)0)
# 2133 "project/radare2/libr/util/print.c"
                                                                      ;
   if (name) {
    num2 = name;
   }
...
# 2139 "project/radare2/libr/util/print.c" 3 4
   fprintf(__stderrp,
# 2139 "project/radare2/libr/util/print.c"
   "Colorize buffer is too small\n"
# 2139 "project/radare2/libr/util/print.c" 3 4
   )
# 2139 "project/radare2/libr/util/print.c"
                                             ;
...
# 2142 "project/radare2/libr/util/print.c" 3 4
  __builtin___memcpy_chk (
# 2142 "project/radare2/libr/util/print.c"
  o + j
# 2142 "project/radare2/libr/util/print.c" 3 4
  , 
# 2142 "project/radare2/libr/util/print.c"
...
# 2147 "project/radare2/libr/util/print.c" 3 4
  fprintf(__stderrp,
# 2147 "project/radare2/libr/util/print.c"
  "r_print_colorize_opcode(): buffer overflow!\n"
# 2147 "project/radare2/libr/util/print.c" 3 4
  )
# 2147 "project/radare2/libr/util/print.c"
                                                           ;
...
#define STRIP_ANSI 1
  ...
  case ',':
   ...
   if (is_float) {
    ...
    if (c_reset + j + 10 >= 1024) {
     
# 2187 "project/radare2/libr/util/print.c" 3 4
    fprintf(__stderrp,
# 2187 "project/radare2/libr/util/print.c"
    "r_print_colorize_opcode(): buffer overflow!\n"
# 2187 "project/radare2/libr/util/print.c" 3 4
    )
# 2187 "project/radare2/libr/util/print.c"
...
# 2191 "project/radare2/libr/util/print.c" 3 4
   _Bool 
# 2191 "project/radare2/libr/util/print.c"
        found_var = check_arg_name (print, p + i + 1, func_addr);
    
# 2192 "project/radare2/libr/util/print.c" 3 4
   __builtin___strcpy_chk (
# 2192 "project/radare2/libr/util/print.c"
   o + j
# 2192 "project/radare2/libr/util/print.c" 3 4
   , 
# 2192 "project/radare2/libr/util/print.c"
...
# 2197 "project/radare2/libr/util/print.c" 3 4
    unsigned int 
# 2197 "project/radare2/libr/util/print.c"
         color_len = strlen (color);
     if (color_len + j + 10 >= 1024) {
      
# 2199 "project/radare2/libr/util/print.c" 3 4
     fprintf(__stderrp,
# 2199 "project/radare2/libr/util/print.c"
     "r_print_colorize_opcode(): buffer overflow!\n"
# 2199 "project/radare2/libr/util/print.c" 3 4
     )
# 2199 "project/radare2/libr/util/print.c"
...
# 2202 "project/radare2/libr/util/print.c" 3 4
    __builtin___strcpy_chk (
# 2202 "project/radare2/libr/util/print.c"
    o + j + 1
# 2202 "project/radare2/libr/util/print.c" 3 4
    , 
# 2202 "project/radare2/libr/util/print.c"
...
# 2227 "project/radare2/libr/util/print.c" 3 4
   __builtin___strcpy_chk (
# 2227 "project/radare2/libr/util/print.c"
   o + j
# 2227 "project/radare2/libr/util/print.c" 3 4
   , 
# 2227 "project/radare2/libr/util/print.c"
...
# 2235 "project/radare2/libr/util/print.c" 3 4
   unsigned int 
# 2235 "project/radare2/libr/util/print.c"
        reg_len = strlen (reg);

    if (reg_len + j + 10 >= 1024) {
     
# 2238 "project/radare2/libr/util/print.c" 3 4
    fprintf(__stderrp,
# 2238 "project/radare2/libr/util/print.c"
    "r_print_colorize_opcode(): buffer overflow!\n"
# 2238 "project/radare2/libr/util/print.c" 3 4
    )
# 2238 "project/radare2/libr/util/print.c"
...
# 2241 "project/radare2/libr/util/print.c" 3 4
   __builtin___strcpy_chk (
# 2241 "project/radare2/libr/util/print.c"
   o + j
# 2241 "project/radare2/libr/util/print.c" 3 4
   , 
# 2241 "project/radare2/libr/util/print.c"
...
# 2241 "project/radare2/libr/util/print.c"
  ...
  case '0':
   if (p[i + 1] == 'x') {
    if (print->flags & 
# 2247 "project/radare2/libr/util/print.c" 3 4
                      0x00002000
# 2247 "project/radare2/libr/util/print.c"
                                          ) {
     RIOMap *map = print->iob.map_get_at (print->iob.io, r_num_get (
# 2248 "project/radare2/libr/util/print.c" 3 4
                                                                   ((void *)0)
# 2248 "project/radare2/libr/util/print.c"
                                                                       , p + i));
     if (map && map->name) {
      if (strlen (map->name) + j + 1 >= 1024) {
       
# 2251 "project/radare2/libr/util/print.c" 3 4
      fprintf(__stderrp,
# 2251 "project/radare2/libr/util/print.c"
...
# 2254 "project/radare2/libr/util/print.c" 3 4
     __builtin___strcpy_chk (
# 2254 "project/radare2/libr/util/print.c"
     o + j
# 2254 "project/radare2/libr/util/print.c" 3 4
     , 
# 2254 "project/radare2/libr/util/print.c"
...
# 2256 "project/radare2/libr/util/print.c" 3 4
     __builtin___strcpy_chk (
# 2256 "project/radare2/libr/util/print.c"
     o + j
# 2256 "project/radare2/libr/util/print.c" 3 4
     , 
# 2256 "project/radare2/libr/util/print.c"
...
# 2269 "project/radare2/libr/util/print.c" 3 4
 __builtin___memmove_chk (
# 2269 "project/radare2/libr/util/print.c"
 o
# 2269 "project/radare2/libr/util/print.c" 3 4
 , 
# 2269 "project/radare2/libr/util/print.c"
...
# 2272 "project/radare2/libr/util/print.c" 3 4
__builtin___strcpy_chk (
# 2272 "project/radare2/libr/util/print.c"
o + j
# 2272 "project/radare2/libr/util/print.c" 3 4
, 
# 2272 "project/radare2/libr/util/print.c"
...
# 2278 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 2278 "project/radare2/libr/util/print.c"
     void r_print_init_rowoffsets(RPrint *p) {
 if (p->calc_row_offsets) {
  
# 2280 "project/radare2/libr/util/print.c" 3 4
 { free((void *)
# 2280 "project/radare2/libr/util/print.c"
 p->row_offsets
# 2280 "project/radare2/libr/util/print.c" 3 4
 ); 
# 2280 "project/radare2/libr/util/print.c"
...
# 2286 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 2286 "project/radare2/libr/util/print.c"
     void r_print_set_rowoff(RPrint *p, int i, 
# 2286 "project/radare2/libr/util/print.c" 3 4
                                               unsigned int 
# 2286 "project/radare2/libr/util/print.c"
                                                    offset, 
...
# 2286 "project/radare2/libr/util/print.c"
 ...
 if (!p->row_offsets || !p->row_offsets_sz) {
  p->row_offsets_sz = 
# 2294 "project/radare2/libr/util/print.c" 3 4
                     (((
# 2294 "project/radare2/libr/util/print.c"
                     i + 1
# 2294 "project/radare2/libr/util/print.c" 3 4
                     )>(
# 2294 "project/radare2/libr/util/print.c"
...
# 2294 "project/radare2/libr/util/print.c"
                                             ;
  p->row_offsets = 
# 2295 "project/radare2/libr/util/print.c" 3 4
                  (unsigned int*)malloc(sizeof(unsigned int)*(
# 2295 "project/radare2/libr/util/print.c"
                  p->row_offsets_sz
# 2295 "project/radare2/libr/util/print.c" 3 4
                  ))
# 2295 "project/radare2/libr/util/print.c"
 ...
 if (i >= p->row_offsets_sz) {
  ...
  new_size = sizeof (
# 2304 "project/radare2/libr/util/print.c" 3 4
                    unsigned int
# 2304 "project/radare2/libr/util/print.c"
                        ) * p->row_offsets_sz;
...
# 2312 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) unsigned int 
# 2312 "project/radare2/libr/util/print.c"
          r_print_rowoff(RPrint *p, int i) {
 if (i < 0 || i >= p->row_offsets_sz) {
  return 
# 2314 "project/radare2/libr/util/print.c" 3 4
        0xFFFFFFFFU
# 2314 "project/radare2/libr/util/print.c"
                ;
 }
...
# 2321 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 2321 "project/radare2/libr/util/print.c"
     int r_print_row_at_off(RPrint *p, 
# 2321 "project/radare2/libr/util/print.c" 3 4
                                       unsigned int 
# 2321 "project/radare2/libr/util/print.c"
                                            offset) {
...
# 2323 "project/radare2/libr/util/print.c" 3 4
unsigned int 
# 2323 "project/radare2/libr/util/print.c"
     tt;
 while ((tt = r_print_rowoff (p, i)) != 
# 2324 "project/radare2/libr/util/print.c" 3 4
                                       0xFFFFFFFFU 
# 2324 "project/radare2/libr/util/print.c"
                                                && tt <= offset) {
  i++;
 }
 return tt != 
# 2327 "project/radare2/libr/util/print.c" 3 4
             0xFFFFFFFFU
# 2327 "project/radare2/libr/util/print.c"
                     ? i - 1: -1;
}


# 2330 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 2330 "project/radare2/libr/util/print.c"
     int r_print_get_cursor(RPrint *p) {
 return p->cur_enabled? p->cur: 0;
}


# 2334 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 2334 "project/radare2/libr/util/print.c"
     int r_print_jsondump(RPrint *p, const 
# 2334 "project/radare2/libr/util/print.c" 3 4
                                           unsigned char 
# 2334 "project/radare2/libr/util/print.c"
                                               *buf, int len, int wordsize) {
 
# 2335 "project/radare2/libr/util/print.c" 3 4
unsigned short 
# 2335 "project/radare2/libr/util/print.c"
     *buf16 = (
# 2335 "project/radare2/libr/util/print.c" 3 4
               unsigned short
# 2335 "project/radare2/libr/util/print.c"
...
# 2336 "project/radare2/libr/util/print.c" 3 4
unsigned int 
# 2336 "project/radare2/libr/util/print.c"
     *buf32 = (
# 2336 "project/radare2/libr/util/print.c" 3 4
               unsigned int
# 2336 "project/radare2/libr/util/print.c"
...
# 2337 "project/radare2/libr/util/print.c" 3 4
unsigned long long 
# 2337 "project/radare2/libr/util/print.c"
     *buf64 = (
# 2337 "project/radare2/libr/util/print.c" 3 4
               unsigned long long
# 2337 "project/radare2/libr/util/print.c"
...
# 2355 "project/radare2/libr/util/print.c" 3 4
  unsigned short 
# 2355 "project/radare2/libr/util/print.c"
       w16 = r_read_ble16 (&buf16[i], p->big_endian);
   p->cb_printf ("%s%hd", i ? "," : "", w16);
   break;
  }
  case 32: {
   
# 2360 "project/radare2/libr/util/print.c" 3 4
  unsigned int 
# 2360 "project/radare2/libr/util/print.c"
       w32 = r_read_ble32 (&buf32[i], p->big_endian);
   p->cb_printf ("%s%d", i ? "," : "", w32);
   break;
  }
  case 64: {
   
# 2365 "project/radare2/libr/util/print.c" 3 4
  unsigned long long 
# 2365 "project/radare2/libr/util/print.c"
       w64 = r_read_ble64 (&buf64[i], p->big_endian);
   p->cb_printf ("%s%"
# 2366 "project/radare2/libr/util/print.c" 3 4
                     "lld"
# 2366 "project/radare2/libr/util/print.c"
                            , i ? "," : "", w64);
   break;
  }
  }
...
# 2375 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 2375 "project/radare2/libr/util/print.c"
     void r_print_hex_from_bin(RPrint *p, char *bin_str) {
 int i, j, index;
...
# 2382 "project/radare2/libr/util/print.c" 3 4
unsigned long long 
# 2382 "project/radare2/libr/util/print.c"
     n, *buf = malloc (sizeof (
# 2382 "project/radare2/libr/util/print.c" 3 4
                               unsigned long long
# 2382 "project/radare2/libr/util/print.c"
...
# 2384 "project/radare2/libr/util/print.c" 3 4
 fprintf(__stderrp,
# 2384 "project/radare2/libr/util/print.c"
 "allocation failed\n"
# 2384 "project/radare2/libr/util/print.c" 3 4
 )
# 2384 "project/radare2/libr/util/print.c"
 ...
 for (i = len - 1, index = 0; i >= 0; i -= 64, index++) {
  ...
  for (j = 0; j < 64 && i - j >= 0; j++) {
   n += (
# 2393 "project/radare2/libr/util/print.c" 3 4
        unsigned long long
# 2393 "project/radare2/libr/util/print.c"
            ) (bin_str[i - j] - '0') << j;
  }
  buf[index] = n;
 }
 ...
 p->cb_printf ("%" 
# 2402 "project/radare2/libr/util/print.c" 3 4
                  "llx"
# 2402 "project/radare2/libr/util/print.c"
                         , buf[index]);
 index--;
 for (i = index; i >= 0; i--) {
  p->cb_printf ("%016" 
# 2405 "project/radare2/libr/util/print.c" 3 4
                      "llx"
# 2405 "project/radare2/libr/util/print.c"
                             , buf[i]);
 }
 p->cb_printf ("\n");
 free (buf);
...
# 2411 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 2411 "project/radare2/libr/util/print.c"
     const char* r_print_rowlog(RPrint *print, const char *str) {
 int use_color = print->flags & 
# 2412 "project/radare2/libr/util/print.c" 3 4
                               0x00000001
# 2412 "project/radare2/libr/util/print.c"
                                                  ;
 
# 2413 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 2413 "project/radare2/libr/util/print.c"
     verbose = print->scr_prompt;
 
# 2414 "project/radare2/libr/util/print.c" 3 4
do { if (!(
# 2414 "project/radare2/libr/util/print.c"
print->cb_eprintf
# 2414 "project/radare2/libr/util/print.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 2414 "project/radare2/libr/util/print.c"
"print->cb_eprintf"
# 2414 "project/radare2/libr/util/print.c" 3 4
, 2414); return (((void *)0)); } } while (0)
# 2414 "project/radare2/libr/util/print.c"
                                              ;
 if (!verbose) {
  return 
# 2416 "project/radare2/libr/util/print.c" 3 4
        ((void *)0)
# 2416 "project/radare2/libr/util/print.c"
            ;
 }
 if (use_color) {
  print->cb_eprintf ("[ ] "
# 2419 "project/radare2/libr/util/print.c" 3 4
                          "\x1b[33m"
# 2419 "project/radare2/libr/util/print.c"
                                      "%s\r["
# 2419 "project/radare2/libr/util/print.c" 3 4
                                             "\x1b[0m"
# 2419 "project/radare2/libr/util/print.c"
...
# 2426 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 2426 "project/radare2/libr/util/print.c"
     void r_print_rowlog_done(RPrint *print, const char *str) {
 int use_color = print->flags & 
# 2427 "project/radare2/libr/util/print.c" 3 4
                               0x00000001
# 2427 "project/radare2/libr/util/print.c"
                                                  ;
 
# 2428 "project/radare2/libr/util/print.c" 3 4
_Bool 
# 2428 "project/radare2/libr/util/print.c"
     verbose = print->scr_prompt;
 
# 2429 "project/radare2/libr/util/print.c" 3 4
do { if (!(
# 2429 "project/radare2/libr/util/print.c"
print->cb_eprintf
# 2429 "project/radare2/libr/util/print.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 2429 "project/radare2/libr/util/print.c"
...
# 2429 "project/radare2/libr/util/print.c"
 ...
 if (verbose) {
  if (use_color) {
   print->cb_eprintf ("\r"
# 2432 "project/radare2/libr/util/print.c" 3 4
                         "\x1b[32m"
# 2432 "project/radare2/libr/util/print.c"
                                    "[x]"
# 2432 "project/radare2/libr/util/print.c" 3 4
                                         "\x1b[0m"
# 2432 "project/radare2/libr/util/print.c"
...
# 2440 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 2440 "project/radare2/libr/util/print.c"
     RBraile r_print_braile(int u) {
#define CH0(x) ((x) >> 8)
#define CH1(x) ((x) & 0xff)
 RBraile b = {0};
 b.str[0] = 0xe2;
...
# 2451 "project/radare2/libr/util/print.c" 3 4
__attribute__((visibility("default"))) 
# 2451 "project/radare2/libr/util/print.c"
     void r_print_graphline(RPrint *print, const 
# 2451 "project/radare2/libr/util/print.c" 3 4
                                                 unsigned char 
# 2451 "project/radare2/libr/util/print.c"
                                                     *buf, size_t len) {
 const 
# 2452 "project/radare2/libr/util/print.c" 3 4
      _Bool 
# 2452 "project/radare2/libr/util/print.c"
           utf8 = print->cons->use_utf8;
 if (utf8) {
  size_t i;
  for (i = 0; i < len; i++) {
   int brailechar = 0;
   
# 2457 "project/radare2/libr/util/print.c" 3 4
  unsigned char 
# 2457 "project/radare2/libr/util/print.c"
      ch = buf[i];
   switch (0|(ch / 64)) {
   case 0:
    brailechar = 
# 2460 "project/radare2/libr/util/print.c" 3 4
                (1 << 8) 
# 2460 "project/radare2/libr/util/print.c"
                    + 
# 2460 "project/radare2/libr/util/print.c" 3 4
                      (2 << 8)
# 2460 "project/radare2/libr/util/print.c"
   ...
   case 1:
    brailechar = 
# 2463 "project/radare2/libr/util/print.c" 3 4
                4 
# 2463 "project/radare2/libr/util/print.c"
                    + 
# 2463 "project/radare2/libr/util/print.c" 3 4
                      32
# 2463 "project/radare2/libr/util/print.c"
   ...
   case 2:
    brailechar = 
# 2466 "project/radare2/libr/util/print.c" 3 4
                2 
# 2466 "project/radare2/libr/util/print.c"
                    + 
# 2466 "project/radare2/libr/util/print.c" 3 4
                      16
# 2466 "project/radare2/libr/util/print.c"
   ...
   case 3:
    brailechar = 
# 2469 "project/radare2/libr/util/print.c" 3 4
                1 
# 2469 "project/radare2/libr/util/print.c"
                    + 
# 2469 "project/radare2/libr/util/print.c" 3 4
                      8
# 2469 "project/radare2/libr/util/print.c"
