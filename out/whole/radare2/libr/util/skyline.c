# 0 "project/radare2/libr/util/skyline.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/skyline.c"
...
# 6 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_skyline.h" 2 3 4
...
# 4 "project/radare2/libr/util/skyline.c" 2

#define CMP_BEGIN_GTE_PART(addr,part) (((addr) > (r_itv_begin (((RSkylineItem *)(part))->itv))) - ((addr) < (r_itv_begin (((RSkylineItem *)(part))->itv))))


#define CMP_END_GTE_PART(addr,part) (((addr) < (r_itv_end (((RSkylineItem *)(part))->itv)) || !r_itv_end (((RSkylineItem *)(part))->itv)) ? -1 : 1)


__attribute__((visibility("default"))) _Bool 
# 11 "project/radare2/libr/util/skyline.c"
          r_skyline_add(RSkyline *skyline, RInterval itv, void *user) {
 
# 12 "project/radare2/libr/util/skyline.c" 3 4
do { if (!(
# 12 "project/radare2/libr/util/skyline.c"
skyline && r_itv_size (itv)
# 12 "project/radare2/libr/util/skyline.c" 3 4
...
# 12 "project/radare2/libr/util/skyline.c"
 ...
 const 
# 15 "project/radare2/libr/util/skyline.c" 3 4
      unsigned long long 
# 15 "project/radare2/libr/util/skyline.c"
           new_part_end = r_itv_end (new_part.itv);


 size_t slot;
 
# 19 "project/radare2/libr/util/skyline.c" 3 4
do { size_t h = (
# 19 "project/radare2/libr/util/skyline.c"
skyline_vec
# 19 "project/radare2/libr/util/skyline.c" 3 4
)->len, m; for (
# 19 "project/radare2/libr/util/skyline.c"
...
# 19 "project/radare2/libr/util/skyline.c"
(((new_part.itv.addr) > (r_itv_begin (((RSkylineItem *)(
# 19 "project/radare2/libr/util/skyline.c" 3 4
((char *)(
# 19 "project/radare2/libr/util/skyline.c"
skyline_vec
...
# 19 "project/radare2/libr/util/skyline.c"
))->itv))) - ((new_part.itv.addr) < (r_itv_begin (((RSkylineItem *)(
# 19 "project/radare2/libr/util/skyline.c" 3 4
((char *)(
# 19 "project/radare2/libr/util/skyline.c"
skyline_vec
...
slot 
# 19 "project/radare2/libr/util/skyline.c" 3 4
= m + 1; } else { h = m; } } } while (0)
# 19 "project/radare2/libr/util/skyline.c"
                                                                               ;
 const 
# 20 "project/radare2/libr/util/skyline.c" 3 4
      _Bool 
# 20 "project/radare2/libr/util/skyline.c"
           is_last = slot == r_vector_len (skyline_vec);
 
# 21 "project/radare2/libr/util/skyline.c" 3 4
_Bool 
# 21 "project/radare2/libr/util/skyline.c"
     is_inside_prev_part = 
# 21 "project/radare2/libr/util/skyline.c" 3 4
                           0
# 21 "project/radare2/libr/util/skyline.c"
 ...
 if (slot) {
  ...
  const 
# 24 "project/radare2/libr/util/skyline.c" 3 4
       unsigned long long 
# 24 "project/radare2/libr/util/skyline.c"
            prev_part_end = r_itv_end (prev_part->itv);
  if (prev_part_end > r_itv_begin (new_part.itv)) {
   ...
   if (prev_part_end > new_part_end) {
    ...
    is_inside_prev_part = 
# 33 "project/radare2/libr/util/skyline.c" 3 4
                         1
# 33 "project/radare2/libr/util/skyline.c"
                             ;
   }
  }
 }
 if (!is_last && !is_inside_prev_part) {
  ...
  while (part && r_itv_include (new_part.itv, part->itv)) {
   ...
   r_vector_remove_at (skyline_vec, slot, 
# 41 "project/radare2/libr/util/skyline.c" 3 4
                                         ((void *)0)
# 41 "project/radare2/libr/util/skyline.c"
                                             );
   part = slot < r_vector_len (skyline_vec) ? r_vector_index_ptr (skyline_vec, slot) : 
# 42 "project/radare2/libr/util/skyline.c" 3 4
                                                                                      ((void *)0)
# 42 "project/radare2/libr/util/skyline.c"
                                                                                          ;
  }
  if (part && r_itv_overlap (new_part.itv, part->itv)) {

   const 
# 46 "project/radare2/libr/util/skyline.c" 3 4
        unsigned long long 
# 46 "project/radare2/libr/util/skyline.c"
             oaddr = r_itv_begin (part->itv);
 ...
 return 
# 52 "project/radare2/libr/util/skyline.c" 3 4
       1
# 52 "project/radare2/libr/util/skyline.c"
           ;
}


# 55 "project/radare2/libr/util/skyline.c" 3 4
__attribute__((visibility("default"))) 
# 55 "project/radare2/libr/util/skyline.c"
     const RSkylineItem *r_skyline_get_item_intersect(RSkyline *skyline, 
# 55 "project/radare2/libr/util/skyline.c" 3 4
                                                                         unsigned long long 
# 55 "project/radare2/libr/util/skyline.c"
                                                                              addr, 
...
# 56 "project/radare2/libr/util/skyline.c" 3 4
do { if (!(
# 56 "project/radare2/libr/util/skyline.c"
skyline
# 56 "project/radare2/libr/util/skyline.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 56 "project/radare2/libr/util/skyline.c"
"skyline"
# 56 "project/radare2/libr/util/skyline.c" 3 4
, 56); return (((void *)0)); } } while (0)
# 56 "project/radare2/libr/util/skyline.c"
                                    ;
 RVector *skyline_vec = &skyline->v;
 size_t i, l = r_vector_len (skyline_vec);
 
# 59 "project/radare2/libr/util/skyline.c" 3 4
do { size_t h = (
# 59 "project/radare2/libr/util/skyline.c"
skyline_vec
# 59 "project/radare2/libr/util/skyline.c" 3 4
)->len, m; for (
# 59 "project/radare2/libr/util/skyline.c"
...
# 59 "project/radare2/libr/util/skyline.c"
 ...
 if (i == l) {
  return 
# 61 "project/radare2/libr/util/skyline.c" 3 4
        0
# 61 "project/radare2/libr/util/skyline.c"
             ;
 }
 const RSkylineItem *item = r_vector_index_ptr (skyline_vec, i);
 return item->itv.addr <= addr + len ? item : 
# 64 "project/radare2/libr/util/skyline.c" 3 4
                                             ((void *)0)
# 64 "project/radare2/libr/util/skyline.c"
                                                 ;
}
