# 0 "project/radare2/libr/util/ascii_table.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/ascii_table.c"
...
# 4 "project/radare2/libr/util/ascii_table.c" 2


# 5 "project/radare2/libr/util/ascii_table.c"
...
# 77 "project/radare2/libr/util/ascii_table.c" 3 4
__attribute__((visibility("default"))) 
# 77 "project/radare2/libr/util/ascii_table.c"
     const char *ret_ascii_table(void) {
 return ascii_table;
}
