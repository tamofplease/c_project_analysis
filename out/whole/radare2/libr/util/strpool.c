# 0 "project/radare2/libr/util/strpool.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/strpool.c"
...
# 4 "project/radare2/libr/util/strpool.c" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/util/strpool.c"
     RStrpool* r_strpool_new(int sz) {
 RStrpool *p = 
# 6 "project/radare2/libr/util/strpool.c" 3 4
              (
# 6 "project/radare2/libr/util/strpool.c"
              RStrpool
# 6 "project/radare2/libr/util/strpool.c" 3 4
              *)malloc(sizeof(
# 6 "project/radare2/libr/util/strpool.c"
...
# 8 "project/radare2/libr/util/strpool.c" 3 4
 fprintf(__stderrp,
# 8 "project/radare2/libr/util/strpool.c"
 "Malloc failed!\n"
# 8 "project/radare2/libr/util/strpool.c" 3 4
 )
# 8 "project/radare2/libr/util/strpool.c"
                             ;
  return 
# 9 "project/radare2/libr/util/strpool.c" 3 4
        ((void *)0)
# 9 "project/radare2/libr/util/strpool.c"
            ;
 }
 if (sz < 1) {
  sz = 1024;
...
# 16 "project/radare2/libr/util/strpool.c" 3 4
 fprintf(__stderrp,
# 16 "project/radare2/libr/util/strpool.c"
 "Malloc failed!\n"
# 16 "project/radare2/libr/util/strpool.c" 3 4
 )
# 16 "project/radare2/libr/util/strpool.c"
  ...
  free (p);
  return 
# 18 "project/radare2/libr/util/strpool.c" 3 4
        ((void *)0)
# 18 "project/radare2/libr/util/strpool.c"
            ;
 }
 p->size = sz;
 p->len = 0;
...
# 26 "project/radare2/libr/util/strpool.c" 3 4
__attribute__((visibility("default"))) 
# 26 "project/radare2/libr/util/strpool.c"
     char *r_strpool_empty(RStrpool *p) {
 p->len = 0;
 p->str[0] = 0;
 p->str[1] = 0;
 return p->str;
...
# 33 "project/radare2/libr/util/strpool.c" 3 4
__attribute__((visibility("default"))) 
# 33 "project/radare2/libr/util/strpool.c"
     char *r_strpool_alloc(RStrpool *p, int l) {
 char *ret = p->str + p->len;
 if ((p->len + l) >= p->size) {
  
# 36 "project/radare2/libr/util/strpool.c" 3 4
 unsigned long long 
# 36 "project/radare2/libr/util/strpool.c"
      osize = p->size;
  if (l >= 
# 37 "project/radare2/libr/util/strpool.c" 3 4
          1024
# 37 "project/radare2/libr/util/strpool.c"
                       ) {
   p->size += l + 
# 38 "project/radare2/libr/util/strpool.c" 3 4
                 1024
# 38 "project/radare2/libr/util/strpool.c"
                              ;
  } else {
   p->size += 
# 40 "project/radare2/libr/util/strpool.c" 3 4
             1024
# 40 "project/radare2/libr/util/strpool.c"
                          ;
  }
  if (p->size < osize) {
   
# 43 "project/radare2/libr/util/strpool.c" 3 4
  fprintf(__stderrp,
# 43 "project/radare2/libr/util/strpool.c"
  "Underflow!\n"
# 43 "project/radare2/libr/util/strpool.c" 3 4
  )
# 43 "project/radare2/libr/util/strpool.c"
   ...
   p->size = osize;
   return 
# 45 "project/radare2/libr/util/strpool.c" 3 4
         ((void *)0)
# 45 "project/radare2/libr/util/strpool.c"
             ;
  }
  ret = realloc (p->str, p->size);
  if (!ret) {
   
# 49 "project/radare2/libr/util/strpool.c" 3 4
  fprintf(__stderrp,
# 49 "project/radare2/libr/util/strpool.c"
  "Realloc failed!\n"
# 49 "project/radare2/libr/util/strpool.c" 3 4
  )
# 49 "project/radare2/libr/util/strpool.c"
   ...
   free (p->str);
   p->str = 
# 51 "project/radare2/libr/util/strpool.c" 3 4
           ((void *)0)
# 51 "project/radare2/libr/util/strpool.c"
               ;
   return 
# 52 "project/radare2/libr/util/strpool.c" 3 4
         ((void *)0)
# 52 "project/radare2/libr/util/strpool.c"
             ;
  }
  p->str = ret;
  ret += p->len;
...
# 61 "project/radare2/libr/util/strpool.c" 3 4
__attribute__((visibility("default"))) 
# 61 "project/radare2/libr/util/strpool.c"
     int r_strpool_memcat(RStrpool *p, const char *s, int len) {
 char *ptr = r_strpool_alloc (p, len);
 if (!ptr) {
  return -1;
 }
 
# 66 "project/radare2/libr/util/strpool.c" 3 4
__builtin___memcpy_chk (
# 66 "project/radare2/libr/util/strpool.c"
ptr
# 66 "project/radare2/libr/util/strpool.c" 3 4
, 
# 66 "project/radare2/libr/util/strpool.c"
...
# 70 "project/radare2/libr/util/strpool.c" 3 4
__attribute__((visibility("default"))) 
# 70 "project/radare2/libr/util/strpool.c"
     int r_strpool_append(RStrpool *p, const char *s) {
 int l = strlen (s) + 1;
 return r_strpool_memcat (p, s, l);
}


# 75 "project/radare2/libr/util/strpool.c" 3 4
__attribute__((visibility("default"))) 
# 75 "project/radare2/libr/util/strpool.c"
     int r_strpool_ansi_chop(RStrpool *p, int n){
...
# 82 "project/radare2/libr/util/strpool.c" 3 4
__attribute__((visibility("default"))) 
# 82 "project/radare2/libr/util/strpool.c"
     void r_strpool_free(RStrpool *p) {
 free (p->str);
 free (p);
}


# 87 "project/radare2/libr/util/strpool.c" 3 4
__attribute__((visibility("default"))) 
# 87 "project/radare2/libr/util/strpool.c"
     int r_strpool_fit(RStrpool *p) {
 char *s;
 if (p->len == p->size) {
  return 
# 90 "project/radare2/libr/util/strpool.c" 3 4
        0
# 90 "project/radare2/libr/util/strpool.c"
             ;
 }
...
# 95 "project/radare2/libr/util/strpool.c" 3 4
 fprintf(__stderrp,
# 95 "project/radare2/libr/util/strpool.c"
 "Realloc failed!\n"
# 95 "project/radare2/libr/util/strpool.c" 3 4
 )
# 95 "project/radare2/libr/util/strpool.c"
  ...
  free (p->str);
  return 
# 97 "project/radare2/libr/util/strpool.c" 3 4
        0
# 97 "project/radare2/libr/util/strpool.c"
             ;
 }
 p->str = s;
 p->size = p->len;
 return 
# 101 "project/radare2/libr/util/strpool.c" 3 4
       1
# 101 "project/radare2/libr/util/strpool.c"
           ;
}


# 104 "project/radare2/libr/util/strpool.c" 3 4
__attribute__((visibility("default"))) 
# 104 "project/radare2/libr/util/strpool.c"
     char *r_strpool_get(RStrpool *p, int index) {
 if (!p || !p->str || index < 0 || index >= p->len) {
  return 
# 106 "project/radare2/libr/util/strpool.c" 3 4
        ((void *)0)
# 106 "project/radare2/libr/util/strpool.c"
            ;
 }
 return p->str + index;
}
...
# 111 "project/radare2/libr/util/strpool.c" 3 4
__attribute__((visibility("default"))) 
# 111 "project/radare2/libr/util/strpool.c"
     char *r_strpool_get_i(RStrpool *p, int index) {
 int i, n = 0;
 if (index < 0 || index >= p->len) {
  return 
# 114 "project/radare2/libr/util/strpool.c" 3 4
        ((void *)0)
# 114 "project/radare2/libr/util/strpool.c"
            ;
 }
 for (i = 0; i < index; i++) {
...
# 123 "project/radare2/libr/util/strpool.c" 3 4
__attribute__((visibility("default"))) 
# 123 "project/radare2/libr/util/strpool.c"
     int r_strpool_get_index(RStrpool *p, const char *s) {
 int ret = (size_t)(s - p->str);
 return (ret > 0) ? ret : 0;
}


# 128 "project/radare2/libr/util/strpool.c" 3 4
__attribute__((visibility("default"))) 
# 128 "project/radare2/libr/util/strpool.c"
     char *r_strpool_next(RStrpool *p, int index) {
 char *ptr = r_strpool_get (p, index);
 if (ptr) {
  char *q = ptr + strlen (ptr) + 1;
  if (q >= (p->str + p->len)) {
   return 
# 133 "project/radare2/libr/util/strpool.c" 3 4
         ((void *)0)
# 133 "project/radare2/libr/util/strpool.c"
             ;
  }
  ptr = q;
  if (!*ptr) {
   ptr = 
# 137 "project/radare2/libr/util/strpool.c" 3 4
        ((void *)0)
# 137 "project/radare2/libr/util/strpool.c"
            ;
  }
 }
 return ptr;
...
# 143 "project/radare2/libr/util/strpool.c" 3 4
__attribute__((visibility("default"))) 
# 143 "project/radare2/libr/util/strpool.c"
     char *r_strpool_slice(RStrpool *p, int index) {
 int idx, len;
 char *o, *x = r_strpool_get_i (p, index + 1);
 if (!x || !*x) {
  return 
# 147 "project/radare2/libr/util/strpool.c" 3 4
        ((void *)0)
# 147 "project/radare2/libr/util/strpool.c"
            ;
 }
 idx = (size_t)(x - p->str);
 len = p->len - idx;
 ...
 if (!o) {
  return 
# 153 "project/radare2/libr/util/strpool.c" 3 4
        ((void *)0)
# 153 "project/radare2/libr/util/strpool.c"
            ;
 }
 
# 155 "project/radare2/libr/util/strpool.c" 3 4
__builtin___memcpy_chk (
# 155 "project/radare2/libr/util/strpool.c"
o
# 155 "project/radare2/libr/util/strpool.c" 3 4
, 
# 155 "project/radare2/libr/util/strpool.c"
