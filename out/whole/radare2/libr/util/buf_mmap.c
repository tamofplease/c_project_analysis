# 0 "project/radare2/libr/util/buf_mmap.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/buf_mmap.c"
...
# 4 "project/radare2/libr/util/buf_mmap.c" 2


# 5 "project/radare2/libr/util/buf_mmap.c"
...
# 19 "project/radare2/libr/util/buf_mmap.c" 3 4
do { if (!(
# 19 "project/radare2/libr/util/buf_mmap.c"
priv
# 19 "project/radare2/libr/util/buf_mmap.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "WARNING (%s:%d):%s%s runtime check failed: (%s)\n", "project/radare2/libr/util/buf_mmap.c", 19, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : "", 
# 19 "project/radare2/libr/util/buf_mmap.c"
"priv"
# 19 "project/radare2/libr/util/buf_mmap.c" 3 4
); } } while (0)
...
static 
# 23 "project/radare2/libr/util/buf_mmap.c" 3 4
      _Bool 
# 23 "project/radare2/libr/util/buf_mmap.c"
           buf_mmap_init(RBuffer *b, const void *user) {
 const struct buf_mmap_user *u = (const struct buf_mmap_user *)user;
 struct buf_mmap_priv *priv = 
# 25 "project/radare2/libr/util/buf_mmap.c" 3 4
                             (
# 25 "project/radare2/libr/util/buf_mmap.c"
                             struct buf_mmap_priv
# 25 "project/radare2/libr/util/buf_mmap.c" 3 4
                             *)calloc(1,sizeof(
# 25 "project/radare2/libr/util/buf_mmap.c"
...
# 25 "project/radare2/libr/util/buf_mmap.c"
 ...
 if (!priv) {
  return 
# 27 "project/radare2/libr/util/buf_mmap.c" 3 4
        0
# 27 "project/radare2/libr/util/buf_mmap.c"
             ;
 }

 priv->mmap = r_file_mmap (u->filename, u->perm & 
# 30 "project/radare2/libr/util/buf_mmap.c" 3 4
                                                 2
# 30 "project/radare2/libr/util/buf_mmap.c"
                                                         , 0);
 if (!priv->mmap) {
  free (priv);
  return 
# 33 "project/radare2/libr/util/buf_mmap.c" 3 4
        0
# 33 "project/radare2/libr/util/buf_mmap.c"
             ;
 }
 ...
 b->priv = priv;
 return 
# 39 "project/radare2/libr/util/buf_mmap.c" 3 4
       1
# 39 "project/radare2/libr/util/buf_mmap.c"
           ;
}

static 
# 42 "project/radare2/libr/util/buf_mmap.c" 3 4
      _Bool 
# 42 "project/radare2/libr/util/buf_mmap.c"
           buf_mmap_fini(RBuffer *b) {
 struct buf_mmap_priv *priv = get_priv_mmap (b);
 r_file_mmap_free (priv->mmap);
 
# 45 "project/radare2/libr/util/buf_mmap.c" 3 4
{ free((void *)
# 45 "project/radare2/libr/util/buf_mmap.c"
b->priv
# 45 "project/radare2/libr/util/buf_mmap.c" 3 4
); 
# 45 "project/radare2/libr/util/buf_mmap.c"
...
# 45 "project/radare2/libr/util/buf_mmap.c"
                ;
 return 
# 46 "project/radare2/libr/util/buf_mmap.c" 3 4
       1
# 46 "project/radare2/libr/util/buf_mmap.c"
           ;
}

static 
# 49 "project/radare2/libr/util/buf_mmap.c" 3 4
      _Bool 
# 49 "project/radare2/libr/util/buf_mmap.c"
           buf_mmap_resize(RBuffer *b, 
# 49 "project/radare2/libr/util/buf_mmap.c" 3 4
                                       unsigned long long 
# 49 "project/radare2/libr/util/buf_mmap.c"
                                            newsize) {
...
# 52 "project/radare2/libr/util/buf_mmap.c" 3 4
 unsigned char 
# 52 "project/radare2/libr/util/buf_mmap.c"
     *t = r_mem_mmap_resize (priv->mmap, newsize);
  if (!t) {
   return 
# 54 "project/radare2/libr/util/buf_mmap.c" 3 4
         0
# 54 "project/radare2/libr/util/buf_mmap.c"
              ;
  }
 ...
 return 
# 59 "project/radare2/libr/util/buf_mmap.c" 3 4
       1
# 59 "project/radare2/libr/util/buf_mmap.c"
           ;
}
