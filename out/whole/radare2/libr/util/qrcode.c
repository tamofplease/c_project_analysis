# 0 "project/radare2/libr/util/qrcode.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 26 "project/radare2/libr/util/qrcode.c" 2
# 1 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include-fixed/limits.h" 1 3 4
# 27 "project/radare2/libr/util/qrcode.c" 2


# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_qrcode.h" 1 3 4
# 25 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_qrcode.h" 3 4
#define R_QRCODE_H 
...
# 1 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include/stddef.h" 1 3 4
# 32 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_qrcode.h" 2 3 4
# 40 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_qrcode.h" 3 4
enum qrcodegen_Ecc {
 qrcodegen_Ecc_LOW = 0,
...
# 103 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_qrcode.h" 3 4
__attribute__((visibility("default"))) _Bool r_qrcode_text(const char *text, uint8_t tempBuffer[], uint8_t qrcode[],
 enum qrcodegen_Ecc ecl, int minVersion, int maxVersion, enum qrcodegen_Mask mask, _Bool boostEcl);
# 125 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_qrcode.h" 3 4
__attribute__((visibility("default"))) _Bool r_qrcode_bin(uint8_t dataAndTemp[], int dataLen, uint8_t qrcode[],
 enum qrcodegen_Ecc ecl, int minVersion, int maxVersion, enum qrcodegen_Mask mask, _Bool boostEcl);

__attribute__((visibility("default"))) char *r_qrcode_print(const unsigned char* qrcode);
# 30 "project/radare2/libr/util/qrcode.c" 2
# 50 "project/radare2/libr/util/qrcode.c"

# 50 "project/radare2/libr/util/qrcode.c"
static int getTextProperties(const char *text, 
# 50 "project/radare2/libr/util/qrcode.c" 3 4
                                              _Bool 
# 50 "project/radare2/libr/util/qrcode.c"
                                                   *isNumeric, 
# 50 "project/radare2/libr/util/qrcode.c" 3 4
...
# 53 "project/radare2/libr/util/qrcode.c" 3 4
                            unsigned char 
# 53 "project/radare2/libr/util/qrcode.c"
                                dataAndQrcode[], int bitLen, 
# 53 "project/radare2/libr/util/qrcode.c" 3 4
                                                             unsigned char 
# 53 "project/radare2/libr/util/qrcode.c"
                                                                 tempBuffer[],
        int version, enum qrcodegen_Ecc ecl, enum qrcodegen_Mask mask, 
# 54 "project/radare2/libr/util/qrcode.c" 3 4
                                                                      _Bool 
# 54 "project/radare2/libr/util/qrcode.c"
                                                                           boostEcl);
static void appendBitsToBuffer(unsigned int val, int numBits, 
# 55 "project/radare2/libr/util/qrcode.c" 3 4
                                                             unsigned char 
# 55 "project/radare2/libr/util/qrcode.c"
                                                                 buffer[], int *bitLen);

static void appendErrorCorrection(
# 57 "project/radare2/libr/util/qrcode.c" 3 4
                                 unsigned char 
# 57 "project/radare2/libr/util/qrcode.c"
                                     data[], int version, enum qrcodegen_Ecc ecl, 
# 57 "project/radare2/libr/util/qrcode.c" 3 4
                                                                                  unsigned char 
# 57 "project/radare2/libr/util/qrcode.c"
                                                                                      result[]);
...
static void calcReedSolomonGenerator(int degree, 
# 61 "project/radare2/libr/util/qrcode.c" 3 4
                                                unsigned char 
# 61 "project/radare2/libr/util/qrcode.c"
                                                    result[]);
static void calcReedSolomonRemainder(const 
# 62 "project/radare2/libr/util/qrcode.c" 3 4
                                          unsigned char 
# 62 "project/radare2/libr/util/qrcode.c"
                                              data[], int dataLen, const 
# 62 "project/radare2/libr/util/qrcode.c" 3 4
                                                                         unsigned char 
# 62 "project/radare2/libr/util/qrcode.c"
                                                                             generator[], int degree, 
# 62 "project/radare2/libr/util/qrcode.c" 3 4
                                                                                                      unsigned char 
# 62 "project/radare2/libr/util/qrcode.c"
                                                                                                          result[]);
static 
# 63 "project/radare2/libr/util/qrcode.c" 3 4
      unsigned char 
# 63 "project/radare2/libr/util/qrcode.c"
          finiteFieldMultiply(
# 63 "project/radare2/libr/util/qrcode.c" 3 4
                              unsigned char 
# 63 "project/radare2/libr/util/qrcode.c"
...
static void initializeFunctionModules(int version, 
# 65 "project/radare2/libr/util/qrcode.c" 3 4
                                                  unsigned char 
# 65 "project/radare2/libr/util/qrcode.c"
                                                      qrcode[]);
static void drawWhiteFunctionModules(
# 66 "project/radare2/libr/util/qrcode.c" 3 4
                                    unsigned char 
# 66 "project/radare2/libr/util/qrcode.c"
                                        qrcode[], int version);
static void drawFormatBits(enum qrcodegen_Ecc ecl, enum qrcodegen_Mask mask, 
# 67 "project/radare2/libr/util/qrcode.c" 3 4
                                                                            unsigned char 
# 67 "project/radare2/libr/util/qrcode.c"
                                                                                qrcode[]);
static int getAlignmentPatternPositions(int version, 
# 68 "project/radare2/libr/util/qrcode.c" 3 4
                                                    unsigned char 
# 68 "project/radare2/libr/util/qrcode.c"
                                                        result[7]);
static void fillRectangle(int left, int top, int width, int height, 
# 69 "project/radare2/libr/util/qrcode.c" 3 4
                                                                   unsigned char 
# 69 "project/radare2/libr/util/qrcode.c"
                                                                       qrcode[]);

static 
# 71 "project/radare2/libr/util/qrcode.c" 3 4
      _Bool 
# 71 "project/radare2/libr/util/qrcode.c"
           drawCodewords(const 
# 71 "project/radare2/libr/util/qrcode.c" 3 4
                               unsigned char 
# 71 "project/radare2/libr/util/qrcode.c"
...
# 71 "project/radare2/libr/util/qrcode.c"
                                                            qrcode[]);
static 
# 72 "project/radare2/libr/util/qrcode.c" 3 4
      _Bool 
# 72 "project/radare2/libr/util/qrcode.c"
           applyMask(const 
# 72 "project/radare2/libr/util/qrcode.c" 3 4
                           unsigned char 
# 72 "project/radare2/libr/util/qrcode.c"
...
# 72 "project/radare2/libr/util/qrcode.c" 3 4
                                                  unsigned char 
# 72 "project/radare2/libr/util/qrcode.c"
                                                      qrcode[], enum qrcodegen_Mask mask);
static long getPenaltyScore(const 
# 73 "project/radare2/libr/util/qrcode.c" 3 4
                                 unsigned char 
# 73 "project/radare2/libr/util/qrcode.c"
                                     qrcode[]);

static 
# 75 "project/radare2/libr/util/qrcode.c" 3 4
      _Bool 
# 75 "project/radare2/libr/util/qrcode.c"
           getModule(const 
# 75 "project/radare2/libr/util/qrcode.c" 3 4
                           unsigned char 
# 75 "project/radare2/libr/util/qrcode.c"
                               qrcode[], int x, int y);
static 
# 76 "project/radare2/libr/util/qrcode.c" 3 4
      _Bool 
# 76 "project/radare2/libr/util/qrcode.c"
           setModule(
# 76 "project/radare2/libr/util/qrcode.c" 3 4
                     unsigned char 
# 76 "project/radare2/libr/util/qrcode.c"
...
# 76 "project/radare2/libr/util/qrcode.c"
                                                      isBlack);
static void setModuleBounded(
# 77 "project/radare2/libr/util/qrcode.c" 3 4
                            unsigned char 
# 77 "project/radare2/libr/util/qrcode.c"
                                qrcode[], int x, int y, 
# 77 "project/radare2/libr/util/qrcode.c" 3 4
                                                        _Bool 
# 77 "project/radare2/libr/util/qrcode.c"
...
static 
# 94 "project/radare2/libr/util/qrcode.c" 3 4
      _Bool 
# 94 "project/radare2/libr/util/qrcode.c"
...
# 132 "project/radare2/libr/util/qrcode.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 132 "project/radare2/libr/util/qrcode.c"
          r_qrcode_text(const char *text, 
# 132 "project/radare2/libr/util/qrcode.c" 3 4
                                          unsigned char 
# 132 "project/radare2/libr/util/qrcode.c"
                                              tempBuffer[], 
# 132 "project/radare2/libr/util/qrcode.c" 3 4
                                                            unsigned char 
# 132 "project/radare2/libr/util/qrcode.c"
                                                                qrcode[], enum qrcodegen_Ecc ecl, int minVersion, int maxVersion, enum qrcodegen_Mask mask, 
# 132 "project/radare2/libr/util/qrcode.c" 3 4
                                                                                                                                                            _Bool 
# 132 "project/radare2/libr/util/qrcode.c"
                                                                                                                                                                 boostEcl) {
 if (!text || !tempBuffer || !qrcode) {
  return 
# 134 "project/radare2/libr/util/qrcode.c" 3 4
        0
# 134 "project/radare2/libr/util/qrcode.c"
             ;
 }
 if (minVersion < 
# 136 "project/radare2/libr/util/qrcode.c" 3 4
                 1 
# 136 "project/radare2/libr/util/qrcode.c"
                                       || minVersion > 
# 136 "project/radare2/libr/util/qrcode.c" 3 4
                                                       40
# 136 "project/radare2/libr/util/qrcode.c"
  ...
  return 
# 137 "project/radare2/libr/util/qrcode.c" 3 4
        0
# 137 "project/radare2/libr/util/qrcode.c"
             ;
 }
 if (maxVersion < 
# 139 "project/radare2/libr/util/qrcode.c" 3 4
                 1 
# 139 "project/radare2/libr/util/qrcode.c"
                                       || maxVersion > 
# 139 "project/radare2/libr/util/qrcode.c" 3 4
                                                       40
# 139 "project/radare2/libr/util/qrcode.c"
  ...
  return 
# 140 "project/radare2/libr/util/qrcode.c" 3 4
        0
# 140 "project/radare2/libr/util/qrcode.c"
             ;
 }
 if (ecl < qrcodegen_Ecc_LOW || ecl > qrcodegen_Ecc_HIGH) {
  return 
# 143 "project/radare2/libr/util/qrcode.c" 3 4
        0
# 143 "project/radare2/libr/util/qrcode.c"
             ;
 }
 if (mask < -1 || mask > 7) {
  return 
# 146 "project/radare2/libr/util/qrcode.c" 3 4
        0
# 146 "project/radare2/libr/util/qrcode.c"
             ;
 }
...
# 153 "project/radare2/libr/util/qrcode.c" 3 4
_Bool 
# 153 "project/radare2/libr/util/qrcode.c"
     isNumeric, isAlphanumeric;
 int textBits;
 int textLen = getTextProperties (text, &isNumeric, &isAlphanumeric, &textBits);
 if (textLen < 0) {
  return 
# 157 "project/radare2/libr/util/qrcode.c" 3 4
        0
# 157 "project/radare2/libr/util/qrcode.c"
             ;
 }

 if (!isAlphanumeric) {
  if (textLen > 
# 161 "project/radare2/libr/util/qrcode.c" 3 4
               ((((
# 161 "project/radare2/libr/util/qrcode.c"
               maxVersion
# 161 "project/radare2/libr/util/qrcode.c" 3 4
               ) * 4 + 17) * ((
# 161 "project/radare2/libr/util/qrcode.c"
...
# 161 "project/radare2/libr/util/qrcode.c"
   ...
   return 
# 162 "project/radare2/libr/util/qrcode.c" 3 4
         0
# 162 "project/radare2/libr/util/qrcode.c"
              ;
  }
  int i;
  for (i = 0; i < textLen; i++) {
   tempBuffer[i] = (
# 166 "project/radare2/libr/util/qrcode.c" 3 4
                   unsigned char
# 166 "project/radare2/libr/util/qrcode.c"
                      ) text[i];
  }
 ...
 if (version == 0) {
  return 
# 174 "project/radare2/libr/util/qrcode.c" 3 4
        0
# 174 "project/radare2/libr/util/qrcode.c"
             ;
 }
 
# 176 "project/radare2/libr/util/qrcode.c" 3 4
__builtin___memset_chk (
# 176 "project/radare2/libr/util/qrcode.c"
qrcode
# 176 "project/radare2/libr/util/qrcode.c" 3 4
, 
# 176 "project/radare2/libr/util/qrcode.c"
...
# 176 "project/radare2/libr/util/qrcode.c"
 ...
 return 
# 223 "project/radare2/libr/util/qrcode.c" 3 4
       1
# 223 "project/radare2/libr/util/qrcode.c"
           ;
}
...
# 228 "project/radare2/libr/util/qrcode.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 228 "project/radare2/libr/util/qrcode.c"
          r_qrcode_bin(
# 228 "project/radare2/libr/util/qrcode.c" 3 4
                       unsigned char 
# 228 "project/radare2/libr/util/qrcode.c"
                           *dataAndTemp, int dataLen, 
# 228 "project/radare2/libr/util/qrcode.c" 3 4
                                                      unsigned char 
# 228 "project/radare2/libr/util/qrcode.c"
                                                          *qrcode,
   enum qrcodegen_Ecc ecl, int minVersion, int maxVersion, enum qrcodegen_Mask mask, 
# 229 "project/radare2/libr/util/qrcode.c" 3 4
                                                                                    _Bool 
# 229 "project/radare2/libr/util/qrcode.c"
                                                                                         boostEcl) {
 if (!dataAndTemp || !qrcode || dataLen < 1) {
  return 
# 231 "project/radare2/libr/util/qrcode.c" 3 4
        0
# 231 "project/radare2/libr/util/qrcode.c"
             ;
 }
 if (minVersion < 
# 233 "project/radare2/libr/util/qrcode.c" 3 4
                 1 
# 233 "project/radare2/libr/util/qrcode.c"
                                       || minVersion > 
# 233 "project/radare2/libr/util/qrcode.c" 3 4
                                                       40
# 233 "project/radare2/libr/util/qrcode.c"
  ...
  return 
# 234 "project/radare2/libr/util/qrcode.c" 3 4
        0
# 234 "project/radare2/libr/util/qrcode.c"
             ;
 }
 if (maxVersion < 
# 236 "project/radare2/libr/util/qrcode.c" 3 4
                 1 
# 236 "project/radare2/libr/util/qrcode.c"
                                       || maxVersion > 
# 236 "project/radare2/libr/util/qrcode.c" 3 4
                                                       40
# 236 "project/radare2/libr/util/qrcode.c"
  ...
  return 
# 237 "project/radare2/libr/util/qrcode.c" 3 4
        0
# 237 "project/radare2/libr/util/qrcode.c"
             ;
 }
 if (ecl < qrcodegen_Ecc_LOW || ecl > qrcodegen_Ecc_HIGH) {
  return 
# 240 "project/radare2/libr/util/qrcode.c" 3 4
        0
# 240 "project/radare2/libr/util/qrcode.c"
             ;
 }
 if (mask < -1 || mask > 7) {
  return 
# 243 "project/radare2/libr/util/qrcode.c" 3 4
        0
# 243 "project/radare2/libr/util/qrcode.c"
             ;
 }
 ...
 if (dataLen > 
# 250 "project/radare2/libr/util/qrcode.c" 3 4
              32767 
# 250 "project/radare2/libr/util/qrcode.c"
                        / 8) {
  return 
# 251 "project/radare2/libr/util/qrcode.c" 3 4
        0
# 251 "project/radare2/libr/util/qrcode.c"
             ;
 }
 ...
 if (version == 0) {
  return 
# 256 "project/radare2/libr/util/qrcode.c" 3 4
        0
# 256 "project/radare2/libr/util/qrcode.c"
             ;
 }


 
# 260 "project/radare2/libr/util/qrcode.c" 3 4
__builtin___memset_chk (
# 260 "project/radare2/libr/util/qrcode.c"
qrcode
# 260 "project/radare2/libr/util/qrcode.c" 3 4
, 
# 260 "project/radare2/libr/util/qrcode.c"
...
# 260 "project/radare2/libr/util/qrcode.c"
 ...
 return 
# 269 "project/radare2/libr/util/qrcode.c" 3 4
       1
# 269 "project/radare2/libr/util/qrcode.c"
           ;
}
...
static int getTextProperties(const char *text, 
# 277 "project/radare2/libr/util/qrcode.c" 3 4
                                              _Bool 
# 277 "project/radare2/libr/util/qrcode.c"
                                                   *isNumeric, 
# 277 "project/radare2/libr/util/qrcode.c" 3 4
                                                               _Bool 
# 277 "project/radare2/libr/util/qrcode.c"
 ...
 int textLen = 0;
 *isNumeric = 
# 279 "project/radare2/libr/util/qrcode.c" 3 4
             1
# 279 "project/radare2/libr/util/qrcode.c"
                 ;
 *isAlphanumeric = 
# 280 "project/radare2/libr/util/qrcode.c" 3 4
                  1
# 280 "project/radare2/libr/util/qrcode.c"
                      ;
 const char *p;
 for (p = text; *p != '\0'; p++, textLen++) {
  if (textLen >= 
# 283 "project/radare2/libr/util/qrcode.c" 3 4
                32767
# 283 "project/radare2/libr/util/qrcode.c"
                         ) {
   return -1;
  }
  char c = *p;
  if (c < '0' || c > '9') {
   *isNumeric = 
# 288 "project/radare2/libr/util/qrcode.c" 3 4
               0
# 288 "project/radare2/libr/util/qrcode.c"
                    ;
   *isAlphanumeric &= strchr (ALPHANUMERIC_CHARSET, c) != 
# 289 "project/radare2/libr/util/qrcode.c" 3 4
                                                         ((void *)0)
# 289 "project/radare2/libr/util/qrcode.c"
                                                             ;
  }
 }
...
static int fitVersionToData(int minVersion, int maxVersion, enum qrcodegen_Ecc ecl,
 ...
 if (
# 314 "project/radare2/libr/util/qrcode.c" 3 4
    1 
# 314 "project/radare2/libr/util/qrcode.c"
...
# 314 "project/radare2/libr/util/qrcode.c"
  ...
  for (version = minVersion;; version++) {
   ...
   if (dataLen < (1L << lengthBits)) {
    ...
    if (dataBitLen <= 0x7fffffff - header && header + dataBitLen <= dataCapacityBits) {
     return version;
    }
   }
...
static void encodeQrCodeTail(
# 362 "project/radare2/libr/util/qrcode.c" 3 4
                            unsigned char 
# 362 "project/radare2/libr/util/qrcode.c"
                                dataAndQrcode[], int bitLen, 
# 362 "project/radare2/libr/util/qrcode.c" 3 4
                                                             unsigned char 
# 362 "project/radare2/libr/util/qrcode.c"
                                                                 tempBuffer[], int version, enum qrcodegen_Ecc ecl, enum qrcodegen_Mask mask, 
# 362 "project/radare2/libr/util/qrcode.c" 3 4
                                                                                                                                              _Bool 
# 362 "project/radare2/libr/util/qrcode.c"
                                                                                                                                                   boostEcl) {
...
# 384 "project/radare2/libr/util/qrcode.c" 3 4
unsigned char 
# 384 "project/radare2/libr/util/qrcode.c"
    padByte;
 ...
 if (mask == qrcodegen_Mask_AUTO) {
  long minPenalty = 0x7fffffffffffffffL;
  int i;
  for (i = 0; i < 8; i++) {
...
static void appendBitsToBuffer(unsigned int val, int numBits, 
# 425 "project/radare2/libr/util/qrcode.c" 3 4
                                                             unsigned char 
# 425 "project/radare2/libr/util/qrcode.c"
                                                                 buffer[], int *bitLen) {
...
static void appendErrorCorrection(
# 443 "project/radare2/libr/util/qrcode.c" 3 4
                                 unsigned char 
# 443 "project/radare2/libr/util/qrcode.c"
                                     data[], int version, enum qrcodegen_Ecc ecl, 
# 443 "project/radare2/libr/util/qrcode.c" 3 4
...
# 443 "project/radare2/libr/util/qrcode.c"
 ...
 if ((int) ecl < qrcodegen_Ecc_LOW || (int) ecl > qrcodegen_Ecc_HIGH || version < 
# 445 "project/radare2/libr/util/qrcode.c" 3 4
                                                                                 1 
# 445 "project/radare2/libr/util/qrcode.c"
                                                                                                       || version > 
# 445 "project/radare2/libr/util/qrcode.c" 3 4
                                                                                                                    40
# 445 "project/radare2/libr/util/qrcode.c"
...
# 456 "project/radare2/libr/util/qrcode.c" 3 4
unsigned char 
# 456 "project/radare2/libr/util/qrcode.c"
    generator[30];
...
static int getNumRawDataModules(int version) {
 if (version < 
# 503 "project/radare2/libr/util/qrcode.c" 3 4
              1 
# 503 "project/radare2/libr/util/qrcode.c"
                                    || version > 
# 503 "project/radare2/libr/util/qrcode.c" 3 4
                                                 40
# 503 "project/radare2/libr/util/qrcode.c"
...
static void calcReedSolomonGenerator(int degree, 
# 520 "project/radare2/libr/util/qrcode.c" 3 4
                                                unsigned char 
# 520 "project/radare2/libr/util/qrcode.c"
                                                    result[]) {
...
# 525 "project/radare2/libr/util/qrcode.c" 3 4
__builtin___memset_chk (
# 525 "project/radare2/libr/util/qrcode.c"
result
# 525 "project/radare2/libr/util/qrcode.c" 3 4
, 
# 525 "project/radare2/libr/util/qrcode.c"
0, degree * sizeof(result[0])
# 525 "project/radare2/libr/util/qrcode.c" 3 4
, __builtin_object_size (
# 525 "project/radare2/libr/util/qrcode.c"
result
...
# 532 "project/radare2/libr/util/qrcode.c" 3 4
unsigned char 
# 532 "project/radare2/libr/util/qrcode.c"
    root = 1;
 for (i = 0; i < degree; i++) {
...
static void calcReedSolomonRemainder(const 
# 548 "project/radare2/libr/util/qrcode.c" 3 4
                                          unsigned char 
# 548 "project/radare2/libr/util/qrcode.c"
                                              data[], int dataLen, const 
# 548 "project/radare2/libr/util/qrcode.c" 3 4
                                                                         unsigned char 
# 548 "project/radare2/libr/util/qrcode.c"
...
# 553 "project/radare2/libr/util/qrcode.c" 3 4
__builtin___memset_chk (
# 553 "project/radare2/libr/util/qrcode.c"
result
# 553 "project/radare2/libr/util/qrcode.c" 3 4
, 
# 553 "project/radare2/libr/util/qrcode.c"
...
# 556 "project/radare2/libr/util/qrcode.c" 3 4
 unsigned char 
# 556 "project/radare2/libr/util/qrcode.c"
     factor = data[i] ^ result[0];
  
# 557 "project/radare2/libr/util/qrcode.c" 3 4
 __builtin___memmove_chk (
# 557 "project/radare2/libr/util/qrcode.c"
 &result[0]
# 557 "project/radare2/libr/util/qrcode.c" 3 4
 , 
# 557 "project/radare2/libr/util/qrcode.c"
 &result[1], (degree - 1) * sizeof(result[0])
# 557 "project/radare2/libr/util/qrcode.c" 3 4
 , __builtin_object_size (
# 557 "project/radare2/libr/util/qrcode.c"
 &result[0]
...
static 
# 568 "project/radare2/libr/util/qrcode.c" 3 4
      unsigned char 
# 568 "project/radare2/libr/util/qrcode.c"
          finiteFieldMultiply(
# 568 "project/radare2/libr/util/qrcode.c" 3 4
                              unsigned char 
# 568 "project/radare2/libr/util/qrcode.c"
...
# 570 "project/radare2/libr/util/qrcode.c" 3 4
unsigned char 
# 570 "project/radare2/libr/util/qrcode.c"
    z = 0;
 int i;
 for (i = 7; i >= 0; i--) {
  z = (z << 1) ^ ((z >> 7) * 0x11D);
...
static void initializeFunctionModules(int version, 
# 583 "project/radare2/libr/util/qrcode.c" 3 4
                                                  unsigned char 
# 583 "project/radare2/libr/util/qrcode.c"
                                                      qrcode[]) {

 int qrsize = version * 4 + 17;
 
# 586 "project/radare2/libr/util/qrcode.c" 3 4
__builtin___memset_chk (
# 586 "project/radare2/libr/util/qrcode.c"
qrcode
# 586 "project/radare2/libr/util/qrcode.c" 3 4
, 
# 586 "project/radare2/libr/util/qrcode.c"
0, ((qrsize * qrsize + 7) / 8 + 1) * sizeof(qrcode[0])
# 586 "project/radare2/libr/util/qrcode.c" 3 4
, __builtin_object_size (
# 586 "project/radare2/libr/util/qrcode.c"
qrcode
...
# 586 "project/radare2/libr/util/qrcode.c"
                                                                       ;
 qrcode[0] = (
# 587 "project/radare2/libr/util/qrcode.c" 3 4
             unsigned char
# 587 "project/radare2/libr/util/qrcode.c"
                ) qrsize;
...
# 599 "project/radare2/libr/util/qrcode.c" 3 4
unsigned char 
# 599 "project/radare2/libr/util/qrcode.c"
    alignPatPos[7] = {
  0
 };
...
static void drawWhiteFunctionModules(
# 623 "project/radare2/libr/util/qrcode.c" 3 4
                                    unsigned char 
# 623 "project/radare2/libr/util/qrcode.c"
                                        qrcode[], int version) {

 int i, j, k, l, qrsize = qrcodegen_getSize (qrcode);
 for (i = 7; i < qrsize - 7; i += 2) {
  setModule (qrcode, 6, i, 
# 627 "project/radare2/libr/util/qrcode.c" 3 4
                          0
# 627 "project/radare2/libr/util/qrcode.c"
                               );
  setModule (qrcode, i, 6, 
# 628 "project/radare2/libr/util/qrcode.c" 3 4
                          0
# 628 "project/radare2/libr/util/qrcode.c"
                               );
 }
 ...
 for (i = -4; i <= 4; i++) {
  for (j = -4; j <= 4; j++) {
   ...
   if (dist == 2 || dist == 4) {
    setModuleBounded (qrcode, 3 + j, 3 + i, 
# 639 "project/radare2/libr/util/qrcode.c" 3 4
                                           0
# 639 "project/radare2/libr/util/qrcode.c"
                                                );
    setModuleBounded (qrcode, qrsize - 4 + j, 3 + i, 
# 640 "project/radare2/libr/util/qrcode.c" 3 4
                                                    0
# 640 "project/radare2/libr/util/qrcode.c"
                                                         );
    setModuleBounded (qrcode, 3 + j, qrsize - 4 + i, 
# 641 "project/radare2/libr/util/qrcode.c" 3 4
                                                    0
# 641 "project/radare2/libr/util/qrcode.c"
                                                         );
   }
  }
 }
...
# 647 "project/radare2/libr/util/qrcode.c" 3 4
unsigned char 
# 647 "project/radare2/libr/util/qrcode.c"
    alignPatPos[7] = {
  0
 };
...
# 671 "project/radare2/libr/util/qrcode.c" 3 4
 unsigned int 
# 671 "project/radare2/libr/util/qrcode.c"
      data = ((
# 671 "project/radare2/libr/util/qrcode.c" 3 4
               unsigned int
# 671 "project/radare2/libr/util/qrcode.c"
...
static void drawFormatBits(enum qrcodegen_Ecc ecl, enum qrcodegen_Mask mask, 
# 692 "project/radare2/libr/util/qrcode.c" 3 4
                                                                            unsigned char 
# 692 "project/radare2/libr/util/qrcode.c"
                                                                                qrcode[]) {
 ...
 setModule (qrcode, 8, qrsize - 8, 
# 735 "project/radare2/libr/util/qrcode.c" 3 4
                                  1
# 735 "project/radare2/libr/util/qrcode.c"
                                      );
}
...
static int getAlignmentPatternPositions(int version, 
# 741 "project/radare2/libr/util/qrcode.c" 3 4
                                                    unsigned char 
# 741 "project/radare2/libr/util/qrcode.c"
                                                        result[7]) {
 if (version == 1) {
  return 0;
 }
...
static void fillRectangle(int left, int top, int width, int height, 
# 762 "project/radare2/libr/util/qrcode.c" 3 4
                                                                   unsigned char 
# 762 "project/radare2/libr/util/qrcode.c"
                                                                       qrcode[]) {
 int dx, dy;
 for (dy = 0; dy < height; dy++) {
  for (dx = 0; dx < width; dx++) {
   setModule (qrcode, left + dx, top + dy, 
# 766 "project/radare2/libr/util/qrcode.c" 3 4
                                          1
# 766 "project/radare2/libr/util/qrcode.c"
                                              );
  }
 }
}
...
static 
# 775 "project/radare2/libr/util/qrcode.c" 3 4
      _Bool 
# 775 "project/radare2/libr/util/qrcode.c"
           drawCodewords(const 
# 775 "project/radare2/libr/util/qrcode.c" 3 4
                               unsigned char 
# 775 "project/radare2/libr/util/qrcode.c"
...
# 786 "project/radare2/libr/util/qrcode.c" 3 4
   _Bool 
# 786 "project/radare2/libr/util/qrcode.c"
        upward = ((right + 1) & 2) == 0;
    int y = upward? qrsize - 1 - vert: vert;
    if (!getModule (qrcode, x, y) && i < dataLen * 8) {
     
# 789 "project/radare2/libr/util/qrcode.c" 3 4
    _Bool 
# 789 "project/radare2/libr/util/qrcode.c"
         black = ((data[i >> 3] >> (7 - (i & 7))) & 1) != 0;
...
static 
# 806 "project/radare2/libr/util/qrcode.c" 3 4
      _Bool 
# 806 "project/radare2/libr/util/qrcode.c"
           applyMask(const 
# 806 "project/radare2/libr/util/qrcode.c" 3 4
                           unsigned char 
# 806 "project/radare2/libr/util/qrcode.c"
...
# 806 "project/radare2/libr/util/qrcode.c"
 ...
 if (mask < 0 || mask > 7) {
  return 
# 808 "project/radare2/libr/util/qrcode.c" 3 4
        0
# 808 "project/radare2/libr/util/qrcode.c"
             ;
 }
...
# 816 "project/radare2/libr/util/qrcode.c" 3 4
  _Bool 
# 816 "project/radare2/libr/util/qrcode.c"
       invert;
   switch ((int) mask) {
   ...
   default: return 
# 826 "project/radare2/libr/util/qrcode.c" 3 4
                  0
# 826 "project/radare2/libr/util/qrcode.c"
                       ;
   }
   
# 828 "project/radare2/libr/util/qrcode.c" 3 4
  _Bool 
# 828 "project/radare2/libr/util/qrcode.c"
       val = getModule (qrcode, x, y);
   setModule (qrcode, x, y, val ^ invert);
  }
 }
 return 
# 832 "project/radare2/libr/util/qrcode.c" 3 4
       1
# 832 "project/radare2/libr/util/qrcode.c"
           ;
}
...
static long getPenaltyScore(const 
# 838 "project/radare2/libr/util/qrcode.c" 3 4
                                 unsigned char 
# 838 "project/radare2/libr/util/qrcode.c"
                                     qrcode[]) {
...
# 844 "project/radare2/libr/util/qrcode.c" 3 4
 _Bool 
# 844 "project/radare2/libr/util/qrcode.c"
      colorX;
  int runX = 0;
  for (x = 0; x < qrsize; x++) {
...
# 862 "project/radare2/libr/util/qrcode.c" 3 4
 _Bool 
# 862 "project/radare2/libr/util/qrcode.c"
      colorY;
  int runY = 0;
  for (y = 0; y < qrsize; y++) {
...
# 882 "project/radare2/libr/util/qrcode.c" 3 4
  _Bool 
# 882 "project/radare2/libr/util/qrcode.c"
...
static int qrcodegen_getSize(const 
# 933 "project/radare2/libr/util/qrcode.c" 3 4
                                  unsigned char 
# 933 "project/radare2/libr/util/qrcode.c"
                                      *qrcode) {
 if (!qrcode) {
  return 0;
 }
 int result = qrcode[0];
 if ((
# 938 "project/radare2/libr/util/qrcode.c" 3 4
     1 
# 938 "project/radare2/libr/util/qrcode.c"
                           * 4 + 17) <= result && result <= (
# 938 "project/radare2/libr/util/qrcode.c" 3 4
                                                             40 
# 938 "project/radare2/libr/util/qrcode.c"
...
static 
# 946 "project/radare2/libr/util/qrcode.c" 3 4
      _Bool 
# 946 "project/radare2/libr/util/qrcode.c"
           qrcodegen_getModule(const 
# 946 "project/radare2/libr/util/qrcode.c" 3 4
                                     unsigned char 
# 946 "project/radare2/libr/util/qrcode.c"
                                         qrcode[], int x, int y) {
 if (!qrcode) {
  return 
# 948 "project/radare2/libr/util/qrcode.c" 3 4
        0
# 948 "project/radare2/libr/util/qrcode.c"
             ;
 }
 int qrsize = qrcode[0];
...
static 
# 956 "project/radare2/libr/util/qrcode.c" 3 4
      _Bool 
# 956 "project/radare2/libr/util/qrcode.c"
           getModule(const 
# 956 "project/radare2/libr/util/qrcode.c" 3 4
                           unsigned char 
# 956 "project/radare2/libr/util/qrcode.c"
 ...
 return 
# 964 "project/radare2/libr/util/qrcode.c" 3 4
       0
# 964 "project/radare2/libr/util/qrcode.c"
            ;
}
...
static 
# 969 "project/radare2/libr/util/qrcode.c" 3 4
      _Bool 
# 969 "project/radare2/libr/util/qrcode.c"
           setModule(
# 969 "project/radare2/libr/util/qrcode.c" 3 4
                     unsigned char 
# 969 "project/radare2/libr/util/qrcode.c"
...
# 969 "project/radare2/libr/util/qrcode.c"
 ...
 if (21 <= qrsize && qrsize <= 177 && 0 <= x && x < qrsize && 0 <= y && y < qrsize) {
  ...
  return 
# 980 "project/radare2/libr/util/qrcode.c" 3 4
        1
# 980 "project/radare2/libr/util/qrcode.c"
            ;
 }
 return 
# 982 "project/radare2/libr/util/qrcode.c" 3 4
       0
# 982 "project/radare2/libr/util/qrcode.c"
            ;
}
...
static void setModuleBounded(
# 987 "project/radare2/libr/util/qrcode.c" 3 4
                            unsigned char 
# 987 "project/radare2/libr/util/qrcode.c"
                                qrcode[], int x, int y, 
# 987 "project/radare2/libr/util/qrcode.c" 3 4
                                                        _Bool 
# 987 "project/radare2/libr/util/qrcode.c"
...
# 1001 "project/radare2/libr/util/qrcode.c" 3 4
__attribute__((visibility("default"))) 
# 1001 "project/radare2/libr/util/qrcode.c"
     char *r_qrcode_gen(const 
# 1001 "project/radare2/libr/util/qrcode.c" 3 4
                              unsigned char 
# 1001 "project/radare2/libr/util/qrcode.c"
                                  *text, int len, 
...
# 1001 "project/radare2/libr/util/qrcode.c"
                                                                  inverted) {
 uint8_t qrcode[
# 1002 "project/radare2/libr/util/qrcode.c" 3 4
               ((((40) * 4 + 17) * ((40) * 4 + 17) + 7) / 8 + 1)
# 1002 "project/radare2/libr/util/qrcode.c"
                                       ] = {
  0
 };
 ...
 if (len < 0) {
  return 
# 1007 "project/radare2/libr/util/qrcode.c" 3 4
        ((void *)0)
# 1007 "project/radare2/libr/util/qrcode.c"
            ;
 }

 
# 1010 "project/radare2/libr/util/qrcode.c" 3 4
unsigned char 
# 1010 "project/radare2/libr/util/qrcode.c"
    *buf = calloc ((128 + len), 32);
 
# 1011 "project/radare2/libr/util/qrcode.c" 3 4
__builtin___memcpy_chk (
# 1011 "project/radare2/libr/util/qrcode.c"
buf
# 1011 "project/radare2/libr/util/qrcode.c" 3 4
, 
# 1011 "project/radare2/libr/util/qrcode.c"
...
# 1012 "project/radare2/libr/util/qrcode.c" 3 4
_Bool 
# 1012 "project/radare2/libr/util/qrcode.c"
     ok = r_qrcode_bin (buf, len, qrcode, errCorLvl,
  
# 1013 "project/radare2/libr/util/qrcode.c" 3 4
 1
# 1013 "project/radare2/libr/util/qrcode.c"
                      , 
# 1013 "project/radare2/libr/util/qrcode.c" 3 4
                        40
# 1013 "project/radare2/libr/util/qrcode.c"
                                             ,
  qrcodegen_Mask_AUTO, 
# 1014 "project/radare2/libr/util/qrcode.c" 3 4
                      1
# 1014 "project/radare2/libr/util/qrcode.c"
                          );
 if (!ok) {
  free (buf);
  return 
# 1017 "project/radare2/libr/util/qrcode.c" 3 4
        ((void *)0)
# 1017 "project/radare2/libr/util/qrcode.c"
            ;
 }
 ...
 if (size < 1) {
  free (buf);
  return 
# 1023 "project/radare2/libr/util/qrcode.c" 3 4
        ((void *)0)
# 1023 "project/radare2/libr/util/qrcode.c"
            ;
 }
 int border = 1;
 ...
 if (!res) {
  free (buf);
  return 
# 1030 "project/radare2/libr/util/qrcode.c" 3 4
        ((void *)0)
# 1030 "project/radare2/libr/util/qrcode.c"
            ;
 }
 char *p = res;
 int x, y;
...
# 1046 "project/radare2/libr/util/qrcode.c" 3 4
   __builtin___memcpy_chk (
# 1046 "project/radare2/libr/util/qrcode.c"
   p
# 1046 "project/radare2/libr/util/qrcode.c" 3 4
   , 
# 1046 "project/radare2/libr/util/qrcode.c"
...
# 1054 "project/radare2/libr/util/qrcode.c" 3 4
   _Bool 
# 1054 "project/radare2/libr/util/qrcode.c"
        fill = qrcodegen_getModule (qrcode, x, y);
    const char *pixel = (fill ^ inverted) ? "##" : "  ";
    
# 1056 "project/radare2/libr/util/qrcode.c" 3 4
   __builtin___memcpy_chk (
# 1056 "project/radare2/libr/util/qrcode.c"
   p
# 1056 "project/radare2/libr/util/qrcode.c" 3 4
   , 
# 1056 "project/radare2/libr/util/qrcode.c"
