# 0 "project/radare2/libr/util/buf_io.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/buf_io.c"
...
# 4 "project/radare2/libr/util/buf_io.c" 2
...
# 5 "project/radare2/libr/util/buf_io.c" 2


# 6 "project/radare2/libr/util/buf_io.c"
struct buf_io_user {
 RIOBind *iob;
 int fd;
};
...
# 18 "project/radare2/libr/util/buf_io.c" 3 4
do { if (!(
# 18 "project/radare2/libr/util/buf_io.c"
priv
# 18 "project/radare2/libr/util/buf_io.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "WARNING (%s:%d):%s%s runtime check failed: (%s)\n", "project/radare2/libr/util/buf_io.c", 18, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : "", 
# 18 "project/radare2/libr/util/buf_io.c"
"priv"
# 18 "project/radare2/libr/util/buf_io.c" 3 4
); } } while (0)
...
static 
# 22 "project/radare2/libr/util/buf_io.c" 3 4
      _Bool 
# 22 "project/radare2/libr/util/buf_io.c"
           buf_io_init(RBuffer *b, const void *user) {
 const struct buf_io_user *u = (const struct buf_io_user *)user;
 struct buf_io_priv *priv = 
# 24 "project/radare2/libr/util/buf_io.c" 3 4
                           (
# 24 "project/radare2/libr/util/buf_io.c"
                           struct buf_io_priv
# 24 "project/radare2/libr/util/buf_io.c" 3 4
                           *)calloc(1,sizeof(
# 24 "project/radare2/libr/util/buf_io.c"
...
# 24 "project/radare2/libr/util/buf_io.c"
 ...
 if (!priv) {
  return 
# 26 "project/radare2/libr/util/buf_io.c" 3 4
        0
# 26 "project/radare2/libr/util/buf_io.c"
             ;
 }
 priv->iob = u->iob;
 priv->fd = u->fd;
 b->priv = priv;
 return 
# 31 "project/radare2/libr/util/buf_io.c" 3 4
       1
# 31 "project/radare2/libr/util/buf_io.c"
           ;
}

static 
# 34 "project/radare2/libr/util/buf_io.c" 3 4
      _Bool 
# 34 "project/radare2/libr/util/buf_io.c"
           buf_io_fini(RBuffer *b) {

 
# 36 "project/radare2/libr/util/buf_io.c" 3 4
{ free((void *)
# 36 "project/radare2/libr/util/buf_io.c"
b->priv
# 36 "project/radare2/libr/util/buf_io.c" 3 4
); 
# 36 "project/radare2/libr/util/buf_io.c"
...
# 36 "project/radare2/libr/util/buf_io.c"
                ;
 return 
# 37 "project/radare2/libr/util/buf_io.c" 3 4
       1
# 37 "project/radare2/libr/util/buf_io.c"
           ;
}

static 
# 40 "project/radare2/libr/util/buf_io.c" 3 4
      long long 
# 40 "project/radare2/libr/util/buf_io.c"
           buf_io_seek(RBuffer *b, 
# 40 "project/radare2/libr/util/buf_io.c" 3 4
                                   long long 
# 40 "project/radare2/libr/util/buf_io.c"
                                        addr, int whence) {
...
# 46 "project/radare2/libr/util/buf_io.c" 3 4
 do { r_assert_log (R_LOGLVL_WARN, "(%s:%d):%s%s code should not be reached\n", "project/radare2/libr/util/buf_io.c", 46, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : ""); } while (0)
# 46 "project/radare2/libr/util/buf_io.c"
                     ;
 case 
# 47 "project/radare2/libr/util/buf_io.c" 3 4
     0
# 47 "project/radare2/libr/util/buf_io.c"
              :
  io_whence = 
# 48 "project/radare2/libr/util/buf_io.c" 3 4
             0
# 48 "project/radare2/libr/util/buf_io.c"
                          ;
  break;
 case 
# 50 "project/radare2/libr/util/buf_io.c" 3 4
     2
# 50 "project/radare2/libr/util/buf_io.c"
              :
  io_whence = 
# 51 "project/radare2/libr/util/buf_io.c" 3 4
             2
# 51 "project/radare2/libr/util/buf_io.c"
                          ;
  break;
 case 
# 53 "project/radare2/libr/util/buf_io.c" 3 4
     1
# 53 "project/radare2/libr/util/buf_io.c"
              :
  io_whence = 
# 54 "project/radare2/libr/util/buf_io.c" 3 4
             1
# 54 "project/radare2/libr/util/buf_io.c"
                          ;
  break;
 }
...
static 
# 60 "project/radare2/libr/util/buf_io.c" 3 4
      unsigned long long 
# 60 "project/radare2/libr/util/buf_io.c"
           buf_io_get_size(RBuffer *b) {
 struct buf_io_priv *priv = get_priv_io (b);
 return priv->iob->fd_size (priv->iob->io, priv->fd);
}

static 
# 65 "project/radare2/libr/util/buf_io.c" 3 4
      _Bool 
# 65 "project/radare2/libr/util/buf_io.c"
           buf_io_resize(RBuffer *b, 
# 65 "project/radare2/libr/util/buf_io.c" 3 4
                                     unsigned long long 
# 65 "project/radare2/libr/util/buf_io.c"
                                          newsize) {
...
static 
# 70 "project/radare2/libr/util/buf_io.c" 3 4
      long long 
# 70 "project/radare2/libr/util/buf_io.c"
           buf_io_read(RBuffer *b, 
# 70 "project/radare2/libr/util/buf_io.c" 3 4
                                   unsigned char 
# 70 "project/radare2/libr/util/buf_io.c"
                                       *buf, 
...
static 
# 75 "project/radare2/libr/util/buf_io.c" 3 4
      long long 
# 75 "project/radare2/libr/util/buf_io.c"
           buf_io_write(RBuffer *b, const 
# 75 "project/radare2/libr/util/buf_io.c" 3 4
                                          unsigned char 
# 75 "project/radare2/libr/util/buf_io.c"
                                              *buf, 
