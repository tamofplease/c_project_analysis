# 0 "project/radare2/libr/util/intervaltree.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/intervaltree.c"
...
# 4 "project/radare2/libr/util/intervaltree.c" 2
...
# 5 "project/radare2/libr/util/intervaltree.c" 2

#define unwrap(rbnode) container_of (rbnode, RIntervalNode, node)


# 8 "project/radare2/libr/util/intervaltree.c"
static void node_max(RBNode *node) {
 RIntervalNode *intervalnode = 
# 9 "project/radare2/libr/util/intervaltree.c" 3 4
                              ((
# 9 "project/radare2/libr/util/intervaltree.c"
                              RIntervalNode 
# 9 "project/radare2/libr/util/intervaltree.c" 3 4
                              *)((char *)(__typeof__(((
# 9 "project/radare2/libr/util/intervaltree.c"
...
# 14 "project/radare2/libr/util/intervaltree.c" 3 4
  unsigned long long 
# 14 "project/radare2/libr/util/intervaltree.c"
       end = 
# 14 "project/radare2/libr/util/intervaltree.c" 3 4
             ((
# 14 "project/radare2/libr/util/intervaltree.c"
...
# 23 "project/radare2/libr/util/intervaltree.c" 3 4
unsigned long long 
# 23 "project/radare2/libr/util/intervaltree.c"
     incoming_start = *(
# 23 "project/radare2/libr/util/intervaltree.c" 3 4
                        unsigned long long 
# 23 "project/radare2/libr/util/intervaltree.c"
...
# 24 "project/radare2/libr/util/intervaltree.c" 3 4
unsigned long long 
# 24 "project/radare2/libr/util/intervaltree.c"
     other_start = 
# 24 "project/radare2/libr/util/intervaltree.c" 3 4
                   ((
# 24 "project/radare2/libr/util/intervaltree.c"
...
static int cmp_exact_node(const void *incoming, const RBNode *in_tree, void *user) {
 ...
 const RIntervalNode *node = 
# 37 "project/radare2/libr/util/intervaltree.c" 3 4
                            ((
# 37 "project/radare2/libr/util/intervaltree.c"
                            const RIntervalNode 
# 37 "project/radare2/libr/util/intervaltree.c" 3 4
                            *)((char *)(__typeof__(((
# 37 "project/radare2/libr/util/intervaltree.c"
...
# 37 "project/radare2/libr/util/intervaltree.c"
 ...
 if (!path_cache->len) {
  ...
  while (cur) {
   ...
   if (incoming_node->start <= 
# 56 "project/radare2/libr/util/intervaltree.c" 3 4
                              ((
# 56 "project/radare2/libr/util/intervaltree.c"
                              RIntervalNode 
# 56 "project/radare2/libr/util/intervaltree.c" 3 4
                              *)((char *)(__typeof__(((
# 56 "project/radare2/libr/util/intervaltree.c"
...
# 56 "project/radare2/libr/util/intervaltree.c"
  ...
  while (
# 65 "project/radare2/libr/util/intervaltree.c" 3 4
        ((
# 65 "project/radare2/libr/util/intervaltree.c"
        path_cache
# 65 "project/radare2/libr/util/intervaltree.c" 3 4
        )->len)
# 65 "project/radare2/libr/util/intervaltree.c"
   ...
   RIntervalNode *intervalnode = 
# 66 "project/radare2/libr/util/intervaltree.c" 3 4
                                (((
# 66 "project/radare2/libr/util/intervaltree.c"
                                RIntervalNode 
# 66 "project/radare2/libr/util/intervaltree.c" 3 4
                                *)((char *)(__typeof__(((
# 66 "project/radare2/libr/util/intervaltree.c"
...
# 66 "project/radare2/libr/util/intervaltree.c"
 ...
 RBNode *next_child = 
# 86 "project/radare2/libr/util/intervaltree.c" 3 4
                     ((void *)0)
# 86 "project/radare2/libr/util/intervaltree.c"
                         ;

 size_t i;
 for (i = 0; i < path_cache->len - 1; i++) {
  if (
# 90 "project/radare2/libr/util/intervaltree.c" 3 4
     ((
# 90 "project/radare2/libr/util/intervaltree.c"
     RIntervalNode 
# 90 "project/radare2/libr/util/intervaltree.c" 3 4
     *)((char *)(__typeof__(((
# 90 "project/radare2/libr/util/intervaltree.c"
...
# 100 "project/radare2/libr/util/intervaltree.c" 3 4
__attribute__((visibility("default"))) 
# 100 "project/radare2/libr/util/intervaltree.c"
     void r_interval_tree_init(RIntervalTree *tree, RIntervalNodeFree free) {
 tree->root = 
# 101 "project/radare2/libr/util/intervaltree.c" 3 4
             ((void *)0)
# 101 "project/radare2/libr/util/intervaltree.c"
                 ;
 tree->free = free;
}
...
static void interval_node_free(RBNode *node, void *user) {
 RIntervalNode *ragenode = 
# 108 "project/radare2/libr/util/intervaltree.c" 3 4
                                     ((
# 108 "project/radare2/libr/util/intervaltree.c"
                                     RIntervalNode 
# 108 "project/radare2/libr/util/intervaltree.c" 3 4
                                     *)((char *)(__typeof__(((
# 108 "project/radare2/libr/util/intervaltree.c"
...
# 115 "project/radare2/libr/util/intervaltree.c" 3 4
__attribute__((visibility("default"))) 
# 115 "project/radare2/libr/util/intervaltree.c"
     void r_interval_tree_fini(RIntervalTree *tree) {
 if (!tree || !tree->root) {
  return;
 }
...
# 122 "project/radare2/libr/util/intervaltree.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 122 "project/radare2/libr/util/intervaltree.c"
          r_interval_tree_insert(RIntervalTree *tree, 
# 122 "project/radare2/libr/util/intervaltree.c" 3 4
                                                      unsigned long long 
# 122 "project/radare2/libr/util/intervaltree.c"
                                                           start, 
...
# 123 "project/radare2/libr/util/intervaltree.c" 3 4
do { if (!(
# 123 "project/radare2/libr/util/intervaltree.c"
end >= start
# 123 "project/radare2/libr/util/intervaltree.c" 3 4
...
"end >= start"
# 123 "project/radare2/libr/util/intervaltree.c" 3 4
, 123); return (0); } } while (0)
# 123 "project/radare2/libr/util/intervaltree.c"
                                          ;
 RIntervalNode *node = 
# 124 "project/radare2/libr/util/intervaltree.c" 3 4
                      (
# 124 "project/radare2/libr/util/intervaltree.c"
                      RIntervalNode
# 124 "project/radare2/libr/util/intervaltree.c" 3 4
                      *)calloc(1,sizeof(
# 124 "project/radare2/libr/util/intervaltree.c"
...
# 124 "project/radare2/libr/util/intervaltree.c"
 ...
 if (!node) {
  return 
# 126 "project/radare2/libr/util/intervaltree.c" 3 4
        0
# 126 "project/radare2/libr/util/intervaltree.c"
             ;
 }
 node->start = start;
 node->end = end;
 node->data = data;
 RBNode *root = tree->root ? &tree->root->node : 
# 131 "project/radare2/libr/util/intervaltree.c" 3 4
                                                ((void *)0)
# 131 "project/radare2/libr/util/intervaltree.c"
                                                    ;
 
# 132 "project/radare2/libr/util/intervaltree.c" 3 4
_Bool 
# 132 "project/radare2/libr/util/intervaltree.c"
     r = r_rbtree_aug_insert (&root, &start, &node->node, cmp, 
# 132 "project/radare2/libr/util/intervaltree.c" 3 4
                                                               ((void *)0)
# 132 "project/radare2/libr/util/intervaltree.c"
                                                                   , node_max);
 tree->root = 
# 133 "project/radare2/libr/util/intervaltree.c" 3 4
             ((
# 133 "project/radare2/libr/util/intervaltree.c"
             RIntervalNode 
# 133 "project/radare2/libr/util/intervaltree.c" 3 4
             *)((char *)(__typeof__(((
# 133 "project/radare2/libr/util/intervaltree.c"
...
# 140 "project/radare2/libr/util/intervaltree.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 140 "project/radare2/libr/util/intervaltree.c"
          r_interval_tree_delete(RIntervalTree *tree, RIntervalNode *node, 
# 140 "project/radare2/libr/util/intervaltree.c" 3 4
                                                                           _Bool 
# 140 "project/radare2/libr/util/intervaltree.c"
                                                                                free) {
...
# 143 "project/radare2/libr/util/intervaltree.c" 3 4
_Bool 
# 143 "project/radare2/libr/util/intervaltree.c"
     r = r_rbtree_aug_delete (&root, node, cmp_exact_node, &path_cache, interval_node_free, free ? tree->free : 
# 143 "project/radare2/libr/util/intervaltree.c" 3 4
                                                                                                                ((void *)0)
# 143 "project/radare2/libr/util/intervaltree.c"
                                                                                                                    , node_max);
 tree->root = root ? 
# 144 "project/radare2/libr/util/intervaltree.c" 3 4
                    ((
# 144 "project/radare2/libr/util/intervaltree.c"
                    RIntervalNode 
# 144 "project/radare2/libr/util/intervaltree.c" 3 4
                    *)((char *)(__typeof__(((
# 144 "project/radare2/libr/util/intervaltree.c"
...
# 148 "project/radare2/libr/util/intervaltree.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 148 "project/radare2/libr/util/intervaltree.c"
          r_interval_tree_resize(RIntervalTree *tree, RIntervalNode *node, 
# 148 "project/radare2/libr/util/intervaltree.c" 3 4
                                                                           unsigned long long 
# 148 "project/radare2/libr/util/intervaltree.c"
                                                                                new_start, 
...
# 149 "project/radare2/libr/util/intervaltree.c" 3 4
do { if (!(
# 149 "project/radare2/libr/util/intervaltree.c"
new_end >= new_start
# 149 "project/radare2/libr/util/intervaltree.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 149 "project/radare2/libr/util/intervaltree.c"
...
# 149 "project/radare2/libr/util/intervaltree.c"
 ...
 if (node->start != new_start) {
  ...
  void *data = node->data;
  if (!r_interval_tree_delete (tree, node, 
# 153 "project/radare2/libr/util/intervaltree.c" 3 4
                                          0
# 153 "project/radare2/libr/util/intervaltree.c"
                                               )) {
   return 
# 154 "project/radare2/libr/util/intervaltree.c" 3 4
         0
# 154 "project/radare2/libr/util/intervaltree.c"
              ;
  }
 ...
 return 
# 165 "project/radare2/libr/util/intervaltree.c" 3 4
       1
# 165 "project/radare2/libr/util/intervaltree.c"
           ;
}
...
# 170 "project/radare2/libr/util/intervaltree.c" 3 4
__attribute__((visibility("default"))) 
# 170 "project/radare2/libr/util/intervaltree.c"
     RIntervalNode *r_interval_tree_node_at(RIntervalTree *tree, 
# 170 "project/radare2/libr/util/intervaltree.c" 3 4
                                                                 unsigned long long 
# 170 "project/radare2/libr/util/intervaltree.c"
                                                                      start) {
 ...
 while (node) {
  if (start < node->start) {
   node = 
# 174 "project/radare2/libr/util/intervaltree.c" 3 4
         ((
# 174 "project/radare2/libr/util/intervaltree.c"
         RIntervalNode 
# 174 "project/radare2/libr/util/intervaltree.c" 3 4
         *)((char *)(__typeof__(((
# 174 "project/radare2/libr/util/intervaltree.c"
...
# 174 "project/radare2/libr/util/intervaltree.c"
   ...
   node = 
# 176 "project/radare2/libr/util/intervaltree.c" 3 4
         ((
# 176 "project/radare2/libr/util/intervaltree.c"
         RIntervalNode 
# 176 "project/radare2/libr/util/intervaltree.c" 3 4
         *)((char *)(__typeof__(((
# 176 "project/radare2/libr/util/intervaltree.c"
...
# 176 "project/radare2/libr/util/intervaltree.c"
 ...
 return 
# 181 "project/radare2/libr/util/intervaltree.c" 3 4
       ((void *)0)
# 181 "project/radare2/libr/util/intervaltree.c"
           ;
}


# 184 "project/radare2/libr/util/intervaltree.c" 3 4
__attribute__((visibility("default"))) 
# 184 "project/radare2/libr/util/intervaltree.c"
     RBIter r_interval_tree_first_at(RIntervalTree *tree, 
# 184 "project/radare2/libr/util/intervaltree.c" 3 4
                                                          unsigned long long 
# 184 "project/radare2/libr/util/intervaltree.c"
                                                               start) {
 ...
 while (node) {
  if (start <= 
# 196 "project/radare2/libr/util/intervaltree.c" 3 4
              ((
# 196 "project/radare2/libr/util/intervaltree.c"
              RIntervalNode 
# 196 "project/radare2/libr/util/intervaltree.c" 3 4
              *)((char *)(__typeof__(((
# 196 "project/radare2/libr/util/intervaltree.c"
...
# 207 "project/radare2/libr/util/intervaltree.c" 3 4
__attribute__((visibility("default"))) 
# 207 "project/radare2/libr/util/intervaltree.c"
     RIntervalNode *r_interval_tree_node_at_data(RIntervalTree *tree, 
# 207 "project/radare2/libr/util/intervaltree.c" 3 4
                                                                      unsigned long long 
# 207 "project/radare2/libr/util/intervaltree.c"
                                                                           start, void *data) {
 ...
 while (
# 209 "project/radare2/libr/util/intervaltree.c" 3 4
       ((
# 209 "project/radare2/libr/util/intervaltree.c"
       &it
# 209 "project/radare2/libr/util/intervaltree.c" 3 4
       )->len)
# 209 "project/radare2/libr/util/intervaltree.c"
  ...
  RIntervalNode *intervalnode = 
# 210 "project/radare2/libr/util/intervaltree.c" 3 4
                               (((
# 210 "project/radare2/libr/util/intervaltree.c"
                               RIntervalNode 
# 210 "project/radare2/libr/util/intervaltree.c" 3 4
                               *)((char *)(__typeof__(((
# 210 "project/radare2/libr/util/intervaltree.c"
...
# 210 "project/radare2/libr/util/intervaltree.c"
 ...
 return 
# 219 "project/radare2/libr/util/intervaltree.c" 3 4
       ((void *)0)
# 219 "project/radare2/libr/util/intervaltree.c"
           ;
}


# 222 "project/radare2/libr/util/intervaltree.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 222 "project/radare2/libr/util/intervaltree.c"
          r_interval_tree_all_at(RIntervalTree *tree, 
# 222 "project/radare2/libr/util/intervaltree.c" 3 4
                                                      unsigned long long 
# 222 "project/radare2/libr/util/intervaltree.c"
                                                           start, RIntervalIterCb cb, void *user) {
 RBIter it = r_interval_tree_first_at (tree, start);
 
# 224 "project/radare2/libr/util/intervaltree.c" 3 4
_Bool 
# 224 "project/radare2/libr/util/intervaltree.c"
     ret = 
# 224 "project/radare2/libr/util/intervaltree.c" 3 4
           1
# 224 "project/radare2/libr/util/intervaltree.c"
               ;
 while (
# 225 "project/radare2/libr/util/intervaltree.c" 3 4
       ((
# 225 "project/radare2/libr/util/intervaltree.c"
       &it
# 225 "project/radare2/libr/util/intervaltree.c" 3 4
       )->len)
# 225 "project/radare2/libr/util/intervaltree.c"
  ...
  RIntervalNode *intervalnode = 
# 226 "project/radare2/libr/util/intervaltree.c" 3 4
                               (((
# 226 "project/radare2/libr/util/intervaltree.c"
                               RIntervalNode 
# 226 "project/radare2/libr/util/intervaltree.c" 3 4
                               *)((char *)(__typeof__(((
# 226 "project/radare2/libr/util/intervaltree.c"
...
# 239 "project/radare2/libr/util/intervaltree.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 239 "project/radare2/libr/util/intervaltree.c"
          r_interval_node_all_in(RIntervalNode *node, 
# 239 "project/radare2/libr/util/intervaltree.c" 3 4
                                                      unsigned long long 
# 239 "project/radare2/libr/util/intervaltree.c"
                                                           value, 
# 239 "project/radare2/libr/util/intervaltree.c" 3 4
                                                                  _Bool 
# 239 "project/radare2/libr/util/intervaltree.c"
                                                                       end_inclusive, RIntervalIterCb cb, void *user) {
 while (node && value < node->start) {

  node = 
# 242 "project/radare2/libr/util/intervaltree.c" 3 4
        ((
# 242 "project/radare2/libr/util/intervaltree.c"
        RIntervalNode 
# 242 "project/radare2/libr/util/intervaltree.c" 3 4
        *)((char *)(__typeof__(((
# 242 "project/radare2/libr/util/intervaltree.c"
...
# 242 "project/radare2/libr/util/intervaltree.c"
 ...
 if (!node) {
  return 
# 245 "project/radare2/libr/util/intervaltree.c" 3 4
        1
# 245 "project/radare2/libr/util/intervaltree.c"
            ;
 }
 if (end_inclusive ? value > node->max_end : value >= node->max_end) {
  return 
# 248 "project/radare2/libr/util/intervaltree.c" 3 4
        1
# 248 "project/radare2/libr/util/intervaltree.c"
            ;
 }
 if (end_inclusive ? value <= node->end : value < node->end) {
  if (!cb (node, user)) {
   return 
# 252 "project/radare2/libr/util/intervaltree.c" 3 4
         0
# 252 "project/radare2/libr/util/intervaltree.c"
              ;
  }
 }

 
# 256 "project/radare2/libr/util/intervaltree.c" 3 4
_Bool 
# 256 "project/radare2/libr/util/intervaltree.c"
     ret = r_interval_node_all_in (
# 256 "project/radare2/libr/util/intervaltree.c" 3 4
                                   ((
# 256 "project/radare2/libr/util/intervaltree.c"
                                   RIntervalNode 
...
# 256 "project/radare2/libr/util/intervaltree.c"
                                                               , value, end_inclusive, cb, user);
 if (!ret) {
  return 
# 258 "project/radare2/libr/util/intervaltree.c" 3 4
        0
# 258 "project/radare2/libr/util/intervaltree.c"
             ;
 }
 return r_interval_node_all_in (
# 260 "project/radare2/libr/util/intervaltree.c" 3 4
                               ((
# 260 "project/radare2/libr/util/intervaltree.c"
                               RIntervalNode 
# 260 "project/radare2/libr/util/intervaltree.c" 3 4
                               *)((char *)(__typeof__(((
# 260 "project/radare2/libr/util/intervaltree.c"
...
# 263 "project/radare2/libr/util/intervaltree.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 263 "project/radare2/libr/util/intervaltree.c"
          r_interval_tree_all_in(RIntervalTree *tree, 
# 263 "project/radare2/libr/util/intervaltree.c" 3 4
                                                      unsigned long long 
# 263 "project/radare2/libr/util/intervaltree.c"
                                                           value, 
...
static 
# 268 "project/radare2/libr/util/intervaltree.c" 3 4
      _Bool 
# 268 "project/radare2/libr/util/intervaltree.c"
           r_interval_node_all_intersect(RIntervalNode *node, 
# 268 "project/radare2/libr/util/intervaltree.c" 3 4
                                                              unsigned long long 
# 268 "project/radare2/libr/util/intervaltree.c"
                                                                   start, 
...
# 269 "project/radare2/libr/util/intervaltree.c" 3 4
do { if (!(
# 269 "project/radare2/libr/util/intervaltree.c"
end >= start
# 269 "project/radare2/libr/util/intervaltree.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 269 "project/radare2/libr/util/intervaltree.c"
"end >= start"
# 269 "project/radare2/libr/util/intervaltree.c" 3 4
, 269); return (1); } } while (0)
# 269 "project/radare2/libr/util/intervaltree.c"
                                         ;
 while (node && (end_inclusive ? end < node->start : end <= node->start)) {

  node = 
# 272 "project/radare2/libr/util/intervaltree.c" 3 4
        ((
# 272 "project/radare2/libr/util/intervaltree.c"
        RIntervalNode 
# 272 "project/radare2/libr/util/intervaltree.c" 3 4
        *)((char *)(__typeof__(((
# 272 "project/radare2/libr/util/intervaltree.c"
...
# 272 "project/radare2/libr/util/intervaltree.c"
 ...
 if (!node) {
  return 
# 275 "project/radare2/libr/util/intervaltree.c" 3 4
        1
# 275 "project/radare2/libr/util/intervaltree.c"
            ;
 }
 if (end_inclusive ? start > node->max_end : start >= node->max_end) {
  return 
# 278 "project/radare2/libr/util/intervaltree.c" 3 4
        1
# 278 "project/radare2/libr/util/intervaltree.c"
            ;
 }
 if (end_inclusive ? start <= node->end : start < node->end) {
  if (!cb (node, user)) {
   return 
# 282 "project/radare2/libr/util/intervaltree.c" 3 4
         0
# 282 "project/radare2/libr/util/intervaltree.c"
              ;
  }
 }

 if (!r_interval_node_all_intersect (
# 286 "project/radare2/libr/util/intervaltree.c" 3 4
                                    ((
# 286 "project/radare2/libr/util/intervaltree.c"
                                    RIntervalNode 
# 286 "project/radare2/libr/util/intervaltree.c" 3 4
                                    *)((char *)(__typeof__(((
# 286 "project/radare2/libr/util/intervaltree.c"
...
# 286 "project/radare2/libr/util/intervaltree.c"
                                                                , start, end, end_inclusive, cb, user)) {
  return 
# 287 "project/radare2/libr/util/intervaltree.c" 3 4
        0
# 287 "project/radare2/libr/util/intervaltree.c"
             ;
 }
 return r_interval_node_all_intersect (
# 289 "project/radare2/libr/util/intervaltree.c" 3 4
                                      ((
# 289 "project/radare2/libr/util/intervaltree.c"
                                      RIntervalNode 
# 289 "project/radare2/libr/util/intervaltree.c" 3 4
                                      *)((char *)(__typeof__(((
# 289 "project/radare2/libr/util/intervaltree.c"
...
# 292 "project/radare2/libr/util/intervaltree.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 292 "project/radare2/libr/util/intervaltree.c"
          r_interval_tree_all_intersect(RIntervalTree *tree, 
# 292 "project/radare2/libr/util/intervaltree.c" 3 4
                                                             unsigned long long 
# 292 "project/radare2/libr/util/intervaltree.c"
                                                                  start, 
