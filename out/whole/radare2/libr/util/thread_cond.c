# 0 "project/radare2/libr/util/thread_cond.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/thread_cond.c"
...
# 4 "project/radare2/libr/util/thread_cond.c" 2



__attribute__((visibility("default"))) 
# 7 "project/radare2/libr/util/thread_cond.c"
     RThreadCond *r_th_cond_new(void) {
 RThreadCond *cond = 
# 8 "project/radare2/libr/util/thread_cond.c" 3 4
                    (
# 8 "project/radare2/libr/util/thread_cond.c"
                    RThreadCond
# 8 "project/radare2/libr/util/thread_cond.c" 3 4
                    *)calloc(1,sizeof(
# 8 "project/radare2/libr/util/thread_cond.c"
...
# 8 "project/radare2/libr/util/thread_cond.c"
 ...
 if (!cond) {
  return 
# 10 "project/radare2/libr/util/thread_cond.c" 3 4
        ((void *)0)
# 10 "project/radare2/libr/util/thread_cond.c"
            ;
 }

 if (pthread_cond_init (&cond->cond, 
# 13 "project/radare2/libr/util/thread_cond.c" 3 4
                                    ((void *)0)
# 13 "project/radare2/libr/util/thread_cond.c"
                                        ) != 0) {
  free (cond);
  return 
# 15 "project/radare2/libr/util/thread_cond.c" 3 4
        ((void *)0)
# 15 "project/radare2/libr/util/thread_cond.c"
            ;
 }
...
# 23 "project/radare2/libr/util/thread_cond.c" 3 4
__attribute__((visibility("default"))) 
# 23 "project/radare2/libr/util/thread_cond.c"
     void r_th_cond_signal(RThreadCond *cond) {
...
# 31 "project/radare2/libr/util/thread_cond.c" 3 4
__attribute__((visibility("default"))) 
# 31 "project/radare2/libr/util/thread_cond.c"
     void r_th_cond_signal_all(RThreadCond *cond) {
...
# 39 "project/radare2/libr/util/thread_cond.c" 3 4
__attribute__((visibility("default"))) 
# 39 "project/radare2/libr/util/thread_cond.c"
     void r_th_cond_wait(RThreadCond *cond, RThreadLock *lock) {
...
# 47 "project/radare2/libr/util/thread_cond.c" 3 4
__attribute__((visibility("default"))) 
# 47 "project/radare2/libr/util/thread_cond.c"
     void r_th_cond_free(RThreadCond *cond) {
 if (!cond) {
  return;
 }
