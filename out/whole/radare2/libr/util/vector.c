# 0 "project/radare2/libr/util/vector.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/vector.c"
...
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_vector.h" 2 3 4
...
# 4 "project/radare2/libr/util/vector.c" 2
# 12 "project/radare2/libr/util/vector.c"
#define INITIAL_VECTOR_LEN 4


#define NEXT_VECTOR_CAPACITY (vec->capacity < INITIAL_VECTOR_LEN ? INITIAL_VECTOR_LEN : vec->capacity <= 12 ? vec->capacity * 2 : vec->capacity + (vec->capacity >> 1))




#define RESIZE_OR_RETURN_NULL(next_capacity) do { size_t new_capacity = next_capacity; void **new_a = realloc (vec->a, vec->elem_size * new_capacity); if (!new_a) { return NULL; } vec->a = new_a; vec->capacity = new_capacity; } while (0)
# 30 "project/radare2/libr/util/vector.c"
__attribute__((visibility("default"))) 
# 30 "project/radare2/libr/util/vector.c"
     void r_vector_init(RVector *vec, size_t elem_size, RVectorFree free, void *free_user) {
 
# 31 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 31 "project/radare2/libr/util/vector.c"
vec
# 31 "project/radare2/libr/util/vector.c" 3 4
...
# 31 "project/radare2/libr/util/vector.c"
                      ;
 vec->a = 
# 32 "project/radare2/libr/util/vector.c" 3 4
         ((void *)0)
# 32 "project/radare2/libr/util/vector.c"
             ;
...
# 39 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 39 "project/radare2/libr/util/vector.c"
     RVector *r_vector_new(size_t elem_size, RVectorFree free, void *free_user) {
 RVector *vec = 
# 40 "project/radare2/libr/util/vector.c" 3 4
               (
# 40 "project/radare2/libr/util/vector.c"
               RVector
# 40 "project/radare2/libr/util/vector.c" 3 4
               *)malloc(sizeof(
# 40 "project/radare2/libr/util/vector.c"
...
# 40 "project/radare2/libr/util/vector.c"
 ...
 if (!vec) {
  return 
# 42 "project/radare2/libr/util/vector.c" 3 4
        ((void *)0)
# 42 "project/radare2/libr/util/vector.c"
            ;
 }
...
# 58 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 58 "project/radare2/libr/util/vector.c"
     void r_vector_fini(RVector *vec) {
 
# 59 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 59 "project/radare2/libr/util/vector.c"
vec
# 59 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 59 "project/radare2/libr/util/vector.c"
...
# 59 "project/radare2/libr/util/vector.c"
 ...
 r_vector_clear (vec);
 vec->free = 
# 61 "project/radare2/libr/util/vector.c" 3 4
            ((void *)0)
# 61 "project/radare2/libr/util/vector.c"
                ;
 vec->free_user = 
# 62 "project/radare2/libr/util/vector.c" 3 4
                 ((void *)0)
# 62 "project/radare2/libr/util/vector.c"
                     ;
}


# 65 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 65 "project/radare2/libr/util/vector.c"
     void r_vector_clear(RVector *vec) {
 
# 66 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 66 "project/radare2/libr/util/vector.c"
vec
# 66 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 66 "project/radare2/libr/util/vector.c"
...
# 68 "project/radare2/libr/util/vector.c" 3 4
{ free((void *)
# 68 "project/radare2/libr/util/vector.c"
vec->a
# 68 "project/radare2/libr/util/vector.c" 3 4
); 
# 68 "project/radare2/libr/util/vector.c"
...
# 72 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 72 "project/radare2/libr/util/vector.c"
...
static 
# 79 "project/radare2/libr/util/vector.c" 3 4
      _Bool 
# 79 "project/radare2/libr/util/vector.c"
           vector_clone(RVector *dst, RVector *src) {
 
# 80 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 80 "project/radare2/libr/util/vector.c"
dst && src
# 80 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 80 "project/radare2/libr/util/vector.c"
...
# 80 "project/radare2/libr/util/vector.c"
 ...
 if (!dst->len) {
  dst->a = 
# 87 "project/radare2/libr/util/vector.c" 3 4
          ((void *)0)
# 87 "project/radare2/libr/util/vector.c"
              ;
 } else {
  dst->a = malloc (src->elem_size * src->capacity);
  if (!dst->a) {
   return 
# 91 "project/radare2/libr/util/vector.c" 3 4
         0
# 91 "project/radare2/libr/util/vector.c"
              ;
  }
  
# 93 "project/radare2/libr/util/vector.c" 3 4
 __builtin___memcpy_chk (
# 93 "project/radare2/libr/util/vector.c"
 dst->a
# 93 "project/radare2/libr/util/vector.c" 3 4
 , 
# 93 "project/radare2/libr/util/vector.c"
 src->a, src->elem_size * src->len
# 93 "project/radare2/libr/util/vector.c" 3 4
...
# 93 "project/radare2/libr/util/vector.c"
 ...
 return 
# 95 "project/radare2/libr/util/vector.c" 3 4
       1
# 95 "project/radare2/libr/util/vector.c"
           ;
}


# 98 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 98 "project/radare2/libr/util/vector.c"
     RVector *r_vector_clone(RVector *vec) {
 
# 99 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 99 "project/radare2/libr/util/vector.c"
vec
# 99 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 99 "project/radare2/libr/util/vector.c"
...
# 99 "project/radare2/libr/util/vector.c"
                                ;
 RVector *ret = 
# 100 "project/radare2/libr/util/vector.c" 3 4
               (
# 100 "project/radare2/libr/util/vector.c"
               RVector
# 100 "project/radare2/libr/util/vector.c" 3 4
               *)malloc(sizeof(
# 100 "project/radare2/libr/util/vector.c"
...
# 100 "project/radare2/libr/util/vector.c"
 ...
 if (!ret) {
  return 
# 102 "project/radare2/libr/util/vector.c" 3 4
        ((void *)0)
# 102 "project/radare2/libr/util/vector.c"
            ;
 }
 if (!vector_clone (ret, vec)) {
  free (ret);
  return 
# 106 "project/radare2/libr/util/vector.c" 3 4
        ((void *)0)
# 106 "project/radare2/libr/util/vector.c"
            ;
 }
 return ret;
}
...
# 111 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 111 "project/radare2/libr/util/vector.c"
     void r_vector_assign(RVector *vec, void *p, void *elem) {
 
# 112 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 112 "project/radare2/libr/util/vector.c"
vec && p && elem
# 112 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 112 "project/radare2/libr/util/vector.c"
...
# 113 "project/radare2/libr/util/vector.c" 3 4
__builtin___memcpy_chk (
# 113 "project/radare2/libr/util/vector.c"
p
# 113 "project/radare2/libr/util/vector.c" 3 4
, 
# 113 "project/radare2/libr/util/vector.c"
...
# 116 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 116 "project/radare2/libr/util/vector.c"
...
# 124 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 124 "project/radare2/libr/util/vector.c"
     void r_vector_remove_at(RVector *vec, size_t index, void *into) {
 
# 125 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 125 "project/radare2/libr/util/vector.c"
vec
# 125 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 125 "project/radare2/libr/util/vector.c"
...
# 132 "project/radare2/libr/util/vector.c" 3 4
 __builtin___memmove_chk (
# 132 "project/radare2/libr/util/vector.c"
 p
# 132 "project/radare2/libr/util/vector.c" 3 4
 , 
# 132 "project/radare2/libr/util/vector.c"
 (char *)p + vec->elem_size, vec->elem_size * (vec->len - index)
# 132 "project/radare2/libr/util/vector.c" 3 4
 , __builtin_object_size (
# 132 "project/radare2/libr/util/vector.c"
 p
...
# 136 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 136 "project/radare2/libr/util/vector.c"
     void *r_vector_insert(RVector *vec, size_t index, void *x) {
 
# 137 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 137 "project/radare2/libr/util/vector.c"
vec && index <= vec->len
# 137 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 137 "project/radare2/libr/util/vector.c"
"vec && index <= vec->len"
# 137 "project/radare2/libr/util/vector.c" 3 4
, 137); return (((void *)0)); } } while (0)
# 137 "project/radare2/libr/util/vector.c"
                                                     ;
 if (vec->len >= vec->capacity) {
  do { size_t new_capacity = (vec->capacity < 4 ? 4 : vec->capacity <= 12 ? vec->capacity * 2 : vec->capacity + (vec->capacity >> 1)); void **new_a = realloc (vec->a, vec->elem_size * new_capacity); if (!new_a) { return 
# 139 "project/radare2/libr/util/vector.c" 3 4
 ((void *)0)
# 139 "project/radare2/libr/util/vector.c"
 ; } vec->a = new_a; vec->capacity = new_capacity; } while (0);
 }
 void *p = r_vector_index_ptr (vec, index);
 if (index < vec->len) {
  
# 143 "project/radare2/libr/util/vector.c" 3 4
 __builtin___memmove_chk (
# 143 "project/radare2/libr/util/vector.c"
 (char *)p + vec->elem_size
# 143 "project/radare2/libr/util/vector.c" 3 4
 , 
# 143 "project/radare2/libr/util/vector.c"
 p, vec->elem_size * (vec->len - index)
# 143 "project/radare2/libr/util/vector.c" 3 4
 , __builtin_object_size (
# 143 "project/radare2/libr/util/vector.c"
 (char *)p + vec->elem_size
...
# 152 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 152 "project/radare2/libr/util/vector.c"
     void *r_vector_insert_range(RVector *vec, size_t index, void *first, size_t count) {
 
# 153 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 153 "project/radare2/libr/util/vector.c"
vec && index <= vec->len
# 153 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 153 "project/radare2/libr/util/vector.c"
"vec && index <= vec->len"
# 153 "project/radare2/libr/util/vector.c" 3 4
, 153); return (((void *)0)); } } while (0)
# 153 "project/radare2/libr/util/vector.c"
                                                     ;
 if (vec->len + count > vec->capacity) {
  do { size_t new_capacity = 
# 155 "project/radare2/libr/util/vector.c" 3 4
 (((
# 155 "project/radare2/libr/util/vector.c"
 (vec->capacity < 4 ? 4 : vec->capacity <= 12 ? vec->capacity * 2 : vec->capacity + (vec->capacity >> 1))
# 155 "project/radare2/libr/util/vector.c" 3 4
 )>(
# 155 "project/radare2/libr/util/vector.c"
 vec->len + count
...
# 155 "project/radare2/libr/util/vector.c"
 ; void **new_a = realloc (vec->a, vec->elem_size * new_capacity); if (!new_a) { return 
# 155 "project/radare2/libr/util/vector.c" 3 4
 ((void *)0)
# 155 "project/radare2/libr/util/vector.c"
 ; } vec->a = new_a; vec->capacity = new_capacity; } while (0);
...
# 160 "project/radare2/libr/util/vector.c" 3 4
 __builtin___memmove_chk (
# 160 "project/radare2/libr/util/vector.c"
 (char *)p + sz
# 160 "project/radare2/libr/util/vector.c" 3 4
 , 
# 160 "project/radare2/libr/util/vector.c"
...
# 164 "project/radare2/libr/util/vector.c" 3 4
 __builtin___memcpy_chk (
# 164 "project/radare2/libr/util/vector.c"
 p
# 164 "project/radare2/libr/util/vector.c" 3 4
 , 
# 164 "project/radare2/libr/util/vector.c"
...
# 169 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 169 "project/radare2/libr/util/vector.c"
     void r_vector_pop(RVector *vec, void *into) {
 
# 170 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 170 "project/radare2/libr/util/vector.c"
vec
# 170 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 170 "project/radare2/libr/util/vector.c"
...
# 177 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 177 "project/radare2/libr/util/vector.c"
     void r_vector_pop_front(RVector *vec, void *into) {
 
# 178 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 178 "project/radare2/libr/util/vector.c"
vec
# 178 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 178 "project/radare2/libr/util/vector.c"
...
# 182 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 182 "project/radare2/libr/util/vector.c"
     void *r_vector_push(RVector *vec, void *x) {
 
# 183 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 183 "project/radare2/libr/util/vector.c"
vec
# 183 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 183 "project/radare2/libr/util/vector.c"
"vec"
# 183 "project/radare2/libr/util/vector.c" 3 4
, 183); return (((void *)0)); } } while (0)
# 183 "project/radare2/libr/util/vector.c"
                                ;
 if (vec->len >= vec->capacity) {
  do { size_t new_capacity = (vec->capacity < 4 ? 4 : vec->capacity <= 12 ? vec->capacity * 2 : vec->capacity + (vec->capacity >> 1)); void **new_a = realloc (vec->a, vec->elem_size * new_capacity); if (!new_a) { return 
# 185 "project/radare2/libr/util/vector.c" 3 4
 ((void *)0)
# 185 "project/radare2/libr/util/vector.c"
 ; } vec->a = new_a; vec->capacity = new_capacity; } while (0);
 }
...
# 194 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 194 "project/radare2/libr/util/vector.c"
     void *r_vector_push_front(RVector *vec, void *x) {
 
# 195 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 195 "project/radare2/libr/util/vector.c"
vec
# 195 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 195 "project/radare2/libr/util/vector.c"
...
# 199 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 199 "project/radare2/libr/util/vector.c"
     void *r_vector_reserve(RVector *vec, size_t capacity) {
 
# 200 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 200 "project/radare2/libr/util/vector.c"
vec
# 200 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 200 "project/radare2/libr/util/vector.c"
"vec"
# 200 "project/radare2/libr/util/vector.c" 3 4
, 200); return (((void *)0)); } } while (0)
# 200 "project/radare2/libr/util/vector.c"
                                ;
 if (vec->capacity < capacity) {
  do { size_t new_capacity = capacity; void **new_a = realloc (vec->a, vec->elem_size * new_capacity); if (!new_a) { return 
# 202 "project/radare2/libr/util/vector.c" 3 4
 ((void *)0)
# 202 "project/radare2/libr/util/vector.c"
 ; } vec->a = new_a; vec->capacity = new_capacity; } while (0);
 }
 return vec->a;
}
...
# 207 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 207 "project/radare2/libr/util/vector.c"
     void *r_vector_shrink(RVector *vec) {
 
# 208 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 208 "project/radare2/libr/util/vector.c"
vec
# 208 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 208 "project/radare2/libr/util/vector.c"
"vec"
# 208 "project/radare2/libr/util/vector.c" 3 4
, 208); return (((void *)0)); } } while (0)
# 208 "project/radare2/libr/util/vector.c"
                                ;
 if (vec->len < vec->capacity) {
  do { size_t new_capacity = vec->len; void **new_a = realloc (vec->a, vec->elem_size * new_capacity); if (!new_a) { return 
# 210 "project/radare2/libr/util/vector.c" 3 4
 ((void *)0)
# 210 "project/radare2/libr/util/vector.c"
 ; } vec->a = new_a; vec->capacity = new_capacity; } while (0);
 }
 return vec->a;
}
...
# 215 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 215 "project/radare2/libr/util/vector.c"
     void *r_vector_flush(RVector *vec) {
       
# 216 "project/radare2/libr/util/vector.c" 3 4
      do { if (!(
# 216 "project/radare2/libr/util/vector.c"
      vec
# 216 "project/radare2/libr/util/vector.c" 3 4
      )) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 216 "project/radare2/libr/util/vector.c"
      "vec"
# 216 "project/radare2/libr/util/vector.c" 3 4
      , 216); return (((void *)0)); } } while (0)
# 216 "project/radare2/libr/util/vector.c"
                                      ;
       r_vector_shrink (vec);
       void *r = vec->a;
       vec->a = 
# 219 "project/radare2/libr/util/vector.c" 3 4
               ((void *)0)
# 219 "project/radare2/libr/util/vector.c"
                   ;
       vec->capacity = vec->len = 0;
       return r;
}
...
# 232 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 232 "project/radare2/libr/util/vector.c"
     void r_pvector_init(RPVector *vec, RPVectorFree free) {
 r_vector_init (&vec->v, sizeof (void *), free ? pvector_free_elem : 
# 233 "project/radare2/libr/util/vector.c" 3 4
                                                                    ((void *)0)
# 233 "project/radare2/libr/util/vector.c"
                                                                        , free);
}


# 236 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 236 "project/radare2/libr/util/vector.c"
     RPVector *r_pvector_new(RPVectorFree free) {
 RPVector *v = 
# 237 "project/radare2/libr/util/vector.c" 3 4
              (
# 237 "project/radare2/libr/util/vector.c"
              RPVector
# 237 "project/radare2/libr/util/vector.c" 3 4
              *)malloc(sizeof(
# 237 "project/radare2/libr/util/vector.c"
...
# 237 "project/radare2/libr/util/vector.c"
 ...
 if (!v) {
  return 
# 239 "project/radare2/libr/util/vector.c" 3 4
        ((void *)0)
# 239 "project/radare2/libr/util/vector.c"
            ;
 }
...
# 245 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 245 "project/radare2/libr/util/vector.c"
     RPVector *r_pvector_new_with_len(RPVectorFree free, size_t length) {
 RPVector *v = r_pvector_new (free);
 if (!v) {
  return 
# 248 "project/radare2/libr/util/vector.c" 3 4
        ((void *)0)
# 248 "project/radare2/libr/util/vector.c"
            ;
 }
 ...
 if (!p) {
  r_pvector_free (v);
  return 
# 253 "project/radare2/libr/util/vector.c" 3 4
        ((void *)0)
# 253 "project/radare2/libr/util/vector.c"
            ;
 }
 
# 255 "project/radare2/libr/util/vector.c" 3 4
__builtin___memset_chk (
# 255 "project/radare2/libr/util/vector.c"
p
# 255 "project/radare2/libr/util/vector.c" 3 4
, 
# 255 "project/radare2/libr/util/vector.c"
0, v->v.elem_size * v->v.capacity
# 255 "project/radare2/libr/util/vector.c" 3 4
, __builtin_object_size (
# 255 "project/radare2/libr/util/vector.c"
p
...
# 260 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 260 "project/radare2/libr/util/vector.c"
     void r_pvector_clear(RPVector *vec) {
 
# 261 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 261 "project/radare2/libr/util/vector.c"
vec
# 261 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 261 "project/radare2/libr/util/vector.c"
...
# 265 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 265 "project/radare2/libr/util/vector.c"
     void r_pvector_fini(RPVector *vec) {
 
# 266 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 266 "project/radare2/libr/util/vector.c"
vec
# 266 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 266 "project/radare2/libr/util/vector.c"
...
# 270 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 270 "project/radare2/libr/util/vector.c"
     void r_pvector_free(RPVector *vec) {
 if (!vec) {
  return;
 }
 r_vector_fini (&vec->v);
...
# 278 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 278 "project/radare2/libr/util/vector.c"
     void **r_pvector_contains(RPVector *vec, void *x) {
 
# 279 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 279 "project/radare2/libr/util/vector.c"
vec
# 279 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 279 "project/radare2/libr/util/vector.c"
...
# 279 "project/radare2/libr/util/vector.c"
 ...
 return 
# 286 "project/radare2/libr/util/vector.c" 3 4
       ((void *)0)
# 286 "project/radare2/libr/util/vector.c"
           ;
}


# 289 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 289 "project/radare2/libr/util/vector.c"
     void *r_pvector_remove_at(RPVector *vec, size_t index) {
 
# 290 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 290 "project/radare2/libr/util/vector.c"
vec
# 290 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 290 "project/radare2/libr/util/vector.c"
"vec"
# 290 "project/radare2/libr/util/vector.c" 3 4
, 290); return (((void *)0)); } } while (0)
# 290 "project/radare2/libr/util/vector.c"
                                ;
 void *r = r_pvector_at (vec, index);
 r_vector_remove_at (&vec->v, index, 
# 292 "project/radare2/libr/util/vector.c" 3 4
                                    ((void *)0)
# 292 "project/radare2/libr/util/vector.c"
                                        );
 return r;
}


# 296 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 296 "project/radare2/libr/util/vector.c"
     void r_pvector_remove_data(RPVector *vec, void *x) {
 ...
 r_vector_remove_at (&vec->v, index, 
# 303 "project/radare2/libr/util/vector.c" 3 4
                                    ((void *)0)
# 303 "project/radare2/libr/util/vector.c"
                                        );
}


# 306 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 306 "project/radare2/libr/util/vector.c"
     void *r_pvector_pop(RPVector *vec) {
 
# 307 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 307 "project/radare2/libr/util/vector.c"
vec
# 307 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 307 "project/radare2/libr/util/vector.c"
"vec"
# 307 "project/radare2/libr/util/vector.c" 3 4
, 307); return (((void *)0)); } } while (0)
# 307 "project/radare2/libr/util/vector.c"
                                ;
 if (r_pvector_len (vec) < 1) {
  return 
# 309 "project/radare2/libr/util/vector.c" 3 4
        ((void *)0)
# 309 "project/radare2/libr/util/vector.c"
            ;
 }
 void *r = r_pvector_at (vec, vec->v.len - 1);
 r_vector_pop (&vec->v, 
# 312 "project/radare2/libr/util/vector.c" 3 4
                       ((void *)0)
# 312 "project/radare2/libr/util/vector.c"
                           );
 return r;
}


# 316 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 316 "project/radare2/libr/util/vector.c"
     void *r_pvector_pop_front(RPVector *vec) {
 
# 317 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 317 "project/radare2/libr/util/vector.c"
vec
# 317 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 317 "project/radare2/libr/util/vector.c"
"vec"
# 317 "project/radare2/libr/util/vector.c" 3 4
, 317); return (((void *)0)); } } while (0)
# 317 "project/radare2/libr/util/vector.c"
                                ;
 if (r_pvector_len (vec) < 1) {
  return 
# 319 "project/radare2/libr/util/vector.c" 3 4
        ((void *)0)
# 319 "project/radare2/libr/util/vector.c"
            ;
 }
 void *r = r_pvector_at (vec, 0);
 r_vector_pop_front (&vec->v, 
# 322 "project/radare2/libr/util/vector.c" 3 4
                             ((void *)0)
# 322 "project/radare2/libr/util/vector.c"
                                 );
 return r;
}
...
# 348 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 348 "project/radare2/libr/util/vector.c"
     void r_pvector_sort(RPVector *vec, RPVectorComparator cmp) {
 
# 349 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 349 "project/radare2/libr/util/vector.c"
vec && cmp
# 349 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 349 "project/radare2/libr/util/vector.c"
...
# 353 "project/radare2/libr/util/vector.c" 3 4
__attribute__((visibility("default"))) 
# 353 "project/radare2/libr/util/vector.c"
     int r_pvector_bsearch(RPVector *vec, void *needle, RPVectorComparator cmp) {
 
# 354 "project/radare2/libr/util/vector.c" 3 4
do { if (!(
# 354 "project/radare2/libr/util/vector.c"
vec && cmp
# 354 "project/radare2/libr/util/vector.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 354 "project/radare2/libr/util/vector.c"
