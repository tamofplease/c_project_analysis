# 0 "project/radare2/libr/util/big_ssl.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/big_ssl.c"
...
# 2 "project/radare2/libr/util/big_ssl.c" 2

__attribute__((visibility("default"))) 
# 3 "project/radare2/libr/util/big_ssl.c"
     RNumBig *r_big_new(void) {
 return BN_new ();
}


# 7 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 7 "project/radare2/libr/util/big_ssl.c"
     void r_big_free(RNumBig *b) {
 BN_free (b);
}


# 11 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 11 "project/radare2/libr/util/big_ssl.c"
     void r_big_init(RNumBig *b) {
 BN_zero (b);
}


# 15 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 15 "project/radare2/libr/util/big_ssl.c"
     void r_big_fini(RNumBig *b) {
 BN_clear (b);
}


# 19 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 19 "project/radare2/libr/util/big_ssl.c"
...
# 28 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) long long 
# 28 "project/radare2/libr/util/big_ssl.c"
...
# 43 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 43 "project/radare2/libr/util/big_ssl.c"
     void r_big_from_hexstr(RNumBig *b, const char *str) {
...
# 54 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 54 "project/radare2/libr/util/big_ssl.c"
...
# 70 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 70 "project/radare2/libr/util/big_ssl.c"
     void r_big_assign(RNumBig *dst, RNumBig *src) {
 BN_copy (dst, src);
}


# 74 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 74 "project/radare2/libr/util/big_ssl.c"
     void r_big_add(RNumBig *c, RNumBig *a, RNumBig *b) {
 BN_add (c, a, b);
}


# 78 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 78 "project/radare2/libr/util/big_ssl.c"
     void r_big_sub(RNumBig *c, RNumBig *a, RNumBig *b) {
 BN_sub (c, a, b);
}


# 82 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 82 "project/radare2/libr/util/big_ssl.c"
...
# 88 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 88 "project/radare2/libr/util/big_ssl.c"
     void r_big_div(RNumBig *c, RNumBig *a, RNumBig *b) {
 BN_CTX *bn_ctx = BN_CTX_new ();
 BN_div (c, 
# 90 "project/radare2/libr/util/big_ssl.c" 3 4
           ((void *)0)
# 90 "project/radare2/libr/util/big_ssl.c"
               , a, b, bn_ctx);
 BN_CTX_free (bn_ctx);
}


# 94 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 94 "project/radare2/libr/util/big_ssl.c"
...
# 100 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 100 "project/radare2/libr/util/big_ssl.c"
...
# 106 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 106 "project/radare2/libr/util/big_ssl.c"
...
# 113 "project/radare2/libr/util/big_ssl.c" 3 4
unsigned int 
# 113 "project/radare2/libr/util/big_ssl.c"
     tmp = 0;
 r_big_assign (A, a);
 r_big_assign (B, b);
...
# 137 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 137 "project/radare2/libr/util/big_ssl.c"
...
# 144 "project/radare2/libr/util/big_ssl.c" 3 4
unsigned int 
# 144 "project/radare2/libr/util/big_ssl.c"
     tmp = 0;
 r_big_assign (A, a);
 r_big_assign (B, b);
...
# 168 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 168 "project/radare2/libr/util/big_ssl.c"
...
# 175 "project/radare2/libr/util/big_ssl.c" 3 4
unsigned int 
# 175 "project/radare2/libr/util/big_ssl.c"
     tmp = 0;
 r_big_assign (A, a);
 r_big_assign (B, b);
...
# 199 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 199 "project/radare2/libr/util/big_ssl.c"
     void r_big_lshift(RNumBig *c, RNumBig *a, size_t nbits) {
 BN_lshift (c, a, nbits);
}


# 203 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 203 "project/radare2/libr/util/big_ssl.c"
     void r_big_rshift(RNumBig *c, RNumBig *a, size_t nbits) {
 BN_rshift (c, a, nbits);
}


# 207 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 207 "project/radare2/libr/util/big_ssl.c"
     int r_big_cmp(RNumBig *a, RNumBig *b) {
 return BN_cmp (a, b);
}


# 211 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 211 "project/radare2/libr/util/big_ssl.c"
     int r_big_is_zero(RNumBig *a) {
 return BN_is_zero (a);
}


# 215 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 215 "project/radare2/libr/util/big_ssl.c"
     void r_big_inc(RNumBig *a) {
 BN_add_word (a, 1);
}


# 219 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 219 "project/radare2/libr/util/big_ssl.c"
     void r_big_dec(RNumBig *a) {
 BN_sub_word (a, 1);
}


# 223 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 223 "project/radare2/libr/util/big_ssl.c"
...
# 229 "project/radare2/libr/util/big_ssl.c" 3 4
__attribute__((visibility("default"))) 
# 229 "project/radare2/libr/util/big_ssl.c"
