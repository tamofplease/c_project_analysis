# 0 "project/radare2/libr/util/queue.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/queue.c"
...
# 4 "project/radare2/libr/util/queue.c" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/util/queue.c"
     RQueue *r_queue_new (int n) {
 if (n <= 0) {
  return 
# 7 "project/radare2/libr/util/queue.c" 3 4
        ((void *)0)
# 7 "project/radare2/libr/util/queue.c"
            ;
 }
 RQueue *q = 
# 9 "project/radare2/libr/util/queue.c" 3 4
            (
# 9 "project/radare2/libr/util/queue.c"
            RQueue
# 9 "project/radare2/libr/util/queue.c" 3 4
            *)calloc(1,sizeof(
# 9 "project/radare2/libr/util/queue.c"
...
# 9 "project/radare2/libr/util/queue.c"
 ...
 if (!q) {
  return 
# 11 "project/radare2/libr/util/queue.c" 3 4
        ((void *)0)
# 11 "project/radare2/libr/util/queue.c"
            ;
 }
 q->elems = 
# 13 "project/radare2/libr/util/queue.c" 3 4
           (
# 13 "project/radare2/libr/util/queue.c"
           void *
# 13 "project/radare2/libr/util/queue.c" 3 4
           *)calloc(
# 13 "project/radare2/libr/util/queue.c"
...
# 13 "project/radare2/libr/util/queue.c"
 ...
 if (!q->elems){
  free (q);
  return 
# 16 "project/radare2/libr/util/queue.c" 3 4
        ((void *)0)
# 16 "project/radare2/libr/util/queue.c"
            ;
 }
 q->front = 0;
 q->rear = -1;
...
# 25 "project/radare2/libr/util/queue.c" 3 4
__attribute__((visibility("default"))) 
# 25 "project/radare2/libr/util/queue.c"
...
static int increase_capacity(RQueue *q) {
 ...
 newelems = 
# 39 "project/radare2/libr/util/queue.c" 3 4
           (
# 39 "project/radare2/libr/util/queue.c"
           void *
# 39 "project/radare2/libr/util/queue.c" 3 4
           *)calloc(
# 39 "project/radare2/libr/util/queue.c"
...
# 39 "project/radare2/libr/util/queue.c"
 ...
 if (!newelems) {
  return 
# 41 "project/radare2/libr/util/queue.c" 3 4
        0
# 41 "project/radare2/libr/util/queue.c"
             ;
 }
 ...
 return 
# 57 "project/radare2/libr/util/queue.c" 3 4
       1
# 57 "project/radare2/libr/util/queue.c"
           ;
}


# 60 "project/radare2/libr/util/queue.c" 3 4
__attribute__((visibility("default"))) 
# 60 "project/radare2/libr/util/queue.c"
     int r_queue_enqueue(RQueue *q, void *el) {
 if (is_full(q)) {
  int res = increase_capacity (q);
  if (!res) {
   return 
# 64 "project/radare2/libr/util/queue.c" 3 4
         0
# 64 "project/radare2/libr/util/queue.c"
              ;
  }
 }
 ...
 q->size++;
 return 
# 71 "project/radare2/libr/util/queue.c" 3 4
       1
# 71 "project/radare2/libr/util/queue.c"
           ;
}


# 74 "project/radare2/libr/util/queue.c" 3 4
__attribute__((visibility("default"))) 
# 74 "project/radare2/libr/util/queue.c"
     void *r_queue_dequeue(RQueue *q) {
 void *res;

 if (r_queue_is_empty (q)) {
  return 
# 78 "project/radare2/libr/util/queue.c" 3 4
        ((void *)0)
# 78 "project/radare2/libr/util/queue.c"
            ;
 }
 res = q->elems[q->front];
...
# 86 "project/radare2/libr/util/queue.c" 3 4
__attribute__((visibility("default"))) 
# 86 "project/radare2/libr/util/queue.c"
