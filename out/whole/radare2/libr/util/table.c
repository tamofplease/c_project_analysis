# 0 "project/radare2/libr/util/table.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/table.c"
...
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_table.h" 2 3 4
...
# 4 "project/radare2/libr/util/table.c" 2




# 7 "project/radare2/libr/util/table.c"
static int Gnth = 0;
static RListComparator Gcmp = 
# 8 "project/radare2/libr/util/table.c" 3 4
                             ((void *)0)
# 8 "project/radare2/libr/util/table.c"
                                 ;
...
static int sortNumber(const void *a, const void *b) {
 return r_num_get (
# 15 "project/radare2/libr/util/table.c" 3 4
                  ((void *)0)
# 15 "project/radare2/libr/util/table.c"
                      , a) - r_num_get (
# 15 "project/radare2/libr/util/table.c" 3 4
                                        ((void *)0)
# 15 "project/radare2/libr/util/table.c"
...
# 23 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 23 "project/radare2/libr/util/table.c"
     RTableColumnType *r_table_type (const char *name) {
 if (!strcmp (name, "bool")) {
 ...
 return 
# 36 "project/radare2/libr/util/table.c" 3 4
       ((void *)0)
# 36 "project/radare2/libr/util/table.c"
           ;
}
...
# 44 "project/radare2/libr/util/table.c" 3 4
if (
# 44 "project/radare2/libr/util/table.c"
t->cols
# 44 "project/radare2/libr/util/table.c" 3 4
) for (
# 44 "project/radare2/libr/util/table.c"
...
# 48 "project/radare2/libr/util/table.c" 3 4
if (
# 48 "project/radare2/libr/util/table.c"
t->rows
# 48 "project/radare2/libr/util/table.c" 3 4
) for (
# 48 "project/radare2/libr/util/table.c"
...
# 51 "project/radare2/libr/util/table.c" 3 4
 if (
# 51 "project/radare2/libr/util/table.c"
 row->items
# 51 "project/radare2/libr/util/table.c" 3 4
 ) for (
# 51 "project/radare2/libr/util/table.c"
...
# 51 "project/radare2/libr/util/table.c"
   ...
   if (c) {
    c->width = 
# 55 "project/radare2/libr/util/table.c" 3 4
              (((
# 55 "project/radare2/libr/util/table.c"
              c->width
# 55 "project/radare2/libr/util/table.c" 3 4
              )>(
# 55 "project/radare2/libr/util/table.c"
...
# 62 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 62 "project/radare2/libr/util/table.c"
     void r_table_row_free(void *_row) {
 RTableRow *row = _row;
...
# 68 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 68 "project/radare2/libr/util/table.c"
     void r_table_column_free(void *_col) {
...
# 74 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 74 "project/radare2/libr/util/table.c"
     RTableRow *r_table_row_clone(RTableRow *row) {
 RTableRow *r = r_table_row_new (r_list_newf (free));
 RListIter *iter;
 char *word;
 
# 78 "project/radare2/libr/util/table.c" 3 4
if (
# 78 "project/radare2/libr/util/table.c"
row->items
# 78 "project/radare2/libr/util/table.c" 3 4
) for (
# 78 "project/radare2/libr/util/table.c"
...
# 84 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 84 "project/radare2/libr/util/table.c"
     RTableColumn *r_table_column_clone(RTableColumn *col) {
 RTableColumn *c = 
# 85 "project/radare2/libr/util/table.c" 3 4
                  (
# 85 "project/radare2/libr/util/table.c"
                  RTableColumn
# 85 "project/radare2/libr/util/table.c" 3 4
                  *)calloc(1,sizeof(
# 85 "project/radare2/libr/util/table.c"
...
# 85 "project/radare2/libr/util/table.c"
 ...
 if (!c) {
  return 
# 87 "project/radare2/libr/util/table.c" 3 4
        ((void *)0)
# 87 "project/radare2/libr/util/table.c"
            ;
 }
 
# 89 "project/radare2/libr/util/table.c" 3 4
__builtin___memcpy_chk (
# 89 "project/radare2/libr/util/table.c"
c
# 89 "project/radare2/libr/util/table.c" 3 4
, 
# 89 "project/radare2/libr/util/table.c"
...
# 94 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 94 "project/radare2/libr/util/table.c"
     RTable *r_table_new(const char *name) {
 RTable *t = 
# 95 "project/radare2/libr/util/table.c" 3 4
            (
# 95 "project/radare2/libr/util/table.c"
            RTable
# 95 "project/radare2/libr/util/table.c" 3 4
            *)calloc(1,sizeof(
# 95 "project/radare2/libr/util/table.c"
...
# 95 "project/radare2/libr/util/table.c"
 ...
 if (t) {
  t->showHeader = 
# 97 "project/radare2/libr/util/table.c" 3 4
                 1
# 97 "project/radare2/libr/util/table.c"
                     ;
  t->name = strdup (name);
  t->cols = r_list_newf (r_table_column_free);
  t->rows = r_list_newf (r_table_row_free);
  t->showSum = 
# 101 "project/radare2/libr/util/table.c" 3 4
              0
# 101 "project/radare2/libr/util/table.c"
                   ;
 }
 return t;
}
...
# 106 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 106 "project/radare2/libr/util/table.c"
     void r_table_free(RTable *t) {
 if (!t) {
  return;
 }
 r_list_free (t->cols);
...
# 116 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 116 "project/radare2/libr/util/table.c"
     void r_table_add_column(RTable *t, RTableColumnType *type, const char *name, int maxWidth) {
 RTableColumn *c = 
# 117 "project/radare2/libr/util/table.c" 3 4
                  (
# 117 "project/radare2/libr/util/table.c"
                  RTableColumn
# 117 "project/radare2/libr/util/table.c" 3 4
                  *)calloc(1,sizeof(
# 117 "project/radare2/libr/util/table.c"
...
# 129 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 129 "project/radare2/libr/util/table.c"
     RTableRow *r_table_row_new(RList *items) {
 RTableRow *row = 
# 130 "project/radare2/libr/util/table.c" 3 4
                 (
# 130 "project/radare2/libr/util/table.c"
                 RTableRow
# 130 "project/radare2/libr/util/table.c" 3 4
                 *)malloc(sizeof(
# 130 "project/radare2/libr/util/table.c"
...
static 
# 135 "project/radare2/libr/util/table.c" 3 4
      _Bool 
# 135 "project/radare2/libr/util/table.c"
           __addRow(RTable *t, RList *items, const char *arg, int col) {
 int itemLength = r_str_len_utf8_ansi (arg) + 1;
 RTableColumn *c = r_list_get_n (t->cols, col);
 if (c) {
  c->width = 
# 139 "project/radare2/libr/util/table.c" 3 4
            (((
# 139 "project/radare2/libr/util/table.c"
            c->width
# 139 "project/radare2/libr/util/table.c" 3 4
            )>(
# 139 "project/radare2/libr/util/table.c"
...
# 139 "project/radare2/libr/util/table.c"
  ...
  return 
# 141 "project/radare2/libr/util/table.c" 3 4
        1
# 141 "project/radare2/libr/util/table.c"
            ;
 }
 return 
# 143 "project/radare2/libr/util/table.c" 3 4
       0
# 143 "project/radare2/libr/util/table.c"
            ;
}


# 146 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 146 "project/radare2/libr/util/table.c"
     void r_table_add_row_list(RTable *t, RList *items) {
 
# 147 "project/radare2/libr/util/table.c" 3 4
do { if (!(
# 147 "project/radare2/libr/util/table.c"
t && items
# 147 "project/radare2/libr/util/table.c" 3 4
...
# 147 "project/radare2/libr/util/table.c"
 ...
 t->totalCols = 
# 151 "project/radare2/libr/util/table.c" 3 4
               (((
# 151 "project/radare2/libr/util/table.c"
               t->totalCols
# 151 "project/radare2/libr/util/table.c" 3 4
               )>(
# 151 "project/radare2/libr/util/table.c"
...
# 154 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 154 "project/radare2/libr/util/table.c"
     void r_table_set_columnsf(RTable *t, const char *fmt, ...) {
 va_list ap;
 
# 156 "project/radare2/libr/util/table.c" 3 4
__builtin_va_start(
# 156 "project/radare2/libr/util/table.c"
ap
# 156 "project/radare2/libr/util/table.c" 3 4
,
# 156 "project/radare2/libr/util/table.c"
...
# 156 "project/radare2/libr/util/table.c"
 ...
 for (;*f;f++) {
  name = 
# 163 "project/radare2/libr/util/table.c" 3 4
        __builtin_va_arg(
# 163 "project/radare2/libr/util/table.c"
        ap
# 163 "project/radare2/libr/util/table.c" 3 4
        ,
# 163 "project/radare2/libr/util/table.c"
...
# 183 "project/radare2/libr/util/table.c" 3 4
  fprintf(__stderrp,
# 183 "project/radare2/libr/util/table.c"
...
# 187 "project/radare2/libr/util/table.c" 3 4
__builtin_va_end(
# 187 "project/radare2/libr/util/table.c"
ap
# 187 "project/radare2/libr/util/table.c" 3 4
)
# 187 "project/radare2/libr/util/table.c"
...
# 190 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 190 "project/radare2/libr/util/table.c"
     void r_table_add_rowf(RTable *t, const char *fmt, ...) {
 va_list ap;
 
# 192 "project/radare2/libr/util/table.c" 3 4
__builtin_va_start(
# 192 "project/radare2/libr/util/table.c"
ap
# 192 "project/radare2/libr/util/table.c" 3 4
,
# 192 "project/radare2/libr/util/table.c"
...
# 192 "project/radare2/libr/util/table.c"
 ...
 const char *f = fmt;
 const char *arg = 
# 195 "project/radare2/libr/util/table.c" 3 4
                  ((void *)0)
# 195 "project/radare2/libr/util/table.c"
                      ;
 for (; *f; f++) {
  switch (*f) {
  case 's':
  case 'z':
   arg = 
# 200 "project/radare2/libr/util/table.c" 3 4
        __builtin_va_arg(
# 200 "project/radare2/libr/util/table.c"
        ap
# 200 "project/radare2/libr/util/table.c" 3 4
        ,
# 200 "project/radare2/libr/util/table.c"
...
# 200 "project/radare2/libr/util/table.c"
   ...
   break;
  case 'b':
   r_list_append (list, r_str_new (r_str_bool (
# 204 "project/radare2/libr/util/table.c" 3 4
                                              __builtin_va_arg(
# 204 "project/radare2/libr/util/table.c"
                                              ap
# 204 "project/radare2/libr/util/table.c" 3 4
                                              ,
# 204 "project/radare2/libr/util/table.c"
...
# 204 "project/radare2/libr/util/table.c"
  ...
  case 'i':
  case 'd':
   r_list_append (list, r_str_newf ("%d", 
# 208 "project/radare2/libr/util/table.c" 3 4
                                         __builtin_va_arg(
# 208 "project/radare2/libr/util/table.c"
                                         ap
# 208 "project/radare2/libr/util/table.c" 3 4
                                         ,
# 208 "project/radare2/libr/util/table.c"
...
# 208 "project/radare2/libr/util/table.c"
   ...
   break;
  case 'n':
   r_list_append (list, r_str_newf ("%"
# 211 "project/radare2/libr/util/table.c" 3 4
                                      "lld"
# 211 "project/radare2/libr/util/table.c"
                                             , 
# 211 "project/radare2/libr/util/table.c" 3 4
                                               __builtin_va_arg(
# 211 "project/radare2/libr/util/table.c"
...
# 211 "project/radare2/libr/util/table.c"
   ...
   break;
  case 'u':
   r_list_append (list, r_num_units (
# 214 "project/radare2/libr/util/table.c" 3 4
                                    ((void *)0)
# 214 "project/radare2/libr/util/table.c"
                                        , 32, 
# 214 "project/radare2/libr/util/table.c" 3 4
                                              __builtin_va_arg(
# 214 "project/radare2/libr/util/table.c"
...
# 219 "project/radare2/libr/util/table.c" 3 4
   unsigned long long 
# 219 "project/radare2/libr/util/table.c"
        n = 
# 219 "project/radare2/libr/util/table.c" 3 4
            __builtin_va_arg(
# 219 "project/radare2/libr/util/table.c"
...
# 219 "project/radare2/libr/util/table.c"
                             ;
    if (n == 
# 220 "project/radare2/libr/util/table.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 220 "project/radare2/libr/util/table.c"
                    ) {
     if (*f == 'X') {
     ...
     if (*f == 'X') {
      r_list_append (list, r_str_newf ("0x%08"
# 228 "project/radare2/libr/util/table.c" 3 4
                                             "llx"
# 228 "project/radare2/libr/util/table.c"
                                                    , n));
     } else {
      r_list_append (list, r_str_newf ("0x%"
# 230 "project/radare2/libr/util/table.c" 3 4
                                           "llx"
# 230 "project/radare2/libr/util/table.c"
                                                  , n));
     }
    }
   }
...
# 236 "project/radare2/libr/util/table.c" 3 4
  fprintf(__stderrp,
# 236 "project/radare2/libr/util/table.c"
  "Invalid format string char '%c', use 's' or 'n'\n", *f
# 236 "project/radare2/libr/util/table.c" 3 4
  )
# 236 "project/radare2/libr/util/table.c"
...
# 240 "project/radare2/libr/util/table.c" 3 4
__builtin_va_end(
# 240 "project/radare2/libr/util/table.c"
ap
# 240 "project/radare2/libr/util/table.c" 3 4
)
# 240 "project/radare2/libr/util/table.c"
...
# 244 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 244 "project/radare2/libr/util/table.c"
     void r_table_add_row(RTable *t, const char *name, ...) {
 va_list ap;
 
# 246 "project/radare2/libr/util/table.c" 3 4
__builtin_va_start(
# 246 "project/radare2/libr/util/table.c"
ap
# 246 "project/radare2/libr/util/table.c" 3 4
,
# 246 "project/radare2/libr/util/table.c"
...
# 246 "project/radare2/libr/util/table.c"
 ...
 for (;;) {
  const char *arg = 
# 251 "project/radare2/libr/util/table.c" 3 4
                   __builtin_va_arg(
# 251 "project/radare2/libr/util/table.c"
                   ap
# 251 "project/radare2/libr/util/table.c" 3 4
                   ,
# 251 "project/radare2/libr/util/table.c"
...
# 259 "project/radare2/libr/util/table.c" 3 4
__builtin_va_end(
# 259 "project/radare2/libr/util/table.c"
ap
# 259 "project/radare2/libr/util/table.c" 3 4
)
# 259 "project/radare2/libr/util/table.c"
 ...
 t->totalCols = 
# 263 "project/radare2/libr/util/table.c" 3 4
               (((
# 263 "project/radare2/libr/util/table.c"
               t->totalCols
# 263 "project/radare2/libr/util/table.c" 3 4
               )>(
# 263 "project/radare2/libr/util/table.c"
...
static int __strbuf_append_col_aligned_fancy(RTable *t, RStrBuf *sb, RTableColumn *col, char *str) {
 ...
 const char *v_line = (cons && (cons->use_utf8 || cons->use_utf8_curvy)) ? 
# 270 "project/radare2/libr/util/table.c" 3 4
                                                                           "│" 
# 270 "project/radare2/libr/util/table.c"
                                                                                          : "|";
...
# 295 "project/radare2/libr/util/table.c" 3 4
if (
# 295 "project/radare2/libr/util/table.c"
t->rows
# 295 "project/radare2/libr/util/table.c" 3 4
) for (
# 295 "project/radare2/libr/util/table.c"
...
# 298 "project/radare2/libr/util/table.c" 3 4
 if (
# 298 "project/radare2/libr/util/table.c"
 row->items
# 298 "project/radare2/libr/util/table.c" 3 4
 ) for (
# 298 "project/radare2/libr/util/table.c"
...
# 311 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 311 "project/radare2/libr/util/table.c"
     char *r_table_tofancystring(RTable *t) {
...
# 320 "project/radare2/libr/util/table.c" 3 4
_Bool 
# 320 "project/radare2/libr/util/table.c"
     useUtf8 = (cons && cons->use_utf8);
 
# 321 "project/radare2/libr/util/table.c" 3 4
_Bool 
# 321 "project/radare2/libr/util/table.c"
     useUtf8Curvy = (cons && cons->use_utf8_curvy);
 const char *v_line = useUtf8 || useUtf8Curvy ? 
# 322 "project/radare2/libr/util/table.c" 3 4
                                               "│" 
# 322 "project/radare2/libr/util/table.c"
                                                              : "|";
 const char *h_line = useUtf8 || useUtf8Curvy ? 
# 323 "project/radare2/libr/util/table.c" 3 4
                                               "─" 
# 323 "project/radare2/libr/util/table.c"
                                                               : "-";
 const char *l_intersect = useUtf8 || useUtf8Curvy ? 
# 324 "project/radare2/libr/util/table.c" 3 4
                                                    "│" 
# 324 "project/radare2/libr/util/table.c"
                                                                   : ")";
 const char *r_intersect = useUtf8 || useUtf8Curvy ? 
# 325 "project/radare2/libr/util/table.c" 3 4
                                                    "│" 
# 325 "project/radare2/libr/util/table.c"
                                                                   : "(";
 const char *tl_corner = useUtf8 ? (useUtf8Curvy ? 
# 326 "project/radare2/libr/util/table.c" 3 4
                                                  "╭" 
# 326 "project/radare2/libr/util/table.c"
                                                                       : 
# 326 "project/radare2/libr/util/table.c" 3 4
                                                                         "┌"
# 326 "project/radare2/libr/util/table.c"
                                                                                       ) : ".";
 const char *tr_corner = useUtf8 ? (useUtf8Curvy ? 
# 327 "project/radare2/libr/util/table.c" 3 4
                                                  "╮" 
# 327 "project/radare2/libr/util/table.c"
                                                                       : 
# 327 "project/radare2/libr/util/table.c" 3 4
                                                                         "┐"
# 327 "project/radare2/libr/util/table.c"
                                                                                       ) : ".";
 const char *bl_corner = useUtf8 ? (useUtf8Curvy ? 
# 328 "project/radare2/libr/util/table.c" 3 4
                                                  "╰" 
# 328 "project/radare2/libr/util/table.c"
                                                                       : 
# 328 "project/radare2/libr/util/table.c" 3 4
                                                                         "└"
# 328 "project/radare2/libr/util/table.c"
                                                                                       ) : "`";
 const char *br_corner = useUtf8 ? (useUtf8Curvy ? 
# 329 "project/radare2/libr/util/table.c" 3 4
                                                  "╯" 
# 329 "project/radare2/libr/util/table.c"
                                                                       : 
# 329 "project/radare2/libr/util/table.c" 3 4
                                                                         "┘"
# 329 "project/radare2/libr/util/table.c"
...
# 332 "project/radare2/libr/util/table.c" 3 4
if (
# 332 "project/radare2/libr/util/table.c"
t->cols
# 332 "project/radare2/libr/util/table.c" 3 4
) for (
# 332 "project/radare2/libr/util/table.c"
...
# 345 "project/radare2/libr/util/table.c" 3 4
if (
# 345 "project/radare2/libr/util/table.c"
t->rows
# 345 "project/radare2/libr/util/table.c" 3 4
) for (
# 345 "project/radare2/libr/util/table.c"
...
# 348 "project/radare2/libr/util/table.c" 3 4
 if (
# 348 "project/radare2/libr/util/table.c"
 row->items
# 348 "project/radare2/libr/util/table.c" 3 4
 ) for (
# 348 "project/radare2/libr/util/table.c"
...
# 348 "project/radare2/libr/util/table.c"
   ...
   if (col) {
    ...
    len = 
# 352 "project/radare2/libr/util/table.c" 3 4
         (((
# 352 "project/radare2/libr/util/table.c"
         len
# 352 "project/radare2/libr/util/table.c" 3 4
         )>(
# 352 "project/radare2/libr/util/table.c"
...
# 363 "project/radare2/libr/util/table.c" 3 4
 if (
# 363 "project/radare2/libr/util/table.c"
 t->cols
# 363 "project/radare2/libr/util/table.c" 3 4
 ) for (
# 363 "project/radare2/libr/util/table.c"
...
# 363 "project/radare2/libr/util/table.c"
   ...
   len = 
# 366 "project/radare2/libr/util/table.c" 3 4
        (((
# 366 "project/radare2/libr/util/table.c"
        len
# 366 "project/radare2/libr/util/table.c" 3 4
        )>(
# 366 "project/radare2/libr/util/table.c"
...
static int __strbuf_append_col_aligned(RStrBuf *sb, RTableColumn *col, const char *str, 
# 375 "project/radare2/libr/util/table.c" 3 4
                                                                                       _Bool 
# 375 "project/radare2/libr/util/table.c"
                                                                                            nopad) {
 int ll = r_strbuf_length (sb);
 if (nopad) {
...
# 408 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 408 "project/radare2/libr/util/table.c"
     char *r_table_tostring(RTable *t) {
 if (!t) {
  return strdup ("");
 }
 if (t->showR2) {
...
# 433 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 433 "project/radare2/libr/util/table.c"
     char *r_table_tosimplestring(RTable *t) {
 RStrBuf *sb = r_strbuf_new ("");
 RTableRow *row;
 RTableColumn *col;
 RListIter *iter, *iter2;
 RCons *cons = (RCons *) t->cons;
 const char *h_line = (cons && (cons->use_utf8 || cons->use_utf8_curvy)) ? 
# 439 "project/radare2/libr/util/table.c" 3 4
                                                                          "―" 
# 439 "project/radare2/libr/util/table.c"
                                                                                               : "-";
 __table_adjust (t);
 int maxlen = 0;
 if (t->showHeader) {
  
# 443 "project/radare2/libr/util/table.c" 3 4
 if (
# 443 "project/radare2/libr/util/table.c"
 t->cols
# 443 "project/radare2/libr/util/table.c" 3 4
 ) for (
# 443 "project/radare2/libr/util/table.c"
...
# 444 "project/radare2/libr/util/table.c" 3 4
  _Bool 
# 444 "project/radare2/libr/util/table.c"
       nopad = !iter->n;
   int ll = __strbuf_append_col_aligned (sb, col, col->name, nopad);
   maxlen = 
# 446 "project/radare2/libr/util/table.c" 3 4
           (((
# 446 "project/radare2/libr/util/table.c"
           maxlen
# 446 "project/radare2/libr/util/table.c" 3 4
           )>(
# 446 "project/radare2/libr/util/table.c"
...
# 446 "project/radare2/libr/util/table.c"
  ...
  char *l = r_str_repeat (h_line, 
# 449 "project/radare2/libr/util/table.c" 3 4
                                 (((
# 449 "project/radare2/libr/util/table.c"
                                 maxlen
# 449 "project/radare2/libr/util/table.c" 3 4
                                 )>(
# 449 "project/radare2/libr/util/table.c"
...
# 455 "project/radare2/libr/util/table.c" 3 4
if (
# 455 "project/radare2/libr/util/table.c"
t->rows
# 455 "project/radare2/libr/util/table.c" 3 4
) for (
# 455 "project/radare2/libr/util/table.c"
...
# 458 "project/radare2/libr/util/table.c" 3 4
 if (
# 458 "project/radare2/libr/util/table.c"
 row->items
# 458 "project/radare2/libr/util/table.c" 3 4
 ) for (
# 458 "project/radare2/libr/util/table.c"
...
# 459 "project/radare2/libr/util/table.c" 3 4
  _Bool 
# 459 "project/radare2/libr/util/table.c"
       nopad = !iter2->n;
   RTableColumn *col = r_list_get_n (t->cols, c);
   if (col) {
...
# 478 "project/radare2/libr/util/table.c" 3 4
 if (
# 478 "project/radare2/libr/util/table.c"
 t->cols
# 478 "project/radare2/libr/util/table.c" 3 4
 ) for (
# 478 "project/radare2/libr/util/table.c"
...
# 479 "project/radare2/libr/util/table.c" 3 4
  _Bool 
# 479 "project/radare2/libr/util/table.c"
       nopad = !iter->n;
...
# 486 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 486 "project/radare2/libr/util/table.c"
     char *r_table_tor2cmds(RTable *t) {
 RStrBuf *sb = r_strbuf_new ("");
 RTableRow *row;
 RTableColumn *col;
 RListIter *iter, *iter2;
...
# 493 "project/radare2/libr/util/table.c" 3 4
if (
# 493 "project/radare2/libr/util/table.c"
t->cols
# 493 "project/radare2/libr/util/table.c" 3 4
) for (
# 493 "project/radare2/libr/util/table.c"
...
# 497 "project/radare2/libr/util/table.c" 3 4
if (
# 497 "project/radare2/libr/util/table.c"
t->cols
# 497 "project/radare2/libr/util/table.c" 3 4
) for (
# 497 "project/radare2/libr/util/table.c"
...
# 502 "project/radare2/libr/util/table.c" 3 4
if (
# 502 "project/radare2/libr/util/table.c"
t->rows
# 502 "project/radare2/libr/util/table.c" 3 4
) for (
# 502 "project/radare2/libr/util/table.c"
...
# 506 "project/radare2/libr/util/table.c" 3 4
 if (
# 506 "project/radare2/libr/util/table.c"
 row->items
# 506 "project/radare2/libr/util/table.c" 3 4
 ) for (
# 506 "project/radare2/libr/util/table.c"
...
# 518 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 518 "project/radare2/libr/util/table.c"
     char *r_table_tosql(RTable *t) {
 
# 519 "project/radare2/libr/util/table.c" 3 4
do { if (!(
# 519 "project/radare2/libr/util/table.c"
t
# 519 "project/radare2/libr/util/table.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 519 "project/radare2/libr/util/table.c"
...
# 525 "project/radare2/libr/util/table.c" 3 4
                         (!(
# 525 "project/radare2/libr/util/table.c"
                         t->name
# 525 "project/radare2/libr/util/table.c" 3 4
                         ) || !*(
# 525 "project/radare2/libr/util/table.c"
...
# 527 "project/radare2/libr/util/table.c" 3 4
_Bool 
# 527 "project/radare2/libr/util/table.c"
     primary_key = 
# 527 "project/radare2/libr/util/table.c" 3 4
                   1
# 527 "project/radare2/libr/util/table.c"
...
# 528 "project/radare2/libr/util/table.c" 3 4
if (
# 528 "project/radare2/libr/util/table.c"
t->cols
# 528 "project/radare2/libr/util/table.c" 3 4
) for (
# 528 "project/radare2/libr/util/table.c"
...
# 528 "project/radare2/libr/util/table.c"
  ...
  free (s);
  primary_key = 
# 535 "project/radare2/libr/util/table.c" 3 4
               0
# 535 "project/radare2/libr/util/table.c"
                    ;
 }
 r_strbuf_appendf (sb, ");\n");

 
# 539 "project/radare2/libr/util/table.c" 3 4
if (
# 539 "project/radare2/libr/util/table.c"
t->rows
# 539 "project/radare2/libr/util/table.c" 3 4
) for (
# 539 "project/radare2/libr/util/table.c"
...
# 543 "project/radare2/libr/util/table.c" 3 4
 if (
# 543 "project/radare2/libr/util/table.c"
 t->cols
# 543 "project/radare2/libr/util/table.c" 3 4
 ) for (
# 543 "project/radare2/libr/util/table.c"
...
# 550 "project/radare2/libr/util/table.c" 3 4
 if (
# 550 "project/radare2/libr/util/table.c"
 row->items
# 550 "project/radare2/libr/util/table.c" 3 4
 ) for (
# 550 "project/radare2/libr/util/table.c"
...
# 569 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 569 "project/radare2/libr/util/table.c"
     char *r_table_tocsv(RTable *t) {
 RStrBuf *sb = r_strbuf_new ("");
 RTableRow *row;
 RTableColumn *col;
 RListIter *iter, *iter2;
...
# 576 "project/radare2/libr/util/table.c" 3 4
 if (
# 576 "project/radare2/libr/util/table.c"
 t->cols
# 576 "project/radare2/libr/util/table.c" 3 4
 ) for (
# 576 "project/radare2/libr/util/table.c"
...
# 587 "project/radare2/libr/util/table.c" 3 4
if (
# 587 "project/radare2/libr/util/table.c"
t->rows
# 587 "project/radare2/libr/util/table.c" 3 4
) for (
# 587 "project/radare2/libr/util/table.c"
...
# 591 "project/radare2/libr/util/table.c" 3 4
 if (
# 591 "project/radare2/libr/util/table.c"
 row->items
# 591 "project/radare2/libr/util/table.c" 3 4
 ) for (
# 591 "project/radare2/libr/util/table.c"
...
# 608 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 608 "project/radare2/libr/util/table.c"
     char *r_table_tojson(RTable *t) {
 PJ *pj = pj_new ();
 RTableRow *row;
 RListIter *iter, *iter2;
 pj_a (pj);
 
# 613 "project/radare2/libr/util/table.c" 3 4
if (
# 613 "project/radare2/libr/util/table.c"
t->rows
# 613 "project/radare2/libr/util/table.c" 3 4
) for (
# 613 "project/radare2/libr/util/table.c"
...
# 617 "project/radare2/libr/util/table.c" 3 4
 if (
# 617 "project/radare2/libr/util/table.c"
 row->items
# 617 "project/radare2/libr/util/table.c" 3 4
 ) for (
# 617 "project/radare2/libr/util/table.c"
...
# 621 "project/radare2/libr/util/table.c" 3 4
    unsigned long long 
# 621 "project/radare2/libr/util/table.c"
         n = r_num_get (
# 621 "project/radare2/libr/util/table.c" 3 4
                        ((void *)0)
# 621 "project/radare2/libr/util/table.c"
...
# 641 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 641 "project/radare2/libr/util/table.c"
     void r_table_filter(RTable *t, int nth, int op, const char *un) {
 
# 642 "project/radare2/libr/util/table.c" 3 4
do { if (!(
# 642 "project/radare2/libr/util/table.c"
t && un
# 642 "project/radare2/libr/util/table.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 642 "project/radare2/libr/util/table.c"
...
# 645 "project/radare2/libr/util/table.c" 3 4
unsigned long long 
# 645 "project/radare2/libr/util/table.c"
     uv = r_num_math (
# 645 "project/radare2/libr/util/table.c" 3 4
                      ((void *)0)
# 645 "project/radare2/libr/util/table.c"
...
# 646 "project/radare2/libr/util/table.c" 3 4
unsigned long long 
# 646 "project/radare2/libr/util/table.c"
     sum = 0;
...
# 666 "project/radare2/libr/util/table.c" 3 4
if (
# 666 "project/radare2/libr/util/table.c"
t->rows
# 666 "project/radare2/libr/util/table.c" 3 4
) for (
# 666 "project/radare2/libr/util/table.c"
...
# 668 "project/radare2/libr/util/table.c" 3 4
 unsigned long long 
# 668 "project/radare2/libr/util/table.c"
      nv = r_num_math (
# 668 "project/radare2/libr/util/table.c" 3 4
                       ((void *)0)
# 668 "project/radare2/libr/util/table.c"
...
# 669 "project/radare2/libr/util/table.c" 3 4
 _Bool 
# 669 "project/radare2/libr/util/table.c"
      match = 
# 669 "project/radare2/libr/util/table.c" 3 4
              1
# 669 "project/radare2/libr/util/table.c"
  ...
  case 'p':
   ...
   if (nrow < lrow) {
    match = 
# 674 "project/radare2/libr/util/table.c" 3 4
           0
# 674 "project/radare2/libr/util/table.c"
                ;
   }
   if (nrow > uv) {
    match = 
# 677 "project/radare2/libr/util/table.c" 3 4
           0
# 677 "project/radare2/libr/util/table.c"
                ;
   }
   break;
  case 't':
   ...
   if (nrow < uv) {
    match = 
# 683 "project/radare2/libr/util/table.c" 3 4
           0
# 683 "project/radare2/libr/util/table.c"
                ;
   }
   break;
  case 'S':
  ...
  case 'h':
   ...
   if (nrow > uv) {
    match = 
# 693 "project/radare2/libr/util/table.c" 3 4
           0
# 693 "project/radare2/libr/util/table.c"
                ;
   }
   break;
  case '+':
   ...
   sum += nv;
   match = 
# 699 "project/radare2/libr/util/table.c" 3 4
          0
# 699 "project/radare2/libr/util/table.c"
               ;
   break;
  case '>':
   match = (nv > uv);
  ...
  case '$':
   match = strstr (nn, un) == 
# 722 "project/radare2/libr/util/table.c" 3 4
                             ((void *)0)
# 722 "project/radare2/libr/util/table.c"
                                 ;
   break;
  case '~':
   match = strstr (nn, un) != 
# 725 "project/radare2/libr/util/table.c" 3 4
                             ((void *)0)
# 725 "project/radare2/libr/util/table.c"
                                 ;
   break;
  case 's':
...
# 757 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 757 "project/radare2/libr/util/table.c"
     void r_table_sort(RTable *t, int nth, 
# 757 "project/radare2/libr/util/table.c" 3 4
                                           _Bool 
# 757 "project/radare2/libr/util/table.c"
                                                dec) {
 ...
 if (col) {
  ...
  if (col->type && col->type->cmp) {
   Gcmp = col->type->cmp;
   t->rows->sorted = 
# 763 "project/radare2/libr/util/table.c" 3 4
                    0
# 763 "project/radare2/libr/util/table.c"
                         ;
  ...
  Gnth = 0;
  Gcmp = 
# 770 "project/radare2/libr/util/table.c" 3 4
        ((void *)0)
# 770 "project/radare2/libr/util/table.c"
            ;
 }
}
...
# 783 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 783 "project/radare2/libr/util/table.c"
     void r_table_sortlen(RTable *t, int nth, 
# 783 "project/radare2/libr/util/table.c" 3 4
                                              _Bool 
# 783 "project/radare2/libr/util/table.c"
                                                   dec) {
 ...
 if (col) {
  Gnth = nth;
  t->rows->sorted = 
# 787 "project/radare2/libr/util/table.c" 3 4
                   0
# 787 "project/radare2/libr/util/table.c"
                        ;
...
# 837 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 837 "project/radare2/libr/util/table.c"
     void r_table_uniq(RTable *t) {
 r_table_group (t, -1, 
# 838 "project/radare2/libr/util/table.c" 3 4
                      ((void *)0)
# 838 "project/radare2/libr/util/table.c"
                          );
}


# 841 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 841 "project/radare2/libr/util/table.c"
     void r_table_group(RTable *t, int nth, RTableSelector fcn) {
 RListIter *iter;
 RListIter *tmp;
 RTableRow *row;
...
# 851 "project/radare2/libr/util/table.c" 3 4
if (
# 851 "project/radare2/libr/util/table.c"
rows
# 851 "project/radare2/libr/util/table.c" 3 4
) for (
# 851 "project/radare2/libr/util/table.c"
...
# 869 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 869 "project/radare2/libr/util/table.c"
     int r_table_column_nth(RTable *t, const char *name) {
 RListIter *iter;
 RTableColumn *col;
 int n = 0;
 
# 873 "project/radare2/libr/util/table.c" 3 4
if (
# 873 "project/radare2/libr/util/table.c"
t->cols
# 873 "project/radare2/libr/util/table.c" 3 4
) for (
# 873 "project/radare2/libr/util/table.c"
...
# 903 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 903 "project/radare2/libr/util/table.c"
     void r_table_columns(RTable *t, RList *col_names) {

 
# 905 "project/radare2/libr/util/table.c" 3 4
_Bool 
# 905 "project/radare2/libr/util/table.c"
     *free_cols = malloc (sizeof (
# 905 "project/radare2/libr/util/table.c" 3 4
                                  _Bool
# 905 "project/radare2/libr/util/table.c"
                                      ) * r_list_length (t->cols));
 if (!free_cols) {
  return;
 }
 size_t i;
 for (i = 0; i < r_list_length (t->cols); i++) {
  free_cols[i] = 
# 911 "project/radare2/libr/util/table.c" 3 4
                1
# 911 "project/radare2/libr/util/table.c"
                    ;
 }
...
# 917 "project/radare2/libr/util/table.c" 3 4
 _Bool 
# 917 "project/radare2/libr/util/table.c"
      dup;
...
# 928 "project/radare2/libr/util/table.c" 3 4
if (
# 928 "project/radare2/libr/util/table.c"
col_names
# 928 "project/radare2/libr/util/table.c" 3 4
) for (
# 928 "project/radare2/libr/util/table.c"
...
# 928 "project/radare2/libr/util/table.c"
  ...
  free_cols[fc] = 
# 935 "project/radare2/libr/util/table.c" 3 4
                 0
# 935 "project/radare2/libr/util/table.c"
                      ;
  new_count++;
 }
...
# 940 "project/radare2/libr/util/table.c" 3 4
if (
# 940 "project/radare2/libr/util/table.c"
t->rows
# 940 "project/radare2/libr/util/table.c" 3 4
) for (
# 940 "project/radare2/libr/util/table.c"
...
# 959 "project/radare2/libr/util/table.c" 3 4
 if (
# 959 "project/radare2/libr/util/table.c"
 old_items
# 959 "project/radare2/libr/util/table.c" 3 4
 ) for (
# 959 "project/radare2/libr/util/table.c"
...
# 959 "project/radare2/libr/util/table.c"
  ...
  old_items->free = 
# 965 "project/radare2/libr/util/table.c" 3 4
                   ((void *)0)
# 965 "project/radare2/libr/util/table.c"
                       ;
...
# 986 "project/radare2/libr/util/table.c" 3 4
if (
# 986 "project/radare2/libr/util/table.c"
old_cols
# 986 "project/radare2/libr/util/table.c" 3 4
) for (
# 986 "project/radare2/libr/util/table.c"
...
# 986 "project/radare2/libr/util/table.c"
 ...
 old_cols->free = 
# 992 "project/radare2/libr/util/table.c" 3 4
                 ((void *)0)
# 992 "project/radare2/libr/util/table.c"
                     ;
...
# 999 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 999 "project/radare2/libr/util/table.c"
     void r_table_filter_columns(RTable *t, RList *list) {
 const char *col;
 RListIter *iter;
 RList *cols = t->cols;
 t->cols = r_list_newf (__table_column_free);
 
# 1004 "project/radare2/libr/util/table.c" 3 4
if (
# 1004 "project/radare2/libr/util/table.c"
list
# 1004 "project/radare2/libr/util/table.c" 3 4
) for (
# 1004 "project/radare2/libr/util/table.c"
...
# 1015 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 1015 "project/radare2/libr/util/table.c"
     const char *r_table_help(void) {
 return
...
static 
# 1045 "project/radare2/libr/util/table.c" 3 4
      _Bool 
# 1045 "project/radare2/libr/util/table.c"
           __table_special(RTable *t, const char *columnName) {
 if (*columnName != ':') {
  return 
# 1047 "project/radare2/libr/util/table.c" 3 4
        0
# 1047 "project/radare2/libr/util/table.c"
             ;
 }
 if (!strcmp (columnName, ":quiet")) {
  t->showHeader = 
# 1050 "project/radare2/libr/util/table.c" 3 4
                 1
# 1050 "project/radare2/libr/util/table.c"
                     ;
 } else if (!strcmp (columnName, ":fancy")) {
  t->showFancy = 
# 1052 "project/radare2/libr/util/table.c" 3 4
                1
# 1052 "project/radare2/libr/util/table.c"
                    ;
 } else if (!strcmp (columnName, ":sql")) {
  t->showSQL = 
# 1054 "project/radare2/libr/util/table.c" 3 4
              1
# 1054 "project/radare2/libr/util/table.c"
                  ;
 } else if (!strcmp (columnName, ":simple")) {
  t->showFancy = 
# 1056 "project/radare2/libr/util/table.c" 3 4
                0
# 1056 "project/radare2/libr/util/table.c"
                     ;
 } else if (!strcmp (columnName, ":r2")) {
  t->showR2 = 
# 1058 "project/radare2/libr/util/table.c" 3 4
             1
# 1058 "project/radare2/libr/util/table.c"
                 ;
 } else if (!strcmp (columnName, ":csv")) {
  t->showCSV = 
# 1060 "project/radare2/libr/util/table.c" 3 4
              1
# 1060 "project/radare2/libr/util/table.c"
                  ;
 } else if (!strcmp (columnName, ":json")) {
  t->showJSON = 
# 1062 "project/radare2/libr/util/table.c" 3 4
               1
# 1062 "project/radare2/libr/util/table.c"
                   ;
 } else {
  return 
# 1064 "project/radare2/libr/util/table.c" 3 4
        0
# 1064 "project/radare2/libr/util/table.c"
             ;
 }
 return 
# 1066 "project/radare2/libr/util/table.c" 3 4
       1
# 1066 "project/radare2/libr/util/table.c"
           ;
}


# 1069 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 1069 "project/radare2/libr/util/table.c"
          r_table_query(RTable *t, const char *q) {
 
# 1070 "project/radare2/libr/util/table.c" 3 4
do { if (!(
# 1070 "project/radare2/libr/util/table.c"
t
# 1070 "project/radare2/libr/util/table.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1070 "project/radare2/libr/util/table.c"
...
# 1070 "project/radare2/libr/util/table.c"
 ...
 if (!q || !*q) {
  __table_adjust (t);
  return 
# 1077 "project/radare2/libr/util/table.c" 3 4
        1
# 1077 "project/radare2/libr/util/table.c"
            ;
 }
 if (*q == '?') {
  const char *th = r_table_help ();
  
# 1081 "project/radare2/libr/util/table.c" 3 4
 fprintf(__stderrp,
# 1081 "project/radare2/libr/util/table.c"
 "%s\n", th
# 1081 "project/radare2/libr/util/table.c" 3 4
 )
# 1081 "project/radare2/libr/util/table.c"
                     ;
  return 
# 1082 "project/radare2/libr/util/table.c" 3 4
        0
# 1082 "project/radare2/libr/util/table.c"
             ;
 }
...
# 1089 "project/radare2/libr/util/table.c" 3 4
if (
# 1089 "project/radare2/libr/util/table.c"
queries
# 1089 "project/radare2/libr/util/table.c" 3 4
) for (
# 1089 "project/radare2/libr/util/table.c"
...
# 1089 "project/radare2/libr/util/table.c"
  ...
  if (col == -1) {
   if (columnName == 
# 1099 "project/radare2/libr/util/table.c" 3 4
                    ((void *)0) 
# 1099 "project/radare2/libr/util/table.c"
                         && strcmp (operation, "uniq")) {
    
# 1100 "project/radare2/libr/util/table.c" 3 4
   fprintf(__stderrp,
# 1100 "project/radare2/libr/util/table.c"
...
# 1100 "project/radare2/libr/util/table.c"
  ...
  if (!strcmp (operation, "sort")) {
   ...
   r_table_group (t, col, 
# 1113 "project/radare2/libr/util/table.c" 3 4
                         ((void *)0)
# 1113 "project/radare2/libr/util/table.c"
                             );
...
# 1173 "project/radare2/libr/util/table.c" 3 4
   fprintf(__stderrp,
# 1173 "project/radare2/libr/util/table.c"
   "Invalid operation (%s)\n", operation
# 1173 "project/radare2/libr/util/table.c" 3 4
   )
# 1173 "project/radare2/libr/util/table.c"
 ...
 __table_adjust (t);
 return 
# 1183 "project/radare2/libr/util/table.c" 3 4
       1
# 1183 "project/radare2/libr/util/table.c"
           ;
}


# 1186 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 1186 "project/radare2/libr/util/table.c"
          r_table_align(RTable *t, int nth, int align) {
 RTableColumn *col = r_list_get_n (t->cols, nth);
 if (col) {
  col->align = align;
  return 
# 1190 "project/radare2/libr/util/table.c" 3 4
        1
# 1190 "project/radare2/libr/util/table.c"
            ;
 }
 return 
# 1192 "project/radare2/libr/util/table.c" 3 4
       0
# 1192 "project/radare2/libr/util/table.c"
            ;
}


# 1195 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 1195 "project/radare2/libr/util/table.c"
     void r_table_hide_header (RTable *t) {
 t->showHeader = 
# 1196 "project/radare2/libr/util/table.c" 3 4
                0
# 1196 "project/radare2/libr/util/table.c"
                     ;
}


# 1199 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 1199 "project/radare2/libr/util/table.c"
     void r_table_visual_list(RTable *table, RList *list, 
# 1199 "project/radare2/libr/util/table.c" 3 4
                                                          unsigned long long 
# 1199 "project/radare2/libr/util/table.c"
                                                               seek, 
...
# 1200 "project/radare2/libr/util/table.c" 3 4
unsigned long long 
# 1200 "project/radare2/libr/util/table.c"
     mul, min = -1, max = -1;
 RListIter *iter;
 RListInfo *info;
 RCons *cons = (RCons *) table->cons;
 table->showHeader = 
# 1204 "project/radare2/libr/util/table.c" 3 4
                    0
# 1204 "project/radare2/libr/util/table.c"
                         ;
 const char *h_line = cons->use_utf8 ? 
# 1205 "project/radare2/libr/util/table.c" 3 4
                                      "―" 
# 1205 "project/radare2/libr/util/table.c"
                                                           : "-";
 const char *block = cons->use_utf8 ? 
# 1206 "project/radare2/libr/util/table.c" 3 4
                                     "\u2588" 
# 1206 "project/radare2/libr/util/table.c"
                                                  : "#";
 int j, i;
 width -= 80;
 if (width < 1) {
...
# 1214 "project/radare2/libr/util/table.c" 3 4
if (
# 1214 "project/radare2/libr/util/table.c"
list
# 1214 "project/radare2/libr/util/table.c" 3 4
) for (
# 1214 "project/radare2/libr/util/table.c"
...
# 1225 "project/radare2/libr/util/table.c" 3 4
 if (
# 1225 "project/radare2/libr/util/table.c"
 list
# 1225 "project/radare2/libr/util/table.c" 3 4
 ) for (
# 1225 "project/radare2/libr/util/table.c"
...
# 1228 "project/radare2/libr/util/table.c" 3 4
   unsigned long long 
# 1228 "project/radare2/libr/util/table.c"
        pos = min + j * mul;
    
# 1229 "project/radare2/libr/util/table.c" 3 4
   unsigned long long 
# 1229 "project/radare2/libr/util/table.c"
        npos = min + (j + 1) * mul;
   ...
   if (va) {
    r_table_add_rowf (table, "sssssss",
     ...
     sdb_fmt ("0x%"
# 1238 "project/radare2/libr/util/table.c" 3 4
                  "llx"
# 1238 "project/radare2/libr/util/table.c"
                         , info->vitv.addr),
     b,
     sdb_fmt ("0x%"
# 1240 "project/radare2/libr/util/table.c" 3 4
                  "llx"
# 1240 "project/radare2/libr/util/table.c"
                         , r_itv_end (info->vitv)),
    ...
    r_table_add_rowf (table, "sssssss", sdb_fmt ("%d%c", i, r_itv_contain (info->pitv, seek) ? '*' : ' '),
     sdb_fmt ("0x%"
# 1246 "project/radare2/libr/util/table.c" 3 4
                  "llx"
# 1246 "project/radare2/libr/util/table.c"
                         , info->pitv.addr), b,
     sdb_fmt ("0x%"
# 1247 "project/radare2/libr/util/table.c" 3 4
                  "llx"
# 1247 "project/radare2/libr/util/table.c"
                         , r_itv_end (info->pitv)),
  ...
  if (i > 0 && len != 0) {
   if (seek == 
# 1256 "project/radare2/libr/util/table.c" 3 4
              0xFFFFFFFFFFFFFFFFULL
# 1256 "project/radare2/libr/util/table.c"
                      ) {
    seek = 0;
   }
   for (j = 0; j < width; j++) {
   ...
   r_table_add_rowf (table, "sssssss", "=>", sdb_fmt ("0x%08"
# 1263 "project/radare2/libr/util/table.c" 3 4
                                                            "llx"
# 1263 "project/radare2/libr/util/table.c"
                                                                   , seek),
     r_strbuf_drain (buf), sdb_fmt ("0x%08"
# 1264 "project/radare2/libr/util/table.c" 3 4
                                          "llx"
# 1264 "project/radare2/libr/util/table.c"
                                                 , seek + len), "", "", "");
  } else {
   r_strbuf_free (buf);
  }
...
# 1271 "project/radare2/libr/util/table.c" 3 4
__attribute__((visibility("default"))) 
# 1271 "project/radare2/libr/util/table.c"
     RTable *r_table_clone(const RTable *t) {
 RTable *o = r_table_new (t->name);
 RTableColumn *col;
 RTableRow *row;
 RListIter *iter;
 
# 1276 "project/radare2/libr/util/table.c" 3 4
if (
# 1276 "project/radare2/libr/util/table.c"
t->cols
# 1276 "project/radare2/libr/util/table.c" 3 4
) for (
# 1276 "project/radare2/libr/util/table.c"
...
# 1279 "project/radare2/libr/util/table.c" 3 4
if (
# 1279 "project/radare2/libr/util/table.c"
t->rows
# 1279 "project/radare2/libr/util/table.c" 3 4
) for (
# 1279 "project/radare2/libr/util/table.c"
