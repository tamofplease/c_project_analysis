# 0 "project/radare2/libr/util/pj.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/pj.c"
...
# 4 "project/radare2/libr/util/pj.c" 2
...
# 5 "project/radare2/libr/util/pj.c" 2

__attribute__((visibility("default"))) 
# 6 "project/radare2/libr/util/pj.c"
     void pj_raw(PJ *j, const char *msg) {
 
# 7 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 7 "project/radare2/libr/util/pj.c"
j && msg
# 7 "project/radare2/libr/util/pj.c" 3 4
...
# 14 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 14 "project/radare2/libr/util/pj.c"
j
# 14 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 14 "project/radare2/libr/util/pj.c"
...
# 14 "project/radare2/libr/util/pj.c"
 ...
 j->is_first = 
# 20 "project/radare2/libr/util/pj.c" 3 4
              0
# 20 "project/radare2/libr/util/pj.c"
                   ;
 j->is_key = 
# 21 "project/radare2/libr/util/pj.c" 3 4
            0
# 21 "project/radare2/libr/util/pj.c"
                 ;
}


# 24 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 24 "project/radare2/libr/util/pj.c"
     PJ *pj_new(void) {
 PJ *j = 
# 25 "project/radare2/libr/util/pj.c" 3 4
        (
# 25 "project/radare2/libr/util/pj.c"
        PJ
# 25 "project/radare2/libr/util/pj.c" 3 4
        *)calloc(1,sizeof(
# 25 "project/radare2/libr/util/pj.c"
...
# 25 "project/radare2/libr/util/pj.c"
 ...
 if (j) {
  r_strbuf_init (&j->sb);
  j->is_first = 
# 28 "project/radare2/libr/util/pj.c" 3 4
               1
# 28 "project/radare2/libr/util/pj.c"
                   ;
...
# 35 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 35 "project/radare2/libr/util/pj.c"
     PJ *pj_new_with_encoding(PJEncodingStr str_encoding, PJEncodingNum num_encoding) {
 PJ *j = pj_new ();
 if (j) {
...
# 44 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 44 "project/radare2/libr/util/pj.c"
     void pj_free(PJ *pj) {
 if (pj) {
  r_strbuf_fini (&pj->sb);
  free (pj);
...
# 51 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 51 "project/radare2/libr/util/pj.c"
     void pj_reset(PJ *j) {
 
# 52 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 52 "project/radare2/libr/util/pj.c"
j
# 52 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 52 "project/radare2/libr/util/pj.c"
...
# 52 "project/radare2/libr/util/pj.c"
 ...
 j->level = 0;
 j->is_first = 
# 55 "project/radare2/libr/util/pj.c" 3 4
              1
# 55 "project/radare2/libr/util/pj.c"
                  ;
 j->is_key = 
# 56 "project/radare2/libr/util/pj.c" 3 4
            0
# 56 "project/radare2/libr/util/pj.c"
                 ;
}


# 59 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 59 "project/radare2/libr/util/pj.c"
     char *pj_drain(PJ *pj) {
 
# 60 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 60 "project/radare2/libr/util/pj.c"
pj && pj->level == 0
# 60 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 60 "project/radare2/libr/util/pj.c"
...
# 66 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 66 "project/radare2/libr/util/pj.c"
     const char *pj_string(PJ *j) {
 return j? r_strbuf_get (&j->sb): 
# 67 "project/radare2/libr/util/pj.c" 3 4
                                 ((void *)0)
# 67 "project/radare2/libr/util/pj.c"
                                     ;
}
...
static PJ *pj_begin(PJ *j, char type) {
 if (j) {
  if (!j || j->level >= 
# 72 "project/radare2/libr/util/pj.c" 3 4
                       128
# 72 "project/radare2/libr/util/pj.c"
                                               ) {
   return 
# 73 "project/radare2/libr/util/pj.c" 3 4
         ((void *)0)
# 73 "project/radare2/libr/util/pj.c"
             ;
  }
  char msg[2] = { type, 0 };
  pj_raw (j, msg);
  ...
  j->level++;
  j->is_first = 
# 79 "project/radare2/libr/util/pj.c" 3 4
               1
# 79 "project/radare2/libr/util/pj.c"
                   ;
 }
 return j;
}
...
# 84 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 84 "project/radare2/libr/util/pj.c"
     PJ *pj_o(PJ *j) {
 
# 85 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 85 "project/radare2/libr/util/pj.c"
j
# 85 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 85 "project/radare2/libr/util/pj.c"
...
# 90 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 90 "project/radare2/libr/util/pj.c"
     PJ *pj_a(PJ *j) {
 
# 91 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 91 "project/radare2/libr/util/pj.c"
j
# 91 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 91 "project/radare2/libr/util/pj.c"
...
# 96 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 96 "project/radare2/libr/util/pj.c"
     PJ *pj_end(PJ *j) {
 
# 97 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 97 "project/radare2/libr/util/pj.c"
j
# 97 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 97 "project/radare2/libr/util/pj.c"
...
# 97 "project/radare2/libr/util/pj.c"
 ...
 j->is_first = 
# 107 "project/radare2/libr/util/pj.c" 3 4
              0
# 107 "project/radare2/libr/util/pj.c"
                   ;
 char msg[2] = { j->braces[j->level], 0 };
 pj_raw (j, msg);
 return j;
...
# 113 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 113 "project/radare2/libr/util/pj.c"
     PJ *pj_k(PJ *j, const char *k) {
 
# 114 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 114 "project/radare2/libr/util/pj.c"
j && k
# 114 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 114 "project/radare2/libr/util/pj.c"
...
# 114 "project/radare2/libr/util/pj.c"
                                ;
 j->is_key = 
# 115 "project/radare2/libr/util/pj.c" 3 4
            0
# 115 "project/radare2/libr/util/pj.c"
                 ;
 pj_s (j, k);
 pj_raw (j, ":");
 j->is_first = 
# 118 "project/radare2/libr/util/pj.c" 3 4
              0
# 118 "project/radare2/libr/util/pj.c"
                   ;
 j->is_key = 
# 119 "project/radare2/libr/util/pj.c" 3 4
            1
# 119 "project/radare2/libr/util/pj.c"
                ;
 return j;
}


# 123 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 123 "project/radare2/libr/util/pj.c"
     PJ *pj_knull(PJ *j, const char *k) {
 
# 124 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 124 "project/radare2/libr/util/pj.c"
j && k
# 124 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 124 "project/radare2/libr/util/pj.c"
...
# 130 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 130 "project/radare2/libr/util/pj.c"
     PJ *pj_kn(PJ *j, const char *k, 
# 130 "project/radare2/libr/util/pj.c" 3 4
                                     unsigned long long 
# 130 "project/radare2/libr/util/pj.c"
                                          n) {
 
# 131 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 131 "project/radare2/libr/util/pj.c"
j && k
# 131 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 131 "project/radare2/libr/util/pj.c"
...
# 141 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 141 "project/radare2/libr/util/pj.c"
     PJ *pj_kN(PJ *j, const char *k, 
# 141 "project/radare2/libr/util/pj.c" 3 4
                                     long long 
# 141 "project/radare2/libr/util/pj.c"
...
# 149 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 149 "project/radare2/libr/util/pj.c"
     PJ *pj_kd(PJ *j, const char *k, double d) {
 
# 150 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 150 "project/radare2/libr/util/pj.c"
j && k
# 150 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 150 "project/radare2/libr/util/pj.c"
...
# 156 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 156 "project/radare2/libr/util/pj.c"
     PJ *pj_kf(PJ *j, const char *k, float d) {
 
# 157 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 157 "project/radare2/libr/util/pj.c"
j && k
# 157 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 157 "project/radare2/libr/util/pj.c"
...
# 162 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 162 "project/radare2/libr/util/pj.c"
     PJ *pj_ki(PJ *j, const char *k, int i) {
 
# 163 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 163 "project/radare2/libr/util/pj.c"
j && k
# 163 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 163 "project/radare2/libr/util/pj.c"
...
# 169 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 169 "project/radare2/libr/util/pj.c"
     PJ *pj_ko(PJ *j, const char *k) {
 
# 170 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 170 "project/radare2/libr/util/pj.c"
j && k
# 170 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 170 "project/radare2/libr/util/pj.c"
...
# 176 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 176 "project/radare2/libr/util/pj.c"
     PJ *pj_ka(PJ *j, const char *k) {
 
# 177 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 177 "project/radare2/libr/util/pj.c"
j && k
# 177 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 177 "project/radare2/libr/util/pj.c"
...
# 183 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 183 "project/radare2/libr/util/pj.c"
     PJ *pj_ks(PJ *j, const char *k, const char *v) {
 
# 184 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 184 "project/radare2/libr/util/pj.c"
j && k && v
# 184 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 184 "project/radare2/libr/util/pj.c"
...
# 194 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 194 "project/radare2/libr/util/pj.c"
     PJ *pj_kb(PJ *j, const char *k, 
# 194 "project/radare2/libr/util/pj.c" 3 4
                                     _Bool 
# 194 "project/radare2/libr/util/pj.c"
                                          v) {
 
# 195 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 195 "project/radare2/libr/util/pj.c"
j && k
# 195 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 195 "project/radare2/libr/util/pj.c"
...
# 201 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 201 "project/radare2/libr/util/pj.c"
     PJ *pj_null(PJ *j) {
 
# 202 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 202 "project/radare2/libr/util/pj.c"
j
# 202 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 202 "project/radare2/libr/util/pj.c"
...
# 208 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 208 "project/radare2/libr/util/pj.c"
     PJ *pj_b(PJ *j, 
# 208 "project/radare2/libr/util/pj.c" 3 4
                     _Bool 
# 208 "project/radare2/libr/util/pj.c"
...
# 209 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 209 "project/radare2/libr/util/pj.c"
j
# 209 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 209 "project/radare2/libr/util/pj.c"
...
# 215 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 215 "project/radare2/libr/util/pj.c"
     PJ *pj_s(PJ *j, const char *k) {
 
# 216 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 216 "project/radare2/libr/util/pj.c"
j && k
# 216 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 216 "project/radare2/libr/util/pj.c"
...
# 224 "project/radare2/libr/util/pj.c" 3 4
 fprintf(__stderrp,
# 224 "project/radare2/libr/util/pj.c"
...
# 230 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 230 "project/radare2/libr/util/pj.c"
     PJ *pj_se(PJ *j, const char *k) {
 
# 231 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 231 "project/radare2/libr/util/pj.c"
j && k
# 231 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 231 "project/radare2/libr/util/pj.c"
...
# 251 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 251 "project/radare2/libr/util/pj.c"
     PJ *pj_r(PJ *j, const unsigned char *v, size_t v_len) {
 
# 252 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 252 "project/radare2/libr/util/pj.c"
j && v
# 252 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 252 "project/radare2/libr/util/pj.c"
...
# 262 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 262 "project/radare2/libr/util/pj.c"
     PJ *pj_kr(PJ *j, const char *k, const unsigned char *v, size_t v_len) {
 
# 263 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 263 "project/radare2/libr/util/pj.c"
j && k && v
# 263 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 263 "project/radare2/libr/util/pj.c"
...
# 269 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 269 "project/radare2/libr/util/pj.c"
     PJ *pj_j(PJ *j, const char *k) {
 
# 270 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 270 "project/radare2/libr/util/pj.c"
j && k
# 270 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 270 "project/radare2/libr/util/pj.c"
...
# 278 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 278 "project/radare2/libr/util/pj.c"
     PJ *pj_n(PJ *j, 
# 278 "project/radare2/libr/util/pj.c" 3 4
                     unsigned long long 
# 278 "project/radare2/libr/util/pj.c"
...
# 279 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 279 "project/radare2/libr/util/pj.c"
j
# 279 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 279 "project/radare2/libr/util/pj.c"
...
# 279 "project/radare2/libr/util/pj.c"
 ...
 pj_comma (j);
 pj_raw (j, sdb_fmt ("%" 
# 281 "project/radare2/libr/util/pj.c" 3 4
                        "llu"
# 281 "project/radare2/libr/util/pj.c"
                               , n));
 return j;
}


# 285 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 285 "project/radare2/libr/util/pj.c"
     PJ *pj_ne(PJ *j, 
# 285 "project/radare2/libr/util/pj.c" 3 4
                      unsigned long long 
# 285 "project/radare2/libr/util/pj.c"
...
# 286 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 286 "project/radare2/libr/util/pj.c"
j
# 286 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 286 "project/radare2/libr/util/pj.c"
...
# 286 "project/radare2/libr/util/pj.c"
 ...
 if (j->num_encoding == PJ_ENCODING_NUM_STR) {
  pj_raw (j, sdb_fmt ("\"%" 
# 289 "project/radare2/libr/util/pj.c" 3 4
                           "llu" 
# 289 "project/radare2/libr/util/pj.c"
                                   "\"", n));
 } else if (j->num_encoding == PJ_ENCODING_NUM_HEX) {
  pj_raw (j, sdb_fmt ("\"0x%" 
# 291 "project/radare2/libr/util/pj.c" 3 4
                             "llx" 
# 291 "project/radare2/libr/util/pj.c"
                                     "\"", n));
 } else {
  pj_n(j, n);
 }
...
# 298 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 298 "project/radare2/libr/util/pj.c"
     PJ *pj_N(PJ *j, 
# 298 "project/radare2/libr/util/pj.c" 3 4
                     long long 
# 298 "project/radare2/libr/util/pj.c"
...
# 299 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 299 "project/radare2/libr/util/pj.c"
j
# 299 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 299 "project/radare2/libr/util/pj.c"
...
# 299 "project/radare2/libr/util/pj.c"
 ...
 pj_comma (j);
 pj_raw (j, sdb_fmt ("%"
# 301 "project/radare2/libr/util/pj.c" 3 4
                       "lld"
# 301 "project/radare2/libr/util/pj.c"
                              , n));
 return j;
}


# 305 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 305 "project/radare2/libr/util/pj.c"
     PJ *pj_f(PJ *j, float f) {
 
# 306 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 306 "project/radare2/libr/util/pj.c"
j
# 306 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 306 "project/radare2/libr/util/pj.c"
...
# 312 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 312 "project/radare2/libr/util/pj.c"
     PJ *pj_d(PJ *j, double d) {
 
# 313 "project/radare2/libr/util/pj.c" 3 4
do { if (!(
# 313 "project/radare2/libr/util/pj.c"
j
# 313 "project/radare2/libr/util/pj.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 313 "project/radare2/libr/util/pj.c"
...
# 319 "project/radare2/libr/util/pj.c" 3 4
__attribute__((visibility("default"))) 
# 319 "project/radare2/libr/util/pj.c"
     PJ *pj_i(PJ *j, int i) {
 if (j) {
  pj_comma (j);
