# 0 "project/radare2/libr/util/sys.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/sys.c"
...
# 4 "project/radare2/libr/util/sys.c" 2
...
# 5 "project/radare2/libr/util/sys.c" 2
...
# 6 "project/radare2/libr/util/sys.c" 2
# 28 "project/radare2/libr/util/sys.c"
...
# 29 "project/radare2/libr/util/sys.c" 2
...
# 30 "project/radare2/libr/util/sys.c" 2
...
# 31 "project/radare2/libr/util/sys.c" 2
...
# 32 "project/radare2/libr/util/sys.c" 2


# 33 "project/radare2/libr/util/sys.c"
static char** env = 
# 33 "project/radare2/libr/util/sys.c" 3 4
                   ((void *)0)
# 33 "project/radare2/libr/util/sys.c"
                       ;
...
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/errno.h" 1 3 4
# 41 "project/radare2/libr/util/sys.c" 2
...
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/execinfo.h" 1 3 4
# 24 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/execinfo.h" 3 4
...
# 29 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/execinfo.h" 2 3 4
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/os/availability.h" 1 3 4
# 22 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/os/availability.h" 3 4
#define __OS_AVAILABILITY__ 
# 37 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/os/availability.h" 3 4
#define API_TO_BE_DEPRECATED 100000
# 112 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/os/availability.h" 3 4
...
# 154 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/os/availability.h" 3 4
...
# 30 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/execinfo.h" 2 3 4
...
# 32 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/execinfo.h" 2 3 4
...
# 49 "project/radare2/libr/util/sys.c" 2




# 52 "project/radare2/libr/util/sys.c"
extern char ***_NSGetEnviron(void);

#define PROC_PIDPATHINFO_MAXSIZE 1024
int proc_pidpath(int pid, void * buffer, 
# 55 "project/radare2/libr/util/sys.c" 3 4
                                        unsigned int 
# 55 "project/radare2/libr/util/sys.c"
                                             buffersize);




# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/utsname.h" 1 3 4
# 68 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/utsname.h" 3 4
...
# 74 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/utsname.h" 3 4
struct utsname {
 char sysname[256];
 char nodename[256];
 char release[256];
...
# 61 "project/radare2/libr/util/sys.c" 2

# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/errno.h" 1 3 4
# 63 "project/radare2/libr/util/sys.c" 2
...
# 65 "project/radare2/libr/util/sys.c" 2




# 68 "project/radare2/libr/util/sys.c"
extern char **environ;
# 86 "project/radare2/libr/util/sys.c"

# 86 "project/radare2/libr/util/sys.c" 3 4
...
#define R_SYS_ASM_START_ROP() __asm__ __volatile__ ("leaq %0, %%rsp; ret" : : "m" (*bufptr));
# 117 "project/radare2/libr/util/sys.c"
static const struct {const char* name; 
# 117 "project/radare2/libr/util/sys.c" 3 4
                                      unsigned long long 
# 117 "project/radare2/libr/util/sys.c"
                                           bit;} arch_bit_array[] = {
    {"x86", R_SYS_ARCH_X86},
    ...
    {
# 139 "project/radare2/libr/util/sys.c" 3 4
    ((void *)0)
# 139 "project/radare2/libr/util/sys.c"
        , 0}
};


# 142 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 142 "project/radare2/libr/util/sys.c"
     int r_sys_fork(void) {
...
# 188 "project/radare2/libr/util/sys.c"

# 188 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 188 "project/radare2/libr/util/sys.c"
     int r_sys_sigaction(int *sig, void (*handler)(int)) {
 if (!sig) {
  return -
# 190 "project/radare2/libr/util/sys.c" 3 4
         22
# 190 "project/radare2/libr/util/sys.c"
               ;
 }
 size_t i;
 for (i = 0; sig[i] != 0; i++) {
  ...
  if (ret == 
# 195 "project/radare2/libr/util/sys.c" 3 4
            ((void (*)(int))-1)
# 195 "project/radare2/libr/util/sys.c"
                   ) {
   
# 196 "project/radare2/libr/util/sys.c" 3 4
  fprintf(__stderrp,
# 196 "project/radare2/libr/util/sys.c"
...
# 204 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 204 "project/radare2/libr/util/sys.c"
     int r_sys_signal(int sig, void (*handler) (int)) {
 int s[2] = { sig, 0 };
 return r_sys_sigaction (s, handler);
}


# 209 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 209 "project/radare2/libr/util/sys.c"
     void r_sys_exit(int status, 
# 209 "project/radare2/libr/util/sys.c" 3 4
                                 _Bool 
# 209 "project/radare2/libr/util/sys.c"
                                      nocleanup) {
...
# 217 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 217 "project/radare2/libr/util/sys.c"
     int r_sys_truncate(const char *file, int sz) {
# 232 "project/radare2/libr/util/sys.c"
 if (r_sandbox_enable (0)) {
  return 
# 233 "project/radare2/libr/util/sys.c" 3 4
        0
# 233 "project/radare2/libr/util/sys.c"
             ;
 }
...
# 239 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 239 "project/radare2/libr/util/sys.c"
     RList *r_sys_dir(const char *path) {
 RList *list = 
# 240 "project/radare2/libr/util/sys.c" 3 4
              ((void *)0)
# 240 "project/radare2/libr/util/sys.c"
                  ;
# 260 "project/radare2/libr/util/sys.c"
 struct dirent *entry;
...
# 276 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 276 "project/radare2/libr/util/sys.c"
     char *r_sys_cmd_strf(const char *fmt, ...) {
 char *ret, cmd[4096];
 va_list ap;
 
# 279 "project/radare2/libr/util/sys.c" 3 4
__builtin_va_start(
# 279 "project/radare2/libr/util/sys.c"
ap
# 279 "project/radare2/libr/util/sys.c" 3 4
,
# 279 "project/radare2/libr/util/sys.c"
...
# 280 "project/radare2/libr/util/sys.c" 3 4
__builtin___vsnprintf_chk (
# 280 "project/radare2/libr/util/sys.c"
cmd
# 280 "project/radare2/libr/util/sys.c" 3 4
, 
# 280 "project/radare2/libr/util/sys.c"
...
# 280 "project/radare2/libr/util/sys.c"
                                      ;
 ret = r_sys_cmd_str (cmd, 
# 281 "project/radare2/libr/util/sys.c" 3 4
                          ((void *)0)
# 281 "project/radare2/libr/util/sys.c"
                              , 
# 281 "project/radare2/libr/util/sys.c" 3 4
                                ((void *)0)
# 281 "project/radare2/libr/util/sys.c"
...
# 282 "project/radare2/libr/util/sys.c" 3 4
__builtin_va_end(
# 282 "project/radare2/libr/util/sys.c"
ap
# 282 "project/radare2/libr/util/sys.c" 3 4
)
# 282 "project/radare2/libr/util/sys.c"
...
# 286 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 286 "project/radare2/libr/util/sys.c"
         *r_sys_unxz(const 
# 286 "project/radare2/libr/util/sys.c" 3 4
                           unsigned char 
# 286 "project/radare2/libr/util/sys.c"
                               *buf, size_t len, size_t *olen) {
 char *err = 
# 287 "project/radare2/libr/util/sys.c" 3 4
            ((void *)0)
# 287 "project/radare2/libr/util/sys.c"
                ;
 
# 288 "project/radare2/libr/util/sys.c" 3 4
unsigned char 
# 288 "project/radare2/libr/util/sys.c"
    *out = 
# 288 "project/radare2/libr/util/sys.c" 3 4
           ((void *)0)
# 288 "project/radare2/libr/util/sys.c"
 ...
 free (err);
 return 
# 300 "project/radare2/libr/util/sys.c" 3 4
       ((void *)0)
# 300 "project/radare2/libr/util/sys.c"
           ;
}
...
# 316 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 316 "project/radare2/libr/util/sys.c"
     void r_sys_backtrace(void) {

 void *array[10];
 size_t size = backtrace (array, 10);
 
# 320 "project/radare2/libr/util/sys.c" 3 4
fprintf(__stderrp,
# 320 "project/radare2/libr/util/sys.c"
...
# 342 "project/radare2/libr/util/sys.c"
}


# 344 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 344 "project/radare2/libr/util/sys.c"
...
# 358 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 358 "project/radare2/libr/util/sys.c"
     int r_sys_usleep(int usecs) {
# 370 "project/radare2/libr/util/sys.c"
 return usleep (usecs);
...
# 380 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 380 "project/radare2/libr/util/sys.c"
     int r_sys_clearenv(void) {
# 393 "project/radare2/libr/util/sys.c"
 if (!environ) {
  return 0;
 }
 while (*environ) {
  *environ++ = 
# 397 "project/radare2/libr/util/sys.c" 3 4
              ((void *)0)
# 397 "project/radare2/libr/util/sys.c"
                  ;
 }
...
# 407 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 407 "project/radare2/libr/util/sys.c"
...
# 431 "project/radare2/libr/util/sys.c"
}


static char *crash_handler_cmd = 
# 434 "project/radare2/libr/util/sys.c" 3 4
                                ((void *)0)
# 434 "project/radare2/libr/util/sys.c"
                                    ;
...
# 464 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 464 "project/radare2/libr/util/sys.c"
     int r_sys_crash_handler(const char *cmd) {

 int sig[] = { 
# 466 "project/radare2/libr/util/sys.c" 3 4
              2
# 466 "project/radare2/libr/util/sys.c"
                    , 
# 466 "project/radare2/libr/util/sys.c" 3 4
                      11
# 466 "project/radare2/libr/util/sys.c"
...
# 466 "project/radare2/libr/util/sys.c"
 ...
 if (!checkcmd (cmd)) {
  return 
# 469 "project/radare2/libr/util/sys.c" 3 4
        0
# 469 "project/radare2/libr/util/sys.c"
             ;
 }
 ...
 return 
# 484 "project/radare2/libr/util/sys.c" 3 4
       1
# 484 "project/radare2/libr/util/sys.c"
           ;
}


# 487 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 487 "project/radare2/libr/util/sys.c"
     char *r_sys_getenv(const char *key) {
# 523 "project/radare2/libr/util/sys.c"
 char *b;
 if (!key) {
  return 
# 525 "project/radare2/libr/util/sys.c" 3 4
        ((void *)0)
# 525 "project/radare2/libr/util/sys.c"
            ;
 }
 b = getenv (key);
 return b? strdup (b): 
# 528 "project/radare2/libr/util/sys.c" 3 4
                      ((void *)0)
# 528 "project/radare2/libr/util/sys.c"
                          ;

}


# 532 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 532 "project/radare2/libr/util/sys.c"
          r_sys_getenv_asbool(const char *key) {
 
# 533 "project/radare2/libr/util/sys.c" 3 4
do { if (!(
# 533 "project/radare2/libr/util/sys.c"
key
# 533 "project/radare2/libr/util/sys.c" 3 4
...
"key"
# 533 "project/radare2/libr/util/sys.c" 3 4
, 533); return (0); } } while (0)
# 533 "project/radare2/libr/util/sys.c"
                                 ;
 char *env = r_sys_getenv (key);
 const 
# 535 "project/radare2/libr/util/sys.c" 3 4
      _Bool 
# 535 "project/radare2/libr/util/sys.c"
           res = env && r_str_is_true (env);
 free (env);
 return res;
}


# 540 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 540 "project/radare2/libr/util/sys.c"
     char *r_sys_getdir(void) {
...
# 558 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 558 "project/radare2/libr/util/sys.c"
          r_sys_chdir(const char *s) {
 return r_sandbox_chdir (s) == 0;
}


# 562 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 562 "project/radare2/libr/util/sys.c"
          r_sys_aslr(int val) {
 
# 563 "project/radare2/libr/util/sys.c" 3 4
_Bool 
# 563 "project/radare2/libr/util/sys.c"
     ret = 
# 563 "project/radare2/libr/util/sys.c" 3 4
           1
# 563 "project/radare2/libr/util/sys.c"
               ;
# 603 "project/radare2/libr/util/sys.c"
 return ret;
}



# 607 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 607 "project/radare2/libr/util/sys.c"
     int r_sys_cmd_str_full(const char *cmd, const char *input, int ilen, char **output, int *len, char **sterr) {
 char *mysterr = 
# 608 "project/radare2/libr/util/sys.c" 3 4
                ((void *)0)
# 608 "project/radare2/libr/util/sys.c"
                    ;
 if (!sterr) {
  sterr = &mysterr;
 }
 
# 612 "project/radare2/libr/util/sys.c" 3 4
unsigned char 
# 612 "project/radare2/libr/util/sys.c"
    buffer[1024];
 char *outputptr = 
# 613 "project/radare2/libr/util/sys.c" 3 4
                  ((void *)0)
# 613 "project/radare2/libr/util/sys.c"
                      ;
 ...
 if (pipe (sh_in)) {
  return 
# 625 "project/radare2/libr/util/sys.c" 3 4
        0
# 625 "project/radare2/libr/util/sys.c"
             ;
 }
 if (output) {
  if (pipe (sh_out)) {
   ...
   close (sh_out[1]);
   return 
# 633 "project/radare2/libr/util/sys.c" 3 4
         0
# 633 "project/radare2/libr/util/sys.c"
              ;
  }
 }
 if (pipe (sh_err)) {
  ...
  close (sh_in[1]);
  return 
# 639 "project/radare2/libr/util/sys.c" 3 4
        0
# 639 "project/radare2/libr/util/sys.c"
             ;
 }
 ...
 case -1:
  return 
# 644 "project/radare2/libr/util/sys.c" 3 4
        0
# 644 "project/radare2/libr/util/sys.c"
             ;
 case 0:
  dup2 (sh_in[0], 0);
  close (sh_in[0]);
 ...
 default:
  ...
  if (!outputptr) {
   return 
# 665 "project/radare2/libr/util/sys.c" 3 4
         0
# 665 "project/radare2/libr/util/sys.c"
              ;
  }
  if (sterr) {
   *sterr = strdup ("");
   if (!*sterr) {
    free (outputptr);
    return 
# 671 "project/radare2/libr/util/sys.c" 3 4
          0
# 671 "project/radare2/libr/util/sys.c"
               ;
   }
  }
  if (output) {
  ...
  r_sys_signal (
# 683 "project/radare2/libr/util/sys.c" 3 4
               13
# 683 "project/radare2/libr/util/sys.c"
                      , 
# 683 "project/radare2/libr/util/sys.c" 3 4
                        (void (*)(int))1
# 683 "project/radare2/libr/util/sys.c"
...
# 689 "project/radare2/libr/util/sys.c" 3 4
  __builtin_bzero(
# 689 "project/radare2/libr/util/sys.c"
  &rfds
# 689 "project/radare2/libr/util/sys.c" 3 4
  , sizeof(*(
# 689 "project/radare2/libr/util/sys.c"
...
# 690 "project/radare2/libr/util/sys.c" 3 4
  __builtin_bzero(
# 690 "project/radare2/libr/util/sys.c"
  &wfds
# 690 "project/radare2/libr/util/sys.c" 3 4
  , sizeof(*(
# 690 "project/radare2/libr/util/sys.c"
...
# 692 "project/radare2/libr/util/sys.c" 3 4
   __darwin_fd_set((
# 692 "project/radare2/libr/util/sys.c"
   sh_out[0]
# 692 "project/radare2/libr/util/sys.c" 3 4
   ), (
# 692 "project/radare2/libr/util/sys.c"
...
# 695 "project/radare2/libr/util/sys.c" 3 4
   __darwin_fd_set((
# 695 "project/radare2/libr/util/sys.c"
   sh_err[0]
# 695 "project/radare2/libr/util/sys.c" 3 4
   ), (
# 695 "project/radare2/libr/util/sys.c"
...
# 698 "project/radare2/libr/util/sys.c" 3 4
   __darwin_fd_set((
# 698 "project/radare2/libr/util/sys.c"
   sh_in[1]
# 698 "project/radare2/libr/util/sys.c" 3 4
   ), (
# 698 "project/radare2/libr/util/sys.c"
...
# 700 "project/radare2/libr/util/sys.c" 3 4
  __builtin___memset_chk (
# 700 "project/radare2/libr/util/sys.c"
  buffer
# 700 "project/radare2/libr/util/sys.c" 3 4
  , 
# 700 "project/radare2/libr/util/sys.c"
...
# 700 "project/radare2/libr/util/sys.c"
                                     ;
   nfd = select (sh_err[0] + 1, &rfds, &wfds, 
# 701 "project/radare2/libr/util/sys.c" 3 4
                                             ((void *)0)
# 701 "project/radare2/libr/util/sys.c"
                                                 , 
# 701 "project/radare2/libr/util/sys.c" 3 4
                                                   ((void *)0)
# 701 "project/radare2/libr/util/sys.c"
   ...
   if (output && 
# 705 "project/radare2/libr/util/sys.c" 3 4
                __darwin_fd_isset((
# 705 "project/radare2/libr/util/sys.c"
                sh_out[0]
# 705 "project/radare2/libr/util/sys.c" 3 4
                ), (
# 705 "project/radare2/libr/util/sys.c"
...
# 711 "project/radare2/libr/util/sys.c" 3 4
    { free((void *)
# 711 "project/radare2/libr/util/sys.c"
    outputptr
# 711 "project/radare2/libr/util/sys.c" 3 4
    ); 
# 711 "project/radare2/libr/util/sys.c"
...
# 715 "project/radare2/libr/util/sys.c" 3 4
   __builtin___memcpy_chk (
# 715 "project/radare2/libr/util/sys.c"
   outputptr + out_len
# 715 "project/radare2/libr/util/sys.c" 3 4
   , 
# 715 "project/radare2/libr/util/sys.c"
...
# 717 "project/radare2/libr/util/sys.c" 3 4
             __darwin_fd_isset((
# 717 "project/radare2/libr/util/sys.c"
             sh_err[0]
# 717 "project/radare2/libr/util/sys.c" 3 4
             ), (
# 717 "project/radare2/libr/util/sys.c"
...
# 723 "project/radare2/libr/util/sys.c" 3 4
    { free((void *)
# 723 "project/radare2/libr/util/sys.c"
    *sterr
# 723 "project/radare2/libr/util/sys.c" 3 4
    ); 
# 723 "project/radare2/libr/util/sys.c"
...
# 727 "project/radare2/libr/util/sys.c" 3 4
   __builtin___memcpy_chk (
# 727 "project/radare2/libr/util/sys.c"
   *sterr + err_len
# 727 "project/radare2/libr/util/sys.c" 3 4
   , 
# 727 "project/radare2/libr/util/sys.c"
...
# 729 "project/radare2/libr/util/sys.c" 3 4
             __darwin_fd_isset((
# 729 "project/radare2/libr/util/sys.c"
             sh_in[1]
# 729 "project/radare2/libr/util/sys.c" 3 4
             ), (
# 729 "project/radare2/libr/util/sys.c"
...
# 729 "project/radare2/libr/util/sys.c"
    ...
    inputptr_len = 
# 731 "project/radare2/libr/util/sys.c" 3 4
                  (((
# 731 "project/radare2/libr/util/sys.c"
                  inputptr_len
# 731 "project/radare2/libr/util/sys.c" 3 4
                  )>(
# 731 "project/radare2/libr/util/sys.c"
...
# 746 "project/radare2/libr/util/sys.c" 3 4
 _Bool 
# 746 "project/radare2/libr/util/sys.c"
      ret = 
# 746 "project/radare2/libr/util/sys.c" 3 4
            1
# 746 "project/radare2/libr/util/sys.c"
  ...
  if (status) {
   ...
   ret = 
# 753 "project/radare2/libr/util/sys.c" 3 4
        0
# 753 "project/radare2/libr/util/sys.c"
             ;
  }
 ...
 return 
# 773 "project/radare2/libr/util/sys.c" 3 4
       0
# 773 "project/radare2/libr/util/sys.c"
            ;
}
# 786 "project/radare2/libr/util/sys.c"

# 786 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 786 "project/radare2/libr/util/sys.c"
...
# 790 "project/radare2/libr/util/sys.c" 3 4
__builtin_va_start(
# 790 "project/radare2/libr/util/sys.c"
ap
# 790 "project/radare2/libr/util/sys.c" 3 4
,
# 790 "project/radare2/libr/util/sys.c"
...
# 791 "project/radare2/libr/util/sys.c" 3 4
__builtin___vsnprintf_chk (
# 791 "project/radare2/libr/util/sys.c"
cmd
# 791 "project/radare2/libr/util/sys.c" 3 4
, 
# 791 "project/radare2/libr/util/sys.c"
...
# 793 "project/radare2/libr/util/sys.c" 3 4
__builtin_va_end(
# 793 "project/radare2/libr/util/sys.c"
ap
# 793 "project/radare2/libr/util/sys.c" 3 4
)
# 793 "project/radare2/libr/util/sys.c"
...
# 797 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 797 "project/radare2/libr/util/sys.c"
     int r_sys_cmdbg (const char *str) {
...
# 807 "project/radare2/libr/util/sys.c" 3 4
fprintf(__stderrp,
# 807 "project/radare2/libr/util/sys.c"
"{exit: %d, pid: %d, cmd: \"%s\"}", ret, pid, str
# 807 "project/radare2/libr/util/sys.c" 3 4
)
# 807 "project/radare2/libr/util/sys.c"
                                                           ;
...
# 816 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 816 "project/radare2/libr/util/sys.c"
     int r_sys_cmd(const char *str) {
 if (r_sandbox_enable (0)) {
  return 
# 818 "project/radare2/libr/util/sys.c" 3 4
        0
# 818 "project/radare2/libr/util/sys.c"
             ;
 }
...
# 823 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 823 "project/radare2/libr/util/sys.c"
     char *r_sys_cmd_str(const char *cmd, const char *input, int *len) {
 char *output = 
# 824 "project/radare2/libr/util/sys.c" 3 4
               ((void *)0)
# 824 "project/radare2/libr/util/sys.c"
                   ;
 if (r_sys_cmd_str_full (cmd, input, -1, &output, len, 
# 825 "project/radare2/libr/util/sys.c" 3 4
                                                      ((void *)0)
# 825 "project/radare2/libr/util/sys.c"
                                                          )) {
  return output;
 }
 free (output);
 return 
# 829 "project/radare2/libr/util/sys.c" 3 4
       ((void *)0)
# 829 "project/radare2/libr/util/sys.c"
           ;
}


# 832 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 832 "project/radare2/libr/util/sys.c"
          r_sys_mkdir(const char *dir) {
 
# 833 "project/radare2/libr/util/sys.c" 3 4
_Bool 
# 833 "project/radare2/libr/util/sys.c"
     ret;

 if (r_sandbox_enable (0)) {
  return 
# 836 "project/radare2/libr/util/sys.c" 3 4
        0
# 836 "project/radare2/libr/util/sys.c"
             ;
 }
...
# 849 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 849 "project/radare2/libr/util/sys.c"
          r_sys_mkdirp(const char *dir) {
 
# 850 "project/radare2/libr/util/sys.c" 3 4
_Bool 
# 850 "project/radare2/libr/util/sys.c"
     ret = 
# 850 "project/radare2/libr/util/sys.c" 3 4
           1
# 850 "project/radare2/libr/util/sys.c"
               ;
 char slash = 
# 851 "project/radare2/libr/util/sys.c" 3 4
             "/"
# 851 "project/radare2/libr/util/sys.c"
                      [0];
 char *path = strdup (dir), *ptr = path;
 if (!path) {
  
# 854 "project/radare2/libr/util/sys.c" 3 4
 fprintf(__stderrp,
# 854 "project/radare2/libr/util/sys.c"
 "r_sys_mkdirp: Unable to allocate memory\n"
# 854 "project/radare2/libr/util/sys.c" 3 4
 )
# 854 "project/radare2/libr/util/sys.c"
                                                      ;
  return 
# 855 "project/radare2/libr/util/sys.c" 3 4
        0
# 855 "project/radare2/libr/util/sys.c"
             ;
 }
 if (*ptr == slash) {
  ptr++;
 }
# 868 "project/radare2/libr/util/sys.c"
 for (;;) {
  ...
  *ptr = 0;
  if (!r_sys_mkdir (path) && 
# 880 "project/radare2/libr/util/sys.c" 3 4
                            ((*__error()) != 17)
# 880 "project/radare2/libr/util/sys.c"
                                                 ) {
   
# 881 "project/radare2/libr/util/sys.c" 3 4
  fprintf(__stderrp,
# 881 "project/radare2/libr/util/sys.c"
  "r_sys_mkdirp: fail '%s' of '%s'\n", path, dir
# 881 "project/radare2/libr/util/sys.c" 3 4
  )
# 881 "project/radare2/libr/util/sys.c"
                                                          ;
   free (path);
   return 
# 883 "project/radare2/libr/util/sys.c" 3 4
         0
# 883 "project/radare2/libr/util/sys.c"
              ;
  }
  *ptr = slash;
  ptr++;
 ...
 if (!r_sys_mkdir (path) && 
# 888 "project/radare2/libr/util/sys.c" 3 4
                           ((*__error()) != 17)
# 888 "project/radare2/libr/util/sys.c"
                                                ) {
  ret = 
# 889 "project/radare2/libr/util/sys.c" 3 4
       0
# 889 "project/radare2/libr/util/sys.c"
            ;
 }
 free (path);
 return ret;
...
# 895 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 895 "project/radare2/libr/util/sys.c"
...
# 924 "project/radare2/libr/util/sys.c"
}


# 926 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 926 "project/radare2/libr/util/sys.c"
          r_sys_arch_match(const char *archstr, const char *arch) {
 char *ptr;
 if (!archstr || !arch || !*archstr || !*arch) {
  return 
# 929 "project/radare2/libr/util/sys.c" 3 4
        1
# 929 "project/radare2/libr/util/sys.c"
            ;
 }
 if (!strcmp (archstr, "*") || !strcmp (archstr, "any")) {
  return 
# 932 "project/radare2/libr/util/sys.c" 3 4
        1
# 932 "project/radare2/libr/util/sys.c"
            ;
 }
 if (!strcmp (archstr, arch)) {
  return 
# 935 "project/radare2/libr/util/sys.c" 3 4
        1
# 935 "project/radare2/libr/util/sys.c"
            ;
 }
 if ((ptr = strstr (archstr, arch))) {
  ...
  if (!p || p==',') {
   return 
# 940 "project/radare2/libr/util/sys.c" 3 4
         1
# 940 "project/radare2/libr/util/sys.c"
             ;
  }
 }
 return 
# 943 "project/radare2/libr/util/sys.c" 3 4
       0
# 943 "project/radare2/libr/util/sys.c"
            ;
}


# 946 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 946 "project/radare2/libr/util/sys.c"
...
# 956 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 956 "project/radare2/libr/util/sys.c"
     const char *r_sys_arch_str(int arch) {
 int i;
 for (i = 0; arch_bit_array[i].name; i++) {
...
# 967 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 967 "project/radare2/libr/util/sys.c"
     int r_sys_run(const 
# 967 "project/radare2/libr/util/sys.c" 3 4
                         unsigned char 
# 967 "project/radare2/libr/util/sys.c"
...
# 974 "project/radare2/libr/util/sys.c" 3 4
unsigned char 
# 974 "project/radare2/libr/util/sys.c"
    *ptr, *p = malloc ((sz + len) << 1);
 ptr = p;
...
# 981 "project/radare2/libr/util/sys.c" 3 4
 fprintf(__stderrp,
# 981 "project/radare2/libr/util/sys.c"
 "r_sys_run: Cannot run empty buffer\n"
# 981 "project/radare2/libr/util/sys.c" 3 4
 )
# 981 "project/radare2/libr/util/sys.c"
                                                 ;
  free (p);
  return 
# 983 "project/radare2/libr/util/sys.c" 3 4
        0
# 983 "project/radare2/libr/util/sys.c"
             ;
 }
 
# 985 "project/radare2/libr/util/sys.c" 3 4
__builtin___memcpy_chk (
# 985 "project/radare2/libr/util/sys.c"
ptr
# 985 "project/radare2/libr/util/sys.c" 3 4
, 
# 985 "project/radare2/libr/util/sys.c"
...
# 985 "project/radare2/libr/util/sys.c"
 ...
 cb = (int (*)())ptr;
# 1013 "project/radare2/libr/util/sys.c"
 ret = (*cb) ();
...
# 1019 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 1019 "project/radare2/libr/util/sys.c"
     int r_sys_run_rop(const 
# 1019 "project/radare2/libr/util/sys.c" 3 4
                             unsigned char 
# 1019 "project/radare2/libr/util/sys.c"
                                 *buf, int len) {
...
# 1024 "project/radare2/libr/util/sys.c" 3 4
unsigned char 
# 1024 "project/radare2/libr/util/sys.c"
    *bufptr = malloc (len);
 if (!bufptr) {
  
# 1026 "project/radare2/libr/util/sys.c" 3 4
 fprintf(__stderrp,
# 1026 "project/radare2/libr/util/sys.c"
 "r_sys_run_rop: Cannot allocate buffer\n"
# 1026 "project/radare2/libr/util/sys.c" 3 4
 )
# 1026 "project/radare2/libr/util/sys.c"
                                                    ;
  return 
# 1027 "project/radare2/libr/util/sys.c" 3 4
        0
# 1027 "project/radare2/libr/util/sys.c"
             ;
 }

 if (!buf) {
  
# 1031 "project/radare2/libr/util/sys.c" 3 4
 fprintf(__stderrp,
# 1031 "project/radare2/libr/util/sys.c"
 "r_sys_run_rop: Cannot execute empty rop chain\n"
# 1031 "project/radare2/libr/util/sys.c" 3 4
 )
# 1031 "project/radare2/libr/util/sys.c"
                                                            ;
  free (bufptr);
  return 
# 1033 "project/radare2/libr/util/sys.c" 3 4
        0
# 1033 "project/radare2/libr/util/sys.c"
             ;
 }
 
# 1035 "project/radare2/libr/util/sys.c" 3 4
__builtin___memcpy_chk (
# 1035 "project/radare2/libr/util/sys.c"
bufptr
# 1035 "project/radare2/libr/util/sys.c" 3 4
, 
# 1035 "project/radare2/libr/util/sys.c"
...
# 1035 "project/radare2/libr/util/sys.c"
                         ;
# 1063 "project/radare2/libr/util/sys.c"
 __asm__ __volatile__ ("leaq %0, %%rsp; ret" : : "m" (*bufptr));;

 free (bufptr);
 return 0;
}
# 1152 "project/radare2/libr/util/sys.c"

# 1152 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 1152 "project/radare2/libr/util/sys.c"
     char *r_sys_pid_to_path(int pid) {
# 1167 "project/radare2/libr/util/sys.c"
 char pathbuf[1024];
 pathbuf[0] = 0;
 int ret = proc_pidpath (pid, pathbuf, sizeof (pathbuf));
 if (ret <= 0) {
  return 
# 1171 "project/radare2/libr/util/sys.c" 3 4
        ((void *)0)
# 1171 "project/radare2/libr/util/sys.c"
            ;
 }
 return strdup (pathbuf);
# 1212 "project/radare2/libr/util/sys.c"
}


# 1214 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 1214 "project/radare2/libr/util/sys.c"
     void r_sys_env_init(void) {
...
# 1221 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 1221 "project/radare2/libr/util/sys.c"
     char **r_sys_get_environ(void) {
 ...
 if (!env) {
  env = r_lib_dl_sym (
# 1229 "project/radare2/libr/util/sys.c" 3 4
                     ((void *)0)
# 1229 "project/radare2/libr/util/sys.c"
                         , "environ");
 }
 return env;
}
...
# 1234 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 1234 "project/radare2/libr/util/sys.c"
     void r_sys_set_environ(char **e) {
 env = e;
}


# 1238 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 1238 "project/radare2/libr/util/sys.c"
     char *r_sys_whoami(void) {
 char buf[32];
# 1248 "project/radare2/libr/util/sys.c"
...
# 1253 "project/radare2/libr/util/sys.c" 3 4
__builtin___snprintf_chk (
# 1253 "project/radare2/libr/util/sys.c"
buf
# 1253 "project/radare2/libr/util/sys.c" 3 4
, 
# 1253 "project/radare2/libr/util/sys.c"
...
# 1258 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 1258 "project/radare2/libr/util/sys.c"
     int r_sys_uid(void) {
# 1271 "project/radare2/libr/util/sys.c"
 return getuid ();

}


# 1275 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 1275 "project/radare2/libr/util/sys.c"
...
# 1288 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 1288 "project/radare2/libr/util/sys.c"
          r_sys_tts(const char *txt, 
# 1288 "project/radare2/libr/util/sys.c" 3 4
                                     _Bool 
# 1288 "project/radare2/libr/util/sys.c"
                                          bg) {
...
# 1290 "project/radare2/libr/util/sys.c" 3 4
do { if (!(
# 1290 "project/radare2/libr/util/sys.c"
txt
# 1290 "project/radare2/libr/util/sys.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1290 "project/radare2/libr/util/sys.c"
"txt"
# 1290 "project/radare2/libr/util/sys.c" 3 4
, 1290); return (0); } } while (0)
# 1290 "project/radare2/libr/util/sys.c"
                                 ;
 const char *says[] = {
  "say", "termux-tts-speak", 
# 1292 "project/radare2/libr/util/sys.c" 3 4
                            ((void *)0)
 
# 1293 "project/radare2/libr/util/sys.c"
};
 for (i = 0; says[i]; i++) {
  ...
  if (sayPath) {
   ...
   free (sayPath);
   return 
# 1301 "project/radare2/libr/util/sys.c" 3 4
         1
# 1301 "project/radare2/libr/util/sys.c"
             ;
  }
 }
 return 
# 1304 "project/radare2/libr/util/sys.c" 3 4
       0
# 1304 "project/radare2/libr/util/sys.c"
            ;
}


# 1307 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 1307 "project/radare2/libr/util/sys.c"
     const char *r_sys_prefix(const char *pfx) {
 static char *prefix = 
# 1308 "project/radare2/libr/util/sys.c" 3 4
                      ((void *)0)
# 1308 "project/radare2/libr/util/sys.c"
                          ;
 if (!prefix) {
  ...
  prefix = strdup (
# 1316 "project/radare2/libr/util/sys.c" 3 4
                  "/usr/local"
# 1316 "project/radare2/libr/util/sys.c"
                           );
...
# 1326 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 1326 "project/radare2/libr/util/sys.c"
     RSysInfo *r_sys_info(void) {

 struct utsname un = {{0}};
 if (uname (&un) != -1) {
  RSysInfo *si = 
# 1330 "project/radare2/libr/util/sys.c" 3 4
                (
# 1330 "project/radare2/libr/util/sys.c"
                RSysInfo
# 1330 "project/radare2/libr/util/sys.c" 3 4
                *)calloc(1,sizeof(
# 1330 "project/radare2/libr/util/sys.c"
...
# 1399 "project/radare2/libr/util/sys.c"
 return 
# 1399 "project/radare2/libr/util/sys.c" 3 4
       ((void *)0)
# 1399 "project/radare2/libr/util/sys.c"
           ;
}
...
# 1402 "project/radare2/libr/util/sys.c" 3 4
__attribute__((visibility("default"))) 
# 1402 "project/radare2/libr/util/sys.c"
     void r_sys_info_free(RSysInfo *si) {
 free (si->sysname);
 free (si->nodename);
 free (si->release);
 free (si->version);
