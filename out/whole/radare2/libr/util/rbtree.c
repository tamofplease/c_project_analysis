# 0 "project/radare2/libr/util/rbtree.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/rbtree.c"
...
# 4 "project/radare2/libr/util/rbtree.c" 2
...
# 6 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_rbtree.h" 2 3 4
...
# 9 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_rbtree.h" 2 3 4
...
# 6 "project/radare2/libr/util/rbtree.c" 2
...
# 7 "project/radare2/libr/util/rbtree.c" 2


# 8 "project/radare2/libr/util/rbtree.c"
static inline 
# 8 "project/radare2/libr/util/rbtree.c" 3 4
             _Bool 
# 8 "project/radare2/libr/util/rbtree.c"
                  red(RBNode *x) {
 return x && x->red;
...
static inline RBNode *zag(RBNode *x, int dir, RBNodeSum sum) {
 ...
 x->parent = y;
 x->red = 
# 20 "project/radare2/libr/util/rbtree.c" 3 4
         1
# 20 "project/radare2/libr/util/rbtree.c"
             ;
 y->red = 
# 21 "project/radare2/libr/util/rbtree.c" 3 4
         0
# 21 "project/radare2/libr/util/rbtree.c"
              ;
 if (sum) {
  sum (x);
 }
...
static inline RBNode *zig_zag(RBNode *x, int dir, RBNodeSum sum) {
 ...
 x->parent = z;
 x->red = y->red = 
# 42 "project/radare2/libr/util/rbtree.c" 3 4
                  1
# 42 "project/radare2/libr/util/rbtree.c"
                      ;
 z->red = 
# 43 "project/radare2/libr/util/rbtree.c" 3 4
         0
# 43 "project/radare2/libr/util/rbtree.c"
              ;
 if (sum) {
  sum (x);
  sum (y);
...
static inline RBIter bound_iter(RBNode *x, void *data, RBComparator cmp, 
# 51 "project/radare2/libr/util/rbtree.c" 3 4
                                                                        _Bool 
# 51 "project/radare2/libr/util/rbtree.c"
                                                                             upper, void *user) {
 RBIter it;
 it.len = 0;
 
# 54 "project/radare2/libr/util/rbtree.c" 3 4
__builtin___memset_chk (
# 54 "project/radare2/libr/util/rbtree.c"
it.path
# 54 "project/radare2/libr/util/rbtree.c" 3 4
, 
# 54 "project/radare2/libr/util/rbtree.c"
...
# 102 "project/radare2/libr/util/rbtree.c"

# 102 "project/radare2/libr/util/rbtree.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 102 "project/radare2/libr/util/rbtree.c"
          r_rbtree_aug_delete(RBNode **root, void *data, RBComparator cmp, void *cmp_user, RBNodeFree freefn, void *free_user, RBNodeSum sum) {
 RBNode head, *del = 
# 103 "project/radare2/libr/util/rbtree.c" 3 4
                    ((void *)0)
# 103 "project/radare2/libr/util/rbtree.c"
                        , **del_link = 
# 103 "project/radare2/libr/util/rbtree.c" 3 4
                                       ((void *)0)
# 103 "project/radare2/libr/util/rbtree.c"
...
# 103 "project/radare2/libr/util/rbtree.c"
 ...
 head.parent = head.child[0] = 
# 105 "project/radare2/libr/util/rbtree.c" 3 4
                              ((void *)0)
# 105 "project/radare2/libr/util/rbtree.c"
                                  ;
 head.child[1] = *root;
 while (q->child[direction]) {
  ...
  if (q != &head) {
   if (depth >= 
# 124 "project/radare2/libr/util/rbtree.c" 3 4
               62
# 124 "project/radare2/libr/util/rbtree.c"
                                  ) {
    
# 125 "project/radare2/libr/util/rbtree.c" 3 4
   fprintf(__stderrp,
# 125 "project/radare2/libr/util/rbtree.c"
   "Too deep tree\n"
# 125 "project/radare2/libr/util/rbtree.c" 3 4
   )
# 125 "project/radare2/libr/util/rbtree.c"
  ...
  if (red (q->child[!direction])) {
   ...
   p = p->child[direction2];
   if (depth >= 
# 141 "project/radare2/libr/util/rbtree.c" 3 4
               62
# 141 "project/radare2/libr/util/rbtree.c"
                                  ) {
    
# 142 "project/radare2/libr/util/rbtree.c" 3 4
   fprintf(__stderrp,
# 142 "project/radare2/libr/util/rbtree.c"
   "Too deep tree\n"
# 142 "project/radare2/libr/util/rbtree.c" 3 4
   )
# 142 "project/radare2/libr/util/rbtree.c"
   ...
   if (!red (s->child[0]) && !red (s->child[1])) {
    p->red = 
# 152 "project/radare2/libr/util/rbtree.c" 3 4
            0
# 152 "project/radare2/libr/util/rbtree.c"
                 ;
    q->red = s->red = 
# 153 "project/radare2/libr/util/rbtree.c" 3 4
                     1
# 153 "project/radare2/libr/util/rbtree.c"
                         ;
   } else {
    ...
    t->red = q->red = 
# 168 "project/radare2/libr/util/rbtree.c" 3 4
                     1
# 168 "project/radare2/libr/util/rbtree.c"
                         ;
    t->child[0]->red = t->child[1]->red = 
# 169 "project/radare2/libr/util/rbtree.c" 3 4
                                         0
# 169 "project/radare2/libr/util/rbtree.c"
                                              ;
    g->child[direction3] = t;
    t->parent = g;
    if (depth >= 
# 172 "project/radare2/libr/util/rbtree.c" 3 4
                62
# 172 "project/radare2/libr/util/rbtree.c"
                                   ) {
     
# 173 "project/radare2/libr/util/rbtree.c" 3 4
    fprintf(__stderrp,
# 173 "project/radare2/libr/util/rbtree.c"
    "Too deep tree\n"
# 173 "project/radare2/libr/util/rbtree.c" 3 4
    )
# 173 "project/radare2/libr/util/rbtree.c"
 ...
 if (del_link) {
  del = *del_link;
  if (q->child[q->child[0] == 
# 183 "project/radare2/libr/util/rbtree.c" 3 4
                             ((void *)0)
# 183 "project/radare2/libr/util/rbtree.c"
                                 ]) {
   q->child[q->child[0] == 
# 184 "project/radare2/libr/util/rbtree.c" 3 4
                          ((void *)0)
# 184 "project/radare2/libr/util/rbtree.c"
                              ]->parent = p;
  }
  p->child[q != p->child[0]] = q->child[q->child[0] == 
# 186 "project/radare2/libr/util/rbtree.c" 3 4
                                                      ((void *)0)
# 186 "project/radare2/libr/util/rbtree.c"
                                                          ];
  if (del != q) {
   *q = *del;
   *del_link = q;
 ...
 if (sum) {
  if (depth >= 
# 196 "project/radare2/libr/util/rbtree.c" 3 4
              62
# 196 "project/radare2/libr/util/rbtree.c"
                                 ) {
   
# 197 "project/radare2/libr/util/rbtree.c" 3 4
  fprintf(__stderrp,
# 197 "project/radare2/libr/util/rbtree.c"
  "Too deep tree\n"
# 197 "project/radare2/libr/util/rbtree.c" 3 4
  )
# 197 "project/radare2/libr/util/rbtree.c"
 ...
 if ((*root = head.child[1])) {
  (*root)->red = 
# 205 "project/radare2/libr/util/rbtree.c" 3 4
                0
# 205 "project/radare2/libr/util/rbtree.c"
                     ;
  (*root)->parent = 
# 206 "project/radare2/libr/util/rbtree.c" 3 4
                   ((void *)0)
# 206 "project/radare2/libr/util/rbtree.c"
                       ;
 }
 return del;
}
...
# 212 "project/radare2/libr/util/rbtree.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 212 "project/radare2/libr/util/rbtree.c"
          r_rbtree_aug_insert(RBNode **root, void *data, RBNode *node, RBComparator cmp, void *cmp_user, RBNodeSum sum) {
 node->parent = node->child[0] = node->child[1] = 
# 213 "project/radare2/libr/util/rbtree.c" 3 4
                                                 ((void *)0)
# 213 "project/radare2/libr/util/rbtree.c"
                                                     ;
 if (!*root) {
  *root = node;
  node->red = 
# 216 "project/radare2/libr/util/rbtree.c" 3 4
             0
# 216 "project/radare2/libr/util/rbtree.c"
                  ;
  if (sum) {
   sum (node);
  }
  return 
# 220 "project/radare2/libr/util/rbtree.c" 3 4
        1
# 220 "project/radare2/libr/util/rbtree.c"
            ;
 }
 RBNode *t = 
# 222 "project/radare2/libr/util/rbtree.c" 3 4
            ((void *)0)
# 222 "project/radare2/libr/util/rbtree.c"
                , *g = 
# 222 "project/radare2/libr/util/rbtree.c" 3 4
                       ((void *)0)
# 222 "project/radare2/libr/util/rbtree.c"
...
# 224 "project/radare2/libr/util/rbtree.c" 3 4
_Bool 
# 224 "project/radare2/libr/util/rbtree.c"
     done = 
# 224 "project/radare2/libr/util/rbtree.c" 3 4
            0
# 224 "project/radare2/libr/util/rbtree.c"
                 ;
 RBNode *path[
# 225 "project/radare2/libr/util/rbtree.c" 3 4
             62
# 225 "project/radare2/libr/util/rbtree.c"
                                ];
 for (;;) {
  if (!q) {
   q = node;
   q->red = 
# 229 "project/radare2/libr/util/rbtree.c" 3 4
           1
# 229 "project/radare2/libr/util/rbtree.c"
               ;
   p->child[direction] = q;
   q->parent = p;
   done = 
# 232 "project/radare2/libr/util/rbtree.c" 3 4
         1
# 232 "project/radare2/libr/util/rbtree.c"
             ;
  } else if (red (q->child[0]) && red (q->child[1])) {
   q->child[0]->red = q->child[1]->red = 
# 234 "project/radare2/libr/util/rbtree.c" 3 4
                                        0
# 234 "project/radare2/libr/util/rbtree.c"
                                             ;
   if (q != *root) {
    q->red = 
# 236 "project/radare2/libr/util/rbtree.c" 3 4
            1
# 236 "project/radare2/libr/util/rbtree.c"
                ;
   }
  }
  if (q->red && p && p->red) {
    ...
    *root = g;
    g->parent = 
# 255 "project/radare2/libr/util/rbtree.c" 3 4
               ((void *)0)
# 255 "project/radare2/libr/util/rbtree.c"
                   ;
   }
  }
  if (done) {
  ...
  p = q;
  if (depth >= 
# 265 "project/radare2/libr/util/rbtree.c" 3 4
              62
# 265 "project/radare2/libr/util/rbtree.c"
                                 ) {
   
# 266 "project/radare2/libr/util/rbtree.c" 3 4
  fprintf(__stderrp,
# 266 "project/radare2/libr/util/rbtree.c"
  "Too deep tree\n"
# 266 "project/radare2/libr/util/rbtree.c" 3 4
  )
# 266 "project/radare2/libr/util/rbtree.c"
...
# 288 "project/radare2/libr/util/rbtree.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 288 "project/radare2/libr/util/rbtree.c"
          r_rbtree_aug_update_sum(RBNode *root, void *data, RBNode *node, RBComparator cmp, void *cmp_user, RBNodeSum sum) {
 size_t depth = 0;
 RBNode *path[
# 290 "project/radare2/libr/util/rbtree.c" 3 4
             62
# 290 "project/radare2/libr/util/rbtree.c"
                                ];
 RBNode *cur = root;
 for (;;) {
  if (!cur) {
   return 
# 294 "project/radare2/libr/util/rbtree.c" 3 4
         0
# 294 "project/radare2/libr/util/rbtree.c"
              ;
  }
  if (depth >= 
# 296 "project/radare2/libr/util/rbtree.c" 3 4
              62
# 296 "project/radare2/libr/util/rbtree.c"
                                 ) {
   
# 297 "project/radare2/libr/util/rbtree.c" 3 4
  fprintf(__stderrp,
# 297 "project/radare2/libr/util/rbtree.c"
  "Too deep tree\n"
# 297 "project/radare2/libr/util/rbtree.c" 3 4
  )
# 297 "project/radare2/libr/util/rbtree.c"
                             ;
   return 
# 298 "project/radare2/libr/util/rbtree.c" 3 4
         0
# 298 "project/radare2/libr/util/rbtree.c"
              ;
  }
  path[depth] = cur;
  depth++;
 ...
 return 
# 312 "project/radare2/libr/util/rbtree.c" 3 4
       1
# 312 "project/radare2/libr/util/rbtree.c"
           ;
}


# 315 "project/radare2/libr/util/rbtree.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 315 "project/radare2/libr/util/rbtree.c"
          r_rbtree_delete(RBNode **root, void *data, RBComparator cmp, void *cmp_user, RBNodeFree freefn, void *free_user) {
 return r_rbtree_aug_delete (root, data, cmp, cmp_user, freefn, free_user, 
# 316 "project/radare2/libr/util/rbtree.c" 3 4
                                                                          ((void *)0)
# 316 "project/radare2/libr/util/rbtree.c"
                                                                              );
}


# 319 "project/radare2/libr/util/rbtree.c" 3 4
__attribute__((visibility("default"))) 
# 319 "project/radare2/libr/util/rbtree.c"
     RBNode *r_rbtree_find(RBNode *x, void *data, RBComparator cmp, void *user) {
 while (x) {
 ...
 return 
# 330 "project/radare2/libr/util/rbtree.c" 3 4
       ((void *)0)
# 330 "project/radare2/libr/util/rbtree.c"
           ;
}


# 333 "project/radare2/libr/util/rbtree.c" 3 4
__attribute__((visibility("default"))) 
# 333 "project/radare2/libr/util/rbtree.c"
     void r_rbtree_free(RBNode *x, RBNodeFree freefn, void *user) {
 if (x) {
...
# 341 "project/radare2/libr/util/rbtree.c" 3 4
__attribute__((visibility("default"))) 
# 341 "project/radare2/libr/util/rbtree.c"
     void r_rbtree_insert(RBNode **root, void *data, RBNode *node, RBComparator cmp, void *user) {
 r_rbtree_aug_insert (root, data, node, cmp, user, 
# 342 "project/radare2/libr/util/rbtree.c" 3 4
                                                  ((void *)0)
# 342 "project/radare2/libr/util/rbtree.c"
                                                      );
}


# 345 "project/radare2/libr/util/rbtree.c" 3 4
__attribute__((visibility("default"))) 
# 345 "project/radare2/libr/util/rbtree.c"
     RBNode *r_rbtree_lower_bound(RBNode *x, void *data, RBComparator cmp, void *user) {
 RBNode *ret = 
# 346 "project/radare2/libr/util/rbtree.c" 3 4
              ((void *)0)
# 346 "project/radare2/libr/util/rbtree.c"
                  ;
 while (x) {
  int direction = cmp (data, x, user);
  if (direction <= 0) {
...
# 359 "project/radare2/libr/util/rbtree.c" 3 4
__attribute__((visibility("default"))) 
# 359 "project/radare2/libr/util/rbtree.c"
     RBIter r_rbtree_lower_bound_forward(RBNode *root, void *data, RBComparator cmp, void *user) {
 return bound_iter (root, data, cmp, 
# 360 "project/radare2/libr/util/rbtree.c" 3 4
                                    0
# 360 "project/radare2/libr/util/rbtree.c"
                                         , user);
}


# 363 "project/radare2/libr/util/rbtree.c" 3 4
__attribute__((visibility("default"))) 
# 363 "project/radare2/libr/util/rbtree.c"
     RBNode *r_rbtree_upper_bound(RBNode *x, void *data, RBComparator cmp, void *user) {
 void *ret = 
# 364 "project/radare2/libr/util/rbtree.c" 3 4
            ((void *)0)
# 364 "project/radare2/libr/util/rbtree.c"
                ;
 while (x) {
  int direction = cmp (data, x, user);
  if (direction < 0) {
...
# 377 "project/radare2/libr/util/rbtree.c" 3 4
__attribute__((visibility("default"))) 
# 377 "project/radare2/libr/util/rbtree.c"
     RBIter r_rbtree_upper_bound_backward(RBNode *root, void *data, RBComparator cmp, void *user) {
 return bound_iter (root, data, cmp, 
# 378 "project/radare2/libr/util/rbtree.c" 3 4
                                    1
# 378 "project/radare2/libr/util/rbtree.c"
                                        , user);
}
...
# 390 "project/radare2/libr/util/rbtree.c" 3 4
__attribute__((visibility("default"))) 
# 390 "project/radare2/libr/util/rbtree.c"
     RBIter r_rbtree_first(RBNode *tree) {
 return _first (tree, 0);
}


# 394 "project/radare2/libr/util/rbtree.c" 3 4
__attribute__((visibility("default"))) 
# 394 "project/radare2/libr/util/rbtree.c"
     RBIter r_rbtree_last(RBNode *tree) {
...
# 405 "project/radare2/libr/util/rbtree.c" 3 4
__attribute__((visibility("default"))) 
# 405 "project/radare2/libr/util/rbtree.c"
     void r_rbtree_iter_next(RBIter *it) {
 _next (it, 0);
}


# 409 "project/radare2/libr/util/rbtree.c" 3 4
__attribute__((visibility("default"))) 
# 409 "project/radare2/libr/util/rbtree.c"
     void r_rbtree_iter_prev(RBIter *it) {
 _next (it, 1);
}
