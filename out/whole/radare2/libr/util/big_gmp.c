# 0 "project/radare2/libr/util/big_gmp.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/big_gmp.c"
...
# 2 "project/radare2/libr/util/big_gmp.c" 2

__attribute__((visibility("default"))) 
# 3 "project/radare2/libr/util/big_gmp.c"
     RNumBig *r_big_new(void) {
 RNumBig *n = 
# 4 "project/radare2/libr/util/big_gmp.c" 3 4
             (
# 4 "project/radare2/libr/util/big_gmp.c"
             RNumBig
# 4 "project/radare2/libr/util/big_gmp.c" 3 4
             *)malloc(sizeof(
# 4 "project/radare2/libr/util/big_gmp.c"
...
# 11 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 11 "project/radare2/libr/util/big_gmp.c"
...
# 16 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 16 "project/radare2/libr/util/big_gmp.c"
     void r_big_init(RNumBig *b) {
 mpz_init (*b);
}


# 20 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 20 "project/radare2/libr/util/big_gmp.c"
     void r_big_fini(RNumBig *b) {
 mpz_clear (*b);
}


# 24 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 24 "project/radare2/libr/util/big_gmp.c"
...
# 28 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) long long 
# 28 "project/radare2/libr/util/big_gmp.c"
          r_big_to_int(RNumBig *b) {
 return mpz_get_si (*b);
}


# 32 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 32 "project/radare2/libr/util/big_gmp.c"
...
# 43 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 43 "project/radare2/libr/util/big_gmp.c"
     char *r_big_to_hexstr(RNumBig *b) {
 char *tmp = mpz_get_str (
# 44 "project/radare2/libr/util/big_gmp.c" 3 4
                         ((void *)0)
# 44 "project/radare2/libr/util/big_gmp.c"
                             , 16, *b);
 char *res;
 if (tmp[0] == '-') {
...
# 55 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 55 "project/radare2/libr/util/big_gmp.c"
     void r_big_assign(RNumBig *dst, RNumBig *src) {
 mpz_set (*dst, *src);
}


# 59 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 59 "project/radare2/libr/util/big_gmp.c"
     void r_big_add(RNumBig *c, RNumBig *a, RNumBig *b) {
 mpz_add (*c, *a, *b);
}


# 63 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 63 "project/radare2/libr/util/big_gmp.c"
     void r_big_sub(RNumBig *c, RNumBig *a, RNumBig *b) {
 mpz_sub (*c, *a, *b);
}


# 67 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 67 "project/radare2/libr/util/big_gmp.c"
     void r_big_mul(RNumBig *c, RNumBig *a, RNumBig *b) {
 mpz_mul (*c, *a, *b);
}


# 71 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 71 "project/radare2/libr/util/big_gmp.c"
     void r_big_div(RNumBig *c, RNumBig *a, RNumBig *b) {
 mpz_tdiv_q (*c, *a, *b);
}


# 75 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 75 "project/radare2/libr/util/big_gmp.c"
     void r_big_mod(RNumBig *c, RNumBig *a, RNumBig *b) {
 mpz_mod (*c, *a, *b);
}


# 79 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 79 "project/radare2/libr/util/big_gmp.c"
     void r_big_divmod(RNumBig *c, RNumBig *d, RNumBig *a, RNumBig *b) {
 mpz_tdiv_qr (*c, *d, *a, *b);
}


# 83 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 83 "project/radare2/libr/util/big_gmp.c"
     void r_big_and(RNumBig *c, RNumBig *a, RNumBig *b) {
 mpz_and (*c, *a, *b);
}


# 87 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 87 "project/radare2/libr/util/big_gmp.c"
     void r_big_or(RNumBig *c, RNumBig *a, RNumBig *b) {
 mpz_ior (*c, *a, *b);
}


# 91 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 91 "project/radare2/libr/util/big_gmp.c"
     void r_big_xor(RNumBig *c, RNumBig *a, RNumBig *b) {
 mpz_xor (*c, *a, *b);
}


# 95 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 95 "project/radare2/libr/util/big_gmp.c"
     void r_big_lshift(RNumBig *c, RNumBig *a, size_t nbits) {
 mpz_mul_2exp (*c, *a, nbits);
}


# 99 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 99 "project/radare2/libr/util/big_gmp.c"
     void r_big_rshift(RNumBig *c, RNumBig *a, size_t nbits) {
 mpz_tdiv_q_2exp (*c, *a, nbits);
}


# 103 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 103 "project/radare2/libr/util/big_gmp.c"
...
# 114 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 114 "project/radare2/libr/util/big_gmp.c"
     int r_big_is_zero(RNumBig *a) {
 return mpz_cmp_ui (*a, 0) == 0;
}


# 118 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 118 "project/radare2/libr/util/big_gmp.c"
...
# 124 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 124 "project/radare2/libr/util/big_gmp.c"
...
# 130 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 130 "project/radare2/libr/util/big_gmp.c"
     void r_big_powm(RNumBig *c, RNumBig *a, RNumBig *b, RNumBig *m) {
 mpz_powm (*c, *a, *b, *m);
}


# 134 "project/radare2/libr/util/big_gmp.c" 3 4
__attribute__((visibility("default"))) 
# 134 "project/radare2/libr/util/big_gmp.c"
     void r_big_isqrt(RNumBig *c, RNumBig *a) {
 mpz_sqrt (*c, *a);
}
