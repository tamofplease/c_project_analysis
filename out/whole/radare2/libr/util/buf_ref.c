# 0 "project/radare2/libr/util/buf_ref.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/buf_ref.c"
...
# 4 "project/radare2/libr/util/buf_ref.c" 2


# 5 "project/radare2/libr/util/buf_ref.c"
struct buf_ref_user {
 RBuffer *parent;
 
# 7 "project/radare2/libr/util/buf_ref.c" 3 4
unsigned long long 
# 7 "project/radare2/libr/util/buf_ref.c"
     offset;
 
# 8 "project/radare2/libr/util/buf_ref.c" 3 4
unsigned long long 
# 8 "project/radare2/libr/util/buf_ref.c"
     size;
};
...
# 13 "project/radare2/libr/util/buf_ref.c" 3 4
unsigned long long 
# 13 "project/radare2/libr/util/buf_ref.c"
     cur;
 
# 14 "project/radare2/libr/util/buf_ref.c" 3 4
unsigned long long 
# 14 "project/radare2/libr/util/buf_ref.c"
     base;
 
# 15 "project/radare2/libr/util/buf_ref.c" 3 4
unsigned long long 
# 15 "project/radare2/libr/util/buf_ref.c"
     size;
};
...
# 20 "project/radare2/libr/util/buf_ref.c" 3 4
do { if (!(
# 20 "project/radare2/libr/util/buf_ref.c"
priv
# 20 "project/radare2/libr/util/buf_ref.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "WARNING (%s:%d):%s%s runtime check failed: (%s)\n", "project/radare2/libr/util/buf_ref.c", 20, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : "", 
# 20 "project/radare2/libr/util/buf_ref.c"
"priv"
# 20 "project/radare2/libr/util/buf_ref.c" 3 4
); } } while (0)
...
static 
# 24 "project/radare2/libr/util/buf_ref.c" 3 4
      _Bool 
# 24 "project/radare2/libr/util/buf_ref.c"
           buf_ref_init(RBuffer *b, const void *user) {
 const struct buf_ref_user *u = (const struct buf_ref_user *)user;
 struct buf_ref_priv *priv = 
# 26 "project/radare2/libr/util/buf_ref.c" 3 4
                            (
# 26 "project/radare2/libr/util/buf_ref.c"
                            struct buf_ref_priv
# 26 "project/radare2/libr/util/buf_ref.c" 3 4
                            *)calloc(1,sizeof(
# 26 "project/radare2/libr/util/buf_ref.c"
...
# 26 "project/radare2/libr/util/buf_ref.c"
 ...
 if (!priv) {
  return 
# 28 "project/radare2/libr/util/buf_ref.c" 3 4
        0
# 28 "project/radare2/libr/util/buf_ref.c"
             ;
 }
...
# 34 "project/radare2/libr/util/buf_ref.c" 3 4
unsigned long long 
# 34 "project/radare2/libr/util/buf_ref.c"
     parent_sz = r_buf_size (u->parent);
 b->readonly = 
# 35 "project/radare2/libr/util/buf_ref.c" 3 4
              1
# 35 "project/radare2/libr/util/buf_ref.c"
                  ;
 priv->parent = r_buf_ref (u->parent);
 priv->base = 
# 37 "project/radare2/libr/util/buf_ref.c" 3 4
             (((
# 37 "project/radare2/libr/util/buf_ref.c"
             u->offset
# 37 "project/radare2/libr/util/buf_ref.c" 3 4
             )>(
# 37 "project/radare2/libr/util/buf_ref.c"
...
# 37 "project/radare2/libr/util/buf_ref.c"
                                         ;
 priv->size = 
# 38 "project/radare2/libr/util/buf_ref.c" 3 4
             (((
# 38 "project/radare2/libr/util/buf_ref.c"
             parent_sz - priv->base
# 38 "project/radare2/libr/util/buf_ref.c" 3 4
             )>(
# 38 "project/radare2/libr/util/buf_ref.c"
...
# 38 "project/radare2/libr/util/buf_ref.c"
 ...
 b->priv = priv;
 return 
# 40 "project/radare2/libr/util/buf_ref.c" 3 4
       1
# 40 "project/radare2/libr/util/buf_ref.c"
           ;
}

static 
# 43 "project/radare2/libr/util/buf_ref.c" 3 4
      _Bool 
# 43 "project/radare2/libr/util/buf_ref.c"
           buf_ref_fini(RBuffer *b) {
 struct buf_ref_priv *priv = get_priv_ref (b);
 r_buf_free (priv->parent);
 
# 46 "project/radare2/libr/util/buf_ref.c" 3 4
{ free((void *)
# 46 "project/radare2/libr/util/buf_ref.c"
b->priv
# 46 "project/radare2/libr/util/buf_ref.c" 3 4
); 
# 46 "project/radare2/libr/util/buf_ref.c"
...
# 46 "project/radare2/libr/util/buf_ref.c"
                ;
 return 
# 47 "project/radare2/libr/util/buf_ref.c" 3 4
       1
# 47 "project/radare2/libr/util/buf_ref.c"
           ;
}

static 
# 50 "project/radare2/libr/util/buf_ref.c" 3 4
      _Bool 
# 50 "project/radare2/libr/util/buf_ref.c"
           buf_ref_resize(RBuffer *b, 
# 50 "project/radare2/libr/util/buf_ref.c" 3 4
                                      unsigned long long 
# 50 "project/radare2/libr/util/buf_ref.c"
                                           newsize) {
...
# 52 "project/radare2/libr/util/buf_ref.c" 3 4
unsigned long long 
# 52 "project/radare2/libr/util/buf_ref.c"
     parent_sz = r_buf_size (priv->parent);
 priv->size = 
# 53 "project/radare2/libr/util/buf_ref.c" 3 4
             (((
# 53 "project/radare2/libr/util/buf_ref.c"
             parent_sz - priv->base
# 53 "project/radare2/libr/util/buf_ref.c" 3 4
             )>(
# 53 "project/radare2/libr/util/buf_ref.c"
...
# 53 "project/radare2/libr/util/buf_ref.c"
                                                    ;
 return 
# 54 "project/radare2/libr/util/buf_ref.c" 3 4
       1
# 54 "project/radare2/libr/util/buf_ref.c"
           ;
}

static 
# 57 "project/radare2/libr/util/buf_ref.c" 3 4
      long long 
# 57 "project/radare2/libr/util/buf_ref.c"
           buf_ref_read(RBuffer *b, 
# 57 "project/radare2/libr/util/buf_ref.c" 3 4
                                    unsigned char 
# 57 "project/radare2/libr/util/buf_ref.c"
                                        *buf, 
...
# 57 "project/radare2/libr/util/buf_ref.c"
 ...
 len = 
# 62 "project/radare2/libr/util/buf_ref.c" 3 4
      (((
# 62 "project/radare2/libr/util/buf_ref.c"
      len
# 62 "project/radare2/libr/util/buf_ref.c" 3 4
      )>(
# 62 "project/radare2/libr/util/buf_ref.c"
...
# 63 "project/radare2/libr/util/buf_ref.c" 3 4
long long 
# 63 "project/radare2/libr/util/buf_ref.c"
     r = r_buf_read_at (priv->parent, priv->base + priv->cur, buf, len);
 if (r < 0) {
  return r;
 }
 priv->cur += r;
...
static 
# 71 "project/radare2/libr/util/buf_ref.c" 3 4
      unsigned long long 
# 71 "project/radare2/libr/util/buf_ref.c"
           buf_ref_get_size(RBuffer *b) {
 struct buf_ref_priv *priv = get_priv_ref (b);
 return priv->size;
}

static 
# 76 "project/radare2/libr/util/buf_ref.c" 3 4
      long long 
# 76 "project/radare2/libr/util/buf_ref.c"
           buf_ref_seek(RBuffer *b, 
# 76 "project/radare2/libr/util/buf_ref.c" 3 4
                                    long long 
# 76 "project/radare2/libr/util/buf_ref.c"
                                         addr, int whence) {
 ...
 switch (whence) {
 case 
# 79 "project/radare2/libr/util/buf_ref.c" 3 4
     1
# 79 "project/radare2/libr/util/buf_ref.c"
              :
  priv->cur += addr;
  break;
 case 
# 82 "project/radare2/libr/util/buf_ref.c" 3 4
     0
# 82 "project/radare2/libr/util/buf_ref.c"
              :
  priv->cur = addr;
  break;
 case 
# 85 "project/radare2/libr/util/buf_ref.c" 3 4
     2
# 85 "project/radare2/libr/util/buf_ref.c"
              :
  priv->cur = priv->size + addr;
  break;
 default:
  
# 89 "project/radare2/libr/util/buf_ref.c" 3 4
 do { r_assert_log (R_LOGLVL_WARN, "(%s:%d):%s%s code should not be reached\n", "project/radare2/libr/util/buf_ref.c", 89, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : ""); } while (0)
# 89 "project/radare2/libr/util/buf_ref.c"
                     ;
  return -1;
 }
 return priv->cur;
