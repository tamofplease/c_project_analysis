# 0 "project/radare2/libr/util/lib.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/lib.c"
...
# 4 "project/radare2/libr/util/lib.c" 2
...
# 5 "project/radare2/libr/util/lib.c" 2

__attribute__((visibility("default"))) const char *
# 6 "project/radare2/libr/util/lib.c"
r_lib_version
# 6 "project/radare2/libr/util/lib.c" 3 4
(void) { return "" "5.5.4"; }
# 6 "project/radare2/libr/util/lib.c"
                   ;
...
static 
# 10 "project/radare2/libr/util/lib.c" 3 4
      _Bool 
# 10 "project/radare2/libr/util/lib.c"
           __has_debug = 
# 10 "project/radare2/libr/util/lib.c" 3 4
                         0
# 10 "project/radare2/libr/util/lib.c"
...
static const char *r_lib_types[] = {
 ...
 "bp", "syscall", "fastcall", "crypto", "core", "egg", "fs", 
# 15 "project/radare2/libr/util/lib.c" 3 4
                                                            ((void *)0)

# 16 "project/radare2/libr/util/lib.c"
};
...
# 25 "project/radare2/libr/util/lib.c" 3 4
__attribute__((visibility("default"))) 
# 25 "project/radare2/libr/util/lib.c"
     int r_lib_types_get_i(const char *str) {
 int i;
...
# 35 "project/radare2/libr/util/lib.c" 3 4
__attribute__((visibility("default"))) 
# 35 "project/radare2/libr/util/lib.c"
     void *r_lib_dl_open(const char *libname) {
 void *ret = 
# 36 "project/radare2/libr/util/lib.c" 3 4
            ((void *)0)
# 36 "project/radare2/libr/util/lib.c"
                ;
 ...
 if (libname) {
  ...
  if (!ret) {
   ret = dlopen (libname, 
# 44 "project/radare2/libr/util/lib.c" 3 4
                         0x8 
# 44 "project/radare2/libr/util/lib.c"
                                     | 
# 44 "project/radare2/libr/util/lib.c" 3 4
                                       0x1
# 44 "project/radare2/libr/util/lib.c"
  ...
  ret = dlopen (
# 47 "project/radare2/libr/util/lib.c" 3 4
               ((void *)0)
# 47 "project/radare2/libr/util/lib.c"
                   , 
# 47 "project/radare2/libr/util/lib.c" 3 4
                     0x2
# 47 "project/radare2/libr/util/lib.c"
...
# 50 "project/radare2/libr/util/lib.c" 3 4
 fprintf(__stderrp,
# 50 "project/radare2/libr/util/lib.c"
 "r_lib_dl_open: error: %s (%s)\n", libname, dlerror ()
# 50 "project/radare2/libr/util/lib.c" 3 4
 )
# 50 "project/radare2/libr/util/lib.c"
                                                                 ;
 }
# 72 "project/radare2/libr/util/lib.c"
 return ret;
}


# 75 "project/radare2/libr/util/lib.c" 3 4
__attribute__((visibility("default"))) 
# 75 "project/radare2/libr/util/lib.c"
     void *r_lib_dl_sym(void *handler, const char *name) {


 return dlsym (handler, name);
# 87 "project/radare2/libr/util/lib.c"
}


# 89 "project/radare2/libr/util/lib.c" 3 4
__attribute__((visibility("default"))) 
# 89 "project/radare2/libr/util/lib.c"
     int r_lib_dl_close(void *handler) {
...
# 97 "project/radare2/libr/util/lib.c" 3 4
__attribute__((visibility("default"))) 
# 97 "project/radare2/libr/util/lib.c"
     char *r_lib_path(const char *libname) {
# 133 "project/radare2/libr/util/lib.c"
 ...
 do {
  ...
  char *libpath = r_str_newf ("%s"
# 148 "project/radare2/libr/util/lib.c" 3 4
                                 "/"
# 148 "project/radare2/libr/util/lib.c"
                                          "%s." 
# 148 "project/radare2/libr/util/lib.c" 3 4
                                                "dylib"
# 148 "project/radare2/libr/util/lib.c"
 ...
 free (env);
 return 
# 157 "project/radare2/libr/util/lib.c" 3 4
       ((void *)0)
# 157 "project/radare2/libr/util/lib.c"
           ;

}


# 161 "project/radare2/libr/util/lib.c" 3 4
__attribute__((visibility("default"))) 
# 161 "project/radare2/libr/util/lib.c"
     RLib *r_lib_new(const char *symname, const char *symnamefunc) {
 RLib *lib = 
# 162 "project/radare2/libr/util/lib.c" 3 4
            (
# 162 "project/radare2/libr/util/lib.c"
            RLib
# 162 "project/radare2/libr/util/lib.c" 3 4
            *)malloc(sizeof(
# 162 "project/radare2/libr/util/lib.c"
...
# 162 "project/radare2/libr/util/lib.c"
 ...
 if (lib) {
  ...
  lib->symname = strdup (symname? symname: 
# 168 "project/radare2/libr/util/lib.c" 3 4
                                          "radare_plugin"
# 168 "project/radare2/libr/util/lib.c"
                                                       );
  lib->symnamefunc = strdup (symnamefunc? symnamefunc: 
# 169 "project/radare2/libr/util/lib.c" 3 4
                                                      "radare_plugin_function"
# 169 "project/radare2/libr/util/lib.c"
                                                                   );
 }
 return lib;
}
...
# 174 "project/radare2/libr/util/lib.c" 3 4
__attribute__((visibility("default"))) 
# 174 "project/radare2/libr/util/lib.c"
     void r_lib_free(RLib *lib) {
 if (lib) {
  r_lib_close (lib, 
# 176 "project/radare2/libr/util/lib.c" 3 4
                   ((void *)0)
# 176 "project/radare2/libr/util/lib.c"
                       );
...
static 
# 185 "project/radare2/libr/util/lib.c" 3 4
      _Bool 
# 185 "project/radare2/libr/util/lib.c"
           __lib_dl_check_filename(const char *file) {
 return r_str_endswith (file, "." 
# 186 "project/radare2/libr/util/lib.c" 3 4
                                 "dylib"
# 186 "project/radare2/libr/util/lib.c"
                                          );
}


# 189 "project/radare2/libr/util/lib.c" 3 4
__attribute__((visibility("default"))) 
# 189 "project/radare2/libr/util/lib.c"
     int r_lib_run_handler(RLib *lib, RLibPlugin *plugin, RLibStruct *symbol) {
 RLibHandler *h = plugin->handler;
 if (h && h->constructor) {
  if(__has_debug) 
# 192 "project/radare2/libr/util/lib.c" 3 4
       fprintf(__stderrp,
# 192 "project/radare2/libr/util/lib.c"
       "PLUGIN LOADED %p fcn %p\n", h, h->constructor
# 192 "project/radare2/libr/util/lib.c" 3 4
       )
# 192 "project/radare2/libr/util/lib.c"
                                                               ;
 ...
 if(__has_debug) 
# 195 "project/radare2/libr/util/lib.c" 3 4
      fprintf(__stderrp,
# 195 "project/radare2/libr/util/lib.c"
      "Cannot find plugin constructor\n"
# 195 "project/radare2/libr/util/lib.c" 3 4
      )
# 195 "project/radare2/libr/util/lib.c"
                                                  ;
...
# 199 "project/radare2/libr/util/lib.c" 3 4
__attribute__((visibility("default"))) 
# 199 "project/radare2/libr/util/lib.c"
     RLibHandler *r_lib_get_handler(RLib *lib, int type) {
 RLibHandler *h;
 RListIter *iter;
 
# 202 "project/radare2/libr/util/lib.c" 3 4
if (
# 202 "project/radare2/libr/util/lib.c"
lib->handlers
# 202 "project/radare2/libr/util/lib.c" 3 4
) for (
# 202 "project/radare2/libr/util/lib.c"
...
# 202 "project/radare2/libr/util/lib.c"
 ...
 return 
# 207 "project/radare2/libr/util/lib.c" 3 4
       ((void *)0)
# 207 "project/radare2/libr/util/lib.c"
           ;
}


# 210 "project/radare2/libr/util/lib.c" 3 4
__attribute__((visibility("default"))) 
# 210 "project/radare2/libr/util/lib.c"
     int r_lib_close(RLib *lib, const char *file) {
 RLibPlugin *p;
 RListIter *iter, *iter2;
 
# 213 "project/radare2/libr/util/lib.c" 3 4
if (
# 213 "project/radare2/libr/util/lib.c"
lib->plugins
# 213 "project/radare2/libr/util/lib.c" 3 4
) for (
# 213 "project/radare2/libr/util/lib.c"
...
# 213 "project/radare2/libr/util/lib.c"
  ...
  if ((!file || !strcmp (file, p->file))) {
   ...
   if (file != 
# 224 "project/radare2/libr/util/lib.c" 3 4
              ((void *)0)
# 224 "project/radare2/libr/util/lib.c"
                  ) {
    return ret;
   }
  }
...
# 233 "project/radare2/libr/util/lib.c" 3 4
if (
# 233 "project/radare2/libr/util/lib.c"
lib->plugins
# 233 "project/radare2/libr/util/lib.c" 3 4
) for (
# 233 "project/radare2/libr/util/lib.c"
...
# 240 "project/radare2/libr/util/lib.c" 3 4
  fprintf(__stderrp,
# 240 "project/radare2/libr/util/lib.c"
  "Unloaded %s\n", p->file
# 240 "project/radare2/libr/util/lib.c" 3 4
  )
# 240 "project/radare2/libr/util/lib.c"
...
static 
# 249 "project/radare2/libr/util/lib.c" 3 4
      _Bool 
# 249 "project/radare2/libr/util/lib.c"
           __already_loaded(RLib *lib, const char *file) {
 const char *fileName = r_str_rstr (file, 
# 250 "project/radare2/libr/util/lib.c" 3 4
                                         "/"
# 250 "project/radare2/libr/util/lib.c"
                                                  );
 RLibPlugin *p;
 RListIter *iter;
 if (fileName) {
  
# 254 "project/radare2/libr/util/lib.c" 3 4
 if (
# 254 "project/radare2/libr/util/lib.c"
 lib->plugins
# 254 "project/radare2/libr/util/lib.c" 3 4
 ) for (
# 254 "project/radare2/libr/util/lib.c"
...
# 254 "project/radare2/libr/util/lib.c"
                                        {
   const char *pFileName = r_str_rstr (p->file, 
# 255 "project/radare2/libr/util/lib.c" 3 4
                                               "/"
# 255 "project/radare2/libr/util/lib.c"
                                                        );
   if (pFileName && !strcmp (fileName, pFileName)) {
    return 
# 257 "project/radare2/libr/util/lib.c" 3 4
          1
# 257 "project/radare2/libr/util/lib.c"
              ;
   }
  }
 }
 return 
# 261 "project/radare2/libr/util/lib.c" 3 4
       0
# 261 "project/radare2/libr/util/lib.c"
            ;
}


# 264 "project/radare2/libr/util/lib.c" 3 4
__attribute__((visibility("default"))) 
# 264 "project/radare2/libr/util/lib.c"
     int r_lib_open(RLib *lib, const char *file) {

 if (!__lib_dl_check_filename (file)) {
  
# 267 "project/radare2/libr/util/lib.c" 3 4
 fprintf(__stderrp,
# 267 "project/radare2/libr/util/lib.c"
 "Invalid library extension: %s\n", file
# 267 "project/radare2/libr/util/lib.c" 3 4
 )
# 267 "project/radare2/libr/util/lib.c"
                                                  ;
...
# 272 "project/radare2/libr/util/lib.c" 3 4
 fprintf(__stderrp,
# 272 "project/radare2/libr/util/lib.c"
...
# 272 "project/radare2/libr/util/lib.c"
 ...
 if (!handler) {
  if(__has_debug) 
# 278 "project/radare2/libr/util/lib.c" 3 4
       fprintf(__stderrp,
# 278 "project/radare2/libr/util/lib.c"
...
# 278 "project/radare2/libr/util/lib.c"
 ...
 RLibStruct *stru = 
# 283 "project/radare2/libr/util/lib.c" 3 4
                   ((void *)0)
# 283 "project/radare2/libr/util/lib.c"
                       ;
 if (strf) {
  stru = strf ();
 }
 ...
 if (!stru) {
  if(__has_debug) 
# 291 "project/radare2/libr/util/lib.c" 3 4
       fprintf(__stderrp,
# 291 "project/radare2/libr/util/lib.c"
       "Cannot find symbol '%s' in library '%s'\n", lib->symname, file
# 291 "project/radare2/libr/util/lib.c" 3 4
       )
                      
# 292 "project/radare2/libr/util/lib.c"
                     ;
...
# 316 "project/radare2/libr/util/lib.c" 3 4
__attribute__((visibility("default"))) 
# 316 "project/radare2/libr/util/lib.c"
     int r_lib_open_ptr(RLib *lib, const char *file, void *handler, RLibStruct *stru) {
 
# 317 "project/radare2/libr/util/lib.c" 3 4
do { if (!(
# 317 "project/radare2/libr/util/lib.c"
lib && file && stru
# 317 "project/radare2/libr/util/lib.c" 3 4
...
# 317 "project/radare2/libr/util/lib.c"
 ...
 if (stru->version && !lib->ignore_version) {
  ...
  char *mm1 = major_minor (
# 320 "project/radare2/libr/util/lib.c" 3 4
                          "5.5.4"
# 320 "project/radare2/libr/util/lib.c"
                                    );
  
# 321 "project/radare2/libr/util/lib.c" 3 4
 _Bool 
# 321 "project/radare2/libr/util/lib.c"
      mismatch = strcmp (mm0, mm1);
  free (mm0);
  free (mm1);
  if (mismatch) {
   
# 325 "project/radare2/libr/util/lib.c" 3 4
  fprintf(__stderrp,
# 325 "project/radare2/libr/util/lib.c"
  "Module version mismatch %s (%s) vs (%s)\n", file, stru->version, 
# 325 "project/radare2/libr/util/lib.c" 3 4
  "5.5.4")
                                     
# 326 "project/radare2/libr/util/lib.c"
                                    ;
 ...
 RLibPlugin *p = 
# 339 "project/radare2/libr/util/lib.c" 3 4
                (
# 339 "project/radare2/libr/util/lib.c"
                RLibPlugin
# 339 "project/radare2/libr/util/lib.c" 3 4
                *)calloc(1,sizeof(
# 339 "project/radare2/libr/util/lib.c"
...
# 339 "project/radare2/libr/util/lib.c"
 ...
 if (ret == -1) {
  if(__has_debug) 
# 349 "project/radare2/libr/util/lib.c" 3 4
       fprintf(__stderrp,
# 349 "project/radare2/libr/util/lib.c"
       "Library handler has failed for '%s'\n", file
# 349 "project/radare2/libr/util/lib.c" 3 4
       )
# 349 "project/radare2/libr/util/lib.c"
                                                              ;
...
# 360 "project/radare2/libr/util/lib.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 360 "project/radare2/libr/util/lib.c"
          r_lib_opendir(RLib *lib, const char *path) {

 
# 362 "project/radare2/libr/util/lib.c" 3 4
do { if (!(
# 362 "project/radare2/libr/util/lib.c"
lib && path
# 362 "project/radare2/libr/util/lib.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 362 "project/radare2/libr/util/lib.c"
"lib && path"
# 362 "project/radare2/libr/util/lib.c" 3 4
, 362); return (0); } } while (0)
# 362 "project/radare2/libr/util/lib.c"
                                         ;
# 371 "project/radare2/libr/util/lib.c"
 char file[1024];
 struct dirent *de;
 DIR *dh;
 ...
 if (!path) {
  return 
# 381 "project/radare2/libr/util/lib.c" 3 4
        0
# 381 "project/radare2/libr/util/lib.c"
             ;
 }
# 411 "project/radare2/libr/util/lib.c"
 dh = opendir (path);
 if (!dh) {
  if(__has_debug) 
# 413 "project/radare2/libr/util/lib.c" 3 4
       fprintf(__stderrp,
# 413 "project/radare2/libr/util/lib.c"
...
# 413 "project/radare2/libr/util/lib.c"
                                                     ;
  return 
# 414 "project/radare2/libr/util/lib.c" 3 4
        0
# 414 "project/radare2/libr/util/lib.c"
             ;
 }
...
# 420 "project/radare2/libr/util/lib.c" 3 4
 __builtin___snprintf_chk (
# 420 "project/radare2/libr/util/lib.c"
 file
# 420 "project/radare2/libr/util/lib.c" 3 4
 , 
# 420 "project/radare2/libr/util/lib.c"
...
# 420 "project/radare2/libr/util/lib.c"
  ...
  if (__lib_dl_check_filename (file)) {
   if(__has_debug) 
# 422 "project/radare2/libr/util/lib.c" 3 4
        fprintf(__stderrp,
# 422 "project/radare2/libr/util/lib.c"
        "Loading %s\n", file
# 422 "project/radare2/libr/util/lib.c" 3 4
        )
# 422 "project/radare2/libr/util/lib.c"
   ...
   if(__has_debug) 
# 425 "project/radare2/libr/util/lib.c" 3 4
        fprintf(__stderrp,
# 425 "project/radare2/libr/util/lib.c"
        "Cannot open %s\n", file
# 425 "project/radare2/libr/util/lib.c" 3 4
        )
# 425 "project/radare2/libr/util/lib.c"
 ...
 return 
# 431 "project/radare2/libr/util/lib.c" 3 4
       1
# 431 "project/radare2/libr/util/lib.c"
           ;
}


# 434 "project/radare2/libr/util/lib.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 434 "project/radare2/libr/util/lib.c"
          r_lib_add_handler(RLib *lib,
 ...
 void *user)
{
 ...
 RListIter *iter;
 RLibHandler *handler = 
# 442 "project/radare2/libr/util/lib.c" 3 4
                       ((void *)0)
# 442 "project/radare2/libr/util/lib.c"
                           ;

 
# 444 "project/radare2/libr/util/lib.c" 3 4
if (
# 444 "project/radare2/libr/util/lib.c"
lib->handlers
# 444 "project/radare2/libr/util/lib.c" 3 4
) for (
# 444 "project/radare2/libr/util/lib.c"
...
# 444 "project/radare2/libr/util/lib.c"
  ...
  if (type == h->type) {
   if(__has_debug) 
# 446 "project/radare2/libr/util/lib.c" 3 4
        fprintf(__stderrp,
# 446 "project/radare2/libr/util/lib.c"
        "Redefining library handler constructor for %d\n", type
# 446 "project/radare2/libr/util/lib.c" 3 4
        )
# 446 "project/radare2/libr/util/lib.c"
                                                                         ;
 ...
 if (!handler) {
  handler = 
# 452 "project/radare2/libr/util/lib.c" 3 4
           (
# 452 "project/radare2/libr/util/lib.c"
           RLibHandler
# 452 "project/radare2/libr/util/lib.c" 3 4
           *)malloc(sizeof(
# 452 "project/radare2/libr/util/lib.c"
...
# 452 "project/radare2/libr/util/lib.c"
  ...
  if (!handler) {
   return 
# 454 "project/radare2/libr/util/lib.c" 3 4
         0
# 454 "project/radare2/libr/util/lib.c"
              ;
  }
  handler->type = type;
...
# 459 "project/radare2/libr/util/lib.c" 3 4
__builtin___strncpy_chk (
# 459 "project/radare2/libr/util/lib.c"
handler->desc
# 459 "project/radare2/libr/util/lib.c" 3 4
, 
# 459 "project/radare2/libr/util/lib.c"
desc, sizeof (handler->desc)-1
# 459 "project/radare2/libr/util/lib.c" 3 4
...
# 459 "project/radare2/libr/util/lib.c"
 ...
 return 
# 464 "project/radare2/libr/util/lib.c" 3 4
       1
# 464 "project/radare2/libr/util/lib.c"
           ;
}


# 467 "project/radare2/libr/util/lib.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 467 "project/radare2/libr/util/lib.c"
          r_lib_del_handler(RLib *lib, int type) {
 RLibHandler *h;
 RListIter *iter;


 
# 472 "project/radare2/libr/util/lib.c" 3 4
if (
# 472 "project/radare2/libr/util/lib.c"
lib->handlers
# 472 "project/radare2/libr/util/lib.c" 3 4
) for (
# 472 "project/radare2/libr/util/lib.c"
...
# 472 "project/radare2/libr/util/lib.c"
  ...
  if (type == h->type) {
   ...
   return 
# 475 "project/radare2/libr/util/lib.c" 3 4
         1
# 475 "project/radare2/libr/util/lib.c"
             ;
  }
 }
 return 
# 478 "project/radare2/libr/util/lib.c" 3 4
       0
# 478 "project/radare2/libr/util/lib.c"
            ;
}



# 482 "project/radare2/libr/util/lib.c" 3 4
__attribute__((visibility("default"))) 
# 482 "project/radare2/libr/util/lib.c"
     void r_lib_list(RLib *lib) {
 RListIter *iter;
 RLibPlugin *p;
 
# 485 "project/radare2/libr/util/lib.c" 3 4
if (
# 485 "project/radare2/libr/util/lib.c"
lib->plugins
# 485 "project/radare2/libr/util/lib.c" 3 4
) for (
# 485 "project/radare2/libr/util/lib.c"
