# 0 "project/radare2/libr/util/str.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/str.c"
...
# 4 "project/radare2/libr/util/str.c" 2
...
# 5 "project/radare2/libr/util/str.c" 2
...
#undef KEY_TO_HASH
#undef HT_NULL_VALUE
# 40 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/sdb/src/ht_inc.h" 3 4
...
# 508 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/netinet6/in6.h" 3 4
...
# 58 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/poll.h" 3 4
#define _SYS_POLL_H_ 
# 68 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/poll.h" 3 4
...
# 65 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/ptrace.h" 3 4
...
# 7 "project/radare2/libr/util/str.c" 2
...
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_base64.h" 1 3 4
# 13 "project/radare2/libr/util/str.c" 2



# 15 "project/radare2/libr/util/str.c"
...
# 38 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 38 "project/radare2/libr/util/str.c"
     int r_str_casecmp(const char *s1, const char *s2) {
...
# 46 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 46 "project/radare2/libr/util/str.c"
     int r_str_ncasecmp(const char *s1, const char *s2, size_t n) {
...
# 56 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 56 "project/radare2/libr/util/str.c"
     int r_str_replace_ch(char *s, char a, char b, 
# 56 "project/radare2/libr/util/str.c" 3 4
                                                   _Bool 
# 56 "project/radare2/libr/util/str.c"
                                                        global) {
...
# 82 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 82 "project/radare2/libr/util/str.c"
     int r_str_replace_char_once(char *s, int a, int b) {
 return r_str_replace_ch (s, a, b, 
# 83 "project/radare2/libr/util/str.c" 3 4
                                  0
# 83 "project/radare2/libr/util/str.c"
                                       );
}


# 86 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 86 "project/radare2/libr/util/str.c"
     int r_str_replace_char(char *s, int a, int b) {
 return r_str_replace_ch (s, a, b, 
# 87 "project/radare2/libr/util/str.c" 3 4
                                  1
# 87 "project/radare2/libr/util/str.c"
                                      );
}


# 90 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 90 "project/radare2/libr/util/str.c"
     void r_str_remove_char(char *str, char c) {
 while (*str) {
  if (*str == c) {
   
# 93 "project/radare2/libr/util/str.c" 3 4
  __builtin___memmove_chk (
# 93 "project/radare2/libr/util/str.c"
  str
# 93 "project/radare2/libr/util/str.c" 3 4
  , 
# 93 "project/radare2/libr/util/str.c"
...
# 100 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 100 "project/radare2/libr/util/str.c"
     void r_str_reverse(char *str) {
...
# 112 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 112 "project/radare2/libr/util/str.c"
     int r_str_bits(char *strout, const 
# 112 "project/radare2/libr/util/str.c" 3 4
                                        unsigned char 
# 112 "project/radare2/libr/util/str.c"
                                            *buf, int len, const char *bitz) {
 int i, j, idx;
 if (bitz) {
  for (i = j = 0; i<len && (!bitz||bitz[i]); i++) {
   ...
   if (*buf & (1 << (i % 8))) {
    strout[j++] = toupper ((const 
# 120 "project/radare2/libr/util/str.c" 3 4
                                 unsigned char
# 120 "project/radare2/libr/util/str.c"
                                    )bitz[i]);
   }
  }
 } else {
...
# 134 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 134 "project/radare2/libr/util/str.c"
     const char *r_str_sysbits(const int v) {
 switch (v) {
 case 
# 136 "project/radare2/libr/util/str.c" 3 4
     1
# 136 "project/radare2/libr/util/str.c"
                 : return "8";
 case 
# 137 "project/radare2/libr/util/str.c" 3 4
     2
# 137 "project/radare2/libr/util/str.c"
                  : return "16";
 case 
# 138 "project/radare2/libr/util/str.c" 3 4
     4
# 138 "project/radare2/libr/util/str.c"
                  : return "32";
 case 
# 139 "project/radare2/libr/util/str.c" 3 4
     8
# 139 "project/radare2/libr/util/str.c"
                  : return "64";
 case 
# 140 "project/radare2/libr/util/str.c" 3 4
     2 
# 140 "project/radare2/libr/util/str.c"
                   | 
# 140 "project/radare2/libr/util/str.c" 3 4
                     4
# 140 "project/radare2/libr/util/str.c"
                                  : return "16,32";
 case 
# 141 "project/radare2/libr/util/str.c" 3 4
     2 
# 141 "project/radare2/libr/util/str.c"
                   | 
# 141 "project/radare2/libr/util/str.c" 3 4
                     4 
# 141 "project/radare2/libr/util/str.c"
...
# 141 "project/radare2/libr/util/str.c"
                                                  : return "16,32,64";
 case 
# 142 "project/radare2/libr/util/str.c" 3 4
     4 
# 142 "project/radare2/libr/util/str.c"
                   | 
# 142 "project/radare2/libr/util/str.c" 3 4
                     8
# 142 "project/radare2/libr/util/str.c"
...
# 155 "project/radare2/libr/util/str.c" 3 4
__builtin___memmove_chk (
# 155 "project/radare2/libr/util/str.c"
b
# 155 "project/radare2/libr/util/str.c" 3 4
, 
# 155 "project/radare2/libr/util/str.c"
...
# 161 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 161 "project/radare2/libr/util/str.c"
     int r_str_bits64(char* strout, 
# 161 "project/radare2/libr/util/str.c" 3 4
                                    unsigned long long 
# 161 "project/radare2/libr/util/str.c"
                                         in) {
...
# 183 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 183 "project/radare2/libr/util/str.c"
          r_str_bits_from_string(const char *buf, const char *bitz) {
 
# 184 "project/radare2/libr/util/str.c" 3 4
unsigned long long 
# 184 "project/radare2/libr/util/str.c"
     out = 0LL;
 ...
 for (; *buf; buf++) {
  ...
  if (ch) {
   ...
   out |= (
# 193 "project/radare2/libr/util/str.c" 3 4
          unsigned long long
# 193 "project/radare2/libr/util/str.c"
              )(1LL << bit);
  } else {
   return 
# 195 "project/radare2/libr/util/str.c" 3 4
         0xFFFFFFFFFFFFFFFFULL
# 195 "project/radare2/libr/util/str.c"
                 ;
  }
 }
 return out;
...
# 201 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 201 "project/radare2/libr/util/str.c"
     int r_str_binstr2bin(const char *str, 
# 201 "project/radare2/libr/util/str.c" 3 4
                                           unsigned char 
# 201 "project/radare2/libr/util/str.c"
                                               *out, int outlen) {
...
# 235 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 235 "project/radare2/libr/util/str.c"
     int r_str_rwx(const char *str) {
 int ret = atoi (str);
 if (!ret) {
...
# 242 "project/radare2/libr/util/str.c" 3 4
                             (sizeof (
# 242 "project/radare2/libr/util/str.c"
                             rwxstr
# 242 "project/radare2/libr/util/str.c" 3 4
                             ) / sizeof ((
# 242 "project/radare2/libr/util/str.c"
...
# 249 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 249 "project/radare2/libr/util/str.c"
     const char *r_str_rwx_i(int rwx) {
 if (rwx < 0 || rwx >= 
# 250 "project/radare2/libr/util/str.c" 3 4
                      (sizeof (
# 250 "project/radare2/libr/util/str.c"
                      rwxstr
# 250 "project/radare2/libr/util/str.c" 3 4
                      ) / sizeof ((
# 250 "project/radare2/libr/util/str.c"
...
# 258 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 258 "project/radare2/libr/util/str.c"
     void r_str_case(char *str, 
# 258 "project/radare2/libr/util/str.c" 3 4
                                _Bool 
# 258 "project/radare2/libr/util/str.c"
                                     up) {
 if (up) {
  char oc = 0;
  for (; *str; oc = *str++) {
   *str = (*str=='x' && oc=='0') ? 'x': toupper ((int)(
# 262 "project/radare2/libr/util/str.c" 3 4
                                                      unsigned char
# 262 "project/radare2/libr/util/str.c"
                                                         )*str);
  }
 } else {
  for (; *str; str++) {
   *str = tolower ((int)(
# 266 "project/radare2/libr/util/str.c" 3 4
                        unsigned char
# 266 "project/radare2/libr/util/str.c"
                           )*str);
  }
 }
}
...
# 271 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 271 "project/radare2/libr/util/str.c"
     char *r_str_home(const char *str) {
 char *dst, *home = r_sys_getenv (
# 272 "project/radare2/libr/util/str.c" 3 4
                                 "HOME"
# 272 "project/radare2/libr/util/str.c"
                                           );
 size_t length;
 if (!home) {
  home = r_file_tmpdir ();
  if (!home) {
   return 
# 277 "project/radare2/libr/util/str.c" 3 4
         ((void *)0)
# 277 "project/radare2/libr/util/str.c"
             ;
  }
 }
 length = strlen (home) + 1;
 if (
# 281 "project/radare2/libr/util/str.c" 3 4
    ((
# 281 "project/radare2/libr/util/str.c"
    str
# 281 "project/radare2/libr/util/str.c" 3 4
    ) && *(
# 281 "project/radare2/libr/util/str.c"
...
# 281 "project/radare2/libr/util/str.c"
  ...
  length += strlen (
# 282 "project/radare2/libr/util/str.c" 3 4
                   "/"
# 282 "project/radare2/libr/util/str.c"
                            ) + strlen (str);
 }
...
# 289 "project/radare2/libr/util/str.c" 3 4
__builtin___memcpy_chk (
# 289 "project/radare2/libr/util/str.c"
dst
# 289 "project/radare2/libr/util/str.c" 3 4
, 
# 289 "project/radare2/libr/util/str.c"
...
# 289 "project/radare2/libr/util/str.c"
                                ;
 if (
# 290 "project/radare2/libr/util/str.c" 3 4
    ((
# 290 "project/radare2/libr/util/str.c"
    str
# 290 "project/radare2/libr/util/str.c" 3 4
    ) && *(
# 290 "project/radare2/libr/util/str.c"
...
# 290 "project/radare2/libr/util/str.c"
  ...
  dst[home_len] = 
# 291 "project/radare2/libr/util/str.c" 3 4
                 "/"
# 291 "project/radare2/libr/util/str.c"
                          [0];
  
# 292 "project/radare2/libr/util/str.c" 3 4
 __builtin___strcpy_chk (
# 292 "project/radare2/libr/util/str.c"
 dst + home_len + 1
# 292 "project/radare2/libr/util/str.c" 3 4
 , 
# 292 "project/radare2/libr/util/str.c"
...
# 299 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 299 "project/radare2/libr/util/str.c"
     char *r_str_r2_prefix(const char *str) {
 return r_str_newf ("%s%s%s", r_sys_prefix (
# 300 "project/radare2/libr/util/str.c" 3 4
                                           ((void *)0)
# 300 "project/radare2/libr/util/str.c"
                                               ), 
# 300 "project/radare2/libr/util/str.c" 3 4
                                                  "/"
# 300 "project/radare2/libr/util/str.c"
...
# 304 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 304 "project/radare2/libr/util/str.c"
          r_str_hash64(const char *s) {
 
# 305 "project/radare2/libr/util/str.c" 3 4
unsigned long long 
# 305 "project/radare2/libr/util/str.c"
     len, h = 5381;
 if (!s) {
  return 0;
 }
...
# 316 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) unsigned int 
# 316 "project/radare2/libr/util/str.c"
          r_str_hash(const char *s) {
 return (
# 317 "project/radare2/libr/util/str.c" 3 4
        unsigned int
# 317 "project/radare2/libr/util/str.c"
            ) r_str_hash64 (s);
}


# 320 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 320 "project/radare2/libr/util/str.c"
...
# 330 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 330 "project/radare2/libr/util/str.c"
     int r_str_split(char *str, char ch) {
 int i;
 char *p;
 if (!str || !*str) {
  return 0;
...
# 350 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 350 "project/radare2/libr/util/str.c"
...
# 359 "project/radare2/libr/util/str.c" 3 4
  __builtin___memmove_chk (
# 359 "project/radare2/libr/util/str.c"
  str + i
# 359 "project/radare2/libr/util/str.c" 3 4
  , 
# 359 "project/radare2/libr/util/str.c"
...
# 375 "project/radare2/libr/util/str.c" 3 4
   __builtin___memmove_chk (
# 375 "project/radare2/libr/util/str.c"
   p
# 375 "project/radare2/libr/util/str.c" 3 4
   , 
# 375 "project/radare2/libr/util/str.c"
...
# 384 "project/radare2/libr/util/str.c" 3 4
   __builtin___memmove_chk (
# 384 "project/radare2/libr/util/str.c"
   p
# 384 "project/radare2/libr/util/str.c" 3 4
   , 
# 384 "project/radare2/libr/util/str.c"
...
# 398 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 398 "project/radare2/libr/util/str.c"
     int r_str_word_set0_stack(char *str) {
 int i;
 char *p, *q;
 RStack *s;
 void *pop;
...
# 408 "project/radare2/libr/util/str.c" 3 4
  __builtin___memmove_chk (
# 408 "project/radare2/libr/util/str.c"
  str + i
# 408 "project/radare2/libr/util/str.c" 3 4
  , 
# 408 "project/radare2/libr/util/str.c"
  str + i + 1, strlen (str + i)
# 408 "project/radare2/libr/util/str.c" 3 4
  , __builtin_object_size (
# 408 "project/radare2/libr/util/str.c"
  str + i
...
# 412 "project/radare2/libr/util/str.c" 3 4
  __builtin___memmove_chk (
# 412 "project/radare2/libr/util/str.c"
  str + i
# 412 "project/radare2/libr/util/str.c" 3 4
  , 
# 412 "project/radare2/libr/util/str.c"
...
# 422 "project/radare2/libr/util/str.c" 3 4
  __builtin___memmove_chk (
# 422 "project/radare2/libr/util/str.c"
  q
# 422 "project/radare2/libr/util/str.c" 3 4
  , 
# 422 "project/radare2/libr/util/str.c"
...
# 456 "project/radare2/libr/util/str.c" 3 4
   __builtin___memmove_chk (
# 456 "project/radare2/libr/util/str.c"
   p
# 456 "project/radare2/libr/util/str.c" 3 4
   , 
# 456 "project/radare2/libr/util/str.c"
...
# 475 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 475 "project/radare2/libr/util/str.c"
     char *r_str_word_get0set(char *stra, int stralen, int idx, const char *newstr, int *newlen) {
 char *p = 
# 476 "project/radare2/libr/util/str.c" 3 4
          ((void *)0)
# 476 "project/radare2/libr/util/str.c"
              ;
 char *out;
 int alen, blen, nlen;
 if (!stra && !newstr) {
  return 
# 480 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 480 "project/radare2/libr/util/str.c"
            ;
 }
 if (stra) {
 ...
 if (!p) {
  ...
  if (!out) {
   return 
# 489 "project/radare2/libr/util/str.c" 3 4
         ((void *)0)
# 489 "project/radare2/libr/util/str.c"
             ;
  }
  
# 491 "project/radare2/libr/util/str.c" 3 4
 __builtin___strcpy_chk (
# 491 "project/radare2/libr/util/str.c"
 out
# 491 "project/radare2/libr/util/str.c" 3 4
 , 
# 491 "project/radare2/libr/util/str.c"
...
# 491 "project/radare2/libr/util/str.c"
 ...
 if (!out) {
  return 
# 506 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 506 "project/radare2/libr/util/str.c"
            ;
 }
 if (alen > 0) {
  
# 509 "project/radare2/libr/util/str.c" 3 4
 __builtin___memcpy_chk (
# 509 "project/radare2/libr/util/str.c"
 out
# 509 "project/radare2/libr/util/str.c" 3 4
 , 
# 509 "project/radare2/libr/util/str.c"
...
# 511 "project/radare2/libr/util/str.c" 3 4
__builtin___memcpy_chk (
# 511 "project/radare2/libr/util/str.c"
out + alen
# 511 "project/radare2/libr/util/str.c" 3 4
, 
# 511 "project/radare2/libr/util/str.c"
...
# 513 "project/radare2/libr/util/str.c" 3 4
 __builtin___memcpy_chk (
# 513 "project/radare2/libr/util/str.c"
 out + alen + strlen (newstr) + 1
# 513 "project/radare2/libr/util/str.c" 3 4
 , 
# 513 "project/radare2/libr/util/str.c"
 p + strlen (p) + 1, blen + 1
...
# 525 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 525 "project/radare2/libr/util/str.c"
...
# 538 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 538 "project/radare2/libr/util/str.c"
     int r_str_char_count(const char *string, char ch) {
 int i, count = 0;
 for (i = 0; string[i]; i++) {
  if (string[i] == ch) {
   count++;
 ...
 return 
# 545 "project/radare2/libr/util/str.c" 3 4
       (((
# 545 "project/radare2/libr/util/str.c"
       0
# 545 "project/radare2/libr/util/str.c" 3 4
       )>(
# 545 "project/radare2/libr/util/str.c"
...
# 550 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 550 "project/radare2/libr/util/str.c"
     int r_str_word_count(const char *string) {
 const char *text;
 int word;

 for (text = string; *text && 
# 554 "project/radare2/libr/util/str.c" 3 4
                             ((
# 554 "project/radare2/libr/util/str.c"
                             *text
# 554 "project/radare2/libr/util/str.c" 3 4
                             ) == ' ' || (
# 554 "project/radare2/libr/util/str.c"
...
# 554 "project/radare2/libr/util/str.c"
 ...
 for (word = 0; *text; word++) {
  for (; *text && !
# 558 "project/radare2/libr/util/str.c" 3 4
                  ((
# 558 "project/radare2/libr/util/str.c"
                  *text
# 558 "project/radare2/libr/util/str.c" 3 4
                  ) == ' ' || (
# 558 "project/radare2/libr/util/str.c"
...
# 558 "project/radare2/libr/util/str.c"
  ...
  for (; *text && 
# 561 "project/radare2/libr/util/str.c" 3 4
                 ((
# 561 "project/radare2/libr/util/str.c"
                 *text
# 561 "project/radare2/libr/util/str.c" 3 4
                 ) == ' ' || (
# 561 "project/radare2/libr/util/str.c"
...
# 561 "project/radare2/libr/util/str.c"
 ...
 return 
# 565 "project/radare2/libr/util/str.c" 3 4
       (((
# 565 "project/radare2/libr/util/str.c"
       0
# 565 "project/radare2/libr/util/str.c" 3 4
       )>(
# 565 "project/radare2/libr/util/str.c"
...
# 573 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 573 "project/radare2/libr/util/str.c"
...
# 582 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 582 "project/radare2/libr/util/str.c"
     const char *r_str_lchr(const char *str, char chr) {
 if (str) {
  int len = strlen (str);
  for (; len >= 0; len--) {
   if (str[len] == chr) {
 ...
 return 
# 591 "project/radare2/libr/util/str.c" 3 4
       ((void *)0)
# 591 "project/radare2/libr/util/str.c"
           ;
}



# 595 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 595 "project/radare2/libr/util/str.c"
     const char *r_sub_str_lchr(const char *str, int start, int end, char chr) {
 do {
  end--;
 } while (str[end] != chr && end >= start);
 return str[end] == chr ? &str[end] : 
# 599 "project/radare2/libr/util/str.c" 3 4
                                     ((void *)0)
# 599 "project/radare2/libr/util/str.c"
                                         ;
}



# 603 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 603 "project/radare2/libr/util/str.c"
     const char *r_sub_str_rchr(const char *str, int start, int end, char chr) {
 while (str[start] != chr && start < end) {
  start++;
 }
 return str[start] == chr ? str + start : 
# 607 "project/radare2/libr/util/str.c" 3 4
                                         ((void *)0)
# 607 "project/radare2/libr/util/str.c"
                                             ;
}


# 610 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 610 "project/radare2/libr/util/str.c"
     const char *r_str_sep(const char *base, const char *sep) {
 int i;
 while (*base) {
  for (i = 0; sep[i]; i++) {
   if (*base == sep[i]) {
 ...
 return 
# 620 "project/radare2/libr/util/str.c" 3 4
       ((void *)0)
# 620 "project/radare2/libr/util/str.c"
           ;
}


# 623 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 623 "project/radare2/libr/util/str.c"
     const char *r_str_rsep(const char *base, const char *p, const char *sep) {
 int i;
 while (p >= base) {
  for (i = 0; sep[i]; i++) {
   if (*p == sep[i]) {
 ...
 return 
# 633 "project/radare2/libr/util/str.c" 3 4
       ((void *)0)
# 633 "project/radare2/libr/util/str.c"
           ;
}


# 636 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 636 "project/radare2/libr/util/str.c"
     const char *r_str_rstr(const char *base, const char *p) {
 char *s = strdup (base);
 char *k = strdup (p);
 r_str_reverse (s);
 r_str_reverse (k);
 char *q = strstr (s, k);
 const char *r = 
# 642 "project/radare2/libr/util/str.c" 3 4
                ((void *)0)
# 642 "project/radare2/libr/util/str.c"
                    ;
 if (q) {
...
# 651 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 651 "project/radare2/libr/util/str.c"
     const char *r_str_rchr(const char *base, const char *p, int ch) {
 
# 652 "project/radare2/libr/util/str.c" 3 4
do { if (!(
# 652 "project/radare2/libr/util/str.c"
base
# 652 "project/radare2/libr/util/str.c" 3 4
...
# 652 "project/radare2/libr/util/str.c"
 ...
 return (p >= base) ? p: 
# 661 "project/radare2/libr/util/str.c" 3 4
                        ((void *)0)
# 661 "project/radare2/libr/util/str.c"
                            ;
}


# 664 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 664 "project/radare2/libr/util/str.c"
     const char *r_str_nstr(const char *s, const char *find, int slen) {
 char c, sc;
 size_t len;
 ...
 if ((c = *find++) != '\0') {
  ...
  do {
   do {
    if (slen-- < 1 || !(sc = *s++)) {
     return 
# 673 "project/radare2/libr/util/str.c" 3 4
           ((void *)0)
# 673 "project/radare2/libr/util/str.c"
               ;
    }
   } while (sc != c);
   if (len > slen) {
    return 
# 677 "project/radare2/libr/util/str.c" 3 4
          ((void *)0)
# 677 "project/radare2/libr/util/str.c"
              ;
   }
...
# 687 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 687 "project/radare2/libr/util/str.c"
     char *r_str_new(const char *str) {
 return str? strdup (str): 
# 688 "project/radare2/libr/util/str.c" 3 4
                          ((void *)0)
# 688 "project/radare2/libr/util/str.c"
                              ;
}
...
# 693 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 693 "project/radare2/libr/util/str.c"
     char *r_str_newlen(const char *str, int len) {
 if (len < 1) {
  return 
# 695 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 695 "project/radare2/libr/util/str.c"
            ;
 }
 char *buf = malloc (len + 1);
 if (buf) {
  
# 699 "project/radare2/libr/util/str.c" 3 4
 __builtin___memcpy_chk (
# 699 "project/radare2/libr/util/str.c"
 buf
# 699 "project/radare2/libr/util/str.c" 3 4
 , 
# 699 "project/radare2/libr/util/str.c"
...
# 705 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 705 "project/radare2/libr/util/str.c"
     char *r_str_trunc_ellipsis(const char *str, int len) {
 if (!str) {
  return 
# 707 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 707 "project/radare2/libr/util/str.c"
            ;
 }
 if (strlen (str) < len) {
  return strdup (str);
...
# 714 "project/radare2/libr/util/str.c" 3 4
 __builtin___strcpy_chk (
# 714 "project/radare2/libr/util/str.c"
 buf + len - 4
# 714 "project/radare2/libr/util/str.c" 3 4
 , 
# 714 "project/radare2/libr/util/str.c"
...
# 719 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 719 "project/radare2/libr/util/str.c"
     char *r_str_newvf(const char *fmt, va_list ap) {
 va_list ap2;
 
# 721 "project/radare2/libr/util/str.c" 3 4
__builtin_va_copy(
# 721 "project/radare2/libr/util/str.c"
ap2
# 721 "project/radare2/libr/util/str.c" 3 4
,
# 721 "project/radare2/libr/util/str.c"
...
# 721 "project/radare2/libr/util/str.c"
                 ;
 int ret = 
# 722 "project/radare2/libr/util/str.c" 3 4
          __builtin___vsnprintf_chk (((void *)0), 
# 722 "project/radare2/libr/util/str.c"
          0
# 722 "project/radare2/libr/util/str.c" 3 4
...
# 722 "project/radare2/libr/util/str.c"
 ...
 if (p) {
  (void)
# 726 "project/radare2/libr/util/str.c" 3 4
       __builtin___vsnprintf_chk (
# 726 "project/radare2/libr/util/str.c"
       p
# 726 "project/radare2/libr/util/str.c" 3 4
       , 
# 726 "project/radare2/libr/util/str.c"
...
# 728 "project/radare2/libr/util/str.c" 3 4
__builtin_va_end(
# 728 "project/radare2/libr/util/str.c"
ap2
# 728 "project/radare2/libr/util/str.c" 3 4
)
# 728 "project/radare2/libr/util/str.c"
...
# 732 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 732 "project/radare2/libr/util/str.c"
     char *r_str_newf(const char *fmt, ...) {
 va_list ap, ap2;

 
# 735 "project/radare2/libr/util/str.c" 3 4
__builtin_va_start(
# 735 "project/radare2/libr/util/str.c"
ap
# 735 "project/radare2/libr/util/str.c" 3 4
,
# 735 "project/radare2/libr/util/str.c"
...
# 737 "project/radare2/libr/util/str.c" 3 4
 __builtin_va_end(
# 737 "project/radare2/libr/util/str.c"
 ap
# 737 "project/radare2/libr/util/str.c" 3 4
 )
# 737 "project/radare2/libr/util/str.c"
...
# 740 "project/radare2/libr/util/str.c" 3 4
__builtin_va_copy(
# 740 "project/radare2/libr/util/str.c"
ap2
# 740 "project/radare2/libr/util/str.c" 3 4
,
# 740 "project/radare2/libr/util/str.c"
...
# 740 "project/radare2/libr/util/str.c"
                 ;
 int ret = 
# 741 "project/radare2/libr/util/str.c" 3 4
          __builtin___vsnprintf_chk (((void *)0), 
# 741 "project/radare2/libr/util/str.c"
          0
# 741 "project/radare2/libr/util/str.c" 3 4
          , 0, __builtin_object_size (((void *)0), 2 > 1 ? 1 : 0), 
# 741 "project/radare2/libr/util/str.c"
...
# 741 "project/radare2/libr/util/str.c"
 ...
 if (p) {
  (void)
# 745 "project/radare2/libr/util/str.c" 3 4
       __builtin___vsnprintf_chk (
# 745 "project/radare2/libr/util/str.c"
       p
# 745 "project/radare2/libr/util/str.c" 3 4
       , 
# 745 "project/radare2/libr/util/str.c"
...
# 747 "project/radare2/libr/util/str.c" 3 4
__builtin_va_end(
# 747 "project/radare2/libr/util/str.c"
ap2
# 747 "project/radare2/libr/util/str.c" 3 4
)
# 747 "project/radare2/libr/util/str.c"
...
# 748 "project/radare2/libr/util/str.c" 3 4
__builtin_va_end(
# 748 "project/radare2/libr/util/str.c"
ap
# 748 "project/radare2/libr/util/str.c" 3 4
)
# 748 "project/radare2/libr/util/str.c"
...
# 753 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 753 "project/radare2/libr/util/str.c"
...
# 771 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 771 "project/radare2/libr/util/str.c"
          r_str_ccmp(const char *dst, const char *src, int ch) {
 int i;
 for (i = 0; src[i] && src[i] != ch; i++) {
  if (dst[i] != src[i]) {
   return 
# 775 "project/radare2/libr/util/str.c" 3 4
         1
# 775 "project/radare2/libr/util/str.c"
             ;
  }
 }
 return 
# 778 "project/radare2/libr/util/str.c" 3 4
       0
# 778 "project/radare2/libr/util/str.c"
            ;
}



# 782 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 782 "project/radare2/libr/util/str.c"
          r_str_cmp_list(const char *list, const char *item, char sep) {
 if (!list || !item) {
  return 
# 784 "project/radare2/libr/util/str.c" 3 4
        0
# 784 "project/radare2/libr/util/str.c"
             ;
 }
 int i = 0, j = 0;
 for (; list[i] && list[i] != sep; i++, j++) {
  if (item[j] != list[i]) {
   ...
   if (!list[i]) {
    return 
# 793 "project/radare2/libr/util/str.c" 3 4
          0
# 793 "project/radare2/libr/util/str.c"
               ;
   }
   j = -1;
   continue;
 ...
 return 
# 799 "project/radare2/libr/util/str.c" 3 4
       1
# 799 "project/radare2/libr/util/str.c"
           ;
}



# 803 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 803 "project/radare2/libr/util/str.c"
...
# 820 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 820 "project/radare2/libr/util/str.c"
     int r_str_ccpy(char *dst, char *src, int ch) {
 int i;
 for (i = 0; src[i] && src[i] != ch; i++) {
  dst[i] = src[i];
 }
...
# 829 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 829 "project/radare2/libr/util/str.c"
     char *r_str_word_get_first(const char *text) {
 for (; *text && 
# 830 "project/radare2/libr/util/str.c" 3 4
                ((
# 830 "project/radare2/libr/util/str.c"
                *text
# 830 "project/radare2/libr/util/str.c" 3 4
                ) == ' ' || (
# 830 "project/radare2/libr/util/str.c"
...
# 836 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 836 "project/radare2/libr/util/str.c"
     const char *r_str_get(const char *str) {
 return str? str: nullstr;
}


# 840 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 840 "project/radare2/libr/util/str.c"
     const char *r_str_get_fail(const char *str, const char *failstr) {
 return str? str: failstr;
}


# 844 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 844 "project/radare2/libr/util/str.c"
     const char *r_str_getf(const char *str) {
 return str? str: nullstr_c;
}


# 848 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 848 "project/radare2/libr/util/str.c"
     char *r_str_ndup(const char *ptr, int len) {
 if (!ptr || len < 0) {
  return 
# 850 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 850 "project/radare2/libr/util/str.c"
            ;
 }
 size_t plen = r_str_nlen (ptr, len);
 size_t olen = 
# 853 "project/radare2/libr/util/str.c" 3 4
              (((
# 853 "project/radare2/libr/util/str.c"
              len
# 853 "project/radare2/libr/util/str.c" 3 4
              )>(
# 853 "project/radare2/libr/util/str.c"
...
# 853 "project/radare2/libr/util/str.c"
 ...
 if (!out) {
  return 
# 856 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 856 "project/radare2/libr/util/str.c"
            ;
 }
 
# 858 "project/radare2/libr/util/str.c" 3 4
__builtin___memcpy_chk (
# 858 "project/radare2/libr/util/str.c"
out
# 858 "project/radare2/libr/util/str.c" 3 4
, 
# 858 "project/radare2/libr/util/str.c"
...
# 864 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 864 "project/radare2/libr/util/str.c"
...
# 870 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 870 "project/radare2/libr/util/str.c"
     char *r_str_prepend(char *ptr, const char *string) {
 int slen, plen;
 if (!ptr) {
 ...
 if (!ptr) {
  return 
# 879 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 879 "project/radare2/libr/util/str.c"
            ;
 }
 
# 881 "project/radare2/libr/util/str.c" 3 4
__builtin___memmove_chk (
# 881 "project/radare2/libr/util/str.c"
ptr + slen
# 881 "project/radare2/libr/util/str.c" 3 4
, 
# 881 "project/radare2/libr/util/str.c"
...
# 882 "project/radare2/libr/util/str.c" 3 4
__builtin___memmove_chk (
# 882 "project/radare2/libr/util/str.c"
ptr
# 882 "project/radare2/libr/util/str.c" 3 4
, 
# 882 "project/radare2/libr/util/str.c"
...
# 886 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 886 "project/radare2/libr/util/str.c"
     char *r_str_appendlen(char *ptr, const char *string, int slen) {
...
# 893 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 893 "project/radare2/libr/util/str.c"
     char *r_str_append_owned(char *ptr, char *string) {
 if (!ptr) {
  return string;
 }
...
# 905 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 905 "project/radare2/libr/util/str.c"
     char *r_str_append(char *ptr, const char *string) {
 if (string && !ptr) {
  return strdup (string);
 }
 if (
# 909 "project/radare2/libr/util/str.c" 3 4
    (!(
# 909 "project/radare2/libr/util/str.c"
    string
# 909 "project/radare2/libr/util/str.c" 3 4
    ) || !*(
# 909 "project/radare2/libr/util/str.c"
...
# 909 "project/radare2/libr/util/str.c"
 ...
 if (!newptr) {
  free (ptr);
  return 
# 917 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 917 "project/radare2/libr/util/str.c"
            ;
 }
 ptr = newptr;
 
# 920 "project/radare2/libr/util/str.c" 3 4
__builtin___memcpy_chk (
# 920 "project/radare2/libr/util/str.c"
ptr + plen
# 920 "project/radare2/libr/util/str.c" 3 4
, 
# 920 "project/radare2/libr/util/str.c"
...
# 924 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 924 "project/radare2/libr/util/str.c"
     char *r_str_appendf(char *ptr, const char *fmt, ...) {
 va_list ap, ap2;

 
# 927 "project/radare2/libr/util/str.c" 3 4
__builtin_va_start(
# 927 "project/radare2/libr/util/str.c"
ap
# 927 "project/radare2/libr/util/str.c" 3 4
,
# 927 "project/radare2/libr/util/str.c"
...
# 929 "project/radare2/libr/util/str.c" 3 4
 __builtin_va_end(
# 929 "project/radare2/libr/util/str.c"
 ap
# 929 "project/radare2/libr/util/str.c" 3 4
 )
# 929 "project/radare2/libr/util/str.c"
...
# 932 "project/radare2/libr/util/str.c" 3 4
__builtin_va_copy(
# 932 "project/radare2/libr/util/str.c"
ap2
# 932 "project/radare2/libr/util/str.c" 3 4
,
# 932 "project/radare2/libr/util/str.c"
...
# 932 "project/radare2/libr/util/str.c"
                 ;
 int ret = 
# 933 "project/radare2/libr/util/str.c" 3 4
          __builtin___vsnprintf_chk (((void *)0), 
# 933 "project/radare2/libr/util/str.c"
          0
# 933 "project/radare2/libr/util/str.c" 3 4
          , 0, __builtin_object_size (((void *)0), 2 > 1 ? 1 : 0), 
# 933 "project/radare2/libr/util/str.c"
...
# 933 "project/radare2/libr/util/str.c"
 ...
 if (p) {
  (void)
# 937 "project/radare2/libr/util/str.c" 3 4
       __builtin___vsnprintf_chk (
# 937 "project/radare2/libr/util/str.c"
       p
# 937 "project/radare2/libr/util/str.c" 3 4
       , 
# 937 "project/radare2/libr/util/str.c"
...
# 941 "project/radare2/libr/util/str.c" 3 4
__builtin_va_end(
# 941 "project/radare2/libr/util/str.c"
ap2
# 941 "project/radare2/libr/util/str.c" 3 4
)
# 941 "project/radare2/libr/util/str.c"
...
# 942 "project/radare2/libr/util/str.c" 3 4
__builtin_va_end(
# 942 "project/radare2/libr/util/str.c"
ap
# 942 "project/radare2/libr/util/str.c" 3 4
)
# 942 "project/radare2/libr/util/str.c"
...
# 946 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 946 "project/radare2/libr/util/str.c"
     char *r_str_appendch(char *x, char y) {
 char b[2] = { y, 0 };
 return r_str_append (x, b);
}


# 951 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 951 "project/radare2/libr/util/str.c"
     char* r_str_replace(char *str, const char *key, const char *val, int g) {
 if (g == 'i') {
  return r_str_replace_icase (str, key, val, g, 
# 953 "project/radare2/libr/util/str.c" 3 4
                                               1
# 953 "project/radare2/libr/util/str.c"
                                                   );
 }
 
# 955 "project/radare2/libr/util/str.c" 3 4
do { if (!(
# 955 "project/radare2/libr/util/str.c"
str && key && val
# 955 "project/radare2/libr/util/str.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 955 "project/radare2/libr/util/str.c"
...
# 985 "project/radare2/libr/util/str.c" 3 4
    fprintf(__stderrp,
# 985 "project/radare2/libr/util/str.c"
    "realloc fail\n"
# 985 "project/radare2/libr/util/str.c" 3 4
    )
# 985 "project/radare2/libr/util/str.c"
...
# 986 "project/radare2/libr/util/str.c" 3 4
    { free((void *)
# 986 "project/radare2/libr/util/str.c"
    str
# 986 "project/radare2/libr/util/str.c" 3 4
    ); 
# 986 "project/radare2/libr/util/str.c"
...
# 992 "project/radare2/libr/util/str.c" 3 4
  __builtin___memmove_chk (
# 992 "project/radare2/libr/util/str.c"
  p + vlen
# 992 "project/radare2/libr/util/str.c" 3 4
  , 
# 992 "project/radare2/libr/util/str.c"
...
# 994 "project/radare2/libr/util/str.c" 3 4
 __builtin___memcpy_chk (
# 994 "project/radare2/libr/util/str.c"
 p
# 994 "project/radare2/libr/util/str.c" 3 4
 , 
# 994 "project/radare2/libr/util/str.c"
...
# 1004 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1004 "project/radare2/libr/util/str.c"
     char *r_str_replace_icase(char *str, const char *key, const char *val, int g, int keep_case) {
 
# 1005 "project/radare2/libr/util/str.c" 3 4
do { if (!(
# 1005 "project/radare2/libr/util/str.c"
str && key && val
# 1005 "project/radare2/libr/util/str.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1005 "project/radare2/libr/util/str.c"
...
# 1030 "project/radare2/libr/util/str.c" 3 4
  __builtin___memmove_chk (
# 1030 "project/radare2/libr/util/str.c"
  p + vlen
# 1030 "project/radare2/libr/util/str.c" 3 4
  , 
# 1030 "project/radare2/libr/util/str.c"
...
# 1046 "project/radare2/libr/util/str.c" 3 4
  __builtin___memcpy_chk (
# 1046 "project/radare2/libr/util/str.c"
  p
# 1046 "project/radare2/libr/util/str.c" 3 4
  , 
# 1046 "project/radare2/libr/util/str.c"
...
# 1049 "project/radare2/libr/util/str.c" 3 4
  __builtin___memcpy_chk (
# 1049 "project/radare2/libr/util/str.c"
  p
# 1049 "project/radare2/libr/util/str.c" 3 4
  , 
# 1049 "project/radare2/libr/util/str.c"
...
# 1060 "project/radare2/libr/util/str.c" 3 4
fprintf(__stderrp,
# 1060 "project/radare2/libr/util/str.c"
"alloc fail\n"
# 1060 "project/radare2/libr/util/str.c" 3 4
)
# 1060 "project/radare2/libr/util/str.c"
 ...
 free (str);
 return 
# 1062 "project/radare2/libr/util/str.c" 3 4
       ((void *)0)
# 1062 "project/radare2/libr/util/str.c"
           ;
}
# 1077 "project/radare2/libr/util/str.c"

# 1077 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1077 "project/radare2/libr/util/str.c"
     char* r_str_replace_thunked(char *str, char *clean, int *thunk, int clen,
      const char *key, const char *val, int g) {
 ...
 if (!str || !key || !val || !clean || !thunk) {
  return 
# 1083 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 1083 "project/radare2/libr/util/str.c"
            ;
 }
 klen = strlen (key);
 vlen = strlen (val);
 ...
 for (i = 0; i < clen; ) {
  p = (char *)r_mem_mem (
   (const 
# 1094 "project/radare2/libr/util/str.c" 3 4
         unsigned char
# 1094 "project/radare2/libr/util/str.c"
            *)clean + i, clen - i,
   (const 
# 1095 "project/radare2/libr/util/str.c" 3 4
         unsigned char
# 1095 "project/radare2/libr/util/str.c"
            *)key, klen);
  if (!p) {
   break;
  }
  ...
  r_str_ansi_filter (str_p, 
# 1105 "project/radare2/libr/util/str.c" 3 4
                           ((void *)0)
# 1105 "project/radare2/libr/util/str.c"
                               , 
# 1105 "project/radare2/libr/util/str.c" 3 4
                                 ((void *)0)
# 1105 "project/radare2/libr/util/str.c"
...
# 1113 "project/radare2/libr/util/str.c" 3 4
  fprintf(__stderrp,
# 1113 "project/radare2/libr/util/str.c"
  "realloc fail\n"
# 1113 "project/radare2/libr/util/str.c" 3 4
  )
# 1113 "project/radare2/libr/util/str.c"
...
# 1114 "project/radare2/libr/util/str.c" 3 4
  { free((void *)
# 1114 "project/radare2/libr/util/str.c"
  str
# 1114 "project/radare2/libr/util/str.c" 3 4
  ); 
# 1114 "project/radare2/libr/util/str.c"
...
# 1120 "project/radare2/libr/util/str.c" 3 4
 __builtin___memcpy_chk (
# 1120 "project/radare2/libr/util/str.c"
 str_p
# 1120 "project/radare2/libr/util/str.c" 3 4
 , 
# 1120 "project/radare2/libr/util/str.c"
...
# 1121 "project/radare2/libr/util/str.c" 3 4
 __builtin___memcpy_chk (
# 1121 "project/radare2/libr/util/str.c"
 str_p + vlen
# 1121 "project/radare2/libr/util/str.c" 3 4
 , 
# 1121 "project/radare2/libr/util/str.c"
...
# 1132 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1132 "project/radare2/libr/util/str.c"
     char *r_str_replace_in(char *str, 
# 1132 "project/radare2/libr/util/str.c" 3 4
                                       unsigned int 
# 1132 "project/radare2/libr/util/str.c"
                                            sz, const char *key, const char *val, int g) {
 if (!str || !key || !val) {
  return 
# 1134 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 1134 "project/radare2/libr/util/str.c"
            ;
 }
 char *heaped = r_str_replace (strdup (str), key, val, g);
 if (heaped) {
  
# 1138 "project/radare2/libr/util/str.c" 3 4
 __builtin___strncpy_chk (
# 1138 "project/radare2/libr/util/str.c"
 str
# 1138 "project/radare2/libr/util/str.c" 3 4
 , 
# 1138 "project/radare2/libr/util/str.c"
...
# 1144 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1144 "project/radare2/libr/util/str.c"
     int r_str_unescape(char *buf) {
...
# 1194 "project/radare2/libr/util/str.c" 3 4
   fprintf(__stderrp,
# 1194 "project/radare2/libr/util/str.c"
...
# 1200 "project/radare2/libr/util/str.c" 3 4
   fprintf(__stderrp,
# 1200 "project/radare2/libr/util/str.c"
...
# 1200 "project/radare2/libr/util/str.c"
  ...
  default:
   if (
# 1210 "project/radare2/libr/util/str.c" 3 4
      ((
# 1210 "project/radare2/libr/util/str.c"
      buf[i + 1]
# 1210 "project/radare2/libr/util/str.c" 3 4
      ) >= '0' && (
# 1210 "project/radare2/libr/util/str.c"
...
# 1210 "project/radare2/libr/util/str.c"
    ...
    buf[i] = buf[i + 1] - '0';
    if (
# 1213 "project/radare2/libr/util/str.c" 3 4
       ((
# 1213 "project/radare2/libr/util/str.c"
       buf[i + 2]
# 1213 "project/radare2/libr/util/str.c" 3 4
       ) >= '0' && (
# 1213 "project/radare2/libr/util/str.c"
...
# 1213 "project/radare2/libr/util/str.c"
     ...
     num_digits++;
     buf[i] = (
# 1215 "project/radare2/libr/util/str.c" 3 4
              unsigned char
# 1215 "project/radare2/libr/util/str.c"
                 )buf[i] * 8 + (buf[i + 2] - '0');
     if (
# 1216 "project/radare2/libr/util/str.c" 3 4
        ((
# 1216 "project/radare2/libr/util/str.c"
        buf[i + 3]
# 1216 "project/radare2/libr/util/str.c" 3 4
        ) >= '0' && (
# 1216 "project/radare2/libr/util/str.c"
...
# 1216 "project/radare2/libr/util/str.c"
      ...
      num_digits++;
      buf[i] = (
# 1218 "project/radare2/libr/util/str.c" 3 4
               unsigned char
# 1218 "project/radare2/libr/util/str.c"
                  )buf[i] * 8 + (buf[i + 3] - '0');
     }
    }
...
# 1226 "project/radare2/libr/util/str.c" 3 4
 __builtin___memmove_chk (
# 1226 "project/radare2/libr/util/str.c"
 buf + i + 1
# 1226 "project/radare2/libr/util/str.c" 3 4
 , 
# 1226 "project/radare2/libr/util/str.c"
 buf + i + esc_seq_len, strlen (buf + i + esc_seq_len) + 1
# 1226 "project/radare2/libr/util/str.c" 3 4
 , __builtin_object_size (
# 1226 "project/radare2/libr/util/str.c"
 buf + i + 1
...
# 1231 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1231 "project/radare2/libr/util/str.c"
     void r_str_sanitize(char *c) {
 char *d = c;
 if (d) {
  for (; *d; c++, d++) {
   switch (*d) {
...
# 1255 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1255 "project/radare2/libr/util/str.c"
     char *r_str_sanitize_sdb_key(const char *s) {
 if (!s || !*s) {
  return 
# 1257 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 1257 "project/radare2/libr/util/str.c"
            ;
 }
 size_t len = strlen (s);
 ...
 if (!ret) {
  return 
# 1262 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 1262 "project/radare2/libr/util/str.c"
            ;
 }
 char *cur = ret;
 while (len > 0) {
...
# 1280 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1280 "project/radare2/libr/util/str.c"
     void r_str_byte_escape(const char *p, char **dst, int dot_nl, 
# 1280 "project/radare2/libr/util/str.c" 3 4
                                                                   _Bool 
# 1280 "project/radare2/libr/util/str.c"
                                                                        default_dot, 
...
# 1280 "project/radare2/libr/util/str.c"
 ...
 default:
  ...
  if (!
# 1323 "project/radare2/libr/util/str.c" 3 4
      ((
# 1323 "project/radare2/libr/util/str.c"
      *p
# 1323 "project/radare2/libr/util/str.c" 3 4
      ) >=' ' && (
# 1323 "project/radare2/libr/util/str.c"
...
static char *r_str_escape_(const char *buf, int dot_nl, 
# 1341 "project/radare2/libr/util/str.c" 3 4
                                                       _Bool 
# 1341 "project/radare2/libr/util/str.c"
                                                            parse_esc_seq, 
# 1341 "project/radare2/libr/util/str.c" 3 4
                                                                           _Bool 
# 1341 "project/radare2/libr/util/str.c"
...
# 1342 "project/radare2/libr/util/str.c" 3 4
do { if (!(
# 1342 "project/radare2/libr/util/str.c"
buf
# 1342 "project/radare2/libr/util/str.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1342 "project/radare2/libr/util/str.c"
...
# 1342 "project/radare2/libr/util/str.c"
 ...
 if (!new_buf) {
  return 
# 1348 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 1348 "project/radare2/libr/util/str.c"
            ;
 }
 const char *p = buf;
 char *q = new_buf;
...
# 1370 "project/radare2/libr/util/str.c" 3 4
     __builtin___memcpy_chk (
# 1370 "project/radare2/libr/util/str.c"
     q
# 1370 "project/radare2/libr/util/str.c" 3 4
     , 
# 1370 "project/radare2/libr/util/str.c"
     start_seq, p - start_seq + 1
# 1370 "project/radare2/libr/util/str.c" 3 4
     , __builtin_object_size (
# 1370 "project/radare2/libr/util/str.c"
     q
...
# 1388 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1388 "project/radare2/libr/util/str.c"
     char *r_str_escape_raw(const 
# 1388 "project/radare2/libr/util/str.c" 3 4
                                  unsigned char 
# 1388 "project/radare2/libr/util/str.c"
                                      *buf, int sz) {
 
# 1389 "project/radare2/libr/util/str.c" 3 4
do { if (!(
# 1389 "project/radare2/libr/util/str.c"
buf
# 1389 "project/radare2/libr/util/str.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1389 "project/radare2/libr/util/str.c"
...
# 1389 "project/radare2/libr/util/str.c"
 ...
 if (!new_buf) {
  return 
# 1394 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 1394 "project/radare2/libr/util/str.c"
            ;
 }
 char *q = new_buf;
 int i;
 for (i = 0; i < sz; i++) {
  r_str_byte_escape ((char *)&buf[i], &q, 
# 1399 "project/radare2/libr/util/str.c" 3 4
                                         0
# 1399 "project/radare2/libr/util/str.c"
                                              , 
# 1399 "project/radare2/libr/util/str.c" 3 4
                                                0
# 1399 "project/radare2/libr/util/str.c"
...
# 1405 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1405 "project/radare2/libr/util/str.c"
     char *r_str_escape(const char *buf) {
 return r_str_escape_ (buf, 
# 1406 "project/radare2/libr/util/str.c" 3 4
                           0
# 1406 "project/radare2/libr/util/str.c"
                                , 
# 1406 "project/radare2/libr/util/str.c" 3 4
                                  1
# 1406 "project/radare2/libr/util/str.c"
...
# 1409 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1409 "project/radare2/libr/util/str.c"
     char *r_str_sanitize_r2(const char *buf) {
 
# 1410 "project/radare2/libr/util/str.c" 3 4
do { if (!(
# 1410 "project/radare2/libr/util/str.c"
buf
# 1410 "project/radare2/libr/util/str.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1410 "project/radare2/libr/util/str.c"
"buf"
# 1410 "project/radare2/libr/util/str.c" 3 4
, 1410); return (((void *)0)); } } while (0)
# 1410 "project/radare2/libr/util/str.c"
                                ;
 char *new_buf = malloc (1 + strlen (buf) * 2);
 if (!new_buf) {
  return 
# 1413 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 1413 "project/radare2/libr/util/str.c"
            ;
 }
 const char *p = buf;
 char *q = new_buf;
...
# 1436 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1436 "project/radare2/libr/util/str.c"
     char *r_str_escape_sql(const char *buf) {
 
# 1437 "project/radare2/libr/util/str.c" 3 4
do { if (!(
# 1437 "project/radare2/libr/util/str.c"
buf
# 1437 "project/radare2/libr/util/str.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1437 "project/radare2/libr/util/str.c"
"buf"
# 1437 "project/radare2/libr/util/str.c" 3 4
, 1437); return (((void *)0)); } } while (0)
# 1437 "project/radare2/libr/util/str.c"
                                ;
 char *res = r_str_replace (strdup (buf), "'", "\\'", 
# 1438 "project/radare2/libr/util/str.c" 3 4
                                                     1
# 1438 "project/radare2/libr/util/str.c"
                                                         );
 return res;
}
...
# 1443 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1443 "project/radare2/libr/util/str.c"
     char *r_str_escape_sh(const char *buf) {
 
# 1444 "project/radare2/libr/util/str.c" 3 4
do { if (!(
# 1444 "project/radare2/libr/util/str.c"
buf
# 1444 "project/radare2/libr/util/str.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1444 "project/radare2/libr/util/str.c"
"buf"
# 1444 "project/radare2/libr/util/str.c" 3 4
, 1444); return (((void *)0)); } } while (0)
# 1444 "project/radare2/libr/util/str.c"
                                ;
 char *new_buf = malloc (1 + strlen (buf) * 2);
 if (!new_buf) {
  return 
# 1447 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 1447 "project/radare2/libr/util/str.c"
            ;
 }
 const char *p = buf;
 char *q = new_buf;
...
# 1470 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1470 "project/radare2/libr/util/str.c"
     char *r_str_escape_dot(const char *buf) {
 return r_str_escape_ (buf, 
# 1471 "project/radare2/libr/util/str.c" 3 4
                           1
# 1471 "project/radare2/libr/util/str.c"
                               , 
# 1471 "project/radare2/libr/util/str.c" 3 4
                                 1
# 1471 "project/radare2/libr/util/str.c"
...
# 1474 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1474 "project/radare2/libr/util/str.c"
     char *r_str_escape_latin1(const char *buf, 
# 1474 "project/radare2/libr/util/str.c" 3 4
                                                _Bool 
# 1474 "project/radare2/libr/util/str.c"
                                                     show_asciidot, 
...
# 1474 "project/radare2/libr/util/str.c"
                                                                                          colors) {
 return r_str_escape_ (buf, 
# 1475 "project/radare2/libr/util/str.c" 3 4
                           0
# 1475 "project/radare2/libr/util/str.c"
                                , colors, !colors, show_asciidot, esc_bslash);
}

static char *r_str_escape_utf(const char *buf, int buf_size, RStrEnc enc, 
# 1478 "project/radare2/libr/util/str.c" 3 4
                                                                         _Bool 
# 1478 "project/radare2/libr/util/str.c"
                                                                              show_asciidot, 
# 1478 "project/radare2/libr/util/str.c" 3 4
                                                                                             _Bool 
# 1478 "project/radare2/libr/util/str.c"
...
# 1478 "project/radare2/libr/util/str.c"
 ...
 if (!buf) {
  return 
# 1485 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 1485 "project/radare2/libr/util/str.c"
            ;
 }
 switch (enc) {
 ...
 case R_STRING_ENC_UTF32BE:
  if (buf_size < 0) {
   return 
# 1493 "project/radare2/libr/util/str.c" 3 4
         ((void *)0)
# 1493 "project/radare2/libr/util/str.c"
             ;
  }
  if (enc == R_STRING_ENC_UTF16LE || enc == R_STRING_ENC_UTF16BE) {
   end = (char *)r_mem_mem_aligned ((
# 1496 "project/radare2/libr/util/str.c" 3 4
                                    unsigned char 
# 1496 "project/radare2/libr/util/str.c"
                                        *)buf, buf_size, (
# 1496 "project/radare2/libr/util/str.c" 3 4
                                                          unsigned char 
# 1496 "project/radare2/libr/util/str.c"
...
# 1498 "project/radare2/libr/util/str.c" 3 4
                                    unsigned char 
# 1498 "project/radare2/libr/util/str.c"
                                        *)buf, buf_size, (
# 1498 "project/radare2/libr/util/str.c" 3 4
                                                          unsigned char 
# 1498 "project/radare2/libr/util/str.c"
 ...
 if (!new_buf) {
  return 
# 1512 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 1512 "project/radare2/libr/util/str.c"
            ;
 }
 p = buf;
 q = new_buf;
 while (p < end) {
  ...
  case R_STRING_ENC_UTF32BE:
   if (enc == R_STRING_ENC_UTF16LE || enc == R_STRING_ENC_UTF16BE) {
    ch_bytes = r_utf16_decode ((
# 1523 "project/radare2/libr/util/str.c" 3 4
                               unsigned char 
# 1523 "project/radare2/libr/util/str.c"
                                   *)p, end - p, &ch, enc == R_STRING_ENC_UTF16BE);
   } else {
    ch_bytes = r_utf32_decode ((
# 1525 "project/radare2/libr/util/str.c" 3 4
                               unsigned char 
# 1525 "project/radare2/libr/util/str.c"
                                   *)p, end - p, &ch, enc == R_STRING_ENC_UTF32BE);
   }
   if (ch_bytes == 0) {
    p++;
    continue;
   ...
   break;
  default:
   ch_bytes = r_utf8_decode ((
# 1533 "project/radare2/libr/util/str.c" 3 4
                             unsigned char 
# 1533 "project/radare2/libr/util/str.c"
                                 *)p, end - p, &ch);
   if (ch_bytes == 0) {
    ch_bytes = 1;
   }
  ...
  if (show_asciidot && !
# 1538 "project/radare2/libr/util/str.c" 3 4
                       ((
# 1538 "project/radare2/libr/util/str.c"
                       ch
# 1538 "project/radare2/libr/util/str.c" 3 4
                       ) >=' ' && (
# 1538 "project/radare2/libr/util/str.c"
...
# 1538 "project/radare2/libr/util/str.c"
   ...
   *q++ = '.';
   ...
   if (keep_printable) {
    q += r_utf8_encode ((
# 1542 "project/radare2/libr/util/str.c" 3 4
                        unsigned char 
# 1542 "project/radare2/libr/util/str.c"
                            *)q, ch);
   } else {
    *q++ = '\\';
    *q++ = ch_bytes == 4 ? 'U' : 'u';
   ...
   r_str_byte_escape (p + offset, &q, 
# 1553 "project/radare2/libr/util/str.c" 3 4
                                     0
# 1553 "project/radare2/libr/util/str.c"
                                          , 
# 1553 "project/radare2/libr/util/str.c" 3 4
                                            0
# 1553 "project/radare2/libr/util/str.c"
...
# 1572 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1572 "project/radare2/libr/util/str.c"
     char *r_str_escape_utf8(const char *buf, 
# 1572 "project/radare2/libr/util/str.c" 3 4
                                              _Bool 
# 1572 "project/radare2/libr/util/str.c"
                                                   show_asciidot, 
...
# 1573 "project/radare2/libr/util/str.c" 3 4
                                                                                0
# 1573 "project/radare2/libr/util/str.c"
                                                                                     );
}


# 1576 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1576 "project/radare2/libr/util/str.c"
     char *r_str_escape_utf8_keep_printable(const char *buf, 
# 1576 "project/radare2/libr/util/str.c" 3 4
                                                             _Bool 
# 1576 "project/radare2/libr/util/str.c"
                                                                  show_asciidot, 
...
# 1576 "project/radare2/libr/util/str.c"
                                                                                      esc_bslash) {
 return r_str_escape_utf (buf, -1, R_STRING_ENC_UTF8, show_asciidot, esc_bslash, 
# 1577 "project/radare2/libr/util/str.c" 3 4
                                                                                1
# 1577 "project/radare2/libr/util/str.c"
                                                                                    );
}


# 1580 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1580 "project/radare2/libr/util/str.c"
     char *r_str_escape_utf16le(const char *buf, int buf_size, 
# 1580 "project/radare2/libr/util/str.c" 3 4
                                                               _Bool 
# 1580 "project/radare2/libr/util/str.c"
                                                                    show_asciidot, 
...
# 1581 "project/radare2/libr/util/str.c" 3 4
                                                                                         0
# 1581 "project/radare2/libr/util/str.c"
                                                                                              );
}


# 1584 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1584 "project/radare2/libr/util/str.c"
     char *r_str_escape_utf32le(const char *buf, int buf_size, 
# 1584 "project/radare2/libr/util/str.c" 3 4
                                                               _Bool 
# 1584 "project/radare2/libr/util/str.c"
                                                                    show_asciidot, 
...
# 1585 "project/radare2/libr/util/str.c" 3 4
                                                                                         0
# 1585 "project/radare2/libr/util/str.c"
                                                                                              );
}


# 1588 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1588 "project/radare2/libr/util/str.c"
     char *r_str_escape_utf16be(const char *buf, int buf_size, 
# 1588 "project/radare2/libr/util/str.c" 3 4
                                                               _Bool 
# 1588 "project/radare2/libr/util/str.c"
                                                                    show_asciidot, 
...
# 1589 "project/radare2/libr/util/str.c" 3 4
                                                                                         0
# 1589 "project/radare2/libr/util/str.c"
                                                                                              );
}


# 1592 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1592 "project/radare2/libr/util/str.c"
     char *r_str_escape_utf32be(const char *buf, int buf_size, 
# 1592 "project/radare2/libr/util/str.c" 3 4
                                                               _Bool 
# 1592 "project/radare2/libr/util/str.c"
                                                                    show_asciidot, 
...
# 1593 "project/radare2/libr/util/str.c" 3 4
                                                                                         0
# 1593 "project/radare2/libr/util/str.c"
                                                                                              );
}


# 1596 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1596 "project/radare2/libr/util/str.c"
     char *r_str_encoded_json(const char *buf, int buf_size, int encoding) {
 
# 1597 "project/radare2/libr/util/str.c" 3 4
do { if (!(
# 1597 "project/radare2/libr/util/str.c"
buf
# 1597 "project/radare2/libr/util/str.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1597 "project/radare2/libr/util/str.c"
...
# 1597 "project/radare2/libr/util/str.c"
 ...
 if (encoding == PJ_ENCODING_STR_BASE64) {
  ...
  if (!SZT_MUL_OVFCHK (((buf_sz * increment) + 1), 
# 1608 "project/radare2/libr/util/str.c" 3 4
                                                  0xFFFFFFFFFFFFFFFFULL
# 1608 "project/radare2/libr/util/str.c"
                                                         )) {
   return 
# 1609 "project/radare2/libr/util/str.c" 3 4
         ((void *)0)
# 1609 "project/radare2/libr/util/str.c"
             ;
  }
  ...
  if (!encoded_str) {
   return 
# 1615 "project/radare2/libr/util/str.c" 3 4
         ((void *)0)
# 1615 "project/radare2/libr/util/str.c"
             ;
  }
...
# 1620 "project/radare2/libr/util/str.c" 3 4
  __builtin___snprintf_chk (
# 1620 "project/radare2/libr/util/str.c"
  encoded_str + i
# 1620 "project/radare2/libr/util/str.c" 3 4
  , 
# 1620 "project/radare2/libr/util/str.c"
...
# 1638 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1638 "project/radare2/libr/util/str.c"
     char *r_str_escape_utf8_for_json_strip(const char *buf, int buf_size) {
 char *new_buf, *q;
 const char *p, *end;
 RRune ch;
 int i, len, ch_bytes;
 ...
 if (!buf) {
  return 
# 1645 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 1645 "project/radare2/libr/util/str.c"
            ;
 }
 ...
 if (!new_buf) {
  return 
# 1652 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 1652 "project/radare2/libr/util/str.c"
            ;
 }
 p = buf;
 q = new_buf;
 while (p < end) {
  ch_bytes = r_utf8_decode ((
# 1657 "project/radare2/libr/util/str.c" 3 4
                            unsigned char 
# 1657 "project/radare2/libr/util/str.c"
                                *)p, end - p, &ch);
  if (ch_bytes == 1) {
   switch (*p) {
   case '\n':
   ...
   default:
    if (
# 1689 "project/radare2/libr/util/str.c" 3 4
       ((
# 1689 "project/radare2/libr/util/str.c"
       *p
# 1689 "project/radare2/libr/util/str.c" 3 4
       ) >=' ' && (
# 1689 "project/radare2/libr/util/str.c"
...
# 1741 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1741 "project/radare2/libr/util/str.c"
     char *r_str_escape_utf8_for_json(const char *buf, int buf_size) {
 char *new_buf, *q;
 const char *p, *end;
 RRune ch;
 int i, len, ch_bytes;
 ...
 if (!buf) {
  return 
# 1748 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 1748 "project/radare2/libr/util/str.c"
            ;
 }
 len = buf_size < 0 ? strlen (buf) : buf_size;
 end = buf + len;
 ...
 if (!new_buf) {
  return 
# 1755 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 1755 "project/radare2/libr/util/str.c"
            ;
 }
 p = buf;
 q = new_buf;
 while (p < end) {
  ch_bytes = r_utf8_decode ((
# 1760 "project/radare2/libr/util/str.c" 3 4
                            unsigned char 
# 1760 "project/radare2/libr/util/str.c"
                                *)p, end - p, &ch);
  if (ch_bytes == 1) {
   switch (*p) {
   case '\n':
   ...
   default:
    if (!
# 1792 "project/radare2/libr/util/str.c" 3 4
        ((
# 1792 "project/radare2/libr/util/str.c"
        *p
# 1792 "project/radare2/libr/util/str.c" 3 4
        ) >=' ' && (
# 1792 "project/radare2/libr/util/str.c"
...
# 1858 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1858 "project/radare2/libr/util/str.c"
     char *r_str_format_msvc_argv(size_t argc, const char **argv) {
 RStrBuf sb;
 r_strbuf_init (&sb);
...
# 1868 "project/radare2/libr/util/str.c" 3 4
 _Bool 
# 1868 "project/radare2/libr/util/str.c"
      must_escape = strchr (arg, '\"') != 
# 1868 "project/radare2/libr/util/str.c" 3 4
                                          ((void *)0)
# 1868 "project/radare2/libr/util/str.c"
                                              ;
  
# 1869 "project/radare2/libr/util/str.c" 3 4
 _Bool 
# 1869 "project/radare2/libr/util/str.c"
      must_quote = strpbrk (arg, " \t") != 
# 1869 "project/radare2/libr/util/str.c" 3 4
                                           ((void *)0) 
# 1869 "project/radare2/libr/util/str.c"
                                                || !*arg;
  if (!must_escape && must_quote && *arg && arg[strlen (arg) - 1] == '\\') {
   ...
   must_escape = 
# 1872 "project/radare2/libr/util/str.c" 3 4
                1
# 1872 "project/radare2/libr/util/str.c"
                    ;
  }
  if (must_quote) {
   r_strbuf_append (&sb, "\"");
...
# 1937 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1937 "project/radare2/libr/util/str.c"
     size_t r_str_ansi_nlen(const char *str, size_t slen) {
 size_t i = 0, len = 0;
 if (slen > 0) {
  while (str[i] && i < slen) {
...
# 1959 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1959 "project/radare2/libr/util/str.c"
     size_t r_str_ansi_len(const char *str) {
 return r_str_ansi_nlen (str, 0);
}


# 1963 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1963 "project/radare2/libr/util/str.c"
     size_t r_str_nlen(const char *str, int n) {
 size_t len = 0;
 if (str) {
  while (n > 0 && *str) {
   len++;
...
# 1977 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 1977 "project/radare2/libr/util/str.c"
     size_t r_str_nlen_w(const char *str, int n) {
 size_t len = 0;
 if (str) {
  while (*str && n > 0) {
   len++;
...
# 1999 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 1999 "project/radare2/libr/util/str.c"
          r_str_is_ascii(const char *str) {
 const 
# 2000 "project/radare2/libr/util/str.c" 3 4
      unsigned char 
# 2000 "project/radare2/libr/util/str.c"
          *ptr;
 for (ptr = (const 
# 2001 "project/radare2/libr/util/str.c" 3 4
                  unsigned char 
# 2001 "project/radare2/libr/util/str.c"
                      *)str; *ptr; ptr++) {
  if (*ptr > 0x7f) {
   return 
# 2003 "project/radare2/libr/util/str.c" 3 4
         0
# 2003 "project/radare2/libr/util/str.c"
              ;
  }
 }
 return 
# 2006 "project/radare2/libr/util/str.c" 3 4
       1
# 2006 "project/radare2/libr/util/str.c"
           ;
}


# 2009 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 2009 "project/radare2/libr/util/str.c"
          r_str_is_printable(const char *str) {
 while (*str) {
  int ulen = r_utf8_decode ((const 
# 2011 "project/radare2/libr/util/str.c" 3 4
                                  unsigned char
# 2011 "project/radare2/libr/util/str.c"
                                     *)str, strlen (str), 
# 2011 "project/radare2/libr/util/str.c" 3 4
                                                          ((void *)0)
# 2011 "project/radare2/libr/util/str.c"
  ...
  if (!
# 2016 "project/radare2/libr/util/str.c" 3 4
      ((
# 2016 "project/radare2/libr/util/str.c"
      *str
# 2016 "project/radare2/libr/util/str.c" 3 4
      ) >=' ' && (
# 2016 "project/radare2/libr/util/str.c"
...
# 2016 "project/radare2/libr/util/str.c"
   ...
   return 
# 2017 "project/radare2/libr/util/str.c" 3 4
         0
# 2017 "project/radare2/libr/util/str.c"
              ;
  }
  str++;
 }
 return 
# 2021 "project/radare2/libr/util/str.c" 3 4
       1
# 2021 "project/radare2/libr/util/str.c"
           ;
}


# 2024 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 2024 "project/radare2/libr/util/str.c"
          r_str_is_printable_limited(const char *str, int size) {
 while (size > 0 && *str) {
  int ulen = r_utf8_decode ((const 
# 2026 "project/radare2/libr/util/str.c" 3 4
                                  unsigned char
# 2026 "project/radare2/libr/util/str.c"
                                     *)str, strlen (str), 
# 2026 "project/radare2/libr/util/str.c" 3 4
                                                          ((void *)0)
# 2026 "project/radare2/libr/util/str.c"
  ...
  if (!
# 2031 "project/radare2/libr/util/str.c" 3 4
      ((
# 2031 "project/radare2/libr/util/str.c"
      *str
# 2031 "project/radare2/libr/util/str.c" 3 4
      ) >=' ' && (
# 2031 "project/radare2/libr/util/str.c"
...
# 2031 "project/radare2/libr/util/str.c"
   ...
   return 
# 2032 "project/radare2/libr/util/str.c" 3 4
         0
# 2032 "project/radare2/libr/util/str.c"
              ;
  }
  str++;
  size--;
 ...
 return 
# 2037 "project/radare2/libr/util/str.c" 3 4
       1
# 2037 "project/radare2/libr/util/str.c"
           ;
}


# 2040 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 2040 "project/radare2/libr/util/str.c"
          r_str_is_printable_incl_newlines(const char *str) {
 while (*str) {
  int ulen = r_utf8_decode ((const 
# 2042 "project/radare2/libr/util/str.c" 3 4
                                  unsigned char
# 2042 "project/radare2/libr/util/str.c"
                                     *)str, strlen (str), 
# 2042 "project/radare2/libr/util/str.c" 3 4
                                                          ((void *)0)
# 2042 "project/radare2/libr/util/str.c"
  ...
  if (!
# 2047 "project/radare2/libr/util/str.c" 3 4
      ((
# 2047 "project/radare2/libr/util/str.c"
      *str
# 2047 "project/radare2/libr/util/str.c" 3 4
      ) >=' ' && (
# 2047 "project/radare2/libr/util/str.c"
...
# 2047 "project/radare2/libr/util/str.c"
   ...
   if (*str != '\r' && *str != '\n' && *str != '\t') {
    return 
# 2049 "project/radare2/libr/util/str.c" 3 4
          0
# 2049 "project/radare2/libr/util/str.c"
               ;
   }
  }
  str++;
 ...
 return 
# 2054 "project/radare2/libr/util/str.c" 3 4
       1
# 2054 "project/radare2/libr/util/str.c"
           ;
}



# 2058 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2058 "project/radare2/libr/util/str.c"
     size_t r_wstr_clen(const char *s) {
 size_t len = 0;
 if (!*s++) {
  return 0;
 }
...
# 2070 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2070 "project/radare2/libr/util/str.c"
...
# 2100 "project/radare2/libr/util/str.c"

# 2100 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2100 "project/radare2/libr/util/str.c"
     int r_str_ansi_filter(char *str, char **out, int **cposs, int len) {
 int i, j, *cps;
...
# 2113 "project/radare2/libr/util/str.c" 3 4
__builtin___memcpy_chk (
# 2113 "project/radare2/libr/util/str.c"
tmp
# 2113 "project/radare2/libr/util/str.c" 3 4
, 
# 2113 "project/radare2/libr/util/str.c"
...
# 2150 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2150 "project/radare2/libr/util/str.c"
     char *r_str_ansi_crop(const char *str, 
# 2150 "project/radare2/libr/util/str.c" 3 4
                                            unsigned int 
# 2150 "project/radare2/libr/util/str.c"
                                                 x, 
...
# 2154 "project/radare2/libr/util/str.c" 3 4
unsigned int 
# 2154 "project/radare2/libr/util/str.c"
     ch = 0, cw = 0;
 if (x2 <= x || y2 <= y || !str) {
  return strdup ("");
 }
 ...
 r_len = str_len + nr_of_lines * strlen (
# 2166 "project/radare2/libr/util/str.c" 3 4
                                        "\x1b[0m"
# 2166 "project/radare2/libr/util/str.c"
                                                   ) + 1;
 r = ret = malloc (r_len);
 if (!r) {
  return 
# 2169 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 2169 "project/radare2/libr/util/str.c"
            ;
 }
 r_end = r + r_len;
 while (*str) {
  ...
  if (*str == '\n') {
   if (ch >= y && ch < y2) {
    const char *reset = 
# 2180 "project/radare2/libr/util/str.c" 3 4
                       "\x1b[0m" 
# 2180 "project/radare2/libr/util/str.c"
                                   "\n";
    if (strlen (reset) < (r_end - r)) {
     const int reset_length = strlen (reset);
     
# 2183 "project/radare2/libr/util/str.c" 3 4
    __builtin___memcpy_chk (
# 2183 "project/radare2/libr/util/str.c"
    r
# 2183 "project/radare2/libr/util/str.c" 3 4
    , 
# 2183 "project/radare2/libr/util/str.c"
    reset, reset_length + 1
# 2183 "project/radare2/libr/util/str.c" 3 4
    , __builtin_object_size (
# 2183 "project/radare2/libr/util/str.c"
    r
...
# 2240 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2240 "project/radare2/libr/util/str.c"
...
# 2253 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 2253 "project/radare2/libr/util/str.c"
          r_str_char_fullwidth(const char* s, size_t left) {
 size_t codepoint = r_str_utf8_codepoint (s, left);
 return (codepoint >= 0x1100 &&
   (codepoint <= 0x115f ||
     codepoint == 0x2329 || codepoint == 0x232a ||
   (
# 2258 "project/radare2/libr/util/str.c" 3 4
   (((
# 2258 "project/radare2/libr/util/str.c"
   codepoint
# 2258 "project/radare2/libr/util/str.c" 3 4
   )>=(
# 2258 "project/radare2/libr/util/str.c"
...
# 2259 "project/radare2/libr/util/str.c"
  && codepoint != 0x303f) ||
   
# 2260 "project/radare2/libr/util/str.c" 3 4
  (((
# 2260 "project/radare2/libr/util/str.c"
  codepoint
# 2260 "project/radare2/libr/util/str.c" 3 4
  )>=(
# 2260 "project/radare2/libr/util/str.c"
...
# 2261 "project/radare2/libr/util/str.c" 3 4
  (((
# 2261 "project/radare2/libr/util/str.c"
  codepoint
# 2261 "project/radare2/libr/util/str.c" 3 4
  )>=(
# 2261 "project/radare2/libr/util/str.c"
...
# 2262 "project/radare2/libr/util/str.c" 3 4
  (((
# 2262 "project/radare2/libr/util/str.c"
  codepoint
# 2262 "project/radare2/libr/util/str.c" 3 4
  )>=(
# 2262 "project/radare2/libr/util/str.c"
...
# 2263 "project/radare2/libr/util/str.c" 3 4
  (((
# 2263 "project/radare2/libr/util/str.c"
  codepoint
# 2263 "project/radare2/libr/util/str.c" 3 4
  )>=(
# 2263 "project/radare2/libr/util/str.c"
...
# 2264 "project/radare2/libr/util/str.c" 3 4
  (((
# 2264 "project/radare2/libr/util/str.c"
  codepoint
# 2264 "project/radare2/libr/util/str.c" 3 4
  )>=(
# 2264 "project/radare2/libr/util/str.c"
...
# 2265 "project/radare2/libr/util/str.c" 3 4
  (((
# 2265 "project/radare2/libr/util/str.c"
  codepoint
# 2265 "project/radare2/libr/util/str.c" 3 4
  )>=(
# 2265 "project/radare2/libr/util/str.c"
...
# 2266 "project/radare2/libr/util/str.c" 3 4
  (((
# 2266 "project/radare2/libr/util/str.c"
  codepoint
# 2266 "project/radare2/libr/util/str.c" 3 4
  )>=(
# 2266 "project/radare2/libr/util/str.c"
...
# 2267 "project/radare2/libr/util/str.c" 3 4
  (((
# 2267 "project/radare2/libr/util/str.c"
  codepoint
# 2267 "project/radare2/libr/util/str.c" 3 4
  )>=(
# 2267 "project/radare2/libr/util/str.c"
...
# 2275 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2275 "project/radare2/libr/util/str.c"
     size_t r_str_utf8_charsize(const char *str) {
 
# 2276 "project/radare2/libr/util/str.c" 3 4
do { if (!(
# 2276 "project/radare2/libr/util/str.c"
str
# 2276 "project/radare2/libr/util/str.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 2276 "project/radare2/libr/util/str.c"
...
# 2294 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2294 "project/radare2/libr/util/str.c"
     size_t r_str_utf8_charsize_prev(const char *str, int prev_len) {
 
# 2295 "project/radare2/libr/util/str.c" 3 4
do { if (!(
# 2295 "project/radare2/libr/util/str.c"
str
# 2295 "project/radare2/libr/util/str.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 2295 "project/radare2/libr/util/str.c"
...
# 2295 "project/radare2/libr/util/str.c"
                             ;
 int pos = 0;
 size_t size = 0, minsize = 
# 2297 "project/radare2/libr/util/str.c" 3 4
                           (((
# 2297 "project/radare2/libr/util/str.c"
                           5
# 2297 "project/radare2/libr/util/str.c" 3 4
                           )>(
# 2297 "project/radare2/libr/util/str.c"
...
# 2312 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2312 "project/radare2/libr/util/str.c"
     size_t r_str_utf8_charsize_last(const char *str) {
 
# 2313 "project/radare2/libr/util/str.c" 3 4
do { if (!(
# 2313 "project/radare2/libr/util/str.c"
str
# 2313 "project/radare2/libr/util/str.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 2313 "project/radare2/libr/util/str.c"
...
# 2318 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2318 "project/radare2/libr/util/str.c"
     void r_str_filter_zeroline(char *str, int len) {
 int i;
 for (i = 0; i < len && str[i]; i++) {
  ...
  if (!
# 2324 "project/radare2/libr/util/str.c" 3 4
      ((
# 2324 "project/radare2/libr/util/str.c"
      str[i]
# 2324 "project/radare2/libr/util/str.c" 3 4
      ) >=' ' && (
# 2324 "project/radare2/libr/util/str.c"
...
# 2331 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2331 "project/radare2/libr/util/str.c"
     void r_str_filter(char *str, int len) {
 size_t i;
 if (len < 1) {
  len = strlen (str);
 }
 for (i = 0; i < len; i++) {
  if (!
# 2337 "project/radare2/libr/util/str.c" 3 4
      ((
# 2337 "project/radare2/libr/util/str.c"
      str[i]
# 2337 "project/radare2/libr/util/str.c" 3 4
      ) >=' ' && (
# 2337 "project/radare2/libr/util/str.c"
...
# 2343 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 2343 "project/radare2/libr/util/str.c"
          r_str_glob(const char* str, const char *glob) {
 if (!glob) {
  return 
# 2345 "project/radare2/libr/util/str.c" 3 4
        1
# 2345 "project/radare2/libr/util/str.c"
            ;
 }
 ...
 while (*str) {
  if (!*glob) {
   return 
# 2353 "project/radare2/libr/util/str.c" 3 4
         1
# 2353 "project/radare2/libr/util/str.c"
             ;
  }
  switch (*glob) {
  case '*':
   if (!*++glob) {
    return 
# 2358 "project/radare2/libr/util/str.c" 3 4
          1
# 2358 "project/radare2/libr/util/str.c"
              ;
   }
   while (*str) {
    if (*glob == *str) {
  ...
  default:
   if (*glob != *str) {
    return 
# 2375 "project/radare2/libr/util/str.c" 3 4
          0
# 2375 "project/radare2/libr/util/str.c"
               ;
   }
   str++;
   glob++;
...
# 2386 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2386 "project/radare2/libr/util/str.c"
     char *r_str_arg_escape(const char *arg) {
 char *str;
 int dest_i = 0, src_i = 0;
 if (!arg) {
  return 
# 2390 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 2390 "project/radare2/libr/util/str.c"
            ;
 }
 str = malloc ((2 * strlen (arg) + 1) * sizeof (char));
 if (!str) {
  return 
# 2394 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 2394 "project/radare2/libr/util/str.c"
            ;
 }
...
# 2416 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2416 "project/radare2/libr/util/str.c"
     int r_str_arg_unescape(char *arg) {
 int dest_i = 0, src_i = 0;
 if (!arg) {
  return 0;
 }
...
# 2436 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2436 "project/radare2/libr/util/str.c"
     char *r_str_path_escape(const char *path) {
 char *str;
 int dest_i = 0, src_i = 0;

 if (!path) {
  return 
# 2441 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 2441 "project/radare2/libr/util/str.c"
            ;
 }
 ...
 if (!str) {
  return 
# 2446 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 2446 "project/radare2/libr/util/str.c"
            ;
 }
...
# 2466 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2466 "project/radare2/libr/util/str.c"
     int r_str_path_unescape(char *path) {
 int i;
...
# 2475 "project/radare2/libr/util/str.c" 3 4
  __builtin___memmove_chk (
# 2475 "project/radare2/libr/util/str.c"
  path + i + 1
# 2475 "project/radare2/libr/util/str.c" 3 4
  , 
# 2475 "project/radare2/libr/util/str.c"
  path + i + 2, strlen (path + i + 2) + 1
# 2475 "project/radare2/libr/util/str.c" 3 4
  , __builtin_object_size (
# 2475 "project/radare2/libr/util/str.c"
  path + i + 1
...
# 2482 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2482 "project/radare2/libr/util/str.c"
     char **r_str_argv(const char *cmdline, int *_argc) {
 int argc = 0;
 int argv_len = 128;
 char *args;
 ...
 if (!cmdline) {
  return 
# 2491 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 2491 "project/radare2/libr/util/str.c"
            ;
 }
 ...
 if (!argv) {
  return 
# 2496 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 2496 "project/radare2/libr/util/str.c"
            ;
 }
 ...
 if (!args) {
  free (argv);
  return 
# 2501 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 2501 "project/radare2/libr/util/str.c"
            ;
 }
 do {
...
# 2510 "project/radare2/libr/util/str.c" 3 4
                                            ((
# 2510 "project/radare2/libr/util/str.c"
...
# 2510 "project/radare2/libr/util/str.c"
  ...
  if (argc >= argv_len) {
   ...
   if (!tmp) {
    ...
    free (argv);
    return 
# 2585 "project/radare2/libr/util/str.c" 3 4
          ((void *)0)
# 2585 "project/radare2/libr/util/str.c"
              ;
   }
   argv = tmp;
  }
 ...
 argv[argc] = 
# 2591 "project/radare2/libr/util/str.c" 3 4
             ((void *)0)
# 2591 "project/radare2/libr/util/str.c"
                 ;
 ...
 if (tmp) {
  ...
  free (argv);
  argv = 
# 2597 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 2597 "project/radare2/libr/util/str.c"
            ;
 }
 if (_argc) {
  *_argc = argc;
...
# 2606 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2606 "project/radare2/libr/util/str.c"
     void r_str_argv_free(char **argv) {
 int argc = 0;
 if (!argv) {
  return;
 }
...
# 2617 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2617 "project/radare2/libr/util/str.c"
     const char *r_str_firstbut(const char *s, char ch, const char *but) {
 int idx, _b = 0;
 
# 2619 "project/radare2/libr/util/str.c" 3 4
unsigned char 
# 2619 "project/radare2/libr/util/str.c"
    *b = (
# 2619 "project/radare2/libr/util/str.c" 3 4
          unsigned char
# 2619 "project/radare2/libr/util/str.c"
...
# 2626 "project/radare2/libr/util/str.c" 3 4
 fprintf(__stderrp,
# 2626 "project/radare2/libr/util/str.c"
 "r_str_firstbut: but string too long\n"
# 2626 "project/radare2/libr/util/str.c" 3 4
 )
# 2626 "project/radare2/libr/util/str.c"
                                                  ;
  return 
# 2627 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 2627 "project/radare2/libr/util/str.c"
            ;
 }
 for (p = s; *p; p++) {
  isbut = strchr (but, *p);
  if (isbut) {
   ...
   _b = 
# 2633 "project/radare2/libr/util/str.c" 3 4
       ( (*(
# 2633 "project/radare2/libr/util/str.c"
       b
# 2633 "project/radare2/libr/util/str.c" 3 4
       ) & (1<<(
# 2633 "project/radare2/libr/util/str.c"
...
# 2633 "project/radare2/libr/util/str.c"
 ...
 return 
# 2640 "project/radare2/libr/util/str.c" 3 4
       ((void *)0)
# 2640 "project/radare2/libr/util/str.c"
           ;
}


# 2643 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2643 "project/radare2/libr/util/str.c"
     const char *r_str_firstbut_escape(const char *s, char ch, const char *but) {
 int idx, _b = 0;
 
# 2645 "project/radare2/libr/util/str.c" 3 4
unsigned char 
# 2645 "project/radare2/libr/util/str.c"
    *b = (
# 2645 "project/radare2/libr/util/str.c" 3 4
          unsigned char
# 2645 "project/radare2/libr/util/str.c"
...
# 2652 "project/radare2/libr/util/str.c" 3 4
 fprintf(__stderrp,
# 2652 "project/radare2/libr/util/str.c"
 "r_str_firstbut: but string too long\n"
# 2652 "project/radare2/libr/util/str.c" 3 4
 )
# 2652 "project/radare2/libr/util/str.c"
                                                  ;
  return 
# 2653 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 2653 "project/radare2/libr/util/str.c"
            ;
 }
 for (p = s; *p; p++) {
  if (*p == '\\') {
  ...
  if (isbut) {
   idx = (int)(size_t)(isbut - but);
   _b = 
# 2670 "project/radare2/libr/util/str.c" 3 4
       ( (*(
# 2670 "project/radare2/libr/util/str.c"
       b
# 2670 "project/radare2/libr/util/str.c" 3 4
       ) & (1<<(
# 2670 "project/radare2/libr/util/str.c"
...
# 2670 "project/radare2/libr/util/str.c"
   ...
   if (_b && (_b & (_b - 1))) {
    _b = 
# 2672 "project/radare2/libr/util/str.c" 3 4
        ( (*(
# 2672 "project/radare2/libr/util/str.c"
        b
# 2672 "project/radare2/libr/util/str.c" 3 4
        ) & (1<<(
# 2672 "project/radare2/libr/util/str.c"
...
# 2672 "project/radare2/libr/util/str.c"
 ...
 return 
# 2680 "project/radare2/libr/util/str.c" 3 4
       ((void *)0)
# 2680 "project/radare2/libr/util/str.c"
           ;
}


# 2683 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2683 "project/radare2/libr/util/str.c"
     const char *r_str_lastbut(const char *s, char ch, const char *but) {
 int idx, _b = 0;
 
# 2685 "project/radare2/libr/util/str.c" 3 4
unsigned char 
# 2685 "project/radare2/libr/util/str.c"
    *b = (
# 2685 "project/radare2/libr/util/str.c" 3 4
          unsigned char
# 2685 "project/radare2/libr/util/str.c"
             *)&_b;
 const char *isbut, *p, *lp = 
# 2686 "project/radare2/libr/util/str.c" 3 4
                             ((void *)0)
# 2686 "project/radare2/libr/util/str.c"
                                 ;
 const int bsz = sizeof (_b) * 8;
 if (!but) {
...
# 2692 "project/radare2/libr/util/str.c" 3 4
 fprintf(__stderrp,
# 2692 "project/radare2/libr/util/str.c"
 "r_str_lastbut: but string too long\n"
# 2692 "project/radare2/libr/util/str.c" 3 4
 )
# 2692 "project/radare2/libr/util/str.c"
                                                 ;
  return 
# 2693 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 2693 "project/radare2/libr/util/str.c"
            ;
 }
 for (p = s; *p; p++) {
  isbut = strchr (but, *p);
  if (isbut) {
   idx = (int)(size_t)(isbut - but);
   _b = 
# 2699 "project/radare2/libr/util/str.c" 3 4
       ( (*(
# 2699 "project/radare2/libr/util/str.c"
       b
# 2699 "project/radare2/libr/util/str.c" 3 4
       ) & (1<<(
# 2699 "project/radare2/libr/util/str.c"
...
# 2710 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2710 "project/radare2/libr/util/str.c"
     size_t r_str_len_utf8char(const char *s, int left) {
 size_t i = 1;
...
# 2722 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2722 "project/radare2/libr/util/str.c"
...
# 2736 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2736 "project/radare2/libr/util/str.c"
     size_t r_str_len_utf8_ansi(const char *str) {
...
# 2755 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2755 "project/radare2/libr/util/str.c"
     const char *r_strstr_ansi(const char *a, const char *b) {
 const char *ch, *p = a;
 do {
  ch = strchr (p, '\x1b');
  if (ch) {
...
# 2770 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2770 "project/radare2/libr/util/str.c"
     const char *r_str_casestr(const char *a, const char *b) {
 ...
 if (!hay_len || !needle_len) {
  return 
# 2776 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 2776 "project/radare2/libr/util/str.c"
            ;
 }
 ...
 return 
# 2785 "project/radare2/libr/util/str.c" 3 4
       ((void *)0)
# 2785 "project/radare2/libr/util/str.c"
           ;
}


# 2788 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2788 "project/radare2/libr/util/str.c"
     int r_str_write(int fd, const char *b) {
 return write (fd, b, strlen (b));
}


# 2792 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2792 "project/radare2/libr/util/str.c"
 ...
 for (; *r; r++) {
  ...
  if (*r == '-') {
   if (p != r) {
    ...
    fprintf (
# 2807 "project/radare2/libr/util/str.c" 3 4
            __stderrp
# 2807 "project/radare2/libr/util/str.c"
                  , "Invalid range\n");
   }
   for (r++; *r && *r != ',' && *r != '-'; r++) {
    ;
...
# 2820 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 2820 "project/radare2/libr/util/str.c"
          r_str_range_in(const char *r, 
# 2820 "project/radare2/libr/util/str.c" 3 4
                                        unsigned long long 
# 2820 "project/radare2/libr/util/str.c"
                                             addr) {
...
# 2822 "project/radare2/libr/util/str.c" 3 4
unsigned long long 
# 2822 "project/radare2/libr/util/str.c"
     min = 
# 2822 "project/radare2/libr/util/str.c" 3 4
           0xFFFFFFFFFFFFFFFFULL
# 2822 "project/radare2/libr/util/str.c"
...
# 2823 "project/radare2/libr/util/str.c" 3 4
unsigned long long 
# 2823 "project/radare2/libr/util/str.c"
     max = 0;
 if (!r) {
  return 
# 2825 "project/radare2/libr/util/str.c" 3 4
        0
# 2825 "project/radare2/libr/util/str.c"
             ;
 }
 for (; *r; r++) {
  if (*r == ',') {
   if (max == 0) {
    if (addr == r_num_get (
# 2830 "project/radare2/libr/util/str.c" 3 4
                          ((void *)0)
# 2830 "project/radare2/libr/util/str.c"
                              , p)) {
     return 
# 2831 "project/radare2/libr/util/str.c" 3 4
           1
# 2831 "project/radare2/libr/util/str.c"
               ;
    }
   } else {
    if (addr >= min && addr <= r_num_get (
# 2834 "project/radare2/libr/util/str.c" 3 4
                                         ((void *)0)
# 2834 "project/radare2/libr/util/str.c"
                                             , p)) {
     return 
# 2835 "project/radare2/libr/util/str.c" 3 4
           1
# 2835 "project/radare2/libr/util/str.c"
               ;
    }
   }
   p = r + 1;
...
# 2842 "project/radare2/libr/util/str.c" 3 4
   unsigned long long 
# 2842 "project/radare2/libr/util/str.c"
        from = r_num_get (
# 2842 "project/radare2/libr/util/str.c" 3 4
                          ((void *)0)
# 2842 "project/radare2/libr/util/str.c"
...
# 2843 "project/radare2/libr/util/str.c" 3 4
   unsigned long long 
# 2843 "project/radare2/libr/util/str.c"
        to = r_num_get (
# 2843 "project/radare2/libr/util/str.c" 3 4
                        ((void *)0)
# 2843 "project/radare2/libr/util/str.c"
    ...
    if (addr >= from && addr <= to) {
     return 
# 2845 "project/radare2/libr/util/str.c" 3 4
           1
# 2845 "project/radare2/libr/util/str.c"
               ;
    }
   } else {
    fprintf (
# 2848 "project/radare2/libr/util/str.c" 3 4
            __stderrp
# 2848 "project/radare2/libr/util/str.c"
                  , "Invalid range\n");
   }
   for (r++; *r && *r != ',' && *r != '-'; r++) {
    ;
 ...
 if (*p) {
  if (addr == r_num_get (
# 2857 "project/radare2/libr/util/str.c" 3 4
                        ((void *)0)
# 2857 "project/radare2/libr/util/str.c"
                            , p)) {
   return 
# 2858 "project/radare2/libr/util/str.c" 3 4
         1
# 2858 "project/radare2/libr/util/str.c"
             ;
  }
 }
 return 
# 2861 "project/radare2/libr/util/str.c" 3 4
       0
# 2861 "project/radare2/libr/util/str.c"
            ;
}
...
# 2866 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2866 "project/radare2/libr/util/str.c"
     void r_str_uri_decode(char *s) {
 int n;
 char *d;
 for (d = s; *s; s++, d++) {
  if (*s == '%') {
...
# 2881 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2881 "project/radare2/libr/util/str.c"
     char *r_str_uri_encode(const char *s) {
 char ch[4], *d, *od;
 if (!s) {
  return 
# 2884 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 2884 "project/radare2/libr/util/str.c"
            ;
 }
 od = d = malloc (1 + (strlen (s) * 4));
 if (!d) {
  return 
# 2888 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 2888 "project/radare2/libr/util/str.c"
            ;
 }
 for (; *s; s++) {
  if((*s>='0' && *s<='9')
...
# 2897 "project/radare2/libr/util/str.c" 3 4
  __builtin___snprintf_chk (
# 2897 "project/radare2/libr/util/str.c"
  ch
# 2897 "project/radare2/libr/util/str.c" 3 4
  , 
# 2897 "project/radare2/libr/util/str.c"
...
# 2907 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2907 "project/radare2/libr/util/str.c"
     int r_str_utf16_to_utf8(
# 2907 "project/radare2/libr/util/str.c" 3 4
                             unsigned char 
# 2907 "project/radare2/libr/util/str.c"
                                 *dst, int len_dst, const 
# 2907 "project/radare2/libr/util/str.c" 3 4
                                                          unsigned char 
# 2907 "project/radare2/libr/util/str.c"
                                                              *src, int len_src, int little_endian) {
 
# 2908 "project/radare2/libr/util/str.c" 3 4
unsigned char 
# 2908 "project/radare2/libr/util/str.c"
    *outstart = dst;
 
# 2909 "project/radare2/libr/util/str.c" 3 4
unsigned char 
# 2909 "project/radare2/libr/util/str.c"
    *outend = dst + len_dst;
 
# 2910 "project/radare2/libr/util/str.c" 3 4
unsigned short 
# 2910 "project/radare2/libr/util/str.c"
     *in = (
# 2910 "project/radare2/libr/util/str.c" 3 4
            unsigned short
# 2910 "project/radare2/libr/util/str.c"
...
# 2911 "project/radare2/libr/util/str.c" 3 4
unsigned short 
# 2911 "project/radare2/libr/util/str.c"
     *inend;
 
# 2912 "project/radare2/libr/util/str.c" 3 4
unsigned int 
# 2912 "project/radare2/libr/util/str.c"
     c, d, inlen;
 
# 2913 "project/radare2/libr/util/str.c" 3 4
unsigned char 
# 2913 "project/radare2/libr/util/str.c"
    *tmp;
 int bits;
 ...
 while ((in < inend) && (dst - outstart + 5 < len_dst)) {
  if (little_endian) {
   ...
   tmp = (
# 2925 "project/radare2/libr/util/str.c" 3 4
         unsigned char
# 2925 "project/radare2/libr/util/str.c"
            *) in;
   c = *tmp++;
   if (!c && !*tmp) {
    break;
   ...
   c = c | (((
# 2930 "project/radare2/libr/util/str.c" 3 4
             unsigned int
# 2930 "project/radare2/libr/util/str.c"
                 )*tmp) << 8);
   in++;
  }
  if ((c & 0xFC00) == 0xD800) {
   ...
   if (little_endian) {
    ...
    tmp = (
# 2940 "project/radare2/libr/util/str.c" 3 4
          unsigned char
# 2940 "project/radare2/libr/util/str.c"
             *) in;
    d = *tmp++;
    d = d | (((
# 2942 "project/radare2/libr/util/str.c" 3 4
              unsigned int
# 2942 "project/radare2/libr/util/str.c"
                  )*tmp) << 8);
    in++;
   }
   if ((d & 0xFC00) == 0xDC00) {
...
# 2983 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 2983 "project/radare2/libr/util/str.c"
     char *r_str_utf16_decode(const 
# 2983 "project/radare2/libr/util/str.c" 3 4
                                    unsigned char 
# 2983 "project/radare2/libr/util/str.c"
                                        *s, int len) {
 ...
 int j = 0;
 char *result = 
# 2986 "project/radare2/libr/util/str.c" 3 4
               ((void *)0)
# 2986 "project/radare2/libr/util/str.c"
                   ;
 int count_unicode = 0;
 int count_ascii = 0;
 int lenresult = 0;
 if (!s) {
  return 
# 2991 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 2991 "project/radare2/libr/util/str.c"
            ;
 }
 ...
 if (!(result = calloc (1 + count_ascii + count_unicode * 6, 1))) {
  return 
# 3002 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 3002 "project/radare2/libr/util/str.c"
            ;
 }
 for (i = 0; i < len && j < lenresult && (s[i] || s[i+1]); i += 2) {
  if (!s[i+1] && 
# 3005 "project/radare2/libr/util/str.c" 3 4
                ((
# 3005 "project/radare2/libr/util/str.c"
                s[i]
# 3005 "project/radare2/libr/util/str.c" 3 4
                ) >=' ' && (
# 3005 "project/radare2/libr/util/str.c"
...
# 3005 "project/radare2/libr/util/str.c"
   ...
   j += 
# 3008 "project/radare2/libr/util/str.c" 3 4
       __builtin___snprintf_chk (
# 3008 "project/radare2/libr/util/str.c"
       &result[j]
# 3008 "project/radare2/libr/util/str.c" 3 4
       , 
# 3008 "project/radare2/libr/util/str.c"
...
# 3015 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3015 "project/radare2/libr/util/str.c"
     char *r_str_utf16_encode(const char *s, int len) {
 int i;
 char ch[4], *d, *od, *tmp;
 if (!s) {
  return 
# 3019 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 3019 "project/radare2/libr/util/str.c"
            ;
 }
 if (len < 0) {
  len = strlen (s);
 ...
 if ((len * 7) + 1 < len) {
  return 
# 3025 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 3025 "project/radare2/libr/util/str.c"
            ;
 }
 od = d = malloc (1 + (len * 7));
 if (!d) {
  return 
# 3029 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 3029 "project/radare2/libr/util/str.c"
            ;
 }
 for (i = 0; i < len; s++, i++) {
  if (*s == '\\') {
...
# 3046 "project/radare2/libr/util/str.c" 3 4
  __builtin___snprintf_chk (
# 3046 "project/radare2/libr/util/str.c"
  ch
# 3046 "project/radare2/libr/util/str.c" 3 4
  , 
# 3046 "project/radare2/libr/util/str.c"
 ...
 *d = 0;
 ...
 if (!tmp) {
  free (od);
  return 
# 3055 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 3055 "project/radare2/libr/util/str.c"
            ;
 }
 return tmp;
}
...
# 3060 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3060 "project/radare2/libr/util/str.c"
     char *r_str_prefix_all(const char *s, const char *pfx) {
 const char *os = s;
 char *p;
 int newlines = 1;
 int len = 0;
 ...
 if (!o) {
  return 
# 3082 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 3082 "project/radare2/libr/util/str.c"
            ;
 }
 
# 3084 "project/radare2/libr/util/str.c" 3 4
__builtin___memcpy_chk (
# 3084 "project/radare2/libr/util/str.c"
o
# 3084 "project/radare2/libr/util/str.c" 3 4
, 
# 3084 "project/radare2/libr/util/str.c"
...
# 3088 "project/radare2/libr/util/str.c" 3 4
  __builtin___memcpy_chk (
# 3088 "project/radare2/libr/util/str.c"
  p
# 3088 "project/radare2/libr/util/str.c" 3 4
  , 
# 3088 "project/radare2/libr/util/str.c"
...
# 3098 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 3098 "project/radare2/libr/util/str.c"
         r_str_contains_macro(const char *input_value) {
 char *has_tilde = input_value ? strchr (input_value,'~') : 
# 3099 "project/radare2/libr/util/str.c" 3 4
                                             ((void *)0)
# 3099 "project/radare2/libr/util/str.c"
                                                 ,
   *has_bang = input_value ? strchr (input_value,'!') : 
# 3100 "project/radare2/libr/util/str.c" 3 4
                                         ((void *)0)
# 3100 "project/radare2/libr/util/str.c"
                                             ,
   *has_brace = input_value ? (void*)(size_t)(strchr (input_value,'[') || strchr (input_value,']')) : 
# 3101 "project/radare2/libr/util/str.c" 3 4
                                                              ((void *)0)
# 3101 "project/radare2/libr/util/str.c"
                                                                  ,
   *has_paren = input_value ? (void*)(size_t)(strchr (input_value,'(') || strchr (input_value,')')) : 
# 3102 "project/radare2/libr/util/str.c" 3 4
                                                              ((void *)0)
# 3102 "project/radare2/libr/util/str.c"
                                                                  ,
   *has_cbrace = input_value ? (void*)(size_t)(strchr (input_value,'{') || strchr (input_value,'}')) : 
# 3103 "project/radare2/libr/util/str.c" 3 4
                                                               ((void *)0)
# 3103 "project/radare2/libr/util/str.c"
                                                                   ,
   *has_qmark = input_value ? strchr (input_value,'?') : 
# 3104 "project/radare2/libr/util/str.c" 3 4
                                          ((void *)0)
# 3104 "project/radare2/libr/util/str.c"
                                              ,
   *has_colon = input_value ? strchr (input_value,':') : 
# 3105 "project/radare2/libr/util/str.c" 3 4
                                          ((void *)0)
# 3105 "project/radare2/libr/util/str.c"
                                              ,
   *has_at = input_value ? strchr (input_value, '@') : 
# 3106 "project/radare2/libr/util/str.c" 3 4
                                                      ((void *)0)
# 3106 "project/radare2/libr/util/str.c"
                                                          ;
...
# 3112 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3112 "project/radare2/libr/util/str.c"
     void r_str_truncate_cmd(char *string) {
 
# 3113 "project/radare2/libr/util/str.c" 3 4
unsigned int 
# 3113 "project/radare2/libr/util/str.c"
     pos = 0;
 if (string && *string) {
  
# 3115 "project/radare2/libr/util/str.c" 3 4
 unsigned int 
# 3115 "project/radare2/libr/util/str.c"
      sz = strlen (string);
...
# 3134 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3134 "project/radare2/libr/util/str.c"
     const char *r_str_closer_chr(const char *b, const char *s) {
 const char *a;
 while (*b) {
  for (a = s; *a; a++) {
   if (*b == *a) {
 ...
 return 
# 3144 "project/radare2/libr/util/str.c" 3 4
       ((void *)0)
# 3144 "project/radare2/libr/util/str.c"
           ;
}


# 3147 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3147 "project/radare2/libr/util/str.c"
     int r_str_bounds(const char *_str, int *h) {
 const char *str, *ptr;
 int W = 0, H = 0;
 int cw = 0;
...
# 3180 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3180 "project/radare2/libr/util/str.c"
     char *r_str_crop(const char *str, unsigned int x, unsigned int y,
...
# 3223 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3223 "project/radare2/libr/util/str.c"
     char *r_str_wrap(const char *str, int w) {
 char *r, *ret;
 if (w < 1 || !str) {
  return strdup ("");
 }
...
# 3255 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3255 "project/radare2/libr/util/str.c"
     const char * r_str_tok(const char *str1, const char b, size_t len) {
 const char *p = str1;
 size_t i = 0;
 if (!p || !*p) {
  return p;
 ...
 if (i == len) {
  p = 
# 3270 "project/radare2/libr/util/str.c" 3 4
     ((void *)0)
# 3270 "project/radare2/libr/util/str.c"
         ;
 }
 return p;
}
...
# 3275 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3275 "project/radare2/libr/util/str.c"
     int r_str_do_until_token(str_operation op, char *str, const char tok) {
 int ret;
 if (!str) {
  return -1;
 }
...
# 3292 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3292 "project/radare2/libr/util/str.c"
...
# 3297 "project/radare2/libr/util/str.c" 3 4
__builtin___memset_chk (
# 3297 "project/radare2/libr/util/str.c"
pad
# 3297 "project/radare2/libr/util/str.c" 3 4
, 
# 3297 "project/radare2/libr/util/str.c"
...
# 3305 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3305 "project/radare2/libr/util/str.c"
     char *r_str_repeat(const char *ch, int sz) {
 int i;
 if (sz < 0) {
  sz = 0;
 }
...
# 3320 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3320 "project/radare2/libr/util/str.c"
     char *r_str_between(const char *cmt, const char *prefix, const char *suffix) {
 char *c0, *c1;
 if (!cmt || !prefix || !suffix || !*cmt) {
  return 
# 3323 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 3323 "project/radare2/libr/util/str.c"
            ;
 }
 ...
 return 
# 3332 "project/radare2/libr/util/str.c" 3 4
       ((void *)0)
# 3332 "project/radare2/libr/util/str.c"
           ;
}


# 3335 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 3335 "project/radare2/libr/util/str.c"
          r_str_startswith(const char *str, const char *needle) {
 
# 3336 "project/radare2/libr/util/str.c" 3 4
do { if (!(
# 3336 "project/radare2/libr/util/str.c"
str && needle
# 3336 "project/radare2/libr/util/str.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 3336 "project/radare2/libr/util/str.c"
"str && needle"
# 3336 "project/radare2/libr/util/str.c" 3 4
, 3336); return (0); } } while (0)
# 3336 "project/radare2/libr/util/str.c"
                                           ;
 if (str == needle) {
  return 
# 3338 "project/radare2/libr/util/str.c" 3 4
        1
# 3338 "project/radare2/libr/util/str.c"
            ;
 }
...
# 3343 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 3343 "project/radare2/libr/util/str.c"
          r_str_endswith(const char *str, const char *needle) {
 
# 3344 "project/radare2/libr/util/str.c" 3 4
do { if (!(
# 3344 "project/radare2/libr/util/str.c"
str && needle
# 3344 "project/radare2/libr/util/str.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 3344 "project/radare2/libr/util/str.c"
"str && needle"
# 3344 "project/radare2/libr/util/str.c" 3 4
, 3344); return (0); } } while (0)
# 3344 "project/radare2/libr/util/str.c"
                                           ;
 if (!*needle) {
  return 
# 3346 "project/radare2/libr/util/str.c" 3 4
        1
# 3346 "project/radare2/libr/util/str.c"
            ;
 }
 int slen = strlen (str);
 ...
 if (!slen || !nlen || slen < nlen) {
  return 
# 3351 "project/radare2/libr/util/str.c" 3 4
        0
# 3351 "project/radare2/libr/util/str.c"
             ;
 }
...
# 3357 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3357 "project/radare2/libr/util/str.c"
     RList *r_str_split_list(char *str, const char *c, int n) {
 
# 3358 "project/radare2/libr/util/str.c" 3 4
do { if (!(
# 3358 "project/radare2/libr/util/str.c"
str && c
# 3358 "project/radare2/libr/util/str.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 3358 "project/radare2/libr/util/str.c"
"str && c"
# 3358 "project/radare2/libr/util/str.c" 3 4
, 3358); return (((void *)0)); } } while (0)
# 3358 "project/radare2/libr/util/str.c"
                                     ;
 RList *lst = r_list_newf (
# 3359 "project/radare2/libr/util/str.c" 3 4
                          ((void *)0)
# 3359 "project/radare2/libr/util/str.c"
                              );
 char *aux = str;
 int i = 0;
 char *e = aux;
...
# 3381 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3381 "project/radare2/libr/util/str.c"
     RList *r_str_split_duplist(const char *_str, const char *c, 
# 3381 "project/radare2/libr/util/str.c" 3 4
                                                                 _Bool 
# 3381 "project/radare2/libr/util/str.c"
                                                                      trim) {
 
# 3382 "project/radare2/libr/util/str.c" 3 4
do { if (!(
# 3382 "project/radare2/libr/util/str.c"
_str && c
# 3382 "project/radare2/libr/util/str.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 3382 "project/radare2/libr/util/str.c"
...
# 3403 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3403 "project/radare2/libr/util/str.c"
     size_t *r_str_split_lines(char *str, size_t *count) {
 int i;
 size_t lines = 0;
 if (!str) {
  return 
# 3407 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 3407 "project/radare2/libr/util/str.c"
            ;
 }
 size_t *indexes = 
# 3409 "project/radare2/libr/util/str.c" 3 4
                  ((void *)0)
# 3409 "project/radare2/libr/util/str.c"
                      ;
 ...
 if (!indexes) {
  return 
# 3419 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 3419 "project/radare2/libr/util/str.c"
            ;
 }
 size_t line = 0;
 indexes[line++] = 0;
...
# 3435 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 3435 "project/radare2/libr/util/str.c"
          r_str_isnumber(const char *str) {
 if (!str || (!
# 3436 "project/radare2/libr/util/str.c" 3 4
              ((
# 3436 "project/radare2/libr/util/str.c"
              *str
# 3436 "project/radare2/libr/util/str.c" 3 4
              ) >= '0' && (
# 3436 "project/radare2/libr/util/str.c"
...
# 3436 "project/radare2/libr/util/str.c"
                              && *str != '-')) {
  return 
# 3437 "project/radare2/libr/util/str.c" 3 4
        0
# 3437 "project/radare2/libr/util/str.c"
             ;
 }

 while (*++str) {
  if (!
# 3441 "project/radare2/libr/util/str.c" 3 4
      ((
# 3441 "project/radare2/libr/util/str.c"
      *str
# 3441 "project/radare2/libr/util/str.c" 3 4
      ) >= '0' && (
# 3441 "project/radare2/libr/util/str.c"
...
# 3441 "project/radare2/libr/util/str.c"
   ...
   return 
# 3442 "project/radare2/libr/util/str.c" 3 4
         0
# 3442 "project/radare2/libr/util/str.c"
              ;
  }
 }

 return 
# 3446 "project/radare2/libr/util/str.c" 3 4
       1
# 3446 "project/radare2/libr/util/str.c"
           ;
}



# 3450 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3450 "project/radare2/libr/util/str.c"
     const char *r_str_last(const char *str, const char *ch) {
 char *ptr, *end = 
# 3451 "project/radare2/libr/util/str.c" 3 4
                  ((void *)0)
# 3451 "project/radare2/libr/util/str.c"
                      ;
 if (!str || !ch) {
  return 
# 3453 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 3453 "project/radare2/libr/util/str.c"
            ;
 }
 do {
  ptr = strstr (str, ch);
...
# 3462 "project/radare2/libr/util/str.c" 3 4
         1
# 3462 "project/radare2/libr/util/str.c"
             );
 return end;
}
...
static char *strchr_skip_color_codes(const char *s, int c) {
 ...
 return 
# 3537 "project/radare2/libr/util/str.c" 3 4
       ((void *)0)
# 3537 "project/radare2/libr/util/str.c"
           ;
}
...
# 3542 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3542 "project/radare2/libr/util/str.c"
     char* r_str_highlight(char *str, const char *word, const char *color, const char *color_reset) {
 if (!str || !*str) {
  return 
# 3544 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 3544 "project/radare2/libr/util/str.c"
            ;
 }
 
# 3546 "project/radare2/libr/util/str.c" 3 4
unsigned int 
# 3546 "project/radare2/libr/util/str.c"
     i = 0, j = 0, to_copy;
 char *start = str;
 
# 3548 "project/radare2/libr/util/str.c" 3 4
unsigned int 
# 3548 "project/radare2/libr/util/str.c"
     l_str = strlen (str);
 
# 3549 "project/radare2/libr/util/str.c" 3 4
unsigned int 
# 3549 "project/radare2/libr/util/str.c"
     l_reset = strlen (color_reset);
 
# 3550 "project/radare2/libr/util/str.c" 3 4
unsigned int 
# 3550 "project/radare2/libr/util/str.c"
     l_color = color? strlen (color): 0;
 if (!color) {
  return strdup (str);
 }
 if (!word || !*word) {
...
# 3557 "project/radare2/libr/util/str.c" 3 4
unsigned int 
# 3557 "project/radare2/libr/util/str.c"
     l_word = strlen (word);
...
# 3570 "project/radare2/libr/util/str.c" 3 4
  __builtin___strncpy_chk (
# 3570 "project/radare2/libr/util/str.c"
  o + j
# 3570 "project/radare2/libr/util/str.c" 3 4
  , 
# 3570 "project/radare2/libr/util/str.c"
...
# 3578 "project/radare2/libr/util/str.c" 3 4
   __builtin___strcpy_chk (
# 3578 "project/radare2/libr/util/str.c"
   o + j
# 3578 "project/radare2/libr/util/str.c" 3 4
   , 
# 3578 "project/radare2/libr/util/str.c"
...
# 3591 "project/radare2/libr/util/str.c" 3 4
   __builtin___strcpy_chk (
# 3591 "project/radare2/libr/util/str.c"
   o + j
# 3591 "project/radare2/libr/util/str.c" 3 4
   , 
# 3591 "project/radare2/libr/util/str.c"
...
# 3600 "project/radare2/libr/util/str.c" 3 4
  __builtin___strcpy_chk (
# 3600 "project/radare2/libr/util/str.c"
  o + j
# 3600 "project/radare2/libr/util/str.c" 3 4
  , 
# 3600 "project/radare2/libr/util/str.c"
...
# 3607 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3607 "project/radare2/libr/util/str.c"
     wchar_t* r_str_mb_to_wc_l(const char *buf, int len) {
 wchar_t *res_buf = 
# 3608 "project/radare2/libr/util/str.c" 3 4
                   ((void *)0)
# 3608 "project/radare2/libr/util/str.c"
                       ;
 size_t sz;
 
# 3610 "project/radare2/libr/util/str.c" 3 4
_Bool 
# 3610 "project/radare2/libr/util/str.c"
     fail = 
# 3610 "project/radare2/libr/util/str.c" 3 4
            1
# 3610 "project/radare2/libr/util/str.c"
 ...
 if (!buf || len <= 0) {
  return 
# 3613 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 3613 "project/radare2/libr/util/str.c"
            ;
 }
 sz = mbstowcs (
# 3615 "project/radare2/libr/util/str.c" 3 4
               ((void *)0)
# 3615 "project/radare2/libr/util/str.c"
                   , buf, len);
 if (sz == (size_t)-1) {
 ...
 fail = 
# 3627 "project/radare2/libr/util/str.c" 3 4
       0
# 3627 "project/radare2/libr/util/str.c"
            ;
err_r_str_mb_to_wc:
 if (fail) {
  
# 3630 "project/radare2/libr/util/str.c" 3 4
 { free((void *)
# 3630 "project/radare2/libr/util/str.c"
 res_buf
# 3630 "project/radare2/libr/util/str.c" 3 4
 ); 
# 3630 "project/radare2/libr/util/str.c"
...
# 3635 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3635 "project/radare2/libr/util/str.c"
     char* r_str_wc_to_mb_l(const wchar_t *buf, int len) {
 
# 3636 "project/radare2/libr/util/str.c" 3 4
do { if (!(
# 3636 "project/radare2/libr/util/str.c"
buf
# 3636 "project/radare2/libr/util/str.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 3636 "project/radare2/libr/util/str.c"
"buf"
# 3636 "project/radare2/libr/util/str.c" 3 4
, 3636); return (((void *)0)); } } while (0)
# 3636 "project/radare2/libr/util/str.c"
                                ;
 char *res_buf = 
# 3637 "project/radare2/libr/util/str.c" 3 4
                ((void *)0)
# 3637 "project/radare2/libr/util/str.c"
                    ;
 
# 3638 "project/radare2/libr/util/str.c" 3 4
_Bool 
# 3638 "project/radare2/libr/util/str.c"
     fail = 
# 3638 "project/radare2/libr/util/str.c" 3 4
            1
# 3638 "project/radare2/libr/util/str.c"
 ...
 if (len <= 0) {
  return 
# 3641 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 3641 "project/radare2/libr/util/str.c"
            ;
 }
 size_t sz = wcstombs (
# 3643 "project/radare2/libr/util/str.c" 3 4
                      ((void *)0)
# 3643 "project/radare2/libr/util/str.c"
                          , buf, 0);
 if (sz == (size_t)-1) {
 ...
 fail = 
# 3655 "project/radare2/libr/util/str.c" 3 4
       0
# 3655 "project/radare2/libr/util/str.c"
            ;
err_r_str_wc_to_mb:
 if (fail) {
  
# 3658 "project/radare2/libr/util/str.c" 3 4
 { free((void *)
# 3658 "project/radare2/libr/util/str.c"
 res_buf
# 3658 "project/radare2/libr/util/str.c" 3 4
 ); 
# 3658 "project/radare2/libr/util/str.c"
...
# 3663 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3663 "project/radare2/libr/util/str.c"
     char* r_str_wc_to_mb(const wchar_t *buf) {
 if (!buf) {
  return 
# 3665 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 3665 "project/radare2/libr/util/str.c"
            ;
 }
...
# 3670 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3670 "project/radare2/libr/util/str.c"
     wchar_t* r_str_mb_to_wc(const char *buf) {
 if (!buf) {
  return 
# 3672 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 3672 "project/radare2/libr/util/str.c"
            ;
 }
...
# 3677 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3677 "project/radare2/libr/util/str.c"
     char *r_str_from_ut64(
# 3677 "project/radare2/libr/util/str.c" 3 4
                           unsigned long long 
# 3677 "project/radare2/libr/util/str.c"
                                val) {
 ...
 if (!str) {
  return 
# 3682 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 3682 "project/radare2/libr/util/str.c"
            ;
 }
 while (!*v && i < 8) {
  v++;
...
# 3694 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3694 "project/radare2/libr/util/str.c"
     int r_snprintf(char *string, int len, const char *fmt, ...) {
 va_list ap;
 
# 3696 "project/radare2/libr/util/str.c" 3 4
__builtin_va_start(
# 3696 "project/radare2/libr/util/str.c"
ap
# 3696 "project/radare2/libr/util/str.c" 3 4
,
# 3696 "project/radare2/libr/util/str.c"
...
# 3696 "project/radare2/libr/util/str.c"
 ...
 if (len > 0) {
  ret = 
# 3699 "project/radare2/libr/util/str.c" 3 4
       __builtin___vsnprintf_chk (
# 3699 "project/radare2/libr/util/str.c"
       string
# 3699 "project/radare2/libr/util/str.c" 3 4
       , 
# 3699 "project/radare2/libr/util/str.c"
...
# 3704 "project/radare2/libr/util/str.c" 3 4
__builtin_va_end(
# 3704 "project/radare2/libr/util/str.c"
ap
# 3704 "project/radare2/libr/util/str.c" 3 4
)
# 3704 "project/radare2/libr/util/str.c"
...
# 3709 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3709 "project/radare2/libr/util/str.c"
 ...
 for (i = 0; i < slen; ) {
  ptr = (char*) r_mem_mem ((
# 3720 "project/radare2/libr/util/str.c" 3 4
                           unsigned char
# 3720 "project/radare2/libr/util/str.c"
                              *) str + i, slen - i, (
# 3720 "project/radare2/libr/util/str.c" 3 4
                                                     unsigned char
# 3720 "project/radare2/libr/util/str.c"
  ...
  if (!ptr) {
   ptr = (char*) r_mem_mem ((
# 3722 "project/radare2/libr/util/str.c" 3 4
                            unsigned char
# 3722 "project/radare2/libr/util/str.c"
                               *) str + i, slen - i, (
# 3722 "project/radare2/libr/util/str.c" 3 4
                                                      unsigned char
# 3722 "project/radare2/libr/util/str.c"
  ...
  ptr = (char*) r_mem_mem ((
# 3732 "project/radare2/libr/util/str.c" 3 4
                           unsigned char
# 3732 "project/radare2/libr/util/str.c"
                              *) str + i, off, (
# 3732 "project/radare2/libr/util/str.c" 3 4
                                                unsigned char
# 3732 "project/radare2/libr/util/str.c"
...
# 3744 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3744 "project/radare2/libr/util/str.c"
     char *r_str_list_join(RList *str, const char *sep) {
...
# 3756 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3756 "project/radare2/libr/util/str.c"
     char *r_str_array_join(const char **a, size_t n, const char *sep) {
 RStrBuf *sb = r_strbuf_new ("");
 size_t i;
...
# 3772 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3772 "project/radare2/libr/util/str.c"
     int r_str_fmtargs(const char *fmt) {
 int n = 0;
 while (*fmt) {
  if (*fmt == '%') {
   if (fmt[1] == '*') {
...
# 3791 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3791 "project/radare2/libr/util/str.c"
     const char *r_str_bool(int b) {
 return b? "true": "false";
}


# 3795 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 3795 "project/radare2/libr/util/str.c"
          r_str_is_true(const char *s) {
...
# 3802 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 3802 "project/radare2/libr/util/str.c"
          r_str_is_false(const char *s) {
...
# 3810 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 3810 "project/radare2/libr/util/str.c"
          r_str_is_bool(const char *val) {
 return r_str_is_true (val) || r_str_is_false (val);
}


# 3814 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3814 "project/radare2/libr/util/str.c"
     char *r_str_nextword(char *s, char ch) {
 char *p = strchr (s, ch);
 if (!p) {
  return 
# 3817 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 3817 "project/radare2/libr/util/str.c"
            ;
 }
 *p++ = 0;
 return p;
...
# 3823 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3823 "project/radare2/libr/util/str.c"
     char *r_str_scale(const char *s, int w, int h) {
...
# 3837 "project/radare2/libr/util/str.c" 3 4
if (
# 3837 "project/radare2/libr/util/str.c"
lines
# 3837 "project/radare2/libr/util/str.c" 3 4
) for (
# 3837 "project/radare2/libr/util/str.c"
...
# 3837 "project/radare2/libr/util/str.c"
                                   {
  maxcol = 
# 3838 "project/radare2/libr/util/str.c" 3 4
          (((
# 3838 "project/radare2/libr/util/str.c"
          strlen (line)
# 3838 "project/radare2/libr/util/str.c" 3 4
          )>(
# 3838 "project/radare2/libr/util/str.c"
...
# 3857 "project/radare2/libr/util/str.c" 3 4
 __builtin___memset_chk (
# 3857 "project/radare2/libr/util/str.c"
 linetext
# 3857 "project/radare2/libr/util/str.c" 3 4
 , 
# 3857 "project/radare2/libr/util/str.c"
...
# 3864 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3864 "project/radare2/libr/util/str.c"
     int r_str_distance(const char *a, const char *b) {
 
# 3865 "project/radare2/libr/util/str.c" 3 4
unsigned int 
# 3865 "project/radare2/libr/util/str.c"
     distance = 0;
 double similarity = 0;
 r_diff_buffers_distance_levenshtein (
# 3867 "project/radare2/libr/util/str.c" 3 4
                                     ((void *)0)
# 3867 "project/radare2/libr/util/str.c"
                                         , (const 
# 3867 "project/radare2/libr/util/str.c" 3 4
                                                  unsigned char
# 3867 "project/radare2/libr/util/str.c"
...
# 3867 "project/radare2/libr/util/str.c" 3 4
                                                                             unsigned char
# 3867 "project/radare2/libr/util/str.c"
                                                                                *)b, strlen (b), &distance, &similarity);
 return (int)(similarity * 100);;
}


# 3871 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3871 "project/radare2/libr/util/str.c"
     const char *r_str_str_xy(const char *s, const char *word, const char *prev, int *x, int *y) {
 
# 3872 "project/radare2/libr/util/str.c" 3 4
do { if (!(
# 3872 "project/radare2/libr/util/str.c"
s && word && x && y
# 3872 "project/radare2/libr/util/str.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 3872 "project/radare2/libr/util/str.c"
"s && word && x && y"
# 3872 "project/radare2/libr/util/str.c" 3 4
, 3872); return (((void *)0)); } } while (0)
# 3872 "project/radare2/libr/util/str.c"
                                                ;
 
# 3873 "project/radare2/libr/util/str.c" 3 4
do { if (!(
# 3873 "project/radare2/libr/util/str.c"
word[0] != '\0' && word[0] != '\n'
# 3873 "project/radare2/libr/util/str.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 3873 "project/radare2/libr/util/str.c"
...
# 3873 "project/radare2/libr/util/str.c"
 ...
 if (!d) {
  return 
# 3877 "project/radare2/libr/util/str.c" 3 4
        ((void *)0)
# 3877 "project/radare2/libr/util/str.c"
            ;
 }
 const char *q;
...
# 3909 "project/radare2/libr/util/str.c"

# 3909 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3909 "project/radare2/libr/util/str.c"
     char *r_str_version(const char *program) {
 char *s = r_str_newf ("%s "
# 3910 "project/radare2/libr/util/str.c" 3 4
                           "5.5.4"
# 3910 "project/radare2/libr/util/str.c"
                                     " %d @ "
   
# 3911 "project/radare2/libr/util/str.c" 3 4
  "darwin"
# 3911 "project/radare2/libr/util/str.c"
          "-"
   
# 3912 "project/radare2/libr/util/str.c" 3 4
  "x86"
# 3912 "project/radare2/libr/util/str.c"
            "-%d git.%s\n",
   program, 
# 3913 "project/radare2/libr/util/str.c" 3 4
           27746
# 3913 "project/radare2/libr/util/str.c"
                            ,
   (
# 3914 "project/radare2/libr/util/str.c" 3 4
   (4 | 8) 
# 3914 "project/radare2/libr/util/str.c"
              & 8)? 64: 32,
   *
# 3915 "project/radare2/libr/util/str.c" 3 4
   "5.5.4" 
# 3915 "project/radare2/libr/util/str.c"
             ? 
# 3915 "project/radare2/libr/util/str.c" 3 4
               "5.5.4"
# 3915 "project/radare2/libr/util/str.c"
                        : "");
 if (*
# 3916 "project/radare2/libr/util/str.c" 3 4
     "1703da75e247871e6fa22d3308551a291dad8f01"
# 3916 "project/radare2/libr/util/str.c"
              ) {
  s = r_str_appendf (s, "commit: "
# 3917 "project/radare2/libr/util/str.c" 3 4
                                 "1703da75e247871e6fa22d3308551a291dad8f01"
# 3917 "project/radare2/libr/util/str.c"
                                          " build: "
# 3917 "project/radare2/libr/util/str.c" 3 4
...
# 3922 "project/radare2/libr/util/str.c" 3 4
__attribute__((visibility("default"))) 
# 3922 "project/radare2/libr/util/str.c"
     int r_str_size(const char *s, int *rows) {
 RRune ch;
 int cols = 0;
 int h = 0;
 ...
 while (*s) {
  ...
  int chsz = r_utf8_decode ((const 
# 3938 "project/radare2/libr/util/str.c" 3 4
                                  unsigned char
# 3938 "project/radare2/libr/util/str.c"
                                     *)s, e - s, &ch);
  if (chsz < 1) {
   chsz = 1;
  }
