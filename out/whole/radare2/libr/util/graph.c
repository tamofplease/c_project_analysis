# 0 "project/radare2/libr/util/graph.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/graph.c"
...
# 4 "project/radare2/libr/util/graph.c" 2


# 5 "project/radare2/libr/util/graph.c"
enum {
 WHITE_COLOR = 0,
 GRAY_COLOR,
 BLACK_COLOR
...
static RGraphNode *r_graph_node_new (void *data) {
 RGraphNode *p = 
# 12 "project/radare2/libr/util/graph.c" 3 4
                (
# 12 "project/radare2/libr/util/graph.c"
                RGraphNode
# 12 "project/radare2/libr/util/graph.c" 3 4
                *)calloc(1,sizeof(
# 12 "project/radare2/libr/util/graph.c"
...
# 12 "project/radare2/libr/util/graph.c"
 ...
 if (p) {
  p->data = data;
  p->free = 
# 15 "project/radare2/libr/util/graph.c" 3 4
           ((void *)0)
# 15 "project/radare2/libr/util/graph.c"
               ;
...
static void dfs_node (RGraph *g, RGraphNode *n, RGraphVisitor *vis, int color[], const 
# 41 "project/radare2/libr/util/graph.c" 3 4
                                                                                      _Bool 
# 41 "project/radare2/libr/util/graph.c"
                                                                                           direction) {
 if (!n) {
  return;
 }
 ...
 RGraphEdge *edg = 
# 49 "project/radare2/libr/util/graph.c" 3 4
                  (
# 49 "project/radare2/libr/util/graph.c"
                  RGraphEdge
# 49 "project/radare2/libr/util/graph.c" 3 4
                  *)calloc(1,sizeof(
# 49 "project/radare2/libr/util/graph.c"
...
# 49 "project/radare2/libr/util/graph.c"
 ...
 edg->from = 
# 54 "project/radare2/libr/util/graph.c" 3 4
            ((void *)0)
# 54 "project/radare2/libr/util/graph.c"
                ;
 edg->to = n;
 r_stack_push (s, edg);
 while (!r_stack_is_empty (s)) {
  ...
  edg = 
# 86 "project/radare2/libr/util/graph.c" 3 4
       (
# 86 "project/radare2/libr/util/graph.c"
       RGraphEdge
# 86 "project/radare2/libr/util/graph.c" 3 4
       *)calloc(1,sizeof(
# 86 "project/radare2/libr/util/graph.c"
...
# 95 "project/radare2/libr/util/graph.c" 3 4
 if (
# 95 "project/radare2/libr/util/graph.c"
 neighbours
# 95 "project/radare2/libr/util/graph.c" 3 4
 ) for (
# 95 "project/radare2/libr/util/graph.c"
...
# 95 "project/radare2/libr/util/graph.c"
                                    {
   edg = 
# 96 "project/radare2/libr/util/graph.c" 3 4
        (
# 96 "project/radare2/libr/util/graph.c"
        RGraphEdge
# 96 "project/radare2/libr/util/graph.c" 3 4
        *)malloc(sizeof(
# 96 "project/radare2/libr/util/graph.c"
...
# 106 "project/radare2/libr/util/graph.c" 3 4
__attribute__((visibility("default"))) 
# 106 "project/radare2/libr/util/graph.c"
     RGraph *r_graph_new(void) {
 RGraph *t = 
# 107 "project/radare2/libr/util/graph.c" 3 4
            (
# 107 "project/radare2/libr/util/graph.c"
            RGraph
# 107 "project/radare2/libr/util/graph.c" 3 4
            *)calloc(1,sizeof(
# 107 "project/radare2/libr/util/graph.c"
...
# 107 "project/radare2/libr/util/graph.c"
 ...
 if (!t) {
  return 
# 109 "project/radare2/libr/util/graph.c" 3 4
        ((void *)0)
# 109 "project/radare2/libr/util/graph.c"
            ;
 }
 t->nodes = r_list_new ();
 if (!t->nodes) {
  r_graph_free(t);
  return 
# 114 "project/radare2/libr/util/graph.c" 3 4
        ((void *)0)
# 114 "project/radare2/libr/util/graph.c"
            ;
 }
...
# 122 "project/radare2/libr/util/graph.c" 3 4
__attribute__((visibility("default"))) 
# 122 "project/radare2/libr/util/graph.c"
     void r_graph_free(RGraph* t) {
 r_list_free (t->nodes);
 free (t);
}


# 127 "project/radare2/libr/util/graph.c" 3 4
__attribute__((visibility("default"))) 
# 127 "project/radare2/libr/util/graph.c"
     RGraphNode *r_graph_get_node(const RGraph *t, unsigned int idx) {
 RListIter *it = r_list_find (t->nodes, (void *)(size_t)idx, (RListComparator)node_cmp);
 if (!it) {
  return 
# 130 "project/radare2/libr/util/graph.c" 3 4
        ((void *)0)
# 130 "project/radare2/libr/util/graph.c"
            ;
 }
...
# 135 "project/radare2/libr/util/graph.c" 3 4
__attribute__((visibility("default"))) 
# 135 "project/radare2/libr/util/graph.c"
     RListIter *r_graph_node_iter(const RGraph *t, unsigned int idx) {
 return r_list_find (t->nodes, (void *)(size_t)idx, (RListComparator)node_cmp);
}


# 139 "project/radare2/libr/util/graph.c" 3 4
__attribute__((visibility("default"))) 
# 139 "project/radare2/libr/util/graph.c"
     void r_graph_reset (RGraph *t) {
 r_list_free (t->nodes);
 t->nodes = r_list_new ();
 if (!t->nodes) {
  return;
...
# 151 "project/radare2/libr/util/graph.c" 3 4
__attribute__((visibility("default"))) 
# 151 "project/radare2/libr/util/graph.c"
     RGraphNode *r_graph_add_node(RGraph *t, void *data) {
 if (!t) {
  return 
# 153 "project/radare2/libr/util/graph.c" 3 4
        ((void *)0)
# 153 "project/radare2/libr/util/graph.c"
            ;
 }
 RGraphNode *n = r_graph_node_new (data);
 if (!n) {
  return 
# 157 "project/radare2/libr/util/graph.c" 3 4
        ((void *)0)
# 157 "project/radare2/libr/util/graph.c"
            ;
 }
 n->idx = t->last_index++;
...
# 165 "project/radare2/libr/util/graph.c" 3 4
__attribute__((visibility("default"))) 
# 165 "project/radare2/libr/util/graph.c"
     RGraphNode *r_graph_add_nodef(RGraph *graph, void *data, RListFree user_free) {
...
# 175 "project/radare2/libr/util/graph.c" 3 4
__attribute__((visibility("default"))) 
# 175 "project/radare2/libr/util/graph.c"
     void r_graph_del_node(RGraph *t, RGraphNode *n) {
 RGraphNode *gn;
 RListIter *it;
 if (!n) {
  return;
...
# 181 "project/radare2/libr/util/graph.c" 3 4
if (
# 181 "project/radare2/libr/util/graph.c"
n->in_nodes
# 181 "project/radare2/libr/util/graph.c" 3 4
) for (
# 181 "project/radare2/libr/util/graph.c"
...
# 187 "project/radare2/libr/util/graph.c" 3 4
if (
# 187 "project/radare2/libr/util/graph.c"
n->out_nodes
# 187 "project/radare2/libr/util/graph.c" 3 4
) for (
# 187 "project/radare2/libr/util/graph.c"
...
# 197 "project/radare2/libr/util/graph.c" 3 4
__attribute__((visibility("default"))) 
# 197 "project/radare2/libr/util/graph.c"
     void r_graph_add_edge(RGraph *t, RGraphNode *from, RGraphNode *to) {
 r_graph_add_edge_at (t, from, to, -1);
}


# 201 "project/radare2/libr/util/graph.c" 3 4
__attribute__((visibility("default"))) 
# 201 "project/radare2/libr/util/graph.c"
     void r_graph_add_edge_at(RGraph *t, RGraphNode *from, RGraphNode *to, int nth) {
 if (from && to) {
...
# 212 "project/radare2/libr/util/graph.c" 3 4
__attribute__((visibility("default"))) 
# 212 "project/radare2/libr/util/graph.c"
     RGraphNode *r_graph_node_split_forward(RGraph *g, RGraphNode *split_me, void *data) {
...
# 219 "project/radare2/libr/util/graph.c" 3 4
if (
# 219 "project/radare2/libr/util/graph.c"
front->out_nodes
# 219 "project/radare2/libr/util/graph.c" 3 4
) for (
# 219 "project/radare2/libr/util/graph.c"
...
# 230 "project/radare2/libr/util/graph.c" 3 4
__attribute__((visibility("default"))) 
# 230 "project/radare2/libr/util/graph.c"
     void r_graph_del_edge(RGraph *t, RGraphNode *from, RGraphNode *to) {
...
# 243 "project/radare2/libr/util/graph.c" 3 4
__attribute__((visibility("default"))) 
# 243 "project/radare2/libr/util/graph.c"
     const RList *r_graph_get_neighbours(const RGraph *g, const RGraphNode *n) {
 return n? n->out_nodes: 
# 244 "project/radare2/libr/util/graph.c" 3 4
                        ((void *)0)
# 244 "project/radare2/libr/util/graph.c"
                            ;
}
...
# 249 "project/radare2/libr/util/graph.c" 3 4
__attribute__((visibility("default"))) 
# 249 "project/radare2/libr/util/graph.c"
     RGraphNode *r_graph_nth_neighbour(const RGraph *g, const RGraphNode *n, int nth) {
 return n? (RGraphNode *)r_list_get_n (n->out_nodes, nth): 
# 250 "project/radare2/libr/util/graph.c" 3 4
                                                          ((void *)0)
# 250 "project/radare2/libr/util/graph.c"
                                                              ;
}



# 254 "project/radare2/libr/util/graph.c" 3 4
__attribute__((visibility("default"))) 
# 254 "project/radare2/libr/util/graph.c"
     const RList *r_graph_innodes(const RGraph *g, const RGraphNode *n) {
 return n? n->in_nodes: 
# 255 "project/radare2/libr/util/graph.c" 3 4
                       ((void *)0)
# 255 "project/radare2/libr/util/graph.c"
                           ;
}



# 259 "project/radare2/libr/util/graph.c" 3 4
__attribute__((visibility("default"))) 
# 259 "project/radare2/libr/util/graph.c"
     const RList *r_graph_all_neighbours(const RGraph *g, const RGraphNode *n) {
 return n? n->all_neighbours: 
# 260 "project/radare2/libr/util/graph.c" 3 4
                             ((void *)0)
# 260 "project/radare2/libr/util/graph.c"
                                 ;
}


# 263 "project/radare2/libr/util/graph.c" 3 4
__attribute__((visibility("default"))) 
# 263 "project/radare2/libr/util/graph.c"
     const RList *r_graph_get_nodes(const RGraph *g) {
 return g? g->nodes: 
# 264 "project/radare2/libr/util/graph.c" 3 4
                    ((void *)0)
# 264 "project/radare2/libr/util/graph.c"
                        ;
}



# 268 "project/radare2/libr/util/graph.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 268 "project/radare2/libr/util/graph.c"
          r_graph_adjacent(const RGraph *g, const RGraphNode *from, const RGraphNode *to) {
 if (!g || !from) {
  return 
# 270 "project/radare2/libr/util/graph.c" 3 4
        0
# 270 "project/radare2/libr/util/graph.c"
             ;
 }
...
# 275 "project/radare2/libr/util/graph.c" 3 4
__attribute__((visibility("default"))) 
# 275 "project/radare2/libr/util/graph.c"
     void r_graph_dfs_node(RGraph *g, RGraphNode *n, RGraphVisitor *vis) {
 if (!g || !n || !vis) {
  return;
 }
 int *color = 
# 279 "project/radare2/libr/util/graph.c" 3 4
             (
# 279 "project/radare2/libr/util/graph.c"
             int
# 279 "project/radare2/libr/util/graph.c" 3 4
             *)calloc(
# 279 "project/radare2/libr/util/graph.c"
...
# 281 "project/radare2/libr/util/graph.c" 3 4
                             1
# 281 "project/radare2/libr/util/graph.c"
                                 );
  free (color);
 }
}
...
# 286 "project/radare2/libr/util/graph.c" 3 4
__attribute__((visibility("default"))) 
# 286 "project/radare2/libr/util/graph.c"
     void r_graph_dfs_node_reverse(RGraph *g, RGraphNode *n, RGraphVisitor *vis) {
 if (!g || !n || !vis) {
  return;
 }
 int *color = 
# 290 "project/radare2/libr/util/graph.c" 3 4
             (
# 290 "project/radare2/libr/util/graph.c"
             int
# 290 "project/radare2/libr/util/graph.c" 3 4
             *)calloc(
# 290 "project/radare2/libr/util/graph.c"
...
# 290 "project/radare2/libr/util/graph.c"
 ...
 if (color) {
  dfs_node (g, n, vis, color, 
# 292 "project/radare2/libr/util/graph.c" 3 4
                             0
# 292 "project/radare2/libr/util/graph.c"
                                  );
  free (color);
 }
}
...
# 297 "project/radare2/libr/util/graph.c" 3 4
__attribute__((visibility("default"))) 
# 297 "project/radare2/libr/util/graph.c"
     void r_graph_dfs(RGraph *g, RGraphVisitor *vis) {
 
# 298 "project/radare2/libr/util/graph.c" 3 4
do { if (!(
# 298 "project/radare2/libr/util/graph.c"
g && vis
# 298 "project/radare2/libr/util/graph.c" 3 4
...
# 298 "project/radare2/libr/util/graph.c"
 ...
 int *color = 
# 302 "project/radare2/libr/util/graph.c" 3 4
             (
# 302 "project/radare2/libr/util/graph.c"
             int
# 302 "project/radare2/libr/util/graph.c" 3 4
             *)calloc(
# 302 "project/radare2/libr/util/graph.c"
...
# 304 "project/radare2/libr/util/graph.c" 3 4
 if (
# 304 "project/radare2/libr/util/graph.c"
 g->nodes
# 304 "project/radare2/libr/util/graph.c" 3 4
 ) for (
# 304 "project/radare2/libr/util/graph.c"
...
# 304 "project/radare2/libr/util/graph.c"
   ...
   if (color[n->idx] == WHITE_COLOR) {
    dfs_node (g, n, vis, color, 
# 306 "project/radare2/libr/util/graph.c" 3 4
                               1
# 306 "project/radare2/libr/util/graph.c"
                                   );
   }
  }
  free (color);
