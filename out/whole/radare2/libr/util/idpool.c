# 0 "project/radare2/libr/util/idpool.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/util/idpool.c" 2
...
# 11 "project/radare2/libr/util/idpool.c"
static 
# 11 "project/radare2/libr/util/idpool.c" 3 4
      unsigned int 
# 11 "project/radare2/libr/util/idpool.c"
           get_msb(
# 11 "project/radare2/libr/util/idpool.c" 3 4
...
# 21 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) 
# 21 "project/radare2/libr/util/idpool.c"
     RIDPool* r_id_pool_new(
# 21 "project/radare2/libr/util/idpool.c" 3 4
                            unsigned int 
# 21 "project/radare2/libr/util/idpool.c"
                                 start_id, 
...
# 21 "project/radare2/libr/util/idpool.c"
                                                last_id) {
 RIDPool* pool = 
# 22 "project/radare2/libr/util/idpool.c" 3 4
                ((void *)0)
# 22 "project/radare2/libr/util/idpool.c"
                    ;
 if (start_id < last_id) {
  pool = 
# 24 "project/radare2/libr/util/idpool.c" 3 4
        (
# 24 "project/radare2/libr/util/idpool.c"
        RIDPool
# 24 "project/radare2/libr/util/idpool.c" 3 4
        *)calloc(1,sizeof(
# 24 "project/radare2/libr/util/idpool.c"
...
# 33 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 33 "project/radare2/libr/util/idpool.c"
          r_id_pool_grab_id(RIDPool* pool, 
# 33 "project/radare2/libr/util/idpool.c" 3 4
                                           unsigned int
# 33 "project/radare2/libr/util/idpool.c"
                                               * grabber) {
 
# 34 "project/radare2/libr/util/idpool.c" 3 4
do { if (!(
# 34 "project/radare2/libr/util/idpool.c"
pool && grabber
# 34 "project/radare2/libr/util/idpool.c" 3 4
 ...
 *grabber = 
# 36 "project/radare2/libr/util/idpool.c" 3 4
           0xFFFFFFFFU
# 36 "project/radare2/libr/util/idpool.c"
                   ;
 if (pool->freed_ids) {
  
# 38 "project/radare2/libr/util/idpool.c" 3 4
 unsigned int 
# 38 "project/radare2/libr/util/idpool.c"
      grab = (
# 38 "project/radare2/libr/util/idpool.c" 3 4
              unsigned int
# 38 "project/radare2/libr/util/idpool.c"
                  ) (size_t)r_queue_dequeue (pool->freed_ids);
  *grabber = (
# 39 "project/radare2/libr/util/idpool.c" 3 4
             unsigned int
# 39 "project/radare2/libr/util/idpool.c"
                 ) grab;
  if (r_queue_is_empty (pool->freed_ids)) {
   r_queue_free (pool->freed_ids);
   pool->freed_ids = 
# 42 "project/radare2/libr/util/idpool.c" 3 4
                    ((void *)0)
# 42 "project/radare2/libr/util/idpool.c"
                        ;
  }
  return 
# 44 "project/radare2/libr/util/idpool.c" 3 4
        1
# 44 "project/radare2/libr/util/idpool.c"
            ;
 }
  ...
  *grabber = pool->next_id;
  pool->next_id++;
  return 
# 49 "project/radare2/libr/util/idpool.c" 3 4
        1
# 49 "project/radare2/libr/util/idpool.c"
            ;
 }
 return 
# 51 "project/radare2/libr/util/idpool.c" 3 4
       0
# 51 "project/radare2/libr/util/idpool.c"
            ;
}


# 54 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 54 "project/radare2/libr/util/idpool.c"
          r_id_pool_kick_id(RIDPool* pool, 
# 54 "project/radare2/libr/util/idpool.c" 3 4
                                           unsigned int 
# 54 "project/radare2/libr/util/idpool.c"
                                                kick) {
 if (!pool || (kick < pool->start_id) || (pool->start_id == pool->next_id)) {
  return 
# 56 "project/radare2/libr/util/idpool.c" 3 4
        0
# 56 "project/radare2/libr/util/idpool.c"
             ;
 }
 if (kick == (pool->next_id - 1)) {
  pool->next_id--;
  return 
# 60 "project/radare2/libr/util/idpool.c" 3 4
        1
# 60 "project/radare2/libr/util/idpool.c"
            ;
 }
 if (!pool->freed_ids) {
 ...
 return 
# 66 "project/radare2/libr/util/idpool.c" 3 4
       1
# 66 "project/radare2/libr/util/idpool.c"
           ;
}


# 69 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) 
# 69 "project/radare2/libr/util/idpool.c"
     void r_id_pool_free(RIDPool* pool) {
...
# 76 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) 
# 76 "project/radare2/libr/util/idpool.c"
     RIDStorage* r_id_storage_new(
# 76 "project/radare2/libr/util/idpool.c" 3 4
                                  unsigned int 
# 76 "project/radare2/libr/util/idpool.c"
                                       start_id, 
...
# 76 "project/radare2/libr/util/idpool.c"
                                                      last_id) {
 RIDStorage* storage = 
# 77 "project/radare2/libr/util/idpool.c" 3 4
                      ((void *)0)
# 77 "project/radare2/libr/util/idpool.c"
                          ;
 RIDPool *pool = r_id_pool_new (start_id, last_id);
 if (pool) {
  storage = 
# 80 "project/radare2/libr/util/idpool.c" 3 4
           (
# 80 "project/radare2/libr/util/idpool.c"
           RIDStorage
# 80 "project/radare2/libr/util/idpool.c" 3 4
           *)calloc(1,sizeof(
# 80 "project/radare2/libr/util/idpool.c"
...
# 80 "project/radare2/libr/util/idpool.c"
  ...
  if (!storage) {
   r_id_pool_free (pool);
   return 
# 83 "project/radare2/libr/util/idpool.c" 3 4
         ((void *)0)
# 83 "project/radare2/libr/util/idpool.c"
             ;
  }
  storage->pool = pool;
 }
...
static 
# 90 "project/radare2/libr/util/idpool.c" 3 4
      _Bool 
# 90 "project/radare2/libr/util/idpool.c"
           id_storage_reallocate(RIDStorage* storage, 
# 90 "project/radare2/libr/util/idpool.c" 3 4
                                                      unsigned int 
# 90 "project/radare2/libr/util/idpool.c"
                                                           size) {
 if (!storage) {
  return 
# 92 "project/radare2/libr/util/idpool.c" 3 4
        0
# 92 "project/radare2/libr/util/idpool.c"
             ;
 }
 void **data = realloc (storage->data, size * sizeof (void*));
 if (!data) {
  return 
# 96 "project/radare2/libr/util/idpool.c" 3 4
        0
# 96 "project/radare2/libr/util/idpool.c"
             ;
 }
 if (size > storage->size) {
  
# 99 "project/radare2/libr/util/idpool.c" 3 4
 __builtin___memset_chk (
# 99 "project/radare2/libr/util/idpool.c"
 data + storage->size
# 99 "project/radare2/libr/util/idpool.c" 3 4
 , 
# 99 "project/radare2/libr/util/idpool.c"
 0, (size - storage->size) * sizeof (void*)
# 99 "project/radare2/libr/util/idpool.c" 3 4
...
# 99 "project/radare2/libr/util/idpool.c"
 ...
 storage->size = size;
 return 
# 103 "project/radare2/libr/util/idpool.c" 3 4
       1
# 103 "project/radare2/libr/util/idpool.c"
           ;
}

static 
# 106 "project/radare2/libr/util/idpool.c" 3 4
      _Bool 
# 106 "project/radare2/libr/util/idpool.c"
           oid_storage_preallocate(ROIDStorage *st, 
# 106 "project/radare2/libr/util/idpool.c" 3 4
                                                    unsigned int 
# 106 "project/radare2/libr/util/idpool.c"
                                                         size) {
 
# 107 "project/radare2/libr/util/idpool.c" 3 4
unsigned int 
# 107 "project/radare2/libr/util/idpool.c"
     *permutation;
 if (!st) {
  return 
# 109 "project/radare2/libr/util/idpool.c" 3 4
        0
# 109 "project/radare2/libr/util/idpool.c"
             ;
 }
 if (!size) {
  
# 112 "project/radare2/libr/util/idpool.c" 3 4
 { free((void *)
# 112 "project/radare2/libr/util/idpool.c"
 st->permutation
# 112 "project/radare2/libr/util/idpool.c" 3 4
 ); 
# 112 "project/radare2/libr/util/idpool.c"
...
# 112 "project/radare2/libr/util/idpool.c"
 ...
 permutation = realloc (st->permutation, size * sizeof (
# 115 "project/radare2/libr/util/idpool.c" 3 4
                                                       unsigned int
# 115 "project/radare2/libr/util/idpool.c"
                                                           ));
 if (!permutation) {
  return 
# 117 "project/radare2/libr/util/idpool.c" 3 4
        0
# 117 "project/radare2/libr/util/idpool.c"
             ;
 }
 if (size > st->psize) {
  
# 120 "project/radare2/libr/util/idpool.c" 3 4
 __builtin___memset_chk (
# 120 "project/radare2/libr/util/idpool.c"
 permutation + st->psize
# 120 "project/radare2/libr/util/idpool.c" 3 4
 , 
# 120 "project/radare2/libr/util/idpool.c"
 0, (size - st->psize) * sizeof (
# 120 "project/radare2/libr/util/idpool.c" 3 4
 unsigned int
# 120 "project/radare2/libr/util/idpool.c"
 )
...
# 120 "project/radare2/libr/util/idpool.c"
 ...
 st->psize = size;
 return 
# 124 "project/radare2/libr/util/idpool.c" 3 4
       1
# 124 "project/radare2/libr/util/idpool.c"
           ;
}


# 127 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 127 "project/radare2/libr/util/idpool.c"
          r_id_storage_set(RIDStorage* storage, void* data, 
# 127 "project/radare2/libr/util/idpool.c" 3 4
                                                            unsigned int 
# 127 "project/radare2/libr/util/idpool.c"
                                                                 id) {
 
# 128 "project/radare2/libr/util/idpool.c" 3 4
unsigned int 
# 128 "project/radare2/libr/util/idpool.c"
     n;
 if (!storage || !storage->pool || (id >= storage->pool->next_id)) {
  return 
# 130 "project/radare2/libr/util/idpool.c" 3 4
        0
# 130 "project/radare2/libr/util/idpool.c"
             ;
 }
 n = get_msb (id + 1);
 if (n > ((storage->size / 2) + (storage->size / 4))) {
  if ((n * 2) < storage->pool->last_id) {
   if (!id_storage_reallocate (storage, n * 2)) {
    return 
# 136 "project/radare2/libr/util/idpool.c" 3 4
          0
# 136 "project/radare2/libr/util/idpool.c"
               ;
   }
  } else if (n != (storage->pool->last_id)) {
   if (!id_storage_reallocate (storage, storage->pool->last_id)) {
    return 
# 140 "project/radare2/libr/util/idpool.c" 3 4
          0
# 140 "project/radare2/libr/util/idpool.c"
               ;
   }
  }
 }
 ...
 return 
# 148 "project/radare2/libr/util/idpool.c" 3 4
       1
# 148 "project/radare2/libr/util/idpool.c"
           ;
}


# 151 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 151 "project/radare2/libr/util/idpool.c"
          r_id_storage_add(RIDStorage* storage, void* data, 
# 151 "project/radare2/libr/util/idpool.c" 3 4
                                                            unsigned int
# 151 "project/radare2/libr/util/idpool.c"
                                                                * id) {
 if (!storage || !r_id_pool_grab_id (storage->pool, id)) {
  return 
# 153 "project/radare2/libr/util/idpool.c" 3 4
        0
# 153 "project/radare2/libr/util/idpool.c"
             ;
 }
...
# 158 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) 
# 158 "project/radare2/libr/util/idpool.c"
     void* r_id_storage_get(RIDStorage* storage, 
# 158 "project/radare2/libr/util/idpool.c" 3 4
                                                 unsigned int 
# 158 "project/radare2/libr/util/idpool.c"
                                                      id) {
 if (!storage || !storage->data || (storage->size <= id)) {
  return 
# 160 "project/radare2/libr/util/idpool.c" 3 4
        ((void *)0)
# 160 "project/radare2/libr/util/idpool.c"
            ;
 }
...
# 165 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 165 "project/radare2/libr/util/idpool.c"
          r_id_storage_get_lowest(RIDStorage *storage, 
# 165 "project/radare2/libr/util/idpool.c" 3 4
                                                       unsigned int 
# 165 "project/radare2/libr/util/idpool.c"
                                                            *id) {
 
# 166 "project/radare2/libr/util/idpool.c" 3 4
do { if (!(
# 166 "project/radare2/libr/util/idpool.c"
storage
# 166 "project/radare2/libr/util/idpool.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 166 "project/radare2/libr/util/idpool.c"
...
# 167 "project/radare2/libr/util/idpool.c" 3 4
unsigned int 
# 167 "project/radare2/libr/util/idpool.c"
     i;
...
# 173 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 173 "project/radare2/libr/util/idpool.c"
          r_id_storage_get_highest(RIDStorage *storage, 
# 173 "project/radare2/libr/util/idpool.c" 3 4
                                                        unsigned int 
# 173 "project/radare2/libr/util/idpool.c"
                                                             *id) {
 
# 174 "project/radare2/libr/util/idpool.c" 3 4
do { if (!(
# 174 "project/radare2/libr/util/idpool.c"
storage
# 174 "project/radare2/libr/util/idpool.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 174 "project/radare2/libr/util/idpool.c"
...
# 179 "project/radare2/libr/util/idpool.c" 3 4
                            ((void *)0)
# 179 "project/radare2/libr/util/idpool.c"
                                ;
 }

 return 
# 182 "project/radare2/libr/util/idpool.c" 3 4
       0
# 182 "project/radare2/libr/util/idpool.c"
            ;
}


# 185 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 185 "project/radare2/libr/util/idpool.c"
          r_id_storage_get_next(RIDStorage *storage, 
# 185 "project/radare2/libr/util/idpool.c" 3 4
                                                     unsigned int 
# 185 "project/radare2/libr/util/idpool.c"
                                                          *idref) {
 
# 186 "project/radare2/libr/util/idpool.c" 3 4
do { if (!(
# 186 "project/radare2/libr/util/idpool.c"
idref && storage
# 186 "project/radare2/libr/util/idpool.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 186 "project/radare2/libr/util/idpool.c"
"idref && storage"
# 186 "project/radare2/libr/util/idpool.c" 3 4
, 186); return (0); } } while (0)
# 186 "project/radare2/libr/util/idpool.c"
                                              ;
 
# 187 "project/radare2/libr/util/idpool.c" 3 4
unsigned int 
# 187 "project/radare2/libr/util/idpool.c"
     id = *idref;
 if (storage->size < 1 || id >= storage->size || !storage->data) {
  return 
# 189 "project/radare2/libr/util/idpool.c" 3 4
        0
# 189 "project/radare2/libr/util/idpool.c"
             ;
 }
  ...
  *idref = id;
  return 
# 194 "project/radare2/libr/util/idpool.c" 3 4
        1
# 194 "project/radare2/libr/util/idpool.c"
            ;
 }
 return 
# 196 "project/radare2/libr/util/idpool.c" 3 4
       0
# 196 "project/radare2/libr/util/idpool.c"
            ;
}


# 199 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 199 "project/radare2/libr/util/idpool.c"
          r_id_storage_get_prev(RIDStorage *storage, 
# 199 "project/radare2/libr/util/idpool.c" 3 4
                                                     unsigned int 
# 199 "project/radare2/libr/util/idpool.c"
                                                          *idref) {
 
# 200 "project/radare2/libr/util/idpool.c" 3 4
do { if (!(
# 200 "project/radare2/libr/util/idpool.c"
idref && storage
# 200 "project/radare2/libr/util/idpool.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 200 "project/radare2/libr/util/idpool.c"
...
# 201 "project/radare2/libr/util/idpool.c" 3 4
unsigned int 
# 201 "project/radare2/libr/util/idpool.c"
     id = *idref;
 if (id == 0 || id >= storage->size || storage->size < 1 || !storage->data) {
  return 
# 203 "project/radare2/libr/util/idpool.c" 3 4
        0
# 203 "project/radare2/libr/util/idpool.c"
             ;
 }
  ...
  *idref = id;
  return 
# 208 "project/radare2/libr/util/idpool.c" 3 4
        1
# 208 "project/radare2/libr/util/idpool.c"
            ;
 }
 return 
# 210 "project/radare2/libr/util/idpool.c" 3 4
       0
# 210 "project/radare2/libr/util/idpool.c"
            ;
}


# 213 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) 
# 213 "project/radare2/libr/util/idpool.c"
     void r_id_storage_delete(RIDStorage* storage, 
# 213 "project/radare2/libr/util/idpool.c" 3 4
                                                   unsigned int 
# 213 "project/radare2/libr/util/idpool.c"
                                                        id) {
 ...
 storage->data[id] = 
# 217 "project/radare2/libr/util/idpool.c" 3 4
                    ((void *)0)
# 217 "project/radare2/libr/util/idpool.c"
                        ;
 if (id == storage->top_id) {
...
# 227 "project/radare2/libr/util/idpool.c" 3 4
   { free((void *)
# 227 "project/radare2/libr/util/idpool.c"
   storage->data
# 227 "project/radare2/libr/util/idpool.c" 3 4
   ); 
# 227 "project/radare2/libr/util/idpool.c"
...
# 240 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) 
# 240 "project/radare2/libr/util/idpool.c"
     void* r_id_storage_take(RIDStorage* storage, 
# 240 "project/radare2/libr/util/idpool.c" 3 4
                                                  unsigned int 
# 240 "project/radare2/libr/util/idpool.c"
                                                       id) {
...
# 246 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 246 "project/radare2/libr/util/idpool.c"
          r_id_storage_foreach(RIDStorage* storage, RIDStorageForeachCb cb, void* user) {
 
# 247 "project/radare2/libr/util/idpool.c" 3 4
unsigned int 
# 247 "project/radare2/libr/util/idpool.c"
     i;
 if (!cb || !storage || !storage->data) {
  return 
# 249 "project/radare2/libr/util/idpool.c" 3 4
        0
# 249 "project/radare2/libr/util/idpool.c"
             ;
 }
 for (i = 0; i < storage->top_id; i++) {
  if (storage->data[i] && !cb (user, storage->data[i], i)) {
   return 
# 253 "project/radare2/libr/util/idpool.c" 3 4
         0
# 253 "project/radare2/libr/util/idpool.c"
              ;
  }
 }
 if (storage->data[i]) {
 ...
 return 
# 259 "project/radare2/libr/util/idpool.c" 3 4
       1
# 259 "project/radare2/libr/util/idpool.c"
           ;
}


# 262 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) 
# 262 "project/radare2/libr/util/idpool.c"
     void r_id_storage_free(RIDStorage* storage) {
 if (storage) {
  r_id_pool_free (storage->pool);
  free (storage->data);
 }
...
static 
# 270 "project/radare2/libr/util/idpool.c" 3 4
      _Bool 
# 270 "project/radare2/libr/util/idpool.c"
           _list(void* user, void* data, 
# 270 "project/radare2/libr/util/idpool.c" 3 4
                                         unsigned int 
# 270 "project/radare2/libr/util/idpool.c"
                                              id) {
 ...
 return 
# 272 "project/radare2/libr/util/idpool.c" 3 4
       1
# 272 "project/radare2/libr/util/idpool.c"
           ;
}


# 275 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) 
# 275 "project/radare2/libr/util/idpool.c"
     RList *r_id_storage_list(RIDStorage *s) {
 RList *list = r_list_newf (
# 276 "project/radare2/libr/util/idpool.c" 3 4
                           ((void *)0)
# 276 "project/radare2/libr/util/idpool.c"
                               );
...
# 281 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) 
# 281 "project/radare2/libr/util/idpool.c"
     ROIDStorage *r_oids_new(
# 281 "project/radare2/libr/util/idpool.c" 3 4
                             unsigned int 
# 281 "project/radare2/libr/util/idpool.c"
                                  start_id, 
...
# 281 "project/radare2/libr/util/idpool.c"
                                                 last_id) {
 ROIDStorage *storage = 
# 282 "project/radare2/libr/util/idpool.c" 3 4
                       (
# 282 "project/radare2/libr/util/idpool.c"
                       ROIDStorage
# 282 "project/radare2/libr/util/idpool.c" 3 4
                       *)calloc(1,sizeof(
# 282 "project/radare2/libr/util/idpool.c"
...
# 282 "project/radare2/libr/util/idpool.c"
 ...
 if (!storage) {
  return 
# 284 "project/radare2/libr/util/idpool.c" 3 4
        ((void *)0)
# 284 "project/radare2/libr/util/idpool.c"
            ;
 }
 if (!(storage->data = r_id_storage_new (start_id, last_id))) {
  free (storage);
  return 
# 288 "project/radare2/libr/util/idpool.c" 3 4
        ((void *)0)
# 288 "project/radare2/libr/util/idpool.c"
            ;
 }
 return storage;
}
...
# 293 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) 
# 293 "project/radare2/libr/util/idpool.c"
     void *r_oids_get(ROIDStorage *storage, 
# 293 "project/radare2/libr/util/idpool.c" 3 4
                                            unsigned int 
# 293 "project/radare2/libr/util/idpool.c"
                                                 id) {
 ...
 return 
# 297 "project/radare2/libr/util/idpool.c" 3 4
       ((void *)0)
# 297 "project/radare2/libr/util/idpool.c"
           ;
}


# 300 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) 
# 300 "project/radare2/libr/util/idpool.c"
     void *r_oids_oget(ROIDStorage *storage, 
# 300 "project/radare2/libr/util/idpool.c" 3 4
                                             unsigned int 
# 300 "project/radare2/libr/util/idpool.c"
                                                  od) {
 
# 301 "project/radare2/libr/util/idpool.c" 3 4
unsigned int 
# 301 "project/radare2/libr/util/idpool.c"
     id;
 if (r_oids_get_id (storage, od, &id)) {
  return r_id_storage_get (storage->data, id);
 }
 return 
# 305 "project/radare2/libr/util/idpool.c" 3 4
       ((void *)0)
# 305 "project/radare2/libr/util/idpool.c"
           ;
}


# 308 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 308 "project/radare2/libr/util/idpool.c"
          r_oids_get_id(ROIDStorage *storage, 
# 308 "project/radare2/libr/util/idpool.c" 3 4
                                              unsigned int 
# 308 "project/radare2/libr/util/idpool.c"
                                                   od, 
...
# 308 "project/radare2/libr/util/idpool.c"
  ...
  *id = storage->permutation[od];
  return 
# 311 "project/radare2/libr/util/idpool.c" 3 4
        1
# 311 "project/radare2/libr/util/idpool.c"
            ;
 }
 return 
# 313 "project/radare2/libr/util/idpool.c" 3 4
       0
# 313 "project/radare2/libr/util/idpool.c"
            ;
}


# 316 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 316 "project/radare2/libr/util/idpool.c"
          r_oids_get_od(ROIDStorage *storage, 
# 316 "project/radare2/libr/util/idpool.c" 3 4
                                              unsigned int 
# 316 "project/radare2/libr/util/idpool.c"
                                                   id, 
 ...
 if (storage && storage->permutation &&
  ...
  for (od[0] = 0; od[0] < storage->ptop; od[0]++) {
   if (id == storage->permutation[od[0]]) {
    return 
# 321 "project/radare2/libr/util/idpool.c" 3 4
          1
# 321 "project/radare2/libr/util/idpool.c"
              ;
   }
  }
 }
 return 
# 325 "project/radare2/libr/util/idpool.c" 3 4
       0
# 325 "project/radare2/libr/util/idpool.c"
            ;
}


# 328 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 328 "project/radare2/libr/util/idpool.c"
          r_oids_add(ROIDStorage *storage, void *data, 
# 328 "project/radare2/libr/util/idpool.c" 3 4
                                                       unsigned int 
# 328 "project/radare2/libr/util/idpool.c"
                                                            *id, 
...
# 328 "project/radare2/libr/util/idpool.c"
 ...
 if (!storage || !id || !od) {
  return 
# 330 "project/radare2/libr/util/idpool.c" 3 4
        0
# 330 "project/radare2/libr/util/idpool.c"
             ;
 }
 if (!r_id_storage_add (storage->data, data, id)) {
  return 
# 333 "project/radare2/libr/util/idpool.c" 3 4
        0
# 333 "project/radare2/libr/util/idpool.c"
             ;
 }
 ...
 if (storage->psize <= storage->ptop) {
  ...
  return 
# 342 "project/radare2/libr/util/idpool.c" 3 4
        0
# 342 "project/radare2/libr/util/idpool.c"
             ;
 }
 if (!storage->permutation) {
  return 
# 345 "project/radare2/libr/util/idpool.c" 3 4
        0
# 345 "project/radare2/libr/util/idpool.c"
             ;
 }
 *od = storage->ptop;
 ...
 storage->ptop++;
 return 
# 350 "project/radare2/libr/util/idpool.c" 3 4
       1
# 350 "project/radare2/libr/util/idpool.c"
           ;
}


# 353 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 353 "project/radare2/libr/util/idpool.c"
          r_oids_to_front(ROIDStorage *storage, const 
# 353 "project/radare2/libr/util/idpool.c" 3 4
                                                      unsigned int 
# 353 "project/radare2/libr/util/idpool.c"
                                                           id) {
 
# 354 "project/radare2/libr/util/idpool.c" 3 4
unsigned int 
# 354 "project/radare2/libr/util/idpool.c"
     od;
 if (!storage || !storage->permutation) {
  return 
# 356 "project/radare2/libr/util/idpool.c" 3 4
        0
# 356 "project/radare2/libr/util/idpool.c"
             ;
 }
 ...
 if (od == storage->ptop) {
  return 
# 364 "project/radare2/libr/util/idpool.c" 3 4
        0
# 364 "project/radare2/libr/util/idpool.c"
             ;
 } else if (od == (storage->ptop - 1)) {
  return 
# 366 "project/radare2/libr/util/idpool.c" 3 4
        1
# 366 "project/radare2/libr/util/idpool.c"
            ;
 }
 
# 368 "project/radare2/libr/util/idpool.c" 3 4
__builtin___memmove_chk (
# 368 "project/radare2/libr/util/idpool.c"
&storage->permutation[od]
# 368 "project/radare2/libr/util/idpool.c" 3 4
, 
# 368 "project/radare2/libr/util/idpool.c"
&storage->permutation[od + 1], (storage->ptop - od - 1) * sizeof (
# 368 "project/radare2/libr/util/idpool.c" 3 4
unsigned int
# 368 "project/radare2/libr/util/idpool.c"
)
...
# 369 "project/radare2/libr/util/idpool.c"
                                          ;
 storage->permutation[storage->ptop - 1]= id;
 return 
# 371 "project/radare2/libr/util/idpool.c" 3 4
       1
# 371 "project/radare2/libr/util/idpool.c"
           ;
}


# 374 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 374 "project/radare2/libr/util/idpool.c"
          r_oids_to_rear(ROIDStorage *storage, 
# 374 "project/radare2/libr/util/idpool.c" 3 4
                                               unsigned int 
# 374 "project/radare2/libr/util/idpool.c"
                                                    id) {
 
# 375 "project/radare2/libr/util/idpool.c" 3 4
unsigned int 
# 375 "project/radare2/libr/util/idpool.c"
     od;
 if (!storage || !storage->permutation ||
  !storage->data || (id >= storage->data->pool->next_id)) {
  return 
# 378 "project/radare2/libr/util/idpool.c" 3 4
        0
# 378 "project/radare2/libr/util/idpool.c"
             ;
 }
 
# 380 "project/radare2/libr/util/idpool.c" 3 4
_Bool 
# 380 "project/radare2/libr/util/idpool.c"
     found = 
# 380 "project/radare2/libr/util/idpool.c" 3 4
             0
# 380 "project/radare2/libr/util/idpool.c"
 ...
 for (od = 0; od < storage->ptop; od++) {
  if (id == storage->permutation[od]) {
   found = 
# 383 "project/radare2/libr/util/idpool.c" 3 4
          1
# 383 "project/radare2/libr/util/idpool.c"
              ;
   break;
  }
 }
 if (od == storage->ptop) {
  return 
# 388 "project/radare2/libr/util/idpool.c" 3 4
        0
# 388 "project/radare2/libr/util/idpool.c"
             ;
 }
 if (!found) {
  return 
# 391 "project/radare2/libr/util/idpool.c" 3 4
        1
# 391 "project/radare2/libr/util/idpool.c"
            ;
 }
 
# 393 "project/radare2/libr/util/idpool.c" 3 4
__builtin___memmove_chk (
# 393 "project/radare2/libr/util/idpool.c"
&storage->permutation[1]
# 393 "project/radare2/libr/util/idpool.c" 3 4
, 
# 393 "project/radare2/libr/util/idpool.c"
&storage->permutation[0], od * sizeof (
# 393 "project/radare2/libr/util/idpool.c" 3 4
unsigned int
# 393 "project/radare2/libr/util/idpool.c"
)
...
# 393 "project/radare2/libr/util/idpool.c"
 ...
 return 
# 395 "project/radare2/libr/util/idpool.c" 3 4
       1
# 395 "project/radare2/libr/util/idpool.c"
           ;
}


# 398 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) 
# 398 "project/radare2/libr/util/idpool.c"
     void r_oids_delete(ROIDStorage *storage, 
# 398 "project/radare2/libr/util/idpool.c" 3 4
                                              unsigned int 
# 398 "project/radare2/libr/util/idpool.c"
                                                   id) {
...
# 405 "project/radare2/libr/util/idpool.c" 3 4
 { free((void *)
# 405 "project/radare2/libr/util/idpool.c"
 storage->permutation
# 405 "project/radare2/libr/util/idpool.c" 3 4
 ); 
# 405 "project/radare2/libr/util/idpool.c"
...
# 412 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) 
# 412 "project/radare2/libr/util/idpool.c"
     void r_oids_odelete(ROIDStorage *st, 
# 412 "project/radare2/libr/util/idpool.c" 3 4
                                          unsigned int 
# 412 "project/radare2/libr/util/idpool.c"
                                               od) {
 
# 413 "project/radare2/libr/util/idpool.c" 3 4
unsigned int 
# 413 "project/radare2/libr/util/idpool.c"
     n;
...
# 419 "project/radare2/libr/util/idpool.c" 3 4
__builtin___memmove_chk (
# 419 "project/radare2/libr/util/idpool.c"
&st->permutation[od]
# 419 "project/radare2/libr/util/idpool.c" 3 4
, 
# 419 "project/radare2/libr/util/idpool.c"
&st->permutation[od + 1], n * sizeof(
# 419 "project/radare2/libr/util/idpool.c" 3 4
unsigned int
# 419 "project/radare2/libr/util/idpool.c"
)
...
# 422 "project/radare2/libr/util/idpool.c" 3 4
 { free((void *)
# 422 "project/radare2/libr/util/idpool.c"
 st->permutation
# 422 "project/radare2/libr/util/idpool.c" 3 4
 ); 
# 422 "project/radare2/libr/util/idpool.c"
...
# 429 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) 
# 429 "project/radare2/libr/util/idpool.c"
     void *r_oids_take(ROIDStorage *storage, 
# 429 "project/radare2/libr/util/idpool.c" 3 4
                                             unsigned int 
# 429 "project/radare2/libr/util/idpool.c"
                                                  id) {
 
# 430 "project/radare2/libr/util/idpool.c" 3 4
do { if (!(
# 430 "project/radare2/libr/util/idpool.c"
storage
# 430 "project/radare2/libr/util/idpool.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 430 "project/radare2/libr/util/idpool.c"
...
# 436 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) 
# 436 "project/radare2/libr/util/idpool.c"
     void *r_oids_otake(ROIDStorage *st, 
# 436 "project/radare2/libr/util/idpool.c" 3 4
                                         unsigned int 
# 436 "project/radare2/libr/util/idpool.c"
                                              od) {
...
# 442 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) 
# 442 "project/radare2/libr/util/idpool.c"
     void r_oids_free(ROIDStorage *storage) {
 if (storage) {
...
# 451 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) 
# 451 "project/radare2/libr/util/idpool.c"
     void *r_oids_last(ROIDStorage *storage) {
 if (storage && storage->data && storage->data->data
  && storage->permutation) {
  return storage->data->data[storage->permutation[0]];
 }
 return 
# 456 "project/radare2/libr/util/idpool.c" 3 4
       ((void *)0)
# 456 "project/radare2/libr/util/idpool.c"
           ;
}



# 460 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) 
# 460 "project/radare2/libr/util/idpool.c"
     void *r_oids_first(ROIDStorage *storage) {
 if (storage && storage->data && storage->data->data
  && storage->permutation) {
  return storage->data->data[storage->permutation[storage->ptop - 1]];
 }
 return 
# 465 "project/radare2/libr/util/idpool.c" 3 4
       ((void *)0)
# 465 "project/radare2/libr/util/idpool.c"
           ;
}


# 468 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 468 "project/radare2/libr/util/idpool.c"
          r_oids_foreach (ROIDStorage *storage, RIDStorageForeachCb cb, void *user) {
 
# 469 "project/radare2/libr/util/idpool.c" 3 4
unsigned int 
# 469 "project/radare2/libr/util/idpool.c"
     i;
 
# 470 "project/radare2/libr/util/idpool.c" 3 4
unsigned int 
# 470 "project/radare2/libr/util/idpool.c"
     id;
 if (!cb || !storage || !storage->data || !storage->data->data
  || !storage->permutation) {
  return 
# 473 "project/radare2/libr/util/idpool.c" 3 4
        0
# 473 "project/radare2/libr/util/idpool.c"
             ;
 }
 for (i = storage->ptop - 1; i != 0; i--) {
  ...
  if (!cb (user, storage->data->data[id], id)) {
   return 
# 478 "project/radare2/libr/util/idpool.c" 3 4
         0
# 478 "project/radare2/libr/util/idpool.c"
              ;
  }
 }
...
# 485 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 485 "project/radare2/libr/util/idpool.c"
          r_oids_foreach_prev (ROIDStorage* storage, RIDStorageForeachCb cb, void* user) {
 
# 486 "project/radare2/libr/util/idpool.c" 3 4
unsigned int 
# 486 "project/radare2/libr/util/idpool.c"
     i;
 
# 487 "project/radare2/libr/util/idpool.c" 3 4
unsigned int 
# 487 "project/radare2/libr/util/idpool.c"
     id;
 if (!cb || !storage || !storage->data || !storage->data->data
  || !storage->permutation) {
  return 
# 490 "project/radare2/libr/util/idpool.c" 3 4
        0
# 490 "project/radare2/libr/util/idpool.c"
             ;
 }
 for (i = 0; i < storage->ptop; i++) {
  ...
  if (!cb (user, storage->data->data[id], id)) {
   return 
# 495 "project/radare2/libr/util/idpool.c" 3 4
         0
# 495 "project/radare2/libr/util/idpool.c"
              ;
  }
 }
 return 
# 498 "project/radare2/libr/util/idpool.c" 3 4
       1
# 498 "project/radare2/libr/util/idpool.c"
           ;
}


# 501 "project/radare2/libr/util/idpool.c" 3 4
_Bool 
# 501 "project/radare2/libr/util/idpool.c"
    oids_od_bfind (ROIDStorage *st, 
# 501 "project/radare2/libr/util/idpool.c" 3 4
                                    unsigned int 
# 501 "project/radare2/libr/util/idpool.c"
                                         *od, void *incoming, void *user) {
 
# 502 "project/radare2/libr/util/idpool.c" 3 4
long long 
# 502 "project/radare2/libr/util/idpool.c"
     high, low;
 int cmp_res;
 void *in;
 ...
 if (!st->ptop) {
  return 
# 507 "project/radare2/libr/util/idpool.c" 3 4
        0
# 507 "project/radare2/libr/util/idpool.c"
             ;
 }
 ...
 while (1) {
  if (high <= low) {
   od[0] = (
# 515 "project/radare2/libr/util/idpool.c" 3 4
           unsigned int
# 515 "project/radare2/libr/util/idpool.c"
               )low;
   in = r_oids_oget(st, od[0]);

   if (!st->cmp(in, incoming, user, &cmp_res)) {
    return 
# 519 "project/radare2/libr/util/idpool.c" 3 4
          0
# 519 "project/radare2/libr/util/idpool.c"
               ;
   }
   if (cmp_res < 0) {
    od[0]++;
   ...
   return 
# 524 "project/radare2/libr/util/idpool.c" 3 4
         1
# 524 "project/radare2/libr/util/idpool.c"
             ;
  }

  od[0] = (
# 527 "project/radare2/libr/util/idpool.c" 3 4
          unsigned int
# 527 "project/radare2/libr/util/idpool.c"
              )((low + high) / 2);
  in = r_oids_oget(st, od[0]);
  if (!st->cmp(in, incoming, user, &cmp_res)) {
   return 
# 530 "project/radare2/libr/util/idpool.c" 3 4
         0
# 530 "project/radare2/libr/util/idpool.c"
              ;
  }

  if (cmp_res == 0) {
   return 
# 534 "project/radare2/libr/util/idpool.c" 3 4
         1
# 534 "project/radare2/libr/util/idpool.c"
             ;
  }
 ...
 return 
# 544 "project/radare2/libr/util/idpool.c" 3 4
       0
# 544 "project/radare2/libr/util/idpool.c"
            ;
}


# 547 "project/radare2/libr/util/idpool.c" 3 4
_Bool 
# 547 "project/radare2/libr/util/idpool.c"
    oids_od_binsert(ROIDStorage *storage, 
# 547 "project/radare2/libr/util/idpool.c" 3 4
                                          unsigned int 
# 547 "project/radare2/libr/util/idpool.c"
                                               id, 
...
# 547 "project/radare2/libr/util/idpool.c"
 ...
 if (!oids_od_bfind (storage, od, incoming, user)) {
  return 
# 549 "project/radare2/libr/util/idpool.c" 3 4
        0
# 549 "project/radare2/libr/util/idpool.c"
             ;
 }
 if(od[0] != storage->ptop) {
  
# 552 "project/radare2/libr/util/idpool.c" 3 4
 __builtin___memmove_chk (
# 552 "project/radare2/libr/util/idpool.c"
 &storage->permutation[od[0] + 1]
# 552 "project/radare2/libr/util/idpool.c" 3 4
 , 
# 552 "project/radare2/libr/util/idpool.c"
 &storage->permutation[od[0]], (storage->ptop - od[0]) * sizeof(
# 552 "project/radare2/libr/util/idpool.c" 3 4
 unsigned int
# 552 "project/radare2/libr/util/idpool.c"
 )
...
# 552 "project/radare2/libr/util/idpool.c"
 ...
 return 
# 556 "project/radare2/libr/util/idpool.c" 3 4
       1
# 556 "project/radare2/libr/util/idpool.c"
           ;
}


# 559 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 559 "project/radare2/libr/util/idpool.c"
          r_oids_insert(ROIDStorage *storage, void *data, 
# 559 "project/radare2/libr/util/idpool.c" 3 4
                                                          unsigned int 
# 559 "project/radare2/libr/util/idpool.c"
                                                               *id, 
...
# 559 "project/radare2/libr/util/idpool.c"
 ...
 if (!storage || !storage->cmp || !id || !od) {
  return 
# 561 "project/radare2/libr/util/idpool.c" 3 4
        0
# 561 "project/radare2/libr/util/idpool.c"
             ;
 }
 if (!storage->ptop) {
 ...
 if (!r_id_storage_add (storage->data, data, id)) {
  return 
# 567 "project/radare2/libr/util/idpool.c" 3 4
        0
# 567 "project/radare2/libr/util/idpool.c"
             ;
 }
...
# 575 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 575 "project/radare2/libr/util/idpool.c"
          r_oids_sort(ROIDStorage *storage, void *user) {
 
# 576 "project/radare2/libr/util/idpool.c" 3 4
unsigned int 
# 576 "project/radare2/libr/util/idpool.c"
     od, id, ptop, *permutation;

 if (!storage || !storage->ptop || !storage->cmp) {
  return 
# 579 "project/radare2/libr/util/idpool.c" 3 4
        0
# 579 "project/radare2/libr/util/idpool.c"
             ;
 }
 if (storage->ptop == 1) {
  return 
# 582 "project/radare2/libr/util/idpool.c" 3 4
        1
# 582 "project/radare2/libr/util/idpool.c"
            ;
 }
 permutation = storage->permutation;
 storage->permutation = 
# 585 "project/radare2/libr/util/idpool.c" 3 4
                       (unsigned int*)calloc(
# 585 "project/radare2/libr/util/idpool.c"
                       storage->psize
# 585 "project/radare2/libr/util/idpool.c" 3 4
                       ,sizeof(unsigned int))
# 585 "project/radare2/libr/util/idpool.c"
 ...
 if (!storage->permutation) {
  ...
  return 
# 588 "project/radare2/libr/util/idpool.c" 3 4
        0
# 588 "project/radare2/libr/util/idpool.c"
             ;
 }
 ...
 free (permutation);
 return 
# 601 "project/radare2/libr/util/idpool.c" 3 4
       1
# 601 "project/radare2/libr/util/idpool.c"
           ;
...
beach:
 ...
 storage->ptop = ptop;
 return 
# 607 "project/radare2/libr/util/idpool.c" 3 4
       0
# 607 "project/radare2/libr/util/idpool.c"
            ;
}


# 610 "project/radare2/libr/util/idpool.c" 3 4
__attribute__((visibility("default"))) unsigned int 
# 610 "project/radare2/libr/util/idpool.c"
          r_oids_find(ROIDStorage *storage, void *incoming, void *user) {
 
# 611 "project/radare2/libr/util/idpool.c" 3 4
unsigned int 
# 611 "project/radare2/libr/util/idpool.c"
     ret;
