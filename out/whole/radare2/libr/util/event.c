# 0 "project/radare2/libr/util/event.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/event.c"
...
# 4 "project/radare2/libr/util/event.c" 2



# 6 "project/radare2/libr/util/event.c"
...
# 16 "project/radare2/libr/util/event.c" 3 4
__attribute__((visibility("default"))) 
# 16 "project/radare2/libr/util/event.c"
     REvent *r_event_new(void *user) {
 REvent *ev = 
# 17 "project/radare2/libr/util/event.c" 3 4
             (
# 17 "project/radare2/libr/util/event.c"
             REvent
# 17 "project/radare2/libr/util/event.c" 3 4
             *)calloc(1,sizeof(
# 17 "project/radare2/libr/util/event.c"
...
# 17 "project/radare2/libr/util/event.c"
 ...
 if (!ev) {
  return 
# 19 "project/radare2/libr/util/event.c" 3 4
        ((void *)0)
# 19 "project/radare2/libr/util/event.c"
            ;
 }

 ev->user = user;
 ev->next_handle = 0;
 ev->callbacks = ht_up_new (
# 24 "project/radare2/libr/util/event.c" 3 4
                           ((void *)0)
# 24 "project/radare2/libr/util/event.c"
                               , ht_callback_free, 
# 24 "project/radare2/libr/util/event.c" 3 4
                                                   ((void *)0)
# 24 "project/radare2/libr/util/event.c"
 ...
 r_vector_init (&ev->all_callbacks, sizeof (REventCallbackHook), 
# 28 "project/radare2/libr/util/event.c" 3 4
                                                                ((void *)0)
# 28 "project/radare2/libr/util/event.c"
                                                                    , 
# 28 "project/radare2/libr/util/event.c" 3 4
                                                                      ((void *)0)
# 28 "project/radare2/libr/util/event.c"
...
err:
 r_event_free (ev);
 return 
# 32 "project/radare2/libr/util/event.c" 3 4
       ((void *)0)
# 32 "project/radare2/libr/util/event.c"
           ;
}


# 35 "project/radare2/libr/util/event.c" 3 4
__attribute__((visibility("default"))) 
# 35 "project/radare2/libr/util/event.c"
...
static RVector *get_cbs(REvent *ev, int type) {
 RVector *cbs = ht_up_find (ev->callbacks, (
# 45 "project/radare2/libr/util/event.c" 3 4
                                           unsigned long long
# 45 "project/radare2/libr/util/event.c"
                                               )type, 
# 45 "project/radare2/libr/util/event.c" 3 4
                                                      ((void *)0)
# 45 "project/radare2/libr/util/event.c"
 ...
 if (!cbs) {
  cbs = r_vector_new (sizeof (REventCallbackHook), 
# 47 "project/radare2/libr/util/event.c" 3 4
                                                  ((void *)0)
# 47 "project/radare2/libr/util/event.c"
                                                      , 
# 47 "project/radare2/libr/util/event.c" 3 4
                                                        ((void *)0)
# 47 "project/radare2/libr/util/event.c"
  ...
  if (cbs) {
   ht_up_insert (ev->callbacks, (
# 49 "project/radare2/libr/util/event.c" 3 4
                                unsigned long long
# 49 "project/radare2/libr/util/event.c"
                                    )type, cbs);
  }
 }
 return cbs;
...
# 55 "project/radare2/libr/util/event.c" 3 4
__attribute__((visibility("default"))) 
# 55 "project/radare2/libr/util/event.c"
     REventCallbackHandle r_event_hook(REvent *ev, int type, REventCallback cb, void *user) {
 REventCallbackHandle handle = { 0 };
 REventCallbackHook hook;

 
# 59 "project/radare2/libr/util/event.c" 3 4
do { if (!(
# 59 "project/radare2/libr/util/event.c"
ev
# 59 "project/radare2/libr/util/event.c" 3 4
...
static 
# 77 "project/radare2/libr/util/event.c" 3 4
      _Bool 
# 77 "project/radare2/libr/util/event.c"
           del_hook(void *user, const 
# 77 "project/radare2/libr/util/event.c" 3 4
                                      unsigned long long 
# 77 "project/radare2/libr/util/event.c"
                                           k, const void *v) {
...
# 82 "project/radare2/libr/util/event.c" 3 4
do { if (!(
# 82 "project/radare2/libr/util/event.c"
cbs
# 82 "project/radare2/libr/util/event.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 82 "project/radare2/libr/util/event.c"
...
# 83 "project/radare2/libr/util/event.c" 3 4
if (!r_vector_empty (
# 83 "project/radare2/libr/util/event.c"
cbs
# 83 "project/radare2/libr/util/event.c" 3 4
)) for (
# 83 "project/radare2/libr/util/event.c"
...
# 83 "project/radare2/libr/util/event.c"
  ...
  if (hook->handle == handle) {
   r_vector_remove_at (cbs, i, 
# 85 "project/radare2/libr/util/event.c" 3 4
                              ((void *)0)
# 85 "project/radare2/libr/util/event.c"
                                  );
   break;
  }
 }
 return 
# 89 "project/radare2/libr/util/event.c" 3 4
       1
# 89 "project/radare2/libr/util/event.c"
           ;
}


# 92 "project/radare2/libr/util/event.c" 3 4
__attribute__((visibility("default"))) 
# 92 "project/radare2/libr/util/event.c"
     void r_event_unhook(REvent *ev, REventCallbackHandle handle) {
 
# 93 "project/radare2/libr/util/event.c" 3 4
do { if (!(
# 93 "project/radare2/libr/util/event.c"
ev
# 93 "project/radare2/libr/util/event.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 93 "project/radare2/libr/util/event.c"
...
# 93 "project/radare2/libr/util/event.c"
 ...
 if (handle.type == R_EVENT_ALL) {
  ...
  RVector *cbs = ht_up_find (ev->callbacks, (
# 100 "project/radare2/libr/util/event.c" 3 4
                                            unsigned long long
# 100 "project/radare2/libr/util/event.c"
                                                )handle.type, 
# 100 "project/radare2/libr/util/event.c" 3 4
                                                              ((void *)0)
# 100 "project/radare2/libr/util/event.c"
...
# 101 "project/radare2/libr/util/event.c" 3 4
 do { if (!(
# 101 "project/radare2/libr/util/event.c"
 cbs
# 101 "project/radare2/libr/util/event.c" 3 4
 )) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 101 "project/radare2/libr/util/event.c"
...
# 106 "project/radare2/libr/util/event.c" 3 4
__attribute__((visibility("default"))) 
# 106 "project/radare2/libr/util/event.c"
     void r_event_send(REvent *ev, int type, void *data) {
 REventCallbackHook *hook;
 
# 108 "project/radare2/libr/util/event.c" 3 4
do { if (!(
# 108 "project/radare2/libr/util/event.c"
ev && !ev->incall
# 108 "project/radare2/libr/util/event.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 108 "project/radare2/libr/util/event.c"
...
# 108 "project/radare2/libr/util/event.c"
 ...
 ev->incall = 
# 111 "project/radare2/libr/util/event.c" 3 4
             1
# 111 "project/radare2/libr/util/event.c"
                 ;
 
# 112 "project/radare2/libr/util/event.c" 3 4
if (!r_vector_empty (
# 112 "project/radare2/libr/util/event.c"
&ev->all_callbacks
# 112 "project/radare2/libr/util/event.c" 3 4
)) for (
# 112 "project/radare2/libr/util/event.c"
...
# 112 "project/radare2/libr/util/event.c"
 ...
 ev->incall = 
# 115 "project/radare2/libr/util/event.c" 3 4
             0
# 115 "project/radare2/libr/util/event.c"
                  ;

 RVector *cbs = ht_up_find (ev->callbacks, (
# 117 "project/radare2/libr/util/event.c" 3 4
                                           unsigned long long
# 117 "project/radare2/libr/util/event.c"
                                               )type, 
# 117 "project/radare2/libr/util/event.c" 3 4
                                                      ((void *)0)
# 117 "project/radare2/libr/util/event.c"
 ...
 ev->incall = 
# 121 "project/radare2/libr/util/event.c" 3 4
             1
# 121 "project/radare2/libr/util/event.c"
                 ;
 
# 122 "project/radare2/libr/util/event.c" 3 4
if (!r_vector_empty (
# 122 "project/radare2/libr/util/event.c"
cbs
# 122 "project/radare2/libr/util/event.c" 3 4
)) for (
# 122 "project/radare2/libr/util/event.c"
...
# 122 "project/radare2/libr/util/event.c"
 ...
 ev->incall = 
# 125 "project/radare2/libr/util/event.c" 3 4
             0
# 125 "project/radare2/libr/util/event.c"
                  ;
}
