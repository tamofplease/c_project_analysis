# 0 "project/radare2/libr/util/getopt.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 9 "project/radare2/libr/util/getopt.c" 2
...
# 14 "project/radare2/libr/util/getopt.c"
     void r_getopt_init(RGetopt *opt, int argc, const char **argv, const char *ostr) {
 
# 15 "project/radare2/libr/util/getopt.c" 3 4
__builtin___memset_chk (
# 15 "project/radare2/libr/util/getopt.c"
opt
# 15 "project/radare2/libr/util/getopt.c" 3 4
, 
# 15 "project/radare2/libr/util/getopt.c"
...
# 15 "project/radare2/libr/util/getopt.c"
 ...
 opt->reset = 0;
 opt->arg = 
# 20 "project/radare2/libr/util/getopt.c" 3 4
           ((void *)0)
# 20 "project/radare2/libr/util/getopt.c"
               ;
 opt->argc = argc;
 opt->argv = argv;
 opt->ostr = ostr;
...
# 26 "project/radare2/libr/util/getopt.c" 3 4
__attribute__((visibility("default"))) 
# 26 "project/radare2/libr/util/getopt.c"
 ...
 if ((opt->opt = (int)*place++) == (int)':' || !(oli = strchr (opt->ostr, opt->opt))) {
  ...
  if (opt->err && *opt->ostr != ':') {
   (void)
# 55 "project/radare2/libr/util/getopt.c" 3 4
        fprintf(__stderrp,
# 55 "project/radare2/libr/util/getopt.c"
        "%s: illegal option -- %c\n", opt->argv[0], opt->opt
# 55 "project/radare2/libr/util/getopt.c" 3 4
        )
# 55 "project/radare2/libr/util/getopt.c"
 ...
 if (*++oli == ':') {
  if (*place) {
   ...
   if (opt->err) {
    (void)
# 68 "project/radare2/libr/util/getopt.c" 3 4
         fprintf(__stderrp,
# 68 "project/radare2/libr/util/getopt.c"
...
# 68 "project/radare2/libr/util/getopt.c"
  ...
  opt->arg = 
# 77 "project/radare2/libr/util/getopt.c" 3 4
            ((void *)0)
# 77 "project/radare2/libr/util/getopt.c"
                ;
  if (!*place) {
   opt->ind++;
  }
