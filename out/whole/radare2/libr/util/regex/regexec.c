# 0 "project/radare2/libr/util/regex/regexec.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 45 "project/radare2/libr/util/regex/regexec.c" 2
...
# 46 "project/radare2/libr/util/regex/regexec.c" 2
...
# 47 "project/radare2/libr/util/regex/regexec.c" 2
...
# 48 "project/radare2/libr/util/regex/regexec.c" 2
...
# 49 "project/radare2/libr/util/regex/regexec.c" 2
...
# 50 "project/radare2/libr/util/regex/regexec.c" 2
...
# 51 "project/radare2/libr/util/regex/regexec.c" 2
...
#define ut8 unsigned char
# 52 "project/radare2/libr/util/regex/regexec.c" 2
...
# 53 "project/radare2/libr/util/regex/regexec.c" 2
...
# 1 "project/radare2/libr/util/regex/engine.c" 1
# 46 "project/radare2/libr/util/regex/engine.c"
...
static int smatcher(struct re_guts *, char *, size_t, RRegexMatch[], int);
static char *sdissect(struct smat *, char *, char *, sopno, sopno);
static char *sbackref(struct smat *, char *, char *, sopno, sopno, sopno, int);
static char *sfast(struct smat *, char *, char *, sopno, sopno);
static char *sslow(struct smat *, char *, char *, sopno, sopno);
static long sstep(struct re_guts *, sopno, sopno, long, int, long);
...
static int smatcher(struct re_guts *g, char *string, size_t nmatch, RRegexMatch pmatch[], int eflags) {
 char *endp;
 int i;
 struct smat mv;
 struct smat *m = &mv;
 ...
 if (g->cflags & 
# 123 "project/radare2/libr/util/regex/engine.c" 3 4
                0004
# 123 "project/radare2/libr/util/regex/engine.c"
                             ) {
  nmatch = 0;
 }
 if (eflags & 
# 126 "project/radare2/libr/util/regex/engine.c" 3 4
             00004 
# 126 "project/radare2/libr/util/regex/engine.c"
                              && pmatch) {
 ...
 if (start > stop) {
  return 
# 134 "project/radare2/libr/util/regex/engine.c" 3 4
        16
# 134 "project/radare2/libr/util/regex/engine.c"
                      ;
 }


 if (g->must != 
# 138 "project/radare2/libr/util/regex/engine.c" 3 4
               ((void *)0)
# 138 "project/radare2/libr/util/regex/engine.c"
                   ) {
  ...
  if (dp == stop) {
   return 
# 145 "project/radare2/libr/util/regex/engine.c" 3 4
         1
# 145 "project/radare2/libr/util/regex/engine.c"
                        ;
  }
 }
 ...
 m->eflags = eflags;
 m->pmatch = 
# 152 "project/radare2/libr/util/regex/engine.c" 3 4
            ((void *)0)
# 152 "project/radare2/libr/util/regex/engine.c"
                ;
 m->lastpos = 
# 153 "project/radare2/libr/util/regex/engine.c" 3 4
             ((void *)0)
# 153 "project/radare2/libr/util/regex/engine.c"
                 ;
 m->offp = string;
 m->beginp = start;
 m->endp = stop;
 ...
 if (m->g->nstates * 4 < m->g->nstates) {
  return 
# 159 "project/radare2/libr/util/regex/engine.c" 3 4
        1
# 159 "project/radare2/libr/util/regex/engine.c"
                       ;
 }
 ;
 ((m->st) = 0);
 ...
 for (;;) {
  endp = sfast (m, start, stop, gf, gl);
  if (!endp) {
   free (m->pmatch);
   free (m->lastpos);
   ;
   return 
# 175 "project/radare2/libr/util/regex/engine.c" 3 4
         1
# 175 "project/radare2/libr/util/regex/engine.c"
                        ;
  }
  ...
  for (;;) {
   endp = sslow (m, m->coldp, stop, gf, gl);
  ...
  if (!m->pmatch) {
   if ((m->g->nsub + 1) * sizeof (RRegexMatch) < m->g->nsub) {
    return 
# 197 "project/radare2/libr/util/regex/engine.c" 3 4
          12
# 197 "project/radare2/libr/util/regex/engine.c"
                        ;
   }
  ...
  if (!m->pmatch) {
   ;
   return 
# 204 "project/radare2/libr/util/regex/engine.c" 3 4
         12
# 204 "project/radare2/libr/util/regex/engine.c"
                       ;
  }
  for (i = 1; i <= m->g->nsub; i++) {
   m->pmatch[i].rm_so = m->pmatch[i].rm_eo = -1;
  }
  if (!g->backrefs && !(m->eflags&
# 209 "project/radare2/libr/util/regex/engine.c" 3 4
                                 02000
# 209 "project/radare2/libr/util/regex/engine.c"
                                              )) {
   dp = sdissect (m, m->coldp, endp, gf, gl);
  } else {
   if (g->nplus > 0 && !m->lastpos) {
    if ((g->nplus + 1) * sizeof (char *) < g->nplus) {
     ...
     ;
     return 
# 216 "project/radare2/libr/util/regex/engine.c" 3 4
           12
# 216 "project/radare2/libr/util/regex/engine.c"
                         ;
    }
   ...
   if (g->nplus > 0 && !m->lastpos) {
    ...
    ;
    return 
# 224 "project/radare2/libr/util/regex/engine.c" 3 4
          12
# 224 "project/radare2/libr/util/regex/engine.c"
                        ;
   }
   dp = sbackref (m, m->coldp, endp, gf, gl, (sopno)0, 0);
  }
  if (dp) {
   break;
  }
  ...
  for (;;) {
   if (dp != 
# 239 "project/radare2/libr/util/regex/engine.c" 3 4
            ((void *)0) 
# 239 "project/radare2/libr/util/regex/engine.c"
                 || endp <= m->coldp) {
    break;
   }
   endp = sslow (m, m->coldp, endp - 1, gf, gl);
   if (!endp) {
    break;
   }
  ...
  if (dp != 
# 259 "project/radare2/libr/util/regex/engine.c" 3 4
           ((void *)0) 
# 259 "project/radare2/libr/util/regex/engine.c"
                || dp != endp) {
   break;
  }
...
static char *
sdissect(struct smat *m, char *start, char *stop, sopno startst, sopno stopst)
{
 int i;
 sopno ss;
 sopno es;
 ...
 for (ss = startst; ss < stopst; ss = es) {
  ...
  es = ss;
  switch (((m->g->strip[es])&0xf8000000LU)) {
  case (9LU<<((unsigned)27)):
  case (11LU<<((unsigned)27)):
   es += ((m->g->strip[es])&0x07ffffffLU);
   break;
  case (15LU<<((unsigned)27)):
   while (((m->g->strip[es])&0xf8000000LU) != (18LU<<((unsigned)27)))
    es += ((m->g->strip[es])&0x07ffffffLU);
   break;
  }
  es++;
  ...
  switch (((m->g->strip[ss])&0xf8000000LU)) {
  case (1LU<<((unsigned)27)):
   break;
  case (2LU<<((unsigned)27)):
   sp++;
   break;
  case (3LU<<((unsigned)27)):
  case (4LU<<((unsigned)27)):
  case (19LU<<((unsigned)27)):
  case (20LU<<((unsigned)27)):
   break;
  case (5LU<<((unsigned)27)):
  case (6LU<<((unsigned)27)):
   sp++;
   break;
  case (7LU<<((unsigned)27)):
  case (8LU<<((unsigned)27)):
   break;
  ...
  case (11LU<<((unsigned)27)):
   ...
   for (;;) {
    ...
    rest = sslow(m, sp, stp, ss, es);
    if (rest) {

     tail = sslow(m, rest, stop, es, stopst);
     if (tail == stop)
      break;
   ...
   if (sslow(m, sp, rest, ssub, esub) != 
# 370 "project/radare2/libr/util/regex/engine.c" 3 4
                                       ((void *)0)
# 370 "project/radare2/libr/util/regex/engine.c"
                                           ) {
    dp = sdissect(m, sp, rest, ssub, esub);
    if (dp != rest) return 
# 372 "project/radare2/libr/util/regex/engine.c" 3 4
                          ((void *)0)
# 372 "project/radare2/libr/util/regex/engine.c"
                              ;
   } else if (sp != rest) return 
# 373 "project/radare2/libr/util/regex/engine.c" 3 4
                                ((void *)0)
# 373 "project/radare2/libr/util/regex/engine.c"
                                    ;
   sp = rest;
   break;
  case (9LU<<((unsigned)27)):
   ...
   for (;;) {
    ...
    rest = sslow(m, sp, stp, ss, es);
    if (rest != 
# 381 "project/radare2/libr/util/regex/engine.c" 3 4
               ((void *)0)
# 381 "project/radare2/libr/util/regex/engine.c"
                   ) {
   ...
   oldssp = ssp;
   for (;;) {
    sep = sslow(m, ssp, rest, ssub, esub);
    if (!sep || sep == ssp)
     break;
    oldssp = ssp;
    ssp = sep;
   ...
   if (sep == rest) {
    if (sslow(m, ssp, sep, ssub, esub) == rest) {
     dp = sdissect(m, ssp, sep, ssub, esub);
     if (dp == sep) {
      sp = rest;
     }
    }
  ...
  case (15LU<<((unsigned)27)):
   ...
   ssub = ss + 1;
   esub = ss + ((m->g->strip[ss])&0x07ffffffLU) - 1;
   if (((m->g->strip[esub])&0xf8000000LU) != (16LU<<((unsigned)27))) {
    break;
   }
   for (;;) {
    if (sslow (m, sp, rest, ssub, esub) == rest)
     break;

    if (((m->g->strip[esub])&0xf8000000LU) == (16LU<<((unsigned)27))) {
     esub++;
     if (((m->g->strip[esub])&0xf8000000LU) == (17LU<<((unsigned)27))) {
      ssub = esub + 1;
      esub += ((m->g->strip[esub])&0x07ffffffLU);
      if (((m->g->strip[esub])&0xf8000000LU) == (17LU<<((unsigned)27))) {
       esub--;
      } else {
       if (((m->g->strip[esub])&0xf8000000LU) != (18LU<<((unsigned)27))) {
        break;
       }
      }
     }
  ...
  case (12LU<<((unsigned)27)):
  case (16LU<<((unsigned)27)):
  case (17LU<<((unsigned)27)):
  case (18LU<<((unsigned)27)):
   break;
  case (13LU<<((unsigned)27)):
   i = ((m->g->strip[ss])&0x07ffffffLU);
   if (i > 0 && i <= m->g->nsub) {
 ...
 return (sp == stop)? sp: 
# 481 "project/radare2/libr/util/regex/engine.c" 3 4
                         ((void *)0)
# 481 "project/radare2/libr/util/regex/engine.c"
                             ;
}
...
static char *
sbackref(struct smat *m, char *start, char *stop, sopno startst, sopno stopst,
    sopno lev, int rec)
{
 int i;
 sopno ss;
...
# 501 "project/radare2/libr/util/regex/engine.c" 3 4
unsigned long long 
# 501 "project/radare2/libr/util/regex/engine.c"
     offsave;
 cset *cs;
 ...
 for (ss = startst; !hard && ss < stopst; ss++)
  switch (((s = m->g->strip[ss])&0xf8000000LU)) {
  case (2LU<<((unsigned)27)):
   if (sp == stop || *sp++ != (char)((s)&0x07ffffffLU))
    return 
# 513 "project/radare2/libr/util/regex/engine.c" 3 4
          ((void *)0)
# 513 "project/radare2/libr/util/regex/engine.c"
              ;
   break;
  case (5LU<<((unsigned)27)):
   if (sp == stop)
    return 
# 517 "project/radare2/libr/util/regex/engine.c" 3 4
          ((void *)0)
# 517 "project/radare2/libr/util/regex/engine.c"
              ;
   sp++;
   break;
  case (6LU<<((unsigned)27)):
   cs = &m->g->sets[((s)&0x07ffffffLU)];
   if (sp == stop || !((cs)->ptr[(unsigned char)(*sp++)] & (cs)->mask))
    return 
# 523 "project/radare2/libr/util/regex/engine.c" 3 4
          ((void *)0)
# 523 "project/radare2/libr/util/regex/engine.c"
              ;
   break;
  case (3LU<<((unsigned)27)):
   if ( (sp == m->beginp && !(m->eflags&
# 526 "project/radare2/libr/util/regex/engine.c" 3 4
                                       00001
# 526 "project/radare2/libr/util/regex/engine.c"
                                                     )) ||
     (sp < m->endp && *(sp-1) == '\n' &&
      (m->g->cflags&
# 528 "project/radare2/libr/util/regex/engine.c" 3 4
                   0010
# 528 "project/radare2/libr/util/regex/engine.c"
                                  )) )
    { }
   else
    return 
# 531 "project/radare2/libr/util/regex/engine.c" 3 4
          ((void *)0)
# 531 "project/radare2/libr/util/regex/engine.c"
              ;
   break;
  case (4LU<<((unsigned)27)):
   if ( (sp == m->endp && !(m->eflags&
# 534 "project/radare2/libr/util/regex/engine.c" 3 4
                                     00002
# 534 "project/radare2/libr/util/regex/engine.c"
                                                   )) ||
     (sp < m->endp && *sp == '\n' &&
      (m->g->cflags&
# 536 "project/radare2/libr/util/regex/engine.c" 3 4
                   0010
# 536 "project/radare2/libr/util/regex/engine.c"
                                  )) )
    { }
   else
    return 
# 539 "project/radare2/libr/util/regex/engine.c" 3 4
          ((void *)0)
# 539 "project/radare2/libr/util/regex/engine.c"
              ;
   break;
  case (19LU<<((unsigned)27)):
   if (( (sp == m->beginp && !(m->eflags&
# 542 "project/radare2/libr/util/regex/engine.c" 3 4
                                        00001
# 542 "project/radare2/libr/util/regex/engine.c"
                                                      )) ||
     (sp < m->endp && *(sp-1) == '\n' &&
      (m->g->cflags&
# 544 "project/radare2/libr/util/regex/engine.c" 3 4
                   0010
# 544 "project/radare2/libr/util/regex/engine.c"
                                  )) ||
     (sp > m->beginp && !(isalnum((unsigned char)((unsigned char)*(sp-1))) || ((unsigned char)*(sp-1)) == '_')) ) &&
     (sp < m->endp && (isalnum((unsigned char)((unsigned char)*sp)) || ((unsigned char)*sp) == '_')) )
    { }
   else
    return 
# 549 "project/radare2/libr/util/regex/engine.c" 3 4
          ((void *)0)
# 549 "project/radare2/libr/util/regex/engine.c"
              ;
   break;
  case (20LU<<((unsigned)27)):
   if (( (sp == m->endp && !(m->eflags&
# 552 "project/radare2/libr/util/regex/engine.c" 3 4
                                      00002
# 552 "project/radare2/libr/util/regex/engine.c"
                                                    )) ||
     (sp < m->endp && *sp == '\n' &&
      (m->g->cflags&
# 554 "project/radare2/libr/util/regex/engine.c" 3 4
                   0010
# 554 "project/radare2/libr/util/regex/engine.c"
                                  )) ||
     (sp < m->endp && !(isalnum((unsigned char)((unsigned char)*sp)) || ((unsigned char)*sp) == '_')) ) &&
     (sp > m->beginp && (isalnum((unsigned char)((unsigned char)*(sp-1))) || ((unsigned char)*(sp-1)) == '_')) )
    { }
    ...
    return 
# 559 "project/radare2/libr/util/regex/engine.c" 3 4
          ((void *)0)
# 559 "project/radare2/libr/util/regex/engine.c"
              ;
   break;
  case (12LU<<((unsigned)27)):
   break;
  case (16LU<<((unsigned)27)):
   ...
   s = m->g->strip[ss];
   do {
    if (((s)&0xf8000000LU) == (17LU<<((unsigned)27))) {
     ss += ((s)&0x07ffffffLU);
    }
   } while (((s = m->g->strip[ss])&0xf8000000LU) != (18LU<<((unsigned)27)));
 ...
 if (!hard) {
  return (sp == stop)? sp: 
# 578 "project/radare2/libr/util/regex/engine.c" 3 4
                          ((void *)0)
# 578 "project/radare2/libr/util/regex/engine.c"
                              ;
 }
 ss--;
 ...
 case (7LU<<((unsigned)27)):
  ...
  if (i > 0 && i <= m->g->nsub) {
   if (m->pmatch[i].rm_eo == -1) {
    return 
# 590 "project/radare2/libr/util/regex/engine.c" 3 4
          ((void *)0)
# 590 "project/radare2/libr/util/regex/engine.c"
              ;
   }
  }
  if (m->pmatch[i].rm_so != -1) {
   ...
   if (len == 0 && rec++ > 100)
    return 
# 596 "project/radare2/libr/util/regex/engine.c" 3 4
          ((void *)0)
# 596 "project/radare2/libr/util/regex/engine.c"
              ;
   if (stop - m->beginp >= len) {
    if (sp > stop - len) {
     return 
# 599 "project/radare2/libr/util/regex/engine.c" 3 4
           ((void *)0)
# 599 "project/radare2/libr/util/regex/engine.c"
               ;
    }
   }
   ...
   if (memcmp (sp, ssp, len) != 0)
    return 
# 604 "project/radare2/libr/util/regex/engine.c" 3 4
          ((void *)0)
# 604 "project/radare2/libr/util/regex/engine.c"
              ;
   while (m->g->strip[ss] != (((8LU<<((unsigned)27)))|(i)))
    ss++;
   return sbackref (m, sp+len, stop, ss + 1, stopst, lev, rec);
  }
  break;
 case (11LU<<((unsigned)27)):
  dp = sbackref(m, sp, stop, ss+1, stopst, lev, rec);
  if (dp) {
   return dp;
  }
  return sbackref (m, sp, stop, ss + ((s)&0x07ffffffLU) + 1, stopst, lev, rec);
 case (9LU<<((unsigned)27)):
 ...
 case (10LU<<((unsigned)27)):
  ...
  m->lastpos[lev] = sp;
  dp = sbackref(m, sp, stop, ss-((s)&0x07ffffffLU)+1, stopst, lev, rec);
  return dp? dp: sbackref(m, sp, stop, ss+1, stopst, lev-1, rec);
 case (15LU<<((unsigned)27)):
  ssub = ss + 1;
  esub = ss + ((s)&0x07ffffffLU) - 1;
  if (((m->g->strip[esub])&0xf8000000LU) != (16LU<<((unsigned)27))) {
   break;
  }
  for (;;) {
   dp = sbackref(m, sp, stop, ssub, esub, lev, rec);
   if (dp != 
# 637 "project/radare2/libr/util/regex/engine.c" 3 4
            ((void *)0)
# 637 "project/radare2/libr/util/regex/engine.c"
                )
    return dp;

   if (((m->g->strip[esub])&0xf8000000LU) == (18LU<<((unsigned)27)))
    return 
# 641 "project/radare2/libr/util/regex/engine.c" 3 4
          ((void *)0)
# 641 "project/radare2/libr/util/regex/engine.c"
              ;
   esub++;
   if (((m->g->strip[esub])&0xf8000000LU) != (17LU<<((unsigned)27))) {
    break;
 ...
 case (13LU<<((unsigned)27)):
  ...
  if (i > 0 && i <= m->g->nsub) {
   ...
   dp = sbackref(m, sp, stop, ss+1, stopst, lev, rec);
   if (dp != 
# 662 "project/radare2/libr/util/regex/engine.c" 3 4
            ((void *)0)
# 662 "project/radare2/libr/util/regex/engine.c"
                )
    return(dp);
   m->pmatch[i].rm_so = offsave;
   return(
# 665 "project/radare2/libr/util/regex/engine.c" 3 4
         ((void *)0)
# 665 "project/radare2/libr/util/regex/engine.c"
             );
  }
  break;
 case (14LU<<((unsigned)27)):
  ...
  if (i > 0 && i <= m->g->nsub) {
   ...
   return 
# 678 "project/radare2/libr/util/regex/engine.c" 3 4
         ((void *)0)
# 678 "project/radare2/libr/util/regex/engine.c"
             ;
  }
  break;
 default:
 ...
 return 
# 686 "project/radare2/libr/util/regex/engine.c" 3 4
       ((void *)0)
# 686 "project/radare2/libr/util/regex/engine.c"
           ;
}
...
static char *
sfast(struct smat *m, char *start, char *stop, sopno startst, sopno stopst)
{
 long st = m->st;
 long fresh = m->fresh;
 long tmp = m->tmp;
 char *p = start;
 int c = (start == m->beginp) ? (0x7f +1) : *(start-1);
 int lastc;
 int flagch;
 int i;
 char *coldp;
 ...
 ((st) = 0);
 ((st) |= (unsigned long)1 << (startst));
 st = sstep (m->g, startst, stopst, st, (((0x7f +1)+1)+3), st);
 ((fresh) = (st));
 ;
 coldp = 
# 710 "project/radare2/libr/util/regex/engine.c" 3 4
        ((void *)0)
# 710 "project/radare2/libr/util/regex/engine.c"
            ;
 for (;;) {
  ...
  i = 0;
  if ( (lastc == '\n' && m->g->cflags&
# 721 "project/radare2/libr/util/regex/engine.c" 3 4
                                     0010
# 721 "project/radare2/libr/util/regex/engine.c"
                                                    ) ||
    (lastc == (0x7f +1) && !(m->eflags&
# 722 "project/radare2/libr/util/regex/engine.c" 3 4
                                00001
# 722 "project/radare2/libr/util/regex/engine.c"
                                              )) ) {
   flagch = ((0x7f +1)+1);
   i = m->g->nbol;
  }
  if ( (c == '\n' && m->g->cflags&
# 726 "project/radare2/libr/util/regex/engine.c" 3 4
                                 0010
# 726 "project/radare2/libr/util/regex/engine.c"
                                                ) ||
    (c == (0x7f +1) && !(m->eflags&
# 727 "project/radare2/libr/util/regex/engine.c" 3 4
                            00002
# 727 "project/radare2/libr/util/regex/engine.c"
                                          )) ) {
   flagch = (flagch == ((0x7f +1)+1)) ? (((0x7f +1)+1)+2) : (((0x7f +1)+1)+1);
   i += m->g->neol;
  }
  if (i != 0) {
   for (; i > 0; i--) {
  ...
  if ( (flagch == ((0x7f +1)+1) || (lastc != (0x7f +1) && !(isalnum((unsigned char)(lastc)) || (lastc) == '_'))) &&
     (c != (0x7f +1) && (isalnum((unsigned char)(c)) || (c) == '_')) ) {
   flagch = (((0x7f +1)+1)+4);
  }
  if ( (lastc != (0x7f +1) && (isalnum((unsigned char)(lastc)) || (lastc) == '_')) &&
    (flagch == (((0x7f +1)+1)+1) || (c != (0x7f +1) && !(isalnum((unsigned char)(c)) || (c) == '_'))) ) {
   flagch = (((0x7f +1)+1)+5);
  }
  if (flagch == (((0x7f +1)+1)+4) || flagch == (((0x7f +1)+1)+5)) {
   st = sstep (m->g, startst, stopst, st, flagch, st);
   ;
  }


  if ((((st) & ((unsigned long)1 << (stopst))) != 0) || p == stop) {
   break;
  }
  ...
  ;
  if (!((sstep (m->g, startst, stopst, st, (((0x7f +1)+1)+3), st)) == (st))) {
   break;
  }
  p++;
 }
 ...
 if (coldp) {
  m->coldp = coldp;
  if ((((st) & ((unsigned long)1 << (stopst))) != 0))
   return p + 1;
 }
 return 
# 776 "project/radare2/libr/util/regex/engine.c" 3 4
       ((void *)0)
# 776 "project/radare2/libr/util/regex/engine.c"
           ;
}
...
static char *
sslow(struct smat *m, char *start, char *stop, sopno startst, sopno stopst)
{
 long st = m->st;
 long empty = m->empty;
 long tmp = m->tmp;
 ...
 st = sstep (m->g, startst, stopst, st, (((0x7f +1)+1)+3), st);
 matchp = 
# 800 "project/radare2/libr/util/regex/engine.c" 3 4
         ((void *)0)
# 800 "project/radare2/libr/util/regex/engine.c"
             ;
 for (;;) {
  ...
  i = 0;
  if ( (lastc == '\n' && m->g->cflags&
# 809 "project/radare2/libr/util/regex/engine.c" 3 4
                                     0010
# 809 "project/radare2/libr/util/regex/engine.c"
                                                    ) ||
    (lastc == (0x7f +1) && !(m->eflags&
# 810 "project/radare2/libr/util/regex/engine.c" 3 4
                                00001
# 810 "project/radare2/libr/util/regex/engine.c"
                                              )) ) {
   flagch = ((0x7f +1)+1);
   i = m->g->nbol;
  }
  if ( (c == '\n' && m->g->cflags&
# 814 "project/radare2/libr/util/regex/engine.c" 3 4
                                 0010
# 814 "project/radare2/libr/util/regex/engine.c"
                                                ) ||
    (c == (0x7f +1) && !(m->eflags&
# 815 "project/radare2/libr/util/regex/engine.c" 3 4
                            00002
# 815 "project/radare2/libr/util/regex/engine.c"
                                          )) ) {
   flagch = (flagch == ((0x7f +1)+1)) ? (((0x7f +1)+1)+2) : (((0x7f +1)+1)+1);
   i += m->g->neol;
  }
    ...
    long aft)
{
 ...
 for (pc = start, ((here) = (unsigned long)1 << (pc)); pc != stop; pc++, ((here) <<= 1)) {
  s = g->strip[pc];
  switch (((s)&0xf8000000LU)) {
  case (1LU<<((unsigned)27)):
   break;
  case (2LU<<((unsigned)27)):
   ...
   if (!((ch) > 0x7f) || ch != (char)((s)&0x07ffffffLU)) {
    if (ch == (char)((s)&0x07ffffffLU)) {
     ((aft) |= ((unsigned long)(bef)&(here)) << (1));
    }
   }
   break;
  case (3LU<<((unsigned)27)):
   if (ch == ((0x7f +1)+1) || ch == (((0x7f +1)+1)+2)) {
    ((aft) |= ((unsigned long)(bef)&(here)) << (1));
   }
   break;
  case (4LU<<((unsigned)27)):
   if (ch == (((0x7f +1)+1)+1) || ch == (((0x7f +1)+1)+2)) {
    ((aft) |= ((unsigned long)(bef)&(here)) << (1));
   }
   break;
  case (19LU<<((unsigned)27)):
  ...
  case (5LU<<((unsigned)27)):
   ...
   break;
  case (6LU<<((unsigned)27)):
   cs = &g->sets[((s)&0x07ffffffLU)];
   if (!((ch) > 0x7f) && ((cs)->ptr[(unsigned char)(ch)] & (cs)->mask))
    ((aft) |= ((unsigned long)(bef)&(here)) << (1));
   break;
  case (7LU<<((unsigned)27)):
  case (8LU<<((unsigned)27)):
   ((aft) |= ((unsigned long)(aft)&(here)) << (1));
   break;
  case (9LU<<((unsigned)27)):
   ((aft) |= ((unsigned long)(aft)&(here)) << (1));
   break;
  case (10LU<<((unsigned)27)):
   ((aft) |= ((unsigned long)(aft)&(here)) << (1));
   i = (((aft) & ((unsigned long)here >> (((s)&0x07ffffffLU)))) != 0);
   ((aft) |= ((unsigned long)(aft)&(here)) >> (((s)&0x07ffffffLU)));
   if (!i && (((aft) & ((unsigned long)here >> (((s)&0x07ffffffLU)))) != 0)) {

    pc -= ((s)&0x07ffffffLU) + 1;
    ((here) = (unsigned long)1 << (pc));
   }
   break;
  case (11LU<<((unsigned)27)):
   ((aft) |= ((unsigned long)(aft)&(here)) << (1));
  ...
  case (15LU<<((unsigned)27)):
   ((aft) |= ((unsigned long)(aft)&(here)) << (1));
   if ((((g->strip[pc + ((s)&0x07ffffffLU)])&0xf8000000LU) != (17LU<<((unsigned)27)))) {
    break;
   }
   ((aft) |= ((unsigned long)(aft)&(here)) << (((s)&0x07ffffffLU)));
   break;
  case (16LU<<((unsigned)27)):
   if ((((aft) & (here)) != 0)) {
    for (look = 1;
      ((s = g->strip[pc+look])&0xf8000000LU) != (18LU<<((unsigned)27));
      look += ((s)&0x07ffffffLU)) {
       if (((s)&0xf8000000LU) != (17LU<<((unsigned)27))) {
        break;
       }
      }
    ((aft) |= ((unsigned long)(aft)&(here)) << (look));
   }
   break;
  case (17LU<<((unsigned)27)):
   ((aft) |= ((unsigned long)(aft)&(here)) << (1));
   if (((g->strip[pc+((s)&0x07ffffffLU)])&0xf8000000LU) != (18LU<<((unsigned)27))) {
    if (((g->strip[pc+((s)&0x07ffffffLU)])&0xf8000000LU) == (17LU<<((unsigned)27))) {
     ((aft) |= ((unsigned long)(aft)&(here)) << (((s)&0x07ffffffLU)));
    }
   }
...
# 986 "project/radare2/libr/util/regex/engine.c" 3 4
  fprintf(__stderrp,
# 986 "project/radare2/libr/util/regex/engine.c"
  "ops in regex.c\n"
# 986 "project/radare2/libr/util/regex/engine.c" 3 4
  )
# 986 "project/radare2/libr/util/regex/engine.c"
...
#undef match
#undef nope
# 80 "project/radare2/libr/util/regex/regexec.c" 2
...
#define STATESETUP(m,nv) { (m)->space = malloc((nv)*(m)->g->nstates); if (!(m)->space) return R_REGEX_ESPACE; (m)->vn = 0; }
...
# 1 "project/radare2/libr/util/regex/engine.c" 1
# 58 "project/radare2/libr/util/regex/engine.c"
...
static int lmatcher(struct re_guts *, char *, size_t, RRegexMatch[], int);
static char *ldissect(struct lmat *, char *, char *, sopno, sopno);
static char *lbackref(struct lmat *, char *, char *, sopno, sopno, sopno, int);
static char *lfast(struct lmat *, char *, char *, sopno, sopno);
static char *lslow(struct lmat *, char *, char *, sopno, sopno);
static char * lstep(struct re_guts *, sopno, sopno, char *, int, char *);
#define MAX_RECURSION 100
#define BOL (OUT+1)
#define EOL (BOL+1)
#define BOLEOL (BOL+2)
...
static int lmatcher(struct re_guts *g, char *string, size_t nmatch, RRegexMatch pmatch[], int eflags) {
 char *endp;
 int i;
 struct lmat mv;
 struct lmat *m = &mv;
...
# 159 "project/radare2/libr/util/regex/engine.c"
 ...
 { (m)->space = malloc((4)*(m)->g->nstates); if (!(m)->space) return 
# 161 "project/radare2/libr/util/regex/engine.c" 3 4
12
# 161 "project/radare2/libr/util/regex/engine.c"
; (m)->vn = 0; };
 ((m->st) = &m->space[m->vn++ * m->g->nstates]);
 ((m->fresh) = &m->space[m->vn++ * m->g->nstates]);
 ((m->tmp) = &m->space[m->vn++ * m->g->nstates]);
 ((m->empty) = &m->space[m->vn++ * m->g->nstates]);
 
# 166 "project/radare2/libr/util/regex/engine.c" 3 4
__builtin___memset_chk (
# 166 "project/radare2/libr/util/regex/engine.c"
m->empty
# 166 "project/radare2/libr/util/regex/engine.c" 3 4
, 
# 166 "project/radare2/libr/util/regex/engine.c"
...
# 175 "project/radare2/libr/util/regex/engine.c"
  ...
  for (;;) {
   endp = lslow (m, m->coldp, stop, gf, gl);
   if (endp || m->coldp > m->endp) {
    break;
   }
   m->coldp++;
...
# 209 "project/radare2/libr/util/regex/engine.c"
   ...
   dp = ldissect (m, m->coldp, endp, gf, gl);
  } else {
   if (g->nplus > 0 && !m->lastpos) {
    if ((g->nplus + 1) * sizeof (char *) < g->nplus) {
     free (m->pmatch);
...
# 224 "project/radare2/libr/util/regex/engine.c"
   ...
   dp = lbackref (m, m->coldp, endp, gf, gl, (sopno)0, 0);
  }
  if (dp) {
   break;
  }
...
# 239 "project/radare2/libr/util/regex/engine.c"
   ...
   endp = lslow (m, m->coldp, endp - 1, gf, gl);
   if (!endp) {
    break;
   }
...
static char *
ldissect(struct lmat *m, char *start, char *stop, sopno startst, sopno stopst)
{
 int i;
 sopno ss;
 sopno es;
 ...
 for (ss = startst; ss < stopst; ss = es) {
  ...
  case (11LU<<((unsigned)27)):
   ...
   for (;;) {
    ...
    rest = lslow(m, sp, stp, ss, es);
    if (rest) {

     tail = lslow(m, rest, stop, es, stopst);
     if (tail == stop)
      break;
   ...
   if (lslow(m, sp, rest, ssub, esub) != 
# 370 "project/radare2/libr/util/regex/engine.c" 3 4
                                       ((void *)0)
# 370 "project/radare2/libr/util/regex/engine.c"
                                           ) {
    dp = ldissect(m, sp, rest, ssub, esub);
    if (dp != rest) return 
# 372 "project/radare2/libr/util/regex/engine.c" 3 4
                          ((void *)0)
# 372 "project/radare2/libr/util/regex/engine.c"
...
# 381 "project/radare2/libr/util/regex/engine.c"
   ...
   oldssp = ssp;
   for (;;) {
    sep = lslow(m, ssp, rest, ssub, esub);
    if (!sep || sep == ssp)
     break;
    oldssp = ssp;
    ssp = sep;
   ...
   if (sep == rest) {
    if (lslow(m, ssp, sep, ssub, esub) == rest) {
     dp = ldissect(m, ssp, sep, ssub, esub);
     if (dp == sep) {
      sp = rest;
     }
    }
  ...
  case (15LU<<((unsigned)27)):
   ...
   for (;;) {
    if (lslow (m, sp, rest, ssub, esub) == rest)
     break;
...
static char *
lbackref(struct lmat *m, char *start, char *stop, sopno startst, sopno stopst,
    sopno lev, int rec)
{
 int i;
 sopno ss;
...
# 604 "project/radare2/libr/util/regex/engine.c"
   ...
   while (m->g->strip[ss] != (((8LU<<((unsigned)27)))|(i)))
    ss++;
   return lbackref (m, sp+len, stop, ss + 1, stopst, lev, rec);
  }
  break;
 case (11LU<<((unsigned)27)):
  dp = lbackref(m, sp, stop, ss+1, stopst, lev, rec);
  if (dp) {
   return dp;
  }
  return lbackref (m, sp, stop, ss + ((s)&0x07ffffffLU) + 1, stopst, lev, rec);
 case (9LU<<((unsigned)27)):
  if (m->lastpos && (lev + 1 <= m->g->nplus)) {
   m->lastpos[lev+1] = sp;
 ...
 case (10LU<<((unsigned)27)):
  ...
  m->lastpos[lev] = sp;
  dp = lbackref(m, sp, stop, ss-((s)&0x07ffffffLU)+1, stopst, lev, rec);
  return dp? dp: lbackref(m, sp, stop, ss+1, stopst, lev-1, rec);
 case (15LU<<((unsigned)27)):
  ssub = ss + 1;
  esub = ss + ((s)&0x07ffffffLU) - 1;
  if (((m->g->strip[esub])&0xf8000000LU) != (16LU<<((unsigned)27))) {
  ...
  for (;;) {
   dp = lbackref(m, sp, stop, ssub, esub, lev, rec);
   if (dp != 
# 637 "project/radare2/libr/util/regex/engine.c" 3 4
            ((void *)0)
# 637 "project/radare2/libr/util/regex/engine.c"
...
static char *
lfast(struct lmat *m, char *start, char *stop, sopno startst, sopno stopst)
{
 char * st = m->st;
 char * fresh = m->fresh;
 char * tmp = m->tmp;
...
# 705 "project/radare2/libr/util/regex/engine.c" 3 4
__builtin___memset_chk (
# 705 "project/radare2/libr/util/regex/engine.c"
st
# 705 "project/radare2/libr/util/regex/engine.c" 3 4
, 
# 705 "project/radare2/libr/util/regex/engine.c"
...
# 705 "project/radare2/libr/util/regex/engine.c"
          ;
 ((st)[startst] = 1);
 st = lstep (m->g, startst, stopst, st, (((0x7f +1)+1)+3), st);
 
# 708 "project/radare2/libr/util/regex/engine.c" 3 4
__builtin___memcpy_chk (
# 708 "project/radare2/libr/util/regex/engine.c"
fresh
# 708 "project/radare2/libr/util/regex/engine.c" 3 4
, 
# 708 "project/radare2/libr/util/regex/engine.c"
...
# 727 "project/radare2/libr/util/regex/engine.c"
  ...
  if (i != 0) {
   for (; i > 0; i--) {
    st = lstep (m->g, startst, stopst, st, flagch, st);
   }
   ;
  }
...
# 758 "project/radare2/libr/util/regex/engine.c" 3 4
 __builtin___memcpy_chk (
# 758 "project/radare2/libr/util/regex/engine.c"
 tmp
# 758 "project/radare2/libr/util/regex/engine.c" 3 4
 , 
# 758 "project/radare2/libr/util/regex/engine.c"
...
# 759 "project/radare2/libr/util/regex/engine.c" 3 4
 __builtin___memcpy_chk (
# 759 "project/radare2/libr/util/regex/engine.c"
 st
# 759 "project/radare2/libr/util/regex/engine.c" 3 4
 , 
# 759 "project/radare2/libr/util/regex/engine.c"
...
# 759 "project/radare2/libr/util/regex/engine.c"
  ...
  st = lstep (m->g, startst, stopst, tmp, c, st);
  ;
  if (!(memcmp(lstep (m->g, startst, stopst, st, (((0x7f +1)+1)+3), st), st, m->g->nstates) == 0)) {
   break;
  }
  p++;
 }
...
static char *
lslow(struct lmat *m, char *start, char *stop, sopno startst, sopno stopst)
{
 char * st = m->st;
 char * empty = m->empty;
 char * tmp = m->tmp;
...
# 796 "project/radare2/libr/util/regex/engine.c" 3 4
__builtin___memset_chk (
# 796 "project/radare2/libr/util/regex/engine.c"
st
# 796 "project/radare2/libr/util/regex/engine.c" 3 4
, 
# 796 "project/radare2/libr/util/regex/engine.c"
...
# 815 "project/radare2/libr/util/regex/engine.c"
  ...
  if ((memcmp(st, empty, m->g->nstates) == 0) || p == stop) {
   break;
  }


  
# 849 "project/radare2/libr/util/regex/engine.c" 3 4
 __builtin___memcpy_chk (
# 849 "project/radare2/libr/util/regex/engine.c"
 tmp
# 849 "project/radare2/libr/util/regex/engine.c" 3 4
 , 
# 849 "project/radare2/libr/util/regex/engine.c"
...
# 850 "project/radare2/libr/util/regex/engine.c" 3 4
 __builtin___memcpy_chk (
# 850 "project/radare2/libr/util/regex/engine.c"
 st
# 850 "project/radare2/libr/util/regex/engine.c" 3 4
 , 
# 850 "project/radare2/libr/util/regex/engine.c"
    ...
    char * aft)
{
 ...
 for (pc = start, ((here) = (pc)); pc != stop; pc++, ((here)++)) {
  ...
  case (10LU<<((unsigned)27)):
   ((aft)[here+(1)] |= (aft)[here]);
   i = ((aft)[here - (((s)&0x07ffffffLU))]);
   ((aft)[here-(((s)&0x07ffffffLU))] |= (aft)[here]);
   if (!i && ((aft)[here - (((s)&0x07ffffffLU))])) {
...
#undef match
#undef nope
# 129 "project/radare2/libr/util/regex/regexec.c" 2



# 131 "project/radare2/libr/util/regex/regexec.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 131 "project/radare2/libr/util/regex/regexec.c"
          r_regex_check(const RRegex *rr, const char *str) {
 return r_regex_exec (rr, str, 0, 
# 132 "project/radare2/libr/util/regex/regexec.c" 3 4
                                 ((void *)0)
# 132 "project/radare2/libr/util/regex/regexec.c"
                                     , rr->re_flags);
}
# 143 "project/radare2/libr/util/regex/regexec.c"

# 143 "project/radare2/libr/util/regex/regexec.c" 3 4
__attribute__((visibility("default"))) 
# 143 "project/radare2/libr/util/regex/regexec.c"
     int r_regex_exec(const RRegex *preg, const char *string, size_t nmatch, RRegexMatch pmatch[], int eflags) {
 if (!preg || !string) {
  return 
# 145 "project/radare2/libr/util/regex/regexec.c" 3 4
        15
# 145 "project/radare2/libr/util/regex/regexec.c"
                      ;
 }
 if (((int)nmatch) < 0) {
  return 
# 148 "project/radare2/libr/util/regex/regexec.c" 3 4
        16
# 148 "project/radare2/libr/util/regex/regexec.c"
                      ;
 }
 struct re_guts *g = preg->re_g;
 if (preg->re_magic != ((('r'^0200)<<8) | 'e') || g->magic != ((('R'^0200)<<8)|'E')) {
  return 
# 152 "project/radare2/libr/util/regex/regexec.c" 3 4
        2
# 152 "project/radare2/libr/util/regex/regexec.c"
                      ;
 }
 if (g->iflags & 04) {
  return 
# 155 "project/radare2/libr/util/regex/regexec.c" 3 4
        2
# 155 "project/radare2/libr/util/regex/regexec.c"
                      ;
 }
 eflags |= (
# 157 "project/radare2/libr/util/regex/regexec.c" 3 4
           00001 
# 157 "project/radare2/libr/util/regex/regexec.c"
                          | 
# 157 "project/radare2/libr/util/regex/regexec.c" 3 4
                            00002 
# 157 "project/radare2/libr/util/regex/regexec.c"
...
# 157 "project/radare2/libr/util/regex/regexec.c"
 ...
 if (g->nstates <= 8 * sizeof (char *) && !(eflags & 
# 158 "project/radare2/libr/util/regex/regexec.c" 3 4
                                                            01000
# 158 "project/radare2/libr/util/regex/regexec.c"
                                                                         )) {
