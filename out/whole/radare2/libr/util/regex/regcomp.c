# 0 "project/radare2/libr/util/regex/regcomp.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 38 "project/radare2/libr/util/regex/regcomp.c" 2
...
# 39 "project/radare2/libr/util/regex/regcomp.c" 2
...
# 40 "project/radare2/libr/util/regex/regcomp.c" 2
...
# 41 "project/radare2/libr/util/regex/regcomp.c" 2
...
# 42 "project/radare2/libr/util/regex/regcomp.c" 2
...
# 43 "project/radare2/libr/util/regex/regcomp.c" 2
...
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_regex.h" 2 3 4
...
# 44 "project/radare2/libr/util/regex/regcomp.c" 2
...
# 45 "project/radare2/libr/util/regex/regcomp.c" 2
...
# 46 "project/radare2/libr/util/regex/regcomp.c" 2

# 1 "project/radare2/libr/util/regex/utils.h" 1
...
#define ut8 unsigned char
# 48 "project/radare2/libr/util/regex/regcomp.c" 2
# 1 "project/radare2/libr/util/regex/regex2.h" 1
...
# 49 "project/radare2/libr/util/regex/regcomp.c" 2

# 1 "project/radare2/libr/util/regex/cclass.h" 1
# 39 "project/radare2/libr/util/regex/cclass.h"
static struct cclass {
 ...
 { 
# 56 "project/radare2/libr/util/regex/cclass.h" 3 4
  ((void *)0)
# 56 "project/radare2/libr/util/regex/cclass.h"
      , 
# 56 "project/radare2/libr/util/regex/cclass.h" 3 4
         ((void *)0)
# 56 "project/radare2/libr/util/regex/cclass.h"
...
# 51 "project/radare2/libr/util/regex/regcomp.c" 2
# 1 "project/radare2/libr/util/regex/cname.h" 1
# 39 "project/radare2/libr/util/regex/cname.h"
static struct cname {
 const char *name;
 char code;
} cnames[] = {
 ...
 { "DEL", '\177' },
 { 
# 138 "project/radare2/libr/util/regex/cname.h" 3 4
  ((void *)0)
# 138 "project/radare2/libr/util/regex/cname.h"
      , 0 }
};
# 52 "project/radare2/libr/util/regex/regcomp.c" 2
...
# 143 "project/radare2/libr/util/regex/regcomp.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 143 "project/radare2/libr/util/regex/regcomp.c"
          r_regex_match(const char *pattern, const char *flags, const char *text) {
 RRegex rx;
 int re_flags = r_regex_flags (flags);
 if (r_regex_init (&rx, pattern, re_flags)) {
  
# 147 "project/radare2/libr/util/regex/regcomp.c" 3 4
 fprintf(__stderrp,
# 147 "project/radare2/libr/util/regex/regcomp.c"
 "r_regex_match: /%s/ fails to compile.\n", pattern
# 147 "project/radare2/libr/util/regex/regcomp.c" 3 4
 )
# 147 "project/radare2/libr/util/regex/regcomp.c"
                                                             ;
  return 
# 148 "project/radare2/libr/util/regex/regcomp.c" 3 4
        0
# 148 "project/radare2/libr/util/regex/regcomp.c"
             ;
 }
...
# 155 "project/radare2/libr/util/regex/regcomp.c" 3 4
__attribute__((visibility("default"))) 
# 155 "project/radare2/libr/util/regex/regcomp.c"
     RList *r_regex_match_list(RRegex *rx, const char *text) {
 ...
 while (!r_regex_exec (rx, text, 1, &match, rx->re_flags | 
# 162 "project/radare2/libr/util/regex/regcomp.c" 3 4
                                                          00004
# 162 "project/radare2/libr/util/regex/regcomp.c"
                                                                          )) {
...
# 173 "project/radare2/libr/util/regex/regcomp.c" 3 4
__attribute__((visibility("default"))) 
# 173 "project/radare2/libr/util/regex/regcomp.c"
     RRegex *r_regex_new(const char *pattern, const char *flags) {
 
# 174 "project/radare2/libr/util/regex/regcomp.c" 3 4
do { if (!(
# 174 "project/radare2/libr/util/regex/regcomp.c"
pattern
# 174 "project/radare2/libr/util/regex/regcomp.c" 3 4
...
"pattern"
# 174 "project/radare2/libr/util/regex/regcomp.c" 3 4
, 174); return (((void *)0)); } } while (0)
# 174 "project/radare2/libr/util/regex/regcomp.c"
                                    ;
 RRegex *r, rx = {0};
 if (r_regex_init (&rx, pattern, r_regex_flags (flags))) {
  return 
# 177 "project/radare2/libr/util/regex/regcomp.c" 3 4
        ((void *)0)
# 177 "project/radare2/libr/util/regex/regcomp.c"
            ;
 }
 r = 
# 179 "project/radare2/libr/util/regex/regcomp.c" 3 4
    (
# 179 "project/radare2/libr/util/regex/regcomp.c"
    RRegex
# 179 "project/radare2/libr/util/regex/regcomp.c" 3 4
    *)malloc(sizeof(
# 179 "project/radare2/libr/util/regex/regcomp.c"
...
# 179 "project/radare2/libr/util/regex/regcomp.c"
 ...
 if (!r) {
  return 
# 181 "project/radare2/libr/util/regex/regcomp.c" 3 4
        ((void *)0)
# 181 "project/radare2/libr/util/regex/regcomp.c"
            ;
 }
 
# 183 "project/radare2/libr/util/regex/regcomp.c" 3 4
__builtin___memcpy_chk (
# 183 "project/radare2/libr/util/regex/regcomp.c"
r
# 183 "project/radare2/libr/util/regex/regcomp.c" 3 4
, 
# 183 "project/radare2/libr/util/regex/regcomp.c"
...
# 187 "project/radare2/libr/util/regex/regcomp.c" 3 4
__attribute__((visibility("default"))) 
# 187 "project/radare2/libr/util/regex/regcomp.c"
     int r_regex_flags(const char *f) {
 int flags = 0;
 if (!f || !*f) {
  return 0;
 }
 if (strchr (f, 'e')) {
  flags |= 
# 193 "project/radare2/libr/util/regex/regcomp.c" 3 4
          0001
# 193 "project/radare2/libr/util/regex/regcomp.c"
                          ;
 }
 if (strchr (f, 'i')) {
  flags |= 
# 196 "project/radare2/libr/util/regex/regcomp.c" 3 4
          0002
# 196 "project/radare2/libr/util/regex/regcomp.c"
                       ;
 }
 if (strchr (f, 's')) {
  flags |= 
# 199 "project/radare2/libr/util/regex/regcomp.c" 3 4
          0004
# 199 "project/radare2/libr/util/regex/regcomp.c"
                       ;
 }
 if (strchr (f, 'n')) {
  flags |= 
# 202 "project/radare2/libr/util/regex/regcomp.c" 3 4
          0010
# 202 "project/radare2/libr/util/regex/regcomp.c"
                         ;
 }
 if (strchr (f, 'N')) {
  flags |= 
# 205 "project/radare2/libr/util/regex/regcomp.c" 3 4
          0020
# 205 "project/radare2/libr/util/regex/regcomp.c"
                        ;
 }
 if (strchr (f, 'p')) {
  flags |= 
# 208 "project/radare2/libr/util/regex/regcomp.c" 3 4
          0040
# 208 "project/radare2/libr/util/regex/regcomp.c"
                      ;
 }
 if (strchr (f, 'd')) {
  flags |= 
# 211 "project/radare2/libr/util/regex/regcomp.c" 3 4
          0200
# 211 "project/radare2/libr/util/regex/regcomp.c"
                      ;
 }
 return flags;
}
...
# 216 "project/radare2/libr/util/regex/regcomp.c" 3 4
__attribute__((visibility("default"))) 
# 216 "project/radare2/libr/util/regex/regcomp.c"
     void r_regex_fini(RRegex *preg) {
 struct re_guts *g;
 if (!preg) {
  return;
 }
 if (preg->re_magic != ((('r'^0200)<<8) | 'e')) {
  return;
 }

 g = preg->re_g;
 if (!g || g->magic != ((('R'^0200)<<8)|'E')) {
  return;
 }
 preg->re_magic = 0;
 g->magic = 0;
...
# 239 "project/radare2/libr/util/regex/regcomp.c" 3 4
__attribute__((visibility("default"))) 
# 239 "project/radare2/libr/util/regex/regcomp.c"
     void r_regex_free(RRegex *preg) {
 r_regex_fini (preg);
 free (preg);
}
...
# 248 "project/radare2/libr/util/regex/regcomp.c" 3 4
__attribute__((visibility("default"))) 
# 248 "project/radare2/libr/util/regex/regcomp.c"
     int r_regex_init(RRegex *preg, const char *pattern, int cflags) {
 struct parse pa;
 struct parse *p = &pa;
 int i;
 size_t len;
 cflags &= ~
# 253 "project/radare2/libr/util/regex/regcomp.c" 3 4
           0200
# 253 "project/radare2/libr/util/regex/regcomp.c"
                       ;
 if (!preg || ((cflags & 
# 254 "project/radare2/libr/util/regex/regcomp.c" 3 4
                        0001
# 254 "project/radare2/libr/util/regex/regcomp.c"
                                        ) && (cflags & 
# 254 "project/radare2/libr/util/regex/regcomp.c" 3 4
                                                       0020
# 254 "project/radare2/libr/util/regex/regcomp.c"
  ...
  return 
# 255 "project/radare2/libr/util/regex/regcomp.c" 3 4
        16
# 255 "project/radare2/libr/util/regex/regcomp.c"
                      ;
 }
 if (cflags & 
# 257 "project/radare2/libr/util/regex/regcomp.c" 3 4
             0040
# 257 "project/radare2/libr/util/regex/regcomp.c"
                         ) {
  if (preg->re_endp < pattern) {
   return 
# 259 "project/radare2/libr/util/regex/regcomp.c" 3 4
         16
# 259 "project/radare2/libr/util/regex/regcomp.c"
                       ;
  }
 ...
 struct re_guts *g = (struct re_guts *)calloc (sizeof (struct re_guts) + ((0x7f - 
# 266 "project/radare2/libr/util/regex/regcomp.c" 3 4
                                                                         (-0x7f - 1) 
# 266 "project/radare2/libr/util/regex/regcomp.c"
                                                                         + 1) - 1), sizeof (cat_t));
 if (!g) {
  return 
# 268 "project/radare2/libr/util/regex/regcomp.c" 3 4
        12
# 268 "project/radare2/libr/util/regex/regcomp.c"
                      ;
 }
# 279 "project/radare2/libr/util/regex/regcomp.c"
 ...
 if (len >= maxlen) {
  free (g);
  return 
# 282 "project/radare2/libr/util/regex/regcomp.c" 3 4
        12
# 282 "project/radare2/libr/util/regex/regcomp.c"
                      ;
 }
 ...
 if (p->ssize < len) {
  free (g);
  return 
# 288 "project/radare2/libr/util/regex/regcomp.c" 3 4
        12
# 288 "project/radare2/libr/util/regex/regcomp.c"
                      ;
 }
 ...
 if (!p->strip) {
  free (g);
  return 
# 294 "project/radare2/libr/util/regex/regcomp.c" 3 4
        12
# 294 "project/radare2/libr/util/regex/regcomp.c"
                      ;
 }
 p->slen = 0;
 if (!p->strip) {
  free (g);
  return 
# 299 "project/radare2/libr/util/regex/regcomp.c" 3 4
        12
# 299 "project/radare2/libr/util/regex/regcomp.c"
                      ;
 }
 ...
 g->csetsize = (0x7f - 
# 312 "project/radare2/libr/util/regex/regcomp.c" 3 4
              (-0x7f - 1) 
# 312 "project/radare2/libr/util/regex/regcomp.c"
              + 1);
 g->sets = 
# 313 "project/radare2/libr/util/regex/regcomp.c" 3 4
          ((void *)0)
# 313 "project/radare2/libr/util/regex/regcomp.c"
              ;
 g->setbits = 
# 314 "project/radare2/libr/util/regex/regcomp.c" 3 4
             ((void *)0)
# 314 "project/radare2/libr/util/regex/regcomp.c"
                 ;
 g->ncsets = 0;
 g->cflags = cflags;
 g->iflags = 0;
 ...
 g->neol = 0;
 g->must = 
# 320 "project/radare2/libr/util/regex/regcomp.c" 3 4
          ((void *)0)
# 320 "project/radare2/libr/util/regex/regcomp.c"
              ;
 g->mlen = 0;
 g->nsub = 0;
 g->ncategories = 1;
 g->categories = &g->catspace[-(
# 324 "project/radare2/libr/util/regex/regcomp.c" 3 4
                               (-0x7f - 1)
# 324 "project/radare2/libr/util/regex/regcomp.c"
                                       )];
 (void) 
# 325 "project/radare2/libr/util/regex/regcomp.c" 3 4
       __builtin___memset_chk (
# 325 "project/radare2/libr/util/regex/regcomp.c"
       (char *)g->catspace
# 325 "project/radare2/libr/util/regex/regcomp.c" 3 4
       , 
# 325 "project/radare2/libr/util/regex/regcomp.c"
...
# 325 "project/radare2/libr/util/regex/regcomp.c"
 ...
 doemit(p, (sop)((1LU<<((unsigned)27))), (size_t)(0));
 g->firststate = (p->slen - 1);
 if (cflags & 
# 331 "project/radare2/libr/util/regex/regcomp.c" 3 4
             0001
# 331 "project/radare2/libr/util/regex/regcomp.c"
                             ) {
  p_ere(p, (0x7f +1));
 } else if (cflags & 
# 333 "project/radare2/libr/util/regex/regcomp.c" 3 4
                    0020
# 333 "project/radare2/libr/util/regex/regcomp.c"
                                  ) {
  p_str (p);
 } else {
  p_bre (p, (0x7f +1), (0x7f +1));
 }
 doemit(p, (sop)((1LU<<((unsigned)27))), (size_t)(0));
 ...
 preg->re_nsub = g->nsub;
 preg->re_g = g;
 preg->re_magic = ((('r'^0200)<<8) | 'e');

 if (g->iflags & 04) {
  seterr(p, (
# 352 "project/radare2/libr/util/regex/regcomp.c" 3 4
 15
# 352 "project/radare2/libr/util/regex/regcomp.c"
 ));
 }
 if (p->error) {
  r_regex_fini (preg);
...
# 364 "project/radare2/libr/util/regex/regcomp.c" 3 4
_Bool 
# 364 "project/radare2/libr/util/regex/regcomp.c"
     isFirst = 
# 364 "project/radare2/libr/util/regex/regcomp.c" 3 4
               1
# 364 "project/radare2/libr/util/regex/regcomp.c"
 ...
 for (;;) {
  ...
  conc = (p->slen);
  while ((p->next < p->end) && (c = (*p->next)) != '|' && c != stop) {
   p_ere_exp (p);
  }
  (void)(((p->slen) != conc) || seterr(p, (
# 376 "project/radare2/libr/util/regex/regcomp.c" 3 4
 14
# 376 "project/radare2/libr/util/regex/regcomp.c"
 )));

  if (!((((p->next < p->end) && (*p->next) == ('|'))) ? ((p->next++), 1) : 0)) {
   break;
  }
  if (isFirst) {
   doinsert(p, (sop)((15LU<<((unsigned)27))), (p->slen)-(conc)+1, conc);
   prevfwd = conc;
   prevback = conc;
   isFirst = 
# 385 "project/radare2/libr/util/regex/regcomp.c" 3 4
            0
# 385 "project/radare2/libr/util/regex/regcomp.c"
                 ;
  }
  doemit(p, (sop)((16LU<<((unsigned)27))), (size_t)((p->slen)-(prevback)));
  prevback = (p->slen - 1);
  dofwd(p, prevfwd, (p->slen)-(prevfwd));
  prevfwd = (p->slen);
  doemit(p, (sop)((17LU<<((unsigned)27))), (size_t)(0));
 }

 if (!isFirst) {
  dofwd(p, prevfwd, (p->slen)-(prevfwd));
  doemit(p, (sop)((18LU<<((unsigned)27))), (size_t)((p->slen)-(prevback)));
 }
...
static void p_ere_exp(struct parse *p) {
 ...
 switch (c) {
 case '(':
  (void)(((p->next < p->end)) || seterr(p, (
# 420 "project/radare2/libr/util/regex/regcomp.c" 3 4
 8
# 420 "project/radare2/libr/util/regex/regcomp.c"
 )));
  p->g->nsub++;
  subno = p->g->nsub;
  if (subno < 10) {
   p->pbegin[subno] = (p->slen);
  }
  doemit(p, (sop)((13LU<<((unsigned)27))), (size_t)(subno));
  ...
  doemit(p, (sop)((14LU<<((unsigned)27))), (size_t)(subno));
  ((void)(((p->next < p->end) && (*p->next++) == (')')) || seterr(p, (
# 437 "project/radare2/libr/util/regex/regcomp.c" 3 4
 8
# 437 "project/radare2/libr/util/regex/regcomp.c"
 ))));
  break;
 case '^':
  doemit(p, (sop)((3LU<<((unsigned)27))), (size_t)(0));
  p->g->iflags |= 01;
  p->g->nbol++;
  wascaret = 1;
  break;
 case '$':
  doemit(p, (sop)((4LU<<((unsigned)27))), (size_t)(0));
  p->g->iflags |= 02;
  p->g->neol++;
  break;
 case '|':
  seterr(p, (
# 451 "project/radare2/libr/util/regex/regcomp.c" 3 4
 14
# 451 "project/radare2/libr/util/regex/regcomp.c"
 ));
  break;
 case '*':
 case '+':
 case '?':
  seterr(p, (
# 456 "project/radare2/libr/util/regex/regcomp.c" 3 4
 13
# 456 "project/radare2/libr/util/regex/regcomp.c"
 ));
  break;
 case '.':
  if (p->g->cflags & 
# 459 "project/radare2/libr/util/regex/regcomp.c" 3 4
                    0010
# 459 "project/radare2/libr/util/regex/regcomp.c"
                                   ) {
   nonnewline(p);
  } else {
   doemit(p, (sop)((5LU<<((unsigned)27))), (size_t)(0));
  }
  break;
 case '[':
  p_bracket(p);
 ...
 case '\\':
  (void)(((p->next < p->end)) || seterr(p, (
# 469 "project/radare2/libr/util/regex/regcomp.c" 3 4
 5
# 469 "project/radare2/libr/util/regex/regcomp.c"
 )));
  c = (*p->next++);
  if (!isalpha(c)) {
   ordinary(p, c);
  ...
  break;
 case '{':
  (void)((!(p->next < p->end) || !isdigit((unsigned char)(*p->next))) || seterr(p, (
# 478 "project/radare2/libr/util/regex/regcomp.c" 3 4
 13
# 478 "project/radare2/libr/util/regex/regcomp.c"
 )));
 ...
 if (!(c == '*' || c == '+' || c == '?' ||
      (c == '{' && (p->next+1 < p->end) && isdigit ((unsigned char)(*(p->next+1)))))) {
  return;
 }
 (p->next++);

 (void)((!wascaret) || seterr(p, (
# 496 "project/radare2/libr/util/regex/regcomp.c" 3 4
13
# 496 "project/radare2/libr/util/regex/regcomp.c"
)));
 switch (c) {
 case '*':

  doinsert(p, (sop)((9LU<<((unsigned)27))), (p->slen)-(pos)+1, pos);
  doemit(p, (sop)((10LU<<((unsigned)27))), (size_t)((p->slen)-(pos)));
  doinsert(p, (sop)((11LU<<((unsigned)27))), (p->slen)-(pos)+1, pos);
  doemit(p, (sop)((12LU<<((unsigned)27))), (size_t)((p->slen)-(pos)));
  break;
 case '+':
  doinsert(p, (sop)((9LU<<((unsigned)27))), (p->slen)-(pos)+1, pos);
  doemit(p, (sop)((10LU<<((unsigned)27))), (size_t)((p->slen)-(pos)));
 ...
 case '?':
  ...
  doinsert(p, (sop)((15LU<<((unsigned)27))), (p->slen)-(pos)+1, pos);
  doemit(p, (sop)((16LU<<((unsigned)27))), (size_t)((p->slen)-(pos)));
  dofwd(p, pos, (p->slen)-(pos));
  doemit(p, (sop)((17LU<<((unsigned)27))), (size_t)(0));
  dofwd(p, (p->slen - 1), (p->slen)-((p->slen - 1)));
  doemit(p, (sop)((18LU<<((unsigned)27))), (size_t)((p->slen)-((p->slen - 2))));
  break;
 case '{':
  count = p_count(p);
  if (((((p->next < p->end) && (*p->next) == (','))) ? ((p->next++), 1) : 0)) {
   if (isdigit((unsigned char)(*p->next))) {
    count2 = p_count(p);
    (void)((count <= count2) || seterr(p, (
# 523 "project/radare2/libr/util/regex/regcomp.c" 3 4
   10
# 523 "project/radare2/libr/util/regex/regcomp.c"
   )));
   } else {
    count2 = (255 + 1);
   }
  ...
  if (!((((p->next < p->end) && (*p->next) == ('}'))) ? ((p->next++), 1) : 0)) {
   while ((p->next < p->end) && (*p->next) != '}') {
    (p->next++);
   }
   (void)(((p->next < p->end)) || seterr(p, (
# 535 "project/radare2/libr/util/regex/regcomp.c" 3 4
  9
# 535 "project/radare2/libr/util/regex/regcomp.c"
  )));
   seterr(p, (
# 536 "project/radare2/libr/util/regex/regcomp.c" 3 4
  10
# 536 "project/radare2/libr/util/regex/regcomp.c"
  ));
  }
  break;
 }
 ...
 seterr(p, (
# 549 "project/radare2/libr/util/regex/regcomp.c" 3 4
13
# 549 "project/radare2/libr/util/regex/regcomp.c"
));
}
...
static void p_str(struct parse *p) {
 (void)(((p->next < p->end)) || seterr(p, (
# 556 "project/radare2/libr/util/regex/regcomp.c" 3 4
14
# 556 "project/radare2/libr/util/regex/regcomp.c"
)));
 while ((p->next < p->end)) {
  ordinary(p, (*p->next++));
 }
    ...
    int end2)
{
 ...
 while ((p->next < p->end) && !((p->next < p->end) && (p->next+1 < p->end) && (*p->next) == (end1) && (*(p->next+1)) == (end2))) {
 ...
 (void)(((p->slen) != start) || seterr(p, (
# 596 "project/radare2/libr/util/regex/regcomp.c" 3 4
14
# 596 "project/radare2/libr/util/regex/regcomp.c"
)));
}
...
#define BACKSL (1<<CHAR_BIT)
 ...
 if (c == '\\') {
  (void)(((p->next < p->end)) || seterr(p, (
# 621 "project/radare2/libr/util/regex/regcomp.c" 3 4
 5
# 621 "project/radare2/libr/util/regex/regcomp.c"
 )));
  c = (1<<8) | (*p->next++);
 }
 switch (c) {
 case '.':
  if (p->g->cflags & 
# 626 "project/radare2/libr/util/regex/regcomp.c" 3 4
                    0010
# 626 "project/radare2/libr/util/regex/regcomp.c"
                                   ) {
   nonnewline(p);
  } else {
   doemit(p, (sop)((5LU<<((unsigned)27))), (size_t)(0));
 ...
 case (1<<8)|'{':
  seterr(p, (
# 636 "project/radare2/libr/util/regex/regcomp.c" 3 4
 13
# 636 "project/radare2/libr/util/regex/regcomp.c"
 ));
  break;
 case (1<<8)|'(':
  p->g->nsub++;
  ...
  if ((p->next < p->end) && !((p->next < p->end) && (p->next+1 < p->end) && (*p->next) == ('\\') && (*(p->next+1)) == (')'))) {
   p_bre (p, '\\', ')');
  }
  if (subno < 10) {
   p->pend[subno] = (p->slen);
  ...
  doemit(p, (sop)((14LU<<((unsigned)27))), (size_t)(subno));
  (void)((((((p->next < p->end) && (p->next+1 < p->end) && (*p->next) == ('\\') && (*(p->next+1)) == (')'))) ? ((p->next += 2), 1) : 0)) || seterr(p, (
# 656 "project/radare2/libr/util/regex/regcomp.c" 3 4
 8
# 656 "project/radare2/libr/util/regex/regcomp.c"
 )));
  break;
 case (1<<8)|')':
 case (1<<8)|'}':
  seterr(p, (
# 660 "project/radare2/libr/util/regex/regcomp.c" 3 4
 8
# 660 "project/radare2/libr/util/regex/regcomp.c"
 ));
  break;
 case (1<<8)|'1':
 case (1<<8)|'2':
 ...
 case (1<<8)|'9':
  ...
  if (p->pend[i] != 0) {
   if (i <= p->g->nsub) {
    doemit(p, (sop)((7LU<<((unsigned)27))), (size_t)(i));
    if (p->pbegin[i] != 0 && ((p->strip[p->pbegin[i]])&0xf8000000LU) == (13LU<<((unsigned)27)) &&
      ((p->strip[p->pend[i]])&0xf8000000LU) == (14LU<<((unsigned)27))) {
     (void) dupl(p, p->pbegin[i]+1, p->pend[i]);
     doemit(p, (sop)((8LU<<((unsigned)27))), (size_t)(i));
    }
   }
  } else {
   seterr(p, (
# 682 "project/radare2/libr/util/regex/regcomp.c" 3 4
  6
# 682 "project/radare2/libr/util/regex/regcomp.c"
  ));
  }
  p->g->backrefs = 1;
  break;
 case '*':
  (void)((starordinary) || seterr(p, (
# 687 "project/radare2/libr/util/regex/regcomp.c" 3 4
 13
# 687 "project/radare2/libr/util/regex/regcomp.c"
 )));
 ...
 if (((((p->next < p->end) && (*p->next) == ('*'))) ? ((p->next++), 1) : 0)) {
  ...
  doinsert(p, (sop)((11LU<<((unsigned)27))), (p->slen)-(pos)+1, pos);
  doemit(p, (sop)((12LU<<((unsigned)27))), (size_t)((p->slen)-(pos)));
 } else if (((((p->next < p->end) && (p->next+1 < p->end) && (*p->next) == ('\\') && (*(p->next+1)) == ('{'))) ? ((p->next += 2), 1) : 0)) {
  count = p_count(p);
  if (((((p->next < p->end) && (*p->next) == (','))) ? ((p->next++), 1) : 0)) {
   if ((p->next < p->end) && isdigit((unsigned char)(*p->next))) {
    count2 = p_count(p);
    (void)((count <= count2) || seterr(p, (
# 705 "project/radare2/libr/util/regex/regcomp.c" 3 4
   10
# 705 "project/radare2/libr/util/regex/regcomp.c"
   )));
   } else {
    count2 = (255 + 1);
   }
  ...
  repeat(p, pos, count, count2);
  if (!((((p->next < p->end) && (p->next+1 < p->end) && (*p->next) == ('\\') && (*(p->next+1)) == ('}'))) ? ((p->next += 2), 1) : 0)) {
   while ((p->next < p->end) && !((p->next < p->end) && (p->next+1 < p->end) && (*p->next) == ('\\') && (*(p->next+1)) == ('}'))) {
    (p->next++);
   }
   (void)(((p->next < p->end)) || seterr(p, (
# 717 "project/radare2/libr/util/regex/regcomp.c" 3 4
  9
# 717 "project/radare2/libr/util/regex/regcomp.c"
  )));
   seterr(p, (
# 718 "project/radare2/libr/util/regex/regcomp.c" 3 4
  10
# 718 "project/radare2/libr/util/regex/regcomp.c"
  ));
  }
 } else if (c == '$') {
  return (1);
...
p_count(struct parse *p)
{
 ...
 while ((p->next < p->end) && isdigit((unsigned char)(*p->next)) && count <= 255) {
  count = count*10 + ((*p->next++) - '0');
  ndigits++;
 }

 (void)((ndigits > 0 && count <= 255) || seterr(p, (
# 741 "project/radare2/libr/util/regex/regcomp.c" 3 4
10
# 741 "project/radare2/libr/util/regex/regcomp.c"
)));
 return(count);
}
...
static void p_bracket(struct parse *p) {
 ...
 if (p->next + 5 < p->end && strncmp(p->next, "[:<:]]", 6) == 0) {
  doemit(p, (sop)((19LU<<((unsigned)27))), (size_t)(0));
  (p->next += (6));
  return;
 }
 if (p->next + 5 < p->end && strncmp(p->next, "[:>:]]", 6) == 0) {
  doemit(p, (sop)((20LU<<((unsigned)27))), (size_t)(0));
  (p->next += (6));
  return;
 }
 ...
 if (((((p->next < p->end) && (*p->next) == (']'))) ? ((p->next++), 1) : 0)) {
  ((cs)->ptr[(unsigned char)(']')] |= (cs)->mask, (cs)->hash += (']'));
 } else if (((((p->next < p->end) && (*p->next) == ('-'))) ? ((p->next++), 1) : 0)) {
  ((cs)->ptr[(unsigned char)('-')] |= (cs)->mask, (cs)->hash += ('-'));
 }
 while ((p->next < p->end) && (*p->next) != ']' && !((p->next < p->end) && (p->next+1 < p->end) && (*p->next) == ('-') && (*(p->next+1)) == (']'))) {
  p_b_term (p, cs);
 }
 if (((((p->next < p->end) && (*p->next) == ('-'))) ? ((p->next++), 1) : 0)) {
  ((cs)->ptr[(unsigned char)('-')] |= (cs)->mask, (cs)->hash += ('-'));
 ...
 ((void)(((p->next < p->end) && (*p->next++) == (']')) || seterr(p, (
# 786 "project/radare2/libr/util/regex/regcomp.c" 3 4
7
# 786 "project/radare2/libr/util/regex/regcomp.c"
))));
 ...
 if (p->g->cflags&
# 793 "project/radare2/libr/util/regex/regcomp.c" 3 4
                 0002
# 793 "project/radare2/libr/util/regex/regcomp.c"
                              ) {
  int i;
  int ci;

  for (i = p->g->csetsize - 1; i >= 0; i--) {
   if (((cs)->ptr[(unsigned char)(i)] & (cs)->mask) && isalpha(i)) {
    ci = othercase(i);
    if (ci != i) {
     ((cs)->ptr[(unsigned char)(ci)] |= (cs)->mask, (cs)->hash += (ci));
    }
   }
  }
  if (cs->multis != 
# 805 "project/radare2/libr/util/regex/regcomp.c" 3 4
                   ((void *)0)
# 805 "project/radare2/libr/util/regex/regcomp.c"
                       ) {
   mccase (p, cs);
  }
 }
 if (invert) {
  ...
  for (i = p->g->csetsize - 1; i >= 0; i--) {
   if (((cs)->ptr[(unsigned char)(i)] & (cs)->mask)) {
    ((cs)->ptr[(unsigned char)(i)] &= ~(cs)->mask, (cs)->hash -= (i));
   } else {
    ((cs)->ptr[(unsigned char)(i)] |= (cs)->mask, (cs)->hash += (i));
   }
  }
  if (p->g->cflags & 
# 819 "project/radare2/libr/util/regex/regcomp.c" 3 4
                    0010
# 819 "project/radare2/libr/util/regex/regcomp.c"
                                   ) {
   ((cs)->ptr[(unsigned char)('\n')] &= ~(cs)->mask, (cs)->hash -= ('\n'));
  }
  if (cs->multis != 
# 822 "project/radare2/libr/util/regex/regcomp.c" 3 4
                   ((void *)0)
# 822 "project/radare2/libr/util/regex/regcomp.c"
                       ) {
   mcinvert (p, cs);
  }
 }
 ...
 if (nch(p, cs) == 1) {
  ...
  doemit(p, (sop)((6LU<<((unsigned)27))), (size_t)(freezeset(p, cs)));
 }
}
...
static void p_b_term(struct parse *p, cset *cs) {
 ...
 switch (((p->next < p->end)) ? (*p->next) : '\0') {
 case '[':
  c = ((p->next+1 < p->end)) ? (*(p->next+1)) : '\0';
  break;
 case '-':
  seterr(p, (
# 853 "project/radare2/libr/util/regex/regcomp.c" 3 4
 11
# 853 "project/radare2/libr/util/regex/regcomp.c"
 ));
  return;
  break;
 default:
 ...
 case ':':
  (p->next += 2);
  (void)(((p->next < p->end)) || seterr(p, (
# 864 "project/radare2/libr/util/regex/regcomp.c" 3 4
 7
# 864 "project/radare2/libr/util/regex/regcomp.c"
 )));
  c = (*p->next);
  (void)((c != '-' && c != ']') || seterr(p, (
# 866 "project/radare2/libr/util/regex/regcomp.c" 3 4
 4
# 866 "project/radare2/libr/util/regex/regcomp.c"
 )));
  p_b_cclass(p, cs);
  (void)(((p->next < p->end)) || seterr(p, (
# 868 "project/radare2/libr/util/regex/regcomp.c" 3 4
 7
# 868 "project/radare2/libr/util/regex/regcomp.c"
 )));
  (void)((((((p->next < p->end) && (p->next+1 < p->end) && (*p->next) == (':') && (*(p->next+1)) == (']'))) ? ((p->next += 2), 1) : 0)) || seterr(p, (
# 869 "project/radare2/libr/util/regex/regcomp.c" 3 4
 4
# 869 "project/radare2/libr/util/regex/regcomp.c"
 )));
  break;
 case '=':
  (p->next += 2);
  (void)(((p->next < p->end)) || seterr(p, (
# 873 "project/radare2/libr/util/regex/regcomp.c" 3 4
 7
# 873 "project/radare2/libr/util/regex/regcomp.c"
 )));
  c = (*p->next);
  (void)((c != '-' && c != ']') || seterr(p, (
# 875 "project/radare2/libr/util/regex/regcomp.c" 3 4
 3
# 875 "project/radare2/libr/util/regex/regcomp.c"
 )));
  p_b_eclass(p, cs);
  (void)(((p->next < p->end)) || seterr(p, (
# 877 "project/radare2/libr/util/regex/regcomp.c" 3 4
 7
# 877 "project/radare2/libr/util/regex/regcomp.c"
 )));
  (void)((((((p->next < p->end) && (p->next+1 < p->end) && (*p->next) == ('=') && (*(p->next+1)) == (']'))) ? ((p->next += 2), 1) : 0)) || seterr(p, (
# 878 "project/radare2/libr/util/regex/regcomp.c" 3 4
 3
# 878 "project/radare2/libr/util/regex/regcomp.c"
 )));
  break;
 default:

  start = p_b_symbol(p);
  if (((p->next < p->end) && (*p->next) == ('-')) && (p->next+1 < p->end) && (*(p->next+1)) != ']') {
  ...
  (void)((start <= finish) || seterr(p, (
# 895 "project/radare2/libr/util/regex/regcomp.c" 3 4
 11
# 895 "project/radare2/libr/util/regex/regcomp.c"
 )));
...
static void p_b_cclass(struct parse *p, cset *cs) {
 ...
 while ((p->next < p->end) && isalpha ((unsigned char)(*p->next))) {
  (p->next++);
 }
 len = p->next - sp;
 for (cp = cclasses; cp->name != 
# 917 "project/radare2/libr/util/regex/regcomp.c" 3 4
                                ((void *)0)
# 917 "project/radare2/libr/util/regex/regcomp.c"
                                    ; cp++) {
 ...
 if (!cp->name) {
  ...
  seterr(p, (
# 924 "project/radare2/libr/util/regex/regcomp.c" 3 4
 4
# 924 "project/radare2/libr/util/regex/regcomp.c"
 ));
  return;
 }
 ...
 u = cp->chars;
 while ((c = *u++) != '\0') {
  ((cs)->ptr[(unsigned char)(c)] |= (cs)->mask, (cs)->hash += (c));
 }
...
p_b_symbol(struct parse *p)
{
 ...
 (void)(((p->next < p->end)) || seterr(p, (
# 957 "project/radare2/libr/util/regex/regcomp.c" 3 4
7
# 957 "project/radare2/libr/util/regex/regcomp.c"
)));
 if (!((((p->next < p->end) && (p->next+1 < p->end) && (*p->next) == ('[') && (*(p->next+1)) == ('.'))) ? ((p->next += 2), 1) : 0)) {
  return ((*p->next++));
 }
 ...
 (void)((((((p->next < p->end) && (p->next+1 < p->end) && (*p->next) == ('.') && (*(p->next+1)) == (']'))) ? ((p->next += 2), 1) : 0)) || seterr(p, (
# 964 "project/radare2/libr/util/regex/regcomp.c" 3 4
3
# 964 "project/radare2/libr/util/regex/regcomp.c"
)));
 return(value);
}
    ...
    int endc)
{
 ...
 while ((p->next < p->end) && !((p->next < p->end) && (p->next+1 < p->end) && (*p->next) == (endc) && (*(p->next+1)) == (']'))) {
  (p->next++);
 }
 if (!(p->next < p->end)) {
  seterr(p, (
# 983 "project/radare2/libr/util/regex/regcomp.c" 3 4
 7
# 983 "project/radare2/libr/util/regex/regcomp.c"
 ));
  return(0);
 }
 len = p->next - sp;
 for (cp = cnames; cp->name != 
# 987 "project/radare2/libr/util/regex/regcomp.c" 3 4
                              ((void *)0)
# 987 "project/radare2/libr/util/regex/regcomp.c"
                                  ; cp++) {
  if (strncmp (cp->name, sp, len) == 0 && cp->name[len] == '\0') {
   return (cp->code);
  }
 ...
 seterr(p, (
# 995 "project/radare2/libr/util/regex/regcomp.c" 3 4
3
# 995 "project/radare2/libr/util/regex/regcomp.c"
));
 return(0);
}
...
ordinary(struct parse *p, int ch)
{
 ...
 if ((p->g->cflags & 
# 1051 "project/radare2/libr/util/regex/regcomp.c" 3 4
                    0002
# 1051 "project/radare2/libr/util/regex/regcomp.c"
                                 ) && isalpha ((unsigned char)ch) && othercase (ch) != ch) {
  bothcases(p, ch);
 } else {
  doemit(p, (sop)((2LU<<((unsigned)27))), (size_t)((unsigned char)ch));
  if (cap[ch] == 0) {
...
special(struct parse *p, int ch) {
 ...
 case 'x':
  digits[0] = (*p->next++);
  digits[1] = (*p->next++);
  c = (char)strtol (digits, 
# 1073 "project/radare2/libr/util/regex/regcomp.c" 3 4
                           ((void *)0)
# 1073 "project/radare2/libr/util/regex/regcomp.c"
                               , 16);
  ordinary (p, c);
  return;
 case 'n':
...
# 1087 "project/radare2/libr/util/regex/regcomp.c" 3 4
 __builtin___memcpy_chk (
# 1087 "project/radare2/libr/util/regex/regcomp.c"
 bracket
# 1087 "project/radare2/libr/util/regex/regcomp.c" 3 4
 , 
# 1087 "project/radare2/libr/util/regex/regcomp.c"
...
# 1091 "project/radare2/libr/util/regex/regcomp.c" 3 4
 __builtin___memcpy_chk (
# 1091 "project/radare2/libr/util/regex/regcomp.c"
 bracket
# 1091 "project/radare2/libr/util/regex/regcomp.c" 3 4
 , 
# 1091 "project/radare2/libr/util/regex/regcomp.c"
...
# 1095 "project/radare2/libr/util/regex/regcomp.c" 3 4
 __builtin___memcpy_chk (
# 1095 "project/radare2/libr/util/regex/regcomp.c"
 bracket
# 1095 "project/radare2/libr/util/regex/regcomp.c" 3 4
 , 
# 1095 "project/radare2/libr/util/regex/regcomp.c"
...
# 1095 "project/radare2/libr/util/regex/regcomp.c"
 ...
 default:
  seterr(p, (
# 1098 "project/radare2/libr/util/regex/regcomp.c" 3 4
 16
# 1098 "project/radare2/libr/util/regex/regcomp.c"
 ));
  return;
 }
...
#define MAP(n) (((n) <= 1) ? (n) : ((n) == INTFINITY) ? INF : N)
 ...
 case ((0)*8 + (3)):
  ...
  doinsert(p, (sop)((15LU<<((unsigned)27))), (p->slen)-(start)+1, start);
  repeat(p, start+1, 1, to);
  doemit(p, (sop)((16LU<<((unsigned)27))), (size_t)((p->slen)-(start)));
 ...
 case ((1)*8 + (2)):
  ...
  break;
 case ((1)*8 + (3)):
  doinsert(p, (sop)((9LU<<((unsigned)27))), (p->slen)-(start)+1, start);
  doemit(p, (sop)((10LU<<((unsigned)27))), (size_t)((p->slen)-(start)));
  break;
 case ((2)*8 + (2)):
 ...
 default:
  seterr(p, (
# 1207 "project/radare2/libr/util/regex/regcomp.c" 3 4
 15
# 1207 "project/radare2/libr/util/regex/regcomp.c"
 ));
  break;
 }
}
...
static cset * allocset(struct parse *p) {
 ...
 if (no >= p->ncsalloc) {
  ...
  ptr = (unsigned char *)realloc((char *)p->g->setbits, nbytes);
  if (!ptr) {
   goto nomem;
  }
  p->g->setbits = ptr;
  ...
  for (i = 0; i < no; i++) {
   p->g->sets[i].ptr = p->g->setbits + css * (i / 8);
  }

  (void) 
# 1263 "project/radare2/libr/util/regex/regcomp.c" 3 4
        __builtin___memset_chk (
# 1263 "project/radare2/libr/util/regex/regcomp.c"
...
# 1263 "project/radare2/libr/util/regex/regcomp.c"
 ...
 cs = &p->g->sets[no];
 cs->ptr = p->g->setbits + css*((no)/8);
 cs->mask = 1 << ((no) % 8);
 cs->hash = 0;
 cs->smultis = 0;
 cs->multis = 
# 1275 "project/radare2/libr/util/regex/regcomp.c" 3 4
             ((void *)0)
# 1275 "project/radare2/libr/util/regex/regcomp.c"
                 ;

 return(cs);
nomem:
 
# 1279 "project/radare2/libr/util/regex/regcomp.c" 3 4
{ free((void *)
# 1279 "project/radare2/libr/util/regex/regcomp.c"
p->g->sets
# 1279 "project/radare2/libr/util/regex/regcomp.c" 3 4
); 
# 1279 "project/radare2/libr/util/regex/regcomp.c"
...
# 1280 "project/radare2/libr/util/regex/regcomp.c" 3 4
{ free((void *)
# 1280 "project/radare2/libr/util/regex/regcomp.c"
p->g->setbits
# 1280 "project/radare2/libr/util/regex/regcomp.c" 3 4
); 
# 1280 "project/radare2/libr/util/regex/regcomp.c"
...
# 1280 "project/radare2/libr/util/regex/regcomp.c"
 ...
 seterr(p, (
# 1282 "project/radare2/libr/util/regex/regcomp.c" 3 4
12
# 1282 "project/radare2/libr/util/regex/regcomp.c"
));

 return(
# 1284 "project/radare2/libr/util/regex/regcomp.c" 3 4
       ((void *)0)
# 1284 "project/radare2/libr/util/regex/regcomp.c"
           );
}
...
freezeset(struct parse *p, cset *cs)
{
 ...
 for (cs2 = &p->g->sets[0]; cs2 < top; cs2++) {
  if (cs2->hash == h && cs2 != cs) {
   ...
   for (i = 0; i < css; i++) {
    if (!!((cs2)->ptr[(unsigned char)(i)] & (cs2)->mask) != !!((cs)->ptr[(unsigned char)(i)] & (cs)->mask)) {
     break;
    }
   }
   if (i == css) {
...
static void mcadd( struct parse *p, cset *cs, const char *cp) {
 ...
 if (!np) {
  ...
  cs->multis = 
# 1390 "project/radare2/libr/util/regex/regcomp.c" 3 4
              ((void *)0)
# 1390 "project/radare2/libr/util/regex/regcomp.c"
                  ;
  seterr(p, (
# 1391 "project/radare2/libr/util/regex/regcomp.c" 3 4
 12
# 1391 "project/radare2/libr/util/regex/regcomp.c"
 ));
  return;
 }
 cs->multis = np;
...
{
 cat_t *cats = g? g->categories : 
# 1468 "project/radare2/libr/util/regex/regcomp.c" 3 4
                                 ((void *)0)
# 1468 "project/radare2/libr/util/regex/regcomp.c"
                                     ;
 unsigned int c;
 unsigned int c2;
 cat_t cat;
 ...
 for (c = 
# 1478 "project/radare2/libr/util/regex/regcomp.c" 3 4
         (-0x7f - 1)
# 1478 "project/radare2/libr/util/regex/regcomp.c"
                 ; c <= 0x7f; c++) {
  if ( *(cats+c) && isinsets(g, c)) {
   cat = g->ncategories++;
   cats[c] = cat;
   for (c2 = c + 1; c2 <= 0x7f; c2++) {
    ...
    sopno finish)
{
 ...
 if (finish >= start) {
  ...
  if (p->ssize >= p->slen + len) {
   (void) 
# 1508 "project/radare2/libr/util/regex/regcomp.c" 3 4
         __builtin___memcpy_chk (
# 1508 "project/radare2/libr/util/regex/regcomp.c"
         (char *)(p->strip + p->slen)
# 1508 "project/radare2/libr/util/regex/regcomp.c" 3 4
         , 
# 1508 "project/radare2/libr/util/regex/regcomp.c"
...
# 1509 "project/radare2/libr/util/regex/regcomp.c"
                                                        ;
   p->slen += len;
   return(ret);
  }
...
# 1580 "project/radare2/libr/util/regex/regcomp.c" 3 4
__builtin___memmove_chk (
# 1580 "project/radare2/libr/util/regex/regcomp.c"
(char *)&p->strip[pos+1]
# 1580 "project/radare2/libr/util/regex/regcomp.c" 3 4
, 
# 1580 "project/radare2/libr/util/regex/regcomp.c"
(char *)&p->strip[pos], ((p->slen)-pos-1)*sizeof(sop)
# 1580 "project/radare2/libr/util/regex/regcomp.c" 3 4
, __builtin_object_size (
# 1580 "project/radare2/libr/util/regex/regcomp.c"
(char *)&p->strip[pos+1]
...
# 1581 "project/radare2/libr/util/regex/regcomp.c"
                                ;
 p->strip[pos] = s;
}
...
dofwd(struct parse *p, sopno pos, sop value)
{
 ...
 if (value < 1<<((unsigned)27)) {
  p->strip[pos] = ((p->strip[pos])&0xf8000000LU) | value;
 }
}
...
enlarge(struct parse *p, sopno size)
{
 ...
 if (!sp) {
  seterr(p, (
# 1615 "project/radare2/libr/util/regex/regcomp.c" 3 4
 12
# 1615 "project/radare2/libr/util/regex/regcomp.c"
 ));
  return;
 }
 p->strip = sp;
...
stripsnug(struct parse *p, struct re_guts *g)
{
 ...
 if (!g->strip) {
  seterr(p, (
# 1631 "project/radare2/libr/util/regex/regcomp.c" 3 4
 12
# 1631 "project/radare2/libr/util/regex/regcomp.c"
 ));
  g->strip = p->strip;
 }
}
...
findmust(struct parse *p, struct re_guts *g)
{
 sop *scan;
 sop *start = 
# 1649 "project/radare2/libr/util/regex/regcomp.c" 3 4
             ((void *)0)
# 1649 "project/radare2/libr/util/regex/regcomp.c"
                 ;
 sop *newstart = 
# 1650 "project/radare2/libr/util/regex/regcomp.c" 3 4
                ((void *)0)
# 1650 "project/radare2/libr/util/regex/regcomp.c"
                    ;
 sopno newlen;
 sop s;
 char *cp;
 ...
 do {
  s = *scan++;
  switch (((s)&0xf8000000LU)) {
  case (2LU<<((unsigned)27)):
   if (newlen == 0) {
    newstart = scan - 1;
   }
   newlen++;
   break;
  case (9LU<<((unsigned)27)):
  case (13LU<<((unsigned)27)):
  case (14LU<<((unsigned)27)):
   break;
  case (11LU<<((unsigned)27)):
  case (15LU<<((unsigned)27)):
   scan--;
   do {
    scan += ((s)&0x07ffffffLU);
    s = *scan;

    if (((s)&0xf8000000LU) != (12LU<<((unsigned)27)) && ((s)&0xf8000000LU) != (18LU<<((unsigned)27)) &&
       ((s)&0xf8000000LU) != (17LU<<((unsigned)27))) {
     g->iflags |= 04;
     return;
    }
   } while (((s)&0xf8000000LU) != (12LU<<((unsigned)27)) && ((s)&0xf8000000LU) != (18LU<<((unsigned)27)));
 ...
 } while (((s)&0xf8000000LU) != (1LU<<((unsigned)27)));
 ...
 scan = start;
 for (i = g->mlen; i > 0; i--) {
  while (((s = *scan++)&0xf8000000LU) != (2LU<<((unsigned)27))) {
   continue;
  }
  if (cp < g->must + g->mlen) {
   *cp++ = (char)((s)&0x07ffffffLU);
  }
 }
 if (cp == g->must + g->mlen) {
  *cp++ = '\0';
