# 0 "project/radare2/libr/util/udiff.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/udiff.c"
...
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_diff.h" 2 3 4
...
# 6 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_util/r_diff.h" 2 3 4
...
# 4 "project/radare2/libr/util/udiff.c" 2
...
# 9 "project/radare2/libr/util/udiff.c"
     RDiff *r_diff_new_from(
# 9 "project/radare2/libr/util/udiff.c" 3 4
                            unsigned long long 
# 9 "project/radare2/libr/util/udiff.c"
                                 off_a, 
# 9 "project/radare2/libr/util/udiff.c" 3 4
...
# 9 "project/radare2/libr/util/udiff.c"
                                             off_b) {
 RDiff *d = 
# 10 "project/radare2/libr/util/udiff.c" 3 4
           (
# 10 "project/radare2/libr/util/udiff.c"
           RDiff
# 10 "project/radare2/libr/util/udiff.c" 3 4
           *)calloc(1,sizeof(
# 10 "project/radare2/libr/util/udiff.c"
...
# 10 "project/radare2/libr/util/udiff.c"
 ...
 if (d) {
  d->delta = 1;
  d->user = 
# 13 "project/radare2/libr/util/udiff.c" 3 4
           ((void *)0)
# 13 "project/radare2/libr/util/udiff.c"
               ;
  d->off_a = off_a;
  d->off_b = off_b;
...
# 21 "project/radare2/libr/util/udiff.c" 3 4
__attribute__((visibility("default"))) 
# 21 "project/radare2/libr/util/udiff.c"
     RDiff *r_diff_new(void) {
 return r_diff_new_from (0, 0);
}


# 25 "project/radare2/libr/util/udiff.c" 3 4
__attribute__((visibility("default"))) 
# 25 "project/radare2/libr/util/udiff.c"
     void r_diff_free(RDiff *d) {
 if (d) {
  free (d->diff_cmd);
  free (d);
 }
...
# 32 "project/radare2/libr/util/udiff.c" 3 4
__attribute__((visibility("default"))) 
# 32 "project/radare2/libr/util/udiff.c"
     int r_diff_set_callback(RDiff *d, RDiffCallback callback, void *user) {
 d->callback = callback;
 d->user = user;
 return 1;
}
...
# 38 "project/radare2/libr/util/udiff.c" 3 4
__attribute__((visibility("default"))) 
# 38 "project/radare2/libr/util/udiff.c"
     int r_diff_set_delta(RDiff *d, int delta) {
 d->delta = delta;
 return 1;
}
...
# 44 "project/radare2/libr/util/udiff.c" 3 4
unsigned int 
# 44 "project/radare2/libr/util/udiff.c"
     *changes;
 
# 45 "project/radare2/libr/util/udiff.c" 3 4
unsigned int 
# 45 "project/radare2/libr/util/udiff.c"
     start, end;
} Levrow;

static void lev_matrix_free(Levrow *matrix, 
# 48 "project/radare2/libr/util/udiff.c" 3 4
                                           unsigned int 
# 48 "project/radare2/libr/util/udiff.c"
                                                len) {
 size_t i;
 for (i = 0; i < len; i++) {
...
static inline void lev_row_adjust(Levrow *row, 
# 56 "project/radare2/libr/util/udiff.c" 3 4
                                              unsigned int 
# 56 "project/radare2/libr/util/udiff.c"
                                                   maxdst, 
# 56 "project/radare2/libr/util/udiff.c" 3 4
                                                           unsigned int 
# 56 "project/radare2/libr/util/udiff.c"
...
# 58 "project/radare2/libr/util/udiff.c" 3 4
unsigned long long 
# 58 "project/radare2/libr/util/udiff.c"
     end = (
# 58 "project/radare2/libr/util/udiff.c" 3 4
            unsigned long long
# 58 "project/radare2/libr/util/udiff.c"
 ...
 row->end = 
# 59 "project/radare2/libr/util/udiff.c" 3 4
           (((
# 59 "project/radare2/libr/util/udiff.c"
           end
# 59 "project/radare2/libr/util/udiff.c" 3 4
           )>(
# 59 "project/radare2/libr/util/udiff.c"
...
static inline Levrow *lev_row_init(Levrow *matrix, 
# 63 "project/radare2/libr/util/udiff.c" 3 4
                                                  unsigned int 
# 63 "project/radare2/libr/util/udiff.c"
                                                       maxdst, 
# 63 "project/radare2/libr/util/udiff.c" 3 4
                                                               unsigned int 
# 63 "project/radare2/libr/util/udiff.c"
...
# 64 "project/radare2/libr/util/udiff.c" 3 4
do { if (!(
# 64 "project/radare2/libr/util/udiff.c"
matrix && !matrix[rownum].changes
# 64 "project/radare2/libr/util/udiff.c" 3 4
...
# 64 "project/radare2/libr/util/udiff.c"
 ...
 if ((row->changes = 
# 67 "project/radare2/libr/util/udiff.c" 3 4
                    (unsigned int*)malloc(sizeof(unsigned int)*(
# 67 "project/radare2/libr/util/udiff.c"
                    row->end - row->start + 1
# 67 "project/radare2/libr/util/udiff.c" 3 4
                    ))
# 67 "project/radare2/libr/util/udiff.c"
...
# 67 "project/radare2/libr/util/udiff.c"
  ...
  return 
# 68 "project/radare2/libr/util/udiff.c" 3 4
        ((void *)0)
# 68 "project/radare2/libr/util/udiff.c"
            ;
 }
 return row;
}
...
static inline 
# 73 "project/radare2/libr/util/udiff.c" 3 4
             unsigned int 
# 73 "project/radare2/libr/util/udiff.c"
                  lev_get_val(Levrow *row, 
# 73 "project/radare2/libr/util/udiff.c" 3 4
                                           unsigned int 
# 73 "project/radare2/libr/util/udiff.c"
                                                i) {
 ...
 return 
# 77 "project/radare2/libr/util/udiff.c" 3 4
       0xFFFFFFFFU 
# 77 "project/radare2/libr/util/udiff.c"
                - 1;
}
...
static 
# 82 "project/radare2/libr/util/udiff.c" 3 4
      int 
# 82 "project/radare2/libr/util/udiff.c"
           lev_parse_matrix(Levrow *matrix, 
# 82 "project/radare2/libr/util/udiff.c" 3 4
                                            unsigned int 
# 82 "project/radare2/libr/util/udiff.c"
                                                 len, 
...
# 83 "project/radare2/libr/util/udiff.c" 3 4
do { if (!(
# 83 "project/radare2/libr/util/udiff.c"
len >= 2 && matrix && chgs && !*chgs
# 83 "project/radare2/libr/util/udiff.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 83 "project/radare2/libr/util/udiff.c"
"len >= 2 && matrix && chgs && !*chgs"
...
# 83 "project/radare2/libr/util/udiff.c"
 ...
 size_t size = j;
 RLevOp *changes = 
# 96 "project/radare2/libr/util/udiff.c" 3 4
                  (
# 96 "project/radare2/libr/util/udiff.c"
                  RLevOp
# 96 "project/radare2/libr/util/udiff.c" 3 4
                  *)malloc(sizeof(
# 96 "project/radare2/libr/util/udiff.c"
...
# 103 "project/radare2/libr/util/udiff.c" 3 4
 unsigned int 
# 103 "project/radare2/libr/util/udiff.c"
      sub = lev_get_val (prev_row, j - 1);
  
# 104 "project/radare2/libr/util/udiff.c" 3 4
 unsigned int 
# 104 "project/radare2/libr/util/udiff.c"
      del = lev_get_val (prev_row, j);
  
# 105 "project/radare2/libr/util/udiff.c" 3 4
 unsigned int 
# 105 "project/radare2/libr/util/udiff.c"
      add = lev_get_val (row, j - 1);
  ...
  free (row->changes);
  row->changes = 
# 137 "project/radare2/libr/util/udiff.c" 3 4
                ((void *)0)
# 137 "project/radare2/libr/util/udiff.c"
                    ;
  row = prev_row--;
 }
 if (size - insert < j) {
...
static inline void lev_fill_changes(RLevOp *chgs, RLevOp op, 
# 163 "project/radare2/libr/util/udiff.c" 3 4
                                                            unsigned int 
# 163 "project/radare2/libr/util/udiff.c"
                                                                 count) {
 while (count > 0) {
  count--;
  chgs[count] = op;
...
# 176 "project/radare2/libr/util/udiff.c" 3 4
__attribute__((visibility("default"))) 
# 176 "project/radare2/libr/util/udiff.c"
     char *r_diff_buffers_to_string(RDiff *d, const 
# 176 "project/radare2/libr/util/udiff.c" 3 4
                                                    unsigned char 
# 176 "project/radare2/libr/util/udiff.c"
                                                        *a, int la, const 
...
# 228 "project/radare2/libr/util/udiff.c"
...
# 239 "project/radare2/libr/util/udiff.c"

# 239 "project/radare2/libr/util/udiff.c" 3 4
__attribute__((visibility("default"))) 
# 239 "project/radare2/libr/util/udiff.c"
     int r_diff_buffers_static(RDiff *d, const 
# 239 "project/radare2/libr/util/udiff.c" 3 4
                                               unsigned char 
# 239 "project/radare2/libr/util/udiff.c"
                                                   *a, int la, const 
...
# 239 "project/radare2/libr/util/udiff.c"
 ...
 int hit = 0;
 la = 
# 242 "project/radare2/libr/util/udiff.c" 3 4
     (((
# 242 "project/radare2/libr/util/udiff.c"
     la
# 242 "project/radare2/libr/util/udiff.c" 3 4
     )<0)?-(
# 242 "project/radare2/libr/util/udiff.c"
...
# 242 "project/radare2/libr/util/udiff.c"
               ;
 lb = 
# 243 "project/radare2/libr/util/udiff.c" 3 4
     (((
# 243 "project/radare2/libr/util/udiff.c"
     lb
# 243 "project/radare2/libr/util/udiff.c" 3 4
     )<0)?-(
# 243 "project/radare2/libr/util/udiff.c"
...
# 243 "project/radare2/libr/util/udiff.c"
 ...
 if (la != lb) {
  len = 
# 245 "project/radare2/libr/util/udiff.c" 3 4
       (((
# 245 "project/radare2/libr/util/udiff.c"
       la
# 245 "project/radare2/libr/util/udiff.c" 3 4
       )>(
# 245 "project/radare2/libr/util/udiff.c"
...
# 246 "project/radare2/libr/util/udiff.c" 3 4
 fprintf(__stderrp,
# 246 "project/radare2/libr/util/udiff.c"
 "Buffer truncated to %d byte(s) (%d not compared)\n", len, 
# 246 "project/radare2/libr/util/udiff.c" 3 4
 (((
# 246 "project/radare2/libr/util/udiff.c"
 lb - la
...
# 246 "project/radare2/libr/util/udiff.c"
 ...
 for (i = 0; i < len; i++) {
  if (a[i] != b[i]) {
   ...
   if (hit > 0) {
    { const size_t i_hit = i - hit; int ra = la - i_hit; int rb = lb - i_hit; struct r_diff_op_t o = { .a_off = d->off_a+i-hit, .a_buf = a+i-hit, .a_len = 
# 255 "project/radare2/libr/util/udiff.c" 3 4
   (((
# 255 "project/radare2/libr/util/udiff.c"
   hit
# 255 "project/radare2/libr/util/udiff.c" 3 4
   )>(
# 255 "project/radare2/libr/util/udiff.c"
...
# 255 "project/radare2/libr/util/udiff.c"
   , .b_off = d->off_b+i-hit, .b_buf = b+i-hit, .b_len = 
# 255 "project/radare2/libr/util/udiff.c" 3 4
   (((
# 255 "project/radare2/libr/util/udiff.c"
   hit
...
# 255 "project/radare2/libr/util/udiff.c"
 ...
 if (hit > 0) {
  { const size_t i_hit = i - hit; int ra = la - i_hit; int rb = lb - i_hit; struct r_diff_op_t o = { .a_off = d->off_a+i-hit, .a_buf = a+i-hit, .a_len = 
# 261 "project/radare2/libr/util/udiff.c" 3 4
 (((
# 261 "project/radare2/libr/util/udiff.c"
 hit
# 261 "project/radare2/libr/util/udiff.c" 3 4
 )>(
# 261 "project/radare2/libr/util/udiff.c"
...
# 267 "project/radare2/libr/util/udiff.c" 3 4
__attribute__((visibility("default"))) 
# 267 "project/radare2/libr/util/udiff.c"
     char *r_diff_buffers_unified(RDiff *d, const 
# 267 "project/radare2/libr/util/udiff.c" 3 4
                                                  unsigned char 
# 267 "project/radare2/libr/util/udiff.c"
                                                      *a, int la, const 
...
# 279 "project/radare2/libr/util/udiff.c"
 char *err = 
# 279 "project/radare2/libr/util/udiff.c" 3 4
            ((void *)0)
# 279 "project/radare2/libr/util/udiff.c"
                ;
 char *out = 
# 280 "project/radare2/libr/util/udiff.c" 3 4
            ((void *)0)
# 280 "project/radare2/libr/util/udiff.c"
                ;
 int out_len;
 char *diff_cmdline = r_str_newf ("%s .a .b", d->diff_cmd);
 if (diff_cmdline) {
  (void)r_sys_cmd_str_full (diff_cmdline, 
# 284 "project/radare2/libr/util/udiff.c" 3 4
                                         ((void *)0)
# 284 "project/radare2/libr/util/udiff.c"
                                             , 0, &out, &out_len, &err);
  free (diff_cmdline);
 }
 r_file_rm (".a");
...
# 293 "project/radare2/libr/util/udiff.c" 3 4
__attribute__((visibility("default"))) 
# 293 "project/radare2/libr/util/udiff.c"
     int r_diff_buffers(RDiff *d, const 
# 293 "project/radare2/libr/util/udiff.c" 3 4
                                        unsigned char 
# 293 "project/radare2/libr/util/udiff.c"
                                            *a, 
...
# 301 "project/radare2/libr/util/udiff.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 301 "project/radare2/libr/util/udiff.c"
          r_diff_buffers_distance_myers(RDiff *diff, const 
# 301 "project/radare2/libr/util/udiff.c" 3 4
                                                           unsigned char 
# 301 "project/radare2/libr/util/udiff.c"
                                                               *a, 
...
# 301 "project/radare2/libr/util/udiff.c" 3 4
                                                                                                   unsigned int 
# 301 "project/radare2/libr/util/udiff.c"
                                                                                                        *distance, double *similarity) {
 
# 302 "project/radare2/libr/util/udiff.c" 3 4
do { if (!(
# 302 "project/radare2/libr/util/udiff.c"
a && b
# 302 "project/radare2/libr/util/udiff.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 302 "project/radare2/libr/util/udiff.c"
"a && b"
# 302 "project/radare2/libr/util/udiff.c" 3 4
, 302); return (0); } } while (0)
# 302 "project/radare2/libr/util/udiff.c"
                                    ;
 const 
# 303 "project/radare2/libr/util/udiff.c" 3 4
      _Bool 
# 303 "project/radare2/libr/util/udiff.c"
           verbose = diff? diff->verbose: 
# 303 "project/radare2/libr/util/udiff.c" 3 4
                                          0
# 303 "project/radare2/libr/util/udiff.c"
                                               ;
 const 
# 304 "project/radare2/libr/util/udiff.c" 3 4
      unsigned int 
# 304 "project/radare2/libr/util/udiff.c"
           length = la + lb;
 const 
# 305 "project/radare2/libr/util/udiff.c" 3 4
      unsigned char 
# 305 "project/radare2/libr/util/udiff.c"
          *ea = a + la, *eb = b + lb;
...
# 312 "project/radare2/libr/util/udiff.c" 3 4
unsigned int 
# 312 "project/radare2/libr/util/udiff.c"
     *v0, *v;
 
# 313 "project/radare2/libr/util/udiff.c" 3 4
long long 
# 313 "project/radare2/libr/util/udiff.c"
     m = (
# 313 "project/radare2/libr/util/udiff.c" 3 4
          long long
# 313 "project/radare2/libr/util/udiff.c"
              )la + lb, di = 0, low, high, i, x, y;
 if (m + 2 > 
# 314 "project/radare2/libr/util/udiff.c" 3 4
            18446744073709551615UL 
# 314 "project/radare2/libr/util/udiff.c"
                     / sizeof (
# 314 "project/radare2/libr/util/udiff.c" 3 4
                               long long
# 314 "project/radare2/libr/util/udiff.c"
                                   ) || !(v0 = malloc ((m + 2) * sizeof (
# 314 "project/radare2/libr/util/udiff.c" 3 4
                                                                         unsigned int
# 314 "project/radare2/libr/util/udiff.c"
                                                                             )))) {
  return 
# 315 "project/radare2/libr/util/udiff.c" 3 4
        0
# 315 "project/radare2/libr/util/udiff.c"
             ;
 }
 v = v0 + lb;
 v[1] = 0;
 for (di = 0; di <= m; di++) {
  low = -di + 2 * 
# 320 "project/radare2/libr/util/udiff.c" 3 4
                 (((
# 320 "project/radare2/libr/util/udiff.c"
                 0
# 320 "project/radare2/libr/util/udiff.c" 3 4
                 )>(
# 320 "project/radare2/libr/util/udiff.c"
...
# 320 "project/radare2/libr/util/udiff.c"
                                         ;
  high = di - 2 * 
# 321 "project/radare2/libr/util/udiff.c" 3 4
                 (((
# 321 "project/radare2/libr/util/udiff.c"
                 0
# 321 "project/radare2/libr/util/udiff.c" 3 4
                 )>(
# 321 "project/radare2/libr/util/udiff.c"
...
# 335 "project/radare2/libr/util/udiff.c" 3 4
  fprintf(__stderrp,
# 335 "project/radare2/libr/util/udiff.c"
  "\rProcessing dist %" 
# 335 "project/radare2/libr/util/udiff.c" 3 4
  "lld" 
# 335 "project/radare2/libr/util/udiff.c"
...
# 341 "project/radare2/libr/util/udiff.c" 3 4
 fprintf(__stderrp,
# 341 "project/radare2/libr/util/udiff.c"
 "\n"
# 341 "project/radare2/libr/util/udiff.c" 3 4
 )
# 341 "project/radare2/libr/util/udiff.c"
 ...
 return 
# 351 "project/radare2/libr/util/udiff.c" 3 4
       1
# 351 "project/radare2/libr/util/udiff.c"
           ;
}


# 354 "project/radare2/libr/util/udiff.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 354 "project/radare2/libr/util/udiff.c"
          r_diff_buffers_distance_levenshtein(RDiff *diff, const 
# 354 "project/radare2/libr/util/udiff.c" 3 4
                                                                 unsigned char 
# 354 "project/radare2/libr/util/udiff.c"
                                                                     *a, 
...
# 355 "project/radare2/libr/util/udiff.c" 3 4
do { if (!(
# 355 "project/radare2/libr/util/udiff.c"
a && b
# 355 "project/radare2/libr/util/udiff.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 355 "project/radare2/libr/util/udiff.c"
"a && b"
# 355 "project/radare2/libr/util/udiff.c" 3 4
, 355); return (0); } } while (0)
# 355 "project/radare2/libr/util/udiff.c"
                                    ;
 const 
# 356 "project/radare2/libr/util/udiff.c" 3 4
      _Bool 
# 356 "project/radare2/libr/util/udiff.c"
           verbose = diff ? diff->verbose : 
# 356 "project/radare2/libr/util/udiff.c" 3 4
                                            0
# 356 "project/radare2/libr/util/udiff.c"
                                                 ;
 const 
# 357 "project/radare2/libr/util/udiff.c" 3 4
      unsigned int 
# 357 "project/radare2/libr/util/udiff.c"
           length = 
# 357 "project/radare2/libr/util/udiff.c" 3 4
                    (((
# 357 "project/radare2/libr/util/udiff.c"
...
# 357 "project/radare2/libr/util/udiff.c"
                                  ;
 const 
# 358 "project/radare2/libr/util/udiff.c" 3 4
      unsigned char 
# 358 "project/radare2/libr/util/udiff.c"
          *ea = a + la, *eb = b + lb, *t;
 
# 359 "project/radare2/libr/util/udiff.c" 3 4
unsigned int 
# 359 "project/radare2/libr/util/udiff.c"
     *d, i, j;
 ...
 if (sizeof (
# 375 "project/radare2/libr/util/udiff.c" 3 4
            unsigned int
# 375 "project/radare2/libr/util/udiff.c"
                ) > 
# 375 "project/radare2/libr/util/udiff.c" 3 4
                    18446744073709551615UL 
# 375 "project/radare2/libr/util/udiff.c"
                             / (lb + 1) || !(d = malloc ((lb + 1) * sizeof (
# 375 "project/radare2/libr/util/udiff.c" 3 4
                                                                            unsigned int
# 375 "project/radare2/libr/util/udiff.c"
                                                                                )))) {
  return 
# 376 "project/radare2/libr/util/udiff.c" 3 4
        0
# 376 "project/radare2/libr/util/udiff.c"
             ;
 }
 for (i = 0; i <= lb; i++) {
  d[i] = i;
...
# 382 "project/radare2/libr/util/udiff.c" 3 4
 unsigned int 
# 382 "project/radare2/libr/util/udiff.c"
      ul = d[0];
  d[0] = i + 1;
  for (j = 0; j < lb; j++) {
   
# 385 "project/radare2/libr/util/udiff.c" 3 4
  unsigned int 
# 385 "project/radare2/libr/util/udiff.c"
       u = d[j + 1];
   d[j + 1] = a[i] == b[j] ? ul : 
# 386 "project/radare2/libr/util/udiff.c" 3 4
                                 (((
# 386 "project/radare2/libr/util/udiff.c"
                                 ul
# 386 "project/radare2/libr/util/udiff.c" 3 4
                                 )>((((
# 386 "project/radare2/libr/util/udiff.c"
...
# 390 "project/radare2/libr/util/udiff.c" 3 4
  fprintf(__stderrp,
# 390 "project/radare2/libr/util/udiff.c"
  "\rProcessing %" 
# 390 "project/radare2/libr/util/udiff.c" 3 4
  "u" 
# 390 "project/radare2/libr/util/udiff.c"
...
# 395 "project/radare2/libr/util/udiff.c" 3 4
 fprintf(__stderrp,
# 395 "project/radare2/libr/util/udiff.c"
 "\n"
# 395 "project/radare2/libr/util/udiff.c" 3 4
 )
# 395 "project/radare2/libr/util/udiff.c"
 ...
 free (d);
 return 
# 404 "project/radare2/libr/util/udiff.c" 3 4
       1
# 404 "project/radare2/libr/util/udiff.c"
           ;
}


# 407 "project/radare2/libr/util/udiff.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 407 "project/radare2/libr/util/udiff.c"
          r_diff_buffers_distance(RDiff *d, const 
# 407 "project/radare2/libr/util/udiff.c" 3 4
                                                  unsigned char 
# 407 "project/radare2/libr/util/udiff.c"
                                                      *a, 
...
# 424 "project/radare2/libr/util/udiff.c" 3 4
__attribute__((visibility("default"))) 
# 424 "project/radare2/libr/util/udiff.c"
     RDiffChar *r_diffchar_new(const 
# 424 "project/radare2/libr/util/udiff.c" 3 4
                                     unsigned char 
# 424 "project/radare2/libr/util/udiff.c"
                                         *a, const 
...
# 425 "project/radare2/libr/util/udiff.c" 3 4
do { if (!(
# 425 "project/radare2/libr/util/udiff.c"
a && b
# 425 "project/radare2/libr/util/udiff.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 425 "project/radare2/libr/util/udiff.c"
"a && b"
# 425 "project/radare2/libr/util/udiff.c" 3 4
, 425); return (((void *)0)); } } while (0)
# 425 "project/radare2/libr/util/udiff.c"
                                   ;
 RDiffChar *diffchar = 
# 426 "project/radare2/libr/util/udiff.c" 3 4
                      (
# 426 "project/radare2/libr/util/udiff.c"
                      RDiffChar
# 426 "project/radare2/libr/util/udiff.c" 3 4
                      *)calloc(1,sizeof(
# 426 "project/radare2/libr/util/udiff.c"
...
# 426 "project/radare2/libr/util/udiff.c"
 ...
 if (!diffchar) {
  return 
# 428 "project/radare2/libr/util/udiff.c" 3 4
        ((void *)0)
# 428 "project/radare2/libr/util/udiff.c"
            ;
 }
...
# 437 "project/radare2/libr/util/udiff.c" 3 4
short 
# 437 "project/radare2/libr/util/udiff.c"
     *align_table = malloc (dim * dim * sizeof (
# 437 "project/radare2/libr/util/udiff.c" 3 4
                                                short
# 437 "project/radare2/libr/util/udiff.c"
                                                    ));
 
# 438 "project/radare2/libr/util/udiff.c" 3 4
unsigned char 
# 438 "project/radare2/libr/util/udiff.c"
    *align_a = malloc (2 * len_long);
 
# 439 "project/radare2/libr/util/udiff.c" 3 4
unsigned char 
# 439 "project/radare2/libr/util/udiff.c"
    *align_b = malloc (2 * len_long);
 if (!(dup_a && dup_b && align_table && align_a && align_b)) {
  ...
  free (diffchar);
  return 
# 447 "project/radare2/libr/util/udiff.c" 3 4
        ((void *)0)
# 447 "project/radare2/libr/util/udiff.c"
            ;
 }

 
# 450 "project/radare2/libr/util/udiff.c" 3 4
__builtin___snprintf_chk (
# 450 "project/radare2/libr/util/udiff.c"
dup_a
# 450 "project/radare2/libr/util/udiff.c" 3 4
, 
# 450 "project/radare2/libr/util/udiff.c"
...
# 450 "project/radare2/libr/util/udiff.c"
                                   ;
 a = (const 
# 451 "project/radare2/libr/util/udiff.c" 3 4
           unsigned char
# 451 "project/radare2/libr/util/udiff.c"
              *)dup_a;
 
# 452 "project/radare2/libr/util/udiff.c" 3 4
__builtin___snprintf_chk (
# 452 "project/radare2/libr/util/udiff.c"
dup_b
# 452 "project/radare2/libr/util/udiff.c" 3 4
, 
# 452 "project/radare2/libr/util/udiff.c"
...
# 452 "project/radare2/libr/util/udiff.c"
                                   ;
 b = (const 
# 453 "project/radare2/libr/util/udiff.c" 3 4
           unsigned char
# 453 "project/radare2/libr/util/udiff.c"
              *)dup_b;
 ...
 *align_table = 0;
  ...
  *(align_table + row) = *(align_table + row * dim) = -(
# 460 "project/radare2/libr/util/udiff.c" 3 4
                                                       short
# 460 "project/radare2/libr/util/udiff.c"
                                                           )row;
 }
 const 
# 462 "project/radare2/libr/util/udiff.c" 3 4
      short 
# 462 "project/radare2/libr/util/udiff.c"
           match = 1;
 const 
# 463 "project/radare2/libr/util/udiff.c" 3 4
      short 
# 463 "project/radare2/libr/util/udiff.c"
           match_nl = 2;
 const 
# 464 "project/radare2/libr/util/udiff.c" 3 4
      short 
# 464 "project/radare2/libr/util/udiff.c"
           mismatch = -2;
 const 
# 465 "project/radare2/libr/util/udiff.c" 3 4
      short 
# 465 "project/radare2/libr/util/udiff.c"
           gap = -1;
 for (row = 1; row < dim; row++) {
  for (col = 1; col < dim; col++) {

   const 
# 469 "project/radare2/libr/util/udiff.c" 3 4
        unsigned char 
# 469 "project/radare2/libr/util/udiff.c"
            a_ch = a[col - 1];
   const 
# 470 "project/radare2/libr/util/udiff.c" 3 4
        unsigned char 
# 470 "project/radare2/libr/util/udiff.c"
            b_ch = b[row - 1];
   const 
# 471 "project/radare2/libr/util/udiff.c" 3 4
        short 
# 471 "project/radare2/libr/util/udiff.c"
             tl_score = *(align_table + (row - 1) * dim + col - 1)
    + (a_ch == b_ch
     ? (a_ch == '\n'
      ? match_nl
      : match)
     : mismatch);
   const 
# 477 "project/radare2/libr/util/udiff.c" 3 4
        short 
# 477 "project/radare2/libr/util/udiff.c"
             t_score = *(align_table + (row - 1) * dim + col) + gap;
   const 
# 478 "project/radare2/libr/util/udiff.c" 3 4
        short 
# 478 "project/radare2/libr/util/udiff.c"
             l_score = *(align_table + row * dim + col - 1) + gap;
   
# 479 "project/radare2/libr/util/udiff.c" 3 4
  short 
# 479 "project/radare2/libr/util/udiff.c"
       score;
...
# 523 "project/radare2/libr/util/udiff.c"
 ...
 while (pos_row || pos_col) {
  const 
# 529 "project/radare2/libr/util/udiff.c" 3 4
       short 
# 529 "project/radare2/libr/util/udiff.c"
            tl_score = (pos_row > 0 && pos_col > 0) ?
    *(align_table + (pos_row - 1) * dim + pos_col - 1) :
    
# 531 "project/radare2/libr/util/udiff.c" 3 4
   (-0x7FFF -1)
# 531 "project/radare2/libr/util/udiff.c"
           ;
  const 
# 532 "project/radare2/libr/util/udiff.c" 3 4
       short 
# 532 "project/radare2/libr/util/udiff.c"
            t_score = pos_row > 0 ?
    *(align_table + (pos_row - 1) * dim + pos_col) :
    
# 534 "project/radare2/libr/util/udiff.c" 3 4
   (-0x7FFF -1)
# 534 "project/radare2/libr/util/udiff.c"
           ;
  const 
# 535 "project/radare2/libr/util/udiff.c" 3 4
       short 
# 535 "project/radare2/libr/util/udiff.c"
            l_score = pos_col > 0 ?
    *(align_table + pos_row * dim + pos_col - 1) :
    
# 537 "project/radare2/libr/util/udiff.c" 3 4
   (-0x7FFF -1)
# 537 "project/radare2/libr/util/udiff.c"
           ;
  const 
# 538 "project/radare2/libr/util/udiff.c" 3 4
       _Bool 
# 538 "project/radare2/libr/util/udiff.c"
...
# 592 "project/radare2/libr/util/udiff.c"
...
# 610 "project/radare2/libr/util/udiff.c" 3 4
__attribute__((visibility("default"))) 
# 610 "project/radare2/libr/util/udiff.c"
     void r_diffchar_print(RDiffChar *diffchar) {
 
# 611 "project/radare2/libr/util/udiff.c" 3 4
do { if (!(
# 611 "project/radare2/libr/util/udiff.c"
diffchar
# 611 "project/radare2/libr/util/udiff.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 611 "project/radare2/libr/util/udiff.c"
...
# 611 "project/radare2/libr/util/udiff.c"
 ...
 while (idx_align < 2 * diffchar->len_buf) {
  const 
# 616 "project/radare2/libr/util/udiff.c" 3 4
       unsigned char 
# 616 "project/radare2/libr/util/udiff.c"
           a_ch = diffchar->align_a[idx_align];
  const 
# 617 "project/radare2/libr/util/udiff.c" 3 4
       unsigned char 
# 617 "project/radare2/libr/util/udiff.c"
           b_ch = diffchar->align_b[idx_align];
  if (a_ch && !b_ch) {
...
# 623 "project/radare2/libr/util/udiff.c" 3 4
  fprintf(__stderrp,
# 623 "project/radare2/libr/util/udiff.c"
  "Internal error: mismatch detected!\n"
# 623 "project/radare2/libr/util/udiff.c" 3 4
  )
# 623 "project/radare2/libr/util/udiff.c"
                                                  ;
  ...
  if (cur_mode == R2R_DIFF_MATCH) {
   if (cur_align == R2R_ALIGN_MATCH) {
    ...
    printf (a_ch == '\n'
      ? "%c" 
# 635 "project/radare2/libr/util/udiff.c" 3 4
            "\x1b[48;5;52m" "\x1b[91m"
      
# 636 "project/radare2/libr/util/udiff.c"
     : 
# 636 "project/radare2/libr/util/udiff.c" 3 4
       "\x1b[48;5;52m" "\x1b[91m" 
# 636 "project/radare2/libr/util/udiff.c"
                      "%c",
     a_ch);
    ...
    printf (b_ch == '\n'
      ? "%c" 
# 641 "project/radare2/libr/util/udiff.c" 3 4
            "\x1b[48;5;22m" "\x1b[92m"
      
# 642 "project/radare2/libr/util/udiff.c"
     : 
# 642 "project/radare2/libr/util/udiff.c" 3 4
       "\x1b[48;5;22m" "\x1b[92m" 
# 642 "project/radare2/libr/util/udiff.c"
                      "%c",
     b_ch);
   ...
   if (cur_align == R2R_ALIGN_MATCH) {
    printf (
# 648 "project/radare2/libr/util/udiff.c" 3 4
           "\x1b[0m"
# 648 "project/radare2/libr/util/udiff.c"
                      );
    if (a_ch) {
     printf ("%c", a_ch);
    }
    ...
    printf (a_ch == '\n'
      ? 
# 655 "project/radare2/libr/util/udiff.c" 3 4
       "\x1b[0m" 
# 655 "project/radare2/libr/util/udiff.c"
                   "%c" 
# 655 "project/radare2/libr/util/udiff.c" 3 4
                        "\x1b[48;5;52m" "\x1b[91m"
      
# 656 "project/radare2/libr/util/udiff.c"
     : "%c",
     a_ch);
   } else if (cur_align == R2R_ALIGN_TOP_GAP) {
    printf (b_ch == '\n'
      ? 
# 660 "project/radare2/libr/util/udiff.c" 3 4
       "\x1b[0m" 
# 660 "project/radare2/libr/util/udiff.c"
                   "%c" 
# 660 "project/radare2/libr/util/udiff.c" 3 4
                        "\x1b[48;5;22m" "\x1b[92m"
      
# 661 "project/radare2/libr/util/udiff.c"
     : 
# 661 "project/radare2/libr/util/udiff.c" 3 4
       "\x1b[48;5;22m" "\x1b[92m" 
# 661 "project/radare2/libr/util/udiff.c"
                      "%c",
     b_ch);
   ...
   if (cur_align == R2R_ALIGN_MATCH) {
    printf (
# 667 "project/radare2/libr/util/udiff.c" 3 4
           "\x1b[0m"
# 667 "project/radare2/libr/util/udiff.c"
                      );
    if (a_ch) {
     printf ("%c", a_ch);
    }
    ...
    printf (a_ch == '\n'
      ? 
# 674 "project/radare2/libr/util/udiff.c" 3 4
       "\x1b[0m" 
# 674 "project/radare2/libr/util/udiff.c"
                   "%c" 
# 674 "project/radare2/libr/util/udiff.c" 3 4
                        "\x1b[48;5;52m" "\x1b[91m"
      
# 675 "project/radare2/libr/util/udiff.c"
     : 
# 675 "project/radare2/libr/util/udiff.c" 3 4
       "\x1b[48;5;52m" "\x1b[91m" 
# 675 "project/radare2/libr/util/udiff.c"
                      "%c",
     a_ch);
    ...
    printf (b_ch == '\n'
      ? 
# 680 "project/radare2/libr/util/udiff.c" 3 4
       "\x1b[0m" 
# 680 "project/radare2/libr/util/udiff.c"
                   "%c" 
# 680 "project/radare2/libr/util/udiff.c" 3 4
                        "\x1b[48;5;22m" "\x1b[92m"
      
# 681 "project/radare2/libr/util/udiff.c"
     : "%c",
     b_ch);
   }
  }
 ...
 printf (
# 687 "project/radare2/libr/util/udiff.c" 3 4
        "\x1b[0m" 
# 687 "project/radare2/libr/util/udiff.c"
                    "\n");
}


# 690 "project/radare2/libr/util/udiff.c" 3 4
__attribute__((visibility("default"))) 
# 690 "project/radare2/libr/util/udiff.c"
     void r_diffchar_free(RDiffChar *diffchar) {
 if (diffchar) {
  free ((
# 692 "project/radare2/libr/util/udiff.c" 3 4
        unsigned char 
# 692 "project/radare2/libr/util/udiff.c"
            *)diffchar->align_a);
  free ((
# 693 "project/radare2/libr/util/udiff.c" 3 4
        unsigned char 
# 693 "project/radare2/libr/util/udiff.c"
            *)diffchar->align_b);
  free (diffchar);
 }
}
...
static 
# 698 "project/radare2/libr/util/udiff.c" 3 4
      int 
# 698 "project/radare2/libr/util/udiff.c"
           r_diff_levenshtein_nopath(RLevBuf *bufa, RLevBuf *bufb, 
# 698 "project/radare2/libr/util/udiff.c" 3 4
                                                                   unsigned int 
# 698 "project/radare2/libr/util/udiff.c"
                                                                        maxdst, RLevMatches levdiff, size_t skip, 
# 698 "project/radare2/libr/util/udiff.c" 3 4
                                                                                                                  unsigned int 
# 698 "project/radare2/libr/util/udiff.c"
                                                                                                                       alen, 
...
# 699 "project/radare2/libr/util/udiff.c" 3 4
do { if (!(
# 699 "project/radare2/libr/util/udiff.c"
bufa && bufb && bufa->buf && bufb->buf
# 699 "project/radare2/libr/util/udiff.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 699 "project/radare2/libr/util/udiff.c"
"bufa && bufb && bufa->buf && bufb->buf"
...
# 700 "project/radare2/libr/util/udiff.c" 3 4
do { if (!(
# 700 "project/radare2/libr/util/udiff.c"
blen >= alen && alen > 0
# 700 "project/radare2/libr/util/udiff.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 700 "project/radare2/libr/util/udiff.c"
...
# 703 "project/radare2/libr/util/udiff.c" 3 4
unsigned int 
# 703 "project/radare2/libr/util/udiff.c"
     origdst = maxdst = 
# 703 "project/radare2/libr/util/udiff.c" 3 4
                        (((
# 703 "project/radare2/libr/util/udiff.c"
...
# 703 "project/radare2/libr/util/udiff.c"
 ...
 Levrow *matrix = 
# 706 "project/radare2/libr/util/udiff.c" 3 4
                 (
# 706 "project/radare2/libr/util/udiff.c"
                 Levrow
# 706 "project/radare2/libr/util/udiff.c" 3 4
                 *)calloc(
# 706 "project/radare2/libr/util/udiff.c"
...
# 706 "project/radare2/libr/util/udiff.c"
 ...
 row->changes = 
# 715 "project/radare2/libr/util/udiff.c" 3 4
               (unsigned int*)malloc(sizeof(unsigned int)*(
# 715 "project/radare2/libr/util/udiff.c"
               2 * maxdst + 1
# 715 "project/radare2/libr/util/udiff.c" 3 4
               ))
# 715 "project/radare2/libr/util/udiff.c"
                                            ;
 prev_row->changes = 
# 716 "project/radare2/libr/util/udiff.c" 3 4
                    (unsigned int*)malloc(sizeof(unsigned int)*(
# 716 "project/radare2/libr/util/udiff.c"
                    2 * maxdst + 1
# 716 "project/radare2/libr/util/udiff.c" 3 4
                    ))
# 716 "project/radare2/libr/util/udiff.c"
...
# 722 "project/radare2/libr/util/udiff.c" 3 4
unsigned int 
# 722 "project/radare2/libr/util/udiff.c"
     ldelta = blen - alen;
 if (ldelta > maxdst) {
  lev_matrix_free (matrix, alen + 1);
  return 
# 725 "project/radare2/libr/util/udiff.c" 3 4
        0x7FFFFFFF
# 725 "project/radare2/libr/util/udiff.c"
                ;
 }
...
# 735 "project/radare2/libr/util/udiff.c" 3 4
unsigned int 
# 735 "project/radare2/libr/util/udiff.c"
     oldmin = 0;
 for (i = 1; i <= alen; i++) {
...
# 747 "project/radare2/libr/util/udiff.c" 3 4
 unsigned int 
# 747 "project/radare2/libr/util/udiff.c"
      start = row->start;
  
# 748 "project/radare2/libr/util/udiff.c" 3 4
 unsigned int 
# 748 "project/radare2/libr/util/udiff.c"
      udel = 
# 748 "project/radare2/libr/util/udiff.c" 3 4
             0xFFFFFFFFU
# 748 "project/radare2/libr/util/udiff.c"
...
# 753 "project/radare2/libr/util/udiff.c" 3 4
 unsigned int 
# 753 "project/radare2/libr/util/udiff.c"
      newmin = 
# 753 "project/radare2/libr/util/udiff.c" 3 4
               0xFFFFFFFFU
# 753 "project/radare2/libr/util/udiff.c"
...
# 754 "project/radare2/libr/util/udiff.c" 3 4
 unsigned int 
# 754 "project/radare2/libr/util/udiff.c"
      sub = lev_get_val (prev_row, start - 1);
  
# 755 "project/radare2/libr/util/udiff.c" 3 4
 unsigned int 
# 755 "project/radare2/libr/util/udiff.c"
      j;
  for (j = start; j <= row->end; j++) {
   
# 757 "project/radare2/libr/util/udiff.c" 3 4
  unsigned int 
# 757 "project/radare2/libr/util/udiff.c"
       add = lev_get_val (prev_row, j);
   
# 758 "project/radare2/libr/util/udiff.c" 3 4
  unsigned int 
# 758 "project/radare2/libr/util/udiff.c"
       ans = 
# 758 "project/radare2/libr/util/udiff.c" 3 4
             (((
# 758 "project/radare2/libr/util/udiff.c"
...
# 758 "project/radare2/libr/util/udiff.c"
   ...
   if (ans >= sub) {
    ...
    ans = 
# 763 "project/radare2/libr/util/udiff.c" 3 4
         (((
# 763 "project/radare2/libr/util/udiff.c"
         ans
# 763 "project/radare2/libr/util/udiff.c" 3 4
         )>(
# 763 "project/radare2/libr/util/udiff.c"
...
# 763 "project/radare2/libr/util/udiff.c"
  ...
  if (newmin > oldmin) {
   if (maxdst == 0) {
    ...
    return 
# 776 "project/radare2/libr/util/udiff.c" 3 4
          0x7FFFFFFF
# 776 "project/radare2/libr/util/udiff.c"
                  ;
   }
...
# 786 "project/radare2/libr/util/udiff.c" 3 4
int 
# 786 "project/radare2/libr/util/udiff.c"
     ret = lev_get_val (row, row->end);
 if (ret > origdst) {
  ret = 
# 788 "project/radare2/libr/util/udiff.c" 3 4
       0x7FFFFFFF
# 788 "project/radare2/libr/util/udiff.c"
               ;
 }
 lev_matrix_free (matrix, 2);
 return ret;
}
# 810 "project/radare2/libr/util/udiff.c"

# 810 "project/radare2/libr/util/udiff.c" 3 4
__attribute__((visibility("default"))) int 
# 810 "project/radare2/libr/util/udiff.c"
          r_diff_levenshtein_path(RLevBuf *bufa, RLevBuf *bufb, 
# 810 "project/radare2/libr/util/udiff.c" 3 4
                                                                unsigned int 
# 810 "project/radare2/libr/util/udiff.c"
                                                                     maxdst, RLevMatches levdiff, RLevOp **chgs) {
 
# 811 "project/radare2/libr/util/udiff.c" 3 4
do { if (!(
# 811 "project/radare2/libr/util/udiff.c"
bufa && bufb && bufa->buf && bufb->buf
# 811 "project/radare2/libr/util/udiff.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 811 "project/radare2/libr/util/udiff.c"
...
# 812 "project/radare2/libr/util/udiff.c" 3 4
do { if (!(
# 812 "project/radare2/libr/util/udiff.c"
!chgs || !*chgs
# 812 "project/radare2/libr/util/udiff.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 812 "project/radare2/libr/util/udiff.c"
...
# 815 "project/radare2/libr/util/udiff.c" 3 4
_Bool 
# 815 "project/radare2/libr/util/udiff.c"
     invert = 
# 815 "project/radare2/libr/util/udiff.c" 3 4
              0
# 815 "project/radare2/libr/util/udiff.c"
 ...
 if (bufb->len < bufa->len) {
  invert = 
# 817 "project/radare2/libr/util/udiff.c" 3 4
          1
# 817 "project/radare2/libr/util/udiff.c"
              ;
  RLevBuf *x = bufa;
  bufa = bufb;
  bufb = x;
...
# 822 "project/radare2/libr/util/udiff.c" 3 4
do { if (!(
# 822 "project/radare2/libr/util/udiff.c"
bufb->len < 
# 822 "project/radare2/libr/util/udiff.c" 3 4
0xFFFFFFFFU)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 822 "project/radare2/libr/util/udiff.c"
"bufb->len < UT32_MAX"
# 822 "project/radare2/libr/util/udiff.c" 3 4
, 822); return (
...
# 823 "project/radare2/libr/util/udiff.c" 3 4
unsigned int 
# 823 "project/radare2/libr/util/udiff.c"
     ldelta = bufb->len - bufa->len;
 if (ldelta > maxdst) {
  return 
# 825 "project/radare2/libr/util/udiff.c" 3 4
        0x7FFFFFFF
# 825 "project/radare2/libr/util/udiff.c"
                ;
 }
...
# 830 "project/radare2/libr/util/udiff.c" 3 4
unsigned int 
# 830 "project/radare2/libr/util/udiff.c"
     alen = bufa->len;
 
# 831 "project/radare2/libr/util/udiff.c" 3 4
unsigned int 
# 831 "project/radare2/libr/util/udiff.c"
     blen = bufb->len;
 ...
 if (alen == 0) {
  if (chgs) {
   RLevOp *c = 
# 842 "project/radare2/libr/util/udiff.c" 3 4
              (
# 842 "project/radare2/libr/util/udiff.c"
              RLevOp
# 842 "project/radare2/libr/util/udiff.c" 3 4
              *)malloc(sizeof(
# 842 "project/radare2/libr/util/udiff.c"
...
# 864 "project/radare2/libr/util/udiff.c" 3 4
unsigned int 
# 864 "project/radare2/libr/util/udiff.c"
     origdst = maxdst = 
# 864 "project/radare2/libr/util/udiff.c" 3 4
                        (((
# 864 "project/radare2/libr/util/udiff.c"
...
# 864 "project/radare2/libr/util/udiff.c"
 ...
 Levrow *matrix = 
# 867 "project/radare2/libr/util/udiff.c" 3 4
                 (
# 867 "project/radare2/libr/util/udiff.c"
                 Levrow
# 867 "project/radare2/libr/util/udiff.c" 3 4
                 *)calloc(
# 867 "project/radare2/libr/util/udiff.c"
...
# 883 "project/radare2/libr/util/udiff.c" 3 4
unsigned int 
# 883 "project/radare2/libr/util/udiff.c"
     oldmin = 0;
 Levrow *prev_row;
 for (i = 1; i <= alen; i++) {
  prev_row = row;
  if ((row = lev_row_init (matrix, maxdst, i, blen, ldelta)) == 
# 887 "project/radare2/libr/util/udiff.c" 3 4
                                                               ((void *)0)
# 887 "project/radare2/libr/util/udiff.c"
                                                                   ) {
   lev_matrix_free (matrix, alen + 1);
   return -1;
  }
...
# 892 "project/radare2/libr/util/udiff.c" 3 4
 unsigned int 
# 892 "project/radare2/libr/util/udiff.c"
      start = row->start;
  
# 893 "project/radare2/libr/util/udiff.c" 3 4
 unsigned int 
# 893 "project/radare2/libr/util/udiff.c"
      udel = 
# 893 "project/radare2/libr/util/udiff.c" 3 4
             0xFFFFFFFFU
# 893 "project/radare2/libr/util/udiff.c"
...
# 898 "project/radare2/libr/util/udiff.c" 3 4
 unsigned int 
# 898 "project/radare2/libr/util/udiff.c"
      newmin = 
# 898 "project/radare2/libr/util/udiff.c" 3 4
               0xFFFFFFFFU
# 898 "project/radare2/libr/util/udiff.c"
...
# 899 "project/radare2/libr/util/udiff.c" 3 4
 unsigned int 
# 899 "project/radare2/libr/util/udiff.c"
      sub = lev_get_val (prev_row, start - 1);
  
# 900 "project/radare2/libr/util/udiff.c" 3 4
 unsigned int 
# 900 "project/radare2/libr/util/udiff.c"
      j;
  for (j = start; j <= row->end; j++) {
   
# 902 "project/radare2/libr/util/udiff.c" 3 4
  unsigned int 
# 902 "project/radare2/libr/util/udiff.c"
       add = lev_get_val (prev_row, j);
   
# 903 "project/radare2/libr/util/udiff.c" 3 4
  unsigned int 
# 903 "project/radare2/libr/util/udiff.c"
       ans = 
# 903 "project/radare2/libr/util/udiff.c" 3 4
             (((
# 903 "project/radare2/libr/util/udiff.c"
...
# 903 "project/radare2/libr/util/udiff.c"
   ...
   if (ans >= sub) {
    ...
    int d = levdiff (bufa, bufb, i + skip - 1, j + skip - 1)? 1: 0;
    ans = 
# 908 "project/radare2/libr/util/udiff.c" 3 4
         (((
# 908 "project/radare2/libr/util/udiff.c"
         ans
# 908 "project/radare2/libr/util/udiff.c" 3 4
         )>(
# 908 "project/radare2/libr/util/udiff.c"
...
# 908 "project/radare2/libr/util/udiff.c"
  ...
  if (newmin > oldmin) {
   if (maxdst == 0) {
    lev_matrix_free (matrix, alen + 1);
    return 
# 920 "project/radare2/libr/util/udiff.c" 3 4
          0x7FFFFFFF
# 920 "project/radare2/libr/util/udiff.c"
                  ;
   }
...
# 930 "project/radare2/libr/util/udiff.c" 3 4
int 
# 930 "project/radare2/libr/util/udiff.c"
     ret = lev_get_val (row, row->end);
 if (ret > origdst) {

  lev_matrix_free (matrix, alen + 1);
  return 
# 934 "project/radare2/libr/util/udiff.c" 3 4
        0x7FFFFFFF
# 934 "project/radare2/libr/util/udiff.c"
                ;
 }
# 960 "project/radare2/libr/util/udiff.c"
 RLevOp *mtxpath = 
# 960 "project/radare2/libr/util/udiff.c" 3 4
                  ((void *)0)
# 960 "project/radare2/libr/util/udiff.c"
                      ;
 
# 961 "project/radare2/libr/util/udiff.c" 3 4
int 
# 961 "project/radare2/libr/util/udiff.c"
     chg_size = lev_parse_matrix (matrix, alen + 1, invert, &mtxpath);
 lev_matrix_free (matrix, alen + 1);
 if (chg_size > 0 && mtxpath) {
  
# 964 "project/radare2/libr/util/udiff.c" 3 4
 unsigned int 
# 964 "project/radare2/libr/util/udiff.c"
      tail = bufb->len - skip - blen;
  RLevOp *c = 
# 965 "project/radare2/libr/util/udiff.c" 3 4
             (
# 965 "project/radare2/libr/util/udiff.c"
             RLevOp
# 965 "project/radare2/libr/util/udiff.c" 3 4
             *)malloc(sizeof(
# 965 "project/radare2/libr/util/udiff.c"
