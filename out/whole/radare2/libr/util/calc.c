# 0 "project/radare2/libr/util/calc.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/calc.c"
# 11 "project/radare2/libr/util/calc.c"
...
# 12 "project/radare2/libr/util/calc.c" 2
...
# 13 "project/radare2/libr/util/calc.c" 2





# 17 "project/radare2/libr/util/calc.c"
static inline RNumCalcValue Nset(
# 17 "project/radare2/libr/util/calc.c" 3 4
                                unsigned long long 
# 17 "project/radare2/libr/util/calc.c"
                                     v) { RNumCalcValue n; n.d = (double)v; n.n = v; return n; }
static inline RNumCalcValue Nsetf(double v) { RNumCalcValue n; n.d = v; n.n = (
# 18 "project/radare2/libr/util/calc.c" 3 4
                                                                              unsigned long long
# 18 "project/radare2/libr/util/calc.c"
                                                                                  )v; return n; }

static inline RNumCalcValue Naddi(RNumCalcValue n, 
# 20 "project/radare2/libr/util/calc.c" 3 4
                                                  unsigned long long 
# 20 "project/radare2/libr/util/calc.c"
                                                       v) { n.d += (double)v; n.n += v; return n; }
static inline RNumCalcValue Nsubi(RNumCalcValue n, 
# 21 "project/radare2/libr/util/calc.c" 3 4
                                                  unsigned long long 
# 21 "project/radare2/libr/util/calc.c"
                                                       v) { n.d -= (double)v; n.n -= v; return n; }
...
static RNumCalcValue term(RNum *num, RNumCalc *nc, int get) {
 ...
 for (;;) {
  if (nc->curr_tok == RNCMUL) {
   ...
   RNumCalcValue d = prim (num, nc, 1);
   if (num != 
# 124 "project/radare2/libr/util/calc.c" 3 4
             ((void *)0) 
# 124 "project/radare2/libr/util/calc.c"
                  && (!d.d || !d.n)) {
    num->dbz = 1;
    return d;
   }
...
# 205 "project/radare2/libr/util/calc.c" 3 4
__attribute__((visibility("default"))) 
# 205 "project/radare2/libr/util/calc.c"
     const char *r_num_calc_index(RNum *num, const char *p) {
 if (!num) {
  return 
# 207 "project/radare2/libr/util/calc.c" 3 4
        ((void *)0)
# 207 "project/radare2/libr/util/calc.c"
            ;
 }
 if (p) {
  num->nc.calc_buf = p;
...
static int cin_get_num(RNum *num, RNumCalc *nc, RNumCalcValue *n) {
 double d;
 char str[
# 237 "project/radare2/libr/util/calc.c" 3 4
         1024 
# 237 "project/radare2/libr/util/calc.c"
                         + 1];
 int i = 0;
 char c;
 str[0] = 0;
 while (cin_get (num, nc, &c)) {
  if (c != '_' && c != ':' && c != '.' && !isalnum ((
# 242 "project/radare2/libr/util/calc.c" 3 4
                                                    unsigned char
# 242 "project/radare2/libr/util/calc.c"
                                                       )c)) {
   cin_putback (num, nc, c);
   break;
  }
  if (i < 
# 246 "project/radare2/libr/util/calc.c" 3 4
         1024
# 246 "project/radare2/libr/util/calc.c"
                        ) {
   str[i++] = c;
  }
 }
 ...
 *n = Nset (r_num_get (num, str));
 if (
# 252 "project/radare2/libr/util/calc.c" 3 4
    ((
# 252 "project/radare2/libr/util/calc.c"
    *str
# 252 "project/radare2/libr/util/calc.c" 3 4
    ) >= '0' && (
# 252 "project/radare2/libr/util/calc.c"
...
# 271 "project/radare2/libr/util/calc.c" 3 4
                                 unsigned char
# 271 "project/radare2/libr/util/calc.c"
                                    )ch));
...
#define stringValueAppend(x) { const size_t max = sizeof (nc->string_value) - 1; if (i < max) nc->string_value[i++] = x; else nc->string_value[max] = 0; }
   ...
   { const size_t max = sizeof (nc->string_value) - 1; if (i < max) nc->string_value[i++] = ch; else nc->string_value[max] = 0; };
   if (ch == '[') {
    while (cin_get (num, nc, &ch) && ch!=']') {
     if (i > 
# 353 "project/radare2/libr/util/calc.c" 3 4
            1024 
# 353 "project/radare2/libr/util/calc.c"
                            - 1) {
    ...
    while (cin_get (num, nc, &ch) && (isalnum((unsigned char)ch) || ((unsigned char)ch)==':' || ((unsigned char)ch)=='$' || ((unsigned char)ch)=='.' || ((unsigned char)ch)=='_' || ((unsigned char)ch)=='?' || ((unsigned char)ch)=='\\' || ((unsigned char)ch)==' ' || ((unsigned char)ch)=='[' || ((unsigned char)ch)==']' || ((unsigned char)ch)=='}' || ((unsigned char)ch)=='{' || (((unsigned char)ch)>='0' && ((unsigned char)ch)<='9'))) {
     if (i >= 
# 362 "project/radare2/libr/util/calc.c" 3 4
             1024
# 362 "project/radare2/libr/util/calc.c"
                            ) {
      error (num, nc, "string too long");
      return 0;
     }
   ...
   { const size_t max = sizeof (nc->string_value) - 1; if (i < max) nc->string_value[i++] = 0; else nc->string_value[max] = 0; };
   if (ch != '\'') {
    cin_putback (num, nc, ch);
   }
...
static void load_token(RNum *num, RNumCalc *nc, const char *s) {
 ...
 nc->calc_buf = s;
 nc->calc_err = 
# 382 "project/radare2/libr/util/calc.c" 3 4
               ((void *)0)
# 382 "project/radare2/libr/util/calc.c"
                   ;
}


# 385 "project/radare2/libr/util/calc.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 385 "project/radare2/libr/util/calc.c"
          r_num_calc(RNum *num, const char *str, const char **err) {
 RNumCalcValue n;
 ...
 nc->oc = 0;
 nc->calc_err = 
# 403 "project/radare2/libr/util/calc.c" 3 4
               ((void *)0)
# 403 "project/radare2/libr/util/calc.c"
                   ;
 nc->calc_i = 0;
 nc->calc_len = 0;
 nc->calc_buf = 
# 406 "project/radare2/libr/util/calc.c" 3 4
               ((void *)0)
# 406 "project/radare2/libr/util/calc.c"
                   ;
 nc->under_calc = 
# 407 "project/radare2/libr/util/calc.c" 3 4
                 1
# 407 "project/radare2/libr/util/calc.c"
                     ;
 ...
 nc->under_calc = 
# 418 "project/radare2/libr/util/calc.c" 3 4
                 0
# 418 "project/radare2/libr/util/calc.c"
                      ;
 return n.n;
}
