# 0 "project/radare2/libr/util/thread_lock.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/thread_lock.c"
...
# 4 "project/radare2/libr/util/thread_lock.c" 2



__attribute__((visibility("default"))) 
# 7 "project/radare2/libr/util/thread_lock.c"
     RThreadLock *r_th_lock_new(
# 7 "project/radare2/libr/util/thread_lock.c" 3 4
                                _Bool 
# 7 "project/radare2/libr/util/thread_lock.c"
                                     recursive) {
 RThreadLock *thl = 
# 8 "project/radare2/libr/util/thread_lock.c" 3 4
                   (
# 8 "project/radare2/libr/util/thread_lock.c"
                   RThreadLock
# 8 "project/radare2/libr/util/thread_lock.c" 3 4
                   *)calloc(1,sizeof(
# 8 "project/radare2/libr/util/thread_lock.c"
...
# 15 "project/radare2/libr/util/thread_lock.c" 3 4
                                    2
# 15 "project/radare2/libr/util/thread_lock.c"
                                                           );
   ...
   pthread_mutex_init (&thl->lock, 
# 21 "project/radare2/libr/util/thread_lock.c" 3 4
                                  ((void *)0)
# 21 "project/radare2/libr/util/thread_lock.c"
                                      );
  }
...
# 31 "project/radare2/libr/util/thread_lock.c" 3 4
__attribute__((visibility("default"))) 
# 31 "project/radare2/libr/util/thread_lock.c"
     int r_th_lock_wait(RThreadLock *thl) {
 r_th_lock_enter (thl);
 r_th_lock_leave (thl);
 return 0;
}
...
# 37 "project/radare2/libr/util/thread_lock.c" 3 4
__attribute__((visibility("default"))) 
# 37 "project/radare2/libr/util/thread_lock.c"
     int r_th_lock_enter(RThreadLock *thl) {
...
# 48 "project/radare2/libr/util/thread_lock.c" 3 4
__attribute__((visibility("default"))) 
# 48 "project/radare2/libr/util/thread_lock.c"
     int r_th_lock_tryenter(RThreadLock *thl) {
...
# 58 "project/radare2/libr/util/thread_lock.c" 3 4
__attribute__((visibility("default"))) 
# 58 "project/radare2/libr/util/thread_lock.c"
     int r_th_lock_leave(RThreadLock *thl) {
...
# 69 "project/radare2/libr/util/thread_lock.c" 3 4
__attribute__((visibility("default"))) 
# 69 "project/radare2/libr/util/thread_lock.c"
     void *r_th_lock_free(RThreadLock *thl) {
 if (thl) {
 ...
 return 
# 78 "project/radare2/libr/util/thread_lock.c" 3 4
       ((void *)0)
# 78 "project/radare2/libr/util/thread_lock.c"
           ;
}
