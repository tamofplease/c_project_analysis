# 0 "project/radare2/libr/util/json_indent.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/util/json_indent.c"
...
# 4 "project/radare2/libr/util/json_indent.c" 2



# 6 "project/radare2/libr/util/json_indent.c"
...
#define EMIT_ESC(s,code) do { if (color) { const char *p = code; while (*p) { *(s)++ = *p++; } } } while (0);
# 25 "project/radare2/libr/util/json_indent.c"
enum {
 JC_FALSE,
 JC_TRUE,
 JC_KEY,
...
# 42 "project/radare2/libr/util/json_indent.c" 3 4
__attribute__((visibility("default"))) 
# 42 "project/radare2/libr/util/json_indent.c"
     char* r_print_json_path(const char* s, int pos) {
 int indent = 0;
#define DSZ 128
 const char *words[128] = { 
# 45 "project/radare2/libr/util/json_indent.c" 3 4
                           ((void *)0) 
# 45 "project/radare2/libr/util/json_indent.c"
                                };
 int lengths[128] = { 0 };
 int indexs[128] = { 0 };
 int instr = 0;
 
# 49 "project/radare2/libr/util/json_indent.c" 3 4
_Bool 
# 49 "project/radare2/libr/util/json_indent.c"
     isarr = 
# 49 "project/radare2/libr/util/json_indent.c" 3 4
             0
# 49 "project/radare2/libr/util/json_indent.c"
 ...
 if (!s) {
  return 
# 51 "project/radare2/libr/util/json_indent.c" 3 4
        ((void *)0)
# 51 "project/radare2/libr/util/json_indent.c"
            ;
 }
 int arrpos = 0;
 const char *os = s;
 ...
 if (osz < 1) {
  return 
# 57 "project/radare2/libr/util/json_indent.c" 3 4
        ((void *)0)
# 57 "project/radare2/libr/util/json_indent.c"
            ;
 }

 const char *str_a = 
# 60 "project/radare2/libr/util/json_indent.c" 3 4
                    ((void *)0)
# 60 "project/radare2/libr/util/json_indent.c"
                        ;
 for (; *s; s++) {
  if (instr) {
   if (s[0] == '"') {
...
# 65 "project/radare2/libr/util/json_indent.c" 3 4
   unsigned long long 
# 65 "project/radare2/libr/util/json_indent.c"
        cur = str_a - os;
    if (cur > pos) {
     break;
    }
  ...
  case '[':
   if (*s == '[') {
    isarr = 
# 100 "project/radare2/libr/util/json_indent.c" 3 4
           1
# 100 "project/radare2/libr/util/json_indent.c"
               ;
    arrpos = 0;
   }
   if (indent > 128) {
    
# 104 "project/radare2/libr/util/json_indent.c" 3 4
   fprintf(__stderrp,
# 104 "project/radare2/libr/util/json_indent.c"
...
# 104 "project/radare2/libr/util/json_indent.c"
  ...
  case ']':
   if (*s == ']') {
    isarr = 
# 113 "project/radare2/libr/util/json_indent.c" 3 4
           0
# 113 "project/radare2/libr/util/json_indent.c"
                ;
   }
   indent--;
   break;
...
# 120 "project/radare2/libr/util/json_indent.c" 3 4
unsigned long long 
# 120 "project/radare2/libr/util/json_indent.c"
     opos = 0;
 for (i = 0; i < 128 && i < indent; i++) {
  if ((int)(size_t)words[i] < 128) {
   
# 123 "project/radare2/libr/util/json_indent.c" 3 4
  unsigned long long 
# 123 "project/radare2/libr/util/json_indent.c"
       cur = lengths[i];
   if (cur < opos) {
    continue;
   }
...
# 131 "project/radare2/libr/util/json_indent.c" 3 4
  fprintf(__stderrp,
# 131 "project/radare2/libr/util/json_indent.c"
  "0x%08"
# 131 "project/radare2/libr/util/json_indent.c" 3 4
  "llx"
# 131 "project/radare2/libr/util/json_indent.c"
...
# 134 "project/radare2/libr/util/json_indent.c" 3 4
  unsigned long long 
# 134 "project/radare2/libr/util/json_indent.c"
       cur = words[i] - os - 1;
   if (cur < opos) {
    continue;
   }
...
# 146 "project/radare2/libr/util/json_indent.c" 3 4
  fprintf(__stderrp,
# 146 "project/radare2/libr/util/json_indent.c"
  "0x%08"
# 146 "project/radare2/libr/util/json_indent.c" 3 4
  "llx"
# 146 "project/radare2/libr/util/json_indent.c"
...
# 146 "project/radare2/libr/util/json_indent.c"
 ...
 return 
# 151 "project/radare2/libr/util/json_indent.c" 3 4
       ((void *)0)
# 151 "project/radare2/libr/util/json_indent.c"
           ;
}


# 154 "project/radare2/libr/util/json_indent.c" 3 4
__attribute__((visibility("default"))) 
# 154 "project/radare2/libr/util/json_indent.c"
     char* r_print_json_human(const char* s) {
 int indent = 0;
 const char *tab = "  ";
 ...
 if (!s) {
  return 
# 161 "project/radare2/libr/util/json_indent.c" 3 4
        ((void *)0)
# 161 "project/radare2/libr/util/json_indent.c"
            ;
 }
 int osz = (1 + strlen (s)) * 20;
 if (osz < 1) {
  return 
# 165 "project/radare2/libr/util/json_indent.c" 3 4
        ((void *)0)
# 165 "project/radare2/libr/util/json_indent.c"
            ;
 }
 ...
 if (!O) {
  return 
# 170 "project/radare2/libr/util/json_indent.c" 3 4
        ((void *)0)
# 170 "project/radare2/libr/util/json_indent.c"
            ;
 }
 OE = O + osz;
 for (o = O; *s; s++) {
  if (o + (indent * indentSize) + 10 > OE) {
   ...
   if (osz < 1) {
    free (O);
    return 
# 179 "project/radare2/libr/util/json_indent.c" 3 4
          ((void *)0)
# 179 "project/radare2/libr/util/json_indent.c"
              ;
   }
   tmp = realloc (O, osz);
   if (!tmp) {
    free (O);
    return 
# 184 "project/radare2/libr/util/json_indent.c" 3 4
          ((void *)0)
# 184 "project/radare2/libr/util/json_indent.c"
              ;
   }
   O = tmp;
   OE = tmp + osz;
...
# 231 "project/radare2/libr/util/json_indent.c" 3 4
   fprintf(__stderrp,
# 231 "project/radare2/libr/util/json_indent.c"
   "JSON indentation is too deep\n"
# 231 "project/radare2/libr/util/json_indent.c" 3 4
   )
# 231 "project/radare2/libr/util/json_indent.c"
...
# 253 "project/radare2/libr/util/json_indent.c" 3 4
__attribute__((visibility("default"))) 
# 253 "project/radare2/libr/util/json_indent.c"
     char* r_print_json_indent(const char* s, 
# 253 "project/radare2/libr/util/json_indent.c" 3 4
                                              _Bool 
# 253 "project/radare2/libr/util/json_indent.c"
                                                   color, const char* tab, const char **palette) {
 int indent = 0;
 const int indentSize = strlen (tab);
 int instr = 0;
 
# 257 "project/radare2/libr/util/json_indent.c" 3 4
_Bool 
# 257 "project/radare2/libr/util/json_indent.c"
     isValue = 
# 257 "project/radare2/libr/util/json_indent.c" 3 4
               0
# 257 "project/radare2/libr/util/json_indent.c"
 ...
 if (!s) {
  return 
# 260 "project/radare2/libr/util/json_indent.c" 3 4
        ((void *)0)
# 260 "project/radare2/libr/util/json_indent.c"
            ;
 }
 ...
 if (osz < 1) {
  return 
# 265 "project/radare2/libr/util/json_indent.c" 3 4
        ((void *)0)
# 265 "project/radare2/libr/util/json_indent.c"
            ;
 }
 ...
 if (!O) {
  return 
# 270 "project/radare2/libr/util/json_indent.c" 3 4
        ((void *)0)
# 270 "project/radare2/libr/util/json_indent.c"
            ;
 }
 OE = O + osz;
 for (o = O; *s; s++) {
  if (o + (indent * indentSize) + 10 > OE) {
   ...
   if (osz < 1) {
    free (O);
    return 
# 279 "project/radare2/libr/util/json_indent.c" 3 4
          ((void *)0)
# 279 "project/radare2/libr/util/json_indent.c"
              ;
   }
   tmp = realloc (O, osz);
   if (!tmp) {
    free (O);
    return 
# 284 "project/radare2/libr/util/json_indent.c" 3 4
          ((void *)0)
# 284 "project/radare2/libr/util/json_indent.c"
              ;
   }
   O = tmp;
   OE = tmp + osz;
  ...
  if (instr) {
   ...
   if (instr) {
    if (isValue) {
     ...
     do { if (color) { const char *p = colors[JC_VAL]; while (*p) { *(o)++ = *p++; } } } while (0);;
    } else {
     do { if (color) { const char *p = colors[JC_KEY]; while (*p) { *(o)++ = *p++; } } } while (0);;
    }
   } else {
    do { if (color) { const char *p = colors[JC_RESET]; while (*p) { *(o)++ = *p++; } } } while (0);;
   }
   *o++ = *s;
   continue;
  }
  ...
  if (*s == '\n' || *s == '\r' || *s == '\t' || *s == ' ' || !
# 322 "project/radare2/libr/util/json_indent.c" 3 4
                                                             ((
# 322 "project/radare2/libr/util/json_indent.c"
                                                             *s
# 322 "project/radare2/libr/util/json_indent.c" 3 4
                                                             ) >=' ' && (
# 322 "project/radare2/libr/util/json_indent.c"
...
# 322 "project/radare2/libr/util/json_indent.c"
   ...
   *o++ = ' ';
   ...
   if (!strncmp (s, "true", 4)) {
    do { if (color) { const char *p = colors[JC_TRUE]; while (*p) { *(o)++ = *p++; } } } while (0);;
   } else if (!strncmp (s, "false", 5)) {
    do { if (color) { const char *p = colors[JC_FALSE]; while (*p) { *(o)++ = *p++; } } } while (0);;
   }
   s--;
   isValue = 
# 336 "project/radare2/libr/util/json_indent.c" 3 4
            1
# 336 "project/radare2/libr/util/json_indent.c"
                ;
   break;
  case ',':
   do { if (color) { const char *p = colors[JC_RESET]; while (*p) { *(o)++ = *p++; } } } while (0);;
   ...
   *o++ = '\n';
   isValue = 
# 342 "project/radare2/libr/util/json_indent.c" 3 4
            0
# 342 "project/radare2/libr/util/json_indent.c"
                 ;
  ...
  case '[':
   isValue = 
# 347 "project/radare2/libr/util/json_indent.c" 3 4
            0
# 347 "project/radare2/libr/util/json_indent.c"
                 ;
   *o++ = *s;
   *o++ = (indent != -1)? '\n': ' ';
   if (indent > 128) {
    
# 351 "project/radare2/libr/util/json_indent.c" 3 4
   fprintf(__stderrp,
# 351 "project/radare2/libr/util/json_indent.c"
   "JSON indentation is too deep\n"
# 351 "project/radare2/libr/util/json_indent.c" 3 4
   )
# 351 "project/radare2/libr/util/json_indent.c"
  ...
  case ']':
   do { if (color) { const char *p = colors[JC_RESET]; while (*p) { *(o)++ = *p++; } } } while (0);;
   isValue = 
# 361 "project/radare2/libr/util/json_indent.c" 3 4
            0
# 361 "project/radare2/libr/util/json_indent.c"
                 ;
   *o++ = '\n';
   indent--;
   doIndent (indent, &o, tab);
