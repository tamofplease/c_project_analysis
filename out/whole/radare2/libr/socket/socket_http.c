# 0 "project/radare2/libr/socket/socket_http.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/socket/socket_http.c"
...
# 4 "project/radare2/libr/socket/socket_http.c" 2
...
# 5 "project/radare2/libr/socket/socket_http.c" 2
...
# 13 "project/radare2/libr/socket/socket_http.c"
...
# 18 "project/radare2/libr/socket/socket_http.c" 3 4
                        1
# 18 "project/radare2/libr/socket/socket_http.c"
                            , 0, 1000);
 for (i = 0; i < 0x2000; i += 1) {
  
# 20 "project/radare2/libr/socket/socket_http.c" 3 4
 unsigned char 
# 20 "project/radare2/libr/socket/socket_http.c"
     c;
  int olen = r_socket_read_block (s, &c, 1);
  if (olen != 1) {
   r_buf_append_bytes (buf, (
# 23 "project/radare2/libr/socket/socket_http.c" 3 4
                            unsigned char 
# 23 "project/radare2/libr/socket/socket_http.c"
                                *)"", 1);
   break;
  }
...
static char *socket_http_get_recursive(const char *url, int *code, int *rlen, 
# 31 "project/radare2/libr/socket/socket_http.c" 3 4
                                                                             unsigned int 
# 31 "project/radare2/libr/socket/socket_http.c"
                                                                                  redirections);

static char *socket_http_answer(RSocket *s, int *code, int *rlen, 
# 33 "project/radare2/libr/socket/socket_http.c" 3 4
                                                                 unsigned int 
# 33 "project/radare2/libr/socket/socket_http.c"
                                                                      redirections) {
 
# 34 "project/radare2/libr/socket/socket_http.c" 3 4
do { if (!(
# 34 "project/radare2/libr/socket/socket_http.c"
s
# 34 "project/radare2/libr/socket/socket_http.c" 3 4
...
"s"
# 34 "project/radare2/libr/socket/socket_http.c" 3 4
, 34); return (((void *)0)); } } while (0)
# 34 "project/radare2/libr/socket/socket_http.c"
                              ;
 const char *p;
 int ret, len = 0, delta = 0;
 char *dn = 
# 37 "project/radare2/libr/socket/socket_http.c" 3 4
           ((void *)0)
# 37 "project/radare2/libr/socket/socket_http.c"
               ;
 RBuffer *b = r_buf_new ();
 if (!b) {
  return 
# 40 "project/radare2/libr/socket/socket_http.c" 3 4
        ((void *)0)
# 40 "project/radare2/libr/socket/socket_http.c"
            ;
 }
 char *res = 
# 42 "project/radare2/libr/socket/socket_http.c" 3 4
            ((void *)0)
# 42 "project/radare2/libr/socket/socket_http.c"
                ;
 ...
 r_buf_read_at (b, 0, (
# 48 "project/radare2/libr/socket/socket_http.c" 3 4
                      unsigned char 
# 48 "project/radare2/libr/socket/socket_http.c"
                          *)buf, olen);
 buf[olen] = 0;
...
# 75 "project/radare2/libr/socket/socket_http.c" 3 4
  fprintf(__stderrp,
# 75 "project/radare2/libr/socket/socket_http.c"
  "Too many redirects\n"
# 75 "project/radare2/libr/socket/socket_http.c" 3 4
  )
# 75 "project/radare2/libr/socket/socket_http.c"
...
# 105 "project/radare2/libr/socket/socket_http.c" 3 4
  __builtin___memcpy_chk (
# 105 "project/radare2/libr/socket/socket_http.c"
  res
# 105 "project/radare2/libr/socket/socket_http.c" 3 4
  , 
# 105 "project/radare2/libr/socket/socket_http.c"
...
# 107 "project/radare2/libr/socket/socket_http.c" 3 4
                                  unsigned char
# 107 "project/radare2/libr/socket/socket_http.c"
                                     *) res + olen, len - olen);
    if (ret < 1) {
     break;
    }
...
# 117 "project/radare2/libr/socket/socket_http.c" 3 4
   __builtin___memcpy_chk (
# 117 "project/radare2/libr/socket/socket_http.c"
   res
# 117 "project/radare2/libr/socket/socket_http.c" 3 4
   , 
# 117 "project/radare2/libr/socket/socket_http.c"
...
# 190 "project/radare2/libr/socket/socket_http.c"
static char *socket_http_get_recursive(const char *url, int *code, int *rlen, 
# 190 "project/radare2/libr/socket/socket_http.c" 3 4
                                                                             unsigned int 
# 190 "project/radare2/libr/socket/socket_http.c"
                                                                                  redirections) {
 if (code) {
 ...
 if (!
# 198 "project/radare2/libr/socket/socket_http.c" 3 4
     (!(
# 198 "project/radare2/libr/socket/socket_http.c"
     curl_env
# 198 "project/radare2/libr/socket/socket_http.c" 3 4
     ) || !*(
# 198 "project/radare2/libr/socket/socket_http.c"
...
# 198 "project/radare2/libr/socket/socket_http.c"
  ...
  char *res = r_sys_cmd_str (command, 
# 202 "project/radare2/libr/socket/socket_http.c" 3 4
                                     ((void *)0)
# 202 "project/radare2/libr/socket/socket_http.c"
                                         , &len);
  free (escaped_url);
  free (command);
  free (curl_env);
  if (!res) {
   return 
# 207 "project/radare2/libr/socket/socket_http.c" 3 4
         ((void *)0)
# 207 "project/radare2/libr/socket/socket_http.c"
             ;
  }
  if (res) {
   if (code) {
...
# 224 "project/radare2/libr/socket/socket_http.c" 3 4
_Bool 
# 224 "project/radare2/libr/socket/socket_http.c"
     ssl = r_str_startswith (url, "https://");

 if (ssl) {
  
# 227 "project/radare2/libr/socket/socket_http.c" 3 4
 fprintf(__stderrp,
# 227 "project/radare2/libr/socket/socket_http.c"
...
# 227 "project/radare2/libr/socket/socket_http.c"
                                                                                             ;
  return 
# 228 "project/radare2/libr/socket/socket_http.c" 3 4
        ((void *)0)
# 228 "project/radare2/libr/socket/socket_http.c"
            ;
 }
 ...
 if (!uri) {
  return 
# 234 "project/radare2/libr/socket/socket_http.c" 3 4
        ((void *)0)
# 234 "project/radare2/libr/socket/socket_http.c"
            ;
 }
 host = strstr (uri, "://");
 if (!host) {
...
# 239 "project/radare2/libr/socket/socket_http.c" 3 4
 fprintf(__stderrp,
# 239 "project/radare2/libr/socket/socket_http.c"
 "r_socket_http_get: Invalid URI"
# 239 "project/radare2/libr/socket/socket_http.c" 3 4
 )
# 239 "project/radare2/libr/socket/socket_http.c"
                                           ;
  return 
# 240 "project/radare2/libr/socket/socket_http.c" 3 4
        ((void *)0)
# 240 "project/radare2/libr/socket/socket_http.c"
            ;
 }
 host += 3;
 port = strchr (host, ':');
...
# 263 "project/radare2/libr/socket/socket_http.c" 3 4
 fprintf(__stderrp,
# 263 "project/radare2/libr/socket/socket_http.c"
 "r_socket_http_get: Cannot create socket\n"
# 263 "project/radare2/libr/socket/socket_http.c" 3 4
 )
# 263 "project/radare2/libr/socket/socket_http.c"
                                                      ;
  free (uri);
  return 
# 265 "project/radare2/libr/socket/socket_http.c" 3 4
        ((void *)0)
# 265 "project/radare2/libr/socket/socket_http.c"
            ;
 }
 if (
# 267 "project/radare2/libr/socket/socket_http.c" 3 4
    r_socket_connect (
# 267 "project/radare2/libr/socket/socket_http.c"
    s
# 267 "project/radare2/libr/socket/socket_http.c" 3 4
    , 
# 267 "project/radare2/libr/socket/socket_http.c"
...
# 267 "project/radare2/libr/socket/socket_http.c"
  ...
  r_socket_printf (s,
    "GET /%s HTTP/1.1\r\n"
    "User-Agent: radare2 "
# 270 "project/radare2/libr/socket/socket_http.c" 3 4
                         "5.5.4"
# 270 "project/radare2/libr/socket/socket_http.c"
                                   "\r\n"
    "Accept: */*\r\n"
    "Host: %s:%s\r\n"
    "\r\n", path, host, port);
...
# 276 "project/radare2/libr/socket/socket_http.c" 3 4
 fprintf(__stderrp,
# 276 "project/radare2/libr/socket/socket_http.c"
...
# 276 "project/radare2/libr/socket/socket_http.c"
                                                  ;
  response = 
# 277 "project/radare2/libr/socket/socket_http.c" 3 4
            ((void *)0)
# 277 "project/radare2/libr/socket/socket_http.c"
                ;
 }
 free (uri);
 r_socket_free (s);
...
# 285 "project/radare2/libr/socket/socket_http.c" 3 4
__attribute__((visibility("default"))) 
# 285 "project/radare2/libr/socket/socket_http.c"
     char *r_socket_http_get(const char *url, int *code, int *rlen) {
 return socket_http_get_recursive (url, code, rlen, 5);
}


# 289 "project/radare2/libr/socket/socket_http.c" 3 4
__attribute__((visibility("default"))) 
# 289 "project/radare2/libr/socket/socket_http.c"
     char *r_socket_http_post(const char *url, const char *data, int *code, int *rlen) {
 RSocket *s;
 
# 291 "project/radare2/libr/socket/socket_http.c" 3 4
_Bool 
# 291 "project/radare2/libr/socket/socket_http.c"
     ssl = r_str_startswith (url, "https://");
 char *uri = strdup (url);
 if (!uri) {
  return 
# 294 "project/radare2/libr/socket/socket_http.c" 3 4
        ((void *)0)
# 294 "project/radare2/libr/socket/socket_http.c"
            ;
 }
 ...
 if (!host) {
  ...
  printf ("Invalid URI");
  return 
# 301 "project/radare2/libr/socket/socket_http.c" 3 4
        ((void *)0)
# 301 "project/radare2/libr/socket/socket_http.c"
            ;
 }
 host += 3;
 ...
 if (!s) {
  ...
  free (uri);
  return 
# 320 "project/radare2/libr/socket/socket_http.c" 3 4
        ((void *)0)
# 320 "project/radare2/libr/socket/socket_http.c"
            ;
 }
 if (!
# 322 "project/radare2/libr/socket/socket_http.c" 3 4
     r_socket_connect (
# 322 "project/radare2/libr/socket/socket_http.c"
     s
# 322 "project/radare2/libr/socket/socket_http.c" 3 4
     , 
# 322 "project/radare2/libr/socket/socket_http.c"
...
# 323 "project/radare2/libr/socket/socket_http.c" 3 4
 fprintf(__stderrp,
# 323 "project/radare2/libr/socket/socket_http.c"
 "Cannot connect to %s:%s\n", host, port
# 323 "project/radare2/libr/socket/socket_http.c" 3 4
 )
# 323 "project/radare2/libr/socket/socket_http.c"
  ...
  r_socket_free (s);
  return 
# 326 "project/radare2/libr/socket/socket_http.c" 3 4
        ((void *)0)
# 326 "project/radare2/libr/socket/socket_http.c"
            ;
 }
 ...
 r_socket_printf (s,
   "POST /%s HTTP/1.0\r\n"
   "User-Agent: radare2 "
# 331 "project/radare2/libr/socket/socket_http.c" 3 4
                        "5.5.4"
# 331 "project/radare2/libr/socket/socket_http.c"
                                  "\r\n"
   "Accept: */*\r\n"
   "Host: %s\r\n"
   "Content-Length: %i\r\n"
