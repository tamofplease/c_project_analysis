# 0 "project/radare2/libr/socket/socket.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/socket/socket.c"
...
# 5 "project/radare2/libr/socket/socket.c" 2
...
# 7 "project/radare2/libr/socket/socket.c" 2
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/errno.h" 1 3 4
# 8 "project/radare2/libr/socket/socket.c" 2
# 16 "project/radare2/libr/socket/socket.c"
...
# 21 "project/radare2/libr/socket/socket.c"
r_socket_version
# 21 "project/radare2/libr/socket/socket.c" 3 4
(void) { return "" "5.5.4"; }
# 21 "project/radare2/libr/socket/socket.c"
                      ;
# 97 "project/radare2/libr/socket/socket.c"

# 97 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 97 "project/radare2/libr/socket/socket.c"
          r_socket_is_connected(RSocket *s) {
# 109 "project/radare2/libr/socket/socket.c"
 int error = 0;
 socklen_t len = sizeof (error);
 int ret = getsockopt (s->fd, 
# 111 "project/radare2/libr/socket/socket.c" 3 4
                             0xffff
# 111 "project/radare2/libr/socket/socket.c"
                                       , 
# 111 "project/radare2/libr/socket/socket.c" 3 4
                                         0x1007
# 111 "project/radare2/libr/socket/socket.c"
 ...
 if (ret != 0) {
  perror ("getsockopt");
  return 
# 114 "project/radare2/libr/socket/socket.c" 3 4
        0
# 114 "project/radare2/libr/socket/socket.c"
             ;
 }
 return (error == 0);
...
static 
# 121 "project/radare2/libr/socket/socket.c" 3 4
      _Bool 
# 121 "project/radare2/libr/socket/socket.c"
           __connect_unix(RSocket *s, const char *file) {
 struct sockaddr_un addr;
 int sock = socket (
# 123 "project/radare2/libr/socket/socket.c" 3 4
                   1
# 123 "project/radare2/libr/socket/socket.c"
                          , 
# 123 "project/radare2/libr/socket/socket.c" 3 4
                            1
# 123 "project/radare2/libr/socket/socket.c"
 ...
 if (sock < 0) {
  return 
# 125 "project/radare2/libr/socket/socket.c" 3 4
        0
# 125 "project/radare2/libr/socket/socket.c"
             ;
 }

 addr.sun_family = 
# 128 "project/radare2/libr/socket/socket.c" 3 4
                  1
# 128 "project/radare2/libr/socket/socket.c"
                         ;
 
# 129 "project/radare2/libr/socket/socket.c" 3 4
__builtin___strncpy_chk (
# 129 "project/radare2/libr/socket/socket.c"
addr.sun_path
# 129 "project/radare2/libr/socket/socket.c" 3 4
, 
# 129 "project/radare2/libr/socket/socket.c"
file, sizeof (addr.sun_path) - 1
# 129 "project/radare2/libr/socket/socket.c" 3 4
...
# 129 "project/radare2/libr/socket/socket.c"
 ...
 if (connect (sock, (struct sockaddr *)&addr, sizeof (addr)) == -1) {
  close (sock);
  return 
# 133 "project/radare2/libr/socket/socket.c" 3 4
        0
# 133 "project/radare2/libr/socket/socket.c"
             ;
 }
 s->fd = sock;
 s->is_ssl = 
# 136 "project/radare2/libr/socket/socket.c" 3 4
            0
# 136 "project/radare2/libr/socket/socket.c"
                 ;
 return 
# 137 "project/radare2/libr/socket/socket.c" 3 4
       1
# 137 "project/radare2/libr/socket/socket.c"
           ;
}

static 
# 140 "project/radare2/libr/socket/socket.c" 3 4
      _Bool 
# 140 "project/radare2/libr/socket/socket.c"
           __listen_unix(RSocket *s, const char *file) {
 struct sockaddr_un unix_name;
 int sock = socket (
# 142 "project/radare2/libr/socket/socket.c" 3 4
                   1
# 142 "project/radare2/libr/socket/socket.c"
                          , 
# 142 "project/radare2/libr/socket/socket.c" 3 4
                            1
# 142 "project/radare2/libr/socket/socket.c"
 ...
 if (sock < 0) {
  return 
# 144 "project/radare2/libr/socket/socket.c" 3 4
        0
# 144 "project/radare2/libr/socket/socket.c"
             ;
 }

 unix_name.sun_family = 
# 147 "project/radare2/libr/socket/socket.c" 3 4
                       1
# 147 "project/radare2/libr/socket/socket.c"
                              ;
 
# 148 "project/radare2/libr/socket/socket.c" 3 4
__builtin___strncpy_chk (
# 148 "project/radare2/libr/socket/socket.c"
unix_name.sun_path
# 148 "project/radare2/libr/socket/socket.c" 3 4
, 
# 148 "project/radare2/libr/socket/socket.c"
file, sizeof (unix_name.sun_path)-1
# 148 "project/radare2/libr/socket/socket.c" 3 4
, __builtin_object_size (
# 148 "project/radare2/libr/socket/socket.c"
unix_name.sun_path
...
# 148 "project/radare2/libr/socket/socket.c"
 ...
 if (bind (sock, (struct sockaddr *) &unix_name, sizeof (unix_name)) < 0) {
  close (sock);
  return 
# 155 "project/radare2/libr/socket/socket.c" 3 4
        0
# 155 "project/radare2/libr/socket/socket.c"
             ;
 }
 r_sys_signal (
# 157 "project/radare2/libr/socket/socket.c" 3 4
              13
# 157 "project/radare2/libr/socket/socket.c"
                     , 
# 157 "project/radare2/libr/socket/socket.c" 3 4
                       (void (*)(int))1
# 157 "project/radare2/libr/socket/socket.c"
 ...
 if (chmod (unix_name.sun_path, 0777) != 0) {
  close (sock);
  return 
# 162 "project/radare2/libr/socket/socket.c" 3 4
        0
# 162 "project/radare2/libr/socket/socket.c"
             ;
 }
 if (listen (sock, 1)) {
  close (sock);
  return 
# 166 "project/radare2/libr/socket/socket.c" 3 4
        0
# 166 "project/radare2/libr/socket/socket.c"
             ;
 }
 s->fd = sock;
 return 
# 169 "project/radare2/libr/socket/socket.c" 3 4
       1
# 169 "project/radare2/libr/socket/socket.c"
           ;
}



# 173 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) 
# 173 "project/radare2/libr/socket/socket.c"
     RSocket *r_socket_new(
# 173 "project/radare2/libr/socket/socket.c" 3 4
                           _Bool 
# 173 "project/radare2/libr/socket/socket.c"
                                is_ssl) {
 RSocket *s = 
# 174 "project/radare2/libr/socket/socket.c" 3 4
             (
# 174 "project/radare2/libr/socket/socket.c"
             RSocket
# 174 "project/radare2/libr/socket/socket.c" 3 4
             *)calloc(1,sizeof(
# 174 "project/radare2/libr/socket/socket.c"
...
# 174 "project/radare2/libr/socket/socket.c"
 ...
 if (!s) {
  return 
# 176 "project/radare2/libr/socket/socket.c" 3 4
        ((void *)0)
# 176 "project/radare2/libr/socket/socket.c"
            ;
 }
 s->is_ssl = is_ssl;
 s->port = 0;
 ...
 s->local = 0;
 s->fd = 
# 184 "project/radare2/libr/socket/socket.c" 3 4
        -1
# 184 "project/radare2/libr/socket/socket.c"
                        ;
# 199 "project/radare2/libr/socket/socket.c"
 return s;
}


# 202 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 202 "project/radare2/libr/socket/socket.c"
          r_socket_spawn(RSocket *s, const char *cmd, unsigned int timeout) {

 const int port = 2000 + r_num_rand (2000);
 int childPid = r_sys_fork ();
 if (childPid == 0) {
  char *a = r_str_replace (strdup (cmd), "\\", "\\\\", 
# 207 "project/radare2/libr/socket/socket.c" 3 4
                                                      1
# 207 "project/radare2/libr/socket/socket.c"
                                                          );
  int res = r_sys_cmdf ("rarun2 system=\"%s\" listen=%d", a, port);
  free (a);
# 220 "project/radare2/libr/socket/socket.c"
  if (res != 0) {
   
# 221 "project/radare2/libr/socket/socket.c" 3 4
  fprintf(__stderrp,
# 221 "project/radare2/libr/socket/socket.c"
...
# 224 "project/radare2/libr/socket/socket.c" 3 4
 fprintf(__stderrp,
# 224 "project/radare2/libr/socket/socket.c"
 "r_socket_spawn: %s is dead\n", cmd
# 224 "project/radare2/libr/socket/socket.c" 3 4
 )
# 224 "project/radare2/libr/socket/socket.c"
                                              ;
...
# 231 "project/radare2/libr/socket/socket.c" 3 4
__builtin___sprintf_chk (
# 231 "project/radare2/libr/socket/socket.c"
aport
# 231 "project/radare2/libr/socket/socket.c" 3 4
...
# 233 "project/radare2/libr/socket/socket.c" 3 4
_Bool 
# 233 "project/radare2/libr/socket/socket.c"
     sock = r_socket_connect (s, "127.0.0.1", aport, 
# 233 "project/radare2/libr/socket/socket.c" 3 4
                                                     6
# 233 "project/radare2/libr/socket/socket.c"
                                                                       , 2000);
 if (!sock) {
  return 
# 235 "project/radare2/libr/socket/socket.c" 3 4
        0
# 235 "project/radare2/libr/socket/socket.c"
             ;
 }
 ...
 int status = 0;
 int ret = waitpid (childPid, &status, 
# 242 "project/radare2/libr/socket/socket.c" 3 4
                                      0x00000001
# 242 "project/radare2/libr/socket/socket.c"
                                             );
 if (ret != 0) {
  r_socket_close (s);
  return 
# 245 "project/radare2/libr/socket/socket.c" 3 4
        0
# 245 "project/radare2/libr/socket/socket.c"
             ;
 }

 return 
# 248 "project/radare2/libr/socket/socket.c" 3 4
       1
# 248 "project/radare2/libr/socket/socket.c"
           ;
}


# 251 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 251 "project/radare2/libr/socket/socket.c"
          r_socket_connect(RSocket *s, const char *host, const char *port, int proto, unsigned int timeout) {
 
# 252 "project/radare2/libr/socket/socket.c" 3 4
do { if (!(
# 252 "project/radare2/libr/socket/socket.c"
s
# 252 "project/radare2/libr/socket/socket.c" 3 4
...
# 252 "project/radare2/libr/socket/socket.c"
                               ;
# 262 "project/radare2/libr/socket/socket.c"
 int ret;
 struct addrinfo hints = { 0 };
 struct addrinfo *res, *rp;
 if (proto == 
# 265 "project/radare2/libr/socket/socket.c" 3 4
             0
# 265 "project/radare2/libr/socket/socket.c"
                                ) {
  proto = 
# 266 "project/radare2/libr/socket/socket.c" 3 4
         6
# 266 "project/radare2/libr/socket/socket.c"
                               ;
 }

 r_sys_signal (
# 269 "project/radare2/libr/socket/socket.c" 3 4
              13
# 269 "project/radare2/libr/socket/socket.c"
                     , 
# 269 "project/radare2/libr/socket/socket.c" 3 4
                       (void (*)(int))1
# 269 "project/radare2/libr/socket/socket.c"
 ...
 if (proto == 
# 271 "project/radare2/libr/socket/socket.c" 3 4
             0x1337
# 271 "project/radare2/libr/socket/socket.c"
                                ) {

  if (!__connect_unix (s, host)) {
   return 
# 274 "project/radare2/libr/socket/socket.c" 3 4
         0
# 274 "project/radare2/libr/socket/socket.c"
              ;
  }

 } else if (proto == 
# 277 "project/radare2/libr/socket/socket.c" 3 4
                    0xc42b05
# 277 "project/radare2/libr/socket/socket.c"
                                      ) {
# 337 "project/radare2/libr/socket/socket.c"
  
# 337 "project/radare2/libr/socket/socket.c" 3 4
 fprintf(__stderrp,
# 337 "project/radare2/libr/socket/socket.c"
 "Unsupported ISOTP socket protocol\n"
# 337 "project/radare2/libr/socket/socket.c" 3 4
 )
# 337 "project/radare2/libr/socket/socket.c"
                                                ;
  return 
# 338 "project/radare2/libr/socket/socket.c" 3 4
        0
# 338 "project/radare2/libr/socket/socket.c"
             ;

 } else {
  hints.ai_family = 
# 341 "project/radare2/libr/socket/socket.c" 3 4
                   0
# 341 "project/radare2/libr/socket/socket.c"
                            ;
  hints.ai_protocol = proto;
  int gai = getaddrinfo (host, port, &hints, &res);
  if (gai != 0) {
   
# 345 "project/radare2/libr/socket/socket.c" 3 4
  fprintf(__stderrp,
# 345 "project/radare2/libr/socket/socket.c"
  "r_socket_connect: Error in getaddrinfo: %s (%s:%s)\n", gai_strerror (gai), host, port
# 345 "project/radare2/libr/socket/socket.c" 3 4
  )
                                   
# 346 "project/radare2/libr/socket/socket.c"
                                  ;
   return 
# 347 "project/radare2/libr/socket/socket.c" 3 4
         0
# 347 "project/radare2/libr/socket/socket.c"
              ;
  }
  for (rp = res; rp; rp = rp->ai_next) {
   ...
   switch (proto) {
   case 
# 359 "project/radare2/libr/socket/socket.c" 3 4
       6
# 359 "project/radare2/libr/socket/socket.c"
                         :
    ret = setsockopt (s->fd, 
# 360 "project/radare2/libr/socket/socket.c" 3 4
                            6
# 360 "project/radare2/libr/socket/socket.c"
                                       , 
# 360 "project/radare2/libr/socket/socket.c" 3 4
                                         0x01
# 360 "project/radare2/libr/socket/socket.c"
    ...
    r_socket_block_time (s, 
# 367 "project/radare2/libr/socket/socket.c" 3 4
                           1
# 367 "project/radare2/libr/socket/socket.c"
                               , 1, 0);
    ret = connect (s->fd, rp->ai_addr, rp->ai_addrlen);
    break;
   case 
# 370 "project/radare2/libr/socket/socket.c" 3 4
       17
# 370 "project/radare2/libr/socket/socket.c"
                         :
    
# 371 "project/radare2/libr/socket/socket.c" 3 4
   __builtin___memset_chk (
# 371 "project/radare2/libr/socket/socket.c"
   &s->sa
# 371 "project/radare2/libr/socket/socket.c" 3 4
   , 
# 371 "project/radare2/libr/socket/socket.c"
...
# 371 "project/radare2/libr/socket/socket.c"
                                     ;
    s->sa.sin_family = 
# 372 "project/radare2/libr/socket/socket.c" 3 4
                      2
# 372 "project/radare2/libr/socket/socket.c"
                             ;
    s->sa.sin_addr.s_addr = 
# 373 "project/radare2/libr/socket/socket.c" 3 4
                           (__builtin_constant_p(
# 373 "project/radare2/libr/socket/socket.c"
                           s->local? 
# 373 "project/radare2/libr/socket/socket.c" 3 4
...
# 373 "project/radare2/libr/socket/socket.c"
                           : 
# 373 "project/radare2/libr/socket/socket.c" 3 4
                           (u_int32_t)0x00000000) ? ((__uint32_t)((((__uint32_t)(
# 373 "project/radare2/libr/socket/socket.c"
                           s->local? 
# 373 "project/radare2/libr/socket/socket.c" 3 4
                           (u_int32_t)0x7f000001
# 373 "project/radare2/libr/socket/socket.c"
                           : 
# 373 "project/radare2/libr/socket/socket.c" 3 4
                           (u_int32_t)0x00000000) & 0xff000000U) >> 24) | (((__uint32_t)(
# 373 "project/radare2/libr/socket/socket.c"
                           s->local? 
# 373 "project/radare2/libr/socket/socket.c" 3 4
                           (u_int32_t)0x7f000001
# 373 "project/radare2/libr/socket/socket.c"
                           : 
# 373 "project/radare2/libr/socket/socket.c" 3 4
                           (u_int32_t)0x00000000) & 0x00ff0000U) >> 8) | (((__uint32_t)(
# 373 "project/radare2/libr/socket/socket.c"
                           s->local? 
# 373 "project/radare2/libr/socket/socket.c" 3 4
                           (u_int32_t)0x7f000001
# 373 "project/radare2/libr/socket/socket.c"
                           : 
# 373 "project/radare2/libr/socket/socket.c" 3 4
                           (u_int32_t)0x00000000) & 0x0000ff00U) << 8) | (((__uint32_t)(
# 373 "project/radare2/libr/socket/socket.c"
                           s->local? 
# 373 "project/radare2/libr/socket/socket.c" 3 4
                           (u_int32_t)0x7f000001
# 373 "project/radare2/libr/socket/socket.c"
                           : 
# 373 "project/radare2/libr/socket/socket.c" 3 4
                           (u_int32_t)0x00000000) & 0x000000ffU) << 24))) : _OSSwapInt32(
# 373 "project/radare2/libr/socket/socket.c"
                           s->local? 
# 373 "project/radare2/libr/socket/socket.c" 3 4
                           (u_int32_t)0x7f000001
...
# 373 "project/radare2/libr/socket/socket.c"
    ...
    s->sa.sin_port = 
# 378 "project/radare2/libr/socket/socket.c" 3 4
                    ((__uint16_t)(__builtin_constant_p(
# 378 "project/radare2/libr/socket/socket.c"
                    s->port
# 378 "project/radare2/libr/socket/socket.c" 3 4
...
# 380 "project/radare2/libr/socket/socket.c" 3 4
    r_sys_perror_str(
# 380 "project/radare2/libr/socket/socket.c"
    "bind"
# 380 "project/radare2/libr/socket/socket.c" 3 4
    );
# 380 "project/radare2/libr/socket/socket.c"
   ...
   default:
    r_socket_block_time (s, 
# 391 "project/radare2/libr/socket/socket.c" 3 4
                           1
# 391 "project/radare2/libr/socket/socket.c"
                               , 1, 0);
    ret = connect (s->fd, rp->ai_addr, rp->ai_addrlen);
    break;
   }
   ...
   if (ret == 0) {
    freeaddrinfo (res);
    return 
# 398 "project/radare2/libr/socket/socket.c" 3 4
          1
# 398 "project/radare2/libr/socket/socket.c"
              ;
   }
   if (
# 400 "project/radare2/libr/socket/socket.c" 3 4
      (*__error()) 
# 400 "project/radare2/libr/socket/socket.c"
            == 
# 400 "project/radare2/libr/socket/socket.c" 3 4
               36
# 400 "project/radare2/libr/socket/socket.c"
...
# 403 "project/radare2/libr/socket/socket.c" 3 4
   __builtin_bzero(
# 403 "project/radare2/libr/socket/socket.c"
   &wfds
# 403 "project/radare2/libr/socket/socket.c" 3 4
   , sizeof(*(
# 403 "project/radare2/libr/socket/socket.c"
...
# 404 "project/radare2/libr/socket/socket.c" 3 4
   __darwin_fd_set((
# 404 "project/radare2/libr/socket/socket.c"
   s->fd
# 404 "project/radare2/libr/socket/socket.c" 3 4
   ), (
# 404 "project/radare2/libr/socket/socket.c"
...
# 404 "project/radare2/libr/socket/socket.c"
    ...
    if ((ret = select (s->fd + 1, 
# 406 "project/radare2/libr/socket/socket.c" 3 4
                                 ((void *)0)
# 406 "project/radare2/libr/socket/socket.c"
                                     , &wfds, 
# 406 "project/radare2/libr/socket/socket.c" 3 4
                                              ((void *)0)
# 406 "project/radare2/libr/socket/socket.c"
...
# 419 "project/radare2/libr/socket/socket.c" 3 4
  fprintf(__stderrp,
# 419 "project/radare2/libr/socket/socket.c"
...
# 419 "project/radare2/libr/socket/socket.c"
                                                                         ;
   return 
# 420 "project/radare2/libr/socket/socket.c" 3 4
         0
# 420 "project/radare2/libr/socket/socket.c"
              ;
  }
 }
success:
# 463 "project/radare2/libr/socket/socket.c"
 return 
# 463 "project/radare2/libr/socket/socket.c" 3 4
       1
# 463 "project/radare2/libr/socket/socket.c"
           ;
}
...
# 467 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) 
# 467 "project/radare2/libr/socket/socket.c"
     int r_socket_close_fd(RSocket *s) {



 return s->fd != -1 ? close (s->fd) : 
# 471 "project/radare2/libr/socket/socket.c" 3 4
                                     0
# 471 "project/radare2/libr/socket/socket.c"
                                          ;
...
# 476 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) 
# 476 "project/radare2/libr/socket/socket.c"
     int r_socket_close(RSocket *s) {
 int ret = 
# 477 "project/radare2/libr/socket/socket.c" 3 4
          0
# 477 "project/radare2/libr/socket/socket.c"
               ;
 if (!s) {
  return 
# 479 "project/radare2/libr/socket/socket.c" 3 4
        0
# 479 "project/radare2/libr/socket/socket.c"
             ;
 }
 if (s->fd != 
# 481 "project/radare2/libr/socket/socket.c" 3 4
             -1
# 481 "project/radare2/libr/socket/socket.c"
                             ) {

  shutdown (s->fd, 
# 483 "project/radare2/libr/socket/socket.c" 3 4
                  2
# 483 "project/radare2/libr/socket/socket.c"
                           );
# 496 "project/radare2/libr/socket/socket.c"
  ret = close (s->fd);

  s->fd = 
# 498 "project/radare2/libr/socket/socket.c" 3 4
         -1
# 498 "project/radare2/libr/socket/socket.c"
                         ;
 }
...
# 510 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) 
# 510 "project/radare2/libr/socket/socket.c"
     int r_socket_free(RSocket *s) {
 int res = r_socket_close (s);
# 522 "project/radare2/libr/socket/socket.c"
 free (s);
 return res;
}


# 526 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) 
# 526 "project/radare2/libr/socket/socket.c"
     int r_socket_port_by_name(const char *name) {
 struct servent *p = getservbyname (name, "tcp");
 return (p && p->s_port) ? 
# 528 "project/radare2/libr/socket/socket.c" 3 4
                          ((__uint16_t)(__builtin_constant_p(
# 528 "project/radare2/libr/socket/socket.c"
                          p->s_port
# 528 "project/radare2/libr/socket/socket.c" 3 4
                          ) ? ((__uint16_t)((((__uint16_t)(
# 528 "project/radare2/libr/socket/socket.c"
...
# 531 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 531 "project/radare2/libr/socket/socket.c"
          r_socket_listen(RSocket *s, const char *port, const char *certfile) {
 int optval = 1;
 int ret;
 struct linger linger = { 0 };

 if (s->proto == 
# 536 "project/radare2/libr/socket/socket.c" 3 4
                0x1337
# 536 "project/radare2/libr/socket/socket.c"
                                   ) {

  return __listen_unix (s, port);

  return 
# 540 "project/radare2/libr/socket/socket.c" 3 4
        0
# 540 "project/radare2/libr/socket/socket.c"
             ;
 }

 if (r_sandbox_enable (0)) {
  return 
# 544 "project/radare2/libr/socket/socket.c" 3 4
        0
# 544 "project/radare2/libr/socket/socket.c"
             ;
 }
 ...
 if (s->proto == 
# 553 "project/radare2/libr/socket/socket.c" 3 4
                0
# 553 "project/radare2/libr/socket/socket.c"
                                   ) {
  s->proto = 
# 554 "project/radare2/libr/socket/socket.c" 3 4
            6
# 554 "project/radare2/libr/socket/socket.c"
                                  ;
 }
 switch (s->proto) {
 case 
# 557 "project/radare2/libr/socket/socket.c" 3 4
     6
# 557 "project/radare2/libr/socket/socket.c"
                       :
  if ((s->fd = socket (
# 558 "project/radare2/libr/socket/socket.c" 3 4
                      2
# 558 "project/radare2/libr/socket/socket.c"
                             , 
# 558 "project/radare2/libr/socket/socket.c" 3 4
                               1
# 558 "project/radare2/libr/socket/socket.c"
...
# 558 "project/radare2/libr/socket/socket.c"
   ...
   return 
# 559 "project/radare2/libr/socket/socket.c" 3 4
         0
# 559 "project/radare2/libr/socket/socket.c"
              ;
  }
  break;
 case 
# 562 "project/radare2/libr/socket/socket.c" 3 4
     17
# 562 "project/radare2/libr/socket/socket.c"
                       :
  if ((s->fd = socket (
# 563 "project/radare2/libr/socket/socket.c" 3 4
                      2
# 563 "project/radare2/libr/socket/socket.c"
                             , 
# 563 "project/radare2/libr/socket/socket.c" 3 4
                               2
# 563 "project/radare2/libr/socket/socket.c"
...
# 563 "project/radare2/libr/socket/socket.c"
   ...
   return 
# 564 "project/radare2/libr/socket/socket.c" 3 4
         0
# 564 "project/radare2/libr/socket/socket.c"
              ;
  }
  break;
 default:
  
# 568 "project/radare2/libr/socket/socket.c" 3 4
 fprintf(__stderrp,
# 568 "project/radare2/libr/socket/socket.c"
...
# 568 "project/radare2/libr/socket/socket.c"
                                          ;
  return 
# 569 "project/radare2/libr/socket/socket.c" 3 4
        0
# 569 "project/radare2/libr/socket/socket.c"
             ;
 }
 ...
 linger.l_linger = 1;
 ret = setsockopt (s->fd, 
# 574 "project/radare2/libr/socket/socket.c" 3 4
                         0xffff
# 574 "project/radare2/libr/socket/socket.c"
                                   , 
# 574 "project/radare2/libr/socket/socket.c" 3 4
                                     0x0080
# 574 "project/radare2/libr/socket/socket.c"
 ...
 if (ret < 0) {
  return 
# 576 "project/radare2/libr/socket/socket.c" 3 4
        0
# 576 "project/radare2/libr/socket/socket.c"
             ;
 }
 {
 int x = 1500;
 ret = setsockopt (s->fd, 
# 580 "project/radare2/libr/socket/socket.c" 3 4
                         0xffff
# 580 "project/radare2/libr/socket/socket.c"
                                   , 
# 580 "project/radare2/libr/socket/socket.c" 3 4
                                     0x1001
# 580 "project/radare2/libr/socket/socket.c"
 ...
 if (ret < 0) {
  return 
# 582 "project/radare2/libr/socket/socket.c" 3 4
        0
# 582 "project/radare2/libr/socket/socket.c"
             ;
 }
 }
 ret = setsockopt (s->fd, 
# 585 "project/radare2/libr/socket/socket.c" 3 4
                         0xffff
# 585 "project/radare2/libr/socket/socket.c"
                                   , 
# 585 "project/radare2/libr/socket/socket.c" 3 4
                                     0x0004
# 585 "project/radare2/libr/socket/socket.c"
 ...
 if (ret < 0) {
  return 
# 587 "project/radare2/libr/socket/socket.c" 3 4
        0
# 587 "project/radare2/libr/socket/socket.c"
             ;
 }

 
# 590 "project/radare2/libr/socket/socket.c" 3 4
__builtin___memset_chk (
# 590 "project/radare2/libr/socket/socket.c"
&s->sa
# 590 "project/radare2/libr/socket/socket.c" 3 4
, 
# 590 "project/radare2/libr/socket/socket.c"
...
# 590 "project/radare2/libr/socket/socket.c"
                                  ;
 s->sa.sin_family = 
# 591 "project/radare2/libr/socket/socket.c" 3 4
                   2
# 591 "project/radare2/libr/socket/socket.c"
                          ;
 s->sa.sin_addr.s_addr = 
# 592 "project/radare2/libr/socket/socket.c" 3 4
                        (__builtin_constant_p(
# 592 "project/radare2/libr/socket/socket.c"
                        s->local? 
# 592 "project/radare2/libr/socket/socket.c" 3 4
                        (u_int32_t)0x7f000001
# 592 "project/radare2/libr/socket/socket.c"
...
# 592 "project/radare2/libr/socket/socket.c"
 ...
 if (s->port < 1) {
  return 
# 595 "project/radare2/libr/socket/socket.c" 3 4
        0
# 595 "project/radare2/libr/socket/socket.c"
             ;
 }
 s->sa.sin_port = 
# 597 "project/radare2/libr/socket/socket.c" 3 4
                 ((__uint16_t)(__builtin_constant_p(
# 597 "project/radare2/libr/socket/socket.c"
                 s->port
# 597 "project/radare2/libr/socket/socket.c" 3 4
                 ) ? ((__uint16_t)((((__uint16_t)(
# 597 "project/radare2/libr/socket/socket.c"
...
# 599 "project/radare2/libr/socket/socket.c" 3 4
 r_sys_perror_str(
# 599 "project/radare2/libr/socket/socket.c"
 "bind"
# 599 "project/radare2/libr/socket/socket.c" 3 4
 );
# 599 "project/radare2/libr/socket/socket.c"
  ...
  return 
# 605 "project/radare2/libr/socket/socket.c" 3 4
        0
# 605 "project/radare2/libr/socket/socket.c"
             ;
 }

 r_sys_signal (
# 608 "project/radare2/libr/socket/socket.c" 3 4
              13
# 608 "project/radare2/libr/socket/socket.c"
                     , 
# 608 "project/radare2/libr/socket/socket.c" 3 4
                       (void (*)(int))1
# 608 "project/radare2/libr/socket/socket.c"
 ...
 if (s->proto == 
# 610 "project/radare2/libr/socket/socket.c" 3 4
                6
# 610 "project/radare2/libr/socket/socket.c"
                                  ) {
  if (listen (s->fd, 32) < 0) {
   
# 612 "project/radare2/libr/socket/socket.c" 3 4
  r_sys_perror_str(
# 612 "project/radare2/libr/socket/socket.c"
  "listen"
# 612 "project/radare2/libr/socket/socket.c" 3 4
  );
# 612 "project/radare2/libr/socket/socket.c"
   ...
   return 
# 618 "project/radare2/libr/socket/socket.c" 3 4
         0
# 618 "project/radare2/libr/socket/socket.c"
              ;
  }
 }
# 639 "project/radare2/libr/socket/socket.c"
 return 
# 639 "project/radare2/libr/socket/socket.c" 3 4
       1
# 639 "project/radare2/libr/socket/socket.c"
           ;
}
...
# 642 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) 
# 642 "project/radare2/libr/socket/socket.c"
     RSocket *r_socket_accept(RSocket *s) {
 RSocket *sock;
 socklen_t salen = sizeof (s->sa);
 if (!s) {
  return 
# 646 "project/radare2/libr/socket/socket.c" 3 4
        ((void *)0)
# 646 "project/radare2/libr/socket/socket.c"
            ;
 }
 sock = 
# 648 "project/radare2/libr/socket/socket.c" 3 4
       (
# 648 "project/radare2/libr/socket/socket.c"
       RSocket
# 648 "project/radare2/libr/socket/socket.c" 3 4
       *)calloc(1,sizeof(
# 648 "project/radare2/libr/socket/socket.c"
...
# 648 "project/radare2/libr/socket/socket.c"
 ...
 if (!sock) {
  return 
# 650 "project/radare2/libr/socket/socket.c" 3 4
        ((void *)0)
# 650 "project/radare2/libr/socket/socket.c"
            ;
 }

 sock->fd = accept (s->fd, (struct sockaddr *)&s->sa, &salen);
 if (sock->fd == 
# 654 "project/radare2/libr/socket/socket.c" 3 4
                -1
# 654 "project/radare2/libr/socket/socket.c"
                                ) {
  if (
# 655 "project/radare2/libr/socket/socket.c" 3 4
     (*__error()) 
# 655 "project/radare2/libr/socket/socket.c"
           != 
# 655 "project/radare2/libr/socket/socket.c" 3 4
              35
# 655 "project/radare2/libr/socket/socket.c"
...
# 657 "project/radare2/libr/socket/socket.c" 3 4
  r_sys_perror_str(
# 657 "project/radare2/libr/socket/socket.c"
  "accept"
# 657 "project/radare2/libr/socket/socket.c" 3 4
  );
# 657 "project/radare2/libr/socket/socket.c"
  ...
  free (sock);
  return 
# 660 "project/radare2/libr/socket/socket.c" 3 4
        ((void *)0)
# 660 "project/radare2/libr/socket/socket.c"
            ;
 }
# 681 "project/radare2/libr/socket/socket.c"
 sock->is_ssl = 0;
...
# 686 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) 
# 686 "project/radare2/libr/socket/socket.c"
     RSocket *r_socket_accept_timeout(RSocket *s, unsigned int timeout) {
 fd_set read_fds;
 fd_set except_fds;

 
# 690 "project/radare2/libr/socket/socket.c" 3 4
__builtin_bzero(
# 690 "project/radare2/libr/socket/socket.c"
&read_fds
# 690 "project/radare2/libr/socket/socket.c" 3 4
, sizeof(*(
# 690 "project/radare2/libr/socket/socket.c"
...
# 691 "project/radare2/libr/socket/socket.c" 3 4
__darwin_fd_set((
# 691 "project/radare2/libr/socket/socket.c"
s->fd
# 691 "project/radare2/libr/socket/socket.c" 3 4
), (
# 691 "project/radare2/libr/socket/socket.c"
...
# 693 "project/radare2/libr/socket/socket.c" 3 4
__builtin_bzero(
# 693 "project/radare2/libr/socket/socket.c"
&except_fds
# 693 "project/radare2/libr/socket/socket.c" 3 4
, sizeof(*(
# 693 "project/radare2/libr/socket/socket.c"
...
# 694 "project/radare2/libr/socket/socket.c" 3 4
__darwin_fd_set((
# 694 "project/radare2/libr/socket/socket.c"
s->fd
# 694 "project/radare2/libr/socket/socket.c" 3 4
), (
# 694 "project/radare2/libr/socket/socket.c"
...
# 694 "project/radare2/libr/socket/socket.c"
 ...
 int r = select (s->fd + 1, &read_fds, 
# 698 "project/radare2/libr/socket/socket.c" 3 4
                                      ((void *)0)
# 698 "project/radare2/libr/socket/socket.c"
                                          , &except_fds, &t);
 if(r < 0) {
  perror ("select");
 } else if (r > 0 && 
# 701 "project/radare2/libr/socket/socket.c" 3 4
                    __darwin_fd_isset((
# 701 "project/radare2/libr/socket/socket.c"
                    s->fd
# 701 "project/radare2/libr/socket/socket.c" 3 4
                    ), (
# 701 "project/radare2/libr/socket/socket.c"
...
# 701 "project/radare2/libr/socket/socket.c"
 ...
 return 
# 705 "project/radare2/libr/socket/socket.c" 3 4
       ((void *)0)
# 705 "project/radare2/libr/socket/socket.c"
           ;
}



# 709 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 709 "project/radare2/libr/socket/socket.c"
          r_socket_block_time(RSocket *s, 
# 709 "project/radare2/libr/socket/socket.c" 3 4
                                          _Bool 
# 709 "project/radare2/libr/socket/socket.c"
                                               block, int sec, int usec) {

 int ret, flags;

 if (!s) {
  return 
# 714 "project/radare2/libr/socket/socket.c" 3 4
        0
# 714 "project/radare2/libr/socket/socket.c"
             ;
 }

 flags = fcntl (s->fd, 
# 717 "project/radare2/libr/socket/socket.c" 3 4
                      3
# 717 "project/radare2/libr/socket/socket.c"
                             , 0);
 if (flags < 0) {
  return 
# 719 "project/radare2/libr/socket/socket.c" 3 4
        0
# 719 "project/radare2/libr/socket/socket.c"
             ;
 }
 ret = fcntl (s->fd, 
# 721 "project/radare2/libr/socket/socket.c" 3 4
                    4
# 721 "project/radare2/libr/socket/socket.c"
                           , block?
   (flags & ~
# 722 "project/radare2/libr/socket/socket.c" 3 4
            0x00000004
# 722 "project/radare2/libr/socket/socket.c"
                      ):
   (flags | 
# 723 "project/radare2/libr/socket/socket.c" 3 4
           0x00000004
# 723 "project/radare2/libr/socket/socket.c"
                     ));
 if (ret < 0) {
  return 
# 725 "project/radare2/libr/socket/socket.c" 3 4
        0
# 725 "project/radare2/libr/socket/socket.c"
             ;
 }
 ...
 if (sec > 0 || usec > 0) {
  ...
  if (setsockopt (s->fd, 
# 732 "project/radare2/libr/socket/socket.c" 3 4
                        0xffff
# 732 "project/radare2/libr/socket/socket.c"
                                  , 
# 732 "project/radare2/libr/socket/socket.c" 3 4
                                    0x1006
# 732 "project/radare2/libr/socket/socket.c"
                                               , (char *)&tv, sizeof (tv)) < 0) {
   return 
# 733 "project/radare2/libr/socket/socket.c" 3 4
         0
# 733 "project/radare2/libr/socket/socket.c"
              ;
  }
 }
 return 
# 736 "project/radare2/libr/socket/socket.c" 3 4
       1
# 736 "project/radare2/libr/socket/socket.c"
           ;
}


# 739 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) 
# 739 "project/radare2/libr/socket/socket.c"
 ...
 return 
# 745 "project/radare2/libr/socket/socket.c" 3 4
       1
# 745 "project/radare2/libr/socket/socket.c"
           ;
}
...
# 750 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) 
# 750 "project/radare2/libr/socket/socket.c"
     int r_socket_ready(RSocket *s, int secs, int usecs) {
 fd_set rfds;
 struct timeval tv = {secs, usecs};
 if (s->fd == 
# 753 "project/radare2/libr/socket/socket.c" 3 4
             -1
# 753 "project/radare2/libr/socket/socket.c"
                             ) {
  return -1;
 }
 
# 756 "project/radare2/libr/socket/socket.c" 3 4
__builtin_bzero(
# 756 "project/radare2/libr/socket/socket.c"
&rfds
# 756 "project/radare2/libr/socket/socket.c" 3 4
, sizeof(*(
# 756 "project/radare2/libr/socket/socket.c"
...
# 757 "project/radare2/libr/socket/socket.c" 3 4
__darwin_fd_set((
# 757 "project/radare2/libr/socket/socket.c"
s->fd
# 757 "project/radare2/libr/socket/socket.c" 3 4
), (
# 757 "project/radare2/libr/socket/socket.c"
...
# 757 "project/radare2/libr/socket/socket.c"
                     ;
 return select (s->fd + 1, &rfds, 
# 758 "project/radare2/libr/socket/socket.c" 3 4
                                 ((void *)0)
# 758 "project/radare2/libr/socket/socket.c"
                                     , 
# 758 "project/radare2/libr/socket/socket.c" 3 4
                                       ((void *)0)
# 758 "project/radare2/libr/socket/socket.c"
...
# 761 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) 
# 761 "project/radare2/libr/socket/socket.c"
     char *r_socket_to_string(RSocket *s) {



 char *str = 
# 765 "project/radare2/libr/socket/socket.c" 3 4
            ((void *)0)
# 765 "project/radare2/libr/socket/socket.c"
                ;
 struct sockaddr sa;
 socklen_t sl = sizeof (sa);
 
# 768 "project/radare2/libr/socket/socket.c" 3 4
__builtin___memset_chk (
# 768 "project/radare2/libr/socket/socket.c"
&sa
# 768 "project/radare2/libr/socket/socket.c" 3 4
, 
# 768 "project/radare2/libr/socket/socket.c"
...
# 771 "project/radare2/libr/socket/socket.c" 3 4
 unsigned char 
# 771 "project/radare2/libr/socket/socket.c"
     *a = (
# 771 "project/radare2/libr/socket/socket.c" 3 4
           unsigned char
# 771 "project/radare2/libr/socket/socket.c"
...
# 773 "project/radare2/libr/socket/socket.c" 3 4
  __builtin___sprintf_chk (
# 773 "project/radare2/libr/socket/socket.c"
  str
# 773 "project/radare2/libr/socket/socket.c" 3 4
  , 0, __builtin_object_size (
# 773 "project/radare2/libr/socket/socket.c"
...
# 774 "project/radare2/libr/socket/socket.c"
                                                  ;
  }
 } else {
  
# 777 "project/radare2/libr/socket/socket.c" 3 4
 fprintf(__stderrp,
# 777 "project/radare2/libr/socket/socket.c"
 "getperrname: failed\n"
# 777 "project/radare2/libr/socket/socket.c" 3 4
 )
# 777 "project/radare2/libr/socket/socket.c"
...
# 786 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) 
# 786 "project/radare2/libr/socket/socket.c"
     int r_socket_write(RSocket *s, const void *buf, int len) {
 int ret, delta = 0;

 r_sys_signal (
# 789 "project/radare2/libr/socket/socket.c" 3 4
              13
# 789 "project/radare2/libr/socket/socket.c"
                     , 
# 789 "project/radare2/libr/socket/socket.c" 3 4
                       (void (*)(int))1
# 789 "project/radare2/libr/socket/socket.c"
...
# 805 "project/radare2/libr/socket/socket.c"
  {
...
# 821 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) 
# 821 "project/radare2/libr/socket/socket.c"
     int r_socket_puts(RSocket *s, char *buf) {
 return r_socket_write (s, buf, strlen (buf));
}


# 825 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) 
# 825 "project/radare2/libr/socket/socket.c"
     void r_socket_printf(RSocket *s, const char *fmt, ...) {
 va_list ap, ap0;
 if (s->fd != 
# 827 "project/radare2/libr/socket/socket.c" 3 4
             -1
# 827 "project/radare2/libr/socket/socket.c"
                             ) {
  
# 828 "project/radare2/libr/socket/socket.c" 3 4
 __builtin_va_start(
# 828 "project/radare2/libr/socket/socket.c"
 ap
# 828 "project/radare2/libr/socket/socket.c" 3 4
 ,
# 828 "project/radare2/libr/socket/socket.c"
...
# 829 "project/radare2/libr/socket/socket.c" 3 4
 __builtin_va_copy(
# 829 "project/radare2/libr/socket/socket.c"
 ap0
# 829 "project/radare2/libr/socket/socket.c" 3 4
 ,
# 829 "project/radare2/libr/socket/socket.c"
...
# 829 "project/radare2/libr/socket/socket.c"
                  ;
  size_t len = 
# 830 "project/radare2/libr/socket/socket.c" 3 4
              __builtin___vsnprintf_chk (((void *)0), 
# 830 "project/radare2/libr/socket/socket.c"
              0
# 830 "project/radare2/libr/socket/socket.c" 3 4
...
# 833 "project/radare2/libr/socket/socket.c" 3 4
  __builtin___vsnprintf_chk (
# 833 "project/radare2/libr/socket/socket.c"
  buf
# 833 "project/radare2/libr/socket/socket.c" 3 4
  , 
# 833 "project/radare2/libr/socket/socket.c"
...
# 849 "project/radare2/libr/socket/socket.c" 3 4
 __builtin_va_end(
# 849 "project/radare2/libr/socket/socket.c"
 ap
# 849 "project/radare2/libr/socket/socket.c" 3 4
 )
# 849 "project/radare2/libr/socket/socket.c"
...
# 853 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) 
# 853 "project/radare2/libr/socket/socket.c"
     int r_socket_read(RSocket *s, unsigned char *buf, int len) {
 if (!s) {
  return -1;
 }
# 866 "project/radare2/libr/socket/socket.c"
 int r = recv (s->fd, (char *)buf, len, 0);
 if(0) { 
# 867 "project/radare2/libr/socket/socket.c" 3 4
    fprintf(__stderrp,
# 867 "project/radare2/libr/socket/socket.c"
    "READ "
# 867 "project/radare2/libr/socket/socket.c" 3 4
    )
# 867 "project/radare2/libr/socket/socket.c"
...
# 871 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) 
# 871 "project/radare2/libr/socket/socket.c"
     int r_socket_read_block(RSocket *s, 
# 871 "project/radare2/libr/socket/socket.c" 3 4
                                         unsigned char 
# 871 "project/radare2/libr/socket/socket.c"
                                             *buf, int len) {
...
# 893 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) 
# 893 "project/radare2/libr/socket/socket.c"
     int r_socket_gets(RSocket *s, char *buf, int size) {
 int i = 0;
 int ret = 0;

 if (s->fd == 
# 897 "project/radare2/libr/socket/socket.c" 3 4
             -1
# 897 "project/radare2/libr/socket/socket.c"
                             ) {
  return -1;
 }
 while (i < size) {
  ret = r_socket_read (s, (
# 901 "project/radare2/libr/socket/socket.c" 3 4
                          unsigned char 
# 901 "project/radare2/libr/socket/socket.c"
                              *)buf + i, 1);
  if (ret == 0) {
   if (i > 0) {
    return i;
...
# 922 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) 
# 922 "project/radare2/libr/socket/socket.c"
     RSocket *r_socket_new_from_fd(int fd) {
 RSocket *s = 
# 923 "project/radare2/libr/socket/socket.c" 3 4
             (
# 923 "project/radare2/libr/socket/socket.c"
             RSocket
# 923 "project/radare2/libr/socket/socket.c" 3 4
             *)calloc(1,sizeof(
# 923 "project/radare2/libr/socket/socket.c"
...
# 923 "project/radare2/libr/socket/socket.c"
 ...
 if (s) {
  s->fd = fd;
  s->proto = 
# 926 "project/radare2/libr/socket/socket.c" 3 4
            6
# 926 "project/radare2/libr/socket/socket.c"
                                  ;
 }
 return s;
}
...
# 931 "project/radare2/libr/socket/socket.c" 3 4
__attribute__((visibility("default"))) unsigned char
# 931 "project/radare2/libr/socket/socket.c"
        * r_socket_slurp(RSocket *s, int *len) {
 int blockSize = 4096;
 
# 933 "project/radare2/libr/socket/socket.c" 3 4
unsigned char 
# 933 "project/radare2/libr/socket/socket.c"
    *ptr, *buf = malloc (blockSize);
 if (!buf) {
  return 
# 935 "project/radare2/libr/socket/socket.c" 3 4
        ((void *)0)
# 935 "project/radare2/libr/socket/socket.c"
            ;
 }
 int copied = 0;
 if (len) {
...
# 956 "project/radare2/libr/socket/socket.c" 3 4
 { free((void *)
# 956 "project/radare2/libr/socket/socket.c"
 buf
# 956 "project/radare2/libr/socket/socket.c" 3 4
 ); 
# 956 "project/radare2/libr/socket/socket.c"
