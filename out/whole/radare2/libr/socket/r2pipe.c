# 0 "project/radare2/libr/socket/r2pipe.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/socket/r2pipe.c"
# 19 "project/radare2/libr/socket/r2pipe.c"
...
# 20 "project/radare2/libr/socket/r2pipe.c" 2
...
# 21 "project/radare2/libr/socket/r2pipe.c" 2
...
# 22 "project/radare2/libr/socket/r2pipe.c" 2
...
# 34 "project/radare2/libr/socket/r2pipe.c"
...
# 41 "project/radare2/libr/socket/r2pipe.c" 3 4
__attribute__((visibility("default"))) 
# 41 "project/radare2/libr/socket/r2pipe.c"
     int r2pipe_write(R2Pipe *r2pipe, const char *str) {
 char *cmd;
 int ret, len;
 if (!r2pipe || !str) {
  return -1;
...
# 52 "project/radare2/libr/socket/r2pipe.c" 3 4
__builtin___memcpy_chk (
# 52 "project/radare2/libr/socket/r2pipe.c"
cmd
# 52 "project/radare2/libr/socket/r2pipe.c" 3 4
, 
# 52 "project/radare2/libr/socket/r2pipe.c"
...
# 53 "project/radare2/libr/socket/r2pipe.c" 3 4
__builtin___strcpy_chk (
# 53 "project/radare2/libr/socket/r2pipe.c"
cmd + len - 2
# 53 "project/radare2/libr/socket/r2pipe.c" 3 4
, 
# 53 "project/radare2/libr/socket/r2pipe.c"
...
# 66 "project/radare2/libr/socket/r2pipe.c" 3 4
__attribute__((visibility("default"))) 
# 66 "project/radare2/libr/socket/r2pipe.c"
     char *r2pipe_read(R2Pipe *r2pipe) {
 int bufsz = 0;
 char *buf = 
# 68 "project/radare2/libr/socket/r2pipe.c" 3 4
            ((void *)0)
# 68 "project/radare2/libr/socket/r2pipe.c"
                ;
 if (!r2pipe) {
  return 
# 70 "project/radare2/libr/socket/r2pipe.c" 3 4
        ((void *)0)
# 70 "project/radare2/libr/socket/r2pipe.c"
            ;
 }
 bufsz = 4096;
 buf = calloc (1, bufsz);
 if (!buf) {
  return 
# 75 "project/radare2/libr/socket/r2pipe.c" 3 4
        ((void *)0)
# 75 "project/radare2/libr/socket/r2pipe.c"
            ;
 }
# 90 "project/radare2/libr/socket/r2pipe.c"
 char *newbuf;
 int i, rv;
 for (i = 0; i < bufsz; i++) {
...
# 98 "project/radare2/libr/socket/r2pipe.c" 3 4
   { free((void *)
# 98 "project/radare2/libr/socket/r2pipe.c"
   buf
# 98 "project/radare2/libr/socket/r2pipe.c" 3 4
   ); 
# 98 "project/radare2/libr/socket/r2pipe.c"
...
# 115 "project/radare2/libr/socket/r2pipe.c" 3 4
__attribute__((visibility("default"))) 
# 115 "project/radare2/libr/socket/r2pipe.c"
     int r2pipe_close(R2Pipe *r2pipe) {
 if (!r2pipe) {
  return 0;
 }
# 133 "project/radare2/libr/socket/r2pipe.c"
 if (r2pipe->input[0] != -1) {
 ...
 if (r2pipe->child != -1) {
  kill (r2pipe->child, 
# 150 "project/radare2/libr/socket/r2pipe.c" 3 4
                      15
# 150 "project/radare2/libr/socket/r2pipe.c"
                             );
  waitpid (r2pipe->child, 
# 151 "project/radare2/libr/socket/r2pipe.c" 3 4
                         ((void *)0)
# 151 "project/radare2/libr/socket/r2pipe.c"
                             , 0);
  r2pipe->child = -1;
 }
...
# 176 "project/radare2/libr/socket/r2pipe.c"
static R2Pipe* r2p_open_spawn(R2Pipe* r2p, const char *cmd) {
 
# 177 "project/radare2/libr/socket/r2pipe.c" 3 4
do { if (!(
# 177 "project/radare2/libr/socket/r2pipe.c"
r2p
# 177 "project/radare2/libr/socket/r2pipe.c" 3 4
...
# 177 "project/radare2/libr/socket/r2pipe.c"
 ...
 int done = 
# 181 "project/radare2/libr/socket/r2pipe.c" 3 4
           0
# 181 "project/radare2/libr/socket/r2pipe.c"
                ;
 if (in && out) {
  int i_in = atoi (in);
  int i_out = atoi (out);
...
# 188 "project/radare2/libr/socket/r2pipe.c" 3 4
         1
# 188 "project/radare2/libr/socket/r2pipe.c"
             ;
  }
 }
 if (!done) {
  
# 192 "project/radare2/libr/socket/r2pipe.c" 3 4
 fprintf(__stderrp,
# 192 "project/radare2/libr/socket/r2pipe.c"
...
# 193 "project/radare2/libr/socket/r2pipe.c" 3 4
 { free((void *)
# 193 "project/radare2/libr/socket/r2pipe.c"
 r2p
# 193 "project/radare2/libr/socket/r2pipe.c" 3 4
 ); 
# 193 "project/radare2/libr/socket/r2pipe.c"
...
static R2Pipe *r2pipe_new(void) {
 R2Pipe *r2pipe = 
# 205 "project/radare2/libr/socket/r2pipe.c" 3 4
                 (
# 205 "project/radare2/libr/socket/r2pipe.c"
                 R2Pipe
# 205 "project/radare2/libr/socket/r2pipe.c" 3 4
                 *)calloc(1,sizeof(
# 205 "project/radare2/libr/socket/r2pipe.c"
...
# 216 "project/radare2/libr/socket/r2pipe.c" 3 4
__attribute__((visibility("default"))) 
# 216 "project/radare2/libr/socket/r2pipe.c"
     R2Pipe *r2pipe_open_corebind(RCoreBind *coreb) {
 R2Pipe *r2pipe = r2pipe_new ();
 if (r2pipe) {
  
# 219 "project/radare2/libr/socket/r2pipe.c" 3 4
 __builtin___memcpy_chk (
# 219 "project/radare2/libr/socket/r2pipe.c"
 &r2pipe->coreb
# 219 "project/radare2/libr/socket/r2pipe.c" 3 4
 , 
# 219 "project/radare2/libr/socket/r2pipe.c"
 coreb, sizeof (RCoreBind)
# 219 "project/radare2/libr/socket/r2pipe.c" 3 4
 , __builtin_object_size (
# 219 "project/radare2/libr/socket/r2pipe.c"
 &r2pipe->coreb
...
# 224 "project/radare2/libr/socket/r2pipe.c" 3 4
__attribute__((visibility("default"))) 
# 224 "project/radare2/libr/socket/r2pipe.c"
     R2Pipe *r2pipe_open_dl(const char *libr_path) {
...
# 238 "project/radare2/libr/socket/r2pipe.c" 3 4
fprintf(__stderrp,
# 238 "project/radare2/libr/socket/r2pipe.c"
"Cannot resolve r_core_cmd, r_core_cmd_str, r_core_free\n"
# 238 "project/radare2/libr/socket/r2pipe.c" 3 4
)
# 238 "project/radare2/libr/socket/r2pipe.c"
                                                                    ;
 return 
# 239 "project/radare2/libr/socket/r2pipe.c" 3 4
       ((void *)0)
# 239 "project/radare2/libr/socket/r2pipe.c"
           ;
}


# 242 "project/radare2/libr/socket/r2pipe.c" 3 4
__attribute__((visibility("default"))) 
# 242 "project/radare2/libr/socket/r2pipe.c"
     R2Pipe *r2pipe_open(const char *cmd) {
 R2Pipe *r2p = r2pipe_new ();
 if (!r2p) {
  return 
# 245 "project/radare2/libr/socket/r2pipe.c" 3 4
        ((void *)0)
# 245 "project/radare2/libr/socket/r2pipe.c"
            ;
 }
 if (
# 247 "project/radare2/libr/socket/r2pipe.c" 3 4
    (!(
# 247 "project/radare2/libr/socket/r2pipe.c"
    cmd
# 247 "project/radare2/libr/socket/r2pipe.c" 3 4
    ) || !*(
# 247 "project/radare2/libr/socket/r2pipe.c"
...
# 257 "project/radare2/libr/socket/r2pipe.c" 3 4
 fprintf(__stderrp,
# 257 "project/radare2/libr/socket/r2pipe.c"
...
# 257 "project/radare2/libr/socket/r2pipe.c"
  ...
  r2pipe_close (r2p);
  return 
# 259 "project/radare2/libr/socket/r2pipe.c" 3 4
        ((void *)0)
# 259 "project/radare2/libr/socket/r2pipe.c"
            ;
 }
 r = pipe (r2p->output);
 if (r != 0) {
  
# 263 "project/radare2/libr/socket/r2pipe.c" 3 4
 fprintf(__stderrp,
# 263 "project/radare2/libr/socket/r2pipe.c"
...
# 263 "project/radare2/libr/socket/r2pipe.c"
  ...
  r2pipe_close (r2p);
  return 
# 265 "project/radare2/libr/socket/r2pipe.c" 3 4
        ((void *)0)
# 265 "project/radare2/libr/socket/r2pipe.c"
            ;
 }
 ...
 if (r2p->child == -1) {
  r2pipe_close (r2p);
  return 
# 270 "project/radare2/libr/socket/r2pipe.c" 3 4
        ((void *)0)
# 270 "project/radare2/libr/socket/r2pipe.c"
            ;
 }
...
# 279 "project/radare2/libr/socket/r2pipe.c" 3 4
  fprintf(__stderrp,
# 279 "project/radare2/libr/socket/r2pipe.c"
...
# 279 "project/radare2/libr/socket/r2pipe.c"
   ...
   r2pipe_close (r2p);
   return 
# 281 "project/radare2/libr/socket/r2pipe.c" 3 4
         ((void *)0)
# 281 "project/radare2/libr/socket/r2pipe.c"
             ;
  }
  if (ch == -1) {
   
# 284 "project/radare2/libr/socket/r2pipe.c" 3 4
  fprintf(__stderrp,
# 284 "project/radare2/libr/socket/r2pipe.c"
  "[+] r2pipe link error.\n"
# 284 "project/radare2/libr/socket/r2pipe.c" 3 4
  )
# 284 "project/radare2/libr/socket/r2pipe.c"
   ...
   r2pipe_close (r2p);
   return 
# 286 "project/radare2/libr/socket/r2pipe.c" 3 4
         ((void *)0)
# 286 "project/radare2/libr/socket/r2pipe.c"
             ;
  }
...
# 306 "project/radare2/libr/socket/r2pipe.c" 3 4
   fprintf(__stderrp,
# 306 "project/radare2/libr/socket/r2pipe.c"
   "return code %d for %s\n", rc, cmd
# 306 "project/radare2/libr/socket/r2pipe.c" 3 4
   )
# 306 "project/radare2/libr/socket/r2pipe.c"
  ...
  exit (rc);
  return 
# 317 "project/radare2/libr/socket/r2pipe.c" 3 4
        ((void *)0)
# 317 "project/radare2/libr/socket/r2pipe.c"
            ;
 }
...
# 323 "project/radare2/libr/socket/r2pipe.c" 3 4
__attribute__((visibility("default"))) 
# 323 "project/radare2/libr/socket/r2pipe.c"
     char *r2pipe_cmd(R2Pipe *r2p, const char *str) {
 
# 324 "project/radare2/libr/socket/r2pipe.c" 3 4
do { if (!(
# 324 "project/radare2/libr/socket/r2pipe.c"
r2p && str
# 324 "project/radare2/libr/socket/r2pipe.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 324 "project/radare2/libr/socket/r2pipe.c"
"r2p && str"
# 324 "project/radare2/libr/socket/r2pipe.c" 3 4
, 324); return (((void *)0)); } } while (0)
# 324 "project/radare2/libr/socket/r2pipe.c"
                                       ;
 if (!*str || !r2pipe_write (r2p, str)) {
  perror ("r2pipe_write");
  return 
# 327 "project/radare2/libr/socket/r2pipe.c" 3 4
        ((void *)0)
# 327 "project/radare2/libr/socket/r2pipe.c"
            ;
 }
...
# 332 "project/radare2/libr/socket/r2pipe.c" 3 4
__attribute__((visibility("default"))) 
# 332 "project/radare2/libr/socket/r2pipe.c"
     char *r2pipe_cmdf(R2Pipe *r2p, const char *fmt, ...) {
 int ret, ret2;
 char *p, string[1024];
 va_list ap, ap2;
 
# 336 "project/radare2/libr/socket/r2pipe.c" 3 4
__builtin_va_start(
# 336 "project/radare2/libr/socket/r2pipe.c"
ap
# 336 "project/radare2/libr/socket/r2pipe.c" 3 4
,
# 336 "project/radare2/libr/socket/r2pipe.c"
...
# 337 "project/radare2/libr/socket/r2pipe.c" 3 4
__builtin_va_start(
# 337 "project/radare2/libr/socket/r2pipe.c"
ap2
# 337 "project/radare2/libr/socket/r2pipe.c" 3 4
,
# 337 "project/radare2/libr/socket/r2pipe.c"
...
# 337 "project/radare2/libr/socket/r2pipe.c"
                   ;
 ret = 
# 338 "project/radare2/libr/socket/r2pipe.c" 3 4
      __builtin___vsnprintf_chk (
# 338 "project/radare2/libr/socket/r2pipe.c"
      string
# 338 "project/radare2/libr/socket/r2pipe.c" 3 4
      , 
# 338 "project/radare2/libr/socket/r2pipe.c"
...
# 342 "project/radare2/libr/socket/r2pipe.c" 3 4
  __builtin_va_end(
# 342 "project/radare2/libr/socket/r2pipe.c"
  ap2
# 342 "project/radare2/libr/socket/r2pipe.c" 3 4
  )
# 342 "project/radare2/libr/socket/r2pipe.c"
...
# 343 "project/radare2/libr/socket/r2pipe.c" 3 4
  __builtin_va_end(
# 343 "project/radare2/libr/socket/r2pipe.c"
  ap
# 343 "project/radare2/libr/socket/r2pipe.c" 3 4
  )
# 343 "project/radare2/libr/socket/r2pipe.c"
             ;
   return 
# 344 "project/radare2/libr/socket/r2pipe.c" 3 4
         ((void *)0)
# 344 "project/radare2/libr/socket/r2pipe.c"
             ;
  }
  ret2 = 
# 346 "project/radare2/libr/socket/r2pipe.c" 3 4
        __builtin___vsnprintf_chk (
# 346 "project/radare2/libr/socket/r2pipe.c"
        p
# 346 "project/radare2/libr/socket/r2pipe.c" 3 4
        , 
# 346 "project/radare2/libr/socket/r2pipe.c"
...
# 349 "project/radare2/libr/socket/r2pipe.c" 3 4
  __builtin_va_end(
# 349 "project/radare2/libr/socket/r2pipe.c"
  ap2
# 349 "project/radare2/libr/socket/r2pipe.c" 3 4
  )
# 349 "project/radare2/libr/socket/r2pipe.c"
...
# 350 "project/radare2/libr/socket/r2pipe.c" 3 4
  __builtin_va_end(
# 350 "project/radare2/libr/socket/r2pipe.c"
  ap
# 350 "project/radare2/libr/socket/r2pipe.c" 3 4
  )
# 350 "project/radare2/libr/socket/r2pipe.c"
             ;
   return 
# 351 "project/radare2/libr/socket/r2pipe.c" 3 4
         ((void *)0)
# 351 "project/radare2/libr/socket/r2pipe.c"
             ;
  }
...
# 358 "project/radare2/libr/socket/r2pipe.c" 3 4
__builtin_va_end(
# 358 "project/radare2/libr/socket/r2pipe.c"
ap2
# 358 "project/radare2/libr/socket/r2pipe.c" 3 4
)
# 358 "project/radare2/libr/socket/r2pipe.c"
...
# 359 "project/radare2/libr/socket/r2pipe.c" 3 4
__builtin_va_end(
# 359 "project/radare2/libr/socket/r2pipe.c"
ap
# 359 "project/radare2/libr/socket/r2pipe.c" 3 4
)
# 359 "project/radare2/libr/socket/r2pipe.c"
