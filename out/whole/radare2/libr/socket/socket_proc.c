# 0 "project/radare2/libr/socket/socket_proc.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/socket/socket_proc.c"
...
# 7 "project/radare2/libr/socket/socket_proc.c" 2
...
# 8 "project/radare2/libr/socket/socket_proc.c" 2
...
# 16 "project/radare2/libr/socket/socket_proc.c"
     struct r_socket_proc_t *r_socket_proc_open(char* const argv[]) {

 RSocketProc *sp = 
# 18 "project/radare2/libr/socket/socket_proc.c" 3 4
                  (
# 18 "project/radare2/libr/socket/socket_proc.c"
                  RSocketProc
# 18 "project/radare2/libr/socket/socket_proc.c" 3 4
                  *)malloc(sizeof(
# 18 "project/radare2/libr/socket/socket_proc.c"
...
# 18 "project/radare2/libr/socket/socket_proc.c"
 ...
 const int flags = 
# 20 "project/radare2/libr/socket/socket_proc.c" 3 4
                  0x01000000
# 20 "project/radare2/libr/socket/socket_proc.c"
                           ;
 ...
 if (!sp) {
  return 
# 26 "project/radare2/libr/socket/socket_proc.c" 3 4
        ((void *)0)
# 26 "project/radare2/libr/socket/socket_proc.c"
            ;
 }
...
error:
 free (sp);
 return 
# 70 "project/radare2/libr/socket/socket_proc.c" 3 4
       ((void *)0)
# 70 "project/radare2/libr/socket/socket_proc.c"
           ;
...
# 76 "project/radare2/libr/socket/socket_proc.c" 3 4
__attribute__((visibility("default"))) 
# 76 "project/radare2/libr/socket/socket_proc.c"
     int r_socket_proc_close(struct r_socket_proc_t *sp) {


 kill (sp->pid, 
# 79 "project/radare2/libr/socket/socket_proc.c" 3 4
               9
# 79 "project/radare2/libr/socket/socket_proc.c"
                      );
 waitpid (sp->pid, 
# 80 "project/radare2/libr/socket/socket_proc.c" 3 4
                  ((void *)0)
# 80 "project/radare2/libr/socket/socket_proc.c"
                      , 0);
 close (sp->fd0[0]);
 close (sp->fd0[1]);
...
# 91 "project/radare2/libr/socket/socket_proc.c" 3 4
__attribute__((visibility("default"))) 
# 91 "project/radare2/libr/socket/socket_proc.c"
     int r_socket_proc_read (RSocketProc *sp, unsigned char *buf, int len) {
 RSocket s;
 s.is_ssl = 
# 93 "project/radare2/libr/socket/socket_proc.c" 3 4
           0
# 93 "project/radare2/libr/socket/socket_proc.c"
                ;
 s.fd = sp->fd1[0];
...
# 98 "project/radare2/libr/socket/socket_proc.c" 3 4
__attribute__((visibility("default"))) 
# 98 "project/radare2/libr/socket/socket_proc.c"
     int r_socket_proc_gets (RSocketProc *sp, char *buf, int size) {
 RSocket s;
 s.is_ssl = 
# 100 "project/radare2/libr/socket/socket_proc.c" 3 4
           0
# 100 "project/radare2/libr/socket/socket_proc.c"
                ;
 s.fd = sp->fd1[0];
...
# 105 "project/radare2/libr/socket/socket_proc.c" 3 4
__attribute__((visibility("default"))) 
# 105 "project/radare2/libr/socket/socket_proc.c"
     int r_socket_proc_write (RSocketProc *sp, void *buf, int len) {
 RSocket s;
 s.is_ssl = 
# 107 "project/radare2/libr/socket/socket_proc.c" 3 4
           0
# 107 "project/radare2/libr/socket/socket_proc.c"
                ;
 s.fd = sp->fd0[1];
...
# 112 "project/radare2/libr/socket/socket_proc.c" 3 4
__attribute__((visibility("default"))) 
# 112 "project/radare2/libr/socket/socket_proc.c"
     void r_socket_proc_printf (RSocketProc *sp, const char *fmt, ...) {
 RSocket s;
 char buf[4096];
 va_list ap;
 s.is_ssl = 
# 116 "project/radare2/libr/socket/socket_proc.c" 3 4
           0
# 116 "project/radare2/libr/socket/socket_proc.c"
                ;
 s.fd = sp->fd0[1];
 if (s.fd != 
# 118 "project/radare2/libr/socket/socket_proc.c" 3 4
            -1
# 118 "project/radare2/libr/socket/socket_proc.c"
                            ) {
  
# 119 "project/radare2/libr/socket/socket_proc.c" 3 4
 __builtin_va_start(
# 119 "project/radare2/libr/socket/socket_proc.c"
 ap
# 119 "project/radare2/libr/socket/socket_proc.c" 3 4
 ,
# 119 "project/radare2/libr/socket/socket_proc.c"
...
# 120 "project/radare2/libr/socket/socket_proc.c" 3 4
 __builtin___vsnprintf_chk (
# 120 "project/radare2/libr/socket/socket_proc.c"
 buf
# 120 "project/radare2/libr/socket/socket_proc.c" 3 4
 , 
# 120 "project/radare2/libr/socket/socket_proc.c"
...
# 122 "project/radare2/libr/socket/socket_proc.c" 3 4
 __builtin_va_end(
# 122 "project/radare2/libr/socket/socket_proc.c"
 ap
# 122 "project/radare2/libr/socket/socket_proc.c" 3 4
 )
# 122 "project/radare2/libr/socket/socket_proc.c"
...
# 126 "project/radare2/libr/socket/socket_proc.c" 3 4
__attribute__((visibility("default"))) 
# 126 "project/radare2/libr/socket/socket_proc.c"
     int r_socket_proc_ready (RSocketProc *sp, int secs, int usecs) {
 RSocket s;
 s.is_ssl = 
# 128 "project/radare2/libr/socket/socket_proc.c" 3 4
           0
# 128 "project/radare2/libr/socket/socket_proc.c"
                ;
 s.fd = sp->fd1[0];
