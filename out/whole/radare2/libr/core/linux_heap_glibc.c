# 0 "project/radare2/libr/core/linux_heap_glibc.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 6 "project/radare2/libr/core/linux_heap_glibc.c" 2
#define HEAP32 1
# 1 "project/radare2/libr/core/linux_heap_glibc.c" 1
# 11 "project/radare2/libr/core/linux_heap_glibc.c"
#undef GH
#undef GHT
#undef GHT_MAX
#undef read_le
...
# 39 "project/radare2/libr/core/linux_heap_glibc.c"

# 39 "project/radare2/libr/core/linux_heap_glibc.c"
static 
# 39 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
      unsigned int 
# 39 "project/radare2/libr/core/linux_heap_glibc.c"
          get_va_symbol_32(RCore *core, const char *path, const char *sym_name) {
 
# 40 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 40 "project/radare2/libr/core/linux_heap_glibc.c"
    vaddr = 
# 40 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
            0xFFFFFFFFU
# 40 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 RBinFileOptions opt;
 r_bin_file_options_init (&opt, -1, 0, 0, 
# 47 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                         0
# 47 "project/radare2/libr/core/linux_heap_glibc.c"
                                              );
 
# 48 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
_Bool 
# 48 "project/radare2/libr/core/linux_heap_glibc.c"
     res = r_bin_open (bin, path, &opt);
 if (!res) {
  return vaddr;
 }
...
# 54 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
if (
# 54 "project/radare2/libr/core/linux_heap_glibc.c"
syms
# 54 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
) for (
# 54 "project/radare2/libr/core/linux_heap_glibc.c"
...
static inline 
# 67 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
             unsigned int 
# 67 "project/radare2/libr/core/linux_heap_glibc.c"
                 align_address_to_size_32(
# 67 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                           unsigned long long 
# 67 "project/radare2/libr/core/linux_heap_glibc.c"
                                                addr, 
...
static inline 
# 71 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
             unsigned int 
# 71 "project/radare2/libr/core/linux_heap_glibc.c"
                 get_next_pointer_32(RCore *core, 
# 71 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                   unsigned int 
# 71 "project/radare2/libr/core/linux_heap_glibc.c"
                                                       pos, 
...
static 
# 75 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
      unsigned int 
# 75 "project/radare2/libr/core/linux_heap_glibc.c"
          get_main_arena_with_symbol_32(RCore *core, RDebugMap *map) {
 
# 76 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
do { if (!(
# 76 "project/radare2/libr/core/linux_heap_glibc.c"
core && map
# 76 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
...
"core && map"
# 76 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
, 76); return (0xFFFFFFFFU); } } while (0)
# 76 "project/radare2/libr/core/linux_heap_glibc.c"
                                           ;
 
# 77 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 77 "project/radare2/libr/core/linux_heap_glibc.c"
    base_addr = map->addr;
 
# 78 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
do { if (!(
# 78 "project/radare2/libr/core/linux_heap_glibc.c"
base_addr != 
# 78 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
...
"base_addr != GHT_MAX"
# 78 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
, 78); return (0xFFFFFFFFU); } } while (0)
# 78 "project/radare2/libr/core/linux_heap_glibc.c"
                                                    ;

 
# 80 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 80 "project/radare2/libr/core/linux_heap_glibc.c"
    main_arena = 
# 80 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 0xFFFFFFFFU
# 80 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 81 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 81 "project/radare2/libr/core/linux_heap_glibc.c"
    vaddr = 
# 81 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
            0xFFFFFFFFU
# 81 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 if (path && r_file_exists (path)) {
  vaddr = get_va_symbol_32 (core, path, "main_arena");
  if (vaddr != 
# 85 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
              0xFFFFFFFFU
# 85 "project/radare2/libr/core/linux_heap_glibc.c"
                     ) {
   main_arena = base_addr + vaddr;
  } else {
   vaddr = get_va_symbol_32 (core, path, "__malloc_hook");
   if (vaddr == 
# 89 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
               0xFFFFFFFFU
# 89 "project/radare2/libr/core/linux_heap_glibc.c"
                      ) {
    return main_arena;
   }
   RBinInfo *info = r_bin_get_info (core->bin);
   if (!strcmp (info->arch, "x86")) {
    main_arena = align_address_to_size_32 (vaddr + base_addr + sizeof (
# 94 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                                        unsigned int
# 94 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                           ), 0x20);
   } else if (!strcmp (info->arch, "arm")) {
    main_arena = vaddr + base_addr - sizeof (
# 96 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                            unsigned int
# 96 "project/radare2/libr/core/linux_heap_glibc.c"
                                               ) * 2 - sizeof (MallocState);
   }
  }
 }
 free (path);
...
static 
# 104 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
      _Bool 
# 104 "project/radare2/libr/core/linux_heap_glibc.c"
           is_tcache_32(RCore *core) {
 char *fp = 
# 105 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
           ((void *)0)
# 105 "project/radare2/libr/core/linux_heap_glibc.c"
               ;
 double v = 0;
...
# 111 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 if (
# 111 "project/radare2/libr/core/linux_heap_glibc.c"
 core->dbg->maps
# 111 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 ) for (
# 111 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 125 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 _Bool 
# 125 "project/radare2/libr/core/linux_heap_glibc.c"
      tcv = r_config_get_b (core->config, "dbg.glibc.tcache");

  return tcv;
 }
 if (fp) {
  v = r_num_get_float (
# 130 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                      ((void *)0)
# 130 "project/radare2/libr/core/linux_heap_glibc.c"
                          , fp + 5);
...
static 
# 136 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
      unsigned int 
# 136 "project/radare2/libr/core/linux_heap_glibc.c"
          tcache_chunk_size_32(RCore *core, 
# 136 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                             unsigned int 
# 136 "project/radare2/libr/core/linux_heap_glibc.c"
                                                 brk_start) {
 
# 137 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 137 "project/radare2/libr/core/linux_heap_glibc.c"
    sz = 0;

 RHeapChunk_32 *cnk = 
# 139 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                       (
# 139 "project/radare2/libr/core/linux_heap_glibc.c"
                       RHeapChunk_32
# 139 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                       *)calloc(1,sizeof(
# 139 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 139 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 r_io_read_at (core->io, brk_start, (
# 143 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                    unsigned char 
# 143 "project/radare2/libr/core/linux_heap_glibc.c"
                                        *)cnk, sizeof (RHeapChunk_32));
 sz = (cnk->size >> 3) << 3;
 return sz;
}

static void update_arena_with_tc_32(RHeap_MallocState_tcache_32 *cmain_arena, MallocState *main_arena) {
 int i = 0;
 ...
 for (i = 0; i < NFASTBINS; i++) {
  main_arena->fastbinsY_32[i] = cmain_arena->fastbinsY[i];
 }
 main_arena->top_32 = cmain_arena->top;
 main_arena->last_remainder_32 = cmain_arena->last_remainder;
 for (i = 0; i < NBINS * 2 - 2; i++) {
  main_arena->bins_32[i] = cmain_arena->bins[i];
 }
 main_arena->next_32 = cmain_arena->next;
 main_arena->next_free_32 = cmain_arena->next_free;
 main_arena->system_mem_32 = cmain_arena->system_mem;
 main_arena->max_system_mem_32 = cmain_arena->max_system_mem;
}

static void update_arena_without_tc_32(RHeap_MallocState_32 *cmain_arena, MallocState *main_arena) {
 size_t i = 0;
 main_arena->mutex = cmain_arena->mutex;
 main_arena->flags = cmain_arena->flags;
 for (i = 0; i < BINMAPSIZE; i++) {
...
static 
# 193 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
      _Bool 
# 193 "project/radare2/libr/core/linux_heap_glibc.c"
           update_main_arena_32(RCore *core, 
# 193 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                              unsigned int 
# 193 "project/radare2/libr/core/linux_heap_glibc.c"
                                                  m_arena, MallocState *main_arena) {
 const int tcache = r_config_get_i (core->config, "dbg.glibc.tcache");
 if (tcache) {
  RHeap_MallocState_tcache_32 *cmain_arena = 
# 196 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                             (
# 196 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 196 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  if (!cmain_arena) {
   return 
# 198 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
         0
# 198 "project/radare2/libr/core/linux_heap_glibc.c"
              ;
  }
  (void)r_io_read_at (core->io, m_arena, (
# 200 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                         unsigned char 
# 200 "project/radare2/libr/core/linux_heap_glibc.c"
                                             *)cmain_arena, sizeof (RHeap_MallocState_tcache_32));
  update_arena_with_tc_32(cmain_arena, main_arena);
 } else {
  RHeap_MallocState_32 *cmain_arena = 
# 203 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                      (
# 203 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 203 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  if (!cmain_arena) {
   return 
# 205 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
         0
# 205 "project/radare2/libr/core/linux_heap_glibc.c"
              ;
  }
  (void)r_io_read_at (core->io, m_arena, (
# 207 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                         unsigned char 
# 207 "project/radare2/libr/core/linux_heap_glibc.c"
                                             *)cmain_arena, sizeof (RHeap_MallocState_32));
  update_arena_without_tc_32(cmain_arena, main_arena);
 }
 return 
# 210 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
       1
# 210 "project/radare2/libr/core/linux_heap_glibc.c"
           ;
}

static void get_brks_32(RCore *core, 
# 213 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                     unsigned int 
# 213 "project/radare2/libr/core/linux_heap_glibc.c"
                                         *brk_start, 
# 213 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                     unsigned int 
# 213 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 218 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 if (
# 218 "project/radare2/libr/core/linux_heap_glibc.c"
 core->dbg->maps
# 218 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 ) for (
# 218 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 234 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 if (
# 234 "project/radare2/libr/core/linux_heap_glibc.c"
 bank->maprefs
# 234 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 ) for (
# 234 "project/radare2/libr/core/linux_heap_glibc.c"
...
static void print_arena_stats_32(RCore *core, 
# 247 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                              unsigned int 
# 247 "project/radare2/libr/core/linux_heap_glibc.c"
                                                  m_arena, MallocState *main_arena, 
# 247 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                                                    unsigned int 
# 247 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                                        global_max_fast, int format) {
 size_t i, j, k, start;
 
# 249 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 249 "project/radare2/libr/core/linux_heap_glibc.c"
    align = 12 * SZ + sizeof (int) * 2;
 const int tcache = r_config_get_i (core->config, "dbg.glibc.tcache");
...
# 257 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 257 "project/radare2/libr/core/linux_heap_glibc.c"
    apart[NSMALLBINS + 1] = { 0LL };
 if (format == '*') {
  for (i = 0; i < NBINS * 2 - 2; i += 2) {
   
# 260 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
  unsigned int 
# 260 "project/radare2/libr/core/linux_heap_glibc.c"
      addr = m_arena + align + SZ * i - SZ * 2;
   
# 261 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
  unsigned int 
# 261 "project/radare2/libr/core/linux_heap_glibc.c"
      bina = main_arena->bins_32[i];
   r_cons_printf ("f chunk.%zu.bin = 0x%"
# 262 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                        "llx"
# 262 "project/radare2/libr/core/linux_heap_glibc.c"
                                               "\n", i, (
# 262 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                         unsigned long long
# 262 "project/radare2/libr/core/linux_heap_glibc.c"
                                                             )addr);
   r_cons_printf ("f chunk.%zu.fd = 0x%"
# 263 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                       "llx"
# 263 "project/radare2/libr/core/linux_heap_glibc.c"
                                              "\n", i, (
# 263 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                        unsigned long long
# 263 "project/radare2/libr/core/linux_heap_glibc.c"
                                                            )bina);
   bina = main_arena->bins_32[i + 1];
   r_cons_printf ("f chunk.%zu.bk = 0x%"
# 265 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                       "llx"
# 265 "project/radare2/libr/core/linux_heap_glibc.c"
                                              "\n", i, (
# 265 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                        unsigned long long
# 265 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  for (i = 0; i < BINMAPSIZE; i++) {
   r_cons_printf ("f binmap.%zu = 0x%"
# 268 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                     "llx"
# 268 "project/radare2/libr/core/linux_heap_glibc.c"
                                            , i, (
# 268 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                  unsigned long long
# 268 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  {
   char units[8];
   r_num_units (units, sizeof (units), main_arena->max_system_mem_32);
   r_cons_printf ("f heap.maxmem = %s\n", units);

   r_num_units (units, sizeof (units), main_arena->system_mem_32);
   r_cons_printf ("f heap.sysmem = %s\n", units);

   r_num_units (units, sizeof (units), main_arena->next_free_32);
   r_cons_printf ("f heap.nextfree = %s\n", units);

   r_num_units (units, sizeof (units), main_arena->next_32);
 ...
 PRINTF_BA ("0x%"
# 288 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                "llx"
# 288 "project/radare2/libr/core/linux_heap_glibc.c"
                       "\n\n", (
# 288 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                unsigned long long
# 288 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 PRINT_GA ("  mutex = ");
 PRINTF_BA ("0x%08x\n", (
# 291 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                        unsigned int
# 291 "project/radare2/libr/core/linux_heap_glibc.c"
                            )main_arena->mutex);
 PRINT_GA ("  flags = ");
 PRINTF_BA ("0x%08x\n", (
# 293 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                        unsigned int
# 293 "project/radare2/libr/core/linux_heap_glibc.c"
                            )main_arena->flags);
 PRINT_GA ("  fastbinsY = {\n");
 ...
 for (i = 0, j = 1, k = SZ * 4; i < NFASTBINS; i++, j++, k += SZ * 2) {
  ...
  PRINTF_BA (" == %04zu ", k);
  PRINTF_GA ("0x%"
# 304 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 "llx"
# 304 "project/radare2/libr/core/linux_heap_glibc.c"
                        , (
# 304 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                           unsigned long long
# 304 "project/radare2/libr/core/linux_heap_glibc.c"
                               )main_arena->fastbinsY_32[i]);
  PRINT_GA (",\n");
 }
 PRINT_GA ("}\n");
 PRINT_GA ("  top = ");
 PRINTF_BA ("0x%"
# 309 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                "llx"
# 309 "project/radare2/libr/core/linux_heap_glibc.c"
                       , (
# 309 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                          unsigned long long
# 309 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 PRINTF_BA ("0x%"
# 312 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                "llx"
# 312 "project/radare2/libr/core/linux_heap_glibc.c"
                       , (
# 312 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                          unsigned long long
# 312 "project/radare2/libr/core/linux_heap_glibc.c"
                              )main_arena->last_remainder_32);
 PRINT_GA (",\n");
 PRINT_GA ("  bins {\n");
 ...
 for (i = 0, j = 1, k = SZ * 4; i < NBINS * 2 - 2; i += 2, j++) {
  ...
  if (j == 1) {
   ...
   if (j != NBINS - 1) {
    PRINTF_BA (" >= %06"
# 358 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                       "lld"
# 358 "project/radare2/libr/core/linux_heap_glibc.c"
                              "  ", (
# 358 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                     unsigned long long
# 358 "project/radare2/libr/core/linux_heap_glibc.c"
                                         )apart[j - NSMALLBINS - 1]);
   } else {
    PRINT_BA (" remaining ");
   }
  }
  
# 363 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 unsigned int 
# 363 "project/radare2/libr/core/linux_heap_glibc.c"
     bin = m_arena + align + SZ * i - SZ * 2;
  PRINTF_GA ("0x%"
# 364 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 "llx"
# 364 "project/radare2/libr/core/linux_heap_glibc.c"
                        "->fd = ", (
# 364 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                    unsigned long long
# 364 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  PRINTF_BA ("0x%"
# 365 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 "llx"
# 365 "project/radare2/libr/core/linux_heap_glibc.c"
                        , (
# 365 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                           unsigned long long
# 365 "project/radare2/libr/core/linux_heap_glibc.c"
                               )main_arena->bins_32[i]);
  PRINT_GA (", ");
  PRINTF_GA ("0x%"
# 367 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 "llx"
# 367 "project/radare2/libr/core/linux_heap_glibc.c"
                        "->bk = ", (
# 367 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                    unsigned long long
# 367 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  PRINTF_BA ("0x%"
# 368 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 "llx"
# 368 "project/radare2/libr/core/linux_heap_glibc.c"
                        , (
# 368 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                           unsigned long long
# 368 "project/radare2/libr/core/linux_heap_glibc.c"
                               )main_arena->bins_32[i + 1] );
  PRINT_GA (", ");
  r_cons_newline ();
 }
 ...
 for (i = 0; i < BINMAPSIZE; i++) {
  ...
  PRINTF_BA ("0x%x", (
# 380 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                     unsigned int
# 380 "project/radare2/libr/core/linux_heap_glibc.c"
                         )main_arena->binmap[i]);
 }
 PRINT_GA ("}\n");
 PRINT_GA ("  next = ");
 PRINTF_BA ("0x%"
# 384 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                "llx"
# 384 "project/radare2/libr/core/linux_heap_glibc.c"
                       , (
# 384 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                          unsigned long long
# 384 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 PRINT_GA ("  next_free = ");
 PRINTF_BA ("0x%"
# 387 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                "llx"
# 387 "project/radare2/libr/core/linux_heap_glibc.c"
                       , (
# 387 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                          unsigned long long
# 387 "project/radare2/libr/core/linux_heap_glibc.c"
                              )main_arena->next_free_32);
 PRINT_GA (",\n");
 PRINT_GA ("  system_mem = ");
 PRINTF_BA ("0x%"
# 390 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                "llx"
# 390 "project/radare2/libr/core/linux_heap_glibc.c"
                       , (
# 390 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                          unsigned long long
# 390 "project/radare2/libr/core/linux_heap_glibc.c"
                              )main_arena->system_mem_32);
 PRINT_GA (",\n");
 PRINT_GA ("  max_system_mem = ");
 PRINTF_BA ("0x%"
# 393 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                "llx"
# 393 "project/radare2/libr/core/linux_heap_glibc.c"
                       , (
# 393 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                          unsigned long long
# 393 "project/radare2/libr/core/linux_heap_glibc.c"
                              )main_arena->max_system_mem_32);
 PRINT_GA (",\n");
 PRINT_GA ("}\n\n");
}

static 
# 398 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
      _Bool 
# 398 "project/radare2/libr/core/linux_heap_glibc.c"
           r_resolve_main_arena_32(RCore *core, 
# 398 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                 unsigned int 
# 398 "project/radare2/libr/core/linux_heap_glibc.c"
                                                     *m_arena) {
 
# 399 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
do { if (!(
# 399 "project/radare2/libr/core/linux_heap_glibc.c"
core && core->dbg && core->dbg->maps
# 399 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 399 "project/radare2/libr/core/linux_heap_glibc.c"
"core && core->dbg && core->dbg->maps"
# 399 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
, 399); return (0); } } while (0)
# 399 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                  ;

 if (core->dbg->main_arena_resolved) {
  return 
# 402 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
        1
# 402 "project/radare2/libr/core/linux_heap_glibc.c"
            ;
 }

 
# 405 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 405 "project/radare2/libr/core/linux_heap_glibc.c"
    brk_start = 
# 405 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                0xFFFFFFFFU
# 405 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 406 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 406 "project/radare2/libr/core/linux_heap_glibc.c"
    libc_addr_sta = 
# 406 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                    0xFFFFFFFFU
# 406 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 407 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 407 "project/radare2/libr/core/linux_heap_glibc.c"
    addr_srch = 
# 407 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                0xFFFFFFFFU
# 407 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 408 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 408 "project/radare2/libr/core/linux_heap_glibc.c"
    main_arena_sym = 
# 408 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                     0xFFFFFFFFU
# 408 "project/radare2/libr/core/linux_heap_glibc.c"
                            ;
 const 
# 409 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
      _Bool 
# 409 "project/radare2/libr/core/linux_heap_glibc.c"
           is_debugged = r_config_get_b (core->config, "cfg.debug");
 
# 410 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
_Bool 
# 410 "project/radare2/libr/core/linux_heap_glibc.c"
     first_libc = 
# 410 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                  1
# 410 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 416 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 if (
# 416 "project/radare2/libr/core/linux_heap_glibc.c"
 core->dbg->maps
# 416 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 ) for (
# 416 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 416 "project/radare2/libr/core/linux_heap_glibc.c"
   ...
   if ((strstr (map->name, "/libc-") || strstr (map->name, "/libc."))
     && first_libc && main_arena_sym == 
# 419 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                       0xFFFFFFFFU
# 419 "project/radare2/libr/core/linux_heap_glibc.c"
                                              ) {
    first_libc = 
# 420 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                0
# 420 "project/radare2/libr/core/linux_heap_glibc.c"
                     ;
    main_arena_sym = get_main_arena_with_symbol_32 (core, map);
   }
   if ((strstr (map->name, "/libc-") || strstr (map->name, "/libc."))
     && map->perm == 
# 424 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                    (4|2)
# 424 "project/radare2/libr/core/linux_heap_glibc.c"
                             ) {
  ...
  if (!bank) {
   return 
# 433 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
         0
# 433 "project/radare2/libr/core/linux_heap_glibc.c"
              ;
  }
  RIOMapRef *mapref;
  RListIter *iter;
  
# 437 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 if (
# 437 "project/radare2/libr/core/linux_heap_glibc.c"
 bank->maprefs
# 437 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 ) for (
# 437 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 437 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 if (libc_addr_sta == 
# 447 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                     0xFFFFFFFFU 
# 447 "project/radare2/libr/core/linux_heap_glibc.c"
                             || libc_addr_end == 
# 447 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                 0xFFFFFFFFU
# 447 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 449 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
  fprintf(__stderrp,
# 449 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 451 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
  fprintf(__stderrp,
# 451 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 451 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  return 
# 453 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
        0
# 453 "project/radare2/libr/core/linux_heap_glibc.c"
             ;
 }

 get_brks_32 (core, &brk_start, &brk_end);
 if (brk_start == 
# 457 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 0xFFFFFFFFU 
# 457 "project/radare2/libr/core/linux_heap_glibc.c"
                         || brk_end == 
# 457 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                       0xFFFFFFFFU
# 457 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 458 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 fprintf(__stderrp,
# 458 "project/radare2/libr/core/linux_heap_glibc.c"
 "No Heap section\n"
# 458 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 )
# 458 "project/radare2/libr/core/linux_heap_glibc.c"
                              ;
  return 
# 459 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
        0
# 459 "project/radare2/libr/core/linux_heap_glibc.c"
             ;
 }
 ...
 MallocState *ta = 
# 464 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                  (
# 464 "project/radare2/libr/core/linux_heap_glibc.c"
                  MallocState
# 464 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                  *)calloc(1,sizeof(
# 464 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 464 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 if (!ta) {
  return 
# 466 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
        0
# 466 "project/radare2/libr/core/linux_heap_glibc.c"
             ;
 }

 if (main_arena_sym != 
# 469 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                      0xFFFFFFFFU
# 469 "project/radare2/libr/core/linux_heap_glibc.c"
                             ) {
  update_main_arena_32 (core, main_arena_sym, ta);
  *m_arena = main_arena_sym;
  core->dbg->main_arena_resolved = 
# 472 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                  1
# 472 "project/radare2/libr/core/linux_heap_glibc.c"
                                      ;
  free (ta);
  return 
# 474 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
        1
# 474 "project/radare2/libr/core/linux_heap_glibc.c"
            ;
 }
 while (addr_srch < libc_addr_end) {
  update_main_arena_32 (core, addr_srch, ta);
  if ( ta->top_32 > brk_start && ta->top_32 < brk_end &&
   ta->system_mem_32 == heap_sz) {

   *m_arena = addr_srch;
   free (ta);
   if (is_debugged) {
    core->dbg->main_arena_resolved = 
# 484 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                    1
# 484 "project/radare2/libr/core/linux_heap_glibc.c"
                                        ;
   }
   return 
# 486 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
         1
# 486 "project/radare2/libr/core/linux_heap_glibc.c"
             ;
  }
  addr_srch += sizeof (
# 488 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                      unsigned int
# 488 "project/radare2/libr/core/linux_heap_glibc.c"
                         );
 }
 
# 490 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
fprintf(__stderrp,
# 490 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 490 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 free (ta);
 return 
# 492 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
       0
# 492 "project/radare2/libr/core/linux_heap_glibc.c"
            ;
}

void print_heap_chunk_32(RCore *core) {
 RHeapChunk_32 *cnk = 
# 496 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                      (
# 496 "project/radare2/libr/core/linux_heap_glibc.c"
                      RHeapChunk_32
# 496 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                      *)calloc(1,sizeof(
# 496 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 497 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 497 "project/radare2/libr/core/linux_heap_glibc.c"
    chunk = core->offset;
 RConsPrintablePalette *pal = &r_cons_singleton ()->context->pal;
 ...
 (void) r_io_read_at (core->io, chunk, (
# 504 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                       unsigned char 
# 504 "project/radare2/libr/core/linux_heap_glibc.c"
                                           *)cnk, sizeof (*cnk));

 PRINT_GA ("struct malloc_chunk @ ");
 PRINTF_BA ("0x%"
# 507 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                "llx"
# 507 "project/radare2/libr/core/linux_heap_glibc.c"
                       , (
# 507 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                          unsigned long long
# 507 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 PRINT_GA (" {\n  prev_size = ");
 PRINTF_BA ("0x%"
# 509 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                "llx"
# 509 "project/radare2/libr/core/linux_heap_glibc.c"
                       , (
# 509 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                          unsigned long long
# 509 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 PRINT_GA (",\n  size = ");
 PRINTF_BA ("0x%"
# 511 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                "llx"
# 511 "project/radare2/libr/core/linux_heap_glibc.c"
                       , (
# 511 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                          unsigned long long
# 511 "project/radare2/libr/core/linux_heap_glibc.c"
                              )cnk->size & ~(NON_MAIN_ARENA | IS_MMAPPED | PREV_INUSE));
 PRINT_GA(",\n  flags: |N:");
 PRINTF_BA("%1"
# 513 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
              "llu"
# 513 "project/radare2/libr/core/linux_heap_glibc.c"
                     , (
# 513 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                        unsigned long long
# 513 "project/radare2/libr/core/linux_heap_glibc.c"
                            )(cnk->size & NON_MAIN_ARENA ) >> 2);
 PRINT_GA(" |M:");
 PRINTF_BA("%1"
# 515 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
              "llu"
# 515 "project/radare2/libr/core/linux_heap_glibc.c"
                     , (
# 515 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                        unsigned long long
# 515 "project/radare2/libr/core/linux_heap_glibc.c"
                            )(cnk->size & IS_MMAPPED) >> 1);
 PRINT_GA(" |P:");
 PRINTF_BA("%1"
# 517 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
              "llu"
# 517 "project/radare2/libr/core/linux_heap_glibc.c"
                     , (
# 517 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                        unsigned long long
# 517 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 PRINT_GA (",\n  fd = ");
 PRINTF_BA ("0x%"
# 520 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                "llx"
# 520 "project/radare2/libr/core/linux_heap_glibc.c"
                       , (
# 520 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                          unsigned long long
# 520 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 PRINT_GA (",\n  bk = ");
 PRINTF_BA ("0x%"
# 523 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                "llx"
# 523 "project/radare2/libr/core/linux_heap_glibc.c"
                       , (
# 523 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                          unsigned long long
# 523 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 if (cnk->size > SZ * 128) {
  PRINT_GA (",\n  fd-nextsize = ");
  PRINTF_BA ("0x%"
# 527 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 "llx"
# 527 "project/radare2/libr/core/linux_heap_glibc.c"
                        , (
# 527 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                           unsigned long long
# 527 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  PRINT_GA (",\n  bk-nextsize = ");
  PRINTF_BA ("0x%"
# 529 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 "llx"
# 529 "project/radare2/libr/core/linux_heap_glibc.c"
                        , (
# 529 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                           unsigned long long
# 529 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 533 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 533 "project/radare2/libr/core/linux_heap_glibc.c"
    size = ((cnk->size >> 3) << 3) - SZ * 2;
 if (size > SZ * 128) {
 ...
 if (data) {
  r_io_read_at (core->io, chunk + SZ * 2, (
# 541 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                          unsigned char 
# 541 "project/radare2/libr/core/linux_heap_glibc.c"
                                              *)data, size);
  PRINT_GA ("chunk data = \n");
  r_print_hexdump (core->print, chunk + SZ * 2, (
# 543 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                unsigned char 
# 543 "project/radare2/libr/core/linux_heap_glibc.c"
                                                    *)data, size, SZ * 8, SZ, 1);
  free (data);
 }
 free (cnk);
...
static 
# 549 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
      _Bool 
# 549 "project/radare2/libr/core/linux_heap_glibc.c"
           is_arena_32(RCore *core, 
# 549 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                     unsigned int 
# 549 "project/radare2/libr/core/linux_heap_glibc.c"
                                         m_arena, 
...
# 549 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 if (m_arena == m_state) {
  return 
# 551 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
        1
# 551 "project/radare2/libr/core/linux_heap_glibc.c"
            ;
 }
 MallocState *ta = 
# 553 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                  (
# 553 "project/radare2/libr/core/linux_heap_glibc.c"
                  MallocState
# 553 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                  *)calloc(1,sizeof(
# 553 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 553 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 if (!ta) {
  return 
# 555 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
        0
# 555 "project/radare2/libr/core/linux_heap_glibc.c"
             ;
 }
 if (!update_main_arena_32 (core, m_arena, ta)) {
  free (ta);
  return 
# 559 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
        0
# 559 "project/radare2/libr/core/linux_heap_glibc.c"
             ;
 }
 if (ta->next_32 == m_state) {
  free (ta);
  return 
# 563 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
        1
# 563 "project/radare2/libr/core/linux_heap_glibc.c"
            ;
 }
 while (ta->next_32 != 
# 565 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                       0xFFFFFFFFU 
# 565 "project/radare2/libr/core/linux_heap_glibc.c"
                               && ta->next_32 != m_arena) {
  if (!update_main_arena_32 (core, ta->next_32, ta)) {
   free (ta);
   return 
# 568 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
         0
# 568 "project/radare2/libr/core/linux_heap_glibc.c"
              ;
  }
  if (ta->next_32 == m_state) {
   free (ta);
   return 
# 572 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
         1
# 572 "project/radare2/libr/core/linux_heap_glibc.c"
             ;
  }
 }
 free (ta);
 return 
# 576 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
       0
# 576 "project/radare2/libr/core/linux_heap_glibc.c"
            ;
}

static int print_double_linked_list_bin_simple_32(RCore *core, 
# 579 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                               unsigned int 
# 579 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                   bin, MallocState *main_arena, 
# 579 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                                                                 unsigned int 
# 579 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                                                     brk_start) {
 
# 580 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 580 "project/radare2/libr/core/linux_heap_glibc.c"
    next = 
# 580 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
           0xFFFFFFFFU
# 580 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 int ret = 1;
 RHeapChunk_32 *cnk = 
# 582 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                      (
# 582 "project/radare2/libr/core/linux_heap_glibc.c"
                      RHeapChunk_32
# 582 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                      *)calloc(1,sizeof(
# 582 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 582 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 r_io_read_at (core->io, bin, (
# 589 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                              unsigned char 
# 589 "project/radare2/libr/core/linux_heap_glibc.c"
                                  *)cnk, sizeof (RHeapChunk_32));

 PRINTF_GA ("    0x%"
# 591 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                    "llx"
# 591 "project/radare2/libr/core/linux_heap_glibc.c"
                           , (
# 591 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                              unsigned long long
# 591 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 while (cnk->fd != bin) {
  PRINTF_BA ("->fd = 0x%"
# 596 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                        "llx"
# 596 "project/radare2/libr/core/linux_heap_glibc.c"
                               , (
# 596 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                  unsigned long long
# 596 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  next = cnk->fd;
  if (next < brk_start || next > main_arena->top_32) {
   PRINT_RA ("Double linked list corrupted\n");
   free (cnk);
   return -1;
  }
  r_io_read_at (core->io, next, (
# 603 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                unsigned char 
# 603 "project/radare2/libr/core/linux_heap_glibc.c"
                                    *)cnk, sizeof (RHeapChunk_32));
 }

 PRINTF_GA ("->fd = 0x%"
# 606 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                       "llx"
# 606 "project/radare2/libr/core/linux_heap_glibc.c"
                              , (
# 606 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                 unsigned long long
# 606 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 (void)r_io_read_at (core->io, next, (
# 614 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                     unsigned char 
# 614 "project/radare2/libr/core/linux_heap_glibc.c"
                                         *)cnk, sizeof (RHeapChunk_32));
 PRINTF_GA ("\n    0x%"
# 615 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                      "llx"
# 615 "project/radare2/libr/core/linux_heap_glibc.c"
                             , (
# 615 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                unsigned long long
# 615 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 while (cnk->bk != bin) {
  PRINTF_BA ("->bk = 0x%"
# 618 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                        "llx"
# 618 "project/radare2/libr/core/linux_heap_glibc.c"
                               , (
# 618 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                  unsigned long long
# 618 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  (void)r_io_read_at (core->io, next, (
# 625 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                      unsigned char 
# 625 "project/radare2/libr/core/linux_heap_glibc.c"
                                          *)cnk, sizeof (RHeapChunk_32));
 }

 PRINTF_GA ("->bk = 0x%"
# 628 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                       "llx"
# 628 "project/radare2/libr/core/linux_heap_glibc.c"
                              , (
# 628 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                 unsigned long long
# 628 "project/radare2/libr/core/linux_heap_glibc.c"
...
static int print_double_linked_list_bin_graph_32(RCore *core, 
# 633 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                              unsigned int 
# 633 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                  bin, MallocState *main_arena, 
# 633 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                                                                unsigned int 
# 633 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 635 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 635 "project/radare2/libr/core/linux_heap_glibc.c"
    next = 
# 635 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
           0xFFFFFFFFU
# 635 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 RANode *bin_node = 
# 637 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                   ((void *)0)
# 637 "project/radare2/libr/core/linux_heap_glibc.c"
                       , *prev_node = 
# 637 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                      ((void *)0)
# 637 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 637 "project/radare2/libr/core/linux_heap_glibc.c"
                                                             ;
 RHeapChunk_32 *cnk = 
# 638 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                      (
# 638 "project/radare2/libr/core/linux_heap_glibc.c"
                      RHeapChunk_32
# 638 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                      *)calloc(1,sizeof(
# 638 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 638 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 (void)r_io_read_at (core->io, bin, (
# 648 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                    unsigned char 
# 648 "project/radare2/libr/core/linux_heap_glibc.c"
                                        *)cnk, sizeof (RHeapChunk_32));
 
# 649 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
__builtin___snprintf_chk (
# 649 "project/radare2/libr/core/linux_heap_glibc.c"
title
# 649 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
, 
# 649 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 650 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
__builtin___snprintf_chk (
# 650 "project/radare2/libr/core/linux_heap_glibc.c"
chunk
# 650 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
, 
# 650 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 651 "project/radare2/libr/core/linux_heap_glibc.c"
                              ;
 bin_node = r_agraph_add_node (g, title, chunk, 
# 652 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                               ((void *)0)
# 652 "project/radare2/libr/core/linux_heap_glibc.c"
                                                   );
 prev_node = bin_node;
 ...
 while (cnk->bk != bin) {
  ...
  r_io_read_at (core->io, next, (
# 664 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                unsigned char 
# 664 "project/radare2/libr/core/linux_heap_glibc.c"
                                    *)cnk, sizeof (RHeapChunk_32));
  
# 665 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 __builtin___snprintf_chk (
# 665 "project/radare2/libr/core/linux_heap_glibc.c"
 title
# 665 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 , 
# 665 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 666 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 __builtin___snprintf_chk (
# 666 "project/radare2/libr/core/linux_heap_glibc.c"
 chunk
# 666 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 , 
# 666 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 667 "project/radare2/libr/core/linux_heap_glibc.c"
                               ;
  next_node = r_agraph_add_node (g, title, chunk, 
# 668 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                 ((void *)0)
# 668 "project/radare2/libr/core/linux_heap_glibc.c"
                                                     );
  r_agraph_add_edge (g, prev_node, next_node, 
# 669 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                             0
# 669 "project/radare2/libr/core/linux_heap_glibc.c"
                                                  );
  r_agraph_add_edge (g, next_node, prev_node, 
# 670 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                             0
# 670 "project/radare2/libr/core/linux_heap_glibc.c"
                                                  );
  prev_node = next_node;
 }

 r_agraph_add_edge (g, prev_node, bin_node, 
# 674 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                           0
# 674 "project/radare2/libr/core/linux_heap_glibc.c"
                                                );
 r_agraph_add_edge (g, bin_node, prev_node, 
# 675 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                           0
# 675 "project/radare2/libr/core/linux_heap_glibc.c"
                                                );
 r_agraph_print (g);
...
static int print_double_linked_list_bin_32(RCore *core, MallocState *main_arena, 
# 683 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                                                 unsigned int 
# 683 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                                     m_arena, 
# 683 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                                                              unsigned int 
# 683 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 688 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 688 "project/radare2/libr/core/linux_heap_glibc.c"
    brk_start = 
# 688 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                0xFFFFFFFFU
# 688 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 694 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 694 "project/radare2/libr/core/linux_heap_glibc.c"
    bin = main_arena->bins_32[num_bin];
 ...
 get_brks_32 (core, &brk_start, &brk_end);
 if (brk_start == 
# 701 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 0xFFFFFFFFU 
# 701 "project/radare2/libr/core/linux_heap_glibc.c"
                         || brk_end == 
# 701 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                       0xFFFFFFFFU
# 701 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 702 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 fprintf(__stderrp,
# 702 "project/radare2/libr/core/linux_heap_glibc.c"
 "No Heap section\n"
# 702 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 )
# 702 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 if (!graph || graph == 1) {
  ret = print_double_linked_list_bin_simple_32(core, bin, main_arena, initial_brk);
 } else {
  ret = print_double_linked_list_bin_graph_32(core, bin, main_arena, initial_brk);
 }
 PRINT_GA ("\n  }\n");
 return ret;
}

static void print_heap_bin_32(RCore *core, 
# 737 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                           unsigned int 
# 737 "project/radare2/libr/core/linux_heap_glibc.c"
                                               m_arena, MallocState *main_arena, const char *input) {
 int i, j = 2;
 
# 739 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 739 "project/radare2/libr/core/linux_heap_glibc.c"
    num_bin = 
# 739 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
              0xFFFFFFFFU
# 739 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 740 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 740 "project/radare2/libr/core/linux_heap_glibc.c"
    offset;
 RConsPrintablePalette *pal = &r_cons_singleton ()->context->pal;
 ...
 case '\0':
  ...
  for (i = 0; i < NBINS - 1; i++) {
   PRINTF_YA (" Bin %03d:\n", i + 1);
   print_double_linked_list_bin_32 (core, main_arena, m_arena, offset, i, 0);
  }
  PRINT_YA ("\n}\n");
  break;
 case ' ':
 ...
 case 'g':
  num_bin = r_num_get (
# 763 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                      ((void *)0)
# 763 "project/radare2/libr/core/linux_heap_glibc.c"
                          , input + j) - 1;
  if (num_bin > NBINS - 2) {
   
# 765 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
  fprintf(__stderrp,
# 765 "project/radare2/libr/core/linux_heap_glibc.c"
  "Error: 0 < bin <= %d\n", NBINS - 1
# 765 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
  )
# 765 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  PRINTF_YA ("  Bin %03"
# 768 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                       "llu"
# 768 "project/radare2/libr/core/linux_heap_glibc.c"
                              ":\n", (
# 768 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                      unsigned long long
# 768 "project/radare2/libr/core/linux_heap_glibc.c"
                                          )num_bin + 1);
  print_double_linked_list_bin_32 (core, main_arena, m_arena, offset, num_bin, j);
  break;
 }
}

static int print_single_linked_list_bin_32(RCore *core, MallocState *main_arena, 
# 774 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                                                 unsigned int 
# 774 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                                     m_arena, 
# 774 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                                                              unsigned int 
# 774 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 778 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 778 "project/radare2/libr/core/linux_heap_glibc.c"
    next = 
# 778 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
           0xFFFFFFFFU
# 778 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 778 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 RHeapChunk_32 *cnk = 
# 781 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                      (
# 781 "project/radare2/libr/core/linux_heap_glibc.c"
                      RHeapChunk_32
# 781 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                      *)calloc(1,sizeof(
# 781 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 781 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 if (!update_main_arena_32 (core, m_arena, main_arena)) {
  free (cnk);
  return 0;
 }

 
# 791 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 791 "project/radare2/libr/core/linux_heap_glibc.c"
    bin = main_arena->fastbinsY_32[bin_num];
 if (!bin) {
  free (cnk);
  return -1;
 }
 ...
 r_io_read_at (core->io, bin, (
# 798 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                              unsigned char 
# 798 "project/radare2/libr/core/linux_heap_glibc.c"
                                  *)&next, SZ);

 get_brks_32 (core, &brk_start, &brk_end);
 if (brk_start == 
# 801 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 0xFFFFFFFFU 
# 801 "project/radare2/libr/core/linux_heap_glibc.c"
                         || brk_end == 
# 801 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                       0xFFFFFFFFU
# 801 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 802 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 fprintf(__stderrp,
# 802 "project/radare2/libr/core/linux_heap_glibc.c"
 "No Heap section\n"
# 802 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 )
# 802 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 PRINTF_GA ("  fastbin %"
# 807 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                        "lld"
# 807 "project/radare2/libr/core/linux_heap_glibc.c"
                               " @ ", (
# 807 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                       unsigned long long
# 807 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 PRINTF_GA ("0x%"
# 808 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                "llx"
# 808 "project/radare2/libr/core/linux_heap_glibc.c"
                       " {\n   ", (
# 808 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                   unsigned long long
# 808 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 810 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 810 "project/radare2/libr/core/linux_heap_glibc.c"
    size = main_arena->top_32 - brk_start;

 
# 812 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 812 "project/radare2/libr/core/linux_heap_glibc.c"
    next_root = next, next_tmp = next, double_free = 
# 812 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                     0xFFFFFFFFU
# 812 "project/radare2/libr/core/linux_heap_glibc.c"
                                                            ;
 while (next && next >= brk_start && next < main_arena->top_32) {
  PRINTF_BA ("0x%"
# 814 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 "llx"
# 814 "project/radare2/libr/core/linux_heap_glibc.c"
                        , (
# 814 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                           unsigned long long
# 814 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  while (double_free == 
# 815 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                       0xFFFFFFFFU 
# 815 "project/radare2/libr/core/linux_heap_glibc.c"
                               && next_tmp && next_tmp >= brk_start && next_tmp <= main_arena->top_32) {
   r_io_read_at (core->io, next_tmp, (
# 816 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                     unsigned char 
# 816 "project/radare2/libr/core/linux_heap_glibc.c"
                                         *)cnk, sizeof (RHeapChunk_32));
  ...
  r_io_read_at (core->io, next, (
# 826 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                unsigned char 
# 826 "project/radare2/libr/core/linux_heap_glibc.c"
                                    *)cnk, sizeof (RHeapChunk_32));
  next = (!demangle) ? cnk->fd : PROTECT_PTR (next, cnk->fd);
  PRINTF_BA ("%s", next ? "->fd = " : "");
  if (cnk->prev_size > size || ((cnk->size >> 3) << 3) > size) {
   PRINTF_RA (" 0x%"
# 830 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                   "llx"
# 830 "project/radare2/libr/core/linux_heap_glibc.c"
                          , (
# 830 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                             unsigned long long
# 830 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  if (double_free == next) {
   PRINTF_RA ("0x%"
# 839 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                  "llx"
# 839 "project/radare2/libr/core/linux_heap_glibc.c"
                         , (
# 839 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                            unsigned long long
# 839 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 if (next && (next < brk_start || next >= main_arena->top_32)) {
  PRINTF_RA ("0x%"
# 848 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 "llx"
# 848 "project/radare2/libr/core/linux_heap_glibc.c"
                        , (
# 848 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                           unsigned long long
# 848 "project/radare2/libr/core/linux_heap_glibc.c"
...
void print_heap_fastbin_32(RCore *core, 
# 860 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                        unsigned int 
# 860 "project/radare2/libr/core/linux_heap_glibc.c"
                                            m_arena, MallocState *main_arena, 
# 860 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                                              unsigned int 
# 860 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                                  global_max_fast, const char *input, 
# 860 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                                                                                      _Bool 
# 860 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                                                                           demangle) {
...
# 862 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 862 "project/radare2/libr/core/linux_heap_glibc.c"
    num_bin = 
# 862 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
              0xFFFFFFFFU
# 862 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 case '\0':
  ...
  for (i = 1; i <= NFASTBINS; i++) {
   ...
   if (print_single_linked_list_bin_32 (core, main_arena, m_arena, offset, i - 1, demangle)) {
    PRINT_GA ("  Empty bin");
    PRINT_BA ("  0x0\n");
   }
  }
 ...
 case ' ':
  num_bin = r_num_get (
# 890 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                      ((void *)0)
# 890 "project/radare2/libr/core/linux_heap_glibc.c"
                          , input) - 1;
  if (num_bin >= NFASTBINS) {
   
# 892 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
  fprintf(__stderrp,
# 892 "project/radare2/libr/core/linux_heap_glibc.c"
  "Error: 0 < bin <= %d\n", NFASTBINS
# 892 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
  )
# 892 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  if (print_single_linked_list_bin_32(core, main_arena, m_arena, offset, num_bin, demangle)) {
   PRINT_GA (" Empty bin");
   PRINT_BA (" 0x0\n");
  }
  break;
...
static RTcache_32* tcache_new_32 (RCore *core) {
 
# 904 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
do { if (!(
# 904 "project/radare2/libr/core/linux_heap_glibc.c"
core
# 904 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 904 "project/radare2/libr/core/linux_heap_glibc.c"
"core"
# 904 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
, 904); return (((void *)0)); } } while (0)
# 904 "project/radare2/libr/core/linux_heap_glibc.c"
                                 ;
 RTcache_32 *tcache = 
# 905 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                       (
# 905 "project/radare2/libr/core/linux_heap_glibc.c"
                       RTcache_32
# 905 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                       *)calloc(1,sizeof(
# 905 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 905 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 if (core->dbg->glibc_version >= TCACHE_NEW_VERSION) {
  tcache->type = NEW;
  tcache->RHeapTcache.heap_tcache = 
# 908 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                   (
# 908 "project/radare2/libr/core/linux_heap_glibc.c"
                                   RHeapTcache_32
# 908 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                   *)calloc(1,sizeof(
# 908 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 908 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  tcache->type = OLD;
  tcache->RHeapTcache.heap_tcache_pre_230 = 
# 911 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                           (
# 911 "project/radare2/libr/core/linux_heap_glibc.c"
...
static void tcache_free_32 (RTcache_32* tcache) {
 
# 917 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
do { if (!(
# 917 "project/radare2/libr/core/linux_heap_glibc.c"
tcache
# 917 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 917 "project/radare2/libr/core/linux_heap_glibc.c"
...
static 
# 924 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
      _Bool 
# 924 "project/radare2/libr/core/linux_heap_glibc.c"
           tcache_read_32 (RCore *core, 
# 924 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                          unsigned int 
# 924 "project/radare2/libr/core/linux_heap_glibc.c"
                                              tcache_start, RTcache_32* tcache) {
 
# 925 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
do { if (!(
# 925 "project/radare2/libr/core/linux_heap_glibc.c"
core && tcache
# 925 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 925 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 927 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                          unsigned char 
# 927 "project/radare2/libr/core/linux_heap_glibc.c"
                                              *)tcache->RHeapTcache.heap_tcache, sizeof (RHeapTcache_32))
  : r_io_read_at (core->io, tcache_start, (
# 928 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                          unsigned char 
# 928 "project/radare2/libr/core/linux_heap_glibc.c"
                                              *)tcache->RHeapTcache.heap_tcache_pre_230, sizeof (RHeapTcachePre230_32));
}

static int tcache_get_count_32 (RTcache_32* tcache, int index) {
 
# 932 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
do { if (!(
# 932 "project/radare2/libr/core/linux_heap_glibc.c"
tcache
# 932 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 932 "project/radare2/libr/core/linux_heap_glibc.c"
...
static 
# 938 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
      unsigned int 
# 938 "project/radare2/libr/core/linux_heap_glibc.c"
          tcache_get_entry_32 (RTcache_32* tcache, int index) {
 
# 939 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
do { if (!(
# 939 "project/radare2/libr/core/linux_heap_glibc.c"
tcache
# 939 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 939 "project/radare2/libr/core/linux_heap_glibc.c"
...
static void tcache_print_32 (RCore *core, RTcache_32* tcache, 
# 945 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                                 _Bool 
# 945 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                      demangle) {
 
# 946 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
do { if (!(
# 946 "project/radare2/libr/core/linux_heap_glibc.c"
core && tcache
# 946 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 946 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 947 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 947 "project/radare2/libr/core/linux_heap_glibc.c"
    tcache_fd = 
# 947 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                0xFFFFFFFFU
# 947 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 948 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 948 "project/radare2/libr/core/linux_heap_glibc.c"
    tcache_tmp = 
# 948 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 0xFFFFFFFFU
# 948 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 for (i = 0; i < TCACHE_MAX_BINS; i++) {
  int count = tcache_get_count_32 (tcache, i);
  
# 953 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 unsigned int 
# 953 "project/radare2/libr/core/linux_heap_glibc.c"
     entry = tcache_get_entry_32 (tcache, i);
  if (entry == 
# 954 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
              0xFFFFFFFFU
# 954 "project/radare2/libr/core/linux_heap_glibc.c"
                     ) {
   break;
  }
  if (count > 0) {
   ...
   PRINTF_BA ("0x%"
# 964 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                  "llx"
# 964 "project/radare2/libr/core/linux_heap_glibc.c"
                         , (
# 964 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                            unsigned long long
# 964 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 969 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
    _Bool 
# 969 "project/radare2/libr/core/linux_heap_glibc.c"
         r = r_io_read_at (core->io, tcache_fd, (
# 969 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                 unsigned char 
# 969 "project/radare2/libr/core/linux_heap_glibc.c"
                                                     *)&tcache_tmp, sizeof (
...
# 969 "project/radare2/libr/core/linux_heap_glibc.c"
     ...
     tcache_tmp = (!demangle)
      ? r_read_le32(&tcache_tmp)
      : PROTECT_PTR (tcache_fd, r_read_le32(&tcache_tmp));
     PRINTF_BA ("->0x%"
# 976 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                      "llx"
# 976 "project/radare2/libr/core/linux_heap_glibc.c"
                             , (
# 976 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                unsigned long long
# 976 "project/radare2/libr/core/linux_heap_glibc.c"
                                    )(tcache_tmp - TC_HDR_SZ));
...
static void print_tcache_instance_32(RCore *core, 
# 985 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                   unsigned int 
# 985 "project/radare2/libr/core/linux_heap_glibc.c"
                                                       m_arena, MallocState *main_arena, 
# 985 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                                                         _Bool 
# 985 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 986 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
do { if (!(
# 986 "project/radare2/libr/core/linux_heap_glibc.c"
core && core->dbg && core->dbg->maps
# 986 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 986 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 986 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 const int tcache = r_config_get_i (core->config, "dbg.glibc.tcache");
 if (!tcache || m_arena == 
# 989 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                          0xFFFFFFFFU
# 989 "project/radare2/libr/core/linux_heap_glibc.c"
                                 ) {
  return;
 }
 
# 992 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 992 "project/radare2/libr/core/linux_heap_glibc.c"
    brk_start = 
# 992 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                0xFFFFFFFFU
# 992 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 994 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 994 "project/radare2/libr/core/linux_heap_glibc.c"
    tcache_start = 
# 994 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                   0xFFFFFFFFU
# 994 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 998 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 998 "project/radare2/libr/core/linux_heap_glibc.c"
    fc_offset = tcache_chunk_size_32 (core, brk_start);
 initial_brk = brk_start + fc_offset;
 if (brk_start == 
# 1000 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 0xFFFFFFFFU 
# 1000 "project/radare2/libr/core/linux_heap_glibc.c"
                         || brk_end == 
# 1000 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                       0xFFFFFFFFU 
# 1000 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1001 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 fprintf(__stderrp,
# 1001 "project/radare2/libr/core/linux_heap_glibc.c"
 "No heap section\n"
# 1001 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 )
# 1001 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 RTcache_32* r_tcache = tcache_new_32 (core);
 if (!r_tcache) {
  return;
 }
 if (!tcache_read_32 (core, tcache_start, r_tcache)) {
  return;
 }

 PRINT_GA ("Tcache main arena @");
 PRINTF_BA (" 0x%"
# 1014 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 "llx"
# 1014 "project/radare2/libr/core/linux_heap_glibc.c"
                        "\n", (
# 1014 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                               unsigned long long
# 1014 "project/radare2/libr/core/linux_heap_glibc.c"
                                   )m_arena);
 tcache_print_32 (core, r_tcache, demangle);

 if (main_arena->next_32 != m_arena) {
  
# 1018 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 unsigned int 
# 1018 "project/radare2/libr/core/linux_heap_glibc.c"
     mmap_start = 
# 1018 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                  0xFFFFFFFFU
# 1018 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1018 "project/radare2/libr/core/linux_heap_glibc.c"
                                                 ;
  MallocState *ta = 
# 1019 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                   (
# 1019 "project/radare2/libr/core/linux_heap_glibc.c"
                   MallocState
# 1019 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                   *)calloc(1,sizeof(
# 1019 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1019 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  if (!ta) {
   free(ta);
   tcache_free_32 (r_tcache);
   return;
  }
  ta->next_32 = main_arena->next_32;
  while (is_arena_32 (core, m_arena, ta->next_32) && ta->next_32 != m_arena) {
   PRINT_YA ("Tcache thread arena @ ");
   PRINTF_BA (" 0x%"
# 1028 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                   "llx"
# 1028 "project/radare2/libr/core/linux_heap_glibc.c"
                          , (
# 1028 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                             unsigned long long
# 1028 "project/radare2/libr/core/linux_heap_glibc.c"
                                 )ta->next_32);
   mmap_start = ((ta->next_32 >> 16) << 16);
   tcache_start = mmap_start + sizeof (RHeapInfo_32) + sizeof (RHeap_MallocState_tcache_32) + MMAP_ALIGN_32;
   ...
   if (ta->attached_threads) {
    PRINT_BA ("\n");
    tcache_read_32 (core, tcache_start, r_tcache);
    tcache_print_32 (core, r_tcache, demangle);
   } else {
    PRINT_GA (" free\n");
   }
...
static void print_heap_segment_32(RCore *core, MallocState *main_arena,
  
# 1051 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 unsigned int 
# 1051 "project/radare2/libr/core/linux_heap_glibc.c"
     m_arena, 
# 1051 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
              unsigned int 
# 1051 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1051 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                           unsigned int 
# 1051 "project/radare2/libr/core/linux_heap_glibc.c"
                               global_max_fast, int format_out) {
...
# 1058 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 1058 "project/radare2/libr/core/linux_heap_glibc.c"
    brk_start = 
# 1058 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                0xFFFFFFFFU
# 1058 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1058 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                   0xFFFFFFFFU
# 1058 "project/radare2/libr/core/linux_heap_glibc.c"
                                          , size_tmp, min_size = SZ * 4;
 
# 1059 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 1059 "project/radare2/libr/core/linux_heap_glibc.c"
    tcache_fd = 
# 1059 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                0xFFFFFFFFU
# 1059 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1060 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 1060 "project/radare2/libr/core/linux_heap_glibc.c"
    initial_brk = 
# 1060 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                  0xFFFFFFFFU
# 1060 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1060 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 if (m_arena == m_state) {
  get_brks_32 (core, &brk_start, &brk_end);
  if (tcache) {
   initial_brk = ((brk_start >> 12) << 12) + HDR_SZ_32;
   if (r_config_get_b (core->config, "cfg.debug")) {
    tcache_initial_brk = initial_brk;
   }
   initial_brk += (glibc_version < 230)
    ? sizeof (RHeapTcachePre230_32)
    : sizeof (RHeapTcache_32);
  } else {
   initial_brk = (brk_start >> 12) << 12;
  }
 } else {
  brk_start = ((m_state >> 16) << 16) ;
  brk_end = brk_start + main_arena->system_mem_32;
  if (tcache) {
   tcache_initial_brk = brk_start + sizeof (RHeapInfo_32) + sizeof (RHeap_MallocState_tcache_32) + MMAP_ALIGN_32;
   initial_brk = tcache_initial_brk + offset;
  } else {
   initial_brk = brk_start + sizeof (RHeapInfo_32) + sizeof (RHeap_MallocState_32) + MMAP_OFFSET;
  }
 }

 if (brk_start == 
# 1091 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 0xFFFFFFFFU 
# 1091 "project/radare2/libr/core/linux_heap_glibc.c"
                         || brk_end == 
# 1091 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                       0xFFFFFFFFU 
# 1091 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1092 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 fprintf(__stderrp,
# 1092 "project/radare2/libr/core/linux_heap_glibc.c"
 "No Heap section\n"
# 1092 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 )
# 1092 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1096 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 1096 "project/radare2/libr/core/linux_heap_glibc.c"
    next_chunk = initial_brk, prev_chunk = next_chunk;
 RHeapChunk_32 *cnk = 
# 1097 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                      (
# 1097 "project/radare2/libr/core/linux_heap_glibc.c"
                      RHeapChunk_32
# 1097 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                      *)calloc(1,sizeof(
# 1097 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1097 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 RHeapChunk_32 *cnk_next = 
# 1101 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                           (
# 1101 "project/radare2/libr/core/linux_heap_glibc.c"
                           RHeapChunk_32
# 1101 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                           *)calloc(1,sizeof(
# 1101 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1101 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 RANode *top = 
# 1133 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
              { 0 }
# 1133 "project/radare2/libr/core/linux_heap_glibc.c"
                     , *chunk_node = 
# 1133 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                     { 0 }
# 1133 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1135 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
_Bool 
# 1135 "project/radare2/libr/core/linux_heap_glibc.c"
     first_node = 
# 1135 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                  1
# 1135 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 if (!r_io_read_at (core->io, next_chunk, (
# 1140 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                          unsigned char 
# 1140 "project/radare2/libr/core/linux_heap_glibc.c"
                                              *)cnk, sizeof (RHeapChunk_32))) {
  
# 1141 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 fprintf(__stderrp,
# 1141 "project/radare2/libr/core/linux_heap_glibc.c"
 "Cannot read"
# 1141 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 )
# 1141 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1150 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned long long 
# 1150 "project/radare2/libr/core/linux_heap_glibc.c"
     prev_chunk_addr;
 
# 1151 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned long long 
# 1151 "project/radare2/libr/core/linux_heap_glibc.c"
     prev_chunk_size;
 PJ *pj = 
# 1152 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
         ((void *)0)
# 1152 "project/radare2/libr/core/linux_heap_glibc.c"
             ;
 ...
 case 'g':
  ...
  top_title = r_str_newf ("Top chunk @ 0x%"
# 1172 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                          "llx"
# 1172 "project/radare2/libr/core/linux_heap_glibc.c"
                                                 "\n", (
# 1172 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                        unsigned long long
# 1172 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 while (next_chunk && next_chunk >= brk_start && next_chunk < main_arena->top_32) {
  if (size_tmp < min_size || next_chunk + size_tmp > main_arena->top_32) {
   const char *status = "corrupted";
   switch (format_out) {
   case 'c':
    PRINT_YA ("\n  Malloc chunk @ ");
    PRINTF_BA ("0x%"
# 1181 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                   "llx"
# 1181 "project/radare2/libr/core/linux_heap_glibc.c"
                          " ", (
# 1181 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                unsigned long long
# 1181 "project/radare2/libr/core/linux_heap_glibc.c"
    ...
    PRINTF_RA ("[%s]\n",status);
    PRINTF_RA ("   size: 0x%"
# 1183 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                            "llx"
# 1183 "project/radare2/libr/core/linux_heap_glibc.c"
                                   "\n   fd: 0x%"
# 1183 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                 "llx"
# 1183 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1183 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                          "\n",
    (
# 1184 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
    unsigned long long
# 1184 "project/radare2/libr/core/linux_heap_glibc.c"
        )cnk->size, (
# 1184 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                     unsigned long long
# 1184 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1184 "project/radare2/libr/core/linux_heap_glibc.c"
   ...
   case '*':
    ...
    char *name = r_str_newf ("chunk.corrupted.%06" 
# 1197 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                  "llx" 
# 1197 "project/radare2/libr/core/linux_heap_glibc.c"
                                                          , ((prev_chunk >> 4) & 0xffffULL));
    r_cons_printf ("f %s %d 0x%"
# 1198 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                               "llx"
# 1198 "project/radare2/libr/core/linux_heap_glibc.c"
                                      "\n", name, (int)cnk->size, (
# 1198 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                                   unsigned long long
# 1198 "project/radare2/libr/core/linux_heap_glibc.c"
    ...
    break;
   case 'g':
    node_title = r_str_newf ("  Malloc chunk @ 0x%"
# 1202 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                  "llx"
# 1202 "project/radare2/libr/core/linux_heap_glibc.c"
                                                         " ", (
# 1202 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                               unsigned long long
# 1202 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                   )prev_chunk);
    node_data = r_str_newf ("[corrupted] size: 0x%"
# 1203 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                  "llx"
# 1203 "project/radare2/libr/core/linux_heap_glibc.c"
                                                         "\n fd: 0x%"
# 1203 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                                     "llx"
# 1203 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1204 "project/radare2/libr/core/linux_heap_glibc.c"
    "\nHeap graph could not be recovered\n", (
# 1204 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                              unsigned long long
# 1204 "project/radare2/libr/core/linux_heap_glibc.c"
                                                  )cnk->size, (
# 1204 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
...
# 1205 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                ((void *)0)
# 1205 "project/radare2/libr/core/linux_heap_glibc.c"
                                                    );
    if (first_node) {
     first_node = 
# 1207 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 0
# 1207 "project/radare2/libr/core/linux_heap_glibc.c"
                      ;
    }
    break;
   }
  ...
  prev_chunk_addr = (
# 1214 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                    unsigned long long
# 1214 "project/radare2/libr/core/linux_heap_glibc.c"
                        )prev_chunk;
  prev_chunk_size = (((
# 1215 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                      unsigned long long
# 1215 "project/radare2/libr/core/linux_heap_glibc.c"
                          )cnk->size) >> 3) << 3;

  
# 1217 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 _Bool 
# 1217 "project/radare2/libr/core/linux_heap_glibc.c"
      fastbin = size_tmp >= SZ * 4 && size_tmp <= global_max_fast;
  
# 1218 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 _Bool 
# 1218 "project/radare2/libr/core/linux_heap_glibc.c"
      is_free = 
# 1218 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                0
# 1218 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1222 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
  unsigned int 
# 1222 "project/radare2/libr/core/linux_heap_glibc.c"
      idx = (
# 1222 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
             unsigned int
# 1222 "project/radare2/libr/core/linux_heap_glibc.c"
                )main_arena->fastbinsY_32[i];
   (void)r_io_read_at (core->io, idx, (
# 1223 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                      unsigned char 
# 1223 "project/radare2/libr/core/linux_heap_glibc.c"
                                          *)cnk, sizeof (RHeapChunk_32));
   
# 1224 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
  unsigned int 
# 1224 "project/radare2/libr/core/linux_heap_glibc.c"
      next = get_next_pointer_32 (core, idx, cnk->fd);
   if (prev_chunk == idx && idx && !next) {
    is_free = 
# 1226 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
             1
# 1226 "project/radare2/libr/core/linux_heap_glibc.c"
                 ;
   }
   while (next && next >= brk_start && next < main_arena->top_32) {
    if (prev_chunk == idx || prev_chunk == next || idx == next) {
     is_free = 
# 1230 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
              1
# 1230 "project/radare2/libr/core/linux_heap_glibc.c"
                  ;
     if (idx == next) {
      double_free = 
# 1232 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                   1
# 1232 "project/radare2/libr/core/linux_heap_glibc.c"
                       ;
      break;
     }
     (void)r_io_read_at (core->io, next, (
# 1235 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                         unsigned char 
# 1235 "project/radare2/libr/core/linux_heap_glibc.c"
                                             *)cnk_next, sizeof (RHeapChunk_32));
     
# 1236 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
    unsigned int 
# 1236 "project/radare2/libr/core/linux_heap_glibc.c"
        next_node = get_next_pointer_32 (core, next, cnk_next->fd);

     while (next_node && next_node >= brk_start && next_node < main_arena->top_32) {
      if (prev_chunk == next_node) {
       double_free = 
# 1240 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                    1
# 1240 "project/radare2/libr/core/linux_heap_glibc.c"
                        ;
       break;
      }
      (void)r_io_read_at (core->io, next_node, (
# 1243 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                               unsigned char 
# 1243 "project/radare2/libr/core/linux_heap_glibc.c"
                                                   *)cnk_next, sizeof (RHeapChunk_32));
      next_node = get_next_pointer_32 (core, next_node, cnk_next->fd);
     }
     if (double_free) {
      break;
     }
    ...
    (void)r_io_read_at (core->io, next, (
# 1250 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                        unsigned char 
# 1250 "project/radare2/libr/core/linux_heap_glibc.c"
                                            *)cnk, sizeof (RHeapChunk_32));
    next = get_next_pointer_32 (core, next, cnk->fd);
   }
   if (double_free) {
    PRINT_RA (" Double free in simple-linked list detected ");
    break;
   }
   prev_chunk_size = ((i + 1) * HDR_SZ_32) + HDR_SZ_32;
  }

  if (tcache) {
   RTcache_32* tcache_heap = tcache_new_32 (core);
   if (!tcache_heap) {
    r_cons_canvas_free (can);
    r_config_hold_restore (hc);
    r_config_hold_free (hc);
   ...
   tcache_read_32 (core, tcache_initial_brk, tcache_heap);
   size_t i;
   for (i = 0; i < TCACHE_MAX_BINS; i++) {
    int count = tcache_get_count_32 (tcache_heap, i);
    
# 1275 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
   unsigned int 
# 1275 "project/radare2/libr/core/linux_heap_glibc.c"
       entry = tcache_get_entry_32 (tcache_heap, i);
    if (count > 0) {
     if (entry - SZ * 2 == prev_chunk) {
      is_free = 
# 1278 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
               1
# 1278 "project/radare2/libr/core/linux_heap_glibc.c"
                   ;
      prev_chunk_size = ((i + 1) * TC_HDR_SZ + TC_SZ_32);
      break;
     }
     if (count > 1) {
      tcache_fd = entry;
...
# 1286 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
      _Bool 
# 1286 "project/radare2/libr/core/linux_heap_glibc.c"
           r = r_io_read_at (core->io, tcache_fd, (
# 1286 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                   unsigned char
# 1286 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1286 "project/radare2/libr/core/linux_heap_glibc.c"
       ...
       tcache_tmp = get_next_pointer_32 (core, tcache_fd, r_read_le32(&tcache_tmp));
       if (tcache_tmp - SZ * 2 == prev_chunk) {
        is_free = 
# 1292 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 1
# 1292 "project/radare2/libr/core/linux_heap_glibc.c"
                     ;
        prev_chunk_size = ((i + 1) * TC_HDR_SZ + TC_SZ_32);
        break;
       }
       tcache_fd = (
# 1296 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                   unsigned long long
# 1296 "project/radare2/libr/core/linux_heap_glibc.c"
                       )tcache_tmp;
      }
     }
    }
   }
   tcache_free_32 (tcache_heap);
  }

  next_chunk += size_tmp;
  prev_chunk = next_chunk;
  r_io_read_at (core->io, next_chunk, (
# 1306 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                      unsigned char 
# 1306 "project/radare2/libr/core/linux_heap_glibc.c"
                                          *)cnk, sizeof (RHeapChunk_32));
  size_tmp = (cnk->size >> 3) << 3;
  ...
  case 'c':
   PRINT_YA ("\n  Malloc chunk @ ");
   PRINTF_BA ("0x%"
# 1327 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                  "llx"
# 1327 "project/radare2/libr/core/linux_heap_glibc.c"
                         " ", prev_chunk_addr);
   PRINT_GA ("[size: ");
   PRINTF_BA ("0x%"
# 1329 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                  "llx"
# 1329 "project/radare2/libr/core/linux_heap_glibc.c"
                         , prev_chunk_size);
   PRINTF_GA ("][%s]",status);
   break;
  case 'j':
  ...
  case '*':
   ...
   char *name = r_str_newf ("chunk.%06" 
# 1341 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                       "llx"
# 1341 "project/radare2/libr/core/linux_heap_glibc.c"
                                              , ((prev_chunk_addr>>4) & 0xffffULL));
   r_cons_printf ("f %s %d 0x%"
# 1342 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                              "llx"
# 1342 "project/radare2/libr/core/linux_heap_glibc.c"
                                     "\n", name, (int)prev_chunk_size, (
# 1342 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                                        unsigned long long
# 1342 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                            )prev_chunk_addr);
  ...
  case 'g':
   node_title = r_str_newf ("  Malloc chunk @ 0x%"
# 1346 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                 "llx"
# 1346 "project/radare2/libr/core/linux_heap_glibc.c"
                                                        " ", (
# 1346 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                              unsigned long long
# 1346 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                  )prev_chunk_addr);
   node_data = r_str_newf ("size: 0x%"
# 1347 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                     "llx"
# 1347 "project/radare2/libr/core/linux_heap_glibc.c"
                                            " status: %s\n", (
# 1347 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                              unsigned long long
# 1347 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                  )prev_chunk_size, status);
   chunk_node = r_agraph_add_node (g, node_title, node_data, 
# 1348 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                            ((void *)0)
# 1348 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                );
   if (first_node) {
    first_node = 
# 1350 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                0
# 1350 "project/radare2/libr/core/linux_heap_glibc.c"
                     ;
   } else {
    r_agraph_add_edge (g, prev_node, chunk_node, 
# 1352 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                0
# 1352 "project/radare2/libr/core/linux_heap_glibc.c"
                                                     );
   }
 ...
 case 'c':
  PRINT_YA ("\n  Top chunk @ ");
  PRINTF_BA ("0x%"
# 1362 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 "llx"
# 1362 "project/radare2/libr/core/linux_heap_glibc.c"
                        , (
# 1362 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                           unsigned long long
# 1362 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  PRINT_GA (" - [brk_start: ");
  PRINTF_BA ("0x%"
# 1364 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 "llx"
# 1364 "project/radare2/libr/core/linux_heap_glibc.c"
                        , (
# 1364 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                           unsigned long long
# 1364 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  PRINT_GA (", brk_end: ");
  PRINTF_BA ("0x%"
# 1366 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 "llx"
# 1366 "project/radare2/libr/core/linux_heap_glibc.c"
                        , (
# 1366 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                           unsigned long long
# 1366 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 case 'j':
  pj_end (pj);
  pj_kn (pj, "top", main_arena->top_32);
  pj_kn (pj, "brk", brk_start);
  pj_kn (pj, "end", brk_end);
  pj_end (pj);
  
# 1375 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 r_cons_strcat (
# 1375 "project/radare2/libr/core/linux_heap_glibc.c"
 pj_string (pj)
# 1375 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 )
# 1375 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 case '*':
  r_cons_printf ("fs-\n");
  r_cons_printf ("f heap.top = 0x%08"
# 1380 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                    "llx"
# 1380 "project/radare2/libr/core/linux_heap_glibc.c"
                                           "\n", (
# 1380 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                  unsigned long long
# 1380 "project/radare2/libr/core/linux_heap_glibc.c"
                                                      )main_arena->top_32);
  r_cons_printf ("f heap.brk = 0x%08"
# 1381 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                    "llx"
# 1381 "project/radare2/libr/core/linux_heap_glibc.c"
                                           "\n", (
# 1381 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                  unsigned long long
# 1381 "project/radare2/libr/core/linux_heap_glibc.c"
                                                      )brk_start);
  r_cons_printf ("f heap.end = 0x%08"
# 1382 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                    "llx"
# 1382 "project/radare2/libr/core/linux_heap_glibc.c"
                                           "\n", (
# 1382 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                  unsigned long long
# 1382 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1385 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                  ((void *)0)
# 1385 "project/radare2/libr/core/linux_heap_glibc.c"
                                                      );
  if (!first_node) {
   r_agraph_add_edge (g, prev_node, top, 
# 1387 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                        0
# 1387 "project/radare2/libr/core/linux_heap_glibc.c"
                                             );
   free (node_data);
   free (node_title);
  }
...
void print_malloc_states_32( RCore *core, 
# 1406 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                          unsigned int 
# 1406 "project/radare2/libr/core/linux_heap_glibc.c"
                                              m_arena, MallocState *main_arena) {
 MallocState *ta = 
# 1407 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                  (
# 1407 "project/radare2/libr/core/linux_heap_glibc.c"
                  MallocState
# 1407 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                  *)calloc(1,sizeof(
# 1407 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1407 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 PRINT_YA ("main_arena @ ");
 PRINTF_BA ("0x%"
# 1414 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                "llx"
# 1414 "project/radare2/libr/core/linux_heap_glibc.c"
                       "\n", (
# 1414 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                              unsigned long long
# 1414 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 if (main_arena->next_32 != m_arena) {
  ...
  while (is_arena_32 (core, m_arena, ta->next_32) && ta->next_32 != m_arena) {
   ...
   PRINTF_BA ("0x%"
# 1419 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                  "llx"
# 1419 "project/radare2/libr/core/linux_heap_glibc.c"
                         , (
# 1419 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                            unsigned long long
# 1419 "project/radare2/libr/core/linux_heap_glibc.c"
...
void print_inst_minfo_32(RHeapInfo_32 *heap_info, 
# 1434 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                   unsigned int 
# 1434 "project/radare2/libr/core/linux_heap_glibc.c"
                                                       hinfo) {
 RConsPrintablePalette *pal = &r_cons_singleton ()->context->pal;

 PRINT_YA ("malloc_info @ ");
 PRINTF_BA ("0x%"
# 1438 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                "llx"
# 1438 "project/radare2/libr/core/linux_heap_glibc.c"
                       , (
# 1438 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                          unsigned long long
# 1438 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 PRINT_YA (" {\n  ar_ptr = " );
 PRINTF_BA ("0x%"
# 1440 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                "llx"
# 1440 "project/radare2/libr/core/linux_heap_glibc.c"
                       "\n", (
# 1440 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                              unsigned long long
# 1440 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 PRINT_YA ("  prev = ");
 PRINTF_BA ("0x%"
# 1442 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                "llx"
# 1442 "project/radare2/libr/core/linux_heap_glibc.c"
                       "\n", (
# 1442 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                              unsigned long long
# 1442 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 PRINT_YA ("  size = ");
 PRINTF_BA ("0x%"
# 1444 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                "llx"
# 1444 "project/radare2/libr/core/linux_heap_glibc.c"
                       "\n", (
# 1444 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                              unsigned long long
# 1444 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 PRINTF_BA ("0x%"
# 1446 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                "llx"
# 1446 "project/radare2/libr/core/linux_heap_glibc.c"
                       "\n", (
# 1446 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                              unsigned long long
# 1446 "project/radare2/libr/core/linux_heap_glibc.c"
...
void print_malloc_info_32(RCore *core, 
# 1450 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                       unsigned int 
# 1450 "project/radare2/libr/core/linux_heap_glibc.c"
                                           m_state, 
# 1450 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                    unsigned int 
# 1450 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1451 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 1451 "project/radare2/libr/core/linux_heap_glibc.c"
    h_info;
 RConsPrintablePalette *pal = &r_cons_singleton ()->context->pal;

 if (malloc_state == m_state) {
  PRINT_RA ("main_arena does not have an instance of malloc_info\n");
 } else if (is_arena_32 (core, malloc_state, m_state)) {

  h_info = (malloc_state >> 16) << 16;
  RHeapInfo_32 *heap_info = 
# 1459 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                            (
# 1459 "project/radare2/libr/core/linux_heap_glibc.c"
                            RHeapInfo_32
# 1459 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                            *)calloc(1,sizeof(
# 1459 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1459 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  r_io_read_at (core->io, h_info, (
# 1463 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                  unsigned char
# 1463 "project/radare2/libr/core/linux_heap_glibc.c"
                                     *)heap_info, sizeof (RHeapInfo_32));
  print_inst_minfo_32 (heap_info, h_info);
  MallocState *ms = 
# 1465 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                   (
# 1465 "project/radare2/libr/core/linux_heap_glibc.c"
                   MallocState
# 1465 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                   *)calloc(1,sizeof(
# 1465 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1465 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  while (heap_info->prev != 0x0 && heap_info->prev != 
# 1471 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                     0xFFFFFFFFU
# 1471 "project/radare2/libr/core/linux_heap_glibc.c"
                                                            ) {
   if (!update_main_arena_32 (core, malloc_state, ms)) {
    free (ms);
    free (heap_info);
    return;
   }
   if ((ms->top_32 >> 16) << 16 != h_info) {
    h_info = (ms->top_32 >> 16) << 16;
    r_io_read_at (core->io, h_info, (
# 1479 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                    unsigned char
# 1479 "project/radare2/libr/core/linux_heap_glibc.c"
                                       *)heap_info, sizeof (RHeapInfo_32));
    print_inst_minfo_32 (heap_info, h_info);
   }
  }
...
# 1509 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
((void *)0)

# 1510 "project/radare2/libr/core/linux_heap_glibc.c"
};

static int cmd_dbg_map_heap_glibc_32(RCore *core, const char *input) {
 static 
# 1513 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
       unsigned int 
# 1513 "project/radare2/libr/core/linux_heap_glibc.c"
           m_arena = 
# 1513 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                     0xFFFFFFFFU
# 1513 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1516 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
unsigned int 
# 1516 "project/radare2/libr/core/linux_heap_glibc.c"
    global_max_fast = (64 * SZ / 4);

 MallocState *main_arena = 
# 1518 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                          (
# 1518 "project/radare2/libr/core/linux_heap_glibc.c"
                          MallocState
# 1518 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                          *)calloc(1,sizeof(
# 1518 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1518 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 if (!main_arena) {
  return 
# 1520 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
        0
# 1520 "project/radare2/libr/core/linux_heap_glibc.c"
             ;
 }

 r_config_set_b (core->config, "dbg.glibc.tcache", is_tcache_32 (core));

 int format = 'c';
 
# 1526 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
_Bool 
# 1526 "project/radare2/libr/core/linux_heap_glibc.c"
     get_state = 
# 1526 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 0
# 1526 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 case ' ' :
  m_state = r_num_get (
# 1530 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                      ((void *)0)
# 1530 "project/radare2/libr/core/linux_heap_glibc.c"
                          , input);
  get_state = 
# 1531 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
             1
# 1531 "project/radare2/libr/core/linux_heap_glibc.c"
                 ;
 case '\0':
  if (r_resolve_main_arena_32 (core, &m_arena)) {
   ...
   if (is_arena_32 (core, m_arena, m_state)) {
    if (!update_main_arena_32 (core, m_state, main_arena)) {
     break;
    }
    print_heap_segment_32 (core, main_arena, m_arena, m_state, global_max_fast, format);
    break;
   } else {
    PRINT_RA ("This address is not part of the arenas\n");
    break;
 ...
 case 'a':
  if (r_resolve_main_arena_32 (core, &m_arena)) {
   ...
   print_malloc_states_32 (core, m_arena, main_arena);
  }
  break;
 case 'i':
  if (r_resolve_main_arena_32 (core, &m_arena)) {
   ...
   if (!strcmp (input, "\0")) {
     ...
     m_state = r_num_get (
# 1573 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                         ((void *)0)
# 1573 "project/radare2/libr/core/linux_heap_glibc.c"
                             , input);
    }
   print_malloc_info_32 (core, m_arena, m_state);
  }
  break;
 case 'm':
  if (r_resolve_main_arena_32 (core, &m_arena)) {
   ...
   if (!strcmp (input, "\0")) {
    ...
    m_arena = r_num_get (
# 1604 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                        ((void *)0)
# 1604 "project/radare2/libr/core/linux_heap_glibc.c"
                            , input);
    if (!update_main_arena_32 (core, m_arena, main_arena)) {
     break;
    }
   }
   print_arena_stats_32 (core, m_arena, main_arena, global_max_fast, format);
  }
  break;
 case 'b':
  if (r_resolve_main_arena_32 (core, &m_arena)) {
   ...
   if (*dup) {
    strtok (dup, ":");
    m_state_str = strtok (
# 1617 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                         ((void *)0)
# 1617 "project/radare2/libr/core/linux_heap_glibc.c"
                             , ":");
    m_state = r_num_get (
# 1618 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                        ((void *)0)
# 1618 "project/radare2/libr/core/linux_heap_glibc.c"
                            , m_state_str);
    if (!m_state) {
     m_state = m_arena;
    }
   ...
   if (is_arena_32 (core, m_arena, m_state)) {
    ...
    print_heap_bin_32 (core, m_state, main_arena, dup);
   } else {
    PRINT_RA ("This address is not part of the arenas\n");
    free (dup);
    break;
...
# 1650 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
  _Bool 
# 1650 "project/radare2/libr/core/linux_heap_glibc.c"
       demangle = r_config_get_i (core->config, "dbg.glibc.demangle");
   char *m_state_str, *dup = strdup (input + 1);
   if (*dup) {
    strtok (dup, ":");
    m_state_str = strtok (
# 1654 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                         ((void *)0)
# 1654 "project/radare2/libr/core/linux_heap_glibc.c"
                             , ":");
    m_state = r_num_get (
# 1655 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                        ((void *)0)
# 1655 "project/radare2/libr/core/linux_heap_glibc.c"
                            , m_state_str);
    if (!m_state) {
     m_state = m_arena;
    }
   ...
   if (is_arena_32 (core, m_arena, m_state)) {
    ...
    print_heap_fastbin_32 (core, m_state, main_arena, global_max_fast, dup, demangle);
   } else {
    PRINT_RA ("This address is not part of the arenas\n");
    free (dup);
    break;
  ...
  if (r_resolve_main_arena_32 (core, &m_arena)) {
   ...
   if (!strcmp (input, "\0")) {
    if (core->offset != core->prompt_offset) {
     m_state = core->offset;
     get_state = 
# 1697 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                1
# 1697 "project/radare2/libr/core/linux_heap_glibc.c"
                    ;
     }
    } else {
     m_state = r_num_get (
# 1700 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                         ((void *)0)
# 1700 "project/radare2/libr/core/linux_heap_glibc.c"
                             , input);
     get_state = 
# 1701 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                1
# 1701 "project/radare2/libr/core/linux_heap_glibc.c"
                    ;
    }
   if (!get_state) {
    m_state = m_arena;
...
# 1721 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
  _Bool 
# 1721 "project/radare2/libr/core/linux_heap_glibc.c"
       demangle = r_config_get_i (core->config, "dbg.glibc.demangle");
   print_tcache_instance_32 (core, m_arena, main_arena, demangle);
  }
  break;
 case '?':
  r_core_cmd_help (core, help_msg_32);
  break;
 }
 free (main_arena);
 return 
# 1730 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
       1
# 1730 "project/radare2/libr/core/linux_heap_glibc.c"
           ;
}
# 8 "project/radare2/libr/core/linux_heap_glibc.c" 2
#undef HEAP32
...
# 39 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
      unsigned long long 
# 39 "project/radare2/libr/core/linux_heap_glibc.c"
          get_va_symbol_64(RCore *core, const char *path, const char *sym_name) {
...
# 71 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
             unsigned long long 
# 71 "project/radare2/libr/core/linux_heap_glibc.c"
                 get_next_pointer_64(RCore *core, 
# 71 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                   unsigned long long 
# 71 "project/radare2/libr/core/linux_heap_glibc.c"
                                                       pos, 
...
# 75 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
      unsigned long long 
# 75 "project/radare2/libr/core/linux_heap_glibc.c"
          get_main_arena_with_symbol_64(RCore *core, RDebugMap *map) {
...
"core && map"
# 76 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
, 76); return (0xFFFFFFFFFFFFFFFFULL); } } while (0)
# 76 "project/radare2/libr/core/linux_heap_glibc.c"
                                           ;
...
"base_addr != GHT_MAX"
# 78 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
, 78); return (0xFFFFFFFFFFFFFFFFULL); } } while (0)
# 78 "project/radare2/libr/core/linux_heap_glibc.c"
                                                    ;
...
# 81 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 char *path = strdup (map->name);
 if (path && r_file_exists (path)) {
  vaddr = get_va_symbol_64 (core, path, "main_arena");
  if (vaddr != 
# 85 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
              0xFFFFFFFFFFFFFFFFULL
# 85 "project/radare2/libr/core/linux_heap_glibc.c"
   ...
   vaddr = get_va_symbol_64 (core, path, "__malloc_hook");
   if (vaddr == 
# 89 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
               0xFFFFFFFFFFFFFFFFULL
# 89 "project/radare2/libr/core/linux_heap_glibc.c"
   ...
   RBinInfo *info = r_bin_get_info (core->bin);
   if (!strcmp (info->arch, "x86")) {
    main_arena = align_address_to_size_64 (vaddr + base_addr + sizeof (
# 94 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                                        unsigned long long
# 94 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                           ), 0x20);
...
# 136 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
      unsigned long long 
# 136 "project/radare2/libr/core/linux_heap_glibc.c"
          tcache_chunk_size_64(RCore *core, 
# 136 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                             unsigned long long 
# 136 "project/radare2/libr/core/linux_heap_glibc.c"
                                                 brk_start) {
...
# 143 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                    unsigned char 
# 143 "project/radare2/libr/core/linux_heap_glibc.c"
                                        *)cnk, sizeof (RHeapChunk_64));
 sz = (cnk->size >> 3) << 3;
 return sz;
}

static void update_arena_with_tc_64(RHeap_MallocState_tcache_64 *cmain_arena, MallocState *main_arena) {
 int i = 0;
 main_arena->mutex = cmain_arena->mutex;
 main_arena->flags = cmain_arena->flags;
 for (i = 0; i < BINMAPSIZE; i++) {
 ...
 main_arena->attached_threads = cmain_arena->attached_threads;
 for (i = 0; i < NFASTBINS; i++) {
  main_arena->fastbinsY_64[i] = cmain_arena->fastbinsY[i];
 }
 main_arena->top_64 = cmain_arena->top;
 main_arena->last_remainder_64 = cmain_arena->last_remainder;
 for (i = 0; i < NBINS * 2 - 2; i++) {
  main_arena->bins_64[i] = cmain_arena->bins[i];
 }
 main_arena->next_64 = cmain_arena->next;
 main_arena->next_free_64 = cmain_arena->next_free;
 main_arena->system_mem_64 = cmain_arena->system_mem;
 main_arena->max_system_mem_64 = cmain_arena->max_system_mem;
}

static void update_arena_without_tc_64(RHeap_MallocState_64 *cmain_arena, MallocState *main_arena) {
 size_t i = 0;
 main_arena->mutex = cmain_arena->mutex;
 main_arena->flags = cmain_arena->flags;
 for (i = 0; i < BINMAPSIZE; i++) {
...
# 193 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
      _Bool 
# 193 "project/radare2/libr/core/linux_heap_glibc.c"
           update_main_arena_64(RCore *core, 
# 193 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                              unsigned long long 
# 193 "project/radare2/libr/core/linux_heap_glibc.c"
                                                  m_arena, MallocState *main_arena) {
 const int tcache = r_config_get_i (core->config, "dbg.glibc.tcache");
 if (tcache) {
  RHeap_MallocState_tcache_64 *cmain_arena = 
# 196 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                             (
# 196 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 200 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                         unsigned char 
# 200 "project/radare2/libr/core/linux_heap_glibc.c"
                                             *)cmain_arena, sizeof (RHeap_MallocState_tcache_64));
  update_arena_with_tc_64(cmain_arena, main_arena);
 } else {
  RHeap_MallocState_64 *cmain_arena = 
# 203 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                      (
# 203 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 207 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                         unsigned char 
# 207 "project/radare2/libr/core/linux_heap_glibc.c"
                                             *)cmain_arena, sizeof (RHeap_MallocState_64));
  update_arena_without_tc_64(cmain_arena, main_arena);
 }
 return 
# 210 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
       1
...
static void get_brks_64(RCore *core, 
# 213 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                     unsigned long long 
# 213 "project/radare2/libr/core/linux_heap_glibc.c"
                                         *brk_start, 
...
static void print_arena_stats_64(RCore *core, 
# 247 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                              unsigned long long 
# 247 "project/radare2/libr/core/linux_heap_glibc.c"
                                                  m_arena, MallocState *main_arena, 
...
# 268 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  {
   char units[8];
   r_num_units (units, sizeof (units), main_arena->max_system_mem_64);
   r_cons_printf ("f heap.maxmem = %s\n", units);

   r_num_units (units, sizeof (units), main_arena->system_mem_64);
   r_cons_printf ("f heap.sysmem = %s\n", units);

   r_num_units (units, sizeof (units), main_arena->next_free_64);
   r_cons_printf ("f heap.nextfree = %s\n", units);

   r_num_units (units, sizeof (units), main_arena->next_64);
   r_cons_printf ("f heap.next= %s\n", units);
  }
  return;
 }
...
# 398 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
      _Bool 
# 398 "project/radare2/libr/core/linux_heap_glibc.c"
           r_resolve_main_arena_64(RCore *core, 
# 398 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                 unsigned long long 
# 398 "project/radare2/libr/core/linux_heap_glibc.c"
                                                     *m_arena) {
...
# 420 "project/radare2/libr/core/linux_heap_glibc.c"
                     ;
    main_arena_sym = get_main_arena_with_symbol_64 (core, map);
   }
   if ((strstr (map->name, "/libc-") || strstr (map->name, "/libc."))
     && map->perm == 
# 424 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
...
# 469 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  update_main_arena_64 (core, main_arena_sym, ta);
  *m_arena = main_arena_sym;
  core->dbg->main_arena_resolved = 
# 472 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                  1
...
# 474 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 while (addr_srch < libc_addr_end) {
  update_main_arena_64 (core, addr_srch, ta);
  if ( ta->top_64 > brk_start && ta->top_64 < brk_end &&
   ta->system_mem_64 == heap_sz) {
...
void print_heap_chunk_64(RCore *core) {
 RHeapChunk_64 *cnk = 
# 496 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                      (
# 496 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 555 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 if (!update_main_arena_64 (core, m_arena, ta)) {
  free (ta);
  return 
# 559 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
        0
...
# 565 "project/radare2/libr/core/linux_heap_glibc.c"
                               && ta->next_64 != m_arena) {
  if (!update_main_arena_64 (core, ta->next_64, ta)) {
   free (ta);
   return 
# 568 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
         0
...
static int print_double_linked_list_bin_simple_64(RCore *core, 
# 579 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                               unsigned long long 
# 579 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                   bin, MallocState *main_arena, 
...
# 596 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  next = cnk->fd;
  if (next < brk_start || next > main_arena->top_64) {
   PRINT_RA ("Double linked list corrupted\n");
   free (cnk);
   return -1;
  }
...
static int print_double_linked_list_bin_graph_64(RCore *core, 
# 633 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                              unsigned long long 
# 633 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                  bin, MallocState *main_arena, 
...
static int print_double_linked_list_bin_64(RCore *core, MallocState *main_arena, 
# 683 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                                                 unsigned long long 
# 683 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                                     m_arena, 
...
unsigned long long 
# 694 "project/radare2/libr/core/linux_heap_glibc.c"
    bin = main_arena->bins_64[num_bin];
...
# 702 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 if (!graph || graph == 1) {
  ret = print_double_linked_list_bin_simple_64(core, bin, main_arena, initial_brk);
 } else {
  ret = print_double_linked_list_bin_graph_64(core, bin, main_arena, initial_brk);
 }
 PRINT_GA ("\n  }\n");
 return ret;
}

static void print_heap_bin_64(RCore *core, 
# 737 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                           unsigned long long 
# 737 "project/radare2/libr/core/linux_heap_glibc.c"
                                               m_arena, MallocState *main_arena, const char *input) {
...
# 740 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 case '\0':
  ...
  for (i = 0; i < NBINS - 1; i++) {
   PRINTF_YA (" Bin %03d:\n", i + 1);
   print_double_linked_list_bin_64 (core, main_arena, m_arena, offset, i, 0);
  }
  PRINT_YA ("\n}\n");
  break;
 case ' ':
...
# 768 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  print_double_linked_list_bin_64 (core, main_arena, m_arena, offset, num_bin, j);
  break;
 }
}

static int print_single_linked_list_bin_64(RCore *core, MallocState *main_arena, 
# 774 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                                                 unsigned long long 
# 774 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                                     m_arena, 
...
# 781 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 if (!update_main_arena_64 (core, m_arena, main_arena)) {
  free (cnk);
  return 0;
 }
...
unsigned long long 
# 791 "project/radare2/libr/core/linux_heap_glibc.c"
    bin = main_arena->fastbinsY_64[bin_num];
 if (!bin) {
  free (cnk);
  return -1;
 }
...
unsigned long long 
# 810 "project/radare2/libr/core/linux_heap_glibc.c"
    size = main_arena->top_64 - brk_start;
...
# 812 "project/radare2/libr/core/linux_heap_glibc.c"
                                                            ;
 while (next && next >= brk_start && next < main_arena->top_64) {
  PRINTF_BA ("0x%"
# 814 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 "llx"
# 814 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 815 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                       0xFFFFFFFFFFFFFFFFULL 
# 815 "project/radare2/libr/core/linux_heap_glibc.c"
                               && next_tmp && next_tmp >= brk_start && next_tmp <= main_arena->top_64) {
   r_io_read_at (core->io, next_tmp, (
# 816 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                     unsigned char 
# 816 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 839 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 if (next && (next < brk_start || next >= main_arena->top_64)) {
  PRINTF_RA ("0x%"
# 848 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 "llx"
# 848 "project/radare2/libr/core/linux_heap_glibc.c"
...
void print_heap_fastbin_64(RCore *core, 
# 860 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                        unsigned long long 
# 860 "project/radare2/libr/core/linux_heap_glibc.c"
                                            m_arena, MallocState *main_arena, 
...
# 862 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 case '\0':
  ...
  for (i = 1; i <= NFASTBINS; i++) {
   ...
   if (print_single_linked_list_bin_64 (core, main_arena, m_arena, offset, i - 1, demangle)) {
    PRINT_GA ("  Empty bin");
    PRINT_BA ("  0x0\n");
   }
  }
...
# 892 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  if (print_single_linked_list_bin_64(core, main_arena, m_arena, offset, num_bin, demangle)) {
   PRINT_GA (" Empty bin");
   PRINT_BA (" 0x0\n");
  }
  break;
...
static RTcache_64* tcache_new_64 (RCore *core) {
...
static void tcache_free_64 (RTcache_64* tcache) {
...
# 924 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
      _Bool 
# 924 "project/radare2/libr/core/linux_heap_glibc.c"
           tcache_read_64 (RCore *core, 
# 924 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                          unsigned long long 
# 924 "project/radare2/libr/core/linux_heap_glibc.c"
                                              tcache_start, RTcache_64* tcache) {
...
# 927 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                          unsigned char 
# 927 "project/radare2/libr/core/linux_heap_glibc.c"
                                              *)tcache->RHeapTcache.heap_tcache, sizeof (RHeapTcache_64))
  : r_io_read_at (core->io, tcache_start, (
# 928 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                          unsigned char 
# 928 "project/radare2/libr/core/linux_heap_glibc.c"
                                              *)tcache->RHeapTcache.heap_tcache_pre_230, sizeof (RHeapTcachePre230_64));
}

static int tcache_get_count_64 (RTcache_64* tcache, int index) {
...
# 938 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
      unsigned long long 
# 938 "project/radare2/libr/core/linux_heap_glibc.c"
          tcache_get_entry_64 (RTcache_64* tcache, int index) {
...
static void tcache_print_64 (RCore *core, RTcache_64* tcache, 
# 945 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                                 _Bool 
# 945 "project/radare2/libr/core/linux_heap_glibc.c"
                                                                      demangle) {
...
# 948 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 size_t i;
 for (i = 0; i < TCACHE_MAX_BINS; i++) {
  int count = tcache_get_count_64 (tcache, i);
  
# 953 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
 unsigned long long 
# 953 "project/radare2/libr/core/linux_heap_glibc.c"
     entry = tcache_get_entry_64 (tcache, i);
  if (entry == 
# 954 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
              0xFFFFFFFFFFFFFFFFULL
# 954 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 969 "project/radare2/libr/core/linux_heap_glibc.c"
     ...
     tcache_tmp = (!demangle)
      ? r_read_le64(&tcache_tmp)
      : PROTECT_PTR (tcache_fd, r_read_le64(&tcache_tmp));
     PRINTF_BA ("->0x%"
# 976 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                      "llx"
# 976 "project/radare2/libr/core/linux_heap_glibc.c"
...
static void print_tcache_instance_64(RCore *core, 
# 985 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                   unsigned long long 
# 985 "project/radare2/libr/core/linux_heap_glibc.c"
                                                       m_arena, MallocState *main_arena, 
...
unsigned long long 
# 998 "project/radare2/libr/core/linux_heap_glibc.c"
    fc_offset = tcache_chunk_size_64 (core, brk_start);
 initial_brk = brk_start + fc_offset;
 if (brk_start == 
# 1000 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 0xFFFFFFFFFFFFFFFFULL 
...
# 1001 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 RTcache_64* r_tcache = tcache_new_64 (core);
 if (!r_tcache) {
  return;
 }
 if (!tcache_read_64 (core, tcache_start, r_tcache)) {
  return;
 }
...
# 1014 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 tcache_print_64 (core, r_tcache, demangle);

 if (main_arena->next_64 != m_arena) {
...
# 1019 "project/radare2/libr/core/linux_heap_glibc.c"
  ...
  if (!ta) {
   free(ta);
   tcache_free_64 (r_tcache);
   return;
  }
  ta->next_64 = main_arena->next_64;
  while (is_arena_64 (core, m_arena, ta->next_64) && ta->next_64 != m_arena) {
   PRINT_YA ("Tcache thread arena @ ");
   PRINTF_BA (" 0x%"
# 1028 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                   "llx"
...
# 1028 "project/radare2/libr/core/linux_heap_glibc.c"
   ...
   mmap_start = ((ta->next_64 >> 16) << 16);
   tcache_start = mmap_start + sizeof (RHeapInfo_64) + sizeof (RHeap_MallocState_tcache_64) + MMAP_ALIGN_64;
   ...
   if (ta->attached_threads) {
    PRINT_BA ("\n");
    tcache_read_64 (core, tcache_start, r_tcache);
    tcache_print_64 (core, r_tcache, demangle);
   } else {
    PRINT_GA (" free\n");
   }
...
static void print_heap_segment_64(RCore *core, MallocState *main_arena,
...
# 1060 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 if (m_arena == m_state) {
  get_brks_64 (core, &brk_start, &brk_end);
  if (tcache) {
   initial_brk = ((brk_start >> 12) << 12) + HDR_SZ_64;
   if (r_config_get_b (core->config, "cfg.debug")) {
    tcache_initial_brk = initial_brk;
   }
   initial_brk += (glibc_version < 230)
    ? sizeof (RHeapTcachePre230_64)
    : sizeof (RHeapTcache_64);
  } else {
   initial_brk = (brk_start >> 12) << 12;
  }
 } else {
  brk_start = ((m_state >> 16) << 16) ;
  brk_end = brk_start + main_arena->system_mem_64;
  if (tcache) {
   tcache_initial_brk = brk_start + sizeof (RHeapInfo_64) + sizeof (RHeap_MallocState_tcache_64) + MMAP_ALIGN_64;
   initial_brk = tcache_initial_brk + offset;
  } else {
   initial_brk = brk_start + sizeof (RHeapInfo_64) + sizeof (RHeap_MallocState_64) + MMAP_OFFSET;
  }
 }
...
# 1172 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 while (next_chunk && next_chunk >= brk_start && next_chunk < main_arena->top_64) {
  if (size_tmp < min_size || next_chunk + size_tmp > main_arena->top_64) {
   const char *status = "corrupted";
   switch (format_out) {
   case 'c':
    PRINT_YA ("\n  Malloc chunk @ ");
...
# 1224 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
  unsigned long long 
# 1224 "project/radare2/libr/core/linux_heap_glibc.c"
      next = get_next_pointer_64 (core, idx, cnk->fd);
   if (prev_chunk == idx && idx && !next) {
    is_free = 
# 1226 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
             1
...
# 1235 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                         unsigned char 
# 1235 "project/radare2/libr/core/linux_heap_glibc.c"
                                             *)cnk_next, sizeof (RHeapChunk_64));
     
# 1236 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
    unsigned long long 
# 1236 "project/radare2/libr/core/linux_heap_glibc.c"
        next_node = get_next_pointer_64 (core, next, cnk_next->fd);

     while (next_node && next_node >= brk_start && next_node < main_arena->top_64) {
      if (prev_chunk == next_node) {
       double_free = 
# 1240 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                    1
...
# 1243 "project/radare2/libr/core/linux_heap_glibc.c"
                                                   *)cnk_next, sizeof (RHeapChunk_64));
      next_node = get_next_pointer_64 (core, next_node, cnk_next->fd);
     }
     if (double_free) {
      break;
     }
...
# 1250 "project/radare2/libr/core/linux_heap_glibc.c"
                                            *)cnk, sizeof (RHeapChunk_64));
    next = get_next_pointer_64 (core, next, cnk->fd);
   }
   if (double_free) {
    PRINT_RA (" Double free in simple-linked list detected ");
    break;
   }
   prev_chunk_size = ((i + 1) * HDR_SZ_64) + HDR_SZ_64;
  }

  if (tcache) {
   RTcache_64* tcache_heap = tcache_new_64 (core);
   if (!tcache_heap) {
    r_cons_canvas_free (can);
    r_config_hold_restore (hc);
    r_config_hold_free (hc);
   ...
   tcache_read_64 (core, tcache_initial_brk, tcache_heap);
   size_t i;
   for (i = 0; i < TCACHE_MAX_BINS; i++) {
    int count = tcache_get_count_64 (tcache_heap, i);
    
# 1275 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
   unsigned long long 
# 1275 "project/radare2/libr/core/linux_heap_glibc.c"
       entry = tcache_get_entry_64 (tcache_heap, i);
    if (count > 0) {
     if (entry - SZ * 2 == prev_chunk) {
      is_free = 
# 1278 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
...
# 1278 "project/radare2/libr/core/linux_heap_glibc.c"
                   ;
      prev_chunk_size = ((i + 1) * TC_HDR_SZ + TC_SZ_64);
      break;
     }
     if (count > 1) {
      tcache_fd = entry;
...
# 1286 "project/radare2/libr/core/linux_heap_glibc.c"
       ...
       tcache_tmp = get_next_pointer_64 (core, tcache_fd, r_read_le64(&tcache_tmp));
       if (tcache_tmp - SZ * 2 == prev_chunk) {
        is_free = 
# 1292 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                 1
...
# 1366 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 case 'j':
  pj_end (pj);
  pj_kn (pj, "top", main_arena->top_64);
  pj_kn (pj, "brk", brk_start);
  pj_kn (pj, "end", brk_end);
  pj_end (pj);
...
void print_malloc_states_64( RCore *core, 
# 1406 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                          unsigned long long 
# 1406 "project/radare2/libr/core/linux_heap_glibc.c"
                                              m_arena, MallocState *main_arena) {
...
void print_inst_minfo_64(RHeapInfo_64 *heap_info, 
# 1434 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                                   unsigned long long 
# 1434 "project/radare2/libr/core/linux_heap_glibc.c"
                                                       hinfo) {
...
void print_malloc_info_64(RCore *core, 
# 1450 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                       unsigned long long 
# 1450 "project/radare2/libr/core/linux_heap_glibc.c"
                                           m_state, 
...
# 1451 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 if (malloc_state == m_state) {
  PRINT_RA ("main_arena does not have an instance of malloc_info\n");
 } else if (is_arena_64 (core, malloc_state, m_state)) {

  h_info = (malloc_state >> 16) << 16;
  RHeapInfo_64 *heap_info = 
# 1459 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                            (
# 1459 "project/radare2/libr/core/linux_heap_glibc.c"
                            RHeapInfo_64
...
# 1463 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                  unsigned char
# 1463 "project/radare2/libr/core/linux_heap_glibc.c"
                                     *)heap_info, sizeof (RHeapInfo_64));
  print_inst_minfo_64 (heap_info, h_info);
  MallocState *ms = 
# 1465 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                   (
# 1465 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1471 "project/radare2/libr/core/linux_heap_glibc.c"
   ...
   if (!update_main_arena_64 (core, malloc_state, ms)) {
    free (ms);
    free (heap_info);
    return;
   }
   if ((ms->top_64 >> 16) << 16 != h_info) {
    h_info = (ms->top_64 >> 16) << 16;
    r_io_read_at (core->io, h_info, (
# 1479 "project/radare2/libr/core/linux_heap_glibc.c" 3 4
                                    unsigned char
# 1479 "project/radare2/libr/core/linux_heap_glibc.c"
...
# 1520 "project/radare2/libr/core/linux_heap_glibc.c"
 ...
 r_config_set_b (core->config, "dbg.glibc.tcache", is_tcache_64 (core));
...
# 1531 "project/radare2/libr/core/linux_heap_glibc.c"
                 ;
 case '\0':
  if (r_resolve_main_arena_64 (core, &m_arena)) {
   ...
   if (is_arena_64 (core, m_arena, m_state)) {
    if (!update_main_arena_64 (core, m_state, main_arena)) {
     break;
    }
    print_heap_segment_64 (core, main_arena, m_arena, m_state, global_max_fast, format);
    break;
   } else {
    PRINT_RA ("This address is not part of the arenas\n");
    break;
 ...
 case 'a':
  if (r_resolve_main_arena_64 (core, &m_arena)) {
   ...
   print_malloc_states_64 (core, m_arena, main_arena);
  }
  break;
 case 'i':
  if (r_resolve_main_arena_64 (core, &m_arena)) {
...
# 1573 "project/radare2/libr/core/linux_heap_glibc.c"
   ...
   print_malloc_info_64 (core, m_arena, m_state);
  }
  break;
 case 'm':
  if (r_resolve_main_arena_64 (core, &m_arena)) {
...
# 1604 "project/radare2/libr/core/linux_heap_glibc.c"
   ...
   print_arena_stats_64 (core, m_arena, main_arena, global_max_fast, format);
  }
  break;
 case 'b':
  if (r_resolve_main_arena_64 (core, &m_arena)) {
...
# 1618 "project/radare2/libr/core/linux_heap_glibc.c"
   ...
   if (is_arena_64 (core, m_arena, m_state)) {
    ...
    print_heap_bin_64 (core, m_state, main_arena, dup);
   } else {
    PRINT_RA ("This address is not part of the arenas\n");
    free (dup);
    break;
...
# 1655 "project/radare2/libr/core/linux_heap_glibc.c"
   ...
   if (is_arena_64 (core, m_arena, m_state)) {
    ...
    print_heap_fastbin_64 (core, m_state, main_arena, global_max_fast, dup, demangle);
   } else {
    PRINT_RA ("This address is not part of the arenas\n");
    free (dup);
    break;
...
# 1721 "project/radare2/libr/core/linux_heap_glibc.c"
       demangle = r_config_get_i (core->config, "dbg.glibc.demangle");
   print_tcache_instance_64 (core, m_arena, main_arena, demangle);
  }
  break;
 case '?':
  r_core_cmd_help (core, help_msg_64);
  break;
 }
 free (main_arena);
 return 
