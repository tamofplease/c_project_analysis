# 0 "project/radare2/libr/io/io_submap.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/io/io_submap.c"
...
# 4 "project/radare2/libr/io/io_submap.c" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/io/io_submap.c"
     RIOSubMap *r_io_submap_new(RIO *io, RIOMapRef *mapref) {
 
# 6 "project/radare2/libr/io/io_submap.c" 3 4
do { if (!(
# 6 "project/radare2/libr/io/io_submap.c"
io && mapref
# 6 "project/radare2/libr/io/io_submap.c" 3 4
...
# 6 "project/radare2/libr/io/io_submap.c"
 ...
 RIOSubMap *sm = 
# 8 "project/radare2/libr/io/io_submap.c" 3 4
                (
# 8 "project/radare2/libr/io/io_submap.c"
                RIOSubMap
# 8 "project/radare2/libr/io/io_submap.c" 3 4
                *)malloc(sizeof(
# 8 "project/radare2/libr/io/io_submap.c"
...
# 16 "project/radare2/libr/io/io_submap.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 16 "project/radare2/libr/io/io_submap.c"
          r_io_submap_set_from(RIOSubMap *sm, const 
# 16 "project/radare2/libr/io/io_submap.c" 3 4
                                                    unsigned long long 
# 16 "project/radare2/libr/io/io_submap.c"
                                                         from) {
 
# 17 "project/radare2/libr/io/io_submap.c" 3 4
do { if (!(
# 17 "project/radare2/libr/io/io_submap.c"
sm
# 17 "project/radare2/libr/io/io_submap.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 17 "project/radare2/libr/io/io_submap.c"
...
# 17 "project/radare2/libr/io/io_submap.c"
                                ;
 if (
# 18 "project/radare2/libr/io/io_submap.c" 3 4
    (( r_itv_end (
# 18 "project/radare2/libr/io/io_submap.c"
    sm
# 18 "project/radare2/libr/io/io_submap.c" 3 4
    ->itv) - 1 )) 
# 18 "project/radare2/libr/io/io_submap.c"
                        < from) {
  return 
# 19 "project/radare2/libr/io/io_submap.c" 3 4
        0
# 19 "project/radare2/libr/io/io_submap.c"
             ;
 }
 sm->itv.size = sm->itv.addr + sm->itv.size - from;
 sm->itv.addr = from;
 return 
# 23 "project/radare2/libr/io/io_submap.c" 3 4
       1
# 23 "project/radare2/libr/io/io_submap.c"
           ;
}


# 26 "project/radare2/libr/io/io_submap.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 26 "project/radare2/libr/io/io_submap.c"
          r_io_submap_set_to(RIOSubMap *sm, const 
# 26 "project/radare2/libr/io/io_submap.c" 3 4
                                                  unsigned long long 
# 26 "project/radare2/libr/io/io_submap.c"
                                                       to) {
 
# 27 "project/radare2/libr/io/io_submap.c" 3 4
do { if (!(
# 27 "project/radare2/libr/io/io_submap.c"
sm
# 27 "project/radare2/libr/io/io_submap.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 27 "project/radare2/libr/io/io_submap.c"
...
# 27 "project/radare2/libr/io/io_submap.c"
                                ;
 if (
# 28 "project/radare2/libr/io/io_submap.c" 3 4
    (r_itv_begin (
# 28 "project/radare2/libr/io/io_submap.c"
    sm
# 28 "project/radare2/libr/io/io_submap.c" 3 4
    ->itv)) 
# 28 "project/radare2/libr/io/io_submap.c"
                          > to) {
  return 
# 29 "project/radare2/libr/io/io_submap.c" 3 4
        0
# 29 "project/radare2/libr/io/io_submap.c"
             ;
 }
 sm->itv.size = sm->itv.size + to - 
# 31 "project/radare2/libr/io/io_submap.c" 3 4
                                   (( r_itv_end (
# 31 "project/radare2/libr/io/io_submap.c"
                                   sm
# 31 "project/radare2/libr/io/io_submap.c" 3 4
                                   ->itv) - 1 ))
# 31 "project/radare2/libr/io/io_submap.c"
                                                      ;
 return 
# 32 "project/radare2/libr/io/io_submap.c" 3 4
       1
# 32 "project/radare2/libr/io/io_submap.c"
           ;
}
