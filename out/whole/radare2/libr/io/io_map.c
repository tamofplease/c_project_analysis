# 0 "project/radare2/libr/io/io_map.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/io/io_map.c"
...
# 4 "project/radare2/libr/io/io_map.c" 2
...
#define END_OF_MAP_IDS UT32_MAX
 _Bool 
# 9 "project/radare2/libr/io/io_map.c"
          io_bank_has_map(RIO *io, const 
# 9 "project/radare2/libr/io/io_map.c" 3 4
                                         unsigned int 
# 9 "project/radare2/libr/io/io_map.c"
                                              bankid, const 
# 9 "project/radare2/libr/io/io_map.c" 3 4
...
static RIOMap *io_map_new(RIO* io, int fd, int perm, 
# 11 "project/radare2/libr/io/io_map.c" 3 4
                                                    unsigned long long 
# 11 "project/radare2/libr/io/io_map.c"
                                                         delta, 
# 11 "project/radare2/libr/io/io_map.c" 3 4
                                                                unsigned long long 
# 11 "project/radare2/libr/io/io_map.c"
...
# 12 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 12 "project/radare2/libr/io/io_map.c"
io && io->maps
# 12 "project/radare2/libr/io/io_map.c" 3 4
...
"io && io->maps"
# 12 "project/radare2/libr/io/io_map.c" 3 4
, 12); return (((void *)0)); } } while (0)
# 12 "project/radare2/libr/io/io_map.c"
                                           ;
 if (!size) {
  return 
# 14 "project/radare2/libr/io/io_map.c" 3 4
        ((void *)0)
# 14 "project/radare2/libr/io/io_map.c"
            ;
 }
 RIOMap* map = 
# 16 "project/radare2/libr/io/io_map.c" 3 4
              (
# 16 "project/radare2/libr/io/io_map.c"
              RIOMap
# 16 "project/radare2/libr/io/io_map.c" 3 4
              *)calloc(1,sizeof(
# 16 "project/radare2/libr/io/io_map.c"
...
# 16 "project/radare2/libr/io/io_map.c"
 ...
 if (!map || !r_id_storage_add (io->maps, map, &map->id)) {
  free (map);
  return 
# 19 "project/radare2/libr/io/io_map.c" 3 4
        ((void *)0)
# 19 "project/radare2/libr/io/io_map.c"
            ;
 }
 map->fd = fd;
 map->delta = delta;
...
# 32 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 32 "project/radare2/libr/io/io_map.c"
          r_io_map_remap(RIO *io, 
# 32 "project/radare2/libr/io/io_map.c" 3 4
                                  unsigned int 
# 32 "project/radare2/libr/io/io_map.c"
                                       id, 
...
# 34 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 34 "project/radare2/libr/io/io_map.c"
io && map
# 34 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 34 "project/radare2/libr/io/io_map.c"
...
# 34 "project/radare2/libr/io/io_map.c"
                                       ;
 const 
# 35 "project/radare2/libr/io/io_map.c" 3 4
      unsigned long long 
# 35 "project/radare2/libr/io/io_map.c"
           ofrom = 
# 35 "project/radare2/libr/io/io_map.c" 3 4
                   r_itv_begin (
# 35 "project/radare2/libr/io/io_map.c"
...
# 35 "project/radare2/libr/io/io_map.c"
                                      ;
 const 
# 36 "project/radare2/libr/io/io_map.c" 3 4
      unsigned long long 
# 36 "project/radare2/libr/io/io_map.c"
           oto = 
# 36 "project/radare2/libr/io/io_map.c" 3 4
                 ( r_itv_end (
# 36 "project/radare2/libr/io/io_map.c"
...
# 37 "project/radare2/libr/io/io_map.c" 3 4
unsigned long long 
# 37 "project/radare2/libr/io/io_map.c"
     size = 
# 37 "project/radare2/libr/io/io_map.c" 3 4
            r_itv_size (
# 37 "project/radare2/libr/io/io_map.c"
...
# 38 "project/radare2/libr/io/io_map.c" 3 4
do { 
# 38 "project/radare2/libr/io/io_map.c"
map
# 38 "project/radare2/libr/io/io_map.c" 3 4
->itv.addr = 
# 38 "project/radare2/libr/io/io_map.c"
...
# 38 "project/radare2/libr/io/io_map.c"
                              ;
 if (
# 39 "project/radare2/libr/io/io_map.c" 3 4
    0xFFFFFFFFFFFFFFFFULL 
# 39 "project/radare2/libr/io/io_map.c"
             - size + 1 < addr) {
  
# 40 "project/radare2/libr/io/io_map.c" 3 4
 long long 
# 40 "project/radare2/libr/io/io_map.c"
      saddr = (
# 40 "project/radare2/libr/io/io_map.c" 3 4
               long long
# 40 "project/radare2/libr/io/io_map.c"
  ...
  const 
# 41 "project/radare2/libr/io/io_map.c" 3 4
       unsigned long long 
# 41 "project/radare2/libr/io/io_map.c"
            osize = 
# 41 "project/radare2/libr/io/io_map.c" 3 4
                    r_itv_size (
# 41 "project/radare2/libr/io/io_map.c"
...
# 42 "project/radare2/libr/io/io_map.c" 3 4
 do { 
# 42 "project/radare2/libr/io/io_map.c"
 map
# 42 "project/radare2/libr/io/io_map.c" 3 4
 ->itv.size = 
# 42 "project/radare2/libr/io/io_map.c"
...
# 48 "project/radare2/libr/io/io_map.c" 3 4
  unsigned int 
# 48 "project/radare2/libr/io/io_map.c"
       bankid;
...
# 58 "project/radare2/libr/io/io_map.c" 3 4
  do { 
# 58 "project/radare2/libr/io/io_map.c"
  map
# 58 "project/radare2/libr/io/io_map.c" 3 4
  ->itv.addr = 
# 58 "project/radare2/libr/io/io_map.c"
...
# 59 "project/radare2/libr/io/io_map.c" 3 4
  do { 
# 59 "project/radare2/libr/io/io_map.c"
  map
# 59 "project/radare2/libr/io/io_map.c" 3 4
  ->itv.size = 
# 59 "project/radare2/libr/io/io_map.c"
...
# 59 "project/radare2/libr/io/io_map.c"
                                ;
   return 
# 60 "project/radare2/libr/io/io_map.c" 3 4
         0
# 60 "project/radare2/libr/io/io_map.c"
              ;
  }
 }
 
# 63 "project/radare2/libr/io/io_map.c" 3 4
unsigned int 
# 63 "project/radare2/libr/io/io_map.c"
     bankid;
 r_id_storage_get_lowest (io->banks, &bankid);
 do {
 ...
 return 
# 69 "project/radare2/libr/io/io_map.c" 3 4
       1
# 69 "project/radare2/libr/io/io_map.c"
           ;
}


# 72 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 72 "project/radare2/libr/io/io_map.c"
          r_io_map_remap_fd(RIO *io, int fd, 
# 72 "project/radare2/libr/io/io_map.c" 3 4
                                             unsigned long long 
# 72 "project/radare2/libr/io/io_map.c"
                                                  addr) {
...
# 74 "project/radare2/libr/io/io_map.c" 3 4
_Bool 
# 74 "project/radare2/libr/io/io_map.c"
     retval = 
# 74 "project/radare2/libr/io/io_map.c" 3 4
              0
# 74 "project/radare2/libr/io/io_map.c"
...
static 
# 86 "project/radare2/libr/io/io_map.c" 3 4
      _Bool 
# 86 "project/radare2/libr/io/io_map.c"
           _map_free_cb(void *user, void *data, 
# 86 "project/radare2/libr/io/io_map.c" 3 4
                                                unsigned int 
# 86 "project/radare2/libr/io/io_map.c"
                                                     id) {
 ...
 return 
# 92 "project/radare2/libr/io/io_map.c" 3 4
       1
# 92 "project/radare2/libr/io/io_map.c"
           ;
}


# 95 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) 
# 95 "project/radare2/libr/io/io_map.c"
     void r_io_map_init(RIO* io) {
 
# 96 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 96 "project/radare2/libr/io/io_map.c"
io
# 96 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 96 "project/radare2/libr/io/io_map.c"
...
# 96 "project/radare2/libr/io/io_map.c"
                     ;
 if (io->maps) {
  r_id_storage_foreach (io->maps, _map_free_cb, 
# 98 "project/radare2/libr/io/io_map.c" 3 4
                                               ((void *)0)
# 98 "project/radare2/libr/io/io_map.c"
                                                   );
  r_id_storage_free (io->maps);
 }
 io->maps = r_id_storage_new (1, 
# 101 "project/radare2/libr/io/io_map.c" 3 4
                                0xFFFFFFFFU
# 101 "project/radare2/libr/io/io_map.c"
                                              );
}



# 105 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 105 "project/radare2/libr/io/io_map.c"
          r_io_map_exists(RIO *io, RIOMap *map) {
 
# 106 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 106 "project/radare2/libr/io/io_map.c"
io && map
# 106 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 106 "project/radare2/libr/io/io_map.c"
"io && map"
# 106 "project/radare2/libr/io/io_map.c" 3 4
, 106); return (0); } } while (0)
# 106 "project/radare2/libr/io/io_map.c"
                                       ;
 RIOMap *_map = r_io_map_get (io, map->id);
 if (!_map) {
  return 
# 109 "project/radare2/libr/io/io_map.c" 3 4
        0
# 109 "project/radare2/libr/io/io_map.c"
             ;
 }
...
# 115 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 115 "project/radare2/libr/io/io_map.c"
          r_io_map_exists_for_id(RIO *io, 
# 115 "project/radare2/libr/io/io_map.c" 3 4
                                          unsigned int 
# 115 "project/radare2/libr/io/io_map.c"
                                               id) {
 
# 116 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 116 "project/radare2/libr/io/io_map.c"
io && io->maps
# 116 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 116 "project/radare2/libr/io/io_map.c"
"io && io->maps"
# 116 "project/radare2/libr/io/io_map.c" 3 4
, 116); return (0); } } while (0)
# 116 "project/radare2/libr/io/io_map.c"
                                            ;
 return r_io_map_get (io, id) != 
# 117 "project/radare2/libr/io/io_map.c" 3 4
                                ((void *)0)
# 117 "project/radare2/libr/io/io_map.c"
                                    ;
}


# 120 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) 
# 120 "project/radare2/libr/io/io_map.c"
     RIOMap* r_io_map_get(RIO *io, 
# 120 "project/radare2/libr/io/io_map.c" 3 4
                                   unsigned int 
# 120 "project/radare2/libr/io/io_map.c"
                                        id) {
 
# 121 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 121 "project/radare2/libr/io/io_map.c"
io
# 121 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 121 "project/radare2/libr/io/io_map.c"
...
# 125 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) 
# 125 "project/radare2/libr/io/io_map.c"
     RIOMap *r_io_map_add(RIO *io, int fd, int perm, 
# 125 "project/radare2/libr/io/io_map.c" 3 4
                                                     unsigned long long 
# 125 "project/radare2/libr/io/io_map.c"
                                                          delta, 
...
# 126 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 126 "project/radare2/libr/io/io_map.c"
io
# 126 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 126 "project/radare2/libr/io/io_map.c"
"io"
# 126 "project/radare2/libr/io/io_map.c" 3 4
, 126); return (((void *)0)); } } while (0)
# 126 "project/radare2/libr/io/io_map.c"
                               ;
 if (!size) {
  return 
# 128 "project/radare2/libr/io/io_map.c" 3 4
        ((void *)0)
# 128 "project/radare2/libr/io/io_map.c"
            ;
 }
 ...
 if (desc) {
  ...
  perm &= desc->perm | 
# 134 "project/radare2/libr/io/io_map.c" 3 4
                      1
# 134 "project/radare2/libr/io/io_map.c"
                              ;
  RIOMap *map[2] = {
# 135 "project/radare2/libr/io/io_map.c" 3 4
                   ((void *)0)
# 135 "project/radare2/libr/io/io_map.c"
                       , 
# 135 "project/radare2/libr/io/io_map.c" 3 4
                         ((void *)0)
# 135 "project/radare2/libr/io/io_map.c"
  ...
  if ((
# 136 "project/radare2/libr/io/io_map.c" 3 4
      0xFFFFFFFFFFFFFFFFULL 
# 136 "project/radare2/libr/io/io_map.c"
               - size + 1) < addr) {
   const 
# 137 "project/radare2/libr/io/io_map.c" 3 4
        unsigned long long 
# 137 "project/radare2/libr/io/io_map.c"
             new_size = size - (
# 137 "project/radare2/libr/io/io_map.c" 3 4
                                0xFFFFFFFFFFFFFFFFULL 
# 137 "project/radare2/libr/io/io_map.c"
   ...
   if (!map[0]) {
    return 
# 140 "project/radare2/libr/io/io_map.c" 3 4
          ((void *)0)
# 140 "project/radare2/libr/io/io_map.c"
              ;
   }
   if (!r_io_bank_map_add_top (io, io->bank, map[0]->id)) {
    ...
    free (map[0]);
    return 
# 145 "project/radare2/libr/io/io_map.c" 3 4
          ((void *)0)
# 145 "project/radare2/libr/io/io_map.c"
              ;
   }
   size = new_size;
  }
  ...
  if (!map[1]) {
   ...
   free (map[1]);
   return 
# 156 "project/radare2/libr/io/io_map.c" 3 4
         ((void *)0)
# 156 "project/radare2/libr/io/io_map.c"
             ;
  }
  if (!r_io_bank_map_add_top (io, io->bank, map[1]->id)) {
   ...
   free (map[1]);
   return 
# 165 "project/radare2/libr/io/io_map.c" 3 4
         ((void *)0)
# 165 "project/radare2/libr/io/io_map.c"
             ;
  }
  return map[1];
 }
 return 
# 169 "project/radare2/libr/io/io_map.c" 3 4
       ((void *)0)
# 169 "project/radare2/libr/io/io_map.c"
           ;
}


# 172 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) 
# 172 "project/radare2/libr/io/io_map.c"
     RIOMap *r_io_map_add_bottom(RIO *io, int fd, int perm, 
# 172 "project/radare2/libr/io/io_map.c" 3 4
                                                            unsigned long long 
# 172 "project/radare2/libr/io/io_map.c"
                                                                 delta, 
...
# 173 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 173 "project/radare2/libr/io/io_map.c"
io
# 173 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 173 "project/radare2/libr/io/io_map.c"
"io"
# 173 "project/radare2/libr/io/io_map.c" 3 4
, 173); return (((void *)0)); } } while (0)
# 173 "project/radare2/libr/io/io_map.c"
                               ;
 if (!size) {
  return 
# 175 "project/radare2/libr/io/io_map.c" 3 4
        ((void *)0)
# 175 "project/radare2/libr/io/io_map.c"
            ;
 }
 ...
 if (desc) {
  ...
  perm &= desc->perm | 
# 181 "project/radare2/libr/io/io_map.c" 3 4
                      1
# 181 "project/radare2/libr/io/io_map.c"
                              ;
  RIOMap *map[2] = {
# 182 "project/radare2/libr/io/io_map.c" 3 4
                   ((void *)0)
# 182 "project/radare2/libr/io/io_map.c"
                       , 
# 182 "project/radare2/libr/io/io_map.c" 3 4
                         ((void *)0)
# 182 "project/radare2/libr/io/io_map.c"
  ...
  if ((
# 183 "project/radare2/libr/io/io_map.c" 3 4
      0xFFFFFFFFFFFFFFFFULL 
# 183 "project/radare2/libr/io/io_map.c"
               - size + 1) < addr) {
   const 
# 184 "project/radare2/libr/io/io_map.c" 3 4
        unsigned long long 
# 184 "project/radare2/libr/io/io_map.c"
             new_size = size - (
# 184 "project/radare2/libr/io/io_map.c" 3 4
                                0xFFFFFFFFFFFFFFFFULL 
# 184 "project/radare2/libr/io/io_map.c"
   ...
   if (!map[0]) {
    return 
# 187 "project/radare2/libr/io/io_map.c" 3 4
          ((void *)0)
# 187 "project/radare2/libr/io/io_map.c"
              ;
   }
   if (!r_io_bank_map_add_bottom (io, io->bank, map[0]->id)) {
    ...
    free (map[0]);
    return 
# 192 "project/radare2/libr/io/io_map.c" 3 4
          ((void *)0)
# 192 "project/radare2/libr/io/io_map.c"
              ;
   }
   size = new_size;
  }
  ...
  if (!map[1]) {
   ...
   free (map[1]);
   return 
# 203 "project/radare2/libr/io/io_map.c" 3 4
         ((void *)0)
# 203 "project/radare2/libr/io/io_map.c"
             ;
  }
  if (!r_io_bank_map_add_bottom (io, io->bank, map[1]->id)) {
   ...
   free (map[1]);
   return 
# 212 "project/radare2/libr/io/io_map.c" 3 4
         ((void *)0)
# 212 "project/radare2/libr/io/io_map.c"
             ;
  }
  return map[1];
 }
 return 
# 216 "project/radare2/libr/io/io_map.c" 3 4
       ((void *)0)
# 216 "project/radare2/libr/io/io_map.c"
           ;
}


# 219 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) 
# 219 "project/radare2/libr/io/io_map.c"
     RIOMap *r_io_map_get_paddr(RIO* io, 
# 219 "project/radare2/libr/io/io_map.c" 3 4
                                         unsigned long long 
# 219 "project/radare2/libr/io/io_map.c"
                                              paddr) {
 
# 220 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 220 "project/radare2/libr/io/io_map.c"
io
# 220 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 220 "project/radare2/libr/io/io_map.c"
...
# 225 "project/radare2/libr/io/io_map.c" 3 4
 if (
# 225 "project/radare2/libr/io/io_map.c"
 bank->maprefs
# 225 "project/radare2/libr/io/io_map.c" 3 4
 ) for (
# 225 "project/radare2/libr/io/io_map.c"
...
# 225 "project/radare2/libr/io/io_map.c"
   ...
   if (map && map->delta <= paddr && paddr < map->delta + 
# 227 "project/radare2/libr/io/io_map.c" 3 4
                                                         r_itv_size (
# 227 "project/radare2/libr/io/io_map.c"
                                                         map
# 227 "project/radare2/libr/io/io_map.c" 3 4
                                                         ->itv)
# 227 "project/radare2/libr/io/io_map.c"
 ...
 return 
# 232 "project/radare2/libr/io/io_map.c" 3 4
       ((void *)0)
# 232 "project/radare2/libr/io/io_map.c"
           ;
}



# 236 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) 
# 236 "project/radare2/libr/io/io_map.c"
     RIOMap *r_io_map_get_at(RIO* io, 
# 236 "project/radare2/libr/io/io_map.c" 3 4
                                      unsigned long long 
# 236 "project/radare2/libr/io/io_map.c"
                                           addr) {
 
# 237 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 237 "project/radare2/libr/io/io_map.c"
io
# 237 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 237 "project/radare2/libr/io/io_map.c"
...
# 241 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 241 "project/radare2/libr/io/io_map.c"
          r_io_map_is_mapped(RIO* io, 
# 241 "project/radare2/libr/io/io_map.c" 3 4
                                      unsigned long long 
# 241 "project/radare2/libr/io/io_map.c"
                                           addr) {
 
# 242 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 242 "project/radare2/libr/io/io_map.c"
io
# 242 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 242 "project/radare2/libr/io/io_map.c"
"io"
# 242 "project/radare2/libr/io/io_map.c" 3 4
, 242); return (0); } } while (0)
# 242 "project/radare2/libr/io/io_map.c"
                                ;
 return (
# 243 "project/radare2/libr/io/io_map.c" 3 4
        _Bool
# 243 "project/radare2/libr/io/io_map.c"
            )r_io_map_get_at (io, addr);
}


# 246 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) 
# 246 "project/radare2/libr/io/io_map.c"
     void r_io_map_reset(RIO* io) {
 r_io_map_fini (io);
 r_io_map_init (io);
}


# 251 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) 
# 251 "project/radare2/libr/io/io_map.c"
     void r_io_map_del(RIO *io, 
# 251 "project/radare2/libr/io/io_map.c" 3 4
                                unsigned int 
# 251 "project/radare2/libr/io/io_map.c"
                                     id) {
 
# 252 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 252 "project/radare2/libr/io/io_map.c"
io && io->maps
# 252 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 252 "project/radare2/libr/io/io_map.c"
...
# 257 "project/radare2/libr/io/io_map.c" 3 4
unsigned int 
# 257 "project/radare2/libr/io/io_map.c"
     bankid;
 
# 258 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 258 "project/radare2/libr/io/io_map.c"
r_id_storage_get_lowest (io->banks, &bankid)
# 258 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 258 "project/radare2/libr/io/io_map.c"
...
# 258 "project/radare2/libr/io/io_map.c"
 ...
 _map_free_cb (
# 264 "project/radare2/libr/io/io_map.c" 3 4
              ((void *)0)
# 264 "project/radare2/libr/io/io_map.c"
                  , map, id);
}



# 268 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 268 "project/radare2/libr/io/io_map.c"
          r_io_map_del_for_fd(RIO* io, int fd) {
 
# 269 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 269 "project/radare2/libr/io/io_map.c"
io && io->maps
# 269 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 269 "project/radare2/libr/io/io_map.c"
"io && io->maps"
# 269 "project/radare2/libr/io/io_map.c" 3 4
, 269); return (0); } } while (0)
# 269 "project/radare2/libr/io/io_map.c"
                                            ;
 
# 270 "project/radare2/libr/io/io_map.c" 3 4
unsigned int 
# 270 "project/radare2/libr/io/io_map.c"
     map_id;
 if (!r_id_storage_get_lowest (io->maps, &map_id)) {
  return 
# 272 "project/radare2/libr/io/io_map.c" 3 4
        0
# 272 "project/radare2/libr/io/io_map.c"
             ;
 }

 
# 275 "project/radare2/libr/io/io_map.c" 3 4
_Bool 
# 275 "project/radare2/libr/io/io_map.c"
     ret = 
# 275 "project/radare2/libr/io/io_map.c" 3 4
           0
# 275 "project/radare2/libr/io/io_map.c"
...
# 276 "project/radare2/libr/io/io_map.c" 3 4
_Bool 
# 276 "project/radare2/libr/io/io_map.c"
     cont;
 do {
  
# 278 "project/radare2/libr/io/io_map.c" 3 4
 unsigned int 
# 278 "project/radare2/libr/io/io_map.c"
      next = map_id;
  cont = r_id_storage_get_next (io->maps, &next);
  RIOMap *map = r_io_map_get (io, map_id);
  if (map->fd == fd) {
   ret = 
# 282 "project/radare2/libr/io/io_map.c" 3 4
        1
# 282 "project/radare2/libr/io/io_map.c"
            ;
...
# 292 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 292 "project/radare2/libr/io/io_map.c"
          r_io_map_priorize(RIO* io, 
# 292 "project/radare2/libr/io/io_map.c" 3 4
                                     unsigned int 
# 292 "project/radare2/libr/io/io_map.c"
                                          id) {
 
# 293 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 293 "project/radare2/libr/io/io_map.c"
io
# 293 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 293 "project/radare2/libr/io/io_map.c"
...
# 297 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 297 "project/radare2/libr/io/io_map.c"
          r_io_map_depriorize(RIO* io, 
# 297 "project/radare2/libr/io/io_map.c" 3 4
                                       unsigned int 
# 297 "project/radare2/libr/io/io_map.c"
                                            id) {
 
# 298 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 298 "project/radare2/libr/io/io_map.c"
io
# 298 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 298 "project/radare2/libr/io/io_map.c"
...
# 302 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 302 "project/radare2/libr/io/io_map.c"
          r_io_map_priorize_for_fd(RIO *io, int fd) {
 
# 303 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 303 "project/radare2/libr/io/io_map.c"
io
# 303 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 303 "project/radare2/libr/io/io_map.c"
"io"
# 303 "project/radare2/libr/io/io_map.c" 3 4
, 303); return (0); } } while (0)
# 303 "project/radare2/libr/io/io_map.c"
                                ;
 RList *map_list = r_io_map_get_by_fd (io, fd);
 if (!map_list) {
  return 
# 306 "project/radare2/libr/io/io_map.c" 3 4
        0
# 306 "project/radare2/libr/io/io_map.c"
             ;
 }
 RListIter *iter;
 RIOMap *map;
 
# 310 "project/radare2/libr/io/io_map.c" 3 4
if (
# 310 "project/radare2/libr/io/io_map.c"
map_list
# 310 "project/radare2/libr/io/io_map.c" 3 4
) for (
# 310 "project/radare2/libr/io/io_map.c"
...
# 310 "project/radare2/libr/io/io_map.c"
 ...
 return 
# 314 "project/radare2/libr/io/io_map.c" 3 4
       1
# 314 "project/radare2/libr/io/io_map.c"
           ;
}



# 318 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) 
# 318 "project/radare2/libr/io/io_map.c"
     void r_io_map_cleanup(RIO* io) {
 
# 319 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 319 "project/radare2/libr/io/io_map.c"
io
# 319 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 319 "project/radare2/libr/io/io_map.c"
...
static 
# 329 "project/radare2/libr/io/io_map.c" 3 4
      _Bool 
# 329 "project/radare2/libr/io/io_map.c"
           _clear_banks_cb (void *user, void *data, 
# 329 "project/radare2/libr/io/io_map.c" 3 4
                                                    unsigned int 
# 329 "project/radare2/libr/io/io_map.c"
                                                         id) {
 ...
 return 
# 331 "project/radare2/libr/io/io_map.c" 3 4
       1
# 331 "project/radare2/libr/io/io_map.c"
           ;
}


# 334 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) 
# 334 "project/radare2/libr/io/io_map.c"
     void r_io_map_fini(RIO* io) {
 
# 335 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 335 "project/radare2/libr/io/io_map.c"
io
# 335 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 335 "project/radare2/libr/io/io_map.c"
...
# 335 "project/radare2/libr/io/io_map.c"
                     ;
 r_id_storage_foreach (io->banks, _clear_banks_cb, 
# 336 "project/radare2/libr/io/io_map.c" 3 4
                                                  ((void *)0)
# 336 "project/radare2/libr/io/io_map.c"
                                                      );
 r_id_storage_foreach (io->maps, _map_free_cb, 
# 337 "project/radare2/libr/io/io_map.c" 3 4
                                              ((void *)0)
# 337 "project/radare2/libr/io/io_map.c"
                                                  );
 r_id_storage_free (io->maps);
 io->maps = 
# 339 "project/radare2/libr/io/io_map.c" 3 4
           ((void *)0)
# 339 "project/radare2/libr/io/io_map.c"
               ;
}


# 342 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) 
# 342 "project/radare2/libr/io/io_map.c"
     void r_io_map_set_name(RIOMap* map, const char* name) {
 
# 343 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 343 "project/radare2/libr/io/io_map.c"
map && name
# 343 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 343 "project/radare2/libr/io/io_map.c"
...
# 348 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) 
# 348 "project/radare2/libr/io/io_map.c"
     void r_io_map_del_name(RIOMap* map) {
 
# 349 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 349 "project/radare2/libr/io/io_map.c"
map
# 349 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 349 "project/radare2/libr/io/io_map.c"
...
# 350 "project/radare2/libr/io/io_map.c" 3 4
{ free((void *)
# 350 "project/radare2/libr/io/io_map.c"
map->name
# 350 "project/radare2/libr/io/io_map.c" 3 4
); 
# 350 "project/radare2/libr/io/io_map.c"
...
# 353 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 353 "project/radare2/libr/io/io_map.c"
          r_io_map_locate(RIO *io, 
# 353 "project/radare2/libr/io/io_map.c" 3 4
                                   unsigned long long 
# 353 "project/radare2/libr/io/io_map.c"
                                        *addr, const 
...
# 354 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 354 "project/radare2/libr/io/io_map.c"
io
# 354 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 354 "project/radare2/libr/io/io_map.c"
...
# 361 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) 
# 361 "project/radare2/libr/io/io_map.c"
     RList* r_io_map_get_by_fd(RIO* io, int fd) {
 
# 362 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 362 "project/radare2/libr/io/io_map.c"
io
# 362 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 362 "project/radare2/libr/io/io_map.c"
...
# 362 "project/radare2/libr/io/io_map.c"
                               ;
 RList* map_list = r_list_newf (
# 363 "project/radare2/libr/io/io_map.c" 3 4
                               ((void *)0)
# 363 "project/radare2/libr/io/io_map.c"
                                   );
 if (!map_list) {
  return 
# 365 "project/radare2/libr/io/io_map.c" 3 4
        ((void *)0)
# 365 "project/radare2/libr/io/io_map.c"
            ;
 }
 RIOBank *bank = r_io_bank_get (io, io->bank);
 if (!bank) {
  return 
# 369 "project/radare2/libr/io/io_map.c" 3 4
        ((void *)0)
# 369 "project/radare2/libr/io/io_map.c"
            ;
 }
 RListIter *iter;
 RIOMapRef *mapref;
 
# 373 "project/radare2/libr/io/io_map.c" 3 4
if (
# 373 "project/radare2/libr/io/io_map.c"
bank->maprefs
# 373 "project/radare2/libr/io/io_map.c" 3 4
) for (
# 373 "project/radare2/libr/io/io_map.c"
...
# 382 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 382 "project/radare2/libr/io/io_map.c"
          r_io_map_resize(RIO *io, 
# 382 "project/radare2/libr/io/io_map.c" 3 4
                                   unsigned int 
# 382 "project/radare2/libr/io/io_map.c"
                                        id, 
...
# 383 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 383 "project/radare2/libr/io/io_map.c"
io
# 383 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 383 "project/radare2/libr/io/io_map.c"
"io"
# 383 "project/radare2/libr/io/io_map.c" 3 4
, 383); return (0); } } while (0)
# 383 "project/radare2/libr/io/io_map.c"
                                ;
 RIOMap *map;
 if (!newsize || !(map = r_io_map_get (io, id))) {
  return 
# 386 "project/radare2/libr/io/io_map.c" 3 4
        0
# 386 "project/radare2/libr/io/io_map.c"
             ;
 }
 
# 388 "project/radare2/libr/io/io_map.c" 3 4
unsigned long long 
# 388 "project/radare2/libr/io/io_map.c"
     addr = 
# 388 "project/radare2/libr/io/io_map.c" 3 4
            r_itv_begin (
# 388 "project/radare2/libr/io/io_map.c"
...
# 388 "project/radare2/libr/io/io_map.c"
                                ;
 const 
# 389 "project/radare2/libr/io/io_map.c" 3 4
      unsigned long long 
# 389 "project/radare2/libr/io/io_map.c"
           oto = 
# 389 "project/radare2/libr/io/io_map.c" 3 4
                 ( r_itv_end (
# 389 "project/radare2/libr/io/io_map.c"
...
# 389 "project/radare2/libr/io/io_map.c"
                                  ;
 if (
# 390 "project/radare2/libr/io/io_map.c" 3 4
    0xFFFFFFFFFFFFFFFFULL 
# 390 "project/radare2/libr/io/io_map.c"
             - newsize + 1 < addr) {
  
# 391 "project/radare2/libr/io/io_map.c" 3 4
 long long 
# 391 "project/radare2/libr/io/io_map.c"
      saddr = (
# 391 "project/radare2/libr/io/io_map.c" 3 4
               long long
# 391 "project/radare2/libr/io/io_map.c"
  ...
  const 
# 392 "project/radare2/libr/io/io_map.c" 3 4
       unsigned long long 
# 392 "project/radare2/libr/io/io_map.c"
            osize = 
# 392 "project/radare2/libr/io/io_map.c" 3 4
                    r_itv_size (
# 392 "project/radare2/libr/io/io_map.c"
...
# 393 "project/radare2/libr/io/io_map.c" 3 4
 do { 
# 393 "project/radare2/libr/io/io_map.c"
 map
# 393 "project/radare2/libr/io/io_map.c" 3 4
 ->itv.size = 
# 393 "project/radare2/libr/io/io_map.c"
...
# 393 "project/radare2/libr/io/io_map.c"
  ...
  if (newmap) {
   if (!io_bank_has_map (io, io->bank, id)) {
    ...
    r_io_bank_update_map_boundaries (io, io->bank, id, 
# 399 "project/radare2/libr/io/io_map.c" 3 4
                                                      r_itv_begin (
# 399 "project/radare2/libr/io/io_map.c"
                                                      map
# 399 "project/radare2/libr/io/io_map.c" 3 4
                                                      ->itv)
# 399 "project/radare2/libr/io/io_map.c"
...
# 401 "project/radare2/libr/io/io_map.c" 3 4
  unsigned int 
# 401 "project/radare2/libr/io/io_map.c"
       bankid;
   r_id_storage_get_lowest (io->banks, &bankid);
   do {
    if (bankid != io->bank && io_bank_has_map (io, bankid, id)) {
     ...
     r_io_bank_update_map_boundaries (io, io->bank, id, 
# 406 "project/radare2/libr/io/io_map.c" 3 4
                                                       r_itv_begin (
# 406 "project/radare2/libr/io/io_map.c"
                                                       map
# 406 "project/radare2/libr/io/io_map.c" 3 4
                                                       ->itv)
# 406 "project/radare2/libr/io/io_map.c"
...
# 412 "project/radare2/libr/io/io_map.c" 3 4
  do { 
# 412 "project/radare2/libr/io/io_map.c"
  map
# 412 "project/radare2/libr/io/io_map.c" 3 4
  ->itv.size = 
# 412 "project/radare2/libr/io/io_map.c"
...
# 412 "project/radare2/libr/io/io_map.c"
                                ;
   return 
# 413 "project/radare2/libr/io/io_map.c" 3 4
         0
# 413 "project/radare2/libr/io/io_map.c"
              ;
  }
  return 
# 415 "project/radare2/libr/io/io_map.c" 3 4
        1
# 415 "project/radare2/libr/io/io_map.c"
            ;
 }
 
# 417 "project/radare2/libr/io/io_map.c" 3 4
do { 
# 417 "project/radare2/libr/io/io_map.c"
map
# 417 "project/radare2/libr/io/io_map.c" 3 4
->itv.size = 
# 417 "project/radare2/libr/io/io_map.c"
...
# 418 "project/radare2/libr/io/io_map.c" 3 4
unsigned int 
# 418 "project/radare2/libr/io/io_map.c"
     bankid;
 r_id_storage_get_lowest (io->banks, &bankid);
 do {
  if (io_bank_has_map (io, bankid, id)) {

   r_io_bank_update_map_boundaries (io, bankid, id, 
# 423 "project/radare2/libr/io/io_map.c" 3 4
                                                   r_itv_begin (
# 423 "project/radare2/libr/io/io_map.c"
                                                   map
# 423 "project/radare2/libr/io/io_map.c" 3 4
                                                   ->itv)
# 423 "project/radare2/libr/io/io_map.c"
 ...
 return 
# 426 "project/radare2/libr/io/io_map.c" 3 4
       1
# 426 "project/radare2/libr/io/io_map.c"
           ;
}


# 429 "project/radare2/libr/io/io_map.c" 3 4
__attribute__((visibility("default"))) 
# 429 "project/radare2/libr/io/io_map.c"
     RIOMap *r_io_map_get_by_ref(RIO *io, RIOMapRef *ref) {
 
# 430 "project/radare2/libr/io/io_map.c" 3 4
do { if (!(
# 430 "project/radare2/libr/io/io_map.c"
io && ref
# 430 "project/radare2/libr/io/io_map.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 430 "project/radare2/libr/io/io_map.c"
"io && ref"
# 430 "project/radare2/libr/io/io_map.c" 3 4
, 430); return (((void *)0)); } } while (0)
# 430 "project/radare2/libr/io/io_map.c"
                                      ;
 RIOMap *map = r_io_map_get (io, ref->id);

 return (map && map->ts == ref->ts) ? map : 
# 433 "project/radare2/libr/io/io_map.c" 3 4
                                           ((void *)0)
# 433 "project/radare2/libr/io/io_map.c"
                                               ;
}
