# 0 "project/radare2/libr/io/io_bank.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/io/io_bank.c"
...
# 4 "project/radare2/libr/io/io_bank.c" 2


__attribute__((visibility("default"))) 
# 6 "project/radare2/libr/io/io_bank.c"
     RIOBank *r_io_bank_new(const char *name) {
 
# 7 "project/radare2/libr/io/io_bank.c" 3 4
do { if (!(
# 7 "project/radare2/libr/io/io_bank.c"
name
# 7 "project/radare2/libr/io/io_bank.c" 3 4
...
"name"
# 7 "project/radare2/libr/io/io_bank.c" 3 4
, 7); return (((void *)0)); } } while (0)
# 7 "project/radare2/libr/io/io_bank.c"
                                 ;
 RIOBank *bank = 
# 8 "project/radare2/libr/io/io_bank.c" 3 4
                (
# 8 "project/radare2/libr/io/io_bank.c"
                RIOBank
# 8 "project/radare2/libr/io/io_bank.c" 3 4
                *)calloc(1,sizeof(
# 8 "project/radare2/libr/io/io_bank.c"
...
# 8 "project/radare2/libr/io/io_bank.c"
 ...
 if (!bank) {
  return 
# 10 "project/radare2/libr/io/io_bank.c" 3 4
        ((void *)0)
# 10 "project/radare2/libr/io/io_bank.c"
            ;
 }
 ...
 if (!bank->submaps) {
  free (bank);
  return 
# 16 "project/radare2/libr/io/io_bank.c" 3 4
        ((void *)0)
# 16 "project/radare2/libr/io/io_bank.c"
            ;
 }
 ...
 if (!bank->maprefs) {
  ...
  free (bank);
  return 
# 22 "project/radare2/libr/io/io_bank.c" 3 4
        ((void *)0)
# 22 "project/radare2/libr/io/io_bank.c"
            ;
 }
 ...
 if (!bank->todo) {
  ...
  free (bank);
  return 
# 29 "project/radare2/libr/io/io_bank.c" 3 4
        ((void *)0)
# 29 "project/radare2/libr/io/io_bank.c"
            ;
 }
 return bank;
}
...
# 34 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) 
# 34 "project/radare2/libr/io/io_bank.c"
     void r_io_bank_clear(RIOBank *bank) {
 
# 35 "project/radare2/libr/io/io_bank.c" 3 4
do { if (!(
# 35 "project/radare2/libr/io/io_bank.c"
bank
# 35 "project/radare2/libr/io/io_bank.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 35 "project/radare2/libr/io/io_bank.c"
...
# 35 "project/radare2/libr/io/io_bank.c"
 ...
 bank->last_used = 
# 39 "project/radare2/libr/io/io_bank.c" 3 4
                  ((void *)0)
# 39 "project/radare2/libr/io/io_bank.c"
                      ;
...
# 44 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) 
# 44 "project/radare2/libr/io/io_bank.c"
     void r_io_bank_free(RIOBank *bank) {
 if (bank) {
...
# 54 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) 
# 54 "project/radare2/libr/io/io_bank.c"
     void r_io_bank_init(RIO *io) {
 
# 55 "project/radare2/libr/io/io_bank.c" 3 4
do { if (!(
# 55 "project/radare2/libr/io/io_bank.c"
io
# 55 "project/radare2/libr/io/io_bank.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 55 "project/radare2/libr/io/io_bank.c"
...
# 55 "project/radare2/libr/io/io_bank.c"
                     ;
 r_io_bank_fini (io);
 io->banks = r_id_storage_new (0, 
# 57 "project/radare2/libr/io/io_bank.c" 3 4
                                 0xFFFFFFFFU
# 57 "project/radare2/libr/io/io_bank.c"
                                         );
}


static 
# 61 "project/radare2/libr/io/io_bank.c" 3 4
      _Bool 
# 61 "project/radare2/libr/io/io_bank.c"
           _bank_free_cb(void *user, void *data, 
# 61 "project/radare2/libr/io/io_bank.c" 3 4
                                                 unsigned int 
# 61 "project/radare2/libr/io/io_bank.c"
                                                      id) {
 ...
 return 
# 63 "project/radare2/libr/io/io_bank.c" 3 4
       1
# 63 "project/radare2/libr/io/io_bank.c"
           ;
}


# 66 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) 
# 66 "project/radare2/libr/io/io_bank.c"
     void r_io_bank_fini(RIO *io) {
 
# 67 "project/radare2/libr/io/io_bank.c" 3 4
do { if (!(
# 67 "project/radare2/libr/io/io_bank.c"
io
# 67 "project/radare2/libr/io/io_bank.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 67 "project/radare2/libr/io/io_bank.c"
...
# 67 "project/radare2/libr/io/io_bank.c"
                     ;
 if (io->banks) {
  r_id_storage_foreach (io->banks, _bank_free_cb, 
# 69 "project/radare2/libr/io/io_bank.c" 3 4
                                                 ((void *)0)
# 69 "project/radare2/libr/io/io_bank.c"
                                                     );
  r_id_storage_free (io->banks);
  io->banks = 
# 71 "project/radare2/libr/io/io_bank.c" 3 4
             ((void *)0)
# 71 "project/radare2/libr/io/io_bank.c"
                 ;
 }
}


# 75 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) 
# 75 "project/radare2/libr/io/io_bank.c"
     RIOBank *r_io_bank_get(RIO *io, const 
# 75 "project/radare2/libr/io/io_bank.c" 3 4
                                           unsigned int 
# 75 "project/radare2/libr/io/io_bank.c"
                                                bankid) {
 
# 76 "project/radare2/libr/io/io_bank.c" 3 4
do { if (!(
# 76 "project/radare2/libr/io/io_bank.c"
io && io->banks
# 76 "project/radare2/libr/io/io_bank.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 76 "project/radare2/libr/io/io_bank.c"
...
# 80 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) unsigned int 
# 80 "project/radare2/libr/io/io_bank.c"
          r_io_bank_first(RIO *io) {
 
# 81 "project/radare2/libr/io/io_bank.c" 3 4
unsigned int 
# 81 "project/radare2/libr/io/io_bank.c"
     bankid = -1;
...
# 86 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 86 "project/radare2/libr/io/io_bank.c"
          r_io_bank_use(RIO *io, 
# 86 "project/radare2/libr/io/io_bank.c" 3 4
                                 unsigned int 
# 86 "project/radare2/libr/io/io_bank.c"
                                      bankid) {
 ...
 if (bank) {
  io->bank = bankid;
  return 
# 90 "project/radare2/libr/io/io_bank.c" 3 4
        1
# 90 "project/radare2/libr/io/io_bank.c"
            ;
 }
 return 
# 92 "project/radare2/libr/io/io_bank.c" 3 4
       0
# 92 "project/radare2/libr/io/io_bank.c"
            ;
}


# 95 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 95 "project/radare2/libr/io/io_bank.c"
          r_io_bank_add(RIO *io, RIOBank *bank) {
 
# 96 "project/radare2/libr/io/io_bank.c" 3 4
do { if (!(
# 96 "project/radare2/libr/io/io_bank.c"
io && io->banks && bank
# 96 "project/radare2/libr/io/io_bank.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 96 "project/radare2/libr/io/io_bank.c"
...
static RIOMapRef *_mapref_from_map(RIOMap *map) {
 RIOMapRef *mapref = 
# 101 "project/radare2/libr/io/io_bank.c" 3 4
                    (
# 101 "project/radare2/libr/io/io_bank.c"
                    RIOMapRef
# 101 "project/radare2/libr/io/io_bank.c" 3 4
                    *)malloc(sizeof(
# 101 "project/radare2/libr/io/io_bank.c"
...
static int _find_sm_by_from_vaddr_cb(void *incoming, void *in, void *user) {
 ...
 if (
# 113 "project/radare2/libr/io/io_bank.c" 3 4
    (r_itv_begin (
# 113 "project/radare2/libr/io/io_bank.c"
    bd
# 113 "project/radare2/libr/io/io_bank.c" 3 4
    ->itv)) 
# 113 "project/radare2/libr/io/io_bank.c"
...
# 113 "project/radare2/libr/io/io_bank.c"
 ...
 if (
# 116 "project/radare2/libr/io/io_bank.c" 3 4
    (r_itv_begin (
# 116 "project/radare2/libr/io/io_bank.c"
    bd
# 116 "project/radare2/libr/io/io_bank.c" 3 4
    ->itv)) 
# 116 "project/radare2/libr/io/io_bank.c"
...
static int _find_sm_by_vaddr_cb(void *incoming, void *in, void *user) {
 const 
# 123 "project/radare2/libr/io/io_bank.c" 3 4
      unsigned long long 
# 123 "project/radare2/libr/io/io_bank.c"
           addr = ((
# 123 "project/radare2/libr/io/io_bank.c" 3 4
                    unsigned long long 
# 123 "project/radare2/libr/io/io_bank.c"
 ...
 if (
# 125 "project/radare2/libr/io/io_bank.c" 3 4
    r_itv_contain (
# 125 "project/radare2/libr/io/io_bank.c"
    sm
# 125 "project/radare2/libr/io/io_bank.c" 3 4
    ->itv, 
# 125 "project/radare2/libr/io/io_bank.c"
...
# 125 "project/radare2/libr/io/io_bank.c"
 ...
 if (addr < 
# 128 "project/radare2/libr/io/io_bank.c" 3 4
           (r_itv_begin (
# 128 "project/radare2/libr/io/io_bank.c"
           sm
# 128 "project/radare2/libr/io/io_bank.c" 3 4
           ->itv))
# 128 "project/radare2/libr/io/io_bank.c"
...
static int _find_lowest_intersection_sm_cb(void *incoming, void *in, void *user) {
 RIOSubMap *bd = (RIOSubMap *)incoming, *sm = (RIOSubMap *)in;
 if (
# 136 "project/radare2/libr/io/io_bank.c" 3 4
    r_itv_overlap(
# 136 "project/radare2/libr/io/io_bank.c"
    bd
# 136 "project/radare2/libr/io/io_bank.c" 3 4
    ->itv, 
# 136 "project/radare2/libr/io/io_bank.c"
...
# 136 "project/radare2/libr/io/io_bank.c"
 ...
 if (
# 139 "project/radare2/libr/io/io_bank.c" 3 4
    (r_itv_begin (
# 139 "project/radare2/libr/io/io_bank.c"
    bd
# 139 "project/radare2/libr/io/io_bank.c" 3 4
    ->itv)) 
# 139 "project/radare2/libr/io/io_bank.c"
...
static RRBNode *_find_entry_submap_node(RIOBank *bank, RIOSubMap *sm) {
 RRBNode *node = r_crbtree_find_node (bank->submaps, sm, _find_lowest_intersection_sm_cb, 
# 147 "project/radare2/libr/io/io_bank.c" 3 4
                                                                                         ((void *)0)
# 147 "project/radare2/libr/io/io_bank.c"
                                                                                             );
 if (!node) {
  return 
# 149 "project/radare2/libr/io/io_bank.c" 3 4
        ((void *)0)
# 149 "project/radare2/libr/io/io_bank.c"
            ;
 }
 RRBNode *prev = r_rbnode_prev (node);
 while (prev && 
# 152 "project/radare2/libr/io/io_bank.c" 3 4
               r_itv_overlap(
# 152 "project/radare2/libr/io/io_bank.c"
               ((RIOSubMap *)prev->data)
# 152 "project/radare2/libr/io/io_bank.c" 3 4
               ->itv, 
# 152 "project/radare2/libr/io/io_bank.c"
...
# 159 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 159 "project/radare2/libr/io/io_bank.c"
          r_io_bank_map_add_top(RIO *io, const 
# 159 "project/radare2/libr/io/io_bank.c" 3 4
                                               unsigned int 
# 159 "project/radare2/libr/io/io_bank.c"
                                                    bankid, const 
...
# 162 "project/radare2/libr/io/io_bank.c" 3 4
do { if (!(
# 162 "project/radare2/libr/io/io_bank.c"
io && bank && map
# 162 "project/radare2/libr/io/io_bank.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 162 "project/radare2/libr/io/io_bank.c"
"io && bank && map"
# 162 "project/radare2/libr/io/io_bank.c" 3 4
, 162); return (0); } } while (0)
# 162 "project/radare2/libr/io/io_bank.c"
                                               ;
 RIOMapRef *mapref = _mapref_from_map (map);
 if (!mapref) {
  return 
# 165 "project/radare2/libr/io/io_bank.c" 3 4
        0
# 165 "project/radare2/libr/io/io_bank.c"
             ;
 }
 ...
 if (!sm) {
  free (mapref);
  return 
# 170 "project/radare2/libr/io/io_bank.c" 3 4
        0
# 170 "project/radare2/libr/io/io_bank.c"
             ;
 }
 RRBNode *entry = _find_entry_submap_node (bank, sm);
 if (!entry) {

  if (!r_crbtree_insert (bank->submaps, sm, _find_sm_by_from_vaddr_cb, 
# 175 "project/radare2/libr/io/io_bank.c" 3 4
                                                                      ((void *)0)
# 175 "project/radare2/libr/io/io_bank.c"
                                                                          )) {
   free (sm);
   free (mapref);
   return 
# 178 "project/radare2/libr/io/io_bank.c" 3 4
         0
# 178 "project/radare2/libr/io/io_bank.c"
              ;
  }
  r_list_append (bank->maprefs, mapref);
  return 
# 181 "project/radare2/libr/io/io_bank.c" 3 4
        1
# 181 "project/radare2/libr/io/io_bank.c"
            ;
 }
 bank->last_used = 
# 183 "project/radare2/libr/io/io_bank.c" 3 4
                  ((void *)0)
# 183 "project/radare2/libr/io/io_bank.c"
                      ;
 RIOSubMap *bd = (RIOSubMap *)entry->data;
 if (
# 185 "project/radare2/libr/io/io_bank.c" 3 4
    (( r_itv_end (
# 185 "project/radare2/libr/io/io_bank.c"
    bd
# 185 "project/radare2/libr/io/io_bank.c" 3 4
    ->itv) - 1 )) 
# 185 "project/radare2/libr/io/io_bank.c"
...
# 186 "project/radare2/libr/io/io_bank.c" 3 4
 (r_itv_begin (
# 186 "project/radare2/libr/io/io_bank.c"
 bd
# 186 "project/radare2/libr/io/io_bank.c" 3 4
 ->itv)) 
# 186 "project/radare2/libr/io/io_bank.c"
...
# 190 "project/radare2/libr/io/io_bank.c" 3 4
 __builtin___memcpy_chk (
# 190 "project/radare2/libr/io/io_bank.c"
 bd
# 190 "project/radare2/libr/io/io_bank.c" 3 4
 , 
# 190 "project/radare2/libr/io/io_bank.c"
...
# 190 "project/radare2/libr/io/io_bank.c"
  ...
  r_list_append (bank->maprefs, mapref);
  return 
# 193 "project/radare2/libr/io/io_bank.c" 3 4
        1
# 193 "project/radare2/libr/io/io_bank.c"
            ;
 }
 if (
# 195 "project/radare2/libr/io/io_bank.c" 3 4
    (r_itv_begin (
# 195 "project/radare2/libr/io/io_bank.c"
    bd
# 195 "project/radare2/libr/io/io_bank.c" 3 4
    ->itv)) 
# 195 "project/radare2/libr/io/io_bank.c"
...
# 196 "project/radare2/libr/io/io_bank.c" 3 4
 (( r_itv_end (
# 196 "project/radare2/libr/io/io_bank.c"
 sm
# 196 "project/radare2/libr/io/io_bank.c" 3 4
 ->itv) - 1 )) 
# 196 "project/radare2/libr/io/io_bank.c"
...
# 196 "project/radare2/libr/io/io_bank.c"
  ...
  RIOSubMap *bdsm = 
# 198 "project/radare2/libr/io/io_bank.c" 3 4
                   (
# 198 "project/radare2/libr/io/io_bank.c"
                   RIOSubMap
# 198 "project/radare2/libr/io/io_bank.c" 3 4
                   *)r_new_copy(sizeof(
# 198 "project/radare2/libr/io/io_bank.c"
...
# 198 "project/radare2/libr/io/io_bank.c"
  ...
  if (!bdsm) {
   ...
   free (mapref);
   return 
# 202 "project/radare2/libr/io/io_bank.c" 3 4
         0
# 202 "project/radare2/libr/io/io_bank.c"
              ;
  }
  r_io_submap_set_from (bdsm, 
# 204 "project/radare2/libr/io/io_bank.c" 3 4
                             (( r_itv_end (
# 204 "project/radare2/libr/io/io_bank.c"
                             sm
# 204 "project/radare2/libr/io/io_bank.c" 3 4
                             ->itv) - 1 )) 
# 204 "project/radare2/libr/io/io_bank.c"
                                                 + 1);
  r_io_submap_set_to (bd, 
# 205 "project/radare2/libr/io/io_bank.c" 3 4
                         (r_itv_begin (
# 205 "project/radare2/libr/io/io_bank.c"
                         sm
# 205 "project/radare2/libr/io/io_bank.c" 3 4
                         ->itv)) 
# 205 "project/radare2/libr/io/io_bank.c"
  ...
  if (!r_crbtree_insert (bank->submaps, sm, _find_sm_by_from_vaddr_cb, 
# 207 "project/radare2/libr/io/io_bank.c" 3 4
                                                                      ((void *)0)
# 207 "project/radare2/libr/io/io_bank.c"
                                                                          )) {
   free (sm);
   free (bdsm);
   free (mapref);
   return 
# 211 "project/radare2/libr/io/io_bank.c" 3 4
         0
# 211 "project/radare2/libr/io/io_bank.c"
              ;
  }
  if (!r_crbtree_insert (bank->submaps, bdsm, _find_sm_by_from_vaddr_cb, 
# 213 "project/radare2/libr/io/io_bank.c" 3 4
                                                                        ((void *)0)
# 213 "project/radare2/libr/io/io_bank.c"
                                                                            )) {
   r_crbtree_delete (bank->submaps, sm, _find_sm_by_from_vaddr_cb, 
# 214 "project/radare2/libr/io/io_bank.c" 3 4
                                                                  ((void *)0)
# 214 "project/radare2/libr/io/io_bank.c"
                                                                      );
   free (sm);
   free (bdsm);
   free (mapref);
   return 
# 218 "project/radare2/libr/io/io_bank.c" 3 4
         0
# 218 "project/radare2/libr/io/io_bank.c"
              ;
  }
  r_list_append (bank->maprefs, mapref);
  return 
# 221 "project/radare2/libr/io/io_bank.c" 3 4
        1
# 221 "project/radare2/libr/io/io_bank.c"
            ;
 }


 if (
# 225 "project/radare2/libr/io/io_bank.c" 3 4
    (r_itv_begin (
# 225 "project/radare2/libr/io/io_bank.c"
    bd
# 225 "project/radare2/libr/io/io_bank.c" 3 4
    ->itv)) 
# 225 "project/radare2/libr/io/io_bank.c"
...
# 225 "project/radare2/libr/io/io_bank.c"
  ...
  r_io_submap_set_to (bd, 
# 226 "project/radare2/libr/io/io_bank.c" 3 4
                         (r_itv_begin (
# 226 "project/radare2/libr/io/io_bank.c"
                         sm
# 226 "project/radare2/libr/io/io_bank.c" 3 4
                         ->itv)) 
# 226 "project/radare2/libr/io/io_bank.c"
 ...
 while (entry && 
# 229 "project/radare2/libr/io/io_bank.c" 3 4
                (( r_itv_end (
# 229 "project/radare2/libr/io/io_bank.c"
...
# 233 "project/radare2/libr/io/io_bank.c" 3 4
                                                                          ((void *)0)
# 233 "project/radare2/libr/io/io_bank.c"
                                                                              );
  entry = next;
 }
 if (entry && 
# 236 "project/radare2/libr/io/io_bank.c" 3 4
             (r_itv_begin (
# 236 "project/radare2/libr/io/io_bank.c"
             ((RIOSubMap *)entry->data)
# 236 "project/radare2/libr/io/io_bank.c" 3 4
             ->itv)) 
# 236 "project/radare2/libr/io/io_bank.c"
...
# 236 "project/radare2/libr/io/io_bank.c"
  ...
  r_io_submap_set_from (bd, 
# 238 "project/radare2/libr/io/io_bank.c" 3 4
                           (( r_itv_end (
# 238 "project/radare2/libr/io/io_bank.c"
                           sm
# 238 "project/radare2/libr/io/io_bank.c" 3 4
                           ->itv) - 1 )) 
# 238 "project/radare2/libr/io/io_bank.c"
 ...
 if (!r_crbtree_insert (bank->submaps, sm, _find_sm_by_from_vaddr_cb, 
# 240 "project/radare2/libr/io/io_bank.c" 3 4
                                                                     ((void *)0)
# 240 "project/radare2/libr/io/io_bank.c"
                                                                         )) {
  free (sm);
  free (mapref);
  return 
# 243 "project/radare2/libr/io/io_bank.c" 3 4
        0
# 243 "project/radare2/libr/io/io_bank.c"
             ;
 }
 r_list_append (bank->maprefs, mapref);
 return 
# 246 "project/radare2/libr/io/io_bank.c" 3 4
       1
# 246 "project/radare2/libr/io/io_bank.c"
           ;
}


# 249 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 249 "project/radare2/libr/io/io_bank.c"
          r_io_bank_map_add_bottom(RIO *io, const 
# 249 "project/radare2/libr/io/io_bank.c" 3 4
                                                  unsigned int 
# 249 "project/radare2/libr/io/io_bank.c"
                                                       bankid, const 
...
# 252 "project/radare2/libr/io/io_bank.c" 3 4
do { if (!(
# 252 "project/radare2/libr/io/io_bank.c"
io && bank && map
# 252 "project/radare2/libr/io/io_bank.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 252 "project/radare2/libr/io/io_bank.c"
"io && bank && map"
# 252 "project/radare2/libr/io/io_bank.c" 3 4
, 252); return (0); } } while (0)
# 252 "project/radare2/libr/io/io_bank.c"
                                               ;
 RIOMapRef *mapref = _mapref_from_map (map);
 if (!mapref) {
  return 
# 255 "project/radare2/libr/io/io_bank.c" 3 4
        0
# 255 "project/radare2/libr/io/io_bank.c"
             ;
 }
 RIOSubMap *sm = r_io_submap_new (io, mapref);
 if (!sm) {
  free (mapref);
  return 
# 260 "project/radare2/libr/io/io_bank.c" 3 4
        0
# 260 "project/radare2/libr/io/io_bank.c"
             ;
 }
 RRBNode *entry = _find_entry_submap_node (bank, sm);
 if (!entry) {
  ...
  if (!r_crbtree_insert (bank->submaps, sm, _find_sm_by_from_vaddr_cb, 
# 265 "project/radare2/libr/io/io_bank.c" 3 4
                                                                      ((void *)0)
# 265 "project/radare2/libr/io/io_bank.c"
                                                                          )) {
   free (sm);
   free (mapref);
   return 
# 268 "project/radare2/libr/io/io_bank.c" 3 4
         0
# 268 "project/radare2/libr/io/io_bank.c"
              ;
  }
  r_list_prepend (bank->maprefs, mapref);
  return 
# 271 "project/radare2/libr/io/io_bank.c" 3 4
        1
# 271 "project/radare2/libr/io/io_bank.c"
            ;
 }
 while (entry && 
# 273 "project/radare2/libr/io/io_bank.c" 3 4
                (r_itv_begin (
# 273 "project/radare2/libr/io/io_bank.c"
                ((RIOSubMap *)entry->data)
# 273 "project/radare2/libr/io/io_bank.c" 3 4
                ->itv)) 
# 273 "project/radare2/libr/io/io_bank.c"
...
# 273 "project/radare2/libr/io/io_bank.c"
  ...
  RIOSubMap *bd = (RIOSubMap *)entry->data;
  if (
# 275 "project/radare2/libr/io/io_bank.c" 3 4
     (r_itv_begin (
# 275 "project/radare2/libr/io/io_bank.c"
     sm
# 275 "project/radare2/libr/io/io_bank.c" 3 4
     ->itv)) 
# 275 "project/radare2/libr/io/io_bank.c"
...
# 275 "project/radare2/libr/io/io_bank.c"
   ...
   RIOSubMap *bdsm = 
# 276 "project/radare2/libr/io/io_bank.c" 3 4
                    (
# 276 "project/radare2/libr/io/io_bank.c"
                    RIOSubMap
# 276 "project/radare2/libr/io/io_bank.c" 3 4
                    *)r_new_copy(sizeof(
# 276 "project/radare2/libr/io/io_bank.c"
...
# 276 "project/radare2/libr/io/io_bank.c"
                                             ;
   r_io_submap_set_to (bdsm, 
# 277 "project/radare2/libr/io/io_bank.c" 3 4
                            (r_itv_begin (
# 277 "project/radare2/libr/io/io_bank.c"
                            bd
# 277 "project/radare2/libr/io/io_bank.c" 3 4
                            ->itv)) 
# 277 "project/radare2/libr/io/io_bank.c"
                                                  - 1);
   r_crbtree_insert (bank->submaps, bdsm, _find_sm_by_from_vaddr_cb, 
# 278 "project/radare2/libr/io/io_bank.c" 3 4
                                                                    ((void *)0)
# 278 "project/radare2/libr/io/io_bank.c"
                                                                        );
  }
  if (
# 280 "project/radare2/libr/io/io_bank.c" 3 4
     (( r_itv_end (
# 280 "project/radare2/libr/io/io_bank.c"
     sm
# 280 "project/radare2/libr/io/io_bank.c" 3 4
     ->itv) - 1 )) 
# 280 "project/radare2/libr/io/io_bank.c"
...
# 280 "project/radare2/libr/io/io_bank.c"
   ...
   free (sm);
   return 
# 283 "project/radare2/libr/io/io_bank.c" 3 4
         1
# 283 "project/radare2/libr/io/io_bank.c"
             ;
  }
  r_io_submap_set_from (sm, 
# 285 "project/radare2/libr/io/io_bank.c" 3 4
                           (( r_itv_end (
# 285 "project/radare2/libr/io/io_bank.c"
                           bd
# 285 "project/radare2/libr/io/io_bank.c" 3 4
                           ->itv) - 1 )) 
# 285 "project/radare2/libr/io/io_bank.c"
 ...
 r_crbtree_insert (bank->submaps, sm, _find_sm_by_from_vaddr_cb, 
# 288 "project/radare2/libr/io/io_bank.c" 3 4
                                                                ((void *)0)
# 288 "project/radare2/libr/io/io_bank.c"
                                                                    );
 r_list_prepend (bank->maprefs, mapref);
 return 
# 290 "project/radare2/libr/io/io_bank.c" 3 4
       1
# 290 "project/radare2/libr/io/io_bank.c"
           ;
}


# 293 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 293 "project/radare2/libr/io/io_bank.c"
          r_io_bank_map_priorize(RIO *io, const 
# 293 "project/radare2/libr/io/io_bank.c" 3 4
                                                unsigned int 
# 293 "project/radare2/libr/io/io_bank.c"
                                                     bankid, const 
...
# 295 "project/radare2/libr/io/io_bank.c" 3 4
do { if (!(
# 295 "project/radare2/libr/io/io_bank.c"
io && bank
# 295 "project/radare2/libr/io/io_bank.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 295 "project/radare2/libr/io/io_bank.c"
"io && bank"
# 295 "project/radare2/libr/io/io_bank.c" 3 4
, 295); return (0); } } while (0)
# 295 "project/radare2/libr/io/io_bank.c"
                                        ;
 RListIter *iter;
 RIOMapRef *mapref;
 
# 298 "project/radare2/libr/io/io_bank.c" 3 4
if (
# 298 "project/radare2/libr/io/io_bank.c"
bank->maprefs
# 298 "project/radare2/libr/io/io_bank.c" 3 4
) for (
# 298 "project/radare2/libr/io/io_bank.c"
...
# 298 "project/radare2/libr/io/io_bank.c"
 ...
 return 
# 303 "project/radare2/libr/io/io_bank.c" 3 4
       0
# 303 "project/radare2/libr/io/io_bank.c"
            ;
found:
 if (iter == bank->maprefs->tail) {
  return r_io_map_get_by_ref (io, mapref) ? 
# 306 "project/radare2/libr/io/io_bank.c" 3 4
                                           1 
# 306 "project/radare2/libr/io/io_bank.c"
                                                : 
# 306 "project/radare2/libr/io/io_bank.c" 3 4
                                                  0
# 306 "project/radare2/libr/io/io_bank.c"
 ...
 if (!sm) {
  return 
# 310 "project/radare2/libr/io/io_bank.c" 3 4
        0
# 310 "project/radare2/libr/io/io_bank.c"
             ;
 }
 RRBNode *entry = _find_entry_submap_node (bank, sm);
 if (!entry) {
  ...
  free (sm);
  return 
# 316 "project/radare2/libr/io/io_bank.c" 3 4
        0
# 316 "project/radare2/libr/io/io_bank.c"
             ;
 }
 bank->last_used = 
# 318 "project/radare2/libr/io/io_bank.c" 3 4
                  ((void *)0)
# 318 "project/radare2/libr/io/io_bank.c"
                      ;
 RIOSubMap *bd = (RIOSubMap *)entry->data;
 if (r_itv_eq (bd->itv, sm->itv)) {
  ...
  return 
# 326 "project/radare2/libr/io/io_bank.c" 3 4
        1
# 326 "project/radare2/libr/io/io_bank.c"
            ;
 }
 if (
# 328 "project/radare2/libr/io/io_bank.c" 3 4
    (r_itv_begin (
# 328 "project/radare2/libr/io/io_bank.c"
    bd
# 328 "project/radare2/libr/io/io_bank.c" 3 4
    ->itv)) 
# 328 "project/radare2/libr/io/io_bank.c"
...
# 329 "project/radare2/libr/io/io_bank.c" 3 4
 (( r_itv_end (
# 329 "project/radare2/libr/io/io_bank.c"
 sm
# 329 "project/radare2/libr/io/io_bank.c" 3 4
 ->itv) - 1 )) 
# 329 "project/radare2/libr/io/io_bank.c"
...
# 329 "project/radare2/libr/io/io_bank.c"
  ...
  RIOSubMap *bdsm = 
# 333 "project/radare2/libr/io/io_bank.c" 3 4
                   (
# 333 "project/radare2/libr/io/io_bank.c"
                   RIOSubMap
# 333 "project/radare2/libr/io/io_bank.c" 3 4
                   *)r_new_copy(sizeof(
# 333 "project/radare2/libr/io/io_bank.c"
...
# 333 "project/radare2/libr/io/io_bank.c"
  ...
  if (!bdsm) {
   free (sm);
   return 
# 336 "project/radare2/libr/io/io_bank.c" 3 4
         0
# 336 "project/radare2/libr/io/io_bank.c"
              ;
  }
  r_io_submap_set_from (bdsm, 
# 338 "project/radare2/libr/io/io_bank.c" 3 4
                             (( r_itv_end (
# 338 "project/radare2/libr/io/io_bank.c"
                             sm
# 338 "project/radare2/libr/io/io_bank.c" 3 4
                             ->itv) - 1 )) 
# 338 "project/radare2/libr/io/io_bank.c"
                                                 + 1);
  r_io_submap_set_to (bd, 
# 339 "project/radare2/libr/io/io_bank.c" 3 4
                         (r_itv_begin (
# 339 "project/radare2/libr/io/io_bank.c"
                         sm
# 339 "project/radare2/libr/io/io_bank.c" 3 4
                         ->itv)) 
# 339 "project/radare2/libr/io/io_bank.c"
  ...
  r_list_iter_to_top (bank->maprefs, iter);
  return r_crbtree_insert (bank->submaps, sm, _find_sm_by_from_vaddr_cb, 
# 342 "project/radare2/libr/io/io_bank.c" 3 4
                                                                        ((void *)0)
# 342 "project/radare2/libr/io/io_bank.c"
                                                                            ) &
   r_crbtree_insert (bank->submaps, bdsm, _find_sm_by_from_vaddr_cb, 
# 343 "project/radare2/libr/io/io_bank.c" 3 4
                                                                    ((void *)0)
# 343 "project/radare2/libr/io/io_bank.c"
                                                                        );
 }

 if (
# 346 "project/radare2/libr/io/io_bank.c" 3 4
    (r_itv_begin (
# 346 "project/radare2/libr/io/io_bank.c"
    bd
# 346 "project/radare2/libr/io/io_bank.c" 3 4
    ->itv)) 
# 346 "project/radare2/libr/io/io_bank.c"
...
# 346 "project/radare2/libr/io/io_bank.c"
  ...
  r_io_submap_set_to (bd, 
# 347 "project/radare2/libr/io/io_bank.c" 3 4
                         (r_itv_begin (
# 347 "project/radare2/libr/io/io_bank.c"
                         sm
# 347 "project/radare2/libr/io/io_bank.c" 3 4
                         ->itv)) 
# 347 "project/radare2/libr/io/io_bank.c"
 ...
 while (entry && 
# 350 "project/radare2/libr/io/io_bank.c" 3 4
                (( r_itv_end (
# 350 "project/radare2/libr/io/io_bank.c"
                ((RIOSubMap *)entry->data)
# 350 "project/radare2/libr/io/io_bank.c" 3 4
                ->itv) - 1 )) 
# 350 "project/radare2/libr/io/io_bank.c"
...
# 350 "project/radare2/libr/io/io_bank.c"
  ...
  r_crbtree_delete (bank->submaps, entry->data, _find_sm_by_from_vaddr_cb, 
# 354 "project/radare2/libr/io/io_bank.c" 3 4
                                                                          ((void *)0)
# 354 "project/radare2/libr/io/io_bank.c"
                                                                              );
  entry = next;
 }
 if (entry && 
# 357 "project/radare2/libr/io/io_bank.c" 3 4
             (r_itv_begin (
# 357 "project/radare2/libr/io/io_bank.c"
             ((RIOSubMap *)entry->data)
# 357 "project/radare2/libr/io/io_bank.c" 3 4
             ->itv)) 
# 357 "project/radare2/libr/io/io_bank.c"
...
# 357 "project/radare2/libr/io/io_bank.c"
  ...
  bd = (RIOSubMap *)entry->data;
  r_io_submap_set_from (bd, 
# 359 "project/radare2/libr/io/io_bank.c" 3 4
                           (( r_itv_end (
# 359 "project/radare2/libr/io/io_bank.c"
                           sm
# 359 "project/radare2/libr/io/io_bank.c" 3 4
                           ->itv) - 1 )) 
# 359 "project/radare2/libr/io/io_bank.c"
 ...
 r_list_iter_to_top (bank->maprefs, iter);
 return r_crbtree_insert (bank->submaps, sm, _find_sm_by_from_vaddr_cb, 
# 362 "project/radare2/libr/io/io_bank.c" 3 4
                                                                       ((void *)0)
# 362 "project/radare2/libr/io/io_bank.c"
                                                                           );
}
...
static void _delete_submaps_from_bank_tree(RIO *io, RIOBank *bank, RListIter *prio, RIOMap *map) {
 ...
 RIOSubMap *bd = (RIOSubMap *)entry->data;
 while (bd && 
# 378 "project/radare2/libr/io/io_bank.c" 3 4
             r_itv_overlap(
# 378 "project/radare2/libr/io/io_bank.c"
             bd
# 378 "project/radare2/libr/io/io_bank.c" 3 4
             ->itv, 
# 378 "project/radare2/libr/io/io_bank.c"
...
# 378 "project/radare2/libr/io/io_bank.c"
  ...
  if (bd->mapref.id == fake_sm.mapref.id) {
   r_queue_enqueue (bank->todo, 
# 383 "project/radare2/libr/io/io_bank.c" 3 4
                               (
# 383 "project/radare2/libr/io/io_bank.c"
                               RIOSubMap
# 383 "project/radare2/libr/io/io_bank.c" 3 4
                               *)r_new_copy(sizeof(
# 383 "project/radare2/libr/io/io_bank.c"
...
# 383 "project/radare2/libr/io/io_bank.c"
   ...
   r_crbtree_delete (bank->submaps, bd, _find_sm_by_from_vaddr_cb, 
# 384 "project/radare2/libr/io/io_bank.c" 3 4
                                                                  ((void *)0)
# 384 "project/radare2/libr/io/io_bank.c"
                                                                      );
  }
  entry = next;
  bd = entry ? (RIOSubMap *)entry->data : 
# 387 "project/radare2/libr/io/io_bank.c" 3 4
                                         ((void *)0)
# 387 "project/radare2/libr/io/io_bank.c"
                                             ;
 }
 RListIter *iter = prio;
 while (!r_queue_is_empty (bank->todo)) {
  ...
  while (ator) {
   ...
   if (
# 409 "project/radare2/libr/io/io_bank.c" 3 4
      (( r_itv_end (
# 409 "project/radare2/libr/io/io_bank.c"
      sm
# 409 "project/radare2/libr/io/io_bank.c" 3 4
      ->itv) - 1 )) 
# 409 "project/radare2/libr/io/io_bank.c"
...
# 409 "project/radare2/libr/io/io_bank.c"
   ...
   if (
# 419 "project/radare2/libr/io/io_bank.c" 3 4
      (r_itv_begin (
# 419 "project/radare2/libr/io/io_bank.c"
      sm
# 419 "project/radare2/libr/io/io_bank.c" 3 4
      ->itv)) 
# 419 "project/radare2/libr/io/io_bank.c"
...
# 419 "project/radare2/libr/io/io_bank.c"
    ...
    r_io_submap_set_from (bd, 
# 421 "project/radare2/libr/io/io_bank.c" 3 4
                             (r_itv_begin (
# 421 "project/radare2/libr/io/io_bank.c"
                             sm
# 421 "project/radare2/libr/io/io_bank.c" 3 4
                             ->itv))
# 421 "project/radare2/libr/io/io_bank.c"
                                                  );
    r_crbtree_insert (bank->submaps, bd, _find_sm_by_from_vaddr_cb, 
# 422 "project/radare2/libr/io/io_bank.c" 3 4
                                                                   ((void *)0)
# 422 "project/radare2/libr/io/io_bank.c"
                                                                       );
    if (
# 423 "project/radare2/libr/io/io_bank.c" 3 4
       (( r_itv_end (
# 423 "project/radare2/libr/io/io_bank.c"
       sm
# 423 "project/radare2/libr/io/io_bank.c" 3 4
       ->itv) - 1 )) 
# 423 "project/radare2/libr/io/io_bank.c"
...
# 423 "project/radare2/libr/io/io_bank.c"
     ...
     r_io_submap_set_to (bd, 
# 425 "project/radare2/libr/io/io_bank.c" 3 4
                            (( r_itv_end (
# 425 "project/radare2/libr/io/io_bank.c"
                            sm
# 425 "project/radare2/libr/io/io_bank.c" 3 4
                            ->itv) - 1 ))
# 425 "project/radare2/libr/io/io_bank.c"
    ...
    r_io_submap_set_from (sm, 
# 429 "project/radare2/libr/io/io_bank.c" 3 4
                             (( r_itv_end (
# 429 "project/radare2/libr/io/io_bank.c"
                             bd
# 429 "project/radare2/libr/io/io_bank.c" 3 4
                             ->itv) - 1 )) 
# 429 "project/radare2/libr/io/io_bank.c"
   ...
   if (
# 432 "project/radare2/libr/io/io_bank.c" 3 4
      (( r_itv_end (
# 432 "project/radare2/libr/io/io_bank.c"
      sm
# 432 "project/radare2/libr/io/io_bank.c" 3 4
      ->itv) - 1 )) 
# 432 "project/radare2/libr/io/io_bank.c"
...
# 432 "project/radare2/libr/io/io_bank.c"
    ...
    r_io_submap_set_to (bd, 
# 435 "project/radare2/libr/io/io_bank.c" 3 4
                           (( r_itv_end (
# 435 "project/radare2/libr/io/io_bank.c"
                           sm
# 435 "project/radare2/libr/io/io_bank.c" 3 4
                           ->itv) - 1 ))
# 435 "project/radare2/libr/io/io_bank.c"
    ...
    r_io_submap_set_to (sm, 
# 437 "project/radare2/libr/io/io_bank.c" 3 4
                           (r_itv_begin (
# 437 "project/radare2/libr/io/io_bank.c"
                           bd
# 437 "project/radare2/libr/io/io_bank.c" 3 4
                           ->itv)) 
# 437 "project/radare2/libr/io/io_bank.c"
                                                 - 1);
    r_crbtree_insert (bank->submaps, bd, _find_sm_by_from_vaddr_cb, 
# 438 "project/radare2/libr/io/io_bank.c" 3 4
                                                                   ((void *)0)
# 438 "project/radare2/libr/io/io_bank.c"
                                                                       );
    continue;
   }

   RIOSubMap *bdsm = 
# 442 "project/radare2/libr/io/io_bank.c" 3 4
                    (
# 442 "project/radare2/libr/io/io_bank.c"
                    RIOSubMap
# 442 "project/radare2/libr/io/io_bank.c" 3 4
                    *)r_new_copy(sizeof(
# 442 "project/radare2/libr/io/io_bank.c"
...
# 442 "project/radare2/libr/io/io_bank.c"
                                             ;
   r_io_submap_set_to (sm, 
# 443 "project/radare2/libr/io/io_bank.c" 3 4
                          (r_itv_begin (
# 443 "project/radare2/libr/io/io_bank.c"
                          bd
# 443 "project/radare2/libr/io/io_bank.c" 3 4
                          ->itv)) 
# 443 "project/radare2/libr/io/io_bank.c"
                                                - 1);
   r_io_submap_set_from (bdsm, 
# 444 "project/radare2/libr/io/io_bank.c" 3 4
                              (( r_itv_end (
# 444 "project/radare2/libr/io/io_bank.c"
                              bd
# 444 "project/radare2/libr/io/io_bank.c" 3 4
                              ->itv) - 1 )) 
# 444 "project/radare2/libr/io/io_bank.c"
                                                  + 1);
   r_crbtree_insert (bank->submaps, bd, _find_sm_by_from_vaddr_cb, 
# 445 "project/radare2/libr/io/io_bank.c" 3 4
                                                                  ((void *)0)
# 445 "project/radare2/libr/io/io_bank.c"
                                                                      );
...
# 452 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 452 "project/radare2/libr/io/io_bank.c"
          r_io_bank_map_depriorize(RIO *io, const 
# 452 "project/radare2/libr/io/io_bank.c" 3 4
                                                  unsigned int 
# 452 "project/radare2/libr/io/io_bank.c"
                                                       bankid, const 
...
# 455 "project/radare2/libr/io/io_bank.c" 3 4
do { if (!(
# 455 "project/radare2/libr/io/io_bank.c"
bank && map
# 455 "project/radare2/libr/io/io_bank.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 455 "project/radare2/libr/io/io_bank.c"
...
# 455 "project/radare2/libr/io/io_bank.c"
 ...
 RListIter *iter;
 RIOMapRef *mapref = 
# 457 "project/radare2/libr/io/io_bank.c" 3 4
                    ((void *)0)
# 457 "project/radare2/libr/io/io_bank.c"
                        ;
 
# 458 "project/radare2/libr/io/io_bank.c" 3 4
if (
# 458 "project/radare2/libr/io/io_bank.c"
bank->maprefs
# 458 "project/radare2/libr/io/io_bank.c" 3 4
) for (
# 458 "project/radare2/libr/io/io_bank.c"
...
# 458 "project/radare2/libr/io/io_bank.c"
 ...
 return 
# 464 "project/radare2/libr/io/io_bank.c" 3 4
       0
# 464 "project/radare2/libr/io/io_bank.c"
            ;
found:
 if (iter == bank->maprefs->head) {

  return 
# 468 "project/radare2/libr/io/io_bank.c" 3 4
        1
# 468 "project/radare2/libr/io/io_bank.c"
            ;
 }
 bank->last_used = 
# 470 "project/radare2/libr/io/io_bank.c" 3 4
                  ((void *)0)
# 470 "project/radare2/libr/io/io_bank.c"
                      ;
...
# 488 "project/radare2/libr/io/io_bank.c" 3 4
if (
# 488 "project/radare2/libr/io/io_bank.c"
bank->maprefs
# 488 "project/radare2/libr/io/io_bank.c" 3 4
) for (
# 488 "project/radare2/libr/io/io_bank.c"
...
# 499 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 499 "project/radare2/libr/io/io_bank.c"
          r_io_bank_update_map_boundaries(RIO *io, const 
# 499 "project/radare2/libr/io/io_bank.c" 3 4
                                                         unsigned int 
# 499 "project/radare2/libr/io/io_bank.c"
                                                              bankid, const 
...
# 501 "project/radare2/libr/io/io_bank.c" 3 4
do { if (!(
# 501 "project/radare2/libr/io/io_bank.c"
io && bank
# 501 "project/radare2/libr/io/io_bank.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 501 "project/radare2/libr/io/io_bank.c"
"io && bank"
# 501 "project/radare2/libr/io/io_bank.c" 3 4
, 501); return (0); } } while (0)
# 501 "project/radare2/libr/io/io_bank.c"
                                        ;
 RListIter *iter;
 RIOMapRef *mapref;
 
# 504 "project/radare2/libr/io/io_bank.c" 3 4
if (
# 504 "project/radare2/libr/io/io_bank.c"
bank->maprefs
# 504 "project/radare2/libr/io/io_bank.c" 3 4
) for (
# 504 "project/radare2/libr/io/io_bank.c"
...
# 504 "project/radare2/libr/io/io_bank.c"
 ...
 return 
# 510 "project/radare2/libr/io/io_bank.c" 3 4
       0
# 510 "project/radare2/libr/io/io_bank.c"
            ;
found:
 ...
 if (!map) {
  ...
  return 
# 516 "project/radare2/libr/io/io_bank.c" 3 4
        0
# 516 "project/radare2/libr/io/io_bank.c"
             ;
 }
 if (
# 518 "project/radare2/libr/io/io_bank.c" 3 4
    r_itv_begin (
# 518 "project/radare2/libr/io/io_bank.c"
    map
# 518 "project/radare2/libr/io/io_bank.c" 3 4
    ->itv) 
# 518 "project/radare2/libr/io/io_bank.c"
...
# 518 "project/radare2/libr/io/io_bank.c"
  ...
  return 
# 520 "project/radare2/libr/io/io_bank.c" 3 4
        1
# 520 "project/radare2/libr/io/io_bank.c"
            ;
 }
 ...
 if (!sm) {
  return 
# 526 "project/radare2/libr/io/io_bank.c" 3 4
        0
# 526 "project/radare2/libr/io/io_bank.c"
             ;
 }

 bank->last_used = 
# 529 "project/radare2/libr/io/io_bank.c" 3 4
                  ((void *)0)
# 529 "project/radare2/libr/io/io_bank.c"
                      ;
...
# 534 "project/radare2/libr/io/io_bank.c" 3 4
__builtin___memcpy_chk (
# 534 "project/radare2/libr/io/io_bank.c"
&fake_map
# 534 "project/radare2/libr/io/io_bank.c" 3 4
, 
# 534 "project/radare2/libr/io/io_bank.c"
...
# 534 "project/radare2/libr/io/io_bank.c"
 ...
 if (!entry) {
  ...
  r_crbtree_insert (bank->submaps, sm, _find_sm_by_from_vaddr_cb, 
# 542 "project/radare2/libr/io/io_bank.c" 3 4
                                                                 ((void *)0)
# 542 "project/radare2/libr/io/io_bank.c"
                                                                     );


  return 
# 545 "project/radare2/libr/io/io_bank.c" 3 4
        1
# 545 "project/radare2/libr/io/io_bank.c"
            ;
 }
 ...
 if (_mapref_priority_cmp (bank, &sm->mapref, &bd->mapref) == 1) {
  ...
  if (
# 552 "project/radare2/libr/io/io_bank.c" 3 4
     (( r_itv_end (
# 552 "project/radare2/libr/io/io_bank.c"
     bd
# 552 "project/radare2/libr/io/io_bank.c" 3 4
     ->itv) - 1 )) 
# 552 "project/radare2/libr/io/io_bank.c"
...
# 552 "project/radare2/libr/io/io_bank.c"
   ...
   if (
# 553 "project/radare2/libr/io/io_bank.c" 3 4
      (r_itv_begin (
# 553 "project/radare2/libr/io/io_bank.c"
      bd
# 553 "project/radare2/libr/io/io_bank.c" 3 4
      ->itv)) 
# 553 "project/radare2/libr/io/io_bank.c"
...
# 559 "project/radare2/libr/io/io_bank.c" 3 4
   __builtin___memcpy_chk (
# 559 "project/radare2/libr/io/io_bank.c"
   bd
# 559 "project/radare2/libr/io/io_bank.c" 3 4
   , 
# 559 "project/radare2/libr/io/io_bank.c"
...
# 559 "project/radare2/libr/io/io_bank.c"
    ...
    r_io_submap_set_to (bd, 
# 562 "project/radare2/libr/io/io_bank.c" 3 4
                           (r_itv_begin (
# 562 "project/radare2/libr/io/io_bank.c"
                           sm
# 562 "project/radare2/libr/io/io_bank.c" 3 4
                           ->itv)) 
# 562 "project/radare2/libr/io/io_bank.c"
                                                 - 1);
    r_crbtree_insert (bank->submaps, sm, _find_sm_by_from_vaddr_cb, 
# 563 "project/radare2/libr/io/io_bank.c" 3 4
                                                                   ((void *)0)
# 563 "project/radare2/libr/io/io_bank.c"
                                                                       );
   }
   return 
# 565 "project/radare2/libr/io/io_bank.c" 3 4
         1
# 565 "project/radare2/libr/io/io_bank.c"
             ;
  }
  if (
# 567 "project/radare2/libr/io/io_bank.c" 3 4
     (r_itv_begin (
# 567 "project/radare2/libr/io/io_bank.c"
     bd
# 567 "project/radare2/libr/io/io_bank.c" 3 4
     ->itv)) 
# 567 "project/radare2/libr/io/io_bank.c"
...
# 568 "project/radare2/libr/io/io_bank.c" 3 4
  (( r_itv_end (
# 568 "project/radare2/libr/io/io_bank.c"
  sm
# 568 "project/radare2/libr/io/io_bank.c" 3 4
  ->itv) - 1 )) 
# 568 "project/radare2/libr/io/io_bank.c"
...
# 568 "project/radare2/libr/io/io_bank.c"
   ...
   RIOSubMap *bdsm = 
# 569 "project/radare2/libr/io/io_bank.c" 3 4
                    (
# 569 "project/radare2/libr/io/io_bank.c"
                    RIOSubMap
# 569 "project/radare2/libr/io/io_bank.c" 3 4
                    *)r_new_copy(sizeof(
# 569 "project/radare2/libr/io/io_bank.c"
...
# 569 "project/radare2/libr/io/io_bank.c"
   ...
   r_io_submap_set_from (bdsm, 
# 571 "project/radare2/libr/io/io_bank.c" 3 4
                              (( r_itv_end (
# 571 "project/radare2/libr/io/io_bank.c"
                              sm
# 571 "project/radare2/libr/io/io_bank.c" 3 4
                              ->itv) - 1 )) 
# 571 "project/radare2/libr/io/io_bank.c"
                                                  + 1);
   r_io_submap_set_to (bd, 
# 572 "project/radare2/libr/io/io_bank.c" 3 4
                          (r_itv_begin (
# 572 "project/radare2/libr/io/io_bank.c"
                          sm
# 572 "project/radare2/libr/io/io_bank.c" 3 4
                          ->itv)) 
# 572 "project/radare2/libr/io/io_bank.c"
   ...
   r_crbtree_insert (bank->submaps, sm, _find_sm_by_from_vaddr_cb, 
# 574 "project/radare2/libr/io/io_bank.c" 3 4
                                                                  ((void *)0)
# 574 "project/radare2/libr/io/io_bank.c"
                                                                      );
   r_crbtree_insert (bank->submaps, bdsm, _find_sm_by_from_vaddr_cb, 
# 575 "project/radare2/libr/io/io_bank.c" 3 4
                                                                    ((void *)0)
# 575 "project/radare2/libr/io/io_bank.c"
                                                                        );
   return 
# 576 "project/radare2/libr/io/io_bank.c" 3 4
         1
# 576 "project/radare2/libr/io/io_bank.c"
             ;
  }
  if (
# 578 "project/radare2/libr/io/io_bank.c" 3 4
     (r_itv_begin (
# 578 "project/radare2/libr/io/io_bank.c"
     bd
# 578 "project/radare2/libr/io/io_bank.c" 3 4
     ->itv)) 
# 578 "project/radare2/libr/io/io_bank.c"
...
# 578 "project/radare2/libr/io/io_bank.c"
   ...
   r_io_submap_set_to (bd, 
# 579 "project/radare2/libr/io/io_bank.c" 3 4
                          (r_itv_begin (
# 579 "project/radare2/libr/io/io_bank.c"
                          sm
# 579 "project/radare2/libr/io/io_bank.c" 3 4
                          ->itv)) 
# 579 "project/radare2/libr/io/io_bank.c"
  ...
  if (
# 587 "project/radare2/libr/io/io_bank.c" 3 4
     (r_itv_begin (
# 587 "project/radare2/libr/io/io_bank.c"
     bd
# 587 "project/radare2/libr/io/io_bank.c" 3 4
     ->itv)) 
# 587 "project/radare2/libr/io/io_bank.c"
...
# 587 "project/radare2/libr/io/io_bank.c"
   ...
   if (
# 588 "project/radare2/libr/io/io_bank.c" 3 4
      (( r_itv_end (
# 588 "project/radare2/libr/io/io_bank.c"
      sm
# 588 "project/radare2/libr/io/io_bank.c" 3 4
      ->itv) - 1 )) 
# 588 "project/radare2/libr/io/io_bank.c"
...
# 588 "project/radare2/libr/io/io_bank.c"
    ...
    free (sm);
    return 
# 591 "project/radare2/libr/io/io_bank.c" 3 4
          1
# 591 "project/radare2/libr/io/io_bank.c"
              ;
   }
   ...
   if (
# 596 "project/radare2/libr/io/io_bank.c" 3 4
      (( r_itv_end (
# 596 "project/radare2/libr/io/io_bank.c"
      sm
# 596 "project/radare2/libr/io/io_bank.c" 3 4
      ->itv) - 1 )) 
# 596 "project/radare2/libr/io/io_bank.c"
...
# 596 "project/radare2/libr/io/io_bank.c"
    ...
    r_io_submap_set_to (sm, 
# 597 "project/radare2/libr/io/io_bank.c" 3 4
                           (r_itv_begin (
# 597 "project/radare2/libr/io/io_bank.c"
                           bd
# 597 "project/radare2/libr/io/io_bank.c" 3 4
                           ->itv)) 
# 597 "project/radare2/libr/io/io_bank.c"
                                                 - 1);
    if (!r_crbtree_insert (bank->submaps, sm, _find_sm_by_from_vaddr_cb, 
# 598 "project/radare2/libr/io/io_bank.c" 3 4
                                                                        ((void *)0)
# 598 "project/radare2/libr/io/io_bank.c"
                                                                            )) {
     free (sm);
     return 
# 600 "project/radare2/libr/io/io_bank.c" 3 4
           0
# 600 "project/radare2/libr/io/io_bank.c"
                ;
    }
    return 
# 602 "project/radare2/libr/io/io_bank.c" 3 4
          1
# 602 "project/radare2/libr/io/io_bank.c"
              ;
   }
   RIOSubMap *bdsm = 
# 604 "project/radare2/libr/io/io_bank.c" 3 4
                    (
# 604 "project/radare2/libr/io/io_bank.c"
                    RIOSubMap
# 604 "project/radare2/libr/io/io_bank.c" 3 4
                    *)r_new_copy(sizeof(
# 604 "project/radare2/libr/io/io_bank.c"
...
# 604 "project/radare2/libr/io/io_bank.c"
   ...
   if (!bdsm) {
    free (sm);
    return 
# 607 "project/radare2/libr/io/io_bank.c" 3 4
          0
# 607 "project/radare2/libr/io/io_bank.c"
               ;
   }
   r_io_submap_set_to (bdsm, 
# 609 "project/radare2/libr/io/io_bank.c" 3 4
                            (r_itv_begin (
# 609 "project/radare2/libr/io/io_bank.c"
                            bd
# 609 "project/radare2/libr/io/io_bank.c" 3 4
                            ->itv)) 
# 609 "project/radare2/libr/io/io_bank.c"
   ...
   if (!r_crbtree_insert (bank->submaps, bdsm, _find_sm_by_from_vaddr_cb, 
# 611 "project/radare2/libr/io/io_bank.c" 3 4
                                                                         ((void *)0)
# 611 "project/radare2/libr/io/io_bank.c"
                                                                             )) {
    free (bdsm);
    free (sm);
    return 
# 614 "project/radare2/libr/io/io_bank.c" 3 4
          0
# 614 "project/radare2/libr/io/io_bank.c"
               ;
   }
  ...
  r_io_submap_set_from (sm, 
# 619 "project/radare2/libr/io/io_bank.c" 3 4
                           (( r_itv_end (
# 619 "project/radare2/libr/io/io_bank.c"
                           bd
# 619 "project/radare2/libr/io/io_bank.c" 3 4
                           ->itv) - 1 )) 
# 619 "project/radare2/libr/io/io_bank.c"
 ...
 while (entry && 
# 624 "project/radare2/libr/io/io_bank.c" 3 4
                (( r_itv_end (
# 624 "project/radare2/libr/io/io_bank.c"
                ((RIOSubMap *)entry->data)
# 624 "project/radare2/libr/io/io_bank.c" 3 4
                ->itv) - 1 )) 
# 624 "project/radare2/libr/io/io_bank.c"
...
# 624 "project/radare2/libr/io/io_bank.c"
  ...
  if (_mapref_priority_cmp (bank, &sm->mapref, &bd->mapref) == 1) {
   ...
   r_crbtree_delete (bank->submaps, bd, _find_sm_by_from_vaddr_cb, 
# 631 "project/radare2/libr/io/io_bank.c" 3 4
                                                                  ((void *)0)
# 631 "project/radare2/libr/io/io_bank.c"
                                                                      );
  } else {
   ...
   if (
# 637 "project/radare2/libr/io/io_bank.c" 3 4
      (r_itv_begin (
# 637 "project/radare2/libr/io/io_bank.c"
      bd
# 637 "project/radare2/libr/io/io_bank.c" 3 4
      ->itv)) 
# 637 "project/radare2/libr/io/io_bank.c"
...
# 637 "project/radare2/libr/io/io_bank.c"
    ...
    RIOSubMap *bdsm = 
# 638 "project/radare2/libr/io/io_bank.c" 3 4
                     (
# 638 "project/radare2/libr/io/io_bank.c"
                     RIOSubMap
# 638 "project/radare2/libr/io/io_bank.c" 3 4
                     *)r_new_copy(sizeof(
# 638 "project/radare2/libr/io/io_bank.c"
...
# 638 "project/radare2/libr/io/io_bank.c"
                                              ;
    r_io_submap_set_to (bdsm, 
# 639 "project/radare2/libr/io/io_bank.c" 3 4
                             (r_itv_begin (
# 639 "project/radare2/libr/io/io_bank.c"
                             bd
# 639 "project/radare2/libr/io/io_bank.c" 3 4
                             ->itv)) 
# 639 "project/radare2/libr/io/io_bank.c"
                                                   - 1);
    r_crbtree_insert (bank->submaps, bdsm, _find_sm_by_from_vaddr_cb, 
# 640 "project/radare2/libr/io/io_bank.c" 3 4
                                                                     ((void *)0)
# 640 "project/radare2/libr/io/io_bank.c"
                                                                         );
   }
   if (
# 642 "project/radare2/libr/io/io_bank.c" 3 4
      (( r_itv_end (
# 642 "project/radare2/libr/io/io_bank.c"
      bd
# 642 "project/radare2/libr/io/io_bank.c" 3 4
      ->itv) - 1 )) 
# 642 "project/radare2/libr/io/io_bank.c"
...
# 642 "project/radare2/libr/io/io_bank.c"
    ...
    free (sm);
    return 
# 646 "project/radare2/libr/io/io_bank.c" 3 4
          1
# 646 "project/radare2/libr/io/io_bank.c"
              ;
   }
   r_io_submap_set_from (sm, 
# 648 "project/radare2/libr/io/io_bank.c" 3 4
                            (( r_itv_end (
# 648 "project/radare2/libr/io/io_bank.c"
                            bd
# 648 "project/radare2/libr/io/io_bank.c" 3 4
                            ->itv) - 1 )) 
# 648 "project/radare2/libr/io/io_bank.c"
 ...
 if (!entry) {
  return r_crbtree_insert (bank->submaps, sm, _find_sm_by_from_vaddr_cb, 
# 652 "project/radare2/libr/io/io_bank.c" 3 4
                                                                        ((void *)0)
# 652 "project/radare2/libr/io/io_bank.c"
                                                                            );
 }
 bd = (RIOSubMap *)entry->data;
 if (_mapref_priority_cmp (bank, &sm->mapref, &bd->mapref) == 1) {
  if (
# 656 "project/radare2/libr/io/io_bank.c" 3 4
     (r_itv_begin (
# 656 "project/radare2/libr/io/io_bank.c"
     bd
# 656 "project/radare2/libr/io/io_bank.c" 3 4
     ->itv)) 
# 656 "project/radare2/libr/io/io_bank.c"
...
# 656 "project/radare2/libr/io/io_bank.c"
   ...
   r_io_submap_set_from (bd, 
# 657 "project/radare2/libr/io/io_bank.c" 3 4
                            (( r_itv_end (
# 657 "project/radare2/libr/io/io_bank.c"
                            sm
# 657 "project/radare2/libr/io/io_bank.c" 3 4
                            ->itv) - 1 )) 
# 657 "project/radare2/libr/io/io_bank.c"
  ...
  r_crbtree_insert (bank->submaps, sm, _find_sm_by_from_vaddr_cb, 
# 659 "project/radare2/libr/io/io_bank.c" 3 4
                                                                 ((void *)0)
# 659 "project/radare2/libr/io/io_bank.c"
                                                                     );
 } else {
  if (
# 661 "project/radare2/libr/io/io_bank.c" 3 4
     (r_itv_begin (
# 661 "project/radare2/libr/io/io_bank.c"
     sm
# 661 "project/radare2/libr/io/io_bank.c" 3 4
     ->itv)) 
# 661 "project/radare2/libr/io/io_bank.c"
...
# 661 "project/radare2/libr/io/io_bank.c"
   ...
   if (
# 662 "project/radare2/libr/io/io_bank.c" 3 4
      (r_itv_begin (
# 662 "project/radare2/libr/io/io_bank.c"
      bd
# 662 "project/radare2/libr/io/io_bank.c" 3 4
      ->itv)) 
# 662 "project/radare2/libr/io/io_bank.c"
...
# 662 "project/radare2/libr/io/io_bank.c"
    ...
    r_io_submap_set_to (sm, 
# 663 "project/radare2/libr/io/io_bank.c" 3 4
                           (r_itv_begin (
# 663 "project/radare2/libr/io/io_bank.c"
                           bd
# 663 "project/radare2/libr/io/io_bank.c" 3 4
                           ->itv)) 
# 663 "project/radare2/libr/io/io_bank.c"
   ...
   r_crbtree_insert (bank->submaps, sm, _find_sm_by_from_vaddr_cb, 
# 665 "project/radare2/libr/io/io_bank.c" 3 4
                                                                  ((void *)0)
# 665 "project/radare2/libr/io/io_bank.c"
                                                                      );
  } else {
 ...
 return 
# 671 "project/radare2/libr/io/io_bank.c" 3 4
       1
# 671 "project/radare2/libr/io/io_bank.c"
           ;
}



# 675 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 675 "project/radare2/libr/io/io_bank.c"
          r_io_bank_locate(RIO *io, const 
# 675 "project/radare2/libr/io/io_bank.c" 3 4
                                          unsigned int 
# 675 "project/radare2/libr/io/io_bank.c"
                                               bankid, 
...
# 677 "project/radare2/libr/io/io_bank.c" 3 4
do { if (!(
# 677 "project/radare2/libr/io/io_bank.c"
io && bank && bank->submaps && addr && size
# 677 "project/radare2/libr/io/io_bank.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 677 "project/radare2/libr/io/io_bank.c"
"io && bank && bank->submaps && addr && size"
...
# 682 "project/radare2/libr/io/io_bank.c" 3 4
__builtin___memset_chk (
# 682 "project/radare2/libr/io/io_bank.c"
&fake_sm
# 682 "project/radare2/libr/io/io_bank.c" 3 4
, 
# 682 "project/radare2/libr/io/io_bank.c"
0x00, sizeof(RIOSubMap)
# 682 "project/radare2/libr/io/io_bank.c" 3 4
, __builtin_object_size (
# 682 "project/radare2/libr/io/io_bank.c"
&fake_sm
...
# 682 "project/radare2/libr/io/io_bank.c"
  ...
  *addr = fake_sm.itv.addr;
  return 
# 689 "project/radare2/libr/io/io_bank.c" 3 4
        1
# 689 "project/radare2/libr/io/io_bank.c"
            ;
 }
...
# 694 "project/radare2/libr/io/io_bank.c" 3 4
unsigned long long 
# 694 "project/radare2/libr/io/io_bank.c"
     next_location = fake_sm.itv.addr;
 while (entry) {
  RIOSubMap *sm = (RIOSubMap *)entry->data;
  if (size <= 
# 697 "project/radare2/libr/io/io_bank.c" 3 4
             (r_itv_begin (
# 697 "project/radare2/libr/io/io_bank.c"
             sm
# 697 "project/radare2/libr/io/io_bank.c" 3 4
             ->itv)) 
# 697 "project/radare2/libr/io/io_bank.c"
   ...
   *addr = next_location;
   return 
# 699 "project/radare2/libr/io/io_bank.c" 3 4
         1
# 699 "project/radare2/libr/io/io_bank.c"
             ;
  }
  next_location = (
# 701 "project/radare2/libr/io/io_bank.c" 3 4
                  (( r_itv_end (
# 701 "project/radare2/libr/io/io_bank.c"
                  sm
# 701 "project/radare2/libr/io/io_bank.c" 3 4
                  ->itv) - 1 )) 
# 701 "project/radare2/libr/io/io_bank.c"
                                      + 1) +
   (load_align - ((
# 702 "project/radare2/libr/io/io_bank.c" 3 4
                  (( r_itv_end (
# 702 "project/radare2/libr/io/io_bank.c"
                  sm
# 702 "project/radare2/libr/io/io_bank.c" 3 4
                  ->itv) - 1 )) 
# 702 "project/radare2/libr/io/io_bank.c"
                                      + 1) % load_align)) % load_align;
  entry = r_rbnode_next (entry);
 }
 if (next_location == 0LL) {

  return 
# 707 "project/radare2/libr/io/io_bank.c" 3 4
        0
# 707 "project/radare2/libr/io/io_bank.c"
             ;
 }
 if (
# 709 "project/radare2/libr/io/io_bank.c" 3 4
    0xFFFFFFFFFFFFFFFFULL 
# 709 "project/radare2/libr/io/io_bank.c"
             - size + 1 < next_location) {
  return 
# 710 "project/radare2/libr/io/io_bank.c" 3 4
        0
# 710 "project/radare2/libr/io/io_bank.c"
             ;
 }
 *addr = next_location;
 return 
# 713 "project/radare2/libr/io/io_bank.c" 3 4
       1
# 713 "project/radare2/libr/io/io_bank.c"
           ;
}


# 716 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 716 "project/radare2/libr/io/io_bank.c"
          r_io_bank_read_at(RIO *io, const 
# 716 "project/radare2/libr/io/io_bank.c" 3 4
                                           unsigned int 
# 716 "project/radare2/libr/io/io_bank.c"
                                                bankid, 
...
# 718 "project/radare2/libr/io/io_bank.c" 3 4
do { if (!(
# 718 "project/radare2/libr/io/io_bank.c"
io && bank
# 718 "project/radare2/libr/io/io_bank.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 718 "project/radare2/libr/io/io_bank.c"
...
# 720 "project/radare2/libr/io/io_bank.c" 3 4
__builtin___memset_chk (
# 720 "project/radare2/libr/io/io_bank.c"
&fake_sm
# 720 "project/radare2/libr/io/io_bank.c" 3 4
, 
# 720 "project/radare2/libr/io/io_bank.c"
...
# 720 "project/radare2/libr/io/io_bank.c"
 ...
 RRBNode *node;
 if (bank->last_used && 
# 724 "project/radare2/libr/io/io_bank.c" 3 4
                       r_itv_contain (
# 724 "project/radare2/libr/io/io_bank.c"
                       ((RIOSubMap *)bank->last_used->data)
# 724 "project/radare2/libr/io/io_bank.c" 3 4
                       ->itv, 
# 724 "project/radare2/libr/io/io_bank.c"
                       addr
...
# 729 "project/radare2/libr/io/io_bank.c" 3 4
__builtin___memset_chk (
# 729 "project/radare2/libr/io/io_bank.c"
buf
# 729 "project/radare2/libr/io/io_bank.c" 3 4
, 
# 729 "project/radare2/libr/io/io_bank.c"
...
# 729 "project/radare2/libr/io/io_bank.c"
                           ;
 RIOSubMap *sm = node ? (RIOSubMap *)node->data : 
# 730 "project/radare2/libr/io/io_bank.c" 3 4
                                                 ((void *)0)
# 730 "project/radare2/libr/io/io_bank.c"
                                                     ;
 
# 731 "project/radare2/libr/io/io_bank.c" 3 4
_Bool 
# 731 "project/radare2/libr/io/io_bank.c"
     ret = 
# 731 "project/radare2/libr/io/io_bank.c" 3 4
           1
# 731 "project/radare2/libr/io/io_bank.c"
               ;
 while (sm && 
# 732 "project/radare2/libr/io/io_bank.c" 3 4
             r_itv_overlap(
# 732 "project/radare2/libr/io/io_bank.c"
             (&fake_sm)
# 732 "project/radare2/libr/io/io_bank.c" 3 4
             ->itv, 
# 732 "project/radare2/libr/io/io_bank.c"
...
# 732 "project/radare2/libr/io/io_bank.c"
  ...
  if (!map) {
   ...
   return 
# 737 "project/radare2/libr/io/io_bank.c" 3 4
         0
# 737 "project/radare2/libr/io/io_bank.c"
              ;
  }
  if (!(map->perm & 
# 739 "project/radare2/libr/io/io_bank.c" 3 4
                   4
# 739 "project/radare2/libr/io/io_bank.c"
                           )) {
   node = r_rbnode_next (node);
   sm = node ? (RIOSubMap *)node->data : 
# 741 "project/radare2/libr/io/io_bank.c" 3 4
                                        ((void *)0)
# 741 "project/radare2/libr/io/io_bank.c"
                                            ;
   continue;
  }
  const 
# 744 "project/radare2/libr/io/io_bank.c" 3 4
       unsigned long long 
# 744 "project/radare2/libr/io/io_bank.c"
            buf_off = 
# 744 "project/radare2/libr/io/io_bank.c" 3 4
                      (((
# 744 "project/radare2/libr/io/io_bank.c"
...
# 744 "project/radare2/libr/io/io_bank.c"
                                                          - addr;
  const int read_len = 
# 745 "project/radare2/libr/io/io_bank.c" 3 4
                      ((((( r_itv_end (
# 745 "project/radare2/libr/io/io_bank.c"
                      (&fake_sm)
# 745 "project/radare2/libr/io/io_bank.c" 3 4
                      ->itv) - 1 )))>((( r_itv_end (
# 745 "project/radare2/libr/io/io_bank.c"
...
# 746 "project/radare2/libr/io/io_bank.c"
                              - (addr + buf_off) + 1;
  const 
# 747 "project/radare2/libr/io/io_bank.c" 3 4
       unsigned long long 
# 747 "project/radare2/libr/io/io_bank.c"
            paddr = addr + buf_off - 
# 747 "project/radare2/libr/io/io_bank.c" 3 4
                                     r_itv_begin (
# 747 "project/radare2/libr/io/io_bank.c"
...
# 747 "project/radare2/libr/io/io_bank.c"
  ...
  node = r_rbnode_next (node);
  sm = node ? (RIOSubMap *)node->data : 
# 751 "project/radare2/libr/io/io_bank.c" 3 4
                                       ((void *)0)
# 751 "project/radare2/libr/io/io_bank.c"
                                           ;
 }
 return ret;
}
...
# 756 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 756 "project/radare2/libr/io/io_bank.c"
          r_io_bank_write_at(RIO *io, const 
# 756 "project/radare2/libr/io/io_bank.c" 3 4
                                            unsigned int 
# 756 "project/radare2/libr/io/io_bank.c"
                                                 bankid, 
...
# 758 "project/radare2/libr/io/io_bank.c" 3 4
do { if (!(
# 758 "project/radare2/libr/io/io_bank.c"
io && bank
# 758 "project/radare2/libr/io/io_bank.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 758 "project/radare2/libr/io/io_bank.c"
"io && bank"
# 758 "project/radare2/libr/io/io_bank.c" 3 4
, 758); return (0); } } while (0)
# 758 "project/radare2/libr/io/io_bank.c"
                                        ;
 RIOSubMap fake_sm;
 
# 760 "project/radare2/libr/io/io_bank.c" 3 4
__builtin___memset_chk (
# 760 "project/radare2/libr/io/io_bank.c"
&fake_sm
# 760 "project/radare2/libr/io/io_bank.c" 3 4
, 
# 760 "project/radare2/libr/io/io_bank.c"
...
# 760 "project/radare2/libr/io/io_bank.c"
 ...
 RRBNode *node;
 if (bank->last_used && 
# 764 "project/radare2/libr/io/io_bank.c" 3 4
                       r_itv_contain (
# 764 "project/radare2/libr/io/io_bank.c"
                       ((RIOSubMap *)bank->last_used->data)
# 764 "project/radare2/libr/io/io_bank.c" 3 4
                       ->itv, 
# 764 "project/radare2/libr/io/io_bank.c"
...
# 764 "project/radare2/libr/io/io_bank.c"
 ...
 RIOSubMap *sm = node ? (RIOSubMap *)node->data : 
# 769 "project/radare2/libr/io/io_bank.c" 3 4
                                                 ((void *)0)
# 769 "project/radare2/libr/io/io_bank.c"
                                                     ;
 
# 770 "project/radare2/libr/io/io_bank.c" 3 4
_Bool 
# 770 "project/radare2/libr/io/io_bank.c"
     ret = 
# 770 "project/radare2/libr/io/io_bank.c" 3 4
           1
# 770 "project/radare2/libr/io/io_bank.c"
               ;
 while (sm && 
# 771 "project/radare2/libr/io/io_bank.c" 3 4
             r_itv_overlap(
# 771 "project/radare2/libr/io/io_bank.c"
             (&fake_sm)
# 771 "project/radare2/libr/io/io_bank.c" 3 4
             ->itv, 
# 771 "project/radare2/libr/io/io_bank.c"
...
# 771 "project/radare2/libr/io/io_bank.c"
  ...
  if (!map) {
   ...
   return 
# 776 "project/radare2/libr/io/io_bank.c" 3 4
         0
# 776 "project/radare2/libr/io/io_bank.c"
              ;
  }
  if (!(map->perm & 
# 778 "project/radare2/libr/io/io_bank.c" 3 4
                   2
# 778 "project/radare2/libr/io/io_bank.c"
                           )) {
   node = r_rbnode_next (node);
   sm = node ? (RIOSubMap *)node->data : 
# 780 "project/radare2/libr/io/io_bank.c" 3 4
                                        ((void *)0)
# 780 "project/radare2/libr/io/io_bank.c"
                                            ;
   ret = 
# 781 "project/radare2/libr/io/io_bank.c" 3 4
        0
# 781 "project/radare2/libr/io/io_bank.c"
             ;
   continue;
  }
  const 
# 784 "project/radare2/libr/io/io_bank.c" 3 4
       unsigned long long 
# 784 "project/radare2/libr/io/io_bank.c"
            buf_off = 
# 784 "project/radare2/libr/io/io_bank.c" 3 4
                      (((
# 784 "project/radare2/libr/io/io_bank.c"
...
# 784 "project/radare2/libr/io/io_bank.c"
                                                          - addr;
  const int write_len = 
# 785 "project/radare2/libr/io/io_bank.c" 3 4
                       ((((( r_itv_end (
# 785 "project/radare2/libr/io/io_bank.c"
                       (&fake_sm)
# 785 "project/radare2/libr/io/io_bank.c" 3 4
                       ->itv) - 1 )))>((( r_itv_end (
# 785 "project/radare2/libr/io/io_bank.c"
...
# 786 "project/radare2/libr/io/io_bank.c"
                              - (addr + buf_off) + 1;
  const 
# 787 "project/radare2/libr/io/io_bank.c" 3 4
       unsigned long long 
# 787 "project/radare2/libr/io/io_bank.c"
            paddr = addr + buf_off - 
# 787 "project/radare2/libr/io/io_bank.c" 3 4
                                     r_itv_begin (
# 787 "project/radare2/libr/io/io_bank.c"
...
# 787 "project/radare2/libr/io/io_bank.c"
  ...
  node = r_rbnode_next (node);
  sm = node ? (RIOSubMap *)node->data : 
# 791 "project/radare2/libr/io/io_bank.c" 3 4
                                       ((void *)0)
# 791 "project/radare2/libr/io/io_bank.c"
                                           ;
 }
 return ret;
}
...
# 798 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) 
# 798 "project/radare2/libr/io/io_bank.c"
     int r_io_bank_read_from_submap_at(RIO *io, const 
# 798 "project/radare2/libr/io/io_bank.c" 3 4
                                                      unsigned int 
# 798 "project/radare2/libr/io/io_bank.c"
                                                           bankid, 
...
# 800 "project/radare2/libr/io/io_bank.c" 3 4
do { if (!(
# 800 "project/radare2/libr/io/io_bank.c"
io && bank
# 800 "project/radare2/libr/io/io_bank.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 800 "project/radare2/libr/io/io_bank.c"
...
# 800 "project/radare2/libr/io/io_bank.c"
 ...
 RRBNode *node;
 if (bank->last_used && 
# 805 "project/radare2/libr/io/io_bank.c" 3 4
                       r_itv_contain (
# 805 "project/radare2/libr/io/io_bank.c"
                       ((RIOSubMap *)bank->last_used->data)
# 805 "project/radare2/libr/io/io_bank.c" 3 4
                       ->itv, 
# 805 "project/radare2/libr/io/io_bank.c"
...
# 805 "project/radare2/libr/io/io_bank.c"
  ...
  node = r_crbtree_find_node (bank->submaps, &addr, _find_sm_by_vaddr_cb, 
# 808 "project/radare2/libr/io/io_bank.c" 3 4
                                                                         ((void *)0)
# 808 "project/radare2/libr/io/io_bank.c"
                                                                             );
  if (!node) {
   return 0;
  }
 ...
 if (!
# 815 "project/radare2/libr/io/io_bank.c" 3 4
     r_itv_contain (
# 815 "project/radare2/libr/io/io_bank.c"
     sm
# 815 "project/radare2/libr/io/io_bank.c" 3 4
     ->itv, 
# 815 "project/radare2/libr/io/io_bank.c"
...
# 815 "project/radare2/libr/io/io_bank.c"
 ...
 RIOMap *map = r_io_map_get_by_ref (io, &sm->mapref);
 if (!map || !(map->perm & 
# 819 "project/radare2/libr/io/io_bank.c" 3 4
                          4
# 819 "project/radare2/libr/io/io_bank.c"
                                  )) {
  return -1;
 }
 const int read_len = 
# 822 "project/radare2/libr/io/io_bank.c" 3 4
                     (((
# 822 "project/radare2/libr/io/io_bank.c"
                     len
# 822 "project/radare2/libr/io/io_bank.c" 3 4
                     )>((( r_itv_end (
# 822 "project/radare2/libr/io/io_bank.c"
...
# 822 "project/radare2/libr/io/io_bank.c"
                                                                ;
 const 
# 823 "project/radare2/libr/io/io_bank.c" 3 4
      unsigned long long 
# 823 "project/radare2/libr/io/io_bank.c"
           paddr = addr - 
# 823 "project/radare2/libr/io/io_bank.c" 3 4
                          r_itv_begin (
# 823 "project/radare2/libr/io/io_bank.c"
...
# 829 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) 
# 829 "project/radare2/libr/io/io_bank.c"
     int r_io_bank_write_to_submap_at(RIO *io, const 
# 829 "project/radare2/libr/io/io_bank.c" 3 4
                                                     unsigned int 
# 829 "project/radare2/libr/io/io_bank.c"
                                                          bankid, 
...
# 831 "project/radare2/libr/io/io_bank.c" 3 4
do { if (!(
# 831 "project/radare2/libr/io/io_bank.c"
io && bank
# 831 "project/radare2/libr/io/io_bank.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 831 "project/radare2/libr/io/io_bank.c"
...
# 831 "project/radare2/libr/io/io_bank.c"
 ...
 RRBNode *node;
 if (bank->last_used && 
# 836 "project/radare2/libr/io/io_bank.c" 3 4
                       r_itv_contain (
# 836 "project/radare2/libr/io/io_bank.c"
                       ((RIOSubMap *)bank->last_used->data)
# 836 "project/radare2/libr/io/io_bank.c" 3 4
                       ->itv, 
# 836 "project/radare2/libr/io/io_bank.c"
...
# 836 "project/radare2/libr/io/io_bank.c"
  ...
  node = r_crbtree_find_node (bank->submaps, &addr, _find_sm_by_vaddr_cb, 
# 839 "project/radare2/libr/io/io_bank.c" 3 4
                                                                         ((void *)0)
# 839 "project/radare2/libr/io/io_bank.c"
                                                                             );
  if (!node) {
   return 0;
  }
 ...
 RIOSubMap *sm = (RIOSubMap *)node->data;
 if (!
# 846 "project/radare2/libr/io/io_bank.c" 3 4
     r_itv_contain (
# 846 "project/radare2/libr/io/io_bank.c"
     sm
# 846 "project/radare2/libr/io/io_bank.c" 3 4
     ->itv, 
# 846 "project/radare2/libr/io/io_bank.c"
...
# 846 "project/radare2/libr/io/io_bank.c"
 ...
 RIOMap *map = r_io_map_get_by_ref (io, &sm->mapref);
 if (!map || !(map->perm & 
# 850 "project/radare2/libr/io/io_bank.c" 3 4
                          2
# 850 "project/radare2/libr/io/io_bank.c"
                                  )) {
  return -1;
 }
 const int write_len = 
# 853 "project/radare2/libr/io/io_bank.c" 3 4
                      (((
# 853 "project/radare2/libr/io/io_bank.c"
                      len
# 853 "project/radare2/libr/io/io_bank.c" 3 4
                      )>((( r_itv_end (
# 853 "project/radare2/libr/io/io_bank.c"
...
# 853 "project/radare2/libr/io/io_bank.c"
                                                                 ;
 const 
# 854 "project/radare2/libr/io/io_bank.c" 3 4
      unsigned long long 
# 854 "project/radare2/libr/io/io_bank.c"
           paddr = addr - 
# 854 "project/radare2/libr/io/io_bank.c" 3 4
                          r_itv_begin (
# 854 "project/radare2/libr/io/io_bank.c"
...
# 858 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) 
# 858 "project/radare2/libr/io/io_bank.c"
     RIOMap *r_io_bank_get_map_at(RIO *io, const 
# 858 "project/radare2/libr/io/io_bank.c" 3 4
                                                 unsigned int 
# 858 "project/radare2/libr/io/io_bank.c"
                                                      bankid, 
...
# 860 "project/radare2/libr/io/io_bank.c" 3 4
do { if (!(
# 860 "project/radare2/libr/io/io_bank.c"
io && bank
# 860 "project/radare2/libr/io/io_bank.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 860 "project/radare2/libr/io/io_bank.c"
"io && bank"
# 860 "project/radare2/libr/io/io_bank.c" 3 4
, 860); return (((void *)0)); } } while (0)
# 860 "project/radare2/libr/io/io_bank.c"
                                       ;
 RRBNode *node = r_crbtree_find_node (bank->submaps, &addr, _find_sm_by_vaddr_cb, 
# 861 "project/radare2/libr/io/io_bank.c" 3 4
                                                                                 ((void *)0)
# 861 "project/radare2/libr/io/io_bank.c"
                                                                                     );
 if (!node) {
  return 
# 863 "project/radare2/libr/io/io_bank.c" 3 4
        ((void *)0)
# 863 "project/radare2/libr/io/io_bank.c"
            ;
 }
 RIOSubMap *sm = (RIOSubMap *)node->data;
 if (!
# 866 "project/radare2/libr/io/io_bank.c" 3 4
     r_itv_contain (
# 866 "project/radare2/libr/io/io_bank.c"
     sm
# 866 "project/radare2/libr/io/io_bank.c" 3 4
     ->itv, 
# 866 "project/radare2/libr/io/io_bank.c"
...
# 866 "project/radare2/libr/io/io_bank.c"
  ...
  return 
# 867 "project/radare2/libr/io/io_bank.c" 3 4
        ((void *)0)
# 867 "project/radare2/libr/io/io_bank.c"
            ;
 }
...
# 873 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) 
# 873 "project/radare2/libr/io/io_bank.c"
     void r_io_bank_del_map(RIO *io, const 
# 873 "project/radare2/libr/io/io_bank.c" 3 4
                                           unsigned int 
# 873 "project/radare2/libr/io/io_bank.c"
                                                bankid, const 
...
# 877 "project/radare2/libr/io/io_bank.c" 3 4
do { if (!(
# 877 "project/radare2/libr/io/io_bank.c"
bank && map
# 877 "project/radare2/libr/io/io_bank.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 877 "project/radare2/libr/io/io_bank.c"
...
# 877 "project/radare2/libr/io/io_bank.c"
 ...
 RListIter *iter;
 RIOMapRef *mapref = 
# 879 "project/radare2/libr/io/io_bank.c" 3 4
                    ((void *)0)
# 879 "project/radare2/libr/io/io_bank.c"
                        ;
 
# 880 "project/radare2/libr/io/io_bank.c" 3 4
if (
# 880 "project/radare2/libr/io/io_bank.c"
bank->maprefs
# 880 "project/radare2/libr/io/io_bank.c" 3 4
) for (
# 880 "project/radare2/libr/io/io_bank.c"
...
# 880 "project/radare2/libr/io/io_bank.c"
 ...
 bank->last_used = 
# 887 "project/radare2/libr/io/io_bank.c" 3 4
                  ((void *)0)
# 887 "project/radare2/libr/io/io_bank.c"
                      ;

}


# 891 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) 
# 891 "project/radare2/libr/io/io_bank.c"
     void r_io_bank_del(RIO *io, const 
# 891 "project/radare2/libr/io/io_bank.c" 3 4
                                       unsigned int 
# 891 "project/radare2/libr/io/io_bank.c"
                                            bankid) {
...
# 899 "project/radare2/libr/io/io_bank.c" 3 4
__attribute__((visibility("default"))) 
# 899 "project/radare2/libr/io/io_bank.c"
     void r_io_bank_drain(RIO *io, const 
# 899 "project/radare2/libr/io/io_bank.c" 3 4
                                         unsigned int 
# 899 "project/radare2/libr/io/io_bank.c"
                                              bankid) {
 
# 900 "project/radare2/libr/io/io_bank.c" 3 4
do { if (!(
# 900 "project/radare2/libr/io/io_bank.c"
io
# 900 "project/radare2/libr/io/io_bank.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 900 "project/radare2/libr/io/io_bank.c"
...
# 900 "project/radare2/libr/io/io_bank.c"
 ...
 bank->last_used = 
# 905 "project/radare2/libr/io/io_bank.c" 3 4
                  ((void *)0)
# 905 "project/radare2/libr/io/io_bank.c"
                      ;
 RRBNode *node = r_crbtree_first_node (bank->submaps);
 RRBNode *next = 
# 907 "project/radare2/libr/io/io_bank.c" 3 4
                ((void *)0)
# 907 "project/radare2/libr/io/io_bank.c"
                    ;
 while (node) {
  ...
  if (next) {
   ...
   if (!memcmp (&bd->mapref, &sm->mapref, sizeof (RIOMapRef))) {
    r_io_submap_set_to (bd, 
# 914 "project/radare2/libr/io/io_bank.c" 3 4
                           (( r_itv_end (
# 914 "project/radare2/libr/io/io_bank.c"
                           sm
# 914 "project/radare2/libr/io/io_bank.c" 3 4
                           ->itv) - 1 ))
# 914 "project/radare2/libr/io/io_bank.c"
    ...
    r_crbtree_delete (bank->submaps, sm, _find_sm_by_from_vaddr_cb, 
# 915 "project/radare2/libr/io/io_bank.c" 3 4
                                                                   ((void *)0)
# 915 "project/radare2/libr/io/io_bank.c"
                                                                       );
    continue;
   }
  }
...
# 923 "project/radare2/libr/io/io_bank.c" 3 4
     _Bool 
# 923 "project/radare2/libr/io/io_bank.c"
          io_bank_has_map(RIO *io, const 
# 923 "project/radare2/libr/io/io_bank.c" 3 4
                                         unsigned int 
# 923 "project/radare2/libr/io/io_bank.c"
                                              bankid, const 
...
# 925 "project/radare2/libr/io/io_bank.c" 3 4
do { if (!(
# 925 "project/radare2/libr/io/io_bank.c"
io && bank
# 925 "project/radare2/libr/io/io_bank.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 925 "project/radare2/libr/io/io_bank.c"
"io && bank"
# 925 "project/radare2/libr/io/io_bank.c" 3 4
, 925); return (0); } } while (0)
# 925 "project/radare2/libr/io/io_bank.c"
                                        ;
 RListIter *iter;
 RIOMapRef *mapref;
 
# 928 "project/radare2/libr/io/io_bank.c" 3 4
if (
# 928 "project/radare2/libr/io/io_bank.c"
bank->maprefs
# 928 "project/radare2/libr/io/io_bank.c" 3 4
) for (
# 928 "project/radare2/libr/io/io_bank.c"
...
# 928 "project/radare2/libr/io/io_bank.c"
  ...
  if (mapref->id == mapid) {
   return 
# 930 "project/radare2/libr/io/io_bank.c" 3 4
         1
# 930 "project/radare2/libr/io/io_bank.c"
             ;
  }
 }
 return 
# 933 "project/radare2/libr/io/io_bank.c" 3 4
       0
# 933 "project/radare2/libr/io/io_bank.c"
            ;
}
