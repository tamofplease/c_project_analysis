# 0 "project/radare2/libr/io/io_memory.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/io/io_memory.h" 1
...
# 5 "project/radare2/libr/io/io_memory.h" 2


# 6 "project/radare2/libr/io/io_memory.h"
typedef struct {
 
# 7 "project/radare2/libr/io/io_memory.h" 3 4
unsigned char 
# 7 "project/radare2/libr/io/io_memory.h"
    *buf;
 
# 8 "project/radare2/libr/io/io_memory.h" 3 4
unsigned int 
# 8 "project/radare2/libr/io/io_memory.h"
     size;
 
# 9 "project/radare2/libr/io/io_memory.h" 3 4
unsigned long long 
# 9 "project/radare2/libr/io/io_memory.h"
     offset;
 void *data;
} RIOMalloc;


# 13 "project/radare2/libr/io/io_memory.h" 3 4
_Bool 
# 13 "project/radare2/libr/io/io_memory.h"
    io_memory_close(RIODesc *fd);
int io_memory_read(RIO *io, RIODesc *fd, 
# 14 "project/radare2/libr/io/io_memory.h" 3 4
                                        unsigned char 
# 14 "project/radare2/libr/io/io_memory.h"
                                            *buf, int count);

# 15 "project/radare2/libr/io/io_memory.h" 3 4
unsigned long long 
# 15 "project/radare2/libr/io/io_memory.h"
...
# 16 "project/radare2/libr/io/io_memory.h" 3 4
                                               unsigned char 
# 16 "project/radare2/libr/io/io_memory.h"
                                                   *buf, int count);

# 17 "project/radare2/libr/io/io_memory.h" 3 4
_Bool 
# 17 "project/radare2/libr/io/io_memory.h"
    io_memory_resize(RIO *io, RIODesc *fd, 
# 17 "project/radare2/libr/io/io_memory.h" 3 4
                                           unsigned long long 
# 17 "project/radare2/libr/io/io_memory.h"
                                                count);
# 4 "project/radare2/libr/io/io_memory.c" 2

static inline 
# 5 "project/radare2/libr/io/io_memory.c" 3 4
             unsigned int 
# 5 "project/radare2/libr/io/io_memory.c"
...
static inline 
# 13 "project/radare2/libr/io/io_memory.c" 3 4
             unsigned char
# 13 "project/radare2/libr/io/io_memory.c"
                * _io_malloc_buf(RIODesc *desc) {
 if (!desc) {
  return 
# 15 "project/radare2/libr/io/io_memory.c" 3 4
        ((void *)0)
# 15 "project/radare2/libr/io/io_memory.c"
            ;
 }
 RIOMalloc *mal = (RIOMalloc*)desc->data;
 return mal->buf;
}
# 31 "project/radare2/libr/io/io_memory.c"
static inline 
# 31 "project/radare2/libr/io/io_memory.c" 3 4
             unsigned long long 
# 31 "project/radare2/libr/io/io_memory.c"
...
# 39 "project/radare2/libr/io/io_memory.c" 3 4
                                                    unsigned long long 
# 39 "project/radare2/libr/io/io_memory.c"
                                                         off) {
 if (!desc) {
  return;
 }
...
int io_memory_write(RIO *io, RIODesc *fd, const 
# 47 "project/radare2/libr/io/io_memory.c" 3 4
                                               unsigned char 
# 47 "project/radare2/libr/io/io_memory.c"
                                                   *buf, int count) {
...
# 58 "project/radare2/libr/io/io_memory.c" 3 4
 __builtin___memcpy_chk (
# 58 "project/radare2/libr/io/io_memory.c"
...
# 65 "project/radare2/libr/io/io_memory.c" 3 4
_Bool 
# 65 "project/radare2/libr/io/io_memory.c"
    io_memory_resize(RIO *io, RIODesc *fd, 
# 65 "project/radare2/libr/io/io_memory.c" 3 4
                                           unsigned long long 
# 65 "project/radare2/libr/io/io_memory.c"
 ...
 if (!fd || !fd->data || count == 0) {
  return 
# 67 "project/radare2/libr/io/io_memory.c" 3 4
        0
# 67 "project/radare2/libr/io/io_memory.c"
             ;
 }
 
# 69 "project/radare2/libr/io/io_memory.c" 3 4
unsigned int 
# 69 "project/radare2/libr/io/io_memory.c"
     mallocsz = _io_malloc_sz (fd);
 if (_io_malloc_off (fd) > mallocsz) {
  return 
# 71 "project/radare2/libr/io/io_memory.c" 3 4
        0
# 71 "project/radare2/libr/io/io_memory.c"
             ;
 }
 RIOMalloc *mal = (RIOMalloc*)fd->data;
 
# 74 "project/radare2/libr/io/io_memory.c" 3 4
unsigned char 
# 74 "project/radare2/libr/io/io_memory.c"
    *new_buf = realloc (mal->buf, count);
 if (!new_buf) {
  return 
# 76 "project/radare2/libr/io/io_memory.c" 3 4
        0
# 76 "project/radare2/libr/io/io_memory.c"
             ;
 }
 mal->buf = new_buf;
 if (count > mal->size) {
  
# 80 "project/radare2/libr/io/io_memory.c" 3 4
 __builtin___memset_chk (
# 80 "project/radare2/libr/io/io_memory.c"
 mal->buf + mal->size
# 80 "project/radare2/libr/io/io_memory.c" 3 4
 , 
# 80 "project/radare2/libr/io/io_memory.c"
...
# 80 "project/radare2/libr/io/io_memory.c"
 ...
 mal->size = count;
 return 
# 83 "project/radare2/libr/io/io_memory.c" 3 4
       1
# 83 "project/radare2/libr/io/io_memory.c"
           ;
}

int io_memory_read(RIO *io, RIODesc *fd, 
# 86 "project/radare2/libr/io/io_memory.c" 3 4
                                        unsigned char 
# 86 "project/radare2/libr/io/io_memory.c"
                                            *buf, int count) {
 
# 87 "project/radare2/libr/io/io_memory.c" 3 4
__builtin___memset_chk (
# 87 "project/radare2/libr/io/io_memory.c"
buf
# 87 "project/radare2/libr/io/io_memory.c" 3 4
, 
# 87 "project/radare2/libr/io/io_memory.c"
...
# 91 "project/radare2/libr/io/io_memory.c" 3 4
unsigned int 
# 91 "project/radare2/libr/io/io_memory.c"
     mallocsz = _io_malloc_sz (fd);
 if (_io_malloc_off (fd) > mallocsz) {
  return -1;
 }
...
# 98 "project/radare2/libr/io/io_memory.c" 3 4
__builtin___memcpy_chk (
# 98 "project/radare2/libr/io/io_memory.c"
buf
# 98 "project/radare2/libr/io/io_memory.c" 3 4
, 
# 98 "project/radare2/libr/io/io_memory.c"
...
# 103 "project/radare2/libr/io/io_memory.c" 3 4
_Bool 
# 103 "project/radare2/libr/io/io_memory.c"
    io_memory_close(RIODesc *fd) {
 RIOMalloc *riom;
 if (!fd || !fd->data) {
  return 
# 106 "project/radare2/libr/io/io_memory.c" 3 4
        0
# 106 "project/radare2/libr/io/io_memory.c"
             ;
 }
 riom = fd->data;
 
# 109 "project/radare2/libr/io/io_memory.c" 3 4
{ free((void *)
# 109 "project/radare2/libr/io/io_memory.c"
riom->buf
# 109 "project/radare2/libr/io/io_memory.c" 3 4
); 
# 109 "project/radare2/libr/io/io_memory.c"
...
# 110 "project/radare2/libr/io/io_memory.c" 3 4
{ free((void *)
# 110 "project/radare2/libr/io/io_memory.c"
fd->data
# 110 "project/radare2/libr/io/io_memory.c" 3 4
); 
# 110 "project/radare2/libr/io/io_memory.c"
...
# 110 "project/radare2/libr/io/io_memory.c"
                 ;
 return 
# 111 "project/radare2/libr/io/io_memory.c" 3 4
       1
# 111 "project/radare2/libr/io/io_memory.c"
           ;
}


# 114 "project/radare2/libr/io/io_memory.c" 3 4
unsigned long long 
# 114 "project/radare2/libr/io/io_memory.c"
    io_memory_lseek(RIO* io, RIODesc *fd, 
# 114 "project/radare2/libr/io/io_memory.c" 3 4
                                          unsigned long long 
# 114 "project/radare2/libr/io/io_memory.c"
...
# 115 "project/radare2/libr/io/io_memory.c" 3 4
unsigned long long 
# 115 "project/radare2/libr/io/io_memory.c"
     r_offset = offset;
 if (!fd || !fd->data) {
  return offset;
 }
 
# 119 "project/radare2/libr/io/io_memory.c" 3 4
unsigned int 
# 119 "project/radare2/libr/io/io_memory.c"
     mallocsz = _io_malloc_sz (fd);
 switch (whence) {
 case 
# 121 "project/radare2/libr/io/io_memory.c" 3 4
     0
# 121 "project/radare2/libr/io/io_memory.c"
             :
  r_offset = (offset <= mallocsz) ? offset : mallocsz;
  break;
 case 
# 124 "project/radare2/libr/io/io_memory.c" 3 4
     1
# 124 "project/radare2/libr/io/io_memory.c"
             :
  r_offset = (_io_malloc_off (fd) + offset <= mallocsz ) ? _io_malloc_off (fd) + offset : mallocsz;
  break;
 case 
# 127 "project/radare2/libr/io/io_memory.c" 3 4
     2
# 127 "project/radare2/libr/io/io_memory.c"
             :
