# 0 "project/radare2/libr/io/p/io_default.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/io/p/io_default.c"
...
# 4 "project/radare2/libr/io/p/io_default.c" 2
...
# 5 "project/radare2/libr/io/p/io_default.c" 2
...
# 6 "project/radare2/libr/io/p/io_default.c" 2



# 8 "project/radare2/libr/io/p/io_default.c"
...
# 13 "project/radare2/libr/io/p/io_default.c" 3 4
_Bool 
# 13 "project/radare2/libr/io/p/io_default.c"
     rawio;
 
# 14 "project/radare2/libr/io/p/io_default.c" 3 4
_Bool 
# 14 "project/radare2/libr/io/p/io_default.c"
     nocache;
 RBuffer *buf;
 RIO * io_backref;
} RIOMMapFileObj;
...
# 39 "project/radare2/libr/io/p/io_default.c"
 const size_t posixFlags = (perm & 
# 39 "project/radare2/libr/io/p/io_default.c" 3 4
                                  2
# 39 "project/radare2/libr/io/p/io_default.c"
                                          ) ? (perm & 
# 39 "project/radare2/libr/io/p/io_default.c" 3 4
...
# 39 "project/radare2/libr/io/p/io_default.c"
   ...
   ? (
# 40 "project/radare2/libr/io/p/io_default.c" 3 4
     0x0002 
# 40 "project/radare2/libr/io/p/io_default.c"
            | 
# 40 "project/radare2/libr/io/p/io_default.c" 3 4
              0x00000200
# 40 "project/radare2/libr/io/p/io_default.c"
...
static 
# 46 "project/radare2/libr/io/p/io_default.c" 3 4
      unsigned long long 
# 46 "project/radare2/libr/io/p/io_default.c"
           r_io_def_mmap_seek(RIO *io, RIOMMapFileObj *mmo, 
# 46 "project/radare2/libr/io/p/io_default.c" 3 4
                                                            unsigned long long 
# 46 "project/radare2/libr/io/p/io_default.c"
                                                                 offset, int whence) {
 if (!mmo) {
  return 
# 48 "project/radare2/libr/io/p/io_default.c" 3 4
        0xFFFFFFFFFFFFFFFFULL
# 48 "project/radare2/libr/io/p/io_default.c"
                ;
 }
 if (mmo->rawio) {
 ...
 if (!mmo->buf) {
  return 
# 55 "project/radare2/libr/io/p/io_default.c" 3 4
        0xFFFFFFFFFFFFFFFFULL
# 55 "project/radare2/libr/io/p/io_default.c"
                ;
 }
...
# 63 "project/radare2/libr/io/p/io_default.c" 3 4
unsigned long long 
# 63 "project/radare2/libr/io/p/io_default.c"
     cur;
 if (mmo->buf) {
  cur = r_buf_tell (mmo->buf);
  r_buf_free (mmo->buf);
  mmo->buf = 
# 67 "project/radare2/libr/io/p/io_default.c" 3 4
            ((void *)0)
# 67 "project/radare2/libr/io/p/io_default.c"
                ;
 } else {
  cur = 0;
 }
 
# 71 "project/radare2/libr/io/p/io_default.c" 3 4
long long 
# 71 "project/radare2/libr/io/p/io_default.c"
     sz = r_file_size (mmo->filename);
 if (sz > 
# 72 "project/radare2/libr/io/p/io_default.c" 3 4
         0x7FFFFFFF
# 72 "project/radare2/libr/io/p/io_default.c"
                 ) {

  mmo->rawio = 
# 74 "project/radare2/libr/io/p/io_default.c" 3 4
              1
# 74 "project/radare2/libr/io/p/io_default.c"
                  ;
 }
 if (mmo->rawio) {
  ...
  if (mmo->nocache) {
   ...
   fcntl (mmo->fd, 
# 80 "project/radare2/libr/io/p/io_default.c" 3 4
                  48
# 80 "project/radare2/libr/io/p/io_default.c"
                           , 1);
 ...
 if (mmo->buf) {
  r_io_def_mmap_seek (io, mmo, cur, 
# 87 "project/radare2/libr/io/p/io_default.c" 3 4
                                   0
# 87 "project/radare2/libr/io/p/io_default.c"
                                           );
  return 
# 88 "project/radare2/libr/io/p/io_default.c" 3 4
        1
# 88 "project/radare2/libr/io/p/io_default.c"
            ;
 } else {
  mmo->rawio = 
# 90 "project/radare2/libr/io/p/io_default.c" 3 4
              1
# 90 "project/radare2/libr/io/p/io_default.c"
                  ;
  mmo->fd = __io_posix_open (mmo->filename, mmo->perm, mmo->mode);
  if (mmo->nocache) {

   fcntl (mmo->fd, 
# 94 "project/radare2/libr/io/p/io_default.c" 3 4
                  48
# 94 "project/radare2/libr/io/p/io_default.c"
                           , 1);
 ...
 return 
# 99 "project/radare2/libr/io/p/io_default.c" 3 4
       0
# 99 "project/radare2/libr/io/p/io_default.c"
            ;
}
...
# 112 "project/radare2/libr/io/p/io_default.c" 3 4
do { if (!(
# 112 "project/radare2/libr/io/p/io_default.c"
io && filename
# 112 "project/radare2/libr/io/p/io_default.c" 3 4
...
"io && filename"
# 112 "project/radare2/libr/io/p/io_default.c" 3 4
, 112); return (((void *)0)); } } while (0)
# 112 "project/radare2/libr/io/p/io_default.c"
                                           ;
 RIOMMapFileObj *mmo = 
# 113 "project/radare2/libr/io/p/io_default.c" 3 4
                      (
# 113 "project/radare2/libr/io/p/io_default.c"
                      RIOMMapFileObj
# 113 "project/radare2/libr/io/p/io_default.c" 3 4
                      *)calloc(1,sizeof(
# 113 "project/radare2/libr/io/p/io_default.c"
...
# 113 "project/radare2/libr/io/p/io_default.c"
 ...
 if (!mmo) {
  return 
# 115 "project/radare2/libr/io/p/io_default.c" 3 4
        ((void *)0)
# 115 "project/radare2/libr/io/p/io_default.c"
            ;
 }
 ...
 mmo->mode = mode;
 mmo->io_backref = io;
 const int posixFlags = (perm & 
# 128 "project/radare2/libr/io/p/io_default.c" 3 4
                               2
# 128 "project/radare2/libr/io/p/io_default.c"
                                       )
   ?(
    (perm & 
# 130 "project/radare2/libr/io/p/io_default.c" 3 4
           64
# 130 "project/radare2/libr/io/p/io_default.c"
                       )
     ? (
# 131 "project/radare2/libr/io/p/io_default.c" 3 4
       0x0002 
# 131 "project/radare2/libr/io/p/io_default.c"
              | 
# 131 "project/radare2/libr/io/p/io_default.c" 3 4
                0x00000200
# 131 "project/radare2/libr/io/p/io_default.c"
     ...
     : 
# 132 "project/radare2/libr/io/p/io_default.c" 3 4
      0x0002
   
# 133 "project/radare2/libr/io/p/io_default.c"
  ): 
# 133 "project/radare2/libr/io/p/io_default.c" 3 4
     0x0000
# 133 "project/radare2/libr/io/p/io_default.c"
             ;
 ...
 if (mmo->fd == -1) {
  ...
  free (mmo);
  return 
# 138 "project/radare2/libr/io/p/io_default.c" 3 4
        ((void *)0)
# 138 "project/radare2/libr/io/p/io_default.c"
            ;
 }
 if (!r_io_def_mmap_refresh_def_mmap_buf (mmo)) {
  mmo->rawio = 
# 141 "project/radare2/libr/io/p/io_default.c" 3 4
              1
# 141 "project/radare2/libr/io/p/io_default.c"
                  ;
  if (!r_io_def_mmap_refresh_def_mmap_buf (mmo)) {
   r_io_def_mmap_free (mmo);
   mmo = 
# 144 "project/radare2/libr/io/p/io_default.c" 3 4
        ((void *)0)
# 144 "project/radare2/libr/io/p/io_default.c"
            ;
  }
 }
 return mmo;
...
static 
# 150 "project/radare2/libr/io/p/io_default.c" 3 4
      _Bool 
# 150 "project/radare2/libr/io/p/io_default.c"
           r_io_def_mmap_check_default(const char *filename) {
 
# 151 "project/radare2/libr/io/p/io_default.c" 3 4
do { if (!(
# 151 "project/radare2/libr/io/p/io_default.c"
filename && *filename
# 151 "project/radare2/libr/io/p/io_default.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 151 "project/radare2/libr/io/p/io_default.c"
...
# 151 "project/radare2/libr/io/p/io_default.c"
 ...
 const char * peekaboo = (!strncmp (filename, "nocache://", 10))
  ? 
# 156 "project/radare2/libr/io/p/io_default.c" 3 4
   ((void *)0) 
# 156 "project/radare2/libr/io/p/io_default.c"
        : strstr (filename, "://");
 return (!peekaboo || (peekaboo - filename) > 10);
}

static int r_io_def_mmap_read(RIO *io, RIODesc *fd, 
# 160 "project/radare2/libr/io/p/io_default.c" 3 4
                                                   unsigned char 
# 160 "project/radare2/libr/io/p/io_default.c"
                                                       *buf, int count) {
 
# 161 "project/radare2/libr/io/p/io_default.c" 3 4
do { if (!(
# 161 "project/radare2/libr/io/p/io_default.c"
fd && fd->data && buf
# 161 "project/radare2/libr/io/p/io_default.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 161 "project/radare2/libr/io/p/io_default.c"
...
# 161 "project/radare2/libr/io/p/io_default.c"
                                                ;
 if (io->off == 
# 162 "project/radare2/libr/io/p/io_default.c" 3 4
               0xFFFFFFFFFFFFFFFFULL
# 162 "project/radare2/libr/io/p/io_default.c"
                       ) {
  
# 163 "project/radare2/libr/io/p/io_default.c" 3 4
 __builtin___memset_chk (
# 163 "project/radare2/libr/io/p/io_default.c"
 buf
# 163 "project/radare2/libr/io/p/io_default.c" 3 4
 , 
# 163 "project/radare2/libr/io/p/io_default.c"
...
# 163 "project/radare2/libr/io/p/io_default.c"
 ...
 if (mmo->rawio) {
  if (lseek (mmo->fd, io->off, 
# 172 "project/radare2/libr/io/p/io_default.c" 3 4
                              0
# 172 "project/radare2/libr/io/p/io_default.c"
                                      ) < 0) {
   return -1;
  }
 ...
 r_buf_seek (mmo->buf, r, 
# 184 "project/radare2/libr/io/p/io_default.c" 3 4
                         1
# 184 "project/radare2/libr/io/p/io_default.c"
                                  );
 io->off += r;
 return r;
}

static int r_io_def_mmap_write(RIO *io, RIODesc *fd, const 
# 189 "project/radare2/libr/io/p/io_default.c" 3 4
                                                          unsigned char 
# 189 "project/radare2/libr/io/p/io_default.c"
                                                              *buf, int count) {
 
# 190 "project/radare2/libr/io/p/io_default.c" 3 4
do { if (!(
# 190 "project/radare2/libr/io/p/io_default.c"
io && fd && fd->data && buf
# 190 "project/radare2/libr/io/p/io_default.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 190 "project/radare2/libr/io/p/io_default.c"
...
# 193 "project/radare2/libr/io/p/io_default.c" 3 4
unsigned long long 
# 193 "project/radare2/libr/io/p/io_default.c"
     addr = io->off;
 RIOMMapFileObj *mmo = fd->data;
 if (mmo->rawio) {
 ...
 if (mmo && mmo->buf) {
  if (!(mmo->perm & 
# 204 "project/radare2/libr/io/p/io_default.c" 3 4
                   2
# 204 "project/radare2/libr/io/p/io_default.c"
                           )) {
   return -1;
  }
  if ( (count + addr > r_buf_size (mmo->buf)) || r_buf_size (mmo->buf) == 0) {
   
# 208 "project/radare2/libr/io/p/io_default.c" 3 4
  unsigned long long 
# 208 "project/radare2/libr/io/p/io_default.c"
       sz = count + addr;
...
# 222 "project/radare2/libr/io/p/io_default.c" 3 4
 fprintf(__stderrp,
# 222 "project/radare2/libr/io/p/io_default.c"
 "io_def_mmap: failed to refresh the def_mmap backed buffer.\n"
# 222 "project/radare2/libr/io/p/io_default.c" 3 4
 )
# 222 "project/radare2/libr/io/p/io_default.c"
                                                                         ;
...
# 229 "project/radare2/libr/io/p/io_default.c" 3 4
do { if (!(
# 229 "project/radare2/libr/io/p/io_default.c"
io && file
# 229 "project/radare2/libr/io/p/io_default.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 229 "project/radare2/libr/io/p/io_default.c"
"io && file"
# 229 "project/radare2/libr/io/p/io_default.c" 3 4
, 229); return (((void *)0)); } } while (0)
# 229 "project/radare2/libr/io/p/io_default.c"
                                       ;
# 240 "project/radare2/libr/io/p/io_default.c"
 RIOMMapFileObj *mmo = r_io_def_mmap_create_new_file (io, file, perm, mode);
 if (!mmo) {
  return 
# 242 "project/radare2/libr/io/p/io_default.c" 3 4
        ((void *)0)
# 242 "project/radare2/libr/io/p/io_default.c"
            ;
 }
...
static int r_io_def_mmap_truncate(RIOMMapFileObj *mmo, 
# 257 "project/radare2/libr/io/p/io_default.c" 3 4
                                                      unsigned long long 
# 257 "project/radare2/libr/io/p/io_default.c"
                                                           size) {
 
# 258 "project/radare2/libr/io/p/io_default.c" 3 4
_Bool 
# 258 "project/radare2/libr/io/p/io_default.c"
     res = r_file_truncate (mmo->filename, size);
 if (res && !r_io_def_mmap_refresh_def_mmap_buf (mmo) ) {
  
# 260 "project/radare2/libr/io/p/io_default.c" 3 4
 fprintf(__stderrp,
# 260 "project/radare2/libr/io/p/io_default.c"
 "r_io_def_mmap_truncate: Error trying to refresh the def_mmap'ed file."
# 260 "project/radare2/libr/io/p/io_default.c" 3 4
 )
# 260 "project/radare2/libr/io/p/io_default.c"
                                                                                  ;
  res = 
# 261 "project/radare2/libr/io/p/io_default.c" 3 4
       0
# 261 "project/radare2/libr/io/p/io_default.c"
            ;
 } else if (!res) {
  
# 263 "project/radare2/libr/io/p/io_default.c" 3 4
 fprintf(__stderrp,
# 263 "project/radare2/libr/io/p/io_default.c"
 "r_io_def_mmap_truncate: Error trying to resize the file."
# 263 "project/radare2/libr/io/p/io_default.c" 3 4
 )
# 263 "project/radare2/libr/io/p/io_default.c"
                                                                     ;
...
static 
# 268 "project/radare2/libr/io/p/io_default.c" 3 4
      _Bool 
# 268 "project/radare2/libr/io/p/io_default.c"
           __plugin_open_default(RIO *io, const char *file, 
# 268 "project/radare2/libr/io/p/io_default.c" 3 4
                                                            _Bool 
# 268 "project/radare2/libr/io/p/io_default.c"
                                                                 many) {
...
static RIODesc *__open_default(RIO *io, const char *file, int perm, int mode) {
 ...
 return 
# 277 "project/radare2/libr/io/p/io_default.c" 3 4
       ((void *)0)
# 277 "project/radare2/libr/io/p/io_default.c"
           ;
}

static int __read(RIO *io, RIODesc *fd, 
# 280 "project/radare2/libr/io/p/io_default.c" 3 4
                                       unsigned char 
# 280 "project/radare2/libr/io/p/io_default.c"
                                           *buf, int len) {
 return r_io_def_mmap_read (io, fd, buf, len);
}

static int __write(RIO *io, RIODesc *fd, const 
# 284 "project/radare2/libr/io/p/io_default.c" 3 4
                                              unsigned char 
# 284 "project/radare2/libr/io/p/io_default.c"
                                                  *buf, int len) {
 return r_io_def_mmap_write(io, fd, buf, len);
}

static 
# 288 "project/radare2/libr/io/p/io_default.c" 3 4
      unsigned long long 
# 288 "project/radare2/libr/io/p/io_default.c"
...
# 289 "project/radare2/libr/io/p/io_default.c" 3 4
do { if (!(
# 289 "project/radare2/libr/io/p/io_default.c"
fd && fd->data
# 289 "project/radare2/libr/io/p/io_default.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 289 "project/radare2/libr/io/p/io_default.c"
"fd && fd->data"
# 289 "project/radare2/libr/io/p/io_default.c" 3 4
, 289); return (0xFFFFFFFFFFFFFFFFULL); } } while (0)
# 289 "project/radare2/libr/io/p/io_default.c"
                                               ;
...
static 
# 293 "project/radare2/libr/io/p/io_default.c" 3 4
      _Bool 
# 293 "project/radare2/libr/io/p/io_default.c"
           __close(RIODesc *fd) {
 
# 294 "project/radare2/libr/io/p/io_default.c" 3 4
do { if (!(
# 294 "project/radare2/libr/io/p/io_default.c"
fd
# 294 "project/radare2/libr/io/p/io_default.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 294 "project/radare2/libr/io/p/io_default.c"
"fd"
# 294 "project/radare2/libr/io/p/io_default.c" 3 4
, 294); return (0); } } while (0)
# 294 "project/radare2/libr/io/p/io_default.c"
                                ;
 if (fd->data) {
  r_io_def_mmap_free ((RIOMMapFileObj *) fd->data);
  fd->data = 
# 297 "project/radare2/libr/io/p/io_default.c" 3 4
            ((void *)0)
# 297 "project/radare2/libr/io/p/io_default.c"
                ;
 }
 return 
# 299 "project/radare2/libr/io/p/io_default.c" 3 4
       1
# 299 "project/radare2/libr/io/p/io_default.c"
           ;
}

static 
# 302 "project/radare2/libr/io/p/io_default.c" 3 4
      _Bool 
# 302 "project/radare2/libr/io/p/io_default.c"
           __resize(RIO *io, RIODesc *fd, 
# 302 "project/radare2/libr/io/p/io_default.c" 3 4
                                          unsigned long long 
# 302 "project/radare2/libr/io/p/io_default.c"
                                               size) {
 
# 303 "project/radare2/libr/io/p/io_default.c" 3 4
do { if (!(
# 303 "project/radare2/libr/io/p/io_default.c"
io && fd && fd->data
# 303 "project/radare2/libr/io/p/io_default.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 303 "project/radare2/libr/io/p/io_default.c"
...
# 303 "project/radare2/libr/io/p/io_default.c"
 ...
 RIOMMapFileObj *mmo = fd->data;
 if (!(mmo->perm & 
# 305 "project/radare2/libr/io/p/io_default.c" 3 4
                  2
# 305 "project/radare2/libr/io/p/io_default.c"
                          )) {
  return 
# 306 "project/radare2/libr/io/p/io_default.c" 3 4
        0
# 306 "project/radare2/libr/io/p/io_default.c"
             ;
 }
...
static 
# 312 "project/radare2/libr/io/p/io_default.c" 3 4
      _Bool 
# 312 "project/radare2/libr/io/p/io_default.c"
           __is_blockdevice (RIODesc *desc) {
 
# 313 "project/radare2/libr/io/p/io_default.c" 3 4
do { if (!(
# 313 "project/radare2/libr/io/p/io_default.c"
desc && desc->data
# 313 "project/radare2/libr/io/p/io_default.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 313 "project/radare2/libr/io/p/io_default.c"
...
# 313 "project/radare2/libr/io/p/io_default.c"
 ...
 if (fstat (mmo->fd, &buf) == -1) {
  return 
# 317 "project/radare2/libr/io/p/io_default.c" 3 4
        0
# 317 "project/radare2/libr/io/p/io_default.c"
             ;
 }
 return ((buf.st_mode & 
# 319 "project/radare2/libr/io/p/io_default.c" 3 4
                       0060000
# 319 "project/radare2/libr/io/p/io_default.c"
                              ) == 
# 319 "project/radare2/libr/io/p/io_default.c" 3 4
                                   0060000
# 319 "project/radare2/libr/io/p/io_default.c"
...
# 341 "project/radare2/libr/io/p/io_default.c" 3 4
__attribute__((visibility("default"))) 
# 341 "project/radare2/libr/io/p/io_default.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_default,
 .version = 
# 344 "project/radare2/libr/io/p/io_default.c" 3 4
           "5.5.4"

# 345 "project/radare2/libr/io/p/io_default.c"
};
