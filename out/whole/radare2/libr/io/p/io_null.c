# 0 "project/radare2/libr/io/p/io_null.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/io/p/io_null.c"
...
# 4 "project/radare2/libr/io/p/io_null.c" 2
...
# 5 "project/radare2/libr/io/p/io_null.c" 2


# 6 "project/radare2/libr/io/p/io_null.c"
typedef struct {
 
# 7 "project/radare2/libr/io/p/io_null.c" 3 4
unsigned long long 
# 7 "project/radare2/libr/io/p/io_null.c"
     size;
 
# 8 "project/radare2/libr/io/p/io_null.c" 3 4
unsigned long long 
# 8 "project/radare2/libr/io/p/io_null.c"
     offset;
} RIONull;

static int __write(RIO* io, RIODesc* fd, const 
# 11 "project/radare2/libr/io/p/io_null.c" 3 4
                                              unsigned char
# 11 "project/radare2/libr/io/p/io_null.c"
                                                 * buf, int count) {
 RIONull* null;
 if (!fd || !fd->data || !buf) {
  return -1;
...
static 
# 25 "project/radare2/libr/io/p/io_null.c" 3 4
      _Bool 
# 25 "project/radare2/libr/io/p/io_null.c"
...
# 25 "project/radare2/libr/io/p/io_null.c"
 ...
 if (fd && fd->data) {
  ...
  return 
# 36 "project/radare2/libr/io/p/io_null.c" 3 4
        1
# 36 "project/radare2/libr/io/p/io_null.c"
            ;
 }
 return 
# 38 "project/radare2/libr/io/p/io_null.c" 3 4
       0
# 38 "project/radare2/libr/io/p/io_null.c"
            ;
}

static int __read(RIO* io, RIODesc* fd, 
# 41 "project/radare2/libr/io/p/io_null.c" 3 4
                                       unsigned char
# 41 "project/radare2/libr/io/p/io_null.c"
                                          * buf, int count) {
 RIONull* null;
 if (!fd || !fd->data || !buf) {
  return -1;
...
# 49 "project/radare2/libr/io/p/io_null.c" 3 4
 __builtin___memset_chk (
# 49 "project/radare2/libr/io/p/io_null.c"
 buf
# 49 "project/radare2/libr/io/p/io_null.c" 3 4
 , 
# 49 "project/radare2/libr/io/p/io_null.c"
...
# 53 "project/radare2/libr/io/p/io_null.c" 3 4
__builtin___memset_chk (
# 53 "project/radare2/libr/io/p/io_null.c"
buf
# 53 "project/radare2/libr/io/p/io_null.c" 3 4
, 
# 53 "project/radare2/libr/io/p/io_null.c"
...
static 
# 58 "project/radare2/libr/io/p/io_null.c" 3 4
      _Bool 
# 58 "project/radare2/libr/io/p/io_null.c"
           __close(RIODesc* fd) {
 
# 59 "project/radare2/libr/io/p/io_null.c" 3 4
{ free((void *)
# 59 "project/radare2/libr/io/p/io_null.c"
fd->data
# 59 "project/radare2/libr/io/p/io_null.c" 3 4
); 
# 59 "project/radare2/libr/io/p/io_null.c"
...
# 59 "project/radare2/libr/io/p/io_null.c"
                 ;
 return 
# 60 "project/radare2/libr/io/p/io_null.c" 3 4
       1
# 60 "project/radare2/libr/io/p/io_null.c"
           ;
}

static 
# 63 "project/radare2/libr/io/p/io_null.c" 3 4
      unsigned long long 
# 63 "project/radare2/libr/io/p/io_null.c"
...
# 63 "project/radare2/libr/io/p/io_null.c"
 ...
 switch (whence) {
 case 
# 70 "project/radare2/libr/io/p/io_null.c" 3 4
     0
# 70 "project/radare2/libr/io/p/io_null.c"
             :
  if (offset >= null->size) {
 ...
 case 
# 75 "project/radare2/libr/io/p/io_null.c" 3 4
     1
# 75 "project/radare2/libr/io/p/io_null.c"
             :
  ...
  return null->offset += offset;
 case 
# 80 "project/radare2/libr/io/p/io_null.c" 3 4
     2
# 80 "project/radare2/libr/io/p/io_null.c"
             :
  return null->offset = null->size - 1;
 }
 return offset;
...
static 
# 86 "project/radare2/libr/io/p/io_null.c" 3 4
      _Bool 
# 86 "project/radare2/libr/io/p/io_null.c"
...
static RIODesc* __open(RIO* io, const char* pathname, int rw, int mode) {
 ...
 if (__plugin_open (io, pathname,0)) {
  if (!strncmp (pathname, "null://", 7) && strlen (pathname + 7)) {
   null = 
# 94 "project/radare2/libr/io/p/io_null.c" 3 4
         (
# 94 "project/radare2/libr/io/p/io_null.c"
         RIONull
# 94 "project/radare2/libr/io/p/io_null.c" 3 4
         *)calloc(1,sizeof(
# 94 "project/radare2/libr/io/p/io_null.c"
...
# 94 "project/radare2/libr/io/p/io_null.c"
                         ;
   null->size = r_num_math (
# 95 "project/radare2/libr/io/p/io_null.c" 3 4
                           ((void *)0)
# 95 "project/radare2/libr/io/p/io_null.c"
                               , pathname + 7) + 1;
   null->offset = 0LL;
 ...
 return 
# 100 "project/radare2/libr/io/p/io_null.c" 3 4
       ((void *)0)
# 100 "project/radare2/libr/io/p/io_null.c"
           ;
}
...
# 118 "project/radare2/libr/io/p/io_null.c" 3 4
__attribute__((visibility("default"))) 
# 118 "project/radare2/libr/io/p/io_null.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_null,
 .version = 
# 121 "project/radare2/libr/io/p/io_null.c" 3 4
           "5.5.4"

# 122 "project/radare2/libr/io/p/io_null.c"
};
