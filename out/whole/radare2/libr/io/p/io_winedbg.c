# 0 "project/radare2/libr/io/p/io_winedbg.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/io/p/io_winedbg.c" 2
...
# 5 "project/radare2/libr/io/p/io_winedbg.c" 2
...
# 6 "project/radare2/libr/io/p/io_winedbg.c" 2





# 10 "project/radare2/libr/io/p/io_winedbg.c"
static RSocket *gs = 
# 10 "project/radare2/libr/io/p/io_winedbg.c" 3 4
                    ((void *)0)
# 10 "project/radare2/libr/io/p/io_winedbg.c"
                        ;

struct winedbg_x86_32 { 
# 12 "project/radare2/libr/io/p/io_winedbg.c" 3 4
unsigned short 
# 12 "project/radare2/libr/io/p/io_winedbg.c"
cs; 
# 12 "project/radare2/libr/io/p/io_winedbg.c" 3 4
unsigned short 
# 12 "project/radare2/libr/io/p/io_winedbg.c"
...
# 29 "project/radare2/libr/io/p/io_winedbg.c"
  ;



# 32 "project/radare2/libr/io/p/io_winedbg.c"
static char *runcmd(const char *cmd) {
 ...
 int timeout = 1000000;
 char *str = 
# 38 "project/radare2/libr/io/p/io_winedbg.c" 3 4
            ((void *)0)
# 38 "project/radare2/libr/io/p/io_winedbg.c"
                ;
 r_socket_block_time (gs, 1, timeout, 0);
 while (
# 40 "project/radare2/libr/io/p/io_winedbg.c" 3 4
       1
# 40 "project/radare2/libr/io/p/io_winedbg.c"
           ) {
  
# 41 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 __builtin___memset_chk (
# 41 "project/radare2/libr/io/p/io_winedbg.c"
 buf
# 41 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 , 
# 41 "project/radare2/libr/io/p/io_winedbg.c"
...
# 41 "project/radare2/libr/io/p/io_winedbg.c"
                              ;
  int rc = r_socket_read (gs, (
# 42 "project/radare2/libr/io/p/io_winedbg.c" 3 4
                              unsigned char
# 42 "project/radare2/libr/io/p/io_winedbg.c"
                                 *)buf, sizeof (buf) - 1);
  if (rc == -1) {
   break;
  }
 ...
 free (str);
 return 
# 55 "project/radare2/libr/io/p/io_winedbg.c" 3 4
       ((void *)0)
# 55 "project/radare2/libr/io/p/io_winedbg.c"
           ;
}

static int __write(RIO *io, RIODesc *fd, const 
# 58 "project/radare2/libr/io/p/io_winedbg.c" 3 4
                                              unsigned char 
# 58 "project/radare2/libr/io/p/io_winedbg.c"
                                                  *buf, int count) {
 if (!fd || !fd->data) {
  return -1;
 }
...
# 63 "project/radare2/libr/io/p/io_winedbg.c" 3 4
unsigned int 
# 63 "project/radare2/libr/io/p/io_winedbg.c"
     *w = (
# 63 "project/radare2/libr/io/p/io_winedbg.c" 3 4
           unsigned int
# 63 "project/radare2/libr/io/p/io_winedbg.c"
...
# 67 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 unsigned long long 
# 67 "project/radare2/libr/io/p/io_winedbg.c"
      addr = io->off + (i * wordSize);
  char *cmd = r_str_newf ("set *0x%"
# 68 "project/radare2/libr/io/p/io_winedbg.c" 3 4
                                   "llx"
# 68 "project/radare2/libr/io/p/io_winedbg.c"
                                          " = 0x%x", addr, w[i]);
  free (runcmd (cmd));
  free (cmd);
 }
...
# 75 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 unsigned int 
# 75 "project/radare2/libr/io/p/io_winedbg.c"
      leftW = -1;
  
# 76 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 __builtin___memcpy_chk (
# 76 "project/radare2/libr/io/p/io_winedbg.c"
 &leftW
# 76 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 , 
# 76 "project/radare2/libr/io/p/io_winedbg.c"
...
# 77 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 unsigned long long 
# 77 "project/radare2/libr/io/p/io_winedbg.c"
      addr = io->off + (words * wordSize);
  char *cmd = r_str_newf ("set *0x%"
# 78 "project/radare2/libr/io/p/io_winedbg.c" 3 4
                                   "llx"
# 78 "project/radare2/libr/io/p/io_winedbg.c"
                                          " = 0x%x", addr, leftW);
  free (runcmd (cmd));
  free (cmd);
 }
...
# 85 "project/radare2/libr/io/p/io_winedbg.c" 3 4
                                       unsigned char 
# 85 "project/radare2/libr/io/p/io_winedbg.c"
                                           *buf, int count) {
 if (!fd || !fd->data) {
  return -1;
 }
...
# 106 "project/radare2/libr/io/p/io_winedbg.c"
 int wordSize = 4;
 
# 107 "project/radare2/libr/io/p/io_winedbg.c" 3 4
unsigned int 
# 107 "project/radare2/libr/io/p/io_winedbg.c"
     *w = (
# 107 "project/radare2/libr/io/p/io_winedbg.c" 3 4
           unsigned int
# 107 "project/radare2/libr/io/p/io_winedbg.c"
...
# 109 "project/radare2/libr/io/p/io_winedbg.c" 3 4
__builtin___memset_chk (
# 109 "project/radare2/libr/io/p/io_winedbg.c"
buf
# 109 "project/radare2/libr/io/p/io_winedbg.c" 3 4
, 
# 109 "project/radare2/libr/io/p/io_winedbg.c"
...
# 112 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 unsigned long long 
# 112 "project/radare2/libr/io/p/io_winedbg.c"
      addr = io->off + (i * wordSize);
  char *cmd = r_str_newf ("x 0x%"
# 113 "project/radare2/libr/io/p/io_winedbg.c" 3 4
                                "llx"
# 113 "project/radare2/libr/io/p/io_winedbg.c"
                                       , addr);
  char *res = runcmd (cmd);
  if (res) {
   sscanf (res, "%x", &w[i]);
...
# 124 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 unsigned int 
# 124 "project/radare2/libr/io/p/io_winedbg.c"
      n = 0xff;
  
# 125 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 unsigned char 
# 125 "project/radare2/libr/io/p/io_winedbg.c"
     *wn = (
# 125 "project/radare2/libr/io/p/io_winedbg.c" 3 4
            unsigned char
# 125 "project/radare2/libr/io/p/io_winedbg.c"
...
# 126 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 unsigned long long 
# 126 "project/radare2/libr/io/p/io_winedbg.c"
      addr = io->off + (i * wordSize);
  char *cmd = r_str_newf ("x 0x%"
# 127 "project/radare2/libr/io/p/io_winedbg.c" 3 4
                                "llx"
# 127 "project/radare2/libr/io/p/io_winedbg.c"
                                       , addr);
  char *res = runcmd (cmd);
  sscanf (res, "%x", &n);
  free (res);
...
# 132 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 __builtin___memcpy_chk (
# 132 "project/radare2/libr/io/p/io_winedbg.c"
 buf + (words * wordSize)
# 132 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 , 
# 132 "project/radare2/libr/io/p/io_winedbg.c"
...
static 
# 137 "project/radare2/libr/io/p/io_winedbg.c" 3 4
      _Bool 
# 137 "project/radare2/libr/io/p/io_winedbg.c"
           __close(RIODesc *fd) {
 if (!fd || !fd->data) {
  return 
# 139 "project/radare2/libr/io/p/io_winedbg.c" 3 4
        0
# 139 "project/radare2/libr/io/p/io_winedbg.c"
             ;
 }
 ...
 return 
# 144 "project/radare2/libr/io/p/io_winedbg.c" 3 4
       1
# 144 "project/radare2/libr/io/p/io_winedbg.c"
           ;
}

static 
# 147 "project/radare2/libr/io/p/io_winedbg.c" 3 4
      unsigned long long 
# 147 "project/radare2/libr/io/p/io_winedbg.c"
...
# 147 "project/radare2/libr/io/p/io_winedbg.c"
 ...
 switch (whence) {
 case 
# 149 "project/radare2/libr/io/p/io_winedbg.c" 3 4
     0
# 149 "project/radare2/libr/io/p/io_winedbg.c"
                  :
  io->off = offset;
  break;
 case 
# 152 "project/radare2/libr/io/p/io_winedbg.c" 3 4
     1
# 152 "project/radare2/libr/io/p/io_winedbg.c"
                  :
  io->off += offset;
  break;
 case 
# 155 "project/radare2/libr/io/p/io_winedbg.c" 3 4
     2
# 155 "project/radare2/libr/io/p/io_winedbg.c"
                  :
  io->off = 
# 156 "project/radare2/libr/io/p/io_winedbg.c" 3 4
           ((long long)0x7FFFFFFFFFFFFFFFULL)
# 156 "project/radare2/libr/io/p/io_winedbg.c"
                   ;
 }
 io->off = offset;
 return offset;
...
static 
# 162 "project/radare2/libr/io/p/io_winedbg.c" 3 4
      _Bool 
# 162 "project/radare2/libr/io/p/io_winedbg.c"
...
static RIODesc *__open(RIO *io, const char *pathname, int rw, int mode) {
 if (__plugin_open (io, pathname, 0)) {
  if (gs) {
   return 
# 169 "project/radare2/libr/io/p/io_winedbg.c" 3 4
         ((void *)0)
# 169 "project/radare2/libr/io/p/io_winedbg.c"
             ;
  }
  gs = r_socket_new (0);
  ...
  if (!res) {
   return 
# 176 "project/radare2/libr/io/p/io_winedbg.c" 3 4
         ((void *)0)
# 176 "project/radare2/libr/io/p/io_winedbg.c"
             ;
  }
  char *reply = runcmd (
# 178 "project/radare2/libr/io/p/io_winedbg.c" 3 4
                       ((void *)0)
# 178 "project/radare2/libr/io/p/io_winedbg.c"
                           );
  if (reply) {
   int rw = 7;
   free (reply);
   
# 182 "project/radare2/libr/io/p/io_winedbg.c" 3 4
  fprintf(__stderrp,
# 182 "project/radare2/libr/io/p/io_winedbg.c"
...
# 185 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 fprintf(__stderrp,
# 185 "project/radare2/libr/io/p/io_winedbg.c"
...
# 185 "project/radare2/libr/io/p/io_winedbg.c"
 ...
 return 
# 187 "project/radare2/libr/io/p/io_winedbg.c" 3 4
       ((void *)0)
# 187 "project/radare2/libr/io/p/io_winedbg.c"
           ;
}
...
# 202 "project/radare2/libr/io/p/io_winedbg.c" 3 4
  unsigned int 
# 202 "project/radare2/libr/io/p/io_winedbg.c"
       eip, esp, ebp, eflags;
...
# 211 "project/radare2/libr/io/p/io_winedbg.c" 3 4
   unsigned int 
# 211 "project/radare2/libr/io/p/io_winedbg.c"
        eax, ebx, ecx, edx;
...
# 220 "project/radare2/libr/io/p/io_winedbg.c" 3 4
    unsigned int 
# 220 "project/radare2/libr/io/p/io_winedbg.c"
         esi, edi;
...
static char *__system(RIO *io, RIODesc *fd, const char *cmd) {
 if (!strcmp (cmd, "")) {
  return 
# 234 "project/radare2/libr/io/p/io_winedbg.c" 3 4
        ((void *)0)
# 234 "project/radare2/libr/io/p/io_winedbg.c"
            ;
 }
 if (!strncmp (cmd, "?", 1)) {
  
# 237 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 fprintf(__stderrp,
# 237 "project/radare2/libr/io/p/io_winedbg.c"
 "dr  : show registers\n"
# 237 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 )
# 237 "project/radare2/libr/io/p/io_winedbg.c"
...
# 238 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 fprintf(__stderrp,
# 238 "project/radare2/libr/io/p/io_winedbg.c"
...
# 239 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 fprintf(__stderrp,
# 239 "project/radare2/libr/io/p/io_winedbg.c"
...
# 240 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 fprintf(__stderrp,
# 240 "project/radare2/libr/io/p/io_winedbg.c"
...
# 241 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 fprintf(__stderrp,
# 241 "project/radare2/libr/io/p/io_winedbg.c"
 "ds  : step into\n"
# 241 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 )
# 241 "project/radare2/libr/io/p/io_winedbg.c"
...
# 242 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 fprintf(__stderrp,
# 242 "project/radare2/libr/io/p/io_winedbg.c"
...
# 243 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 fprintf(__stderrp,
# 243 "project/radare2/libr/io/p/io_winedbg.c"
 "dc  : continue\n"
# 243 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 )
# 243 "project/radare2/libr/io/p/io_winedbg.c"
...
# 244 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 fprintf(__stderrp,
# 244 "project/radare2/libr/io/p/io_winedbg.c"
 "dm  : show maps\n"
# 244 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 )
# 244 "project/radare2/libr/io/p/io_winedbg.c"
...
# 245 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 fprintf(__stderrp,
# 245 "project/radare2/libr/io/p/io_winedbg.c"
...
# 248 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 unsigned char 
# 248 "project/radare2/libr/io/p/io_winedbg.c"
     *arena = (
# 248 "project/radare2/libr/io/p/io_winedbg.c" 3 4
               unsigned char
# 248 "project/radare2/libr/io/p/io_winedbg.c"
                  *)calloc (3, sizeof (struct winedbg_x86_32));
  if (arena) {
   r_hex_bin2str ((
# 250 "project/radare2/libr/io/p/io_winedbg.c" 3 4
                  unsigned char
# 250 "project/radare2/libr/io/p/io_winedbg.c"
                     *)&r, sizeof (r), (char *)arena);
   return (char *)arena;
  }
 } else if (!strncmp (cmd, "drp", 3)) {
const char *msg =
"=PC	eip\n""=SP	esp\n""=BP	ebp\n""=A0	eax\n""=A1	ebx\n""=A2	ecx\n""=A3	edx\n""=A4	esi\n""=A5	edi\n""=SN	eax\n"
# 266 "project/radare2/libr/io/p/io_winedbg.c"
"seg	cs	.16	0	0\n""seg	ss	.16	2	0\n""seg	ds	.16	4	0\n""seg	es	.16	6	0\n""seg	fs	.16	8	0\n""seg	gs	.16	10	0\n"
...
"flg	flags	.16	24	0\n""flg	cf	.1	.192	0\n""flg	pf	.1	.193	0\n""flg	af	.1	.194	0\n""flg	zf	.1	.195	0\n""flg	sf	.1	.196	0\n""flg	tf	.1	.197	0\n""flg	if	.1	.198	0\n""flg	df	.1	.199	0\n""flg	of	.1	.200	0\n""flg	nt	.1	.201	0\n""flg	rf	.1	.202	0\n""flg	vm	.1	.203	0\n";
# 298 "project/radare2/libr/io/p/io_winedbg.c"
  return strdup (msg);
  ...
  free (runcmd (sdb_fmt ("break *%x", r_num_get (
# 320 "project/radare2/libr/io/p/io_winedbg.c" 3 4
                                                ((void *)0)
# 320 "project/radare2/libr/io/p/io_winedbg.c"
                                                    , cmd + 3) || io->off)));
...
# 326 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 fprintf(__stderrp,
# 326 "project/radare2/libr/io/p/io_winedbg.c"
 "TODO: dso\n"
# 326 "project/radare2/libr/io/p/io_winedbg.c" 3 4
 )
# 326 "project/radare2/libr/io/p/io_winedbg.c"
  ...
  char *res = 
# 331 "project/radare2/libr/io/p/io_winedbg.c" 3 4
             ((void *)0)
# 331 "project/radare2/libr/io/p/io_winedbg.c"
                 ;
  if (wineDbgMaps) {
   const char *perm;
...
# 342 "project/radare2/libr/io/p/io_winedbg.c" 3 4
   unsigned long long 
# 342 "project/radare2/libr/io/p/io_winedbg.c"
        from = 0, to = 0;
    if (strstr (ptr, " commit ")) {
     ...
     sscanf (ptr, "%08"
# 347 "project/radare2/libr/io/p/io_winedbg.c" 3 4
                      "llx"
# 347 "project/radare2/libr/io/p/io_winedbg.c"
                             " %08"
# 347 "project/radare2/libr/io/p/io_winedbg.c" 3 4
                                   "llx"
# 347 "project/radare2/libr/io/p/io_winedbg.c"
    ...
    char *row = r_str_newf ("0x%08"
# 349 "project/radare2/libr/io/p/io_winedbg.c" 3 4
                                  "llx"
# 349 "project/radare2/libr/io/p/io_winedbg.c"
                                         " - 0x%08" 
# 349 "project/radare2/libr/io/p/io_winedbg.c" 3 4
                                                    "llx"
# 349 "project/radare2/libr/io/p/io_winedbg.c"
 ...
 return 
# 364 "project/radare2/libr/io/p/io_winedbg.c" 3 4
       ((void *)0)
# 364 "project/radare2/libr/io/p/io_winedbg.c"
           ;
}
...
RIOPlugin r_io_plugin_winedbg = {
 ...
 .system = __system,
 .isdbg = 
# 379 "project/radare2/libr/io/p/io_winedbg.c" 3 4
         1

# 380 "project/radare2/libr/io/p/io_winedbg.c"
};



# 383 "project/radare2/libr/io/p/io_winedbg.c" 3 4
__attribute__((visibility("default"))) 
# 383 "project/radare2/libr/io/p/io_winedbg.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_winedbg,
 .version = 
# 386 "project/radare2/libr/io/p/io_winedbg.c" 3 4
           "5.5.4"

# 387 "project/radare2/libr/io/p/io_winedbg.c"
};
