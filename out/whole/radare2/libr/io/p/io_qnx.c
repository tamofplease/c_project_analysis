# 0 "project/radare2/libr/io/p/io_qnx.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/io/p/io_qnx.c"
...
# 4 "project/radare2/libr/io/p/io_qnx.c" 2
...
# 5 "project/radare2/libr/io/p/io_qnx.c" 2
...
# 11 "project/radare2/libr/io/p/io_qnx.c" 2


# 12 "project/radare2/libr/io/p/io_qnx.c"
typedef struct {
 libqnxr_t desc;
} RIOQnx;

static libqnxr_t *desc = 
# 16 "project/radare2/libr/io/p/io_qnx.c" 3 4
                        ((void *)0)
# 16 "project/radare2/libr/io/p/io_qnx.c"
                            ;
static RIODesc *rioqnx = 
# 17 "project/radare2/libr/io/p/io_qnx.c" 3 4
                        ((void *)0)
# 17 "project/radare2/libr/io/p/io_qnx.c"
                            ;

static 
# 19 "project/radare2/libr/io/p/io_qnx.c" 3 4
      _Bool 
# 19 "project/radare2/libr/io/p/io_qnx.c"
...
static 
# 25 "project/radare2/libr/io/p/io_qnx.c" 3 4
      unsigned long long 
# 25 "project/radare2/libr/io/p/io_qnx.c"
           c_addr = 
# 25 "project/radare2/libr/io/p/io_qnx.c" 3 4
...
# 25 "project/radare2/libr/io/p/io_qnx.c"
                            ;
static 
# 26 "project/radare2/libr/io/p/io_qnx.c" 3 4
      unsigned int 
# 26 "project/radare2/libr/io/p/io_qnx.c"
           c_size = 
# 26 "project/radare2/libr/io/p/io_qnx.c" 3 4
                    0xFFFFFFFFU
# 26 "project/radare2/libr/io/p/io_qnx.c"
                            ;
static 
# 27 "project/radare2/libr/io/p/io_qnx.c" 3 4
      unsigned char 
# 27 "project/radare2/libr/io/p/io_qnx.c"
          *c_buff = 
# 27 "project/radare2/libr/io/p/io_qnx.c" 3 4
                    ((void *)0)
# 27 "project/radare2/libr/io/p/io_qnx.c"
...
static int debug_qnx_read_at (
# 30 "project/radare2/libr/io/p/io_qnx.c" 3 4
                             unsigned char 
# 30 "project/radare2/libr/io/p/io_qnx.c"
                                 *buf, int sz, 
# 30 "project/radare2/libr/io/p/io_qnx.c" 3 4
                                               unsigned long long 
# 30 "project/radare2/libr/io/p/io_qnx.c"
...
# 31 "project/radare2/libr/io/p/io_qnx.c" 3 4
unsigned int 
# 31 "project/radare2/libr/io/p/io_qnx.c"
     size_max = 500;
 
# 32 "project/radare2/libr/io/p/io_qnx.c" 3 4
unsigned int 
# 32 "project/radare2/libr/io/p/io_qnx.c"
     packets = sz / size_max;
 
# 33 "project/radare2/libr/io/p/io_qnx.c" 3 4
unsigned int 
# 33 "project/radare2/libr/io/p/io_qnx.c"
     last = sz % size_max;
 
# 34 "project/radare2/libr/io/p/io_qnx.c" 3 4
unsigned int 
# 34 "project/radare2/libr/io/p/io_qnx.c"
     x;
 if (c_buff && addr != 
# 35 "project/radare2/libr/io/p/io_qnx.c" 3 4
                      0xFFFFFFFFFFFFFFFFULL 
# 35 "project/radare2/libr/io/p/io_qnx.c"
                               && addr == c_addr) {
  
# 36 "project/radare2/libr/io/p/io_qnx.c" 3 4
 __builtin___memcpy_chk (
# 36 "project/radare2/libr/io/p/io_qnx.c"
 buf
# 36 "project/radare2/libr/io/p/io_qnx.c" 3 4
 , 
# 36 "project/radare2/libr/io/p/io_qnx.c"
...
# 36 "project/radare2/libr/io/p/io_qnx.c"
 ...
 if (sz < 1 || addr >= 
# 39 "project/radare2/libr/io/p/io_qnx.c" 3 4
                      0xFFFFFFFFFFFFFFFFULL
# 39 "project/radare2/libr/io/p/io_qnx.c"
                              ) {
  return -1;
 }
 for (x = 0; x < packets; x++) {
...
static int debug_qnx_write_at (const 
# 57 "project/radare2/libr/io/p/io_qnx.c" 3 4
                                    unsigned char 
# 57 "project/radare2/libr/io/p/io_qnx.c"
                                        *buf, int sz, 
# 57 "project/radare2/libr/io/p/io_qnx.c" 3 4
                                                      unsigned long long 
# 57 "project/radare2/libr/io/p/io_qnx.c"
...
# 58 "project/radare2/libr/io/p/io_qnx.c" 3 4
unsigned int 
# 58 "project/radare2/libr/io/p/io_qnx.c"
     x, size_max = 500;
 
# 59 "project/radare2/libr/io/p/io_qnx.c" 3 4
unsigned int 
# 59 "project/radare2/libr/io/p/io_qnx.c"
     packets = sz / size_max;
 
# 60 "project/radare2/libr/io/p/io_qnx.c" 3 4
unsigned int 
# 60 "project/radare2/libr/io/p/io_qnx.c"
     last = sz % size_max;

 if (sz < 1 || addr >= 
# 62 "project/radare2/libr/io/p/io_qnx.c" 3 4
                      0xFFFFFFFFFFFFFFFFULL
# 62 "project/radare2/libr/io/p/io_qnx.c"
                              ) {
  return -1;
 }
 if (c_addr != 
# 65 "project/radare2/libr/io/p/io_qnx.c" 3 4
              0xFFFFFFFFFFFFFFFFULL 
# 65 "project/radare2/libr/io/p/io_qnx.c"
                       && addr >= c_addr && c_addr + sz < (c_addr + c_size)) {
  
# 66 "project/radare2/libr/io/p/io_qnx.c" 3 4
 { free((void *)
# 66 "project/radare2/libr/io/p/io_qnx.c"
 c_buff
# 66 "project/radare2/libr/io/p/io_qnx.c" 3 4
 ); 
# 66 "project/radare2/libr/io/p/io_qnx.c"
...
# 66 "project/radare2/libr/io/p/io_qnx.c"
                ;
  c_addr = 
# 67 "project/radare2/libr/io/p/io_qnx.c" 3 4
          0xFFFFFFFFFFFFFFFFULL
# 67 "project/radare2/libr/io/p/io_qnx.c"
                  ;
 }
 for (x = 0; x < packets; x++) {
...
static RIODesc *__open (RIO *io, const char *file, int rw, int mode) {
 ...
 if (!__plugin_open (io, file, 0)) {
  return 
# 86 "project/radare2/libr/io/p/io_qnx.c" 3 4
        ((void *)0)
# 86 "project/radare2/libr/io/p/io_qnx.c"
            ;
 }
 if (rioqnx) {
...
# 92 "project/radare2/libr/io/p/io_qnx.c" 3 4
__builtin___strncpy_chk (
# 92 "project/radare2/libr/io/p/io_qnx.c"
host
# 92 "project/radare2/libr/io/p/io_qnx.c" 3 4
, 
# 92 "project/radare2/libr/io/p/io_qnx.c"
file + 6, sizeof(host) - 1
# 92 "project/radare2/libr/io/p/io_qnx.c" 3 4
, __builtin_object_size (
# 92 "project/radare2/libr/io/p/io_qnx.c"
host
...
# 96 "project/radare2/libr/io/p/io_qnx.c" 3 4
 fprintf(__stderrp,
# 96 "project/radare2/libr/io/p/io_qnx.c"
...
# 96 "project/radare2/libr/io/p/io_qnx.c"
                                                                 ;
  return 
# 97 "project/radare2/libr/io/p/io_qnx.c" 3 4
        ((void *)0)
# 97 "project/radare2/libr/io/p/io_qnx.c"
            ;
 }
 *port = '\0';
 port++;
...
# 107 "project/radare2/libr/io/p/io_qnx.c" 3 4
 fprintf(__stderrp,
# 107 "project/radare2/libr/io/p/io_qnx.c"
 "sandbox: Cannot use network\n"
# 107 "project/radare2/libr/io/p/io_qnx.c" 3 4
 )
# 107 "project/radare2/libr/io/p/io_qnx.c"
                                          ;
  return 
# 108 "project/radare2/libr/io/p/io_qnx.c" 3 4
        ((void *)0)
# 108 "project/radare2/libr/io/p/io_qnx.c"
            ;
 }
 rioq = 
# 110 "project/radare2/libr/io/p/io_qnx.c" 3 4
       (
# 110 "project/radare2/libr/io/p/io_qnx.c"
       RIOQnx
# 110 "project/radare2/libr/io/p/io_qnx.c" 3 4
       *)calloc(1,sizeof(
# 110 "project/radare2/libr/io/p/io_qnx.c"
...
# 118 "project/radare2/libr/io/p/io_qnx.c" 3 4
fprintf(__stderrp,
# 118 "project/radare2/libr/io/p/io_qnx.c"
...
# 118 "project/radare2/libr/io/p/io_qnx.c"
 ...
 free (rioq);
 return 
# 120 "project/radare2/libr/io/p/io_qnx.c" 3 4
       ((void *)0)
# 120 "project/radare2/libr/io/p/io_qnx.c"
           ;
}

static int __write (RIO *io, RIODesc *fd, const 
# 123 "project/radare2/libr/io/p/io_qnx.c" 3 4
                                               unsigned char 
# 123 "project/radare2/libr/io/p/io_qnx.c"
                                                   *buf, int count) {
 
# 124 "project/radare2/libr/io/p/io_qnx.c" 3 4
unsigned long long 
# 124 "project/radare2/libr/io/p/io_qnx.c"
     addr = io->off;
 if (!desc) {
  return -1;
 }
...
static 
# 131 "project/radare2/libr/io/p/io_qnx.c" 3 4
      unsigned long long 
# 131 "project/radare2/libr/io/p/io_qnx.c"
...
# 135 "project/radare2/libr/io/p/io_qnx.c" 3 4
                                       unsigned char 
# 135 "project/radare2/libr/io/p/io_qnx.c"
                                           *buf, int count) {
 
# 136 "project/radare2/libr/io/p/io_qnx.c" 3 4
__builtin___memset_chk (
# 136 "project/radare2/libr/io/p/io_qnx.c"
buf
# 136 "project/radare2/libr/io/p/io_qnx.c" 3 4
, 
# 136 "project/radare2/libr/io/p/io_qnx.c"
...
# 137 "project/radare2/libr/io/p/io_qnx.c" 3 4
unsigned long long 
# 137 "project/radare2/libr/io/p/io_qnx.c"
     addr = io->off;
 if (!desc) {
  return -1;
 }
...
static 
# 144 "project/radare2/libr/io/p/io_qnx.c" 3 4
      _Bool 
# 144 "project/radare2/libr/io/p/io_qnx.c"
           __close(RIODesc *fd) {

 return 
# 146 "project/radare2/libr/io/p/io_qnx.c" 3 4
       1
# 146 "project/radare2/libr/io/p/io_qnx.c"
           ;
}

static char *__system(RIO *io, RIODesc *fd, const char *cmd) {
 return 
# 150 "project/radare2/libr/io/p/io_qnx.c" 3 4
       ((void *)0)
# 150 "project/radare2/libr/io/p/io_qnx.c"
           ;
}
...
RIOPlugin r_io_plugin_qnx = {
 ...
 .system = __system,
 .isdbg = 
# 165 "project/radare2/libr/io/p/io_qnx.c" 3 4
         1

# 166 "project/radare2/libr/io/p/io_qnx.c"
};



# 169 "project/radare2/libr/io/p/io_qnx.c" 3 4
__attribute__((visibility("default"))) 
# 169 "project/radare2/libr/io/p/io_qnx.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_qnx,
 .version = 
# 172 "project/radare2/libr/io/p/io_qnx.c" 3 4
           "5.5.4"

# 173 "project/radare2/libr/io/p/io_qnx.c"
};
