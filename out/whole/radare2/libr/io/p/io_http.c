# 0 "project/radare2/libr/io/p/io_http.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/io/p/io_http.c" 2
...
# 5 "project/radare2/libr/io/p/io_http.c" 2
...
# 17 "project/radare2/libr/io/p/../io_memory.h"
                                                count);
# 8 "project/radare2/libr/io/p/io_http.c" 2

static 
# 9 "project/radare2/libr/io/p/io_http.c" 3 4
      _Bool 
# 9 "project/radare2/libr/io/p/io_http.c"
...
static RIODesc *__open(RIO *io, const char *pathname, int rw, int mode) {
 if (__check (io, pathname, 0)) {
  int rlen, code;
  RIOMalloc *mal = 
# 16 "project/radare2/libr/io/p/io_http.c" 3 4
                  (
# 16 "project/radare2/libr/io/p/io_http.c"
                  RIOMalloc
# 16 "project/radare2/libr/io/p/io_http.c" 3 4
                  *)calloc(1,sizeof(
# 16 "project/radare2/libr/io/p/io_http.c"
...
# 16 "project/radare2/libr/io/p/io_http.c"
  ...
  if (!mal) {
   return 
# 18 "project/radare2/libr/io/p/io_http.c" 3 4
         ((void *)0)
# 18 "project/radare2/libr/io/p/io_http.c"
             ;
  }
  mal->offset = 0;
  mal->buf = (
# 21 "project/radare2/libr/io/p/io_http.c" 3 4
             unsigned char
# 21 "project/radare2/libr/io/p/io_http.c"
                *)r_socket_http_get (pathname, &code, &rlen);
  if (mal->buf && rlen > 0) {
   mal->size = rlen;
   return r_io_desc_new (io, &r_io_plugin_malloc, pathname, 
# 24 "project/radare2/libr/io/p/io_http.c" 3 4
                                                           (4|2) 
# 24 "project/radare2/libr/io/p/io_http.c"
                                                                     | rw, mode, mal);
  }
  
# 26 "project/radare2/libr/io/p/io_http.c" 3 4
 fprintf(__stderrp,
# 26 "project/radare2/libr/io/p/io_http.c"
 "No HTTP response\n"
# 26 "project/radare2/libr/io/p/io_http.c" 3 4
 )
# 26 "project/radare2/libr/io/p/io_http.c"
 ...
 return 
# 29 "project/radare2/libr/io/p/io_http.c" 3 4
       ((void *)0)
# 29 "project/radare2/libr/io/p/io_http.c"
           ;
}
...
# 46 "project/radare2/libr/io/p/io_http.c" 3 4
__attribute__((visibility("default"))) 
# 46 "project/radare2/libr/io/p/io_http.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_http,
 .version = 
# 49 "project/radare2/libr/io/p/io_http.c" 3 4
           "5.5.4"

# 50 "project/radare2/libr/io/p/io_http.c"
};
