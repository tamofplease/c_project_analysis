# 0 "project/radare2/libr/io/p/io_r2web.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/io/p/io_r2web.c"
...
# 4 "project/radare2/libr/io/p/io_r2web.c" 2
...
# 5 "project/radare2/libr/io/p/io_r2web.c" 2





# 9 "project/radare2/libr/io/p/io_r2web.c"
typedef struct {
 int fd;
 char *url;
} RIOR2Web;
...
# 17 "project/radare2/libr/io/p/io_r2web.c" 3 4
                                              unsigned char 
# 17 "project/radare2/libr/io/p/io_r2web.c"
                                                  *buf, int count) {
 int code, rlen;
 char *out, *url, *hexbuf;
 if (!fd || !fd->data) {
 ...
 url = r_str_newf ("%s/wx%%20%s@%"
# 32 "project/radare2/libr/io/p/io_r2web.c" 3 4
                                 "lld"
# 32 "project/radare2/libr/io/p/io_r2web.c"
                                        ,
  (((RIOR2Web*)(fd)->data)->url), hexbuf, io->off);
...
# 41 "project/radare2/libr/io/p/io_r2web.c" 3 4
                                       unsigned char 
# 41 "project/radare2/libr/io/p/io_r2web.c"
                                           *buf, int count) {
 int code, rlen;
 char *out, *url;
 int ret = 0;
 ...
 url = r_str_newf ("%s/p8%%20%d@0x%"
# 48 "project/radare2/libr/io/p/io_r2web.c" 3 4
                                   "llx"
# 48 "project/radare2/libr/io/p/io_r2web.c"
                                          ,
  (((RIOR2Web*)(fd)->data)->url), count, io->off);
 out = r_socket_http_get (url, &code, &rlen);
 if (out && rlen > 0) {
  
# 52 "project/radare2/libr/io/p/io_r2web.c" 3 4
 unsigned char 
# 52 "project/radare2/libr/io/p/io_r2web.c"
     *tmp = calloc (1, rlen+1);
  if (!tmp) {
   goto beach;
  }
...
# 57 "project/radare2/libr/io/p/io_r2web.c" 3 4
 __builtin___memcpy_chk (
# 57 "project/radare2/libr/io/p/io_r2web.c"
 buf
# 57 "project/radare2/libr/io/p/io_r2web.c" 3 4
 , 
# 57 "project/radare2/libr/io/p/io_r2web.c"
...
static 
# 70 "project/radare2/libr/io/p/io_r2web.c" 3 4
      _Bool 
# 70 "project/radare2/libr/io/p/io_r2web.c"
           __close(RIODesc *fd) {
 if (!fd || !fd->data) {
  return 
# 72 "project/radare2/libr/io/p/io_r2web.c" 3 4
        0
# 72 "project/radare2/libr/io/p/io_r2web.c"
             ;
 }
 RIOR2Web *riom = fd->data;
 
# 75 "project/radare2/libr/io/p/io_r2web.c" 3 4
{ free((void *)
# 75 "project/radare2/libr/io/p/io_r2web.c"
riom->url
# 75 "project/radare2/libr/io/p/io_r2web.c" 3 4
); 
# 75 "project/radare2/libr/io/p/io_r2web.c"
...
# 76 "project/radare2/libr/io/p/io_r2web.c" 3 4
{ free((void *)
# 76 "project/radare2/libr/io/p/io_r2web.c"
fd->data
# 76 "project/radare2/libr/io/p/io_r2web.c" 3 4
); 
# 76 "project/radare2/libr/io/p/io_r2web.c"
...
# 76 "project/radare2/libr/io/p/io_r2web.c"
                 ;
 return 
# 77 "project/radare2/libr/io/p/io_r2web.c" 3 4
       1
# 77 "project/radare2/libr/io/p/io_r2web.c"
           ;
}

static 
# 80 "project/radare2/libr/io/p/io_r2web.c" 3 4
      unsigned long long 
# 80 "project/radare2/libr/io/p/io_r2web.c"
...
# 80 "project/radare2/libr/io/p/io_r2web.c"
 ...
 switch (whence) {
 case 
# 82 "project/radare2/libr/io/p/io_r2web.c" 3 4
     0
# 82 "project/radare2/libr/io/p/io_r2web.c"
             : return offset;
 case 
# 83 "project/radare2/libr/io/p/io_r2web.c" 3 4
     1
# 83 "project/radare2/libr/io/p/io_r2web.c"
             : return io->off + offset;
 case 
# 84 "project/radare2/libr/io/p/io_r2web.c" 3 4
     2
# 84 "project/radare2/libr/io/p/io_r2web.c"
             : return 
# 84 "project/radare2/libr/io/p/io_r2web.c" 3 4
...
static 
# 89 "project/radare2/libr/io/p/io_r2web.c" 3 4
      _Bool 
# 89 "project/radare2/libr/io/p/io_r2web.c"
...
static RIODesc *__open(RIO *io, const char *pathname, int rw, int mode) {
 ...
 if (__plugin_open (io, pathname, 0)) {
  RIOR2Web *mal = 
# 102 "project/radare2/libr/io/p/io_r2web.c" 3 4
                 (
# 102 "project/radare2/libr/io/p/io_r2web.c"
                 RIOR2Web
# 102 "project/radare2/libr/io/p/io_r2web.c" 3 4
                 *)calloc(1,sizeof(
# 102 "project/radare2/libr/io/p/io_r2web.c"
...
# 102 "project/radare2/libr/io/p/io_r2web.c"
  ...
  if (!mal) {
   return 
# 104 "project/radare2/libr/io/p/io_r2web.c" 3 4
         ((void *)0)
# 104 "project/radare2/libr/io/p/io_r2web.c"
             ;
  }
...
# 131 "project/radare2/libr/io/p/io_r2web.c" 3 4
 fprintf(__stderrp,
# 131 "project/radare2/libr/io/p/io_r2web.c"
...
# 131 "project/radare2/libr/io/p/io_r2web.c"
 ...
 return 
# 133 "project/radare2/libr/io/p/io_r2web.c" 3 4
       ((void *)0)
# 133 "project/radare2/libr/io/p/io_r2web.c"
           ;
}
...
static char *__system(RIO *io, RIODesc *fd, const char *command) {
 if (!*command) {
  return 
# 138 "project/radare2/libr/io/p/io_r2web.c" 3 4
        ((void *)0)
# 138 "project/radare2/libr/io/p/io_r2web.c"
            ;
 }
 int code, rlen;
 char *cmd = r_str_uri_encode (command);
 char *url = r_str_newf ("%s/%s", (((RIOR2Web*)(fd)->data)->url), cmd);
 ...
 free (cmd);
 return 
# 150 "project/radare2/libr/io/p/io_r2web.c" 3 4
       ((void *)0)
# 150 "project/radare2/libr/io/p/io_r2web.c"
           ;
}
...
# 168 "project/radare2/libr/io/p/io_r2web.c" 3 4
__attribute__((visibility("default"))) 
# 168 "project/radare2/libr/io/p/io_r2web.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_r2web,
 .version = 
# 171 "project/radare2/libr/io/p/io_r2web.c" 3 4
           "5.5.4"

# 172 "project/radare2/libr/io/p/io_r2web.c"
};
