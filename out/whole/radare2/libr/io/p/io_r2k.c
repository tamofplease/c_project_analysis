# 0 "project/radare2/libr/io/p/io_r2k.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/io/p/io_r2k.c"
...
# 4 "project/radare2/libr/io/p/io_r2k.c" 2
...
# 5 "project/radare2/libr/io/p/io_r2k.c" 2
# 15 "project/radare2/libr/io/p/io_r2k.c"

# 15 "project/radare2/libr/io/p/io_r2k.c"
int r2k_struct;


int r2k__write(RIO *io, RIODesc *fd, const 
# 18 "project/radare2/libr/io/p/io_r2k.c" 3 4
                                          unsigned char 
# 18 "project/radare2/libr/io/p/io_r2k.c"
                                              *buf, int count) {
# 35 "project/radare2/libr/io/p/io_r2k.c"
 io->cb_printf ("TODO: r2k not implemented for this plataform.\n");
 return -1;

}

static int r2k__read(RIO *io, RIODesc *fd, 
# 40 "project/radare2/libr/io/p/io_r2k.c" 3 4
                                          unsigned char 
# 40 "project/radare2/libr/io/p/io_r2k.c"
                                              *buf, int count) {
# 57 "project/radare2/libr/io/p/io_r2k.c"
 io->cb_printf ("TODO: r2k not implemented for this plataform.\n");
 
# 58 "project/radare2/libr/io/p/io_r2k.c" 3 4
__builtin___memset_chk (
# 58 "project/radare2/libr/io/p/io_r2k.c"
buf
# 58 "project/radare2/libr/io/p/io_r2k.c" 3 4
, 
# 58 "project/radare2/libr/io/p/io_r2k.c"
...
static 
# 63 "project/radare2/libr/io/p/io_r2k.c" 3 4
      _Bool 
# 63 "project/radare2/libr/io/p/io_r2k.c"
           r2k__close(RIODesc *fd) {
# 74 "project/radare2/libr/io/p/io_r2k.c"
 
# 74 "project/radare2/libr/io/p/io_r2k.c" 3 4
fprintf(__stderrp,
# 74 "project/radare2/libr/io/p/io_r2k.c"
"TODO: r2k not implemented for this plataform.\n"
# 74 "project/radare2/libr/io/p/io_r2k.c" 3 4
)
# 74 "project/radare2/libr/io/p/io_r2k.c"
                                                           ;
 ...
 return 
# 76 "project/radare2/libr/io/p/io_r2k.c" 3 4
       1
# 76 "project/radare2/libr/io/p/io_r2k.c"
           ;
}

static 
# 79 "project/radare2/libr/io/p/io_r2k.c" 3 4
      unsigned long long 
# 79 "project/radare2/libr/io/p/io_r2k.c"
           r2k__lseek(RIO *io, RIODesc *fd, 
# 79 "project/radare2/libr/io/p/io_r2k.c" 3 4
                                            unsigned long long 
# 79 "project/radare2/libr/io/p/io_r2k.c"
                                                 offset, int whence) {
 return (!whence) ? offset : whence == 1
  ? io->off + offset : 
# 81 "project/radare2/libr/io/p/io_r2k.c" 3 4
                      0xFFFFFFFFFFFFFFFFULL
# 81 "project/radare2/libr/io/p/io_r2k.c"
                              ;
}

static 
# 84 "project/radare2/libr/io/p/io_r2k.c" 3 4
      _Bool 
# 84 "project/radare2/libr/io/p/io_r2k.c"
           r2k__plugin_open(RIO *io, const char *pathname, 
# 84 "project/radare2/libr/io/p/io_r2k.c" 3 4
                                                           _Bool 
# 84 "project/radare2/libr/io/p/io_r2k.c"
                                                                many) {
...
static char *r2k__system(RIO *io, RIODesc *fd, const char *cmd) {
 if (!strcmp (cmd, "")) {
  return 
# 90 "project/radare2/libr/io/p/io_r2k.c" 3 4
        ((void *)0)
# 90 "project/radare2/libr/io/p/io_r2k.c"
            ;
 }
...
# 101 "project/radare2/libr/io/p/io_r2k.c" 3 4
 fprintf(__stderrp,
# 101 "project/radare2/libr/io/p/io_r2k.c"
 "Try: '=!mod'\n    '.=!mod'\n"
# 101 "project/radare2/libr/io/p/io_r2k.c" 3 4
 )
# 101 "project/radare2/libr/io/p/io_r2k.c"
 ...
 return 
# 104 "project/radare2/libr/io/p/io_r2k.c" 3 4
       ((void *)0)
# 104 "project/radare2/libr/io/p/io_r2k.c"
           ;
}
...
static RIODesc *r2k__open(RIO *io, const char *pathname, int rw, int mode) {
 if (!strncmp (pathname, "r2k://", 6)) {
  rw |= 
# 109 "project/radare2/libr/io/p/io_r2k.c" 3 4
       (2|1)
# 109 "project/radare2/libr/io/p/io_r2k.c"
                ;
# 131 "project/radare2/libr/io/p/io_r2k.c"
  io->cb_printf ("Not supported on this platform\n");

 }
 return 
# 134 "project/radare2/libr/io/p/io_r2k.c" 3 4
       ((void *)0)
# 134 "project/radare2/libr/io/p/io_r2k.c"
           ;
}
...
# 152 "project/radare2/libr/io/p/io_r2k.c" 3 4
__attribute__((visibility("default"))) 
# 152 "project/radare2/libr/io/p/io_r2k.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_r2k,
 .version = 
# 155 "project/radare2/libr/io/p/io_r2k.c" 3 4
           "5.5.4"

# 156 "project/radare2/libr/io/p/io_r2k.c"
};
