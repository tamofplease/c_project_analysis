# 0 "project/radare2/libr/io/p/io_gdb.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/io/p/io_gdb.c" 2
...
# 5 "project/radare2/libr/io/p/io_gdb.c" 2
...
# 10 "project/radare2/libr/io/p/io_gdb.c" 2
...
# 11 "project/radare2/libr/io/p/io_gdb.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/gdbclient/responses.h" 1 3 4
# 10 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/gdb/include/gdbclient/responses.h" 3 4
#define RESPONSES_H 
...
# 12 "project/radare2/libr/io/p/io_gdb.c" 2


# 13 "project/radare2/libr/io/p/io_gdb.c"
typedef struct {
 libgdbr_t desc;
} RIOGdb;
...
static 
# 20 "project/radare2/libr/io/p/io_gdb.c" 3 4
      _Bool 
# 20 "project/radare2/libr/io/p/io_gdb.c"
           __close(RIODesc *fd);
static libgdbr_t *desc = 
# 21 "project/radare2/libr/io/p/io_gdb.c" 3 4
                        ((void *)0)
# 21 "project/radare2/libr/io/p/io_gdb.c"
                            ;

static 
# 23 "project/radare2/libr/io/p/io_gdb.c" 3 4
      _Bool 
# 23 "project/radare2/libr/io/p/io_gdb.c"
...
static int debug_gdb_read_at(
# 27 "project/radare2/libr/io/p/io_gdb.c" 3 4
                            unsigned char 
# 27 "project/radare2/libr/io/p/io_gdb.c"
                                *buf, int sz, 
# 27 "project/radare2/libr/io/p/io_gdb.c" 3 4
                                              unsigned long long 
# 27 "project/radare2/libr/io/p/io_gdb.c"
                                                   addr) {
 if (sz < 1 || addr >= 
# 28 "project/radare2/libr/io/p/io_gdb.c" 3 4
                      0xFFFFFFFFFFFFFFFFULL 
# 28 "project/radare2/libr/io/p/io_gdb.c"
                               || !desc) {
  return -1;
 }
...
static int debug_gdb_write_at(const 
# 34 "project/radare2/libr/io/p/io_gdb.c" 3 4
                                   unsigned char 
# 34 "project/radare2/libr/io/p/io_gdb.c"
                                       *buf, int sz, 
# 34 "project/radare2/libr/io/p/io_gdb.c" 3 4
                                                     unsigned long long 
# 34 "project/radare2/libr/io/p/io_gdb.c"
...
# 35 "project/radare2/libr/io/p/io_gdb.c" 3 4
unsigned int 
# 35 "project/radare2/libr/io/p/io_gdb.c"
     x, size_max;
 
# 36 "project/radare2/libr/io/p/io_gdb.c" 3 4
unsigned int 
# 36 "project/radare2/libr/io/p/io_gdb.c"
     packets;
 
# 37 "project/radare2/libr/io/p/io_gdb.c" 3 4
unsigned int 
# 37 "project/radare2/libr/io/p/io_gdb.c"
     last;
 if (sz < 1 || addr >= 
# 38 "project/radare2/libr/io/p/io_gdb.c" 3 4
                      0xFFFFFFFFFFFFFFFFULL 
# 38 "project/radare2/libr/io/p/io_gdb.c"
                               || !desc) {
  return -1;
 }
...
# 44 "project/radare2/libr/io/p/io_gdb.c" 3 4
unsigned long long 
# 44 "project/radare2/libr/io/p/io_gdb.c"
     offset = 0;
...
static RIODesc *__open(RIO *io, const char *file, int rw, int mode) {
 RIODesc *riogdb = 
# 55 "project/radare2/libr/io/p/io_gdb.c" 3 4
                  ((void *)0)
# 55 "project/radare2/libr/io/p/io_gdb.c"
                      ;
 RIOGdb *riog;
 char host[128], *port, *pid;
 int i_port = -1;
 
# 59 "project/radare2/libr/io/p/io_gdb.c" 3 4
_Bool 
# 59 "project/radare2/libr/io/p/io_gdb.c"
     isdev = 
# 59 "project/radare2/libr/io/p/io_gdb.c" 3 4
             0
# 59 "project/radare2/libr/io/p/io_gdb.c"
 ...
 if (!__plugin_open (io, file, 0)) {
  return 
# 62 "project/radare2/libr/io/p/io_gdb.c" 3 4
        ((void *)0)
# 62 "project/radare2/libr/io/p/io_gdb.c"
            ;
 }
 
# 64 "project/radare2/libr/io/p/io_gdb.c" 3 4
__builtin___strncpy_chk (
# 64 "project/radare2/libr/io/p/io_gdb.c"
host
# 64 "project/radare2/libr/io/p/io_gdb.c" 3 4
, 
# 64 "project/radare2/libr/io/p/io_gdb.c"
...
# 64 "project/radare2/libr/io/p/io_gdb.c"
 ...
 if (host[0] == '/') {
  isdev = 
# 67 "project/radare2/libr/io/p/io_gdb.c" 3 4
         1
# 67 "project/radare2/libr/io/p/io_gdb.c"
             ;
 }
...
# 81 "project/radare2/libr/io/p/io_gdb.c" 3 4
  fprintf(__stderrp,
# 81 "project/radare2/libr/io/p/io_gdb.c"
...
# 81 "project/radare2/libr/io/p/io_gdb.c"
                                           ;
   return 
# 82 "project/radare2/libr/io/p/io_gdb.c" 3 4
         ((void *)0)
# 82 "project/radare2/libr/io/p/io_gdb.c"
             ;
  }
...
# 87 "project/radare2/libr/io/p/io_gdb.c" 3 4
  fprintf(__stderrp,
# 87 "project/radare2/libr/io/p/io_gdb.c"
...
# 89 "project/radare2/libr/io/p/io_gdb.c"
                                                                      ;
   return 
# 90 "project/radare2/libr/io/p/io_gdb.c" 3 4
         ((void *)0)
# 90 "project/radare2/libr/io/p/io_gdb.c"
             ;
  }
  *port = '\0';
  port++;
 ...
 if (!(riog = 
# 108 "project/radare2/libr/io/p/io_gdb.c" 3 4
             (
# 108 "project/radare2/libr/io/p/io_gdb.c"
             RIOGdb
# 108 "project/radare2/libr/io/p/io_gdb.c" 3 4
             *)calloc(1,sizeof(
# 108 "project/radare2/libr/io/p/io_gdb.c"
...
# 108 "project/radare2/libr/io/p/io_gdb.c"
  ...
  return 
# 109 "project/radare2/libr/io/p/io_gdb.c" 3 4
        ((void *)0)
# 109 "project/radare2/libr/io/p/io_gdb.c"
            ;
 }
 gdbr_init (&riog->desc, 
# 111 "project/radare2/libr/io/p/io_gdb.c" 3 4
                        0
# 111 "project/radare2/libr/io/p/io_gdb.c"
                             );

 if (gdbr_connect (&riog->desc, host, i_port) == 0) {
  __close (
# 114 "project/radare2/libr/io/p/io_gdb.c" 3 4
          ((void *)0)
# 114 "project/radare2/libr/io/p/io_gdb.c"
              );
...
# 120 "project/radare2/libr/io/p/io_gdb.c" 3 4
   fprintf(__stderrp,
# 120 "project/radare2/libr/io/p/io_gdb.c"
...
# 120 "project/radare2/libr/io/p/io_gdb.c"
                                                        ;
    return 
# 121 "project/radare2/libr/io/p/io_gdb.c" 3 4
          ((void *)0)
# 121 "project/radare2/libr/io/p/io_gdb.c"
              ;
   }
  } else if ((i_pid = desc->pid) < 0) {
   i_pid = -1;
  }
  riogdb = r_io_desc_new (io, &r_io_plugin_gdb, file, 
# 126 "project/radare2/libr/io/p/io_gdb.c" 3 4
                                                     (4|2|1)
# 126 "project/radare2/libr/io/p/io_gdb.c"
                                                               , mode, riog);
 }
...
# 132 "project/radare2/libr/io/p/io_gdb.c" 3 4
 fprintf(__stderrp,
# 132 "project/radare2/libr/io/p/io_gdb.c"
...
# 138 "project/radare2/libr/io/p/io_gdb.c" 3 4
                                              unsigned char 
# 138 "project/radare2/libr/io/p/io_gdb.c"
                                                  *buf, int count) {
 
# 139 "project/radare2/libr/io/p/io_gdb.c" 3 4
unsigned long long 
# 139 "project/radare2/libr/io/p/io_gdb.c"
     addr = io->off;
 if (!desc || !desc->data) {
  return -1;
 }
...
static 
# 146 "project/radare2/libr/io/p/io_gdb.c" 3 4
      unsigned long long 
# 146 "project/radare2/libr/io/p/io_gdb.c"
...
# 146 "project/radare2/libr/io/p/io_gdb.c"
 ...
 switch (whence) {
 case 
# 148 "project/radare2/libr/io/p/io_gdb.c" 3 4
     0
# 148 "project/radare2/libr/io/p/io_gdb.c"
                  :
  io->off = offset;
  break;
 case 
# 151 "project/radare2/libr/io/p/io_gdb.c" 3 4
     1
# 151 "project/radare2/libr/io/p/io_gdb.c"
                  :
  io->off += offset;
  break;
 case 
# 154 "project/radare2/libr/io/p/io_gdb.c" 3 4
     2
# 154 "project/radare2/libr/io/p/io_gdb.c"
                  :
  io->off = 
# 155 "project/radare2/libr/io/p/io_gdb.c" 3 4
           ((long long)0x7FFFFFFFFFFFFFFFULL)
# 155 "project/radare2/libr/io/p/io_gdb.c"
                   ;
 }
 return io->off;
}
...
# 160 "project/radare2/libr/io/p/io_gdb.c" 3 4
                                       unsigned char 
# 160 "project/radare2/libr/io/p/io_gdb.c"
                                           *buf, int count) {
 if (!io || !fd || !buf || count < 1) {
  return -1;
 }
 
# 164 "project/radare2/libr/io/p/io_gdb.c" 3 4
__builtin___memset_chk (
# 164 "project/radare2/libr/io/p/io_gdb.c"
buf
# 164 "project/radare2/libr/io/p/io_gdb.c" 3 4
, 
# 164 "project/radare2/libr/io/p/io_gdb.c"
...
# 165 "project/radare2/libr/io/p/io_gdb.c" 3 4
unsigned long long 
# 165 "project/radare2/libr/io/p/io_gdb.c"
     addr = io->off;
 if (!desc || !desc->data) {
  return -1;
 }
...
static 
# 172 "project/radare2/libr/io/p/io_gdb.c" 3 4
      _Bool 
# 172 "project/radare2/libr/io/p/io_gdb.c"
           __close(RIODesc *fd) {
 if (fd) {
  
# 174 "project/radare2/libr/io/p/io_gdb.c" 3 4
 { free((void *)
# 174 "project/radare2/libr/io/p/io_gdb.c"
 fd->name
# 174 "project/radare2/libr/io/p/io_gdb.c" 3 4
 ); 
# 174 "project/radare2/libr/io/p/io_gdb.c"
...
# 178 "project/radare2/libr/io/p/io_gdb.c" 3 4
{ free((void *)
# 178 "project/radare2/libr/io/p/io_gdb.c"
desc
# 178 "project/radare2/libr/io/p/io_gdb.c" 3 4
); 
# 178 "project/radare2/libr/io/p/io_gdb.c"
...
# 178 "project/radare2/libr/io/p/io_gdb.c"
             ;
 return 
# 179 "project/radare2/libr/io/p/io_gdb.c" 3 4
       1
# 179 "project/radare2/libr/io/p/io_gdb.c"
           ;
}
...
# 199 "project/radare2/libr/io/p/io_gdb.c"
}
...
# 206 "project/radare2/libr/io/p/io_gdb.c" 3 4
                                           _Bool 
# 206 "project/radare2/libr/io/p/io_gdb.c"
                                                vcont);

static char *__system(RIO *io, RIODesc *fd, const char *cmd) {
 if (!desc) {
  return 
# 210 "project/radare2/libr/io/p/io_gdb.c" 3 4
        ((void *)0)
# 210 "project/radare2/libr/io/p/io_gdb.c"
            ;
 }
 if (!*cmd) {
  return 
# 213 "project/radare2/libr/io/p/io_gdb.c" 3 4
        ((void *)0)
# 213 "project/radare2/libr/io/p/io_gdb.c"
            ;
 }
 if (cmd[0] == '?' || !strcmp (cmd, "help")) {
  
# 216 "project/radare2/libr/io/p/io_gdb.c" 3 4
 fprintf(__stderrp,
# 216 "project/radare2/libr/io/p/io_gdb.c"
...
# 229 "project/radare2/libr/io/p/io_gdb.c"
                                                   ;
  
# 230 "project/radare2/libr/io/p/io_gdb.c"
 return 
# 230 "project/radare2/libr/io/p/io_gdb.c" 3 4
        ((void *)0)
# 230 "project/radare2/libr/io/p/io_gdb.c"
            ;
 }
 if (r_str_startswith (cmd, "pktsz")) {
  ...
  if (!isdigit ((
# 234 "project/radare2/libr/io/p/io_gdb.c" 3 4
                unsigned char
# 234 "project/radare2/libr/io/p/io_gdb.c"
                   )*ptr)) {
   io->cb_printf ("packet size: %u bytes\n",
           desc->stub_features.pkt_sz);
   return 
# 237 "project/radare2/libr/io/p/io_gdb.c" 3 4
         ((void *)0)
# 237 "project/radare2/libr/io/p/io_gdb.c"
             ;
  }
  
# 239 "project/radare2/libr/io/p/io_gdb.c" 3 4
 unsigned int 
# 239 "project/radare2/libr/io/p/io_gdb.c"
      pktsz;
  if (!(pktsz = (
# 240 "project/radare2/libr/io/p/io_gdb.c" 3 4
                unsigned int
# 240 "project/radare2/libr/io/p/io_gdb.c"
                    ) strtoul (ptr, 
# 240 "project/radare2/libr/io/p/io_gdb.c" 3 4
                                    ((void *)0)
# 240 "project/radare2/libr/io/p/io_gdb.c"
   ...
   return 
# 242 "project/radare2/libr/io/p/io_gdb.c" 3 4
         ((void *)0)
# 242 "project/radare2/libr/io/p/io_gdb.c"
             ;
  }
  desc->stub_features.pkt_sz = 
# 244 "project/radare2/libr/io/p/io_gdb.c" 3 4
                              (((
# 244 "project/radare2/libr/io/p/io_gdb.c"
                              pktsz
# 244 "project/radare2/libr/io/p/io_gdb.c" 3 4
                              )>(
# 244 "project/radare2/libr/io/p/io_gdb.c"
...
# 244 "project/radare2/libr/io/p/io_gdb.c"
                                              ;
  return 
# 245 "project/radare2/libr/io/p/io_gdb.c" 3 4
        ((void *)0)
# 245 "project/radare2/libr/io/p/io_gdb.c"
            ;
 }
 if (r_str_startswith (cmd, "detach")) {
  int res;
  if (!isspace ((
# 249 "project/radare2/libr/io/p/io_gdb.c" 3 4
                unsigned char
# 249 "project/radare2/libr/io/p/io_gdb.c"
                   )cmd[6]) || !desc->stub_features.multiprocess) {
   res = gdbr_detach (desc) >= 0;
  } else {
   int pid = 0;
   cmd = r_str_trim_head_ro (cmd + 6);
   if (!*cmd || !(pid = strtoul (cmd, 
# 254 "project/radare2/libr/io/p/io_gdb.c" 3 4
                                     ((void *)0)
# 254 "project/radare2/libr/io/p/io_gdb.c"
                                         , 10))) {
    res = gdbr_detach (desc) >= 0;
   } else {
...
# 260 "project/radare2/libr/io/p/io_gdb.c" 3 4
 fprintf(__stderrp,
# 260 "project/radare2/libr/io/p/io_gdb.c"
 "%d\n", res
# 260 "project/radare2/libr/io/p/io_gdb.c" 3 4
 )
# 260 "project/radare2/libr/io/p/io_gdb.c"
                      ;
  return 
# 261 "project/radare2/libr/io/p/io_gdb.c" 3 4
        ((void *)0)
# 261 "project/radare2/libr/io/p/io_gdb.c"
            ;
 }
...
# 266 "project/radare2/libr/io/p/io_gdb.c" 3 4
                           0
# 266 "project/radare2/libr/io/p/io_gdb.c"
                                );
   desc->data[desc->data_len] = '\0';
   io->cb_printf ("reply:\n%s\n", desc->data);
   if (!desc->no_ack) {
    
# 270 "project/radare2/libr/io/p/io_gdb.c" 3 4
   fprintf(__stderrp,
# 270 "project/radare2/libr/io/p/io_gdb.c"
   "[waiting for ack]\n"
# 270 "project/radare2/libr/io/p/io_gdb.c" 3 4
   )
# 270 "project/radare2/libr/io/p/io_gdb.c"
  ...
  return 
# 274 "project/radare2/libr/io/p/io_gdb.c" 3 4
        ((void *)0)
# 274 "project/radare2/libr/io/p/io_gdb.c"
            ;
 }
 if (r_str_startswith (cmd, "rd")) {
  ...
  pj_free (pj);
  return 
# 284 "project/radare2/libr/io/p/io_gdb.c" 3 4
        ((void *)0)
# 284 "project/radare2/libr/io/p/io_gdb.c"
            ;
 }
 if (r_str_startswith (cmd, "dsb")) {
  if (!desc->stub_features.ReverseStep) {
   
# 288 "project/radare2/libr/io/p/io_gdb.c" 3 4
  fprintf(__stderrp,
# 288 "project/radare2/libr/io/p/io_gdb.c"
...
# 288 "project/radare2/libr/io/p/io_gdb.c"
                                                                                    ;
   return 
# 289 "project/radare2/libr/io/p/io_gdb.c" 3 4
         ((void *)0)
# 289 "project/radare2/libr/io/p/io_gdb.c"
             ;
  }
  gdbr_lock_enter (desc);
  if (send_msg (desc, "bs") >= 0) {
   (void)read_packet (desc, 
# 293 "project/radare2/libr/io/p/io_gdb.c" 3 4
                           0
# 293 "project/radare2/libr/io/p/io_gdb.c"
                                );
   desc->data[desc->data_len] = '\0';
   if (!desc->no_ack) {
    
# 296 "project/radare2/libr/io/p/io_gdb.c" 3 4
   fprintf(__stderrp,
# 296 "project/radare2/libr/io/p/io_gdb.c"
   "[waiting for ack]\n"
# 296 "project/radare2/libr/io/p/io_gdb.c" 3 4
   )
# 296 "project/radare2/libr/io/p/io_gdb.c"
...
# 299 "project/radare2/libr/io/p/io_gdb.c" 3 4
                                     0
# 299 "project/radare2/libr/io/p/io_gdb.c"
                                          ) {
     
# 300 "project/radare2/libr/io/p/io_gdb.c" 3 4
    fprintf(__stderrp,
# 300 "project/radare2/libr/io/p/io_gdb.c"
    "Thread (%d) stopped for an invalid reason: %d\n", desc->stop_reason.thread.tid, desc->stop_reason.reason
# 300 "project/radare2/libr/io/p/io_gdb.c" 3 4
    )
                                                             
# 301 "project/radare2/libr/io/p/io_gdb.c"
                                                            ;
    }
   }
  ...
  gdbr_lock_leave (desc);
  return 
# 307 "project/radare2/libr/io/p/io_gdb.c" 3 4
        ((void *)0)
# 307 "project/radare2/libr/io/p/io_gdb.c"
            ;
 }
 if (r_str_startswith (cmd, "dcb")) {
  if (!desc->stub_features.ReverseContinue) {
   
# 311 "project/radare2/libr/io/p/io_gdb.c" 3 4
  fprintf(__stderrp,
# 311 "project/radare2/libr/io/p/io_gdb.c"
...
# 311 "project/radare2/libr/io/p/io_gdb.c"
                                                                                    ;
   return 
# 312 "project/radare2/libr/io/p/io_gdb.c" 3 4
         ((void *)0)
# 312 "project/radare2/libr/io/p/io_gdb.c"
             ;
  }
  gdbr_lock_enter (desc);
  if (send_msg (desc, "bc") >= 0) {
   (void)read_packet (desc, 
# 316 "project/radare2/libr/io/p/io_gdb.c" 3 4
                           0
# 316 "project/radare2/libr/io/p/io_gdb.c"
                                );
   desc->data[desc->data_len] = '\0';
   if (!desc->no_ack) {
    
# 319 "project/radare2/libr/io/p/io_gdb.c" 3 4
   fprintf(__stderrp,
# 319 "project/radare2/libr/io/p/io_gdb.c"
   "[waiting for ack]\n"
# 319 "project/radare2/libr/io/p/io_gdb.c" 3 4
   )
# 319 "project/radare2/libr/io/p/io_gdb.c"
    ...
    handle_stop_reason (desc);
    if (desc->stop_reason.is_valid == 
# 322 "project/radare2/libr/io/p/io_gdb.c" 3 4
                                     0
# 322 "project/radare2/libr/io/p/io_gdb.c"
                                          ) {
     
# 323 "project/radare2/libr/io/p/io_gdb.c" 3 4
    fprintf(__stderrp,
# 323 "project/radare2/libr/io/p/io_gdb.c"
    "Thread (%d) stopped for an invalid reason: %d\n", desc->stop_reason.thread.tid, desc->stop_reason.reason
# 323 "project/radare2/libr/io/p/io_gdb.c" 3 4
    )
                                                             
# 324 "project/radare2/libr/io/p/io_gdb.c"
                                                            ;
    }
   }
   gdbr_invalidate_reg_cache ();
  ...
  gdbr_lock_leave (desc);
  return 
# 330 "project/radare2/libr/io/p/io_gdb.c" 3 4
        ((void *)0)
# 330 "project/radare2/libr/io/p/io_gdb.c"
            ;
 }
 ...
 if (r_str_startswith (cmd, "monitor")) {
  ...
  if (!isspace ((
# 341 "project/radare2/libr/io/p/io_gdb.c" 3 4
                unsigned char
# 341 "project/radare2/libr/io/p/io_gdb.c"
                   )cmd[7])) {
   qrcmd = "help";
  }
  if (gdbr_send_qRcmd (desc, qrcmd, io->cb_printf) < 0) {
   
# 345 "project/radare2/libr/io/p/io_gdb.c" 3 4
  fprintf(__stderrp,
# 345 "project/radare2/libr/io/p/io_gdb.c"
  "remote error\n"
# 345 "project/radare2/libr/io/p/io_gdb.c" 3 4
  )
# 345 "project/radare2/libr/io/p/io_gdb.c"
                            ;
   return 
# 346 "project/radare2/libr/io/p/io_gdb.c" 3 4
         ((void *)0)
# 346 "project/radare2/libr/io/p/io_gdb.c"
             ;
  }
  return 
# 348 "project/radare2/libr/io/p/io_gdb.c" 3 4
        ((void *)0)
# 348 "project/radare2/libr/io/p/io_gdb.c"
            ;
 }
 if (r_str_startswith (cmd, "inv.reg")) {
  gdbr_invalidate_reg_cache ();
  return 
# 352 "project/radare2/libr/io/p/io_gdb.c" 3 4
        ((void *)0)
# 352 "project/radare2/libr/io/p/io_gdb.c"
            ;
 }
 if (r_str_startswith (cmd, "exec_file")) {
  ...
  char *file;
  if (!isspace ((
# 357 "project/radare2/libr/io/p/io_gdb.c" 3 4
                unsigned char
# 357 "project/radare2/libr/io/p/io_gdb.c"
                   )*ptr)) {
   file = gdbr_exec_file_read (desc, 0);
  } else {
   while (isspace ((
# 360 "project/radare2/libr/io/p/io_gdb.c" 3 4
                   unsigned char
# 360 "project/radare2/libr/io/p/io_gdb.c"
                      )*ptr)) {
    ptr++;
   }
   if (isdigit ((
# 363 "project/radare2/libr/io/p/io_gdb.c" 3 4
                unsigned char
# 363 "project/radare2/libr/io/p/io_gdb.c"
                   )*ptr)) {
    int pid = atoi (ptr);
  ...
  if (!file) {
   return 
# 371 "project/radare2/libr/io/p/io_gdb.c" 3 4
         ((void *)0)
# 371 "project/radare2/libr/io/p/io_gdb.c"
             ;
  }
  io->cb_printf ("%s\n", file);
  return file;
 ...
 if (r_str_startswith (cmd, "retries")) {
  int num_retries;
  if (isspace ((
# 379 "project/radare2/libr/io/p/io_gdb.c" 3 4
               unsigned char
# 379 "project/radare2/libr/io/p/io_gdb.c"
                  )cmd[7]) && isdigit ((
# 379 "project/radare2/libr/io/p/io_gdb.c" 3 4
                                        unsigned char
# 379 "project/radare2/libr/io/p/io_gdb.c"
   ...
   return 
# 383 "project/radare2/libr/io/p/io_gdb.c" 3 4
         ((void *)0)
# 383 "project/radare2/libr/io/p/io_gdb.c"
             ;
  }
  io->cb_printf ("num_retries: %d byte(s)\n", desc->page_size);
  return 
# 386 "project/radare2/libr/io/p/io_gdb.c" 3 4
        ((void *)0)
# 386 "project/radare2/libr/io/p/io_gdb.c"
            ;
 }
 if (r_str_startswith (cmd, "page_size")) {
  int page_size;
  if (isspace ((
# 390 "project/radare2/libr/io/p/io_gdb.c" 3 4
               unsigned char
# 390 "project/radare2/libr/io/p/io_gdb.c"
                  )cmd[9]) && isdigit ((
# 390 "project/radare2/libr/io/p/io_gdb.c" 3 4
                                        unsigned char
# 390 "project/radare2/libr/io/p/io_gdb.c"
   ...
   return 
# 394 "project/radare2/libr/io/p/io_gdb.c" 3 4
         ((void *)0)
# 394 "project/radare2/libr/io/p/io_gdb.c"
             ;
  }
  io->cb_printf ("page size: %d byte(s)\n", desc->page_size);
  return 
# 397 "project/radare2/libr/io/p/io_gdb.c" 3 4
        ((void *)0)
# 397 "project/radare2/libr/io/p/io_gdb.c"
            ;
 }

 if (!strcmp (cmd, "baddr")) {
  desc->get_baddr = 
# 401 "project/radare2/libr/io/p/io_gdb.c" 3 4
                   1
# 401 "project/radare2/libr/io/p/io_gdb.c"
                       ;
  return 
# 402 "project/radare2/libr/io/p/io_gdb.c" 3 4
        ((void *)0)
# 402 "project/radare2/libr/io/p/io_gdb.c"
            ;
 }
 
# 404 "project/radare2/libr/io/p/io_gdb.c" 3 4
fprintf(__stderrp,
# 404 "project/radare2/libr/io/p/io_gdb.c"
"Try: '=!?'\n"
# 404 "project/radare2/libr/io/p/io_gdb.c" 3 4
)
# 404 "project/radare2/libr/io/p/io_gdb.c"
                        ;
 return 
# 405 "project/radare2/libr/io/p/io_gdb.c" 3 4
       ((void *)0)
# 405 "project/radare2/libr/io/p/io_gdb.c"
           ;
}
...
RIOPlugin r_io_plugin_gdb = {
 ...
 .gettid = __gettid,
 .isdbg = 
# 423 "project/radare2/libr/io/p/io_gdb.c" 3 4
         1

# 424 "project/radare2/libr/io/p/io_gdb.c"
};



# 427 "project/radare2/libr/io/p/io_gdb.c" 3 4
__attribute__((visibility("default"))) 
# 427 "project/radare2/libr/io/p/io_gdb.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_gdb,
 .version = 
# 430 "project/radare2/libr/io/p/io_gdb.c" 3 4
           "5.5.4"

# 431 "project/radare2/libr/io/p/io_gdb.c"
};
