# 0 "project/radare2/libr/io/p/io_gprobe.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/io/p/io_gprobe.c"
...
# 4 "project/radare2/libr/io/p/io_gprobe.c" 2
...
# 5 "project/radare2/libr/io/p/io_gprobe.c" 2
...
# 7 "project/radare2/libr/io/p/io_gprobe.c" 2

#define USE_OWNTIMER 1

# 1 "project/radare2/libr/io/p/io_gprobe.h" 1
#define Timercmp(tvp,uvp,cmp) (((tvp)->tv_sec == (uvp)->tv_sec) ? ((tvp)->tv_usec cmp (uvp)->tv_usec) : ((tvp)->tv_sec cmp (uvp)->tv_sec))



#define Timeradd(tvp,uvp,vvp) do { (vvp)->tv_sec = (tvp)->tv_sec + (uvp)->tv_sec; (vvp)->tv_usec = (tvp)->tv_usec + (uvp)->tv_usec; if ((vvp)->tv_usec >= 1000000) { (vvp)->tv_sec++; (vvp)->tv_usec -= 1000000; } } while (0)
# 14 "project/radare2/libr/io/p/io_gprobe.h"
#define Timersub(tvp,uvp,vvp) do { (vvp)->tv_sec = (tvp)->tv_sec - (uvp)->tv_sec; (vvp)->tv_usec = (tvp)->tv_usec - (uvp)->tv_usec; if ((vvp)->tv_usec < 0) { (vvp)->tv_sec--; (vvp)->tv_usec += 1000000; } } while (0)
# 11 "project/radare2/libr/io/p/io_gprobe.c" 2
# 25 "project/radare2/libr/io/p/io_gprobe.c"
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/errno.h" 1 3 4
# 26 "project/radare2/libr/io/p/io_gprobe.c" 2
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/fcntl.h" 1 3 4
# 27 "project/radare2/libr/io/p/io_gprobe.c" 2



# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/ioctl.h" 1 3 4
# 31 "project/radare2/libr/io/p/io_gprobe.c" 2
...
# 47 "project/radare2/libr/io/p/io_gprobe.c"
struct gport {
 const char *name;
# 60 "project/radare2/libr/io/p/io_gprobe.c"
 int fd;

 int (*send_request) (struct gport *port, RBuffer *request);
 int (*get_reply) (struct gport *port, 
# 63 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                      unsigned char 
# 63 "project/radare2/libr/io/p/io_gprobe.c"
                                          cmd, RBuffer *reply);
 void (*frame) (RBuffer *frame);

 
# 66 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned int 
# 66 "project/radare2/libr/io/p/io_gprobe.c"
     max_rx_size;
 
# 67 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned int 
# 67 "project/radare2/libr/io/p/io_gprobe.c"
     max_tx_size;
};
...
# 72 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned long long 
# 72 "project/radare2/libr/io/p/io_gprobe.c"
     offset;
} RIOGprobe;
...
static 
# 88 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      unsigned char 
# 88 "project/radare2/libr/io/p/io_gprobe.c"
          gprobe_checksum_i2c (const 
# 88 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                     unsigned char 
# 88 "project/radare2/libr/io/p/io_gprobe.c"
                                         *p, unsigned int size, 
...
# 89 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned char 
# 89 "project/radare2/libr/io/p/io_gprobe.c"
    res = initial;
 unsigned int k;
...
# 100 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned char 
# 100 "project/radare2/libr/io/p/io_gprobe.c"
    size = r_buf_size (frame) + 1;
 
# 101 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned char 
# 101 "project/radare2/libr/io/p/io_gprobe.c"
    header[] = {0x51, 0x80 + size + 3, 0xc2, 0x00, 0x00};

 r_buf_prepend_bytes (frame, &size, 1);
 r_buf_prepend_bytes (frame, header, sizeof (header));

 
# 106 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned long long 
# 106 "project/radare2/libr/io/p/io_gprobe.c"
     tmpsz;
 const 
# 107 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      unsigned char 
# 107 "project/radare2/libr/io/p/io_gprobe.c"
          *tmp = r_buf_data (frame, &tmpsz);
 
# 108 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned char 
# 108 "project/radare2/libr/io/p/io_gprobe.c"
    checksum = gprobe_checksum_i2c (tmp, tmpsz, 0x6e);

 r_buf_append_bytes (frame, &checksum, 1);
}

static int gprobe_get_reply_i2c(struct gport *port, 
# 113 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                                   unsigned char 
# 113 "project/radare2/libr/io/p/io_gprobe.c"
                                                       cmd, RBuffer *reply) {
 
# 114 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned char 
# 114 "project/radare2/libr/io/p/io_gprobe.c"
    buf[131];
 int count;
 int ddc2bi3_len;
 
# 117 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned char 
# 117 "project/radare2/libr/io/p/io_gprobe.c"
    addr = 0x50;
 
# 118 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned char 
# 118 "project/radare2/libr/io/p/io_gprobe.c"
    checksum;
...
# 144 "project/radare2/libr/io/p/io_gprobe.c" 3 4
 fprintf(__stderrp,
# 144 "project/radare2/libr/io/p/io_gprobe.c"
...
# 153 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned long long 
# 153 "project/radare2/libr/io/p/io_gprobe.c"
     tmpsz;
 const 
# 154 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      unsigned char 
# 154 "project/radare2/libr/io/p/io_gprobe.c"
          *tmp = r_buf_data (request, &tmpsz);
...
# 169 "project/radare2/libr/io/p/io_gprobe.c" 3 4
__builtin___snprintf_chk (
# 169 "project/radare2/libr/io/p/io_gprobe.c"
filename
# 169 "project/radare2/libr/io/p/io_gprobe.c" 3 4
, 
# 169 "project/radare2/libr/io/p/io_gprobe.c"
...
# 169 "project/radare2/libr/io/p/io_gprobe.c"
 ...
 int file = r_sandbox_open (filename, 
# 171 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                     0x0002
# 171 "project/radare2/libr/io/p/io_gprobe.c"
                                           , 0);

 if (file < 0 && (
# 173 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                 (*__error()) 
# 173 "project/radare2/libr/io/p/io_gprobe.c"
                       == 
# 173 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                          2 
# 173 "project/radare2/libr/io/p/io_gprobe.c"
...
# 174 "project/radare2/libr/io/p/io_gprobe.c" 3 4
 __builtin___sprintf_chk (
# 174 "project/radare2/libr/io/p/io_gprobe.c"
 filename
# 174 "project/radare2/libr/io/p/io_gprobe.c" 3 4
 , 0, __builtin_object_size (
# 174 "project/radare2/libr/io/p/io_gprobe.c"
...
# 174 "project/radare2/libr/io/p/io_gprobe.c"
                                          ;
  file = r_sandbox_open (filename, 
# 175 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                  0x0002
# 175 "project/radare2/libr/io/p/io_gprobe.c"
                                        , 0);
 }
 if (file < 0) {
  return -1;
 }
 if (ioctl (file, 0x0703, 0x6e >> 1) < 0) {
...
# 209 "project/radare2/libr/io/p/io_gprobe.c"
 if (close (port->fd) == -1) {
  return -1;
 }
...
# 246 "project/radare2/libr/io/p/io_gprobe.c"
static int sp_open (struct gport *port) {
# 344 "project/radare2/libr/io/p/io_gprobe.c"
 struct termios tty = {0};

 if ((port->fd = r_sandbox_open (port->name, 
# 346 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                            0x00000004 
# 346 "project/radare2/libr/io/p/io_gprobe.c"
                                                       | 
# 346 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                                         0x00020000 
# 346 "project/radare2/libr/io/p/io_gprobe.c"
...
# 346 "project/radare2/libr/io/p/io_gprobe.c"
 ...
 cfsetospeed (&tty, 
# 355 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                   115200
# 355 "project/radare2/libr/io/p/io_gprobe.c"
                          );
 cfsetispeed (&tty, 
# 356 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                   115200
# 356 "project/radare2/libr/io/p/io_gprobe.c"
                          );

 tty.c_cflag = (tty.c_cflag & ~
# 358 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                              0x00000300
# 358 "project/radare2/libr/io/p/io_gprobe.c"
                                   ) | 
# 358 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                       0x00000300
# 358 "project/radare2/libr/io/p/io_gprobe.c"
                                          ;
 tty.c_iflag &= ~
# 359 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                0x00000001
# 359 "project/radare2/libr/io/p/io_gprobe.c"
                      ;
 tty.c_lflag = 0;
 tty.c_oflag = 0;
 tty.c_cc[
# 362 "project/radare2/libr/io/p/io_gprobe.c" 3 4
         16
# 362 "project/radare2/libr/io/p/io_gprobe.c"
             ] = 0;
 tty.c_cc[
# 363 "project/radare2/libr/io/p/io_gprobe.c" 3 4
         17
# 363 "project/radare2/libr/io/p/io_gprobe.c"
              ] = 0;
 tty.c_iflag &= ~(
# 364 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                 0x00000200 
# 364 "project/radare2/libr/io/p/io_gprobe.c"
                      | 
# 364 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                        0x00000400 
# 364 "project/radare2/libr/io/p/io_gprobe.c"
...
# 364 "project/radare2/libr/io/p/io_gprobe.c"
 ...
 tty.c_cflag |= (
# 366 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                0x00008000 
# 366 "project/radare2/libr/io/p/io_gprobe.c"
                       | 
# 366 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                         0x00000800
# 366 "project/radare2/libr/io/p/io_gprobe.c"
 ...
 tty.c_cflag &= ~(
# 367 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                 0x00001000 
# 367 "project/radare2/libr/io/p/io_gprobe.c"
                        | 
# 367 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                          0x00002000
# 367 "project/radare2/libr/io/p/io_gprobe.c"
 ...
 tty.c_cflag &= ~
# 368 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                0x00000400
# 368 "project/radare2/libr/io/p/io_gprobe.c"
                      ;

 tty.c_cflag &= ~
# 370 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                (0x00010000 | 0x00020000)
# 370 "project/radare2/libr/io/p/io_gprobe.c"
                       ;




 if (tcsetattr (port->fd, 
# 375 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                         0
# 375 "project/radare2/libr/io/p/io_gprobe.c"
                                , &tty) != 0) {
  return -1;
 }
...
# 407 "project/radare2/libr/io/p/io_gprobe.c"
static int sp_blocking_read (struct gport *port, void *buf,
        size_t count, unsigned int timeout_ms) {
# 440 "project/radare2/libr/io/p/io_gprobe.c"
 size_t bytes_read = 0;
 ...
 if (timeout_ms) {
  ...
  gettimeofday (&start, 
# 449 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                       ((void *)0)
# 449 "project/radare2/libr/io/p/io_gprobe.c"
                           );

  delta.tv_sec = timeout_ms / 1000;
  delta.tv_usec = (timeout_ms % 1000) * 1000;

  do { (&end)->tv_sec = (&start)->tv_sec + (&delta)->tv_sec; (&end)->tv_usec = (&start)->tv_usec + (&delta)->tv_usec; if ((&end)->tv_usec >= 1000000) { (&end)->tv_sec++; (&end)->tv_usec -= 1000000; } } while (0);
 }

 
# 457 "project/radare2/libr/io/p/io_gprobe.c" 3 4
__builtin_bzero(
# 457 "project/radare2/libr/io/p/io_gprobe.c"
&fds
# 457 "project/radare2/libr/io/p/io_gprobe.c" 3 4
, sizeof(*(
# 457 "project/radare2/libr/io/p/io_gprobe.c"
...
# 458 "project/radare2/libr/io/p/io_gprobe.c" 3 4
__darwin_fd_set((
# 458 "project/radare2/libr/io/p/io_gprobe.c"
port->fd
# 458 "project/radare2/libr/io/p/io_gprobe.c" 3 4
), (
# 458 "project/radare2/libr/io/p/io_gprobe.c"
...
# 458 "project/radare2/libr/io/p/io_gprobe.c"
 ...
 while (bytes_read < count) {
  ...
  if (timeout_ms && started) {
   gettimeofday (&now, 
# 468 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                      ((void *)0)
# 468 "project/radare2/libr/io/p/io_gprobe.c"
                          );
   if ((((&now)->tv_sec == (&end)->tv_sec) ? ((&now)->tv_usec > (&end)->tv_usec) : ((&now)->tv_sec > (&end)->tv_sec))) {

    break;
   }
   do { (&delta)->tv_sec = (&end)->tv_sec - (&now)->tv_sec; (&delta)->tv_usec = (&end)->tv_usec - (&now)->tv_usec; if ((&delta)->tv_usec < 0) { (&delta)->tv_sec--; (&delta)->tv_usec += 1000000; } } while (0);
  }
  result = select (port->fd + 1, &fds, 
# 475 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                      ((void *)0)
# 475 "project/radare2/libr/io/p/io_gprobe.c"
                                          , 
# 475 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                            ((void *)0)
# 475 "project/radare2/libr/io/p/io_gprobe.c"
...
# 475 "project/radare2/libr/io/p/io_gprobe.c"
  ...
  if (result < 0) {
   if (
# 478 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      (*__error()) 
# 478 "project/radare2/libr/io/p/io_gprobe.c"
            == 
# 478 "project/radare2/libr/io/p/io_gprobe.c" 3 4
               4
# 478 "project/radare2/libr/io/p/io_gprobe.c"
  ...
  if (result < 0) {
   if (
# 492 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      (*__error()) 
# 492 "project/radare2/libr/io/p/io_gprobe.c"
            == 
# 492 "project/radare2/libr/io/p/io_gprobe.c" 3 4
               35
# 492 "project/radare2/libr/io/p/io_gprobe.c"
...
# 523 "project/radare2/libr/io/p/io_gprobe.c"
 if (tcflush (port->fd, 
# 523 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                       1
# 523 "project/radare2/libr/io/p/io_gprobe.c"
                               ) < 0) {
  return -1;
...
# 549 "project/radare2/libr/io/p/io_gprobe.c"
static int sp_blocking_write (struct gport *port, const void *buf,
         size_t count, unsigned int timeout_ms) {
# 581 "project/radare2/libr/io/p/io_gprobe.c"
 ...
 if (timeout_ms) {
  ...
  gettimeofday (&start, 
# 590 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                       ((void *)0)
# 590 "project/radare2/libr/io/p/io_gprobe.c"
                           );
...
# 598 "project/radare2/libr/io/p/io_gprobe.c" 3 4
__builtin_bzero(
# 598 "project/radare2/libr/io/p/io_gprobe.c"
&fds
# 598 "project/radare2/libr/io/p/io_gprobe.c" 3 4
, sizeof(*(
# 598 "project/radare2/libr/io/p/io_gprobe.c"
...
# 599 "project/radare2/libr/io/p/io_gprobe.c" 3 4
__darwin_fd_set((
# 599 "project/radare2/libr/io/p/io_gprobe.c"
port->fd
# 599 "project/radare2/libr/io/p/io_gprobe.c" 3 4
), (
# 599 "project/radare2/libr/io/p/io_gprobe.c"
...
# 599 "project/radare2/libr/io/p/io_gprobe.c"
 ...
 while (bytes_written < count) {
  ...
  if (timeout_ms && started) {
   gettimeofday (&now, 
# 609 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                      ((void *)0)
# 609 "project/radare2/libr/io/p/io_gprobe.c"
                          );
   if ((((&now)->tv_sec == (&end)->tv_sec) ? ((&now)->tv_usec > (&end)->tv_usec) : ((&now)->tv_sec > (&end)->tv_sec))) {
  ...
  result = select (port->fd + 1, 
# 616 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                ((void *)0)
# 616 "project/radare2/libr/io/p/io_gprobe.c"
                                    , &fds, 
# 616 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                            ((void *)0)
# 616 "project/radare2/libr/io/p/io_gprobe.c"
...
# 616 "project/radare2/libr/io/p/io_gprobe.c"
  ...
  if (result < 0) {
   if (
# 619 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      (*__error()) 
# 619 "project/radare2/libr/io/p/io_gprobe.c"
            == 
# 619 "project/radare2/libr/io/p/io_gprobe.c" 3 4
               4
# 619 "project/radare2/libr/io/p/io_gprobe.c"
  ...
  if (result < 0) {
   if (
# 633 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      (*__error()) 
# 633 "project/radare2/libr/io/p/io_gprobe.c"
            == 
# 633 "project/radare2/libr/io/p/io_gprobe.c" 3 4
               35
# 633 "project/radare2/libr/io/p/io_gprobe.c"
...
static 
# 650 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      unsigned char 
# 650 "project/radare2/libr/io/p/io_gprobe.c"
          gprobe_checksum (const 
# 650 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                 unsigned char 
# 650 "project/radare2/libr/io/p/io_gprobe.c"
                                     *p, unsigned int size) {
 
# 651 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned char 
# 651 "project/radare2/libr/io/p/io_gprobe.c"
    res = 0;
 unsigned int k;
...
# 664 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned long long 
# 664 "project/radare2/libr/io/p/io_gprobe.c"
     size;
 const 
# 665 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      unsigned char 
# 665 "project/radare2/libr/io/p/io_gprobe.c"
          *tmp = r_buf_data (frame, &size);
 size += 2;
 
# 667 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned char 
# 667 "project/radare2/libr/io/p/io_gprobe.c"
    checksum;

 r_buf_prepend_bytes (frame, (const 
# 669 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                   unsigned char 
# 669 "project/radare2/libr/io/p/io_gprobe.c"
                                       *)&size, 1);
...
# 675 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                                  unsigned char 
# 675 "project/radare2/libr/io/p/io_gprobe.c"
                                                      cmd, RBuffer *reply) {
 
# 676 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned char 
# 676 "project/radare2/libr/io/p/io_gprobe.c"
    buf[256];
...
# 704 "project/radare2/libr/io/p/io_gprobe.c"
...
# 712 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned long long 
# 712 "project/radare2/libr/io/p/io_gprobe.c"
     tmpsz;
 const 
# 713 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      unsigned char 
# 713 "project/radare2/libr/io/p/io_gprobe.c"
          *tmp = r_buf_data (request, &tmpsz);
...
# 721 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                          unsigned int 
# 721 "project/radare2/libr/io/p/io_gprobe.c"
                                               addr, 
# 721 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                                     unsigned char 
# 721 "project/radare2/libr/io/p/io_gprobe.c"
...
# 721 "project/radare2/libr/io/p/io_gprobe.c"
 ...
 const 
# 724 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      unsigned char 
# 724 "project/radare2/libr/io/p/io_gprobe.c"
          cmd = GPROBE_RAM_READ_2;
 
# 725 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned char 
# 725 "project/radare2/libr/io/p/io_gprobe.c"
    addr_be[4];
 
# 726 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned char 
# 726 "project/radare2/libr/io/p/io_gprobe.c"
    count_be[4];
 int res;
 ...
 count = 
# 735 "project/radare2/libr/io/p/io_gprobe.c" 3 4
        (((
# 735 "project/radare2/libr/io/p/io_gprobe.c"
        port->max_rx_size
# 735 "project/radare2/libr/io/p/io_gprobe.c" 3 4
        )>(
# 735 "project/radare2/libr/io/p/io_gprobe.c"
...
# 767 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                            unsigned int 
# 767 "project/radare2/libr/io/p/io_gprobe.c"
                                                 addr, const 
# 767 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                                             unsigned char 
# 767 "project/radare2/libr/io/p/io_gprobe.c"
...
# 767 "project/radare2/libr/io/p/io_gprobe.c"
 ...
 RBuffer *reply = r_buf_new ();
 const 
# 770 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      unsigned char 
# 770 "project/radare2/libr/io/p/io_gprobe.c"
          cmd = GPROBE_RAM_WRITE_2;
 
# 771 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned char 
# 771 "project/radare2/libr/io/p/io_gprobe.c"
    addr_be[4];
 
# 772 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned char 
# 772 "project/radare2/libr/io/p/io_gprobe.c"
    count_be[4];
 ...
 count = 
# 780 "project/radare2/libr/io/p/io_gprobe.c" 3 4
        (((
# 780 "project/radare2/libr/io/p/io_gprobe.c"
        port->max_tx_size
# 780 "project/radare2/libr/io/p/io_gprobe.c" 3 4
        )>(
# 780 "project/radare2/libr/io/p/io_gprobe.c"
...
# 810 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                            unsigned char 
# 810 "project/radare2/libr/io/p/io_gprobe.c"
                                                code) {
 if (!port) {
  return -1;
 }
 ...
 RBuffer *reply = r_buf_new ();
 const 
# 816 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      unsigned char 
# 816 "project/radare2/libr/io/p/io_gprobe.c"
          cmd = GPROBE_RESET;
...
static int gprobe_debugon (struct gport *port) {
 ...
 RBuffer *reply = r_buf_new ();
 const 
# 854 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      unsigned char 
# 854 "project/radare2/libr/io/p/io_gprobe.c"
          cmd = GPROBE_DEBUGON;
...
static int gprobe_debugoff (struct gport *port) {
 ...
 RBuffer *reply = r_buf_new ();
 const 
# 885 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      unsigned char 
# 885 "project/radare2/libr/io/p/io_gprobe.c"
          cmd = GPROBE_DEBUGOFF;
...
# 907 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                              unsigned int 
# 907 "project/radare2/libr/io/p/io_gprobe.c"
                                                   addr) {
 if (!port) {
  return -1;
 }
 ...
 RBuffer *reply = r_buf_new ();
 const 
# 913 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      unsigned char 
# 913 "project/radare2/libr/io/p/io_gprobe.c"
          cmd = GPROBE_RUN_CODE_2;
 
# 914 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned char 
# 914 "project/radare2/libr/io/p/io_gprobe.c"
    addr_be[4];
...
# 946 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                                  unsigned char 
# 946 "project/radare2/libr/io/p/io_gprobe.c"
                                                      index) {
 if (!port) {
  return -1;
 }
 ...
 RBuffer *reply = r_buf_new ();
 const 
# 952 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      unsigned char 
# 952 "project/radare2/libr/io/p/io_gprobe.c"
          cmd = GPROBE_GET_DEVICE_ID;
...
static int gprobe_getinformation (struct gport *port) {
 ...
 RBuffer *reply = r_buf_new ();
 const 
# 994 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      unsigned char 
# 994 "project/radare2/libr/io/p/io_gprobe.c"
          cmd = GPROBE_GET_INFORMATION;
 const 
# 995 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      unsigned char 
# 995 "project/radare2/libr/io/p/io_gprobe.c"
          index = 0;
...
# 1014 "project/radare2/libr/io/p/io_gprobe.c" 3 4
unsigned long long 
# 1014 "project/radare2/libr/io/p/io_gprobe.c"
     tmpsz;
 const 
# 1015 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      unsigned char 
# 1015 "project/radare2/libr/io/p/io_gprobe.c"
          *tmp = r_buf_data (reply, &tmpsz);
 r_print_hexdump (
# 1016 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                 ((void *)0)
# 1016 "project/radare2/libr/io/p/io_gprobe.c"
                     , 0, tmp, tmpsz, 16, 1, 1);
...
# 1029 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                              unsigned char 
# 1029 "project/radare2/libr/io/p/io_gprobe.c"
                                                  *buf, int count) {
 RIOGprobe *gprobe;
 int res;
 int has_written = 0;
 ...
 if ((gprobe->offset + count) > (1LL << 32)) {
  count = (1LL << 32) - gprobe->offset;
 }
...
# 1056 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                        unsigned char 
# 1056 "project/radare2/libr/io/p/io_gprobe.c"
                                            *buf, int count) {
 int res;
 RIOGprobe *gprobe;
 int has_read = 0;
...
static 
# 1083 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      _Bool 
# 1083 "project/radare2/libr/io/p/io_gprobe.c"
           __close(RIODesc *fd) {
 if (!fd || !fd->data) {
  return 
# 1085 "project/radare2/libr/io/p/io_gprobe.c" 3 4
        0
# 1085 "project/radare2/libr/io/p/io_gprobe.c"
             ;
 }
 RIOGprobe *gprobe = (RIOGprobe *)fd->data;
 sp_close (&gprobe->gport);
 
# 1089 "project/radare2/libr/io/p/io_gprobe.c" 3 4
{ free((void *)
# 1089 "project/radare2/libr/io/p/io_gprobe.c"
fd->data
# 1089 "project/radare2/libr/io/p/io_gprobe.c" 3 4
); 
# 1089 "project/radare2/libr/io/p/io_gprobe.c"
...
# 1089 "project/radare2/libr/io/p/io_gprobe.c"
                 ;
 return 
# 1090 "project/radare2/libr/io/p/io_gprobe.c" 3 4
       1
# 1090 "project/radare2/libr/io/p/io_gprobe.c"
           ;
}

static 
# 1093 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      unsigned long long 
# 1093 "project/radare2/libr/io/p/io_gprobe.c"
...
# 1093 "project/radare2/libr/io/p/io_gprobe.c"
 ...
 switch (whence) {
 case 
# 1100 "project/radare2/libr/io/p/io_gprobe.c" 3 4
     0
# 1100 "project/radare2/libr/io/p/io_gprobe.c"
             :
  if (offset >= (1LL << 32)) {
   return gprobe->offset = (1LL << 32) - 1;
  }
  return gprobe->offset = offset;
 case 
# 1105 "project/radare2/libr/io/p/io_gprobe.c" 3 4
     1
# 1105 "project/radare2/libr/io/p/io_gprobe.c"
             :
  if ((gprobe->offset + offset) >= (1LL << 32)) {
   return gprobe->offset = (1LL << 32) - 1;
  }
  return gprobe->offset += offset;
 case 
# 1110 "project/radare2/libr/io/p/io_gprobe.c" 3 4
     2
# 1110 "project/radare2/libr/io/p/io_gprobe.c"
             :
  return gprobe->offset = (1LL << 32) - 1;
 }
 return offset;
...
static 
# 1116 "project/radare2/libr/io/p/io_gprobe.c" 3 4
      _Bool 
# 1116 "project/radare2/libr/io/p/io_gprobe.c"
           __plugin_open(RIO *io, const char *pathname, 
# 1116 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                                                        _Bool 
# 1116 "project/radare2/libr/io/p/io_gprobe.c"
                                                             many) {
...
static RIODesc *__open (RIO *io, const char *pathname, int rw, int mode) {
 if (__plugin_open (io, pathname, 0)) {
  RIOGprobe *gprobe = 
# 1122 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                     (
# 1122 "project/radare2/libr/io/p/io_gprobe.c"
                     RIOGprobe
# 1122 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                     *)calloc(1,sizeof(
# 1122 "project/radare2/libr/io/p/io_gprobe.c"
...
# 1136 "project/radare2/libr/io/p/io_gprobe.c" 3 4
   { free((void *)
# 1136 "project/radare2/libr/io/p/io_gprobe.c"
   gprobe
# 1136 "project/radare2/libr/io/p/io_gprobe.c" 3 4
   ); 
# 1136 "project/radare2/libr/io/p/io_gprobe.c"
...
# 1136 "project/radare2/libr/io/p/io_gprobe.c"
                  ;
    return 
# 1137 "project/radare2/libr/io/p/io_gprobe.c" 3 4
          ((void *)0)
# 1137 "project/radare2/libr/io/p/io_gprobe.c"
              ;
   }
...
# 1151 "project/radare2/libr/io/p/io_gprobe.c" 3 4
   { free((void *)
# 1151 "project/radare2/libr/io/p/io_gprobe.c"
   gprobe
# 1151 "project/radare2/libr/io/p/io_gprobe.c" 3 4
   ); 
# 1151 "project/radare2/libr/io/p/io_gprobe.c"
...
# 1151 "project/radare2/libr/io/p/io_gprobe.c"
                  ;
    return 
# 1152 "project/radare2/libr/io/p/io_gprobe.c" 3 4
          ((void *)0)
# 1152 "project/radare2/libr/io/p/io_gprobe.c"
              ;
   }
  }
 ...
 return 
# 1159 "project/radare2/libr/io/p/io_gprobe.c" 3 4
       ((void *)0)
# 1159 "project/radare2/libr/io/p/io_gprobe.c"
           ;
}
...
static char *__system(RIO *io, RIODesc *fd, const char *cmd) {
 if (!fd || !fd->data) {
  return 
# 1164 "project/radare2/libr/io/p/io_gprobe.c" 3 4
        ((void *)0)
# 1164 "project/radare2/libr/io/p/io_gprobe.c"
            ;
 }
 RIOGprobe *gprobe = (RIOGprobe *)fd->data;
 ...
 if (!cmd[0] || cmd[0] == '?' || !strcmp (cmd, "help")) {
  printf ("Usage: =!cmd args\n"
   ...
   " =!getinformation\n");
  return 
# 1176 "project/radare2/libr/io/p/io_gprobe.c" 3 4
        ((void *)0)
# 1176 "project/radare2/libr/io/p/io_gprobe.c"
            ;
 }

 if (r_str_startswith (cmd, "reset") && (strlen (cmd) > 6)) {
  
# 1180 "project/radare2/libr/io/p/io_gprobe.c" 3 4
 unsigned int 
# 1180 "project/radare2/libr/io/p/io_gprobe.c"
      code = (
# 1180 "project/radare2/libr/io/p/io_gprobe.c" 3 4
              unsigned int
# 1180 "project/radare2/libr/io/p/io_gprobe.c"
...
# 1180 "project/radare2/libr/io/p/io_gprobe.c"
  ...
  return 
# 1184 "project/radare2/libr/io/p/io_gprobe.c" 3 4
        ((void *)0)
# 1184 "project/radare2/libr/io/p/io_gprobe.c"
            ;
 }
 ...
 if (r_str_startswith (cmd, "debugon")) {
  ...
  return 
# 1190 "project/radare2/libr/io/p/io_gprobe.c" 3 4
        ((void *)0)
# 1190 "project/radare2/libr/io/p/io_gprobe.c"
            ;
 }
 ...
 if (r_str_startswith (cmd, "debugoff")) {
  ...
  return 
# 1196 "project/radare2/libr/io/p/io_gprobe.c" 3 4
        ((void *)0)
# 1196 "project/radare2/libr/io/p/io_gprobe.c"
            ;
 }

 if (r_str_startswith (cmd, "runcode") && (strlen (cmd) > 8)) {
  
# 1200 "project/radare2/libr/io/p/io_gprobe.c" 3 4
 unsigned int 
# 1200 "project/radare2/libr/io/p/io_gprobe.c"
      address = (
# 1200 "project/radare2/libr/io/p/io_gprobe.c" 3 4
                 unsigned int
# 1200 "project/radare2/libr/io/p/io_gprobe.c"
...
# 1200 "project/radare2/libr/io/p/io_gprobe.c"
  ...
  return 
# 1204 "project/radare2/libr/io/p/io_gprobe.c" 3 4
        ((void *)0)
# 1204 "project/radare2/libr/io/p/io_gprobe.c"
            ;
 }

 if (r_str_startswith (cmd, "getdeviceid")) {
  
# 1208 "project/radare2/libr/io/p/io_gprobe.c" 3 4
 unsigned char 
# 1208 "project/radare2/libr/io/p/io_gprobe.c"
     index = 0;
  ...
  return 
# 1213 "project/radare2/libr/io/p/io_gprobe.c" 3 4
        ((void *)0)
# 1213 "project/radare2/libr/io/p/io_gprobe.c"
            ;
 }
 ...
 if (r_str_startswith (cmd, "getinformation")) {
  ...
  return 
# 1219 "project/radare2/libr/io/p/io_gprobe.c" 3 4
        ((void *)0)
# 1219 "project/radare2/libr/io/p/io_gprobe.c"
            ;
 }
 ...
 return 
# 1224 "project/radare2/libr/io/p/io_gprobe.c" 3 4
       ((void *)0)
# 1224 "project/radare2/libr/io/p/io_gprobe.c"
           ;
}
...
# 1242 "project/radare2/libr/io/p/io_gprobe.c" 3 4
__attribute__((visibility("default"))) 
# 1242 "project/radare2/libr/io/p/io_gprobe.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_gprobe,
 .version = 
# 1245 "project/radare2/libr/io/p/io_gprobe.c" 3 4
           "5.5.4"
# 1245 "project/radare2/libr/io/p/io_gprobe.c"
                     };
