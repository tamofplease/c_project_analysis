# 0 "project/radare2/libr/io/p/io_fd.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/io/p/io_fd.c"
...
# 4 "project/radare2/libr/io/p/io_fd.c" 2
...
# 5 "project/radare2/libr/io/p/io_fd.c" 2
# 13 "project/radare2/libr/io/p/io_fd.c"
#define FDURI "fd://"



# 16 "project/radare2/libr/io/p/io_fd.c"
typedef struct {
 int fd;
} RIOFdata;

static int __write(RIO *io, RIODesc *desc, const 
# 20 "project/radare2/libr/io/p/io_fd.c" 3 4
                                                unsigned char 
# 20 "project/radare2/libr/io/p/io_fd.c"
                                                    *buf, int count) {
...
static 
# 28 "project/radare2/libr/io/p/io_fd.c" 3 4
      _Bool 
# 28 "project/radare2/libr/io/p/io_fd.c"
           __resize(RIO *io, RIODesc *desc, 
# 28 "project/radare2/libr/io/p/io_fd.c" 3 4
                                            unsigned long long 
# 28 "project/radare2/libr/io/p/io_fd.c"
                                                 count) {
 ...
 return 
# 33 "project/radare2/libr/io/p/io_fd.c" 3 4
       0
# 33 "project/radare2/libr/io/p/io_fd.c"
            ;
}

static int __read(RIO *io, RIODesc *desc, 
# 36 "project/radare2/libr/io/p/io_fd.c" 3 4
                                         unsigned char 
# 36 "project/radare2/libr/io/p/io_fd.c"
                                             *buf, int count) {
 RIOFdata *fdd = (RIOFdata*)desc->data;
 if (fdd) {
  r_cons_break_push (
# 39 "project/radare2/libr/io/p/io_fd.c" 3 4
                    ((void *)0)
# 39 "project/radare2/libr/io/p/io_fd.c"
                        , 
# 39 "project/radare2/libr/io/p/io_fd.c" 3 4
                          ((void *)0)
# 39 "project/radare2/libr/io/p/io_fd.c"
...
static 
# 47 "project/radare2/libr/io/p/io_fd.c" 3 4
      _Bool 
# 47 "project/radare2/libr/io/p/io_fd.c"
           __close(RIODesc *desc) {
 
# 48 "project/radare2/libr/io/p/io_fd.c" 3 4
{ free((void *)
# 48 "project/radare2/libr/io/p/io_fd.c"
desc->data
# 48 "project/radare2/libr/io/p/io_fd.c" 3 4
); 
# 48 "project/radare2/libr/io/p/io_fd.c"
...
# 48 "project/radare2/libr/io/p/io_fd.c"
                   ;
 return 
# 49 "project/radare2/libr/io/p/io_fd.c" 3 4
       1
# 49 "project/radare2/libr/io/p/io_fd.c"
           ;
}

static 
# 52 "project/radare2/libr/io/p/io_fd.c" 3 4
      unsigned long long 
# 52 "project/radare2/libr/io/p/io_fd.c"
           __lseek(RIO* io, RIODesc *desc, 
# 52 "project/radare2/libr/io/p/io_fd.c" 3 4
                                           unsigned long long 
# 52 "project/radare2/libr/io/p/io_fd.c"
                                                offset, int whence) {
...
static 
# 60 "project/radare2/libr/io/p/io_fd.c" 3 4
      _Bool 
# 60 "project/radare2/libr/io/p/io_fd.c"
           __check(RIO *io, const char *pathname, 
# 60 "project/radare2/libr/io/p/io_fd.c" 3 4
                                                  _Bool 
# 60 "project/radare2/libr/io/p/io_fd.c"
                                                       many) {
 return !strncmp (pathname, "fd://", strlen ("fd://"));
}

static RIODesc *__open(RIO *io, const char *pathname, int rw, int mode) {
 if (r_sandbox_enable (
# 65 "project/radare2/libr/io/p/io_fd.c" 3 4
                      0
# 65 "project/radare2/libr/io/p/io_fd.c"
                           )) {
  
# 66 "project/radare2/libr/io/p/io_fd.c" 3 4
 fprintf(__stderrp,
# 66 "project/radare2/libr/io/p/io_fd.c"
 "Do not permit " "fd://" " in sandbox mode.\n"
# 66 "project/radare2/libr/io/p/io_fd.c" 3 4
 )
# 66 "project/radare2/libr/io/p/io_fd.c"
                                                       ;
  return 
# 67 "project/radare2/libr/io/p/io_fd.c" 3 4
        ((void *)0)
# 67 "project/radare2/libr/io/p/io_fd.c"
            ;
 }
 if (!__check (io, pathname, 0)) {
  return 
# 70 "project/radare2/libr/io/p/io_fd.c" 3 4
        ((void *)0)
# 70 "project/radare2/libr/io/p/io_fd.c"
            ;
 }
 RIOFdata *fdd = 
# 72 "project/radare2/libr/io/p/io_fd.c" 3 4
                (
# 72 "project/radare2/libr/io/p/io_fd.c"
                RIOFdata
# 72 "project/radare2/libr/io/p/io_fd.c" 3 4
                *)calloc(1,sizeof(
# 72 "project/radare2/libr/io/p/io_fd.c"
...
# 72 "project/radare2/libr/io/p/io_fd.c"
 ...
 if (fdd) {
  fdd->fd = r_num_math (
# 74 "project/radare2/libr/io/p/io_fd.c" 3 4
                       ((void *)0)
# 74 "project/radare2/libr/io/p/io_fd.c"
                           , pathname + strlen ("fd://"));
...
# 80 "project/radare2/libr/io/p/io_fd.c" 3 4
  fprintf(__stderrp,
# 80 "project/radare2/libr/io/p/io_fd.c"
...
# 80 "project/radare2/libr/io/p/io_fd.c"
                                       ;
   return 
# 81 "project/radare2/libr/io/p/io_fd.c" 3 4
         ((void *)0)
# 81 "project/radare2/libr/io/p/io_fd.c"
             ;
  }
 }
 return r_io_desc_new (io, &r_io_plugin_fd, pathname, 
# 84 "project/radare2/libr/io/p/io_fd.c" 3 4
                                                     (4|2) 
# 84 "project/radare2/libr/io/p/io_fd.c"
                                                               | rw, mode, fdd);
}
...
# 107 "project/radare2/libr/io/p/io_fd.c" 3 4
__attribute__((visibility("default"))) 
# 107 "project/radare2/libr/io/p/io_fd.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_fd,
 .version = 
# 110 "project/radare2/libr/io/p/io_fd.c" 3 4
           "5.5.4"

# 111 "project/radare2/libr/io/p/io_fd.c"
};
