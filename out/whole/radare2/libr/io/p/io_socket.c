# 0 "project/radare2/libr/io/p/io_socket.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/io/p/io_socket.c"
...
# 4 "project/radare2/libr/io/p/io_socket.c" 2
...
# 5 "project/radare2/libr/io/p/io_socket.c" 2

# 1 "project/radare2/libr/io/p/../io_memory.h" 1
...
# 6 "project/radare2/libr/io/p/../io_memory.h"
typedef struct {
 
# 7 "project/radare2/libr/io/p/../io_memory.h" 3 4
unsigned char 
# 7 "project/radare2/libr/io/p/../io_memory.h"
    *buf;
 
# 8 "project/radare2/libr/io/p/../io_memory.h" 3 4
unsigned int 
# 8 "project/radare2/libr/io/p/../io_memory.h"
     size;
 
# 9 "project/radare2/libr/io/p/../io_memory.h" 3 4
unsigned long long 
# 9 "project/radare2/libr/io/p/../io_memory.h"
     offset;
 void *data;
} RIOMalloc;


# 13 "project/radare2/libr/io/p/../io_memory.h" 3 4
_Bool 
# 13 "project/radare2/libr/io/p/../io_memory.h"
    io_memory_close(RIODesc *fd);
int io_memory_read(RIO *io, RIODesc *fd, 
# 14 "project/radare2/libr/io/p/../io_memory.h" 3 4
                                        unsigned char 
# 14 "project/radare2/libr/io/p/../io_memory.h"
                                            *buf, int count);

# 15 "project/radare2/libr/io/p/../io_memory.h" 3 4
unsigned long long 
# 15 "project/radare2/libr/io/p/../io_memory.h"
    io_memory_lseek(RIO* io, RIODesc *fd, 
# 15 "project/radare2/libr/io/p/../io_memory.h" 3 4
                                          unsigned long long 
# 15 "project/radare2/libr/io/p/../io_memory.h"
                                               offset, int whence);
int io_memory_write(RIO *io, RIODesc *fd, const 
# 16 "project/radare2/libr/io/p/../io_memory.h" 3 4
                                               unsigned char 
# 16 "project/radare2/libr/io/p/../io_memory.h"
                                                   *buf, int count);

# 17 "project/radare2/libr/io/p/../io_memory.h" 3 4
_Bool 
# 17 "project/radare2/libr/io/p/../io_memory.h"
    io_memory_resize(RIO *io, RIODesc *fd, 
# 17 "project/radare2/libr/io/p/../io_memory.h" 3 4
                                           unsigned long long 
# 17 "project/radare2/libr/io/p/../io_memory.h"
                                                count);
# 7 "project/radare2/libr/io/p/io_socket.c" 2
...
static int __write(RIO *io, RIODesc *desc, const 
# 25 "project/radare2/libr/io/p/io_socket.c" 3 4
                                                unsigned char 
# 25 "project/radare2/libr/io/p/io_socket.c"
                                                    *buf, int count) {
 RIOMalloc *mal = (RIOMalloc*)desc->data;
 if (mal) {
  r_cons_break_push (
# 28 "project/radare2/libr/io/p/io_socket.c" 3 4
                    ((void *)0)
# 28 "project/radare2/libr/io/p/io_socket.c"
                        , 
# 28 "project/radare2/libr/io/p/io_socket.c" 3 4
                          ((void *)0)
# 28 "project/radare2/libr/io/p/io_socket.c"
...
# 35 "project/radare2/libr/io/p/io_socket.c" 3 4
                                         unsigned char 
# 35 "project/radare2/libr/io/p/io_socket.c"
                                             *buf, int count) {
 RIOMalloc *mal = (RIOMalloc*)desc->data;
 if (mal) {
  
# 38 "project/radare2/libr/io/p/io_socket.c" 3 4
 unsigned long long 
# 38 "project/radare2/libr/io/p/io_socket.c"
      addr = mal->offset;
  r_cons_break_push (
# 39 "project/radare2/libr/io/p/io_socket.c" 3 4
                    ((void *)0)
# 39 "project/radare2/libr/io/p/io_socket.c"
                        , 
# 39 "project/radare2/libr/io/p/io_socket.c" 3 4
                          ((void *)0)
# 39 "project/radare2/libr/io/p/io_socket.c"
...
# 42 "project/radare2/libr/io/p/io_socket.c" 3 4
 unsigned char 
# 42 "project/radare2/libr/io/p/io_socket.c"
     *mem = malloc (4096);
  if (mem) {
...
# 48 "project/radare2/libr/io/p/io_socket.c" 3 4
   __builtin___memcpy_chk (
# 48 "project/radare2/libr/io/p/io_socket.c"
   mal->buf + osz
# 48 "project/radare2/libr/io/p/io_socket.c" 3 4
   , 
# 48 "project/radare2/libr/io/p/io_socket.c"
...
static 
# 63 "project/radare2/libr/io/p/io_socket.c" 3 4
      _Bool 
# 63 "project/radare2/libr/io/p/io_socket.c"
           __close(RIODesc *desc) {
 
# 64 "project/radare2/libr/io/p/io_socket.c" 3 4
{ free((void *)
# 64 "project/radare2/libr/io/p/io_socket.c"
desc->data
# 64 "project/radare2/libr/io/p/io_socket.c" 3 4
); 
# 64 "project/radare2/libr/io/p/io_socket.c"
...
# 64 "project/radare2/libr/io/p/io_socket.c"
                   ;
 return 
# 65 "project/radare2/libr/io/p/io_socket.c" 3 4
       1
# 65 "project/radare2/libr/io/p/io_socket.c"
           ;
}

static 
# 68 "project/radare2/libr/io/p/io_socket.c" 3 4
      _Bool 
# 68 "project/radare2/libr/io/p/io_socket.c"
           __check(RIO *io, const char *pathname, 
# 68 "project/radare2/libr/io/p/io_socket.c" 3 4
                                                  _Bool 
# 68 "project/radare2/libr/io/p/io_socket.c"
                                                       many) {
 return !strncmp (pathname, "socket://", strlen ("socket://"));
}

static RIODesc *__open(RIO *io, const char *pathname, int rw, int mode) {
 if (r_sandbox_enable (
# 73 "project/radare2/libr/io/p/io_socket.c" 3 4
                      0
# 73 "project/radare2/libr/io/p/io_socket.c"
                           )) {
  
# 74 "project/radare2/libr/io/p/io_socket.c" 3 4
 fprintf(__stderrp,
# 74 "project/radare2/libr/io/p/io_socket.c"
 "Do not permit " "socket://" " in sandbox mode.\n"
# 74 "project/radare2/libr/io/p/io_socket.c" 3 4
 )
# 74 "project/radare2/libr/io/p/io_socket.c"
                                                           ;
  return 
# 75 "project/radare2/libr/io/p/io_socket.c" 3 4
        ((void *)0)
# 75 "project/radare2/libr/io/p/io_socket.c"
            ;
 }
 if (!__check (io, pathname, 0)) {
  return 
# 78 "project/radare2/libr/io/p/io_socket.c" 3 4
        ((void *)0)
# 78 "project/radare2/libr/io/p/io_socket.c"
            ;
 }
 RIOMalloc *mal = 
# 80 "project/radare2/libr/io/p/io_socket.c" 3 4
                 (
# 80 "project/radare2/libr/io/p/io_socket.c"
                 RIOMalloc
# 80 "project/radare2/libr/io/p/io_socket.c" 3 4
                 *)calloc(1,sizeof(
# 80 "project/radare2/libr/io/p/io_socket.c"
...
# 80 "project/radare2/libr/io/p/io_socket.c"
                                   ;
 RIOSocketData *data = 
# 81 "project/radare2/libr/io/p/io_socket.c" 3 4
                      (
# 81 "project/radare2/libr/io/p/io_socket.c"
                      RIOSocketData
# 81 "project/radare2/libr/io/p/io_socket.c" 3 4
                      *)calloc(1,sizeof(
# 81 "project/radare2/libr/io/p/io_socket.c"
...
# 81 "project/radare2/libr/io/p/io_socket.c"
 ...
 if (!mal || !data) {
  ...
  return 
# 85 "project/radare2/libr/io/p/io_socket.c" 3 4
        ((void *)0)
# 85 "project/radare2/libr/io/p/io_socket.c"
            ;
 }
 mal->data = data;
 mal->buf = calloc (1, 1);
 if (!mal->buf) {
  ...
  free_socketdata (data);
  return 
# 92 "project/radare2/libr/io/p/io_socket.c" 3 4
        ((void *)0)
# 92 "project/radare2/libr/io/p/io_socket.c"
            ;
 }
 mal->size = 1;
 mal->offset = 0;
...
# 99 "project/radare2/libr/io/p/io_socket.c" 3 4
 fprintf(__stderrp,
# 99 "project/radare2/libr/io/p/io_socket.c"
 "Usage: $ nc -l -p 9999 ; r2 socket://localhost:9999\n"
# 99 "project/radare2/libr/io/p/io_socket.c" 3 4
 )
# 99 "project/radare2/libr/io/p/io_socket.c"
                                                                  ;
  
# 100 "project/radare2/libr/io/p/io_socket.c" 3 4
 fprintf(__stderrp,
# 100 "project/radare2/libr/io/p/io_socket.c"
 "   or: $ nc localhost 9999 ; r2 socket://:9999\n"
# 100 "project/radare2/libr/io/p/io_socket.c" 3 4
 )
# 100 "project/radare2/libr/io/p/io_socket.c"
                                                             ;
  ...
  data->sl = r_socket_new (
# 103 "project/radare2/libr/io/p/io_socket.c" 3 4
                          0
# 103 "project/radare2/libr/io/p/io_socket.c"
                               );
  if (!r_socket_listen (data->sl, pathname + 1, 
# 104 "project/radare2/libr/io/p/io_socket.c" 3 4
                                               ((void *)0)
# 104 "project/radare2/libr/io/p/io_socket.c"
                                                   )) {
   
# 105 "project/radare2/libr/io/p/io_socket.c" 3 4
  fprintf(__stderrp,
# 105 "project/radare2/libr/io/p/io_socket.c"
  "Cannot listen\n"
# 105 "project/radare2/libr/io/p/io_socket.c" 3 4
  )
# 105 "project/radare2/libr/io/p/io_socket.c"
   ...
   data->sl = 
# 107 "project/radare2/libr/io/p/io_socket.c" 3 4
             ((void *)0)
# 107 "project/radare2/libr/io/p/io_socket.c"
                 ;
   return 
# 108 "project/radare2/libr/io/p/io_socket.c" 3 4
         ((void *)0)
# 108 "project/radare2/libr/io/p/io_socket.c"
             ;
  }
  data->sc = r_socket_accept (data->sl);
  r_socket_block_time (data->sc, 
# 111 "project/radare2/libr/io/p/io_socket.c" 3 4
                                0
# 111 "project/radare2/libr/io/p/io_socket.c"
                                     , 0, 0);
 } else {
  ...
  if (!host) {
   return 
# 116 "project/radare2/libr/io/p/io_socket.c" 3 4
         ((void *)0)
# 116 "project/radare2/libr/io/p/io_socket.c"
             ;
  }
...
# 122 "project/radare2/libr/io/p/io_socket.c" 3 4
  fprintf(__stderrp,
# 122 "project/radare2/libr/io/p/io_socket.c"
  "Missing port.\n"
# 122 "project/radare2/libr/io/p/io_socket.c" 3 4
  )
# 122 "project/radare2/libr/io/p/io_socket.c"
   ...
   free (host);
   return 
# 125 "project/radare2/libr/io/p/io_socket.c" 3 4
         ((void *)0)
# 125 "project/radare2/libr/io/p/io_socket.c"
             ;
  }

  data->sc = r_socket_new (
# 128 "project/radare2/libr/io/p/io_socket.c" 3 4
                          0
# 128 "project/radare2/libr/io/p/io_socket.c"
                               );
  if (!r_socket_connect (data->sc, host, port, 
# 129 "project/radare2/libr/io/p/io_socket.c" 3 4
                                              6
# 129 "project/radare2/libr/io/p/io_socket.c"
                                                                , 0)) {
   
# 130 "project/radare2/libr/io/p/io_socket.c" 3 4
  fprintf(__stderrp,
# 130 "project/radare2/libr/io/p/io_socket.c"
  "Cannot connect\n"
# 130 "project/radare2/libr/io/p/io_socket.c" 3 4
  )
# 130 "project/radare2/libr/io/p/io_socket.c"
   ...
   free_socketdata (data);
   return 
# 133 "project/radare2/libr/io/p/io_socket.c" 3 4
         ((void *)0)
# 133 "project/radare2/libr/io/p/io_socket.c"
             ;
  }
  r_socket_block_time (data->sc, 
# 135 "project/radare2/libr/io/p/io_socket.c" 3 4
                                0
# 135 "project/radare2/libr/io/p/io_socket.c"
                                     , 0, 0);
  free (host);
 }
 return r_io_desc_new (io, &r_io_plugin_socket, pathname, 
# 138 "project/radare2/libr/io/p/io_socket.c" 3 4
                                                         (4|2) 
# 138 "project/radare2/libr/io/p/io_socket.c"
                                                                   | rw, mode, mal);
}
...
# 155 "project/radare2/libr/io/p/io_socket.c" 3 4
__attribute__((visibility("default"))) 
# 155 "project/radare2/libr/io/p/io_socket.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_socket,
 .version = 
# 158 "project/radare2/libr/io/p/io_socket.c" 3 4
           "5.5.4"

# 159 "project/radare2/libr/io/p/io_socket.c"
};
