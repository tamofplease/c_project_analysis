# 0 "project/radare2/libr/io/p/io_malloc.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/io/p/io_malloc.c" 2
...
# 5 "project/radare2/libr/io/p/../io_memory.h" 2
...
# 17 "project/radare2/libr/io/p/../io_memory.h"
                                                count);
# 7 "project/radare2/libr/io/p/io_malloc.c" 2

static 
# 8 "project/radare2/libr/io/p/io_malloc.c" 3 4
      _Bool 
# 8 "project/radare2/libr/io/p/io_malloc.c"
...
static RIODesc *__open(RIO *io, const char *pathname, int rw, int mode) {
 if (__check (io, pathname, 0)) {
  RIOMalloc *mal = 
# 16 "project/radare2/libr/io/p/io_malloc.c" 3 4
                  (
# 16 "project/radare2/libr/io/p/io_malloc.c"
                  RIOMalloc
# 16 "project/radare2/libr/io/p/io_malloc.c" 3 4
                  *)calloc(1,sizeof(
# 16 "project/radare2/libr/io/p/io_malloc.c"
...
# 16 "project/radare2/libr/io/p/io_malloc.c"
  ...
  if (!mal) {
   return 
# 18 "project/radare2/libr/io/p/io_malloc.c" 3 4
         ((void *)0)
# 18 "project/radare2/libr/io/p/io_malloc.c"
             ;
  }
  if (!strncmp (pathname, "slurp://", 8)) {
   ...
   if (!buf || size < 1) {
    free (mal);
    return 
# 25 "project/radare2/libr/io/p/io_malloc.c" 3 4
          ((void *)0)
# 25 "project/radare2/libr/io/p/io_malloc.c"
              ;
   }
   mal->size = size;
   mal->buf = (
# 28 "project/radare2/libr/io/p/io_malloc.c" 3 4
              unsigned char
# 28 "project/radare2/libr/io/p/io_malloc.c"
                 *)buf;
   ...
   if (!mal->buf) {
    free (mal);
    return 
# 34 "project/radare2/libr/io/p/io_malloc.c" 3 4
          ((void *)0)
# 34 "project/radare2/libr/io/p/io_malloc.c"
              ;
   }
   mal->size = r_hex_str2bin (pathname + 6, mal->buf);
   if ((int)mal->size < 1) {
    
# 38 "project/radare2/libr/io/p/io_malloc.c" 3 4
   { free((void *)
# 38 "project/radare2/libr/io/p/io_malloc.c"
   mal->buf
# 38 "project/radare2/libr/io/p/io_malloc.c" 3 4
   ); 
# 38 "project/radare2/libr/io/p/io_malloc.c"
...
# 38 "project/radare2/libr/io/p/io_malloc.c"
   ...
   mal->size = r_num_math (
# 41 "project/radare2/libr/io/p/io_malloc.c" 3 4
                          ((void *)0)
# 41 "project/radare2/libr/io/p/io_malloc.c"
                              , pathname + 9);
   if (((int)mal->size) <= 0) {
    free (mal);
    
# 44 "project/radare2/libr/io/p/io_malloc.c" 3 4
   fprintf(__stderrp,
# 44 "project/radare2/libr/io/p/io_malloc.c"
   "Cannot allocate (%s) 0 bytes\n", pathname + 9
# 44 "project/radare2/libr/io/p/io_malloc.c" 3 4
   )
# 44 "project/radare2/libr/io/p/io_malloc.c"
                                                           ;
    return 
# 45 "project/radare2/libr/io/p/io_malloc.c" 3 4
          ((void *)0)
# 45 "project/radare2/libr/io/p/io_malloc.c"
              ;
   }
   mal->buf = calloc (1, mal->size + 1);
  }
...
# 51 "project/radare2/libr/io/p/io_malloc.c" 3 4
                                                           (4|2) 
# 51 "project/radare2/libr/io/p/io_malloc.c"
                                                                     | rw, mode, mal);
  }
  
# 53 "project/radare2/libr/io/p/io_malloc.c" 3 4
 fprintf(__stderrp,
# 53 "project/radare2/libr/io/p/io_malloc.c"
...
# 53 "project/radare2/libr/io/p/io_malloc.c"
 ...
 return 
# 56 "project/radare2/libr/io/p/io_malloc.c" 3 4
       ((void *)0)
# 56 "project/radare2/libr/io/p/io_malloc.c"
           ;
}
...
# 74 "project/radare2/libr/io/p/io_malloc.c" 3 4
__attribute__((visibility("default"))) 
# 74 "project/radare2/libr/io/p/io_malloc.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_malloc,
 .version = 
# 77 "project/radare2/libr/io/p/io_malloc.c" 3 4
           "5.5.4"

# 78 "project/radare2/libr/io/p/io_malloc.c"
};
