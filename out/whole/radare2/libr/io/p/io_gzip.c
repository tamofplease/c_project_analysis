# 0 "project/radare2/libr/io/p/io_gzip.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/io/p/io_gzip.c"
...
# 4 "project/radare2/libr/io/p/io_gzip.c" 2
...
# 5 "project/radare2/libr/io/p/io_gzip.c" 2





# 9 "project/radare2/libr/io/p/io_gzip.c"
typedef struct {
 
# 10 "project/radare2/libr/io/p/io_gzip.c" 3 4
unsigned char 
# 10 "project/radare2/libr/io/p/io_gzip.c"
    *buf;
 
# 11 "project/radare2/libr/io/p/io_gzip.c" 3 4
unsigned int 
# 11 "project/radare2/libr/io/p/io_gzip.c"
     size;
 
# 12 "project/radare2/libr/io/p/io_gzip.c" 3 4
unsigned long long 
# 12 "project/radare2/libr/io/p/io_gzip.c"
     offset;
 
# 13 "project/radare2/libr/io/p/io_gzip.c" 3 4
_Bool 
# 13 "project/radare2/libr/io/p/io_gzip.c"
     has_changed;
} RIOGzip;

static inline 
# 16 "project/radare2/libr/io/p/io_gzip.c" 3 4
             unsigned int 
# 16 "project/radare2/libr/io/p/io_gzip.c"
                  _io_malloc_sz(RIODesc *desc) {
 if (!desc) {
  return 0;
 }
...
static inline void _io_malloc_set_sz(RIODesc *desc, 
# 24 "project/radare2/libr/io/p/io_gzip.c" 3 4
                                                   unsigned int 
# 24 "project/radare2/libr/io/p/io_gzip.c"
                                                        sz) {
 if (!desc) {
  return;
 }
...
static inline 
# 34 "project/radare2/libr/io/p/io_gzip.c" 3 4
             unsigned char
# 34 "project/radare2/libr/io/p/io_gzip.c"
                * _io_malloc_buf(RIODesc *desc) {
 if (!desc) {
  return 
# 36 "project/radare2/libr/io/p/io_gzip.c" 3 4
        ((void *)0)
# 36 "project/radare2/libr/io/p/io_gzip.c"
            ;
 }
 RIOGzip *mal = (RIOGzip*)desc->data;
 return mal->buf;
...
static inline 
# 43 "project/radare2/libr/io/p/io_gzip.c" 3 4
             unsigned char
# 43 "project/radare2/libr/io/p/io_gzip.c"
                * _io_malloc_set_buf(RIODesc *desc, 
# 43 "project/radare2/libr/io/p/io_gzip.c" 3 4
                                                    unsigned char
# 43 "project/radare2/libr/io/p/io_gzip.c"
                                                       * buf) {
 if (!desc) {
  return 
# 45 "project/radare2/libr/io/p/io_gzip.c" 3 4
        ((void *)0)
# 45 "project/radare2/libr/io/p/io_gzip.c"
            ;
 }
 RIOGzip *mal = (RIOGzip*)desc->data;
 return mal->buf = buf;
...
static inline 
# 51 "project/radare2/libr/io/p/io_gzip.c" 3 4
             unsigned long long 
# 51 "project/radare2/libr/io/p/io_gzip.c"
                  _io_malloc_off(RIODesc *desc) {
 if (!desc) {
  return 0;
 }
 RIOGzip *mal = (RIOGzip*)desc->data;
...
static inline void _io_malloc_set_off(RIODesc *desc, 
# 59 "project/radare2/libr/io/p/io_gzip.c" 3 4
                                                    unsigned long long 
# 59 "project/radare2/libr/io/p/io_gzip.c"
                                                         off) {
 if (!desc) {
  return;
 }
...
# 67 "project/radare2/libr/io/p/io_gzip.c" 3 4
                                              unsigned char 
# 67 "project/radare2/libr/io/p/io_gzip.c"
                                                  *buf, int count) {
 ...
 if (count > 0) {
  ...
  riom->has_changed = 
# 79 "project/radare2/libr/io/p/io_gzip.c" 3 4
                     1
# 79 "project/radare2/libr/io/p/io_gzip.c"
                         ;
  
# 80 "project/radare2/libr/io/p/io_gzip.c" 3 4
 __builtin___memcpy_chk (
# 80 "project/radare2/libr/io/p/io_gzip.c"
 _io_malloc_buf (fd) + _io_malloc_off (fd)
# 80 "project/radare2/libr/io/p/io_gzip.c" 3 4
 , 
# 80 "project/radare2/libr/io/p/io_gzip.c"
 buf, count
...
static 
# 87 "project/radare2/libr/io/p/io_gzip.c" 3 4
      _Bool 
# 87 "project/radare2/libr/io/p/io_gzip.c"
...
# 88 "project/radare2/libr/io/p/io_gzip.c" 3 4
unsigned char 
# 88 "project/radare2/libr/io/p/io_gzip.c"
    * new_buf = 
# 88 "project/radare2/libr/io/p/io_gzip.c" 3 4
                ((void *)0)
# 88 "project/radare2/libr/io/p/io_gzip.c"
 ...
 if (!fd || !fd->data || count == 0) {
  return 
# 90 "project/radare2/libr/io/p/io_gzip.c" 3 4
        0
# 90 "project/radare2/libr/io/p/io_gzip.c"
             ;
 }
 
# 92 "project/radare2/libr/io/p/io_gzip.c" 3 4
unsigned int 
# 92 "project/radare2/libr/io/p/io_gzip.c"
     mallocsz = _io_malloc_sz (fd);
 if (_io_malloc_off (fd) > mallocsz) {
  return 
# 94 "project/radare2/libr/io/p/io_gzip.c" 3 4
        0
# 94 "project/radare2/libr/io/p/io_gzip.c"
             ;
 }
 new_buf = malloc (count);
 if (!new_buf) {
  return 
# 98 "project/radare2/libr/io/p/io_gzip.c" 3 4
        0
# 98 "project/radare2/libr/io/p/io_gzip.c"
             ;
 }
 
# 100 "project/radare2/libr/io/p/io_gzip.c" 3 4
__builtin___memcpy_chk (
# 100 "project/radare2/libr/io/p/io_gzip.c"
new_buf
# 100 "project/radare2/libr/io/p/io_gzip.c" 3 4
, 
# 100 "project/radare2/libr/io/p/io_gzip.c"
...
# 102 "project/radare2/libr/io/p/io_gzip.c" 3 4
 __builtin___memset_chk (
# 102 "project/radare2/libr/io/p/io_gzip.c"
 new_buf + mallocsz
# 102 "project/radare2/libr/io/p/io_gzip.c" 3 4
 , 
# 102 "project/radare2/libr/io/p/io_gzip.c"
...
# 102 "project/radare2/libr/io/p/io_gzip.c"
 ...
 return 
# 107 "project/radare2/libr/io/p/io_gzip.c" 3 4
       1
# 107 "project/radare2/libr/io/p/io_gzip.c"
           ;
}

static int __read(RIO *io, RIODesc *fd, 
# 110 "project/radare2/libr/io/p/io_gzip.c" 3 4
                                       unsigned char 
# 110 "project/radare2/libr/io/p/io_gzip.c"
                                           *buf, int count) {
 
# 111 "project/radare2/libr/io/p/io_gzip.c" 3 4
__builtin___memset_chk (
# 111 "project/radare2/libr/io/p/io_gzip.c"
buf
# 111 "project/radare2/libr/io/p/io_gzip.c" 3 4
, 
# 111 "project/radare2/libr/io/p/io_gzip.c"
...
# 115 "project/radare2/libr/io/p/io_gzip.c" 3 4
unsigned int 
# 115 "project/radare2/libr/io/p/io_gzip.c"
     mallocsz = _io_malloc_sz (fd);
 if (_io_malloc_off (fd) > mallocsz) {
  return -1;
 }
...
# 122 "project/radare2/libr/io/p/io_gzip.c" 3 4
__builtin___memcpy_chk (
# 122 "project/radare2/libr/io/p/io_gzip.c"
buf
# 122 "project/radare2/libr/io/p/io_gzip.c" 3 4
, 
# 122 "project/radare2/libr/io/p/io_gzip.c"
_io_malloc_buf (fd) + _io_malloc_off (fd), count
# 122 "project/radare2/libr/io/p/io_gzip.c" 3 4
, __builtin_object_size (
# 122 "project/radare2/libr/io/p/io_gzip.c"
buf
...
static 
# 126 "project/radare2/libr/io/p/io_gzip.c" 3 4
      _Bool 
# 126 "project/radare2/libr/io/p/io_gzip.c"
           __close(RIODesc *fd) {
 if (!fd || !fd->data) {
  return 
# 128 "project/radare2/libr/io/p/io_gzip.c" 3 4
        0
# 128 "project/radare2/libr/io/p/io_gzip.c"
             ;
 }
 RIOGzip *riom = fd->data;
 if (riom->has_changed) {
  
# 132 "project/radare2/libr/io/p/io_gzip.c" 3 4
 fprintf(__stderrp,
# 132 "project/radare2/libr/io/p/io_gzip.c"
...
# 134 "project/radare2/libr/io/p/io_gzip.c" 3 4
{ free((void *)
# 134 "project/radare2/libr/io/p/io_gzip.c"
riom->buf
# 134 "project/radare2/libr/io/p/io_gzip.c" 3 4
); 
# 134 "project/radare2/libr/io/p/io_gzip.c"
...
# 135 "project/radare2/libr/io/p/io_gzip.c" 3 4
{ free((void *)
# 135 "project/radare2/libr/io/p/io_gzip.c"
fd->data
# 135 "project/radare2/libr/io/p/io_gzip.c" 3 4
); 
# 135 "project/radare2/libr/io/p/io_gzip.c"
...
# 135 "project/radare2/libr/io/p/io_gzip.c"
                 ;
 return 
# 136 "project/radare2/libr/io/p/io_gzip.c" 3 4
       1
# 136 "project/radare2/libr/io/p/io_gzip.c"
           ;
}

static 
# 139 "project/radare2/libr/io/p/io_gzip.c" 3 4
      unsigned long long 
# 139 "project/radare2/libr/io/p/io_gzip.c"
...
# 140 "project/radare2/libr/io/p/io_gzip.c" 3 4
unsigned long long 
# 140 "project/radare2/libr/io/p/io_gzip.c"
     r_offset = offset;
 if (!fd || !fd->data) {
  return offset;
 }
 
# 144 "project/radare2/libr/io/p/io_gzip.c" 3 4
unsigned int 
# 144 "project/radare2/libr/io/p/io_gzip.c"
     mallocsz = _io_malloc_sz (fd);
 switch (whence) {
 case 
# 146 "project/radare2/libr/io/p/io_gzip.c" 3 4
     0
# 146 "project/radare2/libr/io/p/io_gzip.c"
             :
  r_offset = (offset <= mallocsz) ? offset : mallocsz;
  break;
 case 
# 149 "project/radare2/libr/io/p/io_gzip.c" 3 4
     1
# 149 "project/radare2/libr/io/p/io_gzip.c"
             :
  r_offset = (_io_malloc_off (fd) + offset <= mallocsz ) ? _io_malloc_off (fd) + offset : mallocsz;
  break;
 case 
# 152 "project/radare2/libr/io/p/io_gzip.c" 3 4
     2
# 152 "project/radare2/libr/io/p/io_gzip.c"
             :
...
static 
# 160 "project/radare2/libr/io/p/io_gzip.c" 3 4
      _Bool 
# 160 "project/radare2/libr/io/p/io_gzip.c"
...
static RIODesc *__open(RIO *io, const char *pathname, int rw, int mode) {
 if (__plugin_open (io, pathname, 0)) {
  RIOGzip *mal = 
# 166 "project/radare2/libr/io/p/io_gzip.c" 3 4
                (
# 166 "project/radare2/libr/io/p/io_gzip.c"
                RIOGzip
# 166 "project/radare2/libr/io/p/io_gzip.c" 3 4
                *)calloc(1,sizeof(
# 166 "project/radare2/libr/io/p/io_gzip.c"
...
# 166 "project/radare2/libr/io/p/io_gzip.c"
  ...
  if (!mal) {
   return 
# 168 "project/radare2/libr/io/p/io_gzip.c" 3 4
         ((void *)0)
# 168 "project/radare2/libr/io/p/io_gzip.c"
             ;
  }
  size_t len;
  
# 171 "project/radare2/libr/io/p/io_gzip.c" 3 4
 unsigned char 
# 171 "project/radare2/libr/io/p/io_gzip.c"
     *data = (
# 171 "project/radare2/libr/io/p/io_gzip.c" 3 4
              unsigned char 
# 171 "project/radare2/libr/io/p/io_gzip.c"
                  *)r_file_slurp (pathname+7, &len);
  int *size = (int*)&mal->size;
  mal->buf = r_inflate (data, (int)len, 
# 173 "project/radare2/libr/io/p/io_gzip.c" 3 4
                                       ((void *)0)
# 173 "project/radare2/libr/io/p/io_gzip.c"
                                           , size);
  if (mal->buf) {
...
# 178 "project/radare2/libr/io/p/io_gzip.c" 3 4
 fprintf(__stderrp,
# 178 "project/radare2/libr/io/p/io_gzip.c"
...
# 178 "project/radare2/libr/io/p/io_gzip.c"
 ...
 return 
# 181 "project/radare2/libr/io/p/io_gzip.c" 3 4
       ((void *)0)
# 181 "project/radare2/libr/io/p/io_gzip.c"
           ;
}
...
# 199 "project/radare2/libr/io/p/io_gzip.c" 3 4
__attribute__((visibility("default"))) 
# 199 "project/radare2/libr/io/p/io_gzip.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_gzip,
 .version = 
# 202 "project/radare2/libr/io/p/io_gzip.c" 3 4
           "5.5.4"

# 203 "project/radare2/libr/io/p/io_gzip.c"
};
