# 0 "project/radare2/libr/io/p/io_bochs.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/io/p/io_bochs.c"
...
# 4 "project/radare2/libr/io/p/io_bochs.c" 2
...
# 5 "project/radare2/libr/io/p/io_bochs.c" 2

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/bochs/include/libbochs.h" 1 3 4
...
typedef struct libbochs_t {
 ...
 int punteroBuffer;
 int sizeSend;
# 24 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/bochs/include/libbochs.h" 3 4
 int hReadPipeIn;
 int hReadPipeOut;
 int hWritePipeIn;
 int hWritePipeOut;
...
_Bool bochs_wait(libbochs_t *b);
void bochs_reset_buffer(libbochs_t* b);
_Bool bochs_cmd_stop(libbochs_t * b);
void bochs_send_cmd(libbochs_t* b, const char * comando, _Bool bWait);
int bochs_read(libbochs_t* b, unsigned long long addr, int count, unsigned char* buf);
void bochs_close(libbochs_t* b);
_Bool bochs_open(libbochs_t* b, const char *rutaBochs, const char *rutaConfig);
...
#define lprintf(x,y...) {}
# 7 "project/radare2/libr/io/p/io_bochs.c" 2


# 8 "project/radare2/libr/io/p/io_bochs.c"
typedef struct {
 libbochs_t desc;
} RIOBochs;

static libbochs_t *desc = 
# 12 "project/radare2/libr/io/p/io_bochs.c" 3 4
                         ((void *)0)
# 12 "project/radare2/libr/io/p/io_bochs.c"
                             ;
static RIODesc *riobochs = 
# 13 "project/radare2/libr/io/p/io_bochs.c" 3 4
                          ((void *)0)
# 13 "project/radare2/libr/io/p/io_bochs.c"
                              ;
extern RIOPlugin r_io_plugin_bochs;

static 
# 16 "project/radare2/libr/io/p/io_bochs.c" 3 4
      _Bool 
# 16 "project/radare2/libr/io/p/io_bochs.c"
...
# 22 "project/radare2/libr/io/p/io_bochs.c" 3 4
{}
# 22 "project/radare2/libr/io/p/io_bochs.c"
                    ;
 const char *i;
 char * fileBochs = 
# 24 "project/radare2/libr/io/p/io_bochs.c" 3 4
                   ((void *)0)
# 24 "project/radare2/libr/io/p/io_bochs.c"
                       ;
 char * fileCfg = 
# 25 "project/radare2/libr/io/p/io_bochs.c" 3 4
                 ((void *)0)
# 25 "project/radare2/libr/io/p/io_bochs.c"
                     ;
 int l;
 if (!__plugin_open (io, file, 0)) {
  return 
# 28 "project/radare2/libr/io/p/io_bochs.c" 3 4
        ((void *)0)
# 28 "project/radare2/libr/io/p/io_bochs.c"
            ;
 }
 if (r_sandbox_enable (
# 30 "project/radare2/libr/io/p/io_bochs.c" 3 4
                      0
# 30 "project/radare2/libr/io/p/io_bochs.c"
                           )) {
  
# 31 "project/radare2/libr/io/p/io_bochs.c" 3 4
 fprintf(__stderrp,
# 31 "project/radare2/libr/io/p/io_bochs.c"
 "sandbox exit\n"
# 31 "project/radare2/libr/io/p/io_bochs.c" 3 4
 )
# 31 "project/radare2/libr/io/p/io_bochs.c"
                           ;
  return 
# 32 "project/radare2/libr/io/p/io_bochs.c" 3 4
        ((void *)0)
# 32 "project/radare2/libr/io/p/io_bochs.c"
            ;
 }
 if (riobochs) {
  return riobochs;
...
# 45 "project/radare2/libr/io/p/io_bochs.c" 3 4
 fprintf(__stderrp,
# 45 "project/radare2/libr/io/p/io_bochs.c"
 "Error can't find :\n"
# 45 "project/radare2/libr/io/p/io_bochs.c" 3 4
 )
# 45 "project/radare2/libr/io/p/io_bochs.c"
                                 ;
  return 
# 46 "project/radare2/libr/io/p/io_bochs.c" 3 4
        ((void *)0)
# 46 "project/radare2/libr/io/p/io_bochs.c"
            ;
 }
 riob = 
# 48 "project/radare2/libr/io/p/io_bochs.c" 3 4
       (
# 48 "project/radare2/libr/io/p/io_bochs.c"
       RIOBochs
# 48 "project/radare2/libr/io/p/io_bochs.c" 3 4
       *)calloc(1,sizeof(
# 48 "project/radare2/libr/io/p/io_bochs.c"
...
# 48 "project/radare2/libr/io/p/io_bochs.c"
 ...
 if (bochs_open (&riob->desc, fileBochs, fileCfg) == 
# 51 "project/radare2/libr/io/p/io_bochs.c" 3 4
                                                    1
# 51 "project/radare2/libr/io/p/io_bochs.c"
                                                        ) {
  desc = &riob->desc;
...
# 59 "project/radare2/libr/io/p/io_bochs.c" 3 4
{}
# 59 "project/radare2/libr/io/p/io_bochs.c"
                                                    ;
 free (riob);
 free (fileBochs);
 free (fileCfg);
 return 
# 63 "project/radare2/libr/io/p/io_bochs.c" 3 4
       ((void *)0)
# 63 "project/radare2/libr/io/p/io_bochs.c"
           ;
}

static int __write(RIO *io, RIODesc *fd, const 
# 66 "project/radare2/libr/io/p/io_bochs.c" 3 4
                                              unsigned char 
# 66 "project/radare2/libr/io/p/io_bochs.c"
                                                  *buf, int count) {
 
# 67 "project/radare2/libr/io/p/io_bochs.c" 3 4
{}
# 67 "project/radare2/libr/io/p/io_bochs.c"
                     ;
 return -1;
}

static 
# 71 "project/radare2/libr/io/p/io_bochs.c" 3 4
      unsigned long long 
# 71 "project/radare2/libr/io/p/io_bochs.c"
...
# 72 "project/radare2/libr/io/p/io_bochs.c" 3 4
{}
# 72 "project/radare2/libr/io/p/io_bochs.c"
                                          ;
 return offset;
}

static int __read(RIO *io, RIODesc *fd, 
# 76 "project/radare2/libr/io/p/io_bochs.c" 3 4
                                       unsigned char 
# 76 "project/radare2/libr/io/p/io_bochs.c"
                                           *buf, int count) {
 
# 77 "project/radare2/libr/io/p/io_bochs.c" 3 4
__builtin___memset_chk (
# 77 "project/radare2/libr/io/p/io_bochs.c"
buf
# 77 "project/radare2/libr/io/p/io_bochs.c" 3 4
, 
# 77 "project/radare2/libr/io/p/io_bochs.c"
...
# 78 "project/radare2/libr/io/p/io_bochs.c" 3 4
unsigned long long 
# 78 "project/radare2/libr/io/p/io_bochs.c"
     addr = io->off;
 if (!desc || !desc->data) {
  return -1;
 }
 
# 82 "project/radare2/libr/io/p/io_bochs.c" 3 4
{}
# 82 "project/radare2/libr/io/p/io_bochs.c"
                                                                  ;
...
static 
# 87 "project/radare2/libr/io/p/io_bochs.c" 3 4
      _Bool 
# 87 "project/radare2/libr/io/p/io_bochs.c"
           __close(RIODesc *fd) {
 bochs_close (desc);
 return 
# 89 "project/radare2/libr/io/p/io_bochs.c" 3 4
       1
# 89 "project/radare2/libr/io/p/io_bochs.c"
           ;
}

static char *__system(RIO *io, RIODesc *fd, const char *cmd) {
 
# 93 "project/radare2/libr/io/p/io_bochs.c" 3 4
{}
# 93 "project/radare2/libr/io/p/io_bochs.c"
                                      ;
 if (!strcmp (cmd, "help")) {
  
# 95 "project/radare2/libr/io/p/io_bochs.c" 3 4
 {}

                                    
# 97 "project/radare2/libr/io/p/io_bochs.c"
                                   ;
  
# 98 "project/radare2/libr/io/p/io_bochs.c" 3 4
 {}
# 98 "project/radare2/libr/io/p/io_bochs.c"
                                                 ;
  bochs_send_cmd (desc, &cmd[1], 
# 99 "project/radare2/libr/io/p/io_bochs.c" 3 4
                                1
# 99 "project/radare2/libr/io/p/io_bochs.c"
                                    );
  io->cb_printf ("%s\n", desc->data);
 ...
 return 
# 105 "project/radare2/libr/io/p/io_bochs.c" 3 4
       ((void *)0)
# 105 "project/radare2/libr/io/p/io_bochs.c"
           ;
}
...
RIOPlugin r_io_plugin_bochs = {
 ...
 .system = __system,
 .isdbg = 
# 120 "project/radare2/libr/io/p/io_bochs.c" 3 4
         1

# 121 "project/radare2/libr/io/p/io_bochs.c"
};



# 124 "project/radare2/libr/io/p/io_bochs.c" 3 4
__attribute__((visibility("default"))) 
# 124 "project/radare2/libr/io/p/io_bochs.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_bochs,
 .version = 
# 127 "project/radare2/libr/io/p/io_bochs.c" 3 4
           "5.5.4"

# 128 "project/radare2/libr/io/p/io_bochs.c"
};
