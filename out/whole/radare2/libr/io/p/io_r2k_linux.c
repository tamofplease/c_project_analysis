# 0 "project/radare2/libr/io/p/io_r2k_linux.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/io/p/io_r2k_linux.c"


# 1 "project/radare2/libr/io/p/io_r2k_linux.h" 1
...
# 5 "project/radare2/libr/io/p/io_r2k_linux.h" 2
...
# 6 "project/radare2/libr/io/p/io_r2k_linux.h" 2
...
# 9 "project/radare2/libr/io/p/io_r2k_linux.h" 2

# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/sys/ioctl.h" 1 3 4
# 11 "project/radare2/libr/io/p/io_r2k_linux.h" 2
...
# 12 "project/radare2/libr/io/p/io_r2k_linux.h" 2
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/errno.h" 1 3 4
# 13 "project/radare2/libr/io/p/io_r2k_linux.h" 2
...
# 22 "project/radare2/libr/io/p/io_r2k_linux.h"
struct io_r2k_linux {
 int beid;
 int pid;
 
# 25 "project/radare2/libr/io/p/io_r2k_linux.h" 3 4
unsigned char 
# 25 "project/radare2/libr/io/p/io_r2k_linux.h"
    wp;
};
...
# 32 "project/radare2/libr/io/p/io_r2k_linux.h" 3 4
unsigned char 
# 32 "project/radare2/libr/io/p/io_r2k_linux.h"
    *buff;
 
# 33 "project/radare2/libr/io/p/io_r2k_linux.h" 3 4
unsigned char 
# 33 "project/radare2/libr/io/p/io_r2k_linux.h"
    wp;
};
...
struct r2k_control_reg {
 ...
 size_t cr8;
# 71 "project/radare2/libr/io/p/io_r2k_linux.h"
};
...
int ReadMemory (RIO *io, RIODesc *iodesc, int ioctl_n, size_t pid, size_t address, 
# 122 "project/radare2/libr/io/p/io_r2k_linux.h" 3 4
                                                                                  unsigned char 
# 122 "project/radare2/libr/io/p/io_r2k_linux.h"
                                                                                      *buf, int len);
int WriteMemory (RIO *io, RIODesc *iodesc, int ioctl_n, size_t pid, 
# 123 "project/radare2/libr/io/p/io_r2k_linux.h" 3 4
                                                                   unsigned long long 
# 123 "project/radare2/libr/io/p/io_r2k_linux.h"
                                                                        address, const 
# 123 "project/radare2/libr/io/p/io_r2k_linux.h" 3 4
                                                                                       unsigned char 
# 123 "project/radare2/libr/io/p/io_r2k_linux.h"
...
# 4 "project/radare2/libr/io/p/io_r2k_linux.c" 2
...
static void x86_ctrl_reg_pretty_print (RIO *io, struct r2k_control_reg ctrl) {
 io->cb_printf ("CR0: 0x%"
# 9 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                         "llx"
# 9 "project/radare2/libr/io/p/io_r2k_linux.c"
                                "\n", (
# 9 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                       unsigned long long
# 9 "project/radare2/libr/io/p/io_r2k_linux.c"
 ...
 io->cb_printf (" [*] PG:    %d\n"
         ...
         " [*] PE:    %d\n",
         ((((ctrl.cr0) & (((
# 21 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
        unsigned long long
# 21 "project/radare2/libr/io/p/io_r2k_linux.c"
        ) 1) << (31))) == 0) ? 0 : 1), ((((ctrl.cr0) & (((
# 21 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                             unsigned long long
# 21 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 21 "project/radare2/libr/io/p/io_r2k_linux.c"
         ...
         ((((ctrl.cr0) & (((
# 22 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
        unsigned long long
# 22 "project/radare2/libr/io/p/io_r2k_linux.c"
        ) 1) << (16))) == 0) ? 0 : 1), ((((ctrl.cr0) & (((
# 22 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                             unsigned long long
# 22 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 22 "project/radare2/libr/io/p/io_r2k_linux.c"
         ...
         ((((ctrl.cr0) & (((
# 23 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
        unsigned long long
# 23 "project/radare2/libr/io/p/io_r2k_linux.c"
        ) 1) << (2))) == 0) ? 0 : 1), ((((ctrl.cr0) & (((
# 23 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                            unsigned long long
# 23 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 23 "project/radare2/libr/io/p/io_r2k_linux.c"
 ...
 io->cb_printf ("CR2: 0x%"
# 26 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                         "llx"
# 26 "project/radare2/libr/io/p/io_r2k_linux.c"
                                "\n", (
# 26 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                       unsigned long long
# 26 "project/radare2/libr/io/p/io_r2k_linux.c"
                                           ) ctrl.cr2);
 io->cb_printf ("Page-Fault Linear Address: 0x%"
# 27 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                               "llx"
# 27 "project/radare2/libr/io/p/io_r2k_linux.c"
                                                      "\n", (
# 27 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                                             unsigned long long
# 27 "project/radare2/libr/io/p/io_r2k_linux.c"
 ...
 io->cb_printf ("CR3: 0x%"
# 30 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                         "llx"
# 30 "project/radare2/libr/io/p/io_r2k_linux.c"
                                "\n", (
# 30 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                       unsigned long long
# 30 "project/radare2/libr/io/p/io_r2k_linux.c"
                                           ) ctrl.cr3);
 io->cb_printf (" [*] Page-Directory Base:    0x%"
# 31 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                                 "llx"
# 31 "project/radare2/libr/io/p/io_r2k_linux.c"
                                                        "\n"
         " [*] PCD:                    %d\n"
         " [*] PWT:                    %d\n",
         (((
# 34 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
           unsigned long long
# 34 "project/radare2/libr/io/p/io_r2k_linux.c"
               ) ctrl.cr3) & 0xfffffffffffff000), ((((ctrl.cr3) & (((
# 34 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                                  unsigned long long
# 34 "project/radare2/libr/io/p/io_r2k_linux.c"
                                                  ) 1) << (4))) == 0) ? 0 : 1), ((((ctrl.cr3) & (((
...
# 34 "project/radare2/libr/io/p/io_r2k_linux.c"
 ...
 io->cb_printf ("CR4: 0x%"
# 37 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                         "llx"
# 37 "project/radare2/libr/io/p/io_r2k_linux.c"
                                "\n", (
# 37 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                       unsigned long long
# 37 "project/radare2/libr/io/p/io_r2k_linux.c"
 ...
 io->cb_printf (" [*] PKE:         %d\n"
         ...
         " [*] VME:         %d\n",
         ((((ctrl.cr4) & (((
# 58 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
        unsigned long long
# 58 "project/radare2/libr/io/p/io_r2k_linux.c"
        ) 1) << (22))) == 0) ? 0 : 1), ((((ctrl.cr4) & (((
# 58 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                             unsigned long long
# 58 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 58 "project/radare2/libr/io/p/io_r2k_linux.c"
         ...
         ((((ctrl.cr4) & (((
# 59 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
        unsigned long long
# 59 "project/radare2/libr/io/p/io_r2k_linux.c"
        ) 1) << (17))) == 0) ? 0 : 1), ((((ctrl.cr4) & (((
# 59 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                             unsigned long long
# 59 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 59 "project/radare2/libr/io/p/io_r2k_linux.c"
         ...
         ((((ctrl.cr4) & (((
# 60 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
        unsigned long long
# 60 "project/radare2/libr/io/p/io_r2k_linux.c"
        ) 1) << (11))) == 0) ? 0 : 1), ((((ctrl.cr4) & (((
# 60 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                             unsigned long long
# 60 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 60 "project/radare2/libr/io/p/io_r2k_linux.c"
         ...
         ((((ctrl.cr4) & (((
# 61 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
        unsigned long long
# 61 "project/radare2/libr/io/p/io_r2k_linux.c"
        ) 1) << (7))) == 0) ? 0 : 1), ((((ctrl.cr4) & (((
# 61 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                            unsigned long long
# 61 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 61 "project/radare2/libr/io/p/io_r2k_linux.c"
         ...
         ((((ctrl.cr4) & (((
# 62 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
        unsigned long long
# 62 "project/radare2/libr/io/p/io_r2k_linux.c"
        ) 1) << (3))) == 0) ? 0 : 1), ((((ctrl.cr4) & (((
# 62 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                            unsigned long long
# 62 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 62 "project/radare2/libr/io/p/io_r2k_linux.c"
 ...
 io->cb_printf ("CR8: 0x%"
# 66 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                         "llx"
# 66 "project/radare2/libr/io/p/io_r2k_linux.c"
                                "\n", (
# 66 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                       unsigned long long
# 66 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 203 "project/radare2/libr/io/p/io_r2k_linux.c"
...
int ReadMemory(RIO *io, RIODesc *iodesc, int ioctl_n, size_t pid, size_t address, 
# 267 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                                                                 unsigned char 
# 267 "project/radare2/libr/io/p/io_r2k_linux.c"
                                                                                     *buf, int len) {
 int ret = -1;
 int pagesize, newlen;
 
# 270 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
unsigned long long 
# 270 "project/radare2/libr/io/p/io_r2k_linux.c"
     pageaddr, offset;
 
# 271 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
_Bool 
# 271 "project/radare2/libr/io/p/io_r2k_linux.c"
     flag = 0;
 
# 272 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
unsigned char 
# 272 "project/radare2/libr/io/p/io_r2k_linux.c"
    garbage;
 ...
 if (iodesc && iodesc->data > 0 && buf) {
  ...
  data.len = len;
  data.buff = (
# 280 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
              unsigned char 
# 280 "project/radare2/libr/io/p/io_r2k_linux.c"
                  *) calloc (len + 1, 1);
  if (!data.buff) {
   return -1;
  }
...
# 287 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
  __builtin___memcpy_chk (
# 287 "project/radare2/libr/io/p/io_r2k_linux.c"
  buf
# 287 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
  , 
# 287 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 300 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
    __builtin___memcpy_chk (
# 300 "project/radare2/libr/io/p/io_r2k_linux.c"
    buf + offset
# 300 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
    , 
# 300 "project/radare2/libr/io/p/io_r2k_linux.c"
    data.buff, pageaddr - address
# 300 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
    , __builtin_object_size (
# 300 "project/radare2/libr/io/p/io_r2k_linux.c"
    buf + offset
...
# 303 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
    __builtin___memset_chk (
# 303 "project/radare2/libr/io/p/io_r2k_linux.c"
    buf + offset
# 303 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
    , 
# 303 "project/radare2/libr/io/p/io_r2k_linux.c"
    garbage, pageaddr - address
# 303 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
    , __builtin_object_size (
# 303 "project/radare2/libr/io/p/io_r2k_linux.c"
    buf + offset
...
# 314 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
     __builtin___memcpy_chk (
# 314 "project/radare2/libr/io/p/io_r2k_linux.c"
     buf + offset
# 314 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
     , 
# 314 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 317 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
     __builtin___memset_chk (
# 317 "project/radare2/libr/io/p/io_r2k_linux.c"
     buf + offset
# 317 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
     , 
# 317 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 328 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
    __builtin___memcpy_chk (
# 328 "project/radare2/libr/io/p/io_r2k_linux.c"
    buf + offset
# 328 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
    , 
# 328 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 331 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
    __builtin___memset_chk (
# 331 "project/radare2/libr/io/p/io_r2k_linux.c"
    buf + offset
# 331 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
    , 
# 331 "project/radare2/libr/io/p/io_r2k_linux.c"
...
int WriteMemory(RIO *io, RIODesc *iodesc, int ioctl_n, size_t pid, 
# 346 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                                                  unsigned long long 
# 346 "project/radare2/libr/io/p/io_r2k_linux.c"
                                                                       address, const 
# 346 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                                                                      unsigned char 
# 346 "project/radare2/libr/io/p/io_r2k_linux.c"
 ...
 if (iodesc && iodesc->data > 0 && buf) {
  ...
  data.len = len;
  data.buff = (
# 355 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
              unsigned char 
# 355 "project/radare2/libr/io/p/io_r2k_linux.c"
                  *) calloc (len + 1, 1);
...
# 362 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
 __builtin___memcpy_chk (
# 362 "project/radare2/libr/io/p/io_r2k_linux.c"
 data.buff
# 362 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
 , 
# 362 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 367 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                                            (*__error())
# 367 "project/radare2/libr/io/p/io_r2k_linux.c"
                                                                 ));
   ret = -1;
  }
...
# 383 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
unsigned char 
# 383 "project/radare2/libr/io/p/io_r2k_linux.c"
    *databuf = 
# 383 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
               ((void *)0)
# 383 "project/radare2/libr/io/p/io_r2k_linux.c"
 ...
 case 'W':
  {
   ...
   r2k_struct.wp = (
# 400 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                   unsigned char
# 400 "project/radare2/libr/io/p/io_r2k_linux.c"
                      )wp;
  }
  break;
 case 'b':
  {
   char *cmd = 
# 405 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
              ((void *)0)
# 405 "project/radare2/libr/io/p/io_r2k_linux.c"
                  ;
   if (buf[1] != ' ') {
    io->cb_printf ("beid: %d\n", r2k_struct.beid);
    io->cb_printf ("pid:  %d\n", r2k_struct.pid);
...
# 433 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
   __builtin___sprintf_chk (
# 433 "project/radare2/libr/io/p/io_r2k_linux.c"
   cmd
# 433 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
 ...
 case 'r':
  {
   ...
   case 'l':
    ...
    ioctl_n = 
# 458 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
             ((__uint32_t)0x40000000 | ((sizeof(
# 458 "project/radare2/libr/io/p/io_r2k_linux.c"
             sizeof (struct r2k_data)
# 458 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
             ) & 0x1fff) << 16) | (((
# 458 "project/radare2/libr/io/p/io_r2k_linux.c"
             0x69
...
# 458 "project/radare2/libr/io/p/io_r2k_linux.c"
   ...
   case 'p':
    ...
    ioctl_n = 
# 475 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
             ((__uint32_t)0x40000000 | ((sizeof(
# 475 "project/radare2/libr/io/p/io_r2k_linux.c"
             sizeof (struct r2k_data)
# 475 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
             ) & 0x1fff) << 16) | (((
# 475 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 475 "project/radare2/libr/io/p/io_r2k_linux.c"
   ...
   case 'P':
    ...
    ioctl_n = 
# 492 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
             ((__uint32_t)0x40000000 | ((sizeof(
# 492 "project/radare2/libr/io/p/io_r2k_linux.c"
             sizeof (struct r2k_data)
# 492 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
             ) & 0x1fff) << 16) | (((
# 492 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 492 "project/radare2/libr/io/p/io_r2k_linux.c"
   ...
   databuf = (
# 499 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
             unsigned char 
# 499 "project/radare2/libr/io/p/io_r2k_linux.c"
                 *) calloc (len + 1, 1);
   if (databuf) {
    ret = ReadMemory (io, iodesc, ioctl_n, pid, addr, databuf, len);
    if (ret > 0) {
     r_print_hexdump (print, addr, (const 
# 503 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                         unsigned char 
# 503 "project/radare2/libr/io/p/io_r2k_linux.c"
                                             *) databuf, ret, 16, 1, 1);
    }
   } else {
 ...
 case 'w':
  ...
  case 'l':
   ...
   ioctl_n = 
# 529 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
            ((__uint32_t)0x40000000 | ((sizeof(
# 529 "project/radare2/libr/io/p/io_r2k_linux.c"
            sizeof (struct r2k_data)
# 529 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
            ) & 0x1fff) << 16) | (((
# 529 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 529 "project/radare2/libr/io/p/io_r2k_linux.c"
  ...
  case 'p':
   ...
   ioctl_n = 
# 546 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
            ((__uint32_t)0x40000000 | ((sizeof(
# 546 "project/radare2/libr/io/p/io_r2k_linux.c"
            sizeof (struct r2k_data)
# 546 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
            ) & 0x1fff) << 16) | (((
# 546 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 546 "project/radare2/libr/io/p/io_r2k_linux.c"
  ...
  case 'P':
   ...
   ioctl_n = 
# 563 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
            ((__uint32_t)0x40000000 | ((sizeof(
# 563 "project/radare2/libr/io/p/io_r2k_linux.c"
            sizeof (struct r2k_data)
# 563 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
            ) & 0x1fff) << 16) | (((
# 563 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 563 "project/radare2/libr/io/p/io_r2k_linux.c"
  ...
  len = strlen (buf);
  databuf = (
# 574 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
            unsigned char 
# 574 "project/radare2/libr/io/p/io_r2k_linux.c"
                *) calloc (len + 1, 1);
  if (databuf) {
   if (inphex) {
...
# 579 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
   __builtin___memcpy_chk (
# 579 "project/radare2/libr/io/p/io_r2k_linux.c"
   databuf
# 579 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
   , 
# 579 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 579 "project/radare2/libr/io/p/io_r2k_linux.c"
   ...
   ret = WriteMemory (io, iodesc, ioctl_n, pid, addr, (const 
# 582 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                                            unsigned char 
# 582 "project/radare2/libr/io/p/io_r2k_linux.c"
                                                                *) databuf, len);
  } else {
   
# 584 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
  fprintf(__stderrp,
# 584 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 594 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                            29
# 594 "project/radare2/libr/io/p/io_r2k_linux.c"
                                        );

   ioctl_n = 
# 596 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
            ((__uint32_t)0x40000000 | ((sizeof(
# 596 "project/radare2/libr/io/p/io_r2k_linux.c"
            sizeof (struct r2k_kernel_maps)
# 596 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
            ) & 0x1fff) << 16) | (((
# 596 "project/radare2/libr/io/p/io_r2k_linux.c"
            0x69
...
# 600 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                               (*__error())
# 600 "project/radare2/libr/io/p/io_r2k_linux.c"
                                                    ));
    break;
   }

   io->cb_printf ("map_data.size: %d, map_data.n_entries: %d\n", map_data.size, map_data.n_entries);
   info = mmap (0, map_data.size, 
# 605 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                 0x01
# 605 "project/radare2/libr/io/p/io_r2k_linux.c"
                                          , 
# 605 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                            0x0001
# 605 "project/radare2/libr/io/p/io_r2k_linux.c"
                                                      , (int)(size_t)iodesc->data, 0);
   if (info == 
# 606 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
              ((void *)-1)
# 606 "project/radare2/libr/io/p/io_r2k_linux.c"
                        ) {
    io->cb_printf ("mmap err: %s\n", strerror (
# 607 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                              (*__error())
# 607 "project/radare2/libr/io/p/io_r2k_linux.c"
                                                   ));
    break;
   }
   ...
   for (i = 0; i < map_data.n_entries; i++) {
    ...
    io->cb_printf ("start_addr: 0x%"
# 613 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                   "llx"
# 613 "project/radare2/libr/io/p/io_r2k_linux.c"
                                          "\n", (
# 613 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                                 unsigned long long
# 613 "project/radare2/libr/io/p/io_r2k_linux.c"
                                                     ) in->start_addr);
    io->cb_printf ("end_addr: 0x%"
# 614 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                 "llx"
# 614 "project/radare2/libr/io/p/io_r2k_linux.c"
                                        "\n", (
# 614 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                               unsigned long long
# 614 "project/radare2/libr/io/p/io_r2k_linux.c"
    ...
    for (j = 0; j < in->n_phys_addr; j++) {
     io->cb_printf ("  phys_addr: 0x%"
# 618 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                     "llx"
# 618 "project/radare2/libr/io/p/io_r2k_linux.c"
                                            "\n", (
# 618 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                                   unsigned long long
# 618 "project/radare2/libr/io/p/io_r2k_linux.c"
 ...
 case 'R':
  {
   ...
   ioctl_n = 
# 633 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
            ((__uint32_t)0x40000000 | ((sizeof(
# 633 "project/radare2/libr/io/p/io_r2k_linux.c"
            sizeof (struct r2k_control_reg)
# 633 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
            ) & 0x1fff) << 16) | (((
# 633 "project/radare2/libr/io/p/io_r2k_linux.c"
            0x69
...
# 633 "project/radare2/libr/io/p/io_r2k_linux.c"
   ...
   if (ret) {
    io->cb_printf ("ioctl err: %s\n", strerror (
# 637 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                               (*__error())
# 637 "project/radare2/libr/io/p/io_r2k_linux.c"
                                                    ));
    break;
   }
   ...
   if (buf[1] != 0 && buf[1] == 'p') {
    ...
    io->cb_printf ("cr0 = 0x%"
# 647 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                             "llx"
# 647 "project/radare2/libr/io/p/io_r2k_linux.c"
                                    "\n", (
# 647 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                           unsigned long long
# 647 "project/radare2/libr/io/p/io_r2k_linux.c"
    ...
    io->cb_printf ("cr1 = 0x%"
# 648 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                             "llx"
# 648 "project/radare2/libr/io/p/io_r2k_linux.c"
                                    "\n", (
# 648 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                           unsigned long long
# 648 "project/radare2/libr/io/p/io_r2k_linux.c"
    ...
    io->cb_printf ("cr2 = 0x%"
# 649 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                             "llx"
# 649 "project/radare2/libr/io/p/io_r2k_linux.c"
                                    "\n", (
# 649 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                           unsigned long long
# 649 "project/radare2/libr/io/p/io_r2k_linux.c"
    ...
    io->cb_printf ("cr3 = 0x%"
# 650 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                             "llx"
# 650 "project/radare2/libr/io/p/io_r2k_linux.c"
                                    "\n", (
# 650 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                           unsigned long long
# 650 "project/radare2/libr/io/p/io_r2k_linux.c"
    ...
    io->cb_printf ("cr4 = 0x%"
# 651 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                             "llx"
# 651 "project/radare2/libr/io/p/io_r2k_linux.c"
                                    "\n", (
# 651 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                           unsigned long long
# 651 "project/radare2/libr/io/p/io_r2k_linux.c"
    ...
    io->cb_printf ("cr8 = 0x%"
# 653 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                             "llx"
# 653 "project/radare2/libr/io/p/io_r2k_linux.c"
                                    "\n", (
# 653 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                           unsigned long long
# 653 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 676 "project/radare2/libr/io/p/io_r2k_linux.c"
  }
  break;
 case 'p':
  {
...
# 682 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
  unsigned long long 
# 682 "project/radare2/libr/io/p/io_r2k_linux.c"
       i;
   
# 683 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
  unsigned long long 
# 683 "project/radare2/libr/io/p/io_r2k_linux.c"
       nextstart;
   
# 684 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
  unsigned long long 
# 684 "project/radare2/libr/io/p/io_r2k_linux.c"
       buffsize;
   
# 685 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
  _Bool 
# 685 "project/radare2/libr/io/p/io_r2k_linux.c"
       fflag = 0;
   ...
   proc_data.pid = pid;
   ioctl_n = 
# 713 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
            ((__uint32_t)0x40000000 | ((sizeof(
# 713 "project/radare2/libr/io/p/io_r2k_linux.c"
            sizeof (struct r2k_data)
# 713 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
            ) & 0x1fff) << 16) | (((
# 713 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 713 "project/radare2/libr/io/p/io_r2k_linux.c"
   ...
   if (ret) {
    io->cb_printf ("ioctl err: %s\n", strerror (
# 717 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                               (*__error())
# 717 "project/radare2/libr/io/p/io_r2k_linux.c"
                                                    ));
    break;
   }

   buffsize = (
# 721 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
              unsigned long long
# 721 "project/radare2/libr/io/p/io_r2k_linux.c"
                  ) (sizeof (proc_data.vmareastruct) / sizeof (proc_data.vmareastruct[0]));
   if (fflag) {
    int j = 0;
    for (i = 0; i + 1 < buffsize;) {
     ...
     io->cb_printf ("f pid.%d.%s.%d.start=0x%"
# 734 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                             "llx"
# 734 "project/radare2/libr/io/p/io_r2k_linux.c"
                                                    "\n", proc_data.pid, (char*)&(proc_data.vmareastruct[i + 7]), j, (
# 734 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                                                                                                      unsigned long long
# 734 "project/radare2/libr/io/p/io_r2k_linux.c"
                                                                                                                          ) proc_data.vmareastruct[i]);
     io->cb_printf ("f pid.%d.%s.%d.end=0x%"
# 735 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                           "llx"
# 735 "project/radare2/libr/io/p/io_r2k_linux.c"
                                                  "\n", proc_data.pid, (char*)&(proc_data.vmareastruct[i + 7]), j, (
# 735 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                                                                                                    unsigned long long
# 735 "project/radare2/libr/io/p/io_r2k_linux.c"
    ...
    for (i = 0; i < buffsize && i + 8 < sizeof (proc_data.vmareastruct) ;) {
     ...
     io->cb_printf ("0x%08"
# 752 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                          "llx"
# 752 "project/radare2/libr/io/p/io_r2k_linux.c"
                                 " - 0x%08"
# 752 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                           "llx"
# 752 "project/radare2/libr/io/p/io_r2k_linux.c"
...
# 752 "project/radare2/libr/io/p/io_r2k_linux.c"
                                                                                                   "",
       (
# 753 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
       unsigned long long
# 753 "project/radare2/libr/io/p/io_r2k_linux.c"
           ) proc_data.vmareastruct[i], (
# 753 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                         unsigned long long
# 753 "project/radare2/libr/io/p/io_r2k_linux.c"
                                             ) proc_data.vmareastruct[i+1],
       proc_data.vmareastruct[i + 2] & 0x1 ? 'r' : '-',
       proc_data.vmareastruct[i + 2] & 0x2 ? 'w' : '-',
       proc_data.vmareastruct[i + 2] & 0x4 ? 'x' : '-',
       proc_data.vmareastruct[i + 2] & 0x80 ? 's' : 'p',
       (
# 758 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
       unsigned long long
# 758 "project/radare2/libr/io/p/io_r2k_linux.c"
           ) proc_data.vmareastruct[i + 3], proc_data.vmareastruct[i + 4],
       proc_data.vmareastruct[i + 5], (
# 759 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                                      unsigned long long
# 759 "project/radare2/libr/io/p/io_r2k_linux.c"
                                          ) proc_data.vmareastruct[i + 6]);
 ...
 default:
  {
   print_help (io, 
# 769 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                  ((void *)0)
# 769 "project/radare2/libr/io/p/io_r2k_linux.c"
                      , 1);
  }
 }
 end:
...
int run_new_command(RIO *io, RIODesc *iodesc, const char *buf) {
 ...
 if (r_str_startswith (buf, "e r2k.wp")) {
  ...
  if (eq) {
   int v = atoi (eq + 1);
   r2k_struct.wp = (
# 838 "project/radare2/libr/io/p/io_r2k_linux.c" 3 4
                   unsigned char
# 838 "project/radare2/libr/io/p/io_r2k_linux.c"
                      )v;
  } else {
