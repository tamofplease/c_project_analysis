# 0 "project/radare2/libr/io/p/io_tcpslurp.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/io/p/io_tcpslurp.c" 2
...
# 5 "project/radare2/libr/io/p/io_tcpslurp.c" 2
...
# 17 "project/radare2/libr/io/p/../io_memory.h"
                                                count);
# 8 "project/radare2/libr/io/p/io_tcpslurp.c" 2

static 
# 9 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
      _Bool 
# 9 "project/radare2/libr/io/p/io_tcpslurp.c"
...
static 
# 13 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
      unsigned char 
# 13 "project/radare2/libr/io/p/io_tcpslurp.c"
          *tcpme(const char *pathname, int *code, int *len) {
 pathname += strlen ("tcp-slurp://");
 *code = 404;

 r_sys_signal (
# 17 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
              2
# 17 "project/radare2/libr/io/p/io_tcpslurp.c"
                    , 
# 17 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
                      (void (*)(int))1
# 17 "project/radare2/libr/io/p/io_tcpslurp.c"
...
# 20 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
 fprintf(__stderrp,
# 20 "project/radare2/libr/io/p/io_tcpslurp.c"
 "Usage: $ nc -l -p 9999 < /bin/ls ; r2 tcp-slurp://localhost:9999\n"
# 20 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
 )
# 20 "project/radare2/libr/io/p/io_tcpslurp.c"
                                                                               ;
  
# 21 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
 fprintf(__stderrp,
# 21 "project/radare2/libr/io/p/io_tcpslurp.c"
 "   or: $ nc localhost 9999 < /bin/ls ; r2 tcp-slurp://:9999\n"
# 21 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
 )
# 21 "project/radare2/libr/io/p/io_tcpslurp.c"
                                                                          ;
  ...
  RSocket *sl = r_socket_new (
# 24 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
                             0
# 24 "project/radare2/libr/io/p/io_tcpslurp.c"
                                  );
  if (!r_socket_listen (sl, pathname + 1, 
# 25 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
                                         ((void *)0)
# 25 "project/radare2/libr/io/p/io_tcpslurp.c"
                                             )) {
   
# 26 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
  fprintf(__stderrp,
# 26 "project/radare2/libr/io/p/io_tcpslurp.c"
  "Cannot listen\n"
# 26 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
  )
# 26 "project/radare2/libr/io/p/io_tcpslurp.c"
   ...
   r_socket_free (sl);
   return 
# 28 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
         ((void *)0)
# 28 "project/radare2/libr/io/p/io_tcpslurp.c"
             ;
  }
  RSocket *sc = r_socket_accept (sl);
  
# 31 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
 unsigned char 
# 31 "project/radare2/libr/io/p/io_tcpslurp.c"
     *res = r_socket_slurp (sc, len);
  r_socket_free (sc);
  r_socket_free (sl);
  if (res) {
   *code = 200;
  ...
  if (!host) {
   return 
# 42 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
         ((void *)0)
# 42 "project/radare2/libr/io/p/io_tcpslurp.c"
             ;
  }
...
# 47 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
                             0
# 47 "project/radare2/libr/io/p/io_tcpslurp.c"
                                  );
   if (r_socket_connect (s, host, port, 
# 48 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
                                       6
# 48 "project/radare2/libr/io/p/io_tcpslurp.c"
                                                         , 0)) {
    
# 49 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
   unsigned char 
# 49 "project/radare2/libr/io/p/io_tcpslurp.c"
       *res = r_socket_slurp (s, len);
    if (*len < 1) {
     
# 51 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
    { free((void *)
# 51 "project/radare2/libr/io/p/io_tcpslurp.c"
    res
# 51 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
    ); 
# 51 "project/radare2/libr/io/p/io_tcpslurp.c"
...
# 61 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
  fprintf(__stderrp,
# 61 "project/radare2/libr/io/p/io_tcpslurp.c"
  "Missing port.\n"
# 61 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
  )
# 61 "project/radare2/libr/io/p/io_tcpslurp.c"
 ...
 return 
# 65 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
       ((void *)0)
# 65 "project/radare2/libr/io/p/io_tcpslurp.c"
           ;
}
...
static RIODesc *__open(RIO *io, const char *pathname, int rw, int mode) {
 if (__check (io, pathname, 0)) {
  int rlen, code;
  RIOMalloc *mal = 
# 71 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
                  (
# 71 "project/radare2/libr/io/p/io_tcpslurp.c"
                  RIOMalloc
# 71 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
                  *)calloc(1,sizeof(
# 71 "project/radare2/libr/io/p/io_tcpslurp.c"
...
# 71 "project/radare2/libr/io/p/io_tcpslurp.c"
  ...
  if (!mal) {
   return 
# 73 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
         ((void *)0)
# 73 "project/radare2/libr/io/p/io_tcpslurp.c"
             ;
  }
  mal->offset = 0;
 ...
 return 
# 83 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
       ((void *)0)
# 83 "project/radare2/libr/io/p/io_tcpslurp.c"
           ;
}
...
# 100 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
__attribute__((visibility("default"))) 
# 100 "project/radare2/libr/io/p/io_tcpslurp.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_tcpslurp,
 .version = 
# 103 "project/radare2/libr/io/p/io_tcpslurp.c" 3 4
           "5.5.4"

# 104 "project/radare2/libr/io/p/io_tcpslurp.c"
};
