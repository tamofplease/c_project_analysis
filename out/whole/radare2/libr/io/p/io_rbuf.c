# 0 "project/radare2/libr/io/p/io_rbuf.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/io/p/io_rbuf.c"
...
# 4 "project/radare2/libr/io/p/io_rbuf.c" 2
...
# 5 "project/radare2/libr/io/p/io_rbuf.c" 2
...
# 10 "project/radare2/libr/io/p/io_rbuf.c"
static int __write(RIO *io, RIODesc *fd, const 
# 10 "project/radare2/libr/io/p/io_rbuf.c" 3 4
                                              unsigned char 
# 10 "project/radare2/libr/io/p/io_rbuf.c"
                                                  *buf, int count) {
...
# 18 "project/radare2/libr/io/p/io_rbuf.c" 3 4
                                       unsigned char 
# 18 "project/radare2/libr/io/p/io_rbuf.c"
                                           *buf, int count) {
 RBuffer *b = fd->data;
...
static 
# 23 "project/radare2/libr/io/p/io_rbuf.c" 3 4
      _Bool 
# 23 "project/radare2/libr/io/p/io_rbuf.c"
           __close(RIODesc *fd) {
 RBuffer *b = fd->data;
 r_buf_free (b);
 return 
# 26 "project/radare2/libr/io/p/io_rbuf.c" 3 4
       1
# 26 "project/radare2/libr/io/p/io_rbuf.c"
           ;
}

static 
# 29 "project/radare2/libr/io/p/io_rbuf.c" 3 4
      unsigned long long 
# 29 "project/radare2/libr/io/p/io_rbuf.c"
...
static 
# 34 "project/radare2/libr/io/p/io_rbuf.c" 3 4
      _Bool 
# 34 "project/radare2/libr/io/p/io_rbuf.c"
...
static RIODesc *__open(RIO *io, const char *pathname, int rw, int mode) {
 ...
 r_buf_free (buf);
 return 
# 45 "project/radare2/libr/io/p/io_rbuf.c" 3 4
       ((void *)0)
# 45 "project/radare2/libr/io/p/io_rbuf.c"
           ;
}
...
# 62 "project/radare2/libr/io/p/io_rbuf.c" 3 4
__attribute__((visibility("default"))) 
# 62 "project/radare2/libr/io/p/io_rbuf.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_IO,
 .data = &r_io_plugin_rbuf,
 .version = 
# 65 "project/radare2/libr/io/p/io_rbuf.c" 3 4
           "5.5.4"

# 66 "project/radare2/libr/io/p/io_rbuf.c"
};
