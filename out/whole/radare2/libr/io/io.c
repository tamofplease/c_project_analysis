# 0 "project/radare2/libr/io/io.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/io/io.c"
...
# 4 "project/radare2/libr/io/io.c" 2

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/sdb/src/config.h" 1 3 4
# 6 "project/radare2/libr/io/io.c" 2

__attribute__((visibility("default"))) const char *
# 7 "project/radare2/libr/io/io.c"
r_io_version
# 7 "project/radare2/libr/io/io.c" 3 4
(void) { return "" "5.5.4"; }
# 7 "project/radare2/libr/io/io.c"
                   ;


# 9 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) 
# 9 "project/radare2/libr/io/io.c"
     RIO* r_io_new(void) {
 return r_io_init (
# 10 "project/radare2/libr/io/io.c" 3 4
                  (
# 10 "project/radare2/libr/io/io.c"
                  RIO
# 10 "project/radare2/libr/io/io.c" 3 4
                  *)calloc(1,sizeof(
# 10 "project/radare2/libr/io/io.c"
...
# 13 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) 
# 13 "project/radare2/libr/io/io.c"
     RIO* r_io_init(RIO* io) {
 
# 14 "project/radare2/libr/io/io.c" 3 4
do { if (!(
# 14 "project/radare2/libr/io/io.c"
io
# 14 "project/radare2/libr/io/io.c" 3 4
...
# 32 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) 
# 32 "project/radare2/libr/io/io.c"
...
# 40 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) 
# 40 "project/radare2/libr/io/io.c"
     RIODesc *r_io_open_buffer(RIO *io, RBuffer *b, int perm, int mode) {
 
# 41 "project/radare2/libr/io/io.c" 3 4
unsigned long long 
# 41 "project/radare2/libr/io/io.c"
     bufSize = r_buf_size (b);
 char *uri = r_str_newf ("malloc://%" 
# 42 "project/radare2/libr/io/io.c" 3 4
                                     "lld"
# 42 "project/radare2/libr/io/io.c"
                                            , bufSize);
 RIODesc *desc = r_io_open_nomap (io, uri, perm, mode);
 if (desc) {
  const 
# 45 "project/radare2/libr/io/io.c" 3 4
       unsigned char 
# 45 "project/radare2/libr/io/io.c"
           *tmp = r_buf_data (b, &bufSize);
...
# 52 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) 
# 52 "project/radare2/libr/io/io.c"
     RIODesc *r_io_open_nomap(RIO *io, const char *uri, int perm, int mode) {
 
# 53 "project/radare2/libr/io/io.c" 3 4
do { if (!(
# 53 "project/radare2/libr/io/io.c"
io && uri
# 53 "project/radare2/libr/io/io.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 53 "project/radare2/libr/io/io.c"
...
# 63 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) 
# 63 "project/radare2/libr/io/io.c"
     RIODesc* r_io_open(RIO* io, const char* uri, int perm, int mode) {
 
# 64 "project/radare2/libr/io/io.c" 3 4
do { if (!(
# 64 "project/radare2/libr/io/io.c"
io
# 64 "project/radare2/libr/io/io.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 64 "project/radare2/libr/io/io.c"
...
# 73 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) 
# 73 "project/radare2/libr/io/io.c"
     RIODesc* r_io_open_at(RIO* io, const char* uri, int perm, int mode, 
# 73 "project/radare2/libr/io/io.c" 3 4
                                                                         unsigned long long 
# 73 "project/radare2/libr/io/io.c"
                                                                              at) {
 
# 74 "project/radare2/libr/io/io.c" 3 4
do { if (!(
# 74 "project/radare2/libr/io/io.c"
io && uri
# 74 "project/radare2/libr/io/io.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 74 "project/radare2/libr/io/io.c"
...
# 74 "project/radare2/libr/io/io.c"
 ...
 if (!desc) {
  return 
# 78 "project/radare2/libr/io/io.c" 3 4
        ((void *)0)
# 78 "project/radare2/libr/io/io.c"
            ;
 }
 
# 80 "project/radare2/libr/io/io.c" 3 4
unsigned long long 
# 80 "project/radare2/libr/io/io.c"
     size = r_io_desc_size (desc);
# 90 "project/radare2/libr/io/io.c"
...
# 95 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) 
# 95 "project/radare2/libr/io/io.c"
     RList* r_io_open_many(RIO* io, const char* uri, int perm, int mode) {
 RList* desc_list;
 RListIter* iter;
 RIODesc* desc;
 
# 99 "project/radare2/libr/io/io.c" 3 4
do { if (!(
# 99 "project/radare2/libr/io/io.c"
io && io->files && uri
# 99 "project/radare2/libr/io/io.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 99 "project/radare2/libr/io/io.c"
...
# 99 "project/radare2/libr/io/io.c"
 ...
 if (!plugin || !plugin->open_many || !plugin->close) {
  return 
# 102 "project/radare2/libr/io/io.c" 3 4
        ((void *)0)
# 102 "project/radare2/libr/io/io.c"
            ;
 }
 if (!(desc_list = plugin->open_many (io, uri, perm, mode))) {
  return 
# 105 "project/radare2/libr/io/io.c" 3 4
        ((void *)0)
# 105 "project/radare2/libr/io/io.c"
            ;
 }
 
# 107 "project/radare2/libr/io/io.c" 3 4
if (
# 107 "project/radare2/libr/io/io.c"
desc_list
# 107 "project/radare2/libr/io/io.c" 3 4
) for (
# 107 "project/radare2/libr/io/io.c"
...
# 107 "project/radare2/libr/io/io.c"
 ...
 desc_list->free = 
# 123 "project/radare2/libr/io/io.c" 3 4
                  ((void *)0)
# 123 "project/radare2/libr/io/io.c"
                      ;
 return desc_list;
}
# 147 "project/radare2/libr/io/io.c"

# 147 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 147 "project/radare2/libr/io/io.c"
          r_io_reopen(RIO* io, int fd, int perm, int mode) {
 RIODesc *od = r_io_desc_get (io, fd);
 if (!od) {
  return 
# 150 "project/radare2/libr/io/io.c" 3 4
        0
# 150 "project/radare2/libr/io/io.c"
             ;
 }
 ...
 if (nd) {
  ...
  r_io_desc_close (od);
  if (nd->perm & 
# 157 "project/radare2/libr/io/io.c" 3 4
                2
# 157 "project/radare2/libr/io/io.c"
                        ) {
   io->corebind.cmdf (io->corebind.core, "omfg");
  }
  return 
# 160 "project/radare2/libr/io/io.c" 3 4
        1
# 160 "project/radare2/libr/io/io.c"
            ;
 }
 
# 162 "project/radare2/libr/io/io.c" 3 4
fprintf(__stderrp,
# 162 "project/radare2/libr/io/io.c"
"Cannot reopen\n"
# 162 "project/radare2/libr/io/io.c" 3 4
)
# 162 "project/radare2/libr/io/io.c"
                           ;
 return 
# 163 "project/radare2/libr/io/io.c" 3 4
       0
# 163 "project/radare2/libr/io/io.c"
            ;
}



# 167 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) 
# 167 "project/radare2/libr/io/io.c"
     void r_io_close_all(RIO* io) {
 
# 168 "project/radare2/libr/io/io.c" 3 4
do { if (!(
# 168 "project/radare2/libr/io/io.c"
io
# 168 "project/radare2/libr/io/io.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 168 "project/radare2/libr/io/io.c"
...
# 178 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) 
# 178 "project/radare2/libr/io/io.c"
     int r_io_pread_at(RIO* io, 
# 178 "project/radare2/libr/io/io.c" 3 4
                                unsigned long long 
# 178 "project/radare2/libr/io/io.c"
                                     paddr, 
...
# 179 "project/radare2/libr/io/io.c" 3 4
do { if (!(
# 179 "project/radare2/libr/io/io.c"
io && buf && len >= 0
# 179 "project/radare2/libr/io/io.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 179 "project/radare2/libr/io/io.c"
...
# 181 "project/radare2/libr/io/io.c" 3 4
 __builtin___memset_chk (
# 181 "project/radare2/libr/io/io.c"
 buf
# 181 "project/radare2/libr/io/io.c" 3 4
 , 
# 181 "project/radare2/libr/io/io.c"
...
# 186 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) 
# 186 "project/radare2/libr/io/io.c"
     int r_io_pwrite_at(RIO* io, 
# 186 "project/radare2/libr/io/io.c" 3 4
                                 unsigned long long 
# 186 "project/radare2/libr/io/io.c"
                                      paddr, const 
...
# 187 "project/radare2/libr/io/io.c" 3 4
do { if (!(
# 187 "project/radare2/libr/io/io.c"
io && buf && len > 0
# 187 "project/radare2/libr/io/io.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 187 "project/radare2/libr/io/io.c"
...
# 192 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 192 "project/radare2/libr/io/io.c"
          r_io_vread_at(RIO *io, 
# 192 "project/radare2/libr/io/io.c" 3 4
                                 unsigned long long 
# 192 "project/radare2/libr/io/io.c"
                                      vaddr, 
...
# 193 "project/radare2/libr/io/io.c" 3 4
do { if (!(
# 193 "project/radare2/libr/io/io.c"
io && buf && len > 0
# 193 "project/radare2/libr/io/io.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 193 "project/radare2/libr/io/io.c"
"io && buf && len > 0"
# 193 "project/radare2/libr/io/io.c" 3 4
, 193); return (0); } } while (0)
# 193 "project/radare2/libr/io/io.c"
                                                  ;
 if ((
# 194 "project/radare2/libr/io/io.c" 3 4
     0xFFFFFFFFFFFFFFFFULL 
# 194 "project/radare2/libr/io/io.c"
              - (len - 1)) < vaddr) {
  int _len = 
# 195 "project/radare2/libr/io/io.c" 3 4
            0xFFFFFFFFFFFFFFFFULL 
# 195 "project/radare2/libr/io/io.c"
                     - vaddr + 1;
  len -= _len;
  if (!r_io_vread_at (io, 0ULL, &buf[_len], len)) {
   return 
# 198 "project/radare2/libr/io/io.c" 3 4
         0
# 198 "project/radare2/libr/io/io.c"
              ;
  }
  len = _len;
 }
...
# 203 "project/radare2/libr/io/io.c" 3 4
 __builtin___memset_chk (
# 203 "project/radare2/libr/io/io.c"
 buf
# 203 "project/radare2/libr/io/io.c" 3 4
 , 
# 203 "project/radare2/libr/io/io.c"
...
# 208 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 208 "project/radare2/libr/io/io.c"
          r_io_vwrite_at(RIO *io, 
# 208 "project/radare2/libr/io/io.c" 3 4
                                  unsigned long long 
# 208 "project/radare2/libr/io/io.c"
                                       vaddr, const 
...
# 209 "project/radare2/libr/io/io.c" 3 4
do { if (!(
# 209 "project/radare2/libr/io/io.c"
io && buf && len > 0
# 209 "project/radare2/libr/io/io.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 209 "project/radare2/libr/io/io.c"
"io && buf && len > 0"
# 209 "project/radare2/libr/io/io.c" 3 4
, 209); return (0); } } while (0)
# 209 "project/radare2/libr/io/io.c"
                                                  ;
 if ((
# 210 "project/radare2/libr/io/io.c" 3 4
     0xFFFFFFFFFFFFFFFFULL 
# 210 "project/radare2/libr/io/io.c"
              - (len - 1)) < vaddr) {
  int _len = 
# 211 "project/radare2/libr/io/io.c" 3 4
            0xFFFFFFFFFFFFFFFFULL 
# 211 "project/radare2/libr/io/io.c"
                     - vaddr + 1;
  len -= _len;
  if (!r_io_vwrite_at (io, 0ULL, &buf[_len], len)) {
   return 
# 214 "project/radare2/libr/io/io.c" 3 4
         0
# 214 "project/radare2/libr/io/io.c"
              ;
  }
  len = _len;
 }
...
static 
# 221 "project/radare2/libr/io/io.c" 3 4
      _Bool 
# 221 "project/radare2/libr/io/io.c"
           internal_r_io_read_at(RIO *io, 
# 221 "project/radare2/libr/io/io.c" 3 4
                                          unsigned long long 
# 221 "project/radare2/libr/io/io.c"
                                               addr, 
...
# 221 "project/radare2/libr/io/io.c"
 ...
 if (len < 1) {
  return 
# 223 "project/radare2/libr/io/io.c" 3 4
        0
# 223 "project/radare2/libr/io/io.c"
             ;
 }
 
# 225 "project/radare2/libr/io/io.c" 3 4
_Bool 
# 225 "project/radare2/libr/io/io.c"
     ret = (io->va)
  ? r_io_vread_at (io, addr, buf, len)
  : r_io_pread_at (io, addr, buf, len) > 0;
 if (io->cached & 
# 228 "project/radare2/libr/io/io.c" 3 4
                 4
# 228 "project/radare2/libr/io/io.c"
                         ) {
...
# 239 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 239 "project/radare2/libr/io/io.c"
          r_io_read_at(RIO *io, 
# 239 "project/radare2/libr/io/io.c" 3 4
                                unsigned long long 
# 239 "project/radare2/libr/io/io.c"
...
# 240 "project/radare2/libr/io/io.c" 3 4
do { if (!(
# 240 "project/radare2/libr/io/io.c"
io && buf && len >= 0
# 240 "project/radare2/libr/io/io.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 240 "project/radare2/libr/io/io.c"
...
# 240 "project/radare2/libr/io/io.c"
 ...
 if (len == 0) {
  return 
# 242 "project/radare2/libr/io/io.c" 3 4
        0
# 242 "project/radare2/libr/io/io.c"
             ;
 }
 if (io->mask) {
  
# 245 "project/radare2/libr/io/io.c" 3 4
 unsigned long long 
# 245 "project/radare2/libr/io/io.c"
      p = addr;
  
# 246 "project/radare2/libr/io/io.c" 3 4
 unsigned char 
# 246 "project/radare2/libr/io/io.c"
     *b = buf;
  size_t q = 0;
  while (q < len) {
   p &= io->mask;
   ...
   if (!internal_r_io_read_at (io, p, buf + q, sz)) {
    return 
# 256 "project/radare2/libr/io/io.c" 3 4
          0
# 256 "project/radare2/libr/io/io.c"
               ;
   }
   q += sz;
   b += sz;
  ...
  return 
# 262 "project/radare2/libr/io/io.c" 3 4
        1
# 262 "project/radare2/libr/io/io.c"
            ;
 }
...
# 271 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 271 "project/radare2/libr/io/io.c"
          r_io_read_at_mapped(RIO *io, 
# 271 "project/radare2/libr/io/io.c" 3 4
                                       unsigned long long 
# 271 "project/radare2/libr/io/io.c"
                                            addr, 
...
# 272 "project/radare2/libr/io/io.c" 3 4
_Bool 
# 272 "project/radare2/libr/io/io.c"
     ret;
 
# 273 "project/radare2/libr/io/io.c" 3 4
do { if (!(
# 273 "project/radare2/libr/io/io.c"
io && buf
# 273 "project/radare2/libr/io/io.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 273 "project/radare2/libr/io/io.c"
"io && buf"
# 273 "project/radare2/libr/io/io.c" 3 4
, 273); return (0); } } while (0)
# 273 "project/radare2/libr/io/io.c"
                                       ;
 if (io->ff) {
  
# 275 "project/radare2/libr/io/io.c" 3 4
 __builtin___memset_chk (
# 275 "project/radare2/libr/io/io.c"
 buf
# 275 "project/radare2/libr/io/io.c" 3 4
 , 
# 275 "project/radare2/libr/io/io.c"
...
# 275 "project/radare2/libr/io/io.c"
 ...
 if (io->cached & 
# 282 "project/radare2/libr/io/io.c" 3 4
                 4
# 282 "project/radare2/libr/io/io.c"
                         ) {
  (void)r_io_cache_read(io, addr, buf, len);
 }
 return ret;
...
# 291 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) 
# 291 "project/radare2/libr/io/io.c"
     int r_io_nread_at(RIO *io, 
# 291 "project/radare2/libr/io/io.c" 3 4
                                unsigned long long 
# 291 "project/radare2/libr/io/io.c"
                                     addr, 
...
# 293 "project/radare2/libr/io/io.c" 3 4
do { if (!(
# 293 "project/radare2/libr/io/io.c"
io && buf && len >= 0
# 293 "project/radare2/libr/io/io.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 293 "project/radare2/libr/io/io.c"
...
# 299 "project/radare2/libr/io/io.c" 3 4
  __builtin___memset_chk (
# 299 "project/radare2/libr/io/io.c"
  buf
# 299 "project/radare2/libr/io/io.c" 3 4
  , 
# 299 "project/radare2/libr/io/io.c"
...
# 299 "project/radare2/libr/io/io.c"
 ...
 if (ret > 0 && io->cached & 
# 305 "project/radare2/libr/io/io.c" 3 4
                            4
# 305 "project/radare2/libr/io/io.c"
                                    ) {
  (void)r_io_cache_read (io, addr, buf, len);
 }
 return ret;
...
# 311 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 311 "project/radare2/libr/io/io.c"
          r_io_write_at(RIO* io, 
# 311 "project/radare2/libr/io/io.c" 3 4
                                 unsigned long long 
# 311 "project/radare2/libr/io/io.c"
                                      addr, const 
...
# 312 "project/radare2/libr/io/io.c" 3 4
do { if (!(
# 312 "project/radare2/libr/io/io.c"
io && buf && len > 0
# 312 "project/radare2/libr/io/io.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 312 "project/radare2/libr/io/io.c"
"io && buf && len > 0"
# 312 "project/radare2/libr/io/io.c" 3 4
, 312); return (0); } } while (0)
# 312 "project/radare2/libr/io/io.c"
                                                  ;
 
# 313 "project/radare2/libr/io/io.c" 3 4
_Bool 
# 313 "project/radare2/libr/io/io.c"
     ret = 
# 313 "project/radare2/libr/io/io.c" 3 4
           0
# 313 "project/radare2/libr/io/io.c"
...
# 314 "project/radare2/libr/io/io.c" 3 4
unsigned char 
# 314 "project/radare2/libr/io/io.c"
    *mybuf = (
# 314 "project/radare2/libr/io/io.c" 3 4
              unsigned char
# 314 "project/radare2/libr/io/io.c"
 ...
 if (io->cached & 
# 323 "project/radare2/libr/io/io.c" 3 4
                 2
# 323 "project/radare2/libr/io/io.c"
                         ) {
...
# 336 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 336 "project/radare2/libr/io/io.c"
          r_io_read(RIO* io, 
# 336 "project/radare2/libr/io/io.c" 3 4
                             unsigned char
# 336 "project/radare2/libr/io/io.c"
 ...
 if (io && r_io_read_at (io, io->off, buf, len)) {
  io->off += len;
  return 
# 339 "project/radare2/libr/io/io.c" 3 4
        1
# 339 "project/radare2/libr/io/io.c"
            ;
 }
 return 
# 341 "project/radare2/libr/io/io.c" 3 4
       0
# 341 "project/radare2/libr/io/io.c"
            ;
}


# 344 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 344 "project/radare2/libr/io/io.c"
          r_io_write(RIO* io, 
# 344 "project/radare2/libr/io/io.c" 3 4
                              unsigned char
# 344 "project/radare2/libr/io/io.c"
 ...
 if (io && buf && len > 0 && r_io_write_at (io, io->off, buf, len)) {
  io->off += len;
  return 
# 347 "project/radare2/libr/io/io.c" 3 4
        1
# 347 "project/radare2/libr/io/io.c"
            ;
 }
 return 
# 349 "project/radare2/libr/io/io.c" 3 4
       0
# 349 "project/radare2/libr/io/io.c"
            ;
}


# 352 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 352 "project/radare2/libr/io/io.c"
          r_io_size(RIO* io) {
...
# 357 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 357 "project/radare2/libr/io/io.c"
          r_io_is_listener(RIO* io) {
 if (io && io->desc && io->desc->plugin && io->desc->plugin->listener) {
  return io->desc->plugin->listener (io->desc);
 }
 return 
# 361 "project/radare2/libr/io/io.c" 3 4
       0
# 361 "project/radare2/libr/io/io.c"
            ;
}


# 364 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) 
# 364 "project/radare2/libr/io/io.c"
     char *r_io_system(RIO* io, const char* cmd) {
 if (io && io->desc && io->desc->plugin && io->desc->plugin->system) {
  return io->desc->plugin->system (io, io->desc, cmd);
 }
 return 
# 368 "project/radare2/libr/io/io.c" 3 4
       ((void *)0)
# 368 "project/radare2/libr/io/io.c"
           ;
}


# 371 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 371 "project/radare2/libr/io/io.c"
          r_io_resize(RIO* io, 
# 371 "project/radare2/libr/io/io.c" 3 4
                               unsigned long long 
# 371 "project/radare2/libr/io/io.c"
...
# 376 "project/radare2/libr/io/io.c" 3 4
 unsigned long long 
# 376 "project/radare2/libr/io/io.c"
      fd_size = r_io_fd_size (io, io->desc->fd);
  const 
# 377 "project/radare2/libr/io/io.c" 3 4
       _Bool 
# 377 "project/radare2/libr/io/io.c"
            ret = r_io_desc_resize (io->desc, newsize);
  
# 378 "project/radare2/libr/io/io.c" 3 4
 if (
# 378 "project/radare2/libr/io/io.c"
 maps
# 378 "project/radare2/libr/io/io.c" 3 4
 ) for (
# 378 "project/radare2/libr/io/io.c"
...
# 378 "project/radare2/libr/io/io.c"
   ...
   if (
# 380 "project/radare2/libr/io/io.c" 3 4
      r_itv_size (
# 380 "project/radare2/libr/io/io.c"
      current_map
# 380 "project/radare2/libr/io/io.c" 3 4
      ->itv) 
# 380 "project/radare2/libr/io/io.c"
 ...
 return 
# 387 "project/radare2/libr/io/io.c" 3 4
       0
# 387 "project/radare2/libr/io/io.c"
            ;
}


# 390 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 390 "project/radare2/libr/io/io.c"
          r_io_close(RIO *io) {
 return io ? r_io_desc_close (io->desc) : 
# 391 "project/radare2/libr/io/io.c" 3 4
                                         0
# 391 "project/radare2/libr/io/io.c"
                                              ;
}


# 394 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) 
# 394 "project/radare2/libr/io/io.c"
     int r_io_extend_at(RIO* io, 
# 394 "project/radare2/libr/io/io.c" 3 4
                                 unsigned long long 
# 394 "project/radare2/libr/io/io.c"
                                      addr, 
...
# 395 "project/radare2/libr/io/io.c" 3 4
unsigned long long 
# 395 "project/radare2/libr/io/io.c"
     cur_size, tmp_size;
 
# 396 "project/radare2/libr/io/io.c" 3 4
unsigned char
# 396 "project/radare2/libr/io/io.c"
   * buffer;
 if (!io || !io->desc || !io->desc->plugin || !size) {
  return 
# 398 "project/radare2/libr/io/io.c" 3 4
        0
# 398 "project/radare2/libr/io/io.c"
             ;
 }
 if (io->desc->plugin->extend) {
  int ret;
  
# 402 "project/radare2/libr/io/io.c" 3 4
 unsigned long long 
# 402 "project/radare2/libr/io/io.c"
      cur_off = io->off;
  r_io_seek (io, addr, 
# 403 "project/radare2/libr/io/io.c" 3 4
                      0
# 403 "project/radare2/libr/io/io.c"
                                   );
 ...
 if ((io->desc->perm & 
# 409 "project/radare2/libr/io/io.c" 3 4
                      (4|2)
# 409 "project/radare2/libr/io/io.c"
                               ) != 
# 409 "project/radare2/libr/io/io.c" 3 4
                                    (4|2)
# 409 "project/radare2/libr/io/io.c"
  ...
  return 
# 410 "project/radare2/libr/io/io.c" 3 4
        0
# 410 "project/radare2/libr/io/io.c"
             ;
 }
 cur_size = r_io_desc_size (io->desc);
 if (addr > cur_size) {
  return 
# 414 "project/radare2/libr/io/io.c" 3 4
        0
# 414 "project/radare2/libr/io/io.c"
             ;
 }
 if ((
# 416 "project/radare2/libr/io/io.c" 3 4
     0xFFFFFFFFFFFFFFFFULL 
# 416 "project/radare2/libr/io/io.c"
              - size) < cur_size) {
  return 
# 417 "project/radare2/libr/io/io.c" 3 4
        0
# 417 "project/radare2/libr/io/io.c"
             ;
 }
 if (!r_io_resize (io, cur_size + size)) {
  return 
# 420 "project/radare2/libr/io/io.c" 3 4
        0
# 420 "project/radare2/libr/io/io.c"
             ;
 }
 if ((tmp_size = cur_size - addr) == 0LL) {
  return 
# 423 "project/radare2/libr/io/io.c" 3 4
        1
# 423 "project/radare2/libr/io/io.c"
            ;
 }
 if (!(buffer = calloc (1, (size_t) tmp_size + 1))) {
  return 
# 426 "project/radare2/libr/io/io.c" 3 4
        0
# 426 "project/radare2/libr/io/io.c"
             ;
 }
 r_io_pread_at (io, addr, buffer, (int) tmp_size);

 
# 430 "project/radare2/libr/io/io.c" 3 4
unsigned char 
# 430 "project/radare2/libr/io/io.c"
    *empty = calloc (1, size);
 if (empty) {
 ...
 free (buffer);
 return 
# 437 "project/radare2/libr/io/io.c" 3 4
       1
# 437 "project/radare2/libr/io/io.c"
           ;
}


# 440 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 440 "project/radare2/libr/io/io.c"
          r_io_set_write_mask(RIO* io, const 
# 440 "project/radare2/libr/io/io.c" 3 4
                                             unsigned char
# 440 "project/radare2/libr/io/io.c"
                                                * mask, int len) {
 if (!io || len < 1) {
  return 
# 442 "project/radare2/libr/io/io.c" 3 4
        0
# 442 "project/radare2/libr/io/io.c"
             ;
 }
 free (io->write_mask);
 if (!mask) {
  io->write_mask = 
# 446 "project/radare2/libr/io/io.c" 3 4
                  ((void *)0)
# 446 "project/radare2/libr/io/io.c"
                      ;
  io->write_mask_len = 0;
  return 
# 448 "project/radare2/libr/io/io.c" 3 4
        1
# 448 "project/radare2/libr/io/io.c"
            ;
 }
 io->write_mask = (
# 450 "project/radare2/libr/io/io.c" 3 4
                  unsigned char
# 450 "project/radare2/libr/io/io.c"
                     *) malloc (len);
 
# 451 "project/radare2/libr/io/io.c" 3 4
__builtin___memcpy_chk (
# 451 "project/radare2/libr/io/io.c"
io->write_mask
# 451 "project/radare2/libr/io/io.c" 3 4
, 
# 451 "project/radare2/libr/io/io.c"
...
# 451 "project/radare2/libr/io/io.c"
 ...
 return 
# 453 "project/radare2/libr/io/io.c" 3 4
       1
# 453 "project/radare2/libr/io/io.c"
           ;
}


# 456 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 456 "project/radare2/libr/io/io.c"
          r_io_p2v(RIO *io, 
# 456 "project/radare2/libr/io/io.c" 3 4
                            unsigned long long 
# 456 "project/radare2/libr/io/io.c"
 ...
 if (map) {
  return pa - map->delta + 
# 459 "project/radare2/libr/io/io.c" 3 4
                          r_itv_begin (
# 459 "project/radare2/libr/io/io.c"
                          map
# 459 "project/radare2/libr/io/io.c" 3 4
                          ->itv)
# 459 "project/radare2/libr/io/io.c"
 ...
 return 
# 461 "project/radare2/libr/io/io.c" 3 4
       0xFFFFFFFFFFFFFFFFULL
# 461 "project/radare2/libr/io/io.c"
               ;
}


# 464 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 464 "project/radare2/libr/io/io.c"
          r_io_v2p(RIO *io, 
# 464 "project/radare2/libr/io/io.c" 3 4
                            unsigned long long 
# 464 "project/radare2/libr/io/io.c"
...
# 467 "project/radare2/libr/io/io.c" 3 4
 long long 
# 467 "project/radare2/libr/io/io.c"
      delta = va - 
# 467 "project/radare2/libr/io/io.c" 3 4
                   r_itv_begin (
# 467 "project/radare2/libr/io/io.c"
...
# 467 "project/radare2/libr/io/io.c"
                                       ;
  return 
# 468 "project/radare2/libr/io/io.c" 3 4
        r_itv_begin (
# 468 "project/radare2/libr/io/io.c"
        map
# 468 "project/radare2/libr/io/io.c" 3 4
        ->itv) 
# 468 "project/radare2/libr/io/io.c"
 ...
 return 
# 470 "project/radare2/libr/io/io.c" 3 4
       0xFFFFFFFFFFFFFFFFULL
# 470 "project/radare2/libr/io/io.c"
               ;
}


# 473 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) 
# 473 "project/radare2/libr/io/io.c"
     void r_io_bind(RIO *io, RIOBind *bnd) {
 
# 474 "project/radare2/libr/io/io.c" 3 4
do { if (!(
# 474 "project/radare2/libr/io/io.c"
io && bnd
# 474 "project/radare2/libr/io/io.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 474 "project/radare2/libr/io/io.c"
...
# 474 "project/radare2/libr/io/io.c"
 ...
 bnd->io = io;
 bnd->init = 
# 477 "project/radare2/libr/io/io.c" 3 4
            1
# 477 "project/radare2/libr/io/io.c"
                ;
...
# 516 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 516 "project/radare2/libr/io/io.c"
          r_io_shift(RIO* io, 
# 516 "project/radare2/libr/io/io.c" 3 4
                              unsigned long long 
# 516 "project/radare2/libr/io/io.c"
...
# 517 "project/radare2/libr/io/io.c" 3 4
unsigned char
# 517 "project/radare2/libr/io/io.c"
   * buf;
 
# 518 "project/radare2/libr/io/io.c" 3 4
unsigned long long 
# 518 "project/radare2/libr/io/io.c"
     chunksize = 0x10000;
 
# 519 "project/radare2/libr/io/io.c" 3 4
unsigned long long 
# 519 "project/radare2/libr/io/io.c"
     saved_off = io->off;
 
# 520 "project/radare2/libr/io/io.c" 3 4
unsigned long long 
# 520 "project/radare2/libr/io/io.c"
     src, shiftsize = r_num_abs (move);
 if (!shiftsize || (end - start) <= shiftsize) {
  return 
# 522 "project/radare2/libr/io/io.c" 3 4
        0
# 522 "project/radare2/libr/io/io.c"
             ;
 }
 
# 524 "project/radare2/libr/io/io.c" 3 4
unsigned long long 
# 524 "project/radare2/libr/io/io.c"
     rest = (end - start) - shiftsize;
 if (!(buf = calloc (1, chunksize + 1))) {
  return 
# 526 "project/radare2/libr/io/io.c" 3 4
        0
# 526 "project/radare2/libr/io/io.c"
             ;
 }
 if (move > 0) {
  src = end - shiftsize;
 ...
 free (buf);
 io->off = r_io_desc_seek (io->desc, saved_off, 
# 548 "project/radare2/libr/io/io.c" 3 4
                                               0
# 548 "project/radare2/libr/io/io.c"
                                                            );
 return 
# 549 "project/radare2/libr/io/io.c" 3 4
       1
# 549 "project/radare2/libr/io/io.c"
           ;
}


# 552 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 552 "project/radare2/libr/io/io.c"
          r_io_seek(RIO* io, 
# 552 "project/radare2/libr/io/io.c" 3 4
                             unsigned long long 
# 552 "project/radare2/libr/io/io.c"
 ...
 switch (whence) {
 case 
# 557 "project/radare2/libr/io/io.c" 3 4
     0
# 557 "project/radare2/libr/io/io.c"
                  :
  io->off = offset;
  break;
 case 
# 560 "project/radare2/libr/io/io.c" 3 4
     1
# 560 "project/radare2/libr/io/io.c"
                  :
  io->off += offset;
  break;
 case 
# 563 "project/radare2/libr/io/io.c" 3 4
     2
# 563 "project/radare2/libr/io/io.c"
                  :
 default:
...
# 592 "project/radare2/libr/io/io.c"

# 592 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) 
# 592 "project/radare2/libr/io/io.c"
     long r_io_ptrace(RIO *io, r_ptrace_request_t request, pid_t pid, void *addr, r_ptrace_data_t data) {
# 603 "project/radare2/libr/io/io.c"
 return ptrace (request, pid, addr, data);
}


# 606 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) 
# 606 "project/radare2/libr/io/io.c"
     pid_t r_io_ptrace_fork(RIO *io, void (*child_callback)(void *), void *child_callback_user) {
# 617 "project/radare2/libr/io/io.c"
 pid_t r = r_sys_fork ();
 if (r == 0) {
...
# 624 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) 
# 624 "project/radare2/libr/io/io.c"
     void *r_io_ptrace_func(RIO *io, void *(*func)(void *), void *user) {
...
# 636 "project/radare2/libr/io/io.c" 3 4
__attribute__((visibility("default"))) 
# 636 "project/radare2/libr/io/io.c"
     void r_io_fini(RIO* io) {
 if (!io) {
  return;
 }
 r_io_bank_fini (io);
...
# 647 "project/radare2/libr/io/io.c" 3 4
{ free((void *)
# 647 "project/radare2/libr/io/io.c"
io->runprofile
# 647 "project/radare2/libr/io/io.c" 3 4
); 
# 647 "project/radare2/libr/io/io.c"
