# 0 "project/radare2/libr/io/undo.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/io/undo.c" 2
# 12 "project/radare2/libr/io/undo.c"
__attribute__((visibility("default"))) 
# 12 "project/radare2/libr/io/undo.c"
     int r_io_undo_init(RIO *io) {
 ...
 return 
# 22 "project/radare2/libr/io/undo.c" 3 4
       1
# 22 "project/radare2/libr/io/undo.c"
           ;
}


# 25 "project/radare2/libr/io/undo.c" 3 4
__attribute__((visibility("default"))) 
# 25 "project/radare2/libr/io/undo.c"
     void r_io_undo_enable(RIO *io, int s, int w) {
 io->undo.s_enable = s;
 io->undo.w_enable = w;
}
...
# 32 "project/radare2/libr/io/undo.c" 3 4
__attribute__((visibility("default"))) 
# 32 "project/radare2/libr/io/undo.c"
     RIOUndos *r_io_sundo(RIO *io, 
# 32 "project/radare2/libr/io/undo.c" 3 4
                                   unsigned long long 
# 32 "project/radare2/libr/io/undo.c"
                                        offset) {
 if (!io->undo.s_enable || !io->undo.undos) {
  return 
# 34 "project/radare2/libr/io/undo.c" 3 4
        ((void *)0)
# 34 "project/radare2/libr/io/undo.c"
            ;
 }
 ...
 io->undo.idx = (io->undo.idx - 1 + 
# 45 "project/radare2/libr/io/undo.c" 3 4
                                   64
# 45 "project/radare2/libr/io/undo.c"
                                             ) % 
# 45 "project/radare2/libr/io/undo.c" 3 4
                                                 64
# 45 "project/radare2/libr/io/undo.c"
 ...
 if (!map || (map->delta == 
# 51 "project/radare2/libr/io/undo.c" 3 4
                           r_itv_begin (
# 51 "project/radare2/libr/io/undo.c"
                           map
# 51 "project/radare2/libr/io/undo.c" 3 4
                           ->itv)
# 51 "project/radare2/libr/io/undo.c"
  ...
  io->off = undo->off - (
# 54 "project/radare2/libr/io/undo.c" 3 4
                        r_itv_begin (
# 54 "project/radare2/libr/io/undo.c"
                        map
# 54 "project/radare2/libr/io/undo.c" 3 4
                        ->itv) 
# 54 "project/radare2/libr/io/undo.c"
...
# 59 "project/radare2/libr/io/undo.c" 3 4
__attribute__((visibility("default"))) 
# 59 "project/radare2/libr/io/undo.c"
     RIOUndos *r_io_sundo_redo(RIO *io) {
 RIOUndos *undo;
 RIOMap *map;

 if (!io->undo.s_enable || !io->undo.redos) {
  return 
# 64 "project/radare2/libr/io/undo.c" 3 4
        ((void *)0)
# 64 "project/radare2/libr/io/undo.c"
            ;
 }

 io->undo.idx = (io->undo.idx + 1) % 
# 67 "project/radare2/libr/io/undo.c" 3 4
                                    64
# 67 "project/radare2/libr/io/undo.c"
                                              ;
 io->undo.undos++;
 io->undo.redos--;
 ...
 if (!map || (map->delta == 
# 73 "project/radare2/libr/io/undo.c" 3 4
                           r_itv_begin (
# 73 "project/radare2/libr/io/undo.c"
                           map
# 73 "project/radare2/libr/io/undo.c" 3 4
                           ->itv)
# 73 "project/radare2/libr/io/undo.c"
  ...
  io->off = undo->off - 
# 76 "project/radare2/libr/io/undo.c" 3 4
                       r_itv_begin (
# 76 "project/radare2/libr/io/undo.c"
                       map
# 76 "project/radare2/libr/io/undo.c" 3 4
                       ->itv) 
# 76 "project/radare2/libr/io/undo.c"
...
# 81 "project/radare2/libr/io/undo.c" 3 4
__attribute__((visibility("default"))) 
# 81 "project/radare2/libr/io/undo.c"
     void r_io_sundo_push(RIO *io, 
# 81 "project/radare2/libr/io/undo.c" 3 4
                                   unsigned long long 
# 81 "project/radare2/libr/io/undo.c"
                                        off, int cursor) {
...
# 88 "project/radare2/libr/io/undo.c" 3 4
                                           64
# 88 "project/radare2/libr/io/undo.c"
                                                     ) % 
# 88 "project/radare2/libr/io/undo.c" 3 4
                                                         64
# 88 "project/radare2/libr/io/undo.c"
 ...
 undo->cursor = cursor;
 io->undo.idx = (io->undo.idx + 1) % 
# 97 "project/radare2/libr/io/undo.c" 3 4
                                    64
# 97 "project/radare2/libr/io/undo.c"
                                              ;



 if (io->undo.undos < 
# 101 "project/radare2/libr/io/undo.c" 3 4
                     64 
# 101 "project/radare2/libr/io/undo.c"
                                - 1) {
  io->undo.undos++;
 }
...
# 109 "project/radare2/libr/io/undo.c" 3 4
__attribute__((visibility("default"))) 
# 109 "project/radare2/libr/io/undo.c"
     void r_io_sundo_reset(RIO *io) {
 io->undo.idx = 0;
 io->undo.undos = 0;
 io->undo.redos = 0;
}
...
# 115 "project/radare2/libr/io/undo.c" 3 4
__attribute__((visibility("default"))) 
# 115 "project/radare2/libr/io/undo.c"
     RList *r_io_sundo_list(RIO *io, int mode) {
 int idx, undos, redos, i, j, start, end;
 RList* list = 
# 117 "project/radare2/libr/io/undo.c" 3 4
              ((void *)0)
# 117 "project/radare2/libr/io/undo.c"
                  ;
 ...
 if (!io->undo.s_enable) {
  return 
# 123 "project/radare2/libr/io/undo.c" 3 4
        ((void *)0)
# 123 "project/radare2/libr/io/undo.c"
            ;
 }
 undos = io->undo.undos;
 redos = io->undo.redos;
 ...
 idx = io->undo.idx;
 start = (idx - undos + 
# 129 "project/radare2/libr/io/undo.c" 3 4
                       64
# 129 "project/radare2/libr/io/undo.c"
                                 ) % 
# 129 "project/radare2/libr/io/undo.c" 3 4
                                     64
# 129 "project/radare2/libr/io/undo.c"
...
# 130 "project/radare2/libr/io/undo.c" 3 4
                              64
# 130 "project/radare2/libr/io/undo.c"
                                        ;
 ...
 for (i = start; ; i = (i + 1) % 
# 141 "project/radare2/libr/io/undo.c" 3 4
                                                                 64
# 141 "project/radare2/libr/io/undo.c"
                                                                           ) {
  int idx = (j < undos)? undos - j - 1: j - undos - 1;
  RIOUndos *undo = &io->undo.seek[i];
  
# 144 "project/radare2/libr/io/undo.c" 3 4
 unsigned long long 
# 144 "project/radare2/libr/io/undo.c"
      addr = undo->off;
  
# 145 "project/radare2/libr/io/undo.c" 3 4
 _Bool 
# 145 "project/radare2/libr/io/undo.c"
      notLast = (j + 1 < undos);
  switch (mode) {
  case '=':
   if (j < undos) {
    io->cb_printf ("0x%"
# 149 "project/radare2/libr/io/undo.c" 3 4
                       "llx"
# 149 "project/radare2/libr/io/undo.c"
                              "%s", addr, notLast? " > ": "");
   }
   break;
  case '*':
   if (j < undos) {
    io->cb_printf ("f undo_%d @ 0x%"
# 154 "project/radare2/libr/io/undo.c" 3 4
                                   "llx"
# 154 "project/radare2/libr/io/undo.c"
                                          "\n", idx, addr);
   } else if (j == undos && j != 0 && redos != 0) {
    io->cb_printf ("# Current undo/redo position.\n");
   } else if (j != undos) {
    io->cb_printf ("f redo_%d @ 0x%"
# 158 "project/radare2/libr/io/undo.c" 3 4
                                   "llx"
# 158 "project/radare2/libr/io/undo.c"
                                          "\n", idx, addr);
   }
   break;
  case 0:
   if (list) {
    RIOUndos *u = 
# 163 "project/radare2/libr/io/undo.c" 3 4
                  (
# 163 "project/radare2/libr/io/undo.c"
                  RIOUndos
# 163 "project/radare2/libr/io/undo.c" 3 4
                  *)calloc(1,sizeof(
# 163 "project/radare2/libr/io/undo.c"
...
# 168 "project/radare2/libr/io/undo.c" 3 4
     __builtin___memcpy_chk (
# 168 "project/radare2/libr/io/undo.c"
     u
# 168 "project/radare2/libr/io/undo.c" 3 4
     , 
# 168 "project/radare2/libr/io/undo.c"
     undo, sizeof (RIOUndos)
# 168 "project/radare2/libr/io/undo.c" 3 4
...
# 192 "project/radare2/libr/io/undo.c" 3 4
__attribute__((visibility("default"))) 
# 192 "project/radare2/libr/io/undo.c"
     void r_io_wundo_new(RIO *io, 
# 192 "project/radare2/libr/io/undo.c" 3 4
                                  unsigned long long 
# 192 "project/radare2/libr/io/undo.c"
                                       off, const 
...
# 192 "project/radare2/libr/io/undo.c"
 ...
 uw = 
# 198 "project/radare2/libr/io/undo.c" 3 4
     (
# 198 "project/radare2/libr/io/undo.c"
     RIOUndoWrite
# 198 "project/radare2/libr/io/undo.c" 3 4
     *)calloc(1,sizeof(
# 198 "project/radare2/libr/io/undo.c"
...
# 198 "project/radare2/libr/io/undo.c"
 ...
 uw->set = 
# 202 "project/radare2/libr/io/undo.c" 3 4
          1
# 202 "project/radare2/libr/io/undo.c"
              ;
 uw->off = off;
 uw->len = len;
 uw->n = (
# 205 "project/radare2/libr/io/undo.c" 3 4
         unsigned char
# 205 "project/radare2/libr/io/undo.c"
            *) malloc (len);
 if (!uw->n) {
  free (uw);
  return;
...
# 210 "project/radare2/libr/io/undo.c" 3 4
__builtin___memcpy_chk (
# 210 "project/radare2/libr/io/undo.c"
uw->n
# 210 "project/radare2/libr/io/undo.c" 3 4
, 
# 210 "project/radare2/libr/io/undo.c"
...
# 210 "project/radare2/libr/io/undo.c"
                         ;
 uw->o = (
# 211 "project/radare2/libr/io/undo.c" 3 4
         unsigned char
# 211 "project/radare2/libr/io/undo.c"
            *) malloc (len);
 if (!uw->o) {
  
# 213 "project/radare2/libr/io/undo.c" 3 4
 { free((void *)
# 213 "project/radare2/libr/io/undo.c"
 uw
# 213 "project/radare2/libr/io/undo.c" 3 4
 ); 
# 213 "project/radare2/libr/io/undo.c"
...
# 216 "project/radare2/libr/io/undo.c" 3 4
__builtin___memset_chk (
# 216 "project/radare2/libr/io/undo.c"
uw->o
# 216 "project/radare2/libr/io/undo.c" 3 4
, 
# 216 "project/radare2/libr/io/undo.c"
...
# 221 "project/radare2/libr/io/undo.c" 3 4
__attribute__((visibility("default"))) 
# 221 "project/radare2/libr/io/undo.c"
     void r_io_wundo_clear(RIO *io) {
...
# 227 "project/radare2/libr/io/undo.c" 3 4
__attribute__((visibility("default"))) 
# 227 "project/radare2/libr/io/undo.c"
     int r_io_wundo_size(RIO *io) {
 return r_list_length (io->undo.w_list);
}



# 232 "project/radare2/libr/io/undo.c" 3 4
__attribute__((visibility("default"))) 
# 232 "project/radare2/libr/io/undo.c"
     void r_io_wundo_list(RIO *io) {
#define BW 8
 RListIter *iter;
 RIOUndoWrite *u;
 int i = 0, j, len;
...
# 239 "project/radare2/libr/io/undo.c" 3 4
 if (
# 239 "project/radare2/libr/io/undo.c"
 io->undo.w_list
# 239 "project/radare2/libr/io/undo.c" 3 4
 ) for (
# 239 "project/radare2/libr/io/undo.c"
...
# 239 "project/radare2/libr/io/undo.c"
                                           {
   io->cb_printf ("%02d %c %zu %08" 
# 240 "project/radare2/libr/io/undo.c" 3 4
                                   "llx" 
# 240 "project/radare2/libr/io/undo.c"
                                           ": ", i, u->set ? '+' : '-', u->len, u->off);
   len = (u->len > 8) ? 8 : u->len;
   for (j = 0; j < len; j++) {
...
# 261 "project/radare2/libr/io/undo.c" 3 4
__attribute__((visibility("default"))) 
# 261 "project/radare2/libr/io/undo.c"
     int r_io_wundo_apply(RIO *io, RIOUndoWrite *u, int set) {
 int orig = io->undo.w_enable;
 io->undo.w_enable = 0;
 if (set) {
  r_io_write_at (io, u->off, u->n, u->len);
  u->set = 
# 266 "project/radare2/libr/io/undo.c" 3 4
          1
# 266 "project/radare2/libr/io/undo.c"
              ;
 } else {
  r_io_write_at (io, u->off, u->o, u->len);
  u->set = 
# 269 "project/radare2/libr/io/undo.c" 3 4
          0
# 269 "project/radare2/libr/io/undo.c"
               ;
 }
...
# 275 "project/radare2/libr/io/undo.c" 3 4
__attribute__((visibility("default"))) 
# 275 "project/radare2/libr/io/undo.c"
     void r_io_wundo_apply_all(RIO *io, int set) {
 RListIter *iter;
 RIOUndoWrite *u;

 
# 279 "project/radare2/libr/io/undo.c" 3 4
if (
# 279 "project/radare2/libr/io/undo.c"
io->undo.w_list
# 279 "project/radare2/libr/io/undo.c" 3 4
) for (
# 279 "project/radare2/libr/io/undo.c"
...
# 281 "project/radare2/libr/io/undo.c" 3 4
 fprintf(__stderrp,
# 281 "project/radare2/libr/io/undo.c"
 "%s 0x%08"
# 281 "project/radare2/libr/io/undo.c" 3 4
 "llx"
# 281 "project/radare2/libr/io/undo.c"
...
# 287 "project/radare2/libr/io/undo.c" 3 4
__attribute__((visibility("default"))) 
# 287 "project/radare2/libr/io/undo.c"
     int r_io_wundo_set(RIO *io, int n, int set) {
 RListIter *iter;
 RIOUndoWrite *u = 
# 289 "project/radare2/libr/io/undo.c" 3 4
                  ((void *)0)
# 289 "project/radare2/libr/io/undo.c"
                      ;
 int i = 0;
 if (io->undo.w_init) {
  
# 292 "project/radare2/libr/io/undo.c" 3 4
 if (
# 292 "project/radare2/libr/io/undo.c"
 io->undo.w_list
# 292 "project/radare2/libr/io/undo.c" 3 4
 ) for (
# 292 "project/radare2/libr/io/undo.c"
...
# 292 "project/radare2/libr/io/undo.c"
  ...
  if (u) {
   r_io_wundo_apply (io, u, set);
   return 
# 299 "project/radare2/libr/io/undo.c" 3 4
         1
# 299 "project/radare2/libr/io/undo.c"
             ;
  }
  
# 301 "project/radare2/libr/io/undo.c" 3 4
 fprintf(__stderrp,
# 301 "project/radare2/libr/io/undo.c"
...
# 303 "project/radare2/libr/io/undo.c" 3 4
 fprintf(__stderrp,
# 303 "project/radare2/libr/io/undo.c"
 "no writes done\n"
# 303 "project/radare2/libr/io/undo.c" 3 4
 )
# 303 "project/radare2/libr/io/undo.c"
 ...
 return 
# 305 "project/radare2/libr/io/undo.c" 3 4
       0
# 305 "project/radare2/libr/io/undo.c"
            ;
}
