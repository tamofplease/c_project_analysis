# 0 "project/radare2/libr/reg/rcond.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/reg/rcond.c"
...
# 4 "project/radare2/libr/reg/rcond.c" 2
...
# 16 "project/radare2/libr/reg/rcond.c"
     RRegItem *r_reg_cond_get(RReg *reg, const char *name) {
 int i = R_REG_TYPE_GPR;
 RListIter *iter;
 RRegItem *r;
 
# 20 "project/radare2/libr/reg/rcond.c" 3 4
do { if (!(
# 20 "project/radare2/libr/reg/rcond.c"
reg && name
# 20 "project/radare2/libr/reg/rcond.c" 3 4
...
# 22 "project/radare2/libr/reg/rcond.c" 3 4
if (
# 22 "project/radare2/libr/reg/rcond.c"
reg->regset[i].regs
# 22 "project/radare2/libr/reg/rcond.c" 3 4
) for (
# 22 "project/radare2/libr/reg/rcond.c"
...
# 22 "project/radare2/libr/reg/rcond.c"
 ...
 return 
# 27 "project/radare2/libr/reg/rcond.c" 3 4
       ((void *)0)
# 27 "project/radare2/libr/reg/rcond.c"
           ;
}


# 30 "project/radare2/libr/reg/rcond.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 30 "project/radare2/libr/reg/rcond.c"
          r_reg_cond_get_value(RReg *r, const char *name) {
 RRegItem *ri = r_reg_cond_get (r, name);
 return ri && r_reg_get_value (r, ri) != 0;
}


# 35 "project/radare2/libr/reg/rcond.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 35 "project/radare2/libr/reg/rcond.c"
          r_reg_cond_set(RReg *r, const char *name, 
# 35 "project/radare2/libr/reg/rcond.c" 3 4
                                                    _Bool 
# 35 "project/radare2/libr/reg/rcond.c"
                                                         val) {
 ...
 if (item) {
  ...
  return 
# 39 "project/radare2/libr/reg/rcond.c" 3 4
        1
# 39 "project/radare2/libr/reg/rcond.c"
            ;
 }

 return 
# 42 "project/radare2/libr/reg/rcond.c" 3 4
       0
# 42 "project/radare2/libr/reg/rcond.c"
            ;
}


# 45 "project/radare2/libr/reg/rcond.c" 3 4
__attribute__((visibility("default"))) 
# 45 "project/radare2/libr/reg/rcond.c"
     const char *r_reg_cond_to_string(int n) {
 const char *cs[] = {
 ...
 if (n < 0 || (n > (sizeof (cs) / sizeof (*cs)) - 1)) {
  return 
# 51 "project/radare2/libr/reg/rcond.c" 3 4
        ((void *)0)
# 51 "project/radare2/libr/reg/rcond.c"
            ;
 }
 return cs[n];
}
...
# 56 "project/radare2/libr/reg/rcond.c" 3 4
__attribute__((visibility("default"))) 
# 56 "project/radare2/libr/reg/rcond.c"
     int r_reg_cond_from_string(const char *str) {
 if (!strcmp (str, "eq")) {
  return 
# 58 "project/radare2/libr/reg/rcond.c" 3 4
        0
# 58 "project/radare2/libr/reg/rcond.c"
                     ;
 }
 if (!strcmp (str, "ne")) {
  return 
# 61 "project/radare2/libr/reg/rcond.c" 3 4
        1
# 61 "project/radare2/libr/reg/rcond.c"
                     ;
 }
 if (!strcmp (str, "cf")) {
  return 
# 64 "project/radare2/libr/reg/rcond.c" 3 4
        2
# 64 "project/radare2/libr/reg/rcond.c"
                     ;
 }
 if (!strcmp (str, "neg")) {
  return 
# 67 "project/radare2/libr/reg/rcond.c" 3 4
        3
# 67 "project/radare2/libr/reg/rcond.c"
                      ;
 }
 if (!strcmp (str, "of")) {
  return 
# 70 "project/radare2/libr/reg/rcond.c" 3 4
        4
# 70 "project/radare2/libr/reg/rcond.c"
                     ;
 }
 if (!strcmp (str, "hi")) {
  return 
# 73 "project/radare2/libr/reg/rcond.c" 3 4
        5
# 73 "project/radare2/libr/reg/rcond.c"
                     ;
 }
 if (!strcmp (str, "he")) {
  return 
# 76 "project/radare2/libr/reg/rcond.c" 3 4
        6
# 76 "project/radare2/libr/reg/rcond.c"
                     ;
 }
 if (!strcmp (str, "lo")) {
  return 
# 79 "project/radare2/libr/reg/rcond.c" 3 4
        7
# 79 "project/radare2/libr/reg/rcond.c"
                     ;
 }
 if (!strcmp (str, "loe")) {
  return 
# 82 "project/radare2/libr/reg/rcond.c" 3 4
        8
# 82 "project/radare2/libr/reg/rcond.c"
                      ;
 }
 if (!strcmp (str, "ge")) {
  return 
# 85 "project/radare2/libr/reg/rcond.c" 3 4
        9
# 85 "project/radare2/libr/reg/rcond.c"
                     ;
 }
 if (!strcmp (str, "gt")) {
  return 
# 88 "project/radare2/libr/reg/rcond.c" 3 4
        10
# 88 "project/radare2/libr/reg/rcond.c"
                     ;
 }
 if (!strcmp (str, "lt")) {
  return 
# 91 "project/radare2/libr/reg/rcond.c" 3 4
        11
# 91 "project/radare2/libr/reg/rcond.c"
                     ;
 }
 if (!strcmp (str, "le")) {
  return 
# 94 "project/radare2/libr/reg/rcond.c" 3 4
        12
# 94 "project/radare2/libr/reg/rcond.c"
                     ;
 }

 
# 97 "project/radare2/libr/reg/rcond.c" 3 4
fprintf(__stderrp,
# 97 "project/radare2/libr/reg/rcond.c"
"| Usage: drc[=] [condition](=1,0)\n" "| eq    equal\n" "| ne    not equal\n" "| cf    carry flag set\n" "| neg   negative value (has sign)\n" "| of    overflow\n" "|unsigned:\n" "| hi    higher\n" "| he    higher or equal\n" "| lo    lower\n" "| loe   lower or equal\n" "|signed:\n" "| ge    greater or equal\n" "| gt    greater than\n" "| le    less or equal\n" "| lt    less than\n"
# 97 "project/radare2/libr/reg/rcond.c" 3 4
)
# 112 "project/radare2/libr/reg/rcond.c"
                         ;
 
# 113 "project/radare2/libr/reg/rcond.c"
return -1;
}


# 116 "project/radare2/libr/reg/rcond.c" 3 4
__attribute__((visibility("default"))) 
# 116 "project/radare2/libr/reg/rcond.c"
     int r_reg_cond_bits(RReg *r, int type, RRegFlags *f) {
 switch (type) {
 case 
# 118 "project/radare2/libr/reg/rcond.c" 3 4
     0
# 118 "project/radare2/libr/reg/rcond.c"
                  : return f->z;
 case 
# 119 "project/radare2/libr/reg/rcond.c" 3 4
     1
# 119 "project/radare2/libr/reg/rcond.c"
                  : return !f->z;
 case 
# 120 "project/radare2/libr/reg/rcond.c" 3 4
     2
# 120 "project/radare2/libr/reg/rcond.c"
                  : return f->c;
 case 
# 121 "project/radare2/libr/reg/rcond.c" 3 4
     3
# 121 "project/radare2/libr/reg/rcond.c"
                   : return f->s;
 case 
# 122 "project/radare2/libr/reg/rcond.c" 3 4
     4
# 122 "project/radare2/libr/reg/rcond.c"
                  :
  return f->o;

 case 
# 125 "project/radare2/libr/reg/rcond.c" 3 4
     5
# 125 "project/radare2/libr/reg/rcond.c"
                  : return (!f->z && f->c);
 case 
# 126 "project/radare2/libr/reg/rcond.c" 3 4
     6
# 126 "project/radare2/libr/reg/rcond.c"
                  : return f->z || (!f->z && f->c);
 case 
# 127 "project/radare2/libr/reg/rcond.c" 3 4
     7
# 127 "project/radare2/libr/reg/rcond.c"
                  : return (f->z || !f->c);
 case 
# 128 "project/radare2/libr/reg/rcond.c" 3 4
     8
# 128 "project/radare2/libr/reg/rcond.c"
                   :
  return (f->z || !f->c);

 case 
# 131 "project/radare2/libr/reg/rcond.c" 3 4
     9
# 131 "project/radare2/libr/reg/rcond.c"
                  : return ((f->s && f->o) || (!f->s && !f->o));
 case 
# 132 "project/radare2/libr/reg/rcond.c" 3 4
     10
# 132 "project/radare2/libr/reg/rcond.c"
                  : return ((f->s && !f->z && f->o) || (!f->s && !f->z && !f->o));
 case 
# 133 "project/radare2/libr/reg/rcond.c" 3 4
     11
# 133 "project/radare2/libr/reg/rcond.c"
                  : return ((f->s && !f->o) || (!f->s && f->o));
 case 
# 134 "project/radare2/libr/reg/rcond.c" 3 4
     12
# 134 "project/radare2/libr/reg/rcond.c"
                  : return (f->z || (f->s && !f->o) || (!f->s && f->o));
 }
 return 
# 136 "project/radare2/libr/reg/rcond.c" 3 4
       0
# 136 "project/radare2/libr/reg/rcond.c"
            ;
}


# 139 "project/radare2/libr/reg/rcond.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 139 "project/radare2/libr/reg/rcond.c"
          r_reg_cond_bits_set(RReg *r, int type, RRegFlags *f, 
# 139 "project/radare2/libr/reg/rcond.c" 3 4
                                                               _Bool 
# 139 "project/radare2/libr/reg/rcond.c"
                                                                    v) {
 switch (type) {
 case 
# 141 "project/radare2/libr/reg/rcond.c" 3 4
     0
# 141 "project/radare2/libr/reg/rcond.c"
                  : f->z = v; break;
 case 
# 142 "project/radare2/libr/reg/rcond.c" 3 4
     1
# 142 "project/radare2/libr/reg/rcond.c"
                  : f->z = !v; break;
 case 
# 143 "project/radare2/libr/reg/rcond.c" 3 4
     2
# 143 "project/radare2/libr/reg/rcond.c"
                  : f->c = v; break;
 case 
# 144 "project/radare2/libr/reg/rcond.c" 3 4
     3
# 144 "project/radare2/libr/reg/rcond.c"
                   : f->s = v; break;
 case 
# 145 "project/radare2/libr/reg/rcond.c" 3 4
     4
# 145 "project/radare2/libr/reg/rcond.c"
                  : f->o = v; break;
 case 
# 146 "project/radare2/libr/reg/rcond.c" 3 4
     5
# 146 "project/radare2/libr/reg/rcond.c"
                  :
  if (v) {
   f->z = 0;
   f->c = 1;
  ...
  break;
 case 
# 155 "project/radare2/libr/reg/rcond.c" 3 4
     6
# 155 "project/radare2/libr/reg/rcond.c"
                  :
  if (v) {
   f->z = 1;
  } else {
  ...
  break;
 case 
# 163 "project/radare2/libr/reg/rcond.c" 3 4
     7
# 163 "project/radare2/libr/reg/rcond.c"
                  :
  if (v) {
   f->z = 1;
   f->c = 0;
  ...
  break;
 case 
# 172 "project/radare2/libr/reg/rcond.c" 3 4
     8
# 172 "project/radare2/libr/reg/rcond.c"
                   :
  if (v) {
   f->z = 1;
   f->c = 0;
 ...
 case 
# 182 "project/radare2/libr/reg/rcond.c" 3 4
     9
# 182 "project/radare2/libr/reg/rcond.c"
                  :
  if (v) {
   f->s = f->o = 1;
  } else {
  ...
  break;
 case 
# 190 "project/radare2/libr/reg/rcond.c" 3 4
     10
# 190 "project/radare2/libr/reg/rcond.c"
                  :
  if (v) {
   f->s = 1;
   f->z = 0;
  ...
  break;
 case 
# 201 "project/radare2/libr/reg/rcond.c" 3 4
     11
# 201 "project/radare2/libr/reg/rcond.c"
                  :
  if (v) {
   f->s = 1;
   f->o = 0;
  ...
  break;
 case 
# 210 "project/radare2/libr/reg/rcond.c" 3 4
     12
# 210 "project/radare2/libr/reg/rcond.c"
                  :
  if (v) {
   f->s = 0;
   f->z = 1;
 ...
 default:
  return 
# 222 "project/radare2/libr/reg/rcond.c" 3 4
        0
# 222 "project/radare2/libr/reg/rcond.c"
             ;
 }
 return 
# 224 "project/radare2/libr/reg/rcond.c" 3 4
       1
# 224 "project/radare2/libr/reg/rcond.c"
           ;
}


# 227 "project/radare2/libr/reg/rcond.c" 3 4
__attribute__((visibility("default"))) 
# 227 "project/radare2/libr/reg/rcond.c"
     int r_reg_cond(RReg *r, int type) {
 RRegFlags f = { 0 };
...
# 233 "project/radare2/libr/reg/rcond.c" 3 4
__attribute__((visibility("default"))) 
# 233 "project/radare2/libr/reg/rcond.c"
     RRegFlags *r_reg_cond_retrieve(RReg *r, RRegFlags *f) {
 if (!f) {
  f = 
# 235 "project/radare2/libr/reg/rcond.c" 3 4
     (
# 235 "project/radare2/libr/reg/rcond.c"
     RRegFlags
# 235 "project/radare2/libr/reg/rcond.c" 3 4
     *)calloc(1,sizeof(
# 235 "project/radare2/libr/reg/rcond.c"
...
# 235 "project/radare2/libr/reg/rcond.c"
 ...
 if (!f) {
  return 
# 238 "project/radare2/libr/reg/rcond.c" 3 4
        ((void *)0)
# 238 "project/radare2/libr/reg/rcond.c"
            ;
 }
 f->s = r_reg_cond_get_value (r, "sign");
 f->z = r_reg_cond_get_value (r, "zero");
 f->c = r_reg_cond_get_value (r, "carry");
 f->o = r_reg_cond_get_value (r, "overflow");
 f->p = r_reg_cond_get_value (r, "parity");
 return f;
}


# 248 "project/radare2/libr/reg/rcond.c" 3 4
__attribute__((visibility("default"))) 
# 248 "project/radare2/libr/reg/rcond.c"
     void r_reg_cond_apply(RReg *r, RRegFlags *f) {
 
# 249 "project/radare2/libr/reg/rcond.c" 3 4
do { if (!(
# 249 "project/radare2/libr/reg/rcond.c"
r && f
# 249 "project/radare2/libr/reg/rcond.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 249 "project/radare2/libr/reg/rcond.c"
