# 0 "project/radare2/libr/reg/arena.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/reg/arena.c"
...
# 4 "project/radare2/libr/reg/arena.c" 2
...
# 5 "project/radare2/libr/reg/arena.c" 2


__attribute__((visibility("default"))) unsigned char 
# 7 "project/radare2/libr/reg/arena.c"
         *r_reg_get_bytes(RReg *reg, int type, int *size) {
 RRegArena *arena;
 int i, sz, osize;
 
# 10 "project/radare2/libr/reg/arena.c" 3 4
unsigned char 
# 10 "project/radare2/libr/reg/arena.c"
    *buf, *newbuf;
 if (size) {
  *size = 0;
 }
 if (type == -1) {
  ...
  if (!buf) {
   return 
# 20 "project/radare2/libr/reg/arena.c" 3 4
         ((void *)0)
# 20 "project/radare2/libr/reg/arena.c"
             ;
  }
...
# 30 "project/radare2/libr/reg/arena.c" 3 4
  __builtin___memcpy_chk (
# 30 "project/radare2/libr/reg/arena.c"
  buf + osize
# 30 "project/radare2/libr/reg/arena.c" 3 4
  , 
# 30 "project/radare2/libr/reg/arena.c"
...
# 30 "project/radare2/libr/reg/arena.c"
 ...
 if (type < 0 || type > (R_REG_TYPE_LAST - 1)) {
  return 
# 39 "project/radare2/libr/reg/arena.c" 3 4
        ((void *)0)
# 39 "project/radare2/libr/reg/arena.c"
            ;
 }
 ...
 if (!sz) {
  return 
# 46 "project/radare2/libr/reg/arena.c" 3 4
        ((void *)0)
# 46 "project/radare2/libr/reg/arena.c"
            ;
 }
 buf = malloc (sz);
 if (buf) {
  
# 50 "project/radare2/libr/reg/arena.c" 3 4
 __builtin___memcpy_chk (
# 50 "project/radare2/libr/reg/arena.c"
 buf
# 50 "project/radare2/libr/reg/arena.c" 3 4
 , 
# 50 "project/radare2/libr/reg/arena.c"
 reg->regset[type].arena->bytes, sz
# 50 "project/radare2/libr/reg/arena.c" 3 4
 , __builtin_object_size (
# 50 "project/radare2/libr/reg/arena.c"
 buf
...
# 57 "project/radare2/libr/reg/arena.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 57 "project/radare2/libr/reg/arena.c"
          r_reg_read_regs(RReg *reg, 
# 57 "project/radare2/libr/reg/arena.c" 3 4
                                     unsigned char 
# 57 "project/radare2/libr/reg/arena.c"
                                         *buf, const int len) {
 ...
 for (i = 0; i < R_REG_TYPE_LAST; i++) {
  if (reg->regset[i].arena) {
   ...
   arena = reg->regset[i].arena = 
# 64 "project/radare2/libr/reg/arena.c" 3 4
                                 (
# 64 "project/radare2/libr/reg/arena.c"
                                 RRegArena
# 64 "project/radare2/libr/reg/arena.c" 3 4
                                 *)calloc(1,sizeof(
# 64 "project/radare2/libr/reg/arena.c"
...
# 64 "project/radare2/libr/reg/arena.c"
   ...
   if (!arena) {
    return 
# 66 "project/radare2/libr/reg/arena.c" 3 4
          0
# 66 "project/radare2/libr/reg/arena.c"
               ;
   }
   arena->size = len;
   ...
   if (!arena->bytes) {
    ...
    return 
# 72 "project/radare2/libr/reg/arena.c" 3 4
          0
# 72 "project/radare2/libr/reg/arena.c"
               ;
   }
  }
  if (!arena->bytes) {
   arena->size = 0;
   return 
# 77 "project/radare2/libr/reg/arena.c" 3 4
         0
# 77 "project/radare2/libr/reg/arena.c"
              ;
  }
  
# 79 "project/radare2/libr/reg/arena.c" 3 4
 __builtin___memset_chk (
# 79 "project/radare2/libr/reg/arena.c"
 arena->bytes
# 79 "project/radare2/libr/reg/arena.c" 3 4
 , 
# 79 "project/radare2/libr/reg/arena.c"
...
# 80 "project/radare2/libr/reg/arena.c" 3 4
 __builtin___memcpy_chk (
# 80 "project/radare2/libr/reg/arena.c"
 arena->bytes
# 80 "project/radare2/libr/reg/arena.c" 3 4
 , 
# 80 "project/radare2/libr/reg/arena.c"
...
# 81 "project/radare2/libr/reg/arena.c"
                                 ;
  off += arena->size;
  if (off > len) {
   return 
# 84 "project/radare2/libr/reg/arena.c" 3 4
         0
# 84 "project/radare2/libr/reg/arena.c"
              ;
  }
 }
 return 
# 87 "project/radare2/libr/reg/arena.c" 3 4
       1
# 87 "project/radare2/libr/reg/arena.c"
           ;
}



# 91 "project/radare2/libr/reg/arena.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 91 "project/radare2/libr/reg/arena.c"
          r_reg_set_bytes(RReg *reg, int type, const 
# 91 "project/radare2/libr/reg/arena.c" 3 4
                                                     unsigned char 
# 91 "project/radare2/libr/reg/arena.c"
                                                         *buf, const int len) {
 ...
 if (len < 1 || !buf) {
  return 
# 96 "project/radare2/libr/reg/arena.c" 3 4
        0
# 96 "project/radare2/libr/reg/arena.c"
             ;
 }
 if (type < 0 || type >= R_REG_TYPE_LAST) {
  return 
# 99 "project/radare2/libr/reg/arena.c" 3 4
        0
# 99 "project/radare2/libr/reg/arena.c"
             ;
 }
 ...
 if (!arena) {
  return 
# 104 "project/radare2/libr/reg/arena.c" 3 4
        0
# 104 "project/radare2/libr/reg/arena.c"
             ;
 }
 maxsz = 
# 106 "project/radare2/libr/reg/arena.c" 3 4
        (((
# 106 "project/radare2/libr/reg/arena.c"
        arena->size
# 106 "project/radare2/libr/reg/arena.c" 3 4
        )>(
# 106 "project/radare2/libr/reg/arena.c"
...
# 106 "project/radare2/libr/reg/arena.c"
                                ;
 minsz = 
# 107 "project/radare2/libr/reg/arena.c" 3 4
        (((
# 107 "project/radare2/libr/reg/arena.c"
        arena->size
# 107 "project/radare2/libr/reg/arena.c" 3 4
        )>(
# 107 "project/radare2/libr/reg/arena.c"
...
# 107 "project/radare2/libr/reg/arena.c"
 ...
 if ((arena->size != len) || (!arena->bytes)) {
  ...
  if (!arena->bytes) {
   arena->size = 0;
   return 
# 113 "project/radare2/libr/reg/arena.c" 3 4
         0
# 113 "project/radare2/libr/reg/arena.c"
              ;
  }
  arena->size = maxsz;
 }
...
# 118 "project/radare2/libr/reg/arena.c" 3 4
 unsigned char 
# 118 "project/radare2/libr/reg/arena.c"
     *tmp = realloc (arena->bytes, maxsz);
  if (!tmp) {
   
# 120 "project/radare2/libr/reg/arena.c" 3 4
  fprintf(__stderrp,
# 120 "project/radare2/libr/reg/arena.c"
  "Error resizing arena to %d\n", len
# 120 "project/radare2/libr/reg/arena.c" 3 4
  )
# 120 "project/radare2/libr/reg/arena.c"
                                               ;
   return 
# 121 "project/radare2/libr/reg/arena.c" 3 4
         0
# 121 "project/radare2/libr/reg/arena.c"
              ;
  }
  arena->size = maxsz;
  arena->bytes = tmp;
...
# 127 "project/radare2/libr/reg/arena.c" 3 4
 __builtin___memset_chk (
# 127 "project/radare2/libr/reg/arena.c"
 arena->bytes
# 127 "project/radare2/libr/reg/arena.c" 3 4
 , 
# 127 "project/radare2/libr/reg/arena.c"
...
# 128 "project/radare2/libr/reg/arena.c" 3 4
 __builtin___memcpy_chk (
# 128 "project/radare2/libr/reg/arena.c"
 arena->bytes
# 128 "project/radare2/libr/reg/arena.c" 3 4
 , 
# 128 "project/radare2/libr/reg/arena.c"
...
# 128 "project/radare2/libr/reg/arena.c"
                                  ;
  return 
# 129 "project/radare2/libr/reg/arena.c" 3 4
        1
# 129 "project/radare2/libr/reg/arena.c"
            ;
 }
 return 
# 131 "project/radare2/libr/reg/arena.c" 3 4
       0
# 131 "project/radare2/libr/reg/arena.c"
            ;
}


# 134 "project/radare2/libr/reg/arena.c" 3 4
__attribute__((visibility("default"))) 
# 134 "project/radare2/libr/reg/arena.c"
     int r_reg_fit_arena(RReg *reg) {
 RRegArena *arena;
 RListIter *iter;
 RRegItem *r;
 int size, i, newsize;
...
# 146 "project/radare2/libr/reg/arena.c" 3 4
 if (
# 146 "project/radare2/libr/reg/arena.c"
 reg->regset[i].regs
# 146 "project/radare2/libr/reg/arena.c" 3 4
 ) for (
# 146 "project/radare2/libr/reg/arena.c"
...
# 146 "project/radare2/libr/reg/arena.c"
   ...
   size = 
# 148 "project/radare2/libr/reg/arena.c" 3 4
         (((
# 148 "project/radare2/libr/reg/arena.c"
         r->offset + r->size
# 148 "project/radare2/libr/reg/arena.c" 3 4
         )/8)+(((
# 148 "project/radare2/libr/reg/arena.c"
...
# 148 "project/radare2/libr/reg/arena.c"
                                         ;
   newsize = 
# 149 "project/radare2/libr/reg/arena.c" 3 4
            (((
# 149 "project/radare2/libr/reg/arena.c"
            size
# 149 "project/radare2/libr/reg/arena.c" 3 4
            )>(
# 149 "project/radare2/libr/reg/arena.c"
...
# 152 "project/radare2/libr/reg/arena.c" 3 4
  { free((void *)
# 152 "project/radare2/libr/reg/arena.c"
  arena->bytes
# 152 "project/radare2/libr/reg/arena.c" 3 4
  ); 
# 152 "project/radare2/libr/reg/arena.c"
...
# 155 "project/radare2/libr/reg/arena.c" 3 4
  unsigned char 
# 155 "project/radare2/libr/reg/arena.c"
      *buf = realloc (arena->bytes, newsize);
   if (buf) {
    arena->size = newsize;
    arena->bytes = buf;
    
# 159 "project/radare2/libr/reg/arena.c" 3 4
   __builtin___memset_chk (
# 159 "project/radare2/libr/reg/arena.c"
   arena->bytes
# 159 "project/radare2/libr/reg/arena.c" 3 4
   , 
# 159 "project/radare2/libr/reg/arena.c"
...
# 159 "project/radare2/libr/reg/arena.c"
    ...
    arena->bytes = 
# 161 "project/radare2/libr/reg/arena.c" 3 4
                  ((void *)0)
# 161 "project/radare2/libr/reg/arena.c"
                      ;
    arena->size = 0;
   }
  }
 ...
 return 
# 166 "project/radare2/libr/reg/arena.c" 3 4
       1
# 166 "project/radare2/libr/reg/arena.c"
           ;
}


# 169 "project/radare2/libr/reg/arena.c" 3 4
__attribute__((visibility("default"))) 
# 169 "project/radare2/libr/reg/arena.c"
     RRegArena *r_reg_arena_new(int size) {
 RRegArena *arena = 
# 170 "project/radare2/libr/reg/arena.c" 3 4
                   (
# 170 "project/radare2/libr/reg/arena.c"
                   RRegArena
# 170 "project/radare2/libr/reg/arena.c" 3 4
                   *)calloc(1,sizeof(
# 170 "project/radare2/libr/reg/arena.c"
...
# 176 "project/radare2/libr/reg/arena.c" 3 4
  { free((void *)
# 176 "project/radare2/libr/reg/arena.c"
  arena
# 176 "project/radare2/libr/reg/arena.c" 3 4
  ); 
# 176 "project/radare2/libr/reg/arena.c"
...
# 184 "project/radare2/libr/reg/arena.c" 3 4
__attribute__((visibility("default"))) 
# 184 "project/radare2/libr/reg/arena.c"
     void r_reg_arena_free(RRegArena *ra) {
 if (ra) {
  free (ra->bytes);
  free (ra);
 }
...
# 191 "project/radare2/libr/reg/arena.c" 3 4
__attribute__((visibility("default"))) 
# 191 "project/radare2/libr/reg/arena.c"
     void r_reg_arena_swap(RReg *reg, int copy) {
...
# 211 "project/radare2/libr/reg/arena.c" 3 4
__attribute__((visibility("default"))) 
# 211 "project/radare2/libr/reg/arena.c"
...
# 231 "project/radare2/libr/reg/arena.c" 3 4
__attribute__((visibility("default"))) 
# 231 "project/radare2/libr/reg/arena.c"
     int r_reg_arena_push(RReg *reg) {
 int i;
 for (i = 0; i < R_REG_TYPE_LAST; i++) {
...
# 244 "project/radare2/libr/reg/arena.c" 3 4
  __builtin___memcpy_chk (
# 244 "project/radare2/libr/reg/arena.c"
  b->bytes
# 244 "project/radare2/libr/reg/arena.c" 3 4
  , 
# 244 "project/radare2/libr/reg/arena.c"
...
# 246 "project/radare2/libr/reg/arena.c" 3 4
 r_list_append ((
# 246 "project/radare2/libr/reg/arena.c"
 reg->regset[i].pool
# 246 "project/radare2/libr/reg/arena.c" 3 4
 ), (
# 246 "project/radare2/libr/reg/arena.c"
...
# 256 "project/radare2/libr/reg/arena.c" 3 4
__attribute__((visibility("default"))) 
# 256 "project/radare2/libr/reg/arena.c"
...
# 261 "project/radare2/libr/reg/arena.c" 3 4
  __builtin___memset_chk (
# 261 "project/radare2/libr/reg/arena.c"
  reg->regset[i].arena->bytes
# 261 "project/radare2/libr/reg/arena.c" 3 4
  , 
# 261 "project/radare2/libr/reg/arena.c"
  0, a->size
...
# 266 "project/radare2/libr/reg/arena.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 266 "project/radare2/libr/reg/arena.c"
         *r_reg_arena_peek(RReg *reg, int *size) {
 RRegSet *regset = r_reg_regset_get (reg, R_REG_TYPE_GPR);
 if (!reg || !regset || !regset->arena || (regset->arena->size < 1)) {
  return 
# 269 "project/radare2/libr/reg/arena.c" 3 4
        ((void *)0)
# 269 "project/radare2/libr/reg/arena.c"
            ;
 }
 
# 271 "project/radare2/libr/reg/arena.c" 3 4
unsigned char 
# 271 "project/radare2/libr/reg/arena.c"
    *ret = malloc (regset->arena->size);
 if (!ret) {
  return 
# 273 "project/radare2/libr/reg/arena.c" 3 4
        ((void *)0)
# 273 "project/radare2/libr/reg/arena.c"
            ;
 }
 
# 275 "project/radare2/libr/reg/arena.c" 3 4
__builtin___memcpy_chk (
# 275 "project/radare2/libr/reg/arena.c"
ret
# 275 "project/radare2/libr/reg/arena.c" 3 4
, 
# 275 "project/radare2/libr/reg/arena.c"
regset->arena->bytes, regset->arena->size
# 275 "project/radare2/libr/reg/arena.c" 3 4
, __builtin_object_size (
# 275 "project/radare2/libr/reg/arena.c"
ret
...
# 282 "project/radare2/libr/reg/arena.c" 3 4
__attribute__((visibility("default"))) 
# 282 "project/radare2/libr/reg/arena.c"
     void r_reg_arena_poke(RReg *reg, const 
# 282 "project/radare2/libr/reg/arena.c" 3 4
                                            unsigned char 
# 282 "project/radare2/libr/reg/arena.c"
                                                *ret, int len) {
...
# 288 "project/radare2/libr/reg/arena.c" 3 4
 fprintf(__stderrp,
# 288 "project/radare2/libr/reg/arena.c"
 "Invalid size of the arena bytes to poke (%d vs %d).\n", len, regset->arena->size
# 288 "project/radare2/libr/reg/arena.c" 3 4
 )
                            
# 289 "project/radare2/libr/reg/arena.c"
                           ;
  return;
 }
 
# 292 "project/radare2/libr/reg/arena.c" 3 4
__builtin___memcpy_chk (
# 292 "project/radare2/libr/reg/arena.c"
regset->arena->bytes
# 292 "project/radare2/libr/reg/arena.c" 3 4
, 
# 292 "project/radare2/libr/reg/arena.c"
ret, regset->arena->size
# 292 "project/radare2/libr/reg/arena.c" 3 4
, __builtin_object_size (
# 292 "project/radare2/libr/reg/arena.c"
regset->arena->bytes
...
# 295 "project/radare2/libr/reg/arena.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 295 "project/radare2/libr/reg/arena.c"
         *r_reg_arena_dup(RReg *reg, const 
# 295 "project/radare2/libr/reg/arena.c" 3 4
                                           unsigned char 
# 295 "project/radare2/libr/reg/arena.c"
                                               *source) {
 ...
 if (!reg || !regset || !regset->arena || (regset->arena->size < 1)) {
  return 
# 298 "project/radare2/libr/reg/arena.c" 3 4
        ((void *)0)
# 298 "project/radare2/libr/reg/arena.c"
            ;
 }
 
# 300 "project/radare2/libr/reg/arena.c" 3 4
unsigned char 
# 300 "project/radare2/libr/reg/arena.c"
    *ret = malloc (regset->arena->size);
 if (!ret) {
  return 
# 302 "project/radare2/libr/reg/arena.c" 3 4
        ((void *)0)
# 302 "project/radare2/libr/reg/arena.c"
            ;
 }
 
# 304 "project/radare2/libr/reg/arena.c" 3 4
__builtin___memcpy_chk (
# 304 "project/radare2/libr/reg/arena.c"
ret
# 304 "project/radare2/libr/reg/arena.c" 3 4
, 
# 304 "project/radare2/libr/reg/arena.c"
source, regset->arena->size
# 304 "project/radare2/libr/reg/arena.c" 3 4
, __builtin_object_size (
# 304 "project/radare2/libr/reg/arena.c"
ret
...
# 308 "project/radare2/libr/reg/arena.c" 3 4
__attribute__((visibility("default"))) 
# 308 "project/radare2/libr/reg/arena.c"
     int r_reg_arena_set_bytes(RReg *reg, const char *str) {
 str = r_str_trim_head_ro (str);
 int len = r_hex_str_is_valid (str);
 if (len == -1) {
  
# 312 "project/radare2/libr/reg/arena.c" 3 4
 fprintf(__stderrp,
# 312 "project/radare2/libr/reg/arena.c"
 "Invalid input\n"
# 312 "project/radare2/libr/reg/arena.c" 3 4
 )
# 312 "project/radare2/libr/reg/arena.c"
 ...
 int bin_str_len = (len + 1) / 2;
 
# 316 "project/radare2/libr/reg/arena.c" 3 4
unsigned char 
# 316 "project/radare2/libr/reg/arena.c"
    *bin_str = malloc (bin_str_len);
 if (!bin_str) {
  
# 318 "project/radare2/libr/reg/arena.c" 3 4
 fprintf(__stderrp,
# 318 "project/radare2/libr/reg/arena.c"
...
# 339 "project/radare2/libr/reg/arena.c" 3 4
__attribute__((visibility("default"))) 
# 339 "project/radare2/libr/reg/arena.c"
     void r_reg_arena_shrink(RReg *reg) {
 RListIter *iter;
 RRegArena *a;
 int i;
 for (i = 0; i < R_REG_TYPE_LAST; i++) {
  
# 344 "project/radare2/libr/reg/arena.c" 3 4
 if (
# 344 "project/radare2/libr/reg/arena.c"
 reg->regset[i].pool
# 344 "project/radare2/libr/reg/arena.c" 3 4
 ) for (
# 344 "project/radare2/libr/reg/arena.c"
