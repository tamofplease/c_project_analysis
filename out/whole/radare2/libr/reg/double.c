# 0 "project/radare2/libr/reg/double.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/reg/double.c"
...
# 4 "project/radare2/libr/reg/double.c" 2
...
# 5 "project/radare2/libr/reg/double.c" 2




__attribute__((visibility("default"))) 
# 9 "project/radare2/libr/reg/double.c"
     double r_reg_get_double(RReg *reg, RRegItem *item) {
 RRegSet *regset;
 double vld = 0.0f;
 int off;
 double ret = 0.0f;
 ...
 off = 
# 17 "project/radare2/libr/reg/double.c" 3 4
      (((
# 17 "project/radare2/libr/reg/double.c"
      item->offset
# 17 "project/radare2/libr/reg/double.c" 3 4
      )/8)+(((
# 17 "project/radare2/libr/reg/double.c"
...
# 22 "project/radare2/libr/reg/double.c" 3 4
  __builtin___memcpy_chk (
# 22 "project/radare2/libr/reg/double.c"
  &vld
# 22 "project/radare2/libr/reg/double.c" 3 4
  , 
# 22 "project/radare2/libr/reg/double.c"
  regset->arena->bytes + off, sizeof (double)
# 22 "project/radare2/libr/reg/double.c" 3 4
...
# 27 "project/radare2/libr/reg/double.c" 3 4
 fprintf(__stderrp,
# 27 "project/radare2/libr/reg/double.c"
 "r_reg_set_double: Bit size %d not supported\n", item->size
# 27 "project/radare2/libr/reg/double.c" 3 4
 )
# 27 "project/radare2/libr/reg/double.c"
                                                                      ;
...
# 33 "project/radare2/libr/reg/double.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 33 "project/radare2/libr/reg/double.c"
          r_reg_set_double(RReg *reg, RRegItem *item, double value) {
 
# 34 "project/radare2/libr/reg/double.c" 3 4
unsigned char 
# 34 "project/radare2/libr/reg/double.c"
    *src;

 if (!item) {
  
# 37 "project/radare2/libr/reg/double.c" 3 4
 fprintf(__stderrp,
# 37 "project/radare2/libr/reg/double.c"
 "r_reg_set_value: item is NULL\n"
# 37 "project/radare2/libr/reg/double.c" 3 4
 )
# 37 "project/radare2/libr/reg/double.c"
                                            ;
  return 
# 38 "project/radare2/libr/reg/double.c" 3 4
        0
# 38 "project/radare2/libr/reg/double.c"
             ;
 }
 switch (item->size) {
 case 64:
  ...
  src = (
# 43 "project/radare2/libr/reg/double.c" 3 4
        unsigned char 
# 43 "project/radare2/libr/reg/double.c"
            *)&value;
  break;
 default:
  
# 46 "project/radare2/libr/reg/double.c" 3 4
 fprintf(__stderrp,
# 46 "project/radare2/libr/reg/double.c"
 "r_reg_set_double: Bit size %d not supported\n", item->size
# 46 "project/radare2/libr/reg/double.c" 3 4
 )
# 46 "project/radare2/libr/reg/double.c"
                                                                      ;
  return 
# 47 "project/radare2/libr/reg/double.c" 3 4
        0
# 47 "project/radare2/libr/reg/double.c"
             ;
 }
 if (reg->regset[item->arena].arena->size - 
# 49 "project/radare2/libr/reg/double.c" 3 4
                                           (((
# 49 "project/radare2/libr/reg/double.c"
                                           item->offset
# 49 "project/radare2/libr/reg/double.c" 3 4
                                           )/8)+(((
# 49 "project/radare2/libr/reg/double.c"
...
# 51 "project/radare2/libr/reg/double.c" 3 4
   (((
# 51 "project/radare2/libr/reg/double.c"
   item->offset
# 51 "project/radare2/libr/reg/double.c" 3 4
   )/8)+(((
# 51 "project/radare2/libr/reg/double.c"
...
# 51 "project/radare2/libr/reg/double.c"
   ...
   src, item->size);
  return 
# 53 "project/radare2/libr/reg/double.c" 3 4
        1
# 53 "project/radare2/libr/reg/double.c"
            ;
 }
 
# 55 "project/radare2/libr/reg/double.c" 3 4
fprintf(__stderrp,
# 55 "project/radare2/libr/reg/double.c"
"r_reg_set_value: Cannot set %s to %lf\n", item->name, value
# 55 "project/radare2/libr/reg/double.c" 3 4
)
# 55 "project/radare2/libr/reg/double.c"
                                                                      ;
 return 
# 56 "project/radare2/libr/reg/double.c" 3 4
       0
# 56 "project/radare2/libr/reg/double.c"
            ;
}



# 60 "project/radare2/libr/reg/double.c" 3 4
__attribute__((visibility("default"))) 
# 60 "project/radare2/libr/reg/double.c"
     long double r_reg_get_longdouble(RReg *reg, RRegItem *item) {
 RRegSet *regset;
 ...
 off = 
# 68 "project/radare2/libr/reg/double.c" 3 4
      (((
# 68 "project/radare2/libr/reg/double.c"
      item->offset
# 68 "project/radare2/libr/reg/double.c" 3 4
      )/8)+(((
# 68 "project/radare2/libr/reg/double.c"
...
# 76 "project/radare2/libr/reg/double.c" 3 4
  __builtin___memcpy_chk (
# 76 "project/radare2/libr/reg/double.c"
  &vld
# 76 "project/radare2/libr/reg/double.c" 3 4
  , 
# 76 "project/radare2/libr/reg/double.c"
  regset->arena->bytes + off, sizeof (long double)
# 76 "project/radare2/libr/reg/double.c" 3 4
  , __builtin_object_size (
# 76 "project/radare2/libr/reg/double.c"
  &vld
...
# 81 "project/radare2/libr/reg/double.c" 3 4
 fprintf(__stderrp,
# 81 "project/radare2/libr/reg/double.c"
 "r_reg_get_longdouble: Bit size %d not supported\n", item->size
# 81 "project/radare2/libr/reg/double.c" 3 4
 )
# 81 "project/radare2/libr/reg/double.c"
                                                                          ;
...
# 87 "project/radare2/libr/reg/double.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 87 "project/radare2/libr/reg/double.c"
          r_reg_set_longdouble(RReg *reg, RRegItem *item, long double value) {
 
# 88 "project/radare2/libr/reg/double.c" 3 4
unsigned char 
# 88 "project/radare2/libr/reg/double.c"
    *src = 
# 88 "project/radare2/libr/reg/double.c" 3 4
           ((void *)0)
# 88 "project/radare2/libr/reg/double.c"
...
# 91 "project/radare2/libr/reg/double.c" 3 4
 fprintf(__stderrp,
# 91 "project/radare2/libr/reg/double.c"
 "r_reg_set_value: item is NULL\n"
# 91 "project/radare2/libr/reg/double.c" 3 4
 )
# 91 "project/radare2/libr/reg/double.c"
                                            ;
  return 
# 92 "project/radare2/libr/reg/double.c" 3 4
        0
# 92 "project/radare2/libr/reg/double.c"
             ;
 }
 switch (item->size) {
 case 80:
 ...
 case 128:
  ...
  src = (
# 99 "project/radare2/libr/reg/double.c" 3 4
        unsigned char 
# 99 "project/radare2/libr/reg/double.c"
            *)&value;
  break;
 default:
  
# 102 "project/radare2/libr/reg/double.c" 3 4
 fprintf(__stderrp,
# 102 "project/radare2/libr/reg/double.c"
 "r_reg_set_longdouble: Bit size %d not supported\n", item->size
# 102 "project/radare2/libr/reg/double.c" 3 4
 )
# 102 "project/radare2/libr/reg/double.c"
                                                                          ;
  return 
# 103 "project/radare2/libr/reg/double.c" 3 4
        0
# 103 "project/radare2/libr/reg/double.c"
             ;
 }
 if (reg->regset[item->arena].arena->size - 
# 105 "project/radare2/libr/reg/double.c" 3 4
                                           (((
# 105 "project/radare2/libr/reg/double.c"
                                           item->offset
# 105 "project/radare2/libr/reg/double.c" 3 4
                                           )/8)+(((
# 105 "project/radare2/libr/reg/double.c"
...
# 107 "project/radare2/libr/reg/double.c" 3 4
   (((
# 107 "project/radare2/libr/reg/double.c"
   item->offset
# 107 "project/radare2/libr/reg/double.c" 3 4
   )/8)+(((
# 107 "project/radare2/libr/reg/double.c"
...
# 107 "project/radare2/libr/reg/double.c"
   ...
   src, item->size);
  return 
# 109 "project/radare2/libr/reg/double.c" 3 4
        1
# 109 "project/radare2/libr/reg/double.c"
            ;
 }
 
# 111 "project/radare2/libr/reg/double.c" 3 4
fprintf(__stderrp,
# 111 "project/radare2/libr/reg/double.c"
...
# 111 "project/radare2/libr/reg/double.c"
 ...
 return 
# 113 "project/radare2/libr/reg/double.c" 3 4
       0
# 113 "project/radare2/libr/reg/double.c"
            ;
}



# 117 "project/radare2/libr/reg/double.c" 3 4
__attribute__((visibility("default"))) 
# 117 "project/radare2/libr/reg/double.c"
     float r_reg_get_float(RReg *reg, RRegItem *item) {

 return 0.0f;
}


# 122 "project/radare2/libr/reg/double.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 122 "project/radare2/libr/reg/double.c"
          r_reg_set_float(RReg *reg, RRegItem *item, float value) {
 return 
# 123 "project/radare2/libr/reg/double.c" 3 4
       0
# 123 "project/radare2/libr/reg/double.c"
            ;
}
