# 0 "project/radare2/libr/reg/profile.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/reg/profile.c" 2
...
# 5 "project/radare2/libr/reg/profile.c" 2
...
# 6 "project/radare2/libr/reg/profile.c" 2


# 7 "project/radare2/libr/reg/profile.c"
static const char *parse_alias(RReg *reg, char **tok, const int n) {
 if (n == 2) {
  ...
  return r_reg_set_name (reg, role, tok[1])
   ? 
# 11 "project/radare2/libr/reg/profile.c" 3 4
    ((void *)0)
   
# 12 "project/radare2/libr/reg/profile.c"
  : "Invalid alias";
 }
...
static 
# 20 "project/radare2/libr/reg/profile.c" 3 4
      unsigned long long 
# 20 "project/radare2/libr/reg/profile.c"
           parse_size(char *s, char **end) {
 if (*s == '.') {
...
# 27 "project/radare2/libr/reg/profile.c" 3 4
 unsigned long long 
# 27 "project/radare2/libr/reg/profile.c"
      a = strtoul (s, end, 0) << 3;
  
# 28 "project/radare2/libr/reg/profile.c" 3 4
 unsigned long long 
# 28 "project/radare2/libr/reg/profile.c"
      b = strtoul (has_dot, end, 0);
  return a + b;
 }
...
# 62 "project/radare2/libr/reg/profile.c" 3 4
 fprintf(__stderrp,
# 62 "project/radare2/libr/reg/profile.c"
...
# 62 "project/radare2/libr/reg/profile.c"
                                                                   ;
  return 
# 63 "project/radare2/libr/reg/profile.c" 3 4
        ((void *)0)
# 63 "project/radare2/libr/reg/profile.c"
            ;
 ...
 RRegItem *item = 
# 68 "project/radare2/libr/reg/profile.c" 3 4
                 (
# 68 "project/radare2/libr/reg/profile.c"
                 RRegItem
# 68 "project/radare2/libr/reg/profile.c" 3 4
                 *)calloc(1,sizeof(
# 68 "project/radare2/libr/reg/profile.c"
...
# 68 "project/radare2/libr/reg/profile.c"
 ...
 return 
# 125 "project/radare2/libr/reg/profile.c" 3 4
       ((void *)0)
# 125 "project/radare2/libr/reg/profile.c"
           ;
}

#define PARSER_MAX_TOKENS 8

# 129 "project/radare2/libr/reg/profile.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 129 "project/radare2/libr/reg/profile.c"
          r_reg_set_profile_string(RReg *reg, const char *str) {
 char *tok[8];
 char tmp[128];
 int i, j, l;
 const char *p = str;
...
# 135 "project/radare2/libr/reg/profile.c" 3 4
do { if (!(
# 135 "project/radare2/libr/reg/profile.c"
reg && str
# 135 "project/radare2/libr/reg/profile.c" 3 4
...
"reg && str"
# 135 "project/radare2/libr/reg/profile.c" 3 4
, 135); return (0); } } while (0)
# 135 "project/radare2/libr/reg/profile.c"
                                        ;
 if (
# 136 "project/radare2/libr/reg/profile.c" 3 4
    (!(
# 136 "project/radare2/libr/reg/profile.c"
    str
# 136 "project/radare2/libr/reg/profile.c" 3 4
    ) || !*(
# 136 "project/radare2/libr/reg/profile.c"
...
# 136 "project/radare2/libr/reg/profile.c"
  ...
  return 
# 137 "project/radare2/libr/reg/profile.c" 3 4
        1
# 137 "project/radare2/libr/reg/profile.c"
            ;
 }
 ...
 if (reg->reg_profile_str && !strcmp (reg->reg_profile_str, str)) {
  ...
  return 
# 144 "project/radare2/libr/reg/profile.c" 3 4
        1
# 144 "project/radare2/libr/reg/profile.c"
            ;
 }
...
# 150 "project/radare2/libr/reg/profile.c" 3 4
                          1
# 150 "project/radare2/libr/reg/profile.c"
                              );
...
# 158 "project/radare2/libr/reg/profile.c" 3 4
_Bool 
# 158 "project/radare2/libr/reg/profile.c"
     have_a0 = 
# 158 "project/radare2/libr/reg/profile.c" 3 4
               0
# 158 "project/radare2/libr/reg/profile.c"
  ...
  if (j) {
   ...
   if (!strncmp (first, "=RS", 3)) {
    ...
    if (!strncmp (first, "=A0", 3)) {
     have_a0 = 
# 223 "project/radare2/libr/reg/profile.c" 3 4
              1
# 223 "project/radare2/libr/reg/profile.c"
                  ;
    }
...
# 231 "project/radare2/libr/reg/profile.c" 3 4
    fprintf(__stderrp,
# 231 "project/radare2/libr/reg/profile.c"
    "%s: Parse error @ line %d (%s)\n", __FUNCTION__, l, r
# 231 "project/radare2/libr/reg/profile.c" 3 4
    )
                          
# 232 "project/radare2/libr/reg/profile.c"
                         ;


     r_reg_free_internal (reg, 
# 235 "project/radare2/libr/reg/profile.c" 3 4
                              0
# 235 "project/radare2/libr/reg/profile.c"
                                   );
     r_reg_init (reg);
     return 
# 237 "project/radare2/libr/reg/profile.c" 3 4
           0
# 237 "project/radare2/libr/reg/profile.c"
                ;
    }
   }
  }
...
# 243 "project/radare2/libr/reg/profile.c" 3 4
 fprintf(__stderrp,
# 243 "project/radare2/libr/reg/profile.c"
...
# 243 "project/radare2/libr/reg/profile.c"
 ...
 return 
# 265 "project/radare2/libr/reg/profile.c" 3 4
       1
# 265 "project/radare2/libr/reg/profile.c"
           ;
}



# 269 "project/radare2/libr/reg/profile.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 269 "project/radare2/libr/reg/profile.c"
          r_reg_set_profile(RReg *reg, const char *profile) {
 
# 270 "project/radare2/libr/reg/profile.c" 3 4
do { if (!(
# 270 "project/radare2/libr/reg/profile.c"
reg && profile
# 270 "project/radare2/libr/reg/profile.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 270 "project/radare2/libr/reg/profile.c"
...
# 271 "project/radare2/libr/reg/profile.c" 3 4
                                   ((void *)0)
# 271 "project/radare2/libr/reg/profile.c"
                                       );
 if (!str) {
  char *base = r_sys_getenv (
# 273 "project/radare2/libr/reg/profile.c" 3 4
                            "R2_LIBR_PLUGINS"
# 273 "project/radare2/libr/reg/profile.c"
                                     );
  if (base) {
   char *file = r_str_append (base, profile);
   str = r_file_slurp (file, 
# 276 "project/radare2/libr/reg/profile.c" 3 4
                            ((void *)0)
# 276 "project/radare2/libr/reg/profile.c"
                                );
   free (file);
  }
 }
...
# 281 "project/radare2/libr/reg/profile.c" 3 4
 fprintf(__stderrp,
# 281 "project/radare2/libr/reg/profile.c"
 "r_reg_set_profile: Cannot find '%s'\n", profile
# 281 "project/radare2/libr/reg/profile.c" 3 4
 )
# 281 "project/radare2/libr/reg/profile.c"
                                                           ;
  return 
# 282 "project/radare2/libr/reg/profile.c" 3 4
        0
# 282 "project/radare2/libr/reg/profile.c"
             ;
 }
 
# 284 "project/radare2/libr/reg/profile.c" 3 4
_Bool 
# 284 "project/radare2/libr/reg/profile.c"
...
# 290 "project/radare2/libr/reg/profile.c" 3 4
do { if (!(
# 290 "project/radare2/libr/reg/profile.c"
gdb
# 290 "project/radare2/libr/reg/profile.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 290 "project/radare2/libr/reg/profile.c"
...
# 290 "project/radare2/libr/reg/profile.c"
 ...
 if (!sb) {
  return 
# 293 "project/radare2/libr/reg/profile.c" 3 4
        ((void *)0)
# 293 "project/radare2/libr/reg/profile.c"
            ;
 }
 ...
 if (r_str_startswith (ptr, "Name")) {
  if (!(ptr = strchr (ptr, '\n'))) {
   return 
# 307 "project/radare2/libr/reg/profile.c" 3 4
         ((void *)0)
# 307 "project/radare2/libr/reg/profile.c"
             ;
  }
  ptr++;
 }
 for (;;) {
  ...
  while (isspace ((
# 313 "project/radare2/libr/reg/profile.c" 3 4
                  unsigned char
# 313 "project/radare2/libr/reg/profile.c"
                     )*ptr)) {
   ptr++;
  }
  if (!*ptr) {
...
# 322 "project/radare2/libr/reg/profile.c" 3 4
  fprintf(__stderrp,
# 322 "project/radare2/libr/reg/profile.c"
...
# 322 "project/radare2/libr/reg/profile.c"
   ...
   r_strbuf_free (sb);
   return 
# 324 "project/radare2/libr/reg/profile.c" 3 4
         0
# 324 "project/radare2/libr/reg/profile.c"
              ;
  }
...
# 331 "project/radare2/libr/reg/profile.c" 3 4
   fprintf(__stderrp,
# 331 "project/radare2/libr/reg/profile.c"
...
# 331 "project/radare2/libr/reg/profile.c"
    ...
    r_strbuf_free (sb);
    return 
# 333 "project/radare2/libr/reg/profile.c" 3 4
          0
# 333 "project/radare2/libr/reg/profile.c"
               ;
   }
   ptr = ptr1 + 1;
   continue;
...
# 412 "project/radare2/libr/reg/profile.c" 3 4
__attribute__((visibility("default"))) 
# 412 "project/radare2/libr/reg/profile.c"
     char *r_reg_parse_gdb_profile(const char *profile_file) {
 char *str = 
# 413 "project/radare2/libr/reg/profile.c" 3 4
            ((void *)0)
# 413 "project/radare2/libr/reg/profile.c"
                ;
 if (!(str = r_file_slurp (profile_file, 
# 414 "project/radare2/libr/reg/profile.c" 3 4
                                        ((void *)0)
# 414 "project/radare2/libr/reg/profile.c"
                                            ))) {
  char *base = r_sys_getenv (
# 415 "project/radare2/libr/reg/profile.c" 3 4
                            "R2_LIBR_PLUGINS"
# 415 "project/radare2/libr/reg/profile.c"
                                     );
  if (base) {
   char *file = r_str_appendf (base, 
# 417 "project/radare2/libr/reg/profile.c" 3 4
                                    "/" 
# 417 "project/radare2/libr/reg/profile.c"
                                              "%s", profile_file);
   if (file) {
    str = r_file_slurp (file, 
# 419 "project/radare2/libr/reg/profile.c" 3 4
                             ((void *)0)
# 419 "project/radare2/libr/reg/profile.c"
                                 );
    free (file);
   }
  }
...
# 429 "project/radare2/libr/reg/profile.c" 3 4
fprintf(__stderrp,
# 429 "project/radare2/libr/reg/profile.c"
"r_reg_parse_gdb_profile: Cannot find '%s'\n", profile_file
# 429 "project/radare2/libr/reg/profile.c" 3 4
)
# 429 "project/radare2/libr/reg/profile.c"
                                                                     ;
 return 
# 430 "project/radare2/libr/reg/profile.c" 3 4
       ((void *)0)
# 430 "project/radare2/libr/reg/profile.c"
           ;
}


# 433 "project/radare2/libr/reg/profile.c" 3 4
__attribute__((visibility("default"))) 
# 433 "project/radare2/libr/reg/profile.c"
 ...
 if (!r0) {
  ...
  return 
# 446 "project/radare2/libr/reg/profile.c" 3 4
        ((void *)0)
# 446 "project/radare2/libr/reg/profile.c"
            ;
 }
 if (a3 && a2 && a1) {
