# 0 "project/radare2/libr/reg/rvalue.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/reg/rvalue.c"
...
# 5 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_reg.h" 2 3 4
...
# 6 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_reg.h" 2 3 4
...
# 7 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_reg.h" 2 3 4
...
# 8 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/include/r_reg.h" 2 3 4
...
# 4 "project/radare2/libr/reg/rvalue.c" 2
...
# 5 "project/radare2/libr/reg/rvalue.c" 2


# 6 "project/radare2/libr/reg/rvalue.c"
typedef 
# 6 "project/radare2/libr/reg/rvalue.c" 3 4
       unsigned int 
# 6 "project/radare2/libr/reg/rvalue.c"
            ut27;
static ut27 r_read_me27(const 
# 7 "project/radare2/libr/reg/rvalue.c" 3 4
                             unsigned char 
# 7 "project/radare2/libr/reg/rvalue.c"
                                 *buf, int boff) {
 ut27 ret = 0;
 r_mem_copybits_delta ((
# 9 "project/radare2/libr/reg/rvalue.c" 3 4
                       unsigned char 
# 9 "project/radare2/libr/reg/rvalue.c"
                           *)&ret, 18, buf, boff, 9);
 r_mem_copybits_delta ((
# 10 "project/radare2/libr/reg/rvalue.c" 3 4
                       unsigned char 
# 10 "project/radare2/libr/reg/rvalue.c"
                           *)&ret, 9, buf, boff + 9, 9);
 r_mem_copybits_delta ((
# 11 "project/radare2/libr/reg/rvalue.c" 3 4
                       unsigned char 
# 11 "project/radare2/libr/reg/rvalue.c"
                           *)&ret, 0, buf, boff + 18, 9);
 return ret;
}


# 15 "project/radare2/libr/reg/rvalue.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 15 "project/radare2/libr/reg/rvalue.c"
          r_reg_get_value_big(RReg *reg, RRegItem *item, utX *val) {
 
# 16 "project/radare2/libr/reg/rvalue.c" 3 4
do { if (!(
# 16 "project/radare2/libr/reg/rvalue.c"
reg && item
# 16 "project/radare2/libr/reg/rvalue.c" 3 4
...
# 18 "project/radare2/libr/reg/rvalue.c" 3 4
unsigned long long 
# 18 "project/radare2/libr/reg/rvalue.c"
     ret = 0LL;
 int off = 
# 19 "project/radare2/libr/reg/rvalue.c" 3 4
          (((
# 19 "project/radare2/libr/reg/rvalue.c"
          item->offset
# 19 "project/radare2/libr/reg/rvalue.c" 3 4
          )/8)+(((
# 19 "project/radare2/libr/reg/rvalue.c"
...
# 19 "project/radare2/libr/reg/rvalue.c"
 ...
 case 80:
  if (regset->arena->bytes && (off + 10 <= regset->arena->size)) {
   val->v80.Low = *((
# 27 "project/radare2/libr/reg/rvalue.c" 3 4
                    unsigned long long 
# 27 "project/radare2/libr/reg/rvalue.c"
                         *)(regset->arena->bytes + off));
   val->v80.High = *((
# 28 "project/radare2/libr/reg/rvalue.c" 3 4
                     unsigned short 
# 28 "project/radare2/libr/reg/rvalue.c"
                          *)(regset->arena->bytes + off + 8));
  } else {
   
# 30 "project/radare2/libr/reg/rvalue.c" 3 4
  fprintf(__stderrp,
# 30 "project/radare2/libr/reg/rvalue.c"
...
# 30 "project/radare2/libr/reg/rvalue.c"
 ...
 case 96:
  if (regset->arena->bytes && (off + 12 <= regset->arena->size)) {
   val->v96.Low = *((
# 36 "project/radare2/libr/reg/rvalue.c" 3 4
                    unsigned long long 
# 36 "project/radare2/libr/reg/rvalue.c"
                         *)(regset->arena->bytes + off));
   val->v96.High = *((
# 37 "project/radare2/libr/reg/rvalue.c" 3 4
                     unsigned int 
# 37 "project/radare2/libr/reg/rvalue.c"
                          *)(regset->arena->bytes + off + 8));
  } else {
   
# 39 "project/radare2/libr/reg/rvalue.c" 3 4
  fprintf(__stderrp,
# 39 "project/radare2/libr/reg/rvalue.c"
  "r_reg_get_value: null or oob arena for current regset\n"
# 39 "project/radare2/libr/reg/rvalue.c" 3 4
  )
# 39 "project/radare2/libr/reg/rvalue.c"
 ...
 case 128:
  if (regset->arena->bytes && (off + 16 <= regset->arena->size)) {
   val->v128.Low = *((
# 45 "project/radare2/libr/reg/rvalue.c" 3 4
                     unsigned long long 
# 45 "project/radare2/libr/reg/rvalue.c"
                          *)(regset->arena->bytes + off));
   val->v128.High = *((
# 46 "project/radare2/libr/reg/rvalue.c" 3 4
                      unsigned long long 
# 46 "project/radare2/libr/reg/rvalue.c"
                           *)(regset->arena->bytes + off + 8));
  } else {
   
# 48 "project/radare2/libr/reg/rvalue.c" 3 4
  fprintf(__stderrp,
# 48 "project/radare2/libr/reg/rvalue.c"
  "r_reg_get_value: null or oob arena for current regset\n"
# 48 "project/radare2/libr/reg/rvalue.c" 3 4
  )
# 48 "project/radare2/libr/reg/rvalue.c"
 ...
 case 256:
  if (regset->arena->bytes && (off + 32 <= regset->arena->size)) {
   val->v256.Low.Low = *((
# 54 "project/radare2/libr/reg/rvalue.c" 3 4
                         unsigned long long 
# 54 "project/radare2/libr/reg/rvalue.c"
                              *)(regset->arena->bytes + off));
   val->v256.Low.High = *((
# 55 "project/radare2/libr/reg/rvalue.c" 3 4
                          unsigned long long 
# 55 "project/radare2/libr/reg/rvalue.c"
                               *)(regset->arena->bytes + off + 8));
   val->v256.High.Low = *((
# 56 "project/radare2/libr/reg/rvalue.c" 3 4
                          unsigned long long 
# 56 "project/radare2/libr/reg/rvalue.c"
                               *)(regset->arena->bytes + off + 16));
   val->v256.High.High = *((
# 57 "project/radare2/libr/reg/rvalue.c" 3 4
                           unsigned long long 
# 57 "project/radare2/libr/reg/rvalue.c"
                                *)(regset->arena->bytes + off + 24));
  } else {
   
# 59 "project/radare2/libr/reg/rvalue.c" 3 4
  fprintf(__stderrp,
# 59 "project/radare2/libr/reg/rvalue.c"
  "r_reg_get_value: null or oob arena for current regset\n"
# 59 "project/radare2/libr/reg/rvalue.c" 3 4
  )
# 59 "project/radare2/libr/reg/rvalue.c"
...
# 64 "project/radare2/libr/reg/rvalue.c" 3 4
 fprintf(__stderrp,
# 64 "project/radare2/libr/reg/rvalue.c"
 "r_reg_get_value_big: Bit size %d not supported\n", item->size
# 64 "project/radare2/libr/reg/rvalue.c" 3 4
 )
# 64 "project/radare2/libr/reg/rvalue.c"
                                                                         ;
...
# 70 "project/radare2/libr/reg/rvalue.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 70 "project/radare2/libr/reg/rvalue.c"
          r_reg_get_value(RReg *reg, RRegItem *item) {
 
# 71 "project/radare2/libr/reg/rvalue.c" 3 4
do { if (!(
# 71 "project/radare2/libr/reg/rvalue.c"
reg && item
# 71 "project/radare2/libr/reg/rvalue.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 71 "project/radare2/libr/reg/rvalue.c"
...
# 71 "project/radare2/libr/reg/rvalue.c"
 ...
 int off = 
# 75 "project/radare2/libr/reg/rvalue.c" 3 4
          (((
# 75 "project/radare2/libr/reg/rvalue.c"
          item->offset
# 75 "project/radare2/libr/reg/rvalue.c" 3 4
          )/8)+(((
# 75 "project/radare2/libr/reg/rvalue.c"
...
# 115 "project/radare2/libr/reg/rvalue.c" 3 4
 fprintf(__stderrp,
# 115 "project/radare2/libr/reg/rvalue.c"
 "r_reg_get_value: 32bit oob read %d\n", off
# 115 "project/radare2/libr/reg/rvalue.c" 3 4
 )
# 115 "project/radare2/libr/reg/rvalue.c"
                                                      ;
 ...
 case 96:
  ...
  return (
# 126 "project/radare2/libr/reg/rvalue.c" 3 4
         unsigned long long
# 126 "project/radare2/libr/reg/rvalue.c"
             )r_reg_get_longdouble (reg, item);
 case 128:
 case 256:

  return (
# 130 "project/radare2/libr/reg/rvalue.c" 3 4
         unsigned long long
# 130 "project/radare2/libr/reg/rvalue.c"
             )r_reg_get_longdouble (reg, item);
 default:
  
# 132 "project/radare2/libr/reg/rvalue.c" 3 4
 fprintf(__stderrp,
# 132 "project/radare2/libr/reg/rvalue.c"
 "r_reg_get_value: Bit size %d not supported\n", item->size
# 132 "project/radare2/libr/reg/rvalue.c" 3 4
 )
# 132 "project/radare2/libr/reg/rvalue.c"
                                                                     ;
...
# 138 "project/radare2/libr/reg/rvalue.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 138 "project/radare2/libr/reg/rvalue.c"
          r_reg_get_value_by_role(RReg *reg, RRegisterId role) {

 return r_reg_get_value (reg, r_reg_get (reg, r_reg_get_name (reg, role), -1));
}


# 143 "project/radare2/libr/reg/rvalue.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 143 "project/radare2/libr/reg/rvalue.c"
          r_reg_set_value(RReg *reg, RRegItem *item, 
# 143 "project/radare2/libr/reg/rvalue.c" 3 4
                                                     unsigned long long 
# 143 "project/radare2/libr/reg/rvalue.c"
                                                          value) {
 
# 144 "project/radare2/libr/reg/rvalue.c" 3 4
do { if (!(
# 144 "project/radare2/libr/reg/rvalue.c"
reg && item
# 144 "project/radare2/libr/reg/rvalue.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 144 "project/radare2/libr/reg/rvalue.c"
"reg && item"
# 144 "project/radare2/libr/reg/rvalue.c" 3 4
, 144); return (0); } } while (0)
# 144 "project/radare2/libr/reg/rvalue.c"
                                         ;

 
# 146 "project/radare2/libr/reg/rvalue.c" 3 4
unsigned char 
# 146 "project/radare2/libr/reg/rvalue.c"
    bytes[12];
 
# 147 "project/radare2/libr/reg/rvalue.c" 3 4
unsigned char 
# 147 "project/radare2/libr/reg/rvalue.c"
    *src = bytes;

 if (r_reg_is_readonly (reg, item)) {
  return 
# 150 "project/radare2/libr/reg/rvalue.c" 3 4
        1
# 150 "project/radare2/libr/reg/rvalue.c"
            ;
 }
 if (item->offset < 0) {
  return 
# 153 "project/radare2/libr/reg/rvalue.c" 3 4
        1
# 153 "project/radare2/libr/reg/rvalue.c"
            ;
 }
 RRegArena *arena = reg->regset[item->arena].arena;
 if (!arena) {
  return 
# 157 "project/radare2/libr/reg/rvalue.c" 3 4
        0
# 157 "project/radare2/libr/reg/rvalue.c"
             ;
 }
 switch (item->size) {
 case 80:
 ...
 case 8:
  r_write_ble8 (src, (
# 186 "project/radare2/libr/reg/rvalue.c" 3 4
                     unsigned char
# 186 "project/radare2/libr/reg/rvalue.c"
                        ) (value & 
# 186 "project/radare2/libr/reg/rvalue.c" 3 4
                                   0xFFU
# 186 "project/radare2/libr/reg/rvalue.c"
...
# 190 "project/radare2/libr/reg/rvalue.c" 3 4
  unsigned char 
# 190 "project/radare2/libr/reg/rvalue.c"
      *buf = arena->bytes + (item->offset / 8);
   int bit = (item->offset % 8);
   
# 192 "project/radare2/libr/reg/rvalue.c" 3 4
  unsigned char 
# 192 "project/radare2/libr/reg/rvalue.c"
      mask = (1 << bit);
...
# 197 "project/radare2/libr/reg/rvalue.c" 3 4
   fprintf(__stderrp,
# 197 "project/radare2/libr/reg/rvalue.c"
   "RRegSetOverflow %d vs %d\n", idx + item->size, arena->size
# 197 "project/radare2/libr/reg/rvalue.c" 3 4
   )
# 197 "project/radare2/libr/reg/rvalue.c"
                                                                        ;
    return 
# 198 "project/radare2/libr/reg/rvalue.c" 3 4
          0
# 198 "project/radare2/libr/reg/rvalue.c"
               ;
   }
   
# 200 "project/radare2/libr/reg/rvalue.c" 3 4
  unsigned char 
# 200 "project/radare2/libr/reg/rvalue.c"
      *buf = arena->bytes + idx;
   int bit = item->offset % 8;
   
# 202 "project/radare2/libr/reg/rvalue.c" 3 4
  unsigned char 
# 202 "project/radare2/libr/reg/rvalue.c"
      mask = 0xff ^ (1 << bit);
   buf[0] = (buf[0] & mask) | 0;
  }
  return 
# 205 "project/radare2/libr/reg/rvalue.c" 3 4
        1
# 205 "project/radare2/libr/reg/rvalue.c"
            ;
 case 128:
 case 256:

  return 
# 209 "project/radare2/libr/reg/rvalue.c" 3 4
        0
# 209 "project/radare2/libr/reg/rvalue.c"
             ;
 default:
  
# 211 "project/radare2/libr/reg/rvalue.c" 3 4
 fprintf(__stderrp,
# 211 "project/radare2/libr/reg/rvalue.c"
 "r_reg_set_value: Bit size %d not supported\n", item->size
# 211 "project/radare2/libr/reg/rvalue.c" 3 4
 )
# 211 "project/radare2/libr/reg/rvalue.c"
                                                                     ;
  return 
# 212 "project/radare2/libr/reg/rvalue.c" 3 4
        0
# 212 "project/radare2/libr/reg/rvalue.c"
             ;
 }
 const 
# 214 "project/radare2/libr/reg/rvalue.c" 3 4
      _Bool 
# 214 "project/radare2/libr/reg/rvalue.c"
           fits_in_arena = (arena->size - 
# 214 "project/radare2/libr/reg/rvalue.c" 3 4
                                          (((
# 214 "project/radare2/libr/reg/rvalue.c"
                                          item->offset
...
# 217 "project/radare2/libr/reg/rvalue.c" 3 4
   (((
# 217 "project/radare2/libr/reg/rvalue.c"
   item->offset
# 217 "project/radare2/libr/reg/rvalue.c" 3 4
   )/8)+(((
# 217 "project/radare2/libr/reg/rvalue.c"
...
# 217 "project/radare2/libr/reg/rvalue.c"
    ...
    src, item->size);
  return 
# 219 "project/radare2/libr/reg/rvalue.c" 3 4
        1
# 219 "project/radare2/libr/reg/rvalue.c"
            ;
 }
 
# 221 "project/radare2/libr/reg/rvalue.c" 3 4
fprintf(__stderrp,
# 221 "project/radare2/libr/reg/rvalue.c"
"r_reg_set_value: Cannot set %s to 0x%" 
# 221 "project/radare2/libr/reg/rvalue.c" 3 4
"llx" 
# 221 "project/radare2/libr/reg/rvalue.c"
"\n", item->name, value
...
# 221 "project/radare2/libr/reg/rvalue.c"
                                                                                 ;
 return 
# 222 "project/radare2/libr/reg/rvalue.c" 3 4
       0
# 222 "project/radare2/libr/reg/rvalue.c"
            ;
}


# 225 "project/radare2/libr/reg/rvalue.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 225 "project/radare2/libr/reg/rvalue.c"
          r_reg_set_value_by_role(RReg *reg, RRegisterId role, 
# 225 "project/radare2/libr/reg/rvalue.c" 3 4
                                                               unsigned long long 
# 225 "project/radare2/libr/reg/rvalue.c"
                                                                    val) {
...
# 231 "project/radare2/libr/reg/rvalue.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 231 "project/radare2/libr/reg/rvalue.c"
          r_reg_set_bvalue(RReg *reg, RRegItem *item, const char *str) {
 
# 232 "project/radare2/libr/reg/rvalue.c" 3 4
unsigned long long 
# 232 "project/radare2/libr/reg/rvalue.c"
     num = 
# 232 "project/radare2/libr/reg/rvalue.c" 3 4
...
# 232 "project/radare2/libr/reg/rvalue.c"
 ...
 if (item && item->flags && str) {
  ...
  if (num == 
# 235 "project/radare2/libr/reg/rvalue.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 235 "project/radare2/libr/reg/rvalue.c"
                    ) {
   num = r_num_math (
# 236 "project/radare2/libr/reg/rvalue.c" 3 4
                    ((void *)0)
# 236 "project/radare2/libr/reg/rvalue.c"
                        , str);
  }
...
# 243 "project/radare2/libr/reg/rvalue.c" 3 4
__attribute__((visibility("default"))) 
# 243 "project/radare2/libr/reg/rvalue.c"
            char *r_reg_get_bvalue(RReg *reg, RRegItem *item) {
 char *out = 
# 244 "project/radare2/libr/reg/rvalue.c" 3 4
            ((void *)0)
# 244 "project/radare2/libr/reg/rvalue.c"
                ;
 if (reg && item && item->flags) {
  out = malloc (strlen (item->flags) + 1);
  if (out) {
   
# 248 "project/radare2/libr/reg/rvalue.c" 3 4
  unsigned long long 
# 248 "project/radare2/libr/reg/rvalue.c"
       num = r_reg_get_value (reg, item);
   r_str_bits (out, (
# 249 "project/radare2/libr/reg/rvalue.c" 3 4
                    unsigned char 
# 249 "project/radare2/libr/reg/rvalue.c"
                        *)&num,
...
# 260 "project/radare2/libr/reg/rvalue.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 260 "project/radare2/libr/reg/rvalue.c"
          r_reg_get_pack(RReg *reg, RRegItem *item, int packidx, int packbits) {
 
# 261 "project/radare2/libr/reg/rvalue.c" 3 4
do { if (!(
# 261 "project/radare2/libr/reg/rvalue.c"
reg && item
# 261 "project/radare2/libr/reg/rvalue.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 261 "project/radare2/libr/reg/rvalue.c"
...
# 268 "project/radare2/libr/reg/rvalue.c" 3 4
 fprintf(__stderrp,
# 268 "project/radare2/libr/reg/rvalue.c"
...
# 271 "project/radare2/libr/reg/rvalue.c" 3 4
unsigned long long 
# 271 "project/radare2/libr/reg/rvalue.c"
     ret = 0LL;
 const int packbytes = packbits / 8;
 const int packmod = packbits % 8;
 if (packmod) {
  
# 275 "project/radare2/libr/reg/rvalue.c" 3 4
 fprintf(__stderrp,
# 275 "project/radare2/libr/reg/rvalue.c"
...
# 279 "project/radare2/libr/reg/rvalue.c" 3 4
 fprintf(__stderrp,
# 279 "project/radare2/libr/reg/rvalue.c"
...
# 279 "project/radare2/libr/reg/rvalue.c"
 ...
 int off = 
# 286 "project/radare2/libr/reg/rvalue.c" 3 4
          (((
# 286 "project/radare2/libr/reg/rvalue.c"
          item->offset
# 286 "project/radare2/libr/reg/rvalue.c" 3 4
          )/8)+(((
# 286 "project/radare2/libr/reg/rvalue.c"
...
# 298 "project/radare2/libr/reg/rvalue.c" 3 4
__attribute__((visibility("default"))) 
# 298 "project/radare2/libr/reg/rvalue.c"
     int r_reg_set_pack(RReg *reg, RRegItem *item, int packidx, int packbits, 
# 298 "project/radare2/libr/reg/rvalue.c" 3 4
                                                                              unsigned long long 
# 298 "project/radare2/libr/reg/rvalue.c"
                                                                                   val) {
 
# 299 "project/radare2/libr/reg/rvalue.c" 3 4
do { if (!(
# 299 "project/radare2/libr/reg/rvalue.c"
reg && reg->regset->arena && item
# 299 "project/radare2/libr/reg/rvalue.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 299 "project/radare2/libr/reg/rvalue.c"
"reg && reg->regset->arena && item"
# 299 "project/radare2/libr/reg/rvalue.c" 3 4
, 299); return (0); } } while (0)
# 299 "project/radare2/libr/reg/rvalue.c"
                                                               ;
...
# 306 "project/radare2/libr/reg/rvalue.c" 3 4
 fprintf(__stderrp,
# 306 "project/radare2/libr/reg/rvalue.c"
 "Does not support pack bits > 64\n"
# 306 "project/radare2/libr/reg/rvalue.c" 3 4
 )
# 306 "project/radare2/libr/reg/rvalue.c"
...
# 311 "project/radare2/libr/reg/rvalue.c" 3 4
 fprintf(__stderrp,
# 311 "project/radare2/libr/reg/rvalue.c"
 "Packed index is beyond the register size\n"
# 311 "project/radare2/libr/reg/rvalue.c" 3 4
 )
# 311 "project/radare2/libr/reg/rvalue.c"
                                                       ;
  return 
# 312 "project/radare2/libr/reg/rvalue.c" 3 4
        0
# 312 "project/radare2/libr/reg/rvalue.c"
             ;
 }
 int off = 
# 314 "project/radare2/libr/reg/rvalue.c" 3 4
          (((
# 314 "project/radare2/libr/reg/rvalue.c"
          item->offset
# 314 "project/radare2/libr/reg/rvalue.c" 3 4
          )/8)+(((
# 314 "project/radare2/libr/reg/rvalue.c"
...
# 314 "project/radare2/libr/reg/rvalue.c"
                                   ;
 off += (packidx * packbytes);
 if (reg->regset[item->arena].arena->size - 
# 316 "project/radare2/libr/reg/rvalue.c" 3 4
                                           (((
# 316 "project/radare2/libr/reg/rvalue.c"
                                           off
# 316 "project/radare2/libr/reg/rvalue.c" 3 4
                                           )/8)+(((
# 316 "project/radare2/libr/reg/rvalue.c"
...
# 317 "project/radare2/libr/reg/rvalue.c" 3 4
 unsigned char 
# 317 "project/radare2/libr/reg/rvalue.c"
     *dst = reg->regset[item->arena].arena->bytes + off;
  int i;
  for (i = 0; i < packbytes; i++, val >>= 8) {
   dst[i] = val & 0xff;
  }
  return 
# 322 "project/radare2/libr/reg/rvalue.c" 3 4
        1
# 322 "project/radare2/libr/reg/rvalue.c"
            ;
 }
 
# 324 "project/radare2/libr/reg/rvalue.c" 3 4
fprintf(__stderrp,
# 324 "project/radare2/libr/reg/rvalue.c"
"r_reg_set_value: Cannot set %s to 0x%" 
# 324 "project/radare2/libr/reg/rvalue.c" 3 4
"llx" 
# 324 "project/radare2/libr/reg/rvalue.c"
...
# 324 "project/radare2/libr/reg/rvalue.c"
                                                                               ;
 return 
# 325 "project/radare2/libr/reg/rvalue.c" 3 4
       0
# 325 "project/radare2/libr/reg/rvalue.c"
            ;
}
