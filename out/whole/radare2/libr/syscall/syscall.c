# 0 "project/radare2/libr/syscall/syscall.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/syscall/syscall.c"
...
# 4 "project/radare2/libr/syscall/syscall.c" 2
...
# 5 "project/radare2/libr/syscall/syscall.c" 2
...
# 6 "project/radare2/libr/syscall/syscall.c" 2



__attribute__((visibility("default"))) const char *
# 9 "project/radare2/libr/syscall/syscall.c"
r_syscall_version
# 9 "project/radare2/libr/syscall/syscall.c" 3 4
(void) { return "" "5.5.4"; }
# 9 "project/radare2/libr/syscall/syscall.c"
                        ;
...
# 15 "project/radare2/libr/syscall/syscall.c" 3 4
__attribute__((visibility("default"))) 
# 15 "project/radare2/libr/syscall/syscall.c"
     RSyscall* r_syscall_ref(RSyscall *sc) {
 sc->refs++;
 return sc;
}


# 20 "project/radare2/libr/syscall/syscall.c" 3 4
__attribute__((visibility("default"))) 
# 20 "project/radare2/libr/syscall/syscall.c"
     RSyscall* r_syscall_new(void) {
 RSyscall *rs = 
# 21 "project/radare2/libr/syscall/syscall.c" 3 4
               (
# 21 "project/radare2/libr/syscall/syscall.c"
               RSyscall
# 21 "project/radare2/libr/syscall/syscall.c" 3 4
               *)calloc(1,sizeof(
# 21 "project/radare2/libr/syscall/syscall.c"
...
# 30 "project/radare2/libr/syscall/syscall.c" 3 4
__attribute__((visibility("default"))) 
# 30 "project/radare2/libr/syscall/syscall.c"
     void r_syscall_free(RSyscall *s) {
 if (s) {
  if (s->refs > 0) {
   s->refs--;
   return;
...
# 45 "project/radare2/libr/syscall/syscall.c" 3 4
__attribute__((visibility("default"))) 
# 45 "project/radare2/libr/syscall/syscall.c"
     SdbGperf *r_syscall_get_gperf(const char *k);
...
static Sdb *openDatabase(Sdb *db, const char *name) {
 ...
 if (sg) {
  ...
  char *file = r_str_newf ("%s" 
# 53 "project/radare2/libr/syscall/syscall.c" 3 4
                          "/" "share" "/" "radare2" "/" "5.5.4" "/" 
# 53 "project/radare2/libr/syscall/syscall.c"
                          "%s.sdb", r_sys_prefix (
# 53 "project/radare2/libr/syscall/syscall.c" 3 4
                                                                                 ((void *)0)
# 53 "project/radare2/libr/syscall/syscall.c"
...
static inline 
# 70 "project/radare2/libr/syscall/syscall.c" 3 4
             _Bool 
# 70 "project/radare2/libr/syscall/syscall.c"
                  syscall_reload_needed(RSyscall *s, const char *os, const char *arch, int bits) {
 if (!s->os || strcmp (s->os, os)) {
  return 
# 72 "project/radare2/libr/syscall/syscall.c" 3 4
        1
# 72 "project/radare2/libr/syscall/syscall.c"
            ;
 }
 if (!s->arch || strcmp (s->arch, arch)) {
  return 
# 75 "project/radare2/libr/syscall/syscall.c" 3 4
        1
# 75 "project/radare2/libr/syscall/syscall.c"
            ;
 }
 return s->bits != bits;
}
...
static inline 
# 80 "project/radare2/libr/syscall/syscall.c" 3 4
             _Bool 
# 80 "project/radare2/libr/syscall/syscall.c"
                  sysregs_reload_needed(RSyscall *s, const char *arch, int bits, const char *cpu) {
 if (!s->arch || strcmp (s->arch, arch)) {
  return 
# 82 "project/radare2/libr/syscall/syscall.c" 3 4
        1
# 82 "project/radare2/libr/syscall/syscall.c"
            ;
 }
 if (s->bits != bits) {
  return 
# 85 "project/radare2/libr/syscall/syscall.c" 3 4
        1
# 85 "project/radare2/libr/syscall/syscall.c"
            ;
 }
...
# 91 "project/radare2/libr/syscall/syscall.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 91 "project/radare2/libr/syscall/syscall.c"
          r_syscall_setup(RSyscall *s, const char *arch, int bits, const char *cpu, const char *os) {
 
# 92 "project/radare2/libr/syscall/syscall.c" 3 4
do { if (!(
# 92 "project/radare2/libr/syscall/syscall.c"
s
# 92 "project/radare2/libr/syscall/syscall.c" 3 4
...
# 93 "project/radare2/libr/syscall/syscall.c" 3 4
_Bool 
# 93 "project/radare2/libr/syscall/syscall.c"
     syscall_changed, sysregs_changed;

 if (!os || !*os) {
  os = 
# 96 "project/radare2/libr/syscall/syscall.c" 3 4
      "darwin"
# 96 "project/radare2/libr/syscall/syscall.c"
              ;
 }
 if (!arch) {
  arch = 
# 99 "project/radare2/libr/syscall/syscall.c" 3 4
        "x86"
# 99 "project/radare2/libr/syscall/syscall.c"
                  ;
 }
 if (!cpu) {
  cpu = arch;
 ...
 if (!strcmp (os, "any")) {
  return 
# 119 "project/radare2/libr/syscall/syscall.c" 3 4
        1
# 119 "project/radare2/libr/syscall/syscall.c"
            ;
 }
 if (!strcmp (arch, "avr")) {
 ...
 if (syscall_changed) {
  char *dbName = r_str_newf ("syscall" 
# 130 "project/radare2/libr/syscall/syscall.c" 3 4
                            "/" 
# 130 "project/radare2/libr/syscall/syscall.c"
                            "%s-%s-%d",
   os, arch, bits);
  if (dbName) {
 ...
 if (sysregs_changed) {
  char *dbName = r_str_newf ("sysregs" 
# 139 "project/radare2/libr/syscall/syscall.c" 3 4
                            "/" 
# 139 "project/radare2/libr/syscall/syscall.c"
                            "%s-%d-%s",
   arch, bits, cpu);
  if (dbName) {
   sdb_free (s->srdb);
   s->srdb = openDatabase (
# 143 "project/radare2/libr/syscall/syscall.c" 3 4
                          ((void *)0)
# 143 "project/radare2/libr/syscall/syscall.c"
                              , dbName);
   free (dbName);
  }
 }
 if (s->fd) {
  fclose (s->fd);
  s->fd = 
# 149 "project/radare2/libr/syscall/syscall.c" 3 4
         ((void *)0)
# 149 "project/radare2/libr/syscall/syscall.c"
             ;
 }
 return 
# 151 "project/radare2/libr/syscall/syscall.c" 3 4
       1
# 151 "project/radare2/libr/syscall/syscall.c"
           ;
}


# 154 "project/radare2/libr/syscall/syscall.c" 3 4
__attribute__((visibility("default"))) 
# 154 "project/radare2/libr/syscall/syscall.c"
     RSyscallItem *r_syscall_item_new_from_string(const char *name, const char *s) {
 RSyscallItem *si;
 char *o;
 if (!name || !s) {
  return 
# 158 "project/radare2/libr/syscall/syscall.c" 3 4
        ((void *)0)
# 158 "project/radare2/libr/syscall/syscall.c"
            ;
 }
 o = strdup (s);
 ...
 if (cols < 3) {
  free (o);
  return 
# 164 "project/radare2/libr/syscall/syscall.c" 3 4
        ((void *)0)
# 164 "project/radare2/libr/syscall/syscall.c"
            ;
 }

 si = 
# 167 "project/radare2/libr/syscall/syscall.c" 3 4
     (
# 167 "project/radare2/libr/syscall/syscall.c"
     RSyscallItem
# 167 "project/radare2/libr/syscall/syscall.c" 3 4
     *)calloc(1,sizeof(
# 167 "project/radare2/libr/syscall/syscall.c"
...
# 167 "project/radare2/libr/syscall/syscall.c"
 ...
 if (!si) {
  free (o);
  return 
# 170 "project/radare2/libr/syscall/syscall.c" 3 4
        ((void *)0)
# 170 "project/radare2/libr/syscall/syscall.c"
            ;
 }
 si->name = strdup (name);
 si->swi = (int)r_num_get (
# 173 "project/radare2/libr/syscall/syscall.c" 3 4
                          ((void *)0)
# 173 "project/radare2/libr/syscall/syscall.c"
                              , r_str_word_get0 (o, 0));
 si->num = (int)r_num_get (
# 174 "project/radare2/libr/syscall/syscall.c" 3 4
                          ((void *)0)
# 174 "project/radare2/libr/syscall/syscall.c"
                              , r_str_word_get0 (o, 1));
 si->args = (int)r_num_get (
# 175 "project/radare2/libr/syscall/syscall.c" 3 4
                           ((void *)0)
# 175 "project/radare2/libr/syscall/syscall.c"
                               , r_str_word_get0 (o, 2));
 ...
 if (!si->sargs) {
  ...
  free (o);
  return 
# 180 "project/radare2/libr/syscall/syscall.c" 3 4
        ((void *)0)
# 180 "project/radare2/libr/syscall/syscall.c"
            ;
 }
 if (cols > 3) {
  
# 183 "project/radare2/libr/syscall/syscall.c" 3 4
 __builtin___strncpy_chk (
# 183 "project/radare2/libr/syscall/syscall.c"
 si->sargs
# 183 "project/radare2/libr/syscall/syscall.c" 3 4
 , 
# 183 "project/radare2/libr/syscall/syscall.c"
 r_str_word_get0 (o, 3), si->args
# 183 "project/radare2/libr/syscall/syscall.c" 3 4
...
# 189 "project/radare2/libr/syscall/syscall.c" 3 4
__attribute__((visibility("default"))) 
# 189 "project/radare2/libr/syscall/syscall.c"
...
# 205 "project/radare2/libr/syscall/syscall.c" 3 4
__attribute__((visibility("default"))) 
# 205 "project/radare2/libr/syscall/syscall.c"
     int r_syscall_get_swi(RSyscall *s) {
 return (int)sdb_num_get (s->db, "_", 
# 206 "project/radare2/libr/syscall/syscall.c" 3 4
                                     ((void *)0)
# 206 "project/radare2/libr/syscall/syscall.c"
                                         );
}


# 209 "project/radare2/libr/syscall/syscall.c" 3 4
__attribute__((visibility("default"))) 
# 209 "project/radare2/libr/syscall/syscall.c"
     RSyscallItem *r_syscall_get(RSyscall *s, int num, int swi) {
 
# 210 "project/radare2/libr/syscall/syscall.c" 3 4
do { if (!(
# 210 "project/radare2/libr/syscall/syscall.c"
s && s->db
# 210 "project/radare2/libr/syscall/syscall.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 210 "project/radare2/libr/syscall/syscall.c"
...
# 214 "project/radare2/libr/syscall/syscall.c" 3 4
 __builtin___snprintf_chk (
# 214 "project/radare2/libr/syscall/syscall.c"
 key
# 214 "project/radare2/libr/syscall/syscall.c" 3 4
 , 
# 214 "project/radare2/libr/syscall/syscall.c"
...
# 216 "project/radare2/libr/syscall/syscall.c" 3 4
 __builtin___snprintf_chk (
# 216 "project/radare2/libr/syscall/syscall.c"
 key
# 216 "project/radare2/libr/syscall/syscall.c" 3 4
 , 
# 216 "project/radare2/libr/syscall/syscall.c"
...
# 220 "project/radare2/libr/syscall/syscall.c" 3 4
 __builtin___snprintf_chk (
# 220 "project/radare2/libr/syscall/syscall.c"
 key
# 220 "project/radare2/libr/syscall/syscall.c" 3 4
 , 
# 220 "project/radare2/libr/syscall/syscall.c"
...
# 223 "project/radare2/libr/syscall/syscall.c" 3 4
  __builtin___snprintf_chk (
# 223 "project/radare2/libr/syscall/syscall.c"
  key
# 223 "project/radare2/libr/syscall/syscall.c" 3 4
  , 
# 223 "project/radare2/libr/syscall/syscall.c"
...
# 223 "project/radare2/libr/syscall/syscall.c"
   ...
   if (!ret) {
    return 
# 226 "project/radare2/libr/syscall/syscall.c" 3 4
          ((void *)0)
# 226 "project/radare2/libr/syscall/syscall.c"
              ;
   }
  }
 }
 ...
 if (!ret2) {
  return 
# 232 "project/radare2/libr/syscall/syscall.c" 3 4
        ((void *)0)
# 232 "project/radare2/libr/syscall/syscall.c"
            ;
 }
...
# 237 "project/radare2/libr/syscall/syscall.c" 3 4
__attribute__((visibility("default"))) 
# 237 "project/radare2/libr/syscall/syscall.c"
     int r_syscall_get_num(RSyscall *s, const char *str) {
 
# 238 "project/radare2/libr/syscall/syscall.c" 3 4
do { if (!(
# 238 "project/radare2/libr/syscall/syscall.c"
s && str && s->db
# 238 "project/radare2/libr/syscall/syscall.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 238 "project/radare2/libr/syscall/syscall.c"
...
# 239 "project/radare2/libr/syscall/syscall.c" 3 4
                                                ((void *)0)
# 239 "project/radare2/libr/syscall/syscall.c"
                                                    );
 if (sn == 0) {
  return (int)sdb_array_get_num (s->db, str, 0, 
# 241 "project/radare2/libr/syscall/syscall.c" 3 4
                                               ((void *)0)
# 241 "project/radare2/libr/syscall/syscall.c"
                                                   );
 }
 return sn;
}
...
# 246 "project/radare2/libr/syscall/syscall.c" 3 4
__attribute__((visibility("default"))) 
# 246 "project/radare2/libr/syscall/syscall.c"
     const char *r_syscall_get_i(RSyscall *s, int num, int swi) {
 
# 247 "project/radare2/libr/syscall/syscall.c" 3 4
do { if (!(
# 247 "project/radare2/libr/syscall/syscall.c"
s && s->db
# 247 "project/radare2/libr/syscall/syscall.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 247 "project/radare2/libr/syscall/syscall.c"
"s && s->db"
# 247 "project/radare2/libr/syscall/syscall.c" 3 4
, 247); return (((void *)0)); } } while (0)
# 247 "project/radare2/libr/syscall/syscall.c"
                                       ;
 char foo[32];
 swi = getswi (s, swi);
 
# 250 "project/radare2/libr/syscall/syscall.c" 3 4
__builtin___snprintf_chk (
# 250 "project/radare2/libr/syscall/syscall.c"
foo
# 250 "project/radare2/libr/syscall/syscall.c" 3 4
, 
# 250 "project/radare2/libr/syscall/syscall.c"
...
static 
# 254 "project/radare2/libr/syscall/syscall.c" 3 4
      _Bool 
# 254 "project/radare2/libr/syscall/syscall.c"
           callback_list(void *u, const char *k, const char *v) {
 RList *list = (RList*)u;
 if (!strchr (k, '.')) {
  RSyscallItem *si = r_syscall_item_new_from_string (k, v);
  if (!si) {
   return 
# 259 "project/radare2/libr/syscall/syscall.c" 3 4
         1
# 259 "project/radare2/libr/syscall/syscall.c"
             ;
  }
  if (!strchr (si->name, '.')) {
 ...
 return 
# 267 "project/radare2/libr/syscall/syscall.c" 3 4
       1
# 267 "project/radare2/libr/syscall/syscall.c"
           ;
}


# 270 "project/radare2/libr/syscall/syscall.c" 3 4
__attribute__((visibility("default"))) 
# 270 "project/radare2/libr/syscall/syscall.c"
     RList *r_syscall_list(RSyscall *s) {
 
# 271 "project/radare2/libr/syscall/syscall.c" 3 4
do { if (!(
# 271 "project/radare2/libr/syscall/syscall.c"
s && s->db
# 271 "project/radare2/libr/syscall/syscall.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 271 "project/radare2/libr/syscall/syscall.c"
...
# 278 "project/radare2/libr/syscall/syscall.c" 3 4
__attribute__((visibility("default"))) 
# 278 "project/radare2/libr/syscall/syscall.c"
     const char *r_syscall_get_io(RSyscall *s, int ioport) {
 
# 279 "project/radare2/libr/syscall/syscall.c" 3 4
do { if (!(
# 279 "project/radare2/libr/syscall/syscall.c"
s
# 279 "project/radare2/libr/syscall/syscall.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 279 "project/radare2/libr/syscall/syscall.c"
...
# 279 "project/radare2/libr/syscall/syscall.c"
 ...
 return 
# 290 "project/radare2/libr/syscall/syscall.c" 3 4
       ((void *)0)
# 290 "project/radare2/libr/syscall/syscall.c"
           ;
}


# 293 "project/radare2/libr/syscall/syscall.c" 3 4
__attribute__((visibility("default"))) 
# 293 "project/radare2/libr/syscall/syscall.c"
     const char* r_syscall_sysreg(RSyscall *s, const char *type, 
# 293 "project/radare2/libr/syscall/syscall.c" 3 4
                                                                 unsigned long long 
# 293 "project/radare2/libr/syscall/syscall.c"
                                                                      num) {
 
# 294 "project/radare2/libr/syscall/syscall.c" 3 4
do { if (!(
# 294 "project/radare2/libr/syscall/syscall.c"
s && s->db
# 294 "project/radare2/libr/syscall/syscall.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 294 "project/radare2/libr/syscall/syscall.c"
"s && s->db"
# 294 "project/radare2/libr/syscall/syscall.c" 3 4
, 294); return (((void *)0)); } } while (0)
# 294 "project/radare2/libr/syscall/syscall.c"
                                       ;
 const char *key = sdb_fmt ("%s,%"
# 295 "project/radare2/libr/syscall/syscall.c" 3 4
                                 "lld"
# 295 "project/radare2/libr/syscall/syscall.c"
                                        , type, num);
