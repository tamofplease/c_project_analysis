# 0 "project/radare2/libr/config/hold.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/config/hold.c"
...
# 4 "project/radare2/libr/config/hold.c" 2



# 6 "project/radare2/libr/config/hold.c"
typedef struct r_config_holder_t {
 
# 7 "project/radare2/libr/config/hold.c" 3 4
unsigned int 
# 7 "project/radare2/libr/config/hold.c"
     flags;
 char *key;
 union {
  
# 10 "project/radare2/libr/config/hold.c" 3 4
 unsigned long long 
# 10 "project/radare2/libr/config/hold.c"
      num;
  char *str;
 } data;
} RConfigHolder;
...
static void r_config_holder_free(RConfigHolder *hc) {
 if (hc) {
  free (hc->key);
  if (hc->flags & 
# 18 "project/radare2/libr/config/hold.c" 3 4
                 0x000008
# 18 "project/radare2/libr/config/hold.c"
                       ) {
   free (hc->data.str);
  }
  free (hc);
...
static RConfigHolder *node_to_holder(RConfigNode *node) {
 RConfigHolder *hc = 
# 26 "project/radare2/libr/config/hold.c" 3 4
                    (
# 26 "project/radare2/libr/config/hold.c"
                    RConfigHolder
# 26 "project/radare2/libr/config/hold.c" 3 4
                    *)calloc(1,sizeof(
# 26 "project/radare2/libr/config/hold.c"
...
# 26 "project/radare2/libr/config/hold.c"
 ...
 if (hc) {
  ...
  hc->flags = node->flags;
  if (node->flags & 
# 30 "project/radare2/libr/config/hold.c" 3 4
                   0x000008
# 30 "project/radare2/libr/config/hold.c"
                         ) {
...
# 39 "project/radare2/libr/config/hold.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 39 "project/radare2/libr/config/hold.c"
          r_config_hold(RConfigHold *h, ...) {
 
# 40 "project/radare2/libr/config/hold.c" 3 4
do { if (!(
# 40 "project/radare2/libr/config/hold.c"
h
# 40 "project/radare2/libr/config/hold.c" 3 4
...
# 43 "project/radare2/libr/config/hold.c" 3 4
__builtin_va_start(
# 43 "project/radare2/libr/config/hold.c"
ap
# 43 "project/radare2/libr/config/hold.c" 3 4
,
# 43 "project/radare2/libr/config/hold.c"
...
# 43 "project/radare2/libr/config/hold.c"
                ;
 while ((key = 
# 44 "project/radare2/libr/config/hold.c" 3 4
              __builtin_va_arg(
# 44 "project/radare2/libr/config/hold.c"
              ap
# 44 "project/radare2/libr/config/hold.c" 3 4
              ,
# 44 "project/radare2/libr/config/hold.c"
...
# 46 "project/radare2/libr/config/hold.c" 3 4
 do { if (!(
# 46 "project/radare2/libr/config/hold.c"
 node
# 46 "project/radare2/libr/config/hold.c" 3 4
 )) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 46 "project/radare2/libr/config/hold.c"
...
# 49 "project/radare2/libr/config/hold.c" 3 4
__builtin_va_end(
# 49 "project/radare2/libr/config/hold.c"
ap
# 49 "project/radare2/libr/config/hold.c" 3 4
)
# 49 "project/radare2/libr/config/hold.c"
           ;
 return 
# 50 "project/radare2/libr/config/hold.c" 3 4
       1
# 50 "project/radare2/libr/config/hold.c"
           ;
}


# 53 "project/radare2/libr/config/hold.c" 3 4
__attribute__((visibility("default"))) 
# 53 "project/radare2/libr/config/hold.c"
     RConfigHold* r_config_hold_new(RConfig *cfg) {
 
# 54 "project/radare2/libr/config/hold.c" 3 4
do { if (!(
# 54 "project/radare2/libr/config/hold.c"
cfg
# 54 "project/radare2/libr/config/hold.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 54 "project/radare2/libr/config/hold.c"
"cfg"
# 54 "project/radare2/libr/config/hold.c" 3 4
, 54); return (((void *)0)); } } while (0)
# 54 "project/radare2/libr/config/hold.c"
                                ;
 RConfigHold *hold = 
# 55 "project/radare2/libr/config/hold.c" 3 4
                    (
# 55 "project/radare2/libr/config/hold.c"
                    RConfigHold
# 55 "project/radare2/libr/config/hold.c" 3 4
                    *)calloc(1,sizeof(
# 55 "project/radare2/libr/config/hold.c"
...
# 55 "project/radare2/libr/config/hold.c"
 ...
 return 
# 61 "project/radare2/libr/config/hold.c" 3 4
       ((void *)0)
# 61 "project/radare2/libr/config/hold.c"
           ;
}


# 64 "project/radare2/libr/config/hold.c" 3 4
__attribute__((visibility("default"))) 
# 64 "project/radare2/libr/config/hold.c"
     void r_config_hold_restore(RConfigHold *h) {
 
# 65 "project/radare2/libr/config/hold.c" 3 4
do { if (!(
# 65 "project/radare2/libr/config/hold.c"
h
# 65 "project/radare2/libr/config/hold.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 65 "project/radare2/libr/config/hold.c"
...
# 69 "project/radare2/libr/config/hold.c" 3 4
if (
# 69 "project/radare2/libr/config/hold.c"
h->list
# 69 "project/radare2/libr/config/hold.c" 3 4
) for (
# 69 "project/radare2/libr/config/hold.c"
...
# 69 "project/radare2/libr/config/hold.c"
                                   {
  if (hc->flags & 
# 70 "project/radare2/libr/config/hold.c" 3 4
                 0x000008
# 70 "project/radare2/libr/config/hold.c"
                       ) {
...
# 78 "project/radare2/libr/config/hold.c" 3 4
__attribute__((visibility("default"))) 
# 78 "project/radare2/libr/config/hold.c"
