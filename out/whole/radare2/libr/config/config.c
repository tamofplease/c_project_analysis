# 0 "project/radare2/libr/config/config.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/config/config.c"
...
# 4 "project/radare2/libr/config/config.c" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/config/config.c"
     RConfigNode* r_config_node_new(const char *name, const char *value) {
 
# 6 "project/radare2/libr/config/config.c" 3 4
do { if (!(
# 6 "project/radare2/libr/config/config.c"
name && *name && value
# 6 "project/radare2/libr/config/config.c" 3 4
...
"name && *name && value"
# 6 "project/radare2/libr/config/config.c" 3 4
, 6); return (((void *)0)); } } while (0)
# 6 "project/radare2/libr/config/config.c"
                                                   ;
 RConfigNode *node = 
# 7 "project/radare2/libr/config/config.c" 3 4
                    (
# 7 "project/radare2/libr/config/config.c"
                    RConfigNode
# 7 "project/radare2/libr/config/config.c" 3 4
                    *)calloc(1,sizeof(
# 7 "project/radare2/libr/config/config.c"
...
# 7 "project/radare2/libr/config/config.c"
 ...
 if (!node) {
  return 
# 9 "project/radare2/libr/config/config.c" 3 4
        ((void *)0)
# 9 "project/radare2/libr/config/config.c"
            ;
 }
 node->name = strdup (name);
 node->value = strdup (r_str_get (value));
 node->flags = 
# 13 "project/radare2/libr/config/config.c" 3 4
              0x000020 
# 13 "project/radare2/libr/config/config.c"
                    | 
# 13 "project/radare2/libr/config/config.c" 3 4
                      0x000008
# 13 "project/radare2/libr/config/config.c"
                            ;
 node->i_value = r_num_get (
# 14 "project/radare2/libr/config/config.c" 3 4
                           ((void *)0)
# 14 "project/radare2/libr/config/config.c"
                               , value);
 node->options = 
# 15 "project/radare2/libr/config/config.c" 3 4
                ((void *)0)
# 15 "project/radare2/libr/config/config.c"
                    ;
 return node;
}


# 19 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 19 "project/radare2/libr/config/config.c"
     char *r_config_node_to_string(RConfigNode *node) {
 return (node && node->name)? strdup (node->name): 
# 20 "project/radare2/libr/config/config.c" 3 4
                                                  ((void *)0)
# 20 "project/radare2/libr/config/config.c"
                                                      ;
}


# 23 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 23 "project/radare2/libr/config/config.c"
...
# 31 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 31 "project/radare2/libr/config/config.c"
...
# 38 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 38 "project/radare2/libr/config/config.c"
     RConfigNode* r_config_node_clone(RConfigNode *n) {
 
# 39 "project/radare2/libr/config/config.c" 3 4
do { if (!(
# 39 "project/radare2/libr/config/config.c"
n
# 39 "project/radare2/libr/config/config.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 39 "project/radare2/libr/config/config.c"
...
# 39 "project/radare2/libr/config/config.c"
                              ;
 RConfigNode *cn = 
# 40 "project/radare2/libr/config/config.c" 3 4
                  (
# 40 "project/radare2/libr/config/config.c"
                  RConfigNode
# 40 "project/radare2/libr/config/config.c" 3 4
                  *)calloc(1,sizeof(
# 40 "project/radare2/libr/config/config.c"
...
# 40 "project/radare2/libr/config/config.c"
 ...
 if (!cn) {
  return 
# 42 "project/radare2/libr/config/config.c" 3 4
        ((void *)0)
# 42 "project/radare2/libr/config/config.c"
            ;
 }
 cn->name = strdup (n->name);
 cn->desc = n->desc ? strdup (n->desc) : 
# 45 "project/radare2/libr/config/config.c" 3 4
                                        ((void *)0)
# 45 "project/radare2/libr/config/config.c"
                                            ;
 cn->value = strdup (r_str_get (n->value));
 cn->i_value = n->i_value;
 cn->flags = n->flags;
 cn->setter = n->setter;
 cn->options = n->options? r_list_clone (n->options): 
# 50 "project/radare2/libr/config/config.c" 3 4
                                                     ((void *)0)
# 50 "project/radare2/libr/config/config.c"
                                                         ;
 return cn;
}


# 54 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 54 "project/radare2/libr/config/config.c"
...
# 67 "project/radare2/libr/config/config.c" 3 4
do { if (!(
# 67 "project/radare2/libr/config/config.c"
cfg && node
# 67 "project/radare2/libr/config/config.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 67 "project/radare2/libr/config/config.c"
...
# 75 "project/radare2/libr/config/config.c" 3 4
  unsigned long long 
# 75 "project/radare2/libr/config/config.c"
       n = r_num_get (
# 75 "project/radare2/libr/config/config.c" 3 4
                      ((void *)0)
# 75 "project/radare2/libr/config/config.c"
                          , val);
   cfg->cb_printf ("%"
# 76 "project/radare2/libr/config/config.c" 3 4
                     "lld"
# 76 "project/radare2/libr/config/config.c"
                            , n);
  } else if (r_str_isnumber (val) || (*val && r_str_is_bool (val))) {
   cfg->cb_printf ("%s", val);
  } else {
...
static void config_print_node(RConfig *cfg, RConfigNode *node, const char *pfx, const char *sfx, 
# 88 "project/radare2/libr/config/config.c" 3 4
                                                                                                _Bool 
# 88 "project/radare2/libr/config/config.c"
                                                                                                     verbose, 
# 88 "project/radare2/libr/config/config.c" 3 4
                                                                                                              _Bool 
# 88 "project/radare2/libr/config/config.c"
...
# 89 "project/radare2/libr/config/config.c" 3 4
do { if (!(
# 89 "project/radare2/libr/config/config.c"
cfg && node && pfx && sfx
# 89 "project/radare2/libr/config/config.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 89 "project/radare2/libr/config/config.c"
...
# 91 "project/radare2/libr/config/config.c" 3 4
_Bool 
# 91 "project/radare2/libr/config/config.c"
     isFirst;
 RListIter *iter;
 char *es = 
# 93 "project/radare2/libr/config/config.c" 3 4
           ((void *)0)
# 93 "project/radare2/libr/config/config.c"
               ;
 ...
 if (json) {
  if (verbose) {
   ...
   if (node->options && !
# 108 "project/radare2/libr/config/config.c" 3 4
                        (!(
# 108 "project/radare2/libr/config/config.c"
                        node->options
# 108 "project/radare2/libr/config/config.c" 3 4
                        ) || !(
# 108 "project/radare2/libr/config/config.c"
...
# 108 "project/radare2/libr/config/config.c"
    ...
    isFirst = 
# 109 "project/radare2/libr/config/config.c" 3 4
             1
# 109 "project/radare2/libr/config/config.c"
                 ;
    cfg->cb_printf (",\"options\":[");
    
# 111 "project/radare2/libr/config/config.c" 3 4
   if (
# 111 "project/radare2/libr/config/config.c"
   node->options
# 111 "project/radare2/libr/config/config.c" 3 4
   ) for (
# 111 "project/radare2/libr/config/config.c"
...
# 111 "project/radare2/libr/config/config.c"
     ...
     if (es) {
      if (isFirst) {
       isFirst = 
# 115 "project/radare2/libr/config/config.c" 3 4
                0
# 115 "project/radare2/libr/config/config.c"
                     ;
      } else {
       cfg->cb_printf (",");
      }
  ...
  if (verbose) {
   cfg->cb_printf ("%s%s = %s%s %s; %s", pfx,
    ...
    node->desc);
   if (node->options && !
# 136 "project/radare2/libr/config/config.c" 3 4
                        (!(
# 136 "project/radare2/libr/config/config.c"
                        node->options
# 136 "project/radare2/libr/config/config.c" 3 4
                        ) || !(
# 136 "project/radare2/libr/config/config.c"
...
# 136 "project/radare2/libr/config/config.c"
    ...
    isFirst = 
# 137 "project/radare2/libr/config/config.c" 3 4
             1
# 137 "project/radare2/libr/config/config.c"
                 ;
    cfg->cb_printf(" [");
    
# 139 "project/radare2/libr/config/config.c" 3 4
   if (
# 139 "project/radare2/libr/config/config.c"
   node->options
# 139 "project/radare2/libr/config/config.c" 3 4
   ) for (
# 139 "project/radare2/libr/config/config.c"
...
# 139 "project/radare2/libr/config/config.c"
     ...
     if (isFirst) {
      isFirst = 
# 141 "project/radare2/libr/config/config.c" 3 4
               0
# 141 "project/radare2/libr/config/config.c"
                    ;
     } else {
      cfg->cb_printf (", ");
     }
...
# 157 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 157 "project/radare2/libr/config/config.c"
     void r_config_list(RConfig *cfg, const char *str, int rad) {
 
# 158 "project/radare2/libr/config/config.c" 3 4
do { if (!(
# 158 "project/radare2/libr/config/config.c"
cfg
# 158 "project/radare2/libr/config/config.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 158 "project/radare2/libr/config/config.c"
...
# 164 "project/radare2/libr/config/config.c" 3 4
_Bool 
# 164 "project/radare2/libr/config/config.c"
     verbose = 
# 164 "project/radare2/libr/config/config.c" 3 4
               0
# 164 "project/radare2/libr/config/config.c"
...
# 165 "project/radare2/libr/config/config.c" 3 4
_Bool 
# 165 "project/radare2/libr/config/config.c"
     json = 
# 165 "project/radare2/libr/config/config.c" 3 4
            0
# 165 "project/radare2/libr/config/config.c"
...
# 166 "project/radare2/libr/config/config.c" 3 4
_Bool 
# 166 "project/radare2/libr/config/config.c"
     isFirst = 
# 166 "project/radare2/libr/config/config.c" 3 4
               0
# 166 "project/radare2/libr/config/config.c"
 ...
 if (!
# 168 "project/radare2/libr/config/config.c" 3 4
     (!(
# 168 "project/radare2/libr/config/config.c"
     str
# 168 "project/radare2/libr/config/config.c" 3 4
     ) || !*(
# 168 "project/radare2/libr/config/config.c"
...
# 168 "project/radare2/libr/config/config.c"
  ...
  if (len > 0 && str[0] == 'j') {
   ...
   len--;
   json = 
# 174 "project/radare2/libr/config/config.c" 3 4
         1
# 174 "project/radare2/libr/config/config.c"
             ;
   rad = 'J';
  }
  if (len > 0 && str[0] == ' ') {
  ...
  if (strlen (str) == 0) {
   str = 
# 182 "project/radare2/libr/config/config.c" 3 4
        ((void *)0)
# 182 "project/radare2/libr/config/config.c"
            ;
   len = 0;
  }
 }
...
# 193 "project/radare2/libr/config/config.c" 3 4
 if (
# 193 "project/radare2/libr/config/config.c"
 cfg->nodes
# 193 "project/radare2/libr/config/config.c" 3 4
 ) for (
# 193 "project/radare2/libr/config/config.c"
...
# 200 "project/radare2/libr/config/config.c" 3 4
 if (
# 200 "project/radare2/libr/config/config.c"
 cfg->nodes
# 200 "project/radare2/libr/config/config.c" 3 4
 ) for (
# 200 "project/radare2/libr/config/config.c"
...
# 211 "project/radare2/libr/config/config.c" 3 4
  if (
# 211 "project/radare2/libr/config/config.c"
  cfg->nodes
# 211 "project/radare2/libr/config/config.c" 3 4
  ) for (
# 211 "project/radare2/libr/config/config.c"
...
# 211 "project/radare2/libr/config/config.c"
   ...
   char *oldSpace = 
# 223 "project/radare2/libr/config/config.c" 3 4
                   ((void *)0)
# 223 "project/radare2/libr/config/config.c"
                       ;
   
# 224 "project/radare2/libr/config/config.c" 3 4
  if (
# 224 "project/radare2/libr/config/config.c"
  cfg->nodes
# 224 "project/radare2/libr/config/config.c" 3 4
  ) for (
# 224 "project/radare2/libr/config/config.c"
...
# 224 "project/radare2/libr/config/config.c"
 ...
 case 'v':
  verbose = 
# 246 "project/radare2/libr/config/config.c" 3 4
           1
# 246 "project/radare2/libr/config/config.c"
               ;
  
# 247 "project/radare2/libr/config/config.c" 3 4
 if (
# 247 "project/radare2/libr/config/config.c"
 cfg->nodes
# 247 "project/radare2/libr/config/config.c" 3 4
 ) for (
# 247 "project/radare2/libr/config/config.c"
...
# 254 "project/radare2/libr/config/config.c" 3 4
 if (
# 254 "project/radare2/libr/config/config.c"
 cfg->nodes
# 254 "project/radare2/libr/config/config.c" 3 4
 ) for (
# 254 "project/radare2/libr/config/config.c"
...
# 254 "project/radare2/libr/config/config.c"
 ...
 case 'J':
  verbose = 
# 261 "project/radare2/libr/config/config.c" 3 4
           1
# 261 "project/radare2/libr/config/config.c"
               ;

 case 'j':
  isFirst = 
# 264 "project/radare2/libr/config/config.c" 3 4
           1
# 264 "project/radare2/libr/config/config.c"
               ;
  if (verbose) {
   cfg->cb_printf ("[");
  } else {
...
# 270 "project/radare2/libr/config/config.c" 3 4
 if (
# 270 "project/radare2/libr/config/config.c"
 cfg->nodes
# 270 "project/radare2/libr/config/config.c" 3 4
 ) for (
# 270 "project/radare2/libr/config/config.c"
...
# 270 "project/radare2/libr/config/config.c"
   ...
   if (!str || (str && (!strncmp (str, node->name, len)))) {
    if (!str || !strncmp (str, node->name, len)) {
     if (isFirst) {
      isFirst = 
# 274 "project/radare2/libr/config/config.c" 3 4
               0
# 274 "project/radare2/libr/config/config.c"
                    ;
     } else {
      cfg->cb_printf (",");
     }
     config_print_node (cfg, node, pfx, sfx, verbose, 
# 278 "project/radare2/libr/config/config.c" 3 4
                                                     1
# 278 "project/radare2/libr/config/config.c"
                                                         );
    }
   }
  }
...
# 291 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 291 "project/radare2/libr/config/config.c"
     RConfigNode* r_config_node_get(RConfig *cfg, const char *name) {
 
# 292 "project/radare2/libr/config/config.c" 3 4
do { if (!(
# 292 "project/radare2/libr/config/config.c"
cfg && name
# 292 "project/radare2/libr/config/config.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 292 "project/radare2/libr/config/config.c"
"cfg && name"
# 292 "project/radare2/libr/config/config.c" 3 4
, 292); return (((void *)0)); } } while (0)
# 292 "project/radare2/libr/config/config.c"
                                        ;
 return ht_pp_find (cfg->ht, name, 
# 293 "project/radare2/libr/config/config.c" 3 4
                                  ((void *)0)
# 293 "project/radare2/libr/config/config.c"
                                      );
}


# 296 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 296 "project/radare2/libr/config/config.c"
     const char* r_config_get(RConfig *cfg, const char *name) {
 
# 297 "project/radare2/libr/config/config.c" 3 4
do { if (!(
# 297 "project/radare2/libr/config/config.c"
cfg && name
# 297 "project/radare2/libr/config/config.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 297 "project/radare2/libr/config/config.c"
...
# 308 "project/radare2/libr/config/config.c" 3 4
 fprintf(__stderrp,
# 308 "project/radare2/libr/config/config.c"
 "r_config_get: variable '%s' not found\n", name
# 308 "project/radare2/libr/config/config.c" 3 4
 )
# 308 "project/radare2/libr/config/config.c"
                                                          ;
 ...
 return 
# 310 "project/radare2/libr/config/config.c" 3 4
       ((void *)0)
# 310 "project/radare2/libr/config/config.c"
           ;
}


# 313 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 313 "project/radare2/libr/config/config.c"
          r_config_toggle(RConfig *cfg, const char *name) {
 RConfigNode *node = r_config_node_get (cfg, name);
 if (!node) {
  return 
# 316 "project/radare2/libr/config/config.c" 3 4
        0
# 316 "project/radare2/libr/config/config.c"
             ;
 }
 if (!r_config_node_is_bool (node)) {
  
# 319 "project/radare2/libr/config/config.c" 3 4
 fprintf(__stderrp,
# 319 "project/radare2/libr/config/config.c"
 "(error: '%s' is not a boolean variable)\n", name
# 319 "project/radare2/libr/config/config.c" 3 4
 )
# 319 "project/radare2/libr/config/config.c"
                                                            ;
  return 
# 320 "project/radare2/libr/config/config.c" 3 4
        0
# 320 "project/radare2/libr/config/config.c"
             ;
 }
 if (r_config_node_is_ro (node)) {
  
# 323 "project/radare2/libr/config/config.c" 3 4
 fprintf(__stderrp,
# 323 "project/radare2/libr/config/config.c"
...
# 323 "project/radare2/libr/config/config.c"
                                                          ;
  return 
# 324 "project/radare2/libr/config/config.c" 3 4
        0
# 324 "project/radare2/libr/config/config.c"
             ;
 }
 (void)r_config_set_b (cfg, name, !node->i_value);
 return 
# 327 "project/radare2/libr/config/config.c" 3 4
       1
# 327 "project/radare2/libr/config/config.c"
           ;
}


# 330 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 330 "project/radare2/libr/config/config.c"
          r_config_get_b(RConfig *cfg, const char *name) {
 return r_config_get_i (cfg, name) != 0;
}


# 334 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 334 "project/radare2/libr/config/config.c"
          r_config_get_i(RConfig *cfg, const char *name) {
 
# 335 "project/radare2/libr/config/config.c" 3 4
do { if (!(
# 335 "project/radare2/libr/config/config.c"
cfg
# 335 "project/radare2/libr/config/config.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 335 "project/radare2/libr/config/config.c"
...
# 335 "project/radare2/libr/config/config.c"
 ...
 if (node) {
  ...
  return (
# 350 "project/radare2/libr/config/config.c" 3 4
         unsigned long long
# 350 "project/radare2/libr/config/config.c"
             ) r_num_math (cfg->num, node->value);
 }
 return 0ULL;
}


# 355 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 355 "project/radare2/libr/config/config.c"
     const char* r_config_node_type(RConfigNode *node) {
 
# 356 "project/radare2/libr/config/config.c" 3 4
do { if (!(
# 356 "project/radare2/libr/config/config.c"
node
# 356 "project/radare2/libr/config/config.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 356 "project/radare2/libr/config/config.c"
...
# 373 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 373 "project/radare2/libr/config/config.c"
...
# 381 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 381 "project/radare2/libr/config/config.c"
 ...
 if (node && (node->setter = cb)) {
  if (!node->setter (cfg->user, node)) {
   return 
# 385 "project/radare2/libr/config/config.c" 3 4
         ((void *)0)
# 385 "project/radare2/libr/config/config.c"
             ;
  }
 }
 return node;
...
static inline 
# 391 "project/radare2/libr/config/config.c" 3 4
             _Bool 
# 391 "project/radare2/libr/config/config.c"
                  is_true_or_false(const char *s) {
 return s && (!r_str_casecmp (s, "true") || !r_str_casecmp (s, "false"));
}



# 396 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 396 "project/radare2/libr/config/config.c"
     RConfigNode* r_config_set(RConfig *cfg, const char *name, const char *value) {
 RConfigNode *node = 
# 397 "project/radare2/libr/config/config.c" 3 4
                    ((void *)0)
# 397 "project/radare2/libr/config/config.c"
                        ;
 char *ov = 
# 398 "project/radare2/libr/config/config.c" 3 4
           ((void *)0)
# 398 "project/radare2/libr/config/config.c"
               ;
 
# 399 "project/radare2/libr/config/config.c" 3 4
unsigned long long 
# 399 "project/radare2/libr/config/config.c"
     oi;

 
# 401 "project/radare2/libr/config/config.c" 3 4
do { if (!(
# 401 "project/radare2/libr/config/config.c"
cfg && cfg->ht
# 401 "project/radare2/libr/config/config.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 401 "project/radare2/libr/config/config.c"
"cfg && cfg->ht"
# 401 "project/radare2/libr/config/config.c" 3 4
, 401); return (((void *)0)); } } while (0)
# 401 "project/radare2/libr/config/config.c"
                                           ;
 
# 402 "project/radare2/libr/config/config.c" 3 4
do { if (!(
# 402 "project/radare2/libr/config/config.c"
!
# 402 "project/radare2/libr/config/config.c" 3 4
(!(
# 402 "project/radare2/libr/config/config.c"
...
# 407 "project/radare2/libr/config/config.c" 3 4
  fprintf(__stderrp,
# 407 "project/radare2/libr/config/config.c"
  "(error: '%s' config key is read only)\n", name
# 407 "project/radare2/libr/config/config.c" 3 4
  )
# 407 "project/radare2/libr/config/config.c"
...
# 420 "project/radare2/libr/config/config.c" 3 4
  _Bool 
# 420 "project/radare2/libr/config/config.c"
       b = r_str_is_true (value);
   node->i_value = b;
   ...
   if (!value) {
    ...
    if (
# 438 "project/radare2/libr/config/config.c" 3 4
       ((
# 438 "project/radare2/libr/config/config.c"
       *value
# 438 "project/radare2/libr/config/config.c" 3 4
       ) >= '0' && (
# 438 "project/radare2/libr/config/config.c"
...
# 438 "project/radare2/libr/config/config.c"
    ...
    node->flags |= 
# 447 "project/radare2/libr/config/config.c" 3 4
                  0x000002
# 447 "project/radare2/libr/config/config.c"
                        ;
   }
  }
 } else {
  oi = 
# 451 "project/radare2/libr/config/config.c" 3 4
      0xFFFFFFFFFFFFFFFFULL
# 451 "project/radare2/libr/config/config.c"
              ;
  if (!cfg->lock) {
   ...
   if (node) {
    if (is_true_or_false (value)) {
     node->flags |= 
# 456 "project/radare2/libr/config/config.c" 3 4
                   0x000001
# 456 "project/radare2/libr/config/config.c"
                          ;
...
# 462 "project/radare2/libr/config/config.c" 3 4
   fprintf(__stderrp,
# 462 "project/radare2/libr/config/config.c"
   "r_config_set: unable to create a new RConfigNode\n"
# 462 "project/radare2/libr/config/config.c" 3 4
   )
# 462 "project/radare2/libr/config/config.c"
                                                                 ;
...
# 465 "project/radare2/libr/config/config.c" 3 4
  fprintf(__stderrp,
# 465 "project/radare2/libr/config/config.c"
  "r_config_set: variable '%s' not found\n", name
# 465 "project/radare2/libr/config/config.c" 3 4
  )
# 465 "project/radare2/libr/config/config.c"
                                                           ;
 ...
 if (node && node->setter) {
  if (!node->setter (cfg->user, node)) {
   if (oi != 
# 471 "project/radare2/libr/config/config.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 471 "project/radare2/libr/config/config.c"
                    ) {
    node->i_value = oi;
   }
   free (node->value);
   ...
   return 
# 479 "project/radare2/libr/config/config.c" 3 4
         ((void *)0)
# 479 "project/radare2/libr/config/config.c"
             ;
  }
 }
beach:
...
# 490 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 490 "project/radare2/libr/config/config.c"
     RConfigNode * r_config_desc(RConfig *cfg, const char *name, const char *desc) {
 RConfigNode *node = r_config_node_get (cfg, name);
 return r_config_node_desc (node, desc);
}


# 495 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 495 "project/radare2/libr/config/config.c"
     RConfigNode* r_config_node_desc(RConfigNode *node, const char *desc) {
 
# 496 "project/radare2/libr/config/config.c" 3 4
do { if (!(
# 496 "project/radare2/libr/config/config.c"
node
# 496 "project/radare2/libr/config/config.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 496 "project/radare2/libr/config/config.c"
...
# 504 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 504 "project/radare2/libr/config/config.c"
          r_config_rm(RConfig *cfg, const char *name) {
 RConfigNode *node = r_config_node_get (cfg, name);
 if (node) {
  ht_pp_delete (cfg->ht, node->name);
  r_list_delete_data (cfg->nodes, node);
  return 
# 509 "project/radare2/libr/config/config.c" 3 4
        1
# 509 "project/radare2/libr/config/config.c"
            ;
 }
 return 
# 511 "project/radare2/libr/config/config.c" 3 4
       0
# 511 "project/radare2/libr/config/config.c"
            ;
}


# 514 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 514 "project/radare2/libr/config/config.c"
     void r_config_node_value_format_i(char *buf, size_t buf_size, const 
# 514 "project/radare2/libr/config/config.c" 3 4
                                                                         unsigned long long 
# 514 "project/radare2/libr/config/config.c"
                                                                              i, RConfigNode *node) {
...
# 520 "project/radare2/libr/config/config.c" 3 4
 __builtin___snprintf_chk (
# 520 "project/radare2/libr/config/config.c"
 buf
# 520 "project/radare2/libr/config/config.c" 3 4
 , 
# 520 "project/radare2/libr/config/config.c"
...
# 522 "project/radare2/libr/config/config.c" 3 4
 __builtin___snprintf_chk (
# 522 "project/radare2/libr/config/config.c"
 buf
# 522 "project/radare2/libr/config/config.c" 3 4
 , 
# 522 "project/radare2/libr/config/config.c"
...
# 526 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 526 "project/radare2/libr/config/config.c"
     RConfigNode* r_config_set_b(RConfig *cfg, const char *name, 
# 526 "project/radare2/libr/config/config.c" 3 4
                                                                 _Bool 
# 526 "project/radare2/libr/config/config.c"
                                                                      b) {
 ...
 return 
# 531 "project/radare2/libr/config/config.c" 3 4
       ((void *)0)
# 531 "project/radare2/libr/config/config.c"
           ;
}


# 534 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 534 "project/radare2/libr/config/config.c"
     RConfigNode* r_config_set_i(RConfig *cfg, const char *name, const 
# 534 "project/radare2/libr/config/config.c" 3 4
                                                                       unsigned long long 
# 534 "project/radare2/libr/config/config.c"
                                                                            i) {
 char buf[128], *ov = 
# 535 "project/radare2/libr/config/config.c" 3 4
                     ((void *)0)
# 535 "project/radare2/libr/config/config.c"
                         ;
 
# 536 "project/radare2/libr/config/config.c" 3 4
do { if (!(
# 536 "project/radare2/libr/config/config.c"
cfg && name
# 536 "project/radare2/libr/config/config.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 536 "project/radare2/libr/config/config.c"
...
# 536 "project/radare2/libr/config/config.c"
 ...
 if (node) {
  if (r_config_node_is_ro (node)) {
   node = 
# 540 "project/radare2/libr/config/config.c" 3 4
         ((void *)0)
# 540 "project/radare2/libr/config/config.c"
             ;
   goto beach;
  }
  ov = node->value;
  r_config_node_value_format_i (buf, sizeof (buf), i, 
# 544 "project/radare2/libr/config/config.c" 3 4
                                                     ((void *)0)
# 544 "project/radare2/libr/config/config.c"
                                                         );
  node->value = strdup (buf);
  if (!node->value) {
   node = 
# 547 "project/radare2/libr/config/config.c" 3 4
         ((void *)0)
# 547 "project/radare2/libr/config/config.c"
             ;
   goto beach;
  }
  node->i_value = i;
  ...
  if (!cfg->lock) {
   r_config_node_value_format_i (buf, sizeof (buf), i, 
# 553 "project/radare2/libr/config/config.c" 3 4
                                                      ((void *)0)
# 553 "project/radare2/libr/config/config.c"
                                                          );
   node = r_config_node_new (name, buf);
   if (!node) {
    node = 
# 556 "project/radare2/libr/config/config.c" 3 4
          ((void *)0)
# 556 "project/radare2/libr/config/config.c"
              ;
    goto beach;
   }
   node->flags = 
# 559 "project/radare2/libr/config/config.c" 3 4
                0x000020 
# 559 "project/radare2/libr/config/config.c"
                      | 
# 559 "project/radare2/libr/config/config.c" 3 4
                        0x000002
# 559 "project/radare2/libr/config/config.c"
...
# 566 "project/radare2/libr/config/config.c" 3 4
  fprintf(__stderrp,
# 566 "project/radare2/libr/config/config.c"
  "(locked: no new keys can be created (%s))\n", name
# 566 "project/radare2/libr/config/config.c" 3 4
  )
# 566 "project/radare2/libr/config/config.c"
                                                               ;
...
# 571 "project/radare2/libr/config/config.c" 3 4
 unsigned long long 
# 571 "project/radare2/libr/config/config.c"
      oi = node->i_value;
  ...
  if (!ret) {
   ...
   ov = 
# 577 "project/radare2/libr/config/config.c" 3 4
       ((void *)0)
# 577 "project/radare2/libr/config/config.c"
           ;
  }
 }
beach:
...
# 605 "project/radare2/libr/config/config.c" 3 4
   fprintf(__stderrp,
# 605 "project/radare2/libr/config/config.c"
...
# 611 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 611 "project/radare2/libr/config/config.c"
          r_config_eval(RConfig *cfg, const char *str, 
# 611 "project/radare2/libr/config/config.c" 3 4
                                                       _Bool 
# 611 "project/radare2/libr/config/config.c"
                                                            many) {
 
# 612 "project/radare2/libr/config/config.c" 3 4
do { if (!(
# 612 "project/radare2/libr/config/config.c"
cfg && str
# 612 "project/radare2/libr/config/config.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 612 "project/radare2/libr/config/config.c"
...
# 612 "project/radare2/libr/config/config.c"
 ...
 if (!*s || !strcmp (s, "help")) {
  r_config_list (cfg, 
# 617 "project/radare2/libr/config/config.c" 3 4
                     ((void *)0)
# 617 "project/radare2/libr/config/config.c"
                         , 0);
  free (s);
  return 
# 619 "project/radare2/libr/config/config.c" 3 4
        0
# 619 "project/radare2/libr/config/config.c"
             ;
 }
 ...
 if (*s == '-') {
  ...
  free (s);
  return 
# 625 "project/radare2/libr/config/config.c" 3 4
        0
# 625 "project/radare2/libr/config/config.c"
             ;
 }
 if (many) {
...
# 633 "project/radare2/libr/config/config.c" 3 4
 if (
# 633 "project/radare2/libr/config/config.c"
 list
# 633 "project/radare2/libr/config/config.c" 3 4
 ) for (
# 633 "project/radare2/libr/config/config.c"
...
# 633 "project/radare2/libr/config/config.c"
  ...
  free (s);
  return 
# 637 "project/radare2/libr/config/config.c" 3 4
        1
# 637 "project/radare2/libr/config/config.c"
            ;
 }
 __evalString (cfg, s);
 free (s);
 return 
# 641 "project/radare2/libr/config/config.c" 3 4
       1
# 641 "project/radare2/libr/config/config.c"
           ;
}
...
# 648 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 648 "project/radare2/libr/config/config.c"
     void r_config_lock(RConfig *cfg, 
# 648 "project/radare2/libr/config/config.c" 3 4
                                      _Bool 
# 648 "project/radare2/libr/config/config.c"
                                           lock) {
...
# 653 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 653 "project/radare2/libr/config/config.c"
          r_config_readonly(RConfig *cfg, const char *key) {
 RConfigNode *n = r_config_node_get (cfg, key);
 if (n) {
  n->flags |= 
# 656 "project/radare2/libr/config/config.c" 3 4
             0x000010
# 656 "project/radare2/libr/config/config.c"
                  ;
  return 
# 657 "project/radare2/libr/config/config.c" 3 4
        1
# 657 "project/radare2/libr/config/config.c"
            ;
 }
 return 
# 659 "project/radare2/libr/config/config.c" 3 4
       0
# 659 "project/radare2/libr/config/config.c"
            ;
}


# 662 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 662 "project/radare2/libr/config/config.c"
     RConfig* r_config_new(void *user) {
 RConfig *cfg = 
# 663 "project/radare2/libr/config/config.c" 3 4
               (
# 663 "project/radare2/libr/config/config.c"
               RConfig
# 663 "project/radare2/libr/config/config.c" 3 4
               *)calloc(1,sizeof(
# 663 "project/radare2/libr/config/config.c"
...
# 663 "project/radare2/libr/config/config.c"
 ...
 if (!cfg) {
  return 
# 665 "project/radare2/libr/config/config.c" 3 4
        ((void *)0)
# 665 "project/radare2/libr/config/config.c"
            ;
 }
 cfg->ht = ht_pp_new0 ();
...
# 670 "project/radare2/libr/config/config.c" 3 4
 { free((void *)
# 670 "project/radare2/libr/config/config.c"
 cfg
# 670 "project/radare2/libr/config/config.c" 3 4
 ); 
# 670 "project/radare2/libr/config/config.c"
...
# 670 "project/radare2/libr/config/config.c"
             ;
  return 
# 671 "project/radare2/libr/config/config.c" 3 4
        ((void *)0)
# 671 "project/radare2/libr/config/config.c"
            ;
 }
 cfg->user = user;
 cfg->num = 
# 674 "project/radare2/libr/config/config.c" 3 4
           ((void *)0)
# 674 "project/radare2/libr/config/config.c"
               ;
 cfg->lock = 
# 675 "project/radare2/libr/config/config.c" 3 4
            0
# 675 "project/radare2/libr/config/config.c"
                 ;
...
# 680 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 680 "project/radare2/libr/config/config.c"
 ...
 if (!c) {
  return 
# 685 "project/radare2/libr/config/config.c" 3 4
        ((void *)0)
# 685 "project/radare2/libr/config/config.c"
            ;
 }
 
# 687 "project/radare2/libr/config/config.c" 3 4
if (
# 687 "project/radare2/libr/config/config.c"
cfg->nodes
# 687 "project/radare2/libr/config/config.c" 3 4
) for (
# 687 "project/radare2/libr/config/config.c"
...
# 697 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 697 "project/radare2/libr/config/config.c"
...
# 706 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 706 "project/radare2/libr/config/config.c"
     void r_config_visual_hit_i(RConfig *cfg, const char *name, int delta) {
 RConfigNode *node = r_config_node_get (cfg, name);
...
# 713 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 713 "project/radare2/libr/config/config.c"
...
# 721 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) 
# 721 "project/radare2/libr/config/config.c"
     void r_config_serialize( RConfig *config, Sdb *db) {
 RListIter *iter;
 RConfigNode *node;
 
# 724 "project/radare2/libr/config/config.c" 3 4
if (
# 724 "project/radare2/libr/config/config.c"
config->nodes
# 724 "project/radare2/libr/config/config.c" 3 4
) for (
# 724 "project/radare2/libr/config/config.c"
...
static 
# 729 "project/radare2/libr/config/config.c" 3 4
      _Bool 
# 729 "project/radare2/libr/config/config.c"
           load_config_cb(void *user, const char *k, const char *v) {
 RConfig *config = user;
 ...
 return 
# 735 "project/radare2/libr/config/config.c" 3 4
       1
# 735 "project/radare2/libr/config/config.c"
           ;
}


# 738 "project/radare2/libr/config/config.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 738 "project/radare2/libr/config/config.c"
          r_config_unserialize( RConfig *config, Sdb *db, char **err) {
 sdb_foreach (db, load_config_cb, config);
 return 
# 740 "project/radare2/libr/config/config.c" 3 4
       1
# 740 "project/radare2/libr/config/config.c"
           ;
}
