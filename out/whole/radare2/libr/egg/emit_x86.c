# 0 "project/radare2/libr/egg/emit_x86.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/egg/emit_x86.c"
...
# 4 "project/radare2/libr/egg/emit_x86.c" 2



#define attsyntax 0
# 21 "project/radare2/libr/egg/emit_x86.c"
...
# 30 "project/radare2/libr/egg/emit_x86.c"
...
if (0) {
 r_egg_printf (egg, "mov %%" "esp" ", %%" "ebp" "\n");
} else {
 r_egg_printf (egg, "mov " "ebp" ", " "esp" "\n");
}
}
...
static char *emit_syscall (REgg *egg, int nargs) {
 char p[512];
 if (0) {
  return strdup (": mov $`.arg`, %" "eax" "\n: " "int $0x80" "\n");
 }
 switch (egg->os) {
 case 
# 50 "project/radare2/libr/egg/emit_x86.c" 3 4
     0x5ca62a43
# 50 "project/radare2/libr/egg/emit_x86.c"
                   :
  
# 51 "project/radare2/libr/egg/emit_x86.c" 3 4
 __builtin___strcpy_chk (
# 51 "project/radare2/libr/egg/emit_x86.c"
 p
# 51 "project/radare2/libr/egg/emit_x86.c" 3 4
 , 
# 51 "project/radare2/libr/egg/emit_x86.c"
...
# 51 "project/radare2/libr/egg/emit_x86.c"
  ...
  break;
 case 
# 53 "project/radare2/libr/egg/emit_x86.c" 3 4
     0x0ad593a1
# 53 "project/radare2/libr/egg/emit_x86.c"
                 :
 case 
# 54 "project/radare2/libr/egg/emit_x86.c" 3 4
     0x5cb23c16
# 54 "project/radare2/libr/egg/emit_x86.c"
                   :
 case 
# 55 "project/radare2/libr/egg/emit_x86.c" 3 4
     0xd86d1ae2
# 55 "project/radare2/libr/egg/emit_x86.c"
                    :
...
# 61 "project/radare2/libr/egg/emit_x86.c" 3 4
 __builtin___snprintf_chk (
# 61 "project/radare2/libr/egg/emit_x86.c"
 p
# 61 "project/radare2/libr/egg/emit_x86.c" 3 4
 , 
# 61 "project/radare2/libr/egg/emit_x86.c"
...
# 66 "project/radare2/libr/egg/emit_x86.c"
    ;

  break;
 default:
  return 
# 70 "project/radare2/libr/egg/emit_x86.c" 3 4
        ((void *)0)
# 70 "project/radare2/libr/egg/emit_x86.c"
            ;
 }
 return strdup (p);
}
...
static void emit_frame_end (REgg *egg, int sz, int ctx) {
 if (sz>0) {
  if (0) {
   r_egg_printf (egg, "  add $%d, %%""esp""\n", sz);
   r_egg_printf (egg, "  pop %%""ebp""\n");
  } else {
   r_egg_printf (egg, "  add ""esp"", %d\n", sz);
   r_egg_printf (egg, "  pop ""ebp""\n");
  }
 }
 if (ctx > 0) {
...
# 111 "project/radare2/libr/egg/emit_x86.c" 3 4
__builtin_va_start(
# 111 "project/radare2/libr/egg/emit_x86.c"
ap
# 111 "project/radare2/libr/egg/emit_x86.c" 3 4
,
# 111 "project/radare2/libr/egg/emit_x86.c"
...
# 112 "project/radare2/libr/egg/emit_x86.c" 3 4
__builtin___vsnprintf_chk (
# 112 "project/radare2/libr/egg/emit_x86.c"
buf
# 112 "project/radare2/libr/egg/emit_x86.c" 3 4
, 
# 112 "project/radare2/libr/egg/emit_x86.c"
...
# 118 "project/radare2/libr/egg/emit_x86.c" 3 4
__builtin_va_end(
# 118 "project/radare2/libr/egg/emit_x86.c"
ap
# 118 "project/radare2/libr/egg/emit_x86.c" 3 4
)
# 118 "project/radare2/libr/egg/emit_x86.c"
...
static const char *getreg(int i) {
 if (i < 0 || i >= (sizeof (regs)/sizeof (char *))) {
  return 
# 127 "project/radare2/libr/egg/emit_x86.c" 3 4
        ((void *)0)
# 127 "project/radare2/libr/egg/emit_x86.c"
            ;
 }
 return regs[i];
}
...
# 138 "project/radare2/libr/egg/emit_x86.c" 3 4
  fprintf(__stderrp,
# 138 "project/radare2/libr/egg/emit_x86.c"
  "Cannot find gpr %d\n", j + 1
# 138 "project/radare2/libr/egg/emit_x86.c" 3 4
  )
# 138 "project/radare2/libr/egg/emit_x86.c"
  ...
  if (0) {
   r_egg_printf (egg, "  mov %d(%%""esp""), %%%s\n", k, reg);
  } else {
   if (k > 0) {
    r_egg_printf (egg, "  mov %s, [""esp""+%d]\n", reg, k);
   } else if (k < 0) {
    r_egg_printf (egg, "  mov %s, [""esp""%d]\n", reg, k);
   } else {
    r_egg_printf (egg, "  mov %s, [""esp""]\n", reg);
   }
  }
 }
}
...
# 164 "project/radare2/libr/egg/emit_x86.c" 3 4
__builtin___memcpy_chk (
# 164 "project/radare2/libr/egg/emit_x86.c"
s
# 164 "project/radare2/libr/egg/emit_x86.c" 3 4
, 
# 164 "project/radare2/libr/egg/emit_x86.c"
...
# 165 "project/radare2/libr/egg/emit_x86.c" 3 4
__builtin___memset_chk (
# 165 "project/radare2/libr/egg/emit_x86.c"
s + len
# 165 "project/radare2/libr/egg/emit_x86.c" 3 4
, 
# 165 "project/radare2/libr/egg/emit_x86.c"
...
# 173 "project/radare2/libr/egg/emit_x86.c" 3 4
 unsigned int 
# 173 "project/radare2/libr/egg/emit_x86.c"
      *n = (
# 173 "project/radare2/libr/egg/emit_x86.c" 3 4
            unsigned int 
# 173 "project/radare2/libr/egg/emit_x86.c"
                 *)(s+i-4);
  p = r_egg_mkvar (egg, str2, dstvar, i+(4 -4));
  if (0) {
   r_egg_printf (egg, "  movl $0x%x, %s\n", (unsigned int)((*n) & 0xffffffff), p);
  } else {
   r_egg_printf (egg, "  mov dword %s, 0x%x\n", p, (unsigned int)((*n) & 0xffffffff));
  }
  free (p);
  j -= 4;
 }
#undef M32
 ...
 p = r_egg_mkvar (egg, str2, dstvar, j+4+(4 -4));
 if (0) {
  r_egg_printf (egg, "  lea %s, %%" "eax" "\n", p);
 } else {
  r_egg_printf (egg, "  lea " "eax" ", %s\n", p);
 }
 free (p);

 p = r_egg_mkvar (egg, str2, dstvar, 0);
 if (0) {
  r_egg_printf (egg, "  mov %%" "eax" ", %s\n", p);
 } else {
  r_egg_printf (egg, "  mov %s, " "eax" "\n", p);
 }
 free (p);

#undef BPOFF
# 230 "project/radare2/libr/egg/emit_x86.c"
 free (s);
}
...
# 257 "project/radare2/libr/egg/emit_x86.c" 3 4
 fprintf(__stderrp,
# 257 "project/radare2/libr/egg/emit_x86.c"
...
static void emit_arg (REgg *egg, int xs, int num, const char *str) {
 ...
 switch (xs) {
 case 0:
# 281 "project/radare2/libr/egg/emit_x86.c"
 ...
 case '&':
  if (0) {
   if (d != 0) {
    r_egg_printf (egg, "  addl $%d, %%" "ebp" "\n", d);
   }
   r_egg_printf (egg, "  pushl %%""ebp""\n");
   if (d != 0) {
    r_egg_printf (egg, "  subl $%d, %%" "ebp" "\n", d);
   }
  } else {
   if (d != 0) {
    r_egg_printf (egg, "  add " "ebp" ", %d\n", d);
   }
   r_egg_printf (egg, "  push ""ebp""\n");
   if (d != 0) {
    r_egg_printf (egg, "  sub " "ebp" ", %d\n", d);
   }
  }
  break;
 }
...
static void emit_restore_stack (REgg *egg, int size) {
 if (0) {
  r_egg_printf (egg, "  add $%d, %%" "esp" " /* args */\n", size);
 } else {
  r_egg_printf (egg, "  add " "esp" ", %d\n", size);
 }
}
...
# 330 "project/radare2/libr/egg/emit_x86.c" 3 4
__builtin___sprintf_chk (
# 330 "project/radare2/libr/egg/emit_x86.c"
str
# 330 "project/radare2/libr/egg/emit_x86.c" 3 4
, 0, __builtin_object_size (
# 330 "project/radare2/libr/egg/emit_x86.c"
...
static void emit_while_end (REgg *egg, const char *labelback) {
  ...
  r_egg_printf (egg, "  pop ""eax""\n");
  r_egg_printf (egg, "  test ""eax"", ""eax""\n");
...
# 352 "project/radare2/libr/egg/emit_x86.c" 3 4
  __builtin___sprintf_chk (
# 352 "project/radare2/libr/egg/emit_x86.c"
  out
# 352 "project/radare2/libr/egg/emit_x86.c" 3 4
  , 0, __builtin_object_size (
# 352 "project/radare2/libr/egg/emit_x86.c"
...
# 354 "project/radare2/libr/egg/emit_x86.c" 3 4
  __builtin___sprintf_chk (
# 354 "project/radare2/libr/egg/emit_x86.c"
  out
# 354 "project/radare2/libr/egg/emit_x86.c" 3 4
  , 0, __builtin_object_size (
# 354 "project/radare2/libr/egg/emit_x86.c"
...
# 356 "project/radare2/libr/egg/emit_x86.c" 3 4
  __builtin___strcpy_chk (
# 356 "project/radare2/libr/egg/emit_x86.c"
  out
# 356 "project/radare2/libr/egg/emit_x86.c" 3 4
  , 
# 356 "project/radare2/libr/egg/emit_x86.c"
...
# 361 "project/radare2/libr/egg/emit_x86.c" 3 4
 fprintf(__stderrp,
# 361 "project/radare2/libr/egg/emit_x86.c"
...
# 364 "project/radare2/libr/egg/emit_x86.c" 3 4
  __builtin___sprintf_chk (
# 364 "project/radare2/libr/egg/emit_x86.c"
  out
# 364 "project/radare2/libr/egg/emit_x86.c" 3 4
  , 0, __builtin_object_size (
# 364 "project/radare2/libr/egg/emit_x86.c"
...
# 366 "project/radare2/libr/egg/emit_x86.c" 3 4
  __builtin___sprintf_chk (
# 366 "project/radare2/libr/egg/emit_x86.c"
  out
# 366 "project/radare2/libr/egg/emit_x86.c" 3 4
  , 0, __builtin_object_size (
# 366 "project/radare2/libr/egg/emit_x86.c"
...
# 368 "project/radare2/libr/egg/emit_x86.c" 3 4
  __builtin___strcpy_chk (
# 368 "project/radare2/libr/egg/emit_x86.c"
  out
# 368 "project/radare2/libr/egg/emit_x86.c" 3 4
  , 
# 368 "project/radare2/libr/egg/emit_x86.c"
...
# 373 "project/radare2/libr/egg/emit_x86.c" 3 4
  __builtin___sprintf_chk (
# 373 "project/radare2/libr/egg/emit_x86.c"
  out
# 373 "project/radare2/libr/egg/emit_x86.c" 3 4
  , 0, __builtin_object_size (
# 373 "project/radare2/libr/egg/emit_x86.c"
...
# 375 "project/radare2/libr/egg/emit_x86.c" 3 4
  __builtin___sprintf_chk (
# 375 "project/radare2/libr/egg/emit_x86.c"
  out
# 375 "project/radare2/libr/egg/emit_x86.c" 3 4
  , 0, __builtin_object_size (
# 375 "project/radare2/libr/egg/emit_x86.c"
...
# 377 "project/radare2/libr/egg/emit_x86.c" 3 4
  __builtin___strcpy_chk (
# 377 "project/radare2/libr/egg/emit_x86.c"
  out
# 377 "project/radare2/libr/egg/emit_x86.c" 3 4
  , 
# 377 "project/radare2/libr/egg/emit_x86.c"
...
static void emit_load_ptr(REgg *egg, const char *dst) {
 ...
 if (0) {
  r_egg_printf (egg, "  leal %d(%%""ebp""), %%""eax""\n", d);
 } else {
  r_egg_printf (egg, "  lea ""eax"", [""ebp""+%d]\n", d);
 }
...
static void emit_branch(REgg *egg, char *b, char *g, char *e, char *n, int sz, const char *dst) {
 char *p, str[64];
 char *arg = 
# 409 "project/radare2/libr/egg/emit_x86.c" 3 4
            ((void *)0)
# 409 "project/radare2/libr/egg/emit_x86.c"
                ;
 char *op = "jz";
 int signed_value = 1;
 ...
 if (0) {
  r_egg_printf (egg, "  pop %%""eax""\n");
  r_egg_printf (egg, "  cmp%c %s, %%""eax""\n", sz, p);
 } else {
  r_egg_printf (egg, "  pop ""eax""\n");
  r_egg_printf (egg, "  cmp ""eax"", %s\n", p);
 }
...
static void emit_load(REgg *egg, const char *dst, int sz) {
 if (0) {
  switch (sz) {
  case 'l':
   r_egg_printf (egg, "  movl %s, %%""eax""\n", dst);
   r_egg_printf (egg, "  movl (%%""eax""), %%""eax""\n");
   break;
  case 'b':
   r_egg_printf (egg, "  movl %s, %%""eax""\n", dst);
   r_egg_printf (egg, "  movzb (%%""eax""), %%""eax""\n");
   break;
  default:

   r_egg_printf (egg, "  mov%c %s, %%""eax""\n", sz, dst);
   r_egg_printf (egg, "  mov%c (%%""eax""), %%""eax""\n", sz);
  }
 } else {
  switch (sz) {
  case 'l':
   r_egg_printf (egg, "  mov ""eax"", %s\n", dst);
   r_egg_printf (egg, "  mov ""eax"", [""eax""]\n");
   break;
  case 'b':
   r_egg_printf (egg, "  mov ""eax"", %s\n", dst);
   r_egg_printf (egg, "  movz ""eax"", [""eax""]\n");
   break;
  default:
...
static const char* emit_regs(REgg *egg, int idx) {
 return regs[idx%(sizeof (regs)/sizeof (char *))];
}

static void emit_get_ar (REgg *egg, char *out, int idx) {
 const char *reg = emit_regs (egg, 0 + idx);

 if (reg) {
  
# 544 "project/radare2/libr/egg/emit_x86.c" 3 4
 __builtin___strcpy_chk (
# 544 "project/radare2/libr/egg/emit_x86.c"
 out
# 544 "project/radare2/libr/egg/emit_x86.c" 3 4
 , 
# 544 "project/radare2/libr/egg/emit_x86.c"
