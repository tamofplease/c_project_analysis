# 0 "project/radare2/libr/egg/p/egg_xor.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 5 "project/radare2/libr/egg/p/egg_xor.c" 2

#define DEFAULT_XOR_KEY "0xFF"


# 8 "project/radare2/libr/egg/p/egg_xor.c"
static RBuffer *build (REgg *egg) {
 RBuffer *buf, *sc;
 
# 10 "project/radare2/libr/egg/p/egg_xor.c" 3 4
unsigned char 
# 10 "project/radare2/libr/egg/p/egg_xor.c"
    aux[32], nkey;
 const char *default_key = "0xFF";
...
# 18 "project/radare2/libr/egg/p/egg_xor.c" 3 4
 fprintf(__stderrp,
# 18 "project/radare2/libr/egg/p/egg_xor.c"
...
# 18 "project/radare2/libr/egg/p/egg_xor.c"
 ...
 nkey = r_num_math (
# 20 "project/radare2/libr/egg/p/egg_xor.c" 3 4
                   ((void *)0)
# 20 "project/radare2/libr/egg/p/egg_xor.c"
                       , key);
 if (nkey == 0) {
  
# 22 "project/radare2/libr/egg/p/egg_xor.c" 3 4
 fprintf(__stderrp,
# 22 "project/radare2/libr/egg/p/egg_xor.c"
 "Invalid key (%s)\n", key
# 22 "project/radare2/libr/egg/p/egg_xor.c" 3 4
 )
# 22 "project/radare2/libr/egg/p/egg_xor.c"
  ...
  free (key);
  return 
# 24 "project/radare2/libr/egg/p/egg_xor.c" 3 4
        0
# 24 "project/radare2/libr/egg/p/egg_xor.c"
             ;
 }
 if (nkey != (nkey & 0xff)) {
  nkey &= 0xff;
  
# 28 "project/radare2/libr/egg/p/egg_xor.c" 3 4
 fprintf(__stderrp,
# 28 "project/radare2/libr/egg/p/egg_xor.c"
 "xor key wrapped to (%d)\n", nkey
# 28 "project/radare2/libr/egg/p/egg_xor.c" 3 4
 )
# 28 "project/radare2/libr/egg/p/egg_xor.c"
                                            ;
...
# 31 "project/radare2/libr/egg/p/egg_xor.c" 3 4
 fprintf(__stderrp,
# 31 "project/radare2/libr/egg/p/egg_xor.c"
 "shellcode is too long :(\n"
# 31 "project/radare2/libr/egg/p/egg_xor.c" 3 4
 )
# 31 "project/radare2/libr/egg/p/egg_xor.c"
                                       ;
  free (key);
  return 
# 33 "project/radare2/libr/egg/p/egg_xor.c" 3 4
        ((void *)0)
# 33 "project/radare2/libr/egg/p/egg_xor.c"
            ;
 }
 sc = egg->bin;
 if (!r_buf_size (sc)) {
  
# 37 "project/radare2/libr/egg/p/egg_xor.c" 3 4
 fprintf(__stderrp,
# 37 "project/radare2/libr/egg/p/egg_xor.c"
 "No shellcode found!\n"
# 37 "project/radare2/libr/egg/p/egg_xor.c" 3 4
 )
# 37 "project/radare2/libr/egg/p/egg_xor.c"
  ...
  free (key);
  return 
# 39 "project/radare2/libr/egg/p/egg_xor.c" 3 4
        ((void *)0)
# 39 "project/radare2/libr/egg/p/egg_xor.c"
            ;
 }
...
# 45 "project/radare2/libr/egg/p/egg_xor.c" 3 4
  fprintf(__stderrp,
# 45 "project/radare2/libr/egg/p/egg_xor.c"
  "This xor key generates null bytes. Try again.\n"
# 45 "project/radare2/libr/egg/p/egg_xor.c" 3 4
  )
# 45 "project/radare2/libr/egg/p/egg_xor.c"
                                                             ;
   free (key);
   return 
# 47 "project/radare2/libr/egg/p/egg_xor.c" 3 4
         ((void *)0)
# 47 "project/radare2/libr/egg/p/egg_xor.c"
             ;
  }
 }
 buf = r_buf_new ();
...
# 58 "project/radare2/libr/egg/p/egg_xor.c" 3 4
 unsigned char 
# 58 "project/radare2/libr/egg/p/egg_xor.c"
     stub[18] =
   "\xe8\xff\xff\xff\xff"
   "\xc1"
   "\x5e"
  ...
  r_buf_append_bytes (buf, stub, 18);

  for (i = 0; i<r_buf_size (sc); i++) {
   
# 80 "project/radare2/libr/egg/p/egg_xor.c" 3 4
  unsigned char 
# 80 "project/radare2/libr/egg/p/egg_xor.c"
      v = r_buf_read8_at (sc, i) ^ nkey;
...
REggPlugin r_egg_plugin_xor = {
 .name = "xor",
 .type = 
# 93 "project/radare2/libr/egg/p/egg_xor.c" 3 4
        1
# 93 "project/radare2/libr/egg/p/egg_xor.c"
                            ,
