# 0 "project/radare2/libr/egg/emit_trace.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/egg/emit_trace.c"
...
# 4 "project/radare2/libr/egg/emit_trace.c" 2
#define attsyntax 0
...
# 17 "project/radare2/libr/egg/emit_trace.c"
static char *regs[] = { "a0", "a1", "a2", "a3", "a4" };
...
# 25 "project/radare2/libr/egg/emit_trace.c" 3 4
__builtin___snprintf_chk (
# 25 "project/radare2/libr/egg/emit_trace.c"
buf
# 25 "project/radare2/libr/egg/emit_trace.c" 3 4
, 
# 25 "project/radare2/libr/egg/emit_trace.c"
...
# 40 "project/radare2/libr/egg/emit_trace.c" 3 4
__builtin_va_start(
# 40 "project/radare2/libr/egg/emit_trace.c"
ap
# 40 "project/radare2/libr/egg/emit_trace.c" 3 4
,
# 40 "project/radare2/libr/egg/emit_trace.c"
...
# 41 "project/radare2/libr/egg/emit_trace.c" 3 4
__builtin___vsnprintf_chk (
# 41 "project/radare2/libr/egg/emit_trace.c"
buf
# 41 "project/radare2/libr/egg/emit_trace.c" 3 4
, 
# 41 "project/radare2/libr/egg/emit_trace.c"
...
# 43 "project/radare2/libr/egg/emit_trace.c" 3 4
__builtin_va_end(
# 43 "project/radare2/libr/egg/emit_trace.c"
ap
# 43 "project/radare2/libr/egg/emit_trace.c" 3 4
)
# 43 "project/radare2/libr/egg/emit_trace.c"
...
static void emit_get_var (REgg *egg, int type, char *out, int idx) {
 switch (type) {
 case 0: 
# 100 "project/radare2/libr/egg/emit_trace.c" 3 4
        __builtin___sprintf_chk (
# 100 "project/radare2/libr/egg/emit_trace.c"
        out
# 100 "project/radare2/libr/egg/emit_trace.c" 3 4
        , 0, __builtin_object_size (
# 100 "project/radare2/libr/egg/emit_trace.c"
...
# 100 "project/radare2/libr/egg/emit_trace.c"
                                     ; break;
 case 1: 
# 101 "project/radare2/libr/egg/emit_trace.c" 3 4
        __builtin___sprintf_chk (
# 101 "project/radare2/libr/egg/emit_trace.c"
        out
# 101 "project/radare2/libr/egg/emit_trace.c" 3 4
        , 0, __builtin_object_size (
# 101 "project/radare2/libr/egg/emit_trace.c"
...
static void emit_branch(REgg *egg, char *b, char *g, char *e, char *n, int sz, const char *dst) {
 ...
 char *p, str[64];
 char *arg = 
# 117 "project/radare2/libr/egg/emit_trace.c" 3 4
            ((void *)0)
# 117 "project/radare2/libr/egg/emit_trace.c"
                ;
 char *op = "beq";
