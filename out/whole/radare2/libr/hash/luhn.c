# 0 "project/radare2/libr/hash/luhn.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/hash/luhn.c"
...
# 4 "project/radare2/libr/hash/luhn.c" 2

__attribute__((visibility("default"))) unsigned long long 
# 5 "project/radare2/libr/hash/luhn.c"
          r_hash_luhn(const 
# 5 "project/radare2/libr/hash/luhn.c" 3 4
                            unsigned char 
# 5 "project/radare2/libr/hash/luhn.c"
                                *buf, 
# 5 "project/radare2/libr/hash/luhn.c" 3 4
...
# 7 "project/radare2/libr/hash/luhn.c" 3 4
unsigned long long 
# 7 "project/radare2/libr/hash/luhn.c"
     i, sum = 0;
 char curChar[2] = {0, 0};
 for (i = len; i > 0; i--) {
  curChar[0] = buf[i - 1];
