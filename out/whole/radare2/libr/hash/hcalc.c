# 0 "project/radare2/libr/hash/hcalc.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/hash/hcalc.c"
...
# 4 "project/radare2/libr/hash/hcalc.c" 2

#define HANDLE_CRC_PRESET(rbits,aname) do { if (algobit & R_HASH_ ##aname) { ut ##rbits res = r_hash_crc_preset (buf, len, CRC_PRESET_ ##aname); r_write_be ##rbits (ctx->digest, res); return R_HASH_SIZE_ ##aname; } } while(0)
# 15 "project/radare2/libr/hash/hcalc.c"
__attribute__((visibility("default"))) 
# 15 "project/radare2/libr/hash/hcalc.c"
     int r_hash_calculate(
# 15 "project/radare2/libr/hash/hcalc.c" 3 4
                          struct r_hash_t 
# 15 "project/radare2/libr/hash/hcalc.c"
                                *ctx, 
# 15 "project/radare2/libr/hash/hcalc.c" 3 4
...
# 15 "project/radare2/libr/hash/hcalc.c"
 ...
 if (algobit & 
# 19 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_SSDEEP)
# 19 "project/radare2/libr/hash/hcalc.c"
                           ) {
  r_hash_do_ssdeep (ctx, buf, len);
  return 
# 21 "project/radare2/libr/hash/hcalc.c" 3 4
        128
# 21 "project/radare2/libr/hash/hcalc.c"
                          ;
 }
 if (algobit & 
# 23 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_MD4)
# 23 "project/radare2/libr/hash/hcalc.c"
                        ) {
  r_hash_do_md4 (ctx, buf, len);
  return 
# 25 "project/radare2/libr/hash/hcalc.c" 3 4
        16
# 25 "project/radare2/libr/hash/hcalc.c"
                       ;
 }
 if (algobit & 
# 27 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_MD5)
# 27 "project/radare2/libr/hash/hcalc.c"
                        ) {
  r_hash_do_md5 (ctx, buf, len);
  return 
# 29 "project/radare2/libr/hash/hcalc.c" 3 4
        16
# 29 "project/radare2/libr/hash/hcalc.c"
                       ;
 }
 if (algobit & 
# 31 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_SHA1)
# 31 "project/radare2/libr/hash/hcalc.c"
                         ) {
  r_hash_do_sha1 (ctx, buf, len);
  return 
# 33 "project/radare2/libr/hash/hcalc.c" 3 4
        20
# 33 "project/radare2/libr/hash/hcalc.c"
                        ;
 }
 if (algobit & 
# 35 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_SHA256)
# 35 "project/radare2/libr/hash/hcalc.c"
                           ) {
  r_hash_do_sha256 (ctx, buf, len);
  return 
# 37 "project/radare2/libr/hash/hcalc.c" 3 4
        32
# 37 "project/radare2/libr/hash/hcalc.c"
                          ;
 }
 if (algobit & 
# 39 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_SHA384)
# 39 "project/radare2/libr/hash/hcalc.c"
                           ) {
  r_hash_do_sha384 (ctx, buf, len);
  return 
# 41 "project/radare2/libr/hash/hcalc.c" 3 4
        48
# 41 "project/radare2/libr/hash/hcalc.c"
                          ;
 }
 if (algobit & 
# 43 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_SHA512)
# 43 "project/radare2/libr/hash/hcalc.c"
                           ) {
  r_hash_do_sha512 (ctx, buf, len);
  return 
# 45 "project/radare2/libr/hash/hcalc.c" 3 4
        64
# 45 "project/radare2/libr/hash/hcalc.c"
                          ;
 }
 if (algobit & 
# 47 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_XXHASH)
# 47 "project/radare2/libr/hash/hcalc.c"
                           ) {
  
# 48 "project/radare2/libr/hash/hcalc.c" 3 4
 unsigned int 
# 48 "project/radare2/libr/hash/hcalc.c"
      res = r_hash_xxhash (buf, len);
  r_write_le32 (ctx->digest, res);
  return 
# 50 "project/radare2/libr/hash/hcalc.c" 3 4
        4
# 50 "project/radare2/libr/hash/hcalc.c"
                          ;
 }
 if (algobit & 
# 52 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_FLETCHER8)
# 52 "project/radare2/libr/hash/hcalc.c"
                              ) {
  
# 53 "project/radare2/libr/hash/hcalc.c" 3 4
 unsigned char 
# 53 "project/radare2/libr/hash/hcalc.c"
     res = r_hash_fletcher8 (buf, len);
  r_write_le8 (ctx->digest, res);
  return 
# 55 "project/radare2/libr/hash/hcalc.c" 3 4
        1
# 55 "project/radare2/libr/hash/hcalc.c"
                             ;
 }
 if (algobit & 
# 57 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_FLETCHER16)
# 57 "project/radare2/libr/hash/hcalc.c"
                               ) {
  
# 58 "project/radare2/libr/hash/hcalc.c" 3 4
 unsigned short 
# 58 "project/radare2/libr/hash/hcalc.c"
      res = r_hash_fletcher16 (buf, len);
  r_write_le16 (ctx->digest, res);
  return 
# 60 "project/radare2/libr/hash/hcalc.c" 3 4
        2
# 60 "project/radare2/libr/hash/hcalc.c"
                              ;
 }
 if (algobit & 
# 62 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_FLETCHER32)
# 62 "project/radare2/libr/hash/hcalc.c"
                               ) {
  
# 63 "project/radare2/libr/hash/hcalc.c" 3 4
 unsigned int 
# 63 "project/radare2/libr/hash/hcalc.c"
      res = r_hash_fletcher32 (buf, len);
  r_write_le32 (ctx->digest, res);
  return 
# 65 "project/radare2/libr/hash/hcalc.c" 3 4
        4
# 65 "project/radare2/libr/hash/hcalc.c"
                              ;
 }
 if (algobit & 
# 67 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_FLETCHER64)
# 67 "project/radare2/libr/hash/hcalc.c"
                               ) {
  
# 68 "project/radare2/libr/hash/hcalc.c" 3 4
 unsigned long long 
# 68 "project/radare2/libr/hash/hcalc.c"
      res = r_hash_fletcher64 (buf, len);
  r_write_le64 (ctx->digest, res);
  return 
# 70 "project/radare2/libr/hash/hcalc.c" 3 4
        8
# 70 "project/radare2/libr/hash/hcalc.c"
                              ;
 }
 if (algobit & 
# 72 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_ADLER32)
# 72 "project/radare2/libr/hash/hcalc.c"
                            ) {
  
# 73 "project/radare2/libr/hash/hcalc.c" 3 4
 unsigned int 
# 73 "project/radare2/libr/hash/hcalc.c"
      res = r_hash_adler32 (buf, len);
  r_write_le32 (ctx->digest, res);
  return 
# 75 "project/radare2/libr/hash/hcalc.c" 3 4
        4
# 75 "project/radare2/libr/hash/hcalc.c"
                           ;
 }
 if (algobit & 
# 77 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_HAMDIST)
# 77 "project/radare2/libr/hash/hcalc.c"
                            ) {
  *ctx->digest = r_hash_hamdist (buf, len);
  return 
# 79 "project/radare2/libr/hash/hcalc.c" 3 4
        1
# 79 "project/radare2/libr/hash/hcalc.c"
                           ;
 }
 if (algobit & 
# 81 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_PCPRINT)
# 81 "project/radare2/libr/hash/hcalc.c"
                            ) {
  *ctx->digest = r_hash_pcprint (buf, len);
  return 
# 83 "project/radare2/libr/hash/hcalc.c" 3 4
        1
# 83 "project/radare2/libr/hash/hcalc.c"
                           ;
 }
 if (algobit & 
# 85 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_PARITY)
# 85 "project/radare2/libr/hash/hcalc.c"
                           ) {
  *ctx->digest = r_hash_parity (buf, len);
  return 
# 87 "project/radare2/libr/hash/hcalc.c" 3 4
        1
# 87 "project/radare2/libr/hash/hcalc.c"
                          ;
 }
 if (algobit & 
# 89 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_ENTROPY)
# 89 "project/radare2/libr/hash/hcalc.c"
                            ) {
  r_mem_memzero (ctx->digest, sizeof (ctx->entropy));
  ctx->entropy = r_hash_entropy (buf, len);
  return 
# 92 "project/radare2/libr/hash/hcalc.c" 3 4
        0
# 92 "project/radare2/libr/hash/hcalc.c"
                           ;
 }
 if (algobit & 
# 94 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_XOR)
# 94 "project/radare2/libr/hash/hcalc.c"
                        ) {
  *ctx->digest = r_hash_xor (buf, len);
  return 
# 96 "project/radare2/libr/hash/hcalc.c" 3 4
        1
# 96 "project/radare2/libr/hash/hcalc.c"
                       ;
 }
 if (algobit & 
# 98 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_XORPAIR)
# 98 "project/radare2/libr/hash/hcalc.c"
                            ) {
  
# 99 "project/radare2/libr/hash/hcalc.c" 3 4
 unsigned short 
# 99 "project/radare2/libr/hash/hcalc.c"
      res = r_hash_xorpair (buf, len);
  r_write_le16 (ctx->digest, res);
  return 
# 101 "project/radare2/libr/hash/hcalc.c" 3 4
        2
# 101 "project/radare2/libr/hash/hcalc.c"
                           ;
 }
 if (algobit & 
# 103 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_MOD255)
# 103 "project/radare2/libr/hash/hcalc.c"
                           ) {
  *ctx->digest = r_hash_mod255 (buf, len);
  return 
# 105 "project/radare2/libr/hash/hcalc.c" 3 4
        1
# 105 "project/radare2/libr/hash/hcalc.c"
                          ;
 }
 if (algobit & 
# 107 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_LUHN)
# 107 "project/radare2/libr/hash/hcalc.c"
                         ) {
  *ctx->digest = r_hash_luhn (buf, len);
  return 
# 109 "project/radare2/libr/hash/hcalc.c" 3 4
        1
# 109 "project/radare2/libr/hash/hcalc.c"
                        ;
 }

 if (algobit & 
# 112 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_CRC8_SMBUS)
# 112 "project/radare2/libr/hash/hcalc.c"
                               ) {
  
# 113 "project/radare2/libr/hash/hcalc.c" 3 4
 unsigned char 
# 113 "project/radare2/libr/hash/hcalc.c"
     res = r_hash_crc_preset (buf, len, CRC_PRESET_8_SMBUS);
  r_write_le8 (ctx->digest, res);
  return 
# 115 "project/radare2/libr/hash/hcalc.c" 3 4
        1
# 115 "project/radare2/libr/hash/hcalc.c"
                              ;
 }
# 131 "project/radare2/libr/hash/hcalc.c"
 if (algobit & 
# 131 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_CRC15_CAN)
# 131 "project/radare2/libr/hash/hcalc.c"
                              ) {
  
# 132 "project/radare2/libr/hash/hcalc.c" 3 4
 unsigned short 
# 132 "project/radare2/libr/hash/hcalc.c"
      res = r_hash_crc_preset (buf, len, CRC_PRESET_15_CAN);
  r_write_be16 (ctx->digest, res);
  return 
# 134 "project/radare2/libr/hash/hcalc.c" 3 4
        2
# 134 "project/radare2/libr/hash/hcalc.c"
                             ;
 }


 if (algobit & 
# 138 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_CRC16)
# 138 "project/radare2/libr/hash/hcalc.c"
                          ) {
  
# 139 "project/radare2/libr/hash/hcalc.c" 3 4
 unsigned short 
# 139 "project/radare2/libr/hash/hcalc.c"
      res = r_hash_crc_preset (buf, len, CRC_PRESET_16);
  r_write_be16 (ctx->digest, res);
  return 
# 141 "project/radare2/libr/hash/hcalc.c" 3 4
        2
# 141 "project/radare2/libr/hash/hcalc.c"
                         ;
 }
 if (algobit & 
# 143 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_CRC16_HDLC)
# 143 "project/radare2/libr/hash/hcalc.c"
                               ) {
  
# 144 "project/radare2/libr/hash/hcalc.c" 3 4
 unsigned short 
# 144 "project/radare2/libr/hash/hcalc.c"
      res = r_hash_crc_preset (buf, len, CRC_PRESET_16_HDLC);
  r_write_be16 (ctx->digest, res);
  return 
# 146 "project/radare2/libr/hash/hcalc.c" 3 4
        2
# 146 "project/radare2/libr/hash/hcalc.c"
                              ;
 }
 if (algobit & 
# 148 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_CRC16_USB)
# 148 "project/radare2/libr/hash/hcalc.c"
                              ) {
  
# 149 "project/radare2/libr/hash/hcalc.c" 3 4
 unsigned short 
# 149 "project/radare2/libr/hash/hcalc.c"
      res = r_hash_crc_preset (buf, len, CRC_PRESET_16_USB);
  r_write_be16 (ctx->digest, res);
  return 
# 151 "project/radare2/libr/hash/hcalc.c" 3 4
        2
# 151 "project/radare2/libr/hash/hcalc.c"
                             ;
 }
 if (algobit & 
# 153 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_CRC16_CITT)
# 153 "project/radare2/libr/hash/hcalc.c"
                               ) {
  
# 154 "project/radare2/libr/hash/hcalc.c" 3 4
 unsigned short 
# 154 "project/radare2/libr/hash/hcalc.c"
      res = r_hash_crc_preset (buf, len, CRC_PRESET_16_CITT);
  r_write_be16 (ctx->digest, res);
  return 
# 156 "project/radare2/libr/hash/hcalc.c" 3 4
        2
# 156 "project/radare2/libr/hash/hcalc.c"
                              ;
 }
# 182 "project/radare2/libr/hash/hcalc.c"
 if (algobit & 
# 182 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_CRC24)
# 182 "project/radare2/libr/hash/hcalc.c"
                          ) {
  
# 183 "project/radare2/libr/hash/hcalc.c" 3 4
 unsigned int 
# 183 "project/radare2/libr/hash/hcalc.c"
      res = r_hash_crc_preset (buf, len, CRC_PRESET_24);
  r_write_be24 (ctx->digest, res);
  return 
# 185 "project/radare2/libr/hash/hcalc.c" 3 4
        3
# 185 "project/radare2/libr/hash/hcalc.c"
                         ;
 }


 if (algobit & 
# 189 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_CRC32)
# 189 "project/radare2/libr/hash/hcalc.c"
                          ) {
  
# 190 "project/radare2/libr/hash/hcalc.c" 3 4
 unsigned int 
# 190 "project/radare2/libr/hash/hcalc.c"
      res = r_hash_crc_preset (buf, len, CRC_PRESET_32);
  r_write_be32 (ctx->digest, res);
  return 
# 192 "project/radare2/libr/hash/hcalc.c" 3 4
        4
# 192 "project/radare2/libr/hash/hcalc.c"
                         ;
 }
 if (algobit & 
# 194 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_CRC32C)
# 194 "project/radare2/libr/hash/hcalc.c"
                           ) {
  
# 195 "project/radare2/libr/hash/hcalc.c" 3 4
 unsigned int 
# 195 "project/radare2/libr/hash/hcalc.c"
      res = r_hash_crc_preset (buf, len, CRC_PRESET_32C);
  r_write_be32 (ctx->digest, res);
  return 
# 197 "project/radare2/libr/hash/hcalc.c" 3 4
        4
# 197 "project/radare2/libr/hash/hcalc.c"
                          ;
 }
 if (algobit & 
# 199 "project/radare2/libr/hash/hcalc.c" 3 4
              (1ULL << R_HASH_IDX_CRC32_ECMA_267)
# 199 "project/radare2/libr/hash/hcalc.c"
                                   ) {
  
# 200 "project/radare2/libr/hash/hcalc.c" 3 4
 unsigned int 
# 200 "project/radare2/libr/hash/hcalc.c"
      res = r_hash_crc_preset (buf, len, CRC_PRESET_32_ECMA_267);
  r_write_be32 (ctx->digest, res);
  return 
# 202 "project/radare2/libr/hash/hcalc.c" 3 4
        4
# 202 "project/radare2/libr/hash/hcalc.c"
                                  ;
 }

 do { if (algobit & 
# 205 "project/radare2/libr/hash/hcalc.c" 3 4
(1ULL << R_HASH_IDX_CRC32_BZIP2)
# 205 "project/radare2/libr/hash/hcalc.c"
) { 
# 205 "project/radare2/libr/hash/hcalc.c" 3 4
unsigned int 
# 205 "project/radare2/libr/hash/hcalc.c"
res = r_hash_crc_preset (buf, len, CRC_PRESET_CRC32_BZIP2); r_write_be32 (ctx->digest, res); return 
# 205 "project/radare2/libr/hash/hcalc.c" 3 4
4
# 205 "project/radare2/libr/hash/hcalc.c"
; } } while(0);
 do { if (algobit & 
# 206 "project/radare2/libr/hash/hcalc.c" 3 4
(1ULL << R_HASH_IDX_CRC32D)
# 206 "project/radare2/libr/hash/hcalc.c"
) { 
# 206 "project/radare2/libr/hash/hcalc.c" 3 4
unsigned int 
# 206 "project/radare2/libr/hash/hcalc.c"
res = r_hash_crc_preset (buf, len, CRC_PRESET_CRC32D); r_write_be32 (ctx->digest, res); return 
# 206 "project/radare2/libr/hash/hcalc.c" 3 4
4
# 206 "project/radare2/libr/hash/hcalc.c"
; } } while(0);
 do { if (algobit & 
# 207 "project/radare2/libr/hash/hcalc.c" 3 4
(1ULL << R_HASH_IDX_CRC32_MPEG2)
# 207 "project/radare2/libr/hash/hcalc.c"
) { 
# 207 "project/radare2/libr/hash/hcalc.c" 3 4
unsigned int 
# 207 "project/radare2/libr/hash/hcalc.c"
res = r_hash_crc_preset (buf, len, CRC_PRESET_CRC32_MPEG2); r_write_be32 (ctx->digest, res); return 
# 207 "project/radare2/libr/hash/hcalc.c" 3 4
4
# 207 "project/radare2/libr/hash/hcalc.c"
; } } while(0);
 do { if (algobit & 
# 208 "project/radare2/libr/hash/hcalc.c" 3 4
(1ULL << R_HASH_IDX_CRC32_POSIX)
# 208 "project/radare2/libr/hash/hcalc.c"
) { 
# 208 "project/radare2/libr/hash/hcalc.c" 3 4
unsigned int 
# 208 "project/radare2/libr/hash/hcalc.c"
res = r_hash_crc_preset (buf, len, CRC_PRESET_CRC32_POSIX); r_write_be32 (ctx->digest, res); return 
# 208 "project/radare2/libr/hash/hcalc.c" 3 4
4
# 208 "project/radare2/libr/hash/hcalc.c"
; } } while(0);
 do { if (algobit & 
# 209 "project/radare2/libr/hash/hcalc.c" 3 4
(1ULL << R_HASH_IDX_CRC32Q)
# 209 "project/radare2/libr/hash/hcalc.c"
) { 
# 209 "project/radare2/libr/hash/hcalc.c" 3 4
unsigned int 
# 209 "project/radare2/libr/hash/hcalc.c"
res = r_hash_crc_preset (buf, len, CRC_PRESET_CRC32Q); r_write_be32 (ctx->digest, res); return 
# 209 "project/radare2/libr/hash/hcalc.c" 3 4
4
# 209 "project/radare2/libr/hash/hcalc.c"
; } } while(0);
 do { if (algobit & 
# 210 "project/radare2/libr/hash/hcalc.c" 3 4
(1ULL << R_HASH_IDX_CRC32_JAMCRC)
# 210 "project/radare2/libr/hash/hcalc.c"
) { 
# 210 "project/radare2/libr/hash/hcalc.c" 3 4
unsigned int 
# 210 "project/radare2/libr/hash/hcalc.c"
res = r_hash_crc_preset (buf, len, CRC_PRESET_CRC32_JAMCRC); r_write_be32 (ctx->digest, res); return 
# 210 "project/radare2/libr/hash/hcalc.c" 3 4
4
# 210 "project/radare2/libr/hash/hcalc.c"
; } } while(0);
 do { if (algobit & 
# 211 "project/radare2/libr/hash/hcalc.c" 3 4
(1ULL << R_HASH_IDX_CRC32_XFER)
# 211 "project/radare2/libr/hash/hcalc.c"
) { 
# 211 "project/radare2/libr/hash/hcalc.c" 3 4
unsigned int 
# 211 "project/radare2/libr/hash/hcalc.c"
res = r_hash_crc_preset (buf, len, CRC_PRESET_CRC32_XFER); r_write_be32 (ctx->digest, res); return 
# 211 "project/radare2/libr/hash/hcalc.c" 3 4
4
# 211 "project/radare2/libr/hash/hcalc.c"
; } } while(0);
 ...
 do { if (algobit & 
# 215 "project/radare2/libr/hash/hcalc.c" 3 4
(1ULL << R_HASH_IDX_CRC64)
# 215 "project/radare2/libr/hash/hcalc.c"
) { 
# 215 "project/radare2/libr/hash/hcalc.c" 3 4
unsigned long long 
# 215 "project/radare2/libr/hash/hcalc.c"
res = r_hash_crc_preset (buf, len, CRC_PRESET_CRC64); r_write_be64 (ctx->digest, res); return 
# 215 "project/radare2/libr/hash/hcalc.c" 3 4
8
# 215 "project/radare2/libr/hash/hcalc.c"
; } } while(0);
 ...
 do { if (algobit & 
# 219 "project/radare2/libr/hash/hcalc.c" 3 4
(1ULL << R_HASH_IDX_CRC64_ECMA182)
# 219 "project/radare2/libr/hash/hcalc.c"
) { 
# 219 "project/radare2/libr/hash/hcalc.c" 3 4
unsigned long long 
# 219 "project/radare2/libr/hash/hcalc.c"
res = r_hash_crc_preset (buf, len, CRC_PRESET_CRC64_ECMA182); r_write_be64 (ctx->digest, res); return 
# 219 "project/radare2/libr/hash/hcalc.c" 3 4
8
# 219 "project/radare2/libr/hash/hcalc.c"
; } } while(0);
 do { if (algobit & 
# 220 "project/radare2/libr/hash/hcalc.c" 3 4
(1ULL << R_HASH_IDX_CRC64_WE)
# 220 "project/radare2/libr/hash/hcalc.c"
) { 
# 220 "project/radare2/libr/hash/hcalc.c" 3 4
unsigned long long 
# 220 "project/radare2/libr/hash/hcalc.c"
res = r_hash_crc_preset (buf, len, CRC_PRESET_CRC64_WE); r_write_be64 (ctx->digest, res); return 
# 220 "project/radare2/libr/hash/hcalc.c" 3 4
8
# 220 "project/radare2/libr/hash/hcalc.c"
; } } while(0);
 do { if (algobit & 
# 221 "project/radare2/libr/hash/hcalc.c" 3 4
(1ULL << R_HASH_IDX_CRC64_XZ)
# 221 "project/radare2/libr/hash/hcalc.c"
) { 
# 221 "project/radare2/libr/hash/hcalc.c" 3 4
unsigned long long 
# 221 "project/radare2/libr/hash/hcalc.c"
res = r_hash_crc_preset (buf, len, CRC_PRESET_CRC64_XZ); r_write_be64 (ctx->digest, res); return 
# 221 "project/radare2/libr/hash/hcalc.c" 3 4
8
# 221 "project/radare2/libr/hash/hcalc.c"
; } } while(0);
 do { if (algobit & 
# 222 "project/radare2/libr/hash/hcalc.c" 3 4
(1ULL << R_HASH_IDX_CRC64_ISO)
# 222 "project/radare2/libr/hash/hcalc.c"
) { 
# 222 "project/radare2/libr/hash/hcalc.c" 3 4
unsigned long long 
# 222 "project/radare2/libr/hash/hcalc.c"
res = r_hash_crc_preset (buf, len, CRC_PRESET_CRC64_ISO); r_write_be64 (ctx->digest, res); return 
# 222 "project/radare2/libr/hash/hcalc.c" 3 4
8
# 222 "project/radare2/libr/hash/hcalc.c"
; } } while(0);
