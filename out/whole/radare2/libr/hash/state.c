# 0 "project/radare2/libr/hash/state.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/hash/state.c"
...
# 4 "project/radare2/libr/hash/state.c" 2
...
# 5 "project/radare2/libr/hash/state.c" 2
# 33 "project/radare2/libr/hash/state.c"
# 1 "project/radare2/libr/hash/md4.h" 1

#define _R_MD4_H 


# 4 "project/radare2/libr/hash/md4.h"
void MD4(const 
# 4 "project/radare2/libr/hash/md4.h" 3 4
              unsigned char 
# 4 "project/radare2/libr/hash/md4.h"
                  *in, int n, 
# 4 "project/radare2/libr/hash/md4.h" 3 4
...
# 4 "project/radare2/libr/hash/md4.h"
                                  *out);
# 34 "project/radare2/libr/hash/state.c" 2
# 1 "project/radare2/libr/hash/md5.h" 1

#define _R_MD5_H 

void r_MD5_Init(
# 4 "project/radare2/libr/hash/md5.h" 3 4
               R_MD5_CTX 
# 4 "project/radare2/libr/hash/md5.h"
                       *);
void r_MD5_Update(
# 5 "project/radare2/libr/hash/md5.h" 3 4
                 R_MD5_CTX 
# 5 "project/radare2/libr/hash/md5.h"
                         *, const 
# 5 "project/radare2/libr/hash/md5.h" 3 4
                                  unsigned char
# 5 "project/radare2/libr/hash/md5.h"
                                     *, unsigned int);
void r_MD5_Final(
# 6 "project/radare2/libr/hash/md5.h" 3 4
                unsigned char 
# 6 "project/radare2/libr/hash/md5.h"
                    [16], 
# 6 "project/radare2/libr/hash/md5.h" 3 4
                          R_MD5_CTX 
# 6 "project/radare2/libr/hash/md5.h"
                                  *);
# 35 "project/radare2/libr/hash/state.c" 2
# 1 "project/radare2/libr/hash/sha1.h" 1
# 37 "project/radare2/libr/hash/sha1.h"
#define SHA1_H 
# 48 "project/radare2/libr/hash/sha1.h"
...
# 36 "project/radare2/libr/hash/state.c" 2
# 1 "project/radare2/libr/hash/sha2.h" 1
# 35 "project/radare2/libr/hash/sha2.h"
#define __SHA2_H__ 
# 51 "project/radare2/libr/hash/sha2.h"
...
# 68 "project/radare2/libr/hash/sha2.h"
...
# 92 "project/radare2/libr/hash/sha2.h"
                            *, size_t, char[(64 * 2 + 1)]);
# 37 "project/radare2/libr/hash/state.c" 2


#define CHKFLAG(x) if (!flags || flags & (x))


# 41 "project/radare2/libr/hash/state.c" 3 4
__attribute__((visibility("default"))) struct r_hash_t 
# 41 "project/radare2/libr/hash/state.c"
           *r_hash_new(
# 41 "project/radare2/libr/hash/state.c" 3 4
                       _Bool 
# 41 "project/radare2/libr/hash/state.c"
...
# 42 "project/radare2/libr/hash/state.c" 3 4
struct r_hash_t 
# 42 "project/radare2/libr/hash/state.c"
      *ctx = 
# 42 "project/radare2/libr/hash/state.c" 3 4
             (struct r_hash_t*)calloc(1,sizeof(struct r_hash_t))
# 42 "project/radare2/libr/hash/state.c"
                           ;
 if (ctx) {
...
# 50 "project/radare2/libr/hash/state.c" 3 4
__attribute__((visibility("default"))) 
# 50 "project/radare2/libr/hash/state.c"
     void r_hash_do_begin(
# 50 "project/radare2/libr/hash/state.c" 3 4
                          struct r_hash_t 
# 50 "project/radare2/libr/hash/state.c"
                                *ctx, 
...
# 50 "project/radare2/libr/hash/state.c"
                                           flags) {
 if (!flags || flags & (
# 51 "project/radare2/libr/hash/state.c" 3 4
(1ULL << R_HASH_IDX_MD5)
# 51 "project/radare2/libr/hash/state.c"
)) r_hash_do_md5 (ctx, 
# 51 "project/radare2/libr/hash/state.c" 3 4
                                         ((void *)0)
# 51 "project/radare2/libr/hash/state.c"
                                             , -1);
 if (!flags || flags & (
# 52 "project/radare2/libr/hash/state.c" 3 4
(1ULL << R_HASH_IDX_SHA1)
# 52 "project/radare2/libr/hash/state.c"
)) r_SHA1_Init (&ctx->sha1);
 if (!flags || flags & (
# 53 "project/radare2/libr/hash/state.c" 3 4
(1ULL << R_HASH_IDX_SHA256)
# 53 "project/radare2/libr/hash/state.c"
)) r_SHA256_Init (&ctx->sha256);
 if (!flags || flags & (
# 54 "project/radare2/libr/hash/state.c" 3 4
(1ULL << R_HASH_IDX_SHA384)
# 54 "project/radare2/libr/hash/state.c"
)) r_SHA384_Init (&ctx->sha384);
 if (!flags || flags & (
# 55 "project/radare2/libr/hash/state.c" 3 4
(1ULL << R_HASH_IDX_SHA512)
# 55 "project/radare2/libr/hash/state.c"
)) r_SHA512_Init (&ctx->sha512);
 ctx->rst = 
# 56 "project/radare2/libr/hash/state.c" 3 4
           0
# 56 "project/radare2/libr/hash/state.c"
                ;
}


# 59 "project/radare2/libr/hash/state.c" 3 4
__attribute__((visibility("default"))) 
# 59 "project/radare2/libr/hash/state.c"
     void r_hash_do_end(
# 59 "project/radare2/libr/hash/state.c" 3 4
                        struct r_hash_t 
# 59 "project/radare2/libr/hash/state.c"
...
# 59 "project/radare2/libr/hash/state.c"
                                         flags) {
 if (!flags || flags & (
# 60 "project/radare2/libr/hash/state.c" 3 4
(1ULL << R_HASH_IDX_MD5)
# 60 "project/radare2/libr/hash/state.c"
)) r_hash_do_md5 (ctx, 
# 60 "project/radare2/libr/hash/state.c" 3 4
                                         ((void *)0)
# 60 "project/radare2/libr/hash/state.c"
                                             , -2);
 if (!flags || flags & (
# 61 "project/radare2/libr/hash/state.c" 3 4
(1ULL << R_HASH_IDX_SHA1)
# 61 "project/radare2/libr/hash/state.c"
)) r_SHA1_Final (ctx->digest, &ctx->sha1);
 if (!flags || flags & (
# 62 "project/radare2/libr/hash/state.c" 3 4
(1ULL << R_HASH_IDX_SHA256)
# 62 "project/radare2/libr/hash/state.c"
)) r_SHA256_Final (ctx->digest, &ctx->sha256);
 if (!flags || flags & (
# 63 "project/radare2/libr/hash/state.c" 3 4
(1ULL << R_HASH_IDX_SHA384)
# 63 "project/radare2/libr/hash/state.c"
)) r_SHA384_Final (ctx->digest, &ctx->sha384);
 if (!flags || flags & (
# 64 "project/radare2/libr/hash/state.c" 3 4
(1ULL << R_HASH_IDX_SHA512)
# 64 "project/radare2/libr/hash/state.c"
)) r_SHA512_Final (ctx->digest, &ctx->sha512);
 ctx->rst = 
# 65 "project/radare2/libr/hash/state.c" 3 4
           1
# 65 "project/radare2/libr/hash/state.c"
               ;
}


# 68 "project/radare2/libr/hash/state.c" 3 4
__attribute__((visibility("default"))) 
# 68 "project/radare2/libr/hash/state.c"
     void r_hash_free(
# 68 "project/radare2/libr/hash/state.c" 3 4
                      struct r_hash_t 
# 68 "project/radare2/libr/hash/state.c"
...
# 72 "project/radare2/libr/hash/state.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 72 "project/radare2/libr/hash/state.c"
         *r_hash_do_ssdeep(
# 72 "project/radare2/libr/hash/state.c" 3 4
                           struct r_hash_t 
# 72 "project/radare2/libr/hash/state.c"
...
# 72 "project/radare2/libr/hash/state.c"
 ...
 if (len < 0) {
  return 
# 74 "project/radare2/libr/hash/state.c" 3 4
        ((void *)0)
# 74 "project/radare2/libr/hash/state.c"
            ;
 }
 char *res = r_hash_ssdeep (input, len);
 if (res) {
  r_str_ncpy ((char *)ctx->digest, res, 
# 78 "project/radare2/libr/hash/state.c" 3 4
                                       128
# 78 "project/radare2/libr/hash/state.c"
                                                         );
  free (res);
 }
 return ctx->digest;
...
# 84 "project/radare2/libr/hash/state.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 84 "project/radare2/libr/hash/state.c"
         *r_hash_do_sha1(
# 84 "project/radare2/libr/hash/state.c" 3 4
                         struct r_hash_t 
# 84 "project/radare2/libr/hash/state.c"
...
# 84 "project/radare2/libr/hash/state.c"
 ...
 if (len < 0) {
  return 
# 86 "project/radare2/libr/hash/state.c" 3 4
        ((void *)0)
# 86 "project/radare2/libr/hash/state.c"
            ;
 }
 if (ctx->rst) {
  r_SHA1_Init (&ctx->sha1);
...
# 98 "project/radare2/libr/hash/state.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 98 "project/radare2/libr/hash/state.c"
         *r_hash_do_sha256(
# 98 "project/radare2/libr/hash/state.c" 3 4
                           struct r_hash_t 
# 98 "project/radare2/libr/hash/state.c"
...
# 98 "project/radare2/libr/hash/state.c"
 ...
 if (len < 0) {
  return 
# 100 "project/radare2/libr/hash/state.c" 3 4
        ((void *)0)
# 100 "project/radare2/libr/hash/state.c"
            ;
 }
 if (ctx->rst) {
  r_SHA256_Init (&ctx->sha256);
...
# 112 "project/radare2/libr/hash/state.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 112 "project/radare2/libr/hash/state.c"
         *r_hash_do_sha384(
# 112 "project/radare2/libr/hash/state.c" 3 4
                           struct r_hash_t 
# 112 "project/radare2/libr/hash/state.c"
...
# 112 "project/radare2/libr/hash/state.c"
 ...
 if (len < 0) {
  return 
# 114 "project/radare2/libr/hash/state.c" 3 4
        ((void *)0)
# 114 "project/radare2/libr/hash/state.c"
            ;
 }
 if (ctx->rst) {
  r_SHA384_Init (&ctx->sha384);
...
# 126 "project/radare2/libr/hash/state.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 126 "project/radare2/libr/hash/state.c"
         *r_hash_do_sha512(
# 126 "project/radare2/libr/hash/state.c" 3 4
                           struct r_hash_t 
# 126 "project/radare2/libr/hash/state.c"
...
# 126 "project/radare2/libr/hash/state.c"
 ...
 if (len < 0) {
  return 
# 128 "project/radare2/libr/hash/state.c" 3 4
        ((void *)0)
# 128 "project/radare2/libr/hash/state.c"
            ;
 }
 if (ctx->rst) {
  r_SHA512_Init (&ctx->sha512);
...
# 140 "project/radare2/libr/hash/state.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 140 "project/radare2/libr/hash/state.c"
         *r_hash_do_md5(
# 140 "project/radare2/libr/hash/state.c" 3 4
                        struct r_hash_t 
# 140 "project/radare2/libr/hash/state.c"
...
# 140 "project/radare2/libr/hash/state.c"
 ...
 if (len < 0) {
  ...
  return 
# 147 "project/radare2/libr/hash/state.c" 3 4
        ((void *)0)
# 147 "project/radare2/libr/hash/state.c"
            ;
 }
 if (ctx->rst) {
  r_MD5_Init (&ctx->md5);
 ...
 if (len > 0) {
  ...
  r_MD5_Update (&ctx->md5, (const 
# 155 "project/radare2/libr/hash/state.c" 3 4
                                 unsigned char 
# 155 "project/radare2/libr/hash/state.c"
                                     *) "", 0);
 }
 if (ctx->rst) {
  r_MD5_Final (ctx->digest, &ctx->md5);
...
# 163 "project/radare2/libr/hash/state.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 163 "project/radare2/libr/hash/state.c"
         *r_hash_do_md4(
# 163 "project/radare2/libr/hash/state.c" 3 4
                        struct r_hash_t 
# 163 "project/radare2/libr/hash/state.c"
...
# 163 "project/radare2/libr/hash/state.c"
 ...
 return 
# 168 "project/radare2/libr/hash/state.c" 3 4
       ((void *)0)
# 168 "project/radare2/libr/hash/state.c"
           ;
}


# 171 "project/radare2/libr/hash/state.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 171 "project/radare2/libr/hash/state.c"
         *r_hash_do_hmac_sha256(
# 171 "project/radare2/libr/hash/state.c" 3 4
                                struct r_hash_t 
# 171 "project/radare2/libr/hash/state.c"
                                      *ctx, const 
...
# 171 "project/radare2/libr/hash/state.c"
 ...
 if (len < 0 || klen < 0) {
  return 
# 173 "project/radare2/libr/hash/state.c" 3 4
        ((void *)0)
# 173 "project/radare2/libr/hash/state.c"
            ;
 }

 size_t i;
 
# 177 "project/radare2/libr/hash/state.c" 3 4
unsigned char 
# 177 "project/radare2/libr/hash/state.c"
    bskey[64];
 
# 178 "project/radare2/libr/hash/state.c" 3 4
unsigned char 
# 178 "project/radare2/libr/hash/state.c"
    kpad[64];


 
# 181 "project/radare2/libr/hash/state.c" 3 4
__builtin___memset_chk (
# 181 "project/radare2/libr/hash/state.c"
bskey
# 181 "project/radare2/libr/hash/state.c" 3 4
, 
# 181 "project/radare2/libr/hash/state.c"
...
# 186 "project/radare2/libr/hash/state.c" 3 4
 __builtin___memcpy_chk (
# 186 "project/radare2/libr/hash/state.c"
 bskey
# 186 "project/radare2/libr/hash/state.c" 3 4
 , 
# 186 "project/radare2/libr/hash/state.c"
...
# 188 "project/radare2/libr/hash/state.c" 3 4
 __builtin___memcpy_chk (
# 188 "project/radare2/libr/hash/state.c"
 bskey
# 188 "project/radare2/libr/hash/state.c" 3 4
 , 
# 188 "project/radare2/libr/hash/state.c"
...
# 192 "project/radare2/libr/hash/state.c" 3 4
__builtin___memset_chk (
# 192 "project/radare2/libr/hash/state.c"
kpad
# 192 "project/radare2/libr/hash/state.c" 3 4
, 
# 192 "project/radare2/libr/hash/state.c"
...
# 193 "project/radare2/libr/hash/state.c" 3 4
__builtin___memcpy_chk (
# 193 "project/radare2/libr/hash/state.c"
kpad
# 193 "project/radare2/libr/hash/state.c" 3 4
, 
# 193 "project/radare2/libr/hash/state.c"
...
# 193 "project/radare2/libr/hash/state.c"
 ...
 r_SHA256_Init (&ctx->sha256);
 r_SHA256_Update (&ctx->sha256, kpad, 64);
 r_SHA256_Update (&ctx->sha256, input, len);
 r_SHA256_Final (ctx->digest, &ctx->sha256);


 
# 205 "project/radare2/libr/hash/state.c" 3 4
__builtin___memset_chk (
# 205 "project/radare2/libr/hash/state.c"
kpad
# 205 "project/radare2/libr/hash/state.c" 3 4
, 
# 205 "project/radare2/libr/hash/state.c"
...
# 206 "project/radare2/libr/hash/state.c" 3 4
__builtin___memcpy_chk (
# 206 "project/radare2/libr/hash/state.c"
kpad
# 206 "project/radare2/libr/hash/state.c" 3 4
, 
# 206 "project/radare2/libr/hash/state.c"
...
# 206 "project/radare2/libr/hash/state.c"
 ...
 r_SHA256_Init (&ctx->sha256);
 r_SHA256_Update (&ctx->sha256, kpad, 64);
 r_SHA256_Update (&ctx->sha256, ctx->digest, 
# 214 "project/radare2/libr/hash/state.c" 3 4
                                            32
# 214 "project/radare2/libr/hash/state.c"
                                                              );
 r_SHA256_Final (ctx->digest, &ctx->sha256);
