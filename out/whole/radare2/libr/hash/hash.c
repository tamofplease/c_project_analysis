# 0 "project/radare2/libr/hash/hash.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/hash/hash.c" 2
...
# 5 "project/radare2/libr/hash/hash.c" 2



# 1 "project/radare2/libr/hash/xxhash.h" 1
# 60 "project/radare2/libr/hash/xxhash.h"
       
# 71 "project/radare2/libr/hash/xxhash.h"

# 71 "project/radare2/libr/hash/xxhash.h"
unsigned int XXH32 (const void* input, size_t len, unsigned int seed);
# 89 "project/radare2/libr/hash/xxhash.h"
void* XXH32_init (unsigned int seed);
int XXH32_feed (void* state, const void* input, int len);
unsigned int XXH32_result (void* state);
# 116 "project/radare2/libr/hash/xxhash.h"
unsigned int XXH32_getIntermediateResult (void* state);
# 9 "project/radare2/libr/hash/hash.c" 2



# 11 "project/radare2/libr/hash/hash.c" 3 4
__attribute__((visibility("default"))) const char *
# 11 "project/radare2/libr/hash/hash.c"
r_hash_version
# 11 "project/radare2/libr/hash/hash.c" 3 4
(void) { return "" "5.5.4"; }
# 11 "project/radare2/libr/hash/hash.c"
...
# 15 "project/radare2/libr/hash/hash.c" 3 4
unsigned long long 
# 15 "project/radare2/libr/hash/hash.c"
     bit;
} hash_name_bytes[] = {
 { "all", 
# 17 "project/radare2/libr/hash/hash.c" 3 4
         0xFFFFFFFFFFFFFFFFULL 
# 17 "project/radare2/libr/hash/hash.c"
                  },
 { "xor", 
# 18 "project/radare2/libr/hash/hash.c" 3 4
         (1ULL << R_HASH_IDX_XOR) 
# 18 "project/radare2/libr/hash/hash.c"
                    },
 { "xorpair", 
# 19 "project/radare2/libr/hash/hash.c" 3 4
             (1ULL << R_HASH_IDX_XORPAIR) 
# 19 "project/radare2/libr/hash/hash.c"
                            },
 { "md4", 
# 20 "project/radare2/libr/hash/hash.c" 3 4
         (1ULL << R_HASH_IDX_MD4) 
# 20 "project/radare2/libr/hash/hash.c"
                    },
 { "md5", 
# 21 "project/radare2/libr/hash/hash.c" 3 4
         (1ULL << R_HASH_IDX_MD5) 
# 21 "project/radare2/libr/hash/hash.c"
                    },
 { "sha1", 
# 22 "project/radare2/libr/hash/hash.c" 3 4
          (1ULL << R_HASH_IDX_SHA1) 
# 22 "project/radare2/libr/hash/hash.c"
                      },
 { "sha256", 
# 23 "project/radare2/libr/hash/hash.c" 3 4
            (1ULL << R_HASH_IDX_SHA256) 
# 23 "project/radare2/libr/hash/hash.c"
                          },
 { "sha384", 
# 24 "project/radare2/libr/hash/hash.c" 3 4
            (1ULL << R_HASH_IDX_SHA384) 
# 24 "project/radare2/libr/hash/hash.c"
                          },
 { "sha512", 
# 25 "project/radare2/libr/hash/hash.c" 3 4
            (1ULL << R_HASH_IDX_SHA512) 
# 25 "project/radare2/libr/hash/hash.c"
                          },
 { "adler32", 
# 26 "project/radare2/libr/hash/hash.c" 3 4
             (1ULL << R_HASH_IDX_ADLER32) 
# 26 "project/radare2/libr/hash/hash.c"
                            },
 { "xxhash", 
# 27 "project/radare2/libr/hash/hash.c" 3 4
            (1ULL << R_HASH_IDX_XXHASH) 
# 27 "project/radare2/libr/hash/hash.c"
                          },
 { "parity", 
# 28 "project/radare2/libr/hash/hash.c" 3 4
            (1ULL << R_HASH_IDX_PARITY) 
# 28 "project/radare2/libr/hash/hash.c"
                          },
 { "entropy", 
# 29 "project/radare2/libr/hash/hash.c" 3 4
             (1ULL << R_HASH_IDX_ENTROPY) 
# 29 "project/radare2/libr/hash/hash.c"
                            },
 { "hamdist", 
# 30 "project/radare2/libr/hash/hash.c" 3 4
             (1ULL << R_HASH_IDX_HAMDIST) 
# 30 "project/radare2/libr/hash/hash.c"
                            },
 { "pcprint", 
# 31 "project/radare2/libr/hash/hash.c" 3 4
             (1ULL << R_HASH_IDX_PCPRINT) 
# 31 "project/radare2/libr/hash/hash.c"
                            },
 { "mod255", 
# 32 "project/radare2/libr/hash/hash.c" 3 4
            (1ULL << R_HASH_IDX_MOD255) 
# 32 "project/radare2/libr/hash/hash.c"
                          },



 { "luhn", 
# 36 "project/radare2/libr/hash/hash.c" 3 4
          (1ULL << R_HASH_IDX_LUHN) 
# 36 "project/radare2/libr/hash/hash.c"
                      },
 { "ssdeep", 
# 37 "project/radare2/libr/hash/hash.c" 3 4
            (1ULL << R_HASH_IDX_SSDEEP) 
# 37 "project/radare2/libr/hash/hash.c"
                          },

 { "fletcher8", 
# 39 "project/radare2/libr/hash/hash.c" 3 4
               (1ULL << R_HASH_IDX_FLETCHER8) 
# 39 "project/radare2/libr/hash/hash.c"
                                },
 { "fletcher16", 
# 40 "project/radare2/libr/hash/hash.c" 3 4
                (1ULL << R_HASH_IDX_FLETCHER16) 
# 40 "project/radare2/libr/hash/hash.c"
                                  },
 { "fletcher32", 
# 41 "project/radare2/libr/hash/hash.c" 3 4
                (1ULL << R_HASH_IDX_FLETCHER32) 
# 41 "project/radare2/libr/hash/hash.c"
                                  },
 { "fletcher64", 
# 42 "project/radare2/libr/hash/hash.c" 3 4
                (1ULL << R_HASH_IDX_FLETCHER64) 
# 42 "project/radare2/libr/hash/hash.c"
                                  },

 { "crc8smbus", 
# 44 "project/radare2/libr/hash/hash.c" 3 4
               (1ULL << R_HASH_IDX_CRC8_SMBUS) 
# 44 "project/radare2/libr/hash/hash.c"
                                 },
# 58 "project/radare2/libr/hash/hash.c"
 { "crc15can", 
# 58 "project/radare2/libr/hash/hash.c" 3 4
              (1ULL << R_HASH_IDX_CRC15_CAN) 
# 58 "project/radare2/libr/hash/hash.c"
                               },


 { "crc16", 
# 61 "project/radare2/libr/hash/hash.c" 3 4
           (1ULL << R_HASH_IDX_CRC16) 
# 61 "project/radare2/libr/hash/hash.c"
                        },
 { "crc16hdlc", 
# 62 "project/radare2/libr/hash/hash.c" 3 4
               (1ULL << R_HASH_IDX_CRC16_HDLC) 
# 62 "project/radare2/libr/hash/hash.c"
                                 },
 { "crc16usb", 
# 63 "project/radare2/libr/hash/hash.c" 3 4
                                       (1ULL << R_HASH_IDX_CRC16_USB) 
# 63 "project/radare2/libr/hash/hash.c"
                                                        },
 { "crc16citt", 
# 64 "project/radare2/libr/hash/hash.c" 3 4
                                        (1ULL << R_HASH_IDX_CRC16_CITT) 
# 64 "project/radare2/libr/hash/hash.c"
                                                          },
# 89 "project/radare2/libr/hash/hash.c"
 { "crc24", 
# 89 "project/radare2/libr/hash/hash.c" 3 4
           (1ULL << R_HASH_IDX_CRC24) 
# 89 "project/radare2/libr/hash/hash.c"
                        },


 { "crc32", 
# 92 "project/radare2/libr/hash/hash.c" 3 4
           (1ULL << R_HASH_IDX_CRC32) 
# 92 "project/radare2/libr/hash/hash.c"
                        },
 { "crc32c", 
# 93 "project/radare2/libr/hash/hash.c" 3 4
            (1ULL << R_HASH_IDX_CRC32C) 
# 93 "project/radare2/libr/hash/hash.c"
                          },
 { "crc32ecma267", 
# 94 "project/radare2/libr/hash/hash.c" 3 4
                  (1ULL << R_HASH_IDX_CRC32_ECMA_267) 
# 94 "project/radare2/libr/hash/hash.c"
                                        },

 { "crc32bzip2", 
# 96 "project/radare2/libr/hash/hash.c" 3 4
                                         (1ULL << R_HASH_IDX_CRC32_BZIP2) 
# 96 "project/radare2/libr/hash/hash.c"
                                                            },
 { "crc32d", 
# 97 "project/radare2/libr/hash/hash.c" 3 4
                                     (1ULL << R_HASH_IDX_CRC32D) 
# 97 "project/radare2/libr/hash/hash.c"
                                                   },
 { "crc32mpeg2", 
# 98 "project/radare2/libr/hash/hash.c" 3 4
                                         (1ULL << R_HASH_IDX_CRC32_MPEG2) 
# 98 "project/radare2/libr/hash/hash.c"
                                                            },
 { "crc32posix", 
# 99 "project/radare2/libr/hash/hash.c" 3 4
                                         (1ULL << R_HASH_IDX_CRC32_POSIX) 
# 99 "project/radare2/libr/hash/hash.c"
                                                            },
 { "crc32q", 
# 100 "project/radare2/libr/hash/hash.c" 3 4
                                     (1ULL << R_HASH_IDX_CRC32Q) 
# 100 "project/radare2/libr/hash/hash.c"
                                                   },
 { "crc32jamcrc", 
# 101 "project/radare2/libr/hash/hash.c" 3 4
                                          (1ULL << R_HASH_IDX_CRC32_JAMCRC) 
# 101 "project/radare2/libr/hash/hash.c"
                                                              },
 { "crc32xfer", 
# 102 "project/radare2/libr/hash/hash.c" 3 4
                                        (1ULL << R_HASH_IDX_CRC32_XFER) 
# 102 "project/radare2/libr/hash/hash.c"
                                                          },



 { "crc64", 
# 106 "project/radare2/libr/hash/hash.c" 3 4
                                    (1ULL << R_HASH_IDX_CRC64) 
# 106 "project/radare2/libr/hash/hash.c"
                                                 },



 { "crc64ecma", 
# 110 "project/radare2/libr/hash/hash.c" 3 4
                                        (1ULL << R_HASH_IDX_CRC64_ECMA182) 
# 110 "project/radare2/libr/hash/hash.c"
                                                             },
 { "crc64we", 
# 111 "project/radare2/libr/hash/hash.c" 3 4
                                      (1ULL << R_HASH_IDX_CRC64_WE) 
# 111 "project/radare2/libr/hash/hash.c"
                                                      },
 { "crc64xz", 
# 112 "project/radare2/libr/hash/hash.c" 3 4
                                      (1ULL << R_HASH_IDX_CRC64_XZ) 
# 112 "project/radare2/libr/hash/hash.c"
                                                      },
 { "crc64iso", 
# 113 "project/radare2/libr/hash/hash.c" 3 4
                                       (1ULL << R_HASH_IDX_CRC64_ISO) 
# 113 "project/radare2/libr/hash/hash.c"
                                                        },

 { 
# 115 "project/radare2/libr/hash/hash.c" 3 4
  ((void *)0)
# 115 "project/radare2/libr/hash/hash.c"
      , 0 }
};



# 119 "project/radare2/libr/hash/hash.c" 3 4
__attribute__((visibility("default"))) 
# 119 "project/radare2/libr/hash/hash.c"
     int r_hash_pcprint(const 
# 119 "project/radare2/libr/hash/hash.c" 3 4
                              unsigned char 
# 119 "project/radare2/libr/hash/hash.c"
                                  *buffer, 
...
# 119 "project/radare2/libr/hash/hash.c"
                                                len) {
 const 
# 120 "project/radare2/libr/hash/hash.c" 3 4
      unsigned char 
# 120 "project/radare2/libr/hash/hash.c"
          *end = buffer + len;
 int n;
 if (len < 1) {
  return 0;
 ...
 for (n = 0; buffer < end; buffer++) {
  if (
# 126 "project/radare2/libr/hash/hash.c" 3 4
     ((
# 126 "project/radare2/libr/hash/hash.c"
     *buffer
# 126 "project/radare2/libr/hash/hash.c" 3 4
     ) >=' ' && (
# 126 "project/radare2/libr/hash/hash.c"
...
# 133 "project/radare2/libr/hash/hash.c" 3 4
__attribute__((visibility("default"))) 
# 133 "project/radare2/libr/hash/hash.c"
     int r_hash_parity(const 
# 133 "project/radare2/libr/hash/hash.c" 3 4
                             unsigned char 
# 133 "project/radare2/libr/hash/hash.c"
                                 *buf, 
...
# 133 "project/radare2/libr/hash/hash.c"
                                            len) {
 const 
# 134 "project/radare2/libr/hash/hash.c" 3 4
      unsigned char 
# 134 "project/radare2/libr/hash/hash.c"
          *end = buf + len;
 
# 135 "project/radare2/libr/hash/hash.c" 3 4
unsigned int 
# 135 "project/radare2/libr/hash/hash.c"
     ones = 0;
 for (; buf < end; buf++) {
  
# 137 "project/radare2/libr/hash/hash.c" 3 4
 unsigned char 
# 137 "project/radare2/libr/hash/hash.c"
     x = buf[0];
...
# 146 "project/radare2/libr/hash/hash.c" 3 4
__attribute__((visibility("default"))) unsigned short 
# 146 "project/radare2/libr/hash/hash.c"
          r_hash_xorpair(const 
# 146 "project/radare2/libr/hash/hash.c" 3 4
                               unsigned char 
# 146 "project/radare2/libr/hash/hash.c"
                                   *a, 
...
# 147 "project/radare2/libr/hash/hash.c" 3 4
unsigned short 
# 147 "project/radare2/libr/hash/hash.c"
     result = 0, *b = (
# 147 "project/radare2/libr/hash/hash.c" 3 4
                       unsigned short 
# 147 "project/radare2/libr/hash/hash.c"
...
# 154 "project/radare2/libr/hash/hash.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 154 "project/radare2/libr/hash/hash.c"
         r_hash_xor(const 
# 154 "project/radare2/libr/hash/hash.c" 3 4
                          unsigned char 
# 154 "project/radare2/libr/hash/hash.c"
...
# 155 "project/radare2/libr/hash/hash.c" 3 4
unsigned char 
# 155 "project/radare2/libr/hash/hash.c"
    res = 0;
 for (; len--; b++) {
  res ^= *b;
 }
...
# 162 "project/radare2/libr/hash/hash.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 162 "project/radare2/libr/hash/hash.c"
         r_hash_mod255(const 
# 162 "project/radare2/libr/hash/hash.c" 3 4
                             unsigned char 
# 162 "project/radare2/libr/hash/hash.c"
...
# 171 "project/radare2/libr/hash/hash.c" 3 4
__attribute__((visibility("default"))) unsigned int 
# 171 "project/radare2/libr/hash/hash.c"
          r_hash_xxhash(const 
# 171 "project/radare2/libr/hash/hash.c" 3 4
                              unsigned char 
# 171 "project/radare2/libr/hash/hash.c"
...
# 175 "project/radare2/libr/hash/hash.c" 3 4
__attribute__((visibility("default"))) unsigned char 
# 175 "project/radare2/libr/hash/hash.c"
         r_hash_deviation(const 
# 175 "project/radare2/libr/hash/hash.c" 3 4
                                unsigned char 
# 175 "project/radare2/libr/hash/hash.c"
                                    *b, 
...
# 175 "project/radare2/libr/hash/hash.c"
 ...
 for (c = i = 0, len--; i < len; i++) {
  c += 
# 178 "project/radare2/libr/hash/hash.c" 3 4
      (((
# 178 "project/radare2/libr/hash/hash.c"
      b[i + 1] - b[i]
# 178 "project/radare2/libr/hash/hash.c" 3 4
      )<0)?-(
# 178 "project/radare2/libr/hash/hash.c"
...
# 183 "project/radare2/libr/hash/hash.c" 3 4
__attribute__((visibility("default"))) 
# 183 "project/radare2/libr/hash/hash.c"
     const char *r_hash_name(
# 183 "project/radare2/libr/hash/hash.c" 3 4
                             unsigned long long 
# 183 "project/radare2/libr/hash/hash.c"
                                  bit) {
...
# 193 "project/radare2/libr/hash/hash.c" 3 4
__attribute__((visibility("default"))) 
# 193 "project/radare2/libr/hash/hash.c"
     int r_hash_size(
# 193 "project/radare2/libr/hash/hash.c" 3 4
                     unsigned long long 
# 193 "project/radare2/libr/hash/hash.c"
...
#define ALGOBIT(x) if (algo & R_HASH_ ##x) { return R_HASH_SIZE_ ##x; }
 ...
 if (algo & 
# 198 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_FLETCHER8)
# 198 "project/radare2/libr/hash/hash.c"
) { return 
# 198 "project/radare2/libr/hash/hash.c" 3 4
1
# 198 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 199 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_FLETCHER16)
# 199 "project/radare2/libr/hash/hash.c"
) { return 
# 199 "project/radare2/libr/hash/hash.c" 3 4
2
# 199 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 200 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_FLETCHER32)
# 200 "project/radare2/libr/hash/hash.c"
) { return 
# 200 "project/radare2/libr/hash/hash.c" 3 4
4
# 200 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 201 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_FLETCHER64)
# 201 "project/radare2/libr/hash/hash.c"
) { return 
# 201 "project/radare2/libr/hash/hash.c" 3 4
8
# 201 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 202 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_MD4)
# 202 "project/radare2/libr/hash/hash.c"
) { return 
# 202 "project/radare2/libr/hash/hash.c" 3 4
16
# 202 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 203 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_MD5)
# 203 "project/radare2/libr/hash/hash.c"
) { return 
# 203 "project/radare2/libr/hash/hash.c" 3 4
16
# 203 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 204 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_SHA1)
# 204 "project/radare2/libr/hash/hash.c"
) { return 
# 204 "project/radare2/libr/hash/hash.c" 3 4
20
# 204 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 205 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_SHA256)
# 205 "project/radare2/libr/hash/hash.c"
) { return 
# 205 "project/radare2/libr/hash/hash.c" 3 4
32
# 205 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 206 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_SHA384)
# 206 "project/radare2/libr/hash/hash.c"
) { return 
# 206 "project/radare2/libr/hash/hash.c" 3 4
48
# 206 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 207 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_SHA512)
# 207 "project/radare2/libr/hash/hash.c"
) { return 
# 207 "project/radare2/libr/hash/hash.c" 3 4
64
# 207 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 208 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_XXHASH)
# 208 "project/radare2/libr/hash/hash.c"
) { return 
# 208 "project/radare2/libr/hash/hash.c" 3 4
4
# 208 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 209 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_ADLER32)
# 209 "project/radare2/libr/hash/hash.c"
) { return 
# 209 "project/radare2/libr/hash/hash.c" 3 4
4
# 209 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 210 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_PARITY)
# 210 "project/radare2/libr/hash/hash.c"
) { return 
# 210 "project/radare2/libr/hash/hash.c" 3 4
1
# 210 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 211 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_ENTROPY)
# 211 "project/radare2/libr/hash/hash.c"
) { return 
# 211 "project/radare2/libr/hash/hash.c" 3 4
0
# 211 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 212 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_HAMDIST)
# 212 "project/radare2/libr/hash/hash.c"
) { return 
# 212 "project/radare2/libr/hash/hash.c" 3 4
1
# 212 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 213 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_XOR)
# 213 "project/radare2/libr/hash/hash.c"
) { return 
# 213 "project/radare2/libr/hash/hash.c" 3 4
1
# 213 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 214 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_XORPAIR)
# 214 "project/radare2/libr/hash/hash.c"
) { return 
# 214 "project/radare2/libr/hash/hash.c" 3 4
2
# 214 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 215 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_MOD255)
# 215 "project/radare2/libr/hash/hash.c"
) { return 
# 215 "project/radare2/libr/hash/hash.c" 3 4
1
# 215 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 216 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_PCPRINT)
# 216 "project/radare2/libr/hash/hash.c"
) { return 
# 216 "project/radare2/libr/hash/hash.c" 3 4
1
# 216 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 217 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_LUHN)
# 217 "project/radare2/libr/hash/hash.c"
) { return 
# 217 "project/radare2/libr/hash/hash.c" 3 4
1
# 217 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 218 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_SSDEEP)
# 218 "project/radare2/libr/hash/hash.c"
) { return 
# 218 "project/radare2/libr/hash/hash.c" 3 4
128
# 218 "project/radare2/libr/hash/hash.c"
; };
 ...
 if (algo & 
# 220 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC8_SMBUS)
# 220 "project/radare2/libr/hash/hash.c"
) { return 
# 220 "project/radare2/libr/hash/hash.c" 3 4
1
# 220 "project/radare2/libr/hash/hash.c"
; };
# 234 "project/radare2/libr/hash/hash.c"
 if (algo & 
# 234 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC15_CAN)
# 234 "project/radare2/libr/hash/hash.c"
) { return 
# 234 "project/radare2/libr/hash/hash.c" 3 4
...
; };
 ...
 if (algo & 
# 237 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC16)
# 237 "project/radare2/libr/hash/hash.c"
) { return 
# 237 "project/radare2/libr/hash/hash.c" 3 4
2
# 237 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 238 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC16_HDLC)
# 238 "project/radare2/libr/hash/hash.c"
) { return 
# 238 "project/radare2/libr/hash/hash.c" 3 4
2
# 238 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 239 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC16_USB)
# 239 "project/radare2/libr/hash/hash.c"
) { return 
# 239 "project/radare2/libr/hash/hash.c" 3 4
2
# 239 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 240 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC16_CITT)
# 240 "project/radare2/libr/hash/hash.c"
) { return 
# 240 "project/radare2/libr/hash/hash.c" 3 4
2
# 240 "project/radare2/libr/hash/hash.c"
; };
# 265 "project/radare2/libr/hash/hash.c"
 if (algo & 
# 265 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC24)
# 265 "project/radare2/libr/hash/hash.c"
) { return 
# 265 "project/radare2/libr/hash/hash.c" 3 4
...
; };
 ...
 if (algo & 
# 268 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC32)
# 268 "project/radare2/libr/hash/hash.c"
) { return 
# 268 "project/radare2/libr/hash/hash.c" 3 4
4
# 268 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 269 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC32C)
# 269 "project/radare2/libr/hash/hash.c"
) { return 
# 269 "project/radare2/libr/hash/hash.c" 3 4
4
# 269 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 270 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC32_ECMA_267)
# 270 "project/radare2/libr/hash/hash.c"
) { return 
# 270 "project/radare2/libr/hash/hash.c" 3 4
4
# 270 "project/radare2/libr/hash/hash.c"
; };
 ...
 if (algo & 
# 272 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC32_BZIP2)
# 272 "project/radare2/libr/hash/hash.c"
) { return 
# 272 "project/radare2/libr/hash/hash.c" 3 4
4
# 272 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 273 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC32D)
# 273 "project/radare2/libr/hash/hash.c"
) { return 
# 273 "project/radare2/libr/hash/hash.c" 3 4
4
# 273 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 274 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC32_MPEG2)
# 274 "project/radare2/libr/hash/hash.c"
) { return 
# 274 "project/radare2/libr/hash/hash.c" 3 4
4
# 274 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 275 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC32_POSIX)
# 275 "project/radare2/libr/hash/hash.c"
) { return 
# 275 "project/radare2/libr/hash/hash.c" 3 4
4
# 275 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 276 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC32Q)
# 276 "project/radare2/libr/hash/hash.c"
) { return 
# 276 "project/radare2/libr/hash/hash.c" 3 4
4
# 276 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 277 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC32_JAMCRC)
# 277 "project/radare2/libr/hash/hash.c"
) { return 
# 277 "project/radare2/libr/hash/hash.c" 3 4
4
# 277 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 278 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC32_XFER)
# 278 "project/radare2/libr/hash/hash.c"
) { return 
# 278 "project/radare2/libr/hash/hash.c" 3 4
4
# 278 "project/radare2/libr/hash/hash.c"
; };
 ...
 if (algo & 
# 282 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC64)
# 282 "project/radare2/libr/hash/hash.c"
) { return 
# 282 "project/radare2/libr/hash/hash.c" 3 4
8
# 282 "project/radare2/libr/hash/hash.c"
; };
 ...
 if (algo & 
# 286 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC64_ECMA182)
# 286 "project/radare2/libr/hash/hash.c"
) { return 
# 286 "project/radare2/libr/hash/hash.c" 3 4
8
# 286 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 287 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC64_WE)
# 287 "project/radare2/libr/hash/hash.c"
) { return 
# 287 "project/radare2/libr/hash/hash.c" 3 4
8
# 287 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 288 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC64_XZ)
# 288 "project/radare2/libr/hash/hash.c"
) { return 
# 288 "project/radare2/libr/hash/hash.c" 3 4
8
# 288 "project/radare2/libr/hash/hash.c"
; };
 if (algo & 
# 289 "project/radare2/libr/hash/hash.c" 3 4
(1ULL << R_HASH_IDX_CRC64_ISO)
# 289 "project/radare2/libr/hash/hash.c"
) { return 
# 289 "project/radare2/libr/hash/hash.c" 3 4
8
# 289 "project/radare2/libr/hash/hash.c"
...
# 295 "project/radare2/libr/hash/hash.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 295 "project/radare2/libr/hash/hash.c"
          r_hash_name_to_bits(const char *name) {
 char tmp[128];
 int i;
 const char *ptr = name;
 
# 299 "project/radare2/libr/hash/hash.c" 3 4
unsigned long long 
# 299 "project/radare2/libr/hash/hash.c"
     ret = 0;
 ...
 do {
  ...
  for (i = 0; *ptr && *ptr != ',' && i < sizeof (tmp) - 1; i++) {
    tmp[i] = tolower ((
# 308 "project/radare2/libr/hash/hash.c" 3 4
                      unsigned char
# 308 "project/radare2/libr/hash/hash.c"
                         )*ptr++);
  }
...
# 330 "project/radare2/libr/hash/hash.c" 3 4
__attribute__((visibility("default"))) 
# 330 "project/radare2/libr/hash/hash.c"
...
# 330 "project/radare2/libr/hash/hash.c" 3 4
                                      unsigned long long 
# 330 "project/radare2/libr/hash/hash.c"
                                           algo, int loops, RHashSeed *seed) {
 
# 331 "project/radare2/libr/hash/hash.c" 3 4
do { if (!(
# 331 "project/radare2/libr/hash/hash.c"
ctx
# 331 "project/radare2/libr/hash/hash.c" 3 4
...
# 334 "project/radare2/libr/hash/hash.c" 3 4
unsigned char 
# 334 "project/radare2/libr/hash/hash.c"
...
# 341 "project/radare2/libr/hash/hash.c" 3 4
   __builtin___memcpy_chk (
# 341 "project/radare2/libr/hash/hash.c"
   buf
# 341 "project/radare2/libr/hash/hash.c" 3 4
   , 
# 341 "project/radare2/libr/hash/hash.c"
...
# 342 "project/radare2/libr/hash/hash.c" 3 4
   __builtin___memcpy_chk (
# 342 "project/radare2/libr/hash/hash.c"
   buf + seed->len
# 342 "project/radare2/libr/hash/hash.c" 3 4
   , 
# 342 "project/radare2/libr/hash/hash.c"
...
# 344 "project/radare2/libr/hash/hash.c" 3 4
   __builtin___memcpy_chk (
# 344 "project/radare2/libr/hash/hash.c"
   buf
# 344 "project/radare2/libr/hash/hash.c" 3 4
   , 
# 344 "project/radare2/libr/hash/hash.c"
...
# 345 "project/radare2/libr/hash/hash.c" 3 4
   __builtin___memcpy_chk (
# 345 "project/radare2/libr/hash/hash.c"
   buf + hlen
# 345 "project/radare2/libr/hash/hash.c" 3 4
   , 
# 345 "project/radare2/libr/hash/hash.c"
...
# 349 "project/radare2/libr/hash/hash.c" 3 4
  __builtin___memcpy_chk (
# 349 "project/radare2/libr/hash/hash.c"
  buf
# 349 "project/radare2/libr/hash/hash.c" 3 4
  , 
# 349 "project/radare2/libr/hash/hash.c"
...
# 357 "project/radare2/libr/hash/hash.c" 3 4
__attribute__((visibility("default"))) 
# 357 "project/radare2/libr/hash/hash.c"
     char *r_hash_to_string( 
# 357 "project/radare2/libr/hash/hash.c" 3 4
                                       struct r_hash_t 
# 357 "project/radare2/libr/hash/hash.c"
                                             *ctx, const char *name, const 
# 357 "project/radare2/libr/hash/hash.c" 3 4
                                                                           unsigned char 
# 357 "project/radare2/libr/hash/hash.c"
                                                                               *data, int len) {
 
# 358 "project/radare2/libr/hash/hash.c" 3 4
do { if (!(
# 358 "project/radare2/libr/hash/hash.c"
name && len >= 0
# 358 "project/radare2/libr/hash/hash.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 358 "project/radare2/libr/hash/hash.c"
"name && len >= 0"
# 358 "project/radare2/libr/hash/hash.c" 3 4
, 358); return (((void *)0)); } } while (0)
# 358 "project/radare2/libr/hash/hash.c"
                                             ;
 
# 359 "project/radare2/libr/hash/hash.c" 3 4
unsigned long long 
# 359 "project/radare2/libr/hash/hash.c"
     algo = r_hash_name_to_bits (name);
 char *digest_hex = 
# 360 "project/radare2/libr/hash/hash.c" 3 4
                   ((void *)0)
# 360 "project/radare2/libr/hash/hash.c"
                       ;
 
# 361 "project/radare2/libr/hash/hash.c" 3 4
struct r_hash_t 
# 361 "project/radare2/libr/hash/hash.c"
      *myctx = 
# 361 "project/radare2/libr/hash/hash.c" 3 4
               ((void *)0)
# 361 "project/radare2/libr/hash/hash.c"
 ...
 if (!algo || !data) {
  return 
# 364 "project/radare2/libr/hash/hash.c" 3 4
        ((void *)0)
# 364 "project/radare2/libr/hash/hash.c"
            ;
 }
 if (!ctx) {
  myctx = ctx = r_hash_new (
# 367 "project/radare2/libr/hash/hash.c" 3 4
                           1
# 367 "project/radare2/libr/hash/hash.c"
                               , algo);
 }
...
# 374 "project/radare2/libr/hash/hash.c" 3 4
 __builtin___snprintf_chk (
# 374 "project/radare2/libr/hash/hash.c"
 digest_hex
# 374 "project/radare2/libr/hash/hash.c" 3 4
 , 
# 374 "project/radare2/libr/hash/hash.c"
...
# 374 "project/radare2/libr/hash/hash.c"
  ...
  if (digest_size * 2 < digest_size) {
   digest_hex = 
# 377 "project/radare2/libr/hash/hash.c" 3 4
               ((void *)0)
# 377 "project/radare2/libr/hash/hash.c"
                   ;
  } else {
...
# 382 "project/radare2/libr/hash/hash.c" 3 4
    __builtin___sprintf_chk (
# 382 "project/radare2/libr/hash/hash.c"
    digest_hex + (i * 2)
# 382 "project/radare2/libr/hash/hash.c" 3 4
    , 0, __builtin_object_size (
# 382 "project/radare2/libr/hash/hash.c"
