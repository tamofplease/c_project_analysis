# 0 "project/radare2/libr/hash/xxhash.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/hash/xxhash.c"
# 37 "project/radare2/libr/hash/xxhash.c"
...
# 38 "project/radare2/libr/hash/xxhash.c" 2
...
# 39 "project/radare2/libr/hash/xxhash.c" 2
...
# 40 "project/radare2/libr/hash/xxhash.c" 2
...
# 41 "project/radare2/libr/hash/xxhash.c" 2
...
# 50 "project/radare2/libr/hash/xxhash.c" 3 4
unsigned int 
# 50 "project/radare2/libr/hash/xxhash.c"
    XXH32(const void *input, size_t len, 
# 50 "project/radare2/libr/hash/xxhash.c" 3 4
                                         unsigned int 
# 50 "project/radare2/libr/hash/xxhash.c"
                                              seed) {
 const 
# 51 "project/radare2/libr/hash/xxhash.c" 3 4
      unsigned char 
# 51 "project/radare2/libr/hash/xxhash.c"
          *p = (const 
# 51 "project/radare2/libr/hash/xxhash.c" 3 4
                      unsigned char 
# 51 "project/radare2/libr/hash/xxhash.c"
                          *) input;
 const 
# 52 "project/radare2/libr/hash/xxhash.c" 3 4
      unsigned char 
# 52 "project/radare2/libr/hash/xxhash.c"
          *const bEnd = p + len;
 
# 53 "project/radare2/libr/hash/xxhash.c" 3 4
unsigned int 
# 53 "project/radare2/libr/hash/xxhash.c"
     h32;

 if (len >= 16) {
  const 
# 56 "project/radare2/libr/hash/xxhash.c" 3 4
       unsigned char 
# 56 "project/radare2/libr/hash/xxhash.c"
           *const limit = bEnd - 16;
  
# 57 "project/radare2/libr/hash/xxhash.c" 3 4
 unsigned int 
# 57 "project/radare2/libr/hash/xxhash.c"
      v1 = seed + 2654435761U + 2246822519U;
  
# 58 "project/radare2/libr/hash/xxhash.c" 3 4
 unsigned int 
# 58 "project/radare2/libr/hash/xxhash.c"
      v2 = seed + 2246822519U;
  
# 59 "project/radare2/libr/hash/xxhash.c" 3 4
 unsigned int 
# 59 "project/radare2/libr/hash/xxhash.c"
      v3 = seed + 0;
  
# 60 "project/radare2/libr/hash/xxhash.c" 3 4
 unsigned int 
# 60 "project/radare2/libr/hash/xxhash.c"
      v4 = seed - 2654435761U;

  do {
   v1 += r_read_le32 (p) * 2246822519U;
   v1 = (((v1) << (13)) | ((v1) >> (32 - (13))));
   v1 *= 2654435761U;
   p += 4;
   v2 += r_read_le32 (p) * 2246822519U;
   v2 = (((v2) << (13)) | ((v2) >> (32 - (13))));
   v2 *= 2654435761U;
   p += 4;
   v3 += r_read_le32 (p) * 2246822519U;
   v3 = (((v3) << (13)) | ((v3) >> (32 - (13))));
   v3 *= 2654435761U;
   p += 4;
   v4 += r_read_le32 (p) * 2246822519U;
   v4 = (((v4) << (13)) | ((v4) >> (32 - (13))));
   v4 *= 2654435761U;
   p += 4;
  } while (p <= limit);
 ...
 h32 += (
# 87 "project/radare2/libr/hash/xxhash.c" 3 4
        unsigned int
# 87 "project/radare2/libr/hash/xxhash.c"
            ) len;

 while (p <= bEnd - 4) {
  h32 += r_read_le32 (p) * 3266489917U;
...
# 111 "project/radare2/libr/hash/xxhash.c" 3 4
unsigned int 
# 111 "project/radare2/libr/hash/xxhash.c"
     seed;
 
# 112 "project/radare2/libr/hash/xxhash.c" 3 4
unsigned int 
# 112 "project/radare2/libr/hash/xxhash.c"
     v1;
 
# 113 "project/radare2/libr/hash/xxhash.c" 3 4
unsigned int 
# 113 "project/radare2/libr/hash/xxhash.c"
     v2;
 
# 114 "project/radare2/libr/hash/xxhash.c" 3 4
unsigned int 
# 114 "project/radare2/libr/hash/xxhash.c"
     v3;
 
# 115 "project/radare2/libr/hash/xxhash.c" 3 4
unsigned int 
# 115 "project/radare2/libr/hash/xxhash.c"
     v4;
 
# 116 "project/radare2/libr/hash/xxhash.c" 3 4
unsigned long long 
# 116 "project/radare2/libr/hash/xxhash.c"
     total_len;
 char memory[16];
 int memsize;
};
...
void *XXH32_init (
# 121 "project/radare2/libr/hash/xxhash.c" 3 4
                 unsigned int 
# 121 "project/radare2/libr/hash/xxhash.c"
                      seed) {
 struct XXH_state32_t *state =
  (struct XXH_state32_t *) malloc (sizeof (struct XXH_state32_t));
 if (!state) {
  return 
# 125 "project/radare2/libr/hash/xxhash.c" 3 4
        ((void *)0)
# 125 "project/radare2/libr/hash/xxhash.c"
            ;
 }
 state->seed = seed;
...
int XXH32_feed (void *state_in, const void *input, int len) {
 ...
 const 
# 139 "project/radare2/libr/hash/xxhash.c" 3 4
      unsigned char 
# 139 "project/radare2/libr/hash/xxhash.c"
          *p = (const 
# 139 "project/radare2/libr/hash/xxhash.c" 3 4
                      unsigned char 
# 139 "project/radare2/libr/hash/xxhash.c"
                          *) input;
 const 
# 140 "project/radare2/libr/hash/xxhash.c" 3 4
      unsigned char 
# 140 "project/radare2/libr/hash/xxhash.c"
          *const bEnd = p + len;
...
# 145 "project/radare2/libr/hash/xxhash.c" 3 4
 __builtin___memcpy_chk (
# 145 "project/radare2/libr/hash/xxhash.c"
 state->memory + state->memsize
# 145 "project/radare2/libr/hash/xxhash.c" 3 4
 , 
# 145 "project/radare2/libr/hash/xxhash.c"
 input, len
...
# 152 "project/radare2/libr/hash/xxhash.c" 3 4
 __builtin___memcpy_chk (
# 152 "project/radare2/libr/hash/xxhash.c"
 state->memory + state->memsize
# 152 "project/radare2/libr/hash/xxhash.c" 3 4
 , 
# 152 "project/radare2/libr/hash/xxhash.c"
...
# 152 "project/radare2/libr/hash/xxhash.c"
  ...
  {
   const 
# 154 "project/radare2/libr/hash/xxhash.c" 3 4
        unsigned int 
# 154 "project/radare2/libr/hash/xxhash.c"
             *p32 = (const 
# 154 "project/radare2/libr/hash/xxhash.c" 3 4
                           unsigned int 
# 154 "project/radare2/libr/hash/xxhash.c"
                                *) state->memory;
   state->v1 += r_read_le32 (p32) * 2246822519U;
   state->v1 = (((state->v1) << (13)) | ((state->v1) >> (32 - (13))));
   state->v1 *= 2654435761U;
   p32++;
   state->v2 += r_read_le32 (p32) * 2246822519U;
   state->v2 = (((state->v2) << (13)) | ((state->v2) >> (32 - (13))));
   state->v2 *= 2654435761U;
   p32++;
   state->v3 += r_read_le32 (p32) * 2246822519U;
   state->v3 = (((state->v3) << (13)) | ((state->v3) >> (32 - (13))));
   state->v3 *= 2654435761U;
   p32++;
   state->v4 += r_read_le32 (p32) * 2246822519U;
   state->v4 = (((state->v4) << (13)) | ((state->v4) >> (32 - (13))));
   state->v4 *= 2654435761U;
   p32++;
  }
  p += 16 - state->memsize;
  state->memsize = 0;
 ...
 {
  const 
# 177 "project/radare2/libr/hash/xxhash.c" 3 4
       unsigned char 
# 177 "project/radare2/libr/hash/xxhash.c"
           *const limit = bEnd - 16;
  
# 178 "project/radare2/libr/hash/xxhash.c" 3 4
 unsigned int 
# 178 "project/radare2/libr/hash/xxhash.c"
      v1 = state->v1;
  
# 179 "project/radare2/libr/hash/xxhash.c" 3 4
 unsigned int 
# 179 "project/radare2/libr/hash/xxhash.c"
      v2 = state->v2;
  
# 180 "project/radare2/libr/hash/xxhash.c" 3 4
 unsigned int 
# 180 "project/radare2/libr/hash/xxhash.c"
      v3 = state->v3;
  
# 181 "project/radare2/libr/hash/xxhash.c" 3 4
 unsigned int 
# 181 "project/radare2/libr/hash/xxhash.c"
      v4 = state->v4;
 ...
 if (p < bEnd) {
  state->memsize = 
# 208 "project/radare2/libr/hash/xxhash.c" 3 4
                  (((
# 208 "project/radare2/libr/hash/xxhash.c"
                  bEnd - p
# 208 "project/radare2/libr/hash/xxhash.c" 3 4
                  )>(
# 208 "project/radare2/libr/hash/xxhash.c"
...
# 209 "project/radare2/libr/hash/xxhash.c" 3 4
 __builtin___memcpy_chk (
# 209 "project/radare2/libr/hash/xxhash.c"
 state->memory
# 209 "project/radare2/libr/hash/xxhash.c" 3 4
 , 
# 209 "project/radare2/libr/hash/xxhash.c"
...
# 214 "project/radare2/libr/hash/xxhash.c" 3 4
unsigned int 
# 214 "project/radare2/libr/hash/xxhash.c"
    XXH32_getIntermediateResult (void *state_in) {
 struct XXH_state32_t *state = state_in;
 
# 216 "project/radare2/libr/hash/xxhash.c" 3 4
unsigned char 
# 216 "project/radare2/libr/hash/xxhash.c"
    *p = (
# 216 "project/radare2/libr/hash/xxhash.c" 3 4
          unsigned char 
# 216 "project/radare2/libr/hash/xxhash.c"
...
# 217 "project/radare2/libr/hash/xxhash.c" 3 4
unsigned char 
# 217 "project/radare2/libr/hash/xxhash.c"
    *bEnd = (
# 217 "project/radare2/libr/hash/xxhash.c" 3 4
             unsigned char 
# 217 "project/radare2/libr/hash/xxhash.c"
...
# 218 "project/radare2/libr/hash/xxhash.c" 3 4
unsigned int 
# 218 "project/radare2/libr/hash/xxhash.c"
     h32;

 if (state->total_len >= 16) {
  h32 = (((state->v1) << (1)) | ((state->v1) >> (32 - (1)))) + (((state->v2) << (7)) | ((state->v2) >> (32 - (7)))) +
  (((state->v3) << (12)) | ((state->v3) >> (32 - (12)))) + (((state->v4) << (18)) | ((state->v4) >> (32 - (18))));
 } else {
  h32 = state->seed + 374761393U;
 }

 h32 += (
# 227 "project/radare2/libr/hash/xxhash.c" 3 4
        unsigned int
# 227 "project/radare2/libr/hash/xxhash.c"
            ) state->total_len;
...
# 247 "project/radare2/libr/hash/xxhash.c" 3 4
unsigned int 
# 247 "project/radare2/libr/hash/xxhash.c"
    XXH32_result (void *state_in) {
 
# 248 "project/radare2/libr/hash/xxhash.c" 3 4
unsigned int 
# 248 "project/radare2/libr/hash/xxhash.c"
     h32 = XXH32_getIntermediateResult (state_in);
 free (state_in);
 return h32;
}
