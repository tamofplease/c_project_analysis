# 0 "project/radare2/libr/hash/crca.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 6 "project/radare2/libr/hash/crca.c" 2


# 7 "project/radare2/libr/hash/crca.c"
void crc_init (R_CRC_CTX *ctx, utcrc crc, 
# 7 "project/radare2/libr/hash/crca.c" 3 4
                                         unsigned int 
# 7 "project/radare2/libr/hash/crca.c"
                                              size, int reflect, utcrc poly, utcrc xout) {
 ctx->crc = crc;
 ctx->size = size;
 ctx->reflect = reflect;
 ctx->poly = poly;
...
void crc_update (R_CRC_CTX *ctx, const 
# 15 "project/radare2/libr/hash/crca.c" 3 4
                                      unsigned char 
# 15 "project/radare2/libr/hash/crca.c"
                                          *data, 
# 15 "project/radare2/libr/hash/crca.c" 3 4
                                                 unsigned int 
# 15 "project/radare2/libr/hash/crca.c"
...
static void crc_final (R_CRC_CTX *ctx, utcrc *r) {
 ...
 crc = ctx->crc;
 crc &= (((
# 42 "project/radare2/libr/hash/crca.c" 3 4
          ((utcrc)(
# 42 "project/radare2/libr/hash/crca.c"
          1
# 42 "project/radare2/libr/hash/crca.c" 3 4
          )) 
# 42 "project/radare2/libr/hash/crca.c"
 ...
 if (ctx->reflect) {
  for (i = 0; i < (ctx->size >> 1); i++) {
   if (((crc >> i) ^ (crc >> (ctx->size - 1 - i))) & 1) {
    crc ^= (
# 46 "project/radare2/libr/hash/crca.c" 3 4
           ((utcrc)(
# 46 "project/radare2/libr/hash/crca.c"
           1
# 46 "project/radare2/libr/hash/crca.c" 3 4
           )) 
# 46 "project/radare2/libr/hash/crca.c"
...
R_CRC_CTX crc_presets[] = {
 { 
# 60 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 60 "project/radare2/libr/hash/crca.c"
0x00
# 60 "project/radare2/libr/hash/crca.c" 3 4
))
# 60 "project/radare2/libr/hash/crca.c"
...
# 74 "project/radare2/libr/hash/crca.c"
 { 
# 74 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 74 "project/radare2/libr/hash/crca.c"
0x0000
# 74 "project/radare2/libr/hash/crca.c" 3 4
...
# 74 "project/radare2/libr/hash/crca.c"
 ...
 { 
# 77 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 77 "project/radare2/libr/hash/crca.c"
0x0000
# 77 "project/radare2/libr/hash/crca.c" 3 4
))
# 77 "project/radare2/libr/hash/crca.c"
...
# 77 "project/radare2/libr/hash/crca.c"
 ...
 { 
# 78 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 78 "project/radare2/libr/hash/crca.c"
0xFFFF
# 78 "project/radare2/libr/hash/crca.c" 3 4
))
# 78 "project/radare2/libr/hash/crca.c"
...
# 78 "project/radare2/libr/hash/crca.c"
 ...
 { 
# 79 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 79 "project/radare2/libr/hash/crca.c"
0xFFFF
# 79 "project/radare2/libr/hash/crca.c" 3 4
))
# 79 "project/radare2/libr/hash/crca.c"
...
# 79 "project/radare2/libr/hash/crca.c"
 ...
 { 
# 80 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 80 "project/radare2/libr/hash/crca.c"
0xFFFF
# 80 "project/radare2/libr/hash/crca.c" 3 4
))
# 80 "project/radare2/libr/hash/crca.c"
...
# 105 "project/radare2/libr/hash/crca.c"
 { 
# 105 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 105 "project/radare2/libr/hash/crca.c"
0xB704CE
# 105 "project/radare2/libr/hash/crca.c" 3 4
...
# 105 "project/radare2/libr/hash/crca.c"
 ...
 { 
# 108 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 108 "project/radare2/libr/hash/crca.c"
0xFFFFFFFF
# 108 "project/radare2/libr/hash/crca.c" 3 4
))
# 108 "project/radare2/libr/hash/crca.c"
...
# 108 "project/radare2/libr/hash/crca.c"
 ...
 { 
# 109 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 109 "project/radare2/libr/hash/crca.c"
0x00000000
# 109 "project/radare2/libr/hash/crca.c" 3 4
))
# 109 "project/radare2/libr/hash/crca.c"
...
# 109 "project/radare2/libr/hash/crca.c"
 ...
 { 
# 110 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 110 "project/radare2/libr/hash/crca.c"
0xFFFFFFFF
# 110 "project/radare2/libr/hash/crca.c" 3 4
))
# 110 "project/radare2/libr/hash/crca.c"
...
# 110 "project/radare2/libr/hash/crca.c"
 ...
 { 
# 112 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 112 "project/radare2/libr/hash/crca.c"
0xFFFFFFFF
# 112 "project/radare2/libr/hash/crca.c" 3 4
))
# 112 "project/radare2/libr/hash/crca.c"
...
# 112 "project/radare2/libr/hash/crca.c"
 ...
 { 
# 113 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 113 "project/radare2/libr/hash/crca.c"
0xFFFFFFFF
# 113 "project/radare2/libr/hash/crca.c" 3 4
))
# 113 "project/radare2/libr/hash/crca.c"
...
# 113 "project/radare2/libr/hash/crca.c"
 ...
 { 
# 114 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 114 "project/radare2/libr/hash/crca.c"
0xFFFFFFFF
# 114 "project/radare2/libr/hash/crca.c" 3 4
))
# 114 "project/radare2/libr/hash/crca.c"
...
# 114 "project/radare2/libr/hash/crca.c"
 ...
 { 
# 115 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 115 "project/radare2/libr/hash/crca.c"
0x00000000
# 115 "project/radare2/libr/hash/crca.c" 3 4
))
# 115 "project/radare2/libr/hash/crca.c"
...
# 115 "project/radare2/libr/hash/crca.c"
 ...
 { 
# 116 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 116 "project/radare2/libr/hash/crca.c"
0x00000000
# 116 "project/radare2/libr/hash/crca.c" 3 4
))
# 116 "project/radare2/libr/hash/crca.c"
...
# 116 "project/radare2/libr/hash/crca.c"
 ...
 { 
# 117 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 117 "project/radare2/libr/hash/crca.c"
0xFFFFFFFF
# 117 "project/radare2/libr/hash/crca.c" 3 4
))
# 117 "project/radare2/libr/hash/crca.c"
...
# 117 "project/radare2/libr/hash/crca.c"
 ...
 { 
# 118 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 118 "project/radare2/libr/hash/crca.c"
0x00000000
# 118 "project/radare2/libr/hash/crca.c" 3 4
))
# 118 "project/radare2/libr/hash/crca.c"
...
# 118 "project/radare2/libr/hash/crca.c"
 ...
 { 
# 122 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 122 "project/radare2/libr/hash/crca.c"
0x0000000000000000
# 122 "project/radare2/libr/hash/crca.c" 3 4
))
# 122 "project/radare2/libr/hash/crca.c"
...
# 122 "project/radare2/libr/hash/crca.c"
 ...
 { 
# 125 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 125 "project/radare2/libr/hash/crca.c"
0x0000000000000000
# 125 "project/radare2/libr/hash/crca.c" 3 4
))
# 125 "project/radare2/libr/hash/crca.c"
...
# 125 "project/radare2/libr/hash/crca.c"
 ...
 { 
# 126 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 126 "project/radare2/libr/hash/crca.c"
0xFFFFFFFFFFFFFFFF
# 126 "project/radare2/libr/hash/crca.c" 3 4
))
# 126 "project/radare2/libr/hash/crca.c"
...
# 126 "project/radare2/libr/hash/crca.c"
 ...
 { 
# 127 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 127 "project/radare2/libr/hash/crca.c"
0xFFFFFFFFFFFFFFFF
# 127 "project/radare2/libr/hash/crca.c" 3 4
))
# 127 "project/radare2/libr/hash/crca.c"
...
# 127 "project/radare2/libr/hash/crca.c"
 ...
 { 
# 128 "project/radare2/libr/hash/crca.c" 3 4
((utcrc)(
# 128 "project/radare2/libr/hash/crca.c"
0xFFFFFFFFFFFFFFFF
# 128 "project/radare2/libr/hash/crca.c" 3 4
))
# 128 "project/radare2/libr/hash/crca.c"
...
utcrc r_hash_crc_preset (const 
# 140 "project/radare2/libr/hash/crca.c" 3 4
                              unsigned char 
# 140 "project/radare2/libr/hash/crca.c"
                                  *data, 
# 140 "project/radare2/libr/hash/crca.c" 3 4
                                         unsigned int 
# 140 "project/radare2/libr/hash/crca.c"
                                              size, enum CRC_PRESETS preset) {
