# 0 "project/radare2/libr/hash/fletcher.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/hash/fletcher.c"
...
# 4 "project/radare2/libr/hash/fletcher.c" 2

__attribute__((visibility("default"))) unsigned char 
# 5 "project/radare2/libr/hash/fletcher.c"
         r_hash_fletcher8(const 
# 5 "project/radare2/libr/hash/fletcher.c" 3 4
                                unsigned char 
# 5 "project/radare2/libr/hash/fletcher.c"
                                    *d, size_t length) {
 size_t i;
 
# 7 "project/radare2/libr/hash/fletcher.c" 3 4
unsigned short 
# 7 "project/radare2/libr/hash/fletcher.c"
     a = 0;
 
# 8 "project/radare2/libr/hash/fletcher.c" 3 4
unsigned short 
# 8 "project/radare2/libr/hash/fletcher.c"
     b = 0;
 for (i = 0; i < length; i++) {
  a += d[i];
  a = (a & 0xff) + (a >> 8);
...
# 18 "project/radare2/libr/hash/fletcher.c" 3 4
__attribute__((visibility("default"))) unsigned short 
# 18 "project/radare2/libr/hash/fletcher.c"
          r_hash_fletcher16(const 
# 18 "project/radare2/libr/hash/fletcher.c" 3 4
                                  unsigned char 
# 18 "project/radare2/libr/hash/fletcher.c"
                                      *data, size_t len) {
 
# 19 "project/radare2/libr/hash/fletcher.c" 3 4
unsigned int 
# 19 "project/radare2/libr/hash/fletcher.c"
     c0, c1;
 size_t i;
...
# 39 "project/radare2/libr/hash/fletcher.c" 3 4
__attribute__((visibility("default"))) unsigned int 
# 39 "project/radare2/libr/hash/fletcher.c"
          r_hash_fletcher32(const 
# 39 "project/radare2/libr/hash/fletcher.c" 3 4
                                  unsigned char 
# 39 "project/radare2/libr/hash/fletcher.c"
                                      *data, size_t len) {
 
# 40 "project/radare2/libr/hash/fletcher.c" 3 4
unsigned int 
# 40 "project/radare2/libr/hash/fletcher.c"
     c0, c1;
 size_t i;
 
# 42 "project/radare2/libr/hash/fletcher.c" 3 4
unsigned char 
# 42 "project/radare2/libr/hash/fletcher.c"
    word[sizeof (
# 42 "project/radare2/libr/hash/fletcher.c" 3 4
                 unsigned short
# 42 "project/radare2/libr/hash/fletcher.c"
...
# 46 "project/radare2/libr/hash/fletcher.c" 3 4
  __builtin___memset_chk (
# 46 "project/radare2/libr/hash/fletcher.c"
  word
# 46 "project/radare2/libr/hash/fletcher.c" 3 4
  , 
# 46 "project/radare2/libr/hash/fletcher.c"
...
# 47 "project/radare2/libr/hash/fletcher.c" 3 4
  __builtin___memcpy_chk (
# 47 "project/radare2/libr/hash/fletcher.c"
  word
# 47 "project/radare2/libr/hash/fletcher.c" 3 4
  , 
# 47 "project/radare2/libr/hash/fletcher.c"
...
# 47 "project/radare2/libr/hash/fletcher.c"
  ...
  c0 %= 
# 52 "project/radare2/libr/hash/fletcher.c" 3 4
       0xFFFFU
# 52 "project/radare2/libr/hash/fletcher.c"
               ;
  c1 %= 
# 53 "project/radare2/libr/hash/fletcher.c" 3 4
       0xFFFFU
# 53 "project/radare2/libr/hash/fletcher.c"
               ;
 }
 for (i = 0; i < len; i+=2) {
  size_t left = len - i;
  
# 57 "project/radare2/libr/hash/fletcher.c" 3 4
 __builtin___memset_chk (
# 57 "project/radare2/libr/hash/fletcher.c"
 word
# 57 "project/radare2/libr/hash/fletcher.c" 3 4
 , 
# 57 "project/radare2/libr/hash/fletcher.c"
...
# 58 "project/radare2/libr/hash/fletcher.c" 3 4
 __builtin___memcpy_chk (
# 58 "project/radare2/libr/hash/fletcher.c"
 word
# 58 "project/radare2/libr/hash/fletcher.c" 3 4
 , 
# 58 "project/radare2/libr/hash/fletcher.c"
...
# 58 "project/radare2/libr/hash/fletcher.c"
 ...
 c0 %= 
# 63 "project/radare2/libr/hash/fletcher.c" 3 4
      0xFFFFU
# 63 "project/radare2/libr/hash/fletcher.c"
              ;
 c1 %= 
# 64 "project/radare2/libr/hash/fletcher.c" 3 4
      0xFFFFU
# 64 "project/radare2/libr/hash/fletcher.c"
              ;
 return (c1 << 16 | c0);
}


# 68 "project/radare2/libr/hash/fletcher.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 68 "project/radare2/libr/hash/fletcher.c"
          r_hash_fletcher64(const 
# 68 "project/radare2/libr/hash/fletcher.c" 3 4
                                  unsigned char 
# 68 "project/radare2/libr/hash/fletcher.c"
                                      *addr, size_t len) {
 const 
# 69 "project/radare2/libr/hash/fletcher.c" 3 4
      unsigned char 
# 69 "project/radare2/libr/hash/fletcher.c"
          *p32 = addr;
 const 
# 70 "project/radare2/libr/hash/fletcher.c" 3 4
      unsigned char 
# 70 "project/radare2/libr/hash/fletcher.c"
          *p32end = addr + len;
 
# 71 "project/radare2/libr/hash/fletcher.c" 3 4
unsigned int 
# 71 "project/radare2/libr/hash/fletcher.c"
     lo32 = 0;
 
# 72 "project/radare2/libr/hash/fletcher.c" 3 4
unsigned int 
# 72 "project/radare2/libr/hash/fletcher.c"
     hi32 = 0;

 
# 74 "project/radare2/libr/hash/fletcher.c" 3 4
unsigned char 
# 74 "project/radare2/libr/hash/fletcher.c"
    word[sizeof (
# 74 "project/radare2/libr/hash/fletcher.c" 3 4
                 unsigned int
# 74 "project/radare2/libr/hash/fletcher.c"
...
# 77 "project/radare2/libr/hash/fletcher.c" 3 4
 __builtin___memset_chk (
# 77 "project/radare2/libr/hash/fletcher.c"
 word
# 77 "project/radare2/libr/hash/fletcher.c" 3 4
 , 
# 77 "project/radare2/libr/hash/fletcher.c"
...
# 78 "project/radare2/libr/hash/fletcher.c" 3 4
 __builtin___memcpy_chk (
# 78 "project/radare2/libr/hash/fletcher.c"
 word
# 78 "project/radare2/libr/hash/fletcher.c" 3 4
 , 
# 78 "project/radare2/libr/hash/fletcher.c"
...
# 79 "project/radare2/libr/hash/fletcher.c" 3 4
 unsigned int 
# 79 "project/radare2/libr/hash/fletcher.c"
      w = r_read_le32 (word);
  lo32 += w;
  p32 += sizeof (
# 81 "project/radare2/libr/hash/fletcher.c" 3 4
                unsigned int
# 81 "project/radare2/libr/hash/fletcher.c"
                    );
  hi32 += lo32;
 }
 return ((
# 84 "project/radare2/libr/hash/fletcher.c" 3 4
         unsigned long long
# 84 "project/radare2/libr/hash/fletcher.c"
             )hi32 << 32) | lo32;
}
