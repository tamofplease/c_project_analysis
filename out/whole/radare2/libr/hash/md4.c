# 0 "project/radare2/libr/hash/md4.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/hash/md4.c"
# 23 "project/radare2/libr/hash/md4.c"
...
# 24 "project/radare2/libr/hash/md4.c" 2




# 27 "project/radare2/libr/hash/md4.c"
static inline 
# 27 "project/radare2/libr/hash/md4.c" 3 4
             unsigned int 
# 27 "project/radare2/libr/hash/md4.c"
                  F(
# 27 "project/radare2/libr/hash/md4.c" 3 4
...
static inline 
# 31 "project/radare2/libr/hash/md4.c" 3 4
             unsigned int 
# 31 "project/radare2/libr/hash/md4.c"
                  G(
# 31 "project/radare2/libr/hash/md4.c" 3 4
                    unsigned int 
# 31 "project/radare2/libr/hash/md4.c"
...
static inline 
# 35 "project/radare2/libr/hash/md4.c" 3 4
             unsigned int 
# 35 "project/radare2/libr/hash/md4.c"
                  H(
# 35 "project/radare2/libr/hash/md4.c" 3 4
                    unsigned int 
# 35 "project/radare2/libr/hash/md4.c"
...
static inline 
# 39 "project/radare2/libr/hash/md4.c" 3 4
             unsigned int 
# 39 "project/radare2/libr/hash/md4.c"
                  lshift(
# 39 "project/radare2/libr/hash/md4.c" 3 4
                         unsigned int 
# 39 "project/radare2/libr/hash/md4.c"
                              x, int s) {
 x &= 
# 40 "project/radare2/libr/hash/md4.c" 3 4
     0xFFFFFFFFU
# 40 "project/radare2/libr/hash/md4.c"
             ;
 return ((x << s) & 
# 41 "project/radare2/libr/hash/md4.c" 3 4
                   0xFFFFFFFFU
# 41 "project/radare2/libr/hash/md4.c"
                           ) | (x >> (32 - s));
}
...
# 49 "project/radare2/libr/hash/md4.c" 3 4
                    unsigned int 
# 49 "project/radare2/libr/hash/md4.c"
                         *M, 
# 49 "project/radare2/libr/hash/md4.c" 3 4
                             unsigned int 
# 49 "project/radare2/libr/hash/md4.c"
...
# 51 "project/radare2/libr/hash/md4.c" 3 4
unsigned int 
# 51 "project/radare2/libr/hash/md4.c"
     X[16];
...
# 57 "project/radare2/libr/hash/md4.c" 3 4
unsigned int 
# 57 "project/radare2/libr/hash/md4.c"
     AA = *A;
 
# 58 "project/radare2/libr/hash/md4.c" 3 4
unsigned int 
# 58 "project/radare2/libr/hash/md4.c"
     BB = *B;
 
# 59 "project/radare2/libr/hash/md4.c" 3 4
unsigned int 
# 59 "project/radare2/libr/hash/md4.c"
     CC = *C;
 
# 60 "project/radare2/libr/hash/md4.c" 3 4
unsigned int 
# 60 "project/radare2/libr/hash/md4.c"
     DD = *D;

 (*A) = lshift ((*A) + F (*B, *C, *D) + X[0], 3);
 (*D) = lshift ((*D) + F (*A, *B, *C) + X[1], 7);
 (*C) = lshift ((*C) + F (*D, *A, *B) + X[2], 11);
 (*B) = lshift ((*B) + F (*C, *D, *A) + X[3], 19);
 (*A) = lshift ((*A) + F (*B, *C, *D) + X[4], 3);
 (*D) = lshift ((*D) + F (*A, *B, *C) + X[5], 7);
 (*C) = lshift ((*C) + F (*D, *A, *B) + X[6], 11);
 (*B) = lshift ((*B) + F (*C, *D, *A) + X[7], 19);
 (*A) = lshift ((*A) + F (*B, *C, *D) + X[8], 3);
 (*D) = lshift ((*D) + F (*A, *B, *C) + X[9], 7);
 (*C) = lshift ((*C) + F (*D, *A, *B) + X[10], 11);
 (*B) = lshift ((*B) + F (*C, *D, *A) + X[11], 19);
 (*A) = lshift ((*A) + F (*B, *C, *D) + X[12], 3);
 (*D) = lshift ((*D) + F (*A, *B, *C) + X[13], 7);
 (*C) = lshift ((*C) + F (*D, *A, *B) + X[14], 11);
 (*B) = lshift ((*B) + F (*C, *D, *A) + X[15], 19);

 (*A) = lshift ((*A) + G (*B, *C, *D) + X[0] + (
# 79 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 79 "project/radare2/libr/hash/md4.c"
) 0x5A827999, 3);
 (*D) = lshift ((*D) + G (*A, *B, *C) + X[4] + (
# 80 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 80 "project/radare2/libr/hash/md4.c"
) 0x5A827999, 5);
 (*C) = lshift ((*C) + G (*D, *A, *B) + X[8] + (
# 81 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 81 "project/radare2/libr/hash/md4.c"
) 0x5A827999, 9);
 (*B) = lshift ((*B) + G (*C, *D, *A) + X[12] + (
# 82 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 82 "project/radare2/libr/hash/md4.c"
) 0x5A827999, 13);
 (*A) = lshift ((*A) + G (*B, *C, *D) + X[1] + (
# 83 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 83 "project/radare2/libr/hash/md4.c"
) 0x5A827999, 3);
 (*D) = lshift ((*D) + G (*A, *B, *C) + X[5] + (
# 84 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 84 "project/radare2/libr/hash/md4.c"
) 0x5A827999, 5);
 (*C) = lshift ((*C) + G (*D, *A, *B) + X[9] + (
# 85 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 85 "project/radare2/libr/hash/md4.c"
) 0x5A827999, 9);
 (*B) = lshift ((*B) + G (*C, *D, *A) + X[13] + (
# 86 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 86 "project/radare2/libr/hash/md4.c"
) 0x5A827999, 13);
 (*A) = lshift ((*A) + G (*B, *C, *D) + X[2] + (
# 87 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 87 "project/radare2/libr/hash/md4.c"
) 0x5A827999, 3);
 (*D) = lshift ((*D) + G (*A, *B, *C) + X[6] + (
# 88 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 88 "project/radare2/libr/hash/md4.c"
) 0x5A827999, 5);
 (*C) = lshift ((*C) + G (*D, *A, *B) + X[10] + (
# 89 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 89 "project/radare2/libr/hash/md4.c"
) 0x5A827999, 9);
 (*B) = lshift ((*B) + G (*C, *D, *A) + X[14] + (
# 90 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 90 "project/radare2/libr/hash/md4.c"
) 0x5A827999, 13);
 (*A) = lshift ((*A) + G (*B, *C, *D) + X[3] + (
# 91 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 91 "project/radare2/libr/hash/md4.c"
) 0x5A827999, 3);
 (*D) = lshift ((*D) + G (*A, *B, *C) + X[7] + (
# 92 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 92 "project/radare2/libr/hash/md4.c"
) 0x5A827999, 5);
 (*C) = lshift ((*C) + G (*D, *A, *B) + X[11] + (
# 93 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 93 "project/radare2/libr/hash/md4.c"
) 0x5A827999, 9);
 (*B) = lshift ((*B) + G (*C, *D, *A) + X[15] + (
# 94 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 94 "project/radare2/libr/hash/md4.c"
) 0x5A827999, 13);

 (*A) = lshift ((*A) + H (*B, *C, *D) + X[0] + (
# 96 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 96 "project/radare2/libr/hash/md4.c"
) 0x6ED9EBA1, 3);
 (*D) = lshift ((*D) + H (*A, *B, *C) + X[8] + (
# 97 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 97 "project/radare2/libr/hash/md4.c"
) 0x6ED9EBA1, 9);
 (*C) = lshift ((*C) + H (*D, *A, *B) + X[4] + (
# 98 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 98 "project/radare2/libr/hash/md4.c"
) 0x6ED9EBA1, 11);
 (*B) = lshift ((*B) + H (*C, *D, *A) + X[12] + (
# 99 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 99 "project/radare2/libr/hash/md4.c"
) 0x6ED9EBA1, 15);
 (*A) = lshift ((*A) + H (*B, *C, *D) + X[2] + (
# 100 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 100 "project/radare2/libr/hash/md4.c"
) 0x6ED9EBA1, 3);
 (*D) = lshift ((*D) + H (*A, *B, *C) + X[10] + (
# 101 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 101 "project/radare2/libr/hash/md4.c"
) 0x6ED9EBA1, 9);
 (*C) = lshift ((*C) + H (*D, *A, *B) + X[6] + (
# 102 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 102 "project/radare2/libr/hash/md4.c"
) 0x6ED9EBA1, 11);
 (*B) = lshift ((*B) + H (*C, *D, *A) + X[14] + (
# 103 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 103 "project/radare2/libr/hash/md4.c"
) 0x6ED9EBA1, 15);
 (*A) = lshift ((*A) + H (*B, *C, *D) + X[1] + (
# 104 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 104 "project/radare2/libr/hash/md4.c"
) 0x6ED9EBA1, 3);
 (*D) = lshift ((*D) + H (*A, *B, *C) + X[9] + (
# 105 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 105 "project/radare2/libr/hash/md4.c"
) 0x6ED9EBA1, 9);
 (*C) = lshift ((*C) + H (*D, *A, *B) + X[5] + (
# 106 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 106 "project/radare2/libr/hash/md4.c"
) 0x6ED9EBA1, 11);
 (*B) = lshift ((*B) + H (*C, *D, *A) + X[13] + (
# 107 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 107 "project/radare2/libr/hash/md4.c"
) 0x6ED9EBA1, 15);
 (*A) = lshift ((*A) + H (*B, *C, *D) + X[3] + (
# 108 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 108 "project/radare2/libr/hash/md4.c"
) 0x6ED9EBA1, 3);
 (*D) = lshift ((*D) + H (*A, *B, *C) + X[11] + (
# 109 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 109 "project/radare2/libr/hash/md4.c"
) 0x6ED9EBA1, 9);
 (*C) = lshift ((*C) + H (*D, *A, *B) + X[7] + (
# 110 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 110 "project/radare2/libr/hash/md4.c"
) 0x6ED9EBA1, 11);
 (*B) = lshift ((*B) + H (*C, *D, *A) + X[15] + (
# 111 "project/radare2/libr/hash/md4.c" 3 4
unsigned int
# 111 "project/radare2/libr/hash/md4.c"
) 0x6ED9EBA1, 15);
 ...
 *A &= 
# 118 "project/radare2/libr/hash/md4.c" 3 4
      0xFFFFFFFFU
# 118 "project/radare2/libr/hash/md4.c"
              ;
 *B &= 
# 119 "project/radare2/libr/hash/md4.c" 3 4
      0xFFFFFFFFU
# 119 "project/radare2/libr/hash/md4.c"
              ;
 *C &= 
# 120 "project/radare2/libr/hash/md4.c" 3 4
      0xFFFFFFFFU
# 120 "project/radare2/libr/hash/md4.c"
              ;
 *D &= 
# 121 "project/radare2/libr/hash/md4.c" 3 4
      0xFFFFFFFFU
# 121 "project/radare2/libr/hash/md4.c"
              ;
...
static void copy64(
# 128 "project/radare2/libr/hash/md4.c" 3 4
                  unsigned int 
# 128 "project/radare2/libr/hash/md4.c"
                       *M, const 
# 128 "project/radare2/libr/hash/md4.c" 3 4
                                 unsigned char 
# 128 "project/radare2/libr/hash/md4.c"
 ...
 for (i = 0; i < 16; i++) {
  M[i] = ((
# 131 "project/radare2/libr/hash/md4.c" 3 4
          unsigned int
# 131 "project/radare2/libr/hash/md4.c"
...
static void copy4(
# 136 "project/radare2/libr/hash/md4.c" 3 4
                 unsigned char 
# 136 "project/radare2/libr/hash/md4.c"
                     *out, 
# 136 "project/radare2/libr/hash/md4.c" 3 4
                           unsigned int 
# 136 "project/radare2/libr/hash/md4.c"
...
void MD4(const 
# 143 "project/radare2/libr/hash/md4.c" 3 4
              unsigned char 
# 143 "project/radare2/libr/hash/md4.c"
                  *in, int n, 
# 143 "project/radare2/libr/hash/md4.c" 3 4
                              unsigned char 
# 143 "project/radare2/libr/hash/md4.c"
...
# 144 "project/radare2/libr/hash/md4.c" 3 4
unsigned char 
# 144 "project/radare2/libr/hash/md4.c"
    buf[128];
 
# 145 "project/radare2/libr/hash/md4.c" 3 4
unsigned int 
# 145 "project/radare2/libr/hash/md4.c"
     M[16];
 
# 146 "project/radare2/libr/hash/md4.c" 3 4
unsigned int 
# 146 "project/radare2/libr/hash/md4.c"
     b = n * 8;
 int i;
 
# 148 "project/radare2/libr/hash/md4.c" 3 4
unsigned int 
# 148 "project/radare2/libr/hash/md4.c"
     A = 0x67452301;
 
# 149 "project/radare2/libr/hash/md4.c" 3 4
unsigned int 
# 149 "project/radare2/libr/hash/md4.c"
     B = 0xefcdab89;
 
# 150 "project/radare2/libr/hash/md4.c" 3 4
unsigned int 
# 150 "project/radare2/libr/hash/md4.c"
     C = 0x98badcfe;
 
# 151 "project/radare2/libr/hash/md4.c" 3 4
unsigned int 
# 151 "project/radare2/libr/hash/md4.c"
     D = 0x10325476;
...
# 163 "project/radare2/libr/hash/md4.c" 3 4
__builtin___memcpy_chk (
# 163 "project/radare2/libr/hash/md4.c"
buf
# 163 "project/radare2/libr/hash/md4.c" 3 4
, 
# 163 "project/radare2/libr/hash/md4.c"
