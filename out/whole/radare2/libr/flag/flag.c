# 0 "project/radare2/libr/flag/flag.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/flag/flag.c"
...
# 4 "project/radare2/libr/flag/flag.c" 2




__attribute__((visibility("default"))) const char *
# 8 "project/radare2/libr/flag/flag.c"
r_flag_version
# 8 "project/radare2/libr/flag/flag.c" 3 4
(void) { return "" "5.5.4"; }
# 8 "project/radare2/libr/flag/flag.c"
                    ;
...
static const char *str_callback(RNum *user, 
# 14 "project/radare2/libr/flag/flag.c" 3 4
                                           unsigned long long 
# 14 "project/radare2/libr/flag/flag.c"
                                                off, int *ok) {
 RFlag *f = (RFlag*)user;
 if (ok) {
  *ok = 0;
 ...
 if (f) {
  ...
  if (item) {
   if (ok) {
    *ok = 
# 24 "project/radare2/libr/flag/flag.c" 3 4
         1
# 24 "project/radare2/libr/flag/flag.c"
             ;
   }
   return item->name;
  }
 ...
 return 
# 29 "project/radare2/libr/flag/flag.c" 3 4
       ((void *)0)
# 29 "project/radare2/libr/flag/flag.c"
           ;
}
...
static 
# 46 "project/radare2/libr/flag/flag.c" 3 4
      unsigned long long 
# 46 "project/radare2/libr/flag/flag.c"
           num_callback(RNum *user, const char *name, int *ok) {
 RFlag *f = (RFlag *)user;
 if (ok) {
  *ok = 0;
 }
 RFlagItem *item = ht_pp_find (f->ht_name, name, 
# 51 "project/radare2/libr/flag/flag.c" 3 4
                                                ((void *)0)
# 51 "project/radare2/libr/flag/flag.c"
                                                    );
 if (item) {
...
static RFlagsAtOffset *r_flag_get_nearest_list(RFlag *f, 
# 81 "project/radare2/libr/flag/flag.c" 3 4
                                                        unsigned long long 
# 81 "project/radare2/libr/flag/flag.c"
                                                             off, int dir) {
 RFlagsAtOffset key = { .off = off };
 RFlagsAtOffset *flags = (dir >= 0)
  ? r_skiplist_get_geq (f->by_off, &key)
  : r_skiplist_get_leq (f->by_off, &key);
 return (dir == 0 && flags && flags->off != off)? 
# 86 "project/radare2/libr/flag/flag.c" 3 4
                                                 ((void *)0)
# 86 "project/radare2/libr/flag/flag.c"
                                                     : flags;
}

static void remove_offsetmap(RFlag *f, RFlagItem *item) {
 
# 90 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 90 "project/radare2/libr/flag/flag.c"
f && item
# 90 "project/radare2/libr/flag/flag.c" 3 4
...
# 90 "project/radare2/libr/flag/flag.c"
 ...
 if (flags) {
  ...
  if (
# 94 "project/radare2/libr/flag/flag.c" 3 4
     (!(
# 94 "project/radare2/libr/flag/flag.c"
     flags->flags
# 94 "project/radare2/libr/flag/flag.c" 3 4
     ) || !(
# 94 "project/radare2/libr/flag/flag.c"
...
static RFlagsAtOffset *flags_at_offset(RFlag *f, 
# 100 "project/radare2/libr/flag/flag.c" 3 4
                                                unsigned long long 
# 100 "project/radare2/libr/flag/flag.c"
                                                     off) {
 if (f->mask) {
  off &= f->mask;
 }
 ...
 res = 
# 110 "project/radare2/libr/flag/flag.c" 3 4
      (
# 110 "project/radare2/libr/flag/flag.c"
      RFlagsAtOffset
# 110 "project/radare2/libr/flag/flag.c" 3 4
      *)malloc(sizeof(
# 110 "project/radare2/libr/flag/flag.c"
...
# 110 "project/radare2/libr/flag/flag.c"
 ...
 if (!res) {
  return 
# 112 "project/radare2/libr/flag/flag.c" 3 4
        ((void *)0)
# 112 "project/radare2/libr/flag/flag.c"
            ;
 }
 ...
 if (!res->flags) {
  free (res);
  return 
# 118 "project/radare2/libr/flag/flag.c" 3 4
        ((void *)0)
# 118 "project/radare2/libr/flag/flag.c"
            ;
 }
...
static char *filter_item_name(const char *name) {
 ...
 if (!res) {
  return 
# 129 "project/radare2/libr/flag/flag.c" 3 4
        ((void *)0)
# 129 "project/radare2/libr/flag/flag.c"
            ;
 }
...
static 
# 144 "project/radare2/libr/flag/flag.c" 3 4
      _Bool 
# 144 "project/radare2/libr/flag/flag.c"
           update_flag_item_offset(RFlag *f, RFlagItem *item, 
# 144 "project/radare2/libr/flag/flag.c" 3 4
                                                              unsigned long long 
# 144 "project/radare2/libr/flag/flag.c"
                                                                   newoff, 
...
# 144 "project/radare2/libr/flag/flag.c"
 ...
 if (item->offset != newoff || force) {
  ...
  if (!flagsAtOffset) {
   return 
# 153 "project/radare2/libr/flag/flag.c" 3 4
         0
# 153 "project/radare2/libr/flag/flag.c"
              ;
  }

  r_list_append (flagsAtOffset->flags, item);
  return 
# 157 "project/radare2/libr/flag/flag.c" 3 4
        1
# 157 "project/radare2/libr/flag/flag.c"
            ;
 }

 return 
# 160 "project/radare2/libr/flag/flag.c" 3 4
       0
# 160 "project/radare2/libr/flag/flag.c"
            ;
}

static 
# 163 "project/radare2/libr/flag/flag.c" 3 4
      _Bool 
# 163 "project/radare2/libr/flag/flag.c"
           update_flag_item_name(RFlag *f, RFlagItem *item, const char *newname, 
# 163 "project/radare2/libr/flag/flag.c" 3 4
                                                                                 _Bool 
# 163 "project/radare2/libr/flag/flag.c"
                                                                                      force) {
 if (!f || !item || !newname) {
  return 
# 165 "project/radare2/libr/flag/flag.c" 3 4
        0
# 165 "project/radare2/libr/flag/flag.c"
             ;
 }
 if (!force && (item->name == newname || (item->name && !strcmp (item->name, newname)))) {
  return 
# 168 "project/radare2/libr/flag/flag.c" 3 4
        0
# 168 "project/radare2/libr/flag/flag.c"
             ;
 }
 char *fname = filter_item_name (newname);
 if (!fname) {
  return 
# 172 "project/radare2/libr/flag/flag.c" 3 4
        0
# 172 "project/radare2/libr/flag/flag.c"
             ;
 }
 
# 174 "project/radare2/libr/flag/flag.c" 3 4
_Bool 
# 174 "project/radare2/libr/flag/flag.c"
     res = (item->name)
 ...
 if (res) {
  set_name (item, fname);
  return 
# 179 "project/radare2/libr/flag/flag.c" 3 4
        1
# 179 "project/radare2/libr/flag/flag.c"
            ;
 }
 free (fname);
 return 
# 182 "project/radare2/libr/flag/flag.c" 3 4
       0
# 182 "project/radare2/libr/flag/flag.c"
            ;
}
...
static 
# 190 "project/radare2/libr/flag/flag.c" 3 4
      _Bool 
# 190 "project/radare2/libr/flag/flag.c"
           count_flags(RFlagItem *fi, void *user) {
 int *count = (int *)user;
 (*count)++;
 return 
# 193 "project/radare2/libr/flag/flag.c" 3 4
       1
# 193 "project/radare2/libr/flag/flag.c"
           ;
}

static 
# 196 "project/radare2/libr/flag/flag.c" 3 4
      _Bool 
# 196 "project/radare2/libr/flag/flag.c"
           unset_flags_space(RFlagItem *fi, void *user) {
 fi->space = 
# 197 "project/radare2/libr/flag/flag.c" 3 4
            ((void *)0)
# 197 "project/radare2/libr/flag/flag.c"
                ;
 return 
# 198 "project/radare2/libr/flag/flag.c" 3 4
       1
# 198 "project/radare2/libr/flag/flag.c"
           ;
}
...
static void count_flags_in_space(REvent *ev, int type, void *user, void *data) {
 ...
 RFlag *f = 
# 203 "project/radare2/libr/flag/flag.c" 3 4
           ((
# 203 "project/radare2/libr/flag/flag.c"
           RFlag 
# 203 "project/radare2/libr/flag/flag.c" 3 4
           *)((char *)(__typeof__(((
# 203 "project/radare2/libr/flag/flag.c"
...
static void unset_flagspace(REvent *ev, int type, void *user, void *data) {
 RSpaces *sp = (RSpaces *)ev->user;
 RFlag *f = 
# 210 "project/radare2/libr/flag/flag.c" 3 4
           ((
# 210 "project/radare2/libr/flag/flag.c"
           RFlag 
# 210 "project/radare2/libr/flag/flag.c" 3 4
           *)((char *)(__typeof__(((
# 210 "project/radare2/libr/flag/flag.c"
...
# 210 "project/radare2/libr/flag/flag.c"
 ...
 r_flag_foreach_space (f, spe->data.unset.space, unset_flags_space, 
# 212 "project/radare2/libr/flag/flag.c" 3 4
                                                                   ((void *)0)
# 212 "project/radare2/libr/flag/flag.c"
                                                                       );
}
...
# 217 "project/radare2/libr/flag/flag.c" 3 4
                                                                          ((void *)0)
# 217 "project/radare2/libr/flag/flag.c"
                                                                              );
 r_event_hook (f->spaces.event, R_SPACE_EVENT_UNSET, unset_flagspace, 
# 218 "project/radare2/libr/flag/flag.c" 3 4
                                                                     ((void *)0)
# 218 "project/radare2/libr/flag/flag.c"
                                                                         );
}


# 221 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 221 "project/radare2/libr/flag/flag.c"
     RFlag *r_flag_new(void) {
 RFlag *f = 
# 222 "project/radare2/libr/flag/flag.c" 3 4
           (
# 222 "project/radare2/libr/flag/flag.c"
           RFlag
# 222 "project/radare2/libr/flag/flag.c" 3 4
           *)calloc(1,sizeof(
# 222 "project/radare2/libr/flag/flag.c"
...
# 222 "project/radare2/libr/flag/flag.c"
 ...
 if (!f) {
  return 
# 224 "project/radare2/libr/flag/flag.c" 3 4
        ((void *)0)
# 224 "project/radare2/libr/flag/flag.c"
            ;
 }
 ...
 if (!f->num) {
  r_flag_free (f);
  return 
# 229 "project/radare2/libr/flag/flag.c" 3 4
        ((void *)0)
# 229 "project/radare2/libr/flag/flag.c"
            ;
 }
 f->base = 0;
 ...
 f->tags = sdb_new0 ();
 f->ht_name = ht_pp_new (
# 235 "project/radare2/libr/flag/flag.c" 3 4
                        ((void *)0)
# 235 "project/radare2/libr/flag/flag.c"
                            , ht_free_flag, 
# 235 "project/radare2/libr/flag/flag.c" 3 4
                                            ((void *)0)
# 235 "project/radare2/libr/flag/flag.c"
...
# 241 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 241 "project/radare2/libr/flag/flag.c"
     RFlagItem *r_flag_item_clone(RFlagItem *item) {
 
# 242 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 242 "project/radare2/libr/flag/flag.c"
item
# 242 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 242 "project/radare2/libr/flag/flag.c"
"item"
# 242 "project/radare2/libr/flag/flag.c" 3 4
, 242); return (((void *)0)); } } while (0)
# 242 "project/radare2/libr/flag/flag.c"
                                 ;

 RFlagItem *n = 
# 244 "project/radare2/libr/flag/flag.c" 3 4
               (
# 244 "project/radare2/libr/flag/flag.c"
               RFlagItem
# 244 "project/radare2/libr/flag/flag.c" 3 4
               *)calloc(1,sizeof(
# 244 "project/radare2/libr/flag/flag.c"
...
# 244 "project/radare2/libr/flag/flag.c"
 ...
 if (!n) {
  return 
# 246 "project/radare2/libr/flag/flag.c" 3 4
        ((void *)0)
# 246 "project/radare2/libr/flag/flag.c"
            ;
 }
 n->color = (!
# 248 "project/radare2/libr/flag/flag.c" 3 4
           (!(
# 248 "project/radare2/libr/flag/flag.c"
           item->color
# 248 "project/radare2/libr/flag/flag.c" 3 4
           ) || !*(
# 248 "project/radare2/libr/flag/flag.c"
...
# 248 "project/radare2/libr/flag/flag.c"
 ...
 n->comment = (!
# 249 "project/radare2/libr/flag/flag.c" 3 4
             (!(
# 249 "project/radare2/libr/flag/flag.c"
             item->comment
# 249 "project/radare2/libr/flag/flag.c" 3 4
             ) || !*(
# 249 "project/radare2/libr/flag/flag.c"
...
# 249 "project/radare2/libr/flag/flag.c"
 ...
 n->alias = (!
# 250 "project/radare2/libr/flag/flag.c" 3 4
           (!(
# 250 "project/radare2/libr/flag/flag.c"
           item->alias
# 250 "project/radare2/libr/flag/flag.c" 3 4
           ) || !*(
# 250 "project/radare2/libr/flag/flag.c"
...
# 250 "project/radare2/libr/flag/flag.c"
 ...
 n->name = (!
# 251 "project/radare2/libr/flag/flag.c" 3 4
          (!(
# 251 "project/radare2/libr/flag/flag.c"
          item->name
# 251 "project/radare2/libr/flag/flag.c" 3 4
          ) || !*(
# 251 "project/radare2/libr/flag/flag.c"
...
# 251 "project/radare2/libr/flag/flag.c"
 ...
 n->realname = (!
# 252 "project/radare2/libr/flag/flag.c" 3 4
              (!(
# 252 "project/radare2/libr/flag/flag.c"
              item->realname
# 252 "project/radare2/libr/flag/flag.c" 3 4
              ) || !*(
# 252 "project/radare2/libr/flag/flag.c"
...
# 259 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 259 "project/radare2/libr/flag/flag.c"
     void r_flag_item_free(RFlagItem *item) {
 if (!item) {
  return;
 }
 free (item->color);
...
# 272 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 272 "project/radare2/libr/flag/flag.c"
     RFlag *r_flag_free(RFlag *f) {
 
# 273 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 273 "project/radare2/libr/flag/flag.c"
f
# 273 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 273 "project/radare2/libr/flag/flag.c"
...
# 273 "project/radare2/libr/flag/flag.c"
 ...
 free (f);
 return 
# 281 "project/radare2/libr/flag/flag.c" 3 4
       ((void *)0)
# 281 "project/radare2/libr/flag/flag.c"
           ;
}

static 
# 284 "project/radare2/libr/flag/flag.c" 3 4
      _Bool 
# 284 "project/radare2/libr/flag/flag.c"
           print_flag_name(RFlagItem *fi, void *user) {
 RFlag *flag = (RFlag *)user;
 flag->cb_printf ("%s\n", fi->name);
 return 
# 287 "project/radare2/libr/flag/flag.c" 3 4
       1
# 287 "project/radare2/libr/flag/flag.c"
           ;
}
...
# 293 "project/radare2/libr/flag/flag.c" 3 4
_Bool 
# 293 "project/radare2/libr/flag/flag.c"
     in_range;
 
# 294 "project/radare2/libr/flag/flag.c" 3 4
unsigned long long 
# 294 "project/radare2/libr/flag/flag.c"
     range_from;
 
# 295 "project/radare2/libr/flag/flag.c" 3 4
unsigned long long 
# 295 "project/radare2/libr/flag/flag.c"
     range_to;
 RSpace *fs;
 
# 297 "project/radare2/libr/flag/flag.c" 3 4
_Bool 
# 297 "project/radare2/libr/flag/flag.c"
     real;
 const char *pfx;
};

static 
# 301 "project/radare2/libr/flag/flag.c" 3 4
      _Bool 
# 301 "project/radare2/libr/flag/flag.c"
           print_flag_json(RFlagItem *flag, void *user) {
 struct print_flag_t *u = (struct print_flag_t *)user;
 if (u->in_range && (flag->offset < u->range_from || flag->offset >= u->range_to)) {
  return 
# 304 "project/radare2/libr/flag/flag.c" 3 4
        1
# 304 "project/radare2/libr/flag/flag.c"
            ;
 }
 pj_o (u->pj);
 ...
 pj_end (u->pj);
 return 
# 321 "project/radare2/libr/flag/flag.c" 3 4
       1
# 321 "project/radare2/libr/flag/flag.c"
           ;
}

static 
# 324 "project/radare2/libr/flag/flag.c" 3 4
      _Bool 
# 324 "project/radare2/libr/flag/flag.c"
           print_flag_rad(RFlagItem *flag, void *user) {
 struct print_flag_t *u = (struct print_flag_t *)user;
 char *comment_b64 = 
# 326 "project/radare2/libr/flag/flag.c" 3 4
                    ((void *)0)
# 326 "project/radare2/libr/flag/flag.c"
                        , *tmp = 
# 326 "project/radare2/libr/flag/flag.c" 3 4
                                 ((void *)0)
# 326 "project/radare2/libr/flag/flag.c"
 ...
 if (u->in_range && (flag->offset < u->range_from || flag->offset >= u->range_to)) {
  return 
# 328 "project/radare2/libr/flag/flag.c" 3 4
        1
# 328 "project/radare2/libr/flag/flag.c"
            ;
 }
 ...
 if (flag->alias) {
  ...
  u->f->cb_printf ("f %s %" 
# 350 "project/radare2/libr/flag/flag.c" 3 4
                           "lld" 
# 350 "project/radare2/libr/flag/flag.c"
                                   " 0x%08" 
# 350 "project/radare2/libr/flag/flag.c" 3 4
                                            "llx" 
# 350 "project/radare2/libr/flag/flag.c"
 ...
 free (comment_b64);
 return 
# 357 "project/radare2/libr/flag/flag.c" 3 4
       1
# 357 "project/radare2/libr/flag/flag.c"
           ;
}

static 
# 360 "project/radare2/libr/flag/flag.c" 3 4
      _Bool 
# 360 "project/radare2/libr/flag/flag.c"
           print_flag_orig_name(RFlagItem *flag, void *user) {
 struct print_flag_t *u = (struct print_flag_t *)user;
 if (u->in_range && (flag->offset < u->range_from || flag->offset >= u->range_to)) {
  return 
# 363 "project/radare2/libr/flag/flag.c" 3 4
        1
# 363 "project/radare2/libr/flag/flag.c"
            ;
 }
 if (flag->alias) {
  const char *n = u->real? flag->realname: flag->name;
  u->f->cb_printf ("%s %"
# 367 "project/radare2/libr/flag/flag.c" 3 4
                        "lld"
# 367 "project/radare2/libr/flag/flag.c"
                               " %s\n", flag->alias, flag->size, n);
 } else {
  const char *n = u->real? flag->realname: (u->f->realnames? flag->realname: flag->name);
  u->f->cb_printf ("0x%08" 
# 370 "project/radare2/libr/flag/flag.c" 3 4
                          "llx" 
# 370 "project/radare2/libr/flag/flag.c"
                                  " %" 
# 370 "project/radare2/libr/flag/flag.c" 3 4
                                       "lld" 
# 370 "project/radare2/libr/flag/flag.c"
 ...
 return 
# 372 "project/radare2/libr/flag/flag.c" 3 4
       1
# 372 "project/radare2/libr/flag/flag.c"
           ;
}



# 376 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 376 "project/radare2/libr/flag/flag.c"
     void r_flag_list(RFlag *f, int rad, const char *pfx) {
 
# 377 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 377 "project/radare2/libr/flag/flag.c"
f
# 377 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 377 "project/radare2/libr/flag/flag.c"
...
# 378 "project/radare2/libr/flag/flag.c" 3 4
_Bool 
# 378 "project/radare2/libr/flag/flag.c"
     in_range = 
# 378 "project/radare2/libr/flag/flag.c" 3 4
                0
# 378 "project/radare2/libr/flag/flag.c"
...
# 379 "project/radare2/libr/flag/flag.c" 3 4
unsigned long long 
# 379 "project/radare2/libr/flag/flag.c"
     range_from = 
# 379 "project/radare2/libr/flag/flag.c" 3 4
...
# 380 "project/radare2/libr/flag/flag.c" 3 4
unsigned long long 
# 380 "project/radare2/libr/flag/flag.c"
     range_to = 
# 380 "project/radare2/libr/flag/flag.c" 3 4
                0xFFFFFFFFFFFFFFFFULL
# 380 "project/radare2/libr/flag/flag.c"
 ...
 if (rad == 'i') {
  ...
  in_range = 
# 393 "project/radare2/libr/flag/flag.c" 3 4
            1
# 393 "project/radare2/libr/flag/flag.c"
                ;
  free (arg);
  rad = pfx[0];
  pfx = 
# 396 "project/radare2/libr/flag/flag.c" 3 4
       ((void *)0)
# 396 "project/radare2/libr/flag/flag.c"
           ;
 }

 if (pfx && !*pfx) {
  pfx = 
# 400 "project/radare2/libr/flag/flag.c" 3 4
       ((void *)0)
# 400 "project/radare2/libr/flag/flag.c"
           ;
 }
 ...
 case 'j': {
  ...
  struct print_flag_t u = {
   ...
   .range_to = range_to,
   .real = 
# 415 "project/radare2/libr/flag/flag.c" 3 4
          0
  
# 416 "project/radare2/libr/flag/flag.c"
 };
  pj_a (pj);
 ...
 case '*': {
  struct print_flag_t u = {
   ...
   .range_to = range_to,
   .fs = 
# 431 "project/radare2/libr/flag/flag.c" 3 4
        ((void *)0)
# 431 "project/radare2/libr/flag/flag.c"
            ,
   .pfx = pfx
  };
 ...
 case 'n': {
  if (!pfx || pfx[0] != 'j') {
   ...
   struct print_flag_t u = {
    ...
    .range_to = range_to,
    .real = 
# 456 "project/radare2/libr/flag/flag.c" 3 4
           1
   
# 457 "project/radare2/libr/flag/flag.c"
  };
   pj_a (pj);
   r_flag_foreach_space (f, r_flag_space_cur (f), print_flag_json, &u);
   pj_end (pj);
...
# 470 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 470 "project/radare2/libr/flag/flag.c"
f && item
# 470 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 470 "project/radare2/libr/flag/flag.c"
...
# 479 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 479 "project/radare2/libr/flag/flag.c"
          r_flag_exist_at(RFlag *f, const char *flag_prefix, 
# 479 "project/radare2/libr/flag/flag.c" 3 4
                                                             unsigned short 
# 479 "project/radare2/libr/flag/flag.c"
                                                                  fp_size, 
...
# 480 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 480 "project/radare2/libr/flag/flag.c"
f && flag_prefix
# 480 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 480 "project/radare2/libr/flag/flag.c"
"f && flag_prefix"
# 480 "project/radare2/libr/flag/flag.c" 3 4
, 480); return (0); } } while (0)
# 480 "project/radare2/libr/flag/flag.c"
                                              ;
 RListIter *iter = 
# 481 "project/radare2/libr/flag/flag.c" 3 4
                  ((void *)0)
# 481 "project/radare2/libr/flag/flag.c"
                      ;
 RFlagItem *item = 
# 482 "project/radare2/libr/flag/flag.c" 3 4
                  ((void *)0)
# 482 "project/radare2/libr/flag/flag.c"
                      ;
 if (f->mask) {
  off &= f->mask;
 }
...
# 488 "project/radare2/libr/flag/flag.c" 3 4
 if (
# 488 "project/radare2/libr/flag/flag.c"
 list
# 488 "project/radare2/libr/flag/flag.c" 3 4
 ) for (
# 488 "project/radare2/libr/flag/flag.c"
...
# 488 "project/radare2/libr/flag/flag.c"
   ...
   if (item->name && !strncmp (item->name, flag_prefix, fp_size)) {
    return 
# 490 "project/radare2/libr/flag/flag.c" 3 4
          1
# 490 "project/radare2/libr/flag/flag.c"
              ;
   }
  }
 }
 return 
# 494 "project/radare2/libr/flag/flag.c" 3 4
       0
# 494 "project/radare2/libr/flag/flag.c"
            ;
}
...
# 499 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 499 "project/radare2/libr/flag/flag.c"
     RFlagItem *r_flag_get(RFlag *f, const char *name) {
 
# 500 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 500 "project/radare2/libr/flag/flag.c"
f
# 500 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 500 "project/radare2/libr/flag/flag.c"
"f"
# 500 "project/radare2/libr/flag/flag.c" 3 4
, 500); return (((void *)0)); } } while (0)
# 500 "project/radare2/libr/flag/flag.c"
                              ;
 RFlagItem *r = ht_pp_find (f->ht_name, name, 
# 501 "project/radare2/libr/flag/flag.c" 3 4
                                             ((void *)0)
# 501 "project/radare2/libr/flag/flag.c"
                                                 );
 return r? evalFlag (f, r): 
# 502 "project/radare2/libr/flag/flag.c" 3 4
                           ((void *)0)
# 502 "project/radare2/libr/flag/flag.c"
                               ;
}



# 506 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 506 "project/radare2/libr/flag/flag.c"
     RFlagItem *r_flag_get_i(RFlag *f, 
# 506 "project/radare2/libr/flag/flag.c" 3 4
                                       unsigned long long 
# 506 "project/radare2/libr/flag/flag.c"
                                            off) {
 
# 507 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 507 "project/radare2/libr/flag/flag.c"
f
# 507 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 507 "project/radare2/libr/flag/flag.c"
...
# 507 "project/radare2/libr/flag/flag.c"
 ...
 const RList *list = r_flag_get_list (f, off);
 return list? evalFlag (f, r_list_get_top (list)): 
# 512 "project/radare2/libr/flag/flag.c" 3 4
                                                  ((void *)0)
# 512 "project/radare2/libr/flag/flag.c"
                                                      ;
}
...
# 518 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 518 "project/radare2/libr/flag/flag.c"
     RFlagItem *r_flag_get_by_spaces(RFlag *f, 
# 518 "project/radare2/libr/flag/flag.c" 3 4
                                               unsigned long long 
# 518 "project/radare2/libr/flag/flag.c"
                                                    off, ...) {
 
# 519 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 519 "project/radare2/libr/flag/flag.c"
f
# 519 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 519 "project/radare2/libr/flag/flag.c"
...
# 519 "project/radare2/libr/flag/flag.c"
 ...
 const RList *list = r_flag_get_list (f, off);
 RFlagItem *ret = 
# 525 "project/radare2/libr/flag/flag.c" 3 4
                 ((void *)0)
# 525 "project/radare2/libr/flag/flag.c"
                     ;
...
# 533 "project/radare2/libr/flag/flag.c" 3 4
__builtin_va_start(
# 533 "project/radare2/libr/flag/flag.c"
ap
# 533 "project/radare2/libr/flag/flag.c" 3 4
,
# 533 "project/radare2/libr/flag/flag.c"
...
# 533 "project/radare2/libr/flag/flag.c"
 ...
 if (
# 535 "project/radare2/libr/flag/flag.c" 3 4
    (!(
# 535 "project/radare2/libr/flag/flag.c"
    list
# 535 "project/radare2/libr/flag/flag.c" 3 4
    ) || !(
# 535 "project/radare2/libr/flag/flag.c"
...
# 544 "project/radare2/libr/flag/flag.c" 3 4
__builtin_va_copy(
# 544 "project/radare2/libr/flag/flag.c"
aq
# 544 "project/radare2/libr/flag/flag.c" 3 4
,
# 544 "project/radare2/libr/flag/flag.c"
...
# 544 "project/radare2/libr/flag/flag.c"
                ;
 spacename = 
# 545 "project/radare2/libr/flag/flag.c" 3 4
            __builtin_va_arg(
# 545 "project/radare2/libr/flag/flag.c"
            aq
# 545 "project/radare2/libr/flag/flag.c" 3 4
            ,
# 545 "project/radare2/libr/flag/flag.c"
...
# 545 "project/radare2/libr/flag/flag.c"
 ...
 while (spacename) {
  n_spaces++;
  spacename = 
# 548 "project/radare2/libr/flag/flag.c" 3 4
             __builtin_va_arg(
# 548 "project/radare2/libr/flag/flag.c"
             aq
# 548 "project/radare2/libr/flag/flag.c" 3 4
             ,
# 548 "project/radare2/libr/flag/flag.c"
...
# 550 "project/radare2/libr/flag/flag.c" 3 4
__builtin_va_end(
# 550 "project/radare2/libr/flag/flag.c"
aq
# 550 "project/radare2/libr/flag/flag.c" 3 4
)
# 550 "project/radare2/libr/flag/flag.c"
 ...
 i = 0;
 spaces = 
# 554 "project/radare2/libr/flag/flag.c" 3 4
         (
# 554 "project/radare2/libr/flag/flag.c"
         RSpace *
# 554 "project/radare2/libr/flag/flag.c" 3 4
         *)malloc(sizeof(
# 554 "project/radare2/libr/flag/flag.c"
...
# 554 "project/radare2/libr/flag/flag.c"
                                    ;
 spacename = 
# 555 "project/radare2/libr/flag/flag.c" 3 4
            __builtin_va_arg(
# 555 "project/radare2/libr/flag/flag.c"
            ap
# 555 "project/radare2/libr/flag/flag.c" 3 4
            ,
# 555 "project/radare2/libr/flag/flag.c"
...
# 555 "project/radare2/libr/flag/flag.c"
 ...
 while (spacename) {
  ...
  spacename = 
# 561 "project/radare2/libr/flag/flag.c" 3 4
             __builtin_va_arg(
# 561 "project/radare2/libr/flag/flag.c"
             ap
# 561 "project/radare2/libr/flag/flag.c" 3 4
             ,
# 561 "project/radare2/libr/flag/flag.c"
...
# 565 "project/radare2/libr/flag/flag.c" 3 4
unsigned long long 
# 565 "project/radare2/libr/flag/flag.c"
     min_space_i = n_spaces + 1;
 
# 566 "project/radare2/libr/flag/flag.c" 3 4
if (
# 566 "project/radare2/libr/flag/flag.c"
list
# 566 "project/radare2/libr/flag/flag.c" 3 4
) for (
# 566 "project/radare2/libr/flag/flag.c"
...
# 589 "project/radare2/libr/flag/flag.c" 3 4
__builtin_va_end(
# 589 "project/radare2/libr/flag/flag.c"
ap
# 589 "project/radare2/libr/flag/flag.c" 3 4
)
# 589 "project/radare2/libr/flag/flag.c"
           ;
 return ret? evalFlag (f, ret): 
# 590 "project/radare2/libr/flag/flag.c" 3 4
                               ((void *)0)
# 590 "project/radare2/libr/flag/flag.c"
                                   ;
}

static 
# 593 "project/radare2/libr/flag/flag.c" 3 4
      _Bool 
# 593 "project/radare2/libr/flag/flag.c"
           isFunctionFlag(const char *n) {
...
# 603 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 603 "project/radare2/libr/flag/flag.c"
     RFlagItem *r_flag_get_at(RFlag *f, 
# 603 "project/radare2/libr/flag/flag.c" 3 4
                                        unsigned long long 
# 603 "project/radare2/libr/flag/flag.c"
                                             off, 
...
# 604 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 604 "project/radare2/libr/flag/flag.c"
f
# 604 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 604 "project/radare2/libr/flag/flag.c"
...
# 604 "project/radare2/libr/flag/flag.c"
 ...
 RFlagItem *nice = 
# 609 "project/radare2/libr/flag/flag.c" 3 4
                  ((void *)0)
# 609 "project/radare2/libr/flag/flag.c"
                      ;
 RListIter *iter;
 const RFlagsAtOffset *flags_at = r_flag_get_nearest_list (f, off, -1);
 if (!flags_at) {
  return 
# 613 "project/radare2/libr/flag/flag.c" 3 4
        ((void *)0)
# 613 "project/radare2/libr/flag/flag.c"
            ;
 }
 if (flags_at->off == off) {
  RFlagItem *item;
  
# 617 "project/radare2/libr/flag/flag.c" 3 4
 if (
# 617 "project/radare2/libr/flag/flag.c"
 flags_at->flags
# 617 "project/radare2/libr/flag/flag.c" 3 4
 ) for (
# 617 "project/radare2/libr/flag/flag.c"
...
# 617 "project/radare2/libr/flag/flag.c"
                                              {
   if ((r_flag_space_cur (f) && (item)->space != r_flag_space_cur (f))) {
    continue;
   }
   if (nice) {
 ...
 if (!closest) {
  return 
# 635 "project/radare2/libr/flag/flag.c" 3 4
        ((void *)0)
# 635 "project/radare2/libr/flag/flag.c"
            ;
 }
 while (!nice && flags_at) {
  RFlagItem *item;
  
# 639 "project/radare2/libr/flag/flag.c" 3 4
 if (
# 639 "project/radare2/libr/flag/flag.c"
 flags_at->flags
# 639 "project/radare2/libr/flag/flag.c" 3 4
 ) for (
# 639 "project/radare2/libr/flag/flag.c"
...
# 644 "project/radare2/libr/flag/flag.c" 3 4
   fprintf(__stderrp,
# 644 "project/radare2/libr/flag/flag.c"
...
# 644 "project/radare2/libr/flag/flag.c"
  ...
  if (!nice && flags_at->off) {
   ...
   flags_at = 
# 653 "project/radare2/libr/flag/flag.c" 3 4
             ((void *)0)
# 653 "project/radare2/libr/flag/flag.c"
                 ;
  }
 }
 return nice? evalFlag (f, nice): 
# 656 "project/radare2/libr/flag/flag.c" 3 4
                                 ((void *)0)
# 656 "project/radare2/libr/flag/flag.c"
                                     ;
}

static 
# 659 "project/radare2/libr/flag/flag.c" 3 4
      _Bool 
# 659 "project/radare2/libr/flag/flag.c"
           append_to_list(RFlagItem *fi, void *user) {
 RList *ret = (RList *)user;
 r_list_append (ret, fi);
 return 
# 662 "project/radare2/libr/flag/flag.c" 3 4
       1
# 662 "project/radare2/libr/flag/flag.c"
           ;
}


# 665 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 665 "project/radare2/libr/flag/flag.c"
     RList *r_flag_all_list(RFlag *f, 
# 665 "project/radare2/libr/flag/flag.c" 3 4
                                      _Bool 
# 665 "project/radare2/libr/flag/flag.c"
                                           by_space) {
 ...
 if (!ret) {
  return 
# 668 "project/radare2/libr/flag/flag.c" 3 4
        ((void *)0)
# 668 "project/radare2/libr/flag/flag.c"
            ;
 }

 RSpace *cur = by_space? r_flag_space_cur (f): 
# 671 "project/radare2/libr/flag/flag.c" 3 4
                                              ((void *)0)
# 671 "project/radare2/libr/flag/flag.c"
                                                  ;
...
# 677 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 677 "project/radare2/libr/flag/flag.c"
     const RList* r_flag_get_list(RFlag *f, 
# 677 "project/radare2/libr/flag/flag.c" 3 4
                                                             unsigned long long 
# 677 "project/radare2/libr/flag/flag.c"
                                                                  off) {
...
# 682 "project/radare2/libr/flag/flag.c" 3 4
                            ((void *)0)
# 682 "project/radare2/libr/flag/flag.c"
                                ;
}


# 685 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 685 "project/radare2/libr/flag/flag.c"
     char *r_flag_get_liststr(RFlag *f, 
# 685 "project/radare2/libr/flag/flag.c" 3 4
                                        unsigned long long 
# 685 "project/radare2/libr/flag/flag.c"
                                             off) {
 ...
 const RList *list = r_flag_get_list (f, off);
 char *p = 
# 692 "project/radare2/libr/flag/flag.c" 3 4
          ((void *)0)
# 692 "project/radare2/libr/flag/flag.c"
              ;
 
# 693 "project/radare2/libr/flag/flag.c" 3 4
if (
# 693 "project/radare2/libr/flag/flag.c"
list
# 693 "project/radare2/libr/flag/flag.c" 3 4
) for (
# 693 "project/radare2/libr/flag/flag.c"
...
# 702 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 702 "project/radare2/libr/flag/flag.c"
     RFlagItem *r_flag_set_next(RFlag *f, const char *name, 
# 702 "project/radare2/libr/flag/flag.c" 3 4
                                                            unsigned long long 
# 702 "project/radare2/libr/flag/flag.c"
                                                                 off, 
...
# 703 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 703 "project/radare2/libr/flag/flag.c"
f && name
# 703 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 703 "project/radare2/libr/flag/flag.c"
...
# 703 "project/radare2/libr/flag/flag.c"
 ...
 if (!newName) {
  return 
# 713 "project/radare2/libr/flag/flag.c" 3 4
        ((void *)0)
# 713 "project/radare2/libr/flag/flag.c"
            ;
 }
 
# 715 "project/radare2/libr/flag/flag.c" 3 4
__builtin___strcpy_chk (
# 715 "project/radare2/libr/flag/flag.c"
newName
# 715 "project/radare2/libr/flag/flag.c" 3 4
, 
# 715 "project/radare2/libr/flag/flag.c"
...
# 717 "project/radare2/libr/flag/flag.c" 3 4
 __builtin___snprintf_chk (
# 717 "project/radare2/libr/flag/flag.c"
 newName + newNameSize
# 717 "project/radare2/libr/flag/flag.c" 3 4
 , 
# 717 "project/radare2/libr/flag/flag.c"
...
# 717 "project/radare2/libr/flag/flag.c"
 ...
 return 
# 726 "project/radare2/libr/flag/flag.c" 3 4
       ((void *)0)
# 726 "project/radare2/libr/flag/flag.c"
           ;
}


# 729 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 729 "project/radare2/libr/flag/flag.c"
     RFlagItem *r_flag_set_inspace(RFlag *f, const char *space, const char *name, 
# 729 "project/radare2/libr/flag/flag.c" 3 4
                                                                                  unsigned long long 
# 729 "project/radare2/libr/flag/flag.c"
                                                                                       off, 
...
# 743 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 743 "project/radare2/libr/flag/flag.c"
     RFlagItem *r_flag_set(RFlag *f, const char *name, 
# 743 "project/radare2/libr/flag/flag.c" 3 4
                                                       unsigned long long 
# 743 "project/radare2/libr/flag/flag.c"
                                                            off, 
...
# 744 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 744 "project/radare2/libr/flag/flag.c"
f && name && *name
# 744 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 744 "project/radare2/libr/flag/flag.c"
...
# 749 "project/radare2/libr/flag/flag.c" 3 4
_Bool 
# 749 "project/radare2/libr/flag/flag.c"
     is_new = 
# 749 "project/radare2/libr/flag/flag.c" 3 4
              0
# 749 "project/radare2/libr/flag/flag.c"
 ...
 if (!itemname) {
  return 
# 752 "project/radare2/libr/flag/flag.c" 3 4
        ((void *)0)
# 752 "project/radare2/libr/flag/flag.c"
            ;
 }

 if (!r_name_check (itemname)) {
  
# 756 "project/radare2/libr/flag/flag.c" 3 4
 fprintf(__stderrp,
# 756 "project/radare2/libr/flag/flag.c"
 "Invalid flag name '%s'\n", name
# 756 "project/radare2/libr/flag/flag.c" 3 4
 )
# 756 "project/radare2/libr/flag/flag.c"
                                           ;
  return 
# 757 "project/radare2/libr/flag/flag.c" 3 4
        ((void *)0)
# 757 "project/radare2/libr/flag/flag.c"
            ;
 }
 ...
 if (!item) {
  item = 
# 768 "project/radare2/libr/flag/flag.c" 3 4
        (
# 768 "project/radare2/libr/flag/flag.c"
        RFlagItem
# 768 "project/radare2/libr/flag/flag.c" 3 4
        *)calloc(1,sizeof(
# 768 "project/radare2/libr/flag/flag.c"
...
# 768 "project/radare2/libr/flag/flag.c"
  ...
  is_new = 
# 772 "project/radare2/libr/flag/flag.c" 3 4
          1
# 772 "project/radare2/libr/flag/flag.c"
              ;
 }
 ...
 update_flag_item_offset (f, item, off + f->base, is_new, 
# 778 "project/radare2/libr/flag/flag.c" 3 4
                                                         1
# 778 "project/radare2/libr/flag/flag.c"
                                                             );
 update_flag_item_name (f, item, name, 
# 779 "project/radare2/libr/flag/flag.c" 3 4
                                      1
# 779 "project/radare2/libr/flag/flag.c"
                                          );
 return item;
err:
 r_flag_item_free (item);
 return 
# 783 "project/radare2/libr/flag/flag.c" 3 4
       ((void *)0)
# 783 "project/radare2/libr/flag/flag.c"
           ;
}



# 787 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 787 "project/radare2/libr/flag/flag.c"
     void r_flag_item_set_alias(RFlagItem *item, const char *alias) {
 
# 788 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 788 "project/radare2/libr/flag/flag.c"
item
# 788 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 788 "project/radare2/libr/flag/flag.c"
...
# 788 "project/radare2/libr/flag/flag.c"
 ...
 free (item->alias);
 item->alias = 
# 790 "project/radare2/libr/flag/flag.c" 3 4
              (!(
# 790 "project/radare2/libr/flag/flag.c"
              alias
# 790 "project/radare2/libr/flag/flag.c" 3 4
              ) || !*(
# 790 "project/radare2/libr/flag/flag.c"
...
# 794 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 794 "project/radare2/libr/flag/flag.c"
     void r_flag_item_set_comment(RFlagItem *item, const char *comment) {
 
# 795 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 795 "project/radare2/libr/flag/flag.c"
item
# 795 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 795 "project/radare2/libr/flag/flag.c"
...
# 795 "project/radare2/libr/flag/flag.c"
 ...
 free (item->comment);
 item->comment = 
# 797 "project/radare2/libr/flag/flag.c" 3 4
                (!(
# 797 "project/radare2/libr/flag/flag.c"
                comment
# 797 "project/radare2/libr/flag/flag.c" 3 4
                ) || !*(
# 797 "project/radare2/libr/flag/flag.c"
...
# 801 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 801 "project/radare2/libr/flag/flag.c"
     void r_flag_item_set_realname(RFlagItem *item, const char *realname) {
 
# 802 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 802 "project/radare2/libr/flag/flag.c"
item
# 802 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 802 "project/radare2/libr/flag/flag.c"
...
# 802 "project/radare2/libr/flag/flag.c"
 ...
 free_item_realname (item);
 item->realname = 
# 804 "project/radare2/libr/flag/flag.c" 3 4
                 (!(
# 804 "project/radare2/libr/flag/flag.c"
                 realname
# 804 "project/radare2/libr/flag/flag.c" 3 4
                 ) || !*(
# 804 "project/radare2/libr/flag/flag.c"
...
# 808 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 808 "project/radare2/libr/flag/flag.c"
     const char *r_flag_item_set_color(RFlagItem *item, const char *color) {
 
# 809 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 809 "project/radare2/libr/flag/flag.c"
item
# 809 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 809 "project/radare2/libr/flag/flag.c"
"item"
# 809 "project/radare2/libr/flag/flag.c" 3 4
, 809); return (((void *)0)); } } while (0)
# 809 "project/radare2/libr/flag/flag.c"
                                 ;
 free (item->color);
 item->color = (color && *color) ? strdup (color) : 
# 811 "project/radare2/libr/flag/flag.c" 3 4
                                                   ((void *)0)
# 811 "project/radare2/libr/flag/flag.c"
                                                       ;
 return item->color;
}
...
# 817 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 817 "project/radare2/libr/flag/flag.c"
     int r_flag_rename(RFlag *f, RFlagItem *item, const char *name) {
 
# 818 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 818 "project/radare2/libr/flag/flag.c"
f && item && name && *name
# 818 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 818 "project/radare2/libr/flag/flag.c"
"f && item && name && *name"
# 818 "project/radare2/libr/flag/flag.c" 3 4
, 818); return (0); } } while (0)
# 818 "project/radare2/libr/flag/flag.c"
                                                        ;
 return update_flag_item_name (f, item, name, 
# 819 "project/radare2/libr/flag/flag.c" 3 4
                                             0
# 819 "project/radare2/libr/flag/flag.c"
                                                  );
}


# 822 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 822 "project/radare2/libr/flag/flag.c"
     void r_flag_item_set_type(RFlagItem *fi, const char *type) {
 
# 823 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 823 "project/radare2/libr/flag/flag.c"
fi && type
# 823 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 823 "project/radare2/libr/flag/flag.c"
...
# 832 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 832 "project/radare2/libr/flag/flag.c"
          r_flag_unset(RFlag *f, RFlagItem *item) {
 
# 833 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 833 "project/radare2/libr/flag/flag.c"
f && item
# 833 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 833 "project/radare2/libr/flag/flag.c"
"f && item"
# 833 "project/radare2/libr/flag/flag.c" 3 4
, 833); return (0); } } while (0)
# 833 "project/radare2/libr/flag/flag.c"
                                       ;
 remove_offsetmap (f, item);
 ht_pp_delete (f->ht_name, item->name);
 return 
# 836 "project/radare2/libr/flag/flag.c" 3 4
       1
# 836 "project/radare2/libr/flag/flag.c"
           ;
}
...
# 841 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 841 "project/radare2/libr/flag/flag.c"
          r_flag_unset_off(RFlag *f, 
# 841 "project/radare2/libr/flag/flag.c" 3 4
                                     unsigned long long 
# 841 "project/radare2/libr/flag/flag.c"
                                          off) {
 
# 842 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 842 "project/radare2/libr/flag/flag.c"
f
# 842 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 842 "project/radare2/libr/flag/flag.c"
"f"
# 842 "project/radare2/libr/flag/flag.c" 3 4
, 842); return (0); } } while (0)
# 842 "project/radare2/libr/flag/flag.c"
                               ;
 RFlagItem *item = r_flag_get_i (f, off);
 if (item && r_flag_unset (f, item)) {
  return 
# 845 "project/radare2/libr/flag/flag.c" 3 4
        1
# 845 "project/radare2/libr/flag/flag.c"
            ;
 }
 return 
# 847 "project/radare2/libr/flag/flag.c" 3 4
       0
# 847 "project/radare2/libr/flag/flag.c"
            ;
}
...
static 
# 855 "project/radare2/libr/flag/flag.c" 3 4
      _Bool 
# 855 "project/radare2/libr/flag/flag.c"
           unset_foreach(RFlagItem *fi, void *user) {
 struct unset_foreach_t *u = (struct unset_foreach_t *)user;
 if ((r_flag_space_cur (u->f) && (fi)->space != r_flag_space_cur (u->f))) {
  return 
# 858 "project/radare2/libr/flag/flag.c" 3 4
        1
# 858 "project/radare2/libr/flag/flag.c"
            ;
 }
 r_flag_unset (u->f, fi);
 u->n++;
 return 
# 862 "project/radare2/libr/flag/flag.c" 3 4
       1
# 862 "project/radare2/libr/flag/flag.c"
           ;
}
...
# 868 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 868 "project/radare2/libr/flag/flag.c"
     int r_flag_unset_glob(RFlag *f, const char *glob) {
 
# 869 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 869 "project/radare2/libr/flag/flag.c"
f
# 869 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 869 "project/radare2/libr/flag/flag.c"
...
# 878 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 878 "project/radare2/libr/flag/flag.c"
          r_flag_unset_name(RFlag *f, const char *name) {
 
# 879 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 879 "project/radare2/libr/flag/flag.c"
f
# 879 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 879 "project/radare2/libr/flag/flag.c"
"f"
# 879 "project/radare2/libr/flag/flag.c" 3 4
, 879); return (0); } } while (0)
# 879 "project/radare2/libr/flag/flag.c"
                               ;
 RFlagItem *item = ht_pp_find (f->ht_name, name, 
# 880 "project/radare2/libr/flag/flag.c" 3 4
                                                ((void *)0)
# 880 "project/radare2/libr/flag/flag.c"
                                                    );
...
# 885 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 885 "project/radare2/libr/flag/flag.c"
     void r_flag_unset_all(RFlag *f) {
 
# 886 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 886 "project/radare2/libr/flag/flag.c"
f
# 886 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 886 "project/radare2/libr/flag/flag.c"
...
# 886 "project/radare2/libr/flag/flag.c"
 ...
 ht_pp_free (f->ht_name);
 f->ht_name = ht_pp_new (
# 888 "project/radare2/libr/flag/flag.c" 3 4
                        ((void *)0)
# 888 "project/radare2/libr/flag/flag.c"
                            , ht_free_flag, 
# 888 "project/radare2/libr/flag/flag.c" 3 4
                                            ((void *)0)
# 888 "project/radare2/libr/flag/flag.c"
...
# 896 "project/radare2/libr/flag/flag.c" 3 4
unsigned long long 
# 896 "project/radare2/libr/flag/flag.c"
     off;
 
# 897 "project/radare2/libr/flag/flag.c" 3 4
unsigned long long 
# 897 "project/radare2/libr/flag/flag.c"
     off_mask;
 
# 898 "project/radare2/libr/flag/flag.c" 3 4
unsigned long long 
# 898 "project/radare2/libr/flag/flag.c"
     neg_mask;
 
# 899 "project/radare2/libr/flag/flag.c" 3 4
unsigned long long 
# 899 "project/radare2/libr/flag/flag.c"
     to;
 int n;
};

static 
# 903 "project/radare2/libr/flag/flag.c" 3 4
      _Bool 
# 903 "project/radare2/libr/flag/flag.c"
           flag_relocate_foreach(RFlagItem *fi, void *user) {
 struct flag_relocate_t *u = (struct flag_relocate_t *)user;
 
# 905 "project/radare2/libr/flag/flag.c" 3 4
unsigned long long 
# 905 "project/radare2/libr/flag/flag.c"
     fn = fi->offset & u->neg_mask;
 
# 906 "project/radare2/libr/flag/flag.c" 3 4
unsigned long long 
# 906 "project/radare2/libr/flag/flag.c"
     on = u->off & u->neg_mask;
 if (fn == on) {
  
# 908 "project/radare2/libr/flag/flag.c" 3 4
 unsigned long long 
# 908 "project/radare2/libr/flag/flag.c"
      fm = fi->offset & u->off_mask;
  
# 909 "project/radare2/libr/flag/flag.c" 3 4
 unsigned long long 
# 909 "project/radare2/libr/flag/flag.c"
      om = u->to & u->off_mask;
  update_flag_item_offset (u->f, fi, (u->to & u->neg_mask) + fm + om, 
# 910 "project/radare2/libr/flag/flag.c" 3 4
                                                                     0
# 910 "project/radare2/libr/flag/flag.c"
                                                                          , 
# 910 "project/radare2/libr/flag/flag.c" 3 4
                                                                            0
# 910 "project/radare2/libr/flag/flag.c"
 ...
 return 
# 913 "project/radare2/libr/flag/flag.c" 3 4
       1
# 913 "project/radare2/libr/flag/flag.c"
           ;
}


# 916 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 916 "project/radare2/libr/flag/flag.c"
     int r_flag_relocate(RFlag *f, 
# 916 "project/radare2/libr/flag/flag.c" 3 4
                                   unsigned long long 
# 916 "project/radare2/libr/flag/flag.c"
                                        off, 
...
# 917 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 917 "project/radare2/libr/flag/flag.c"
f
# 917 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 917 "project/radare2/libr/flag/flag.c"
...
# 931 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 931 "project/radare2/libr/flag/flag.c"
          r_flag_move(RFlag *f, 
# 931 "project/radare2/libr/flag/flag.c" 3 4
                                unsigned long long 
# 931 "project/radare2/libr/flag/flag.c"
...
# 932 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 932 "project/radare2/libr/flag/flag.c"
f
# 932 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 932 "project/radare2/libr/flag/flag.c"
...
# 932 "project/radare2/libr/flag/flag.c"
 ...
 if (item) {
  ...
  return 
# 936 "project/radare2/libr/flag/flag.c" 3 4
        1
# 936 "project/radare2/libr/flag/flag.c"
            ;
 }
 return 
# 938 "project/radare2/libr/flag/flag.c" 3 4
       0
# 938 "project/radare2/libr/flag/flag.c"
            ;
}



# 942 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 942 "project/radare2/libr/flag/flag.c"
     void r_flag_bind(RFlag *f, RFlagBind *fb) {
 
# 943 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 943 "project/radare2/libr/flag/flag.c"
f && fb
# 943 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 943 "project/radare2/libr/flag/flag.c"
...
static 
# 958 "project/radare2/libr/flag/flag.c" 3 4
      _Bool 
# 958 "project/radare2/libr/flag/flag.c"
           flag_count_foreach(RFlagItem *fi, void *user) {
 int *count = (int *)user;
 (*count)++;
 return 
# 961 "project/radare2/libr/flag/flag.c" 3 4
       1
# 961 "project/radare2/libr/flag/flag.c"
           ;
}


# 964 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 964 "project/radare2/libr/flag/flag.c"
     int r_flag_count(RFlag *f, const char *glob) {
 int count = 0;
 
# 966 "project/radare2/libr/flag/flag.c" 3 4
do { if (!(
# 966 "project/radare2/libr/flag/flag.c"
f
# 966 "project/radare2/libr/flag/flag.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 966 "project/radare2/libr/flag/flag.c"
...
#define FOREACH_BODY(condition) RSkipListNode *it, *tmp; RFlagsAtOffset *flags_at; RListIter *it2, *tmp2; RFlagItem *fi; r_skiplist_foreach_safe (f->by_off, it, tmp, flags_at) { if (flags_at) { r_list_foreach_safe (flags_at->flags, it2, tmp2, fi) { if (condition) { if (!cb (fi, user)) { return; } } } } }
# 988 "project/radare2/libr/flag/flag.c"

# 988 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 988 "project/radare2/libr/flag/flag.c"
     void r_flag_foreach(RFlag *f, RFlagItemCb cb, void *user) {
 RSkipListNode *it, *tmp; RFlagsAtOffset *flags_at; RListIter *it2, *tmp2; RFlagItem *fi; 
# 989 "project/radare2/libr/flag/flag.c" 3 4
if (
# 989 "project/radare2/libr/flag/flag.c"
f->by_off
# 989 "project/radare2/libr/flag/flag.c" 3 4
) for (
# 989 "project/radare2/libr/flag/flag.c"
...
1
# 989 "project/radare2/libr/flag/flag.c"
) { if (!cb (fi, user)) { return; } } } } };
}


# 992 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 992 "project/radare2/libr/flag/flag.c"
     void r_flag_foreach_prefix(RFlag *f, const char *pfx, int pfx_len, RFlagItemCb cb, void *user) {
 pfx_len = pfx_len < 0? strlen (pfx): pfx_len;
 RSkipListNode *it, *tmp; RFlagsAtOffset *flags_at; RListIter *it2, *tmp2; RFlagItem *fi; 
# 994 "project/radare2/libr/flag/flag.c" 3 4
if (
# 994 "project/radare2/libr/flag/flag.c"
f->by_off
# 994 "project/radare2/libr/flag/flag.c" 3 4
) for (
# 994 "project/radare2/libr/flag/flag.c"
...
# 994 "project/radare2/libr/flag/flag.c"
{ if (!strncmp (fi->name, pfx, pfx_len)) { if (!cb (fi, user)) { return; } } } } };
}


# 997 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 997 "project/radare2/libr/flag/flag.c"
     void r_flag_foreach_range(RFlag *f, 
# 997 "project/radare2/libr/flag/flag.c" 3 4
                                         unsigned long long 
# 997 "project/radare2/libr/flag/flag.c"
                                              from, 
# 997 "project/radare2/libr/flag/flag.c" 3 4
                                                    unsigned long long 
# 997 "project/radare2/libr/flag/flag.c"
                                                         to, RFlagItemCb cb, void *user) {
 RSkipListNode *it, *tmp; RFlagsAtOffset *flags_at; RListIter *it2, *tmp2; RFlagItem *fi; 
# 998 "project/radare2/libr/flag/flag.c" 3 4
if (
# 998 "project/radare2/libr/flag/flag.c"
f->by_off
# 998 "project/radare2/libr/flag/flag.c" 3 4
) for (
# 998 "project/radare2/libr/flag/flag.c"
...
# 998 "project/radare2/libr/flag/flag.c"
{ if (fi->offset >= from && fi->offset < to) { if (!cb (fi, user)) { return; } } } } };
}


# 1001 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 1001 "project/radare2/libr/flag/flag.c"
     void r_flag_foreach_glob(RFlag *f, const char *glob, RFlagItemCb cb, void *user) {
 RSkipListNode *it, *tmp; RFlagsAtOffset *flags_at; RListIter *it2, *tmp2; RFlagItem *fi; 
# 1002 "project/radare2/libr/flag/flag.c" 3 4
if (
# 1002 "project/radare2/libr/flag/flag.c"
f->by_off
# 1002 "project/radare2/libr/flag/flag.c" 3 4
) for (
# 1002 "project/radare2/libr/flag/flag.c"
...
# 1002 "project/radare2/libr/flag/flag.c"
{ if (!glob || r_str_glob (fi->name, glob)) { if (!cb (fi, user)) { return; } } } } };
}


# 1005 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 1005 "project/radare2/libr/flag/flag.c"
     void r_flag_foreach_space_glob(RFlag *f, const char *glob, const RSpace *space, RFlagItemCb cb, void *user) {
 RSkipListNode *it, *tmp; RFlagsAtOffset *flags_at; RListIter *it2, *tmp2; RFlagItem *fi; 
# 1006 "project/radare2/libr/flag/flag.c" 3 4
if (
# 1006 "project/radare2/libr/flag/flag.c"
f->by_off
# 1006 "project/radare2/libr/flag/flag.c" 3 4
) for (
# 1006 "project/radare2/libr/flag/flag.c"
...
# 1006 "project/radare2/libr/flag/flag.c"
{ if ((!(space) || (fi)->space == (space)) && (!glob || r_str_glob (fi->name, glob))) { if (!cb (fi, user)) { return; } } } } };
}


# 1009 "project/radare2/libr/flag/flag.c" 3 4
__attribute__((visibility("default"))) 
# 1009 "project/radare2/libr/flag/flag.c"
     void r_flag_foreach_space(RFlag *f, const RSpace *space, RFlagItemCb cb, void *user) {
 RSkipListNode *it, *tmp; RFlagsAtOffset *flags_at; RListIter *it2, *tmp2; RFlagItem *fi; 
# 1010 "project/radare2/libr/flag/flag.c" 3 4
if (
# 1010 "project/radare2/libr/flag/flag.c"
f->by_off
# 1010 "project/radare2/libr/flag/flag.c" 3 4
) for (
# 1010 "project/radare2/libr/flag/flag.c"
...
# 1010 "project/radare2/libr/flag/flag.c"
{ if ((!(space) || (fi)->space == (space))) { if (!cb (fi, user)) { return; } } } } };
}
