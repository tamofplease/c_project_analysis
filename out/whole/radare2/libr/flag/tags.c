# 0 "project/radare2/libr/flag/tags.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/flag/tags.c" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/flag/tags.c"
     RList *r_flag_tags_set(RFlag *f, const char *name, const char *words) {
 
# 6 "project/radare2/libr/flag/tags.c" 3 4
do { if (!(
# 6 "project/radare2/libr/flag/tags.c"
f && name && words
# 6 "project/radare2/libr/flag/tags.c" 3 4
...
# 6 "project/radare2/libr/flag/tags.c"
 ...
 return 
# 9 "project/radare2/libr/flag/tags.c" 3 4
       ((void *)0)
# 9 "project/radare2/libr/flag/tags.c"
           ;
}


# 12 "project/radare2/libr/flag/tags.c" 3 4
__attribute__((visibility("default"))) 
# 12 "project/radare2/libr/flag/tags.c"
     RList *r_flag_tags_list(RFlag *f, const char *name) {
 
# 13 "project/radare2/libr/flag/tags.c" 3 4
do { if (!(
# 13 "project/radare2/libr/flag/tags.c"
f
# 13 "project/radare2/libr/flag/tags.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 13 "project/radare2/libr/flag/tags.c"
"f"
# 13 "project/radare2/libr/flag/tags.c" 3 4
, 13); return (((void *)0)); } } while (0)
# 13 "project/radare2/libr/flag/tags.c"
                              ;
 if (name) {
  const char *k = sdb_fmt ("tag.%s", name);
  char *words = sdb_get (f->tags, k, 
# 16 "project/radare2/libr/flag/tags.c" 3 4
                                    ((void *)0)
# 16 "project/radare2/libr/flag/tags.c"
                                        );
  return r_str_split_list (words, " ", 0);
 }
 RList *res = r_list_newf (free);
 SdbList *o = sdb_foreach_list (f->tags, 
# 20 "project/radare2/libr/flag/tags.c" 3 4
                                        0
# 20 "project/radare2/libr/flag/tags.c"
                                             );
 SdbListIter *iter;
 SdbKv *kv;
 
# 23 "project/radare2/libr/flag/tags.c" 3 4
if ((
# 23 "project/radare2/libr/flag/tags.c"
o
# 23 "project/radare2/libr/flag/tags.c" 3 4
)) for (
# 23 "project/radare2/libr/flag/tags.c"
...
# 34 "project/radare2/libr/flag/tags.c" 3 4
__attribute__((visibility("default"))) 
# 34 "project/radare2/libr/flag/tags.c"
     void r_flag_tags_reset(RFlag *f, const char *name) {

 
# 36 "project/radare2/libr/flag/tags.c" 3 4
do { if (!(
# 36 "project/radare2/libr/flag/tags.c"
f
# 36 "project/radare2/libr/flag/tags.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 36 "project/radare2/libr/flag/tags.c"
...
static 
# 45 "project/radare2/libr/flag/tags.c" 3 4
      _Bool 
# 45 "project/radare2/libr/flag/tags.c"
           iter_glob_flag(RFlagItem *fi, void *user) {
 struct iter_glob_flag_t *u = (struct iter_glob_flag_t *)user;
 RListIter *iter;
 const char *word;

 
# 50 "project/radare2/libr/flag/tags.c" 3 4
if (
# 50 "project/radare2/libr/flag/tags.c"
u->words
# 50 "project/radare2/libr/flag/tags.c" 3 4
) for (
# 50 "project/radare2/libr/flag/tags.c"
...
# 50 "project/radare2/libr/flag/tags.c"
 ...
 return 
# 55 "project/radare2/libr/flag/tags.c" 3 4
       1
# 55 "project/radare2/libr/flag/tags.c"
           ;
}


# 58 "project/radare2/libr/flag/tags.c" 3 4
__attribute__((visibility("default"))) 
# 58 "project/radare2/libr/flag/tags.c"
     RList *r_flag_tags_get(RFlag *f, const char *name) {
 
# 59 "project/radare2/libr/flag/tags.c" 3 4
do { if (!(
# 59 "project/radare2/libr/flag/tags.c"
f && name
# 59 "project/radare2/libr/flag/tags.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 59 "project/radare2/libr/flag/tags.c"
...
# 59 "project/radare2/libr/flag/tags.c"
                                      ;
 const char *k = sdb_fmt ("tag.%s", name);
 RList *res = r_list_newf (
# 61 "project/radare2/libr/flag/tags.c" 3 4
                          ((void *)0)
# 61 "project/radare2/libr/flag/tags.c"
                              );
 char *words = sdb_get (f->tags, k, 
# 62 "project/radare2/libr/flag/tags.c" 3 4
                                   ((void *)0)
# 62 "project/radare2/libr/flag/tags.c"
                                       );
 if (words) {
