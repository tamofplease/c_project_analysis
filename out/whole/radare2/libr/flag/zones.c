# 0 "project/radare2/libr/flag/zones.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/flag/zones.c"
...
# 4 "project/radare2/libr/flag/zones.c" 2


#define DB f->zones


# 8 "project/radare2/libr/flag/zones.c"
static RFlagZoneItem *r_flag_zone_get (RFlag *f, const char *name) {
 RListIter *iter;
 RFlagZoneItem *zi;
 
# 11 "project/radare2/libr/flag/zones.c" 3 4
if (
# 11 "project/radare2/libr/flag/zones.c"
f->zones
# 11 "project/radare2/libr/flag/zones.c" 3 4
) for (
# 11 "project/radare2/libr/flag/zones.c"
...
# 11 "project/radare2/libr/flag/zones.c"
 ...
 return 
# 16 "project/radare2/libr/flag/zones.c" 3 4
       ((void *)0)
# 16 "project/radare2/libr/flag/zones.c"
           ;
}

static RFlagZoneItem *r_flag_zone_get_inrange (RFlag *f, 
# 19 "project/radare2/libr/flag/zones.c" 3 4
                                                        unsigned long long 
# 19 "project/radare2/libr/flag/zones.c"
                                                             from, 
# 19 "project/radare2/libr/flag/zones.c" 3 4
                                                                   unsigned long long 
# 19 "project/radare2/libr/flag/zones.c"
...
# 22 "project/radare2/libr/flag/zones.c" 3 4
if (
# 22 "project/radare2/libr/flag/zones.c"
f->zones
# 22 "project/radare2/libr/flag/zones.c" 3 4
) for (
# 22 "project/radare2/libr/flag/zones.c"
...
# 22 "project/radare2/libr/flag/zones.c"
                              {
  if (
# 23 "project/radare2/libr/flag/zones.c" 3 4
     (((
# 23 "project/radare2/libr/flag/zones.c"
     zi->from
# 23 "project/radare2/libr/flag/zones.c" 3 4
     )>=(
# 23 "project/radare2/libr/flag/zones.c"
...
# 23 "project/radare2/libr/flag/zones.c"
 ...
 return 
# 27 "project/radare2/libr/flag/zones.c" 3 4
       ((void *)0)
# 27 "project/radare2/libr/flag/zones.c"
           ;
}


# 30 "project/radare2/libr/flag/zones.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 30 "project/radare2/libr/flag/zones.c"
          r_flag_zone_add(RFlag *f, const char *name, 
# 30 "project/radare2/libr/flag/zones.c" 3 4
                                                      unsigned long long 
# 30 "project/radare2/libr/flag/zones.c"
                                                           addr) {
 
# 31 "project/radare2/libr/flag/zones.c" 3 4
do { if (!(
# 31 "project/radare2/libr/flag/zones.c"
f && name && *name
# 31 "project/radare2/libr/flag/zones.c" 3 4
...
# 31 "project/radare2/libr/flag/zones.c"
 ...
 if (zi) {
  ...
  zi = 
# 44 "project/radare2/libr/flag/zones.c" 3 4
      (
# 44 "project/radare2/libr/flag/zones.c"
      RFlagZoneItem
# 44 "project/radare2/libr/flag/zones.c" 3 4
      *)calloc(1,sizeof(
# 44 "project/radare2/libr/flag/zones.c"
...
# 44 "project/radare2/libr/flag/zones.c"
 ...
 return 
# 49 "project/radare2/libr/flag/zones.c" 3 4
       1
# 49 "project/radare2/libr/flag/zones.c"
           ;
}


# 52 "project/radare2/libr/flag/zones.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 52 "project/radare2/libr/flag/zones.c"
          r_flag_zone_reset(RFlag *f) {
 r_list_free (f->zones);
 f->zones = r_list_newf (r_flag_zone_item_free);
 return 
# 55 "project/radare2/libr/flag/zones.c" 3 4
       1
# 55 "project/radare2/libr/flag/zones.c"
           ;
}


# 58 "project/radare2/libr/flag/zones.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 58 "project/radare2/libr/flag/zones.c"
          r_flag_zone_del(RFlag *f, const char *name) {
 RListIter *iter;
 RFlagZoneItem *zi;
 
# 61 "project/radare2/libr/flag/zones.c" 3 4
if (
# 61 "project/radare2/libr/flag/zones.c"
f->zones
# 61 "project/radare2/libr/flag/zones.c" 3 4
) for (
# 61 "project/radare2/libr/flag/zones.c"
...
# 61 "project/radare2/libr/flag/zones.c"
                              {
  if (!strcmp (name, zi->name)) {
   r_list_delete (f->zones, iter);
   return 
# 64 "project/radare2/libr/flag/zones.c" 3 4
         1
# 64 "project/radare2/libr/flag/zones.c"
             ;
  }
 }
 return 
# 67 "project/radare2/libr/flag/zones.c" 3 4
       0
# 67 "project/radare2/libr/flag/zones.c"
            ;
}



# 71 "project/radare2/libr/flag/zones.c" 3 4
__attribute__((visibility("default"))) 
# 71 "project/radare2/libr/flag/zones.c"
     void r_flag_zone_item_free(void *a) {
 RFlagZoneItem *zi = a;
 free (zi->name);
 free (zi);
}
...
# 77 "project/radare2/libr/flag/zones.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 77 "project/radare2/libr/flag/zones.c"
          r_flag_zone_around(RFlag *f, 
# 77 "project/radare2/libr/flag/zones.c" 3 4
                                       unsigned long long 
# 77 "project/radare2/libr/flag/zones.c"
                                            addr, const char **prev, const char **next) {
 RListIter *iter;
 RFlagZoneItem *zi;
 *prev = *next = 
# 80 "project/radare2/libr/flag/zones.c" 3 4
                ((void *)0)
# 80 "project/radare2/libr/flag/zones.c"
                    ;
 
# 81 "project/radare2/libr/flag/zones.c" 3 4
unsigned long long 
# 81 "project/radare2/libr/flag/zones.c"
     h = 
# 81 "project/radare2/libr/flag/zones.c" 3 4
...
# 83 "project/radare2/libr/flag/zones.c" 3 4
if (
# 83 "project/radare2/libr/flag/zones.c"
f->zones
# 83 "project/radare2/libr/flag/zones.c" 3 4
) for (
# 83 "project/radare2/libr/flag/zones.c"
...
# 83 "project/radare2/libr/flag/zones.c"
  ...
  if (zi->from > addr) {
   if (h == 
# 85 "project/radare2/libr/flag/zones.c" 3 4
           0xFFFFFFFFFFFFFFFFULL
# 85 "project/radare2/libr/flag/zones.c"
                   ) {
    h = zi->from;
    *next = zi->name;
   } else {
  ...
  if (zi->from < addr) {
   if (l == 
# 96 "project/radare2/libr/flag/zones.c" 3 4
           0xFFFFFFFFFFFFFFFFULL
# 96 "project/radare2/libr/flag/zones.c"
                   ) {
    l = zi->from;
    *prev = zi->name;
   } else {
  ...
  if (zi->to <= addr) {
   if (l == 
# 107 "project/radare2/libr/flag/zones.c" 3 4
           0xFFFFFFFFFFFFFFFFULL
# 107 "project/radare2/libr/flag/zones.c"
                   ) {
    l = zi->to;
    *prev = zi->name;
   } else {
  ...
  if (zi->to > addr) {
   if (h == 
# 118 "project/radare2/libr/flag/zones.c" 3 4
           0xFFFFFFFFFFFFFFFFULL
# 118 "project/radare2/libr/flag/zones.c"
                   ) {
    h = zi->to;
    *next = zi->name;
   } else {
 ...
 return 
# 129 "project/radare2/libr/flag/zones.c" 3 4
       1
# 129 "project/radare2/libr/flag/zones.c"
           ;
}


# 132 "project/radare2/libr/flag/zones.c" 3 4
__attribute__((visibility("default"))) 
# 132 "project/radare2/libr/flag/zones.c"
     RList *r_flag_zone_barlist(RFlag *f, 
# 132 "project/radare2/libr/flag/zones.c" 3 4
                                          unsigned long long 
# 132 "project/radare2/libr/flag/zones.c"
                                               from, 
...
# 132 "project/radare2/libr/flag/zones.c"
                                                          bsize, int rows) {
 RList *list = r_list_newf (
# 133 "project/radare2/libr/flag/zones.c" 3 4
                           ((void *)0)
# 133 "project/radare2/libr/flag/zones.c"
                               );
 int i;
 for (i = 0; i < rows; i++) {
...
# 147 "project/radare2/libr/flag/zones.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 147 "project/radare2/libr/flag/zones.c"
          r_flag_zone_list(RFlag *f, int mode) {
 RListIter *iter;
 RFlagZoneItem *zi;
 
# 150 "project/radare2/libr/flag/zones.c" 3 4
if (
# 150 "project/radare2/libr/flag/zones.c"
f->zones
# 150 "project/radare2/libr/flag/zones.c" 3 4
) for (
# 150 "project/radare2/libr/flag/zones.c"
...
# 150 "project/radare2/libr/flag/zones.c"
                              {
  if (mode == '*') {
   f->cb_printf ("fz %s @ 0x08%"
# 152 "project/radare2/libr/flag/zones.c" 3 4
                               "llx"
# 152 "project/radare2/libr/flag/zones.c"
                                      "\n", zi->name, zi->from);
   f->cb_printf ("f %s %"
# 153 "project/radare2/libr/flag/zones.c" 3 4
                        "lld"
# 153 "project/radare2/libr/flag/zones.c"
                               " 0x08%"
# 153 "project/radare2/libr/flag/zones.c" 3 4
                                       "llx"
# 153 "project/radare2/libr/flag/zones.c"
   ...
   f->cb_printf ("0x08%"
# 156 "project/radare2/libr/flag/zones.c" 3 4
                       "llx"
# 156 "project/radare2/libr/flag/zones.c"
                              "  0x%08"
# 156 "project/radare2/libr/flag/zones.c" 3 4
                                       "llx"
# 156 "project/radare2/libr/flag/zones.c"
 ...
 return 
# 160 "project/radare2/libr/flag/zones.c" 3 4
       1
# 160 "project/radare2/libr/flag/zones.c"
           ;
}
