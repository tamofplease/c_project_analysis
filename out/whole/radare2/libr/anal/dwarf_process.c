# 0 "project/radare2/libr/anal/dwarf_process.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 5 "project/radare2/libr/anal/base_types.h" 2
...
# 4 "project/radare2/libr/anal/dwarf_process.c" 2
...
# 6 "project/radare2/libr/anal/dwarf_process.c" 2




# 9 "project/radare2/libr/anal/dwarf_process.c"
typedef struct dwarf_parse_context_t {
 const RAnal *anal;
 const RBinDwarfDie *all_dies;
 const 
# 12 "project/radare2/libr/anal/dwarf_process.c" 3 4
      unsigned long long 
# 12 "project/radare2/libr/anal/dwarf_process.c"
           count;
 Sdb *sdb;
 HtUP *die_map;
 HtUP *locations;
...
# 20 "project/radare2/libr/anal/dwarf_process.c" 3 4
unsigned long long 
# 20 "project/radare2/libr/anal/dwarf_process.c"
     addr;
 const char *name;
 const char *signature;
 
# 23 "project/radare2/libr/anal/dwarf_process.c" 3 4
_Bool 
# 23 "project/radare2/libr/anal/dwarf_process.c"
     is_external;
 
# 24 "project/radare2/libr/anal/dwarf_process.c" 3 4
_Bool 
# 24 "project/radare2/libr/anal/dwarf_process.c"
     is_method;
 
# 25 "project/radare2/libr/anal/dwarf_process.c" 3 4
_Bool 
# 25 "project/radare2/libr/anal/dwarf_process.c"
     is_virtual;
 
# 26 "project/radare2/libr/anal/dwarf_process.c" 3 4
_Bool 
# 26 "project/radare2/libr/anal/dwarf_process.c"
     is_trampoline;
 
# 27 "project/radare2/libr/anal/dwarf_process.c" 3 4
unsigned char 
# 27 "project/radare2/libr/anal/dwarf_process.c"
    access;
 
# 28 "project/radare2/libr/anal/dwarf_process.c" 3 4
unsigned long long 
# 28 "project/radare2/libr/anal/dwarf_process.c"
     vtable_addr;
 
# 29 "project/radare2/libr/anal/dwarf_process.c" 3 4
unsigned long long 
# 29 "project/radare2/libr/anal/dwarf_process.c"
     call_conv;
} Function;
...
# 42 "project/radare2/libr/anal/dwarf_process.c" 3 4
unsigned long long 
# 42 "project/radare2/libr/anal/dwarf_process.c"
     address;
 
# 43 "project/radare2/libr/anal/dwarf_process.c" 3 4
unsigned long long 
# 43 "project/radare2/libr/anal/dwarf_process.c"
     reg_num;
 
# 44 "project/radare2/libr/anal/dwarf_process.c" 3 4
long long 
# 44 "project/radare2/libr/anal/dwarf_process.c"
     offset;
 const char *reg_name;
} VariableLocation;
...
static inline 
# 62 "project/radare2/libr/anal/dwarf_process.c" 3 4
             int 
# 62 "project/radare2/libr/anal/dwarf_process.c"
                  find_attr_idx(const RBinDwarfDie *die, 
# 62 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                         int 
# 62 "project/radare2/libr/anal/dwarf_process.c"
                                                              attr_name) {
 
# 63 "project/radare2/libr/anal/dwarf_process.c" 3 4
int 
# 63 "project/radare2/libr/anal/dwarf_process.c"
     i;
 
# 64 "project/radare2/libr/anal/dwarf_process.c" 3 4
do { if (!(
# 64 "project/radare2/libr/anal/dwarf_process.c"
die
# 64 "project/radare2/libr/anal/dwarf_process.c" 3 4
...
static RBinDwarfAttrValue *find_attr(const RBinDwarfDie *die, 
# 74 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                             int 
# 74 "project/radare2/libr/anal/dwarf_process.c"
                                                                  attr_name) {
 
# 75 "project/radare2/libr/anal/dwarf_process.c" 3 4
int 
# 75 "project/radare2/libr/anal/dwarf_process.c"
     i;
 
# 76 "project/radare2/libr/anal/dwarf_process.c" 3 4
do { if (!(
# 76 "project/radare2/libr/anal/dwarf_process.c"
die
# 76 "project/radare2/libr/anal/dwarf_process.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 76 "project/radare2/libr/anal/dwarf_process.c"
...
# 76 "project/radare2/libr/anal/dwarf_process.c"
 ...
 return 
# 82 "project/radare2/libr/anal/dwarf_process.c" 3 4
       ((void *)0)
# 82 "project/radare2/libr/anal/dwarf_process.c"
           ;
}
# 93 "project/radare2/libr/anal/dwarf_process.c"
static 
# 93 "project/radare2/libr/anal/dwarf_process.c" 3 4
      _Bool 
# 93 "project/radare2/libr/anal/dwarf_process.c"
           strbuf_rev_prepend_char(RStrBuf *sb, const char *s, int c) {
 
# 94 "project/radare2/libr/anal/dwarf_process.c" 3 4
do { if (!(
# 94 "project/radare2/libr/anal/dwarf_process.c"
sb && s
# 94 "project/radare2/libr/anal/dwarf_process.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 94 "project/radare2/libr/anal/dwarf_process.c"
...
# 94 "project/radare2/libr/anal/dwarf_process.c"
 ...
 if (l == 0) {
  return 
# 98 "project/radare2/libr/anal/dwarf_process.c" 3 4
        1
# 98 "project/radare2/libr/anal/dwarf_process.c"
            ;
 }
 size_t newlen = l + sb->len;
 char *ns = malloc (newlen + 1);
 
# 102 "project/radare2/libr/anal/dwarf_process.c" 3 4
_Bool 
# 102 "project/radare2/libr/anal/dwarf_process.c"
     ret = 
# 102 "project/radare2/libr/anal/dwarf_process.c" 3 4
           0
# 102 "project/radare2/libr/anal/dwarf_process.c"
 ...
 if (!pivot) {
  free (ns);
  return 
# 107 "project/radare2/libr/anal/dwarf_process.c" 3 4
        0
# 107 "project/radare2/libr/anal/dwarf_process.c"
             ;
 }
 size_t idx = pivot - sb_str;
 if (ns) {
  
# 111 "project/radare2/libr/anal/dwarf_process.c" 3 4
 __builtin___memcpy_chk (
# 111 "project/radare2/libr/anal/dwarf_process.c"
 ns
# 111 "project/radare2/libr/anal/dwarf_process.c" 3 4
 , 
# 111 "project/radare2/libr/anal/dwarf_process.c"
...
# 112 "project/radare2/libr/anal/dwarf_process.c" 3 4
 __builtin___memcpy_chk (
# 112 "project/radare2/libr/anal/dwarf_process.c"
 ns + idx
# 112 "project/radare2/libr/anal/dwarf_process.c" 3 4
 , 
# 112 "project/radare2/libr/anal/dwarf_process.c"
...
# 113 "project/radare2/libr/anal/dwarf_process.c" 3 4
 __builtin___memcpy_chk (
# 113 "project/radare2/libr/anal/dwarf_process.c"
 ns + idx + l
# 113 "project/radare2/libr/anal/dwarf_process.c" 3 4
 , 
# 113 "project/radare2/libr/anal/dwarf_process.c"
 sb_str + idx, sb->len - idx
# 113 "project/radare2/libr/anal/dwarf_process.c" 3 4
 , __builtin_object_size (
# 113 "project/radare2/libr/anal/dwarf_process.c"
 ns + idx + l
...
# 115 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                ((void *)0)
# 115 "project/radare2/libr/anal/dwarf_process.c"
                                    ;
  free (ns);
 }
 return ret;
...
static 
# 128 "project/radare2/libr/anal/dwarf_process.c" 3 4
      _Bool 
# 128 "project/radare2/libr/anal/dwarf_process.c"
           strbuf_rev_append_char(RStrBuf *sb, const char *s, const char *needle) {
 
# 129 "project/radare2/libr/anal/dwarf_process.c" 3 4
do { if (!(
# 129 "project/radare2/libr/anal/dwarf_process.c"
sb && s
# 129 "project/radare2/libr/anal/dwarf_process.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 129 "project/radare2/libr/anal/dwarf_process.c"
...
# 129 "project/radare2/libr/anal/dwarf_process.c"
 ...
 if (l == 0) {
  return 
# 133 "project/radare2/libr/anal/dwarf_process.c" 3 4
        1
# 133 "project/radare2/libr/anal/dwarf_process.c"
            ;
 }
 
# 135 "project/radare2/libr/anal/dwarf_process.c" 3 4
_Bool 
# 135 "project/radare2/libr/anal/dwarf_process.c"
     ret = 
# 135 "project/radare2/libr/anal/dwarf_process.c" 3 4
           0
# 135 "project/radare2/libr/anal/dwarf_process.c"
 ...
 if (!pivot) {
  return 
# 139 "project/radare2/libr/anal/dwarf_process.c" 3 4
        0
# 139 "project/radare2/libr/anal/dwarf_process.c"
             ;
 }
 pivot += strlen (needle);
 size_t idx = pivot - sb_str;
...
# 146 "project/radare2/libr/anal/dwarf_process.c" 3 4
 __builtin___memcpy_chk (
# 146 "project/radare2/libr/anal/dwarf_process.c"
 ns
# 146 "project/radare2/libr/anal/dwarf_process.c" 3 4
 , 
# 146 "project/radare2/libr/anal/dwarf_process.c"
...
# 147 "project/radare2/libr/anal/dwarf_process.c" 3 4
 __builtin___memcpy_chk (
# 147 "project/radare2/libr/anal/dwarf_process.c"
 ns + idx
# 147 "project/radare2/libr/anal/dwarf_process.c" 3 4
 , 
# 147 "project/radare2/libr/anal/dwarf_process.c"
...
# 148 "project/radare2/libr/anal/dwarf_process.c" 3 4
 __builtin___memcpy_chk (
# 148 "project/radare2/libr/anal/dwarf_process.c"
 ns + idx + l
# 148 "project/radare2/libr/anal/dwarf_process.c" 3 4
 , 
# 148 "project/radare2/libr/anal/dwarf_process.c"
...
# 148 "project/radare2/libr/anal/dwarf_process.c"
  ...
  ns[newlen] = 0;
  ret = r_strbuf_set (sb, ns) != 
# 150 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                ((void *)0)
# 150 "project/radare2/libr/anal/dwarf_process.c"
                                    ;
  free (ns);
 }
 return ret;
...
static inline char *create_type_name_from_offset(
# 156 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                unsigned long long 
# 156 "project/radare2/libr/anal/dwarf_process.c"
                                                     offset) {
 return r_str_newf ("type_0x%" 
# 157 "project/radare2/libr/anal/dwarf_process.c" 3 4
                              "llx"
# 157 "project/radare2/libr/anal/dwarf_process.c"
                                     , offset);
}
...
# 167 "project/radare2/libr/anal/dwarf_process.c" 3 4
int 
# 167 "project/radare2/libr/anal/dwarf_process.c"
     name_attr_idx = find_attr_idx (die, 
# 167 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                         0x03
# 167 "project/radare2/libr/anal/dwarf_process.c"
                                                   );
 if (name_attr_idx < 0 || name_attr_idx >= die->count) {
  return 
# 169 "project/radare2/libr/anal/dwarf_process.c" 3 4
        ((void *)0)
# 169 "project/radare2/libr/anal/dwarf_process.c"
            ;
 }
...
static 
# 184 "project/radare2/libr/anal/dwarf_process.c" 3 4
      unsigned long long 
# 184 "project/radare2/libr/anal/dwarf_process.c"
           get_die_size(const RBinDwarfDie *die) {
 
# 185 "project/radare2/libr/anal/dwarf_process.c" 3 4
unsigned long long 
# 185 "project/radare2/libr/anal/dwarf_process.c"
     size = 0;
 
# 186 "project/radare2/libr/anal/dwarf_process.c" 3 4
int 
# 186 "project/radare2/libr/anal/dwarf_process.c"
     byte_size_idx = find_attr_idx (die, 
# 186 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                         0x0b
# 186 "project/radare2/libr/anal/dwarf_process.c"
                                                        );
 ...
 if (byte_size_idx != -1) {
  size = die->attr_values[byte_size_idx].uconstant * 8;
 } else {
  
# 191 "project/radare2/libr/anal/dwarf_process.c" 3 4
 int 
# 191 "project/radare2/libr/anal/dwarf_process.c"
      bit_size_idx = find_attr_idx (die, 
# 191 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                         0x0d
# 191 "project/radare2/libr/anal/dwarf_process.c"
                                                       );
...
static void parse_array_type(Context *ctx, int idx, RStrBuf *strbuf) {
 ...
 if (die->has_children) {
  ...
  for (j = idx; child_depth > 0 && j < ctx->count; j++) {
   ...
   if (child_depth == 1 && child_die->tag == 
# 222 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                            0x21
# 222 "project/radare2/libr/anal/dwarf_process.c"
                                                                ) {
    size_t i;
    for (i = 0; i < child_die->count; i++) {
     ...
     case 
# 227 "project/radare2/libr/anal/dwarf_process.c" 3 4
         0x2f
# 227 "project/radare2/libr/anal/dwarf_process.c"
                          :
     case 
# 228 "project/radare2/libr/anal/dwarf_process.c" 3 4
         0x37
# 228 "project/radare2/libr/anal/dwarf_process.c"
                    :
      r_strbuf_appendf (strbuf, "[%" 
# 229 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                    "lld" 
# 229 "project/radare2/libr/anal/dwarf_process.c"
                                            "]", value->uconstant + 1);
      break;
...
static 
# 261 "project/radare2/libr/anal/dwarf_process.c" 3 4
      int 
# 261 "project/radare2/libr/anal/dwarf_process.c"
           parse_type(Context *ctx, const 
# 261 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                          unsigned long long 
# 261 "project/radare2/libr/anal/dwarf_process.c"
                                               offset, RStrBuf *strbuf, 
# 261 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                                        unsigned long long 
# 261 "project/radare2/libr/anal/dwarf_process.c"
                                                                             *size, HtUP **visited) {
 
# 262 "project/radare2/libr/anal/dwarf_process.c" 3 4
do { if (!(
# 262 "project/radare2/libr/anal/dwarf_process.c"
strbuf
# 262 "project/radare2/libr/anal/dwarf_process.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 262 "project/radare2/libr/anal/dwarf_process.c"
...
# 262 "project/radare2/libr/anal/dwarf_process.c"
                                 ;
 RBinDwarfDie *die = ht_up_find (ctx->die_map, offset, 
# 263 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                      ((void *)0)
# 263 "project/radare2/libr/anal/dwarf_process.c"
                                                          );
 if (!die) {
  return -1;
 }
 
# 267 "project/radare2/libr/anal/dwarf_process.c" 3 4
_Bool 
# 267 "project/radare2/libr/anal/dwarf_process.c"
     root = 
# 267 "project/radare2/libr/anal/dwarf_process.c" 3 4
            0
# 267 "project/radare2/libr/anal/dwarf_process.c"
 ...
 if (!visited) {
  root = 
# 270 "project/radare2/libr/anal/dwarf_process.c" 3 4
        1
# 270 "project/radare2/libr/anal/dwarf_process.c"
            ;
  SetU *su = set_u_new ();
...
# 276 "project/radare2/libr/anal/dwarf_process.c" 3 4
 fprintf(__stderrp,
# 276 "project/radare2/libr/anal/dwarf_process.c"
 "Warning: anal.dwarf.parse_type: infinite recursion detected.\n"
# 276 "project/radare2/libr/anal/dwarf_process.c" 3 4
 )
# 276 "project/radare2/libr/anal/dwarf_process.c"
                                                                           ;
...
# 281 "project/radare2/libr/anal/dwarf_process.c" 3 4
int 
# 281 "project/radare2/libr/anal/dwarf_process.c"
     type_idx;
 
# 282 "project/radare2/libr/anal/dwarf_process.c" 3 4
int 
# 282 "project/radare2/libr/anal/dwarf_process.c"
     tag;
 char *name = 
# 283 "project/radare2/libr/anal/dwarf_process.c" 3 4
             ((void *)0)
# 283 "project/radare2/libr/anal/dwarf_process.c"
                 ;
 ...
 case 
# 290 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x0f
# 290 "project/radare2/libr/anal/dwarf_process.c"
                        :
  type_idx = find_attr_idx (die, 
# 291 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                0x49
# 291 "project/radare2/libr/anal/dwarf_process.c"
                                          );
  if (type_idx == -1) {
   ...
   if (tag == 
# 297 "project/radare2/libr/anal/dwarf_process.c" 3 4
             0x15
# 297 "project/radare2/libr/anal/dwarf_process.c"
                                   ) {
    strbuf_rev_prepend_char (strbuf, "(*)", '(');
   } else if (tag == 
# 299 "project/radare2/libr/anal/dwarf_process.c" 3 4
                    0x0f
# 299 "project/radare2/libr/anal/dwarf_process.c"
                                       ) {
 ...
 case 
# 310 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x16
# 310 "project/radare2/libr/anal/dwarf_process.c"
                   :
 case 
# 311 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x24
# 311 "project/radare2/libr/anal/dwarf_process.c"
                     :
 case 
# 312 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x13
# 312 "project/radare2/libr/anal/dwarf_process.c"
                          :
 case 
# 313 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x04
# 313 "project/radare2/libr/anal/dwarf_process.c"
                            :
 case 
# 314 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x17
# 314 "project/radare2/libr/anal/dwarf_process.c"
                      :
 case 
# 315 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x02
# 315 "project/radare2/libr/anal/dwarf_process.c"
                      :
  ...
  break;
 case 
# 322 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x15
# 322 "project/radare2/libr/anal/dwarf_process.c"
                           :
  type_idx = find_attr_idx (die, 
# 323 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                0x49
# 323 "project/radare2/libr/anal/dwarf_process.c"
                                          );
  if (type_idx == -1) {
   r_strbuf_append (strbuf, "void");
  } else {
  ...
  break;
 case 
# 334 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x01
# 334 "project/radare2/libr/anal/dwarf_process.c"
                      :
  type_idx = find_attr_idx (die, 
# 335 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                0x49
# 335 "project/radare2/libr/anal/dwarf_process.c"
                                          );
  if (type_idx != -1) {
   parse_type (ctx, die->attr_values[type_idx].reference, strbuf, size, visited);
  }
  ...
  break;
 case 
# 341 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x26
# 341 "project/radare2/libr/anal/dwarf_process.c"
                      :
  type_idx = find_attr_idx (die, 
# 342 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                0x49
# 342 "project/radare2/libr/anal/dwarf_process.c"
                                          );
  if (type_idx != -1) {
   parse_type (ctx, die->attr_values[type_idx].reference, strbuf, size, visited);
  }
  ...
  break;
 case 
# 348 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x35
# 348 "project/radare2/libr/anal/dwarf_process.c"
                         :
  type_idx = find_attr_idx (die, 
# 349 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                0x49
# 349 "project/radare2/libr/anal/dwarf_process.c"
                                          );
  if (type_idx != -1) {
   parse_type (ctx, die->attr_values[type_idx].reference, strbuf, size, visited);
  }
  ...
  break;
 case 
# 355 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x37
# 355 "project/radare2/libr/anal/dwarf_process.c"
                         :
  type_idx = find_attr_idx (die, 
# 356 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                0x49
# 356 "project/radare2/libr/anal/dwarf_process.c"
                                          );
  if (type_idx != -1) {
   parse_type (ctx, die->attr_values[type_idx].reference, strbuf, size, visited);
  }
  ...
  break;
 case 
# 362 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x42
# 362 "project/radare2/libr/anal/dwarf_process.c"
                                 :
  type_idx = find_attr_idx (die, 
# 363 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                0x49
# 363 "project/radare2/libr/anal/dwarf_process.c"
                                          );
  if (type_idx != -1) {
   parse_type (ctx, die->attr_values[type_idx].reference, strbuf, size, visited);
  }
  ...
  break;
 case 
# 369 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x10
# 369 "project/radare2/libr/anal/dwarf_process.c"
                          :
  type_idx = find_attr_idx (die, 
# 370 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                0x49
# 370 "project/radare2/libr/anal/dwarf_process.c"
                                          );
  if (type_idx != -1) {
   parse_type (ctx, die->attr_values[type_idx].reference, strbuf, size, visited);
  }
 ...
 return (
# 382 "project/radare2/libr/anal/dwarf_process.c" 3 4
        int
# 382 "project/radare2/libr/anal/dwarf_process.c"
            )die->tag;
}
# 394 "project/radare2/libr/anal/dwarf_process.c"
static RAnalStructMember *parse_struct_member(Context *ctx, 
# 394 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                           unsigned long long 
# 394 "project/radare2/libr/anal/dwarf_process.c"
                                                                idx, RAnalStructMember *result) {
 
# 395 "project/radare2/libr/anal/dwarf_process.c" 3 4
do { if (!(
# 395 "project/radare2/libr/anal/dwarf_process.c"
result
# 395 "project/radare2/libr/anal/dwarf_process.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 395 "project/radare2/libr/anal/dwarf_process.c"
"result"
# 395 "project/radare2/libr/anal/dwarf_process.c" 3 4
, 395); return (((void *)0)); } } while (0)
# 395 "project/radare2/libr/anal/dwarf_process.c"
                                   ;
 const RBinDwarfDie *die = &ctx->all_dies[idx];

 char *name = 
# 398 "project/radare2/libr/anal/dwarf_process.c" 3 4
             ((void *)0)
# 398 "project/radare2/libr/anal/dwarf_process.c"
                 ;
 char *type = 
# 399 "project/radare2/libr/anal/dwarf_process.c" 3 4
             ((void *)0)
# 399 "project/radare2/libr/anal/dwarf_process.c"
                 ;
 
# 400 "project/radare2/libr/anal/dwarf_process.c" 3 4
unsigned long long 
# 400 "project/radare2/libr/anal/dwarf_process.c"
     offset = 0;
 
# 401 "project/radare2/libr/anal/dwarf_process.c" 3 4
unsigned long long 
# 401 "project/radare2/libr/anal/dwarf_process.c"
     size = 0;
 RStrBuf strbuf;
 ...
 for (i = 0; i < die->count; i++) {
  ...
  case 
# 408 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x03
# 408 "project/radare2/libr/anal/dwarf_process.c"
                :
   free (name);
   name = get_die_name (die);
   if (!name) {
   ...
   break;
  case 
# 415 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x49
# 415 "project/radare2/libr/anal/dwarf_process.c"
                :
   parse_type (ctx, value->reference, &strbuf, &size, 
# 416 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                     ((void *)0)
# 416 "project/radare2/libr/anal/dwarf_process.c"
                                                         );
   free (type);
   ...
   break;
  case 
# 423 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x38
# 423 "project/radare2/libr/anal/dwarf_process.c"
                                :
   ...
   break;
  case 
# 433 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x32
# 433 "project/radare2/libr/anal/dwarf_process.c"
                         :
  case 
# 434 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x61
# 434 "project/radare2/libr/anal/dwarf_process.c"
                   :
  case 
# 435 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x6b
# 435 "project/radare2/libr/anal/dwarf_process.c"
                           :
  ...
  case 
# 443 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x0b
# 443 "project/radare2/libr/anal/dwarf_process.c"
                     :
   size = value->uconstant * 8;
   break;
  case 
# 446 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x0d
# 446 "project/radare2/libr/anal/dwarf_process.c"
                    :
   size = value->uconstant;
   break;
  case 
# 449 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x1d
# 449 "project/radare2/libr/anal/dwarf_process.c"
                           :
  default:
   break;
  }
...
cleanup:
 ...
 free (type);
 return 
# 463 "project/radare2/libr/anal/dwarf_process.c" 3 4
       ((void *)0)
# 463 "project/radare2/libr/anal/dwarf_process.c"
           ;
}
# 475 "project/radare2/libr/anal/dwarf_process.c"
static RAnalEnumCase *parse_enumerator(Context *ctx, 
# 475 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                    unsigned long long 
# 475 "project/radare2/libr/anal/dwarf_process.c"
                                                         idx, RAnalEnumCase *result) {
 const RBinDwarfDie *die = &ctx->all_dies[idx];

 char *name = 
# 478 "project/radare2/libr/anal/dwarf_process.c" 3 4
             ((void *)0)
# 478 "project/radare2/libr/anal/dwarf_process.c"
                 ;
 int val = 0;
 size_t i;
 ...
 for (i = 0; i < die->count; i++) {
  ...
  switch (die->attr_values[i].attr_name) {
  case 
# 486 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x03
# 486 "project/radare2/libr/anal/dwarf_process.c"
                :
   name = get_die_name (die);
   if (!name) {
    goto cleanup;
   ...
   break;
  case 
# 492 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x1c
# 492 "project/radare2/libr/anal/dwarf_process.c"
                       :
...
cleanup:
 free (name);
 return 
# 506 "project/radare2/libr/anal/dwarf_process.c" 3 4
       ((void *)0)
# 506 "project/radare2/libr/anal/dwarf_process.c"
           ;
}
# 517 "project/radare2/libr/anal/dwarf_process.c"
static void parse_structure_type(Context *ctx, 
# 517 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                              unsigned long long 
# 517 "project/radare2/libr/anal/dwarf_process.c"
                                                   idx) {
 const RBinDwarfDie *die = &ctx->all_dies[idx];
 ...
 RAnalBaseTypeKind kind;
 if (die->tag == 
# 521 "project/radare2/libr/anal/dwarf_process.c" 3 4
                0x17
# 521 "project/radare2/libr/anal/dwarf_process.c"
                                 ) {
...
# 538 "project/radare2/libr/anal/dwarf_process.c" 3 4
int 
# 538 "project/radare2/libr/anal/dwarf_process.c"
     spec_attr_idx = find_attr_idx (die, 
# 538 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                         0x47
# 538 "project/radare2/libr/anal/dwarf_process.c"
                                                            );
 if (spec_attr_idx != -1) {
  RBinDwarfDie *decl_die = ht_up_find (ctx->die_map, die->attr_values[spec_attr_idx].reference, 
# 540 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                                                               ((void *)0)
# 540 "project/radare2/libr/anal/dwarf_process.c"
                                                                                                   );
  if (!decl_die) {
   goto cleanup;
  }
  
# 544 "project/radare2/libr/anal/dwarf_process.c" 3 4
 int 
# 544 "project/radare2/libr/anal/dwarf_process.c"
      name_attr_idx = find_attr_idx (decl_die, 
# 544 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                               0x03
# 544 "project/radare2/libr/anal/dwarf_process.c"
                                                         );
 ...
 if (die->has_children) {
  ...
  for (j = idx; child_depth > 0 && j < ctx->count; j++) {
   ...
   if (child_depth == 1 && child_die->tag == 
# 563 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                            0x0d
# 563 "project/radare2/libr/anal/dwarf_process.c"
                                                         ) {
...
static void parse_enum_type(Context *ctx, 
# 594 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                         unsigned long long 
# 594 "project/radare2/libr/anal/dwarf_process.c"
                                              idx) {
 const RBinDwarfDie *die = &ctx->all_dies[idx];
...
# 608 "project/radare2/libr/anal/dwarf_process.c" 3 4
int 
# 608 "project/radare2/libr/anal/dwarf_process.c"
     type_attr_idx = find_attr_idx (die, 
# 608 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                         0x49
# 608 "project/radare2/libr/anal/dwarf_process.c"
                                                   );
...
# 612 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                                                        ((void *)0)
# 612 "project/radare2/libr/anal/dwarf_process.c"
                                                                                            );
 ...
 if (die->has_children) {
  ...
  for (j = idx; child_depth > 0 && j < ctx->count; j++) {
   ...
   if (child_depth == 1 && child_die->tag == 
# 624 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                            0x28
# 624 "project/radare2/libr/anal/dwarf_process.c"
                                                             ) {
    ...
    if (!element) {
     enum_type_case_free (result, 
# 631 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                 ((void *)0)
# 631 "project/radare2/libr/anal/dwarf_process.c"
                                     );
     goto cleanup;
    }
   }
...
# 658 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                       unsigned long long 
# 658 "project/radare2/libr/anal/dwarf_process.c"
                                            idx) {
 const RBinDwarfDie *die = &ctx->all_dies[idx];
 ...
 char *name = 
# 661 "project/radare2/libr/anal/dwarf_process.c" 3 4
             ((void *)0)
# 661 "project/radare2/libr/anal/dwarf_process.c"
                 ;
 char *type = 
# 662 "project/radare2/libr/anal/dwarf_process.c" 3 4
             ((void *)0)
# 662 "project/radare2/libr/anal/dwarf_process.c"
                 ;
 
# 663 "project/radare2/libr/anal/dwarf_process.c" 3 4
unsigned long long 
# 663 "project/radare2/libr/anal/dwarf_process.c"
     size = 0;
 RStrBuf strbuf;
 r_strbuf_init (&strbuf);
 size_t i;
 ...
 for (i = 0; i < die->count; i++) {
  ...
  switch (die->attr_values[i].attr_name) {
  case 
# 671 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x03
# 671 "project/radare2/libr/anal/dwarf_process.c"
                :
   free (name);
   name = get_die_name (die);
   if (!name) {
   ...
   break;
  case 
# 678 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x49
# 678 "project/radare2/libr/anal/dwarf_process.c"
                :
   parse_type (ctx, value->reference, &strbuf, &size, 
# 679 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                     ((void *)0)
# 679 "project/radare2/libr/anal/dwarf_process.c"
                                                         );
   free (type);
   type = r_strbuf_drain_nofree (&strbuf);
   if (!type) {
...
static void parse_atomic_type(Context *ctx, 
# 709 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                           unsigned long long 
# 709 "project/radare2/libr/anal/dwarf_process.c"
                                                idx) {
 const RBinDwarfDie *die = &ctx->all_dies[idx];

 char *name = 
# 712 "project/radare2/libr/anal/dwarf_process.c" 3 4
             ((void *)0)
# 712 "project/radare2/libr/anal/dwarf_process.c"
                 ;
 
# 713 "project/radare2/libr/anal/dwarf_process.c" 3 4
unsigned long long 
# 713 "project/radare2/libr/anal/dwarf_process.c"
     size = 0;
 size_t i;
 ...
 for (i = 0; i < die->count; i++) {
  ...
  switch (die->attr_values[i].attr_name) {
  case 
# 719 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x03
# 719 "project/radare2/libr/anal/dwarf_process.c"
                :
   
# 720 "project/radare2/libr/anal/dwarf_process.c" 3 4
  { free((void *)
# 720 "project/radare2/libr/anal/dwarf_process.c"
  name
# 720 "project/radare2/libr/anal/dwarf_process.c" 3 4
  ); 
# 720 "project/radare2/libr/anal/dwarf_process.c"
...
# 720 "project/radare2/libr/anal/dwarf_process.c"
   ...
   break;
  case 
# 732 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x0b
# 732 "project/radare2/libr/anal/dwarf_process.c"
                     :
   size = value->uconstant * 8;
   break;
  case 
# 735 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x0d
# 735 "project/radare2/libr/anal/dwarf_process.c"
                    :
   size = value->uconstant;
   break;
  case 
# 738 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x3e
# 738 "project/radare2/libr/anal/dwarf_process.c"
                    :
  default:
   break;
  }
...
# 758 "project/radare2/libr/anal/dwarf_process.c" 3 4
int 
# 758 "project/radare2/libr/anal/dwarf_process.c"
     linkage_name_attr_idx = find_attr_idx (die, 
# 758 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                 0x6e
# 758 "project/radare2/libr/anal/dwarf_process.c"
                                                                   );
...
# 762 "project/radare2/libr/anal/dwarf_process.c" 3 4
int 
# 762 "project/radare2/libr/anal/dwarf_process.c"
     name_attr_idx = find_attr_idx (die, 
# 762 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                         0x03
# 762 "project/radare2/libr/anal/dwarf_process.c"
 ...
 return 
# 766 "project/radare2/libr/anal/dwarf_process.c" 3 4
       ((void *)0)
# 766 "project/radare2/libr/anal/dwarf_process.c"
           ;
}

static void get_spec_die_type(Context *ctx, RBinDwarfDie *die, RStrBuf *ret_type) {
 
# 770 "project/radare2/libr/anal/dwarf_process.c" 3 4
int 
# 770 "project/radare2/libr/anal/dwarf_process.c"
     attr_idx = find_attr_idx (die, 
# 770 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                    0x49
# 770 "project/radare2/libr/anal/dwarf_process.c"
                                              );
...
# 772 "project/radare2/libr/anal/dwarf_process.c" 3 4
 unsigned long long 
# 772 "project/radare2/libr/anal/dwarf_process.c"
      size = 0;
  parse_type (ctx, die->attr_values[attr_idx].reference, ret_type, &size, 
# 773 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                                         ((void *)0)
# 773 "project/radare2/libr/anal/dwarf_process.c"
                                                                             );
 }
}
...
static 
# 779 "project/radare2/libr/anal/dwarf_process.c" 3 4
      _Bool 
# 779 "project/radare2/libr/anal/dwarf_process.c"
           prefer_linkage_name(const char *lang) {
 if (lang == 
# 780 "project/radare2/libr/anal/dwarf_process.c" 3 4
            ((void *)0)
# 780 "project/radare2/libr/anal/dwarf_process.c"
                ) {
  return 
# 781 "project/radare2/libr/anal/dwarf_process.c" 3 4
        0
# 781 "project/radare2/libr/anal/dwarf_process.c"
             ;
 } else if (!strcmp (lang, "rust")) {
  return 
# 783 "project/radare2/libr/anal/dwarf_process.c" 3 4
        0
# 783 "project/radare2/libr/anal/dwarf_process.c"
             ;
 } else if (!strcmp (lang, "ada")) {
  return 
# 785 "project/radare2/libr/anal/dwarf_process.c" 3 4
        0
# 785 "project/radare2/libr/anal/dwarf_process.c"
             ;
 }
 return 
# 787 "project/radare2/libr/anal/dwarf_process.c" 3 4
       1
# 787 "project/radare2/libr/anal/dwarf_process.c"
           ;
}

static void parse_abstract_origin(Context *ctx, 
# 790 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                               unsigned long long 
# 790 "project/radare2/libr/anal/dwarf_process.c"
                                                    offset, RStrBuf *type, const char **name) {
 RBinDwarfDie *die = ht_up_find (ctx->die_map, offset, 
# 791 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                      ((void *)0)
# 791 "project/radare2/libr/anal/dwarf_process.c"
                                                          );
 if (die) {
  size_t i;
  
# 794 "project/radare2/libr/anal/dwarf_process.c" 3 4
 unsigned long long 
# 794 "project/radare2/libr/anal/dwarf_process.c"
      size = 0;
  
# 795 "project/radare2/libr/anal/dwarf_process.c" 3 4
 _Bool 
# 795 "project/radare2/libr/anal/dwarf_process.c"
      has_linkage_name = 
# 795 "project/radare2/libr/anal/dwarf_process.c" 3 4
                         0
# 795 "project/radare2/libr/anal/dwarf_process.c"
...
# 796 "project/radare2/libr/anal/dwarf_process.c" 3 4
 _Bool 
# 796 "project/radare2/libr/anal/dwarf_process.c"
      get_linkage_name = prefer_linkage_name (ctx->lang);
  for (i = 0; i < die->count; i++) {
   const RBinDwarfAttrValue *val = &die->attr_values[i];
   switch (val->attr_name) {
   case 
# 800 "project/radare2/libr/anal/dwarf_process.c" 3 4
       0x03
# 800 "project/radare2/libr/anal/dwarf_process.c"
                 :
    ...
    break;
   case 
# 805 "project/radare2/libr/anal/dwarf_process.c" 3 4
       0x6e
# 805 "project/radare2/libr/anal/dwarf_process.c"
                         :
   case 
# 806 "project/radare2/libr/anal/dwarf_process.c" 3 4
       0x2007
# 806 "project/radare2/libr/anal/dwarf_process.c"
                              :
    *name = val->string.content;
    has_linkage_name = 
# 808 "project/radare2/libr/anal/dwarf_process.c" 3 4
                      1
# 808 "project/radare2/libr/anal/dwarf_process.c"
                          ;
    break;
   case 
# 810 "project/radare2/libr/anal/dwarf_process.c" 3 4
       0x49
# 810 "project/radare2/libr/anal/dwarf_process.c"
                 :
    parse_type (ctx, val->reference, type, &size, 
# 811 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                 ((void *)0)
# 811 "project/radare2/libr/anal/dwarf_process.c"
                                                     );
    break;
   default:
    break;
...
static const char *map_dwarf_reg_to_x86_64_reg(
# 821 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                              unsigned long long 
# 821 "project/radare2/libr/anal/dwarf_process.c"
                                                   reg_num, VariableLocationKind *kind) {
...
static const char *map_dwarf_reg_to_x86_reg(
# 859 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                           unsigned long long 
# 859 "project/radare2/libr/anal/dwarf_process.c"
                                                reg_num, VariableLocationKind *kind) {
 *kind = LOCATION_REGISTER;
 switch (reg_num) {
 case 0: return "eax";
...
# 883 "project/radare2/libr/anal/dwarf_process.c" 3 4
 do { r_assert_log (R_LOGLVL_WARN, "(%s:%d):%s%s code should not be reached\n", "project/radare2/libr/anal/dwarf_process.c", 883, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : ""); } while (0)
# 883 "project/radare2/libr/anal/dwarf_process.c"
                     ;
  *kind = LOCATION_UNKNOWN;
  return "unsupported_reg";
 }
...
static const char *map_dwarf_reg_to_ppc64_reg(
# 890 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                             unsigned long long 
# 890 "project/radare2/libr/anal/dwarf_process.c"
                                                  reg_num, VariableLocationKind *kind) {
 *kind = LOCATION_REGISTER;
 switch (reg_num) {
 case 0: return "r0";
...
# 928 "project/radare2/libr/anal/dwarf_process.c" 3 4
 do { r_assert_log (R_LOGLVL_WARN, "(%s:%d):%s%s code should not be reached\n", "project/radare2/libr/anal/dwarf_process.c", 928, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : ""); } while (0)
# 928 "project/radare2/libr/anal/dwarf_process.c"
                     ;
  *kind = LOCATION_UNKNOWN;
  return "unsupported_reg";
 }
...
static RBinDwarfLocRange *find_largest_loc_range(RList *loc_list) {
 RBinDwarfLocRange *largest = 
# 953 "project/radare2/libr/anal/dwarf_process.c" 3 4
                             ((void *)0)
# 953 "project/radare2/libr/anal/dwarf_process.c"
                                 ;
 
# 954 "project/radare2/libr/anal/dwarf_process.c" 3 4
unsigned long long 
# 954 "project/radare2/libr/anal/dwarf_process.c"
     max_range_size = 0;
 RListIter *iter;
 RBinDwarfLocRange *range;
 
# 957 "project/radare2/libr/anal/dwarf_process.c" 3 4
if (
# 957 "project/radare2/libr/anal/dwarf_process.c"
loc_list
# 957 "project/radare2/libr/anal/dwarf_process.c" 3 4
) for (
# 957 "project/radare2/libr/anal/dwarf_process.c"
...
# 958 "project/radare2/libr/anal/dwarf_process.c" 3 4
 unsigned long long 
# 958 "project/radare2/libr/anal/dwarf_process.c"
...
# 977 "project/radare2/libr/anal/dwarf_process.c"
 if (loc->kind != DW_AT_KIND_BLOCK && loc->kind != DW_AT_KIND_LOCLISTPTR && loc->kind != DW_AT_KIND_REFERENCE && loc->kind != DW_AT_KIND_CONSTANT) {
  return 
# 978 "project/radare2/libr/anal/dwarf_process.c" 3 4
        ((void *)0)
# 978 "project/radare2/libr/anal/dwarf_process.c"
            ;
 }
 RBinDwarfBlock block;
 if (loc->kind == DW_AT_KIND_LOCLISTPTR || loc->kind == DW_AT_KIND_REFERENCE || loc->kind == DW_AT_KIND_CONSTANT) {
  
# 982 "project/radare2/libr/anal/dwarf_process.c" 3 4
 unsigned long long 
# 982 "project/radare2/libr/anal/dwarf_process.c"
      offset = loc->reference;
  RBinDwarfLocList *range_list = ht_up_find (ctx->locations, offset, 
# 983 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                                    ((void *)0)
# 983 "project/radare2/libr/anal/dwarf_process.c"
                                                                        );
  if (!range_list) {
   return 
# 985 "project/radare2/libr/anal/dwarf_process.c" 3 4
         ((void *)0)
# 985 "project/radare2/libr/anal/dwarf_process.c"
             ;
  }
  ...
  if (!range) {
   return 
# 990 "project/radare2/libr/anal/dwarf_process.c" 3 4
         ((void *)0)
# 990 "project/radare2/libr/anal/dwarf_process.c"
             ;
  }
...
# 999 "project/radare2/libr/anal/dwarf_process.c" 3 4
long long 
# 999 "project/radare2/libr/anal/dwarf_process.c"
     offset = 0;
 
# 1000 "project/radare2/libr/anal/dwarf_process.c" 3 4
unsigned long long 
# 1000 "project/radare2/libr/anal/dwarf_process.c"
     address = 0;
 
# 1001 "project/radare2/libr/anal/dwarf_process.c" 3 4
unsigned long long 
# 1001 "project/radare2/libr/anal/dwarf_process.c"
     reg_num = -1;
 const char *reg_name = 
# 1002 "project/radare2/libr/anal/dwarf_process.c" 3 4
                       ((void *)0)
# 1002 "project/radare2/libr/anal/dwarf_process.c"
                           ;
 size_t i;
 for (i = 0; i < block.length; i++) {
  switch (block.data[i]) {
  case 
# 1006 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x91
# 1006 "project/radare2/libr/anal/dwarf_process.c"
                 : {


   if (i == block.length - 1) {
    return 
# 1010 "project/radare2/libr/anal/dwarf_process.c" 3 4
          ((void *)0)
# 1010 "project/radare2/libr/anal/dwarf_process.c"
              ;
   }
   i++;
   const 
# 1013 "project/radare2/libr/anal/dwarf_process.c" 3 4
        unsigned char 
# 1013 "project/radare2/libr/anal/dwarf_process.c"
            *dump = block.data + i;
   if (loc->block.length > block.length) {

    return 
# 1016 "project/radare2/libr/anal/dwarf_process.c" 3 4
          ((void *)0)
# 1016 "project/radare2/libr/anal/dwarf_process.c"
              ;
   }
   ...
   if (frame_base) {
    ...
    VariableLocation *location = parse_dwarf_location (ctx, frame_base, 
# 1022 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                                       ((void *)0)
# 1022 "project/radare2/libr/anal/dwarf_process.c"
                                                                           );
    if (location) {
   ...
   return 
# 1030 "project/radare2/libr/anal/dwarf_process.c" 3 4
         ((void *)0)
# 1030 "project/radare2/libr/anal/dwarf_process.c"
             ;
  }
  case 
# 1032 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x50
# 1032 "project/radare2/libr/anal/dwarf_process.c"
                :
  case 
# 1033 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x51
# 1033 "project/radare2/libr/anal/dwarf_process.c"
                :
  case 
# 1034 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x52
# 1034 "project/radare2/libr/anal/dwarf_process.c"
                :
  case 
# 1035 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x53
# 1035 "project/radare2/libr/anal/dwarf_process.c"
                :
  case 
# 1036 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x54
# 1036 "project/radare2/libr/anal/dwarf_process.c"
                :
  case 
# 1037 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x55
# 1037 "project/radare2/libr/anal/dwarf_process.c"
                :
  case 
# 1038 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x56
# 1038 "project/radare2/libr/anal/dwarf_process.c"
                :
  case 
# 1039 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x57
# 1039 "project/radare2/libr/anal/dwarf_process.c"
                :
  case 
# 1040 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x58
# 1040 "project/radare2/libr/anal/dwarf_process.c"
                :
  case 
# 1041 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x59
# 1041 "project/radare2/libr/anal/dwarf_process.c"
                :
  case 
# 1042 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x5a
# 1042 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1043 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x5b
# 1043 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1044 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x5c
# 1044 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1045 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x5d
# 1045 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1046 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x5e
# 1046 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1047 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x5f
# 1047 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1048 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x60
# 1048 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1049 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x61
# 1049 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1050 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x62
# 1050 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1051 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x63
# 1051 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1052 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x64
# 1052 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1053 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x65
# 1053 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1054 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x66
# 1054 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1055 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x67
# 1055 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1056 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x68
# 1056 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1057 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x69
# 1057 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1058 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x6a
# 1058 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1059 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x6b
# 1059 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1060 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x6c
# 1060 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1061 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x6d
# 1061 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1062 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x6e
# 1062 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1063 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x6f
# 1063 "project/radare2/libr/anal/dwarf_process.c"
                 : {


   reg_num = block.data[i] - 
# 1066 "project/radare2/libr/anal/dwarf_process.c" 3 4
                            0x50
# 1066 "project/radare2/libr/anal/dwarf_process.c"
                                      ;
   reg_name = get_dwarf_reg_name (ctx->anal->cpu, reg_num, &kind, ctx->anal->bits);
   break;
  }
  case 
# 1070 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x70
# 1070 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1071 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x71
# 1071 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1072 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x72
# 1072 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1073 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x73
# 1073 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1074 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x74
# 1074 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1075 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x75
# 1075 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1076 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x76
# 1076 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1077 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x77
# 1077 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1078 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x78
# 1078 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1079 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x79
# 1079 "project/radare2/libr/anal/dwarf_process.c"
                 :
  case 
# 1080 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x7a
# 1080 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1081 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x7b
# 1081 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1082 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x7c
# 1082 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1083 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x7d
# 1083 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1084 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x7e
# 1084 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1085 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x7f
# 1085 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1086 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x80
# 1086 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1087 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x81
# 1087 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1088 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x82
# 1088 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1089 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x83
# 1089 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1090 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x84
# 1090 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1091 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x85
# 1091 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1092 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x86
# 1092 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1093 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x87
# 1093 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1094 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x88
# 1094 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1095 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x89
# 1095 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1096 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x8a
# 1096 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1097 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x8b
# 1097 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1098 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x8c
# 1098 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1099 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x8d
# 1099 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1100 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x8e
# 1100 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1101 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x8f
# 1101 "project/radare2/libr/anal/dwarf_process.c"
                  : {
   if (i == block.length - 1) {
    return 
# 1103 "project/radare2/libr/anal/dwarf_process.c" 3 4
          ((void *)0)
# 1103 "project/radare2/libr/anal/dwarf_process.c"
              ;
   }


   reg_num = block.data[i] - 
# 1107 "project/radare2/libr/anal/dwarf_process.c" 3 4
                            0x70
# 1107 "project/radare2/libr/anal/dwarf_process.c"
                                       ;
   const 
# 1108 "project/radare2/libr/anal/dwarf_process.c" 3 4
        unsigned char 
# 1108 "project/radare2/libr/anal/dwarf_process.c"
            *buffer = &block.data[++i];
  ...
  case 
# 1115 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x92
# 1115 "project/radare2/libr/anal/dwarf_process.c"
                 : {
   if (i == block.length - 1) {
    return 
# 1117 "project/radare2/libr/anal/dwarf_process.c" 3 4
          ((void *)0)
# 1117 "project/radare2/libr/anal/dwarf_process.c"
              ;
   }


   const 
# 1121 "project/radare2/libr/anal/dwarf_process.c" 3 4
        unsigned char 
# 1121 "project/radare2/libr/anal/dwarf_process.c"
            *buffer = &block.data[++i];
   const 
# 1122 "project/radare2/libr/anal/dwarf_process.c" 3 4
        unsigned char 
# 1122 "project/radare2/libr/anal/dwarf_process.c"
            *buf_end = &block.data[block.length];
   buffer = r_uleb128 (buffer, buf_end - buffer, &reg_num, 
# 1123 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                          ((void *)0)
# 1123 "project/radare2/libr/anal/dwarf_process.c"
                                                              );
   if (buffer == buf_end) {
    return 
# 1125 "project/radare2/libr/anal/dwarf_process.c" 3 4
          ((void *)0)
# 1125 "project/radare2/libr/anal/dwarf_process.c"
              ;
   }
  ...
  case 
# 1131 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x03
# 1131 "project/radare2/libr/anal/dwarf_process.c"
                : {


   const int addr_size = ctx->anal->bits / 8;
   const 
# 1135 "project/radare2/libr/anal/dwarf_process.c" 3 4
        unsigned char 
# 1135 "project/radare2/libr/anal/dwarf_process.c"
            *dump = &block.data[++i];

   if (block.length - i < addr_size) {
    return 
# 1138 "project/radare2/libr/anal/dwarf_process.c" 3 4
          ((void *)0)
# 1138 "project/radare2/libr/anal/dwarf_process.c"
              ;
   }
   switch (addr_size) {
   case 1:
...
# 1154 "project/radare2/libr/anal/dwarf_process.c" 3 4
   do { r_assert_log (R_LOGLVL_WARN, "(%s:%d):%s%s code should not be reached\n", "project/radare2/libr/anal/dwarf_process.c", 1154, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : ""); } while (0)
# 1154 "project/radare2/libr/anal/dwarf_process.c"
                       ;
    return 
# 1155 "project/radare2/libr/anal/dwarf_process.c" 3 4
          ((void *)0)
# 1155 "project/radare2/libr/anal/dwarf_process.c"
              ;
   }
  ...
  case 
# 1160 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x9c
# 1160 "project/radare2/libr/anal/dwarf_process.c"
                          : {
 ...
 if (kind == LOCATION_UNKNOWN) {
  return 
# 1171 "project/radare2/libr/anal/dwarf_process.c" 3 4
        ((void *)0)
# 1171 "project/radare2/libr/anal/dwarf_process.c"
            ;
 }
 VariableLocation *location = 
# 1173 "project/radare2/libr/anal/dwarf_process.c" 3 4
                             (
# 1173 "project/radare2/libr/anal/dwarf_process.c"
                             VariableLocation
# 1173 "project/radare2/libr/anal/dwarf_process.c" 3 4
                             *)calloc(1,sizeof(
# 1173 "project/radare2/libr/anal/dwarf_process.c"
...
static 
# 1184 "project/radare2/libr/anal/dwarf_process.c" 3 4
      int 
# 1184 "project/radare2/libr/anal/dwarf_process.c"
           parse_function_args_and_vars(Context *ctx, 
# 1184 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                      unsigned long long 
# 1184 "project/radare2/libr/anal/dwarf_process.c"
                                                           idx, RStrBuf *args, RList *variables) {
 const RBinDwarfDie *die = &ctx->all_dies[idx++];
...
# 1190 "project/radare2/libr/anal/dwarf_process.c" 3 4
 _Bool 
# 1190 "project/radare2/libr/anal/dwarf_process.c"
      get_linkage_name = prefer_linkage_name (ctx->lang);
  
# 1191 "project/radare2/libr/anal/dwarf_process.c" 3 4
 _Bool 
# 1191 "project/radare2/libr/anal/dwarf_process.c"
      has_linkage_name = 
# 1191 "project/radare2/libr/anal/dwarf_process.c" 3 4
                         0
# 1191 "project/radare2/libr/anal/dwarf_process.c"
  ...
  int argNumber = 1;
  const char *name = 
# 1193 "project/radare2/libr/anal/dwarf_process.c" 3 4
                    ((void *)0)
# 1193 "project/radare2/libr/anal/dwarf_process.c"
                        ;
  size_t j;
  for (j = idx; child_depth > 0 && j < ctx->count; j++) {
   const RBinDwarfDie *child_die = &ctx->all_dies[j];
   ...
   r_strbuf_init (&type);
   if (child_die->tag == 
# 1199 "project/radare2/libr/anal/dwarf_process.c" 3 4
                        0x05 
# 1199 "project/radare2/libr/anal/dwarf_process.c"
                                                || child_die->tag == 
# 1199 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                                     0x34
# 1199 "project/radare2/libr/anal/dwarf_process.c"
    ...
    Variable *var = 
# 1200 "project/radare2/libr/anal/dwarf_process.c" 3 4
                   (
# 1200 "project/radare2/libr/anal/dwarf_process.c"
                   Variable
# 1200 "project/radare2/libr/anal/dwarf_process.c" 3 4
                   *)calloc(1,sizeof(
# 1200 "project/radare2/libr/anal/dwarf_process.c"
...
# 1200 "project/radare2/libr/anal/dwarf_process.c"
    ...
    size_t i;
    name = 
# 1202 "project/radare2/libr/anal/dwarf_process.c" 3 4
          ((void *)0)
# 1202 "project/radare2/libr/anal/dwarf_process.c"
              ;
    for (i = 0; i < child_die->count; i++) {
     const RBinDwarfAttrValue *val = &child_die->attr_values[i];
     switch (val->attr_name) {
     case 
# 1206 "project/radare2/libr/anal/dwarf_process.c" 3 4
         0x03
# 1206 "project/radare2/libr/anal/dwarf_process.c"
                   :
      if (!get_linkage_name || !has_linkage_name) {
       name = val->string.content;
      }
      break;
     case 
# 1211 "project/radare2/libr/anal/dwarf_process.c" 3 4
         0x6e
# 1211 "project/radare2/libr/anal/dwarf_process.c"
                           :
     case 
# 1212 "project/radare2/libr/anal/dwarf_process.c" 3 4
         0x2007
# 1212 "project/radare2/libr/anal/dwarf_process.c"
                                :
      name = val->string.content;
      has_linkage_name = 
# 1214 "project/radare2/libr/anal/dwarf_process.c" 3 4
                        1
# 1214 "project/radare2/libr/anal/dwarf_process.c"
                            ;
      break;
     case 
# 1216 "project/radare2/libr/anal/dwarf_process.c" 3 4
         0x49
# 1216 "project/radare2/libr/anal/dwarf_process.c"
                   :
      parse_type (ctx, val->reference, &type, 
# 1217 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                             ((void *)0)
# 1217 "project/radare2/libr/anal/dwarf_process.c"
                                                 , 
# 1217 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                   ((void *)0)
# 1217 "project/radare2/libr/anal/dwarf_process.c"
     ...
     case 
# 1220 "project/radare2/libr/anal/dwarf_process.c" 3 4
         0x31
# 1220 "project/radare2/libr/anal/dwarf_process.c"
                              :
      parse_abstract_origin (ctx, val->reference, &type, &name);
      break;
     case 
# 1223 "project/radare2/libr/anal/dwarf_process.c" 3 4
         0x02
# 1223 "project/radare2/libr/anal/dwarf_process.c"
                       :
      var->location = parse_dwarf_location (ctx, val, find_attr (die, 
# 1224 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                                     0x40
# 1224 "project/radare2/libr/anal/dwarf_process.c"
                                                                                     ));
      break;
     default:
      break;
    ...
    if (child_die->tag == 
# 1230 "project/radare2/libr/anal/dwarf_process.c" 3 4
                         0x05 
# 1230 "project/radare2/libr/anal/dwarf_process.c"
                                                 && child_depth == 1) {
   ...
   } else if (child_depth == 1 && child_die->tag == 
# 1255 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                   0x18
# 1255 "project/radare2/libr/anal/dwarf_process.c"
                                                                                ) {
...
static void sdb_save_dwarf_function(Function *dwarf_fcn, RList *variables, Sdb *sdb) {
 ...
 char *addr_val = r_str_newf ("0x%" 
# 1278 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                   "llx" 
# 1278 "project/radare2/libr/anal/dwarf_process.c"
                                           "", dwarf_fcn->addr);
...
# 1298 "project/radare2/libr/anal/dwarf_process.c" 3 4
if (
# 1298 "project/radare2/libr/anal/dwarf_process.c"
variables
# 1298 "project/radare2/libr/anal/dwarf_process.c" 3 4
) for (
# 1298 "project/radare2/libr/anal/dwarf_process.c"
...
# 1298 "project/radare2/libr/anal/dwarf_process.c"
  ...
  char *key = 
# 1303 "project/radare2/libr/anal/dwarf_process.c" 3 4
             ((void *)0)
# 1303 "project/radare2/libr/anal/dwarf_process.c"
                 ;
  char *val = 
# 1304 "project/radare2/libr/anal/dwarf_process.c" 3 4
             ((void *)0)
# 1304 "project/radare2/libr/anal/dwarf_process.c"
                 ;
  ...
  case LOCATION_BP: {
   ...
   val = r_str_newf ("%s,%" 
# 1311 "project/radare2/libr/anal/dwarf_process.c" 3 4
                           "lld" 
# 1311 "project/radare2/libr/anal/dwarf_process.c"
                                   ",%s", "b", var->location->offset, var->type);
  ...
  case LOCATION_SP: {
   ...
   key = r_str_newf ("fcn.%s.var.%s", sname, var->name);
   val = r_str_newf ("%s,%" 
# 1320 "project/radare2/libr/anal/dwarf_process.c" 3 4
                           "lld" 
# 1320 "project/radare2/libr/anal/dwarf_process.c"
                                   ",%s", "s", var->location->offset, var->type);
   sdb_set (sdb, key, val, 0);
   break;
  }
  case LOCATION_GLOBAL: {
   ...
   key = r_str_newf ("fcn.%s.var.%s", sname, var->name);
   val = r_str_newf ("%s,%" 
# 1329 "project/radare2/libr/anal/dwarf_process.c" 3 4
                           "llu" 
# 1329 "project/radare2/libr/anal/dwarf_process.c"
                                   ",%s", "g", var->location->address, var->type);
   sdb_set (sdb, key, val, 0);
   break;
  }
...
# 1369 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                        unsigned long long 
# 1369 "project/radare2/libr/anal/dwarf_process.c"
                                             idx) {
 const RBinDwarfDie *die = &ctx->all_dies[idx];
...
# 1373 "project/radare2/libr/anal/dwarf_process.c" 3 4
_Bool 
# 1373 "project/radare2/libr/anal/dwarf_process.c"
     has_linkage_name = 
# 1373 "project/radare2/libr/anal/dwarf_process.c" 3 4
                        0
# 1373 "project/radare2/libr/anal/dwarf_process.c"
...
# 1374 "project/radare2/libr/anal/dwarf_process.c" 3 4
_Bool 
# 1374 "project/radare2/libr/anal/dwarf_process.c"
     get_linkage_name = prefer_linkage_name (ctx->lang);
 RStrBuf ret_type;
 r_strbuf_init (&ret_type);
 if (find_attr_idx (die, 
# 1377 "project/radare2/libr/anal/dwarf_process.c" 3 4
                        0x3c
# 1377 "project/radare2/libr/anal/dwarf_process.c"
                                         ) != -1) {
  return;
 }
 size_t i;
 ...
 for (i = 0; i < die->count; i++) {
  ...
  switch (die->attr_values[i].attr_name) {
  case 
# 1385 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x03
# 1385 "project/radare2/libr/anal/dwarf_process.c"
                :
   if (!get_linkage_name || !has_linkage_name) {
   ...
   break;
  case 
# 1390 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x6e
# 1390 "project/radare2/libr/anal/dwarf_process.c"
                        :
  case 
# 1391 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x2007
# 1391 "project/radare2/libr/anal/dwarf_process.c"
                             :
   fcn.name = val->string.content;
   has_linkage_name = 
# 1393 "project/radare2/libr/anal/dwarf_process.c" 3 4
                     1
# 1393 "project/radare2/libr/anal/dwarf_process.c"
                         ;
   break;
  case 
# 1395 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x11
# 1395 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1396 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x52
# 1396 "project/radare2/libr/anal/dwarf_process.c"
                    :
   fcn.addr = val->address;
   break;
  case 
# 1399 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x47
# 1399 "project/radare2/libr/anal/dwarf_process.c"
                         :
  {
   RBinDwarfDie *spec_die = ht_up_find (ctx->die_map, val->reference, 
# 1401 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                                     ((void *)0)
# 1401 "project/radare2/libr/anal/dwarf_process.c"
                                                                         );
   if (spec_die) {
  ...
  case 
# 1408 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x49
# 1408 "project/radare2/libr/anal/dwarf_process.c"
                :
   parse_type (ctx, val->reference, &ret_type, 
# 1409 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                              ((void *)0)
# 1409 "project/radare2/libr/anal/dwarf_process.c"
                                                  , 
# 1409 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                    ((void *)0)
# 1409 "project/radare2/libr/anal/dwarf_process.c"
   ...
   break;
  case 
# 1411 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x4c
# 1411 "project/radare2/libr/anal/dwarf_process.c"
                      :
   fcn.is_method = 
# 1412 "project/radare2/libr/anal/dwarf_process.c" 3 4
                  1
# 1412 "project/radare2/libr/anal/dwarf_process.c"
                      ;
   fcn.is_virtual = 
# 1413 "project/radare2/libr/anal/dwarf_process.c" 3 4
                   1
# 1413 "project/radare2/libr/anal/dwarf_process.c"
                       ;
   break;
  case 
# 1415 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x64
# 1415 "project/radare2/libr/anal/dwarf_process.c"
                          :
   fcn.is_method = 
# 1416 "project/radare2/libr/anal/dwarf_process.c" 3 4
                  1
# 1416 "project/radare2/libr/anal/dwarf_process.c"
                      ;
   break;
  case 
# 1418 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x4d
# 1418 "project/radare2/libr/anal/dwarf_process.c"
                                :
   fcn.is_method = 
# 1419 "project/radare2/libr/anal/dwarf_process.c" 3 4
                  1
# 1419 "project/radare2/libr/anal/dwarf_process.c"
                      ;
   fcn.vtable_addr = 0;
   break;
  case 
# 1422 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x32
# 1422 "project/radare2/libr/anal/dwarf_process.c"
                         :
   fcn.is_method = 
# 1423 "project/radare2/libr/anal/dwarf_process.c" 3 4
                  1
# 1423 "project/radare2/libr/anal/dwarf_process.c"
                      ;
   fcn.access = (
# 1424 "project/radare2/libr/anal/dwarf_process.c" 3 4
                unsigned char
# 1424 "project/radare2/libr/anal/dwarf_process.c"
                   )val->uconstant;
   break;
  case 
# 1426 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x3f
# 1426 "project/radare2/libr/anal/dwarf_process.c"
                    :
   fcn.is_external = 
# 1427 "project/radare2/libr/anal/dwarf_process.c" 3 4
                    1
# 1427 "project/radare2/libr/anal/dwarf_process.c"
                        ;
   break;
  case 
# 1429 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x56
# 1429 "project/radare2/libr/anal/dwarf_process.c"
                      :
   fcn.is_trampoline = 
# 1430 "project/radare2/libr/anal/dwarf_process.c" 3 4
                      1
# 1430 "project/radare2/libr/anal/dwarf_process.c"
                          ;
   break;
  case 
# 1432 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x55
# 1432 "project/radare2/libr/anal/dwarf_process.c"
                  :
  case 
# 1433 "project/radare2/libr/anal/dwarf_process.c" 3 4
      0x12
# 1433 "project/radare2/libr/anal/dwarf_process.c"
                   :
  default:
   break;
  }
...
# 1451 "project/radare2/libr/anal/dwarf_process.c" 3 4
do { if (!(
# 1451 "project/radare2/libr/anal/dwarf_process.c"
ctx->lang
# 1451 "project/radare2/libr/anal/dwarf_process.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "WARNING (%s:%d):%s%s runtime check failed: (%s)\n", "project/radare2/libr/anal/dwarf_process.c", 1451, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : "", 
# 1451 "project/radare2/libr/anal/dwarf_process.c"
"ctx->lang"
# 1451 "project/radare2/libr/anal/dwarf_process.c" 3 4
); } } while (0)
# 1451 "project/radare2/libr/anal/dwarf_process.c"
 ...
 char *new_name = ctx->anal->binb.demangle
  ? ctx->anal->binb.demangle (
# 1453 "project/radare2/libr/anal/dwarf_process.c" 3 4
                             ((void *)0)
# 1453 "project/radare2/libr/anal/dwarf_process.c"
                                 , ctx->lang, fcn.name, fcn.addr, 
# 1453 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                                  0
# 1453 "project/radare2/libr/anal/dwarf_process.c"
                                                                       ): 
...
# 1463 "project/radare2/libr/anal/dwarf_process.c" 3 4
if (
# 1463 "project/radare2/libr/anal/dwarf_process.c"
variables
# 1463 "project/radare2/libr/anal/dwarf_process.c" 3 4
) for (
# 1463 "project/radare2/libr/anal/dwarf_process.c"
...
# 1479 "project/radare2/libr/anal/dwarf_process.c" 3 4
do { if (!(
# 1479 "project/radare2/libr/anal/dwarf_process.c"
die
# 1479 "project/radare2/libr/anal/dwarf_process.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1479 "project/radare2/libr/anal/dwarf_process.c"
"die"
# 1479 "project/radare2/libr/anal/dwarf_process.c" 3 4
, 1479); return (((void *)0)); } } while (0)
# 1479 "project/radare2/libr/anal/dwarf_process.c"
                                ;

 int idx = find_attr_idx (die, 
# 1481 "project/radare2/libr/anal/dwarf_process.c" 3 4
                              0x13
# 1481 "project/radare2/libr/anal/dwarf_process.c"
                                            );
 const char *lang = "cxx";
 if (idx == -1) {
...
# 1488 "project/radare2/libr/anal/dwarf_process.c" 3 4
do { if (!(
# 1488 "project/radare2/libr/anal/dwarf_process.c"
val->kind == DW_AT_KIND_CONSTANT
# 1488 "project/radare2/libr/anal/dwarf_process.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "WARNING (%s:%d):%s%s runtime check failed: (%s)\n", "project/radare2/libr/anal/dwarf_process.c", 1488, ((const char*) (__func__)), ((const char*) (__func__))[0] ? ":" : "", 
# 1488 "project/radare2/libr/anal/dwarf_process.c"
"val->kind == DW_AT_KIND_CONSTANT"
# 1488 "project/radare2/libr/anal/dwarf_process.c" 3 4
); } } while (0)
# 1488 "project/radare2/libr/anal/dwarf_process.c"
 ...
 {
 case 
# 1492 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x000b
# 1492 "project/radare2/libr/anal/dwarf_process.c"
                 :
  return "java";
 case 
# 1494 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x0010
# 1494 "project/radare2/libr/anal/dwarf_process.c"
                 :

 case 
# 1496 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x0011
# 1496 "project/radare2/libr/anal/dwarf_process.c"
                           :
  return "objc";
 case 
# 1498 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x0013
# 1498 "project/radare2/libr/anal/dwarf_process.c"
              :
  return "dlang";
 case 
# 1500 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x001c
# 1500 "project/radare2/libr/anal/dwarf_process.c"
                 :
  return "rust";
 case 
# 1502 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x0004
# 1502 "project/radare2/libr/anal/dwarf_process.c"
                        :
 case 
# 1503 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x0021
# 1503 "project/radare2/libr/anal/dwarf_process.c"
                           :

 case 
# 1505 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x0003
# 1505 "project/radare2/libr/anal/dwarf_process.c"
                  :
 case 
# 1506 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x0005
# 1506 "project/radare2/libr/anal/dwarf_process.c"
                    :
 case 
# 1507 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x0006
# 1507 "project/radare2/libr/anal/dwarf_process.c"
                    :
 case 
# 1508 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x0007
# 1508 "project/radare2/libr/anal/dwarf_process.c"
                      :
 case 
# 1509 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x0008
# 1509 "project/radare2/libr/anal/dwarf_process.c"
                      :
 case 
# 1510 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x0009
# 1510 "project/radare2/libr/anal/dwarf_process.c"
                     :
 case 
# 1511 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x000a
# 1511 "project/radare2/libr/anal/dwarf_process.c"
                    :
 case 
# 1512 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x000d
# 1512 "project/radare2/libr/anal/dwarf_process.c"
                  :
 case 
# 1513 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x000e
# 1513 "project/radare2/libr/anal/dwarf_process.c"
                      :
 case 
# 1514 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x000f
# 1514 "project/radare2/libr/anal/dwarf_process.c"
                :
 case 
# 1515 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x0014
# 1515 "project/radare2/libr/anal/dwarf_process.c"
                   :
 case 
# 1516 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x001e
# 1516 "project/radare2/libr/anal/dwarf_process.c"
                  :
 case 
# 1517 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x001f
# 1517 "project/radare2/libr/anal/dwarf_process.c"
                  :
 case 
# 1518 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x0020
# 1518 "project/radare2/libr/anal/dwarf_process.c"
                  :
 case 
# 1519 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x0022
# 1519 "project/radare2/libr/anal/dwarf_process.c"
                      :
 case 
# 1520 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x0023
# 1520 "project/radare2/libr/anal/dwarf_process.c"
                      :
 case 
# 1521 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x0012
# 1521 "project/radare2/libr/anal/dwarf_process.c"
                :
 case 
# 1522 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x0002
# 1522 "project/radare2/libr/anal/dwarf_process.c"
              :
 case 
# 1523 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x0001
# 1523 "project/radare2/libr/anal/dwarf_process.c"
                :
 case 
# 1524 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x000c
# 1524 "project/radare2/libr/anal/dwarf_process.c"
                :
 case 
# 1525 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x001d
# 1525 "project/radare2/libr/anal/dwarf_process.c"
                :
 default:
  return lang;
 }
...
# 1538 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                          unsigned long long 
# 1538 "project/radare2/libr/anal/dwarf_process.c"
                                               idx) {
 
# 1539 "project/radare2/libr/anal/dwarf_process.c" 3 4
do { if (!(
# 1539 "project/radare2/libr/anal/dwarf_process.c"
ctx
# 1539 "project/radare2/libr/anal/dwarf_process.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1539 "project/radare2/libr/anal/dwarf_process.c"
...
# 1539 "project/radare2/libr/anal/dwarf_process.c"
 ...
 switch (die->tag) {
 case 
# 1543 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x13
# 1543 "project/radare2/libr/anal/dwarf_process.c"
                          :
 case 
# 1544 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x17
# 1544 "project/radare2/libr/anal/dwarf_process.c"
                      :
 case 
# 1545 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x02
# 1545 "project/radare2/libr/anal/dwarf_process.c"
                      :
  parse_structure_type (ctx, idx);
  break;
 case 
# 1548 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x04
# 1548 "project/radare2/libr/anal/dwarf_process.c"
                            :
  parse_enum_type (ctx, idx);
  break;
 case 
# 1551 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x16
# 1551 "project/radare2/libr/anal/dwarf_process.c"
                   :
  parse_typedef (ctx, idx);
  break;
 case 
# 1554 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x24
# 1554 "project/radare2/libr/anal/dwarf_process.c"
                     :
  parse_atomic_type (ctx, idx);
  break;
 case 
# 1557 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x2e
# 1557 "project/radare2/libr/anal/dwarf_process.c"
                      :
  parse_function (ctx, idx);
  break;
 case 
# 1560 "project/radare2/libr/anal/dwarf_process.c" 3 4
     0x11
# 1560 "project/radare2/libr/anal/dwarf_process.c"
                        :
...
# 1575 "project/radare2/libr/anal/dwarf_process.c" 3 4
__attribute__((visibility("default"))) 
# 1575 "project/radare2/libr/anal/dwarf_process.c"
     void r_anal_dwarf_process_info(const RAnal *anal, RAnalDwarfContext *ctx) {
 
# 1576 "project/radare2/libr/anal/dwarf_process.c" 3 4
do { if (!(
# 1576 "project/radare2/libr/anal/dwarf_process.c"
ctx && anal
# 1576 "project/radare2/libr/anal/dwarf_process.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1576 "project/radare2/libr/anal/dwarf_process.c"
...
# 1576 "project/radare2/libr/anal/dwarf_process.c"
 ...
 for (i = 0; i < info->count; i++) {
  ...
  Context dw_context = {
   ...
   .locations = ctx->loc,
   .lang = 
# 1589 "project/radare2/libr/anal/dwarf_process.c" 3 4
          ((void *)0)
  
# 1590 "project/radare2/libr/anal/dwarf_process.c"
 };
...
# 1597 "project/radare2/libr/anal/dwarf_process.c" 3 4
_Bool 
# 1597 "project/radare2/libr/anal/dwarf_process.c"
    filter_sdb_function_names(void *user, const char *k, const char *v) {
 (void) user;
 (void) k;
 return !strcmp (v, "fcn");
}
...
# 1610 "project/radare2/libr/anal/dwarf_process.c" 3 4
__attribute__((visibility("default"))) 
# 1610 "project/radare2/libr/anal/dwarf_process.c"
     void r_anal_dwarf_integrate_functions(RAnal *anal, RFlag *flags, Sdb *dwarf_sdb) {
 
# 1611 "project/radare2/libr/anal/dwarf_process.c" 3 4
do { if (!(
# 1611 "project/radare2/libr/anal/dwarf_process.c"
anal && dwarf_sdb
# 1611 "project/radare2/libr/anal/dwarf_process.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1611 "project/radare2/libr/anal/dwarf_process.c"
...
# 1611 "project/radare2/libr/anal/dwarf_process.c"
 ...
 SdbList *sdb_list = sdb_foreach_list_filter (dwarf_sdb, filter_sdb_function_names, 
# 1614 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                                                   0
# 1614 "project/radare2/libr/anal/dwarf_process.c"
                                                                                        );
 SdbListIter *it;
 SdbKv *kv;

 
# 1618 "project/radare2/libr/anal/dwarf_process.c" 3 4
if ((
# 1618 "project/radare2/libr/anal/dwarf_process.c"
sdb_list
# 1618 "project/radare2/libr/anal/dwarf_process.c" 3 4
)) for (
# 1618 "project/radare2/libr/anal/dwarf_process.c"
...
# 1622 "project/radare2/libr/anal/dwarf_process.c" 3 4
 unsigned long long 
# 1622 "project/radare2/libr/anal/dwarf_process.c"
      faddr = sdb_num_get (dwarf_sdb, addr_key, 0);
  free (addr_key);
  ...
  char *vars = sdb_get (dwarf_sdb, var_names_key, 
# 1647 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                 ((void *)0)
# 1647 "project/radare2/libr/anal/dwarf_process.c"
                                                     );
  char *var_name;
  
# 1649 "project/radare2/libr/anal/dwarf_process.c" 3 4
 { char *next; if (
# 1649 "project/radare2/libr/anal/dwarf_process.c"
 vars
# 1649 "project/radare2/libr/anal/dwarf_process.c" 3 4
 ) for (
# 1649 "project/radare2/libr/anal/dwarf_process.c"
...
# 1649 "project/radare2/libr/anal/dwarf_process.c"
   ...
   char *var_data = sdb_get (dwarf_sdb, var_key, 
# 1651 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                ((void *)0)
# 1651 "project/radare2/libr/anal/dwarf_process.c"
                                                    );
   if (!var_data) {
    goto loop_end;
   }
   char *extra = 
# 1655 "project/radare2/libr/anal/dwarf_process.c" 3 4
                ((void *)0)
# 1655 "project/radare2/libr/anal/dwarf_process.c"
                    ;
   char *kind = sdb_anext (var_data, &extra);
   char *type = 
# 1657 "project/radare2/libr/anal/dwarf_process.c" 3 4
               ((void *)0)
# 1657 "project/radare2/libr/anal/dwarf_process.c"
                   ;
   extra = sdb_anext (extra, &type);
   
# 1659 "project/radare2/libr/anal/dwarf_process.c" 3 4
  long long 
# 1659 "project/radare2/libr/anal/dwarf_process.c"
       offset = 0;
   if (*kind != 'r') {
    offset = strtol (extra, 
# 1661 "project/radare2/libr/anal/dwarf_process.c" 3 4
                           ((void *)0)
# 1661 "project/radare2/libr/anal/dwarf_process.c"
                               , 10);
   }
   if (*kind == 'g') {
    ...
    r_anal_function_set_var (fcn, offset - fcn->maxstack, *kind, type, 4, 
# 1669 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                                         0
# 1669 "project/radare2/libr/anal/dwarf_process.c"
                                                                              , var_name);
   } else if (*kind == 'r' && fcn) {
    ...
    r_anal_function_set_var (fcn, i->index, *kind, type, 4, 
# 1675 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                           0
# 1675 "project/radare2/libr/anal/dwarf_process.c"
                                                                , var_name);
   } else if (fcn) {
    r_anal_function_set_var (fcn, offset - fcn->bp_off, *kind, type, 4, 
# 1677 "project/radare2/libr/anal/dwarf_process.c" 3 4
                                                                       0
# 1677 "project/radare2/libr/anal/dwarf_process.c"
                                                                            , var_name);
   }
   free (var_key);
   free (var_data);
...
# 1682 "project/radare2/libr/anal/dwarf_process.c" 3 4
  if (!next) break; *(next-1) = ','; 
# 1682 "project/radare2/libr/anal/dwarf_process.c"
  var_name 
# 1682 "project/radare2/libr/anal/dwarf_process.c" 3 4
  = next; } }
# 1682 "project/radare2/libr/anal/dwarf_process.c"
