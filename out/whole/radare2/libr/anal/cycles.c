# 0 "project/radare2/libr/anal/cycles.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/anal/cycles.c" 2



__attribute__((visibility("default"))) 
# 7 "project/radare2/libr/anal/cycles.c"
     RAnalCycleFrame *r_anal_cycle_frame_new(void) {
 RAnalCycleFrame *cf = 
# 8 "project/radare2/libr/anal/cycles.c" 3 4
                      (
# 8 "project/radare2/libr/anal/cycles.c"
                      RAnalCycleFrame
# 8 "project/radare2/libr/anal/cycles.c" 3 4
                      *)calloc(1,sizeof(
# 8 "project/radare2/libr/anal/cycles.c"
...
# 11 "project/radare2/libr/anal/cycles.c" 3 4
  { free((void *)
# 11 "project/radare2/libr/anal/cycles.c"
  cf
# 11 "project/radare2/libr/anal/cycles.c" 3 4
  ); 
# 11 "project/radare2/libr/anal/cycles.c"
...
# 17 "project/radare2/libr/anal/cycles.c" 3 4
__attribute__((visibility("default"))) 
# 17 "project/radare2/libr/anal/cycles.c"
     void r_anal_cycle_frame_free(RAnalCycleFrame *cf) {
 if (!cf) {
  return;
 }
