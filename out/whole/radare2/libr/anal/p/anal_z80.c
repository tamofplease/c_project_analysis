# 0 "project/radare2/libr/anal/p/anal_z80.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/p/anal_z80.c"
...
# 4 "project/radare2/libr/anal/p/anal_z80.c" 2
...
# 5 "project/radare2/libr/anal/p/anal_z80.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_z80.c" 2
...
# 7 "project/radare2/libr/anal/p/anal_z80.c" 2

# 1 "project/radare2/libr/anal/p/../../asm/arch/z80/z80_tab.h" 1
...
# 11 "project/radare2/libr/anal/p/../../asm/arch/z80/z80_tab.h"
enum {
 Z80_OP_UNK = 1,
 Z80_OP8 = 2,
 Z80_OP16 = 4,
...
static 
# 28 "project/radare2/libr/anal/p/../../asm/arch/z80/z80_tab.h" 3 4
      unsigned char 
# 28 "project/radare2/libr/anal/p/../../asm/arch/z80/z80_tab.h"
...
static 
# 147 "project/radare2/libr/anal/p/../../asm/arch/z80/z80_tab.h" 3 4
      unsigned char 
# 147 "project/radare2/libr/anal/p/../../asm/arch/z80/z80_tab.h"
...
# 9 "project/radare2/libr/anal/p/anal_z80.c" 2

static void z80_op_size(const 
# 10 "project/radare2/libr/anal/p/anal_z80.c" 3 4
                             unsigned char 
# 10 "project/radare2/libr/anal/p/anal_z80.c"
                                 *_data, int len, int *size, int *size_prefix) {
 
# 11 "project/radare2/libr/anal/p/anal_z80.c" 3 4
unsigned char 
# 11 "project/radare2/libr/anal/p/anal_z80.c"
    data[4] = {0};
 int type = 0;
 if (len < 1) {
  return;
...
# 16 "project/radare2/libr/anal/p/anal_z80.c" 3 4
__builtin___memcpy_chk (
# 16 "project/radare2/libr/anal/p/anal_z80.c"
data
# 16 "project/radare2/libr/anal/p/anal_z80.c" 3 4
, 
# 16 "project/radare2/libr/anal/p/anal_z80.c"
...
static int z80_anal_op(RAnal *anal, RAnalOp *op, 
# 54 "project/radare2/libr/anal/p/anal_z80.c" 3 4
                                                unsigned long long 
# 54 "project/radare2/libr/anal/p/anal_z80.c"
                                                     addr, const 
# 54 "project/radare2/libr/anal/p/anal_z80.c" 3 4
                                                                 unsigned char 
# 54 "project/radare2/libr/anal/p/anal_z80.c"
                                                                     *_data, int len, RAnalOpMask mask) {
 int ilen = 0;
 
# 56 "project/radare2/libr/anal/p/anal_z80.c" 3 4
unsigned char 
# 56 "project/radare2/libr/anal/p/anal_z80.c"
    data[4] = {0};
 
# 57 "project/radare2/libr/anal/p/anal_z80.c" 3 4
__builtin___memcpy_chk (
# 57 "project/radare2/libr/anal/p/anal_z80.c"
data
# 57 "project/radare2/libr/anal/p/anal_z80.c" 3 4
, 
# 57 "project/radare2/libr/anal/p/anal_z80.c"
...
# 57 "project/radare2/libr/anal/p/anal_z80.c"
 ...
 case 0xc9:
  ...
  op->eob = 
# 140 "project/radare2/libr/anal/p/anal_z80.c" 3 4
           1
# 140 "project/radare2/libr/anal/p/anal_z80.c"
               ;
 ...
 case 0xed:
  ...
  case 0x4d:
   op->type = R_ANAL_OP_TYPE_RET;
   op->eob = 
# 165 "project/radare2/libr/anal/p/anal_z80.c" 3 4
            1
# 165 "project/radare2/libr/anal/p/anal_z80.c"
                ;
   break;
  }
  break;
 ...
 case 0x10:
  ...
  op->jump = addr + (
# 226 "project/radare2/libr/anal/p/anal_z80.c" 3 4
                    signed char
# 226 "project/radare2/libr/anal/p/anal_z80.c"
                       )data[1] + ilen ;
  op->fail = addr + ilen;
  break;
 case 0x18:
  ...
  op->jump = addr + (
# 231 "project/radare2/libr/anal/p/anal_z80.c" 3 4
                    signed char
# 231 "project/radare2/libr/anal/p/anal_z80.c"
                       )data[1] + ilen;
  break;
 ...
 case 0x38:
  op->type = R_ANAL_OP_TYPE_CJMP;
  op->jump = addr + ((len>1)? (
# 239 "project/radare2/libr/anal/p/anal_z80.c" 3 4
                              signed char
# 239 "project/radare2/libr/anal/p/anal_z80.c"
                                 )data[1]:0) + ilen;
  op->fail = addr + ilen;
  break;
...
static 
# 368 "project/radare2/libr/anal/p/anal_z80.c" 3 4
      _Bool 
# 368 "project/radare2/libr/anal/p/anal_z80.c"
...
static int archinfo(RAnal *anal, int q) {
 switch (q) {
 case 
# 412 "project/radare2/libr/anal/p/anal_z80.c" 3 4
     4
# 412 "project/radare2/libr/anal/p/anal_z80.c"
                          :
  return 0;
 case 
# 414 "project/radare2/libr/anal/p/anal_z80.c" 3 4
     1
# 414 "project/radare2/libr/anal/p/anal_z80.c"
                                :
  return 3;
 case 
# 416 "project/radare2/libr/anal/p/anal_z80.c" 3 4
     2
# 416 "project/radare2/libr/anal/p/anal_z80.c"
                                :
  return 1;
 case 
# 418 "project/radare2/libr/anal/p/anal_z80.c" 3 4
     0
# 418 "project/radare2/libr/anal/p/anal_z80.c"
                                :
  return 1;
 }
 return 1;
...
# 436 "project/radare2/libr/anal/p/anal_z80.c" 3 4
__attribute__((visibility("default"))) 
# 436 "project/radare2/libr/anal/p/anal_z80.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ANAL,
 .data = &r_anal_plugin_z80,
 .version = 
# 439 "project/radare2/libr/anal/p/anal_z80.c" 3 4
           "5.5.4"

# 440 "project/radare2/libr/anal/p/anal_z80.c"
};
