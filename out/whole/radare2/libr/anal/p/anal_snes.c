# 0 "project/radare2/libr/anal/p/anal_snes.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/anal/p/anal_snes.c" 2
...
# 5 "project/radare2/libr/anal/p/anal_snes.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_snes.c" 2
...
# 7 "project/radare2/libr/anal/p/anal_snes.c" 2
...
# 9 "project/radare2/libr/anal/p/anal_snes.c" 2
# 1 "project/radare2/libr/anal/p/../../asm/p/asm_snes.h" 1
...
# 10 "project/radare2/libr/anal/p/anal_snes.c" 2

static struct snes_asm_flags* snesflags = 
# 11 "project/radare2/libr/anal/p/anal_snes.c" 3 4
                                         ((void *)0)
# 11 "project/radare2/libr/anal/p/anal_snes.c"
                                             ;

static int snes_anop(RAnal *anal, RAnalOp *op, 
# 13 "project/radare2/libr/anal/p/anal_snes.c" 3 4
                                              unsigned long long 
# 13 "project/radare2/libr/anal/p/anal_snes.c"
                                                   addr, const 
# 13 "project/radare2/libr/anal/p/anal_snes.c" 3 4
                                                               unsigned char 
# 13 "project/radare2/libr/anal/p/anal_snes.c"
 ...
 case 0x4c:
  op->eob = 
# 154 "project/radare2/libr/anal/p/anal_snes.c" 3 4
           1
# 154 "project/radare2/libr/anal/p/anal_snes.c"
               ;
  op->jump = (addr & 0xFF0000) | 
# 155 "project/radare2/libr/anal/p/anal_snes.c" 3 4
                                ((
# 155 "project/radare2/libr/anal/p/anal_snes.c"
                                data + 1
# 155 "project/radare2/libr/anal/p/anal_snes.c" 3 4
                                )[0]|((
# 155 "project/radare2/libr/anal/p/anal_snes.c"
...
# 155 "project/radare2/libr/anal/p/anal_snes.c"
 ...
 case 0x5c:
  op->eob = 
# 159 "project/radare2/libr/anal/p/anal_snes.c" 3 4
           1
# 159 "project/radare2/libr/anal/p/anal_snes.c"
               ;
 ...
 case 0x80:
  op->eob = 
# 164 "project/radare2/libr/anal/p/anal_snes.c" 3 4
           1
# 164 "project/radare2/libr/anal/p/anal_snes.c"
               ;
  op->jump = addr + 2 + (
# 165 "project/radare2/libr/anal/p/anal_snes.c" 3 4
                        signed char
# 165 "project/radare2/libr/anal/p/anal_snes.c"
                           )data[1];
  op->type = R_ANAL_OP_TYPE_JMP;
  break;
 case 0x82:
  op->eob = 
# 169 "project/radare2/libr/anal/p/anal_snes.c" 3 4
           1
# 169 "project/radare2/libr/anal/p/anal_snes.c"
               ;
  op->jump = addr + 3 + (
# 170 "project/radare2/libr/anal/p/anal_snes.c" 3 4
                        short
# 170 "project/radare2/libr/anal/p/anal_snes.c"
                            )
# 170 "project/radare2/libr/anal/p/anal_snes.c" 3 4
                             ((
# 170 "project/radare2/libr/anal/p/anal_snes.c"
...
# 170 "project/radare2/libr/anal/p/anal_snes.c"
 ...
 case 0xdc:
  op->eob = 
# 176 "project/radare2/libr/anal/p/anal_snes.c" 3 4
           1
# 176 "project/radare2/libr/anal/p/anal_snes.c"
               ;
 ...
 case 0xb0:
  op->eob = 
# 185 "project/radare2/libr/anal/p/anal_snes.c" 3 4
           1
# 185 "project/radare2/libr/anal/p/anal_snes.c"
               ;
  op->jump = addr + 2 + (
# 186 "project/radare2/libr/anal/p/anal_snes.c" 3 4
                        signed char
# 186 "project/radare2/libr/anal/p/anal_snes.c"
                           )data[1];
  op->fail = addr + 2;
 ...
 case 0xd0:
  op->eob = 
# 191 "project/radare2/libr/anal/p/anal_snes.c" 3 4
           1
# 191 "project/radare2/libr/anal/p/anal_snes.c"
               ;
  op->cond = R_ANAL_COND_NE;
  op->jump = addr + 2 + (
# 193 "project/radare2/libr/anal/p/anal_snes.c" 3 4
                        signed char
# 193 "project/radare2/libr/anal/p/anal_snes.c"
                           )data[1];
  op->fail = addr + 2;
  op->type = R_ANAL_OP_TYPE_CJMP;
  break;
 case 0xf0:
  op->eob = 
# 198 "project/radare2/libr/anal/p/anal_snes.c" 3 4
           1
# 198 "project/radare2/libr/anal/p/anal_snes.c"
               ;
  op->cond = R_ANAL_COND_EQ;
  op->jump = addr + 2 + (
# 200 "project/radare2/libr/anal/p/anal_snes.c" 3 4
                        signed char
# 200 "project/radare2/libr/anal/p/anal_snes.c"
                           )data[1];
  op->fail = addr + 2;
  op->type = R_ANAL_OP_TYPE_CJMP;
  break;
 case 0x20:
  op->jump = (addr & 0xFF0000) | 
# 205 "project/radare2/libr/anal/p/anal_snes.c" 3 4
                                ((
# 205 "project/radare2/libr/anal/p/anal_snes.c"
                                data+1
# 205 "project/radare2/libr/anal/p/anal_snes.c" 3 4
                                )[0]|((
# 205 "project/radare2/libr/anal/p/anal_snes.c"
...
# 205 "project/radare2/libr/anal/p/anal_snes.c"
 ...
 case 0x6b:
  op->eob = 
# 218 "project/radare2/libr/anal/p/anal_snes.c" 3 4
           1
# 218 "project/radare2/libr/anal/p/anal_snes.c"
               ;
  op->type = R_ANAL_OP_TYPE_RET;
  break;
 case 0xc2:
  if (((
# 222 "project/radare2/libr/anal/p/anal_snes.c" 3 4
       signed char
# 222 "project/radare2/libr/anal/p/anal_snes.c"
          )data[1]) & 0x10) {
   snesflags->X = 0;
  }
  if (((
# 225 "project/radare2/libr/anal/p/anal_snes.c" 3 4
       signed char
# 225 "project/radare2/libr/anal/p/anal_snes.c"
          )data[1]) & 0x20) {
   snesflags->M = 0;
  }
  break;
 case 0xe2:
  if (((
# 230 "project/radare2/libr/anal/p/anal_snes.c" 3 4
       signed char
# 230 "project/radare2/libr/anal/p/anal_snes.c"
          )data[1]) & 0x10) {
   snesflags->X = 1;
  }
  if (((
# 233 "project/radare2/libr/anal/p/anal_snes.c" 3 4
       signed char
# 233 "project/radare2/libr/anal/p/anal_snes.c"
          )data[1]) & 0x20) {
   snesflags->M = 1;
  }
  break;
...
# 245 "project/radare2/libr/anal/p/anal_snes.c" 3 4
__builtin___memset_chk (
# 245 "project/radare2/libr/anal/p/anal_snes.c"
snesflags
# 245 "project/radare2/libr/anal/p/anal_snes.c" 3 4
, 
# 245 "project/radare2/libr/anal/p/anal_snes.c"
...
static int snes_anal_fini (void* user) {
 free(snesflags);
 snesflags = 
# 251 "project/radare2/libr/anal/p/anal_snes.c" 3 4
            ((void *)0)
# 251 "project/radare2/libr/anal/p/anal_snes.c"
                ;
 return 0;
}
...
# 267 "project/radare2/libr/anal/p/anal_snes.c" 3 4
__attribute__((visibility("default"))) 
# 267 "project/radare2/libr/anal/p/anal_snes.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ANAL,
 .data = &r_anal_plugin_snes,
 .version = 
# 270 "project/radare2/libr/anal/p/anal_snes.c" 3 4
           "5.5.4"

# 271 "project/radare2/libr/anal/p/anal_snes.c"
};
