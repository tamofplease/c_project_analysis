# 0 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c" 2
...
# 5 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c" 2
...
# 7 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c" 2


unsigned int 
# 9 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c"
    get_ins_len(
# 9 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c" 3 4
                unsigned char 
# 9 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c"
                    opcode);

int tms320_c55x_plus_op(RAnal *anal, RAnalOp *op, 
# 11 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c" 3 4
                                                 unsigned long long 
# 11 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c"
                                                      addr, const 
# 11 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c" 3 4
                                                                  unsigned char 
# 11 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c"
...
# 12 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c" 3 4
unsigned short 
# 12 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c"
     *ins = (
# 12 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c" 3 4
             unsigned short
# 12 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c"
...
# 13 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c" 3 4
unsigned int 
# 13 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c"
     ins_len;
 ...
 if (ins_len == 1) {
  ...
  op->type = R_ANAL_OP_TYPE_CJMP;
  op->jump = addr + ((
# 40 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c" 3 4
                     signed char
# 40 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c"
                        )buf[1]) + ins_len;
 } else if (ins_len >= 3 && buf[0] == 0x9A) {

  op->type = R_ANAL_OP_TYPE_CJMP;
  op->jump = addr + (
# 44 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c" 3 4
                    short
# 44 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c"
                        )((buf[1] << 8) | buf[2]) + ins_len;
  ...
  op->type = R_ANAL_OP_TYPE_JMP;
  op->jump = addr + (
# 52 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c" 3 4
                    short
# 52 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c"
                        )((buf[1] << 8) | buf[2]) + ins_len;
  ...
  op->jump = addr + (
# 61 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c" 3 4
                    short
# 61 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c"
                        )((buf[1] << 8) | buf[2]) + ins_len;
  ...
  op->type = R_ANAL_OP_TYPE_CALL;
  op->jump = addr + (
# 69 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c" 3 4
                    short
# 69 "project/radare2/libr/anal/p/anal_tms320_c55x_plus.c"
                        )((buf[1] << 8) | buf[2]) + ins_len;
