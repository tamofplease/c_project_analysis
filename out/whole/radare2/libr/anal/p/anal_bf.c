# 0 "project/radare2/libr/anal/p/anal_bf.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/p/anal_bf.c"
...
# 4 "project/radare2/libr/anal/p/anal_bf.c" 2
...
# 5 "project/radare2/libr/anal/p/anal_bf.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_bf.c" 2
...
# 7 "project/radare2/libr/anal/p/anal_bf.c" 2



# 9 "project/radare2/libr/anal/p/anal_bf.c"
static size_t countChar(const 
# 9 "project/radare2/libr/anal/p/anal_bf.c" 3 4
                             unsigned char 
# 9 "project/radare2/libr/anal/p/anal_bf.c"
                                 *buf, int len, char ch) {
 int i;
...
static int bf_op(RAnal *anal, RAnalOp *op, 
# 26 "project/radare2/libr/anal/p/anal_bf.c" 3 4
                                          unsigned long long 
# 26 "project/radare2/libr/anal/p/anal_bf.c"
                                               addr, const 
# 26 "project/radare2/libr/anal/p/anal_bf.c" 3 4
                                                           unsigned char 
# 26 "project/radare2/libr/anal/p/anal_bf.c"
...
# 27 "project/radare2/libr/anal/p/anal_bf.c" 3 4
unsigned long long 
# 27 "project/radare2/libr/anal/p/anal_bf.c"
     dst = 0LL;
 if (!op) {
  return 1;
 }
...
# 32 "project/radare2/libr/anal/p/anal_bf.c" 3 4
__builtin___memset_chk (
# 32 "project/radare2/libr/anal/p/anal_bf.c"
op
# 32 "project/radare2/libr/anal/p/anal_bf.c" 3 4
, 
# 32 "project/radare2/libr/anal/p/anal_bf.c"
...
# 32 "project/radare2/libr/anal/p/anal_bf.c"
 ...
 case '[':
  ...
  {
   const 
# 45 "project/radare2/libr/anal/p/anal_bf.c" 3 4
        unsigned char 
# 45 "project/radare2/libr/anal/p/anal_bf.c"
            *p = buf + 1;
   int lev = 0, i = 1;
   len--;
   while (i < len && *p) {
    ...
    if (*p == ']') {
     ...
     if (lev==-1) {
      ...
      r_strbuf_setf (&op->esil,
        "$$,brk,=[1],brk,++=,"
        "ptr,[1],!,?{,0x%"
# 60 "project/radare2/libr/anal/p/anal_bf.c" 3 4
                         "llx"
# 60 "project/radare2/libr/anal/p/anal_bf.c"
                                ",pc,=,brk,--=,}", dst);
      goto beach;
     }
    }
    ...
    if (i == len - 1 && anal->read_at) {
     int new_buf_len = len + 1 + 32;
     
# 70 "project/radare2/libr/anal/p/anal_bf.c" 3 4
    unsigned char 
# 70 "project/radare2/libr/anal/p/anal_bf.c"
        *new_buf = calloc (new_buf_len, 1);
     if (new_buf) {
      free ((
# 72 "project/radare2/libr/anal/p/anal_bf.c" 3 4
            unsigned char 
# 72 "project/radare2/libr/anal/p/anal_bf.c"
                *)buf);
...
beach:
  free ((
# 84 "project/radare2/libr/anal/p/anal_bf.c" 3 4
        unsigned char 
# 84 "project/radare2/libr/anal/p/anal_bf.c"
            *)buf);
  break;
...
RAnalPlugin r_anal_plugin_bf = {
 ...
 .bits = 8,
 .esil = 
# 154 "project/radare2/libr/anal/p/anal_bf.c" 3 4
        1
# 154 "project/radare2/libr/anal/p/anal_bf.c"
            ,
 .op = &bf_op,
...
# 160 "project/radare2/libr/anal/p/anal_bf.c" 3 4
__attribute__((visibility("default"))) 
# 160 "project/radare2/libr/anal/p/anal_bf.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ANAL,
 .data = &r_anal_plugin_bf,
 .version = 
# 163 "project/radare2/libr/anal/p/anal_bf.c" 3 4
           "5.5.4"

# 164 "project/radare2/libr/anal/p/anal_bf.c"
};
