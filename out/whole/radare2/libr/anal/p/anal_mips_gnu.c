# 0 "project/radare2/libr/anal/p/anal_mips_gnu.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/p/anal_mips_gnu.c"
...
# 4 "project/radare2/libr/anal/p/anal_mips_gnu.c" 2
...
# 5 "project/radare2/libr/anal/p/anal_mips_gnu.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_mips_gnu.c" 2
...
# 7 "project/radare2/libr/anal/p/anal_mips_gnu.c" 2




# 10 "project/radare2/libr/anal/p/anal_mips_gnu.c"
static 
# 10 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
      unsigned long long 
# 10 "project/radare2/libr/anal/p/anal_mips_gnu.c"
           t9_pre = 
# 10 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
...
# 56 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
unsigned long long 
# 56 "project/radare2/libr/anal/p/anal_mips_gnu.c"
     mask = 1ULL << (bit-1);
 r_strbuf_appendf (&op->esil,
  "%d,0x%" 
# 58 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
          "llx" 
# 58 "project/radare2/libr/anal/p/anal_mips_gnu.c"
                  ",%s,%s,^,&,>>,%d,0x%" 
# 58 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
                                         "llx" 
# 58 "project/radare2/libr/anal/p/anal_mips_gnu.c"
                                                 ",%s,%s,+,&,>>,|,1,==,$z,?{,$$,1,TRAP,}{,%s,%s,+,%s,=,}",
...
# 703 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
unsigned char 
# 703 "project/radare2/libr/anal/p/anal_mips_gnu.c"
    sa[32];
};

struct gnu_jreg {
 
# 707 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
unsigned char 
# 707 "project/radare2/libr/anal/p/anal_mips_gnu.c"
    jump[32];
};
...
# 714 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
 unsigned char 
# 714 "project/radare2/libr/anal/p/anal_mips_gnu.c"
     imm[32];
  
# 715 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
 unsigned char 
# 715 "project/radare2/libr/anal/p/anal_mips_gnu.c"
     jump[32];
 };
};
...
# 720 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
unsigned char 
# 720 "project/radare2/libr/anal/p/anal_mips_gnu.c"
    optype;
 
# 721 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
unsigned int 
# 721 "project/radare2/libr/anal/p/anal_mips_gnu.c"
     id;
 union {
...
static const char* mips_reg_decode(
# 736 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
                                  unsigned int 
# 736 "project/radare2/libr/anal/p/anal_mips_gnu.c"
                                       reg_num) {
 ...
 return 
# 747 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
       ((void *)0)
# 747 "project/radare2/libr/anal/p/anal_mips_gnu.c"
           ;
}

static int analop_esil(RAnal *a, RAnalOp *op, 
# 750 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
                                             unsigned long long 
# 750 "project/radare2/libr/anal/p/anal_mips_gnu.c"
                                                  addr, gnu_insn*insn) {
 ...
 switch (insn->id) {
  ...
  case MIPS_INS_SD:
   r_strbuf_appendf (&op->esil, "%s,%s,%s,+,=[8]",
    ((const char *)insn->i_reg.rt), ((const char *)insn->i_reg.imm), ((const char *)insn->i_reg.rs));
   break;
  case MIPS_INS_SW:
  case MIPS_INS_SWL:
  case MIPS_INS_SWR:
  ...
  case MIPS_INS_SRA:
   r_strbuf_appendf (&op->esil,
    ...
    ((const char *)insn->r_reg.sa), ((const char *)insn->r_reg.rt), ((const char *)insn->r_reg.rt), ((const char *)insn->r_reg.sa), ((const char *)insn->r_reg.rd));
   break;
  case MIPS_INS_DSRA:
   r_strbuf_appendf (&op->esil,
  ...
  case MIPS_INS_SRL:
   r_strbuf_appendf (&op->esil, "%s,%s,>>,%s,=",
       ((const char *)insn->r_reg.rs)?((const char *)insn->r_reg.rs):((const char *)insn->r_reg.sa), ((const char *)insn->r_reg.rt),((const char *)insn->r_reg.rd) );
   break;
  case MIPS_INS_SLLV:
  case MIPS_INS_SLL:
   r_strbuf_appendf (&op->esil, "%s,%s,<<,%s,=",
  ...
  case MIPS_INS_BAL:
  case MIPS_INS_JAL:
   r_strbuf_appendf (&op->esil, "" "" "pc,4,+,""ra"",=,""%s"",pc,=", ((const char *)insn->i_reg.jump));
   break;
  case MIPS_INS_JALR:
  case MIPS_INS_JALRS:
   if (strcmp(((const char *)insn->r_reg.rd), "rd")==0) {
    r_strbuf_appendf (&op->esil, "" "" "pc,4,+,""ra"",=,""%s"",pc,=", ((const char *)insn->r_reg.rs));
   } else {
    r_strbuf_appendf (&op->esil, "" "" "pc,4,+,""%s"",=,""%s"",pc,=", ((const char *)insn->r_reg.rd), ((const char *)insn->r_reg.rs));
   }
   break;
  case MIPS_INS_JR:
  case MIPS_INS_JRC:
   r_strbuf_appendf (&op->esil, "" "" "%s"",pc,=", ((const char *)insn->r_reg.rs));
   break;
  case MIPS_INS_J:
   r_strbuf_appendf (&op->esil, "" "" "%s"",pc,=", ((const char *)insn->j_reg.jump));
  case MIPS_INS_B:

   r_strbuf_appendf (&op->esil, "" "" "%s"",pc,=", ((const char *)insn->i_reg.jump));
   break;
  case MIPS_INS_BNE:
  case MIPS_INS_BNEL:
   r_strbuf_appendf (&op->esil, "" "%s,%s,==,$z,!,?{," "%s"",pc,=" ",}",
    ((const char *)insn->i_reg.rs), ((const char *)insn->i_reg.rt), ((const char *)insn->i_reg.jump));
   break;
  case MIPS_INS_BEQ:
  case MIPS_INS_BEQL:
   r_strbuf_appendf (&op->esil, "" "%s,%s,==,$z,?{," "%s"",pc,=" ",}",
  ...
  case MIPS_INS_BEQZ:
  case MIPS_INS_BEQZC:
   r_strbuf_appendf (&op->esil, "" "%s,0,==,$z,?{," "%s"",pc,=" ",}",
    ((const char *)insn->i_reg.rs), ((const char *)insn->i_reg.jump));
   break;
  case MIPS_INS_BNEZ:
   r_strbuf_appendf (&op->esil, "" "%s,0,==,$z,!,?{," "%s"",pc,=" ",}",
    ((const char *)insn->i_reg.rs), ((const char *)insn->i_reg.jump));
  ...
  case MIPS_INS_BLEZC:
  case MIPS_INS_BLEZL:
   r_strbuf_appendf (&op->esil, "" "0,%s,==,$z,?{," "%s"",pc,=" ",BREAK,},",
    ((const char *)insn->i_reg.rs), ((const char *)insn->i_reg.jump));
   r_strbuf_appendf (&op->esil, "" "1," "1,""%s"",<<<,1,&" ",==,$z,?{," "%s"",pc,=" ",}",
    ((const char *)insn->i_reg.rs), ((const char *)insn->i_reg.jump));
   break;
  case MIPS_INS_BGEZ:
  case MIPS_INS_BGEZC:
  case MIPS_INS_BGEZL:
   r_strbuf_appendf (&op->esil, "" "0," "1,""%s"",<<<,1,&" ",==,$z,?{," "%s"",pc,=" ",}",
    ((const char *)insn->i_reg.rs), ((const char *)insn->i_reg.jump));
   break;
  case MIPS_INS_BGEZAL:
   r_strbuf_appendf (&op->esil, "" "0," "1,""%s"",<<<,1,&" ",==,$z,?{," "pc,4,+,""ra"",=,""%s"",pc,=" ",}",
    ((const char *)insn->i_reg.rs), ((const char *)insn->i_reg.jump));
   break;
  case MIPS_INS_BLTZAL:
   r_strbuf_appendf (&op->esil, "" "1," "1,""%s"",<<<,1,&" ",==,$z,?{," "pc,4,+,""ra"",=,""%s"",pc,=" ",}",
    ((const char *)insn->i_reg.rs), ((const char *)insn->i_reg.jump));
   break;
  case MIPS_INS_BLTZ:
  case MIPS_INS_BLTZC:
  ...
  case MIPS_INS_BGTZC:
  case MIPS_INS_BGTZL:
   r_strbuf_appendf (&op->esil, "" "0,%s,==,$z,?{,BREAK,},", ((const char *)insn->i_reg.rs));
   r_strbuf_appendf (&op->esil, "" "0," "1,""%s"",<<<,1,&" ",==,$z,?{," "%s"",pc,=" ",}",
    ((const char *)insn->i_reg.rs), ((const char *)insn->i_reg.jump));
   break;
  case MIPS_INS_BTEQZ:
  ...
  case MIPS_INS_MOV:
  case MIPS_INS_MOVE:
   r_strbuf_appendf (&op->esil, "%s,%s,=", ((const char *)insn->r_reg.rs), ((const char *)insn->r_reg.rd));
   break;
  case MIPS_INS_MOVZ:
  case MIPS_INS_MOVF:
   r_strbuf_appendf (&op->esil, "0,%s,==,$z,?{,%s,%s,=,}",
    ((const char *)insn->r_reg.rt), ((const char *)insn->r_reg.rs), ((const char *)insn->r_reg.rd));
   break;
  case MIPS_INS_MOVT:
  ...
  case MIPS_INS_ADD:
   es_add_ck (op, ((const char *)insn->r_reg.rs), ((const char *)insn->r_reg.rt), ((const char *)insn->r_reg.rd), 32);
  break;
  case MIPS_INS_ADDI:
   es_add_ck (op, ((const char *)insn->i_reg.imm), ((const char *)insn->i_reg.rs), ((const char *)insn->i_reg.rt), 32);
   break;
  case MIPS_INS_DADD:
   es_add_ck (op, ((const char *)insn->r_reg.rs), ((const char *)insn->r_reg.rt), ((const char *)insn->r_reg.rd), 64);
   break;
  case MIPS_INS_DADDU:
  case MIPS_INS_ADDU:
   r_strbuf_appendf (&op->esil, "%s,%s,+,%s,=",
   ...
   break;
  case MIPS_INS_DADDI:
  es_add_ck (op, ((const char *)insn->i_reg.imm), ((const char *)insn->i_reg.rs), ((const char *)insn->i_reg.rt), 64);
  break;
  case MIPS_INS_ADDIU:
  case MIPS_INS_DADDIU:
   r_strbuf_appendf (&op->esil, "%s,%s,+,%s,=",
    ((const char *)insn->i_reg.imm), ((const char *)insn->i_reg.rs), ((const char *)insn->i_reg.rt));
   es_sign_n_64 (a, op, ((const char *)insn->i_reg.rt), 32);
   break;
  case MIPS_INS_LI:
  case MIPS_INS_LDI:
   r_strbuf_appendf (&op->esil, "%s,%s,=", ((const char *)insn->i_reg.imm), ((const char *)insn->i_reg.rt));
   break;
  case MIPS_INS_LUI:
   r_strbuf_appendf (&op->esil, "%s0000,%s,=",((const char *)insn->i_reg.imm), ((const char *)insn->i_reg.rt));
   break;
  case MIPS_INS_LB:
   op->sign = 
# 951 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
             1
# 951 "project/radare2/libr/anal/p/anal_mips_gnu.c"
                 ;
  ...
  case MIPS_INS_LH:
   op->sign = 
# 977 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
             1
# 977 "project/radare2/libr/anal/p/anal_mips_gnu.c"
                 ;
  ...
  case MIPS_INS_LWX:
   break;
  case MIPS_INS_AND:
   r_strbuf_appendf (&op->esil, "%s,%s,&,%s,=", ((const char *)insn->r_reg.rt), ((const char *)insn->r_reg.rs), ((const char *)insn->r_reg.rd));
  break;
  case MIPS_INS_ANDI:
   r_strbuf_appendf (&op->esil, "%s,%s,&,%s,=", ((const char *)insn->i_reg.imm), ((const char *)insn->i_reg.rs), ((const char *)insn->i_reg.rt));
   break;
  case MIPS_INS_OR:
   r_strbuf_appendf (&op->esil, "%s,%s,|,%s,=", ((const char *)insn->r_reg.rt), ((const char *)insn->r_reg.rs), ((const char *)insn->r_reg.rd));
   break;
  ...
  case MIPS_INS_XORI:
   ...
   break;
  case MIPS_INS_NOR:
   r_strbuf_appendf (&op->esil, "%s,%s,|,0xffffffff,^,%s,=",((const char *)insn->r_reg.rs), ((const char *)insn->r_reg.rt), ((const char *)insn->r_reg.rd));
   break;
  case MIPS_INS_SLT:
   r_strbuf_appendf (&op->esil, "%s,%s,<,t,=", ((const char *)insn->r_reg.rs), ((const char *)insn->r_reg.rt));
   break;
  case MIPS_INS_SLTI:
   r_strbuf_appendf (&op->esil, "%s,%s,<,%s,=", ((const char *)insn->i_reg.imm), ((const char *)insn->i_reg.rs), ((const char *)insn->i_reg.rt));
   break;
  case MIPS_INS_SLTU:
   r_strbuf_appendf (&op->esil, "%s,0xffffffff,&,%s,0xffffffff,&,<,t,=",
    ((const char *)insn->r_reg.rs), ((const char *)insn->r_reg.rt));
   break;
  case MIPS_INS_SLTIU:
   ...
   break;
  case MIPS_INS_MUL:
  r_strbuf_appendf (&op->esil, "0xffffffff,""%s,%s,*"",&"",%s,=", ((const char *)insn->r_reg.rs), ((const char *)insn->r_reg.rt), ((const char *)insn->r_reg.rd));
  es_sign_n_64 (a, op, ((const char *)insn->r_reg.rd), 32);
   break;
  case MIPS_INS_MULT:
  case MIPS_INS_MULTU:
   r_strbuf_appendf (&op->esil, "0xffffffff,""%s,%s,*"",&"",lo,=", ((const char *)insn->r_reg.rs), ((const char *)insn->r_reg.rt));
   es_sign_n_64 (a, op, "lo", 32);
   r_strbuf_appendf (&op->esil, "0xffffffff,""32,%s,%s,*,>>"",&"",hi,=", ((const char *)insn->r_reg.rs), ((const char *)insn->r_reg.rt));
   es_sign_n_64 (a, op, "hi", 32);
   break;
  case MIPS_INS_MFLO:
   r_strbuf_appendf (&op->esil, "lo,%s,=", ((const char *)insn->r_reg.rd));
  break;
 case MIPS_INS_MFHI:
   r_strbuf_appendf (&op->esil, "hi,%s,=", ((const char *)insn->r_reg.rd));
  break;
 case MIPS_INS_MTLO:
  r_strbuf_appendf (&op->esil, "%s,lo,=,", ((const char *)insn->r_reg.rs));
  es_sign_n_64 (a, op, "lo", 32);
  break;
 case MIPS_INS_MTHI:
  r_strbuf_appendf (&op->esil, "%s,hi,=,", ((const char *)insn->r_reg.rs));
  es_sign_n_64 (a, op, "hi", 32);
  break;
 default:
  return -1;
...
static int mips_op(RAnal *anal, RAnalOp *op, 
# 1054 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
                                            unsigned long long 
# 1054 "project/radare2/libr/anal/p/anal_mips_gnu.c"
                                                 addr, const 
# 1054 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
                                                             unsigned char 
# 1054 "project/radare2/libr/anal/p/anal_mips_gnu.c"
                                                                 *b, int len, RAnalOpMask mask) {
 
# 1055 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
unsigned int 
# 1055 "project/radare2/libr/anal/p/anal_mips_gnu.c"
     opcode;

 int optype, oplen = (anal->bits==16)?2:4;
 const 
# 1058 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
      unsigned char 
# 1058 "project/radare2/libr/anal/p/anal_mips_gnu.c"
          * buf;
 gnu_insn insn;
 ...
 buf = (
# 1078 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
       unsigned char 
# 1078 "project/radare2/libr/anal/p/anal_mips_gnu.c"
           *) & opcode;
 ...
 if (optype == 0) {
# 1102 "project/radare2/libr/anal/p/anal_mips_gnu.c"
...
# 1111 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
 __builtin___snprintf_chk (
# 1111 "project/radare2/libr/anal/p/anal_mips_gnu.c"
 (char *)insn.r_reg.sa
# 1111 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
 , 
# 1111 "project/radare2/libr/anal/p/anal_mips_gnu.c"
...
# 1111 "project/radare2/libr/anal/p/anal_mips_gnu.c"
  ...
  case 0:
   ...
   insn.r_reg.rs = 
# 1116 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
                  ((void *)0)
# 1116 "project/radare2/libr/anal/p/anal_mips_gnu.c"
                      ;
   op->val = sa;
  case 4:
  ...
  case 2:
   ...
   insn.r_reg.rs = 
# 1124 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
                  ((void *)0)
# 1124 "project/radare2/libr/anal/p/anal_mips_gnu.c"
                      ;
   op->val = sa;
  case 6:
 ...
 if ((optype & 0x3e) == 2) {
# 1293 "project/radare2/libr/anal/p/anal_mips_gnu.c"
  int address = (((buf[0]&3)<<24)+(buf[1]<<16)+(buf[2]<<8)+buf[3]) << 2;
  
# 1294 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
 unsigned long long 
# 1294 "project/radare2/libr/anal/p/anal_mips_gnu.c"
      page_hack = addr & 0xf0000000;
...
# 1302 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
  __builtin___snprintf_chk (
# 1302 "project/radare2/libr/anal/p/anal_mips_gnu.c"
  (char *)insn.j_reg.jump
# 1302 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
  , 
# 1302 "project/radare2/libr/anal/p/anal_mips_gnu.c"
  32
...
# 1310 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
  __builtin___snprintf_chk (
# 1310 "project/radare2/libr/anal/p/anal_mips_gnu.c"
  (char *)insn.j_reg.jump
# 1310 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
  , 
# 1310 "project/radare2/libr/anal/p/anal_mips_gnu.c"
...
# 1334 "project/radare2/libr/anal/p/anal_mips_gnu.c"
  int fun = (buf[3]&63);
...
# 1362 "project/radare2/libr/anal/p/anal_mips_gnu.c"
  op->refptr = 0;
  int rs = ((buf[0] & 3) << 3) + (buf[1] >> 5);
  int rt = buf[1] & 31;
...
# 1372 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
 __builtin___snprintf_chk (
# 1372 "project/radare2/libr/anal/p/anal_mips_gnu.c"
 (char *)insn.i_reg.imm
# 1372 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
 , 
# 1372 "project/radare2/libr/anal/p/anal_mips_gnu.c"
...
# 1386 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
     __builtin___snprintf_chk (
# 1386 "project/radare2/libr/anal/p/anal_mips_gnu.c"
     (char *)insn.i_reg.jump
# 1386 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
     , 
# 1386 "project/radare2/libr/anal/p/anal_mips_gnu.c"
     32
...
# 1429 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
  __builtin___snprintf_chk (
# 1429 "project/radare2/libr/anal/p/anal_mips_gnu.c"
  (char *)insn.i_reg.jump
# 1429 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
  , 
# 1429 "project/radare2/libr/anal/p/anal_mips_gnu.c"
...
# 1429 "project/radare2/libr/anal/p/anal_mips_gnu.c"
                                                                         ;
   break;
# 1447 "project/radare2/libr/anal/p/anal_mips_gnu.c"
  case 15:
   insn.id = MIPS_INS_LUI;
   
# 1449 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
  __builtin___snprintf_chk (
# 1449 "project/radare2/libr/anal/p/anal_mips_gnu.c"
  (char *)insn.i_reg.imm
# 1449 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
  , 
# 1449 "project/radare2/libr/anal/p/anal_mips_gnu.c"
...
# 1466 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
   __builtin___snprintf_chk (
# 1466 "project/radare2/libr/anal/p/anal_mips_gnu.c"
   (char *)insn.i_reg.imm
# 1466 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
   , 
# 1466 "project/radare2/libr/anal/p/anal_mips_gnu.c"
...
# 1500 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
   __builtin___snprintf_chk (
# 1500 "project/radare2/libr/anal/p/anal_mips_gnu.c"
   (char *)insn.i_reg.imm
# 1500 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
   , 
# 1500 "project/radare2/libr/anal/p/anal_mips_gnu.c"
...
# 1568 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
  __builtin___snprintf_chk (
# 1568 "project/radare2/libr/anal/p/anal_mips_gnu.c"
  (char *)insn.i_reg.jump
# 1568 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
  , 
# 1568 "project/radare2/libr/anal/p/anal_mips_gnu.c"
...
# 1568 "project/radare2/libr/anal/p/anal_mips_gnu.c"
 ...
 return oplen;
# 1674 "project/radare2/libr/anal/p/anal_mips_gnu.c"
 return op->size;
}

static 
# 1677 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
      _Bool 
# 1677 "project/radare2/libr/anal/p/anal_mips_gnu.c"
           mips_set_reg_profile(RAnal* anal){
     const char *p =
# 1721 "project/radare2/libr/anal/p/anal_mips_gnu.c"
 "=PC	pc\n"
 "=SP	sp\n"
 "=BP	fp\n"
 "=A0	a0\n"
...
RAnalPlugin r_anal_plugin_mips_gnu = {
 ...
 .bits = 32,
 .esil = 
# 1782 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
        1
# 1782 "project/radare2/libr/anal/p/anal_mips_gnu.c"
            ,
 .archinfo = archinfo,
 .op = &mips_op,
...
# 1789 "project/radare2/libr/anal/p/anal_mips_gnu.c" 3 4
__attribute__((visibility("default"))) 
# 1789 "project/radare2/libr/anal/p/anal_mips_gnu.c"
