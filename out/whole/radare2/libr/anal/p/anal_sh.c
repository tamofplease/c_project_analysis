# 0 "project/radare2/libr/anal/p/anal_sh.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/anal/p/anal_sh.c" 2
...
# 5 "project/radare2/libr/anal/p/anal_sh.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_sh.c" 2
...
# 7 "project/radare2/libr/anal/p/anal_sh.c" 2
...
# 183 "project/radare2/libr/anal/p/anal_sh.c"
static 
# 183 "project/radare2/libr/anal/p/anal_sh.c" 3 4
      unsigned long long 
# 183 "project/radare2/libr/anal/p/anal_sh.c"
           disarm_12bit_offset (RAnalOp *op, unsigned int insoff) {
 
# 184 "project/radare2/libr/anal/p/anal_sh.c" 3 4
unsigned long long 
# 184 "project/radare2/libr/anal/p/anal_sh.c"
     off = insoff;
...
static 
# 194 "project/radare2/libr/anal/p/anal_sh.c" 3 4
      unsigned long long 
# 194 "project/radare2/libr/anal/p/anal_sh.c"
           disarm_8bit_offset (
# 194 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                               unsigned long long 
# 194 "project/radare2/libr/anal/p/anal_sh.c"
...
# 197 "project/radare2/libr/anal/p/anal_sh.c" 3 4
 unsigned long long 
# 197 "project/radare2/libr/anal/p/anal_sh.c"
      off = offs;
...
static RAnalValue *anal_fill_im(RAnal *anal, 
# 214 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                            int 
# 214 "project/radare2/libr/anal/p/anal_sh.c"
                                                 v) {
 RAnalValue *ret = r_anal_value_new ();
 ret->imm = v;
 return ret;
...
static RAnalValue *anal_fill_reg_disp_mem(RAnal *anal, int reg, 
# 221 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                               long long 
# 221 "project/radare2/libr/anal/p/anal_sh.c"
                                                                    delta, 
# 221 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                                           long long 
# 221 "project/radare2/libr/anal/p/anal_sh.c"
...
static RAnalValue *anal_fill_reg_ref(RAnal *anal, int reg, 
# 229 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                          long long 
# 229 "project/radare2/libr/anal/p/anal_sh.c"
                                                               size) {
 RAnalValue *ret = anal_fill_ai_rg (anal, reg);
 ret->memref = size;
 return ret;
...
static RAnalValue *anal_fill_r0_reg_ref(RAnal *anal, int reg, 
# 236 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                             long long 
# 236 "project/radare2/libr/anal/p/anal_sh.c"
                                                                  size) {
...
static RAnalValue *anal_pcrel_disp_mov(RAnal* anal, RAnalOp* op, 
# 244 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                                unsigned char 
# 244 "project/radare2/libr/anal/p/anal_sh.c"
                                                                    disp, int size) {
 RAnalValue *ret = r_anal_value_new ();
 if (size==2) {
  ret->base = op->addr + 4;
...
static RAnalValue *anal_regrel_jump(RAnal* anal, RAnalOp* op, 
# 258 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                             unsigned char 
# 258 "project/radare2/libr/anal/p/anal_sh.c"
                                                                 reg) {
 RAnalValue *ret = r_anal_value_new ();
...
static int first_nibble_is_0(RAnal* anal, RAnalOp* op, 
# 266 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                      unsigned short 
# 266 "project/radare2/libr/anal/p/anal_sh.c"
                                                           code) {
 if (((code) & 0xf0ff) == 0x0003) {

  op->type = R_ANAL_OP_TYPE_UCALL;
  op->delay = 1;
  op->dst = anal_regrel_jump (anal, op, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "1,SETD,pc,2,+,pr,=,r%d,2,+,pc,+=", (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xf0ff) == 0x0023)) {
  op->type = R_ANAL_OP_TYPE_UJMP;
  op->dst = anal_regrel_jump (anal, op, (((code) >> 8) & 0x0f));
  op->eob = 
# 276 "project/radare2/libr/anal/p/anal_sh.c" 3 4
           1
# 276 "project/radare2/libr/anal/p/anal_sh.c"
               ;
  op->delay = 1;
  r_strbuf_setf (&op->esil, "1,SETD,r%d,2,+,pc,+=", (((code) >> 8) & 0x0f));
 } else if (code == 0x000b) {
  op->type = R_ANAL_OP_TYPE_RET;
  op->delay = 1;
  op->eob = 
# 282 "project/radare2/libr/anal/p/anal_sh.c" 3 4
           1
# 282 "project/radare2/libr/anal/p/anal_sh.c"
               ;
  ...
  op->delay = 1;
  op->eob = 
# 287 "project/radare2/libr/anal/p/anal_sh.c" 3 4
           1
# 287 "project/radare2/libr/anal/p/anal_sh.c"
               ;


  r_strbuf_setf (&op->esil, "1,SETD,r15,[4],pc,=,r15,4,+,[4],0xFFF0FFF,&,sr,=,8,r15,+=");
 } else if ((((code) & 0xF00F) == 0x0004)) {
  op->type = R_ANAL_OP_TYPE_STORE;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->dst = anal_fill_r0_reg_ref (anal, (((code) >> 8) & 0x0f), 1);
  r_strbuf_setf (&op->esil, "r%d,0xFF,&,r0,r%d,+,=[1]", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x0005)) {
  op->type = R_ANAL_OP_TYPE_STORE;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->dst = anal_fill_r0_reg_ref (anal, (((code) >> 8) & 0x0f), 2);
  r_strbuf_setf (&op->esil, "r%d,0xFFFF,&,r0,r%d,+,=[2]", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x0006)) {
  op->type = R_ANAL_OP_TYPE_STORE;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->dst = anal_fill_r0_reg_ref(anal, (((code) >> 8) & 0x0f), 4);
  r_strbuf_setf (&op->esil, "r%d,r0,r%d,+,=[4]", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x000C)) {
  op->type = R_ANAL_OP_TYPE_LOAD;
  op->src[0] = anal_fill_r0_reg_ref (anal, (((code) >> 4) & 0x0f), 1);
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "r0,r%d,+,[1],r%d,=,0x000000FF,r%d,&=,r%d,0x80,&,?{,0xFFFFFF00,r%d,|=,}", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x000D)) {
  op->type = R_ANAL_OP_TYPE_LOAD;
  op->src[0] = anal_fill_r0_reg_ref (anal, (((code) >> 4) & 0x0f), 2);
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "r0,r%d,+,[2],r%d,=,0x0000FFFF,r%d,&=,r%d,0x8000,&,?{,0xFFFF0000,r%d,|=,}", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x000E)) {
  op->type = R_ANAL_OP_TYPE_LOAD;
  op->src[0] = anal_fill_r0_reg_ref (anal, (((code) >> 4) & 0x0f), 4);
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "r0,r%d,+,[4],r%d,=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if (code == 0x0009) {
 ...
 } else if ((((code) & 0xF0FF) == 0x0029)) {
  op->type = R_ANAL_OP_TYPE_MOV;
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "0x1,sr,&,r%d,=", (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x0007)) {
  op->type = R_ANAL_OP_TYPE_MUL;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  op->src[1] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  r_strbuf_setf (&op->esil, "r%d,r%d,*,macl,=", (((code) >> 8) & 0x0f), (((code) >> 4) & 0x0f));
 } else if (code == 0x001b) {
  op->type = R_ANAL_OP_TYPE_UNK;
  r_strbuf_setf (&op->esil, "sleep_called,TRAP");
 } else if ((((code) & 0xF0FF) == 0x000A)) {
  op->type = R_ANAL_OP_TYPE_MOV;
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "mach,r%d,=", (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF0FF) == 0x001A)) {
  op->type = R_ANAL_OP_TYPE_MOV;
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "macl,r%d,=", (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF0FF) == 0x4012)) {
  op->type = R_ANAL_OP_TYPE_MOV;
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "macl,r%d,=", (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF0CF) == 0x0002)) {
  op->type = R_ANAL_OP_TYPE_MOV;
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));

  switch((((code) >> 4) & 0x0f)) {
  case 0:
   r_strbuf_setf (&op->esil, "sr,r%d,=", (((code) >> 8) & 0x0f));
   break;
  case 1:
   r_strbuf_setf (&op->esil, "gbr,r%d,=", (((code) >> 8) & 0x0f));
   break;
  case 2:
   r_strbuf_setf (&op->esil, "vbr,r%d,=", (((code) >> 8) & 0x0f));
   break;
  default:
 ...
 } else if ((((code) & 0xF0FF) == 0x002A)) {
  op->type = R_ANAL_OP_TYPE_MOV;
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "pr,r%d,=", (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x000F)) {
  r_strbuf_setf (&op->esil,
   "mach,0x80000000,&,!,"
   "r%d,[4]"",DUP,0x80000000,&,?{,0xFFFFFFFF00000000,|,}"","
   "r%d,[4]"",DUP,0x80000000,&,?{,0xFFFFFFFF00000000,|,}"","
   "*,"
   "macl,32,mach,<<,|,"
   "+,"
...
static int movl_reg_rdisp(RAnal* anal, RAnalOp* op, 
# 415 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                   unsigned short 
# 415 "project/radare2/libr/anal/p/anal_sh.c"
                                                        code) {
 op->type = R_ANAL_OP_TYPE_STORE;
 op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
 op->dst = anal_fill_reg_disp_mem (anal, (((code) >> 8) & 0x0f), code & 0x0F, 4);
 r_strbuf_setf (&op->esil, "r%d,r%d,0x%x,+,=[4]", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f), (code & 0xF) << 2);
 return op->size;
}

static int first_nibble_is_2(RAnal* anal, RAnalOp* op, 
# 423 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                      unsigned short 
# 423 "project/radare2/libr/anal/p/anal_sh.c"
                                                           code) {
 if ((((code) & 0xF00F) == 0x2000)) {
  op->type = R_ANAL_OP_TYPE_STORE;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->dst = anal_fill_reg_ref (anal, (((code) >> 8) & 0x0f), 1);
  r_strbuf_setf (&op->esil, "r%d,r%d,=[1]", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x2001)) {
  op->type = R_ANAL_OP_TYPE_STORE;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->dst = anal_fill_reg_ref (anal, (((code) >> 8) & 0x0f), 2);
  r_strbuf_setf (&op->esil, "r%d,r%d,=[2]", (((code) >> 4) & 0x0f) & 0xFF, (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x2002)) {
  op->type = R_ANAL_OP_TYPE_STORE;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->dst = anal_fill_reg_ref (anal, (((code) >> 8) & 0x0f), 4);
  r_strbuf_setf (&op->esil, "r%d,r%d,=[4]", (((code) >> 4) & 0x0f) & 0xFF, (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x2009)) {
  op->type = R_ANAL_OP_TYPE_AND;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "r%d,r%d,&=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x200A)) {
  op->type = R_ANAL_OP_TYPE_XOR;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "r%d,r%d,^=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x200B)) {
  op->type = R_ANAL_OP_TYPE_OR;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "r%d,r%d,|=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x2004)) {
  op->type = R_ANAL_OP_TYPE_PUSH;
  r_strbuf_setf (&op->esil, "1,r%d,-=,r%d,r%d,=[1]", (((code) >> 8) & 0x0f), (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x2005)) {
  op->type = R_ANAL_OP_TYPE_PUSH;
  r_strbuf_setf (&op->esil, "2,r%d,-=,r%d,r%d,=[2]", (((code) >> 8) & 0x0f), (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x2006)) {
  op->type = R_ANAL_OP_TYPE_PUSH;
  r_strbuf_setf (&op->esil, "4,r%d,-=,r%d,r%d,=[4]", (((code) >> 8) & 0x0f), (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x2008)) {
  op->type = R_ANAL_OP_TYPE_ACMP;
  r_strbuf_setf (&op->esil, "1,sr,|=,r%d,r%d,&,?{,0xFFFFFFFE,sr,&=,}", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x200C)) {
  op->type = R_ANAL_OP_TYPE_ACMP;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->src[1] = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "0xFFFFFFFE,sr,&=,24,r%d,r%d,^,>>,0xFF,&,!,?{,1,sr,|=,},16,r%d,r%d,^,>>,0xFF,&,!,?{,1,sr,|=,},8,r%d,r%d,^,>>,0xFF,&,!,?{,1,sr,|=,},r%d,r%d,^,0xFF,&,!,?{,1,sr,|=,}", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x200D)) {
  op->type = R_ANAL_OP_TYPE_MOV;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->src[1] = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "16,r%d,0xFFFF,&,<<,16,r%d,0xFFFF0000,&,>>,|,r%d,=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x2007)) {
  op->type = R_ANAL_OP_TYPE_DIV;
  r_strbuf_setf (&op->esil, "0xFFFFFCFE,sr,&=,r%d,0x80000000,&,?{,0x200,sr,|=,},r%d,0x80000000,&,?{,0x100,sr,|=,},sr,1,sr,<<,^,0x200,&,?{,1,sr,|=,}", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x200E)) {
  op->type = R_ANAL_OP_TYPE_MUL;
  op->src[0] = anal_fill_ai_rg(anal, (((code) >> 4) & 0x0f));
  op->src[1] = anal_fill_ai_rg(anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "r%d,0xFFFF,&,r%d,0xFFFF,&,*,macl,=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x200F)) {
  op->type = R_ANAL_OP_TYPE_MUL;
  op->src[0] = anal_fill_ai_rg(anal, (((code) >> 4) & 0x0f));
  op->src[1] = anal_fill_ai_rg(anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "r%d"",DUP,0x8000,&,?{,0xFFFFFFFFFFFF0000,|,}" "," "r%d"",DUP,0x8000,&,?{,0xFFFFFFFFFFFF0000,|,}" ",*,macl,=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 }
...
static int first_nibble_is_3(RAnal* anal, RAnalOp* op, 
# 496 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                      unsigned short 
# 496 "project/radare2/libr/anal/p/anal_sh.c"
                                                           code) {

 if ((((code) & 0xF00F) == 0x300C)) {
  op->type = R_ANAL_OP_TYPE_ADD;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "r%d,r%d,+=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x300E)) {
  op->type = R_ANAL_OP_TYPE_ADD;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "sr,0x1,&,0xFFFFFFFE,sr,&=,r%d,+=,31,$c,sr,|,sr,:=,r%d,r%d,+=,31,$c,sr,|,sr,:=", (((code) >> 8) & 0x0f), (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x300F)) {
  op->type = R_ANAL_OP_TYPE_ADD;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "0xFFFFFFFE,sr,&=,r%d,r%d,+=,31,$o,sr,|=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x3008)) {
  op->type = R_ANAL_OP_TYPE_SUB;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "r%d,r%d,-=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x300A)) {
  op->type = R_ANAL_OP_TYPE_SUB;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "sr,1,&," "0xFFFFFFFE,sr,&=" ",r%d,-=,31,$b,sr,|,sr,:=,r%d,r%d,-=,31,$b,sr,|,sr,:=", (((code) >> 8) & 0x0f), (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x300B)) {
  op->type = R_ANAL_OP_TYPE_SUB;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "0xFFFFFFFE,sr,&=" ",r%d,r%d,-=,31,$o,sr,|,sr,:=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x3000)) {
  op->type = R_ANAL_OP_TYPE_CMP;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  op->src[1] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  r_strbuf_setf (&op->esil, "0xFFFFFFFE,sr,&,r%d,r%d,^,!,|,sr,=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x3003)) {
  op->type = R_ANAL_OP_TYPE_CMP;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  op->src[1] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  r_strbuf_setf (&op->esil, "0xFFFFFFFE,sr,&=,r%d,r%d,>=,?{,0x1,sr,|=,}", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x3007)) {
  op->type = R_ANAL_OP_TYPE_CMP;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  op->src[1] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  r_strbuf_setf (&op->esil, "0xFFFFFFFE,sr,&=,r%d,r%d,>,?{,0x1,sr,|=,}", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x3006)) {
  op->type = R_ANAL_OP_TYPE_CMP;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  op->src[1] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  r_strbuf_setf (&op->esil, "0xFFFFFFFE,sr,&=,r%d,0x100000000,+,r%d,0x100000000,+,>,?{,0x1,sr,|=,}", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x3002)) {
  op->type = R_ANAL_OP_TYPE_CMP;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  op->src[1] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  r_strbuf_setf (&op->esil, "0xFFFFFFFE,sr,&=,r%d,0x100000000,+,r%d,0x100000000,+,>=,?{,0x1,sr,|=,}", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x3004)) {
  op->type = R_ANAL_OP_TYPE_DIV;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  op->src[1] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  r_strbuf_setf (&op->esil,
   ...
   "0xFFFFFFFE,sr,&="","
   "1,sr,>>,sr,^,0x80,&,!,sr,|=",
   (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f),
   (((code) >> 8) & 0x0f),
   (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f),
   (((code) >> 8) & 0x0f),
   (((code) >> 8) & 0x0f),
   (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f),
   (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x3005)) {
  op->type = R_ANAL_OP_TYPE_MUL;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->src[1] = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "32,r%d,r%d,*,DUP,0xFFFFFFFF,&,macl,=,>>,mach,=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x300D)) {
  op->type = R_ANAL_OP_TYPE_MUL;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->src[1] = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "32,r%d,r%d,0x80000000,&,?{,0xFFFFFFFF00000000,+,},r%d,r%d,0x80000000,&,?{,0xFFFFFFFF00000000,+,},*,DUP,0xFFFFFFFF,&,macl,=,>>,mach,=", (((code) >> 4) & 0x0f), (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
 }
 return op->size;
}
...
static int first_nibble_is_4(RAnal* anal, RAnalOp* op, 
# 597 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                      unsigned short 
# 597 "project/radare2/libr/anal/p/anal_sh.c"
                                                           code) {
 switch(code & 0xF0FF) {
 case 0x4020:
  op->type = R_ANAL_OP_TYPE_SAL;
  r_strbuf_setf (&op->esil, "0xFFFFFFFE,sr,&=,r%d,0x80000000,&,?{,0x1,sr,|=,},1,r%d,<<=", (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
  break;
 case 0x4021:
  op->type = R_ANAL_OP_TYPE_SAR;
  r_strbuf_setf (&op->esil, "0xFFFFFFFE,sr,&=,r%d,0x1,&,?{,0x1,sr,|=,},0,r%d,0x80000000,&,?{,0x80000000,+,},1,r%d,>>=,r%d,|=", (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
  break;
 case 0x4000:
 ...
 case 0x4008:
  op->type = R_ANAL_OP_TYPE_SHL;
  r_strbuf_setf (&op->esil, "2,r%d,<<=", (((code) >> 8) & 0x0f));
  break;
 case 0x4018:
  op->type = R_ANAL_OP_TYPE_SHL;
  r_strbuf_setf (&op->esil, "8,r%d,<<=", (((code) >> 8) & 0x0f));
  break;
 case 0x4028:
  op->type = R_ANAL_OP_TYPE_SHL;
  r_strbuf_setf (&op->esil, "16,r%d,<<=", (((code) >> 8) & 0x0f));
  break;
 case 0x4001:
  r_strbuf_setf (&op->esil, "0xFFFFFFFE,sr,&=,r%d,0x1,&,?{,0x1,sr,|=,},1,r%d,>>=", (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
 ...
 if ((((code) & 0xf0ff) == 0x400b)) {
  ...
  op->delay = 1;
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "1,SETD,pc,2,+,pr,=,r%d,pc,=", (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xf0ff) == 0x402b)) {
  op->type = R_ANAL_OP_TYPE_UJMP;
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  op->delay = 1;
  op->eob = 
# 653 "project/radare2/libr/anal/p/anal_sh.c" 3 4
           1
# 653 "project/radare2/libr/anal/p/anal_sh.c"
               ;
  r_strbuf_setf (&op->esil, "1,SETD,r%d,pc,=", (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xf0ff) == 0x4015)) {
  op->type = R_ANAL_OP_TYPE_CMP;
  r_strbuf_setf (&op->esil, "0xFFFFFFFE,sr,&=,0,r%d,>,?{,0x1,sr,|=,}", (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xf0ff) == 0x4011)) {
  op->type = R_ANAL_OP_TYPE_CMP;
  r_strbuf_setf (&op->esil, "0xFFFFFFFE,sr,&=,0,r%d,>=,?{,0x1,sr,|=,}", (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF0FF) == 0x4007)) {
  op->type = R_ANAL_OP_TYPE_POP;
  r_strbuf_setf (&op->esil, "r%d,[4],0x0FFF0FFF,&,sr,=,4,r%d,+=", (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF0FF) == 0x4017)) {
  op->type = R_ANAL_OP_TYPE_POP;
  r_strbuf_setf (&op->esil, "r%d,[4],gbr,=,4,r%d,+=", (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF0FF) == 0x4027)) {
  op->type = R_ANAL_OP_TYPE_POP;
  r_strbuf_setf (&op->esil, "r%d,[4],vbr,=,4,r%d,+=", (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));

 } else if ((((code) & 0xF0FF) == 0x4006)) {
  op->type = R_ANAL_OP_TYPE_POP;
  r_strbuf_setf (&op->esil, "r%d,[4],mach,=,4,r%d,+=", (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF0FF) == 0x4016)) {
  op->type = R_ANAL_OP_TYPE_POP;
  r_strbuf_setf (&op->esil, "r%d,[4],macl,=,4,r%d,+=", (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF0FF) == 0x4026)) {
  op->type = R_ANAL_OP_TYPE_POP;
  r_strbuf_setf (&op->esil, "r%d,[4],pr,=,4,r%d,+=", (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF0FF) == 0x400E)) {
  r_strbuf_setf (&op->esil, "r%d,0x0FFF0FFF,&,sr,=", (((code) >> 8) & 0x0f));
  op->type = R_ANAL_OP_TYPE_MOV;
 } else if ((((code) & 0xF0FF) == 0x401E)) {
  r_strbuf_setf (&op->esil, "r%d,gbr,=", (((code) >> 8) & 0x0f));
  op->type = R_ANAL_OP_TYPE_MOV;
 } else if ((((code) & 0xF0FF) == 0x402E)) {
  r_strbuf_setf (&op->esil, "r%d,vbr,=", (((code) >> 8) & 0x0f));
  op->type = R_ANAL_OP_TYPE_MOV;
 } else if ((((code) & 0xF0FF) == 0x400A)) {
  r_strbuf_setf (&op->esil, "r%d,mach,=", (((code) >> 8) & 0x0f));
  op->type = R_ANAL_OP_TYPE_MOV;
 } else if ((((code) & 0xF0FF) == 0x401A)) {
  r_strbuf_setf (&op->esil, "r%d,macl,=", (((code) >> 8) & 0x0f));
  op->type = R_ANAL_OP_TYPE_MOV;
 } else if ((((code) & 0xF0FF) == 0x402A)) {
  r_strbuf_setf (&op->esil, "r%d,pr,=", (((code) >> 8) & 0x0f));
  op->type = R_ANAL_OP_TYPE_MOV;
 } else if ((((code) & 0xF0FF) == 0x4005)) {
  r_strbuf_setf (&op->esil, "0xFFFFFFFE,sr,&=,r%d,0x1,&,sr,|=,0x1,r%d,>>>,r%d,=", (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
  op->type = (code & 1)? R_ANAL_OP_TYPE_ROR:R_ANAL_OP_TYPE_ROL;
 } else if ((((code) & 0xF0FF) == 0x4004)) {
  r_strbuf_setf (&op->esil, "0xFFFFFFFE,sr,&=,0x1,r%d,<<<,r%d,=,r%d,0x1,&,sr,|=", (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
  op->type = (code & 1)? R_ANAL_OP_TYPE_ROR:R_ANAL_OP_TYPE_ROL;
 } else if ((((code) & 0xF0FF) == 0x4025)) {
  r_strbuf_setf (&op->esil, "0,sr,0x1,&,?{,0x80000000,},0xFFFFFFFE,sr,&=,r%d,1,&,sr,|=,1,r%d,>>=,r%d,|=", (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
  op->type = (code & 1)? R_ANAL_OP_TYPE_ROR:R_ANAL_OP_TYPE_ROL;
 } else if ((((code) & 0xF0FF) == 0x4024)) {
  r_strbuf_setf (&op->esil, "sr,0x1,&,0xFFFFFFFE,sr,&=,r%d,0x80000000,&,?{,1,sr,|=,},1,r%d,<<=,r%d,|=", (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
  op->type = (code & 1)? R_ANAL_OP_TYPE_ROR:R_ANAL_OP_TYPE_ROL;
 } else if ((((code) & 0xF0FF) == 0x4003)) {
  r_strbuf_setf (&op->esil, "4,r%d,-=,sr,r%d,=[4]", (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
  op->type = R_ANAL_OP_TYPE_PUSH;
 } else if ((((code) & 0xF0FF) == 0x4013)) {
  r_strbuf_setf (&op->esil, "4,r%d,-=,gbr,r%d,=[4]", (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
  op->type = R_ANAL_OP_TYPE_PUSH;
 } else if ((((code) & 0xF0FF) == 0x4023)) {
  r_strbuf_setf (&op->esil, "4,r%d,-=,vbr,r%d,=[4]", (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
  op->type = R_ANAL_OP_TYPE_PUSH;
 } else if ((((code) & 0xF0FF) == 0x4012)) {
  r_strbuf_setf (&op->esil, "4,r%d,-=,macl,r%d,=[4]", (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
  op->type = R_ANAL_OP_TYPE_PUSH;
 } else if ((((code) & 0xF0FF) == 0x4002)) {
  r_strbuf_setf (&op->esil, "4,r%d,-=,mach,r%d,=[4]", (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
  op->type = R_ANAL_OP_TYPE_PUSH;
 } else if ((((code) & 0xF0FF) == 0x4022)) {
  op->type = R_ANAL_OP_TYPE_PUSH;
  r_strbuf_setf (&op->esil, "4,r%d,-=,pr,r%d,=[4]", (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF0FF) == 0x401B)) {
  r_strbuf_setf (&op->esil, "0xFFFFFFFE,sr,&=,r%d,[1],!,?{,0x80,r%d,=[1],1,sr,|=,}", (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
  op->type = R_ANAL_OP_TYPE_UNK;
 } else if ((((code) & 0xF0FF) == 0x4010)) {
  r_strbuf_setf (&op->esil, "0xFFFFFFFE,sr,&=,1,r%d,-=,$z,sr,|,sr,:=", (((code) >> 8) & 0x0f));
  op->type = R_ANAL_OP_TYPE_UNK;
 } else if ((((code) & 0xF00F) == 0x400F)){
  r_strbuf_setf (&op->esil,
   "0x2,sr,&,!,?{,"
    "r%d,[2]"",DUP,0x8000,&,?{,0xFFFFFFFFFFFF0000,|,}"","
    "r%d,[2]"",DUP,0x8000,&,?{,0xFFFFFFFFFFFF0000,|,}"","
    "*,"
    "macl,32,mach,<<,|,"
    "+,"
...
static int movl_rdisp_reg(RAnal* anal, RAnalOp* op, 
# 773 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                   unsigned short 
# 773 "project/radare2/libr/anal/p/anal_sh.c"
                                                        code) {
 op->type = R_ANAL_OP_TYPE_LOAD;
 op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
 op->src[0] = anal_fill_reg_disp_mem (anal, (((code) >> 4) & 0x0f), code & 0x0F, 4);
 r_strbuf_setf (&op->esil, "r%d,0x%x,+,[4],r%d,=", (((code) >> 4) & 0x0f), (code&0xF) * 4, (((code) >> 8) & 0x0f));
 return op->size;
}


static int first_nibble_is_6(RAnal* anal, RAnalOp* op, 
# 782 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                      unsigned short 
# 782 "project/radare2/libr/anal/p/anal_sh.c"
                                                           code) {
 if ((((code) & 0xf00f) == 0x6003)) {
  op->type = R_ANAL_OP_TYPE_MOV;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "r%d,r%d,=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x6000)) {
  op->type = R_ANAL_OP_TYPE_LOAD;
  op->src[0] = anal_fill_reg_ref (anal, (((code) >> 4) & 0x0f), 1);
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "0x000000FF,r%d,&=,r%d,[1],DUP,0x80,&,?{,0xFFFFFF00,|=,},r%d,=", (((code) >> 8) & 0x0f), (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x6001)) {
  op->type = R_ANAL_OP_TYPE_LOAD;
  op->src[0] = anal_fill_reg_ref (anal, (((code) >> 4) & 0x0f), 2);
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "0x0000FFFF,r%d,&=,r%d,[2],DUP,0x8000,&,?{,0xFFFF0000,|=,},r%d,=", (((code) >> 8) & 0x0f), (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x6002)) {
  op->type = R_ANAL_OP_TYPE_LOAD;
  op->src[0] = anal_fill_reg_ref (anal, (((code) >> 4) & 0x0f), 4);
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "r%d,[4],r%d,=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00C) == 0x600C)) {
  ...
  switch(code & 0xF) {
  case 0xC:
   r_strbuf_setf (&op->esil, "r%d,0xFF,&,r%d,=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
   break;
  case 0xD:
   r_strbuf_setf (&op->esil, "r%d,0xFFFF,&,r%d,=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
   break;
  case 0xE:
   r_strbuf_setf (&op->esil, "r%d,0xFF,&,DUP,0x80,&,?{,0xFFFFFF00,|,},r%d,=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
   break;
  case 0xF:
   r_strbuf_setf (&op->esil, "r%d,0xFFFF,&,DUP,0x8000,&,?{,0xFFFF0000,|,},r%d,=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
   break;
  default:
   r_strbuf_setf (&op->esil, "TODO,NOT IMPLEMENTED");
   break;
  }
 } else if ((((code) & 0xF00F) == 0x6004)) {
  op->type = R_ANAL_OP_TYPE_POP;
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "r%d,[1],DUP,0x80,&,?{,0xFFFFFF00,|,},r%d,=,1,r%d,+=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 4) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x6005)) {
  op->type = R_ANAL_OP_TYPE_POP;
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "r%d,[2],DUP,0x8000,&,?{,0xFFFF0000,|,},r%d,=,2,r%d,+=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 4) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x6006)) {
  op->type = R_ANAL_OP_TYPE_POP;
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
  r_strbuf_setf (&op->esil, "r%d,[4],r%d,=,4,r%d,+=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 4) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x600B)) {

  op->type = R_ANAL_OP_TYPE_UNK;
  r_strbuf_setf (&op->esil, "r%d,0,-,r%d,=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x600A)) {
  op->type = R_ANAL_OP_TYPE_UNK;
  r_strbuf_setf (&op->esil, "1,sr,&,0xFFFFFFFE,sr,&=,r%d,+,0,-,31,$b,sr,|,sr,=,r%d,=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x6007)) {

  r_strbuf_setf (&op->esil, "0xFFFFFFFF,r%d,^,r%d,=", (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
  op->type = R_ANAL_OP_TYPE_NOT;
  op->src[0] = anal_fill_ai_rg (anal, (((code) >> 4) & 0x0f));
  op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
 } else if ((((code) & 0xF00F) == 0x6008)) {
  r_strbuf_setf (&op->esil, "r%d,0xFFFF0000,&,8,r%d,0xFF,&,<<,|,8,r%d,0xFF00,&,>>,|,r%d,=", (((code) >> 4) & 0x0f), (((code) >> 4) & 0x0f), (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
  op->type = R_ANAL_OP_TYPE_MOV;

 } else if ((((code) & 0xF00F) == 0x6009)) {
  r_strbuf_setf (&op->esil, "16,r%d,0xFFFF,&,<<,16,r%d,0xFFFF0000,&,>>,|,r%d,=", (((code) >> 4) & 0x0f), (((code) >> 4) & 0x0f), (((code) >> 8) & 0x0f));
  op->type = R_ANAL_OP_TYPE_MOV;
 }
 return op->size;
}
...
static int add_imm(RAnal* anal, RAnalOp* op, 
# 867 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                            unsigned short 
# 867 "project/radare2/libr/anal/p/anal_sh.c"
                                                 code) {
 op->type = R_ANAL_OP_TYPE_ADD;
 op->src[0] = anal_fill_im (anal, (
# 869 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                  signed char
# 869 "project/radare2/libr/anal/p/anal_sh.c"
                                     )(code & 0xFF));
 op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
 r_strbuf_setf (&op->esil, "0x%x,DUP,0x80,&,?{,0xFFFFFF00,|,},r%d,+=", code & 0xFF, (((code) >> 8) & 0x0f));
 return op->size;
}

static int first_nibble_is_8(RAnal* anal, RAnalOp* op, 
# 875 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                      unsigned short 
# 875 "project/radare2/libr/anal/p/anal_sh.c"
                                                           code) {
 if ((((code) & 0xff00) == 0x8900)||(((code) & 0xff00) == 0x8D00)||(((code) & 0xff00) == 0x8B00)||(((code) & 0xff00) == 0x8F00)) {
  op->type = R_ANAL_OP_TYPE_CJMP;
  op->jump = disarm_8bit_offset (op->addr, ((code) & 0x00ff));
  op->fail = op->addr + 2 ;
  op->eob = 
# 880 "project/radare2/libr/anal/p/anal_sh.c" 3 4
           1
# 880 "project/radare2/libr/anal/p/anal_sh.c"
               ;
  if ((((code) & 0xff00) == 0x8900)) {
   r_strbuf_setf (&op->esil, "sr,1,&,?{,0x%" 
# 882 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                            "llx" 
# 882 "project/radare2/libr/anal/p/anal_sh.c"
                                                    ",pc,=,}", op->jump);
  } else if ((((code) & 0xff00) == 0x8D00)) {
   r_strbuf_setf (&op->esil, "1,SETD,sr,1,&,?{,0x%" 
# 884 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                   "llx" 
# 884 "project/radare2/libr/anal/p/anal_sh.c"
                                                           ",pc,=,}", op->jump);
   op->delay = 1;
  } else if ((((code) & 0xff00) == 0x8F00)) {
   r_strbuf_setf (&op->esil, "1,SETD,sr,1,&,!,?{,0x%" 
# 887 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                     "llx" 
# 887 "project/radare2/libr/anal/p/anal_sh.c"
                                                             ",pc,=,}",op->jump);
   op->delay = 1;
  } else if ((((code) & 0xff00) == 0x8B00)) {
   r_strbuf_setf (&op->esil, "sr,1,&,!,?{,0x%" 
# 890 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                              "llx" 
# 890 "project/radare2/libr/anal/p/anal_sh.c"
                                                      ",pc,=,}", op->jump);
  }
  ...
  op->src[0] = anal_fill_reg_disp_mem (anal, (((code) >> 4) & 0x0f), code & 0x0F, 1);
  r_strbuf_setf (&op->esil, "r%d,0x%x,+,[1],DUP,0x80,&,?{,0xFFFFFF00,|,},r0,=", (((code) >> 4) & 0x0f), code & 0xF);
 } else if ((((code) & 0xFF00) == 0x8500)) {

  op->type = R_ANAL_OP_TYPE_LOAD;
  op->dst = anal_fill_ai_rg (anal, 0);
  op->src[0] = anal_fill_reg_disp_mem (anal, (((code) >> 4) & 0x0f), code & 0x0F, 2);
  r_strbuf_setf (&op->esil, "r%d,0x%x,+,[2],DUP,0x8000,&,?{,0xFFFF0000,|,},r0,=", (((code) >> 4) & 0x0f), (code & 0xF) * 2);
 } else if ((((code) & 0xFF00) == 0x8800)) {
  op->type = R_ANAL_OP_TYPE_CMP;
  ...
  op->dst = anal_fill_reg_disp_mem (anal, (((code) >> 4) & 0x0f), code & 0x0F, 1);
  r_strbuf_setf (&op->esil, "r0,0xFF,&,0x%x,r%d,+,=[1]", code & 0xF, (((code) >> 4) & 0x0f));
 } else if ((((code) & 0xFF00) == 0x8100)) {

  op->type = R_ANAL_OP_TYPE_STORE;
  op->src[0] = anal_fill_ai_rg (anal, 0);
  op->dst = anal_fill_reg_disp_mem (anal, (((code) >> 4) & 0x0f), code & 0x0F, 2);
  r_strbuf_setf (&op->esil, "r0,0xFFFF,&,0x%x,r%d,+,=[2]", (code & 0xF) * 2, (((code) >> 4) & 0x0f));
 }
 return op->size;
}


static int movw_pcdisp_reg(RAnal* anal, RAnalOp* op, 
# 924 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                    unsigned short 
# 924 "project/radare2/libr/anal/p/anal_sh.c"
                                                         code) {
 op->type = R_ANAL_OP_TYPE_LOAD;
 op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
...
# 930 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                "llx" 
# 930 "project/radare2/libr/anal/p/anal_sh.c"
                                        ",[2],r%d,=,r%d,0x8000,&,?{,0xFFFF0000,r%d,|=,}", op->src[0]->base, (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
 return op->size;
}


static int bra(RAnal* anal, RAnalOp* op, 
# 935 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                        unsigned short 
# 935 "project/radare2/libr/anal/p/anal_sh.c"
                                             code) {

 op->type = R_ANAL_OP_TYPE_JMP;
 op->delay = 1;
 op->jump = disarm_12bit_offset (op, ((code) & 0x0fff));
 op->eob = 
# 940 "project/radare2/libr/anal/p/anal_sh.c" 3 4
          1
# 940 "project/radare2/libr/anal/p/anal_sh.c"
              ;
 r_strbuf_setf (&op->esil, "1,SETD,0x%" 
# 941 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                       "llx" 
# 941 "project/radare2/libr/anal/p/anal_sh.c"
                                               ",pc,=", op->jump);
 return op->size;
}


static int bsr(RAnal* anal, RAnalOp* op, 
# 946 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                        unsigned short 
# 946 "project/radare2/libr/anal/p/anal_sh.c"
                                             code) {

 op->type = R_ANAL_OP_TYPE_CALL;
 op->jump = disarm_12bit_offset (op, ((code) & 0x0fff));
 op->delay = 1;
 r_strbuf_setf (&op->esil, "1,SETD,pc,2,+,pr,=,0x%" 
# 951 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                   "llx" 
# 951 "project/radare2/libr/anal/p/anal_sh.c"
                                                           ",pc,=", op->jump);
 return op->size;
}

static int first_nibble_is_c(RAnal* anal, RAnalOp* op, 
# 955 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                      unsigned short 
# 955 "project/radare2/libr/anal/p/anal_sh.c"
                                                           code) {
 if ((((code) & 0xFF00) == 0xC300)) {
  op->type = R_ANAL_OP_TYPE_SWI;
  op->val = (
# 958 "project/radare2/libr/anal/p/anal_sh.c" 3 4
            unsigned char
# 958 "project/radare2/libr/anal/p/anal_sh.c"
               )(code & 0xFF);
  r_strbuf_setf (&op->esil, "4,r15,-=,sr,r15,=[4],4,r15,-=,2,pc,-,r15,=[4],2,0x%x,<<,4,+,vbr,+,pc,=", code & 0xFF);
 } else if ((((code) & 0xFF00) == 0xC700)) {

  op->type = R_ANAL_OP_TYPE_LEA;
  op->src[0] = anal_pcrel_disp_mov (anal, op, code & 0xFF, 4);
  op->dst = anal_fill_ai_rg (anal, 0);
  r_strbuf_setf (&op->esil, "0x%x,pc,+,r0,=", (code & 0xFF) * 4);
 } else if ((((code) & 0xFC00) == 0xC800)) {
...
static int movl_pcdisp_reg(RAnal* anal, RAnalOp* op, 
# 1041 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                    unsigned short 
# 1041 "project/radare2/libr/anal/p/anal_sh.c"
                                                         code) {
 op->type = R_ANAL_OP_TYPE_LOAD;
 op->src[0] = anal_pcrel_disp_mov (anal, op, code & 0xFF, 4);
 ...
 r_strbuf_setf (&op->esil, "0x%" 
# 1047 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                "llx" 
# 1047 "project/radare2/libr/anal/p/anal_sh.c"
                                        ",[4],r%d,=", (code & 0xFF) * 4 + ((op->addr >> 2)<<2) + 4, (((code) >> 8) & 0x0f));
 return op->size;
}


static int mov_imm_reg(RAnal* anal, RAnalOp* op, 
# 1052 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                unsigned short 
# 1052 "project/radare2/libr/anal/p/anal_sh.c"
                                                     code) {
 op->type = R_ANAL_OP_TYPE_MOV;
 op->dst = anal_fill_ai_rg (anal, (((code) >> 8) & 0x0f));
 op->src[0] = anal_fill_im (anal, (
# 1055 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                  signed char
# 1055 "project/radare2/libr/anal/p/anal_sh.c"
                                     )(code & 0xFF));
 r_strbuf_setf (&op->esil, "0x%x,r%d,=,r%d,0x80,&,?{,0xFFFFFF00,r%d,|=,}", code & 0xFF, (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f), (((code) >> 8) & 0x0f));
 return op->size;
}


static int fpu_insn(RAnal* anal, RAnalOp* op, 
# 1061 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                             unsigned short 
# 1061 "project/radare2/libr/anal/p/anal_sh.c"
                                                  code) {
...
static int (*first_nibble_decode[])(RAnal*,RAnalOp*,
# 1068 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                   unsigned short
# 1068 "project/radare2/libr/anal/p/anal_sh.c"
                                                       ) = {
 first_nibble_is_0,
 movl_reg_rdisp,
 first_nibble_is_2,
...
static int sh_op(RAnal *anal, RAnalOp *op, 
# 1091 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                          unsigned long long 
# 1091 "project/radare2/libr/anal/p/anal_sh.c"
                                               addr, const 
# 1091 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                           unsigned char 
# 1091 "project/radare2/libr/anal/p/anal_sh.c"
...
# 1092 "project/radare2/libr/anal/p/anal_sh.c" 3 4
unsigned char 
# 1092 "project/radare2/libr/anal/p/anal_sh.c"
    op_MSB, op_LSB;
 int ret;
 if (!data || len < 2) {
  return 0;
 ...
 ret = first_nibble_decode[(op_MSB>>4) & 0x0F](anal, op, (
# 1104 "project/radare2/libr/anal/p/anal_sh.c" 3 4
                                                         unsigned short
# 1104 "project/radare2/libr/anal/p/anal_sh.c"
                                                             )(op_MSB<<8 | op_LSB));
...
static 
# 1110 "project/radare2/libr/anal/p/anal_sh.c" 3 4
      _Bool 
# 1110 "project/radare2/libr/anal/p/anal_sh.c"
           sh_set_reg_profile(RAnal* anal) {
...
RAnalPlugin r_anal_plugin_sh = {
 ...
 .esil = 
# 1167 "project/radare2/libr/anal/p/anal_sh.c" 3 4
        1

# 1168 "project/radare2/libr/anal/p/anal_sh.c"
};



# 1171 "project/radare2/libr/anal/p/anal_sh.c" 3 4
__attribute__((visibility("default"))) 
# 1171 "project/radare2/libr/anal/p/anal_sh.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ANAL,
 .data = &r_anal_plugin_sh,
 .version = 
# 1174 "project/radare2/libr/anal/p/anal_sh.c" 3 4
           "5.5.4"

# 1175 "project/radare2/libr/anal/p/anal_sh.c"
};
