# 0 "project/radare2/libr/anal/p/anal_pyc.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/p/anal_pyc.c"
...
# 4 "project/radare2/libr/anal/p/anal_pyc.c" 2
...
# 5 "project/radare2/libr/anal/p/anal_pyc.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_pyc.c" 2
...
# 7 "project/radare2/libr/anal/p/anal_pyc.c" 2

# 1 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h" 1
...
# 1 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 1
...
# 13 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
typedef enum {
 HASCOMPARE = 0x1,
 HASCONDITION = 0x2,
 HASCONST = 0x4,
...
# 37 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
unsigned short 
# 37 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
     type;
 
# 38 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
unsigned char 
# 38 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
    op_code;
 
# 39 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
signed char 
# 39 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
    op_push;
 
# 40 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
signed char 
# 40 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
    op_pop;
} pyc_opcode_object;

typedef struct {
 
# 44 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
unsigned char 
# 44 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
    extended_arg;
 
# 45 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
unsigned char 
# 45 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
    have_argument;
 
# 46 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
unsigned char 
# 46 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
    bits;
 void *(*version_sig)();
...
typedef struct {
 char *op_name;
 char *(*formatter)(
# 54 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
                   unsigned int 
# 54 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
                        oparg);
} pyc_arg_fmt;
...
# 64 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
                                                     unsigned int 
# 64 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
                                                          oparg);
} op_anal_func;

void anal_pyc_op(RAnalOp *op, pyc_opcode_object *op_obj, 
# 67 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
                                                        unsigned int 
# 67 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
                                                             oparg);
...
# 101 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
_Bool 
# 101 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
    pyc_opcodes_equal(pyc_opcodes *op, const char *version);

void add_arg_fmt(pyc_opcodes *ret, char *op_name, char *(*formatter) (
# 103 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
                                                                     unsigned int 
# 103 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
                                                                          oparg));

char *format_MAKE_FUNCTION_arg_3x(
# 105 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
                                 unsigned int 
# 105 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
                                      oparg);
char *format_extended_arg(
# 106 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
                         unsigned int 
# 106 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
                              oparg);
char *format_CALL_FUNCTION_pos_name_encoded(
# 107 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
                                           unsigned int 
# 107 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
                                                oparg);
char *format_CALL_FUNCTION_KW_36(
# 108 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
                                unsigned int 
# 108 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
                                     oparg);
char *format_CALL_FUNCTION_EX_36(
# 109 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
                                unsigned int 
# 109 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
                                     oparg);
char *format_MAKE_FUNCTION_arg_36(
# 110 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
                                 unsigned int 
# 110 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
                                      oparg);
char *format_value_flags_36(
# 111 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
                           unsigned int 
# 111 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
                                oparg);
char *format_extended_arg_36(
# 112 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
                            unsigned int 
# 112 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
                                 oparg);
...
# 117 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
unsigned char 
# 117 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
    op_code;
 
# 118 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
signed char 
# 118 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
    pop;
 
# 119 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
signed char 
# 119 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
    push;
 pyc_store_op_func func;
 
# 121 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
_Bool 
# 121 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
     conditional;
 
# 122 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h" 3 4
_Bool 
# 122 "project/radare2/libr/anal/p/../../asm/arch/pyc/opcode.h"
     fallthrough;
};
...
# 12 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h" 2
...
# 57 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h" 3 4
unsigned int 
# 57 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h"
     argcount;
 
# 58 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h" 3 4
unsigned int 
# 58 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h"
     posonlyargcount;
 
# 59 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h" 3 4
unsigned int 
# 59 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h"
     kwonlyargcount;
 
# 60 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h" 3 4
unsigned int 
# 60 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h"
     nlocals;
 
# 61 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h" 3 4
unsigned int 
# 61 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h"
     stacksize;
 
# 62 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h" 3 4
unsigned int 
# 62 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h"
     flags;
 pyc_object *code;
 pyc_object *consts;
 pyc_object *names;
...
# 71 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h" 3 4
unsigned int 
# 71 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h"
     firstlineno;
 pyc_object *lnotab;
 
# 73 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h" 3 4
long long 
# 73 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h"
     start_offset;
 
# 74 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h" 3 4
long long 
# 74 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h"
     end_offset;
} pyc_code_object;

int r_pyc_disasm(RAsmOp *op, const 
# 77 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h" 3 4
                                  unsigned char 
# 77 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h"
                                      *buf, RList *cobjs, RList *interned_table, 
# 77 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h" 3 4
                                                                                 unsigned long long 
# 77 "project/radare2/libr/anal/p/../../asm/arch/pyc/pyc_dis.h"
                                                                                      pc, pyc_opcodes *opcodes);
# 9 "project/radare2/libr/anal/p/anal_pyc.c" 2

static pyc_opcodes *ops = 
# 10 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
                         ((void *)0)
# 10 "project/radare2/libr/anal/p/anal_pyc.c"
                             ;
...
static int archinfo(RAnal *anal, int query) {
 ...
 switch (query) {
 case 
# 18 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
     0
# 18 "project/radare2/libr/anal/p/anal_pyc.c"
                                :
  return (anal->bits == 16)? 1: 2;
 case 
# 20 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
     1
# 20 "project/radare2/libr/anal/p/anal_pyc.c"
                                :
...
static 
# 48 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
      _Bool 
# 48 "project/radare2/libr/anal/p/anal_pyc.c"
           set_reg_profile(RAnal *anal) {
 char *rp = get_reg_profile (anal);
 if (rp) {
  
# 51 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
 _Bool 
# 51 "project/radare2/libr/anal/p/anal_pyc.c"
      b = r_reg_set_profile_string (anal->reg, rp);
  free (rp);
  return b;
 }
 return 
# 55 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
       0
# 55 "project/radare2/libr/anal/p/anal_pyc.c"
            ;
}

static RList *get_pyc_code_obj(RAnal *anal) {
 RBin *b = anal->binb.bin;
 RBinPlugin *plugin = b->cur && b->cur->o? b->cur->o->plugin: 
# 60 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
                                                             ((void *)0)
# 60 "project/radare2/libr/anal/p/anal_pyc.c"
                                                                 ;
 
# 61 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
_Bool 
# 61 "project/radare2/libr/anal/p/anal_pyc.c"
     is_pyc = (plugin && strcmp (plugin->name, "pyc") == 0);
 return is_pyc? b->cur->o->bin_obj: 
# 62 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
                                   ((void *)0)
# 62 "project/radare2/libr/anal/p/anal_pyc.c"
                                       ;
}

static int pyc_op(RAnal *a, RAnalOp *op, 
# 65 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
                                        unsigned long long 
# 65 "project/radare2/libr/anal/p/anal_pyc.c"
                                             addr, const 
# 65 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
                                                         unsigned char 
# 65 "project/radare2/libr/anal/p/anal_pyc.c"
 ...
 RListIter *iter = 
# 71 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
                  ((void *)0)
# 71 "project/radare2/libr/anal/p/anal_pyc.c"
                      ;
 pyc_code_object *func = 
# 72 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
                        ((void *)0)
# 72 "project/radare2/libr/anal/p/anal_pyc.c"
                            , *t = 
# 72 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
                                   ((void *)0)
# 72 "project/radare2/libr/anal/p/anal_pyc.c"
...
# 73 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
if (
# 73 "project/radare2/libr/anal/p/anal_pyc.c"
cobjs
# 73 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
) for (
# 73 "project/radare2/libr/anal/p/anal_pyc.c"
...
# 73 "project/radare2/libr/anal/p/anal_pyc.c"
                                {
  if (
# 74 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
     (((
# 74 "project/radare2/libr/anal/p/anal_pyc.c"
     addr
# 74 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
     )>=(
# 74 "project/radare2/libr/anal/p/anal_pyc.c"
...
# 83 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
unsigned long long 
# 83 "project/radare2/libr/anal/p/anal_pyc.c"
     func_base = func->start_offset;
 
# 84 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
unsigned int 
# 84 "project/radare2/libr/anal/p/anal_pyc.c"
     extended_arg = 0, oparg = 0;
 
# 85 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
unsigned char 
# 85 "project/radare2/libr/anal/p/anal_pyc.c"
    op_code = data[0];
 op->addr = addr;
 op->sign = 
# 87 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
           1
# 87 "project/radare2/libr/anal/p/anal_pyc.c"
               ;
...
# 96 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
_Bool 
# 96 "project/radare2/libr/anal/p/anal_pyc.c"
     is_python36 = a->bits == 8;
...
static int finish(void *user) {
 if (ops) {
  free_opcode (ops);
  ops = 
# 151 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
       ((void *)0)
# 151 "project/radare2/libr/anal/p/anal_pyc.c"
           ;
 }
 return 0;
}
...
RAnalPlugin r_anal_plugin_pyc = {
 ...
 .op = &pyc_op,
 .esil = 
# 166 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
        0
# 166 "project/radare2/libr/anal/p/anal_pyc.c"
             ,
 .fini = &finish,
};
...
# 171 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
__attribute__((visibility("default"))) 
# 171 "project/radare2/libr/anal/p/anal_pyc.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ANAL,
 .data = &r_anal_plugin_pyc,
 .version = 
# 174 "project/radare2/libr/anal/p/anal_pyc.c" 3 4
           "5.5.4"

# 175 "project/radare2/libr/anal/p/anal_pyc.c"
};
