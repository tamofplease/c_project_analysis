# 0 "project/radare2/libr/anal/p/anal_wasm.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/p/anal_wasm.c"
...
# 4 "project/radare2/libr/anal/p/anal_wasm.c" 2
...
# 5 "project/radare2/libr/anal/p/anal_wasm.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_wasm.c" 2
...
# 7 "project/radare2/libr/anal/p/anal_wasm.c" 2

#undef R_IPI
#define R_IPI static
#define WASM_NO_ASM 
# 1 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 1
# 9 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
...
# 33 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
typedef enum {
...
# 63 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned char 
# 63 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
    flags;
 
# 64 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 64 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     initial;
 
# 65 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 65 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     maximum;
};

typedef struct r_bin_wasm_name_t {
 
# 69 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 69 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     len;
 
# 70 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned char 
# 70 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
    *name;
} RBinWasmName;

typedef struct r_bin_wasm_section_t {
 
# 74 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned char 
# 74 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
    id;
 
# 75 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 75 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     size;
 
# 76 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 76 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     name_len;
 char *name;
 
# 78 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 78 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     offset;
 
# 79 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 79 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     payload_data;
 
# 80 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 80 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     payload_len;
 
# 81 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 81 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     count;
} RBinWasmSection;

typedef struct r_bin_wasm_type_t {
 
# 85 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned char 
# 85 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
    form;
 
# 86 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 86 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     param_count;
 r_bin_wasm_value_type_t *param_types;
 
# 88 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
signed char 
# 88 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
    return_count;
...
# 96 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned char 
# 96 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
    mutability;
};
...
# 109 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 109 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     module_len;
 char module_str[256];
 
# 111 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 111 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     field_len;
 char field_str[256];
 
# 113 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned char 
# 113 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
    kind;
 union {
  
# 115 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
 unsigned int 
# 115 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
      type_f;
...
# 124 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 124 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     type_index;
} RBinWasmFunctionEntry;

typedef struct r_bin_wasm_table_t {
 
# 128 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned char 
# 128 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
    element_type;
 struct r_bin_wasm_resizable_limits_t limits;
} RBinWasmTableEntry;
...
# 138 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned char 
# 138 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
    mutability;
...
# 143 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 143 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     field_len;
 char field_str[256];
 
# 145 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned char 
# 145 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
    kind;
 
# 146 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 146 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     index;
} RBinWasmExportEntry;

typedef struct r_bin_wasm_start_t {
 
# 150 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 150 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     index;
} RBinWasmStartEntry;

struct r_bin_wasm_local_entry_t {
 
# 154 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 154 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     count;
...
# 159 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 159 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     index;
 struct r_bin_wasm_init_expr_t init;
 
# 161 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 161 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     num_elem;
 
# 162 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 162 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     elems[];
} RBinWasmElementEntry;

typedef struct r_bin_wasm_code_t {
 
# 166 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 166 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     body_size;
 
# 167 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 167 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     local_count;
 struct r_bin_wasm_local_entry_t *locals;
 
# 169 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 169 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     code;
 
# 170 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 170 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     len;
 
# 171 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned char 
# 171 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
    byte;
 char *name;
 char *signature;
} RBinWasmCodeEntry;
...
# 177 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 177 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     index;
 struct r_bin_wasm_init_expr_t offset;
 
# 179 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 179 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     size;
 
# 180 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 180 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     data;
} RBinWasmDataEntry;
...
# 187 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 187 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     count;
 RIDStorage *names;
...
# 192 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 192 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     index;

 
# 194 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 194 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     names_count;
 RIDStorage *names;
...
# 199 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 199 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     count;
 RList *locals;
...
# 205 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned char 
# 205 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
    type;
 
# 206 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 206 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     size;

 
# 208 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned char 
# 208 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
    payload_data;
 union {
...
# 221 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 221 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
     entrypoint;
...
# 254 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
unsigned int 
# 254 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
    r_bin_wasm_get_entrypoint(RBinWasmObj *bin);
const char *r_bin_wasm_get_function_name(RBinWasmObj *bin, 
# 255 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h" 3 4
                                                          unsigned int 
# 255 "project/radare2/libr/anal/p/../../bin/format/wasm/wasm.h"
                                                               idx);
const char *r_bin_wasm_valuetype_to_string(r_bin_wasm_value_type_t type);
# 12 "project/radare2/libr/anal/p/anal_wasm.c" 2
# 1 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c" 1
# 9 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c"
# 1 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.h" 1
...
static int wasm_dis(WasmOp *op, const unsigned char *buf, int buf_len);
# 10 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c" 2
# 1 "project/radare2/libr/anal/p/../../asm/arch/wasm/../../../bin/format/wasm/wasm.h" 1
# 11 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c" 2
...
# 476 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c"
static int wasm_dis(WasmOp *op, const unsigned char *buf, int buf_len) {
...
# 623 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c" 3 4
   int 
# 623 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c"
        val = 0;
...
# 658 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c" 3 4
   unsigned int 
# 658 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c"
        val = 0;
...
# 669 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c" 3 4
   unsigned int 
# 669 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c"
        count = 0, *table = 
# 669 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c" 3 4
                            ((void *)0)
# 669 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c"
    ...
    if (!(table = calloc (count, sizeof (
# 674 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c" 3 4
                                        unsigned int
# 674 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c"
                                            )))) {
     goto err;
    }
    int i = 0;
...
# 708 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c" 3 4
   unsigned int 
# 708 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c"
        val = 0, reserved = 0;
    size_t n = read_u32_leb128 (buf + 1, buf + buf_len, &val);
    if (!(n > 0 && n < buf_len)) {
     goto err;
...
# 729 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c" 3 4
   unsigned int 
# 729 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c"
        val = 0;
    size_t n = read_u32_leb128 (buf + 1, buf + buf_len, &val);
    if (!(n > 0 && n < buf_len)) {
     goto err;
...
# 762 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c" 3 4
   unsigned int 
# 762 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c"
        flag = 0, offset = 0;
...
# 779 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c" 3 4
   unsigned int 
# 779 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c"
        reserved = 0;
...
# 791 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c" 3 4
   int 
# 791 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c"
        val = 0;
    size_t n = read_i32_leb128 (buf + 1, buf + buf_len, &val);
    if (!(n > 0 && n < buf_len)) {
     goto err;
    ...
    r_strbuf_setf (sb, "%s %" 
# 796 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c" 3 4
                             "d"
# 796 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c"
                                    , opdef->txt, val);
    op->len += n;
   }
   break;
...
# 802 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c" 3 4
   long long 
# 802 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c"
        val = 0;
    ...
    r_strbuf_setf (sb, "%s %" 
# 807 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c" 3 4
                             "lld"
# 807 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c"
                                    , opdef->txt, val);
    op->len += n;
   }
   break;
...
# 814 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c" 3 4
    unsigned int 
# 814 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c"
          v;
     float f;
    } u;
...
# 827 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c" 3 4
    unsigned long long 
# 827 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c"
           v;
     double f;
    } u;
...
# 905 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c" 3 4
   unsigned int 
# 905 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c"
        flag = 0, offset = 0;
...
# 926 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c" 3 4
 unsigned int 
# 926 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c"
      simdop;
...
# 1102 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c" 3 4
   unsigned int 
# 1102 "project/radare2/libr/anal/p/../../asm/arch/wasm/wasm.c"
        offset = 0, align = 0;
...
# 13 "project/radare2/libr/anal/p/anal_wasm.c" 2

#define WASM_STACK_SIZE 256

static 
# 16 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
      unsigned long long 
# 16 "project/radare2/libr/anal/p/anal_wasm.c"
           scope_hint = 
# 16 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
...
# 16 "project/radare2/libr/anal/p/anal_wasm.c"
                                ;
static 
# 17 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
      unsigned long long 
# 17 "project/radare2/libr/anal/p/anal_wasm.c"
           addr_old = 
# 17 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                      0xFFFFFFFFFFFFFFFFULL
# 17 "project/radare2/libr/anal/p/anal_wasm.c"
...
static 
# 20 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
      unsigned long long 
# 20 "project/radare2/libr/anal/p/anal_wasm.c"
           get_cf_offset(RAnal *anal, const 
# 20 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                                            unsigned char 
# 20 "project/radare2/libr/anal/p/anal_wasm.c"
                                                *data, int len) {
 
# 21 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
unsigned int 
# 21 "project/radare2/libr/anal/p/anal_wasm.c"
     fcn_id;
 if (len < 2 || !read_u32_leb128 (&data[1], &data[len - 1], &fcn_id)) {
  return 
# 23 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
        0xFFFFFFFFFFFFFFFFULL
# 23 "project/radare2/libr/anal/p/anal_wasm.c"
                ;
 }
...
static 
# 28 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
      _Bool 
# 28 "project/radare2/libr/anal/p/anal_wasm.c"
           advance_till_scope_end(RAnal* anal, RAnalOp *op, 
# 28 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                                                            unsigned long long 
# 28 "project/radare2/libr/anal/p/anal_wasm.c"
                                                                 address, 
...
# 29 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
unsigned char 
# 29 "project/radare2/libr/anal/p/anal_wasm.c"
    buffer[16];
 
# 30 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
unsigned char 
# 30 "project/radare2/libr/anal/p/anal_wasm.c"
    *ptr = buffer;
 
# 31 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
unsigned char 
# 31 "project/radare2/libr/anal/p/anal_wasm.c"
    *end = ptr + sizeof (buffer);
 WasmOp wop = {{0}};
 int size = 0;
 while (anal->iob.read_at (anal->iob.io, address, buffer, sizeof (buffer))) {
  ...
  if (wop.type == WASM_TYPE_OP_CORE) {
   ...
   if (use_else && wopop == WASM_OP_ELSE && !depth) {
    ...
    op->jump = address + 1;
    return 
# 48 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
          1
# 48 "project/radare2/libr/anal/p/anal_wasm.c"
              ;
    ...
    op->jump = address;
    return 
# 55 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
          1
# 55 "project/radare2/libr/anal/p/anal_wasm.c"
              ;
   }
  }
  address += size;
 ...
 return 
# 60 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
       0
# 60 "project/radare2/libr/anal/p/anal_wasm.c"
            ;
}


static int wasm_op(RAnal *anal, RAnalOp *op, 
# 64 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                                            unsigned long long 
# 64 "project/radare2/libr/anal/p/anal_wasm.c"
                                                 addr, const 
# 64 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                                                             unsigned char 
# 64 "project/radare2/libr/anal/p/anal_wasm.c"
 ...
 WasmOp wop = {{0}};
 RAnalHint *hint = 
# 66 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                  ((void *)0)
# 66 "project/radare2/libr/anal/p/anal_wasm.c"
                      ;
 int ret = wasm_dis (&wop, data, len);
 op->size = ret;
 op->addr = addr;
 op->sign = 
# 70 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
           1
# 70 "project/radare2/libr/anal/p/anal_wasm.c"
               ;
 ...
 case WASM_TYPE_OP_CORE:
  ...
  case WASM_OP_IF:
   if (!(hint = r_anal_hint_get (anal, addr))) {
    ...
    r_anal_hint_set_jump (anal, scope_hint, addr);
    if (advance_till_scope_end (anal, op, addr + op->size, R_ANAL_OP_TYPE_CJMP, 0, 
# 119 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                                                                                  1
# 119 "project/radare2/libr/anal/p/anal_wasm.c"
                                                                                      )) {
  ...
  case WASM_OP_ELSE:
   ...
   if (!(hint = r_anal_hint_get (anal, addr))) {
    advance_till_scope_end (anal, op, addr + op->size, R_ANAL_OP_TYPE_JMP, 0, 
# 131 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                                                                             1
# 131 "project/radare2/libr/anal/p/anal_wasm.c"
                                                                                 );
   } else {
  ...
  case WASM_OP_BR:
   {
    RAnalHint *hint2 = 
# 139 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                      ((void *)0)
# 139 "project/radare2/libr/anal/p/anal_wasm.c"
                          ;
    
# 140 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
   unsigned int 
# 140 "project/radare2/libr/anal/p/anal_wasm.c"
        val;
    read_u32_leb128 (data + 1, data + len, &val);
    if ((hint2 = r_anal_hint_get (anal, addr)) && hint2->jump != 
# 142 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                                                                0xFFFFFFFFFFFFFFFFULL
# 142 "project/radare2/libr/anal/p/anal_wasm.c"
                                                                        ) {
     op->type = R_ANAL_OP_TYPE_JMP;
     op->jump = hint2->jump;
     ...
     if (hint->opcode && !strncmp ("loop", hint->opcode, 4)) {
      ...
      if (advance_till_scope_end (anal, op, addr + op->size, R_ANAL_OP_TYPE_JMP, val, 
# 151 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                                                                                     0
# 151 "project/radare2/libr/anal/p/anal_wasm.c"
                                                                                          )) {
       r_anal_hint_set_jump (anal, addr, op->jump);
      }
     }
     ...
     if (advance_till_scope_end (anal, op, addr + op->size, R_ANAL_OP_TYPE_JMP, val, 
# 156 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                                                                                    0
# 156 "project/radare2/libr/anal/p/anal_wasm.c"
                                                                                         )) {
      
# 157 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
     fprintf(__stderrp,
# 157 "project/radare2/libr/anal/p/anal_wasm.c"
...
# 160 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
     fprintf(__stderrp,
# 160 "project/radare2/libr/anal/p/anal_wasm.c"
     "[wasm] cannot find jump for br\n"
# 160 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
     )
# 160 "project/radare2/libr/anal/p/anal_wasm.c"
                                                 ;
  ...
  case WASM_OP_BRIF:
   {
    RAnalHint *hint2 = 
# 168 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                      ((void *)0)
# 168 "project/radare2/libr/anal/p/anal_wasm.c"
                          ;
    
# 169 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
   unsigned int 
# 169 "project/radare2/libr/anal/p/anal_wasm.c"
        val;
    read_u32_leb128 (data + 1, data + len, &val);
    if ((hint2 = r_anal_hint_get (anal, addr)) && hint2->jump != 
# 171 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                                                                0xFFFFFFFFFFFFFFFFULL
# 171 "project/radare2/libr/anal/p/anal_wasm.c"
                                                                        ) {
     op->type = R_ANAL_OP_TYPE_CJMP;
     op->jump = hint2->jump;
     op->fail = addr + op->size;
     ...
     if (hint->opcode && !strncmp ("loop", hint->opcode, 4)) {
      ...
      if (advance_till_scope_end (anal, op, addr + op->size, R_ANAL_OP_TYPE_CJMP, val, 
# 181 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                                                                                      0
# 181 "project/radare2/libr/anal/p/anal_wasm.c"
                                                                                           )) {
       op->fail = addr + op->size;
       r_anal_hint_set_jump (anal, addr, op->jump);
      }
     ...
     if (advance_till_scope_end (anal, op, addr + op->size, R_ANAL_OP_TYPE_CJMP, val, 
# 187 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                                                                                     0
# 187 "project/radare2/libr/anal/p/anal_wasm.c"
                                                                                          )) {
      
# 188 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
     fprintf(__stderrp,
# 188 "project/radare2/libr/anal/p/anal_wasm.c"
...
# 192 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
     fprintf(__stderrp,
# 192 "project/radare2/libr/anal/p/anal_wasm.c"
     "[wasm] cannot find jump for br_if\n"
# 192 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
     )
# 192 "project/radare2/libr/anal/p/anal_wasm.c"
                                                    ;
  ...
  case WASM_OP_END:
   {
    op->type = R_ANAL_OP_TYPE_NOP;
    if (scope_hint < 
# 201 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                    0xFFFFFFFFFFFFFFFFULL
# 201 "project/radare2/libr/anal/p/anal_wasm.c"
                            ) {
     ...
     if (hint && !strncmp ("loop", hint->opcode, 4)) {
      ...
      r_anal_hint_set_jump (anal, addr, 
# 209 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                                       0xFFFFFFFFFFFFFFFFULL
# 209 "project/radare2/libr/anal/p/anal_wasm.c"
                                               );
     }
     if (hint) {
      r_anal_hint_set_opcode (anal, scope_hint, "invalid");
      r_anal_hint_set_jump (anal, scope_hint, 
# 213 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                                             0xFFFFFFFFFFFFFFFFULL
# 213 "project/radare2/libr/anal/p/anal_wasm.c"
                                                     );
      ...
      op->eob = 
# 218 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
               1
# 218 "project/radare2/libr/anal/p/anal_wasm.c"
                   ;
      op->type = R_ANAL_OP_TYPE_RET;
      scope_hint = 
# 220 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                  0xFFFFFFFFFFFFFFFFULL
# 220 "project/radare2/libr/anal/p/anal_wasm.c"
                          ;
     }
    } else {
     if (!(hint = r_anal_hint_get (anal, addr))) {
      ...
      op->eob = 
# 225 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
               1
# 225 "project/radare2/libr/anal/p/anal_wasm.c"
                   ;
      op->type = R_ANAL_OP_TYPE_RET;
     }
    }
...
# 306 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
   unsigned char 
# 306 "project/radare2/libr/anal/p/anal_wasm.c"
       arg = data[1];
  ...
  case WASM_OP_CALLINDIRECT:
   ...
   op->fail = addr + op->size;
   if (op->jump != 
# 331 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                  0xFFFFFFFFFFFFFFFFULL
# 331 "project/radare2/libr/anal/p/anal_wasm.c"
                          ) {
    op->ptr = op->jump;
   }
   r_strbuf_setf (&op->esil, "4,sp,-=,0x%"
# 334 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                                         "llx"
# 334 "project/radare2/libr/anal/p/anal_wasm.c"
                                                ",sp,=[4],0x%"
# 334 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
                                                              "llx"
# 334 "project/radare2/libr/anal/p/anal_wasm.c"
...
RAnalPlugin r_anal_plugin_wasm = {
 ...
 .op = &wasm_op,
 .esil = 
# 458 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
        1

# 459 "project/radare2/libr/anal/p/anal_wasm.c"
};



# 462 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
__attribute__((visibility("default"))) 
# 462 "project/radare2/libr/anal/p/anal_wasm.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ANAL,
 .data = &r_anal_plugin_wasm,
 .version = 
# 465 "project/radare2/libr/anal/p/anal_wasm.c" 3 4
           "5.5.4"

# 466 "project/radare2/libr/anal/p/anal_wasm.c"
};
