# 0 "project/radare2/libr/anal/p/anal_ebc.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/p/anal_ebc.c"
...
# 4 "project/radare2/libr/anal/p/anal_ebc.c" 2
...
# 5 "project/radare2/libr/anal/p/anal_ebc.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_ebc.c" 2
...
# 7 "project/radare2/libr/anal/p/anal_ebc.c" 2


# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/ebc/ebc_disas.h" 1 3 4
...
# 10 "project/radare2/libr/anal/p/anal_ebc.c" 2


# 11 "project/radare2/libr/anal/p/anal_ebc.c"
static void ebc_anal_jmp8(RAnalOp *op, 
# 11 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
                                      unsigned long long 
# 11 "project/radare2/libr/anal/p/anal_ebc.c"
                                           addr, const 
# 11 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
...
# 11 "project/radare2/libr/anal/p/anal_ebc.c"
 ...
 if (
# 17 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
    (
# 17 "project/radare2/libr/anal/p/anal_ebc.c"
    buf[0] 
# 17 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
    & (1 << 
# 17 "project/radare2/libr/anal/p/anal_ebc.c"
...
static void ebc_anal_jmp(RAnalOp *op, 
# 24 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
                                     unsigned long long 
# 24 "project/radare2/libr/anal/p/anal_ebc.c"
                                          addr, const 
# 24 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
                                                      unsigned char 
# 24 "project/radare2/libr/anal/p/anal_ebc.c"
 ...
 op->fail = addr + 6;
 op->jump = (
# 26 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
            unsigned long long
# 26 "project/radare2/libr/anal/p/anal_ebc.c"
                )*(int32_t*)(buf + 2);
 if (
# 27 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
    (
# 27 "project/radare2/libr/anal/p/anal_ebc.c"
    buf[1] 
# 27 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
    & (1 << 
# 27 "project/radare2/libr/anal/p/anal_ebc.c"
...
# 27 "project/radare2/libr/anal/p/anal_ebc.c"
 ...
 if (buf[1] & 0x7) {
  ...
  if (
# 33 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
     (
# 33 "project/radare2/libr/anal/p/anal_ebc.c"
     buf[1] 
# 33 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
     & (1 << 
# 33 "project/radare2/libr/anal/p/anal_ebc.c"
...
static void ebc_anal_call(RAnalOp *op, 
# 41 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
                                      unsigned long long 
# 41 "project/radare2/libr/anal/p/anal_ebc.c"
                                           addr, const 
# 41 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
                                                       unsigned char 
# 41 "project/radare2/libr/anal/p/anal_ebc.c"
 ...
 op->fail = addr + 6;
 if ((buf[1] & 0x7) == 0 && 
# 45 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
                           (
# 45 "project/radare2/libr/anal/p/anal_ebc.c"
                           buf[0] 
# 45 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
                           & (1 << 
# 45 "project/radare2/libr/anal/p/anal_ebc.c"
...
# 45 "project/radare2/libr/anal/p/anal_ebc.c"
                                               == 0
   && 
# 46 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
     (
# 46 "project/radare2/libr/anal/p/anal_ebc.c"
     buf[0] 
# 46 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
     & (1 << 
# 46 "project/radare2/libr/anal/p/anal_ebc.c"
...
# 46 "project/radare2/libr/anal/p/anal_ebc.c"
  ...
  if (
# 49 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
     (
# 49 "project/radare2/libr/anal/p/anal_ebc.c"
     buf[1] 
# 49 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
     & (1 << 
# 49 "project/radare2/libr/anal/p/anal_ebc.c"
...
static int ebc_op(RAnal *anal, RAnalOp *op, 
# 60 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
                                           unsigned long long 
# 60 "project/radare2/libr/anal/p/anal_ebc.c"
                                                addr, const 
# 60 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
                                                            unsigned char 
# 60 "project/radare2/libr/anal/p/anal_ebc.c"
...
# 63 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
unsigned char 
# 63 "project/radare2/libr/anal/p/anal_ebc.c"
    opcode = buf[0] & 
# 63 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
                      0x3F
# 63 "project/radare2/libr/anal/p/anal_ebc.c"
...
# 174 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
__attribute__((visibility("default"))) 
# 174 "project/radare2/libr/anal/p/anal_ebc.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ANAL,
 .data = &r_anal_plugin_ebc,
 .version = 
# 177 "project/radare2/libr/anal/p/anal_ebc.c" 3 4
           "5.5.4"

# 178 "project/radare2/libr/anal/p/anal_ebc.c"
};
