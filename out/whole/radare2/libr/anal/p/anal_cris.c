# 0 "project/radare2/libr/anal/p/anal_cris.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/p/anal_cris.c"
...
# 4 "project/radare2/libr/anal/p/anal_cris.c" 2
...
# 5 "project/radare2/libr/anal/p/anal_cris.c" 2


# 6 "project/radare2/libr/anal/p/anal_cris.c"
static int analop(RAnal *a, RAnalOp *op, 
# 6 "project/radare2/libr/anal/p/anal_cris.c" 3 4
                                        unsigned long long 
# 6 "project/radare2/libr/anal/p/anal_cris.c"
                                             addr, const 
# 6 "project/radare2/libr/anal/p/anal_cris.c" 3 4
...
# 6 "project/radare2/libr/anal/p/anal_cris.c"
 ...
 case 0x7f:
  ...
  if (len > 5) {
   ...
   op->ptr |= buf[4]<<16;
   op->ptr |= ((
# 26 "project/radare2/libr/anal/p/anal_cris.c" 3 4
               unsigned int
# 26 "project/radare2/libr/anal/p/anal_cris.c"
                   )(0xff&buf[5]))<<24;
   op->ptr += addr;
   opsize = 6;
  } else {
   ...
   op->ptr = 
# 31 "project/radare2/libr/anal/p/anal_cris.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 31 "project/radare2/libr/anal/p/anal_cris.c"
                    ;
  }
  break;
 case 0xbf:
...
# 37 "project/radare2/libr/anal/p/anal_cris.c" 3 4
  int 
# 37 "project/radare2/libr/anal/p/anal_cris.c"
       delta = buf[2];
   delta |= buf[3]<<8;
   delta |= buf[4]<<16;
   delta |= buf[5]<<24;
   ...
   op->jump = 
# 43 "project/radare2/libr/anal/p/anal_cris.c" 3 4
             0xFFFFFFFFFFFFFFFFULL
# 43 "project/radare2/libr/anal/p/anal_cris.c"
                     ;
  }
  op->fail = addr + 6;
  opsize = 6;
...
# 54 "project/radare2/libr/anal/p/anal_cris.c" 3 4
   signed char 
# 54 "project/radare2/libr/anal/p/anal_cris.c"
       delta = buf[0];
    op->jump = addr + delta;
   }
  }
...
# 131 "project/radare2/libr/anal/p/anal_cris.c" 3 4
   signed char 
# 131 "project/radare2/libr/anal/p/anal_cris.c"
       delta = buf[0];
    op->jump = addr + delta;
   }
   break;
...
# 235 "project/radare2/libr/anal/p/anal_cris.c"
 op->size = opsize;
...
static 
# 240 "project/radare2/libr/anal/p/anal_cris.c" 3 4
      _Bool 
# 240 "project/radare2/libr/anal/p/anal_cris.c"
...
RAnalPlugin r_anal_plugin_cris = {
 ...
 .license = "LGPL3",
 .esil = 
# 281 "project/radare2/libr/anal/p/anal_cris.c" 3 4
        0
# 281 "project/radare2/libr/anal/p/anal_cris.c"
             ,
 .arch = "cris",
...
# 289 "project/radare2/libr/anal/p/anal_cris.c" 3 4
__attribute__((visibility("default"))) 
# 289 "project/radare2/libr/anal/p/anal_cris.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ANAL,
 .data = &r_anal_plugin_cris,
 .version = 
# 292 "project/radare2/libr/anal/p/anal_cris.c" 3 4
           "5.5.4"

# 293 "project/radare2/libr/anal/p/anal_cris.c"
};
