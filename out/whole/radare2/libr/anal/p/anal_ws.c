# 0 "project/radare2/libr/anal/p/anal_ws.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/p/anal_ws.c"
...
# 4 "project/radare2/libr/anal/p/anal_ws.c" 2
...
# 5 "project/radare2/libr/anal/p/anal_ws.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_ws.c" 2
...
# 8 "project/radare2/libr/anal/p/anal_ws.c" 2

#define WS_API static
# 1 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c" 1
# 11 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c"
...
static int get_ws_pref_optype(const 
# 22 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c" 3 4
                                   unsigned char 
# 22 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c"
                                       *buf, int len) {
 if (len < 1) {
  return WS_OP_UNK;
 }
...
static int get_ws_suf_optype(const 
# 34 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c" 3 4
                                  unsigned char 
# 34 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c"
                                      *buf, int len) {
 if (len < 1) {
  return WS_OP_UNK;
 }
...
static int get_ws_optype(const 
# 46 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c" 3 4
                              unsigned char 
# 46 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c"
                                  *buf, int len) {
 const 
# 47 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c" 3 4
      unsigned char 
# 47 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c"
          *ptr;
...
static const 
# 58 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c" 3 4
            unsigned char 
# 58 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c"
                *get_ws_next_token(const 
# 58 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c" 3 4
                                         unsigned char 
# 58 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c"
                                             *buf, int len) {
 const 
# 59 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c" 3 4
      unsigned char 
# 59 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c"
          *ret;
 ret = buf;
 while (len - (ret - buf)) {
  switch (*ret) {
 ...
 return 
# 70 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c" 3 4
       ((void *)0)
# 70 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c"
           ;
}

static 
# 73 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c" 3 4
      int 
# 73 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c"
           get_ws_val(const 
# 73 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c" 3 4
                            unsigned char 
# 73 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c"
...
# 74 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c" 3 4
unsigned char 
# 74 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c"
    sig;
 int i, ret = 0;
 const 
# 76 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c" 3 4
      unsigned char 
# 76 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c"
...
static int test_ws_token_exist(const 
# 95 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c" 3 4
                                    unsigned char 
# 95 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c"
                                        *buf, 
# 95 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c" 3 4
                                              unsigned char 
# 95 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c"
                                                  token, int len) {
 const 
# 96 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c" 3 4
      unsigned char 
# 96 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c"
...
static int wsdis(RAsmOp *op, const 
# 106 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c" 3 4
                                  unsigned char 
# 106 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c"
                                      *buf, int len) {
 const char *buf_asm = 
# 107 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c" 3 4
                      ((void *)0)
# 107 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c"
                          ;
 const 
# 108 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c" 3 4
      unsigned char 
# 108 "project/radare2/libr/anal/p/../../asm/arch/whitespace/wsdis.c"
          *ptr = buf;
...
# 11 "project/radare2/libr/anal/p/anal_ws.c" 2

static 
# 12 "project/radare2/libr/anal/p/anal_ws.c" 3 4
      unsigned long long 
# 12 "project/radare2/libr/anal/p/anal_ws.c"
           ws_find_label(int l, const RIOBind *iob) {
 RIO *io = iob->io;
 
# 14 "project/radare2/libr/anal/p/anal_ws.c" 3 4
unsigned long long 
# 14 "project/radare2/libr/anal/p/anal_ws.c"
     cur = 0, size = iob->desc_size (io->desc);
 
# 15 "project/radare2/libr/anal/p/anal_ws.c" 3 4
unsigned char 
# 15 "project/radare2/libr/anal/p/anal_ws.c"
    buf[128];
 RAsmOp aop;
...
static int ws_anal(RAnal *anal, RAnalOp *op, 
# 29 "project/radare2/libr/anal/p/anal_ws.c" 3 4
                                            unsigned long long 
# 29 "project/radare2/libr/anal/p/anal_ws.c"
                                                 addr, const 
# 29 "project/radare2/libr/anal/p/anal_ws.c" 3 4
                                                             unsigned char 
# 29 "project/radare2/libr/anal/p/anal_ws.c"
 ...
 RAsmOp *aop = 
# 32 "project/radare2/libr/anal/p/anal_ws.c" 3 4
              (
# 32 "project/radare2/libr/anal/p/anal_ws.c"
              RAsmOp
# 32 "project/radare2/libr/anal/p/anal_ws.c" 3 4
              *)calloc(1,sizeof(
# 32 "project/radare2/libr/anal/p/anal_ws.c"
...
# 132 "project/radare2/libr/anal/p/anal_ws.c" 3 4
__attribute__((visibility("default"))) 
# 132 "project/radare2/libr/anal/p/anal_ws.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ANAL,
 .data = &r_anal_plugin_ws,
 .version = 
# 135 "project/radare2/libr/anal/p/anal_ws.c" 3 4
           "5.5.4"

# 136 "project/radare2/libr/anal/p/anal_ws.c"
};
