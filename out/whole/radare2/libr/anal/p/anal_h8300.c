# 0 "project/radare2/libr/anal/p/anal_h8300.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/anal/p/anal_h8300.c" 2
...
# 5 "project/radare2/libr/anal/p/anal_h8300.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_h8300.c" 2
...
# 7 "project/radare2/libr/anal/p/anal_h8300.c" 2
...
# 11 "project/radare2/libr/anal/p/anal_h8300.c" 2
...
# 47 "project/radare2/libr/anal/p/anal_h8300.c"
static void h8300_anal_jmp(RAnalOp *op, 
# 47 "project/radare2/libr/anal/p/anal_h8300.c" 3 4
                                       unsigned long long 
# 47 "project/radare2/libr/anal/p/anal_h8300.c"
                                            addr, const 
# 47 "project/radare2/libr/anal/p/anal_h8300.c" 3 4
...
# 48 "project/radare2/libr/anal/p/anal_h8300.c" 3 4
unsigned short 
# 48 "project/radare2/libr/anal/p/anal_h8300.c"
     ad;
 ...
 case H8300_JMP_2:
  ...
  r_mem_swapendian ((
# 56 "project/radare2/libr/anal/p/anal_h8300.c" 3 4
                    unsigned char
# 56 "project/radare2/libr/anal/p/anal_h8300.c"
                       *)&ad, buf + 2, sizeof (
# 56 "project/radare2/libr/anal/p/anal_h8300.c" 3 4
                                               unsigned short
# 56 "project/radare2/libr/anal/p/anal_h8300.c"
...
static void h8300_anal_jsr(RAnalOp *op, 
# 66 "project/radare2/libr/anal/p/anal_h8300.c" 3 4
                                       unsigned long long 
# 66 "project/radare2/libr/anal/p/anal_h8300.c"
                                            addr, const 
# 66 "project/radare2/libr/anal/p/anal_h8300.c" 3 4
                                                        unsigned char 
# 66 "project/radare2/libr/anal/p/anal_h8300.c"
...
# 67 "project/radare2/libr/anal/p/anal_h8300.c" 3 4
unsigned short 
# 67 "project/radare2/libr/anal/p/anal_h8300.c"
     ad;
 ...
 case H8300_JSR_2:
  ...
  r_mem_swapendian ((
# 75 "project/radare2/libr/anal/p/anal_h8300.c" 3 4
                    unsigned char
# 75 "project/radare2/libr/anal/p/anal_h8300.c"
                       *)&ad, buf + 2, sizeof (
# 75 "project/radare2/libr/anal/p/anal_h8300.c" 3 4
                                               unsigned short
# 75 "project/radare2/libr/anal/p/anal_h8300.c"
...
# 86 "project/radare2/libr/anal/p/anal_h8300.c" 3 4
                                             unsigned long long 
# 86 "project/radare2/libr/anal/p/anal_h8300.c"
                                                  addr, const 
# 86 "project/radare2/libr/anal/p/anal_h8300.c" 3 4
                                                              unsigned char 
# 86 "project/radare2/libr/anal/p/anal_h8300.c"
...
# 88 "project/radare2/libr/anal/p/anal_h8300.c" 3 4
unsigned char 
# 88 "project/radare2/libr/anal/p/anal_h8300.c"
    opcode = buf[0];
 if (!op) {
  return 2;
 }
 ...
 case H8300_CMP_4BIT:
  ...
  r_strbuf_appendf(&op->esil, "0x%02x,r%u%c,-", buf[1], buf[0]&0x07,buf[0]&0x8?'l':'h');

  r_strbuf_appendf(&op->esil, ",%s,V,=", "%o");
  r_strbuf_appendf(&op->esil, ",15,$s,N,=");
  r_strbuf_appendf(&op->esil, ",3,$b,H,:=");
  r_strbuf_appendf(&op->esil, ",7,$b,C,:=");
  r_strbuf_appendf(&op->esil, ",0xff,r%u%c,&=",buf[0]&0x07,buf[0]&0x8?'l':'h');;
  r_strbuf_appendf(&op->esil, ",$z,Z,:=");
  return 0;
 case H8300_OR_4BIT:
  r_strbuf_appendf(&op->esil, "0x%02x,r%u%c,|=", buf[1], buf[0]&0x07,buf[0]&0x8?'l':'h');

  r_strbuf_appendf(&op->esil, ",%s,V,=", "0");
  r_strbuf_appendf(&op->esil, ",15,$s,N,=");
  r_strbuf_appendf(&op->esil, ",0xff,r%u%c,&=",buf[0]&0x07,buf[0]&0x8?'l':'h');;
  r_strbuf_appendf(&op->esil, ",$z,Z,:=");
  return 0;
 ...
 case H8300_ADD_4BIT:
  ...
  r_strbuf_appendf(&op->esil, ",%s,V,=", "%o");
  r_strbuf_appendf(&op->esil, ",15,$s,N,=");
  r_strbuf_appendf(&op->esil, ",3,$c,H,:=");
  r_strbuf_appendf(&op->esil, ",7,$c,C,:=");
  r_strbuf_appendf(&op->esil, ",0xff,r%u%c,&=",buf[0]&0x07,buf[0]&0x8?'l':'h');;
  r_strbuf_appendf(&op->esil, ",$z,Z,:=");
  return 0;
 case H8300_ADDX_4BIT:
  r_strbuf_appendf(&op->esil, "0x%02x,C,+,r%u%c,+= ", buf[1], buf[0]&0x07,buf[0]&0x8?'l':'h');
 ...
 case H8300_SUBX_4BIT:
  ...
  r_strbuf_appendf(&op->esil, "0x%02x,r%u%c,-=,C,r%u%c,-=", buf[1], buf[0]&0x07,buf[0]&0x8?'l':'h', buf[0]&0x07,buf[0]&0x8?'l':'h');
 ...
 case H8300_SLEEP:
  return 0;
 case H8300_STC:
  r_strbuf_appendf(&op->esil, "ccr,r%u%c,=", buf[1]&0x07,buf[1]&0x8?'l':'h');
  return 0;
 case H8300_LDC:
  r_strbuf_appendf(&op->esil, "r%u%c,ccr,=", buf[1]&0x07,buf[1]&0x8?'l':'h');
  return 0;
 case H8300_ORC:
  r_strbuf_appendf(&op->esil, "0x%02x,ccr,|=", buf[1]);
  return 0;
 case H8300_XORC:
  r_strbuf_appendf(&op->esil, "0x%02x,ccr,^=", buf[1]);
  return 0;
 ...
 case H8300_ADDB_DIRECT:
  r_strbuf_appendf(&op->esil, "r%u%c,r%u%c,+=", (buf[1]&0x70)>>4,buf[1]&0x80?'l':'h', buf[1]&0x07,buf[1]&0x8?'l':'h');
  r_strbuf_appendf(&op->esil, ",3,$c,H,:=");
  r_strbuf_appendf(&op->esil, ",%s,V,=", "%o");
  r_strbuf_appendf(&op->esil, ",7,$c,C,:=") ;
  r_strbuf_appendf(&op->esil, ",15,$s,N,=");

  r_strbuf_appendf(&op->esil, ",0xff,r%u%c,&=",buf[1]&0x07,buf[1]&0x8?'l':'h');;
  r_strbuf_appendf(&op->esil, ",$z,Z,:=");
  return 0;
 case H8300_ADDW_DIRECT:
  r_strbuf_appendf (&op->esil, "r%u,r%u,+=", (buf[1]&0x70)>>4, buf[1]&0x07);
  r_strbuf_appendf(&op->esil, ",11,$c,H,:=");
  r_strbuf_appendf(&op->esil, ",%s,V,=", "%o");
  r_strbuf_appendf(&op->esil, ",15,$c,C,:=");
  r_strbuf_appendf(&op->esil, ",15,$s,N,=");
  r_strbuf_appendf(&op->esil, ",0xffff,r%u,&=",buf[1]&0x07);;
  r_strbuf_appendf(&op->esil, ",$z,Z,:=");
  return 0;
 case H8300_INC:
  r_strbuf_appendf(&op->esil, "1,r%u%c,+=", buf[1]&0x07,buf[1]&0x8?'l':'h');
 ...
 case H8300_ADDS:
  r_strbuf_appendf (&op->esil, "%d,r%u,+=",
   ((buf[1] & 0xf0) == 0x80) ? 2 : 1, buf[1]&0x07);
  return 0;
 case H8300_MOV_1:
 ...
 case H8300_ADDX:
  ...
  r_strbuf_appendf (&op->esil, "r%u%c,C,+,r%u%c,+=",
    (buf[1]&0x70)>>4,buf[1]&0x80?'l':'h', buf[1]&0x07,buf[1]&0x8?'l':'h');
 ...
 case H8300_NOT_NEG:
  if ((buf[1] & 0xf0) == 0x80) {
   r_strbuf_appendf(&op->esil, "r%u%c,0,-,r%u%c,=", buf[1]&0x07,buf[1]&0x8?'l':'h', buf[1]&0x07,buf[1]&0x8?'l':'h');
   ...
   r_strbuf_appendf(&op->esil, "r%u%c,!=", buf[1]&0x07,buf[1]&0x8?'l':'h');
 ...
 case H8300_SUBW:
  r_strbuf_appendf (&op->esil, "r%u,r%u,-=", (buf[1]&0x70)>>4, buf[1]&0x07);
  r_strbuf_appendf(&op->esil, ",11,$b,H,:=");
  r_strbuf_appendf(&op->esil, ",%s,V,=", "%o");
  r_strbuf_appendf(&op->esil, ",15,$b,C,:=");
  r_strbuf_appendf(&op->esil, ",15,$s,N,=");
  r_strbuf_appendf(&op->esil, ",0xffff,r%u,&=",buf[1]&0x07);;
  r_strbuf_appendf(&op->esil, ",$z,Z,:=");
  return 0;
 ...
 case H8300_SUBX:
  ...
  r_strbuf_appendf(&op->esil, "r%u%c,r%u%c,-=,C,r%u%c,-=",
   (buf[1]&0x70)>>4,buf[1]&0x80?'l':'h', buf[1]&0x07,buf[1]&0x8?'l':'h', buf[1]&0x07,buf[1]&0x8?'l':'h');
 ...
 case H8300_MULXU:
  ...
  r_strbuf_appendf(&op->esil, "r%u%c,r%ul,*,r%u,=",
    (buf[1]&0x70)>>4,buf[1]&0x80?'l':'h', buf[1]&0x07, buf[1]&0x07);
  return 0;
 ...
 case H8300_BSET_1:
  ...
  r_strbuf_appendf(&op->esil, "0x7,r%u%c,&,1,<<,r%u%c,|=", (buf[1]&0x70)>>4,buf[1]&0x80?'l':'h', buf[1]&0x07,buf[1]&0x8?'l':'h');
  return 0;
 case H8300_BNOT_1:

  r_strbuf_appendf(&op->esil,"0x07,r%u%c,&,1,<<,r%u%c,^=", (buf[1]&0x70)>>4,buf[1]&0x80?'l':'h', buf[1]&0x07,buf[1]&0x8?'l':'h');
  return 0;
 ...
 case H8300_BTST_R2R8:
  ...
  r_strbuf_appendf(&op->esil, "0x7,r%u%c,&,0x7,r%u%c,&,1,<<,r%u%c,&,>>,!,Z,=",
    (buf[1]&0x70)>>4,buf[1]&0x80?'l':'h', (buf[1]&0x70)>>4,buf[1]&0x80?'l':'h', buf[1]&0x07,buf[1]&0x8?'l':'h');
  return 0;
 case H8300_BST_BIST:
  if (!(buf[1] & 0x80)) {
   r_strbuf_appendf(&op->esil,"%d,C,<<,r%u%c,|=",(buf[1]&0x70)>>4,buf[1]&0x07,buf[1]&0x8?'l':'h');
  } else {
   r_strbuf_appendf (&op->esil, "%d,C,!,<<,r%u%c,|=", (buf[1]&0x70)>>4, buf[1]&0x07,buf[1]&0x8?'l':'h');
  }
  return 0;
 ...
 case H8300_BSET_2:
  ...
  r_strbuf_appendf(&op->esil, "%d,1,<<,r%u%c,|=", (buf[1]&0x70)>>4, buf[1]&0x07,buf[1]&0x8?'l':'h');
  return 0;
 case H8300_BNOT_2:
 ...
 case H8300_BTST:
  ...
  r_strbuf_appendf(&op->esil, "%d,%d,1,<<,r%u%c,&,>>,!,Z,=",
    (buf[1]&0x70)>>4, (buf[1]&0x70)>>4, buf[1]&0x07,buf[1]&0x8?'l':'h');
  return 0;
 case H8300_BOR_BIOR:
  if (!(buf[1] & 0x80)) {
...
static int h8300_op(RAnal *anal, RAnalOp *op, 
# 539 "project/radare2/libr/anal/p/anal_h8300.c" 3 4
                                             unsigned long long 
# 539 "project/radare2/libr/anal/p/anal_h8300.c"
                                                  addr,
  const 
# 540 "project/radare2/libr/anal/p/anal_h8300.c" 3 4
       unsigned char 
# 540 "project/radare2/libr/anal/p/anal_h8300.c"
           *buf, int len, RAnalOpMask mask)
{
 int ret;
 
# 543 "project/radare2/libr/anal/p/anal_h8300.c" 3 4
unsigned char 
# 543 "project/radare2/libr/anal/p/anal_h8300.c"
    opcode = buf[0];
 ...
 case H8300_BLE:
  ...
  op->jump = addr + 2 + (
# 669 "project/radare2/libr/anal/p/anal_h8300.c" 3 4
                        signed char
# 669 "project/radare2/libr/anal/p/anal_h8300.c"
                           )(buf[1]);
  op->fail = addr + 2;
  break;
 default:
...
static 
# 682 "project/radare2/libr/anal/p/anal_h8300.c" 3 4
      _Bool 
# 682 "project/radare2/libr/anal/p/anal_h8300.c"
...
RAnalPlugin r_anal_plugin_h8300 = {
 ...
 .op = &h8300_op,
 .esil = 
# 731 "project/radare2/libr/anal/p/anal_h8300.c" 3 4
        1
# 731 "project/radare2/libr/anal/p/anal_h8300.c"
            ,
...
struct r_lib_struct_t radare_plugin = {
 ...
 .version = 
# 739 "project/radare2/libr/anal/p/anal_h8300.c" 3 4
           "5.5.4"

# 740 "project/radare2/libr/anal/p/anal_h8300.c"
};
