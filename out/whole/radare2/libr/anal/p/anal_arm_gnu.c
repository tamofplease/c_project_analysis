# 0 "project/radare2/libr/anal/p/anal_arm_gnu.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 4 "project/radare2/libr/anal/p/anal_arm_gnu.c" 2
...
# 5 "project/radare2/libr/anal/p/anal_arm_gnu.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_arm_gnu.c" 2
...
# 7 "project/radare2/libr/anal/p/anal_arm_gnu.c" 2



# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/include/wine-arm.h" 1 3 4
...
# 74 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/include/wine-arm.h" 3 4
...
# 11 "project/radare2/libr/anal/p/anal_arm_gnu.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/arm/asm-arm.h" 1 3 4

#define _INCLUDE_ARMASS_H_ 



int armass_assemble(const char *str, unsigned long long off, int thumb);
# 12 "project/radare2/libr/anal/p/anal_arm_gnu.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/arm/winedbg/be_arm.h" 1 3 4
...
struct winedbg_arm_insn {
 ...
 char *str_asm;
 char *str_hex;
 unsigned long long jmp, fail;
};

int arm_disasm_one_insn(struct winedbg_arm_insn *arminsn);
void arm_set_pc(struct winedbg_arm_insn *arminsn, unsigned long long pc);
void arm_set_input_buffer(struct winedbg_arm_insn *arminsn, const unsigned char *buf);
...
# 13 "project/radare2/libr/anal/p/anal_arm_gnu.c" 2
# 1 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 1


# 2 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
static int hack_handle_dp_reg(
# 2 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
                             unsigned int 
# 2 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
                                  insn, RAnalOp *op) {
 const 
# 3 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
      _Bool 
# 3 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
           op0 = (insn >> 30) & 0x1;
 const 
# 4 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
      _Bool 
# 4 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
           op1 = (insn >> 28) & 0x1;
 const 
# 5 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
      unsigned char 
# 5 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
          op2 = (insn >> 21) & 0xf;


 if (!op0 && op1 && op2 == 6) {
  const 
# 9 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
       _Bool 
# 9 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
            sf = (insn >> 31) & 0x1;
  const 
# 10 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
       _Bool 
# 10 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
            S = (insn >> 29) & 0x1;
  const 
# 11 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
       unsigned char 
# 11 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
           opcode = (insn >> 10) & 0x1f;
  if (sf) {
   if (!S) {
    if (opcode == 4) {
...
static int hack_handle_ldst(
# 37 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
                           unsigned int 
# 37 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
                                insn, RAnalOp *op) {
 const 
# 38 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
      unsigned char 
# 38 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
          op0 = (insn >> 28) & 0xf;
 const 
# 39 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
      _Bool 
# 39 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
           op1 = (insn >> 26) & 0x1;
 
# 40 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
unsigned char 
# 40 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
    op2 = (insn >> 23) & 0x3;
 const 
# 41 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
      _Bool 
# 41 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
           op3 = (insn >> 21) & 0x1;


 if (op0 == 13 && !op1 && (op2 == 2 || op2 == 3) && op3) {
  const 
# 45 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
       unsigned char 
# 45 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
           opc = (insn >> 22) & 0x3;
  op2 = (insn >> 10) & 0x3;
  if (op2 > 0) {
   switch (opc) {
  ...
  const 
# 88 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
       unsigned char 
# 88 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
           opc = (insn >> 30) & 0x3;
  const 
# 89 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
       _Bool 
# 89 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
            V = (insn >> 26) & 0x1;
  const 
# 90 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
       _Bool 
# 90 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
            L = (insn >> 22) & 0x1;
  if (opc == 1 && !V && !L) {
...
static int hack_handle_dp_imm(
# 100 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
                             unsigned int 
# 100 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
                                  insn, RAnalOp *op) {
 const 
# 101 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
      unsigned char 
# 101 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
          op0 = (insn >> 23) & 0x7;


 if (op0 == 3) {
  const 
# 105 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
       _Bool 
# 105 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
            sf = (insn >> 31) & 0x1;
  const 
# 106 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
       _Bool 
# 106 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
            op_ = (insn >> 30) & 0x1;
  const 
# 107 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
       _Bool 
# 107 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
            S = (insn >> 29) & 0x1;
  const 
# 108 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
       _Bool 
# 108 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
            o2 = (insn >> 22) & 0x1;
  if (sf && !S && !o2) {
   if (op_ ) {
...
static int hack_handle_br_exc_sys(
# 123 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
                                 unsigned int 
# 123 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
                                      insn, RAnalOp *op) {
 const 
# 124 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
      unsigned char 
# 124 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
          op0 = (insn >> 29) & 0x7;
 const 
# 125 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
      unsigned short 
# 125 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
           op1 = (insn >> 12) & 0x3fff;
 
# 126 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
unsigned char 
# 126 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
    op2 = insn & 0x1f;


 if (op0 == 6 && op1 == 4146 && op2 == 31) {
  const 
# 130 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
       unsigned char 
# 130 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
           CRm = (insn >> 8) & 0xf;
  op2 = (insn >> 5) & 0x7;
  if (CRm == 4 && (op2 & 1) == 0) {
   switch (op2) {
...
static inline int hackyArmAnal(RAnal *a, RAnalOp *op, const 
# 146 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
                                                           unsigned char 
# 146 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
                                                               *buf, int len) {
 int ret = -1;

 if (a->bits == 64 && len >= 4) {
  
# 150 "project/radare2/libr/anal/p/./anal_arm_hacks.inc" 3 4
 unsigned int 
# 150 "project/radare2/libr/anal/p/./anal_arm_hacks.inc"
      insn = r_read_ble32 (buf, a->big_endian);
...
# 14 "project/radare2/libr/anal/p/anal_arm_gnu.c" 2
...
static int op_thumb(RAnal *anal, RAnalOp *op, 
# 35 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                                             unsigned long long 
# 35 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                                                  addr, const 
# 35 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                                                              unsigned char 
# 35 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 37 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
unsigned short 
# 37 "project/radare2/libr/anal/p/anal_arm_gnu.c"
     *_ins = (
# 37 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
              unsigned short 
# 37 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 38 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
unsigned short 
# 38 "project/radare2/libr/anal/p/anal_arm_gnu.c"
     ins = *_ins;
 
# 39 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
unsigned int 
# 39 "project/radare2/libr/anal/p/anal_arm_gnu.c"
     *_ins32 = (
# 39 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                unsigned int 
# 39 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 40 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
unsigned int 
# 40 "project/radare2/libr/anal/p/anal_arm_gnu.c"
     ins32 = *_ins32;

 struct winedbg_arm_insn *arminsn = arm_new ();
 arm_set_thumb (arminsn, 
# 43 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                        1
# 43 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                            );
 ...
 if (((ins & 
# 55 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
            ((14<<12)|(
# 55 "project/radare2/libr/anal/p/anal_arm_gnu.c"
            0
# 55 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
            <<8)|(
# 55 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 55 "project/radare2/libr/anal/p/anal_arm_gnu.c"
     ...
     && (1 == (ins & 
# 56 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                    ((
# 56 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                    1
# 56 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                    <<12)|(8<<8)|(
# 56 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 56 "project/radare2/libr/anal/p/anal_arm_gnu.c"
 ...
 if ((ins & 
# 60 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
           ((15<<12)|(12<<8)|(
# 60 "project/radare2/libr/anal/p/anal_arm_gnu.c"
           0
# 60 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
           <<4)|(
# 60 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 60 "project/radare2/libr/anal/p/anal_arm_gnu.c"
  ...
  op_code = (ins & 
# 61 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  ((
# 61 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                  0
# 61 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  <<12)|(3<<8)|(12<<4)|(
# 61 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 61 "project/radare2/libr/anal/p/anal_arm_gnu.c"
 ...
 if ((ins & 
# 67 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
           ((15<<12)|(12<<8)|(
# 67 "project/radare2/libr/anal/p/anal_arm_gnu.c"
           0
# 67 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
           <<4)|(
# 67 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 67 "project/radare2/libr/anal/p/anal_arm_gnu.c"
  ...
  op_code = (ins & 
# 68 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  ((
# 68 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                  0
# 68 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  <<12)|(3<<8)|(
# 68 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 77 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                               ((15<<12)|(8<<8)|(
# 77 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                               0
# 77 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                               <<4)|(
# 77 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 83 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  ((15<<12)|(
# 83 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                  0
# 83 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  <<8)|(
# 83 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 83 "project/radare2/libr/anal/p/anal_arm_gnu.c"
  ...
  op_code = (ins & 
# 84 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  ((
# 84 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                  0
# 84 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  <<12)|(14<<8)|(
# 84 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 90 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  ((15<<12)|(
# 90 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                  0
# 90 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  <<8)|(
# 90 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 90 "project/radare2/libr/anal/p/anal_arm_gnu.c"
  ...
  int delta = (ins & 
# 92 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                    ((
# 92 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                    0
# 92 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                    <<12)|(
# 92 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 96 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  ((15<<12)|(8<<8)|(
# 96 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                  0
# 96 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  <<4)|(
# 96 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 96 "project/radare2/libr/anal/p/anal_arm_gnu.c"
  ...
  int delta = (ins & 
# 98 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                    ((
# 98 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                    0
# 98 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                    <<12)|(
# 98 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 102 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  ((15<<12)|(15<<8)|(8<<4)|(
# 102 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                  0
# 102 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  ))
# 102 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 106 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  ((15<<12)|(15<<8)|(8<<4)|(
# 106 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                  0
# 106 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  ))
# 106 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 110 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  ((15<<12)|(8<<8)|(
# 110 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                  0
# 110 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  <<4)|(
# 110 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 114 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
 unsigned short 
# 114 "project/radare2/libr/anal/p/anal_arm_gnu.c"
      nextins = (ins32 & 0xFFFF0000) >> 16;
  
# 115 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
 unsigned int 
# 115 "project/radare2/libr/anal/p/anal_arm_gnu.c"
      high = (ins & 
# 115 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                    ((
# 115 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 115 "project/radare2/libr/anal/p/anal_arm_gnu.c"
  ...
  if (ins & 
# 116 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
           ((
# 116 "project/radare2/libr/anal/p/anal_arm_gnu.c"
           0
# 116 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
           <<12)|(4<<8)|(
# 116 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 116 "project/radare2/libr/anal/p/anal_arm_gnu.c"
   ...
   high |= 
# 117 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
          ((15<<12)|(8<<8)|(
# 117 "project/radare2/libr/anal/p/anal_arm_gnu.c"
          0
# 117 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
          <<4)|(
# 117 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 117 "project/radare2/libr/anal/p/anal_arm_gnu.c"
  ...
  int delta = high + ((nextins & 
# 119 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                                ((
# 119 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                                0
# 119 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                                <<12)|(7<<8)|(15<<4)|(15))
# 119 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 123 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  ((15<<12)|(15<<8)|(
# 123 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                  0
# 123 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  <<4)|(
# 123 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 123 "project/radare2/libr/anal/p/anal_arm_gnu.c"
  ...
  op->val = (
# 125 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
            unsigned long long
# 125 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                ) (ins >> 8);
 } else if ((ins & 
# 126 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  ((15<<12)|(15<<8)|(
# 126 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                  0
# 126 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                  <<4)|(
# 126 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 126 "project/radare2/libr/anal/p/anal_arm_gnu.c"
  ...
  op->val = (
# 128 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
            unsigned long long
# 128 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                ) (ins >> 8);
 }
 return op->size;
}
...
static int op_cond(const 
# 157 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                        unsigned char 
# 157 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                            *data) {
 
# 158 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
unsigned char 
# 158 "project/radare2/libr/anal/p/anal_arm_gnu.c"
    b = data[3] >> 4;
 if (b == 0xf) {
  return 0;
 }
...
static int arm_op32(RAnal *anal, RAnalOp *op, 
# 165 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                                             unsigned long long 
# 165 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                                                  addr, const 
# 165 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                                                              unsigned char 
# 165 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                                                                  *data, int len) {
 const 
# 166 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
      unsigned char 
# 166 "project/radare2/libr/anal/p/anal_arm_gnu.c"
          *b = (
# 166 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                unsigned char 
# 166 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 167 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
unsigned char 
# 167 "project/radare2/libr/anal/p/anal_arm_gnu.c"
    ndata[4] = {0};
 
# 168 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
unsigned int 
# 168 "project/radare2/libr/anal/p/anal_arm_gnu.c"
     branch_dst_addr, i = 0;
 
# 169 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
unsigned int 
# 169 "project/radare2/libr/anal/p/anal_arm_gnu.c"
     *code = (
# 169 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
              unsigned int 
# 169 "project/radare2/libr/anal/p/anal_arm_gnu.c"
 ...
 arminsn = arm_new ();
 arm_set_thumb (arminsn, 
# 176 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                        0
# 176 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                             );
 arm_set_input_buffer (arminsn, data);
 arm_set_pc (arminsn, addr);
 op->addr = addr;
...
# 184 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
 unsigned char 
# 184 "project/radare2/libr/anal/p/anal_arm_gnu.c"
     tmp = data[3];
  ndata[0] = data[3];
  ndata[1] = data[2];
  ndata[2] = data[1];
...
#define ROR(x,y) ((int) ((x) >> (y)) | (((x) << (32 - (y)))))
  op->ptr = addr + ((int) ((b[0]) >> ((b[1] & 0xf) << 1)) | (((b[0]) << (32 - ((b[1] & 0xf) << 1))))) + 8;
...
# 240 "project/radare2/libr/anal/p/anal_arm_gnu.c"
  if ((b[1] & 0xf0) == 0xf0) {
  ...
  op->stackop = R_ANAL_STACK_INC;
  op->val = -b[0];
 } else if (code[i] == 0x1eff2fe1 || code[i] == 0xe12fff1e) {
  op->type = R_ANAL_OP_TYPE_RET;
 } else if (code[i] & 
# 273 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                     (0x01<<20)
# 273 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                                 ) {
  
# 274 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
 unsigned int 
# 274 "project/radare2/libr/anal/p/anal_arm_gnu.c"
      ptr = 0;
  op->type = R_ANAL_OP_TYPE_MOV;
  if (b[2] == 0x1b) {
   ...
   if (anal->bits == 32) {
    b = (
# 285 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
        unsigned char 
# 285 "project/radare2/libr/anal/p/anal_arm_gnu.c"
            *) &ptr;
 ...
 if ((((code[i]) & 
# 295 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
    (0x01<<20)
# 295 "project/radare2/libr/anal/p/anal_arm_gnu.c"
    ) == (
# 295 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
    (0x01<<20)
# 295 "project/radare2/libr/anal/p/anal_arm_gnu.c"
 ...
 if (((((code[i] & 0xff) >= 0x10 && (code[i] & 0xff) < 0x20)) &&
     ...
     ((((code[i]) & 
# 301 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
    0x0E000000
# 301 "project/radare2/libr/anal/p/anal_arm_gnu.c"
    ) == 
# 301 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
    0x0a000000
# 301 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 311 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
            0x0E000000
# 311 "project/radare2/libr/anal/p/anal_arm_gnu.c"
            ) == 
# 311 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
            0x0a000000
# 311 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 311 "project/radare2/libr/anal/p/anal_arm_gnu.c"
   ...
   if ((((code[i]) & 
# 312 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
      0x0E000000
# 312 "project/radare2/libr/anal/p/anal_arm_gnu.c"
      ) == 
# 312 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
      0x0a000000
# 312 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 319 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
            0x0E000000
# 319 "project/radare2/libr/anal/p/anal_arm_gnu.c"
            ) == 
# 319 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
            0x0a000000
# 319 "project/radare2/libr/anal/p/anal_arm_gnu.c"
   ...
   if ((((code[i]) & 
# 320 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
      0xf0000000
# 320 "project/radare2/libr/anal/p/anal_arm_gnu.c"
      ) == 
# 320 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
      0xe0000000
# 320 "project/radare2/libr/anal/p/anal_arm_gnu.c"
    ...
    op->jump = branch_dst_addr;
    op->fail = 
# 323 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
              0xFFFFFFFFFFFFFFFFULL
# 323 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                      ;
   } else {
    op->type = R_ANAL_OP_TYPE_CJMP;
    op->jump = branch_dst_addr;
...
static 
# 342 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
      unsigned long long 
# 342 "project/radare2/libr/anal/p/anal_arm_gnu.c"
           getaddr(
# 342 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                   unsigned long long 
# 342 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
# 345 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
 int 
# 345 "project/radare2/libr/anal/p/anal_arm_gnu.c"
      n = (d[0] + (d[1] << 8) + (d[2] << 16) + ((
# 345 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                                                 unsigned long long
# 345 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
static int arm_op64(RAnal *anal, RAnalOp *op, 
# 352 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                                             unsigned long long 
# 352 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                                                  addr, const 
# 352 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                                                              unsigned char 
# 352 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
static int arm_op(RAnal *anal, RAnalOp *op, 
# 401 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                                           unsigned long long 
# 401 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                                                addr, const 
# 401 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
                                                            unsigned char 
# 401 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
static 
# 408 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
      _Bool 
# 408 "project/radare2/libr/anal/p/anal_arm_gnu.c"
...
static int archinfo(RAnal *anal, int q) {
 if (q == 
# 444 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
         4
# 444 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                              ) {
 ...
 if (q == 
# 450 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
         1
# 450 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                                    ) {
  return 4;
 }
 if (q == 
# 453 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
         0
# 453 "project/radare2/libr/anal/p/anal_arm_gnu.c"
                                    ) {
  if (anal && anal->bits == 16) {
   return 2;
  }
...
# 474 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
__attribute__((visibility("default"))) 
# 474 "project/radare2/libr/anal/p/anal_arm_gnu.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ANAL,
 .data = &r_anal_plugin_arm_gnu,
 .version = 
# 477 "project/radare2/libr/anal/p/anal_arm_gnu.c" 3 4
           "5.5.4"

# 478 "project/radare2/libr/anal/p/anal_arm_gnu.c"
};
