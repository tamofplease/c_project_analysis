# 0 "project/radare2/libr/anal/p/anal_or1k.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/anal/p/anal_or1k.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_or1k.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/or1k/or1k_disas.h" 1 3 4
...
insn_extra_t *find_extra_descriptor(insn_extra_t *extra_descr, unsigned int insn);
# 149 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/or1k/or1k_disas.h" 3 4
unsigned int sign_extend(unsigned int number, unsigned int mask);

static inline unsigned int get_operand_mask(insn_type_descr_t *type_descr, insn_oper_t operand) {
 return type_descr->operands[operand].mask;
}

static inline unsigned int get_operand_shift(insn_type_descr_t *type_descr, insn_oper_t operand) {
 return type_descr->operands[operand].shift;
}

static inline unsigned int get_operand_value(unsigned int insn, insn_type_descr_t *type_descr, insn_oper_t operand) {
...
static inline insn_type_t type_of_opcode(insn_t *descr, insn_extra_t *extra_descr) {
 do { if (!(descr)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), "descr", 172); return (INSN_END); } } while (0);

 if (extra_descr == ((void *)0)) {
  return descr->type;
 } else {
  return extra_descr->type;
 }
}
# 7 "project/radare2/libr/anal/p/anal_or1k.c" 2


# 8 "project/radare2/libr/anal/p/anal_or1k.c"
struct operands {
 
# 9 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
unsigned int 
# 9 "project/radare2/libr/anal/p/anal_or1k.c"
     rd;
 
# 10 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
unsigned int 
# 10 "project/radare2/libr/anal/p/anal_or1k.c"
     ra;
 
# 11 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
unsigned int 
# 11 "project/radare2/libr/anal/p/anal_or1k.c"
     rb;
 
# 12 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
unsigned int 
# 12 "project/radare2/libr/anal/p/anal_or1k.c"
     n;
 
# 13 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
unsigned int 
# 13 "project/radare2/libr/anal/p/anal_or1k.c"
     k1;
 
# 14 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
unsigned int 
# 14 "project/radare2/libr/anal/p/anal_or1k.c"
     k2;
 
# 15 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
unsigned int 
# 15 "project/radare2/libr/anal/p/anal_or1k.c"
     k;
 
# 16 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
unsigned int 
# 16 "project/radare2/libr/anal/p/anal_or1k.c"
     i;
 
# 17 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
unsigned int 
# 17 "project/radare2/libr/anal/p/anal_or1k.c"
     l;
};

static 
# 20 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
      unsigned int 
# 20 "project/radare2/libr/anal/p/anal_or1k.c"
           cpu[32] = {0};
static 
# 21 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
      unsigned int 
# 21 "project/radare2/libr/anal/p/anal_or1k.c"
           cpu_enable;
# 33 "project/radare2/libr/anal/p/anal_or1k.c"
static 
# 33 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
      unsigned long long 
# 33 "project/radare2/libr/anal/p/anal_or1k.c"
           n_oper_to_addr(
# 33 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
...
# 33 "project/radare2/libr/anal/p/anal_or1k.c"
 ...
 return (
# 37 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
        unsigned long long
# 37 "project/radare2/libr/anal/p/anal_or1k.c"
            ) ((
# 37 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
                long long
# 37 "project/radare2/libr/anal/p/anal_or1k.c"
...
# 37 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
                        int
# 37 "project/radare2/libr/anal/p/anal_or1k.c"
                            ) (sign_extend(n, mask) << 2)) + addr);
}

static int insn_to_op(RAnal *a, RAnalOp *op, 
# 40 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
                                            unsigned long long 
# 40 "project/radare2/libr/anal/p/anal_or1k.c"
                                                 addr, insn_t *descr, insn_extra_t *extra, 
# 40 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
                                                                                           unsigned int 
# 40 "project/radare2/libr/anal/p/anal_or1k.c"
                                                                                                insn) {
 ...
 if (extra == 
# 50 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
             ((void *)0)
# 50 "project/radare2/libr/anal/p/anal_or1k.c"
                 ) {
 ...
 switch ((insn & 
# 56 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
                (0x3fULL * 0x4000000)
# 56 "project/radare2/libr/anal/p/anal_or1k.c"
                                ) >> 
# 56 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
                                     26
# 56 "project/radare2/libr/anal/p/anal_or1k.c"
 ...
 case 0x00:
  ...
  op->eob = 
# 59 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
           1
# 59 "project/radare2/libr/anal/p/anal_or1k.c"
               ;
 ...
 case 0x01:
  o.n = get_operand_value(insn, type_descr, INSN_OPER_N);
  op->eob = 
# 66 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
           1
# 66 "project/radare2/libr/anal/p/anal_or1k.c"
               ;
  op->jump = n_oper_to_addr(o.n, get_operand_mask(type_descr, INSN_OPER_N),
    addr);
  op->delay = 1;
 ...
 case 0x11:
  ...
  op->eob = 
# 89 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
           1
# 89 "project/radare2/libr/anal/p/anal_or1k.c"
               ;
 ...
 case 0x12:
  o.rb = get_operand_value(insn, type_descr, INSN_OPER_B);
  op->eob = 
# 97 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
           1
# 97 "project/radare2/libr/anal/p/anal_or1k.c"
               ;
  if (cpu_enable & (1 << o.rb)) {
   op->jump = cpu[o.rb];
  }
...
static int or1k_op(RAnal *a, RAnalOp *op, 
# 150 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
                                         unsigned long long 
# 150 "project/radare2/libr/anal/p/anal_or1k.c"
                                              addr, const 
# 150 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
                                                          unsigned char 
# 150 "project/radare2/libr/anal/p/anal_or1k.c"
...
# 151 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
unsigned int 
# 151 "project/radare2/libr/anal/p/anal_or1k.c"
     insn, opcode;
 
# 152 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
unsigned char 
# 152 "project/radare2/libr/anal/p/anal_or1k.c"
    opcode_idx;
 insn_t *insn_descr;
 ...
 op->size = 4;
 opcode = (insn & 
# 159 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
                 (0x3fULL * 0x4000000)
# 159 "project/radare2/libr/anal/p/anal_or1k.c"
                                 );
 opcode_idx = opcode >> 
# 160 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
                       26
# 160 "project/radare2/libr/anal/p/anal_or1k.c"
                                        ;
 ...
 if ((insn_descr->name == 
# 175 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
                         ((void *)0)
# 175 "project/radare2/libr/anal/p/anal_or1k.c"
                             ) && (insn_descr->extra != 
# 175 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
                                                        ((void *)0)
# 175 "project/radare2/libr/anal/p/anal_or1k.c"
  ...
  if (extra_descr != 
# 177 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
                    ((void *)0)
# 177 "project/radare2/libr/anal/p/anal_or1k.c"
                        ) {
  ...
  insn_to_op(a, op, addr, insn_descr, 
# 183 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
                                     ((void *)0)
# 183 "project/radare2/libr/anal/p/anal_or1k.c"
                                         , insn);
 }
...
RAnalPlugin r_anal_plugin_or1k = {
 ...
 .arch = "or1k",
 .esil = 
# 195 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
        0
# 195 "project/radare2/libr/anal/p/anal_or1k.c"
             ,
 .op = &or1k_op,
};
...
# 200 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
__attribute__((visibility("default"))) 
# 200 "project/radare2/libr/anal/p/anal_or1k.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ANAL,
 .data = &r_anal_plugin_or1k,
 .version = 
# 203 "project/radare2/libr/anal/p/anal_or1k.c" 3 4
           "5.5.4"

# 204 "project/radare2/libr/anal/p/anal_or1k.c"
};
