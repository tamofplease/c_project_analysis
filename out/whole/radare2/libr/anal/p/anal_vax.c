# 0 "project/radare2/libr/anal/p/anal_vax.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/p/anal_vax.c"
...
# 4 "project/radare2/libr/anal/p/anal_vax.c" 2
...
# 5 "project/radare2/libr/anal/p/anal_vax.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_vax.c" 2
...
# 7 "project/radare2/libr/anal/p/anal_vax.c" 2
...
# 8 "project/radare2/libr/anal/p/anal_vax.c" 2
...
# 14 "project/radare2/libr/anal/p/anal_vax.c"
static int vax_op(RAnal *anal, RAnalOp *op, 
# 14 "project/radare2/libr/anal/p/anal_vax.c" 3 4
                                           unsigned long long 
# 14 "project/radare2/libr/anal/p/anal_vax.c"
                                                addr, const 
# 14 "project/radare2/libr/anal/p/anal_vax.c" 3 4
...
# 155 "project/radare2/libr/anal/p/anal_vax.c" 3 4
  unsigned int 
# 155 "project/radare2/libr/anal/p/anal_vax.c"
       delta = buf[oa];
   delta |= (
# 156 "project/radare2/libr/anal/p/anal_vax.c" 3 4
            unsigned int
# 156 "project/radare2/libr/anal/p/anal_vax.c"
                )(buf[oa + 1]) << 8;
   delta |= (
# 157 "project/radare2/libr/anal/p/anal_vax.c" 3 4
            unsigned int
# 157 "project/radare2/libr/anal/p/anal_vax.c"
                )(buf[oa + 2]) << 16;
   delta |= (
# 158 "project/radare2/libr/anal/p/anal_vax.c" 3 4
            unsigned int
# 158 "project/radare2/libr/anal/p/anal_vax.c"
                )(buf[oa + 3]) << 24;
   delta += op->size;
...
static int archinfo(RAnal *anal, int q) {
 if (q == 
# 212 "project/radare2/libr/anal/p/anal_vax.c" 3 4
         8
# 212 "project/radare2/libr/anal/p/anal_vax.c"
                                   ) {
  return 1;
 }
 if (q == 
# 215 "project/radare2/libr/anal/p/anal_vax.c" 3 4
         4
# 215 "project/radare2/libr/anal/p/anal_vax.c"
                              ) {
  return 1;
 }
 if (q == 
# 218 "project/radare2/libr/anal/p/anal_vax.c" 3 4
         1
# 218 "project/radare2/libr/anal/p/anal_vax.c"
                                    ) {
  return 56;
 }
 if (q == 
# 221 "project/radare2/libr/anal/p/anal_vax.c" 3 4
         0
# 221 "project/radare2/libr/anal/p/anal_vax.c"
                                    ) {
  return 1;
 }
 return 1;
...
RAnalPlugin r_anal_plugin_vax = {
 ...
 .arch = "vax",
 .esil = 
# 232 "project/radare2/libr/anal/p/anal_vax.c" 3 4
        1
# 232 "project/radare2/libr/anal/p/anal_vax.c"
            ,
 .bits = 32,
 .op = &vax_op,
...
# 240 "project/radare2/libr/anal/p/anal_vax.c" 3 4
__attribute__((visibility("default"))) 
# 240 "project/radare2/libr/anal/p/anal_vax.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ANAL,
 .data = &r_anal_plugin_vax,
 .version = 
# 243 "project/radare2/libr/anal/p/anal_vax.c" 3 4
           "5.5.4"

# 244 "project/radare2/libr/anal/p/anal_vax.c"
};
