# 0 "project/radare2/libr/anal/p/anal_v850.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/p/anal_v850.c"
...
# 5 "project/radare2/libr/anal/p/anal_v850.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_v850.c" 2
...
# 7 "project/radare2/libr/anal/p/anal_v850.c" 2
...
# 8 "project/radare2/libr/anal/p/anal_v850.c" 2




# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/libr/asm/arch/v850/v850_disas.h" 1 3 4
...
static inline unsigned char get_opcode(const unsigned short instr) {
 return (instr >> 5) & 0x3F;
}


static inline unsigned char get_subopcode(const unsigned short instr) {
 return (instr & 0x7e00000) >> 21;
}

static inline unsigned char get_reg1(const unsigned short instr) {
 return instr & 0x1F;
}

static inline unsigned char get_reg2(const unsigned short instr) {
 return instr >> 11;
}

int v850_decode_command (const unsigned char *instr, int len, struct v850_cmd *cmd);
# 13 "project/radare2/libr/anal/p/anal_v850.c" 2
...
# 102 "project/radare2/libr/anal/p/anal_v850.c"
...
static int v850_op(RAnal *anal, RAnalOp *op, 
# 167 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                                            unsigned long long 
# 167 "project/radare2/libr/anal/p/anal_v850.c"
                                                 addr, const 
# 167 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                                                             unsigned char 
# 167 "project/radare2/libr/anal/p/anal_v850.c"
...
# 169 "project/radare2/libr/anal/p/anal_v850.c" 3 4
unsigned char 
# 169 "project/radare2/libr/anal/p/anal_v850.c"
    opcode = 0;
 const char *reg1 = 
# 170 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                   ((void *)0)
# 170 "project/radare2/libr/anal/p/anal_v850.c"
                       ;
 const char *reg2 = 
# 171 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                   ((void *)0)
# 171 "project/radare2/libr/anal/p/anal_v850.c"
                       ;
 
# 172 "project/radare2/libr/anal/p/anal_v850.c" 3 4
unsigned int 
# 172 "project/radare2/libr/anal/p/anal_v850.c"
     bitmask = 0;
 
# 173 "project/radare2/libr/anal/p/anal_v850.c" 3 4
unsigned short 
# 173 "project/radare2/libr/anal/p/anal_v850.c"
     destaddr = 0;
 
# 174 "project/radare2/libr/anal/p/anal_v850.c" 3 4
short 
# 174 "project/radare2/libr/anal/p/anal_v850.c"
     destaddrs = 0;
 
# 175 "project/radare2/libr/anal/p/anal_v850.c" 3 4
unsigned short 
# 175 "project/radare2/libr/anal/p/anal_v850.c"
     word1 = 0, word2 = 0;
 struct v850_cmd cmd;

 if (len < 1 || (len > 0 && !memcmp (buf, "\xff\xff\xff\xff\xff\xff", 
# 178 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                                                                     (((
# 178 "project/radare2/libr/anal/p/anal_v850.c"
                                                                     len
# 178 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                                                                     )>(
# 178 "project/radare2/libr/anal/p/anal_v850.c"
...
# 182 "project/radare2/libr/anal/p/anal_v850.c" 3 4
__builtin___memset_chk (
# 182 "project/radare2/libr/anal/p/anal_v850.c"
&cmd
# 182 "project/radare2/libr/anal/p/anal_v850.c" 3 4
, 
# 182 "project/radare2/libr/anal/p/anal_v850.c"
...
# 182 "project/radare2/libr/anal/p/anal_v850.c"
 ...
 case V850_MOV:
  ...
  if (opcode != V850_MOV_IMM5) {
   r_strbuf_appendf (&op->esil, "%s,%s,=", (V850_REG_NAMES[((word1) & 0x1F)]), (V850_REG_NAMES[(((word1) & 0xF800) >> 11)]));
  } else {
   r_strbuf_appendf (&op->esil, "%"
# 206 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                                  "lld"
# 206 "project/radare2/libr/anal/p/anal_v850.c"
                                         ",%s,=", (
# 206 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                                                   long long
# 206 "project/radare2/libr/anal/p/anal_v850.c"
                                                       )(((word1) & 0x1F)), (V850_REG_NAMES[(((word1) & 0xF800) >> 11)]));
  }
  break;
 case V850_MOVEA:
  op->type = R_ANAL_OP_TYPE_MOV;

  r_strbuf_appendf (&op->esil, "%s,0xffff,&,%u,+,%s,=", (V850_REG_NAMES[((word1) & 0x1F)]), word2, (V850_REG_NAMES[(((word1) & 0xF800) >> 11)]));
  break;
 case V850_SLDB:
 case V850_SLDH:
 case V850_SLDW:
  op->type = R_ANAL_OP_TYPE_LOAD;
  if ((((word1) & 0xF800) >> 11) == V850_SP) {
 ...
 case V850_NOT:
  ...
  r_strbuf_appendf (&op->esil, "%s,0xffffffff,^,%s,=",(V850_REG_NAMES[((word1) & 0x1F)]), (V850_REG_NAMES[(((word1) & 0xF800) >> 11)]));
 ...
 case V850_DIVH:
  ...
  r_strbuf_appendf (&op->esil, "%s,%s,0xffff,&,/,%s,=",
       (V850_REG_NAMES[((word1) & 0x1F)]), (V850_REG_NAMES[(((word1) & 0xF800) >> 11)]), (V850_REG_NAMES[(((word1) & 0xF800) >> 11)]));
 ...
 case V850_JMP:
  ...
  op->jump = word1;
  op->fail = addr + 2;
  r_strbuf_appendf (&op->esil, "%s,pc,=", (V850_REG_NAMES[((word1) & 0x1F)]));
  break;
 case V850_JARL2:

  op->type = R_ANAL_OP_TYPE_JMP;
  op->jump = addr + ((((
# 259 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                   unsigned int
# 259 "project/radare2/libr/anal/p/anal_v850.c"
                   )(((
# 259 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                   unsigned int
# 259 "project/radare2/libr/anal/p/anal_v850.c"
                   )word2 << 16) | word1) & 0xffff) << 31) | (((
# 259 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                   unsigned int
# 259 "project/radare2/libr/anal/p/anal_v850.c"
                   )(((
# 259 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                   unsigned int
# 259 "project/radare2/libr/anal/p/anal_v850.c"
                   )word2 << 16) | word1) & 0xffff0000) << 1));
  op->fail = addr + 4;
  r_strbuf_appendf (&op->esil, "pc,%s,=,pc,%u,+=", (V850_REG_NAMES[(((word1) & 0xF800) >> 11)]), ((((
# 261 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                                                                 unsigned int
# 261 "project/radare2/libr/anal/p/anal_v850.c"
                                                                 )(((
# 261 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                                                                 unsigned int
# 261 "project/radare2/libr/anal/p/anal_v850.c"
...
# 261 "project/radare2/libr/anal/p/anal_v850.c"
 ...
 case V850_ORI:
  ...
  r_strbuf_appendf (&op->esil, "%hu,%s,|,%s,=",
       word2, (V850_REG_NAMES[((word1) & 0x1F)]), (V850_REG_NAMES[(((word1) & 0xF800) >> 11)]));
  update_flags (op, V850_FLAG_S | V850_FLAG_Z);
  clear_flags (op, V850_FLAG_OV);
  break;
 case V850_MULH:
 ...
 case V850_XORI:
  op->type = R_ANAL_OP_TYPE_XOR;
  r_strbuf_appendf (&op->esil, "%hu,%s,^,%s,=", word2, (V850_REG_NAMES[((word1) & 0x1F)]), (V850_REG_NAMES[(((word1) & 0xF800) >> 11)]));
  update_flags (op, V850_FLAG_S | V850_FLAG_Z);
  clear_flags (op, V850_FLAG_OV);
  break;
 case V850_AND:
...
# 318 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                                           signed char
# 318 "project/radare2/libr/anal/p/anal_v850.c"
                                              )
# 318 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                                               (((
# 318 "project/radare2/libr/anal/p/anal_v850.c"
...
# 318 "project/radare2/libr/anal/p/anal_v850.c"
                                                                   , (V850_REG_NAMES[(((word1) & 0xF800) >> 11)]));
  update_flags (op, -1);
  break;
 case V850_TST:
  op->type = R_ANAL_OP_TYPE_CMP;
 ...
 case V850_SUBR:
  op->type = R_ANAL_OP_TYPE_SUB;
  r_strbuf_appendf (&op->esil, "%s,%s,-,%s=", (V850_REG_NAMES[(((word1) & 0xF800) >> 11)]), (V850_REG_NAMES[((word1) & 0x1F)]), (V850_REG_NAMES[(((word1) & 0xF800) >> 11)]));
  update_flags (op, -1);
  break;
 case V850_ADD:
 ...
 case V850_ADD_IMM5:
  ...
  if ((((word1) & 0xF800) >> 11) == V850_SP) {
   ...
   op->stackptr = ((word1) & 0x1F);
   op->val = op->stackptr;
  }
  r_strbuf_appendf (&op->esil, "%d,%s,+=", (
# 349 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                                           signed char
# 349 "project/radare2/libr/anal/p/anal_v850.c"
                                              )
# 349 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                                               (((
# 349 "project/radare2/libr/anal/p/anal_v850.c"
...
# 349 "project/radare2/libr/anal/p/anal_v850.c"
 ...
 case V850_ADDI:
  ...
  if ((((word1) & 0xF800) >> 11) == V850_SP) {
   op->stackop = R_ANAL_STACK_INC;
   op->stackptr = (
# 356 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                  long long
# 356 "project/radare2/libr/anal/p/anal_v850.c"
                      ) word2;
   op->val = op->stackptr;
  }
  r_strbuf_appendf (&op->esil, "%d,%s,+,%s,=", (
# 359 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                                               int
# 359 "project/radare2/libr/anal/p/anal_v850.c"
                                                   ) word2, (V850_REG_NAMES[((word1) & 0x1F)]), (V850_REG_NAMES[(((word1) & 0xF800) >> 11)]));
  update_flags (op, -1);
  break;
 case V850_SHR_IMM5:
  op->type = R_ANAL_OP_TYPE_SHR;
  r_strbuf_appendf (&op->esil, "%u,%s,>>=", (
# 364 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                                            unsigned char
# 364 "project/radare2/libr/anal/p/anal_v850.c"
                                               )((word1) & 0x1F), (V850_REG_NAMES[(((word1) & 0xF800) >> 11)]));
...
# 370 "project/radare2/libr/anal/p/anal_v850.c" 3 4
 unsigned short 
# 370 "project/radare2/libr/anal/p/anal_v850.c"
      imm5 = ((word1) & 0x1F);
  reg2 = (V850_REG_NAMES[(((word1) & 0xF800) >> 11)]);
  r_strbuf_appendf (&op->esil, "31,%s,>>,?{,%u,32,-,%u,1,<<,--,<<,}{,0,},%u,%s,>>,|,%s,=", reg2, (
# 372 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                                                                                                 unsigned char
# 372 "project/radare2/libr/anal/p/anal_v850.c"
                                                                                                    )imm5, (
# 372 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                                                                                                            unsigned char
# 372 "project/radare2/libr/anal/p/anal_v850.c"
...
# 372 "project/radare2/libr/anal/p/anal_v850.c"
 ...
 case V850_SHL_IMM5:
  ...
  r_strbuf_appendf (&op->esil, "%u,%s,<<=", (
# 378 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                                            unsigned char
# 378 "project/radare2/libr/anal/p/anal_v850.c"
                                               )((word1) & 0x1F), (V850_REG_NAMES[(((word1) & 0xF800) >> 11)]));
  update_flags (op, V850_FLAG_CY | V850_FLAG_S | V850_FLAG_Z);
  clear_flags (op, V850_FLAG_OV);
  break;
...
# 447 "project/radare2/libr/anal/p/anal_v850.c" 3 4
 unsigned char 
# 447 "project/radare2/libr/anal/p/anal_v850.c"
     bitop = word1 >> 14;
  switch (bitop) {
  case V850_BIT_CLR1:
   bitmask = (1 << (((word1) & 0x3800) >> 11));
   r_strbuf_appendf (&op->esil, "%hu,%s,+,[1],%u,&,%hu,%s,+,=[1]", word2, (V850_REG_NAMES[((word1) & 0x1F)]), bitmask, word2, (V850_REG_NAMES[((word1) & 0x1F)]));
...
# 463 "project/radare2/libr/anal/p/anal_v850.c" 3 4
                                unsigned int
# 463 "project/radare2/libr/anal/p/anal_v850.c"
                                    )word2 << 16)) {
  case V850_EXT_SHL:
   op->type = R_ANAL_OP_TYPE_SHL;
   r_strbuf_appendf (&op->esil, "%s,%s,<<=", (V850_REG_NAMES[((word1) & 0x1F)]), (V850_REG_NAMES[(((word1) & 0xF800) >> 11)]));
  ...
  case V850_EXT_SAR:
   op->type = R_ANAL_OP_TYPE_SAR;
   reg1 = (V850_REG_NAMES[((word1) & 0x1F)]);
   reg2 = (V850_REG_NAMES[(((word1) & 0xF800) >> 11)]);
...
# 561 "project/radare2/libr/anal/p/anal_v850.c" 3 4
unsigned char
# 561 "project/radare2/libr/anal/p/anal_v850.c"
*)"\x80\x07",2,(const 
# 561 "project/radare2/libr/anal/p/anal_v850.c" 3 4
unsigned char
# 561 "project/radare2/libr/anal/p/anal_v850.c"
...
# 561 "project/radare2/libr/anal/p/anal_v850.c"
 ...
 r_list_append (l, r_search_keyword_new((const 
# 562 "project/radare2/libr/anal/p/anal_v850.c" 3 4
unsigned char
# 562 "project/radare2/libr/anal/p/anal_v850.c"
*)"\x50\x1a\x63\x0f",4,(const 
# 562 "project/radare2/libr/anal/p/anal_v850.c" 3 4
unsigned char
# 562 "project/radare2/libr/anal/p/anal_v850.c"
*)"\xf0\xff\xff\x0f", 4, 
...
static int archinfo(RAnal *anal, int q) {
 switch (q) {
 case 
# 568 "project/radare2/libr/anal/p/anal_v850.c" 3 4
     4
# 568 "project/radare2/libr/anal/p/anal_v850.c"
                          :
 case 
# 569 "project/radare2/libr/anal/p/anal_v850.c" 3 4
     8
# 569 "project/radare2/libr/anal/p/anal_v850.c"
                               :
  return 2;
 case 
# 571 "project/radare2/libr/anal/p/anal_v850.c" 3 4
     1
# 571 "project/radare2/libr/anal/p/anal_v850.c"
                                :
  return 8;
 case 
# 573 "project/radare2/libr/anal/p/anal_v850.c" 3 4
     0
# 573 "project/radare2/libr/anal/p/anal_v850.c"
                                :
  return 2;
 }
 return 0;
...
RAnalPlugin r_anal_plugin_v850 = {
 ...
 .op = v850_op,
 .esil = 
# 587 "project/radare2/libr/anal/p/anal_v850.c" 3 4
        1
# 587 "project/radare2/libr/anal/p/anal_v850.c"
            ,
 .archinfo = archinfo,
...
# 593 "project/radare2/libr/anal/p/anal_v850.c" 3 4
__attribute__((visibility("default"))) 
# 593 "project/radare2/libr/anal/p/anal_v850.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ANAL,
 .data = &r_anal_plugin_v850,
 .version = 
# 596 "project/radare2/libr/anal/p/anal_v850.c" 3 4
           "5.5.4"

# 597 "project/radare2/libr/anal/p/anal_v850.c"
};
