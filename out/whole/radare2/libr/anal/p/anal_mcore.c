# 0 "project/radare2/libr/anal/p/anal_mcore.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/p/anal_mcore.c"
...
# 4 "project/radare2/libr/anal/p/anal_mcore.c" 2
...
# 6 "project/radare2/libr/anal/p/anal_mcore.c" 2
# 1 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h" 1

#define MCORE_H 
# 11 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h"
#define ARGS_SIZE 5
...
# 26 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h"
typedef struct {
 const 
# 27 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h" 3 4
      unsigned char
# 27 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h"
         * end;
 const 
# 28 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h" 3 4
      unsigned char
# 28 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h"
         * pos;
 
# 29 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h" 3 4
unsigned short 
# 29 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h"
     inc;
} mcore_handle;

typedef struct {
 
# 33 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h" 3 4
unsigned int 
# 33 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h"
     value;
 
# 34 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h" 3 4
unsigned short 
# 34 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h"
     type;
} mcore_field_t;
...
# 40 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h" 3 4
unsigned long long 
# 40 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h"
     type;
 
# 41 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h" 3 4
unsigned short 
# 41 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h"
     n_args;
 
# 42 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h" 3 4
unsigned short 
# 42 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h"
     bytes;
 
# 43 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h" 3 4
unsigned short 
# 43 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h"
     size;
} mcore_t;

int mcore_init(mcore_handle* handle, const 
# 46 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h" 3 4
                                          unsigned char
# 46 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h"
                                             * buffer, const 
# 46 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h" 3 4
                                                             unsigned int 
# 46 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h"
...
# 49 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h" 3 4
                                       unsigned long long 
# 49 "project/radare2/libr/anal/p/../../asm/arch/mcore/mcore.h"
                                            addr, mcore_t* instr);
# 7 "project/radare2/libr/anal/p/anal_mcore.c" 2

static int mcore_anal(RAnal *anal, RAnalOp *op, 
# 8 "project/radare2/libr/anal/p/anal_mcore.c" 3 4
                                               unsigned long long 
# 8 "project/radare2/libr/anal/p/anal_mcore.c"
                                                    addr, const 
# 8 "project/radare2/libr/anal/p/anal_mcore.c" 3 4
                                                                unsigned char 
# 8 "project/radare2/libr/anal/p/anal_mcore.c"
 ...
 mcore_t* instr = 
# 10 "project/radare2/libr/anal/p/anal_mcore.c" 3 4
                 ((void *)0)
# 10 "project/radare2/libr/anal/p/anal_mcore.c"
                     ;

 if (mcore_init (&handle, buf, len)) {
  
# 13 "project/radare2/libr/anal/p/anal_mcore.c" 3 4
 fprintf(__stderrp,
# 13 "project/radare2/libr/anal/p/anal_mcore.c"
 "[!] mcore: bad or invalid data.\n"
# 13 "project/radare2/libr/anal/p/anal_mcore.c" 3 4
 )
# 13 "project/radare2/libr/anal/p/anal_mcore.c"
                                              ;
 ...
 if ((instr = mcore_next (&handle))) {
  ...
  case R_ANAL_OP_TYPE_ILL:
   op->eob = 
# 36 "project/radare2/libr/anal/p/anal_mcore.c" 3 4
            1
# 36 "project/radare2/libr/anal/p/anal_mcore.c"
                ;
   break;
  default:
   break;
...
static 
# 46 "project/radare2/libr/anal/p/anal_mcore.c" 3 4
      _Bool 
# 46 "project/radare2/libr/anal/p/anal_mcore.c"
...
# 128 "project/radare2/libr/anal/p/anal_mcore.c" 3 4
__attribute__((visibility("default"))) 
# 128 "project/radare2/libr/anal/p/anal_mcore.c"
     RLibStruct radare_plugin = {
 .type = R_LIB_TYPE_ANAL,
 .data = &r_anal_plugin_mcore,
 .version = 
# 131 "project/radare2/libr/anal/p/anal_mcore.c" 3 4
           "5.5.4"

# 132 "project/radare2/libr/anal/p/anal_mcore.c"
};
