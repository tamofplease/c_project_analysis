# 0 "project/radare2/libr/anal/block.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/anal/block.c" 2
...
# 5 "project/radare2/libr/anal/block.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/sdb/src/ht_uu.h" 1 3 4
...
#undef KEY_TO_HASH
#undef HT_NULL_VALUE
# 32 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/sdb/src/ht_inc.h" 3 4
...
typedef unsigned long long (*HtUUDupKey)(const unsigned long long);
typedef unsigned long long (*HtUUDupValue)(const unsigned long long);
typedef unsigned int (*HtUUCalcSizeK)(const unsigned long long);
typedef unsigned int (*HtUUCalcSizeV)(const unsigned long long);
typedef unsigned int (*HtUUHashFunction)(const unsigned long long);
typedef int (*HtUUListComparator)(const unsigned long long, const unsigned long long);
typedef _Bool (*HtUUForeachCallback)(void *user, const unsigned long long, const unsigned long long);

typedef struct ht_uu_bucket_t {
 HtUUKv *arr;
 unsigned int count;
} HtUUBucket;


typedef struct ht_uu_options_t {
 HtUUListComparator cmp;
 HtUUHashFunction hashfn;
 HtUUDupKey dupkey;
 HtUUDupValue dupvalue;
 HtUUCalcSizeK calcsizeK;
 HtUUCalcSizeV calcsizeV;
 HtUUKvFreeFunc freefn;
 size_t elem_size;
} HtUUOptions;


typedef struct ht_uu_t {
 unsigned int size;
 unsigned int count;
 HtUUBucket* table;
 unsigned int prime_idx;
...
__attribute__ ((visibility ("default"))) HtUU* ht_uu_new_opt(HtUUOptions *opt);

__attribute__ ((visibility ("default"))) void ht_uu_free(HtUU* ht);

__attribute__ ((visibility ("default"))) _Bool ht_uu_insert(HtUU* ht, const unsigned long long key, unsigned long long value);

__attribute__ ((visibility ("default"))) _Bool ht_uu_update(HtUU* ht, const unsigned long long key, unsigned long long value);

__attribute__ ((visibility ("default"))) _Bool ht_uu_update_key(HtUU* ht, const unsigned long long old_key, const unsigned long long new_key);

__attribute__ ((visibility ("default"))) _Bool ht_uu_delete(HtUU* ht, const unsigned long long key);

__attribute__ ((visibility ("default"))) unsigned long long ht_uu_find(HtUU* ht, const unsigned long long key, _Bool* found);




__attribute__ ((visibility ("default"))) void ht_uu_foreach(HtUU *ht, HtUUForeachCallback cb, void *user);

__attribute__ ((visibility ("default"))) HtUUKv* ht_uu_find_kv(HtUU* ht, const unsigned long long key, _Bool* found);
__attribute__ ((visibility ("default"))) _Bool ht_uu_insert_kv(HtUU *ht, HtUUKv *kv, _Bool update);

#undef HT_TYPE
# 11 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/sdb/src/ht_uu.h" 2 3 4


__attribute__ ((visibility ("default"))) HtUU* ht_uu_new0(void);
# 6 "project/radare2/libr/anal/block.c" 2

#define unwrap(rbnode) container_of (rbnode, RAnalBlock, _rb)


# 9 "project/radare2/libr/anal/block.c"
static void __max_end(RBNode *node) {
 RAnalBlock *block = 
# 10 "project/radare2/libr/anal/block.c" 3 4
                    ((
# 10 "project/radare2/libr/anal/block.c"
                    RAnalBlock 
# 10 "project/radare2/libr/anal/block.c" 3 4
                    *)((char *)(__typeof__(((
# 10 "project/radare2/libr/anal/block.c"
...
# 15 "project/radare2/libr/anal/block.c" 3 4
  unsigned long long 
# 15 "project/radare2/libr/anal/block.c"
       end = 
# 15 "project/radare2/libr/anal/block.c" 3 4
             ((
# 15 "project/radare2/libr/anal/block.c"
...
# 24 "project/radare2/libr/anal/block.c" 3 4
unsigned long long 
# 24 "project/radare2/libr/anal/block.c"
     incoming_addr = *(
# 24 "project/radare2/libr/anal/block.c" 3 4
                       unsigned long long 
# 24 "project/radare2/libr/anal/block.c"
                            *)incoming;
 const RAnalBlock *in_tree_block = 
# 25 "project/radare2/libr/anal/block.c" 3 4
                                  ((
# 25 "project/radare2/libr/anal/block.c"
                                  const RAnalBlock 
# 25 "project/radare2/libr/anal/block.c" 3 4
                                  *)((char *)(__typeof__(((
# 25 "project/radare2/libr/anal/block.c"
...
# 37 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) 
# 37 "project/radare2/libr/anal/block.c"
     void r_anal_block_ref(RAnalBlock *bb) {

 
# 39 "project/radare2/libr/anal/block.c" 3 4
do { if (!(
# 39 "project/radare2/libr/anal/block.c"
bb->ref > 0
# 39 "project/radare2/libr/anal/block.c" 3 4
...
static RAnalBlock *block_new(RAnal *a, 
# 45 "project/radare2/libr/anal/block.c" 3 4
                                      unsigned long long 
# 45 "project/radare2/libr/anal/block.c"
                                           addr, 
# 45 "project/radare2/libr/anal/block.c" 3 4
                                                 unsigned long long 
# 45 "project/radare2/libr/anal/block.c"
                                                      size) {
 RAnalBlock *block = 
# 46 "project/radare2/libr/anal/block.c" 3 4
                    (
# 46 "project/radare2/libr/anal/block.c"
                    RAnalBlock
# 46 "project/radare2/libr/anal/block.c" 3 4
                    *)calloc(1,sizeof(
# 46 "project/radare2/libr/anal/block.c"
...
# 46 "project/radare2/libr/anal/block.c"
 ...
 if (!block) {
  return 
# 48 "project/radare2/libr/anal/block.c" 3 4
        ((void *)0)
# 48 "project/radare2/libr/anal/block.c"
            ;
 }
 block->addr = addr;
 block->size = size;
 ...
 block->ref = 1;
 block->jump = 
# 54 "project/radare2/libr/anal/block.c" 3 4
              0xFFFFFFFFFFFFFFFFULL
# 54 "project/radare2/libr/anal/block.c"
                      ;
 block->fail = 
# 55 "project/radare2/libr/anal/block.c" 3 4
              0xFFFFFFFFFFFFFFFFULL
# 55 "project/radare2/libr/anal/block.c"
                      ;
 block->op_pos = 
# 56 "project/radare2/libr/anal/block.c" 3 4
                (unsigned short*)calloc(
# 56 "project/radare2/libr/anal/block.c"
                3
# 56 "project/radare2/libr/anal/block.c" 3 4
...
# 56 "project/radare2/libr/anal/block.c"
 ...
 block->op_pos_size = 3;
 block->stackptr = 0;
 block->parent_stackptr = 0x7fffffff;
 block->cmpval = 
# 60 "project/radare2/libr/anal/block.c" 3 4
                0xFFFFFFFFFFFFFFFFULL
# 60 "project/radare2/libr/anal/block.c"
                        ;
...
void __block_free_rb(RBNode *node, void *user) {
 RAnalBlock *block = 
# 84 "project/radare2/libr/anal/block.c" 3 4
                    ((
# 84 "project/radare2/libr/anal/block.c"
                    RAnalBlock 
# 84 "project/radare2/libr/anal/block.c" 3 4
                    *)((char *)(__typeof__(((
# 84 "project/radare2/libr/anal/block.c"
...
# 88 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) 
# 88 "project/radare2/libr/anal/block.c"
     RAnalBlock *r_anal_get_block_at(RAnal *anal, 
# 88 "project/radare2/libr/anal/block.c" 3 4
                                                  unsigned long long 
# 88 "project/radare2/libr/anal/block.c"
                                                       addr) {
 RBNode *node = r_rbtree_find (anal->bb_tree, &addr, __bb_addr_cmp, 
# 89 "project/radare2/libr/anal/block.c" 3 4
                                                                   ((void *)0)
# 89 "project/radare2/libr/anal/block.c"
                                                                       );
 return node? 
# 90 "project/radare2/libr/anal/block.c" 3 4
             ((
# 90 "project/radare2/libr/anal/block.c"
             RAnalBlock 
# 90 "project/radare2/libr/anal/block.c" 3 4
             *)((char *)(__typeof__(((
# 90 "project/radare2/libr/anal/block.c"
...
static 
# 94 "project/radare2/libr/anal/block.c" 3 4
      _Bool 
# 94 "project/radare2/libr/anal/block.c"
           all_in(RAnalBlock *node, 
# 94 "project/radare2/libr/anal/block.c" 3 4
                                    unsigned long long 
# 94 "project/radare2/libr/anal/block.c"
                                         addr, RAnalBlockCb cb, void *user) {
 while (node && addr < node->addr) {

  node = 
# 97 "project/radare2/libr/anal/block.c" 3 4
        ((
# 97 "project/radare2/libr/anal/block.c"
        RAnalBlock 
# 97 "project/radare2/libr/anal/block.c" 3 4
        *)((char *)(__typeof__(((
# 97 "project/radare2/libr/anal/block.c"
...
# 97 "project/radare2/libr/anal/block.c"
 ...
 if (!node) {
  return 
# 100 "project/radare2/libr/anal/block.c" 3 4
        1
# 100 "project/radare2/libr/anal/block.c"
            ;
 }
 if (addr >= node->_max_end) {
  return 
# 103 "project/radare2/libr/anal/block.c" 3 4
        1
# 103 "project/radare2/libr/anal/block.c"
            ;
 }
 if (addr < node->addr + node->size) {
  if (!cb (node, user)) {
   return 
# 107 "project/radare2/libr/anal/block.c" 3 4
         0
# 107 "project/radare2/libr/anal/block.c"
              ;
  }
 }

 if (!all_in (
# 111 "project/radare2/libr/anal/block.c" 3 4
             ((
# 111 "project/radare2/libr/anal/block.c"
             RAnalBlock 
# 111 "project/radare2/libr/anal/block.c" 3 4
             *)((char *)(__typeof__(((
# 111 "project/radare2/libr/anal/block.c"
...
# 111 "project/radare2/libr/anal/block.c"
                                        , addr, cb, user)) {
  return 
# 112 "project/radare2/libr/anal/block.c" 3 4
        0
# 112 "project/radare2/libr/anal/block.c"
             ;
 }
 if (!all_in (
# 114 "project/radare2/libr/anal/block.c" 3 4
             ((
# 114 "project/radare2/libr/anal/block.c"
             RAnalBlock 
# 114 "project/radare2/libr/anal/block.c" 3 4
             *)((char *)(__typeof__(((
# 114 "project/radare2/libr/anal/block.c"
...
# 114 "project/radare2/libr/anal/block.c"
                                        , addr, cb, user)) {
  return 
# 115 "project/radare2/libr/anal/block.c" 3 4
        0
# 115 "project/radare2/libr/anal/block.c"
             ;
 }
 return 
# 117 "project/radare2/libr/anal/block.c" 3 4
       1
# 117 "project/radare2/libr/anal/block.c"
           ;
}


# 120 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 120 "project/radare2/libr/anal/block.c"
          r_anal_blocks_foreach_in(RAnal *anal, 
# 120 "project/radare2/libr/anal/block.c" 3 4
                                                unsigned long long 
# 120 "project/radare2/libr/anal/block.c"
                                                     addr, RAnalBlockCb cb, void *user) {
 return all_in (anal->bb_tree ? 
# 121 "project/radare2/libr/anal/block.c" 3 4
                               ((
# 121 "project/radare2/libr/anal/block.c"
                               RAnalBlock 
# 121 "project/radare2/libr/anal/block.c" 3 4
                               *)((char *)(__typeof__(((
# 121 "project/radare2/libr/anal/block.c"
...
static 
# 124 "project/radare2/libr/anal/block.c" 3 4
      _Bool 
# 124 "project/radare2/libr/anal/block.c"
           block_list_cb(RAnalBlock *block, void *user) {
 RList *list = user;
 r_anal_block_ref (block);
 
# 127 "project/radare2/libr/anal/block.c" 3 4
r_list_append ((
# 127 "project/radare2/libr/anal/block.c"
list
# 127 "project/radare2/libr/anal/block.c" 3 4
), (
# 127 "project/radare2/libr/anal/block.c"
...
# 127 "project/radare2/libr/anal/block.c"
                         ;
 return 
# 128 "project/radare2/libr/anal/block.c" 3 4
       1
# 128 "project/radare2/libr/anal/block.c"
           ;
}


# 131 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) 
# 131 "project/radare2/libr/anal/block.c"
     RList *r_anal_get_blocks_in(RAnal *anal, 
# 131 "project/radare2/libr/anal/block.c" 3 4
                                              unsigned long long 
# 131 "project/radare2/libr/anal/block.c"
                                                   addr) {
...
static void all_intersect(RAnalBlock *node, 
# 139 "project/radare2/libr/anal/block.c" 3 4
                                           unsigned long long 
# 139 "project/radare2/libr/anal/block.c"
                                                addr, 
# 139 "project/radare2/libr/anal/block.c" 3 4
                                                      unsigned long long 
# 139 "project/radare2/libr/anal/block.c"
                                                           size, RAnalBlockCb cb, void *user) {
 
# 140 "project/radare2/libr/anal/block.c" 3 4
unsigned long long 
# 140 "project/radare2/libr/anal/block.c"
     end = addr + size;
 while (node && end <= node->addr) {

  node = 
# 143 "project/radare2/libr/anal/block.c" 3 4
        ((
# 143 "project/radare2/libr/anal/block.c"
        RAnalBlock 
# 143 "project/radare2/libr/anal/block.c" 3 4
        *)((char *)(__typeof__(((
# 143 "project/radare2/libr/anal/block.c"
...
# 143 "project/radare2/libr/anal/block.c"
 ...
 all_intersect (
# 155 "project/radare2/libr/anal/block.c" 3 4
               ((
# 155 "project/radare2/libr/anal/block.c"
               RAnalBlock 
# 155 "project/radare2/libr/anal/block.c" 3 4
               *)((char *)(__typeof__(((
# 155 "project/radare2/libr/anal/block.c"
...
# 155 "project/radare2/libr/anal/block.c"
                                          , addr, size, cb, user);
 all_intersect (
# 156 "project/radare2/libr/anal/block.c" 3 4
               ((
# 156 "project/radare2/libr/anal/block.c"
               RAnalBlock 
# 156 "project/radare2/libr/anal/block.c" 3 4
               *)((char *)(__typeof__(((
# 156 "project/radare2/libr/anal/block.c"
...
# 159 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) 
# 159 "project/radare2/libr/anal/block.c"
     void r_anal_blocks_foreach_intersect(RAnal *anal, 
# 159 "project/radare2/libr/anal/block.c" 3 4
                                                       unsigned long long 
# 159 "project/radare2/libr/anal/block.c"
                                                            addr, 
...
# 159 "project/radare2/libr/anal/block.c"
                                                                       size, RAnalBlockCb cb, void *user) {
 all_intersect (anal->bb_tree ? 
# 160 "project/radare2/libr/anal/block.c" 3 4
                               ((
# 160 "project/radare2/libr/anal/block.c"
                               RAnalBlock 
# 160 "project/radare2/libr/anal/block.c" 3 4
                               *)((char *)(__typeof__(((
# 160 "project/radare2/libr/anal/block.c"
...
# 163 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) 
# 163 "project/radare2/libr/anal/block.c"
     RList *r_anal_get_blocks_intersect(RAnal *anal, 
# 163 "project/radare2/libr/anal/block.c" 3 4
                                                     unsigned long long 
# 163 "project/radare2/libr/anal/block.c"
                                                          addr, 
...
# 163 "project/radare2/libr/anal/block.c"
 ...
 if (!list) {
  return 
# 166 "project/radare2/libr/anal/block.c" 3 4
        ((void *)0)
# 166 "project/radare2/libr/anal/block.c"
            ;
 }
...
# 172 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) 
# 172 "project/radare2/libr/anal/block.c"
     RAnalBlock *r_anal_create_block(RAnal *anal, 
# 172 "project/radare2/libr/anal/block.c" 3 4
                                                  unsigned long long 
# 172 "project/radare2/libr/anal/block.c"
                                                       addr, 
...
# 172 "project/radare2/libr/anal/block.c"
 ...
 if (r_anal_get_block_at (anal, addr)) {
  return 
# 174 "project/radare2/libr/anal/block.c" 3 4
        ((void *)0)
# 174 "project/radare2/libr/anal/block.c"
            ;
 }
 RAnalBlock *block = block_new (anal, addr, size);
 if (!block) {
  return 
# 178 "project/radare2/libr/anal/block.c" 3 4
        ((void *)0)
# 178 "project/radare2/libr/anal/block.c"
            ;
 }
 r_rbtree_aug_insert (&anal->bb_tree, &block->addr, &block->_rb, __bb_addr_cmp, 
# 180 "project/radare2/libr/anal/block.c" 3 4
                                                                               ((void *)0)
# 180 "project/radare2/libr/anal/block.c"
                                                                                   , __max_end);
 return block;
}


# 184 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) 
# 184 "project/radare2/libr/anal/block.c"
     void r_anal_delete_block(RAnalBlock *bb) {
 r_anal_block_ref (bb);
 while (!
# 186 "project/radare2/libr/anal/block.c" 3 4
        (!(
# 186 "project/radare2/libr/anal/block.c"
        bb->fcns
# 186 "project/radare2/libr/anal/block.c" 3 4
        ) || !(
# 186 "project/radare2/libr/anal/block.c"
...
# 192 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) 
# 192 "project/radare2/libr/anal/block.c"
     void r_anal_block_set_size(RAnalBlock *block, 
# 192 "project/radare2/libr/anal/block.c" 3 4
                                                   unsigned long long 
# 192 "project/radare2/libr/anal/block.c"
                                                        size) {
...
# 200 "project/radare2/libr/anal/block.c" 3 4
if (
# 200 "project/radare2/libr/anal/block.c"
block->fcns
# 200 "project/radare2/libr/anal/block.c" 3 4
) for (
# 200 "project/radare2/libr/anal/block.c"
...
# 200 "project/radare2/libr/anal/block.c"
                                        {
  if (fcn->meta._min != 
# 201 "project/radare2/libr/anal/block.c" 3 4
                       0xFFFFFFFFFFFFFFFFULL 
# 201 "project/radare2/libr/anal/block.c"
                                && fcn->meta._max == block->addr + block->size) {
 ...
 block->size = size;
 r_rbtree_aug_update_sum (block->anal->bb_tree, &block->addr, &block->_rb, __bb_addr_cmp, 
# 208 "project/radare2/libr/anal/block.c" 3 4
                                                                                         ((void *)0)
# 208 "project/radare2/libr/anal/block.c"
                                                                                             , __max_end);
}


# 211 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 211 "project/radare2/libr/anal/block.c"
          r_anal_block_relocate(RAnalBlock *block, 
# 211 "project/radare2/libr/anal/block.c" 3 4
                                                   unsigned long long 
# 211 "project/radare2/libr/anal/block.c"
                                                        addr, 
...
# 211 "project/radare2/libr/anal/block.c"
 ...
 if (block->addr == addr) {
  ...
  r_anal_block_update_hash (block);
  return 
# 215 "project/radare2/libr/anal/block.c" 3 4
        1
# 215 "project/radare2/libr/anal/block.c"
            ;
 }
 if (r_anal_get_block_at (block->anal, addr)) {

  return 
# 219 "project/radare2/libr/anal/block.c" 3 4
        0
# 219 "project/radare2/libr/anal/block.c"
             ;
 }
...
# 225 "project/radare2/libr/anal/block.c" 3 4
if (
# 225 "project/radare2/libr/anal/block.c"
block->fcns
# 225 "project/radare2/libr/anal/block.c" 3 4
) for (
# 225 "project/radare2/libr/anal/block.c"
...
# 225 "project/radare2/libr/anal/block.c"
                                        {
  if (fcn->meta._min != 
# 226 "project/radare2/libr/anal/block.c" 3 4
                       0xFFFFFFFFFFFFFFFFULL
# 226 "project/radare2/libr/anal/block.c"
                               ) {
   if (addr + size > fcn->meta._max) {
    ...
    fcn->meta._min = 
# 232 "project/radare2/libr/anal/block.c" 3 4
                    0xFFFFFFFFFFFFFFFFULL
# 232 "project/radare2/libr/anal/block.c"
                            ;
    continue;
   }
   if (block->addr < fcn->meta._min) {
    ...
    fcn->meta._min = 
# 240 "project/radare2/libr/anal/block.c" 3 4
                    0xFFFFFFFFFFFFFFFFULL
# 240 "project/radare2/libr/anal/block.c"
                            ;
   }
  }
 }

 r_rbtree_aug_delete (&block->anal->bb_tree, &block->addr, __bb_addr_cmp, 
# 245 "project/radare2/libr/anal/block.c" 3 4
                                                                         ((void *)0)
# 245 "project/radare2/libr/anal/block.c"
                                                                             , 
# 245 "project/radare2/libr/anal/block.c" 3 4
                                                                               ((void *)0)
# 245 "project/radare2/libr/anal/block.c"
...
# 245 "project/radare2/libr/anal/block.c"
 ...
 block->size = size;
 r_anal_block_update_hash (block);
 r_rbtree_aug_insert (&block->anal->bb_tree, &block->addr, &block->_rb, __bb_addr_cmp, 
# 249 "project/radare2/libr/anal/block.c" 3 4
                                                                                      ((void *)0)
# 249 "project/radare2/libr/anal/block.c"
                                                                                          , __max_end);
 return 
# 250 "project/radare2/libr/anal/block.c" 3 4
       1
# 250 "project/radare2/libr/anal/block.c"
           ;
}


# 253 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) 
# 253 "project/radare2/libr/anal/block.c"
     RAnalBlock *r_anal_block_split(RAnalBlock *bbi, 
# 253 "project/radare2/libr/anal/block.c" 3 4
                                                     unsigned long long 
# 253 "project/radare2/libr/anal/block.c"
                                                          addr) {
...
# 255 "project/radare2/libr/anal/block.c" 3 4
do { if (!(
# 255 "project/radare2/libr/anal/block.c"
bbi && addr >= bbi->addr && addr < bbi->addr + bbi->size && addr != 
# 255 "project/radare2/libr/anal/block.c" 3 4
0xFFFFFFFFFFFFFFFFULL)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 255 "project/radare2/libr/anal/block.c"
"bbi && addr >= bbi->addr && addr < bbi->addr + bbi->size && addr != UT64_MAX"
# 255 "project/radare2/libr/anal/block.c" 3 4
, 255); return (
# 255 "project/radare2/libr/anal/block.c"
0
...
# 255 "project/radare2/libr/anal/block.c"
 ...
 if (r_anal_get_block_at (bbi->anal, addr)) {
  ...
  return 
# 263 "project/radare2/libr/anal/block.c" 3 4
        ((void *)0)
# 263 "project/radare2/libr/anal/block.c"
            ;
 }
 ...
 if (!bb) {
  return 
# 269 "project/radare2/libr/anal/block.c" 3 4
        ((void *)0)
# 269 "project/radare2/libr/anal/block.c"
            ;
 }
 bb->jump = bbi->jump;
 bb->fail = bbi->fail;
 ...
 bbi->jump = addr;
 bbi->fail = 
# 279 "project/radare2/libr/anal/block.c" 3 4
            0xFFFFFFFFFFFFFFFFULL
# 279 "project/radare2/libr/anal/block.c"
                    ;
 bbi->switch_op = 
# 280 "project/radare2/libr/anal/block.c" 3 4
                 ((void *)0)
# 280 "project/radare2/libr/anal/block.c"
                     ;
 r_anal_block_update_hash (bbi);


 r_rbtree_aug_insert (&anal->bb_tree, &bb->addr, &bb->_rb, __bb_addr_cmp, 
# 284 "project/radare2/libr/anal/block.c" 3 4
                                                                         ((void *)0)
# 284 "project/radare2/libr/anal/block.c"
                                                                             , __max_end);
...
# 289 "project/radare2/libr/anal/block.c" 3 4
if (
# 289 "project/radare2/libr/anal/block.c"
bbi->fcns
# 289 "project/radare2/libr/anal/block.c" 3 4
) for (
# 289 "project/radare2/libr/anal/block.c"
...
# 303 "project/radare2/libr/anal/block.c" 3 4
  unsigned short 
# 303 "project/radare2/libr/anal/block.c"
       off_op = r_anal_bb_offset_inst (bbi, i);
...
# 316 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 316 "project/radare2/libr/anal/block.c"
          r_anal_block_merge(RAnalBlock *a, RAnalBlock *b) {
 if (!r_anal_block_is_contiguous (a, b)) {
  return 
# 318 "project/radare2/libr/anal/block.c" 3 4
        0
# 318 "project/radare2/libr/anal/block.c"
             ;
 }
 ...
 if (r_list_length (a->fcns) != r_list_length (b->fcns)) {
  return 
# 323 "project/radare2/libr/anal/block.c" 3 4
        0
# 323 "project/radare2/libr/anal/block.c"
             ;
 }
 RAnalFunction *fcn;
 RListIter *iter;
 
# 327 "project/radare2/libr/anal/block.c" 3 4
if (
# 327 "project/radare2/libr/anal/block.c"
a->fcns
# 327 "project/radare2/libr/anal/block.c" 3 4
) for (
# 327 "project/radare2/libr/anal/block.c"
...
# 327 "project/radare2/libr/anal/block.c"
  ...
  if (!r_list_contains (b->fcns, fcn)) {
   return 
# 329 "project/radare2/libr/anal/block.c" 3 4
         0
# 329 "project/radare2/libr/anal/block.c"
              ;
  }
 }
 ...
 r_anal_block_ref (b);
 while (!
# 335 "project/radare2/libr/anal/block.c" 3 4
        (!(
# 335 "project/radare2/libr/anal/block.c"
        b->fcns
# 335 "project/radare2/libr/anal/block.c" 3 4
        ) || !(
# 335 "project/radare2/libr/anal/block.c"
...
# 351 "project/radare2/libr/anal/block.c" 3 4
  fprintf(__stderrp,
# 351 "project/radare2/libr/anal/block.c"
  "Dropping switch table at 0x%" 
# 351 "project/radare2/libr/anal/block.c" 3 4
  "llx" 
# 351 "project/radare2/libr/anal/block.c"
  " of block at 0x%" 
...
# 351 "project/radare2/libr/anal/block.c"
 ...
 b->switch_op = 
# 356 "project/radare2/libr/anal/block.c" 3 4
               ((void *)0)
# 356 "project/radare2/libr/anal/block.c"
                   ;
 r_anal_block_update_hash (a);


 r_rbtree_aug_delete (&a->anal->bb_tree, &b->addr, __bb_addr_cmp, 
# 360 "project/radare2/libr/anal/block.c" 3 4
                                                                 ((void *)0)
# 360 "project/radare2/libr/anal/block.c"
                                                                     , __block_free_rb, 
# 360 "project/radare2/libr/anal/block.c" 3 4
                                                                                        ((void *)0)
# 360 "project/radare2/libr/anal/block.c"
...
# 363 "project/radare2/libr/anal/block.c" 3 4
if (
# 363 "project/radare2/libr/anal/block.c"
a->fcns
# 363 "project/radare2/libr/anal/block.c" 3 4
) for (
# 363 "project/radare2/libr/anal/block.c"
...
# 363 "project/radare2/libr/anal/block.c"
                                    {
  fcn->meta._min = 
# 364 "project/radare2/libr/anal/block.c" 3 4
                  0xFFFFFFFFFFFFFFFFULL
# 364 "project/radare2/libr/anal/block.c"
                          ;
 }

 return 
# 367 "project/radare2/libr/anal/block.c" 3 4
       1
# 367 "project/radare2/libr/anal/block.c"
           ;
}


# 370 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) 
# 370 "project/radare2/libr/anal/block.c"
     void r_anal_block_unref(RAnalBlock *bb) {
 if (!bb) {
  return;
 }
 
# 374 "project/radare2/libr/anal/block.c" 3 4
do { if (!(
# 374 "project/radare2/libr/anal/block.c"
bb->ref > 0
# 374 "project/radare2/libr/anal/block.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 374 "project/radare2/libr/anal/block.c"
...
# 376 "project/radare2/libr/anal/block.c" 3 4
do { if (!(
# 376 "project/radare2/libr/anal/block.c"
bb->ref >= r_list_length (bb->fcns)
# 376 "project/radare2/libr/anal/block.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 376 "project/radare2/libr/anal/block.c"
"bb->ref >= r_list_length (bb->fcns)"
...
# 379 "project/radare2/libr/anal/block.c" 3 4
 do { if (!(
# 379 "project/radare2/libr/anal/block.c"
 !bb->fcns || 
# 379 "project/radare2/libr/anal/block.c" 3 4
 (!(
# 379 "project/radare2/libr/anal/block.c"
...
# 379 "project/radare2/libr/anal/block.c"
 bb->fcns
# 379 "project/radare2/libr/anal/block.c" 3 4
 )->length))) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 379 "project/radare2/libr/anal/block.c"
 "!bb->fcns || r_list_empty (bb->fcns)"
# 379 "project/radare2/libr/anal/block.c" 3 4
 , 379); return; } } while (0)
# 379 "project/radare2/libr/anal/block.c"
                                                        ;
  r_rbtree_aug_delete (&anal->bb_tree, &bb->addr, __bb_addr_cmp, 
# 380 "project/radare2/libr/anal/block.c" 3 4
                                                                ((void *)0)
# 380 "project/radare2/libr/anal/block.c"
                                                                    , __block_free_rb, 
# 380 "project/radare2/libr/anal/block.c" 3 4
                                                                                       ((void *)0)
# 380 "project/radare2/libr/anal/block.c"
...
# 384 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 384 "project/radare2/libr/anal/block.c"
          r_anal_block_successor_addrs_foreach(RAnalBlock *block, RAnalAddrCb cb, void *user) {
#define CB_ADDR(addr) do { if (addr == UT64_MAX) { break; } if (!cb (addr, user)) { return false; } } while(0);
# 394 "project/radare2/libr/anal/block.c"
 do { if (block->jump == 
# 394 "project/radare2/libr/anal/block.c" 3 4
0xFFFFFFFFFFFFFFFFULL
# 394 "project/radare2/libr/anal/block.c"
) { break; } if (!cb (block->jump, user)) { return 
# 394 "project/radare2/libr/anal/block.c" 3 4
0
# 394 "project/radare2/libr/anal/block.c"
; } } while(0);;
 do { if (block->fail == 
# 395 "project/radare2/libr/anal/block.c" 3 4
0xFFFFFFFFFFFFFFFFULL
# 395 "project/radare2/libr/anal/block.c"
) { break; } if (!cb (block->fail, user)) { return 
# 395 "project/radare2/libr/anal/block.c" 3 4
0
# 395 "project/radare2/libr/anal/block.c"
; } } while(0);;
...
# 399 "project/radare2/libr/anal/block.c" 3 4
 if (
# 399 "project/radare2/libr/anal/block.c"
 block->switch_op->cases
# 399 "project/radare2/libr/anal/block.c" 3 4
 ) for (
# 399 "project/radare2/libr/anal/block.c"
 iter 
...
# 399 "project/radare2/libr/anal/block.c"
                                                        {
   do { if (caseop->jump == 
# 400 "project/radare2/libr/anal/block.c" 3 4
  0xFFFFFFFFFFFFFFFFULL
# 400 "project/radare2/libr/anal/block.c"
  ) { break; } if (!cb (caseop->jump, user)) { return 
# 400 "project/radare2/libr/anal/block.c" 3 4
  0
# 400 "project/radare2/libr/anal/block.c"
  ; } } while(0);;
 ...
 return 
# 404 "project/radare2/libr/anal/block.c" 3 4
       1
# 404 "project/radare2/libr/anal/block.c"
           ;
#undef CB_ADDR
}
...
static 
# 414 "project/radare2/libr/anal/block.c" 3 4
      _Bool 
# 414 "project/radare2/libr/anal/block.c"
...
# 414 "project/radare2/libr/anal/block.c"
 ...
 if (ht_up_find_kv (ctx->visited, addr, 
# 416 "project/radare2/libr/anal/block.c" 3 4
                                       ((void *)0)
# 416 "project/radare2/libr/anal/block.c"
                                           )) {

  return 
# 418 "project/radare2/libr/anal/block.c" 3 4
        1
# 418 "project/radare2/libr/anal/block.c"
            ;
 }
 ht_up_insert (ctx->visited, addr, 
# 420 "project/radare2/libr/anal/block.c" 3 4
                                  ((void *)0)
# 420 "project/radare2/libr/anal/block.c"
                                      );
 RAnalBlock *block = r_anal_get_block_at (ctx->anal, addr);
 if (!block) {
  return 
# 423 "project/radare2/libr/anal/block.c" 3 4
        1
# 423 "project/radare2/libr/anal/block.c"
            ;
 }
 r_pvector_push (&ctx->to_visit, block);
 return 
# 426 "project/radare2/libr/anal/block.c" 3 4
       1
# 426 "project/radare2/libr/anal/block.c"
           ;
}


# 429 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 429 "project/radare2/libr/anal/block.c"
          r_anal_block_recurse(RAnalBlock *block, RAnalBlockCb cb, void *user) {
 
# 430 "project/radare2/libr/anal/block.c" 3 4
_Bool 
# 430 "project/radare2/libr/anal/block.c"
     breaked = 
# 430 "project/radare2/libr/anal/block.c" 3 4
               0
# 430 "project/radare2/libr/anal/block.c"
 ...
 ctx.anal = block->anal;
 r_pvector_init (&ctx.to_visit, 
# 433 "project/radare2/libr/anal/block.c" 3 4
                               ((void *)0)
# 433 "project/radare2/libr/anal/block.c"
                                   );
 ...
 ht_up_insert (ctx.visited, block->addr, 
# 439 "project/radare2/libr/anal/block.c" 3 4
                                        ((void *)0)
# 439 "project/radare2/libr/anal/block.c"
                                            );
 r_pvector_push (&ctx.to_visit, block);
...
# 457 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 457 "project/radare2/libr/anal/block.c"
          r_anal_block_recurse_followthrough(RAnalBlock *block, RAnalBlockCb cb, void *user) {
 
# 458 "project/radare2/libr/anal/block.c" 3 4
_Bool 
# 458 "project/radare2/libr/anal/block.c"
     breaked = 
# 458 "project/radare2/libr/anal/block.c" 3 4
               0
# 458 "project/radare2/libr/anal/block.c"
 ...
 ctx.anal = block->anal;
 r_pvector_init (&ctx.to_visit, 
# 461 "project/radare2/libr/anal/block.c" 3 4
                               ((void *)0)
# 461 "project/radare2/libr/anal/block.c"
                                   );
 ctx.visited = ht_up_new0 ();
 if (!ctx.visited) {
  goto beach;
 ...
 ht_up_insert (ctx.visited, block->addr, 
# 467 "project/radare2/libr/anal/block.c" 3 4
                                        ((void *)0)
# 467 "project/radare2/libr/anal/block.c"
                                            );
 r_pvector_push (&ctx.to_visit, block);
...
# 472 "project/radare2/libr/anal/block.c" 3 4
 _Bool 
# 472 "project/radare2/libr/anal/block.c"
      b = !cb (cur, user);
  if (b) {
   breaked = 
# 474 "project/radare2/libr/anal/block.c" 3 4
            1
# 474 "project/radare2/libr/anal/block.c"
                ;
  } else {
   r_anal_block_successor_addrs_foreach (cur, block_recurse_successor_cb, &ctx);
  }
...
# 491 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 491 "project/radare2/libr/anal/block.c"
          r_anal_block_recurse_depth_first(RAnalBlock *block, RAnalBlockCb cb, RAnalBlockCb on_exit, void *user) {
 
# 492 "project/radare2/libr/anal/block.c" 3 4
_Bool 
# 492 "project/radare2/libr/anal/block.c"
     breaked = 
# 492 "project/radare2/libr/anal/block.c" 3 4
               0
# 492 "project/radare2/libr/anal/block.c"
 ...
 if (!block) {
  return 
# 494 "project/radare2/libr/anal/block.c" 3 4
        0
# 494 "project/radare2/libr/anal/block.c"
             ;
 }
 ...
 RVector path;
 r_vector_init (&path, sizeof (RecurseDepthFirstCtx), 
# 502 "project/radare2/libr/anal/block.c" 3 4
                                                     ((void *)0)
# 502 "project/radare2/libr/anal/block.c"
                                                         , 
# 502 "project/radare2/libr/anal/block.c" 3 4
                                                           ((void *)0)
# 502 "project/radare2/libr/anal/block.c"
 ...
 RecurseDepthFirstCtx ctx = { cur_bb, 
# 504 "project/radare2/libr/anal/block.c" 3 4
                                     ((void *)0) 
# 504 "project/radare2/libr/anal/block.c"
                                          };
 r_vector_push (&path, &ctx);
 ht_up_insert (visited, cur_bb->addr, 
# 506 "project/radare2/libr/anal/block.c" 3 4
                                     ((void *)0)
# 506 "project/radare2/libr/anal/block.c"
                                         );
 ...
 do {
  ...
  cur_bb = cur_ctx->bb;
  if (cur_bb->jump != 
# 514 "project/radare2/libr/anal/block.c" 3 4
                     0xFFFFFFFFFFFFFFFFULL 
# 514 "project/radare2/libr/anal/block.c"
                              && !ht_up_find_kv (visited, cur_bb->jump, 
# 514 "project/radare2/libr/anal/block.c" 3 4
                                                                        ((void *)0)
# 514 "project/radare2/libr/anal/block.c"
                                                                            )) {
...
# 516 "project/radare2/libr/anal/block.c" 3 4
                            0xFFFFFFFFFFFFFFFFULL 
# 516 "project/radare2/libr/anal/block.c"
                                     && !ht_up_find_kv (visited, cur_bb->fail, 
# 516 "project/radare2/libr/anal/block.c" 3 4
                                                                               ((void *)0)
# 516 "project/radare2/libr/anal/block.c"
                                                                                   )) {
   ...
   RAnalCaseOp *cop = 
# 519 "project/radare2/libr/anal/block.c" 3 4
                     ((void *)0)
# 519 "project/radare2/libr/anal/block.c"
                         ;
   if (cur_bb->switch_op && !cur_ctx->switch_it) {
    ...
    while ((cur_ctx->switch_it = r_list_iter_get_next (cur_ctx->switch_it))) {
     ...
     if (!ht_up_find_kv (visited, cop->jump, 
# 526 "project/radare2/libr/anal/block.c" 3 4
                                            ((void *)0)
# 526 "project/radare2/libr/anal/block.c"
                                                )) {
      break;
     }
     cop = 
# 529 "project/radare2/libr/anal/block.c" 3 4
          ((void *)0)
# 529 "project/radare2/libr/anal/block.c"
              ;
    }
   }
   cur_bb = cop ? r_anal_get_block_at (anal, cop->jump) : 
# 532 "project/radare2/libr/anal/block.c" 3 4
                                                         ((void *)0)
# 532 "project/radare2/libr/anal/block.c"
                                                             ;
  }
  if (cur_bb) {
   RecurseDepthFirstCtx ctx = { cur_bb, 
# 535 "project/radare2/libr/anal/block.c" 3 4
                                       ((void *)0) 
# 535 "project/radare2/libr/anal/block.c"
                                            };
   r_vector_push (&path, &ctx);
   ht_up_insert (visited, cur_bb->addr, 
# 537 "project/radare2/libr/anal/block.c" 3 4
                                       ((void *)0)
# 537 "project/radare2/libr/anal/block.c"
                                           );
   
# 538 "project/radare2/libr/anal/block.c" 3 4
  _Bool 
# 538 "project/radare2/libr/anal/block.c"
       breaked = !cb (cur_bb, user);
   if (breaked) {
    break;
   }
   ...
   r_vector_pop (&path, 
# 546 "project/radare2/libr/anal/block.c" 3 4
                       ((void *)0)
# 546 "project/radare2/libr/anal/block.c"
                           );
  }
...
static 
# 556 "project/radare2/libr/anal/block.c" 3 4
      _Bool 
# 556 "project/radare2/libr/anal/block.c"
           recurse_list_cb(RAnalBlock *block, void *user) {
 RList *list = user;
 r_anal_block_ref (block);
 
# 559 "project/radare2/libr/anal/block.c" 3 4
r_list_append ((
# 559 "project/radare2/libr/anal/block.c"
list
# 559 "project/radare2/libr/anal/block.c" 3 4
), (
# 559 "project/radare2/libr/anal/block.c"
...
# 559 "project/radare2/libr/anal/block.c"
                         ;
 return 
# 560 "project/radare2/libr/anal/block.c" 3 4
       1
# 560 "project/radare2/libr/anal/block.c"
           ;
}


# 563 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) 
# 563 "project/radare2/libr/anal/block.c"
     RList *r_anal_block_recurse_list(RAnalBlock *block) {
...
# 571 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) 
# 571 "project/radare2/libr/anal/block.c"
     void r_anal_block_add_switch_case(RAnalBlock *block, 
# 571 "project/radare2/libr/anal/block.c" 3 4
                                                          unsigned long long 
# 571 "project/radare2/libr/anal/block.c"
                                                               switch_addr, 
...
# 578 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 578 "project/radare2/libr/anal/block.c"
          r_anal_block_op_starts_at(RAnalBlock *bb, 
# 578 "project/radare2/libr/anal/block.c" 3 4
                                                    unsigned long long 
# 578 "project/radare2/libr/anal/block.c"
                                                         addr) {
 if (!r_anal_block_contains (bb, addr)) {
  return 
# 580 "project/radare2/libr/anal/block.c" 3 4
        0
# 580 "project/radare2/libr/anal/block.c"
             ;
 }
 
# 582 "project/radare2/libr/anal/block.c" 3 4
unsigned long long 
# 582 "project/radare2/libr/anal/block.c"
     off = addr - bb->addr;
 if (off > 
# 583 "project/radare2/libr/anal/block.c" 3 4
          0xFFFFU
# 583 "project/radare2/libr/anal/block.c"
                  ) {
  return 
# 584 "project/radare2/libr/anal/block.c" 3 4
        0
# 584 "project/radare2/libr/anal/block.c"
             ;
 }
 size_t i;
 for (i = 0; i < bb->ninstr; i++) {
  
# 588 "project/radare2/libr/anal/block.c" 3 4
 unsigned short 
# 588 "project/radare2/libr/anal/block.c"
      inst_off = r_anal_bb_offset_inst (bb, i);
  if (off == inst_off) {
   return 
# 590 "project/radare2/libr/anal/block.c" 3 4
         1
# 590 "project/radare2/libr/anal/block.c"
             ;
  }
 }
 return 
# 593 "project/radare2/libr/anal/block.c" 3 4
       0
# 593 "project/radare2/libr/anal/block.c"
            ;
}
...
# 599 "project/radare2/libr/anal/block.c" 3 4
unsigned long long 
# 599 "project/radare2/libr/anal/block.c"
     dst;
 RPVector *next_visit;
 HtUP *visited;
} PathContext;
...
static 
# 604 "project/radare2/libr/anal/block.c" 3 4
      _Bool 
# 604 "project/radare2/libr/anal/block.c"
...
# 604 "project/radare2/libr/anal/block.c"
 ...
 if (ht_up_find_kv (ctx->visited, addr, 
# 606 "project/radare2/libr/anal/block.c" 3 4
                                       ((void *)0)
# 606 "project/radare2/libr/anal/block.c"
                                           )) {

  return 
# 608 "project/radare2/libr/anal/block.c" 3 4
        1
# 608 "project/radare2/libr/anal/block.c"
            ;
 }
...
# 619 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) 
# 619 "project/radare2/libr/anal/block.c"
                RList *r_anal_block_shortest_path(RAnalBlock *block, 
# 619 "project/radare2/libr/anal/block.c" 3 4
                                                                                       unsigned long long 
# 619 "project/radare2/libr/anal/block.c"
                                                                                            dst) {
 RList *ret = 
# 620 "project/radare2/libr/anal/block.c" 3 4
             ((void *)0)
# 620 "project/radare2/libr/anal/block.c"
                 ;
 PathContext ctx;
 ctx.anal = block->anal;
 ctx.dst = dst;
 ...
 RPVector visit_a;
 r_pvector_init (&visit_a, 
# 627 "project/radare2/libr/anal/block.c" 3 4
                          ((void *)0)
# 627 "project/radare2/libr/anal/block.c"
                              );
 RPVector visit_b;
 r_pvector_init (&visit_b, 
# 629 "project/radare2/libr/anal/block.c" 3 4
                          ((void *)0)
# 629 "project/radare2/libr/anal/block.c"
                              );
 ...
 ht_up_insert (ctx.visited, block->addr, 
# 638 "project/radare2/libr/anal/block.c" 3 4
                                        ((void *)0)
# 638 "project/radare2/libr/anal/block.c"
                                            );
...
# 644 "project/radare2/libr/anal/block.c" 3 4
 for (
# 644 "project/radare2/libr/anal/block.c"
 it 
# 644 "project/radare2/libr/anal/block.c" 3 4
 = (void **)(
# 644 "project/radare2/libr/anal/block.c"
...
# 656 "project/radare2/libr/anal/block.c" 3 4
_Bool 
# 656 "project/radare2/libr/anal/block.c"
     found = 
# 656 "project/radare2/libr/anal/block.c" 3 4
             0
# 656 "project/radare2/libr/anal/block.c"
 ...
 if (found && dst_block) {
  ...
  while (prev) {
   ...
   prev = ht_up_find (ctx.visited, prev->addr, 
# 666 "project/radare2/libr/anal/block.c" 3 4
                                              ((void *)0)
# 666 "project/radare2/libr/anal/block.c"
                                                  );
  }
 }
...
# 677 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 677 "project/radare2/libr/anal/block.c"
          r_anal_block_was_modified(RAnalBlock *block) {
 
# 678 "project/radare2/libr/anal/block.c" 3 4
do { if (!(
# 678 "project/radare2/libr/anal/block.c"
block
# 678 "project/radare2/libr/anal/block.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 678 "project/radare2/libr/anal/block.c"
"block"
# 678 "project/radare2/libr/anal/block.c" 3 4
, 678); return (0); } } while (0)
# 678 "project/radare2/libr/anal/block.c"
                                   ;
 if (!block->anal->iob.read_at) {
  return 
# 680 "project/radare2/libr/anal/block.c" 3 4
        0
# 680 "project/radare2/libr/anal/block.c"
             ;
 }
 
# 682 "project/radare2/libr/anal/block.c" 3 4
unsigned char 
# 682 "project/radare2/libr/anal/block.c"
    *buf = malloc (block->size);
 if (!buf) {
  return 
# 684 "project/radare2/libr/anal/block.c" 3 4
        0
# 684 "project/radare2/libr/anal/block.c"
             ;
 }
 if (!block->anal->iob.read_at (block->anal->iob.io, block->addr, buf, block->size)) {
  free (buf);
  return 
# 688 "project/radare2/libr/anal/block.c" 3 4
        0
# 688 "project/radare2/libr/anal/block.c"
             ;
 }
 
# 690 "project/radare2/libr/anal/block.c" 3 4
unsigned int 
# 690 "project/radare2/libr/anal/block.c"
     cur_hash = r_hash_xxhash (buf, block->size);
 free (buf);
 return block->bbhash != cur_hash;
}


# 695 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) 
# 695 "project/radare2/libr/anal/block.c"
     void r_anal_block_update_hash(RAnalBlock *block) {
 
# 696 "project/radare2/libr/anal/block.c" 3 4
do { if (!(
# 696 "project/radare2/libr/anal/block.c"
block
# 696 "project/radare2/libr/anal/block.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 696 "project/radare2/libr/anal/block.c"
...
# 700 "project/radare2/libr/anal/block.c" 3 4
unsigned char 
# 700 "project/radare2/libr/anal/block.c"
    *buf = malloc (block->size);
 if (!buf) {
  return;
 }
...
# 714 "project/radare2/libr/anal/block.c" 3 4
_Bool 
# 714 "project/radare2/libr/anal/block.c"
     reachable;
} NoreturnSuccessor;
...
static 
# 723 "project/radare2/libr/anal/block.c" 3 4
      _Bool 
# 723 "project/radare2/libr/anal/block.c"
           noreturn_successors_cb(RAnalBlock *block, void *user) {
 HtUP *succs = user;
 NoreturnSuccessor *succ = 
# 725 "project/radare2/libr/anal/block.c" 3 4
                          (
# 725 "project/radare2/libr/anal/block.c"
                          NoreturnSuccessor
# 725 "project/radare2/libr/anal/block.c" 3 4
                          *)calloc(1,sizeof(
# 725 "project/radare2/libr/anal/block.c"
...
# 725 "project/radare2/libr/anal/block.c"
 ...
 if (!succ) {
  return 
# 727 "project/radare2/libr/anal/block.c" 3 4
        0
# 727 "project/radare2/libr/anal/block.c"
             ;
 }
 r_anal_block_ref (block);
 succ->block = block;
 succ->reachable = 
# 731 "project/radare2/libr/anal/block.c" 3 4
                  0
# 731 "project/radare2/libr/anal/block.c"
                       ;
 ht_up_insert (succs, block->addr, succ);
 return 
# 733 "project/radare2/libr/anal/block.c" 3 4
       1
# 733 "project/radare2/libr/anal/block.c"
           ;
}

static 
# 736 "project/radare2/libr/anal/block.c" 3 4
      _Bool 
# 736 "project/radare2/libr/anal/block.c"
           noreturn_successors_reachable_cb(RAnalBlock *block, void *user) {
 HtUP *succs = user;
 NoreturnSuccessor *succ = ht_up_find (succs, block->addr, 
# 738 "project/radare2/libr/anal/block.c" 3 4
                                                          ((void *)0)
# 738 "project/radare2/libr/anal/block.c"
                                                              );
 if (succ) {
  succ->reachable = 
# 740 "project/radare2/libr/anal/block.c" 3 4
                   1
# 740 "project/radare2/libr/anal/block.c"
                       ;
 }
 return 
# 742 "project/radare2/libr/anal/block.c" 3 4
       1
# 742 "project/radare2/libr/anal/block.c"
           ;
}

static 
# 745 "project/radare2/libr/anal/block.c" 3 4
      _Bool 
# 745 "project/radare2/libr/anal/block.c"
           noreturn_remove_unreachable_cb(void *user, const 
# 745 "project/radare2/libr/anal/block.c" 3 4
                                                            unsigned long long 
# 745 "project/radare2/libr/anal/block.c"
                                                                 k, const void *v) {
 ...
 succ->reachable = 
# 751 "project/radare2/libr/anal/block.c" 3 4
                  0
# 751 "project/radare2/libr/anal/block.c"
                       ;
 return 
# 752 "project/radare2/libr/anal/block.c" 3 4
       1
# 752 "project/radare2/libr/anal/block.c"
           ;
}

static 
# 755 "project/radare2/libr/anal/block.c" 3 4
      _Bool 
# 755 "project/radare2/libr/anal/block.c"
           noreturn_get_blocks_cb(void *user, const 
# 755 "project/radare2/libr/anal/block.c" 3 4
                                                    unsigned long long 
# 755 "project/radare2/libr/anal/block.c"
                                                         k, const void *v) {
...
# 759 "project/radare2/libr/anal/block.c" 3 4
r_list_append ((
# 759 "project/radare2/libr/anal/block.c"
blocks
# 759 "project/radare2/libr/anal/block.c" 3 4
), (
# 759 "project/radare2/libr/anal/block.c"
...
# 759 "project/radare2/libr/anal/block.c"
                                 ;
 return 
# 760 "project/radare2/libr/anal/block.c" 3 4
       1
# 760 "project/radare2/libr/anal/block.c"
           ;
}


# 763 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) 
# 763 "project/radare2/libr/anal/block.c"
     RAnalBlock *r_anal_block_chop_noreturn(RAnalBlock *block, 
# 763 "project/radare2/libr/anal/block.c" 3 4
                                                               unsigned long long 
# 763 "project/radare2/libr/anal/block.c"
                                                                    addr) {
 
# 764 "project/radare2/libr/anal/block.c" 3 4
do { if (!(
# 764 "project/radare2/libr/anal/block.c"
block
# 764 "project/radare2/libr/anal/block.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 764 "project/radare2/libr/anal/block.c"
...
# 764 "project/radare2/libr/anal/block.c"
 ...
 HtUP *succs = ht_up_new (
# 772 "project/radare2/libr/anal/block.c" 3 4
                         ((void *)0)
# 772 "project/radare2/libr/anal/block.c"
...
# 772 "project/radare2/libr/anal/block.c"
 ...
 r_anal_block_update_hash (block);
 block->jump = 
# 781 "project/radare2/libr/anal/block.c" 3 4
              0xFFFFFFFFFFFFFFFFULL
# 781 "project/radare2/libr/anal/block.c"
                      ;
 block->fail = 
# 782 "project/radare2/libr/anal/block.c" 3 4
              0xFFFFFFFFFFFFFFFFULL
# 782 "project/radare2/libr/anal/block.c"
                      ;
 r_anal_switch_op_free (block->switch_op);
 block->switch_op = 
# 784 "project/radare2/libr/anal/block.c" 3 4
                   ((void *)0)
# 784 "project/radare2/libr/anal/block.c"
                       ;
...
# 791 "project/radare2/libr/anal/block.c" 3 4
if (
# 791 "project/radare2/libr/anal/block.c"
fcns_cpy
# 791 "project/radare2/libr/anal/block.c" 3 4
) for (
# 791 "project/radare2/libr/anal/block.c"
...
# 812 "project/radare2/libr/anal/block.c" 3 4
unsigned long long 
# 812 "project/radare2/libr/anal/block.c"
 ...
 RAnalBlock *ret = 
# 818 "project/radare2/libr/anal/block.c" 3 4
                  ((void *)0)
# 818 "project/radare2/libr/anal/block.c"
                      ;
...
static 
# 840 "project/radare2/libr/anal/block.c" 3 4
      _Bool 
# 840 "project/radare2/libr/anal/block.c"
           count_successors_cb(
# 840 "project/radare2/libr/anal/block.c" 3 4
                               unsigned long long 
# 840 "project/radare2/libr/anal/block.c"
 ...
 ctx->cur_succ_count++;
 return 
# 843 "project/radare2/libr/anal/block.c" 3 4
       1
# 843 "project/radare2/libr/anal/block.c"
           ;
}

static 
# 846 "project/radare2/libr/anal/block.c" 3 4
      _Bool 
# 846 "project/radare2/libr/anal/block.c"
...
# 846 "project/radare2/libr/anal/block.c"
 ...
 AutomergeCtx *ctx = user;
 ctx->cur_succ_count++;
 RAnalBlock *block = ht_up_find (ctx->blocks, addr, 
# 849 "project/radare2/libr/anal/block.c" 3 4
                                                   ((void *)0)
# 849 "project/radare2/libr/anal/block.c"
                                                       );
 if (!block) {

  return 
# 852 "project/radare2/libr/anal/block.c" 3 4
        1
# 852 "project/radare2/libr/anal/block.c"
            ;
 }
 
# 854 "project/radare2/libr/anal/block.c" 3 4
_Bool 
# 854 "project/radare2/libr/anal/block.c"
     found;
 RAnalBlock *pred = ht_up_find (ctx->predecessors, (
# 855 "project/radare2/libr/anal/block.c" 3 4
                                                   unsigned long long
# 855 "project/radare2/libr/anal/block.c"
                                                       )(size_t)block, &found);
 if (found) {
  if (pred) {

   ht_up_update (ctx->predecessors, (
# 859 "project/radare2/libr/anal/block.c" 3 4
                                    unsigned long long
# 859 "project/radare2/libr/anal/block.c"
                                        )(size_t) block, 
# 859 "project/radare2/libr/anal/block.c" 3 4
                                                         ((void *)0)
# 859 "project/radare2/libr/anal/block.c"
  ...
  ht_up_insert (ctx->predecessors, (
# 863 "project/radare2/libr/anal/block.c" 3 4
                                   unsigned long long
# 863 "project/radare2/libr/anal/block.c"
                                       )(size_t) block, ctx->cur_pred);
 }
 return 
# 865 "project/radare2/libr/anal/block.c" 3 4
       1
# 865 "project/radare2/libr/anal/block.c"
           ;
}

static 
# 868 "project/radare2/libr/anal/block.c" 3 4
      _Bool 
# 868 "project/radare2/libr/anal/block.c"
           automerge_get_predecessors_cb(void *user, 
# 868 "project/radare2/libr/anal/block.c" 3 4
                                                     unsigned long long 
# 868 "project/radare2/libr/anal/block.c"
                                                          k) {
...
# 873 "project/radare2/libr/anal/block.c" 3 4
if (
# 873 "project/radare2/libr/anal/block.c"
fcn->bbs
# 873 "project/radare2/libr/anal/block.c" 3 4
) for (
# 873 "project/radare2/libr/anal/block.c"
...
# 874 "project/radare2/libr/anal/block.c" 3 4
 _Bool 
# 874 "project/radare2/libr/anal/block.c"
      already_visited;
  ht_up_find (ctx->visited_blocks, (
# 875 "project/radare2/libr/anal/block.c" 3 4
                                   unsigned long long
# 875 "project/radare2/libr/anal/block.c"
  ...
  ht_up_insert (ctx->visited_blocks, (
# 882 "project/radare2/libr/anal/block.c" 3 4
                                     unsigned long long
# 882 "project/radare2/libr/anal/block.c"
                                         )(size_t)block, (void *)ctx->cur_succ_count);
 }
 return 
# 884 "project/radare2/libr/anal/block.c" 3 4
       1
# 884 "project/radare2/libr/anal/block.c"
           ;
}
...
# 889 "project/radare2/libr/anal/block.c" 3 4
__attribute__((visibility("default"))) 
# 889 "project/radare2/libr/anal/block.c"
     void r_anal_block_automerge(RList *blocks) {
 
# 890 "project/radare2/libr/anal/block.c" 3 4
do { if (!(
# 890 "project/radare2/libr/anal/block.c"
blocks
# 890 "project/radare2/libr/anal/block.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 890 "project/radare2/libr/anal/block.c"
...
# 906 "project/radare2/libr/anal/block.c" 3 4
if (
# 906 "project/radare2/libr/anal/block.c"
blocks
# 906 "project/radare2/libr/anal/block.c" 3 4
) for (
# 906 "project/radare2/libr/anal/block.c"
...
# 909 "project/radare2/libr/anal/block.c" 3 4
 if (
# 909 "project/radare2/libr/anal/block.c"
 block->fcns
# 909 "project/radare2/libr/anal/block.c" 3 4
 ) for (
# 909 "project/radare2/libr/anal/block.c"
...
# 909 "project/radare2/libr/anal/block.c"
                                        {
   set_u_add (relevant_fcns, (
# 910 "project/radare2/libr/anal/block.c" 3 4
                             unsigned long long
# 910 "project/radare2/libr/anal/block.c"
                                 )(size_t)fcn);
  }
...
# 920 "project/radare2/libr/anal/block.c" 3 4
if (
# 920 "project/radare2/libr/anal/block.c"
blocks
# 920 "project/radare2/libr/anal/block.c" 3 4
) for (
# 920 "project/radare2/libr/anal/block.c"
...
# 920 "project/radare2/libr/anal/block.c"
                                             {
  RAnalBlock *predecessor = ht_up_find (ctx.predecessors, (
# 921 "project/radare2/libr/anal/block.c" 3 4
                                                          unsigned long long
# 921 "project/radare2/libr/anal/block.c"
                                                              )(size_t)block, 
# 921 "project/radare2/libr/anal/block.c" 3 4
                                                                              ((void *)0)
# 921 "project/radare2/libr/anal/block.c"
  ...
  size_t pred_succs_count = (size_t)ht_up_find (ctx.visited_blocks, (
# 925 "project/radare2/libr/anal/block.c" 3 4
                                                                    unsigned long long
# 925 "project/radare2/libr/anal/block.c"
                                                                        )(size_t)predecessor, 
# 925 "project/radare2/libr/anal/block.c" 3 4
                                                                                              ((void *)0)
# 925 "project/radare2/libr/anal/block.c"
  ...
  for (bit = it->n; bit && (clock = bit->data, 1); bit = bit->n) {
   RAnalBlock *fixup_pred = ht_up_find (ctx.predecessors, (
# 937 "project/radare2/libr/anal/block.c" 3 4
                                                          unsigned long long
# 937 "project/radare2/libr/anal/block.c"
                                                              )(size_t)clock, 
# 937 "project/radare2/libr/anal/block.c" 3 4
                                                                              ((void *)0)
# 937 "project/radare2/libr/anal/block.c"
...
# 939 "project/radare2/libr/anal/block.c" 3 4
   r_list_append ((
# 939 "project/radare2/libr/anal/block.c"
   fixup_candidates
# 939 "project/radare2/libr/anal/block.c" 3 4
   ), (
# 939 "project/radare2/libr/anal/block.c"
...
# 939 "project/radare2/libr/anal/block.c"
  ...
  if (r_anal_block_merge (predecessor, block)) {
   ...
   ht_up_update (ctx.visited_blocks, (
# 948 "project/radare2/libr/anal/block.c" 3 4
                                     unsigned long long
# 948 "project/radare2/libr/anal/block.c"
                                         )(size_t)predecessor, (void *)ctx.cur_succ_count);
   
# 949 "project/radare2/libr/anal/block.c" 3 4
  if (
# 949 "project/radare2/libr/anal/block.c"
  fixup_candidates
# 949 "project/radare2/libr/anal/block.c" 3 4
  ) for (
# 949 "project/radare2/libr/anal/block.c"
...
# 949 "project/radare2/libr/anal/block.c"
    ...
    ht_up_update (ctx.predecessors, (
# 951 "project/radare2/libr/anal/block.c" 3 4
                                    unsigned long long
# 951 "project/radare2/libr/anal/block.c"
