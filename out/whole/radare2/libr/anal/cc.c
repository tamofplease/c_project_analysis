# 0 "project/radare2/libr/anal/cc.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/cc.c"
...
# 6 "project/radare2/libr/anal/cc.c" 2
#define DB anal->sdb_cc

__attribute__((visibility("default"))) 
# 8 "project/radare2/libr/anal/cc.c"
     void r_anal_cc_del(RAnal *anal, const char *name) {
 
# 9 "project/radare2/libr/anal/cc.c" 3 4
do { if (!(
# 9 "project/radare2/libr/anal/cc.c"
anal && name
# 9 "project/radare2/libr/anal/cc.c" 3 4
...
# 9 "project/radare2/libr/anal/cc.c"
 ...
 size_t i;
 RStrBuf sb;
 sdb_unset (anal->sdb_cc, r_strbuf_initf (&sb, "%s", name), 0);
 sdb_unset (anal->sdb_cc, r_strbuf_setf (&sb, "cc.%s.ret", name), 0);
 sdb_unset (anal->sdb_cc, r_strbuf_setf (&sb, "cc.%s.argn", name), 0);
 for (i = 0; i < 
# 15 "project/radare2/libr/anal/cc.c" 3 4
                16
# 15 "project/radare2/libr/anal/cc.c"
                                ; i++) {
  sdb_unset (anal->sdb_cc, r_strbuf_setf (&sb, "cc.%s.arg%zu", name, i), 0);
 }
 sdb_unset (anal->sdb_cc, r_strbuf_setf (&sb, "cc.%s.self", name), 0);
 sdb_unset (anal->sdb_cc, r_strbuf_setf (&sb, "cc.%s.error", name), 0);
 r_strbuf_fini (&sb);
}


# 23 "project/radare2/libr/anal/cc.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 23 "project/radare2/libr/anal/cc.c"
          r_anal_cc_set(RAnal *anal, const char *expr) {
 
# 24 "project/radare2/libr/anal/cc.c" 3 4
do { if (!(
# 24 "project/radare2/libr/anal/cc.c"
anal && expr
# 24 "project/radare2/libr/anal/cc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 24 "project/radare2/libr/anal/cc.c"
...
# 24 "project/radare2/libr/anal/cc.c"
 ...
 if (!p) {
  free (e);
  return 
# 29 "project/radare2/libr/anal/cc.c" 3 4
        0
# 29 "project/radare2/libr/anal/cc.c"
             ;
 }
 *p++ = 0;
 char *args = strdup (p);
 ...
 if (!end) {
  ...
  free (e);
  return 
# 38 "project/radare2/libr/anal/cc.c" 3 4
        0
# 38 "project/radare2/libr/anal/cc.c"
             ;
 }
 *end++ = 0;
 r_str_trim (p);
  ...
  *ccname++ = 0;
  ...
  free (e);
  return 
# 50 "project/radare2/libr/anal/cc.c" 3 4
        0
# 50 "project/radare2/libr/anal/cc.c"
             ;
 }
 sdb_set (anal->sdb_cc, ccname, "cc", 0);
 sdb_set (anal->sdb_cc, sdb_fmt ("cc.%s.ret", ccname), e, 0);
...
# 59 "project/radare2/libr/anal/cc.c" 3 4
if (
# 59 "project/radare2/libr/anal/cc.c"
ccArgs
# 59 "project/radare2/libr/anal/cc.c" 3 4
) for (
# 59 "project/radare2/libr/anal/cc.c"
...
# 59 "project/radare2/libr/anal/cc.c"
                                   {
  if (!strcmp (arg, "stack")) {
   sdb_set (anal->sdb_cc, sdb_fmt ("cc.%s.argn", ccname), arg, 0);
  } else {
   sdb_set (anal->sdb_cc, sdb_fmt ("cc.%s.arg%d", ccname, n), arg, 0);
   n++;
  }
 }
 r_list_free (ccArgs);
 ...
 free (args);
 return 
# 70 "project/radare2/libr/anal/cc.c" 3 4
       1
# 70 "project/radare2/libr/anal/cc.c"
           ;
}


# 73 "project/radare2/libr/anal/cc.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 73 "project/radare2/libr/anal/cc.c"
          r_anal_cc_once(RAnal *anal) {
 return sdb_add (anal->sdb_cc, "warn", "once", 0);
}


# 77 "project/radare2/libr/anal/cc.c" 3 4
__attribute__((visibility("default"))) 
# 77 "project/radare2/libr/anal/cc.c"
     void r_anal_cc_get_json(RAnal *anal, PJ *pj, const char *name) {
 
# 78 "project/radare2/libr/anal/cc.c" 3 4
do { if (!(
# 78 "project/radare2/libr/anal/cc.c"
anal && pj && name
# 78 "project/radare2/libr/anal/cc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 78 "project/radare2/libr/anal/cc.c"
...
# 78 "project/radare2/libr/anal/cc.c"
 ...
 if (r_str_cmp (sdb_const_get (anal->sdb_cc, name, 0), "cc", -1)) {
  return;
 }
 const char *ret = sdb_const_get (anal->sdb_cc, sdb_fmt ("cc.%s.ret", name), 0);
 if (!ret) {
  return;
 }
 pj_ks (pj, "ret", ret);
 ...
 pj_ka (pj, "args");
 for (i = 0; i < 
# 93 "project/radare2/libr/anal/cc.c" 3 4
                16
# 93 "project/radare2/libr/anal/cc.c"
                                ; i++) {
  const char *k = sdb_fmt ("cc.%s.arg%d", name, i);
  const char *arg = sdb_const_get (anal->sdb_cc, k, 0);
  if (!arg) {
   break;
  }
  pj_s (pj, arg);
 ...
 pj_end (pj);
 const char *argn = sdb_const_get (anal->sdb_cc, sdb_fmt ("cc.%s.argn", name), 0);
 if (argn) {
  pj_ks (pj, "argn", argn);
 }
...
# 112 "project/radare2/libr/anal/cc.c" 3 4
__attribute__((visibility("default"))) 
# 112 "project/radare2/libr/anal/cc.c"
     char *r_anal_cc_get(RAnal *anal, const char *name) {
 
# 113 "project/radare2/libr/anal/cc.c" 3 4
do { if (!(
# 113 "project/radare2/libr/anal/cc.c"
anal && name
# 113 "project/radare2/libr/anal/cc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 113 "project/radare2/libr/anal/cc.c"
...
# 117 "project/radare2/libr/anal/cc.c" 3 4
 fprintf(__stderrp,
# 117 "project/radare2/libr/anal/cc.c"
 "This is not a valid calling convention name (%s)\n", name
# 117 "project/radare2/libr/anal/cc.c" 3 4
 )
# 117 "project/radare2/libr/anal/cc.c"
                                                                     ;
  return 
# 118 "project/radare2/libr/anal/cc.c" 3 4
        ((void *)0)
# 118 "project/radare2/libr/anal/cc.c"
            ;
 }
 const char *ret = sdb_const_get (anal->sdb_cc, sdb_fmt ("cc.%s.ret", name), 0);
 if (!ret) {
  
# 122 "project/radare2/libr/anal/cc.c" 3 4
 fprintf(__stderrp,
# 122 "project/radare2/libr/anal/cc.c"
 "Cannot find return type for %s\n", name
# 122 "project/radare2/libr/anal/cc.c" 3 4
 )
# 122 "project/radare2/libr/anal/cc.c"
                                                   ;
  return 
# 123 "project/radare2/libr/anal/cc.c" 3 4
        ((void *)0)
# 123 "project/radare2/libr/anal/cc.c"
            ;
 }
 RStrBuf *sb = r_strbuf_new (
# 125 "project/radare2/libr/anal/cc.c" 3 4
                            ((void *)0)
# 125 "project/radare2/libr/anal/cc.c"
                                );
 const char *self = r_anal_cc_self (anal, name);
 r_strbuf_appendf (sb, "%s %s%s%s (", ret, r_str_get (self), self? ".": "", name);
 
# 128 "project/radare2/libr/anal/cc.c" 3 4
_Bool 
# 128 "project/radare2/libr/anal/cc.c"
     isFirst = 
# 128 "project/radare2/libr/anal/cc.c" 3 4
               1
# 128 "project/radare2/libr/anal/cc.c"
                   ;
 for (i = 0; i < 
# 129 "project/radare2/libr/anal/cc.c" 3 4
                16
# 129 "project/radare2/libr/anal/cc.c"
                                ; i++) {
  const char *k = sdb_fmt ("cc.%s.arg%d", name, i);
  const char *arg = sdb_const_get (anal->sdb_cc, k, 0);
  if (!arg) {
  ...
  isFirst = 
# 136 "project/radare2/libr/anal/cc.c" 3 4
           0
# 136 "project/radare2/libr/anal/cc.c"
                ;
 }
 const char *argn = sdb_const_get (anal->sdb_cc, sdb_fmt ("cc.%s.argn", name), 0);
 if (argn) {
...
# 153 "project/radare2/libr/anal/cc.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 153 "project/radare2/libr/anal/cc.c"
          r_anal_cc_exist(RAnal *anal, const char *convention) {
 
# 154 "project/radare2/libr/anal/cc.c" 3 4
do { if (!(
# 154 "project/radare2/libr/anal/cc.c"
anal && convention
# 154 "project/radare2/libr/anal/cc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 154 "project/radare2/libr/anal/cc.c"
"anal && convention"
# 154 "project/radare2/libr/anal/cc.c" 3 4
, 154); return (0); } } while (0)
# 154 "project/radare2/libr/anal/cc.c"
                                                ;
 const char *x = sdb_const_get (anal->sdb_cc, convention, 0);
 return x && *x && !strcmp (x, "cc");
}


# 159 "project/radare2/libr/anal/cc.c" 3 4
__attribute__((visibility("default"))) 
# 159 "project/radare2/libr/anal/cc.c"
     const char *r_anal_cc_arg(RAnal *anal, const char *convention, int n) {
 
# 160 "project/radare2/libr/anal/cc.c" 3 4
do { if (!(
# 160 "project/radare2/libr/anal/cc.c"
anal
# 160 "project/radare2/libr/anal/cc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 160 "project/radare2/libr/anal/cc.c"
"anal"
# 160 "project/radare2/libr/anal/cc.c" 3 4
, 160); return (((void *)0)); } } while (0)
# 160 "project/radare2/libr/anal/cc.c"
                                 ;
 
# 161 "project/radare2/libr/anal/cc.c" 3 4
do { if (!(
# 161 "project/radare2/libr/anal/cc.c"
n >= 0
# 161 "project/radare2/libr/anal/cc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 161 "project/radare2/libr/anal/cc.c"
"n >= 0"
# 161 "project/radare2/libr/anal/cc.c" 3 4
, 161); return (((void *)0)); } } while (0)
# 161 "project/radare2/libr/anal/cc.c"
                                   ;
 if (!convention) {
  return 
# 163 "project/radare2/libr/anal/cc.c" 3 4
        ((void *)0)
# 163 "project/radare2/libr/anal/cc.c"
            ;
 }

 const char *query = sdb_fmt ("cc.%s.arg%d", convention, n);
 const char *ret = sdb_const_get (anal->sdb_cc, query, 0);
 if (!ret) {
  query = sdb_fmt ("cc.%s.argn", convention);
  ret = sdb_const_get (anal->sdb_cc, query, 0);
 }
 return ret? r_str_constpool_get (&anal->constpool, ret): 
# 172 "project/radare2/libr/anal/cc.c" 3 4
                                                         ((void *)0)
# 172 "project/radare2/libr/anal/cc.c"
                                                             ;
}


# 175 "project/radare2/libr/anal/cc.c" 3 4
__attribute__((visibility("default"))) 
# 175 "project/radare2/libr/anal/cc.c"
     const char *r_anal_cc_self(RAnal *anal, const char *convention) {
 
# 176 "project/radare2/libr/anal/cc.c" 3 4
do { if (!(
# 176 "project/radare2/libr/anal/cc.c"
anal && convention
# 176 "project/radare2/libr/anal/cc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 176 "project/radare2/libr/anal/cc.c"
"anal && convention"
# 176 "project/radare2/libr/anal/cc.c" 3 4
, 176); return (((void *)0)); } } while (0)
# 176 "project/radare2/libr/anal/cc.c"
                                               ;
 const char *query = sdb_fmt ("cc.%s.self", convention);
 const char *self = sdb_const_get (anal->sdb_cc, query, 0);
 return self? r_str_constpool_get (&anal->constpool, self): 
# 179 "project/radare2/libr/anal/cc.c" 3 4
                                                           ((void *)0)
# 179 "project/radare2/libr/anal/cc.c"
                                                               ;
}


# 182 "project/radare2/libr/anal/cc.c" 3 4
__attribute__((visibility("default"))) 
# 182 "project/radare2/libr/anal/cc.c"
     void r_anal_cc_set_self(RAnal *anal, const char *convention, const char *self) {
 
# 183 "project/radare2/libr/anal/cc.c" 3 4
do { if (!(
# 183 "project/radare2/libr/anal/cc.c"
anal && convention && self
# 183 "project/radare2/libr/anal/cc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 183 "project/radare2/libr/anal/cc.c"
"anal && convention && self"
...
# 192 "project/radare2/libr/anal/cc.c" 3 4
__attribute__((visibility("default"))) 
# 192 "project/radare2/libr/anal/cc.c"
     const char *r_anal_cc_error(RAnal *anal, const char *convention) {
 
# 193 "project/radare2/libr/anal/cc.c" 3 4
do { if (!(
# 193 "project/radare2/libr/anal/cc.c"
anal && convention
# 193 "project/radare2/libr/anal/cc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 193 "project/radare2/libr/anal/cc.c"
"anal && convention"
# 193 "project/radare2/libr/anal/cc.c" 3 4
, 193); return (((void *)0)); } } while (0)
# 193 "project/radare2/libr/anal/cc.c"
                                               ;
 const char *query = sdb_fmt ("cc.%s.error", convention);
 const char *error = sdb_const_get (anal->sdb_cc, query, 0);
 return error? r_str_constpool_get (&anal->constpool, error): 
# 196 "project/radare2/libr/anal/cc.c" 3 4
                                                             ((void *)0)
# 196 "project/radare2/libr/anal/cc.c"
                                                                 ;
}


# 199 "project/radare2/libr/anal/cc.c" 3 4
__attribute__((visibility("default"))) 
# 199 "project/radare2/libr/anal/cc.c"
     void r_anal_cc_set_error(RAnal *anal, const char *convention, const char *error) {
 
# 200 "project/radare2/libr/anal/cc.c" 3 4
do { if (!(
# 200 "project/radare2/libr/anal/cc.c"
anal && convention && error
# 200 "project/radare2/libr/anal/cc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 200 "project/radare2/libr/anal/cc.c"
"anal && convention && error"
...
# 209 "project/radare2/libr/anal/cc.c" 3 4
__attribute__((visibility("default"))) 
# 209 "project/radare2/libr/anal/cc.c"
     int r_anal_cc_max_arg(RAnal *anal, const char *cc) {
 int i = 0;
 
# 211 "project/radare2/libr/anal/cc.c" 3 4
do { if (!(
# 211 "project/radare2/libr/anal/cc.c"
anal && anal->sdb_cc && cc
# 211 "project/radare2/libr/anal/cc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 211 "project/radare2/libr/anal/cc.c"
...
# 211 "project/radare2/libr/anal/cc.c"
                                          ;
 static void *oldDB = 
# 212 "project/radare2/libr/anal/cc.c" 3 4
                     ((void *)0)
# 212 "project/radare2/libr/anal/cc.c"
                         ;
 static char *oldCC = 
# 213 "project/radare2/libr/anal/cc.c" 3 4
                     ((void *)0)
# 213 "project/radare2/libr/anal/cc.c"
                         ;
 static int oldArg = 0;
 if (oldDB == anal->sdb_cc && !strcmp (cc, oldCC)) {
  return oldArg;
 }
 oldDB = anal->sdb_cc;
 free (oldCC);
 oldCC = strdup (cc);
 for (i = 0; i < 
# 221 "project/radare2/libr/anal/cc.c" 3 4
                16
# 221 "project/radare2/libr/anal/cc.c"
                                ; i++) {
  const char *query = sdb_fmt ("cc.%s.arg%d", cc, i);
  const char *res = sdb_const_get (anal->sdb_cc, query, 0);
  if (!res) {
   break;
  }
 }
...
# 232 "project/radare2/libr/anal/cc.c" 3 4
__attribute__((visibility("default"))) 
# 232 "project/radare2/libr/anal/cc.c"
     const char *r_anal_cc_ret(RAnal *anal, const char *convention) {
 
# 233 "project/radare2/libr/anal/cc.c" 3 4
do { if (!(
# 233 "project/radare2/libr/anal/cc.c"
anal && convention
# 233 "project/radare2/libr/anal/cc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 233 "project/radare2/libr/anal/cc.c"
"anal && convention"
# 233 "project/radare2/libr/anal/cc.c" 3 4
, 233); return (((void *)0)); } } while (0)
# 233 "project/radare2/libr/anal/cc.c"
                                               ;
 char *query = sdb_fmt ("cc.%s.ret", convention);
 return sdb_const_get (anal->sdb_cc, query, 0);
}


# 238 "project/radare2/libr/anal/cc.c" 3 4
__attribute__((visibility("default"))) 
# 238 "project/radare2/libr/anal/cc.c"
     const char *r_anal_cc_default(RAnal *anal) {
 
# 239 "project/radare2/libr/anal/cc.c" 3 4
do { if (!(
# 239 "project/radare2/libr/anal/cc.c"
anal
# 239 "project/radare2/libr/anal/cc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 239 "project/radare2/libr/anal/cc.c"
"anal"
# 239 "project/radare2/libr/anal/cc.c" 3 4
, 239); return (((void *)0)); } } while (0)
# 239 "project/radare2/libr/anal/cc.c"
                                 ;
 return sdb_const_get (anal->sdb_cc, "default.cc", 0);
}


# 243 "project/radare2/libr/anal/cc.c" 3 4
__attribute__((visibility("default"))) 
# 243 "project/radare2/libr/anal/cc.c"
     void r_anal_set_cc_default(RAnal *anal, const char *cc) {
 
# 244 "project/radare2/libr/anal/cc.c" 3 4
do { if (!(
# 244 "project/radare2/libr/anal/cc.c"
anal && cc
# 244 "project/radare2/libr/anal/cc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 244 "project/radare2/libr/anal/cc.c"
...
# 244 "project/radare2/libr/anal/cc.c"
                             ;
 sdb_set (anal->sdb_cc, "default.cc", cc, 0);
}


# 248 "project/radare2/libr/anal/cc.c" 3 4
__attribute__((visibility("default"))) 
# 248 "project/radare2/libr/anal/cc.c"
     const char *r_anal_syscc_default(RAnal *anal) {
 
# 249 "project/radare2/libr/anal/cc.c" 3 4
do { if (!(
# 249 "project/radare2/libr/anal/cc.c"
anal
# 249 "project/radare2/libr/anal/cc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 249 "project/radare2/libr/anal/cc.c"
"anal"
# 249 "project/radare2/libr/anal/cc.c" 3 4
, 249); return (((void *)0)); } } while (0)
# 249 "project/radare2/libr/anal/cc.c"
                                 ;
 return sdb_const_get (anal->sdb_cc, "default.syscc", 0);
}


# 253 "project/radare2/libr/anal/cc.c" 3 4
__attribute__((visibility("default"))) 
# 253 "project/radare2/libr/anal/cc.c"
     void r_anal_set_syscc_default(RAnal *anal, const char *cc) {
 
# 254 "project/radare2/libr/anal/cc.c" 3 4
do { if (!(
# 254 "project/radare2/libr/anal/cc.c"
anal && cc
# 254 "project/radare2/libr/anal/cc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 254 "project/radare2/libr/anal/cc.c"
...
# 254 "project/radare2/libr/anal/cc.c"
                             ;
 sdb_set (anal->sdb_cc, "default.syscc", cc, 0);
}


# 258 "project/radare2/libr/anal/cc.c" 3 4
__attribute__((visibility("default"))) 
# 258 "project/radare2/libr/anal/cc.c"
     const char *r_anal_cc_func(RAnal *anal, const char *func_name) {
 
# 259 "project/radare2/libr/anal/cc.c" 3 4
do { if (!(
# 259 "project/radare2/libr/anal/cc.c"
anal && func_name
# 259 "project/radare2/libr/anal/cc.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 259 "project/radare2/libr/anal/cc.c"
