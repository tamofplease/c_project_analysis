# 0 "project/radare2/libr/anal/vtable.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/vtable.c"
...
# 4 "project/radare2/libr/anal/vtable.c" 2
...
# 5 "project/radare2/libr/anal/vtable.c" 2

#define VTABLE_BUFF_SIZE 10

#define VTABLE_READ_ADDR_FUNC(fname,read_fname,sz) static bool fname(RAnal *anal, ut64 addr, ut64 *buf) { ut8 tmp[sz]; if (!anal->iob.read_at (anal->iob.io, addr, tmp, sz)) { return false; } *buf = read_fname (tmp); return true; }
# 17 "project/radare2/libr/anal/vtable.c"

# 17 "project/radare2/libr/anal/vtable.c"
static 
# 17 "project/radare2/libr/anal/vtable.c" 3 4
_Bool 
# 17 "project/radare2/libr/anal/vtable.c"
vtable_read_addr_le8(RAnal *anal, 
# 17 "project/radare2/libr/anal/vtable.c" 3 4
unsigned long long 
# 17 "project/radare2/libr/anal/vtable.c"
addr, 
...
unsigned char 
# 17 "project/radare2/libr/anal/vtable.c"
tmp[1]; if (!anal->iob.read_at (anal->iob.io, addr, tmp, 1)) { return 
# 17 "project/radare2/libr/anal/vtable.c" 3 4
0
# 17 "project/radare2/libr/anal/vtable.c"
; } *buf = r_read_le8 (tmp); return 
# 17 "project/radare2/libr/anal/vtable.c" 3 4
1
# 17 "project/radare2/libr/anal/vtable.c"
; }
static 
# 18 "project/radare2/libr/anal/vtable.c" 3 4
_Bool 
# 18 "project/radare2/libr/anal/vtable.c"
vtable_read_addr_le16(RAnal *anal, 
# 18 "project/radare2/libr/anal/vtable.c" 3 4
unsigned long long 
# 18 "project/radare2/libr/anal/vtable.c"
addr, 
...
unsigned char 
# 18 "project/radare2/libr/anal/vtable.c"
tmp[2]; if (!anal->iob.read_at (anal->iob.io, addr, tmp, 2)) { return 
# 18 "project/radare2/libr/anal/vtable.c" 3 4
0
# 18 "project/radare2/libr/anal/vtable.c"
; } *buf = r_read_le16 (tmp); return 
# 18 "project/radare2/libr/anal/vtable.c" 3 4
1
# 18 "project/radare2/libr/anal/vtable.c"
; }
static 
# 19 "project/radare2/libr/anal/vtable.c" 3 4
_Bool 
# 19 "project/radare2/libr/anal/vtable.c"
vtable_read_addr_le32(RAnal *anal, 
# 19 "project/radare2/libr/anal/vtable.c" 3 4
unsigned long long 
# 19 "project/radare2/libr/anal/vtable.c"
addr, 
...
unsigned char 
# 19 "project/radare2/libr/anal/vtable.c"
tmp[4]; if (!anal->iob.read_at (anal->iob.io, addr, tmp, 4)) { return 
# 19 "project/radare2/libr/anal/vtable.c" 3 4
0
# 19 "project/radare2/libr/anal/vtable.c"
; } *buf = r_read_le32 (tmp); return 
# 19 "project/radare2/libr/anal/vtable.c" 3 4
1
# 19 "project/radare2/libr/anal/vtable.c"
; }
static 
# 20 "project/radare2/libr/anal/vtable.c" 3 4
_Bool 
# 20 "project/radare2/libr/anal/vtable.c"
vtable_read_addr_le64(RAnal *anal, 
# 20 "project/radare2/libr/anal/vtable.c" 3 4
unsigned long long 
# 20 "project/radare2/libr/anal/vtable.c"
addr, 
...
unsigned char 
# 20 "project/radare2/libr/anal/vtable.c"
tmp[8]; if (!anal->iob.read_at (anal->iob.io, addr, tmp, 8)) { return 
# 20 "project/radare2/libr/anal/vtable.c" 3 4
0
# 20 "project/radare2/libr/anal/vtable.c"
; } *buf = r_read_le64 (tmp); return 
# 20 "project/radare2/libr/anal/vtable.c" 3 4
1
# 20 "project/radare2/libr/anal/vtable.c"
; }
static 
# 21 "project/radare2/libr/anal/vtable.c" 3 4
_Bool 
# 21 "project/radare2/libr/anal/vtable.c"
vtable_read_addr_be8(RAnal *anal, 
# 21 "project/radare2/libr/anal/vtable.c" 3 4
unsigned long long 
# 21 "project/radare2/libr/anal/vtable.c"
addr, 
...
0
# 21 "project/radare2/libr/anal/vtable.c"
; } *buf = r_read_be8 (tmp); return 
# 21 "project/radare2/libr/anal/vtable.c" 3 4
1
# 21 "project/radare2/libr/anal/vtable.c"
; }
static 
# 22 "project/radare2/libr/anal/vtable.c" 3 4
_Bool 
# 22 "project/radare2/libr/anal/vtable.c"
vtable_read_addr_be16(RAnal *anal, 
# 22 "project/radare2/libr/anal/vtable.c" 3 4
unsigned long long 
# 22 "project/radare2/libr/anal/vtable.c"
addr, 
...
0
# 22 "project/radare2/libr/anal/vtable.c"
; } *buf = r_read_be16 (tmp); return 
# 22 "project/radare2/libr/anal/vtable.c" 3 4
1
# 22 "project/radare2/libr/anal/vtable.c"
; }
static 
# 23 "project/radare2/libr/anal/vtable.c" 3 4
_Bool 
# 23 "project/radare2/libr/anal/vtable.c"
vtable_read_addr_be32(RAnal *anal, 
# 23 "project/radare2/libr/anal/vtable.c" 3 4
unsigned long long 
# 23 "project/radare2/libr/anal/vtable.c"
addr, 
...
0
# 23 "project/radare2/libr/anal/vtable.c"
; } *buf = r_read_be32 (tmp); return 
# 23 "project/radare2/libr/anal/vtable.c" 3 4
1
# 23 "project/radare2/libr/anal/vtable.c"
; }
static 
# 24 "project/radare2/libr/anal/vtable.c" 3 4
_Bool 
# 24 "project/radare2/libr/anal/vtable.c"
vtable_read_addr_be64(RAnal *anal, 
# 24 "project/radare2/libr/anal/vtable.c" 3 4
unsigned long long 
# 24 "project/radare2/libr/anal/vtable.c"
addr, 
...
# 26 "project/radare2/libr/anal/vtable.c" 3 4
__attribute__((visibility("default"))) 
# 26 "project/radare2/libr/anal/vtable.c"
     void r_anal_vtable_info_free(RVTableInfo *vtable) {
 if (!vtable) {
  return;
 }
...
# 34 "project/radare2/libr/anal/vtable.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 34 "project/radare2/libr/anal/vtable.c"
          r_anal_vtable_info_get_size(RVTableContext *context, RVTableInfo *vtable) {
 return (
# 35 "project/radare2/libr/anal/vtable.c" 3 4
        unsigned long long
# 35 "project/radare2/libr/anal/vtable.c"
            )vtable->methods.len * context->word_size;
}


# 38 "project/radare2/libr/anal/vtable.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 38 "project/radare2/libr/anal/vtable.c"
          r_anal_vtable_begin(RAnal *anal, RVTableContext *context) {
 context->anal = anal;
 context->abi = anal->cpp_abi;
 context->word_size = (
# 41 "project/radare2/libr/anal/vtable.c" 3 4
                      unsigned char
# 41 "project/radare2/libr/anal/vtable.c"
                         ) (anal->bits / 8);
 const 
# 42 "project/radare2/libr/anal/vtable.c" 3 4
      _Bool 
# 42 "project/radare2/libr/anal/vtable.c"
           is_arm = anal->cur->arch && r_str_startswith (anal->cur->arch, "arm");
 ...
 default:
  return 
# 60 "project/radare2/libr/anal/vtable.c" 3 4
        0
# 60 "project/radare2/libr/anal/vtable.c"
             ;
 }
 return 
# 62 "project/radare2/libr/anal/vtable.c" 3 4
       1
# 62 "project/radare2/libr/anal/vtable.c"
           ;
}

static 
# 65 "project/radare2/libr/anal/vtable.c" 3 4
      _Bool 
# 65 "project/radare2/libr/anal/vtable.c"
           vtable_addr_in_text_section(RVTableContext *context, 
# 65 "project/radare2/libr/anal/vtable.c" 3 4
                                                                unsigned long long 
# 65 "project/radare2/libr/anal/vtable.c"
                                                                     curAddress) {
...
static 
# 72 "project/radare2/libr/anal/vtable.c" 3 4
      _Bool 
# 72 "project/radare2/libr/anal/vtable.c"
           vtable_is_value_in_text_section(RVTableContext *context, 
# 72 "project/radare2/libr/anal/vtable.c" 3 4
                                                                    unsigned long long 
# 72 "project/radare2/libr/anal/vtable.c"
                                                                         curAddress, 
...
# 74 "project/radare2/libr/anal/vtable.c" 3 4
unsigned long long 
# 74 "project/radare2/libr/anal/vtable.c"
     curAddressValue;
 if (!context->read_addr (context->anal, curAddress, &curAddressValue)) {
  return 
# 76 "project/radare2/libr/anal/vtable.c" 3 4
        0
# 76 "project/radare2/libr/anal/vtable.c"
             ;
 }

 
# 79 "project/radare2/libr/anal/vtable.c" 3 4
_Bool 
# 79 "project/radare2/libr/anal/vtable.c"
     ret = vtable_addr_in_text_section (context, curAddressValue);
 if (value) {
...
static 
# 86 "project/radare2/libr/anal/vtable.c" 3 4
      _Bool 
# 86 "project/radare2/libr/anal/vtable.c"
           vtable_section_can_contain_vtables(RBinSection *section) {
 if (section->is_segment) {
  return 
# 88 "project/radare2/libr/anal/vtable.c" 3 4
        0
# 88 "project/radare2/libr/anal/vtable.c"
             ;
 }
...
static 
# 97 "project/radare2/libr/anal/vtable.c" 3 4
      _Bool 
# 97 "project/radare2/libr/anal/vtable.c"
           section_can_contain_rtti(RBinSection *section) {
 if (!section) {
  return 
# 99 "project/radare2/libr/anal/vtable.c" 3 4
        0
# 99 "project/radare2/libr/anal/vtable.c"
             ;
 }
 if (section->is_data) {
  return 
# 102 "project/radare2/libr/anal/vtable.c" 3 4
        1
# 102 "project/radare2/libr/anal/vtable.c"
            ;
 }
...
static 
# 109 "project/radare2/libr/anal/vtable.c" 3 4
      _Bool 
# 109 "project/radare2/libr/anal/vtable.c"
           vtable_is_addr_vtable_start_itanium(RVTableContext *context, RBinSection *section, 
# 109 "project/radare2/libr/anal/vtable.c" 3 4
                                                                                              unsigned long long 
# 109 "project/radare2/libr/anal/vtable.c"
                                                                                                   curAddress) {
 
# 110 "project/radare2/libr/anal/vtable.c" 3 4
unsigned long long 
# 110 "project/radare2/libr/anal/vtable.c"
     value;
 if (!curAddress || curAddress == 
# 111 "project/radare2/libr/anal/vtable.c" 3 4
                                 0xFFFFFFFFFFFFFFFFULL
# 111 "project/radare2/libr/anal/vtable.c"
                                         ) {
  return 
# 112 "project/radare2/libr/anal/vtable.c" 3 4
        0
# 112 "project/radare2/libr/anal/vtable.c"
             ;
 }
 if (curAddress && !vtable_is_value_in_text_section (context, curAddress, 
# 114 "project/radare2/libr/anal/vtable.c" 3 4
                                                                         ((void *)0)
# 114 "project/radare2/libr/anal/vtable.c"
                                                                             )) {
  return 
# 115 "project/radare2/libr/anal/vtable.c" 3 4
        0
# 115 "project/radare2/libr/anal/vtable.c"
             ;
 }
 if (!context->read_addr (context->anal, curAddress - context->word_size, &value)) {
  return 
# 118 "project/radare2/libr/anal/vtable.c" 3 4
        0
# 118 "project/radare2/libr/anal/vtable.c"
             ;
 }
 ...
 if (value && !section_can_contain_rtti (rtti_section)) {
  return 
# 122 "project/radare2/libr/anal/vtable.c" 3 4
        0
# 122 "project/radare2/libr/anal/vtable.c"
             ;
 }
 if (!context->read_addr (context->anal, curAddress - 2 * context->word_size, &value)) {
  return 
# 125 "project/radare2/libr/anal/vtable.c" 3 4
        0
# 125 "project/radare2/libr/anal/vtable.c"
             ;
 }
 if ((
# 127 "project/radare2/libr/anal/vtable.c" 3 4
     int
# 127 "project/radare2/libr/anal/vtable.c"
         )value > 0) {
  return 
# 128 "project/radare2/libr/anal/vtable.c" 3 4
        0
# 128 "project/radare2/libr/anal/vtable.c"
             ;
 }
 return 
# 130 "project/radare2/libr/anal/vtable.c" 3 4
       1
# 130 "project/radare2/libr/anal/vtable.c"
           ;
}

static 
# 133 "project/radare2/libr/anal/vtable.c" 3 4
      _Bool 
# 133 "project/radare2/libr/anal/vtable.c"
           vtable_is_addr_vtable_start_msvc(RVTableContext *context, 
# 133 "project/radare2/libr/anal/vtable.c" 3 4
                                                                     unsigned long long 
# 133 "project/radare2/libr/anal/vtable.c"
                                                                          curAddress) {
 ...
 if (!curAddress || curAddress == 
# 137 "project/radare2/libr/anal/vtable.c" 3 4
                                 0xFFFFFFFFFFFFFFFFULL
# 137 "project/radare2/libr/anal/vtable.c"
                                         ) {
  return 
# 138 "project/radare2/libr/anal/vtable.c" 3 4
        0
# 138 "project/radare2/libr/anal/vtable.c"
             ;
 }
 if (curAddress && !vtable_is_value_in_text_section (context, curAddress, 
# 140 "project/radare2/libr/anal/vtable.c" 3 4
                                                                         ((void *)0)
# 140 "project/radare2/libr/anal/vtable.c"
                                                                             )) {
  return 
# 141 "project/radare2/libr/anal/vtable.c" 3 4
        0
# 141 "project/radare2/libr/anal/vtable.c"
             ;
 }

 RList *xrefs = r_anal_xrefs_get (context->anal, curAddress);
 if (
# 145 "project/radare2/libr/anal/vtable.c" 3 4
    (!(
# 145 "project/radare2/libr/anal/vtable.c"
    xrefs
# 145 "project/radare2/libr/anal/vtable.c" 3 4
    ) || !(
# 145 "project/radare2/libr/anal/vtable.c"
...
# 145 "project/radare2/libr/anal/vtable.c"
  ...
  r_list_free (xrefs);
  return 
# 147 "project/radare2/libr/anal/vtable.c" 3 4
        0
# 147 "project/radare2/libr/anal/vtable.c"
             ;
 }
 
# 149 "project/radare2/libr/anal/vtable.c" 3 4
if (
# 149 "project/radare2/libr/anal/vtable.c"
xrefs
# 149 "project/radare2/libr/anal/vtable.c" 3 4
) for (
# 149 "project/radare2/libr/anal/vtable.c"
...
# 152 "project/radare2/libr/anal/vtable.c" 3 4
  unsigned char 
# 152 "project/radare2/libr/anal/vtable.c"
      buf[10];
   ...
   if (analop.type == R_ANAL_OP_TYPE_MOV
    ...
    return 
# 162 "project/radare2/libr/anal/vtable.c" 3 4
          1
# 162 "project/radare2/libr/anal/vtable.c"
              ;
   }
 ...
 r_list_free (xrefs);
 return 
# 169 "project/radare2/libr/anal/vtable.c" 3 4
       0
# 169 "project/radare2/libr/anal/vtable.c"
            ;
}

static 
# 172 "project/radare2/libr/anal/vtable.c" 3 4
      _Bool 
# 172 "project/radare2/libr/anal/vtable.c"
           vtable_is_addr_vtable_start(RVTableContext *context, RBinSection *section, 
# 172 "project/radare2/libr/anal/vtable.c" 3 4
                                                                                      unsigned long long 
# 172 "project/radare2/libr/anal/vtable.c"
                                                                                           curAddress) {
...
# 179 "project/radare2/libr/anal/vtable.c" 3 4
do { r_assert_log (R_LOGLVL_ERROR, "file %s: line %d (%s): should not be reached\n", "project/radare2/libr/anal/vtable.c", 179, ((const char*) (__func__))); return (0); } while (0)
# 179 "project/radare2/libr/anal/vtable.c"
                               ;
 return 
# 180 "project/radare2/libr/anal/vtable.c" 3 4
       0
# 180 "project/radare2/libr/anal/vtable.c"
            ;
}


# 183 "project/radare2/libr/anal/vtable.c" 3 4
__attribute__((visibility("default"))) 
# 183 "project/radare2/libr/anal/vtable.c"
     RVTableInfo *r_anal_vtable_parse_at(RVTableContext *context, 
# 183 "project/radare2/libr/anal/vtable.c" 3 4
                                                                  unsigned long long 
# 183 "project/radare2/libr/anal/vtable.c"
                                                                       addr) {
 
# 184 "project/radare2/libr/anal/vtable.c" 3 4
unsigned long long 
# 184 "project/radare2/libr/anal/vtable.c"
     offset_to_top;
 if (!context->read_addr (context->anal, addr - 2 * context->word_size, &offset_to_top)) {
  return 
# 186 "project/radare2/libr/anal/vtable.c" 3 4
        ((void *)0)
# 186 "project/radare2/libr/anal/vtable.c"
            ;
 }
 ...
 if (!vtable) {
  return 
# 191 "project/radare2/libr/anal/vtable.c" 3 4
        ((void *)0)
# 191 "project/radare2/libr/anal/vtable.c"
            ;
 }

 vtable->saddr = addr;

 r_vector_init (&vtable->methods, sizeof (RVTableMethodInfo), 
# 196 "project/radare2/libr/anal/vtable.c" 3 4
                                                             ((void *)0)
# 196 "project/radare2/libr/anal/vtable.c"
                                                                 , 
# 196 "project/radare2/libr/anal/vtable.c" 3 4
                                                                   ((void *)0)
# 196 "project/radare2/libr/anal/vtable.c"
 ...
 while (vtable_is_value_in_text_section (context, addr, &meth.addr)) {
  ...
  if (!
# 209 "project/radare2/libr/anal/vtable.c" 3 4
      (!(
# 209 "project/radare2/libr/anal/vtable.c"
      ll
# 209 "project/radare2/libr/anal/vtable.c" 3 4
      ) || !(
# 209 "project/radare2/libr/anal/vtable.c"
...
# 218 "project/radare2/libr/anal/vtable.c" 3 4
__attribute__((visibility("default"))) 
# 218 "project/radare2/libr/anal/vtable.c"
     RList *r_anal_vtable_search(RVTableContext *context) {
 RAnal *anal = context->anal;
 if (!anal) {
  return 
# 221 "project/radare2/libr/anal/vtable.c" 3 4
        ((void *)0)
# 221 "project/radare2/libr/anal/vtable.c"
            ;
 }
 ...
 if (!vtables) {
  return 
# 226 "project/radare2/libr/anal/vtable.c" 3 4
        ((void *)0)
# 226 "project/radare2/libr/anal/vtable.c"
            ;
 }
 ...
 if (!sections) {
  r_list_free (vtables);
  return 
# 232 "project/radare2/libr/anal/vtable.c" 3 4
        ((void *)0)
# 232 "project/radare2/libr/anal/vtable.c"
            ;
 }

 r_cons_break_push (
# 235 "project/radare2/libr/anal/vtable.c" 3 4
                   ((void *)0)
# 235 "project/radare2/libr/anal/vtable.c"
                       , 
# 235 "project/radare2/libr/anal/vtable.c" 3 4
                         ((void *)0)
# 235 "project/radare2/libr/anal/vtable.c"
...
# 239 "project/radare2/libr/anal/vtable.c" 3 4
if (
# 239 "project/radare2/libr/anal/vtable.c"
sections
# 239 "project/radare2/libr/anal/vtable.c" 3 4
) for (
# 239 "project/radare2/libr/anal/vtable.c"
...
# 248 "project/radare2/libr/anal/vtable.c" 3 4
 unsigned long long 
# 248 "project/radare2/libr/anal/vtable.c"
      startAddress = section->vaddr;
  
# 249 "project/radare2/libr/anal/vtable.c" 3 4
 unsigned long long 
# 249 "project/radare2/libr/anal/vtable.c"
      endAddress = startAddress + (section->vsize) - context->word_size;
  
# 250 "project/radare2/libr/anal/vtable.c" 3 4
 unsigned long long 
# 250 "project/radare2/libr/anal/vtable.c"
      ss = endAddress - startAddress;
  if (ss > 
# 251 "project/radare2/libr/anal/vtable.c" 3 4
          0x7FFFFFFF
# 251 "project/radare2/libr/anal/vtable.c"
                  ) {
   break;
  }
...
# 266 "project/radare2/libr/anal/vtable.c" 3 4
    unsigned long long 
# 266 "project/radare2/libr/anal/vtable.c"
         size = r_anal_vtable_info_get_size (context, vtable);
     if (size > 0) {
      startAddress += size;
      continue;
     }
 ...
 if (
# 279 "project/radare2/libr/anal/vtable.c" 3 4
    (!(
# 279 "project/radare2/libr/anal/vtable.c"
    vtables
# 279 "project/radare2/libr/anal/vtable.c" 3 4
    ) || !(
# 279 "project/radare2/libr/anal/vtable.c"
...
# 279 "project/radare2/libr/anal/vtable.c"
  ...
  r_list_free (vtables);
  return 
# 282 "project/radare2/libr/anal/vtable.c" 3 4
        ((void *)0)
# 282 "project/radare2/libr/anal/vtable.c"
            ;
 }
 return vtables;
}
...
# 287 "project/radare2/libr/anal/vtable.c" 3 4
__attribute__((visibility("default"))) 
# 287 "project/radare2/libr/anal/vtable.c"
     void r_anal_list_vtables(RAnal *anal, int rad) {
...
# 304 "project/radare2/libr/anal/vtable.c" 3 4
 if (
# 304 "project/radare2/libr/anal/vtable.c"
 vtables
# 304 "project/radare2/libr/anal/vtable.c" 3 4
 ) for (
# 304 "project/radare2/libr/anal/vtable.c"
...
# 308 "project/radare2/libr/anal/vtable.c" 3 4
  if (!r_vector_empty (
# 308 "project/radare2/libr/anal/vtable.c"
  &table->methods
# 308 "project/radare2/libr/anal/vtable.c" 3 4
  )) for (
# 308 "project/radare2/libr/anal/vtable.c"
...
# 308 "project/radare2/libr/anal/vtable.c"
    ...
    const char *const name = fcn ? fcn->name : 
# 310 "project/radare2/libr/anal/vtable.c" 3 4
                                              ((void *)0)
# 310 "project/radare2/libr/anal/vtable.c"
                                                  ;
    pj_o (pj);
...
# 323 "project/radare2/libr/anal/vtable.c" 3 4
 if (
# 323 "project/radare2/libr/anal/vtable.c"
 vtables
# 323 "project/radare2/libr/anal/vtable.c" 3 4
 ) for (
# 323 "project/radare2/libr/anal/vtable.c"
...
# 323 "project/radare2/libr/anal/vtable.c"
                                             {
   r_cons_printf ("f vtable.0x%08"
# 324 "project/radare2/libr/anal/vtable.c" 3 4
                                 "llx"
# 324 "project/radare2/libr/anal/vtable.c"
                                        " %"
# 324 "project/radare2/libr/anal/vtable.c" 3 4
                                            "lld"
# 324 "project/radare2/libr/anal/vtable.c"
...
# 328 "project/radare2/libr/anal/vtable.c" 3 4
  if (!r_vector_empty (
# 328 "project/radare2/libr/anal/vtable.c"
  &table->methods
# 328 "project/radare2/libr/anal/vtable.c" 3 4
  )) for (
# 328 "project/radare2/libr/anal/vtable.c"
...
# 328 "project/radare2/libr/anal/vtable.c"
                                                {
    r_cons_printf ("Cd %d @ 0x%08"
# 329 "project/radare2/libr/anal/vtable.c" 3 4
                                 "llx"
# 329 "project/radare2/libr/anal/vtable.c"
                                        "\n", context.word_size, table->saddr + curMethod->vtable_offset);
    RAnalFunction *fcn = r_anal_get_fcn_in (anal, curMethod->addr, 0);
    const char *const name = fcn ? fcn->name : 
# 331 "project/radare2/libr/anal/vtable.c" 3 4
                                              ((void *)0)
# 331 "project/radare2/libr/anal/vtable.c"
                                                  ;
    if (name) {
     r_cons_printf ("f %s=0x%08"
# 333 "project/radare2/libr/anal/vtable.c" 3 4
                               "llx"
# 333 "project/radare2/libr/anal/vtable.c"
                                      "\n", name, curMethod->addr);
    } else {
     r_cons_printf ("f method.virtual.0x%08"
# 335 "project/radare2/libr/anal/vtable.c" 3 4
                                           "llx"
# 335 "project/radare2/libr/anal/vtable.c"
                                                  "=0x%08"
# 335 "project/radare2/libr/anal/vtable.c" 3 4
                                                          "llx"
# 335 "project/radare2/libr/anal/vtable.c"
...
# 340 "project/radare2/libr/anal/vtable.c" 3 4
 if (
# 340 "project/radare2/libr/anal/vtable.c"
 vtables
# 340 "project/radare2/libr/anal/vtable.c" 3 4
 ) for (
# 340 "project/radare2/libr/anal/vtable.c"
...
# 341 "project/radare2/libr/anal/vtable.c" 3 4
  unsigned long long 
# 341 "project/radare2/libr/anal/vtable.c"
       vtableStartAddress = table->saddr;
   r_cons_printf ("\nVtable Found at 0x%08"
# 342 "project/radare2/libr/anal/vtable.c" 3 4
                                          "llx"
# 342 "project/radare2/libr/anal/vtable.c"
                                                 "\n", vtableStartAddress);
   
# 343 "project/radare2/libr/anal/vtable.c" 3 4
  if (!r_vector_empty (
# 343 "project/radare2/libr/anal/vtable.c"
  &table->methods
# 343 "project/radare2/libr/anal/vtable.c" 3 4
  )) for (
# 343 "project/radare2/libr/anal/vtable.c"
...
# 343 "project/radare2/libr/anal/vtable.c"
    ...
    RAnalFunction *fcn = r_anal_get_fcn_in (anal, curMethod->addr, 0);
    const char *const name = fcn ? fcn->name : 
# 345 "project/radare2/libr/anal/vtable.c" 3 4
                                              ((void *)0)
# 345 "project/radare2/libr/anal/vtable.c"
                                                  ;
    r_cons_printf ("0x%08"
# 346 "project/radare2/libr/anal/vtable.c" 3 4
                         "llx"
# 346 "project/radare2/libr/anal/vtable.c"
