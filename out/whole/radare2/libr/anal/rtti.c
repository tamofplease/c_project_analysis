# 0 "project/radare2/libr/anal/rtti.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/rtti.c"
...
# 4 "project/radare2/libr/anal/rtti.c" 2

__attribute__((visibility("default"))) 
# 5 "project/radare2/libr/anal/rtti.c"
     char *r_anal_rtti_demangle_class_name(RAnal *anal, const char *name) {
...
# 14 "project/radare2/libr/anal/rtti.c" 3 4
__attribute__((visibility("default"))) 
# 14 "project/radare2/libr/anal/rtti.c"
     void r_anal_rtti_print_at_vtable(RAnal *anal, 
# 14 "project/radare2/libr/anal/rtti.c" 3 4
                                                   unsigned long long 
# 14 "project/radare2/libr/anal/rtti.c"
                                                        addr, int mode) {
 
# 15 "project/radare2/libr/anal/rtti.c" 3 4
_Bool 
# 15 "project/radare2/libr/anal/rtti.c"
     use_json = mode == 'j';
 if (use_json) {
  
# 17 "project/radare2/libr/anal/rtti.c" 3 4
 r_cons_strcat (
# 17 "project/radare2/libr/anal/rtti.c"
 "["
# 17 "project/radare2/libr/anal/rtti.c" 3 4
 )
# 17 "project/radare2/libr/anal/rtti.c"
...
# 23 "project/radare2/libr/anal/rtti.c" 3 4
                                                         0
# 23 "project/radare2/libr/anal/rtti.c"
                                                              );
 } else {
...
# 29 "project/radare2/libr/anal/rtti.c" 3 4
 r_cons_strcat (
# 29 "project/radare2/libr/anal/rtti.c"
 "]\n"
# 29 "project/radare2/libr/anal/rtti.c" 3 4
 )
# 29 "project/radare2/libr/anal/rtti.c"
...
# 33 "project/radare2/libr/anal/rtti.c" 3 4
__attribute__((visibility("default"))) 
# 33 "project/radare2/libr/anal/rtti.c"
     void r_anal_rtti_print_all(RAnal *anal, int mode) {
 RVTableContext context;
 r_anal_vtable_begin (anal, &context);

 
# 37 "project/radare2/libr/anal/rtti.c" 3 4
_Bool 
# 37 "project/radare2/libr/anal/rtti.c"
     use_json = mode == 'j';
 if (use_json) {
  
# 39 "project/radare2/libr/anal/rtti.c" 3 4
 r_cons_strcat (
# 39 "project/radare2/libr/anal/rtti.c"
 "["
# 39 "project/radare2/libr/anal/rtti.c" 3 4
 )
# 39 "project/radare2/libr/anal/rtti.c"
 ...
 r_cons_break_push (
# 42 "project/radare2/libr/anal/rtti.c" 3 4
                   ((void *)0)
# 42 "project/radare2/libr/anal/rtti.c"
                       , 
# 42 "project/radare2/libr/anal/rtti.c" 3 4
                         ((void *)0)
# 42 "project/radare2/libr/anal/rtti.c"
...
# 48 "project/radare2/libr/anal/rtti.c" 3 4
 _Bool 
# 48 "project/radare2/libr/anal/rtti.c"
      comma = 
# 48 "project/radare2/libr/anal/rtti.c" 3 4
              0
# 48 "project/radare2/libr/anal/rtti.c"
...
# 49 "project/radare2/libr/anal/rtti.c" 3 4
 _Bool 
# 49 "project/radare2/libr/anal/rtti.c"
      success = 
# 49 "project/radare2/libr/anal/rtti.c" 3 4
                0
# 49 "project/radare2/libr/anal/rtti.c"
...
# 50 "project/radare2/libr/anal/rtti.c" 3 4
 if (
# 50 "project/radare2/libr/anal/rtti.c"
 vtables
# 50 "project/radare2/libr/anal/rtti.c" 3 4
 ) for (
# 50 "project/radare2/libr/anal/rtti.c"
...
# 55 "project/radare2/libr/anal/rtti.c" 3 4
   r_cons_strcat (
# 55 "project/radare2/libr/anal/rtti.c"
   ","
# 55 "project/radare2/libr/anal/rtti.c" 3 4
   )
# 55 "project/radare2/libr/anal/rtti.c"
                     ;
    comma = 
# 56 "project/radare2/libr/anal/rtti.c" 3 4
           1
# 56 "project/radare2/libr/anal/rtti.c"
               ;
   }
   if (context.abi == R_ANAL_CPP_ABI_MSVC) {
    success = r_anal_rtti_msvc_print_at_vtable (&context, table->saddr, mode, 
# 59 "project/radare2/libr/anal/rtti.c" 3 4
                                                                             1
# 59 "project/radare2/libr/anal/rtti.c"
                                                                                 );
   } else {
   ...
   if (success) {
    comma = 
# 64 "project/radare2/libr/anal/rtti.c" 3 4
           0
# 64 "project/radare2/libr/anal/rtti.c"
                ;
    if (!use_json) {
     
# 66 "project/radare2/libr/anal/rtti.c" 3 4
    r_cons_strcat (
# 66 "project/radare2/libr/anal/rtti.c"
    "\n"
# 66 "project/radare2/libr/anal/rtti.c" 3 4
    )
# 66 "project/radare2/libr/anal/rtti.c"
...
# 78 "project/radare2/libr/anal/rtti.c" 3 4
 r_cons_strcat (
# 78 "project/radare2/libr/anal/rtti.c"
 "]\n"
# 78 "project/radare2/libr/anal/rtti.c" 3 4
 )
# 78 "project/radare2/libr/anal/rtti.c"
...
# 84 "project/radare2/libr/anal/rtti.c" 3 4
__attribute__((visibility("default"))) 
# 84 "project/radare2/libr/anal/rtti.c"
     void r_anal_rtti_recover_all(RAnal *anal) {
 RVTableContext context;
 r_anal_vtable_begin (anal, &context);

 r_cons_break_push (
# 88 "project/radare2/libr/anal/rtti.c" 3 4
                   ((void *)0)
# 88 "project/radare2/libr/anal/rtti.c"
                       , 
# 88 "project/radare2/libr/anal/rtti.c" 3 4
                         ((void *)0)
# 88 "project/radare2/libr/anal/rtti.c"
