# 0 "project/radare2/libr/anal/labels.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/anal/labels.c" 2

static unsigned long long* 
# 5 "project/radare2/libr/anal/labels.c"
ut64_new
# 5 "project/radare2/libr/anal/labels.c" 3 4
(unsigned long long n) { unsigned long long *m = malloc(sizeof (unsigned long long)); return m? *m = n, m: m; }
# 5 "project/radare2/libr/anal/labels.c"
              ;


# 7 "project/radare2/libr/anal/labels.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 7 "project/radare2/libr/anal/labels.c"
          r_anal_function_get_label(RAnalFunction *fcn, const char *name) {
 
# 8 "project/radare2/libr/anal/labels.c" 3 4
do { if (!(
# 8 "project/radare2/libr/anal/labels.c"
fcn
# 8 "project/radare2/libr/anal/labels.c" 3 4
...
"fcn"
# 8 "project/radare2/libr/anal/labels.c" 3 4
, 8); return (0xFFFFFFFFFFFFFFFFULL); } } while (0)
# 8 "project/radare2/libr/anal/labels.c"
                                    ;
 
# 9 "project/radare2/libr/anal/labels.c" 3 4
unsigned long long 
# 9 "project/radare2/libr/anal/labels.c"
     *addr = ht_pp_find (fcn->label_addrs, name, 
# 9 "project/radare2/libr/anal/labels.c" 3 4
                                                 ((void *)0)
# 9 "project/radare2/libr/anal/labels.c"
                                                     );
 return addr? *addr: 
# 10 "project/radare2/libr/anal/labels.c" 3 4
                    0xFFFFFFFFFFFFFFFFULL
# 10 "project/radare2/libr/anal/labels.c"
                            ;
}


# 13 "project/radare2/libr/anal/labels.c" 3 4
__attribute__((visibility("default"))) 
# 13 "project/radare2/libr/anal/labels.c"
     const char *r_anal_function_get_label_at(RAnalFunction *fcn, 
# 13 "project/radare2/libr/anal/labels.c" 3 4
                                                                  unsigned long long 
# 13 "project/radare2/libr/anal/labels.c"
                                                                       addr) {
 
# 14 "project/radare2/libr/anal/labels.c" 3 4
do { if (!(
# 14 "project/radare2/libr/anal/labels.c"
fcn
# 14 "project/radare2/libr/anal/labels.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 14 "project/radare2/libr/anal/labels.c"
...
# 14 "project/radare2/libr/anal/labels.c"
                                ;
 return ht_up_find (fcn->labels, addr, 
# 15 "project/radare2/libr/anal/labels.c" 3 4
                                      ((void *)0)
# 15 "project/radare2/libr/anal/labels.c"
                                          );
}


# 18 "project/radare2/libr/anal/labels.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 18 "project/radare2/libr/anal/labels.c"
          r_anal_function_set_label(RAnalFunction *fcn, const char *name, 
# 18 "project/radare2/libr/anal/labels.c" 3 4
                                                                          unsigned long long 
# 18 "project/radare2/libr/anal/labels.c"
                                                                               addr) {
 
# 19 "project/radare2/libr/anal/labels.c" 3 4
do { if (!(
# 19 "project/radare2/libr/anal/labels.c"
fcn && name
# 19 "project/radare2/libr/anal/labels.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 19 "project/radare2/libr/anal/labels.c"
...
# 19 "project/radare2/libr/anal/labels.c"
                                         ;
 if (ht_pp_find (fcn->label_addrs, name, 
# 20 "project/radare2/libr/anal/labels.c" 3 4
                                        ((void *)0)
# 20 "project/radare2/libr/anal/labels.c"
                                            )) {
  return 
# 21 "project/radare2/libr/anal/labels.c" 3 4
        0
# 21 "project/radare2/libr/anal/labels.c"
             ;
 }
 char *n = strdup (name);
 if (!ht_up_insert (fcn->labels, addr, n)) {
  free (n);
  return 
# 26 "project/radare2/libr/anal/labels.c" 3 4
        0
# 26 "project/radare2/libr/anal/labels.c"
             ;
 }
 ht_pp_insert (fcn->label_addrs, name, ut64_new (addr));
 return 
# 29 "project/radare2/libr/anal/labels.c" 3 4
       1
# 29 "project/radare2/libr/anal/labels.c"
           ;
}


# 32 "project/radare2/libr/anal/labels.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 32 "project/radare2/libr/anal/labels.c"
          r_anal_function_delete_label(RAnalFunction *fcn, const char *name) {
 
# 33 "project/radare2/libr/anal/labels.c" 3 4
do { if (!(
# 33 "project/radare2/libr/anal/labels.c"
fcn && name
# 33 "project/radare2/libr/anal/labels.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 33 "project/radare2/libr/anal/labels.c"
...
# 34 "project/radare2/libr/anal/labels.c" 3 4
unsigned long long 
# 34 "project/radare2/libr/anal/labels.c"
     *addr = ht_pp_find (fcn->label_addrs, name, 
# 34 "project/radare2/libr/anal/labels.c" 3 4
                                                 ((void *)0)
# 34 "project/radare2/libr/anal/labels.c"
 ...
 if (!addr) {
  return 
# 36 "project/radare2/libr/anal/labels.c" 3 4
        0
# 36 "project/radare2/libr/anal/labels.c"
             ;
 }
 ht_up_delete (fcn->labels, *addr);
 ht_pp_delete (fcn->label_addrs, name);
 return 
# 40 "project/radare2/libr/anal/labels.c" 3 4
       1
# 40 "project/radare2/libr/anal/labels.c"
           ;
}


# 43 "project/radare2/libr/anal/labels.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 43 "project/radare2/libr/anal/labels.c"
          r_anal_function_delete_label_at(RAnalFunction *fcn, 
# 43 "project/radare2/libr/anal/labels.c" 3 4
                                                              unsigned long long 
# 43 "project/radare2/libr/anal/labels.c"
                                                                   addr) {
 
# 44 "project/radare2/libr/anal/labels.c" 3 4
do { if (!(
# 44 "project/radare2/libr/anal/labels.c"
fcn
# 44 "project/radare2/libr/anal/labels.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 44 "project/radare2/libr/anal/labels.c"
...
# 44 "project/radare2/libr/anal/labels.c"
                                 ;
 char *name = ht_up_find (fcn->labels, addr, 
# 45 "project/radare2/libr/anal/labels.c" 3 4
                                            ((void *)0)
# 45 "project/radare2/libr/anal/labels.c"
                                                );
 if (!name) {
  return 
# 47 "project/radare2/libr/anal/labels.c" 3 4
        0
# 47 "project/radare2/libr/anal/labels.c"
             ;
 }
 ht_pp_delete (fcn->label_addrs, name);
 ht_up_delete (fcn->labels, addr);
 return 
# 51 "project/radare2/libr/anal/labels.c" 3 4
       1
# 51 "project/radare2/libr/anal/labels.c"
           ;
}
