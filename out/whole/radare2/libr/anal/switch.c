# 0 "project/radare2/libr/anal/switch.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/switch.c"
...
# 4 "project/radare2/libr/anal/switch.c" 2


# 5 "project/radare2/libr/anal/switch.c"
static RAnalSwitchOp *__switch_op_new(void) {
 RAnalSwitchOp * swop = 
# 6 "project/radare2/libr/anal/switch.c" 3 4
                       (
# 6 "project/radare2/libr/anal/switch.c"
                       RAnalSwitchOp
# 6 "project/radare2/libr/anal/switch.c" 3 4
                       *)calloc(1,sizeof(
# 6 "project/radare2/libr/anal/switch.c"
...
# 6 "project/radare2/libr/anal/switch.c"
 ...
 if (swop) {
  ...
  if (!swop->cases) {
   free (swop);
   return 
# 11 "project/radare2/libr/anal/switch.c" 3 4
         ((void *)0)
# 11 "project/radare2/libr/anal/switch.c"
             ;
  }
...
# 19 "project/radare2/libr/anal/switch.c" 3 4
__attribute__((visibility("default"))) 
# 19 "project/radare2/libr/anal/switch.c"
     RAnalSwitchOp *r_anal_switch_op_new(
# 19 "project/radare2/libr/anal/switch.c" 3 4
                                         unsigned long long 
# 19 "project/radare2/libr/anal/switch.c"
                                              addr, 
...
# 30 "project/radare2/libr/anal/switch.c" 3 4
__attribute__((visibility("default"))) 
# 30 "project/radare2/libr/anal/switch.c"
     RAnalCaseOp * r_anal_case_op_new(
# 30 "project/radare2/libr/anal/switch.c" 3 4
                                      unsigned long long 
# 30 "project/radare2/libr/anal/switch.c"
                                           addr, 
...
# 30 "project/radare2/libr/anal/switch.c"
                                                                jump) {
 RAnalCaseOp *c = 
# 31 "project/radare2/libr/anal/switch.c" 3 4
                 (
# 31 "project/radare2/libr/anal/switch.c"
                 RAnalCaseOp
# 31 "project/radare2/libr/anal/switch.c" 3 4
                 *)calloc(1,sizeof(
# 31 "project/radare2/libr/anal/switch.c"
...
# 40 "project/radare2/libr/anal/switch.c" 3 4
__attribute__((visibility("default"))) 
# 40 "project/radare2/libr/anal/switch.c"
     void r_anal_switch_op_free(RAnalSwitchOp * swop) {
 if (swop) {
...
# 47 "project/radare2/libr/anal/switch.c" 3 4
__attribute__((visibility("default"))) 
# 47 "project/radare2/libr/anal/switch.c"
     RAnalCaseOp* r_anal_switch_op_add_case(RAnalSwitchOp * swop, 
# 47 "project/radare2/libr/anal/switch.c" 3 4
                                                                  unsigned long long 
# 47 "project/radare2/libr/anal/switch.c"
                                                                       addr, 
...
# 48 "project/radare2/libr/anal/switch.c" 3 4
do { if (!(
# 48 "project/radare2/libr/anal/switch.c"
swop && addr != 
# 48 "project/radare2/libr/anal/switch.c" 3 4
