# 0 "project/radare2/libr/anal/data.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/anal/data.c" 2

#define MINLEN 1

# 6 "project/radare2/libr/anal/data.c"
static int is_string(const 
# 6 "project/radare2/libr/anal/data.c" 3 4
                          unsigned char 
# 6 "project/radare2/libr/anal/data.c"
                              *buf, int size, int *len) {
 int i;
 if (size < 1) {
  return 0;
 }
 ...
 for (i = 0; i < size; i++) {
  ...
  if (!
# 27 "project/radare2/libr/anal/data.c" 3 4
      ((
# 27 "project/radare2/libr/anal/data.c"
      buf[i]
# 27 "project/radare2/libr/anal/data.c" 3 4
      ) >=' ' && (
# 27 "project/radare2/libr/anal/data.c"
...
# 36 "project/radare2/libr/anal/data.c" 3 4
                          unsigned char 
# 36 "project/radare2/libr/anal/data.c"
                              *buf, int size) {
 
# 37 "project/radare2/libr/anal/data.c" 3 4
unsigned long long 
# 37 "project/radare2/libr/anal/data.c"
     n = r_mem_get_num (buf, size);
 return (n < 
# 38 "project/radare2/libr/anal/data.c" 3 4
            0xFFFFFFFFU
# 38 "project/radare2/libr/anal/data.c"
                    )? (int)n: 0;
}

static int is_null(const 
# 41 "project/radare2/libr/anal/data.c" 3 4
                        unsigned char 
# 41 "project/radare2/libr/anal/data.c"
                            *buf, int size) {
 const char zero[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
 return (!memcmp (buf, &zero, size))? 1: 0;
}

static int is_invalid(const 
# 46 "project/radare2/libr/anal/data.c" 3 4
                           unsigned char 
# 46 "project/radare2/libr/anal/data.c"
                               *buf, int size) {
 if (size < 1) {
  return 1;
 }
...
static 
# 57 "project/radare2/libr/anal/data.c" 3 4
      unsigned long long 
# 57 "project/radare2/libr/anal/data.c"
           is_pointer(RAnal *anal, const 
# 57 "project/radare2/libr/anal/data.c" 3 4
                                         unsigned char 
# 57 "project/radare2/libr/anal/data.c"
                                             *buf, int size) {
 
# 58 "project/radare2/libr/anal/data.c" 3 4
unsigned long long 
# 58 "project/radare2/libr/anal/data.c"
     n;
 
# 59 "project/radare2/libr/anal/data.c" 3 4
unsigned char 
# 59 "project/radare2/libr/anal/data.c"
    buf2[32];
 ...
 return r? n: 0LL;
# 82 "project/radare2/libr/anal/data.c"
}

static 
# 84 "project/radare2/libr/anal/data.c" 3 4
      _Bool 
# 84 "project/radare2/libr/anal/data.c"
           is_bin(const 
# 84 "project/radare2/libr/anal/data.c" 3 4
                        unsigned char 
# 84 "project/radare2/libr/anal/data.c"
 ...
 if ((size >= 4 && !memcmp (buf, "\xcf\xfa\xed\xfe", 4))) {
  return 
# 87 "project/radare2/libr/anal/data.c" 3 4
        1
# 87 "project/radare2/libr/anal/data.c"
            ;
 }
 if ((size >= 4 && !memcmp (buf, "\x7f\x45\x4c\x46", 4))) {
  return 
# 90 "project/radare2/libr/anal/data.c" 3 4
        1
# 90 "project/radare2/libr/anal/data.c"
            ;
 }
 if ((size >= 2 && !memcmp (buf, "MZ", 2))) {
  return 
# 93 "project/radare2/libr/anal/data.c" 3 4
        1
# 93 "project/radare2/libr/anal/data.c"
            ;
 }
 return 
# 95 "project/radare2/libr/anal/data.c" 3 4
       0
# 95 "project/radare2/libr/anal/data.c"
            ;
}
...
# 100 "project/radare2/libr/anal/data.c" 3 4
__attribute__((visibility("default"))) 
# 100 "project/radare2/libr/anal/data.c"
     char *r_anal_data_to_string(RAnalData *d, RConsPrintablePalette *pal) {
 int i, len, mallocsz = 1024;
 
# 102 "project/radare2/libr/anal/data.c" 3 4
unsigned int 
# 102 "project/radare2/libr/anal/data.c"
     n32;

 if (!d) {
  return 
# 105 "project/radare2/libr/anal/data.c" 3 4
        ((void *)0)
# 105 "project/radare2/libr/anal/data.c"
            ;
 }

 RStrBuf *sb = r_strbuf_new (
# 108 "project/radare2/libr/anal/data.c" 3 4
                            ((void *)0)
# 108 "project/radare2/libr/anal/data.c"
                                );
 if (!sb || !r_strbuf_reserve (sb, mallocsz)) {
  
# 110 "project/radare2/libr/anal/data.c" 3 4
 fprintf(__stderrp,
# 110 "project/radare2/libr/anal/data.c"
...
# 110 "project/radare2/libr/anal/data.c"
                                                   ;
  return 
# 111 "project/radare2/libr/anal/data.c" 3 4
        ((void *)0)
# 111 "project/radare2/libr/anal/data.c"
            ;
 }
 if (pal) {
  const char *k = pal->offset;
  r_strbuf_appendf (sb, "%s0x%08" 
# 115 "project/radare2/libr/anal/data.c" 3 4
                                 "llx" "\x1b[0m"
# 115 "project/radare2/libr/anal/data.c"
                                                    "  ", k, d->addr);
 } else {
  r_strbuf_appendf (sb, "0x%08" 
# 117 "project/radare2/libr/anal/data.c" 3 4
                               "llx" 
# 117 "project/radare2/libr/anal/data.c"
                                       "  ", d->addr);
 }
 n32 = (
# 119 "project/radare2/libr/anal/data.c" 3 4
       unsigned int
# 119 "project/radare2/libr/anal/data.c"
           )d->ptr;
 len = 
# 120 "project/radare2/libr/anal/data.c" 3 4
      (((
# 120 "project/radare2/libr/anal/data.c"
      d->len
# 120 "project/radare2/libr/anal/data.c" 3 4
      )>(
# 120 "project/radare2/libr/anal/data.c"
...
# 120 "project/radare2/libr/anal/data.c"
 ...
 case R_ANAL_DATA_TYPE_STRING:
  if (pal) {
   r_strbuf_appendf (sb, "%sstring \"%s\""
# 131 "project/radare2/libr/anal/data.c" 3 4
                                         "\x1b[0m"
# 131 "project/radare2/libr/anal/data.c"
                                                    , pal->comment, d->str);
  } else {
 ...
 case R_ANAL_DATA_TYPE_NUMBER:
  if (pal) {
   ...
   if (n32 == d->ptr) {
    r_strbuf_appendf (sb, "%snumber %d (0x%x)"
# 143 "project/radare2/libr/anal/data.c" 3 4
                                             "\x1b[0m"
# 143 "project/radare2/libr/anal/data.c"
                                                        , k, n32, n32);
   } else {
    r_strbuf_appendf (sb, "%snumber %" 
# 145 "project/radare2/libr/anal/data.c" 3 4
                                      "lld" 
# 145 "project/radare2/libr/anal/data.c"
                                              " (0x%" 
# 145 "project/radare2/libr/anal/data.c" 3 4
                                                      "llx" 
# 145 "project/radare2/libr/anal/data.c"
...
# 145 "project/radare2/libr/anal/data.c"
   ...
   if (n32 == d->ptr) {
    ...
    r_strbuf_appendf (sb, "number %" 
# 152 "project/radare2/libr/anal/data.c" 3 4
                                    "lld" 
# 152 "project/radare2/libr/anal/data.c"
                                            " 0x%" 
# 152 "project/radare2/libr/anal/data.c" 3 4
                                                   "llx"
# 152 "project/radare2/libr/anal/data.c"
 ...
 case R_ANAL_DATA_TYPE_POINTER:
  ...
  if (pal) {
   const char *k = pal->offset;
   r_strbuf_appendf (sb, " %s0x%08" 
# 161 "project/radare2/libr/anal/data.c" 3 4
                                   "llx"
# 161 "project/radare2/libr/anal/data.c"
                                          , k, d->ptr);
  } else {
   r_strbuf_appendf (sb, " 0x%08" 
# 163 "project/radare2/libr/anal/data.c" 3 4
                                 "llx"
# 163 "project/radare2/libr/anal/data.c"
                                        , d->ptr);
  }
  break;
 case R_ANAL_DATA_TYPE_INVALID:
  if (pal) {
   r_strbuf_appendf (sb, "%sinvalid"
# 168 "project/radare2/libr/anal/data.c" 3 4
                                   "\x1b[0m"
# 168 "project/radare2/libr/anal/data.c"
                                              , pal->invalid);
  } else {
 ...
 case R_ANAL_DATA_TYPE_UNKNOWN:
  if (pal) {
   r_strbuf_appendf (sb, "%sunknown"
# 184 "project/radare2/libr/anal/data.c" 3 4
                                   "\x1b[0m"
# 184 "project/radare2/libr/anal/data.c"
                                              , pal->invalid);
  } else {
...
# 191 "project/radare2/libr/anal/data.c" 3 4
                                  "\x1b[0m"
# 191 "project/radare2/libr/anal/data.c"
                                             , pal->b0x00);
  } else {
...
# 200 "project/radare2/libr/anal/data.c" 3 4
__attribute__((visibility("default"))) 
# 200 "project/radare2/libr/anal/data.c"
     RAnalData *r_anal_data_new_string(
# 200 "project/radare2/libr/anal/data.c" 3 4
                                       unsigned long long 
# 200 "project/radare2/libr/anal/data.c"
                                            addr, const char *p, int len, int type) {
 RAnalData *ad = 
# 201 "project/radare2/libr/anal/data.c" 3 4
                (
# 201 "project/radare2/libr/anal/data.c"
                RAnalData
# 201 "project/radare2/libr/anal/data.c" 3 4
                *)calloc(1,sizeof(
# 201 "project/radare2/libr/anal/data.c"
...
# 201 "project/radare2/libr/anal/data.c"
 ...
 if (!ad) {
  return 
# 203 "project/radare2/libr/anal/data.c" 3 4
        ((void *)0)
# 203 "project/radare2/libr/anal/data.c"
            ;
 }
 ad->str = 
# 205 "project/radare2/libr/anal/data.c" 3 4
          ((void *)0)
# 205 "project/radare2/libr/anal/data.c"
              ;
 ad->addr = addr;
 ad->type = type;
 if (len == 0) {
 ...
 if (type == R_ANAL_DATA_TYPE_WIDE_STRING) {
  ...
  if (!ad->str) {
   r_anal_data_free (ad);
   return 
# 218 "project/radare2/libr/anal/data.c" 3 4
         ((void *)0)
# 218 "project/radare2/libr/anal/data.c"
             ;
  }
  
# 220 "project/radare2/libr/anal/data.c" 3 4
 __builtin___memcpy_chk (
# 220 "project/radare2/libr/anal/data.c"
 ad->str
# 220 "project/radare2/libr/anal/data.c" 3 4
 , 
# 220 "project/radare2/libr/anal/data.c"
...
# 225 "project/radare2/libr/anal/data.c" 3 4
  fprintf(__stderrp,
# 225 "project/radare2/libr/anal/data.c"
  "Cannot allocate %d byte(s)\n", len + 1
# 225 "project/radare2/libr/anal/data.c" 3 4
  )
# 225 "project/radare2/libr/anal/data.c"
                                                   ;
   return 
# 226 "project/radare2/libr/anal/data.c" 3 4
         ((void *)0)
# 226 "project/radare2/libr/anal/data.c"
             ;
  }
  
# 228 "project/radare2/libr/anal/data.c" 3 4
 __builtin___memcpy_chk (
# 228 "project/radare2/libr/anal/data.c"
 ad->buf
# 228 "project/radare2/libr/anal/data.c" 3 4
 , 
# 228 "project/radare2/libr/anal/data.c"
...
# 235 "project/radare2/libr/anal/data.c" 3 4
__attribute__((visibility("default"))) 
# 235 "project/radare2/libr/anal/data.c"
     RAnalData *r_anal_data_new(
# 235 "project/radare2/libr/anal/data.c" 3 4
                                unsigned long long 
# 235 "project/radare2/libr/anal/data.c"
                                     addr, int type, 
...
# 235 "project/radare2/libr/anal/data.c"
                                                                       *buf, int len) {
 RAnalData *ad = 
# 236 "project/radare2/libr/anal/data.c" 3 4
                (
# 236 "project/radare2/libr/anal/data.c"
                RAnalData
# 236 "project/radare2/libr/anal/data.c" 3 4
                *)calloc(1,sizeof(
# 236 "project/radare2/libr/anal/data.c"
...
# 236 "project/radare2/libr/anal/data.c"
                                  ;
 int l = 
# 237 "project/radare2/libr/anal/data.c" 3 4
        (((
# 237 "project/radare2/libr/anal/data.c"
        len
# 237 "project/radare2/libr/anal/data.c" 3 4
        )>(
# 237 "project/radare2/libr/anal/data.c"
...
# 237 "project/radare2/libr/anal/data.c"
 ...
 if (!ad) {
  return 
# 239 "project/radare2/libr/anal/data.c" 3 4
        ((void *)0)
# 239 "project/radare2/libr/anal/data.c"
            ;
 }
 ad->buf = (
# 241 "project/radare2/libr/anal/data.c" 3 4
           unsigned char 
# 241 "project/radare2/libr/anal/data.c"
               *)&(ad->sbuf);
 
# 242 "project/radare2/libr/anal/data.c" 3 4
__builtin___memset_chk (
# 242 "project/radare2/libr/anal/data.c"
ad->buf
# 242 "project/radare2/libr/anal/data.c" 3 4
, 
# 242 "project/radare2/libr/anal/data.c"
...
# 242 "project/radare2/libr/anal/data.c"
 ...
 if (l < 1) {
  r_anal_data_free (ad);
  return 
# 245 "project/radare2/libr/anal/data.c" 3 4
        ((void *)0)
# 245 "project/radare2/libr/anal/data.c"
            ;
 }
 if (buf) {
  
# 248 "project/radare2/libr/anal/data.c" 3 4
 __builtin___memcpy_chk (
# 248 "project/radare2/libr/anal/data.c"
 ad->buf
# 248 "project/radare2/libr/anal/data.c" 3 4
 , 
# 248 "project/radare2/libr/anal/data.c"
...
# 248 "project/radare2/libr/anal/data.c"
 ...
 ad->type = type;
 ad->str = 
# 252 "project/radare2/libr/anal/data.c" 3 4
          ((void *)0)
# 252 "project/radare2/libr/anal/data.c"
              ;
 switch (type) {
 case R_ANAL_DATA_TYPE_PATTERN:
 case R_ANAL_DATA_TYPE_SEQUENCE:
...
# 265 "project/radare2/libr/anal/data.c" 3 4
__attribute__((visibility("default"))) 
# 265 "project/radare2/libr/anal/data.c"
     void r_anal_data_free(RAnalData *d) {
 if (d) {
  if (d->buf != (
# 267 "project/radare2/libr/anal/data.c" 3 4
                unsigned char 
# 267 "project/radare2/libr/anal/data.c"
                    *)&(d->sbuf)) {
   free (d->buf);
  }
  free (d->str);
...
# 275 "project/radare2/libr/anal/data.c" 3 4
__attribute__((visibility("default"))) 
# 275 "project/radare2/libr/anal/data.c"
     RAnalData *r_anal_data(RAnal *anal, 
# 275 "project/radare2/libr/anal/data.c" 3 4
                                         unsigned long long 
# 275 "project/radare2/libr/anal/data.c"
                                              addr, const 
# 275 "project/radare2/libr/anal/data.c" 3 4
                                                          unsigned char 
# 275 "project/radare2/libr/anal/data.c"
                                                              *buf, int size, int wordsize) {
 
# 276 "project/radare2/libr/anal/data.c" 3 4
unsigned long long 
# 276 "project/radare2/libr/anal/data.c"
     dst = 0;
 int n, nsize = 0;
 int bits = anal->bits;
 int word = wordsize? wordsize: 
# 279 "project/radare2/libr/anal/data.c" 3 4
                               (((
# 279 "project/radare2/libr/anal/data.c"
                               8
# 279 "project/radare2/libr/anal/data.c" 3 4
                               )>(
# 279 "project/radare2/libr/anal/data.c"
...
# 279 "project/radare2/libr/anal/data.c"
 ...
 if (size < 4) {
  return 
# 282 "project/radare2/libr/anal/data.c" 3 4
        ((void *)0)
# 282 "project/radare2/libr/anal/data.c"
            ;
 }
 ...
 {
  int i, len = 
# 288 "project/radare2/libr/anal/data.c" 3 4
              (((
# 288 "project/radare2/libr/anal/data.c"
              size
# 288 "project/radare2/libr/anal/data.c" 3 4
              )>(
# 288 "project/radare2/libr/anal/data.c"
...
# 288 "project/radare2/libr/anal/data.c"
 ...
 return r_anal_data_new (addr, R_ANAL_DATA_TYPE_UNKNOWN, dst, buf, 
# 335 "project/radare2/libr/anal/data.c" 3 4
                                                                  (((
# 335 "project/radare2/libr/anal/data.c"
                                                                  word
# 335 "project/radare2/libr/anal/data.c" 3 4
                                                                  )>(
# 335 "project/radare2/libr/anal/data.c"
...
# 338 "project/radare2/libr/anal/data.c" 3 4
__attribute__((visibility("default"))) 
# 338 "project/radare2/libr/anal/data.c"
     const char *r_anal_data_kind(RAnal *a, 
# 338 "project/radare2/libr/anal/data.c" 3 4
                                            unsigned long long 
# 338 "project/radare2/libr/anal/data.c"
                                                 addr, const 
...
# 401 "project/radare2/libr/anal/data.c" 3 4
__attribute__((visibility("default"))) 
# 401 "project/radare2/libr/anal/data.c"
     const char *r_anal_datatype_to_string(RAnalDataType t) {
 switch (t) {
 case R_ANAL_DATATYPE_NULL:
  return 
# 404 "project/radare2/libr/anal/data.c" 3 4
        ((void *)0)
# 404 "project/radare2/libr/anal/data.c"
            ;
 ...
 return 
# 424 "project/radare2/libr/anal/data.c" 3 4
       ((void *)0)
# 424 "project/radare2/libr/anal/data.c"
           ;
}
