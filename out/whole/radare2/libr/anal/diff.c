# 0 "project/radare2/libr/anal/diff.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/diff.c"
...
# 4 "project/radare2/libr/anal/diff.c" 2


__attribute__((visibility("default"))) 
# 6 "project/radare2/libr/anal/diff.c"
     RAnalDiff *r_anal_diff_new(void) {
 RAnalDiff *diff = 
# 7 "project/radare2/libr/anal/diff.c" 3 4
                  (
# 7 "project/radare2/libr/anal/diff.c"
                  RAnalDiff
# 7 "project/radare2/libr/anal/diff.c" 3 4
                  *)calloc(1,sizeof(
# 7 "project/radare2/libr/anal/diff.c"
...
# 7 "project/radare2/libr/anal/diff.c"
 ...
 if (diff) {
  ...
  diff->addr = 
# 10 "project/radare2/libr/anal/diff.c" 3 4
              0xFFFFFFFFFFFFFFFFULL
# 10 "project/radare2/libr/anal/diff.c"
                      ;
  diff->dist = 0;
  diff->name = 
# 12 "project/radare2/libr/anal/diff.c" 3 4
              ((void *)0)
# 12 "project/radare2/libr/anal/diff.c"
                  ;
  diff->size = 0;
 }
 return diff;
...
# 18 "project/radare2/libr/anal/diff.c" 3 4
__attribute__((visibility("default"))) 
# 18 "project/radare2/libr/anal/diff.c"
     void r_anal_diff_free(RAnalDiff *diff) {
 if (diff) {
  free (diff->name);
  free (diff);
 }
...
# 26 "project/radare2/libr/anal/diff.c" 3 4
__attribute__((visibility("default"))) 
# 26 "project/radare2/libr/anal/diff.c"
     void r_anal_diff_setup(RAnal *anal, int doops, double thbb, double thfcn) {
 if (doops >= 0) {
  anal->diff_ops = doops;
 }
 anal->diff_thbb = (thbb>=0)? thbb: 
# 30 "project/radare2/libr/anal/diff.c" 3 4
                                   0.7F
# 30 "project/radare2/libr/anal/diff.c"
                                                     ;
 anal->diff_thfcn = (thfcn>=0)? thfcn: 
# 31 "project/radare2/libr/anal/diff.c" 3 4
                                      0.7F
# 31 "project/radare2/libr/anal/diff.c"
                                                         ;
}



# 35 "project/radare2/libr/anal/diff.c" 3 4
__attribute__((visibility("default"))) 
# 35 "project/radare2/libr/anal/diff.c"
     void r_anal_diff_setup_i(RAnal *anal, int doops, int thbb, int thfcn) {
 if (doops >= 0) {
  anal->diff_ops = doops;
 }
 anal->diff_thbb = (thbb>=0)? ((double)thbb) / 100: 
# 39 "project/radare2/libr/anal/diff.c" 3 4
                                                   0.7F
# 39 "project/radare2/libr/anal/diff.c"
                                                                     ;
 anal->diff_thfcn = (thfcn>=0)? ((double)thfcn) / 100: 
# 40 "project/radare2/libr/anal/diff.c" 3 4
                                                      0.7F
# 40 "project/radare2/libr/anal/diff.c"
                                                                         ;
}



# 44 "project/radare2/libr/anal/diff.c" 3 4
__attribute__((visibility("default"))) 
# 44 "project/radare2/libr/anal/diff.c"
     int r_anal_diff_fingerprint_bb(RAnal *anal, RAnalBlock *bb) {
 RAnalOp *op;
 
# 46 "project/radare2/libr/anal/diff.c" 3 4
unsigned char 
# 46 "project/radare2/libr/anal/diff.c"
    *buf;
 int oplen, idx = 0;

 if (!anal) {
  return 
# 50 "project/radare2/libr/anal/diff.c" 3 4
        0
# 50 "project/radare2/libr/anal/diff.c"
             ;
 }
 ...
 if (!(bb->fingerprint = malloc (1 + bb->size))) {
  return 
# 56 "project/radare2/libr/anal/diff.c" 3 4
        0
# 56 "project/radare2/libr/anal/diff.c"
             ;
 }
 if (!(buf = malloc (bb->size + 1))) {
  free (bb->fingerprint);
  return 
# 60 "project/radare2/libr/anal/diff.c" 3 4
        0
# 60 "project/radare2/libr/anal/diff.c"
             ;
 }
 if (anal->iob.read_at (anal->iob.io, bb->addr, buf, bb->size)) {
  
# 63 "project/radare2/libr/anal/diff.c" 3 4
 __builtin___memcpy_chk (
# 63 "project/radare2/libr/anal/diff.c"
 bb->fingerprint
# 63 "project/radare2/libr/anal/diff.c" 3 4
 , 
# 63 "project/radare2/libr/anal/diff.c"
...
# 63 "project/radare2/libr/anal/diff.c"
  ...
  if (anal->diff_ops) {
   if (!(op = r_anal_op_new ())) {
    ...
    free (buf);
    return 
# 68 "project/radare2/libr/anal/diff.c" 3 4
          0
# 68 "project/radare2/libr/anal/diff.c"
               ;
   }
   while (idx < bb->size) {
...
# 75 "project/radare2/libr/anal/diff.c" 3 4
    __builtin___memset_chk (
# 75 "project/radare2/libr/anal/diff.c"
    bb->fingerprint+idx+op->nopcode
# 75 "project/radare2/libr/anal/diff.c" 3 4
    , 
# 75 "project/radare2/libr/anal/diff.c"
    0, oplen-op->nopcode
...
# 98 "project/radare2/libr/anal/diff.c" 3 4
__attribute__((visibility("default"))) 
# 98 "project/radare2/libr/anal/diff.c"
     size_t r_anal_diff_fingerprint_fcn(RAnal *anal, RAnalFunction *fcn) {
 RAnalBlock *bb;
 RListIter *iter;
 ...
 fcn->fingerprint = 
# 106 "project/radare2/libr/anal/diff.c" 3 4
                   ((void *)0)
# 106 "project/radare2/libr/anal/diff.c"
                       ;
 fcn->fingerprint_size = 0;
 r_list_sort (fcn->bbs, &bb_sort_by_addr);
 
# 109 "project/radare2/libr/anal/diff.c" 3 4
if (
# 109 "project/radare2/libr/anal/diff.c"
fcn->bbs
# 109 "project/radare2/libr/anal/diff.c" 3 4
) for (
# 109 "project/radare2/libr/anal/diff.c"
...
# 115 "project/radare2/libr/anal/diff.c" 3 4
 __builtin___memcpy_chk (
# 115 "project/radare2/libr/anal/diff.c"
 fcn->fingerprint + fcn->fingerprint_size - bb->size
# 115 "project/radare2/libr/anal/diff.c" 3 4
 , 
# 115 "project/radare2/libr/anal/diff.c"
 bb->fingerprint, bb->size
# 115 "project/radare2/libr/anal/diff.c" 3 4
 , __builtin_object_size (
# 115 "project/radare2/libr/anal/diff.c"
 fcn->fingerprint + fcn->fingerprint_size - bb->size
...
# 120 "project/radare2/libr/anal/diff.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 120 "project/radare2/libr/anal/diff.c"
          r_anal_diff_bb(RAnal *anal, RAnalFunction *fcn, RAnalFunction *fcn2) {
 ...
 if (!anal || !fcn || !fcn2) {
  return 
# 126 "project/radare2/libr/anal/diff.c" 3 4
        0
# 126 "project/radare2/libr/anal/diff.c"
             ;
 }
...
# 133 "project/radare2/libr/anal/diff.c" 3 4
if (
# 133 "project/radare2/libr/anal/diff.c"
fcn->bbs
# 133 "project/radare2/libr/anal/diff.c" 3 4
) for (
# 133 "project/radare2/libr/anal/diff.c"
...
# 133 "project/radare2/libr/anal/diff.c"
  ...
  ot = 0;
  mbb = mbb2 = 
# 138 "project/radare2/libr/anal/diff.c" 3 4
              ((void *)0)
# 138 "project/radare2/libr/anal/diff.c"
                  ;
  r_list_sort (fcn2->bbs, &bb_sort_by_addr);
  
# 140 "project/radare2/libr/anal/diff.c" 3 4
 if (
# 140 "project/radare2/libr/anal/diff.c"
 fcn2->bbs
# 140 "project/radare2/libr/anal/diff.c" 3 4
 ) for (
# 140 "project/radare2/libr/anal/diff.c"
...
# 142 "project/radare2/libr/anal/diff.c" 3 4
                            ((void *)0)
# 142 "project/radare2/libr/anal/diff.c"
                                , bb->fingerprint, bb->size,
      bb2->fingerprint, bb2->size, 
# 143 "project/radare2/libr/anal/diff.c" 3 4
                                  ((void *)0)
# 143 "project/radare2/libr/anal/diff.c"
                                      , &t);
  ...
  if (mbb && mbb2) {
   ...
   if (!mbb->diff || !mbb2->diff) {
    return 
# 162 "project/radare2/libr/anal/diff.c" 3 4
          0
# 162 "project/radare2/libr/anal/diff.c"
               ;
   }
...
# 171 "project/radare2/libr/anal/diff.c" 3 4
  { free((void *)
# 171 "project/radare2/libr/anal/diff.c"
  mbb->fingerprint
# 171 "project/radare2/libr/anal/diff.c" 3 4
  ); 
# 171 "project/radare2/libr/anal/diff.c"
...
# 172 "project/radare2/libr/anal/diff.c" 3 4
  { free((void *)
# 172 "project/radare2/libr/anal/diff.c"
  mbb2->fingerprint
# 172 "project/radare2/libr/anal/diff.c" 3 4
  ); 
# 172 "project/radare2/libr/anal/diff.c"
...
# 172 "project/radare2/libr/anal/diff.c"
 ...
 return 
# 183 "project/radare2/libr/anal/diff.c" 3 4
       1
# 183 "project/radare2/libr/anal/diff.c"
           ;
}


# 186 "project/radare2/libr/anal/diff.c" 3 4
__attribute__((visibility("default"))) 
# 186 "project/radare2/libr/anal/diff.c"
     int r_anal_diff_fcn(RAnal *anal, RList *fcns, RList *fcns2) {
 RAnalFunction *fcn, *fcn2, *mfcn, *mfcn2;
 RListIter *iter, *iter2;
 
# 189 "project/radare2/libr/anal/diff.c" 3 4
unsigned long long 
# 189 "project/radare2/libr/anal/diff.c"
     maxsize, minsize;
 double t, ot;

 if (!anal) {
  return 
# 193 "project/radare2/libr/anal/diff.c" 3 4
        0
# 193 "project/radare2/libr/anal/diff.c"
             ;
 }
...
# 200 "project/radare2/libr/anal/diff.c" 3 4
 if (
# 200 "project/radare2/libr/anal/diff.c"
 fcns
# 200 "project/radare2/libr/anal/diff.c" 3 4
 ) for (
# 200 "project/radare2/libr/anal/diff.c"
...
# 201 "project/radare2/libr/anal/diff.c" 3 4
  if (
# 201 "project/radare2/libr/anal/diff.c"
  fcns2
# 201 "project/radare2/libr/anal/diff.c" 3 4
  ) for (
# 201 "project/radare2/libr/anal/diff.c"
...
# 201 "project/radare2/libr/anal/diff.c"
    ...
    r_diff_buffers_distance (
# 205 "project/radare2/libr/anal/diff.c" 3 4
                            ((void *)0)
# 205 "project/radare2/libr/anal/diff.c"
                                , fcn->fingerprint, fcn->fingerprint_size,
      fcn2->fingerprint, fcn2->fingerprint_size,
      
# 207 "project/radare2/libr/anal/diff.c" 3 4
     ((void *)0)
# 207 "project/radare2/libr/anal/diff.c"
         , &t);
...
# 213 "project/radare2/libr/anal/diff.c" 3 4
   { free((void *)
# 213 "project/radare2/libr/anal/diff.c"
   fcn->fingerprint
# 213 "project/radare2/libr/anal/diff.c" 3 4
   ); 
# 213 "project/radare2/libr/anal/diff.c"
...
# 214 "project/radare2/libr/anal/diff.c" 3 4
   { free((void *)
# 214 "project/radare2/libr/anal/diff.c"
   fcn2->fingerprint
# 214 "project/radare2/libr/anal/diff.c" 3 4
   ); 
# 214 "project/radare2/libr/anal/diff.c"
...
# 219 "project/radare2/libr/anal/diff.c" 3 4
   { free((void *)
# 219 "project/radare2/libr/anal/diff.c"
   fcn->diff->name
# 219 "project/radare2/libr/anal/diff.c" 3 4
   ); 
# 219 "project/radare2/libr/anal/diff.c"
...
# 223 "project/radare2/libr/anal/diff.c" 3 4
   { free((void *)
# 223 "project/radare2/libr/anal/diff.c"
   fcn2->diff->name
# 223 "project/radare2/libr/anal/diff.c" 3 4
   ); 
# 223 "project/radare2/libr/anal/diff.c"
...
# 233 "project/radare2/libr/anal/diff.c" 3 4
if (
# 233 "project/radare2/libr/anal/diff.c"
fcns
# 233 "project/radare2/libr/anal/diff.c" 3 4
) for (
# 233 "project/radare2/libr/anal/diff.c"
...
# 233 "project/radare2/libr/anal/diff.c"
  ...
  ot = 0;
  mfcn = mfcn2 = 
# 245 "project/radare2/libr/anal/diff.c" 3 4
                ((void *)0)
# 245 "project/radare2/libr/anal/diff.c"
                    ;
  
# 246 "project/radare2/libr/anal/diff.c" 3 4
 if (
# 246 "project/radare2/libr/anal/diff.c"
 fcns2
# 246 "project/radare2/libr/anal/diff.c" 3 4
 ) for (
# 246 "project/radare2/libr/anal/diff.c"
...
# 247 "project/radare2/libr/anal/diff.c" 3 4
  unsigned long long 
# 247 "project/radare2/libr/anal/diff.c"
       fcn_size = r_anal_function_linear_size (fcn);
   
# 248 "project/radare2/libr/anal/diff.c" 3 4
  unsigned long long 
# 248 "project/radare2/libr/anal/diff.c"
       fcn2_size = r_anal_function_linear_size (fcn2);
...
# 257 "project/radare2/libr/anal/diff.c" 3 4
   fprintf(__stderrp,
# 257 "project/radare2/libr/anal/diff.c"
   "Exceeded anal threshold while diffing %s and %s\n", fcn->name, fcn2->name
# 257 "project/radare2/libr/anal/diff.c" 3 4
   )
# 257 "project/radare2/libr/anal/diff.c"
                                                                                       ;
...
# 261 "project/radare2/libr/anal/diff.c" 3 4
   fprintf(__stderrp,
# 261 "project/radare2/libr/anal/diff.c"
   "Function %s already diffed\n", fcn2->name
# 261 "project/radare2/libr/anal/diff.c" 3 4
   )
# 261 "project/radare2/libr/anal/diff.c"
                                                       ;
...
# 265 "project/radare2/libr/anal/diff.c" 3 4
   fprintf(__stderrp,
# 265 "project/radare2/libr/anal/diff.c"
   "Function %s type not supported\n", fcn2->name
# 265 "project/radare2/libr/anal/diff.c" 3 4
   )
# 265 "project/radare2/libr/anal/diff.c"
                                                           ;
   ...
   r_diff_buffers_distance (
# 268 "project/radare2/libr/anal/diff.c" 3 4
                           ((void *)0)
# 268 "project/radare2/libr/anal/diff.c"
...
# 284 "project/radare2/libr/anal/diff.c" 3 4
  { free((void *)
# 284 "project/radare2/libr/anal/diff.c"
  mfcn->fingerprint
# 284 "project/radare2/libr/anal/diff.c" 3 4
  ); 
# 284 "project/radare2/libr/anal/diff.c"
...
# 285 "project/radare2/libr/anal/diff.c" 3 4
  { free((void *)
# 285 "project/radare2/libr/anal/diff.c"
  mfcn2->fingerprint
# 285 "project/radare2/libr/anal/diff.c" 3 4
  ); 
# 285 "project/radare2/libr/anal/diff.c"
...
# 290 "project/radare2/libr/anal/diff.c" 3 4
  { free((void *)
# 290 "project/radare2/libr/anal/diff.c"
  mfcn->diff->name
# 290 "project/radare2/libr/anal/diff.c" 3 4
  ); 
# 290 "project/radare2/libr/anal/diff.c"
...
# 294 "project/radare2/libr/anal/diff.c" 3 4
  { free((void *)
# 294 "project/radare2/libr/anal/diff.c"
  mfcn2->diff->name
# 294 "project/radare2/libr/anal/diff.c" 3 4
  ); 
# 294 "project/radare2/libr/anal/diff.c"
...
# 294 "project/radare2/libr/anal/diff.c"
 ...
 return 
# 301 "project/radare2/libr/anal/diff.c" 3 4
       1
# 301 "project/radare2/libr/anal/diff.c"
           ;
}


# 304 "project/radare2/libr/anal/diff.c" 3 4
__attribute__((visibility("default"))) 
# 304 "project/radare2/libr/anal/diff.c"
     int r_anal_diff_eval(RAnal *anal) {
 if (anal && anal->cur && anal->cur->diff_eval) {
  return (anal->cur->diff_eval (anal));
 }
 return 
# 308 "project/radare2/libr/anal/diff.c" 3 4
       1
# 308 "project/radare2/libr/anal/diff.c"
           ;
}
