# 0 "project/radare2/libr/anal/bb.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/bb.c"
...
# 4 "project/radare2/libr/anal/bb.c" 2


# 1 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include-fixed/limits.h" 1 3 4
# 7 "project/radare2/libr/anal/bb.c" 2


# 8 "project/radare2/libr/anal/bb.c"
typedef struct {
 
# 9 "project/radare2/libr/anal/bb.c" 3 4
unsigned long long 
# 9 "project/radare2/libr/anal/bb.c"
     addr;
 RAnalBlock *ret;
} BBFromOffsetJmpmidCtx;

static 
# 13 "project/radare2/libr/anal/bb.c" 3 4
      _Bool 
# 13 "project/radare2/libr/anal/bb.c"
           bb_from_offset_jmpmid_cb(RAnalBlock *block, void *user) {
 BBFromOffsetJmpmidCtx *ctx = user;

 if (r_anal_block_op_starts_at (block, ctx->addr)) {
  ctx->ret = block;
  return 
# 18 "project/radare2/libr/anal/bb.c" 3 4
        0
# 18 "project/radare2/libr/anal/bb.c"
             ;
 }
 ...
 return 
# 24 "project/radare2/libr/anal/bb.c" 3 4
       1
# 24 "project/radare2/libr/anal/bb.c"
           ;
}

static 
# 27 "project/radare2/libr/anal/bb.c" 3 4
      _Bool 
# 27 "project/radare2/libr/anal/bb.c"
           bb_from_offset_first_cb(RAnalBlock *block, void *user) {
 RAnalBlock **ret = user;
 *ret = block;
 return 
# 30 "project/radare2/libr/anal/bb.c" 3 4
       0
# 30 "project/radare2/libr/anal/bb.c"
            ;
}


# 33 "project/radare2/libr/anal/bb.c" 3 4
__attribute__((visibility("default"))) 
# 33 "project/radare2/libr/anal/bb.c"
     RAnalBlock *r_anal_bb_from_offset(RAnal *anal, 
# 33 "project/radare2/libr/anal/bb.c" 3 4
                                                    unsigned long long 
# 33 "project/radare2/libr/anal/bb.c"
                                                         off) {
 const 
# 34 "project/radare2/libr/anal/bb.c" 3 4
      _Bool 
# 34 "project/radare2/libr/anal/bb.c"
           x86 = anal->cur->arch && !strcmp (anal->cur->arch, "x86");
 if (anal->opt.jmpmid && x86) {
  BBFromOffsetJmpmidCtx ctx = { off, 
# 36 "project/radare2/libr/anal/bb.c" 3 4
                                    ((void *)0) 
# 36 "project/radare2/libr/anal/bb.c"
                                         };
 ...
 RAnalBlock *ret = 
# 41 "project/radare2/libr/anal/bb.c" 3 4
                  ((void *)0)
# 41 "project/radare2/libr/anal/bb.c"
                      ;
...
# 48 "project/radare2/libr/anal/bb.c" 3 4
__attribute__((visibility("default"))) unsigned short 
# 48 "project/radare2/libr/anal/bb.c"
          r_anal_bb_offset_inst(const RAnalBlock *bb, int i) {
 if (i < 0 || i >= bb->ninstr) {
  return 
# 50 "project/radare2/libr/anal/bb.c" 3 4
        0xFFFFU
# 50 "project/radare2/libr/anal/bb.c"
                ;
 }
...
# 57 "project/radare2/libr/anal/bb.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 57 "project/radare2/libr/anal/bb.c"
          r_anal_bb_opaddr_i(RAnalBlock *bb, int i) {
 
# 58 "project/radare2/libr/anal/bb.c" 3 4
unsigned short 
# 58 "project/radare2/libr/anal/bb.c"
     offset = r_anal_bb_offset_inst (bb, i);
 if (offset == 
# 59 "project/radare2/libr/anal/bb.c" 3 4
              0xFFFFU
# 59 "project/radare2/libr/anal/bb.c"
                      ) {
  return 
# 60 "project/radare2/libr/anal/bb.c" 3 4
        0xFFFFFFFFFFFFFFFFULL
# 60 "project/radare2/libr/anal/bb.c"
                ;
 }
...
# 66 "project/radare2/libr/anal/bb.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 66 "project/radare2/libr/anal/bb.c"
          r_anal_bb_set_offset(RAnalBlock *bb, int i, 
# 66 "project/radare2/libr/anal/bb.c" 3 4
                                                      unsigned short 
# 66 "project/radare2/libr/anal/bb.c"
                                                           v) {
...
# 71 "project/radare2/libr/anal/bb.c" 3 4
  unsigned short 
# 71 "project/radare2/libr/anal/bb.c"
       *tmp_op_pos = realloc (bb->op_pos, new_pos_size * sizeof (*bb->op_pos));
   if (!tmp_op_pos) {
    return 
# 73 "project/radare2/libr/anal/bb.c" 3 4
          0
# 73 "project/radare2/libr/anal/bb.c"
               ;
   }
  ...
  bb->op_pos[i - 1] = v;
  return 
# 79 "project/radare2/libr/anal/bb.c" 3 4
        1
# 79 "project/radare2/libr/anal/bb.c"
            ;
 }
 return 
# 81 "project/radare2/libr/anal/bb.c" 3 4
       1
# 81 "project/radare2/libr/anal/bb.c"
           ;
}
...
# 86 "project/radare2/libr/anal/bb.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 86 "project/radare2/libr/anal/bb.c"
          r_anal_bb_opaddr_at(RAnalBlock *bb, 
# 86 "project/radare2/libr/anal/bb.c" 3 4
                                              unsigned long long 
# 86 "project/radare2/libr/anal/bb.c"
                                                   off) {
 
# 87 "project/radare2/libr/anal/bb.c" 3 4
unsigned short 
# 87 "project/radare2/libr/anal/bb.c"
     delta, delta_off, last_delta;
 int i;

 if (!r_anal_block_contains (bb, off)) {
  return 
# 91 "project/radare2/libr/anal/bb.c" 3 4
        0xFFFFFFFFFFFFFFFFULL
# 91 "project/radare2/libr/anal/bb.c"
                ;
 }
 last_delta = 0;
...
# 106 "project/radare2/libr/anal/bb.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 106 "project/radare2/libr/anal/bb.c"
          r_anal_bb_size_i(RAnalBlock *bb, int i) {
 if (i < 0 || i >= bb->ninstr) {
  return 
# 108 "project/radare2/libr/anal/bb.c" 3 4
        0xFFFFFFFFFFFFFFFFULL
# 108 "project/radare2/libr/anal/bb.c"
                ;
 }
 
# 110 "project/radare2/libr/anal/bb.c" 3 4
unsigned short 
# 110 "project/radare2/libr/anal/bb.c"
     idx_cur = r_anal_bb_offset_inst (bb, i);
 
# 111 "project/radare2/libr/anal/bb.c" 3 4
unsigned short 
# 111 "project/radare2/libr/anal/bb.c"
     idx_next = r_anal_bb_offset_inst (bb, i + 1);
 return idx_next != 
# 112 "project/radare2/libr/anal/bb.c" 3 4
                   0xFFFFU
# 112 "project/radare2/libr/anal/bb.c"
                           ? idx_next - idx_cur: bb->size - idx_cur;
}




# 117 "project/radare2/libr/anal/bb.c" 3 4
__attribute__((visibility("default"))) unsigned long long 
# 117 "project/radare2/libr/anal/bb.c"
          r_anal_get_bbaddr(RAnal *anal, 
# 117 "project/radare2/libr/anal/bb.c" 3 4
                                         unsigned long long 
# 117 "project/radare2/libr/anal/bb.c"
                                              addr) {
 ...
 return bb? bb->addr: 
# 119 "project/radare2/libr/anal/bb.c" 3 4
                     0xFFFFFFFFFFFFFFFFULL
# 119 "project/radare2/libr/anal/bb.c"
                             ;
}
