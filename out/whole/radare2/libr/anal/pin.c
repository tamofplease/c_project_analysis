# 0 "project/radare2/libr/anal/pin.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/anal/pin.c" 2


# 5 "project/radare2/libr/anal/pin.c"
typedef void (*RAnalEsilPin)(RAnal *a);
# 29 "project/radare2/libr/anal/pin.c"
#define DB a->sdb_pins


# 31 "project/radare2/libr/anal/pin.c" 3 4
__attribute__((visibility("default"))) 
# 31 "project/radare2/libr/anal/pin.c"
     void r_anal_pin_init(RAnal *a) {
 sdb_free (a->sdb_pins);
 a->sdb_pins = sdb_new0();
...
# 38 "project/radare2/libr/anal/pin.c" 3 4
__attribute__((visibility("default"))) 
# 38 "project/radare2/libr/anal/pin.c"
     void r_anal_pin_fini(RAnal *a) {
 if (sdb_free (a->sdb_pins)) {
  a->sdb_pins = 
# 40 "project/radare2/libr/anal/pin.c" 3 4
      ((void *)0)
# 40 "project/radare2/libr/anal/pin.c"
          ;
 }
}


# 44 "project/radare2/libr/anal/pin.c" 3 4
__attribute__((visibility("default"))) 
# 44 "project/radare2/libr/anal/pin.c"
     void r_anal_pin(RAnal *a, 
# 44 "project/radare2/libr/anal/pin.c" 3 4
                               unsigned long long 
# 44 "project/radare2/libr/anal/pin.c"
 ...
 sdb_set (a->sdb_pins, key, name, 0);
}


# 50 "project/radare2/libr/anal/pin.c" 3 4
__attribute__((visibility("default"))) 
# 50 "project/radare2/libr/anal/pin.c"
     void r_anal_pin_unset(RAnal *a, 
# 50 "project/radare2/libr/anal/pin.c" 3 4
                                     unsigned long long 
# 50 "project/radare2/libr/anal/pin.c"
                                          addr) {
 char buf[64];
 const char *key = sdb_itoa (addr, buf, 16);
 sdb_unset (a->sdb_pins, key, 0);
}


# 56 "project/radare2/libr/anal/pin.c" 3 4
__attribute__((visibility("default"))) 
# 56 "project/radare2/libr/anal/pin.c"
     const char *r_anal_pin_call(RAnal *a, 
# 56 "project/radare2/libr/anal/pin.c" 3 4
                                           unsigned long long 
# 56 "project/radare2/libr/anal/pin.c"
                                                addr) {
 ...
 const char *key = sdb_itoa (addr, buf, 16);
 if (key) {
  const char *name = sdb_const_get (a->sdb_pins, key, 
# 60 "project/radare2/libr/anal/pin.c" 3 4
                                            ((void *)0)
# 60 "project/radare2/libr/anal/pin.c"
                                                );
  ...
  return name;
# 79 "project/radare2/libr/anal/pin.c"
 }
 return 
# 80 "project/radare2/libr/anal/pin.c" 3 4
       ((void *)0)
# 80 "project/radare2/libr/anal/pin.c"
           ;
}

static 
# 83 "project/radare2/libr/anal/pin.c" 3 4
      _Bool 
# 83 "project/radare2/libr/anal/pin.c"
           cb_list(void *user, const char *k, const char *v) {
 RAnal *a = (RAnal*)user;
 if (*k == '0') {
 ...
 return 
# 93 "project/radare2/libr/anal/pin.c" 3 4
       1
# 93 "project/radare2/libr/anal/pin.c"
           ;
}


# 96 "project/radare2/libr/anal/pin.c" 3 4
__attribute__((visibility("default"))) 
# 96 "project/radare2/libr/anal/pin.c"
     void r_anal_pin_list(RAnal *a) {
 sdb_foreach (a->sdb_pins, cb_list, a);
}
