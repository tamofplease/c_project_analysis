# 0 "project/radare2/libr/anal/esil_plugin.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/esil_plugin.c"
...
# 4 "project/radare2/libr/anal/esil_plugin.c" 2

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/sdb/src/config.h" 1 3 4
# 6 "project/radare2/libr/anal/esil_plugin.c" 2
...
# 7 "project/radare2/libr/anal/esil_plugin.c" 2


# 8 "project/radare2/libr/anal/esil_plugin.c"
static RAnalEsilPlugin *esil_static_plugins[] = {
 &r_esil_plugin_dummy, 0
};


# 12 "project/radare2/libr/anal/esil_plugin.c" 3 4
__attribute__((visibility("default"))) 
# 12 "project/radare2/libr/anal/esil_plugin.c"
     void r_anal_esil_plugins_init(RAnalEsil *esil) {
 
# 13 "project/radare2/libr/anal/esil_plugin.c" 3 4
do { if (!(
# 13 "project/radare2/libr/anal/esil_plugin.c"
esil
# 13 "project/radare2/libr/anal/esil_plugin.c" 3 4
...
# 23 "project/radare2/libr/anal/esil_plugin.c" 3 4
__attribute__((visibility("default"))) 
# 23 "project/radare2/libr/anal/esil_plugin.c"
     void r_anal_esil_plugins_fini(RAnalEsil *esil) {
 
# 24 "project/radare2/libr/anal/esil_plugin.c" 3 4
do { if (!(
# 24 "project/radare2/libr/anal/esil_plugin.c"
esil
# 24 "project/radare2/libr/anal/esil_plugin.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 24 "project/radare2/libr/anal/esil_plugin.c"
...
# 24 "project/radare2/libr/anal/esil_plugin.c"
 ...
 esil->active_plugins = 
# 35 "project/radare2/libr/anal/esil_plugin.c" 3 4
                       ((void *)0)
# 35 "project/radare2/libr/anal/esil_plugin.c"
                           ;
 esil->plugins = 
# 36 "project/radare2/libr/anal/esil_plugin.c" 3 4
                ((void *)0)
# 36 "project/radare2/libr/anal/esil_plugin.c"
                    ;
}


# 39 "project/radare2/libr/anal/esil_plugin.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 39 "project/radare2/libr/anal/esil_plugin.c"
          r_anal_esil_plugin_add(RAnalEsil *esil, RAnalEsilPlugin *plugin) {
 
# 40 "project/radare2/libr/anal/esil_plugin.c" 3 4
do { if (!(
# 40 "project/radare2/libr/anal/esil_plugin.c"
esil && esil->plugins && plugin
# 40 "project/radare2/libr/anal/esil_plugin.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 40 "project/radare2/libr/anal/esil_plugin.c"
"esil && esil->plugins && plugin"
...
# 40 "project/radare2/libr/anal/esil_plugin.c"
 ...
 return 
# 42 "project/radare2/libr/anal/esil_plugin.c" 3 4
       1
# 42 "project/radare2/libr/anal/esil_plugin.c"
           ;
}
...
# 48 "project/radare2/libr/anal/esil_plugin.c" 3 4
if (
# 48 "project/radare2/libr/anal/esil_plugin.c"
esil->active_plugins
# 48 "project/radare2/libr/anal/esil_plugin.c" 3 4
) for (
# 48 "project/radare2/libr/anal/esil_plugin.c"
...
# 48 "project/radare2/libr/anal/esil_plugin.c"
 ...
 return 
# 53 "project/radare2/libr/anal/esil_plugin.c" 3 4
       ((void *)0)
# 53 "project/radare2/libr/anal/esil_plugin.c"
           ;
}


# 56 "project/radare2/libr/anal/esil_plugin.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 56 "project/radare2/libr/anal/esil_plugin.c"
          r_anal_esil_plugin_activate(RAnalEsil *esil, const char *name) {
 
# 57 "project/radare2/libr/anal/esil_plugin.c" 3 4
do { if (!(
# 57 "project/radare2/libr/anal/esil_plugin.c"
esil && esil->plugins && esil->active_plugins && name
# 57 "project/radare2/libr/anal/esil_plugin.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 57 "project/radare2/libr/anal/esil_plugin.c"
"esil && esil->plugins && esil->active_plugins && name"
...
# 58 "project/radare2/libr/anal/esil_plugin.c"
                                       ;

 if (_get_active_plugin (esil, name)) {
  return 
# 61 "project/radare2/libr/anal/esil_plugin.c" 3 4
        0
# 61 "project/radare2/libr/anal/esil_plugin.c"
             ;
 }
 RListIter *iter;
 RAnalEsilPlugin *ep;
 
# 65 "project/radare2/libr/anal/esil_plugin.c" 3 4
if (
# 65 "project/radare2/libr/anal/esil_plugin.c"
esil->plugins
# 65 "project/radare2/libr/anal/esil_plugin.c" 3 4
) for (
# 65 "project/radare2/libr/anal/esil_plugin.c"
...
# 65 "project/radare2/libr/anal/esil_plugin.c"
  ...
  if (!strcmp(ep->name, name)) {
   RAnalEsilActivePlugin *eap = 
# 67 "project/radare2/libr/anal/esil_plugin.c" 3 4
                               (
# 67 "project/radare2/libr/anal/esil_plugin.c"
                               RAnalEsilActivePlugin
# 67 "project/radare2/libr/anal/esil_plugin.c" 3 4
                               *)malloc(sizeof(
# 67 "project/radare2/libr/anal/esil_plugin.c"
...
# 67 "project/radare2/libr/anal/esil_plugin.c"
   ...
   if (!eap) {
    return 
# 69 "project/radare2/libr/anal/esil_plugin.c" 3 4
          0
# 69 "project/radare2/libr/anal/esil_plugin.c"
               ;
   }
   eap->plugin = ep;
   ...
   return 
# 74 "project/radare2/libr/anal/esil_plugin.c" 3 4
         1
# 74 "project/radare2/libr/anal/esil_plugin.c"
             ;
  }
 }
 return 
# 77 "project/radare2/libr/anal/esil_plugin.c" 3 4
       0
# 77 "project/radare2/libr/anal/esil_plugin.c"
            ;
}


# 80 "project/radare2/libr/anal/esil_plugin.c" 3 4
__attribute__((visibility("default"))) 
# 80 "project/radare2/libr/anal/esil_plugin.c"
     void r_anal_esil_plugin_deactivate(RAnalEsil *esil, const char *name) {
 
# 81 "project/radare2/libr/anal/esil_plugin.c" 3 4
do { if (!(
# 81 "project/radare2/libr/anal/esil_plugin.c"
esil && esil->active_plugins && name
# 81 "project/radare2/libr/anal/esil_plugin.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 81 "project/radare2/libr/anal/esil_plugin.c"
"esil && esil->active_plugins && name"
...
# 84 "project/radare2/libr/anal/esil_plugin.c" 3 4
if (
# 84 "project/radare2/libr/anal/esil_plugin.c"
esil->active_plugins
# 84 "project/radare2/libr/anal/esil_plugin.c" 3 4
) for (
# 84 "project/radare2/libr/anal/esil_plugin.c"
