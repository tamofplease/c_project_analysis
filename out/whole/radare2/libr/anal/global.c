# 0 "project/radare2/libr/anal/global.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/global.c"
...
# 4 "project/radare2/libr/anal/global.c" 2


#define GLOBAL_FLAGSPACE "globals"

__attribute__((visibility("default"))) 
# 8 "project/radare2/libr/anal/global.c"
     RFlagItem *r_anal_global_get(RAnal *anal, 
# 8 "project/radare2/libr/anal/global.c" 3 4
                                               unsigned long long 
# 8 "project/radare2/libr/anal/global.c"
                                                    addr) {
 RFlag *flags = anal->flb.f;
 RFlagItem *fi = r_flag_get_i (flags, addr);
 if (fi && fi->space && fi->space->name && !strcmp (fi->space->name, "globals")) {
  return fi;
 }
 return 
# 14 "project/radare2/libr/anal/global.c" 3 4
       ((void *)0)
# 14 "project/radare2/libr/anal/global.c"
           ;
}


# 17 "project/radare2/libr/anal/global.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 17 "project/radare2/libr/anal/global.c"
          r_anal_global_add(RAnal *anal, 
# 17 "project/radare2/libr/anal/global.c" 3 4
                                         unsigned long long 
# 17 "project/radare2/libr/anal/global.c"
                                              addr, const char *type_name, const char *name) {
 RFlag *flags = anal->flb.f;
 char *fmtstr = r_type_format (anal->sdb_types, type_name);
 if (!fmtstr) {
  
# 21 "project/radare2/libr/anal/global.c" 3 4
 fprintf(__stderrp,
# 21 "project/radare2/libr/anal/global.c"
 "Unknown type\n"
# 21 "project/radare2/libr/anal/global.c" 3 4
 )
# 21 "project/radare2/libr/anal/global.c"
                           ;
  return 
# 22 "project/radare2/libr/anal/global.c" 3 4
        0
# 22 "project/radare2/libr/anal/global.c"
             ;
 }
 ...
 RFlagItem *fi = r_flag_set_inspace (flags, "globals", name, addr, 1);
 if (fi) {
 ...
 return 
# 36 "project/radare2/libr/anal/global.c" 3 4
       1
# 36 "project/radare2/libr/anal/global.c"
           ;
}


# 39 "project/radare2/libr/anal/global.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 39 "project/radare2/libr/anal/global.c"
          r_anal_global_del(RAnal *anal, 
# 39 "project/radare2/libr/anal/global.c" 3 4
                                         unsigned long long 
# 39 "project/radare2/libr/anal/global.c"
                                              addr) {
 ...
 if (fi) {
  ...
  return 
# 46 "project/radare2/libr/anal/global.c" 3 4
        1
# 46 "project/radare2/libr/anal/global.c"
            ;
 }
 return 
# 48 "project/radare2/libr/anal/global.c" 3 4
       0
# 48 "project/radare2/libr/anal/global.c"
            ;
}


# 51 "project/radare2/libr/anal/global.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 51 "project/radare2/libr/anal/global.c"
          r_anal_global_retype(RAnal *anal, 
# 51 "project/radare2/libr/anal/global.c" 3 4
                                            unsigned long long 
# 51 "project/radare2/libr/anal/global.c"
                                                 addr, const char *new_type) {
 RFlagItem *fi = r_anal_global_get (anal, addr);
 if (fi) {
  r_flag_item_set_type (fi, new_type);
  return 
# 55 "project/radare2/libr/anal/global.c" 3 4
        1
# 55 "project/radare2/libr/anal/global.c"
            ;
 }
 return 
# 57 "project/radare2/libr/anal/global.c" 3 4
       0
# 57 "project/radare2/libr/anal/global.c"
            ;
}


# 60 "project/radare2/libr/anal/global.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 60 "project/radare2/libr/anal/global.c"
          r_anal_global_rename(RAnal *anal, 
# 60 "project/radare2/libr/anal/global.c" 3 4
                                            unsigned long long 
# 60 "project/radare2/libr/anal/global.c"
                                                 addr, const char *new_name) {
 RFlagItem *fi = r_anal_global_get (anal, addr);
 if (fi) {
  RFlag *flags = anal->flb.f;
  r_flag_rename (flags, fi, new_name);
  return 
# 65 "project/radare2/libr/anal/global.c" 3 4
        1
# 65 "project/radare2/libr/anal/global.c"
            ;
 }
 return 
# 67 "project/radare2/libr/anal/global.c" 3 4
       0
# 67 "project/radare2/libr/anal/global.c"
            ;
}


# 70 "project/radare2/libr/anal/global.c" 3 4
__attribute__((visibility("default"))) 
# 70 "project/radare2/libr/anal/global.c"
     const char *r_anal_global_get_type(RAnal *anal, 
# 70 "project/radare2/libr/anal/global.c" 3 4
                                                     unsigned long long 
# 70 "project/radare2/libr/anal/global.c"
                                                          addr) {
 ...
 return 
# 75 "project/radare2/libr/anal/global.c" 3 4
       ((void *)0)
# 75 "project/radare2/libr/anal/global.c"
           ;
}
