# 0 "project/radare2/libr/anal/esil_handler.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/esil_handler.c"
...
# 2 "project/radare2/libr/anal/esil_handler.c" 2




# 5 "project/radare2/libr/anal/esil_handler.c"
static 
# 5 "project/radare2/libr/anal/esil_handler.c" 3 4
      _Bool 
# 5 "project/radare2/libr/anal/esil_handler.c"
           _set_interrupt(RAnalEsil *esil, RAnalEsilHandler *intr, 
# 5 "project/radare2/libr/anal/esil_handler.c" 3 4
                                                                   unsigned int 
# 5 "project/radare2/libr/anal/esil_handler.c"
                                                                        intr_num) {
 return intr_num ? dict_set (esil->interrupts, intr_num, intr_num, intr) : (esil->intr0 = intr, 
# 6 "project/radare2/libr/anal/esil_handler.c" 3 4
                                                                                               1
# 6 "project/radare2/libr/anal/esil_handler.c"
                                                                                                   );
}

static 
# 9 "project/radare2/libr/anal/esil_handler.c" 3 4
      _Bool 
# 9 "project/radare2/libr/anal/esil_handler.c"
           _set_syscall(RAnalEsil *esil, RAnalEsilHandler *sysc, 
# 9 "project/radare2/libr/anal/esil_handler.c" 3 4
                                                                 unsigned int 
# 9 "project/radare2/libr/anal/esil_handler.c"
                                                                      sysc_num) {
 return sysc_num ? dict_set (esil->syscalls, sysc_num, sysc_num, sysc) : (esil->sysc0 = sysc, 
# 10 "project/radare2/libr/anal/esil_handler.c" 3 4
                                                                                             1
# 10 "project/radare2/libr/anal/esil_handler.c"
                                                                                                 );
}

static RAnalEsilHandler *_get_interrupt(RAnalEsil *esil, 
# 13 "project/radare2/libr/anal/esil_handler.c" 3 4
                                                        unsigned int 
# 13 "project/radare2/libr/anal/esil_handler.c"
                                                             intr_num) {
 return intr_num ? (RAnalEsilHandler *)dict_getu (esil->interrupts, intr_num) : esil->intr0;
}

static RAnalEsilHandler *_get_syscall(RAnalEsil *esil, 
# 17 "project/radare2/libr/anal/esil_handler.c" 3 4
                                                      unsigned int 
# 17 "project/radare2/libr/anal/esil_handler.c"
                                                           sysc_num) {
 return sysc_num ? (RAnalEsilHandler *)dict_getu (esil->syscalls, sysc_num) : esil->sysc0;
}


# 21 "project/radare2/libr/anal/esil_handler.c" 3 4
__attribute__((visibility("default"))) 
# 21 "project/radare2/libr/anal/esil_handler.c"
     void r_anal_esil_handlers_init(RAnalEsil *esil) {
 
# 22 "project/radare2/libr/anal/esil_handler.c" 3 4
do { if (!(
# 22 "project/radare2/libr/anal/esil_handler.c"
esil
# 22 "project/radare2/libr/anal/esil_handler.c" 3 4
...
# 22 "project/radare2/libr/anal/esil_handler.c"
                       ;
 esil->interrupts = dict_new (sizeof (
# 23 "project/radare2/libr/anal/esil_handler.c" 3 4
                                     unsigned int
# 23 "project/radare2/libr/anal/esil_handler.c"
                                         ), free);
 if (!esil->interrupts) {
  return;
 }
 esil->syscalls = dict_new (sizeof (
# 27 "project/radare2/libr/anal/esil_handler.c" 3 4
                                   unsigned int
# 27 "project/radare2/libr/anal/esil_handler.c"
                                       ), free);
 if (!esil->syscalls) {
 ...
 esil->intr0 = 
# 32 "project/radare2/libr/anal/esil_handler.c" 3 4
              ((void *)0)
# 32 "project/radare2/libr/anal/esil_handler.c"
                  ;
 esil->sysc0 = 
# 33 "project/radare2/libr/anal/esil_handler.c" 3 4
              ((void *)0)
# 33 "project/radare2/libr/anal/esil_handler.c"
                  ;
}



# 37 "project/radare2/libr/anal/esil_handler.c" 3 4
__attribute__((visibility("default"))) 
# 37 "project/radare2/libr/anal/esil_handler.c"
     RAnalEsilHandler *r_anal_esil_handler_new(RAnalEsilHandlerCB cb, void *user) {
 
# 38 "project/radare2/libr/anal/esil_handler.c" 3 4
do { if (!(
# 38 "project/radare2/libr/anal/esil_handler.c"
cb
# 38 "project/radare2/libr/anal/esil_handler.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 38 "project/radare2/libr/anal/esil_handler.c"
"cb"
# 38 "project/radare2/libr/anal/esil_handler.c" 3 4
, 38); return (((void *)0)); } } while (0)
# 38 "project/radare2/libr/anal/esil_handler.c"
                               ;
 RAnalEsilHandler *h = 
# 39 "project/radare2/libr/anal/esil_handler.c" 3 4
                      (
# 39 "project/radare2/libr/anal/esil_handler.c"
                      RAnalEsilHandler
# 39 "project/radare2/libr/anal/esil_handler.c" 3 4
                      *)calloc(1,sizeof(
# 39 "project/radare2/libr/anal/esil_handler.c"
...
# 39 "project/radare2/libr/anal/esil_handler.c"
 ...
 if (!h) {
  return 
# 41 "project/radare2/libr/anal/esil_handler.c" 3 4
        ((void *)0)
# 41 "project/radare2/libr/anal/esil_handler.c"
            ;
 }
 h->cb = cb;
 h->user = user;
...
# 48 "project/radare2/libr/anal/esil_handler.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 48 "project/radare2/libr/anal/esil_handler.c"
          r_anal_esil_set_interrupt(RAnalEsil *esil, 
# 48 "project/radare2/libr/anal/esil_handler.c" 3 4
                                                     unsigned int 
# 48 "project/radare2/libr/anal/esil_handler.c"
                                                          intr_num, RAnalEsilHandlerCB cb, void *user) {
 
# 49 "project/radare2/libr/anal/esil_handler.c" 3 4
do { if (!(
# 49 "project/radare2/libr/anal/esil_handler.c"
esil && esil->interrupts && cb
# 49 "project/radare2/libr/anal/esil_handler.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 49 "project/radare2/libr/anal/esil_handler.c"
"esil && esil->interrupts && cb"
...
# 49 "project/radare2/libr/anal/esil_handler.c"
 ...
 if (!intr) {
  return 
# 52 "project/radare2/libr/anal/esil_handler.c" 3 4
        0
# 52 "project/radare2/libr/anal/esil_handler.c"
             ;
 }
...
# 60 "project/radare2/libr/anal/esil_handler.c" 3 4
__attribute__((visibility("default"))) 
# 60 "project/radare2/libr/anal/esil_handler.c"
     RAnalEsilHandlerCB r_anal_esil_get_interrupt(RAnalEsil *esil, 
# 60 "project/radare2/libr/anal/esil_handler.c" 3 4
                                                                   unsigned int 
# 60 "project/radare2/libr/anal/esil_handler.c"
                                                                        intr_num) {
 
# 61 "project/radare2/libr/anal/esil_handler.c" 3 4
do { if (!(
# 61 "project/radare2/libr/anal/esil_handler.c"
esil && esil->interrupts
# 61 "project/radare2/libr/anal/esil_handler.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 61 "project/radare2/libr/anal/esil_handler.c"
"esil && esil->interrupts"
...
# 61 "project/radare2/libr/anal/esil_handler.c"
 ...
 return handler ? handler->cb : 
# 63 "project/radare2/libr/anal/esil_handler.c" 3 4
                               ((void *)0)
# 63 "project/radare2/libr/anal/esil_handler.c"
                                   ;
}


# 66 "project/radare2/libr/anal/esil_handler.c" 3 4
__attribute__((visibility("default"))) 
# 66 "project/radare2/libr/anal/esil_handler.c"
     void r_anal_esil_del_interrupt(RAnalEsil *esil, 
# 66 "project/radare2/libr/anal/esil_handler.c" 3 4
                                                     unsigned int 
# 66 "project/radare2/libr/anal/esil_handler.c"
                                                          intr_num) {
 
# 67 "project/radare2/libr/anal/esil_handler.c" 3 4
do { if (!(
# 67 "project/radare2/libr/anal/esil_handler.c"
esil && esil->interrupts
# 67 "project/radare2/libr/anal/esil_handler.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 67 "project/radare2/libr/anal/esil_handler.c"
...
# 69 "project/radare2/libr/anal/esil_handler.c" 3 4
 { free((void *)
# 69 "project/radare2/libr/anal/esil_handler.c"
 esil->intr0
# 69 "project/radare2/libr/anal/esil_handler.c" 3 4
 ); 
# 69 "project/radare2/libr/anal/esil_handler.c"
...
# 70 "project/radare2/libr/anal/esil_handler.c"
} else {
...
# 75 "project/radare2/libr/anal/esil_handler.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 75 "project/radare2/libr/anal/esil_handler.c"
          r_anal_esil_set_syscall(RAnalEsil *esil, 
# 75 "project/radare2/libr/anal/esil_handler.c" 3 4
                                                   unsigned int 
# 75 "project/radare2/libr/anal/esil_handler.c"
                                                        sysc_num, RAnalEsilHandlerCB cb, void *user) {
 
# 76 "project/radare2/libr/anal/esil_handler.c" 3 4
do { if (!(
# 76 "project/radare2/libr/anal/esil_handler.c"
esil && esil->syscalls && cb
# 76 "project/radare2/libr/anal/esil_handler.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 76 "project/radare2/libr/anal/esil_handler.c"
"esil && esil->syscalls && cb"
...
# 76 "project/radare2/libr/anal/esil_handler.c"
 ...
 if (!sysc) {
  return 
# 79 "project/radare2/libr/anal/esil_handler.c" 3 4
        0
# 79 "project/radare2/libr/anal/esil_handler.c"
             ;
 }
...
# 87 "project/radare2/libr/anal/esil_handler.c" 3 4
__attribute__((visibility("default"))) 
# 87 "project/radare2/libr/anal/esil_handler.c"
     RAnalEsilHandlerCB r_anal_esil_get_syscall(RAnalEsil *esil, 
# 87 "project/radare2/libr/anal/esil_handler.c" 3 4
                                                                 unsigned int 
# 87 "project/radare2/libr/anal/esil_handler.c"
                                                                      sysc_num) {
 
# 88 "project/radare2/libr/anal/esil_handler.c" 3 4
do { if (!(
# 88 "project/radare2/libr/anal/esil_handler.c"
esil && esil->syscalls
# 88 "project/radare2/libr/anal/esil_handler.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 88 "project/radare2/libr/anal/esil_handler.c"
"esil && esil->syscalls"
# 88 "project/radare2/libr/anal/esil_handler.c" 3 4
, 88); return (((void *)0)); } } while (0)
# 88 "project/radare2/libr/anal/esil_handler.c"
                                                   ;
 RAnalEsilHandler *handler = _get_syscall (esil, sysc_num);
 return handler ? handler->cb : 
# 90 "project/radare2/libr/anal/esil_handler.c" 3 4
                               ((void *)0)
# 90 "project/radare2/libr/anal/esil_handler.c"
                                   ;
}


# 93 "project/radare2/libr/anal/esil_handler.c" 3 4
__attribute__((visibility("default"))) 
# 93 "project/radare2/libr/anal/esil_handler.c"
     void r_anal_esil_del_syscall(RAnalEsil *esil, 
# 93 "project/radare2/libr/anal/esil_handler.c" 3 4
                                                   unsigned int 
# 93 "project/radare2/libr/anal/esil_handler.c"
                                                        sysc_num) {
 
# 94 "project/radare2/libr/anal/esil_handler.c" 3 4
do { if (!(
# 94 "project/radare2/libr/anal/esil_handler.c"
esil && esil->syscalls
# 94 "project/radare2/libr/anal/esil_handler.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 94 "project/radare2/libr/anal/esil_handler.c"
...
# 96 "project/radare2/libr/anal/esil_handler.c" 3 4
 { free((void *)
# 96 "project/radare2/libr/anal/esil_handler.c"
 esil->sysc0
# 96 "project/radare2/libr/anal/esil_handler.c" 3 4
 ); 
# 96 "project/radare2/libr/anal/esil_handler.c"
...
# 97 "project/radare2/libr/anal/esil_handler.c"
} else {
...
# 102 "project/radare2/libr/anal/esil_handler.c" 3 4
__attribute__((visibility("default"))) 
# 102 "project/radare2/libr/anal/esil_handler.c"
     int r_anal_esil_fire_interrupt(RAnalEsil *esil, 
# 102 "project/radare2/libr/anal/esil_handler.c" 3 4
                                                     unsigned int 
# 102 "project/radare2/libr/anal/esil_handler.c"
                                                          intr_num) {
 
# 103 "project/radare2/libr/anal/esil_handler.c" 3 4
do { if (!(
# 103 "project/radare2/libr/anal/esil_handler.c"
esil
# 103 "project/radare2/libr/anal/esil_handler.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 103 "project/radare2/libr/anal/esil_handler.c"
"esil"
# 103 "project/radare2/libr/anal/esil_handler.c" 3 4
, 103); return (0); } } while (0)
# 103 "project/radare2/libr/anal/esil_handler.c"
                                  ;

 if (esil->cmd && esil->cmd (esil, esil->cmd_intr, intr_num, 0)) {
  return 
# 106 "project/radare2/libr/anal/esil_handler.c" 3 4
        1
# 106 "project/radare2/libr/anal/esil_handler.c"
            ;
 }

 if (!esil->interrupts) {
  
# 110 "project/radare2/libr/anal/esil_handler.c" 3 4
 fprintf(__stderrp,
# 110 "project/radare2/libr/anal/esil_handler.c"
 "no interrupts initialized\n"
# 110 "project/radare2/libr/anal/esil_handler.c" 3 4
 )
# 110 "project/radare2/libr/anal/esil_handler.c"
                                        ;
  return 
# 111 "project/radare2/libr/anal/esil_handler.c" 3 4
        0
# 111 "project/radare2/libr/anal/esil_handler.c"
             ;
 }
 RAnalEsilHandler *intr = _get_interrupt (esil, intr_num);
 return (intr && intr->cb) ? intr->cb (esil, intr_num, intr->user) : 
# 114 "project/radare2/libr/anal/esil_handler.c" 3 4
                                                                    0
# 114 "project/radare2/libr/anal/esil_handler.c"
                                                                         ;
}


# 117 "project/radare2/libr/anal/esil_handler.c" 3 4
__attribute__((visibility("default"))) 
# 117 "project/radare2/libr/anal/esil_handler.c"
     int r_anal_esil_do_syscall(RAnalEsil *esil, 
# 117 "project/radare2/libr/anal/esil_handler.c" 3 4
                                                 unsigned int 
# 117 "project/radare2/libr/anal/esil_handler.c"
                                                      sysc_num) {
 
# 118 "project/radare2/libr/anal/esil_handler.c" 3 4
do { if (!(
# 118 "project/radare2/libr/anal/esil_handler.c"
esil
# 118 "project/radare2/libr/anal/esil_handler.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 118 "project/radare2/libr/anal/esil_handler.c"
"esil"
# 118 "project/radare2/libr/anal/esil_handler.c" 3 4
, 118); return (0); } } while (0)
# 118 "project/radare2/libr/anal/esil_handler.c"
                                  ;

 if (!esil->syscalls) {
  
# 121 "project/radare2/libr/anal/esil_handler.c" 3 4
 fprintf(__stderrp,
# 121 "project/radare2/libr/anal/esil_handler.c"
 "no syscalls initialized\n"
# 121 "project/radare2/libr/anal/esil_handler.c" 3 4
 )
# 121 "project/radare2/libr/anal/esil_handler.c"
                                      ;
  return 
# 122 "project/radare2/libr/anal/esil_handler.c" 3 4
        0
# 122 "project/radare2/libr/anal/esil_handler.c"
             ;
 }
 RAnalEsilHandler *sysc = _get_syscall (esil, sysc_num);
 return (sysc && sysc->cb) ? sysc->cb (esil, sysc_num, sysc->user) : 
# 125 "project/radare2/libr/anal/esil_handler.c" 3 4
                                                                    0
# 125 "project/radare2/libr/anal/esil_handler.c"
                                                                         ;
}


# 128 "project/radare2/libr/anal/esil_handler.c" 3 4
__attribute__((visibility("default"))) 
# 128 "project/radare2/libr/anal/esil_handler.c"
     void r_anal_esil_handlers_fini(RAnalEsil *esil) {
 if (esil) {
  if (esil->interrupts) {
   
# 131 "project/radare2/libr/anal/esil_handler.c" 3 4
  { free((void *)
# 131 "project/radare2/libr/anal/esil_handler.c"
  esil->intr0
# 131 "project/radare2/libr/anal/esil_handler.c" 3 4
  ); 
# 131 "project/radare2/libr/anal/esil_handler.c"
...
# 131 "project/radare2/libr/anal/esil_handler.c"
   ...
   dict_free (esil->interrupts);
   esil->interrupts = 
# 133 "project/radare2/libr/anal/esil_handler.c" 3 4
                     ((void *)0)
# 133 "project/radare2/libr/anal/esil_handler.c"
                         ;
  }
  if (esil->syscalls) {
   
# 136 "project/radare2/libr/anal/esil_handler.c" 3 4
  { free((void *)
# 136 "project/radare2/libr/anal/esil_handler.c"
  esil->sysc0
# 136 "project/radare2/libr/anal/esil_handler.c" 3 4
  ); 
# 136 "project/radare2/libr/anal/esil_handler.c"
...
# 136 "project/radare2/libr/anal/esil_handler.c"
   ...
   esil->syscalls = 
# 138 "project/radare2/libr/anal/esil_handler.c" 3 4
                   ((void *)0)
# 138 "project/radare2/libr/anal/esil_handler.c"
                       ;
  }
 }
}
