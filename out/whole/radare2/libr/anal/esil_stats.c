# 0 "project/radare2/libr/anal/esil_stats.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/anal/esil_stats.c"
...
# 4 "project/radare2/libr/anal/esil_stats.c" 2


# 5 "project/radare2/libr/anal/esil_stats.c"
static 
# 5 "project/radare2/libr/anal/esil_stats.c" 3 4
      _Bool 
# 5 "project/radare2/libr/anal/esil_stats.c"
           hook_flag_read(RAnalEsil *esil, const char *flag, 
# 5 "project/radare2/libr/anal/esil_stats.c" 3 4
                                                             unsigned long long 
# 5 "project/radare2/libr/anal/esil_stats.c"
                                                                  *num) {
 ...
 return 
# 7 "project/radare2/libr/anal/esil_stats.c" 3 4
       0
# 7 "project/radare2/libr/anal/esil_stats.c"
            ;
}

static 
# 10 "project/radare2/libr/anal/esil_stats.c" 3 4
      _Bool 
# 10 "project/radare2/libr/anal/esil_stats.c"
           hook_command(RAnalEsil *esil, const char *op) {
 sdb_array_add (esil->stats, "ops.list", op, 0);
 return 
# 12 "project/radare2/libr/anal/esil_stats.c" 3 4
       0
# 12 "project/radare2/libr/anal/esil_stats.c"
            ;
}

static 
# 15 "project/radare2/libr/anal/esil_stats.c" 3 4
      _Bool 
# 15 "project/radare2/libr/anal/esil_stats.c"
           hook_mem_read(RAnalEsil *esil, 
# 15 "project/radare2/libr/anal/esil_stats.c" 3 4
                                          unsigned long long 
# 15 "project/radare2/libr/anal/esil_stats.c"
                                               addr, 
...
# 15 "project/radare2/libr/anal/esil_stats.c"
 ...
 return 
# 17 "project/radare2/libr/anal/esil_stats.c" 3 4
       0
# 17 "project/radare2/libr/anal/esil_stats.c"
            ;
}

static 
# 20 "project/radare2/libr/anal/esil_stats.c" 3 4
      _Bool 
# 20 "project/radare2/libr/anal/esil_stats.c"
...
# 20 "project/radare2/libr/anal/esil_stats.c"
 ...
 return 
# 22 "project/radare2/libr/anal/esil_stats.c" 3 4
       0
# 22 "project/radare2/libr/anal/esil_stats.c"
            ;
}

static 
# 25 "project/radare2/libr/anal/esil_stats.c" 3 4
      _Bool 
# 25 "project/radare2/libr/anal/esil_stats.c"
           hook_reg_read(RAnalEsil *esil, const char *name, 
# 25 "project/radare2/libr/anal/esil_stats.c" 3 4
                                                            unsigned long long 
# 25 "project/radare2/libr/anal/esil_stats.c"
                                                                 *res, int *size) {
 ...
 return 
# 28 "project/radare2/libr/anal/esil_stats.c" 3 4
       0
# 28 "project/radare2/libr/anal/esil_stats.c"
            ;
}

static 
# 31 "project/radare2/libr/anal/esil_stats.c" 3 4
      _Bool 
# 31 "project/radare2/libr/anal/esil_stats.c"
           hook_reg_write(RAnalEsil *esil, const char *name, 
# 31 "project/radare2/libr/anal/esil_stats.c" 3 4
                                                             unsigned long long 
# 31 "project/radare2/libr/anal/esil_stats.c"
                                                                  *val) {
 ...
 return 
# 33 "project/radare2/libr/anal/esil_stats.c" 3 4
       0
# 33 "project/radare2/libr/anal/esil_stats.c"
            ;
}

static 
# 36 "project/radare2/libr/anal/esil_stats.c" 3 4
      _Bool 
# 36 "project/radare2/libr/anal/esil_stats.c"
           hook_NOP_mem_write(RAnalEsil *esil, 
# 36 "project/radare2/libr/anal/esil_stats.c" 3 4
                                               unsigned long long 
# 36 "project/radare2/libr/anal/esil_stats.c"
                                                    addr, const 
...
# 37 "project/radare2/libr/anal/esil_stats.c" 3 4
fprintf(__stderrp,
# 37 "project/radare2/libr/anal/esil_stats.c"
"NOP WRITE AT 0x%08"
# 37 "project/radare2/libr/anal/esil_stats.c" 3 4
"llx"
# 37 "project/radare2/libr/anal/esil_stats.c"
...
# 37 "project/radare2/libr/anal/esil_stats.c"
                                               ;
 return 
# 38 "project/radare2/libr/anal/esil_stats.c" 3 4
       1
# 38 "project/radare2/libr/anal/esil_stats.c"
           ;
}


# 41 "project/radare2/libr/anal/esil_stats.c" 3 4
__attribute__((visibility("default"))) 
# 41 "project/radare2/libr/anal/esil_stats.c"
     void r_anal_esil_mem_ro(RAnalEsil *esil, int mem_readonly) {
 if (mem_readonly) {
  esil->cb.hook_mem_write = hook_NOP_mem_write;
 } else {
  esil->cb.hook_mem_write = 
# 45 "project/radare2/libr/anal/esil_stats.c" 3 4
                           ((void *)0)
# 45 "project/radare2/libr/anal/esil_stats.c"
                               ;
 }
}


# 49 "project/radare2/libr/anal/esil_stats.c" 3 4
__attribute__((visibility("default"))) 
# 49 "project/radare2/libr/anal/esil_stats.c"
     void r_anal_esil_stats(RAnalEsil *esil, int enable) {
 if (enable) {
  if (esil->stats) {
  ...
  esil->cb.hook_mem_write = 
# 64 "project/radare2/libr/anal/esil_stats.c" 3 4
                           ((void *)0)
# 64 "project/radare2/libr/anal/esil_stats.c"
                               ;
  esil->cb.hook_flag_read = 
# 65 "project/radare2/libr/anal/esil_stats.c" 3 4
                           ((void *)0)
# 65 "project/radare2/libr/anal/esil_stats.c"
                               ;
  esil->cb.hook_command = 
# 66 "project/radare2/libr/anal/esil_stats.c" 3 4
                         ((void *)0)
# 66 "project/radare2/libr/anal/esil_stats.c"
                             ;
  sdb_free (esil->stats);
  esil->stats = 
# 68 "project/radare2/libr/anal/esil_stats.c" 3 4
               ((void *)0)
# 68 "project/radare2/libr/anal/esil_stats.c"
                   ;
 }
}
