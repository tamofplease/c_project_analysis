# 0 "project/radare2/libr/cons/stiv.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/cons/stiv.c"
...
# 4 "project/radare2/libr/cons/stiv.c" 2
...
# 9 "project/radare2/libr/cons/stiv.c"
void (*renderer)(PrintfCallback cb_printf, const 
# 9 "project/radare2/libr/cons/stiv.c" 3 4
                                                unsigned char
# 9 "project/radare2/libr/cons/stiv.c"
                                                   *, const 
# 9 "project/radare2/libr/cons/stiv.c" 3 4
...
static int reduce8 (int r, int g, int b) {
 ...
 for (i = 0; i<colors_len; i++) {
  int distance =
     (((((colors[i][0]-r))<0)?-((colors[i][0]-r)):((colors[i][0]-r))) * (r))
   + (((((colors[i][1]-g))<0)?-((colors[i][1]-g)):((colors[i][1]-g))) * (g))
   + (((((colors[i][2]-b))<0)?-((colors[i][2]-b)):((colors[i][2]-b))) * (b));
...
static void render_ansi(PrintfCallback cb_printf, const 
# 47 "project/radare2/libr/cons/stiv.c" 3 4
                                                       unsigned char 
# 47 "project/radare2/libr/cons/stiv.c"
                                                           *c, const 
# 47 "project/radare2/libr/cons/stiv.c" 3 4
                                                                     unsigned char 
# 47 "project/radare2/libr/cons/stiv.c"
...
static int rgb(int r, int g, int b) {
 r = 
# 56 "project/radare2/libr/cons/stiv.c" 3 4
    (((
# 56 "project/radare2/libr/cons/stiv.c"
    r
# 56 "project/radare2/libr/cons/stiv.c" 3 4
    )<(
# 56 "project/radare2/libr/cons/stiv.c"
...
# 56 "project/radare2/libr/cons/stiv.c"
                     ;
 g = 
# 57 "project/radare2/libr/cons/stiv.c" 3 4
    (((
# 57 "project/radare2/libr/cons/stiv.c"
    g
# 57 "project/radare2/libr/cons/stiv.c" 3 4
    )<(
# 57 "project/radare2/libr/cons/stiv.c"
...
# 57 "project/radare2/libr/cons/stiv.c"
                     ;
 b = 
# 58 "project/radare2/libr/cons/stiv.c" 3 4
    (((
# 58 "project/radare2/libr/cons/stiv.c"
    b
# 58 "project/radare2/libr/cons/stiv.c" 3 4
    )<(
# 58 "project/radare2/libr/cons/stiv.c"
...
static void render_256(PrintfCallback cb_printf, const 
# 65 "project/radare2/libr/cons/stiv.c" 3 4
                                                      unsigned char 
# 65 "project/radare2/libr/cons/stiv.c"
                                                          *c, const 
# 65 "project/radare2/libr/cons/stiv.c" 3 4
                                                                    unsigned char 
# 65 "project/radare2/libr/cons/stiv.c"
...
static void render_rgb(PrintfCallback cb_printf, const 
# 70 "project/radare2/libr/cons/stiv.c" 3 4
                                                      unsigned char 
# 70 "project/radare2/libr/cons/stiv.c"
                                                          *c, const 
# 70 "project/radare2/libr/cons/stiv.c" 3 4
                                                                    unsigned char 
# 70 "project/radare2/libr/cons/stiv.c"
...
static void render_greyscale(PrintfCallback cb_printf, const 
# 75 "project/radare2/libr/cons/stiv.c" 3 4
                                                            unsigned char 
# 75 "project/radare2/libr/cons/stiv.c"
                                                                *c, const 
# 75 "project/radare2/libr/cons/stiv.c" 3 4
                                                                          unsigned char 
# 75 "project/radare2/libr/cons/stiv.c"
...
static void render_ascii(PrintfCallback cb_printf, const 
# 87 "project/radare2/libr/cons/stiv.c" 3 4
                                                        unsigned char 
# 87 "project/radare2/libr/cons/stiv.c"
                                                            *c, const 
# 87 "project/radare2/libr/cons/stiv.c" 3 4
                                                                      unsigned char 
# 87 "project/radare2/libr/cons/stiv.c"
...
static void dorender (PrintfCallback cb_printf, const 
# 97 "project/radare2/libr/cons/stiv.c" 3 4
                                                     unsigned char 
# 97 "project/radare2/libr/cons/stiv.c"
                                                         *buf, int len, int w, int h) {
 const 
# 98 "project/radare2/libr/cons/stiv.c" 3 4
      unsigned char 
# 98 "project/radare2/libr/cons/stiv.c"
          *c, *d;
 int x, y;
 for (y=0; y<h; y+=2) {
  for (x=0; x<w; x++) {
...
# 130 "project/radare2/libr/cons/stiv.c" 3 4
__attribute__((visibility("default"))) 
# 130 "project/radare2/libr/cons/stiv.c"
     void r_cons_image(const 
# 130 "project/radare2/libr/cons/stiv.c" 3 4
                             unsigned char 
# 130 "project/radare2/libr/cons/stiv.c"
                                 *buf, int bufsz, int width, int mode) {
