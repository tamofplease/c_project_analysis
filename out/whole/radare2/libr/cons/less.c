# 0 "project/radare2/libr/cons/less.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/cons/less.c" 2
...
# 5 "project/radare2/libr/cons/less.c" 2
...
# 6 "project/radare2/libr/cons/less.c" 2
...
# 7 "project/radare2/libr/cons/less.c" 2


# 8 "project/radare2/libr/cons/less.c" 3 4
__attribute__((visibility("default"))) 
# 8 "project/radare2/libr/cons/less.c"
     int r_cons_less_str(const char *str, const char *exitkeys) {
 
# 9 "project/radare2/libr/cons/less.c" 3 4
do { if (!(
# 9 "project/radare2/libr/cons/less.c"
str && *str
# 9 "project/radare2/libr/cons/less.c" 3 4
...
# 11 "project/radare2/libr/cons/less.c" 3 4
 fprintf(__stderrp,
# 11 "project/radare2/libr/cons/less.c"
...
# 11 "project/radare2/libr/cons/less.c"
 ...
 static int in_help = 
# 15 "project/radare2/libr/cons/less.c" 3 4
                     0
# 15 "project/radare2/libr/cons/less.c"
                          ;
 ...
 int lines_count = 0;
 RRegex *rx = 
# 27 "project/radare2/libr/cons/less.c" 3 4
             ((void *)0)
# 27 "project/radare2/libr/cons/less.c"
                 ;
 ...
 if (lines_count < 1) {
  mla = 
# 44 "project/radare2/libr/cons/less.c" 3 4
       ((void *)0)
# 44 "project/radare2/libr/cons/less.c"
           ;
 } else {
 ...
 r_cons_set_raw (
# 57 "project/radare2/libr/cons/less.c" 3 4
                1
# 57 "project/radare2/libr/cons/less.c"
                    );
 r_cons_show_cursor (
# 58 "project/radare2/libr/cons/less.c" 3 4
                    0
# 58 "project/radare2/libr/cons/less.c"
                         );
 r_cons_reset ();
 h = 0;
 while (ui) {
  w = r_cons_get_size (&h);
  to = 
# 63 "project/radare2/libr/cons/less.c" 3 4
      (((
# 63 "project/radare2/libr/cons/less.c"
      lines_count
# 63 "project/radare2/libr/cons/less.c" 3 4
      )>(
# 63 "project/radare2/libr/cons/less.c"
...
# 63 "project/radare2/libr/cons/less.c"
  ...
  case '?':
   if (!in_help) {
    in_help = 
# 89 "project/radare2/libr/cons/less.c" 3 4
             1
# 89 "project/radare2/libr/cons/less.c"
                 ;
    (void)r_cons_less_str (r_cons_less_help, 
# 90 "project/radare2/libr/cons/less.c" 3 4
                                            ((void *)0)
# 90 "project/radare2/libr/cons/less.c"
                                                );
    in_help = 
# 91 "project/radare2/libr/cons/less.c" 3 4
             0
# 91 "project/radare2/libr/cons/less.c"
                  ;
   }
   break;
  case 'u':
  ...
  case '/':
   ...
   from = 
# 121 "project/radare2/libr/cons/less.c" 3 4
         (((
# 121 "project/radare2/libr/cons/less.c"
         lines_count - 1
# 121 "project/radare2/libr/cons/less.c" 3 4
         )>(
# 121 "project/radare2/libr/cons/less.c"
...
# 121 "project/radare2/libr/cons/less.c"
 ...
 r_cons_reset_colors ();
 r_cons_set_raw (
# 162 "project/radare2/libr/cons/less.c" 3 4
                0
# 162 "project/radare2/libr/cons/less.c"
                     );
 r_cons_show_cursor (
# 163 "project/radare2/libr/cons/less.c" 3 4
                    1
# 163 "project/radare2/libr/cons/less.c"
                        );
 free (ostr);
 return 0;
}
...
# 168 "project/radare2/libr/cons/less.c" 3 4
__attribute__((visibility("default"))) 
# 168 "project/radare2/libr/cons/less.c"
     void r_cons_less(void) {
 (void)r_cons_less_str (r_cons_context ()->buffer, 
# 169 "project/radare2/libr/cons/less.c" 3 4
                                                  ((void *)0)
# 169 "project/radare2/libr/cons/less.c"
                                                      );
}
