# 0 "project/radare2/libr/cons/cpipe.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/cons/cpipe.c" 2
# 1 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include-fixed/limits.h" 1 3 4
# 5 "project/radare2/libr/cons/cpipe.c" 2




# 8 "project/radare2/libr/cons/cpipe.c"
...
static 
# 15 "project/radare2/libr/cons/cpipe.c" 3 4
      _Bool 
# 15 "project/radare2/libr/cons/cpipe.c"
           __dupDescriptor(int fd, int fdn) {
 ...
 backup_fd = sysconf (
# 22 "project/radare2/libr/cons/cpipe.c" 3 4
                     5
# 22 "project/radare2/libr/cons/cpipe.c"
                                 ) - (fd - 2);
 if (backup_fd < 2) {
  backup_fd = 2002 - (fd - 2);
 }
...
# 30 "project/radare2/libr/cons/cpipe.c" 3 4
__attribute__((visibility("default"))) 
# 30 "project/radare2/libr/cons/cpipe.c"
     int r_cons_pipe_open(const char *file, int fdn, int append) {
 ...
 const int fd_flags = 
# 39 "project/radare2/libr/cons/cpipe.c" 3 4
                     0 
# 39 "project/radare2/libr/cons/cpipe.c"
                              | 
# 39 "project/radare2/libr/cons/cpipe.c" 3 4
                                0x0002 
# 39 "project/radare2/libr/cons/cpipe.c"
...
# 42 "project/radare2/libr/cons/cpipe.c" 3 4
 fprintf(__stderrp,
# 42 "project/radare2/libr/cons/cpipe.c"
 "r_cons_pipe_open: Cannot open file '%s'\n", file
# 42 "project/radare2/libr/cons/cpipe.c" 3 4
 )
# 42 "project/radare2/libr/cons/cpipe.c"
                                                            ;
...
# 52 "project/radare2/libr/cons/cpipe.c" 3 4
 fprintf(__stderrp,
# 52 "project/radare2/libr/cons/cpipe.c"
 "Cannot dup stdout to %d\n", fdn
# 52 "project/radare2/libr/cons/cpipe.c" 3 4
 )
# 52 "project/radare2/libr/cons/cpipe.c"
                                           ;
...
# 63 "project/radare2/libr/cons/cpipe.c" 3 4
__attribute__((visibility("default"))) 
# 63 "project/radare2/libr/cons/cpipe.c"
