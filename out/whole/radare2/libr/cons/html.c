# 0 "project/radare2/libr/cons/html.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/cons/html.c"
...
# 4 "project/radare2/libr/cons/html.c" 2


# 5 "project/radare2/libr/cons/html.c"
static 
# 5 "project/radare2/libr/cons/html.c" 3 4
      _Bool 
# 5 "project/radare2/libr/cons/html.c"
           gethtmlrgb(const char *str, char *buf) {
 
# 6 "project/radare2/libr/cons/html.c" 3 4
unsigned char 
# 6 "project/radare2/libr/cons/html.c"
    r = 0, g = 0, b = 0;
 if (r_cons_rgb_parse (str, &r, &g, &b, 0)) {
  
# 8 "project/radare2/libr/cons/html.c" 3 4
 __builtin___sprintf_chk (
# 8 "project/radare2/libr/cons/html.c"
 buf
# 8 "project/radare2/libr/cons/html.c" 3 4
...
# 8 "project/radare2/libr/cons/html.c"
                                        ;
  return 
# 9 "project/radare2/libr/cons/html.c" 3 4
        1
# 9 "project/radare2/libr/cons/html.c"
            ;
 }
 buf[0] = '\0';
 return 
# 12 "project/radare2/libr/cons/html.c" 3 4
       0
# 12 "project/radare2/libr/cons/html.c"
            ;
}
...
# 32 "project/radare2/libr/cons/html.c" 3 4
__attribute__((visibility("default"))) 
# 32 "project/radare2/libr/cons/html.c"
     char *r_cons_html_filter(const char *ptr, int *newlen) {
 const char *str = ptr;
 int esc = 0;
 int len = 0;
 
# 36 "project/radare2/libr/cons/html.c" 3 4
_Bool 
# 36 "project/radare2/libr/cons/html.c"
     inv = 
# 36 "project/radare2/libr/cons/html.c" 3 4
           0
# 36 "project/radare2/libr/cons/html.c"
...
# 39 "project/radare2/libr/cons/html.c" 3 4
_Bool 
# 39 "project/radare2/libr/cons/html.c"
     has_set = 
# 39 "project/radare2/libr/cons/html.c" 3 4
               0
# 39 "project/radare2/libr/cons/html.c"
...
# 40 "project/radare2/libr/cons/html.c" 3 4
_Bool 
# 40 "project/radare2/libr/cons/html.c"
     need_to_set = 
# 40 "project/radare2/libr/cons/html.c" 3 4
                   0
# 40 "project/radare2/libr/cons/html.c"
...
# 41 "project/radare2/libr/cons/html.c" 3 4
_Bool 
# 41 "project/radare2/libr/cons/html.c"
     need_to_clear = 
# 41 "project/radare2/libr/cons/html.c" 3 4
                     0
# 41 "project/radare2/libr/cons/html.c"
...
# 42 "project/radare2/libr/cons/html.c" 3 4
_Bool 
# 42 "project/radare2/libr/cons/html.c"
     first_style;
 int tmp;
 if (!ptr) {
  return 
# 45 "project/radare2/libr/cons/html.c" 3 4
        ((void *)0)
# 45 "project/radare2/libr/cons/html.c"
            ;
 }
 RStrBuf *res = r_strbuf_new ("");
 if (!res) {
  return 
# 49 "project/radare2/libr/cons/html.c" 3 4
        ((void *)0)
# 49 "project/radare2/libr/cons/html.c"
            ;
 }
 for (; ptr[0]; ptr = ptr + 1) {
  if (esc == 0 && ptr[0] != 0x1b && need_to_set) {
   if (has_set) {
    ...
    has_set = 
# 55 "project/radare2/libr/cons/html.c" 3 4
             0
# 55 "project/radare2/libr/cons/html.c"
                  ;
   }
   if (!need_to_clear) {
    first_style = 
# 58 "project/radare2/libr/cons/html.c" 3 4
                 1
# 58 "project/radare2/libr/cons/html.c"
                     ;
    r_strbuf_append (res, "<font");
    if (text_color[0]) {
    ...
    if (background_color[0]) {
     ...
     first_style = 
# 66 "project/radare2/libr/cons/html.c" 3 4
                  0
# 66 "project/radare2/libr/cons/html.c"
                       ;
    }
    if (inv) {
     r_strbuf_append (res, first_style? " style='": ";");
     ...
     first_style = 
# 71 "project/radare2/libr/cons/html.c" 3 4
                  0
# 71 "project/radare2/libr/cons/html.c"
                       ;
    }
    r_strbuf_append (res, first_style? ">": "'>");
    has_set = 
# 74 "project/radare2/libr/cons/html.c" 3 4
             1
# 74 "project/radare2/libr/cons/html.c"
                 ;
   }
   need_to_clear = 
# 76 "project/radare2/libr/cons/html.c" 3 4
                  0
# 76 "project/radare2/libr/cons/html.c"
                       ;
   need_to_set = 
# 77 "project/radare2/libr/cons/html.c" 3 4
                0
# 77 "project/radare2/libr/cons/html.c"
                     ;
  }
  if (ptr[0] == '\n') {
...
# 119 "project/radare2/libr/cons/html.c" 3 4
   fprintf(__stderrp,
# 119 "project/radare2/libr/cons/html.c"
...
# 119 "project/radare2/libr/cons/html.c"
   ...
   if (ptr[0] == '0' && ptr[1] == 'J') {
    ...
    need_to_set = 
# 146 "project/radare2/libr/cons/html.c" 3 4
                 1
# 146 "project/radare2/libr/cons/html.c"
                     ;
    ptr = end;
    str = ptr + 1;
    esc = 0;
    ...
    need_to_set = 
# 153 "project/radare2/libr/cons/html.c" 3 4
                 1
# 153 "project/radare2/libr/cons/html.c"
                     ;
    ptr = end;
    str = ptr + 1;
    esc = 0;
    ...
    esc = 0;
    inv = 
# 167 "project/radare2/libr/cons/html.c" 3 4
         0
# 167 "project/radare2/libr/cons/html.c"
              ;
    text_color[0] = '\0';
    background_color[0] = '\0';
    need_to_set = need_to_clear = 
# 170 "project/radare2/libr/cons/html.c" 3 4
                                 1
# 170 "project/radare2/libr/cons/html.c"
                                     ;
    continue;

   } else if (!strncmp (ptr, "27m", 3)) {
    inv = 
# 174 "project/radare2/libr/cons/html.c" 3 4
         0
# 174 "project/radare2/libr/cons/html.c"
              ;
    need_to_set = 
# 175 "project/radare2/libr/cons/html.c" 3 4
                 1
# 175 "project/radare2/libr/cons/html.c"
                     ;
    ptr = ptr + 2;
    str = ptr + 1;
    esc = 0;
    ...
    str = (++ptr) + 1;
    inv = 
# 183 "project/radare2/libr/cons/html.c" 3 4
         1
# 183 "project/radare2/libr/cons/html.c"
             ;
    need_to_set = 
# 184 "project/radare2/libr/cons/html.c" 3 4
                 1
# 184 "project/radare2/libr/cons/html.c"
                     ;
    esc = 0;
    continue;
    ...
    need_to_set = 
# 193 "project/radare2/libr/cons/html.c" 3 4
                 1
# 193 "project/radare2/libr/cons/html.c"
                     ;
    ptr = ptr + 2;
    str = ptr + 1;
    esc = 0;
    ...
    need_to_set = 
# 203 "project/radare2/libr/cons/html.c" 3 4
                 1
# 203 "project/radare2/libr/cons/html.c"
                     ;
    ptr = ptr + 2;
    str = ptr + 1;
    esc = 0;
