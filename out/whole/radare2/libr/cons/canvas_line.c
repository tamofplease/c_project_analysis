# 0 "project/radare2/libr/cons/canvas_line.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/cons/canvas_line.c"
...
# 4 "project/radare2/libr/cons/canvas_line.c" 2
...
# 16 "project/radare2/libr/cons/canvas_line.c"
enum {
 APEX_DOT = 0,
 DOT_APEX,
 REV_APEX_APEX,
...
static const char* utf8_line_vert (int dot_style) {
 if (r_cons_singleton ()->dotted_lines) {
  switch (dot_style) {
  case 
# 31 "project/radare2/libr/cons/canvas_line.c" 3 4
      0
# 31 "project/radare2/libr/cons/canvas_line.c"
                      : return 
# 31 "project/radare2/libr/cons/canvas_line.c" 3 4
                                    "\xc8"
# 31 "project/radare2/libr/cons/canvas_line.c"
                                                         ;
  case 
# 32 "project/radare2/libr/cons/canvas_line.c" 3 4
      1
# 32 "project/radare2/libr/cons/canvas_line.c"
                           : return "┊";
  case 
# 33 "project/radare2/libr/cons/canvas_line.c" 3 4
      2
# 33 "project/radare2/libr/cons/canvas_line.c"
                        : return "╵";
  }
 }
 return 
# 36 "project/radare2/libr/cons/canvas_line.c" 3 4
       "\xc8"
# 36 "project/radare2/libr/cons/canvas_line.c"
                            ;
}
...
static const char* utf8_line_horiz (int dot_style) {
 if (r_cons_singleton ()->dotted_lines) {
  switch (dot_style) {
  case 
# 42 "project/radare2/libr/cons/canvas_line.c" 3 4
      0
# 42 "project/radare2/libr/cons/canvas_line.c"
                      : return 
# 42 "project/radare2/libr/cons/canvas_line.c" 3 4
                                    "\xce"
# 42 "project/radare2/libr/cons/canvas_line.c"
                                                          ;
  case 
# 43 "project/radare2/libr/cons/canvas_line.c" 3 4
      1
# 43 "project/radare2/libr/cons/canvas_line.c"
                           : return "┄";
  case 
# 44 "project/radare2/libr/cons/canvas_line.c" 3 4
      2
# 44 "project/radare2/libr/cons/canvas_line.c"
                        : return "╴";
  }
 }
 return 
# 47 "project/radare2/libr/cons/canvas_line.c" 3 4
       "\xce"
# 47 "project/radare2/libr/cons/canvas_line.c"
                             ;
}
...
static void apply_line_style(RConsCanvas *c, int x, int y, int x2, int y2,
 ...
 if (!c->color) {
  c->attr = 
# 69 "project/radare2/libr/cons/canvas_line.c" 3 4
           "\x1b[0m"
# 69 "project/radare2/libr/cons/canvas_line.c"
                      ;
 }
 if (style->ansicolor) {
 ...
 case LINE_TRUE:
  if (r_cons_canvas_gotoxy(c,x,y)) {
   r_cons_canvas_write(c,"t");
  }
  break;
 case LINE_FALSE:
  if (r_cons_canvas_gotoxy(c,x,y)) {
   r_cons_canvas_write(c,"f");
  }
  break;
 case LINE_NOSYM_VERT:
  if (r_cons_canvas_gotoxy(c,x,y)) {
   r_cons_canvas_write(c,(r_cons_singleton ()->use_utf8) ? utf8_line_vert (style->dot_style) : "|");
  }
  break;
 case LINE_NOSYM_HORIZ:
  if (r_cons_canvas_gotoxy(c,x,y)) {
   r_cons_canvas_write(c,(r_cons_singleton ()->use_utf8) ? utf8_line_horiz (style->dot_style) : "-");
  }
  break;
 case LINE_NONE:
 default:
...
static void draw_horizontal_line (RConsCanvas *c, int x, int y, int width, int style, int dot_style) {
 ...
 switch (style) {
 case APEX_DOT:
  if ((r_cons_singleton ()->use_utf8)) {
   if ((r_cons_singleton ()->use_utf8_curvy)) {
    l_corner = 
# 129 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xd5"
# 129 "project/radare2/libr/cons/canvas_line.c"
                                         ;
    r_corner = 
# 130 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xd3"
# 130 "project/radare2/libr/cons/canvas_line.c"
                                         ;
   } else {
    l_corner = 
# 132 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xcb"
# 132 "project/radare2/libr/cons/canvas_line.c"
                                   ;
    r_corner = 
# 133 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xd0"
# 133 "project/radare2/libr/cons/canvas_line.c"
                                   ;
   }
  } else {
   l_corner = "'";
 ...
 case DOT_APEX:
  if ((r_cons_singleton ()->use_utf8)) {
   if ((r_cons_singleton ()->use_utf8_curvy)) {
    l_corner = 
# 143 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xd2"
# 143 "project/radare2/libr/cons/canvas_line.c"
                                         ;
    r_corner = 
# 144 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xd4"
# 144 "project/radare2/libr/cons/canvas_line.c"
                                         ;
   } else {
    l_corner = 
# 146 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xcf"
# 146 "project/radare2/libr/cons/canvas_line.c"
                                   ;
    r_corner = 
# 147 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xca"
# 147 "project/radare2/libr/cons/canvas_line.c"
                                   ;
   }
  } else {
   l_corner = ".";
 ...
 case REV_APEX_APEX:
  if ((r_cons_singleton ()->use_utf8)) {
   if ((r_cons_singleton ()->use_utf8_curvy)) {
    l_corner = 
# 157 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xd5"
# 157 "project/radare2/libr/cons/canvas_line.c"
                                         ;
    r_corner = 
# 158 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xd4"
# 158 "project/radare2/libr/cons/canvas_line.c"
                                         ;
   } else {
    l_corner = 
# 160 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xcb"
# 160 "project/radare2/libr/cons/canvas_line.c"
                                   ;
    r_corner = 
# 161 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xca"
# 161 "project/radare2/libr/cons/canvas_line.c"
                                   ;
   }
  } else {
   l_corner = "`";
 ...
 case DOT_DOT:
  if ((r_cons_singleton ()->use_utf8)) {
   if ((r_cons_singleton ()->use_utf8_curvy)) {
    l_corner = 
# 171 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xd2"
# 171 "project/radare2/libr/cons/canvas_line.c"
                                         ;
    r_corner = 
# 172 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xd3"
# 172 "project/radare2/libr/cons/canvas_line.c"
                                         ;
   } else {
    l_corner = 
# 174 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xcf"
# 174 "project/radare2/libr/cons/canvas_line.c"
                                   ;
    r_corner = 
# 175 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xd0"
# 175 "project/radare2/libr/cons/canvas_line.c"
                                   ;
   }
  } else {
   l_corner = r_corner = ".";
 ...
 case NRM_DOT:
  if ((r_cons_singleton ()->use_utf8)) {
   ...
   if ((r_cons_singleton ()->use_utf8_curvy)) {
    r_corner = 
# 185 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xd3"
# 185 "project/radare2/libr/cons/canvas_line.c"
                                         ;
   } else {
    r_corner = 
# 187 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xd0"
# 187 "project/radare2/libr/cons/canvas_line.c"
                                   ;
   }
  } else {
   l_corner = "-";
 ...
 case NRM_APEX:
  if ((r_cons_singleton ()->use_utf8)) {
   ...
   if ((r_cons_singleton ()->use_utf8_curvy)) {
    r_corner = 
# 198 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xd4"
# 198 "project/radare2/libr/cons/canvas_line.c"
                                         ;
   } else {
    r_corner = 
# 200 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xca"
# 200 "project/radare2/libr/cons/canvas_line.c"
                                   ;
   }
  } else {
   l_corner = "-";
 ...
 case DOT_NRM:
  if ((r_cons_singleton ()->use_utf8)) {
   if ((r_cons_singleton ()->use_utf8_curvy)) {
    l_corner = 
# 210 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xd2"
# 210 "project/radare2/libr/cons/canvas_line.c"
                                         ;
   } else {
    l_corner = 
# 212 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xcf"
# 212 "project/radare2/libr/cons/canvas_line.c"
                                   ;
   }
 ...
 case REV_APEX_NRM:
  if ((r_cons_singleton ()->use_utf8)) {
   if ((r_cons_singleton ()->use_utf8_curvy)) {
    l_corner = 
# 223 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xd5"
# 223 "project/radare2/libr/cons/canvas_line.c"
                                         ;
   } else {
    l_corner = 
# 225 "project/radare2/libr/cons/canvas_line.c" 3 4
              "\xcb"
# 225 "project/radare2/libr/cons/canvas_line.c"
                                   ;
   }
   r_corner = utf8_line_horiz (dot_style);
  } else {
 ...
 if (r_cons_canvas_gotoxy(c,x,y)) {
  r_cons_canvas_write(c,l_corner);
 }

 const char *hline = (r_cons_singleton ()->use_utf8) ? utf8_line_horiz (dot_style) : "-";
 r_cons_break_push (
# 248 "project/radare2/libr/cons/canvas_line.c" 3 4
                   ((void *)0)
# 248 "project/radare2/libr/cons/canvas_line.c"
                       , 
# 248 "project/radare2/libr/cons/canvas_line.c" 3 4
                         ((void *)0)
# 248 "project/radare2/libr/cons/canvas_line.c"
 ...
 for (i = x + 1; i < x + width - 1; i++) {
  ...
  if (r_cons_canvas_gotoxy(c,i,y)) {
   r_cons_canvas_write(c,hline);
  }
 }
 r_cons_break_pop ();

 if (r_cons_canvas_gotoxy(c,x + width - 1,y)) {
  r_cons_canvas_write(c,r_corner);
 }
}
...
static void draw_vertical_line(RConsCanvas *c, int x, int y, int height, int dot_style) {
 ...
 const char *vline = (r_cons_singleton ()->use_utf8) ? utf8_line_vert (dot_style) : "|";
 r_cons_break_push (
# 274 "project/radare2/libr/cons/canvas_line.c" 3 4
                   ((void *)0)
# 274 "project/radare2/libr/cons/canvas_line.c"
                       , 
# 274 "project/radare2/libr/cons/canvas_line.c" 3 4
                         ((void *)0)
# 274 "project/radare2/libr/cons/canvas_line.c"
 ...
 for (i = y; i < y + height; i++) {
  ...
  if (r_cons_canvas_gotoxy(c,x,i)) {
   r_cons_canvas_write(c,vline);
  }
 }
 r_cons_break_pop ();
}
...
# 286 "project/radare2/libr/cons/canvas_line.c" 3 4
__attribute__((visibility("default"))) 
# 286 "project/radare2/libr/cons/canvas_line.c"
     void r_cons_canvas_line_diagonal(RConsCanvas *c, int x, int y, int x2, int y2, RCanvasLineStyle *style) {
 if (x == x2 || y == y2) {
  style->dot_style = 
# 288 "project/radare2/libr/cons/canvas_line.c" 3 4
                    0
# 288 "project/radare2/libr/cons/canvas_line.c"
                                    ;
...
loop:
 ...
 if (dx) {
  ...
  if (r_cons_canvas_gotoxy(c,x,y + 1)) {
   r_cons_canvas_write(c,"|");
  }
 }
 c->attr = 
# 369 "project/radare2/libr/cons/canvas_line.c" 3 4
          "\x1b[0m"
# 369 "project/radare2/libr/cons/canvas_line.c"
                     ;
}


# 372 "project/radare2/libr/cons/canvas_line.c" 3 4
__attribute__((visibility("default"))) 
# 372 "project/radare2/libr/cons/canvas_line.c"
     void r_cons_canvas_line_square (RConsCanvas *c, int x, int y, int x2, int y2, RCanvasLineStyle *style) {
 int min_x = 
# 373 "project/radare2/libr/cons/canvas_line.c" 3 4
            (((
# 373 "project/radare2/libr/cons/canvas_line.c"
            x
# 373 "project/radare2/libr/cons/canvas_line.c" 3 4
            )>(
# 373 "project/radare2/libr/cons/canvas_line.c"
...
# 373 "project/radare2/libr/cons/canvas_line.c"
                         ;
 int diff_x = 
# 374 "project/radare2/libr/cons/canvas_line.c" 3 4
             (((
# 374 "project/radare2/libr/cons/canvas_line.c"
             x - x2
# 374 "project/radare2/libr/cons/canvas_line.c" 3 4
             )<0)?-(
# 374 "project/radare2/libr/cons/canvas_line.c"
...
# 374 "project/radare2/libr/cons/canvas_line.c"
                           ;
 int diff_y = 
# 375 "project/radare2/libr/cons/canvas_line.c" 3 4
             (((
# 375 "project/radare2/libr/cons/canvas_line.c"
             y - y2
# 375 "project/radare2/libr/cons/canvas_line.c" 3 4
             )<0)?-(
# 375 "project/radare2/libr/cons/canvas_line.c"
...
# 375 "project/radare2/libr/cons/canvas_line.c"
 ...
 c->attr = 
# 399 "project/radare2/libr/cons/canvas_line.c" 3 4
          "\x1b[0m"
# 399 "project/radare2/libr/cons/canvas_line.c"
                     ;
}


# 402 "project/radare2/libr/cons/canvas_line.c" 3 4
__attribute__((visibility("default"))) 
# 402 "project/radare2/libr/cons/canvas_line.c"
     void r_cons_canvas_line_square_defined (RConsCanvas *c, int x, int y, int x2, int y2, RCanvasLineStyle *style, int bendpoint, int isvert) {
 if (!c->linemode) {
  r_cons_canvas_line (c, x, y, x2, y2, style);
  return;
 }
 int min_x = 
# 407 "project/radare2/libr/cons/canvas_line.c" 3 4
            (((
# 407 "project/radare2/libr/cons/canvas_line.c"
            x
# 407 "project/radare2/libr/cons/canvas_line.c" 3 4
            )>(
# 407 "project/radare2/libr/cons/canvas_line.c"
...
# 407 "project/radare2/libr/cons/canvas_line.c"
                         ;
 int diff_x = 
# 408 "project/radare2/libr/cons/canvas_line.c" 3 4
             (((
# 408 "project/radare2/libr/cons/canvas_line.c"
             x - x2
# 408 "project/radare2/libr/cons/canvas_line.c" 3 4
             )<0)?-(
# 408 "project/radare2/libr/cons/canvas_line.c"
...
# 408 "project/radare2/libr/cons/canvas_line.c"
                           ;
 int diff_y = 
# 409 "project/radare2/libr/cons/canvas_line.c" 3 4
             (((
# 409 "project/radare2/libr/cons/canvas_line.c"
             y - y2
# 409 "project/radare2/libr/cons/canvas_line.c" 3 4
             )<0)?-(
# 409 "project/radare2/libr/cons/canvas_line.c"
...
# 409 "project/radare2/libr/cons/canvas_line.c"
                           ;
 int min_y = 
# 410 "project/radare2/libr/cons/canvas_line.c" 3 4
            (((
# 410 "project/radare2/libr/cons/canvas_line.c"
            y
# 410 "project/radare2/libr/cons/canvas_line.c" 3 4
            )>(
# 410 "project/radare2/libr/cons/canvas_line.c"
...
# 410 "project/radare2/libr/cons/canvas_line.c"
 ...
 c->attr = 
# 452 "project/radare2/libr/cons/canvas_line.c" 3 4
          "\x1b[0m"
# 452 "project/radare2/libr/cons/canvas_line.c"
                     ;
}


# 455 "project/radare2/libr/cons/canvas_line.c" 3 4
__attribute__((visibility("default"))) 
# 455 "project/radare2/libr/cons/canvas_line.c"
     void r_cons_canvas_line_back_edge (RConsCanvas *c, int x, int y, int x2, int y2, RCanvasLineStyle *style, int ybendpoint1, int xbendpoint, int ybendpoint2, int isvert) {
 if (!c->linemode) {
  r_cons_canvas_line (c, x, y, x2, y2, style);
  return;
 }
 int min_x1 = 
# 460 "project/radare2/libr/cons/canvas_line.c" 3 4
             (((
# 460 "project/radare2/libr/cons/canvas_line.c"
             x
# 460 "project/radare2/libr/cons/canvas_line.c" 3 4
             )>(
# 460 "project/radare2/libr/cons/canvas_line.c"
...
# 460 "project/radare2/libr/cons/canvas_line.c"
                                  ;
 int min_x2 = 
# 461 "project/radare2/libr/cons/canvas_line.c" 3 4
             (((
# 461 "project/radare2/libr/cons/canvas_line.c"
             x2
# 461 "project/radare2/libr/cons/canvas_line.c" 3 4
             )>(
# 461 "project/radare2/libr/cons/canvas_line.c"
...
# 461 "project/radare2/libr/cons/canvas_line.c"
 ...
 int diff_x1 = 
# 463 "project/radare2/libr/cons/canvas_line.c" 3 4
              (((
# 463 "project/radare2/libr/cons/canvas_line.c"
              x - xbendpoint
# 463 "project/radare2/libr/cons/canvas_line.c" 3 4
              )<0)?-(
# 463 "project/radare2/libr/cons/canvas_line.c"
...
# 463 "project/radare2/libr/cons/canvas_line.c"
                                    ;
 int diff_x2 = 
# 464 "project/radare2/libr/cons/canvas_line.c" 3 4
              (((
# 464 "project/radare2/libr/cons/canvas_line.c"
              x2 - xbendpoint
# 464 "project/radare2/libr/cons/canvas_line.c" 3 4
              )<0)?-(
# 464 "project/radare2/libr/cons/canvas_line.c"
...
# 464 "project/radare2/libr/cons/canvas_line.c"
 ...
 int diff_y = 
# 466 "project/radare2/libr/cons/canvas_line.c" 3 4
             (((
# 466 "project/radare2/libr/cons/canvas_line.c"
             (y + ybendpoint1 + 1) - (y2 - ybendpoint2- 1)
# 466 "project/radare2/libr/cons/canvas_line.c" 3 4
             )<0)?-(
# 466 "project/radare2/libr/cons/canvas_line.c"
             (y + ybendpoint1 + 1) - (y2 - ybendpoint2- 1)
...
# 466 "project/radare2/libr/cons/canvas_line.c"
 ...
 if (isvert) {
  ...
  int miny1 = 
# 480 "project/radare2/libr/cons/canvas_line.c" 3 4
             (((
# 480 "project/radare2/libr/cons/canvas_line.c"
             y
# 480 "project/radare2/libr/cons/canvas_line.c" 3 4
             )>(
# 480 "project/radare2/libr/cons/canvas_line.c"
...
# 480 "project/radare2/libr/cons/canvas_line.c"
                                  ;
  int miny2 = 
# 481 "project/radare2/libr/cons/canvas_line.c" 3 4
             (((
# 481 "project/radare2/libr/cons/canvas_line.c"
             y2
# 481 "project/radare2/libr/cons/canvas_line.c" 3 4
             )>(
# 481 "project/radare2/libr/cons/canvas_line.c"
...
# 481 "project/radare2/libr/cons/canvas_line.c"
                                   ;
  int diff_y1 = 
# 482 "project/radare2/libr/cons/canvas_line.c" 3 4
               (((
# 482 "project/radare2/libr/cons/canvas_line.c"
               y - xbendpoint
# 482 "project/radare2/libr/cons/canvas_line.c" 3 4
               )<0)?-(
# 482 "project/radare2/libr/cons/canvas_line.c"
...
# 482 "project/radare2/libr/cons/canvas_line.c"
                                     ;
  int diff_y2 = 
# 483 "project/radare2/libr/cons/canvas_line.c" 3 4
               (((
# 483 "project/radare2/libr/cons/canvas_line.c"
               y2 - xbendpoint
# 483 "project/radare2/libr/cons/canvas_line.c" 3 4
               )<0)?-(
# 483 "project/radare2/libr/cons/canvas_line.c"
