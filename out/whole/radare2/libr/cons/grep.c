# 0 "project/radare2/libr/cons/grep.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 4 "project/radare2/libr/cons/grep.c" 2
...
# 5 "project/radare2/libr/cons/grep.c" 2


#define I(x) r_cons_singleton ()->x


# 9 "project/radare2/libr/cons/grep.c"
...
# 14 "project/radare2/libr/cons/grep.c" 3 4
  __builtin___memmove_chk (
# 14 "project/radare2/libr/cons/grep.c"
  prev
# 14 "project/radare2/libr/cons/grep.c" 3 4
  , 
# 14 "project/radare2/libr/cons/grep.c"
...
# 61 "project/radare2/libr/cons/grep.c" 3 4
((void *)0)

# 62 "project/radare2/libr/cons/grep.c"
};


# 64 "project/radare2/libr/cons/grep.c" 3 4
__attribute__((visibility("default"))) 
# 64 "project/radare2/libr/cons/grep.c"
     void r_cons_grep_help(void) {
 r_cons_cmd_help (help_detail_tilde, 
# 65 "project/radare2/libr/cons/grep.c" 3 4
                                    1
# 65 "project/radare2/libr/cons/grep.c"
                                        );
}
...
static void parse_grep_expression(const char *str) {
 static char buf[4096], *ptrs[
# 71 "project/radare2/libr/cons/grep.c" 3 4
                                            10
# 71 "project/radare2/libr/cons/grep.c"
                                                             ];
 int wlen, len, is_range, num_is_parsed, fail = 
# 72 "project/radare2/libr/cons/grep.c" 3 4
                                               0
# 72 "project/radare2/libr/cons/grep.c"
                                                    ;
 char *ptr, *optr, *ptr2, *ptr3, *end_ptr = 
# 73 "project/radare2/libr/cons/grep.c" 3 4
                                           ((void *)0)
# 73 "project/radare2/libr/cons/grep.c"
                                               , last;
 
# 74 "project/radare2/libr/cons/grep.c" 3 4
unsigned long long 
# 74 "project/radare2/libr/cons/grep.c"
     range_begin, range_end;
 size_t ptrs_length;

 if (
# 77 "project/radare2/libr/cons/grep.c" 3 4
    (!(
# 77 "project/radare2/libr/cons/grep.c"
    str
# 77 "project/radare2/libr/cons/grep.c" 3 4
    ) || !*(
# 77 "project/radare2/libr/cons/grep.c"
...
# 89 "project/radare2/libr/cons/grep.c" 3 4
 fprintf(__stderrp,
# 89 "project/radare2/libr/cons/grep.c"
 "r_cons_grep: too long!\n"
# 89 "project/radare2/libr/cons/grep.c" 3 4
 )
# 89 "project/radare2/libr/cons/grep.c"
                                     ;
 ...
 if (len > 0 && str[len] == '?') {
  grep->counter = 1;
  r_str_ncpy (buf, str, 
# 94 "project/radare2/libr/cons/grep.c" 3 4
                       (((
# 94 "project/radare2/libr/cons/grep.c"
                       len
# 94 "project/radare2/libr/cons/grep.c" 3 4
                       )>(
# 94 "project/radare2/libr/cons/grep.c"
...
# 94 "project/radare2/libr/cons/grep.c"
  ...
  *(ptrs[ptrs_length]) = '\0';
  ...
  ptrs_length++;
  if (ptrs_length >= 
# 110 "project/radare2/libr/cons/grep.c" 3 4
                    10
# 110 "project/radare2/libr/cons/grep.c"
                                     ) {
   
# 111 "project/radare2/libr/cons/grep.c" 3 4
  fprintf(__stderrp,
# 111 "project/radare2/libr/cons/grep.c"
  "to many nested greps\n"
# 111 "project/radare2/libr/cons/grep.c" 3 4
  )
# 111 "project/radare2/libr/cons/grep.c"
                                    ;
 ...
 free (grep->str);
 grep->str = 
# 117 "project/radare2/libr/cons/grep.c" 3 4
            ((void *)0)
# 117 "project/radare2/libr/cons/grep.c"
                ;
 
# 118 "project/radare2/libr/cons/grep.c" 3 4
_Bool 
# 118 "project/radare2/libr/cons/grep.c"
     first = 
# 118 "project/radare2/libr/cons/grep.c" 3 4
             1
# 118 "project/radare2/libr/cons/grep.c"
 ...
 for (i = 0; i < ptrs_length; i++) {
  ptr = ptrs[i];
  end_ptr = ptr2 = ptr3 = 
# 123 "project/radare2/libr/cons/grep.c" 3 4
                         ((void *)0)
# 123 "project/radare2/libr/cons/grep.c"
                             ;
  while (*ptr) {
   switch (*ptr) {
   case '.':
   ...
   case '{':
    if (ptr[1] == ':') {
     grep->human = 
# 143 "project/radare2/libr/cons/grep.c" 3 4
                  1
# 143 "project/radare2/libr/cons/grep.c"
                      ;
     grep->json = 1;
     if (!strncmp (ptr, "{:...", 5)) {
      grep->hud = 
# 146 "project/radare2/libr/cons/grep.c" 3 4
                 1
# 146 "project/radare2/libr/cons/grep.c"
                     ;
     ...
     if (!strncmp (ptr, "{}...", 5)) {
      grep->hud = 
# 154 "project/radare2/libr/cons/grep.c" 3 4
                 1
# 154 "project/radare2/libr/cons/grep.c"
                     ;
     } else if (!strncmp (ptr, "{}..", 4)) {
      grep->less = 1;
     }
   ...
   case '$':
    ...
    if (*ptr == '!') {
     grep->sort_invert = 
# 176 "project/radare2/libr/cons/grep.c" 3 4
                        1
# 176 "project/radare2/libr/cons/grep.c"
                            ;
     ptr++;
    } else {
     grep->sort_invert = 
# 179 "project/radare2/libr/cons/grep.c" 3 4
                        0
# 179 "project/radare2/libr/cons/grep.c"
                             ;
    }
    grep->sort = atoi (ptr);
    while (
# 182 "project/radare2/libr/cons/grep.c" 3 4
          ((
# 182 "project/radare2/libr/cons/grep.c"
          *ptr
# 182 "project/radare2/libr/cons/grep.c" 3 4
          ) >= '0' && (
# 182 "project/radare2/libr/cons/grep.c"
...
# 182 "project/radare2/libr/cons/grep.c"
   ...
   case '+':
    if (first) {
     ptr++;
     grep->icase = 
# 201 "project/radare2/libr/cons/grep.c" 3 4
                  1
# 201 "project/radare2/libr/cons/grep.c"
                      ;
    } else {
     goto while_end;
    }
   ...
   case '^':
    ptr++;
    grep->begin = 
# 208 "project/radare2/libr/cons/grep.c" 3 4
                 1
# 208 "project/radare2/libr/cons/grep.c"
                     ;
    break;
   case '!':
    ptr++;
    grep->neg = 
# 212 "project/radare2/libr/cons/grep.c" 3 4
               1
# 212 "project/radare2/libr/cons/grep.c"
                   ;
    break;
   case '?':
    ptr++;
    ...
    if (*ptr == '.') {
     grep->charCounter = 
# 218 "project/radare2/libr/cons/grep.c" 3 4
                        1
# 218 "project/radare2/libr/cons/grep.c"
                            ;
     ptr++;
    } else if (!strcmp (ptr, "ea")) {

     grep->ascart = 
# 222 "project/radare2/libr/cons/grep.c" 3 4
                   1
# 222 "project/radare2/libr/cons/grep.c"
                       ;
    } else if (*ptr == '?') {
     cons->context->filter = 
# 224 "project/radare2/libr/cons/grep.c" 3 4
                            1
# 224 "project/radare2/libr/cons/grep.c"
                                ;
     r_cons_grep_help ();
     return;
    }
   ...
   first = 
# 232 "project/radare2/libr/cons/grep.c" 3 4
          0
# 232 "project/radare2/libr/cons/grep.c"
               ;
  }
 while_end:
  ptr2 = strchr (ptr, '[');
  ...
  num_is_parsed = 0;
  fail = 
# 239 "project/radare2/libr/cons/grep.c" 3 4
        0
# 239 "project/radare2/libr/cons/grep.c"
             ;
...
# 249 "project/radare2/libr/cons/grep.c" 3 4
    __builtin___memset_chk (&
# 249 "project/radare2/libr/cons/grep.c"
    grep->tokens
# 249 "project/radare2/libr/cons/grep.c" 3 4
    , 0, sizeof (
# 249 "project/radare2/libr/cons/grep.c"
...
# 249 "project/radare2/libr/cons/grep.c"
    ...
    case ',':
     for (; range_begin <= range_end; range_begin++) {
      if (range_begin >= 
# 262 "project/radare2/libr/cons/grep.c" 3 4
                        64
# 262 "project/radare2/libr/cons/grep.c"
                                          ) {
       fail = 
# 263 "project/radare2/libr/cons/grep.c" 3 4
             1
# 263 "project/radare2/libr/cons/grep.c"
                 ;
       break;
      }
     ...
     if (*ptr2 == ']' && is_range && !num_is_parsed) {
      num_is_parsed = 
# 271 "project/radare2/libr/cons/grep.c" 3 4
                     1
# 271 "project/radare2/libr/cons/grep.c"
                         ;
      range_end = -1;
     } else {
      is_range = 0;
    ...
    default:
     if (!num_is_parsed) {
      ...
      num_is_parsed = 
# 289 "project/radare2/libr/cons/grep.c" 3 4
                     1
# 289 "project/radare2/libr/cons/grep.c"
                         ;
     }
    }
   }
...
# 298 "project/radare2/libr/cons/grep.c" 3 4
                                           ((
# 298 "project/radare2/libr/cons/grep.c"
                                           ptr2[1]
# 298 "project/radare2/libr/cons/grep.c" 3 4
                                           ) >= '0' && (
# 298 "project/radare2/libr/cons/grep.c"
...
# 298 "project/radare2/libr/cons/grep.c"
                                                              || ptr2[1] == '-' || ptr2[1] == '.')) {
   end_ptr = end_ptr? 
# 299 "project/radare2/libr/cons/grep.c" 3 4
                     (((
# 299 "project/radare2/libr/cons/grep.c"
                     end_ptr
# 299 "project/radare2/libr/cons/grep.c" 3 4
                     )>(
# 299 "project/radare2/libr/cons/grep.c"
...
# 299 "project/radare2/libr/cons/grep.c"
  ...
  if (*ptr) {
   ...
   do {
    ...
    if (wlen >= 
# 348 "project/radare2/libr/cons/grep.c" 3 4
               64 
# 348 "project/radare2/libr/cons/grep.c"
                                     - 1) {
     
# 349 "project/radare2/libr/cons/grep.c" 3 4
    fprintf(__stderrp,
# 349 "project/radare2/libr/cons/grep.c"
...
# 349 "project/radare2/libr/cons/grep.c"
    ...
    grep->nstrings++;
    if (grep->nstrings > 
# 353 "project/radare2/libr/cons/grep.c" 3 4
                        10 
# 353 "project/radare2/libr/cons/grep.c"
                                          - 1) {
     
# 354 "project/radare2/libr/cons/grep.c" 3 4
    fprintf(__stderrp,
# 354 "project/radare2/libr/cons/grep.c"
...
# 354 "project/radare2/libr/cons/grep.c"
    ...
    r_str_ncpy (grep->strings[grep->nstrings - 1],
     optr, 
# 358 "project/radare2/libr/cons/grep.c" 3 4
          64
# 358 "project/radare2/libr/cons/grep.c"
                               );
   } while (ptr);
  }
 }
...
# 382 "project/radare2/libr/cons/grep.c" 3 4
 __builtin___memmove_chk ((
# 382 "project/radare2/libr/cons/grep.c"
 p - 1
# 382 "project/radare2/libr/cons/grep.c" 3 4
 ), (
# 382 "project/radare2/libr/cons/grep.c"
...
# 382 "project/radare2/libr/cons/grep.c"
 ...
 return 
# 385 "project/radare2/libr/cons/grep.c" 3 4
       ((void *)0)
# 385 "project/radare2/libr/cons/grep.c"
           ;
}
...
static char *preprocess_filter_expr(char *cmd, const char *quotes) {
 char *p1, *p2, *ns = 
# 393 "project/radare2/libr/cons/grep.c" 3 4
                     ((void *)0)
# 393 "project/radare2/libr/cons/grep.c"
                         ;
 const char *strsep = "&";
 int len;
 int i;
 ...
 if (!p1) {
  return 
# 400 "project/radare2/libr/cons/grep.c" 3 4
        ((void *)0)
# 400 "project/radare2/libr/cons/grep.c"
            ;
 }
...
# 430 "project/radare2/libr/cons/grep.c" 3 4
__attribute__((visibility("default"))) 
# 430 "project/radare2/libr/cons/grep.c"
     void r_cons_grep_parsecmd(char *cmd, const char *quotestr) {
 
# 431 "project/radare2/libr/cons/grep.c" 3 4
do { if (!(
# 431 "project/radare2/libr/cons/grep.c"
cmd && quotestr
# 431 "project/radare2/libr/cons/grep.c" 3 4
...
# 440 "project/radare2/libr/cons/grep.c" 3 4
__attribute__((visibility("default"))) 
# 440 "project/radare2/libr/cons/grep.c"
     char *r_cons_grep_strip(char *cmd, const char *quotestr) {
 char *ptr = 
# 441 "project/radare2/libr/cons/grep.c" 3 4
            ((void *)0)
# 441 "project/radare2/libr/cons/grep.c"
                ;
...
# 450 "project/radare2/libr/cons/grep.c" 3 4
__attribute__((visibility("default"))) 
# 450 "project/radare2/libr/cons/grep.c"
     void r_cons_grep_process(char *grep) {
 if (grep) {
...
static int cmp(const void *a, const void *b) {
 char *da = 
# 458 "project/radare2/libr/cons/grep.c" 3 4
           ((void *)0)
# 458 "project/radare2/libr/cons/grep.c"
               ;
 char *db = 
# 459 "project/radare2/libr/cons/grep.c" 3 4
           ((void *)0)
# 459 "project/radare2/libr/cons/grep.c"
               ;
 ...
 if (
# 474 "project/radare2/libr/cons/grep.c" 3 4
    ((
# 474 "project/radare2/libr/cons/grep.c"
    *ca
# 474 "project/radare2/libr/cons/grep.c" 3 4
    ) >= '0' && (
# 474 "project/radare2/libr/cons/grep.c"
...
# 475 "project/radare2/libr/cons/grep.c" 3 4
 unsigned long long 
# 475 "project/radare2/libr/cons/grep.c"
      na = r_num_get (
# 475 "project/radare2/libr/cons/grep.c" 3 4
                      ((void *)0)
# 475 "project/radare2/libr/cons/grep.c"
...
# 476 "project/radare2/libr/cons/grep.c" 3 4
 unsigned long long 
# 476 "project/radare2/libr/cons/grep.c"
      nb = r_num_get (
# 476 "project/radare2/libr/cons/grep.c" 3 4
                      ((void *)0)
# 476 "project/radare2/libr/cons/grep.c"
...
# 493 "project/radare2/libr/cons/grep.c" 3 4
__attribute__((visibility("default"))) 
# 493 "project/radare2/libr/cons/grep.c"
     void r_cons_grepbuf(void) {
 RCons *cons = r_cons_singleton ();
...
# 500 "project/radare2/libr/cons/grep.c" 3 4
_Bool 
# 500 "project/radare2/libr/cons/grep.c"
     show = 
# 500 "project/radare2/libr/cons/grep.c" 3 4
            0
# 500 "project/radare2/libr/cons/grep.c"
...
# 503 "project/radare2/libr/cons/grep.c" 3 4
 { free((void *)
# 503 "project/radare2/libr/cons/grep.c"
 cons->context->buffer
# 503 "project/radare2/libr/cons/grep.c" 3 4
 ); 
# 503 "project/radare2/libr/cons/grep.c"
...
# 503 "project/radare2/libr/cons/grep.c"
 ...
 if (grep->ascart) {
  ...
  r_str_ansi_filter (buf, 
# 515 "project/radare2/libr/cons/grep.c" 3 4
                         ((void *)0)
# 515 "project/radare2/libr/cons/grep.c"
                             , 
# 515 "project/radare2/libr/cons/grep.c" 3 4
                               ((void *)0)
# 515 "project/radare2/libr/cons/grep.c"
...
# 516 "project/radare2/libr/cons/grep.c" 3 4
                            ((void *)0)
# 516 "project/radare2/libr/cons/grep.c"
                                , 0);
...
# 526 "project/radare2/libr/cons/grep.c" 3 4
 __builtin___strcpy_chk (
# 526 "project/radare2/libr/cons/grep.c"
 in
# 526 "project/radare2/libr/cons/grep.c" 3 4
 , 
# 526 "project/radare2/libr/cons/grep.c"
...
# 549 "project/radare2/libr/cons/grep.c" 3 4
  { free((void *)
# 549 "project/radare2/libr/cons/grep.c"
  grep->json_path
# 549 "project/radare2/libr/cons/grep.c" 3 4
  ); 
# 549 "project/radare2/libr/cons/grep.c"
...
# 556 "project/radare2/libr/cons/grep.c" 3 4
   "\x1b[0m"
# 556 "project/radare2/libr/cons/grep.c"
              ,
    
# 557 "project/radare2/libr/cons/grep.c" 3 4
   ((void *)0)
   
# 558 "project/radare2/libr/cons/grep.c"
  };
   char *bb = strdup (buf);
   r_str_ansi_filter (bb, 
# 560 "project/radare2/libr/cons/grep.c" 3 4
                         ((void *)0)
# 560 "project/radare2/libr/cons/grep.c"
                             , 
# 560 "project/radare2/libr/cons/grep.c" 3 4
                               ((void *)0)
# 560 "project/radare2/libr/cons/grep.c"
   ...
   char *out = (cons->context->grep.human)
    ...
    : r_print_json_indent (bb, r_cons_singleton ()->context->color_mode, "  ", palette);
   free (bb);
   if (!out) {
    return;
   }
   ...
   if (grep->hud) {
    grep->hud = 
# 574 "project/radare2/libr/cons/grep.c" 3 4
               0
# 574 "project/radare2/libr/cons/grep.c"
                    ;
    r_cons_hud_string (cons->context->buffer);
   } else if (grep->less) {
    grep->less = 0;
    r_cons_less_str (cons->context->buffer, 
# 578 "project/radare2/libr/cons/grep.c" 3 4
                                           ((void *)0)
# 578 "project/radare2/libr/cons/grep.c"
                                               );
   }
  }
  return;
 ...
 if (grep->less) {
  ...
  if (less == 3) {
   ...
   r_cons_less_str (buf, 
# 600 "project/radare2/libr/cons/grep.c" 3 4
                        ((void *)0)
# 600 "project/radare2/libr/cons/grep.c"
                            );
   cons->context->buffer_len = 0;
...
# 605 "project/radare2/libr/cons/grep.c" 3 4
  { free((void *)
# 605 "project/radare2/libr/cons/grep.c"
  cons->context->buffer
# 605 "project/radare2/libr/cons/grep.c" 3 4
  ); 
# 605 "project/radare2/libr/cons/grep.c"
...
# 646 "project/radare2/libr/cons/grep.c" 3 4
_Bool 
# 646 "project/radare2/libr/cons/grep.c"
     is_range_line_grep_only = grep->range_line != 2 && grep->str && *grep->str == '\0';
 in = buf;
 while ((int) (size_t) (in - buf) < len) {
  char *p = strchr (in, '\n');
  if (!p) {
  ...
  if ((!l && is_range_line_grep_only) || l > 0) {
   ...
   if (cons->context->grep_color) {
    ...
    tl = r_str_ansi_filter (tline, 
# 659 "project/radare2/libr/cons/grep.c" 3 4
                                  ((void *)0)
# 659 "project/radare2/libr/cons/grep.c"
                                      , 
# 659 "project/radare2/libr/cons/grep.c" 3 4
                                        ((void *)0)
# 659 "project/radare2/libr/cons/grep.c"
   ...
   if (tl < 0) {
    ...
    if (!grep->range_line) {
     if (grep->line == cons->lines) {
      show = 
# 667 "project/radare2/libr/cons/grep.c" 3 4
            1
# 667 "project/radare2/libr/cons/grep.c"
                ;
     }
    } else if (grep->range_line == 1) {
     if (grep->f_line == cons->lines) {
      show = 
# 671 "project/radare2/libr/cons/grep.c" 3 4
            1
# 671 "project/radare2/libr/cons/grep.c"
                ;
     }
     if (grep->l_line == cons->lines) {
      show = 
# 674 "project/radare2/libr/cons/grep.c" 3 4
            0
# 674 "project/radare2/libr/cons/grep.c"
                 ;
     }
    } else {
     show = 
# 677 "project/radare2/libr/cons/grep.c" 3 4
           1
# 677 "project/radare2/libr/cons/grep.c"
               ;
    }
   }
    ...
    if (show) {
     ...
     if (cons->context->grep_highlight) {
      ...
      for (i = 0; i < grep->nstrings; i++) {
       char *newstr = r_str_newf (
# 686 "project/radare2/libr/cons/grep.c" 3 4
                                 "\x1b[7m"
# 686 "project/radare2/libr/cons/grep.c"
                                             "%s"
# 686 "project/radare2/libr/cons/grep.c" 3 4
                                                 "\x1b[0m"
# 686 "project/radare2/libr/cons/grep.c"
    ...
    if (!grep->range_line) {
     show = 
# 705 "project/radare2/libr/cons/grep.c" 3 4
           0
# 705 "project/radare2/libr/cons/grep.c"
                ;
    }
    cons->lines++;
   } else if (ret < 0) {
...
# 726 "project/radare2/libr/cons/grep.c" 3 4
 __builtin___snprintf_chk (
# 726 "project/radare2/libr/cons/grep.c"
 cons->context->buffer
# 726 "project/radare2/libr/cons/grep.c" 3 4
 , 
# 726 "project/radare2/libr/cons/grep.c"
...
# 738 "project/radare2/libr/cons/grep.c" 3 4
 __builtin___memcpy_chk (
# 738 "project/radare2/libr/cons/grep.c"
 cons->context->buffer
# 738 "project/radare2/libr/cons/grep.c" 3 4
 , 
# 738 "project/radare2/libr/cons/grep.c"
...
# 738 "project/radare2/libr/cons/grep.c"
 ...
 if (grep->sort != -1) {
#define INSERT_LINES(list) do { r_list_foreach (list, iter, str) { int len = strlen (str); memcpy (ptr, str, len); memcpy (ptr + len, "\n", 2); ptr += len + 1; nl++; } } while (false)
# 757 "project/radare2/libr/cons/grep.c"
  RListIter *iter;
  int nl = 0;
  ...
  do { 
# 768 "project/radare2/libr/cons/grep.c" 3 4
 if (
# 768 "project/radare2/libr/cons/grep.c"
 ctx->unsorted_lines
# 768 "project/radare2/libr/cons/grep.c" 3 4
 ) for (
# 768 "project/radare2/libr/cons/grep.c"
...
# 768 "project/radare2/libr/cons/grep.c"
  ...
  do { 
# 769 "project/radare2/libr/cons/grep.c" 3 4
 if (
# 769 "project/radare2/libr/cons/grep.c"
 ctx->sorted_lines
# 769 "project/radare2/libr/cons/grep.c" 3 4
 ) for (
# 769 "project/radare2/libr/cons/grep.c"
...
# 769 "project/radare2/libr/cons/grep.c"
  ...
  ctx->sorted_lines = 
# 772 "project/radare2/libr/cons/grep.c" 3 4
                     ((void *)0)
# 772 "project/radare2/libr/cons/grep.c"
                         ;
  r_list_free (ctx->unsorted_lines);
  ctx->unsorted_lines = 
# 774 "project/radare2/libr/cons/grep.c" 3 4
                       ((void *)0)
# 774 "project/radare2/libr/cons/grep.c"
                           ;
 }
}


# 778 "project/radare2/libr/cons/grep.c" 3 4
__attribute__((visibility("default"))) 
# 778 "project/radare2/libr/cons/grep.c"
     int r_cons_grep_line(char *buf, int len) {
 
# 779 "project/radare2/libr/cons/grep.c" 3 4
do { if (!(
# 779 "project/radare2/libr/cons/grep.c"
buf && len >= 0
# 779 "project/radare2/libr/cons/grep.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 779 "project/radare2/libr/cons/grep.c"
...
# 779 "project/radare2/libr/cons/grep.c"
 ...
 const char *delims = " |,;=\t";
 char *tok = 
# 783 "project/radare2/libr/cons/grep.c" 3 4
            ((void *)0)
# 783 "project/radare2/libr/cons/grep.c"
                ;
 
# 784 "project/radare2/libr/cons/grep.c" 3 4
_Bool 
# 784 "project/radare2/libr/cons/grep.c"
     hit = grep->neg;
 int outlen = 0;
 
# 786 "project/radare2/libr/cons/grep.c" 3 4
_Bool 
# 786 "project/radare2/libr/cons/grep.c"
     use_tok = 
# 786 "project/radare2/libr/cons/grep.c" 3 4
               0
# 786 "project/radare2/libr/cons/grep.c"
...
# 798 "project/radare2/libr/cons/grep.c" 3 4
__builtin___memcpy_chk (
# 798 "project/radare2/libr/cons/grep.c"
in
# 798 "project/radare2/libr/cons/grep.c" 3 4
, 
# 798 "project/radare2/libr/cons/grep.c"
...
# 798 "project/radare2/libr/cons/grep.c"
 ...
 if (grep->nstrings > 0) {
  ...
  if (grep->icase) {
   r_str_case (in, 
# 803 "project/radare2/libr/cons/grep.c" 3 4
                  0
# 803 "project/radare2/libr/cons/grep.c"
                       );
  }
  for (i = 0; i < grep->nstrings; i++) {
   ...
   if (grep->icase) {
    r_str_case (str, 
# 808 "project/radare2/libr/cons/grep.c" 3 4
                    0
# 808 "project/radare2/libr/cons/grep.c"
                         );
   }
 ...
 if (hit) {
  if (!grep->range_line) {
   if (grep->line == cons->lines) {
    use_tok = 
# 840 "project/radare2/libr/cons/grep.c" 3 4
             1
# 840 "project/radare2/libr/cons/grep.c"
                 ;
   }
  } else if (grep->range_line == 1) {
   use_tok = 
# 843 "project/radare2/libr/cons/grep.c" 3 4
            (((
# 843 "project/radare2/libr/cons/grep.c"
            cons->lines
# 843 "project/radare2/libr/cons/grep.c" 3 4
            )>=(
# 843 "project/radare2/libr/cons/grep.c"
...
# 843 "project/radare2/libr/cons/grep.c"
   ...
   use_tok = 
# 845 "project/radare2/libr/cons/grep.c" 3 4
            1
# 845 "project/radare2/libr/cons/grep.c"
                ;
  }
  if (use_tok && grep->tokens_used) {
   for (i = 0; i < 
# 848 "project/radare2/libr/cons/grep.c" 3 4
                  64
# 848 "project/radare2/libr/cons/grep.c"
                                    ; i++) {
    tok = strtok (i? 
# 849 "project/radare2/libr/cons/grep.c" 3 4
                    ((void *)0)
# 849 "project/radare2/libr/cons/grep.c"
                        : in, delims);
    if (tok) {
     if (grep->tokens[i]) {
      int toklen = strlen (tok);
      
# 853 "project/radare2/libr/cons/grep.c" 3 4
     __builtin___memcpy_chk (
# 853 "project/radare2/libr/cons/grep.c"
     out + outlen
# 853 "project/radare2/libr/cons/grep.c" 3 4
     , 
# 853 "project/radare2/libr/cons/grep.c"
...
# 854 "project/radare2/libr/cons/grep.c" 3 4
     __builtin___memcpy_chk (
# 854 "project/radare2/libr/cons/grep.c"
     out + outlen + toklen
# 854 "project/radare2/libr/cons/grep.c" 3 4
     , 
# 854 "project/radare2/libr/cons/grep.c"
...
# 873 "project/radare2/libr/cons/grep.c" 3 4
   fprintf(__stderrp,
# 873 "project/radare2/libr/cons/grep.c"
   "r_cons_grep_line: wtf, how you reach this?\n"
# 873 "project/radare2/libr/cons/grep.c" 3 4
   )
# 873 "project/radare2/libr/cons/grep.c"
                                                           ;
...
# 878 "project/radare2/libr/cons/grep.c" 3 4
  __builtin___memcpy_chk (
# 878 "project/radare2/libr/cons/grep.c"
  buf
# 878 "project/radare2/libr/cons/grep.c" 3 4
  , 
# 878 "project/radare2/libr/cons/grep.c"
...
# 906 "project/radare2/libr/cons/grep.c" 3 4
__attribute__((visibility("default"))) 
# 906 "project/radare2/libr/cons/grep.c"
     void r_cons_grep(const char *grep) {
 
# 907 "project/radare2/libr/cons/grep.c" 3 4
do { if (!(
# 907 "project/radare2/libr/cons/grep.c"
grep
# 907 "project/radare2/libr/cons/grep.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 907 "project/radare2/libr/cons/grep.c"
