# 0 "project/radare2/libr/cons/2048.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/cons/2048.c"
...
# 4 "project/radare2/libr/cons/2048.c" 2


# 5 "project/radare2/libr/cons/2048.c"
static 
# 5 "project/radare2/libr/cons/2048.c" 3 4
      unsigned char 
# 5 "project/radare2/libr/cons/2048.c"
          twok_buf[4][4];
static int score = 0;
...
static void twok_add(void) {
 int i, j;
 while (
# 21 "project/radare2/libr/cons/2048.c" 3 4
       1
# 21 "project/radare2/libr/cons/2048.c"
           ) {
  i = r_num_rand (4);
  j = r_num_rand (4);
  if (!twok_buf[i][j]) {
...
static 
# 31 "project/radare2/libr/cons/2048.c" 3 4
      _Bool 
# 31 "project/radare2/libr/cons/2048.c"
           twok_fin(void) {
 int i, j;
 for (i = 0; i < 4; i++) {
  for (j = 0; j < 4; j++) {
   if (!twok_buf[i][j]) {
    return 
# 36 "project/radare2/libr/cons/2048.c" 3 4
          1
# 36 "project/radare2/libr/cons/2048.c"
              ;
   }
  }
 }
 for (i = 0; i < 4; i++) {
  for (j = 0; j < 3; j++) {
   if (twok_buf[i][j] == twok_buf[i][j + 1]) {
    return 
# 43 "project/radare2/libr/cons/2048.c" 3 4
          1
# 43 "project/radare2/libr/cons/2048.c"
              ;
   }
  }
 }
 for (i = 0; i < 3; i++) {
  for (j = 0; j < 4; j++) {
   if (twok_buf[i][j] == twok_buf[i + 1][j]) {
    return 
# 50 "project/radare2/libr/cons/2048.c" 3 4
          1
# 50 "project/radare2/libr/cons/2048.c"
              ;
   }
  }
 }
 return 
# 54 "project/radare2/libr/cons/2048.c" 3 4
       0
# 54 "project/radare2/libr/cons/2048.c"
            ;
}
...
static void getval(
# 89 "project/radare2/libr/cons/2048.c" 3 4
                  _Bool 
# 89 "project/radare2/libr/cons/2048.c"
                       color, char *val0, int i, int x) {
 const char * colorarray[] = {
  
# 91 "project/radare2/libr/cons/2048.c" 3 4
 "\x1b[37m"
# 91 "project/radare2/libr/cons/2048.c"
            ,
  
# 92 "project/radare2/libr/cons/2048.c" 3 4
 "\x1b[31m"
# 92 "project/radare2/libr/cons/2048.c"
          ,
  
# 93 "project/radare2/libr/cons/2048.c" 3 4
 "\x1b[32m"
# 93 "project/radare2/libr/cons/2048.c"
            ,
  
# 94 "project/radare2/libr/cons/2048.c" 3 4
 "\x1b[35m"
# 94 "project/radare2/libr/cons/2048.c"
              ,
  
# 95 "project/radare2/libr/cons/2048.c" 3 4
 "\x1b[33m"
# 95 "project/radare2/libr/cons/2048.c"
             ,
  
# 96 "project/radare2/libr/cons/2048.c" 3 4
 "\x1b[36m"
# 96 "project/radare2/libr/cons/2048.c"
           ,
  
# 97 "project/radare2/libr/cons/2048.c" 3 4
 "\x1b[34m"
# 97 "project/radare2/libr/cons/2048.c"
           ,
  
# 98 "project/radare2/libr/cons/2048.c" 3 4
 "\x1b[90m"
 
# 99 "project/radare2/libr/cons/2048.c"
};
 if (twok_buf[i][x]) {
  if (color) {
   
# 102 "project/radare2/libr/cons/2048.c" 3 4
  __builtin___snprintf_chk (
# 102 "project/radare2/libr/cons/2048.c"
  val0
# 102 "project/radare2/libr/cons/2048.c" 3 4
  , 
# 102 "project/radare2/libr/cons/2048.c"
...
# 102 "project/radare2/libr/cons/2048.c" 3 4
  "\x1b[0m"
# 102 "project/radare2/libr/cons/2048.c"
  , colorarray [twok_buf [i][x] % 8 ], 1 << twok_buf[i][x]
# 102 "project/radare2/libr/cons/2048.c" 3 4
  )
# 102 "project/radare2/libr/cons/2048.c"
                                                                                                ;
...
# 104 "project/radare2/libr/cons/2048.c" 3 4
  __builtin___snprintf_chk (
# 104 "project/radare2/libr/cons/2048.c"
  val0
# 104 "project/radare2/libr/cons/2048.c" 3 4
  , 
# 104 "project/radare2/libr/cons/2048.c"
...
# 107 "project/radare2/libr/cons/2048.c" 3 4
 __builtin___strcpy_chk (
# 107 "project/radare2/libr/cons/2048.c"
 val0
# 107 "project/radare2/libr/cons/2048.c" 3 4
 , 
# 107 "project/radare2/libr/cons/2048.c"
...
# 111 "project/radare2/libr/cons/2048.c" 3 4
                      _Bool 
# 111 "project/radare2/libr/cons/2048.c"
                           color) {
 char val0[32];
 char val1[32];
 char val2[32];
 ...
 if (color) {
  printf (
# 118 "project/radare2/libr/cons/2048.c" 3 4
         "\x1b[94m"
# 118 "project/radare2/libr/cons/2048.c"
                    "  +------+------+------+------+\n");
 } else {
  printf ("  +------+------+------+------+\n");
 }
 for (i = 0; i < 4; i++) {
  ...
  if (color) {
   printf (
# 128 "project/radare2/libr/cons/2048.c" 3 4
          "\x1b[94m"
# 128 "project/radare2/libr/cons/2048.c"
                     "  |      |      |      |      |\n");
   printf ("  |"
# 129 "project/radare2/libr/cons/2048.c" 3 4
               "\x1b[0m"
# 129 "project/radare2/libr/cons/2048.c"
                          " %s "
# 129 "project/radare2/libr/cons/2048.c" 3 4
                                "\x1b[94m"
# 129 "project/radare2/libr/cons/2048.c"
...
# 130 "project/radare2/libr/cons/2048.c" 3 4
   "\x1b[94m"
# 130 "project/radare2/libr/cons/2048.c"
              "|"
# 130 "project/radare2/libr/cons/2048.c" 3 4
                 "\x1b[0m"
# 130 "project/radare2/libr/cons/2048.c"
...
# 130 "project/radare2/libr/cons/2048.c"
   ...
   printf ("  |      |      |      |      |\n");
   printf ("  +------+------+------+------+\n"
# 133 "project/radare2/libr/cons/2048.c" 3 4
                                             "\x1b[0m"
# 133 "project/radare2/libr/cons/2048.c"
                                                        );
  } else {
   printf ("  |      |      |      |      |\n");
   printf ("  | %s | %s | %s | %s |\n",
...
# 150 "project/radare2/libr/cons/2048.c" 3 4
__attribute__((visibility("default"))) 
# 150 "project/radare2/libr/cons/2048.c"
     void r_cons_2048(
# 150 "project/radare2/libr/cons/2048.c" 3 4
                      _Bool 
# 150 "project/radare2/libr/cons/2048.c"
 ...
 while (twok_fin ()) {
  ...
  if (color) {
   r_cons_printf (
# 159 "project/radare2/libr/cons/2048.c" 3 4
                 "\x1b[32m"
# 159 "project/radare2/libr/cons/2048.c"
                            "[r2048]"
# 159 "project/radare2/libr/cons/2048.c" 3 4
                                     "\x1b[93m"
# 159 "project/radare2/libr/cons/2048.c"
