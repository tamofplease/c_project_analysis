# 0 "project/radare2/libr/cons/cutf8.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 5 "project/radare2/libr/cons/cutf8.c" 2



# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/fcntl.h" 1 3 4
# 9 "project/radare2/libr/cons/cutf8.c" 2



# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/errno.h" 1 3 4
# 13 "project/radare2/libr/cons/cutf8.c" 2
...
# 54 "project/radare2/libr/cons/cutf8.c"
...
int current_tty(void) {
 ...
 int fd;
 const char *dev = ttyname(
# 63 "project/radare2/libr/cons/cutf8.c" 3 4
                          2
# 63 "project/radare2/libr/cons/cutf8.c"
                                       );
...
# 71 "project/radare2/libr/cons/cutf8.c" 3 4
 (*__error()) 
# 71 "project/radare2/libr/cons/cutf8.c"
       = 
# 71 "project/radare2/libr/cons/cutf8.c" 3 4
         25
# 71 "project/radare2/libr/cons/cutf8.c"
 ...
 do {
  fd = open (dev, 
# 76 "project/radare2/libr/cons/cutf8.c" 3 4
                 0x0002 
# 76 "project/radare2/libr/cons/cutf8.c"
                        | 
# 76 "project/radare2/libr/cons/cutf8.c" 3 4
                          0x00020000
# 76 "project/radare2/libr/cons/cutf8.c"
...
# 77 "project/radare2/libr/cons/cutf8.c" 3 4
                     (*__error()) 
# 77 "project/radare2/libr/cons/cutf8.c"
                           == 
# 77 "project/radare2/libr/cons/cutf8.c" 3 4
                              4
# 77 "project/radare2/libr/cons/cutf8.c"
...
# 207 "project/radare2/libr/cons/cutf8.c"

# 207 "project/radare2/libr/cons/cutf8.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 207 "project/radare2/libr/cons/cutf8.c"
          r_cons_is_utf8(void) {
 
# 208 "project/radare2/libr/cons/cutf8.c" 3 4
_Bool 
# 208 "project/radare2/libr/cons/cutf8.c"
     ret = 
# 208 "project/radare2/libr/cons/cutf8.c" 3 4
           0
# 208 "project/radare2/libr/cons/cutf8.c"
...
# 212 "project/radare2/libr/cons/cutf8.c" 3 4
 _Bool 
# 212 "project/radare2/libr/cons/cutf8.c"
      is_set = *e;
  if (is_set) {
   ret = r_str_is_true (e);
  }
...
# 223 "project/radare2/libr/cons/cutf8.c" 3 4
                                                     ((void *)0) 
# 223 "project/radare2/libr/cons/cutf8.c"
                                                          };
 const char **key = keys;
 for (; *key; key++) {
  ...
  if (val) {
   r_str_case (val, 
# 228 "project/radare2/libr/cons/cutf8.c" 3 4
                   0
# 228 "project/radare2/libr/cons/cutf8.c"
                        );
...
# 262 "project/radare2/libr/cons/cutf8.c"
 return ret;
}
