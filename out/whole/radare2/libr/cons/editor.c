# 0 "project/radare2/libr/cons/editor.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/cons/editor.c"
...
# 4 "project/radare2/libr/cons/editor.c" 2
#define I r_cons_singleton ()



# 7 "project/radare2/libr/cons/editor.c"
static char *lines = 
# 7 "project/radare2/libr/cons/editor.c" 3 4
                    ((void *)0)
# 7 "project/radare2/libr/cons/editor.c"
                        ;
static char *path = 
# 8 "project/radare2/libr/cons/editor.c" 3 4
                   ((void *)0)
# 8 "project/radare2/libr/cons/editor.c"
                       ;
...
# 13 "project/radare2/libr/cons/editor.c" 3 4
__builtin___snprintf_chk (
# 13 "project/radare2/libr/cons/editor.c"
prompt
# 13 "project/radare2/libr/cons/editor.c" 3 4
, 
# 13 "project/radare2/libr/cons/editor.c"
...
# 15 "project/radare2/libr/cons/editor.c" 3 4
__builtin___strncpy_chk (
# 15 "project/radare2/libr/cons/editor.c"
r_cons_singleton ()->line->buffer.data
# 15 "project/radare2/libr/cons/editor.c" 3 4
, 
# 15 "project/radare2/libr/cons/editor.c"
r_str_word_get0 (lines, _n), sizeof (r_cons_singleton ()->line->buffer.data) - 1
# 15 "project/radare2/libr/cons/editor.c" 3 4
...
# 16 "project/radare2/libr/cons/editor.c"
                                   ;
 r_cons_singleton ()->line->buffer.data[sizeof (r_cons_singleton ()->line->buffer.data) - 1] = '\0';
 r_cons_singleton ()->line->buffer.index = r_cons_singleton ()->line->buffer.length = strlen (r_cons_singleton ()->line->buffer.data);
 r_cons_singleton ()->line->contents = r_cons_singleton ()->line->buffer.data;
}
...
# 51 "project/radare2/libr/cons/editor.c" 3 4
 fprintf(__stderrp,
# 51 "project/radare2/libr/cons/editor.c"
 "File: "
# 51 "project/radare2/libr/cons/editor.c" 3 4
 )
# 51 "project/radare2/libr/cons/editor.c"
...
# 53 "project/radare2/libr/cons/editor.c" 3 4
                               __stdinp
# 53 "project/radare2/libr/cons/editor.c"
                                    )) {
   if (buf[0]) {
    r_str_trim_tail (buf);
    free (path);
...
# 62 "project/radare2/libr/cons/editor.c" 3 4
 fprintf(__stderrp,
# 62 "project/radare2/libr/cons/editor.c"
 "No file given.\n"
# 62 "project/radare2/libr/cons/editor.c" 3 4
 )
# 62 "project/radare2/libr/cons/editor.c"
...
# 72 "project/radare2/libr/cons/editor.c" 3 4
                              unsigned char 
# 72 "project/radare2/libr/cons/editor.c"
                                  *)lines, bytes, 0)) {
  
# 73 "project/radare2/libr/cons/editor.c" 3 4
 fprintf(__stderrp,
# 73 "project/radare2/libr/cons/editor.c"
 "File '%s' saved (%d byte(s))\n", path, bytes
# 73 "project/radare2/libr/cons/editor.c" 3 4
 )
# 73 "project/radare2/libr/cons/editor.c"
                                                        ;
...
# 75 "project/radare2/libr/cons/editor.c" 3 4
 fprintf(__stderrp,
# 75 "project/radare2/libr/cons/editor.c"
 "Cannot save file\n"
# 75 "project/radare2/libr/cons/editor.c" 3 4
 )
# 75 "project/radare2/libr/cons/editor.c"
...
# 80 "project/radare2/libr/cons/editor.c" 3 4
__attribute__((visibility("default"))) 
# 80 "project/radare2/libr/cons/editor.c"
     char *r_cons_editor(const char *file, const char *str) {
 const char *line;
 _n = 0;
 if (r_cons_singleton ()->cb_editor) {
  return r_cons_singleton ()->cb_editor (r_cons_singleton ()->user, file, str);
 }
 free (path);
 if (file) {
  path = strdup (file);
...
# 94 "project/radare2/libr/cons/editor.c" 3 4
  fprintf(__stderrp,
# 94 "project/radare2/libr/cons/editor.c"
  "Failed to load '%s'.\n", file
# 94 "project/radare2/libr/cons/editor.c" 3 4
  )
# 94 "project/radare2/libr/cons/editor.c"
...
# 95 "project/radare2/libr/cons/editor.c" 3 4
  { free((void *)
# 95 "project/radare2/libr/cons/editor.c"
  path
# 95 "project/radare2/libr/cons/editor.c" 3 4
  ); 
# 95 "project/radare2/libr/cons/editor.c"
...
# 95 "project/radare2/libr/cons/editor.c"
               ;
   return 
# 96 "project/radare2/libr/cons/editor.c" 3 4
         ((void *)0)
# 96 "project/radare2/libr/cons/editor.c"
             ;
  }
  nlines = r_str_split (lines, '\n');
  
# 99 "project/radare2/libr/cons/editor.c" 3 4
 fprintf(__stderrp,
# 99 "project/radare2/libr/cons/editor.c"
 "Loaded %d lines on %d byte(s)\n", (nlines? (nlines - 1): 0), bytes
# 99 "project/radare2/libr/cons/editor.c" 3 4
 )
                                    
# 100 "project/radare2/libr/cons/editor.c"
                                   ;
 } else {
  path = 
# 102 "project/radare2/libr/cons/editor.c" 3 4
        ((void *)0)
# 102 "project/radare2/libr/cons/editor.c"
            ;
 }
 r_cons_singleton ()->line->hist_up = up;
 r_cons_singleton ()->line->hist_down = down;
 r_cons_singleton ()->line->contents = r_cons_singleton ()->line->buffer.data;
 for (;;) {
  setnewline (_n);
  
# 109 "project/radare2/libr/cons/editor.c" 3 4
 __builtin___snprintf_chk (
# 109 "project/radare2/libr/cons/editor.c"
 prompt
# 109 "project/radare2/libr/cons/editor.c" 3 4
 , 
# 109 "project/radare2/libr/cons/editor.c"
...
# 109 "project/radare2/libr/cons/editor.c"
 ...
 filesave ();
 r_cons_singleton ()->line->hist_up = 
# 119 "project/radare2/libr/cons/editor.c" 3 4
                   ((void *)0)
# 119 "project/radare2/libr/cons/editor.c"
                       ;
 r_cons_singleton ()->line->hist_down = 
# 120 "project/radare2/libr/cons/editor.c" 3 4
                     ((void *)0)
# 120 "project/radare2/libr/cons/editor.c"
                         ;
 r_cons_singleton ()->line->contents = 
# 121 "project/radare2/libr/cons/editor.c" 3 4
                    ((void *)0)
# 121 "project/radare2/libr/cons/editor.c"
                        ;
 return lines;
}
