# 0 "project/radare2/libr/cons/canvas.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/cons/canvas.c"
...
# 4 "project/radare2/libr/cons/canvas.c" 2
...
# 12 "project/radare2/libr/cons/canvas.c"
static inline 
# 12 "project/radare2/libr/cons/canvas.c" 3 4
             _Bool 
# 12 "project/radare2/libr/cons/canvas.c"
                  __isAnsiSequence(const char *s) {
...
static const char *__attributeAt(RConsCanvas *c, int loc) {
 if (!c->color) {
  return 
# 36 "project/radare2/libr/cons/canvas.c" 3 4
        ((void *)0)
# 36 "project/radare2/libr/cons/canvas.c"
            ;
 }
 return ht_up_find (c->attrs, loc, 
# 38 "project/radare2/libr/cons/canvas.c" 3 4
                                  ((void *)0)
# 38 "project/radare2/libr/cons/canvas.c"
                                      );
}
...
static const char *set_attr(RConsCanvas *c, const char *s) {
 if (!c || !s) {
  return 
# 55 "project/radare2/libr/cons/canvas.c" 3 4
        ((void *)0)
# 55 "project/radare2/libr/cons/canvas.c"
            ;
 }
 const char *p = s;
...
static 
# 108 "project/radare2/libr/cons/canvas.c" 3 4
      _Bool 
# 108 "project/radare2/libr/cons/canvas.c"
           __expandLine(RConsCanvas *c, int real_len, int utf8_len) {
 if (real_len == 0) {
  return 
# 110 "project/radare2/libr/cons/canvas.c" 3 4
        1
# 110 "project/radare2/libr/cons/canvas.c"
            ;
 }
 int buf_utf8_len = __getUtf8Length2 (c->b[c->y] + c->x, utf8_len, c->blen[c->y] - c->x);
 int goback = 
# 113 "project/radare2/libr/cons/canvas.c" 3 4
             (((
# 113 "project/radare2/libr/cons/canvas.c"
             0
# 113 "project/radare2/libr/cons/canvas.c" 3 4
             )>(
# 113 "project/radare2/libr/cons/canvas.c"
             (buf_utf8_len - utf8_len)
# 113 "project/radare2/libr/cons/canvas.c" 3 4
             ))?(
# 113 "project/radare2/libr/cons/canvas.c"
             0
...
# 113 "project/radare2/libr/cons/canvas.c"
 ...
 if (padding) {
  if (padding > 0 && c->blen[c->y] + padding > c->bsize[c->y]) {
   int newsize = 
# 118 "project/radare2/libr/cons/canvas.c" 3 4
                (((
# 118 "project/radare2/libr/cons/canvas.c"
                (int)(c->bsize[c->y] * 1.5)
# 118 "project/radare2/libr/cons/canvas.c" 3 4
                )>(
# 118 "project/radare2/libr/cons/canvas.c"
...
# 118 "project/radare2/libr/cons/canvas.c"
   ...
   if (!newline) {
    return 
# 121 "project/radare2/libr/cons/canvas.c" 3 4
          0
# 121 "project/radare2/libr/cons/canvas.c"
               ;
   }
   
# 123 "project/radare2/libr/cons/canvas.c" 3 4
  __builtin___memset_chk (
# 123 "project/radare2/libr/cons/canvas.c"
  newline + c->bsize[c->y]
# 123 "project/radare2/libr/cons/canvas.c" 3 4
  , 
# 123 "project/radare2/libr/cons/canvas.c"
  0, newsize - c->bsize[c->y]
# 123 "project/radare2/libr/cons/canvas.c" 3 4
...
# 123 "project/radare2/libr/cons/canvas.c"
  ...
  int size = 
# 127 "project/radare2/libr/cons/canvas.c" 3 4
            (((
# 127 "project/radare2/libr/cons/canvas.c"
            c->blen[c->y] - c->x - goback
# 127 "project/radare2/libr/cons/canvas.c" 3 4
            )>(
# 127 "project/radare2/libr/cons/canvas.c"
            0
...
# 127 "project/radare2/libr/cons/canvas.c"
  ...
  if (!tmp) {
   return 
# 131 "project/radare2/libr/cons/canvas.c" 3 4
         0
# 131 "project/radare2/libr/cons/canvas.c"
              ;
  }
  
# 133 "project/radare2/libr/cons/canvas.c" 3 4
 __builtin___memcpy_chk (
# 133 "project/radare2/libr/cons/canvas.c"
 tmp
# 133 "project/radare2/libr/cons/canvas.c" 3 4
 , 
# 133 "project/radare2/libr/cons/canvas.c"
...
# 133 "project/radare2/libr/cons/canvas.c"
  ...
  if (padding < 0) {
   int lap = 
# 135 "project/radare2/libr/cons/canvas.c" 3 4
            (((
# 135 "project/radare2/libr/cons/canvas.c"
            0
# 135 "project/radare2/libr/cons/canvas.c" 3 4
            )>(
# 135 "project/radare2/libr/cons/canvas.c"
            c->b[c->y] - (start + padding)
# 135 "project/radare2/libr/cons/canvas.c" 3 4
            ))?(
# 135 "project/radare2/libr/cons/canvas.c"
            0
...
# 136 "project/radare2/libr/cons/canvas.c" 3 4
  __builtin___memcpy_chk (
# 136 "project/radare2/libr/cons/canvas.c"
  start + padding + lap
# 136 "project/radare2/libr/cons/canvas.c" 3 4
  , 
# 136 "project/radare2/libr/cons/canvas.c"
...
# 136 "project/radare2/libr/cons/canvas.c"
   ...
   c->blen[c->y] += padding;
   return 
# 139 "project/radare2/libr/cons/canvas.c" 3 4
         1
# 139 "project/radare2/libr/cons/canvas.c"
             ;
  }
  
# 141 "project/radare2/libr/cons/canvas.c" 3 4
 __builtin___memcpy_chk (
# 141 "project/radare2/libr/cons/canvas.c"
 start + padding
# 141 "project/radare2/libr/cons/canvas.c" 3 4
 , 
# 141 "project/radare2/libr/cons/canvas.c"
...
# 141 "project/radare2/libr/cons/canvas.c"
 ...
 return 
# 145 "project/radare2/libr/cons/canvas.c" 3 4
       1
# 145 "project/radare2/libr/cons/canvas.c"
           ;
}


# 148 "project/radare2/libr/cons/canvas.c" 3 4
__attribute__((visibility("default"))) 
# 148 "project/radare2/libr/cons/canvas.c"
...
static 
# 166 "project/radare2/libr/cons/canvas.c" 3 4
      _Bool 
# 166 "project/radare2/libr/cons/canvas.c"
           attribute_delete_cb(void *user, const 
# 166 "project/radare2/libr/cons/canvas.c" 3 4
                                                 unsigned long long 
# 166 "project/radare2/libr/cons/canvas.c"
 ...
 ht_up_delete (ht, key);
 return 
# 169 "project/radare2/libr/cons/canvas.c" 3 4
       1
# 169 "project/radare2/libr/cons/canvas.c"
           ;
}


# 172 "project/radare2/libr/cons/canvas.c" 3 4
__attribute__((visibility("default"))) 
# 172 "project/radare2/libr/cons/canvas.c"
     void r_cons_canvas_clear(RConsCanvas *c) {
 
# 173 "project/radare2/libr/cons/canvas.c" 3 4
do { if (!(
# 173 "project/radare2/libr/cons/canvas.c"
c && c->b
# 173 "project/radare2/libr/cons/canvas.c" 3 4
...
# 176 "project/radare2/libr/cons/canvas.c" 3 4
 __builtin___memset_chk (
# 176 "project/radare2/libr/cons/canvas.c"
 c->b[y]
# 176 "project/radare2/libr/cons/canvas.c" 3 4
 , 
# 176 "project/radare2/libr/cons/canvas.c"
...
# 182 "project/radare2/libr/cons/canvas.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 182 "project/radare2/libr/cons/canvas.c"
          r_cons_canvas_gotoxy(RConsCanvas *c, int x, int y) {
 
# 183 "project/radare2/libr/cons/canvas.c" 3 4
_Bool 
# 183 "project/radare2/libr/cons/canvas.c"
     ret = 
# 183 "project/radare2/libr/cons/canvas.c" 3 4
           1
# 183 "project/radare2/libr/cons/canvas.c"
 ...
 if (y > c->h * 2) {
  return 
# 191 "project/radare2/libr/cons/canvas.c" 3 4
        0
# 191 "project/radare2/libr/cons/canvas.c"
             ;
 }
 if (y >= c->h) {
  y = c->h - 1;
  ret = 
# 195 "project/radare2/libr/cons/canvas.c" 3 4
       0
# 195 "project/radare2/libr/cons/canvas.c"
            ;
 }
 if (y < 0) {
  y = 0;
  ret = 
# 199 "project/radare2/libr/cons/canvas.c" 3 4
       0
# 199 "project/radare2/libr/cons/canvas.c"
            ;
 }
 if (x < 0) {

  ret = 
# 203 "project/radare2/libr/cons/canvas.c" 3 4
       0
# 203 "project/radare2/libr/cons/canvas.c"
            ;
 }
 if (x > c->blen[y] * 2) {
  return 
# 206 "project/radare2/libr/cons/canvas.c" 3 4
        0
# 206 "project/radare2/libr/cons/canvas.c"
             ;
 }
 if (x >= c->blen[y]) {
  c->x = c->blen[y];
  ret = 
# 210 "project/radare2/libr/cons/canvas.c" 3 4
       0
# 210 "project/radare2/libr/cons/canvas.c"
            ;
 }
 if (x < c->blen[y] && x >= 0) {
  c->x = x;
...
# 221 "project/radare2/libr/cons/canvas.c" 3 4
__attribute__((visibility("default"))) 
# 221 "project/radare2/libr/cons/canvas.c"
     RConsCanvas *r_cons_canvas_new(int w, int h) {
 if (w < 1 || h < 1) {
  return 
# 223 "project/radare2/libr/cons/canvas.c" 3 4
        ((void *)0)
# 223 "project/radare2/libr/cons/canvas.c"
            ;
 }
 RConsCanvas *c = 
# 225 "project/radare2/libr/cons/canvas.c" 3 4
                 (
# 225 "project/radare2/libr/cons/canvas.c"
                 RConsCanvas
# 225 "project/radare2/libr/cons/canvas.c" 3 4
                 *)calloc(1,sizeof(
# 225 "project/radare2/libr/cons/canvas.c"
...
# 225 "project/radare2/libr/cons/canvas.c"
 ...
 if (!c) {
  return 
# 227 "project/radare2/libr/cons/canvas.c" 3 4
        ((void *)0)
# 227 "project/radare2/libr/cons/canvas.c"
            ;
 }
 c->bsize = 
# 229 "project/radare2/libr/cons/canvas.c" 3 4
           ((void *)0)
# 229 "project/radare2/libr/cons/canvas.c"
               ;
 c->blen = 
# 230 "project/radare2/libr/cons/canvas.c" 3 4
          ((void *)0)
# 230 "project/radare2/libr/cons/canvas.c"
              ;
 int i = 0;
 c->color = 0;
 c->sx = 0;
 ...
 c->attrs = ht_up_new ((HtUPDupValue)strdup, attribute_free_kv, 
# 261 "project/radare2/libr/cons/canvas.c" 3 4
                                                               ((void *)0)
# 261 "project/radare2/libr/cons/canvas.c"
                                                                   );
 if (!c->attrs) {
  goto beach;
 }
 c->attr = 
# 265 "project/radare2/libr/cons/canvas.c" 3 4
          "\x1b[0m"
# 265 "project/radare2/libr/cons/canvas.c"
                     ;
...
beach:
 ...
 free (c);
 return 
# 278 "project/radare2/libr/cons/canvas.c" 3 4
       ((void *)0)
# 278 "project/radare2/libr/cons/canvas.c"
           ;
}


# 281 "project/radare2/libr/cons/canvas.c" 3 4
__attribute__((visibility("default"))) 
# 281 "project/radare2/libr/cons/canvas.c"
     void r_cons_canvas_write(RConsCanvas *c, const char *s) {
 if (!c || !s || !*s || !
# 282 "project/radare2/libr/cons/canvas.c" 3 4
                        (((
# 282 "project/radare2/libr/cons/canvas.c"
                        c->y
# 282 "project/radare2/libr/cons/canvas.c" 3 4
                        )>=(
# 282 "project/radare2/libr/cons/canvas.c"
...
# 282 "project/radare2/libr/cons/canvas.c"
 ...
 r_cons_break_push (
# 294 "project/radare2/libr/cons/canvas.c" 3 4
                   ((void *)0)
# 294 "project/radare2/libr/cons/canvas.c"
                       , 
# 294 "project/radare2/libr/cons/canvas.c" 3 4
                         ((void *)0)
# 294 "project/radare2/libr/cons/canvas.c"
 ...
 do {
  ...
  if (r_cons_canvas_gotoxy (c, c->x - c->sx, c->y - c->sy)) {
   
# 320 "project/radare2/libr/cons/canvas.c" 3 4
  __builtin___memcpy_chk (
# 320 "project/radare2/libr/cons/canvas.c"
  c->b[c->y] + c->x
# 320 "project/radare2/libr/cons/canvas.c" 3 4
  , 
# 320 "project/radare2/libr/cons/canvas.c"
...
# 320 "project/radare2/libr/cons/canvas.c"
  ...
  if (ch == '\n') {
   c->attr = 
# 330 "project/radare2/libr/cons/canvas.c" 3 4
            "\x1b[0m"
# 330 "project/radare2/libr/cons/canvas.c"
                       ;
...
# 349 "project/radare2/libr/cons/canvas.c" 3 4
__attribute__((visibility("default"))) 
# 349 "project/radare2/libr/cons/canvas.c"
     char *r_cons_canvas_to_string(RConsCanvas *c) {
 
# 350 "project/radare2/libr/cons/canvas.c" 3 4
do { if (!(
# 350 "project/radare2/libr/cons/canvas.c"
c
# 350 "project/radare2/libr/cons/canvas.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 350 "project/radare2/libr/cons/canvas.c"
"c"
# 350 "project/radare2/libr/cons/canvas.c" 3 4
, 350); return (((void *)0)); } } while (0)
# 350 "project/radare2/libr/cons/canvas.c"
                              ;

 int x, y, olen = 0, attr_x = 0;
 
# 353 "project/radare2/libr/cons/canvas.c" 3 4
_Bool 
# 353 "project/radare2/libr/cons/canvas.c"
     is_first = 
# 353 "project/radare2/libr/cons/canvas.c" 3 4
                1
# 353 "project/radare2/libr/cons/canvas.c"
 ...
 char *o = calloc (1, olen * 4 * 
# 358 "project/radare2/libr/cons/canvas.c" 3 4
                                16
# 358 "project/radare2/libr/cons/canvas.c"
                                                );
 if (!o) {
  return 
# 360 "project/radare2/libr/cons/canvas.c" 3 4
        ((void *)0)
# 360 "project/radare2/libr/cons/canvas.c"
            ;
 }
 if (!olen) {
  free (o);
  return 
# 364 "project/radare2/libr/cons/canvas.c" 3 4
        ((void *)0)
# 364 "project/radare2/libr/cons/canvas.c"
            ;
 }
 ...
 for (y = 0; y < c->h; y++) {
  ...
  is_first = 
# 372 "project/radare2/libr/cons/canvas.c" 3 4
            0
# 372 "project/radare2/libr/cons/canvas.c"
                 ;
  attr_x = 0;
...
# 379 "project/radare2/libr/cons/canvas.c" 3 4
    __builtin___memcpy_chk (
# 379 "project/radare2/libr/cons/canvas.c"
    o + olen
# 379 "project/radare2/libr/cons/canvas.c" 3 4
    , 
# 379 "project/radare2/libr/cons/canvas.c"
...
# 379 "project/radare2/libr/cons/canvas.c"
   ...
   const char *rune = r_cons_get_rune ((const 
# 391 "project/radare2/libr/cons/canvas.c" 3 4
                                             unsigned char
# 391 "project/radare2/libr/cons/canvas.c"
                                                )c->b[y][x]);
   if (rune) {
    size_t rune_len = strlen (rune);
    
# 394 "project/radare2/libr/cons/canvas.c" 3 4
   __builtin___memcpy_chk (
# 394 "project/radare2/libr/cons/canvas.c"
   o + olen
# 394 "project/radare2/libr/cons/canvas.c" 3 4
   , 
# 394 "project/radare2/libr/cons/canvas.c"
...
# 408 "project/radare2/libr/cons/canvas.c" 3 4
__attribute__((visibility("default"))) 
# 408 "project/radare2/libr/cons/canvas.c"
     void r_cons_canvas_print_region(RConsCanvas *c) {
...
# 419 "project/radare2/libr/cons/canvas.c" 3 4
__attribute__((visibility("default"))) 
# 419 "project/radare2/libr/cons/canvas.c"
     void r_cons_canvas_print(RConsCanvas *c) {
 char *o = r_cons_canvas_to_string (c);
 if (o) {
  r_cons_strcat (o);
  free (o);
...
# 427 "project/radare2/libr/cons/canvas.c" 3 4
__attribute__((visibility("default"))) 
# 427 "project/radare2/libr/cons/canvas.c"
     int r_cons_canvas_resize(RConsCanvas *c, int w, int h) {
 if (!c || w < 0 || h <= 0) {
  return 
# 429 "project/radare2/libr/cons/canvas.c" 3 4
        0
# 429 "project/radare2/libr/cons/canvas.c"
             ;
 }
 ...
 if (!newblen) {
  ...
  return 
# 434 "project/radare2/libr/cons/canvas.c" 3 4
        0
# 434 "project/radare2/libr/cons/canvas.c"
             ;
 }
 c->blen = newblen;
 ...
 if (!newbsize) {
  r_cons_canvas_free (c);
  return 
# 440 "project/radare2/libr/cons/canvas.c" 3 4
        0
# 440 "project/radare2/libr/cons/canvas.c"
             ;
 }
 c->bsize = newbsize;
 ...
 if (!newb) {
  r_cons_canvas_free (c);
  return 
# 446 "project/radare2/libr/cons/canvas.c" 3 4
        0
# 446 "project/radare2/libr/cons/canvas.c"
             ;
 }
 c->b = newb;
 int i;
 char *newline = 
# 450 "project/radare2/libr/cons/canvas.c" 3 4
                ((void *)0)
# 450 "project/radare2/libr/cons/canvas.c"
                    ;
 for (i = 0; i < h; i++) {
  if (i < c->h) {
  ...
  if (!newline) {
   ...
   free (c);
   return 
# 469 "project/radare2/libr/cons/canvas.c" 3 4
         0
# 469 "project/radare2/libr/cons/canvas.c"
              ;
  }
  c->b[i] = newline;
 }
 ...
 r_cons_canvas_clear (c);
 return 
# 478 "project/radare2/libr/cons/canvas.c" 3 4
       1
# 478 "project/radare2/libr/cons/canvas.c"
           ;
}
...
# 482 "project/radare2/libr/cons/canvas.c" 2
#define PI 3.1415
__attribute__((visibility("default"))) 
# 483 "project/radare2/libr/cons/canvas.c"
     void r_cons_canvas_circle(RConsCanvas *c, int x, int y, int w, int h, const char *color) {
 if (color) {
  c->attr = color;
 }
 double xfactor = 1;
 ...
 if (color) {
  c->attr = 
# 505 "project/radare2/libr/cons/canvas.c" 3 4
           "\x1b[0m"
# 505 "project/radare2/libr/cons/canvas.c"
                      ;
 }
}


# 509 "project/radare2/libr/cons/canvas.c" 3 4
__attribute__((visibility("default"))) 
# 509 "project/radare2/libr/cons/canvas.c"
     void r_cons_canvas_box(RConsCanvas *c, int x, int y, int w, int h, const char *color) {
 const char *hline = (r_cons_singleton ()->use_utf8)? 
# 510 "project/radare2/libr/cons/canvas.c" 3 4
                             "\xce" 
# 510 "project/radare2/libr/cons/canvas.c"
                                                    : "-";
 const char *vtmp = (r_cons_singleton ()->use_utf8)? 
# 511 "project/radare2/libr/cons/canvas.c" 3 4
                            "\xc8" 
# 511 "project/radare2/libr/cons/canvas.c"
                                                  : "|";
 RStrBuf *vline = r_strbuf_new (
# 512 "project/radare2/libr/cons/canvas.c" 3 4
                               ((void *)0)
# 512 "project/radare2/libr/cons/canvas.c"
                                   );
 r_strbuf_appendf (vline, 
# 513 "project/radare2/libr/cons/canvas.c" 3 4
                         "\x1b[0m"
# 513 "project/radare2/libr/cons/canvas.c"
                                    "%s%s", color, vtmp);
 const char *tl_corner = (r_cons_singleton ()->use_utf8) ? ((r_cons_singleton ()->use_utf8_curvy) ? 
# 514 "project/radare2/libr/cons/canvas.c" 3 4
                                                  "\xd2" 
# 514 "project/radare2/libr/cons/canvas.c"
                                                                              : 
# 514 "project/radare2/libr/cons/canvas.c" 3 4
                                                                                "\xcf"
# 514 "project/radare2/libr/cons/canvas.c"
                                                                                                     ) : ".";
 const char *tr_corner = (r_cons_singleton ()->use_utf8) ? ((r_cons_singleton ()->use_utf8_curvy) ? 
# 515 "project/radare2/libr/cons/canvas.c" 3 4
                                                  "\xd3" 
# 515 "project/radare2/libr/cons/canvas.c"
                                                                              : 
# 515 "project/radare2/libr/cons/canvas.c" 3 4
                                                                                "\xd0"
# 515 "project/radare2/libr/cons/canvas.c"
                                                                                                     ) : ".";
 const char *bl_corner = (r_cons_singleton ()->use_utf8) ? ((r_cons_singleton ()->use_utf8_curvy) ? 
# 516 "project/radare2/libr/cons/canvas.c" 3 4
                                                  "\xd5" 
# 516 "project/radare2/libr/cons/canvas.c"
                                                                              : 
# 516 "project/radare2/libr/cons/canvas.c" 3 4
                                                                                "\xcb"
# 516 "project/radare2/libr/cons/canvas.c"
                                                                                                     ) : "`";
 const char *br_corner = (r_cons_singleton ()->use_utf8) ? ((r_cons_singleton ()->use_utf8_curvy) ? 
# 517 "project/radare2/libr/cons/canvas.c" 3 4
                                                  "\xd4" 
# 517 "project/radare2/libr/cons/canvas.c"
                                                                              : 
# 517 "project/radare2/libr/cons/canvas.c" 3 4
                                                                                "\xca"
# 517 "project/radare2/libr/cons/canvas.c"
 ...
 int roundcorners = 0;
 char *row = 
# 520 "project/radare2/libr/cons/canvas.c" 3 4
            ((void *)0)
# 520 "project/radare2/libr/cons/canvas.c"
                , *row_ptr;
 ...
 if (!c->color) {
  c->attr = 
# 529 "project/radare2/libr/cons/canvas.c" 3 4
           "\x1b[0m"
# 529 "project/radare2/libr/cons/canvas.c"
                      ;
 }
 row = malloc (w + 1);
 if (!row) {
...
# 537 "project/radare2/libr/cons/canvas.c" 3 4
 __builtin___memset_chk (
# 537 "project/radare2/libr/cons/canvas.c"
 row + 1
# 537 "project/radare2/libr/cons/canvas.c" 3 4
 , 
# 537 "project/radare2/libr/cons/canvas.c"
...
# 537 "project/radare2/libr/cons/canvas.c"
 ...
 if (x < -c->sx) {
  x_mod = 
# 547 "project/radare2/libr/cons/canvas.c" 3 4
         (((
# 547 "project/radare2/libr/cons/canvas.c"
         -c->sx
# 547 "project/radare2/libr/cons/canvas.c" 3 4
         )>(
# 547 "project/radare2/libr/cons/canvas.c"
...
# 547 "project/radare2/libr/cons/canvas.c"
 ...
 if (r_cons_canvas_gotoxy (c, x_mod, y)) {
  r_cons_canvas_write (c, row_ptr);
 }
 if (r_cons_canvas_gotoxy (c, x_mod, y + h - 1)) {
 ...
 for (i = 1; i < h - 1; i++) {
  if (r_cons_canvas_gotoxy (c, x, y + i)) {
   r_cons_canvas_write (c, r_strbuf_get (vline));
  }
  if (r_cons_canvas_gotoxy (c, x + w - 1, y + i)) {
   r_cons_canvas_write (c, r_strbuf_get (vline));
  }
 }
 free (row);
 ...
 if (color) {
  c->attr = 
# 569 "project/radare2/libr/cons/canvas.c" 3 4
           "\x1b[0m"
# 569 "project/radare2/libr/cons/canvas.c"
                      ;
 }
}


# 573 "project/radare2/libr/cons/canvas.c" 3 4
__attribute__((visibility("default"))) 
# 573 "project/radare2/libr/cons/canvas.c"
     void r_cons_canvas_fill(RConsCanvas *c, int x, int y, int w, int h, char ch) {
 int i;
 if (w < 0) {
  return;
 }
...
# 582 "project/radare2/libr/cons/canvas.c" 3 4
__builtin___memset_chk (
# 582 "project/radare2/libr/cons/canvas.c"
row
# 582 "project/radare2/libr/cons/canvas.c" 3 4
, 
# 582 "project/radare2/libr/cons/canvas.c"
...
# 592 "project/radare2/libr/cons/canvas.c" 3 4
__attribute__((visibility("default"))) 
# 592 "project/radare2/libr/cons/canvas.c"
