# 0 "project/radare2/libr/cons/rgb.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/cons/rgb.c"
...
# 6 "project/radare2/libr/cons/rgb.c" 2


# 7 "project/radare2/libr/cons/rgb.c"
...
static 
# 56 "project/radare2/libr/cons/rgb.c" 3 4
      unsigned int 
# 56 "project/radare2/libr/cons/rgb.c"
           __approximate_rgb(int r, int g, int b) {
 
# 57 "project/radare2/libr/cons/rgb.c" 3 4
_Bool 
# 57 "project/radare2/libr/cons/rgb.c"
     grey = (r > 0 && r < 255 && r == g && r == b);
 if (grey) {
  return 232 + (int)((double)r / (255 / 24.1));
 }
# 77 "project/radare2/libr/cons/rgb.c"
 const int k = (int)(256.0 / 6);
 r = 
# 78 "project/radare2/libr/cons/rgb.c" 3 4
    (((
# 78 "project/radare2/libr/cons/rgb.c"
    (int)(r / k)
# 78 "project/radare2/libr/cons/rgb.c" 3 4
    )<(
# 78 "project/radare2/libr/cons/rgb.c"
...
# 78 "project/radare2/libr/cons/rgb.c"
                              ;
 g = 
# 79 "project/radare2/libr/cons/rgb.c" 3 4
    (((
# 79 "project/radare2/libr/cons/rgb.c"
    (int)(g / k)
# 79 "project/radare2/libr/cons/rgb.c" 3 4
    )<(
# 79 "project/radare2/libr/cons/rgb.c"
...
# 79 "project/radare2/libr/cons/rgb.c"
                              ;
 b = 
# 80 "project/radare2/libr/cons/rgb.c" 3 4
    (((
# 80 "project/radare2/libr/cons/rgb.c"
    (b / k)
# 80 "project/radare2/libr/cons/rgb.c" 3 4
    )<(
# 80 "project/radare2/libr/cons/rgb.c"
...
# 104 "project/radare2/libr/cons/rgb.c" 3 4
__attribute__((visibility("default"))) 
# 104 "project/radare2/libr/cons/rgb.c"
     void r_cons_rgb_init(void) {
...
# 111 "project/radare2/libr/cons/rgb.c" 3 4
__attribute__((visibility("default"))) 
# 111 "project/radare2/libr/cons/rgb.c"
     int r_cons_rgb_parse(const char *p, 
# 111 "project/radare2/libr/cons/rgb.c" 3 4
                                         unsigned char 
# 111 "project/radare2/libr/cons/rgb.c"
                                             *r, 
...
# 113 "project/radare2/libr/cons/rgb.c" 3 4
unsigned char 
# 113 "project/radare2/libr/cons/rgb.c"
    isbg = 0, bold = 127;
 if (!p) {
  return 0;
 }
...
#define SETRGB(x,y,z) if (r) *r = (x); if (g) *g = (y); if (b) *b = (z)
 if (bold != 255 && strchr (p, ';')) {
  ...
  switch (p[1]) {
  case '0': if (r) *r = (0); if (g) *g = (0); if (b) *b = (0); break;
  case '1': if (r) *r = (bold); if (g) *g = (0); if (b) *b = (0); break;
  case '2': if (r) *r = (0); if (g) *g = (bold); if (b) *b = (0); break;
  case '3': if (r) *r = (bold); if (g) *g = (bold); if (b) *b = (0); break;
  case '4': if (r) *r = (0); if (g) *g = (0); if (b) *b = (bold); break;
  case '5': if (r) *r = (bold); if (g) *g = (0); if (b) *b = (bold); break;
  case '6': if (r) *r = (0); if (g) *g = (bold); if (b) *b = (bold); break;
  case '7': if (r) *r = (bold); if (g) *g = (bold); if (b) *b = (bold); break;
  }
 }
 return 1;
}
...
# 201 "project/radare2/libr/cons/rgb.c" 3 4
__attribute__((visibility("default"))) 
# 201 "project/radare2/libr/cons/rgb.c"
     char *r_cons_rgb_str_off(char *outstr, size_t sz, 
# 201 "project/radare2/libr/cons/rgb.c" 3 4
                                                       unsigned long long 
# 201 "project/radare2/libr/cons/rgb.c"
                                                            off) {
 RColor rc = 
# 202 "project/radare2/libr/cons/rgb.c" 3 4
            (RColor) {0, ALPHA_FG, 12, 12, 12, 0x00, 0x00, 0x00, 0}
# 202 "project/radare2/libr/cons/rgb.c"
                        ;
 rc.id16 = -1;
 rc.r = (off >> 2) & 0xff;
 rc.g = (off >> 6) & 0xff;
...
static void r_cons_rgb_gen(RConsColorMode mode, char *outstr, size_t sz, 
# 211 "project/radare2/libr/cons/rgb.c" 3 4
                                                                        unsigned char 
# 211 "project/radare2/libr/cons/rgb.c"
                                                                            attr, 
# 211 "project/radare2/libr/cons/rgb.c" 3 4
                                                                                  unsigned char 
# 211 "project/radare2/libr/cons/rgb.c"
...
# 212 "project/radare2/libr/cons/rgb.c" 3 4
unsigned char 
# 212 "project/radare2/libr/cons/rgb.c"
    fgbg = (a == ALPHA_BG)? 48: 38;
 ...
 case COLOR_MODE_256:
  written = 
# 243 "project/radare2/libr/cons/rgb.c" 3 4
           __builtin___snprintf_chk (
# 243 "project/radare2/libr/cons/rgb.c"
           outstr + i
# 243 "project/radare2/libr/cons/rgb.c" 3 4
           , 
# 243 "project/radare2/libr/cons/rgb.c"
...
# 243 "project/radare2/libr/cons/rgb.c"
 ...
 case COLOR_MODE_16M:
  written = 
# 246 "project/radare2/libr/cons/rgb.c" 3 4
           __builtin___snprintf_chk (
# 246 "project/radare2/libr/cons/rgb.c"
           outstr + i
# 246 "project/radare2/libr/cons/rgb.c" 3 4
           , 
# 246 "project/radare2/libr/cons/rgb.c"
...
# 249 "project/radare2/libr/cons/rgb.c" 3 4
 unsigned char 
# 249 "project/radare2/libr/cons/rgb.c"
     bright, c;
  fgbg -= 8;
  if (id16 >= 0 && id16 <= 15) {
   c = id16 % 8;
...
# 265 "project/radare2/libr/cons/rgb.c" 3 4
   unsigned char 
# 265 "project/radare2/libr/cons/rgb.c"
       k = (r + g + b) / 3;
    r = (r >= k) ? 1 : 0;
    g = (g >= k) ? 1 : 0;
    b = (b >= k) ? 1 : 0;
  ...
  written = 
# 272 "project/radare2/libr/cons/rgb.c" 3 4
           __builtin___snprintf_chk (
# 272 "project/radare2/libr/cons/rgb.c"
           outstr + i
# 272 "project/radare2/libr/cons/rgb.c" 3 4
           , 
# 272 "project/radare2/libr/cons/rgb.c"
...
# 285 "project/radare2/libr/cons/rgb.c" 3 4
__attribute__((visibility("default"))) 
# 285 "project/radare2/libr/cons/rgb.c"
     char *r_cons_rgb_str_mode(RConsColorMode mode, char *outstr, size_t sz, RColor *rcolor) {
 if (!rcolor) {
  return 
# 287 "project/radare2/libr/cons/rgb.c" 3 4
        ((void *)0)
# 287 "project/radare2/libr/cons/rgb.c"
            ;
 }
 if (!outstr) {
  sz = 64;
...
# 295 "project/radare2/libr/cons/rgb.c" 3 4
 __builtin___strcpy_chk (
# 295 "project/radare2/libr/cons/rgb.c"
 outstr
# 295 "project/radare2/libr/cons/rgb.c" 3 4
 , "\x1b[0m", __builtin_object_size (
# 295 "project/radare2/libr/cons/rgb.c"
 outstr
# 295 "project/radare2/libr/cons/rgb.c" 3 4
 , 2 > 1 ? 1 : 0))
...
# 311 "project/radare2/libr/cons/rgb.c" 3 4
__attribute__((visibility("default"))) 
# 311 "project/radare2/libr/cons/rgb.c"
     char *r_cons_rgb_str(char *outstr, size_t sz, RColor *rcolor) {
 return r_cons_rgb_str_mode (r_cons_context ()->color_mode, outstr, sz, rcolor);
}


# 315 "project/radare2/libr/cons/rgb.c" 3 4
__attribute__((visibility("default"))) 
# 315 "project/radare2/libr/cons/rgb.c"
     char *r_cons_rgb_tostring(
# 315 "project/radare2/libr/cons/rgb.c" 3 4
                               unsigned char 
# 315 "project/radare2/libr/cons/rgb.c"
                                   r, 
...
# 315 "project/radare2/libr/cons/rgb.c"
                                                 b) {
 const char *str = 
# 316 "project/radare2/libr/cons/rgb.c" 3 4
                  ((void *)0)
# 316 "project/radare2/libr/cons/rgb.c"
                      ;
 if (r == 0x00 && g == b && g == 0) {
  str = "black";
 }
