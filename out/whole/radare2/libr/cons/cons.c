# 0 "project/radare2/libr/cons/cons.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/libr/cons/cons.c"
...
# 4 "project/radare2/libr/cons/cons.c" 2
...
# 5 "project/radare2/libr/cons/cons.c" 2
...
# 6 "project/radare2/libr/cons/cons.c" 2
# 1 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include-fixed/limits.h" 1 3 4
# 7 "project/radare2/libr/cons/cons.c" 2
...
# 14 "project/radare2/libr/cons/cons.c"
r_cons_version
# 14 "project/radare2/libr/cons/cons.c" 3 4
(void) { return "" "5.5.4"; }
# 14 "project/radare2/libr/cons/cons.c"
                     ;
...
#define C r_cons_instance.context
...
# 30 "project/radare2/libr/cons/cons.c" 3 4
_Bool 
# 30 "project/radare2/libr/cons/cons.c"
     breaked;
 RConsEvent event_interrupt;
 void *event_interrupt_data;
} RConsBreakStack;
...
# 44 "project/radare2/libr/cons/cons.c" 3 4
 { free((void *)
# 44 "project/radare2/libr/cons/cons.c"
 s->grep->str
# 44 "project/radare2/libr/cons/cons.c" 3 4
 ); 
# 44 "project/radare2/libr/cons/cons.c"
...
# 44 "project/radare2/libr/cons/cons.c"
                      ;
  r_cons_instance.context->grep.str = 
# 45 "project/radare2/libr/cons/cons.c" 3 4
               ((void *)0)
# 45 "project/radare2/libr/cons/cons.c"
                   ;
 }
 free (s->grep);
 free (s);
...
# 51 "project/radare2/libr/cons/cons.c" 3 4
                                  _Bool 
# 51 "project/radare2/libr/cons/cons.c"
                                       recreate) {
 RConsStack *data = 
# 52 "project/radare2/libr/cons/cons.c" 3 4
                   (
# 52 "project/radare2/libr/cons/cons.c"
                   RConsStack
# 52 "project/radare2/libr/cons/cons.c" 3 4
                   *)calloc(1,sizeof(
# 52 "project/radare2/libr/cons/cons.c"
...
# 52 "project/radare2/libr/cons/cons.c"
                                      ;
 if (data) {
  if (r_cons_instance.context->buffer) {
   data->buf = r_cons_instance.context->buffer;
   data->buf_len = r_cons_instance.context->buffer_len;
   data->buf_size = r_cons_instance.context->buffer_sz;
  }
  data->grep = 
# 59 "project/radare2/libr/cons/cons.c" 3 4
              (
# 59 "project/radare2/libr/cons/cons.c"
              RConsGrep
# 59 "project/radare2/libr/cons/cons.c" 3 4
              *)calloc(1,sizeof(
# 59 "project/radare2/libr/cons/cons.c"
...
# 61 "project/radare2/libr/cons/cons.c" 3 4
  __builtin___memcpy_chk (
# 61 "project/radare2/libr/cons/cons.c"
  data->grep
# 61 "project/radare2/libr/cons/cons.c" 3 4
  , 
# 61 "project/radare2/libr/cons/cons.c"
  &r_cons_instance.context->grep, sizeof (RConsGrep)
# 61 "project/radare2/libr/cons/cons.c" 3 4
...
# 61 "project/radare2/libr/cons/cons.c"
                                                   ;
   if (r_cons_instance.context->grep.str) {
    data->grep->str = strdup (r_cons_instance.context->grep.str);
   }
  }
  if (recreate && r_cons_instance.context->buffer_sz > 0) {
   r_cons_instance.context->buffer = malloc (r_cons_instance.context->buffer_sz);
   if (!r_cons_instance.context->buffer) {
    r_cons_instance.context->buffer = data->buf;
    free (data);
    return 
# 71 "project/radare2/libr/cons/cons.c" 3 4
          ((void *)0)
# 71 "project/radare2/libr/cons/cons.c"
              ;
   }
  } else {
   r_cons_instance.context->buffer = 
# 74 "project/radare2/libr/cons/cons.c" 3 4
              ((void *)0)
# 74 "project/radare2/libr/cons/cons.c"
                  ;
  }
 }
 return data;
...
# 80 "project/radare2/libr/cons/cons.c" 3 4
                                             _Bool 
# 80 "project/radare2/libr/cons/cons.c"
                                                  free_current) {
 
# 81 "project/radare2/libr/cons/cons.c" 3 4
do { if (!(
# 81 "project/radare2/libr/cons/cons.c"
data
# 81 "project/radare2/libr/cons/cons.c" 3 4
...
# 81 "project/radare2/libr/cons/cons.c"
                       ;
 if (free_current) {
  free (r_cons_instance.context->buffer);
 }
 r_cons_instance.context->buffer = data->buf;
 data->buf = 
# 86 "project/radare2/libr/cons/cons.c" 3 4
            ((void *)0)
# 86 "project/radare2/libr/cons/cons.c"
                ;
 r_cons_instance.context->buffer_len = data->buf_len;
 r_cons_instance.context->buffer_sz = data->buf_size;
 if (data->grep) {
  free (r_cons_instance.context->grep.str);
  
# 91 "project/radare2/libr/cons/cons.c" 3 4
 __builtin___memcpy_chk (
# 91 "project/radare2/libr/cons/cons.c"
 &r_cons_instance.context->grep
# 91 "project/radare2/libr/cons/cons.c" 3 4
 , 
# 91 "project/radare2/libr/cons/cons.c"
 data->grep, sizeof (RConsGrep)
# 91 "project/radare2/libr/cons/cons.c" 3 4
 , __builtin_object_size (
# 91 "project/radare2/libr/cons/cons.c"
 &r_cons_instance.context->grep
...
# 96 "project/radare2/libr/cons/cons.c" 3 4
{ free((void *)
# 96 "project/radare2/libr/cons/cons.c"
grep->str
# 96 "project/radare2/libr/cons/cons.c" 3 4
); 
# 96 "project/radare2/libr/cons/cons.c"
...
# 97 "project/radare2/libr/cons/cons.c" 3 4
__builtin___memset_chk (&
# 97 "project/radare2/libr/cons/cons.c"
*grep
# 97 "project/radare2/libr/cons/cons.c" 3 4
, 0, sizeof (
# 97 "project/radare2/libr/cons/cons.c"
...
# 97 "project/radare2/libr/cons/cons.c"
 ...
 grep->sort = -1;
 grep->sort_invert = 
# 100 "project/radare2/libr/cons/cons.c" 3 4
                    0
# 100 "project/radare2/libr/cons/cons.c"
                         ;
}

static void cons_context_init(RConsContext *context, RConsContext *parent) {
 context->breaked = 
# 104 "project/radare2/libr/cons/cons.c" 3 4
                   0
# 104 "project/radare2/libr/cons/cons.c"
                        ;
 context->cmd_depth = 
# 105 "project/radare2/libr/cons/cons.c" 3 4
                     100 
# 105 "project/radare2/libr/cons/cons.c"
                                      + 1;
 context->error = r_strbuf_new ("");
 context->errmode = R_CONS_ERRMODE_ECHO;
 context->buffer = 
# 108 "project/radare2/libr/cons/cons.c" 3 4
                  ((void *)0)
# 108 "project/radare2/libr/cons/cons.c"
                      ;
 context->buffer_sz = 0;
 context->lastEnabled = 
# 110 "project/radare2/libr/cons/cons.c" 3 4
                       1
# 110 "project/radare2/libr/cons/cons.c"
                           ;
 context->buffer_len = 0;
 context->is_interactive = 
# 112 "project/radare2/libr/cons/cons.c" 3 4
                          0
# 112 "project/radare2/libr/cons/cons.c"
                               ;
...
# 115 "project/radare2/libr/cons/cons.c" 3 4
                           ((void *)0)
# 115 "project/radare2/libr/cons/cons.c"
                               ;
 context->event_interrupt_data = 
# 116 "project/radare2/libr/cons/cons.c" 3 4
                                ((void *)0)
# 116 "project/radare2/libr/cons/cons.c"
                                    ;
 context->pageable = 
# 117 "project/radare2/libr/cons/cons.c" 3 4
                    1
# 117 "project/radare2/libr/cons/cons.c"
                        ;
 context->log_callback = 
# 118 "project/radare2/libr/cons/cons.c" 3 4
                        ((void *)0)
# 118 "project/radare2/libr/cons/cons.c"
                            ;
 context->cmd_str_depth = 0;
 context->noflush = 
# 120 "project/radare2/libr/cons/cons.c" 3 4
                   0
# 120 "project/radare2/libr/cons/cons.c"
                        ;
...
# 134 "project/radare2/libr/cons/cons.c" 3 4
{ free((void *)
# 134 "project/radare2/libr/cons/cons.c"
context->error
# 134 "project/radare2/libr/cons/cons.c" 3 4
); 
# 134 "project/radare2/libr/cons/cons.c"
...
# 134 "project/radare2/libr/cons/cons.c"
 ...
 context->cons_stack = 
# 136 "project/radare2/libr/cons/cons.c" 3 4
                      ((void *)0)
# 136 "project/radare2/libr/cons/cons.c"
                          ;
 r_stack_free (context->break_stack);
 context->break_stack = 
# 138 "project/radare2/libr/cons/cons.c" 3 4
                       ((void *)0)
# 138 "project/radare2/libr/cons/cons.c"
                           ;
...
# 158 "project/radare2/libr/cons/cons.c"
 if (r_cons_instance.fdout < 1) {
  r_cons_instance.fdout = 1;
 }
 (void) write (r_cons_instance.fdout, buf, len);
...
# 179 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 179 "project/radare2/libr/cons/cons.c"
     RColor r_cons_color_random(
# 179 "project/radare2/libr/cons/cons.c" 3 4
                                unsigned char 
# 179 "project/radare2/libr/cons/cons.c"
                                    alpha) {
 RColor rcolor = {0};
 if (r_cons_instance.context->color_mode > COLOR_MODE_16) {
 ...
 int r = r_num_rand (16);
 switch (r) {
 case 0: case 1: rcolor = (RColor) 
# 190 "project/radare2/libr/cons/cons.c" 3 4
                                  (RColor) {0, ALPHA_FG, 197, 15, 31, 0x00, 0x00, 0x00, 1}
# 190 "project/radare2/libr/cons/cons.c"
                                            ; break;
 case 2: case 3: rcolor = (RColor) 
# 191 "project/radare2/libr/cons/cons.c" 3 4
                                  (RColor) {0, ALPHA_FG, 204, 204, 204, 0x00, 0x00, 0x00, 7}
# 191 "project/radare2/libr/cons/cons.c"
                                              ; break;
 case 4: case 5: rcolor = (RColor) 
# 192 "project/radare2/libr/cons/cons.c" 3 4
                                  (RColor) {0, ALPHA_FG, 19, 161, 14, 0x00, 0x00, 0x00, 2}
# 192 "project/radare2/libr/cons/cons.c"
                                              ; break;
 case 6: case 7: rcolor = (RColor) 
# 193 "project/radare2/libr/cons/cons.c" 3 4
                                  (RColor) {0, ALPHA_FG, 136, 23, 152, 0x00, 0x00, 0x00, 5}
# 193 "project/radare2/libr/cons/cons.c"
                                                ; break;
 case 8: case 9: rcolor = (RColor) 
# 194 "project/radare2/libr/cons/cons.c" 3 4
                                  (RColor) {0, ALPHA_FG, 193, 156, 0, 0x00, 0x00, 0x00, 3}
# 194 "project/radare2/libr/cons/cons.c"
                                               ; break;
 case 10: case 11: rcolor = (RColor) 
# 195 "project/radare2/libr/cons/cons.c" 3 4
                                    (RColor) {0, ALPHA_FG, 58, 150, 221, 0x00, 0x00, 0x00, 6}
# 195 "project/radare2/libr/cons/cons.c"
                                               ; break;
 case 12: case 13: rcolor = (RColor) 
# 196 "project/radare2/libr/cons/cons.c" 3 4
                                    (RColor) {0, ALPHA_FG, 0, 55, 218, 0x00, 0x00, 0x00, 4}
# 196 "project/radare2/libr/cons/cons.c"
                                               ; break;
 case 14: case 15: rcolor = (RColor) 
# 197 "project/radare2/libr/cons/cons.c" 3 4
                                    (RColor) {0, ALPHA_FG, 118, 118, 118, 0x00, 0x00, 0x00, 8}
# 197 "project/radare2/libr/cons/cons.c"
                                               ; break;
 }
 if (r & 1) {
...
# 205 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 205 "project/radare2/libr/cons/cons.c"
     void r_cons_color(int fg, int r, int g, int b) {
 int k;
 r = 
# 207 "project/radare2/libr/cons/cons.c" 3 4
    (((
# 207 "project/radare2/libr/cons/cons.c"
    r
# 207 "project/radare2/libr/cons/cons.c" 3 4
    )<(
# 207 "project/radare2/libr/cons/cons.c"
...
# 207 "project/radare2/libr/cons/cons.c"
                     ;
 g = 
# 208 "project/radare2/libr/cons/cons.c" 3 4
    (((
# 208 "project/radare2/libr/cons/cons.c"
    g
# 208 "project/radare2/libr/cons/cons.c" 3 4
    )<(
# 208 "project/radare2/libr/cons/cons.c"
...
# 208 "project/radare2/libr/cons/cons.c"
                     ;
 b = 
# 209 "project/radare2/libr/cons/cons.c" 3 4
    (((
# 209 "project/radare2/libr/cons/cons.c"
    b
# 209 "project/radare2/libr/cons/cons.c" 3 4
    )<(
# 209 "project/radare2/libr/cons/cons.c"
...
# 221 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 221 "project/radare2/libr/cons/cons.c"
     void r_cons_println(const char* str) {

 
# 223 "project/radare2/libr/cons/cons.c" 3 4
r_cons_strcat (
# 223 "project/radare2/libr/cons/cons.c"
str
# 223 "project/radare2/libr/cons/cons.c" 3 4
)
# 223 "project/radare2/libr/cons/cons.c"
...
# 227 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 227 "project/radare2/libr/cons/cons.c"
     void r_cons_printat(const char *str, int x, char y) {
 int i, o, len;
 ...
 for (o = i = len = 0; str[i]; i++, len++) {
  if (str[i] == '\n') {
   ...
   int wlen = 
# 234 "project/radare2/libr/cons/cons.c" 3 4
             (((
# 234 "project/radare2/libr/cons/cons.c"
             len
# 234 "project/radare2/libr/cons/cons.c" 3 4
             )>(
# 234 "project/radare2/libr/cons/cons.c"
...
# 247 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 247 "project/radare2/libr/cons/cons.c"
     void r_cons_strcat_justify(const char *str, int j, char c) {
 int i, o, len;
 for (o = i = len = 0; str[i]; i++, len++) {
  if (str[i] == '\n') {
   r_cons_memset (' ', j);
...
# 269 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 269 "project/radare2/libr/cons/cons.c"
     void r_cons_strcat_at(const char *_str, int x, char y, int w, int h) {
 int i, o, len;
 int cols = 0;
 int rows = 0;
 if (x < 0 || y < 0) {
 ...
 r_cons_strcat (
# 283 "project/radare2/libr/cons/cons.c" 3 4
               "\x1b[s"
# 283 "project/radare2/libr/cons/cons.c"
                                 );
 for (o = i = len = 0; str[i]; i++, len++) {
  if (w < 0 || rows > w) {
   break;
  ...
  if (str[i] == '\n') {
   ...
   cols = 
# 291 "project/radare2/libr/cons/cons.c" 3 4
         (((
# 291 "project/radare2/libr/cons/cons.c"
         w
# 291 "project/radare2/libr/cons/cons.c" 3 4
         )>(
# 291 "project/radare2/libr/cons/cons.c"
...
# 291 "project/radare2/libr/cons/cons.c"
   ...
   cols = end - str + o;
   r_cons_write (str + o, 
# 294 "project/radare2/libr/cons/cons.c" 3 4
                         (((
# 294 "project/radare2/libr/cons/cons.c"
                         len
# 294 "project/radare2/libr/cons/cons.c" 3 4
                         )>(
# 294 "project/radare2/libr/cons/cons.c"
...
# 294 "project/radare2/libr/cons/cons.c"
 ...
 r_cons_strcat (
# 304 "project/radare2/libr/cons/cons.c" 3 4
               "\x1b[0m"
# 304 "project/radare2/libr/cons/cons.c"
                          );
 r_cons_strcat (
# 305 "project/radare2/libr/cons/cons.c" 3 4
               "\x1b[u"
# 305 "project/radare2/libr/cons/cons.c"
                                    );
 free (str);
}


# 309 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 309 "project/radare2/libr/cons/cons.c"
     RConsContext *r_cons_context(void) {
 return r_cons_instance.context;
}


# 313 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 313 "project/radare2/libr/cons/cons.c"
     RCons *r_cons_singleton(void) {
 return &r_cons_instance;
}


# 317 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 317 "project/radare2/libr/cons/cons.c"
     void r_cons_break_clear(void) {
 r_cons_instance.context->was_breaked = 
# 318 "project/radare2/libr/cons/cons.c" 3 4
                 0
# 318 "project/radare2/libr/cons/cons.c"
                      ;
 r_cons_instance.context->breaked = 
# 319 "project/radare2/libr/cons/cons.c" 3 4
             0
# 319 "project/radare2/libr/cons/cons.c"
                  ;
}


# 322 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 322 "project/radare2/libr/cons/cons.c"
     void r_cons_context_break_push(RConsContext *context, RConsBreak cb, void *user, 
# 322 "project/radare2/libr/cons/cons.c" 3 4
                                                                                      _Bool 
# 322 "project/radare2/libr/cons/cons.c"
                                                                                           sig) {
 ...
 RConsBreakStack *b = 
# 328 "project/radare2/libr/cons/cons.c" 3 4
                     (
# 328 "project/radare2/libr/cons/cons.c"
                     RConsBreakStack
# 328 "project/radare2/libr/cons/cons.c" 3 4
                     *)calloc(1,sizeof(
# 328 "project/radare2/libr/cons/cons.c"
...
# 328 "project/radare2/libr/cons/cons.c"
 ...
 if (r_stack_is_empty (context->break_stack)) {
  ...
  if (sig && r_cons_context_is_main ()) {
   r_sys_signal (
# 335 "project/radare2/libr/cons/cons.c" 3 4
                2
# 335 "project/radare2/libr/cons/cons.c"
                      , __break_signal);
  }

  context->breaked = 
# 338 "project/radare2/libr/cons/cons.c" 3 4
                    0
# 338 "project/radare2/libr/cons/cons.c"
                         ;
 }
...
# 349 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 349 "project/radare2/libr/cons/cons.c"
     void r_cons_context_break_pop(RConsContext *context, 
# 349 "project/radare2/libr/cons/cons.c" 3 4
                                                          _Bool 
# 349 "project/radare2/libr/cons/cons.c"
                                                               sig) {
 ...
 RConsBreakStack *b = 
# 354 "project/radare2/libr/cons/cons.c" 3 4
                     ((void *)0)
# 354 "project/radare2/libr/cons/cons.c"
                         ;
 ...
 if (b) {
  ...
  if (sig && r_cons_context_is_main ()) {
   r_sys_signal (
# 364 "project/radare2/libr/cons/cons.c" 3 4
                2
# 364 "project/radare2/libr/cons/cons.c"
                      , 
# 364 "project/radare2/libr/cons/cons.c" 3 4
                        (void (*)(int))1
# 364 "project/radare2/libr/cons/cons.c"
  ...
  r_cons_instance.context->was_breaked = r_cons_instance.context->breaked;
  context->breaked = 
# 368 "project/radare2/libr/cons/cons.c" 3 4
                    0
# 368 "project/radare2/libr/cons/cons.c"
                         ;
 }
}


# 372 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 372 "project/radare2/libr/cons/cons.c"
     void r_cons_break_push(RConsBreak cb, void *user) {
 r_cons_context_break_push (r_cons_instance.context, cb, user, 
# 373 "project/radare2/libr/cons/cons.c" 3 4
                                        1
# 373 "project/radare2/libr/cons/cons.c"
                                            );
}


# 376 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 376 "project/radare2/libr/cons/cons.c"
     void r_cons_break_pop(void) {
 r_cons_context_break_pop (r_cons_instance.context, 
# 377 "project/radare2/libr/cons/cons.c" 3 4
                             1
# 377 "project/radare2/libr/cons/cons.c"
                                 );
}


# 380 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 380 "project/radare2/libr/cons/cons.c"
          r_cons_is_interactive(void) {
 return r_cons_instance.context->is_interactive;
}


# 384 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 384 "project/radare2/libr/cons/cons.c"
          r_cons_default_context_is_interactive(void) {
 return r_cons_context_default.is_interactive;
}


# 388 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 388 "project/radare2/libr/cons/cons.c"
          r_cons_was_breaked(void) {
 
# 389 "project/radare2/libr/cons/cons.c" 3 4
_Bool 
# 389 "project/radare2/libr/cons/cons.c"
     res = r_cons_is_breaked () || r_cons_instance.context->was_breaked;
 r_cons_instance.context->breaked = 
# 390 "project/radare2/libr/cons/cons.c" 3 4
             0
# 390 "project/radare2/libr/cons/cons.c"
                  ;
 r_cons_instance.context->was_breaked = 
# 391 "project/radare2/libr/cons/cons.c" 3 4
                 0
# 391 "project/radare2/libr/cons/cons.c"
                      ;
 return res;
}


# 395 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 395 "project/radare2/libr/cons/cons.c"
          r_cons_is_breaked(void) {
 if (r_cons_instance.cb_break) {
  r_cons_instance.cb_break (r_cons_instance.user);
 }
 if (r_cons_instance.timeout) {
  if (r_time_now_mono () > r_cons_instance.timeout) {
   r_cons_instance.context->breaked = 
# 401 "project/radare2/libr/cons/cons.c" 3 4
               1
# 401 "project/radare2/libr/cons/cons.c"
                   ;
   
# 402 "project/radare2/libr/cons/cons.c" 3 4
  fprintf(__stderrp,
# 402 "project/radare2/libr/cons/cons.c"
  "\nTimeout!\n"
# 402 "project/radare2/libr/cons/cons.c" 3 4
  )
# 402 "project/radare2/libr/cons/cons.c"
                          ;
   r_cons_instance.timeout = 0;
  }
 }
 if (!r_cons_instance.context->was_breaked) {
  r_cons_instance.context->was_breaked = r_cons_instance.context->breaked;
 }
 return r_cons_instance.context && r_cons_instance.context->breaked;
}


# 412 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 412 "project/radare2/libr/cons/cons.c"
     void r_cons_line(int x, int y, int x2, int y2, int ch) {
 char chstr[2] = {ch, 0};
 int X, Y;
 for (X = x; X < x2; X++) {
  for (Y = y; Y < y2; Y++) {
...
# 418 "project/radare2/libr/cons/cons.c" 3 4
  r_cons_strcat (
# 418 "project/radare2/libr/cons/cons.c"
  chstr
# 418 "project/radare2/libr/cons/cons.c" 3 4
  )
# 418 "project/radare2/libr/cons/cons.c"
...
# 423 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 423 "project/radare2/libr/cons/cons.c"
     int r_cons_get_cur_line(void) {
 int curline = 0;
 ...
 fflush (
# 435 "project/radare2/libr/cons/cons.c" 3 4
        __stdoutp
# 435 "project/radare2/libr/cons/cons.c"
              );
 (void) tcgetattr (0, &save);
 cfmakeraw (&raw);
 (void) tcsetattr (0, 
# 438 "project/radare2/libr/cons/cons.c" 3 4
                     0
# 438 "project/radare2/libr/cons/cons.c"
                            , &raw);
 if (isatty (fileno (
# 439 "project/radare2/libr/cons/cons.c" 3 4
                    __stdinp
# 439 "project/radare2/libr/cons/cons.c"
                         ))) {
  if (write (1, 
# 440 "project/radare2/libr/cons/cons.c" 3 4
               "\x1b[6n"
# 440 "project/radare2/libr/cons/cons.c"
                                         , sizeof (
# 440 "project/radare2/libr/cons/cons.c" 3 4
                                                   "\x1b[6n"
# 440 "project/radare2/libr/cons/cons.c"
 ...
 (void) tcsetattr (0, 
# 450 "project/radare2/libr/cons/cons.c" 3 4
                     0
# 450 "project/radare2/libr/cons/cons.c"
                            , &save);
...
# 455 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 455 "project/radare2/libr/cons/cons.c"
     void r_cons_break_timeout(int timeout) {
 r_cons_instance.timeout = (timeout && !r_cons_instance.timeout)
  ? r_time_now_mono () + ((
# 457 "project/radare2/libr/cons/cons.c" 3 4
                          unsigned long long
# 457 "project/radare2/libr/cons/cons.c"
                              ) timeout << 20) : 0;
}


# 460 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 460 "project/radare2/libr/cons/cons.c"
     void r_cons_break_end(void) {
 r_cons_instance.context->breaked = 
# 461 "project/radare2/libr/cons/cons.c" 3 4
             0
# 461 "project/radare2/libr/cons/cons.c"
                  ;
 r_cons_instance.timeout = 0;

 r_sys_signal (
# 464 "project/radare2/libr/cons/cons.c" 3 4
              2
# 464 "project/radare2/libr/cons/cons.c"
                    , 
# 464 "project/radare2/libr/cons/cons.c" 3 4
                      (void (*)(int))1
# 464 "project/radare2/libr/cons/cons.c"
 ...
 if (!r_stack_is_empty (r_cons_instance.context->break_stack)) {

  r_stack_free (r_cons_instance.context->break_stack);

  r_cons_instance.context->break_stack = r_stack_newf (6, break_stack_free);
  r_cons_instance.context->event_interrupt_data = 
# 471 "project/radare2/libr/cons/cons.c" 3 4
                           ((void *)0)
# 471 "project/radare2/libr/cons/cons.c"
                               ;
  r_cons_instance.context->event_interrupt = 
# 472 "project/radare2/libr/cons/cons.c" 3 4
                      ((void *)0)
# 472 "project/radare2/libr/cons/cons.c"
                          ;
 }
}


# 476 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 476 "project/radare2/libr/cons/cons.c"
     void *r_cons_sleep_begin(void) {
 if (!r_cons_instance.cb_sleep_begin) {
  return 
# 478 "project/radare2/libr/cons/cons.c" 3 4
        ((void *)0)
# 478 "project/radare2/libr/cons/cons.c"
            ;
 }
 return r_cons_instance.cb_sleep_begin (r_cons_instance.user);
}


# 483 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 483 "project/radare2/libr/cons/cons.c"
     void r_cons_sleep_end(void *user) {
 if (r_cons_instance.cb_sleep_end) {
  r_cons_instance.cb_sleep_end (r_cons_instance.user, user);
 }
}
# 500 "project/radare2/libr/cons/cons.c"
...
void resizeWin(void) {
 if (r_cons_instance.event_resize) {
  r_cons_instance.event_resize (r_cons_instance.event_data);
 }
}


# 511 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 511 "project/radare2/libr/cons/cons.c"
     void r_cons_set_click(int x, int y) {
 r_cons_instance.click_x = x;
 r_cons_instance.click_y = y;
 r_cons_instance.click_set = 
# 514 "project/radare2/libr/cons/cons.c" 3 4
              1
# 514 "project/radare2/libr/cons/cons.c"
                  ;
 r_cons_instance.mouse_event = 1;
}


# 518 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 518 "project/radare2/libr/cons/cons.c"
          r_cons_get_click(int *x, int *y) {
 if (x) {
  *x = r_cons_instance.click_x;
 }
 if (y) {
  *y = r_cons_instance.click_y;
 }
 
# 525 "project/radare2/libr/cons/cons.c" 3 4
_Bool 
# 525 "project/radare2/libr/cons/cons.c"
     set = r_cons_instance.click_set;
 r_cons_instance.click_set = 
# 526 "project/radare2/libr/cons/cons.c" 3 4
              0
# 526 "project/radare2/libr/cons/cons.c"
                   ;
 return set;
}


# 530 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 530 "project/radare2/libr/cons/cons.c"
     void r_cons_enable_highlight(const 
# 530 "project/radare2/libr/cons/cons.c" 3 4
                                        _Bool 
# 530 "project/radare2/libr/cons/cons.c"
                                             enable) {
 r_cons_instance.enable_highlight = enable;
}


# 534 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 534 "project/radare2/libr/cons/cons.c"
          r_cons_enable_mouse(const 
# 534 "project/radare2/libr/cons/cons.c" 3 4
                                    _Bool 
# 534 "project/radare2/libr/cons/cons.c"
                                         enable) {
 if ((r_cons_instance.mouse && enable) || (!r_cons_instance.mouse && !enable)) {
  return r_cons_instance.mouse;
 }
...
# 547 "project/radare2/libr/cons/cons.c" 3 4
 _Bool 
# 547 "project/radare2/libr/cons/cons.c"
      enabled = r_cons_instance.mouse;
  const size_t click_len = strlen (click);
  if (write (2, click, click_len) != click_len) {
   return 
# 550 "project/radare2/libr/cons/cons.c" 3 4
         0
# 550 "project/radare2/libr/cons/cons.c"
              ;
  }
  r_cons_instance.mouse = enable;
  return enabled;
# 570 "project/radare2/libr/cons/cons.c"
 return 
# 570 "project/radare2/libr/cons/cons.c" 3 4
       0
# 570 "project/radare2/libr/cons/cons.c"
            ;
...
# 576 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 576 "project/radare2/libr/cons/cons.c"
     RCons *r_cons_new(void) {
 r_cons_instance.refcnt++;
 if (r_cons_instance.refcnt != 1) {
  return &r_cons_instance;
 }
 r_cons_instance.use_utf8 = r_cons_is_utf8 ();
 r_cons_instance.rgbstr = r_cons_rgb_str_off;
 r_cons_instance.line = r_line_new ();
 r_cons_instance.enable_highlight = 
# 584 "project/radare2/libr/cons/cons.c" 3 4
                     1
# 584 "project/radare2/libr/cons/cons.c"
                         ;
 r_cons_instance.highlight = 
# 585 "project/radare2/libr/cons/cons.c" 3 4
              ((void *)0)
# 585 "project/radare2/libr/cons/cons.c"
                  ;
 r_cons_instance.is_wine = -1;
 r_cons_instance.fps = 0;
 r_cons_instance.blankline = 
# 588 "project/radare2/libr/cons/cons.c" 3 4
              1
# 588 "project/radare2/libr/cons/cons.c"
                  ;
 r_cons_instance.teefile = 
# 589 "project/radare2/libr/cons/cons.c" 3 4
            ((void *)0)
# 589 "project/radare2/libr/cons/cons.c"
                ;
 r_cons_instance.fix_columns = 0;
 r_cons_instance.fix_rows = 0;
 r_cons_instance.mouse_event = 0;
 r_cons_instance.force_rows = 0;
 r_cons_instance.force_columns = 0;
 r_cons_instance.event_resize = 
# 595 "project/radare2/libr/cons/cons.c" 3 4
                 ((void *)0)
# 595 "project/radare2/libr/cons/cons.c"
                     ;
 r_cons_instance.event_data = 
# 596 "project/radare2/libr/cons/cons.c" 3 4
               ((void *)0)
# 596 "project/radare2/libr/cons/cons.c"
                   ;
 r_cons_instance.linesleep = 0;
 r_cons_instance.fdin = 
# 598 "project/radare2/libr/cons/cons.c" 3 4
         __stdinp
# 598 "project/radare2/libr/cons/cons.c"
              ;
 r_cons_instance.fdout = 1;
 r_cons_instance.break_lines = 
# 600 "project/radare2/libr/cons/cons.c" 3 4
                0
# 600 "project/radare2/libr/cons/cons.c"
                     ;
 r_cons_instance.lines = 0;

 r_cons_instance.context = &r_cons_context_default;
 cons_context_init (r_cons_instance.context, 
# 604 "project/radare2/libr/cons/cons.c" 3 4
                      ((void *)0)
# 604 "project/radare2/libr/cons/cons.c"
                          );

 r_cons_get_size (&r_cons_instance.pagesize);
 r_cons_instance.num = 
# 607 "project/radare2/libr/cons/cons.c" 3 4
        ((void *)0)
# 607 "project/radare2/libr/cons/cons.c"
            ;
 r_cons_instance.null = 0;




 r_cons_instance.vtmode = 2;




 tcgetattr (0, &r_cons_instance.term_buf);
 
# 619 "project/radare2/libr/cons/cons.c" 3 4
__builtin___memcpy_chk (
# 619 "project/radare2/libr/cons/cons.c"
&r_cons_instance.term_raw
# 619 "project/radare2/libr/cons/cons.c" 3 4
, 
# 619 "project/radare2/libr/cons/cons.c"
&r_cons_instance.term_buf, sizeof (r_cons_instance.term_raw)
# 619 "project/radare2/libr/cons/cons.c" 3 4
, __builtin_object_size (
# 619 "project/radare2/libr/cons/cons.c"
&r_cons_instance.term_raw
...
# 619 "project/radare2/libr/cons/cons.c"
                                                      ;
 r_cons_instance.term_raw.c_iflag &= ~(
# 620 "project/radare2/libr/cons/cons.c" 3 4
                        0x00000002
# 620 "project/radare2/libr/cons/cons.c"
                              |
# 620 "project/radare2/libr/cons/cons.c" 3 4
                               0x00000008
# 620 "project/radare2/libr/cons/cons.c"
...
# 620 "project/radare2/libr/cons/cons.c"
 ...
 r_cons_instance.term_raw.c_lflag &= ~(
# 621 "project/radare2/libr/cons/cons.c" 3 4
                        0x00000008
# 621 "project/radare2/libr/cons/cons.c"
                            |
# 621 "project/radare2/libr/cons/cons.c" 3 4
                             0x00000010
# 621 "project/radare2/libr/cons/cons.c"
...
# 621 "project/radare2/libr/cons/cons.c"
 ...
 r_cons_instance.term_raw.c_cflag &= ~(
# 622 "project/radare2/libr/cons/cons.c" 3 4
                        0x00000300
# 622 "project/radare2/libr/cons/cons.c"
                             |
# 622 "project/radare2/libr/cons/cons.c" 3 4
                              0x00001000
# 622 "project/radare2/libr/cons/cons.c"
 ...
 r_cons_instance.term_raw.c_cflag |= 
# 623 "project/radare2/libr/cons/cons.c" 3 4
                      0x00000300
# 623 "project/radare2/libr/cons/cons.c"
                         ;
 r_cons_instance.term_raw.c_cc[
# 624 "project/radare2/libr/cons/cons.c" 3 4
                16
# 624 "project/radare2/libr/cons/cons.c"
                    ] = 1;
 r_sys_signal (
# 625 "project/radare2/libr/cons/cons.c" 3 4
              28
# 625 "project/radare2/libr/cons/cons.c"
                      , resize);
# 634 "project/radare2/libr/cons/cons.c"
 r_cons_instance.pager = 
# 634 "project/radare2/libr/cons/cons.c" 3 4
          ((void *)0)
# 634 "project/radare2/libr/cons/cons.c"
              ;
 r_cons_instance.mouse = 0;
 r_cons_instance.show_vals = 
# 636 "project/radare2/libr/cons/cons.c" 3 4
              0
# 636 "project/radare2/libr/cons/cons.c"
                   ;
 r_cons_reset ();
 r_cons_rgb_init ();
...
# 645 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 645 "project/radare2/libr/cons/cons.c"
     RCons *r_cons_free(void) {
# 654 "project/radare2/libr/cons/cons.c"
 r_cons_instance.refcnt--;
 if (r_cons_instance.refcnt != 0) {
  return 
# 656 "project/radare2/libr/cons/cons.c" 3 4
        ((void *)0)
# 656 "project/radare2/libr/cons/cons.c"
            ;
 }
 if (r_cons_instance.line) {
  r_line_free ();
  r_cons_instance.line = 
# 660 "project/radare2/libr/cons/cons.c" 3 4
          ((void *)0)
# 660 "project/radare2/libr/cons/cons.c"
              ;
 }
 
# 662 "project/radare2/libr/cons/cons.c" 3 4
{ free((void *)
# 662 "project/radare2/libr/cons/cons.c"
r_cons_instance.context->buffer
# 662 "project/radare2/libr/cons/cons.c" 3 4
); 
# 662 "project/radare2/libr/cons/cons.c"
...
# 663 "project/radare2/libr/cons/cons.c" 3 4
{ free((void *)
# 663 "project/radare2/libr/cons/cons.c"
r_cons_instance.break_word
# 663 "project/radare2/libr/cons/cons.c" 3 4
); 
# 663 "project/radare2/libr/cons/cons.c"
r_cons_instance.break_word 
...
# 663 "project/radare2/libr/cons/cons.c"
                     ;
 cons_context_deinit (r_cons_instance.context);
 
# 665 "project/radare2/libr/cons/cons.c" 3 4
{ free((void *)
# 665 "project/radare2/libr/cons/cons.c"
r_cons_instance.context->lastOutput
# 665 "project/radare2/libr/cons/cons.c" 3 4
); 
# 665 "project/radare2/libr/cons/cons.c"
r_cons_instance.context->lastOutput 
...
# 665 "project/radare2/libr/cons/cons.c"
                      ;
 r_cons_instance.context->lastLength = 0;
 
# 667 "project/radare2/libr/cons/cons.c" 3 4
{ free((void *)
# 667 "project/radare2/libr/cons/cons.c"
r_cons_instance.pager
# 667 "project/radare2/libr/cons/cons.c" 3 4
); 
# 667 "project/radare2/libr/cons/cons.c"
...
# 667 "project/radare2/libr/cons/cons.c"
                ;
 return 
# 668 "project/radare2/libr/cons/cons.c" 3 4
       ((void *)0)
# 668 "project/radare2/libr/cons/cons.c"
           ;
}

#define MOAR (4096 * 8)
static 
# 672 "project/radare2/libr/cons/cons.c" 3 4
      _Bool 
# 672 "project/radare2/libr/cons/cons.c"
           palloc(int moar) {
 void *temp;
 if (moar <= 0) {
  return 
# 675 "project/radare2/libr/cons/cons.c" 3 4
        0
# 675 "project/radare2/libr/cons/cons.c"
             ;
 }
 if (!r_cons_instance.context->buffer) {
  int new_sz;
  if ((0x7fffffff - (4096 * 8)) < moar) {
   return 
# 680 "project/radare2/libr/cons/cons.c" 3 4
         0
# 680 "project/radare2/libr/cons/cons.c"
              ;
  }
  new_sz = moar + (4096 * 8);
  temp = calloc (1, new_sz);
  if (temp) {
   r_cons_instance.context->buffer_sz = new_sz;
   r_cons_instance.context->buffer = temp;
   r_cons_instance.context->buffer[0] = '\0';
  }
 } else if (moar + r_cons_instance.context->buffer_len > r_cons_instance.context->buffer_sz) {
  char *new_buffer;
  int old_buffer_sz = r_cons_instance.context->buffer_sz;
  if ((0x7fffffff - (4096 * 8) - moar) < r_cons_instance.context->buffer_sz) {
   return 
# 693 "project/radare2/libr/cons/cons.c" 3 4
         0
# 693 "project/radare2/libr/cons/cons.c"
              ;
  }
  r_cons_instance.context->buffer_sz += moar + (4096 * 8);
  new_buffer = realloc (r_cons_instance.context->buffer, r_cons_instance.context->buffer_sz);
  if (new_buffer) {
   r_cons_instance.context->buffer = new_buffer;
  } else {
   r_cons_instance.context->buffer_sz = old_buffer_sz;
   return 
# 701 "project/radare2/libr/cons/cons.c" 3 4
         0
# 701 "project/radare2/libr/cons/cons.c"
              ;
  }
 }
 return 
# 704 "project/radare2/libr/cons/cons.c" 3 4
       1
# 704 "project/radare2/libr/cons/cons.c"
           ;
}


# 707 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 707 "project/radare2/libr/cons/cons.c"
     int r_cons_eof(void) {
 return feof (r_cons_instance.fdin);
}


# 711 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 711 "project/radare2/libr/cons/cons.c"
...
# 719 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 719 "project/radare2/libr/cons/cons.c"
     void r_cons_print_clear(void) {
 r_cons_strcat ("\x1b[0;0H\x1b[0m");
}


# 723 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 723 "project/radare2/libr/cons/cons.c"
     void r_cons_fill_line(void) {
 char *p, white[1024];
 int cols = r_cons_instance.columns - 1;
 if (cols < 1) {
  return;
 }
 p = (cols >= sizeof (white))
...
# 732 "project/radare2/libr/cons/cons.c" 3 4
 __builtin___memset_chk (
# 732 "project/radare2/libr/cons/cons.c"
 p
# 732 "project/radare2/libr/cons/cons.c" 3 4
 , 
# 732 "project/radare2/libr/cons/cons.c"
...
# 741 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 741 "project/radare2/libr/cons/cons.c"
     void r_cons_clear_line(int std_err) {
# 758 "project/radare2/libr/cons/cons.c"
 fprintf (std_err? 
# 758 "project/radare2/libr/cons/cons.c" 3 4
                  __stderrp
# 758 "project/radare2/libr/cons/cons.c"
                        : 
# 758 "project/radare2/libr/cons/cons.c" 3 4
...
# 758 "project/radare2/libr/cons/cons.c"
 ...
 fflush (std_err? 
# 760 "project/radare2/libr/cons/cons.c" 3 4
                 __stderrp
# 760 "project/radare2/libr/cons/cons.c"
                       : 
# 760 "project/radare2/libr/cons/cons.c" 3 4
                         __stdoutp
# 760 "project/radare2/libr/cons/cons.c"
...
# 763 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 763 "project/radare2/libr/cons/cons.c"
...
# 768 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 768 "project/radare2/libr/cons/cons.c"
     void r_cons_reset_colors(void) {
 r_cons_strcat (
# 769 "project/radare2/libr/cons/cons.c" 3 4
               "\x1b[49m" "\x1b[0m"
# 769 "project/radare2/libr/cons/cons.c"
                                         );
}


# 772 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 772 "project/radare2/libr/cons/cons.c"
     void r_cons_clear(void) {
 r_cons_instance.lines = 0;



 r_cons_strcat (
# 777 "project/radare2/libr/cons/cons.c" 3 4
               "\x1b[0m" "\x1b[2J\r"
# 777 "project/radare2/libr/cons/cons.c"
                                              );

}


# 781 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 781 "project/radare2/libr/cons/cons.c"
     void r_cons_reset(void) {
 if (r_cons_instance.context->buffer) {
  r_cons_instance.context->buffer[0] = '\0';
 }
 r_cons_instance.context->buffer_len = 0;
 r_cons_instance.lines = 0;
 r_cons_instance.lastline = r_cons_instance.context->buffer;
 cons_grep_reset (&r_cons_instance.context->grep);
 r_cons_instance.context->pageable = 
# 789 "project/radare2/libr/cons/cons.c" 3 4
              1
# 789 "project/radare2/libr/cons/cons.c"
                  ;
}


# 792 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 792 "project/radare2/libr/cons/cons.c"
     const char *r_cons_get_buffer(void) {

 return r_cons_instance.context->buffer_len? r_cons_instance.context->buffer : 
# 794 "project/radare2/libr/cons/cons.c" 3 4
                                  ((void *)0)
# 794 "project/radare2/libr/cons/cons.c"
                                      ;
}


# 797 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 797 "project/radare2/libr/cons/cons.c"
     int r_cons_get_buffer_len(void) {
 return r_cons_instance.context->buffer_len;
}


# 801 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 801 "project/radare2/libr/cons/cons.c"
     void r_cons_filter(void) {

 if (r_cons_instance.context->filter || r_cons_instance.context->grep.nstrings > 0 || r_cons_instance.context->grep.tokens_used || r_cons_instance.context->grep.less || r_cons_instance.context->grep.json) {
  (void)r_cons_grepbuf ();
  r_cons_instance.context->filter = 
# 805 "project/radare2/libr/cons/cons.c" 3 4
             0
# 805 "project/radare2/libr/cons/cons.c"
                  ;
 }

 if (r_cons_instance.context->is_html) {
  int newlen = 0;
  char *input = r_str_ndup (r_cons_instance.context->buffer, r_cons_instance.context->buffer_len);
  char *res = r_cons_html_filter (input, &newlen);
  if (res) {
   free (r_cons_instance.context->buffer);
   r_cons_instance.context->buffer = res;
   r_cons_instance.context->buffer_len = newlen;
   r_cons_instance.context->buffer_sz = newlen;
  }
  free (input);
 }
 if (r_cons_instance.context->was_html) {
  r_cons_instance.context->is_html = 
# 821 "project/radare2/libr/cons/cons.c" 3 4
              1
# 821 "project/radare2/libr/cons/cons.c"
                  ;
  r_cons_instance.context->was_html = 
# 822 "project/radare2/libr/cons/cons.c" 3 4
               0
# 822 "project/radare2/libr/cons/cons.c"
                    ;
 }
}


# 826 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 826 "project/radare2/libr/cons/cons.c"
     void r_cons_push(void) {
 if (!r_cons_instance.context->cons_stack) {
  return;
 }
 RConsStack *data = cons_stack_dump (
# 830 "project/radare2/libr/cons/cons.c" 3 4
                                    1
# 830 "project/radare2/libr/cons/cons.c"
                                        );
 if (!data) {
  return;
 }
 r_stack_push (r_cons_instance.context->cons_stack, data);
 r_cons_instance.context->buffer_len = 0;
 if (r_cons_instance.context->buffer) {
  
# 837 "project/radare2/libr/cons/cons.c" 3 4
 __builtin___memset_chk (
# 837 "project/radare2/libr/cons/cons.c"
 r_cons_instance.context->buffer
# 837 "project/radare2/libr/cons/cons.c" 3 4
 , 
# 837 "project/radare2/libr/cons/cons.c"
 0, r_cons_instance.context->buffer_sz
# 837 "project/radare2/libr/cons/cons.c" 3 4
 , __builtin_object_size (
# 837 "project/radare2/libr/cons/cons.c"
 r_cons_instance.context->buffer
...
# 841 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 841 "project/radare2/libr/cons/cons.c"
     void r_cons_pop(void) {
 if (!r_cons_instance.context->cons_stack) {
  return;
 }
 RConsStack *data = (RConsStack *)r_stack_pop (r_cons_instance.context->cons_stack);
 if (!data) {
  return;
 }
 cons_stack_load (data, 
# 849 "project/radare2/libr/cons/cons.c" 3 4
                       1
# 849 "project/radare2/libr/cons/cons.c"
                           );
 cons_stack_free ((void *)data);
}


# 853 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 853 "project/radare2/libr/cons/cons.c"
     RConsContext *r_cons_context_new( RConsContext *parent) {
 RConsContext *context = 
# 854 "project/radare2/libr/cons/cons.c" 3 4
                        (
# 854 "project/radare2/libr/cons/cons.c"
                        RConsContext
# 854 "project/radare2/libr/cons/cons.c" 3 4
                        *)calloc(1,sizeof(
# 854 "project/radare2/libr/cons/cons.c"
...
# 854 "project/radare2/libr/cons/cons.c"
 ...
 if (!context) {
  return 
# 856 "project/radare2/libr/cons/cons.c" 3 4
        ((void *)0)
# 856 "project/radare2/libr/cons/cons.c"
            ;
 }
...
# 862 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 862 "project/radare2/libr/cons/cons.c"
     void r_cons_context_free(RConsContext *context) {
 if (!context) {
  return;
 }
...
# 870 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 870 "project/radare2/libr/cons/cons.c"
     void r_cons_context_load(RConsContext *context) {
 r_cons_instance.context = context;
}


# 874 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 874 "project/radare2/libr/cons/cons.c"
     void r_cons_context_reset(void) {
 r_cons_instance.context = &r_cons_context_default;
 r_cons_instance.context->sorted_column = -1;
}


# 879 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 879 "project/radare2/libr/cons/cons.c"
          r_cons_context_is_main(void) {
 return r_cons_instance.context == &r_cons_context_default;
}


# 883 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 883 "project/radare2/libr/cons/cons.c"
     void r_cons_context_break(RConsContext *context) {
 if (!context) {
  return;
 }
 context->breaked = 
# 887 "project/radare2/libr/cons/cons.c" 3 4
                   1
# 887 "project/radare2/libr/cons/cons.c"
                       ;
...
# 893 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 893 "project/radare2/libr/cons/cons.c"
     void r_cons_last(void) {
 if (!r_cons_instance.context->lastEnabled) {
  return;
 }
 r_cons_instance.context->lastMode = 
# 897 "project/radare2/libr/cons/cons.c" 3 4
              1
# 897 "project/radare2/libr/cons/cons.c"
                  ;
 r_cons_write (r_cons_instance.context->lastOutput, r_cons_instance.context->lastLength);
}

static 
# 901 "project/radare2/libr/cons/cons.c" 3 4
      _Bool 
# 901 "project/radare2/libr/cons/cons.c"
           lastMatters(void) {
 return (r_cons_instance.context->buffer_len > 0)
  && (r_cons_instance.context->lastEnabled && !r_cons_instance.context->filter && r_cons_instance.context->grep.nstrings < 1 &&
  !r_cons_instance.context->grep.tokens_used && !r_cons_instance.context->grep.less &&
  !r_cons_instance.context->grep.json && !r_cons_instance.context->is_html);
}


# 908 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 908 "project/radare2/libr/cons/cons.c"
     void r_cons_echo(const char *msg) {
 static RStrBuf *echodata = 
# 909 "project/radare2/libr/cons/cons.c" 3 4
                           ((void *)0)
# 909 "project/radare2/libr/cons/cons.c"
                               ;
 if (msg) {
  if (echodata) {
  ...
  if (echodata) {
   ...
   r_cons_newline ();
   echodata = 
# 922 "project/radare2/libr/cons/cons.c" 3 4
             ((void *)0)
# 922 "project/radare2/libr/cons/cons.c"
                 ;
   free (data);
  }
 }
...
# 928 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 928 "project/radare2/libr/cons/cons.c"
     void r_cons_eflush(void) {
 char *s = r_cons_errstr ();
 if (s) {
  
# 931 "project/radare2/libr/cons/cons.c" 3 4
 fprintf(__stderrp,
# 931 "project/radare2/libr/cons/cons.c"
 "%s", s
# 931 "project/radare2/libr/cons/cons.c" 3 4
 )
# 931 "project/radare2/libr/cons/cons.c"
...
static void optimize(void) {
 char *buf = r_cons_instance.context->buffer;
 int len = r_cons_instance.context->buffer_len;
 int i, codes = 0;
 int escape_n = 0;
 char escape[32];
 
# 945 "project/radare2/libr/cons/cons.c" 3 4
_Bool 
# 945 "project/radare2/libr/cons/cons.c"
     onescape = 
# 945 "project/radare2/libr/cons/cons.c" 3 4
                0
# 945 "project/radare2/libr/cons/cons.c"
                     ;
 char *oldstr = 
# 946 "project/radare2/libr/cons/cons.c" 3 4
               ((void *)0)
# 946 "project/radare2/libr/cons/cons.c"
                   ;
 for (i = 0; i < len; i++) {
  if (onescape) {
...
# 956 "project/radare2/libr/cons/cons.c" 3 4
    __builtin___memmove_chk (
# 956 "project/radare2/libr/cons/cons.c"
    buf + pos + 1
# 956 "project/radare2/libr/cons/cons.c" 3 4
    , 
# 956 "project/radare2/libr/cons/cons.c"
...
# 956 "project/radare2/libr/cons/cons.c"
    ...
    onescape = 
# 963 "project/radare2/libr/cons/cons.c" 3 4
              0
# 963 "project/radare2/libr/cons/cons.c"
                   ;
   } else {
    if (escape_n + 1 >= sizeof(escape)) {
     escape_n = 0;
     onescape = 
# 967 "project/radare2/libr/cons/cons.c" 3 4
               0
# 967 "project/radare2/libr/cons/cons.c"
                    ;
    }
   }
  } else if (buf[i] == 0x1b) {
   escape_n = 0;
   onescape = 
# 972 "project/radare2/libr/cons/cons.c" 3 4
             1
# 972 "project/radare2/libr/cons/cons.c"
                 ;
   escape[escape_n++] = buf[i];
   escape[escape_n] = 0;
   codes++;
 ...
 r_cons_instance.context->buffer_len = len;
 free (oldstr);
}


# 983 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 983 "project/radare2/libr/cons/cons.c"
     void r_cons_flush(void) {
 const char *tee = r_cons_instance.teefile;
 if (!r_cons_instance.context) {
  r_cons_context_reset ();
 }
 if (r_cons_instance.context->noflush) {
  return;
 }
 if (r_cons_instance.context->errmode == R_CONS_ERRMODE_FLUSH) {
  r_cons_eflush ();
 }
 if (r_cons_instance.null) {
  r_cons_reset ();
  return;
 }
 if (lastMatters () && !r_cons_instance.context->lastMode) {

  if (r_cons_instance.context->buffer_len > r_cons_instance.context->lastLength) {
   free (r_cons_instance.context->lastOutput);
   r_cons_instance.context->lastOutput = malloc (r_cons_instance.context->buffer_len + 1);
  }
  r_cons_instance.context->lastLength = r_cons_instance.context->buffer_len;
  
# 1005 "project/radare2/libr/cons/cons.c" 3 4
 __builtin___memcpy_chk (
# 1005 "project/radare2/libr/cons/cons.c"
 r_cons_instance.context->lastOutput
# 1005 "project/radare2/libr/cons/cons.c" 3 4
 , 
# 1005 "project/radare2/libr/cons/cons.c"
 r_cons_instance.context->buffer, r_cons_instance.context->buffer_len
# 1005 "project/radare2/libr/cons/cons.c" 3 4
 , __builtin_object_size (
# 1005 "project/radare2/libr/cons/cons.c"
 r_cons_instance.context->lastOutput
...
# 1005 "project/radare2/libr/cons/cons.c"
  ...
  r_cons_instance.context->lastMode = 
# 1007 "project/radare2/libr/cons/cons.c" 3 4
               0
# 1007 "project/radare2/libr/cons/cons.c"
                    ;
 }
 if (r_cons_instance.optimize) {

  optimize ();
  if (r_cons_instance.optimize > 1) {
   optimize ();
  }
 }
 r_cons_filter ();
 if (r_cons_is_interactive () && r_cons_instance.fdout == 1) {

  if (r_cons_instance.context->pageable && r_cons_instance.context->buffer && r_cons_instance.pager && *r_cons_instance.pager && r_cons_instance.context->buffer_len > 0 && r_str_char_count (r_cons_instance.context->buffer, '\n') >= r_cons_instance.rows) {
   r_cons_instance.context->buffer[r_cons_instance.context->buffer_len - 1] = 0;
   if (!strcmp (r_cons_instance.pager, "..")) {
    char *str = r_str_ndup (r_cons_instance.context->buffer, r_cons_instance.context->buffer_len);
    r_cons_instance.context->pageable = 
# 1023 "project/radare2/libr/cons/cons.c" 3 4
                 0
# 1023 "project/radare2/libr/cons/cons.c"
                      ;
    r_cons_less_str (str, 
# 1024 "project/radare2/libr/cons/cons.c" 3 4
                         ((void *)0)
# 1024 "project/radare2/libr/cons/cons.c"
                             );
    r_cons_reset ();
    free (str);
    return;
   } else {
    r_sys_cmd_str_full (r_cons_instance.pager, r_cons_instance.context->buffer, -1, 
# 1029 "project/radare2/libr/cons/cons.c" 3 4
                                               ((void *)0)
# 1029 "project/radare2/libr/cons/cons.c"
                                                   , 
# 1029 "project/radare2/libr/cons/cons.c" 3 4
                                                     ((void *)0)
# 1029 "project/radare2/libr/cons/cons.c"
...
# 1029 "project/radare2/libr/cons/cons.c"
  ...
  } else if (r_cons_instance.context->buffer_len > 
# 1032 "project/radare2/libr/cons/cons.c" 3 4
                            102400
# 1032 "project/radare2/libr/cons/cons.c"
                                         ) {

   int i, lines = 0;
   for (i = 0; r_cons_instance.context->buffer[i]; i++) {
    if (r_cons_instance.context->buffer[i] == '\n') {
     lines ++;
    }
   }
...
# 1053 "project/radare2/libr/cons/cons.c"
   r_cons_set_raw (
# 1053 "project/radare2/libr/cons/cons.c" 3 4
                  1
# 1053 "project/radare2/libr/cons/cons.c"
                      );
  }
 ...
 if (tee && *tee) {
  ...
  if (d) {
   if (r_cons_instance.context->buffer_len != fwrite (r_cons_instance.context->buffer, 1, r_cons_instance.context->buffer_len, d)) {
    
# 1060 "project/radare2/libr/cons/cons.c" 3 4
   fprintf(__stderrp,
# 1060 "project/radare2/libr/cons/cons.c"
   "r_cons_flush: fwrite: error (%s)\n", tee
# 1060 "project/radare2/libr/cons/cons.c" 3 4
   )
# 1060 "project/radare2/libr/cons/cons.c"
                                                      ;
...
# 1064 "project/radare2/libr/cons/cons.c" 3 4
  fprintf(__stderrp,
# 1064 "project/radare2/libr/cons/cons.c"
  "Cannot write on '%s'\n", tee
# 1064 "project/radare2/libr/cons/cons.c" 3 4
  )
# 1064 "project/radare2/libr/cons/cons.c"
 ...
 r_cons_highlight (r_cons_instance.highlight);


 if (r_cons_is_interactive () && !r_sandbox_enable (
# 1070 "project/radare2/libr/cons/cons.c" 3 4
                                                   0
# 1070 "project/radare2/libr/cons/cons.c"
                                                        )) {
  if (r_cons_instance.linesleep > 0 && r_cons_instance.linesleep < 1000) {
   int i = 0;
   int pagesize = 
# 1073 "project/radare2/libr/cons/cons.c" 3 4
                 (((
# 1073 "project/radare2/libr/cons/cons.c"
                 1
# 1073 "project/radare2/libr/cons/cons.c" 3 4
                 )>(
# 1073 "project/radare2/libr/cons/cons.c"
                 r_cons_instance.pagesize
# 1073 "project/radare2/libr/cons/cons.c" 3 4
                 ))?(
# 1073 "project/radare2/libr/cons/cons.c"
                 1
...
# 1073 "project/radare2/libr/cons/cons.c"
                                      ;
   char *ptr = r_cons_instance.context->buffer;
   char *nl = strchr (ptr, '\n');
   int len = r_cons_instance.context->buffer_len;
   r_cons_instance.context->buffer[r_cons_instance.context->buffer_len] = 0;
   r_cons_break_push (
# 1078 "project/radare2/libr/cons/cons.c" 3 4
                     ((void *)0)
# 1078 "project/radare2/libr/cons/cons.c"
                         , 
# 1078 "project/radare2/libr/cons/cons.c" 3 4
                           ((void *)0)
# 1078 "project/radare2/libr/cons/cons.c"
   ...
   while (nl && !r_cons_is_breaked ()) {
    ...
    if (r_cons_instance.linesleep && !(i % pagesize)) {
     r_sys_usleep (r_cons_instance.linesleep * 1000);
    }
    ptr = nl + 1;
    nl = strchr (ptr, '\n');
    i++;
   }
   __cons_write (ptr, r_cons_instance.context->buffer + len - ptr);
   r_cons_break_pop ();
  } else {
   __cons_write (r_cons_instance.context->buffer, r_cons_instance.context->buffer_len);
  }
 } else {
  __cons_write (r_cons_instance.context->buffer, r_cons_instance.context->buffer_len);
 }
 ...
 r_cons_reset ();
 if (r_cons_instance.newline) {
  
# 1099 "project/radare2/libr/cons/cons.c" 3 4
 fprintf(__stderrp,
# 1099 "project/radare2/libr/cons/cons.c"
 "\n"
# 1099 "project/radare2/libr/cons/cons.c" 3 4
 )
# 1099 "project/radare2/libr/cons/cons.c"
               ;
  r_cons_instance.newline = 
# 1100 "project/radare2/libr/cons/cons.c" 3 4
             0
# 1100 "project/radare2/libr/cons/cons.c"
                  ;
 }
}


# 1104 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1104 "project/radare2/libr/cons/cons.c"
     void r_cons_visual_flush(void) {
 if (r_cons_instance.context->noflush) {
  return;
 }
 r_cons_highlight (r_cons_instance.highlight);
 if (!r_cons_instance.null) {
# 1118 "project/radare2/libr/cons/cons.c"
  r_cons_visual_write (r_cons_instance.context->buffer);

 }
 r_cons_reset ();
 if (r_cons_instance.fps) {
  r_cons_print_fps (0);
 }
}


# 1127 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1127 "project/radare2/libr/cons/cons.c"
     void r_cons_print_fps(int col) {
 int fps = 0, w = r_cons_get_size (
# 1128 "project/radare2/libr/cons/cons.c" 3 4
                                  ((void *)0)
# 1128 "project/radare2/libr/cons/cons.c"
                                      );
 static 
# 1129 "project/radare2/libr/cons/cons.c" 3 4
       unsigned long long 
# 1129 "project/radare2/libr/cons/cons.c"
            prev = 0LL;
 fps = 0;
 if (prev) {
  
# 1132 "project/radare2/libr/cons/cons.c" 3 4
 unsigned long long 
# 1132 "project/radare2/libr/cons/cons.c"
      now = r_time_now_mono ();
  
# 1133 "project/radare2/libr/cons/cons.c" 3 4
 long long 
# 1133 "project/radare2/libr/cons/cons.c"
      diff = (
# 1133 "project/radare2/libr/cons/cons.c" 3 4
              long long
# 1133 "project/radare2/libr/cons/cons.c"
...
# 1154 "project/radare2/libr/cons/cons.c"
 
# 1154 "project/radare2/libr/cons/cons.c" 3 4
fprintf(__stderrp,
# 1154 "project/radare2/libr/cons/cons.c"
"\x1b[0;%dH[%d FPS] \n", w - col, fps
# 1154 "project/radare2/libr/cons/cons.c" 3 4
...
# 1168 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1168 "project/radare2/libr/cons/cons.c"
     void r_cons_visual_write(char *buffer) {
 char white[1024];
 int cols = r_cons_instance.columns;
 int alen, plen, lines = r_cons_instance.rows;
 
# 1172 "project/radare2/libr/cons/cons.c" 3 4
_Bool 
# 1172 "project/radare2/libr/cons/cons.c"
     break_lines = r_cons_instance.break_lines;
 const char *endptr;
...
# 1179 "project/radare2/libr/cons/cons.c" 3 4
__builtin___memset_chk (
# 1179 "project/radare2/libr/cons/cons.c"
&white
# 1179 "project/radare2/libr/cons/cons.c" 3 4
, 
# 1179 "project/radare2/libr/cons/cons.c"
  ...
  *nl = '\n';
  ...
  if ((break_lines && lines < lines_needed && lines > 0)
   ...
   if (lines > 0) {
    ...
    if (len != olen) {
     __cons_write (
# 1203 "project/radare2/libr/cons/cons.c" 3 4
                  "\x1b[0J\r"
# 1203 "project/radare2/libr/cons/cons.c"
                                                 , -1);
     __cons_write (
# 1204 "project/radare2/libr/cons/cons.c" 3 4
                  "\x1b[0m"
# 1204 "project/radare2/libr/cons/cons.c"
                             , strlen (
# 1204 "project/radare2/libr/cons/cons.c" 3 4
                                       "\x1b[0m"
# 1204 "project/radare2/libr/cons/cons.c"
   ...
   if (lines > 0) {
    ...
    __cons_write (pptr, plen);
    if (r_cons_instance.blankline && w > 0) {
     if (w > sizeof (white) - 1) {
      w = sizeof (white) - 1;
     }
   ...
   if (r_mem_mem ((const 
# 1219 "project/radare2/libr/cons/cons.c" 3 4
                        unsigned char
# 1219 "project/radare2/libr/cons/cons.c"
                           *)ptr, len, (const 
# 1219 "project/radare2/libr/cons/cons.c" 3 4
                                              unsigned char
# 1219 "project/radare2/libr/cons/cons.c"
                                                 *)"\x1b[0;0H", 6)) {
    lines = r_cons_instance.rows;
    __cons_write (pptr, plen);
   }
  }
  if (break_lines) {
...
# 1242 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1242 "project/radare2/libr/cons/cons.c"
     void r_cons_printf_list(const char *format, va_list ap) {
 size_t size, written;
 va_list ap2, ap3;

 
# 1246 "project/radare2/libr/cons/cons.c" 3 4
__builtin_va_copy(
# 1246 "project/radare2/libr/cons/cons.c"
ap2
# 1246 "project/radare2/libr/cons/cons.c" 3 4
,
# 1246 "project/radare2/libr/cons/cons.c"
...
# 1247 "project/radare2/libr/cons/cons.c" 3 4
__builtin_va_copy(
# 1247 "project/radare2/libr/cons/cons.c"
ap3
# 1247 "project/radare2/libr/cons/cons.c" 3 4
,
# 1247 "project/radare2/libr/cons/cons.c"
...
# 1247 "project/radare2/libr/cons/cons.c"
                 ;
 if (r_cons_instance.null || !format) {
  
# 1249 "project/radare2/libr/cons/cons.c" 3 4
 __builtin_va_end(
# 1249 "project/radare2/libr/cons/cons.c"
 ap2
# 1249 "project/radare2/libr/cons/cons.c" 3 4
 )
# 1249 "project/radare2/libr/cons/cons.c"
...
# 1250 "project/radare2/libr/cons/cons.c" 3 4
 __builtin_va_end(
# 1250 "project/radare2/libr/cons/cons.c"
 ap3
# 1250 "project/radare2/libr/cons/cons.c" 3 4
 )
# 1250 "project/radare2/libr/cons/cons.c"
 ...
 if (strchr (format, '%')) {
  if (palloc ((4096 * 8) + strlen (format) * 20)) {
club:
   size = r_cons_instance.context->buffer_sz - r_cons_instance.context->buffer_len;
   written = 
# 1257 "project/radare2/libr/cons/cons.c" 3 4
            __builtin___vsnprintf_chk (
# 1257 "project/radare2/libr/cons/cons.c"
            r_cons_instance.context->buffer + r_cons_instance.context->buffer_len
# 1257 "project/radare2/libr/cons/cons.c" 3 4
            , 
# 1257 "project/radare2/libr/cons/cons.c"
...
# 1260 "project/radare2/libr/cons/cons.c" 3 4
    __builtin_va_end(
# 1260 "project/radare2/libr/cons/cons.c"
    ap3
# 1260 "project/radare2/libr/cons/cons.c" 3 4
    )
# 1260 "project/radare2/libr/cons/cons.c"
...
# 1261 "project/radare2/libr/cons/cons.c" 3 4
    __builtin_va_copy(
# 1261 "project/radare2/libr/cons/cons.c"
    ap3
# 1261 "project/radare2/libr/cons/cons.c" 3 4
    ,
# 1261 "project/radare2/libr/cons/cons.c"
...
# 1261 "project/radare2/libr/cons/cons.c"
   ...
   r_cons_instance.context->buffer_len += written;
  }
 } else {
  r_cons_strcat (format);
 }
 
# 1270 "project/radare2/libr/cons/cons.c" 3 4
__builtin_va_end(
# 1270 "project/radare2/libr/cons/cons.c"
ap2
# 1270 "project/radare2/libr/cons/cons.c" 3 4
)
# 1270 "project/radare2/libr/cons/cons.c"
...
# 1271 "project/radare2/libr/cons/cons.c" 3 4
__builtin_va_end(
# 1271 "project/radare2/libr/cons/cons.c"
ap3
# 1271 "project/radare2/libr/cons/cons.c" 3 4
)
# 1271 "project/radare2/libr/cons/cons.c"
...
# 1274 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1274 "project/radare2/libr/cons/cons.c"
...
# 1279 "project/radare2/libr/cons/cons.c" 3 4
__builtin_va_start(
# 1279 "project/radare2/libr/cons/cons.c"
ap
# 1279 "project/radare2/libr/cons/cons.c" 3 4
,
# 1279 "project/radare2/libr/cons/cons.c"
...
# 1281 "project/radare2/libr/cons/cons.c" 3 4
__builtin_va_end(
# 1281 "project/radare2/libr/cons/cons.c"
ap
# 1281 "project/radare2/libr/cons/cons.c" 3 4
)
# 1281 "project/radare2/libr/cons/cons.c"
...
# 1286 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1286 "project/radare2/libr/cons/cons.c"
     void r_cons_errmode(int mode) {
 r_cons_instance.context->errmode = mode;
}


# 1290 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1290 "project/radare2/libr/cons/cons.c"
     void r_cons_errmodes(const char *mode) {
 int m = -1;
 if (!strcmp (mode, "echo")) {
 ...
 r_cons_instance.context->errmode = m;
}


# 1306 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1306 "project/radare2/libr/cons/cons.c"
     char *r_cons_errstr(void) {
 char *s = r_strbuf_drain (r_cons_instance.context->error);
 r_cons_instance.context->error = 
# 1308 "project/radare2/libr/cons/cons.c" 3 4
           ((void *)0)
# 1308 "project/radare2/libr/cons/cons.c"
               ;
 return s;
}


# 1312 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1312 "project/radare2/libr/cons/cons.c"
     int r_cons_eprintf(const char *format, ...) {
 va_list ap;
 
# 1314 "project/radare2/libr/cons/cons.c" 3 4
do { if (!(
# 1314 "project/radare2/libr/cons/cons.c"
!
# 1314 "project/radare2/libr/cons/cons.c" 3 4
(!(
# 1314 "project/radare2/libr/cons/cons.c"
...
# 1315 "project/radare2/libr/cons/cons.c" 3 4
__builtin_va_start(
# 1315 "project/radare2/libr/cons/cons.c"
ap
# 1315 "project/radare2/libr/cons/cons.c" 3 4
,
# 1315 "project/radare2/libr/cons/cons.c"
...
# 1315 "project/radare2/libr/cons/cons.c"
                     ;
 switch (r_cons_instance.context->errmode) {
 case R_CONS_ERRMODE_NULL:
  break;
 case R_CONS_ERRMODE_ECHO:
  vfprintf (
# 1320 "project/radare2/libr/cons/cons.c" 3 4
           __stderrp
# 1320 "project/radare2/libr/cons/cons.c"
                 , format, ap);
  break;
 case R_CONS_ERRMODE_QUIET:
 case R_CONS_ERRMODE_BUFFER:
 case R_CONS_ERRMODE_FLUSH:
  if (!r_cons_instance.context->error) {
   r_cons_instance.context->error = r_strbuf_new ("");
  }
  r_strbuf_vappendf (r_cons_instance.context->error, format, ap);
  break;
 }
 
# 1331 "project/radare2/libr/cons/cons.c" 3 4
__builtin_va_end(
# 1331 "project/radare2/libr/cons/cons.c"
ap
# 1331 "project/radare2/libr/cons/cons.c" 3 4
)
# 1331 "project/radare2/libr/cons/cons.c"
 ...
 return r_strbuf_length (r_cons_instance.context->error);
}


# 1336 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1336 "project/radare2/libr/cons/cons.c"
     int r_cons_get_column(void) {
 char *line = strrchr (r_cons_instance.context->buffer, '\n');
 if (!line) {
  line = r_cons_instance.context->buffer;
 }
 r_cons_instance.context->buffer[r_cons_instance.context->buffer_len] = 0;
...
# 1346 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1346 "project/radare2/libr/cons/cons.c"
     int r_cons_write(const char *str, int len) {
 
# 1347 "project/radare2/libr/cons/cons.c" 3 4
do { if (!(
# 1347 "project/radare2/libr/cons/cons.c"
str && len >= 0
# 1347 "project/radare2/libr/cons/cons.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 1347 "project/radare2/libr/cons/cons.c"
...
# 1347 "project/radare2/libr/cons/cons.c"
 ...
 if (str && len > 0 && !r_cons_instance.null) {
  if (palloc (len + 1)) {
   
# 1360 "project/radare2/libr/cons/cons.c" 3 4
  __builtin___memcpy_chk (
# 1360 "project/radare2/libr/cons/cons.c"
  r_cons_instance.context->buffer + r_cons_instance.context->buffer_len
# 1360 "project/radare2/libr/cons/cons.c" 3 4
  , 
# 1360 "project/radare2/libr/cons/cons.c"
...
# 1360 "project/radare2/libr/cons/cons.c"
 ...
 if (r_cons_instance.context->flush) {
  r_cons_flush ();
 }
 if (r_cons_instance.break_word && str && len > 0) {
  if (r_mem_mem ((const 
# 1369 "project/radare2/libr/cons/cons.c" 3 4
                       unsigned char
# 1369 "project/radare2/libr/cons/cons.c"
                          *)str, len, (const 
# 1369 "project/radare2/libr/cons/cons.c" 3 4
                                             unsigned char
# 1369 "project/radare2/libr/cons/cons.c"
                                                *)r_cons_instance.break_word, r_cons_instance.break_word_len)) {
   r_cons_instance.context->breaked = 
# 1370 "project/radare2/libr/cons/cons.c" 3 4
               1
# 1370 "project/radare2/libr/cons/cons.c"
                   ;
  }
 }
 return len;
...
# 1376 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1376 "project/radare2/libr/cons/cons.c"
     void r_cons_memset(char ch, int len) {
 if (!r_cons_instance.null && len > 0) {
  if (palloc (len + 1)) {
   
# 1379 "project/radare2/libr/cons/cons.c" 3 4
  __builtin___memset_chk (
# 1379 "project/radare2/libr/cons/cons.c"
  r_cons_instance.context->buffer + r_cons_instance.context->buffer_len
# 1379 "project/radare2/libr/cons/cons.c" 3 4
  , 
# 1379 "project/radare2/libr/cons/cons.c"
...
# 1386 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1386 "project/radare2/libr/cons/cons.c"
     void r_cons_strcat(const char *str) {
 int len;
 if (!str || r_cons_instance.null) {
  return;
 }
 len = strlen (str);
 if (len > 0) {
...
# 1397 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1397 "project/radare2/libr/cons/cons.c"
     void r_cons_newline(void) {
 if (!r_cons_instance.null) {
  r_cons_strcat ("\n");
 }
# 1414 "project/radare2/libr/cons/cons.c"
}




# 1418 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1418 "project/radare2/libr/cons/cons.c"
     int r_cons_get_cursor(int *rows) {
 int i, col = 0;
 int row = 0;

 for (i = 0; i < r_cons_instance.context->buffer_len; i++) {

  if (r_cons_instance.context->buffer[i] == 0x1b) {
   char ch2 = r_cons_instance.context->buffer[i + 1];
   char *str = r_cons_instance.context->buffer;
   if (ch2 == '\\') {
    i++;
   } else if (ch2 == ']') {
  ...
  } else if (r_cons_instance.context->buffer[i] == '\n') {
   row++;
   col = 0;
  } else {
   col++;
...
# 1451 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 1451 "project/radare2/libr/cons/cons.c"
          r_cons_is_windows(void) {



 char *e = r_sys_getenv ("WSL_INTEROP");
 
# 1456 "project/radare2/libr/cons/cons.c" 3 4
_Bool 
# 1456 "project/radare2/libr/cons/cons.c"
     res = 
# 1456 "project/radare2/libr/cons/cons.c" 3 4
           ((
# 1456 "project/radare2/libr/cons/cons.c"
...
# 1462 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 1462 "project/radare2/libr/cons/cons.c"
          r_cons_is_tty(void) {
 ...
 if (!isatty (1)) {
  return 
# 1471 "project/radare2/libr/cons/cons.c" 3 4
        0
# 1471 "project/radare2/libr/cons/cons.c"
             ;
 }
 if (ioctl (1, 
# 1473 "project/radare2/libr/cons/cons.c" 3 4
              ((__uint32_t)0x40000000 | ((sizeof(struct winsize) & 0x1fff) << 16) | ((('t')) << 8) | ((104)))
# 1473 "project/radare2/libr/cons/cons.c"
                        , &win)) {
  return 
# 1474 "project/radare2/libr/cons/cons.c" 3 4
        0
# 1474 "project/radare2/libr/cons/cons.c"
             ;
 }
 if (!win.ws_col || !win.ws_row) {
  return 
# 1477 "project/radare2/libr/cons/cons.c" 3 4
        0
# 1477 "project/radare2/libr/cons/cons.c"
             ;
 }
 tty = ttyname (1);
 if (!tty) {
  return 
# 1481 "project/radare2/libr/cons/cons.c" 3 4
        0
# 1481 "project/radare2/libr/cons/cons.c"
             ;
 }
 if (stat (tty, &sb) || !
# 1483 "project/radare2/libr/cons/cons.c" 3 4
                        (((
# 1483 "project/radare2/libr/cons/cons.c"
                        sb.st_mode
# 1483 "project/radare2/libr/cons/cons.c" 3 4
                        ) & 0170000) == 0020000)
# 1483 "project/radare2/libr/cons/cons.c"
  ...
  return 
# 1484 "project/radare2/libr/cons/cons.c" 3 4
        0
# 1484 "project/radare2/libr/cons/cons.c"
             ;
 }
 return 
# 1486 "project/radare2/libr/cons/cons.c" 3 4
       1
# 1486 "project/radare2/libr/cons/cons.c"
           ;
...
# 1565 "project/radare2/libr/cons/cons.c"

# 1565 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1565 "project/radare2/libr/cons/cons.c"
     int r_cons_get_size(int *rows) {
# 1586 "project/radare2/libr/cons/cons.c"
 struct winsize win = { 0 };
 if (isatty (0) && !ioctl (0, 
# 1587 "project/radare2/libr/cons/cons.c" 3 4
                             ((__uint32_t)0x40000000 | ((sizeof(struct winsize) & 0x1fff) << 16) | ((('t')) << 8) | ((104)))
# 1587 "project/radare2/libr/cons/cons.c"
                                       , &win)) {
  if ((!win.ws_col) || (!win.ws_row)) {
   const char *tty = isatty (1)? ttyname (1): 
# 1589 "project/radare2/libr/cons/cons.c" 3 4
                                             ((void *)0)
# 1589 "project/radare2/libr/cons/cons.c"
                                                 ;
   int fd = open (r_str_get_fail (tty, "/dev/tty"), 
# 1590 "project/radare2/libr/cons/cons.c" 3 4
                                                   0x0000
# 1590 "project/radare2/libr/cons/cons.c"
                                                           );
   if (fd != -1) {
    int ret = ioctl (fd, 
# 1592 "project/radare2/libr/cons/cons.c" 3 4
                        ((__uint32_t)0x40000000 | ((sizeof(struct winsize) & 0x1fff) << 16) | ((('t')) << 8) | ((104)))
# 1592 "project/radare2/libr/cons/cons.c"
                                  , &win);
  ...
  r_cons_instance.columns = win.ws_col;
  r_cons_instance.rows = win.ws_row;
 } else {
  r_cons_instance.columns = 80;
  r_cons_instance.rows = 23;
 }
# 1626 "project/radare2/libr/cons/cons.c"
 if (r_cons_instance.rows < 0) {
  r_cons_instance.rows = 0;
 }
 if (r_cons_instance.columns < 0) {
  r_cons_instance.columns = 0;
 }
 if (r_cons_instance.force_columns) {
  r_cons_instance.columns = r_cons_instance.force_columns;
 }
 if (r_cons_instance.force_rows) {
  r_cons_instance.rows = r_cons_instance.force_rows;
 }
 if (r_cons_instance.fix_columns) {
  r_cons_instance.columns += r_cons_instance.fix_columns;
 }
 if (r_cons_instance.fix_rows) {
  r_cons_instance.rows += r_cons_instance.fix_rows;
 }
 if (rows) {
  *rows = r_cons_instance.rows;
 }
 r_cons_instance.rows = 
# 1647 "project/radare2/libr/cons/cons.c" 3 4
         (((
# 1647 "project/radare2/libr/cons/cons.c"
         0
# 1647 "project/radare2/libr/cons/cons.c" 3 4
         )>(
# 1647 "project/radare2/libr/cons/cons.c"
...
# 1647 "project/radare2/libr/cons/cons.c"
                          ;
 return 
# 1648 "project/radare2/libr/cons/cons.c" 3 4
       (((
# 1648 "project/radare2/libr/cons/cons.c"
       0
# 1648 "project/radare2/libr/cons/cons.c" 3 4
       )>(
# 1648 "project/radare2/libr/cons/cons.c"
       r_cons_instance.columns
# 1648 "project/radare2/libr/cons/cons.c" 3 4
       ))?(
# 1648 "project/radare2/libr/cons/cons.c"
       0
...
# 1702 "project/radare2/libr/cons/cons.c"

# 1702 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1702 "project/radare2/libr/cons/cons.c"
     void r_cons_show_cursor(int cursor) {



  (void) write (1, cursor ? "\x1b[?25h" : "\x1b[?25l", 6);
# 1724 "project/radare2/libr/cons/cons.c"
}
# 1738 "project/radare2/libr/cons/cons.c"

# 1738 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1738 "project/radare2/libr/cons/cons.c"
     void r_cons_set_raw(
# 1738 "project/radare2/libr/cons/cons.c" 3 4
...
# 1738 "project/radare2/libr/cons/cons.c"
 ...
 if (is_raw) {
  r_cons_instance.term_raw.c_lflag &= ~(
# 1750 "project/radare2/libr/cons/cons.c" 3 4
                         0x00000008
# 1750 "project/radare2/libr/cons/cons.c"
                             |
# 1750 "project/radare2/libr/cons/cons.c" 3 4
                              0x00000010
# 1750 "project/radare2/libr/cons/cons.c"
...
# 1750 "project/radare2/libr/cons/cons.c"
  ...
  tcsetattr (0, 
# 1751 "project/radare2/libr/cons/cons.c" 3 4
               0
# 1751 "project/radare2/libr/cons/cons.c"
                      , &r_cons_instance.term_raw);
 } else {
  tcsetattr (0, 
# 1753 "project/radare2/libr/cons/cons.c" 3 4
               0
# 1753 "project/radare2/libr/cons/cons.c"
                      , &r_cons_instance.term_buf);
 }
# 1772 "project/radare2/libr/cons/cons.c"
 fflush (
# 1772 "project/radare2/libr/cons/cons.c" 3 4
        __stdoutp
# 1772 "project/radare2/libr/cons/cons.c"
              );
 oldraw = is_raw;
...
# 1776 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1776 "project/radare2/libr/cons/cons.c"
     void r_cons_set_utf8(
# 1776 "project/radare2/libr/cons/cons.c" 3 4
                          _Bool 
# 1776 "project/radare2/libr/cons/cons.c"
                               b) {
 r_cons_instance.use_utf8 = b;
# 1802 "project/radare2/libr/cons/cons.c"
}


# 1804 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1804 "project/radare2/libr/cons/cons.c"
     void r_cons_invert(int set, int color) {
 r_cons_strcat (
# 1805 "project/radare2/libr/cons/cons.c" 3 4
               (
# 1805 "project/radare2/libr/cons/cons.c"
               color
# 1805 "project/radare2/libr/cons/cons.c" 3 4
               ? (
# 1805 "project/radare2/libr/cons/cons.c"
...
# 1814 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 1814 "project/radare2/libr/cons/cons.c"
          r_cons_set_cup(
# 1814 "project/radare2/libr/cons/cons.c" 3 4
                         _Bool 
# 1814 "project/radare2/libr/cons/cons.c"
 ...
 if (write (2, code, code_len) != code_len) {
  return 
# 1821 "project/radare2/libr/cons/cons.c" 3 4
        0
# 1821 "project/radare2/libr/cons/cons.c"
             ;
 }
 fflush (
# 1823 "project/radare2/libr/cons/cons.c" 3 4
        __stdoutp
# 1823 "project/radare2/libr/cons/cons.c"
              );
# 1838 "project/radare2/libr/cons/cons.c"
 return 
# 1838 "project/radare2/libr/cons/cons.c" 3 4
       1
# 1838 "project/radare2/libr/cons/cons.c"
           ;
}
...
# 1841 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1841 "project/radare2/libr/cons/cons.c"
     void r_cons_column(int c) {
 char *b = malloc (r_cons_instance.context->buffer_len + 1);
 if (!b) {
  return;
 }
 
# 1846 "project/radare2/libr/cons/cons.c" 3 4
__builtin___memcpy_chk (
# 1846 "project/radare2/libr/cons/cons.c"
b
# 1846 "project/radare2/libr/cons/cons.c" 3 4
, 
# 1846 "project/radare2/libr/cons/cons.c"
...
# 1846 "project/radare2/libr/cons/cons.c"
                                    ;
 b[r_cons_instance.context->buffer_len] = 0;
 r_cons_reset ();
...
static 
# 1856 "project/radare2/libr/cons/cons.c" 3 4
      _Bool 
# 1856 "project/radare2/libr/cons/cons.c"
           lasti = 
# 1856 "project/radare2/libr/cons/cons.c" 3 4
                   0
# 1856 "project/radare2/libr/cons/cons.c"
...
# 1858 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1858 "project/radare2/libr/cons/cons.c"
     void r_cons_set_interactive(
# 1858 "project/radare2/libr/cons/cons.c" 3 4
                                 _Bool 
# 1858 "project/radare2/libr/cons/cons.c"
                                      x) {
...
# 1863 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1863 "project/radare2/libr/cons/cons.c"
     void r_cons_set_last_interactive(void) {
 r_cons_context ()->is_interactive = lasti;
}


# 1867 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1867 "project/radare2/libr/cons/cons.c"
     void r_cons_set_title(const char *str) {
# 1879 "project/radare2/libr/cons/cons.c"
 r_cons_printf ("\x1b]0;%s\007", str);

}


# 1883 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1883 "project/radare2/libr/cons/cons.c"
     void r_cons_zero(void) {
 if (r_cons_instance.line) {
  r_cons_instance.line->zerosep = 
# 1885 "project/radare2/libr/cons/cons.c" 3 4
                   1
# 1885 "project/radare2/libr/cons/cons.c"
                       ;
 }
 (void)write (1, "", 1);
}
...
# 1890 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1890 "project/radare2/libr/cons/cons.c"
     void r_cons_highlight(const char *word) {
 int l, *cpos = 
# 1891 "project/radare2/libr/cons/cons.c" 3 4
               ((void *)0)
# 1891 "project/radare2/libr/cons/cons.c"
                   ;
 char *rword = 
# 1892 "project/radare2/libr/cons/cons.c" 3 4
              ((void *)0)
# 1892 "project/radare2/libr/cons/cons.c"
                  , *res, *clean = 
# 1892 "project/radare2/libr/cons/cons.c" 3 4
                                   ((void *)0)
# 1892 "project/radare2/libr/cons/cons.c"
...
# 1894 "project/radare2/libr/cons/cons.c" 3 4
 (1? (1?"\x1b[7m": "\x1b[27m"): (1?"[":"]"))
# 1894 "project/radare2/libr/cons/cons.c"
                           ,
  
# 1895 "project/radare2/libr/cons/cons.c" 3 4
 (1? (0?"\x1b[7m": "\x1b[27m"): (0?"[":"]"))
 
# 1896 "project/radare2/libr/cons/cons.c"
};
 int linv[2] = {
  strlen (inv[0]),
  strlen (inv[1])
 ...
 if (!r_cons_instance.enable_highlight) {
  r_cons_enable_highlight (
# 1903 "project/radare2/libr/cons/cons.c" 3 4
                          1
# 1903 "project/radare2/libr/cons/cons.c"
                              );
  return;
 }
 if (word && *word && r_cons_instance.context->buffer) {
  int word_len = strlen (word);
  char *orig;
  clean = r_str_ndup (r_cons_instance.context->buffer, r_cons_instance.context->buffer_len);
  l = r_str_ansi_filter (clean, &orig, &cpos, -1);
  free (r_cons_instance.context->buffer);
  r_cons_instance.context->buffer = orig;
  if (r_cons_instance.highlight) {
   if (strcmp (word, r_cons_instance.highlight)) {
    free (r_cons_instance.highlight);
    r_cons_instance.highlight = strdup (word);
   }
  } else {
   r_cons_instance.highlight = strdup (word);
  }
...
# 1927 "project/radare2/libr/cons/cons.c" 3 4
 __builtin___strcpy_chk (
# 1927 "project/radare2/libr/cons/cons.c"
 rword
# 1927 "project/radare2/libr/cons/cons.c" 3 4
 , 
# 1927 "project/radare2/libr/cons/cons.c"
...
# 1928 "project/radare2/libr/cons/cons.c" 3 4
 __builtin___strcpy_chk (
# 1928 "project/radare2/libr/cons/cons.c"
 rword + linv[0]
# 1928 "project/radare2/libr/cons/cons.c" 3 4
 , 
# 1928 "project/radare2/libr/cons/cons.c"
...
# 1929 "project/radare2/libr/cons/cons.c" 3 4
 __builtin___strcpy_chk (
# 1929 "project/radare2/libr/cons/cons.c"
 rword + linv[0] + word_len
# 1929 "project/radare2/libr/cons/cons.c" 3 4
 , 
# 1929 "project/radare2/libr/cons/cons.c"
 inv[1]
...
# 1929 "project/radare2/libr/cons/cons.c"
                                            ;
  res = r_str_replace_thunked (r_cons_instance.context->buffer, clean, cpos,
     l, word, rword, 1);
  if (res) {
   r_cons_instance.context->buffer = res;
   r_cons_instance.context->buffer_len = r_cons_instance.context->buffer_sz = strlen (res);
  }
  free (rword);
  free (clean);
  free (cpos);
...
# 1942 "project/radare2/libr/cons/cons.c" 3 4
 { free((void *)
# 1942 "project/radare2/libr/cons/cons.c"
 r_cons_instance.highlight
# 1942 "project/radare2/libr/cons/cons.c" 3 4
 ); 
# 1942 "project/radare2/libr/cons/cons.c"
...
# 1946 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1946 "project/radare2/libr/cons/cons.c"
     char *r_cons_lastline(int *len) {
 char *b = r_cons_instance.context->buffer + r_cons_instance.context->buffer_len;
 while (b > r_cons_instance.context->buffer) {
  b--;
  if (*b == '\n') {
   b++;
   break;
 ...
 if (len) {
  int delta = b - r_cons_instance.context->buffer;
  *len = r_cons_instance.context->buffer_len - delta;
 }
 return b;
}
...
# 1964 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 1964 "project/radare2/libr/cons/cons.c"
     char *r_cons_lastline_utf8_ansi_len(int *len) {
 if (!len) {
...
# 2004 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 2004 "project/radare2/libr/cons/cons.c"
     char *r_cons_swap_ground(const char *col) {
 if (!col) {
  return 
# 2006 "project/radare2/libr/cons/cons.c" 3 4
        ((void *)0)
# 2006 "project/radare2/libr/cons/cons.c"
            ;
 }
...
# 2024 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 2024 "project/radare2/libr/cons/cons.c"
          r_cons_drop(int n) {
 if (n > r_cons_instance.context->buffer_len) {
  r_cons_instance.context->buffer_len = 0;
  return 
# 2027 "project/radare2/libr/cons/cons.c" 3 4
        0
# 2027 "project/radare2/libr/cons/cons.c"
             ;
 }
 r_cons_instance.context->buffer_len -= n;
 return 
# 2030 "project/radare2/libr/cons/cons.c" 3 4
       1
# 2030 "project/radare2/libr/cons/cons.c"
           ;
}


# 2033 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 2033 "project/radare2/libr/cons/cons.c"
     void r_cons_chop(void) {
 while (r_cons_instance.context->buffer_len > 0) {
  char ch = r_cons_instance.context->buffer[r_cons_instance.context->buffer_len - 1];
  if (ch != '\n' && !
# 2036 "project/radare2/libr/cons/cons.c" 3 4
                    ((
# 2036 "project/radare2/libr/cons/cons.c"
                    ch
# 2036 "project/radare2/libr/cons/cons.c" 3 4
                    ) == ' ' || (
# 2036 "project/radare2/libr/cons/cons.c"
...
# 2036 "project/radare2/libr/cons/cons.c"
  ...
  r_cons_instance.context->buffer_len--;
 }
}


# 2043 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 2043 "project/radare2/libr/cons/cons.c"
     void r_cons_bind(RConsBind *bind) {
 if (!bind) {
  return;
 }
...
# 2055 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 2055 "project/radare2/libr/cons/cons.c"
     const char* r_cons_get_rune(const 
# 2055 "project/radare2/libr/cons/cons.c" 3 4
                                       unsigned char 
# 2055 "project/radare2/libr/cons/cons.c"
                                           ch) {
 switch (ch) {
 case 
# 2057 "project/radare2/libr/cons/cons.c" 3 4
     0xce
# 2057 "project/radare2/libr/cons/cons.c"
                        : return 
# 2057 "project/radare2/libr/cons/cons.c" 3 4
                                 "─"
# 2057 "project/radare2/libr/cons/cons.c"
                                                ;
 case 
# 2058 "project/radare2/libr/cons/cons.c" 3 4
     0xc8
# 2058 "project/radare2/libr/cons/cons.c"
                       : return 
# 2058 "project/radare2/libr/cons/cons.c" 3 4
                                 "│"
# 2058 "project/radare2/libr/cons/cons.c"
                                               ;
 case 
# 2059 "project/radare2/libr/cons/cons.c" 3 4
     0xc9
# 2059 "project/radare2/libr/cons/cons.c"
                        : return 
# 2059 "project/radare2/libr/cons/cons.c" 3 4
                                 "┼"
# 2059 "project/radare2/libr/cons/cons.c"
                                                ;
 case 
# 2060 "project/radare2/libr/cons/cons.c" 3 4
     0xcf
# 2060 "project/radare2/libr/cons/cons.c"
                       : return 
# 2060 "project/radare2/libr/cons/cons.c" 3 4
                                 "┌"
# 2060 "project/radare2/libr/cons/cons.c"
                                               ;
 case 
# 2061 "project/radare2/libr/cons/cons.c" 3 4
     0xd0
# 2061 "project/radare2/libr/cons/cons.c"
                       : return 
# 2061 "project/radare2/libr/cons/cons.c" 3 4
                                 "┐"
# 2061 "project/radare2/libr/cons/cons.c"
                                               ;
 case 
# 2062 "project/radare2/libr/cons/cons.c" 3 4
     0xca
# 2062 "project/radare2/libr/cons/cons.c"
                       : return 
# 2062 "project/radare2/libr/cons/cons.c" 3 4
                                 "┘"
# 2062 "project/radare2/libr/cons/cons.c"
                                               ;
 case 
# 2063 "project/radare2/libr/cons/cons.c" 3 4
     0xcb
# 2063 "project/radare2/libr/cons/cons.c"
                       : return 
# 2063 "project/radare2/libr/cons/cons.c" 3 4
                                 "└"
# 2063 "project/radare2/libr/cons/cons.c"
                                               ;
 case 
# 2064 "project/radare2/libr/cons/cons.c" 3 4
     0xd2
# 2064 "project/radare2/libr/cons/cons.c"
                             : return 
# 2064 "project/radare2/libr/cons/cons.c" 3 4
                                       "╭"
# 2064 "project/radare2/libr/cons/cons.c"
                                                           ;
 case 
# 2065 "project/radare2/libr/cons/cons.c" 3 4
     0xd3
# 2065 "project/radare2/libr/cons/cons.c"
                             : return 
# 2065 "project/radare2/libr/cons/cons.c" 3 4
                                       "╮"
# 2065 "project/radare2/libr/cons/cons.c"
                                                           ;
 case 
# 2066 "project/radare2/libr/cons/cons.c" 3 4
     0xd4
# 2066 "project/radare2/libr/cons/cons.c"
                             : return 
# 2066 "project/radare2/libr/cons/cons.c" 3 4
                                       "╯"
# 2066 "project/radare2/libr/cons/cons.c"
                                                           ;
 case 
# 2067 "project/radare2/libr/cons/cons.c" 3 4
     0xd5
# 2067 "project/radare2/libr/cons/cons.c"
                             : return 
# 2067 "project/radare2/libr/cons/cons.c" 3 4
                                       "╰"
# 2067 "project/radare2/libr/cons/cons.c"
 ...
 return 
# 2069 "project/radare2/libr/cons/cons.c" 3 4
       ((void *)0)
# 2069 "project/radare2/libr/cons/cons.c"
           ;
}


# 2072 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 2072 "project/radare2/libr/cons/cons.c"
     void r_cons_breakword( const char *s) {
 free (r_cons_instance.break_word);
 if (s) {
  r_cons_instance.break_word = strdup (s);
  r_cons_instance.break_word_len = strlen (s);
 } else {
  r_cons_instance.break_word = 
# 2078 "project/radare2/libr/cons/cons.c" 3 4
                ((void *)0)
# 2078 "project/radare2/libr/cons/cons.c"
                    ;
  r_cons_instance.break_word_len = 0;
 }
}
# 2095 "project/radare2/libr/cons/cons.c"

# 2095 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 2095 "project/radare2/libr/cons/cons.c"
     void r_cons_cmd_help(const char *help[], 
# 2095 "project/radare2/libr/cons/cons.c" 3 4
                                              _Bool 
# 2095 "project/radare2/libr/cons/cons.c"
                                                   use_color) {
 ...
 const char *help_cmd = 
# 2104 "project/radare2/libr/cons/cons.c" 3 4
                       ((void *)0)
# 2104 "project/radare2/libr/cons/cons.c"
                           , *help_args = 
# 2104 "project/radare2/libr/cons/cons.c" 3 4
                                          ((void *)0)
# 2104 "project/radare2/libr/cons/cons.c"
...
# 2104 "project/radare2/libr/cons/cons.c"
 ...
 for (i = 0; help[i]; i += 3) {
  ...
  if (i) {
   max_length = 
# 2114 "project/radare2/libr/cons/cons.c" 3 4
               (((
# 2114 "project/radare2/libr/cons/cons.c"
               max_length
# 2114 "project/radare2/libr/cons/cons.c" 3 4
               )>(
# 2114 "project/radare2/libr/cons/cons.c"
...
# 2114 "project/radare2/libr/cons/cons.c"
 ...
 for (i = 0; help[i]; i += 3) {
  ...
  if (!strncmp (help_cmd, usage_str, strlen (usage_str))) {
   ...
   padding = 
# 2139 "project/radare2/libr/cons/cons.c" 3 4
            (((
# 2139 "project/radare2/libr/cons/cons.c"
...
# 2149 "project/radare2/libr/cons/cons.c" 3 4
__attribute__((visibility("default"))) 
# 2149 "project/radare2/libr/cons/cons.c"
     void r_cons_clear_buffer(void) {
 if (r_cons_instance.vtmode) {
