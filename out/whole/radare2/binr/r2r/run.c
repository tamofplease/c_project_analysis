# 0 "project/radare2/binr/r2r/run.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/binr/r2r/run.c"
...
# 4 "project/radare2/binr/r2r/run.c" 2
# 390 "project/radare2/binr/r2r/run.c"
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX11.sdk/usr/include/errno.h" 1 3 4
# 391 "project/radare2/binr/r2r/run.c" 2
...
# 409 "project/radare2/binr/r2r/run.c" 3 4
                                    ((void *)0)
# 409 "project/radare2/binr/r2r/run.c"
                                        ;
...
# 414 "project/radare2/binr/r2r/run.c" 3 4
unsigned char 
# 414 "project/radare2/binr/r2r/run.c"
    b = 1;
...
static RThreadFunctionRet sigchld_th(RThread *th) {
 while (
# 419 "project/radare2/binr/r2r/run.c" 3 4
       1
# 419 "project/radare2/binr/r2r/run.c"
           ) {
  
# 420 "project/radare2/binr/r2r/run.c" 3 4
 unsigned char 
# 420 "project/radare2/binr/r2r/run.c"
     b;
  ssize_t rd = read (sigchld_pipe[0], &b, 1);
  if (rd <= 0) {
   if (rd < 0) {
    if (
# 424 "project/radare2/binr/r2r/run.c" 3 4
       (*__error()) 
# 424 "project/radare2/binr/r2r/run.c"
             == 
# 424 "project/radare2/binr/r2r/run.c" 3 4
                4
# 424 "project/radare2/binr/r2r/run.c"
  ...
  while (
# 434 "project/radare2/binr/r2r/run.c" 3 4
        1
# 434 "project/radare2/binr/r2r/run.c"
            ) {
   int wstat;
   pid_t pid = waitpid (-1, &wstat, 
# 436 "project/radare2/binr/r2r/run.c" 3 4
                                   0x00000001
# 436 "project/radare2/binr/r2r/run.c"
                                          );
   if (pid <= 0) {
    break;
   }
   ...
   void **it;
   R2RSubprocess *proc = 
# 442 "project/radare2/binr/r2r/run.c" 3 4
                        ((void *)0)
# 442 "project/radare2/binr/r2r/run.c"
                            ;
   
# 443 "project/radare2/binr/r2r/run.c" 3 4
  for (
# 443 "project/radare2/binr/r2r/run.c"
  it 
# 443 "project/radare2/binr/r2r/run.c" 3 4
  = (void **)(
# 443 "project/radare2/binr/r2r/run.c"
...
# 443 "project/radare2/binr/r2r/run.c"
   ...
   if (
# 454 "project/radare2/binr/r2r/run.c" 3 4
      (((*(int *)&(
# 454 "project/radare2/binr/r2r/run.c"
      wstat
# 454 "project/radare2/binr/r2r/run.c" 3 4
      )) & 0177) == 0)
# 454 "project/radare2/binr/r2r/run.c"
    ...
    proc->ret = 
# 455 "project/radare2/binr/r2r/run.c" 3 4
               (((*(int *)&(
# 455 "project/radare2/binr/r2r/run.c"
               wstat
# 455 "project/radare2/binr/r2r/run.c" 3 4
               )) >> 8) & 0x000000ff)
# 455 "project/radare2/binr/r2r/run.c"
...
# 459 "project/radare2/binr/r2r/run.c" 3 4
  unsigned char 
# 459 "project/radare2/binr/r2r/run.c"
      r = 0;
...
# 470 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 470 "project/radare2/binr/r2r/run.c"
          r2r_subprocess_init(void) {
 r_pvector_init (&subprocs, 
# 471 "project/radare2/binr/r2r/run.c" 3 4
                           ((void *)0)
# 471 "project/radare2/binr/r2r/run.c"
                               );
 subprocs_mutex = r_th_lock_new (
# 472 "project/radare2/binr/r2r/run.c" 3 4
                                0
# 472 "project/radare2/binr/r2r/run.c"
                                     );
 if (!subprocs_mutex) {
  return 
# 474 "project/radare2/binr/r2r/run.c" 3 4
        0
# 474 "project/radare2/binr/r2r/run.c"
             ;
 }
 if (pipe (sigchld_pipe) == -1) {
  ...
  return 
# 479 "project/radare2/binr/r2r/run.c" 3 4
        0
# 479 "project/radare2/binr/r2r/run.c"
             ;
 }
 sigchld_thread = r_th_new (sigchld_th, 
# 481 "project/radare2/binr/r2r/run.c" 3 4
                                       ((void *)0)
# 481 "project/radare2/binr/r2r/run.c"
                                           , 0);
 if (!sigchld_thread) {
  ...
  r_th_lock_free (subprocs_mutex);
  return 
# 486 "project/radare2/binr/r2r/run.c" 3 4
        0
# 486 "project/radare2/binr/r2r/run.c"
             ;
 }
 if (r_sys_signal (
# 488 "project/radare2/binr/r2r/run.c" 3 4
                  20
# 488 "project/radare2/binr/r2r/run.c"
                         , handle_sigchld) < 0) {
  close (sigchld_pipe [0]);
  close (sigchld_pipe [1]);
  r_th_lock_free (subprocs_mutex);
  return 
# 492 "project/radare2/binr/r2r/run.c" 3 4
        0
# 492 "project/radare2/binr/r2r/run.c"
             ;
 }
 return 
# 494 "project/radare2/binr/r2r/run.c" 3 4
       1
# 494 "project/radare2/binr/r2r/run.c"
           ;
}


# 497 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) 
# 497 "project/radare2/binr/r2r/run.c"
     void r2r_subprocess_fini(void) {
 r_sys_signal (
# 498 "project/radare2/binr/r2r/run.c" 3 4
              20
# 498 "project/radare2/binr/r2r/run.c"
                     , 
# 498 "project/radare2/binr/r2r/run.c" 3 4
                       (void (*)(int))1
# 498 "project/radare2/binr/r2r/run.c"
...
# 499 "project/radare2/binr/r2r/run.c" 3 4
unsigned char 
# 499 "project/radare2/binr/r2r/run.c"
    b = 0;
 (void)write (sigchld_pipe[1], &b, 1);
 close (sigchld_pipe [1]);
...
# 509 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) 
# 509 "project/radare2/binr/r2r/run.c"
     R2RSubprocess *r2r_subprocess_start(
  const char *file, const char *args[], size_t args_size,
  const char *envvars[], const char *envvals[], size_t env_size) {
 ...
 if (!argv) {
  return 
# 514 "project/radare2/binr/r2r/run.c" 3 4
        ((void *)0)
# 514 "project/radare2/binr/r2r/run.c"
            ;
 }
 argv[0] = (char *)file;
 if (args_size) {
  
# 518 "project/radare2/binr/r2r/run.c" 3 4
 __builtin___memcpy_chk (
# 518 "project/radare2/binr/r2r/run.c"
 argv + 1
# 518 "project/radare2/binr/r2r/run.c" 3 4
 , 
# 518 "project/radare2/binr/r2r/run.c"
...
# 518 "project/radare2/binr/r2r/run.c"
 ...
 r_th_lock_enter (subprocs_mutex);
 R2RSubprocess *proc = 
# 522 "project/radare2/binr/r2r/run.c" 3 4
                      (
# 522 "project/radare2/binr/r2r/run.c"
                      R2RSubprocess
# 522 "project/radare2/binr/r2r/run.c" 3 4
                      *)calloc(1,sizeof(
# 522 "project/radare2/binr/r2r/run.c"
...
# 535 "project/radare2/binr/r2r/run.c" 3 4
                              4
# 535 "project/radare2/binr/r2r/run.c"
                                     , 
# 535 "project/radare2/binr/r2r/run.c" 3 4
                                       0x00000004
# 535 "project/radare2/binr/r2r/run.c"
...
# 552 "project/radare2/binr/r2r/run.c" 3 4
                          4
# 552 "project/radare2/binr/r2r/run.c"
                                 , 
# 552 "project/radare2/binr/r2r/run.c" 3 4
                                   0x00000004
# 552 "project/radare2/binr/r2r/run.c"
...
# 563 "project/radare2/binr/r2r/run.c" 3 4
                          4
# 563 "project/radare2/binr/r2r/run.c"
                                 , 
# 563 "project/radare2/binr/r2r/run.c" 3 4
                                   0x00000004
# 563 "project/radare2/binr/r2r/run.c"
 ...
 if (proc->pid == -1) {
  ...
  free (argv);
  return 
# 576 "project/radare2/binr/r2r/run.c" 3 4
        ((void *)0)
# 576 "project/radare2/binr/r2r/run.c"
            ;
 } else if (proc->pid == 0) {

  while ((dup2(stdin_pipe[0], 
# 579 "project/radare2/binr/r2r/run.c" 3 4
                             0
# 579 "project/radare2/binr/r2r/run.c"
                                         ) == -1) && (
# 579 "project/radare2/binr/r2r/run.c" 3 4
                                                      (*__error()) 
# 579 "project/radare2/binr/r2r/run.c"
...
# 582 "project/radare2/binr/r2r/run.c" 3 4
                              1
# 582 "project/radare2/binr/r2r/run.c"
                                           ) == -1) && (
# 582 "project/radare2/binr/r2r/run.c" 3 4
                                                        (*__error()) 
# 582 "project/radare2/binr/r2r/run.c"
...
# 585 "project/radare2/binr/r2r/run.c" 3 4
                              2
# 585 "project/radare2/binr/r2r/run.c"
                                           ) == -1) && (
# 585 "project/radare2/binr/r2r/run.c" 3 4
                                                        (*__error()) 
# 585 "project/radare2/binr/r2r/run.c"
...
# 585 "project/radare2/binr/r2r/run.c"
  ...
  perror ("exec");
  r_sys_exit (-1, 
# 595 "project/radare2/binr/r2r/run.c" 3 4
                 1
# 595 "project/radare2/binr/r2r/run.c"
                     );
 }
 free (argv);
...
error:
 ...
 r_th_lock_leave (subprocs_mutex);
 return 
# 637 "project/radare2/binr/r2r/run.c" 3 4
       ((void *)0)
# 637 "project/radare2/binr/r2r/run.c"
           ;
}


# 640 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 640 "project/radare2/binr/r2r/run.c"
          r2r_subprocess_wait(R2RSubprocess *proc, 
# 640 "project/radare2/binr/r2r/run.c" 3 4
                                                   unsigned long long 
# 640 "project/radare2/binr/r2r/run.c"
...
# 641 "project/radare2/binr/r2r/run.c" 3 4
unsigned long long 
# 641 "project/radare2/binr/r2r/run.c"
     timeout_abs;
 if (timeout_ms != 
# 642 "project/radare2/binr/r2r/run.c" 3 4
                  0xFFFFFFFFFFFFFFFFULL
# 642 "project/radare2/binr/r2r/run.c"
                          ) {
  timeout_abs = r_time_now_mono () + timeout_ms * 
# 643 "project/radare2/binr/r2r/run.c" 3 4
                                                 1000ULL
# 643 "project/radare2/binr/r2r/run.c"
                                                                ;
 }

 int r = 0;
 
# 647 "project/radare2/binr/r2r/run.c" 3 4
_Bool 
# 647 "project/radare2/binr/r2r/run.c"
     stdout_eof = 
# 647 "project/radare2/binr/r2r/run.c" 3 4
                  0
# 647 "project/radare2/binr/r2r/run.c"
...
# 648 "project/radare2/binr/r2r/run.c" 3 4
_Bool 
# 648 "project/radare2/binr/r2r/run.c"
     stderr_eof = 
# 648 "project/radare2/binr/r2r/run.c" 3 4
                  0
# 648 "project/radare2/binr/r2r/run.c"
...
# 649 "project/radare2/binr/r2r/run.c" 3 4
_Bool 
# 649 "project/radare2/binr/r2r/run.c"
     child_dead = 
# 649 "project/radare2/binr/r2r/run.c" 3 4
                  0
# 649 "project/radare2/binr/r2r/run.c"
...
# 652 "project/radare2/binr/r2r/run.c" 3 4
 __builtin_bzero(
# 652 "project/radare2/binr/r2r/run.c"
 &rfds
# 652 "project/radare2/binr/r2r/run.c" 3 4
 , sizeof(*(
# 652 "project/radare2/binr/r2r/run.c"
...
# 655 "project/radare2/binr/r2r/run.c" 3 4
  __darwin_fd_set((
# 655 "project/radare2/binr/r2r/run.c"
  proc->stdout_fd
# 655 "project/radare2/binr/r2r/run.c" 3 4
  ), (
# 655 "project/radare2/binr/r2r/run.c"
...
# 661 "project/radare2/binr/r2r/run.c" 3 4
  __darwin_fd_set((
# 661 "project/radare2/binr/r2r/run.c"
  proc->stderr_fd
# 661 "project/radare2/binr/r2r/run.c" 3 4
  ), (
# 661 "project/radare2/binr/r2r/run.c"
...
# 667 "project/radare2/binr/r2r/run.c" 3 4
  __darwin_fd_set((
# 667 "project/radare2/binr/r2r/run.c"
  proc->killpipe[0]
# 667 "project/radare2/binr/r2r/run.c" 3 4
  ), (
# 667 "project/radare2/binr/r2r/run.c"
...
# 675 "project/radare2/binr/r2r/run.c" 3 4
                           ((void *)0)
# 675 "project/radare2/binr/r2r/run.c"
                               ;
  if (timeout_ms != 
# 676 "project/radare2/binr/r2r/run.c" 3 4
                   0xFFFFFFFFFFFFFFFFULL
# 676 "project/radare2/binr/r2r/run.c"
                           ) {
   
# 677 "project/radare2/binr/r2r/run.c" 3 4
  unsigned long long 
# 677 "project/radare2/binr/r2r/run.c"
       now = r_time_now_mono ();
   if (now >= timeout_abs) {
    break;
   }
   
# 681 "project/radare2/binr/r2r/run.c" 3 4
  unsigned long long 
# 681 "project/radare2/binr/r2r/run.c"
       usec_diff = timeout_abs - r_time_now_mono ();
   timeout_s.tv_sec = usec_diff / 
# 682 "project/radare2/binr/r2r/run.c" 3 4
                                 1000000ULL
# 682 "project/radare2/binr/r2r/run.c"
                                               ;
   timeout_s.tv_usec = usec_diff % 
# 683 "project/radare2/binr/r2r/run.c" 3 4
                                  1000000ULL
# 683 "project/radare2/binr/r2r/run.c"
                                                ;
   timeout = &timeout_s;
  }
  r = select (nfds, &rfds, 
# 686 "project/radare2/binr/r2r/run.c" 3 4
                          ((void *)0)
# 686 "project/radare2/binr/r2r/run.c"
                              , 
# 686 "project/radare2/binr/r2r/run.c" 3 4
                                ((void *)0)
# 686 "project/radare2/binr/r2r/run.c"
  ...
  if (r < 0) {
   if (
# 688 "project/radare2/binr/r2r/run.c" 3 4
      (*__error()) 
# 688 "project/radare2/binr/r2r/run.c"
            == 
# 688 "project/radare2/binr/r2r/run.c" 3 4
               4
# 688 "project/radare2/binr/r2r/run.c"
...
# 694 "project/radare2/binr/r2r/run.c" 3 4
 _Bool 
# 694 "project/radare2/binr/r2r/run.c"
      timedout = 
# 694 "project/radare2/binr/r2r/run.c" 3 4
                 1
# 694 "project/radare2/binr/r2r/run.c"
                     ;
  if (
# 695 "project/radare2/binr/r2r/run.c" 3 4
     __darwin_fd_isset((
# 695 "project/radare2/binr/r2r/run.c"
     proc->stdout_fd
# 695 "project/radare2/binr/r2r/run.c" 3 4
     ), (
# 695 "project/radare2/binr/r2r/run.c"
...
# 695 "project/radare2/binr/r2r/run.c"
   ...
   timedout = 
# 696 "project/radare2/binr/r2r/run.c" 3 4
             0
# 696 "project/radare2/binr/r2r/run.c"
                  ;
   char buf[0x500];
   ...
   if (sz < 0) {
    ...
    stdout_eof = 
# 702 "project/radare2/binr/r2r/run.c" 3 4
                1
# 702 "project/radare2/binr/r2r/run.c"
                    ;
   } else {
  ...
  if (
# 707 "project/radare2/binr/r2r/run.c" 3 4
     __darwin_fd_isset((
# 707 "project/radare2/binr/r2r/run.c"
     proc->stderr_fd
# 707 "project/radare2/binr/r2r/run.c" 3 4
     ), (
# 707 "project/radare2/binr/r2r/run.c"
...
# 707 "project/radare2/binr/r2r/run.c"
   ...
   timedout = 
# 708 "project/radare2/binr/r2r/run.c" 3 4
             0
# 708 "project/radare2/binr/r2r/run.c"
                  ;
   char buf[0x500];
   ...
   if (sz < 0) {
    ...
    stderr_eof = 
# 715 "project/radare2/binr/r2r/run.c" 3 4
                1
# 715 "project/radare2/binr/r2r/run.c"
                    ;
   } else {
  ...
  if (
# 720 "project/radare2/binr/r2r/run.c" 3 4
     __darwin_fd_isset((
# 720 "project/radare2/binr/r2r/run.c"
     proc->killpipe[0]
# 720 "project/radare2/binr/r2r/run.c" 3 4
     ), (
# 720 "project/radare2/binr/r2r/run.c"
...
# 720 "project/radare2/binr/r2r/run.c"
   ...
   timedout = 
# 721 "project/radare2/binr/r2r/run.c" 3 4
             0
# 721 "project/radare2/binr/r2r/run.c"
                  ;
   child_dead = 
# 722 "project/radare2/binr/r2r/run.c" 3 4
               1
# 722 "project/radare2/binr/r2r/run.c"
                   ;
  }
  if (timedout) {
   break;
...
# 734 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) 
# 734 "project/radare2/binr/r2r/run.c"
     void r2r_subprocess_kill(R2RSubprocess *proc) {
 kill (proc->pid, 
# 735 "project/radare2/binr/r2r/run.c" 3 4
                 9
# 735 "project/radare2/binr/r2r/run.c"
                        );
}


# 738 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) 
# 738 "project/radare2/binr/r2r/run.c"
...
# 744 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) 
# 744 "project/radare2/binr/r2r/run.c"
     R2RProcessOutput *r2r_subprocess_drain(R2RSubprocess *proc) {
 r_th_lock_enter (subprocs_mutex);
 R2RProcessOutput *out = 
# 746 "project/radare2/binr/r2r/run.c" 3 4
                        (
# 746 "project/radare2/binr/r2r/run.c"
                        R2RProcessOutput
# 746 "project/radare2/binr/r2r/run.c" 3 4
                        *)malloc(sizeof(
# 746 "project/radare2/binr/r2r/run.c"
...
# 746 "project/radare2/binr/r2r/run.c"
 ...
 if (out) {
  ...
  out->ret = proc->ret;
  out->timeout = 
# 751 "project/radare2/binr/r2r/run.c" 3 4
                0
# 751 "project/radare2/binr/r2r/run.c"
                     ;
 }
 r_th_lock_leave (subprocs_mutex);
 return out;
...
# 757 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) 
# 757 "project/radare2/binr/r2r/run.c"
     void r2r_subprocess_free(R2RSubprocess *proc) {
 if (!proc) {
  return;
 }
...
# 777 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) 
# 777 "project/radare2/binr/r2r/run.c"
     void r2r_process_output_free(R2RProcessOutput *out) {
 if (!out) {
  return;
 }
...
static R2RProcessOutput *subprocess_runner(const char *file, const char *args[], size_t args_size,
 const char *envvars[], const char *envvals[], size_t env_size, 
# 787 "project/radare2/binr/r2r/run.c" 3 4
                                                               unsigned long long 
# 787 "project/radare2/binr/r2r/run.c"
                                                                    timeout_ms, void *user) {
 R2RSubprocess *proc = r2r_subprocess_start (file, args, args_size, envvars, envvals, env_size);
 if (!proc) {
  return 
# 790 "project/radare2/binr/r2r/run.c" 3 4
        ((void *)0)
# 790 "project/radare2/binr/r2r/run.c"
            ;
 }
 
# 792 "project/radare2/binr/r2r/run.c" 3 4
_Bool 
# 792 "project/radare2/binr/r2r/run.c"
...
# 870 "project/radare2/binr/r2r/run.c"
static R2RProcessOutput *run_r2_test(R2RRunConfig *config, 
# 870 "project/radare2/binr/r2r/run.c" 3 4
                                                          unsigned long long 
# 870 "project/radare2/binr/r2r/run.c"
...
# 870 "project/radare2/binr/r2r/run.c"
 ...
 RPVector args;
 r_pvector_init (&args, 
# 872 "project/radare2/binr/r2r/run.c" 3 4
                       ((void *)0)
# 872 "project/radare2/binr/r2r/run.c"
                           );
...
# 879 "project/radare2/binr/r2r/run.c" 3 4
if (
# 879 "project/radare2/binr/r2r/run.c"
extra_args
# 879 "project/radare2/binr/r2r/run.c" 3 4
) for (
# 879 "project/radare2/binr/r2r/run.c"
...
# 889 "project/radare2/binr/r2r/run.c" 3 4
if (
# 889 "project/radare2/binr/r2r/run.c"
files
# 889 "project/radare2/binr/r2r/run.c" 3 4
) for (
# 889 "project/radare2/binr/r2r/run.c"
...
# 918 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) 
# 918 "project/radare2/binr/r2r/run.c"
     R2RProcessOutput *r2r_run_cmd_test(R2RRunConfig *config, R2RCmdTest *test, R2RCmdRunner runner, void *user) {
 RList *extra_args = test->args.value ? r_str_split_duplist (test->args.value, " ", 
# 919 "project/radare2/binr/r2r/run.c" 3 4
                                                                                   1
# 919 "project/radare2/binr/r2r/run.c"
                                                                                       ) : 
# 919 "project/radare2/binr/r2r/run.c" 3 4
                                                                                           ((void *)0)
# 919 "project/radare2/binr/r2r/run.c"
...
# 920 "project/radare2/binr/r2r/run.c" 3 4
                                                                              1
# 920 "project/radare2/binr/r2r/run.c"
                                                                                  ): 
# 920 "project/radare2/binr/r2r/run.c" 3 4
                                                                                     ((void *)0)
# 920 "project/radare2/binr/r2r/run.c"
...
# 925 "project/radare2/binr/r2r/run.c" 3 4
 if (
# 925 "project/radare2/binr/r2r/run.c"
 extra_args
# 925 "project/radare2/binr/r2r/run.c" 3 4
 ) for (
# 925 "project/radare2/binr/r2r/run.c"
...
# 935 "project/radare2/binr/r2r/run.c" 3 4
if (
# 935 "project/radare2/binr/r2r/run.c"
files
# 935 "project/radare2/binr/r2r/run.c" 3 4
) for (
# 935 "project/radare2/binr/r2r/run.c"
...
# 935 "project/radare2/binr/r2r/run.c"
 ...
 if (
# 940 "project/radare2/binr/r2r/run.c" 3 4
    (!(
# 940 "project/radare2/binr/r2r/run.c"
    files
# 940 "project/radare2/binr/r2r/run.c" 3 4
    ) || !(
# 940 "project/radare2/binr/r2r/run.c"
...
# 940 "project/radare2/binr/r2r/run.c"
  ...
  if (!files) {
   ...
   files->free = 
# 944 "project/radare2/binr/r2r/run.c" 3 4
                ((void *)0)
# 944 "project/radare2/binr/r2r/run.c"
                    ;
  }
  
# 946 "project/radare2/binr/r2r/run.c" 3 4
 r_list_append ((
# 946 "project/radare2/binr/r2r/run.c"
 files
# 946 "project/radare2/binr/r2r/run.c" 3 4
 ), (
# 946 "project/radare2/binr/r2r/run.c"
...
# 948 "project/radare2/binr/r2r/run.c" 3 4
unsigned long long 
# 948 "project/radare2/binr/r2r/run.c"
...
# 955 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 955 "project/radare2/binr/r2r/run.c"
          r2r_check_cmd_test(R2RProcessOutput *out, R2RCmdTest *test) {
 if (!out || out->ret != 0 || !out->out || !out->err || out->timeout) {
  return 
# 957 "project/radare2/binr/r2r/run.c" 3 4
        0
# 957 "project/radare2/binr/r2r/run.c"
             ;
 }
 const char *expect_out = test->expect.value;
 if (expect_out && strcmp (out->out, expect_out) != 0) {
  return 
# 961 "project/radare2/binr/r2r/run.c" 3 4
        0
# 961 "project/radare2/binr/r2r/run.c"
             ;
 }
 const char *expect_err = test->expect_err.value;
 if (expect_err && strcmp (out->err, expect_err) != 0) {
  return 
# 965 "project/radare2/binr/r2r/run.c" 3 4
        0
# 965 "project/radare2/binr/r2r/run.c"
             ;
 }
 const char *regexp_out = test->regexp_out.value;
 if (regexp_out && !r_regex_match (regexp_out, "e", out->out)) {
  return 
# 969 "project/radare2/binr/r2r/run.c" 3 4
        0
# 969 "project/radare2/binr/r2r/run.c"
             ;
 }
 const char *regexp_err = test->regexp_err.value;
 if (regexp_err && !r_regex_match (regexp_err, "e", out->err)) {
  return 
# 973 "project/radare2/binr/r2r/run.c" 3 4
        0
# 973 "project/radare2/binr/r2r/run.c"
             ;
 }
 return 
# 975 "project/radare2/binr/r2r/run.c" 3 4
       1
# 975 "project/radare2/binr/r2r/run.c"
           ;
}
...
# 980 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 980 "project/radare2/binr/r2r/run.c"
          r2r_check_jq_available(void) {
 const char *args[] = {"."};
 const char *invalid_json = "this is not json lol";
 R2RSubprocess *proc = r2r_subprocess_start ("jq", args, 1, 
# 983 "project/radare2/binr/r2r/run.c" 3 4
                                                             ((void *)0)
# 983 "project/radare2/binr/r2r/run.c"
                                                                 , 
# 983 "project/radare2/binr/r2r/run.c" 3 4
                                                                   ((void *)0)
# 983 "project/radare2/binr/r2r/run.c"
...
# 985 "project/radare2/binr/r2r/run.c" 3 4
                                          unsigned char 
# 985 "project/radare2/binr/r2r/run.c"
                                              *)invalid_json, strlen (invalid_json));
  r2r_subprocess_wait (proc, 
# 986 "project/radare2/binr/r2r/run.c" 3 4
                            0xFFFFFFFFFFFFFFFFULL
# 986 "project/radare2/binr/r2r/run.c"
                                    );
 }
 
# 988 "project/radare2/binr/r2r/run.c" 3 4
_Bool 
# 988 "project/radare2/binr/r2r/run.c"
     invalid_detected = proc && proc->ret != 0;
 r2r_subprocess_free (proc);

 const char *valid_json = "{\"this is\":\"valid json\",\"lol\":true}";
 proc = r2r_subprocess_start ("jq", args, 1, 
# 992 "project/radare2/binr/r2r/run.c" 3 4
                                              ((void *)0)
# 992 "project/radare2/binr/r2r/run.c"
                                                  , 
# 992 "project/radare2/binr/r2r/run.c" 3 4
                                                    ((void *)0)
# 992 "project/radare2/binr/r2r/run.c"
 ...
 if (proc) {
  r2r_subprocess_stdin_write (proc, (const 
# 994 "project/radare2/binr/r2r/run.c" 3 4
                                          unsigned char 
# 994 "project/radare2/binr/r2r/run.c"
                                              *)valid_json, strlen (valid_json));
  r2r_subprocess_wait (proc, 
# 995 "project/radare2/binr/r2r/run.c" 3 4
                            0xFFFFFFFFFFFFFFFFULL
# 995 "project/radare2/binr/r2r/run.c"
                                    );
 }
 
# 997 "project/radare2/binr/r2r/run.c" 3 4
_Bool 
# 997 "project/radare2/binr/r2r/run.c"
...
# 1003 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) 
# 1003 "project/radare2/binr/r2r/run.c"
     R2RProcessOutput *r2r_run_json_test(R2RRunConfig *config, R2RJsonTest *test, R2RCmdRunner runner, void *user) {
 RList *files = r_list_new ();
 
# 1005 "project/radare2/binr/r2r/run.c" 3 4
r_list_append ((
# 1005 "project/radare2/binr/r2r/run.c"
files
# 1005 "project/radare2/binr/r2r/run.c" 3 4
), (
# 1005 "project/radare2/binr/r2r/run.c"
...
# 1006 "project/radare2/binr/r2r/run.c" 3 4
                                                                                   ((void *)0)
# 1006 "project/radare2/binr/r2r/run.c"
...
# 1011 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 1011 "project/radare2/binr/r2r/run.c"
          r2r_check_json_test(R2RProcessOutput *out, R2RJsonTest *test) {
 if (!out || out->ret != 0 || !out->out || !out->err || out->timeout) {
  return 
# 1013 "project/radare2/binr/r2r/run.c" 3 4
        0
# 1013 "project/radare2/binr/r2r/run.c"
             ;
 }
 const char *args[] = {"."};
 R2RSubprocess *proc = r2r_subprocess_start ("jq", args, 1, 
# 1016 "project/radare2/binr/r2r/run.c" 3 4
                                                             ((void *)0)
# 1016 "project/radare2/binr/r2r/run.c"
                                                                 , 
# 1016 "project/radare2/binr/r2r/run.c" 3 4
                                                                   ((void *)0)
# 1016 "project/radare2/binr/r2r/run.c"
                                                                       , 0);
 r2r_subprocess_stdin_write (proc, (const 
# 1017 "project/radare2/binr/r2r/run.c" 3 4
                                         unsigned char 
# 1017 "project/radare2/binr/r2r/run.c"
                                             *)out->out, strlen (out->out));
 r2r_subprocess_wait (proc, 
# 1018 "project/radare2/binr/r2r/run.c" 3 4
                           0xFFFFFFFFFFFFFFFFULL
# 1018 "project/radare2/binr/r2r/run.c"
                                   );
 
# 1019 "project/radare2/binr/r2r/run.c" 3 4
_Bool 
# 1019 "project/radare2/binr/r2r/run.c"
     ret = proc->ret == 0;
 r2r_subprocess_free (proc);
 return ret;
}
...
# 1024 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) 
# 1024 "project/radare2/binr/r2r/run.c"
     R2RAsmTestOutput *r2r_run_asm_test(R2RRunConfig *config, R2RAsmTest *test) {
 R2RAsmTestOutput *out = 
# 1025 "project/radare2/binr/r2r/run.c" 3 4
                        (
# 1025 "project/radare2/binr/r2r/run.c"
                        R2RAsmTestOutput
# 1025 "project/radare2/binr/r2r/run.c" 3 4
                        *)calloc(1,sizeof(
# 1025 "project/radare2/binr/r2r/run.c"
...
# 1025 "project/radare2/binr/r2r/run.c"
 ...
 if (!out) {
  return 
# 1027 "project/radare2/binr/r2r/run.c" 3 4
        ((void *)0)
# 1027 "project/radare2/binr/r2r/run.c"
            ;
 }

 RPVector args;
 r_pvector_init (&args, 
# 1031 "project/radare2/binr/r2r/run.c" 3 4
                       ((void *)0)
# 1031 "project/radare2/binr/r2r/run.c"
                           );
...
# 1045 "project/radare2/binr/r2r/run.c" 3 4
 __builtin___snprintf_chk (
# 1045 "project/radare2/binr/r2r/run.c"
 bits
# 1045 "project/radare2/binr/r2r/run.c" 3 4
 , 
# 1045 "project/radare2/binr/r2r/run.c"
...
# 1056 "project/radare2/binr/r2r/run.c" 3 4
                                           "llx"
# 1056 "project/radare2/binr/r2r/run.c"
                                                  , test->offset);
...
# 1065 "project/radare2/binr/r2r/run.c" 3 4
                                                                                                 ((void *)0)
# 1065 "project/radare2/binr/r2r/run.c"
                                                                                                     , 
# 1065 "project/radare2/binr/r2r/run.c" 3 4
                                                                                                       ((void *)0)
# 1065 "project/radare2/binr/r2r/run.c"
  ...
  if (!r2r_subprocess_wait (proc, config->timeout_ms)) {
   r2r_subprocess_kill (proc);
   out->as_timeout = 
# 1068 "project/radare2/binr/r2r/run.c" 3 4
                    1
# 1068 "project/radare2/binr/r2r/run.c"
                        ;
   goto rip;
  }
  if (proc->ret != 0) {
...
# 1079 "project/radare2/binr/r2r/run.c" 3 4
 unsigned char 
# 1079 "project/radare2/binr/r2r/run.c"
     *bytes = malloc (hexlen);
...
rip:
 ...
 if (test->mode & R2R_ASM_TEST_MODE_DISASSEMBLE) {
  ...
  R2RSubprocess *proc = r2r_subprocess_start (config->rasm2_cmd, args.v.a, r_pvector_len (&args), 
# 1098 "project/radare2/binr/r2r/run.c" 3 4
                                                                                                 ((void *)0)
# 1098 "project/radare2/binr/r2r/run.c"
                                                                                                     , 
# 1098 "project/radare2/binr/r2r/run.c" 3 4
                                                                                                       ((void *)0)
# 1098 "project/radare2/binr/r2r/run.c"
  ...
  if (!r2r_subprocess_wait (proc, config->timeout_ms)) {
   r2r_subprocess_kill (proc);
   out->disas_timeout = 
# 1101 "project/radare2/binr/r2r/run.c" 3 4
                       1
# 1101 "project/radare2/binr/r2r/run.c"
                           ;
   goto ship;
  }
  if (proc->ret != 0) {
...
# 1123 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 1123 "project/radare2/binr/r2r/run.c"
          r2r_check_asm_test(R2RAsmTestOutput *out, R2RAsmTest *test) {
 if (!out) {
  return 
# 1125 "project/radare2/binr/r2r/run.c" 3 4
        0
# 1125 "project/radare2/binr/r2r/run.c"
             ;
 }
 if (test->mode & R2R_ASM_TEST_MODE_ASSEMBLE) {
  if (!out->bytes || !test->bytes || out->bytes_size != test->bytes_size || out->as_timeout) {
   return 
# 1129 "project/radare2/binr/r2r/run.c" 3 4
         0
# 1129 "project/radare2/binr/r2r/run.c"
              ;
  }
  if (memcmp (out->bytes, test->bytes, test->bytes_size)) {
   return 
# 1132 "project/radare2/binr/r2r/run.c" 3 4
         0
# 1132 "project/radare2/binr/r2r/run.c"
              ;
  }
 }
 if (test->mode & R2R_ASM_TEST_MODE_DISASSEMBLE) {
  if (!out->disasm || !test->disasm || out->as_timeout) {
   return 
# 1137 "project/radare2/binr/r2r/run.c" 3 4
         0
# 1137 "project/radare2/binr/r2r/run.c"
              ;
  }
  if (strcmp (out->disasm, test->disasm)) {
   return 
# 1140 "project/radare2/binr/r2r/run.c" 3 4
         0
# 1140 "project/radare2/binr/r2r/run.c"
              ;
  }
 }
 return 
# 1143 "project/radare2/binr/r2r/run.c" 3 4
       1
# 1143 "project/radare2/binr/r2r/run.c"
           ;
}


# 1146 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) 
# 1146 "project/radare2/binr/r2r/run.c"
     void r2r_asm_test_output_free(R2RAsmTestOutput *out) {
 if (!out) {
  return;
 }
...
# 1155 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) 
# 1155 "project/radare2/binr/r2r/run.c"
     R2RProcessOutput *r2r_run_fuzz_test(R2RRunConfig *config, R2RFuzzTest *test, R2RCmdRunner runner, void *user) {
 const char *cmd = "aaa";
 RList *files = r_list_new ();
 
# 1158 "project/radare2/binr/r2r/run.c" 3 4
r_list_append ((
# 1158 "project/radare2/binr/r2r/run.c"
files
# 1158 "project/radare2/binr/r2r/run.c" 3 4
), (
# 1158 "project/radare2/binr/r2r/run.c"
...
# 1164 "project/radare2/binr/r2r/run.c" 3 4
                                                                             ((void *)0)
# 1164 "project/radare2/binr/r2r/run.c"
                                                                                 , 
# 1164 "project/radare2/binr/r2r/run.c" 3 4
                                                                                   0
# 1164 "project/radare2/binr/r2r/run.c"
...
# 1169 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 1169 "project/radare2/binr/r2r/run.c"
          r2r_check_fuzz_test(R2RProcessOutput *out) {
 return out && out->ret == 0 && out->out && out->err && !out->timeout;
}


# 1173 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) 
# 1173 "project/radare2/binr/r2r/run.c"
     char *r2r_test_name(R2RTest *test) {
 switch (test->type) {
 ...
 return 
# 1187 "project/radare2/binr/r2r/run.c" 3 4
       ((void *)0)
# 1187 "project/radare2/binr/r2r/run.c"
           ;
}


# 1190 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) _Bool 
# 1190 "project/radare2/binr/r2r/run.c"
          r2r_test_broken(R2RTest *test) {
 switch (test->type) {
 case R2R_TEST_TYPE_CMD:
...
# 1195 "project/radare2/binr/r2r/run.c" 3 4
                                                         1
# 1195 "project/radare2/binr/r2r/run.c"
                                                             : 
# 1195 "project/radare2/binr/r2r/run.c" 3 4
                                                               0
# 1195 "project/radare2/binr/r2r/run.c"
 ...
 case R2R_TEST_TYPE_FUZZ:
  return 
# 1199 "project/radare2/binr/r2r/run.c" 3 4
        0
# 1199 "project/radare2/binr/r2r/run.c"
             ;
 }
 return 
# 1201 "project/radare2/binr/r2r/run.c" 3 4
       0
# 1201 "project/radare2/binr/r2r/run.c"
            ;
}
# 1216 "project/radare2/binr/r2r/run.c"

# 1216 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) 
# 1216 "project/radare2/binr/r2r/run.c"
     R2RTestResultInfo *r2r_run_test(R2RRunConfig *config, R2RTest *test) {
 R2RTestResultInfo *ret = 
# 1217 "project/radare2/binr/r2r/run.c" 3 4
                         (
# 1217 "project/radare2/binr/r2r/run.c"
                         R2RTestResultInfo
# 1217 "project/radare2/binr/r2r/run.c" 3 4
                         *)calloc(1,sizeof(
# 1217 "project/radare2/binr/r2r/run.c"
...
# 1217 "project/radare2/binr/r2r/run.c"
 ...
 if (!ret) {
  return 
# 1219 "project/radare2/binr/r2r/run.c" 3 4
        ((void *)0)
# 1219 "project/radare2/binr/r2r/run.c"
            ;
 }
 ret->test = test;
 
# 1222 "project/radare2/binr/r2r/run.c" 3 4
_Bool 
# 1222 "project/radare2/binr/r2r/run.c"
     success = 
# 1222 "project/radare2/binr/r2r/run.c" 3 4
               0
# 1222 "project/radare2/binr/r2r/run.c"
...
# 1223 "project/radare2/binr/r2r/run.c" 3 4
unsigned long long 
# 1223 "project/radare2/binr/r2r/run.c"
     start_time = r_time_now_mono ();
 switch (test->type) {
 case R2R_TEST_TYPE_CMD:
  if (r_sys_getenv_asbool ("R2R_SKIP_CMD")) {
   success = 
# 1227 "project/radare2/binr/r2r/run.c" 3 4
            1
# 1227 "project/radare2/binr/r2r/run.c"
                ;
   ret->run_failed = 
# 1228 "project/radare2/binr/r2r/run.c" 3 4
                    0
# 1228 "project/radare2/binr/r2r/run.c"
                         ;
  } else {
   R2RCmdTest *cmd_test = test->cmd_test;
   R2RProcessOutput *out = r2r_run_cmd_test (config, cmd_test, subprocess_runner, 
# 1231 "project/radare2/binr/r2r/run.c" 3 4
                                                                                 ((void *)0)
# 1231 "project/radare2/binr/r2r/run.c"
                                                                                     );
 ...
 case R2R_TEST_TYPE_ASM:
  if (r_sys_getenv_asbool ("R2R_SKIP_ASM")) {
   success = 
# 1240 "project/radare2/binr/r2r/run.c" 3 4
            1
# 1240 "project/radare2/binr/r2r/run.c"
                ;
   ret->run_failed = 
# 1241 "project/radare2/binr/r2r/run.c" 3 4
                    0
# 1241 "project/radare2/binr/r2r/run.c"
                         ;
  } else {
...
# 1247 "project/radare2/binr/r2r/run.c" 3 4
   fprintf(__stderrp,
# 1247 "project/radare2/binr/r2r/run.c"
...
# 1250 "project/radare2/binr/r2r/run.c" 3 4
   fprintf(__stderrp,
# 1250 "project/radare2/binr/r2r/run.c"
...
# 1250 "project/radare2/binr/r2r/run.c"
 ...
 case R2R_TEST_TYPE_JSON:
  if (r_sys_getenv_asbool ("R2R_SKIP_JSON")) {
   success = 
# 1262 "project/radare2/binr/r2r/run.c" 3 4
            1
# 1262 "project/radare2/binr/r2r/run.c"
                ;
   ret->run_failed = 
# 1263 "project/radare2/binr/r2r/run.c" 3 4
                    0
# 1263 "project/radare2/binr/r2r/run.c"
                         ;
  } else {
   R2RJsonTest *json_test = test->json_test;
   R2RProcessOutput *out = r2r_run_json_test (config, json_test, subprocess_runner, 
# 1266 "project/radare2/binr/r2r/run.c" 3 4
                                                                                   ((void *)0)
# 1266 "project/radare2/binr/r2r/run.c"
                                                                                       );
 ...
 case R2R_TEST_TYPE_FUZZ:
  if (r_sys_getenv_asbool ("R2R_SKIP_FUZZ")) {
   success = 
# 1275 "project/radare2/binr/r2r/run.c" 3 4
            1
# 1275 "project/radare2/binr/r2r/run.c"
                ;
   ret->run_failed = 
# 1276 "project/radare2/binr/r2r/run.c" 3 4
                    0
# 1276 "project/radare2/binr/r2r/run.c"
                         ;
  } else {
   R2RFuzzTest *fuzz_test = test->fuzz_test;
   R2RProcessOutput *out = r2r_run_fuzz_test (config, fuzz_test, subprocess_runner, 
# 1279 "project/radare2/binr/r2r/run.c" 3 4
                                                                                   ((void *)0)
# 1279 "project/radare2/binr/r2r/run.c"
                                                                                       );
...
# 1288 "project/radare2/binr/r2r/run.c" 3 4
_Bool 
# 1288 "project/radare2/binr/r2r/run.c"
     broken = r2r_test_broken (test);
# 1298 "project/radare2/binr/r2r/run.c"
 if (success) {
...
# 1306 "project/radare2/binr/r2r/run.c" 3 4
__attribute__((visibility("default"))) 
# 1306 "project/radare2/binr/r2r/run.c"
     void r2r_test_result_info_free(R2RTestResultInfo *result) {
 if (!result) {
  return;
 }
