# 0 "project/radare2/binr/r2agent/r2agent.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/binr/r2agent/r2agent.c"
...
# 4 "project/radare2/binr/r2agent/r2agent.c" 2


# 5 "project/radare2/binr/r2agent/r2agent.c"
int main(int argc, const char **argv) {
