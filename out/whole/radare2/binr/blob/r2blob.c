# 0 "project/radare2/binr/blob/r2blob.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/binr/blob/r2blob.c"
...
# 4 "project/radare2/binr/blob/r2blob.c" 2



# 6 "project/radare2/binr/blob/r2blob.c"
int main(int argc, const char **argv) {
 int rc = 1;
...
# 14 "project/radare2/binr/blob/r2blob.c" 3 4
 fprintf(__stderrp,
# 14 "project/radare2/binr/blob/r2blob.c"
 "Error: r2blob must be renamed or accesed from a symlink:\n" " ln -fs r2blob r2       ; ./r2 -h\n" " ln -fs r2blob rasm2    ; ./rasm2 -h\n" " ln -fs r2blob rabin2   ; ./rabin2 -h\n"
# 14 "project/radare2/binr/blob/r2blob.c" 3 4
 )


                                            
# 17 "project/radare2/binr/blob/r2blob.c"
                                           ;
 }
 return rc;
}
