# 0 "project/radare2/shlr/gdb/src/utils.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/gdb/src/utils.c"
...
# 4 "project/radare2/shlr/gdb/src/utils.c" 2
...
# 5 "project/radare2/shlr/gdb/src/utils.c" 2
...
# 6 "project/radare2/shlr/gdb/src/utils.c" 2
# 15 "project/radare2/shlr/gdb/src/utils.c"
...
# 94 "project/radare2/shlr/gdb/src/utils.c" 3 4
                               unsigned long long 
# 94 "project/radare2/shlr/gdb/src/utils.c"
                                    len, char *dst) {
 int i = 0;
 while (i < (len / 2)) {
  
# 97 "project/radare2/shlr/gdb/src/utils.c" 3 4
 unsigned int 
# 97 "project/radare2/shlr/gdb/src/utils.c"
      val = hex2int (src[(i * 2)]);
  val <<= 4;
...
# 106 "project/radare2/shlr/gdb/src/utils.c" 3 4
                             unsigned long long 
# 106 "project/radare2/shlr/gdb/src/utils.c"
                                  len, char *dst) {
 int i = 0;
 int x = 0;
 while (i < (len * 2)) {
...
# 118 "project/radare2/shlr/gdb/src/utils.c" 3 4
                       unsigned long long 
# 118 "project/radare2/shlr/gdb/src/utils.c"
                            len, 
# 118 "project/radare2/shlr/gdb/src/utils.c" 3 4
                                 unsigned long long 
# 118 "project/radare2/shlr/gdb/src/utils.c"
...
# 123 "project/radare2/shlr/gdb/src/utils.c" 3 4
unsigned long long 
# 123 "project/radare2/shlr/gdb/src/utils.c"
     curr_offset;
 while (x < len) {
  p = hex;
  c = txt;
  ...
  do {
   p += 
# 130 "project/radare2/shlr/gdb/src/utils.c" 3 4
       __builtin___sprintf_chk (
# 130 "project/radare2/shlr/gdb/src/utils.c"
       p
# 130 "project/radare2/shlr/gdb/src/utils.c" 3 4
...
# 135 "project/radare2/shlr/gdb/src/utils.c" 3 4
 fprintf(__stderrp,
# 135 "project/radare2/shlr/gdb/src/utils.c"
 "0x%016"
# 135 "project/radare2/shlr/gdb/src/utils.c" 3 4
 "llx" 
# 135 "project/radare2/shlr/gdb/src/utils.c"
...
int write_thread_id(char *dest, int len, int pid, int tid, 
# 139 "project/radare2/shlr/gdb/src/utils.c" 3 4
                                                          _Bool 
# 139 "project/radare2/shlr/gdb/src/utils.c"
                                                               multiprocess) {
 if (!multiprocess) {
  if (tid < 0) {
   
# 142 "project/radare2/shlr/gdb/src/utils.c" 3 4
  __builtin___strncpy_chk (
# 142 "project/radare2/shlr/gdb/src/utils.c"
  dest
# 142 "project/radare2/shlr/gdb/src/utils.c" 3 4
  , 
# 142 "project/radare2/shlr/gdb/src/utils.c"
...
# 142 "project/radare2/shlr/gdb/src/utils.c"
  ...
  return 
# 145 "project/radare2/shlr/gdb/src/utils.c" 3 4
        __builtin___snprintf_chk (
# 145 "project/radare2/shlr/gdb/src/utils.c"
        dest
# 145 "project/radare2/shlr/gdb/src/utils.c" 3 4
        , 
# 145 "project/radare2/shlr/gdb/src/utils.c"
...
# 145 "project/radare2/shlr/gdb/src/utils.c"
 ...
 if (tid < 0) {
  return 
# 151 "project/radare2/shlr/gdb/src/utils.c" 3 4
        __builtin___snprintf_chk (
# 151 "project/radare2/shlr/gdb/src/utils.c"
        dest
# 151 "project/radare2/shlr/gdb/src/utils.c" 3 4
        , 
# 151 "project/radare2/shlr/gdb/src/utils.c"
...
# 151 "project/radare2/shlr/gdb/src/utils.c"
 ...
 return 
# 153 "project/radare2/shlr/gdb/src/utils.c" 3 4
       __builtin___snprintf_chk (
# 153 "project/radare2/shlr/gdb/src/utils.c"
       dest
# 153 "project/radare2/shlr/gdb/src/utils.c" 3 4
       , 
# 153 "project/radare2/shlr/gdb/src/utils.c"
...
int read_thread_id(const char *src, int *pid, int *tid, 
# 156 "project/radare2/shlr/gdb/src/utils.c" 3 4
                                                       _Bool 
# 156 "project/radare2/shlr/gdb/src/utils.c"
                                                            multiprocess) {
 char *ptr1;
 if (multiprocess && *src == 'p') {
  ...
  if (r_str_startswith (ptr1, "-1")) {
   *pid = (int) strtol (src, 
# 175 "project/radare2/shlr/gdb/src/utils.c" 3 4
                            ((void *)0)
# 175 "project/radare2/shlr/gdb/src/utils.c"
                                , 16);
   *tid = -1;
   return 0;
  }
  ...
  *pid = (int) strtol (src, 
# 182 "project/radare2/shlr/gdb/src/utils.c" 3 4
                           ((void *)0)
# 182 "project/radare2/shlr/gdb/src/utils.c"
                               , 16);
  *tid = (int) strtol (ptr1, 
# 183 "project/radare2/shlr/gdb/src/utils.c" 3 4
                            ((void *)0)
# 183 "project/radare2/shlr/gdb/src/utils.c"
                                , 16);
  return 0;
 }
 if (r_str_startswith (src, "-1")) {
 ...
 *pid = *tid = (int) strtol (src, 
# 193 "project/radare2/shlr/gdb/src/utils.c" 3 4
                                 ((void *)0)
# 193 "project/radare2/shlr/gdb/src/utils.c"
                                     , 16);
 return 0;
}
