# 0 "project/radare2/shlr/gdb/src/common.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/gdb/src/common.c"
...
# 4 "project/radare2/shlr/gdb/src/common.c" 2
...
# 5 "project/radare2/shlr/gdb/src/common.c" 2
...
# 6 "project/radare2/shlr/gdb/src/common.c" 2
...
# 7 "project/radare2/shlr/gdb/src/common.c" 2
...
# 8 "project/radare2/shlr/gdb/src/common.c" 2


# 9 "project/radare2/shlr/gdb/src/common.c"
int handle_qSupported(libgdbr_t *g) {
 char *tok = 
# 10 "project/radare2/shlr/gdb/src/common.c" 3 4
            ((void *)0)
# 10 "project/radare2/shlr/gdb/src/common.c"
                ;
...
# 20 "project/radare2/shlr/gdb/src/common.c" 3 4
                            (((
# 20 "project/radare2/shlr/gdb/src/common.c"
                            strtoul (tok + strlen ("PacketSize="), 
# 20 "project/radare2/shlr/gdb/src/common.c" 3 4
                            ((void *)0)
# 20 "project/radare2/shlr/gdb/src/common.c"
                            , 16)
...
# 20 "project/radare2/shlr/gdb/src/common.c"
   ...
   g->stub_features.pkt_sz = 
# 22 "project/radare2/shlr/gdb/src/common.c" 3 4
                            (((
# 22 "project/radare2/shlr/gdb/src/common.c"
                            g->stub_features.pkt_sz
# 22 "project/radare2/shlr/gdb/src/common.c" 3 4
                            )>(
# 22 "project/radare2/shlr/gdb/src/common.c"
...
# 22 "project/radare2/shlr/gdb/src/common.c"
   ...
   if (!tok[6]) {
    tok = strtok (
# 25 "project/radare2/shlr/gdb/src/common.c" 3 4
                 ((void *)0)
# 25 "project/radare2/shlr/gdb/src/common.c"
                     , ";");
    continue;
   }
   char *p = tok + 6;
   ...
   if (r_str_startswith (tok, "Qbtrace")) {
    if (!tok[strlen ("Qbtrace")]) {
     tok = strtok (
# 69 "project/radare2/shlr/gdb/src/common.c" 3 4
                  ((void *)0)
# 69 "project/radare2/shlr/gdb/src/common.c"
                      , ";");
     continue;
    }
    char *p = tok + 7;
    ...
    g->remote_type = 
# 103 "project/radare2/shlr/gdb/src/common.c" 3 4
                    1
# 103 "project/radare2/shlr/gdb/src/common.c"
                                        ;
    ...
    g->remote_type = 
# 107 "project/radare2/shlr/gdb/src/common.c" 3 4
                    1
# 107 "project/radare2/shlr/gdb/src/common.c"
                                        ;
   ...
   g->remote_type = 
# 114 "project/radare2/shlr/gdb/src/common.c" 3 4
                   1
# 114 "project/radare2/shlr/gdb/src/common.c"
                                       ;
  ...
  tok = strtok (
# 122 "project/radare2/shlr/gdb/src/common.c" 3 4
               ((void *)0)
# 122 "project/radare2/shlr/gdb/src/common.c"
                   , ";");
 }
 return send_ack (g);
}
...
# 139 "project/radare2/shlr/gdb/src/common.c" 3 4
  fprintf(__stderrp,
# 139 "project/radare2/shlr/gdb/src/common.c"
  "[sent ack]\n"
# 139 "project/radare2/shlr/gdb/src/common.c" 3 4
  )
# 139 "project/radare2/shlr/gdb/src/common.c"
