# 0 "project/radare2/shlr/gdb/src/packet.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/gdb/src/packet.c"
...
# 6 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/qnx/include/packet.h" 2 3 4
...
# 7 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/qnx/include/packet.h" 2 3 4
...
# 8 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/qnx/include/packet.h" 2 3 4
...
# 4 "project/radare2/shlr/gdb/src/packet.c" 2
...
# 5 "project/radare2/shlr/gdb/src/packet.c" 2

#define READ_TIMEOUT (250 * 1000)


# 8 "project/radare2/shlr/gdb/src/packet.c"
enum {
 HEADER = 1 << 0,
 CHKSUM = 1 << 1,
 DUP = 1 << 2,
...
# 16 "project/radare2/shlr/gdb/src/packet.c" 3 4
unsigned int 
# 16 "project/radare2/shlr/gdb/src/packet.c"
     flags;
 
# 17 "project/radare2/shlr/gdb/src/packet.c" 3 4
unsigned char 
# 17 "project/radare2/shlr/gdb/src/packet.c"
     last;
 
# 18 "project/radare2/shlr/gdb/src/packet.c" 3 4
unsigned char 
# 18 "project/radare2/shlr/gdb/src/packet.c"
     sum;
 int chksum_nibble;
};

static 
# 22 "project/radare2/shlr/gdb/src/packet.c" 3 4
      _Bool 
# 22 "project/radare2/shlr/gdb/src/packet.c"
           append(libgdbr_t *g, const char ch) {
 char *ptr;
 if (g->data_len == g->data_max - 1) {
  int newsize = g->data_max * 2;
  if (newsize < 1) {
   return 
# 27 "project/radare2/shlr/gdb/src/packet.c" 3 4
         0
# 27 "project/radare2/shlr/gdb/src/packet.c"
              ;
  }
  ptr = realloc (g->data, newsize);
  if (!ptr) {
   
# 31 "project/radare2/shlr/gdb/src/packet.c" 3 4
  fprintf(__stderrp,
# 31 "project/radare2/shlr/gdb/src/packet.c"
  "%s: Failed to reallocate buffer\n", __func__
# 31 "project/radare2/shlr/gdb/src/packet.c" 3 4
  )
              
# 32 "project/radare2/shlr/gdb/src/packet.c"
             ;
   return 
# 33 "project/radare2/shlr/gdb/src/packet.c" 3 4
         0
# 33 "project/radare2/shlr/gdb/src/packet.c"
              ;
  }
  g->data = ptr;
  g->data_max = newsize;
 ...
 return 
# 39 "project/radare2/shlr/gdb/src/packet.c" 3 4
       1
# 39 "project/radare2/shlr/gdb/src/packet.c"
           ;
}
...
# 45 "project/radare2/shlr/gdb/src/packet.c" 3 4
_Bool 
# 45 "project/radare2/shlr/gdb/src/packet.c"
     first = 
# 45 "project/radare2/shlr/gdb/src/packet.c" 3 4
             1
# 45 "project/radare2/shlr/gdb/src/packet.c"
...
# 55 "project/radare2/shlr/gdb/src/packet.c" 3 4
   fprintf(__stderrp,
# 55 "project/radare2/shlr/gdb/src/packet.c"
   "%s: Invalid checksum\n", __func__
# 55 "project/radare2/shlr/gdb/src/packet.c" 3 4
   )
# 55 "project/radare2/shlr/gdb/src/packet.c"
...
# 63 "project/radare2/shlr/gdb/src/packet.c" 3 4
    __builtin___memcpy_chk (
# 63 "project/radare2/shlr/gdb/src/packet.c"
    g->read_buff
# 63 "project/radare2/shlr/gdb/src/packet.c" 3 4
    , 
# 63 "project/radare2/shlr/gdb/src/packet.c"
    g->read_buff + i + 1, g->read_len
# 63 "project/radare2/shlr/gdb/src/packet.c" 3 4
...
# 67 "project/radare2/shlr/gdb/src/packet.c" 3 4
   fprintf(__stderrp,
# 67 "project/radare2/shlr/gdb/src/packet.c"
   "%s: Garbage at end of packet: %s (%s)\n", __func__, g->read_buff + i + 1, g->read_buff + i + 1
# 67 "project/radare2/shlr/gdb/src/packet.c" 3 4
   )
                                                           
# 68 "project/radare2/shlr/gdb/src/packet.c"
                                                          ;
   }
   g->read_len = 0;
   return 0;
...
# 83 "project/radare2/shlr/gdb/src/packet.c" 3 4
   fprintf(__stderrp,
# 83 "project/radare2/shlr/gdb/src/packet.c"
   "%s: Invalid repeat count: %d\n", __func__, cur
# 83 "project/radare2/shlr/gdb/src/packet.c" 3 4
   )
                    
# 84 "project/radare2/shlr/gdb/src/packet.c"
                   ;
    return -1;
   }
   for (j = cur - 29; j > 0; j--) {
...
# 99 "project/radare2/shlr/gdb/src/packet.c" 3 4
   fprintf(__stderrp,
# 99 "project/radare2/shlr/gdb/src/packet.c"
   "%s: More than one $\n", __func__
# 99 "project/radare2/shlr/gdb/src/packet.c" 3 4
   )
# 99 "project/radare2/shlr/gdb/src/packet.c"
...
# 115 "project/radare2/shlr/gdb/src/packet.c" 3 4
   fprintf(__stderrp,
# 115 "project/radare2/shlr/gdb/src/packet.c"
   "%s: Invalid repeat\n", __func__
# 115 "project/radare2/shlr/gdb/src/packet.c" 3 4
   )
# 115 "project/radare2/shlr/gdb/src/packet.c"
...
# 125 "project/radare2/shlr/gdb/src/packet.c" 3 4
    fprintf(__stderrp,
# 125 "project/radare2/shlr/gdb/src/packet.c"
    "[received '%c' (0x%x)]\n", cur, (int) cur
# 125 "project/radare2/shlr/gdb/src/packet.c" 3 4
    )
                 
# 126 "project/radare2/shlr/gdb/src/packet.c"
                ;
    }
    break;
   }
  ...
  default:
   first = 
# 132 "project/radare2/shlr/gdb/src/packet.c" 3 4
          0
# 132 "project/radare2/shlr/gdb/src/packet.c"
               ;
   if (!append (g, cur)) {
    return -1;
   }
...
# 142 "project/radare2/shlr/gdb/src/packet.c" 3 4
                             _Bool 
# 142 "project/radare2/shlr/gdb/src/packet.c"
                                  vcont) {
 struct parse_ctx ctx = { 0 };
 int ret, i;
 if (!g) {
  
# 146 "project/radare2/shlr/gdb/src/packet.c" 3 4
 fprintf(__stderrp,
# 146 "project/radare2/shlr/gdb/src/packet.c"
...
# 155 "project/radare2/shlr/gdb/src/packet.c" 3 4
   fprintf(__stderrp,
# 155 "project/radare2/shlr/gdb/src/packet.c"
   "getpkt (\"%s\");  %s\n", g->data, g->no_ack ? "[no ack sent]" : "[sending ack]"
# 155 "project/radare2/shlr/gdb/src/packet.c" 3 4
   )
                                                    
# 156 "project/radare2/shlr/gdb/src/packet.c"
                                                   ;
   }
   return 0;
  }
 ...
 for (i = 0; i < g->num_retries && !g->isbreaked; vcont ? 0 : i++) {
  ret = r_socket_ready (g->sock, 0, (250 * 1000));
  if (ret == 0 && !vcont) {
   continue;
  }
  if (ret <= 0) {
...
# 172 "project/radare2/shlr/gdb/src/packet.c" 3 4
  fprintf(__stderrp,
# 172 "project/radare2/shlr/gdb/src/packet.c"
  "%s: read failed\n", __func__
# 172 "project/radare2/shlr/gdb/src/packet.c" 3 4
  )
# 172 "project/radare2/shlr/gdb/src/packet.c"
...
# 177 "project/radare2/shlr/gdb/src/packet.c" 3 4
  fprintf(__stderrp,
# 177 "project/radare2/shlr/gdb/src/packet.c"
  "%s: unpack failed\n", __func__
# 177 "project/radare2/shlr/gdb/src/packet.c" 3 4
  )
# 177 "project/radare2/shlr/gdb/src/packet.c"
...
# 183 "project/radare2/shlr/gdb/src/packet.c" 3 4
   fprintf(__stderrp,
# 183 "project/radare2/shlr/gdb/src/packet.c"
   "getpkt (\"%s\");  %s\n", g->data, g->no_ack ? "[no ack sent]" : "[sending ack]"
# 183 "project/radare2/shlr/gdb/src/packet.c" 3 4
   )
                                                    
# 184 "project/radare2/shlr/gdb/src/packet.c"
                                                   ;
   }
   return 0;
  }
...
# 194 "project/radare2/shlr/gdb/src/packet.c" 3 4
 fprintf(__stderrp,
# 194 "project/radare2/shlr/gdb/src/packet.c"
 "Initialize libgdbr_t first\n"
# 194 "project/radare2/shlr/gdb/src/packet.c" 3 4
 )
# 194 "project/radare2/shlr/gdb/src/packet.c"
...
# 199 "project/radare2/shlr/gdb/src/packet.c" 3 4
 fprintf(__stderrp,
# 199 "project/radare2/shlr/gdb/src/packet.c"
 "putpkt (\"%s\");  %s\n", g->send_buff, g->no_ack ? "[noack mode]" : "[looking for ack]"
# 199 "project/radare2/shlr/gdb/src/packet.c" 3 4
 )
                                                     
# 200 "project/radare2/shlr/gdb/src/packet.c"
                                                    ;
 }
...
# 215 "project/radare2/shlr/gdb/src/packet.c" 3 4
 fprintf(__stderrp,
# 215 "project/radare2/shlr/gdb/src/packet.c"
 "%s: message too long: %s", __func__, msg
# 215 "project/radare2/shlr/gdb/src/packet.c" 3 4
 )
# 215 "project/radare2/shlr/gdb/src/packet.c"
                                                    ;
...
# 228 "project/radare2/shlr/gdb/src/packet.c" 3 4
   fprintf(__stderrp,
# 228 "project/radare2/shlr/gdb/src/packet.c"
   "%s: message too long: %s", __func__, msg
# 228 "project/radare2/shlr/gdb/src/packet.c" 3 4
   )
# 228 "project/radare2/shlr/gdb/src/packet.c"
...
# 262 "project/radare2/shlr/gdb/src/packet.c" 3 4
__builtin___snprintf_chk (
# 262 "project/radare2/shlr/gdb/src/packet.c"
g->send_buff + g->send_len
# 262 "project/radare2/shlr/gdb/src/packet.c" 3 4
, 
# 262 "project/radare2/shlr/gdb/src/packet.c"
