# 0 "project/radare2/shlr/gdb/src/arch.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 2 "project/radare2/shlr/gdb/src/arch.c" 2
...
# 3 "project/radare2/shlr/gdb/src/arch.c" 2


# 4 "project/radare2/shlr/gdb/src/arch.c"
static 
# 4 "project/radare2/shlr/gdb/src/arch.c" 3 4
      unsigned long long 
# 4 "project/radare2/shlr/gdb/src/arch.c"
...
# 11 "project/radare2/shlr/gdb/src/arch.c" 3 4
 unsigned long long 
# 11 "project/radare2/shlr/gdb/src/arch.c"
      a = strtoul (s, end, 0) << 3;
  
# 12 "project/radare2/shlr/gdb/src/arch.c" 3 4
 unsigned long long 
# 12 "project/radare2/shlr/gdb/src/arch.c"
...
gdb_reg_t *parse_def(char **tok) {
 char *end;
 gdb_reg_t *r = 
# 20 "project/radare2/shlr/gdb/src/arch.c" 3 4
               (
# 20 "project/radare2/shlr/gdb/src/arch.c"
               gdb_reg_t
# 20 "project/radare2/shlr/gdb/src/arch.c" 3 4
               *)calloc(1,sizeof(
# 20 "project/radare2/shlr/gdb/src/arch.c"
...
# 20 "project/radare2/shlr/gdb/src/arch.c"
 ...
 if (!r) {
  return 
# 22 "project/radare2/shlr/gdb/src/arch.c" 3 4
        ((void *)0)
# 22 "project/radare2/shlr/gdb/src/arch.c"
            ;
 }

 
# 25 "project/radare2/shlr/gdb/src/arch.c" 3 4
__builtin___strcpy_chk (
# 25 "project/radare2/shlr/gdb/src/arch.c"
r->name
# 25 "project/radare2/shlr/gdb/src/arch.c" 3 4
, 
# 25 "project/radare2/shlr/gdb/src/arch.c"
...
# 25 "project/radare2/shlr/gdb/src/arch.c"
 ...
 if (*end != '\0' || !r->size) {
  free (r);
  return 
# 29 "project/radare2/shlr/gdb/src/arch.c" 3 4
        ((void *)0)
# 29 "project/radare2/shlr/gdb/src/arch.c"
            ;
 }
 if (!strcmp (tok[3], "?")) {
  free (r);
  return 
# 33 "project/radare2/shlr/gdb/src/arch.c" 3 4
        ((void *)0)
# 33 "project/radare2/shlr/gdb/src/arch.c"
            ;
 } else {
...
# 107 "project/radare2/shlr/gdb/src/arch.c" 3 4
    fprintf(__stderrp,
# 107 "project/radare2/shlr/gdb/src/arch.c"
    "gdb_regs: Parse error @ line %d\n", l
# 107 "project/radare2/shlr/gdb/src/arch.c" 3 4
    )
# 107 "project/radare2/shlr/gdb/src/arch.c"
                                                    ;
     ...
     return 
# 113 "project/radare2/shlr/gdb/src/arch.c" 3 4
           ((void *)0)
# 113 "project/radare2/shlr/gdb/src/arch.c"
               ;
    }
 ...
 if (!gdb_regs) {
  return 
# 126 "project/radare2/shlr/gdb/src/arch.c" 3 4
        ((void *)0)
# 126 "project/radare2/shlr/gdb/src/arch.c"
            ;
 }
 i = 0;
 
# 129 "project/radare2/shlr/gdb/src/arch.c" 3 4
if (
# 129 "project/radare2/shlr/gdb/src/arch.c"
gdb_regs_list
# 129 "project/radare2/shlr/gdb/src/arch.c" 3 4
) for (
# 129 "project/radare2/shlr/gdb/src/arch.c"
...
# 130 "project/radare2/shlr/gdb/src/arch.c" 3 4
 __builtin___memcpy_chk (
# 130 "project/radare2/shlr/gdb/src/arch.c"
 gdb_regs + i
# 130 "project/radare2/shlr/gdb/src/arch.c" 3 4
 , 
# 130 "project/radare2/shlr/gdb/src/arch.c"
 reg, sizeof (gdb_reg_t)
# 130 "project/radare2/shlr/gdb/src/arch.c" 3 4
 , __builtin_object_size (
# 130 "project/radare2/shlr/gdb/src/arch.c"
 gdb_regs + i
...
# 133 "project/radare2/shlr/gdb/src/arch.c" 3 4
__builtin___memset_chk (
# 133 "project/radare2/shlr/gdb/src/arch.c"
gdb_regs + i
# 133 "project/radare2/shlr/gdb/src/arch.c" 3 4
, 
# 133 "project/radare2/shlr/gdb/src/arch.c"
