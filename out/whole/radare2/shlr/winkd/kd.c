# 0 "project/radare2/shlr/winkd/kd.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/winkd/kd.c"
...
# 3 "project/radare2/shlr/winkd/kd.c" 2
...
# 4 "project/radare2/shlr/winkd/kd.c" 2
...
# 5 "project/radare2/shlr/winkd/kd.c" 2
...
# 5 "project/radare2/shlr/winkd/kd.h" 2
...
# 5 "project/radare2/shlr/winkd/transport.h" 2
...
# 6 "project/radare2/shlr/winkd/kd.c" 2
 ...
 *p = 
# 81 "project/radare2/shlr/winkd/kd.c" 3 4
     ((void *)0)
# 81 "project/radare2/shlr/winkd/kd.c"
         ;
 ...
 if (!kd_packet_is_valid (&pkt)) {
  if (
# 88 "project/radare2/shlr/winkd/kd.c" 3 4
 0
# 88 "project/radare2/shlr/winkd/kd.c"
 ) 
# 88 "project/radare2/shlr/winkd/kd.c" 3 4
        fprintf(__stderrp,
# 88 "project/radare2/shlr/winkd/kd.c"
...
# 100 "project/radare2/shlr/winkd/kd.c" 3 4
     __builtin___memcpy_chk (
# 100 "project/radare2/shlr/winkd/kd.c"
     &pkt
# 100 "project/radare2/shlr/winkd/kd.c" 3 4
     , 
# 100 "project/radare2/shlr/winkd/kd.c"
...
# 120 "project/radare2/shlr/winkd/kd.c" 3 4
__builtin___memcpy_chk (
# 120 "project/radare2/shlr/winkd/kd.c"
buf
# 120 "project/radare2/shlr/winkd/kd.c" 3 4
, 
# 120 "project/radare2/shlr/winkd/kd.c"
&pkt, sizeof (kd_packet_t)
# 120 "project/radare2/shlr/winkd/kd.c" 3 4
, __builtin_object_size (
# 120 "project/radare2/shlr/winkd/kd.c"
buf
...
# 120 "project/radare2/shlr/winkd/kd.c"
 ...
 if (pkt.checksum != kd_data_checksum (buf + sizeof (kd_packet_t), pkt.length)) {
  if (
# 127 "project/radare2/shlr/winkd/kd.c" 3 4
 0
# 127 "project/radare2/shlr/winkd/kd.c"
 ) 
# 127 "project/radare2/shlr/winkd/kd.c" 3 4
        fprintf(__stderrp,
# 127 "project/radare2/shlr/winkd/kd.c"
...
# 127 "project/radare2/shlr/winkd/kd.c"
 ...
 if (pkt.leader == 0x30303030) {
  if (desc->iob->type == 0) {
   ...
   if (trailer != 0xAA) {
    if (
# 138 "project/radare2/shlr/winkd/kd.c" 3 4
   0
# 138 "project/radare2/shlr/winkd/kd.c"
   ) 
# 138 "project/radare2/shlr/winkd/kd.c" 3 4
          fprintf(__stderrp,
# 138 "project/radare2/shlr/winkd/kd.c"
          "Missing trailer 0xAA\n"
# 138 "project/radare2/shlr/winkd/kd.c" 3 4
          )
# 138 "project/radare2/shlr/winkd/kd.c"
                                            ;
...
# 151 "project/radare2/shlr/winkd/kd.c" 3 4
_Bool 
# 151 "project/radare2/shlr/winkd/kd.c"
    kd_packet_is_valid(const kd_packet_t *p) {
 return p->leader == 0x69696969 || p->leader == 0x30303030 || p->leader == 0x00000000;
}

int kd_packet_is_ack(const kd_packet_t *p) {
 return p->leader == 0x69696969 && p->type == KD_PACKET_TYPE_ACKNOWLEDGE;
}
