# 0 "project/radare2/shlr/winkd/transport.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/winkd/transport.c"
...
# 3 "project/radare2/shlr/winkd/transport.c" 2
...
# 4 "project/radare2/shlr/winkd/transport.c" 2

io_desc_t *io_desc_new(io_backend_t *iob, void *fp) {
 io_desc_t *desc = 
# 6 "project/radare2/shlr/winkd/transport.c" 3 4
                  (
# 6 "project/radare2/shlr/winkd/transport.c"
                  io_desc_t
# 6 "project/radare2/shlr/winkd/transport.c" 3 4
                  *)calloc(1,sizeof(
# 6 "project/radare2/shlr/winkd/transport.c"
...
int iob_write(io_desc_t *desc, const uint8_t *buf, const uint32_t buf_len) {
 uint32_t done;
 static RThreadLock *lock = 
# 16 "project/radare2/shlr/winkd/transport.c" 3 4
                           ((void *)0)
# 16 "project/radare2/shlr/winkd/transport.c"
                               ;
 if (!lock) {
  lock = r_th_lock_new (
# 18 "project/radare2/shlr/winkd/transport.c" 3 4
                       1
# 18 "project/radare2/shlr/winkd/transport.c"
                           );
 }
...
int iob_read(io_desc_t *desc, uint8_t *buf, const uint32_t buf_len) {
 uint32_t done;
 static RThreadLock *lock = 
# 37 "project/radare2/shlr/winkd/transport.c" 3 4
                           ((void *)0)
# 37 "project/radare2/shlr/winkd/transport.c"
                               ;
 if (!lock) {
  lock = r_th_lock_new (
# 39 "project/radare2/shlr/winkd/transport.c" 3 4
                       1
# 39 "project/radare2/shlr/winkd/transport.c"
                           );
 }
 if (!desc || !desc->iob || !desc->fp) {
  return E_NOIF;
