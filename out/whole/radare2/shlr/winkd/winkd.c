# 0 "project/radare2/shlr/winkd/winkd.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/winkd/winkd.c"
...
# 3 "project/radare2/shlr/winkd/winkd.c" 2
# 1 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include/stdarg.h" 1 3 4
...
#define __va_list__ 
# 4 "project/radare2/shlr/winkd/winkd.c" 2
...
# 5 "project/radare2/shlr/winkd/winkd.c" 2
...
# 6 "project/radare2/shlr/winkd/winkd.c" 2
...
# 7 "project/radare2/shlr/winkd/winkd.c" 2
...
# 8 "project/radare2/shlr/winkd/winkd.c" 2


# 1 "project/radare2/shlr/winkd/transport.h" 1

#define _TRANSPORT_H_ 
# 13 "project/radare2/shlr/winkd/transport.h"
#define KD_IO_PIPE 0
#define KD_IO_NET 1


# 16 "project/radare2/shlr/winkd/transport.h"
enum {
    E_OK = 0,
    E_TIMEOUT = -1,
    E_ERROR = -2,
...
# 29 "project/radare2/shlr/winkd/transport.h" 3 4
_Bool 
# 29 "project/radare2/shlr/winkd/transport.h"
     (*close)(void *);
...
# 11 "project/radare2/shlr/winkd/winkd.c" 2
# 1 "project/radare2/shlr/winkd/winkd.h" 1
# 17 "project/radare2/shlr/winkd/winkd.h"
#define _winkd_H_ 


# 1 "project/radare2/shlr/winkd/kd.h" 1
...
typedef struct kd_req_t { uint32_t req; uint16_t cpu_level; uint16_t cpu; uint32_t ret; uint32_t pad; union { struct { uint64_t addr; uint32_t length; uint32_t read; } 
# 104 "project/radare2/shlr/winkd/kd.h" 3 4
__attribute__((__packed__)) 
# 104 "project/radare2/shlr/winkd/kd.h"
r_mem; struct { uint16_t major; uint16_t minor; uint8_t proto_major; uint8_t proto_minor; uint16_t flags; uint16_t machine; uint8_t misc[6]; uint64_t kernel_base; uint64_t mod_addr; uint64_t dbg_addr; } 
# 104 "project/radare2/shlr/winkd/kd.h" 3 4
__attribute__((__packed__)) 
# 104 "project/radare2/shlr/winkd/kd.h"
r_ver; struct { uint32_t reason; uint32_t tf; uint32_t dr7; uint32_t css; uint32_t cse; } r_cont; struct { uint64_t addr; uint32_t handle; } r_set_bp; struct { uint32_t handle; } r_del_bp; struct { uint64_t addr; uint32_t flags; } r_set_ibp; struct { uint64_t addr; uint32_t flags; uint32_t calls; } r_get_ibp; struct { uint32_t flags; } r_ctx; struct { uint64_t addr; uint64_t reserved; uint32_t address_space; uint32_t flags; } r_query_mem; uint8_t raw[40]; }; uint8_t data[0]; } 
# 104 "project/radare2/shlr/winkd/kd.h" 3 4
__attribute__((__packed__))
# 169 "project/radare2/shlr/winkd/kd.h"
   kd_req_t
# 169 "project/radare2/shlr/winkd/kd.h"
          ;

#define KD_EXC_BKPT 0x80000003
typedef struct kd_stc_64 { uint32_t state; uint16_t cpu_level; uint16_t cpu; uint32_t cpu_count; uint32_t pad1; uint64_t kthread; uint64_t pc; union { struct { uint32_t code; uint32_t flags; uint64_t ex_record; uint64_t ex_addr; } 
# 172 "project/radare2/shlr/winkd/kd.h" 3 4
__attribute__((__packed__)) 
# 172 "project/radare2/shlr/winkd/kd.h"
exception; }; } 
# 172 "project/radare2/shlr/winkd/kd.h" 3 4
__attribute__((__packed__))
# 190 "project/radare2/shlr/winkd/kd.h"
   kd_stc_64
# 190 "project/radare2/shlr/winkd/kd.h"
           ;
...
typedef struct kd_packet_t { uint32_t leader; uint16_t type; uint16_t length; uint32_t id; uint32_t checksum; uint8_t data[0]; } 
# 198 "project/radare2/shlr/winkd/kd.h" 3 4
__attribute__((__packed__))
...
# 206 "project/radare2/shlr/winkd/kd.h"
  kd_packet_t;
...
# 217 "project/radare2/shlr/winkd/kd.h" 3 4
unsigned int 
# 217 "project/radare2/shlr/winkd/kd.h"
magic; 
# 217 "project/radare2/shlr/winkd/kd.h" 3 4
unsigned char 
# 217 "project/radare2/shlr/winkd/kd.h"
...
# 222 "project/radare2/shlr/winkd/kd.h"
  kdnet_packet_t;
...
enum { assert_line_236 = 1/(!!(sizeof(kd_packet_t)==16)) };
enum { assert_line_237 = 1/(!!(sizeof(kd_req_t)==56)) };
enum { assert_line_238 = 1/(!!(sizeof(kd_ioc_t)==64)) };
...
# 245 "project/radare2/shlr/winkd/kd.h" 3 4
_Bool 
# 245 "project/radare2/shlr/winkd/kd.h"
    kd_packet_is_valid(const kd_packet_t *p);
int kd_packet_is_ack(const kd_packet_t *p);

uint32_t kd_data_checksum(const uint8_t *buf, const uint64_t buf_len);
# 21 "project/radare2/shlr/winkd/winkd.h" 2

typedef struct _WindCtx WindCtx;

typedef struct WindProc {
 
# 25 "project/radare2/shlr/winkd/winkd.h" 3 4
unsigned long long 
# 25 "project/radare2/shlr/winkd/winkd.h"
     eprocess;
 
# 26 "project/radare2/shlr/winkd/winkd.h" 3 4
unsigned int 
# 26 "project/radare2/shlr/winkd/winkd.h"
     uniqueid;
 
# 27 "project/radare2/shlr/winkd/winkd.h" 3 4
unsigned long long 
# 27 "project/radare2/shlr/winkd/winkd.h"
     vadroot;
 
# 28 "project/radare2/shlr/winkd/winkd.h" 3 4
unsigned long long 
# 28 "project/radare2/shlr/winkd/winkd.h"
     dir_base_table;
 
# 29 "project/radare2/shlr/winkd/winkd.h" 3 4
unsigned long long 
# 29 "project/radare2/shlr/winkd/winkd.h"
     peb;
 char name[17];
} WindProc;
...
# 34 "project/radare2/shlr/winkd/winkd.h" 3 4
unsigned int 
# 34 "project/radare2/shlr/winkd/winkd.h"
     uniqueid;
 
# 35 "project/radare2/shlr/winkd/winkd.h" 3 4
_Bool 
# 35 "project/radare2/shlr/winkd/winkd.h"
     runnable;
 char status;
 
# 37 "project/radare2/shlr/winkd/winkd.h" 3 4
unsigned long long 
# 37 "project/radare2/shlr/winkd/winkd.h"
     ethread;
 
# 38 "project/radare2/shlr/winkd/winkd.h" 3 4
unsigned long long 
# 38 "project/radare2/shlr/winkd/winkd.h"
     entrypoint;
} WindThread;
...
# 43 "project/radare2/shlr/winkd/winkd.h" 3 4
unsigned long long 
# 43 "project/radare2/shlr/winkd/winkd.h"
     addr;
 
# 44 "project/radare2/shlr/winkd/winkd.h" 3 4
unsigned long long 
# 44 "project/radare2/shlr/winkd/winkd.h"
     size;
} WindModule;
...
# 82 "project/radare2/shlr/winkd/winkd.h" 3 4
unsigned long long 
# 82 "project/radare2/shlr/winkd/winkd.h"
    winkd_get_target_base(WindCtx *ctx);

# 83 "project/radare2/shlr/winkd/winkd.h" 3 4
unsigned int 
# 83 "project/radare2/shlr/winkd/winkd.h"
    winkd_get_target(WindCtx *ctx);

# 84 "project/radare2/shlr/winkd/winkd.h" 3 4
_Bool 
# 84 "project/radare2/shlr/winkd/winkd.h"
    winkd_set_target(WindCtx *ctx, 
# 84 "project/radare2/shlr/winkd/winkd.h" 3 4
                                   unsigned int 
# 84 "project/radare2/shlr/winkd/winkd.h"
                                        pid);
...
# 89 "project/radare2/shlr/winkd/winkd.h" 3 4
_Bool 
# 89 "project/radare2/shlr/winkd/winkd.h"
    winkd_set_cpu(WindCtx *ctx, int cpu);
int winkd_get_cpu(WindCtx *ctx);
WindCtx * winkd_ctx_new(io_desc_t *desc);
void winkd_ctx_free(WindCtx **ctx);
int winkd_wait_packet(WindCtx *ctx, const 
# 93 "project/radare2/shlr/winkd/winkd.h" 3 4
                                         unsigned int 
# 93 "project/radare2/shlr/winkd/winkd.h"
                                              type, kd_packet_t **p);
int winkd_sync(WindCtx *ctx);

# 95 "project/radare2/shlr/winkd/winkd.h" 3 4
_Bool 
# 95 "project/radare2/shlr/winkd/winkd.h"
    winkd_read_ver(WindCtx *ctx);
int winkd_continue(WindCtx *ctx);

# 97 "project/radare2/shlr/winkd/winkd.h" 3 4
_Bool 
# 97 "project/radare2/shlr/winkd/winkd.h"
    winkd_write_reg(WindCtx *ctx, const uint8_t *buf, int size);
int winkd_read_reg(WindCtx *ctx, uint8_t *buf, int size);
int winkd_query_mem(WindCtx *ctx, const 
# 99 "project/radare2/shlr/winkd/winkd.h" 3 4
                                       unsigned long long 
# 99 "project/radare2/shlr/winkd/winkd.h"
                                            addr, int *address_space, int *flags);
int winkd_bkpt(WindCtx *ctx, const 
# 100 "project/radare2/shlr/winkd/winkd.h" 3 4
                                  unsigned long long 
# 100 "project/radare2/shlr/winkd/winkd.h"
                                       addr, const int set, const int hw, int *handle);
int winkd_read_at(WindCtx *ctx, uint8_t *buf, const 
# 101 "project/radare2/shlr/winkd/winkd.h" 3 4
                                                   unsigned long long 
# 101 "project/radare2/shlr/winkd/winkd.h"
                                                        offset, const int count);
int winkd_read_at_uva(WindCtx *ctx, uint8_t *buf, 
# 102 "project/radare2/shlr/winkd/winkd.h" 3 4
                                                 unsigned long long 
# 102 "project/radare2/shlr/winkd/winkd.h"
                                                      offset, int count);
int winkd_read_at_phys(WindCtx *ctx, uint8_t *buf, const 
# 103 "project/radare2/shlr/winkd/winkd.h" 3 4
                                                        unsigned long long 
# 103 "project/radare2/shlr/winkd/winkd.h"
                                                             offset, const int count);
int winkd_write_at(WindCtx *ctx, const uint8_t *buf, const 
# 104 "project/radare2/shlr/winkd/winkd.h" 3 4
                                                          unsigned long long 
# 104 "project/radare2/shlr/winkd/winkd.h"
                                                               offset, const int count);
int winkd_write_at_uva(WindCtx *ctx, const uint8_t *buf, 
# 105 "project/radare2/shlr/winkd/winkd.h" 3 4
                                                        unsigned long long 
# 105 "project/radare2/shlr/winkd/winkd.h"
                                                             offset, int count);
int winkd_write_at_phys(WindCtx *ctx, const uint8_t *buf, const 
# 106 "project/radare2/shlr/winkd/winkd.h" 3 4
                                                               unsigned long long 
# 106 "project/radare2/shlr/winkd/winkd.h"
                                                                    offset, const int count);

# 107 "project/radare2/shlr/winkd/winkd.h" 3 4
_Bool 
# 107 "project/radare2/shlr/winkd/winkd.h"
    winkd_va_to_pa(WindCtx *ctx, 
# 107 "project/radare2/shlr/winkd/winkd.h" 3 4
                                 unsigned long long 
# 107 "project/radare2/shlr/winkd/winkd.h"
                                      va, 
...
# 110 "project/radare2/shlr/winkd/winkd.h" 3 4
_Bool 
# 110 "project/radare2/shlr/winkd/winkd.h"
    winkd_lock_enter(WindCtx *ctx);

# 111 "project/radare2/shlr/winkd/winkd.h" 3 4
_Bool 
# 111 "project/radare2/shlr/winkd/winkd.h"
    winkd_lock_leave(WindCtx *ctx);

# 112 "project/radare2/shlr/winkd/winkd.h" 3 4
_Bool 
# 112 "project/radare2/shlr/winkd/winkd.h"
    winkd_lock_tryenter(WindCtx *ctx);
# 12 "project/radare2/shlr/winkd/winkd.c" 2


#define O_FLAG_XPVAD 1
#define WIND_DBG if (false)
#define O_(n) ctx->os_profile->f[n]
# 1 "project/radare2/shlr/winkd/profiles.h" 1
Profile XP_SP2_X86 = {
 2600, 2, 32, 1,
...
# 18 "project/radare2/shlr/winkd/winkd.c" 2
...
# 44 "project/radare2/shlr/winkd/winkd.c" 3 4
((void *)0)
# 44 "project/radare2/shlr/winkd/winkd.c"
    ,
};
...
Profile *winkd_get_profile(int bits, int build, int sp) {
 ...
 return 
# 61 "project/radare2/shlr/winkd/winkd.c" 3 4
       ((void *)0)
# 61 "project/radare2/shlr/winkd/winkd.c"
           ;
}

#define LOG_REQ(r) { eprintf ("Request : %08x\nProcessor : %08x\nReturn : %08x\n", (r)->req, (r)->cpu, (r)->ret ); }
...
# 83 "project/radare2/shlr/winkd/winkd.c" 3 4
unsigned long long 
# 83 "project/radare2/shlr/winkd/winkd.c"
     dbg_addr;
 WindProc *target;
 RThreadLock *dontmix;
};
...
# 88 "project/radare2/shlr/winkd/winkd.c" 3 4
_Bool 
# 88 "project/radare2/shlr/winkd/winkd.c"
    winkd_lock_enter(WindCtx *ctx) {
 r_cons_break_push (winkd_break, ctx);
 r_th_lock_enter (ctx->dontmix);
 return 
# 91 "project/radare2/shlr/winkd/winkd.c" 3 4
       1
# 91 "project/radare2/shlr/winkd/winkd.c"
           ;
}


# 94 "project/radare2/shlr/winkd/winkd.c" 3 4
_Bool 
# 94 "project/radare2/shlr/winkd/winkd.c"
    winkd_lock_tryenter(WindCtx *ctx) {
 if (!r_th_lock_tryenter (ctx->dontmix)) {
  return 
# 96 "project/radare2/shlr/winkd/winkd.c" 3 4
        0
# 96 "project/radare2/shlr/winkd/winkd.c"
             ;
 }
 r_cons_break_push (winkd_break, ctx);
 return 
# 99 "project/radare2/shlr/winkd/winkd.c" 3 4
       1
# 99 "project/radare2/shlr/winkd/winkd.c"
           ;
}


# 102 "project/radare2/shlr/winkd/winkd.c" 3 4
_Bool 
# 102 "project/radare2/shlr/winkd/winkd.c"
    winkd_lock_leave(WindCtx *ctx) {
 r_cons_break_pop ();
 r_th_lock_leave (ctx->dontmix);
 return 
# 105 "project/radare2/shlr/winkd/winkd.c" 3 4
       1
# 105 "project/radare2/shlr/winkd/winkd.c"
           ;
}

int winkd_get_bits(WindCtx *ctx) {
 return ctx->is_x64 ? 
# 109 "project/radare2/shlr/winkd/winkd.c" 3 4
                     8 
# 109 "project/radare2/shlr/winkd/winkd.c"
                                   : 
# 109 "project/radare2/shlr/winkd/winkd.c" 3 4
                                     4
# 109 "project/radare2/shlr/winkd/winkd.c"
...
# 119 "project/radare2/shlr/winkd/winkd.c" 3 4
_Bool 
# 119 "project/radare2/shlr/winkd/winkd.c"
    winkd_set_cpu(WindCtx *ctx, int cpu) {
 if (!ctx || cpu > ctx->cpu_count) {
  return 
# 121 "project/radare2/shlr/winkd/winkd.c" 3 4
        0
# 121 "project/radare2/shlr/winkd/winkd.c"
             ;
 }
 ctx->cpu = cpu;
 return 
# 124 "project/radare2/shlr/winkd/winkd.c" 3 4
       1
# 124 "project/radare2/shlr/winkd/winkd.c"
           ;
}
...
# 134 "project/radare2/shlr/winkd/winkd.c" 3 4
_Bool 
# 134 "project/radare2/shlr/winkd/winkd.c"
    winkd_set_target(WindCtx *ctx, uint32_t pid) {
 WindProc *p;
 RListIter *it;
 if (pid) {
  RList *l = winkd_list_process (ctx);
  
# 139 "project/radare2/shlr/winkd/winkd.c" 3 4
 if (
# 139 "project/radare2/shlr/winkd/winkd.c"
 l
# 139 "project/radare2/shlr/winkd/winkd.c" 3 4
 ) for (
# 139 "project/radare2/shlr/winkd/winkd.c"
...
# 139 "project/radare2/shlr/winkd/winkd.c"
   ...
   if (p->uniqueid == pid) {
    ctx->target = p;
    return 
# 142 "project/radare2/shlr/winkd/winkd.c" 3 4
          1
# 142 "project/radare2/shlr/winkd/winkd.c"
              ;
   }
  }
  return 
# 145 "project/radare2/shlr/winkd/winkd.c" 3 4
        0
# 145 "project/radare2/shlr/winkd/winkd.c"
             ;
 }
 ctx->target = 
# 147 "project/radare2/shlr/winkd/winkd.c" 3 4
              ((void *)0)
# 147 "project/radare2/shlr/winkd/winkd.c"
                  ;
 return 
# 148 "project/radare2/shlr/winkd/winkd.c" 3 4
       1
# 148 "project/radare2/shlr/winkd/winkd.c"
           ;
}
...
# 158 "project/radare2/shlr/winkd/winkd.c" 3 4
unsigned long long 
# 158 "project/radare2/shlr/winkd/winkd.c"
    winkd_get_target_base(WindCtx *ctx) {
 
# 159 "project/radare2/shlr/winkd/winkd.c" 3 4
unsigned long long 
# 159 "project/radare2/shlr/winkd/winkd.c"
     base = 0;
 ...
 if (!winkd_read_at_uva (ctx, (uint8_t *) &base,
      ctx->target->peb + ctx->os_profile->f[P_ImageBaseAddress], 4 << ctx->is_x64)) {
  return 0;
 }
...
WindCtx *winkd_ctx_new(io_desc_t *desc) {
 ...
 if (!ctx) {
  return 
# 176 "project/radare2/shlr/winkd/winkd.c" 3 4
        ((void *)0)
# 176 "project/radare2/shlr/winkd/winkd.c"
            ;
 }
 ctx->dontmix = r_th_lock_new (
# 178 "project/radare2/shlr/winkd/winkd.c" 3 4
                              1
# 178 "project/radare2/shlr/winkd/winkd.c"
                                  );
 ctx->desc = desc;
 return ctx;
}
...
# 191 "project/radare2/shlr/winkd/winkd.c" 3 4
{ free((void *)
# 191 "project/radare2/shlr/winkd/winkd.c"
desc
# 191 "project/radare2/shlr/winkd/winkd.c" 3 4
); 
# 191 "project/radare2/shlr/winkd/winkd.c"
...
# 193 "project/radare2/shlr/winkd/winkd.c" 3 4
{ free((void *)
# 193 "project/radare2/shlr/winkd/winkd.c"
*ctx
# 193 "project/radare2/shlr/winkd/winkd.c" 3 4
); 
# 193 "project/radare2/shlr/winkd/winkd.c"
...
# 218 "project/radare2/shlr/winkd/winkd.c"
static int do_io_reply(WindCtx *ctx, kd_packet_t *pkt) {
 ...
 if (id == pkt->id) {
  if (
# 224 "project/radare2/shlr/winkd/winkd.c" 3 4
 0
# 224 "project/radare2/shlr/winkd/winkd.c"
 ) 
# 224 "project/radare2/shlr/winkd/winkd.c" 3 4
          fprintf(__stderrp,
# 224 "project/radare2/shlr/winkd/winkd.c"
          "Host resent io packet, ignoring.\n"
# 224 "project/radare2/shlr/winkd/winkd.c" 3 4
          )
# 224 "project/radare2/shlr/winkd/winkd.c"
                                                       ;
  return 
# 225 "project/radare2/shlr/winkd/winkd.c" 3 4
        1
# 225 "project/radare2/shlr/winkd/winkd.c"
            ;
 }
 int ret;
 ioc.req = 0x3430;
 ...
 ret = kd_send_data_packet (ctx->desc, KD_PACKET_TYPE_FILE_IO,
  (ctx->seq_id ^= 1), (uint8_t *)&ioc, sizeof (kd_ioc_t), 
# 233 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                         ((void *)0)
# 233 "project/radare2/shlr/winkd/winkd.c"
                                                             , 0);
 if (ret != KD_E_OK) {
  goto error;
 }
 if (
# 237 "project/radare2/shlr/winkd/winkd.c" 3 4
0
# 237 "project/radare2/shlr/winkd/winkd.c"
) 
# 237 "project/radare2/shlr/winkd/winkd.c" 3 4
         fprintf(__stderrp,
# 237 "project/radare2/shlr/winkd/winkd.c"
         "Waiting for io_reply ack...\n"
# 237 "project/radare2/shlr/winkd/winkd.c" 3 4
         )
# 237 "project/radare2/shlr/winkd/winkd.c"
                                                 ;
 ret = winkd_wait_packet (ctx, KD_PACKET_TYPE_ACKNOWLEDGE, 
# 238 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                          ((void *)0)
# 238 "project/radare2/shlr/winkd/winkd.c"
                                                              );
 if (ret != KD_E_OK) {
  goto error;
 }
 ...
 if (
# 244 "project/radare2/shlr/winkd/winkd.c" 3 4
0
# 244 "project/radare2/shlr/winkd/winkd.c"
) 
# 244 "project/radare2/shlr/winkd/winkd.c" 3 4
         fprintf(__stderrp,
# 244 "project/radare2/shlr/winkd/winkd.c"
         "Ack received, restore flow\n"
# 244 "project/radare2/shlr/winkd/winkd.c" 3 4
         )
# 244 "project/radare2/shlr/winkd/winkd.c"
                                                ;
 return 
# 245 "project/radare2/shlr/winkd/winkd.c" 3 4
       1
# 245 "project/radare2/shlr/winkd/winkd.c"
           ;
error:
 id = 0;
 winkd_lock_leave (ctx);
...
int winkd_wait_packet(WindCtx *ctx, const uint32_t type, kd_packet_t **p) {
 kd_packet_t *pkt = 
# 253 "project/radare2/shlr/winkd/winkd.c" 3 4
                   ((void *)0)
# 253 "project/radare2/shlr/winkd/winkd.c"
                       ;
 int ret;
 int retries = 10;
...
# 259 "project/radare2/shlr/winkd/winkd.c" 3 4
  { free((void *)
# 259 "project/radare2/shlr/winkd/winkd.c"
  pkt
# 259 "project/radare2/shlr/winkd/winkd.c" 3 4
  ); 
# 259 "project/radare2/shlr/winkd/winkd.c"
...
# 259 "project/radare2/shlr/winkd/winkd.c"
  ...
  if (pkt->type != type) {
   if (
# 273 "project/radare2/shlr/winkd/winkd.c" 3 4
  0
# 273 "project/radare2/shlr/winkd/winkd.c"
  ) 
# 273 "project/radare2/shlr/winkd/winkd.c" 3 4
           fprintf(__stderrp,
# 273 "project/radare2/shlr/winkd/winkd.c"
           "We were not waiting for this... %08x\n", pkt->type
# 273 "project/radare2/shlr/winkd/winkd.c" 3 4
           )
# 273 "project/radare2/shlr/winkd/winkd.c"
                                                                        ;
  }
  if (pkt->leader == 0x30303030 && pkt->type == KD_PACKET_TYPE_STATE_CHANGE64) {

   if (
# 277 "project/radare2/shlr/winkd/winkd.c" 3 4
  0
# 277 "project/radare2/shlr/winkd/winkd.c"
  ) 
# 277 "project/radare2/shlr/winkd/winkd.c" 3 4
           fprintf(__stderrp,
# 277 "project/radare2/shlr/winkd/winkd.c"
...
# 277 "project/radare2/shlr/winkd/winkd.c"
  ...
  if (pkt->leader == 0x30303030 && pkt->type == KD_PACKET_TYPE_FILE_IO) {
   if (
# 280 "project/radare2/shlr/winkd/winkd.c" 3 4
  0
# 280 "project/radare2/shlr/winkd/winkd.c"
  ) 
# 280 "project/radare2/shlr/winkd/winkd.c" 3 4
           fprintf(__stderrp,
# 280 "project/radare2/shlr/winkd/winkd.c"
...
# 280 "project/radare2/shlr/winkd/winkd.c"
  ...
  if (pkt->leader == 0x69696969 && pkt->type == KD_PACKET_TYPE_RESEND) {
   r_sys_backtrace ();
   if (
# 288 "project/radare2/shlr/winkd/winkd.c" 3 4
  0
# 288 "project/radare2/shlr/winkd/winkd.c"
  ) 
# 288 "project/radare2/shlr/winkd/winkd.c" 3 4
           fprintf(__stderrp,
# 288 "project/radare2/shlr/winkd/winkd.c"
...
typedef struct { char tag[4]; 
# 309 "project/radare2/shlr/winkd/winkd.c" 3 4
unsigned int 
# 309 "project/radare2/shlr/winkd/winkd.c"
start_vpn; 
# 309 "project/radare2/shlr/winkd/winkd.c" 3 4
unsigned int 
# 309 "project/radare2/shlr/winkd/winkd.c"
...
# 309 "project/radare2/shlr/winkd/winkd.c" 3 4
__attribute__((__packed__))
# 318 "project/radare2/shlr/winkd/winkd.c"
   mmvad_short
# 318 "project/radare2/shlr/winkd/winkd.c"
             ;

int winkd_walk_vadtree(WindCtx *ctx, 
# 320 "project/radare2/shlr/winkd/winkd.c" 3 4
                                    unsigned long long 
# 320 "project/radare2/shlr/winkd/winkd.c"
                                         address, 
# 320 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                  unsigned long long 
# 320 "project/radare2/shlr/winkd/winkd.c"
...
# 322 "project/radare2/shlr/winkd/winkd.c" 3 4
unsigned long long 
# 322 "project/radare2/shlr/winkd/winkd.c"
     start, end;
 
# 323 "project/radare2/shlr/winkd/winkd.c" 3 4
unsigned int 
# 323 "project/radare2/shlr/winkd/winkd.c"
     prot;

 if (winkd_read_at (ctx, (uint8_t *) &entry, address - 0x4, sizeof(mmvad_short)) != sizeof (mmvad_short)) {
  
# 326 "project/radare2/shlr/winkd/winkd.c" 3 4
 fprintf(__stderrp,
# 326 "project/radare2/shlr/winkd/winkd.c"
 "0x%"
# 326 "project/radare2/shlr/winkd/winkd.c" 3 4
 "llx" 
# 326 "project/radare2/shlr/winkd/winkd.c"
 " Could not read the node!\n", (
# 326 "project/radare2/shlr/winkd/winkd.c" 3 4
 unsigned long long
# 326 "project/radare2/shlr/winkd/winkd.c"
 ) address
...
# 326 "project/radare2/shlr/winkd/winkd.c"
 ...
 if (parent != 
# 330 "project/radare2/shlr/winkd/winkd.c" 3 4
              0xFFFFFFFFFFFFFFFFULL 
# 330 "project/radare2/shlr/winkd/winkd.c"
                       && entry.parent != parent) {
  
# 331 "project/radare2/shlr/winkd/winkd.c" 3 4
 fprintf(__stderrp,
# 331 "project/radare2/shlr/winkd/winkd.c"
 "Wrong parent!\n"
# 331 "project/radare2/shlr/winkd/winkd.c" 3 4
 )
# 331 "project/radare2/shlr/winkd/winkd.c"
...
# 339 "project/radare2/shlr/winkd/winkd.c" 3 4
fprintf(__stderrp,
# 339 "project/radare2/shlr/winkd/winkd.c"
"Start 0x%016"
# 339 "project/radare2/shlr/winkd/winkd.c" 3 4
"llx" 
# 339 "project/radare2/shlr/winkd/winkd.c"
...
# 340 "project/radare2/shlr/winkd/winkd.c"
                                       ;
...
# 354 "project/radare2/shlr/winkd/winkd.c" 3 4
unsigned long long 
# 354 "project/radare2/shlr/winkd/winkd.c"
     ptr, base;

 if (!ctx || !ctx->desc || !ctx->syncd) {
  return 
# 357 "project/radare2/shlr/winkd/winkd.c" 3 4
        ((void *)0)
# 357 "project/radare2/shlr/winkd/winkd.c"
            ;
 }
 ...
 base = ptr;
 if (
# 370 "project/radare2/shlr/winkd/winkd.c" 3 4
0
# 370 "project/radare2/shlr/winkd/winkd.c"
) 
# 370 "project/radare2/shlr/winkd/winkd.c" 3 4
         fprintf(__stderrp,
# 370 "project/radare2/shlr/winkd/winkd.c"
         "Process list head : 0x%016"
# 370 "project/radare2/shlr/winkd/winkd.c" 3 4
         "llx" 
# 370 "project/radare2/shlr/winkd/winkd.c"
         "\n", ptr
...
# 370 "project/radare2/shlr/winkd/winkd.c"
 ...
 if (ptr == 0) {
  return 
# 377 "project/radare2/shlr/winkd/winkd.c" 3 4
        ((void *)0)
# 377 "project/radare2/shlr/winkd/winkd.c"
            ;
 }
...
# 383 "project/radare2/shlr/winkd/winkd.c" 3 4
 unsigned long long 
# 383 "project/radare2/shlr/winkd/winkd.c"
      next;
  ...
  ptr -= ctx->os_profile->f[E_ActiveProcessLinks];


  winkd_read_at (ctx, (uint8_t *) &buf, ptr + ctx->os_profile->f[E_ImageFileName], 16);
  buf[16] = '\0';

  
# 397 "project/radare2/shlr/winkd/winkd.c" 3 4
 unsigned long long 
# 397 "project/radare2/shlr/winkd/winkd.c"
      vadroot = 0;
  
# 398 "project/radare2/shlr/winkd/winkd.c" 3 4
 unsigned long long 
# 398 "project/radare2/shlr/winkd/winkd.c"
      uniqueid = 0;
  
# 399 "project/radare2/shlr/winkd/winkd.c" 3 4
 unsigned long long 
# 399 "project/radare2/shlr/winkd/winkd.c"
      peb = 0;
  
# 400 "project/radare2/shlr/winkd/winkd.c" 3 4
 unsigned long long 
# 400 "project/radare2/shlr/winkd/winkd.c"
      dir_base_table = 0;

  winkd_read_at (ctx, (uint8_t *) &vadroot, ptr + ctx->os_profile->f[E_VadRoot], 4 << ctx->is_x64);
  winkd_read_at (ctx, (uint8_t *) &uniqueid, ptr + ctx->os_profile->f[E_UniqueProcessId], 4 << ctx->is_x64);
  winkd_read_at (ctx, (uint8_t *) &peb, ptr + ctx->os_profile->f[E_Peb], 4 << ctx->is_x64);
  winkd_read_at (ctx, (uint8_t *) &dir_base_table, ptr + ctx->os_profile->f[P_DirectoryTableBase], 4 << ctx->is_x64);

  WindProc *proc = calloc (1, sizeof(WindProc));

  
# 409 "project/radare2/shlr/winkd/winkd.c" 3 4
 __builtin___strcpy_chk (
# 409 "project/radare2/shlr/winkd/winkd.c"
 proc->name
# 409 "project/radare2/shlr/winkd/winkd.c" 3 4
 , 
# 409 "project/radare2/shlr/winkd/winkd.c"
...
int winkd_write_at_uva(WindCtx *ctx, const uint8_t *buf, 
# 427 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                        unsigned long long 
# 427 "project/radare2/shlr/winkd/winkd.c"
                                                             offset, int count) {
 
# 428 "project/radare2/shlr/winkd/winkd.c" 3 4
unsigned long long 
# 428 "project/radare2/shlr/winkd/winkd.c"
     pa;
 
# 429 "project/radare2/shlr/winkd/winkd.c" 3 4
unsigned int 
# 429 "project/radare2/shlr/winkd/winkd.c"
     totwritten = 0;
...
# 434 "project/radare2/shlr/winkd/winkd.c" 3 4
 unsigned int 
# 434 "project/radare2/shlr/winkd/winkd.c"
      restOfPage = 0x1000 - (offset & 0xfff);
  int written = winkd_write_at_phys (ctx, buf + totwritten, pa, 
# 435 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                               (((
# 435 "project/radare2/shlr/winkd/winkd.c"
                                                               count - totwritten
# 435 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                               )>(
# 435 "project/radare2/shlr/winkd/winkd.c"
...
int winkd_read_at_uva(WindCtx *ctx, uint8_t *buf, 
# 445 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                 unsigned long long 
# 445 "project/radare2/shlr/winkd/winkd.c"
                                                      offset, int count) {
 
# 446 "project/radare2/shlr/winkd/winkd.c" 3 4
unsigned long long 
# 446 "project/radare2/shlr/winkd/winkd.c"
     pa;
 
# 447 "project/radare2/shlr/winkd/winkd.c" 3 4
unsigned int 
# 447 "project/radare2/shlr/winkd/winkd.c"
     totread = 0;
 while (totread < count) {
  if (!winkd_va_to_pa (ctx, offset, &pa)) {
   return 0;
...
# 452 "project/radare2/shlr/winkd/winkd.c" 3 4
 unsigned int 
# 452 "project/radare2/shlr/winkd/winkd.c"
      restOfPage = 0x1000 - (offset & 0xfff);
  int read = winkd_read_at_phys (ctx, buf + totread, pa, 
# 453 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                        (((
# 453 "project/radare2/shlr/winkd/winkd.c"
                                                        count - totread
# 453 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                        )>(
# 453 "project/radare2/shlr/winkd/winkd.c"
...
# 465 "project/radare2/shlr/winkd/winkd.c" 3 4
unsigned long long 
# 465 "project/radare2/shlr/winkd/winkd.c"
     ptr, base;

 if (!ctx || !ctx->desc || !ctx->syncd) {
  return 
# 468 "project/radare2/shlr/winkd/winkd.c" 3 4
        ((void *)0)
# 468 "project/radare2/shlr/winkd/winkd.c"
            ;
 }

 if (!ctx->target) {
  
# 472 "project/radare2/shlr/winkd/winkd.c" 3 4
 fprintf(__stderrp,
# 472 "project/radare2/shlr/winkd/winkd.c"
 "No target process\n"
# 472 "project/radare2/shlr/winkd/winkd.c" 3 4
 )
# 472 "project/radare2/shlr/winkd/winkd.c"
                                ;
  return 
# 473 "project/radare2/shlr/winkd/winkd.c" 3 4
        ((void *)0)
# 473 "project/radare2/shlr/winkd/winkd.c"
            ;
 }
...
# 478 "project/radare2/shlr/winkd/winkd.c" 3 4
 fprintf(__stderrp,
# 478 "project/radare2/shlr/winkd/winkd.c"
 "No PEB\n"
# 478 "project/radare2/shlr/winkd/winkd.c" 3 4
 )
# 478 "project/radare2/shlr/winkd/winkd.c"
                     ;
  return 
# 479 "project/radare2/shlr/winkd/winkd.c" 3 4
        ((void *)0)
# 479 "project/radare2/shlr/winkd/winkd.c"
            ;
 }

 
# 482 "project/radare2/shlr/winkd/winkd.c" 3 4
unsigned long long 
# 482 "project/radare2/shlr/winkd/winkd.c"
     ldroff = ctx->is_x64 ? 0x18 : 0xC;


 winkd_read_at_uva (ctx, (uint8_t *) &ptr, ctx->target->peb + ldroff, 4 << ctx->is_x64);

 if (
# 487 "project/radare2/shlr/winkd/winkd.c" 3 4
0
# 487 "project/radare2/shlr/winkd/winkd.c"
) 
# 487 "project/radare2/shlr/winkd/winkd.c" 3 4
         fprintf(__stderrp,
# 487 "project/radare2/shlr/winkd/winkd.c"
         "_PEB_LDR_DATA : 0x%016"
# 487 "project/radare2/shlr/winkd/winkd.c" 3 4
         "llx" 
# 487 "project/radare2/shlr/winkd/winkd.c"
         "\n", ptr
...
# 490 "project/radare2/shlr/winkd/winkd.c" 3 4
unsigned long long 
# 490 "project/radare2/shlr/winkd/winkd.c"
     mlistoff = ctx->is_x64 ? 0x20 : 0x14;
 ...
 if (
# 496 "project/radare2/shlr/winkd/winkd.c" 3 4
0
# 496 "project/radare2/shlr/winkd/winkd.c"
) 
# 496 "project/radare2/shlr/winkd/winkd.c" 3 4
         fprintf(__stderrp,
# 496 "project/radare2/shlr/winkd/winkd.c"
         "InMemoryOrderModuleList : 0x%016"
# 496 "project/radare2/shlr/winkd/winkd.c" 3 4
         "llx" 
# 496 "project/radare2/shlr/winkd/winkd.c"
         "\n", ptr
...
# 496 "project/radare2/shlr/winkd/winkd.c"
 ...
 const 
# 500 "project/radare2/shlr/winkd/winkd.c" 3 4
      unsigned long long 
# 500 "project/radare2/shlr/winkd/winkd.c"
           baseoff = ctx->is_x64 ? 0x30 : 0x18;
 const 
# 501 "project/radare2/shlr/winkd/winkd.c" 3 4
      unsigned long long 
# 501 "project/radare2/shlr/winkd/winkd.c"
           sizeoff = ctx->is_x64 ? 0x40 : 0x20;
 const 
# 502 "project/radare2/shlr/winkd/winkd.c" 3 4
      unsigned long long 
# 502 "project/radare2/shlr/winkd/winkd.c"
           nameoff = ctx->is_x64 ? 0x48 : 0x24;

 do {

  
# 506 "project/radare2/shlr/winkd/winkd.c" 3 4
 unsigned long long 
# 506 "project/radare2/shlr/winkd/winkd.c"
      next = 0;
  winkd_read_at_uva (ctx, (uint8_t *) &next, ptr, 4 << ctx->is_x64);
  if (
# 508 "project/radare2/shlr/winkd/winkd.c" 3 4
 0
# 508 "project/radare2/shlr/winkd/winkd.c"
 ) 
# 508 "project/radare2/shlr/winkd/winkd.c" 3 4
          fprintf(__stderrp,
# 508 "project/radare2/shlr/winkd/winkd.c"
          "_LDR_DATA_TABLE_ENTRY : 0x%016"
# 508 "project/radare2/shlr/winkd/winkd.c" 3 4
          "llx" 
# 508 "project/radare2/shlr/winkd/winkd.c"
          "\n", next
...
# 511 "project/radare2/shlr/winkd/winkd.c" 3 4
  fprintf(__stderrp,
# 511 "project/radare2/shlr/winkd/winkd.c"
  "Corrupted InMemoryOrderModuleList found at: 0x%"
# 511 "project/radare2/shlr/winkd/winkd.c" 3 4
  "llx"
# 511 "project/radare2/shlr/winkd/winkd.c"
  "\n", ptr
...
# 511 "project/radare2/shlr/winkd/winkd.c"
  ...
  WindModule *mod = 
# 517 "project/radare2/shlr/winkd/winkd.c" 3 4
                   (
# 517 "project/radare2/shlr/winkd/winkd.c"
                   WindModule
# 517 "project/radare2/shlr/winkd/winkd.c" 3 4
                   *)calloc(1,sizeof(
# 517 "project/radare2/shlr/winkd/winkd.c"
...
# 524 "project/radare2/shlr/winkd/winkd.c" 3 4
 unsigned short 
# 524 "project/radare2/shlr/winkd/winkd.c"
      length;
  winkd_read_at_uva (ctx, (uint8_t *) &length, ptr + nameoff, sizeof (
# 525 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                                     unsigned short
# 525 "project/radare2/shlr/winkd/winkd.c"
                                                                         ));

  
# 527 "project/radare2/shlr/winkd/winkd.c" 3 4
 unsigned long long 
# 527 "project/radare2/shlr/winkd/winkd.c"
      bufferaddr = 0;
  winkd_read_at_uva (ctx, (uint8_t *) &bufferaddr, ptr + nameoff + sizeof (
# 528 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                                          unsigned int
# 528 "project/radare2/shlr/winkd/winkd.c"
                                                                              ), 4 << ctx->is_x64);

  wchar_t *unname = calloc ((
# 530 "project/radare2/shlr/winkd/winkd.c" 3 4
                            unsigned long long
# 530 "project/radare2/shlr/winkd/winkd.c"
                                )length + 2, 1);
  if (!unname) {
   break;
  }
  ...
  mod->name = calloc ((
# 537 "project/radare2/shlr/winkd/winkd.c" 3 4
                      unsigned long long
# 537 "project/radare2/shlr/winkd/winkd.c"
                          )length + 1, 1);
  if (!mod->name) {
   break;
  }
...
# 554 "project/radare2/shlr/winkd/winkd.c" 3 4
unsigned long long 
# 554 "project/radare2/shlr/winkd/winkd.c"
     ptr, base;

 if (!ctx || !ctx->desc || !ctx->syncd) {
  return 
# 557 "project/radare2/shlr/winkd/winkd.c" 3 4
        ((void *)0)
# 557 "project/radare2/shlr/winkd/winkd.c"
            ;
 }
...
# 565 "project/radare2/shlr/winkd/winkd.c" 3 4
 fprintf(__stderrp,
# 565 "project/radare2/shlr/winkd/winkd.c"
 "No target process\n"
# 565 "project/radare2/shlr/winkd/winkd.c" 3 4
 )
# 565 "project/radare2/shlr/winkd/winkd.c"
                                ;
  return 
# 566 "project/radare2/shlr/winkd/winkd.c" 3 4
        ((void *)0)
# 566 "project/radare2/shlr/winkd/winkd.c"
            ;
 }
...
# 571 "project/radare2/shlr/winkd/winkd.c" 3 4
 fprintf(__stderrp,
# 571 "project/radare2/shlr/winkd/winkd.c"
 "No _EPROCESS\n"
# 571 "project/radare2/shlr/winkd/winkd.c" 3 4
 )
# 571 "project/radare2/shlr/winkd/winkd.c"
                           ;
  return 
# 572 "project/radare2/shlr/winkd/winkd.c" 3 4
        ((void *)0)
# 572 "project/radare2/shlr/winkd/winkd.c"
            ;
 }


 winkd_read_at (ctx, (uint8_t *) &ptr, ptr + ctx->os_profile->f[E_ThreadListHead], 4 << ctx->is_x64);
 if (!ptr) {
  return 
# 578 "project/radare2/shlr/winkd/winkd.c" 3 4
        ((void *)0)
# 578 "project/radare2/shlr/winkd/winkd.c"
            ;
 }
...
# 586 "project/radare2/shlr/winkd/winkd.c" 3 4
 unsigned long long 
# 586 "project/radare2/shlr/winkd/winkd.c"
      next = 0;

  winkd_read_at (ctx, (uint8_t *) &next, ptr, 4 << ctx->is_x64);
  if (!next) {
   
# 590 "project/radare2/shlr/winkd/winkd.c" 3 4
  fprintf(__stderrp,
# 590 "project/radare2/shlr/winkd/winkd.c"
  "Corrupted ThreadListEntry found at: 0x%"
# 590 "project/radare2/shlr/winkd/winkd.c" 3 4
  "llx"
# 590 "project/radare2/shlr/winkd/winkd.c"
  "\n", ptr
...
# 590 "project/radare2/shlr/winkd/winkd.c"
  ...
  ptr -= ctx->os_profile->f[ET_ThreadListEntry];

  
# 597 "project/radare2/shlr/winkd/winkd.c" 3 4
 unsigned long long 
# 597 "project/radare2/shlr/winkd/winkd.c"
      entrypoint = 0;
  winkd_read_at (ctx, (uint8_t *) &entrypoint, ptr + ctx->os_profile->f[ET_Win32StartAddress], 4 << ctx->is_x64);

  
# 600 "project/radare2/shlr/winkd/winkd.c" 3 4
 unsigned long long 
# 600 "project/radare2/shlr/winkd/winkd.c"
      uniqueid = 0;
  winkd_read_at (ctx, (uint8_t *) &uniqueid, ptr + ctx->os_profile->f[ET_Cid] + ctx->os_profile->f[C_UniqueThread], 4 << ctx->is_x64);
  if (uniqueid) {
   WindThread *thread = calloc (1, sizeof(WindThread));
   thread->uniqueid = uniqueid;
   thread->status = 's';
   thread->runnable = 
# 606 "project/radare2/shlr/winkd/winkd.c" 3 4
                     1
# 606 "project/radare2/shlr/winkd/winkd.c"
                         ;
   thread->ethread = ptr;
...
# 628 "project/radare2/shlr/winkd/winkd.c" 3 4
_Bool 
# 628 "project/radare2/shlr/winkd/winkd.c"
    winkd_va_to_pa(WindCtx *ctx, 
# 628 "project/radare2/shlr/winkd/winkd.c" 3 4
                                 unsigned long long 
# 628 "project/radare2/shlr/winkd/winkd.c"
...
# 629 "project/radare2/shlr/winkd/winkd.c" 3 4
unsigned long long 
# 629 "project/radare2/shlr/winkd/winkd.c"
     pml4i, pdpi, pdi, pti;
 
# 630 "project/radare2/shlr/winkd/winkd.c" 3 4
unsigned long long 
# 630 "project/radare2/shlr/winkd/winkd.c"
     tmp, mask;
 ...
 if (
# 637 "project/radare2/shlr/winkd/winkd.c" 3 4
0
# 637 "project/radare2/shlr/winkd/winkd.c"
) 
# 637 "project/radare2/shlr/winkd/winkd.c" 3 4
         fprintf(__stderrp,
# 637 "project/radare2/shlr/winkd/winkd.c"
...
# 637 "project/radare2/shlr/winkd/winkd.c"
 ...
 if (
# 665 "project/radare2/shlr/winkd/winkd.c" 3 4
0
# 665 "project/radare2/shlr/winkd/winkd.c"
) 
# 665 "project/radare2/shlr/winkd/winkd.c" 3 4
         fprintf(__stderrp,
# 665 "project/radare2/shlr/winkd/winkd.c"
...
# 665 "project/radare2/shlr/winkd/winkd.c"
 ...
 if (ctx->is_x64) {
  ...
  if (!winkd_read_at_phys (ctx, (uint8_t *) &tmp, tmp + pml4i * 8, 8)) {
   return 
# 670 "project/radare2/shlr/winkd/winkd.c" 3 4
         0
# 670 "project/radare2/shlr/winkd/winkd.c"
              ;
  }
  tmp &= mask;
  if (
# 673 "project/radare2/shlr/winkd/winkd.c" 3 4
 0
# 673 "project/radare2/shlr/winkd/winkd.c"
 ) 
# 673 "project/radare2/shlr/winkd/winkd.c" 3 4
          fprintf(__stderrp,
# 673 "project/radare2/shlr/winkd/winkd.c"
...
# 673 "project/radare2/shlr/winkd/winkd.c"
 ...
 if (ctx->pae) {
  ...
  if (!winkd_read_at_phys (ctx, (uint8_t *) &tmp, tmp + pdpi * 8, 8)) {
   return 
# 679 "project/radare2/shlr/winkd/winkd.c" 3 4
         0
# 679 "project/radare2/shlr/winkd/winkd.c"
              ;
  }
  tmp &= mask;
  if (
# 682 "project/radare2/shlr/winkd/winkd.c" 3 4
 0
# 682 "project/radare2/shlr/winkd/winkd.c"
 ) 
# 682 "project/radare2/shlr/winkd/winkd.c" 3 4
          fprintf(__stderrp,
# 682 "project/radare2/shlr/winkd/winkd.c"
...
# 682 "project/radare2/shlr/winkd/winkd.c"
 ...
 if (!winkd_read_at_phys (ctx, (uint8_t *) &tmp, tmp + pdi * (4 << ctx->pae), 4 << ctx->pae)) {
  return 
# 687 "project/radare2/shlr/winkd/winkd.c" 3 4
        0
# 687 "project/radare2/shlr/winkd/winkd.c"
             ;
 }
 if (
# 689 "project/radare2/shlr/winkd/winkd.c" 3 4
0
# 689 "project/radare2/shlr/winkd/winkd.c"
) 
# 689 "project/radare2/shlr/winkd/winkd.c" 3 4
         fprintf(__stderrp,
# 689 "project/radare2/shlr/winkd/winkd.c"
...
# 689 "project/radare2/shlr/winkd/winkd.c"
  ...
  *pa = ctx->pae?
  ...
  return 
# 698 "project/radare2/shlr/winkd/winkd.c" 3 4
        1
# 698 "project/radare2/shlr/winkd/winkd.c"
            ;
 }
 ...
 if (!winkd_read_at_phys (ctx, (uint8_t *) &tmp, (tmp & mask) + pti * (4 << ctx->pae), 4 << ctx->pae)) {
  return 
# 703 "project/radare2/shlr/winkd/winkd.c" 3 4
        0
# 703 "project/radare2/shlr/winkd/winkd.c"
             ;
 }
 if (
# 705 "project/radare2/shlr/winkd/winkd.c" 3 4
0
# 705 "project/radare2/shlr/winkd/winkd.c"
) 
# 705 "project/radare2/shlr/winkd/winkd.c" 3 4
         fprintf(__stderrp,
# 705 "project/radare2/shlr/winkd/winkd.c"
...
# 705 "project/radare2/shlr/winkd/winkd.c"
  ...
  *pa = (tmp & mask) | (va & 0xfff);
  return 
# 709 "project/radare2/shlr/winkd/winkd.c" 3 4
        1
# 709 "project/radare2/shlr/winkd/winkd.c"
            ;
 }
...
# 714 "project/radare2/shlr/winkd/winkd.c" 3 4
 fprintf(__stderrp,
# 714 "project/radare2/shlr/winkd/winkd.c"
...
# 714 "project/radare2/shlr/winkd/winkd.c"
 ...
 return 
# 717 "project/radare2/shlr/winkd/winkd.c" 3 4
       0
# 717 "project/radare2/shlr/winkd/winkd.c"
            ;
}


# 720 "project/radare2/shlr/winkd/winkd.c" 3 4
_Bool 
# 720 "project/radare2/shlr/winkd/winkd.c"
    winkd_read_ver(WindCtx *ctx) {
 kd_req_t req = {
  0
 };
 ...
 if (!ctx || !ctx->desc || !ctx->syncd) {
  return 
# 728 "project/radare2/shlr/winkd/winkd.c" 3 4
        0
# 728 "project/radare2/shlr/winkd/winkd.c"
             ;
 }
 ...
 ret = kd_send_data_packet (ctx->desc, KD_PACKET_TYPE_STATE_MANIPULATE,
  (ctx->seq_id ^= 1), (uint8_t *)&req, sizeof (kd_req_t), 
# 737 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                         ((void *)0)
# 737 "project/radare2/shlr/winkd/winkd.c"
                                                             , 0);
 if (ret != KD_E_OK) {
  goto error;
 }
 ...
 ret = winkd_wait_packet (ctx, KD_PACKET_TYPE_ACKNOWLEDGE, 
# 742 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                          ((void *)0)
# 742 "project/radare2/shlr/winkd/winkd.c"
                                                              );
 if (ret != KD_E_OK) {
  goto error;
 }
 ...
 kd_req_t *rr = ((kd_req_t *) (((kd_packet_t *) pkt)->data));

 if (rr->ret) {
  if (
# 757 "project/radare2/shlr/winkd/winkd.c" 3 4
 0
# 757 "project/radare2/shlr/winkd/winkd.c"
 ) 
# 757 "project/radare2/shlr/winkd/winkd.c" 3 4
          fprintf(__stderrp,
# 757 "project/radare2/shlr/winkd/winkd.c"
...
# 757 "project/radare2/shlr/winkd/winkd.c"
 ...
 if (
# 762 "project/radare2/shlr/winkd/winkd.c" 3 4
0
# 762 "project/radare2/shlr/winkd/winkd.c"
) {
  
# 763 "project/radare2/shlr/winkd/winkd.c" 3 4
 fprintf(__stderrp,
# 763 "project/radare2/shlr/winkd/winkd.c"
...
# 764 "project/radare2/shlr/winkd/winkd.c" 3 4
 fprintf(__stderrp,
# 764 "project/radare2/shlr/winkd/winkd.c"
...
# 765 "project/radare2/shlr/winkd/winkd.c" 3 4
 fprintf(__stderrp,
# 765 "project/radare2/shlr/winkd/winkd.c"
 "Flags : %08x\n", rr->r_ver.flags
# 765 "project/radare2/shlr/winkd/winkd.c" 3 4
 )
# 765 "project/radare2/shlr/winkd/winkd.c"
...
# 766 "project/radare2/shlr/winkd/winkd.c" 3 4
 fprintf(__stderrp,
# 766 "project/radare2/shlr/winkd/winkd.c"
 "Machine : %08x\n", rr->r_ver.machine
# 766 "project/radare2/shlr/winkd/winkd.c" 3 4
 )
# 766 "project/radare2/shlr/winkd/winkd.c"
...
# 767 "project/radare2/shlr/winkd/winkd.c" 3 4
 fprintf(__stderrp,
# 767 "project/radare2/shlr/winkd/winkd.c"
 "Module list : %016"
# 767 "project/radare2/shlr/winkd/winkd.c" 3 4
 "llx" 
# 767 "project/radare2/shlr/winkd/winkd.c"
...
# 768 "project/radare2/shlr/winkd/winkd.c" 3 4
 fprintf(__stderrp,
# 768 "project/radare2/shlr/winkd/winkd.c"
 "Debug block : %016"
# 768 "project/radare2/shlr/winkd/winkd.c" 3 4
 "llx" 
# 768 "project/radare2/shlr/winkd/winkd.c"
...
# 768 "project/radare2/shlr/winkd/winkd.c"
 ...
 if (rr->r_ver.machine != 0x014C && rr->r_ver.machine != 0x8664) {
  
# 772 "project/radare2/shlr/winkd/winkd.c" 3 4
 fprintf(__stderrp,
# 772 "project/radare2/shlr/winkd/winkd.c"
...
# 772 "project/radare2/shlr/winkd/winkd.c"
 ...
 if (!(rr->r_ver.flags & 0x0002)) {
  
# 778 "project/radare2/shlr/winkd/winkd.c" 3 4
 fprintf(__stderrp,
# 778 "project/radare2/shlr/winkd/winkd.c"
...
# 778 "project/radare2/shlr/winkd/winkd.c"
 ...
 ctx->is_x64 = (rr->r_ver.machine == 0x8664);

 
# 785 "project/radare2/shlr/winkd/winkd.c" 3 4
unsigned long long 
# 785 "project/radare2/shlr/winkd/winkd.c"
     ptr = 0;
 if (!winkd_read_at (ctx, (uint8_t *) &ptr, rr->r_ver.dbg_addr, 4 << ctx->is_x64)) {
  free (pkt);
  return 
# 788 "project/radare2/shlr/winkd/winkd.c" 3 4
        0
# 788 "project/radare2/shlr/winkd/winkd.c"
             ;
 }
 ...
 if (
# 793 "project/radare2/shlr/winkd/winkd.c" 3 4
0
# 793 "project/radare2/shlr/winkd/winkd.c"
) 
# 793 "project/radare2/shlr/winkd/winkd.c" 3 4
         fprintf(__stderrp,
# 793 "project/radare2/shlr/winkd/winkd.c"
         "_KDDEBUGGER_DATA64 at 0x%016"
# 793 "project/radare2/shlr/winkd/winkd.c" 3 4
         "llx" 
# 793 "project/radare2/shlr/winkd/winkd.c"
         "\n", ctx->dbg_addr
...
# 793 "project/radare2/shlr/winkd/winkd.c"
 ...
 if (!winkd_read_at (ctx, (uint8_t *) &pae_enabled, ctx->dbg_addr + K_PaeEnabled, sizeof(uint16_t))) {
  free (pkt);
  return 
# 799 "project/radare2/shlr/winkd/winkd.c" 3 4
        0
# 799 "project/radare2/shlr/winkd/winkd.c"
             ;
 }
...
# 809 "project/radare2/shlr/winkd/winkd.c" 3 4
 fprintf(__stderrp,
# 809 "project/radare2/shlr/winkd/winkd.c"
...
# 809 "project/radare2/shlr/winkd/winkd.c"
  ...
  free (pkt);
  return 
# 811 "project/radare2/shlr/winkd/winkd.c" 3 4
        0
# 811 "project/radare2/shlr/winkd/winkd.c"
             ;
 }
 free (pkt);
 return 
# 814 "project/radare2/shlr/winkd/winkd.c" 3 4
       1
# 814 "project/radare2/shlr/winkd/winkd.c"
           ;
error:
 winkd_lock_leave (ctx);
 return 0;
...
int winkd_sync(WindCtx *ctx) {
 ...
 if (ctx->desc->iob->type == 0) {
  ...
  ret = winkd_wait_packet (ctx, KD_PACKET_TYPE_RESET, 
# 859 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                     ((void *)0)
# 859 "project/radare2/shlr/winkd/winkd.c"
                                                         );
  if (ret != KD_E_OK) {
   ret = 0;
   goto end;
 ...
 ctx->target = 
# 879 "project/radare2/shlr/winkd/winkd.c" 3 4
              ((void *)0)
# 879 "project/radare2/shlr/winkd/winkd.c"
                  ;
 r_list_free (ctx->plist_cache);
 ctx->plist_cache = 
# 881 "project/radare2/shlr/winkd/winkd.c" 3 4
                   ((void *)0)
# 881 "project/radare2/shlr/winkd/winkd.c"
                       ;
 r_list_free (ctx->tlist_cache);
 ctx->tlist_cache = 
# 883 "project/radare2/shlr/winkd/winkd.c" 3 4
                   ((void *)0)
# 883 "project/radare2/shlr/winkd/winkd.c"
                       ;
 ctx->pae = 0;
...
# 889 "project/radare2/shlr/winkd/winkd.c" 3 4
fprintf(__stderrp,
# 889 "project/radare2/shlr/winkd/winkd.c"
"Sync done! (%i cpus found)\n", ctx->cpu_count
# 889 "project/radare2/shlr/winkd/winkd.c" 3 4
)
# 889 "project/radare2/shlr/winkd/winkd.c"
                                                        ;
...
int winkd_continue(WindCtx *ctx) {
 ...
 ret = kd_send_data_packet (ctx->desc, KD_PACKET_TYPE_STATE_MANIPULATE,
  (ctx->seq_id ^= 1), (uint8_t *)&req, sizeof (kd_req_t), 
# 916 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                         ((void *)0)
# 916 "project/radare2/shlr/winkd/winkd.c"
                                                             , 0);
 if (ret == KD_E_OK) {
  ret = winkd_wait_packet (ctx, KD_PACKET_TYPE_ACKNOWLEDGE, 
# 918 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                           ((void *)0)
# 918 "project/radare2/shlr/winkd/winkd.c"
                                                               );
  if (ret == KD_E_OK) {
   r_list_free (ctx->plist_cache);
   ctx->plist_cache = 
# 921 "project/radare2/shlr/winkd/winkd.c" 3 4
                     ((void *)0)
# 921 "project/radare2/shlr/winkd/winkd.c"
                         ;
   ret = 
# 922 "project/radare2/shlr/winkd/winkd.c" 3 4
        1
# 922 "project/radare2/shlr/winkd/winkd.c"
            ;
   goto end;
  }
 }
 ret = 
# 926 "project/radare2/shlr/winkd/winkd.c" 3 4
      0
# 926 "project/radare2/shlr/winkd/winkd.c"
           ;
...
# 933 "project/radare2/shlr/winkd/winkd.c" 3 4
_Bool 
# 933 "project/radare2/shlr/winkd/winkd.c"
    winkd_write_reg(WindCtx *ctx, const uint8_t *buf, int size) {
 kd_packet_t *pkt;
 kd_req_t req = {
  0
 ...
 if (!ctx || !ctx->desc || !ctx->syncd) {
  return 
# 941 "project/radare2/shlr/winkd/winkd.c" 3 4
        0
# 941 "project/radare2/shlr/winkd/winkd.c"
             ;
 }
 ...
 if (
# 947 "project/radare2/shlr/winkd/winkd.c" 3 4
0
# 947 "project/radare2/shlr/winkd/winkd.c"
) 
# 947 "project/radare2/shlr/winkd/winkd.c" 3 4
         fprintf(__stderrp,
# 947 "project/radare2/shlr/winkd/winkd.c"
...
# 947 "project/radare2/shlr/winkd/winkd.c"
 ...
 ret = winkd_wait_packet (ctx, KD_PACKET_TYPE_ACKNOWLEDGE, 
# 957 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                          ((void *)0)
# 957 "project/radare2/shlr/winkd/winkd.c"
                                                              );
 if (ret != KD_E_OK) {
  goto error;
 }
 ...
 if (rr->ret) {
  if (
# 972 "project/radare2/shlr/winkd/winkd.c" 3 4
 0
# 972 "project/radare2/shlr/winkd/winkd.c"
 ) 
# 972 "project/radare2/shlr/winkd/winkd.c" 3 4
          fprintf(__stderrp,
# 972 "project/radare2/shlr/winkd/winkd.c"
...
int winkd_read_reg(WindCtx *ctx, uint8_t *buf, int size) {
 kd_req_t req;
 kd_packet_t *pkt = 
# 987 "project/radare2/shlr/winkd/winkd.c" 3 4
                   ((void *)0)
# 987 "project/radare2/shlr/winkd/winkd.c"
                       ;
 int ret;
...
# 994 "project/radare2/shlr/winkd/winkd.c" 3 4
__builtin___memset_chk (
# 994 "project/radare2/shlr/winkd/winkd.c"
&req
# 994 "project/radare2/shlr/winkd/winkd.c" 3 4
, 
# 994 "project/radare2/shlr/winkd/winkd.c"
...
# 994 "project/radare2/shlr/winkd/winkd.c"
 ...
 ret = kd_send_data_packet (ctx->desc, KD_PACKET_TYPE_STATE_MANIPULATE, (ctx->seq_id ^= 1), (uint8_t *)&req,
  sizeof (kd_req_t), 
# 1008 "project/radare2/shlr/winkd/winkd.c" 3 4
                    ((void *)0)
# 1008 "project/radare2/shlr/winkd/winkd.c"
                        , 0);
 if (ret != KD_E_OK) {
  goto error;
 }
 ...
 ret = winkd_wait_packet (ctx, KD_PACKET_TYPE_ACKNOWLEDGE, 
# 1013 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                          ((void *)0)
# 1013 "project/radare2/shlr/winkd/winkd.c"
                                                              );
 if (ret != KD_E_OK) {
  goto error;
 }
 ...
 if (rr->ret) {
  if (
# 1028 "project/radare2/shlr/winkd/winkd.c" 3 4
 0
# 1028 "project/radare2/shlr/winkd/winkd.c"
 ) 
# 1028 "project/radare2/shlr/winkd/winkd.c" 3 4
          fprintf(__stderrp,
# 1028 "project/radare2/shlr/winkd/winkd.c"
...
# 1033 "project/radare2/shlr/winkd/winkd.c" 3 4
__builtin___memcpy_chk (
# 1033 "project/radare2/shlr/winkd/winkd.c"
buf
# 1033 "project/radare2/shlr/winkd/winkd.c" 3 4
, 
# 1033 "project/radare2/shlr/winkd/winkd.c"
...
int winkd_query_mem(WindCtx *ctx, const 
# 1043 "project/radare2/shlr/winkd/winkd.c" 3 4
                                       unsigned long long 
# 1043 "project/radare2/shlr/winkd/winkd.c"
                                            addr, int *address_space, int *flags) {
 kd_req_t req;
 kd_packet_t *pkt;
 int ret;
...
# 1052 "project/radare2/shlr/winkd/winkd.c" 3 4
__builtin___memset_chk (
# 1052 "project/radare2/shlr/winkd/winkd.c"
&req
# 1052 "project/radare2/shlr/winkd/winkd.c" 3 4
, 
# 1052 "project/radare2/shlr/winkd/winkd.c"
...
# 1052 "project/radare2/shlr/winkd/winkd.c"
 ...
 ret = kd_send_data_packet (ctx->desc, KD_PACKET_TYPE_STATE_MANIPULATE, (ctx->seq_id ^= 1), (uint8_t *)&req,
  sizeof (kd_req_t), 
# 1063 "project/radare2/shlr/winkd/winkd.c" 3 4
                    ((void *)0)
# 1063 "project/radare2/shlr/winkd/winkd.c"
                        , 0);
 if (ret != KD_E_OK) {
  goto error;
 }
 ...
 ret = winkd_wait_packet (ctx, KD_PACKET_TYPE_ACKNOWLEDGE, 
# 1068 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                          ((void *)0)
# 1068 "project/radare2/shlr/winkd/winkd.c"
                                                              );
 if (ret != KD_E_OK) {
  goto error;
 }
...
int winkd_bkpt(WindCtx *ctx, const 
# 1103 "project/radare2/shlr/winkd/winkd.c" 3 4
                                  unsigned long long 
# 1103 "project/radare2/shlr/winkd/winkd.c"
                                       addr, const int set, const int hw, int *handle) {
 kd_req_t req = {
  0
 };
 ...
 ret = kd_send_data_packet (ctx->desc, KD_PACKET_TYPE_STATE_MANIPULATE, (ctx->seq_id ^= 1), (uint8_t *)&req,
  sizeof (kd_req_t), 
# 1126 "project/radare2/shlr/winkd/winkd.c" 3 4
                    ((void *)0)
# 1126 "project/radare2/shlr/winkd/winkd.c"
                        , 0);
 if (ret != KD_E_OK) {
  goto error;
 }
 ...
 ret = winkd_wait_packet (ctx, KD_PACKET_TYPE_ACKNOWLEDGE, 
# 1131 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                          ((void *)0)
# 1131 "project/radare2/shlr/winkd/winkd.c"
                                                              );
 if (ret != KD_E_OK) {
  goto error;
 }
...
int winkd_read_at_phys(WindCtx *ctx, uint8_t *buf, const 
# 1158 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                        unsigned long long 
# 1158 "project/radare2/shlr/winkd/winkd.c"
                                                             offset, const int count) {
 kd_req_t req = {
  0
 }, *rr;
 ...
 req.r_mem.length = 
# 1171 "project/radare2/shlr/winkd/winkd.c" 3 4
                   (((
# 1171 "project/radare2/shlr/winkd/winkd.c"
                   count
# 1171 "project/radare2/shlr/winkd/winkd.c" 3 4
                   )>(
# 1171 "project/radare2/shlr/winkd/winkd.c"
...
# 1171 "project/radare2/shlr/winkd/winkd.c"
 ...
 ret = kd_send_data_packet (ctx->desc, KD_PACKET_TYPE_STATE_MANIPULATE, (ctx->seq_id ^= 1),
  (uint8_t *)&req, sizeof (kd_req_t), 
# 1181 "project/radare2/shlr/winkd/winkd.c" 3 4
                                     ((void *)0)
# 1181 "project/radare2/shlr/winkd/winkd.c"
                                         , 0);
 if (ret != KD_E_OK) {
  goto error;
 }
 ...
 ret = winkd_wait_packet (ctx, KD_PACKET_TYPE_ACKNOWLEDGE, 
# 1186 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                          ((void *)0)
# 1186 "project/radare2/shlr/winkd/winkd.c"
                                                              );
 if (ret != KD_E_OK) {
  goto error;
 }
 ...
 rr = ((kd_req_t *) (((kd_packet_t *) pkt)->data));
...
# 1205 "project/radare2/shlr/winkd/winkd.c" 3 4
__builtin___memcpy_chk (
# 1205 "project/radare2/shlr/winkd/winkd.c"
buf
# 1205 "project/radare2/shlr/winkd/winkd.c" 3 4
, 
# 1205 "project/radare2/shlr/winkd/winkd.c"
rr->data, rr->r_mem.read
# 1205 "project/radare2/shlr/winkd/winkd.c" 3 4
, __builtin_object_size (
# 1205 "project/radare2/shlr/winkd/winkd.c"
buf
...
int winkd_read_at(WindCtx *ctx, uint8_t *buf, const 
# 1214 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                   unsigned long long 
# 1214 "project/radare2/shlr/winkd/winkd.c"
                                                        offset, const int count) {
 kd_req_t *rr, req = {
  0
 };
 ...
 req.r_mem.addr = offset;
 req.r_mem.length = 
# 1227 "project/radare2/shlr/winkd/winkd.c" 3 4
                   (((
# 1227 "project/radare2/shlr/winkd/winkd.c"
                   count
# 1227 "project/radare2/shlr/winkd/winkd.c" 3 4
                   )>(
# 1227 "project/radare2/shlr/winkd/winkd.c"
...
# 1227 "project/radare2/shlr/winkd/winkd.c"
 ...
 ret = kd_send_data_packet (ctx->desc, KD_PACKET_TYPE_STATE_MANIPULATE,
  (ctx->seq_id ^= 1), (uint8_t *)&req, sizeof (kd_req_t), 
# 1237 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                         ((void *)0)
# 1237 "project/radare2/shlr/winkd/winkd.c"
                                                             , 0);
 if (ret != KD_E_OK) {
  goto error;
 }
 ...
 ret = winkd_wait_packet (ctx, KD_PACKET_TYPE_ACKNOWLEDGE, 
# 1242 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                          ((void *)0)
# 1242 "project/radare2/shlr/winkd/winkd.c"
                                                              );
 if (ret != KD_E_OK) {
  goto error;
 }
...
# 1260 "project/radare2/shlr/winkd/winkd.c" 3 4
__builtin___memcpy_chk (
# 1260 "project/radare2/shlr/winkd/winkd.c"
buf
# 1260 "project/radare2/shlr/winkd/winkd.c" 3 4
, 
# 1260 "project/radare2/shlr/winkd/winkd.c"
...
int winkd_write_at(WindCtx *ctx, const uint8_t *buf, const 
# 1269 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                          unsigned long long 
# 1269 "project/radare2/shlr/winkd/winkd.c"
                                                               offset, const int count) {
 kd_packet_t *pkt;
 kd_req_t req = {
  0
 ...
 payload = 
# 1280 "project/radare2/shlr/winkd/winkd.c" 3 4
          (((
# 1280 "project/radare2/shlr/winkd/winkd.c"
          count
# 1280 "project/radare2/shlr/winkd/winkd.c" 3 4
          )>(
# 1280 "project/radare2/shlr/winkd/winkd.c"
          0x800 - sizeof(kd_req_t)
# 1280 "project/radare2/shlr/winkd/winkd.c" 3 4
          ))?(
# 1280 "project/radare2/shlr/winkd/winkd.c"
          0x800 - sizeof(kd_req_t)
...
# 1280 "project/radare2/shlr/winkd/winkd.c"
 ...
 ret = winkd_wait_packet (ctx, KD_PACKET_TYPE_ACKNOWLEDGE, 
# 1295 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                          ((void *)0)
# 1295 "project/radare2/shlr/winkd/winkd.c"
                                                              );
 if (ret != KD_E_OK) {
  goto error;
 }
...
int winkd_write_at_phys(WindCtx *ctx, const uint8_t *buf, const 
# 1322 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                               unsigned long long 
# 1322 "project/radare2/shlr/winkd/winkd.c"
                                                                    offset, const int count) {
 kd_packet_t *pkt;
 kd_req_t req;
 int ret;
 ...
 payload = 
# 1332 "project/radare2/shlr/winkd/winkd.c" 3 4
          (((
# 1332 "project/radare2/shlr/winkd/winkd.c"
          count
# 1332 "project/radare2/shlr/winkd/winkd.c" 3 4
          )>(
# 1332 "project/radare2/shlr/winkd/winkd.c"
...
# 1334 "project/radare2/shlr/winkd/winkd.c" 3 4
__builtin___memset_chk (
# 1334 "project/radare2/shlr/winkd/winkd.c"
&req
# 1334 "project/radare2/shlr/winkd/winkd.c" 3 4
, 
# 1334 "project/radare2/shlr/winkd/winkd.c"
...
# 1334 "project/radare2/shlr/winkd/winkd.c"
 ...
 ret = winkd_wait_packet (ctx, KD_PACKET_TYPE_ACKNOWLEDGE, 
# 1351 "project/radare2/shlr/winkd/winkd.c" 3 4
                                                          ((void *)0)
# 1351 "project/radare2/shlr/winkd/winkd.c"
                                                              );
 if (ret != KD_E_OK) {
  goto error;
 }
...
int winkd_break_read(WindCtx *ctx) {
# 1396 "project/radare2/shlr/winkd/winkd.c"
 return 1;
}
