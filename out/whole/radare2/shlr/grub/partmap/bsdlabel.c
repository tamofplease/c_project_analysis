# 0 "project/radare2/shlr/grub/partmap/bsdlabel.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 21 "project/radare2/shlr/grub/partmap/bsdlabel.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/bsdlabel.h" 1 3 4
# 20 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/bsdlabel.h" 3 4
...
struct grub_partition_bsd_entry { grub_uint32_t size; grub_uint32_t offset; grub_uint32_t fragment_size; grub_uint8_t fs_type; grub_uint8_t fs_fragments; grub_uint16_t fs_cylinders; } __attribute__((__packed__))
# 76 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/bsdlabel.h" 3 4
  ;


struct grub_partition_bsd_disk_label { grub_uint32_t magic; grub_uint8_t padding[128]; grub_uint32_t magic2; grub_uint16_t checksum; grub_uint16_t num_partitions; grub_uint32_t boot_size; grub_uint32_t superblock_size; } __attribute__((__packed__))
# 89 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/bsdlabel.h" 3 4
  ;
# 22 "project/radare2/shlr/grub/partmap/bsdlabel.c" 2
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 23 "project/radare2/shlr/grub/partmap/bsdlabel.c" 2
...
# 24 "project/radare2/shlr/grub/partmap/bsdlabel.c" 2



# 26 "project/radare2/shlr/grub/partmap/bsdlabel.c"
...
# 45 "project/radare2/shlr/grub/partmap/bsdlabel.c" 3 4
                           1
# 45 "project/radare2/shlr/grub/partmap/bsdlabel.c"
                                                             ,
  ...
  if (label.magic != 
# 50 "project/radare2/shlr/grub/partmap/bsdlabel.c" 3 4
                    ((grub_uint32_t) (0x82564557))
# 50 "project/radare2/shlr/grub/partmap/bsdlabel.c"
                                                                        )
    return grub_error (GRUB_ERR_BAD_PART_TABLE, "no signature");

  pos = sizeof (label) + 
# 53 "project/radare2/shlr/grub/partmap/bsdlabel.c" 3 4
                        1
    
# 54 "project/radare2/shlr/grub/partmap/bsdlabel.c"
   * 
# 54 "project/radare2/shlr/grub/partmap/bsdlabel.c" 3 4
     0x200
# 54 "project/radare2/shlr/grub/partmap/bsdlabel.c"
                          ;
  ...
  for (p.number = 0;
       p.number < 
# 57 "project/radare2/shlr/grub/partmap/bsdlabel.c" 3 4
                 ((grub_uint16_t) (
# 57 "project/radare2/shlr/grub/partmap/bsdlabel.c"
...
# 57 "project/radare2/shlr/grub/partmap/bsdlabel.c"
       ...
       p.number++)
    {
      ...
      p.offset = pos / 
# 62 "project/radare2/shlr/grub/partmap/bsdlabel.c" 3 4
                      0x200
# 62 "project/radare2/shlr/grub/partmap/bsdlabel.c"
                                           ;
      p.index = pos % 
# 63 "project/radare2/shlr/grub/partmap/bsdlabel.c" 3 4
                     0x200
# 63 "project/radare2/shlr/grub/partmap/bsdlabel.c"
                                          ;
 ...
 return grub_errno;
      ...
      p.start = 
# 68 "project/radare2/shlr/grub/partmap/bsdlabel.c" 3 4
               ((grub_uint32_t) (
# 68 "project/radare2/shlr/grub/partmap/bsdlabel.c"
               be.offset
# 68 "project/radare2/shlr/grub/partmap/bsdlabel.c" 3 4
               )) 
# 68 "project/radare2/shlr/grub/partmap/bsdlabel.c"
                                            - delta;
      p.len = 
# 69 "project/radare2/shlr/grub/partmap/bsdlabel.c" 3 4
             ((grub_uint32_t) (
# 69 "project/radare2/shlr/grub/partmap/bsdlabel.c"
             be.size
# 69 "project/radare2/shlr/grub/partmap/bsdlabel.c" 3 4
             ))
# 69 "project/radare2/shlr/grub/partmap/bsdlabel.c"
      ...
      if (be.fs_type != 
# 72 "project/radare2/shlr/grub/partmap/bsdlabel.c" 3 4
                       0
# 72 "project/radare2/shlr/grub/partmap/bsdlabel.c"
                                                        )
