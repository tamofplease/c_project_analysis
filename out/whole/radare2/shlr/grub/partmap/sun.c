# 0 "project/radare2/shlr/grub/partmap/sun.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 21 "project/radare2/shlr/grub/partmap/sun.c" 2
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 22 "project/radare2/shlr/grub/partmap/sun.c" 2
...
# 23 "project/radare2/shlr/grub/partmap/sun.c" 2
...
# 33 "project/radare2/shlr/grub/partmap/sun.c"
struct grub_sun_partition_info { grub_uint8_t spare1; grub_uint8_t id; grub_uint8_t spare2; grub_uint8_t flags; } 
# 33 "project/radare2/shlr/grub/partmap/sun.c" 3 4
...
# 40 "project/radare2/shlr/grub/partmap/sun.c"
 ;

struct grub_sun_partition_descriptor { grub_uint32_t start_cylinder; grub_uint32_t num_sectors; } 
# 42 "project/radare2/shlr/grub/partmap/sun.c" 3 4
__attribute__((__packed__))
...
# 47 "project/radare2/shlr/grub/partmap/sun.c"
 ;

struct grub_sun_block { grub_uint8_t info[128]; grub_uint8_t spare0[14]; struct grub_sun_partition_info infos[8]; grub_uint8_t spare1[246]; grub_uint16_t rspeed; grub_uint16_t pcylcount; grub_uint16_t sparecyl; grub_uint8_t spare2[4]; grub_uint16_t ilfact; grub_uint16_t ncyl; grub_uint16_t nacyl; grub_uint16_t ntrks; grub_uint16_t nsect; grub_uint8_t spare3[4]; struct grub_sun_partition_descriptor partitions[8]; grub_uint16_t magic; grub_uint16_t csum; } 
# 49 "project/radare2/shlr/grub/partmap/sun.c" 3 4
__attribute__((__packed__))
# 69 "project/radare2/shlr/grub/partmap/sun.c"
  ;


# 71 "project/radare2/shlr/grub/partmap/sun.c"
      ...
      void *closure)
{
  ...
  if (0xDABE != 
# 113 "project/radare2/shlr/grub/partmap/sun.c" 3 4
                               ({ grub_uint16_t _x = (
# 113 "project/radare2/shlr/grub/partmap/sun.c"
                               block.magic
# 113 "project/radare2/shlr/grub/partmap/sun.c" 3 4
...
# 113 "project/radare2/shlr/grub/partmap/sun.c"
  ...
  for (partnum = 0; partnum < 8; partnum++)
   ...
   || block.infos[partnum].id == 0x05)
 continue;

      desc = &block.partitions[partnum];
      p->start = ((grub_uint64_t) 
# 136 "project/radare2/shlr/grub/partmap/sun.c" 3 4
                                 grub_swap_bytes32(
# 136 "project/radare2/shlr/grub/partmap/sun.c"
                                 desc->start_cylinder
# 136 "project/radare2/shlr/grub/partmap/sun.c" 3 4
                                 )
    
# 137 "project/radare2/shlr/grub/partmap/sun.c"
   * 
# 137 "project/radare2/shlr/grub/partmap/sun.c" 3 4
     ({ grub_uint16_t _x = (
# 137 "project/radare2/shlr/grub/partmap/sun.c"
     block.ntrks
# 137 "project/radare2/shlr/grub/partmap/sun.c" 3 4
...
# 138 "project/radare2/shlr/grub/partmap/sun.c"
   * 
# 138 "project/radare2/shlr/grub/partmap/sun.c" 3 4
     ({ grub_uint16_t _x = (
# 138 "project/radare2/shlr/grub/partmap/sun.c"
     block.nsect
# 138 "project/radare2/shlr/grub/partmap/sun.c" 3 4
...
# 138 "project/radare2/shlr/grub/partmap/sun.c"
      ...
      p->len = 
# 139 "project/radare2/shlr/grub/partmap/sun.c" 3 4
              grub_swap_bytes32(
# 139 "project/radare2/shlr/grub/partmap/sun.c"
              desc->num_sectors
# 139 "project/radare2/shlr/grub/partmap/sun.c" 3 4
              )
# 139 "project/radare2/shlr/grub/partmap/sun.c"
