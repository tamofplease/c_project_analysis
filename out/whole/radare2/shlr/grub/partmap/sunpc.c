# 0 "project/radare2/shlr/grub/partmap/sunpc.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 21 "project/radare2/shlr/grub/partmap/sunpc.c" 2
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 22 "project/radare2/shlr/grub/partmap/sunpc.c" 2
...
# 23 "project/radare2/shlr/grub/partmap/sunpc.c" 2
...
# 33 "project/radare2/shlr/grub/partmap/sunpc.c"
struct grub_sun_pc_partition_descriptor { grub_uint16_t id; grub_uint16_t unused; grub_uint32_t start_sector; grub_uint32_t num_sectors; } 
# 33 "project/radare2/shlr/grub/partmap/sunpc.c" 3 4
...
# 40 "project/radare2/shlr/grub/partmap/sunpc.c"
 ;

struct grub_sun_pc_block { grub_uint8_t unused[72]; struct grub_sun_pc_partition_descriptor partitions[16]; grub_uint8_t unused2[244]; grub_uint16_t magic; grub_uint16_t csum; } 
# 42 "project/radare2/shlr/grub/partmap/sunpc.c" 3 4
__attribute__((__packed__))
...
# 50 "project/radare2/shlr/grub/partmap/sunpc.c"
 ;
         ...
         void *closure)
{
  ...
  if (0xDABE != 
# 93 "project/radare2/shlr/grub/partmap/sunpc.c" 3 4
                                  ((grub_uint16_t) (
# 93 "project/radare2/shlr/grub/partmap/sunpc.c"
                                  block.magic
# 93 "project/radare2/shlr/grub/partmap/sunpc.c" 3 4
                                  ))
# 93 "project/radare2/shlr/grub/partmap/sunpc.c"
  ...
  for (partnum = 0; partnum < 16; partnum++)
   ...
   || block.partitions[partnum].id == 0x05)
 continue;

      desc = &block.partitions[partnum];
      p->start = 
# 117 "project/radare2/shlr/grub/partmap/sunpc.c" 3 4
                ((grub_uint32_t) (
# 117 "project/radare2/shlr/grub/partmap/sunpc.c"
                desc->start_sector
# 117 "project/radare2/shlr/grub/partmap/sunpc.c" 3 4
                ))
# 117 "project/radare2/shlr/grub/partmap/sunpc.c"
                                                     ;
      p->len = 
# 118 "project/radare2/shlr/grub/partmap/sunpc.c" 3 4
              ((grub_uint32_t) (
# 118 "project/radare2/shlr/grub/partmap/sunpc.c"
              desc->num_sectors
# 118 "project/radare2/shlr/grub/partmap/sunpc.c" 3 4
              ))
# 118 "project/radare2/shlr/grub/partmap/sunpc.c"
