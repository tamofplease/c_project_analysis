# 0 "project/radare2/shlr/grub/partmap/gpt.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 21 "project/radare2/shlr/grub/partmap/gpt.c" 2
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 22 "project/radare2/shlr/grub/partmap/gpt.c" 2
...
void grub_halt (void);
# 23 "project/radare2/shlr/grub/partmap/gpt.c" 2
...
# 24 "project/radare2/shlr/grub/partmap/gpt.c" 2
...
# 25 "project/radare2/shlr/grub/partmap/gpt.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/msdos_partition.h" 1 3 4
# 20 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/msdos_partition.h" 3 4
...
struct grub_msdos_partition_entry { grub_uint8_t flag; grub_uint8_t start_head; grub_uint8_t start_sector; grub_uint8_t start_cylinder; grub_uint8_t type; grub_uint8_t end_head; grub_uint8_t end_sector; grub_uint8_t end_cylinder; grub_uint32_t start; grub_uint32_t length; } __attribute__((__packed__))
# 87 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/msdos_partition.h" 3 4
  ;


struct grub_msdos_partition_mbr { grub_uint8_t code[446]; struct grub_msdos_partition_entry entries[4]; grub_uint16_t signature; } __attribute__((__packed__))
# 101 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/msdos_partition.h" 3 4
  ;
...
# 26 "project/radare2/shlr/grub/partmap/gpt.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/gpt_partition.h" 1 3 4
# 20 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/gpt_partition.h" 3 4
#define GRUB_GPT_PARTITION_HEADER 1



struct grub_gpt_part_type { grub_uint32_t data1; grub_uint16_t data2; grub_uint16_t data3; grub_uint8_t data4[8]; } __attribute__((__packed__))
...
# 45 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/gpt_partition.h" 3 4
...
struct grub_gpt_header { grub_uint8_t magic[8]; grub_uint32_t version; grub_uint32_t headersize; grub_uint32_t crc32; grub_uint32_t unused1; grub_uint64_t primary; grub_uint64_t backup; grub_uint64_t start; grub_uint64_t end; grub_uint8_t guid[16]; grub_uint64_t partitions; grub_uint32_t maxpart; grub_uint32_t partentry_size; grub_uint32_t partentry_crc32; } __attribute__((__packed__))
# 68 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/gpt_partition.h" 3 4
  ;

struct grub_gpt_partentry { grub_gpt_part_type_t type; grub_uint8_t guid[16]; grub_uint64_t start; grub_uint64_t end; grub_uint64_t attrib; char name[72]; } __attribute__((__packed__))
# 79 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/gpt_partition.h" 3 4
  ;
# 27 "project/radare2/shlr/grub/partmap/gpt.c" 2


# 28 "project/radare2/shlr/grub/partmap/gpt.c"
...
# 33 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
                                                                 { 0x0, 0x0, 0x0, { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 } }
# 33 "project/radare2/shlr/grub/partmap/gpt.c"
                                                                                              ;
      ...
      void *closure)
{
  ...
  if (mbr.signature != 
# 59 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
                      ((grub_uint16_t) (0xaa55))
# 59 "project/radare2/shlr/grub/partmap/gpt.c"
                                                                    )
    return grub_error (GRUB_ERR_BAD_PART_TABLE, "no signature");


  if (mbr.entries[0].type != 
# 63 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
                            0xee
# 63 "project/radare2/shlr/grub/partmap/gpt.c"
                                                           )
...
# 73 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
 grub_real_dprintf("/tmp", 73, 
# 73 "project/radare2/shlr/grub/partmap/gpt.c"
 "gpt"
# 73 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
 , 
# 73 "project/radare2/shlr/grub/partmap/gpt.c"
...
# 73 "project/radare2/shlr/grub/partmap/gpt.c"
  ...
  entries = 
# 75 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
           ((grub_uint64_t) (
# 75 "project/radare2/shlr/grub/partmap/gpt.c"
           gpt.partitions
# 75 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
           ))
# 75 "project/radare2/shlr/grub/partmap/gpt.c"
                                            ;
  for (i = 0; i < 
# 76 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
                 ((grub_uint32_t) (
# 76 "project/radare2/shlr/grub/partmap/gpt.c"
                 gpt.maxpart
# 76 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
                 ))
# 76 "project/radare2/shlr/grub/partmap/gpt.c"
...
# 86 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
         __builtin___memset_chk (
# 86 "project/radare2/shlr/grub/partmap/gpt.c"
         &part
# 86 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
         , 
# 86 "project/radare2/shlr/grub/partmap/gpt.c"
         0, sizeof (struct grub_partition)
# 86 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
...
# 86 "project/radare2/shlr/grub/partmap/gpt.c"
                                                          ;
   part.start = 
# 87 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
               ((grub_uint64_t) (
# 87 "project/radare2/shlr/grub/partmap/gpt.c"
               entry.start
# 87 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
               ))
# 87 "project/radare2/shlr/grub/partmap/gpt.c"
                                             ;
   part.len = (
# 88 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
              ((grub_uint64_t) (
# 88 "project/radare2/shlr/grub/partmap/gpt.c"
              entry.end
# 88 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
              ))
        
# 89 "project/radare2/shlr/grub/partmap/gpt.c"
       - 
# 89 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
         ((grub_uint64_t) (
# 89 "project/radare2/shlr/grub/partmap/gpt.c"
         entry.start
# 89 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
...
# 96 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
  grub_real_dprintf("/tmp", 96, 
# 96 "project/radare2/shlr/grub/partmap/gpt.c"
  "gpt"
# 96 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
  , 
# 96 "project/radare2/shlr/grub/partmap/gpt.c"
...
# 97 "project/radare2/shlr/grub/partmap/gpt.c"
                                     ;
   ...
   if (hook (disk, &part, closure))
     return grub_errno;
      ...
      last_offset += 
# 103 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
                    ((grub_uint32_t) (
# 103 "project/radare2/shlr/grub/partmap/gpt.c"
                    gpt.partentry_size
# 103 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
                    ))
# 103 "project/radare2/shlr/grub/partmap/gpt.c"
                                                         ;
      if (last_offset == 
# 104 "project/radare2/shlr/grub/partmap/gpt.c" 3 4
                        0x200
# 104 "project/radare2/shlr/grub/partmap/gpt.c"
                                             ) {
   last_offset = 0;
   entries++;
 }
