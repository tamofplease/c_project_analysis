# 0 "project/radare2/shlr/grub/partmap/apple.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 21 "project/radare2/shlr/grub/partmap/apple.c" 2
...
void grub_halt (void);
# 22 "project/radare2/shlr/grub/partmap/apple.c" 2
...
# 23 "project/radare2/shlr/grub/partmap/apple.c" 2
...
# 24 "project/radare2/shlr/grub/partmap/apple.c" 2

#define GRUB_APPLE_HEADER_MAGIC 0x4552
#define GRUB_APPLE_PART_MAGIC 0x504D


# 28 "project/radare2/shlr/grub/partmap/apple.c"
        ...
        void *closure)
{
  ...
  if (
# 118 "project/radare2/shlr/grub/partmap/apple.c" 3 4
     ({ grub_uint16_t _x = (
# 118 "project/radare2/shlr/grub/partmap/apple.c"
     aheader.magic
# 118 "project/radare2/shlr/grub/partmap/apple.c" 3 4
...
# 120 "project/radare2/shlr/grub/partmap/apple.c" 3 4
     grub_real_dprintf("/tmp", 120, 
# 120 "project/radare2/shlr/grub/partmap/apple.c"
     "partition"
# 120 "project/radare2/shlr/grub/partmap/apple.c" 3 4
     , 
# 120 "project/radare2/shlr/grub/partmap/apple.c"
...
# 123 "project/radare2/shlr/grub/partmap/apple.c"
                             ;
      goto fail;
    }

  pos = 
# 127 "project/radare2/shlr/grub/partmap/apple.c" 3 4
       ({ grub_uint16_t _x = (
# 127 "project/radare2/shlr/grub/partmap/apple.c"
       aheader.blocksize
# 127 "project/radare2/shlr/grub/partmap/apple.c" 3 4
       ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 127 "project/radare2/shlr/grub/partmap/apple.c"
  ...
  do
    {
      part.offset = pos / 
# 131 "project/radare2/shlr/grub/partmap/apple.c" 3 4
                         0x200
# 131 "project/radare2/shlr/grub/partmap/apple.c"
                                              ;
      part.index = pos % 
# 132 "project/radare2/shlr/grub/partmap/apple.c" 3 4
                        0x200
# 132 "project/radare2/shlr/grub/partmap/apple.c"
                                             ;
 ...
 return grub_errno;
      ...
      if (
# 138 "project/radare2/shlr/grub/partmap/apple.c" 3 4
         ({ grub_uint16_t _x = (
# 138 "project/radare2/shlr/grub/partmap/apple.c"
         apart.magic
# 138 "project/radare2/shlr/grub/partmap/apple.c" 3 4
         ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); }) 
# 138 "project/radare2/shlr/grub/partmap/apple.c"
...
# 140 "project/radare2/shlr/grub/partmap/apple.c" 3 4
  grub_real_dprintf("/tmp", 140, 
# 140 "project/radare2/shlr/grub/partmap/apple.c"
  "partition"
# 140 "project/radare2/shlr/grub/partmap/apple.c" 3 4
  , 
# 140 "project/radare2/shlr/grub/partmap/apple.c"
...
# 143 "project/radare2/shlr/grub/partmap/apple.c"
                        ;
   break;
 }
      ...
      if (partnum == 0)
 partnum = 
# 148 "project/radare2/shlr/grub/partmap/apple.c" 3 4
          grub_swap_bytes32(
# 148 "project/radare2/shlr/grub/partmap/apple.c"
          apart.partmap_size
# 148 "project/radare2/shlr/grub/partmap/apple.c" 3 4
          )
# 148 "project/radare2/shlr/grub/partmap/apple.c"
      ...
      part.start = ((grub_disk_addr_t) 
# 150 "project/radare2/shlr/grub/partmap/apple.c" 3 4
                                      grub_swap_bytes32(
# 150 "project/radare2/shlr/grub/partmap/apple.c"
                                      apart.first_phys_block
# 150 "project/radare2/shlr/grub/partmap/apple.c" 3 4
                                      )
      
# 151 "project/radare2/shlr/grub/partmap/apple.c"
     * 
# 151 "project/radare2/shlr/grub/partmap/apple.c" 3 4
       ({ grub_uint16_t _x = (
# 151 "project/radare2/shlr/grub/partmap/apple.c"
       aheader.blocksize
# 151 "project/radare2/shlr/grub/partmap/apple.c" 3 4
...
# 151 "project/radare2/shlr/grub/partmap/apple.c"
 ...
 / 
# 152 "project/radare2/shlr/grub/partmap/apple.c" 3 4
  0x200
# 152 "project/radare2/shlr/grub/partmap/apple.c"
                       ;
      part.len = ((grub_disk_addr_t) 
# 153 "project/radare2/shlr/grub/partmap/apple.c" 3 4
                                    grub_swap_bytes32(
# 153 "project/radare2/shlr/grub/partmap/apple.c"
                                    apart.blockcnt
# 153 "project/radare2/shlr/grub/partmap/apple.c" 3 4
                                    )
    
# 154 "project/radare2/shlr/grub/partmap/apple.c"
   * 
# 154 "project/radare2/shlr/grub/partmap/apple.c" 3 4
     ({ grub_uint16_t _x = (
# 154 "project/radare2/shlr/grub/partmap/apple.c"
     aheader.blocksize
# 154 "project/radare2/shlr/grub/partmap/apple.c" 3 4
...
# 154 "project/radare2/shlr/grub/partmap/apple.c"
 ...
 / 
# 155 "project/radare2/shlr/grub/partmap/apple.c" 3 4
  0x200
# 155 "project/radare2/shlr/grub/partmap/apple.c"
                       ;
      part.offset = pos;
      part.index = partno;
      part.number = partno;
...
# 160 "project/radare2/shlr/grub/partmap/apple.c" 3 4
     grub_real_dprintf("/tmp", 160, 
# 160 "project/radare2/shlr/grub/partmap/apple.c"
     "partition"
# 160 "project/radare2/shlr/grub/partmap/apple.c" 3 4
     , 
# 160 "project/radare2/shlr/grub/partmap/apple.c"
...
# 164 "project/radare2/shlr/grub/partmap/apple.c"
                                       ;
 ...
 return grub_errno;
      ...
      pos += 
# 169 "project/radare2/shlr/grub/partmap/apple.c" 3 4
            ({ grub_uint16_t _x = (
# 169 "project/radare2/shlr/grub/partmap/apple.c"
            aheader.blocksize
# 169 "project/radare2/shlr/grub/partmap/apple.c" 3 4
            ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 169 "project/radare2/shlr/grub/partmap/apple.c"
