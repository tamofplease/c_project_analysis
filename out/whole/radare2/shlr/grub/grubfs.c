# 0 "project/radare2/shlr/grub/grubfs.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/grub/grubfs.c"
...
# 4 "project/radare2/shlr/grub/grubfs.c" 2
...
# 5 "project/radare2/shlr/grub/grubfs.c" 2
...
# 6 "project/radare2/shlr/grub/grubfs.c" 2





# 10 "project/radare2/shlr/grub/grubfs.c"
static RIOBind *bio = 
# 10 "project/radare2/shlr/grub/grubfs.c" 3 4
                     ((void *)0)
# 10 "project/radare2/shlr/grub/grubfs.c"
                         ;
static 
# 11 "project/radare2/shlr/grub/grubfs.c" 3 4
      unsigned long long 
# 11 "project/radare2/shlr/grub/grubfs.c"
           delta = 0;

static void* empty (int sz) {
 void *p = malloc (sz);
 if (p) 
# 15 "project/radare2/shlr/grub/grubfs.c" 3 4
       __builtin___memset_chk (
# 15 "project/radare2/shlr/grub/grubfs.c"
       p
# 15 "project/radare2/shlr/grub/grubfs.c" 3 4
       , 
# 15 "project/radare2/shlr/grub/grubfs.c"
...
# 21 "project/radare2/shlr/grub/grubfs.c" 3 4
 fprintf(__stderrp,
# 21 "project/radare2/shlr/grub/grubfs.c"
 "oops. no disk\n"
# 21 "project/radare2/shlr/grub/grubfs.c" 3 4
 )
# 21 "project/radare2/shlr/grub/grubfs.c"
 ...
 return !iob->read_at (iob->io, delta+(blocksize*sector), (
# 30 "project/radare2/shlr/grub/grubfs.c" 3 4
                                                          unsigned char
# 30 "project/radare2/shlr/grub/grubfs.c"
                                                             *)buf, size*blocksize);
}
...
# 67 "project/radare2/shlr/grub/grubfs.c" 3 4
                                  unsigned long long 
# 67 "project/radare2/shlr/grub/grubfs.c"
                                       _delta) {
 bio = iob;
 delta = _delta;
}
