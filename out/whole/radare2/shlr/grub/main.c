# 0 "project/radare2/shlr/grub/main.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
grub_ssize_t grub_file_pb_read (grub_file_t file, void *buf, grub_size_t len,
    int total);
# 2 "project/radare2/shlr/grub/main.c" 2
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 3 "project/radare2/shlr/grub/main.c" 2
...
# 10 "project/radare2/shlr/grub/main.c"
...
grub_err_t read_foo (struct grub_disk *disk, grub_disk_addr_t sector, grub_size_t size, char *buf) {
 ...
 size=512;
 {
  ...
  if (fd) {
   fseek (fd, (512*sector), 
# 21 "project/radare2/shlr/grub/main.c" 3 4
                           0
# 21 "project/radare2/shlr/grub/main.c"
                                   );
   fread (buf, 1, size, fd);

   fclose (fd);
  } else printf ("Cannot open ""/tmp/test.fs.img""\n");
 }
 return 0;
}
...
void read_hook (grub_disk_addr_t sector, unsigned long offset, unsigned long length, unsigned char *buf) {
...

 {
  ...
  FILE *fd = fopen("/tmp/test.fs.img", "rb");
  if (fd) {
   fseek (fd, (512*sector)+offset, 
# 37 "project/radare2/shlr/grub/main.c" 3 4
                                  0
# 37 "project/radare2/shlr/grub/main.c"
                                          );
   fread (buf, 1, size, fd);
...
# 49 "project/radare2/shlr/grub/main.c" 3 4
__builtin___memset_chk (
# 49 "project/radare2/shlr/grub/main.c"
file->device
# 49 "project/radare2/shlr/grub/main.c" 3 4
, 
# 49 "project/radare2/shlr/grub/main.c"
...
# 51 "project/radare2/shlr/grub/main.c" 3 4
__builtin___memset_chk (
# 51 "project/radare2/shlr/grub/main.c"
file->device->disk
# 51 "project/radare2/shlr/grub/main.c" 3 4
, 
# 51 "project/radare2/shlr/grub/main.c"
...
# 51 "project/radare2/shlr/grub/main.c"
 ...
 file->fs = fs;
# 75 "project/radare2/shlr/grub/main.c"
 return file;
}
...
int do_main() {
 ...
 if (file == 
# 93 "project/radare2/shlr/grub/main.c" 3 4
            ((void *)0)
# 93 "project/radare2/shlr/grub/main.c"
                ) {
  printf ("oops\n");
  return 0;
 }
...
# 3 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grubfs.h" 3 4
...
# 6 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grubfs.h" 2 3 4
...
# 119 "project/radare2/shlr/grub/main.c" 2

# 119 "project/radare2/shlr/grub/main.c"
int foo_main() {
 char buf[1024];
 GrubFS *gfs = grubfs_new (&grub_ext2_fs, 
# 121 "project/radare2/shlr/grub/main.c" 3 4
                                         ((void *)0)
# 121 "project/radare2/shlr/grub/main.c"
                                             );
