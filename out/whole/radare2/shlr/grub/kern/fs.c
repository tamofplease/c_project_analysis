# 0 "project/radare2/shlr/grub/kern/fs.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/grub/kern/fs.c"
# 20 "project/radare2/shlr/grub/kern/fs.c"
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 21 "project/radare2/shlr/grub/kern/fs.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/net.h" 1 3 4
# 20 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/net.h" 3 4
...
# 22 "project/radare2/shlr/grub/kern/fs.c" 2
...
# 23 "project/radare2/shlr/grub/kern/fs.c" 2
...
grub_ssize_t grub_file_pb_read (grub_file_t file, void *buf, grub_size_t len,
    int total);
# 24 "project/radare2/shlr/grub/kern/fs.c" 2
...
# 28 "project/radare2/shlr/grub/kern/fs.c" 2
# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/term.h" 1 3 4
# 22 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/term.h" 3 4
...
# 29 "project/radare2/shlr/grub/kern/fs.c" 2
...
# 30 "project/radare2/shlr/grub/kern/fs.c" 2


# 31 "project/radare2/shlr/grub/kern/fs.c"
                                 ;
;
;
;
...
# 61 "project/radare2/shlr/grub/kern/fs.c" 3 4
  grub_real_dprintf("/tmp", 61, 
# 61 "project/radare2/shlr/grub/kern/fs.c"
  "fs"
# 61 "project/radare2/shlr/grub/kern/fs.c" 3 4
  , 
# 61 "project/radare2/shlr/grub/kern/fs.c"
...
# 67 "project/radare2/shlr/grub/kern/fs.c" 3 4
  grub_real_dprintf("/tmp", 67, 
# 67 "project/radare2/shlr/grub/kern/fs.c"
  "fs"
# 67 "project/radare2/shlr/grub/kern/fs.c" 3 4
  , 
# 67 "project/radare2/shlr/grub/kern/fs.c"
...
grub_fs_blocklist_open (grub_file_t file, const char *name)
{
 ...
 p++;
  ...
  if (! *p)
    {
      blocks[0].offset = 0;
      blocks[0].length = (disk->total_sectors == 
# 150 "project/radare2/shlr/grub/kern/fs.c" 3 4
                                                4294967295UL
# 150 "project/radare2/shlr/grub/kern/fs.c"
                                                              ) ?
 
# 151 "project/radare2/shlr/grub/kern/fs.c" 3 4
4294967295UL 
# 151 "project/radare2/shlr/grub/kern/fs.c"
               : (disk->total_sectors << 9);
      ...
      if (disk->total_sectors < blocks[i].offset + blocks[i].length)
 {
   ...
   goto fail;
      ...
      blocks[i].offset <<= 
# 184 "project/radare2/shlr/grub/kern/fs.c" 3 4
                          9
# 184 "project/radare2/shlr/grub/kern/fs.c"
                                               ;
      blocks[i].length <<= 
# 185 "project/radare2/shlr/grub/kern/fs.c" 3 4
                          9
# 185 "project/radare2/shlr/grub/kern/fs.c"
                                               ;
  ...
  unsigned length, void *closure)
{
  ...
  sector = ((sector - c->part_start) << 
# 280 "project/radare2/shlr/grub/kern/fs.c" 3 4
                                       9
# 280 "project/radare2/shlr/grub/kern/fs.c"
                                                            ) + offset;
  ...
  if ((c->num & (8 - 1)) == 0)
    {
      c->blocks = grub_realloc (c->blocks, (c->num + 8) *
