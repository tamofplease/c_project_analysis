# 0 "project/radare2/shlr/grub/kern/disk.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/grub/kern/disk.c"
# 19 "project/radare2/shlr/grub/kern/disk.c"
...
# 23 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/disk.h" 2 3 4
...
# 24 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/disk.h" 2 3 4
...
# 25 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/disk.h" 2 3 4
...
int grub_device_iterate (int (*hook) (const char *name, void *closure),
    void *closure);
# 26 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/disk.h" 2 3 4
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 20 "project/radare2/shlr/grub/kern/disk.c" 2
...
# 22 "project/radare2/shlr/grub/kern/disk.c" 2
...
# 23 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/partition.h" 2 3 4
...
# 24 "project/radare2/shlr/grub/kern/disk.c" 2

# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/time.h" 1 3 4
# 20 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/time.h" 3 4
#define KERNEL_TIME_HEADER 1



# 1 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/cpu/time.h" 1 3 4
# 20 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/cpu/time.h" 3 4
...
# 25 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/time.h" 2 3 4
# 36 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/time.h" 3 4
...
# 26 "project/radare2/shlr/grub/kern/disk.c" 2
...
grub_ssize_t grub_file_pb_read (grub_file_t file, void *buf, grub_size_t len,
    int total);
# 27 "project/radare2/shlr/grub/kern/disk.c" 2


# 28 "project/radare2/shlr/grub/kern/disk.c"
                                  ;
;
;
...
static struct grub_disk_cache grub_disk_cache_table[
# 60 "project/radare2/shlr/grub/kern/disk.c" 3 4
                                                   1021
# 60 "project/radare2/shlr/grub/kern/disk.c"
                                                                      ];
...
grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 81 "project/radare2/shlr/grub/kern/disk.c"
static unsigned
      ...
      grub_disk_addr_t sector)
{
  return ((dev_id * 524287UL + disk_id * 2606459UL
    + ((unsigned) (sector >> 
# 86 "project/radare2/shlr/grub/kern/disk.c" 3 4
                            3
# 86 "project/radare2/shlr/grub/kern/disk.c"
                                                )))
   % 
# 87 "project/radare2/shlr/grub/kern/disk.c" 3 4
    1021
# 87 "project/radare2/shlr/grub/kern/disk.c"
                       );
}
       ...
       grub_disk_addr_t sector)
{
  ...
  sector &= ~(
# 97 "project/radare2/shlr/grub/kern/disk.c" 3 4
             8 
# 97 "project/radare2/shlr/grub/kern/disk.c"
                                  - 1);
...
grub_disk_cache_invalidate_all (void)
{
  ...
  for (i = 0; i < 
# 116 "project/radare2/shlr/grub/kern/disk.c" 3 4
                 1021
# 116 "project/radare2/shlr/grub/kern/disk.c"
                                    ; i++)
    {
         ...
         grub_disk_addr_t sector, const char *data)
{
  ...
  cache->data = grub_malloc (
# 185 "project/radare2/shlr/grub/kern/disk.c" 3 4
                            0x200 
# 185 "project/radare2/shlr/grub/kern/disk.c"
                                                  << 
# 185 "project/radare2/shlr/grub/kern/disk.c" 3 4
                                                     3
# 185 "project/radare2/shlr/grub/kern/disk.c"
...
# 189 "project/radare2/shlr/grub/kern/disk.c" 3 4
 grub_memmove ((
# 189 "project/radare2/shlr/grub/kern/disk.c"
 cache->data
# 189 "project/radare2/shlr/grub/kern/disk.c" 3 4
 ), (
# 189 "project/radare2/shlr/grub/kern/disk.c"
...
# 190 "project/radare2/shlr/grub/kern/disk.c"
                                                     ;
  cache->dev_id = dev_id;
...
find_part_sep (const char *name)
{
 ...
 return p - 1;
  ...
  return 
# 250 "project/radare2/shlr/grub/kern/disk.c" 3 4
        ((void *)0)
# 250 "project/radare2/shlr/grub/kern/disk.c"
            ;
}
...
# 262 "project/radare2/shlr/grub/kern/disk.c" 3 4
 grub_real_dprintf("/tmp", 262, 
# 262 "project/radare2/shlr/grub/kern/disk.c"
 "disk"
# 262 "project/radare2/shlr/grub/kern/disk.c" 3 4
 , 
# 262 "project/radare2/shlr/grub/kern/disk.c"
...
# 281 "project/radare2/shlr/grub/kern/disk.c" 3 4
     grub_memmove ((
# 281 "project/radare2/shlr/grub/kern/disk.c"
     raw
# 281 "project/radare2/shlr/grub/kern/disk.c" 3 4
     ), (
# 281 "project/radare2/shlr/grub/kern/disk.c"
...
# 337 "project/radare2/shlr/grub/kern/disk.c" 3 4
     grub_real_dprintf("/tmp", 337, 
# 337 "project/radare2/shlr/grub/kern/disk.c"
     "disk"
# 337 "project/radare2/shlr/grub/kern/disk.c" 3 4
     , 
# 337 "project/radare2/shlr/grub/kern/disk.c"
...
# 351 "project/radare2/shlr/grub/kern/disk.c" 3 4
 grub_real_dprintf("/tmp", 351, 
# 351 "project/radare2/shlr/grub/kern/disk.c"
 "disk"
# 351 "project/radare2/shlr/grub/kern/disk.c" 3 4
 , 
# 351 "project/radare2/shlr/grub/kern/disk.c"
...
{
  *sector += *offset >> 
# 377 "project/radare2/shlr/grub/kern/disk.c" 3 4
                       9
# 377 "project/radare2/shlr/grub/kern/disk.c"
                                            ;
  *offset &= 
# 378 "project/radare2/shlr/grub/kern/disk.c" 3 4
            0x200 
# 378 "project/radare2/shlr/grub/kern/disk.c"
                                  - 1;
# 402 "project/radare2/shlr/grub/kern/disk.c"
  return GRUB_ERR_NONE;
...
# 421 "project/radare2/shlr/grub/kern/disk.c" 3 4
     grub_real_dprintf("/tmp", 421, 
# 421 "project/radare2/shlr/grub/kern/disk.c"
     "disk"
# 421 "project/radare2/shlr/grub/kern/disk.c" 3 4
     , 
# 421 "project/radare2/shlr/grub/kern/disk.c"
...
# 422 "project/radare2/shlr/grub/kern/disk.c"
                                              ;
      grub_error_pop ();
      return grub_errno;
    }
  ...
  tmp_buf = grub_malloc (
# 430 "project/radare2/shlr/grub/kern/disk.c" 3 4
                        0x200 
# 430 "project/radare2/shlr/grub/kern/disk.c"
                                              << 
# 430 "project/radare2/shlr/grub/kern/disk.c" 3 4
                                                 3
# 430 "project/radare2/shlr/grub/kern/disk.c"
  ...
  while (size)
    {
      ...
      start_sector = sector & ~(
# 444 "project/radare2/shlr/grub/kern/disk.c" 3 4
                               8 
# 444 "project/radare2/shlr/grub/kern/disk.c"
                                                    - 1);
      pos = (sector - start_sector) << 
# 445 "project/radare2/shlr/grub/kern/disk.c" 3 4
                                      9
# 445 "project/radare2/shlr/grub/kern/disk.c"
                                                           ;
      len = ((
# 446 "project/radare2/shlr/grub/kern/disk.c" 3 4
             0x200 
# 446 "project/radare2/shlr/grub/kern/disk.c"
                                   << 
# 446 "project/radare2/shlr/grub/kern/disk.c" 3 4
                                      3
# 446 "project/radare2/shlr/grub/kern/disk.c"
...
# 462 "project/radare2/shlr/grub/kern/disk.c" 3 4
    grub_memmove ((
# 462 "project/radare2/shlr/grub/kern/disk.c"
    buf
# 462 "project/radare2/shlr/grub/kern/disk.c" 3 4
    ), (
# 462 "project/radare2/shlr/grub/kern/disk.c"
    data + pos + real_offset
# 462 "project/radare2/shlr/grub/kern/disk.c" 3 4
    ), (
# 462 "project/radare2/shlr/grub/kern/disk.c"
    len
...
# 462 "project/radare2/shlr/grub/kern/disk.c"
      ...
      else
 {
   ...
   if (start_sector + 
# 469 "project/radare2/shlr/grub/kern/disk.c" 3 4
                     8 
# 469 "project/radare2/shlr/grub/kern/disk.c"
                                          > disk->total_sectors
       || (disk->dev->read) (disk, start_sector,
        
# 471 "project/radare2/shlr/grub/kern/disk.c" 3 4
       8
# 471 "project/radare2/shlr/grub/kern/disk.c"
                           , tmp_buf)
       != GRUB_ERR_NONE)
     {
       ...
       num = ((size + real_offset + 
# 480 "project/radare2/shlr/grub/kern/disk.c" 3 4
                                   0x200 
# 480 "project/radare2/shlr/grub/kern/disk.c"
                                                         - 1)
       >> 
# 481 "project/radare2/shlr/grub/kern/disk.c" 3 4
         9
# 481 "project/radare2/shlr/grub/kern/disk.c"
                              );

       p = grub_realloc (tmp_buf, num << 
# 483 "project/radare2/shlr/grub/kern/disk.c" 3 4
                                        9
# 483 "project/radare2/shlr/grub/kern/disk.c"
                                                             );
       if (!p)
  goto finish;
...
# 492 "project/radare2/shlr/grub/kern/disk.c" 3 4
   grub_real_dprintf("/tmp", 492, 
# 492 "project/radare2/shlr/grub/kern/disk.c"
   "disk"
# 492 "project/radare2/shlr/grub/kern/disk.c" 3 4
   , 
# 492 "project/radare2/shlr/grub/kern/disk.c"
...
# 498 "project/radare2/shlr/grub/kern/disk.c" 3 4
 grub_memmove ((
# 498 "project/radare2/shlr/grub/kern/disk.c"
 buf
# 498 "project/radare2/shlr/grub/kern/disk.c" 3 4
 ), (
# 498 "project/radare2/shlr/grub/kern/disk.c"
  ...
  while (size)
    {
      ...
      to_read = size;
      if (real_offset + to_read > 
# 507 "project/radare2/shlr/grub/kern/disk.c" 3 4
                                 0x200
# 507 "project/radare2/shlr/grub/kern/disk.c"
                                                      )
        to_read = 
# 508 "project/radare2/shlr/grub/kern/disk.c" 3 4
                 0x200 
# 508 "project/radare2/shlr/grub/kern/disk.c"
                                       - real_offset;
...
# 525 "project/radare2/shlr/grub/kern/disk.c" 3 4
    grub_memmove ((
# 525 "project/radare2/shlr/grub/kern/disk.c"
    buf
# 525 "project/radare2/shlr/grub/kern/disk.c" 3 4
    ), (
# 525 "project/radare2/shlr/grub/kern/disk.c"
    tmp_buf + pos + real_offset
# 525 "project/radare2/shlr/grub/kern/disk.c" 3 4
    ), (
# 525 "project/radare2/shlr/grub/kern/disk.c"
    len
...
# 525 "project/radare2/shlr/grub/kern/disk.c"
      ...
      if (disk->read_hook)
 {
   ...
   while (l)
     ...
     ((l > 
# 539 "project/radare2/shlr/grub/kern/disk.c" 3 4
          0x200
# 539 "project/radare2/shlr/grub/kern/disk.c"
                               )
      ? 
# 540 "project/radare2/shlr/grub/kern/disk.c" 3 4
       0x200
      
# 541 "project/radare2/shlr/grub/kern/disk.c"
     : l), disk->closure);

       if (l < 
# 543 "project/radare2/shlr/grub/kern/disk.c" 3 4
              0x200 
# 543 "project/radare2/shlr/grub/kern/disk.c"
                                    - real_offset)
  break;

       s++;
       l -= 
# 547 "project/radare2/shlr/grub/kern/disk.c" 3 4
           0x200 
# 547 "project/radare2/shlr/grub/kern/disk.c"
                                 - real_offset;
       real_offset = 0;
     }
 }
      ...
      sector = start_sector + 
# 552 "project/radare2/shlr/grub/kern/disk.c" 3 4
                             8
# 552 "project/radare2/shlr/grub/kern/disk.c"
                                                 ;
      if (buf)
 buf = (char *) buf + len;
      size -= len;
     ...
     grub_off_t offset, grub_size_t size, void *buf, int flags)
{
  ...
  while (size)
    {
      char tmp_buf[
# 581 "project/radare2/shlr/grub/kern/disk.c" 3 4
                  0x200
# 581 "project/radare2/shlr/grub/kern/disk.c"
                                       ];
      grub_size_t len;

      if ((real_offset != 0) || (size < 
# 584 "project/radare2/shlr/grub/kern/disk.c" 3 4
                                       0x200
# 584 "project/radare2/shlr/grub/kern/disk.c"
                                                            ))
 {
   len = 
# 586 "project/radare2/shlr/grub/kern/disk.c" 3 4
        0x200 
# 586 "project/radare2/shlr/grub/kern/disk.c"
                              - real_offset;
   if (len > size)
     len = size;
...
# 594 "project/radare2/shlr/grub/kern/disk.c" 3 4
      grub_memmove ((
# 594 "project/radare2/shlr/grub/kern/disk.c"
      buf
# 594 "project/radare2/shlr/grub/kern/disk.c" 3 4
      ), (
# 594 "project/radare2/shlr/grub/kern/disk.c"
...
# 594 "project/radare2/shlr/grub/kern/disk.c"
      ...
      else
 {
   ...
   len = size & ~(
# 607 "project/radare2/shlr/grub/kern/disk.c" 3 4
                 0x200 
# 607 "project/radare2/shlr/grub/kern/disk.c"
                                       - 1);
   n = size >> 
# 608 "project/radare2/shlr/grub/kern/disk.c" 3 4
              9
# 608 "project/radare2/shlr/grub/kern/disk.c"
                                   ;
   ...
   if (disk->read_hook)
     {
       while (n)
  {
    (disk->read_hook) (sector++, 0, 
# 618 "project/radare2/shlr/grub/kern/disk.c" 3 4
                                   0x200
# 618 "project/radare2/shlr/grub/kern/disk.c"
                                                        ,
         disk->closure);
    n--;
  }
...
# 641 "project/radare2/shlr/grub/kern/disk.c" 3 4
 grub_real_dprintf("/tmp", 641, 
# 641 "project/radare2/shlr/grub/kern/disk.c"
 "disk"
# 641 "project/radare2/shlr/grub/kern/disk.c" 3 4
 , 
# 641 "project/radare2/shlr/grub/kern/disk.c"
...
# 641 "project/radare2/shlr/grub/kern/disk.c"
  ...
  while (size)
    {
      if (real_offset != 0 || (size < 
# 650 "project/radare2/shlr/grub/kern/disk.c" 3 4
                                     0x200 
# 650 "project/radare2/shlr/grub/kern/disk.c"
                                                           && size != 0))
 {
   char tmp_buf[
# 652 "project/radare2/shlr/grub/kern/disk.c" 3 4
               0x200
# 652 "project/radare2/shlr/grub/kern/disk.c"
                                    ];
   grub_size_t len;
   grub_partition_t part;
   ...
   part = disk->partition;
   disk->partition = 0;
   if (grub_disk_read (disk, sector, 0, 
# 658 "project/radare2/shlr/grub/kern/disk.c" 3 4
                                       0x200
# 658 "project/radare2/shlr/grub/kern/disk.c"
                                                            , tmp_buf)
       != GRUB_ERR_NONE)
     {
       disk->partition = part;
   ...
   len = 
# 666 "project/radare2/shlr/grub/kern/disk.c" 3 4
        0x200 
# 666 "project/radare2/shlr/grub/kern/disk.c"
                              - real_offset;
   if (len > size)
     len = size;

   
# 670 "project/radare2/shlr/grub/kern/disk.c" 3 4
  grub_memmove ((
# 670 "project/radare2/shlr/grub/kern/disk.c"
  tmp_buf + real_offset
# 670 "project/radare2/shlr/grub/kern/disk.c" 3 4
  ), (
# 670 "project/radare2/shlr/grub/kern/disk.c"
...
# 670 "project/radare2/shlr/grub/kern/disk.c"
      ...
      else
 {
   ...
   len = size & ~(
# 687 "project/radare2/shlr/grub/kern/disk.c" 3 4
                 0x200 
# 687 "project/radare2/shlr/grub/kern/disk.c"
                                       - 1);
   n = size >> 
# 688 "project/radare2/shlr/grub/kern/disk.c" 3 4
              9
# 688 "project/radare2/shlr/grub/kern/disk.c"
                                   ;
