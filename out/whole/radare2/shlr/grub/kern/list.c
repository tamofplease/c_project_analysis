# 0 "project/radare2/shlr/grub/kern/list.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 21 "project/radare2/shlr/grub/kern/list.c" 2
...
# 23 "project/radare2/shlr/grub/kern/list.c" 2


# 24 "project/radare2/shlr/grub/kern/list.c"
                          ;
;
;
;
       ...
       void *closure)
{
  ...
  if (new_item->prio >= (item->prio & 
# 120 "project/radare2/shlr/grub/kern/list.c" 3 4
                                     0xff
# 120 "project/radare2/shlr/grub/kern/list.c"
                                                             ))
    {
      item->prio &= ~
# 122 "project/radare2/shlr/grub/kern/list.c" 3 4
                    0x100
# 122 "project/radare2/shlr/grub/kern/list.c"
                                              ;
      return 1;
    }
...
grub_prio_list_insert (grub_prio_list_t *head, grub_prio_list_t nitem)
{
  ...
  c.inactive = 0;
  grub_list_insert (
# 136 "project/radare2/shlr/grub/kern/list.c" 3 4
                   (((char *) &(*
# 136 "project/radare2/shlr/grub/kern/list.c"
                   head
# 136 "project/radare2/shlr/grub/kern/list.c" 3 4
                   )->next == (char *) &((grub_list_t) (*
# 136 "project/radare2/shlr/grub/kern/list.c"
                   head
# 136 "project/radare2/shlr/grub/kern/list.c" 3 4
                   ))->next) ? (grub_list_t *) (void *) 
# 136 "project/radare2/shlr/grub/kern/list.c"
                   head 
# 136 "project/radare2/shlr/grub/kern/list.c" 3 4
                   : grub_bad_type_cast_real(136, "/tmp"))
# 136 "project/radare2/shlr/grub/kern/list.c"
                                        , 
# 136 "project/radare2/shlr/grub/kern/list.c" 3 4
                                          (((char *) &(
...
# 136 "project/radare2/shlr/grub/kern/list.c"
  ...
  if (! c.inactive)
    nitem->prio |= 
# 139 "project/radare2/shlr/grub/kern/list.c" 3 4
                  0x100
# 139 "project/radare2/shlr/grub/kern/list.c"
                                            ;
}
