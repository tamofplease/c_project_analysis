# 0 "project/radare2/shlr/grub/kern/device.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 24 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/device.h" 2 3 4
...
# 25 "/Users/washi38/University/Labo/c_project_analysis/project/radare2/shlr/grub/include/grub/device.h" 2 3 4
...
int grub_device_iterate (int (*hook) (const char *name, void *closure),
    void *closure);
# 21 "project/radare2/shlr/grub/kern/device.c" 2
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 22 "project/radare2/shlr/grub/kern/device.c" 2
...
# 23 "project/radare2/shlr/grub/kern/device.c" 2
...
# 24 "project/radare2/shlr/grub/kern/device.c" 2
...
# 25 "project/radare2/shlr/grub/kern/device.c" 2
...
# 27 "project/radare2/shlr/grub/kern/device.c" 2
...
# 28 "project/radare2/shlr/grub/kern/device.c" 2


# 29 "project/radare2/shlr/grub/kern/device.c"
                            ;
;
;
  ...
  if (dev->disk && dev->disk->has_partitions)
    {
      ...
      c->ents = 
# 150 "project/radare2/shlr/grub/kern/device.c" 3 4
               ((void *)0)
# 150 "project/radare2/shlr/grub/kern/device.c"
                   ;
      ...
      p = c->ents;
      while (p != 
# 157 "project/radare2/shlr/grub/kern/device.c" 3 4
                 ((void *)0)
# 157 "project/radare2/shlr/grub/kern/device.c"
                     )
 {
