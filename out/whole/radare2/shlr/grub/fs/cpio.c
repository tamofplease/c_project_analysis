# 0 "project/radare2/shlr/grub/fs/cpio.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/grub/fs/cpio.c"
...
# 29 "project/radare2/shlr/grub/fs/cpio.c"
struct head { grub_uint16_t magic; grub_uint16_t dev; grub_uint16_t ino; grub_uint16_t mode; grub_uint16_t uid; grub_uint16_t gid; grub_uint16_t nlink; grub_uint16_t rdev; grub_uint16_t mtime_1; grub_uint16_t mtime_2; grub_uint16_t namesize; grub_uint16_t filesize_1; grub_uint16_t filesize_2; } 
# 29 "project/radare2/shlr/grub/fs/cpio.c" 3 4
__attribute__((__packed__))
# 45 "project/radare2/shlr/grub/fs/cpio.c"
  ;
...
{
  if (head->magic != 070707)
    {
      head->magic = 
# 87 "project/radare2/shlr/grub/fs/cpio.c" 3 4
                   ({ grub_uint16_t _x = (
# 87 "project/radare2/shlr/grub/fs/cpio.c"
                   head->magic
# 87 "project/radare2/shlr/grub/fs/cpio.c" 3 4
...
# 87 "project/radare2/shlr/grub/fs/cpio.c"
                                                  ;
      head->namesize = 
# 88 "project/radare2/shlr/grub/fs/cpio.c" 3 4
                      ({ grub_uint16_t _x = (
# 88 "project/radare2/shlr/grub/fs/cpio.c"
                      head->namesize
# 88 "project/radare2/shlr/grub/fs/cpio.c" 3 4
                      ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 88 "project/radare2/shlr/grub/fs/cpio.c"
                                                        ;
      head->filesize_1 = 
# 89 "project/radare2/shlr/grub/fs/cpio.c" 3 4
                        ({ grub_uint16_t _x = (
# 89 "project/radare2/shlr/grub/fs/cpio.c"
                        head->filesize_1
# 89 "project/radare2/shlr/grub/fs/cpio.c" 3 4
                        ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 89 "project/radare2/shlr/grub/fs/cpio.c"
                                                            ;
      head->filesize_2 = 
# 90 "project/radare2/shlr/grub/fs/cpio.c" 3 4
                        ({ grub_uint16_t _x = (
# 90 "project/radare2/shlr/grub/fs/cpio.c"
                        head->filesize_2
# 90 "project/radare2/shlr/grub/fs/cpio.c" 3 4
                        ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 90 "project/radare2/shlr/grub/fs/cpio.c"
...
# 116 "project/radare2/shlr/grub/fs/cpio.c" 3 4
                                                ((void *)0)
# 116 "project/radare2/shlr/grub/fs/cpio.c"
                                                    )
 return grub_errno;
   ...
   *ofs = 0;
   return GRUB_ERR_NONE;
      ...
      *ofs = data->dofs + data->size;
      if (data->size & 1)
 (*ofs)++;
# 161 "project/radare2/shlr/grub/fs/cpio.c"
  return GRUB_ERR_NONE;
}
