# 0 "project/radare2/shlr/grub/fs/ufs.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/grub/fs/ufs.c"
# 20 "project/radare2/shlr/grub/fs/ufs.c"
...
# 21 "project/radare2/shlr/grub/fs/ufs.c" 2
...
grub_ssize_t grub_file_pb_read (grub_file_t file, void *buf, grub_size_t len,
    int total);
# 22 "project/radare2/shlr/grub/fs/ufs.c" 2
...
# 23 "project/radare2/shlr/grub/fs/ufs.c" 2
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 25 "project/radare2/shlr/grub/fs/ufs.c" 2
...
#define INODE_DIRBLOCKS(data,blk) INODE_ENDIAN (data,blocks.dir_blocks[blk],32,64)

#define INODE_INDIRBLOCKS(data,blk) INODE_ENDIAN (data,blocks.indir_blocks[blk],32,64)




# 79 "project/radare2/shlr/grub/fs/ufs.c"
...
# 165 "project/radare2/shlr/grub/fs/ufs.c"
struct grub_ufs_inode { grub_uint16_t mode; grub_uint16_t nlinks; grub_uint16_t uid; grub_uint16_t gid; grub_int64_t size; grub_uint64_t atime; grub_uint64_t mtime; grub_uint64_t ctime; union { struct { grub_uint32_t dir_blocks[12]; grub_uint32_t indir_blocks[3]; } blocks; grub_uint8_t symlink[(12 + 3) * 4]; }; grub_uint32_t flags; grub_uint32_t nblocks; grub_uint32_t gen; grub_uint32_t unused; grub_uint8_t pad[12]; } 
# 165 "project/radare2/shlr/grub/fs/ufs.c" 3 4
__attribute__((__packed__))
# 190 "project/radare2/shlr/grub/fs/ufs.c"
  ;




# 194 "project/radare2/shlr/grub/fs/ufs.c"
struct grub_ufs_dirent { grub_uint32_t ino; grub_uint16_t direntlen; union { grub_uint16_t namelen; struct { grub_uint8_t filetype_bsd; grub_uint8_t namelen_bsd; }; }; } 
# 194 "project/radare2/shlr/grub/fs/ufs.c" 3 4
__attribute__((__packed__))
# 208 "project/radare2/shlr/grub/fs/ufs.c"
  ;



# 211 "project/radare2/shlr/grub/fs/ufs.c"
...
{
  return (be) ? 
# 224 "project/radare2/shlr/grub/fs/ufs.c" 3 4
               grub_swap_bytes32(
# 224 "project/radare2/shlr/grub/fs/ufs.c"
               num
# 224 "project/radare2/shlr/grub/fs/ufs.c" 3 4
               ) 
# 224 "project/radare2/shlr/grub/fs/ufs.c"
...
{
  return (be) ? 
# 230 "project/radare2/shlr/grub/fs/ufs.c" 3 4
               ({ grub_uint16_t _x = (
# 230 "project/radare2/shlr/grub/fs/ufs.c"
               num
# 230 "project/radare2/shlr/grub/fs/ufs.c" 3 4
...
{
  return (be) ? 
# 236 "project/radare2/shlr/grub/fs/ufs.c" 3 4
               grub_swap_bytes64(
# 236 "project/radare2/shlr/grub/fs/ufs.c"
               num
# 236 "project/radare2/shlr/grub/fs/ufs.c" 3 4
               ) 
# 236 "project/radare2/shlr/grub/fs/ufs.c"
...
{
  int blksz = (grub_num_to_cpu32 (data->sblock.bsize, data->be));
  unsigned int indirsz;
  int log2_blksz;


  if (blk < 12)
    return grub_num_to_cpu32 (data->inode.blocks.dir_blocks[blk], data->be);
  ...
  if (blk < indirsz)
    {
# 271 "project/radare2/shlr/grub/fs/ufs.c"
   grub_uint32_t indir[blksz / sizeof (grub_uint32_t)];




   grub_disk_read (data->disk, grub_num_to_cpu32 (data->inode.blocks.indir_blocks[0], data->be) << log2_blksz,
  ...
  if (blk < indirsz * indirsz)
    {
# 293 "project/radare2/shlr/grub/fs/ufs.c"
   grub_uint32_t indir[blksz / sizeof (grub_uint32_t)];
      ...
      grub_disk_read (data->disk, grub_num_to_cpu32 (data->inode.blocks.indir_blocks[1], data->be) << log2_blksz,
        0, sizeof (indir), indir);
      ...
      int pos, grub_size_t len, char *buf)
{
  ...
  if (len + pos > grub_num_to_cpu32 (data->inode.size, data->be))
    len = grub_num_to_cpu32 (data->inode.size, data->be) - pos;
...
grub_ufs_lookup_symlink (struct grub_ufs_data *data, int ino)
{
  ...
  char symlink[grub_num_to_cpu32 (data->inode.size, data->be)];
  ...
  if (grub_num_to_cpu32 (data->inode.nblocks, data->be) == 0)
    grub_strcpy (symlink, (char *) data->inode. symlink);
  else
    {
      grub_disk_read (data->disk,
        (grub_num_to_cpu32 (data->inode.blocks.dir_blocks[0], data->be)
         << grub_num_to_cpu32 (data->sblock.log2_blksz,
          data->be)),
        0, grub_num_to_cpu32 (data->inode.size, data->be), symlink);
      symlink[grub_num_to_cpu32 (data->inode.size, data->be)] = '\0';
    }
...
grub_ufs_find_file (struct grub_ufs_data *data, const char *path)
{
 ...
 if (!grub_strcmp (name, filename))
   {
     ...
     if ((grub_num_to_cpu16 (data->inode.mode, data->be) & 0160000)
  == 0120000)
       {
  ...
  next++;
     ...
     if ((grub_num_to_cpu16 (data->inode.mode, data->be) & 0160000) != 0040000)
              {
                grub_free (fpath);
                grub_free (filename);
 ...
 grub_free (filename);
    ...
    } while (pos < grub_num_to_cpu32 (data->inode.size, data->be));
...
grub_ufs_mount (grub_disk_t disk)
{
 ...
 goto fail;
      ...
      if (
# 613 "project/radare2/shlr/grub/fs/ufs.c" 3 4
         ((grub_uint32_t) (
# 613 "project/radare2/shlr/grub/fs/ufs.c"
         data->sblock.magic
# 613 "project/radare2/shlr/grub/fs/ufs.c" 3 4
         )) 
# 613 "project/radare2/shlr/grub/fs/ufs.c"
...
# 618 "project/radare2/shlr/grub/fs/ufs.c" 3 4
              grub_swap_bytes32(
# 618 "project/radare2/shlr/grub/fs/ufs.c"
              data->sblock.magic
# 618 "project/radare2/shlr/grub/fs/ufs.c" 3 4
              ) 
# 618 "project/radare2/shlr/grub/fs/ufs.c"
...
grub_ufs_open (struct grub_file *file, const char *name)
{
  ...
  file->data = data;
  file->size = grub_num_to_cpu32 (data->inode.size, data->be);
...
# 805 "project/radare2/shlr/grub/fs/ufs.c"
static grub_err_t
grub_ufs_uuid (grub_device_t device, char **uuid)
{
  ...
  if (data && (data->sblock.uuidhi != 0 || data->sblock.uuidlow != 0))
    *uuid = grub_xasprintf ("%08x%08x",
      (unsigned) 
# 814 "project/radare2/shlr/grub/fs/ufs.c" 3 4
                ((grub_uint32_t) (
# 814 "project/radare2/shlr/grub/fs/ufs.c"
                data->sblock.uuidhi
# 814 "project/radare2/shlr/grub/fs/ufs.c" 3 4
                ))
# 814 "project/radare2/shlr/grub/fs/ufs.c"
                                                      ,
      (unsigned) 
# 815 "project/radare2/shlr/grub/fs/ufs.c" 3 4
                ((grub_uint32_t) (
# 815 "project/radare2/shlr/grub/fs/ufs.c"
                data->sblock.uuidlow
# 815 "project/radare2/shlr/grub/fs/ufs.c" 3 4
                ))
# 815 "project/radare2/shlr/grub/fs/ufs.c"
    ...
    *uuid = 
# 817 "project/radare2/shlr/grub/fs/ufs.c" 3 4
           ((void *)0)
# 817 "project/radare2/shlr/grub/fs/ufs.c"
               ;
...
# 860 "project/radare2/shlr/grub/fs/ufs.c"
