# 0 "project/radare2/shlr/grub/fs/tar.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
#define MODE_USTAR 1
# 1 "project/radare2/shlr/grub/fs/cpio.c" 1
# 20 "project/radare2/shlr/grub/fs/cpio.c"
...
grub_ssize_t grub_file_pb_read (grub_file_t file, void *buf, grub_size_t len,
    int total);
# 21 "project/radare2/shlr/grub/fs/cpio.c" 2
...
# 22 "project/radare2/shlr/grub/fs/cpio.c" 2
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 24 "project/radare2/shlr/grub/fs/cpio.c" 2
# 48 "project/radare2/shlr/grub/fs/cpio.c"
#define MAGIC_USTAR "ustar"


# 50 "project/radare2/shlr/grub/fs/cpio.c"
struct head { char name[100]; char mode[8]; char uid[8]; char gid[8]; char size[12]; char mtime[12]; char chksum[8]; char typeflag; char linkname[100]; char magic[6]; char version[2]; char uname[32]; char gname[32]; char devmajor[8]; char devminor[8]; char prefix[155]; } 
# 50 "project/radare2/shlr/grub/fs/cpio.c" 3 4
__attribute__((__packed__))
# 69 "project/radare2/shlr/grub/fs/cpio.c"
  ;



# 72 "project/radare2/shlr/grub/fs/cpio.c"
...
# 96 "project/radare2/shlr/grub/fs/cpio.c"
static grub_err_t
grub_cpio_find_file (struct grub_cpio_data *data, char **name,
       grub_uint32_t * ofs)
{
# 138 "project/radare2/shlr/grub/fs/cpio.c"
      struct head hd;
      ...
      if (!hd.name[0])
 {
   *ofs = 0;
   return GRUB_ERR_NONE;
      ...
      if (grub_memcmp (hd.magic, "ustar", sizeof ("ustar") - 1))
 return grub_error (GRUB_ERR_BAD_FS, "invalid tar archive");

      if ((*name = grub_strdup (hd.name)) == 
# 153 "project/radare2/shlr/grub/fs/cpio.c" 3 4
                                            ((void *)0)
# 153 "project/radare2/shlr/grub/fs/cpio.c"
                                                )
 return grub_errno;

      data->size = grub_strtoul (hd.size, 
# 156 "project/radare2/shlr/grub/fs/cpio.c" 3 4
                                         ((void *)0)
# 156 "project/radare2/shlr/grub/fs/cpio.c"
                                             , 8);
      data->dofs = data->hofs + 
# 157 "project/radare2/shlr/grub/fs/cpio.c" 3 4
                               0x200
# 157 "project/radare2/shlr/grub/fs/cpio.c"
                                                    ;
      *ofs = data->dofs + ((data->size + 
# 158 "project/radare2/shlr/grub/fs/cpio.c" 3 4
                                        0x200 
# 158 "project/radare2/shlr/grub/fs/cpio.c"
                                                              - 1) &
      ~(
# 159 "project/radare2/shlr/grub/fs/cpio.c" 3 4
       0x200 
# 159 "project/radare2/shlr/grub/fs/cpio.c"
                             - 1));
...
grub_cpio_mount (grub_disk_t disk)
{
  ...
  test = grub_memcmp (hd.magic, "ustar",
     sizeof ("ustar") - 1);
        ...
        void *closure)
{
  ...
  grub_uint32_t ofs = 0;
  char *prev = 
# 212 "project/radare2/shlr/grub/fs/cpio.c" 3 4
              ((void *)0)
# 212 "project/radare2/shlr/grub/fs/cpio.c"
                  , *name = 
# 212 "project/radare2/shlr/grub/fs/cpio.c" 3 4
                            ((void *)0)
# 212 "project/radare2/shlr/grub/fs/cpio.c"
   ...
   if ((!prev) || (grub_strcmp (prev, name) != 0))
     {
       ...
       info.dir = (p != 
# 249 "project/radare2/shlr/grub/fs/cpio.c" 3 4
                       ((void *)0)
# 249 "project/radare2/shlr/grub/fs/cpio.c"
                           );
   ...
   grub_free (prev);
   prev = 
# 254 "project/radare2/shlr/grub/fs/cpio.c" 3 4
         ((void *)0)
# 254 "project/radare2/shlr/grub/fs/cpio.c"
             ;
       }
       prev = name;
     }
...
if (prev == name) {
prev = 
# 260 "project/radare2/shlr/grub/fs/cpio.c" 3 4
      ((void *)0)
# 260 "project/radare2/shlr/grub/fs/cpio.c"
          ;
}
     grub_free (name);
     name = 
# 263 "project/radare2/shlr/grub/fs/cpio.c" 3 4
           ((void *)0)
# 263 "project/radare2/shlr/grub/fs/cpio.c"
               ;
   }
 }
      data->hofs = ofs;
...
{
  struct grub_cpio_data *data = 
# 281 "project/radare2/shlr/grub/fs/cpio.c" 3 4
                               ((void *)0)
# 281 "project/radare2/shlr/grub/fs/cpio.c"
                                   ;
  grub_uint32_t ofs = 0;
  char *fn = 
# 283 "project/radare2/shlr/grub/fs/cpio.c" 3 4
            ((void *)0)
# 283 "project/radare2/shlr/grub/fs/cpio.c"
                ;
  int i, j;
 ...
 goto no_match;
    ...
    no_match:
      ...
      grub_free (fn);
      fn = 
# 335 "project/radare2/shlr/grub/fs/cpio.c" 3 4
          ((void *)0)
# 335 "project/radare2/shlr/grub/fs/cpio.c"
              ;
      data->hofs = ofs;
    }
...
# 374 "project/radare2/shlr/grub/fs/cpio.c"
...
# 3 "project/radare2/shlr/grub/fs/tar.c" 2
