# 0 "project/radare2/shlr/grub/fs/afs_be.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 86 "project/radare2/shlr/grub/fs/afs.c"
...
# 147 "project/radare2/shlr/grub/fs/afs.c"
...
# 487 "project/radare2/shlr/grub/fs/afs.c"
  ...
  if (((grub_uint32_t) (1 << sb->block_shift) != sb->block_size)
   ...
   sb->block_per_group * sb->block_size)
      ...
      || (
# 508 "project/radare2/shlr/grub/fs/afs.c" 3 4
         ({ grub_uint16_t _x = (
# 508 "project/radare2/shlr/grub/fs/afs.c"
         sb->log_block.len
# 508 "project/radare2/shlr/grub/fs/afs.c" 3 4
         ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); }) 
# 508 "project/radare2/shlr/grub/fs/afs.c"
                                               != sb->log_size)
      || (
# 509 "project/radare2/shlr/grub/fs/afs.c" 3 4
         grub_swap_bytes32(
# 509 "project/radare2/shlr/grub/fs/afs.c"
         sb->valid_log_blocks
# 509 "project/radare2/shlr/grub/fs/afs.c" 3 4
         ) 
# 509 "project/radare2/shlr/grub/fs/afs.c"
...
fail:
  grub_error (GRUB_ERR_BAD_FS, "not an " "afs" "_be" " filesystem");
...
# 615 "project/radare2/shlr/grub/fs/afs.c"
  ...
  info.mtime = grub_divmod64 (
# 620 "project/radare2/shlr/grub/fs/afs.c" 3 4
                             grub_swap_bytes64(
# 620 "project/radare2/shlr/grub/fs/afs.c"
...
# 3 "project/radare2/shlr/grub/fs/afs_be.c" 2
