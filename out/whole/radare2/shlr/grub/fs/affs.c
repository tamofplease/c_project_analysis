# 0 "project/radare2/shlr/grub/fs/affs.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/grub/fs/affs.c"
# 20 "project/radare2/shlr/grub/fs/affs.c"
...
# 21 "project/radare2/shlr/grub/fs/affs.c" 2
...
grub_ssize_t grub_file_pb_read (grub_file_t file, void *buf, grub_size_t len,
    int total);
# 22 "project/radare2/shlr/grub/fs/affs.c" 2
...
# 23 "project/radare2/shlr/grub/fs/affs.c" 2
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 25 "project/radare2/shlr/grub/fs/affs.c" 2
...
unsigned int grub_fshelp_log2blksize (unsigned int blksize,
          unsigned int *pow);
# 27 "project/radare2/shlr/grub/fs/affs.c" 2



# 29 "project/radare2/shlr/grub/fs/affs.c"
struct grub_affs_bblock { grub_uint8_t type[3]; grub_uint8_t flags; grub_uint32_t checksum; grub_uint32_t rootblock; } 
# 29 "project/radare2/shlr/grub/fs/affs.c" 3 4
...
# 36 "project/radare2/shlr/grub/fs/affs.c"
 ;
...
struct grub_affs_rblock { grub_uint8_t type[4]; grub_uint8_t unused1[8]; grub_uint32_t htsize; grub_uint32_t unused2; grub_uint32_t checksum; grub_uint32_t hashtable[1]; } 
# 43 "project/radare2/shlr/grub/fs/affs.c" 3 4
__attribute__((__packed__))
# 52 "project/radare2/shlr/grub/fs/affs.c"
  ;



# 55 "project/radare2/shlr/grub/fs/affs.c"
struct grub_affs_file { grub_uint8_t unused1[12]; grub_uint32_t size; grub_uint8_t unused2[104]; grub_uint8_t namelen; grub_uint8_t name[30]; grub_uint8_t unused3[33]; grub_uint32_t next; grub_uint32_t parent; grub_uint32_t extension; grub_int32_t type; } 
# 55 "project/radare2/shlr/grub/fs/affs.c" 3 4
__attribute__((__packed__))
# 68 "project/radare2/shlr/grub/fs/affs.c"
  ;
...
# 87 "project/radare2/shlr/grub/fs/affs.c"
  ...
  for (links = grub_divmod64 (fileblock, data->htsize, &mod); links; links--)
    {
      grub_disk_read (data->disk, block + data->blocksize - 1,
        data->blocksize * (
# 124 "project/radare2/shlr/grub/fs/affs.c" 3 4
                          0x200
      
# 125 "project/radare2/shlr/grub/fs/affs.c"
     - 200),
        sizeof (file), &file);
      if (grub_errno)
 return 0;
      ...
      block = 
# 130 "project/radare2/shlr/grub/fs/affs.c" 3 4
             grub_swap_bytes32(
# 130 "project/radare2/shlr/grub/fs/affs.c"
             file.extension
# 130 "project/radare2/shlr/grub/fs/affs.c" 3 4
             )
# 130 "project/radare2/shlr/grub/fs/affs.c"
  ...
  return 
# 142 "project/radare2/shlr/grub/fs/affs.c" 3 4
        grub_swap_bytes32(
# 142 "project/radare2/shlr/grub/fs/affs.c"
        pos
# 142 "project/radare2/shlr/grub/fs/affs.c" 3 4
        )
# 142 "project/radare2/shlr/grub/fs/affs.c"
...
grub_affs_mount (grub_disk_t disk)
{
  ...
  rootblock = grub_malloc (
# 205 "project/radare2/shlr/grub/fs/affs.c" 3 4
                          0x200 
# 205 "project/radare2/shlr/grub/fs/affs.c"
                                                * 16);
  if (!rootblock)
    goto fail;
...
# 213 "project/radare2/shlr/grub/fs/affs.c" 3 4
   0x200 
# 213 "project/radare2/shlr/grub/fs/affs.c"
                         * 16, rootblock);
  if (grub_errno)
    goto fail;
  ...
  checksumr = 
# 220 "project/radare2/shlr/grub/fs/affs.c" 3 4
             grub_swap_bytes32(
# 220 "project/radare2/shlr/grub/fs/affs.c"
             rblock->checksum
# 220 "project/radare2/shlr/grub/fs/affs.c" 3 4
             )
# 220 "project/radare2/shlr/grub/fs/affs.c"
...
# 224 "project/radare2/shlr/grub/fs/affs.c" 3 4
                                            0x200 
# 224 "project/radare2/shlr/grub/fs/affs.c"
                                                                  * blocksize;
      unsigned int i;

      for (i = 0; i < 
# 227 "project/radare2/shlr/grub/fs/affs.c" 3 4
                     0x200 
# 227 "project/radare2/shlr/grub/fs/affs.c"
                                           / sizeof (*currblock); i++)
 checksum += 
# 228 "project/radare2/shlr/grub/fs/affs.c" 3 4
            grub_swap_bytes32(
# 228 "project/radare2/shlr/grub/fs/affs.c"
            currblock[i]
# 228 "project/radare2/shlr/grub/fs/affs.c" 3 4
            )
# 228 "project/radare2/shlr/grub/fs/affs.c"
 ...
 break;
  ...
  data->disk = disk;
  data->htsize = 
# 242 "project/radare2/shlr/grub/fs/affs.c" 3 4
                grub_swap_bytes32(
# 242 "project/radare2/shlr/grub/fs/affs.c"
                rblock->htsize
# 242 "project/radare2/shlr/grub/fs/affs.c" 3 4
                )
# 242 "project/radare2/shlr/grub/fs/affs.c"
...
grub_affs_read_symlink (grub_fshelp_node_t node)
{
  ...
  symlink = grub_malloc (((data->blocksize) - 225));
  if (!symlink)
    return 0;

  grub_disk_read (data->disk, node->block, 24,
    ((data->blocksize) - 225), symlink);
  if (grub_errno)
    {
      grub_free (symlink);
      return 0;
...
# 277 "project/radare2/shlr/grub/fs/affs.c" 3 4
 grub_real_dprintf("/tmp", 277, 
# 277 "project/radare2/shlr/grub/fs/affs.c"
 "affs"
# 277 "project/radare2/shlr/grub/fs/affs.c" 3 4
 , 
# 277 "project/radare2/shlr/grub/fs/affs.c"
         ...
         struct grub_affs_iterate_dir_closure *c)
{
  ...
  node->block = block;
  node->parent = 
# 311 "project/radare2/shlr/grub/fs/affs.c" 3 4
                grub_swap_bytes32(
# 311 "project/radare2/shlr/grub/fs/affs.c"
                c->file->parent
# 311 "project/radare2/shlr/grub/fs/affs.c" 3 4
                )
# 311 "project/radare2/shlr/grub/fs/affs.c"
         ...
         void *closure)
{
  ...
  grub_disk_read (data->disk, dir->block, 24,
 ...
 continue;
      ...
      next = 
# 367 "project/radare2/shlr/grub/fs/affs.c" 3 4
            grub_swap_bytes32(
# 367 "project/radare2/shlr/grub/fs/affs.c"
            hashtable[i]
# 367 "project/radare2/shlr/grub/fs/affs.c" 3 4
            )
# 367 "project/radare2/shlr/grub/fs/affs.c"
      ...
      while (next)
 {
   grub_disk_read (data->disk, next + data->blocksize - 1,
     data->blocksize * 
# 372 "project/radare2/shlr/grub/fs/affs.c" 3 4
                      0x200
     
# 373 "project/radare2/shlr/grub/fs/affs.c"
    - 200,
   ...
   if ((int) 
# 380 "project/radare2/shlr/grub/fs/affs.c" 3 4
            grub_swap_bytes32(
# 380 "project/radare2/shlr/grub/fs/affs.c"
            file.type
# 380 "project/radare2/shlr/grub/fs/affs.c" 3 4
            ) 
# 380 "project/radare2/shlr/grub/fs/affs.c"
...
# 382 "project/radare2/shlr/grub/fs/affs.c" 3 4
           grub_swap_bytes32(
# 382 "project/radare2/shlr/grub/fs/affs.c"
           file.type
# 382 "project/radare2/shlr/grub/fs/affs.c" 3 4
           ) 
# 382 "project/radare2/shlr/grub/fs/affs.c"
...
# 384 "project/radare2/shlr/grub/fs/affs.c" 3 4
           grub_swap_bytes32(
# 384 "project/radare2/shlr/grub/fs/affs.c"
           file.type
# 384 "project/radare2/shlr/grub/fs/affs.c" 3 4
           ) 
# 384 "project/radare2/shlr/grub/fs/affs.c"
...
# 390 "project/radare2/shlr/grub/fs/affs.c" 3 4
        grub_swap_bytes32(
# 390 "project/radare2/shlr/grub/fs/affs.c"
        file.size
# 390 "project/radare2/shlr/grub/fs/affs.c" 3 4
        )
# 390 "project/radare2/shlr/grub/fs/affs.c"
   ...
   next = 
# 393 "project/radare2/shlr/grub/fs/affs.c" 3 4
         grub_swap_bytes32(
# 393 "project/radare2/shlr/grub/fs/affs.c"
         file.next
# 393 "project/radare2/shlr/grub/fs/affs.c" 3 4
         )
# 393 "project/radare2/shlr/grub/fs/affs.c"
  ...
  void *closure)
{
  ...
  info.dir = ((filetype & 
# 480 "project/radare2/shlr/grub/fs/affs.c" 3 4
                         0xff
# 480 "project/radare2/shlr/grub/fs/affs.c"
                                              ) == GRUB_FSHELP_DIR);
  grub_free (node);
  return c->hook?c->hook (filename, &info, c->closure):
# 482 "project/radare2/shlr/grub/fs/affs.c" 3 4
                                                      ((void *)0)
# 482 "project/radare2/shlr/grub/fs/affs.c"
                                                          ;
}
  ...
  if (data)
    {
      ...
      grub_disk_read (data->disk, disk->total_sectors >> 1,
        data->blocksize * (
# 530 "project/radare2/shlr/grub/fs/affs.c" 3 4
                          0x200
      
# 531 "project/radare2/shlr/grub/fs/affs.c"
     - 200),
        sizeof (file), &file);
      if (grub_errno)
 return 0;
