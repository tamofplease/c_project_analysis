...
#define LOG2_EXT2_BLOCK_SIZE(data) (grub_le_to_cpu32 (data->sblock.log2_block_size) + 1)



#define LOG2_BLOCK_SIZE(data) (grub_le_to_cpu32 (data->sblock.log2_block_size) + 10)
...
#define EXT2_INODE_SIZE(data) (EXT2_REVISION (data) == EXT2_GOOD_OLD_REVISION ? EXT2_GOOD_OLD_INODE_SIZE : grub_le_to_cpu16 (data->sblock.inode_size))
...
# 118 "project/radare2/shlr/grub/fs/ext2.c"
