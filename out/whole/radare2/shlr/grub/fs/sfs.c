# 0 "project/radare2/shlr/grub/fs/sfs.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 21 "project/radare2/shlr/grub/fs/sfs.c" 2
...
grub_ssize_t grub_file_pb_read (grub_file_t file, void *buf, grub_size_t len,
    int total);
# 22 "project/radare2/shlr/grub/fs/sfs.c" 2
...
# 23 "project/radare2/shlr/grub/fs/sfs.c" 2
...
extern grub_err_t (* grub_disk_ata_pass_through) (grub_disk_t,
     struct grub_disk_ata_pass_through_parms *);
# 25 "project/radare2/shlr/grub/fs/sfs.c" 2
...
unsigned int grub_fshelp_log2blksize (unsigned int blksize,
          unsigned int *pow);
# 27 "project/radare2/shlr/grub/fs/sfs.c" 2



# 29 "project/radare2/shlr/grub/fs/sfs.c"
struct grub_sfs_bheader { grub_uint8_t magic[4]; grub_uint32_t chksum; grub_uint32_t ipointtomyself; } 
# 29 "project/radare2/shlr/grub/fs/sfs.c" 3 4
...
# 35 "project/radare2/shlr/grub/fs/sfs.c"
 ;


struct grub_sfs_rblock { struct grub_sfs_bheader header; grub_uint32_t version; grub_uint8_t unused1[36]; grub_uint32_t blocksize; grub_uint8_t unused2[40]; grub_uint8_t unused3[8]; grub_uint32_t rootobject; grub_uint32_t btree; } 
# 38 "project/radare2/shlr/grub/fs/sfs.c" 3 4
__attribute__((__packed__))
# 49 "project/radare2/shlr/grub/fs/sfs.c"
  ;



# 52 "project/radare2/shlr/grub/fs/sfs.c"
struct grub_sfs_obj { grub_uint8_t unused1[4]; grub_uint32_t nodeid; grub_uint8_t unused2[4]; union { struct { grub_uint32_t first_block; grub_uint32_t size; } 
# 52 "project/radare2/shlr/grub/fs/sfs.c" 3 4
__attribute__((__packed__)) 
# 52 "project/radare2/shlr/grub/fs/sfs.c"
file ; struct { grub_uint32_t hashtable; grub_uint32_t dir_objc; } 
# 52 "project/radare2/shlr/grub/fs/sfs.c" 3 4
__attribute__((__packed__)) 
# 52 "project/radare2/shlr/grub/fs/sfs.c"
dir ; } file_dir; grub_uint8_t unused3[4]; grub_uint8_t type; grub_uint8_t filename[1]; grub_uint8_t comment[1]; } 
# 52 "project/radare2/shlr/grub/fs/sfs.c" 3 4
__attribute__((__packed__))
# 77 "project/radare2/shlr/grub/fs/sfs.c"
  ;
...
# 84 "project/radare2/shlr/grub/fs/sfs.c"
struct grub_sfs_objc { struct grub_sfs_bheader header; grub_uint32_t parent; grub_uint32_t next; grub_uint32_t prev; struct grub_sfs_obj objects[1]; } 
# 84 "project/radare2/shlr/grub/fs/sfs.c" 3 4
__attribute__((__packed__))
# 93 "project/radare2/shlr/grub/fs/sfs.c"
  ;


# 95 "project/radare2/shlr/grub/fs/sfs.c"
struct grub_sfs_btree_node { grub_uint32_t key; grub_uint32_t data; } 
# 95 "project/radare2/shlr/grub/fs/sfs.c" 3 4
__attribute__((__packed__))
...
# 100 "project/radare2/shlr/grub/fs/sfs.c"
 ;

struct grub_sfs_btree_extent { grub_uint32_t key; grub_uint32_t next; grub_uint32_t prev; grub_uint16_t size; } 
# 102 "project/radare2/shlr/grub/fs/sfs.c" 3 4
__attribute__((__packed__))
...
# 109 "project/radare2/shlr/grub/fs/sfs.c"
 ;

struct grub_sfs_btree { struct grub_sfs_bheader header; grub_uint16_t nodes; grub_uint8_t leaf; grub_uint8_t nodesize; struct grub_sfs_btree_node node[1]; } 
# 111 "project/radare2/shlr/grub/fs/sfs.c" 3 4
__attribute__((__packed__))
# 121 "project/radare2/shlr/grub/fs/sfs.c"
  ;




# 125 "project/radare2/shlr/grub/fs/sfs.c"
        ...
        int *size, int *nextext)
{
  ...
  next = 
# 163 "project/radare2/shlr/grub/fs/sfs.c" 3 4
        grub_swap_bytes32(
# 163 "project/radare2/shlr/grub/fs/sfs.c"
        data->rblock.btree
# 163 "project/radare2/shlr/grub/fs/sfs.c" 3 4
        )
# 163 "project/radare2/shlr/grub/fs/sfs.c"
      ...
      if (grub_errno)
 {
   ...
   return grub_errno;
      ...
      for (i = 
# 176 "project/radare2/shlr/grub/fs/sfs.c" 3 4
              ({ grub_uint16_t _x = (
# 176 "project/radare2/shlr/grub/fs/sfs.c"
              tree->nodes
# 176 "project/radare2/shlr/grub/fs/sfs.c" 3 4
...
#define EXTNODE(tree,index) ((struct grub_sfs_btree_node *) (((char *) &(tree)->node[0]) + (index) * (tree)->nodesize))




   if ((
# 184 "project/radare2/shlr/grub/fs/sfs.c" 3 4
       grub_swap_bytes32(
# 184 "project/radare2/shlr/grub/fs/sfs.c"
       ((struct grub_sfs_btree_node *) (((char *) &(tree)->node[0]) + (i) * (tree)->nodesize))->key
# 184 "project/radare2/shlr/grub/fs/sfs.c" 3 4
       ) 
# 184 "project/radare2/shlr/grub/fs/sfs.c"
                                                <= block)
     ...
     {
       next = 
# 187 "project/radare2/shlr/grub/fs/sfs.c" 3 4
             grub_swap_bytes32(
# 187 "project/radare2/shlr/grub/fs/sfs.c"
             ((struct grub_sfs_btree_node *) (((char *) &(tree)->node[0]) + (i) * (tree)->nodesize))->data
# 187 "project/radare2/shlr/grub/fs/sfs.c" 3 4
             )
# 187 "project/radare2/shlr/grub/fs/sfs.c"
                                                       ;
   ...
   if (
# 192 "project/radare2/shlr/grub/fs/sfs.c" 3 4
      grub_swap_bytes32(
# 192 "project/radare2/shlr/grub/fs/sfs.c"
      ((struct grub_sfs_btree_node *) (((char *) &(tree)->node[0]) + (i) * (tree)->nodesize))->key
# 192 "project/radare2/shlr/grub/fs/sfs.c" 3 4
      ) 
# 192 "project/radare2/shlr/grub/fs/sfs.c"
                                                == block && tree->leaf)
     {
       ...
       extent = (struct grub_sfs_btree_extent *) ((struct grub_sfs_btree_node *) (((char *) &(tree)->node[0]) + (i) * (tree)->nodesize));


       *size = 
# 198 "project/radare2/shlr/grub/fs/sfs.c" 3 4
              ({ grub_uint16_t _x = (
# 198 "project/radare2/shlr/grub/fs/sfs.c"
              extent->size
# 198 "project/radare2/shlr/grub/fs/sfs.c" 3 4
              ); (grub_uint16_t) ((_x << 8) | (_x >> 8)); })
# 198 "project/radare2/shlr/grub/fs/sfs.c"
                                             ;
       *nextext = 
# 199 "project/radare2/shlr/grub/fs/sfs.c" 3 4
                 grub_swap_bytes32(
# 199 "project/radare2/shlr/grub/fs/sfs.c"
                 extent->next
# 199 "project/radare2/shlr/grub/fs/sfs.c" 3 4
                 )
# 199 "project/radare2/shlr/grub/fs/sfs.c"
...
grub_sfs_mount (grub_disk_t disk)
{
  ...
  data->blocksize = 
# 291 "project/radare2/shlr/grub/fs/sfs.c" 3 4
                   grub_swap_bytes32(
# 291 "project/radare2/shlr/grub/fs/sfs.c"
                   data->rblock.blocksize
# 291 "project/radare2/shlr/grub/fs/sfs.c" 3 4
                   )
# 291 "project/radare2/shlr/grub/fs/sfs.c"
                                                            ;
  ...
  grub_disk_read (disk, 
# 297 "project/radare2/shlr/grub/fs/sfs.c" 3 4
                       grub_swap_bytes32(
# 297 "project/radare2/shlr/grub/fs/sfs.c"
                       data->rblock.rootobject
# 297 "project/radare2/shlr/grub/fs/sfs.c" 3 4
                       )
# 297 "project/radare2/shlr/grub/fs/sfs.c"
                                                                 , 0,
  ...
  blk = 
# 304 "project/radare2/shlr/grub/fs/sfs.c" 3 4
       grub_swap_bytes32(
# 304 "project/radare2/shlr/grub/fs/sfs.c"
       rootobjc->objects[0].file_dir.dir.dir_objc
# 304 "project/radare2/shlr/grub/fs/sfs.c" 3 4
       )
# 304 "project/radare2/shlr/grub/fs/sfs.c"
                                                                    ;
        ...
        void *closure)
{
      ...
      while (pos + sizeof (struct grub_sfs_obj) < data->blocksize)
 {
   ...
   if (type == GRUB_FSHELP_DIR)
     block = 
# 435 "project/radare2/shlr/grub/fs/sfs.c" 3 4
            grub_swap_bytes32(
# 435 "project/radare2/shlr/grub/fs/sfs.c"
            obj->file_dir.dir.dir_objc
# 435 "project/radare2/shlr/grub/fs/sfs.c" 3 4
            )
# 435 "project/radare2/shlr/grub/fs/sfs.c"
                                                         ;
     ...
     block = 
# 437 "project/radare2/shlr/grub/fs/sfs.c" 3 4
            grub_swap_bytes32(
# 437 "project/radare2/shlr/grub/fs/sfs.c"
            obj->file_dir.file.first_block
# 437 "project/radare2/shlr/grub/fs/sfs.c" 3 4
            )
# 437 "project/radare2/shlr/grub/fs/sfs.c"
                                                             ;
...
# 440 "project/radare2/shlr/grub/fs/sfs.c" 3 4
       grub_swap_bytes32(
# 440 "project/radare2/shlr/grub/fs/sfs.c"
       obj->file_dir.file.size
# 440 "project/radare2/shlr/grub/fs/sfs.c" 3 4
       )
# 440 "project/radare2/shlr/grub/fs/sfs.c"
                                                 ,
        type, data, hook, closure))
     {
      ...
      next = 
# 448 "project/radare2/shlr/grub/fs/sfs.c" 3 4
            grub_swap_bytes32(
# 448 "project/radare2/shlr/grub/fs/sfs.c"
            objc->next
# 448 "project/radare2/shlr/grub/fs/sfs.c" 3 4
            )
# 448 "project/radare2/shlr/grub/fs/sfs.c"
  ...
  void *closure)
{
  ...
  info.dir = ((filetype & 
# 532 "project/radare2/shlr/grub/fs/sfs.c" 3 4
                         0xff
# 532 "project/radare2/shlr/grub/fs/sfs.c"
                                              ) == GRUB_FSHELP_DIR);
  grub_free (node);
