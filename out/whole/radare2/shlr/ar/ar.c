# 0 "project/radare2/shlr/ar/ar.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 3 "project/radare2/shlr/ar/ar.c" 2
...
# 4 "project/radare2/shlr/ar/ar.c" 2
# 1 "project/radare2/shlr/ar/ar.h" 1


#define _AR_H 


# 5 "project/radare2/shlr/ar/ar.h"
typedef struct RARFP {
 char *name;
 
# 7 "project/radare2/shlr/ar/ar.h" 3 4
unsigned long long 
# 7 "project/radare2/shlr/ar/ar.h"
     start;
 
# 8 "project/radare2/shlr/ar/ar.h" 3 4
unsigned long long 
# 8 "project/radare2/shlr/ar/ar.h"
     end;
 RBuffer *buf;
 
# 10 "project/radare2/shlr/ar/ar.h" 3 4
unsigned int 
# 10 "project/radare2/shlr/ar/ar.h"
     *refcount;
} RArFp;
...
# 17 "project/radare2/shlr/ar/ar.h" 3 4
__attribute__((visibility("default"))) 
# 17 "project/radare2/shlr/ar/ar.h"
     RArFp *ar_open_file(const char *arname, const char *filename);

# 18 "project/radare2/shlr/ar/ar.h" 3 4
__attribute__((visibility("default"))) 
# 18 "project/radare2/shlr/ar/ar.h"
     RList *ar_open_all(const char *arname);

# 19 "project/radare2/shlr/ar/ar.h" 3 4
__attribute__((visibility("default"))) 
# 19 "project/radare2/shlr/ar/ar.h"
     int ar_open_all_cb(const char *arname, RArOpenManyCB cb, void *user);

# 20 "project/radare2/shlr/ar/ar.h" 3 4
__attribute__((visibility("default"))) 
# 20 "project/radare2/shlr/ar/ar.h"
     int ar_close(RArFp *f);

# 21 "project/radare2/shlr/ar/ar.h" 3 4
__attribute__((visibility("default"))) 
# 21 "project/radare2/shlr/ar/ar.h"
     int ar_read_at(RArFp *f, 
# 21 "project/radare2/shlr/ar/ar.h" 3 4
                              unsigned long long 
# 21 "project/radare2/shlr/ar/ar.h"
                                   off, void *buf, int count);

# 22 "project/radare2/shlr/ar/ar.h" 3 4
__attribute__((visibility("default"))) 
# 22 "project/radare2/shlr/ar/ar.h"
     int ar_write_at(RArFp *f, 
# 22 "project/radare2/shlr/ar/ar.h" 3 4
                               unsigned long long 
# 22 "project/radare2/shlr/ar/ar.h"
                                    off, void *buf, int count);
# 5 "project/radare2/shlr/ar/ar.c" 2
...
# 11 "project/radare2/shlr/ar/ar.c" 3 4
unsigned long long 
# 11 "project/radare2/shlr/ar/ar.c"
     size;
 
# 12 "project/radare2/shlr/ar/ar.c" 3 4
unsigned long long 
# 12 "project/radare2/shlr/ar/ar.c"
     offset;
} filetable;

static RArFp *arfp_new(RBuffer *b, 
# 15 "project/radare2/shlr/ar/ar.c" 3 4
                                  unsigned int 
# 15 "project/radare2/shlr/ar/ar.c"
                                       *refcount) {
 
# 16 "project/radare2/shlr/ar/ar.c" 3 4
do { if (!(
# 16 "project/radare2/shlr/ar/ar.c"
b
# 16 "project/radare2/shlr/ar/ar.c" 3 4
...
"b"
# 16 "project/radare2/shlr/ar/ar.c" 3 4
, 16); return (((void *)0)); } } while (0)
# 16 "project/radare2/shlr/ar/ar.c"
                              ;
 RArFp *f = 
# 17 "project/radare2/shlr/ar/ar.c" 3 4
           (
# 17 "project/radare2/shlr/ar/ar.c"
           RArFp
# 17 "project/radare2/shlr/ar/ar.c" 3 4
           *)malloc(sizeof(
# 17 "project/radare2/shlr/ar/ar.c"
...
# 17 "project/radare2/shlr/ar/ar.c"
 ...
 if (f) {
  ...
  f->name = 
# 22 "project/radare2/shlr/ar/ar.c" 3 4
           ((void *)0)
# 22 "project/radare2/shlr/ar/ar.c"
               ;
  f->refcount = refcount;
  f->buf = b;
  f->start = 0;
...
# 31 "project/radare2/shlr/ar/ar.c" 3 4
_Bool 
# 31 "project/radare2/shlr/ar/ar.c"
    ar_check_magic(RBuffer *b) {
 char buf[sizeof ("!<arch>\n") - 1];
 if (r_buf_read (b, (
# 33 "project/radare2/shlr/ar/ar.c" 3 4
                    unsigned char 
# 33 "project/radare2/shlr/ar/ar.c"
                        *)buf, sizeof (buf)) != sizeof (buf)) {
  return 
# 34 "project/radare2/shlr/ar/ar.c" 3 4
        0
# 34 "project/radare2/shlr/ar/ar.c"
             ;
 }
 if (strncmp (buf, "!<arch>\n", 8)) {
  
# 37 "project/radare2/shlr/ar/ar.c" 3 4
 fprintf(__stderrp,
# 37 "project/radare2/shlr/ar/ar.c"
 "Wrong file type.\n"
# 37 "project/radare2/shlr/ar/ar.c" 3 4
 )
# 37 "project/radare2/shlr/ar/ar.c"
                               ;
  return 
# 38 "project/radare2/shlr/ar/ar.c" 3 4
        0
# 38 "project/radare2/shlr/ar/ar.c"
             ;
 }
 return 
# 40 "project/radare2/shlr/ar/ar.c" 3 4
       1
# 40 "project/radare2/shlr/ar/ar.c"
           ;
}
...
static inline void arf_clean_name(RArFp *arf) {
 free (arf->name);
 arf->name = 
# 45 "project/radare2/shlr/ar/ar.c" 3 4
            ((void *)0)
# 45 "project/radare2/shlr/ar/ar.c"
                ;
}

static char *name_from_table(
# 48 "project/radare2/shlr/ar/ar.c" 3 4
                            unsigned long long 
# 48 "project/radare2/shlr/ar/ar.c"
                                 off, filetable *tbl) {
 if (off > tbl->size) {
  
# 50 "project/radare2/shlr/ar/ar.c" 3 4
 fprintf(__stderrp,
# 50 "project/radare2/shlr/ar/ar.c"
 "Malformed ar: name lookup out of bounds for header at offset 0x%" 
# 50 "project/radare2/shlr/ar/ar.c" 3 4
 "llx" 
# 50 "project/radare2/shlr/ar/ar.c"
 "\n", off
...
# 50 "project/radare2/shlr/ar/ar.c"
                                                                                               ;
  return 
# 51 "project/radare2/shlr/ar/ar.c" 3 4
        ((void *)0)
# 51 "project/radare2/shlr/ar/ar.c"
            ;
 }
...
# 57 "project/radare2/shlr/ar/ar.c" 3 4
unsigned long long 
# 57 "project/radare2/shlr/ar/ar.c"
     i;
 ...
 if (i == off) {
  return 
# 65 "project/radare2/shlr/ar/ar.c" 3 4
        ((void *)0)
# 65 "project/radare2/shlr/ar/ar.c"
            ;
 }
 return r_str_newlen (buf + off, i - off - 1);
}

#define VERIFY_AR_NUM_FIELD(x,s) x[sizeof (x) - 1] = '\0'; r_str_trim_tail (x); if (x[0] != '\0' && (x[0] == '-' || !r_str_isnumber (x))) { eprintf ("Malformed AR: bad %s in header at offset 0x%" PFMT64x "\n", s, h_off); return -1; }
# 79 "project/radare2/shlr/ar/ar.c"
static int ar_parse_header(RArFp *arf, filetable *tbl, 
# 79 "project/radare2/shlr/ar/ar.c" 3 4
                                                      unsigned long long 
# 79 "project/radare2/shlr/ar/ar.c"
                                                           arsize) {
 
# 80 "project/radare2/shlr/ar/ar.c" 3 4
do { if (!(
# 80 "project/radare2/shlr/ar/ar.c"
arf && arf->buf && tbl
# 80 "project/radare2/shlr/ar/ar.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 80 "project/radare2/shlr/ar/ar.c"
...
# 83 "project/radare2/shlr/ar/ar.c" 3 4
unsigned long long 
# 83 "project/radare2/shlr/ar/ar.c"
     h_off = r_buf_tell (b);
 if (h_off % 2 == 1) {

  
# 86 "project/radare2/shlr/ar/ar.c" 3 4
 unsigned char 
# 86 "project/radare2/shlr/ar/ar.c"
     tmp[1];
 ...
 int r = r_buf_read (b, (
# 103 "project/radare2/shlr/ar/ar.c" 3 4
                        unsigned char 
# 103 "project/radare2/shlr/ar/ar.c"
                            *)&h, sizeof (h));
 if (r != sizeof (h)) {
  if (r == 0) {
   return 1;
...
# 109 "project/radare2/shlr/ar/ar.c" 3 4
  fprintf(__stderrp,
# 109 "project/radare2/shlr/ar/ar.c"
  "AR read io error\n"
# 109 "project/radare2/shlr/ar/ar.c" 3 4
  )
# 109 "project/radare2/shlr/ar/ar.c"
...
# 111 "project/radare2/shlr/ar/ar.c" 3 4
  fprintf(__stderrp,
# 111 "project/radare2/shlr/ar/ar.c"
  "Malformed AR: Invalid length while parsing header at 0x%" 
# 111 "project/radare2/shlr/ar/ar.c" 3 4
  "llx" 
# 111 "project/radare2/shlr/ar/ar.c"
  "\n", h_off
...
# 117 "project/radare2/shlr/ar/ar.c" 3 4
 fprintf(__stderrp,
# 117 "project/radare2/shlr/ar/ar.c"
 "Invalid header at offset 0x%" 
# 117 "project/radare2/shlr/ar/ar.c" 3 4
 "llx" 
# 117 "project/radare2/shlr/ar/ar.c"
 ": bad end field\n", h_off
...
# 117 "project/radare2/shlr/ar/ar.c"
 ...
 h.timestamp[sizeof (h.timestamp) - 1] = '\0'; r_str_trim_tail (h.timestamp); if (h.timestamp[0] != '\0' && (h.timestamp[0] == '-' || !r_str_isnumber (h.timestamp))) { 
# 122 "project/radare2/shlr/ar/ar.c" 3 4
fprintf(__stderrp,
# 122 "project/radare2/shlr/ar/ar.c"
"Malformed AR: bad %s in header at offset 0x%" 
# 122 "project/radare2/shlr/ar/ar.c" 3 4
"llx" 
# 122 "project/radare2/shlr/ar/ar.c"
"\n", "timestamp", h_off
...
# 122 "project/radare2/shlr/ar/ar.c"
; return -1; }
 h.oid[sizeof (h.oid) - 1] = '\0'; r_str_trim_tail (h.oid); if (h.oid[0] != '\0' && (h.oid[0] == '-' || !r_str_isnumber (h.oid))) { 
# 123 "project/radare2/shlr/ar/ar.c" 3 4
fprintf(__stderrp,
# 123 "project/radare2/shlr/ar/ar.c"
"Malformed AR: bad %s in header at offset 0x%" 
# 123 "project/radare2/shlr/ar/ar.c" 3 4
"llx" 
# 123 "project/radare2/shlr/ar/ar.c"
...
# 123 "project/radare2/shlr/ar/ar.c"
; return -1; }
 h.gid[sizeof (h.gid) - 1] = '\0'; r_str_trim_tail (h.gid); if (h.gid[0] != '\0' && (h.gid[0] == '-' || !r_str_isnumber (h.gid))) { 
# 124 "project/radare2/shlr/ar/ar.c" 3 4
fprintf(__stderrp,
# 124 "project/radare2/shlr/ar/ar.c"
"Malformed AR: bad %s in header at offset 0x%" 
# 124 "project/radare2/shlr/ar/ar.c" 3 4
"llx" 
# 124 "project/radare2/shlr/ar/ar.c"
...
# 124 "project/radare2/shlr/ar/ar.c"
; return -1; }
 h.mode[sizeof (h.mode) - 1] = '\0'; r_str_trim_tail (h.mode); if (h.mode[0] != '\0' && (h.mode[0] == '-' || !r_str_isnumber (h.mode))) { 
# 125 "project/radare2/shlr/ar/ar.c" 3 4
fprintf(__stderrp,
# 125 "project/radare2/shlr/ar/ar.c"
"Malformed AR: bad %s in header at offset 0x%" 
# 125 "project/radare2/shlr/ar/ar.c" 3 4
"llx" 
# 125 "project/radare2/shlr/ar/ar.c"
...
# 125 "project/radare2/shlr/ar/ar.c"
; return -1; }
 h.size[sizeof (h.size) - 1] = '\0'; r_str_trim_tail (h.size); if (h.size[0] != '\0' && (h.size[0] == '-' || !r_str_isnumber (h.size))) { 
# 126 "project/radare2/shlr/ar/ar.c" 3 4
fprintf(__stderrp,
# 126 "project/radare2/shlr/ar/ar.c"
"Malformed AR: bad %s in header at offset 0x%" 
# 126 "project/radare2/shlr/ar/ar.c" 3 4
"llx" 
# 126 "project/radare2/shlr/ar/ar.c"
...
# 129 "project/radare2/shlr/ar/ar.c" 3 4
 fprintf(__stderrp,
# 129 "project/radare2/shlr/ar/ar.c"
 "Malformed AR: bad size in header at offset 0x%" 
# 129 "project/radare2/shlr/ar/ar.c" 3 4
 "llx" 
# 129 "project/radare2/shlr/ar/ar.c"
 "\n", h_off
...
# 132 "project/radare2/shlr/ar/ar.c" 3 4
unsigned long long 
# 132 "project/radare2/shlr/ar/ar.c"
     size = atol (h.size);
 ...
 if (!strcmp (h.name, "/")) {
  ...
  if (r_buf_seek (b, size, 
# 142 "project/radare2/shlr/ar/ar.c" 3 4
                          1
# 142 "project/radare2/shlr/ar/ar.c"
                                   ) <= 0 || r_buf_tell (b) > arsize) {
   
# 143 "project/radare2/shlr/ar/ar.c" 3 4
  fprintf(__stderrp,
# 143 "project/radare2/shlr/ar/ar.c"
  "Malformed ar: too short\n"
# 143 "project/radare2/shlr/ar/ar.c" 3 4
  )
# 143 "project/radare2/shlr/ar/ar.c"
                                       ;
...
# 151 "project/radare2/shlr/ar/ar.c" 3 4
  fprintf(__stderrp,
# 151 "project/radare2/shlr/ar/ar.c"
  "invalid ar file: two filename lookup tables (at 0x%" 
# 151 "project/radare2/shlr/ar/ar.c" 3 4
  "llx" 
# 151 "project/radare2/shlr/ar/ar.c"
  ", and 0x%" 
...
# 151 "project/radare2/shlr/ar/ar.c"
  ...
  if (!tbl->data || r_buf_read (b, (
# 155 "project/radare2/shlr/ar/ar.c" 3 4
                                   unsigned char 
# 155 "project/radare2/shlr/ar/ar.c"
                                       *)tbl->data, size) != size) {
   return -1;
  }
  tbl->data[size] = '\0';
 ...
 RList *list = r_str_split_duplist (h.name, "/", 
# 169 "project/radare2/shlr/ar/ar.c" 3 4
                                                0
# 169 "project/radare2/shlr/ar/ar.c"
                                                     );
 if (r_list_length (list) != 2) {
  r_list_free (list);
  
# 172 "project/radare2/shlr/ar/ar.c" 3 4
 fprintf(__stderrp,
# 172 "project/radare2/shlr/ar/ar.c"
 "invalid ar file: invalid file name in header at: 0x%" 
# 172 "project/radare2/shlr/ar/ar.c" 3 4
 "llx" 
# 172 "project/radare2/shlr/ar/ar.c"
 "\n", h_off
...
# 183 "project/radare2/shlr/ar/ar.c" 3 4
  fprintf(__stderrp,
# 183 "project/radare2/shlr/ar/ar.c"
  "invalid ar file: invalid file name in header at: 0x%" 
# 183 "project/radare2/shlr/ar/ar.c" 3 4
  "llx" 
# 183 "project/radare2/shlr/ar/ar.c"
...
# 191 "project/radare2/shlr/ar/ar.c" 3 4
  fprintf(__stderrp,
# 191 "project/radare2/shlr/ar/ar.c"
  "invalid ar file: invalid file name in header at: 0x%" 
# 191 "project/radare2/shlr/ar/ar.c" 3 4
  "llx" 
# 191 "project/radare2/shlr/ar/ar.c"
...
# 191 "project/radare2/shlr/ar/ar.c"
 ...
 if (r_buf_seek (b, size, 
# 204 "project/radare2/shlr/ar/ar.c" 3 4
                         1
# 204 "project/radare2/shlr/ar/ar.c"
                                  ) <= 0 || r_buf_tell (b) > arsize) {
  
# 205 "project/radare2/shlr/ar/ar.c" 3 4
 fprintf(__stderrp,
# 205 "project/radare2/shlr/ar/ar.c"
 "Malformed ar: missing the end of %s (header offset: 0x%" 
# 205 "project/radare2/shlr/ar/ar.c" 3 4
 "llx" 
# 205 "project/radare2/shlr/ar/ar.c"
 ")\n", arf->name, h_off
...
# 240 "project/radare2/shlr/ar/ar.c" 3 4
__attribute__((visibility("default"))) 
# 240 "project/radare2/shlr/ar/ar.c"
     RArFp *ar_open_file(const char *arname, const char *filename) {
 RArFp *ret = 
# 241 "project/radare2/shlr/ar/ar.c" 3 4
             ((void *)0)
# 241 "project/radare2/shlr/ar/ar.c"
                 ;
 ...
 if (ar_open_all_cb (arname, (RArOpenManyCB)__ar_open_file_cb, (void *)&data) < 0) {
  ar_close (ret);
  return 
# 247 "project/radare2/shlr/ar/ar.c" 3 4
        ((void *)0)
# 247 "project/radare2/shlr/ar/ar.c"
            ;
 }
 return ret;
}
...
# 269 "project/radare2/shlr/ar/ar.c" 3 4
__attribute__((visibility("default"))) 
# 269 "project/radare2/shlr/ar/ar.c"
     RList *ar_open_all(const char *arname) {
 ...
 if (!list) {
  return 
# 272 "project/radare2/shlr/ar/ar.c" 3 4
        ((void *)0)
# 272 "project/radare2/shlr/ar/ar.c"
            ;
 }
 ...
 r_list_free (list);
 return 
# 278 "project/radare2/shlr/ar/ar.c" 3 4
       ((void *)0)
# 278 "project/radare2/shlr/ar/ar.c"
           ;
}
# 293 "project/radare2/shlr/ar/ar.c"

# 293 "project/radare2/shlr/ar/ar.c" 3 4
__attribute__((visibility("default"))) 
# 293 "project/radare2/shlr/ar/ar.c"
     int ar_open_all_cb(const char *arname, RArOpenManyCB cb, void *user) {
 
# 294 "project/radare2/shlr/ar/ar.c" 3 4
do { if (!(
# 294 "project/radare2/shlr/ar/ar.c"
arname
# 294 "project/radare2/shlr/ar/ar.c" 3 4
)) { r_assert_log (R_LOGLVL_WARN, "%s: assertion '%s' failed (line %d)\n", ((const char*) (__func__)), 
# 294 "project/radare2/shlr/ar/ar.c"
...
# 294 "project/radare2/shlr/ar/ar.c"
                                 ;
 RBuffer *b = r_buf_new_file (arname, 
# 295 "project/radare2/shlr/ar/ar.c" 3 4
                                     0x0002
# 295 "project/radare2/shlr/ar/ar.c"
                                           , 0);
 if (!b) {
  
# 297 "project/radare2/shlr/ar/ar.c" 3 4
 r_sys_perror_str(
# 297 "project/radare2/shlr/ar/ar.c"
 __FUNCTION__
# 297 "project/radare2/shlr/ar/ar.c" 3 4
 );
# 297 "project/radare2/shlr/ar/ar.c"
 ...
 r_buf_seek (b, 0, 
# 301 "project/radare2/shlr/ar/ar.c" 3 4
                  2
# 301 "project/radare2/shlr/ar/ar.c"
                           );
 
# 302 "project/radare2/shlr/ar/ar.c" 3 4
unsigned long long 
# 302 "project/radare2/shlr/ar/ar.c"
     arsize = r_buf_tell (b);
 r_buf_seek (b, 0, 
# 303 "project/radare2/shlr/ar/ar.c" 3 4
                  0
# 303 "project/radare2/shlr/ar/ar.c"
                           );
 ...
 filetable tbl = { 
# 310 "project/radare2/shlr/ar/ar.c" 3 4
                  ((void *)0)
# 310 "project/radare2/shlr/ar/ar.c"
                      , 0, 0 };

 
# 312 "project/radare2/shlr/ar/ar.c" 3 4
unsigned int 
# 312 "project/radare2/shlr/ar/ar.c"
     *refc = 
# 312 "project/radare2/shlr/ar/ar.c" 3 4
...
# 353 "project/radare2/shlr/ar/ar.c" 3 4
__attribute__((visibility("default"))) 
# 353 "project/radare2/shlr/ar/ar.c"
     int ar_close(RArFp *f) {
 if (f) {
  free (f->name);
  (*f->refcount)--;
...
# 368 "project/radare2/shlr/ar/ar.c" 3 4
__attribute__((visibility("default"))) 
# 368 "project/radare2/shlr/ar/ar.c"
     int ar_read_at(RArFp *f, 
# 368 "project/radare2/shlr/ar/ar.c" 3 4
                              unsigned long long 
# 368 "project/radare2/shlr/ar/ar.c"
...
# 379 "project/radare2/shlr/ar/ar.c" 3 4
__attribute__((visibility("default"))) 
# 379 "project/radare2/shlr/ar/ar.c"
     int ar_write_at(RArFp *f, 
# 379 "project/radare2/shlr/ar/ar.c" 3 4
                               unsigned long long 
# 379 "project/radare2/shlr/ar/ar.c"
