# 0 "project/radare2/shlr/spp/r_api.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/spp/r_api.c"
...
# 26 "project/radare2/shlr/spp/spp.h"
...
#define __BSD__ 0
#define __UNIX__ 1
# 63 "project/radare2/shlr/spp/spp.h"
#define MAXIFL 128
...
#define DEFAULT_PROC(x) struct Tag *tags = (struct Tag *)&x ##_tags; struct Arg *args = (struct Arg *)&x ##_args; struct Proc *proc = &x ##_proc;
...
#define HAVE_FORK 1
# 9 "project/radare2/shlr/spp/r_api.c" 2
...
# 10 "project/radare2/shlr/spp/r_api.c" 2
