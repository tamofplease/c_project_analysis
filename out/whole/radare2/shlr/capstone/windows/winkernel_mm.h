# 0 "project/radare2/shlr/capstone/windows/winkernel_mm.h"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/capstone/windows/winkernel_mm.h"
...
# 12 "project/radare2/shlr/capstone/windows/winkernel_mm.h" 2


# 13 "project/radare2/shlr/capstone/windows/winkernel_mm.h"
void cs_winkernel_free(void *ptr);
void * cs_winkernel_malloc(size_t size);
void * cs_winkernel_calloc(size_t n, size_t size);
void * cs_winkernel_realloc(void *ptr, size_t size);
int cs_winkernel_vsnprintf(char *buffer, size_t count, const char *format, va_list argptr);
