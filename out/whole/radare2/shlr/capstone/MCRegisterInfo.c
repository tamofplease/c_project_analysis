# 0 "project/radare2/shlr/capstone/MCRegisterInfo.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 18 "project/radare2/shlr/capstone/MCRegisterInfo.c" 2
...
static 
# 64 "project/radare2/shlr/capstone/MCRegisterInfo.c" 3 4
      _Bool 
# 64 "project/radare2/shlr/capstone/MCRegisterInfo.c"
           DiffListIterator_next(DiffListIterator *d)
{
 MCPhysReg D;

 if (d->List == 0)
  return 
# 69 "project/radare2/shlr/capstone/MCRegisterInfo.c" 3 4
        0
# 69 "project/radare2/shlr/capstone/MCRegisterInfo.c"
             ;
...
static 
# 81 "project/radare2/shlr/capstone/MCRegisterInfo.c" 3 4
      _Bool 
# 81 "project/radare2/shlr/capstone/MCRegisterInfo.c"
           DiffListIterator_isValid(DiffListIterator *d)
{
 return (d->List != 0);
}
...
# 134 "project/radare2/shlr/capstone/MCRegisterInfo.c" 3 4
_Bool 
# 134 "project/radare2/shlr/capstone/MCRegisterInfo.c"
    MCRegisterClass_contains(const MCRegisterClass *c, unsigned Reg)
{
 ...
 if (Byte >= c->RegSetSize)
  return 
# 140 "project/radare2/shlr/capstone/MCRegisterInfo.c" 3 4
        0
# 140 "project/radare2/shlr/capstone/MCRegisterInfo.c"
             ;
