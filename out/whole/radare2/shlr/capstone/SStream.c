# 0 "project/radare2/shlr/capstone/SStream.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/capstone/SStream.c"
...
#define __va_list__ 
# 5 "project/radare2/shlr/capstone/SStream.c" 2
...
# 11 "project/radare2/shlr/capstone/SStream.c" 2
...
# 12 "project/radare2/shlr/capstone/SStream.c" 2
...
# 14 "project/radare2/shlr/capstone/SStream.c" 2
...
# 16 "project/radare2/shlr/capstone/SStream.c" 2
...
# 18 "project/radare2/shlr/capstone/SStream.c" 2
...
# 16 "/usr/local/include/capstone/capstone.h" 3 4
...
# 19 "project/radare2/shlr/capstone/SStream.c" 2
...
# 19 "project/radare2/shlr/capstone/utils.h"
...
# 20 "project/radare2/shlr/capstone/SStream.c" 2
...
# 36 "project/radare2/shlr/capstone/SStream.c" 3 4
__builtin___memcpy_chk (
# 36 "project/radare2/shlr/capstone/SStream.c"
ss->buffer + ss->index
# 36 "project/radare2/shlr/capstone/SStream.c" 3 4
, 
# 36 "project/radare2/shlr/capstone/SStream.c"
...
# 57 "project/radare2/shlr/capstone/SStream.c" 3 4
__builtin_va_start(
# 57 "project/radare2/shlr/capstone/SStream.c"
ap
# 57 "project/radare2/shlr/capstone/SStream.c" 3 4
,
# 57 "project/radare2/shlr/capstone/SStream.c"
...
# 59 "project/radare2/shlr/capstone/SStream.c" 3 4
__builtin_va_end(
# 59 "project/radare2/shlr/capstone/SStream.c"
ap
# 59 "project/radare2/shlr/capstone/SStream.c" 3 4
)
# 59 "project/radare2/shlr/capstone/SStream.c"
...
void printInt64Bang(SStream *O, int64_t val)
{
 if (val >= 0) {
  if (val > 9)
   SStream_concat(O, "#0x%"
# 69 "project/radare2/shlr/capstone/SStream.c" 3 4
                          "ll" "x"
# 69 "project/radare2/shlr/capstone/SStream.c"
                                , val);
  else
   SStream_concat(O, "#%"
# 71 "project/radare2/shlr/capstone/SStream.c" 3 4
                        "ll" "u"
# 71 "project/radare2/shlr/capstone/SStream.c"
                              , val);
 } else {
  if (val <- 9) {
   if (val == 
# 74 "project/radare2/shlr/capstone/SStream.c" 3 4
             (-0x7fffffffffffffffL - 1L)
# 74 "project/radare2/shlr/capstone/SStream.c"
                     )
    SStream_concat(O, "#-0x%"
# 75 "project/radare2/shlr/capstone/SStream.c" 3 4
                            "ll" "x"
# 75 "project/radare2/shlr/capstone/SStream.c"
                                  , (uint64_t)val);
   else
    SStream_concat(O, "#-0x%"
# 77 "project/radare2/shlr/capstone/SStream.c" 3 4
                            "ll" "x"
# 77 "project/radare2/shlr/capstone/SStream.c"
                                  , (uint64_t)-val);
  } else
   SStream_concat(O, "#-%"
# 79 "project/radare2/shlr/capstone/SStream.c" 3 4
                         "ll" "u"
# 79 "project/radare2/shlr/capstone/SStream.c"
                               , -val);
 }
}
...
void printUInt64Bang(SStream *O, uint64_t val)
{
 if (val > 9)
  SStream_concat(O, "#0x%"
# 86 "project/radare2/shlr/capstone/SStream.c" 3 4
                         "ll" "x"
# 86 "project/radare2/shlr/capstone/SStream.c"
                               , val);
 else
  SStream_concat(O, "#%"
# 88 "project/radare2/shlr/capstone/SStream.c" 3 4
                       "ll" "u"
# 88 "project/radare2/shlr/capstone/SStream.c"
                             , val);
}
...
void printInt64(SStream *O, int64_t val)
{
 if (val >= 0) {
  if (val > 9)
   SStream_concat(O, "0x%"
# 96 "project/radare2/shlr/capstone/SStream.c" 3 4
                         "ll" "x"
# 96 "project/radare2/shlr/capstone/SStream.c"
                               , val);
  else
   SStream_concat(O, "%"
# 98 "project/radare2/shlr/capstone/SStream.c" 3 4
                       "ll" "u"
# 98 "project/radare2/shlr/capstone/SStream.c"
                             , val);
 } else {
  if (val <- 9) {
   if (val == 
# 101 "project/radare2/shlr/capstone/SStream.c" 3 4
             (-0x7fffffffffffffffL - 1L)
# 101 "project/radare2/shlr/capstone/SStream.c"
                     )
    SStream_concat(O, "-0x%"
# 102 "project/radare2/shlr/capstone/SStream.c" 3 4
                           "ll" "x"
# 102 "project/radare2/shlr/capstone/SStream.c"
                                 , (uint64_t)val);
   else
    SStream_concat(O, "-0x%"
# 104 "project/radare2/shlr/capstone/SStream.c" 3 4
                           "ll" "x"
# 104 "project/radare2/shlr/capstone/SStream.c"
                                 , (uint64_t)-val);
  } else
   SStream_concat(O, "-%"
# 106 "project/radare2/shlr/capstone/SStream.c" 3 4
                        "ll" "u"
# 106 "project/radare2/shlr/capstone/SStream.c"
                              , -val);
 }
}
...
void printUInt64(SStream *O, uint64_t val)
{
 if (val > 9)
  SStream_concat(O, "0x%"
# 113 "project/radare2/shlr/capstone/SStream.c" 3 4
                        "ll" "x"
# 113 "project/radare2/shlr/capstone/SStream.c"
                              , val);
 else
  SStream_concat(O, "%"
# 115 "project/radare2/shlr/capstone/SStream.c" 3 4
                      "ll" "u"
# 115 "project/radare2/shlr/capstone/SStream.c"
                            , val);
}
...
void printInt32BangDec(SStream *O, int32_t val)
{
 if (val >= 0)
  ...
  if (val == 
# 124 "project/radare2/shlr/capstone/SStream.c" 3 4
            (-0x7fffffff - 1)
# 124 "project/radare2/shlr/capstone/SStream.c"
                   )
   SStream_concat(O, "#-%u", val);
  else
...
void printInt32Bang(SStream *O, int32_t val)
{
 if (val >= 0) {
  ...
  if (val <- 9) {
   if (val == 
# 140 "project/radare2/shlr/capstone/SStream.c" 3 4
             (-0x7fffffff - 1)
# 140 "project/radare2/shlr/capstone/SStream.c"
                    )
...
void printInt32(SStream *O, int32_t val)
{
 if (val >= 0) {
  ...
  if (val <- 9) {
   if (val == 
# 158 "project/radare2/shlr/capstone/SStream.c" 3 4
             (-0x7fffffff - 1)
# 158 "project/radare2/shlr/capstone/SStream.c"
                    )
    SStream_concat(O, "-0x%x", (uint32_t)val);
   else
    SStream_concat(O, "-0x%x", (uint32_t)-val);
