# 0 "project/radare2/shlr/capstone/tests/test_customized_mnem.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 8 "project/radare2/shlr/capstone/tests/test_customized_mnem.c" 2
...
# 9 "project/radare2/shlr/capstone/tests/test_customized_mnem.c" 2
...
# 11 "project/radare2/shlr/capstone/tests/test_customized_mnem.c" 2
...
# 12 "project/radare2/shlr/capstone/tests/test_customized_mnem.c" 2

#define X86_CODE32 "\x75\x01"



# 16 "project/radare2/shlr/capstone/tests/test_customized_mnem.c"
...
static void print_insn(csh handle)
{
 ...
 count = cs_disasm(handle, (const uint8_t *)"\x75\x01", sizeof("\x75\x01") - 1, 0x1000, 1, &insn);
 if (count) {
  print_string_hex((unsigned char *)"\x75\x01", sizeof("\x75\x01") - 1);
...
static void test()
{
 ...
 cs_opt_mnem default_mnem = { X86_INS_JNE, 
# 51 "project/radare2/shlr/capstone/tests/test_customized_mnem.c" 3 4
                                          ((void *)0) 
# 51 "project/radare2/shlr/capstone/tests/test_customized_mnem.c"
                                               };
