# 0 "project/radare2/shlr/capstone/tests/test_wasm.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/capstone/tests/test_wasm.c"
...
# 5 "project/radare2/shlr/capstone/tests/test_wasm.c" 2
...
# 6 "project/radare2/shlr/capstone/tests/test_wasm.c" 2
...
# 8 "project/radare2/shlr/capstone/tests/test_wasm.c" 2
...
# 9 "project/radare2/shlr/capstone/tests/test_wasm.c" 2


# 10 "project/radare2/shlr/capstone/tests/test_wasm.c"
static csh handle;
...
static void print_insn_detail(csh cs_handle, cs_insn *ins)
{
 ...
 if (ins->detail == 
# 37 "project/radare2/shlr/capstone/tests/test_wasm.c" 3 4
                   ((void *)0)
# 37 "project/radare2/shlr/capstone/tests/test_wasm.c"
                       )
  return;
  ...
  for (i = 0; i < wasm->op_count; i++) {
   switch (wasm->operands[i].type) {
    ...
    case WASM_OP_UINT64:
     ...
     printf("\t\tOperand[%u] value: 0x%" 
# 71 "project/radare2/shlr/capstone/tests/test_wasm.c" 3 4
                                        "ll" "x" 
# 71 "project/radare2/shlr/capstone/tests/test_wasm.c"
    ...
    case WASM_OP_VARUINT64:
     ...
     printf("\t\tOperand[%u] value: 0x%" 
# 79 "project/radare2/shlr/capstone/tests/test_wasm.c" 3 4
                                        "ll" "x" 
# 79 "project/radare2/shlr/capstone/tests/test_wasm.c"
...
#define WASM_CODE "\x20\x00\x20\x01\x41\x20\x10\xc9\x01\x45\x0b"
 struct platform platforms[] = {
  {
   CS_ARCH_WASM,
   0,
   (unsigned char *)"\x20\x00\x20\x01\x41\x20\x10\xc9\x01\x45\x0b",
   sizeof("\x20\x00\x20\x01\x41\x20\x10\xc9\x01\x45\x0b") - 1,
   "WASM"
  },
 };
 ...
 for (i = 0; i < sizeof(platforms)/sizeof(platforms[0]); i++) {
  ...
  if (count) {
   ...
   for (j = 0; j < count; j++) {
    printf("0x%" 
# 123 "project/radare2/shlr/capstone/tests/test_wasm.c" 3 4
                "ll" "x" 
# 123 "project/radare2/shlr/capstone/tests/test_wasm.c"
                       ":\t%s\t%s\n", insn[j].address, insn[j].mnemonic, insn[j].op_str);
    print_insn_detail(handle, &insn[j]);
   }
   printf("0x%" 
# 126 "project/radare2/shlr/capstone/tests/test_wasm.c" 3 4
               "ll" "x" 
# 126 "project/radare2/shlr/capstone/tests/test_wasm.c"
