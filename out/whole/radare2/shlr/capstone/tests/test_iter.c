# 0 "project/radare2/shlr/capstone/tests/test_iter.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/capstone/tests/test_iter.c"
...
# 6 "project/radare2/shlr/capstone/tests/test_iter.c" 2
...
# 7 "project/radare2/shlr/capstone/tests/test_iter.c" 2
...
# 9 "project/radare2/shlr/capstone/tests/test_iter.c" 2
...
# 10 "project/radare2/shlr/capstone/tests/test_iter.c" 2


# 11 "project/radare2/shlr/capstone/tests/test_iter.c"
struct platform {
 cs_arch arch;
 cs_mode mode;
 unsigned char *code;
...
static void test()
{
# 71 "project/radare2/shlr/capstone/tests/test_iter.c"
...
# 252 "project/radare2/shlr/capstone/tests/test_iter.c"
 };
 ...
 for (i = 0; i < sizeof(platforms)/sizeof(platforms[0]); i++) {
  ...
  while(cs_disasm_iter(handle, &code, &size, &address, insn)) {
   ...
   printf("0x%" 
# 289 "project/radare2/shlr/capstone/tests/test_iter.c" 3 4
               "ll" "x" 
# 289 "project/radare2/shlr/capstone/tests/test_iter.c"
