# 0 "project/radare2/shlr/capstone/tests/test_basic.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/capstone/tests/test_basic.c"
...
# 5 "project/radare2/shlr/capstone/tests/test_basic.c" 2
...
# 6 "project/radare2/shlr/capstone/tests/test_basic.c" 2
...
# 8 "project/radare2/shlr/capstone/tests/test_basic.c" 2
...
# 9 "project/radare2/shlr/capstone/tests/test_basic.c" 2


# 10 "project/radare2/shlr/capstone/tests/test_basic.c"
struct platform {
 cs_arch arch;
 cs_mode mode;
 unsigned char *code;
...
static void test()
{
# 87 "project/radare2/shlr/capstone/tests/test_basic.c"
...
# 366 "project/radare2/shlr/capstone/tests/test_basic.c"
 };
 ...
 for (i = 0; i < sizeof(platforms)/sizeof(platforms[0]); i++) {
  ...
  if (count) {
   ...
   for (j = 0; j < count; j++) {
    printf("0x%" 
# 395 "project/radare2/shlr/capstone/tests/test_basic.c" 3 4
                "ll" "x" 
# 395 "project/radare2/shlr/capstone/tests/test_basic.c"
                       ":\t%s\t\t%s\n",
   ...
   printf("0x%" 
# 400 "project/radare2/shlr/capstone/tests/test_basic.c" 3 4
               "ll" "x" 
# 400 "project/radare2/shlr/capstone/tests/test_basic.c"
