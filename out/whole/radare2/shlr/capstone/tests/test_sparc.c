# 0 "project/radare2/shlr/capstone/tests/test_sparc.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/capstone/tests/test_sparc.c"
...
# 5 "project/radare2/shlr/capstone/tests/test_sparc.c" 2
...
# 7 "project/radare2/shlr/capstone/tests/test_sparc.c" 2
...
# 8 "project/radare2/shlr/capstone/tests/test_sparc.c" 2


# 9 "project/radare2/shlr/capstone/tests/test_sparc.c"
struct platform {
 cs_arch arch;
 cs_mode mode;
 unsigned char *code;
...
static void print_insn_detail(cs_insn *ins)
{
 ...
 if (ins->detail == 
# 37 "project/radare2/shlr/capstone/tests/test_sparc.c" 3 4
                   ((void *)0)
# 37 "project/radare2/shlr/capstone/tests/test_sparc.c"
                       )
  return;
...
# 53 "project/radare2/shlr/capstone/tests/test_sparc.c" 3 4
                                             "ll" "x" 
# 53 "project/radare2/shlr/capstone/tests/test_sparc.c"
                                                    "\n", i, op->imm);
    break;
   case SPARC_OP_MEM:
...
#define SPARCV9_CODE "\x81\xa8\x0a\x24\x89\xa0\x10\x20\x89\xa0\x1a\x60\x89\xa0\x00\xe0"
 ...
 struct platform platforms[] = {
  {
   CS_ARCH_SPARC,
   CS_MODE_BIG_ENDIAN,
   (unsigned char*)"",
   sizeof("") - 1,
   "Sparc",
  },
  {
   CS_ARCH_SPARC,
   (cs_mode)(CS_MODE_BIG_ENDIAN + CS_MODE_V9),
   (unsigned char*)"\x81\xa8\x0a\x24\x89\xa0\x10\x20\x89\xa0\x1a\x60\x89\xa0\x00\xe0",
   sizeof("\x81\xa8\x0a\x24\x89\xa0\x10\x20\x89\xa0\x1a\x60\x89\xa0\x00\xe0") - 1,
   "SparcV9"
  },
 };
 ...
 for (i = 0; i < sizeof(platforms)/sizeof(platforms[0]); i++) {
  ...
  if (count) {
   ...
   for (j = 0; j < count; j++) {
    printf("0x%" 
# 126 "project/radare2/shlr/capstone/tests/test_sparc.c" 3 4
                "ll" "x" 
# 126 "project/radare2/shlr/capstone/tests/test_sparc.c"
                       ":\t%s\t%s\n", insn[j].address, insn[j].mnemonic, insn[j].op_str);
    print_insn_detail(&insn[j]);
   }
   printf("0x%" 
# 129 "project/radare2/shlr/capstone/tests/test_sparc.c" 3 4
               "ll" "x" 
# 129 "project/radare2/shlr/capstone/tests/test_sparc.c"
