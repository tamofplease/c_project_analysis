# 0 "project/radare2/shlr/capstone/tests/test_bpf.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/capstone/tests/test_bpf.c"
...
# 5 "project/radare2/shlr/capstone/tests/test_bpf.c" 2
# 1 "/usr/local/include/capstone/platform.h" 1 3 4
# 6 "project/radare2/shlr/capstone/tests/test_bpf.c" 2


# 7 "project/radare2/shlr/capstone/tests/test_bpf.c"
static csh handle;
...
static void print_insn_detail(csh cs_handle, cs_insn *ins)
{
 ...
 if (ins->detail == 
# 41 "project/radare2/shlr/capstone/tests/test_bpf.c" 3 4
                   ((void *)0)
# 41 "project/radare2/shlr/capstone/tests/test_bpf.c"
                       )
  return;
 ...
 for (i = 0; i < bpf->op_count; i++) {
  ...
  case BPF_OP_IMM:
   printf("IMM = 0x%" 
# 67 "project/radare2/shlr/capstone/tests/test_bpf.c" 3 4
                     "ll" "x" 
# 67 "project/radare2/shlr/capstone/tests/test_bpf.c"
                            "\n", op->imm);
   break;
  case BPF_OP_OFF:
   printf("OFF = +0x%x\n", op->off);
...
static void test()
{
#define CBPF_CODE "\x94\x09\x00\x00\x37\x13\x03\x00" "\x87\x00\x00\x00\x00\x00\x00\x00" "\x07\x00\x00\x00\x00\x00\x00\x00" "\x16\x00\x00\x00\x00\x00\x00\x00" "\x80\x00\x00\x00\x00\x00\x00\x00"
...
#define EBPF_CODE "\x97\x09\x00\x00\x37\x13\x03\x00" "\xdc\x02\x00\x00\x20\x00\x00\x00" "\x30\x00\x00\x00\x00\x00\x00\x00" "\xdb\x3a\x00\x01\x00\x00\x00\x00" "\x84\x02\x00\x00\x00\x00\x00\x00" "\x6d\x33\x17\x02\x00\x00\x00\x00"
 ...
 struct platform platforms[] = {
  {
   ...
   (unsigned char *)"\x94\x09\x00\x00\x37\x13\x03\x00" "\x87\x00\x00\x00\x00\x00\x00\x00" "\x07\x00\x00\x00\x00\x00\x00\x00" "\x16\x00\x00\x00\x00\x00\x00\x00" "\x80\x00\x00\x00\x00\x00\x00\x00",
   sizeof("\x94\x09\x00\x00\x37\x13\x03\x00" "\x87\x00\x00\x00\x00\x00\x00\x00" "\x07\x00\x00\x00\x00\x00\x00\x00" "\x16\x00\x00\x00\x00\x00\x00\x00" "\x80\x00\x00\x00\x00\x00\x00\x00") - 1,
   "cBPF Le"
  },
  {
   CS_ARCH_BPF,
   CS_MODE_LITTLE_ENDIAN | CS_MODE_BPF_EXTENDED,
   (unsigned char *)"\x97\x09\x00\x00\x37\x13\x03\x00" "\xdc\x02\x00\x00\x20\x00\x00\x00" "\x30\x00\x00\x00\x00\x00\x00\x00" "\xdb\x3a\x00\x01\x00\x00\x00\x00" "\x84\x02\x00\x00\x00\x00\x00\x00" "\x6d\x33\x17\x02\x00\x00\x00\x00",
   sizeof("\x97\x09\x00\x00\x37\x13\x03\x00" "\xdc\x02\x00\x00\x20\x00\x00\x00" "\x30\x00\x00\x00\x00\x00\x00\x00" "\xdb\x3a\x00\x01\x00\x00\x00\x00" "\x84\x02\x00\x00\x00\x00\x00\x00" "\x6d\x33\x17\x02\x00\x00\x00\x00") - 1,
   "eBPF Le"
  },
 };
 ...
 for (i = 0; i < sizeof(platforms)/sizeof(platforms[0]); i++) {
  ...
  if (count) {
   ...
   for (j = 0; j < count; j++) {
    printf("0x%" 
# 165 "project/radare2/shlr/capstone/tests/test_bpf.c" 3 4
                "ll" "x" 
# 165 "project/radare2/shlr/capstone/tests/test_bpf.c"
