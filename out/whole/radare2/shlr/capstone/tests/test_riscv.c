# 0 "project/radare2/shlr/capstone/tests/test_riscv.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/capstone/tests/test_riscv.c"
...
# 2 "project/radare2/shlr/capstone/tests/test_riscv.c" 2
...
# 3 "project/radare2/shlr/capstone/tests/test_riscv.c" 2
...
# 5 "project/radare2/shlr/capstone/tests/test_riscv.c" 2
...
# 6 "project/radare2/shlr/capstone/tests/test_riscv.c" 2


# 7 "project/radare2/shlr/capstone/tests/test_riscv.c"
struct platform {
 cs_arch arch;
 cs_mode mode;
 unsigned char *code;
...
static void print_insn_detail(cs_insn *ins)
{
 ...
 if (ins->detail == 
# 37 "project/radare2/shlr/capstone/tests/test_riscv.c" 3 4
                   ((void *)0)
# 37 "project/radare2/shlr/capstone/tests/test_riscv.c"
                       )
  return;
...
# 55 "project/radare2/shlr/capstone/tests/test_riscv.c" 3 4
                                             "ll" "x" 
# 55 "project/radare2/shlr/capstone/tests/test_riscv.c"
                                                    "\n", i, op->imm);
    break;
   case RISCV_OP_MEM:
...
# 63 "project/radare2/shlr/capstone/tests/test_riscv.c" 3 4
                                              "ll" "x" 
# 63 "project/radare2/shlr/capstone/tests/test_riscv.c"
                                                     "\n", i, op->mem.disp);
...
#define RISCV_CODE64 "\x13\x04\xa8\x7a"
 struct platform platforms[] = {
  {
   CS_ARCH_RISCV,
   CS_MODE_RISCV32,
   (unsigned char *)"",
   sizeof("") - 1,
   "riscv32"
  },
  {
   CS_ARCH_RISCV,
   CS_MODE_RISCV64,
   (unsigned char *)"\x13\x04\xa8\x7a",
   sizeof("\x13\x04\xa8\x7a") - 1,
   "riscv64"
  }
 };
 ...
 for (i = 0; i < sizeof(platforms)/sizeof(platforms[0]); i++) {
  ...
  if (count) {
   ...
   for (j = 0; j < count; j++) {
    printf("0x%" 
# 129 "project/radare2/shlr/capstone/tests/test_riscv.c" 3 4
                "ll" "x" 
# 129 "project/radare2/shlr/capstone/tests/test_riscv.c"
                       ":\t%s\t%s\n", insn[j].address, insn[j].mnemonic, insn[j].op_str);
    print_insn_detail(&insn[j]);
   }
   printf("0x%" 
# 132 "project/radare2/shlr/capstone/tests/test_riscv.c" 3 4
               "ll" "x" 
# 132 "project/radare2/shlr/capstone/tests/test_riscv.c"
