# 0 "project/radare2/shlr/capstone/cstool/cstool_evm.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 2 "project/radare2/shlr/capstone/cstool/cstool_evm.c" 2
...
# 3 "project/radare2/shlr/capstone/cstool/cstool_evm.c" 2
...
# 5 "project/radare2/shlr/capstone/cstool/cstool_evm.c" 2


# 6 "project/radare2/shlr/capstone/cstool/cstool_evm.c"
...
void print_insn_detail_evm(csh handle, cs_insn *ins)
{
 ...
 if (ins->detail == 
# 13 "project/radare2/shlr/capstone/cstool/cstool_evm.c" 3 4
                   ((void *)0)
# 13 "project/radare2/shlr/capstone/cstool/cstool_evm.c"
                       )
  return;
