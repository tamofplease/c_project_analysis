# 0 "project/radare2/shlr/capstone/cstool/cstool.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/capstone/cstool/cstool.c"
...
# 5 "project/radare2/shlr/capstone/cstool/cstool.c" 2
...
# 6 "project/radare2/shlr/capstone/cstool/cstool.c" 2
...
# 7 "project/radare2/shlr/capstone/cstool/cstool.c" 2
# 1 "project/radare2/shlr/capstone/cstool/getopt.h" 1

#define CSTOOL_GETOPT_H 



# 5 "project/radare2/shlr/capstone/cstool/getopt.h"
extern int opterr,
optind,
optopt,
optreset;
...
# 8 "project/radare2/shlr/capstone/cstool/cstool.c" 2
...
# 10 "project/radare2/shlr/capstone/cstool/cstool.c" 2


# 11 "project/radare2/shlr/capstone/cstool/cstool.c"
...
static struct {
 ...
 { "x16att", CS_ARCH_X86, CS_MODE_16 },
 { "x32", CS_ARCH_X86, CS_MODE_32 },
 { "x32att", CS_ARCH_X86, CS_MODE_32 },
 { "x64", CS_ARCH_X86, CS_MODE_64 },
 { "x64att", CS_ARCH_X86, CS_MODE_64 },
 ...
 { 
# 88 "project/radare2/shlr/capstone/cstool/cstool.c" 3 4
  ((void *)0) 
# 88 "project/radare2/shlr/capstone/cstool/cstool.c"
       }
};
...
static uint8_t *preprocess(char *code, size_t *size)
{
 ...
 if (strlen(code) == 0)
  return 
# 146 "project/radare2/shlr/capstone/cstool/cstool.c" 3 4
        ((void *)0)
# 146 "project/radare2/shlr/capstone/cstool/cstool.c"
            ;

 result = (uint8_t *)malloc(strlen(code));
 if (result != 
# 149 "project/radare2/shlr/capstone/cstool/cstool.c" 3 4
              ((void *)0)
# 149 "project/radare2/shlr/capstone/cstool/cstool.c"
                  ) {
  while (code[i] != '\0') {
...
# 168 "project/radare2/shlr/capstone/cstool/cstool.c" 3 4
                                                                4
# 168 "project/radare2/shlr/capstone/cstool/cstool.c"
                                                                                , 
# 168 "project/radare2/shlr/capstone/cstool/cstool.c" 3 4
                                                                                  0
# 168 "project/radare2/shlr/capstone/cstool/cstool.c"
...
# 365 "project/radare2/shlr/capstone/cstool/cstool.c" 3 4
_Bool 
# 365 "project/radare2/shlr/capstone/cstool/cstool.c"
     detail_flag = 
# 365 "project/radare2/shlr/capstone/cstool/cstool.c" 3 4
                   0
# 365 "project/radare2/shlr/capstone/cstool/cstool.c"
...
# 366 "project/radare2/shlr/capstone/cstool/cstool.c" 3 4
_Bool 
# 366 "project/radare2/shlr/capstone/cstool/cstool.c"
     unsigned_flag = 
# 366 "project/radare2/shlr/capstone/cstool/cstool.c" 3 4
                     0
# 366 "project/radare2/shlr/capstone/cstool/cstool.c"
...
# 367 "project/radare2/shlr/capstone/cstool/cstool.c" 3 4
_Bool 
# 367 "project/radare2/shlr/capstone/cstool/cstool.c"
     skipdata = 
# 367 "project/radare2/shlr/capstone/cstool/cstool.c" 3 4
                0
# 367 "project/radare2/shlr/capstone/cstool/cstool.c"
 ...
 while ((c = getopt (argc, argv, "sudhv")) != -1) {
  switch (c) {
   case 's':
    skipdata = 
# 373 "project/radare2/shlr/capstone/cstool/cstool.c" 3 4
              1
# 373 "project/radare2/shlr/capstone/cstool/cstool.c"
                  ;
    break;
   case 'u':
    unsigned_flag = 
# 376 "project/radare2/shlr/capstone/cstool/cstool.c" 3 4
                   1
# 376 "project/radare2/shlr/capstone/cstool/cstool.c"
                       ;
    break;
   case 'd':
    detail_flag = 
# 379 "project/radare2/shlr/capstone/cstool/cstool.c" 3 4
                 1
# 379 "project/radare2/shlr/capstone/cstool/cstool.c"
                     ;
    break;
   case 'v':
    printf("cstool for Capstone Disassembler, v%u.%u.%u\n", 
# 382 "project/radare2/shlr/capstone/cstool/cstool.c" 3 4
                                                           4
# 382 "project/radare2/shlr/capstone/cstool/cstool.c"
                                                                           , 
# 382 "project/radare2/shlr/capstone/cstool/cstool.c" 3 4
                                                                             0
# 382 "project/radare2/shlr/capstone/cstool/cstool.c"
...
# 382 "project/radare2/shlr/capstone/cstool/cstool.c"
    ...
    if (cs_support(
# 449 "project/radare2/shlr/capstone/cstool/cstool.c" 3 4
                  (CS_ARCH_ALL + 1)
# 449 "project/radare2/shlr/capstone/cstool/cstool.c"
                                 )) {
     printf("diet=1 ");
    }

    if (cs_support(
# 453 "project/radare2/shlr/capstone/cstool/cstool.c" 3 4
                  (CS_ARCH_ALL + 2)
# 453 "project/radare2/shlr/capstone/cstool/cstool.c"
                                       )) {
     printf("x86_reduce=1 ");
    }
 ...
 if (args_left == 3) {
  ...
  if (temp == src || *temp != '\0' || 
# 484 "project/radare2/shlr/capstone/cstool/cstool.c" 3 4
                                     (*__error()) 
# 484 "project/radare2/shlr/capstone/cstool/cstool.c"
                                           == 
# 484 "project/radare2/shlr/capstone/cstool/cstool.c" 3 4
                                              34
# 484 "project/radare2/shlr/capstone/cstool/cstool.c"
 ...
 if (count > 0) {
  ...
  for (i = 0; i < count; i++) {
   ...
   printf("%2"
# 535 "project/radare2/shlr/capstone/cstool/cstool.c" 3 4
             "ll" "x"
# 535 "project/radare2/shlr/capstone/cstool/cstool.c"
                   "  ", insn[i].address);
