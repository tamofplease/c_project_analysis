# 0 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
# 9 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
...
# 10 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 2
...
# 11 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 2
...
# 12 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 2
...
# 14 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 2
...
# 15 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 2


# 16 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
static csh handle;
...
# 38 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
 __builtin___snprintf_chk (
# 38 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
 hex_out + (i*2)
# 38 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
 , 
# 38 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
...
#define _this_printf(...) { size_t used = 0; used = snprintf(buf + *cur, *left, __VA_ARGS__); *left -= used; *cur += used; }
 ...
 if (ins->detail == 
# 63 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
                   ((void *)0)
# 63 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
                       )
  return;
 ...
 if (arm->op_count)
  { size_t used = 0; used = 
# 69 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
 __builtin___snprintf_chk (
# 69 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
 buf + *cur
# 69 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
 , 
# 69 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
...
# 69 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
 ...
 for (i = 0; i < arm->op_count; i++) {
  ...
  switch((int)op->type) {
   ...
   case ARM_OP_REG:
    { size_t used = 0; used = 
# 77 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
   __builtin___snprintf_chk (
# 77 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
   buf + *cur
# 77 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
   , 
# 77 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
...
# 77 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
   ...
   case ARM_OP_IMM:
    { size_t used = 0; used = 
# 80 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
   __builtin___snprintf_chk (
# 80 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
   buf + *cur
# 80 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
   , 
# 80 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
...
# 80 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
   ...
   case ARM_OP_FP:
    { size_t used = 0; used = 
# 83 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
   __builtin___snprintf_chk (
# 83 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
   buf + *cur
# 83 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
   , 
# 83 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
...
# 83 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
   ...
   case ARM_OP_MEM:
    { size_t used = 0; used = 
# 86 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
   __builtin___snprintf_chk (
# 86 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
   buf + *cur
# 86 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
   , 
# 86 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
...
# 86 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
   ; *left -= used; *cur += used; };
    if (op->mem.base != X86_REG_INVALID)
     { size_t used = 0; used = 
# 88 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
    __builtin___snprintf_chk (
# 88 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
    buf + *cur
# 88 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
    , 
# 88 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
...
# 88 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
    ...
    if (op->mem.index != X86_REG_INVALID)
     { size_t used = 0; used = 
# 91 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
    __builtin___snprintf_chk (
# 91 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
    buf + *cur
# 91 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
    , 
# 91 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
...
# 91 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
    ...
    if (op->mem.scale != 1)
     { size_t used = 0; used = 
# 94 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
    __builtin___snprintf_chk (
# 94 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
    buf + *cur
# 94 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
    , 
# 94 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
...
# 94 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
    ...
    if (op->mem.disp != 0)
     { size_t used = 0; used = 
# 96 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
    __builtin___snprintf_chk (
# 96 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
    buf + *cur
# 96 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
    , 
# 96 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
...
# 96 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
   ...
   case ARM_OP_PIMM:
    { size_t used = 0; used = 
# 100 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
   __builtin___snprintf_chk (
# 100 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
   buf + *cur
# 100 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
   , 
# 100 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
...
# 100 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
   ...
   case ARM_OP_CIMM:
    { size_t used = 0; used = 
# 103 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
   __builtin___snprintf_chk (
# 103 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
   buf + *cur
# 103 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
   , 
# 103 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
...
# 103 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
  ...
  if (op->shift.type != ARM_SFT_INVALID && op->shift.value) {
   if (op->shift.type < ARM_SFT_ASR_REG) {
    ...
    { size_t used = 0; used = 
# 110 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
   __builtin___snprintf_chk (
# 110 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
   buf + *cur
# 110 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
   , 
# 110 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
...
# 110 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
   ; *left -= used; *cur += used; };
    ...
    { size_t used = 0; used = 
# 113 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
   __builtin___snprintf_chk (
# 113 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
   buf + *cur
# 113 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
   , 
# 113 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
...
# 113 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
 ...
 if (arm->cc != ARM_CC_AL && arm->cc != ARM_CC_INVALID) {
  { size_t used = 0; used = 
# 120 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
 __builtin___snprintf_chk (
# 120 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
 buf + *cur
# 120 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
 , 
# 120 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
...
# 120 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
 ...
 if (arm->update_flags) {
  { size_t used = 0; used = 
# 124 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
 __builtin___snprintf_chk (
# 124 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
 buf + *cur
# 124 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
 , 
# 124 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
...
# 124 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
 ...
 if (arm->writeback) {
  { size_t used = 0; used = 
# 128 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
 __builtin___snprintf_chk (
# 128 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
 buf + *cur
# 128 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
 , 
# 128 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
...
struct invalid_instructions {
 ...
 struct invalid_code invalid_codes[16];
};
...
static void test_invalids()
{
 ...
 struct invalid_instructions * invalid = 
# 173 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
                                        ((void *)0)
# 173 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
                                            ;
 ...
 for (i = 0; i < sizeof(invalids)/sizeof(invalids[0]); i++) {
  ...
  for (j = 0; j < invalid->num_invalid_codes; ++j) {
   struct invalid_code *invalid_code = 
# 199 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
                                      ((void *)0)
# 199 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
                                          ;
   char *hex_str = 
# 200 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
                  ((void *)0)
# 200 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
                      ;
   ...
   if (count) {
    ...
    for (k = 0; k < count; k++) {
     printf("    0x%"
# 219 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
                    "ll" "x"
# 219 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
                          ":\t%s\t%s\n",
...
struct valid_instructions {
 ...
 char *platform_comment;
 int num_valid_codes;
 struct valid_code valid_codes[16];
};
...
static void test_valids()
{
 ...
 struct valid_instructions * valid = 
# 289 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
                                    ((void *)0)
# 289 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
                                        ;
...
#define _this_printf(...) { size_t used = 0; used = snprintf(tmp_buf + cur, left, __VA_ARGS__); left -= used; cur += used; }
  ...
  for (j = 0; j < valid->num_valid_codes; ++j) {
   ...
   int success = 0;
   char * hex_str = 
# 328 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
                   ((void *)0)
# 328 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
                       ;

   struct valid_code * valid_code = 
# 330 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
                                   ((void *)0)
# 330 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
                                       ;
   ...
   if (count) {
    ...
    for (k = 0; k < count; k++) {
     { size_t used = 0; used = 
# 350 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
    __builtin___snprintf_chk (
# 350 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
    tmp_buf + cur
# 350 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c" 3 4
    , 
# 350 "project/radare2/shlr/capstone/suite/arm/test_arm_regression.c"
