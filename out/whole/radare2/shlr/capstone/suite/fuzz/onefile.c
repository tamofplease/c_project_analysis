# 0 "project/radare2/shlr/capstone/suite/fuzz/onefile.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/capstone/suite/fuzz/onefile.c"
...
# 2 "project/radare2/shlr/capstone/suite/fuzz/onefile.c" 2
...
# 3 "project/radare2/shlr/capstone/suite/fuzz/onefile.c" 2
...
# 4 "project/radare2/shlr/capstone/suite/fuzz/onefile.c" 2


# 5 "project/radare2/shlr/capstone/suite/fuzz/onefile.c"
...
int main(int argc, char** argv)
{
    ...
    fp = fopen(argv[1], "rb");
    if (fp == 
# 18 "project/radare2/shlr/capstone/suite/fuzz/onefile.c" 3 4
             ((void *)0)
# 18 "project/radare2/shlr/capstone/suite/fuzz/onefile.c"
                 ) {
        return 2;
    }
    if (fseek(fp, 0L, 
# 21 "project/radare2/shlr/capstone/suite/fuzz/onefile.c" 3 4
                     2
# 21 "project/radare2/shlr/capstone/suite/fuzz/onefile.c"
                             ) != 0) {
        fclose(fp);
        return 2;
    }
    ...
    if (fseek(fp, 0L, 
# 30 "project/radare2/shlr/capstone/suite/fuzz/onefile.c" 3 4
                     0
# 30 "project/radare2/shlr/capstone/suite/fuzz/onefile.c"
                             ) != 0) {
        fclose(fp);
        return 2;
    }
    Data = malloc(Size);
    if (Data == 
# 35 "project/radare2/shlr/capstone/suite/fuzz/onefile.c" 3 4
               ((void *)0)
# 35 "project/radare2/shlr/capstone/suite/fuzz/onefile.c"
                   ) {
        fclose(fp);
        return 2;
    }
