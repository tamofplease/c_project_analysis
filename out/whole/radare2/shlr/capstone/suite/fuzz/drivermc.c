# 0 "project/radare2/shlr/capstone/suite/fuzz/drivermc.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/capstone/suite/fuzz/drivermc.c"
...
# 2 "project/radare2/shlr/capstone/suite/fuzz/drivermc.c" 2
...
# 3 "project/radare2/shlr/capstone/suite/fuzz/drivermc.c" 2
...
# 4 "project/radare2/shlr/capstone/suite/fuzz/drivermc.c" 2
...
# 5 "project/radare2/shlr/capstone/suite/fuzz/drivermc.c" 2


# 6 "project/radare2/shlr/capstone/suite/fuzz/drivermc.c"
...
int main(int argc, char** argv)
{
    ...
    for (i = 1; i < argc; i++) {
        ...
        fp = fopen(argv[i], "rb");
        if (fp == 
# 28 "project/radare2/shlr/capstone/suite/fuzz/drivermc.c" 3 4
                 ((void *)0)
# 28 "project/radare2/shlr/capstone/suite/fuzz/drivermc.c"
                     ) {
            return 2;
        }
        printf("Trying %s\n", argv[i]);
        if (fgets(line, 128, fp) == 
# 32 "project/radare2/shlr/capstone/suite/fuzz/drivermc.c" 3 4
                                             ((void *)0)
# 32 "project/radare2/shlr/capstone/suite/fuzz/drivermc.c"
                                                 ) {
            break;
        }
        if (line[0] == '#') {
            ...
            if (strcmp(arch, "CS_ARCH_X86") == 0 && strcmp(mode, "CS_MODE_32") == 0) {
                ...
                Data[0] = 25;
     } else if (strcmp(arch, "CS_ARCH_BPF") == 0 && strstr(mode, "CS_MODE_BPF_CLASSIC") != 
# 94 "project/radare2/shlr/capstone/suite/fuzz/drivermc.c" 3 4
                                                                                          ((void *)0)
# 94 "project/radare2/shlr/capstone/suite/fuzz/drivermc.c"
                                                                                              ) {
                Data[0] = 29;
            } else if (strcmp(arch, "CS_ARCH_BPF") == 0 && strstr(mode, "CS_MODE_BPF_EXTENDED") != 
# 96 "project/radare2/shlr/capstone/suite/fuzz/drivermc.c" 3 4
                                                                                                  ((void *)0)
# 96 "project/radare2/shlr/capstone/suite/fuzz/drivermc.c"
                                                                                                      ) {
                Data[0] = 30;
        ...
        while(1) {
            if (fgets(line, 128, fp) == 
# 114 "project/radare2/shlr/capstone/suite/fuzz/drivermc.c" 3 4
                                                 ((void *)0)
# 114 "project/radare2/shlr/capstone/suite/fuzz/drivermc.c"
                                                     ) {
                break;
            }
            Size = 1;
