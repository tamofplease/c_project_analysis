# 0 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c"
...
# 2 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c" 2
...
# 3 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c" 2
...
# 4 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c" 2
...
# 5 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c" 2
...
# 6 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c" 2

# 1 "project/radare2/shlr/capstone/suite/fuzz/platform.h" 1
...
# 5 "project/radare2/shlr/capstone/suite/fuzz/platform.h" 2


# 6 "project/radare2/shlr/capstone/suite/fuzz/platform.h"
struct platform {
    cs_arch arch;
    cs_mode mode;
    const char *comment;
...
# 8 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c" 2
...
int main(int argc, char** argv)
{
    ...
    d = opendir(argv[1]);
    if (d == 
# 26 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c" 3 4
            ((void *)0)
# 26 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c"
                ) {
    ...
    while((dir = readdir(d)) != 
# 36 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c" 3 4
                               ((void *)0)
# 36 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c"
                                   ) {

        if (dir->d_type != 
# 38 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c" 3 4
                          8
# 38 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c"
                                ) {
            continue;
        }
        printf("Running file %s ", dir->d_name);
        fflush(
# 42 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c" 3 4
              __stdoutp
# 42 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c"
                    );
        fp = fopen(dir->d_name, "rb");
        if (fp == 
# 44 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c" 3 4
                 ((void *)0)
# 44 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c"
                     ) {
            r = 3;
            break;
        }
        if (fseek(fp, 0L, 
# 48 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c" 3 4
                         2
# 48 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c"
                                 ) != 0) {
            fclose(fp);
            r = 4;
            break;
        ...
        if (fseek(fp, 0L, 
# 62 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c" 3 4
                         0
# 62 "project/radare2/shlr/capstone/suite/fuzz/driverbin.c"
                                 ) != 0) {
            fclose(fp);
            r = 7;
            break;
