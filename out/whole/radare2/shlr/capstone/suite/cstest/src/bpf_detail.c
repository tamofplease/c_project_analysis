# 0 "project/radare2/shlr/capstone/suite/cstest/src/bpf_detail.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/capstone/suite/cstest/src/bpf_detail.c"
...
# 5 "project/radare2/shlr/capstone/suite/cstest/src/bpf_detail.c" 2
...
# 7 "project/radare2/shlr/capstone/suite/cstest/src/bpf_detail.c" 2


# 8 "project/radare2/shlr/capstone/suite/cstest/src/bpf_detail.c"
...
char *get_detail_bpf(csh *handle, cs_mode mode, cs_insn *ins)
{
 ...
 for (i = 0; i < bpf->op_count; i++) {
  ...
  case BPF_OP_REG:
   ...
   break;
  case BPF_OP_IMM:
   add_str(&result, "IMM = 0x%" 
# 40 "project/radare2/shlr/capstone/suite/cstest/src/bpf_detail.c" 3 4
                               "ll" "x"
# 40 "project/radare2/shlr/capstone/suite/cstest/src/bpf_detail.c"
                                     , op->imm);
   break;
  case BPF_OP_OFF:
