# 0 "project/radare2/shlr/zip/zlib/inflate.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/zip/zlib/inflate.c"
# 83 "project/radare2/shlr/zip/zlib/inflate.c"
# 1 "project/radare2/shlr/zip/zlib/zutil.h" 1
# 14 "project/radare2/shlr/zip/zlib/zutil.h"
#define ZUTIL_H 
...
# 500 "project/radare2/shlr/zip/zlib/zconf.h"
#define SEEK_SET 0
#define SEEK_CUR 1
#define SEEK_END 2
...
# 163 "project/radare2/shlr/zip/zlib/zutil.h"
#define OS_CODE 19
...
# 202 "project/radare2/shlr/zip/zlib/zutil.h"
#define F_OPEN(name,mode) fopen((name), (mode))
# 218 "project/radare2/shlr/zip/zlib/zutil.h"
#define HAVE_MEMCPY 
...
# 248 "project/radare2/shlr/zip/zlib/zutil.h"
...
# 84 "project/radare2/shlr/zip/zlib/inflate.c" 2
...
# 49 "project/radare2/shlr/zip/zlib/inftrees.h"
...
int inflate_table (codetype type, unsigned short *lens, unsigned codes, code * *table, unsigned *bits, unsigned short *work)
                                                                           ...
                                                                           ;
# 85 "project/radare2/shlr/zip/zlib/inflate.c" 2
# 1 "project/radare2/shlr/zip/zlib/inflate.h" 1
# 16 "project/radare2/shlr/zip/zlib/inflate.h"
#define GUNZIP 
...
# 82 "project/radare2/shlr/zip/zlib/inflate.h"
...
# 86 "project/radare2/shlr/zip/zlib/inflate.c" 2
# 1 "project/radare2/shlr/zip/zlib/inffast.h" 1
# 11 "project/radare2/shlr/zip/zlib/inffast.h"
void inflate_fast (z_streamp strm, unsigned start);
# 87 "project/radare2/shlr/zip/zlib/inflate.c" 2
# 95 "project/radare2/shlr/zip/zlib/inflate.c"
...
# 278 "project/radare2/shlr/zip/zlib/inflate.c"
static void fixedtables(state)
struct inflate_state *state;
{
# 313 "project/radare2/shlr/zip/zlib/inflate.c"
# 1 "project/radare2/shlr/zip/zlib/inffixed.h" 1
# 10 "project/radare2/shlr/zip/zlib/inffixed.h"
...
# 314 "project/radare2/shlr/zip/zlib/inflate.c" 2
...
# 396 "project/radare2/shlr/zip/zlib/inflate.c"
...
# 423 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
       __builtin___memcpy_chk (
# 423 "project/radare2/shlr/zip/zlib/inflate.c"
       state->window
# 423 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
       , 
# 423 "project/radare2/shlr/zip/zlib/inflate.c"
       end - state->wsize, state->wsize
# 423 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
...
# 430 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
       __builtin___memcpy_chk (
# 430 "project/radare2/shlr/zip/zlib/inflate.c"
...
# 433 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
           __builtin___memcpy_chk (
# 433 "project/radare2/shlr/zip/zlib/inflate.c"
           state->window
# 433 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
           , 
# 433 "project/radare2/shlr/zip/zlib/inflate.c"
...
#define CRC2(check,word) do { hbuf[0] = (unsigned char)(word); hbuf[1] = (unsigned char)((word) >> 8); check = crc32(check, hbuf, 2); } while (0)
...
#define CRC4(check,word) do { hbuf[0] = (unsigned char)(word); hbuf[1] = (unsigned char)((word) >> 8); hbuf[2] = (unsigned char)((word) >> 16); hbuf[3] = (unsigned char)((word) >> 24); check = crc32(check, hbuf, 4); } while (0)
# 476 "project/radare2/shlr/zip/zlib/inflate.c"
...
# 487 "project/radare2/shlr/zip/zlib/inflate.c"
...
# 498 "project/radare2/shlr/zip/zlib/inflate.c"
...
# 516 "project/radare2/shlr/zip/zlib/inflate.c"
...
# 622 "project/radare2/shlr/zip/zlib/inflate.c"
...
# 764 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
                       __builtin___memcpy_chk (
# 764 "project/radare2/shlr/zip/zlib/inflate.c"
                       state->head->extra + len
# 764 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
                       , 
# 764 "project/radare2/shlr/zip/zlib/inflate.c"
                       next, len + copy > state->head->extra_max ? state->head->extra_max - len : copy
# 764 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
                       , __builtin_object_size (
# 764 "project/radare2/shlr/zip/zlib/inflate.c"
                       state->head->extra + len
...
# 766 "project/radare2/shlr/zip/zlib/inflate.c"
                                                                   ;
                    }
                    if ((state->flags & 0x0200) && (state->wrap & 4))
...
# 909 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
               __builtin___memcpy_chk (
# 909 "project/radare2/shlr/zip/zlib/inflate.c"
               put
# 909 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
               , 
# 909 "project/radare2/shlr/zip/zlib/inflate.c"
...
# 1170 "project/radare2/shlr/zip/zlib/inflate.c"
                }
                if (copy > state->wnext) {
                    copy -= state->wnext;
...
# 1304 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
       __builtin___memcpy_chk (
# 1304 "project/radare2/shlr/zip/zlib/inflate.c"
       dictionary
# 1304 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
       , 
# 1304 "project/radare2/shlr/zip/zlib/inflate.c"
       state->window + state->wnext, state->whave - state->wnext
# 1304 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
       , __builtin_object_size (
# 1304 "project/radare2/shlr/zip/zlib/inflate.c"
       dictionary
...
# 1305 "project/radare2/shlr/zip/zlib/inflate.c"
                                           ;
        
# 1306 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
       __builtin___memcpy_chk (
# 1306 "project/radare2/shlr/zip/zlib/inflate.c"
...
# 1307 "project/radare2/shlr/zip/zlib/inflate.c"
                                           ;
    }
    if (dictLength != 0)
...
# 1377 "project/radare2/shlr/zip/zlib/inflate.c"
...
# 1451 "project/radare2/shlr/zip/zlib/inflate.c"
...
# 1490 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
   __builtin___memcpy_chk (
# 1490 "project/radare2/shlr/zip/zlib/inflate.c"
   (voidpf)dest
# 1490 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
   , 
# 1490 "project/radare2/shlr/zip/zlib/inflate.c"
   (voidpf)source, sizeof(z_stream)
# 1490 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
   , __builtin_object_size (
# 1490 "project/radare2/shlr/zip/zlib/inflate.c"
   (voidpf)dest
...
# 1491 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
   __builtin___memcpy_chk (
# 1491 "project/radare2/shlr/zip/zlib/inflate.c"
   (voidpf)copy
# 1491 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
   , 
# 1491 "project/radare2/shlr/zip/zlib/inflate.c"
   (voidpf)state, sizeof(struct inflate_state)
# 1491 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
   , __builtin_object_size (
# 1491 "project/radare2/shlr/zip/zlib/inflate.c"
   (voidpf)copy
...
# 1501 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
       __builtin___memcpy_chk (
# 1501 "project/radare2/shlr/zip/zlib/inflate.c"
       window
# 1501 "project/radare2/shlr/zip/zlib/inflate.c" 3 4
       , 
# 1501 "project/radare2/shlr/zip/zlib/inflate.c"
