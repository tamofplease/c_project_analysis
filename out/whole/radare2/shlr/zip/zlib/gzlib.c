# 0 "project/radare2/shlr/zip/zlib/gzlib.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/zip/zlib/gzlib.c"
...
# 18 "project/radare2/shlr/zip/zlib/gzguts.h"
...
# 32 "project/radare2/shlr/zip/zlib/zlib.h"
#define ZLIB_H 

# 1 "project/radare2/shlr/zip/zlib/zconf.h" 1
# 9 "project/radare2/shlr/zip/zlib/zconf.h"
#define ZCONF_H 
# 203 "project/radare2/shlr/zip/zlib/zconf.h"
#define STDC 



#define STDC99 
# 237 "project/radare2/shlr/zip/zlib/zconf.h"
#define z_const 
...
# 270 "project/radare2/shlr/zip/zlib/zconf.h"
#define MAX_WBITS 15
# 290 "project/radare2/shlr/zip/zlib/zconf.h"
#define OF(args) args
...
# 377 "project/radare2/shlr/zip/zlib/zconf.h"
...
# 506 "project/radare2/shlr/zip/zlib/zconf.h"
#define z_off_t long
# 515 "project/radare2/shlr/zip/zlib/zconf.h"
...
extern int inflateBackInit_ (z_streamp strm, int windowBits, unsigned char *window, const char *version, int stream_size)
                                                          ...
                                                          ;
# 1793 "project/radare2/shlr/zip/zlib/zlib.h"
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                              ...
                                                              ;
# 23 "project/radare2/shlr/zip/zlib/gzguts.h" 2
...
# 25 "project/radare2/shlr/zip/zlib/gzguts.h" 2
...
# 26 "project/radare2/shlr/zip/zlib/gzguts.h" 2
# 1 "/usr/local/Cellar/gcc/11.2.0_3/lib/gcc/11/gcc/x86_64-apple-darwin20/11/include-fixed/limits.h" 1 3 4
...
# 61 "project/radare2/shlr/zip/zlib/gzguts.h"
#define HAVE_VSNPRINTF 
# 116 "project/radare2/shlr/zip/zlib/gzguts.h"
#define local static
...
# 216 "project/radare2/shlr/zip/zlib/gzguts.h"
#define GT_OFF(x) (sizeof(int) == sizeof(z_off64_t) && (x) > INT_MAX)
# 7 "project/radare2/shlr/zip/zlib/gzlib.c" 2
...
# 75 "project/radare2/shlr/zip/zlib/gzlib.c"
    ...
    gz_statep state;
{
    ...
    state->seek = 0;
    gz_error(state, 0, 
# 85 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                         ((void *)0)
# 85 "project/radare2/shlr/zip/zlib/gzlib.c"
                             );
    state->x.pos = 0;
    ...
    const char *mode;
{
    ...
    if (path == 
# 107 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
               ((void *)0)
# 107 "project/radare2/shlr/zip/zlib/gzlib.c"
                   )
        return 
# 108 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
              ((void *)0)
# 108 "project/radare2/shlr/zip/zlib/gzlib.c"
                  ;


    state = (gz_statep)malloc(sizeof(gz_state));
    if (state == 
# 112 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                ((void *)0)
# 112 "project/radare2/shlr/zip/zlib/gzlib.c"
                    )
        return 
# 113 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
              ((void *)0)
# 113 "project/radare2/shlr/zip/zlib/gzlib.c"
                  ;
    state->size = 0;
    state->want = 8192;
    state->msg = 
# 116 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                ((void *)0)
# 116 "project/radare2/shlr/zip/zlib/gzlib.c"
                    ;
    ...
    while (*mode) {
        if (*mode >= '0' && *mode <= '9')
            ...
            case '+':
                free(state);
                return 
# 141 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                      ((void *)0)
# 141 "project/radare2/shlr/zip/zlib/gzlib.c"
                          ;
            case 'b':
                break;
    ...
    if (state->mode == 0) {
        free(state);
        return 
# 178 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
              ((void *)0)
# 178 "project/radare2/shlr/zip/zlib/gzlib.c"
                  ;
    }
    ...
    if (state->mode == 7247) {
        if (state->direct) {
            free(state);
            return 
# 185 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                  ((void *)0)
# 185 "project/radare2/shlr/zip/zlib/gzlib.c"
                      ;
        }
        state->direct = 1;
    }
# 199 "project/radare2/shlr/zip/zlib/gzlib.c"
        len = strlen((const char *)path);
    state->path = (char *)malloc(len + 1);
    if (state->path == 
# 201 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                      ((void *)0)
# 201 "project/radare2/shlr/zip/zlib/gzlib.c"
                          ) {
        free(state);
        return 
# 203 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
              ((void *)0)
# 203 "project/radare2/shlr/zip/zlib/gzlib.c"
                  ;
    }
# 214 "project/radare2/shlr/zip/zlib/gzlib.c"
        (void)
# 214 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
...
# 214 "project/radare2/shlr/zip/zlib/gzlib.c"
    ...
    oflag =
        ...
        (cloexec ? 
# 228 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                  0x01000000 
# 228 "project/radare2/shlr/zip/zlib/gzlib.c"
                            : 0) |

        (state->mode == 7247 ?
         
# 231 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
        0x0000 
# 231 "project/radare2/shlr/zip/zlib/gzlib.c"
                 :
         (
# 232 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
         0x0001 
# 232 "project/radare2/shlr/zip/zlib/gzlib.c"
                  | 
# 232 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                    0x00000200 
# 232 "project/radare2/shlr/zip/zlib/gzlib.c"
          ...
          (exclusive ? 
# 234 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                      0x00000800 
# 234 "project/radare2/shlr/zip/zlib/gzlib.c"
                             : 0) |

          (state->mode == 31153 ?
           
# 237 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
          0x00000400 
# 237 "project/radare2/shlr/zip/zlib/gzlib.c"
                  :
           
# 238 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
          0x00000008
# 238 "project/radare2/shlr/zip/zlib/gzlib.c"
                  )));
    ...
    if (state->fd == -1) {
        ...
        free(state);
        return 
# 249 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
              ((void *)0)
# 249 "project/radare2/shlr/zip/zlib/gzlib.c"
                  ;
    }
    if (state->mode == 1) {
        lseek(state->fd, 0, 
# 252 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                           2
# 252 "project/radare2/shlr/zip/zlib/gzlib.c"
                                   );
        state->mode = 31153;
    }
    ...
    if (state->mode == 7247) {
        state->start = lseek(state->fd, 0, 
# 258 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                                          1
# 258 "project/radare2/shlr/zip/zlib/gzlib.c"
                                                  );
...
# 293 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                                                                   ((void *)0)
# 293 "project/radare2/shlr/zip/zlib/gzlib.c"
                                                                       )
        return 
# 294 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
              ((void *)0)
# 294 "project/radare2/shlr/zip/zlib/gzlib.c"
                  ;

    (void)
# 296 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
         __builtin___snprintf_chk (
# 296 "project/radare2/shlr/zip/zlib/gzlib.c"
         path
# 296 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
         , 
# 296 "project/radare2/shlr/zip/zlib/gzlib.c"
...
# 316 "project/radare2/shlr/zip/zlib/gzlib.c"
    ...
    unsigned size;
{
    ...
    if (file == 
# 323 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
               ((void *)0)
# 323 "project/radare2/shlr/zip/zlib/gzlib.c"
                   )
        return -1;
    ...
    gzFile file;
{
    ...
    if (file == 
# 349 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
               ((void *)0)
# 349 "project/radare2/shlr/zip/zlib/gzlib.c"
                   )
        return -1;
    state = (gz_statep)file;
...
# 359 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                                      0
# 359 "project/radare2/shlr/zip/zlib/gzlib.c"
                                              ) == -1)
        return -1;
    gz_reset(state);
    return 0;
...
long gzseek64(file, offset, whence)
    gzFile file;
    long offset;
    int whence;
{
    ...
    if (file == 
# 376 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
               ((void *)0)
# 376 "project/radare2/shlr/zip/zlib/gzlib.c"
                   )
        return -1;
    state = (gz_statep)file;
    if (state->mode != 7247 && state->mode != 31153)
    ...
    if (whence != 
# 387 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                 0 
# 387 "project/radare2/shlr/zip/zlib/gzlib.c"
                          && whence != 
# 387 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                                       1
# 387 "project/radare2/shlr/zip/zlib/gzlib.c"
    ...
    if (whence == 
# 391 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                 0
# 391 "project/radare2/shlr/zip/zlib/gzlib.c"
                         )
        offset -= state->x.pos;
    else if (state->seek)
        offset += state->skip;
    ...
    if (state->mode == 7247 && state->how == 1 &&
        ...
        ret = lseek(state->fd, offset - state->x.have, 
# 400 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                                                      1
# 400 "project/radare2/shlr/zip/zlib/gzlib.c"
                                                              );
        if (ret == -1)
            return -1;
        state->x.have = 0;
        ...
        state->seek = 0;
        gz_error(state, 0, 
# 407 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                             ((void *)0)
# 407 "project/radare2/shlr/zip/zlib/gzlib.c"
                                 );
        state->strm.avail_in = 0;
        state->x.pos += offset;
        return state->x.pos;
    ...
    if (state->mode == 7247) {
        n = (sizeof(int) == sizeof(long) && (state->x.have) > 0x7fffffff) || (long)state->x.have > offset ?
...
long gzseek(file, offset, whence)
    gzFile file;
    long offset;
    int whence;
{
    ...
    ret = gzseek64(file, (long)offset, whence);
    ...
    gzFile file;
{
    ...
    if (file == 
# 461 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
               ((void *)0)
# 461 "project/radare2/shlr/zip/zlib/gzlib.c"
                   )
        return -1;
    state = (gz_statep)file;
    if (state->mode != 7247 && state->mode != 31153)
    ...
    gzFile file;
{
    ...
    if (file == 
# 489 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
               ((void *)0)
# 489 "project/radare2/shlr/zip/zlib/gzlib.c"
                   )
        return -1;
    state = (gz_statep)file;
    if (state->mode != 7247 && state->mode != 31153)
    ...
    offset = lseek(state->fd, 0, 
# 496 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                                1
# 496 "project/radare2/shlr/zip/zlib/gzlib.c"
                                        );
    if (offset == -1)
        return -1;
    if (state->mode == 7247)
    ...
    gzFile file;
{
    ...
    if (file == 
# 521 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
               ((void *)0)
# 521 "project/radare2/shlr/zip/zlib/gzlib.c"
                   )
        return 0;
    state = (gz_statep)file;
    if (state->mode != 7247 && state->mode != 31153)
    ...
    int *errnum;
{
    ...
    if (file == 
# 539 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
               ((void *)0)
# 539 "project/radare2/shlr/zip/zlib/gzlib.c"
                   )
        return 
# 540 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
              ((void *)0)
# 540 "project/radare2/shlr/zip/zlib/gzlib.c"
                  ;
    state = (gz_statep)file;
    if (state->mode != 7247 && state->mode != 31153)
        return 
# 543 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
              ((void *)0)
# 543 "project/radare2/shlr/zip/zlib/gzlib.c"
                  ;


    if (errnum != 
# 546 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                 ((void *)0)
# 546 "project/radare2/shlr/zip/zlib/gzlib.c"
                     )
        *errnum = state->err;
    return state->err == (-4) ? "out of memory" :
                                       (state->msg == 
# 549 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                                                     ((void *)0) 
# 549 "project/radare2/shlr/zip/zlib/gzlib.c"
                                                          ? "" : state->msg);
}
    ...
    gzFile file;
{
    ...
    if (file == 
# 559 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
               ((void *)0)
# 559 "project/radare2/shlr/zip/zlib/gzlib.c"
                   )
        return;
    state = (gz_statep)file;
    if (state->mode != 7247 && state->mode != 31153)
    ...
    gz_error(state, 0, 
# 570 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                         ((void *)0)
# 570 "project/radare2/shlr/zip/zlib/gzlib.c"
                             );
}
    ...
    const char *msg;
{
    ...
    if (state->msg != 
# 585 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                     ((void *)0)
# 585 "project/radare2/shlr/zip/zlib/gzlib.c"
                         ) {
        if (state->err != (-4))
            free(state->msg);
        state->msg = 
# 588 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
                    ((void *)0)
# 588 "project/radare2/shlr/zip/zlib/gzlib.c"
                        ;
    }
    ...
    state->err = err;
    if (msg == 
# 597 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
              ((void *)0)
# 597 "project/radare2/shlr/zip/zlib/gzlib.c"
                  )
        return;
...
# 606 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
           ((void *)0)
# 606 "project/radare2/shlr/zip/zlib/gzlib.c"
               ) {
        state->err = (-4);
        return;
    }
    ...
    (void)
# 611 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
         __builtin___snprintf_chk (
# 611 "project/radare2/shlr/zip/zlib/gzlib.c"
         state->msg
# 611 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
         , 
# 611 "project/radare2/shlr/zip/zlib/gzlib.c"
         strlen(state->path) + strlen(msg) + 3
# 611 "project/radare2/shlr/zip/zlib/gzlib.c" 3 4
         , 0, __builtin_object_size (
# 611 "project/radare2/shlr/zip/zlib/gzlib.c"
         state->msg
...
# 612 "project/radare2/shlr/zip/zlib/gzlib.c"
                                                   ;
