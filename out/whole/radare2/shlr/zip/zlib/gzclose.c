# 0 "project/radare2/shlr/zip/zlib/gzclose.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/zip/zlib/gzclose.c"
...
# 7 "project/radare2/shlr/zip/zlib/gzclose.c" 2
    ...
    gzFile file;
{
    ...
    if (file == 
# 17 "project/radare2/shlr/zip/zlib/gzclose.c" 3 4
               ((void *)0)
# 17 "project/radare2/shlr/zip/zlib/gzclose.c"
                   )
        return (-2);
