# 0 "project/radare2/shlr/zip/zlib/gzwrite.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/zip/zlib/gzwrite.c"
...
# 7 "project/radare2/shlr/zip/zlib/gzwrite.c" 2


static int gz_init (gz_statep);
static int gz_comp (gz_statep, int);
static int gz_zero (gz_statep, long);
    ...
    gz_statep state;
{
    ...
    if (state->in == 
# 25 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
                    ((void *)0)
# 25 "project/radare2/shlr/zip/zlib/gzwrite.c"
                        ) {
    ...
    if (!state->direct) {
        ...
        if (state->out == 
# 34 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
                         ((void *)0)
# 34 "project/radare2/shlr/zip/zlib/gzwrite.c"
                             ) {
            free(state->in);
            gz_error(state, (-4), "out of memory");
            return -1;
        ...
        strm->zfree = 0;
        strm->opaque = 0;
        ret = deflateInit2_((strm),(state->level),(8),(15 + 16),(8), (state->strategy), "1.2.11", (int)sizeof(z_stream))
                                                                          ;
        if (ret != 0) {
            free(state->out);
            free(state->in);
        ...
        strm->next_in = 
# 52 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
                       ((void *)0)
# 52 "project/radare2/shlr/zip/zlib/gzwrite.c"
                           ;
    }
...
# 91 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
                                        (*__error())
# 91 "project/radare2/shlr/zip/zlib/gzwrite.c"
                                        ));
                return -1;
            }
    ...
    do {
        ...
        if (strm->avail_out == 0 || (flush != 0 &&
            ...
            while (strm->next_out > state->x.next) {
                ...
                if (writ < 0) {
                    gz_error(state, (-1), strerror(
# 112 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
                                            (*__error())
# 112 "project/radare2/shlr/zip/zlib/gzwrite.c"
                                            ));
                    return -1;
                }
                state->x.next += writ;
    ...
    long len;
{
    ...
    first = 1;
    while (len) {
        n = (sizeof(int) == sizeof(long) && (state->size) > 0x7fffffff) || (long)state->size > len ?
            (unsigned)len : state->size;
        if (first) {
            
# 163 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
           __builtin___memset_chk (
# 163 "project/radare2/shlr/zip/zlib/gzwrite.c"
           state->in
# 163 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
           , 
# 163 "project/radare2/shlr/zip/zlib/gzwrite.c"
...
# 213 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
           __builtin___memcpy_chk (
# 213 "project/radare2/shlr/zip/zlib/gzwrite.c"
           state->in + have
# 213 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
           , 
# 213 "project/radare2/shlr/zip/zlib/gzwrite.c"
    ...
    unsigned len;
{
    ...
    if (file == 
# 254 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
               ((void *)0)
# 254 "project/radare2/shlr/zip/zlib/gzwrite.c"
                   )
        return 0;
    ...
    gzFile file;
{
    ...
    if (file == 
# 284 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
               ((void *)0) 
# 284 "project/radare2/shlr/zip/zlib/gzwrite.c"
                    || size < 1) {
        return 0;
    }
    state = (gz_statep)file;
    ...
    int c;
{
    ...
    if (file == 
# 315 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
               ((void *)0)
# 315 "project/radare2/shlr/zip/zlib/gzwrite.c"
                   )
        return -1;
    state = (gz_statep)file;
    strm = &(state->strm);
    ...
    const char *str;
{
    ...
    if (file == 
# 362 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
               ((void *)0)
# 362 "project/radare2/shlr/zip/zlib/gzwrite.c"
                   )
        return -1;
    state = (gz_statep)file;
...
int gzvprintf(gzFile file, const char *format, va_list va)
{
    ...
    if (file == 
# 389 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
               ((void *)0)
# 389 "project/radare2/shlr/zip/zlib/gzwrite.c"
                   )
        return (-2);
    state = (gz_statep)file;
    strm = &(state->strm);
    ...
    next[state->size - 1] = 0;
# 429 "project/radare2/shlr/zip/zlib/gzwrite.c"
    len = 
# 429 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
...
# 445 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
       __builtin___memcpy_chk (
# 445 "project/radare2/shlr/zip/zlib/gzwrite.c"
       state->in
# 445 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
       , 
# 445 "project/radare2/shlr/zip/zlib/gzwrite.c"
       state->in + state->size, left
# 445 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
       , __builtin_object_size (
# 445 "project/radare2/shlr/zip/zlib/gzwrite.c"
       state->in
...
# 457 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
   __builtin_va_start(
# 457 "project/radare2/shlr/zip/zlib/gzwrite.c"
   va
# 457 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
   ,
# 457 "project/radare2/shlr/zip/zlib/gzwrite.c"
...
# 459 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
   __builtin_va_end(
# 459 "project/radare2/shlr/zip/zlib/gzwrite.c"
   va
# 459 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
   )
# 459 "project/radare2/shlr/zip/zlib/gzwrite.c"
...
# 554 "project/radare2/shlr/zip/zlib/gzwrite.c"
    ...
    int flush;
{
    ...
    if (file == 
# 561 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
               ((void *)0)
# 561 "project/radare2/shlr/zip/zlib/gzwrite.c"
                   )
        return (-2);
    state = (gz_statep)file;
    ...
    int strategy;
{
    ...
    if (file == 
# 595 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
               ((void *)0)
# 595 "project/radare2/shlr/zip/zlib/gzwrite.c"
                   )
        return (-2);
    state = (gz_statep)file;
    strm = &(state->strm);
    ...
    gzFile file;
{
    ...
    if (file == 
# 635 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
               ((void *)0)
# 635 "project/radare2/shlr/zip/zlib/gzwrite.c"
                   )
        return (-2);
    state = (gz_statep)file;
    ...
    gz_error(state, 0, 
# 660 "project/radare2/shlr/zip/zlib/gzwrite.c" 3 4
                         ((void *)0)
# 660 "project/radare2/shlr/zip/zlib/gzwrite.c"
                             );
    free(state->path);
    if (close(state->fd) == -1)
        ret = (-1);
