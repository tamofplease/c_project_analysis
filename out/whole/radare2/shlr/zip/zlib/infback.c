# 0 "project/radare2/shlr/zip/zlib/infback.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/zip/zlib/infback.c"
# 13 "project/radare2/shlr/zip/zlib/infback.c"
...
# 14 "project/radare2/shlr/zip/zlib/infback.c" 2
...
int inflate_table (codetype type, unsigned short *lens, unsigned codes, code * *table, unsigned *bits, unsigned short *work)
                                                                           ...
                                                                           ;
# 15 "project/radare2/shlr/zip/zlib/infback.c" 2
...
# 16 "project/radare2/shlr/zip/zlib/infback.c" 2
# 1 "project/radare2/shlr/zip/zlib/inffast.h" 1
# 11 "project/radare2/shlr/zip/zlib/inffast.h"
void inflate_fast (z_streamp strm, unsigned start);
# 17 "project/radare2/shlr/zip/zlib/infback.c" 2


static void fixedtables (struct inflate_state *state);
# 28 "project/radare2/shlr/zip/zlib/infback.c"
...
# 82 "project/radare2/shlr/zip/zlib/infback.c"
static void fixedtables(state)
struct inflate_state *state;
{
# 117 "project/radare2/shlr/zip/zlib/infback.c"
...
# 118 "project/radare2/shlr/zip/zlib/infback.c" 2
...
# 139 "project/radare2/shlr/zip/zlib/infback.c"
...
# 150 "project/radare2/shlr/zip/zlib/infback.c"
...
# 172 "project/radare2/shlr/zip/zlib/infback.c"
#define PULLBYTE() do { PULL(); have--; hold += (unsigned long)(*next++) << bits; bits += 8; } while (0)
# 183 "project/radare2/shlr/zip/zlib/infback.c"
...
# 210 "project/radare2/shlr/zip/zlib/infback.c"
...
# 250 "project/radare2/shlr/zip/zlib/infback.c"
...
# 347 "project/radare2/shlr/zip/zlib/infback.c" 3 4
               __builtin___memcpy_chk (
# 347 "project/radare2/shlr/zip/zlib/infback.c"
               put
# 347 "project/radare2/shlr/zip/zlib/infback.c" 3 4
               , 
# 347 "project/radare2/shlr/zip/zlib/infback.c"
