# 0 "project/radare2/shlr/zip/zlib/gzread.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/zip/zlib/gzread.c"
...
# 7 "project/radare2/shlr/zip/zlib/gzread.c" 2
...
static int gz_skip (gz_statep, long);
...
# 41 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
                                (*__error())
# 41 "project/radare2/shlr/zip/zlib/gzread.c"
                                ));
        return -1;
    }
    if (ret == 0)
...
# 56 "project/radare2/shlr/zip/zlib/gzread.c"
...
# 91 "project/radare2/shlr/zip/zlib/gzread.c"
    ...
    gz_statep state;
{
    ...
    if (state->size == 0) {
        ...
        if (state->in == 
# 101 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
                        ((void *)0) 
# 101 "project/radare2/shlr/zip/zlib/gzread.c"
                             || state->out == 
# 101 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
                                              ((void *)0)
# 101 "project/radare2/shlr/zip/zlib/gzread.c"
        ...
        if (inflateInit2_((&(state->strm)), (15 + 16), "1.2.11", (int)sizeof(z_stream)) != 0) {
            free(state->out);
            free(state->in);
            state->size = 0;
            gz_error(state, (-4), "out of memory");
...
# 139 "project/radare2/shlr/zip/zlib/gzread.c"
    if (strm->avail_in > 1 &&
...
# 161 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
       __builtin___memcpy_chk (
# 161 "project/radare2/shlr/zip/zlib/gzread.c"
       state->x.next
# 161 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
       , 
# 161 "project/radare2/shlr/zip/zlib/gzread.c"
    ...
    gz_statep state;
{
    ...
    do {
        ...
        if (ret == (-3)) {
            gz_error(state, (-3),
                     strm->msg == 
# 206 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
                                 ((void *)0) 
# 206 "project/radare2/shlr/zip/zlib/gzread.c"
    ...
    long len;
{
    ...
    while (len)
        ...
        if (state->x.have) {
            n = (sizeof(int) == sizeof(long) && (state->x.have) > 0x7fffffff) || (long)state->x.have > len ?
...
# 325 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
           __builtin___memcpy_chk (
# 325 "project/radare2/shlr/zip/zlib/gzread.c"
           buf
# 325 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
           , 
# 325 "project/radare2/shlr/zip/zlib/gzread.c"
    ...
    unsigned len;
{
    ...
    if (file == 
# 383 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
               ((void *)0)
# 383 "project/radare2/shlr/zip/zlib/gzread.c"
                   )
        return -1;
    ...
    gzFile file;
{
    ...
    if (file == 
# 421 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
               ((void *)0) 
# 421 "project/radare2/shlr/zip/zlib/gzread.c"
                    || size < 1) {
        return 0;
    }
    state = (gz_statep)file;
    ...
    gzFile file;
{
    ...
    if (file == 
# 456 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
               ((void *)0)
# 456 "project/radare2/shlr/zip/zlib/gzread.c"
                   )
        return -1;
    state = (gz_statep)file;
    ...
    gzFile file;
{
    ...
    if (file == 
# 491 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
               ((void *)0)
# 491 "project/radare2/shlr/zip/zlib/gzread.c"
                   )
        return -1;
    state = (gz_statep)file;
    ...
    int len;
{
    ...
    if (file == 
# 555 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
               ((void *)0) 
# 555 "project/radare2/shlr/zip/zlib/gzread.c"
                    || buf == 
# 555 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
                              ((void *)0) 
# 555 "project/radare2/shlr/zip/zlib/gzread.c"
                                   || len < 1)
        return 
# 556 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
              ((void *)0)
# 556 "project/radare2/shlr/zip/zlib/gzread.c"
                  ;
    state = (gz_statep)file;
    ...
    if (state->mode != 7247 ||
        (state->err != 0 && state->err != (-5)))
        return 
# 562 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
              ((void *)0)
# 562 "project/radare2/shlr/zip/zlib/gzread.c"
                  ;
    ...
    if (state->seek) {
        ...
        if (gz_skip(state, state->skip) == -1)
            return 
# 568 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
                  ((void *)0)
# 568 "project/radare2/shlr/zip/zlib/gzread.c"
                      ;
    }
    ...
    if (left) do {
        ...
        if (state->x.have == 0 && gz_fetch(state) == -1)
            return 
# 579 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
                  ((void *)0)
# 579 "project/radare2/shlr/zip/zlib/gzread.c"
                      ;
        if (state->x.have == 0) {
            state->past = 1;
            break;
        ...
        if (eol != 
# 588 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
                  ((void *)0)
# 588 "project/radare2/shlr/zip/zlib/gzread.c"
                      )
            n = (unsigned)(eol - state->x.next) + 1;


        
# 592 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
       __builtin___memcpy_chk (
# 592 "project/radare2/shlr/zip/zlib/gzread.c"
       buf
# 592 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
       , 
# 592 "project/radare2/shlr/zip/zlib/gzread.c"
...
# 598 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
                           ((void *)0)
# 598 "project/radare2/shlr/zip/zlib/gzread.c"
                               );


    if (buf == str)
        return 
# 602 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
              ((void *)0)
# 602 "project/radare2/shlr/zip/zlib/gzread.c"
                  ;
    buf[0] = 0;
    return str;
}
    ...
    gzFile file;
{
    ...
    if (file == 
# 614 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
               ((void *)0)
# 614 "project/radare2/shlr/zip/zlib/gzread.c"
                   )
        return 0;
    state = (gz_statep)file;
    ...
    gzFile file;
{
    ...
    if (file == 
# 635 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
               ((void *)0)
# 635 "project/radare2/shlr/zip/zlib/gzread.c"
                   )
        return (-2);
    state = (gz_statep)file;
    ...
    err = state->err == (-5) ? (-5) : 0;
    gz_error(state, 0, 
# 650 "project/radare2/shlr/zip/zlib/gzread.c" 3 4
                         ((void *)0)
# 650 "project/radare2/shlr/zip/zlib/gzread.c"
                             );
    free(state->path);
    ret = close(state->fd);
    free(state);
