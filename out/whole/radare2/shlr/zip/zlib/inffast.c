# 0 "project/radare2/shlr/zip/zlib/inffast.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 1 "project/radare2/shlr/zip/zlib/inffast.c"
...
# 7 "project/radare2/shlr/zip/zlib/inffast.c" 2
...
int inflate_table (codetype type, unsigned short *lens, unsigned codes, code * *table, unsigned *bits, unsigned short *work)
                                                                           ...
                                                                           ;
# 8 "project/radare2/shlr/zip/zlib/inffast.c" 2
...
# 9 "project/radare2/shlr/zip/zlib/inffast.c" 2
# 1 "project/radare2/shlr/zip/zlib/inffast.h" 1
# 11 "project/radare2/shlr/zip/zlib/inffast.h"
void inflate_fast (z_streamp strm, unsigned start);
# 10 "project/radare2/shlr/zip/zlib/inffast.c" 2
# 50 "project/radare2/shlr/zip/zlib/inffast.c"
...
# 198 "project/radare2/shlr/zip/zlib/inffast.c"
                    }
                    from = window;
                    if (wnext == 0) {
                        from += wsize - op;
