# 0 "project/radare2/shlr/zip/zlib/deflate.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 14 "project/radare2/shlr/zip/zlib/deflate.h"
#define DEFLATE_H 
...
# 53 "project/radare2/shlr/zip/zlib/deflate.c" 2
...
# 107 "project/radare2/shlr/zip/zlib/deflate.c"
#define NIL 0



#define TOO_FAR 4096
# 120 "project/radare2/shlr/zip/zlib/deflate.c"
...
# 155 "project/radare2/shlr/zip/zlib/deflate.c"
...
# 182 "project/radare2/shlr/zip/zlib/deflate.c"
...
# 402 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
           __builtin___memset_chk (
# 402 "project/radare2/shlr/zip/zlib/deflate.c"
           (Bytef *)s->head
# 402 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
           , 
# 402 "project/radare2/shlr/zip/zlib/deflate.c"
           0, (unsigned)(s->hash_size-1)*sizeof(*s->head)
# 402 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
...
# 460 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
       __builtin___memcpy_chk (
# 460 "project/radare2/shlr/zip/zlib/deflate.c"
       dictionary
# 460 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
       , 
# 460 "project/radare2/shlr/zip/zlib/deflate.c"
       s->window + s->strstart + s->lookahead - len, len
# 460 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
       , __builtin_object_size (
# 460 "project/radare2/shlr/zip/zlib/deflate.c"
       dictionary
    ...
    if (s->level != level) {
        if (s->level == 0 && s->matches != 0) {
            if (s->matches == 1)
                ...
                s->head[s->hash_size-1] = 0; 
# 603 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
               __builtin___memset_chk (
# 603 "project/radare2/shlr/zip/zlib/deflate.c"
               (Bytef *)s->head
# 603 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
               , 
# 603 "project/radare2/shlr/zip/zlib/deflate.c"
...
# 741 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   __builtin___memcpy_chk (
# 741 "project/radare2/shlr/zip/zlib/deflate.c"
   strm->next_out
# 741 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   , 
# 741 "project/radare2/shlr/zip/zlib/deflate.c"
    ...
    if (s->status == 57) {
        ...
        if (s->gzhead == 0) {
            ...
            {s->pending_buf[s->pending++] = (Bytef)(s->level == 9 ? 2 : (s->strategy >= 2 || s->level < 2 ? 4 : 0));}
                             ...
                             ;
            {s->pending_buf[s->pending++] = (Bytef)(19);};
            s->status = 113;
...
# 906 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
               __builtin___memcpy_chk (
# 906 "project/radare2/shlr/zip/zlib/deflate.c"
...
# 907 "project/radare2/shlr/zip/zlib/deflate.c"
                                                           ;
...
# 919 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
           __builtin___memcpy_chk (
# 919 "project/radare2/shlr/zip/zlib/deflate.c"
           s->pending_buf + s->pending
# 919 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
           , 
# 919 "project/radare2/shlr/zip/zlib/deflate.c"
...
# 920 "project/radare2/shlr/zip/zlib/deflate.c"
                                                       ;
            s->pending += left;
            do { if (s->gzhead->hcrc && s->pending > (beg)) strm->adler = crc32(strm->adler, s->pending_buf + (beg), s->pending - (beg)); } while (0);
            s->gzindex = 0;
    ...
    if (strm->avail_in != 0 || s->lookahead != 0 ||
        ...
        if (bstate == block_done) {
            if (flush == 1) {
                ...
                if (flush == 3) {
                    s->head[s->hash_size-1] = 0; 
# 1030 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
                   __builtin___memset_chk (
# 1030 "project/radare2/shlr/zip/zlib/deflate.c"
                   (Bytef *)s->head
# 1030 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
                   , 
# 1030 "project/radare2/shlr/zip/zlib/deflate.c"
...
# 1120 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   __builtin___memcpy_chk (
# 1120 "project/radare2/shlr/zip/zlib/deflate.c"
   (voidpf)dest
# 1120 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   , 
# 1120 "project/radare2/shlr/zip/zlib/deflate.c"
...
# 1125 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   __builtin___memcpy_chk (
# 1125 "project/radare2/shlr/zip/zlib/deflate.c"
   (voidpf)ds
# 1125 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   , 
# 1125 "project/radare2/shlr/zip/zlib/deflate.c"
   (voidpf)ss, sizeof(deflate_state)
# 1125 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   , __builtin_object_size (
# 1125 "project/radare2/shlr/zip/zlib/deflate.c"
   (voidpf)ds
...
# 1140 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   __builtin___memcpy_chk (
# 1140 "project/radare2/shlr/zip/zlib/deflate.c"
   ds->window
# 1140 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   , 
# 1140 "project/radare2/shlr/zip/zlib/deflate.c"
   ss->window, ds->w_size * 2 * sizeof(Byte)
# 1140 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   , __builtin_object_size (
# 1140 "project/radare2/shlr/zip/zlib/deflate.c"
   ds->window
...
# 1141 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   __builtin___memcpy_chk (
# 1141 "project/radare2/shlr/zip/zlib/deflate.c"
   (voidpf)ds->prev
# 1141 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   , 
# 1141 "project/radare2/shlr/zip/zlib/deflate.c"
   (voidpf)ss->prev, ds->w_size * sizeof(Pos)
# 1141 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   , __builtin_object_size (
# 1141 "project/radare2/shlr/zip/zlib/deflate.c"
   (voidpf)ds->prev
...
# 1142 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   __builtin___memcpy_chk (
# 1142 "project/radare2/shlr/zip/zlib/deflate.c"
   (voidpf)ds->head
# 1142 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   , 
# 1142 "project/radare2/shlr/zip/zlib/deflate.c"
   (voidpf)ss->head, ds->hash_size * sizeof(Pos)
# 1142 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   , __builtin_object_size (
# 1142 "project/radare2/shlr/zip/zlib/deflate.c"
   (voidpf)ds->head
...
# 1143 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   __builtin___memcpy_chk (
# 1143 "project/radare2/shlr/zip/zlib/deflate.c"
   ds->pending_buf
# 1143 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   , 
# 1143 "project/radare2/shlr/zip/zlib/deflate.c"
   ss->pending_buf, (uInt)ds->pending_buf_size
# 1143 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   , __builtin_object_size (
# 1143 "project/radare2/shlr/zip/zlib/deflate.c"
   ds->pending_buf
...
# 1176 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   __builtin___memcpy_chk (
# 1176 "project/radare2/shlr/zip/zlib/deflate.c"
   buf
# 1176 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   , 
# 1176 "project/radare2/shlr/zip/zlib/deflate.c"
    ...
    deflate_state *s;
{
    ...
    s->head[s->hash_size-1] = 0; 
# 1199 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   __builtin___memset_chk (
# 1199 "project/radare2/shlr/zip/zlib/deflate.c"
   (Bytef *)s->head
# 1199 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
   , 
# 1199 "project/radare2/shlr/zip/zlib/deflate.c"
...
# 1236 "project/radare2/shlr/zip/zlib/deflate.c"
    ...
    IPos cur_match;
{
    ...
    Posf *prev = s->prev;
    uInt wmask = s->w_mask;
# 1262 "project/radare2/shlr/zip/zlib/deflate.c"
...
# 1330 "project/radare2/shlr/zip/zlib/deflate.c"
...
# 1469 "project/radare2/shlr/zip/zlib/deflate.c"
...
# 1512 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
           __builtin___memcpy_chk (
# 1512 "project/radare2/shlr/zip/zlib/deflate.c"
           s->window
# 1512 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
           , 
# 1512 "project/radare2/shlr/zip/zlib/deflate.c"
           s->window+wsize, (unsigned)wsize - more
# 1512 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
           , __builtin_object_size (
# 1512 "project/radare2/shlr/zip/zlib/deflate.c"
           s->window
...
# 1581 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
           __builtin___memset_chk (
# 1581 "project/radare2/shlr/zip/zlib/deflate.c"
           s->window + curr
# 1581 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
           , 
# 1581 "project/radare2/shlr/zip/zlib/deflate.c"
...
# 1592 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
           __builtin___memset_chk (
# 1592 "project/radare2/shlr/zip/zlib/deflate.c"
           s->window + s->high_water
# 1592 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
           , 
# 1592 "project/radare2/shlr/zip/zlib/deflate.c"
           0, (unsigned)init
...
# 1617 "project/radare2/shlr/zip/zlib/deflate.c"
...
# 1708 "project/radare2/shlr/zip/zlib/deflate.c"
        if (left) {
            if (left > len)
                left = len;
            
# 1711 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
           __builtin___memcpy_chk (
# 1711 "project/radare2/shlr/zip/zlib/deflate.c"
           s->strm->next_out
# 1711 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
           , 
# 1711 "project/radare2/shlr/zip/zlib/deflate.c"
           s->window + s->block_start, left
# 1711 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
           , __builtin_object_size (
# 1711 "project/radare2/shlr/zip/zlib/deflate.c"
           s->strm->next_out
...
# 1743 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
           __builtin___memcpy_chk (
# 1743 "project/radare2/shlr/zip/zlib/deflate.c"
           s->window
# 1743 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
           , 
# 1743 "project/radare2/shlr/zip/zlib/deflate.c"
           s->strm->next_in - s->w_size, s->w_size
# 1743 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
           , __builtin_object_size (
# 1743 "project/radare2/shlr/zip/zlib/deflate.c"
           s->window
...
# 1750 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
               __builtin___memcpy_chk (
# 1750 "project/radare2/shlr/zip/zlib/deflate.c"
               s->window
# 1750 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
               , 
# 1750 "project/radare2/shlr/zip/zlib/deflate.c"
               s->window + s->w_size, s->strstart
# 1750 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
               , __builtin_object_size (
# 1750 "project/radare2/shlr/zip/zlib/deflate.c"
               s->window
...
# 1754 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
           __builtin___memcpy_chk (
# 1754 "project/radare2/shlr/zip/zlib/deflate.c"
           s->window + s->strstart
# 1754 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
           , 
# 1754 "project/radare2/shlr/zip/zlib/deflate.c"
...
# 1778 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
       __builtin___memcpy_chk (
# 1778 "project/radare2/shlr/zip/zlib/deflate.c"
       s->window
# 1778 "project/radare2/shlr/zip/zlib/deflate.c" 3 4
       , 
# 1778 "project/radare2/shlr/zip/zlib/deflate.c"
